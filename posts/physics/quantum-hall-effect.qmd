...
ax1.plot(B, (B/B0) * R_k, color=color1, linestyle='--', alpha=0.5, label=r'Classical Hall ($1/\nu$)')
ax1.set_xlabel('Magnetic Field $B$ (Tesla)', fontsize=12)
ax1.set_ylabel(r'Hall Resistance $R_{xy}$ (k$\Omega$)', color=color1, fontsize=12)
ax1.tick_params(axis='y', labelcolor=color1)

ax2 = ax1.twinx()
color2 = '#e74c3c'
ax2.plot(B, R_xx * R_k, color=color2, lw=2, label='Longitudinal Resistance ($R_{xx}$)')
ax2.set_ylabel(r'Longitudinal Resistance $R_{xx}$ (k$\Omega$)', color=color2, fontsize=12)
