...
|---|---|---|:---:|:---:|:---:|:---:|
| **Phase 1A** | Core RAG, Google SSO, Citations, Escalation, MVP Demo | 4 weeks | $7,500 – $13,200 | **$620** | **2,276** | ~92–95% |
| **Phase 1B** | Streaming, Admin panel, Audit logging, Azure UAE deployment | 6 weeks | $8,000 – $14,000 | **$720** | **2,644** | ~91–95% |
| **Total** | **Complete Phase 1 Production System** | **10 weeks** | **$15,500 – $27,200** | **$1,340** | **4,920** | **~91–95%** |
...
* **Payment Schedule**: 0% upfront (infra/tools direct) / 50% at MVP ($670 / 2,460 AED) / 50% at Launch ($670 / 2,460 AED).

![Milestones & Payment Structure](images/payment_schedule_visualizer.png)

## Action Items

1. **Approve proposal** and confirm budget ($1,340 Phase 1).
2. **Sign mutual NDA**.
