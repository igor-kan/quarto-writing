...
# 5. Financial & Scoping Comparison
...
* **Payment Schedule**: 30% upfront ($201) / 30% at MVP ($201) / 40% at Launch ($268).

![Milestones & Payment Structure](images/payment_schedule_visualizer.png)

## Action Items

1. **Approve proposal** and confirm budget ($670 Phase 1).
2. **Sign mutual NDA**.
