...
**Prepared for**: Aurora Tax Agency (Svetlana, CEO)
...
```
┌──────────────────────────────────────────────────────────────────┐
│  ⚙️ Aurora AI — Admin Console                   Svetlana (Admin) │
│  ═══════════════════════════════════════════════════════════════  │
│                                                                   │
...
| **Aurora Stakeholders** | Svetlana (CEO) + Senior Tax Managers | Requirements validation, UAT testing, knowledge base content, weekly feedback |
...
|---|---|---|---|
| 1 | ✅ **Approve proposal** and confirm budget ($670 Phase 1) | Svetlana (CEO) | ASAP |
...
| 6 | 📝 **Escalation topics list** — which queries should always route to Tax Manager | Svetlana + Tax Managers | Week 2 |
