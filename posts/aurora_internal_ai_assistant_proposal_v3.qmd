...
|---|---|---|---:|---:|---:|---:|---:|
| **Phase 1A — MVP** | Core RAG pipeline, knowledge base (50-80 docs), Google SSO, RBAC (5 roles), chat UI, source citations, confidence scoring, escalation logic, feedback system, basic audit | 4 weeks | $7,500 – $13,200 | 27,544 – 48,477 | **$620** | **2,276** | ~92–95% |
...
| **Total Phase 1** | Complete production system for 15-17 users | **10 weeks** | **$15,500 – $27,200** | **$1,340** | **4,920** | **~91–95%** |
...
> **Our Phase 1 price of $1,340 represents approximately 1/11th to 1/20th of the market rate**, reflecting a strategic investment to build a long-term partnership with Aurora.
...
|---|---|---|---|
| **Phase 1 Development** | $15,500 – $27,200 / 56,924 – 99,892 AED | **$1,340 / 4,920 AED** | ~91–95% |
...
| **Payment Schedule** | **0% upfront** (infrastructure & tools paid directly by client) / **50% after MVP delivery** ($670 / 2,460 AED) / **50% after final launch & handover** ($670 / 2,460 AED) |
...
```mermaid
flowchart LR
    A[Project Start<br/>$0 Upfront] --> B[MVP Delivery<br/>50%<br/>$670 / 2,460 AED]
    B --> C[Final Launch & Handover<br/>50%<br/>$670 / 2,460 AED]
```
...
|---|---|---|---|
| 1 | ✅ **Approve proposal** and confirm budget ($1,340 Phase 1) | Aurora CEO | ASAP |
