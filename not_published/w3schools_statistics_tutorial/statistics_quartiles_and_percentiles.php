<!DOCTYPE html>
<html lang="en-US">
<head><title>Statistics - Quartiles and Percentiles</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Statistics - Quartiles and Percentiles</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="statistics_range.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="statistics_interquartile_range.php">Next &#10095;</a>
</div>
<hr>
<p class="intro">Quartiles and percentiles are measures of variation, which describes how spread out the data is.</p>
<p class="intro">Quartiles and percentiles are both types of <strong>quantiles</strong>.</p>
<hr>
<h2>Quartiles</h2>
...
<ul>
  ...
  <li>Q<sub>1</sub> is the value separating the first quarter from the second quarter of the data.</li>
  <li>Q<sub>2</sub> is the middle value (median), separating the bottom from the top half.</li>
  <li>Q<sub>3</sub> is the value separating the third quarter from the fourth quarter</li>
  <li>Q<sub>4</sub> is the largest value in the data.</li>
</ul>
<hr>
<h2>Calculating Quartiles with Programming</h2>
<p>Quartiles can easily be found with many programming languages.</p>
<p>Using software and programming to calculate statistics is more common for bigger sets of data, as finding it manually becomes difficult.</p>
<div class="w3-example">
  <h3>Example</h3>
  <div>
    <p>With Python use the NumPy library <code class="w3-codespan">quantile()</code> method to find the quartiles of the values 13, 21, 21, 40, 42, 48, 55, 72:</p>
    ...
    <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_stat_numpy_quartiles">Try it Yourself &raquo;</a>
  </div>
</div>
<div class="w3-example">
  <h3>Example</h3>
  <div>
    <p>Use the R <code class="w3-codespan">quantile()</code> function to find the quantiles of the values 13, 21, 21, 40, 42, 48, 55, 72:</p>
    <div class="w3-code notranslate pythonHigh">
    ...
    <a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryr.asp?filename=demo_stat_r_quartiles">Try it Yourself &raquo;</a>
  </div>
</div>
<hr>
<h2>Percentiles</h2>
<p><strong>Percentiles</strong> are values that separate the data into 100 equal parts.</p>
<p>For example, The 95th percentile separates the lowest 95&#37; of the values from the top 5&#37;</p>
<p>The 25th percentile (P<sub>25&#37;</sub>) is the same as the first quartile (Q<sub>1</sub>).</p>
<p>The 50th percentile (P<sub>50&#37;</sub>) is the same as the second quartile (Q<sub>2</sub>) and the median.</p>
<p>The 75th percentile (P<sub>75&#37;</sub>) is the same as the third quartile (Q<sub>3</sub>)</p>
<hr>
<div id="midcontentadcontainer" style="overflow:auto;text-align:center">
<!-- MidContent -->
<!-- <p class="adtext">Advertisement</p> -->
</div><hr>
<h2>Calculating Percentiles with Programming</h2>
<p>Percentiles can easily be found with many programming languages.</p>
<p>Using software and programming to calculate statistics is more common for bigger sets of data, as finding it manually becomes difficult.</p>
<div class="w3-example">
  <h3>Example</h3>
  <div>
    <p>With Python use the NumPy library <code class="w3-codespan">percentile()</code> method to find the <code class="w3-codespan">65</code>th percentile of the values 13, 21, 21, 40, 42, 48, 55, 72:</p>
    <div class="w3-code notranslate pythonHigh">
      import numpy
      <br>
      <br>
    ...
    <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_stat_numpy_percentiles">Try it Yourself &raquo;</a>
  </div>
</div>
<div class="w3-example">
  <h3>Example</h3>
  <div>
    <p>Use the R <code class="w3-codespan">quantile()</code> function to find the 65th percentile (<code class="w3-codespan">0.65</code>) of the values 13, 21, 21, 40, 42, 48, 55, 72:</p>
    <div class="w3-code notranslate pythonHigh">
      values &lt;- c(13,21,21,40,42,48,55,72)
      <br>
      <br>
    ...
    <a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryr.asp?filename=demo_stat_r_percentiles">Try it Yourself &raquo;</a>
  </div>
</div>
<br>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="statistics_box_plots.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="statistics_interquartile_range.php">Next &#10095;</a>
</div>
<div
