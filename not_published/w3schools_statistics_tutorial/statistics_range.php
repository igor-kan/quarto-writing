...
ny:-->
    ...
    <h1>Statistics - Range</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="statistics_variation.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="statistics_quartiles_and_percentiles.php">Next &#10095;</a>
</div>
<hr>
<p class="intro">The range is a measure of variation, which describes how spread out the data is.</p>
<hr>
<h2>Range</h2>
...
<p>The range can only be calculated for numerical data.</p>
<p>First, find the smallest and largest values of this example:</p>
<div class="w3-code notranslate">
  <p><u>13</u>, 21, 21, 40, 48, 55, <u>72</u></p>
</div>
<p>Calculate the difference by subtracting the smallest from the largest:</p>
<p>72 - 13 = <u>59</u></p>
<hr>
...
<h2>Calculating the Range with Programming</h2>
<p>The range can easily be found with many programming languages.</p>
...
<div class="w3-example">
  <h3>Example</h3>
  <div>
    <p>With Python use the NumPy library <code class="w3-codespan">ptp()</code> method to find the range of the values 13, 21, 21, 40, 48, 55, 72:</p>
    ...
    <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_stat_numpy_range">Try it Yourself &raquo;</a>
  </div>
</div>
<div class="w3-example">
  <h3>Example</h3>
  <div>
    <p>Use the R <code class="w3-codespan">min()</code> and <code class="w3-codespan">max()</code> functions to find the range of the values 13, 21, 21, 40, 48, 55, 72:</p>
    <div class="w3-code notranslate pythonHigh">
    ...
    <a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryr.asp?filename=demo_stat_r_range">Try it Yourself &raquo;</a>
  </div>
</div>
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> The <code class="w3-codespan">range()</code> function in R returns the smallest and largest values.</p>
</div>
<br>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="statistics_variation.php">&#10094; Previous</a>
