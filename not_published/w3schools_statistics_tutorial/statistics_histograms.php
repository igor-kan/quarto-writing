<!DOCTYPE html>
<html lang="en-US">
<head><title>Statistics - Histograms</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="statistics_frequency_tables.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="statistics_bar_graphs.php">Next &#10095;</a>
</div>
<hr>
<p class="intro">A histogram visually presents quantitative data.</p>
<hr>
<h2>Histograms</h2>
<p>A histogram is a widely used graph to show the distribution of quantitative (numerical) data.</p>
<p>It shows the <strong>frequency</strong> of values in the data, usually in intervals of values. Frequency is the amount of times that value appeared in the data.</p>
<p>Each interval is represented with a bar, placed next to the other intervals on a number line.</p>
<p>The height of the bar represents the frequency of values in that interval.</p>
<p>Here is a histogram of the age of all 934 Nobel Prize winners up to the year 2020:</p>
<p><img src="img_histogram.svg" style="width:100%; max-width:1200px; height:auto" alt="Histogram of the age of Nobel Prize winners"></p>
<p>This histogram uses age intervals from 10 to 19, 20 to 29, and so on.</p>
<div class="w3-panel ws-note">
<p><strong>Note:</strong> Histograms are similar to bar graphs, which are used for qualitative data.</p>
</div>
<hr>
...
<h2>Bin Width</h2>
<p>The intervals of values are often called 'bins'. And the length of an interval is called 'bin width'.</p>
<p>We can choose any width. It is best with a bin width that shows enough detail without being confusing.</p>
<p>Here is a histogram of the same Nobel Prize winner data, but with bin widths of 5 instead of 10:</p>
<p><img src="img_histogram5bw.svg" style="width:100%; max-width:1200px; height:auto" alt="Histogram of the age of Nobel Prize winners"></p>
<p>This histogram uses age intervals from from 15 to 19, 20 to 24, 25 to 29, and so on.</p>
<p>Smaller intervals gives a more detailed look at the distribution of the age values in the data.</p>
<br>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="statistics_frequency_tables.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="statistics_bar_graphs.php">Next &#10095;</a>
