<!DOCTYPE html>
<html lang="en-US">
<head><title>Statistics - Bar Graphs</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Statistics - Bar Graphs</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="statistics_histograms.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="statistics_pie_charts.php">Next &#10095;</a>
</div>
<hr>
<p class="intro">A bar graph visually presents qualitative data.</p>
<hr>
<h2>Bar Graphs</h2>
<p>Bar graphs are used show the distribution of qualitative (categorical) data.</p>
<p>It shows the <strong>frequency</strong> of values in the data. Frequency is the amount of times that value appeared in the data.</p>
<p>Each category is represented with a bar. The height of the bar represents the frequency of values from that category in the data.</p>
<p>Here is a bar graph of the number of people who have won a Nobel Prize in each category up to the year 2020:</p>
<p><img src="img_bargraph.svg" style="width:100%; max-width:1200px; height:auto" alt="Bar graph of number people who have won Nobel Prizes in each category"></p>
...
<p><strong>Note:</strong> Bar graphs are similar to histograms, which are used for 
quantitative data.</p>
</div>
