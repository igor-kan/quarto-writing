<!DOCTYPE html>
<html lang="en-US">
<head><title>Statistics - Study Types</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Statistics - Study Types</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="statistics_parameters_and_statistics.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="statistics_sample_types.php">Next &#10095;</a>
</div>
<hr>
<p class="intro">A statistical study can be a part of the process of gathering data.</p>
<p class="intro">There are different types of studies. Some are better than others, but they might be harder to do.</p>
<hr>
<h3>Main Types of Statistical Studies</h3>
<p>The main types of statistical studies are <strong>observational</strong> and <strong>experimental</strong> studies.</p>
<p>We are often interested in knowing if something is the <strong>cause</strong> of another thing.</p>
<p>Experimental studies are generally better than observational studies for investigating this, but usually require more effort.</p>
<p>An observational study is when observe and gather data without changing anything.</p>
<h3>Experimental Studies</h3>
<p>In an experimental study, the <strong>circumstances</strong> around the sample is changed. Usually, we compare two groups from a population and these two groups are treated <strong>differently</strong>.</p>
<p>One example can be a medical study to see if a new medicine is effective.</p>
<p>One group receives the medicine and the other does not. These are the different circumstances around those samples.</p>
<p>We can compare the health of both groups afterwards and see if the results are different.</p>
<p>Experimental studies can allow us to investigate causal relationships. A well designed experimental study can be useful since it can <strong>isolate</strong> the relationship we are interested in from <strong>other effects</strong>. Then we can be more confident that we are measuring the true effect.</p>
