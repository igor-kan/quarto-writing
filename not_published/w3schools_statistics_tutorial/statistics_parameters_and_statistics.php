<!DOCTYPE html>
<html lang="en-US">
<head><title>Statistics - Parameters and Statistics</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Statistics - Parameters and Statistics</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="statistics_populations_and_samples.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="statistics_study_types.php">Next &#10095;</a>
</div>
<hr>
<p class="intro">The terms 'parameter' and (sample) 'statistic' refer to key concepts that are closely related in statistics.</p>
<p class="intro">They are also directly connected to the concepts of populations and samples.</p>
<hr>
<h2>Parameters and Statistics</h2>
<p><strong>Parameter</strong>: A number that describes something about the whole <strong>population</strong>.</p>
<p><strong>Sample statistic</strong>: A number that describes something about the <strong>sample</strong>.</p>
<p>The parameters are the key things we want to learn about. The parameters are usually unknown.</p>
<p>Sample statistics gives us <strong>estimates</strong> for parameters.</p>
<p>There will always be some <strong>uncertainty</strong> about how accurate estimates are. More certainty gives us more useful knowledge.</p>
<p>For every parameter we want to learn about we can get a sample and calculate a sample statistic, which gives us an estimate of the parameter.</p>
<h3>Some Important Examples</h3>
...
<p><strong>Mean, median and mode</strong> are different types of averages (typical values in a population). <p>For example:</p>
<ul>
  <li>The typical age of people in a country</li>
  <li>The typical profits of a company</li>
  <li>The typical range of an electric car</li>
</ul>
<p><strong>Variance</strong> and <strong>standard deviation</strong> are two types of values describing how spread out the values are.
<p>A single class of students in a school would usually be about the same age. The age of the students will have <strong>low</strong> variance and standard deviation.
<p>A whole country will have people of all kinds of different ages. The variance and standard deviation of age in the whole country would then be <strong>bigger</strong> than in a single school grade.</p>
