<!DOCTYPE html>
<html lang="en-US">
<head><title>Statistics - Measurement Levels</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Statistics - Measurement Levels</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="statistics_data_types.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="statistics_descriptive_statistics.php">Next &#10095;</a>
</div>
<hr>
<p class="intro">Different data types have different measurement levels.</p>
<p class="intro">Measurement levels are important for what types of statistics can be calculated and how to best present the data.</p>
<hr>
<h2>Measurement Levels</h2>
<p>The main types of data are Qualitative (categories) and Quantitative (numerical). These are further split into the following measurement levels.</p>
<p>These measurement levels are also called measurement 'scales'</p>
<h3>Nominal Level</h3>
<p>Categories (qualitative data) without any order.</p>
<p>Examples:</p>
<ul>
  <li>Brand names</li>
  <li>Countries</li>
...
<h3>Ordinal level</h3>
<p>Categories that can be ordered (from low to high), but the precise "distance" between each is not meaningful.</p>
<p>Examples:</p>
<ul>
  <li>Letter grade scales from F to A</li>
  <li>Military ranks</li>
  <li>Level of satisfaction with a product</li>
</ul>
<p>Consider letter grades from F to A: Is the grade A precisely twice as good as a B? And, is the grade B also twice as good as C?</p>
<p>Exactly how much distance it is between grades is not clear and precise. If the grades are based on amounts of points on a test, you can say that there is a precise "distance" on the point scale, but not the grades themselves.</p>
<h3>Interval Level</h3>
<p>Data that can be ordered and the distance between them is objectively meaningful. But there is no natural 0-value where the scale originates.</p>
<p>Examples:</p>
<ul>
  <li>Years in a calendar</li>
  <li>Temperature measured in Fahrenheit</li>
</ul>
<div class="w3-panel ws-note">
<p><strong>Note:</strong> Interval scales are usually invented by people, like degrees of temperature.</p>
<p>0 degrees Celsius is 32 degrees of Fahrenheit. There is consistent distances between each degree (for every 1 extra degree of 
Celsius, there is 1.8 extra Fahrenheit), but they do not agree on where 0 degrees is.</p>
</div>
<h3>Ratio Level</h3>
<p>Data that can be ordered and there is a consistent and meaningful distance between them. And it also has a natural 0-value.</p>
<p>Examples:</p>
<ul>
  <li>Money</li>
  <li>Age</li>
...
<p>Data that is on the ratio level (or "ratio scale") gives us the most detailed information. Crucially, we can compare precisely how big one value is compared to another. This would be the ratio between these values, like twice as big, or ten times as small.</p>
