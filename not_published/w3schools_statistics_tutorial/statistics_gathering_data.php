<!DOCTYPE html>
<html lang="en-US">
<head><title>Statistics - Gathering Data</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Statistics - Gathering Data</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="statistics_introduction.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="statistics_describing_data.php">Next &#10095;</a>
</div>
<hr>
<h2>Gathering Data</h2>
<p>Gathering data is the first step in statistical analysis.</p>
<p>Say for example that you want to know something about <strong>all the people in France</strong>.</p>
<p>The <strong>population</strong> is then all of the people in France.</p>
<p>It is too much effort to gather information about all of the members of a population (e.g. all 67+ million people living in France). It is often much easier to collect a smaller group of that population and analyze that. This is called a <strong>sample</strong>.
<h3>A representative sample</h3>
<p>The sample needs to be <strong>similar</strong> to the whole population of France. It should have the same characteristics as the population. If you only include people named Jacques living in Paris who are 48 years old, the sample will not be similar to the whole population.
<p>So for a good sample, you will need people from all over France, with different ages, professions, and so on.</p>
<p>If the members of the sample have similar characteristics (like age, profession, etc.) to the whole population of France, we say that the sample is <strong>representative</strong> of the population.</p>
<p>A good <strong>representative sample</strong> is crucial for statistical methods.</p>
<div class="w3-panel ws-info">
<p><strong>Note:</strong> Data from a proper sample is often just as good data from the whole population, as long as it is <strong>representative!</strong></p>
<p>A good sample allows you to make accurate conclusions about the whole population.</p>
</div>
