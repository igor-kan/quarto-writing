<!DOCTYPE html>
<html lang="en-US">
<head><title>Statistics - Average</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<hr>
<p class="intro">An average is a measure of where most of the values in the data are located.</p>
<hr>
<h2>The Center of the Data</h2>
<p>The center of the data is where most of the values in the data are located. Averages are measures of the <strong>location</strong> of the center.</p>
<p>There are different types of averages. The most commonly used are:</p>
<ul>
  <li><a href="statistics_mean.php">Mean</a></li>
  <li><a href="statistics_median.php">Median</a></li>
  <li><a href="statistics_mode">Mode</a></li>
</ul>
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> In statistics, averages are often referred to as 'measures of <strong>central tendency</strong>'.</p>
</div>
<p>For example, using the values:</p>
...
<h2>Median</h2>
<p>The <strong>median</strong> is the 'middle value' of the data.</p>
<p>The median is found by <strong>ordering all the values</strong> in the data and picking the middle value:</p>
<div class="w3-code notranslate">
  <p>13, 21, 21, <u>40</u>, 48, 55, 72</p>
</div>
<p>The median is less influenced by <strong>extreme</strong> values in the data than the mean.</p>
<p>Changing the last value to 356 does not change the median:</p>
<div class="w3-code notranslate">
  <p>13, 21, 21, <u>40</u>, 48, 55, <strong>356</strong></p>
</div>
<p>The median is still 40.</p>
<p>Changing the last value to 356 changes the <strong>mean</strong> a lot:</p>
<div class="w3-code notranslate">
  <p>(13 + 21 + 21 + 40 + 48 + 55 + 72)/7 = <u>38.57</u></p>
  <p>(13 + 21 + 21 + 40 + 48 + 55 + <strong>356</strong>)/7 = <u>79.14</u></p>
</div>
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> Extreme values are values in the data that are much smaller or larger than the average values in the data.</p>
</div>
<hr>
<h2>Mode</h2>
<p>The <strong>mode</strong> is the value(s) that appears most often in the data:</p>
<div class="w3-code notranslate">
  <p>40, <u>21</u>, 55, <u>21</u>, 48, 13, 72</p>
</div>
<p>Here, 21 appears two times, and the other values only once. The mode of this data is 21.</p>
<p>The mode is also used for <strong>categorical</strong> data, unlike the median and mean. Categorical data can't be described directly with numbers, like names:</p>
<div class="w3-code notranslate">
  <p>Alice, <u>John</u>, Bob, Maria, <u>John</u>, Julia, Carol</p>
</div>
<p>Here, John appears two times, and the other values only once. The mode of this data is John.</p>
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> There can be more than one mode if multiple values appear the same number of times in the data.</p>
</div>
<br>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="statistics_box_plots.php">&#10094; Previous</a>
