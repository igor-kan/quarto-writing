<!DOCTYPE html>
<html lang="en-US">
<head><title>Statistics - Median</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Statistics - Median</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="statistics_mean.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="statistics_mode.php">Next &#10095;</a>
</div>
<hr>
<p class="intro">The median is a type of average value, which describes where the center of the data is located.</p>
<hr>
<h2>Median</h2>
<p>The median is the <strong>middle</strong> value in a data set ordered from low to high.</p>
<hr>
<h2>Finding the Median</h2>
<p>The median can only be calculated for numerical variables.</p>
<p>The formula for finding the middle value is:</p>
<p>\( \displaystyle \frac{n + 1}{2} \)</p>
<p>Where \(n\) is the total number of observations.</p>
<p>If the total number of observations is an <strong>odd</strong> number, the formula gives a whole number and the value of this observation is the median.</p>
<div class="w3-code notranslate">
    <p>13, 21, 21, <u>40</u>, 48, 55, 72</p>
</div>
<p>Here, there are 7 total observations, so the median is the 4th value: </p>
<p>\( \displaystyle \frac{7 + 1}{2} = \frac{8}{2} = 4 \)</p>
<p>The 4th value in the ordered list is <strong>40</strong>, so that is the median.</p>
<p>If the total number of observations is an <strong>even</strong> number, the formula gives a decimal number between two observations.</p>
<div class="w3-code notranslate">
    <p>13, 21, 21, <u>40, 42</u>, 48, 55, 72</p>
</div>
<p>Here, there are 8 total observations, so the median is between the 4th and 5th values:</p>
<p> \( \displaystyle \frac{8 + 1}{2} = \frac{9}{2} = 4.5 \)</p>
<p>The 4th and 5th values in the ordered list is <strong>40</strong> and <strong>42</strong>, so the median is the <strong>mean</strong> of these two values. That is, the sum of those two values divided by 2:</p>
<p>\( \displaystyle \frac{40+42}{2} = \frac{82}{2} = \underline{41} \)</p>
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> It is important that the numbers are ordered before you can find the median.</p>
</div>
<hr>
...
<h2>Finding the Median with Programming</h2>
<p>The median can easily be found with many programming languages.</p>
...
<div class="w3-example">
  <h3>Example</h3>
  <div>
    <p>With Python use the NumPy library <code class="w3-codespan">median()</code> method to find the median of the values 13, 21, 21, 40, 42, 48, 55, 72:</p>
    ...
    <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_stat_numpy_median">Try it Yourself &raquo;</a>
  </div>
</div>
<div class="w3-example">
  <h3>Example</h3>
  <div>
    <p>Use the R <code class="w3-codespan">median()</code> function to find the median of the values 13, 21, 21, 40, 42, 48, 55, 72:</p>
    <div class="w3-code notranslate pythonHigh">
    ...
    <a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryr.asp?filename=demo_stat_r_median">Try it Yourself &raquo;</a>
  </div>
</div>
<br>
<div class="w3-clear nextprev">
