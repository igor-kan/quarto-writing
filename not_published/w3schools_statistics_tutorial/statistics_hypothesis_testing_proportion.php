<!DOCTYPE html>
<html lang="en-US">
<head><title>Statistics - Hypothesis Testing a Proportion</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Statistics - Hypothesis Testing a Proportion</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="statistics_hypothesis_testing.php">&#10094; Previous</a>
...
<ul>
  ...
  <li><strong>Category</strong>: Born in the United States of America</li>
</ul>
<p>And we want to check the claim:</p>
<div class="w3-code notranslate">
  <p>"<strong>More</strong> than 20&#37; of Nobel Prize winners were born in the US"</p>
</div>
<p>By taking a sample of 40 randomly selected Nobel Prize winners we could find that:</p>
<div class="w3-code notranslate">
  <p>10 out of 40 Nobel Prize winners in the sample were born in the US</p>
</div>
<p>The <strong>sample</strong> proportion is then: \(\displaystyle \frac{10}{40} = 0.25\), or 25&#37;.</p>
...
<p>In our example, we randomly selected 10 people that were born in the US.</p>
<p>The rest were not born in the US, so there are 30 in the other category.</p>
...
<p>In this case, the <strong>parameter</strong> is the proportion of Nobel Prize winners born in the US (\(p\)).</p>
<p>The null and alternative hypothesis are then:</p>
<div class="w3-code notranslate">
  <p><strong>Null hypothesis</strong>: 20&#37; of Nobel Prize winners were born in the US.</p>
...
<p>This is a '<strong>right</strong> tailed' test, because the alternative hypothesis claims that the proportion is <strong>more</strong> than in the null hypothesis.</p>
...
<p>In our example:</p>
<div class="w3-code notranslate">
  <p>The claimed (\(H_{0}\)) population proportion (\(p\)) was \( 0.20 \)</p>
  <p>The sample proportion (\(\hat{p}\)) was 10 out of 40, or: \(\displaystyle \frac{10}{40} = 0.25\)
  <p>The sample size (\(n\)) was \(40\)</p>
</div>
...
<div class="w3-example">
  ...
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_stat_python_prop_test_statistic">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
  <h3>Example</h3>
    <p>With R use the built-in <code class="w3-codespan">prop.test()</code> function to calculate the test statistic for a proportion.</p>
  <div class="w3-code notranslate pythonHigh">
  ...
  <a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_stat_r_prop_test_statistic">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>5. Concluding</h2>
...
<p>Because the claim is that the population proportion is <strong>more</strong> than 20&#37;, the rejection region is in the right tail:</p>
<p><img src="img_critical_value_right_prop1.svg" alt="Standard Normal Distribution with a right tail area (rejection region) denoted as the greek symbol alpha"></p>
<p>The size of the rejection region is decided by the significance level (\(\alpha\)).
<p>Choosing a significance level (\(\alpha\)) of 0.05, or 5&#37;, we can find the critical Z-value from a <a href="statistics_z_table.php">Z-table</a>, or with a programming language function:</p>
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> The functions find the Z-value for an area from the left side.</p>
  <p>To find the Z-value for a right tail we need to use the function on the area to the left of the tail (1-0.05 = 0.95).</p>
</div>
<div class="w3-example">
  <h3>Example</h3>
  <p>With Python use the Scipy Stats library <code class="w3-codespan">norm.ppf()</code> function find the Z-value for an \(\alpha\) = 0.05 in the right tail.</p>
  <div class="w3-code notranslate pythonHigh">
    import scipy.stats as stats
    <br>
    print(stats.norm.ppf(1-0.05))
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_stat_python_z_score2">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
  <h3>Example</h3>
  <p>With R use the built-in <code class="w3-codespan">qnorm()</code> function to find the Z-value for an \(\alpha\) = 0.05 in the right tail.</p>
  <div class="w3-code notranslate pythonHigh">
    qnorm(1-0.05)
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_stat_r_z_score2">Try it Yourself &raquo;</a>
</div>
<p>Using either method we can find that the critical Z-value is \(\approx \underline{1.6449}\)</p>
<p>For a <strong>right</strong> tailed test we need to check if the test statistic (TS) is <strong>bigger</strong> than the critical value (CV).</p>
<p>If the test statistic is bigger than the critical value, the test statistic is in the <strong>rejection region</strong>.</p>
<p>When the test statistic is in the rejection region, we <strong>reject</strong> the null hypothesis (\(H_{0}\)).</p>
<p>Here, the test statistic (TS) was \(\approx \underline{0.791}\) and the critical value was \(\approx \underline{1.6449}\)</p>
<p>Here is an illustration of this test in a graph:</p>
<p><img src="img_critical_value_right_prop2.svg" alt="Standard Normal Distribution with a right tail area (rejection region) equal to 0.05, a critical value of 1.6449, and a test statistic of 0.791"></p>
<p>Since the test statistic was <strong>smaller</strong> than the critical value we do <strong>not</strong> reject the null hypothesis.</p>
...
<div class="w3-code notranslate">
  <p>The sample data does <strong>not</strong> support the claim that "more than 20&#37; of Nobel Prize winners were born in the US" at a <strong>5&#37; significance level</strong>.</p>
</div>
...
<p>The test statistic was found to be \( \approx \underline{0.791} \)</p>
...
<p>Because this is a <strong>right</strong> tailed test, we need to find the P-value of a Z-value <strong>bigger</strong> than 0.791.</p>
<p>We can find the P-value using a <a href="statistics_z_table.php">Z-table</a>, or with a programming language function:</p>
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> The functions find the P-value (area) to the left side of Z-value.</p>
  <p>To find the P-value for a right tail we need to subtract the left area from the total area: 1 - the output of the function.</p>
</div>
<div class="w3-example">
  <h3>Example</h3>
    <p>With Python use the Scipy Stats library <code class="w3-codespan">norm.cdf()</code> function find the P-value of a Z-value bigger than 0.791:</p>
  <div class="w3-code notranslate pythonHigh">
    import scipy.stats as stats
    <br>
    print(1-stats.norm.cdf(0.791))
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_stat_python_p_value">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
  <h3>Example</h3>
    <p>With R use the built-in <code class="w3-codespan">pnorm()</code> function find the P-value of a Z-value bigger than 0.791:</p>
  <div class="w3-code notranslate pythonHigh">
    1-pnorm(0.791)
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_stat_r_p_value">Try it Yourself &raquo;</a>
</div>
<p>Using either method we can find that the P-value is \(\approx \underline{0.2145}\)</p>
<p>This tells us that the significance level (\(\alpha\)) would need to be bigger than 0.2145, or 21.45&#37;, to <strong>reject</strong> the null hypothesis.</p>
<p>Here is an illustration of this test in a graph:</p>
<p><img src="img_p_value_right_prop.svg"></p>
...
<p>And we can summarize the conclusion stating:</p>
<div class="w3-code notranslate">
  <p>The sample data does <strong>not</strong> support the claim that "more than 20&#37; of Nobel Prize winners were born in the US" at a <strong>10&#37;, 5&#37;, or 1&#37; significance level</strong>.</p>
</div>
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> It may still be true that the real population proportion is more than 20&#37;.</p>
  <p>But there was not strong enough evidence to support it with this sample.</p>
</div>
<hr>
...
<div class="w3-example">
  <h3>Example</h3>
    <p>With Python use the scipy and math libraries to calculate the P-value for a right tailed hypothesis test for a proportion.</p>
    <p>Here, the sample size is 40, the occurrences are 10, and the test is for a proportion bigger than 0.20.</p>
  <div class="w3-code notranslate pythonHigh">
    import scipy.stats as stats
    <br>
    import math
  ...
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_stat_python_prop_test">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
  <h3>Example</h3>
    <p>With R use the built-in <code class="w3-codespan">prop.test()</code> function find the P-value for a right tailed hypothesis test for a proportion.</p>
    <p>Here, the sample size is 40, the occurrences are 10, and the test is for a proportion bigger than 0.20.</p>
  <div class="w3-code notranslate pythonHigh">
    # Specify the sample occurrences (x), the sample size (n), and the null-hypothesis claim (p)
    <br>
  ...
  <a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_stat_r_prop_test">Try it Yourself &raquo;</a>
</div>
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> The <code class="w3-codespan">conf.level</code> in the R code is the reverse of the significance level.</p>
  <p>Here, the significance level is 0.05, or 5&#37;, so the conf.level is 1-0.05 = 0.95, or 95&#37;.</p>
</div>
<hr>
<h2>Left-Tailed and Two-Tailed Tests</h2>
<p>This was an example of a <strong>right</strong> tailed test, where the alternative hypothesis claimed that parameter is <strong>bigger</strong> than the null hypothesis claim.</p>
...
<ul>
  ...
  <li><a href="statistics_hypothesis_testing_proportion_2tail.php">Two-Tailed Test</a></li>
</ul>
<br>
<div class="w3-clear nextprev">
    <a class="w3-left w3-btn" href="statistics_hypothesis_testing.php">&#10094; Previous</a>
