<!DOCTYPE html>
<html lang="en-US">
<head><title>Statistics - Student's T Distribution</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Statistics - Student's T Distribution</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="statistics_standard_normal_distribution.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="statistics_estimation.php">Next &#10095;</a>
</div>
<hr>
<p class="intro">The student's t-distribution is similar to a <a href="statistics_normal_distribution.php">normal distribution</a> and used in statistical inference to adjust for uncertainty.</p>
<hr>
<h2>Student's T Distribution</h2>
<p>The t-distribution is used for estimation and hypothesis testing of a population <a href="statistics_mean.php">mean</a> (average).</p>
<p>The t-distribution is adjusted for the extra uncertainty of estimating the mean.</p>
<p>If the sample is small, the t-distribution is wider. If the sample is big, the t-distribution is narrower.</p>
<p>The bigger the sample size is, the closer the t-distribution gets to the standard normal distribution.</p>
<p>Below is a graph of a few different t-distributions.</p>
<p><img src="img_t_distribution.svg" style="width:100%; max-width:1000px; height:auto" alt="Normal distribution and t-distribtutions with different degrees of freedom."></p>
<p>Notice how some of the curves have bigger tails.</p>
<p>This is due to the uncertainty from a smaller sample size.</p>
<p>The green curve has the smallest sample size.</p>
<p>For the t-distribution this is expressed as 'degrees of freedom' (df), which is calculated by subtracting 1 from the sample size (n).</p>
<p>For example a sample size of 30 will make 29 degrees of freedom for the t-distribution.</p>
<p>The t-distribution is used to find <strong>critical t-values</strong> and <strong>p-values</strong> (probabilities) for estimation and hypothesis testing.</p>
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> Finding the critical t-values and p-values of the t-distribution is similar z-values and p-values of the standard normal distribution. But make sure to use the correct degrees of freedom.</p>
</div>
<hr>
...
<h2>Finding the P-Value of a T-Value</h2>
<p>You can find the p-values of a t-value by using a <a href="statistics_t_table.php">t-table</a> or with programming.</p>
<div class="w3-example">
  <h3>Example</h3>
  <p>With Python use the Scipy Stats library <code class="w3-codespan">t.cdf()</code> function find the probability of getting less than a t-value of 2.1 with 29 degrees of freedom:</p>
  <div class="w3-code notranslate pythonHigh">
    import scipy.stats as stats
    <br>
    print(stats.t.cdf(2.1, 29))
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_stat_python_t_p">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
  <h3>Example</h3>
  <p>With R use the built-in <code class="w3-codespan">pt()</code> function find the probability of getting less than a t-value of 2.1 with 29 degrees of freedom:</p>
  <div class="w3-code notranslate pythonHigh">
    pt(2.1, 29)
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_stat_r_t_p">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Finding the T-value of a P-Value</h2>
<p>You can find the t-values of a p-value by using a <a href="statistics_t_table.php">t-table</a> or with programming.</p>
<div class="w3-example">
  <h3>Example</h3>
  <p>With Python use the Scipy Stats library <code class="w3-codespan">t.ppf()</code> function find the t-value separating the top 25% from the bottom 75% with 29 degrees of freedom:</p>
  <div class="w3-code notranslate pythonHigh">
    import scipy.stats as stats
    <br>
    print(stats.t.ppf(0.75, 29))
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_stat_python_p_t">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
  <h3>Example</h3>
  <p>With R use the built-in <code class="w3-codespan">qt()</code> function find the t-value separating the top 25% from the bottom 75% with 29 degrees of freedom (df):</p>
  <div class="w3-code notranslate pythonHigh">
    qt(0.75, 29)
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_stat_r_p_t">Try it Yourself &raquo;</a>
</div>
<br>
<div class="w3-clear nextprev">
    <a class="w3-left w3-btn" href="statistics_standard_normal_distribution.php">&#10094; Previous</a>
