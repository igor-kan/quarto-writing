<!DOCTYPE html>
<html lang="en-US">
<head><title>Statistics - Data Types</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Statistics - Data Types</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="statistics_sample_types.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="statistics_measurement_levels.php">Next &#10095;</a>
</div>
<hr>
<p class="intro">Data can be different types, and require different types of statistical methods to analyze.</p>
<hr>
<h2>Different types of data</h2>
<p>There are two main types of data: Qualitative (or 'categorical') and quantitative (or 'numerical'). These main types also have different sub-types depending on their <strong>measurement level</strong>.</p>
<h3>Qualitative Data</h3>
<p>Information about something that can be sorted into different categories that can't be described directly by numbers.</p>
<p>Examples:</p>
<ul>
  <li>Brands</li>
  <li>Nationality</li>
...
<p>With categorical data we can calculate statistics like <strong>proportions</strong>. For example, the proportion of Indian people in the world, or the percent of people who prefer one brand to another.</p>
<h3>Quantitative Data</h3>
<p>Information about something that is described by numbers.</p>
<p>Examples:</p>
<ul>
  <li>Income</li>
  <li>Age</li>
...
<p>With numerical data we can calculate statistics like the <strong>average</strong> income in a country, or the <strong>range</strong> of heights of players in a football team.</p>
