<!DOCTYPE html>
<html lang="en-US">
<head><title>Statistics - Hypothesis Testing a Proportion (Left Tailed)</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Statistics - Hypothesis Testing a Proportion (Left Tailed)</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="statistics_t_table.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="statistics_hypothesis_testing_proportion_2tail.php">Next &#10095;</a>
</div>
<hr>
...
<div class="w3-code notranslate">
  <p>"<strong>Less</strong> than 45&#37; of Nobel Prize winners were born in the US"</p>
</div>
...
<ul>
  ...
  <li>There is only two options:</li>
  <ul>
    <li>Being in the category</li>
    <li>Not being in the category</li>
  </ul>
  <li>The sample needs at least:</li>
  <ul>
...
<div class="w3-code notranslate">
  <p><strong>Null hypothesis</strong>: 45&#37; of Nobel Prize winners were born in the US.</p>
...
<p>This is a '<strong>left</strong> tailed' test, because the alternative hypothesis claims that the proportion is <strong>less</strong> than in the null hypothesis.</p>
...
<p>In our example:</p>
<div class="w3-code notranslate">
  <p>The claimed (\(H_{0}\)) population proportion (\(p\)) was \( 0.45 \)</p>
...
<p>\(\displaystyle \frac{0.25-0.45}{\sqrt{0.45(1-0.45)}} \cdot \sqrt{40} = \frac{-0.2}{\sqrt{0.45(0.55)}} \cdot \sqrt{40} = \frac{-0.2}{\sqrt{0.2475}} \cdot \sqrt{40} \approx \frac{-0.2}{0.498} \cdot 6.325 = \underline{-2.543}\)</p>
...
<div class="w3-example">
  ...
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_stat_python_prop_test_statistic_left">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
  <h3>Example</h3>
  ...
  <a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_stat_r_prop_test_statistic_left">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>5. Concluding</h2>
...
<p>Because the claim is that the population proportion is <strong>less</strong> than 45&#37;, the rejection region is in the left tail:</p>
<p><img src="img_critical_value_left_prop.svg" alt="Standard Normal Distribution with a left tail area (rejection region) denoted as the greek symbol alpha"></p>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>With Python use the Scipy Stats library <code class="w3-codespan">norm.ppf()</code> function find the Z-value for an \(\alpha\) = 0.01 in the left tail.</p>
  <div class="w3-code notranslate pythonHigh">
    import scipy.stats as stats
    <br>
    print(stats.norm.ppf(0.01))
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_stat_python_z_score3">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
  <h3>Example</h3>
  <p>With R use the built-in <code class="w3-codespan">qnorm()</code> function to find the Z-value for an \(\alpha\) = 0.01 in the left tail.</p>
  <div class="w3-code notranslate pythonHigh">
    qnorm(0.01)
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_stat_r_z_score3">Try it Yourself &raquo;</a>
</div>
<p>Using either method we can find that the critical Z-value is \(\approx \underline{-2.3264}\)</p>
<p>For a <strong>left</strong> tailed test we need to check if the test statistic (TS) is <strong>smaller</strong> than the critical value (CV).</p>
<p>If the test statistic is smaller than the critical value, the test statistic is in the <strong>rejection region</strong>.</p>
<p>When the test statistic is in the rejection region, we <strong>reject</strong> the null hypothesis (\(H_{0}\)).</p>
<p>Here, the test statistic (TS) was \(\approx \underline{-2.543}\) and the critical value was \(\approx \underline{-2.3264}\)</p>
<p>Here is an illustration of this test in a graph:</p>
<p><img src="img_critical_value_left_prop1.svg" alt="Standard Normal Distribution with a left tail area (rejection region) equal to 0.01, a critical value of -2.3263, and a test statistic of -2.543"></p>
<p>Since the test statistic was <strong>smaller</strong> than the critical value we <strong>reject</strong> the null hypothesis.</p>
<p>This means that the sample data supports the alternative hypothesis.</p>
<p>And we can summarize the conclusion stating:</p>
<div class="w3-code notranslate">
  <p>The sample data <strong>supports</strong> the claim that "less than 45&#37; of Nobel Prize winners were born in the US" at a <strong>1&#37; significance level</strong>.</p>
</div>
...
<p>If the P-value is <stronger>smaller</stronger> than the significance level (\(\alpha\)), we <strong>reject</strong> the null hypothesis (\(H_{0}\)).</p>
<p>The test statistic was found to be \( \approx \underline{-2.543} \)</p>
...
<p>Because this is a <strong>left</strong> tailed test, we need to find the P-value of a Z-value <strong>smaller</strong> than -2.543.</p>
<p>We can find the P-value using a <a href="statistics_z_table.php">Z-table</a>, or with a programming language function:</p>
<div class="w3-example">
  <h3>Example</h3>
    <p>With Python use the Scipy Stats library <code class="w3-codespan">norm.cdf()</code> function find the P-value of a Z-value smaller than -2.543:</p>
  <div class="w3-code notranslate pythonHigh">
    import scipy.stats as stats
    <br>
    print(stats.norm.cdf(-2.543))
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_stat_python_p_value3">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
  <h3>Example</h3>
    <p>With R use the built-in <code class="w3-codespan">pnorm()</code> function find the P-value of a Z-value smaller than -2.543:</p>
  <div class="w3-code notranslate pythonHigh">
    pnorm(-2.543)
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_stat_r_p_value3">Try it Yourself &raquo;</a>
</div>
<p>Using either method we can find that the P-value is \(\approx \underline{0.0055}\)</p>
<p>This tells us that the significance level (\(\alpha\)) would need to be bigger than 0.0055, or 0.55&#37;, to <strong>reject</strong> the null hypothesis.</p>
<p>Here is an illustration of this test in a graph:</p>
<p><img src="img_p_value_left_prop.svg"></p>
...
<p>And we can summarize the conclusion stating:</p>
<div class="w3-code notranslate">
  <p>The sample data <strong>supports</strong>  the claim that "less than 45&#37; of Nobel Prize winners were born in the US" at a <strong>10&#37;, 5&#37;, and 1&#37; significance level</strong>.</p>
</div>
...
<div class="w3-example">
  <h3>Example</h3>
    <p>With Python use the scipy and math libraries to calculate the P-value for a left tailed hypothesis test for a proportion.</p>
    <p>Here, the sample size is 40, the occurrences are 10, and the test is for a proportion smaller than 0.45.</p>
  <div class="w3-code notranslate pythonHigh">
    import scipy.stats as stats
    <br>
    import math
  ...
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_stat_python_prop_test2">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
  <h3>Example</h3>
    ...
    <p>Here, the sample size is 40, the occurrences are 10, and the test is for a proportion bigger than 0.45.</p>
  <div class="w3-code notranslate pythonHigh">
    # Specify the sample occurrences (x), the sample size (n), and the null-hypothesis claim (p)
    <br>
    x <- 10
  ...
  <a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_stat_r_prop_test2">Try it Yourself &raquo;</a>
</div>
<div class="w3-panel ws-note">
