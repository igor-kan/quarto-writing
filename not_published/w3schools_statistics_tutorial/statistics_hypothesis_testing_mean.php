<!DOCTYPE html>
<html lang="en-US">
<head><title>Statistics - Hypothesis Testing a Mean</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Statistics - Hypothesis Testing a Mean</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="statistics_hypothesis_testing_proportion.php">&#10094; Previous</a>
...
<div class="w3-code notranslate">
  <p>"The average age of Nobel Prize winners when they received the prize is <strong>more</strong> than 55"</p>
</div>
...
<div class="w3-code notranslate">
  <p><strong>Null hypothesis</strong>: The average age was 55.</p>
...
<p>In our example:</p>
<div class="w3-code notranslate">
  <p>The claimed (\(H_{0}\)) population mean (\(\mu\)) was \( 55 \)</p>
...
<div class="w3-example">
  ...
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_stat_python_mean_test_statistic">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
  <h3>Example</h3>
  ...
  <a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_stat_r_mean_test_statistic">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>5. Concluding</h2>
...
<p>Because the claim is that the population mean is <strong>more</strong> than 55, the rejection region is in the right tail:</p>
...
<p>Choosing a significance level (\(\alpha\)) of 0.01, or 1&#37;, we can find the critical T-value from a <a href="statistics_t_table.php">T-table</a>, or with a programming language function:</p>
<div class="w3-example">
  <h3>Example</h3>
  <p>With Python use the Scipy Stats library <code class="w3-codespan">t.ppf()</code> function find the T-Value for an \(\alpha\) = 0.01 at 29 degrees of freedom (df).</p>
  <div class="w3-code notranslate pythonHigh">
    import scipy.stats as stats
    <br>
    print(stats.t.ppf(1-0.01, 29))
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_stat_python_t_score2">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
  <h3>Example</h3>
  <p>With R use the built-in <code class="w3-codespan">qt()</code> function to find the t-value for an \(\alpha\) = 0.01 at 29 degrees of freedom (df).</p>
  <div class="w3-code notranslate pythonHigh">
    qt(1-0.01, 29)
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_stat_r_t_score2">Try it Yourself &raquo;</a>
</div>
<p>Using either method we can find that the critical T-Value is \(\approx \underline{2.462}\)</p>
...
<p>Here, the test statistic (TS) was \(\approx \underline{2.889}\) and the critical value was \(\approx \underline{2.462}\)</p>
<p>Here is an illustration of this test in a graph:</p>
<p><img src="img_critical_value_right_mean2.svg" alt="Student's T-Distribution with a right tail area (rejection region) equal to 0.01, a critical value of 2.462, and a test statistic of 2.889"></p>
<p>Since the test statistic was <strong>bigger</strong> than the critical value we <strong>reject</strong> the null hypothesis.</p>
<p>This means that the sample data supports the alternative hypothesis.</p>
<p>And we can summarize the conclusion stating:</p>
<div class="w3-code notranslate">
  <p>The sample data <strong>supports</strong> the claim that "The average age of Nobel Prize winners when they received the prize is more than 55" at a <strong>1&#37; significance level</strong>.</p>
</div>
...
<p>The test statistic was found to be \( \approx \underline{2.889} \)</p>
...
<p>Because this is a <strong>right</strong> tailed test, we need to find the P-value of a t-value <strong>bigger</strong> than 2.889.</p><p>The student's t-distribution is adjusted according to degrees of freedom (df), which is the sample size \((30) - 1 = \underline{29}\)</p>
<p>We can find the P-value using a <a href="statistics_t_table.php">T-table</a>, or with a programming language function:</p>
<div class="w3-example">
  <h3>Example</h3>
    <p>With Python use the Scipy Stats library <code class="w3-codespan">t.cdf()</code> function find the P-value of a T-value bigger than 2.889 at 29 degrees of freedom (df):</p>
  <div class="w3-code notranslate pythonHigh">
    import scipy.stats as stats
    <br>
...
<div class="w3-example">
  <h3>Example</h3>
    <p>With R use the built-in <code class="w3-codespan">pt()</code> function find the P-value of a T-Value bigger than 2.889 at 29 degrees of freedom (df):</p>
  <div class="w3-code notranslate pythonHigh">
    1-pt(2.889, 29)
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_stat_r_p_value">Try it Yourself &raquo;</a>
</div>
<p>Using either method we can find that the P-value is \(\approx \underline{0.0036}\)</p>
<p>This tells us that the significance level (\(\alpha\)) would need to be bigger than 0.0036, or 0.36&#37;, to <strong>reject</strong> the null hypothesis.</p>
<p>Here is an illustration of this test in a graph:</p>
<p><img src="img_p_value_right_mean.svg"></p>
...
<p>And we can summarize the conclusion stating:</p>
<div class="w3-code notranslate">
  <p>The sample data <strong>supports</strong> the claim that "The average age of Nobel Prize winners when they received the prize is more than 55" at a <strong>10&#37;, 5&#37;, or 1&#37; significance level</strong>.</p>
</div>
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> An outcome of an hypothesis test that rejects the null hypothesis with a p-value of 0.36&#37; means:</p>
  <p>For this p-value, we only expect to reject a true null hypothesis 36 out of 10000 times.</p>
</div>
<hr>
...
<div class="w3-example">
  <h3>Example</h3>
    <p>With Python use the scipy and math libraries to calculate the P-value for a right tailed hypothesis test for a mean.</p>
    <p>Here, the sample size is 30, the sample mean is 62.1, the sample standard deviation is 13.46, and the test is for a mean bigger than 55.</p>
  <div class="w3-code notranslate pythonHigh">
    import scipy.stats as stats
    <br>
    import math
  ...
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_stat_python_mean_test">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
  <h3>Example</h3>
    <p>With R use built-in math and statistics functions find the P-value for a right tailed hypothesis test for a mean.</p>
    <p>Here, the sample size is 30, the sample mean is 62.1, the sample standard deviation is 13.46, and the test is for a mean bigger than 55.</p>
  <div class="w3-code notranslate pythonHigh">
    # Specify the sample mean (x_bar), the sample standard deviation (s), the mean claimed in the null-hypothesis (mu_null), and the sample size (n)
    <br>
  ...
  <a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_stat_r_mean_test">Try it Yourself &raquo;</a>
</div>
<hr>
...
<ul>
  <li><a href="statistics_hypothesis_testing_mean_left.php">Left-Tailed Test</a></li>
