<!DOCTYPE html>
<html lang="en-US">
<head><title>Statistics - Interquartile Range</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Statistics - Interquartile Range</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="statistics_quartiles_and_percentiles.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="statistics_standard_deviation.php">Next &#10095;</a>
</div>
<hr>
<p class="intro">Interquartile range is a measure of variation, which describes how spread out the data is.</p>
<hr>
<h2>Interquartile Range</h2>
<p>Interquartile range is the difference between the first and third <a href="statistics_quartiles_and_percentiles.php">quartiles</a> (Q<sub>1</sub> and Q<sub>3</sub>).</p>
<p>The 'middle half' of the data is between the first and third quartile.</p>
<p>The first quartile is the value in the data that separates the bottom 25&#37; of values from the top 75&#37;.</p>
<p>The third quartile is the value in the data that separates the bottom 75&#37; of the values from the top 25&#37;</p>
...
<h2>Calculating the Interquartile Range with Programming</h2>
<p>The interquartile range can easily be found with many programming languages.</p>
...
<div class="w3-example">
  <h3>Example</h3>
  <div>
    <p>With Python use the SciPy library <code class="w3-codespan">iqr()</code> method to find the interquartile range of the values 13, 21, 21, 40, 42, 48, 55, 72:</p>
    ...
    <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_stat_python_iqr">Try it Yourself &raquo;</a>
  </div>
</div>
<div class="w3-example">
  <h3>Example</h3>
  <div>
    <p>Use the R <code class="w3-codespan">IQR()</code> function to find the interquartile range of the values 13, 21, 21, 40, 42, 48, 55, 72:</p>
    <div class="w3-code notranslate pythonHigh">
    ...
    <a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryr.asp?filename=demo_stat_r_iqr">Try it Yourself &raquo;</a>
  </div>
</div>
