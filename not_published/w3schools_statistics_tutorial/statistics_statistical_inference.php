<!DOCTYPE html>
<html lang="en-US">
<head><title>Statistics - Statistical Inference</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Statistics - Statistical Inference</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="statistics_standard_deviation.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="statistics_normal_distribution.php">Next &#10095;</a>
</div>
<hr>
<h2>Statistical Inference</h2>
<p>Using data analysis and statistics to make conclusions about a <a href="statistics_populations_and_samples.php">population</a> is called statistical inference.</p>
<p>The main types of statistical inference are:</p>
<ul>
  <li>Estimation</li>
...
<hr>
<h2>Estimation</h2>
<p>Statistics from a sample are used to estimate population <a href="statistics_parameters_and_statistics.php">parameters</a>.</p>
<p>The most likely value is called a <strong>point estimate</strong>.</p>
<p>There is <strong>always</strong> uncertainty when estimating.</p>
<p>The uncertainty is often expressed as <strong>confidence intervals</strong> defined by a likely lowest and highest value for the parameter.</p>
<p>An example could be a confidence interval for the number of bicycles a Dutch person owns:</p>
<div class="w3-code notranslate"> 
  <p>"The average number of bikes a Dutch person owns is between 3.5 and 6."</p>
</div>
<hr>
<h2>Hypothesis Testing</h2>
<p><strong>Hypothesis testing</strong> is a method to check if a claim about a population is true. More precisely, it checks how likely it is that a hypothesis is true is based on the sample data.</p>
<p>There are different types of hypothesis testing.</p>
<p>The steps of the test depends on:</p>
  <ul>
    <li>Type of data (categorical or numerical)</li>
    <li>If you are looking at:
      <ul>
        <li>A single group</li>
        <li>Comparing one group to another</li>
        <li>Comparing the same group before and after a change</li>
      </ul>
    </li>  
  </ul>
  <p>Some examples of claims or questions that can be checked with hypothesis testing:</p>
<div class="w3-code notranslate"> 
  <ul>
...
<p>Statistical inference methods rely on probability calculation and probability distributions.</p>
<p>You will learn about the most important probability distributions in the next pages.</p>
