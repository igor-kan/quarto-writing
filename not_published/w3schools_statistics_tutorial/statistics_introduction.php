<!DOCTYPE html>
<html lang="en-US">
<head><title>Statistics Introduction</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<hr>
<p class="intro">Statistics gives us methods of gaining knowledge from data.</p>
<hr>
<h2>What is Statistics Used for?</h2>
<p>Statistics is used in all kinds of science and business applications.</p>
<p>Statistics gives us more accurate knowledge which helps us make better decisions.</p>
<p>Statistics can focus on making <strong>predictions</strong> about what will happen in the future. It can also focus on <strong>explaining</strong> how different things are connected.</p>
<div class="w3-panel ws-info">
  <p><strong>Note:</strong> Good statistical explanations are also useful for predictions.</p>
</div>
<hr>
<h2>Typical Steps of Statistical Methods</h2>
The typical steps are:
<ul>
  <li>Gathering data</li>
  <li>Describing and visualizing data</li>
  <li>Making conclusions</li>
</ul>
<p>It is important to keep all three steps in mind for any questions we want more knowledge about.</p>
<p>Knowing which types of data are available can tell you what kinds of questions you can answer with statistical methods.</p>
<p>Knowing which questions you want to answer can help guide what sort of data you need. A lot of data might be available, and knowing what to focus on is important.</p>
<hr>
<h2>How is Statistics Used?</h2>
<p>Statistics can be used to explain things in a precise way. You can use it to understand and make conclusions about the group that you want to know more about. This group is called the <strong>population</strong>.</p>
<p>A population could be many different kinds of groups. It could be:</p>
<ul>
  <li>All of the people in a country</li>
  <li>All the businesses in an industry</li>
  <li>All the customers of a business</li>
  <li>All people that play football who are older than 45</li>
</ul>
<p>and so on - it just depends on what you want to know about.</p>
<p>Gathering data about the population will give you a <strong>sample</strong>. This is a part of the whole population. Statistical methods are then used on that sample.</p>
<p>The results of the statistical methods from the sample is used to make <strong>conclusions</strong> about the population.</p>
<div class="w3-panel ws-note">
<p><strong>Note:</strong> The word 'statistic' can also refer to specific bits of knowledge; like the average value of something.</p>
</div>
<hr>
...
<h2>Important Concepts in Statistics</h2>
<ul>
...
<p>We will cover these topics step by step in this tutorial.</p>
<hr>
<h2>Statistics and Programming</h2>
<p>Statistical analysis is typically done with computers. Small amounts of data can 
be analyzed well, 
without computers.</p>
<p>Historically, all data analysis was performed manually. It was time-consuming and prone to errors.</p>
<p>Nowadays, programming and software is typically used for data analysis.</p>
<p>In this course, we will show examples of code to do statistics with the programming languages Python and R.</p>
<br>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="index.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="statistics_gathering_data.php">Next &#10095;</a>
