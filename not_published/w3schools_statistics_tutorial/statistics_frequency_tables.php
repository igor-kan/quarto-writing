<!DOCTYPE html>
<html lang="en-US">
<head><title>Statistics - Frequency Tables</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Statistics - Frequency Tables</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="statistics_descriptive_statistics.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="statistics_histograms.php">Next &#10095;</a>
</div>
<hr>
<p class="intro">A frequency table is a way to present data. The data are counted and ordered to summarize larger sets of data.</p>
<p class="intro">With a frequency table you can analyze the way the data is distributed across different values.</p>
<hr>
<h2>Frequency Tables</h2>
<p>Frequency means the number of times a value appears in the data. A table can quickly show us how many times each value appears.</p>
<p>If the data has many different values, it is easier to use intervals of values to present them in a table.</p>
<p>Here is the age of the 934 Nobel Prize winners up until the year 2020. In the table each row is an age interval of 10 years.</p>
...
<p>We can see that there is only one winner from ages 10 to 19. And that the highest number of winners are in their 60s.</p>
<div class="w3-panel ws-info">
<p><strong>Note:</strong> The intervals for the values are also called 'bins'.</p>
</div>
<hr>
...
<p>Relative frequency means the number of times a value appears in the data compared to the total amount. A <strong>percentage</strong> is a relative frequency.</p>
<p>Here are the relative frequencies of ages of Noble Prize winners. Now, all the frequencies are divided by the total (934) to give percentages.</p>
<table class="ws-table-all notranslate">
  <tr>
    <th>Age Interval</th>
...
<hr>
<h2>Cumulative Frequency Tables</h2>
<p>Cumulative frequency counts up to a particular value.</p>
<p>Here are the cumulative frequencies of ages of Nobel Prize winners. Now, we can see how many winners have been younger than a certain age.</p>
<table class="ws-table-all notranslate">
  <tr>
    <th>Age</th>
...
<p>Cumulative frequency tables can also be made with relative frequencies (percentages).</p><div class="w3-clear nextprev">
<br>
  <a class="w3-left w3-btn" href="statistics_descriptive_statistics.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="statistics_histograms.php">Next &#10095;</a>
</div>
