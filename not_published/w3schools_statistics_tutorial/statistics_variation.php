<!DOCTYPE html>
<html lang="en-US">
<head><title>Statistics - Variation</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Statistics - Variation</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="statistics_mode.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="statistics_range.php">Next &#10095;</a>
</div>
<hr>
<p class="intro">Variation is a measure of how spread out the data is around the 
center of the data.</p>
<hr>
<h2>The Variation of the Data</h2>
<p>Measures of variation are statistics of how far away the values in the observations (data points) are from each other.</p>
<p>There are different measures of variation. The most commonly used are:</p>
<ul>
  <li><a href="statistics_range.php">Range</a></li>
  <li><a href="statistics_quartiles_and_percentiles.php">Quartiles and Percentiles</a></li>
  <li><a href="statistics_interquartile_range.php">Interquartile Range</a></li>
  <li><a href="statistics_standard_deviation.php">Standard Deviation</a></li>
</ul>
<p>Measures of variation combined with an average (measure of center) gives a good picture of the distribution of the data.</p>
<div class="ws-note">
  <p><strong>Note:</strong> These measures of variation can only be calculated for numerical data.</p>
</div>
<hr>
<h2>Range</h2>
<p>The range is the difference between the smallest and the largest value of the data.</p>
<p>Range is the simplest measure of variation.</p>
<p>Here is a histogram of the age of all 934 Nobel Prize winners up to the year 2020, showing the <strong>range</strong>:</p>
<p><img src="img_histogram_range.svg" style="width:100%; max-width:1000px; height:auto" alt="Histogram of the age of Nobel Prize winners with range shown between the minimum and maximum values."></p>
<p>The youngest winner was 17 years and the oldest was 97 years. The range of ages for Nobel Prize winners is then 80 years.</p>
<hr>
<h2>Quartiles and Percentiles</h2>
<p>Quartiles and percentiles are ways of separating equal numbers of values in the data into parts.</p>
<p><strong>Quartiles</strong> are values that separate the data into four equal parts.</p>
<p><strong>Percentiles</strong> are values that separate the data into 100 equal parts.</p>
<p>Here is a histogram of the age of all 934 Nobel Prize winners up to the year 2020, showing the <strong>quartiles</strong>:</p>
<p><img src="img_histogram_quartiles.svg" style="width:100%; max-width:1000px; height:auto" alt="Histogram of the age of Nobel Prize winners with quartiles shown."></p>
<p>The quartiles (Q<sub>0</sub>,Q<sub>1</sub>,Q<sub>2</sub>,Q<sub>3</sub>,Q<sub>4</sub>) are the values that separate each quarter.</p>
<p>Between Q<sub>0</sub> and Q<sub>1</sub> are the 25&#37; lowest values in the data. Between Q<sub>1</sub> and Q<sub>2</sub> are the next 25%. And so on.</p>
<ul>
  <li>Q<sub>0</sub> is the smallest value in the data.</li>
  <li>Q<sub>2</sub> is the middle value (median).</li>
  <li>Q<sub>4</sub> is the largest value in the data.</li>
</ul>
<hr>
...
<p>Interquartile range is the difference between the first and third quartiles (Q<sub>1</sub> and Q<sub>3</sub>).</p>
<p>The 'middle half' of the data is between the first and third quartile.</p>
<p>Here is a histogram of the age of all 934 Nobel Prize winners up to the year 2020, showing the <strong>interquartile range (IQR)</strong>:</p>
<p><img src="img_histogram_iqr.svg" style="width:100%; max-width:1000px; height:auto" alt="Histogram of the age of Nobel Prize winners with interquartile range shown."></p>
<p>Here, the middle half of is between 51 and 69 years. The interquartile range for Nobel Prize winners is then 18 years.</p>
<hr>
<h2>Standard Deviation</h2>
<p>Standard deviation is the most used measure of variation.</p>
...
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> Values within one standard deviation (&sigma;) are considered to be typical.</p>
  <p>Values outside three standard deviations are considered to be <strong>outliers</strong>.</p>
</div>
<br>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="statistics_mode.php">&#10094; Previous</a>
