<!DOCTYPE html>
<html lang="en-US">
<head><title>Statistics - Standard Deviation</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="statistics_interquartile_range.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="statistics_statistical_inference.php">Next &#10095;</a>
</div>
<hr>
<p class="intro">Standard deviation is the most commonly used measure of variation, which describes how spread out the data is.</p>
<hr>
<h2>Standard Deviation</h2>
<p>Standard deviation (&sigma;) measures how far a 'typical' observation is from the average of the data (&mu;).</p>
<p>Standard deviation is important for many statistical methods.</p>
<p>Here is a histogram of the age of all 934 Nobel Prize winners up to the year 2020, showing <strong>standard deviations</strong>:</p>
<p><img src="img_histogram_std.svg" style="width:100%; max-width:1000px; height:auto" alt="Histogram of the age of Nobel Prize winners with interquartile range shown."></p>
<p>Each dotted line in the histogram shows a shift of one extra standard deviation.</p>
<p>If the data is <strong>normally distributed:</strong></p>
<ul>
...
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> A <strong>normal</strong> distribution has a "bell" shape and spreads out equally on both sides.</p>
</div>
<hr>
<h2>Calculating the Standard Deviation</h2>
<p>You can calculate the standard deviation for both <a href="/statistics_populations_and_samples.php">the <strong>population</strong> and the <strong>sample</strong></a>.</p>
<p>The formulas are <strong>almost</strong> the same and uses different symbols to refer to the standard deviation (\(\sigma\)) and <strong>sample</strong> standard deviation (\(s\)).</p>
<p>Calculating the <strong> standard deviation</strong> (\(\sigma\)) is done with this formula:</p>
<p>\(\displaystyle  \sigma = \sqrt{\frac{\sum (x_{i}-\mu)^2}{n}}\)</p>
<p>Calculating the <strong>sample standard deviation</strong> (\(s\)) is done with this formula:</p>
<p>\(\displaystyle s = \sqrt{\frac{\sum (x_{i}-\bar{x})^2}{n-1}}\)</p>
<p>\(n\) is the total number of observations.</p>
<p>\(\sum \) is the symbol for adding together a list of numbers.</p>
<p>\(x_{i}\) is the list of values in the data: \(x_{1}, x_{2}, x_{3}, \ldots \)</p>
<p>\(\mu\) is the population mean and \(\bar{x}\) is the sample mean (average value).</p>
<p>\( (x_{i} - \mu ) \) and \( (x_{i} - \bar{x} ) \) are the differences between the values of the observations (\(x_{i}\)) and the mean.</p>
<p>Each difference is squared and added together.</p>
<p>Then the sum is divided by \(n\) or (\( n - 1 \)) and then we find the square root.</p>
<p>Using these 4 example values for calculating the <strong>population standard deviation</strong>:</p>
<div class="w3-code notranslate">
  <p>4, 11, 7, 14</p>
</div>
<p>We must first find the <a href="statistics_mean.php">mean</a>:</p>
<p>\(\displaystyle \mu = \frac{\sum x_{i}}{n} = \frac{4 + 11 + 7 + 14}{4} = \frac{36}{4} = \underline{9} \)</p>
<p>Then we find the difference between each value and the mean \( (x_{i}- \mu)\):</p>
<ul>
  <li>\( 4-9 \; \:= -5 \)</li>
  <li>\( 11-9 = 2 \)</li>
  <li>\( 7-9 \; \:= -2 \)</li>
...
<p>Each value is then squared, or multiplied with itself \( ( x_{i}- \mu )^2\):</p>
<ul>
  <li>\( (-5)^2 = (-5)(-5) = 25 \)</li>
  <li>\( 2^2 \; \; \; \; \; \, = 2*2 \; \; \; \; \; \; \; \: = 4 \)</li>
  <li>\( (-2)^2 = (-2)(-2) = 4 \)</li>
...
<p>All of the squared differences are then added together \( \sum (x_{i} -\mu )^2\):</p>
<p>\( 25 + 4 + 4 + 25 = 58\)</p>
<p>Then the sum is divided by the total number of observations, \( n \):</p>
<p>\( \displaystyle \frac{58}{4} = 14.5\)</p>
<p>Finally, we take the square root of this number:
<p>\( \sqrt{14.5} \approx \underline{3.81} \)</p>
<p>So, the standard deviation of the example values is roughly: \(3.81 \)</p>
<hr>
<div id="midcontentadcontainer" style="overflow:auto;text-align:center">
<!-- MidContent -->
<!-- <p class="adtext">Advertisement</p> -->
</div><hr>
<h2>Calculating the Standard Deviation with Programming</h2>
<p>The standard deviation can easily be calculated with many programming languages.</p>
<p>Using software and programming to calculate statistics is more common for bigger sets of data, as calculating by hand becomes difficult.</p>
<h3>Population Standard Deviation</h3>
<div class="w3-example">
  <h3>Example</h3>
  <div>
    <p>With Python use the NumPy library <code class="w3-codespan">std()</code> method to find the standard deviation of the values 4,11,7,14:</p>
    ...
    <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_stat_numpy_std">Try it Yourself &raquo;</a>
  </div>
</div>
<div class="w3-example">
  <h3>Example</h3>
  <div>
    <p>Use an R formula to find the standard deviation of the values 4,11,7,14:</p>
    <div class="w3-code notranslate pythonHigh">
      values &lt;- c(4,7,11,14)
      <br>
      <br>
    ...
    <a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryr.asp?filename=demo_stat_r_std">Try it Yourself &raquo;</a>
  </div>
</div>
...
<div class="w3-example">
  <h3>Example</h3>
  <div>
    <p>With Python use the NumPy library <code class="w3-codespan">std()</code> method to find the <strong>sample</strong> standard deviation of the values 4,11,7,14:</p>
    <div class="w3-code notranslate pythonHigh">
      import numpy
      <br>
      <br>
    ...
    <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_stat_numpy_sstd">Try it Yourself &raquo;</a>
  </div>
</div>
<div class="w3-example">
  <h3>Example</h3>
  <div>
    <p>Use the R <code class="w3-codespan">sd()</code> function to find the <strong>sample</strong> standard deviation of the values 4,11,7,14:</p>
    <div class="w3-code notranslate pythonHigh">
      values &lt;- c(4,7,11,14)
      <br>
      <br>
    ...
    <a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryr.asp?filename=demo_stat_r_sstd">Try it Yourself &raquo;</a>
  </div>
</div>
<hr>
<h2>Statistics Symbol Reference</h2>
...
<tr>
  <td>\( \sigma \)</td>
  <td>Population standard deviation. Pronounced 'sigma'.</td>
</tr>
<tr>
  <td>\( s \)</td>
...
<tr>
    <td>\( \mu \)</td>
    <td>The population mean. Pronounced 'mu'.</td>
</tr>
<tr>
    <td>\( \bar{x} \)</td>
    <td>The sample mean. Pronounced 'x-bar'.</td>
</tr>
<tr>
    <td>\( \sum \)</td>
    <td>The summation operator, 'capital sigma'.</td>
</tr>
<tr>
    <td>\( x \)</td>
    <td>The variable 'x' we are calculating the average for.</td>
</tr>
<tr>
    <td>\( i \)</td>
    <td>The index 'i' of the variable 'x'. This identifies each observation for a variable.</td>
</tr>
<tr>
    <td>\( n \)</td>
    <td>The number of observations.</td>
</tr>
</table>
<br>
<div class="w3-clear nextprev">
