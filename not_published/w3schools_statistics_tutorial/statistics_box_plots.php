<!DOCTYPE html>
<html lang="en-US">
<head><title>Statistics - Box Plots</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Statistics - Box Plots</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="statistics_pie_charts.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="statistics_average.php">Next &#10095;</a>
</div>
<hr>
<p class="intro">A box plot is a graph used to show key features of quantitative data.</p>
<hr>
<h2>Box Plots</h2>
<p>A box plot is a good way to show many important features of quantitative (numerical) data.</p>
<p>It shows the median of the data. This is the middle value of the data and one type of an average value.</p>
<p>It also shows the range and the quartiles of the data. This tells us something about how spread out the data is.</p>
<p>Here is a box plot of the age of all the Nobel Prize winners up to the year 2020:</p>
<p><img src="img_boxplot.svg" style="width:100%; max-width:1000px; height:auto" alt="Box plot of the age of Nobel Prize winners"></p>
<p>The <strong>median</strong> is the red line through the middle of the 'box'. We can see that this is just above the number 60 on the number line below. So the middle value of age is 60 years.</p>
<p>The left side of the box is the 1st <strong>quartile</strong>. This is the value that separates the first <strong>quarter</strong>, or 25% of the data, from the rest. Here, this is 51 years.</p>
<p>The right side of the box is the 3rd <strong>quartile</strong>. This is the value that separates the first three <strong>quarters</strong>, or 75% of the data, from the rest. Here, this is 69 years.</p>
<p>The distance between the sides of the box is called the <strong>inter-quartile range (IQR)</strong>. This tells us where the 'middle half' of the values are. Here, half of the winners were between 51 and 69 years.</p>
<p>The ends of the lines from the box at the left and the right are the minimum and maximum values in the data. The distance between these is called the <strong>range</strong>.</p>
<p>The youngest winner was 17 years old, and the oldest was 97 years old. So the range of the age of winners was 80 years.</p>
<div class="w3-panel ws-note">
<p><strong>Note:</strong> Box plots are also called 'box and whiskers plots'.</p>
</div>
