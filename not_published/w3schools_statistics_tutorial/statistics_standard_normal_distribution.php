<!DOCTYPE html>
<html lang="en-US">
<head><title>Statistics - Standard Normal Distribution</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Statistics - Standard Normal Distribution</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="statistics_normal_distribution.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="statistics_students_t_distribution.php">Next &#10095;</a>
</div>
<hr>
<p class="intro">The standard normal distribution is a <a href="statistics_normal_distribution.php">normal distribution</a> where the mean is 0 and the standard deviation is 1.</p>
<hr>
<h2>Standard Normal Distribution</h2>
<p>Normally distributed data can be transformed into a standard normal distribution.</p>
<p>Standardizing normally distributed data makes it easier to compare different sets of data.</p>
<p>The standard normal distribution is used for:</p>
<ul>
  <li>Calculating confidence intervals</li>
  <li>Hypothesis tests</li>
</ul>
<p>Here is a graph of the standard normal distribution with probability values (p-values) between the standard deviations:</p>
<p><img src="img_standard_normal.svg" style="width:100%; max-width:1000px; height:auto" alt="Standard Normal Distribution with indicated probabilities."></p>

<p>Standardizing makes it easier to calculate probabilities.</p>
<p>The functions for calculating probabilities are complex and difficult to calculate by hand.</p>
<p>Typically, probabilities are found by looking up tables of pre-calculated values, or by using software and programming.</p>
<p>The standard normal distribution is also called the 'Z-distribution' and the values are called 'Z-values' (or Z-scores).</p>
<hr>
<h2>Z-Values</h2>
<p>Z-values express how many standard deviations from the mean a value is.</p>
<p>The formula for calculating a Z-value is:</p>
<p>\(\displaystyle Z = \frac{x-\mu}{\sigma}\)</p>
<p>\(x\) is the value we are standardizing, \(\mu\) is the mean, and \(\sigma\) is the standard deviation.</p>
<p>For example, if we know that:</p>
<div class="w3-code notranslate">
  <p>The mean height of people in Germany is 170 cm (\(\mu\))</p>
  <p>The standard deviation of the height of people in Germany is 10 cm (\(\sigma\))</p>
  <p>Bob is 200 cm tall (\(x\))</p>
</div>
<p>Bob is 30 cm taller than the average person in Germany.</p>
<p>30 cm is 3 times 10 cm. So Bob's height is 3 standard deviations larger than mean height in Germany.</p>
<p>Using the formula:</p>
<p>\(\displaystyle Z = \frac{x-\mu}{\sigma} = \frac{200-170}{10} = \frac{30}{10} = \underline{3} \)</p>
<p>The Z-value of Bob's height (200 cm) is 3.</p>
<hr>
<div id="midcontentadcontainer" style="overflow:auto;text-align:center">
<!-- MidContent -->
<!-- <p class="adtext">Advertisement</p> -->
</div><hr>
<h2>Finding the P-value of a Z-Value</h2>
<p>Using a <a href="statistics_z_table.php">Z-table</a> or programming we can calculate how many people Germany are shorter than Bob and how many are taller.</p>
<div class="w3-example">
  <h3>Example</h3>
    <p>With Python use the Scipy Stats library <code class="w3-codespan">norm.cdf()</code> function find the probability of getting less than a Z-value of 3:</p>
  <div class="w3-code notranslate pythonHigh">
    import scipy.stats as stats
    <br>
    print(stats.norm.cdf(3))
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_stat_python_p_z">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
  <h3>Example</h3>
    <p>With R use the built-in <code class="w3-codespan">pnorm()</code> function find the probability of getting less than a Z-value of 3:</p>
  <div class="w3-code notranslate pythonHigh">
    pnorm(3)
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_stat_r_p_z">Try it Yourself &raquo;</a>
</div>

<p>Using either method we can find that the probability is \(\approx 0.9987\), or \( 99.87\% \)</p>
<p>Which means that Bob is taller than 99.87&#37; of the people in Germany.</p>
<p>Here is a graph of the standard normal distribution and a Z-value of 3 to visualize the probability:</p>
<p><img src="img_z_score3.svg" style="width:100%; max-width:1000px; height:auto" alt="Standard Normal Distribution with indicated probability for a z-value of 3."></p>
<p>These methods find the p-value up to the particular z-value we have.</p>
<p>To find the p-value above the z-value we can calculate 1 minus the probability.</p>
<p>So in Bob's example, we can calculate 1 - 0.9987 = 0.0013, or 0.13&#37;.</p>
<p>Which means that only 0.13&#37; of Germans are taller than Bob.</p>
<hr>
<h2>Finding the P-Value Between Z-Values</h2>
<p>If we instead want to know how many people are between 155 cm and 165 cm in Germany using the same example:</p>
<div class="w3-code notranslate">
  <p>The mean height of people in Germany is 170 cm (\(\mu\))</p>
  <p>The standard deviation of the height of people in Germany is 10 cm (\(\sigma\))</p>
</div>
<p>Now we need to calculate Z-values for both 155 cm and 165 cm:</p>
<br>
<p>\(\displaystyle Z = \frac{x-\mu}{\sigma} = \frac{155-170}{10} = \frac{-15}{10} = \underline{-1.5} \)</p>
<p>The Z-value of 155 cm is -1.5</p>
<br>
<p>\(\displaystyle Z = \frac{x-\mu}{\sigma} = \frac{165-170}{10} = \frac{-5}{10} = \underline{-0.5} \)</p>
<p>The Z-value of 165 cm is -0.5</p>
<br>
<p>Using the <a href="statistics_z_table.php">Z-table</a> or programming we can find that the p-value for the two z-values:</p>
<ul>
  <li>The probability of a z-value smaller than -0.5 (shorter than 165 cm) is 30.85&#37;</li>
  <li>The probability of a z-value smaller than -1.5 (shorter than 155 cm) is 6.68&#37;</li>
</ul>
<p>Subtract 6.68&#37; from 30.85&#37; to find the probability of getting a z-value between them.</p>
<p>30.85&#37; - 6.68&#37; = <u>24.17&#37;</u></p>
<p>Here is a set of graphs illustrating the process:</p>
<p><img src="img_z_scores.svg" style="width:60%; max-width:600px; height:auto" alt="Standard Normal Distribution with indicated probability for a z-value of 3."></p>
<hr>
<h2>Finding the Z-value of a P-Value</h2>
<p>You can also use p-values (probability) to find z-values.</p>
<p>For example:</p>
<div class="w3-code notranslate">
  <p>"How tall are you if you are taller than 90% of Germans?"</p>
</div>
<p>The p-value is 0.9, or 90&#37;.</p>
<p>Using a <a href="statistics_z_table.php">Z-table</a> or programming we can calculate the z-value:</p>
<div class="w3-example">
  <h3>Example</h3>
  <p>With Python use the Scipy Stats library <code class="w3-codespan">norm.ppf()</code> function find the z-value separating the top 10% from the bottom 90%:</p>
  <div class="w3-code notranslate pythonHigh">
    import scipy.stats as stats
    <br>
    print(stats.norm.ppf(0.9))
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_stat_python_z_p">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
  <h3>Example</h3>
  <p>With R use the built-in <code class="w3-codespan">qnorm()</code> function find the z-value separating the top 10% from the bottom 90%:</p>
  <div class="w3-code notranslate pythonHigh">
    qnorm(0.9)
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_stat_r_z_p">Try it Yourself &raquo;</a>
</div>

<p>Using either method we can find that the Z-value is \(\approx 1.281\)</p>
<p>Meaning that a person that is 1.281 standard deviations taller than the mean height of Germans is taller than 90&#37; of Germans.</p>
<p>We then use the formula to calculate the height (\(x\)) based on a mean (\(\mu\)) of 170 cm and standard deviation (\(\sigma\)) of 10 cm:</p>
<p>\(\displaystyle Z  = \frac{x-\mu}{\sigma} \)</p>
<p>\(\displaystyle  1.281 = \frac{x-170}{10} \)</p>
<p>\(1.281 \cdot 10 = x-170 \)</p>
<p>\(12.81 = x - 170 \)</p>
<p>\(12.81 + 170 = x \)</p>
<p>\(\underline{182.81} = x \)</p>
<p>So we can conclude that:</p>
<div class="w3-code notranslate">
  <p>"You have to be at <strong>least</strong> 182.81 cm tall to be taller than 90% of Germans"</p>
</div>
