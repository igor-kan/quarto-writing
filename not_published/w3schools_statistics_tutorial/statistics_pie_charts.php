<!DOCTYPE html>
<html lang="en-US">
<head><title>Statistics - Pie Charts</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Statistics - Pie Charts</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="statistics_bar_graphs.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="statistics_box_plots.php">Next &#10095;</a>
</div>
<hr>
<p class="intro">A pie chart visually presents qualitative data.</p>
<hr>
<h2>Pie Charts</h2>
<p>Pie graphs are used to show the distribution of qualitative (categorical) data.</p>
<p>It shows the <strong>frequency</strong> or <strong>relative frequency</strong> of values in the data.</p>
<p>Frequency is the amount of times that value appeared in the data. Relative frequency is the percentage of the total.</p>
<p>Each category is represented with a slice in the 'pie' (circle). The size of each slice represents the frequency of values from that category in the data.</p>
<p>Here is a pie chart of the number of people who have won a Nobel Prize in each category up to the year 2020:</p>
<p><img src="img_piechart.svg" style="width:100%; max-width:1000px; height:auto" alt="Pie chart of number people who have won Nobel Prizes in each category"></p>
<p>This pie chart shows relative frequency. So each slice is sized by the percentage for each category.</p>
<p>Some of the categories have existed longer than others. Multiple winners are also more common in some categories. So there is a different number of winners in each category.</p>
