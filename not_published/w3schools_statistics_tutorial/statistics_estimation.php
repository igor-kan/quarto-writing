<!DOCTYPE html>
<html lang="en-US">
<head><title>Statistics - Estimation</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Statistics - Estimation</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="statistics_students_t_distribution.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="statistics_estimation_proportion.php">Next &#10095;</a>
</div>
<hr>
<p class="intro">Point estimates are the most likely value for a <a href="statistics_parameters_and_statistics.php">population parameter</a>.</p>
<p class="intro">Confidence intervals express the uncertainty of an estimated population parameter.</p>
<hr>
<h2>The Point Estimate</h2>
<p>A point estimate is calculated from a <a href="statistics_populations_and_samples.php">sample</a>.</p>
<p>The point estimate depends on the type of data:</p>
<ul>
  <li><strong>Categorical data</strong>: the number of occurrences divided by the sample size.</li>
  <li><strong>Numerical data</strong>: the <a href="statistics_mean.php">mean</a> (the average) of the sample.</li>
</ul>
<p>One example could be:</p>
<div class="w3-code notranslate">
  <p>The point estimate for the average height of people in Denmark is 180 cm.</p>
</div>
<p>Estimates are always <strong>uncertain</strong>. This uncertainty can be expressed with a <strong>confidence interval</strong>.</p>

<hr>
<h2>Confidence Intervals</h2>
<p>The confidence interval is defined by a <strong>lower bound</strong> and an <strong>upper bound</strong>.</p>
<p>This gives us a range of values that the true parameter is likely to be between.</p>
<p>For example that:</p>
<div class="w3-code notranslate">
  <p>The average height of people in Denmark is between 170 cm and 190 cm.</p>
</div>
<p>Here, 170 cm is the lower bound, and 190 cm is the upper bound.</p>
<p>The lower and upper bounds of a confidence interval is based on the <strong>confidence level</strong>.</p>
<hr>
<h2>The Confidence Level</h2>
<p>Confidence levels can be expressed as percentages or decimal numbers, and the most commonly used are:</p>
<ul>
  <li>90% (0.90)</li>
  <li>95% (0.95)</li>
  <li>99% (0.99)</li>
</ul>
<p>The higher the confidence level, the bigger the interval will be.</p>
<p>For example, the confidence intervals for the average height of people in Denmark might be:</p>
<div class="w3-code notranslate">
  <p>90% confidence level: between 175 cm and 185 cm.</p>
  <p>95% confidence level: between 170 cm and 190 cm.</p>
  <p>99% confidence level: between 160 cm and 200 cm.</p>
</div>
<p>We use this confidence level together with a probability distribution to decide how large the <strong>margin of error</strong> is.</p>
<hr>
...
<p>The margin of error is the distance between the point estimate and the lower and upper bounds.</p>
<p>The margin of error is based on the confidence level and the data we have from the sample.</p>
<p>For example, if the point estimate for the average height of people in 
Denmark is 180 cm:</p>
<div class="w3-code notranslate">
  <p>5 cm margin of error: between 175 cm and 185 cm.</p>
  <p>10 cm margin of error: between 170 cm and 190 cm.</p>
  <p>20 cm margin of error: between 160 cm and 200 cm.</p>
</div>
<hr>
<h2>Steps for Calculating the Confidence Interval</h2>
...
<p>The other conditions depends on what type of parameter you are calculate the confidence interval for.</p>
<p>Commonly  estimated parameters are:</p>
<ul>
