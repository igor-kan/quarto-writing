<!DOCTYPE html>
<html lang="en-US">
<head><title>Statistics - Describing Data</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Statistics - Describing Data</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="statistics_gathering_data.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="statistics_making_conclusions.php">Next &#10095;</a>
</div>
<hr>
<p class="intro">Describing data is typically the second step of statistical analysis after gathering data.</p>
<hr>
<h2>Descriptive Statistics</h2>
<p>The information (data) from your sample or population can be visualized with graphs or <strong>summarized</strong> by numbers. This will show key information in a simpler way than just looking at raw data. It can help us understand how the data is <strong>distributed</strong>.</p>
<p>Graphs can visually show the data distribution.</p>
<p>Examples of graphs include:</p>
<ul>
  <li><a href="statistics_histograms.php">Histograms</a></li>
  <li><a href="statistics_pie_charts.php">Pie charts</a></li>
  <li><a href="statistics_bar_graphs.php">Bar graphs</a></li>
  <li><a href="statistics_box_plots.php">Box plots</a></li>
</ul>
<p>Some graphs have a close connection to numerical summary statistics. Calculating those gives us the basis of these graphs.</p>
<p>For example, a box plot visually shows the <strong>quartiles</strong> of a data distribution.</p>
<p>Quartiles are the data split into four equal size parts, or quarters. A quartile is one type of summary statistics.</p>
<h3>Summary statistics</h3>
<p>Summary statistics take a large amount of information and sums it up in a few key values.</p>
<p>Numbers are calculated from the data which also describe the shape of the distributions. These are individual 'statistics'.</p>
<p>Some important examples are:</p>
<ul>
  <li><a href="statistics_average.php">Mean, median and mode</a></li>
  <li><a href="statistics_range.php">Range</a> and <a href="statistics_interquartile_range.php">interquartile range</a></li>
  <li><a href="statistics_quartiles_and_percentiles.php">Quartiles and percentiles</a></li>
  <li><a href="statistics_standard_deviation.php">Standard deviation and variance</a></li>
</ul>
<div class="w3-panel ws-info">
<p><strong>Note:</strong> Descriptive statistics is often presented as a part of statistical analysis.</p>
<p>Descriptive statistics is also useful for guiding further analysis, giving insight into the data, and finding what is worth investigating more closely.</p>
</div>
