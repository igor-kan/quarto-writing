<!DOCTYPE html>
<html lang="en-US">
<head><title>Statistics - Hypothesis Testing</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Statistics - Hypothesis Testing</h1>
...
<hr>
<p class="intro">Hypothesis testing is a formal way of checking if a hypothesis about a <a href="statistics_populations_and_samples.php">population</a> is true or not.</p>
<hr>
<h2>Hypothesis Testing</h2>
<p>A <strong>hypothesis</strong> is a claim about a population <a href="statistics_parameters_and_statistics.php">parameter</a>.</p>
<p>A <strong>hypothesis test</strong> is a formal procedure to check if a hypothesis is true or not.</p>
<p>Examples of claims that can be checked:</p>
<div class="w3-code notranslate">
  <p>The average height of people in Denmark is <strong>more</strong> than 170 cm.</p>
...
<hr>
<h2>The Null and Alternative Hypothesis</h2>
<p>Hypothesis testing is based on making two different claims about a population parameter.</p>
<p>The <strong>null</strong> hypothesis (\(H_{0} \)) and the <strong>alternative</strong> hypothesis (\(H_{1}\)) are the claims.</p>
<p>The two claims needs to be <strong>mutually exclusive</strong>, meaning only one of them can be true.</p>
<p>The alternative hypothesis is typically what we are trying to prove.</p>
<p>For example, we want to check the following claim:</p>
<div class="w3-code notranslate">
  <p>"The average height of people in Denmark is more than 170 cm."</p>
</div>
<p>In this case, the <strong>parameter</strong> is the average height of people in Denmark (\(\mu\)).</p>
<p>The null and alternative hypothesis would be:</p>
<div class="w3-code notranslate">
  <p><strong>Null hypothesis</strong>: The average height of people in Denmark <strong>is</strong> 170 cm.</p>
  <p><strong>Alternative hypothesis</strong>: The average height of people in Denmark is <strong>more</strong> than 170 cm.</p>
</div>
<p>The claims are often expressed with symbols like this:</p>
<div class="w3-code notranslate">
  <p>\(H_{0}\): \(\mu = 170 \: cm \)</p>
  <p>\(H_{1}\): \(\mu &gt; 170 \: cm \)</p>
</div>
...
<p>If the data does <strong>not</strong> support the alternative hypothesis, we <strong>keep</strong> the null hypothesis.</p>
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> The alternative hypothesis is also referred to as (\(H_{A} \)).</p>
</div><hr>
<h2>The Significance Level</h2>
<p>The significance level (\(\alpha\)) is the <strong>uncertainty</strong> we accept when rejecting the null hypothesis in the hypothesis test.</p>
...
<p>The test statistic is a <strong>standardized</strong> value calculated from the sample.</p>
<p>Standardization means converting a statistic to a well known <strong>probability distribution</strong>.</p>
<p>The type of probability distribution depends on the type of test.</p>
<p>Common examples are:</p>
<ul>
  <li><a href="statistics_standard_normal_distribution.php">Standard Normal Distribution</a> (Z): used for <a href="statistics_hypothesis_testing_proportion.php">Testing Population Proportions</a></li>
  <li><a href="statistics_students_t_distribution.php">Student's T-Distribution</a> (T): used for <a href="statistics_hypothesis_testing_mean.php">Testing Population Means</a></li>
</ul>
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> You will learn how to calculate the test statistic for each type of test in the following chapters.</p>
</div>
<hr>
<h2>The Critical Value and P-Value Approach</h2>
<p>There are two main approaches used for hypothesis tests:</p>
<ul>
...
<p>The critical value approach checks if the test statistic is in the <strong>rejection region</strong>.</p>
<p>The rejection region is an area of probability in the tails of the distribution.</p>
<p>The size of the rejection region is decided by the significance level (\(\alpha\)).</p>
<p>The value that separates the rejection region from the rest is called the <strong>critical value</strong>.</p>
<p>Here is a graphical illustration:</p>
<p><img src="img_critical_value_right.svg" style="width:100%; max-width:1000px; height:auto" alt="Graph of T-Distribution for right-tailed test, rejection region (alpha), critical value, and test statistic in the rejection area."></p>
<p>If the test statistic is <strong>inside</strong> this rejection region, the null hypothesis is <strong>rejected</strong>.</p>
<p>For example, if the test statistic is 2.3 and the critical value is 2 for a significance level (\(\alpha = 0.05\)):</p>
<div class="w3-code notranslate">
  <p>We reject the null hypothesis (\(H_{0} \)) at 0.05 significance level (\(\alpha\))</p>
</div>
<h3>The P-Value Approach</h3>
<p>The p-value approach checks if the p-value of the test statistic is <strong>smaller</strong> than the significance level (\(\alpha\)).</p>
<p>The p-value of the test statistic is the area of probability in the tails of the distribution from the value of the test statistic.</p>
<p>Here is a graphical illustration:</p>
<p><img src="img_p_value_right.svg"  style="width:100%; max-width:1000px; height:auto" alt="Graphs of T-Distributions for right-tailed test with tail area (alpha), and tail area equal to p-value of test statistic."></p>
<p>If the p-value is <strong>smaller</strong> than the significance level, the null hypothesis is <strong>rejected</strong>.</p>
<p>The p-value directly tells us the <strong>lowest significance level</strong> where we can reject the null hypothesis.</p>
<p>For example, if the p-value is 0.03:</p>
<div class="w3-code notranslate">
  <p>We reject the null hypothesis (\(H_{0} \)) at a 0.05 significance level (\(\alpha\))</p>
  <p>We keep the null hypothesis (\(H_{0}\)) at a 0.01 significance level (\(\alpha\))</p>
</div>
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> The two approaches are only different in how they present the conclusion.</p>
</div>
<hr>
<h2>Steps for a Hypothesis Test</h2>
...
<p>One <strong>condition</strong> is that the sample is <a href="statistics_sample_types.php">randomly selected</a> from the population.</p>
<p>The other conditions depends on what type of parameter you are testing the hypothesis for.</p>
<p>Common parameters to test hypotheses are:</p>
<ul>
  <li>Proportions (for qualitative data)</li>
  <li>Mean values (for numerical data)</li>
</ul>
<p>You will learn the steps for both types in the following pages.</p>
<br>
<div class="w3-clear nextprev">
    <a class="w3-left w3-btn" href="statistics_estimation_mean.php">&#10094; Previous</a>
    <a class="w3-right w3-btn" href="statistics_hypothesis_testing_proportion.php">Next &#10095;</a>
