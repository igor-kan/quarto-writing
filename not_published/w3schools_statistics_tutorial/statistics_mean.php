<!DOCTYPE html>
<html lang="en-US">
<head><title>Statistics - Mean</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Statistics - Mean</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="statistics_average.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="statistics_median.php">Next &#10095;</a>
</div>
<hr>
<p class="intro">The mean is a type of average value, which describes where center of the data is located.</p>
<hr>
<h2>Mean</h2>
<p>The mean is usually referred to as 'the average'.</p>
<p>The mean is the sum of all the values in the data divided by the total number of values in the data.</p>
<p>The mean is calculated for numerical variables. A variable is something in the data that can vary, like:</p>
<ul>
  <li>Age</li>
  <li>Height</li>
  <li>Income</li>
...
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> There are are multiple types of mean values. The most common type of mean is the <strong>arithmetic</strong> mean.</p>
  <p>In this tutorial 'mean' refers to the arithmetic mean.</p>
</div>
<hr>
<h2>Calculating the Mean</h2>
<p>You can calculate the mean for both <a href="/statistics_populations_and_samples.php">the <strong>population</strong> and the <strong>sample</strong></a>.</p>
<p>The formulas are the same and uses different symbols to refer to the population mean (\(\mu\)) and sample mean (\(\bar{x}\)).</p>
<p>Calculating the <strong>population mean</strong> (\(\mu\)) is done with this formula:</p>
<p>\(\displaystyle  \mu = \frac{\sum x_{i}}{n}\)</p>
<p>Calculating the <strong>sample mean</strong> (\(\bar{x}\)) is done with this formula:</p>
<p>\(\displaystyle \bar{x} = \frac{\sum x_{i}}{n}\)</p>
<p>The bottom part of the fraction (\(n\)) is the total number of observations.</p>
...
<p>The top part of the fraction (\(\sum x_{i}\)) is the sum of \(x_{1}, x_{2}, x_{3}, \ldots \) added together.</p>
<p>So, if a sample has 4 observations with values: 4, 11, 7, 14 the calculation is:</p>
...
<h2>Calculation with Programming</h2>
<p>The mean can easily be calculated with many programming languages.</p>
...
<div class="w3-example">
  <h3>Example</h3>
  <div>
    <p>Use the R <code class="w3-codespan">mean()</code> function to find the mean of the values 4,11,7,14:</p>
    <div class="w3-code notranslate pythonHigh">
      values &lt;- c(4,7,11,14)
      <br>
      <br>
    ...
    <a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryr.asp?filename=demo_stat_r_mean">Try it Yourself &raquo;</a>
  </div>
</div>
<hr>
