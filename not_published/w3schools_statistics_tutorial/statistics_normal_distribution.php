<!DOCTYPE html>
<html lang="en-US">
<head><title>Statistics - Normal Distribution</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Statistics - Normal Distribution</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="statistics_statistical_inference.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="statistics_standard_normal_distribution.php">Next &#10095;</a>
</div>
<hr>
<p class="intro">The normal distribution is an important probability distribution used in 
statistics.</p>
<p class="intro">Many real world examples of data are normally distributed.</p>
<hr>
<h2>Normal Distribution</h2>
<p>The normal distribution is described by the <a href="statistics_mean.php">mean</a> (\(\mu\)) and the <a href="statistics_standard_deviation.php">standard deviation</a> (\(\sigma\)).</p>
<p>The normal distribution is often referred to as a 'bell curve' because of it's shape:</p>
<ul>
  <li>Most of the values are around the center (\(\mu\))</li>
  <li>The <a href="statistics_median.php">median</a> and mean are equal</li>
  <li>It has only one <a href="statistics_mode.php">mode</a></li>
  <li>It is symmetric, meaning it decreases the same amount on the left and the right of the 
  center </li>
</ul>
<p>The area under the curve of the normal distribution represents probabilities for the data.</p>
<p>The area under the whole curve is equal to 1, or 100&#37;</p>
<p>Here is a graph of a normal distribution with probabilities between standard deviations (\(\sigma\)):</p>
<p><img src="img_normal_distribution.svg" style="width:100%; max-width:1000px; height:auto" alt="Normal Distributions with indicated probabilities."></p>
<ul>
  <li>Roughly 68.3&#37; of the data is within 1 standard deviation of the average (from &mu;-1&sigma; to &mu;+1&sigma;) </li>
  <li>Roughly 95.5&#37; of the data is within 2 standard deviations of the average (from &mu;-2&sigma; to &mu;+2&sigma;) </li>
  <li>Roughly 99.7&#37; of the data is within 3 standard deviations of the average (from &mu;-3&sigma; to &mu;+3&sigma;) </li>
</ul>
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> Probabilities of the normal distribution can only be calculated for intervals (between two values).</p>
</div>
<hr>
<h2>Different Mean and Standard Deviations</h2>
<p>The mean describes where the center of the normal distribution is.</p>
<p>Here is a graph showing three different normal distributions with the <strong>same</strong> standard deviation but different means.</p>
<p><img src="img_norm_means.svg" style="width:100%; max-width:1000px; height:auto" alt="Normal Distributions with different means."></p>
<p>The standard deviation describes how spread out the normal distribution is.</p>
<p>Here is a graph showing three different normal distributions with the <strong>same</strong> mean but different standard deviations.</p>
<p><img src="img_norm_stds.svg" style="width:100%; max-width:1000px; height:auto" alt="Normal Distributions with different standard deviations."></p>
<p>The purple curve has the biggest standard deviation and the black curve has the smallest standard deviation.</p>
<p>The area under each of the curves is still 1, or 100&#37;.</p>
<hr>
<h2>A Real Data Example of Normally Distributed Data</h2>
<p>Real world data is often normally distributed.</p>
<p>Here is a histogram of the age of Nobel Prize winners when they won the prize:</p>
<p><img src="img_nobel_norm.svg" style="width:100%; max-width:1000px; height:auto" alt="Histogram of the age of Nobel Prize winners when they won the prize and normal distribution fitted to the data."></p>
<p>The normal distribution drawn on top of the histogram is based on the population mean (\(\mu\)) and standard deviation (\(\sigma\)) of the real data.</p>
<p>We can see that the histogram close to a normal distribution.</p>
<p>Examples of real world variables that can be normally distributed:</p>
<ul>
  <li>Test scores</li>
  <li>Height</li>
  <li>Birth weight</li>
...
<p>Probability distributions are functions that calculates the probabilities of the outcomes of random variables.</p>
<p>Typical examples of random variables are coin tosses and dice rolls.</p>
<p>Here is an graph showing the results of a growing number of coin tosses and the expected values of the results (heads or tails).</p>
<p>The expected values of the coin toss is the probability distribution of the coin toss.</p>
<p><img src="img_1_2dice_100f2.gif" style="width:100%; max-width:800px; height:auto" alt="Simulated coin tosses and expected values."></p>
<p>Notice how the result of random coin tosses gets closer to the expected values (50&#37;) as the number of tosses increases.</p>
<p>Similarly, here is a graph showing the results of a growing number of dice rolls and the expected values of the results (from 1 to 6).</p>
<p><img src="img_1_6dice_100f2.gif" style="width:100%; max-width:800px; height:auto" alt="Simulated dice rolls and expected values."></p>
<p>Notice again how the result of random dice rolls gets closer to the expected values (1/6, or 16.666&#37;) as the number of rolls increases.</p>
<p>When the random variable is a <strong>sum</strong> of dice rolls the results and expected values take a different shape.</p>
<p>The different shape comes from there being more ways of getting a sum of near the middle, than a small or large sum.</p>
<p><img src="img_2_6dice_100f2.gif" style="width:100%; max-width:800px; height:auto" alt="Simulated sum of two dice rolls and expected values."></p>
<p>As we keep increasing the number of dice for a sum the shape of the results and expected values look more and more like a normal distribution.</p>
<p><img src="img_3_6dice_100f2.gif" style="width:50%; max-width:600px; height:auto" alt="Simulated sum of 3 dice rolls and expected values."><img src="img_5_6dice_100f2.gif" style="width:50%; max-width:600px; height:auto" alt="Simulated sum of 5 dice rolls and expected values."></p>
<p>Many real world variables follow a similar pattern and naturally form normal distributions.</p>
<p>Normally distributed variables can be analyzed with well-known techniques.</p>
<p>You will learn about some of the most common and useful techniques in the following pages.</p>
<div class="w3-clear nextprev">
    <a class="w3-left w3-btn" href="statistics_statistical_inference.php">&#10094; Previous</a>
    <a class="w3-right w3-btn" href="statistics_standard_normal_distribution.php">Next &#10095;</a>
</div>
