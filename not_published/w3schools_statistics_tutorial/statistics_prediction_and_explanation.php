<!DOCTYPE html>
<html lang="en-US">
<head><title>Statistics - Prediction and Explanation</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Statistics - Prediction and Explanation</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="statistics_making_conclusions.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="statistics_populations_and_samples.php">Next &#10095;</a>
</div>
<hr>
<p class="intro">Some types of statistical methods are focused on predicting what will happen.</p> <p class="intro">Other types of statistical methods are focused on explaining how things are connected.</p>
<hr>
<h2>Prediction</h2>
<p>Some statistical methods are not focused on explaining how things are connected. Only the accuracy of prediction is important.</p>
<p>Many statistical methods are successful at predicting without giving insight into how things are connected.</p>
<p>Some types of machine learning let computers do the hard work, but the way they predict is difficult to understand. These approaches can also be vulnerable to mistakes if the circumstances change, since the how they work is less clear.</p>
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> Predictions about future events are called <strong>forecasts</strong>. Not all predictions are about the future.</p>
  <p>Some predictions can be about something else that is unknown, even if it is not in the future.</p>
  </div>
<hr/>
<h2>Explanation</h2>
<p>Different statistical methods are often used for explaining how things are connected. These statistical methods may not make good predictions. </p>
<p>These statistical methods often explain only small parts of the whole situation. But, if you only want to know how a few things are connected, the rest might not matter.</p>
<p>If these methods accurately explain how all the relevant things are connected, they will also be good at prediction. But managing to explain every detail is often challenging.</p>
<p>Some times we are specifically interested in figuring out if one thing causes another. This is called <strong>causal inference</strong>.</p>
<p>If we are looking at complicated situations, many things are connected. To figure out what causes what, we need to untangle every way these things are connected.</p>
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> Making conclusions about causality should be done carefully.</p>
</div>
