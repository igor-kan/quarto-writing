<!DOCTYPE html>
<html lang="en-US">
<head><title>Statistics - Mode</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Statistics - Mode</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="statistics_median.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="statistics_variation.php">Next &#10095;</a>
</div>
<hr>
<p class="intro">The mode is a type of average value, which describes where most of the data is located.</p>
<hr>
<h2>Mode</h2>
<p>The mode is the value(s) that are the most common in the data.</p>
<p>A dataset can have multiple values that are modes.</p>
<p>A distribution of values with only one mode is called <strong>unimodal</strong>.</p>
<p>A distribution of values with two modes is called <strong>bimodal</strong>. In general, a distribution with more than one mode is called <strong>multimodal</strong>.</p>
<p>Mode can be found for both categorical and numerical data.</p>
<hr>
<h2>Finding the Mode</h2>
<p>Here is a <strong>numerical</strong> example:</p>
<div class="w3-code notranslate">
  <p>4, <u>7</u>, 3, 8, 11, <u>7</u>, 10, 19, 6, 9, <u>12</u>, <u>12</u></p>
</div>
<p>Both 7 and 12 appears two times each, and the other values only once. The modes of this data is 7 and 12. </p>
<p>Here is a <strong>categorical</strong> example with names:</p>
<div class="w3-code notranslate">
  <p>Alice, <u>John</u>, Bob, Maria, <u>John</u>, Julia, Carol</p>
</div>
<p>John appears two times, and the other values only once. The mode of this data is John.</p>
<hr>
<h2>Finding the Mode with Programming</h2>
<p>The mode can easily be found with many programming languages.</p>
...
<div class="w3-example">
  <h3>Example</h3>
  <div>
    <p>With Python use the statistics library <code class="w3-codespan">multimode()</code> method to find the modes of the values 4,7,3,8,11,7,10,19,6,9,12,12:</p>
    ...
    <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_stat_python_mode">Try it Yourself &raquo;</a>
  </div>
</div>
<div class="w3-example">
  <h3>Example</h3>
  <div>
    <p>Using R with a user-defined function to find the modes of the values 4,7,3,8,11,7,10,19,6,9,12,12:</p>
    <div class="w3-code notranslate pythonHigh">
      mode &lt;- function(x) {
      <br>
    ...
    <a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryr.asp?filename=demo_stat_r_mode">Try it Yourself &raquo;</a>
  </div>
</div>
<div class="w3-panel ws-warning">
  <p><strong>Note:</strong> R has no built-in function to find the mode.</p>
</div>
