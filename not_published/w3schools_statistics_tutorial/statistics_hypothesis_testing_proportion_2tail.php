<!DOCTYPE html>
<html lang="en-US">
<head><title>Statistics - Hypothesis Testing a Proportion (Two Tailed)</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Statistics - Hypothesis Testing a Proportion (Two Tailed)</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="statistics_hypothesis_testing_proportion_left.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="statistics_hypothesis_testing_mean_left.php">Next &#10095;</a>
</div>
<hr>
<p class="intro">A population proportion is the share of a population that belongs to a particular <a href="statistics_data_types.php">category</a>.</p>
<p class="intro">Hypothesis tests are used to check a claim about the size of that population proportion.</p>
<hr>
<h2>Hypothesis Testing a Proportion</h2>
<p>The following steps are used for a hypothesis test:</p>
<ol>
  <li>Check the conditions</li>
  <li>Define the claims</li>
  <li>Decide the significance level</li>
  <li>Calculate the test statistic</li>
  <li>Conclusion</li>
</ol>
<p>For example:</p>
<ul>
  <li><strong>Population</strong>: Nobel Prize winners</li>
  <li><strong>Category</strong>: Women</li>
</ul>
<p>And we want to check the claim:</p>
<div class="w3-code notranslate">
  <p>"The share of Nobel Prize winners that are women is <strong>not</strong> 50&#37;"</p>
</div>
<p>By taking a sample of 100 randomly selected Nobel Prize winners we could find that:</p>
<div class="w3-code notranslate">
  <p>10 out of 100 Nobel Prize winners in the sample were women</p>
</div>
<p>The <strong>sample</strong> proportion is then: \(\displaystyle \frac{10}{100} = 0.1\), or 10&#37;.</p>
<p>From this sample data we check the claim with the steps below.</p>
<hr>
<h2>1. Checking the Conditions</h2>
<p>The conditions for calculating a confidence interval for a proportion are:</p>
<ul>
  <li>The sample is <a href="statistics_sample_types.php">randomly selected</a></li>
  <li>There is only two options:
  <ul>
    <li>Being in the category</li>
    <li>Not being in the category</li>
  </ul>
  </li>
  <li>The sample needs at least:
  <ul>
    <li>5 members in the category</li>
    <li>5 members not in the category</li>
  </ul>
  </li> 
</ul>
<p>In our example, we randomly selected 10 people that were women.</p>
<p>The rest were not women, so there are 90 in the other category.</p>
<p>The conditions are fulfilled in this case.</p>
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> It is possible to do a hypothesis test without having 5 of each category. But special adjustments need to be made.</p>
</div>
<hr>
<h2>2. Defining the Claims</h2>
<p>We need to define a <strong>null hypothesis</strong> (\(H_{0}\)) and an <strong>alternative hypothesis</strong> (\(H_{1}\)) based on the claim we are checking.</p>
<p>The claim was:</p>
<div class="w3-code notranslate">
  <p>"The share of Nobel Prize winners that are women is <strong>not</strong> 50&#37;"</p>
</div>
<p>In this case, the <strong>parameter</strong> is the proportion of Nobel Prize winners that are women (\(p\)).</p>
<p>The null and alternative hypothesis are then:</p>
<div class="w3-code notranslate">
  <p><strong>Null hypothesis</strong>: 50&#37; of Nobel Prize winners were women.</p>
  <p><strong>Alternative hypothesis</strong>: The share of Nobel Prize winners that are women is <strong>not</strong> 50&#37;</p>
</div>
<p>Which can be  expressed with symbols as:</p>
<div class="w3-code notranslate">
  <p>\(H_{0}\): \(p = 0.50 \)</p>
  <p>\(H_{1}\): \(p \neq 0.50 \)</p>
</div>
<p>This is a '<strong>two-tailed</strong>' test, because the alternative hypothesis claims that the proportion is <strong>different</strong> (larger or smaller) than in the null hypothesis.</p>
<p>If the data supports the alternative hypothesis, we <strong>reject</strong> the null hypothesis and <strong>accept</strong> the alternative hypothesis.</p>
<hr>
<div id="midcontentadcontainer" style="overflow:auto;text-align:center">
<!-- MidContent -->
<!-- <p class="adtext">Advertisement</p> -->
</div><hr>
<h2>3. Deciding the Significance Level</h2>
<p>The significance level (\(\alpha\)) is the <strong>uncertainty</strong> we accept when rejecting the null hypothesis in a hypothesis test.</p>
<p>The significance level is a percentage probability of accidentally making the wrong conclusion.</p>
<p>Typical significance levels are:</p>
<ul>
  <li>\(\alpha = 0.1\) (10&#37;)</li>
  <li>\(\alpha = 0.05\) (5&#37;)</li>
  <li>\(\alpha = 0.01\) (1&#37;)</li>
</ul>
<p>A lower significance level means that the evidence in the data needs to be stronger to reject the null hypothesis.</p>
<p>There is no "correct" significance level  - it only states the uncertainty of the conclusion.</p>
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> A 5&#37; significance level means that when we reject a null hypothesis:</p>
  <p>We expect to reject a <strong>true</strong> null hypothesis 5 out of 100 times.</p>
</div>
<hr>
<h2>4. Calculating the Test Statistic</h2>
<p>The test statistic is used to decide the outcome of the hypothesis test.</p>
<p>The test statistic is a <a href="statistics_standard_normal_distribution.php">standardized</a> value calculated from the sample.</p>
<p>The formula for the test statistic (TS) of a population proportion is:</p>
<p>\(\displaystyle \frac{\hat{p} - p}{\sqrt{p(1-p)}} \cdot \sqrt{n} \)</p>
<p>\(\hat{p}-p\) is the <strong>difference</strong> between the <strong>sample</strong> proportion (\(\hat{p}\)) and the claimed <strong>population</strong> proportion (\(p\)).</p>
<p>\(n\) is the sample size.</p>
<p>In our example:</p>
<div class="w3-code notranslate">
  <p>The claimed (\(H_{0}\)) population proportion (\(p\)) was \( 0.50 \)</p>
  <p>The sample proportion (\(\hat{p}\)) was 10 out of 100, or: \(\displaystyle \frac{10}{100} = 0.10\)
  <p>The sample size (\(n\)) was \(100\)</p>
</div>
<p>So the test statistic (TS) is then:</p>
<p>\(\displaystyle \frac{0.1-0.5}{\sqrt{0.5(1-0.5)}} \cdot \sqrt{100} = \frac{-0.4}{\sqrt{0.5(0.5)}} \cdot \sqrt{100} = \frac{-0.4}{\sqrt{0.25}} \cdot \sqrt{100} = \frac{-0.4}{0.5} \cdot 10 = \underline{-8}\)</p>
<p>You can also calculate the test statistic using programming language functions:</p>
<div class="w3-example">
  <h3>Example</h3>
    <p>With Python use the scipy and math libraries to calculate the test statistic for a proportion.</p>
  ...
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_stat_python_prop_test_statistic_2t">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
  <h3>Example</h3>
    <p>With R use the built-in math functions to calculate the test statistic for a proportion.</p>
  <div class="w3-code notranslate pythonHigh">
  ...
  <a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_stat_r_prop_test_statistic_2t">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>5. Concluding</h2>
<p>There are two main approaches for making the conclusion of a hypothesis test:</p>
<ul>
  <li>The <strong>critical value</strong> approach compares the test statistic with the critical value of the significance level.</li>
  <li>The <strong>P-value</strong> approach compares the P-value of the test statistic and with the significance level.</li>
</ul>
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> The two approaches are only different in how they present the conclusion.</p>
</div>
<h3>The Critical Value Approach</h3>
<p>For the critical value approach we need to find the <strong>critical value</strong> (CV) of the significance level (\(\alpha\)).</p>
<p>For a population proportion test, the critical value (CV) is a <strong>Z-value</strong> from a <a href="standard_normal_distribution.php">standard normal distribution</a>.</p>
<p>This critical Z-value (CV) defines the <strong>rejection region</strong> for the test.</p>
<p>The rejection region is an area of probability in the tails of the standard normal distribution.</p>
<p>Because the claim is that the population proportion is <strong>different</strong> from 50&#37;, the rejection region is split into both the left and right tail:</p>
<p><img src="img_critical_value_2tail2.svg" alt="Standard Normal Distribution with a left and right tail area (rejection region) denoted as the greek symbol alpha"></p>
<p>The size of the rejection region is decided by the significance level (\(\alpha\)).
<p>Choosing a significance level (\(\alpha\)) of 0.01, or 1&#37;, we can find the critical Z-value from a <a href="statistics_z_table.php">Z-table</a>, or with a programming language function:</p>
<div class="w3-panel ws-note">
    <p><strong>Note:</strong> Because this is a two-tailed test the tail area (\(\alpha\)) needs to be split in half (divided by 2).</p>
</div>
<div class="w3-example">
  <h3>Example</h3>
  <p>With Python use the Scipy Stats library <code class="w3-codespan">norm.ppf()</code> function find the Z-value for an \(\alpha\)/2 = 0.005 in the left tail.</p>
  <div class="w3-code notranslate pythonHigh">
    import scipy.stats as stats
    <br>
    print(stats.norm.ppf(0.005))
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_stat_python_z_score4">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
  <h3>Example</h3>
  <p>With R use the built-in <code class="w3-codespan">qnorm()</code> function to find the Z-value for an \(\alpha\) = 0.005 in the left tail.</p>
  <div class="w3-code notranslate pythonHigh">
    qnorm(0.005)
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_stat_r_z_score4">Try it Yourself &raquo;</a>
</div>
<p>Using either method we can find that the critical Z-value in the left tail is \(\approx \underline{-2.5758}\)</p>
<p>Since a normal distribution i symmetric, we know that the critical Z-value in the right tail will be the same number, only positive: \(\underline{2.5758}\)</p>
<p>For a <strong>two-tailed</strong> test we need to check if the test statistic (TS) is <strong>smaller</strong> than the negative critical value (-CV), <strong>or bigger</strong> than the positive critical value (CV).</p>
<p>If the test statistic is smaller than the <strong>negative</strong> critical value, the test statistic is in the <strong>rejection region</strong>.</p>
<p>If the test statistic is bigger than the <strong>positive</strong> critical value, the test statistic is in the <strong>rejection region</strong>.</p>
<p>When the test statistic is in the rejection region, we <strong>reject</strong> the null hypothesis (\(H_{0}\)).</p>
<p>Here, the test statistic (TS) was \(\approx \underline{-8}\) and the critical value was \(\approx \underline{-2.5758}\)</p>
<p>Here is an illustration of this test in a graph:</p>
<p><img src="img_critical_value_prop_2tail.svg" alt="Standard Normal Distribution with a left tail area (rejection region) equal to 0.01, a critical value of -2.3263, and a test statistic of -2.543"></p>
<p>Since the test statistic was <strong>smaller</strong> than the negative critical value we <strong>reject</strong> the null hypothesis.</p>
<p>This means that the sample data supports the alternative hypothesis.</p>
<p>And we can summarize the conclusion stating:</p>
<div class="w3-code notranslate">
  <p>The sample data <strong>supports</strong> the claim that "The share of Nobel Prize winners that are women is <strong>not</strong> 50&#37;" at a <strong>1&#37; significance level</strong>.</p>
</div>
<h3>The P-Value Approach</h3>
<p>For the P-value approach we need to find the <strong>P-value</strong> of the test statistic (TS).</p>
<p>If the P-value is <strong>smaller</strong> than the significance level (\(\alpha\)), we <strong>reject</strong> the null hypothesis (\(H_{0}\)).</p>
<p>The test statistic was found to be \( \approx \underline{-8} \)</p>
<p>For a population proportion test, the test statistic is a Z-Value from a <a href="statistics_standard_normal_distribution.php">standard normal distribution</a>.</p>
<p>Because this is a <strong>two-tailed</strong> test, we need to find the P-value of a Z-value <strong>smaller</strong> than -8 and <strong>multiply it by 2</strong>.</p>
<p>We can find the P-value using a <a href="statistics_z_table.php">Z-table</a>, or with a programming language function:</p>
<div class="w3-example">
  <h3>Example</h3>
    <p>With Python use the Scipy Stats library <code class="w3-codespan">norm.cdf()</code> function find the P-value of a Z-value smaller than -8 for a two tailed test:</p>
  <div class="w3-code notranslate pythonHigh">
    import scipy.stats as stats
    <br>
    print(2*stats.norm.cdf(-8))
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_stat_python_p_value4">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
  <h3>Example</h3>
    <p>With R use the built-in <code class="w3-codespan">pnorm()</code> function find the P-value of a Z-value smaller than -8 for a two tailed test:</p>
  <div class="w3-code notranslate pythonHigh">
    2*pnorm(-8)
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_stat_r_p_value4">Try it Yourself &raquo;</a>
</div>
<p>Using either method we can find that the P-value is \(\approx \underline{1.25 \cdot 10^{-15}}\) or \(0.00000000000000125\)</p>
<p>This tells us that the significance level (\(\alpha\)) would need to be bigger than 0.000000000000125&#37;, to <strong>reject</strong> the null hypothesis.</p>
<p>Here is an illustration of this test in a graph:</p>
<p><img src="img_p_value_prop_2tail.svg"></p>
<p>This P-value is <strong>smaller</strong> than any of the common significance levels (10&#37;, 5&#37;, 1&#37;).</p>
<p>So the null hypothesis is <strong>rejected</strong> at all of these significance levels.</p>
<p>And we can summarize the conclusion stating:</p>
<div class="w3-code notranslate">
  <p>The sample data <strong>supports</strong>  the claim that "The share of Nobel Prize winners that are women is not 50&#37;" at a <strong>10&#37;, 5&#37;, and 1&#37; significance level</strong>.</p>
</div>

<hr>
<h2>Calculating a P-Value for a Hypothesis Test with Programming</h2>
<p>Many programming languages can calculate the P-value to decide outcome of a hypothesis test.</p>
<p>Using software and programming to calculate statistics is more common for bigger sets of data, as calculating manually becomes difficult.</p>
<p>The P-value calculated here will tell us the <strong>lowest possible significance level</strong> where the null-hypothesis can be rejected.</p>
<div class="w3-example">
  <h3>Example</h3>
    <p>With Python use the scipy and math libraries to calculate the P-value for a two-tailed tailed hypothesis test for a proportion.</p>
    <p>Here, the sample size is 100, the occurrences are 10, and the test is for a proportion different from than 0.50.</p>
  <div class="w3-code notranslate pythonHigh">
    import scipy.stats as stats
    <br>
    import math
  ...
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_stat_python_prop_test3">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
  <h3>Example</h3>
    <p>With R use the built-in <code class="w3-codespan">prop.test()</code> function find the P-value for a left tailed hypothesis test for a proportion.</p>
    <p>Here, the sample size is 100, the occurrences are 10, and the test is for a proportion different from 0.50.</p>
  <div class="w3-code notranslate pythonHigh">
    # Specify the sample occurrences (x), the sample size (n), and the null-hypothesis claim (p)
    <br>
    x &lt;- 10
  ...
  <a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_stat_r_prop_test3">Try it Yourself &raquo;</a>
</div>
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> The <code class="w3-codespan">conf.level</code> in the R code is the reverse of the significance level.</p>
  <p>Here, the significance level is 0.01, or 1&#37;, so the conf.level is 1-0.01 = 0.99, or 99&#37;.</p>
</div>
<hr>
<h2>Left-Tailed and Two-Tailed Tests</h2>
<p>This was an example of a <strong>two</strong> tailed test, where the alternative hypothesis claimed that parameter is <strong>different</strong> from the null hypothesis claim.</p>
<p>You can check out an equivalent step-by-step guide for other types here:</p>
<ul>
    <li><a href="statistics_hypothesis_testing_proportion.php">Right-Tailed Test</a></li>
  <li><a href="statistics_hypothesis_testing_proportion_left.php">Left-Tailed Test</a></li>
</ul>
<br>
<div class="w3-clear nextprev">
    <a class="w3-left w3-btn" href="statistics_hypothesis_testing_proportion_left.php">&#10094; Previous</a>
