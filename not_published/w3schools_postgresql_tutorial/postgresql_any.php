...
ny:-->
    ...
    <h1>PostgreSQL ANY Operator</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="postgresql_exists.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_all.php">Next &#10095;</a>
</div>
...
<p>The <code class="w3-codespan">ANY</code> operator
allows you to perform a comparison between a single column value and a range of other values.</p>

<p>The <code class="w3-codespan">ANY</code> operator:</p>

<ul>
  <li>returns a Boolean value as a result</li>
  <li>returns TRUE if ANY of the sub query values meet the condition</li>
</ul>

<p><code class="w3-codespan">ANY</code>
means that the condition will be true if the operation is true for any of the values in the range.</p>


<div class="w3-example">
  <h3>Example</h3>
  <p>List products that have ANY records in the <code class="w3-codespan">order_details</code> table with a quantity 
  larger than 120:</p>  
  <div class="w3-code notranslate w3-black shellcommands">
SELECT product_name<br>FROM products<br>WHERE product_id = ANY (<br>&nbsp; SELECT 
        product_id<br>&nbsp; FROM order_details<br>&nbsp; WHERE quantity &gt; 120
        <br>);
  </div>
  <a class="w3-btn w3-margin-bottom" href="trypostgresql.php?filename=demo_any" target="_blank">Run Example &raquo;
  </a>  
</div>
...
<div id="exercisecontainer" src="xrcise_any.js" data-extensions="php"></div>
<hr>
