...
ny:-->
    ...
    <h1>PostgreSQL ALL Operator</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="postgresql_any.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_case.php">Next &#10095;</a>
</div>
...
<ul>
  ...
  <li>returns TRUE if ALL of the sub query values meet the condition</li>
  <li>is used with <code class="w3-codespan">SELECT</code>, <code class="w3-codespan">WHERE</code> and <code class="w3-codespan">HAVING</code> statements</li>
</ul>

<p><code class="w3-codespan">ALL</code>
means that the condition will be true only if the operation is true for all values in the range.</p>


<div class="w3-example">
  <h3>Example</h3>
  <p>List the products if ALL the records in the order_details with quantity larger than 10.</p>
  <p><strong>Note:</strong> This will of course return FALSE because the quantity column has many different values (not only the value of 10):
  <div class="w3-code notranslate w3-black shellcommands">
SELECT product_name<br>FROM products<br>WHERE product_id = ALL (<br>&nbsp; SELECT 
        product_id<br>&nbsp; FROM order_details<br>&nbsp; WHERE quantity &gt; 10
        <br>);
  </div>
  <a class="w3-btn w3-margin-bottom" href="trypostgresql.php?filename=demo_all" target="_blank">Run Example &raquo;
  </a>  
</div>
...
<div id="exercisecontainer" src="xrcise_all.js" data-extensions="php"></div>
<hr>
