...
<html lang="en-US">
<head>
<title>PostgreSQL - ORDER BY - Sort Data</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>PostgreSQL ORDER BY</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="postgresql_where.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_limit.php">Next &#10095;</a>
</div>
...
<p>The <code class="w3-codespan">ORDER BY</code> keyword is used to sort the result in ascending or descending order.</p>

<p>The <code class="w3-codespan">ORDER BY</code> keyword sorts the records in ascending order by default.
To sort the records in descending order, use the <code class="w3-codespan">DESC</code> keyword.</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Sort the table by price:</p>
  <div class="w3-code notranslate w3-black shellcommands">
          SELECT * FROM products<br>
          ORDER BY price;
  </div>
  <a target="_blank"
     href="trypostgresql.php?filename=demo_order_by_products"
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Sort the table by price, in descending order:</p>
  <div class="w3-code notranslate w3-black shellcommands">
          SELECT * FROM products<br>
          ORDER BY price DESC;
  </div>
  <a target="_blank"
     href="trypostgresql.php?filename=demo_order_by_desc_products"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>   
</div>
...
<p>For string values the <code class="w3-codespan">ORDER BY</code> keyword will order alphabetically:</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Sort the table by product name:</p>
  <div class="w3-code notranslate w3-black shellcommands">
          SELECT * FROM products<br>
          ORDER BY product_name;
  </div>
  <a target="_blank"
     href="trypostgresql.php?filename=demo_order_by_alphabetically_products"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>   
</div>
...
<p>To sort the table reverse alphabetically, use the <code class="w3-codespan">DESC</code> keyword:</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Sort the table by product name, in descending order:</p>
  <div class="w3-code notranslate w3-black shellcommands">
          SELECT * FROM products<br>
          ORDER BY product_name DESC;
  </div>
  <a target="_blank"
     href="trypostgresql.php?filename=demo_order_by_alphabetically_desc_products"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>   
</div>

<hr>
<div id="exercisecontainer" src="xrcise_orderby.js" data-extensions="php"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="postgresql_where.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_limit.php">Next &#10095;</a>
