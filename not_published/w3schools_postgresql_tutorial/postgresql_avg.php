...
ny:-->
    ...
    <h1>PostgreSQL AVG Function</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="postgresql_sum.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_like.php">Next &#10095;</a>
</div>
...
<p>The <code class="w3-codespan">AVG()</code>
function returns the average value of a numeric column.</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Return the average price of all the products in the <code class="w3-codespan">products</code> table:</p>  
  <div class="w3-code notranslate w3-black shellcommands">
          SELECT AVG(price)<br>
          FROM products;
  </div>
  <a target="_blank"
     href="trypostgresql.php?filename=demo_avg"
...
<h2>With 2 Decimals</h2>

<p>The above example returned the average price of all products, the result was
<code class="w3-codespan">28.8663636363636364</code>.</p>

<p>We can use the <code class="w3-codespan">::NUMERIC</code> operator to round the average price to a number with 2 decimals:</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Return the average price of all the products, rounded to 2 decimals:</p>  
  <div class="w3-code notranslate w3-black shellcommands">
          SELECT AVG(price)::NUMERIC(10,2)<br>
          FROM products;
  </div>
  <a target="_blank"
     href="trypostgresql.php?filename=demo_avg_round"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>  
</div>
<hr>
...
<div id="exercisecontainer" src="xrcise_avg.js" data-extensions="php"></div>
<hr>
