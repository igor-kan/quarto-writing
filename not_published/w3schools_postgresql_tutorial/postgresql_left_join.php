...
ny:-->
    ...
    <h1>PostgreSQL LEFT JOIN</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="postgresql_inner_join.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_right_join.php">Next &#10095;</a>
</div>
...
<p>The <code class="w3-codespan">LEFT JOIN</code> keyword selects ALL records from the "left" table,
and the matching records from the "right" table.
The result is 0 records from the right side if there is no match.</p>

<p>Let's look at an example using our dummy <code class="w3-codespan">testproducts</code> table:</p>


<div class="w3-example">
  <div class="w3-code notranslate w3-black" style="overflow:auto;white-space:nowrap">
...
<p>We will try to join the <code class="w3-codespan">testproducts</code> table 
with the <code class="w3-codespan">categories</code> table:</p>
...
<p><b>Note:</b> Many of the products in <code class="w3-codespan">testproducts</code> have a
<code class="w3-codespan">category_id</code> that does not match any of the 
categories in the <code class="w3-codespan">categories</code> table.</p>
<p>By using <code class="w3-codespan">LEFT JOIN</code> we will get all 
records from <code class="w3-codespan">testpoducts</code>, even the ones with no 
match in the <code class="w3-codespan">categories</code> table:</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Join <code class="w3-codespan">testproducts</code> to <code class="w3-codespan">
  categories</code> using the <code class="w3-codespan">category_id</code> column:</p>  
  ...
  <a class="w3-btn w3-margin-bottom" href="trypostgresql.php?filename=demo_left_join" target="_blank">Run Example &raquo;
  </a>  
</div>

<div class="w3-example">
  <h3>Result</h3>
  <p>All records from <code class="w3-codespan">testproducts</code>, and only the matched records from
  ...
  <div class="w3-code notranslate w3-black" style="overflow:auto;white-space:nowrap">
    ...
    10 | Mias Popular Ice&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |<br>(10 rows)<br></div>
</div>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> <code class="w3-codespan">LEFT JOIN</code> and <code class="w3-codespan">
LEFT OUTER JOIN</code>
will give the same result.</p>
  <p><code class="w3-codespan">OUTER</code> is the default join type for 
<code class="w3-codespan">LEFT JOIN</code>, so when you write
<code class="w3-codespan">LEFT JOIN</code> the parser actually writes
<code class="w3-codespan">LEFT OUTER JOIN</code>.</p>
</div>
...
<div id="exercisecontainer" src="xrcise_left_join.js" data-extensions="php"></div>
<hr>
