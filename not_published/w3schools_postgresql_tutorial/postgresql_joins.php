...
<a class="w3-left w3-btn" href="postgresql_as.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_inner_join.php">Next &#10095;</a>
</div>
<hr>

<h2>JOIN</h2>

<p>A <code class="w3-codespan">JOIN</code> clause is used to combine rows from two or 
more tables, based on a related column between them.</p>

<p>Let's look at a selection from the <code class="w3-codespan">products</code> table:</p>
...
<p>Then, look at a selection from the <code class="w3-codespan">categories</code> table:</p>

<div class="w3-example">
  <div class="w3-code notranslate w3-black">
    &nbsp;category_id | category_name<br>-------------+----------------<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    1 | Beverages<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    2 | Condiments<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    3 | Confections<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    4 | Dairy Products</div>
</div>

<p>Notice that the <code class="w3-codespan">category_id</code> column in the
<code class="w3-codespan">products</code> table refers to the
<code class="w3-codespan">category_id</code> in the
<code class="w3-codespan">categories</code> table.
The relationship between the two tables above is the <code class="w3-codespan">category_id</code> column.</p>

<p>Then, we can create the following SQL statement (with a JOIN),
that selects records that have matching values in both tables:</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Join <code class="w3-codespan">products</code> to <code class="w3-codespan">
  ...
  <div class="w3-code notranslate w3-black shellcommands">
        SELECT product_id, product_name, category_name<br>
        FROM products<br>
        INNER JOIN categories ON products.category_id = categories.category_id;
  </div>
  <a target="_blank"
     href="trypostgresql.php?filename=demo_joins"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>  
</div>

<p>If we pull out the same selection from products table above, we get this result:</p>
<div class="w3-example">
  <h3>Result</h3>
  <div class="w3-code notranslate w3-black">
    &nbsp;product_id 
...
<p>Here are the different types of the Joins in PostgreSQL:</p>

<ul>
<li><code class="w3-codespan">INNER JOIN</code>: Returns records that have matching values in both tables</li>
<li><code class="w3-codespan">LEFT JOIN</code>: Returns all records from the left table, and the matched records from the right table</li>
<li><code class="w3-codespan">RIGHT JOIN</code>: Returns all records from the right table, and the matched records from the left table</li>
<li><code class="w3-codespan">FULL JOIN</code>: Returns all records when there is a match in either left or right table</li>
  <li><code class="w3-codespan">CROSS JOIN</code>: Returns the Cartesian product 
  of two or more 
...
<hr>
<div id="exercisecontainer" src="xrcise_joins.js" data-extensions="php"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="postgresql_as.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_inner_join.php">Next &#10095;</a>
