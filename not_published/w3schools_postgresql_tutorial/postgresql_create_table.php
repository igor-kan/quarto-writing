...
<a class="w3-left w3-btn" href="postgresql_pgadmin4.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_insert_into.php">Next &#10095;</a>
</div>
...
<p>To create a new database table using the SQL Shell, make sure you are connected to the database.
If not, follow the steps in the <a href="postgresql_getstarted.php">Get Started</a> chapter of this tutorial.</p>
...
<code class="w3-codespan">cars</code>
in your PostgreSQL database:</p>
...
-->
<p>When you execute the above statement, an empty table named cars will be created, and the SQL Shell
application will return the following:</p>
...
<p>In the SQL Shell application on your computer the operation above might look like this:</p>


<p><img src="screenshot_postgresql_create_table.png" class="postgresql_screenshot"></p>
...
<h2>SQL Statement Explained</h2>

<p>The above SQL statement created an empty table with three fields:
<code class="w3-codespan">brand</code>,
<code class="w3-codespan">model</code>, and
<code class="w3-codespan">year</code>.
</p>

<p>When creating fields in a table we have to specify the data type of each field.</p>

<p>For <code class="w3-codespan">brand</code> and <code class="w3-codespan">model</code>
we are expecting string values, and string values are specified with the
<code class="w3-codespan">VARCHAR</code> keyword.</p>

<p>We also have to specify the number of characters allowed in a string field,
and since we do not know exactly, we just set it to 255.</p>

<p>For <code class="w3-codespan">year</code> we are expecting integer values (numbers without decimals),
and integer values are specified with the <code class="w3-codespan">INT</code> keyword.</p>

<!--<p>You will learn more about different data types later in the 
<a href="postgresql_datatypes.php">PostgreSQL data types</a> chapter.</p>-->

<hr>

<h2>Display Table</h2>

<p>You can "display" the empty table you just created with another SQL statement:</p>
...
<p><img src="screenshot_postgresql_select.png" class="postgresql_screenshot"></p>

<p>In the next chapters we will learn how to insert data into a table, and also more on how to retrieve data from a table.</p>

<hr>
<div id="exercisecontainer" src="xrcise_create_table.js" data-extensions="php"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="postgresql_pgadmin4.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_insert_into.php">Next &#10095;</a>
