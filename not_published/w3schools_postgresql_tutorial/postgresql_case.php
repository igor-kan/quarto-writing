...
ny:-->
    ...
    <h1>PostgreSQL CASE Expression</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="postgresql_all.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="postgresql_exam.php">Next &#10095;</a>
</div>
...
<p>The <code class="w3-codespan">CASE</code>
expression goes through conditions and returns a value when the first condition is met
(like an if-then-else statement).</p>

<p>Once a condition is true, it will stop reading and return the result.
If no conditions are true, it returns the value in the <code class="w3-codespan">ELSE</code> clause.</p>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Return specific values if the price meets a specific condition:</p>
...
CASE<br>&nbsp;
  ...
  <a class="w3-btn w3-margin-bottom" href="trypostgresql.php?filename=demo_case" target="_blank">Run Example &raquo;
  </a>  
</div>
...
<p>When a column name is not specified for the "case" field,
the parser uses <code class="w3-codespan">case</code> as the column name.</p>


<p>To specify a column name, add an alias after the <code class="w3-codespan">END</code> keyword.</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Same example, but with an alias for the case column::</p>
  <div class="w3-code notranslate w3-black shellcommands">
SELECT product_name,<br>
CASE<br>&nbsp;
  WHEN price &lt; 10 THEN 'Low price product'<br>&nbsp; WHEN price &gt; 50 THEN 'High 
  ...
  <a class="w3-btn w3-margin-bottom" href="trypostgresql.php?filename=demo_case_as" target="_blank">Run Example &raquo;
  </a>  
</div>

<p>You can read more about aliases in our <a href="postgresql_as.php">PostgreSQL AS chapter</a>.</p>
...
<div id="exercisecontainer" src="xrcise_case.js" data-extensions="php"></div>
<hr>
