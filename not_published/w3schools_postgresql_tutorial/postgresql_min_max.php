...
<html lang="en-US">
<head>
<title>PostgreSQL - MIN() and MAX() Functions</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>PostgreSQL MIN and MAX Functions</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="postgresql_limit.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_count.php">Next &#10095;</a>
</div>
...
<p>The <code class="w3-codespan">MIN()</code>
function returns the smallest value of the selected column.</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Return the lowest price in the <code class="w3-codespan">products</code> table:</p>  
  <div class="w3-code notranslate w3-black shellcommands">
          SELECT MIN(price)<br>
          FROM products;
  </div>
  <a target="_blank"
     href="trypostgresql.php?filename=demo_min"
...
<p>The <code class="w3-codespan">MAX()</code>
function returns the largest value of the selected column.</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Return the highest price in the <code class="w3-codespan">products</code> table:</p>  
  <div class="w3-code notranslate w3-black shellcommands">
          SELECT MAX(price)<br>
          FROM products;
  </div>
  <a target="_blank"
     href="trypostgresql.php?filename=demo_max"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>  
</div>
...
<h2>Set Column Name</h2>

<p>When you use <code class="w3-codespan">MIN()</code> or <code class="w3-codespan">MAX()</code>,
the returned column will be named
<code class="w3-codespan">min</code> or <code class="w3-codespan">max</code> by default.
To give the column a new name, use the <code class="w3-codespan">AS</code> keyword.</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Return the lowest price, and name the column <code class="w3-codespan">lowest_price</code>:</p>  
  <div class="w3-code notranslate w3-black shellcommands">
          SELECT MIN(price) AS lowest_price<br>
          FROM products;
  </div>
  <a target="_blank"
     href="trypostgresql.php?filename=demo_min_as"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>  
</div>
...
<div id="exercisecontainer" src="xrcise_min_max.js" data-extensions="php"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="postgresql_limit.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_count.php">Next &#10095;</a>
