...
<html lang="en-US">
<head>
<title>PostgreSQL - The UPDATE Statement</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="postgresql_add_column.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_alter_column.php">Next &#10095;</a>
</div>
...
<p>The <code class="w3-codespan">UPDATE</code> statement is used to modify the value(s) in existing records in a table.</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Set the color of the Volvo to 'red':</p>
...
<p>Which means that <code class="w3-codespan">1</code> row was affected by the <code class="w3-codespan">UPDATE</code> statement.</p>
<div class="w3-panel ws-note">

<p><strong>Note:</strong> Be careful with the <code class="w3-codespan">WHERE</code> clause,
in the example above ALL rows where brand = 'Volvo' gets updated.</p>
</div>
...
<div class="w3-example">
  ...
  <a target="_blank"
     href="trypostgresql.php?filename=demo_update"
...
<h2>Warning! Remember WHERE</h2>

<div class="w3-panel ws-note">
<p>Be careful when updating records. If you omit the <code class="w3-codespan">WHERE</code> clause,
ALL records will be updated!</p>
</div>

<div class="w3-example w3-pale-red">
  <h3>Example</h3>
  <p>Without the <code class="w3-codespan">WHERE</code> clause, ALL records will be updated:</p>
  <div class="w3-code notranslate w3-black shellcommands">
          UPDATE cars<br>
          SET color = 'red';
  </div>
...
<p>Which means that all <code class="w3-codespan">4</code> row was affected by the <code class="w3-codespan">UPDATE</code> statement.</p>
...
<div class="w3-example">
  ...
  <a target="_blank"
     href="trypostgresql.php?filename=demo_update2"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>   
</div>
...
<p>To update more than one column, separate the name/value pairs with a comma <code class="w3-codespan">,</code>:</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Update color and year for the Toyota:</p>
  <div class="w3-code notranslate w3-black shellcommands">
          UPDATE cars<br>
...
<div class="w3-example">
  ...
  <a target="_blank"
     href="trypostgresql.php?filename=demo_update3"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>   
</div>
...
<hr>
<div id="exercisecontainer" src="xrcise_update.js" data-extensions="php"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="postgresql_add_column.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_alter_column.php">Next &#10095;</a>
