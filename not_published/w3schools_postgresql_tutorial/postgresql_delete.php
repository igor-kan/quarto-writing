...
<html lang="en-US">
<head>
<title>PostgreSQL - The DELETE Statement</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="postgresql_drop_column.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_drop_table.php">Next &#10095;</a>
</div>
...
<p><strong>Note:</strong> Be careful when deleting records in a table!
Notice the <code class="w3-codespan">WHERE</code> clause in the
<code class="w3-codespan">DELETE</code> statement.
The <code class="w3-codespan">WHERE</code> clause specifies which record(s) should be deleted.</p>

<p style="text-align:center">If you omit the <code class="w3-codespan">WHERE</code> clause,<br>
<strong>all records in the table will be deleted</strong>!.</p>
</div>

<p>To delete the record(s) where brand is 'Volvo', use this statement:</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Delete all records where brand is 'Volvo':</p>
...
<p>Which means that <code class="w3-codespan">1</code> row was deleted.</p>

<hr>

<h2>Display Table</h2>

<p>To check the result we can display the table with this SQL statement:</p>
...
<div class="w3-example">
  ...
  <a target="_blank"
     href="trypostgresql.php?filename=demo_delete"
...
<p>The following SQL statement deletes all rows in the <code class="w3-codespan">cars</code>
table, without deleting the table:</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Delete all records in the <code class="w3-codespan">cars</code> table:</p>
  <div class="w3-code notranslate w3-black shellcommands">
          DELETE FROM cars;
  </div>
</div>
...
<p>Which means that all <code class="w3-codespan">3</code> rows were deleted.</p>
...
<div class="w3-example">
  ...
  <a target="_blank"
     href="trypostgresql.php?filename=demo_delete_all"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>   
</div>
...
<p>Because we omit the <code class="w3-codespan">WHERE</code> clause in the 
<code class="w3-codespan">DELETE</code> statement above, all records will be deleted from the 
cars table.</p>

<p>The same would have been achieved by using the
<code class="w3-codespan">TRUNCATE TABLE</code> statement:</p>
...
<div class="w3-example">
  ...
  <a target="_blank"
     href="trypostgresql.php?filename=demo_truncate"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>   
</div>
<hr>
<div id="exercisecontainer" src="xrcise_delete.js" data-extensions="php"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="postgresql_drop_column.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_drop_table.php">Next &#10095;</a>
