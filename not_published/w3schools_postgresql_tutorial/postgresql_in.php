...
ny:-->
    ...
    <h1>PostgreSQL IN Operator</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="postgresql_like.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_between.php">Next &#10095;</a>
</div>
...
<p>The <code class="w3-codespan">IN</code>
operator allows you to specify a list of possible values in the WHERE clause.</p>

<p>The <code class="w3-codespan">IN</code>
operator is a shorthand for multiple <code class="w3-codespan">OR</code> conditions.</p>
...
<div class="w3-example">
  ...
  <a target="_blank"
     href="trypostgresql.php?filename=demo_in"
...
<p>By using the <code class="w3-codespan">NOT</code> keyword in front of the <code class="w3-codespan">IN</code>
operator, you return all records that are NOT any of the values in the list.</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Return all customers that are NOT from 'Germany', France' or 'UK':</p>  
  <div class="w3-code notranslate w3-black shellcommands">
          SELECT * FROM customers<br>
          WHERE country NOT IN ('Germany', 'France', 'UK');
  </div>
  <a target="_blank"
     href="trypostgresql.php?filename=demo_not_in"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>  
</div>
...
<p>You can also use a <code class="w3-codespan">SELECT</code> statement inside the parenthesis to return all records
that are in the result of the <code class="w3-codespan">SELECT</code> statement.</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Return all customers that have an order in the <code class="w3-codespan">orders</code> table:</p>  
  <div class="w3-code notranslate w3-black shellcommands">
          SELECT * FROM customers<br>
          WHERE customer_id IN (SELECT customer_id FROM orders);
  </div>
  <a target="_blank"
     href="trypostgresql.php?filename=demo_in_select"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>  
</div>
...
<p>The result in the example above returned 89 records, that means that there are 2 customers that 
haven't placed any orders.</p>

<p>Let us check if that is correct, by using the <code class="w3-codespan">NOT IN</code> operator.</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Return all customers that have NOT placed any orders in the <code class="w3-codespan">orders</code> table:</p>  
  <div class="w3-code notranslate w3-black shellcommands">
          SELECT * FROM customers<br>
          WHERE customer_id NOT IN (SELECT customer_id FROM orders);
  </div>
  <a target="_blank"
     href="trypostgresql.php?filename=demo_not_in_select"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>  
</div>
<hr>
<div id="exercisecontainer" src="xrcise_in.js" data-extensions="php"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="postgresql_like.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_between.php">Next &#10095;</a>
