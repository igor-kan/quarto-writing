...
ny:-->
    ...
    <h1>PostgreSQL CROSS JOIN</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="postgresql_full_join.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_union.php">Next &#10095;</a>
</div>
...
<p>The <code class="w3-codespan">CROSS JOIN</code> keyword returns the Cartesian 
product of two or more 
  tables (combines every row from the first table with every row from the second 
table).</p>
<p><strong>Note:</strong> So, if the first table has 100 rows, and the second 
table has 500 rows, the result set will be 100x500 rows. Be aware that
<code class="w3-codespan">CROSS JOIN</code> can potentially return <strong>very large 
result-sets</strong>!</p>
...
<p><b>Note:</b> The <code class="w3-codespan">CROSS JOIN</code> method will 
return ALL <code class="w3-codespan">categories</code> for EACH
<code class="w3-codespan">testproduct</code>, meaning that it will return 80 
rows (10 * 8).</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Join <code class="w3-codespan">testproducts</code> to <code class="w3-codespan">
  categories</code> using the <code class="w3-codespan">CROSS JOIN</code> 
  keyword:</p>  
  ...
  <a class="w3-btn w3-margin-bottom" href="trypostgresql.php?filename=demo_cross_join" target="_blank">Run Example &raquo;
  </a>  
</div>

<div class="w3-example">
  <h3>Result</h3>
  <p>All <code class="w3-codespan">categories</code> for each
  <code class="w3-codespan">testproduct</code> will be returned:</p>
  <div class="w3-code notranslate w3-black" style="overflow:auto;white-space:nowrap">
    &nbsp;testproduct_id 
    |&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; product_name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | 
    category_name<br>----------------+------------------------+----------------<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
...
<div id="exercisecontainer" src="xrcise_cross_join.js" data-extensions="php"></div>
<hr>
