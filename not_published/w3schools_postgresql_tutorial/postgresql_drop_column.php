...
<html lang="en-US">
<head>
<title>PostgreSQL - ALTER TABLE - DROP COLUMN</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>PostgreSQL DROP COLUMN</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="postgresql_alter_column.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_delete.php">Next &#10095;</a>
</div>
...
<p>To remove a column from a table, we have to use the <code class="w3-codespan">ALTER TABLE</code> statement.</p>
...
<p>We want to remove the column named <code class="w3-codespan">color</code> from the
<code class="w3-codespan">cars</code> table.</p>

<p>To remove a column, use the <code class="w3-codespan">DROP COLUMN</code>
statement:</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Remove the <code class="w3-codespan">color</code> column:</p>
...
<div class="w3-example">
  ...
  <a target="_blank"
     href="trypostgresql.php?filename=demo_drop_column"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>   
</div>


<p>As you can see in the result, the <code class="w3-codespan">color</code> column has been removed from the
<code class="w3-codespan">cars</code> table.</p>
...
<div id="exercisecontainer" src="xrcise_drop_column.js" data-extensions="php"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="postgresql_alter_column.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_delete.php">Next &#10095;</a>
