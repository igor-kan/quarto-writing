...
ny:-->
    ...
    <h1>PostgreSQL RIGHT JOIN</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="postgresql_left_join.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_full_join.php">Next &#10095;</a>
</div>
...
<p>The <code class="w3-codespan">RIGHT JOIN</code> keyword selects ALL records from the "right" table,
...
<p>By using <code class="w3-codespan">RIGHT JOIN</code> we will get all 
records from <code class="w3-codespan">categories</code>, even the ones with no 
match in the <code class="w3-codespan">testproducts</code> table:</p>
...
<div class="w3-example">
  ...
  <a class="w3-btn w3-margin-bottom" href="trypostgresql.php?filename=demo_right_join" target="_blank">Run Example &raquo;
  </a>  
</div>

<div class="w3-example">
  <h3>Result</h3>
  <p>All records from <code class="w3-codespan">categories</code>, and only the matched records from
  ...
  <div class="w3-code notranslate w3-black" style="overflow:auto;white-space:nowrap">
    ...
    | Beverages<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    |&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    | Produce<br>(8 rows)<br></div>
</div>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> <code class="w3-codespan">RIGHT JOIN</code> and <code class="w3-codespan">
RIGHT OUTER JOIN</code>
will give the same result.</p>
  <p><code class="w3-codespan">OUTER</code> is the default join type for 
<code class="w3-codespan">RIGHT JOIN</code>, so when you write
<code class="w3-codespan">RIGHT JOIN</code> the parser actually writes
...
<div id="exercisecontainer" src="xrcise_right_join.js" data-extensions="php"></div>
<hr>
