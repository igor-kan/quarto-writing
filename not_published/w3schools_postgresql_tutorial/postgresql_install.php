...
ny:-->
    ...
    <h1>Install Introduction</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="postgresql_intro.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_getstarted.php">Next &#10095;</a>
</div>
...
<p>To install PostgreSQL locally on your computer, visit the
<a href="https://www.enterprisedb.com/downloads/postgres-postgresql-downloads" target="_blank">
installer by EDB</a>, and download the newest version compatible with your operating system.</p>
<p>I will choose the newest Windows version:</p>
<a href="https://www.enterprisedb.com/downloads/postgres-postgresql-downloads" target="_blank">
<img src="screenshot_postgresql_download.png" class="postgresql_screenshot" style="border:none;">
</a>

<hr>

<h2>Start the Install</h2>
<p>When the downloading is complete, double click the downloaded file and start the installation:</p>
<img src="screenshot_postgresql_install2.png" class="postgresql_screenshot">
<hr>
<h2>Specify Directory</h2>
<p>You can specify the location of PostgreSQL, I will go with the default choice:</p>
<img src="screenshot_postgresql_install3.png" class="postgresql_screenshot">
<hr>
<h2>Select Components</h2>
<p>To use PostgreSQL, you will need to install the PostgreSQL Server. In this tutorial we will also use the 
pgAdmin 4 component, and the Command Line Tools:</p>
<img src="screenshot_postgresql_install4.png" class="postgresql_screenshot">
<hr>
<h2>Storage Directory</h2>
<p>You can also choose where to store the database data, I will go with the default choice:</p>
<img src="screenshot_postgresql_install5.png" class="postgresql_screenshot">
<hr>
<h2>Select Password</h2>
<p>You will have to select a password to get access to the database.
Since this is a local database, with no incoming connection, I will choose the password 12345678:</p>
<img src="screenshot_postgresql_install6.png" class="postgresql_screenshot">
<hr>
<h2>Select Port</h2>
<p>You can set the port the server should listen on, I will go with the default choice:</p>
<img src="screenshot_postgresql_install7.png" class="postgresql_screenshot">
<hr>
<h2>Select Locale</h2>
<p>Select the geographically location of the database server:</p>
<img src="screenshot_postgresql_install8.png" class="postgresql_screenshot">
<hr>
<h2>Final Check</h2>
<p>If everything looks OK, click 'Next' to continue:</p>
<img src="screenshot_postgresql_install9.png" class="postgresql_screenshot">
<hr>
<h2>
Start Installation:</h2>
<p>Click 'Next' to start the installation:</p>
<img src="screenshot_postgresql_install10.png" class="postgresql_screenshot">
...
<h2>Installing</h2>
<p>This can take a while, please wait.</p>
<img src="screenshot_postgresql_install11.png" class="postgresql_screenshot">
<hr>
<h2>Complete!</h2>
<p>Now you have installed PostgreSQL on your computer, and in the next chapter you will start using it!</p>
<img src="screenshot_postgresql_install12.png" class="postgresql_screenshot">
