...
ny:-->
    ...
    <h1>PostgreSQL SUM Function</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="postgresql_count.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_avg.php">Next &#10095;</a>
</div>
...
<p>The <code class="w3-codespan">SUM()</code>
function returns the total sum of a numeric column. </p>

<p>The following SQL statement finds the sum of the
<code class="w3-codespan">quantity</code> fields in the
<code class="w3-codespan">order_details</code> table:</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Return the total amount of ordered items:</p>  
  <div class="w3-code notranslate w3-black shellcommands">
          SELECT SUM(quantity)<br>
          FROM order_details;
  </div>
  <a target="_blank"
     href="trypostgresql.php?filename=demo_sum"
...
<div id="exercisecontainer" src="xrcise_sum.js" data-extensions="php"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="postgresql_count.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_avg.php">Next &#10095;</a>
