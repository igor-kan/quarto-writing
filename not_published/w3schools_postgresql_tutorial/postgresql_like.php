...
ny:-->
    ...
    <h1>PostgreSQL LIKE Operator</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="postgresql_count_avg_sum.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_in.php">Next &#10095;</a>
</div>
...
<p>The <code class="w3-codespan">LIKE</code>
operator is used in a <code class="w3-codespan">WHERE</code> clause to search for a specified pattern in a column.</p>

<p>There are two wildcards often used in conjunction with the <code class="w3-codespan">LIKE</code> operator:</p>

<ul>
<li><code class="w3-codespan">%</code> The percent sign represents zero, one, or multiple characters</li>
<li><code class="w3-codespan">_</code> The underscore sign represents one, single character</li>
</ul>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Return all customers with a name that starts with the letter 'A':</p>  
  <div class="w3-code notranslate w3-black shellcommands">
          SELECT * FROM customers<br>
          WHERE customer_name LIKE 'A%';
  </div>
  <a target="_blank"
     href="trypostgresql.php?filename=demo_like"
...
<p>To return records that contains a specific letter or phrase, add the <code class="w3-codespan">%</code> both before and after the letter or phrase.</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Return all customers with a name that contains the letter 'A':</p>  
  <div class="w3-code notranslate w3-black shellcommands">
          SELECT * FROM customers<br>
          WHERE customer_name LIKE '%A%';
  </div>
  <a target="_blank"
     href="trypostgresql.php?filename=demo_like_contains"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>  
</div>
...
<p><strong>Note:</strong> The <code class="w3-codespan">LIKE</code> operator is case sensitive,
if you want to do a case insensitive search, use the <code class="w3-codespan">ILIKE</code> operator instead.</p>
</div>

<div class="w3-example">
  <h3>Example</h3>
  <p>Return all customers with a name that contains the letter 'A' or 'a':</p>  
  <div class="w3-code notranslate w3-black shellcommands">
          SELECT * FROM customers<br>
          WHERE customer_name ILIKE '%A%';
  </div>
  <a target="_blank"
     href="trypostgresql.php?filename=demo_ilike_contains"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>  
</div>
...
<p>To return records that ends with a specific letter or phrase,
add the <code class="w3-codespan">%</code> before the letter or phrase.</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Return all customers with a name that ends with the phrase 'en':</p>  
  <div class="w3-code notranslate w3-black shellcommands">
          SELECT * FROM customers<br>
          WHERE customer_name LIKE '%en';
  </div>
  <a target="_blank"
     href="trypostgresql.php?filename=demo_like_ends"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>  
</div>
...
<h2>The Underscore <code class="w3-codespan">_</code> Wildcard</h2>
...
<div class="w3-example">
  ...
  <a target="_blank"
     href="trypostgresql.php?filename=demo_like_"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>  
</div>
<hr>
<div id="exercisecontainer" src="xrcise_like.js" data-extensions="php"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="postgresql_count_avg_sum.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_in.php">Next &#10095;</a>
