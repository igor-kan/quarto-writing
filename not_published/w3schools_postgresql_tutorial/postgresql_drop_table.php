...
<html lang="en-US">
<head>
<title>PostgreSQL - The DROP TABLE Statement</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="postgresql_delete.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_create_demodatabase.php">Next &#10095;</a>
</div>
...
<p><strong>Note:</strong> Be careful before dropping a table.
Deleting a table will result in loss of all information stored in the table!</p>
</div>

<p>The following SQL statement drops the existing table <code class="w3-codespan">cars</code>:</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Delete the <code class="w3-codespan">cars</code> table:</p>
...
<p>Which will result in an error, because the <code class="w3-codespan">cars</code> 
table no longer exists:</p>

<div class="w3-example">
  <h3>Result</h3>
  <div class="w3-code notranslate w3-black">
    ERROR: relation &quot;cars&quot; does not exist<br>LINE 1: SELECT * FROM cars;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    ^</div>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_drop_table.js" data-extensions="php"></div>
