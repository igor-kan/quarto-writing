...
<html lang="en-US">
<head>
<title>PostgreSQL - Insert Data</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="postgresql_create_table.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_fetch_data.php">Next &#10095;</a>
</div>
...
<p>To insert data into a table in PostgreSQL, we use the
<code class="w3-codespan">INSERT INTO</code> statement.</p>

<p>The following SQL statement will insert one row of data into the
<code class="w3-codespan">cars</code> table you created in
<a href="postgresql_create_table.php"> the previous chapter</a>.</p>


<div class="w3-example">
  <div class="w3-code notranslate w3-black shellcommands">
INSERT INTO cars (brand, model, year)<br>
VALUES ('Ford', 'Mustang', 1964);
  </div>
</div>

<p>The SQL Shell application will return the following:</p>
...
<p>Which means that <code class="w3-codespan">1</code> row was inserted.</p>

<div class="w3-panel ws-note">
<p>Don't think about the <code class="w3-codespan">0</code>, for now, just accept that it represents 
something else and will always be <code class="w3-codespan">0</code>.</p>
</div>
...
<p>As you can see in the SQL statement above, string values must be written with 
apostrophes.</p>

<p>Numeric values can be written without apostrophes, but you can include them if you want.</p>
...
<p>To insert multiple rows of data, we use the same <code class="w3-codespan">INSERT INTO</code> statement,
but with multiple values:</p>
...
<p>Which means <code class="w3-codespan">3</code> rows were successfully inserted.</p>
...
<h3>Example</h3>
  ...
  <a target="_blank"
     href="trypostgresql.php?filename=demo_select_all"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>   
</div>

<p>Click the "Run Example" button to see the result of the select statement.</p>

<hr>
<div id="exercisecontainer" src="xrcise_insert_into.js" data-extensions="php"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="postgresql_create_table.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_fetch_data.php">Next &#10095;</a>
