...
<html lang="en-US">
<head>
<title>PostgreSQL - AS = Aliases</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="postgresql_between.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_joins.php">Next &#10095;</a>
</div>
...
<h2>AS is Optional</h2>

<p>Actually, you can skip the <code class="w3-codespan">AS</code>
keyword and get the same result:</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Same result without <code class="w3-codespan">AS</code>:</p>  
  <div class="w3-code notranslate w3-black shellcommands">
        SELECT customer_id id<br>
        FROM customers;
  </div>
  <a target="_blank"
     href="trypostgresql.php?filename=demo_as2"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>  
</div>
...
<p>The <code class="w3-codespan">AS</code>
keyword is often used when two or more fields are concatenated into one.</p>
<p>To concatenate two fields use <code class="w3-codespan">||</code>.</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Concatenate two fields and call them <code class="w3-codespan">product</code>:</p>  
  <div class="w3-code notranslate w3-black shellcommands">
        SELECT product_name 
        || unit AS product<br>
        FROM products;
  ...
  <a target="_blank"
     href="trypostgresql.php?filename=demo_as_concat"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>  
</div>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> In the result of the example above we are missing a space between
product_name and unit. To add a space when concatenating, use <code class="w3-codespan">|| ' ' ||</code>.</p>
</div>
<div class="w3-example">
  <h3>Example</h3>
  <p>Concatenate, with space:</p>  
  <div class="w3-code notranslate w3-black shellcommands">
        SELECT product_name || ' ' || unit AS product<br>
        FROM products;
  </div>
  <a target="_blank"
     href="trypostgresql.php?filename=demo_as_concat2"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>  
</div>
...
<h2>Using Aliases With a Space Character</h2>

<p>If you want your alias to contain one or more spaces, like "<code class="w3-codespan">My Great Products</code>", surround your alias with double quotes.</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Surround your alias with double quotes:</p>  
  <div class="w3-code notranslate w3-black shellcommands">
        SELECT product_name AS "My Great Products"<br>
        FROM products;
  </div>
  <a target="_blank"
     href="trypostgresql.php?filename=demo_as_space"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>  
</div>

<hr>
<div id="exercisecontainer" src="xrcise_as.js" data-extensions="php"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="postgresql_between.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_joins.php">Next &#10095;</a>
