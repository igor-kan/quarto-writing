...
<html lang="en-US">
<head>
<title>PostgreSQL - ALTER TABLE - ALTER COLUMN</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>PostgreSQL ALTER COLUMN</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="postgresql_update.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_drop_column.php">Next &#10095;</a>
</div>
...
<p>To change the data type, or the size of a table column we have to use the <code class="w3-codespan">ALTER TABLE</code> statement.</p>

<p>The <code class="w3-codespan">ALTER TABLE</code> statement is used to add, delete,
or modify columns in an existing table.</p>

<p>The <code class="w3-codespan">ALTER TABLE</code> statement is also used to add and drop various constraints on an existing table.</p>

<hr>

<h2>ALTER COLUMN</h2>

<p>We want to change the data type of the <code class="w3-codespan">year</code> column of the
<code class="w3-codespan">cars</code> table from <code class="w3-codespan">INT
</code>to <code class="w3-codespan">VARCHAR(4)</code>.</p>

<p>To modify a column, use the <code class="w3-codespan">ALTER COLUMN</code>
statement and the <code class="w3-codespan">TYPE</code> keyword followed by the 
new data type:</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Change the <code class="w3-codespan">year</code> column from
  <code class="w3-codespan">INT</code> to <code class="w3-codespan">VARCHAR(4)</code>:</p>
...
<p><b>Note:</b> Some data types cannot be converted if the column has value.
...
<h2>Change Maximum Allowed Characters</h2>

<p>We also want to change the maximum number of characters allowed in the
<code class="w3-codespan">color</code> column of the
<code class="w3-codespan">cars</code> table.</p>

<p>Use the same syntax as above, use the <code class="w3-codespan">ALTER COLUMN</code>
statement and the <code class="w3-codespan">TYPE</code> keyword followed by the 
new data type:</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Change the <code class="w3-codespan">color</code> column from
  <code class="w3-codespan">VARCHAR(255)</code> to <code class="w3-codespan">VARCHAR(30)</code>:</p>
  <div class="w3-code notranslate w3-black shellcommands">
          ALTER TABLE cars<br>
...
<div id="exercisecontainer" src="xrcise_alter_column.js" data-extensions="php"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="postgresql_update.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_drop_column.php">Next &#10095;</a>
