...
ny:-->
    ...
    <h1>PostgreSQL FULL JOIN</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="postgresql_right_join.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_cross_join.php">Next &#10095;</a>
</div>
...
<p>The <code class="w3-codespan">FULL JOIN</code> keyword selects ALL records from 
...
value <code class="w3-codespan">NULL</code>.</p>
...
<p>By using <code class="w3-codespan">FULL JOIN</code> we will get all 
records from both the <code class="w3-codespan">categories</code> table and the
<code class="w3-codespan">testproducts</code> table:</p>
...
<div class="w3-example">
  ...
  <a class="w3-btn w3-margin-bottom" href="trypostgresql.php?filename=demo_full_join" target="_blank">Run Example &raquo;
  </a>  
</div>

<div class="w3-example">
  <h3>Result</h3>
  <p>All records from both tables are returned.</p>
  <p>Rows with no match will get a <code class="w3-codespan">NULL</code> value 
  in fields from the opposite table:</p>
  <div class="w3-code notranslate w3-black" style="overflow:auto;white-space:nowrap">
    &nbsp;testproduct_id |&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; product_name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    | category_name<br>
    ----------------+-------------------------+----------------<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    ...
    | Beverages<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    |&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    | Produce<br>(14 rows)<br></div>
</div>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> <code class="w3-codespan">FULL JOIN</code> and <code class="w3-codespan">
FULL OUTER JOIN</code>
will give the same result.</p>
  <p><code class="w3-codespan">OUTER</code> is the default join type for 
<code class="w3-codespan">FULL JOIN</code>, so when you write
<code class="w3-codespan">FULL JOIN</code> the parser actually writes
  <code class="w3-codespan">FULL OUTER JOIN</code>.</p>
</div>
...
<div id="exercisecontainer" src="xrcise_full_join.js" data-extensions="php"></div>
<hr>
