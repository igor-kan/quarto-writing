...
<html lang="en-US">
<head>
<title>PostgreSQL - GROUP BY UNION Clause</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>PostgreSQL GROUP BY Clause</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="postgresql_union.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_having.php">Next &#10095;</a>
</div>
...
<p>The <code class="w3-codespan">GROUP BY</code> clause groups rows that have the same values into summary rows,
like "find the number of customers in each country".</p>

<p>The <code class="w3-codespan">GROUP BY</code> clause is often used with aggregate functions like 
<code class="w3-codespan">COUNT()</code>,
<code class="w3-codespan">MAX()</code>,
<code class="w3-codespan">MIN()</code>,
<code class="w3-codespan">SUM()</code>,
<code class="w3-codespan">AVG()</code> to group the result-set by one or more columns.</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Lists the number of customers in each country:</p>  
  <div class="w3-code notranslate w3-black shellcommands">
        SELECT COUNT(customer_id), country<br>
        FROM customers<br>
        GROUP BY country;
  </div>
  <a class="w3-btn w3-margin-bottom" href="trypostgresql.php?filename=demo_groupby_count" target="_blank">Run Example &raquo;
  </a>  
</div>

<hr>

<h2>GROUP BY With JOIN</h2>

<p>The following SQL statement lists the number of orders made by each customer:</p>

<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate w3-black shellcommands">
SELECT customers.customer_name, COUNT(orders.order_id)<br>
FROM orders<br>
LEFT JOIN customers ON orders.customer_id = customers.customer_id<br>
GROUP BY customer_name;      

  </div>
  <a class="w3-btn w3-margin-bottom" href="trypostgresql.php?filename=demo_groupby" target="_blank">Run Example &raquo;
  </a>  
</div>
<hr>
...
<div id="exercisecontainer" src="xrcise_groupby.js" data-extensions="php"></div>
<hr>
