...
ny:-->
    ...
    <h1>PostgreSQL LIMIT</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="postgresql_orderby.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_min_max.php">Next &#10095;</a>
</div>
...
<p>The <code class="w3-codespan">LIMIT</code>
clause is used to limit the maximum number of records to return.</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Return only the 20 first records from the <code class="w3-codespan">customers</code> table:</p>  
  <div class="w3-code notranslate w3-black shellcommands">
          SELECT * FROM customers<br>
          LIMIT 20;
  </div>
  <a target="_blank"
     href="trypostgresql.php?filename=demo_limit"
...
<h2>The OFFSET Clause</h2>

<p>The <code class="w3-codespan">OFFSET</code>
clause is used to specify where to start selecting the records to return.</p>

<p>If you want to return 20 records, but start at number 40, you can use both
<code class="w3-codespan">LIMIT</code> and <code class="w3-codespan">OFFSET</code>.</p>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> The first record is number 
<code class="w3-codespan">0</code>, so when you specify
<code class="w3-codespan">OFFSET 40</code> it means starting at record number 41.</p>
</div>


<div class="w3-example">
  <h3>Example</h3>
  <p>Return 20 records, starting from the 41th record:</p>  
  <div class="w3-code notranslate w3-black shellcommands">
          SELECT * FROM customers<br>
          LIMIT 20 OFFSET 40;
  </div>
  <a target="_blank"
     href="trypostgresql.php?filename=demo_limit_offset"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>  
</div>

<hr>
<div id="exercisecontainer" src="xrcise_limit.js" data-extensions="php"></div>
