...
<html lang="en-US">
<head>
<title>PostgreSQL - Operators</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="postgresql_create_demodatabase.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_select.php">Next &#10095;</a>
</div>
...
<p>We can operate with different operators in the <code class="w3-codespan">WHERE</code> clause:</p>

<table style="margin-left:20px;">
<tr><th><code class="w3-codespan">=</code></th><td>Equal to</td></tr>
<tr><th><code class="w3-codespan">&lt;</code></th><td>Less than</td></tr>
<tr><th><code class="w3-codespan">&gt;</code></th><td>Greater than</td></tr>
<tr><th><code class="w3-codespan">&lt;=</code></th><td>Less than or equal to</td></tr>
<tr><th><code class="w3-codespan">&gt;=</code></th><td>Greater than or equal to</td></tr>
<tr><th><code class="w3-codespan">&lt;&gt;</code></th><td>Not equal to</td></tr>
<tr><th><code class="w3-codespan">!=</code></th><td>Not equal to</td></tr>
<tr><th><code class="w3-codespan">LIKE</code></th><td>Check if a value matches a pattern (case sensitive)</td></tr>
<tr><th><code class="w3-codespan">ILIKE</code></th><td>Check if a value matches a pattern (case 
  insensitive)</td></tr>
<tr><th><code class="w3-codespan">AND</code></th><td>Logical AND</td></tr>
<tr><th><code class="w3-codespan">OR</code></th><td>Logical OR</td></tr>
<tr><th><code class="w3-codespan">IN</code></th><td>Check if a value matches any value within a provided list</td></tr>
<tr><th><code class="w3-codespan">BETWEEN</code></th><td>Check if a value is within a specified range</td></tr>
<tr><th><code class="w3-codespan">IS NULL</code></th><td>Check if a value is NULL</td></tr>
<tr><th><code class="w3-codespan">NOT</code></th><td>Makes a negative result e.g. 
  <code class="w3-codespan">NOT LIKE</code>, <code class="w3-codespan">NOT IN</code>, 
  <code class="w3-codespan">NOT BETWEEN</code></td></tr>
</table>
...
<p>The <code class="w3-codespan">=</code> operator is used when you want to return all records where a
column is equal to a specified value:</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Return all records where the brand is 'Volvo':</p>
  <div class="w3-code notranslate w3-black shellcommands">
          SELECT * FROM cars<br>
          WHERE brand = 'Volvo';
  </div>
  <a target="_blank"
     href="trypostgresql.php?filename=demo_operator_equal"
...
<p>The <code class="w3-codespan">&lt;</code> operator is used when you want to return all records where a
column is less than a specified value.</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Return all records where the year is less than 1975:</p>
  <div class="w3-code notranslate w3-black shellcommands">
          SELECT * FROM cars<br>
          WHERE year &lt; 1975;
  </div>
  <a target="_blank"
     href="trypostgresql.php?filename=demo_operator_less"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>    
</div>
...
<p>The <code class="w3-codespan">&gt;</code> operator is used when you want to return all records where a
columns is greater than a specified value.</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Return all records where the year is greater than 1975:</p>
  <div class="w3-code notranslate w3-black shellcommands">
          SELECT * FROM cars<br>
          WHERE year &gt; 1975;
  </div>
  <a target="_blank"
     href="trypostgresql.php?filename=demo_operator_greater"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>    
</div>
...
<p>The <code class="w3-codespan">&lt;=</code> operator is used when you want to return all records where a
column is less than, or equal to, a specified value.</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Return all records where the year is less than or equal to 1975:</p>
  <div class="w3-code notranslate w3-black shellcommands">
          SELECT * FROM cars<br>
          WHERE year &lt;= 1975;
  </div>
  <a target="_blank"
     href="trypostgresql.php?filename=demo_operator_less_or_equal"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>    
</div>
...
<p>The <code class="w3-codespan">&gt;=</code> operator is used when you want to return all records where a
columns is greater than, or equal to, a specified value.</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Return all records where the year is greater than or equal 1975:</p>
  <div class="w3-code notranslate w3-black shellcommands">
          SELECT * FROM cars<br>
          WHERE year &gt;= 1975;
  </div>
  <a target="_blank"
     href="trypostgresql.php?filename=demo_operator_greater_or_equal"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>    
</div>
...
<p>The <code class="w3-codespan">&lt;&gt;</code> operator is used when you want to return all records where a
column is NOT equal to a specified value:</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Return all records where the brand is NOT 'Volvo':</p>
  <div class="w3-code notranslate w3-black shellcommands">
          SELECT * FROM cars<br>
          WHERE brand <> 'Volvo';
  </div>
  <a target="_blank"
     href="trypostgresql.php?filename=demo_operator_not_equal"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>    
</div>


<p>You will get the same result with the <code class="w3-codespan">!=</code> operator:</p>
...
<div class="w3-example">
  ...
  <a target="_blank"
     href="trypostgresql.php?filename=demo_operator_not_equal2"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>    
</div>
...
<p>The <code class="w3-codespan">LIKE</code> operator is used when you want to return all records where a
column is equal to a specified pattern.</p>

<p>The pattern can be an absolute value like 'Volvo', or with a wildcard that has a special meaning.</p>

<p>There are two wildcards often used in conjunction with the LIKE operator:</p>

<ul>
<li>The percent sign <code class="w3-codespan">%</code>, represents zero, one, or multiple characters.</li>
<li>The underscore sign <code class="w3-codespan">_</code>, represents one single character.</li>
</ul>

<div class="w3-example">
  <h3>Example</h3>
  <p>Return all records where the model STARTS with a capital 'M':</p>
  <div class="w3-code notranslate w3-black shellcommands">
          SELECT * FROM cars<br>
          WHERE model LIKE 'M%';
  </div>
  <a target="_blank"
     href="trypostgresql.php?filename=demo_operator_like"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>    
</div>

<div class="w3-panel ws-note">
<p>The <code class="w3-codespan">LIKE</code> operator is case sensitive.</p>
</div>
...
<p>Same as the <code class="w3-codespan">LIKE</code> operator, but
<code class="w3-codespan">ILIKE</code> is case insensitive.</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Return all records where the model start with a 'm':</p>
  <div class="w3-code notranslate w3-black shellcommands">
          SELECT * FROM cars<br>
          WHERE model ILIKE 'm%';
  </div>
  <a target="_blank"
     href="trypostgresql.php?filename=demo_operator_ilike"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>    
</div>
<hr>
...
<p>The logical <code class="w3-codespan">AND</code> operator is used when you want to
check more that one condition:</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Return all records where the brand is 'Volvo' and the year is 1968:</p>
  <div class="w3-code notranslate w3-black shellcommands">
          SELECT * FROM cars<br>
          WHERE brand = 'Volvo' AND year = 1968;
  </div>
  <a target="_blank"
     href="trypostgresql.php?filename=demo_operator_and"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>    
</div>
...
<p>The logical <code class="w3-codespan">OR</code> operator is used when you can accept that only one of many
conditions is true:</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Return all records where the brand is 'Volvo' OR the year is 1975:</p>
  <div class="w3-code notranslate w3-black shellcommands">
          SELECT * FROM cars<br>
          WHERE brand = 'Volvo' OR year = 1975;
  </div>
  <a target="_blank"
     href="trypostgresql.php?filename=demo_operator_or"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>    
</div>
...
<p>The <code class="w3-codespan">IN</code> operator is used when a column's value matches any of the values in a list:</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Return all records where the brand is present in this list: ('Volvo', 'Mercedes', 'Ford'):</p>
  <div class="w3-code notranslate w3-black shellcommands">
          SELECT * FROM cars<br>
          WHERE brand IN ('Volvo', 'Mercedes', 'Ford');
  </div>
  <a target="_blank"
     href="trypostgresql.php?filename=demo_operator_in"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>    
</div>
...
<p>The <code class="w3-codespan">BETWEEN</code> operator is used to check if a column's value
is between a specified range of values:</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Return all records where the year is between 1970 and 1980:</p>
  <div class="w3-code notranslate w3-black shellcommands">
          SELECT * FROM cars<br>
          WHERE year BETWEEN 1970 AND 1980;
  </div>
  <a target="_blank"
     href="trypostgresql.php?filename=demo_operator_between"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>    
</div>

<div class="w3-panel ws-note">
<p>The <code class="w3-codespan">BETWEEN</code> operator includes the
<code class="w3-codespan"><em>from</em></code> and
<code class="w3-codespan"><em>to</em></code> values, meaning that in the above example,
the result would include cars made in 1970 and 1980 as well.</p>
</div>

<hr>
<h2>IS NULL</h2>

<p>The <code class="w3-codespan">IS NULL</code> operator is used to check if a column's value
is NULL:</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Return all records where the model is NULL:</p>
  <div class="w3-code notranslate w3-black shellcommands">
          SELECT * FROM cars<br>
          WHERE model IS NULL;
  </div>
  <a target="_blank"
     href="trypostgresql.php?filename=demo_operator_is_null"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>    
</div>
...
<p>The <code class="w3-codespan">NOT</code> operator can be used together with 
<code class="w3-codespan">LIKE</code>, <code class="w3-codespan">ILIKE</code>, 
<code class="w3-codespan">IN</code>, <code class="w3-codespan">BETWEEN</code>, and 
<code class="w3-codespan">NULL</code> operators to reverse the truth of the operator.</p>

<div class="w3-example">
  <h3>Example: NOT LIKE</h3>
  <p>Return all records where the brand does NOT start with a capital 'B' (case sensitive):</p>
  <div class="w3-code notranslate w3-black shellcommands">
          SELECT * FROM cars<br>
          WHERE brand 
          NOT LIKE 'B%';
  ...
  <a target="_blank"
     href="trypostgresql.php?filename=demo_operator_not"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>    
</div>
...
<div class="w3-example">
  <h3>Example: NOT ILIKE</h3>
  <p>Return all records where the brand does NOT start with a 'b' (case 
  insensitive):</p>
  <div class="w3-code notranslate w3-black shellcommands">
          SELECT * FROM cars<br>
          WHERE brand 
  ...
  <a target="_blank"
     href="trypostgresql.php?filename=demo_operator_not2"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>    
</div>
...
<div class="w3-example">
  <h3>Example: NOT IN</h3>
  <p>Return all records where the brand is NOT present in this list: ('Volvo', 'Mercedes', 'Ford'):</p>
  <div class="w3-code notranslate w3-black shellcommands">
          SELECT * FROM cars<br>
          WHERE brand NOT IN ('Volvo', 'Mercedes', 'Ford');
  </div>
  <a target="_blank"
     href="trypostgresql.php?filename=demo_operator_not3"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>    
</div>
...
<div class="w3-example">
  ...
  <p>Return all records where the year is NOT between 1970 and 1980:</p>
  <div class="w3-code notranslate w3-black shellcommands">
          SELECT * FROM cars<br>
          WHERE year NOT BETWEEN 1970 AND 1980;
  </div>
  <a target="_blank"
     href="trypostgresql.php?filename=demo_operator_not4"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>    
</div>

<div class="w3-panel ws-note">
<p>The <code class="w3-codespan">NOT BETWEEN</code> operator excludes the
<code class="w3-codespan"><em>from</em></code> and
<code class="w3-codespan"><em>to</em></code> values, meaning that in the above example,
the result would not include cars made in 1970 and 1980.</p>
</div>


<div class="w3-example">
  <h3>Example: IS NOT NULL</h3>
  <p>Return all records where the model is NOT null:</p>
  <div class="w3-code notranslate w3-black shellcommands">
          SELECT * FROM cars<br>
          WHERE model IS NOT NULL;
  </div>
  <a target="_blank"
     href="trypostgresql.php?filename=demo_operator_not5"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>    
</div>
...
<div class="w3-panel ws-note">
<p>The <code class="w3-codespan">cars</code> table has no columns with NULL values,
so the example above will return all 4 rows.</p>
</div>
<hr>
