...
ny:-->
    ...
    <h1>PostgreSQL COUNT Function</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="postgresql_min_max.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_sum.php">Next &#10095;</a>
</div>
...
<p>The <code class="w3-codespan">COUNT()</code>
function returns the number of rows that matches a specified criterion.</p>

<p>If the specified criterion is a column name,
the <code class="w3-codespan">COUNT()</code> function returns the number of rows with that name.</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Return the number of customers from the <code class="w3-codespan">customers</code> table:</p>  
  <div class="w3-code notranslate w3-black shellcommands">
          SELECT COUNT(customer_id)<br>
          FROM customers;
  </div>
  <a target="_blank"
     href="trypostgresql.php?filename=demo_count"
...
<p>By specifying a <code class="w3-codespan">WHERE</code> clause, you can e.g. return the number of customers
that comes from London:</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Return the number of customers from London:</p>  
  <div class="w3-code notranslate w3-black shellcommands">
          SELECT COUNT(customer_id)<br>
          FROM customers<br>
          WHERE city = 'London';
  ...
  <a target="_blank"
     href="trypostgresql.php?filename=demo_count_where"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>  
</div>
<hr>
...
<div id="exercisecontainer" src="xrcise_count.js" data-extensions="php"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="postgresql_min_max.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_sum.php">Next &#10095;</a>
