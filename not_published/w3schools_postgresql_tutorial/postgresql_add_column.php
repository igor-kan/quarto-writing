...
ny:-->
    ...
    <h1>PostgreSQL ADD COLUMN</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="postgresql_fetch_data.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_update.php">Next &#10095;</a>
</div>
...
<p>To add a column to an existing table, we have to use the <code class="w3-codespan">ALTER TABLE</code> statement.</p>
...
<p>We want to add a column named <code class="w3-codespan">color</code> to our <code class="w3-codespan">cars</code> table.</p>

<p>When adding columns we must also specify the data type of the column. Our <code class="w3-codespan">color</code>
column will be a string, and we specify string types with the <code class="w3-codespan">VARCHAR</code>
keyword. we also want to restrict the number of characters to 255:</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Add a column named <code class="w3-codespan">color</code>:</p>
...
<h3>Example</h3>
  ...
  <a target="_blank"
     href="trypostgresql.php?filename=demo_add_column"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>   
</div>


<p>As you can see, the <code class="w3-codespan">cars</code> table now has a 
<code class="w3-codespan">color</code> column.</p>

<p>The new column is empty, you will learn how to fill it with values in the
<a href="postgresql_update.php">next chapter</a>.</p>
...
<div id="exercisecontainer" src="xrcise_add_column.js" data-extensions="php"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="postgresql_fetch_data.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_update.php">Next &#10095;</a>
