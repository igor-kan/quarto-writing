...
ny:-->
    ...
    <h1>PostgreSQL EXISTS Operator</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="postgresql_having.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_any.php">Next &#10095;</a>
</div>
...
<p>The <code class="w3-codespan">EXISTS</code> operator is used to test for the existence of any record in a 
sub query.</p>

<p>The <code class="w3-codespan">EXISTS</code> operator returns TRUE if the sub 
query returns one or more records.</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Return all customers that is represented in the <code class="w3-codespan">orders</code> table:</p>  
...
FROM orders<br>&nbsp; WHERE customer_id = customers.customer_id<br>);
  ...
  <a class="w3-btn w3-margin-bottom" href="trypostgresql.php?filename=demo_exists" target="_blank">Run Example &raquo;
  </a>  
</div>

<p>The result in example above showed that 89 customers had at least one order in the 
<code class="w3-codespan">orders</code> table.</p>

<hr>

<h2>NOT EXISTS</h2>

<p>To check which customers that do not have any orders, we can use the
<code class="w3-codespan">NOT</code> operator together with the <code class="w3-codespan">EXISTS</code> 
operator :</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Return all customers that is NOT represented in the <code class="w3-codespan">orders</code> table:</p>  
  <div class="w3-code notranslate w3-black shellcommands">
SELECT customers.customer_name<br>
FROM customers<br>
WHERE NOT EXISTS (<br>
...
FROM orders<br>&nbsp; WHERE customer_id = customers.customer_id<br>);
  ...
  <a class="w3-btn w3-margin-bottom" href="trypostgresql.php?filename=demo_not_exists" target="_blank">Run Example &raquo;
  </a>  
</div>
<hr>
<div id="exercisecontainer" src="xrcise_exists.js" data-extensions="php"></div>
