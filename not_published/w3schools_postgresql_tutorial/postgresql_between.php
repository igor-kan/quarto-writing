...
ny:-->
    ...
    <h1>PostgreSQL BETWEEN Operator</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="postgresql_in.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_as.php">Next &#10095;</a>
</div>
...
<p>The <code class="w3-codespan">BETWEEN</code>
operator selects values within a given range. The values can be numbers, text, or dates.</p>

<p>The <code class="w3-codespan">BETWEEN</code>
operator is inclusive: begin and end values are included.</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Select all products with a price between 10 and 15:</p>  
  <div class="w3-code notranslate w3-black shellcommands">
        SELECT * FROM Products<br>
        WHERE Price BETWEEN 10 AND 15;
  </div>
  <a target="_blank"
     href="trypostgresql.php?filename=demo_between"
...
<p>The <code class="w3-codespan">BETWEEN</code>
operator can also be used on text values.</p>

<p>The result returns all records that are <em>alphabetically</em> between the specified values.</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Select all products between 'Pavlova' and 'Tofu':</p>  
  <div class="w3-code notranslate w3-black shellcommands">
        SELECT * FROM Products<br>
        WHERE product_name BETWEEN 'Pavlova' AND 'Tofu';
  </div>
  <a target="_blank"
     href="trypostgresql.php?filename=demo_between_text"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>  
</div>


<p>If we add an <code class="w3-codespan">ORDER BY</code>
clause to the example above, it will be a bit easier to read:</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Same example as above, but we sort it by <code class="w3-codespan">product_name</code>:</p>  
  <div class="w3-code notranslate w3-black shellcommands">
        SELECT * FROM Products<br>
  ...
  <a target="_blank"
     href="trypostgresql.php?filename=demo_between_text_orderby"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>  
</div>
...
<h2>BETWEEN Date Values</h2>

<p>The <code class="w3-codespan">BETWEEN</code>
operator can also be used on date values.</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Select all orders between 12. of April 2023 and 5. of May 2023:</p>  
  <div class="w3-code notranslate w3-black shellcommands">
        SELECT * FROM orders<br>
        WHERE order_date BETWEEN '2023-04-12' AND '2023-05-05';
  </div>
  <a target="_blank"
     href="trypostgresql.php?filename=demo_between_date"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>  
</div>

<hr>
<div id="exercisecontainer" src="xrcise_between.js" data-extensions="php"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="postgresql_in.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_as.php">Next &#10095;</a>
