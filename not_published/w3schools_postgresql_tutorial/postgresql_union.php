...
ny:-->
    ...
    <h1>PostgreSQL UNION Operator</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="postgresql_cross_join.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_groupby.php">Next &#10095;</a>
</div>
...
<p>The <code class="w3-codespan">UNION</code> operator is used to combine the result-set of two or more queries.</p>

<p>The queries in the union must follow these rules:</p>
<ul>
  <li>They must have the same number of columns</li>
  <li>The columns must have the same data types</li>
  <li>The columns must be in the same order</li>
</ul>

<div class="w3-example">
  <h3>Example</h3>
  <p>Combine <code class="w3-codespan">products</code> and
  <code class="w3-codespan">
  testproducts</code> using the <code class="w3-codespan">UNION</code> operator:</p>  
  ...
  <a class="w3-btn w3-margin-bottom" href="trypostgresql.php?filename=demo_union" target="_blank">Run Example &raquo;
  </a>  
</div>
...
<p>With the <code class="w3-codespan">UNION</code> operator,
if some rows in the two queries returns the exact same result, only one row will be listed,
because <code class="w3-codespan">UNION</code> selects only distinct values.</p>

<p>Use <code class="w3-codespan">UNION ALL</code> to return duplicate values.<p>
...
<div class="w3-example">
  ...
  <a class="w3-btn w3-margin-bottom" href="trypostgresql.php?filename=demo_union2" target="_blank">Run Example &raquo;
  </a>  
</div>
<div class="w3-example">
  ...
  <a class="w3-btn w3-margin-bottom" href="trypostgresql.php?filename=demo_union_all" target="_blank">Run Example &raquo;
  </a>  
</div>
...
<div id="exercisecontainer" src="xrcise_union.js" data-extensions="php"></div>
<hr>
