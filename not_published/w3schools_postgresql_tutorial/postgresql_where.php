...
<html lang="en-US">
<head>
<title>PostgreSQL - WHERE - Filter Data</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>PostgreSQL WHERE - Filter Data</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="postgresql_select_distinct.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_orderby.php">Next &#10095;</a>
</div>
...
<p>If we want to return only the records where <code class="w3-codespan">city</code> is 
<code class="w3-codespan">London</code>,
we can specify that in the <code class="w3-codespan">WHERE</code> clause:</p>
...
<div class="w3-example">
  ...
  <a target="_blank"
     href="trypostgresql.php?filename=demo_where_customers"
...
<p>PostgreSQL requires quotes around text values.</p>
...
<div class="w3-example">
  ...
  <a target="_blank"
     href="trypostgresql.php?filename=demo_where_numeric_customers"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>    
</div>
...
<p>Quotes around numeric fields will not fail, but it is good practice to always write numeric values without quotes.</p>
</div>
...
<p>Use the <code class="w3-codespan">&gt;</code>  operator to return all records where
<code class="w3-codespan">customer_id</code> is greater than 80:</p>
...
<div class="w3-example">
  ...
  <a target="_blank"
     href="trypostgresql.php?filename=demo_where_greater_customers"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>    
</div>
...
<hr>
<div id="exercisecontainer" src="xrcise_where.js" data-extensions="php"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="postgresql_select_distinct.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_orderby.php">Next &#10095;</a>
