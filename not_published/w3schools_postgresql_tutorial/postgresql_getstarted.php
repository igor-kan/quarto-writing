...
<html lang="en-US">
<head>
<title>PostgreSQL - Get Started</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>PostgreSQL Get Started</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="postgresql_install.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_pgadmin4.php">Next &#10095;</a>
</div>
...
<p>If you have followed the steps from the <a href="postgresql_install.php">Install PostgreSQL</a> page,
you now have a PostgreSQL database on you computer.</p>

<p>There are several ways to connect to the database, we will look at two ways in this tutorial:</p>
<ul>
<li>SQL Shell (psql)</li>
<li>pgAdmin 4</li>
</ul>
<p>Both of them comes with the installation of PostgreSQL</p>
<hr>

<h2>SQL Shell (psql)</h2>

<p>SQL Shell (psql) is a terminal based program where you can write and execute SQL syntax in the command-line terminal.</p>

<h3>Open SQL Shell (psql)</h3>

<p>You will find the SQL Shell (psql) tool in the start menu under PostgreSQL:</p>

<p><img src="screenshot_postgresql_psql.png" class="postgresql_screenshot"></p>

<p><strong>Tip:</strong> If you cannot find it, try searching for "SQL Shell" on your computer.</p>

<p>Once the program is open, you should see a window like the one below.</p>
<p>Insert the name of the server.</p>
<p>The suggested choice is [localhost], which is correct, press [Enter] to accept:</p>
<p><img src="screenshot_postgresql_shell1.png" class="postgresql_screenshot"></p>
<hr>
<h2>Database</h2>
<p>The suggested database is [postgres], which is correct, press [Enter] to accept:</p>
<p><img src="screenshot_postgresql_shell2.png" class="postgresql_screenshot"></p>
<hr>
<h2>Port</h2>
<p>The suggested port is [5432], which is correct, at least in my case, press [Enter] to accept:</p>
<p><img src="screenshot_postgresql_shell3.png" class="postgresql_screenshot"></p>
<hr>
<h2>Username</h2>
<p>The suggested username is [postgres], which is correct, at least for me, press [Enter] to accept:</p>
<p><img src="screenshot_postgresql_shell4.png" class="postgresql_screenshot"></p>
<hr>
<h2>Password</h2>
<p>Enter the password you chose when you installed the PostgreSQL database, my password is 12345678:</p>
<p><img src="screenshot_postgresql_shell5.png" class="postgresql_screenshot"></p>
<hr>
<h2>Result</h2>
<p>The result might look like an error, but if it shows
<code class="w3-codespan">psql (15.2)</code> or any other version, and in the end 
you see the <code class="w3-codespan">postgres=#</code> command (and maybe a warning in between), then you have 
successfully
connected to the database!</p>
<p><img src="screenshot_postgresql_shell6.png" class="postgresql_screenshot"></p>
...
<p>Once you have connected to the database, you can start executing SQL statements.</p>
<p>Our database is empty, so we cannot query any tables yet, but we can check the version with this SQL statement:</p>
<div class="w3-example">
<pre class="notranslate w3-white language-sql"><code class="language-sql">SELECT version();
</code></pre>
</div>
<p>To insert SQL statements in the SQL Shell command, just write them after the
<code class="w3-codespan">postgres=#</code> command like this: </p>
<p><img src="screenshot_postgresql_shell7.png" class="postgresql_screenshot"></p>
<p>Press [Enter] and the result should look like this:</p>
<p><img src="screenshot_postgresql_shell8.png" class="postgresql_screenshot"></p>
<hr>
<h2>Remember the Semicolon</h2>
<div class="w3-panel ws-note">
<p><strong>Note:</strong> Always end SQL statements with a semicolon
<code class="w3-codespan">;</code></p>
</div>
<p>SQL Shell waits for the semicolon and executes all lines as one SQL statement.</p>
<p>A multiple lines SQL statement is not executed before we include a semicolon 
at the end.</p>

<div class="w3-example" style="max-width:592px;">
<h3>Example</h3>
<p>Same statement, but in two lines:</p>
<p><img src="screenshot_postgresql_shell9.png" class="postgresql_screenshot"></p>
</div>

<p>Now we are ready to create tables and fill them with data, but first we want to take a look at 
an application called pgAdmin 4.</p>
<p>Learn more about pgAdmin 4 in the <a href="postgresql_pgadmin4.php">next 
chapter</a>.</p>
