...
<html lang="en-US">
<head>
<title>PostgreSQL - Select Distinct</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>PostgreSQL SELECT DISTINCT</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="postgresql_select.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_where.php">Next &#10095;</a>
</div>

<hr>

<h2>The SELECT DISTINCT Statement</h2>

<p>The <code class="w3-codespan">SELECT DISTINCT</code>
statement is used to return only distinct (different) values.</p>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Select only the DISTINCT values from the <code class="w3-codespan">country</code>
  column in the <code class="w3-codespan">customers</code> table:</p>  
  <div class="w3-code notranslate w3-black shellcommands">
          SELECT DISTINCT country FROM customers;
  </div>
  <a target="_blank"
     href="trypostgresql.php?filename=demo_select_distinct"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>  
</div>

<p>Even though the customers table has 91 records, it only has 21 different countries, and that is what you get as a
result when executing the <code class="w3-codespan">SELECT DISTINCT</code> 
statement above</p>

<hr>
<h2>SELECT COUNT(DISTINCT)</h2>

<p>We can also use the <code class="w3-codespan">DISTINCT</code> keyword in combination with the 
<code class="w3-codespan">COUNT</code> statement, which in the example below will return the number of
different countries there are in the <code class="w3-codespan">customers</code> table.</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Return the number of different countries there are in the <code class="w3-codespan">customers</code> table:</p>  
  <div class="w3-code notranslate w3-black shellcommands">
          SELECT COUNT(DISTINCT country) FROM customers;
  </div>
  <a target="_blank"
     href="trypostgresql.php?filename=demo_select_distinct_count"
     class="w3-btn w3-margin-bottom">Run Example &raquo;
  </a>  
</div>
...
<div id="exercisecontainer" src="xrcise_select_distinct.js" data-extensions="php"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="postgresql_select.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_where.php">Next &#10095;</a>
