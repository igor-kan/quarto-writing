...
ny:-->
    ...
    <h1>PostgreSQL INNER JOIN</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="postgresql_joins.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="postgresql_left_join.php">Next &#10095;</a>
</div>
...
<p>The <code class="w3-codespan">INNER JOIN</code> keyword selects records that have matching values in both tables.</p>
...
<p>Notice that many of the products in <code class="w3-codespan">testproducts</code> have a
...
<p>By using <code class="w3-codespan">INNER JOIN</code> we will not get the 
...
<div class="w3-example">
  ...
  <a class="w3-btn w3-margin-bottom" href="trypostgresql.php?filename=demo_inner_join" target="_blank">Run Example &raquo;
  </a>  
</div>

<div class="w3-example">
  <h3>Result</h3>
  <p>Only the records with a match in BOTH tables are returned:</p>
  <div class="w3-code notranslate w3-black" style="overflow:auto;white-space:nowrap">
    &nbsp;testproduct_id |&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; product_name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    | category_name<br>
    ----------------+------------------------+----------------<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    ...
    9 | Roberts Rich Spaghetti | Grains/Cereals<br>(4 rows)</div>
</div>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> <code class="w3-codespan">JOIN</code> and <code class="w3-codespan">INNER JOIN</code>
will give the same result.</p>
  <p><code class="w3-codespan">INNER</code> is the default join type for 
<code class="w3-codespan">JOIN</code>, so when you write
<code class="w3-codespan">JOIN</code> the parser actually writes
<code class="w3-codespan">INNER JOIN</code>.</p>
</div>
...
<div id="exercisecontainer" src="xrcise_inner_join.js" data-extensions="php"></div>
<hr>
