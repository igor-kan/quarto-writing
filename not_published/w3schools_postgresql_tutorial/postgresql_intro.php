...
<a class="w3-right w3-btn" href="postgresql_install.php">Next &#10095;</a>
</div>

<hr>
<h2>What is PostgreSQL?</h2>

<p>PostgreSQL is a free open-source database system that supports both relational (SQL) and non-relational (JSON) 
queries.</p>

<p>PostgreSQL is a back-end database for dynamic websites and web applications.</p>

<p>PostgreSQL supports the most important programming languages:</p>
...
<p>PostgreSQL supports basically all features that other database management systems support.</p>
</div>

<hr>

<h2>PostgreSQL History</h2>
<p>PostgreSQL was invented at the Berkeley Computer Science Department, University of California.</p>
<p>It started as a project in 1986 with the goal of creating a database system with the minimal features needed to support multiple data types.</p>
<p>In the beginning, PostgreSQL ran on UNIX platforms, but now it can run on various platforms, including Windows and MacOS.</p>
