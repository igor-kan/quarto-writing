...
<html lang="en-US">
<head>
<title>C++ Multi-Dimensional Arrays</title>
<meta charset="utf-8">
...
<h1>C++ <span class="color_h1">Multi-Dimensional Arrays</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_arrays_reallife.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_challenges_arrays.asp">Next &#10095;</a>
</div>
<hr>
...
<p>To declare a multi-dimensional array, define the variable type, specify the name of the array followed by square brackets which specify how many elements the main array has, followed by another set of square brackets which indicates how many elements the sub-arrays have:</p>

<div class="w3-example">
<div class="w3-code notranslate javaHigh">
  string letters[2][4];<br>
 </div>
</div>

<p>As with ordinary arrays, you can insert values with an array literal - a 
comma-separated list inside curly braces. In a multi-dimensional array, each 
element in an array literal is another array literal.</p>
<div class="w3-example">
<div class="w3-code notranslate javaHigh">
  string letters[2][4] = {<br>&nbsp; { &quot;A&quot;, &quot;B&quot;, &quot;C&quot;, &quot;D&quot; },<br>&nbsp; { &quot;E&quot;, 
  &quot;F&quot;, &quot;G&quot;, &quot;H&quot; }<br>};<br>
 </div>
</div>

<p>Each set of square brackets in an array declaration adds another <strong>dimension
</strong>to an array. An array like the one above is said to have two dimensions.</p>

<p>Arrays can have any number of dimensions. The more dimensions an array has, the more complex the code becomes. The following array has three dimensions:</p>

<div class="w3-example">
<div class="w3-code notranslate javaHigh">
  string letters[2][2][2] = {<br>&nbsp; {<br>&nbsp;&nbsp;&nbsp; { &quot;A&quot;, &quot;B&quot; },<br>&nbsp;&nbsp;&nbsp; 
  { &quot;C&quot;, &quot;D&quot; }<br>&nbsp; },<br>&nbsp; {<br>&nbsp;&nbsp;&nbsp; { &quot;E&quot;, &quot;F&quot; },<br>&nbsp;&nbsp;&nbsp; 
  { &quot;G&quot;, &quot;H&quot; }<br>&nbsp; }<br>};<br>
 </div>
</div>
...
<h2>Access the Elements of a Multi-Dimensional Array</h2>

<p>To access an element of a multi-dimensional array, specify an index number in each of the array&#39;s dimensions.</p>

<p>This statement accesses the value of the element in the <strong>first row (0)</strong> and <strong>third column 
(2)</strong> of the <strong>letters</strong> array.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  string letters[2][4] = {<br>&nbsp; { &quot;A&quot;, &quot;B&quot;, &quot;C&quot;, &quot;D&quot; },<br>&nbsp; { &quot;E&quot;, 
  &quot;F&quot;, &quot;G&quot;, &quot;H&quot; }<br>};<br><br>cout &lt;&lt; letters[0][2];&nbsp; // Outputs &quot;C&quot;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_array_multi_access">Try it Yourself &raquo;</a>
</div>
...
<h2>Change Elements in a Multi-Dimensional Array</h2>
...
<div class="w3-code notranslate javaHigh">
  string letters[2][4] = {<br>&nbsp; { &quot;A&quot;, &quot;B&quot;, &quot;C&quot;, &quot;D&quot; },<br>&nbsp; { &quot;E&quot;, 
  &quot;F&quot;, &quot;G&quot;, &quot;H&quot; }<br>};<br>letters[0][0] = &quot;Z&quot;;<br><br>cout &lt;&lt; letters[0][0];&nbsp; // Now outputs 
  &quot;Z&quot; instead of &quot;A&quot;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_array_multi_change">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>The following example outputs all elements in the <strong>letters</strong> array:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  string letters[2][4] = {<br>&nbsp; { &quot;A&quot;, &quot;B&quot;, &quot;C&quot;, &quot;D&quot; },<br>&nbsp; { &quot;E&quot;, 
  &quot;F&quot;, &quot;G&quot;, &quot;H&quot; }<br>};<br><br>for (int i = 0; i &lt; 2; i++) {<br>&nbsp; for (int j 
  = 0; j &lt; 4; j++) {<br>&nbsp;&nbsp;&nbsp; cout &lt;&lt; letters[i][j] &lt;&lt; &quot;\n&quot;;<br>&nbsp; 
  }<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_array_multi_loop">Try it Yourself &raquo;</a>
</div>

<p>This example shows how to loop through a three-dimensional array:</p>
...
<div class="w3-code notranslate javaHigh">
  string letters[2][2][2] = {<br>&nbsp; {<br>&nbsp;&nbsp;&nbsp; { &quot;A&quot;, &quot;B&quot; },<br>&nbsp;&nbsp;&nbsp; 
  { &quot;C&quot;, &quot;D&quot; }<br>&nbsp; },<br>&nbsp; {<br>&nbsp;&nbsp;&nbsp; { &quot;E&quot;, &quot;F&quot; },<br>&nbsp;&nbsp;&nbsp; 
  { &quot;G&quot;, &quot;H&quot; }<br>&nbsp; }<br>};<br><br>for (int i = 0; i &lt; 2; i++) {<br>&nbsp; 
  for (int j = 0; j &lt; 2; j++) {<br>&nbsp;&nbsp;&nbsp; for (int k = 0; k &lt; 2; k++) 
  {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; cout &lt;&lt; letters[i][j][k] &lt;&lt; &quot;\n&quot;;<br>&nbsp;&nbsp;&nbsp; 
  }<br>&nbsp; }<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_array_multi_loop2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Why Multi-Dimensional Arrays?</h2>
<p>Multi-dimensional arrays are great at representing grids. This example shows a
practical use for them. In the following example we use a multi-dimensional
array to represent a small game of Battleship:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  // We put &quot;1&quot; to indicate there is a ship.<br>bool ships[4][4] = {<br>&nbsp; { 
  0, 1, 1, 0 },<br>&nbsp; { 0, 0, 0, 0 },<br>&nbsp; { 0, 0, 1, 0 },<br>&nbsp; { 
  0, 0, 1, 0 }<br>};<br><br>// Keep track of how many hits the player has and 
  how many turns they have played in these variables<br>int hits = 0;<br>int 
  numberOfTurns = 0;<br><br>// Allow the player to keep going until they have 
  hit all four ships<br>while (hits &lt; 4) {<br>&nbsp; int row, column;<br><br>&nbsp; 
  cout &lt;&lt; &quot;Selecting coordinates\n&quot;;<br><br>&nbsp; // Ask the player for a row<br>&nbsp; 
  cout &lt;&lt; &quot;Choose a row number between 0 and 3: &quot;;<br>&nbsp; cin &gt;&gt; row;<br><br>&nbsp; 
  // Ask the player for a column<br>&nbsp; cout &lt;&lt; &quot;Choose a column number 
  between 0 and 3: &quot;;<br>&nbsp; cin &gt;&gt; column;<br><br>&nbsp; // Check if a ship 
  exists in those coordinates<br>&nbsp; if (ships[row][column]) {<br>&nbsp;&nbsp;&nbsp; 
  // If the player hit a ship, remove it by setting the value to zero.<br>&nbsp;&nbsp;&nbsp; 
  ships[row][column] = 0;<br><br>&nbsp;&nbsp;&nbsp; // Increase the hit counter<br>&nbsp;&nbsp;&nbsp; 
  hits++;<br><br>&nbsp;&nbsp;&nbsp; // Tell the player that they have hit a ship 
  and how many ships are left<br>&nbsp;&nbsp;&nbsp; cout &lt;&lt; &quot;Hit! &quot; &lt;&lt; (4-hits) 
  &lt;&lt; &quot; left.\n\n&quot;;<br>&nbsp; } else {<br>&nbsp;&nbsp;&nbsp; // Tell the player 
  that they missed<br>&nbsp;&nbsp;&nbsp; cout &lt;&lt; &quot;Miss\n\n&quot;;<br>&nbsp; }<br><br>&nbsp; 
  // Count how many turns the player has taken<br>&nbsp; numberOfTurns++;<br>}<br><br>
  cout &lt;&lt; &quot;Victory!\n&quot;;<br>cout &lt;&lt; &quot;You won in &quot; &lt;&lt; numberOfTurns &lt;&lt; &quot; turns&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showcpp.asp?filename=demo_array_multi_battleship">Run Example &raquo;</a>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_arrays_multi.js"></div>
<hr>
