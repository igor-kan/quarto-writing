...
<h1>C++ <span class="color_h1">Stacks</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_list.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_queues.asp">Next &#10095;</a>
</div>
<hr>

<h2>C++ Stack</h2>
<p>A stack stores multiple elements in a specific order, called <strong>LIFO</strong>.</p>
<p><strong>LIFO</strong> stands for <strong>
...
<p>Unlike <a href="cpp_vectors.asp">vectors</a>, elements in the stack are not 
...
-->
<p>To use a stack, you have to include the <code class="w3-codespan">&lt;stack&gt;</code> header file: 
<div class="w3-example">
<div class="w3-code notranslate javaHigh">
  // Include the stack library<br>#include &lt;stack&gt;<br>
 </div>
</div>
...
<p>To create a stack, use the <code class="w3-codespan">stack</code> keyword, 
and specify the <strong>type</strong> of values it should store within angle brackets <code class="w3-codespan">&lt;&gt;</code> 
and then the name of the stack, like: <code class="w3-codespan">stack&lt;<em>type</em>&gt; 
<em>stackName</em></code>.</p>

<div class="w3-example">
<div class="w3-code notranslate javaHigh">
  // Create a 
  stack of strings called cars<br>
  stack&lt;string&gt; cars;<br>
 </div>
</div>
<p><strong>Note:</strong> The type of the stack (string in our example) cannot be changed after its been declared.</p>


<p><strong>Note:</strong> You cannot add elements to the stack at the time of declaration, like you can with <a href="cpp_vectors.asp">vectors</a>:</p>
...
<h2>Add Elements</h2>
<p>To add elements to the stack, use the <code class="w3-codespan">.push()</code> 
function, after declaring the stack:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  // Create a stack of strings called cars<br>stack&lt;string&gt; cars;<br><br>// 
  Add elements to the stack<br>cars.push(&quot;Volvo&quot;);<br>cars.push(&quot;BMW&quot;);<br>
  cars.push(&quot;Ford&quot;);<br>cars.push(&quot;Mazda&quot;);<br>
 </div>
 <p>The stack will look like this (remember that the last element added is the top element):</p>
 <div class="w3-padding notranslate w3-black w3-margin-top w3-margin-bottom">
<code>
   Mazda (top element)<br>
Ford<br>
   BMW<br>
Volvo
</code>
...
<h2>Access Stack Elements</h2>
<p>You cannot access stack elements by referring to index numbers, like you would with 
<a href="cpp_arrays.asp">arrays</a> and <a href="cpp_vectors.asp">vectors</a>.</p>
<p>In a stack, you can only access the top element, which is done using the <code class="w3-codespan">.top()</code> function:</p>
<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    // Access the top element<br>cout &lt;&lt; cars.top();&nbsp; // Outputs 
    &quot;Mazda&quot;<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_stack_access">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Change the Top Element</h2>

<p>You can also use the <code class="w3-codespan">.top</code> function to change the value of the top element:</p>
<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    // 
    Change the value of the top element<br>cars.top() = &quot;Tesla&quot;;<br><br>&nbsp;// 
    Access the top element<br>cout &lt;&lt; cars.top();&nbsp; // Now outputs &quot;Tesla&quot; 
    instead of &quot;Mazda&quot;<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_stack_change">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Remove Elements</h2>
<p>You can use the <code class="w3-codespan">.pop()</code> function to remove an element from the stack.</p>
<p>This will remove the last element that was added to the stack:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  // Create a stack of strings called cars<br>stack&lt;string&gt; cars;<br><br>// 
  ...
  last added 
  element (Mazda)<br><strong>cars.pop();</strong><br><br>// Access the top 
  element (Now Ford)<br>
  cout &lt;&lt; cars.top();<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_stack_remove">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Get the Size of the Stack</h2>
<p>To find out how many elements a stack has, use the <code class="w3-codespan">.size()</code> function:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  cout 
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_stack_size">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Check if the Stack is Empty</h2>
...
1</code> (<em>true</em>) if the stack is empty and <code class="w3-codespan">0</code> (<em>false</em>) 
otherwise:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  stack&lt;string&gt; cars;<br>cout &lt;&lt; cars.empty(); 
  // Outputs 1 (The stack is empty)<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_stack_empty">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  stack&lt;string&gt; cars;<br><br>cars.push(&quot;Volvo&quot;);<br>cars.push(&quot;BMW&quot;);<br>
  cars.push(&quot;Ford&quot;);<br>cars.push(&quot;Mazda&quot;);<br><br>cout 
  &lt;&lt; cars.empty();&nbsp; 
  // Outputs 0 (not empty)<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_stack_empty2">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Stacks and Queues</h2>
<p>Stacks are often mentioned together with <a href="cpp_queues.asp">Queues</a>, which is a similar data structure described on the <a href="cpp_queues.asp">next page</a>.</p>

<hr>
<div id="exercisecontainer" src="xrcise_stacks.js"></div>
<hr>
<br>
