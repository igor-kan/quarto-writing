...
<html lang="en-US">
<head>
<title>C++ Strings - Namespace</title>
<meta charset="utf-8">
...
<h1>C++ <span class="color_h1">String Namespace</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_strings_input.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_strings_cstyle.asp">Next &#10095;</a>
</div>
<hr>

<h2>Omitting Namespace</h2>
<p>You might see some C++ programs that run without the standard namespace library. The <code class="w3-codespan">using namespace std</code> line can be omitted and replaced with the <code class="w3-codespan">std</code> keyword, 
...
<div class="w3-code notranslate javaHigh">
  ...
  std; - Remove this line<br><br>int main() {<br>&nbsp;
  <strong>std::</strong>string greeting = &quot;Hello&quot;;<br>&nbsp; <strong>std::</strong>cout 
  &lt;&lt; greeting;<br>&nbsp; return 0;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_strings_std">Try it Yourself &raquo;</a>
</div>
<div class="ws-note w3-panel">
<p>It is up to you if you want to include the standard namespace library or not.</p>
  <p>In our tutorial, we will continue to include the library.</p>
</div>
...
<hr>
<div id="exercisecontainer" src="xrcise_strings_namespace.js"></div>
<hr>
