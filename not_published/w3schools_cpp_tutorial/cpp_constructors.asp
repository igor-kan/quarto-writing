...
<h1>C++ <span class="color_h1">Constructors</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_class_methods.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_constructors_overloading.asp">Next &#10095;</a>
</div>
<hr>

<h2>Constructors</h2>
<p>A constructor is a <strong>special method</strong> that is 
automatically called when an object of a class is created.</p>
<p>To create a constructor, use the same name as the class, followed by 
parentheses <code class="w3-codespan">()</code>:</p>

<div class="w3-example">
  <h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  class MyClass {&nbsp;&nbsp;&nbsp;&nbsp; // The class<br>&nbsp; 
  public:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  // Access specifier<br>&nbsp;&nbsp;&nbsp; MyClass() {&nbsp;&nbsp;&nbsp;&nbsp; 
  // Constructor<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; cout &lt;&lt; &quot;Hello World!&quot;;<br>&nbsp;&nbsp;&nbsp; 
  }<br>};<br><br>int main() {<br>&nbsp; MyClass myObj;&nbsp;&nbsp;&nbsp; // Create an object of MyClass (this will call 
  the constructor)<br>&nbsp; return 0;<br>}<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_constructor">Try it Yourself &raquo;</a>
</div>
<div class="ws-note w3-panel">
<h3>Constructor Rules</h3>
<ul>
  <li>The constructor has the <b>same name as the class</b>.</li>
  <li>It has <b>no return type</b> (not even <code class="w3-codespan">void</code>).</li>
  <li>It is usually declared <b>public</b>.</li>
  <li>It is <b>automatically called</b> when an object is created.</li>
</ul>
</div>
<hr>

<h2>Constructor with Parameters</h2>
<p>Constructors can also take parameters (just like regular functions), which can be 
useful for setting initial values for attributes.</p>
<p>The following class have <code class="w3-codespan">brand</code>, <code class="w3-codespan">model</code> and <code class="w3-codespan">year</code> attributes, and a constructor with 
different parameters. Inside the constructor we set the attributes equal to the 
constructor parameters (<code class="w3-codespan">brand=x</code>, etc).</p>
...
the corresponding attributes to the same:</p>
<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    class Car {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // The class<br>&nbsp; public:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Access specifier<br>&nbsp;&nbsp;&nbsp; 
    string brand;&nbsp; // Attribute<br>&nbsp;&nbsp;&nbsp; string model;&nbsp; // Attribute<br>&nbsp;&nbsp;&nbsp; 
    int year;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Attribute<br>&nbsp;&nbsp;&nbsp; 
    <strong>Car(string x, string y, int z)</strong> 
    { // Constructor with parameters<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; brand = 
    x;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; model = y;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    year = z;<br>&nbsp;&nbsp;&nbsp; }<br>};<br><br>int main() {<br>&nbsp; // 
    Create Car objects and call the constructor with different values<br>&nbsp; 
    Car carObj1(&quot;BMW&quot;, &quot;X5&quot;, 1999);<br>&nbsp; Car carObj2(&quot;Ford&quot;, &quot;Mustang&quot;, 
    1969);<br><br>&nbsp; // Print values<br>&nbsp; cout &lt;&lt; carObj1.brand &lt;&lt; &quot; &quot; 
    &lt;&lt; carObj1.model &lt;&lt; &quot; &quot; &lt;&lt; carObj1.year &lt;&lt; &quot;\n&quot;;<br>&nbsp; cout &lt;&lt; 
    carObj2.brand &lt;&lt; &quot; &quot; &lt;&lt; carObj2.model &lt;&lt; &quot; &quot; &lt;&lt; carObj2.year &lt;&lt; &quot;\n&quot;;<br>&nbsp; 
    return 0;<br>}<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_constructor_param">Try it Yourself &raquo;</a>
</div>
...
<hr>
<h2>Constructor Defined Outside the Class</h2>

<p>You can also define the constructor outside the class using the scope resolution operator <code class="w3-codespan">::</code>.</p>
<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    class Car {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // The class<br>&nbsp; 
    public:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Access 
    specifier<br>&nbsp;&nbsp;&nbsp; string brand;&nbsp; // Attribute<br>&nbsp;&nbsp;&nbsp; 
    string model;&nbsp; // Attribute<br>&nbsp;&nbsp;&nbsp; int year;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    // Attribute<br>&nbsp;&nbsp;&nbsp; Car(string x, string y, int z); // 
    Constructor declaration<br>};<br><br>// Constructor definition outside the 
    class<br><strong>Car::Car(string x, string y, int z)</strong> {<br>&nbsp; brand = x;<br>&nbsp; 
    model = y;<br>&nbsp; year = z;<br>}<br><br>int main() {<br>&nbsp; // Create 
    Car objects and call the constructor with different values<br>&nbsp; Car 
    carObj1(&quot;BMW&quot;, &quot;X5&quot;, 1999);<br>&nbsp; Car carObj2(&quot;Ford&quot;, &quot;Mustang&quot;, 1969);<br>
    <br>&nbsp; // Print values<br>&nbsp; cout &lt;&lt; carObj1.brand &lt;&lt; &quot; &quot; &lt;&lt; 
    carObj1.model &lt;&lt; &quot; &quot; &lt;&lt; carObj1.year &lt;&lt; &quot;\n&quot;;<br>&nbsp; cout &lt;&lt; 
    carObj2.brand &lt;&lt; &quot; &quot; &lt;&lt; carObj2.model &lt;&lt; &quot; &quot; &lt;&lt; carObj2.year &lt;&lt; &quot;\n&quot;;<br>&nbsp; 
    return 0;<br>}<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_constructor_param2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Why Constructors Are Useful</h2>

<p>Constructors run by themselves when you create an object. They set things up so everything is ready right away.</p>

<p><b>Think of it like this:</b> When you order a pizza (object), the constructor is the chef who adds the sauce, cheese, and toppings before it gets to you - you don't have to do it yourself!</p>

<hr>
<div id="exercisecontainer" src="xrcise_constructors.js"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_class_methods.asp">&#10094; Previous</a>
