...
<html lang="en-US">
<head>
<title>C++ Multilevel Inheritance</title>
<meta charset="utf-8">
...
<h1>C++ <span class="color_h1">Multilevel Inheritance</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_inheritance.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_inheritance_multiple.asp">Next &#10095;</a>
</div>
<hr>

<h2>Multilevel Inheritance</h2>
<p>A class can also be derived from one class, which is already derived from 
another class.</p>
<p>In the following example, <code class="w3-codespan">MyGrandChild</code> is derived from class <code class="w3-codespan">MyChild</code> (which is derived 
from <code class="w3-codespan">MyClass</code>).</p>

<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    // Base class (parent)<br>class MyClass {<br>&nbsp; public: <br>&nbsp;&nbsp;&nbsp; void 
    myFunction() {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    cout &lt;&lt; &quot;Some content in parent class.&quot; ;<br>&nbsp;&nbsp;&nbsp; }<br>};<br><br>// 
    Derived 
    class (child)<br>class MyChild: public MyClass {<br>};<br><br>// Derived class 
    (grandchild) <br>class MyGrandChild: public MyChild {<br>};<br><br>int main() {<br>&nbsp; 
    MyGrandChild myObj;<br>&nbsp; 
    myObj.myFunction();<br>&nbsp; 
    return 0;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_inheritance_multi">Try it Yourself &raquo;</a>
</div>
<hr>
...
<hr>
<div id="exercisecontainer" src="xrcise_inheritance_multilevel.js"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_inheritance.asp">&#10094; Previous</a>
