...
<h1>C++ <span class="color_h1">Inheritance</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_friend_function.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_inheritance_multilevel.asp">Next &#10095;</a>
</div>
<hr>

<h2>Inheritance</h2>
<p><strong>Inheritance</strong> allows one class to reuse attributes and methods from another class. It helps you write cleaner, more efficient code by avoiding duplication.</p>
<p>We group the "inheritance concept" into two categories:</p>

<ul>
<li><strong>derived class</strong> (child) - the class that inherits from another class</li>
<li><strong>base class</strong> (parent) - the class being inherited from</li>
</ul>
<p>To inherit from a class, use the <code class="w3-codespan">:</code> symbol.</p>

<p>In the example below, the <code class="w3-codespan">Car</code> class 
(child) inherits the attributes and methods from the <code class="w3-codespan">Vehicle</code> class 
(parent):</p>

<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    // Base class<br>class Vehicle {<br>&nbsp; public: <br>&nbsp;&nbsp;&nbsp; 
    string brand = &quot;Ford&quot;;<br>&nbsp;&nbsp;&nbsp; void honk() {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    cout &lt;&lt; &quot;Tuut, tuut! \n&quot; ;<br>&nbsp;&nbsp;&nbsp; }<br>};<br><br>// Derived 
    class<br><strong>class Car: public Vehicle</strong> {<br>&nbsp; public: <br>&nbsp;&nbsp;&nbsp; 
    string model = &quot;Mustang&quot;;<br>};<br><br>int main() {<br>&nbsp; Car myCar;<br>&nbsp; 
    myCar.honk();<br>&nbsp; cout &lt;&lt; myCar.brand + &quot; &quot; + myCar.model;<br>&nbsp; 
    return 0;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_inheritance">Try it Yourself &raquo;</a>
</div>
