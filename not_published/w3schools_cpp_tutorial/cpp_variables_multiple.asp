...
<a class="w3-left w3-btn" href="cpp_variables.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_variables_identifiers.asp">Next &#10095;</a>
</div>
<hr>

<h2>Declare Many Variables</h2>
<p>To declare more than one variable of the <strong>same type</strong>, 
use a comma-separated list:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  int x = 5, y = 6, z = 50;<br>cout &lt;&lt; 
  x + y + z;<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_variables_many">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>One Value to Multiple Variables</h2>
<p>You can also assign the <strong>same value</strong> to multiple variables in one line:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  int x, y, z;<br>x = y = z = 50;<br>cout &lt;&lt; x + y + z;<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_variables_multi2">Try it Yourself &raquo;</a>
</div>
<hr>
