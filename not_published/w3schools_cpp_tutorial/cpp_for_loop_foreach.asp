...
<html lang="en-US">
<head>
<title>C++ The foreach Loop (Ranged for-loop)</title>
<meta charset="utf-8">
...
<h1>C++ <span class="color_h1">The foreach Loop</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_for_loop_nested.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_for_loop_reallife.asp">Next &#10095;</a>
</div>
<hr>

<h2>The foreach Loop</h2>
<p>There is also a "<strong>for-each</strong> loop" (also known as ranged-based for loop), which is 
used to loop through elements in an <a href="cpp_arrays.asp">array</a> (or other <a href="cpp_vectors.asp">data structures</a>):</p>
...
<p>You can also use a for-each loop to loop through characters in a string:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_array_loop_foreach_string">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
<p><strong>Note:</strong> Don't worry if you don't understand the examples above. You will learn more about arrays in the <a href="cpp_arrays.asp">C++ Arrays chapter</a>.<strong></strong>
<p><strong>Good to know</strong>: The <strong>for-each</strong> loop was introduced in C++ version 11 (2011).</p>
</div>
<hr>
...
<hr>
<div id="exercisecontainer" src="xrcise_for_loop_foreach.js"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_for_loop_nested.asp">&#10094; Previous</a>
