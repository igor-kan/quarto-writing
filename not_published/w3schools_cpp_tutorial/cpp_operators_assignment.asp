...
<a class="w3-left w3-btn" href="cpp_operators_arithmetic.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_operators_comparison.asp">Next &#10095;</a>
</div>
<hr>
...
int x = 10;</div>
<a class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_oper_assignment1" target="_blank">Try it Yourself &raquo;</a>
</div>
<p>The <strong>addition compound assignment</strong> operator (<code class="w3-codespan">+=</code>) adds a value to a variable:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
int x = 10;<br>
...
<a class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_oper_assignment2" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<td>x = 5</td>
<td>x = 5</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trycpp.asp?filename=demo_oper_ass1">Try it &raquo;</a></td>
</tr>
  <tr>
<td>+=</td>
<td>x += 3</td>
<td>x = x + 3</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trycpp.asp?filename=demo_oper_ass2">Try it &raquo;</a></td>
  </tr>
  <tr>
<td>-=</td>
<td>x -= 3</td>
<td>x = x - 3</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trycpp.asp?filename=demo_oper_ass3">Try it &raquo;</a></td>
  </tr>
  <tr>
<td>*=</td>
<td>x *= 3</td>
<td>x = x * 3</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trycpp.asp?filename=demo_oper_ass4">Try it &raquo;</a></td>
  </tr>
  <tr>
<td>/=</td>
<td>x /= 3</td>
<td>x = x / 3</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trycpp.asp?filename=demo_oper_ass5">Try it &raquo;</a></td>
  </tr>
  <tr>
<td>%=</td>
<td>x %= 3</td>
<td>x = x % 3</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trycpp.asp?filename=demo_oper_ass6">Try it &raquo;</a></td>
  </tr>
  <tr>
<td>&amp;=</td>
<td>x &amp;= 3</td>
<td>x = x &amp; 3</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trycpp.asp?filename=demo_oper_ass7">Try it &raquo;</a></td>
  </tr>
  <tr>
<td>|=</td>
<td>x |= 3</td>
<td>x = x | 3</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trycpp.asp?filename=demo_oper_ass8">Try it &raquo;</a></td>
  </tr>
<tr>
<td>^=</td>
<td>x ^= 3</td>
<td>x = x ^ 3</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trycpp.asp?filename=demo_oper_ass9">Try it &raquo;</a></td>
</tr>
<tr>
<td>&gt;&gt;=</td>
<td>x &gt;&gt;= 3</td>
<td>x = x &gt;&gt; 3</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trycpp.asp?filename=demo_oper_ass10">Try it &raquo;</a></td>
</tr>
<tr>
<td>&lt;&lt;=</td>
<td>x &lt;&lt;= 3</td>
<td>x = x &lt;&lt; 3</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="trycpp.asp?filename=demo_oper_ass11">Try it &raquo;</a></td>
</tr>
</table>
</div>
...
For example, instead of writing <code class="w3-codespan">x = x + 5;</code>, you can simply write <code class="w3-codespan">x += 5;</code>.
</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-cpp w3-white"><code>int x = 10;
...
x *= 2;  // same as x = x * 2
cout &lt;&lt; x &lt;&lt; &quot;\n&quot;; // 30</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_oper_compound">Try it Yourself &raquo;</a>
</div>

<div class="ws-note ws-panel">
<p><strong>Tip:</strong> Compound operators make code shorter and easier to read, especially when updating the same variable many times.</p>
<p><strong>Why "Compound"?</strong><br>
They are called <em>compound assignment operators</em> because they <strong>combine</strong> a regular operator (like <code class="w3-codespan">+</code>, <code class="w3-codespan">-</code>, <code class="w3-codespan">*</code>, etc.) with the assignment operator (<code class="w3-codespan">=</code>) into one single operator.  
For example, <code class="w3-codespan">+=</code> is a <strong>combination</strong> of <code class="w3-codespan">+</code> and <code class="w3-codespan">=</code>.
</p>
</div>
<hr>

<h2>Real-Life Example: Tracking Savings</h2>
<p>Compound assignment operators can also be used in real-life scenarios.  
...
<div class="w3-example">
<h3>Example</h3>
<pre class="language-cpp w3-white"><code>int savings = 100; 
savings += 50; // add 50 to savings

cout &lt;&lt; "Total savings: " &lt;&lt; savings;</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_operators_tracking_savings">Try it Yourself &raquo;</a>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_operators_assignment.js"></div>
<hr>
