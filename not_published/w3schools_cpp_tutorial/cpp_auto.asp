...
<h1>C++ <span class="color_h1">auto</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_data_types_string.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_data_types_reallife.asp">Next &#10095;</a>
</div>
<hr>

<h2>The auto Keyword</h2>

<p>The <code class="w3-codespan">auto</code> keyword automatically detects the type of a variable based on the value you assign to it.</p>

<p>It helps you write cleaner code and avoid repeating types, especially for long or complex types.</p>


<p><b>For example:</b> Instead of writing <code class="w3-codespan">int x = 5;</code>, you can write:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
auto x = 5;      // x is automatically treated as <strong>int</strong></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_auto">Try it Yourself &raquo;</a>
</div>

<div class="ws-note ws-panel">
<p>Starting in <b>C++11</b>, <code class="w3-codespan">auto</code> became a powerful way to let the compiler <b>figure out the type</b> based on the value you assign.</p>
</div>

<hr>

<h2> Example with Different Types</h2>
<p>Here's an example showing how <code class="w3-codespan">auto</code> can be used to create variables of different types, based on the values you assign:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  // Creating auto variables<br>auto myNum = 5; // int<br>auto myFloatNum = 
  5.99f; // float<br>auto myDoubleNum = 9.98; // double<br>auto myLetter = 'D'; 
  // char<br>auto myBoolean = true; // bool<br>auto myString = string(&quot;Hello&quot;); 
  // std::string</div>

<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_auto2">Try it Yourself &raquo;</a>
</div>

<div class="ws-note ws-panel">
<h3>Important Notes</h3>
<ul>
  <li><code class="w3-codespan">auto</code> only works when you assign a value at the same time (You can't declare <code class="w3-codespan">auto x;</code> without 
  assigning a value)</li>
  <li>Once the type is chosen, it stays the same. See example below:</li>
</ul>
  <div class="w3-example">
<div class="w3-code notranslate javaHigh w3-border-red">
  auto x = 5; // x is now an int<br>x = 10;&nbsp;&nbsp;&nbsp;&nbsp; //&nbsp;OK - still an int<br>x = 
  9.99;&nbsp;&nbsp; //&nbsp;Error - can't assign a double to an int</div>
</div>
</div>

<p><b>Note:</b> In this tutorial, we usually use <code class="w3-codespan">int</code>, <code class="w3-codespan">double</code>, and other basic types when the type is simple and easy to see.</p>

<p>But for more complex types - like <a href="cpp_iterators.asp">iterators</a> and <a href="cpp_functions_lambda.asp">lambdas</a>, which you will learn 
more about in a later chapter, we use <code class="w3-codespan">auto</code> to keep the code cleaner and easier to understand.</p>
...
<hr>
<div id="exercisecontainer" src="xrcise_auto.js"></div>
<hr>
