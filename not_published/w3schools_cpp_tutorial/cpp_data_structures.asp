...
<html lang="en-US">
<head>
<title>C++ Data Structures and STL</title>
<meta charset="utf-8">
...
<h1>C++ <span class="color_h1">Data Structures and STL</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_input_validation.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_vectors.asp">Next &#10095;</a>
</div>
<hr>

<h2>Data Structures</h2>
<p>Data structures are used to store and organize data. An <a href="cpp_arrays.asp">array</a> is an example of a data structure, which 
allows multiple elements to be stored in a single variable.</p>
<p>C++ includes many other data structures as well, each is used to handle data 
in different ways.</p>
<p>These are part of the C++ STL, which stands for The <strong>S</strong>tandard <strong>T</strong>emplate 
<strong>L</strong>ibrary.</p>
<hr>

<h2>C++ STL</h2>
<p>STL is a library that consist of different <strong>data structures</strong> and 
<strong>algorithms </strong>to effectively store and manipulate data.</p>
<p>If we say that data structures store data, we can say that algorithms are used to solve different problems, 
often by searching through and manipulating those data structures.</p>
<p>Using the right data structure and algorithm makes your program run faster, 
especially when working with lots of data.</p>
<p>The most common data structures are:</p>
 
<table class="ws-table-all notranslate">
  <tr>
    <th style="width:22%">Data Structure</th>
    <th style="width:78%">Description</th>
  </tr>
  <tr>
    <td><a href="cpp_vectors.asp">Vector</a></td>
    <td>Stores elements like an <a href="cpp_arrays.asp">array</a> but can 
    dynamically change in size. Adding and removing of elements are usually done 
    at the end. Elements can be accessed by index.</td>
  </tr>
  <tr>
    <td><a href="cpp_list.asp">List</a></td>
    <td>Stores elements sequentially, where each element is connected to the 
    next. Adding and removing of elements can be done at both ends. Not 
    accessible by index.</td>
  </tr>
  <tr>
    <td><a href="cpp_stacks.asp">Stack</a></td>
    <td>Stores elements in a specific order, called LIFO (Last In, First Out), 
    where elements can only be added and removed from the top. Not accessible by 
    index.</td>
  </tr>
  <tr>
    <td><a href="cpp_queues.asp">Queue</a></td>
    <td>Stores elements in a specific order, called FIFO (First In, First Out), 
    where elements are added at the end and removed from the front. Not 
    accessible by index.</td>
  </tr>
  <tr>
    <td><a href="cpp_deque.asp">Deque</a></td>
    <td>Stores elements in a double-ended queue, where elements can be added and 
    removed from both ends. Elements can be accessed by index.</td>
  </tr>
  <tr>
    <td><a href="cpp_sets.asp">Set</a></td>
    <td>Stores unique elements. Not accessible by index.</td>
  </tr>
  <tr>
    <td><a href="cpp_maps.asp">Map</a></td>
    <td>Stores elements in "key/value" pairs. Accessible by keys (not by index).</td>
  </tr>
</table>


<p>Which one to use depends on your specific needs. One thing they all have in common is that you must include the 
appropriate header file to use them:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  // Include the vector library<br>#include &lt;vector&gt;<br>
  <br>// Include the list library<br>#include &lt;list&gt;<br><br>// Include the set 
  library<br>#include &lt;set&gt;<br><br>// Include the map library<br>#include &lt;map&gt;<br><br>// Include the stack library<br>#include &lt;stack&gt;<br><br>// 
  Include the queue library<br>#include &lt;queue&gt;<br>
 </div>
</div>

<p>Here is an example of using vectors, after we have included the <code class="w3-codespan">&lt;vector&gt;</code> library:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
...
<p>The next chapters will explain how each data structure works and how to use them.</p>
...
<h2>Key Concepts of the STL</h2>
<p>The key components of the STL consist of <strong>containers</strong>, <strong>iterators,
</strong>and <strong>algorithms</strong>, and the relationship between them:</p>
<ul>
<li><strong>Containers</strong> are data structures that provides a way to store data, like <a href="cpp_vectors.asp">vectors</a>, <a href="cpp_list.asp">lists</a>, etc.</li>
<li style="margin-top:10px;"><a href="cpp_iterators.asp"><strong>Iterators</strong></a> 
are objects used to access elements of 
a data structure.</li>
<li style="margin-top:10px;"><a href="cpp_algorithms.asp"><strong>Algorithms</strong></a> 
include functions, like <code class="w3-codespan">sort()</code> and <code class="w3-codespan">find()</code>, 
that perform operations on data structures through <a href="cpp_iterators.asp"><strong>iterators</strong></a>.</li>
</ul>

<p>In Computer Science, data structures and algorithms go hand in hand. A data structure is not worth 
...
on.</p>
<p>In the following chapters, you will see how everything is connected.</p>
<hr>
<div id="exercisecontainer" src="xrcise_data_structures.js"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_input_validation.asp">&#10094; Previous</a>
