...
<a class="w3-left w3-btn" href="cpp_challenges_switch.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_do_while_loop.asp">Next &#10095;</a>
</div>
<hr>
<h2>C++ Loops</h2>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_while_loop">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> Do not forget to increase the variable used in the condition (<code class="w3-codespan">i++</code>), otherwise 
the loop will never end!</p>
<p>Do you wonder why we use the letter <code class="w3-codespan">i</code> as a variable name? It's a 
<strong>counter</strong> variable and a common choice in simple loops because it's short, traditional, and stands for 'index' or 'iterator'.</p>
</div>
<hr>

<h2>Countdown Example</h2>
<p>This example counts down from 3 to 1 and then displays &quot;Happy New Year!!&quot; at 
the end:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_while_loop_countdown">Try it Yourself &raquo;</a>
</div>
...
<div id="exercisecontainer" src="xrcise_while_loop.js"></div>
<hr>
