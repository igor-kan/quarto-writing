...
<a class="w3-left w3-btn" href="cpp_conditions.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_conditions_elseif.asp">Next &#10095;</a>
</div>
<hr>
...
<p>
Use the <code class="w3-codespan">else</code> statement to specify a block of code to be executed
if the condition is <code class="w3-codespan">false</code>.
</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_if_else">
...
<p>
Because <code class="w3-codespan">time</code> is 20, the condition <code class="w3-codespan">time &lt; 18</code> is false,
so the code inside the <code class="w3-codespan">else</code> block runs and prints "Good evening.".
If <code class="w3-codespan">time</code> was less than 18, the program would print "Good day." instead.
</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_if_else_bool">
Try it Yourself &raquo;
</a>
</div>
...
<div id="exercisecontainer" src="xrcise_conditions_else.js"></div>
<hr>
