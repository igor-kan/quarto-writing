...
<a class="w3-left w3-btn" href="cpp_syllabus.asp">&#10094; Previous</a>
...
<ul>
  <li><a href="default.asp" target="_blank">W3Schools C++ Tutorial</a></li>
  <li><a href="cpp_exercises.asp" target="_blank">C++ Exercises</a></li>
  <li><a href="cpp_quiz.asp" target="_blank">C++ Quiz</a></li>
  <li>C++ Challenges (Coding challenges)</li>
  <li><a href="cpp_exam.asp" target="_blank">C++ Certification Exam (End of Pathway Exam)</a></li>
</ul>
<hr>
...
<p><a title="W3Schools C++ Syllabus" href="cpp_syllabus.asp" target="_blank">Read more about C++ Syllabus</a>.</p>
<hr>
...
<ul>
  <li>Week 1: Introduction, Output &amp; Input</li>
  <li>Week 2: Variables, Data Types</li>
  <li>Week 3: Operators, Strings, Math, Booleans</li>
  <li>Week 4: Conditions, Loop, Arrays, Structures, References</li>
  <li>Week 5: Pointers, Functions, Classes, Exceptions, Inheritance &amp; Polymorphism, Date, Files, Data Structures, C++ Certification Exam</li>
</ul>

<p>Image of Sample C++ study plan:</p>
<a href="cpp_study_plan.png" target="_blank" title="C++ Study Plan"><img src="cpp_study_plan.png" style="height:auto;max-width:100%;"></a>
<hr>
