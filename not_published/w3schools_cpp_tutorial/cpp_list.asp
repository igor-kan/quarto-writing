...
<h1>C++ <span class="color_h1">List</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_vectors.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_stacks.asp">Next &#10095;</a>
</div>
<hr>

<h2>C++ List</h2>
<p>A list is similar to a <a href="cpp_vectors.asp">vector</a> in that it can store multiple elements of the same type and dynamically grow in size.</p>
<p>However, two major differences between lists and vectors are:</p>
<ol>
<li>You can add and remove elements from both the beginning and at the end of a list, while vectors are generally 
optimized for adding and removing at the end.</li><br>
<li>Unlike vectors, a list does not support random access, meaning you cannot 
directly jump to a specific index, or 
access elements by index numbers. <!--Instead, you must traverse the list to reach a 
specific element.--></li>
</ol>
<p>To use a list, you have to include the <code class="w3-codespan">&lt;list&gt;</code> header file:

<div class="w3-example">
<div class="w3-code notranslate javaHigh">
  // Include the list library<br>#include &lt;list&gt;<br>
 </div>
</div>
...
<h2>Create a List</h2>
<p>To create a list, use the <code class="w3-codespan">list</code> keyword, and 
specify the <strong>type</strong> of values it should store within angle brackets <code class="w3-codespan">&lt;&gt;</code> 
and then the name of the list, like: <code class="w3-codespan">list&lt;<em>type</em>&gt; 
<em>listName</em></code>.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  // Create a list called cars that will store strings<br>list&lt;string&gt; cars;<br>
 </div>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  // Create a list called cars that will store strings<br>list&lt;string&gt; cars = {&quot;Volvo&quot;, &quot;BMW&quot;, 
  &quot;Ford&quot;, &quot;Mazda&quot;};<br><br>// Print list elements<br>
  for (string car : cars) {<br>&nbsp; cout &lt;&lt; car &lt;&lt; &quot;\n&quot;;<br>}<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_list">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
  <p><strong>Note:</strong> The type of the list (<code class="w3-codespan">string</code> in our example) cannot be changed after its been declared.</p>
</div>
<hr>

<h2>Access a List</h2>
<p>You cannot access list elements by referring to index numbers, like with 
arrays and vectors.</p>
<p>However, you can access the first or the last element with the <code class="w3-codespan">.front()</code> and 
<code class="w3-codespan">.back()</code> functions, respectively:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  // Create a list called cars that will store strings<br>list&lt;string&gt; cars = {&quot;Volvo&quot;, &quot;BMW&quot;, 
  &quot;Ford&quot;, &quot;Mazda&quot;};<br><br>// Get the first element<br>
  cout &lt;&lt; cars.front();&nbsp; // Outputs Volvo<br><br>// Get the 
  last element<br>
  cout &lt;&lt; cars.back();&nbsp; // Outputs Mazda<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_list_access">Try it Yourself &raquo;</a>
</div>
<hr>
...
<h2>Change a List Element</h2>
<p>You can also change the value of the first or the last element with the <code class="w3-codespan">.front()</code> and 
<code class="w3-codespan">.back()</code> functions</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  list&lt;string&gt; cars = {&quot;Volvo&quot;, &quot;BMW&quot;, &quot;Ford&quot;, &quot;Mazda&quot;};<br><br>// Change the 
  value of the first element<br>cars.front() = &quot;Opel&quot;;<br><br>// Change the 
  value of the last element<br>cars.back() = &quot;Toyota&quot;;<br><br>cout &lt;&lt; cars.front(); // Now 
  outputs Opel instead of Volvo<br>cout &lt;&lt; cars.back();&nbsp; // Now 
  outputs Toyota instead of Mazda<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_list_change">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Add List Elements</h2>
<p>To add elements to a list, you can use <code class="w3-codespan">.push_front()</code> 
to insert an element at the beginning of the list and <code class="w3-codespan">.push_back()</code> 
to add an element at the end:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  list&lt;string&gt; cars = {&quot;Volvo&quot;, &quot;BMW&quot;, &quot;Ford&quot;, &quot;Mazda&quot;};<br><br>// Add an 
  element at the beginning<br>cars.push_front(&quot;Tesla&quot;);<br><br>// Add an element 
  at the end<br>cars.push_back(&quot;VW&quot;);<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_list_add">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Remove List Elements</h2>
<p>To remove elements from a list, use <code class="w3-codespan">.pop_front()</code> 
to remove an element from the beginning of the list and <code class="w3-codespan">.pop_back()</code> 
to remove an element at the end:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  list&lt;string&gt; cars = {&quot;Volvo&quot;, &quot;BMW&quot;, &quot;Ford&quot;, &quot;Mazda&quot;};<br><br>// Remove the 
  first element<br>cars.pop_front();<br><br>// Remove the last element<br>cars.pop_back();<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_list_remove">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>List Size</h2>
<p>To find out how many elements a list has, use the <code class="w3-codespan">.size()</code> function:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  list&lt;string&gt; cars = {&quot;Volvo&quot;, &quot;BMW&quot;, &quot;Ford&quot;, &quot;Mazda&quot;};<br>cout &lt;&lt; cars.size();&nbsp; 
  // Outputs 4<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_list_size">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Check if a List is Empty</h2>
<p>Use the <code class="w3-codespan">.empty()</code> function to find out if a list is empty or not.</p>
<p>The <code class="w3-codespan">.empty()</code> function returns <code class="w3-codespan">
1</code> (<em>true</em>) if the list is empty and <code class="w3-codespan">0</code> (<em>false</em>) 
otherwise:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  list&lt;string&gt; cars;<br>cout &lt;&lt; cars.empty();&nbsp; 
  // Outputs 1 (The list is empty)<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_list_empty">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  list&lt;string&gt; cars = {&quot;Volvo&quot;, &quot;BMW&quot;, &quot;Ford&quot;, &quot;Mazda&quot;};<br>cout &lt;&lt; cars.empty();&nbsp; 
  // Outputs 0 (not empty)<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_list_empty2">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Loop Through a List</h2>
<p>You cannot loop through the list elements with a traditional <code class="w3-codespan">for</code> loop combined with the 
<code class="w3-codespan">.size()</code> function, since it is not possible to access 
elements in a list by index:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh w3-border-red">
  list&lt;string&gt; cars = {&quot;Volvo&quot;, &quot;BMW&quot;, &quot;Ford&quot;, &quot;Mazda&quot;};<br><br>for (int i = 
  0; i &lt; cars.size(); i++) {<br>&nbsp; cout &lt;&lt; cars[i] &lt;&lt; &quot;\n&quot;;<br>}<br>
 </div>
</div>

<p>The simplest way to loop through a list is with the <strong>for-each</strong> 
loop:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  list&lt;string&gt; cars = {&quot;Volvo&quot;, &quot;BMW&quot;, &quot;Ford&quot;, &quot;Mazda&quot;};<br><br>
  for (string car : cars) {<br>&nbsp; cout &lt;&lt; car &lt;&lt; &quot;\n&quot;;<br>}<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_list_loop">Try it Yourself &raquo;</a>
</div>
<p><strong>Tip:</strong> It is also possible to loop through lists with an <a href="cpp_iterators.asp">iterator</a>, which you will learn more about in a later chapter.</p>
