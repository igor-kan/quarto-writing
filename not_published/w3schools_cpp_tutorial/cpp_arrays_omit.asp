...
<html lang="en-US">
<head>
<title>C++ Omit Array Size and Elements on Declaration</title>
<meta charset="utf-8">
...
<h1>C++ <span class="color_h1">Omit Array Size</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_arrays_loop.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_arrays_size.asp">Next &#10095;</a>
</div>
<hr>

<h2>Omit Array Size</h2>
<p>In C++, you don't have to specify the size of the array. The compiler is 
smart enough to determine the size of the array based on the number of inserted values:</p>

<div class="w3-example">
<div class="w3-code notranslate javaHigh">
  string cars[] = {&quot;Volvo&quot;, &quot;BMW&quot;, &quot;Ford&quot;}; // Three array elements<br>
 </div>
</div>
<p>The example above is equal to:</p>
<div class="w3-example">
  <div class="w3-code notranslate javaHigh">
    string cars[3] = {&quot;Volvo&quot;, &quot;BMW&quot;, &quot;Ford&quot;}; // Also three array elements<br>
 </div>
</div>

<p>However, the last approach is considered as &quot;good practice&quot;, because it will reduce 
the chance of errors in your program.</p>

<hr>

<h2>Omit Elements on Declaration</h2>
<p>It is also possible to declare an array without specifying the elements on 
declaration, and add them later:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  string cars[5];<br>cars[0] = &quot;Volvo&quot;;<br>cars[1] = &quot;BMW&quot;;<br>cars[2] 
  = &quot;Ford&quot;;<br>cars[3] = &quot;Mazda&quot;;<br>cars[4] = &quot;Tesla&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_array_size2">Try it Yourself &raquo;</a>
</div>
<p><strong>Note:</strong> The example above only works when you have specified the size of the array. </p>
<p>If you don't specify the array size, an error occurs:</p>
<div class="w3-example w3-pale-red">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh w3-border-red">
  string cars[];&nbsp; 
  // Array size is not specified<br>cars[0] = &quot;Volvo&quot;;<br>cars[1] = &quot;BMW&quot;;<br>cars[2] 
  = &quot;Ford&quot;;<br>cars[3] = &quot;Mazda&quot;;<br>cars[4] = &quot;Tesla&quot;;<br>
  <br>// error: array size missing in 'cars'</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_array_size3">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Fixed Size (Arrays) vs. Dynamic Size (Vectors)</h2>
<p>You will often hear the terms "fixed size" and "dynamic size" when discussing 
arrays in C++.</p>
<p>This is because the size of an array in C++ is fixed, meaning you 
<strong>cannot</strong> <strong>add</strong> or <strong>remove</strong> elements 
after it is created.</p>
<div class="w3-example w3-pale-red">
<h4>Arrays - Fixed Size Example</h4>
<div class="w3-code notranslate javaHigh w3-border-red">
  // An array with 3 elements<br>string cars[3] = {&quot;Volvo&quot;, &quot;BMW&quot;, &quot;Ford&quot;};<br>
  <br>// Trying to add another element (a fourth element) to the cars array will 
  result in an error<br>cars[3] = &quot;Tesla&quot;;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_array_fixed">Try it Yourself &raquo;</a>
</div>
<h3>Vectors</h3>
<p>For operations that require adding and removing array elements, C++ provides
<strong>vectors</strong>, which are <strong>resizable arrays</strong>.</p>
<p>The size of a vector is dynamic, meaning it can grow and shrink as needed. 
</p>
<p>Vectors are found in the <code class="w3-codespan">&lt;vector&gt;</code> library, and they come with many useful 
functions to add, remove and modify elements:</p>
<div class="w3-example">
<h4>Vectors - Dynamic Size Example</h4>
<div class="w3-code notranslate javaHigh">
  // A vector with 3 elements<br>vector&lt;string&gt; cars = {&quot;Volvo&quot;, &quot;BMW&quot;, &quot;Ford&quot;};<br>
  <br>// Adding another element to the vector<br>cars.push_back(&quot;Tesla&quot;);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_array_vector">Try it Yourself &raquo;</a>
</div>
<div class="ws-note w3-panel">
<p>This was just an introduction to <a href="cpp_vectors.asp">vectors</a> to let you know that 
&quot;resizable 
arrays&quot; exist.</p>
  <p>Don't worry if you don't understand the syntax above.</p>
  <p>You will learn much more about vectors and other data structures in <a href="cpp_vectors.asp">a later chapter</a>.</p>
</div>
...
<hr>
<div id="exercisecontainer" src="xrcise_arrays_omit.js"></div>
<hr>
<br>
