...
<a class="w3-left w3-btn" href="cpp_namespaces.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="cpp_exam.asp">Next &#10095;</a>
</div>
<hr>
...
<p>Before starting these projects, make sure you are comfortable with:</p>
<ul>
  <li><a href="cpp_variables.asp">Variables</a>, <a href="cpp_data_types.asp">data types</a> and <a href="cpp_operators.asp">operators</a></li>
  <li><a href="cpp_user_input.asp">User input</a></li>
  <li><a href="cpp_conditions.asp">if statements</a> and <a href="cpp_switch.asp">switch</a></li>
  <li><a href="cpp_for_loop.asp">for loops</a> and <a href="cpp_while_loop.asp">while loops</a></li>
  <li><a href="cpp_arrays.asp">Arrays</a>, <a href="cpp_strings.asp">strings</a> and <a href="cpp_structs.asp">structures</a>.</li>
  <li><a href="cpp_functions.asp">Functions</a></li>
  <li><a href="cpp_oop.asp">Classes and objects</a></li>
  <li><a href="cpp_files.asp">File handling with fstream</a></li>
</ul>
-->
<hr>

<h2>Project Examples</h2>
<p>Some examples of fun C++ projects could be:</p>
<ul>
  <li>Calculate a Students Average</li>
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate javaHigh">
    ...
    // This function returns a letter grade based on the average of a student<br>char gradeFunction(double avg) {<br>&nbsp; if (avg &gt;= 90) return 'A';<br>&nbsp; 
    else if (avg &gt;= 80) return 'B';<br>&nbsp; else if (avg &gt;= 70) return 'C';<br>&nbsp; 
    else if (avg &gt;= 60) return 'D';<br>&nbsp; else return 'F';<br>}<br><br>int main() {<br>&nbsp; 
    int count; // Number of grades the user wants to enter<br>&nbsp; double sum = 0, grade; 
    // Sum stores total grades, grade holds each input<br><br>&nbsp; // Ask the 
    user to enter total grades between 1 to 5<br>&nbsp; cout &lt;&lt; &quot;How many 
    grades (1 to 5)? &quot;;<br>&nbsp; cin &gt;&gt; count;<br><br>&nbsp; // 
    Validate that count is between 1 and 5<br>&nbsp; if (count &lt; 1 || 
    count &gt; 5) {<br>&nbsp;&nbsp;&nbsp; cout &lt;&lt; &quot;Invalid number. You must enter 
    between 1 and 5 grades.\n&quot;;<br>&nbsp;&nbsp;&nbsp; return 1;&nbsp; // Exit<br>&nbsp; 
    }<br><br>&nbsp; // Loop to collect each grade<br>&nbsp; for (int i = 1; i &lt;= count; i++) {<br>&nbsp;&nbsp;&nbsp; 
    cout &lt;&lt; &quot;Enter grade &quot; &lt;&lt; i &lt;&lt; &quot;: &quot;;<br>&nbsp;&nbsp;&nbsp; cin &gt;&gt; grade;<br>&nbsp;&nbsp;&nbsp; 
    sum += grade;<br>&nbsp; }<br><br>&nbsp; // Calculate the average score<br>&nbsp; double avg = sum / count;<br>
    <br>&nbsp; // Display numeric average<br>&nbsp; 
    cout &lt;&lt; &quot;Average: &quot; &lt;&lt; avg &lt;&lt; &quot;\n&quot;;<br>
    <br>&nbsp; // Display letter grade<br>&nbsp; cout &lt;&lt; &quot;Letter grade: &quot; &lt;&lt; 
...
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="showcpp.asp?filename=demo_project_grades">Run example &raquo;</a>
</div>
...
<p>Try to make your own projects. For example, write a program that:</p>
<ul>
...
<p>Open CodeBlocks or any similar C++ IDE, and experiment on your own!</p>

<div class="ws-note ws-panel">
<p>Start small. Add one feature at a time. Remember to test often!</p>
<p><strong>Tip:</strong> We have also gathered a set of simple projects in our <a href="cpp_real_life_examples.asp">Real Life Examples page</a>.</p>
</div>
