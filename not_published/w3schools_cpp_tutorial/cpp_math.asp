...
<h1>C++ <span class="color_h1">Math</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_challenges_strings.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_booleans.asp">Next &#10095;</a>
</div>
<hr>

<h2>C++ Math</h2>
<p>C++ has many functions that allows you to perform mathematical tasks on numbers.</p>
<hr>

<h2>Max and min</h2>

<p>The <code class="w3-codespan">max(<em>x</em>,<em>y</em>)</code> function can be used to find the highest value of <em>x</em> and
<em>y</em>:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_math_max">Try it Yourself &raquo;</a>
</div>

<p>And the <code class="w3-codespan">min(<em>x</em>,<em>y</em>)</code> function can be used to find the lowest value of 
<em>x</em> 
and <em>y</em>:</p>
<div class="w3-example">
<h3>Example</h3>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_math_min">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>C++  &lt;cmath&gt; Library</h2>
<p>Other functions, such as <code class="w3-codespan">sqrt</code> (square root), <code class="w3-codespan">round</code> (rounds a number) and <code class="w3-codespan">log</code> 
(natural logarithm), can be found in the <code class="w3-codespan">&lt;cmath&gt;</code> header 
file:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  // Include the cmath library<br>#include &lt;cmath&gt;<br><br>cout &lt;&lt; 
  sqrt(64);<br>cout &lt;&lt; round(2.6);<br>cout &lt;&lt; log(2);<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_math_cmath">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Complete Math Reference</h2>
<p>For a complete reference of Math functions, go to our <a href="cpp_ref_math.asp">C++ Math Reference</a>.</p>
