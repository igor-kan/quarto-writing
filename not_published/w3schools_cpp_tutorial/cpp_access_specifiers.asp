...
<html lang="en-US">
<head>
<title>C++ Access Specifiers</title>
<meta charset="utf-8">
...
<h1>C++ <span class="color_h1">Access Specifiers</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_constructors_overloading.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_encapsulation.asp">Next &#10095;</a>
</div>
<hr>

<h2>Access Specifiers</h2>
<p><b>Access specifiers</b> control how the members (attributes and methods) of a class can be accessed.</p>

<p>They help protect data and organize code so that only the right parts can be seen or changed.</p>
<hr>

<h2>Using Access Specifiers</h2>

<p>The <code class="w3-codespan">public</code> keyword is an <strong>access specifier.</strong> 
</p>
<p>In the example below, the members are <code class="w3-codespan">public</code> 
- which means that they can be accessed and modified from outside the code:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  class MyClass {&nbsp; // The class<br>&nbsp; <strong>public:</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Access specifier<br>&nbsp;&nbsp;&nbsp; 
  // class members goes here<br>};<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_access_public">Try it Yourself &raquo;</a>
</div>

<p>However, what if we want 
members to be private and hidden from the outside world? </p>
<p>In C++, there are three access specifiers:</p>
<ul>
<li><code class="w3-codespan">public</code> - members are accessible from outside the class</li>
<li><code class="w3-codespan">private</code> - members cannot be accessed (or 
viewed) from outside the class</li>
<li><code class="w3-codespan">protected</code> - members cannot be accessed from 
outside the class, however, they can be accessed in inherited classes. You will learn more about <a href="cpp_inheritance.asp">Inheritance</a> later.</li>
</ul>
<hr>

<h2>Private</h2>
<p>Members declared as <code class="w3-codespan">private</code> cannot be accessed from outside the class.</p>
<p>In the following example, we demonstrate the differences between <code class="w3-codespan">public</code> and <code class="w3-codespan">private</code> members:</p>
<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    class 
    MyClass {<br>&nbsp; 
    <strong>public:</strong>&nbsp;&nbsp;&nbsp; // Public access 
    specifier<br>&nbsp;&nbsp;&nbsp; int x;&nbsp;&nbsp; // Public attribute<br>&nbsp;
    <strong>private:</strong>&nbsp;&nbsp; // Private access specifier<br>&nbsp;&nbsp;&nbsp; 
    int y;&nbsp;&nbsp; // Private attribute<br>};<br><br>int main() {<br>&nbsp; MyClass 
    myObj;<br>&nbsp; myObj.x = 25;&nbsp; // Allowed (public)<br>&nbsp; myObj.y = 50;&nbsp; // 
    Not allowed (private)<br>&nbsp; 
    return 0;<br>}<br>
 </div>
<p>If you try to access a private member, an error occurs:</p>
<div class="w3-padding notranslate w3-black">
<code>
error: y is private
</code>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="trycpp.asp?filename=demo_access_private">Try it Yourself &raquo;</a>
</div>
<div class="ws-note w3-panel">
<p><strong>Note:</strong> It is possible to access private members of a class 
using a public method inside the same class. See the next chapter (<a href="cpp_encapsulation.asp">Encapsulation</a>) 
on how to do this.</p>
  <p><strong>Tip:</strong> It is considered good practice to declare your class attributes as private (as 
often as you can). This will reduce the possibility of yourself (or others) to mess up the code. This is also the 
  main ingredient of the <a href="cpp_encapsulation.asp">Encapsulation</a> 
  concept, which you will learn more about in the next chapter.</p>
</div>

<p><strong>Note:</strong> By default, all members of a class are <code class="w3-codespan">private</code> if you don't specify an access specifier:</p>
<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    class 
    MyClass {<br>&nbsp;&nbsp;int x;&nbsp;&nbsp; // Private attribute<br>&nbsp;&nbsp;int y;&nbsp;&nbsp; // Private attribute<br>};<br>
 </div>
</div>
...
<h2>Protected</h2>
<p>Members declared as <code class="w3-codespan">protected</code> cannot be accessed from outside the class, but they <b>can</b> be accessed in child classes.</p>

<p>You will learn more about <a href="cpp_inheritance.asp">Inheritance</a> in a later chapter.</p>
<hr>

<h2>Real-Life Example</h2>

<ul>
  <li><b>Public:</b> Like the front door of your house - anyone can come in.</li>
  <li><b>Private:</b> Like a locked drawer - only the owner (or trusted friends) can open it.</li>
  <li><b>Protected:</b> Like a family-only room - children (subclasses) can enter, others cannot.</li>
</ul>

<hr>
<div id="exercisecontainer" src="xrcise_access_specifiers.js"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_constructors_overloading.asp">&#10094; Previous</a>
