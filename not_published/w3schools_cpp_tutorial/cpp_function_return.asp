...
<html lang="en-US">
<head>
<title>C++ Functions - Return</title>
<meta charset="utf-8">
...
<h1>C++ <span class="color_h1">The Return Keyword</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_function_multiple.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_function_reference.asp">Next &#10095;</a>
</div>
<hr>
<h2>Return Values</h2>
...
<h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    <strong>int</strong> myFunction(int x) {<br>&nbsp; <strong>return</strong> 5 
    + x;<br>}<br><br>int main() {<br>&nbsp; cout &lt;&lt; myFunction(3);<br>&nbsp; 
    return 0;<br>}<br><br>// Outputs 
  8 (5 + 3)<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_functions_void">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate javaHigh">
  ...
  {<br>&nbsp; cout &lt;&lt; myFunction(5, 3);<br>&nbsp; return 0;<br>}<br><br>
  // Outputs 8 (5 + 3)<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_functions_void2">Try it Yourself &raquo;</a>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  int myFunction(int x, int y) {<br>&nbsp; return x + y;<br>}<br><br>int main() {<br>&nbsp; 
  int z = myFunction(5, 3);<br>&nbsp; cout &lt;&lt; z;<br>&nbsp; return 0;<br>}<br>
  // Outputs 8 (5 + 3)<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_functions_void3">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Pratical Example</h2>
<p>Here is a simple and fun &quot;game example&quot; using a function with <code class="w3-codespan">return</code> 
to double a number five times:</p><div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
...
<hr>
<div id="exercisecontainer" src="xrcise_function_return.js"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_function_multiple.asp">&#10094; Previous</a>
