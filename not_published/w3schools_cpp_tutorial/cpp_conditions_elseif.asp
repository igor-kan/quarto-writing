...
<a class="w3-left w3-btn" href="cpp_conditions_else.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_conditions_shorthand.asp">Next &#10095;</a>
</div>
<hr>
...
<p>
Use the <code class="w3-codespan">else if</code> statement to specify a new condition
to test if the first condition is <code class="w3-codespan">false</code>.
</p>

<p>
You can use <code class="w3-codespan">else if</code> to check multiple conditions,
one after another.
</p>
...
As soon as one condition is <code class="w3-codespan">true</code>,
its block of code is executed, and the rest are skipped.
</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_if_else_if">
...
<p>
Just like with <code class="w3-codespan">if</code> statements,
you can store conditions in boolean variables and use them with
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_if_else_if_bool">
Try it Yourself &raquo;
</a>
</div>
...
<p>
<strong>Tip:</strong> Boolean variable names like
<code class="w3-codespan">isMorning</code> and <code class="w3-codespan">isDay</code>
make it easier to understand what each condition means.
</p>
</div>

<hr>

<div id="exercisecontainer" src="xrcise_conditions_elseif.js"></div>
<hr>
