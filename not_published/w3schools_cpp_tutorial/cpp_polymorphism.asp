...
<h1>C++ <span class="color_h1">Polymorphism</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_inheritance_access.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_virtual_functions.asp">Next &#10095;</a>
</div>
<hr>
...
<a href="cpp_inheritance.asp"><strong>Inheritance</strong></a> lets us 
...
<p>For example, imagine a base class <b>Animal</b> with a method called <code class="w3-codespan">makeSound()</code>. Derived classes of Animals could be Pigs, Cats, Dogs, Birds, etc. Every animal can "make a sound", but each one sounds different:</p>

<ul>
  <li><b>Pig:</b> wee wee</li>
  <li><b>Dog:</b> bow wow</li>
  <li><b>Bird:</b> tweet tweet</li>
</ul>

<p>This is polymorphism - the same action (making a sound) behaves differently 
for each animal:</p>
<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    // Base class<br>class Animal {<br>&nbsp; public:<br>&nbsp;&nbsp;&nbsp; void 
    animalSound() {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; cout &lt;&lt; &quot;The animal makes a sound \n&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>};<br><br>// Derived class<br>
    class Pig : public Animal {<br>&nbsp; public:<br>&nbsp;&nbsp;&nbsp; void 
    animalSound() {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; cout &lt;&lt; &quot;The pig says: wee wee \n&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>};<br><br>// Derived class<br>class Dog 
    : public Animal {<br>&nbsp; public:<br>&nbsp;&nbsp;&nbsp; void animalSound() 
    {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; cout &lt;&lt; &quot;The dog says: bow wow \n&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>
    };</div>
</div>

<div class="ws-note w3-panel">
<p>Remember from the <a href="cpp_inheritance.asp">Inheritance chapter</a> that we use the <code class="w3-codespan">:</code> symbol to inherit from a class.</p>
</div>

<p>Now we can create <code class="w3-codespan">Pig</code> and <code class="w3-codespan">
Dog</code> objects and override the <code class="w3-codespan">animalSound()</code> method:</p>
<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    // Base class<br>class Animal {<br>&nbsp; public:<br>&nbsp;&nbsp;&nbsp; void 
    ...
    : public Animal {<br>&nbsp; public:<br>&nbsp;&nbsp;&nbsp; void animalSound() 
    {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; cout &lt;&lt; &quot;The dog says: bow wow \n&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>
    };<br><br>int main() {<br>&nbsp; Animal 
    myAnimal;<br>&nbsp; Pig myPig;<br>&nbsp; Dog myDog;<br><br>&nbsp; 
    myAnimal.animalSound();<br>&nbsp; myPig.animalSound();<br>&nbsp; 
    myDog.animalSound();<br>&nbsp; return 0;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_polymorphism">Try it Yourself &raquo;</a>
</div>
