...
<a class="w3-left w3-btn" href="cpp_challenges_booleans.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_conditions_else.asp">Next &#10095;</a>
</div>
<hr>
...
<p>These conditions are used to perform different actions depending on whether something is true or false.</p>

<p>C++ has the following conditional statements:</p>
<ul>
  <li>Use <code class="w3-codespan">if</code> to specify a block of code to be executed, if a condition is true</li>
...
<p>
Use the <code class="w3-codespan">if</code> statement to specify a block of C++ code to be executed
if a condition is <code class="w3-codespan">true</code>.
</p>
...
<p>
Note that <code class="w3-codespan">if</code> is written in lowercase letters.
Uppercase letters (<code class="w3-codespan">If</code> or <code class="w3-codespan">IF</code>) will generate an error.
</p>
</div>

<p>
In the example below, we test two values to find out if 20 is greater than 18.
If the condition is <code class="w3-codespan">true</code>, we print a message:
</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_if">
Try it Yourself &raquo;
</a>
</div>

<p>We can also use variables in conditions:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_if2">
Try it Yourself &raquo;
</a>
</div>
...
<p>
In the example above, we use two variables, <strong>x</strong> and <strong>y</strong>,
to test whether <strong>x</strong> is greater than <strong>y</strong>.
Because 20 is greater than 18, the condition is true, and the message is printed.
</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_if_bool">
Try it Yourself &raquo;
</a>
</div>

<p>
This <strong>can</strong> make your code easier to read, especially when the condition is complex
