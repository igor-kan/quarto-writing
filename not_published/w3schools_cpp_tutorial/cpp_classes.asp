...
<h1>C++ <span class="color_h1">Classes and Objects</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_oop.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_class_methods.asp">Next &#10095;</a>
</div>
<hr>
...
<h3>Example</h3>
<p>Create a class called "<code class="w3-codespan">MyClass</code>&quot;:</p>
<div class="w3-code notranslate javaHigh">
  class MyClass {&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; 
  // The class<br>&nbsp; public:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  // Access specifier<br>&nbsp;&nbsp;&nbsp; int myNum;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // 
  Attribute (int variable)<br>&nbsp;&nbsp;&nbsp; string myString;&nbsp; // 
  Attribute (string variable)<br>};<br>
 </div>
</div>
...
<!--
<h3>What's the difference between a Class and a <a href="cpp_structs.asp">Structure</a>?</h3>
<p>The example above looks much like a <a href="cpp_structs.asp">structure (<code class="w3-codespan">struct</code>)</a>.</p>
<ul>
<li>Structures are much simpler than objects. Unlike objects, structures cannot do <a href="cpp_encapsulation.asp">encapsulation</a>, <a href="cpp_inheritance.asp">inheritance</a> or <a href="cpp_polymorphism.asp">polymorphism</a>, 
which you will learn more about in the next chapters. If all you need is a collection of variables, a structure is easier to use than an object.</li>
...
<div class="w3-example">
<h3>Example</h3>
<p>Create an object called "<code class="w3-codespan">myObj</code>&quot; and access 
the attributes:</p>
<div class="w3-code notranslate javaHigh">
  class MyClass {&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; // The class<br>&nbsp; public:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  // Access specifier<br>&nbsp;&nbsp;&nbsp; int myNum;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // 
  Attribute (int variable)<br>&nbsp;&nbsp;&nbsp; string myString;&nbsp; // 
  Attribute (string variable)<br>};<br><br>int main() {<br>&nbsp; MyClass <strong>myObj</strong>;&nbsp; 
  // Create an object of MyClass<br><br>&nbsp; // Access attributes and set values<br>&nbsp; <strong>myObj.myNum</strong> 
  = 15;&nbsp;<br>&nbsp; <strong>
  myObj.myString</strong> = &quot;Some text&quot;;<br><br>&nbsp; // Print attribute values<br>&nbsp; 
  cout &lt;&lt; myObj.myNum&nbsp;&lt;&lt; &quot;\n&quot;; <br>&nbsp; cout &lt;&lt; myObj.myString; <br>&nbsp; return 0;<br>}<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_object_attr">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-example">
  <h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  // Create a Car class with some attributes<br>class Car {<br>&nbsp; public:<br>&nbsp;&nbsp;&nbsp; string brand;&nbsp;&nbsp;&nbsp;<br>&nbsp;&nbsp;&nbsp; string model;<br>&nbsp;&nbsp;&nbsp; int 
  year;<br>};<br><br>int main() {<br>&nbsp; // Create an object of Car<br>&nbsp; Car carObj1;<br>&nbsp; carObj1.brand = &quot;BMW&quot;;<br>&nbsp; 
  carObj1.model = &quot;X5&quot;;<br>&nbsp; carObj1.year = 1999;<br><br>&nbsp; 
  // Create another object of Car<br>&nbsp; Car 
  carObj2;<br>&nbsp; carObj2.brand = &quot;Ford&quot;;<br>&nbsp; carObj2.model = 
  &quot;Mustang&quot;;<br>&nbsp; carObj2.year = 1969;<br><br>&nbsp; // Print 
  attribute values<br>&nbsp; cout &lt;&lt; carObj1.brand 
  &lt;&lt; &quot; &quot; &lt;&lt; carObj1.model &lt;&lt; &quot; &quot; &lt;&lt; carObj1.year &lt;&lt; &quot;\n&quot;;<br>&nbsp; cout &lt;&lt; 
  carObj2.brand &lt;&lt; &quot; &quot; &lt;&lt; carObj2.model &lt;&lt; &quot; &quot; &lt;&lt; carObj2.year &lt;&lt; &quot;\n&quot;;<br>&nbsp; return 0;<br>}<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_object_real">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Challenge Task</h2>

<p>Create a class called <code class="w3-codespan">Book</code> with the following attributes:</p>
<ul>
  <li><code class="w3-codespan">title</code> (<code class="w3-codespan">string</code>)</li>
  <li><code class="w3-codespan">author</code> (<code class="w3-codespan">string</code>)</li>
  <li><code class="w3-codespan">year</code> (<code class="w3-codespan">int</code>)</li>
</ul>
<p>Then create two objects of the class and print their attribute values.</p>

<div class="w3-example">
<h4>Expected Output</h4>
<div class="w3-code notranslate ws-black">
Matilda, Roald Dahl, 1988<br>
The Giving Tree, Shel Silverstein, 1964
</div>
</div>

<button onclick="myAccFunc('classChallenge', this)" class="ws-btn w3-block w3-left-align ">
  <span class="icon" style="margin-right:8px;">&#x2795;</span> Show Solution
</button>

<div id="classChallenge" class="w3-hide">
  <div class="w3-example">
    <div class="w3-code notranslate javaHigh">
#include &lt;iostream&gt;<br>
#include &lt;string&gt;<br>
...
int main() {<br>
&nbsp;&nbsp;Book book1;<br>
&nbsp;&nbsp;book1.title = "Matilda";<br>
&nbsp;&nbsp;book1.author = "Roald Dahl";<br>
&nbsp;&nbsp;book1.year = 1988;<br><br>

&nbsp;&nbsp;Book book2;<br>
&nbsp;&nbsp;book2.title = "The Giving Tree";<br>
&nbsp;&nbsp;book2.author = "Shel 
      Silverstein";<br>
&nbsp;&nbsp;book2.year = 1964;<br><br>

&nbsp;&nbsp;cout &lt;&lt; book1.title &lt;&lt; ", " &lt;&lt; book1.author &lt;&lt; ", " &lt;&lt; book1.year &lt;&lt; "\n";<br>
&nbsp;&nbsp;cout &lt;&lt; book2.title &lt;&lt; ", " &lt;&lt; book2.author &lt;&lt; ", " &lt;&lt; book2.year;<br>
&nbsp;&nbsp;return 0;<br>
}
    </div>
    <a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_object_challenge">Try it Yourself &raquo;</a>
  </div>
</div>

<script>
function myAccFunc(id, btn) {
