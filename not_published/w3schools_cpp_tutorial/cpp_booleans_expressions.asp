...
<html lang="en-US">
<head>
<title>C++ Boolean Expressions</title>
<meta charset="utf-8">
...
<h1>C++ <span class="color_h1">Boolean Expressions</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_booleans.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_booleans_reallife.asp">Next &#10095;</a>
</div>
<hr>

<h2>Boolean Expressions</h2>
<p>A <strong>Boolean expression</strong> is a piece of code that compares values or variables and returns a boolean value:
<code class="w3-codespan">1</code> (true) or <code class="w3-codespan">0</code> (false).</p>

<p>Boolean expressions are the foundation of decision making in programming - they let your program decide what to do based on whether something is true or false.</p>

<p>You can use a <a href="cpp_operators_comparison.asp">comparison operator</a>, such as the <strong>greater than</strong> (<code class="w3-codespan">&gt;</code>) operator,
to find out if an expression (or variable) is true or false:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  int x = 10;<br>int y = 9;<br>cout &lt;&lt; (x &gt; y); // returns 1 (true), because 10 is higher than 9</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_boolean1">Try it Yourself &raquo;</a>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  cout &lt;&lt; (10 &gt; 9); // returns 1 (true), because 10 is higher than 9</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_boolean2">Try it Yourself &raquo;</a>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  int x = 10;<br>cout &lt;&lt; (x == 10);&nbsp; // returns 1 (true), because the value
  of x is equal to 10</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_boolean3">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate javaHigh">
  cout &lt;&lt; (10 == 15);&nbsp; // returns
  0 (false), because 10 is not equal to 15</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_boolean4">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Store the Result in a Boolean Variable</h2>
<p>You can also store the result of a comparison in a <code class="w3-codespan">bool</code> variable:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Store the result of <code class="w3-codespan">x &gt; y</code> in a boolean variable, and print it:</p>
<div class="w3-code notranslate javaHigh">
  int x = 10;<br>
  int y = 9;<br><br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_boolean_store1">
...
<hr>
<div id="exercisecontainer" src="xrcise_booleans_expressions.js"></div>
<hr>
