...
<html lang="en-US">
<head>
<title>C++ Inheritance and Access Specifiers</title>
<meta charset="utf-8">
...
<h1>C++ <span class="color_h1">Inheritance Access</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_inheritance_multiple.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_polymorphism.asp">Next &#10095;</a>
</div>
<hr>

<h2>Access Specifiers</h2>

<p>You learned from the <a href="cpp_access_specifiers.asp">Access Specifiers</a> chapter that there are three 
specifiers available in C++.</p>
<p>Until now, we have only used <code class="w3-codespan">public</code> (members of a 
class are accessible from outside the class) and <code class="w3-codespan">private</code> (members can only be 
accessed within the class).</p>
<p>The third specifier, <code class="w3-codespan">protected</code>, is similar to 
<code class="w3-codespan">private</code>, but it can also be accessed in the 
<strong>inherited</strong> class:</p>
<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    // Base class<br>class 
    Employee {<br>&nbsp; <strong>protected: // Protected access specifier</strong><br>&nbsp;&nbsp;&nbsp; 
    int salary;<br>};<br>
    <br>// Derived class<br>class Programmer: public Employee {<br>&nbsp; 
    public:<br>&nbsp;&nbsp;&nbsp; int bonus;<br>&nbsp;&nbsp;&nbsp; void 
    setSalary(int s) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; salary = s;<br>&nbsp;&nbsp;&nbsp; 
    }<br>&nbsp;&nbsp;&nbsp; int getSalary() {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    return salary;<br>&nbsp;&nbsp;&nbsp; }<br>};<br><br>int main() {<br>&nbsp; 
    Programmer myObj;<br>&nbsp; myObj.setSalary(50000);<br>&nbsp; myObj.bonus = 
    15000;<br>&nbsp; cout &lt;&lt; 
    &quot;Salary: &quot; &lt;&lt; myObj.getSalary() &lt;&lt; &quot;\n&quot;;<br>&nbsp; cout &lt;&lt; &quot;Bonus: &quot; &lt;&lt; 
    myObj.bonus &lt;&lt; &quot;\n&quot;;<br>&nbsp; return 0;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_inheritance_protected">Try it Yourself &raquo;</a>
</div>
...
<hr>
<div id="exercisecontainer" src="xrcise_inheritance_access.js"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_inheritance_multiple.asp">&#10094; Previous</a>
