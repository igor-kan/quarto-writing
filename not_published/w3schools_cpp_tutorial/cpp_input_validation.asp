...
<a class="w3-left w3-btn" href="cpp_exceptions.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_data_structures.asp">Next &#10095;</a>
</div>
<hr>

<h2>Input Validation</h2>

<p>When users enter data into a program, they might type something unexpected. <strong>Input validation</strong> makes sure the input is correct before your program continues.</p>

<p>Without validation, your program might crash or behave incorrectly!</p>
<p>The examples below show simple ways to check if the user's input is valid.</p>
<hr>
<h2>Validate Integer Input</h2>
<p>Make sure the user enters a number. If they enter something else (like a letter), ask again:</p>
...
while (!(cin &gt;&gt; number)) {&nbsp; // Keep asking until the user enters a 
    valid number<br>
&nbsp;&nbsp;cout &lt;&lt; "Invalid input. Try again: ";<br>
&nbsp;&nbsp;cin.clear(); // Reset input errors<br>
&nbsp;&nbsp;cin.ignore(10000, '\n'); // Remove bad input<br>
}<br>
...
<code>Enter a number: f<br>
Invalid input. Try again: 3<br>
You entered: 3</code>
</div>
</div>
<hr>
...
<p>Check if the number is within an allowed range (e.g. 1 to 5):</p>

<div class="w3-example">
  <div class="w3-code notranslate javaHigh">
int number;<br>
do {<br>
&nbsp;&nbsp;cout &lt;&lt; "Choose a number between 1 and 5: ";<br>
&nbsp;&nbsp;cin &gt;&gt; number;<br>
} while (number &lt; 1 || number&gt; 5);&nbsp; // Keep asking until the user 
    enters a number between 1 and 5<br><br>
...
<p>Check that a name is not empty:</p>
...
<p><strong>Tip:</strong> You can read more about the <code class="w3-codespan"><a href="ref_iostream_cin.asp">cin</a></code> object in our 
<a href="cpp_ref_iostream.asp">&lt;iostream&gt; library reference</a>.</p>
<hr>
