...
<h1>C++ <span class="color_h1">Queues</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_stacks.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_deque.asp">Next &#10095;</a>
</div>
<hr>

<h2>C++ Queue</h2>
<p>A queue stores multiple elements in a specific order, called <strong>FIFO</strong>.</p>
<p><strong>FIFO</strong> stands for <strong>
...
<p>Unlike <a href="cpp_vectors.asp">vectors</a>, elements in the queue are not 
...
-->
<p>To use a queue, you have to include the <code class="w3-codespan">&lt;queue&gt;</code> header file: 
<div class="w3-example">
<div class="w3-code notranslate javaHigh">
  // Include the queue library<br>#include &lt;queue&gt;<br>
 </div>
</div>
...
<p>To create a queue, use the <code class="w3-codespan">queue</code> keyword, 
and specify the <strong>type</strong> of values it should store within angle brackets <code class="w3-codespan">&lt;&gt;</code> 
and then the name of the queue, like: <code class="w3-codespan">queue&lt;<em>type</em>&gt; 
<em>queueName</em></code>.</p>

<div class="w3-example">
<div class="w3-code notranslate javaHigh">
  // Create a 
  queue of strings called cars<br>
  queue&lt;string&gt; cars;<br>
 </div>
</div>
<p><strong>Note:</strong> The type of the queue (string in our example) cannot be changed after its been declared.</p>


<p><strong>Note:</strong> You cannot add elements to the queue at the time of declaration, like you can with <a href="cpp_vectors.asp">vectors</a>:</p>
...
<h2>Add Elements</h2>
<p>To add elements to the queue, you can use the <code class="w3-codespan">.push()</code> 
function after declaring the queue.</p>
<p>The <code class="w3-codespan">.push()</code> function adds an element at the 
end of the queue:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  // Create a queue of strings<br>queue&lt;string&gt; cars;<br><br>// Add elements to the queue<br>cars.push(&quot;Volvo&quot;);<br>cars.push(&quot;BMW&quot;);<br>
  cars.push(&quot;Ford&quot;);<br>cars.push(&quot;Mazda&quot;);<br>
 </div>
 <p>The queue will look like this:</p>
 <div class="w3-padding notranslate w3-black w3-margin-top w3-margin-bottom">
<code>
   Volvo (front (first) element)<br>
   BMW<br>
   Ford<br>
...
<h2>Access Queue Elements</h2>
<p>You cannot access queue elements by referring to index numbers, like you would with 
<a href="cpp_arrays.asp">arrays</a> and <a href="cpp_vectors.asp">vectors</a>.</p>
<p>In a queue, you can only access the element at the front or the back, using
<code class="w3-codespan">.front()</code> and <code class="w3-codespan">.back()</code> 
respectively:</p>
<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    // Access the 
    front element (first and oldest)<br>cout &lt;&lt; cars.front();&nbsp; // 
    Outputs &quot;Volvo&quot;<br><br>// Access the 
    back element (last and newest)<br>cout &lt;&lt; cars.back();&nbsp; // 
    Outputs &quot;Mazda&quot;<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_queue_access">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Change Front and Back Elements</h2>

<p>You can also use <code class="w3-codespan">.front</code> and <code class="w3-codespan">.back</code> to change the value of the front and back elements:</p>
<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    // Change the value of the front element<br>cars.front() = &quot;Tesla&quot;;<br><br>
    // Change the value of the back element<br>cars.back() = &quot;VW&quot;;<br><br>// 
    Access the front element<br>cout &lt;&lt; cars.front();&nbsp; // Now outputs 
    &quot;Tesla&quot; instead of &quot;Volvo&quot;<br><br>// Access the back element<br>cout &lt;&lt; cars.back();&nbsp; // Now outputs &quot;VW&quot; instead 
    of &quot;Mazda&quot;<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_queue_change">Try it Yourself &raquo;</a>
</div>
...
<p>You can use the <code class="w3-codespan">.pop()</code> function to remove an element from the 
queue.</p>
<p>This will remove the front element (the first and oldest element that was added to the 
queue):</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  // Create a queue of strings<br>queue&lt;string&gt; cars;<br><br>// Add elements to the queue<br>cars.push(&quot;Volvo&quot;);<br>cars.push(&quot;BMW&quot;);<br>
  cars.push(&quot;Ford&quot;);<br>cars.push(&quot;Mazda&quot;);<br><br>// Remove the 
  front 
  element (Volvo)<br><strong>cars.pop();</strong><br><br>// Access the front 
  element (Now BMW)<br>
  cout &lt;&lt; cars.front();<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_queue_remove">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Get the Size of a Queue</h2>
<p>To find out how many elements there are in a queue, use the <code class="w3-codespan">.size()</code> function:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  cout 
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_queue_size">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Check if the Queue is Empty</h2>
<p>Use the <code class="w3-codespan">.empty()</code> function to find out if the 
queue is empty or not.</p>
<p>The <code class="w3-codespan">.empty()</code> function returns <code class="w3-codespan">
1</code> (<em>true</em>) if the queue is empty and <code class="w3-codespan">0</code> (<em>false</em>) 
otherwise:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  queue&lt;string&gt; cars;<br>cout &lt;&lt; cars.empty(); 
  // Outputs 1 (The queue is empty)<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_queue_empty">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  queue&lt;string&gt; cars;<br><br>cars.push(&quot;Volvo&quot;);<br>cars.push(&quot;BMW&quot;);<br>
  cars.push(&quot;Ford&quot;);<br>cars.push(&quot;Mazda&quot;);<br><br>cout 
  &lt;&lt; cars.empty();&nbsp; 
  // Outputs 0 (not empty)<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_queue_empty2">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Stacks and Queues</h2>
<p>Queues are often mentioned together with <a href="cpp_stacks.asp">Stacks</a>, which is a similar data structure described in the 
<a href="cpp_stacks.asp">previous page</a>.</p>

<hr>
<div id="exercisecontainer" src="xrcise_queues.js"></div>
<hr>
<br>
