...
<h1>C++ <span class="color_h1">Deque</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_queues.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_sets.asp">Next &#10095;</a>
</div>
<hr>

<h2>C++ Deque</h2>
<p>In the previous page, your learned that elements in a <a href="cpp_queues.asp">queue</a> are added at the 
end and removed from the front.<p>A deque (stands for <strong>d</strong>ouble-<strong>e</strong>nded<strong>
queue</strong>) however, is more flexible, as elements can be added and removed 
from both ends (at the front and the back). You can also access elements by 
index numbers. </p>
<p>To use a deque, you have to include the <code class="w3-codespan">&lt;deque&gt;</code> header file:

<div class="w3-example">
<div class="w3-code notranslate javaHigh">
  // Include the deque library<br>#include &lt;deque&gt;<br>
 </div>
</div>

<hr>

<h2>Create a Deque</h2>
<p>To create a deque, use the <code class="w3-codespan">deque</code> keyword, 
and specify the <strong>type</strong> of values it should store within angle brackets <code class="w3-codespan">&lt;&gt;</code> 
and then the name of the deque, like: <code class="w3-codespan">deque&lt;<em>type</em>&gt; 
<em>dequeName</em></code>.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  // Create a deque called cars that will store strings<br>
...
<div class="w3-code notranslate javaHigh">
  ...
  &quot;Ford&quot;, &quot;Mazda&quot;};<br><br>// Print deque elements<br>
  for (string car : cars) {<br>&nbsp; cout &lt;&lt; car &lt;&lt; &quot;\n&quot;;<br>}<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_deque">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
  <p><strong>Note:</strong> The type of the deque (<code class="w3-codespan">string</code> in our example) cannot be changed after its been declared.</p>
</div>
<hr>
<h2>Access a Deque</h2>
<p>You can access a deque element by referring to the index number inside square brackets <code class="w3-codespan">[]</code>.</p>
<p>Deques are 0-indexed, meaning that <code class="w3-codespan">[0]</code> is the first element, 
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_deque_access">Try it Yourself &raquo;</a>
</div>

<p>You can also access the first or the last element of a deque 
with the <code class="w3-codespan">.front()</code> and <code class="w3-codespan">.back()</code> 
functions:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_deque_access2">Try it Yourself &raquo;</a>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  // Create a deque called cars that will store strings<br>deque&lt;string&gt; cars = {&quot;Volvo&quot;, &quot;BMW&quot;, 
  &quot;Ford&quot;, &quot;Mazda&quot;};<br><br>// Get the second element<br>
  cout &lt;&lt; cars.at(1);<br><br>// Get the third element<br>
  cout &lt;&lt; cars.at(2);<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_deque_access3">Try it Yourself &raquo;</a>
</div>
...
error message if the element is out of range:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh w3-border-red">
  ...
  not exist (will throw an exception)<br>cout &lt;&lt; cars.at(6);<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_deque_access4">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_deque_change2">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Add Deque Elements</h2>
<p>To add elements to a deque, you can use <code class="w3-codespan">.push_front()</code> 
to insert an element at the beginning of the deque and <code class="w3-codespan">.push_back()</code> 
to add an element at the end:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  deque&lt;string&gt; cars = {&quot;Volvo&quot;, &quot;BMW&quot;, &quot;Ford&quot;, &quot;Mazda&quot;};<br><br>// Add an 
  element at the beginning<br>cars.push_front(&quot;Tesla&quot;);<br><br>// Add an element 
  at the end<br>cars.push_back(&quot;VW&quot;);<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_deque_add">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Remove Deque Elements</h2>
<p>To remove elements from a deque, use <code class="w3-codespan">.pop_front()</code> 
to remove an element from the beginning of the deque and <code class="w3-codespan">.pop_back()</code> 
to remove an element at the end:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  deque&lt;string&gt; cars = {&quot;Volvo&quot;, &quot;BMW&quot;, &quot;Ford&quot;, &quot;Mazda&quot;};<br><br>// Remove the 
  first element<br>cars.pop_front();<br><br>// Remove the last element<br>cars.pop_back();<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_deque_remove">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Deque Size</h2>
<p>To find out how many elements a deque has, use the <code class="w3-codespan">.size()</code> function:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  deque&lt;string&gt; cars = {&quot;Volvo&quot;, &quot;BMW&quot;, &quot;Ford&quot;, &quot;Mazda&quot;};<br>cout &lt;&lt; cars.size();&nbsp; 
  // Outputs 4<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_deque_size">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Check if a Deque is Empty</h2>
<p>Use the <code class="w3-codespan">.empty()</code> function to find out if a 
deque is empty or not.</p>
<p>The <code class="w3-codespan">.empty()</code> function returns <code class="w3-codespan">
1</code> (<em>true</em>) if the deque is empty and <code class="w3-codespan">0</code> (<em>false</em>) 
otherwise:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  deque&lt;string&gt; cars;<br>cout &lt;&lt; cars.empty();&nbsp; 
  // Outputs 1 (The deque is empty)<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_deque_empty">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  deque&lt;string&gt; cars = {&quot;Volvo&quot;, &quot;BMW&quot;, &quot;Ford&quot;, &quot;Mazda&quot;};<br>cout &lt;&lt; cars.empty();&nbsp; 
  // Outputs 0 (not empty)<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_deque_empty2">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Loop Through a Deque</h2>
<p>You can loop through the deque elements by using a <code class="w3-codespan">for</code> loop combined with the 
<code class="w3-codespan">.size()</code> function:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  deque&lt;string&gt; cars = {&quot;Volvo&quot;, &quot;BMW&quot;, &quot;Ford&quot;, &quot;Mazda&quot;};<br><br>for (int i = 
  0; i &lt; cars.size(); i++) {<br>&nbsp; cout &lt;&lt; cars[i] &lt;&lt; &quot;\n&quot;;<br>}<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_deque_loop">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_deque_loop2">Try it Yourself &raquo;</a>
</div>
<p><strong>Tip:</strong> It is also possible to loop through deques with an <a href="cpp_iterators.asp">iterator</a>, which you will learn more about in a later chapter.</p>

<hr>
<div id="exercisecontainer" src="xrcise_deque.js"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_queues.asp">&#10094; Previous</a>
