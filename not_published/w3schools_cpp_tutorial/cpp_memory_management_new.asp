...
<html lang="en-US">
<head>
<title>C++ Memory Management - new and delete</title>
<meta charset="utf-8">
...
<h1>C++ <span class="color_h1">new and delete</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_memory_management.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_functions.asp">Next &#10095;</a>
</div>
<hr>

<h2>The new Keyword</h2>
<p>The <code class="w3-codespan">new</code> keyword lets you manage memory yourself.</p>

<p>In the example below, we create memory space for an integer using <code class="w3-codespan">new</code>, store the value <code>35</code> in it, and print it using a 
<strong>pointer</strong>:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_memory_management_new">Try it Yourself &raquo;</a>
</div>

<p><b>Explanation:</b></p>
<ul>
  <li><code class="w3-codespan">new int</code> creates memory space for one integer</li>
  <li><code class="w3-codespan">ptr</code> stores the address of that space</li>
  <li><code class="w3-codespan">*ptr = 35;</code> stores the number 35</li>
  <li><code class="w3-codespan">cout &lt;&lt; *ptr;</code> prints the value</li>
</ul>

<p>So we used <code class="w3-codespan">new</code> to create memory, and <code class="w3-codespan">ptr</code> to access it.</p>
<hr>

<h2>The delete Keyword</h2>

<p>When you create something with <code class="w3-codespan">new</code>, it's your job to remove it when you're done.</p>

<p>To do that, use <code class="w3-codespan">delete</code>:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_memory_management_delete">Try it Yourself &raquo;</a>
</div>

<p>This tells C++: "I'm done with this memory, you can clean it up now."</p>


<div class="ws-note ws-panel">
<h4>What Happens If You Forget <code>delete</code>?</h4>

<p>If you forget to delete memory, your program will still run, but it may use more and more memory over time.</p>

<p>This is called a <b>memory leak</b>, and it can slow down or crash your program over time.</p>
</div>
...
<h2>Using new and delete with Arrays</h2>

<p>You can also use the <code class="w3-codespan">new</code> keyword to create dynamic arrays.</p>
<p><b>Note:</b> For arrays, use <code class="w3-codespan">new[]</code> and <code class="w3-codespan">delete[]</code>.
For single variables, use <code class="w3-codespan">new</code> and <code class="w3-codespan">delete</code>.</p>

<p>Dynamic arrays are useful when you don't know the size of the array in advance - like when the size depends on user input or other values that are not 
known at the start of the program.</p>
<p>For example, imagine you run a hotel. Since you don't know how many guests 
will arrive, you ask the user for the number and create that many rooms - one to 
store each guest's name:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  #include &lt;iostream&gt;<br>#include &lt;string&gt;<br>using namespace std;<br><br>int 
  main() {<br>&nbsp; int numGuests;<br>&nbsp; cout &lt;&lt; &quot;How many guests? &quot;;<br>&nbsp; 
  cin &gt;&gt; numGuests;<br><br>&nbsp; // Check for invalid input<br>&nbsp; if 
  (numGuests &lt;= 0) {<br>&nbsp;&nbsp;&nbsp; cout &lt;&lt; "Number of guests must be at 
  least 1.\n";<br>&nbsp;&nbsp;&nbsp; return 0;<br>&nbsp; }<br><br>&nbsp; // Create memory space for <em>x</em> 
  guests (an array of strings)<br>&nbsp; string* guests = new string[numGuests];<br>
  <br>&nbsp; // Ignore the leftover newline character after reading numGuests<br>&nbsp; 
  cin.ignore(); <br><br>&nbsp; // Enter guest names<br>&nbsp; for (int i = 0; i &lt; numGuests; i++) 
  {<br>&nbsp;&nbsp;&nbsp; cout &lt;&lt; &quot;Enter name for guest &quot; &lt;&lt; (i + 1) &lt;&lt; &quot;: &quot;;<br>
  &nbsp;&nbsp;&nbsp; getline(cin, guests[i]); // Read the full name (including spaces)<br>&nbsp; }<br><br>&nbsp; // Show all guests<br>&nbsp; cout 
  &lt;&lt; &quot;\nGuests checked in:\n&quot;;<br>&nbsp; for (int i = 0; i &lt; numGuests; i++) {<br>&nbsp;&nbsp;&nbsp; 
  cout &lt;&lt; guests[i] &lt;&lt; &quot;\n&quot;;<br>&nbsp; }<br><br>&nbsp; delete[] guests; // Clean 
  up memory<br>&nbsp; return 0;<br>}</div>
<p>Example Result:</p>
<div class="notranslate w3-black w3-padding">
  <code>
How many guests? 3<br>
Enter name for guest 1: John Doe<br>
Enter name for guest 2: Liam Spurs<br>
Enter name for guest 3: Jenny Kasp<br>
Guests checked in:<br>
John Doe<br>
Liam Spurs<br>
Jenny Kasp</code>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="showcpp.asp?filename=demo_memory_management_array">Run Example &raquo;</a>
</div>
<hr>

<h2>When to Use <code>new</code></h2>

<p>In most cases, you don't need to use <code class="w3-codespan">new</code>. C++ will automatically handle memory for normal variables like:</p>
...
<p>But <b>sometimes</b>, you have to manage memory yourself - especially when:</p>

<ul>
  <li>You don't know how much memory you'll need in advance (like how many guests or scores)</li>
  <li>You want to create memory while the program is running, based on user input</li>
  <li>You need to store large or flexible amounts of data</li>
  <li>You want full manual control over memory (e.g., performance-critical code)</li>
</ul>

<p>In those cases, <code class="w3-codespan">new</code> helps you create memory, and <code class="w3-codespan">delete</code> helps you clean it up when you're done.</p>

<p><b>Tip:</b> If you use <code class="w3-codespan">new</code>, always remember to use <code class="w3-codespan">delete</code> (or <code class="w3-codespan">delete[]</code> for arrays) to avoid memory leaks.</p>


<!--
<h2>A Safer Option: Smart Pointers</h2>

<p>Instead of using <code class="w3-codespan">new</code> and <code class="w3-codespan">delete</code> yourself, you can use smart pointers.</p>

<p>Smart pointers automatically delete the memory for you. That means you don't have to worry about cleaning it up.</p>

<p>Learn how in the next chapter: <a href="#smart-pointers"><b>C++ Smart Pointers</b></a></p>
-->

<hr>
<div id="exercisecontainer" src="xrcise_memory_management_new.js"></div>
<hr>
