...
<html lang="en-US">
<head>
<title>C++ String Data Type</title>
<meta charset="utf-8">
...
<h1>C++ <span class="color_h1">String Data Types</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_data_types_char.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_auto.asp">Next &#10095;</a>
</div>
<hr>

<h2>String Types</h2>
<p>The <code class="w3-codespan">string</code> type is used to store a sequence of characters (text). 
This is not a built-in type, but it behaves like one in its most basic usage. String values must be surrounded by double quotes:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  string greeting = "Hello";<br>cout &lt;&lt; greeting;</div>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  // Include the string library<br>#include &lt;string&gt;<br><br>// Create a string variable<br>string greeting = "Hello";<br>
  <br>// Output string value<br>cout &lt;&lt; greeting;</div>

<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_strings">Try it Yourself &raquo;</a>
</div>
<div class="ws-note w3-panel">
<p>You will learn much more about strings in our <a href="cpp_strings.asp">C++ Strings Chapter</a>.</p>
</div>
<hr>
...
<hr>
<div id="exercisecontainer" src="xrcise_data_types_string.js"></div>
<hr>
