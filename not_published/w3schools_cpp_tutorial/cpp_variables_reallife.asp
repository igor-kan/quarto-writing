...
<a class="w3-left w3-btn" href="cpp_variables_constants.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_challenges_variables.asp">Next &#10095;</a>
</div>
<hr>

<h2>Real-Life Examples</h2>
<p>Let's get a bit more practical!</p>
...
and so on). This is done to avoid confusion. </p>
<p>However, for a practical example of using variables, we have created a program that stores different data about a college student:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  // Student data<br>int studentID = 15;<br>int studentAge = 23;<br>double 
...
<p>In this real-life example, we create a program to calculate the area of a 
rectangle (by multiplying the length and width):</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  // Create integer variables<br>int length = 4;<br>int width = 6;<br><br>// Calculate the area of a rectangle<br>
