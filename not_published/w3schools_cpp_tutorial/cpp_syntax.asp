...
<a class="w3-left w3-btn" href="cpp_getstarted.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_statements.asp">Next &#10095;</a>
</div>
<hr>
...
<p><strong>Line 3:</strong> A blank line. C++ ignores white space. But we use it 
...
<p><strong>Note:</strong> C++ is case-sensitive: "cout" and "Cout" has different meaning.</p>
...
<p>You might see some C++ programs that run without the standard namespace line. 
The <code class="w3-codespan">using namespace std;</code> statement can be omitted, 
and replaced with the <code class="w3-codespan">std</code> keyword followed by the 
<code class="w3-codespan">::</code> operator, for some objects (like <code class="w3-codespan">std::cout</code> in the example below):</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_helloworld2">
...
<div class="ws-note w3-panel">
<p>
Both approaches are valid in C++. Using <code class="w3-codespan">std::</code> makes it clear
where names come from and avoids name conflicts in larger programs.
</p>
</div>

<h3>Which One Do We Use?</h3>

<p>
In this tutorial, we will mostly use <code class="w3-codespan">using namespace std;</code>
</p>
<p>
This keeps the code shorter and easier to read while learning the basics of C++.
It helps beginners focus on understanding the language itself, instead of repeatedly
writing <code class="w3-codespan">std::</code> in every example.
</p>

<div class="ws-note w3-panel">
<p>
As you write larger or more advanced programs, you may prefer using
<code class="w3-codespan">std::</code> explicitly. You will see both styles in real-world C++ code.
</p>
</div>
<hr>
