...
<h1>C++ <span class="color_h1">Dereference</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_pointers.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_pointers_modify.asp">Next &#10095;</a>
</div>
<hr>

<h2>Get Memory Address and Value</h2>
<p>In the example from the previous page, we used the pointer variable to get the memory address of a variable 
(used together with the <code class="w3-codespan">&amp;</code> <strong>reference</strong> operator). However, you can also 
use the pointer to get the value of the variable, by using the <code class="w3-codespan">*</code> operator 
(the <strong>dereference</strong> operator):</p>
<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    string food = &quot;Pizza&quot;;&nbsp; // Variable declaration<br><strong>string* ptr = 
    &amp;food;</strong>&nbsp;&nbsp;&nbsp; // Pointer declaration<br><br>// 
    Reference: Output the memory address of food with the pointer (0x6dfed4)<br>cout &lt;&lt; 
    ptr &lt;&lt; &quot;\n&quot;;<br><br>// 
    Dereference: Output the value of food with the pointer (Pizza)<br><strong>cout &lt;&lt; 
    *ptr &lt;&lt; &quot;\n&quot;;</strong><br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_pointer_dereference">Try it Yourself &raquo;</a>
</div>
...
in our code:</p>
<ul>
<li>When used in declaration (string* ptr), it creates a <strong>pointer variable</strong>.</li>
...
<hr>
<div id="exercisecontainer" src="xrcise_pointers_dereference.js"></div>
<hr>
<br>
