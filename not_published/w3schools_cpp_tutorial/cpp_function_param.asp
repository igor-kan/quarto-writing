...
<a class="w3-left w3-btn" href="cpp_functions.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_function_default.asp">Next &#10095;</a>
</div>
<hr>
...
<h3>Syntax</h3>
  <div class="w3-code notranslate javaHigh">
    void <em>functionName</em>(<em>parameter1</em>, <em>parameter2</em>, <em>parameter3</em>) {<br>&nbsp; 
...
function that takes a <code class="w3-codespan">string</code> called <b>fname</b> as parameter.
...
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  void myFunction(<strong>string fname</strong>) {<br>&nbsp; cout &lt;&lt; fname &lt;&lt; &quot; Refsnes\n&quot;;<br>}<br>
  <br>int main() {<br>&nbsp; myFunction(<strong>&quot;Liam&quot;</strong>);<br>&nbsp; myFunction(<strong>&quot;Jenny&quot;</strong>);<br>&nbsp; 
  myFunction(<strong>&quot;Anja&quot;</strong>);<br>&nbsp; return 0;<br>}<br><br>// Liam Refsnes<br>// Jenny Refsnes<br>// 
  Anja Refsnes<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_functions_param">Try it Yourself &raquo;</a>
</div>
...
<code class="w3-codespan">fname</code> is a <strong>parameter</strong>, while <code class="w3-codespan">Liam</code>, <code class="w3-codespan">Jenny</code> and <code class="w3-codespan">Anja</code> are <strong>arguments</strong>.</p>
</div>
<hr>
...
<hr>
<div id="exercisecontainer" src="xrcise_function_param.js"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_functions.asp">&#10094; Previous</a>
