...
<html lang="en-US">
<head>
<title>C++ Structures (struct)</title>
<meta charset="utf-8">
...
<h1>C++ <span class="color_h1">Structures (struct)</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_challenges_arrays.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_enum.asp">Next &#10095;</a>
</div>
<hr>
...
<p>Unlike an <a href="cpp_arrays.asp">array</a>, a structure can contain many 
different data types: <code class="w3-codespan">int</code>, <code class="w3-codespan">string</code>, <code class="w3-codespan">bool</code>, etc.</p>
<hr>

<h2>Create a Structure</h2>
<p>To create a structure, use the <code class="w3-codespan">struct</code> 
keyword and declare each of its members inside curly braces.</p>
<p>After the declaration, specify the name of the structure variable (<strong>myStructure</strong> in the example below):</p>
<div class="w3-example">
<div class="w3-code notranslate javaHigh">
  struct {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Structure declaration<br>&nbsp; int myNum;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Member (int 
  variable)<br>&nbsp; string myString;&nbsp;&nbsp; // Member (string variable)<br>} 
  myStructure;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Structure variable</div>
</div>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Assign data to members of a structure and print it:</p>
<div class="w3-code notranslate javaHigh">
  // Create a structure variable called myStructure<br>struct {<br>
&nbsp; int myNum;<br>
&nbsp; string myString;<br>
} myStructure;<br>
  <br>// Assign values to members of myStructure<br>
myStructure.myNum = 1;<br>
myStructure.myString = "Hello World!";<br>
  <br>// Print members of myStructure<br>
cout &lt;&lt; myStructure.myNum &lt;&lt; "\n";<br>
cout &lt;&lt; myStructure.myString &lt;&lt; "\n";
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_struct_access">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>One Structure in Multiple Variables</h2>

<p>You can use a comma (<code class="w3-codespan">,</code>) to use one structure in many variables:</p>
<div class="w3-example">
...
<p>This example shows how to use a structure in two different variables:</p>
<div class="w3-example">
  <h3>Example</h3>
  <p>Use one structure to represent two cars:</p>
<div class="w3-code javaHigh notranslate">
struct {<br>
&nbsp; string brand;<br>
&nbsp; string model;<br>
...
<br>
// Put data into the first structure<br>
myCar1.brand = "BMW";<br>
myCar1.model = "X5";<br>
myCar1.year = 1999;<br>
<br>
// Put data into the second structure<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_struct_multiple">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>By giving a name to the structure, you can treat it as a data type. This means that you can create variables with this structure anywhere in the program at any time.</p>
<p>To create a named structure, put the name of the structure right after the <code class="w3-codespan">struct</code> keyword:</p>

<div class="w3-example">
<div class="w3-code javaHigh notranslate">
  struct car {&nbsp; // This structure is now named &quot;car&quot;<br>&nbsp; string 
  brand;<br>&nbsp; string model;<br>&nbsp; int year;<br>};</div>
</div>
<p>To declare a variable that uses the structure, use the name of the structure as the data type of the variable:</p>
...
<p>Now the structure can be reused anywhere by using <code class="w3-codespan">car</code> as the data type:</p>
<div class="w3-example">
  <h3>Example</h3>
  <p>Use one structure to represent two cars:</p>
<div class="w3-code javaHigh notranslate">
...
<p>Create a structure to represent a student. It should have the following members:</p>
<ul>
  <li><code class="w3-codespan">name</code> (<code class="w3-codespan">string</code>)</li>
  <li><code class="w3-codespan">age</code> (<code class="w3-codespan">int</code>)</li>
  <li><code class="w3-codespan">grade</code> (<code class="w3-codespan">char</code>)</li>
</ul>

<p><b>Then:</b></p>
<ol>
  <li>Create one variable of the structure.</li>
  <li>Assign values to its members.</li>
  <li>Print the values to the screen.</li>
</ol>

<div class="w3-example">
<h4>Expected Output</h4>
<div class="w3-code notranslate ws-black">
Name: Liam<br>
Age: 35<br>
Grade: A
</div>
...
<h3>Solution</h3>
<button onclick="myAccFuncStruct('structExample', this)" class="ws-btn w3-block w3-left-align">
  <span class="icon" style="font-size:11px;vertical-align:middle;margin-right:5px;">&#x2795;</span> Show Example: Structure with Student Info
</button>

<div id="structExample" class="w3-hide">
  <div class="w3-example">
    <div class="w3-code notranslate javaHigh">
#include &lt;iostream&gt;<br>
#include &lt;string&gt;<br>
...
&nbsp;&nbsp;return 0;<br>
    ...
    <a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_struct_challenge">Try it Yourself &raquo;</a>
  </div>
</div>

<script>
function myAccFuncStruct(id, btn) {
  var myaccx = document.getElementById(id);
  var icon = btn.querySelector(".icon");
  if (myaccx.className.indexOf("w3-show") == -1) {
    myaccx.className += " w3-show";
    icon.innerHTML = "&#x2796;"; // minus
  } else { 
    myaccx.className = myaccx.className.replace(" w3-show", "");
    icon.innerHTML = "&#x2795;"; // plus
  }
}
</script>
<hr>
<div id="exercisecontainer" src="xrcise_structs.js"></div>
<hr>
<br>
