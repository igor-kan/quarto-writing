...
<a class="w3-left w3-btn" href="cpp_function_overloading.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_functions_recursion.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Now that you understand how functions work, it is important to 
learn how variables act inside and outside of functions.</p>
<p class="intro">In C++, variables are only accessible inside the region they are created. This is called <strong>scope</strong>.</p>
<hr>
<h2>Local Scope</h2>
...
<div class="w3-code notranslate javaHigh">
  ...
  int x = 5;<br><br>&nbsp; // Print the variable x<br>&nbsp; cout &lt;&lt; x;<br>}<br><br>int main() {<br>&nbsp; 
  myFunction();<br>&nbsp; return 0;<br>}<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_scope">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate javaHigh w3-border-red ">
  void myFunction() {<br>&nbsp; // Local variable that belongs to myFunction<br>&nbsp; 
  int x = 5;<br>}<br><br>int main() {<br>&nbsp; myFunction();<br><br>&nbsp; // Print 
  the variable x in the main function<br>&nbsp; cout &lt;&lt; x;<br>&nbsp; return 0;<br>
  }<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_scope_error">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-code notranslate javaHigh">
  // Global variable x<br>int x = 5;<br><br>void myFunction() {<br>&nbsp; // 
  We can use x here<br>&nbsp; cout &lt;&lt; x &lt;&lt; &quot;\n&quot;;<br>}<br><br>int main() {<br>&nbsp; 
  myFunction();<br><br>&nbsp; // We can also use x here<br>&nbsp; cout &lt;&lt; x;<br>&nbsp; 
  return 0;<br>}<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_scope_global">Try it Yourself &raquo;</a>
</div>
...
<p>The function will print the local <code class="w3-codespan">x</code>, and 
  ...
  <div class="w3-code notranslate javaHigh">
    // Global variable x<br>int x = 5;<br><br>void myFunction() {<br>&nbsp; // 
    Local variable with the same name as the global variable (x)<br>&nbsp; int x 
    = 22;<br>&nbsp; cout &lt;&lt; x &lt;&lt; &quot;\n&quot;; // Refers to the local variable x<br>}<br><br>int main() 
    {<br>&nbsp; myFunction();<br><br>&nbsp; cout &lt;&lt; x; // Refers to the global 
    variable x<br>&nbsp; return 0;<br>}<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_scope_global2">Try it Yourself &raquo;</a>
</div>
...
<p>Change the value of <code class="w3-codespan">x</code> from <code class="w3-codespan">myFunction</code>:</p>
  <div class="w3-code notranslate javaHigh">
    // Global variable x<br>int x = 5;<br><br>void myFunction() { <br>&nbsp; 
    cout &lt;&lt; ++x &lt;&lt; &quot;\n&quot;; // Increment the value of x by 1 and print it<br>}<br><br>int 
    main() {<br>&nbsp; myFunction();<br><br>&nbsp; cout &lt;&lt; x; // Print the 
    global variable x<br>&nbsp; return 0;<br>}<br><br>// The value of 
    x is now 6 (no longer 5)<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_scope_global3">Try it Yourself &raquo;</a>
</div>
