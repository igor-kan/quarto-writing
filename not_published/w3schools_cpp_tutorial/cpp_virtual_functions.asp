...
<h1>C++ <span class="color_h1">Virtual Functions</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_polymorphism.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_templates.asp">Next &#10095;</a>
</div>
<hr>

<h2>C++ Virtual Functions</h2>

<p>A <b>virtual function</b> is a member function in the base class that can be <b>overridden</b> 
in derived classes.</p>
<p>Virtual functions are a key part of <a href="cpp_polymorphism.asp">polymorphism</a> in C++. They let different objects respond differently to the same function call.</p>
<hr>

<h2>Why Use Virtual Functions?</h2>
<p>Without <code class="w3-codespan">virtual</code>, C++ decides which function to call based on the pointer type, not the actual object type.</p>
<p>With <code class="w3-codespan">virtual</code>, it checks the actual object the pointer is pointing to.</p>
<p>Or to put it even more simply: 
<ul>
<li><strong>Without</strong> <code class="w3-codespan">virtual</code>: the base function runs, even 
if the object is from a child class.</li>
<li><strong>With</strong> <code class="w3-codespan">virtual</code>: the child's version runs, like 
you expect.</li>
</ul> 

<hr>

<h2>Without Virtual Function</h2>

<div class="w3-example">
<h3>Example (No virtual keyword)</h3>
...
int main() {<br>
&nbsp;&nbsp;Animal* a;&nbsp; // Declare a pointer to the base class (Animal)<br>
&nbsp;&nbsp;Dog d;&nbsp; // Create an object of the derived class (Dog)<br>
&nbsp;&nbsp;a = &amp;d;&nbsp; // Point the base class pointer to the Dog 
  object<br>
  &nbsp;&nbsp;a-&gt;sound(); // Call the sound() function using the pointer. Since sound() is 
  not virtual, this calls Animal's version<br>
&nbsp;&nbsp;return 0;<br>
}
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_virtual">Try it Yourself &raquo;</a>
</div>

<p>Even though <code class="w3-codespan">a</code> points to a <code class="w3-codespan">Dog</code>, it still calls <code class="w3-codespan">Animal::sound()</code> because the function is not virtual.</p>
...
<h2>With Virtual Function</h2>

<div class="w3-example">
<h3>Example (With virtual keyword)</h3>
<div class="w3-code notranslate javaHigh">
class Animal {<br>
&nbsp;&nbsp;public:<br>
&nbsp;&nbsp;&nbsp;&nbsp;<strong>virtual</strong> void sound() {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;cout &lt;&lt; "Animal sound\n";<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
};<br><br>
...
&nbsp;&nbsp;Dog d;<br>
&nbsp;&nbsp;a = &amp;d;<br>
&nbsp;&nbsp;a-&gt;sound();  // Outputs: Dog barks<br>
&nbsp;&nbsp;return 0;<br>
}
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_virtual2">Try it Yourself &raquo;</a>
</div>

<p><b>Now it works!</b> Because <code class="w3-codespan">sound()</code> is <code class="w3-codespan">virtual</code>, the call uses the actual object's function and not just the pointer type.</p>
<div class="ws-note w3-panel">
<ul>
  <li>Use <code class="w3-codespan">virtual</code> only in the base class</li>
  <li>Use <code class="w3-codespan">override</code> (optional, but recommended) in the derived class for clarity</li>
</ul>
</div>
<hr>

<h2>The <code class="w3-codespan">-&gt;</code> Operator in C++</h2>
<p>You might be wondering why we used <code class="w3-codespan">-></code> in the examples above.</p>
<p>The <code class="w3-codespan">-&gt;</code> operator is used to access members (like functions or variables) through a <a href="cpp_pointers.asp">pointer</a>.</p>

<p>It's a shortcut for writing <code class="w3-codespan">(*pointer).member</code>:</p>
...
<p><b>Tip:</b> If you are using a pointer to an object, use <code class="w3-codespan">-&gt;</code> to access its members.</p>
<hr>


<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_inheritance_access.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_templates.asp">Next &#10095;</a>
</div>
<div
