...
<h1>C++ <span class="color_h1">Operators Code Challenge</span></h1>

<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="cpp_operators_precedence.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="cpp_strings.asp">Next &#10095;</a>
</div>
<hr>
...
<div class="ch-wrap" id="cppChallenges"></div>
...
<script>
  window.CHALLENGE_DATA_URL = "cpp_challenge_operators.js"; 
  window.CHALLENGE_HOST_ID = "cppChallenges";
  window.CHALLENGE_PRISM_LANGUAGE = "cpp";
</script>
<script src="cpp_challenge_checks.js"></script>
...
(function(){
  ...
  var hostId = window.CHALLENGE_HOST_ID || "cppChallenges";
  var DATA_URL = window.CHALLENGE_DATA_URL || "";
  var PRISM_LANG = window.CHALLENGE_PRISM_LANGUAGE || "cpp";
  var ACTION_URL = "https://try.w3schools.com/try_cpp.php";
  var hooked = false;
