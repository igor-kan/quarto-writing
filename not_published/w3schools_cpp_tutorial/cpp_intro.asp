...
<a class="w3-right w3-btn" href="cpp_getstarted.asp">Next &#10095;</a>
</div>
<hr>

<h2>What is C++?</h2>
<p>C++ is a cross-platform language that can be used to create high-performance applications.</p>
<p>C++ was developed by Bjarne Stroustrup, as an extension to the <a href="/c/index.php">C language</a>.</p>
<p>C++ gives programmers a high level of control over system resources and memory.</p>
<p>The language was updated 5 major times in 2011, 2014, 2017, 2020, and 2023 to C++11, C++14, C++17, C++20, and C++23.</p>
<hr>
...
<p>As C++ is close to <a href="/c/index.php">C</a>, <a href="/cs/index.php">C#</a> and <a href="/java/default.asp">Java</a>, it makes it easy for programmers to switch to C++ or vice versa.</p>
<hr>

<h2>Difference between C and C++</h2>
<p>C++ was developed as an extension of <a href="/c/index.php">C</a>, and both languages have almost the same syntax.</p>
<p>The main difference between C and C++ is that C++ supports classes and objects, while C does not.</p>
<hr>

<h2>Get Started</h2>
<p>When you are finished with this tutorial, you will be able to write C++ programs and create real-life examples.</p>
<p>It is not necessary to have any prior programming experience.</p>
<a class="w3-button ws-black w3-round" href="cpp_getstarted.asp">Get Started &raquo;</a>
