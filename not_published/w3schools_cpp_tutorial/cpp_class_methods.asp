...
<h1>C++ <span class="color_h1">Class Methods</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_classes.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_constructors.asp">Next &#10095;</a>
</div>
<hr>

<h2>Class Methods</h2>
<p>Methods are <strong>functions</strong> that belongs to the class.</p>
<p>There are two ways to define functions that belongs to a class:</p>
<ul>
...
<h2>Define a Method Inside the Class</h2>

<p>In the following example, we define a function inside the class, and we name 
it "<code class="w3-codespan">myMethod</code>&quot;.</p>
<p><strong>Note:</strong> You access methods just like you access attributes; by creating an object of 
the class and using the dot syntax (<code class="w3-codespan">.</code>):</p>
<div class="w3-example">
  <h3>Inside Example</h3>
<div class="w3-code notranslate javaHigh">
  class MyClass {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // The class<br>&nbsp; 
  public:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  // Access specifier<br>&nbsp;&nbsp;&nbsp; <strong>void myMethod()</strong> {&nbsp; // Method/function 
  defined inside the 
  class<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; cout &lt;&lt; &quot;Hello World!&quot;;<br>&nbsp;&nbsp;&nbsp; 
  }<br>};<br><br>int main() {<br>&nbsp; MyClass 
  myObj;&nbsp;&nbsp;&nbsp;&nbsp; // Create an object of MyClass<br>&nbsp; 
  myObj.myMethod();&nbsp; // Call the method<br>&nbsp; return 0;<br>}<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_object_method">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Define a Method Outside the Class</h2>

<p>Sometimes it is better to declare the method in the class and define it later (especially in large programs).</p>
<p>This is done by specifiying the 
name of the class, followed the scope resolution <code class="w3-codespan">::</code> operator, 
followed by the name of the function:</p>
<div class="w3-example">
  <h3>Outside Example</h3>
<div class="w3-code notranslate javaHigh">
  class MyClass {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // The class<br>&nbsp; 
  public:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  // Access specifier<br>&nbsp;&nbsp;&nbsp; void myMethod();&nbsp;&nbsp; // Method/function 
  declaration<br>};<br>
  <br>// Method/function definition outside the class<br><strong>void</strong> <strong>
  MyClass::myMethod()</strong> {<br>&nbsp; cout &lt;&lt; &quot;Hello World!&quot;;<br>}<br><br>int main() {<br>&nbsp; MyClass 
  myObj;&nbsp;&nbsp;&nbsp;&nbsp; // Create an object of MyClass<br>&nbsp; 
  myObj.myMethod();&nbsp; // Call the method<br>&nbsp; return 0;<br>}<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_object_method2">Try it Yourself &raquo;</a>
</div>
<hr>
...
<h2>Parameters</h2>
<p>You can also pass values to methods just like regular functions:</p>
<div class="w3-example">
  <h3>&nbsp;Example</h3>
<div class="w3-code notranslate javaHigh">
  #include &lt;iostream&gt;<br>using namespace std;<br><br>class Car {<br>&nbsp; 
  public:<br>&nbsp;&nbsp;&nbsp; int speed(int maxSpeed);<br>};<br><br>int Car::speed(int maxSpeed) {<br>&nbsp; return maxSpeed;<br>}<br><br>int main() {<br>&nbsp; 
  Car myObj; // Create an object of Car<br>&nbsp; cout &lt;&lt; myObj.speed(200); // 
  Call the method with an argument<br>&nbsp; return 0;<br>}<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_object_method_param">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Challenge Task</h2>

<p>Create a class <code class="w3-codespan">Dog</code> with a method
<code class="w3-codespan">bark()</code> that prints <code class="w3-codespan">"Woof!"</code>.</p>

<p>Then call that method from <code class="w3-codespan">main()</code> using an object of the class.</p>

<button onclick="myAccFunc('methodChallenge', this)" class="ws-btn w3-block w3-left-align">
  <span class="icon" style="margin-right:8px;">&#x2795;</span> Show Solution
</button>

<div id="methodChallenge" class="w3-hide">
  <div class="w3-example">
    <div class="w3-code notranslate javaHigh">
#include &lt;iostream&gt;<br>
...
&nbsp;&nbsp;return 0;<br>
    ...
    <a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_class_methods_challenge">Try it Yourself &raquo;</a>
  </div>
</div>
