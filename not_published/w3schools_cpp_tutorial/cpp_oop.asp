...
<html lang="en-US">
<head>
<title>C++ OOP (Object-Oriented Programming)</title>
<meta charset="utf-8">
...
<h1>C++ <span class="color_h1">OOP</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_functions_lambda.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_classes.asp">Next &#10095;</a>
</div>
<hr>
...
<p>Object-oriented programming is about 
creating "objects", which can hold <strong>data</strong> and <strong>functions</strong> that work on that data.</p>
<hr>

<h2>Advantages of OOP</h2>
<ul>
  <li>OOP provides a clear structure to programs</li>
  <li>Makes code easier to maintain, reuse, and debug</li>
  <li>Helps keep your code DRY (<b>Don't Repeat Yourself</b>)</li>
  <li>Makes it possible to create full reusable 
  applications with less code and shorter development time</li>
</ul>
<p><strong>Tip:</strong> The <strong>DRY</strong> principle means you should avoid writing the same code more than once. Move repeated code into functions or classes and 
<strong>reuse it</strong>.</p>
<hr>
...
<p>When you create an object from a class, it inherits all the <strong>variables</strong> and 
<strong>functions</strong> defined inside that class.</p>
<p>In the next chapters, you will learn how to:</p>
<ul>
...
<h2>Procedural vs Object-Oriented Programming</h2>

<p><b>Procedural programming</b> is about writing functions that operate on data.</p>
<p><b>Object-oriented programming (OOP)</b> is about creating objects that contain both the data and the functions.</p>

<p>In procedural programming, the code is organized around functions.<br>
In object-oriented programming, the code is organized around objects.</p>
...
<hr>
<div id="exercisecontainer" src="xrcise_oop.js"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_functions_lambda.asp">&#10094; Previous</a>
