...
<html lang="en-US">
<head>
<title>C++ Function Recursion</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="cpp_scope.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_functions_lambda.asp">Next &#10095;</a>
</div>
<hr>

<h2>Recursion</h2>
<p>Recursion is the technique of making a function call itself.</p>
<p>This technique provides a way
...
complicated.</p>
<p>In the following example, recursion is used to add a range of numbers
together by breaking it down into the simple task of adding two numbers:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  int sum(int k) {<br>&nbsp; if (k &gt; 0) {<br>&nbsp;&nbsp;&nbsp; return k + sum(k - 1);<br>&nbsp; } else {<br>
  &nbsp;&nbsp;&nbsp;
  return 0;<br>&nbsp; }<br>}<br><br>int main() {<br>&nbsp; int result = sum(10);<br>&nbsp; cout &lt;&lt; 
  result;<br>&nbsp; return 0;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_functions_recursion">Try it Yourself &raquo;</a>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  void countdown(int n) {<br>&nbsp; if (n &gt; 0) {<br>&nbsp;&nbsp;&nbsp; cout &lt;&lt; n 
  &lt;&lt; &quot; &quot;;<br>&nbsp;&nbsp;&nbsp;&nbsp;countdown(n - 1); <br>&nbsp; 
  }<br>}<br><br>int main() {<br>&nbsp; countdown(5);<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_recursion_countdown">Try it Yourself &raquo;</a>
</div>
...
int main() {<br>
&nbsp;&nbsp;cout &lt;&lt; "Factorial of 5 is " &lt;&lt; factorial(5);<br>
&nbsp;&nbsp;return 0;<br>
}
    </div>
    <a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_recursion_factorial">Try it Yourself &raquo;</a>
  </div>

<div class="ws-note ws-panel">
<p>Factorial means multiplying a number by every number below it, down to 1 (for example, the factorial of 5 is: 5 * 4 * 3 * 2 * 1 = 120).</p> 
</div>

<hr>
<div id="exercisecontainer" src="xrcise_functions_recursion.js"></div>
<hr>
<br>
