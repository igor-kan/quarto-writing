...
<h1>C++ <span class="color_h1">C-Style Strings</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_strings_namespace.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_challenges_strings.asp">Next &#10095;</a>
</div>
<hr>

<h2>C-Style Strings</h2>
<p>C-style strings are created with the <code class="w3-codespan">char</code> type instead of <code class="w3-codespan">string</code>.</p>
<p>The name comes from the <a href="/c/index.php">C language</a>, which, unlike many other programming languages, does not have a <code class="w3-codespan">string</code> type 
for easily creating string variables. Instead, you must use the <code class="w3-codespan">char</code> type and create an <a href="cpp_arrays.asp">array</a> 
of characters to make a &quot;string&quot; in C.</p>
<p>As C++ was developed as an extension of C, it continued to support this way of creating strings in C++:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  string greeting1 = &quot;Hello&quot;;&nbsp; // Regular String<br>char greeting2[] = 
  &quot;Hello&quot;;&nbsp; // C-Style String (an array of characters)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_strings_cstyle">Try it Yourself &raquo;</a>
</div>

<p><strong>Note:</strong> It is more convenient to work with the standard <code class="w3-codespan">string</code> 
type, rather than C-style strings. However, one reason some users continue to 
use C-style strings is that 
they have access to functions from the C standard library.</p>
<p>A list of all C-style string functions, can be found in our <a href="cpp_ref_cstring.asp">CString Functions Reference</a>.</p>
...
<hr>
<div id="exercisecontainer" src="xrcise_strings_cstyle.js"></div>
<hr>
