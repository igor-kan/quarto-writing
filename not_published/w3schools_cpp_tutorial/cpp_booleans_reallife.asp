...
<h1>C++ <span class="color_h1">Boolean Examples</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_booleans_expressions.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_challenges_booleans.asp">Next &#10095;</a>
</div>
<hr>

<h2>Real Life Example</h2>
<p>Let's use booleans in a real-life example where we want to find out if a person is old enough to vote.</p>
<p>In the example below, we use the <code class="w3-codespan">>=</code> comparison operator to find out if the age (<code class="w3-codespan">25</code>) is 
<strong>greater than OR equal to</strong> the voting age limit, which is set to <code class="w3-codespan">18</code>:</p>
...
<div class="w3-code notranslate javaHigh">
  int myAge = 25;<br>int votingAge = 18;<br><br>if (myAge &gt;= votingAge) {<br>&nbsp; cout &lt;&lt; &quot;Old enough to vote!&quot;;<br>
  } else {<br>&nbsp; cout &lt;&lt; &quot;Not old enough to vote.&quot;;<br>}<br>
  <br>// Outputs: Old enough to vote!</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_boolean_age2">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
<p>Booleans are the basis for all C++ comparisons and conditions.</p>
<p>You will learn more about <a href="cpp_conditions.asp">conditions (<code class="w3-codespan">if...else</code>)</a> in the next chapter.</p>
</div>
<hr>
