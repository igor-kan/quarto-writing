...
<h1>C++ <span class="color_h1">Algorithm</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_iterators.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_namespaces.asp">Next &#10095;</a>
</div>
<hr>

<h2>C++ Algorithms</h2>
<p>In the previous chapters, you learned that data structures (like <a href="cpp_vectors.asp">vectors</a>, <a href="cpp_list.asp">lists</a>, etc) are used to store and organize data.</p>
<p><strong>Algorithms</strong> are used to solve problems by sorting, searching, and manipulating data structures.</p>

<p>The <code class="w3-codespan">&lt;algorithm&gt;</code> library provides many 
useful functions to perform these tasks 
with <a href="cpp_iterators.asp">iterators</a>. </p>
<p>To use these functions, you must include the <code class="w3-codespan">&lt;algorithm&gt;</code> 
header file: </p>

<div class="w3-example">
<div class="w3-code notranslate javaHigh">
  // Include the algorithm library<br>#include &lt;algorithm&gt;<br>
 </div>
</div>
<hr>
...
<p>To sort elements in a data structure, you can use the <code class="w3-codespan">sort()</code> 
function.</p>
<p>The <code class="w3-codespan">sort()</code> function takes <a href="cpp_iterators.asp">iterators</a> 
(typically a <em>start iterator</em> returned by <code class="w3-codespan">begin()</code> 
and an <em>end iterator</em> returned by <code class="w3-codespan">end()</code>) as 
parameters:</p>
...
<div class="w3-code notranslate javaHigh">
  ...
  &quot;Ford&quot;, &quot;Mazda&quot;};<br><br>// Sort cars alphabetically<br>sort(cars.begin(), cars.end());<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_algorithms_sort">Try it Yourself &raquo;</a>
</div>

<p>By default, the elements are sorted in ascending order. In the example above, 
the elements are sorted alphabetically since they are strings.</p>
<p>If we had a vector of integers, they would be sorted numerically:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  // Create a vector called numbers that will store integers<br>vector&lt;int&gt; numbers = {1, 7, 3, 5, 9, 2};<br><br>// Sort numbers numerically<br>sort(numbers.begin(), numbers.end());<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_algorithms_sort2">Try it Yourself &raquo;</a>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  // Create a vector called numbers that will store integers<br>vector&lt;int&gt; numbers = {1, 7, 3, 5, 9, 2};<br><br>// Sort numbers 
  numerically in reverse order<br>sort(numbers<strong>.rbegin()</strong>, numbers<strong>.rend()</strong>);<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_algorithms_sort3">Try it Yourself &raquo;</a>
</div>

<p>To only sort specific elements, you could write:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  // Create a vector called numbers that will store integers<br>vector&lt;int&gt; 
  numbers = {1, 7, 3, 5, 9, 2};<br><br>// Sort numbers numerically, starting 
  from the fourth element (only sort 5, 9, and 2)<br>sort(numbers.<strong>begin() 
  + 3</strong>, numbers.end());<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_algorithms_sort4">Try it Yourself &raquo;</a>
</div>
...
<p>To search for specific elements in a vector, you can use the <code class="w3-codespan">find()</code> 
function.</p>
<p>It takes three parameters: <code class="w3-codespan"><em>start_iterator</em>,
<em>end_iterator</em>, <em>value</em></code>, where <em>value</em> is the value to search for:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Seach for the number <strong>3</strong> in "numbers":</p>
<div class="w3-code notranslate javaHigh">
  // Create a vector called numbers that will store integers<br>vector&lt;int&gt; 
  numbers = {1, 7, 3, 5, 9, 2};<br><br>// Search for the number 3<br>auto it = find(numbers.begin(), numbers.end(), 3);<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_algorithms_find">Try it Yourself &raquo;</a>
</div>
<p>To search for the first element that is <strong>greater than</strong> a specific value, you can use the <code class="w3-codespan">upper_bound()</code> function:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Find the first value greater than <strong>5</strong> in &quot;numbers&quot;:</p>
<div class="w3-code notranslate javaHigh">
  // Create a vector called numbers that will store integers<br>vector&lt;int&gt; 
  numbers = {1, 7, 3, 5, 9, 2};<br><br>// Sort the vector in ascending order<br>
  sort(numbers.begin(), numbers.end());<br><br>// Find the first value that is greater 
  than 5 in the sorted vector<br>auto it = upper_bound(numbers.begin(), 
  numbers.end(), 5);<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_algorithms_upper_bound">Try it Yourself &raquo;</a>
</div>
<div class="ws-note w3-panel">
<p>The <code class="w3-codespan">upper_bound()</code> function is typically used on sorted data structures. That's 
why we first sort the vector in the example above.</p>
</div>

<p>To find the smallest element in a vector, use the <code class="w3-codespan">min_element()</code> function:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  // Create a vector called numbers that will store integers<br>vector&lt;int&gt; 
  numbers = {1, 7, 3, 5, 9, 2};<br><br>// Find the smallest number<br>auto it = 
  min_element(numbers.begin(), numbers.end());</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_algorithms_min">Try it Yourself &raquo;</a>
</div>

<p>To find the largest element, use the <code class="w3-codespan">max_element()</code> function:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  // Create a vector called numbers that will store integers<br>vector&lt;int&gt; 
  numbers = {1, 7, 3, 5, 9, 2};<br><br>// Find the largest number<br>auto it = 
  max_element(numbers.begin(), numbers.end());</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_algorithms_max">Try it Yourself &raquo;</a>
</div>


<hr>

<h2>Modifying Algorithms</h2>

<p>To copy elements from one vector to another, you can use the <code class="w3-codespan">copy()</code> function:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Copy elements from one vector to another:</p>
<div class="w3-code notranslate javaHigh">
  // Create a vector called numbers that will store integers<br>vector&lt;int&gt; 
  numbers = {1, 7, 3, 5, 9, 2};<br><br>// Create a vector called copiedNumbers 
  that should store 6 integers<br>vector&lt;int&gt; copiedNumbers(6);<br><br>// 
  Copy elements from numbers to copiedNumbers<br>copy(numbers.begin(), 
  numbers.end(), copiedNumbers.begin()); <br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_algorithms_copy">Try it Yourself &raquo;</a>
</div>

<p>To fill all elements in a vector with a value, you can use the <code class="w3-codespan">fill()</code> function:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Fill all elements in the numbers vector with the value 35:</p>
<div class="w3-code notranslate javaHigh">
  // Create a vector called numbers that will store 6 integers<br>vector&lt;int&gt; 
  numbers(6);<br><br>// Fill all elements in the numbers vector with the value 
  35<br>fill(numbers.begin(), numbers.end(), 35); <br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_algorithms_fill">Try it Yourself &raquo;</a>
</div>
<hr>

<div id="exercisecontainer" src="xrcise_algorithms.js"></div>
<hr>
<h2>Complete Algorithm Reference</h2>
<p>For a complete reference of algorithm functions, go to our <a href="cpp_ref_algorithm.asp">C++ Algorithm Reference</a>.</p>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_iterators.asp">&#10094; Previous</a>
