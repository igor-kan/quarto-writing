...
<h1>C++ <span class="color_h1">Namespaces</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_algorithms.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_projects.asp">Next &#10095;</a>
</div>
<hr>

<h2>Namespaces</h2>

<p>A <b>namespace</b> is a way to group related code together under a name. It helps you avoid naming conflicts when your code grows or when you use code from multiple sources.</p>

<p>Think of a namespace like a folder: you can have a variable named <code class="w3-codespan">x</code> in two different folders, and they won't clash.</p>
...
<ul>
  <li>To avoid name conflicts, especially in larger projects</li>
  <li>To organize code into logical groups</li>
  <li>To separate your code from code in libraries</li>
</ul>

<hr>

<h2>Basic Namespace Example</h2>

<p>Here we define a variable called <code class="w3-codespan">x</code> inside a namespace called <code class="w3-codespan">MyNamespace</code>:</p>
...
int main() {<br>
&nbsp;&nbsp;cout &lt;&lt; MyNamespace::x;<br>
&nbsp;&nbsp;return 0;<br>
}
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_namespaces">Try it Yourself &raquo;</a>
</div>

<p>We use <code class="w3-codespan">MyNamespace::x</code> to access the variable inside the namespace.</p>

<hr>

<h2>The <code class="w3-codespan">using namespace</code> Keyword</h2>

<p>If you don't want to write the namespace name every time you access the 
variable, you can use the <code class="w3-codespan">using</code> keyword:</p>

<div class="w3-example">
<div class="w3-code notranslate javaHigh">
  namespace MyNamespace {<br>&nbsp; 
  int x = 42;<br>}<br><br><strong>using namespace MyNamespace;</strong><br><br>int main() {<br>&nbsp; 
  cout &lt;&lt; x;&nbsp; // No need to write MyNamespace::x<br>&nbsp; return 0;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_namespaces2">Try it Yourself &raquo;</a>
</div>

<p><b>However, be careful:</b> In large programs, using <code class="w3-codespan">using namespace</code> can cause name conflicts. It's often better to use the full name like 
<code class="w3-codespan">MyNamespace::x</code> instead.</p>
...
<h2>The <code class="w3-codespan">std</code> Namespace</h2>

<p>In C++, things like <code class="w3-codespan">cout</code>, <code class="w3-codespan">cin</code>, and <code class="w3-codespan">endl</code> belong to the Standard Library.</p>

<p>These are all part of a namespace called <code class="w3-codespan">std</code>, which stands for <b>standard</b>. That means you normally have to write <code class="w3-codespan">std::cout</code>, <code class="w3-codespan">
std::cin</code>, and so on.</p>
<p>To make your code shorter, you can add:
<div class="w3-example">
<div class="w3-code notranslate javaHigh">
using namespace std;
</div>
...
This lets you use <code class="w3-codespan">cout</code>, <code class="w3-codespan">cin</code>, and <code class="w3-codespan">endl</code> without writing <code class="w3-codespan">std::</code> every time.</p>

<div style="margin-top:-16px;display: flex; flex-wrap: wrap; gap: 16px;margin-bottom:-16px;">

  <div style="flex: 1 1 300px; min-width: 280px;">
    <div class="w3-example">
    <h5>Without using namespace std</h5>
      <div class="w3-code notranslate javaHigh">
...
&nbsp;&nbsp;return 0;<br>
    ...
    <p>You must type <code class="w3-codespan">std::</code> before <code class="w3-codespan">cout</code>.</p>
  </div>

  <div style="flex: 1 1 300px; min-width: 280px;">
    <div class="w3-example">
    <h5>With using namespace std</h5>
      <div class="w3-code notranslate javaHigh">
#include &lt;iostream&gt;<br>
...
&nbsp;&nbsp;return 0;<br>
    ...
    <p>Now you can use <code class="w3-codespan">cout</code> without writing <code class="w3-codespan">std::</code> every time.</p>
  </div>
</div>
<hr>

<h3>Should You Always Use It?</h3>

<p>For small programs and learning, using <code class="w3-codespan">namespace std</code> is fine.</p>

<p>But in large projects, it is better to write <code class="w3-codespan">std::</code> before each item. This prevents conflicts if different libraries have functions or variables with the same name.</p>

<p><b>In short:</b> <code class="w3-codespan">using namespace std;</code> is helpful for beginners, but use it with care in big programs.</p>
