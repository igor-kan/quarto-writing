...
<a class="w3-left w3-btn" href="cpp_challenges_variables.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_data_types.asp">Next &#10095;</a>
</div>
<hr>
...
<div class="w3-code notranslate javaHigh">
  int x;&nbsp;<br>cout &lt;&lt; "Type a number: "; // Type a number and 
  press enter<br>cin &gt;&gt; x; // Get user 
  input from the keyboard<br>cout &lt;&lt; "Your number is: " &lt;&lt; x; 
  // Display the input value</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showcpp.asp?filename=demo_user_input">Run example &raquo;</a>
</div>

<div class="ws-note w3-panel">
<h4>Good To Know</h4>
<p><code class="w3-codespan">cout</code> is pronounced "see-out". Used for <strong>output</strong>, and uses the insertion operator (<code class="w3-codespan"><<</code>)</p>
<p><code class="w3-codespan">cin</code> is pronounced "see-in". Used for <strong>input</strong>, and uses the extraction operator (<code class="w3-codespan">>></code>)</p>
</div>
<hr>
...
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  int x, y;<br>int sum;<br>cout &lt;&lt; &quot;Type a number: &quot;;<br>cin &gt;&gt; x;<br>cout &lt;&lt; &quot;Type another number: &quot;;<br>cin &gt;&gt; 
  y;<br>sum = x + y;<br>cout &lt;&lt; &quot;Sum is: &quot; &lt;&lt; sum;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showcpp.asp?filename=demo_user_input2">Run example &raquo;</a>
</div>
...
<h2>Complete &lt;iostream&gt; Reference</h2>
<p><strong>Tip:</strong> Both <code class="w3-codespan">cin</code> and <code class="w3-codespan">cout</code> belongs to the <code class="w3-codespan">&lt;iostream&gt;</code> library, 
which is short for <em>standard </em> <strong><em>i</em></strong><em>nput / </em> <strong>
<em>o</em></strong><em>utput
</em><em>
<strong>stream</strong>s</em>. For a complete reference of &lt;iostream&gt; objects along with detailed information, go to our <a href="cpp_ref_iostream.asp">C++ iostream Reference</a>.</p>
