...
<a class="w3-left w3-btn" href="cpp_intro.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_syntax.asp">Next &#10095;</a>
</div>
<hr>

<h2>Get Started With C++</h2>
<p>At W3Schools, you can try C++ without installing anything.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="trycpp.asp?filename=demo_helloworld">Try it Yourself &raquo;</a>
</div>
<p>This editor will be used in the entire tutorial to demonstrate the different aspects of C++.</p>
<hr>

<h2>Install C++</h2>
<p>If you want to run C++ on your own computer, you need two things:</p>
<ul>
...
<p>There are many text editors and compilers to choose from. In the next steps, we will show you how to use an <strong><i>IDE</i></strong> that includes both.</p>
<hr>
...
<p>You can find the latest version of Codeblocks at <a href="https://www.codeblocks.org/downloads/binaries/" target="_blank">http://www.codeblocks.org/</a>. 
...
<img src="codeblocks2020.png" style="width:100%;max-width:790px;" class="w3-border">
