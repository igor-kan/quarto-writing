...
<a class="w3-right w3-btn" href="cpp_challenges_while_loop.asp">Next &#10095;</a>
</div>
<hr>

<h2>Real Life Example</h2>
<p>To demonstrate a practical example of the while loop, we have created a simple "countdown" program:</p>
...
<p>To demonstrate a practical example of the while loop combined with an if else statement, let's say we play a game of Yatzy:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
