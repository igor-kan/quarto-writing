...
<a class="w3-left w3-btn" href="cpp_while_loop.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_while_loop_reallife.asp">Next &#10095;</a>
</div>
<hr>

<h2>The Do/While Loop</h2>

<p>The <code class="w3-codespan">do/while</code> loop is a variant of the <code class="w3-codespan">while</code> loop. This loop will execute the code block <b>once</b>, before checking if the condition is true. Then it will repeat the loop as long as the condition is true.</p>
...
<p><b>Note:</b> The semicolon <code class="w3-codespan">;</code> after the <code class="w3-codespan">while</code> condition is required!</p>
<hr>

<h2>Do/While Example</h2>
<p>The example below uses a <code class="w3-codespan">do/while</code> loop. The 
loop will always be executed at least once, even if the condition is false, 
because the code block is executed before the condition is tested.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_do_while_loop">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
<p>Do not forget to increase the variable used in the condition (<code class="w3-codespan">i++</code>), otherwise 
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_do_while_false">Try it Yourself &raquo;</a>
</div>

<div class="ws-note ws-panel">
<h3>Summary</h3>
<p>The <code class="w3-codespan">do/while</code> loop always runs at least once, even if the condition is already false. This is different from a regular <code class="w3-codespan">while</code> loop, which would skip the loop entirely if the condition is false at the start.</p>
  <p>This behavior makes <code class="w3-codespan">do/while</code> useful when you want to ensure something happens at least once, like showing a message or asking for user input.</p>
</div>
...
<hr>
<h2>Practical Example: User Input</h2>
...
int number;<br>
do {<br>
&nbsp;&nbsp;cout &lt;&lt; "Enter a positive number: ";<br>
&nbsp;&nbsp;cin >> number;<br>
} while (number > 0);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showcpp.asp?filename=demo_do_while_userinput">Run Example &raquo;</a>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_do_while_loop.js"></div>
<hr>
