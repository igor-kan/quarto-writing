...
<h1>C++ <span class="color_h1">Exceptions</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_debugging.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_input_validation.asp">Next &#10095;</a>
</div>
<hr>

<h2>Exceptions</h2>
<p>As mentioned in the <a href="cpp_errors.asp">C++ Errors</a> chapter, different types of errors can occur while running a program - such as coding mistakes, invalid input, or unexpected situations.</p>
<p>When an error occurs, C++ will normally stop and generate an error message. The technical term for this is: C++ will throw an <b>exception</b> (throw an error).</p>
<hr>

<h2>Exception Handling (try and catch)</h2>
<p>Exception handling lets you <strong>catch and handle errors</strong> during runtime - so your program doesn't crash.</p>

<p>It uses three keywords:</p>
<ul>
  <li><code class="w3-codespan">try</code> - defines the code to test</li>
  <li><code class="w3-codespan">throw</code> - triggers an exception</li>
  <li><code class="w3-codespan">catch</code> - handles the error</li>
</ul>
<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    try {<br>&nbsp; // Code that may throw an exception<br>&nbsp; throw 505;<br>
    }<br>catch (int errorCode) {<br>&nbsp; cout &lt;&lt; &quot;Error occurred: &quot; &lt;&lt; 
    errorCode;<br>}</div>
</div>
<p>Here, the program throws an exception with the value 
<code class="w3-codespan">505</code>, which is caught and handled in the <code class="w3-codespan">catch</code> block.</p>
<hr>

<h2>Real-Life Example: Age Check</h2>
<p>We can use exception handling to check if a user is old enough:</p>

<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    try {<br>&nbsp; int age = 15;<br>&nbsp; if (age &gt;= 18) {<br>&nbsp;&nbsp;&nbsp; 
    cout &lt;&lt; &quot;Access granted - you are old enough.&quot;;<br>&nbsp; } else {<br>&nbsp;&nbsp;&nbsp; 
    throw (age);<br>&nbsp; }<br>}<br>catch (int 
    myNum) {<br>&nbsp; cout &lt;&lt; &quot;Access denied - You must be at least 18 years 
    old.\n&quot;;<br>&nbsp; cout &lt;&lt; &quot;Age is: &quot; &lt;&lt; myNum; <br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_try_catch">Try it Yourself &raquo;</a>
</div>

<h4>Example explained</h4>
<p>We use the <code class="w3-codespan">try</code> block to test some code: If the <code class="w3-codespan">age</code> variable is less than <code class="w3-codespan">18</code>, we will <code class="w3-codespan">throw</code> an exception, and handle it in our <code class="w3-codespan">catch</code> block.</p>
<p>In the <code class="w3-codespan">catch</code> block, we catch the error and 
do something about it. The <code class="w3-codespan">catch</code> 
statement takes a <strong>parameter</strong>: in our example we use an <code class="w3-codespan">int</code> variable (<code class="w3-codespan">myNum</code>) (because we are throwing an exception of <code class="w3-codespan">int</code> type in the <code class="w3-codespan">try</code> block (<code class="w3-codespan">age</code>)), 
to output the value of <code class="w3-codespan">age</code>.</p>

<p>If no error occurs (e.g. if <code class="w3-codespan">age</code> is <code class="w3-codespan">20</code> instead of <code class="w3-codespan">15</code>, 
meaning it will be be greater 
than 18), the <code class="w3-codespan">catch</code> block is skipped:</p>
<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    int age = 20;<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_try_catch2">Try it Yourself &raquo;</a>
</div>

<p>You can also use the <code class="w3-codespan">throw</code> keyword to output a reference number, like a 
custom error number/code for organizing purposes (<code class="w3-codespan">505</code> in our example):</p>
<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    try {<br>&nbsp; int age = 15;<br>&nbsp; if (age &gt;= 18) {<br>&nbsp;&nbsp;&nbsp; 
    cout &lt;&lt; &quot;Access granted - you are old enough.&quot;;<br>&nbsp; } else {<br>&nbsp;&nbsp;&nbsp; 
    throw 505;<br>&nbsp; }<br>}<br>catch (int myNum) {<br>&nbsp; 
    cout &lt;&lt; &quot;Access denied - You must be at least 18 years old.\n&quot;;<br>&nbsp; 
    cout &lt;&lt; &quot;Error number: &quot; &lt;&lt; myNum; <br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_try_catch3">Try it Yourself &raquo;</a>
</div>
...
<h2>Handle Any Type of Exceptions (...)</h2>
<p>If you do not know the <code class="w3-codespan">throw</code> <strong>type</strong> used in the <code class="w3-codespan">try</code> block, you can use the "three dots" syntax (<code class="w3-codespan">...</code>) inside the <code class="w3-codespan">catch</code> block, which will handle any type of exception:</p>
<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    try {<br>&nbsp; int age = 15;<br>&nbsp; if (age &gt;= 18) {<br>&nbsp;&nbsp;&nbsp; 
    cout &lt;&lt; &quot;Access granted - you are old enough.&quot;;<br>&nbsp; } else {<br>&nbsp;&nbsp;&nbsp; 
    throw 505;<br>&nbsp; }<br>}<br>catch (...) {<br>&nbsp; cout &lt;&lt; &quot;Access denied - You must be at least 18 years 
    old.\n&quot;;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_try_catch_dots">Try it Yourself &raquo;</a>
</div>


<hr>
<div id="exercisecontainer" src="xrcise_exceptions.js"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_debugging.asp">&#10094; Previous</a>
