...
<a class="w3-left w3-btn" href="cpp_conditions_elseif.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_conditions_nested.asp">Next &#10095;</a>
</div>
<hr>

<h2>Short Hand If...Else (Ternary Operator)</h2>

<p>There is also a short-hand <a href="cpp_conditions_else.asp">if...else</a>, known as the <strong>ternary operator</strong> 
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate javaHigh">
    <em>variable</em> = (<em>condition</em>) ? <em>expressionTrue</em> : <em>expressionFalse</em>;
  </div>
</div>
...
<div class="w3-example">
  ...
  <p>
    <a target="_blank" class="w3-btn" href="trycpp.asp?filename=demo_if_else">Try it Yourself &raquo;</a>
  </p>
</div>
...
<div class="w3-example">
  ...
  <p>
    <a target="_blank" class="w3-btn" href="trycpp.asp?filename=demo_if_ternary">Try it Yourself &raquo;</a>
  </p>
</div>

<p>You can also use the ternary operator directly inside the <code class="w3-codespan">cout</code> statement:</p>
<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    int time = 20;<br>
  ...
  <p>
    <a target="_blank" class="w3-btn" href="trycpp.asp?filename=demo_if_ternary2">Try it Yourself &raquo;</a>
  </p>
</div>

<div class="ws-note ws-panel">
  <p><strong>Tip:</strong> Use the ternary operator for short and simple conditions. For longer or more complex logic, the regular <code class="w3-codespan">if...else</code> statement is easier to read.</p>
</div>
...
<h2>Nested Ternary</h2>

<p>You can nest ternary operators to handle more than two outcomes, but it can make your code harder to read:</p>

<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    int time = 22;<br>
    string message = (time &lt; 12) ? "Good morning."<br>
    &nbsp;&nbsp;: (time &lt; 18) ? "Good afternoon."<br>
    &nbsp;&nbsp;: "Good evening.";<br>
    cout &lt;&lt; message;
  </div>
  <p>
    <a target="_blank" class="w3-btn" href="trycpp.asp?filename=demo_if_ternary_nested">Try it Yourself &raquo;</a>
  </p>
</div>

<div class="ws-note ws-panel">
  <p><strong>Note:</strong> Although nested ternary operators work, it's usually better to use a normal <code class="w3-codespan">if...else if...else</code> statement for clarity.</p>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_conditions_shorthand.js"></div>
<hr>
