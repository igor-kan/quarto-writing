...
<a class="w3-left w3-btn" href="cpp_references_memory.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_pointers_dereference.asp">Next &#10095;</a>
</div>
<hr>

<h2>Creating Pointers</h2>
<p>You learned from the previous chapter, that we can get the <strong>memory 
address</strong> of a variable by using the <code class="w3-codespan">&amp;</code> 
operator:</p>
<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
  string food = &quot;Pizza&quot;; 
    // A food variable of type string<br><br>cout &lt;&lt; 
    food;&nbsp; // Outputs the value of food (Pizza)<br>
  cout &lt;&lt; &amp;food; // Outputs the memory address of food (<strong>0x6dfed4</strong>)<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_pointer_ref">Try it Yourself &raquo;</a>
</div>
<p>A <strong>pointer</strong> however, is a variable that <strong>stores the memory address as its value</strong>. </p>
<p>A pointer variable points to a data type (like <code class="w3-codespan">int</code> or <code class="w3-codespan">string</code>) of the same 
type, and is created with the <code class="w3-codespan">*</code> operator. The address of the variable you're working with is assigned to the pointer:</p>

<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    string food = &quot;Pizza&quot;;&nbsp; // A food variable 
    of type string<br><strong>string* ptr = 
    &amp;food;</strong>&nbsp;&nbsp;&nbsp; // A pointer variable, with the name 
    ptr, that stores the 
    address of food<br><br>// Output the value of food (Pizza)<br>cout &lt;&lt; food &lt;&lt; &quot;\n&quot;;<br><br>// Output 
    the memory address of food (0x6dfed4)<br>cout &lt;&lt; &amp;food &lt;&lt; &quot;\n&quot;;<br><br>// 
    Output the memory address of food with the pointer (0x6dfed4)<br>cout &lt;&lt; 
    ptr &lt;&lt; &quot;\n&quot;;<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_pointer">Try it Yourself &raquo;</a>
</div>
<h4>Example explained</h4>
<p>Create a pointer variable with the name <code class="w3-codespan">ptr</code>, that <strong>points to</strong> a <code class="w3-codespan">string</code> variable, by using the 
asterisk sign 
<code class="w3-codespan">*</code> (<code class="w3-codespan">string* ptr</code>). 
...
variable called <code class="w3-codespan">food</code>, and assign it to the pointer.</p>
<p>Now, <code class="w3-codespan">ptr</code> holds the value of <code class="w3-codespan">food</code>'s memory address.</p>

<div class="ws-note w3-panel">
<p><strong>Tip:</strong> There are three ways to declare pointer variables, but the first way is preferred:</p>
<div class="w3-example">
  <div class="w3-code notranslate javaHigh">
    string* mystring; // Preferred<br>string *mystring;<br>string * mystring;<br>
 </div>
</div>
</div>
...
<hr>
<div id="exercisecontainer" src="xrcise_pointers.js"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_references_memory.asp">&#10094; Previous</a>
