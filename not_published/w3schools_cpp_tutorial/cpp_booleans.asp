...
<a class="w3-left w3-btn" href="cpp_math.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_booleans_expressions.asp">Next &#10095;</a>
</div>
<hr>
...
<p>For this, C++ has a <code class="w3-codespan">bool</code> data type, which can take the values <code class="w3-codespan">true</code> 
(1) or <code class="w3-codespan">false</code> (0).</p>
<hr>

<h2>Boolean Values</h2>
<p>A boolean variable is declared with the <code class="w3-codespan">bool</code> keyword and can take the values <code class="w3-codespan">true</code> or <code class="w3-codespan">false</code>:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-cpp w3-white"><code>bool isCodingFun = true;
bool isFishTasty = false;

cout &lt;&lt; isCodingFun &lt;&lt; "\n";  // Outputs 1 (true)
cout &lt;&lt; isFishTasty &lt;&lt; "\n"; // Outputs 0 (false)
</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_boolean">Try it Yourself &raquo;</a>
</div>

<p>From the example above, you can read that a <code class="w3-codespan">true</code> value returns <code class="w3-codespan">1</code>, and <code class="w3-codespan">false</code> returns <code class="w3-codespan">0</code>.</p>

<hr>

<h2>Printing true/false With <code class="w3-codespan">boolalpha</code></h2>
<p>
If you prefer to print <code class="w3-codespan">true</code> and <code class="w3-codespan">false</code> as words instead of <code class="w3-codespan">1</code> and <code class="w3-codespan">0</code>, you can use the 
<code class="w3-codespan">boolalpha</code> manipulator:
</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-cpp w3-white" data-line="4"><code>bool isCodingFun = true;
bool isFishTasty = false;
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_boolean_boolalpha">Try it Yourself &raquo;</a>
</div>

<div class="ws-note ws-panel">
<p><strong>Note:</strong> <code class="w3-codespan">boolalpha</code> is not a data type.  
It is an <em>I/O manipulator</em> - a setting that changes how <code class="w3-codespan">cout</code> displays boolean values.  
When you use it, you are telling <code class="w3-codespan">cout</code>:  
 "From now on, print booleans as <code class="w3-codespan">true</code> and <code class="w3-codespan">false</code> instead of <code class="w3-codespan">1</code> and <code class="w3-codespan">0</code>."
</p>
</div>
...
<h2>Resetting Back With <code class="w3-codespan">noboolalpha</code></h2>
<p>
If you want to go back to the default behavior (printing <code class="w3-codespan">1</code> and <code class="w3-codespan">0</code>), you can use 
<code class="w3-codespan">noboolalpha</code>:
</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-cpp w3-white" data-line="3,6"><code>bool isCodingFun = true;
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_boolean_noboolalpha">Try it Yourself &raquo;</a>
</div>
<div class="ws-note ws-panel">
<p><strong>Note:</strong> It is up to you whether you prefer the default 
<code class="w3-codespan">1</code> and <code class="w3-codespan">0</code>, or the words 
<code class="w3-codespan">true</code> and <code class="w3-codespan">false</code>.  
Both are correct in C++, and you can switch between them using 
<code class="w3-codespan">boolalpha</code> and <code class="w3-codespan">noboolalpha</code>.</p>
<p><strong>Tip:</strong> You can read more about <code class="w3-codespan">cout</code> and its manipulators in our 
<a href="/cpp/ref_iostream_cout.asp">C++ cout object reference</a>.</p>
<p>In the examples above we used fixed boolean values. But in real programs, boolean values are usually the result of comparing values or variables, which you will learn more about in the <a href="cpp_booleans_expressions.asp">next chapter</a>.</p>
</div>
