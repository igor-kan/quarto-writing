...
<html lang="en-US">
<head>
<title>C++ Lambda Functions</title>
<meta charset="utf-8">
...
<h1>C++ <span class="color_h1">Lambda Functions</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_functions_recursion.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_oop.asp">Next &#10095;</a>
</div>
<hr>

<h2>Lambda Functions</h2>

<p>A <b>lambda function</b> is a small, anonymous function you can write directly in your code. It's useful when you need a quick function without naming it or declaring it separately.</p>

<p>Think of it as a "mini function on the fly."</p>

<div class="w3-example">
<h3>Syntax</h3>
<div class="w3-code notranslate cppHigh">
[<em>capture</em>] (<em>parameters</em>) { <em>code </em>};
</div>
</div>

<p><b>Don't worry:</b> We'll explain what [<em>capture</em>] means later. For now, let's just use an empty pair of brackets.</p>
<hr>

<h2>Basic Lambda Example</h2>
<p>Here, <code class="w3-codespan">message</code> holds a lambda function that prints a message to the screen:</p>
...
<p>Result:</p>
<div class="w3-padding notranslate ws-black">
<code>
Hello World!
</code>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="trycpp.asp?filename=demo_lambda">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Lambda with Parameters</h2>
...
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="trycpp.asp?filename=demo_lambda_param">Try it Yourself &raquo;</a>
</div>
...
<h2>Passing Lambdas to Functions</h2>

<p>You can also <b>pass a lambda function as an argument</b> to another function.</p> <p>This is useful when you want to tell a function <b>what to do</b>, not just what data to use.</p>
<p>In the example below, we send a small lambda function to another function, which then runs it twice:</p>
<div class="w3-example">
<div class="w3-code notranslate javaHigh">
  #include &lt;iostream&gt;<br>#include &lt;functional&gt; // Needed for std::function<br>
  using namespace std;<br><br>// A function that takes another function as 
  parameter<br>void myFunction(function&lt;void()&gt; func) {<br>&nbsp; func();<br>&nbsp; 
  func();<br>}<br>
  <br>int main() {<br>&nbsp; auto message = []() {<br>&nbsp;&nbsp;&nbsp; cout &lt;&lt; 
  &quot;Hello World!\n&quot;;<br>&nbsp; };<br><br>&nbsp; myFunction(message);<br>&nbsp; 
  return 0;<br>}</div>
<p>Result:</p>
<div class="w3-padding notranslate ws-black">
<code>
...
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="trycpp.asp?filename=demo_lambda_pass">Try it Yourself &raquo;</a>
</div>

<p>Note that you must include the <code class="w3-codespan">&lt;functional&gt;</code> library for this example to work.</p>

<hr>

<h2>Using Lambdas in Loops</h2>

<p>You can define and use a lambda function inside a loop, which are great for 
quick actions:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="trycpp.asp?filename=demo_lambda_loop">Try it Yourself &raquo;</a>
</div>
...
<p>You can use the <code class="w3-codespan">[ ]</code> brackets to give a lambda access to variables outside of it.</p>

<p>This is called the <b>capture clause</b>.</p>

<p>In this example, the lambda captures the variable <code class="w3-codespan">x</code> by value (a copy):</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="trycpp.asp?filename=demo_lambda_capture">Try it Yourself &raquo;</a>
</div>

<p><b>Note:</b> The lambda uses a <b>copy</b> of <code class="w3-codespan">x</code>. If you change <code>x</code> after defining the lambda, it won't affect the value inside the lambda.</p>

<p><b>Note:</b> You can also use <code class="w3-codespan">[&amp;]</code> to capture by reference.</p>
<hr>

<h2>Capture by Reference</h2>

<p>If you want the lambda to use the <b>latest value</b> of a variable (not just a copy), you can use <code class="w3-codespan">[&amp;]</code> to capture it by reference.</p>

<p>This means the lambda will work with the original variable, not a separate copy:</p>
...
&nbsp;&nbsp;&nbsp;&nbsp;cout &lt;&lt; x;<br>
&nbsp;&nbsp;};<br><br>
&nbsp;&nbsp;x = 20;&nbsp;  // Change x after the lambda is created<br><br>
&nbsp;&nbsp;show();<br>
&nbsp;&nbsp;return 0;<br>
}
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="trycpp.asp?filename=demo_lambda_capture2">Try it Yourself &raquo;</a>
</div>

<p><b>Why?</b> The lambda sees the original <code class="w3-codespan">x</code> variable, so when you change <code class="w3-codespan">x</code>, the lambda uses the updated value.</p>
<hr>

<h2>Regular Functions vs Lambda Functions</h2>
...
<h4>Use a regular function when:</h4>
<ul>
...
<h4>Use a lambda function when:</h4>
<ul>
...
<p>Both of these examples do the same thing. They return the sum of two numbers:</p>
...
<p><b>Note:</b> The lambda version is great when you don't need to reuse the function later. It's quick and works well inside blocks or as arguments to other functions.</p>

<hr>
<div id="exercisecontainer" src="xrcise_functions_lambda.js"></div>
<hr>
