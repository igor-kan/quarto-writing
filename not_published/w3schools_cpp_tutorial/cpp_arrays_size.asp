...
<a class="w3-left w3-btn" href="cpp_arrays_omit.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_arrays_reallife.asp">Next &#10095;</a>
</div>
<hr>

<h2>Get the Size of an Array</h2>
<p>To get the size of an array, you can use the <code class="w3-codespan">sizeof()</code> 
operator:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  int myNumbers[5] = {10, 20, 30, 40, 50};<br>cout &lt;&lt; <strong>sizeof(myNumbers)</strong>;<br>
 </div>
<p>Result:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="trycpp.asp?filename=demo_array_length">Try it Yourself &raquo;</a>
</div>

<p>Why did the result show <code class="w3-codespan">20</code> instead of <code class="w3-codespan">
5</code>, when the array contains 5 elements?</p>
<p>It is because the <code class="w3-codespan">sizeof()</code> operator returns the size of a type in 
<strong>bytes</strong>.</p>
<p>You learned from the <a href="cpp_data_types.asp">Data Types chapter</a> that an <code class="w3-codespan">int</code> 
type is usually 4 bytes, so from the example above, <em>4 x 5 (4 bytes x 5 elements) = <strong>20 bytes</strong></em>.</p>
<!--
<p>Unlike many other programming languages, like <a href="/cs/index.php">C#</a> and <a href="/java/default.asp">Java</a>, C++ does not have a 

<strong>length</strong> property to find out how many elements an array has.</p>
-->
<p><strong>To find out how many elements an array has</strong>, you have to divide the size of the array 
by the size of the first element in the array:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  int myNumbers[5] = {10, 20, 30, 40, 50};<br>int getArrayLength = <strong>
  sizeof(myNumbers) / sizeof(myNumbers[0])</strong>;<br>cout &lt;&lt; getArrayLength;<br>
 </div>
<p>Result:</p>
<div class="notranslate w3-black w3-padding">
<code>
...
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="trycpp.asp?filename=demo_array_length2">Try it Yourself &raquo;</a>
</div>
<hr>
<!--
<p>It will also find the size of an array with reserved space:</p>
<div class="w3-example">
<div class="w3-code notranslate javaHigh">
  string cars[8] = {&quot;Volvo&quot;, &quot;BMW&quot;, &quot;Ford&quot;, &quot;Mazda&quot;};<br>int getArraySize = 
  sizeof(cars) / sizeof(cars[0]);<br>cout &lt;&lt; &quot;Size of array is: &quot; &lt;&lt; 
  getArraySize; // Outputs 8<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_array_length2">Try it Yourself &raquo;</a>
</div>
-->
...
<hr>
<h2>Loop Through an Array with sizeof()</h2>
<p>In the <a href="cpp_arrays_loop.asp">Arrays and Loops Chapter</a>, we wrote the size of the array in the loop condition (<code class="w3-codespan">i < 
5</code>). This is not ideal, since it will only work for arrays of a specified size.</p>
<p>However, by using the <code class="w3-codespan">sizeof()</code> approach from 
...
<div class="w3-example">
<div class="w3-code notranslate javaHigh">
  int myNumbers[5] = {10, 20, 30, 40, 50};<br>for (int i = 0; i &lt; 
  5; i++) {<br>&nbsp; cout &lt;&lt; myNumbers[i] &lt;&lt; 
  &quot;\n&quot;;<br>}
 </div>
</div>
...
<div class="w3-code notranslate javaHigh">
  int myNumbers[5] = {10, 20, 30, 40, 50};<br>for (int i = 0; i &lt; 
  sizeof(myNumbers) / sizeof(myNumbers[0]); i++) {<br>&nbsp; cout &lt;&lt; myNumbers[i] &lt;&lt; 
  &quot;\n&quot;;<br>}
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_array_length_loop">Try it Yourself &raquo;</a>
</div>

<!--
<p>It will also work for arrays of strings:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  string cars[5] = {&quot;Volvo&quot;, &quot;BMW&quot;, &quot;Ford&quot;, &quot;Mazda&quot;, &quot;Tesla&quot;};<br>for (int i = 
  0; i &lt; sizeof(cars) / sizeof(string); i++) {<br>&nbsp; cout &lt;&lt; cars[i] &lt;&lt; 
  &quot;\n&quot;;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_array_length_loop2">Try it Yourself &raquo;</a>
</div>
-->

<p>Note that, in C++ version 11 (2011), you can also use the <a href="cpp_arrays_loop.asp">"for-each" loop</a>, 
which is even cleaner and simpler:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  int myNumbers[5] = {10, 20, 30, 40, 50};<br>for (int num : myNumbers) {<br>&nbsp; 
  cout &lt;&lt; num &lt;&lt; &quot;\n&quot;;<br>}<br>
 </div>
...
<p>It is good to know the different ways to loop through an array, since you may encounter them all in different programs.</p>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_arrays_size.js"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_arrays_omit.asp">&#10094; Previous</a>
