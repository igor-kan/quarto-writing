...
<html lang="en-US">
<head>
<title>C++ Encapsulation and Getters and Setters</title>
<meta charset="utf-8">
...
<h1>C++ <span class="color_h1">Encapsulation</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_access_specifiers.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_friend_function.asp">Next &#10095;</a>
</div>
<hr>

<h2>Encapsulation</h2>
<p>The meaning of <strong>Encapsulation</strong>, is to make sure that 
"sensitive" data is hidden from users.<p>To achieve this, you must declare class variables/attributes as <code class="w3-codespan">private</code> (cannot 
be accessed from outside the class).<p>If you want others to read or modify the 
value of a private member, you can provide public <strong>get</strong> and 
<strong>set</strong> methods.
<hr>

<h2>Real-Life Example</h2>

<p>Think of an employee's salary:</p>
<ul>
...
<p>Encapsulation works the same way. The data is hidden, and only trusted methods can access or modify it.</p>
<hr>
<h2>Access Private Members</h2>
<p>To access a private attribute, use public &quot;get&quot; and &quot;set&quot; methods:</p>
<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    #include &lt;iostream&gt;<br>using namespace std;<br><br>class Employee {<br>&nbsp; 
    private:<br>&nbsp;&nbsp;&nbsp; // Private attribute<br>&nbsp;&nbsp;&nbsp; int salary;<br><br>&nbsp; public:<br>&nbsp;&nbsp;&nbsp; 
    // Setter<br>&nbsp;&nbsp;&nbsp; 
    void setSalary(int s) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; salary = s;<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; 
    // Getter<br>&nbsp;&nbsp;&nbsp; int getSalary() {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    return salary;<br>&nbsp;&nbsp;&nbsp; }<br>};<br><br>int 
    main() {<br>&nbsp; Employee myObj;<br>&nbsp; myObj.setSalary(50000);<br>&nbsp; 
    cout &lt;&lt; myObj.getSalary();<br>&nbsp; return 0;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_encapsulation">Try it Yourself &raquo;</a>
</div>
<h4>Example explained</h4>
<ul>
  <li><code class="w3-codespan">salary</code> is <b>private</b> - it cannot be accessed directly</li>
  <li><code class="w3-codespan">setSalary()</code> sets the value</li>
  <li><code class="w3-codespan">getSalary()</code> returns the value</li>
</ul>
<p>We use <code class="w3-codespan">myObj.setSalary(50000)</code> to assign a value, and <code class="w3-codespan">myObj.getSalary()</code> to print it.</p>
<hr>

<h2>Why Encapsulation?</h2>
<ul>
<li>It is considered good practice to declare your class attributes as private (as 
often as you can). Encapsulation ensures better control of your data, 
because you (or others) can change one part of the code without affecting other parts</li>
