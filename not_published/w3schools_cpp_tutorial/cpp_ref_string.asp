...
<html lang="en-US">
<head>
<title>C++ string Library Reference (string functions)</title>
<meta charset="utf-8">
...
<h1>C++ <span class="color_h1">string</span> Library</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_ref_math.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_ref_cstring.asp">Next &#10095;</a>
</div>
<hr>

<h2>C++ string Functions</h2>
<p>The <code class="w3-codespan">&lt;string&gt;</code> library has many functions that allow you to perform tasks on strings.</p>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td>append()</td>
    <td>Adds characters or another string to the end of the current string</td>
  </tr>
  <tr>
    <td><a href="ref_string_at.asp">at()</a></td>
    <td>Returns the character at a specified index, with bounds checking</td>
  </tr>
  <tr>
    <td>back()</td>
    <td>Accesses the last character in the string</td>
  </tr>
  <tr>
    <td>begin()</td>
    <td>Returns an iterator pointing to the first character of the string</td>
  </tr>
  <tr>
    <td>c_str()</td>
    <td>Returns a C-style null-terminated string</td>
  </tr>
  <tr>
    <td>clear()</td>
    <td>Removes all characters, making the string empty</td>
  </tr>
  <tr>
    <td>compare()</td>
    <td>Compares the string with another string and returns the result</td>
  </tr>
  <tr>
    <td>copy()</td>
    <td>Copies characters from the string into a character array</td>
  </tr>
  <tr>
    <td>data()</td>
    <td>Returns a pointer to the string's internal character array</td>
  </tr>
  <tr>
    <td><a href="ref_string_empty.asp">empty()</a></td>
    <td>Checks whether the string is empty</td>
  </tr>
  <tr>
    <td>end()</td>
    <td>Returns an iterator pointing just past the last character</td>
  </tr>
  <tr>
    <td>erase()</td>
    <td>Deletes part of the string by position and length</td>
  </tr>
  <tr>
    <td>find()</td>
  ...
  <tr>
    <td>front()</td>
    <td>Accesses the first character in the string</td>
  </tr>
  <tr>
    <td>insert()</td>
    <td>Inserts characters or a substring at a specified position</td>
  </tr>
  <tr>
  ...
  <tr>
    <td><a href="ref_string_max_size.asp">max_size()</a></td>
    <td>Returns the maximum number of characters of a string</td>
  </tr>
  <tr>
    <td>operator[]</td>
    <td>Returns the character at a given index</td>
  </tr>
  <tr>
    <td>pop_back()</td>
  ...
  <tr>
    <td>push_back()</td>
    <td>Adds a single character to the end of the string</td>
  </tr>
  <tr>
    <td>replace()</td>
    <td>Replaces part of the string with new content</td>
  </tr>
  <tr>
    <td><a href="ref_string_rfind.asp">rfind()</a></td>
    <td>Finds the last occurrence of a character or substring</td>
  </tr>
  <tr>
    <td>resize()</td>
    <td>Changes the size of the string, either trimming or padding it</td>
  </tr>
  <tr>
    <td><a href="ref_string_size.asp">size()</a></td>
    <td>Alias of <a href="ref_string_length.asp">length()</a>; returns the string's length</td>
  </tr>
  <tr>
    <td>substr()</td>
    <td>Returns a portion of the string, starting at a given index and length</td>
  </tr>
  <tr>
    <td>swap()</td>
    <td>Exchanges the contents of two strings</td>
  </tr>
</table>

<p>Learn more about strings in our <a href="cpp_strings.asp">C++ Strings Tutorial</a>.</p>
