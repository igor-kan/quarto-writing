...
<h1>C++ <span class="color_h1">Templates</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_virtual_functions.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_files.asp">Next &#10095;</a>
</div>
<hr>

<h2>C++ Templates</h2>

<p>Templates let you write a function or class that works with different data types.</p>
<p>They help avoid repeating code and make programs more flexible.</p>

<hr>

<h2>C++ Function Templates</h2>

<p>You can create a function template by using the <code class="w3-codespan">template</code> keyword:</p>

<div class="w3-example">
<h3>Syntax</h3>
<pre class="w3-code notranslate javaHigh">
template &lt;<em>typename T</em>&gt;
<em>return_type</em> <em>function_name</em>(<em>T parameter</em>) {
  // code
}</pre>
</div>

<ul>
  <li><code class="w3-codespan">T</code> is a placeholder for a data type (like <code class="w3-codespan">int</code>, <code class="w3-codespan">float</code>, etc.).</li>
  <li>You can use any name instead of <code class="w3-codespan">T</code>, but <code class="w3-codespan">T</code> is common.</li>
</ul>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_templates">Try it Yourself &raquo;</a>
</div>
<p>In the example above, <code class="w3-codespan">add&lt;int&gt;(5, 3)</code> tells the compiler to use <code class="w3-codespan">int</code> for <code class="w3-codespan">T</code>, while <code class="w3-codespan">add&lt;double&gt;(2.5, 1.5)</code> tells it to use <code class="w3-codespan">double</code>.</p>

<hr>

<h2>C++ Class Templates</h2>

<p>You can also use templates to make classes that work with any data type:</p>
...
<p>The example below defines a template class <code class="w3-codespan">Box</code> that can store and display a value of any data type, and then creates one box for an <code class="w3-codespan">int</code> and one for a <code class="w3-codespan">string</code>:</p>
<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
template &lt;typename T&gt;<br>
...
int main() {<br>
&nbsp;&nbsp;Box&lt;int&gt; intBox(50);<br>
&nbsp;&nbsp;Box&lt;string&gt; strBox("Hello");<br><br>
&nbsp;&nbsp;intBox.show();<br>
&nbsp;&nbsp;strBox.show();<br>
&nbsp;&nbsp;return 0;<br>
}
  </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_templates_class">Try it Yourself &raquo;</a>
</div>

<p>And this example defines a template class <code class="w3-codespan">Pair</code> that stores two values of different types and displays them, then creates one pair for a person's name and age, and another for an ID and score:</p>

<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    template &lt;typename T1, typename T2&gt;<br>class Pair {<br>&nbsp; public:<br>&nbsp;&nbsp;&nbsp; 
    T1 first;<br>&nbsp;&nbsp;&nbsp; T2 second;<br><br>&nbsp;&nbsp;&nbsp; Pair(T1 
    a, T2 b) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; first = a;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    second = b;<br>&nbsp;&nbsp;&nbsp; }<br><br>&nbsp;&nbsp;&nbsp; void display() 
    {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; cout &lt;&lt; &quot;First: &quot; &lt;&lt; first &lt;&lt; &quot;, Second: 
    &quot; &lt;&lt; second &lt;&lt; &quot;\n&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>};<br><br>int main() {<br>&nbsp; Pair&lt;string, int&gt; 
    person(&quot;John&quot;, 30);<br>&nbsp; Pair&lt;int, double&gt; score(51, 9.5);<br><br>&nbsp; 
    person.display(); <br>&nbsp; score.display(); <br><br>&nbsp; return 0;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_templates_class2">Try it Yourself &raquo;</a>
</div>
...
<p>Templates let you:</p>
<ul>
  <li>Avoid repeating the same logic for different types</li>
...
<div class="ws-note ws-panel">
  <p><strong>Note:</strong> Templates must be defined in the same file where they are used (usually in the <code class="w3-codespan">.h</code> file).</p>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_templates.js"></div>
<hr>
