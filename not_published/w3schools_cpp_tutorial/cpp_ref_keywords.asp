...
<a class="w3-left w3-btn" href="cpp_ref_reference.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_ref_iostream.asp">Next &#10095;</a>
</div>
<hr>

<h2>C++ Keywords</h2>
<p>A list of useful keywords in C++ can be found in the table below.</p>
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td>auto</td>
    <td>Automatically detects the type of a variable based on the value you assign to it</td>
  </tr>
  <tr>
    <td>bitand</td>
