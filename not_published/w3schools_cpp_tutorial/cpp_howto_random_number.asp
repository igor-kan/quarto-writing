...
<html lang="en-US">
<head>
<title>C++ How To Generate a Random Number</title>
<meta charset="utf-8">
...
<h1>C++ <span class="color_h1">How To Generate Random Numbers</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_howto_add_two_numbers.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_ref_reference.asp">Next &#10095;</a>
</div>
<hr>

<h2>Random Number</h2>
<p>You can use the <code class="w3-codespan">rand()</code> function, found in the <code class="w3-codespan">
&lt;cstdlib&gt;</code> library, to generate a random number:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  cout &lt;&lt; rand();<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_howto_random_number">Try it Yourself &raquo;</a>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  // Generate a random number between 0 and 100<br>int 
  randomNum = rand() % 101;<br><br>cout &lt;&lt; randomNum;<br>return 0;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_howto_random_number2">Try it Yourself &raquo;</a>
</div>

<p><strong>Note:</strong> The examples above just outputs a random number once. 
They don't output different random numbers each time the program runs. To fix 
this, you can use the <code class="w3-codespan">srand()</code> function 
and add the <code class="w3-codespan">time()</code> function from the <code class="w3-codespan">&lt;ctime&gt;</code> library.</p>
<p>This will generate a random number from 0 to 100 each time the program runs:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  // Get a different random number each time the program runs<br>srand(time(0));<br><br>// Generate a random number between 0 and 100<br>int 
  randomNum = rand() % 101;<br><br>cout &lt;&lt; randomNum;<br>return 0;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_howto_random_number3">Try it Yourself &raquo;</a>
</div>
<hr>
