...
<a class="w3-left w3-btn" href="cpp_pointers_modify.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_memory_management_new.asp">Next &#10095;</a>
</div>
<hr>

<h2>Memory Management</h2>

<p>Memory management is the process of controlling how much memory your program uses - and how it is used. This includes creating, using, and releasing memory when it's no longer needed.</p>

<hr>

<h2>Memory in C++</h2>

<p>When you create a variable in C++, the compiler automatically reserves space in memory for it.</p>
<p>For example:</p>


<div class="w3-code notranslate cppHigh ws-grey w3-round">
int myNumber = 10;
</div>

<p>The line above tells the program: "I need space to store an <strong>integer</strong>." C++ handles this memory automatically,
so in this case, you dont have to worry about managing memory.</p>

<hr>

<h2>Get Memory Size </h2>

<p>You can check how much memory a variable type uses with the <code class="w3-codespan">sizeof</code> operator:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_memory_management_sizeof">Try it Yourself &raquo;</a>
</div>

<p>Knowing the size of types helps you write more efficient code, especially in larger programs.</p>
...
<hr>
<h2>Do You Have to Manage Memory Yourself?</h2>

<p><strong>Sometimes yes - and sometimes no.</strong></p>

<ul>
  <li>For normal variables (like <code class="w3-codespan">int x = 10;</code>), C++ takes care of the memory for you.</li>
  <li>But when you want to create memory manually while the program is running (for example: based on user input), you need to manage it yourself and clean it up when you're done.</li>
</ul>

<p>If your program uses too much memory, or forgets to clean up memory it no longer needs, it can lead to <b>slow performance</b> or even <b>crashes</b>.</p>

<p>That's why understanding memory is important. It gives you more control and helps avoid common bugs.</p>
<hr>

<h2>What's Next?</h2>

<p>In C++, you can use <a href="cpp_pointers.asp">pointers</a> to access and change memory directly.</p>

<p>This is powerful, but also risky. If you use a pointer the wrong way, you could accidentally change or damage other parts of your program's memory.</p>

<p>In the next chapter, you'll learn how to create memory manually using pointers - with the <code class="w3-codespan">new</code> keyword, and how to free it using <code class="w3-codespan">delete</code>.</p>
<hr>
<div id="exercisecontainer" src="xrcise_memory_management.js"></div>
<hr>
