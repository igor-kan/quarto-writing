...
<h1>C++ <span class="color_h1">Function Overloading</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_function_reallife.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_scope.asp">Next &#10095;</a>
</div>
<hr>

<h2>Function Overloading</h2>
<p><b>Function overloading</b> allows multiple functions to have the same name, as long as their parameters are different in <b>type</b> or <b>number</b>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  int myFunction(int x)<br>float myFunction(float x)<br>double 
  myFunction(double x, double y)<br>
 </div>
</div>
<p>This lets you use the same function name for similar tasks.</p>
<hr>

<h2>Without Function Overloading</h2>
<p>Consider the following example, which have two functions that add numbers of different type:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  int plusFuncInt(int x, int y) {<br>&nbsp; return x + y;<br>}<br><br>double plusFuncDouble(double x, double y) {<br>&nbsp; 
  return x + y;<br>}<br><br>int main() {<br>&nbsp; int myNum1 = plusFuncInt(8, 
  5);<br>&nbsp; double myNum2 = plusFuncDouble(4.3, 6.26);<br><br>&nbsp; cout &lt;&lt; 
  &quot;Int: &quot; &lt;&lt; myNum1 &lt;&lt; &quot;\n&quot;;<br>&nbsp; cout &lt;&lt; &quot;Double: &quot; &lt;&lt; myNum2;<br>&nbsp; 
  return 0;<br>}<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_function_overloading">Try it Yourself &raquo;</a>
</div>
<p><strong>Problem:</strong> We had to create two different function names for the same logic.</p>
<hr>
<h2>Using Function Overloading</h2>
...
<div class="w3-code notranslate javaHigh">
  ...
  y) {<br>&nbsp; return x + y;<br>}<br><br>double plusFunc(double x, double y) {<br>&nbsp; 
  return x + y;<br>}<br><br>int main() {<br>&nbsp; int myNum1 = plusFunc(8, 
  5);<br>&nbsp; double myNum2 = plusFunc(4.3, 6.26);<br><br>&nbsp; cout &lt;&lt; &quot;Int: &quot; &lt;&lt; 
  myNum1 &lt;&lt; &quot;\n&quot;;<br>&nbsp; cout &lt;&lt; &quot;Double: &quot; &lt;&lt; myNum2;<br>&nbsp; return 0;<br>}<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_function_overloading2">Try it Yourself &raquo;</a>
</div>
<div class="ws-note w3-panel">
  <p><strong>Note:</strong> Multiple functions can have the same name 
...
<hr>
<h2>Function Overloading by Number of Parameters</h2>

<p>In this example, we overload a function by using a different number of parameters:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_function_overloading3">Try it Yourself &raquo;</a>
</div>


<hr>
<div id="exercisecontainer" src="xrcise_function_overloading.js"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_function_reallife.asp">&#10094; Previous</a>
