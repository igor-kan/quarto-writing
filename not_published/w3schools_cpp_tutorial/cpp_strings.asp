...
<a class="w3-left w3-btn" href="cpp_challenges_operators.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_strings_concat.asp">Next &#10095;</a>
</div>
<hr>
...
<p>For example, "Hello World" is a string.</p>
<p>A <code class="w3-codespan">string</code> variable contains a collection of characters surrounded by double quotes (<code class="w3-codespan">""</code>):</p>
...
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  // Include the string library<br>#include &lt;string&gt;<br><br>// Create a string variable<br>string greeting = "Hello";<br><br>// Print the string<br>cout &lt;&lt; greeting;</div>

<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_strings">Try it Yourself &raquo;</a>
</div>

<p><strong>Note:</strong> Strings can contain multiple words, spaces, and punctuation:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
string greeting = "Hello and welcome!";<br>
cout &lt;&lt; greeting;
</div>

<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_strings2">Try it Yourself &raquo;</a>
</div>
