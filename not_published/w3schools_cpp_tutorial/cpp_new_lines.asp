...
<a class="w3-left w3-btn" href="cpp_output_numbers.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_challenges_output.asp">Next &#10095;</a>
</div>
<hr>

<h2>New Lines</h2>
<p>To insert a new line in your output, you can use the <code class="w3-codespan">\n</code> character:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  #include &lt;iostream&gt;<br>using namespace std;<br><br>int main() {<br>&nbsp; 
  cout &lt;&lt; &quot;Hello World! <strong>\n</strong>&quot;;<br>&nbsp; cout &lt;&lt; &quot;I am learning C++&quot;;<br>&nbsp; return 0;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_output3">Try it Yourself &raquo;</a>
</div>

<p>You can also use another <code class="w3-codespan">&lt;&lt;</code> operator and place the <code class="w3-codespan">\n</code> character after the text, like this:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  #include &lt;iostream&gt;<br>using namespace std;<br><br>int main() {<br>&nbsp; 
  cout &lt;&lt; &quot;Hello World!&quot; <strong>&lt;&lt; &quot;\n&quot;;</strong><br>&nbsp; cout &lt;&lt; &quot;I am learning C++&quot;;<br>&nbsp; return 0;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_output3_after">Try it Yourself &raquo;</a>
</div>

<p><strong>Tip:</strong> Two <code class="w3-codespan">\n</code> characters after each other will create a blank line:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  #include &lt;iostream&gt;<br>using namespace std;<br><br>int main() {<br>&nbsp; 
  cout &lt;&lt; &quot;Hello World!&quot; &lt;&lt; &quot;<strong>\n\n</strong>&quot;;<br>&nbsp; cout &lt;&lt; &quot;I am learning C++&quot;;<br>&nbsp; return 0;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_output4">Try it Yourself &raquo;</a>
</div>


<p>Another way to insert a new line, is with the <code class="w3-codespan">endl</code> manipulator:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  #include &lt;iostream&gt;<br>using namespace std;<br><br>int main() {<br>&nbsp; 
  cout &lt;&lt; &quot;Hello World!&quot; &lt;&lt; <strong>endl</strong>;<br>&nbsp; cout &lt;&lt; &quot;I am learning C++&quot;;<br>&nbsp; return 0;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_output5">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
<p>Both <code class="w3-codespan">\n</code> and <code class="w3-codespan">endl</code> 
are used to break lines. 
However, <code class="w3-codespan">\n</code> is most used.</p>

<h4>But what is <code class="w3-codespan">\n</code> exactly?</h4>

<p>The newline character (<code class="w3-codespan">\n</code>) is called an <strong>escape sequence</strong>, and 
it forces the cursor to change its position to the beginning of the next line on the screen. This results in a new line.</p>
<!--<p>Escape sequences always starts with a backslash. Escape sequences are important when you want to output special characters. 
For example, if you insert a double quote (<strong>&quot;</strong>) wrongly in your 
code, the program will fail. However, you can add a backslash in front of it, 
and then the output will be as expected.</p>-->
  <p>Examples of other valid escape sequences are:</p>
  <table class="ws-table-all">
    ...
    <tr>
      ...
      <td><a target="_blank" class="w3-btn btnsmall" href="trycpp.asp?filename=demo_esc_char">Try it</a></td>
    </tr>
    <tr>
      <td>\\</td>
      <td>Inserts a backslash character (\)</td>
      <td><a target="_blank" class="w3-btn btnsmall" href="trycpp.asp?filename=demo_esc_char_backslash">Try it</a></td>
    </tr>
    <tr>
      <td>\&quot;</td>
      <td>Inserts a double quote character</td>
      <td><a target="_blank" class="w3-btn btnsmall" href="trycpp.asp?filename=demo_esc_char_dblquote">Try it</a></td>
    </tr>
  </table>
</div>
...
<hr>
<div id="exercisecontainer" src="xrcise_new_lines.js"></div>
<hr>
<br>
