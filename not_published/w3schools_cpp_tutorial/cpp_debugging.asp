...
<a class="w3-left w3-btn" href="cpp_errors.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_exceptions.asp">Next &#10095;</a>
</div>
<hr>
...
<p>Use <code class="w3-codespan">cout</code> to print values at different points 
in your code to see what's going wrong:</p>

<div class="w3-example">
<div class="w3-code notranslate javaHigh w3-border-red">
  int x = 10;<br>int y = 0;<br>cout &lt;&lt; &quot;Before division\n&quot;; // Debug output<br>
  int z = x / y; // Crashes!<br>cout &lt;&lt; &quot;After division\n&quot;; // Never runs</div>
</div>
...
<div class="w3-example">
<div class="w3-code notranslate javaHigh w3-border-red">
  int x = 10;<br>int y = 5;<br>int result = x - y;<br>cout &lt;&lt; &quot;Result: &quot; &lt;&lt; 
  result &lt;&lt; &quot;\n&quot;; // Result: 5</div>
</div>

<p>Expected 15? That means the logic is wrong: try using 
<code class='w3-codespan'>x + y</code> instead.</p>
<hr>

<h3>3. Use a Debugger Tool</h3>

<p>IDEs like Visual Studio, Code::Blocks, and VS Code have <strong>debuggers</strong> that let you:</p>

<ul>
  <li>Pause your program (breakpoints)</li>
  <li>Step through code line by line</li>
  <li>Watch variables and find unexpected values</li>
</ul>

<p><strong>Tip:</strong> Start with "1. Print Debugging". Use IDE tools as you get more comfortable.</p>
...
<p><strong>While debugging</strong> is about finding and fixing errors in your code, <strong>exception handling</strong> is a way to deal with errors while the program is running - and run specific code when something goes wrong.</p><p>Learn about <a href="/cpp/cpp_exceptions.asp">Exception Handling</a> in the next chapter.</p>
<hr>
<div id="exercisecontainer" src="xrcise_debugging.js"></div>
<hr>
