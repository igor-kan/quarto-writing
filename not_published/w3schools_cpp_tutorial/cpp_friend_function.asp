...
<h1>C++ <span class="color_h1">The Friend Keyword</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_encapsulation.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_inheritance.asp">Next &#10095;</a>
</div>
<hr>
<h2>C++ Friend Functions</h2>

<p>Normally, <code class="w3-codespan">private</code> members of a class can only be accessed using public methods like <a href="cpp_encapsulation.asp">getters and setters</a>. But in some cases, you can use a special function called a <code class="w3-codespan">friend</code> function to access them directly.</p>

<p>A <code class="w3-codespan">friend</code> function is not a member of the class, but it is allowed to access the class's private data:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-cpp w3-white"><code>class Employee {
  private:
    int salary;
...
<p>
<a target="_blank" class="w3-btn" href="trycpp.asp?filename=demo_friend_function">Try it Yourself &raquo;</a>
</p>
</div>
...
<ul>
  <li>The <code class="w3-codespan">friend</code> function <code class="w3-codespan">displaySalary()</code> is declared inside the <code class="w3-codespan">Employee</code> class but defined outside of it.</li>
  <li>Even though <code class="w3-codespan">displaySalary()</code> is not a member of the class, it can still access the private member <code class="w3-codespan">salary</code>.</li>
  <li>In the <code class="w3-codespan">main()</code> function, we create an <code class="w3-codespan">Employee</code> object and call the friend function to print its salary.</li>
</ul>
<hr>
...
<hr>
<div id="exercisecontainer" src="xrcise_friend_function.js"></div>
<hr>
