...
<html lang="en-US">
<head>
<title>C++ Boolean Data Types</title>
<meta charset="utf-8">
...
<h1>C++ <span class="color_h1">Boolean Data Types</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_data_types_numeric.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_data_types_char.asp">Next &#10095;</a>
</div>
<hr>

<h2>Boolean Types</h2>
<p>A boolean data type is declared with the <code class="w3-codespan">bool</code> keyword and can only take the values <code class="w3-codespan">true</code> or <code class="w3-codespan">false</code>.</p>
<p>When the value is returned, <code class="w3-codespan">true</code> 
= <code class="w3-codespan">1</code> and <code class="w3-codespan">false</code> 
= <code class="w3-codespan">0</code>.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  bool isCodingFun = true;<br>bool isFishTasty = false;<br>cout &lt;&lt; isCodingFun;&nbsp; 
  // Outputs 1 (true)<br>cout &lt;&lt; isFishTasty;&nbsp; // Outputs 0 (false)</div>
...
<hr>
<div id="exercisecontainer" src="xrcise_data_types_bool.js"></div>
<hr>
