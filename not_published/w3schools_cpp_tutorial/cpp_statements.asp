...
<a class="w3-left w3-btn" href="cpp_syntax.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_challenges_syntax.asp">Next &#10095;</a>
</div>
<hr>
...
<!--<p>A &quot;<strong>C program</strong>&quot; is a list of programming <strong>statements</strong>.</p>-->

<p>The following statement &quot;instructs&quot; the compiler to print the text &quot;Hello World&quot; 
to the screen:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  cout &lt;&lt; &quot;Hello World!&quot;;<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_statements">Try it Yourself &raquo;</a>
</div>

<p>It is important that you end the statement with a semicolon <code class="w3-codespan">;</code></p>
<p>If you forget the semicolon (<code class="w3-codespan">;</code>), an error will occur 
and the program will not run:</p>
...
<p><a target="_blank" class="w3-btn" href="trycpp.asp?filename=demo_statements_error">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Many Statements</h2>
<p>Most C++ programs contain many statements.</p>
<p>The statements are executed, one by one, in the same order as they are 
written:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  cout &lt;&lt; &quot;Hello World!&quot;;<br>cout &lt;&lt; &quot;Have 
  a good day!&quot;;<br>return 0;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_statements2">Try it Yourself &raquo;</a>
</div>

<h4>Example explained</h4>
<p>From the example above, we have three statements:</p>
<ol>
<li><code class="w3-codespan">cout << "Hello World!";</code></li>
  <li><code class="w3-codespan">cout << "Have a good day!";</code></li>
  <li><code class="w3-codespan">return 0;</code></li>
</ol>

<p>The first statement is executed first (print "Hello World!" to the screen).<br>
Then the second statement is executed (print "Have a good day!" to the screen).<br>
And at last, the third statement is executed (end the C++ program successfully).</p>

<div class="ws-note w3-panel">
<p>You will learn more about statements while reading this tutorial. For now, just remember to always end them with a semicolon to avoid any errors.</p>
  <p><strong>Coming up:</strong> The next chapter will teach you how to control 
  the output and how to insert new lines to make it more readable.</p>
</div>
...
<hr>
<div id="exercisecontainer" src="xrcise_statements.js"></div>
<hr>
<br>
