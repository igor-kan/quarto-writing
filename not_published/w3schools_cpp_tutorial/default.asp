...
<a class="w3-right w3-btn" href="cpp_intro.asp">Next &#10095;</a>
</div>
  ...
  <div class="cert-card">
    <div class="cert-card-header">
      <div class="cert-card-icon">
        <svg xmlns="http://www.w3.org/2000/svg" width="39" height="39" fill="#00599C" viewBox="0 0 24 24"><path d="M22.394 6c-.167-.29-.398-.543-.652-.69L12.926.22c-.509-.294-1.34-.294-1.848 0L2.26 5.31c-.508.293-.923 1.013-.923 1.6v10.18c0 .294.104.62.271.91.167.29.398.543.652.69l8.816 5.09c.508.293 1.34.293 1.848 0l8.816-5.09c.254-.147.485-.4.652-.69.167-.29.27-.616.27-.91V6.91c.003-.294-.1-.62-.268-.91zM12 19.11c-3.92 0-7.109-3.19-7.109-7.11 0-3.92 3.19-7.11 7.11-7.11a7.133 7.133 0 016.156 3.553l-3.076 1.78a3.567 3.567 0 00-3.08-1.78A3.56 3.56 0 008.444 12 3.56 3.56 0 0012 15.555a3.57 3.57 0 003.08-1.778l3.078 1.78A7.135 7.135 0 0112 19.11zm7.11-6.715h-.79v.79h-.79v-.79h-.79v-.79h.79v-.79h.79v.79h.79zm2.962 0h-.79v.79h-.79v-.79h-.79v-.79h.79v-.79h.79v.79h.79z"></path></svg>
      </div>
      <h2 class="cert-card-title">Learn C++</h2>
    </div>
    <p class="cert-card-desc">C++ is a popular programming language.</p>
    <p class="cert-card-desc">C++ is used to create computer programs, and is one of the most used languages in game development.</p>
    <p class="cert-card-desc">C++ was developed as an extension of <a href="/c/index.php">C</a>, and both languages have almost the same syntax.</p>
    <div class="cert-card-bottom" style="margin-top:auto;padding-top:16px;">
      <a href="cpp_intro.asp" class="cert-card-btn">Learn C++ now &#10095;</a>
    </div>
  </div>
...
<a href="https://campus.w3schools.com/collections/course-catalog/products/cpp-course" class="cert-card-btn cert-btn-white" target="_blank" style="margin-top:12px;background:#fff;color:#000;border:2px solid #000;">Get Certified &#10095;</a>
        </div>
        <div class="cert-preview" style="flex:1 1 auto;padding:0;align-self:flex-start;">
          <svg class="cert-preview-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 560 400" role="img" aria-label="C++ Certificate preview" style="width:100%;max-width:250px;height:auto;display:block;margin:0 0 0 auto;">
            ...
            <g transform="translate(248,222)">
              <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="#00599C" viewBox="0 0 24 24"><path d="M22.394 6c-.167-.29-.398-.543-.652-.69L12.926.22c-.509-.294-1.34-.294-1.848 0L2.26 5.31c-.508.293-.923 1.013-.923 1.6v10.18c0 .294.104.62.271.91.167.29.398.543.652.69l8.816 5.09c.508.293 1.34.293 1.848 0l8.816-5.09c.254-.147.485-.4.652-.69.167-.29.27-.616.27-.91V6.91c.003-.294-.1-.62-.268-.91zM12 19.11c-3.92 0-7.109-3.19-7.109-7.11 0-3.92 3.19-7.11 7.11-7.11a7.133 7.133 0 016.156 3.553l-3.076 1.78a3.567 3.567 0 00-3.08-1.78A3.56 3.56 0 008.444 12 3.56 3.56 0 0012 15.555a3.57 3.57 0 003.08-1.778l3.078 1.78A7.135 7.135 0 0112 19.11zm7.11-6.715h-.79v.79h-.79v-.79h-.79v-.79h.79v-.79h.79v.79h.79zm2.962 0h-.79v.79h-.79v-.79h-.79v-.79h.79v-.79h.79v.79h.79z"></path></svg>
            </g>
...
<p><a class="w3-btn w3-margin-bottom ws-green" href="cpp_exercises.asp" style="border-radius:5px;font-size: 18px;padding-left:25px;padding-right:25px;font-family: 'Source Sans Pro', sans-serif;margin-top:6px;">See all C++ Exercises</a></p>
<hr>
...
<hr>
<h2>C++ Quiz</h2>
<p>Learn by taking a quiz! The quiz will give you a signal of how much you know, or do not know, about C++.</p>
<p><a href="cpp_quiz.asp" class="w3-button w3-blue w3-round">Start C++ Quiz</a></p>
<hr>

<h2>Learn by Examples</h2>
<p>Learn by examples! This tutorial supplements all explanations with clarifying examples.</p>
<p><a href="cpp_examples.asp" class="w3-button w3-light-grey w3-round">See All C++ Examples</a></p>
<hr>
...
<h2>C++ Reference</h2>
<p>You will also find references for different libraries, keywords and functions:</p>

<div class="ref-grid">

  <a href="cpp_ref_reference.asp" class="ref-box">Reference Overview</a>
  <a href="cpp_ref_keywords.asp" class="ref-box">C++ Keywords</a>
  <a href="cpp_ref_iostream.asp" class="ref-box">C++ &lt;iostream&gt; Objects</a>
  <a href="cpp_ref_fstream.asp" class="ref-box">C++ &lt;fstream&gt; Classes</a>
  <a href="cpp_ref_math.asp" class="ref-box">C++ &lt;cmath&gt; Functions</a>
  <a href="cpp_ref_string.asp" class="ref-box">C++ &lt;string&gt; Functions</a>
  <a href="cpp_ref_cstring.asp" class="ref-box">C++ &lt;cstring&gt; Functions</a>
  <a href="cpp_ref_ctime.asp" class="ref-box">C++ &lt;ctime&gt; Functions</a>
  <a href="cpp_ref_vector.asp" class="ref-box">C++ &lt;vector&gt; Functions</a>
  <a href="cpp_ref_algorithm.asp" class="ref-box">C++ &lt;algorithm&gt; Functions</a>
