...
<a class="w3-left w3-btn" href="cpp_templates.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_date.asp">Next &#10095;</a>
</div>
<hr>

<h2>C++ Files</h2>
<p>The <code class="w3-codespan">fstream</code> library allows us to work with files.</p>
<p>To use the <code class="w3-codespan">fstream</code> library, include both the standard <code class="w3-codespan">&lt;iostream&gt;</code> <strong>AND</strong> the <code class="w3-codespan">&lt;fstream&gt;</code> header file:</p>


<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    #include &lt;iostream&gt;<br>#include &lt;fstream&gt;</div>
</div>
<p>There are three classes included in the <code class="w3-codespan">fstream</code> library, 
which are used to create, write or read files:</p>
...
<h2>Create and Write To a File</h2>
<p>To create a file, use either the <code class="w3-codespan">ofstream</code> or <code class="w3-codespan">fstream</code> class, 
and specify the name of the file.</p>
<p>To write to the file, use the insertion operator (<code class="w3-codespan">&lt;&lt;</code>).</p>

<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    #include &lt;iostream&gt;<br>#include &lt;fstream&gt;<br>using namespace std;<br><br>
    int main() {<br>&nbsp; // Create and open a text file<br>&nbsp; ofstream MyFile(&quot;filename.txt&quot;);<br><br>&nbsp; // 
    Write to the file<br>&nbsp; MyFile &lt;&lt; &quot;Files can be tricky, but it is fun 
    enough!&quot;;<br><br>&nbsp; // 
    Close the file<br>&nbsp; MyFile.close();<br>}</div>
</div>

<div class="ws-note w3-panel">
<h4>Why do we close the file?</h4>
<p>It is considered good practice, and it can clean up unnecessary memory space.</p>
</div>
<hr>
...
<h2>Read a File</h2>
<p>To read from a file, use either the <code class="w3-codespan">ifstream</code> or <code class="w3-codespan">fstream</code> 
class, and the name of the file.</p>
<p>Note that we also use a <code class="w3-codespan">while</code> loop together with the <code class="w3-codespan">getline()</code> function 
(which belongs to the <code class="w3-codespan">ifstream</code> class) to read the file line by line, and to print the content of the file:</p>

<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    // Create a 
    text string, which is used to output the text file<br>string myText;<br>
    <br>// Read from the text file<br>ifstream MyReadFile(&quot;filename.txt&quot;);<br><br>// Use a while 
    loop together with the getline() function to read the file line by line<br>while (getline (MyReadFile, 
    myText)) {<br>&nbsp; // Output the text from the file<br>&nbsp;&nbsp;cout &lt;&lt; myText;<br>
    }<br>
    <br>// Close the file<br>MyReadFile.close();</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showcpp.asp?filename=demo_files_read">Run example &raquo;</a>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_files.js"></div>
<hr>

<h2>Complete &lt;fstream&gt; Reference</h2>
<p>For a complete reference of &lt;fstream&gt; classes and functions, go to our <a href="cpp_ref_fstream.asp">C++ fstream Reference</a>.</p>
<hr>
