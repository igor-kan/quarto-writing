...
<a class="w3-left w3-btn" href="cpp_conditions_shorthand.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_conditions_logical.asp">Next &#10095;</a>
</div>
<hr>
...
<h3>Syntax</h3>
<pre class="language-cpp w3-white"><code>if (condition1) {
...
<div class="w3-example">
<h3>Example</h3>
<pre class="language-cpp w3-white"><code>int x = 15;
int y = 25;
...
<p>
<a target="_blank" class="w3-btn" href="trycpp.asp?filename=demo_if_nested">Try it Yourself &raquo;</a>
</p>
</div>
