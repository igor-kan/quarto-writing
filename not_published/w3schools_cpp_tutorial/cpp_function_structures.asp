...
<html lang="en-US">
<head>
<title>C++ Pass Structures to a Function</title>
<meta charset="utf-8">
...
<h1>C++ <span class="color_h1">Pass Structures to a Function</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_function_array.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_function_reallife.asp">Next &#10095;</a>
</div>
<hr>

<h2>Pass Structure to a Function</h2>

<p>You can also pass a structure to a function.</p>
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate javaHigh">
    struct Car {<br>&nbsp; string brand;<br>&nbsp; int year;<br>};<br><br>void myFunction(Car 
    c) {<br>&nbsp; cout &lt;&lt; &quot;Brand: &quot; &lt;&lt; c.brand &lt;&lt; &quot;, Year: &quot; &lt;&lt; c.year &lt;&lt; &quot;\n&quot;;<br>
    }<br>
    <br>int main() {<br>&nbsp; Car myCar = {&quot;Toyota&quot;, 2020};<br>&nbsp; 
    myFunction(myCar);<br>&nbsp; return 0;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_functions_structs">Try it Yourself &raquo;</a>
</div>

<p><strong>Note:</strong> Since the structure is passed by value, the function 
gets a copy of the structure.</p>
<p>This means that the original data is not changed.</p>
<hr>

<h2>Pass by Reference</h2>
<p>You can also pass a structure by reference, using <code class="w3-codespan">&amp;</code>.</p>
<p>This allows the function to modify the original data:</p>

<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    struct Car {<br>&nbsp; string brand;<br>&nbsp; int year;<br>};<br><br>void updateYear(Car &amp;c) {<br>&nbsp; 
    c.year++;<br>}<br>
    <br>int main() {<br>&nbsp; Car myCar = {&quot;Toyota&quot;, 2020};<br>&nbsp; 
    updateYear(myCar);<br>&nbsp; cout &lt;&lt; &quot;The &quot; &lt;&lt; myCar.brand &lt;&lt; &quot; is now from 
    year &quot; &lt;&lt; myCar.year &lt;&lt; &quot;.\n&quot;;<br>&nbsp; return 0;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_functions_structs2">Try it Yourself &raquo;</a>
</div>

<p><strong>Tip:</strong> Use reference if you want the function to change the structure's data, or to avoid copying large structures.</p>
<hr>
...
<hr>
<div id="exercisecontainer" src="xrcise_function_structures.js"></div>
<hr>
