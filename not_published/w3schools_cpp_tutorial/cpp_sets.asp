...
<h1>C++ <span class="color_h1">Sets</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cpp_deque.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cpp_maps.asp">Next &#10095;</a>
</div>
<hr>

<h2>C++ Set</h2>
<p>A set stores unique elements where they:</p>
<ul>
<li>Are sorted automatically in ascending order.</li>
<li>Are unique, meaning equal or duplicate values are ignored.</li>
<li>Can be added or removed, but the value of an existing element cannot be changed.</li>
<li>Cannot be accessed by index numbers, because the order is based on 
sorting and not indexing.</li>
</ul>

<p>To use a set, you have to include the <code class="w3-codespan">&lt;set&gt;</code> header file: 
<div class="w3-example">
<div class="w3-code notranslate javaHigh">
  // Include the set library<br>#include &lt;set&gt;<br>
 </div>
</div>
...
<h2>Create a Set</h2>
<p>To create a set, use the <code class="w3-codespan">set</code> keyword, 
and specify the <strong>type</strong> of values it should store within angle brackets <code class="w3-codespan">&lt;&gt;</code> 
and then the name of the set, like: <code class="w3-codespan">set&lt;<em>type</em>&gt; 
<em>setName</em></code>.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  // Create a set called cars that will store strings<br>
  set&lt;string&gt; cars;<br>
 </div>
</div>
...
<div class="w3-code notranslate javaHigh">
  ...
  &quot;Ford&quot;, &quot;Mazda&quot;};<br><br>// Print set elements<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_sets">Try it Yourself &raquo;</a>
</div>

<p>As you can see from the result above, the elements in the set are 
sorted automatically. In this case, alphabetically, as we are working with strings.</p>
<p>If you store integers in the set, the returned values are sorted numerically:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  // Create a set called 
  numbers that will store integers<br>
  set&lt;int&gt; numbers = {1, 7, 3, 2, 5, 9};<br><br>// Print set elements<br>
  for (int num : numbers) {<br>&nbsp; cout &lt;&lt; 
  num &lt;&lt; &quot;\n&quot;;<br>}<br>
 </div>
 <p>The output will be:</p>
 <div class="w3-padding notranslate w3-black w3-margin-top w3-margin-bottom">
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_sets_int">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
  <p><strong>Note:</strong> The type of the set (e.g. <code class="w3-codespan">string</code> and <code class="w3-codespan">int</code> in 
  the examples above) cannot be changed after its been declared.</p>
</div>
<hr>

<h2>Sort a Set in Descending Order</h2>
<p>By default, the elements in a set are sorted in ascending order. If you want to reverse the order, 
you can use the <code class="w3-codespan">greater&lt;<em>type</em>&gt;</code> 
functor inside the angle brackets, like this:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  // Sort elements in a set in descending order<br>
  set&lt;int, <strong>greater&lt;int&gt;</strong>&gt; numbers = {1, 7, 3, 2, 5, 9};<br>// Print 
  the elements<br>
  for (int num : numbers) {<br>&nbsp; cout &lt;&lt; 
  num &lt;&lt; &quot;\n&quot;;<br>}<br>
 </div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_sets_greater">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
<p><strong>Note:</strong> The type specified in greater&lt;<em>type</em>&gt; must match the type of elements in the set (<code class="w3-codespan">int</code> in our example).</p>
</div>
<hr>
...
<p>Elements in a set are unique, which means they cannot be 
duplicated or equal.</p>
<p>For example, if we try to add &quot;BMW&quot; two times in the set, the duplicate 
element is ignored:</p>
<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
  set&lt;string&gt; cars = {&quot;Volvo&quot;, &quot;<strong>BMW</strong>&quot;, 
  &quot;Ford&quot;, &quot;<strong>BMW</strong>&quot;, &quot;Mazda&quot;};<br><br>// Print set elements<br>
  for (string car : cars) {<br>&nbsp; cout &lt;&lt; car &lt;&lt; &quot;\n&quot;;<br>}<br>
 </div>
 <p>The output will be:</p>
 <div class="w3-padding notranslate w3-black w3-margin-top w3-margin-bottom">
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_sets_unique">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Add Elements</h2>
<p>To add elements to a set, you can use the <code class="w3-codespan">.insert()</code> function:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  set&lt;string&gt; cars = {&quot;Volvo&quot;, &quot;BMW&quot;, &quot;Ford&quot;, &quot;Mazda&quot;};<br><br>// Add new elements<br>cars.insert(&quot;Tesla&quot;);<br>cars.insert(&quot;VW&quot;);<br>cars.insert(&quot;Toyota&quot;);<br>cars.insert(&quot;Audi&quot;);<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_sets_add">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Remove Elements</h2>
<p>To remove specific elements from a set, you can use the <code class="w3-codespan">.erase()</code> function:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  set&lt;string&gt; cars = {&quot;Volvo&quot;, &quot;BMW&quot;, &quot;Ford&quot;, &quot;Mazda&quot;};<br>
  <br>// Remove elements<br>
  cars.erase(&quot;Volvo&quot;);<br>cars.erase(&quot;Mazda&quot;);<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_sets_remove">Try it Yourself &raquo;</a>
</div>

<p>To remove all elements from a set, you can use the <code class="w3-codespan">.clear()</code> function:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  set&lt;string&gt; cars = {&quot;Volvo&quot;, &quot;BMW&quot;, &quot;Ford&quot;, &quot;Mazda&quot;};<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_sets_remove2">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Find the Size of a Set</h2>
<p>To find out how many elements a set has, use the <code class="w3-codespan">.size()</code> function:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  set&lt;string&gt; cars = {&quot;Volvo&quot;, &quot;BMW&quot;, &quot;Ford&quot;, &quot;Mazda&quot;};<br>cout &lt;&lt; cars.size();&nbsp; 
  // Outputs 4<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_sets_size">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Check if a Set is Empty</h2>
...
1</code> (<em>true</em>) if the set is empty and <code class="w3-codespan">0</code> (<em>false</em>) 
otherwise:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  set&lt;string&gt; cars;<br>cout &lt;&lt; cars.empty();&nbsp; 
  // Outputs 1 (The set is empty)<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_sets_empty">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  set&lt;string&gt; cars = {&quot;Volvo&quot;, &quot;BMW&quot;, &quot;Ford&quot;, &quot;Mazda&quot;};<br>cout &lt;&lt; cars.empty();&nbsp; 
  // Outputs 0 (not empty)<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_sets_empty2">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Loop Through a Set</h2>
<p>You can loop through a set with the <strong>for-each loop</strong>:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  set&lt;string&gt; cars = {&quot;Volvo&quot;, &quot;BMW&quot;, &quot;Ford&quot;, &quot;Mazda&quot;};<br><br>
  for (string car : cars) {<br>&nbsp; cout &lt;&lt; car &lt;&lt; &quot;\n&quot;;<br>}<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_sets_loop">Try it Yourself &raquo;</a>
</div>
<p><strong>Tip:</strong> It is also possible to loop through sets with an <a href="cpp_iterators.asp">iterator</a>, which you will learn more about in a later chapter.</p>
