...
<h1>R <span class="color_h1">For Loop</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="r_while_loop.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="r_for_loop_nested.asp">Next &#10095;</a>
</div>
<hr>

<h2>For Loops</h2>
<!--
<p>When you know exactly how many times you want to loop through a block of code, use the <code class="w3-codespan">for</code> loop instead of a  <code class="w3-codespan">while</code> loop:</p>
-->

<p>A <code class="w3-codespan">for</code> loop is used for iterating over a sequence:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  for (x in 1:10) {<br>&nbsp; print(x)<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_syntax_print_for">Try it Yourself &raquo;</a>
</div>

<p>This is less like the <code class="w3-codespan">for</code> keyword in other programming languages, and works more like an iterator
method as found in other object-oriented programming languages.</p>
<p>With the <code class="w3-codespan">for</code> loop we can execute a set of statements, once for each item in a vector, 
array, list, etc..</p>
<div class="ws-note w3-panel">
<p>You will learn about <a href="r_lists.asp">lists</a> and <a href="r_vectors.asp">vectors</a>, etc in a later chapter.</p>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Print every item in a list:</p>
<div class="w3-code notranslate pythonHigh">
  fruits &lt;- list(&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;)<br><br>for (x in fruits) {<br>&nbsp; 
  print(x)<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_for_loop">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Print the number of dices:</p>
<div class="w3-code notranslate pythonHigh">
  dice &lt;- c(1, 2, 3, 4, 5, 6)<br><br>for (x in dice) {<br>&nbsp; print(x)<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_for_loop2">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
<p>The <code class="w3-codespan">for</code> loop does not require an indexing variable to set beforehand, like with <code class="w3-codespan">while</code> loops.</p>
</div>
<hr>

<h2>Break</h2>
<p>With the <code class="w3-codespan">break</code> statement, we can stop the loop before it has looped through all the items:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Stop the loop at &quot;cherry&quot;:</p>
<div class="w3-code notranslate pythonHigh">
  fruits &lt;- list(&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;)<br><br>for (x in fruits) {<br>&nbsp; 
  if (x == &quot;cherry&quot;) {<br>&nbsp;&nbsp;&nbsp; break<br>&nbsp; }<br>&nbsp; 
  print(x)<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_for_loop_break">Try it Yourself &raquo;</a>
</div>
<p>The loop will stop at &quot;cherry&quot; because we have chosen to finish the loop by using the <code class="w3-codespan">break</code> statement when 
<code class="w3-codespan">x</code> is equal to &quot;cherry&quot; (<code class="w3-codespan">x == 
&quot;cherry&quot;</code>).</p>
<hr>
...
<h2>Next</h2>
<p>With the <code class="w3-codespan">next</code> statement, we can skip an iteration without terminating the loop:</p>
...
<div class="w3-code notranslate pythonHigh">
  fruits &lt;- list(&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;)<br><br>for (x in fruits) {<br>&nbsp; 
  if (x == &quot;banana&quot;) {<br>&nbsp;&nbsp;&nbsp; next<br>&nbsp; }<br>&nbsp; print(x)<br>
  }</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_for_loop_next">Try it Yourself &raquo;</a>
</div>
<p>When the loop passes &quot;banana&quot;, it will skip it and continue to loop.</p>
<hr>

<h2>Yahtzee!</h2>
<h3>If .. Else Combined with a For Loop</h3>
<p>To demonstrate a practical example, let us say we play a game of Yahtzee!</p>

<div class="w3-example">
<h3>Example</h3>
<p>Print &quot;Yahtzee!&quot; If the dice number is 6:</p>
<div class="w3-code notranslate pythonHigh">
  dice &lt;- 1:6<br><br>for(x in dice) {<br>&nbsp; if (x == 6) {<br>&nbsp;&nbsp;&nbsp; 
  print(paste(&quot;The dice number is&quot;, x, &quot;Yahtzee!&quot;))<br>&nbsp; } else {<br>&nbsp;&nbsp;&nbsp; 
  print(paste(&quot;The dice number is&quot;, x, &quot;Not Yahtzee&quot;))<br>&nbsp; }<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_for_loop_yahtzee">Try it Yourself &raquo;</a>
</div>
<p>If the loop reaches the values ranging from 1 to 5, it prints "No Yahtzee" and its number. When it
reaches the value 6, it prints "Yahtzee!" and its number.</p>
<hr>
