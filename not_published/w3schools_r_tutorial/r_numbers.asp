...
<h1>R <span class="color_h1">Numbers</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="r_data_types.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="r_math.asp">Next &#10095;</a>
</div>
<hr>

<h2>Numbers</h2>

<p>There are three number types in R:</p>
<ul>
  <li><code class="w3-codespan">numeric</code></li>
  <li><code class="w3-codespan">integer</code></li>
  <li><code class="w3-codespan">complex</code></li>
</ul>
<p>Variables of number types are created when you assign a value to them:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  x &lt;- 10.5&nbsp;&nbsp; # 
  numeric<br>y &lt;- 10L&nbsp;&nbsp;&nbsp; # integer<br>z &lt;- 1i&nbsp;&nbsp;&nbsp;&nbsp; # complex</div>
</div>

<hr>

<h2>Numeric</h2>
<p>A <code class="w3-codespan">numeric</code> data type is the most common type 
in R, and contains any number with or without a decimal, like: 10.5, 55, 787:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  x &lt;- 10.5<br>y &lt;- 55<br><br># Print values of x and y<br>
  x<br>y<br><br># 
  Print the class name of x and y<br>class(x)<br>class(y)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_numbers_numeric">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Integer</h2>
<p>Integers are numeric data without decimals. This is used when you are certain 
that you will never create a variable that should contain decimals. To create an <code class="w3-codespan">integer</code> 
variable, 
you must use the letter <code class="w3-codespan">L</code> after the integer value:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  x &lt;- 1000L<br>y &lt;- 55L<br><br># Print values of x and y<br>x<br>y<br><br># Print the class name of x and y<br>
  class(x)<br>class(y)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_numbers_integer">Try it Yourself &raquo;</a>
</div>
<hr>
...
<h2>Complex</h2>
<p>A <code class="w3-codespan">complex</code> number is written with an "<code class="w3-codespan">i</code>" as the imaginary part:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  x &lt;- 3+5i<br>y &lt;- 5i<br><br># Print values of x and y<br>x<br>y<br><br># Print the class name of x and y<br>
  class(x)<br>class(y)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_numbers_complex">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Type Conversion</h2>
<p>You can convert from one type to another with the following functions:</p>
<ul>
  <li><code class="w3-codespan">as.numeric()</code></li>
  <li><code class="w3-codespan">as.integer()</code></li>
  <li><code class="w3-codespan">as.complex()</code></li>
</ul>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  x &lt;- 1L # integer<br>y &lt;- 2 # numeric<br><br># convert from integer to 
  numeric:<br>a &lt;- as.numeric(x)<br><br># convert from numeric to integer:<br>b 
  &lt;- as.integer(y)<br><br># print values of x and y<br>x<br>y<br><br># print 
  the class name of a and b<br>class(a)<br>
  class(b)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_numbers_convert">Try it Yourself &raquo;</a>
</div>
