...
<h1>R <span class="color_h1">Mean</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="r_stat_max_min.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="r_stat_median.asp">Next &#10095;</a>
</div>
<hr>

<h2>Mean, Median, and Mode</h2>
<p>In statistics, there are often three values that interests us:</p>
<ul>
  <li><strong>Mean</strong> - The average value</li>
  <li><a href="r_stat_median.asp"><strong>Median</strong></a> - The middle value</li>
  <li><a href="r_stat_mode.asp"><strong>Mode</strong></a> - The most common value</li>
</ul>
<hr>

<h2>Mean</h2>
<p>To calculate the average value (mean) of a variable from the <code class="w3-codespan">mtcars</code> data set, find the sum of all values, and divide the sum by the number of values.</p>
...
<p>Luckily for us, the <code class="w3-codespan">mean()</code> function in R can do it for you:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Find the average weight (<code class="w3-codespan">wt</code>) of a car:</p>
<div class="w3-code notranslate pythonHigh">
  Data_Cars &lt;- mtcars<br><br>mean(Data_Cars$wt)</div>
<p>Result:</p>
<div class="w3-black w3-padding">
<code>
[1] 3.21725</code></div>
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryr.asp?filename=demo_stat_mean">Try it Yourself &raquo;</a>
</div>
