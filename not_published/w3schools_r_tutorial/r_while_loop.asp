...
<h1>R <span class="color_h1">While Loop</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="r_if_else_andor.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="r_for_loop.asp">Next &#10095;</a>
</div>
<hr>
...
<p>R has two loop commands:</p>
<ul>
<li><code class="w3-codespan">while</code> loops</li>
<li><code class="w3-codespan">for</code> loops</li>
</ul>
...
<p>With the <code class="w3-codespan">while</code> loop we can execute a set of statements as long as a condition is TRUE:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Print <code class="w3-codespan">i</code> as long as <code class="w3-codespan">i</code> is less than 6:</p>
<div class="w3-code notranslate pythonHigh">
  i &lt;- 1<br>while (i &lt; 6) {<br>&nbsp; print(i)<br>&nbsp; i &lt;- i + 1<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_while_loop">Try it Yourself &raquo;</a>
</div>

<p>In the example above, the loop will continue to produce numbers ranging from 
1 to 5. The loop will stop at 6 because <code class="w3-codespan">6 &lt; 6</code> is FALSE.</p>
<p>The <code class="w3-codespan">while</code> loop requires relevant variables to be ready, in this example we 
need to define an indexing variable, <code class="w3-codespan">i</code>, which we set to 1.</p>
...
<h2>Break</h2>
<p>With the <code class="w3-codespan">break</code> statement, we can stop the loop even if the while condition is TRUE:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Exit the loop if <code class="w3-codespan">i</code> is equal to 4.</p>
<div class="w3-code notranslate pythonHigh">
  i &lt;- 1<br>while (i &lt; 6) {<br>&nbsp; print(i)<br>&nbsp; i &lt;- i + 1<br>&nbsp; if 
  (i == 4) {<br>&nbsp;&nbsp;&nbsp; break<br>&nbsp; }<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_while_loop_break">Try it Yourself &raquo;</a>
</div>
<p>The loop will stop at 3 because we have chosen to finish the loop by using the <code class="w3-codespan">break</code> statement when <code class="w3-codespan">i</code> is equal to 4 (<code class="w3-codespan">i == 4</code>).</p>
<hr>
...
<div class="w3-code notranslate pythonHigh">
  i &lt;- 0<br>while (i &lt; 6) {<br>&nbsp; i &lt;- i + 1<br>&nbsp; if (i == 3) {<br>&nbsp;&nbsp;&nbsp; 
  next<br>&nbsp; }<br>&nbsp; print(i)<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_while_loop_next">Try it Yourself &raquo;</a>
</div>
<p>When the loop passes the value 3, it will skip it and continue to loop.</p>
<hr>

<h2>Yahtzee!</h2>
<h3>If .. Else Combined with a While Loop</h3>
...
<div class="w3-code notranslate pythonHigh">
  dice &lt;- 1<br>while (dice &lt;= 6) {<br>&nbsp; if (dice &lt; 6) {<br>&nbsp;&nbsp;&nbsp; print(&quot;No 
  Yahtzee&quot;)<br>&nbsp; } else {<br>&nbsp;&nbsp;&nbsp; print(&quot;Yahtzee!&quot;)<br>&nbsp; }<br>&nbsp; dice &lt;- dice 
  + 1<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_while_loop_yahtzee">Try it Yourself &raquo;</a>
</div>
<p>If the loop passes the values ranging from 1 to 5, it prints "No Yahtzee". Whenever it passes the value
6, it prints "Yahtzee!".</p>
