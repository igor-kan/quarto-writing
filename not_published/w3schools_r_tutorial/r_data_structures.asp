...
<h1>R <span class="color_h1">Data Structures</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="r_variables_global.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="r_vectors.asp">Next &#10095;</a>
</div>
<hr>

<h2>Data Structures</h2>

<p>Data structures are used to store and organize values.</p>
<p>R provides many built-in data structures. Each is used to handle data in different ways:</p>
<ul>
  <li>Vectors</li>
  <li>Lists</li>
  <li>Matrices</li>
...
<p>We will explore all of them in detail later, but for now, here's a quick introduction to each one.</p>
<hr>
<h2>Vectors</h2>
<p>A vector is the most basic data structure in R. It contains a list of items 
of the same type.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  # Vector of strings<br>fruits &lt;- c(&quot;banana&quot;, &quot;apple&quot;, &quot;orange&quot;)<br><br># Print 
  fruits<br>fruits</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_data_structures_vectors">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Lists</h2>
<p>A list can hold different types of data in one structure. You can combine numbers, strings, vectors, and even other lists.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  # List of strings<br>thislist &lt;- list(&quot;apple&quot;, &quot;banana&quot;, 
  50, 100)<br><br># 
  Print the list<br>thislist</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_data_structures_lists">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Matrices</h2>
<p>A matrix is a 2D data structure where all elements are of the same type. It 
is like a table with rows and columns.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  # Create a matrix<br>thismatrix &lt;- matrix(c(1,2,3,4,5,6), nrow = 3, ncol = 2)<br>
  <br># Print the matrix<br>thismatrix</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_data_structures_matrices">Try it Yourself &raquo;</a>
</div>

<p>Use <code class="w3-codespan">nrow</code> and <code class="w3-codespan">ncol</code> to control the size of the matrix.</p>
...
<h2>Arrays</h2>
<p>An array is like a matrix but can have more than two dimensions. It stores elements of the same type in multiple dimensions.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_data_structures_arrays">Try it Yourself &raquo;</a>
</div>

<p>Arrays are useful for working with 3D or higher-dimensional data.</p>
<hr>

<h2>Data Frames</h2>
<p>A data frame is like a table in a spreadsheet. It can hold different types of data across multiple columns.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  # Create a data frame<br>Data_Frame &lt;- data.frame (<br>&nbsp; Training = 
  c(&quot;Strength&quot;, &quot;Stamina&quot;, &quot;Other&quot;),<br>&nbsp; Pulse = c(100, 150, 120),<br>&nbsp; 
  Duration = c(60, 30, 45)<br>)<br><br># Print the data frame<br>Data_Frame</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_data_structures_df">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Summary</h2>
<div class="w3-responsive">
<table class="ws-table-all w3-bordered">
    <tr>
  ...
  <tr>
    ...
    <td>No</td>
    <td>Grouped mixed data</td>
  </tr>
  <tr>
    <td>Matrix</td>
    <td>2D same-type values</td>
    <td>Yes</td>
    <td>Tables with numeric data</td>
  </tr>
  <tr>
    <td>Array</td>
    <td>Multi-dimensional values</td>
    <td>Yes</td>
    <td>3D or higher-dimensional data</td>
  </tr>
  <tr>
    <td>Data Frame</td>
    <td>Columns of mixed types</td>
    <td>No</td>
    <td>Working with tabular data</td>
  </tr>
</table>
</div>
<p><strong>Next</strong>, let's take a closer look at each data structure in more detail.</p>
