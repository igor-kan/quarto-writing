...
<h1>R <span class="color_h1">Pie Charts</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="r_graph_scatterplot.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="r_graph_bars.asp">Next &#10095;</a>
</div>
<hr>

<h2>Pie Charts</h2>
<p>A pie chart is a circular graphical view of data.</p>

<p>Use the <code class="w3-codespan">pie()</code> function to draw pie charts:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  # Create a vector of pies<br>x &lt;- c(10,20,30,40)<br><br># Display 
  the pie chart<br>pie(x)</div>
<p>Result:</p>
<div class="w3-black w3-padding w3-padding-16">
<img src="r_pie.png">
</div>
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryr.asp?filename=demo_graph_pie">Try it Yourself &raquo;</a>
</div>
<h4>Example Explained</h4>
<p>As you can see the pie chart draws one pie for each value in the vector (in this case
10, 20, 30, 40).</p>
<p>By default, the plotting of the first pie starts from the x-axis and move <strong>counterclockwise</strong>.</p>
<div class="ws-note w3-panel">
<p><strong>Note:</strong> The size of each pie is determined by comparing the value with all the other values, by
...
<h2>Start Angle</h2>
<p>You can change the start angle of the pie chart with the <code class="w3-codespan">init.angle</code> parameter.</p>
<p>The value of <code class="w3-codespan">init.angle</code> is defined with angle in degrees, where default angle is 0.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Start the first pie at 90 degrees:</p>
<div class="w3-code notranslate pythonHigh">
  # Create a vector of pies<br>x &lt;- c(10,20,30,40)<br><br># Display 
  the pie chart and start the first pie at 90 degrees<br>pie(x, init.angle = 90)</div>
<p>Result:</p>
<div class="w3-black w3-padding w3-padding-16">
<img src="r_pie_angle.png">
</div>
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryr.asp?filename=demo_graph_pie_start_angle">Try it Yourself &raquo;</a>
</div>
...
<h2>Labels and Header</h2>
<p>Use the <code class="w3-codespan">label</code> parameter to add a label to the pie chart, 
and use the <code class="w3-codespan">main</code> 
parameter to add a header:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  # Create a vector of pies<br>x &lt;- c(10,20,30,40)<br><br># Create a vector of labels<br>mylabel &lt;- c(&quot;Apples&quot;, 
  &quot;Bananas&quot;, &quot;Cherries&quot;, &quot;Dates&quot;)<br><br># Display 
  the pie chart with labels<br>pie(x, label = mylabel, main = &quot;Fruits&quot;)</div>
<p>Result:</p>
<div class="w3-black w3-padding w3-padding-16">
<img src="r_pie_label.png">
</div>
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryr.asp?filename=demo_graph_pie_labels">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Colors</h2>
<p>You can add a color to each pie with the <code class="w3-codespan">col</code> parameter:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  # Create a vector of colors<br>colors &lt;- c(&quot;blue&quot;, &quot;yellow&quot;, &quot;green&quot;, &quot;black&quot;)<br><br># Display the pie chart 
  with colors<br>pie(x, label = mylabel, main = 
  &quot;Fruits&quot;, col = colors)</div>
<p>Result:</p>
<div class="w3-black w3-padding w3-padding-16">
<img src="r_pie_col.png">
</div>
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryr.asp?filename=demo_graph_pie_col">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Legend</h2>
<p>To add a list of explanation for each pie, use the <code class="w3-codespan">legend()</code> function:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  # Create a vector of labels<br>mylabel &lt;- c(&quot;Apples&quot;, &quot;Bananas&quot;, &quot;Cherries&quot;, 
  &quot;Dates&quot;)<br><br># Create a vector of colors<br>colors &lt;- c(&quot;blue&quot;, &quot;yellow&quot;, 
  &quot;green&quot;, &quot;black&quot;)<br><br># Display the pie chart with 
  colors<br>pie(x, label = mylabel, 
  main = &quot;Pie Chart&quot;, col = colors)<br><br># Display the explanation box<br>
  legend(&quot;bottomright&quot;, mylabel, fill = colors)</div>
<p>Result:</p>
<div class="w3-black w3-padding w3-padding-16">
<img src="r_pie_legend.png">
</div>
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryr.asp?filename=demo_graph_pie_legend">Try it Yourself &raquo;</a>
</div>
<p>The legend can be positioned as either:</p>
<p>
<code class="w3-codespan">bottomright</code>,

<code class="w3-codespan">bottom</code>,

<code class="w3-codespan">bottomleft</code>,

<code class="w3-codespan">left</code>,

<code class="w3-codespan">topleft</code>,

<code class="w3-codespan">top</code>,

<code class="w3-codespan">topright</code>,

<code class="w3-codespan">right</code>,
