...
<html lang="en-US">
<head>
<title>R Join / Concatenate Elements</title>
<meta charset="utf-8">
...
<h1>R <span class="color_h1">Concatenate Elements</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="r_variables.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="r_variables_multiple.asp">Next &#10095;</a>
</div>
<hr>

<h2>Concatenate Elements</h2>

<p>You can also concatenate, or join, two or more elements, by using the <code class="w3-codespan">paste()</code> function.</p>
<p>To combine both text and a variable, R uses comma (<code class="w3-codespan">,</code>):</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  text &lt;- &quot;awesome&quot;<br><br>paste(&quot;R is&quot;, text)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_variables_paste">Try it Yourself &raquo;</a>
</div>
<p>You can also use <code class="w3-codespan">,</code> to add a variable to another variable:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  text1 &lt;- &quot;R is&quot;<br>text2 &lt;- &quot;awesome&quot;<br><br>paste(text1, 
  text2)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_variables_paste2">Try it Yourself &raquo;</a>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  num1 &lt;- 5<br>num2 &lt;- 10<br><br>num1 + num2</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_variables_plus">Try it Yourself &raquo;</a>
</div>

<p>If you try to combine a string (text) and a number, R will give you an error:</p>

<div class="w3-example w3-pale-red">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh w3-border-red">
  num &lt;- 5<br>text &lt;- &quot;Some text&quot;<br><br>num + text</div>
  <p>Result:</p>
<div class="w3-black w3-padding">
<code>Error in num + text : non-numeric argument to binary operator</code>

</div>
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="tryr.asp?filename=demo_variables_plus2">Try it Yourself &raquo;</a>
</div>
<hr>
