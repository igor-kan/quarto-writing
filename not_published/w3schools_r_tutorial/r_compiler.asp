...
<html lang="en-US">
<head>
<title>R Online Compiler (Editor / Interpreter)</title>
<meta charset="utf-8">
...
/* Syntax highlighting */
.r-function { color: #d73a49; }
.r-string   { color: green; }
.r-number   { color: #098658; }
.r-symbol   { color: #000000; }
.r-variable { color: #000000; }
...
body.darktheme .r-function { color: #faca6b; }
body.darktheme .r-string   { color: #c3e88d; }
body.darktheme .r-number   { color: #f78c6c; }
body.darktheme .r-symbol   { color: #f1f1f1; }
body.darktheme .r-variable { color: #f1f1f1; }
...
<h1>R <span class="color_h1">Online Compiler</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="r_examples.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="r_exercises.asp">Next &#10095;</a>
</div>
<hr>

<h2>R Compiler (Editor)</h2>

<p>With our online R compiler, you can edit R code, and view the result in your browser.</p>
...
<div class="compiler-wrapper">
  ...
  <div class="compiler-body">
    ...
    <div class="editor">
<pre>
<span class="r-string">"Hello World!"</span>
<span class="r-number">5</span> <span class="r-symbol">+</span> <span class="r-number">5</span>
</pre>
    </div>
...
[1] 10
  ...
  <div class="compiler-footer">
    <a href="tryr.asp?filename=demo_compiler"
       target="_blank"
       class="ws-btn">
...
<h2>Build and Publish Projects</h2>

<p>If you want to create your own projects and write code online, <a href="/spaces/index.php">W3Schools Spaces</a> gives you an easy place to write, run, manage, and publish code online.</p>

<hr>
<div class="ws-note w3-panel" style="margin-top:20px;">
  <p>If you do not know R, we suggest that you read our <a href="default.asp">R Tutorial</a> from scratch.</p>
</div>
