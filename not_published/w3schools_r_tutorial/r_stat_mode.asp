...
<h1>R <span class="color_h1">Mode</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="r_stat_median.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="r_stat_percentiles.asp">Next &#10095;</a>
</div>
<hr>
...
<p>R does not have a function to calculate the mode. However, we can create our 
own function to find it.</p>

<p>If we take a look at the values of the <code class="w3-codespan">wt</code> variable (from the <code class="w3-codespan">mtcars</code> data set), we will see that the numbers 
<strong>3.440</strong> are often shown:</p>
...
<div class="w3-code notranslate pythonHigh">
  Data_Cars &lt;- mtcars<br><br>sort(Data_Cars$wt)</div>
<p>Result:</p>
...
<p>Instead of counting it ourselves, we can use the following code to find the mode:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  Data_Cars &lt;- mtcars<br><br>names(sort(-table(Data_Cars$wt)))[1]</div>
<p>Result:</p>
<div class="w3-black w3-padding">
<code>
  [1] &quot;3.44&quot;</code></div>
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryr.asp?filename=demo_stat_mode">Try it Yourself &raquo;</a>
</div>

<p>From the example above, we now know that the number that appears the most number of times in mtcars wt variable is <strong>3.44</strong> or <strong>3.440 lbs</strong>.</p>
