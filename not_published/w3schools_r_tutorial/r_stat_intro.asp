...
<h1>R <span class="color_h1">Statistics</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="r_graph_bars.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="r_stat_data_set.asp">Next &#10095;</a>
</div>
<hr>

<h2>Statistics Introduction</h2>
<p>Statistics is the science of analyzing, reviewing and conclude data.</p>

<p>Some basic statistical numbers include:</p>
<ul>
  <li>Mean, median and mode</li>
  <li>Minimum and maximum value</li>
  <li>Percentiles</li>
  <li>Variance and Standard Devation</li>
  <li>Covariance and Correlation</li>
  <li>Probability distributions</li>
</ul>

<p>The R language was developed by two statisticians. It has many built-in functionalities, in addition to
libraries for the exact purpose of statistical analysis.</p>
<p>You will learn about these features, and how to use them in the next chapters.</p>
<p><strong>Tip:</strong> If you are completely new to statistics, and want to learn more about it, visit our <a href="/statistics/index.php">Statistics Tutorial</a>.</p>
