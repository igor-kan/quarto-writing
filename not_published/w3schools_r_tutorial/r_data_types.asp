...
<h1>R <span class="color_h1">Data Types</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="r_variables_name.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="r_numbers.asp">Next &#10095;</a>
</div>
<hr>
...
<p>In R, variables do not need to be declared with any particular type, and can even change type after they
have been set:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  my_var &lt;- 30 # my_var is type of <strong>numeric</strong><br>my_var &lt;- &quot;Sally&quot; 
  # my_var is now of type <strong>character</strong> (aka string)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_variables2">Try it Yourself &raquo;</a>
</div>

<p>R has a variety of data types and object classes. You will learn much more 
about these as you continue to get to know R.</p>
<hr>

<h2>Basic Data Types</h2>

<p>Basic data types in R can be divided into the following types:</p>

<ul>
<li><code class="w3-codespan">numeric</code> - (10.5, 55, 787)</li>
<li><code class="w3-codespan">integer</code> - (1L, 55L, 100L, where the letter &quot;L&quot; declares this as an integer)</li>
<li><code class="w3-codespan">complex</code> - (9 + 3i, where &quot;i&quot; is the imaginary part)</li>
<li><code class="w3-codespan">character</code> (a.k.a. string) - (&quot;k&quot;, &quot;R is exciting&quot;, &quot;FALSE&quot;, &quot;11.5&quot;)</li>
<li><code class="w3-codespan">logical</code> (a.k.a. boolean) - (TRUE or FALSE)</li>
</ul>

<p>We can use the <code class="w3-codespan">class()</code> function to check the data type of a variable:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  # numeric<br>x &lt;- 10.5<br>class(x)<br><br># integer<br>x &lt;- 1000L<br>
  class(x)<br><br># 
  complex<br>x &lt;- 9i + 3<br>class(x)<br>
  <br># character/string<br>x &lt;- &quot;R is exciting&quot;<br>class(x)<br>
  <br># logical/boolean<br>x &lt;- TRUE<br>class(x)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_data_types">Try it Yourself &raquo;</a>
</div>


<div class="ws-note w3-panel">
<p>You will learn much more about the individual data types in the upcoming chapters.</p>
</div>
