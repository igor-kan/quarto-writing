...
<html lang="en-US">
<head>
<title>R Statistics - Max and Min</title>
<meta charset="utf-8">
...
<h1>R <span class="color_h1">Max and Min</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="r_stat_data_set.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="r_stat_mean.asp">Next &#10095;</a>
</div>
<hr>

<h2>Max Min</h2>
<p>In the previous chapter, we introduced the <strong>mtcars</strong> data set. We will continue to use this data set throughout the next pages.</p>
<p>You learned from the <a href="r_math.asp">R Math</a> chapter that R has several built-in math functions. For example, the <code class="w3-codespan">min()</code> and <code class="w3-codespan">max()</code> functions can be used to find the lowest or highest 
value in a set:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Find the largest and smallest value of the variable <code class="w3-codespan">hp</code> (horsepower).</p>

<div class="w3-code notranslate pythonHigh">
  Data_Cars &lt;- mtcars<br><br>max(Data_Cars$hp)<br>
  min(Data_Cars$hp)</div>
<p>Result:</p>
...
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryr.asp?filename=demo_stat_max_min">Try it Yourself &raquo;</a>
</div>
<p>Now we know that the largest horsepower value in the set is <strong>335</strong>, and the lowest <strong>52</strong>.</p>
<p>We could take a look at the data set and try to find out which car these two values belongs to:</p>

<h4>Observation of cars</h4>
<div class="w3-black w3-padding w3-responsive">
...
<span class="w3-red">Honda Civic         30.4   4  75.7  <strong class="w3-yellow">52</strong> 4.93 1.615 18.52  1  1    4    2</span>
...
<span class="w3-red">Maserati Bora       15.0   8 301.0 <strong class="w3-yellow">335</strong> 3.54 3.570 14.60  0  1    5    8</span>
Volvo 142E          21.4   4 121.0 109 4.11 2.780 18.60  1  1    4    2
</pre>
</div>
<p>By observing the table, it looks like the largest hp value belongs to a Maserati Bora, and the lowest belongs to a Honda Civic.</p>
<p>However, it is much easier (and safer) to let R find out this for us.</p>
<p>For example, we can use the <code class="w3-codespan">which.max()</code> and <code class="w3-codespan">which.min()</code> functions to find the index position of the max and min value in the table:</p>
<div class="w3-example">
<h3>Example</h3>

<div class="w3-code notranslate pythonHigh">
  Data_Cars &lt;- mtcars<br><br>which.max(Data_Cars$hp)<br>which.min(Data_Cars$hp)</div>
<p>Result:</p>
<div class="w3-black w3-padding">
<code>
[1] 31<br>
...
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryr.asp?filename=demo_stat_max_min2">Try it Yourself &raquo;</a>
</div>
<p>Or even better, combine <code class="w3-codespan">which.max()</code> and <code class="w3-codespan">which.min()</code> with the <code class="w3-codespan">rownames()</code> function to get the name of the car with the largest and smallest horsepower:</p>
<div class="w3-example">
<h3>Example</h3>

<div class="w3-code notranslate pythonHigh">
  Data_Cars &lt;- mtcars<br><br>
  rownames(Data_Cars)[which.max(Data_Cars$hp)]<br>
  rownames(Data_Cars)[which.min(Data_Cars$hp)]</div>
<p>Result:</p>
<div class="w3-black w3-padding">
<code>
[1] &quot;Maserati Bora&quot;<br>
...
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryr.asp?filename=demo_stat_max_min3">Try it Yourself &raquo;</a>
</div>
<p>Now we know for sure:<br>
<strong>Maserati Bora</strong> is the car with the highest horsepower, and

<strong>Honda Civic</strong> is the car with the lowest horsepower.</p>
...
<h2>Outliers</h2>
<p>Max and min can also be used to detect <strong>outliers</strong>. An outlier is a data point that differs from rest
of the observations.</p>
<p>Example of data points that could have been outliers in the <strong>mtcars</strong> data set:</p>
<ul>
<li>If maximum of forward gears of a car was 11</li>
<li>If minimum of horsepower of a car was 0</li>
<li>If maximum weight of a car was 50 000 lbs</li>
</ul>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="r_stat_data_set.asp">&#10094; Previous</a>
