...
<html lang="en-US">
<head>
<title>R Booleans / Logical Values</title>
<meta charset="utf-8">
...
<h1>R <span class="color_h1">Booleans / Logical Values</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="r_strings_esc.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="r_operators.asp">Next &#10095;</a>
</div>
<hr>

<h2>Booleans (Logical Values)</h2>
<p>In programming, you often need to know if an expression is <strong>true</strong> or <strong>
false</strong>.</p>
<p>You can evaluate any expression in R, and get one of two answers, <code class="w3-codespan">TRUE</code> or <code class="w3-codespan">FALSE</code>.</p>
<p>When you compare two values, the expression is evaluated and R returns the logical answer:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  10 &gt; 9&nbsp;&nbsp;&nbsp; # TRUE because 10 is greater than 9<br>10 == 9&nbsp;&nbsp; 
  # FALSE because 10 is not equal to 9<br>10 &lt; 9&nbsp;&nbsp;&nbsp; # FALSE 
  because 10 is greater than 9</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_booleans">Try it Yourself &raquo;</a>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  a &lt;- 10<br>b &lt;- 9<br><br>a &gt; b</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_booleans_var">Try it Yourself &raquo;</a>
</div>


<p>You can also run a condition in an <code class="w3-codespan">if</code> statement, 
which you will learn much more about in the <a href="r_if_else.asp">if..else</a> chapter.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  a &lt;- 200<br>b &lt;- 33<br><br>if (b &gt; a) {<br>&nbsp; print (&quot;b is greater than 
  a&quot;)<br>} else {<br>&nbsp; print(&quot;b is not greater than a&quot;)<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_booleans_if">Try it Yourself &raquo;</a>
</div>
