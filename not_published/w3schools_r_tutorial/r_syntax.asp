...
<h1>R <span class="color_h1">Syntax</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="r_get_started.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="r_print.asp">Next &#10095;</a>
</div>
<hr>

<h2>Syntax</h2>

<p>To output text in R, use single or double quotes:</p>
...
<p>To output numbers, just type the number (without quotes):</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  5<br>10<br>25</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_syntax_num">Try it Yourself &raquo;</a>
</div>

<p>To do simple calculations, add numbers together:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  5 + 5</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_syntax_add">Try it Yourself &raquo;</a>
</div>
<p>Congratulations! You have now written your first R code.</p>
