...
<h1>R <span class="color_h1">Factors</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="r_data_frames.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="r_graph_plot.asp">Next &#10095;</a>
</div>
<hr>

<h2>Factors</h2>
<p>Factors are used to categorize data. Examples of factors are:</p>
<ul>
<li>Demography: Male/Female</li>
<li>Music: Rock, Pop, Classic, Jazz</li>
<li>Training: Strength, Stamina</li>
</ul>
<p>To create a factor, use the <code class="w3-codespan">factor()</code> function 
and add a vector as argument:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  # Create a factor<br>music_genre &lt;- factor(c(&quot;Jazz&quot;, &quot;Rock&quot;, &quot;Classic&quot;, &quot;Classic&quot;, &quot;Pop&quot;, &quot;Jazz&quot;, 
  &quot;Rock&quot;, &quot;Jazz&quot;))<br><br># Print the factor<br>music_genre</div>
  
  <p>Result:</p>
<div class="w3-black w3-padding">
<pre style="margin-top:6px;margin-bottom:6px">
[1] Jazz    Rock    Classic Classic Pop     Jazz    Rock    Jazz
Levels: Classic Jazz Pop Rock
</pre>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="tryr.asp?filename=demo_factor">Try it Yourself &raquo;</a>
</div>

<p>You can see from the example above that that the factor has four levels (categories): Classic, Jazz, Pop and Rock.</p>
<p>To only print the levels, use the <code class="w3-codespan">levels()</code> function:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  music_genre &lt;- factor(c(&quot;Jazz&quot;, &quot;Rock&quot;, &quot;Classic&quot;, &quot;Classic&quot;, &quot;Pop&quot;, &quot;Jazz&quot;, 
  &quot;Rock&quot;, &quot;Jazz&quot;))<br><br>levels(music_genre)</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="tryr.asp?filename=demo_factor_levels">Try it Yourself &raquo;</a>
</div>

<p>You can also set the levels, by adding the <code class="w3-codespan">levels</code> argument inside the 
<code class="w3-codespan">factor()</code> function:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  music_genre &lt;- factor(c(&quot;Jazz&quot;, &quot;Rock&quot;, &quot;Classic&quot;, &quot;Classic&quot;, &quot;Pop&quot;, &quot;Jazz&quot;, 
  &quot;Rock&quot;, &quot;Jazz&quot;), levels = c(&quot;Classic&quot;, &quot;Jazz&quot;, &quot;Pop&quot;, &quot;Rock&quot;, &quot;Other&quot;))<br>
  <br>levels(music_genre)</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="tryr.asp?filename=demo_factor_levels2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Factor Length</h2>
<p>Use the <code class="w3-codespan">length()</code> function to find out how many items there are in the factor:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  music_genre &lt;- factor(c(&quot;Jazz&quot;, &quot;Rock&quot;, &quot;Classic&quot;, &quot;Classic&quot;, &quot;Pop&quot;, &quot;Jazz&quot;, 
  &quot;Rock&quot;, &quot;Jazz&quot;))<br><br>length(music_genre)</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="tryr.asp?filename=demo_factor_length">Try it Yourself &raquo;</a>
</div>
<hr>
...
<h2>Access Factors</h2>
<p>To access the items in a factor, refer to the index number, using <code class="w3-codespan">[]</code> brackets:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Access the third item:</p>
<div class="w3-code notranslate pythonHigh">
  music_genre &lt;- factor(c(&quot;Jazz&quot;, &quot;Rock&quot;, &quot;Classic&quot;, &quot;Classic&quot;, &quot;Pop&quot;, &quot;Jazz&quot;, 
  &quot;Rock&quot;, &quot;Jazz&quot;))<br><br>music_genre[3]</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="tryr.asp?filename=demo_factor_access">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-example">
<h3>Example</h3>
<p>Change the value of the third item:</p>
<div class="w3-code notranslate pythonHigh">
  music_genre &lt;- factor(c(&quot;Jazz&quot;, &quot;Rock&quot;, &quot;Classic&quot;, &quot;Classic&quot;, &quot;Pop&quot;, &quot;Jazz&quot;, 
  &quot;Rock&quot;, &quot;Jazz&quot;))<br><br>music_genre[3] &lt;- &quot;Pop&quot;<br><br>music_genre[3]</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="tryr.asp?filename=demo_factor_change">Try it Yourself &raquo;</a>
</div>
<p>Note that you cannot change the value of a specific item if it is not already 
specified in the factor. The following example will produce an error:</p>

<div class="w3-example w3-pale-red">
<h3>Example</h3>
<p>Trying to change the value of the third item (&quot;Classic&quot;) to an item that does 
not exist/not predefined (&quot;Opera&quot;):</p>
<div class="w3-code notranslate pythonHigh w3-border-red">
  music_genre &lt;- factor(c(&quot;Jazz&quot;, &quot;Rock&quot;, &quot;Classic&quot;, &quot;Classic&quot;, &quot;Pop&quot;, &quot;Jazz&quot;, 
  &quot;Rock&quot;, &quot;Jazz&quot;))<br><br>music_genre[3] &lt;- &quot;Opera&quot;<br><br>music_genre[3]</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="tryr.asp?filename=demo_factor_change2">Try it Yourself &raquo;</a>
</div>

<p>However, if you have already specified it inside the <code class="w3-codespan">levels</code> argument, it will work:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Change the value of the third item:</p>
<div class="w3-code notranslate pythonHigh">
  ...
  <br>music_genre[3] &lt;- &quot;Opera&quot;<br><br>music_genre[3]<br></div>
...
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="tryr.asp?filename=demo_factor_change3">Try it Yourself &raquo;</a>
</div>
