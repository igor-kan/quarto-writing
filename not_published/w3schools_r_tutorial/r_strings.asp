...
<html lang="en-US">
<head>
<title>R Strings / Characters</title>
<meta charset="utf-8">
...
<h1>R <span class="color_h1">Strings</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="r_math.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="r_strings_esc.asp">Next &#10095;</a>
</div>
<hr>

<h2>String Literals</h2>
<p>Strings are used for storing text.</p>
<p>A string is surrounded by either single quotation marks, or double quotation marks:</p>
<p><code class="w3-codespan">&quot;hello&quot;</code> is the same as 
<code class="w3-codespan">'hello'</code>:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  &quot;hello&quot;<br>'hello'</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_strings">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Assign a String to a Variable</h2>
<p>Assigning a string to a variable is done with the variable followed by the <code class="w3-codespan">&lt;-</code> operator and the string:</p>
<div class="w3-example">
  <h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  str &lt;- &quot;Hello&quot;<br>str # print the value of str</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_strings2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Multiline Strings</h2>
<p>You can assign a multiline string to a variable like this:</p>
<div class="w3-example">
  <h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  str &lt;- &quot;Lorem ipsum dolor sit amet,<br>consectetur adipiscing elit,<br>sed do 
  eiusmod tempor incididunt<br>ut labore et dolore magna aliqua.&quot;<br><br>
  str # print the value of str</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_strings_multi">Try it Yourself &raquo;</a>
</div>
<p>However, note that R will add a "<strong>\n</strong>" at the end of each line break. This is called an escape character, and the <strong>n</strong> character indicates a <strong>new line</strong>.</p>
<p>If you want the line breaks to be inserted at the same position as in the code, use the <code class="w3-codespan">cat()</code> function:</p>
<div class="w3-example">
  <h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  str &lt;- &quot;Lorem ipsum dolor sit amet,<br>consectetur adipiscing elit,<br>sed do 
  eiusmod tempor incididunt<br>ut labore et dolore magna aliqua.&quot;<br><br>cat(str)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_strings_multi2">Try it Yourself &raquo;</a>
</div>
...
<h2>String Length</h2>
<p>There are many useful string functions in R.</p>
<p>For example, to find the number of characters in a string, use the <code class="w3-codespan">nchar()</code> function:</p>
<div class="w3-example">
  <h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  str &lt;- &quot;Hello World!&quot;<br><br>nchar(str)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_strings_nchar">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Check a String</h2>
<p>Use the <code class="w3-codespan">grepl()</code> function to check if a character or a sequence of characters are present in a string:</p>
<div class="w3-example">
  <h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  str &lt;- &quot;Hello World!&quot;<br><br>grepl(&quot;H&quot;, str)<br>grepl(&quot;Hello&quot;, 
  str)<br>grepl(&quot;X&quot;, 
  str)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_strings_grepl">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Combine Two Strings</h2>
<p>Use the <code class="w3-codespan">paste()</code> function to merge/concatenate two strings:</p>
<div class="w3-example">
  <h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  str1 &lt;- &quot;Hello&quot;<br>str2 &lt;- &quot;World&quot;<br><br>
  paste(str1, str2)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_strings_paste">Try it Yourself &raquo;</a>
</div>
<hr>
