...
<html lang="en-US">
<head>
<title>R If...Else Conditions</title>
<meta charset="utf-8">
...
<h1>R <span class="color_h1">If ... Else</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="r_operators.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="r_if_else_nested.asp">Next &#10095;</a>
</div>
<hr>

<h2>Conditions and If Statements</h2>
<p>You already know that R supports familiar comparison conditions from mathematics, such as:</p>
...
<td>Equal</td>
<td>x == y</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryr.asp?filename=demo_oper_compare1">Try it &raquo;</a></td>
</tr>
<tr>
<td>!=</td>
<td>Not equal</td>
<td>x != y</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryr.asp?filename=demo_oper_compare2">Try it &raquo;</a></td>
</tr>
<tr>
<td>&gt;</td>
<td>Greater than</td>
<td>x &gt; y</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryr.asp?filename=demo_oper_compare4">Try it &raquo;</a></td>
</tr>
<tr>
<td>&lt;</td>
<td>Less than</td>
<td>x &lt; y</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryr.asp?filename=demo_oper_compare5">Try it &raquo;</a></td>
</tr>
  <tr>
<td>&gt;=</td>
<td>Greater than or equal to</td>
<td>x &gt;= y</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryr.asp?filename=demo_oper_compare6">Try it &raquo;</a></td>
  </tr>
<tr>
<td>&lt;=</td>
<td>Less than or equal to</td>
<td>x &lt;= y</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryr.asp?filename=demo_oper_compare7">Try it &raquo;</a></td>
</tr>
</table>
</div>
...
<p>An "if statement" is written with the <code class="w3-codespan">if</code> keyword, and it is used to specify a block of code to be executed if a condition is <code class="w3-codespan">TRUE</code>:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  a &lt;- 33<br>b &lt;- 200<br><br>if (b &gt; a) {<br>&nbsp; print(&quot;b is greater than a&quot;)<br>
  }</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_if">Try it Yourself &raquo;</a>
</div>
<p>In this example we use two variables, <span class="w3-codespan">a</span> and <span class="w3-codespan">b</span>,
which are used as a part of the if statement to test whether <span class="w3-codespan">b</span> is greater than <span class="w3-codespan">a</span>.
...
<p>R uses curly brackets { } to define the scope in the code.</p>
</div>
<hr>

<h2>Else If</h2>
<p>The <code class="w3-codespan">else if</code> keyword is R's way of saying "if the previous conditions were not true, then try this
condition":</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  a &lt;- 33<br>b &lt;- 33<br><br>if (b &gt; a) {<br>&nbsp; print(&quot;b is greater than a&quot;)<br>
  } else if (a == b) {<br>&nbsp; print (&quot;a and b are equal&quot;)<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_else_if">Try it Yourself &raquo;</a>
</div>
<p>In this example <code class="w3-codespan">a</code> is equal to <code class="w3-codespan">b</code>, so the first condition is not true, but the <code class="w3-codespan">else if</code> condition is true, so we
print to screen that "a and b are equal".</p>

<p>You can use as many <code class="w3-codespan">else if</code> statements as you want in R.</p>
<hr>

<h2>If Else</h2>
<p>The <code class="w3-codespan">else</code> keyword catches anything which isn't caught by the preceding conditions:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  a &lt;- 200<br>b &lt;- 33<br><br>if (b &gt; a) {<br>&nbsp; print(&quot;b is greater than a&quot;)<br>
  } else if (a == b) {<br>&nbsp; print(&quot;a and b are equal&quot;)<br>} else {<br>&nbsp; 
  print(&quot;a is greater than b&quot;)<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_if_else">Try it Yourself &raquo;</a>
</div>
<p>In this example, <span class="w3-codespan">a</span> is greater than <span class="w3-codespan">b</span>,
so the first condition is not true, also the <span class="w3-codespan">else if</span> condition is not true,
so we go to the <span class="w3-codespan">else</span> condition and print to screen that "a is greater than b".</p>
<p>You can also use <code class="w3-codespan">else</code> without
<code class="w3-codespan">else if</code>:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  a &lt;- 200<br>b &lt;- 33<br><br>if (b &gt; a) {<br>&nbsp; print(&quot;b is greater than a&quot;)<br>
  } else {<br>&nbsp; print(&quot;b is not greater than a&quot;)<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_if_else2">Try it Yourself &raquo;</a>
</div>
<hr>
