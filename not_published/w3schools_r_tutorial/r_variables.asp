...
<h1>R <span class="color_h1">Variables</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="r_comments.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="r_variables_concat.asp">Next &#10095;</a>
</div>
<hr>

<h2>Creating Variables in R</h2>
<p>Variables are containers for storing data values.</p>
<p>R does not have a command for declaring a variable. A variable is created the moment you first assign a value to it. To assign a value to a variable, use the <code class="w3-codespan">&lt;-</code> 
sign. To output (or print) the variable value, just type the variable name:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  name &lt;- &quot;John&quot;<br>age &lt;- 40<br><br>name&nbsp;&nbsp; # output &quot;John&quot;<br>age&nbsp;&nbsp;&nbsp; # output 40</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_variables">Try it Yourself &raquo;</a>
</div>

<p>From the example above, <code class="w3-codespan">name</code> and 
<code class="w3-codespan">age</code> are <strong>variables</strong>, while <code class="w3-codespan">
&quot;John&quot;</code> and <code class="w3-codespan">40</code> are <strong>values</strong>.</p>
<div class="ws-note w3-panel">
<p>In other programming language, it is common to use <code class="w3-codespan">=</code> as an assignment operator. In R, we can use
both <code class="w3-codespan">=</code> and <code class="w3-codespan">&lt;-</code> as assignment operators.</p>

<p>However, <code class="w3-codespan">&lt;-</code> is preferred in most cases because the <code class="w3-codespan">=</code> operator can be forbidden in some contexts in R.</p>
</div>
<!--
<p>Character variables can be declared by either using single or double quotes:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  x &lt;- 'John'<br># is the same as<br><br>x &lt;- &quot;John&quot;<br>print(x)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showkotlin.asp?filename=demo_default">Try it Yourself &raquo;</a>
</div>
-->
<hr>

<h2>Print / Output Variables</h2>
<p>Compared to many other programming languages, you do not have to use a 
function to print/output variables in R. You can just type the name of the 
variable:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  name &lt;- &quot;John Doe&quot;<br><br>name # auto-print the value of the name variable</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_variables_print">Try it Yourself &raquo;</a>
</div>


<p>However, R does have a <code class="w3-codespan">print()</code> function 
available if you want to use it. This might be useful if you are familiar with other programming languages, such as <a href="/python/default.asp">Python</a>, which 
often use a <code class="w3-codespan">print()</code> function to output variables.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  name &lt;- &quot;John Doe&quot;<br><br>print(name) # print the value of the name variable</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_variables_print2">Try it Yourself &raquo;</a>
</div>
<p>And there are times you must use the <code class="w3-codespan">print()</code> function to output code, for example when working with <code class="w3-codespan">for</code> 
loops (which you will learn more about in a later chapter):</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
...
<div class="ws-note w3-panel">
<p><strong>Conclusion:</strong> It is up to your if you want to use the <code class="w3-codespan">print()</code> 
function or not to output code. However, when your code is inside an R expression (for example inside curly braces 
<code class="w3-codespan">{}</code> like in the example above), use the <code class="w3-codespan">print()</code> function if you want to output the result.</p>
</div>
