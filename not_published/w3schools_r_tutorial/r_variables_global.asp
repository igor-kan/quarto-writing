...
<html lang="en-US">
<head>
<title>R Global and Local Variables</title>
<meta charset="utf-8">
...
<h1>R <span class="color_h1">Global Variables</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="r_functions_recursion.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="r_data_structures.asp">Next &#10095;</a>
</div>
<hr>

<h2>Global Variables</h2>
<p>Variables that are created outside of a function are known as 
...
<div class="w3-code notranslate pythonHigh">
  txt &lt;- &quot;awesome&quot;<br>my_function &lt;- function() {<br>&nbsp; paste(&quot;R is&quot;, 
  txt)<br>
  }<br><br>my_function()</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_variables_global">Try it Yourself &raquo;</a>
</div>

<p>If you create a variable with the same name inside a function, this variable will be local, and can only
...
<div class="w3-example">
<h3>Example</h3>
<p>Create a variable inside of a function with the same name as the
global variable:</p>
<div class="w3-code notranslate pythonHigh">
  txt &lt;- &quot;global variable&quot;<br>my_function &lt;- function() {<br>&nbsp; 
  txt = &quot;fantastic&quot;<br>&nbsp; 
  paste(&quot;R is&quot;, txt)<br>}<br><br>my_function()<br><br>txt # print txt</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_variables_global2">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
<p>If you try to print <code class="w3-codespan">txt</code>, it will return "<strong>global variable</strong>" because we are printing 
<code class="w3-codespan">txt</code> outside the function.</p>
</div>
<hr>
...
<h2>The Global Assignment Operator</h2>
<p>Normally, when you create a variable inside a function, that variable is local, and can only be used
inside that function.</p>
<p>To create a global variable inside a function, you can use the <strong>global assignment</strong> operator <code class="w3-codespan">&lt;&lt;-</code></p>

<div class="w3-example">
<h3>Example</h3>
<p>If you use the assignment operator <code class="w3-codespan">&lt;&lt;-</code>, the variable belongs to the global scope:</p>
<div class="w3-code notranslate pythonHigh">
  my_function &lt;- function() {<br>txt &lt;&lt;- &quot;fantastic&quot;<br>&nbsp; paste(&quot;R is&quot;, 
  txt)<br>
  }<br><br>my_function()<br><br>print(txt)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_variables_global3">Try it Yourself &raquo;</a>
</div>

<p>Also, use the <strong>global</strong> assignment operator if you want to 
change a global variable inside a function:</p>

<div class="w3-example">
<h3>Example</h3>
<p>To change the value of a global variable inside a function, refer to the variable by using the global
assignment operator <code class="w3-codespan">&lt;&lt;-</code>:</p>
<div class="w3-code notranslate pythonHigh">
  txt &lt;- &quot;awesome&quot;<br>my_function &lt;- function() {<br>&nbsp; txt &lt;&lt;- &quot;fantastic&quot;<br>&nbsp; 
  paste(&quot;R is&quot;, txt)<br>}<br><br>my_function()<br><br>paste(&quot;R is&quot;, 
  txt)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_variables_global4">Try it Yourself &raquo;</a>
</div>
