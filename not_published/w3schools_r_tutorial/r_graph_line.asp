...
<h1>R <span class="color_h1">Line</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="r_graph_plot.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="r_graph_scatterplot.asp">Next &#10095;</a>
</div>
<hr>

<h2>Line Graphs</h2>
<p>A line graph has a line that connects all the points in a diagram.</p>
<p>To create a line, use the <code class="w3-codespan">plot()</code> function and add the <code class="w3-codespan">type</code> parameter with a value of <code class="w3-codespan">"l"</code>:</p>
...
<h2>Line Color</h2>
<p>The line color is black by default. To change the color, use the <code class="w3-codespan">col</code> parameter:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  plot(1:10, type=&quot;l&quot;, col=&quot;blue&quot;)</div>
<p>Result:</p>
<div class="w3-black w3-padding w3-padding-16">
<img src="r_plot_l_color.png">
</div>
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryr.asp?filename=demo_graph_line_color">Try it Yourself &raquo;</a>
</div>
<hr>
...
<h2>Line Width</h2>
<p>To change the width of the line, use the <code class="w3-codespan">lwd</code> 
parameter (<code class="w3-codespan">1</code> is default, while <code class="w3-codespan">0.5</code> means 50% smaller, and 
<code class="w3-codespan">2</code> means 100% larger):</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  plot(1:10, type=&quot;l&quot;, lwd=2)</div>
<p>Result:</p>
<div class="w3-black w3-padding w3-padding-16">
<img src="r_plot_l_width.png">
</div>
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryr.asp?filename=demo_graph_line_width">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Line Styles</h2>
<p>The line is solid by default. Use the <code class="w3-codespan">lty</code> parameter with a value from 
<strong>0 to 6</strong> to specify the line format.</p>
<p>For example, <code class="w3-codespan">lty=3</code> will display a dotted line instead of a solid line:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  plot(1:10, type=&quot;l&quot;, lwd=5, lty=3)</div>
<p>Result:</p>
<div class="w3-black w3-padding w3-padding-16">
<img src="r_plot_dotted.png">
</div>
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryr.asp?filename=demo_graph_line_dotted">Try it Yourself &raquo;</a>
</div>

<p>Available parameter values for <code class="w3-codespan">lty</code>:</p>
<ul>
<li><code class="w3-codespan">0</code> removes the line</li>
<li><code class="w3-codespan">1</code> displays a solid line</li>
<li><code class="w3-codespan">2</code> displays a dashed line</li>
<li><code class="w3-codespan">3</code> displays a dotted line</li>
<li><code class="w3-codespan">4</code> displays a "dot dashed" line</li>
<li><code class="w3-codespan">5</code> displays a "long dashed" line</li>
<li><code class="w3-codespan">6</code> displays a "two dashed" line</li>
</ul>
<hr>


<h2>Multiple Lines</h2>
<p>To display more than one line in a graph, use the <code class="w3-codespan">plot()</code> function together with the 
<code class="w3-codespan">lines()</code> function:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  line1 &lt;- c(1,2,3,4,5,10)<br>line2 &lt;- c(2,5,7,8,9,10)<br><br>plot(line1, 
  type = &quot;l&quot;, col = &quot;blue&quot;)<br>lines(line2, type=&quot;l&quot;, col = &quot;red&quot;)</div>
<p>Result:</p>
<div class="w3-black w3-padding w3-padding-16">
<img src="r_plot_multi.png">
</div>
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryr.asp?filename=demo_graph_line_multi">Try it Yourself &raquo;</a>
</div>
<br>
