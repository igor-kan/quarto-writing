...
<html lang="en-US">
<head>
<title>R Graphics - Scatter Plot</title>
<meta charset="utf-8">
...
<h1>R <span class="color_h1">Scatter Plot</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="r_graph_line.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="r_graph_pie.asp">Next &#10095;</a>
</div>
<hr>

<h2>Scatter Plots</h2>
<p>You learned from the <a href="r_graph_plot.asp">Plot chapter</a> that the <code class="w3-codespan">plot()</code> function is used to plot 
numbers against each other.</p>
<p>A "scatter plot" is a type of plot used to display the relationship between two numerical 
variables, and plots one dot for each observation.</p>

<p>It needs two vectors of same 
length, one for the x-axis (horizontal) and one for the y-axis (vertical):</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  x &lt;- c(5,7,8,7,2,2,9,4,11,12,9,6)<br>y &lt;- 
  c(99,86,87,88,111,103,87,94,78,77,85,86)<br><br>plot(x, y)</div>
<p>Result:</p>
<div class="w3-black w3-padding w3-padding-16">
<img src="r_scatterplot.png">

</div>
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryr.asp?filename=demo_graph_scatterplot">Try it Yourself &raquo;</a>
</div>

<p>The observation in the example above should show the result of 12 cars passing by.</p>
<p>That might not be clear for someone who sees the graph for the first time, so let's add a header and 
different labels to describe the scatter plot better:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  x &lt;- c(5,7,8,7,2,2,9,4,11,12,9,6)<br>y &lt;- 
  c(99,86,87,88,111,103,87,94,78,77,85,86)<br><br>plot(x, y, main="Observation 
  of Cars", xlab="Car age", ylab="Car speed")</div>
<p>Result:</p>
<div class="w3-black w3-padding w3-padding-16">
<img src="r_scatterplot_car.png">

</div>
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryr.asp?filename=demo_graph_scatterplot_cars">Try it Yourself &raquo;</a>
</div>

<p>To recap, the observation in the example above is the result of 12 cars passing by.</p>

<p>The <strong>x-axis</strong> shows how old the car is.</p>

<p>The <strong>y-axis</strong> shows the speed of the car when it passes.</p>

<p>Are there any relationships between the observations?</p>

<p>It seems that the newer the car, the faster it drives, but that could be a coincidence, after all we only registered 12 cars.</p>
<hr>
...
<h2>Compare Plots</h2>
<p>In the example above, there seems to be a relationship between the car speed and age, but what if we plot the observations from another day as well? Will the scatter plot tell us something else?</p>
<p>To compare the plot with another plot, use the <code class="w3-codespan">points()</code> function:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Draw two plots on the same figure:</p>
<div class="w3-code notranslate pythonHigh">
  # day one, the age and speed of 12 cars:<br>x1 &lt;- c(5,7,8,7,2,2,9,4,11,12,9,6)<br>y1 &lt;- c(99,86,87,88,111,103,87,94,78,77,85,86)<br>
  <br># day two, the age and speed of 15 cars:<br>x2 &lt;- 
  c(2,2,8,1,15,8,12,9,7,3,11,4,7,14,12)<br>y2 &lt;- 
  c(100,105,84,105,90,99,90,95,94,100,79,112,91,80,85)<br><br>plot(x1, y1, 
  main=&quot;Observation of Cars&quot;, xlab=&quot;Car age&quot;, ylab=&quot;Car speed&quot;, col=&quot;red&quot;, 
  cex=2)<br>points(x2, y2, col=&quot;blue&quot;, cex=2)</div>
<p>Result:</p>
<div class="w3-black w3-padding w3-padding-16">
<img src="r_scatterplot_car2.png">

</div>
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryr.asp?filename=demo_graph_scatterplot_cars2">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
<p><strong>Note:</strong> To be able to see the difference of the comparison, you must assign different colors to the plots (by using the <code class="w3-codespan">col</code> parameter). <span style="color:red">Red</span> represents the values of day 1, while <span style="color:blue">blue</span> represents day 2.  Note that we have also added the <code class="w3-codespan">cex</code> parameter to increase the size of the dots.</p>
</div>

<p><strong>Conclusion of observation:</strong> By comparing the two plots, I think it is safe to say that they both gives us the same conclusion: the newer the car, the faster it drives.</p>
<hr>
...
<p>In the example below, we will continue to use the <a href="r_stat_data_set.asp">mtcars data set from the statistics chapter</a>, to create a scatter plot of <strong>weight</strong> (<code class="w3-codespan">wt</code>) and <strong>horsepower</strong> (<code class="w3-codespan">hp</code>) by using the <code class="w3-codespan">plot(x, 
y)</code> function:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  Data_Cars &lt;- mtcars<br><br>plot(Data_Cars$wt, Data_Cars$hp)</div>
<p>Result:</p>
<div class="w3-black w3-padding w3-padding-16">
<img src="r_scatterplot1.png">
...
<p>The x-axis shows the weight of a car, while the y-axis shows the horsepower of a car.</p>
<div class="ws-note w3-panel"><strong>Note:</strong> This is also a graphical representation of the <strong>correlation </strong>between Horsepower and Weight.</div>
<hr>

<h2>Customized Scatterplot</h2>
<p>The <code class="w3-codespan">plot()</code> function also accept other parameters, 
such as <code class="w3-codespan">main</code>, <code class="w3-codespan">xlab</code> and <code class="w3-codespan">ylab</code> 
if you want to customize the graph with a main title, different labels for the x and y-axis, 
and a specified color for the dots:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  Data_Cars &lt;- mtcars<br><br>plot(Data_Cars$wt, Data_Cars$hp, main = 
  &quot;HP vs. Weight&quot;, xlab = &quot;Weight&quot;, ylab = &quot;Horsepower&quot;, 
  col = &quot;red&quot;)</div>
<p>Result:</p>
<div class="w3-black w3-padding w3-padding-16">
<img src="r_scatterplot2.png">

</div>
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryr.asp?filename=demo_graph_scatterplot2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Compare Plots</h2>

<p>You can use the <code class="w3-codespan">points()</code> function to compare the existing plot with another plot:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Compare the existing plot of weight and horsepower with another plot of weight and horsepower:</p>
<div class="w3-code notranslate pythonHigh">
  Data_Cars &lt;- mtcars<br><br># Custom Weight and Horsepower<br>Weight &lt;- c(2,2,3,3,4,4,5,5)<br>Horsepower &lt;- 
  c(100,120,130,140,150,160,170,180)<br><br># Weight and Horsepower from the 
  mtcars data set<br>plot(Data_Cars$wt, Data_Cars$hp, 
  main = &quot;HP vs. Weight&quot;, xlab = &quot;Weight&quot;, ylab = &quot;Horsepower&quot;, col = &quot;red&quot;)<br>
  <br>points(Weight, Horsepower, col = &quot;blue&quot;)</div>
<p>Result:</p>
<div class="w3-black w3-padding w3-padding-16">
<img src="r_scatterplot_points.png">

</div>
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryr.asp?filename=demo_graph_scatterplot_points">Try it Yourself &raquo;</a>
</div>
<p><strong>Note:</strong> To view the difference between the two plots, remember to assign different colors to them (<span style="color:red">red</span> represents hp and weight from the mtcars data set, while <span style="color:blue">blue</span> represents the other plot).</p>
-->
