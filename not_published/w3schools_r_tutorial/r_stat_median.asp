...
<html lang="en-US">
<head>
<title>R Statistics - Median</title>
<meta charset="utf-8">
...
<h1>R <span class="color_h1">Median</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="r_stat_mean.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="r_stat_mode.asp">Next &#10095;</a>
</div>
<hr>
...
<p>
If we take a look at the values of the <code class="w3-codespan">wt</code> variable (from the <code class="w3-codespan">mtcars</code> data set), we will see that there are two numbers in the middle:
</p>

<div class="w3-responsive">
<h4>Sorted observation of wt (weight)</h4>
  <table class="ws-table-all">
    ...
    <tr>
      ...
      <td>3.170</td>
      <td>3.190</td>
      <td class="w3-red">3.215</td>
    </tr>
    <tr>
      <td class="w3-red">3.435</td>
      <td>3.440</td>
      <td>3.440</td>
      <td>3.440</td>
      <td>3.460</td>
...
<p><strong>Note:</strong> If there are two numbers in the middle, you must divide the sum of those numbers by two, to find the median.</p>

<!--
<div class="ws-note w3-panel">
<p>It would be extremely time-consuming to find the median of a large data set 
(for example with over 1000+ observations). From the example above, we must first sort the wt variable, and then find the number(s) in the middle. As it is two numbers 
here, we must divide the sum of those numbers by two: 3215 + 3435 = <strong>6650</strong>. 6650 / 2 = 
<strong>3325</strong>.</p>
</div>
-->

<p>Luckily, R has a function that does all of that for you: Just use the <code class="w3-codespan">median()</code> 
function to find the middle value:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Find the mid point value of weight (<code class="w3-codespan">wt</code>):</p>
<div class="w3-code notranslate pythonHigh">
  Data_Cars &lt;- mtcars<br><br>median(Data_Cars$wt)</div>
<p>Result:</p>
<div class="w3-black w3-padding">
<code>
  [1] 3.325</code></div>
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryr.asp?filename=demo_stat_median">Try it Yourself &raquo;</a>
</div>
