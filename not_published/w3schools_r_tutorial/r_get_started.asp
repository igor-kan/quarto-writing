...
<h1>R <span class="color_h1">Get Started</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="r_intro.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="r_syntax.asp">Next &#10095;</a>
</div>
<hr>

<h2>How to Install R</h2>
<p>To install R, go to <a href="https://cloud.r-project.org/" target="_blank">https://cloud.r-project.org/</a> and download the latest version of R for Windows, Mac or Linux.</p>
<p>When you have downloaded and installed R, you can run R on your computer.</p>
<p>The screenshot below shows how it may look like when you run R on a Windows 
PC:</p>
<img src="R_img.jpg" style="max-width:100%;">
<p>If you type <code class="w3-codespan">5 + 5</code>, and press enter, you will see that R outputs <code class="w3-codespan">10</code>.</p>
<hr>

<h2>Learning R at W3Schools</h2>
<p>When learning R at W3Schools.com, you can use our "Try it Yourself" tool, which shows both the code and the result 
in your browser. This will make it easier for you to test and understand every part as we move forward:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="tryr.asp?filename=demo_get_started1">Try it Yourself &raquo;</a>
</div>
