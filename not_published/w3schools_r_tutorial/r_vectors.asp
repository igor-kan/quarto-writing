...
<h1>R <span class="color_h1">Vectors</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="r_data_structures.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="r_lists.asp">Next &#10095;</a>
</div>
<hr>

<h2>Vectors</h2>
<p>A vector is simply a list of items that are of the same type.</p>
<p>To combine the list of items to a vector, use the <code class="w3-codespan">c()</code> function and separate the items by a comma.</p>
<p>In the example below, we create a vector variable called <strong>fruits</strong>, 
...
<div class="w3-code notranslate pythonHigh">
  ...
  <br># Print fruits<br>fruits</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_vector_strings">Try it Yourself &raquo;</a>
</div>

<p>In this example, we create a vector that combines numerical values:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  # Vector of numerical 
  values <br>numbers &lt;- c(1, 2, 3)<br><br># Print numbers<br>
  numbers</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_vector_num">Try it Yourself &raquo;</a>
</div>

<p>To create a vector with numerical values in a sequence, use the <code class="w3-codespan">:</code> operator:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  # Vector with numerical values in a sequence<br>numbers &lt;- 
  1:10<br><br>numbers</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_vector_colon">Try it Yourself &raquo;</a>
</div>

<p>You can also create numerical values with decimals in a sequence, but note that if the last element does not belong to the sequence, it is not used:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  # Vector with numerical 
  decimals in a sequence<br>numbers1 &lt;- 
  1.5:6.5<br>numbers1<br><br># Vector with numerical 
  decimals in a sequence where the last element is not used<br>numbers2 &lt;- 
  1.5:6.3<br>numbers2</div>
<p>Result:</p>
<div class="w3-black w3-padding">
  <code>
  [1] 1.5 2.5 3.5 4.5 5.5 6.5<br>[1] 1.5 2.5 3.5 4.5 5.5</code></div>
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="tryr.asp?filename=demo_vector_colon2">Try it Yourself &raquo;</a>
</div>

<p>In the example below, we create a vector of logical values:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  # Vector of logical values<br>log_values &lt;- 
  c(TRUE, FALSE, TRUE, FALSE)<br><br>log_values<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_vector_logical">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Vector Length</h2>
<p>To find out how many items a vector has, use the <code class="w3-codespan">length()</code> function:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  fruits &lt;- c(&quot;banana&quot;, &quot;apple&quot;, &quot;orange&quot;)<br><br>length(fruits)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_vector_length">Try it Yourself &raquo;</a>
</div>
<hr>
...
<h2>Sort a Vector</h2>
<p>To sort items in a vector alphabetically or numerically, use the <code class="w3-codespan">sort()</code> function:</p>
<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate pythonHigh">
    fruits &lt;- c(&quot;banana&quot;, &quot;apple&quot;, &quot;orange&quot;, &quot;mango&quot;, &quot;lemon&quot;)<br>numbers &lt;- c(13, 3, 5, 7, 20, 2)<br><br>sort(fruits)&nbsp;
  # Sort a string<br>
  sort(numbers) # Sort numbers</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_vector_sort">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Access Vectors</h2>
<p>You can access the vector items by referring to its index number inside brackets <code class="w3-codespan">[]</code>. The first item has index 1, the second item has index 2, and so on:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  fruits &lt;- c(&quot;banana&quot;, &quot;apple&quot;, &quot;orange&quot;)<br>
  <br># Access the first item (banana)<br>fruits[1]</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_vector_access">Try it Yourself &raquo;</a>
</div>

<p>You can also access multiple elements by referring to different index 
positions with the <code class="w3-codespan">c()</code> function:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  fruits &lt;- c(&quot;banana&quot;, &quot;apple&quot;, &quot;orange&quot;, 
  &quot;mango&quot;, &quot;lemon&quot;)<br><br># Access the first and third item 
  (banana and orange)<br>fruits[c(1, 3)]</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_vector_access2">Try it Yourself &raquo;</a>
</div>

<p>You can also use negative index numbers to access all items except the ones specified:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  fruits &lt;- c(&quot;banana&quot;, &quot;apple&quot;, &quot;orange&quot;, &quot;mango&quot;, &quot;lemon&quot;)<br><br># Access all 
  items except for the first item<br>fruits[c(-1)]</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_vector_access3">Try it Yourself &raquo;</a>
</div>
<hr>
...
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  fruits &lt;- c(&quot;banana&quot;, &quot;apple&quot;, &quot;orange&quot;, &quot;mango&quot;, &quot;lemon&quot;)<br><br># Change 
  &quot;banana&quot; to &quot;pear&quot;<br>
  fruits[1] &lt;- &quot;pear&quot;<br><br># Print fruits<br>fruits </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_vector_modify">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Repeat Vectors</h2>
<p>To repeat vectors, use the <code class="w3-codespan">rep()</code> function:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Repeat each value:</p>
<div class="w3-code notranslate pythonHigh">
  repeat_each &lt;- rep(c(1,2,3), each = 3)<br><br>repeat_each</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_vector_repeat">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Repeat the sequence of the vector:</p>
<div class="w3-code notranslate pythonHigh">
  repeat_times &lt;- rep(c(1,2,3), times = 3)<br><br>repeat_times</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_vector_repeat2">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Repeat each value independently:</p>
<div class="w3-code notranslate pythonHigh">
  repeat_indepent &lt;- rep(c(1,2,3), times = c(5,2,1))<br><br>repeat_indepent</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_vector_repeat3">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Generating Sequenced Vectors</h2>
<p>One of the examples on top, showed you how to create a vector with numerical values in a sequence with the <code class="w3-codespan">:</code> operator:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  numbers &lt;- 
...
<p>To make bigger or smaller steps in a sequence, use the <code class="w3-codespan">seq()</code> function:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  numbers &lt;- seq(from = 0, to = 100, by = 20)<br><br>numbers</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_vector_seq">Try it Yourself &raquo;</a>
</div>
<p><strong>Note:</strong> The <code class="w3-codespan">seq()</code> function has three parameters: <code class="w3-codespan">from</code> is where the sequence starts, <code class="w3-codespan">to</code> is where the sequence stops, and <code class="w3-codespan">by</code> is the interval of the
sequence.</p>
