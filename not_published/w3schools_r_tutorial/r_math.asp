...
<h1>R <span class="color_h1">Math</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="r_numbers.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="r_strings.asp">Next &#10095;</a>
</div>
<hr>

<h2>Simple Math</h2>
<p>In R, you can use <strong>operators</strong> to perform common mathematical operations on numbers.</p>
<p>The <code class="w3-codespan">+</code> operator is used to add together two values:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  10 + 5</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_math_oper1">Try it Yourself &raquo;</a>
</div>

<p>And the <code class="w3-codespan">-</code> operator is used for subtraction:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  10 - 5</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_math_oper2">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
<p>You will learn more about available operators in our <a href="r_operators.asp">R Operators Tutorial</a>.</p>
</div>

<hr>

<h2>Built-in Math Functions</h2>
<p>R also has many built-in math functions that allows you to perform mathematical tasks on numbers.</p>

<p>For example, the <code class="w3-codespan">min()</code> and <code class="w3-codespan">max()</code> functions can be used to find the lowest or highest 
number in a set:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  max(5, 10, 15)<br><br>min(5, 10, 15)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_math_max_min">Try it Yourself &raquo;</a>
</div>
<hr>
...
<h2>sqrt()</h2>
<p>The <code class="w3-codespan">sqrt()</code> function returns the square root of 
a number:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  sqrt(16)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_math_sqrt">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>abs()</h2>
<p>The <code class="w3-codespan">abs()</code> function returns the absolute (positive) value of 
a number:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  abs(-4.7)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_math_abs">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>ceiling() and floor()</h2>
<p>The <code class="w3-codespan">ceiling()</code> function rounds a number upwards to 
its nearest integer, and the <code class="w3-codespan">floor()</code> 
function rounds a number downwards to its nearest integer, and returns the result:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  ceiling(1.4)<br><br>floor(1.4)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_math_ceiling_floor">Try it Yourself &raquo;</a>
</div>
