...
<h1>R <span class="color_h1">Comments</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="r_print.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="r_variables.asp">Next &#10095;</a>
</div>
<hr>

<h2>Comments</h2>
<p>Comments can be used to explain R code, and to make it more readable. It can also be used to 
prevent execution when testing alternative code.</p>
<p>Comments starts with a <code class="w3-codespan">#</code>. When executing code, R will ignore anything 
that starts with <code class="w3-codespan">#</code>.</p>
<p>This example uses a comment before a line of code:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  # This is a comment<br>&quot;Hello World!&quot;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_comments">Try it Yourself &raquo;</a>
</div>

<p>This example uses a comment at the end of a line of code:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_comments2">Try it Yourself &raquo;</a>
</div>

<p>Comments does not have to be text to explain the code, it can also be used to prevent R from
executing the code:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  # &quot;Good morning!&quot;<br>&quot;Good night!&quot;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_comments3">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Multiline Comments</h2>
<p>Unlike other programming languages, such as <a href="/java/java_comments.asp">Java</a>, there are no syntax in R for multiline comments. However, we can just insert a <code class="w3-codespan">#</code> for each line 
to create multiline comments:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  # This is a comment<br># written in<br># more than just one line<br>
  &quot;Hello World!&quot;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_comments4">Try it Yourself &raquo;</a>
</div>
