...
<h1>R <span class="color_h1">Data Frames</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="r_arrays.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="r_factors.asp">Next &#10095;</a>
</div>
<hr>

<h2>Data Frames</h2>
<p>Data Frames are data displayed in a format as a table.</p>

<p>Data Frames can have different types of data inside it. While the first column can be <code class="w3-codespan">character</code>, the
second and third can be <code class="w3-codespan">numeric</code> or <code class="w3-codespan">logical</code>. However, each column should have the same type of
data.</p>

<p>Use the <code class="w3-codespan">data.frame()</code> function to create a data frame:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  # Create a data frame<br>Data_Frame &lt;- data.frame (<br>&nbsp; Training = c(&quot;Strength&quot;, &quot;Stamina&quot;, 
  &quot;Other&quot;),<br>&nbsp; Pulse = c(100, 150, 120),<br>&nbsp; Duration = c(60, 30, 
  45)<br>)<br><br># Print the data frame<br>Data_Frame</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_data_frames">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Summarize the Data</h2>
<p>Use the <code class="w3-codespan">summary()</code> function to summarize the data from a Data Frame:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  Data_Frame &lt;- data.frame (<br>&nbsp; Training = c(&quot;Strength&quot;, &quot;Stamina&quot;, 
  &quot;Other&quot;),<br>&nbsp; Pulse = c(100, 150, 120),<br>&nbsp; Duration = c(60, 30, 
  45)<br>)<br><br>Data_Frame<br><br>summary(Data_Frame)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_data_frames_summary">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
<p>You will learn more about the <code class="w3-codespan">summary()</code> function in the statistical part of the R tutorial.</p>
</div>
<hr>

<h2>Access Items</h2>
<p>We can use single brackets <code class="w3-codespan">[ ]</code>, double 
brackets <code class="w3-codespan">[[ ]]</code> or <code class="w3-codespan">$</code> 
to access columns from a data frame:</p>
...
<div class="w3-code notranslate pythonHigh">
  Data_Frame &lt;- data.frame (<br>&nbsp; Training = c(&quot;Strength&quot;, &quot;Stamina&quot;, 
  &quot;Other&quot;),<br>&nbsp; Pulse = c(100, 150, 120),<br>&nbsp; Duration = c(60, 30, 
  45)<br>)<br><br>Data_Frame[1]<br>
  <br>Data_Frame[[&quot;Training&quot;]]<br><br>Data_Frame$Training</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_data_frames_access">Try it Yourself &raquo;</a>
</div>
<hr>
...
<h2>Add Rows</h2>
<p>Use the <code class="w3-codespan">rbind()</code> function to add new rows in 
a Data Frame:</p>
...
<div class="w3-code notranslate pythonHigh">
  Data_Frame &lt;- data.frame (<br>&nbsp; Training = c(&quot;Strength&quot;, &quot;Stamina&quot;, 
  &quot;Other&quot;),<br>&nbsp; Pulse = c(100, 150, 120),<br>&nbsp; Duration = c(60, 30, 
  45)<br>)<br><br># Add a new row<br>New_row_DF &lt;- rbind(Data_Frame, c(&quot;Strength&quot;, 
  110, 110))<br><br># Print the new row<br>New_row_DF</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_data_frames_add_rows">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Add Columns</h2>
<p>Use the <code class="w3-codespan">cbind()</code> function to add new columns 
in a Data Frame:</p>
...
<div class="w3-code notranslate pythonHigh">
  Data_Frame &lt;- data.frame (<br>&nbsp; Training = c(&quot;Strength&quot;, &quot;Stamina&quot;, 
  &quot;Other&quot;),<br>&nbsp; Pulse = c(100, 150, 120),<br>&nbsp; Duration = c(60, 30, 
  45)<br>)<br><br># Add a new column<br>New_col_DF &lt;- cbind(Data_Frame, Steps = 
  c(1000, 6000, 2000))<br><br># Print the new column<br>New_col_DF</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_data_frames_add_cols">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Remove Rows and Columns</h2>
<p>Use the <code class="w3-codespan">c()</code> function to remove rows and columns in a Data Frame:</p>
...
<div class="w3-code notranslate pythonHigh">
  Data_Frame &lt;- data.frame (<br>&nbsp; Training = c(&quot;Strength&quot;, &quot;Stamina&quot;, 
  &quot;Other&quot;),<br>&nbsp; Pulse = c(100, 150, 120),<br>&nbsp; Duration = c(60, 30, 
  45)<br>)<br><br># Remove the first row and column<br>Data_Frame_New &lt;- 
  Data_Frame[-c(1), -c(1)]<br><br># Print the new data frame<br>Data_Frame_New</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_data_frames_remove">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Amount of Rows and Columns</h2>
<p>Use the <code class="w3-codespan">dim()</code> function to find the amount of rows and columns in a Data Frame:</p>
...
<div class="w3-code notranslate pythonHigh">
  Data_Frame &lt;- data.frame (<br>&nbsp; Training = c(&quot;Strength&quot;, &quot;Stamina&quot;, 
  &quot;Other&quot;),<br>&nbsp; Pulse = c(100, 150, 120),<br>&nbsp; Duration = c(60, 30, 
  45)<br>)<br><br>dim(Data_Frame)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_data_frames_dim">Try it Yourself &raquo;</a>
</div>

<p>You can also use the <code class="w3-codespan">ncol()</code> function to find the number of columns and <code class="w3-codespan">nrow()</code> to find the number of rows:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  Data_Frame &lt;- data.frame (<br>&nbsp; Training = c(&quot;Strength&quot;, &quot;Stamina&quot;, 
  &quot;Other&quot;),<br>&nbsp; Pulse = c(100, 150, 120),<br>&nbsp; Duration = c(60, 30, 
  45)<br>)<br><br>ncol(Data_Frame)<br>nrow(Data_Frame)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_data_frames_ncol_nrow">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Data Frame Length</h2>
<p>Use the <code class="w3-codespan">length()</code> function to find the number of columns in a Data Frame (similar to <code class="w3-codespan">ncol()</code>):</p>
...
<div class="w3-code notranslate pythonHigh">
  Data_Frame &lt;- data.frame (<br>&nbsp; Training = c(&quot;Strength&quot;, &quot;Stamina&quot;, 
  &quot;Other&quot;),<br>&nbsp; Pulse = c(100, 150, 120),<br>&nbsp; Duration = c(60, 30, 
  45)<br>)<br><br>length(Data_Frame)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_data_frames_length">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Combining Data Frames</h2>
<p>Use the <code class="w3-codespan">rbind()</code> function to combine two or more data frames in R vertically:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  Data_Frame1 &lt;- data.frame (<br>&nbsp; Training = c(&quot;Strength&quot;, &quot;Stamina&quot;, 
  &quot;Other&quot;),<br>&nbsp; Pulse = c(100, 150, 120),<br>&nbsp; Duration = c(60, 30, 
  45)<br>)<br><br>Data_Frame2 &lt;- data.frame (<br>&nbsp; Training = c(&quot;Stamina&quot;, 
  &quot;Stamina&quot;, &quot;Strength&quot;),<br>&nbsp; Pulse = c(140, 150, 160),<br>&nbsp; Duration = 
  c(30, 30, 20)<br>)<br><br>New_Data_Frame &lt;- rbind(Data_Frame1, Data_Frame2)<br>
  New_Data_Frame</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_data_frames_combine">Try it Yourself &raquo;</a>
</div>

<p>And use the <code class="w3-codespan">cbind()</code> function to combine two or more data frames in R horizontally:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  Data_Frame3 &lt;- data.frame (<br>&nbsp; Training = c(&quot;Strength&quot;, &quot;Stamina&quot;, 
  &quot;Other&quot;),<br>&nbsp; Pulse = c(100, 150, 120),<br>&nbsp; Duration = c(60, 30, 
  45)<br>)<br><br>Data_Frame4 &lt;- data.frame (<br>&nbsp; Steps = c(3000, 6000, 
  2000),<br>&nbsp; Calories = c(300, 400, 300)<br>)<br><br>New_Data_Frame1 &lt;- 
  cbind(Data_Frame3, Data_Frame4)<br>New_Data_Frame1</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_data_frames_combine2">Try it Yourself &raquo;</a>
</div>
