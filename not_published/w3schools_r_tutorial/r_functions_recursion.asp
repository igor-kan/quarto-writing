...
<html lang="en-US">
<head>
<title>R Function Recursion</title>
<meta charset="utf-8">
...
<h1>R <span class="color_h1">Function Recursion</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="r_functions_nested.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="r_variables_global.asp">Next &#10095;</a>
</div>
<hr>

<h2>Recursion</h2>
<p>R also accepts function recursion, which means a defined function can call itself.</p>

<p>Recursion is a common mathematical and programming concept. It means that a function calls itself.
This has the benefit of meaning that you can loop through data to reach a result.</p>

<p>The developer should be very careful with recursion as it can be quite easy to slip into writing a
...
<p>In this example, <code class="w3-codespan">tri_recursion()</code> is a function that we have defined to call itself ("recurse"). We use the
<code class="w3-codespan">k</code> variable as the data, which decrements (<code class="w3-codespan">-1</code>) every time we recurse. The recursion ends when the
condition is not greater than 0 (i.e. when it is 0).</p>

<p>To a new developer it can take some time to work out how exactly this works, best way to find out is
by testing and modifying it.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  tri_recursion &lt;- function(k) {<br>&nbsp; if (k &gt; 0) {<br>&nbsp;&nbsp;&nbsp; 
  result &lt;- k + tri_recursion(k - 1)<br>&nbsp;&nbsp;&nbsp; print(result)<br>&nbsp; 
  } else {<br>&nbsp;&nbsp;&nbsp; result = 0<br>&nbsp;&nbsp;&nbsp; return(result)<br>&nbsp; 
  }<br>}<br>tri_recursion(6)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_function_recursion">Try it Yourself &raquo;</a>
</div>
