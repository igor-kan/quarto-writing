...
<h1>R <span class="color_h1">Examples</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="r_exam.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="r_compiler.asp">Next &#10095;</a>
</div>
<hr>

<h2>R Syntax</h2>
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="tryr.asp?filename=demo_syntax_str">
Output some text</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_syntax_num">
Output numbers</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_syntax_add">
Do a simple calculation</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_syntax_print">
Output some text with the print() function</a>

</div>
<a href="r_syntax.asp" class="ws-btn w3-margin-top">Syntax Explained</a>
<hr>

<h2>R Comments</h2>
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="tryr.asp?filename=demo_comments">
Single-line comment before a line of code</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_comments2">
Single-line comment at the end of a line of code</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_comments4">
Multi-line comment</a>
</div>
<a href="r_comments.asp" class="ws-btn w3-margin-top">Comments Explained</a>
<hr>

<h2>R Variables</h2>
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="tryr.asp?filename=demo_variables">
Creating two variables</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_variables_paste">
Combine both text and a variable</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_variables_paste2">
Add a variable to another variable</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_variables_plus">
Display the sum of two variables by using the + operator</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_variables_multi">
Assign the same value to multiple variables in one line</a>

</div>
<a href="r_variables.asp" class="ws-btn w3-margin-top">Variables Explained</a>
<hr>

<h2>R Data Types</h2>
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="tryr.asp?filename=demo_variables2">
Changing the type of a variable after it has been set</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_data_types">
Using the class() function to check the data type of different variables</a>

</div>
<a href="r_data_types.asp" class="ws-btn w3-margin-top">Data Types Explained</a>
<hr>

<h2>R Numbers</h2>
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="tryr.asp?filename=demo_numbers_numeric">
Creating a numeric data type</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_numbers_integer">
Creating an integer</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_numbers_complex">
Creating a complex number</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_numbers_convert">
Converting from one type to another</a>

</div>
<a href="r_numbers.asp" class="ws-btn w3-margin-top">Numbers Explained</a>
<hr>
...
<h2>R Math</h2>
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="tryr.asp?filename=demo_math_oper1">
Add numbers</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_math_oper2">
Subtract numbers</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_math_max_min">
Find the lowest or highest number in a set</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_math_sqrt">
Find the square root of a number</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_math_abs">
Return the absolute (positive) value of a number</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_math_ceiling_floor">
Round a number upwards and downwards to its nearest integer</a>

</div>
<a href="r_math.asp" class="ws-btn w3-margin-top">Math Explained</a>
<hr>

<h2>R Strings</h2>
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="tryr.asp?filename=demo_strings">
Creating a string literal</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_strings2">
Assigning a string to a variable</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_strings_nchar">
Find the number of characters in a string</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_strings_grepl">
Check a string for a character or a sequence of characters</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_strings_paste">
Combine/concatenate two strings</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_strings_esc2">
Using an escape character to output a word in a string</a>

</div>
<a href="r_strings.asp" class="ws-btn w3-margin-top">Strings Explained</a>
<hr>

<h2>R Booleans</h2>
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="tryr.asp?filename=demo_booleans">
Compare different values</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_booleans_var">
Compare variables</a>

</div>
<a href="r_booleans.asp" class="ws-btn w3-margin-top">Booleans Explained</a>
<hr>

<h2>R Operators</h2>
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="tryr.asp?filename=demo_oper_add">
Addition operator</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_oper_sub">
Subtraction operator</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_oper_mult">
Multiplication operator</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_oper_div">
Division operator</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_oper_exp">
Exponent operator</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_oper_mod">
Modulus operator</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_oper_int_div">
Integer Division operator</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_oper_compare1">
Equal operator</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_oper_compare2">
Not equal operator</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_oper_compare4">
Greater than operator</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_oper_compare5">
Less than operator</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_oper_compare6">
Greater than or equal to operator</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_oper_compare7">
Less than or equal to operator</a>

</div>
<a href="r_operators.asp" class="ws-btn w3-margin-top">Operators Explained</a>
<hr>

<h2>R If...Else</h2>
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="tryr.asp?filename=demo_if">
If statement</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_else_if">
Else if statement</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_if_else">
If else statement</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_if_nested">
Nested if statements</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_if_and">
The AND operator (&)</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_if_or">
The OR operator (&)</a>

</div>
<a href="r_if_else.asp" class="ws-btn w3-margin-top">If...Else Explained</a>
<hr>

<h2>R While Loop</h2>
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="tryr.asp?filename=demo_while_loop">
While loop</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_while_loop_break">
While loop with a break</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_while_loop_next">
While loop with the next statement</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_while_loop_yahtzee">
If..else combined with a while loop</a>

</div>
<a href="r_while_loop.asp" class="ws-btn w3-margin-top">While Loop Explained</a>
<hr>

<h2>R For Loop</h2>
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="tryr.asp?filename=demo_syntax_print_for">
Using a for loop to iterate over a sequence</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_for_loop">
Using a for loop to print every item in a list</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_for_loop2">
Using a for loop to print the number of dices</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_for_loop_yahtzee">
If..else combined with a for loop</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_for_loop_nested">
A nested for loop</a>

</div>
<a href="r_for_loop.asp" class="ws-btn w3-margin-top">For Loop Explained</a>
<hr>

<h2>R Functions</h2>
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="tryr.asp?filename=demo_function">
Call a function</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_function_args">
Function arguments</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_function_default">
Default parameter value</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_function_return">
Let a function return a value</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_function_nested">
Nested function</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_function_recursion">
Recursion</a>

</div>
<a href="r_functions.asp" class="ws-btn w3-margin-top">Functions Explained</a>
<hr>

<h2>R Global Variables</h2>
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="tryr.asp?filename=demo_variables_global">
Create a variable outside of a function and use it inside the function</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_variables_global2">
Create a variable inside of a function with the same name as the global variable</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_variables_global3">
Create a global variable inside a function</a>
</div>
<a href="r_variables_global.asp" class="ws-btn w3-margin-top">Global Variables Explained</a>
<hr>

<h2>R Vectors</h2>
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="tryr.asp?filename=demo_vector_strings">
Create a vector of strings</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_vector_num">
Create a vector of numbers</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_vector_colon">
Create a vector with numerical values in a sequence</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_vector_length">
Find the length of a vector</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_vector_sort">
Sort a vector</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_vector_access">
Access a vector</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_vector_modify">
Change a vector item</a>
</div>
<a href="r_vectors.asp" class="ws-btn w3-margin-top">Vectors Explained</a>
<hr>

<h2>R Lists</h2>
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="tryr.asp?filename=demo_lists">
Create a list</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_lists_access">
Access lists</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_lists_change">
Change item value</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_lists_length">
List length</a>
</div>
<a href="r_lists.asp" class="ws-btn w3-margin-top">Lists Explained</a>
<hr>

<h2>R Matrices</h2>
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="tryr.asp?filename=demo_matrices">
Create a matrix</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_matrices_access">
Access matrix items</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_matrices_length">
Matrix length</a>
</div>
<a href="r_matrices.asp" class="ws-btn w3-margin-top">Matrices Explained</a>
<hr>

<h2>R Arrays</h2>
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="tryr.asp?filename=demo_array">
Create arrays</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_array_access">
Access matrix items</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_array_length">
Array length</a>
</div>
<a href="r_arrays.asp" class="ws-btn w3-margin-top">Arrays Explained</a>
<hr>

<h2>R Data Frames</h2>
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="tryr.asp?filename=demo_data_frames">
Create a data frame</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_data_frames_access">
Access data frame items</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_data_frames_length">
Data Frames length</a>
</div>
<a href="r_data_frames.asp" class="ws-btn w3-margin-top">Data Frames Explained</a>
<hr>

<h2>R Factors</h2>
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="tryr.asp?filename=demo_factor">
Create a factor</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_factor_access">
Access factors</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryr.asp?filename=demo_factor_length">
Factor length</a>
</div>
<a href="r_factors.asp" class="ws-btn w3-margin-top">Factors Explained</a>
<hr>
