...
<h1>R <span class="color_h1">Print Output</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="r_syntax.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="r_comments.asp">Next &#10095;</a>
</div>
<hr>

<h2>Print</h2>

<p>Unlike many other programming languages, you can output code in R without using a print function:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  &quot;Hello World!&quot;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_syntax_str">Try it Yourself &raquo;</a>
</div>

<p>However, R does have a <code class="w3-codespan">print()</code> function 
available if you want to use it. This might be useful if you are familiar with other programming languages, such as <a href="/python/default.asp">Python</a>, which often uses the <code class="w3-codespan">print()</code> function to output code.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  print(&quot;Hello World!&quot;)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_syntax_print">Try it Yourself &raquo;</a>
</div>

<p>And there are times you must use the <code class="w3-codespan">print()</code> function to output code, for example when working with <a href="r_for_loop.asp"><code class="w3-codespan">for</code></a> 
...
<p><strong>Conclusion:</strong> It is up to you whether you want to use the <code class="w3-codespan">print()</code> 
function to output code. However, when your code is inside an R expression (e.g. inside curly braces 
<code class="w3-codespan">{}</code> like in the example above), use the <code class="w3-codespan">print()</code> function to output the result.</p>
</div>
