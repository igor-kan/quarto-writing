...
<h1>R <span class="color_h1">Arrays</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="r_matrices.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="r_data_frames.asp">Next &#10095;</a>
</div>
<hr>

<h2>Arrays</h2>
<p>Compared to matrices, arrays can have more than two dimensions. </p>
<p>We can use the <code class="w3-codespan">array()</code> function to create an array, and the <code class="w3-codespan">dim</code> parameter to specify the dimensions:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  # An array with one dimension with values ranging from 1 to 24<br>thisarray &lt;- 
  c(1:24)<br>thisarray<br><br># An array with more than one dimension<br>
  multiarray &lt;- array(thisarray, dim = c(4, 3, 2))<br>multiarray</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_array">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
<h4>Example Explained</h4>
<p>In the example above we create an array with the values 1 to 24.</p>
<p>How does <code class="w3-codespan">dim=c(4,3,2)</code> work?<br>

The first and second number in the bracket specifies the amount of rows and columns.<br>

The last number in the bracket specifies how many dimensions we want.</p>
<p><strong>Note:</strong> Arrays can only have one data type.</p>
</div>
<hr>

<h2>Access Array Items</h2>
<p>You can access the array elements by referring to the index position. You can use the <code class="w3-codespan">[]</code> brackets to
access the desired elements from an array:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  thisarray &lt;- c(1:24)<br>multiarray &lt;- array(thisarray, dim = c(4, 3, 2))<br><br>
  multiarray[2, 3, 2]</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_array_access">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
<p>The syntax is as follow:
array[row position, column position, matrix level]</p>
</div>

<p>You can also access the whole row or column from a matrix in an array, by using the <code class="w3-codespan">c()</code> function:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  thisarray &lt;- c(1:24)<br><br># Access all the items from the first row from 
  matrix one<br>multiarray &lt;- array(thisarray, dim = c(4, 3, 2))<br>
  multiarray[c(1),,1]<br><br># Access all the items from the first column 
  from matrix one<br>multiarray &lt;- array(thisarray, dim = c(4, 3, 2))<br>
  multiarray[,c(1),1]</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_array_access_rc">Try it Yourself &raquo;</a>
</div>
<div class="ws-note w3-panel">
<p>A comma (,) before c() means that we want to access the column.</p>

<p>A comma (,) after c() means that we want to access the row.</p>
</div>
<hr>
...
<p>To find out if a specified item is present in an array, use the <code class="w3-codespan">%in%</code> operator:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Check if the value "2" is present in the array:</p>
<div class="w3-code notranslate pythonHigh">
  thisarray &lt;- c(1:24)<br>multiarray &lt;- array(thisarray, dim = c(4, 3, 2))<br><br>2 %in% multiarray</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_array_check">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Amount of Rows and Columns</h2>
<p>Use the <code class="w3-codespan">dim()</code> function to find the amount of rows and columns in an array:</p>
...
<div class="w3-code notranslate pythonHigh">
  thisarray &lt;- c(1:24)<br>multiarray &lt;- array(thisarray, dim = c(4, 3, 2))<br><br>
  dim(multiarray)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_array_dim">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Array Length</h2>
<p>Use the <code class="w3-codespan">length()</code> function to find the dimension of an array:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  thisarray &lt;- c(1:24)<br>multiarray &lt;- array(thisarray, dim = c(4, 3, 2))<br><br>
  length(multiarray)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_array_length">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Loop Through an Array</h2>
<p>You can loop through the array items by using a <code class="w3-codespan">for</code> loop:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  thisarray &lt;- c(1:24)<br>multiarray &lt;- array(thisarray, dim = c(4, 3, 2))<br>
  <br>for(x in multiarray){<br>&nbsp; print(x)<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_array_loop">Try it Yourself &raquo;</a>
</div>
