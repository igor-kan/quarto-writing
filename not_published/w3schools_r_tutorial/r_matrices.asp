...
<h1>R <span class="color_h1">Matrices</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="r_lists.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="r_arrays.asp">Next &#10095;</a>
</div>
<hr>

<h2>Matrices</h2>
<p>A matrix is a two dimensional data set with columns and rows.</p>
<p>A column is a vertical representation of data, while a row is a horizontal representation of data.</p>
<p>A matrix can be created with the <code class="w3-codespan">matrix()</code> function. Specify the <code class="w3-codespan">nrow</code> and <code class="w3-codespan">ncol</code> parameters to get the amount of rows and columns:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  # Create a matrix<br>thismatrix &lt;- matrix(c(1,2,3,4,5,6), nrow = 3, ncol = 2)<br><br># Print the 
  matrix<br>thismatrix</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_matrices">Try it Yourself &raquo;</a>
</div>
<div class="ws-note w3-panel">
<p><strong>Note:</strong> Remember the <code class="w3-codespan">c()</code> function is used to concatenate 
items together.</p>
</div>
...
<div class="w3-code notranslate pythonHigh">
  ...
  = 2)<br><br>thismatrix</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_matrices2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Access Matrix Items</h2>
<p>You can access the items by using <code class="w3-codespan">[ ]</code> 
brackets. The first number &quot;1&quot; in the bracket specifies the row-position, while 
the second number &quot;2&quot; specifies the column-position: </p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  thismatrix &lt;- matrix(c(&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;, &quot;orange&quot;), nrow = 2, ncol 
  = 2)<br><br><strong>thismatrix[1, 2]</strong></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_matrices_access">Try it Yourself &raquo;</a>
</div>

<p>The whole row can be accessed if you specify a comma <strong>after</strong> the number in the bracket:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  thismatrix &lt;- matrix(c(&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;, &quot;orange&quot;), nrow = 2, ncol 
  = 2)<br><br><strong>thismatrix[2,]</strong></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_matrices_access_row">Try it Yourself &raquo;</a>
</div>

<p>The whole column can be accessed if you specify a comma <strong>before</strong> the number in the bracket:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  thismatrix &lt;- matrix(c(&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;, &quot;orange&quot;), nrow = 2, ncol 
  = 2)<br><br><strong>thismatrix[,2]</strong></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_matrices_access_col">Try it Yourself &raquo;</a>
</div>
<hr>
...
<h2>Access More Than One Row</h2>
<p>More than one row can be accessed if you use the <code class="w3-codespan">c()</code> function:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  thismatrix &lt;- matrix(c(&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;, &quot;orange&quot;,&quot;grape&quot;, 
  &quot;pineapple&quot;, &quot;pear&quot;, &quot;melon&quot;, &quot;fig&quot;), nrow = 3, ncol = 3)<br><br>thismatrix[c(1,2),]</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_matrices_access_row2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Access More Than One Column</h2>
<p>More than one column can be accessed if you use the <code class="w3-codespan">c()</code> function:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  thismatrix &lt;- matrix(c(&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;, &quot;orange&quot;,&quot;grape&quot;, 
  &quot;pineapple&quot;, &quot;pear&quot;, &quot;melon&quot;, &quot;fig&quot;), nrow = 3, ncol = 3)<br><br>thismatrix[, 
  c(1,2)]</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_matrices_access_col2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Add Rows and Columns</h2>
<p>Use the <code class="w3-codespan">cbind()</code> function to add additional columns in a Matrix:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  thismatrix &lt;- matrix(c(&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;, &quot;orange&quot;,&quot;grape&quot;, 
  &quot;pineapple&quot;, &quot;pear&quot;, &quot;melon&quot;, &quot;fig&quot;), nrow = 3, ncol = 3)<br><br>newmatrix &lt;- 
  cbind(thismatrix, c(&quot;strawberry&quot;, &quot;blueberry&quot;, &quot;raspberry&quot;))<br>
  <br># Print the new matrix<br>
  newmatrix</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_matrices_add_cols">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
<p><strong>Note:</strong> The cells in the new column must be of the same length as the existing matrix.</p>
</div>

<p>Use the <code class="w3-codespan">rbind()</code> function to add additional rows in a Matrix:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  thismatrix &lt;- matrix(c(&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;, &quot;orange&quot;,&quot;grape&quot;, 
  &quot;pineapple&quot;, &quot;pear&quot;, &quot;melon&quot;, &quot;fig&quot;), nrow = 3, ncol = 3)<br><br>newmatrix &lt;- 
  rbind(thismatrix, c(&quot;strawberry&quot;, &quot;blueberry&quot;, &quot;raspberry&quot;))<br>
  <br># Print the new matrix<br>
  newmatrix</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_matrices_add_rows">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
<p><strong>Note:</strong> The cells in the new row must be of the same length as the existing matrix.</p>
</div>
<hr>

<h2>Remove Rows and Columns</h2>
<p>Use the <code class="w3-codespan">c()</code> function to remove rows and columns in a Matrix:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  thismatrix &lt;- matrix(c(&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;, &quot;orange&quot;, &quot;mango&quot;, &quot;pineapple&quot;), 
  nrow = 3, ncol =2)<br><br>
  #Remove the first row and the first column<br>thismatrix &lt;- thismatrix[-c(1), -c(1)]<br><br>
  thismatrix</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_matrices_remove_rows_cols">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Check if an Item Exists</h2>
<p>To find out if a specified item is present in a matrix, use the <code class="w3-codespan">%in%</code> operator:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Check if "apple" is present in the matrix:</p>
<div class="w3-code notranslate pythonHigh">
  thismatrix &lt;- matrix(c(&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;, &quot;orange&quot;), nrow = 2, ncol 
  = 2)<br><br>&quot;apple&quot; %in% thismatrix</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_matrices_check">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Number of Rows and Columns</h2>
<p>Use the <code class="w3-codespan">dim()</code> function to find the number of rows and columns in a Matrix:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  thismatrix &lt;- matrix(c(&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;, &quot;orange&quot;), nrow = 2, ncol 
  = 2)<br><br>dim(thismatrix)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_matrices_dim">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Matrix Length</h2>
<p>Use the <code class="w3-codespan">length()</code> function to find the dimension of a Matrix:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  thismatrix &lt;- matrix(c(&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;, &quot;orange&quot;), nrow = 2, ncol 
  = 2)<br><br>length(thismatrix)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_matrices_length">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
<p>Total cells in the matrix is the number of rows multiplied by number of columns.</p>

<p>In the example above: Dimension = 2*2 = <strong>4</strong>.</p>
</div>
<hr>

<h2>Loop Through a Matrix</h2>
<p>You can loop through a Matrix using a <code class="w3-codespan">for</code> loop. The loop will start at the 
first row, moving right:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Loop through the matrix items and print them:</p>
<div class="w3-code notranslate pythonHigh">
  thismatrix &lt;- matrix(c(&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;, &quot;orange&quot;), nrow = 2, ncol 
  = 2)<br><br>for (rows in 1:nrow(thismatrix)) {<br>&nbsp; for (columns in 
  1:ncol(thismatrix)) {<br>&nbsp;&nbsp;&nbsp; print(thismatrix[rows, columns])<br>&nbsp; 
  }<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_matrices_loop">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Combine two Matrices</h2>
<p>Again, you can use the <code class="w3-codespan">rbind()</code> or <code class="w3-codespan">cbind()</code> function to combine two or more matrices together:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  # Combine matrices<br>Matrix1 &lt;- matrix(c(&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;, 
  &quot;grape&quot;), nrow = 2, ncol = 2)<br>Matrix2 &lt;- matrix(c(&quot;orange&quot;, &quot;mango&quot;, 
  &quot;pineapple&quot;, &quot;watermelon&quot;), nrow = 2, ncol = 2)<br><br># Adding it as a rows<br>
  Matrix_Combined &lt;- rbind(Matrix1, Matrix2)<br>Matrix_Combined<br><br>
  # Adding it as a columns<br>Matrix_Combined &lt;- cbind(Matrix1, Matrix2)<br>
  Matrix_Combined</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_matrices_combine">Try it Yourself &raquo;</a>
</div>
<br>
