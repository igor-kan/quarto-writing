...
<html lang="en-US">
<head>
<title>R Nested Functions</title>
<meta charset="utf-8">
...
<h1>R <span class="color_h1">Nested Functions</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="r_functions.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="r_functions_recursion.asp">Next &#10095;</a>
</div>
<hr>

<h2>Nested Functions</h2>
<p>There are two ways to create a nested function:</p>
<ul>
<li>Call a function within another function.</li>
<li>Write a function within a function.</li>
</ul>

<div class="w3-example">
<h3>Example</h3>
<p>Call a function within another function:</p>
<div class="w3-code notranslate pythonHigh">
  Nested_function &lt;- function(x, y) {<br>&nbsp; a &lt;- x + y<br>&nbsp; return(a)<br>
  }<br>
  <br>Nested_function(Nested_function(2,2), Nested_function(3,3))</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_function_nested">Try it Yourself &raquo;</a>
</div>
<h4>Example Explained</h4>
<p>The function tells x to add y.</p>
<p>The first input Nested_function(2,2) is "x" of the main function.</p>
<p>The second input Nested_function(3,3) is "y" of the main function.</p>
<p>The output is therefore (2+2) + (3+3) = <strong>10</strong>.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Write a function within a function:</p>
<div class="w3-code notranslate pythonHigh">
  Outer_func &lt;- function(x) {<br>&nbsp; Inner_func &lt;- function(y) {<br>&nbsp;&nbsp;&nbsp; 
  a &lt;- x + y<br>&nbsp;&nbsp;&nbsp; return(a)<br>&nbsp; }<br>&nbsp; return 
  (Inner_func)<br>}<br>output &lt;- Outer_func(3) # To 
  call the Outer_func<br>output(5)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_function_nested2">Try it Yourself &raquo;</a>
</div>
<h4>Example Explained</h4>
<p>You cannot directly call the function because the Inner_func has been defined (nested) inside the
Outer_func.</p>
<p>We need to call Outer_func first in order to call Inner_func as a second step.
<p>We need to create a new variable called output and give it a value, which is 3 here.</p>
<p>We then print the output with the desired value of "y", which in this case is 5.</p>
<p>The output is therefore <strong>8</strong> (3 + 5).</p>
<hr>
