...
<h1>R <span class="color_h1">Introduction</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="default.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="r_get_started.asp">Next &#10095;</a>
</div>
<hr>

<h2>What is R</h2>
  <p>R is a popular programming language used for statistical computing and graphical presentation.</p>
  <p>Its most common use is to analyze and visualize data.</p>
<hr>

<h2>Why Use R?</h2>
<ul>
<li>It is a great resource for data analysis, data visualization, data science and machine learning</li>
<li>It provides many statistical techniques (such as statistical tests, classification, clustering and data reduction)</li>
<li>It is easy to draw graphs in R, like pie charts, histograms, box plot, scatter plot, etc++</li>
<li>It works on different platforms (Windows, Mac, Linux)</li>
<li>It is open-source and free</li>
<li>It has a large community support</li>
<li>It has many packages (libraries of functions) that can be used to solve different problems</li>
</ul>
<hr>

<h2>Get Started</h2>
<p>This tutorial will teach you the basics of R.</p>
<p>It is not necessary to have any prior programming experience.</p>

<a class="ws-btn ws-black  w3-round" href="r_get_started.asp">Get Started Now &raquo;</a>
<br><br>
