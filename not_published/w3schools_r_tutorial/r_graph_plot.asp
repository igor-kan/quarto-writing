...
<html lang="en-US">
<head>
<title>R Graphics - Plotting</title>
<meta charset="utf-8">
...
<h1>R <span class="color_h1">Plotting</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="r_factors.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="r_graph_line.asp">Next &#10095;</a>
</div>
<hr>
...
<p>Parameter 1 specifies points on the <strong>x-axis</strong>.</p>

<p>Parameter 2 specifies points on the <strong>y-axis</strong>.</p>

<p>At its simplest, you can use the <code class="w3-codespan">plot()</code> function to plot two numbers against each other:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Draw one point in the diagram, at position (1) and position (3):</p>
<div class="w3-code notranslate pythonHigh">
  plot(1, 3)</div>
<p>Result:</p>
<div class="w3-black w3-padding w3-padding-16">
<img src="r_plot_simple.png">

</div>
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryr.asp?filename=demo_graph_plot_simple">Try it Yourself &raquo;</a>
</div>
<p>To draw more points, use <a href="r_vectors.asp">vectors</a>:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Draw two points in the diagram, one at position (1, 3) and one in position (8, 10):</p>
<div class="w3-code notranslate pythonHigh">
  plot(c(1, 8), c(3, 10))</div>
<p>Result:</p>
<div class="w3-black w3-padding w3-padding-16">
<img src="r_plot1.png">

</div>
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryr.asp?filename=demo_graph_plot">Try it Yourself &raquo;</a>
</div>
<hr>
...
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  plot(c(1, 2, 3, 4, 5), c(3, 7, 8, 9, 12))</div>
<p>Result:</p>
<div class="w3-black w3-padding w3-padding-16">
<img src="r_plot2.png">

</div>
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryr.asp?filename=demo_graph_plot2">Try it Yourself &raquo;</a>
</div>

<p>For better organization, when you have many values, it is better to use variables:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  x &lt;- c(1, 2, 3, 4, 5)<br>y &lt;- c(3, 7, 8, 9, 12)<br><br>plot(x, y)</div>
<p>Result:</p>
<div class="w3-black w3-padding w3-padding-16">
<img src="r_plot2.png">

</div>
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryr.asp?filename=demo_graph_plot3">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Sequences of Points</h2>
<p>If you want to draw dots in a sequence, on both the <strong>x-axis</strong> and the <strong>y-axis</strong>, use the <code class="w3-codespan">:</code> operator:</p>
...
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryr.asp?filename=demo_graph_plot_seq">Try it Yourself &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">plot()</code> function also takes a <code class="w3-codespan">type</code> parameter with the value <code class="w3-codespan">l</code> to draw a line to connect all the points in 
the diagram:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  plot(1:10, type=&quot;l&quot;)</div>
<p>Result:</p>
<div class="w3-black w3-padding w3-padding-16">
<img src="r_plot_line.png">

</div>
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryr.asp?filename=demo_graph_plot_line">Try it Yourself &raquo;</a>
</div>
<hr>
...
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  plot(1:10, main=&quot;My Graph&quot;, xlab=&quot;The x-axis&quot;, ylab=&quot;The y axis&quot;)</div>
<p>Result:</p>
<div class="w3-black w3-padding w3-padding-16">
<img src="r_plot_labels.png">

</div>
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryr.asp?filename=demo_graph_plot_labels">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Graph Appearance</h2>
<p>There are many other parameters you can use to change the appearance of the points.</p>

<h3>Colors</h3>
<p>Use <code class="w3-codespan">col="<em>color</em>"</code> to add a color to the 
points:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  plot(1:10, col=&quot;red&quot;)</div>
<p>Result:</p>
<div class="w3-black w3-padding w3-padding-16">
<img src="r_plot_col.png">

</div>
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryr.asp?filename=demo_graph_plot_col">Try it Yourself &raquo;</a>
</div>

<h3>Size</h3>
<p>Use <code class="w3-codespan">cex=<em>number</em></code> to change the size 
of the points (<code class="w3-codespan">1</code> is default, while <code class="w3-codespan">0.5</code> means 50% smaller, and 
<code class="w3-codespan">2</code> means 100% larger):</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  plot(1:10, cex=2)</div>
<p>Result:</p>
<div class="w3-black w3-padding w3-padding-16">
<img src="r_plot_cex.png">

</div>
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryr.asp?filename=demo_graph_plot_cex">Try it Yourself &raquo;</a>
</div>

<h3>Point Shape</h3>
<p>Use <code class="w3-codespan">pch</code> with a value from 0 to 25 to change the point shape format:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  plot(1:10, pch=25, cex=2)</div>
<p>Result:</p>
<div class="w3-black w3-padding w3-padding-16">
<img src="r_plot_pch.png">

</div>
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryr.asp?filename=demo_graph_plot_pch">Try it Yourself &raquo;</a>
</div>
<p>The values of the <code class="w3-codespan">pch</code> parameter ranges from 0 to 25, which means that we can choose up to 26 different types of
point shapes:</p>
<img src="r_plot_pch2.png" style="max-width:100%">
<br>
<br>
