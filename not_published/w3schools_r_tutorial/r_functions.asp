...
<h1>R <span class="color_h1">Functions</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="r_for_loop_nested.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="r_functions_nested.asp">Next &#10095;</a>
</div>
<hr>
...
<p>To create a function, use the <code class="w3-codespan">function()</code> keyword:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  my_function &lt;- function() { # create a function with the name my_function<br>&nbsp; print(&quot;Hello World!&quot;)<br>}</div>
</div>
<hr>

<h2>Call a Function</h2>
<p>To call a function, use the function name followed by parenthesis, like <strong>my_function()</strong>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  my_function &lt;- function() {<br>&nbsp; print(&quot;Hello World!&quot;)<br>}<br><br>
  <strong>my_function() </strong># call the function named my_function</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_function">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>Arguments are specified after the function name, inside the parentheses. You can add as many
arguments as you want, just separate them with a comma.</p>

<p>The following example has a function with one argument (fname). When the function is called, we
pass along a first name, which is used inside the function to print the full name:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  my_function &lt;- function(fname) {<br>&nbsp; paste(fname, &quot;Griffin&quot;)<br>}<br><br>my_function(&quot;Peter&quot;)<br>my_function(&quot;Lois&quot;)<br>my_function(&quot;Stewie&quot;)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_function_args">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
<h3>Parameters or Arguments?</h3>
<p>The terms "parameter" and "argument" can be used for the same thing: information that are passed into
a function.</p>
...
<p>By default, a function must be called with the correct number of arguments. Meaning that if your
function expects 2 arguments, you have to call the function with 2 arguments, not more, and not less:</p>
<div class="w3-example">
<h3>Example</h3>
<p>This function expects 2 arguments, and gets 2 arguments:</p>
<div class="w3-code notranslate pythonHigh">
  my_function &lt;- function(fname, lname) {<br>&nbsp; paste(fname, lname)<br>
  }<br><br>my_function(&quot;Peter&quot;, &quot;Griffin&quot;)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_function_args2">Try it Yourself &raquo;</a>
</div>
<p>If you try to call the function with 1 or 3 arguments, you will get an error:</p>
<div class="w3-example w3-pale-red">
<h3>Example</h3>
<p>This function expects 2 arguments, and gets 1 argument:</p>
<div class="w3-code notranslate pythonHigh w3-border-red">
  my_function &lt;- function(fname, lname) {<br>&nbsp; paste(fname, lname)<br>
  }<br><br>my_function(&quot;Peter&quot;)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_function_args3">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>If we call the function without an argument, it uses the default value:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  my_function &lt;- function(country = &quot;Norway&quot;) {<br>&nbsp; paste(&quot;I am 
  from&quot;, country)<br>}<br><br>my_function(&quot;Sweden&quot;)<br>my_function(&quot;India&quot;)<br>
  my_function() 
  # will get the default value, which is Norway<br>my_function(&quot;USA&quot;)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_function_default">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Return Values</h2>
<p>To let a function return a result, use the <code class="w3-codespan">return()</code> function:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  my_function &lt;- function(x) {<br>&nbsp; return (5 * x)<br>}<br><br>
  print(my_function(3))<br>print(my_function(5))<br>print(my_function(9))</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_function_return">Try it Yourself &raquo;</a>
</div>
