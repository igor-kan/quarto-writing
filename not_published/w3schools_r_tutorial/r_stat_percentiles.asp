...
<html lang="en-US">
<head>
<title>R Statistics - Percentiles</title>
<meta charset="utf-8">
...
<h1>R <span class="color_h1">Percentiles</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="r_stat_mode.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="r_exam.asp">Next &#10095;</a>
</div>
<hr>

<h2>Percentiles</h2>
<p>Percentiles are used in statistics to give you a number that describes the value that a given percent of
the values are lower than.</p>

<p>If we take a look at the values of the <code class="w3-codespan">wt</code> 
(weight) variable from the <code class="w3-codespan">mtcars</code> data set:</p>

<div class="w3-responsive">
<h4>Observation of wt (weight)</h4>
...
<p>What is the 75. percentile of the weight of the cars? The answer is 3.61 or 3 610 lbs, meaning that 75% or the cars weight 3 610 lbs or less:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  Data_Cars &lt;- mtcars<br><br># c() specifies which percentile you want<br>
  quantile(Data_Cars$wt, c(0.75))</div>
<p>Result:</p>
<div class="w3-black w3-padding">
<pre>
75% 
3.61</pre></div>
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="tryr.asp?filename=demo_stat_percentile">Try it Yourself &raquo;</a>
</div>

<p>If you run the <code class="w3-codespan">quantile()</code> function without specifying the <code class="w3-codespan">c()</code> parameter, you will get 
the percentiles of 0, 25, 50, 75 and 100:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  Data_Cars &lt;- mtcars<br><br>quantile(Data_Cars$wt)</div>
<p>Result:</p>
<div class="w3-black w3-padding">
<pre>
     0%     25%     50%     75%    100% 
...
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryr.asp?filename=demo_stat_percentile2">Try it Yourself &raquo;</a>
</div>
...
<h2>Quartiles</h2>
<p>Quartiles are data divided into four parts, when sorted in an ascending order:</p>
<ol>
<li>The value of the first quartile cuts off the first 25% of the data</li>
<li>The value of the second quartile cuts off the first 50% of the data</li>
<li>The value of the third quartile cuts off the first 75% of the data</li>
<li>The value of the fourth quartile cuts off the 100% of the data</li>
</ol>

<div class="ws-note w3-panel">

<p>Use the <code class="w3-codespan">quantile()</code> function to get the quartiles.</p>
