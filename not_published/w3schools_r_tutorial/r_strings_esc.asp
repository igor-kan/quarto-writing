...
<html lang="en-US">
<head>
<title>R Strings - Escape Characters</title>
<meta charset="utf-8">
...
<h1>R <span class="color_h1">Escape Characters</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="r_strings.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="r_booleans.asp">Next &#10095;</a>
</div>
<hr>

<h2>Escape Characters</h2>
<p>To insert characters that are illegal in a string, you must use an escape character.</p>
...
<div class="w3-code notranslate pythonHigh w3-border-red">
  str &lt;- &quot;We are the so-called &quot;Vikings&quot;, from the north.&quot;<br><br>
  str</div>
<p>Result:</p>
<div class="w3-black w3-padding">
<code>Error: unexpected symbol in "str &lt;- "We are the so-called "Vikings"</code>

</div>
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="tryr.asp?filename=demo_strings_esc">Try it Yourself &raquo;</a>
...
<div class="w3-code notranslate pythonHigh">
  ...
  str<br>
  cat(str)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_strings_esc2">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
<p>Note that auto-printing the<strong> str</strong> variable will print the backslash 
in the output. You can use the <code class="w3-codespan">cat()</code> function to print
it without backslash.</p>
</div>

<p>Other escape characters in R:</p>
