...
<html lang="en-US">
<head>
<title>R Statistics Data Set</title>
<meta charset="utf-8">
...
<h1>R <span class="color_h1">Data Set</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="r_stat_intro.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="r_stat_max_min.asp">Next &#10095;</a>
</div>
<hr>

<h2>Data Set</h2>
<p>A data set is a collection of data, often presented in a table.</p>
<p>There is a popular built-in data set in R called "<strong>mtcars</strong>" (Motor Trend Car Road Tests), which is 
retrieved from the 1974 Motor Trend US Magazine.</p>
<p>In the examples below (and for the next chapters), we will use the <code class="w3-codespan">mtcars</code> 
data set, for statistical purposes:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  # Print the mtcars data set<br>mtcars </div>
<p>Result:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="tryr.asp?filename=demo_stat_ds_print">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Information About the Data Set</h2>
<p>You can use the question mark (<code class="w3-codespan">?</code>) to get information about the <code class="w3-codespan">mtcars</code> data set:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  # Use the question mark to get information about 
  the data set<br><br>?mtcars</div>
  
<p>Result:</p>
<div class="w3-black w3-padding">
<body>

<table width="100%" summary="page for mtcars {datasets}"><tbody><tr><td>mtcars {datasets}</td><td style="text-align: right;">R Documentation</td></tr></tbody></table>
...
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="tryr.asp?filename=demo_stat_ds_view">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>Use the <code class="w3-codespan">dim()</code> function to find the dimensions of the data set, and the <code class="w3-codespan">names()</code> function to view the names of the
variables:</p>
...
<div class="w3-code notranslate pythonHigh">
  ...
  organization<br><br># Use dim() to find the dimension of the data set<br>
  dim(Data_Cars)<br><br># Use names() to find the names of the variables from 
  the data set<br>names(Data_Cars)</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="tryr.asp?filename=demo_stat_ds_dim_names">Try it Yourself &raquo;</a>
</div>

<p>Use the <code class="w3-codespan">rownames()</code> function to get the name of each row in the first column, which is the name of each car:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  Data_Cars &lt;- mtcars<br><br>rownames(Data_Cars)</div>
...
[31] "Maserati Bora"       "Volvo 142E"         </pre></div>
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="tryr.asp?filename=demo_stat_ds_rownames">Try it Yourself &raquo;</a>
</div>

<p>From the examples above, we have found out that the data set has <strong>32</strong> observations 
(Mazda RX4, Mazda RX4 Wag, Datsun 710, etc) and <strong>11</strong> variables 
(mpg, cyl, disp, etc).</p>

<p>A variable is defined as something that can be measured or counted.</p>

<p>Here is a brief explanation of the variables from the mtcars data set:</p>
...
<h2>Print Variable Values</h2>
<p>If you want to print all values that belong to a variable, access the data 
frame by using the <code class="w3-codespan">$</code> sign, and the name of the variable 
(for example <code class="w3-codespan">cyl</code> (cylinders)):</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  Data_Cars &lt;- mtcars<br><br>Data_Cars$cyl</div>
<p>Result:</p>
<div class="w3-black w3-padding">
<pre>
 [1] 6 6 4 6 8 6 8 4 4 6 6 8 8 8 8 8 8 4 4 4 4 8 8 8 8 4 4 4 8 6 8 4</pre></div>
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="tryr.asp?filename=demo_stat_ds_varval">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Sort Variable Values</h2>
<p>To sort the values, use the <code class="w3-codespan">sort()</code> function:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  Data_Cars &lt;- mtcars<br><br>sort(Data_Cars$cyl)</div>
<p>Result:</p>
<div class="w3-black w3-padding">
<pre>
 [1] 4 4 4 4 4 4 4 4 4 4 4 6 6 6 6 6 6 6 8 8 8 8 8 8 8 8 8 8 8 8 8 8</pre></div>
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="tryr.asp?filename=demo_stat_ds_sort">Try it Yourself &raquo;</a>
</div>

<p>From the examples above, we see that most cars have 4 and 8 cylinders.</p>
<hr>


<h2>Analyzing the Data</h2>
<p>Now that we have some information about the data set, we can start to analyze it with some statistical numbers.</p>
<p>For example, we can use the <code class="w3-codespan">summary()</code> function to get a statistical summary of the data:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  Data_Cars &lt;- mtcars<br><br>summary(Data_Cars)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryr.asp?filename=demo_stat_ds_summary">Try it Yourself &raquo;</a>
</div>
<p>Do not worry if you do not understand the output numbers. You will master them shortly.</p>
<p>The <code class="w3-codespan">summary()</code> function returns six statistical numbers for each variable:</p>
<ul>
<li>Min (the minimum value in the data)</li>
<li>The 1st quartile (25th percentile)</li>
<li>Median (the middle value- 50th percentile)</li>
<li>Mean (the average value)</li>
<li>The 3rd quartile (75th percentile)</li>
<li>Max (the maximum value in the data)</li>
</ul>
<p>We will cover all of them, along with other statistical numbers in the next chapters.</p>
<hr>
