...
<html lang="en-US">
<head>
<title>R Study Plan (Lesson Plan)</title>
<meta charset="utf-8">
...
<h1>R <span class="color_h1">Study Plan</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="r_syllabus.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="default.asp">Next &#10095;</a>
</div>
<hr>

<h2>Introduction</h2>
<p>The R study plan helps you teach your students R step-by-step.</p>
<p>Creating a study plan for R is easy.</p>
...
<p>Save time with pre-built teacher materials and study plans. Easily organize your class with a timeline from the introduction of R to the final exam.</p>
<hr>
...
<p>W3Schools has everything you need to teach R.</p>

<p>The R training materials is available for you to include and use in your study plan:</p>
<ul>
  <li><a href="default.asp" target="_blank">W3Schools R Tutorial</a></li>
  <li><a href="r_exercises.asp" target="_blank">R Exercises</a></li>
  <li><a href="r_quiz.asp" target="_blank">R Quiz</a></li>
  <li>R Challenges (Coding challenges)</li>
  <li><a href="r_exam.asp" target="_blank">R Certification Exam (End of Pathway Exam)</a></li>
</ul>
<hr>

<h2>R Syllabus</h2>
<p>With the R Syllabus, your students will start with the basics, like understanding variables, data types, and syntax, and move to more advanced topics, like data visualization, statistical analysis, and working with data frames. Each chapter includes examples, try-it-yourself sections, exercises, and quizzes to make learning easy, interactive, and fun.</p>
<p><a title="W3Schools R Syllabus" href="r_syllabus.asp" target="_blank">Read more about R Syllabus</a>.</p>
<hr>
...
<ol>
  ...
  <li style="margin-top:16px">
    ...
    <ul>
      <li>The R study plan aligns with the R Certification Exam.</li>
      <li>The exam can be taken at the end of the study plan, at your selected date.</li>
      <li>The exam summarizes the R Tutorial.</li>
...
<p>Some would like more intensive pace, e.g. 3 weeks, others 12 or more weeks.</p>
<p>It is completely up to you.</p>
<p>For example, this is how a 3-week R study plan could look like:</p>

<ul>
  <li>Week 1: Introduction, Basics</li>
  <li>Week 2: Conditionals &amp; Loops, Functions, Data Structures, Graphics</li>
  <li>Week 3: Statistics, Statistics Mean Median Mode, Statistics Percentiles, R Certification Exam</li>
</ul>

<p>Image of Sample R study plan:</p>
<a href="r_study_plan.png" target="_blank" title="R Study Plan"><img src="r_study_plan.png" style="height:auto;max-width:100%;" loading="lazy"></a>
<hr>

<h2>Ready to get started?</h2>
<p>Start with <strong> R Study Plans</strong> today.</p>
...
<p>Are you interested in learning how you can use <a href="/academy/index.php" target="_blank">W3Schools Academy</a> to Teach R programming? </p>
