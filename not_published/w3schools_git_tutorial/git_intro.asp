...
<html lang="en-US">
<head>
<title id="title">Introduction to Git and {{title}}</title>
<meta charset="utf-8">
...
<h1>Git and {{title}} <span class="color_h1">Introduction</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="default.asp?remote={{remoteName}}">&#10094; Previous</a>
<a class="w3-right w3-btn" href="git_install.asp?remote={{remoteName}}">Next &#10095;</a>
</div>
<hr>
<h2>What is Git?</h2>
<p>Git is a popular version control system.</p>
<p>It was created by Linus Torvalds in 2005, and has been maintained by Junio Hamano since then.</p>
...
<ul>
  <li><strong>Repository:</strong> A folder where Git tracks your project and its history.</li>
  <li><strong>Clone:</strong> Make a copy of a remote repository on your computer.</li>
  <li><strong>Stage:</strong> Tell Git which changes you want to save next.</li>
  <li><strong>Commit:</strong> Save a snapshot of your staged changes.</li>
  <li><strong>Branch:</strong> Work on different versions or features at the same time.</li>
  <li><strong>Merge:</strong> Combine changes from different branches.</li>
  <li><strong>Pull:</strong> Get the latest changes from a remote repository.</li>
  <li><strong>Push:</strong> Send your changes to a remote repository.</li>
</ul>
...
<p><strong>Note:</strong> Most Git actions (like staging, committing, and viewing history) happen on your own computer.</p>
<p>Only <strong>Push</strong> and <strong>Pull</strong> interact with remote servers like GitHub, GitLab, or Bitbucket to upload or download changes.</p>
</div>
<hr>
