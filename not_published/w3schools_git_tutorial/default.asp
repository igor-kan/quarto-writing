...
<a target="_top" href="default.asp?remote={{remoteName}}">Git HOME</a>
<a target="_top" href="git_intro.asp?remote={{remoteName}}">Git Intro</a>
<a target="_top" href="git_install.asp?remote={{remoteName}}">Git Install</a>
<a target="_top" href="git_config.asp?remote={{remoteName}}">Git Config</a>
<a target="_top" href="git_getstarted.asp?remote={{remoteName}}">Git Get Started</a>
<a target="_top" href="git_new_files.asp?remote={{remoteName}}">Git New Files</a>
<a target="_top" href="git_staging_environment.asp?remote={{remoteName}}">Git Staging</a>
<a target="_top" href="git_commit.asp?remote={{remoteName}}">Git Commit</a>
<a target="_top" href="git_tagging.asp?remote={{remoteName}}">Git Tagging</a>
<a target="_top" href="git_stash.asp?remote={{remoteName}}">Git Stash</a>
<a target="_top" href="git_history.asp?remote={{remoteName}}">Git History</a>
<a target="_top" href="git_help.asp?remote={{remoteName}}">Git Help</a>
<a target="_top" href="git_branch.asp?remote={{remoteName}}">Git Branch</a>
<a target="_top" href="git_branch_merge.asp?remote={{remoteName}}">Git Merge</a>
<a target="_top" href="git_workflow.asp?remote={{remoteName}}">Git Workflow</a>
<a target="_top" href="git_best_practices.asp?remote={{remoteName}}">Git Best Practices</a>
<a target="_top" href="git_glossary.asp?remote={{remoteName}}" class="not-wired">Git Glossary</a>
<br>
<h2 class="left"><span class="left_h2">Git</span> and {{title}}</h2>
<a target="_top" href="git_remote_getstarted.asp?remote={{remoteName}}">{{title}} Get Started</a>
<a target="_top" href="git_security_ssh.asp?remote={{remoteName}}">Git What is SSH?</a>
<a target="_top" href="git_remote_add_ssh.asp?remote={{remoteName}}">{{title}} Add SSH</a>
<a target="_top" href="git_set_remote.asp?remote={{remoteName}}">{{title}} Set Remote</a>
<a target="_top" href="git_remote_edit_code.asp?remote={{remoteName}}">{{title}} Edit Code</a>
<a target="_top" href="git_pull_from_remote.asp?remote={{remoteName}}">Pull from {{title}}</a>
<a target="_top" href="git_push_to_remote.asp?remote={{remoteName}}">Push to {{title}}</a>
<a target="_top" href="git_remote_branch.asp?remote={{remoteName}}">{{title}} Branch</a>
<a target="_top" href="git_branch_pull_from_remote.asp?remote={{remoteName}}">Pull Branch from {{title}}</a>
<a target="_top" href="git_branch_push_to_remote.asp?remote={{remoteName}}">Push Branch to {{title}}</a>
<a target="_top" href="git_github_flow.asp?remote={{remoteName}}">GitHub Flow</a>
<a target="_top" href="git_remote_pages.asp?remote={{remoteName}}">{{title}} Pages</a>
<a target="_top" href="git_gui_clients.asp?remote={{remoteName}}" class="not-wired">Git GUI Clients</a>
<br>
<h2 class="left"><span class="left_h2">Git</span> Contribute</h2>
<a target="_top" href="git_remote_fork.asp?remote={{remoteName}}">{{title}} Fork</a>
<a target="_top" href="git_clone.asp?remote={{remoteName}}">Git Clone from {{title}}</a>
<a target="_top" href="git_remote_send_pull_request.asp?remote={{remoteName}}" class="not-wired">{{title}} Send Pull Request</a>
<br>
<h2 class="left"><span class="left_h2">Git</span> Undo</h2>
<a target="_top" href="git_revert.asp?remote={{remoteName}}">Git Revert</a>
<a target="_top" href="git_reset.asp?remote={{remoteName}}">Git Reset</a>
<a target="_top" href="git_amend.asp?remote={{remoteName}}">Git Amend</a>
<a target="_top" href="git_rebase.asp?remote={{remoteName}}">Git Rebase</a>
<a target="_top" href="git_reflog.asp?remote={{remoteName}}">Git Reflog</a>
<a target="_top" href="git_recovery.asp?remote={{remoteName}}" class="not-wired">Git Recovery</a>
<br>
<h2 class="left"><span class="left_h2">Git</span> Advanced</h2>
<a target="_top" href="git_ignore.asp?remote={{remoteName}}">Git .gitignore</a>
<a target="_top" href="git_gitattributes.asp?remote={{remoteName}}">Git .gitattributes</a>
<a target="_top" href="git_lfs.asp?remote={{remoteName}}">Git Large File Storage (LFS)</a>
<a target="_top" href="git_signing.asp?remote={{remoteName}}">Git Signing Commits/Tags</a>
<a target="_top" href="git_cherrypick_patch.asp?remote={{remoteName}}">Git Cherrypick & Patch</a>
<a target="_top" href="git_merge_conflicts.asp?remote={{remoteName}}">Git Merge Conflicts</a>
<a target="_top" href="git_cicd.asp?remote={{remoteName}}">Git CI/CD</a>
<a target="_top" href="git_hooks.asp?remote={{remoteName}}">Git Hooks</a>
<a target="_top" href="git_submodules.asp?remote={{remoteName}}">Git Submodules</a>
<a target="_top" href="git_remote_advanced.asp?remote={{remoteName}}" class="not-wired">Git Remote Advanced</a>
<br>
<h2 class="left"><span class="left_h2">Git</span> Cert</h2>
<a target="_top" class="no-checkmark" href="git_exam.asp?remote={{remoteName}}">Git Certificate</a>
<br>
<h2 class="left"><span class="left_h2">Git</span> Exercises</h2>
<a target="_top" class="no-checkmark" href="git_exercises.asp?remote={{remoteName}}">Git Exercises</a>
<a target="_top" class="no-checkmark" href="git_quiz.asp?remote={{remoteName}}">Git Quiz</a>
<a target="_top" class="no-checkmark" href="git_syllabus.asp?remote={{remoteName}}">Git Syllabus</a>
<a target="_top" class="no-checkmark" href="git_study_plan.asp?remote={{remoteName}}">Git Study Plan</a>
...
<a class="w3-left w3-btn" href="/default.asp?remote={{remoteName}}">&#10094; Home</a>
<a class="w3-right w3-btn" href="git_intro.asp?remote={{remoteName}}">Next &#10095;</a>
</div>
  ...
  <div class="cert-card">
    <div class="cert-card-header">
      <div class="cert-card-icon">
        <svg xmlns="http://www.w3.org/2000/svg" width="39" height="39" fill="#F05032" viewBox="0 0 24 24"><path d="M23.546 10.93L13.067.452c-.604-.603-1.582-.603-2.188 0L8.708 2.627l2.76 2.76c.645-.215 1.379-.07 1.889.441.516.515.658 1.258.438 1.9l2.658 2.66c.645-.223 1.387-.078 1.9.435.721.72.721 1.884 0 2.604-.719.719-1.881.719-2.6 0-.539-.541-.674-1.337-.404-1.996L12.86 8.955v6.525c.176.086.342.203.488.348.713.721.713 1.883 0 2.6-.719.721-1.889.721-2.609 0-.719-.719-.719-1.879 0-2.598.182-.18.387-.316.605-.406V8.835c-.217-.091-.424-.222-.6-.401-.545-.545-.676-1.342-.396-2.009L7.636 3.7.45 10.881c-.6.605-.6 1.584 0 2.189l10.48 10.477c.604.604 1.582.604 2.186 0l10.43-10.43c.605-.603.605-1.582 0-2.187"/></svg>
      </div>
      <h2 class="cert-card-title">Learn Git</h2>
    </div>
    <p class="cert-card-desc">Git is a free, open source tool that helps you save and manage different versions of your files and code.</p>
    <p class="cert-card-desc">With Git, you can work with others, keep track of changes, and undo mistakes.</p>
    <div class="cert-card-bottom" style="margin-top:auto;padding-top:16px;">
      <a href="git_intro.asp" class="cert-card-btn">Learn Git now &#10095;</a>
    </div>
  </div>

  <div class="cert-info" style="padding:24px;display:flex;flex-direction:column;">
    <h3 class="cert-info-title">Become Git Certified</h3>
    <p class="cert-info-desc">Get certified with our Git exam, includes a professionally curated study kit to guide you from beginner to exam-ready.</p>
...
<a href="https://campus.w3schools.com/collections/course-catalog/products/learn-git" class="cert-card-btn cert-btn-white" target="_blank" style="margin-top:12px;background:#fff;color:#000;border:2px solid #000;">Get Certified &#10095;</a>
        </div>
        <div class="cert-preview" style="flex:1 1 auto;padding:0;align-self:flex-start;">
          <svg class="cert-preview-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 560 400" role="img" aria-label="Git Certificate preview" style="width:100%;max-width:250px;height:auto;display:block;margin:0 0 0 auto;">
            ...
            <text x="280" y="212" text-anchor="middle" font-family="Source Sans Pro Topnav, sans-serif" font-size="13" fill="#475569">has passed the W3Schools Git Certification exam and is hereby declared a</text>
            <g transform="translate(248,222)">
              <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="#F05032" viewBox="0 0 24 24"><path d="M23.546 10.93L13.067.452c-.604-.603-1.582-.603-2.188 0L8.708 2.627l2.76 2.76c.645-.215 1.379-.07 1.889.441.516.515.658 1.258.438 1.9l2.658 2.66c.645-.223 1.387-.078 1.9.435.721.72.721 1.884 0 2.604-.719.719-1.881.719-2.6 0-.539-.541-.674-1.337-.404-1.996L12.86 8.955v6.525c.176.086.342.203.488.348.713.721.713 1.883 0 2.6-.719.721-1.889.721-2.609 0-.719-.719-.719-1.879 0-2.598.182-.18.387-.316.605-.406V8.835c-.217-.091-.424-.222-.6-.401-.545-.545-.676-1.342-.396-2.009L7.636 3.7.45 10.881c-.6.605-.6 1.584 0 2.189l10.48 10.477c.604.604 1.582.604 2.186 0l10.43-10.43c.605-.603.605-1.582 0-2.187"/></svg>
            </g>
            <text x="280" y="300" text-anchor="middle" font-family="Source Sans Pro Topnav, sans-serif" font-size="18" font-weight="700" fill="#0f172a">Certified Git Developer</text>
...
<p>Git works on your computer, but you also use it with online services like <strong>GitHub</strong>, <strong>GitLab</strong>, or <strong>Bitbucket</strong> to share your work with others. These are called <strong>remote repositories</strong>.</p>
<p>In this tutorial, you'll learn how to use Git for your own projects and how to connect with remote repositories online.</p>
...
<p>For new users, using the terminal view can seem a bit complicated.</p>
<p>Don't worry! We will keep it really simple, and learning this way gives you a good grasp of how Git works.</p>
...
<p>In general, lines with <code class="language-shell">$</code> in front of it is input.</p>
<p>These are the commands you can copy and run in your terminal.</p>
<hr>
<div class="w3-panel ws-info">
  <p><strong>Tip for Beginners:</strong> Don't worry about making mistakes!</p>
  <p>When you use Git on your own computer, you can't really break anything important.</p>
  <p>Experimenting is a great way to learn, and you can always undo or redo changes as you go.</p>
</div>
<hr>
...
<hr>
<a href="?remote=github"><img src="img_remote_github.png" alt="Shift focus to GitHub" style="height:100%;max-height:25px;margin:auto;margin-right:10px;">GitHub</a>
<a href="?remote=bitbucket"><img src="img_remote_bitbucket.png" alt="Shift focus to Bitbucket" style="height:100%;max-height:25px;margin-right:10px;">Bitbucket</a>
<a href="?remote=gitlab"><img src="img_remote_gitlab.png" alt="Shift focus to GitLab" style="height:100%;max-height:25px;margin-right:10px;">GitLab</a>
</div>
</div>
<h2>What Changes When You Switch Platform?</h2>
<p>The tutorial can show examples for GitHub, GitLab, or Bitbucket.</p>
<p>The Git commands are mostly the same, but some steps (like connecting to a remote or pushing code) might look a little different depending on the platform you choose.</p>
<p>Use the menu to see examples for each platform.</p>
<hr style="clear:both">

<h2>Why Practice with Exercises?</h2>
<p>Practicing with exercises helps you remember the commands and understand how Git works.</p>
<p>Try the exercises and quiz to test your knowledge!</p>
<div id="exercisecontainer" src="xrcise_install.js" data-extensions="asp"></div>
<hr>
<h2>Git Quiz</h2>
<p>Test your Git skills with a quiz.</p>
<p><a href="git_quiz.asp?remote={{remoteName}}" class="w3-button w3-blue w3-round">Start Git Quiz</a></p>
<hr>
