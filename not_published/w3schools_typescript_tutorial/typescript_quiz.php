...
<meta property="og:description" content="You can test your TypeScript skills with W3Schools' Quiz.">  
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>TypeScript <span class="color_h1">Quiz</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="typescript_exercises.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="typescript_practice.php">Next &#10095;</a>
</div>
<hr>
<p class="intro">You can test your TypeScript skills with W3Schools' Quiz.</p>
<hr><h2>The Test</h2>
<p>The test contains 25 questions and there is no time limit.</p>
<p>The test is not official, it's just a nice way to see how much you know, or don't know, about TypeScript.</p>
<h2>Count Your Score</h2>
<p>You will get 1 point for
each correct answer.</p>
<p>At the end of the Quiz, your total score will be displayed.
Maximum score is 25 points.</p>
<div class="ws-grey w3-round w3-padding w3-margin-top">
<h2>Start the Quiz</h2>
<p>Good luck!</p>
<p><a href='/quiztest/quiztest.php?qtest=TS' class="w3-btn w3-blue w3-round" style="margin-top:10px;padding:17px;font-size:17px">Start the TypeScript Quiz &#10095;</a></p>
</div>
