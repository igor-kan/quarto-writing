...
<head>
<title>TypeScript Union Types</title>
<meta property="og:description" content="Union types are used when a value can be more than a single type. Such as when a property would be string or number.">  
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>TypeScript Union Types</h1>

<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="typescript_aliases_and_interfaces.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="typescript_functions.php">Next &#10095;</a>
</div>

<hr>

<p><strong>Union types</strong> are used when a value can be more than a single type.</p>
<p>Such as when a property would be <code class="w3-codespan">string</code> or <code class="w3-codespan">number</code>.</p>

<hr>

<h2>Union | (OR)</h2>
<p>Using the <code class="w3-codespan">|</code> we are saying our parameter is a <code class="w3-codespan">string</code> or <code class="w3-codespan">number</code>:</p>

<div class="w3-example">
<h3>Example</h3>

<div class="w3-code notranslate jsHigh">
function printStatusCode(code: string | number) {<br>
&nbsp;&nbsp;console.log(`My status code is ${code}.`)<br>
}<br>
printStatusCode(404);<br>
printStatusCode('404');
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_or" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<h2>Union Type Errors</h2>

<p><strong>Note:</strong> you need to know what your type is when union types are being used to avoid type errors:</p>
...
<div class="w3-code notranslate jsHigh">
function printStatusCode(code: string | number) {<br>
&nbsp;&nbsp;console.log(`My status code is ${code.toUpperCase()}.`) // error: Property 'toUpperCase' does not exist on type 'string | number'. Property 'toUpperCase' does not exist on type 'number'<br>
}
</div>

<p>In our example we are having an issue invoking <code class="w3-codespan">toUpperCase()</code> as its a
<code class="w3-codespan">string</code> method and <code class="w3-codespan">number</code> doesn't have access
to it.
</p>

<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_or_error" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_union_types.js" data-extensions="php"></div>
<hr>
<br>
