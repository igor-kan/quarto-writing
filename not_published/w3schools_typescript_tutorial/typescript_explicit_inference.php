...
<head>
<title>TypeScript Explicit Types and Inference</title>
<meta property="og:description" content="Learn about TypeScript's type annotations and inference with clear examples and best practices.">  
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>TypeScript Explicit Types and Inference</h1>

<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="typescript_simple_types.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="typescript_special_types.php">Next &#10095;</a>
</div>

<hr>
<h2 id="type-annotations">Type Annotations and Inference</h2>

<p>TypeScript offers two ways to work with types:</p>

<ol>
<li><strong>Explicit Typing</strong>: You explicitly declare the type of a variable</li>
<li><strong>Type Inference</strong>: TypeScript automatically determines the type based on the assigned value</li>
</ol>

<h3>When to Use Each Approach</h3>
<ul>
<li>Use <strong>explicit types</strong> for:
  <ul>
    <li>Function parameters and return types</li>
    <li>Object literals</li>
    <li>When the initial value might not be the final type</li>
  </ul>
</li>
<li>Use <strong>type inference</strong> for:
  <ul>
    <li>Simple variable declarations with immediate assignment</li>
    <li>When the type is obvious from the context</li>
  </ul>
</li>
</ul>
...
<h2 id="explicit-types">Explicit Type Annotations</h2>

<p>Explicit typing means you tell TypeScript exactly what type a variable should be:</p>

<div class="w3-example">
<h4>Basic Explicit Types</h4>
<div class="w3-code notranslate jsHigh">
// String<br>
greeting: string = "Hello, TypeScript!";<br><br>
// Number<br>
userCount: number = 42;<br><br>
// Boolean<br>
isLoading: boolean = true;<br><br>
// Array of numbers<br>
scores: number[] = [100, 95, 98];
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_simple_explicit_types_basic" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-info">
<p><strong>Best Practice:</strong> Use explicit types for function parameters and return types to make your code more maintainable and self-documenting.</p>
</div>

<div class="w3-example">
<h4>Function with Explicit Types</h4>
<div class="w3-code notranslate jsHigh">
// Function with explicit parameter and return types<br>
function greet(name: string): string {<br>
return `Hello, ${name}!`;<br>
}<br><br>
// TypeScript will ensure you pass the correct argument type<br>
greet("Alice"); // OK<br>
greet(42);&nbsp;&nbsp;&nbsp;&nbsp; // Error: Argument of type '42' is not assignable to parameter of type 'string'
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_simple_explicit_function_types" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2 id="type-inference">Type Inference</h2>

<p>TypeScript can automatically determine (infer) the type of a variable based on its initial value:</p>

<div class="w3-example">
<h4>Basic Type Inference</h4>
<div class="w3-code notranslate jsHigh">
// TypeScript infers 'string'<br>
let username = "alice";<br><br>
// TypeScript infers 'number'<br>
let score = 100;<br><br>
// TypeScript infers 'boolean[]'<br>
let flags = [true, false, true];<br><br>
// TypeScript infers return type as 'number'<br>
function add(a: number, b: number) {<br>
return a + b;<br>
}
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_simple_type_inference_basic" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> Type inference works best when variables are initialized at declaration.</p>
<p>Uninitialized variables have type 'any' by default unless you enable <code class="w3-codespan">strictNullChecks</code> in your tsconfig.json.</p>
</div>

<h3>When Inference Shines</h3>

<div class="w3-example">
<h4>Object Literal Inference</h4>
<div class="w3-code notranslate jsHigh">
// TypeScript infers the shape of the object<br>
const user = {<br>
name: "Alice",<br>
age: 30,<br>
isAdmin: true<br>
};<br><br>
// TypeScript knows these properties exist<br>
console.log(user.name);&nbsp;&nbsp;// OK<br>
console.log(user.email); // Error: Property 'email' does not exist
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_simple_object_inference" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-warning">
<p><strong>Watch Out:</strong> While type inference is convenient, being explicit with types can make your code more maintainable, especially in larger codebases or public APIs.</p>
</div>
...
<h2 id="type-safety">Type Safety in Action</h2>

<p>One of TypeScript's main benefits is catching type-related errors during development.</p>
<p>Let's look at how TypeScript helps prevent common mistakes.</p>

<h3>Type Mismatch Errors</h3>

<div class="w3-example">
<h4>Explicit Type Mismatch</h4>
<div class="w3-code notranslate jsHigh">
let username: string = "alice";<br>
username = 42; // Error: Type 'number' is not assignable to type 'string'
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_simple_type_mismatch_explicit" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h4>Implicit Type Mismatch</h4>
<div class="w3-code notranslate jsHigh">
let score = 100;&nbsp;&nbsp;// TypeScript infers 'number'<br>
score = "high";&nbsp;&nbsp;// Error: Type 'string' is not assignable to type 'number'
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_simple_type_mismatch_implicit" target="_blank">Try it Yourself &raquo;</a>
</div>

<h3>JavaScript vs TypeScript</h3>

<p>In JavaScript, the following code would run without errors, potentially causing bugs:</p>

<div class="w3-example">
<h4>JavaScript Behavior</h4>
<div class="w3-code notranslate jsHigh">
// This is valid JavaScript but can lead to bugs<br>
function add(a, b) {<br>
return a + b;<br>
}<br><br>
...
<p>TypeScript catches these issues at compile time:</p>

<div class="w3-example">
<h4>TypeScript Type Safety</h4>
<div class="w3-code notranslate jsHigh">
...
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_simple_typescript_safety" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>When TypeScript Can't Infer Types</h2>

<p>While TypeScript's type inference is powerful, there are cases where it can't determine the correct type.</p>
<p>In these situations, TypeScript falls back to the <code class="w3-codespan">any</code> type, which disables type checking.</p>
<div class="w3-panel ws-note">
<p><strong>Note:</strong> <code class="w3-codespan">any</code> and other Special Types are covered in more detail in the next chapter.</p>
</div>

<div class="w3-example">
<h4>Common Cases for <code class="w3-codespan">any</code></h4>
<div class="w3-code notranslate jsHigh">
// 1. JSON.parse returns 'any' because the structure isn't known at compile time<br>
const data = JSON.parse('{ "name": "Alice", "age": 30 }');<br><br>
// 2. Variables declared without initialization<br>
let something;&nbsp;&nbsp;// Type is 'any'<br>
something = 'hello';<br>
something = 42;&nbsp;&nbsp;// No error
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_simple_any_type" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel">
<h4>Avoid <code class="w3-codespan">any</code> When Possible</h4>
<p>Using <code class="w3-codespan">any</code> disables TypeScript's type checking.</p>
<p>Instead, consider these alternatives:</p>
<ul>
  <li>Use type annotations</li>
  <li>Create interfaces for complex objects</li>
  <li>Use type guards for runtime type checking</li>
  <li>Enable <code class="w3-codespan">noImplicitAny</code> in your <code class="w3-codespan">tsconfig.json</code></li>
</ul>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_explicit_inference.js" data-extensions="php"></div>
