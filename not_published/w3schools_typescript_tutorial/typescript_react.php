...
<html lang="en-US">
<head>
  <title>TypeScript with React - W3Schools</title>
  <meta name="description" content="Master TypeScript with React through comprehensive examples and best practices. Learn to build type-safe React applications with confidence.">
  <meta property="og:description" content="Learn how to use TypeScript with React for robust, type-safe front-end development with comprehensive examples and best practices.">
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="typescript_nodejs.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="typescript_tooling.php">Next &#10095;</a>
</div>
<hr>

<h2>Why Use TypeScript with React?</h2>
<p>TypeScript enhances React with:</p>
<ul>
  <li>Type safety for props, state, and context</li>
  <li>Better IDE autocompletion and refactoring</li>
  <li>Early error detection during development</li>
</ul>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> This tutorial assumes basic knowledge of React.</p>
  <p>If you're new to React, consider checking out our <a href="/react/react_intro.asp">React Tutorial</a> first.</p>
</div>

<hr>

<h2>Getting Started</h2>
<p>Create a new React + TypeScript app with Vite:</p>
...
<p>Your <code class="w3-codespan">tsconfig.json</code> should include these recommended compiler options:</p>
...
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> Keep <code class="w3-codespan">strict</code> enabled for best type safety.</p>
<p>The shown options work well with Vite and Create React App.</p>
</div>
<hr>
<h2>Component Typing</h2>
<p>Define props with TypeScript and use them in a functional component:</p>
<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate jsHigh">
// Greeting.tsx<br>
 ...
 <br>
 export function Greeting({ name, age }: GreetingProps) {<br>
 &nbsp;&nbsp;return (<br>
 &nbsp;&nbsp;&nbsp;&nbsp;&lt;div&gt;<br>
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;h2&gt;Hello, {name}!&lt;/h2&gt;<br>
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{age !== undefined && &lt;p&gt;You are {age} years old&lt;/p&gt;}<br>
 &nbsp;&nbsp;&nbsp;&nbsp;&lt;/div&gt;<br>
 &nbsp;&nbsp;);<br>
 }<br>
  </div>
...
<p>Type event handlers for inputs and buttons:</p>
<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate jsHigh">
// Input change<br>
 function NameInput() {<br>
 &nbsp;&nbsp;function handleChange(e: React.ChangeEvent&lt;HTMLInputElement&gt;) {<br>
 &nbsp;&nbsp;&nbsp;&nbsp;console.log(e.target.value);<br>
 &nbsp;&nbsp;}<br>
 &nbsp;&nbsp;return &lt;input onChange={handleChange} /&gt;;<br>
 }<br>
 <br>
 // Button click<br>
 function SaveButton() {<br>
 &nbsp;&nbsp;function handleClick(e: React.MouseEvent&lt;HTMLButtonElement&gt;) {<br>
 &nbsp;&nbsp;&nbsp;&nbsp;e.preventDefault();<br>
 &nbsp;&nbsp;}<br>
 &nbsp;&nbsp;return &lt;button onClick={handleClick}&gt;Save&lt;/button&gt;;<br>
 }<br>
  </div>
</div>

<h3>Typing State with useState</h3>
<p>Use explicit types for numbers, unions, and nullable values:</p>
<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate jsHigh">
const [count, setCount] = React.useState&lt;number&gt;(0);<br>
 const [status, setStatus] = React.useState&lt;'idle' | 'loading' | 'error'&gt;('idle');<br>
 <br>
 type User = { id: string; name: string };<br>
 const [user, setUser] = React.useState&lt;User | null&gt;(null);<br>
  </div>
</div>

<h3>useRef with DOM Elements</h3>
<p>Type refs to DOM nodes to access properties safely:</p>
<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate jsHigh">
function FocusInput() {<br>
 &nbsp;&nbsp;const inputRef = React.useRef&lt;HTMLInputElement&gt;(null);<br>
 &nbsp;&nbsp;return &lt;input ref={inputRef} onFocus={() =&gt; inputRef.current?.select()} /&gt;;<br>
 }<br>
  </div>
</div>

<h3>Children Typing</h3>
<p>Accept children with the <code class="w3-codespan">React.ReactNode</code> type:</p>
<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate jsHigh">
 type CardProps = { title: string; children?: React.ReactNode };<br>
 function Card({ title, children }: CardProps) {<br>
 &nbsp;&nbsp;return (<br>
 &nbsp;&nbsp;&nbsp;&nbsp;&lt;div&gt;<br>
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;h2&gt;{title}&lt;/h2&gt;<br>
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{children}<br>
...
<h3>Fetch Helpers with Generics</h3>
<p>Use generics to type API responses:</p>
<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate jsHigh">
async function fetchJson&lt;T&gt;(url: string): Promise&lt;T&gt; {<br>
 &nbsp;&nbsp;const res = await fetch(url);<br>
 &nbsp;&nbsp;if (!res.ok) throw new Error('Network error');<br>
 &nbsp;&nbsp;return res.json() as Promise&lt;T&gt;;<br>
 }<br>
 <br>
 // Usage inside an async function/component effect<br>
 async function loadPosts() {<br>
 &nbsp;&nbsp;type Post = { id: number; title: string };<br>
 &nbsp;&nbsp;const posts = await fetchJson&lt;Post[]&gt;("/api/posts");<br>
 &nbsp;&nbsp;console.log(posts);<br>
 }<br>
  </div>
</div>

<h3>Minimal Context and Custom Hook</h3>
<p>Provide a small, typed context and a helper hook:</p>
<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate jsHigh">
 type Theme = 'light' | 'dark';<br>
 const ThemeContext = React.createContext&lt;{ theme: Theme; toggle(): void } | null&gt;(null);<br>
 <br>
 function ThemeProvider({ children }: { children: React.ReactNode }) {<br>
 &nbsp;&nbsp;const [theme, setTheme] = React.useState&lt;Theme&gt;('light');<br>
 &nbsp;&nbsp;const value = { theme, toggle: () =&gt; setTheme(t =&gt; (t === 'light' ? 'dark' : 'light')) };<br>
 &nbsp;&nbsp;return &lt;ThemeContext.Provider value={value}&gt;{children}&lt;/ThemeContext.Provider&gt;;<br>
 }<br>
 <br>
 function useTheme() {<br>
 &nbsp;&nbsp;const ctx = React.useContext(ThemeContext);<br>
 &nbsp;&nbsp;if (!ctx) throw new Error('useTheme must be used within ThemeProvider');<br>
 &nbsp;&nbsp;return ctx;<br>
 }<br>
  </div>
</div>
...
<div class="w3-panel ws-note">
<p><strong>Vite TypeScript types:</strong> Add Vite's ambient types to avoid missing definitions.</p>
  <div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate jsHigh">
// src/vite-env.d.ts<br>
/// &lt;reference types=&quot;vite/client&quot; /&gt;<br>
  </div>
  </div>
  <p>Alternatively, add to <code class="w3-codespan">tsconfig.json</code>:</p>
  <div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate jsHigh">
{<br>
  &nbsp;&nbsp;"compilerOptions": {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;"types": ["vite/client"]<br>
  &nbsp;&nbsp;}<br>
}
  </div>
  </div>
...
<div class="w3-panel ws-note">
  <p><strong>About React.FC:</strong> Prefer directly typed function components.</p>
<p><code class="w3-codespan">React.FC</code> is optional; it implicitly adds <code class="w3-codespan">children</code> but isn't required.</p>
</div>

  <div class="w3-panel ws-note">
<p><strong>Optional <code class="w3-codespan">baseUrl</code> and <code class="w3-codespan">paths</code>:</strong> These can simplify imports if supported by your bundler.</p>
  <div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate jsHigh">
{<br>
...
<p>Configure only if your tooling (e.g., Vite, tsconfig-paths) is set up for path aliases.</p>
</div>

<div id="exercisecontainer" src="xrcise_react.js" data-extensions="php"></div>
