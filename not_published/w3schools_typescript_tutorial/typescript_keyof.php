...
<meta property="og:description" content="keyof is a keyword in TypeScript which is used to extract the key type from an object type.">  
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>TypeScript Keyof</h1>

<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="typescript_utility_types.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="typescript_null.php">Next &#10095;</a>
</div>

<hr>
<p><code class="w3-codespan">keyof</code> is a keyword in TypeScript which is used to extract the key type from an object type.</p>

<hr>
<h2><code class="w3-codespan">keyof</code> with explicit keys</h2>

<p>When used on an object type with explicit keys, <code class="w3-codespan">keyof</code> creates a union type with those keys.</p>
...
// `keyof Person` here creates a union type of "name" and "age", other strings will not be allowed<br>
function printPersonProperty(person: Person, property: keyof Person) {<br>
&nbsp;&nbsp;console.log(`Printing person property ${property}: "${person[property]}"`);<br>
}<br>
let person = {<br>
&nbsp;&nbsp;name: "Max",<br>
&nbsp;&nbsp;age: 27<br>
};<br>
printPersonProperty(person, "name"); // Printing person property name: "Max"<br>
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_keyof_explicit" target="_blank">Try it Yourself &raquo;</a>  
</div>
...
<h2><code class="w3-codespan">keyof</code> with index signatures</h2>

<p><code class="w3-codespan">keyof</code> can also be used with index signatures to extract the index type.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
type StringMap = { [key: string]: unknown };<br>
// `keyof StringMap` resolves to `string` here<br>
function createStringPair(property: keyof StringMap, value: string): StringMap {<br>
&nbsp;&nbsp;return { [property]: value };<br>
}<br>
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_keyof_index_signature" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_keyof.js" data-extensions="php"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="typescript_utility_types.php">&#10094; Previous</a>
