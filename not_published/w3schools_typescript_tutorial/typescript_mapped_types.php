...
<meta property="og:description" content="TypeScript Mapped Types allow you to create new types by transforming properties of existing types.">  
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="typescript_conditional_types.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="typescript_type_inference.php">Next &#10095;</a>
</div>

<hr>

<p>Mapped types in TypeScript allow you to create new types by transforming properties of existing types.</p>

  <ul>
    <li><b>Mapped types</b> = transform every property of a type</li>
    <li>Common ones: <code class="w3-codespan">Partial</code>, <code class="w3-codespan">Readonly</code>, <code class="w3-codespan">Pick</code>, <code class="w3-codespan">Omit</code>, <code class="w3-codespan">Record</code></li>
  </ul>
...
type ReadonlyPerson = { readonly [P in keyof Person]: Person[P] };<br>
</div>
</div>
...
<h2>Basic Mapped Type Syntax</h2>

<h3>Core Syntax</h3>

<p>Mapped types use the syntax <code class="w3-codespan">{ [P in K]: T }</code> where:</p>
<ul>
  <li><code class="w3-codespan">P</code> is the property name being iterated</li>
  <li><code class="w3-codespan">K</code> is a union of property names to iterate over</li>
  <li><code class="w3-codespan">T</code> is the resulting type for each property</li>
</ul>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Define an object type<br>
interface Person {<br>
&nbsp;&nbsp;name: string;<br>
&nbsp;&nbsp;age: number;<br>
&nbsp;&nbsp;email: string;<br>
...
<br>
// Create a mapped type that makes all properties optional<br>
type PartialPerson = {<br>
&nbsp;&nbsp;[P in keyof Person]?: Person[P];<br>
};<br>
<br>
// Usage<br>
const partialPerson: PartialPerson = {<br>
&nbsp;&nbsp;name: "John"<br>
&nbsp;&nbsp;// age and email are optional<br>
};<br>
<br>
// Create a mapped type that makes all properties readonly<br>
type ReadonlyPerson = {<br>
&nbsp;&nbsp;readonly [P in keyof Person]: Person[P];<br>
};<br>
<br>
// Usage<br>
const readonlyPerson: ReadonlyPerson = {<br>
&nbsp;&nbsp;name: "Alice",<br>
&nbsp;&nbsp;age: 30,<br>
...
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_mapped_types_basic" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Built-in Mapped Types</h2>

<h3>Standard Library Utilities</h3>

<p>TypeScript includes several useful built-in mapped types:</p>

<ul>
  <li><code class="w3-codespan">Partial&lt;T&gt;</code>: make all props optional</li>
  <li><code class="w3-codespan">Readonly&lt;T&gt;</code>: make all props readonly</li>
  <li><code class="w3-codespan">Pick&lt;T, K&gt;</code>: select a subset of keys</li>
  <li><code class="w3-codespan">Omit&lt;T, K&gt;</code>: remove keys</li>
  <li><code class="w3-codespan">Record&lt;K, V&gt;</code>: map keys to a value type</li>
</ul>
...
<br>
// Partial&lt;T&gt; - Makes all properties optional<br>
type PartialUser = Partial&lt;User&gt;;<br>
// Equivalent to: { id?: number; name?: string; email?: string; isAdmin?: boolean; }<br>
<br>
// Required&lt;T&gt; - Makes all properties required<br>
type RequiredUser = Required&lt;Partial&lt;User&gt;&gt;;<br>
// Equivalent to: { id: number; name: string; email: string; isAdmin: boolean; }<br>
<br>
// Readonly&lt;T&gt; - Makes all properties readonly<br>
type ReadonlyUser = Readonly&lt;User&gt;;<br>
// Equivalent to: { readonly id: number; readonly name: string; ... }<br>
<br>
// Pick&lt;T, K&gt; - Creates a type with a subset of properties from T<br>
type UserCredentials = Pick&lt;User, "email" | "id"&gt;;<br>
// Equivalent to: { email: string; id: number; }<br>
<br>
// Omit&lt;T, K&gt; - Creates a type by removing specified properties from T<br>
type PublicUser = Omit&lt;User, "id" | "isAdmin"&gt;;<br>
// Equivalent to: { name: string; email: string; }<br>
<br>
// Record&lt;K, T&gt; - Creates a type with specified keys and value types<br>
type UserRoles = Record&lt;"admin" | "user" | "guest", string&gt;;<br>
// Equivalent to: { admin: string; user: string; guest: string; }
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_mapped_types_builtin" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Creating Custom Mapped Types</h2>
<h3>Basic Custom Mappers</h3>

<p>You can create your own mapped types to transform types in specific ways:</p>
...
<br>
// Create a mapped type to convert all properties to string type<br>
type StringifyProperties&lt;T&gt; = {<br>
&nbsp;&nbsp;[P in keyof T]: string;<br>
};<br>
<br>
// Usage<br>
type StringProduct = StringifyProperties&lt;Product&gt;;<br>
// Equivalent to: { id: string; name: string; price: string; inStock: string; }<br>
<br>
// Create a mapped type that adds validation functions for each property<br>
type Validator&lt;T&gt; = {<br>
&nbsp;&nbsp;[P in keyof T]: (value: T[P]) => boolean;<br>
};<br>
<br>
// Usage<br>
const productValidator: Validator&lt;Product&gt; = {<br>
&nbsp;&nbsp;id: (id) => id > 0,<br>
&nbsp;&nbsp;name: (name) => name.length > 0,<br>
&nbsp;&nbsp;price: (price) => price >= 0,<br>
&nbsp;&nbsp;inStock: (inStock) => typeof inStock === "boolean"<br>
};
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_mapped_types_custom" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Modifying Property Modifiers</h2>
<h3>Adding and Removing Modifiers</h3>

<p>Mapped types also allow you to add or remove property modifiers like <code class="w3-codespan">readonly</code> and <code class="w3-codespan">?</code> (optional):</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Base interface with some readonly and optional properties<br>
interface Configuration {<br>
&nbsp;&nbsp;readonly apiKey: string;<br>
&nbsp;&nbsp;readonly apiUrl: string;<br>
&nbsp;&nbsp;timeout?: number;<br>
&nbsp;&nbsp;retries?: number;<br>
}<br>
<br>
// Remove readonly modifier from all properties<br>
type Mutable&lt;T&gt; = {<br>
&nbsp;&nbsp;-readonly [P in keyof T]: T[P];<br>
};<br>
<br>
// Usage<br>
type MutableConfig = Mutable&lt;Configuration&gt;;<br>
// Equivalent to: { apiKey: string; apiUrl: string; timeout?: number; retries?: number; }<br>
<br>
// Make all optional properties required<br>
type RequiredProps&lt;T&gt; = {<br>
&nbsp;&nbsp;[P in keyof T]-?: T[P];<br>
};<br>
<br>
// Usage<br>
type RequiredConfig = RequiredProps&lt;Configuration&gt;;<br>
// Equivalent to: { readonly apiKey: string; readonly apiUrl: string; timeout: number; retries: number; }
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_mapped_types_modifiers" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Advanced Mapped Types</h2>
<h3>Combining with Conditional Types</h3>

<p>Mapped types become even more powerful when combined with conditional types:</p>
...
<br>
// Conditional mapped type: Convert each numeric property to a formatted string<br>
type FormattedResponse&lt;T&gt; = {<br>
&nbsp;&nbsp;[P in keyof T]: T[P] extends number ? string : T[P];<br>
};<br>
<br>
// Usage<br>
type FormattedApiResponse = FormattedResponse&lt;ApiResponse&gt;;<br>
// Equivalent to: { data: unknown; status: string; message: string; timestamp: string; }<br>
<br>
// Another example: Filter for only string properties<br>
type StringPropsOnly&lt;T&gt; = {<br>
&nbsp;&nbsp;[P in keyof T as T[P] extends string ? P : never]: T[P];<br>
};<br>
<br>
// Usage<br>
type ApiResponseStringProps = StringPropsOnly&lt;ApiResponse&gt;;<br>
// Equivalent to: { message: string; }
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_mapped_types_conditional" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<p>Mapped types let you transform every property of a type in a consistent way.</p>

<div class="w3-panel">
  <h3>Key Concepts</h3>
  <ul>
    <li><b>Type Transformation</b>: Modify property types in bulk</li>
    <li><b>Property Modifiers</b>: Add or remove <code class="w3-codespan">readonly</code> and <code class="w3-codespan">?</code> modifiers</li>
    <li><b>Key Remapping</b>: Rename or filter properties using <code class="w3-codespan">as</code> clauses</li>
...
<div class="w3-panel">
  ...
  <ul>
    <li>Creating read-only versions of types</li>
    <li>Making all properties optional or required</li>
    <li>Transforming property types (e.g., to nullable or readonly)</li>
    <li>Filtering properties based on their types</li>
    <li>Creating type-safe utility functions</li>
  </ul>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_mapped_types.js" data-extensions="php"></div>
<hr>
<br>
