...
<meta property="og:description" content="TypeScript Conditional Types allow you to create types that depend on other types, similar to if statements in JavaScript.">  
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="typescript_type_guards.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="typescript_mapped_types.php">Next &#10095;</a>
</div>

<hr>

<h2>Understanding Conditional Types in TypeScript</h2>

<p>Conditional types in TypeScript enable you to create types that depend on other types, similar to how if-else statements work in JavaScript.</p>
<p>They're a powerful feature that allows for sophisticated type transformations and type-level programming.</p>
<hr>
<div class="w3-panel">
  <h3>Key Concepts</h3>
  <ul>
    <li><b>Type-level logic</b>: Perform conditional checks on types</li>
    <li><b>Type inference</b>: Extract and manipulate types using <code class="w3-codespan">infer</code></li>
    <li><b>Composition</b>: Combine with other TypeScript features</li>
    <li><b>Utility types</b>: Build powerful type utilities</li>
  </ul>
</div>
...
<div class="w3-panel">
  ...
  <ul>
    <li>Type-safe function overloading</li>
    <li>API response type transformations</li>
    <li>Complex type validations</li>
    <li>Building reusable type utilities</li>
...
<h2>Basic Conditional Type Syntax</h2>

<p>Conditional types use the form <code class="w3-codespan">T extends U ? X : Y</code>, which means:</p>
<p>"if type <code class="w3-codespan">T</code> extends (or is assignable to) type <code class="w3-codespan">U</code>, use type <code class="w3-codespan">X</code>, otherwise use type <code class="w3-codespan">Y</code>".</p>
...
<br>
// Usage examples<br>
type Result1 = IsString&lt;string&gt;;  // true<br>
type Result2 = IsString&lt;number&gt;;  // false<br>
type Result3 = IsString&lt;"hello"&gt;; // true (literal types extend their base types)<br>
<br>
// We can use this with variables too<br>
let a: IsString&lt;string&gt;; // a has type 'true'<br>
let b: IsString&lt;number&gt;; // b has type 'false'
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_conditional_types_basic" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<p>Conditional types are particularly useful with union types, where they're automatically distributed over union members:</p>
...
<br>
// When used with a union type, it applies to each member of the union<br>
type StringOrNumberArray = ToArray&lt;string | number&gt;;<br>
// This becomes ToArray&lt;string&gt; | ToArray&lt;number&gt;<br>
// Which becomes string[] | number[]<br>
<br>
// We can also extract specific types from a union<br>
type ExtractString&lt;T&gt; = T extends string ? T : never;<br>
type StringsOnly = ExtractString&lt;string | number | boolean | "hello"&gt;;<br>
// Result: string | "hello"
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_conditional_types_unions" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Type Inference with <code class="w3-codespan">infer</code></h2>

<h3>Extracting Types from Complex Structures</h3>

<p>The <code class="w3-codespan">infer</code> keyword allows you to declare a type variable within the condition part of a conditional type and then use it in the true branch of the condition:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Extract the return type of a function type<br>
type ReturnType&lt;T&gt; = T extends (...args: any[]) => infer R ? R : never;<br>
<br>
// Examples<br>
function greet() { return "Hello, world!"; }<br>
function getNumber() { return 42; }<br>
<br>
type GreetReturnType = ReturnType&lt;typeof greet&gt;;   // string<br>
type NumberReturnType = ReturnType&lt;typeof getNumber&gt;; // number<br>
<br>
// Extract element type from array<br>
type ElementType&lt;T&gt; = T extends (infer U)[] ? U : never;<br>
type NumberArrayElement = ElementType&lt;number[]&gt;; // number<br>
type StringArrayElement = ElementType&lt;string[]&gt;; // string
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_conditional_types_infer" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<h3>Standard Library Utilities</h3>

<p>TypeScript includes several built-in conditional types in its standard library:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Extract&lt;T, U&gt; - Extracts types from T that are assignable to U<br>
type OnlyStrings = Extract&lt;string | number | boolean, string&gt;; // string<br>
<br>
// Exclude&lt;T, U&gt; - Excludes types from T that are assignable to U<br>
type NoStrings = Exclude&lt;string | number | boolean, string&gt;; // number | boolean<br>
<br>
// NonNullable&lt;T&gt; - Removes null and undefined from T<br>
type NotNull = NonNullable&lt;string | null | undefined&gt;; // string<br>
<br>
// Parameters&lt;T&gt; - Extracts parameter types from a function type<br>
type Params = Parameters&lt;(a: string, b: number) => void&gt;; // [string, number]<br>
<br>
// ReturnType&lt;T&gt; - Extracts the return type from a function type<br>
type Return = ReturnType&lt;() => string&gt;; // string
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_conditional_types_predefined" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<p>Conditional types can be used recursively to create complex type transformations:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Deeply unwrap Promise types<br>
type UnwrapPromise&lt;T&gt; = T extends Promise&lt;infer U&gt; ? UnwrapPromise&lt;U&gt; : T;<br>
<br>
// Examples<br>
type A = UnwrapPromise&lt;Promise&lt;string&gt;&gt;;           // string<br>
type B = UnwrapPromise&lt;Promise&lt;Promise&lt;number&gt;&gt;&gt;;   // number<br>
type C = UnwrapPromise&lt;boolean&gt;;                   // boolean
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_conditional_types_recursive" target="_blank">Try it Yourself &raquo;</a>
</div>

<h3>Type-Level If-Else Chains</h3>
<p>Chain multiple conditions together for complex type logic:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
type TypeName&lt;T&gt; =<br>
...
<br>
// Usage<br>
type T0 = TypeName&lt;string&gt;;      // "string"<br>
type T1 = TypeName&lt;42&gt;;         // "number"<br>
type T2 = TypeName&lt;true&gt;;       // "boolean"<br>
type T3 = TypeName&lt;() => void&gt;; // "function"<br>
type T4 = TypeName&lt;Date[]&gt;;     // "object"
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_conditional_types_typename" target="_blank">Try it Yourself &raquo;</a>
</div>

<p>Conditional types are powerful when creating generic utilities and type-safe libraries:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// A function that returns different types based on input type<br>
function processValue&lt;T&gt;(value: T): T extends string<br>
&nbsp;&nbsp;? string<br>
&nbsp;&nbsp;: T extends number<br>
&nbsp;&nbsp;? number<br>
&nbsp;&nbsp;: T extends boolean<br>
&nbsp;&nbsp;? boolean<br>
&nbsp;&nbsp;: never {<br>
<br>
&nbsp;&nbsp;if (typeof value === "string") {<br>
&nbsp;&nbsp;&nbsp;&nbsp;return value.toUpperCase() as any; // Type assertion needed due to limitations<br>
&nbsp;&nbsp;} else if (typeof value === "number") {<br>
&nbsp;&nbsp;&nbsp;&nbsp;return (value * 2) as any;<br>
&nbsp;&nbsp;} else if (typeof value === "boolean") {<br>
&nbsp;&nbsp;&nbsp;&nbsp;return (!value) as any;<br>
&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;throw new Error("Unsupported type");<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
// Usage<br>
const stringResult = processValue("hello"); // Returns "HELLO" (type is string)<br>
const numberResult = processValue(10);      // Returns 20 (type is number)<br>
const boolResult = processValue(true);      // Returns false (type is boolean)<br>
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_conditional_types_practical" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-panel">
  ...
  <h3>Do:</h3>
  <ul>
    <li>Use conditional types for complex type transformations</li>
    <li>Combine with <code class="w3-codespan">infer</code> for type extraction</li>
    <li>Create reusable type utilities</li>
    <li>Document complex conditional types</li>
    <li>Test edge cases in your type definitions</li>
  </ul>

  <h3>Don't:</h3>
  <ul>
    <li>Overuse complex conditional types when simple types would suffice</li>
    <li>Create deeply nested conditional types that are hard to understand</li>
    <li>Forget about performance implications with very complex types</li>
    <li>Use conditional types for runtime logic</li>
  </ul>

  <h3>Performance Considerations</h3>
  <ul>
    <li>Deeply nested conditional types can increase compile times</li>
    <li>Consider using type aliases for intermediate results</li>
    <li>Be mindful of TypeScript's recursion depth limits</li>
  </ul>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_conditional_types.js" data-extensions="php"></div>
<hr>
<br>
