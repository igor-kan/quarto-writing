...
<head>
<title>TypeScript Null &amp; Undefined</title>
<meta property="og:description" content="TypeScript has a powerful system to deal with null or undefined values.">  
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="typescript_keyof.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="typescript_definitely_typed.php">Next &#10095;</a>
</div>

<hr>

<p>TypeScript has a powerful system to deal with <code class="w3-codespan">null</code> or <code class="w3-codespan">undefined</code> values.</p>

<div class="w3-panel ws-warning">
<p>By default <code class="w3-codespan">null</code> and <code class="w3-codespan">undefined</code> handling is disabled, and can be enabled by setting <code class="w3-codespan">strictNullChecks</code> to true.</p>
<p>The rest of this page applies for when <code class="w3-codespan">strictNullChecks</code> is enabled.</p>
</div>
...
<p><code class="w3-codespan">null</code> and <code class="w3-codespan">undefined</code> are primitive types and can be used like other types, such as <code class="w3-codespan">string</code>.</p>

<div class="w3-example">
<h3>Example</h3>

<div class="w3-code notranslate jsHigh">
let value: string | undefined | null = null;<br>
value = 'hello';<br>
value = undefined;<br>
</div>

<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_null_optional" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
<p>
When <code class="w3-codespan">strictNullChecks</code> is enabled, TypeScript requires values to be set
unless <code class="w3-codespan">undefined</code> is explicitly added to the type.
</p>
</div>
...
<p>Optional chaining is a JavaScript feature that works well with TypeScript's null handling.</p>
<p>It allows accessing properties on an object that may or may not exist, using compact syntax.</p>
<p>It can be used with the <code class="w3-codespan">?.</code> operator when accessing properties.</p>
...
function printYardSize(house: House) {<br>
&nbsp;&nbsp;const yardSize = house.yard?.sqft;<br>
&nbsp;&nbsp;if (yardSize === undefined) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('No yard');<br>
&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Yard is ${yardSize} sqft`);<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
let home: House = {<br>
...
<br>
printYardSize(home); // Prints 'No yard'<br>
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_null_chaining" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<p>Nullish coalescing is another JavaScript feature that also works well with TypeScript's null handling.</p>
<p>It allows writing expressions that have a fallback specifically when dealing with <code class="w3-codespan">null</code> or <code class="w3-codespan">undefined</code>.</p>
<p>This is useful when other falsy values can occur in the expression but are still valid.</p>
<p>It can be used with the <code class="w3-codespan">??</code> operator in an expression, similar to using the <code class="w3-codespan">&amp;&amp;</code> operator.</p>

<div class="w3-example">
<h3>Example</h3>

<div class="w3-code notranslate jsHigh">
function printMileage(mileage: number | null | undefined) {<br>
&nbsp;&nbsp;console.log(`Mileage: ${mileage ?? 'Not Available'}`);<br>
}<br>
<br>
printMileage(null); // Prints 'Mileage: Not Available'<br>
printMileage(0); // Prints 'Mileage: 0'<br>
</div>

<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_null_coalescence" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<p>TypeScript's inference system isn't perfect, there are times when it makes sense to ignore a value's possibility of being <code class="w3-codespan">null</code> or <code class="w3-codespan">undefined</code>.</p>
<p>An easy way to do this is to use casting, but TypeScript also provides the <code class="w3-codespan">!</code> operator as a convenient shortcut.</p>

<div class="w3-example">
<h3>Example</h3>

<div class="w3-code notranslate jsHigh">
function getValue(): string | undefined {<br>
&nbsp;&nbsp;return 'hello';<br>
}<br>
let value = getValue();<br>
console.log('value length: ' + value!.length);<br>
</div>

<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_null_assertion" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-warning">
<p>Just like casting, this can be unsafe and should be used with care.</p>
</div>
...
<p>Even with <code class="w3-codespan">strictNullChecks</code> enabled, by default TypeScript assumes array access will never return <code class="w3-codespan">undefined</code> (unless <code class="w3-codespan">undefined</code> is part of the array type).</p>
<p>The config <code class="w3-codespan">noUncheckedIndexedAccess</code> can be used to change this behavior.</p>

<div class="w3-example">
<h3>Example</h3>

<div class="w3-code notranslate jsHigh">
let array: number[] = [1, 2, 3];<br>
let value = array[0]; // with `noUncheckedIndexedAccess` this has the type `number | undefined`<br>
</div>

<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_null_bounds" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_null.js" data-extensions="php"></div>
<hr>
<br>
