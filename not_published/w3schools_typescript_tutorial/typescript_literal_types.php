...
<head>
<title>TypeScript Literal Types</title>
<meta property="og:description" content="TypeScript Literal Types allow you to specify the exact value a variable can have, providing more precision than broader types like string or number.">  
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>TypeScript Literal Types</h1>

<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="typescript_type_inference.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="typescript_namespaces.php">Next &#10095;</a>
</div>

<hr>

<h2>Understanding Literal Types in TypeScript</h2>

<p>Literal types in TypeScript allow you to specify exact values that variables can hold, providing more precision than broader types like <code class="w3-codespan">string</code> or <code class="w3-codespan">number</code>.</p>
<p>They are the building blocks for creating precise and type-safe applications.</p>
<hr>
<div class="w3-panel">
  <h3>Key Concepts</h3>
  <ul>
    <li><b>String Literals</b>: Exact string values like <code class="w3-codespan">"success" | "error"</code></li>
    <li><b>Numeric Literals</b>: Specific numbers like <code class="w3-codespan">1 | 2 | 3</code></li>
    <li><b>Boolean Literals</b>: Either <code class="w3-codespan">true</code> or <code class="w3-codespan">false</code></li>
    <li><b>Template Literal Types</b>: String literal types built using template string syntax</li>
  </ul>
</div>
...
<div class="w3-panel">
  ...
  <ul>
    <li>Defining specific sets of allowed values</li>
    <li>Creating discriminated unions</li>
...
<p>A string literal type represents a specific string value:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// A variable with a string literal type<br>
let direction: "north" | "south" | "east" | "west";<br><br>

// Valid assignments<br>
direction = "north";<br>
direction = "south";<br>
<br>
// Invalid assignments would cause errors<br>
// direction = "northeast"; // Error: Type '"northeast"' is not assignable to type '"north" | "south" | "east" | "west"'<br>
// direction = "up";        // Error: Type '"up"' is not assignable to type '"north" | "south" | "east" | "west"'<br>
<br>
// Using string literal types in functions<br>
function move(direction: "north" | "south" | "east" | "west") {<br>
&nbsp;&nbsp;console.log(`Moving ${direction}`);<br>
}<br>
<br>
move("east");  // Valid<br>
// move("up");  // Error: Argument of type '"up"' is not assignable to parameter of type...
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_literal_types_string" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<p>Similar to string literals, numeric literal types represent specific numeric values:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// A variable with a numeric literal type<br>
let diceRoll: 1 | 2 | 3 | 4 | 5 | 6;<br>
<br>
// Valid assignments<br>
diceRoll = 1;<br>
diceRoll = 6;<br>
<br>
// Invalid assignments would cause errors<br>
// diceRoll = 0;      // Error: Type '0' is not assignable to type '1 | 2 | 3 | 4 | 5 | 6'<br>
// diceRoll = 7;      // Error: Type '7' is not assignable to type '1 | 2 | 3 | 4 | 5 | 6'<br>
// diceRoll = 2.5;    // Error: Type '2.5' is not assignable to type '1 | 2 | 3 | 4 | 5 | 6'<br>
<br>
// Using numeric literal types in functions<br>
function rollDice(): 1 | 2 | 3 | 4 | 5 | 6 {<br>
&nbsp;&nbsp;return Math.floor(Math.random() * 6) + 1 as 1 | 2 | 3 | 4 | 5 | 6;<br>
}<br>
<br>
const result = rollDice();<br>
console.log(`You rolled a ${result}`);
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_literal_types_numeric" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Boolean Literal Types</h2>

<p>Boolean literal types are less commonly used since there are only two boolean values, but they can be useful in specific scenarios:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// A type that can only be the literal value 'true'<br>
type YesOnly = true;<br>
<br>
// A function that must return true<br>
function alwaysSucceed(): true {<br>
&nbsp;&nbsp;// Always returns the literal value 'true'<br>
&nbsp;&nbsp;return true;<br>
}<br>
<br>
// Boolean literal combined with other types<br>
type SuccessFlag = true | "success" | 1;<br>
type FailureFlag = false | "failure" | 0;<br>
<br>
function processResult(result: SuccessFlag | FailureFlag) {<br>
&nbsp;&nbsp;if (result === true || result === "success" || result === 1) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log("Operation succeeded");<br>
&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log("Operation failed");<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
processResult(true);      // "Operation succeeded"<br>
processResult("success"); // "Operation succeeded"<br>
processResult(1);         // "Operation succeeded"<br>
processResult(false);     // "Operation failed"
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_literal_types_boolean" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Literal Types with Objects</h2>

<p>Literal types can be combined with object types to create very specific shapes:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Object with literal property values<br>
type HTTPSuccess = {<br>
&nbsp;&nbsp;status: 200 | 201 | 204;<br>
&nbsp;&nbsp;statusText: "OK" | "Created" | "No Content";<br>
&nbsp;&nbsp;data: any;<br>
};<br>
<br>
type HTTPError = {<br>
&nbsp;&nbsp;status: 400 | 401 | 403 | 404 | 500;<br>
&nbsp;&nbsp;statusText: "Bad Request" | "Unauthorized" | "Forbidden" | "Not Found" | "Internal Server Error";<br>
&nbsp;&nbsp;error: string;<br>
};<br>
<br>
type HTTPResponse = HTTPSuccess | HTTPError;<br>
<br>
function handleResponse(response: HTTPResponse) {<br>
&nbsp;&nbsp;if (response.status >= 200 && response.status < 300) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Success: ${response.statusText}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(response.data);<br>
&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Error ${response.status}: ${response.statusText}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Message: ${response.error}`);<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
// Example usage<br>
const successResponse: HTTPSuccess = {<br>
&nbsp;&nbsp;status: 200,<br>
&nbsp;&nbsp;statusText: "OK",<br>
&nbsp;&nbsp;data: { username: "john_doe", email: "john@example.com" }<br>
};<br>
<br>
const errorResponse: HTTPError = {<br>
&nbsp;&nbsp;status: 404,<br>
...
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_literal_types_objects" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Template Literal Types</h2>

<p>TypeScript 4.1+ introduced template literal types, which allow you to create new string literal types by combining existing ones using template string syntax:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Basic template literals<br>
type Direction = "north" | "south" | "east" | "west";<br>
type Distance = "1km" | "5km" | "10km";<br>
<br>
// Using template literals to combine them<br>
type DirectionAndDistance = `${Direction}-${Distance}`;<br>
// "north-1km" | "north-5km" | "north-10km" | "south-1km" | ...<br>
<br>
let route: DirectionAndDistance;<br>
route = "north-5km";   // Valid<br>
route = "west-10km";   // Valid<br>
// route = "north-2km";   // Error<br>
// route = "5km-north";   // Error<br>
<br>
// Advanced string manipulation<br>
type EventType = "click" | "hover" | "scroll";<br>
type EventTarget = "button" | "link" | "div";<br>
type EventName = `on${Capitalize&lt;EventType&gt;}${Capitalize&lt;EventTarget&gt;}`;<br>
// "onClickButton" | "onClickLink" | "onClickDiv" | ...<br>
<br>
// Dynamic property access<br>
type User = {<br>
&nbsp;&nbsp;id: number;<br>
&nbsp;&nbsp;name: string;<br>
&nbsp;&nbsp;email: string;<br>
...
<br>
type GetterName&lt;T&gt; = `get${Capitalize&lt;string & keyof T&gt;}`;<br>
type UserGetters = {<br>
  [K in keyof User as GetterName&lt;User&gt;]: () =&gt; User[K];<br>
};<br>
// { getId: () =&gt; number; getName: () =&gt; string; ... }<br>
<br>
// String pattern matching<br>
type ExtractRouteParams&lt;T extends string&gt; =<br>
&nbsp;&nbsp;T extends `${string}:${infer Param}/${infer Rest}`<br>
&nbsp;&nbsp;&nbsp;&nbsp;? Param | ExtractRouteParams&lt;Rest&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;: T extends `${string}:${infer Param}`<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;? Param<br>
&nbsp;&nbsp;&nbsp;&nbsp;: never;<br>
<br>
type Params = ExtractRouteParams&lt;"/users/:userId/posts/:postId"&gt;;  // "userId" | "postId"<br>
<br>
// CSS units and values<br>
type CssUnit = 'px' | 'em' | 'rem' | '%' | 'vh' | 'vw';<br>
type CssValue = `${number}${CssUnit}`;<br>
<br>
let width: CssValue = '100px';    // Valid<br>
let height: CssValue = '50%';     // Valid<br>
// let margin: CssValue = '10';   // Error<br>
// let padding: CssValue = '2ex'; // Error<br>
<br>
// API versioning<br>
type ApiVersion = 'v1' | 'v2' | 'v3';<br>
type Endpoint = 'users' | 'products' | 'orders';<br>
type HttpMethod = 'GET' | 'POST' | 'PUT' | 'DELETE';<br>
<br>
type ApiUrl = `https://api.example.com/${ApiVersion}/${Endpoint}`;<br>
<br>
// Complex example: Dynamic SQL query builder<br>
type Table = 'users' | 'products' | 'orders';<br>
type Column&lt;T extends Table&gt; =<br>
&nbsp;&nbsp;T extends 'users' ? 'id' | 'name' | 'email' | 'created_at' :<br>
&nbsp;&nbsp;T extends 'products' ? 'id' | 'name' | 'price' | 'in_stock' :<br>
&nbsp;&nbsp;T extends 'orders' ? 'id' | 'user_id' | 'total' | 'status' : never;<br>
<br>
type WhereCondition&lt;T extends Table&gt; = {<br>
&nbsp;&nbsp;[K in Column&lt;T&gt;]?: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;equals?: any;<br>
&nbsp;&nbsp;&nbsp;&nbsp;notEquals?: any;<br>
&nbsp;&nbsp;&nbsp;&nbsp;in?: any[];<br>
...
<br>
function query&lt;T extends Table&gt;(<br>
&nbsp;&nbsp;table: T,<br>
&nbsp;&nbsp;where?: WhereCondition&lt;T&gt;<br>
): `SELECT * FROM ${T}${string}` {<br>
&nbsp;&nbsp;// Implementation would build the query<br>
&nbsp;&nbsp;return `SELECT * FROM ${table}` as const;<br>
}<br>
<br>
// Usage<br>
const userQuery = query('users', {<br>
&nbsp;&nbsp;name: { equals: 'John' },<br>
&nbsp;&nbsp;created_at: { in: ['2023-01-01', '2023-12-31'] }<br>
});<br>
// Type: "SELECT * FROM users WHERE ..."<br>
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_literal_types_template" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-panel">
  ...
  <h4>Do:</h4>
  <ul>
    <li>Use literal types for fixed sets of values (enums, configuration options)</li>
    <li>Combine with union types for better type safety</li>
    <li>Use template literal types for string pattern matching</li>
    <li>Leverage type inference when possible</li>
    <li>Document the meaning of literal types</li>
  </ul>

  <h4>Don't:</h4>
  <ul>
    <li>Overuse literal types when a more general type would be better</li>
    <li>Create extremely large union types that hurt performance</li>
    <li>Use string literals when an enum would be more appropriate</li>
  </ul>
</div>
<hr>
...
<div class="w3-panel">
  ...
  <ul>
    <li>Large union types can slow down type checking</li>
    <li>Complex template literal types can increase compilation time</li>
    <li>Consider using type aliases for complex literal types</li>
    <li>Be mindful of TypeScript's recursion depth limits</li>
  </ul>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_literal_types.js" data-extensions="php"></div>
<hr>
<br>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="typescript_type_inference.php">&#10094; Previous</a>
