...
<html lang="en-US">
<head>
  <title>TypeScript Tooling</title>
  <meta property="og:description" content="Learn about the tools that enhance TypeScript development: linters, formatters, and build tools.">
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>TypeScript Tooling</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="typescript_react.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="typescript_advanced_types.php">Next &#10095;</a>
</div>
<hr>
<h2>TypeScript Development Ecosystem</h2>

<p>TypeScript's tooling ecosystem is one of its greatest strengths, providing developers with powerful tools for every stage of development:</p>
...
<div class="w3-row-padding">
  <div class="w3-third">
    <div class="w3-card w3-padding">
      <h3>Code Quality</h3>
      <ul>
        <li>ESLint with TypeScript support</li>
  ...
  <div class="w3-third">
    <div class="w3-card w3-padding">
      <h3>Build & Deploy</h3>
      <ul>
        <li>Bundlers (Vite, Webpack, Parcel)</li>
...
<h3>Installation</h3>
<p>Install ESLint and the official TypeScript plugin/parser so ESLint can understand TypeScript syntax and rules.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate bash">
# Install ESLint with TypeScript support<br>
npm install --save-dev eslint @typescript-eslint/parser @typescript-eslint/eslint-plugin
</div>
</div>

<h3>Configuration</h3>
<p>This configuration enables recommended ESLint rules for TypeScript, connects ESLint to your tsconfig for type-aware linting, and tweaks a few common rules.</p>
<div class="w3-example">
<h3>Example</h3>
...
&nbsp;&nbsp;&nbsp;&nbsp;"plugin:@typescript-eslint/recommended-requiring-type-checking"<br>
&nbsp;&nbsp;],<br>
&nbsp;&nbsp;"parserOptions": {<br>
...
&nbsp;&nbsp;},<br>
&nbsp;&nbsp;"rules": {<br>
&nbsp;&nbsp;&nbsp;&nbsp;"@typescript-eslint/explicit-function-return-type": "warn",<br>
&nbsp;&nbsp;&nbsp;&nbsp;"@typescript-eslint/no-explicit-any": "warn",<br>
&nbsp;&nbsp;&nbsp;&nbsp;"@typescript-eslint/no-unused-vars": ["error", { "argsIgnorePattern": "^_" }]<br>
&nbsp;&nbsp;}<br>
}<br>
</div>
</div>
...
<h3>NPM Scripts</h3>
<p>Add scripts to run linting and a type-only check.</p>
<p>Use <code class="w3-codespan">lint:fix</code> to auto-fix simple issues.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// package.json<br>
{<br>
&nbsp;&nbsp;"scripts": {<br>
&nbsp;&nbsp;&nbsp;&nbsp;"lint": "eslint . --ext .ts,.tsx",<br>
&nbsp;&nbsp;&nbsp;&nbsp;"lint:fix": "eslint . --ext .ts,.tsx --fix",<br>
...
<p>Prettier enforces a consistent code style across your team.</p>
<p>Combine it with ESLint to avoid formatting-related lint errors.</p>

<h3>Installation</h3>
<p>Install Prettier plus ESLint plugins that disable conflicting rules and surface formatting issues via ESLint.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate bash">
# Install Prettier and related packages<br>
npm install --save-dev prettier eslint-config-prettier eslint-plugin-prettier
</div>
</div>

<h3>Configuration</h3>
<p>Define your Prettier preferences in <code class="w3-codespan">.prettierrc</code> and ignore generated folders in <code class="w3-codespan">.prettierignore</code>.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// .prettierrc<br>
...
<h3>Integrate with ESLint</h3>
<p>Extend <code class="w3-codespan">plugin:prettier/recommended</code> so formatting problems are reported as ESLint issues.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// .eslintrc.json<br>
...
&nbsp;&nbsp;"extends": [<br>
&nbsp;&nbsp;&nbsp;&nbsp;// ... other configs<br>
&nbsp;&nbsp;&nbsp;&nbsp;"plugin:prettier/recommended" // Must be last in the array<br>
&nbsp;&nbsp;]<br>
}<br>
</div>
</div>
<div class="w3-example">
<h3>Example: Integrate Prettier with ESLint</h3>
<div class="w3-code notranslate jsHigh">
npm install --save-dev eslint-config-prettier eslint-plugin-prettier<br>
# In your .eslintrc.js or .eslintrc.json, add:<br>
{<br>
...
<hr>
<h2>Modern Build Tools</h2>
<p>Vite is the recommended choice for fast dev server and modern builds.</p>
<p>Webpack remains common and highly configurable.</p>

<h3>Vite (Recommended)</h3>
<p>Create a new React + TypeScript project using Vite.</p>
<p>It starts a dev server with HMR for rapid feedback.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate bash">
# Create a new project with React + TypeScript<br>
...
<p>If you choose Webpack, this minimal setup transpiles TypeScript, handles CSS, and serves your app with <code class="w3-codespan">webpack-dev-server</code>.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
&nbsp;&nbsp;],<br>
&nbsp;&nbsp;devServer: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;static: path.join(__dirname, 'dist'),<br>
&nbsp;&nbsp;&nbsp;&nbsp;compress: true,<br>
&nbsp;&nbsp;&nbsp;&nbsp;port: 3000,<br>
&nbsp;&nbsp;&nbsp;&nbsp;hot: true,<br>
&nbsp;&nbsp;},<br>
...
<p>A strict <code class="w3-codespan">tsconfig.json</code> that targets modern browsers.</p>
<p>The optional <code class="w3-codespan">baseUrl</code> and <code class="w3-codespan">paths</code> help with absolute imports like <code class="w3-codespan">@/components/Button</code>.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// tsconfig.json<br>
...
<p>Configure your editor to surface lint errors, format on save, and debug efficiently.</p>

<h3>VS Code Extensions</h3>
<div class="w3-panel w3-light-gray">
  <p>Recommended extensions for VS Code:</p>
  <ul>
    <li><b>TypeScript + Webpack Problem Matchers</b> - For better error reporting</li>
    <li><b>ESLint</b> - Integrates ESLint into VS Code</li>
    <li><b>Prettier - Code formatter</b> - For consistent code formatting</li>
    <li><b>Path IntelliSense</b> - Autocomplete filenames</li>
    <li><b>Error Lens</b> - Show errors inline</li>
  </ul>
</div>

<h3>VS Code Settings</h3>
<p>Use Prettier as the default formatter, fix ESLint issues on save, and prefer non-relative import paths.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
&nbsp;&nbsp;},<br>
&nbsp;&nbsp;"eslint.validate": ["javascript", "javascriptreact", "typescript", "typescriptreact"],<br>
&nbsp;&nbsp;"typescript.tsdk": "node_modules/typescript/lib",<br>
&nbsp;&nbsp;"typescript.preferences.importModuleSpecifier": "non-relative"<br>
}<br>
</div>
</div>

<h3>Debugging Configuration</h3>
<p>Launch Chrome against your dev server and run Node-based test debugging directly from VS Code.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"webpack:///./~/*": "${workspaceFolder}/node_modules/*",<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"webpack:///./*": "${workspaceFolder}/src/*"<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;},<br>
&nbsp;&nbsp;&nbsp;&nbsp;{<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"type": "node",<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"request": "launch",<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"name": "Debug Tests",<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"runtimeExecutable": "${workspaceRoot}/node_modules/.bin/jest",<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"args": ["--runInBand", "--watchAll=false"],<br>
...
<hr>
<h2>Testing Setup</h2>
<p>Jest with Testing Library is a popular setup for testing React + TypeScript apps.</p>

<h3>Jest + Testing Library</h3>
<p>Install Jest, TypeScript support, and React Testing Library utilities for DOM assertions and user interactions.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate bash">
...
<p>Configure Jest to use <code class="w3-codespan">ts-jest</code>, map CSS modules, and resolve alias paths like <code class="w3-codespan">@/</code>.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// jest.config.js<br>
...
&nbsp;&nbsp;setupFilesAfterEnv: ['@testing-library/jest-dom'],<br>
&nbsp;&nbsp;moduleNameMapper: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;'^@/(.*)$': '<rootDir>/src/$1',<br>
&nbsp;&nbsp;&nbsp;&nbsp;'\\\.(css|less|scss|sass)$': 'identity-obj-proxy',<br>
&nbsp;&nbsp;},<br>
&nbsp;&nbsp;transform: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;'^.+\\\.tsx?$': 'ts-jest',<br>
&nbsp;&nbsp;},<br>
&nbsp;&nbsp;testMatch: ['**/__tests__/**/*.test.(ts|tsx)'],<br>
};<br>
</div>
</div>

<h3>Example Test</h3>
<p>A simple component test that verifies rendering and click behavior using Testing Library.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// src/__tests__/Button.test.tsx<br>
...
<br>
describe('Button', () =&gt; {<br>
&nbsp;&nbsp;it('renders button with correct text', () =&gt; {<br>
&nbsp;&nbsp;&nbsp;&nbsp;render(&lt;Button&gt;Click me&lt;/Button&gt;);<br>
&nbsp;&nbsp;&nbsp;&nbsp;expect(screen.getByRole('button', { name: /click me/i })).toBeInTheDocument();<br>
&nbsp;&nbsp;});<br>
<br>
&nbsp;&nbsp;it('calls onClick when clicked', () =&gt; {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const handleClick = jest.fn();<br>
&nbsp;&nbsp;&nbsp;&nbsp;render(&lt;Button onClick={handleClick}&gt;Click me&lt;/Button&gt;);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;fireEvent.click(screen.getByRole('button'));<br>
&nbsp;&nbsp;&nbsp;&nbsp;expect(handleClick).toHaveBeenCalledTimes(1);<br>
&nbsp;&nbsp;});<br>
});<br>
</div>
</div>
...
<div class="w3-panel">
  ...
  <ul>
    <li>Use <code class="w3-codespan">npm run dev</code> for development with hot reloading</li>
    <li>Run <code class="w3-codespan">npm run type-check</code> to verify TypeScript types</li>
    <li>Use <code class="w3-codespan">npm run lint</code> to check for linting errors</li>
    <li>Run <code class="w3-codespan">npm run build</code> to create production build</li>
  </ul>

  <h3>Performance Optimization</h3>
  <ul>
    <li>Use code splitting with dynamic imports</li>
    <li>Enable tree-shaking in production builds</li>
    <li>Use <code class="w3-codespan">React.memo</code> and <code class="w3-codespan">useMemo</code> for expensive computations</li>
...
<div class="w3-panel">
  <ul>
    <li><strong>TypeScript configuration:</strong> Ensure <code class="w3-codespan">strict</code> mode is enabled</li>
    <li><strong>ESLint + Prettier conflicts:</strong> Use <code class="w3-codespan">eslint-config-prettier</code> to disable conflicting rules</li>
    <li><strong>Slow builds:</strong> Consider using Vite or esbuild for faster development</li>
    <li><strong>Missing type definitions:</strong> Install <code class="w3-codespan">@types</code> packages for all dependencies</li>
    <li><strong>Debugging issues:</strong> Ensure source maps are properly configured</li>
  </ul>
</div>
...
<div class="w3-panel">
  <ul>
    ...
    <li><strong>Documentation:</strong> TypeDoc, Storybook</li>
    <li><strong>Performance:</strong> Web Vitals, Lighthouse</li>
  </ul>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_tooling.js" data-extensions="php"></div>
<hr>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="typescript_react.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="typescript_advanced_types.php">Next &#10095;</a>
