...
<head>
  <title>TypeScript Definitely Typed</title>
  <meta property="og:description" content="Definitely Typed is a project that provides a central repository of TypeScript definitions for NPM packages which do not have types.">  
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    <div class='w3-col l10 m12 w3-white' id='main'>
      ...
      <h1>TypeScript Definitely Typed</h1>

  <div class="w3-clear nextprev">
    <a class="w3-left w3-btn" href="typescript_null.php">&#10094; Previous</a>
    <a class="w3-right w3-btn" href="typescript_5_updates.php">Next &#10095;</a>
  </div>

  <hr>
  <p>NPM packages in the broad JavaScript ecosystem don't always have types available.</p>
  <p>Sometimes the projects are no longer maintained, and other times they aren't interested in, agree with, or have time to use TypeScript.</p>

  <hr>
  <h2>Using non-typed NPM packages in TypeScript</h2>
  <p>Using untyped NPM packages with TypeScript is not type-safe because types are missing.</p>
  <p>To help TypeScript developers use such packages, there is a community-maintained project called <a href="http://definitelytyped.org/" target="_blank">Definitely Typed</a>.</p>
  <p>Definitely Typed is a project that provides a central repository of TypeScript definitions for NPM packages which do not have types.</p>
...
<!-- <p class="adtext">Advertisement</p> -->
  ...
  <p>Usually, no other steps are needed after installing the declaration package.</p>
<p>TypeScript will automatically pick up the types when you use the package.</p>

  <div class="w3-panel ws-info">
    <p>Editors such as Visual Studio Code will often suggest installing packages like these when types are missing.</p>
  </div>

  <hr>
  <div id="exercisecontainer" src="xrcise_definitely_typed.js" data-extensions="php"></div>
  <hr>
  <br>
