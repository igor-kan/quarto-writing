...
<head>
<title>TypeScript 5.x Updates</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>TypeScript 5.x Updates</h1>

<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="typescript_definitely_typed.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="typescript_config.php">Next &#10095;</a>
</div>

<hr>

<p>TypeScript is actively maintained and updated by Microsoft.</p>
<p>In version 5.x a lot of utility and quality of life updates were made.</p>
<p>This chapter covers the most popular updates to allow stricter and more flexible type safety.</p>

<hr>

<div class="w3-panel ws-info">
<p>As a reminder these features will only be available in 5.x+</p>
</div>

<h2>Template Literal Types</h2>

<p><code class="w3-codespan">Template Literal Types</code> now allows us to create more precise types using template literals.</p>
<p>We can define custom types that depend on the actual values of strings at compile time.</p>
...
type HexColor&#60;T extends Color&#62; = `#${string}`;<br><br>

// Usage:<br>
let myColor: HexColor<"blue"> = "#0000FF";<br>
</div>

<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_template_literal_types" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<h2>Index Signature Labels</h2>

<p><code class="w3-codespan">Index Signature Labels</code> allows us to label index signatures using computed property names.</p>
<p>It helps in providing more descriptive type information when working with dynamic objects.</p>

<div class="w3-example">
<h3>Example</h3>

<div class="w3-code notranslate jsHigh">
type DynamicObject = { [key: `dynamic_${string}`]: string };<br><br>

// Usage: <br>
let obj: DynamicObject = { dynamic_key: "value" };<br>

</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_index_signature_label" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>

<div class="w3-panel ws-info">
<p>5.x also now supports native JavaScript private fields.</p>
<p>The TypeScript 'private' still works as discussed in <a href="typescript_classes.php">Classes</a> section.</p>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_5_updates.js" data-extensions="php"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="typescript_definitely_typed.php">&#10094; Previous</a>
