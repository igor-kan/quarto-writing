...
<meta property="og:description" content="TypeScript namespaces provide a way to organize code and prevent naming conflicts by creating a container for related functionality.">  
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>TypeScript Namespaces</h1>

<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="typescript_literal_types.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="typescript_index_signatures.php">Next &#10095;</a>
</div>

<hr>

<h2>Understanding TypeScript Namespaces</h2>

<p>TypeScript namespaces (previously known as "internal modules") provide a powerful way to organize code and prevent naming conflicts by creating a container for related functionality.</p>
<p>They help in structuring large codebases and managing scope in a clean, maintainable way.</p>
<hr>
<div class="w3-panel">
  <h3>Key Concepts</h3>
  <ul>
    <li><b>Logical Grouping</b>: Organize related code into named containers</li>
    <li><b>Scope Management</b>: Control the visibility of code elements</li>
    <li><b>Name Collision Prevention</b>: Avoid conflicts between similarly named components</li>
    <li><b>Code Organization</b>: Structure large applications in a hierarchical manner</li>
  </ul>
</div>

<div class="w3-panel">
  <h3>When to Use Namespaces</h3>
  <ul>
    <li>Organizing code in large legacy applications</li>
    <li>Working with global libraries</li>
    <li>When migrating from older JavaScript codebases</li>
    <li>When working with code that needs to be available globally</li>
  </ul>
</div>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> While namespaces are still fully supported in TypeScript, modern applications typically use ES modules (import/export) for better modularity and tree-shaking support.</p>
<p>However, understanding namespaces is valuable for maintaining legacy codebases and certain library development scenarios.</p>
</div>

<hr>

<h2>Basic Namespace Syntax</h2>
<h3>Creating and Using Namespaces</h3>

<p>A namespace is defined using the <code class="w3-codespan">namespace</code> keyword:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
namespace Validation {<br>
&nbsp;&nbsp;// Everything inside this block belongs to the Validation namespace<br>
<br>
&nbsp;&nbsp;// Export things you want to make available outside the namespace<br>
&nbsp;&nbsp;export interface StringValidator {<br>
&nbsp;&nbsp;&nbsp;&nbsp;isValid(s: string): boolean;<br>
&nbsp;&nbsp;}<br>
<br>
&nbsp;&nbsp;// This is private to the namespace (not exported)<br>
&nbsp;&nbsp;const lettersRegexp = /^[A-Za-z]+$/;<br>
<br>
&nbsp;&nbsp;// Exported class - available outside the namespace<br>
&nbsp;&nbsp;export class LettersValidator implements StringValidator {<br>
&nbsp;&nbsp;&nbsp;&nbsp;isValid(s: string): boolean {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return lettersRegexp.test(s);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>
<br>
&nbsp;&nbsp;// Another exported class<br>
&nbsp;&nbsp;export class ZipCodeValidator implements StringValidator {<br>
&nbsp;&nbsp;&nbsp;&nbsp;isValid(s: string): boolean {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return /^[0-9]+$/.test(s) && s.length === 5;<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
// Using the namespace members<br>
let letterValidator = new Validation.LettersValidator();<br>
let zipCodeValidator = new Validation.ZipCodeValidator();<br>
<br>
console.log(letterValidator.isValid("Hello")); // true<br>
console.log(letterValidator.isValid("Hello123")); // false<br>
<br>
console.log(zipCodeValidator.isValid("12345")); // true<br>
console.log(zipCodeValidator.isValid("1234")); // false - wrong length
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_namespaces_basic" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<p>Namespaces can be nested to create hierarchical organization:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
namespace App {<br>
&nbsp;&nbsp;export namespace Utils {<br>
&nbsp;&nbsp;&nbsp;&nbsp;export function log(msg: string): void {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`[LOG]: ${msg}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;export function error(msg: string): void {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error(`[ERROR]: ${msg}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>
<br>
&nbsp;&nbsp;export namespace Models {<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;getUser(id: number): User {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return { id, name: "John Doe", email: "john@example.com" };<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
// Using nested namespaces<br>
App.Utils.log("Application starting");<br>
<br>
const userService = new App.Models.UserService();<br>
const user = userService.getUser(1);<br>
<br>
App.Utils.log(`User loaded: ${user.name}`);<br>
<br>
// This would be a type error in TypeScript<br>
// App.log("directly accessing log"); // Error - log is not a direct member of App
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_namespaces_nested" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<p>You can create aliases for namespaces or their members to make long names more manageable:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
namespace VeryLongNamespace {<br>
&nbsp;&nbsp;export namespace DeeplyNested {<br>
&nbsp;&nbsp;&nbsp;&nbsp;export namespace Components {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;export class Button {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;display(): void {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log("Button displayed");<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;export class TextField {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;display(): void {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log("TextField displayed");<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>
...
<br>
// Without alias - very verbose<br>
const button1 = new VeryLongNamespace.DeeplyNested.Components.Button();<br>
button1.display();<br>
<br>
// With namespace alias<br>
import Components = VeryLongNamespace.DeeplyNested.Components;<br>
const button2 = new Components.Button();<br>
button2.display();<br>
<br>
// With specific member alias<br>
import Button = VeryLongNamespace.DeeplyNested.Components.Button;<br>
const button3 = new Button();<br>
button3.display();
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_namespaces_alias" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Working with Multi-file Namespaces</h2>
<h3>Splitting Namespaces Across Files</h3>

<p>Large applications often require splitting code across multiple files.</p>
<p>TypeScript namespaces can be split across files and combined at compile time using reference comments:</p>

<h3>Using Reference Comments</h3>
<p>Reference comments help TypeScript understand the relationship between files:</p>

<p><strong>validators.ts</strong> file:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
namespace Validation {<br>
...
<p><strong>letters-validator.ts</strong> file (extends Validation namespace):</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
/// &lt;reference path="validators.ts" /&gt;<br>
namespace Validation {<br>
&nbsp;&nbsp;const lettersRegexp = /^[A-Za-z]+$/;<br>
<br>
&nbsp;&nbsp;export class LettersValidator implements StringValidator {<br>
...
<p><strong>zipcode-validator.ts</strong> file:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
/// &lt;reference path="validators.ts" /&gt;<br>
namespace Validation {<br>
&nbsp;&nbsp;const zipCodeRegexp = /^[0-9]+$/;<br>
<br>
&nbsp;&nbsp;export class ZipCodeValidator implements StringValidator {<br>
&nbsp;&nbsp;&nbsp;&nbsp;isValid(s: string): boolean {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return zipCodeRegexp.test(s) && s.length === 5;<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>
}
</div>
...
<p><strong>main.ts</strong> file:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
/// &lt;reference path="validators.ts" /&gt;<br>
/// &lt;reference path="letters-validator.ts" /&gt;<br>
/// &lt;reference path="zipcode-validator.ts" /&gt;<br>
<br>
// Now you can use the validators from multiple files<br>
let validators: { [s: string]: Validation.StringValidator } = {};<br>
validators["letters"] = new Validation.LettersValidator();<br>
validators["zipcode"] = new Validation.ZipCodeValidator();<br>
<br>
// Some samples to validate<br>
let strings = ["Hello", "98052", "101"];<br>
<br>
// Validate each<br>
strings.forEach(s => {<br>
&nbsp;&nbsp;for (let name in validators) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`"${s}" - ${validators[name].isValid(s) ? "matches" : "does not match"} ${name}`);<br>
&nbsp;&nbsp;}<br>
});
</div>
</div>

<p>To compile these files into a single JavaScript file, use:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<div class="w3-panel">
  ...
  <p>Understanding when to use namespaces versus modules is crucial for TypeScript development:</p>
  <ul>
    <li><b>Modules</b> are the preferred way to organize code in modern TypeScript applications</li>
    <li><b>Namespaces</b> are still useful for specific scenarios like declaration merging or working with legacy code</li>
    <li><b>Modules</b> have better tooling support and tree-shaking capabilities</li>
    <li><b>Namespaces</b> can be useful for creating global libraries</li>
  </ul>
</div>

<p>Here's a comparison of when to use namespaces versus ES modules:</p>
  ...
  <table class="w3-table-all">
    <tr>
      <th>Feature</th>
      <th>Namespaces</th>
      <th>ES Modules (import/export)</th>
    </tr>
    <tr>
      <td>Recommended scope/scale</td>
      <td>Simpler setups, small apps, legacy codebases</td>
      <td>Modern apps of any size; preferred for new projects</td>
    </tr>
    <tr>
      <td>Syntax and usage</td>
      <td>Global access via dot notation (e.g., <code class="w3-codespan">MyNS.Member</code>)</td>
      <td>Explicit <code class="w3-codespan">import</code>/<code class="w3-codespan">export</code> with file paths</td>
    </tr>
    <tr>
      <td>Loading/bundling</td>
      <td>No loader required; can emit single file via <code class="w3-codespan">--outFile</code></td>
      <td>Typically uses a bundler/loader (Vite, webpack, etc.)</td>
    </tr>
    <tr>
      <td>Splitting across files</td>
      <td>Possible via <code class="w3-codespan">/// &lt;reference /&gt;</code> comments</td>
      <td>Natural; each file is a module with explicit exports/imports</td>
    </tr>
    <tr>
      <td>Tree-shaking</td>
      <td>Limited; harder for bundlers to eliminate unused code</td>
      <td>Excellent; designed for dead-code elimination</td>
    </tr>
    <tr>
      <td>Global scope</td>
      <td>Encourages globals (namespaced)</td>
      <td>Avoids globals; explicit dependencies</td>
    </tr>
    <tr>
      <td>Augmentation/merging</td>
      <td>Strong support via declaration merging</td>
      <td>Module augmentation possible, but more constrained</td>
    </tr>
    <tr>
      <td>Tooling and ecosystem</td>
      <td>Works, but less aligned with modern tooling</td>
      <td>Best support across modern tooling and platforms</td>
    </tr>
    <tr>
      <td>Best used for</td>
      <td>Legacy libraries, global scripts, ambient types</td>
      <td>All new development, libraries, and applications</td>
    </tr>
  </table>

<hr>

<h2>Advanced Namespace Patterns</h2>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Original namespace<br>
declare namespace Express {<br>
&nbsp;&nbsp;interface Request {<br>
&nbsp;&nbsp;&nbsp;&nbsp;user?: { id: number; name: string };<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;interface Response {<br>
&nbsp;&nbsp;&nbsp;&nbsp;json(data: any): void;<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
// Later in your application (e.g., in a .d.ts file)<br>
declare namespace Express {<br>
&nbsp;&nbsp;// Augment the Request interface<br>
&nbsp;&nbsp;interface Request {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Add custom properties<br>
&nbsp;&nbsp;&nbsp;&nbsp;requestTime?: number;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Add methods<br>
&nbsp;&nbsp;&nbsp;&nbsp;log(message: string): void;<br>
&nbsp;&nbsp;}<br>
<br>
&nbsp;&nbsp;// Add new types<br>
&nbsp;&nbsp;interface UserSession {<br>
&nbsp;&nbsp;&nbsp;&nbsp;userId: number;<br>
&nbsp;&nbsp;&nbsp;&nbsp;expires: Date;<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
// Usage in your application<br>
const app = express();<br>
<br>
app.use((req: Express.Request, res: Express.Response, next) => {<br>
&nbsp;&nbsp;// Augmented properties and methods are available<br>
&nbsp;&nbsp;req.requestTime = Date.now();<br>
&nbsp;&nbsp;req.log('Request started');<br>
&nbsp;&nbsp;next();<br>
});
</div>
</div>

<h3>Namespaces with Generics</h3>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Generic namespace example<br>
namespace DataStorage {<br>
&nbsp;&nbsp;export interface Repository&lt;T&gt; {<br>
&nbsp;&nbsp;&nbsp;&nbsp;getAll(): T[];<br>
&nbsp;&nbsp;&nbsp;&nbsp;getById(id: number): T | undefined;<br>
&nbsp;&nbsp;&nbsp;&nbsp;add(item: T): void;<br>
&nbsp;&nbsp;&nbsp;&nbsp;update(id: number, item: T): boolean;<br>
&nbsp;&nbsp;&nbsp;&nbsp;delete(id: number): boolean;<br>
&nbsp;&nbsp;}<br>
  <br>
&nbsp;&nbsp;// Concrete implementation<br>
&nbsp;&nbsp;export class InMemoryRepository&lt;T&gt; implements Repository&lt;T&gt; {<br>
&nbsp;&nbsp;&nbsp;&nbsp;private items: T[] = [];<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;getAll(): T[] {<br>
...
<br>
&nbsp;&nbsp;&nbsp;&nbsp;update(id: number, item: T): boolean {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (id >= 0 && id < this.items.length) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;this.items[id] = item;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return true;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return false;<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
...
<br>
const userRepo = new DataStorage.InMemoryRepository&lt;User&gt;();<br>
userRepo.add({ id: 1, name: 'John Doe', email: 'john@example.com' });<br>
...
<div class="w3-panel">
  ...
  <h4>Do:</h4>
  <ul>
    <li>Use meaningful, hierarchical namespace names</li>
    <li>Export only what's needed from namespaces</li>
    <li>Use <code class="w3-codespan">/// &lt;reference /&gt;</code> for ordering in multi-file namespaces</li>
    <li>Consider using modules for new projects</li>
    <li>Use const enums within namespaces for better performance</li>
    <li>Document your namespaces with JSDoc comments</li>
  </ul>

  <h4>Don't:</h4>
  <ul>
    <li>Create overly deep namespace hierarchies (more than 2-3 levels)</li>
    <li>Pollute the global scope unnecessarily</li>
    <li>Mix namespaces and modules in the same project without a clear strategy</li>
    <li>Use namespaces for small applications - prefer modules</li>
  </ul>
  
  <h3>Performance Considerations</h3>
  <ul>
    <li>Large namespaces can increase bundle size</li>
    <li>Consider code splitting for large applications</li>
    <li>Be mindful of circular dependencies in complex namespace structures</li>
    <li>Use <code class="w3-codespan">const enum</code> for better performance with constant values</li>
  </ul>
</div>
<hr>
<h2>Migrating from Namespaces to Modules</h2>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Before: Using namespaces<br>
namespace MyApp {<br>
&nbsp;&nbsp;export namespace Services {<br>
&nbsp;&nbsp;&nbsp;&nbsp;export class UserService {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;getUser(id: number) { /* ... */ }<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
// After: Using ES modules<br>
// services/UserService.ts<br>
export class UserService {<br>
&nbsp;&nbsp;getUser(id: number) { /* ... */ }<br>
}<br>
<br>
// app.ts<br>
import { UserService } from './services/UserService';<br>
...
<div class="w3-panel">
  ...
  <ol>
    <li>Convert each namespace to a module file</li>
    <li>Replace <code class="w3-codespan">export</code> with ES module exports</li>
    <li>Update imports to use ES module syntax</li>
    <li>Configure your build system to handle modules</li>
    <li>Update tests to work with the new module structure</li>
    <li>Consider using a bundler like webpack or Rollup</li>
    <li>Update your <code class="w3-codespan">tsconfig.json</code> to use <code class="w3-codespan">"module": "ESNext"</code></li>
  </ol>
  
  <h3>Migration Tools</h3>
  <ul>
    <li><code class="w3-codespan">ts-migrate</code> - Automated migration tool from Facebook</li>
    <li><code class="w3-codespan">tslint</code> with <code class="w3-codespan">no-namespace</code> rule to detect namespaces</li>
    <li>TypeScript's built-in refactoring tools</li>
  </ul>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_namespaces.js" data-extensions="php"></div>
<hr>
<br>
