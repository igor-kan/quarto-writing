...
<head>
  ...
  <meta property="og:description" content="Learn about decorators in TypeScript and how to use them for meta-programming, dependency injection, and framework development.">
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<div class="w3-clear nextprev">
  ...
  <a class="w3-right w3-btn" href="typescript_jsdoc.php">Next &#10095;</a>
</div>
<hr>
...
<div class="w3-example">
  <div class="w3-code notranslate jsHigh">
    // A simple class decorator that logs class definition<br>
  ...
  <a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_class_decorator" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate jsHigh">
    // A decorator that adds a version property and logs instantiation<br>
    function versioned(version: string) {<br>
    &nbsp;&nbsp;return function (constructor: Function) {<br>
    &nbsp;&nbsp;&nbsp;&nbsp;// Add a static property<br>
    &nbsp;&nbsp;&nbsp;&nbsp;constructor.prototype.version = version;<br>
    &nbsp;&nbsp;&nbsp;&nbsp;<br>
    &nbsp;&nbsp;&nbsp;&nbsp;// Store the original constructor<br>
    &nbsp;&nbsp;&nbsp;&nbsp;const original = constructor;<br>
    &nbsp;&nbsp;&nbsp;&nbsp;// Create a new constructor that wraps the original<br>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;};<br>
    &nbsp;&nbsp;&nbsp;&nbsp;<br>
    &nbsp;&nbsp;&nbsp;&nbsp;// Copy prototype so instanceof works<br>
    &nbsp;&nbsp;&nbsp;&nbsp;newConstructor.prototype = original.prototype;<br>
    &nbsp;&nbsp;&nbsp;&nbsp;return newConstructor;<br>
    &nbsp;&nbsp;};<br>
    }<br><br>
    
    // Applying the decorator with a version<br>
    @versioned('1.0.0')<br>
    class ApiClient {<br>
    &nbsp;&nbsp;fetchData() {<br>
    ...
    console.log((client as any).version); // Outputs: 1.0.0<br>
    client.fetchData();<br>
  </div>
  <a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_class_decorator_versioned" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-example">
  ...
  <a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_class_decorator_sealed" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate jsHigh">
    // Method decorator to measure execution time<br>
    function measureTime(<br>
    &nbsp;&nbsp;target: any,<br>
    ...
    // When called, it will log the execution time<br>
    const processor = new DataProcessor();<br>
    processor.processData([1, 2, 3, 4, 5]);<br>
  </div>
  <a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_method_timing" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate jsHigh">
    ...
    // Current user context (simplified)<br>
    const currentUser = {<br>
    &nbsp;&nbsp;id: 1,<br>
    &nbsp;&nbsp;name: 'John Doe',<br>
    &nbsp;&nbsp;roles: ['viewer'] as UserRole[]<br>
    };<br><br>

    // Decorator factory for role-based access control<br>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;currentUser.roles.includes(role)<br>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;);<br>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (!hasPermission) {<br>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;throw new Error(<br>
    ...
    try {<br>
    &nbsp;&nbsp;docService.viewDocument('doc123'); // Works - viewer role is allowed<br>
    &nbsp;&nbsp;docService.deleteDocument('doc123'); // Throws error - viewer cannot delete<br>
    } catch (error) {<br>
    &nbsp;&nbsp;console.error(error.message);<br>
    }<br>
    // Change user role to admin<br>
    currentUser.roles = ['admin'];<br>
    docService.deleteDocument('doc123'); // Now works - admin can delete<br>
  </div>
  <a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_method_authorization" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate jsHigh">
    function deprecated(message: string) {<br>
    &nbsp;&nbsp;return function (<br>
    &nbsp;&nbsp;&nbsp;&nbsp;target: any,<br>
    &nbsp;&nbsp;&nbsp;&nbsp;propertyKey: string,<br>
    &nbsp;&nbsp;&nbsp;&nbsp;descriptor: PropertyDescriptor<br>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;const originalMethod = descriptor.value;<br>
    &nbsp;&nbsp;&nbsp;&nbsp;descriptor.value = function (...args: any[]) {<br>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.warn(`Warning: ${propertyKey} is deprecated. ${message}`);<br>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return originalMethod.apply(this, args);<br>
    &nbsp;&nbsp;&nbsp;&nbsp;};<br>
    &nbsp;&nbsp;&nbsp;&nbsp;return descriptor;<br>
    &nbsp;&nbsp};<br>
    ...
    &nbsp;&nbsp;@deprecated('Use processPaymentV2 instead')<br>
    &nbsp;&nbsp;processPayment(amount: number, currency: string) {<br>
    &nbsp;&nbsp;&nbsp;&nbsp;console.log(`Processing payment of ${amount} ${currency}`);<br>
    &nbsp;&nbsp;}<br>
    <br>
    &nbsp;&nbsp;processPaymentV2(amount: number, currency: string) {<br>
    &nbsp;&nbsp;&nbsp;&nbsp;console.log(`Processing payment v2 of ${amount} ${currency}`);<br>
    &nbsp;&nbsp;}
    }<br><br>

    const payment = new PaymentService();<br>
    payment.processPayment(100, 'USD'); // Shows deprecation warning<br>
    payment.processPaymentV2(100, 'USD'); // No warning<br>
  </div>
  <a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_method_deprecated" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate jsHigh">
    // Property decorator to format a string property<br>
  ...
  <a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_property_format" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate jsHigh">
    ...
    product.price = 899.99; // Logs: Setting price from 999.99 to 899.99<br>
    console.log(product.name); // Logs: Getting name: Laptop
  </div>
  <a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_property_logging" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate jsHigh">
    ...
    const user1 = new User('johndoe', 'john@example.com'); // Works<br>
    // const user2 = new User(undefined, 'test@example.com'); // Throws error: Property username is required<br>
    // const user2 = new User('johndoe', undefined); // Throws error: Property email is required
  </div>
  <a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_property_required" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate jsHigh">
    ...
    service.createUser('John', 30, true); // Works<br>
    // service.createUser('', 30, true); // Throws error: Parameter at index 0 failed string validation<br>
    // service.createUser('John', 'thirty', true); // Throws error: Parameter at index 1 failed number validation
  </div>
  <a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_parameter_validation" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate jsHigh">
    // Decorator factory that accepts configuration<br>
  ...
  <a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_decorator_factory" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-example">
  ...
  <a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_decorator_order" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate jsHigh">
    // Simple decorator implementations (simplified for example)<br>
    const ROUTES: any[] = [];<br>
    <br>
    ...
    <br>
    // Simulate route registration<br>
  ...
  <a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_api_controller" target="_blank">Try it Yourself &raquo;</a>
</div>
