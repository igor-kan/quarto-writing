...
<head>
  ...
  <meta property="og:description" content="Learn how to migrate JavaScript projects to TypeScript with a comprehensive, step-by-step guide. Discover best practices, tools, and strategies for a smooth transition.">
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="typescript_jsdoc.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="typescript_error_handling.php">Next &#10095;</a>
</div>
<hr>

<div class="w3-panel">
  <p>Migrating from JavaScript to TypeScript can significantly improve your codebase's maintainability and developer experience.</p>
...
<h2 id="preparation">Preparation Phase</h2>

<div class="w3-panel">
  <h3>Assess Your Codebase</h3>
  <p>Before starting the migration:</p>
  <ul>
    <li>Identify the size and complexity of your codebase</li>
    <li>Document the build process and dependencies</li>
    <li>Check for any existing type definitions (<code class="w3-codespan">.d.ts</code> files)</li>
    <li>Identify critical paths that need special attention</li>
  </ul>
</div>

<div class="w3-example">
  <h3>Set Up Version Control</h3>
  <p>Ensure you have a clean git repository or equivalent:</p>
  <div class="w3-code notranslate jsHigh">
# Create a new branch for the migration<br>
git checkout -b typescript-migration<br>
<br>
# Commit your current state<br>
git add .<br>
git commit -m "Pre-TypeScript migration state"<br>
  </div>
</div>
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate jsHigh">
# Install TypeScript as a dev dependency<br>
npm install --save-dev typescript @types/node<br>
  </div>
</div>

<div class="w3-example">
  <h3>Create tsconfig.json</h3>
  <p>Create a basic <code class="w3-codespan">tsconfig.json</code> to start with:</p>
  <div class="w3-code notranslate jsHigh">
{<br>
  &nbsp;&nbsp;"compilerOptions": {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;"target": "ES2020",<br>
  ...
  <p class="w3-small">Note: Adjust the <code class="w3-codespan">target</code> based on your minimum supported environments.</p>
</div>
...
<h2 id="migration-approaches">Migration Approaches</h2>

<div class="w3-row-padding w3-margin-top">
  <div class="w3-half">
    <div class="w3-card w3-padding">
      <h3>Gradual Migration</h3>
      <p>Migrate one file at a time while keeping the rest as JavaScript.</p>
      <div class="w3-code notranslate jsHigh">
{<br>
&nbsp;&nbsp;"compilerOptions": {<br>
&nbsp;&nbsp;&nbsp;&nbsp;"allowJs": true,<br>
...
&nbsp;&nbsp;}<br>
      ...
      <p><strong>Best for:</strong> Large codebases, minimal disruption</p>
    </div>
  </div>
  
  <div class="w3-half">
    <div class="w3-card w3-padding">
      <h3>All-at-Once Migration</h3>
      <p>Rename all <code class="w3-codespan">.js</code> files to <code class="w3-codespan">.ts</code> and fix errors.</p>
      <div class="w3-code notranslate jsHigh">
# Rename all JS files to TS<br>
find src -name "*.js" -exec sh -c 'mv "$0" "${0%.js}.ts"' {} \;<br>
      </div>
      <p><strong>Best for:</strong> Small to medium projects, greenfield projects</p>
    </div>
  </div>
</div>
...
<div class="w3-panel ws-note">
  ...
  <p>For large projects, we strongly recommend the gradual migration approach to minimize disruption and make the process more manageable.</p>
</div>
...
<div class="w3-example">
  <h3>Start with Configuration</h3>
  <p>Create a basic <code class="w3-codespan">tsconfig.json</code> with these recommended settings:</p>
  <div class="w3-code notranslate jsHigh">
{<br>
  &nbsp;&nbsp;"compilerOptions": {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;"target": "ES2020",<br>
...
<div class="w3-example">
  <h3>Enable Type Checking for JavaScript</h3>
  <p>Add <code class="w3-codespan">// @ts-check</code> to the top of your JavaScript files to enable type checking:</p>
  <div class="w3-code notranslate jsHigh">
// @ts-check<br>
<br>
/** @type {string} */<br>
const name = 'John';<br>
<br>
// TypeScript will catch this error<br>
name = 42; // Error: Type '42' is not assignable to type 'string'<br>
  </div>
  <p class="w3-small">Note: You can disable type checking for specific lines using <code class="w3-codespan">// @ts-ignore</code>.</p>
</div>

<div class="w3-example">
  <h3>Rename Files to .ts</h3>
  <p>Start with non-critical files and rename them from <code class="w3-codespan">.js</code> to <code class="w3-codespan">.ts</code>:</p>
  <div class="w3-code notranslate jsHigh">
# Rename a single file<br>
mv src/utils/helpers.js src/utils/helpers.ts<br>
<br>
# Or rename all files in a directory (use with caution)<br>
find src/utils -name "*.js" -exec sh -c 'mv "$0" "${0%.js}.ts"' {} \;<br>
  </div>
</div>

<div class="w3-example">
  <h3>Add Type Annotations</h3>
  <p>Gradually add type annotations to your code:</p>
  <div class="w3-code notranslate jsHigh">
// Before<br>
function add(a, b) {<br>
&nbsp;&nbsp;return a + b;<br>
...
<br>
function getUser(id: number): User {<br>
&nbsp;&nbsp;return { id, name: 'John Doe' };<br>
}<br>
  </div>
</div>

<div class="w3-example">
  <h3>Update Build and Test Scripts</h3>
  <p>Modify your <code class="w3-codespan">package.json</code> to include TypeScript compilation:</p>
  <div class="w3-code notranslate jsHigh">
  {<br>
  &nbsp;&nbsp;"scripts": {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;"build": "tsc",<br>
  ...
  <p class="w3-small">Note: Make sure to update your test configuration to work with TypeScript files.</p>
</div>

<hr>

<h2 id="tools">Migration Tools</h2>

<div class="w3-row-padding w3-margin-top">
  <div class="w3-third w3-margin-bottom">
    <div class="w3-card w3-padding">
      <h3>ts-migrate</h3>
      <p>Automated tool for migrating JavaScript to TypeScript</p>
      <div class="w3-code notranslate jsHigh">
npx ts-migrate-full .<br>
      </div>
      <p><a href="https://github.com/airbnb/ts-migrate" target="_blank">GitHub Repository</a></p>
    </div>
  </div>
  ...
  <div class="w3-third w3-margin-bottom">
    <div class="w3-card w3-padding">
      <h3>TypeStat</h3>
      <p>Converts JavaScript to TypeScript with type safety</p>
      <div class="w3-code notranslate jsHigh">
npx typestat<br>
      </div>
      <p><a href="https://github.com/JoshuaKGoldberg/TypeStat" target="_blank">GitHub Repository</a></p>
    </div>
  </div>
  
  <div class="w3-third w3-margin-bottom">
    <div class="w3-card w3-padding">
      <h3>@types Packages</h3>
      <p>Install type definitions for your dependencies</p>
      <div class="w3-code notranslate jsHigh">
      npm install --save-dev @types/react @types/node<br>
      </div>
      <p><a href="https://www.typescriptlang.org/dt/search" target="_blank">TypeSearch</a></p>
    </div>
  </div>
</div>
<hr>
<h2 id="best-practices">Best Practices for TypeScript Migration</h2>

<h3>Start Small and Iterate</h3>
<ul>
    <li>Begin with utility functions and non-UI components</li>
    <li>Migrate one file or module at a time</li>
    <li>Commit after each successful migration step</li>
</ul>

<h3>Leverage TypeScript Features</h3>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
  // Use type inference where possible<br>
  const name = 'John';  // TypeScript infers 'string'<br>
  const age = 30;       // TypeScript infers 'number'<br>
  <br>
  // Use union types for flexibility<br>
  type Status = 'active' | 'inactive' | 'pending';<br>
  <br>
  // Use type guards for runtime checks<br>
  function isString(value: any): value is string {<br>
  &nbsp;&nbsp;return typeof value === 'string';<br>
  }<br>
  </div>
  </div>

<h3>Handle Third-Party Libraries</h3>
<ul>
    <li>Install <code class="w3-codespan">@types</code> packages for your dependencies</li>
    <li>Create declaration files for libraries without types</li>
    <li>Use <code class="w3-codespan">declare module</code> for global type extensions</li>
  </ul>
...
<p><strong>Problem:</strong> JavaScript often uses objects as dictionaries.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
  // Before<br>
  const user = {};<br>
  user.name = 'John';  // Error: Property 'name' does not exist<br>
  </div>
</div>
<p><strong>Solution:</strong> Use index signatures or type assertions.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
  // Option 1: Index signature<br>
  interface User {<br>
  &nbsp;&nbsp;[key: string]: any;<br>
  }<br>
  const user: User = {};<br>
  user.name = 'John';  // OK<br>
  <br>
  // Option 2: Type assertion<br>
  const user = {} as { name: string };<br>
  user.name = 'John';  // OK<br>
  </div>
</div>

<h3>Handling <code class="w3-codespan">this</code> Context</h3>
<p><strong>Problem:</strong> <code class="w3-codespan">this</code> binding issues in callbacks.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
  class Counter {<br>
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;this.count++;  // Error: 'this' is not defined<br>
  &nbsp;&nbsp;&nbsp;&nbsp;}, 1000);<br>
  &nbsp;&nbsp;}<br>
  }<br>
  </div>
</div>
<p><strong>Solution:</strong> Use arrow functions or bind <code class="w3-codespan">this</code>.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
  // Solution 1: Arrow function<br>
  setTimeout(() => {<br>
  &nbsp;&nbsp;this.count++;  // 'this' is lexically scoped<br>
  }, 1000);<br>
  <br>
  // Solution 2: Bind 'this'<br>
  setTimeout(function(this: Counter) {<br>
  &nbsp;&nbsp;this.count++;<br>
  }.bind(this), 1000);<br>
  </div>
</div>
...
<div class="w3-panel">
  <p>Migrating from JavaScript to TypeScript is a significant but rewarding investment in your codebase.</p>
<p>By following this guide, you can make the transition smoothly and incrementally.</p>
  
  <h4>Key Takeaways:</h4>
  <ul>
    <li>Start with a solid <code class="w3-codespan">tsconfig.json</code> configuration</li>
    <li>Use <code class="w3-codespan">allowJs</code> and <code class="w3-codespan">checkJs</code> for gradual migration</li>
    <li>Leverage TypeScript's type system to catch errors early</li>
    <li>Update your build and test processes to support TypeScript</li>
    <li>Address common challenges with the patterns shown above</li>
  </ul>
  
  <p>Remember that migration is a process, not an event.</p>
<p>It's okay to have a mixed codebase during the transition period.</p>
<p>The important thing is to keep making progress while maintaining code quality.</p>
</div>

<div class="w3-panel">
  <h3>Ready to Start Your Migration?</h3>
  <p>Begin by setting up TypeScript in your project and gradually adding type annotations.</p>
<p>The TypeScript compiler will guide you through the process of making your code more robust and maintainable.</p>
  <p>For more information, check out the <a href="https://www.typescriptlang.org/docs/handbook/migrating-from-javascript.html" target="_blank">official TypeScript migration guide</a>.</p>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_migration.js" data-extensions="php"></div>
<hr>
<br>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="typescript_jsdoc.php">&#10094; Previous</a>
