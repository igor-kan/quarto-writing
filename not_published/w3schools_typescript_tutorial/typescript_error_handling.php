...
<head>
  ...
  <meta property="og:description" content="Master error handling in TypeScript with comprehensive guide on try/catch, custom errors, type guards, and async error patterns.">
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>TypeScript Error Handling</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="typescript_migration.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="typescript_best_practices.php">Next &#10095;</a>
</div>
<hr>

<div class="w3-panel">
  <p>Robust error handling is crucial for building reliable TypeScript applications.</p>
<p>This guide covers everything from basic try/catch to advanced error handling patterns.</p>
</div>
...
<div class="w3-example">
  ...
  <p>The foundation of error handling in TypeScript:</p>
  <div class="w3-code notranslate jsHigh">
function divide(a: number, b: number): number {<br>
&nbsp;&nbsp;if (b === 0) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;throw new Error('Division by zero');<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;return a / b;<br>
}<br>
<br>
try {<br>
&nbsp;&nbsp;const result = divide(10, 0);<br>
&nbsp;&nbsp;console.log(result);<br>
} catch (error) {<br>
  &nbsp;&nbsp;console.error('An error occurred:', error.message);<br>
}<br>
  </div>
  <a target="_blank" href="trytypescript.php?filename=demo_error_basic" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <h4>TypeScript 4.0+ Note</h4>
  <p>In TypeScript 4.0 and later, the <code class="w3-codespan">unknown</code> type is the default type for catch variables. Always narrow the type before accessing properties.</p>
</div>

<hr>

<h2 id="custom-errors">Custom Error Classes</h2>

<div class="w3-example">
  <h3>Creating Custom Error Classes</h3>
  <p>Extend the built-in <code class="w3-codespan">Error</code> class to create domain-specific errors:</p>
  <div class="w3-code notranslate jsHigh">
class ValidationError extends Error {<br>
&nbsp;&nbsp;constructor(message: string, public field?: string) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;super(message);<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.name = 'ValidationError';<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Restore prototype chain<br>
&nbsp;&nbsp;&nbsp;&nbsp;Object.setPrototypeOf(this, ValidationError.prototype);<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
class DatabaseError extends Error {<br>
&nbsp;&nbsp;constructor(message: string, public code: number) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;super(message);<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.name = 'DatabaseError';<br>
&nbsp;&nbsp;&nbsp;&nbsp;Object.setPrototypeOf(this, DatabaseError.prototype);<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
// Usage<br>
function validateUser(user: any) {<br>
&nbsp;&nbsp;if (!user.name) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;throw new ValidationError('Name is required', 'name');<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;if (!user.email.includes('@')) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;throw new ValidationError('Invalid email format', 'email');<br>
&nbsp;&nbsp;}<br>
}<br>
  </div>
  <a target="_blank" href="trytypescript.php?filename=demo_custom_errors" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<h2 id="type-guards">Type Guards for Errors</h2>

<div class="w3-example">
  <h3>Type Predicates for Error Handling</h3>
  <p>Create type guards to safely work with different error types:</p>
  <div class="w3-code notranslate jsHigh">
// Type guards<br>
function isErrorWithMessage(error: unknown): error is { message: string } {<br>
&nbsp;&nbsp;return (<br>
&nbsp;&nbsp;&nbsp;&nbsp;typeof error === 'object' &&<br>
&nbsp;&nbsp;&nbsp;&nbsp;error !== null &&<br>
&nbsp;&nbsp;&nbsp;&nbsp;'message' in error &&<br>
&nbsp;&nbsp;&nbsp;&nbsp;typeof (error as Record<string, unknown>).message === 'string'<br>
&nbsp;&nbsp;);<br>
}<br>
<br>
function isValidationError(error: unknown): error is ValidationError {<br>
&nbsp;&nbsp;return error instanceof ValidationError;<br>
}<br>
<br>
// Usage in catch block<br>
try {<br>
&nbsp;&nbsp;validateUser({});<br>
} catch (error: unknown) {<br>
&nbsp;&nbsp;if (isValidationError(error)) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error(`Validation error in ${error.field}: ${error.message}`);<br>
&nbsp;&nbsp;} else if (isErrorWithMessage(error)) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error('An error occurred:', error.message);<br>
&nbsp;&nbsp;} else {<br>
...
&nbsp;&nbsp;}<br>
  ...
  <a target="_blank" href="trytypescript.php?filename=demo_type_guards" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
  <h4>Type Assertion Pattern</h4>
  <p>For more complex error handling, consider using a type assertion function:</p>
  <div class="w3-code notranslate jsHigh">
function assertIsError(error: unknown): asserts error is Error {<br>
&nbsp;&nbsp;if (!(error instanceof Error)) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;throw new Error('Caught value is not an Error instance');<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
try {<br>
...
&nbsp;&nbsp;assertIsError(error);<br>
&nbsp;&nbsp;console.error((error as Error).message); // TypeScript now knows error is Error<br>
}<br>
  </div>
</div>
<hr>
...
<div class="w3-example">
  <h3>Handling Async/Await Errors</h3>
  <p>Proper error handling in async/await code requires wrapping await calls in try/catch blocks:</p>
  <div class="w3-code notranslate jsHigh">
  interface User {<br>
  &nbsp;&nbsp;id: number;<br>
  &nbsp;&nbsp;name: string;<br>
  ...
  async function fetchUser(userId: number): Promise<User> {<br>
  &nbsp;&nbsp;try {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;const response = await fetch(`/api/users/${userId}`);<br>
  &nbsp;&nbsp;&nbsp;&nbsp;if (!response.ok) {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;throw new Error(`HTTP error! status: ${response.status}`);<br>
  &nbsp;&nbsp;&nbsp;&nbsp;}<br>
  &nbsp;&nbsp;&nbsp;&nbsp;return await response.json() as User;<br>
  &nbsp;&nbsp;} catch (error) {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;if (error instanceof Error) {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error('Failed to fetch user:', error.message);<br>
  &nbsp;&nbsp;&nbsp;&nbsp;}<br>
  &nbsp;&nbsp;&nbsp;&nbsp;throw error; // Re-throw to allow caller to handle<br>
  &nbsp;&nbsp;}<br>
  }<br>
  <br>
  // Using Promise.catch() for error handling<br>
  function fetchUserPosts(userId: number): Promise<Post[]> {<br>
  &nbsp;&nbsp;return fetch(`/api/users/${userId}/posts`)<br>
  &nbsp;&nbsp;&nbsp;&nbsp;.then(response => {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (!response.ok) {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;throw new Error(`HTTP error! status: ${response.status}`);<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;})<br>
  &nbsp;&nbsp;&nbsp;&nbsp;.catch(error => {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error('Failed to fetch posts:', error);<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return []; // Return empty array as fallback<br>
  &nbsp;&nbsp;&nbsp;&nbsp;});<br>
  }<br>
  </div>
  <a target="_blank" href="trytypescript.php?filename=demo_async_errors" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
  <h4>Unhandled Promise Rejections</h4>
  <p>Always handle promise rejections to prevent unhandled promise rejection warnings:</p>
  <div class="w3-code notranslate jsHigh">
  // Bad: Unhandled promise rejection<br>
  fetchData().then(data => console.log(data));<br>
  <br>
  // Good: Handle both success and error cases<br>
  fetchData()<br>
  &nbsp;&nbsp;.then(data => console.log('Success:', data))<br>
  &nbsp;&nbsp;.catch(error => console.error('Error:', error));<br>
  <br>
  // Or use void for intentionally ignored errors<br>
  void fetchData().catch(console.error);<br>
  </div>
</div>

<hr>

<h2 id="error-boundaries">Error Boundaries in React</h2>

<div class="w3-example">
  <h3>React Error Boundary Component</h3>
  <p>Create an Error Boundary to catch JavaScript errors in React component trees:</p>
  <div class="w3-code notranslate jsHigh">
  import React, { Component, ErrorInfo, ReactNode } from 'react';<br>
  <br>
  interface ErrorBoundaryProps {<br>
  &nbsp;&nbsp;children: ReactNode;<br>
  &nbsp;&nbsp;fallback?: ReactNode;<br>
  }<br>
  <br>
  interface ErrorBoundaryState {<br>
  &nbsp;&nbsp;hasError: boolean;<br>
  &nbsp;&nbsp;error?: Error;<br>
  }<br>
  <br>
  class ErrorBoundary extends Component&lt;ErrorBoundaryProps, ErrorBoundaryState&gt; {<br>
  &nbsp;&nbsp;public state: ErrorBoundaryState = {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;hasError: false<br>
  &nbsp;&nbsp;};<br>
  <br>
  &nbsp;&nbsp;public static getDerivedStateFromError(error: Error): ErrorBoundaryState {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;return { hasError: true, error };<br>
  &nbsp;&nbsp;}<br>
  <br>
  &nbsp;&nbsp;public componentDidCatch(error: Error, errorInfo: ErrorInfo) {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;console.error('Uncaught error:', error, errorInfo);<br>
  &nbsp;&nbsp;&nbsp;&nbsp;// Log to error reporting service<br>
  &nbsp;&nbsp;}<br>
  <br>
  &nbsp;&nbsp;public render() {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;if (this.state.hasError) {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return this.props.fallback || (<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;div className="error-boundary"&gt;<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;h2&gt;Something went wrong&lt;/h2&gt;<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;p&gt;{this.state.error?.message}&lt;/p&gt;<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;button onClick={() =&gt; this.setState({ hasError: false })}&gt;<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Try again<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/button&gt;<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/div&gt;<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;);<br>
  ...
  function App() {<br>
  &nbsp;&nbsp;return (<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&lt;ErrorBoundary fallback={&lt;div&gt;Oops! Something broke.&lt;/div&gt;}&gt;<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;MyComponent /&gt;<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&lt;/ErrorBoundary&gt;<br>
  &nbsp;&nbsp;);<br>
  }<br>
...
<p>Never leave catch blocks empty.</p>
<p>At minimum, log the error:</p>
<div class="w3-example">
  <div class="w3-code notranslate jsHigh">
  // Bad: Silent failure<br>
  try { /* ... */ } catch { /* empty */ }<br>
  <br>
  // Good: At least log the error<br>
  try { /* ... */ } catch (error) {<br>
  &nbsp;&nbsp;console.error('Operation failed:', error);<br>
  }<br>
  </div>
</div>  

<h3>Use Specific Error Types</h3>
<p>Create custom error classes for different error scenarios:</p>
<div class="w3-example">
  <div class="w3-code notranslate jsHigh">
  class NetworkError extends Error {<br>
  &nbsp;&nbsp;constructor(public status: number, message: string) {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;super(message);<br>
  &nbsp;&nbsp;&nbsp;&nbsp;this.name = 'NetworkError';<br>
  &nbsp;&nbsp;}<br>
  }<br>
  <br>
  class ValidationError extends Error {<br>
  &nbsp;&nbsp;constructor(public field: string, message: string) {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;super(message);<br>
  &nbsp;&nbsp;&nbsp;&nbsp;this.name = 'ValidationError';<br>
  &nbsp;&nbsp;}<br>
  }<br>
...
<p>Handle errors where you have enough context to recover or provide a good user experience:</p>
<div class="w3-example">
  <div class="w3-code notranslate jsHigh">
  // In a data access layer<br>
  async function getUser(id: string): Promise<User> {<br>
  &nbsp;&nbsp;const response = await fetch(`/api/users/${id}`);<br>
  &nbsp;&nbsp;if (!response.ok) {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;throw new NetworkError(response.status, 'Failed to fetch user');<br>
  &nbsp;&nbsp;}<br>
  &nbsp;&nbsp;return response.json();<br>
  }<br>
  <br>
  // In a UI component<br>
  async function loadUser() {<br>
  &nbsp;&nbsp;try {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;const user = await getUser('123');<br>
  &nbsp;&nbsp;&nbsp;&nbsp;setUser(user);<br>
  &nbsp;&nbsp;} catch (error) {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;if (error instanceof NetworkError) {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (error.status === 404) {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;showError('User not found');<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;showError('Network error. Please try again later.');<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
  &nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;showError('An unexpected error occurred');<br>
  &nbsp;&nbsp;&nbsp;&nbsp;}<br>
  &nbsp;&nbsp;}<br>
  }<br>
  </div>
...
<div class="w3-panel ws-warning">
  <h4>Not Handling Promise Rejections</h4>
  <p>Always handle promise rejections to prevent unhandled promise rejection warnings:</p>
  <div class="w3-code notranslate jsHigh">
  // Bad: Unhandled promise rejection<br>
  fetchData();<br>
  <br>
  // Good: Handle the rejection<br>
  fetchData().catch(console.error);<br>
  </div>
  
  <h4>Catching Without Proper Type Narrowing</h4>
  <p>In TypeScript 4.0+, caught errors are of type <code class="w3-codespan">unknown</code>:</p>
  <div class="w3-code notranslate jsHigh">
  // Bad: Error is of type 'unknown'<br>
  try { /* ... */ } catch (error) {<br>
  &nbsp;&nbsp;console.log(error.message); // Error: Property 'message' does not exist on type 'unknown'<br>
  }<br>
  <br>
  // Good: Narrow the type<br>
  try { /* ... */ } catch (error) {<br>
  &nbsp;&nbsp;if (error instanceof Error) {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;console.log(error.message); // OK<br>
  &nbsp;&nbsp;}<br>
  }<br>
  </div>
  
  <h4>Swallowing Errors</h4>
  <p>Avoid silently catching and ignoring errors without proper handling:</p>
  <div class="w3-code notranslate jsHigh">
  // Bad: Error is silently ignored<br>
  function saveData(data: Data) {<br>
  &nbsp;&nbsp;try {<br>
  ...
  <br>
  // Better: Log the error and/or notify the user<br>
  function saveData(data: Data) {<br>
  &nbsp;&nbsp;try {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;database.save(data);<br>
  &nbsp;&nbsp;} catch (error) {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;console.error('Failed to save data:', error);<br>
  &nbsp;&nbsp;&nbsp;&nbsp;showError('Failed to save data. Please try again.');<br>
  &nbsp;&nbsp;}<br>
  }<br>
  </div>
</div>
...
<div class="w3-panel">
  <h3>Summary</h3>
  <p>Effective error handling in TypeScript involves:</p>
  <ul>
    <li>Using <code class="w3-codespan">try/catch</code> blocks for synchronous code</li>
    <li>Handling promise rejections with <code class="w3-codespan">.catch()</code> or <code class="w3-codespan">try/catch</code> with <code class="w3-codespan">async/await</code></li>
    <li>Creating custom error classes for domain-specific errors</li>
    <li>Using type guards to safely work with error objects</li>
    <li>Handling errors at the appropriate level in your application</li>
    <li>Providing meaningful error messages to users</li>
  </ul>
  <p>By following these practices, you can build more robust and maintainable TypeScript applications.</p>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_error_handling.js" data-extensions="php"></div>
<hr>
<br>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="typescript_migration.php">&#10094; Previous</a>
