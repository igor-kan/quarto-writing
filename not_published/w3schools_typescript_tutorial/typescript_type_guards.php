...
<meta property="og:description" content="TypeScript Type Guards help narrow down the type of a variable within a conditional block.">  
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="typescript_advanced_types.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="typescript_conditional_types.php">Next &#10095;</a>
</div>

<hr>

<h2>Understanding Type Guards in TypeScript</h2>

<p>TypeScript Type Guards are powerful constructs that allow you to narrow down the type of a variable within a specific scope.</p>
<p>They help TypeScript understand and enforce type safety by providing explicit checks that determine the specific type of a variable at runtime.</p>
<hr>
<div class="w3-panel">
  <h3>Why Use Type Guards?</h3>
  <ul>
    <li><b>Type Safety</b>: Ensure operations are only performed on appropriate types</li>
    <li><b>Code Clarity</b>: Make type checking explicit and self-documenting</li>
    <li><b>Better Tooling</b>: Get accurate IntelliSense and code completion</li>
    <li><b>Error Prevention</b>: Catch type-related errors at compile time</li>
    <li><b>Runtime Safety</b>: Add an extra layer of type checking at runtime</li>
  </ul>
</div>
...
<div class="w3-panel">
  ...
  <ul>
    <li><code class="w3-codespan">typeof</code> type guards</li>
    <li><code class="w3-codespan">instanceof</code> type guards</li>
    <li>User-defined type guards with type predicates</li>
    <li>Discriminated unions with literal types</li>
    <li><code class="w3-codespan">in</code> operator type guards</li>
    <li>Type assertion functions</li>
  </ul>
</div>

<hr>

<h2><code class="w3-codespan">typeof</code> Type Guards</h2>

<p>The <code class="w3-codespan">typeof</code> operator is a built-in type guard that checks the type of a primitive value at runtime.</p>
<p>It's particularly useful for narrowing primitive types like strings, numbers, booleans, etc.</p>

<h3>Basic Usage</h3>
<p>Use <code class="w3-codespan">typeof</code> checks to narrow primitive unions inside conditional branches.</p>
<div class="w3-example">
  <h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Simple type guard with typeof<br>
function formatValue(value: string | number): string {<br>
&nbsp;&nbsp;if (typeof value === 'string') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// TypeScript knows value is string here<br>
&nbsp;&nbsp;&nbsp;&nbsp;return value.trim().toUpperCase();<br>
&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// TypeScript knows value is number here<br>
&nbsp;&nbsp;&nbsp;&nbsp;return value.toFixed(2);<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
// Example usage<br>
const result1 = formatValue('&nbsp;&nbsp;hello&nbsp;&nbsp;');&nbsp;&nbsp;// "HELLO"<br>
const result2 = formatValue(42.1234);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// "42.12"<br>
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_type_guards_typeof" target="_blank">Try it Yourself &raquo;</a>
</div>



<p>In the above example, TypeScript understands the type of <code class="w3-codespan">value</code> in different branches of the <code class="w3-codespan">if</code> statement.</p>
...
<h2><code class="w3-codespan">instanceof</code> Type Guards</h2>

<p>The <code class="w3-codespan">instanceof</code> operator checks if an object is an instance of a specific class or constructor function.</p>
<p>It's useful for narrowing types with custom classes or built-in objects.</p>

<h3>Class-based Type Guarding</h3>
<p>Narrow unions of class instances by checking the constructor with <code class="w3-codespan">instanceof</code>.</p>
<div class="w3-example">
  <h3>Example</h3>
<div class="w3-code notranslate jsHigh">
class Bird {<br>
&nbsp;&nbsp;fly() {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log("Flying...");<br>
&nbsp;&nbsp; }<br>
}<br>
<br>
class Fish {<br>
&nbsp;&nbsp;swim() {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log("Swimming...");<br>
&nbsp;&nbsp; }<br>
}<br>
<br>
function move(animal: Bird | Fish) {<br>
&nbsp;&nbsp;if (animal instanceof Bird) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// TypeScript knows animal is Bird here<br>
&nbsp;&nbsp;&nbsp;&nbsp;animal.fly();<br>
&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// TypeScript knows animal is Fish here<br>
&nbsp;&nbsp;&nbsp;&nbsp;animal.swim();<br>
&nbsp;&nbsp;}<br>
}<br>
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_type_guards_instanceof" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<p>For more complex type checking, you can create custom type guard functions using type predicates.</p>
<p>These are functions that return a type predicate in the form <code class="w3-codespan">parameterName is Type</code>.</p>

<h3>Type Predicate Functions</h3>
<p>Return a predicate like <code class="w3-codespan">value is Type</code> so TypeScript narrows on the true branch.</p>
<div class="w3-example">
  <h3>Example</h3>
<div class="w3-code notranslate jsHigh">
interface Car {<br>
...
<br>
interface Motorcycle {<br>
&nbsp;&nbsp;make: string;<br>
&nbsp;&nbsp;model: string;<br>
&nbsp;&nbsp;year: number;<br>
&nbsp;&nbsp;type: "sport" | "cruiser";<br>
}<br>
<br>
// Type predicate function<br>
function isCar(vehicle: Car | Motorcycle): vehicle is Car {<br>
&nbsp;&nbsp;return (vehicle as Motorcycle).type === undefined;<br>
}<br>
<br>
function displayVehicleInfo(vehicle: Car | Motorcycle) {<br>
&nbsp;&nbsp;console.log(`Make: ${vehicle.make}, Model: ${vehicle.model}, Year: ${vehicle.year}`);<br>
<br>
&nbsp;&nbsp;if (isCar(vehicle)) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// TypeScript knows vehicle is Car here<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log("This is a car");<br>
&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// TypeScript knows vehicle is Motorcycle here<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`This is a ${vehicle.type} motorcycle`);<br>
&nbsp;&nbsp;}<br>
}<br>
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_type_guards_predicate" target="_blank">Try it Yourself &raquo;</a>
</div>

<p>The function signature <code class="w3-codespan">vehicle is Car</code> is a type predicate that tells TypeScript to narrow the type when the function returns true.</p>

<hr>

<h2>Discriminated Unions</h2>

<p>Discriminated unions (also known as tagged unions) use a common property (the discriminant) to distinguish between different object types in a union.</p>
<p>This pattern is particularly powerful when combined with type guards.</p>

<h3>Basic Discriminated Union</h3>
<p>Use a shared literal property (like <code class="w3-codespan">kind</code>) to switch and narrow to the exact variant.</p>
<div class="w3-example">
  <h3>Example</h3>
<div class="w3-code notranslate jsHigh">
interface Circle {<br>
...
<br>
type Shape = Circle | Square;<br>
<br>
function calculateArea(shape: Shape) {<br>
&nbsp;&nbsp;switch (shape.kind) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;case "circle":<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// TypeScript knows shape is Circle here<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return Math.PI * shape.radius ** 2;<br>
&nbsp;&nbsp;&nbsp;&nbsp;case "square":<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// TypeScript knows shape is Square here<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return shape.sideLength ** 2;<br>
&nbsp;&nbsp;}<br>
}<br>
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_type_guards_discriminated" target="_blank">Try it Yourself &raquo;</a>
</div>

<p>The <code class="w3-codespan">kind</code> property is used as a discriminant to determine the type of the shape.</p>

<hr>

<h2>The <code class="w3-codespan">in</code> Operator</h2>

<p>The <code class="w3-codespan">in</code> operator checks for the existence of a property on an object.</p>
<p>It's particularly useful for narrowing union types where different types have distinct properties.</p>

<h3>Property Existence Checking</h3>
<p>Narrow union members by testing whether a distinguishing property exists.</p>
<div class="w3-example">
  <h3>Example</h3>
<div class="w3-code notranslate jsHigh">
interface Dog {<br>
...
&nbsp;&nbsp;if ("bark" in animal) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// TypeScript knows animal is Dog here<br>
&nbsp;&nbsp;&nbsp;&nbsp;animal.bark();<br>
&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// TypeScript knows animal is Cat here<br>
&nbsp;&nbsp;&nbsp;&nbsp;animal.meow();<br>
&nbsp;&nbsp;}<br>
}<br>
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_type_guards_in" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Type Assertion Functions</h2>

<p>Type assertion functions are a special kind of type guard that can throw an error if the type assertion fails.</p>
<p>They're useful for validating data at runtime.</p>

<h3>Assertion Functions</h3>
<p>Encode runtime checks that narrow types and throw on invalid input.</p>
<div class="w3-example">
  <h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Type assertion function<br>
function assertIsString(value: unknown): asserts value is string {<br>
&nbsp;&nbsp;if (typeof value !== 'string') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;throw new Error('Value is not a string');<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
// Type assertion function with custom error<br>
function assert(condition: unknown, message: string): asserts condition {<br>
&nbsp;&nbsp;if (!condition) {<br>
...
<br>
// Usage<br>
function processInput(input: unknown) {<br>
&nbsp;&nbsp;assertIsString(input);<br>
&nbsp;&nbsp;// input is now typed as string<br>
&nbsp;&nbsp;console.log(input.toUpperCase());<br>
}<br>
<br>
// With custom error<br>
function processNumber(value: unknown): number {<br>
&nbsp;&nbsp;assert(typeof value === 'number', 'Value must be a number');<br>
&nbsp;&nbsp;// value is now typed as number<br>
&nbsp;&nbsp;return value * 2;<br>
}<br>
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_type_guards_assertion" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-panel">
  <h3>When to Use Each Type Guard</h3>
  <ul>
    <li>Use <code class="w3-codespan">typeof</code> for primitive types (string, number, boolean, etc.)</li>
    <li>Use <code class="w3-codespan">instanceof</code> for class instances and built-in objects</li>
    <li>Use user-defined type guards for complex validation logic</li>
    <li>Use discriminated unions for related types with a common discriminant</li>
    <li>Use the <code class="w3-codespan">in</code> operator for checking property existence</li>
    <li>Use type assertion functions for runtime validation with errors</li>
  </ul>

  <h3>Performance Considerations</h3>
  <ul>
    <li><code class="w3-codespan">typeof</code> and <code class="w3-codespan">instanceof</code> are very fast</li>
    <li>Avoid complex logic in user-defined type guards when performance is critical</li>
    <li>Consider using type predicates for expensive checks that are used multiple times</li>
  </ul>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_type_guards.js" data-extensions="php"></div>
<hr>
<br>
