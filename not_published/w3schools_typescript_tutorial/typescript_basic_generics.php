...
<head>
<title>TypeScript Basic Generics</title>
<meta property="og:description" content="Generics allow creating 'type variables' which can be used to create classes, functions &amp; type aliases that don't need to explicitly define the types that they use.">  
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="typescript_classes.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="typescript_utility_types.php">Next &#10095;</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_basic_generics" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<hr>
<h2>Classes</h2>
<p>Generics can be used to create generalized classes, like <a href="/js/js_maps.asp" target="_blank">Map</a>.</p>
...
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_basic_generics_class" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<hr>
<div id="exercisecontainer" src="xrcise_basic_generics.js" data-extensions="php"></div>
<hr>
<br>
