...
<a class="w3-left w3-btn" href="typescript_union_types.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="typescript_casting.php">Next &#10095;</a>
</div>

<hr>

<p>TypeScript has a specific syntax for typing function parameters and return values.</p>
<p>Read more about functions <a href="/js/js_functions.asp" target="_blank">here</a>.</p>
...
// the `: number` here specifies that this function returns a number<br>
function getTime(): number {<br>
&nbsp;&nbsp;return new Date().getTime();<br>
}
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_functions_explicit" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<p>The type <code class="w3-codespan">void</code> can be used to indicate a function doesn't return any value.</p>

<div class="w3-example">
<h3>Example</h3>

<div class="w3-code notranslate jsHigh">
function printHello(): void {<br>
...
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_functions_void" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate jsHigh">
function multiply(a: number, b: number) {<br>
&nbsp;&nbsp;return a * b;<br>
}
</div>

<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_functions_params" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-info">
<p>If no parameter type is defined, TypeScript will default to using <code class="w3-codespan">any</code>, unless additional type information is available as shown in the Default Parameters and Type Alias sections below.</p>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// the `?` operator here marks parameter `c` as optional<br>
function add(a: number, b: number, c?: number) {<br>
&nbsp;&nbsp;return a + b + (c || 0);<br>
}
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_functions_params_optional" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
function pow(value: number, exponent: number = 10) {<br>
&nbsp;&nbsp;return value ** exponent;<br>
}
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_functions_params_defaults" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate jsHigh">
function divide({ dividend, divisor }: { dividend: number, divisor: number }) {<br>
&nbsp;&nbsp;return dividend / divisor;<br>
}
</div>

<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_functions_named_types" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate jsHigh">
function add(a: number, b: number, ...rest: number[]) {<br>
&nbsp;&nbsp;return a + b + rest.reduce((p, c) =&gt; p + c, 0);<br>
}
</div>

<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_functions_rest" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Type Alias</h2>

<p>Function types can be specified separately from functions with type aliases.</p>
<p>These types are written similarly to arrow functions, read more about arrow functions <a href="/js/js_arrow_function.asp" target="_blank">here</a>.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
type Negate = (value: number) =&gt; number;<br>
<br>
// in this function, the parameter `value` automatically gets assigned the type `number` from the type `Negate`<br>
const negateFunction: Negate = (value) =&gt; value * -1;
</div>

<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_functions_types" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
