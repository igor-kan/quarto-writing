...
<meta property="og:description" content="Learn how to use TypeScript's index signatures to define types for objects with dynamic keys.">  
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>TypeScript Index Signatures</h1>

<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="typescript_namespaces.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="typescript_declaration_merging.php">Next &#10095;</a>
</div>

<hr>

<h2>Understanding Index Signatures in TypeScript</h2>

<p>Index signatures in TypeScript provide a powerful way to define types for objects with dynamic property names while maintaining type safety.</p>
<p>They allow you to specify the types of values that can be accessed via bracket notation (<code class="w3-codespan">obj[key]</code>), even when the exact property names aren't known in advance.</p>
<hr>
<div class="w3-panel">
  <h3>Key Concepts</h3>
  <ul>
    <li><b>Dynamic Property Access</b>: Handle objects with arbitrary property names</li>
    <li><b>Type Safety</b>: Ensure consistent value types across dynamic properties</li>
    <li><b>Flexible Data Structures</b>: Model dictionaries, maps, and other dynamic data</li>
    <li><b>Runtime Safety</b>: Catch type-related errors at compile time</li>
  </ul>
</div>
...
<h2>Basic Index Signatures</h2>
<h3>String Index Signatures</h3>

<p>Index signatures in TypeScript allow you to define types for objects where you don't know the property names in advance, but you do know the shape of the values.</p>
<p>An index signature defines the types for properties accessed via an index like <code class="w3-codespan">obj[key]</code>.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
//&nbsp;This&nbsp;interface&nbsp;represents&nbsp;an&nbsp;object&nbsp;with&nbsp;string&nbsp;keys&nbsp;and&nbsp;string&nbsp;values<br>
interface&nbsp;StringDictionary&nbsp;{<br>
&nbsp;&nbsp;[key:&nbsp;string]:&nbsp;string;<br>
}<br>
<br>
//&nbsp;Creating&nbsp;a&nbsp;compliant&nbsp;object<br>
const&nbsp;names:&nbsp;StringDictionary&nbsp;=&nbsp;{<br>
&nbsp;&nbsp;firstName:&nbsp;"Alice",<br>
&nbsp;&nbsp;lastName:&nbsp;"Smith",<br>
&nbsp;&nbsp;"100":&nbsp;"One&nbsp;Hundred"<br>
};<br>
...
console.log(names["firstName"]);&nbsp;//&nbsp;"Alice"<br>
console.log(names["lastName"]);&nbsp;//&nbsp;"Smith"<br>
console.log(names["100"]);&nbsp;//&nbsp;"One&nbsp;Hundred"<br>
<br>
//&nbsp;Adding&nbsp;new&nbsp;properties&nbsp;dynamically<br>
names["age"]&nbsp;=&nbsp;"30";<br>
<br>
//&nbsp;This&nbsp;would&nbsp;cause&nbsp;an&nbsp;error<br>
//&nbsp;names["age"]&nbsp;=&nbsp;30;&nbsp;//&nbsp;Error:&nbsp;Type&nbsp;'number'&nbsp;is&nbsp;not&nbsp;assignable&nbsp;to&nbsp;type&nbsp;'string'
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_index_signatures_basic" target="_blank">Try it Yourself &raquo;</a>
</div>

<p>The index signature syntax uses brackets <code class="w3-codespan">[key: type]</code> to describe the types of the property names (or keys) that are allowed, followed by the type of values these properties can have.</p>
...
<h3>Number Index Signatures</h3>

<p>TypeScript supports both string and number index signatures:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
//&nbsp;Object&nbsp;with&nbsp;number&nbsp;indexes<br>
interface&nbsp;NumberDictionary&nbsp;{<br>
&nbsp;&nbsp;[index:&nbsp;number]:&nbsp;any;<br>
}<br>
<br>
const&nbsp;scores:&nbsp;NumberDictionary&nbsp;=&nbsp;{<br>
&nbsp;&nbsp;0:&nbsp;"Zero",<br>
&nbsp;&nbsp;1:&nbsp;100,<br>
&nbsp;&nbsp;2:&nbsp;true<br>
};<br>
<br>
console.log(scores[0]);&nbsp;//&nbsp;"Zero"<br>
console.log(scores[1]);&nbsp;//&nbsp;100<br>
console.log(scores[2]);&nbsp;//&nbsp;true<br>
<br>
//&nbsp;Adding&nbsp;a&nbsp;complex&nbsp;object<br>
scores[3]&nbsp;=&nbsp;{&nbsp;passed:&nbsp;true&nbsp;};
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_index_signatures_numeric" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> In JavaScript, all object keys are stored as strings, even numeric ones.</p>
<p>However, TypeScript makes a distinction to help catch logical errors when using arrays vs objects.</p>
</div>

<hr>

<h2>Advanced Index Signature Patterns</h2>
<h3>Mixed Property Types</h3>

<p>You can combine index signatures with explicit property declarations:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
interface&nbsp;UserInfo&nbsp;{<br>
&nbsp;&nbsp;name:&nbsp;string;&nbsp;//&nbsp;Required&nbsp;property&nbsp;with&nbsp;specific&nbsp;name<br>
&nbsp;&nbsp;age:&nbsp;number;&nbsp;&nbsp;//&nbsp;Required&nbsp;property&nbsp;with&nbsp;specific&nbsp;name<br>
&nbsp;&nbsp;[key:&nbsp;string]:&nbsp;string&nbsp;|&nbsp;number;&nbsp;//&nbsp;All&nbsp;other&nbsp;properties&nbsp;must&nbsp;be&nbsp;string&nbsp;or&nbsp;number<br>
}<br>
<br>
const&nbsp;user:&nbsp;UserInfo&nbsp;=&nbsp;{<br>
&nbsp;&nbsp;name:&nbsp;"Alice",&nbsp;//&nbsp;Required<br>
&nbsp;&nbsp;age:&nbsp;30,&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;//&nbsp;Required<br>
&nbsp;&nbsp;address:&nbsp;"123&nbsp;Main&nbsp;St",&nbsp;//&nbsp;Optional<br>
&nbsp;&nbsp;zipCode:&nbsp;12345&nbsp;//&nbsp;Optional<br>
};<br>
<br>
//&nbsp;This&nbsp;would&nbsp;cause&nbsp;an&nbsp;error<br>
//&nbsp;const&nbsp;invalidUser:&nbsp;UserInfo&nbsp;=&nbsp;{<br>
//&nbsp;&nbsp;name:&nbsp;"Bob",<br>
//&nbsp;&nbsp;age:&nbsp;"thirty",&nbsp;//&nbsp;Error:&nbsp;Type&nbsp;'string'&nbsp;is&nbsp;not&nbsp;assignable&nbsp;to&nbsp;type&nbsp;'number'<br>
//&nbsp;&nbsp;isAdmin:&nbsp;true&nbsp;&nbsp;//&nbsp;Error:&nbsp;Type&nbsp;'boolean'&nbsp;is&nbsp;not&nbsp;assignable&nbsp;to&nbsp;type&nbsp;'string&nbsp;|&nbsp;number'<br>
//&nbsp;};
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_index_signatures_mixed" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-warning">
  <p><strong>Important:</strong> When combining explicit properties with an index signature, the types of explicit properties must be assignable to the index signature's value type.</p>
</div>
...
<p>You can make index signatures read-only to prevent modification after creation:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
interface&nbsp;ReadOnlyStringArray&nbsp;{<br>
&nbsp;&nbsp;readonly&nbsp;[index:&nbsp;number]:&nbsp;string;<br>
}<br>
<br>
const&nbsp;names:&nbsp;ReadOnlyStringArray&nbsp;=&nbsp;["Alice",&nbsp;"Bob",&nbsp;"Charlie"];<br>
<br>
console.log(names[0]);&nbsp;//&nbsp;"Alice"<br>
<br>
//&nbsp;This&nbsp;would&nbsp;cause&nbsp;an&nbsp;error<br>
//&nbsp;names[0]&nbsp;=&nbsp;"Andrew";&nbsp;//&nbsp;Error:&nbsp;Index&nbsp;signature&nbsp;in&nbsp;type&nbsp;'ReadOnlyStringArray'&nbsp;only&nbsp;permits&nbsp;reading
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_index_signatures_readonly" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>

<p>For constraining key sets and transforming shapes, see <a href="typescript_mapped_types.php">Mapped Types</a>.</p>
...
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
//&nbsp;Type&nbsp;for&nbsp;API&nbsp;responses&nbsp;with&nbsp;dynamic&nbsp;keys<br>
interface&nbsp;ApiResponse&lt;T&gt;&nbsp;{<br>
&nbsp;&nbsp;data:&nbsp;{<br>
&nbsp;&nbsp;&nbsp;&nbsp;[resourceType:&nbsp;string]:&nbsp;T[];&nbsp;&nbsp;//&nbsp;e.g.,&nbsp;{&nbsp;"users":&nbsp;User[],&nbsp;"posts":&nbsp;Post[]&nbsp;}<br>
&nbsp;&nbsp;};<br>
&nbsp;&nbsp;meta:&nbsp;{<br>
&nbsp;&nbsp;&nbsp;&nbsp;page:&nbsp;number;<br>
&nbsp;&nbsp;&nbsp;&nbsp;total:&nbsp;number;<br>
&nbsp;&nbsp;&nbsp;&nbsp;[key:&nbsp;string]:&nbsp;any;&nbsp;&nbsp;//&nbsp;Allow&nbsp;additional&nbsp;metadata<br>
&nbsp;&nbsp;};<br>
}<br>
<br>
//&nbsp;Example&nbsp;usage&nbsp;with&nbsp;a&nbsp;users&nbsp;API<br>
interface&nbsp;User&nbsp;{<br>
&nbsp;&nbsp;id:&nbsp;number;<br>
&nbsp;&nbsp;name:&nbsp;string;<br>
&nbsp;&nbsp;email:&nbsp;string;<br>
...
const&nbsp;apiResponse:&nbsp;ApiResponse&lt;User&gt;&nbsp;=&nbsp;{<br>
&nbsp;&nbsp;data:&nbsp;{<br>
&nbsp;&nbsp;&nbsp;&nbsp;users:&nbsp;[<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;page:&nbsp;1,<br>
&nbsp;&nbsp;&nbsp;&nbsp;total:&nbsp;2,<br>
&nbsp;&nbsp;&nbsp;&nbsp;timestamp:&nbsp;"2023-01-01T00:00:00Z"<br>
&nbsp;&nbsp;}<br>
};<br>
<br>
//&nbsp;Accessing&nbsp;the&nbsp;data<br>
const&nbsp;users&nbsp;=&nbsp;apiResponse.data.users;<br>
console.log(users[0].name);&nbsp;&nbsp;//&nbsp;"Alice"
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_index_signatures_api" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-panel">
  ...
  <h4>Do:</h4>
  <ul>
    <li>Use index signatures for collections with dynamic keys</li>
    <li>Combine with explicit properties for known fields</li>
    <li>Keep value types specific (avoid <code class="w3-codespan">any</code>)</li>
    <li>Use <code class="w3-codespan">readonly</code> when mutation isn't needed</li>
  </ul>

  <h4>Don't:</h4>
  <ul>
    <li>Prefer fixed interfaces when keys are known</li>
    <li>Forget that all properties must conform to the index signature type</li>
    <li>Reinvent mapped types-use the dedicated page for transformations</li>
  </ul>
</div>
...
<div class="w3-example">
  <h3>Property Name Conflicts</h3>
  <div class="w3-code notranslate jsHigh">
  interface&nbsp;ConflictingTypes&nbsp;{<br>
  &nbsp;&nbsp;[key:&nbsp;string]:&nbsp;number;<br>
  &nbsp;&nbsp;name:&nbsp;string;&nbsp;//&nbsp;Error:&nbsp;not&nbsp;assignable&nbsp;to&nbsp;string&nbsp;index&nbsp;type&nbsp;'number'<br>
  }<br>
  <br>
  interface&nbsp;FixedTypes&nbsp;{<br>
  &nbsp;&nbsp;[key:&nbsp;string]:&nbsp;number&nbsp;|&nbsp;string;<br>
  &nbsp;&nbsp;name:&nbsp;string; &nbsp;//&nbsp;OK<br>
  &nbsp;&nbsp;age:&nbsp;number; &nbsp;&nbsp;//&nbsp;OK<br>
  }
  </div>
...
<hr>
<h2>Index Signatures vs. Record&lt;K, T&gt;</h2>

<p>Use an index signature for flexible/dynamic keys and when mixing with other properties.</p>
<p>Use <code class="w3-codespan">Record&lt;K, T&gt;</code> for concise simple mappings.</p>
...
<p>Use index signatures when keys are dynamic but value shapes are consistent.</p>
<p>Combine with explicit properties where possible, and see <a href="typescript_mapped_types.php">Mapped Types</a> and <a href="typescript_utility_types.php">Utility Types</a> for advanced transformations.</p>

<hr>

<div id="exercisecontainer" src="xrcise_index_signatures.js" data-extensions="php"></div>
<hr>
<br>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="typescript_namespaces.php">&#10094; Previous</a>
