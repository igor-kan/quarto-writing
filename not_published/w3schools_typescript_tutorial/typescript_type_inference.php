...
<meta name="description" content="Learn how TypeScript infers types automatically for variables, functions, and expressions. See contextual typing, best common type, const assertions, and more with examples.">
<meta property="og:description" content="TypeScript can automatically determine types based on the values and expressions in your code.">  
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>TypeScript Type Inference</h1>

<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="typescript_mapped_types.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="typescript_literal_types.php">Next &#10095;</a>
</div>

<hr>

<h2>Understanding Type Inference in TypeScript</h2>

<p>Type inference is TypeScript's ability to automatically determine and assign types to variables, function returns, and expressions based on their usage and context, without requiring explicit type annotations.</p>
<p>This powerful feature reduces verbosity while maintaining type safety.</p>

<h3>Key Concepts</h3>
<ul>
  <li><b>Type inference</b>: Automatic type detection from assigned values</li>
  <li><b>Contextual typing</b>: Types inferred from surrounding context</li>
  <li><b>Best common type</b>: Algorithm for finding a compatible type</li>
  <li><b>Widening/Narrowing</b>: Types expand or get constrained by usage</li>
  <li><b>When it happens</b>: variable init, returns, default params, callbacks, literals</li>
</ul>

<div class="w3-example">
  <h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// TypeScript infers these variable types<br>
let name = "Alice";           // inferred as string<br>
let age = 30;                 // inferred as number<br>
let isActive = true;          // inferred as boolean<br>
let numbers = [1, 2, 3];      // inferred as number[]<br>
let mixed = [1, "two", true]; // inferred as (string | number | boolean)[]<br>
<br>
// Using the inferred types<br>
name.toUpperCase();  // Works because name is inferred as string<br>
age.toFixed(2);      // Works because age is inferred as number<br>
// name.toFixed(2);  // Error: Property 'toFixed' does not exist on type 'string'
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_type_inference_basic" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<h2>Function Return Type Inference</h2>

<p>TypeScript can infer the return type of a function based on its return statements:</p>

<div class="w3-example">
  <h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Return type is inferred as string<br>
function greet(name: string) {<br>
&nbsp;&nbsp;return `Hello, ${name}!`;<br>
}<br>
<br>
// Return type is inferred as number<br>
function add(a: number, b: number) {<br>
&nbsp;&nbsp;return a + b;<br>
}<br>
<br>
// Return type is inferred as string | number<br>
function getValue(key: string) {<br>
&nbsp;&nbsp; if (key === "name") {<br>
&nbsp;&nbsp;&nbsp;&nbsp;return "Alice";<br>
&nbsp;&nbsp; } else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;return 42;<br>
...
// Using the inferred return types<br>
let greeting = greet("Bob");     // inferred as string<br>
let sum = add(5, 3);             // inferred as number<br>
let value = getValue("age");     // inferred as string | number<br>
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_type_inference_functions" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<p>TypeScript can infer types based on the context in which expressions occur:</p>

<div class="w3-example">
  <h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// The type of the callback parameter is inferred from the array method context<br>
const names = ["Alice", "Bob", "Charlie"];<br>
<br>
// Parameter 'name' is inferred as string<br>
names.forEach(name => {<br>
&nbsp;&nbsp;console.log(name.toUpperCase());<br>
});<br>
<br>
// Parameter 'name' is inferred as string, and the return type is inferred as number<br>
const nameLengths = names.map(name => {<br>
&nbsp;&nbsp;return name.length;<br>
});<br>
<br>
// nameLengths is inferred as number[]<br>
<br>
// Parameter types in event handlers are also inferred<br>
document.addEventListener("click", event => {<br>
&nbsp;&nbsp;// 'event' is inferred as MouseEvent<br>
&nbsp;&nbsp;console.log(event.clientX, event.clientY);<br>
});
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_type_inference_contextual" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Type Inference in Object Literals</h2>

<p>When working with object literals, TypeScript infers the types of properties:</p>

<div class="w3-example">
  <h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// TypeScript infers the type of this object<br>
const user = {<br>
&nbsp;&nbsp;id: 1,<br>
&nbsp;&nbsp;name: "Alice",<br>
...
<br>
// Accessing inferred properties<br>
console.log(user.name.toUpperCase());<br>
console.log(user.details.age.toFixed(0));<br>
console.log(user.details.address.city.toLowerCase());<br>
<br>
// Type errors would be caught<br>
// console.log(user.age);                 // Error: Property 'age' does not exist on type '...'<br>
// console.log(user.details.name);        // Error: Property 'name' does not exist on type '...'<br>
// console.log(user.details.address.zip); // Error: Property 'zip' does not exist on type '...'
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_type_inference_objects" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-example">
  <h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Regular type inference (widens to string)<br>
let name = "Alice";&nbsp;&nbsp;// type: string<br>
<br>
// Const assertion (narrows to literal type)<br>
const nameConst = "Alice" as const;&nbsp;&nbsp;// type: "Alice"<br>
<br>
// With objects<br>
const user = {<br>
&nbsp;&nbsp;id: 1,<br>
&nbsp;&nbsp;name: "Alice",<br>
&nbsp;&nbsp;roles: ["admin", "user"] as const&nbsp;&nbsp;// readonly tuple<br>
} as const;<br>
<br>
// user.name = "Bob";&nbsp;&nbsp;// Error: Cannot assign to 'name' because it is a read-only property<br>
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_type_inference_const_assertions" target="_blank">Try it Yourself &raquo;</a>
</div>


<h3>Type Guards and Control Flow Analysis</h3>
<div class="w3-example">
  <h3>Example</h3>
<div class="w3-code notranslate jsHigh">
function processValue(value: string | number) {<br>
&nbsp;&nbsp;// Type is narrowed to string in this block<br>
&nbsp;&nbsp;if (typeof value === "string") {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(value.toUpperCase());<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;// Type is narrowed to number here<br>
&nbsp;&nbsp;else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(value.toFixed(2));<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
// Discriminated unions<br>
interface Circle { kind: "circle"; radius: number; }<br>
interface Square { kind: "square"; size: number; }<br>
type Shape = Circle | Square;<br>
<br>
function area(shape: Shape) {<br>
&nbsp;&nbsp;// Type is narrowed based on 'kind' property<br>
&nbsp;&nbsp;switch (shape.kind) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;case "circle":<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return Math.PI * shape.radius ** 2;<br>
&nbsp;&nbsp;&nbsp;&nbsp;case "square":<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return shape.size ** 2;<br>
&nbsp;&nbsp;}<br>
}<br>
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_type_inference_type_guards" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<p>Here are some best practices for working with TypeScript's type inference:</p>

<div class="w3-example">
  <h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// 1. Let TypeScript infer simple types<br>
let message = "Hello";  // Good: no need for explicit type here<br>
<br>
// 2. Provide explicit types for function parameters<br>
function formatName(firstName: string, lastName: string) {<br>
&nbsp;&nbsp;return `${firstName} ${lastName}`;<br>
}<br>
<br>
// 3. Consider adding return type annotations for complex functions<br>
function processData(input: string[]): { count: number; items: string[] } {<br>
&nbsp;&nbsp;return {<br>
&nbsp;&nbsp;&nbsp;&nbsp;count: input.length,<br>
&nbsp;&nbsp;&nbsp;&nbsp;items: input.map(item =&gt; item.trim())<br>
&nbsp;&nbsp;};<br>
}<br>
<br>
// 4. Use explicit type annotations for empty arrays or objects<br>
const emptyArray: string[] = [];  // Without annotation, inferred as any[]<br>
const configOptions: Record&lt;string, unknown&gt; = {};  // Without annotation, inferred as {}<br>
<br>
// 5. Use type assertions when TypeScript cannot infer correctly<br>
const canvas = document.getElementById("main-canvas") as HTMLCanvasElement;<br>
</div>
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_type_inference_best_practices" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>When to Use Explicit Types</h2>

<p>While type inference is powerful, there are situations where explicit type annotations are recommended:</p>

<div class="w3-panel">
  <h3>Recommended for Explicit Types</h3>
  <ul>
    <li><b>Public API Contracts</b>: Function parameters and return types in library code</li>
    <li><b>Complex Types</b>: When the inferred type is too broad or complex</li>
    <li><b>Documentation</b>: To make the code more self-documenting</li>
    <li><b>Type Safety</b>: When you need to enforce specific constraints</li>
    <li><b>Empty Collections</b>: Empty arrays or objects that will be populated later</li>
  </ul>
</div>
...
<div class="w3-example">
  <h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Good: Explicit type for complex return values<br>
function processData(input: string[]): { results: string[]; count: number } {<br>
&nbsp;&nbsp;return {<br>
&nbsp;&nbsp;&nbsp;&nbsp;results: input.map(processItem),<br>
&nbsp;&nbsp;&nbsp;&nbsp;count: input.length<br>
&nbsp;&nbsp;};<br>
}<br>
<br>
// Good: Explicit type for empty arrays<br>
const items: Array&lt;{ id: number; name: string }&gt; = [];<br>
<br>
// Good: Explicit type for configuration objects<br>
const config: {<br>
&nbsp;&nbsp;apiUrl: string;<br>
&nbsp;&nbsp;retries: number;<br>
&nbsp;&nbsp;timeout: number;<br>
...
<hr>
<div id="exercisecontainer" src="xrcise_type_inference.js" data-extensions="php"></div>
<hr>
<br>
