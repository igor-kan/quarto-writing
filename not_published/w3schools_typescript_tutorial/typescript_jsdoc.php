...
<html lang="en-US">
<head>
  <title>TypeScript in JavaScript Projects (JSDoc)</title>
  <meta property="og:description" content="Learn how to add TypeScript's powerful type checking to your JavaScript projects using JSDoc comments for gradual typing without file conversion.">
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>TypeScript in JavaScript Projects (JSDoc)</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="typescript_decorators.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="typescript_migration.php">Next &#10095;</a>
</div>
<hr>

<div class="w3-panel ws-info">
  <p>JSDoc with TypeScript allows you to add type checking to JavaScript files without converting them to <code class="w3-codespan">.ts</code>.</p>
  <p>This is perfect for gradual migration or when you want type safety in JavaScript projects.</p>
</div>
...
<p>To enable TypeScript checking in JavaScript files, you need to:</p>

<ol>
  <li>Create a <code class="w3-codespan">tsconfig.json</code> file (if you don't have one)</li>
  <li>Enable <code class="w3-codespan">checkJs</code> or use <code class="w3-codespan">// @ts-check</code> in individual files</li>
</ol>
<div class="w3-example">
<h3>Example: JSDoc for Type Safety</h3>
...
<a target="_blank" href="trytypescript.php?filename=demo_jsdoc_getting_started" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<h2 id="objects-interfaces">Objects and Interfaces</h2>
 ...
 */<br>
function greet(person) {<br>
&nbsp;&nbsp;return `Hello, ${person.firstName} ${person.lastName}`;<br>
}<br>
<br>
greet({ firstName: 'John', lastName: 'Doe' }); // OK<br>
greet({ firstName: 'Jane' }); // Error: Property 'lastName' is missing<br>
</div>
<a target="_blank" href="trytypescript.php?filename=demo_jsdoc_objects" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Using @typedef for Complex Types</h3>
<div class="w3-code notranslate jsHigh">
// @ts-check<br>
<br>
/**<br>
...
<br>
// TypeScript will provide autocomplete for User properties<br>
console.log(currentUser.role);<br>
</div>
<a target="_blank" href="trytypescript.php?filename=demo_jsdoc_typedef" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
// @ts-check<br>
<br>
/** @typedef {{ x: number, y: number }} Point */<br>
<br>
/**<br>
...
<br>
/** @type {Point3D} */<br>
const point3d = { x: 1, y: 2, z: 3 };<br>
<br>
// @ts-expect-error - missing z property<br>
const point2d = { x: 1, y: 2 };<br>
</div>
<a target="_blank" href="trytypescript.php?filename=demo_jsdoc_extend" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<hr>
<h2 id="functions">Function Types</h2>
...
<br>
// TypeScript knows the parameter and return types<br>
const area = calculateArea(10, 20);<br>
</div>
<a target="_blank" href="trytypescript.php?filename=demo_jsdoc_functions_decl" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Function Expressions and Callbacks</h3>
<div class="w3-code notranslate jsHigh">
// @ts-check<br>
<br>
/**<br>
 ...
 */<br>
const toUpperCase = (str) => str.toUpperCase();<br>
<br>
/**<br>
 ...
 * @returns {string[]}<br>
 */<br>
function processStrings(strings, processor) {<br>
&nbsp;&nbsp;return strings.map(processor);<br>
}<br>
<br>
const result = processStrings(['hello', 'world'], toUpperCase);<br>
// result will be ['HELLO', 'WORLD']<br>
</div>
<a target="_blank" href="trytypescript.php?filename=demo_jsdoc_callbacks" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
 ...
 */<br>
function add(a, b) {<br>
&nbsp;&nbsp;if (typeof a === 'string' || typeof b === 'string') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;return String(a) + String(b);<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;return a + b;<br>
}<br>
<br>
const strResult = add('Hello, ', 'World!'); // string<br>
const numResult = add(10, 20);             // number<br>
</div>
<a target="_blank" href="trytypescript.php?filename=demo_jsdoc_overloads" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
// @ts-check<br>
<br>
/** @typedef {{ name: string, age: number }} Person */<br>
/** @typedef {Person & { employeeId: string }} Employee */<br>
/** @typedef {Person | { guestId: string, visitDate: Date }} Visitor */<br>
<br>
/** @type {Employee} */<br>
const employee = {<br>
&nbsp;&nbsp;name: 'Alice',<br>
 ...
 * @returns {string}<br>
 */<br>
function getVisitorId(visitor) {<br>
&nbsp;&nbsp;if ('guestId' in visitor) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;return visitor.guestId;  // TypeScript knows this is a guest<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;return visitor.name;      // TypeScript knows this is a Person<br>
}<br>
</div>
<a target="_blank" href="trytypescript.php?filename=demo_jsdoc_union_intersection" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Mapped and Conditional Types</h3>
<div class="w3-code notranslate jsHigh">
// @ts-check<br>
<br>
/**
 ...
 */<br>
<br>
/** @type {Getters<{ name: string, age: number }> } */<br>
const userGetters = {<br>
&nbsp;&nbsp;getName: () =&gt; 'John',<br>
&nbsp;&nbsp;getAge: () =&gt; 30<br>
};<br>
<br>
// TypeScript enforces the return types<br>
const name = userGetters.getName(); // string<br>
const age = userGetters.getAge();   // number<br>
</div>
<a target="_blank" href="trytypescript.php?filename=demo_jsdoc_mapped" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-example">
<h3>Importing Types from Other Files</h3>
<div class="w3-code notranslate jsHigh">
// @ts-check<br>
<br>
// Importing types from TypeScript files<br>
/** @typedef {import('./types').User} User */<br>
<br>
// Importing types from node_modules<br>
/** @typedef {import('express').Request} ExpressRequest */<br>
<br>
// Importing with renaming<br>
/** @typedef {import('./api').default as ApiClient} ApiClient */<br>
</div>
</div>

<div class="w3-example">
<h3>Creating Declaration Files</h3>
<p>Create a <code class="w3-codespan">types.d.ts</code> file in your project:</p>
<div class="w3-code notranslate jsHigh">
// types.d.ts<br>
declare module 'my-module' {<br>
...
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;export function initialize(config: Config): void;<br>
&nbsp;&nbsp;export function fetchData&lt;T = any&gt;(url: string): Promise&lt;T&gt;;<br>
}<br>
</div>

<p>Then use it in your JavaScript files:</p>
<div class="w3-code notranslate jsHigh">
// @ts-check<br>
<br>
/** @type {import('my-module').Config} */<br>
const config = {<br>
&nbsp;&nbsp;apiKey: '12345',<br>
&nbsp;&nbsp;timeout: 5000<br>
};<br>
<br>
// TypeScript will provide autocomplete and type checking<br>
import { initialize } from 'my-module';<br>
...
<div class="w3-panel">
  <p>Follow these best practices when using JSDoc with TypeScript:</p>
  <ul>
    <li>Enable <code class="w3-codespan">// @ts-check</code> at the top of files where you want type checking</li>
    <li>Use <code class="w3-codespan">@typedef</code> for complex types that are used in multiple places</li>
    <li>Document all function parameters and return types</li>
    <li>Use <code class="w3-codespan">@template</code> for generic functions and types</li>
    <li>Create declaration files (<code class="w3-codespan">.d.ts</code>) for third-party libraries without types</li>
    <li>Use <code class="w3-codespan">@ts-expect-error</code> instead of <code class="w3-codespan">@ts-ignore</code> when you expect an error</li>
  </ul>
</div>
...
<div class="w3-panel ws-warning">
  ...
  <ul>
    <li><strong>Missing <code class="w3-codespan">// @ts-check</code>:</strong> Type checking won't work without it</li>
    <li><strong>Incorrect JSDoc syntax:</strong> A single typo can disable type checking</li>
    <li><strong>Type conflicts:</strong> When types from different sources don't match</li>
    <li><strong>Inference issues:</strong> Sometimes TypeScript can't infer types correctly</li>
    <li><strong>Performance:</strong> Large JavaScript files with complex types can be slow to check</li>
  </ul>
</div>
...
<p>Using JSDoc with TypeScript provides a powerful way to add type safety to your JavaScript projects without the need to convert files to TypeScript.</p>
<p>This approach is particularly useful for:</p>

<ul>
  <li>Gradually migrating JavaScript codebases to TypeScript</li>
  <li>Adding type checking to existing JavaScript projects</li>
  <li>Working in environments where <code class="w3-codespan">.ts</code> files aren't supported</li>
  <li>Documenting JavaScript code with type information</li>
</ul>

<p>By following the patterns and best practices outlined in this tutorial, you can enjoy many of the benefits of TypeScript while continuing to work with JavaScript.</p>

<div class="w3-panel ws-note">
  <p><strong>Remember:</strong> While JSDoc provides excellent type checking, for new projects or complete migrations, consider using <code class="w3-codespan">.ts</code> files for the best TypeScript experience.</p>
</div>

<hr>
<div class="w3-panel ws-info">
  <h3>Ready to try TypeScript with JSDoc?</h3>
  <p>Start by adding <code class="w3-codespan">// @ts-check</code> to your JavaScript files and gradually add type annotations using JSDoc.</p>
  <p>The TypeScript compiler will help you catch errors before they reach production!</p>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_jsdoc.js" data-extensions="php"></div>
<hr>
<br>
