...
<head>
<title>TypeScript Object Types</title>
<meta charset="utf-8" />
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>TypeScript Object Types</h1>

<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="typescript_tuples.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="typescript_enums.php">Next &#10095;</a>
</div>

<hr>

<p>TypeScript has a specific syntax for typing objects.</p>
<p>Read more about objects in our <a href="/js/js_objects.asp" target="_blank">JavaScript Objects chapter</a>.</p>
...
const car: { type: string, model: string, year: number } = {<br>
&nbsp;&nbsp;type: "Toyota",<br>
&nbsp;&nbsp;model: "Corolla",<br>
&nbsp;&nbsp;year: 2009<br>
};
...
<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_object_types_ex" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-info">
<p>Object types like this can also be written separately, and even be reused, look at <a href="typescript_aliases_and_interfaces.php">interfaces</a> for more details.
</p>
</div>
...
car.type = "Ford"; // no error<br>
car.type = 2; // Error: Type 'number' is not assignable to type 'string'.<br>
</div>

<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_object_types_infer" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-example">
<h3>Example without an optional property</h3>

<div class="w3-code notranslate jsHigh">
const car: { type: string, mileage: number } = { // Error: Property 'mileage' is missing in type '{ type: string;
}' but required in type '{ type: string; mileage: number; }'.<br>
&nbsp;&nbsp;type: "Toyota",<br>
};<br>
car.mileage = 2000;
</div>
...
<div class="w3-example">
<h3>Example with an optional property</h3>

<div class="w3-code notranslate jsHigh">
const car: { type: string, mileage?: number } = { // no error<br>
&nbsp;&nbsp;type: "Toyota"<br>
};<br>
car.mileage = 2000;
</div>

<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_object_types_optional" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate jsHigh">
const nameAgeMap: { [index: string]: number } = {};<br>
nameAgeMap.Jack = 25; // no error<br>
nameAgeMap.Mark = "Fifty"; // Error: Type 'string' is not assignable to type 'number'.
</div>

<a class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_object_types_undefined_props" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-info">
<p>Index signatures like this one can also be expressed with utility types like <code class="w3-codespan">Record&lt;string, number&gt;</code>.</p>
<p>Learn more about utility types like this in our <a href="typescript_utility_types.php">TypeScript Utility Types</a> chapter.</p>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_object_types.js" data-extensions="php"></div>
<hr>
<br>
