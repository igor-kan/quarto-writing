...
<html lang="en-US">
<head>
<title>TypeScript Syllabus (Curriculum)</title>
<meta property="og:description" content="TypeScript Syllabus (Curriculum)">  
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>TypeScript <span class="color_h1">Syllabus</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="typescript_practice.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="typescript_study_plan.php">Next &#10095;</a>
</div>
<hr>
<h2>Introduction</h2>
<style>
...
<p>The <a title="W3Schools TypeScript Tutorial" href="index.php">W3Schools TypeScript Tutorial</a> is comprehensive and beginner-friendly.</p>
<p>It will give you a fundamental knowledge of TypeScript.</p>
<p>It is designed for beginners and requires only basic JavaScript knowledge.</p>
...
<p>The syllabus outline and its sequence are structured so you can learn TypeScript step by step, from the introduction to advanced features.</p>
<p><a title="W3Schools TypeScript Tutorial" href="typescript_intro.php" class="ws-btn">Get Started With TypeScript &raquo;</a></p>
<hr>

<h2>Learning Outcomes</h2>
<ul>
  <li>Learn what TypeScript is and how to get started</li>
  <li>Work with simple types (string, number, boolean)</li>
  <li>Use special types (any, void, never, undefined, null)</li>
  <li>Create and work with arrays and tuples</li>
  <li>Define object types and enums</li>
  <li>Use type aliases and interfaces</li>
  <li>Work with union types and functions</li>
  <li>Understand type casting and classes</li>
  <li>Use basic generics and utility types</li>
</ul>
<div class="ws-note w3-panel">
<p><strong>Note:</strong> Are you a teacher teaching TypeScript? <a href="/academy/index.php" target="_blank">W3Schools Academy</a> is a toolbox of features that can help you teach. It offers classroom features such as pre-built study plans, classroom administration and much more. Read more about <a href="/academy/index.php" target="_blank">Academy here</a>.</p>
</div>
<hr>

<h2>Which Subjects Are TypeScript Relevant For?</h2>
<ul>
   <li style="margin-bottom:16px;"><strong>Web Development:</strong><br> TypeScript enhances JavaScript development with static typing.</li>
   <li style="margin-bottom:16px;"><strong>Front-end Development:</strong><br> TypeScript is widely used in Angular and other frameworks.</li>
   <li style="margin-bottom:16px;"><strong>Back-end Development:</strong><br> TypeScript can be used with Node.js for server-side code.</li>
   <li style="margin-bottom:16px;"><strong>Application Development:</strong><br> TypeScript supports building large-scale applications.</li>
   <li style="margin-bottom:16px;"><strong>Enterprise Software:</strong><br> TypeScript provides better tooling and maintainability.</li>
   <li style="margin-bottom:16px;"><strong>API Development:</strong><br> TypeScript offers strong typing for API contracts.</li>
   <li><strong>Full-stack Development:</strong><br> TypeScript enables type safety across the stack.</li>
</ul>
<p><a title="W3Schools TypeScript Tutorial" href="typescript_intro.php" class="ws-btn" style="margin-top:8px">Get Started</a></p>
<hr>

<h2>Activities</h2>
<p>In this tutorial we offer different activities for you to learn TypeScript for free:</p>
<ul>
    <li><a href="index.php" title="W3Schools TypeScript Tutorial">Lessons</a></li>
    <li><a href="typescript_exercises.php" title="W3Schools TypeScript Exercises">Exercises</a></li>
    <li><a href="typescript_quiz.php" title="W3Schools TypeScript Quiz">Quizzes</a></li>
</ul>
...
<ul class="link-boxes">
    <li><a href="index.php">TS HOME</a></li>
    <li><a href="typescript_intro.php">TS Introduction</a></li>
    <li><a href="typescript_getstarted.php">TS Get Started</a></li>
    <li><a href="typescript_simple_types.php">TS Simple Types</a></li>
    <li><a href="typescript_special_types.php">TS Special Types</a></li>
    <li><a href="typescript_arrays.php">TS Arrays</a></li>
    <li><a href="typescript_tuples.php">TS Tuples</a></li>
    <li><a href="typescript_object_types.php">TS Object Types</a></li>
    <li><a href="typescript_enums.php">TS Enums</a></li>
    <li><a href="typescript_aliases_and_interfaces.php">TS Aliases & Interfaces</a></li>
    <li><a href="typescript_union_types.php">TS Union Types</a></li>
    <li><a href="typescript_functions.php">TS Functions</a></li>
    <li><a href="typescript_casting.php">TS Casting</a></li>
    <li><a href="typescript_classes.php">TS Classes</a></li>
    <li><a href="typescript_basic_generics.php">TS Basic Generics</a></li>
    <li><a href="typescript_utility_types.php">TS Utility Types</a></li>
    <li><a href="typescript_keyof.php">TS Keyof</a></li>
    <li><a href="typescript_null.php">TS Null</a></li>
    <li><a href="typescript_definitely_typed.php">TS Definitely Typed</a></li>
    <li><a href="typescript_5_updates.php">TS 5 Updates</a></li>
</ul>
</div>
<p><a title="W3Schools TypeScript Tutorial" href="index.php" class="ws-btn">Get Started</a></p>
<hr>

<h2>Sandbox and Lab Environment</h2>
<p>TypeScript, like any programming language, is best learned through hands-on practice.</p>
<p>Try this example using our editor:</p>
  <div class="w3-example">
    ...
    <a target="_blank" class="w3-btn w3-margin-bottom" href="trytypescript.php?filename=demo_helloworld">Try it Yourself &raquo;</a>
  </div>
...
that allows you to build, test and run TypeScript applications.</p>
<p>Here you get a secure sandbox environment called Spaces, where you can practice TypeScript code and test projects in real-time.</p>
...
<h2>TypeScript Certification</h2>
<p>W3Schools offers an end-of-pathway certification program.</p>
<p>Here you can take exams to get certified.</p>
<p>The TypeScript exam is a test that summarizes the W3Schools TypeScript syllabus.</p>
<p>After passing the exam you get the "Certified TypeScript Developer" Certification.</p>
...
<div class="ws-grey w3-padding w3-round">
<a href="typescript_exam.png" target="_blank"><img src="typescript_exam.png" style="width: 100%" loading="lazy"></a>
</div>
<p><a class="ws-btn" href="https://campus.w3schools.com/collections/certifications/products/typescript-certificate" target="_blank">Buy Certificate &raquo;</a></p>
<hr>
