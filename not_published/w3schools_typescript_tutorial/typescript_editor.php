...
<html lang="en-US">
<head>
<title>TypeScript Online Editor (Compiler)</title>
<meta property="og:description" content="Online TypeScript Editor.">  
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
/* Syntax highlighting */
.ts-keyword  { color: #005cc5; }
.ts-function { color: #d73a49; }
.ts-string   { color: green; }
.ts-symbol   { color: #000000; }
.ts-object   { color: #000000; }
...
body.darktheme .ts-keyword  { color: #c5a5c5; }
body.darktheme .ts-function { color: #faca6b; }
body.darktheme .ts-string   { color: #c3e88d; }
body.darktheme .ts-symbol   { color: #f1f1f1; }
body.darktheme .ts-object   { color: #f1f1f1; }
...
ny:-->
    ...
    <h1>TypeScript <span class="color_h1">Online Editor</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="typescript_exam.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="typescript_exercises.php">Next &#10095;</a>
</div>
<hr>

<h2>TypeScript Editor</h2>

<p>With our online TypeScript editor, you can edit TypeScript code, and view the result in your browser.</p>
...
<div class="compiler-wrapper">
  ...
  <div class="compiler-body">
    ...
    <div class="editor">
<pre>
<span class="ts-object">console</span><span class="ts-symbol">.</span><span class="ts-function">log</span><span class="ts-symbol">(</span><span class="ts-string">'Hello World!'</span><span class="ts-symbol">);</span>
</pre>
    </div>
...
Hello World!
  ...
  <div class="compiler-footer">
    <a href="trytypescript.php?filename=demo_editor"
       target="_blank"
       class="ws-btn">
...
<h2>Build and Publish TypeScript Projects</h2>

<p>If you want to create your own website or build TypeScript applications, <a href="/spaces/index.php">W3Schools Spaces</a> gives you an easy place to write, run, manage, and publish code online.</p>
...
<div class="ws-note w3-panel" style="margin-top:20px;">
  ...
  <p>If you don't know JavaScript, we suggest that you read our <a href="/js/default.asp">JavaScript Tutorial</a> from scratch.</p>
  <p>If you don't know Node.js, we suggest that you read our <a href="/nodejs/default.asp">Node.js Tutorial</a> from scratch.</p>
</div>
