...
<html lang="en-US">
<head>
<title>Java Write To Files</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1">Write To Files</span></h1>
...
<p>If you are just starting with Java, the easiest way to write text to a file is by using the <code class="w3-codespan">FileWriter</code> class.</p>
<p>In the example below, we use <code class="w3-codespan">FileWriter</code> together with its <code class="w3-codespan">write()</code> method to create and write some text into a file.</p>
<p><strong>Note:</strong> When you are done, you should close the writer with the <code class="w3-codespan">close()</code> method:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white" data-line="7,8,9"><code>import java.io.FileWriter;   // Import the FileWriter class
...
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="showjava.asp?filename=demo_files_write">Run Example &raquo;</a>
</div>
<p><strong>Explanation:</strong> This program tries to write some text 
into a file named <code class="w3-codespan">filename.txt</code>.  
If everything works, the program will print <code class="w3-codespan">"Successfully wrote to the file."</code> in the console.  
If something goes wrong (for example, the file cannot be opened), it will print <code class="w3-codespan">"An error occurred."</code> instead.</p>
<hr>

<h2>Write To a File with try-with-resources</h2>
<p>Since Java 7, you can use <a href="java_try_catch_resources.asp"><b>try-with-resources</b></a>. 
This makes sure the writer is closed automatically, even if an error occurs:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white" data-line="7"><code>import java.io.FileWriter;
...
<p><a target="_blank" class="w3-btn" href="showjava.asp?filename=demo_files_write_try">Run Example &raquo;</a></p>
</div>
...
<p>Normally, <code class="w3-codespan">FileWriter</code> will <strong>overwrite</strong> a file if it already exists.  
If you want to <strong>add new content</strong> at the end of the file (without deleting what's already there),  
you can use the two-argument constructor and pass <code class="w3-codespan">true</code> as the second parameter.  
This puts the writer into <strong>append mode</strong>:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white" data-line="7,8"><code>import java.io.FileWriter;
import java.io.IOException;
...
<p><a target="_blank" class="w3-btn" href="showjava.asp?filename=demo_files_write_append">Run Example &raquo;</a></p>
</div>

<p><strong>Explanation:</strong> This program adds the text  
<code class="w3-codespan">"Appended text!"</code>  
to the end of <code class="w3-codespan">filename.txt</code> instead of replacing the file's content.</p>

<p><strong>Note:</strong> If the file does not already exist, Java will create it before appending.</p>

<p><strong>Tip:</strong> To see what's inside the file, go to the <a href="java_files_read.asp">Java Read Files</a> chapter.</p>
<hr>

<h2>Other Ways to Write to Files</h2>
<p>There are several classes you can use to write files in Java:</p>
<ul>
  <li><code class="w3-codespan">FileWriter</code> - easiest choice for <strong>basic text</strong>.</li>
  <li><code class="w3-codespan">BufferedWriter</code> - better for <strong>large text files</strong>, because it is faster and supports handy features.</li>
  <li><code class="w3-codespan">FileOutputStream</code> - best for <strong>binary data</strong> (images, audio, PDFs)</li>
</ul>

<p>You will learn more about <a href="java_fileoutputstream.asp"><code class="w3-codespan">FileOutputStream</code></a> and <a href="java_bufferedwriter.asp"><code class="w3-codespan">BufferedWriter</code></a> in a later chapter.</p>
<hr>
<div id="exercisecontainer" src="xrcise_files_create.js"></div>
<hr>
