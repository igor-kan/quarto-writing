...
value.</p>
<p>To declare an array, define the variable type with <strong>square brackets</strong> <code class="w3-codespan">[ ]</code> :</p>
...
comma-separated list, inside <strong>curly braces</strong> <code class="w3-codespan">{ }</code>:</p>
<div class="w3-example">
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_array">Try it Yourself &raquo;</a></p>
</div>
...
<p>Think of an array as numbered boxes, where each box stores an element:</p>
<table class="ws-table-all notranslate">
<tr><th style="width:20%">Index</th><th>Element</th></tr>
<tr><td>0</td><td>Volvo</td></tr>
<tr><td>1</td><td>BMW</td></tr>
<tr><td>2</td><td>Ford</td></tr>
<tr><td>3</td><td>Mazda</td></tr>
</table>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_array_change">Try it Yourself &raquo;</a>
</p>
</div>
<hr>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_array_length">Try it Yourself &raquo;</a>
</p>
</div>
<hr>

<h2>The <code class="w3-codespan">new</code> Keyword</h2>
<p>You can also create an array by specifying its size with <code class="w3-codespan">new</code>.  
This makes an empty array with space for a fixed number of elements, which you can fill later:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>String[] cars = new String[4]; // size is 4
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_array_new_keyword">Try it Yourself &raquo;</a>
</p>
</div>

<p>However, if you already know the values, you don't need to write <code class="w3-codespan">new</code>.  
Both of these create the same array:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>// With new
...
<p><strong>Note:</strong> You cannot write <code class="w3-codespan">new String[<strong>4</strong>] {"Volvo", "BMW", "Ford", "Mazda"}</code>.</p>
<p>In Java, when using <code class="w3-codespan">new</code>, you either:</p>
<ul>
  <li>Use <code class="w3-codespan">new String[4]</code> to create an empty array with 4 slots, and then fill them later</li>
  <li>Or use <code class="w3-codespan">new String[] {"Volvo", "BMW", "Ford", "Mazda"}</code> (without specifying the number of elements) to create the array and assign values at the same time</li>
</ul>

<p><strong>Tip:</strong> The shortcut syntax is most often used when the values are known at the start.  
Use <code class="w3-codespan">new</code> with a size when you want to create an empty array and fill it later.</p>
