...
<h3>Example</h3>
<p>Use <code class="w3-codespan">var</code> to declare variables:</p>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_keyword_var">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">var</code> keyword allows a variable to be initialized without having to declare its type. The type of the variable depends on the type of the data that is being assigned to it.</p>
<p>The <code class="w3-codespan">var</code> keyword was introduced in Java 10.</p>
<hr>

<h2>Related Pages</h2>
<p>Read more about variables in our <a href="java_variables.asp">Java Variables Tutorial</a>.</p>
