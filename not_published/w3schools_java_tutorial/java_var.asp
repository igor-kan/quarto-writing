...
<h1>Java <span class="color_h1">var</span> Keyword</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_data_types_non-prim.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_challenges_data_types.asp">Next &#10095;</a>
</div>
<hr>

<h2>The var Keyword</h2>

<p>The <code class="w3-codespan">var</code> keyword was introduced in Java 10 (released in 2018).</p>

<p>The <code class="w3-codespan">var</code> keyword lets the compiler automatically detect the type of a variable based on the value you assign to it.</p>

<p>This helps you write cleaner code and avoid repeating types, especially for long or complex types.</p>

<p><strong>For example</strong>, instead of writing <code class="w3-codespan">int x = 5;</code>, you can write:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>var x = 5;  // x is an int
System.out.println(x);
</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_var">Try it Yourself &raquo;</a>
</p>
</div>

<p>When using <code class="w3-codespan">var</code>, the compiler understands 
that <code class="w3-codespan">5</code> is an <code class="w3-codespan">int</code>.</p>
<hr>

<h2>Example with Different Types</h2>

<p>Here are some examples showing how <code class="w3-codespan">var</code> can be used to create variables of different types, based on the values you assign:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>var myNum = 5;         // int
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_var_dt">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>1. <code class="w3-codespan">var</code> only works when you assign a value at the same time (you can't declare <code class="w3-codespan">var x;</code> without assigning a value):</p>
  <div class="w3-example">
<div class="w3-code notranslate javaHigh w3-border-red">
  var x; // Error<br>var x = 5;&nbsp; // OK</div>
</div>
<p>2. Once the type is chosen, it stays the same. See example below:</p>
  <div class="w3-example">
<div class="w3-code notranslate javaHigh w3-border-red">
  var x = 5;&nbsp; // x is now an int<br>x = 10;&nbsp;&nbsp;&nbsp;&nbsp; //&nbsp;OK - still an int<br>x = 
...
<h2>When to Use var</h2>

<p>For simple variables, it's usually clearer to write the type directly (<code class="w3-codespan">int</code>, <code class="w3-codespan">double</code>, <code class="w3-codespan">char</code>, etc.).</p>

<p>But for more complex types, such as <code class="w3-codespan"><a href="java_arraylist.asp">ArrayList</a></code> or <code class="w3-codespan"><a href="java_hashmap.asp">HashMap</a></code>, <code class="w3-codespan">var</code> can make the code shorter and easier to read:</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_var_arraylist">Try it Yourself &raquo;</a>
</p>
</div>
<p>Don't worry if the example above looks a bit advanced - you will learn more about these complex types later. For now, just remember that <code class="w3-codespan">var</code> was introduced in Java 10, and if you work with others, you might see it in their code - so it's good to know what it means.</p>
