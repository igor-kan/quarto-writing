...
<html lang="en-US">
<head>
<title>Java LinkedList spliterator() Method</title>
<meta charset="utf-8">
...
<h1>Java LinkedList <span class="color_h1">spliterator()</span> Method</h1>

<p>
<a class="w3-btn w3-white w3-border" href="java_ref_linkedlist.asp">&#10094; LinkedList Methods</a>
</p>
...
<h3>Example</h3>
<p>Use a <code class="w3-codespan">Spliterator</code> to loop through items in a list:</p>
<pre class="w3-white language-java"><code>import java.util.LinkedList;
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_linkedlist_spliterator">Try it Yourself &raquo;</a></p>
</div>

<div class="ws-note w3-panel">
<p><strong>Note:</strong> The syntax <code class="w3-white w3-codespan language-java">while( it1.tryAdvance( (n) -> { System.out.println(n); } ) );</code> is equivalent to:</p>
<pre class="language-java"><code>boolean x = it1.tryAdvance( (n) -> { System.out.println(n); });
while(x) {
...
<p>The <code class="w3-codespan">spliterator()</code> method returns a <code class="w3-codespan">Spliterator</code> for the list.</p>
<p>A spliterator is a special type of iterator. To learn how to use iterators, see our <a href="java_iterator.asp">Java Iterator tutorial</a>.</p>
<p>The <code class="w3-codespan">Spliterator</code> is considerably different from an ordinary iterator. The purpose of a spliterator is to separate a collection into smaller pieces so that each piece can be processed by a separate thread. The <code class="w3-codespan">Spliterator</code> interface has two important methods:</p>
<ul>
  <li><code class="w3-codespan">trySplit()</code> - Returns a new spliterator which can iterate through (usually and approximately) half of the elements that the original spliterator has access to, while the original spliterator can iterate through the remaining half.</li>
  <li><code class="w3-codespan">tryAdvance(Consumer <em>action</em>)</code> - Moves to the next item that is available to the spliterator and tries to perform an action on it. If there is no next item then it returns <code class="w3-codespan">false</code>. The action can be defined by a lambda expression.</li>
</ul>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public Spliterator spliterator()</code></pre>

<h2>Technical Details</h2>
<table class="ws-table-all">
<tr>
 <th style="width:20%">Returns:</th>
 <td style="width:80%">A <code class="w3-codespan">Spliterator</code> object.</td>
</tr>
<tr>
 <th style="width:20%">Java version:</th>
 <td style="width:80%">1.8+</td>
</tr>
</table>
<hr>
...
<p><a href="java_iterator.asp">Java Iterator Tutorial</a></p>
