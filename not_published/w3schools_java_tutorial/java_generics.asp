...
<h1>Java <span class="color_h1">Generics</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_wrapper_classes.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_annotations.asp">Next &#10095;</a>
</div>
<hr>

<h2>Java Generics</h2>

<p>Generics allow you to write classes, interfaces, and methods that work with different data types, without having to specify the exact type in advance.</p>

<p>This makes your code more flexible, reusable, and type-safe.</p>
...
<ul>
  <li><strong>Code Reusability:</strong> Write one class or method that works with different data types.</li>
  <li><strong>Type Safety:</strong> Catch type errors at compile time instead of runtime.</li>
  <li><strong>Cleaner Code:</strong> No need for casting when retrieving objects.</li>
</ul>
...
<p>You can create a class that works with different data types using generics:</p>

<div class="w3-example">
<div class="w3-code notranslate javaHigh">
class Box&lt;T&gt; {<br>
&nbsp;&nbsp;T value; // T is a placeholder for any data type<br><br>
...
&nbsp;&nbsp;&nbsp;&nbsp;// Create a Box to hold a String<br>
&nbsp;&nbsp;&nbsp;&nbsp;Box&lt;String&gt; stringBox = new Box&lt;&gt;();<br>
&nbsp;&nbsp;&nbsp;&nbsp;stringBox.set("Hello");<br>
&nbsp;&nbsp;&nbsp;&nbsp;System.out.println("Value: " + stringBox.get());<br><br>

&nbsp;&nbsp;&nbsp;&nbsp;// Create a Box to hold an Integer<br>
&nbsp;&nbsp;&nbsp;&nbsp;Box&lt;Integer&gt; intBox = new Box&lt;&gt;();<br>
&nbsp;&nbsp;&nbsp;&nbsp;intBox.set(50);<br>
&nbsp;&nbsp;&nbsp;&nbsp;System.out.println("Value: " + intBox.get());<br>
&nbsp;&nbsp;}<br>
}
</div>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_generics_class">Try it Yourself &raquo;</a></p>
</div>

<p><code class="w3-codespan">T</code> is a generic type parameter. It's like a placeholder for a data type.</p>

<ul>
  <li>When you create a <code class="w3-codespan">Box&lt;String&gt;</code>, <code class="w3-codespan">T</code> becomes <code class="w3-codespan">String</code>.</li>
  <li>When you create a <code class="w3-codespan">Box&lt;Integer&gt;</code>, <code class="w3-codespan">T</code> becomes <code class="w3-codespan">Integer</code>.</li>
</ul>

<p>This way, the same class can be reused with different data types without rewriting the code.</p>
...
<p>You can also create methods that work with any data type using generics:</p>

<div class="w3-example">
<div class="w3-code notranslate javaHigh">
public class Main {<br>
&nbsp;&nbsp;// Generic method: works with any type T<br>
...
&nbsp;&nbsp;public static void main(String[] args) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Array of Strings<br>
&nbsp;&nbsp;&nbsp;&nbsp;String[] names = {"Jenny", "Liam"};<br><br>

&nbsp;&nbsp;&nbsp;&nbsp;// Array of Integers<br>
&nbsp;&nbsp;&nbsp;&nbsp;Integer[] numbers = {1, 2, 3};<br><br>

&nbsp;&nbsp;&nbsp;&nbsp;// Call the generic method with both arrays<br>
&nbsp;&nbsp;&nbsp;&nbsp;printArray(names);<br>
&nbsp;&nbsp;&nbsp;&nbsp;printArray(numbers);<br>
&nbsp;&nbsp;}<br>
}
</div>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_generics_method">Try it Yourself &raquo;</a></p>
</div>

<h3>Example Explained</h3>
<ul>
  <li><code class="w3-codespan">&lt;T&gt;</code> is a generic type parameter - it means the method can work with any type: <code class="w3-codespan">String</code>, <code class="w3-codespan">Integer</code>, <code class="w3-codespan">Double</code>, etc.</li>
  <li>The method <code class="w3-codespan">printArray()</code> takes an array of type <code class="w3-codespan">T</code> and prints every element.</li>
  <li>When you call the method, Java figures out what <code class="w3-codespan">T</code> should be based on the argument you pass in.</li>
</ul>

<p>This is useful when you want to write one method that works with multiple types, instead of repeating code for each one.</p>
...
<p>You can use the <code class="w3-codespan">extends</code> keyword to limit the types a generic class or method can accept.</p>
<p>For example, you can require that the type must be a subclass of <code class="w3-codespan">Number</code>:</p>
...
&nbsp;&nbsp;public static void main(String[] args) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Use with Integer<br>
&nbsp;&nbsp;&nbsp;&nbsp;Integer[] intNums = {10, 20, 30, 40};<br>
&nbsp;&nbsp;&nbsp;&nbsp;Stats&lt;Integer&gt; intStats = new Stats&lt;&gt;(intNums);<br>
&nbsp;&nbsp;&nbsp;&nbsp;System.out.println("Integer average: " + intStats.average());<br><br>

&nbsp;&nbsp;&nbsp;&nbsp;// Use with Double<br>
&nbsp;&nbsp;&nbsp;&nbsp;Double[] doubleNums = {1.5, 2.5, 3.5};<br>
&nbsp;&nbsp;&nbsp;&nbsp;Stats&lt;Double&gt; doubleStats = new Stats&lt;&gt;(doubleNums);<br>
&nbsp;&nbsp;&nbsp;&nbsp;System.out.println("Double average: " + doubleStats.average());<br>
&nbsp;&nbsp;}<br>
}
</div>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_generics_bounds">Try it Yourself &raquo;</a></p>

</div>
<p>Even though <code class="w3-codespan">int</code> values are used in the first case, the <code class="w3-codespan">.doubleValue()</code> method converts them to <code class="w3-codespan">double</code>, so the result is shown with a decimal point.</p>
<h3>Example Explained</h3>
<ul>
  <li><code class="w3-codespan">&lt;T extends Number&gt;</code>: Restricts <code class="w3-codespan">T</code> to only work with numeric types like <code class="w3-codespan">Integer</code>, <code class="w3-codespan">Double</code>, or <code class="w3-codespan">Float</code>.</li>
  <li><code class="w3-codespan">.doubleValue()</code>: Converts any number to a <code class="w3-codespan">double</code> for calculation.</li>
  <li>Works for any array of numbers as long as the elements are subclasses of <code class="w3-codespan">Number</code>.</li>
</ul>
...
<p>Java Collections like <code class="w3-codespan">ArrayList</code> and <code class="w3-codespan">HashMap</code> use generics internally:</p>
...
<ul>
  <li>Generics make your code flexible and type-safe.</li>
  <li>Use <code class="w3-codespan">T</code> or another letter to define a type placeholder.</li>
  <li>Generics can be applied to classes, methods, and interfaces.</li>
  <li>Use bounds to limit what types are allowed.</li>
</ul>
