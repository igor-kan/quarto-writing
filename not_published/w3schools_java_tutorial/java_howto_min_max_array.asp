...
<html lang="en-US">
<head>
<title>Java How To Find the Minimum and Maximum Element in an Array</title>
<meta charset="utf-8">
...
<h1>Java How To <span class="color_h1">Find Min and Max in Array</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_howto_second_largest_array.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_howto_merge_two_arrays.asp">Next &#10095;</a>
</div>
<hr>

<h2>Find the Minimum and Maximum Element in an Array</h2>
<p>Go through the array and keep track of the highest and lowest values:</p>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_howto_min_max_array">Try it Yourself &raquo;</a></p>
</div>
<p><b>Explanation:</b> Start by assuming the first element is both the maximum and minimum. As you loop through the array, update <code class="w3-codespan">max</code> if you find a larger number and <code class="w3-codespan">min</code> if you find a smaller number.</p>
<hr>
