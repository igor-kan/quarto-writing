...
<html lang="en-US">
<head>
<title>Java Math atan() Method</title>
<meta charset="utf-8">
...
<h1>Java Math <span class="color_h1">atan()</span> Method</h1>
...
<h3>Example</h3>
<p>Return the arc tangent of different numbers:</p>
<pre class="w3-white language-java"><code>System.out.println(Math.atan(0.5));
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_math_atan">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The <code class="w3-codespan">atan()</code> method returns the arc tangent of a number in radians.</p>
<p><strong>Tip:</strong> The <code class="w3-codespan">atan()</code> method only returns angles between -PI/2 and PI/2. The <a href="/java/ref_math_atan2.asp">atan2()</a> method can return any angle.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public static double atan(double <em>number</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>number</em></td>
    <td>Required. A number to find the arc tangent of.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">A <code class="w3-codespan">double</code> value representing the arc tangent of a number in radians.</td>
</tr>
<tr>
