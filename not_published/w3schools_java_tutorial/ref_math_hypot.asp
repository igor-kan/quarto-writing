...
<html lang="en-US">
<head>
<title>Java Math hypot() Method</title>
<meta charset="utf-8">
...
<h1>Java Math <span class="color_h1">hypot()</span> Method</h1>
...
<h3>Example</h3>
<p>Get the distance of 2D points (x, y) from the origin (0, 0):</p>
<pre class="w3-white language-java"><code>System.out.println(Math.hypot(3, 4));
System.out.println(Math.hypot(1, 1));
System.out.println(Math.hypot(1, 10));
</code></pre>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_math_hypot">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">hypot()</code> method returns the length of the hypotenuse of a right angle triangle, which is equivalent to the distance between a 2D point (x, y) and the origin (0, 0).</p>
<p>This method returns a value equal to <code class="w3-codespan">Math.sqrt(x * x + y * y)</code> but it is optimized to prevent overflows and underflows caused during intermediate operations such as addition and multiplication.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public static double hypot(double <em>x</em>, double <em>y</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>x</em></td>
    <td>Required. The x coordinate of a point.</td>
  </tr>
  <tr>
    <td><em>y</em></td>
    <td>Required. The y coordinate of a point.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">A <code class="w3-codespan">double</code> value representing the distance between a point (x, y) and the origin (0, 0).</td>
</tr>
<tr>
