...
<html lang="en-US">
<head>
<title>Java FileOutputStream</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1">FileOutputStream</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_fileinputstream.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_bufferedreader.asp">Next &#10095;</a>
</div>
<hr>

<h2>FileOutputStream</h2>
<p>Earlier, you learned how to <a href="java_files_write.asp">write text to files</a> using <code class="w3-codespan">FileWriter</code>.</p>
<p>The <code class="w3-codespan">FileOutputStream</code> class works in a similar way, but it writes data as <strong>raw bytes</strong>.  
That means you can use it not only for text files, but also for <strong>binary files</strong> (like images, PDFs, or audio).</p>

<hr>

<h2>Write a Text File (Basic Example)</h2>
<p>This example writes a short text string to a file using <code class="w3-codespan">FileOutputStream</code>.</p>
<p><strong>Note:</strong> If the file already exists, its contents will be replaced (overwritten).</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>import java.io.FileOutputStream;
...
<code>
Successfully wrote to file.</code>
</div>
<p><a target="_blank" class="w3-btn" href="showjava.asp?filename=demo_fileoutputstream">Run Example &raquo;</a></p>
</div>
<p><strong>Explanation:</strong> This program creates (or overwrites) <code class="w3-codespan">filename.txt</code>  
and writes <code class="w3-codespan">Hello World!</code> into it. If everything works, it prints  
<code class="w3-codespan">"Successfully wrote to file."</code> in the console. Otherwise, it shows an error message.</p>

<hr>

<h2>Copy a Binary File (Real-World Example)</h2>
<p>The real strength of <code class="w3-codespan">FileOutputStream</code> is that it can handle <strong>any file type</strong>, not just text.  
Here is an example that copies an image file:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>import java.io.FileInputStream;
...
<p><strong>Explanation:</strong> This program reads <code class="w3-codespan">image.jpg</code> and writes it into 
<code class="w3-codespan">copy.jpg</code>. Since it works with raw bytes, it can copy <strong>any kind of file</strong> - text, images, audio, or PDFs.</p>

<div class="ws-note ws-panel">
<p><strong>Note:</strong> On the previous page, you saw <code class="w3-codespan">FileInputStream</code> for reading bytes.  
Here, it is paired with <code class="w3-codespan">FileOutputStream</code> to write bytes. Together, they make it possible to copy files.  </p>
</div>
...
<p>By default, <code class="w3-codespan">FileOutputStream</code> <strong>overwrites</strong> the file if it already exists.  
To <strong>add (append)</strong> new content instead, pass <code class="w3-codespan">true</code> as the second argument:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white" data-line="9"><code>import java.io.FileOutputStream;
import java.io.IOException;
...
<div class="notranslate w3-black w3-padding">
<code>
Successfully appended to file.</code>
</div>
<p><a target="_blank" class="w3-btn" href="showjava.asp?filename=demo_fileoutputstream_append">Run Example &raquo;</a></p>
</div>
<p><strong>Explanation:</strong> This program adds <code class="w3-codespan">Appended text!</code> to the end of  
<code class="w3-codespan">filename.txt</code>, keeping the existing content.</p>

<hr>
<h2>Choosing the Right Class</h2>
<p>Java gives you several ways to write to files. Here's when to pick each one:</p>
<ul>
  <li><a href="java_files_write.asp"><code class="w3-codespan">FileWriter</code></a> - best for <strong>basic text files</strong>. Simple and easy to use.</li>
  <li><a href="java_bufferedwriter.asp"><code class="w3-codespan">BufferedWriter</code></a> - best for <strong>large text files</strong>, because it is faster and lets you add new lines easily.</li>
  <li><code class="w3-codespan">FileOutputStream</code> - best for <strong>binary data</strong> (images, PDFs, audio) or when you need full control of raw bytes.</li>
</ul>
<hr>
<br>
