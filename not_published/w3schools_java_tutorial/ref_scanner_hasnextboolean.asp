...
<html lang="en-US">
<head>
<title>Java Scanner hasNextBoolean() Method</title>
<meta charset="utf-8">
...
<h1>Java Scanner <span class="color_h1">hasNextBoolean()</span> Method</h1>
...
<p>The <code class="w3-codespan">hasNextBoolean()</code> method returns <em>true</em> if the next token represents a boolean value. A token represents a boolean value if its value matches one of the strings "true" or "false". The match is case-insensitive, which means that values like "True" and "FALSE" also represent a boolean value.</p>
...
<h2>Syntax</h2>
<pre class="language-java"><code>public boolean hasNextBoolean()</code></pre>

<h2>Technical Details</h2>
<table class="ws-table-all">
<tr>
 <th style="width:20%">Returns:</th>
 <td style="width:80%">A <code class="w3-codespan">boolean</code> value which if true the next token represents a boolean value.</td>
</tr>
<tr>
