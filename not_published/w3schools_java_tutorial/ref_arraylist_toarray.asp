...
<html lang="en-US">
<head>
<title>Java ArrayList toArray() Method</title>
<meta charset="utf-8">
...
<h1>Java ArrayList <span class="color_h1">toArray()</span> Method</h1>
...
<h3>Example</h3>
<p>Get an array from an <code class="w3-codespan">ArrayList</code>:</p>
...
<p><a target="_blank" class="w3-btn " href="tryjava.asp?filename=demo_ref_arraylist_toarray">Try it Yourself &raquo;</a></p>
</div>
<hr>
...
<tr>
 ...
 <td style="width:80%">An array containing all of the elements of the <code class="w3-codespan">ArrayList</code> in order.</td>
</tr>
<tr>
 <th style="width:20%">Throws:</th>
 <td style="width:80%">
  <code class="w3-codespan">ArrayStoreException</code> - If the type of the array is not compatible with the type of the <code class="w3-codespan">ArrayList</code>.<br>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_arraylist_toarray2">Try it Yourself &raquo;</a></p>
</div>
