...
<html lang="en-US">
<head>
<title>Java Math log() Method</title>
<meta charset="utf-8">
...
<h1>Java Math <span class="color_h1">log()</span> Method</h1>
...
<pre class="w3-white language-java"><code>System.out.println(Math.log(6));
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_math_log">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">log()</code> method returns the natural logarithm of a number.</p>
...
<h2>Syntax</h2>
<pre class="language-java"><code>public static double log(double <em>number</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>number</em></td>
    <td>Required. Specifies the value to calculate the logarithm for. <br>If the value is negative, 
    it returns NaN (Not a Number).<br>If the value is 0, it returns -Infinity.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">A <code class="w3-codespan">double</code> value representing the natural logarithm of a number.</td>
</tr>
<tr>
