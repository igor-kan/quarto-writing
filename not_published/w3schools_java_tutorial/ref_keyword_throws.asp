...
<html lang="en-US">
<head>
<title>Java throws Keyword</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1"> throws</span> Keyword</h1>
<p>
<a class="w3-btn w3-white w3-border" href="java_ref_keywords.asp">&#10094; Java Keywords</a>
</p>
<hr>
...
&nbsp; static void checkAge(int age) <strong>throws</strong> ArithmeticException {
&nbsp;&nbsp;&nbsp; if (age &lt; 18) {
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_throws">Try it Yourself &raquo;</a>
</p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">throws</code> keyword indicates what exception type may be thrown by a method.</p>
<p>There are many exception types available in Java: <code class="w3-codespan">ArithmeticException</code>, <code class="w3-codespan">ClassNotFoundException</code>, <code class="w3-codespan">ArrayIndexOutOfBoundsException</code>, <code class="w3-codespan">SecurityException</code>, etc.</p>
<p>Differences between <a href="ref_keyword_throw.asp"><code class="w3-codespan">throw</code></a> and <code class="w3-codespan">throws</code>:</p>
<table class="ws-table-all notranslate">
<tbody><tr>
<th style="width:50%">throw</th>
<th style="width:50%">throws</th>
</tr>
<tr>
<td>Used to throw an exception for a method</td>
<td>Used to indicate what exception type may be thrown by a method</td>
</tr>
<tr>
<td>Cannot throw multiple exceptions</td>
<td>Can declare multiple exceptions</td>
</tr>
<tr>
<td><strong>Syntax:</strong> 
<ul>
<li><code class="w3-codespan" style="padding:0">throw</code> is followed by an object (new <em>type</em>)</li>
<li>used inside the method</li>
</ul></td>
<td><strong>Syntax:</strong> 
<ul>
<li><code class="w3-codespan" style="padding:0">throws</code> is followed by a class</li>
<li>and used with the method signature</li>
</ul></td>
</tr>
</tbody>
</table>
...
<h2>Related Pages</h2>
<p>Read more about exceptions in our <a href="java_try_catch.asp">Java Try..Catch Tutorial</a>.</p>
