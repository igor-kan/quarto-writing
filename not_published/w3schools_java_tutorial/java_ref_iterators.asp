...
<html lang="en-US">
<head>
<title>Java Iterator Reference</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1">Iterator Interface</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_ref_bufferedwriter.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_ref_collections.asp">Next &#10095;</a>
</div>
<hr>

<h2>Iterator Methods</h2>

<p>The <code class="w3-codespan">Iterator</code> interface provides methods to access and iterate through collections:</p>
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td>hasNext()</td>
    <td>Returns true if there are more elements in the iteration</td>
    <td>boolean</td>
  </tr>
  <tr>
    <td>next()</td>
    <td>Returns the next element in the iteration</td>
    <td><em>T</em></td>
  </tr>
  <tr>
    <td>remove()</td>
    <td>Removes the last element returned by next()</td>
    <td>void</td>
  </tr>
</table>
<p><strong>Note:</strong> The <code class="w3-codespan">next()</code> method uses the type of the iterator's items as its return value. This type is referred to as <em>T</em> in the table.</p>
<hr>
