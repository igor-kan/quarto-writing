...
<html lang="en-US">
<head>
<title>Java How To Find the Square Root of a Number</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1">How To Find the Square Root of a Number</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_howto_pos_or_neg.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_howto_area_of_rectangle.asp">Next &#10095;</a>
</div>
<hr>

<h2>Square Root of a Number</h2>
<p>You can use <code class="w3-codespan">Math.sqrt()</code> to find the square root of a number:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Find the square root of 64:</p>
<pre class="language-java w3-white"><code>Math.sqrt(64);</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryjava.asp?filename=demo_howto_find_square_root">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Related Pages</h2>
