...
<h1>Java <span class="color_h1">Nested Loops</span></h1>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_for_loop_nested">Try it Yourself &raquo;</a>
</p>
</div>
<hr>
...
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>for (int i = 1; i &lt;= 3; i++) {<br>&nbsp;&nbsp;for (int j = 1; j &lt;= 3; j++) {<br>&nbsp;&nbsp;&nbsp;&nbsp;System.out.print(i * j + " ");<br>&nbsp;&nbsp;}<br>&nbsp;&nbsp;System.out.println();<br>}
</code></pre>
<pre class="w3-black w3-padding">
<code>1 2 3
2 4 6
3 6 9</code>
</pre>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_for_loop_nested_table">Try it Yourself &raquo;</a>
</p>
</div>
<p>Nested loops are useful when working with tables, matrices, or <a href="java_arrays_multi.asp">multi-dimensional data structures</a>.</p>
