...
<html lang="en-US">
<head>
<title>Java catch Keyword</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1"> catch</span> Keyword</h1>
<p>
...
<h3>Example</h3>
<p>If an error occur, use try...catch to catch the error and execute some code to handle it:</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_try_catch">Try it Yourself &raquo;</a>
</p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">catch</code> keyword catches exceptions generated by <code class="w3-codespan"><a href="ref_keyword_try.asp">try</a></code> statements.</p>
