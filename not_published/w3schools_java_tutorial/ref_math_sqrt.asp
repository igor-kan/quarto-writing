...
<html lang="en-US">
<head>
<title>Java Math sqrt() Method</title>
<meta charset="utf-8">
...
<h1>Java Math <span class="color_h1">sqrt()</span> Method</h1>
...
<pre class="w3-white language-java"><code>System.out.println(Math.sqrt(0));
System.out.println(Math.sqrt(1));
System.out.println(Math.sqrt(9));
System.out.println(Math.sqrt(0.64));
System.out.println(Math.sqrt(-9));
</code></pre>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_math_sqrt">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">sqrt()</code> method returns the square root of a number.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public static double sqrt(double <em>number</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>number</em></td>
    <td>Required. A number to find the square root of.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">A <code class="w3-codespan">double</code> value representing the square root of a number.
 <br>If the number is less than 0, it returns NaN.</td>
</tr>
<tr>
