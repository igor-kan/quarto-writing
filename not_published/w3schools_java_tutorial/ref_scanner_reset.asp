...
<html lang="en-US">
<head>
<title>Java Scanner reset() Method</title>
<meta charset="utf-8">
...
<h1>Java Scanner <span class="color_h1">reset()</span> Method</h1>
...
<h3>Example</h3>
<p>Reset changes made to the scanner's configuration:</p>
...
<p>The <code class="w3-codespan">reset()</code> method resets all changes to the scanner's configuration. Configuration of the scanner can be changed by the <code class="w3-codespan">useDelimiter()</code>, <code class="w3-codespan">useLocale()</code> and <code class="w3-codespan">useRadix()</code> methods.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public Scanner reset()</code></pre>

<h2>Technical Details</h2>
<table class="ws-table-all">
<tr>
 <th style="width:20%">Returns:</th>
 <td style="width:80%">A reference to the <code class="w3-codespan">Scanner</code> object that this method belongs to, which allows for chaining configuration methods. An example of chaining is <code class="language-java">myObj.reset().useDelimiter(",");</code>.</td>
</tr>
<tr>
