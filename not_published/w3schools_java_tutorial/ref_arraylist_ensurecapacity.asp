...
<html lang="en-US">
<head>
<title>Java ArrayList ensureCapacity() Method</title>
<meta charset="utf-8">
...
<h1>Java ArrayList <span class="color_h1">ensureCapacity()</span> Method</h1>
...
<h3>Example</h3>
<p>Increase the capacity of a list to 15 items:</p>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_arraylist_ensurecapacity">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">ensureCapacity()</code> method increases the capacity of a list to a specified amount, if necessary.</p>
<p>This method does not have a visible effect but it can make code more efficient.</p>
<p>When methods such as <code class="w3-codespan">add()</code> and <code class="w3-codespan">addAll()</code> are called, if the capacity of a list is not large enough then some extra work is done to add enough space for the new items. It takes a bit of time to do this, so having this happen with every <code class="w3-codespan">add()</code> call is not ideal.</p>
<p>If you know approximately how many items you are going to add, the <code class="w3-codespan">ensureCapacity()</code> method allows you to increase the capacity of the list just once for multiple <code class="w3-codespan">add()</code> calls.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public void add(int <em>capacity</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    ...
    <td>Required. Specifies the number of items that the list should be able to hold.</td>
  </tr>
</table>
