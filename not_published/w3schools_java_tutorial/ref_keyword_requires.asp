...
<html lang="en-US">
<head>
<title>Java requires Keyword</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1"> requires</span> Keyword</h1>
<p>
...
<h3>Example</h3>
<p>Use <code class="w3-codespan">requires</code> in a module's <em>module-info.java</em> file:</p>
<pre class="w3-white language-java"><code>module mymodule {
  requires module1;
...
<p>The <code class="w3-codespan">requires</code> keyword is a module directive that specifies a different module which this module depends on.</p>
<p>There are two modifiers which can be added to the <code class="w3-codespan">requires</code> directive: <code class="w3-codespan">transitive</code> and <code class="w3-codespan">static</code></p>
<p>The <code class="w3-codespan">transitive</code> modifier allows other modules to use this module without also having to declare this same requirement.</p>
<p>The <code class="w3-codespan">static</code> modifier makes the requirement optional during runtime. It allows this module to run even if the other module is not present.</p>
<p><strong>Note:</strong> The <code class="w3-codespan">requires</code> keyword is a module directive meant to be used in the <em>module-info.java</em> file of a module.</p>
<p>The <code class="w3-codespan">requires</code> keyword was new in Java 9.</p>
