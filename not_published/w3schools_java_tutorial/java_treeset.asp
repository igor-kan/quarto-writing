...
<h1>Java <span class="color_h1">TreeSet</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_hashset.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_linkedhashset.asp">Next &#10095;</a>
</div>
<hr>

<h2>Java TreeSet</h2>

<p>A <code class="w3-codespan">TreeSet</code> is a collection that stores unique elements <strong>in sorted order</strong>.</p>
<p>It is part of the <code class="w3-codespan">java.util</code> package and implements the <a href="java_set.asp"><code class="w3-codespan">Set</code></a> interface.</p>

<div class="ws-note ws-panel">
  <p><strong>Tip:</strong> Unlike <code class="w3-codespan">HashSet</code>, which has no order, <code class="w3-codespan">TreeSet</code> keeps its elements sorted automatically.</p>
</div>

<hr>

<h2>Create a TreeSet</h2>
<div class="w3-example">
  <h3>Example</h3>
<p>Create a <code class="w3-codespan">TreeSet</code> object called <strong>cars</strong> that will store strings:</p>
  <pre class="language-java w3-white"><code>import java.util.TreeSet; // Import the TreeSet class

TreeSet&lt;String&gt; cars = new TreeSet&lt;&gt;();</code></pre>
</div>
<p>Now you can use methods like <code class="w3-codespan">add()</code>, <code class="w3-codespan">contains()</code>, and <code class="w3-codespan">remove()</code> to manage your sorted set of elements.</p>
<hr>

<h2>Add Elements</h2>
<p>To add elements to a <code class="w3-codespan">TreeSet</code>, use the <code class="w3-codespan">add()</code> method:</p>

<div class="w3-example">
  <h3>Example</h3>
  <pre class="language-java w3-white"><code>import java.util.TreeSet;
...
public class Main {
  ...
  <p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_treeset_add">Try it Yourself &raquo;</a></p>
</div>

<div class="ws-note ws-panel">
  <p><strong>Output:</strong> The elements will be sorted automatically (e.g., [BMW, Ford, Mazda, Volvo]).</p>
  <p><strong>Note:</strong> Duplicates like "BMW" will only appear once.</p>
</div>
...
<p>Use <code class="w3-codespan">contains()</code> to check if an element exists:</p>

<div class="w3-example">
  <h3>Example</h3>
  <pre class="language-java w3-white"><code>cars.contains("Mazda");</code></pre>
  <p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_treeset_contains">Try it Yourself &raquo;</a></p>
</div>

<hr>

<h2>Remove an Element</h2>
<p>Use <code class="w3-codespan">remove()</code> to remove an element:</p>

<div class="w3-example">
  <h3>Example</h3>
  <pre class="language-java w3-white"><code>cars.remove("Volvo");</code></pre>
  <p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_treeset_remove">Try it Yourself &raquo;</a></p>
</div>

<hr>

<h2>Remove All Elements</h2>
<p>Use <code class="w3-codespan">clear()</code> to remove all elements:</p>

<div class="w3-example">
  <h3>Example</h3>
  <pre class="language-java w3-white"><code>cars.clear();</code></pre>
  <p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_treeset_clear">Try it Yourself &raquo;</a></p>
</div>

<hr>

<h2>TreeSet Size</h2>
<p>Use <code class="w3-codespan">size()</code> to count how many unique elements are in the set:</p>
<div class="w3-example">
  <h3>Example</h3>
  <pre class="language-java w3-white"><code>cars.size();</code></pre>
  <p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_treeset_size">Try it Yourself &raquo;</a></p>
</div>
  <p><strong>Note:</strong> Duplicate values are not counted - only unique elements are included in the size.</p>
<hr>

<h2>Loop Through a TreeSet</h2>
<p>Loop through the elements of a <code class="w3-codespan">TreeSet</code> with a <b>for-each</b> loop:</p>

<div class="w3-example">
  <h3>Example</h3>
  <pre class="language-java w3-white"><code>TreeSet&lt;String&gt; cars = new TreeSet&lt;&gt;();
// add elements...

for (String i : cars) {
  System.out.println(i);
}</code></pre>
  <p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_treeset_loop">Try it Yourself &raquo;</a></p>
</div>

<hr>

<h2>Using TreeSet with Numbers</h2>
<p><code class="w3-codespan">TreeSet</code> also works with numbers and sorts them from smallest to largest:</p>
...
public class Main {
  ...
  <p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_treeset_numbers">Try it Yourself &raquo;</a></p>
</div>

<div class="ws-note ws-panel">
  <p><strong>Output:</strong> The numbers will be printed in sorted order (10, 20, 30, 40).</p>
</div>
...
<table class="ws-table-all notranslate">
  <tr>
    <th>Feature</th>
    <th><code class="w3-codespan">HashSet</code></th>
    <th><code class="w3-codespan">TreeSet</code></th>
  </tr>
  <tr>
    <td>Order</td>
    <td>No guaranteed order</td>
    <td>Sorted (natural order)</td>
  </tr>
  <tr>
    <td>Duplicates</td>
    <td>Not allowed</td>
  ...
  <tr>
    <td>Performance</td>
    <td>Faster (no sorting)</td>
    <td>Slower (due to sorting)</td>
  </tr>
</table>

<div class="ws-note ws-panel">
  <p><strong>Tip:</strong> Use <a href="java_hashset.asp"><code class="w3-codespan">HashSet</code></a> when you care about speed, and <code class="w3-codespan">TreeSet</code> when you need sorted elements.</p>
</div>
<hr>
...
<p>
From Java 10, you can use the <code class="w3-codespan">var</code> keyword to declare a <code class="w3-codespan">TreeSet</code> variable without writing the type twice.  
...
var cars = new TreeSet&lt;String&gt;();
  ...
  <p>
    <a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_treeset_var">Try it Yourself &raquo;</a>
  </p>
</div>
...
<p><strong>Note:</strong> Sometimes you will see both <code class="w3-codespan">Set</code> and <code class="w3-codespan">TreeSet</code> in Java code, like this:</p>

<div class="w3-example">
  <pre class="language-java w3-white"><code>import java.util.Set;
import java.util.TreeSet;

Set&lt;String&gt; cars = new TreeSet&lt;&gt;();</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_treeset_set">Try it Yourself &raquo;</a>
</p>
</div>
<p>This means the variable (cars) is declared as a <a href="java_set.asp"><code class="w3-codespan">Set</code></a> (the interface), but it stores a <code class="w3-codespan">TreeSet</code> object (the actual set). Since <code class="w3-codespan">TreeSet</code> implements the <code class="w3-codespan">Set</code> interface, this is possible.</p>
