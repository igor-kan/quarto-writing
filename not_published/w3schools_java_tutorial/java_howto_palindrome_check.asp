...
<html lang="en-US">
<head>
<title>Java How To Check if a String Is a Palindrome</title>
<meta charset="utf-8">
...
<h1>Java How To - <span class="color_h1">Palindrome Check</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_howto_reverse_string.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_howto_check_anagram_strings.asp">Next &#10095;</a>
</div>
<hr>

<h2>How To Check if a String Is a Palindrome</h2>
<p>Learn how to check whether a word reads the same forward and backward (like <code class="w3-codespan">&quot;level&quot;</code>):</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>String text = &quot;level&quot;;
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_howto_palindrome_string_loop">Try it Yourself &raquo;</a></p>
</div>

<p><b>Explanation:</b>  
We compare the first character with the last, the second with the second-last, and so on.  
<br>- If all pairs match, the string is a palindrome.  
<br>- If any pair does not match, it is not a palindrome.  
<br>For example, in <code class="w3-codespan">&quot;level&quot;</code>:  
<ul>
  <li><code class="w3-codespan">l == l</code></li>
  <li><code class="w3-codespan">e == e</code></li>
</ul>
Since all characters match, the word is a palindrome.</p>
<hr>
<h2>Using StringBuilder</h2>
<p>You can also use <code class="w3-codespan">StringBuilder</code>, which is a special Java class that makes it easy to work with and change strings (for example, reversing them):</p>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_howto_palindrome_string">Try it Yourself &raquo;</a></p>
</div>

<p><b>Explanation:</b>  
We take the string <code class="w3-codespan">text</code> and use <code class="w3-codespan">StringBuilder.reverse()</code> to create its reverse.  
If the original and reversed strings are the same (ignoring case with <code class="w3-codespan">equalsIgnoreCase()</code>), then it is a palindrome.</p>
