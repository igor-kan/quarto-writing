...
<html lang="en-US">
<head>
<title>Java Math negateExact() Method</title>
<meta charset="utf-8">
...
<h1>Java Math <span class="color_h1">negateExact()</span> Method</h1>
...
<h3>Example</h3>
<p>Change the sign of different numbers:</p>
<pre class="w3-white language-java"><code>System.out.println(Math.negateExact(15));
System.out.println(Math.negateExact(-32));
System.out.println(Math.negateExact(7));
System.out.println(Math.negateExact(-25));
</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryjava.asp?filename=demo_ref_math_negateexact">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">negateExact()</code> method returns an integer with equal value and opposite sign to another integer and throws an exception if an overflow occurs. This prevents incorrect results that can occur from the overflow.</p>
<p>An overflow occurs when the integer is equal to <code class="w3-codespan">Integer.MIN_VALUE</code> or <code class="w3-codespan">Long.MIN_VALUE</code>, the largest negative integer, because it does not have a positive equivalent.</p>
<hr>

<h2>Syntax</h2>
<p>One of the following:</p>
<pre class="language-java"><code>public static int negateExact(int <em>x</em>)</code></pre>
<pre class="language-java"><code>public static long negateExact(long <em>x</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>x</em></td>
    <td>Required. An integer to negate.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">An <code class="w3-codespan">int</code> or <code class="w3-codespan">long</code> value representing an integer with equal value and opposite sign to another integer.</td>
</tr>
<tr>
 <th style="width:20%">Throws:</th>
 <td style="width:80%"> <code class="w3-codespan">ArithmeticException</code> - If the negation causes an overflow.</td>
</tr>
<tr>
