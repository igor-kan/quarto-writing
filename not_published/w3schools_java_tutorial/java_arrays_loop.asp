...
<html lang="en-US">
<head>
<title>Java Loop Through an Array</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1">Arrays Loop</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_arrays.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_arrays_reallife.asp">Next &#10095;</a>
</div>
<hr>

<h2>Loop Through an Array</h2>
<p>You can loop through the array elements with the <code class="w3-codespan">for</code> loop, 
and use the <code class="w3-codespan">length</code> property to specify how many times the loop should run.</p>
<p>This example creates an array of strings and then uses a <code class="w3-codespan">for</code> loop to print each element, one by one:</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_array_loop">Try it Yourself &raquo;</a>
</p>
</div>
<p>Here is a similar example with numbers. We create an array of integers and use a <code class="w3-codespan">for</code> loop to print each value:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>int[] numbers = {10, 20, 30, 40};
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_array_loop_num">Try it Yourself &raquo;</a>
</p>
</div>
<hr>

<h2>Calculate the Sum of Elements</h2>
<p>Now that you know how to work with arrays and loops, let's use them together to calculate the sum of all elements in an array:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>int[] numbers = {1, 5, 10, 25};
int sum = 0;
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_array_loop_sum">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>There is also a "<b>for-each</b>" loop, which is used exclusively to loop through elements in an array (or other <a href="java_data_structures.asp">data structures</a>):</p>

<div class="w3-example">
<h3>Syntax</h3>
<pre class="language-java w3-white"><code>for (<em>type</em> <em>variable</em> : <em>arrayname</em>) {
  // code block to be executed
}
</code></pre>
</div>

<p>The colon (<code class="w3-codespan">:</code>) is read as &quot;in&quot;.  
So you can read the loop as: <em>&quot;for each variable in array&quot;</em>.</p>

<p>The following example uses a <b>for-each</b> loop to print all elements in the <strong>cars</strong> array:</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_array_for_each">Try it Yourself &raquo;</a>
</p>
</div>

<p>This means: <strong>for each</strong> <code class="w3-codespan">String</code> in the <code class="w3-codespan">cars</code> array (here called <code class="w3-codespan">car</code>), print its value.</p>

<p>Compared to a regular <code class="w3-codespan">for</code> loop, the <b>for-each</b> loop is easier to write and read because it does not need a counter (like <code class="w3-codespan">i &lt; cars.length</code>).  
However, it only gives you the values, not their positions (indexes) in the array.</p>

<p>So, if you need both the position (index) of each element and its value, a regular <code class="w3-codespan">for</code> loop is the right choice. For example, when printing seat numbers in a theater row, you need to show both the seat number (the index) and who is sitting there (the value):</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>String[] seats = {&quot;Jenny&quot;, &quot;Liam&quot;, &quot;Angie&quot;, &quot;Bo&quot;};

for (int i = 0; i &lt; seats.length; i++) {
  System.out.println(&quot;Seat number &quot; + i + &quot; is taken by &quot; + seats[i]);
}</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_array_loop_index">Try it Yourself &raquo;</a>
</p>
</div>

<div class="ws-note ws-panel">
<p><strong>Note:</strong> The <b>for-each</b> loop is great when you only need to read elements.  
If you want to change the elements later, or keep track of their index, use a regular <code class="w3-codespan">for</code> loop instead.</p>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryjava.asp?filename=demo_array_new">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryjava.asp?filename=demo_array_new2">Try it Yourself &raquo;</a>
</div>
<hr>
-->
<hr>
