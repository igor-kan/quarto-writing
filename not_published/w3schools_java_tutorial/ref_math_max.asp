...
<html lang="en-US">
<head>
<title>Java Math max() Method</title>
<meta charset="utf-8">
...
<h1>Java Math <span class="color_h1">max()</span> Method</h1>
...
<h3>Example</h3>
<p>Get the highest value from different pairs of numbers:</p>
<pre class="w3-white language-java"><code>System.out.println(Math.max(2.0, 0.25));
System.out.println(Math.max(31.2f, 18.0f));
System.out.println(Math.max(14, 22));
System.out.println(Math.max(96L, 2048L));
</code></pre>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_math_max">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">max()</code> method returns the number with the highest value from a pair of numbers.</p>
<p><strong>Tip:</strong> Use the <code class="w3-codespan"><a href="ref_math_min.asp">min()</a></code> method to return the number with the lowest value.</p>
<hr>

<h2>Syntax</h2>
<p>One of the following:</p>
<pre class="language-java"><code>public static double max(double <em>x</em>, double <em>y</em>)</code></pre>
<pre class="language-java"><code>public static float max(float <em>x</em>, float <em>y</em>)</code></pre>
<pre class="language-java"><code>public static int max(int <em>x</em>, int <em>y</em>)</code></pre>
<pre class="language-java"><code>public static long max(long <em>x</em>, long <em>y</em>)</code></pre>
...
<tr>
 ...
 <td style="width:80%">A <code class="w3-codespan">double</code>, <code class="w3-codespan">float</code>, <code class="w3-codespan">int</code> or <code class="w3-codespan">long</code> value representing the highest of two numbers.</td>
</tr>
<tr>
