...
<h1>Java <span class="color_h1">LinkedHashMap</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_treemap.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_iterator.asp">Next &#10095;</a>
</div>
<hr>

<h2>Java LinkedHashMap</h2>

<p>A <code class="w3-codespan">LinkedHashMap</code> stores keys and values, and keeps them in the same order you put them in.</p>

<p>It is part of the <code class="w3-codespan">java.util</code> package and implements the <a href="java_map.asp"><code class="w3-codespan">Map</code></a> interface.</p>

<div class="ws-note ws-panel">
  <p><strong>Tip:</strong> Use <code class="w3-codespan">LinkedHashMap</code> when you want predictable iteration order (insertion order).</p>
</div>
<hr>

<h2>Create a LinkedHashMap</h2>
<p>
  Create a <code class="w3-codespan">LinkedHashMap</code> object called <code class="w3-codespan">capitalCities</code> that will store 
  <code class="w3-codespan">String</code> keys and <code class="w3-codespan">String</code> values:
</p>

<div class="w3-example">
  <h3>Example</h3>
  <pre class="language-java w3-white"><code>import java.util.LinkedHashMap; // Import the LinkedHashMap class

LinkedHashMap&lt;String, String&gt; capitalCities = new LinkedHashMap&lt;&gt;();</code></pre>
</div>
<p>
  Now you can use methods like <code class="w3-codespan">put()</code> to add key/value pairs, 
  <code class="w3-codespan">get()</code> to retrieve a value by key, 
  and <code class="w3-codespan">remove()</code> to delete an entry - all while maintaining insertion order.
</p>
<hr>

<h2>Add Items</h2>
<p>Use the <code class="w3-codespan">put()</code> method to add items to the <code class="w3-codespan">LinkedHashMap</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>// Import the LinkedHashMap class
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_linkedhashmap_put">Try it Yourself &raquo;</a>
</p>
</div>
<div class="ws-note ws-panel">
  <p><strong>Output:</strong> The items will appear in the order they were added (e.g., {England=London, India=New Dehli, Austria=Wien, Norway=Oslo, USA=Washington DC}).</p>
  <p><strong>Note:</strong> Duplicates like "Norway" are ignored.</p>
</div>
...
<p>Use <code class="w3-codespan">get()</code> with a key to get its associated value:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>capitalCities.get("England");</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_linkedhashmap_get">Try it Yourself &raquo;</a>
</p>
</div>
<hr>

<h2>Remove an Item</h2>
<p>Use <code class="w3-codespan">remove()</code> to remove an item by key:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>capitalCities.remove("England");</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_linkedhashmap_remove">Try it Yourself &raquo;</a>
</p>
</div>

<p>Use <code class="w3-codespan">clear()</code> to remove all items:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>capitalCities.clear();</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_linkedhashmap_clear">Try it Yourself &raquo;</a>
</p>
</div>

<hr>

<h2>LinkedHashMap Size</h2>
<p>Use <code class="w3-codespan">size()</code> to check how many key/value pairs are in the map:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>capitalCities.size();</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_linkedhashmap_size">Try it Yourself &raquo;</a>
</p>
</div>
<p><strong>Note:</strong> The size only counts unique keys. If a key is added more than once, only the latest value is kept.</p>
<hr>

<h2>Loop Through a LinkedHashMap</h2>
<p>You can loop through a <code class="w3-codespan">LinkedHashMap</code> using a for-each loop. Use:</p>
<ul>
  <li><code class="w3-codespan">keySet()</code> to get all keys</li>
  <li><code class="w3-codespan">values()</code> to get all values</li>
</ul>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_linkedhashmap_loop_key">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_linkedhashmap_loop_value">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_linkedhashmap_loop_keyvalue">Try it Yourself &raquo;</a>
</p>
</div>

<hr>

<h2>HashMap vs LinkedHashMap</h2>
<table class="ws-table-all notranslate">
  <tr>
    <th>Feature</th>
    <th><code class="w3-codespan">HashMap</code></th>
    <th><code class="w3-codespan">LinkedHashMap</code></th>
  </tr>
  <tr>
    <td>Order</td>
  ...
  <tr>
    <td>Performance</td>
    <td>Faster for random access</td>
...
<div class="ws-note ws-panel">
  <p><strong>Tip:</strong> Use <code class="w3-codespan">LinkedHashMap</code> when you want the map to remember the order in which entries were added.</p>
</div>
<hr>
...
<p>
From Java 10, you can use the <code class="w3-codespan">var</code> keyword to declare a <code class="w3-codespan">LinkedHashMap</code> variable without writing the type twice.  
...
var capitalCities = new LinkedHashMap&lt;String, String&gt;();
  ...
  <p>
    <a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_linkedhashmap_var">Try it Yourself &raquo;</a>
  </p>
</div>
...
<p><strong>Note:</strong> Sometimes you will see both <code class="w3-codespan">Map</code> and <code class="w3-codespan">LinkedHashMap</code> in Java code, like this:</p>

<div class="w3-example">
  <pre class="language-java w3-white"><code>import java.util.Map;
import java.util.LinkedHashMap;

Map&lt;String, String&gt; capitalCities = new LinkedHashMap&lt;&gt;();
</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_linkedhashmap_map">Try it Yourself &raquo;</a>
</p>
</div>
<p>This means the variable (capitalCities) is declared as a <a href="java_map.asp"><code class="w3-codespan">Map</code></a> (the interface), but it stores a <code class="w3-codespan">LinkedHashMap</code> object (the actual map). Since <code class="w3-codespan">LinkedHashMap</code> implements the <code class="w3-codespan">Map</code> interface, this is possible.</p>
