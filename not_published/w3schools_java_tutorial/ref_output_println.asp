...
<html lang="en-US">
<head>
<title>Java Output println() Method</title>
<meta charset="utf-8">
...
<h1>Java Output <span class="color_h1">println()</span> Method</h1>
...
<h3>Example</h3>
<p>Print some text to the console, followed by a new line:</p>
<pre class="w3-white language-java"><code>System.out.println(&quot;Hello World!&quot;);
System.out.println(&quot;I will print a new line.&quot;);</code></pre>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_output_println">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">println()</code> method prints text or values 
to the console, followed by a new line.</p>
<p>This method is often preferred over the <a href="ref_output_print.asp"><code class="w3-codespan">print()</code></a> method, as the new line makes 
the output of code easier to read.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>System.out.println(<em>argument</em>);</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    ...
    <td>A value or text that should be printed to the console</td>
  </tr>
</table>
