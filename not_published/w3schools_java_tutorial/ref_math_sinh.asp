...
<html lang="en-US">
<head>
<title>Java Math sinh() Method</title>
<meta charset="utf-8">
...
<h1>Java Math <span class="color_h1">sinh()</span> Method</h1>
...
<pre class="w3-white language-java"><code>System.out.println(Math.sinh(3));
System.out.println(Math.sinh(-3));
System.out.println(Math.sinh(0));
System.out.println(Math.sinh(1));
</code></pre>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_math_sinh">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">sinh()</code> method returns the hyperbolic sine of a number.</p>
<p>The hyperbolic sine is equivalent to <code class="w3-codespan">(Math.exp(number) - Math.exp(-number)) / 2</code>.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public static double sinh(double <em>number</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>number</em></td>
    <td>Required. A number to find the hyperbolic sine of.</td>
  </tr>
</table>
...
<tr>
  ...
  <td style="width:80%">A <code class="w3-codespan">double</code> value representing the hyperbolic sine of a number.</td>
</tr>
<tr>
