...
<html lang="en-US">
<head>
<title>Java How To Count Vowels in a String</title>
<meta charset="utf-8">
...
<h1>Java How To - <span class="color_h1">Count Vowels in a String</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_howto_count_words.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_howto_remove_vowels_string.asp">Next &#10095;</a>
</div>
<hr>

<h2>Count Vowels in a String</h2>
<p>Loop through each character and count <code class="w3-codespan">a, e, i, o, u</code> (case-insensitive).</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>String text = "Hello Java";
int count = 0;
...
System.out.println("Vowels: " + count);</code></pre>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_howto_count_vowels_string">Try it Yourself &raquo;</a></p>
</div>

<p><b>Explanation:</b> We convert the string to lowercase, loop through each character, and count whenever we see a vowel.</p>
<hr>

<h2>General Example</h2>
<p>The example above checks each vowel with multiple conditions. That works fine, but if you want a more general solution, you can store the vowels in a <code class="w3-codespan">Set</code> and check characters against it:</p>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_howto_count_vowels_string2">Try it Yourself &raquo;</a></p>
</div>

<p><b>Explanation:</b> We first add all vowels to a <code class="w3-codespan">Set</code>. Then we loop through the characters of the string (converted to lowercase). Each character is checked against the set, and if it exists, the counter goes up. This method is easier to extend if you want to count other characters (like consonants, digits, or symbols).</p>
