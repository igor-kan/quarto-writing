...
<html lang="en-US">
<head>
<title>Java Math floorMod() Method</title>
<meta charset="utf-8">
...
<h1>Java Math <span class="color_h1">floorMod()</span> Method</h1>
...
<h3>Example</h3>
<p>Return the remainders of rounded-down divisions:</p>
<pre class="w3-white language-java"><code>System.out.println(Math.floorMod(10, 4));
System.out.println(Math.floorMod(-10, 4));
System.out.println(Math.floorMod(10, 3));
System.out.println(Math.floorMod(-10, 3));
</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryjava.asp?filename=demo_ref_math_floormod">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">floorMod()</code> method returns the remainder of a division between two integers where the result of the division was rounded down.</p>
<p></p>The result is equal to <code class="w3-codespan">dividend - Math.floorDiv(dividend, divisor) * divisor</code>.</p>
<p>
<hr>

<h2>Syntax</h2>
<p>One of the following:</p>
<pre class="language-java"><code>public static int floorMod(int <em>dividend</em>, int <em>divisor</em>)</code></pre>
<pre class="language-java"><code>public static long floorMod(long <em>dividend</em>, long <em>divisor</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>dividend</em></td>
    <td>Required. The dividend of the remainder operation.</td>
  </tr>
  <tr>
    <td><em>divisor</em></td>
    <td>Required. The divisor of the remainder operation.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">An <code class="w3-codespan">int</code> or <code class="w3-codespan">long</code> value representing the remainder from a division between two integers.</td>
</tr>
<tr>
 <th style="width:20%">Throws:</th>
 <td style="width:80%"> <code class="w3-codespan">ArithmeticException</code> - If the divisor is zero.</td>
</tr>
<tr>
