...
<html lang="en-US">
<head>
<title>Java HashMap size() Method</title>
<meta charset="utf-8">
...
<h1>Java HashMap <span class="color_h1">size()</span> Method</h1>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_hashmap_size">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">size()</code> method returns the number of entries in a map.</p>
<hr>
...
<tr>
 ...
 <td style="width:80%">The number of entries in the map.</td>
</tr>
</table>
<hr>
