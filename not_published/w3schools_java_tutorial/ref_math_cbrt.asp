...
<html lang="en-US">
<head>
<title>Java Math cbrt() Method</title>
<meta charset="utf-8">
...
<h1>Java Math <span class="color_h1">cbrt()</span> Method</h1>
...
<h3>Example</h3>
<p>Return the cube root of different numbers:</p>
<pre class="w3-white language-java"><code>System.out.println(Math.cbrt(0));
System.out.println(Math.cbrt(1));
System.out.println(Math.cbrt(27));
System.out.println(Math.cbrt(0.64));
System.out.println(Math.cbrt(-27));
</code></pre>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_math_cbrt">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">cbrt()</code> method returns the cube root of a number.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public static double cbrt(double <em>number</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>number</em></td>
    <td>Required. A number to find the cube root of.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">A <code class="w3-codespan">double</code> value representing the cube root of a number.</td>
</tr>
<tr>
