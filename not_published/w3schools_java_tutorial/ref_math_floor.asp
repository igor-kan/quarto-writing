...
<html lang="en-US">
<head>
<title>Java Math floor() Method</title>
<meta charset="utf-8">
...
<h1>Java Math <span class="color_h1">floor()</span> Method</h1>
...
<pre class="w3-white language-java"><code>System.out.println(Math.floor(0.60));
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_math_floor">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">floor()</code> method rounds a number DOWN to 
the nearest integer.</p>
<p><strong>Tip:</strong> To round a number UP to the nearest integer, look at the <a href="/java/ref_math_ceil.asp">ceil()</a> method.</p>
<p><strong>Tip:</strong> To round a number to the nearest integer in either direction, look at the <a href="/java/ref_math_round.asp">round()</a> method.</p>
<div class="ws-note w3-panel">
<p><strong>Note:</strong> For positive numbers the <code class="w3-codespan">floor()</code> method just removes the decimal part, but for negative numbers the integer part of the number will be changed if the number has a decimal part. If you only want to remove the decimal part, you can <a href="/java/java_type_casting.asp">type cast</a> the number as an integer.</p>
</div>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public static double floor(double <em>number</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>number</em></td>
    <td>Required. A number to round down.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">A <code class="w3-codespan">double</code> value representing the nearest integer less or equal to a number.</td>
</tr>
<tr>
