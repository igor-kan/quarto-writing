...
<html lang="en-US">
<head>
<title>Java String matches() Method</title>
<meta charset="utf-8">
...
<h1>Java String <span class="color_h1">matches()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Check whether a string matches the regular expression:</p>
<pre class="language-java w3-white"><code>String regex = &quot;cat|dog|fish&quot;;

System.out.println(&quot;cat&quot;.matches(regex));
System.out.println(&quot;dog&quot;.matches(regex));
System.out.println(&quot;catfish&quot;.matches(regex));
System.out.println(&quot;doggy bag&quot;.matches(regex));</code></pre>
<p>
  <a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_string_matches">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>The <code class="w3-codespan">matches()</code> method searches a string for a match against a regular expression, and returns the matches.</p>

<hr>

<h2>Syntax</h2>

<pre class="language-java"><code>public String matches(String <em>regex</em>)</code></pre>
...
<tr>
 <th style="width:21%">Returns:</th>
  <td>A <code class="w3-codespan">boolean</code> value:<br><br> <code class="w3-codespan">true</code> if the regular expression exactly matches the string <br><code class="w3-codespan">false</code> 
  if it does not match the string.</td>
</tr>
</table>
<br>
