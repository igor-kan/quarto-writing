...
<html lang="en-US">
<head>
<title>Java Data Types Challenge</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1">Data Types Code Challenge</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_var.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_type_casting.asp">Next &#10095;</a>
</div>
<hr>

<h3>Challenge: Create a Student Report Card</h3>
<p>Test your understanding of <strong>Java Data Types</strong> by completing a small coding challenge.</p>

<div class="ch-wrap" id="javaChallenges"></div>

<script>
  window.CHALLENGE_DATA_URL = "java_challenge_data_types.js";
  window.CHALLENGE_HOST_ID = "javaChallenges";
  window.CHALLENGE_PRISM_LANGUAGE = "java";
</script>
<script src="java_challenge_checks.js"></script>
<script src="/lib/challenge-engine/main.v1.0.7.js"></script>
<!-- Java Challenge Runner (self-contained) -->
<style>
...
(function(){
  ...
  var hostId = window.CHALLENGE_HOST_ID || "javaChallenges";
  var DATA_URL = window.CHALLENGE_DATA_URL || "";
  var PRISM_LANG = window.CHALLENGE_PRISM_LANGUAGE || "java";
  var ACTION_URL = "https://try.w3schools.com/try_java.php";
  var hooked = false;
