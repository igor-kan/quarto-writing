...
<h1>Java <span class="color_h1">Do/While Loop</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_while_loop.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_while_loop_reallife.asp">Next &#10095;</a>
</div>
<hr>
...
execute the code block <strong>once</strong>, before checking if the condition is 
<strong>true</strong>. 
Then it will
repeat the loop as long as the condition is <strong>true</strong>.</p>
...
executed at least once, even if the condition is <strong>false</strong>, because the code block 
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_do_while_loop">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>In the <code class="w3-codespan">while</code> loop chapter, we saw that if the condition is 
<b>false</b> at the beginning, the loop never runs at all.</p>

<p>The <code class="w3-codespan">do/while</code> loop is different: it will always run the code block 
<strong>at least once</strong>, even if the condition is <strong>false</strong> from the start.</p>

<p>In the example below, the variable <code class="w3-codespan">i</code> starts at 10, so 
<code class="w3-codespan">i &lt; 5</code> is false immediately. Still, the loop runs once before checking the condition:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>int i = 10;
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_do_while_false">Try it Yourself &raquo;</a>
</p>
</div>

<div class="ws-note ws-panel">
<p><strong>Summary:</strong> A <code class="w3-codespan">do/while</code> loop always runs at least once, 
even if the condition is false at the start.  
This is the key difference from a <code class="w3-codespan">while</code> loop, which would skip the code block completely in the same situation.</p>

<p>This behavior makes <code class="w3-codespan">do/while</code> useful when you want something to happen at least once, 
such as showing a message or asking the user for input.</p>
</div>
...
<hr>
<div id="exercisecontainer" src="xrcise_while_loop_do.js"></div>
<hr>
