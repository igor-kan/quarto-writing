...
<html lang="en-US">
<head>
<title>Java String copyValueOf() Method</title>
<meta charset="utf-8">
...
<h1>Java String <span class="color_h1">copyValueOf()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Return a String that represents certain characters of a char array:</p>
<pre class="language-java w3-white"><code>char[] myStr1 = {'H', 'e', 'l', 'l', 'o'};
String myStr2 = &quot;&quot;;
myStr2 = myStr2.copyValueOf(myStr1, 0, 5);
System.out.println(&quot;Returned String: &quot; + myStr2);</code></pre>
<p>
  <a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_string_copyvalueof">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>The <code class="w3-codespan">copyValueOf()</code> method returns a <code class="w3-codespan">String</code> that represents the characters of 
a char array.</p>
<p>This method returns a new <code class="w3-codespan">String</code> array and copies the characters into it.</p>

<hr>

<h2>Syntax</h2>

<pre class="language-java"><code>public static String copyValueOf(char[] <em>data</em>, int <em>offset</em>, int <em> count</em>)
</code></pre>
...
<table class="ws-table-all notranslate"> 
  <tbody><tr>
    ...
    <tr>
    <td><em>data</em></td>
    <td>A <code class="w3-codespan">char</code> array</td>
    </tr>
    <tr>
    <td><em>offset</em></td>
    <td>An <code class="w3-codespan">int</code> value, representing the start 
    index of the char array</td>
    </tr>
    <tr>
    <td><em>count</em></td>
    <td>An <code class="w3-codespan">int</code> value, representing the length 
    of the char array</td>
    </tr>
</tbody>
</table>
...
<tr>
 <th style="width:21%">Returns:</th>
  <td>A <code class="w3-codespan">String</code>, representing the characters of the 
  char array</td>
</tr>
<tr>
 <th style="width:21%">Throws:</th>
  <td><code class="w3-codespan">StringIndexOutOfBoundsException</code> - if offset is 
