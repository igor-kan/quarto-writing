...
<html lang="en-US">
<head>
<title>Java String endsWith() Method</title>
<meta charset="utf-8">
...
<h1>Java String <span class="color_h1">endsWith()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Find out if the string ends with the specified characters:</p>
...
System.out.println(myStr.endsWith(&quot;o&quot;));&nbsp;&nbsp;&nbsp;&nbsp; // true</code></pre>
<p>
  <a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_string_endswith">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>The <code class="w3-codespan">endsWith()</code> method checks whether a 
string ends with the specified character(s).</p>
<p><strong>Tip:</strong> Use the <a href="ref_string_startswith.asp">startsWith()</a> method to check whether a string 
<strong>starts</strong> with the specified character(s).</p>
<hr>

<h2>Syntax</h2>

<pre class="language-java"><code>public boolean endsWith(String <em>chars</em>)
</code></pre>
...
<tr>
 <th style="width:21%">Returns:</th>
  ...
  <ul>
  <li><code class="w3-codespan">true</code> - if the string ends with the specified character(s)</li>
  <li><code class="w3-codespan">false</code> - if the string does not end with the specified character(s)</li>
 </ul>
</tr>
</table>
<br>
