...
<html lang="en-US">
<head>
<title>Java LinkedList get() Method</title>
<meta charset="utf-8">
...
<h1>Java LinkedList <span class="color_h1">get()</span> Method</h1>
...
<h3>Example</h3>
<p>Output the value of an item in a list:</p>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_linkedlist_get">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">get()</code> method returns the item at a specified position in the list.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public T get(int <em>index</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>index</em></td>
    <td>Required. Specifies the position of the item in the list.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">The item at the specified position.</td>
</tr>
<tr>
