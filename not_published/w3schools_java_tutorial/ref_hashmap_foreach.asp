...
<html lang="en-US">
<head>
<title>Java HashMap forEach() Method</title>
<meta charset="utf-8">
...
<h1>Java HashMap <span class="color_h1">forEach()</span> Method</h1>
...
<h3>Example</h3>
<p>Use the <code class="w3-codespan">forEach()</code> method to print every entry in the map:</p>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_hashmap_foreach">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">forEach()</code> method performs an action on every entry in the map. The action can be defined by a lambda expression that is compatible with the <code class="w3-codespan">accept()</code> method of Java's <code class="w3-codespan">BiConsumer</code> interface.</p>
<p>To learn about lambda expressions, see our <a href="java_lambda.asp">Java Lambda Expression tutorial</a>.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public void forEach(BiConsumer <em>action</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>action</em></td>
    <td>
      Required. A <code class="w3-codespan">BiConsumer</code> object or lambda expression which performs an action on an entry.<br>
