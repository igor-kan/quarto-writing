...
<html lang="en-US">
<head>
<title>Java Arrays equals() Method</title>
<meta charset="utf-8">
...
<h1>Java Arrays.<span class="color_h1">equals()</span> Method</h1>
...
<h3>Example</h3>
<p>Find out if two arrays are equal:</p>
<pre class="language-java w3-white"><code>String[] cars = {&quot;Volvo&quot;, &quot;BMW&quot;, &quot;Tesla&quot;};
String[] cars2 = {&quot;Volvo&quot;, &quot;BMW&quot;, &quot;Tesla&quot;};

System.out.println(Arrays.equals(cars, cars2)); </code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_arrays_equals">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>The <code class="w3-codespan">equals()</code> method checks whether two 
arrays are equal.</p>
<p><strong>Note:</strong> Two arrays are consided equal if they share the same 
...
<tr>
 <th style="width:21%">Returns:</th>
  <td>Returns <code class="w3-codespan">true</code> if the arrays are equal.<br><br>
  Returns <code class="w3-codespan">false</code> if the arrays are not equal.</td>
</tr>
</table>
