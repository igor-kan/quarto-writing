...
<html lang="en-US">
<head>
<title>Java How To Add Two Numbers</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1">How To Add Two Numbers</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_howtos.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_howto_swap_two_variables.asp">Next &#10095;</a>
</div>
<hr>

<h2>Add Two Numbers</h2>
<p>Learn how to add two numbers in Java:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>int x = 5;
int y = 6;
int sum = x + y;
System.out.println(sum); // Print the sum of x + y</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryjava.asp?filename=demo_howto_add_two_numbers">Try it Yourself &raquo;</a>
</div>

<p><b>Explanation:</b> We create two integer variables (<code class="w3-codespan">x</code> and <code class="w3-codespan">y</code>) and assign them values. The expression <code class="w3-codespan">x + y</code> is stored in the variable <code class="w3-codespan">sum</code>. Finally, we print the result with <code class="w3-codespan">System.out.println()</code>.</p>

<hr>

<h2>Add Two Numbers with User Input</h2>
<p>Learn how to add two numbers with user input:</p>
<div class="w3-example">
<h3>Example</h3>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_howto_add_two_numbers_scanner">Run Example &raquo;</a>
</div>

<p><b>Explanation:</b> Here we use the <code class="w3-codespan">Scanner</code> class to read two numbers from the keyboard. The method <code class="w3-codespan">nextInt()</code> reads an integer from the user. We then add the two numbers together and print the result.</p>
