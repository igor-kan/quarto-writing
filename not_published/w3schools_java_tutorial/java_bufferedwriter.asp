...
<html lang="en-US">
<head>
<title>Java BufferedWriter</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1">BufferedWriter</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_bufferedreader.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_data_structures.asp">Next &#10095;</a>
</div>
<hr>

<h2>BufferedWriter</h2>

<p>The <code class="w3-codespan">BufferedWriter</code> class is used to write text to a file, one line or one string at a time.  
If the file already exists, its contents will be replaced (overwritten).</p>
<hr>

<h2>Write to a Text File</h2>
<p>Use <code class="w3-codespan">BufferedWriter</code> with <code class="w3-codespan">FileWriter</code> to write text to a file.  
The <code class="w3-codespan">write()</code> method adds text, and you can use <code class="w3-codespan">newLine()</code> to insert a line break:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white" data-line="7"><code>import java.io.BufferedWriter;
...
<code>
Successfully wrote to the file.</code>
</div>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_bufferedwriter">Try it Yourself &raquo;</a></p>
</div>
<p><strong>Explanation:</strong> This program creates (or overwrites) <code class="w3-codespan">filename.txt</code>  
and writes two lines of text into it. The <code class="w3-codespan">newLine()</code> method inserts a line break between  
<code class="w3-codespan">"First line"</code> and <code class="w3-codespan">"Second line"</code>.  
If everything goes well, the console will print <code class="w3-codespan">"Successfully wrote to the file."</code></p>
<hr>

<h2>Append to a Text File</h2>
<p>To add new content to the end of a file (instead of overwriting), pass <code class="w3-codespan">true</code> to <code class="w3-codespan">FileWriter</code>:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white" data-line="8,10"><code>import java.io.BufferedWriter;
import java.io.FileWriter;
import java.io.IOException;
...
<div class="notranslate w3-black w3-padding">
<code>
Successfully appended to the file.</code>
</div>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_bufferedwriter_append">Try it Yourself &raquo;</a></p>
</div>

<p><strong>Explanation:</strong> This program keeps the existing content of <code class="w3-codespan">filename.txt</code>  
and adds a new line with the text <code class="w3-codespan">"Appended line"</code> at the end.  
If everything works, the console prints <code class="w3-codespan">"Successfully appended to the file."</code></p>
...
<h2>Comparing File Writing Classes</h2>
<p>Java gives you several ways to write to files. Here's when to pick each one:</p>

<ul>
  <li><a href="java_files_write.asp"><code class="w3-codespan">FileWriter</code></a> - best for <strong>simple text writing</strong>. Quick and easy to use.</li>
  <li><code class="w3-codespan">BufferedWriter</code> - better for <strong>larger text files</strong>, because it is faster and lets you easily add line breaks with <code class="w3-codespan">newLine()</code>.</li>
  <li><a href="java_fileoutputstream.asp"><code class="w3-codespan">FileOutputStream</code></a> - best for <strong>binary files</strong> (like images, PDFs, or audio)</li>
</ul>
<hr>
