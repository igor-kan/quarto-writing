...
<html lang="en-US">
<head>
<title>Java HashMap get() Method</title>
<meta charset="utf-8">
...
<h1>Java HashMap <span class="color_h1">get()</span> Method</h1>
...
<h3>Example</h3>
<p>Get the value of an entry in a map:</p>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_hashmap_get">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">get()</code> method returns the value of the entry in the map which has a specified key.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public V get(Object <em>key</em>)</code></pre>
...
<tr>
 ...
 <td style="width:80%">The value of the entry with the specified key or <em>null</em> if an entry with that key does not exist.</td>
</tr>
</table>
