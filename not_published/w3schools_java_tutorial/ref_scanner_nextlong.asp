...
<html lang="en-US">
<head>
<title>Java Scanner nextLong() Method</title>
<meta charset="utf-8">
...
<h1>Java Scanner <span class="color_h1">nextLong()</span> Method</h1>
...
<h3>Example</h3>
<p>Print the value of every long integer in the string:</p>
...
<p>The <code class="w3-codespan">nextLong()</code> method returns the <code class="w3-codespan">long</code> value of the number that the next token represents. The token must represent a whole number between -9,223,372,036,854,775,808 and 9,223,372,036,854,775,807.</p>
<p>The scanner is able to interpret digit groupings, such as using a comma for separating groups of 3 digits. The format of the groupings depends on the locale settings of the scanner, which can be changed with the <code class="w3-codespan"><a href="ref_scanner_uselocale.asp">useLocale()</a></code> method.</p>
<p>If the <em>radix</em> parameter is used, then it interprets numbers using the radix. For example, a radix of 16 would interpret numbers as hexadecimal (digits 0 to 9 and A to F). If the <em>radix</em> parameter is not used then it interprets numbers using the scanner's radix which is 10 by default, but it can be changed with the <code class="w3-codespan"><a href="ref_scanner_useradix.asp">useRadix()</a></code> method.</p>
<div class="w3-panel ws-note">
<p><strong>What is a token?</strong> </p>
  <p>A token is a sequence of characters separated from other tokens by delimiters. The default delimiter is a block of whitespace characters but it can be changed with the <code class="w3-codespan"><a href="ref_scanner_usedelimiter.asp">useDelimiter()</a></code> method.</p>
</div>
<hr>

<h2>Syntax</h2>
<p>One of the following:</p>
<pre class="language-java"><code>public long nextLong()</code></pre>
<pre class="language-java"><code>public long nextLong(int <em>radix</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>radix</em></td>
    <td>Optional. Specifies the radix used to interpret numbers. The radix specifies how many different symbols can be used to represent a digit in a number.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">The <code class="w3-codespan">long</code> value of the number that the next token represents.</td>
</tr>
<tr>
 <th style="width:20%">Throws:</th>
 <td style="width:80%">
  <code class="w3-codespan">InputMismatchException</code> - If the token does not represent a <code class="w3-codespan">long</code> type value.<br>
  <code class="w3-codespan">NoSuchElementException</code> - If there are no more tokens in the scanner.<br>
  <code class="w3-codespan">IllegalStateException</code> - If the scanner has been closed.
 </td>
</tr>
</table>
<hr>
