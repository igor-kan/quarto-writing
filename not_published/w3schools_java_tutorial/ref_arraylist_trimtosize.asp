...
<html lang="en-US">
<head>
<title>Java ArrayList trimToSize() Method</title>
<meta charset="utf-8">
...
<h1>Java ArrayList <span class="color_h1">trimToSize()</span> Method</h1>
...
<h3>Example</h3>
<p>Reduce the capacity of a list to exactly the size of the list:</p>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_arraylist_trimtosize">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">trimToSize()</code> method reduces the capacity of a list to fit exactly the number of items that the list contains.</p>
<p>This method does not have a visible effect but it can can be used to reduce the memory usage of the list.</p>
<p>When an <code class="w3-codespan">ArrayList</code> is created, capacity for 10 items is reserved unless another number is specified in the constructor. Even if the list does not have 10 items, this space is still reserved. Removing items from a list may leave the space for those items reserved. When you are not using of the capacity of an <code class="w3-codespan">ArrayList</code> then there is some wasted memory which can accumulate if your program makes use of many <code class="w3-codespan">ArrayList</code>s. You can use the <code class="w3-codespan">trimToSize()</code> method to recover the unused memory.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public void trimToSize()</code></pre><hr>
