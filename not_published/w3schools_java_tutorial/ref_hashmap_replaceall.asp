...
<html lang="en-US">
<head>
<title>Java HashMap replaceAll() Method</title>
<meta charset="utf-8">
...
<h1>Java HashMap <span class="color_h1">replaceAll()</span> Method</h1>
...
<h3>Example</h3>
<p>Update the value of every entry in a map:</p>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_hashmap_replaceall">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">replaceAll()</code> method replaces the value of every entry in the map with the result of an operation using the entry's key and value. The operation can be defined by a lambda expression that is compatible with the <code class="w3-codespan">apply()</code> method of Java's <code class="w3-codespan">BiFunction</code> interface.</p>
<p>To learn about lambda expressions, see our <a href="java_lambda.asp">Java Lambda Expression tutorial</a>.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public void replaceAll(BiFunction <em>operator</em>)</code></pre>
