...
<html lang="en-US">
<head>
<title>Java Multi-Dimensional Arrays</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1">Multi-Dimensional Arrays</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_arrays_reallife.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_challenges_arrays.asp">Next &#10095;</a>
</div>
<hr>

<h2>Multidimensional Arrays</h2>
<p>A multidimensional array is an array that contains other arrays.</p>
<p>You can use it to store data in a table with rows and columns.</p>
<p>To create a two-dimensional array, write each row inside its own <strong>curly braces</strong>:</p>

<div class="w3-example">
<pre class="language-java w3-white"><code>int[][] myNumbers = { {1, 4, 2}, {3, 6, 8} };
</code></pre>
</div>

<p>Here, <strong>myNumbers</strong> has two arrays (two rows):</p>
<ul>
  <li>First row: <code class="w3-codespan">{1, 4, 2}</code></li>
  <li>Second row: <code class="w3-codespan">{3, 6, 8}</code></li>
</ul>

<p>Think of it like this:</p>
<div class="ws-light-green w3-round" style="padding:30px 10px">
  <img src="/c/col-row.png" style="max-width:100%;margin:auto;display:block;">
</div>
<hr>

<h2>Access Elements</h2>
<p>To access an element of a two-dimensional array, you need two indexes: the first for the row, and the second for the column.</p>
<p><strong>Remember:</strong> Array indexes start at 0. That means row <code class="w3-codespan">0</code> is the first row, and column <code class="w3-codespan">0</code> is the first column. (So row index <code>1</code> is the <em>second</em> row, and column index <code>2</code> is the <em>third</em> column.)</p>

<p>This statement accesses the element in the <strong>second row</strong> (index <code class="w3-codespan">1</code>) and <strong>third column</strong> (index <code class="w3-codespan">2</code>) of the <strong>myNumbers</strong> array:</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_array_multi">Try it Yourself &raquo;</a>
</p>
</div>

<p>This example prints the value at row <code class="w3-codespan">0</code>, column <code class="w3-codespan">1</code>:</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_array_multi2">Try it Yourself &raquo;</a>
</p>
</div>
...
<h2>Change Element Values</h2>
<p>You can overwrite an existing element using the same two-index notation (row, then column):</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_array_multi_change">Try it Yourself &raquo;</a>
</p>
</div>

<hr>

<h2>Rows and Columns (Lengths)</h2>
<p>You can use <code class="w3-codespan">length</code> to get the number of rows, and <code class="w3-codespan">
<em>myNumbers[row]</em>.length</code> for the number of columns in a given row:</p>

<div class="w3-example">
<h3>Example: Sizes</h3>
<pre class="language-java w3-white"><code>int[][] myNumbers = { {1, 4, 2}, {3, 6, 8, 5, 2} };

System.out.println("Rows: " + myNumbers.length);             // 2
System.out.println("Cols in row 0: " + myNumbers[0].length); // 3
System.out.println("Cols in row 1: " + myNumbers[1].length); // 5</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_array_multi_lengths">Try it Yourself &raquo;</a>
</p>
</div>
<p><strong>Note:</strong> Notice how rows can have different lengths - In this example, the second row has more elements than the first, and that's perfectly valid in Java.</p>
<hr>

<h2>Loop Through a Multidimensional Array</h2>
<p>Use a <code class="w3-codespan">for</code> loop inside another <code class="w3-codespan">for</code> loop to visit every element (row by row):</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_array_multi_for">Try it Yourself &raquo;</a>
</p>
</div>

<p>Or use a <strong>for-each</strong> loop in both levels, which many find easier to read:</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_array_multi_foreach">Try it Yourself &raquo;</a>
</p>
</div>
