...
<html lang="en-US">
<head>
<title>Java HashMap clone() Method</title>
<meta charset="utf-8">
...
<h1>Java HashMap <span class="color_h1">clone()</span> Method</h1>
...
<h3>Example</h3>
<p>Create a copy of a map and change it:</p>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_hashmap_clone">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">clone()</code> method returns a copy of the map as an <code class="w3-codespan">Object</code>.</p>
<p>This creates a "shallow" copy, which means that copies of objects in the map are not created, instead the map has references to the same objects that are in the original map.</p>
<p><strong>Note:</strong> Since the return type is <code class="w3-codespan">Object</code>, it must be <a href="java_type_casting.asp">type casted</a> in order to use it as a <code class="w3-codespan">HashMap</code> as shown in the example above.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public Object clone()</code></pre>

<h2>Technical Details</h2>
<table class="ws-table-all">
<tr>
 <th style="width:20%">Returns:</th>
 <td style="width:80%">A copy of the <code class="w3-codespan">HashMap</code> object.</td>
</tr>
</table>
<hr>
