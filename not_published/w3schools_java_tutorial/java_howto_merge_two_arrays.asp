...
<html lang="en-US">
<head>
<title>Java How To Merge Two Arrays</title>
<meta charset="utf-8">
...
<h1>Java How To - <span class="color_h1">Merge Two Arrays</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_howto_min_max_array.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_howto_remove_duplicates_array.asp">Next &#10095;</a>
</div>
<hr>

<h2>How To Merge Two Arrays</h2>
<p>Combine two <code class="w3-codespan">int</code> arrays into a single array:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>int[] a = {1, 2, 3};
int[] b = {4, 5};
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_howto_merge_two_arrays">Try it Yourself &raquo;</a></p>
</div>
<hr>
