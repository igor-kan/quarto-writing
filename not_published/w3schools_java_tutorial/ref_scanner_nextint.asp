...
<html lang="en-US">
<head>
<title>Java Scanner nextInt() Method</title>
<meta charset="utf-8">
...
<h1>Java Scanner <span class="color_h1">nextInt()</span> Method</h1>
...
<h3>Example</h3>
<p>Print the value of every integer in the string:</p>
...
<p>The <code class="w3-codespan">nextInt()</code> method returns the <code class="w3-codespan">int</code> value of the number that the next token represents. The token must represent a whole number between -2,147,483,648 and 2,147,483,647.</p>
...
<pre class="language-java"><code>public int nextInt()</code></pre>
<pre class="language-java"><code>public int nextInt(int <em>radix</em>)</code></pre>
...
<tr>
 ...
 <td style="width:80%">The <code class="w3-codespan">int</code> value of the number that the next token represents.</td>
</tr>
<tr>
 <th style="width:20%">Throws:</th>
 <td style="width:80%">
  <code class="w3-codespan">InputMismatchException</code> - If the token does not represent an <code class="w3-codespan">int</code> type value.<br>
