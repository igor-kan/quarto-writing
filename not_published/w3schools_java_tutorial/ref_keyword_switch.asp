...
<html lang="en-US">
<head>
<title>Java switch Keyword</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1"> switch</span> Keyword</h1>
<p>
...
<h3>Example</h3>
<p>Use the switch  statement to calculate the weekday name:</p>
...
<p>The <code class="w3-codespan">switch</code> keyword selects one of many code blocks to be executed.</p>
<p>From the example above, it works like this:</p>
<ul>
...
<li>The <code class="w3-codespan">break</code> keyword is used to break out of the switch block when a match is found</li>
</ul>
<hr>
