...
<html lang="en-US">
<head>
<title>Java Math nextDown() Method</title>
<meta charset="utf-8">
...
<h1>Java Math <span class="color_h1">nextDown()</span> Method</h1>
...
<h3>Example</h3>
<p>Find the next floating point number below different numbers:</p>
<pre class="w3-white language-java"><code>System.out.println(Math.nextDown(1.0f));
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_math_nextdown">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">nextDown()</code> method returns the floating point number adjacent to a number in the negative direction, which is the highest possible floating point number that is less than the starting number.<p>
<p>The return value for <code class="w3-codespan">double</code> type arguments will be closer to the starting number than the return value for <code class="w3-codespan">float</code> type arguments.</p>
<hr>

<h2>Syntax</h2>
<p>One of the following:</p>
<pre class="language-java"><code>public static double nextDown(double <em>start</em>)</code></pre>
<pre class="language-java"><code>public static float nextDown(float <em>start</em>)</code></pre>
...
<tr>
 ...
 <td style="width:80%">A <code class="w3-codespan">double</code> or <code class="w3-codespan">float</code> value representing the floating point number adjacent to a starting number in the negative direction.</td>
</tr>
<tr>
