...
<html lang="en-US">
<head>
<title>Java Math addExact() Method</title>
<meta charset="utf-8">
...
<h1>Java Math <span class="color_h1">addExact()</span> Method</h1>
...
<h3>Example</h3>
<p>Add integers:</p>
<pre class="w3-white language-java"><code>System.out.println(Math.addExact(12, 16));
System.out.println(Math.addExact(10000, 24060));
</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryjava.asp?filename=demo_ref_math_addexact">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">addExact()</code> method adds two integers and throws an exception if the addition causes an overflow. This prevents incorrect results that can occur from adding really large numbers.</p>
<hr>

<h2>Syntax</h2>
<p>One of the following:</p>
<pre class="language-java"><code>public static int addExact(int <em>x</em>, int <em>y</em>)</code></pre>
<pre class="language-java"><code>public static long addExact(long <em>x</em>, long <em>y</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>x</em></td>
    <td>Required. The first number to be added.</td>
  </tr>
  <tr>
    <td><em>y</em></td>
    <td>Required. The second number to be added.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">An <code class="w3-codespan">int</code> or <code class="w3-codespan">long</code> value representing the sum of two numbers.</td>
</tr>
<tr>
 <th style="width:20%">Throws:</th>
 <td style="width:80%"> <code class="w3-codespan">ArithmeticException</code> - If the sum causes an overflow.</td>
</tr>
<tr>
