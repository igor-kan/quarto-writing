...
<a class="w3-left w3-btn" href="java_challenges_conditions.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_challenges_switch.asp">Next &#10095;</a>
</div>
<hr>
...
<p>Think of it like ordering food in a restaurant: <em>If you choose number 1, you get Pizza. If you choose 2, you get a Burger. If you choose 3, you get Pasta. Otherwise, you get nothing</em>.</p>
...
<li>The result is compared with each <code class="w3-codespan">case</code> value.</li>
<li>If there is a match, the matching block of code runs.</li>
<li>The <code class="w3-codespan">break</code> statement stops the switch after the matching case has run.</li>
<li>The <code class="w3-codespan">default</code> statement runs if there is no match.</li>
</ul>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_switch">Try it Yourself &raquo;</a>
</p>
</div>
<hr>
