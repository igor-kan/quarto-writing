...
<a class="w3-left w3-btn" href="java_challenges_switch.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_while_loop_do.asp">Next &#10095;</a>
</div>
<hr>
<h2>Loops</h2>
...
<p>The <code class="w3-codespan">while</code> loop repeats a block of code as long as the specified condition is <b>true</b>:</p>

<div class="w3-example">
<h3>Syntax</h3>
<pre class="language-java w3-white"><code>while (condition) {
  // code block to be executed
}
</code></pre>
</div>

<p>In the example below, the code in the loop will run again and again, as long as 
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_while_loop">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>Do you wonder why we used the letter <code class="w3-codespan">i</code> in 
the example above? It's a <strong>counter</strong> variable and a common choice in simple loops because it's short, traditional, and stands for 'index' or 'iterator'.</p>
</div>
<hr>
...
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>int countdown = 3;
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_while_loop_countdown">Try it Yourself &raquo;</a>
</p>
</div>
...
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white w3-border-red"><code>int i = 10;
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_while_false">Try it Yourself &raquo;</a>
</p>
</div>
...
In the next chapter, you will learn about the <a href="java_while_loop_do.asp"><code class="w3-codespan">do while</code></a> loop, which always runs the code at least once before checking the condition.</p>
</div>
