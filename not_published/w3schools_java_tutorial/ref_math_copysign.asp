...
<html lang="en-US">
<head>
<title>Java Math copySign() Method</title>
<meta charset="utf-8">
...
<h1>Java Math <span class="color_h1">copySign()</span> Method</h1>
...
<h3>Example</h3>
<p>Return the value of a number with the sign of another:</p>
<pre class="w3-white language-java"><code>System.out.println(Math.copySign(-4.7, 3));
System.out.println(Math.copySign(4.7, -2.5));
System.out.println(Math.copySign(3, 4)); 
System.out.println(Math.copySign(-2.5, -4.7)); 
</code></pre>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_math_copysign">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The <code class="w3-codespan">copySign()</code> method returns the value of the first number with the sign of the second number.</p>
<hr>

<h2>Syntax</h2>
<p>One of the following:</p>
<pre class="language-java"><code>public static double copySign(double <em>value</em>, double <em>sign</em>)</code></pre>
<pre class="language-java"><code>public static float copySign(float <em>value</em>, float <em>sign</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>value</em></td>
    <td>Required. A number which determines the value.</td>
  </tr>
  <tr>
    <td><em>sign</em></td>
    <td>Required. A number which determines the sign.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">A <code class="w3-codespan">double</code> or <code class="w3-codespan">float</code> with the value of the first number and the sign of the second number.</td>
</tr>
<tr>
