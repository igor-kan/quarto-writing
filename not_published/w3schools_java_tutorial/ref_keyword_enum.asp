...
<h1>Java <span class="color_h1"> enum</span> Keyword</h1>
<p>
...
<h3>Example</h3>
<p>Create an <code class="w3-codespan">enum</code> with <strong>constants</strong> (unchangeable variables):</p>
...
<p>The <code class="w3-codespan">enum</code> keyword declares an enumerated (unchangeable) type.</p>
<p>An enum is a special "class" that represents a group of constants (unchangeable variables, like final variables).</p>
<p>To create an enum, use the <code class="w3-codespan">enum</code> keyword (instead of class or interface), and separate the constants with a comma. Note that they should be in uppercase letters.</p>
...
<p>An <code class="w3-codespan">enum</code> cannot be used to create objects, and it can not extend other classes (but it can implement interfaces).</p>

<p>Use enums when you have values that you know aren't going to change, like month days, days, colors, deck of cards, etc.</p>
</div><hr>

<h2>Related Pages</h2>
<p>Read more about enums in our <a href="java_enums.asp">Java Enum Tutorial</a>.</p>
