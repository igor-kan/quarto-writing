...
<html lang="en-US">
<head>
<title>Java How To Reverse a Number</title>
<meta charset="utf-8">
...
<h1>Java How To <span class="color_h1">Reverse a Number</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_howto_even_or_odd.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_howto_pos_or_neg.asp">Next &#10095;</a>
</div>
<hr>

<h2>Reverse a Number</h2>
<p>Take an integer and print it in reverse order:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>int num = 1234;
int reversed = 0;
...
System.out.println(&quot;Reversed: &quot; + reversed);</code></pre>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_howto_reverse_number">Try it Yourself &raquo;</a></p>
</div>
<p><b>Explanation:</b> 
We start with the number <code class="w3-codespan">1234</code>.  
Inside the loop:  
<br>- <code class="w3-codespan">num % 10</code> gives us the last digit (4, then 3, then 2, then 1).  
<br>- We add this digit to <code class="w3-codespan">reversed</code>, making the new number grow step by step.  
<br>- <code class="w3-codespan">num /= 10</code> removes the last digit from the original number.  
<br>When the loop finishes, <code class="w3-codespan">reversed</code> contains <code class="w3-codespan">4321</code>.</p>
<hr>
