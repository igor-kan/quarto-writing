...
<h1>Java <span class="color_h1"> do</span> Keyword</h1>
<p>
...
<h3>Example</h3>
<p>The following loop will always be executed at least once, even if the condition is false, because the code block is executed before the condition is tested:</p>
...
<p>The <code class="w3-codespan">do</code> keyword is used together with <code class="w3-codespan"><a href="ref_keyword_while.asp">while</a></code> to create a do-while loop.</p>
...
<h2>Related Pages</h2>
<p>Read more about while loops in our <a href="java_while_loop.asp">Java While Loop Tutorial</a>.</p>
