...
<html lang="en-US">
<head>
<title>Java String join() Method</title>
<meta charset="utf-8">
...
<h1>Java String <span class="color_h1">join()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Join strings with a space between them:</p>
<pre class="language-java w3-white"><code>String fruits = String.join(&quot; &quot;, &quot;Orange&quot;, &quot;Apple&quot;, &quot;Mango&quot;);
System.out.println(fruits);</code></pre>
<p>
  <a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_string_join">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>The <code class="w3-codespan">join()</code> method joins one or more strings 
with a specified separator.</p>
...
<pre class="language-java"><code>public String join(CharSequence <em>separator</em>, CharSequence... <em>elements</em>)</code></pre>
<pre class="language-java"><code>public String join(CharSequence <em>separator</em>, Iterable <em>elements</em>)</code></pre>
...
<table class="ws-table-all notranslate"> 
  <tbody><tr>
    ...
    <td>Required. The separator 
    used to join the elements</td>
    </tr>
    <tr>
    <td><em>elements</em></td>
    <td>Required. Elements to be joined</td>
    </tr>
</tbody>
</table>
...
<tr>
 <th style="width:21%">Returns:</th>
  <td>A new <code class="w3-codespan">String</code>, separated by the specified 
  separator</td>
</tr>
<tr>
