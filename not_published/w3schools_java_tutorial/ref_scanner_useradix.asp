...
<html lang="en-US">
<head>
<title>Java Scanner useRadix() Method</title>
<meta charset="utf-8">
...
<h1>Java Scanner <span class="color_h1">useRadix()</span> Method</h1>
...
<p>The <code class="w3-codespan">useRadix()</code> method changes the radix used by the scanner. The radix specifies how many different symbols can be used to represent each digit in a number. For example, a radix of 16 would allow the symbols 0 to 9 and A to F to be used as digits.</p>

<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public Scanner useRadix(int <em>radix</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>radix</em></td>
    <td>Required. An <code class="w3-codespan">int</code> value specifying the radix that the scanner will use to interpret whole numbers.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">A reference to the <code class="w3-codespan">Scanner</code> object that this method belongs to, which allows for chaining configuration methods. An example of chaining is <code class="language-java">myObj.useRadix(16).useDelimiter(",");</code>.</td>
</tr>
</table>
