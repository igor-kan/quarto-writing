...
<html lang="en-US">
<head>
<title>Java Math IEEEremainder() Method</title>
<meta charset="utf-8">
...
<h1>Java Math <span class="color_h1">IEEEremainder()</span> Method</h1>
...
<h3>Example</h3>
<p>Calculate the IEEE 754 remainder of different pairs of numbers:</p>
<pre class="w3-white language-java"><code>System.out.println(Math.IEEEremainder(11, 3));
System.out.println(Math.IEEEremainder(16, 4));
System.out.println(Math.IEEEremainder(31, 2.5));
</code></pre>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_math_ieeeremainder">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">IEEEremainder()</code> method computes the remainder operation on two numbers as prescribed by the IEEE 754 standard.</p>
<p>The return value of this method for two numbers a and b is equal to <code class="w3-codespan">a - (b * Math.rint(a/b))</code>.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public static double IEEEremainder(double <em>dividend</em>, double <em>divisor</em>)</code></pre>
...
<tr>
 ...
 <td style="width:80%">A <code class="w3-codespan">double</code> value representing the result of the remainder operation between two numbers.</td>
</tr>
<tr>
