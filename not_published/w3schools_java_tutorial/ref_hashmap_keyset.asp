...
<html lang="en-US">
<head>
<title>Java HashMap keySet() Method</title>
<meta charset="utf-8">
...
<h1>Java HashMap <span class="color_h1">keySet()</span> Method</h1>
...
<h3>Example</h3>
<p>Return all the keys in a map:</p>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_hashmap_keyset">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">keySet()</code> method returns a set containing all of the keys in the map.</p>
...
<h2>Syntax</h2>
<pre class="language-java"><code>public Set&lt;K&gt; keySet()</code></pre>
...
<tr>
 ...
 <td style="width:80%">A set containing all of the keys in the map.</td>
</tr>
</table>
<hr>
