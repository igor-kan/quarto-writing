...
<h1>Java <span class="color_h1"> void</span> Keyword</h1>
<p>
...
<h3>Example</h3>
<p>A method without any return values:</p>
<pre class="language-java w3-white"><code>public class Main {
&nbsp; static <strong>void</strong> myMethod() {
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_method">Try it Yourself &raquo;</a>
</p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">void</code> keyword specifies that a method should not have a return value.</p>
<hr>

<h2>More Examples</h2>

<p><strong>Tip:</strong> If you 
want a method to return a value, you can use a primitive data type (such as <code class="w3-codespan">int</code>, 
<code class="w3-codespan">char</code>, etc.) instead of <code class="w3-codespan">void</code>, and use the <code class="w3-codespan"><a href="ref_keyword_return.asp">return</a></code> 
