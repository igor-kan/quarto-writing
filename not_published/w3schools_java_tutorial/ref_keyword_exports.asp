...
<html lang="en-US">
<head>
<title>Java exports Keyword</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1"> exports</span> Keyword</h1>
<p>
...
<h3>Example</h3>
<p>Use <code class="w3-codespan">exports</code> in a module's <em>module-info.java</em> file:</p>
...
<p>The <code class="w3-codespan">exports</code> keyword allows a package from a module to be used by other modules.</p>
<p>If the <code class="w3-codespan">to</code> keyword is added, the exported package is only allowed to be used by the modules that are listed.</p>
<p><strong>Note:</strong> The <code class="w3-codespan">exports</code> keyword is a module directive meant to be used in the <em>module-info.java</em> file of a module.</p>
<p>The <code class="w3-codespan">exports</code> keyword was new in Java 9.</p>
<hr>
