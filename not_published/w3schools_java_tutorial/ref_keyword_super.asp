...
<html lang="en-US">
<head>
<title>Java super Keyword</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1"> super</span> Keyword</h1>
<p>
...
<h3>Example</h3>
<p>Using <code class="w3-codespan">super</code> to call the superclass of <code class="w3-codespan">Dog</code> 
(subclass):</p>
<pre class="language-java w3-white"><code>class Animal { // Superclass (parent)
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_super">Try it Yourself &raquo;</a>
</p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">super</code> keyword refers to superclass 
(parent) objects.</p>
<p>It is used to call superclass methods, and to access the superclass 
constructor.</p>
<p>The most common use of the <code class="w3-codespan">super</code> keyword is to eliminate 
the confusion between superclasses and subclasses that have methods with the 
same name.</p>
<p>To understand the <code class="w3-codespan">super</code> keyword, you should have a basic understanding of <a href="java_inheritance.asp">Inheritance</a> and <a href="java_polymorphism.asp">Polymorphism</a>.</p>
<hr>

<h2>Related Pages</h2>
<p>Read more about inheritance (subclasses and superclasses) in our <a href="java_inheritance.asp">Java Inheritance Tutorial</a>.</p>
<p>Read more about polymorphism in our <a href="java_polymorphism.asp">Java Polymorphism Tutorial</a>.</p>
