...
<html lang="en-US">
<head>
<title>Java LinkedHashSet</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1">LinkedHashSet</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_treeset.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_map.asp">Next &#10095;</a>
</div>
<hr>

<h2>Java LinkedHashSet</h2>

<p>A <code class="w3-codespan">LinkedHashSet</code> is a collection that stores <strong>
unique elements</strong> and <strong>remembers the order they were added</strong>.</p>
...
<div class="ws-note ws-panel">
  <p><strong>Tip:</strong> Use <code class="w3-codespan">LinkedHashSet</code> when you want a set that does not allow duplicates <em>and</em> keeps the original insertion order.</p>
</div>

<hr>

<h2>Create a LinkedHashSet</h2>
<div class="w3-example">
  <h3>Example</h3>
<p>Create a <code class="w3-codespan">LinkedHashSet</code> object called <strong>cars</strong> that will store strings:</p>
  <pre class="language-java w3-white"><code>import java.util.LinkedHashSet; // Import the LinkedHashSet class

LinkedHashSet&lt;String&gt; cars = new LinkedHashSet&lt;&gt;();</code></pre>
</div>
<p>Now you can use methods like <code class="w3-codespan">add()</code>, <code class="w3-codespan">contains()</code>, and <code class="w3-codespan">remove()</code> to manage your collection.</p>

<hr>

<h2>Add Elements</h2>
<p>To add elements to a <code class="w3-codespan">LinkedHashSet</code>, use the <code class="w3-codespan">add()</code> method:</p>

<div class="w3-example">
  <h3>Example</h3>
  <pre class="language-java w3-white"><code>import java.util.LinkedHashSet;
...
public class Main {
  ...
  <p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_linkedhashset_add">Try it Yourself &raquo;</a></p>
</div>

<div class="ws-note ws-panel">
  <p><strong>Output:</strong> The elements will appear in the order they were added (e.g., [Volvo, BMW, Ford, Mazda]).</p>
  <p><strong>Note:</strong> Duplicates like "BMW" are ignored.</p>
</div>
...
<p>Use <code class="w3-codespan">contains()</code> to check for an element:</p>

<div class="w3-example">
  <h3>Example</h3>
  <pre class="language-java w3-white"><code>cars.contains("Mazda");</code></pre>
  <p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_linkedhashset_contains">Try it Yourself &raquo;</a></p>
</div>
...
<div class="w3-example">
  ...
  <p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_linkedhashset_remove">Try it Yourself &raquo;</a></p>
</div>
...
<div class="w3-example">
  ...
  <p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_linkedhashset_clear">Try it Yourself &raquo;</a></p>
</div>

<hr>

<h2>LinkedHashSet Size</h2>
...
<div class="w3-example">
  ...
  <p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_linkedhashset_size">Try it Yourself &raquo;</a></p>
</div>
  <p><strong>Note:</strong> Duplicate values are not counted - only unique elements are included in the size.</p>
<hr>

<h2>Loop Through a LinkedHashSet</h2>
<p>Loop through the elements of a <code class="w3-codespan">LinkedHashSet</code> with a <b>for-each</b> loop:</p>

<div class="w3-example">
  <h3>Example</h3>
  <pre class="language-java w3-white"><code>LinkedHashSet&lt;String&gt; cars = new LinkedHashSet&lt;&gt;();
// Add elements...

for (String car : cars) {
  System.out.println(car);
}</code></pre>
  <p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_linkedhashset_loop">Try it Yourself &raquo;</a></p>
</div>

<hr>

<h2>HashSet vs LinkedHashSet</h2>
<table class="ws-table-all notranslate">
  <tr>
    <th>Feature</th>
    <th><code class="w3-codespan">HashSet</code></th>
    <th><code class="w3-codespan">LinkedHashSet</code></th>
  </tr>
  <tr>
    <td>Order</td>
  ...
  <tr>
    <td>Performance</td>
    <td>Faster</td>
    <td>Slightly slower (due to order tracking)</td>
  </tr>
</table>

<div class="ws-note ws-panel">
  <p><strong>Tip:</strong> Use <code class="w3-codespan">HashSet</code> when you only care about uniqueness and speed. Use <code class="w3-codespan">LinkedHashSet</code> when order matters.</p>
</div>
<hr>
...
<p>
From Java 10, you can use the <code class="w3-codespan">var</code> keyword to declare a <code class="w3-codespan">LinkedHashSet</code> variable without writing the type twice.  
...
var cars = new LinkedHashSet&lt;String&gt;();
  ...
  <p>
    <a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_linkedhashset_var">Try it Yourself &raquo;</a>
  </p>
</div>
...
<p><strong>Note:</strong> Sometimes you will see both <code class="w3-codespan">Set</code> and <code class="w3-codespan">LinkedHashSet</code> in Java code, like this:</p>

<div class="w3-example">
  <pre class="language-java w3-white"><code>import java.util.Set;
import java.util.LinkedHashSet;

Set&lt;String&gt; cars = new LinkedHashSet&lt;&gt;();</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_linkedhashset_set">Try it Yourself &raquo;</a>
</p>
</div>
<p>This means the variable (cars) is declared as a <a href="java_set.asp"><code class="w3-codespan">Set</code></a> (the interface), but it stores a <code class="w3-codespan">LinkedHashSet</code> object (the actual set). Since <code class="w3-codespan">LinkedHashSet</code> implements the <code class="w3-codespan">Set</code> interface, this is possible.</p>
