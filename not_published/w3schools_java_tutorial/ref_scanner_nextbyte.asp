...
<html lang="en-US">
<head>
<title>Java Scanner nextByte() Method</title>
<meta charset="utf-8">
...
<h1>Java Scanner <span class="color_h1">nextByte()</span> Method</h1>
...
<h3>Example</h3>
<p>Print the value of every byte in the string:</p>
...
<p>The <code class="w3-codespan">nextByte()</code> method returns the <code class="w3-codespan">byte</code> value of the number that the next token represents. The token must represent a whole number between -128 and 127.</p>
...
<pre class="language-java"><code>public boolean nextByte()</code></pre>
<pre class="language-java"><code>public boolean nextByte(int <em>radix</em>)</code></pre>
...
<tr>
 ...
 <td style="width:80%">The <code class="w3-codespan">byte</code> value of the number that the next token represents.</td>
</tr>
<tr>
 <th style="width:20%">Throws:</th>
 <td style="width:80%">
  <code class="w3-codespan">InputMismatchException</code> - If the token does not represent a <code class="w3-codespan">byte</code> type value.<br>
