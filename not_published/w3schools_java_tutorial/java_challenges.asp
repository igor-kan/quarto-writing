...
<html lang="en-US">
<head>
<title>Java Code Challenges</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1">Code Challenges</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_quiz.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_practice.php">Next &#10095;</a>
</div>
<hr>
<p>Test your Java skills with code challenges from all categories:</p>
...
(function() {
  ...
  overviews.forEach(function(overview) {
    var challengeLink = overview.querySelector('a[href*="java_challenges_"]');
    if (challengeLink) {
      ...
      var title = headerLink ? headerLink.textContent.trim() : href.replace('java_challenges_', '').replace('.asp', '');
      title = title.replace(/^Java\s*/i, '');
...
<p>Code challenges are interactive coding exercises where you write Java code to achieve a specific result.</p>
<p>Each challenge presents you with a goal and lets you practice writing real Java code.</p>
