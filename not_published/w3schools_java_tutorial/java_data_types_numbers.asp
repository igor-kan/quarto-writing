...
<h1>Java <span class="color_h1">Numbers</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_data_types.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_data_types_boolean.asp">Next &#10095;</a>
</div>
<hr>
...
<h3>Example</h3>
<pre class="language-java w3-white"><code>byte myNum = 100;
System.out.println(myNum);
</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_type_byte">Try it Yourself &raquo;</a>
</p>
</div>
...
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>short myNum = 5000;
System.out.println(myNum);
</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_type_short">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>int myNum = 100000;
System.out.println(myNum);
</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_type_int">Try it Yourself &raquo;</a>
</p>
</div>

<h3>Long</h3>
<p>The <code class="w3-codespan">long</code> data type can store whole numbers from -9223372036854775808 to 9223372036854775807. This is used when int is not large enough to store the value. Note that you should end the value with an "L":</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>long myNum = 15000000000L;
System.out.println(myNum);
</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_type_long">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>The <code class="w3-codespan">float</code> and <code class="w3-codespan">double</code> data types can store fractional numbers. Note that you should end the value with an "f" for floats and "d" for doubles:</p>
<div class="w3-example">
<h3>Float Example</h3>
<pre class="language-java w3-white"><code>float myNum = 5.75f;
System.out.println(myNum);
</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_type_float">Try it Yourself &raquo;</a>
</p>
</div>

<div class="w3-example">
<h3>Double Example</h3>
<pre class="language-java w3-white"><code>double myNum = 19.99d;
System.out.println(myNum);
</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_type_double">Try it Yourself &raquo;</a>
</p>
</div>
...
The precision of <code class="w3-codespan">float</code> is only 6-7 
decimal digits, while <code class="w3-codespan">double</code> variables have a 
precision of about 16 digits.</p><p>Therefore it is safer to use <code class="w3-codespan">double</code> for most calculations.</p>
</div>
...
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>float f1 = 35e3f;
double d1 = 12E4d;
System.out.println(f1);
System.out.println(d1);
</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_type_scientific">Try it Yourself &raquo;</a>
</p>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_data_types_numbers.js"></div>
<hr>
