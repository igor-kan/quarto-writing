...
<html lang="en-US">
<head>
<title>Java How To Find Out if a Number is Positive or Negative</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1">How To Find Positive or Negative Numbers</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_howto_reverse_number.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_howto_find_square_root.asp">Next &#10095;</a>
</div>
<hr>

<h2>Find Out if a Number is Positive or Negative</h2>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryjava.asp?filename=demo_howto_pos_or_neg">Try it Yourself &raquo;</a>
</div>
<p><b>Explanation:</b> We use simple comparisons with <code class="w3-codespan">&gt;</code> and <code class="w3-codespan">&lt;</code>.  
<br>- If the number is greater than 0, it is positive.  
<br>- If the number is less than 0, it is negative.  
<br>- If it is neither, it must be exactly 0.</p>
<hr>

<h2>Related Pages</h2>
<p><a href="java_conditions.asp">Java If..Else Tutorial</a></p>
