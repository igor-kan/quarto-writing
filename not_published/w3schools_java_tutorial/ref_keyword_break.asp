...
<html lang="en-US">
<head>
<title>Java break Keyword</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1"> break</span> Keyword</h1>
<p>
...
<h3>Example</h3>
<p>End the loop when <code class="w3-codespan">i</code> is equal to 4:</p>
...
<code class="w3-codespan">for</code> loop, a <code class="w3-codespan">while</code> 
loop or a <code class="w3-codespan">switch</code> block.</p>
<hr>
