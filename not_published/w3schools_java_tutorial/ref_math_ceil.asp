...
<html lang="en-US">
<head>
<title>Java Math ceil() Method</title>
<meta charset="utf-8">
...
<h1>Java Math <span class="color_h1">ceil()</span> Method</h1>
...
<pre class="w3-white language-java"><code>System.out.println(Math.ceil(0.60));
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_math_ceil">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">ceil()</code> method rounds a number UP to the 
nearest integer.</p>
<p><strong>Tip:</strong> To round a number DOWN to the nearest integer, look at the <a href="/java/ref_math_floor.asp">floor()</a> method.</p>
...
<h2>Syntax</h2>
<pre class="language-java"><code>public static double ceil(double <em>number</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>number</em></td>
    <td>Required. A number to round up.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">A <code class="w3-codespan">double</code> value representing the nearest integer greater or equal to a number.</td>
</tr>
<tr>
