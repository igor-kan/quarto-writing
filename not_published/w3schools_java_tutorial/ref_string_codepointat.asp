...
<html lang="en-US">
<head>
<title>Java String codePointAt() Method</title>
<meta charset="utf-8">
...
<h1>Java String <span class="color_h1">codePointAt()</span> Method</h1>
...
<p>
  <a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_string_codepointat">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>The <code class="w3-codespan">codePointAt()</code> method returns the Unicode 
value of the character at the specified index in a string.</p>
...
<pre class="language-java"><code>public int codePointAt(int <em>index</em>)
</code></pre>
...
<table class="ws-table-all notranslate"> 
  <tbody><tr>
    ...
    <tr>
    <td><em>index</em></td>
    <td>An <code class="w3-codespan">int</code> value, representing the index of the character to return</td>
    </tr>
</tbody>
</table>
