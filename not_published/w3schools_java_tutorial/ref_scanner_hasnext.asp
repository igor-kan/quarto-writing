...
<html lang="en-US">
<head>
<title>Java Scanner hasNext() Method</title>
<meta charset="utf-8">
...
<h1>Java Scanner <span class="color_h1">hasNext()</span> Method</h1>
...
<h3>Example</h3>
<p>Use hasNext() to read every token in a string:</p>
...
<p>The <code class="w3-codespan">hasNext()</code> method returns <em>true</em> if there is another token available in the scanner.</p>
<p>If the <em>pattern</em> parameter is used, then it only returns true if the next token matches the regular expression specified by the parameter.</p>
...
<pre class="language-java"><code>public boolean hasNext()</code></pre>
<pre class="language-java"><code>public boolean hasNext(Pattern <em>pattern</em>)</code></pre>
<pre class="language-java"><code>public boolean hasNext(String <em>pattern</em>)</code></pre>
...
<tr>
 ...
 <td style="width:80%">A <code class="w3-codespan">boolean</code> value which is true if another token is available and matches the regular expression provided by the <em>pattern</em> parameter.</td>
</tr>
<tr>
