...
<html lang="en-US">
<head>
<title>Java HashMap merge() Method</title>
<meta charset="utf-8">
...
<h1>Java HashMap <span class="color_h1">merge()</span> Method</h1>

<p><a class="w3-btn w3-white w3-border" href="java_ref_hashmap.asp">&#10094; HashMap Methods</a></p>

<hr>

<div class="w3-example">
<h3>Example</h3>
<p>Compute a new value for an entry in a map:</p>
<pre class="w3-white language-java"><code>import java.util.HashMap;
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_hashmap_merge">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">merge()</code> method creates an entry with a specified key and value or, if an entry with the specified key already exists, calculates a new value for the entry. </p>
<p>The new value is computed using a function, which can be defined by a lambda expression that is compatible with the <code class="w3-codespan">apply()</code> method of Java's <code class="w3-codespan">BiFunction</code> interface.</p>
<p>To learn about lambda expressions, see our <a href="java_lambda.asp">Java Lambda Expression tutorial</a>.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public V merge(K <em>key</em>, V <em>value</em>, BiFunction <em>function</em>)</code></pre>
<p><code class="w3-codespan">K</code> and <code class="w3-codespan">V</code> refer to the data types of the keys and values of the map.</p>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>key</em></td>
    <td>Required. The key of the entry.</td>
  </tr>
  <tr>
    <td><em>value</em></td>
    <td>Required. The value to use if an entry with the specified key does not yet exist.</td>
  </tr>
  <tr>
    <td><em>function</em></td>
    <td>
      Required. A <code class="w3-codespan">BiFunction</code> object or lambda expression which operates on each entry.<br>
      The first parameter of the function contains the current value of the entry and the second parameter contains the value specified by the <em>value</em> argument.
    </td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">The value that is written into the entry.</td>
</tr>
</table>
<hr>
...
<a class="w3-btn w3-white w3-border" href="java_ref_hashmap.asp">&#10094; HashMap Methods</a>
