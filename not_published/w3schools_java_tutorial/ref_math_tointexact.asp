...
<html lang="en-US">
<head>
<title>Java Math toIntExact() Method</title>
<meta charset="utf-8">
...
<h1>Java Math <span class="color_h1">toIntExact()</span> Method</h1>
...
<h3>Example</h3>
<p>Convert <code class="w3-codespan">long</code> values to <code class="w3-codespan">int</code>:</p>
<pre class="w3-white language-java"><code>System.out.println(Math.toIntExact(1500000L));
System.out.println(Math.toIntExact(-32L));
System.out.println(Math.toIntExact(-86345L));
System.out.println(Math.toIntExact(25L));
</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="/java/tryjava.asp?filename=demo_ref_math_tointexact">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">toIntExact()</code> method Converts a <code class="w3-codespan">long</code> value to an <code class="w3-codespan">int</code> and throws an exception if the conversion results in an overflow. This prevents incorrect results that can occur from the overflow.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public static int toIntExact(long <em>x</em>)</code></pre>
...
<tr>
 ...
 <td style="width:80%">An <code class="w3-codespan">int</code> value representing the contents of a <code class="w3-codespan">long</code> integer.</td>
</tr>
<tr>
 <th style="width:20%">Throws:</th>
 <td style="width:80%"> <code class="w3-codespan">ArithmeticException</code> - If the conversion causes an overflow.</td>
</tr>
<tr>
