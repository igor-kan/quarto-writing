...
<html lang="en-US">
<head>
<title>Java Non-Primitive Data Types</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1">Non-Primitive Data Types</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_data_types_reallife.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_var.asp">Next &#10095;</a>
</div>
<hr>
...
<p>The main differences between <strong>primitive</strong> and <strong>non-primitive</strong> data types are:</p>

<ul>
<li>Primitive types in Java are predefined and built into the language, while 
non-primitive types are created by the programmer (except for <code class="w3-codespan">String</code>).</li>
<li>Non-primitive types can be used to call methods to perform certain operations, 
whereas primitive types cannot.</li>
<li>Primitive types start with a lowercase letter (like <code class="w3-codespan">int</code>), while non-primitive types typically starts with an uppercase letter 
(like <code class="w3-codespan">String</code>).</li>
<li>Primitive types always hold a value, whereas non-primitive types can be <code class="w3-codespan">null</code>.</li>
<!--<li>The size of a primitive type depends on the data type, while non-primitive types have all the same size.</li>-->
</ul>

<p>Examples of non-primitive types are <a href="java_strings.asp">Strings</a>, <a href="java_arrays.asp">Arrays</a>, <a href="java_classes.asp">Classes</a> etc. You will learn more about these in a later chapter.</p>
<hr>
