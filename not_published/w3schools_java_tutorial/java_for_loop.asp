...
<a class="w3-left w3-btn" href="java_challenges_while_loop.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_for_loop_nested.asp">Next &#10095;</a>
</div>
<hr>
...
code, use the <code class="w3-codespan">for</code> loop instead of a <a href="java_while_loop.asp"><code class="w3-codespan">while</code></a> loop:</p>
...
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>for (int i = 0; i &lt; 5; i++) {<br>&nbsp;&nbsp;System.out.println(i);<br>}
</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_for_loop">Try it Yourself &raquo;</a>
</p>
</div>

<h3>Example explained</h3>
<ul>
  <li><strong>Statement 1</strong> sets a variable before the loop starts: <code class="w3-codespan">int i = 0</code></li>
  <li><strong>Statement 2</strong> defines the condition for the loop to run: <code class="w3-codespan">i &lt; 5</code>. If the condition is true, the loop will run again; if it is false, the loop ends.</li>
  <li><strong>Statement 3</strong> increases a value each time the code block has run: <code class="w3-codespan">i++</code></li>
</ul>
...
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>for (int i = 0; i &lt;= 10; i = i + 2) {<br>&nbsp;&nbsp;System.out.println(i);<br>}
</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_for_loop_even">Try it Yourself &raquo;</a>
</p>
</div>
...
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>int sum = 0;<br>for (int i = 1; i &lt;= 5; i++) {<br>&nbsp;&nbsp;sum = sum + i;<br>}<br>System.out.println("Sum is " + sum);
</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_for_loop_sum">Try it Yourself &raquo;</a>
</p>
</div>
...
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>for (int i = 5; i &gt; 0; i--) {<br>&nbsp;&nbsp;System.out.println(i);<br>}
</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_for_loop_countdown">Try it Yourself &raquo;</a>
</p>
</div>
<hr>

<h2>For Loop With False Condition</h2>
<p>Just like a <code class="w3-codespan">while</code> loop, a <code class="w3-codespan">for</code> loop may also never run.  
If the condition is <code class="w3-codespan">false</code> right from the start, the code inside the loop will be skipped entirely:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>for (int i = 10; i &lt; 5; i++) {
  System.out.println("This will never be printed");
}
</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_for_false">Try it Yourself &raquo;</a>
</p>
</div>
<p>In this example, the loop starts with <code class="w3-codespan">i = 10</code>.  
The condition <code class="w3-codespan">i &lt; 5</code> is already false, so the loop body is skipped, and nothing is printed.</p>
