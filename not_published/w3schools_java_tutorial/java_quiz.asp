...
<h1>Java <span class="color_h1">Quiz</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_exercises.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_challenges.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">You can test your Java skills with W3Schools' Quiz.</p>
<hr>
<h2>The Test</h2>
...
<p>Good luck!</p>
<p><a href='/quiztest/quiztest.asp?qtest=JAVA' class="w3-btn w3-blue w3-round" style="margin-top:10px;padding:17px;font-size:17px">Start the Java Quiz &#10095;</a></p>
</div>
