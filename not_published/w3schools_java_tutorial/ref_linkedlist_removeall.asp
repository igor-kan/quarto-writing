...
<html lang="en-US">
<head>
<title>Java LinkedList removeAll() Method</title>
<meta charset="utf-8">
...
<h1>Java LinkedList <span class="color_h1">removeAll()</span> Method</h1>
...
<h3>Example</h3>
<p>Remove all items from a list:</p>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_linkedlist_removeall">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">removeAll()</code> method removes all items from a list which belong to a specified collection.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public boolean removeAll(Collection <em>items</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>items</em></td>
    <td>Required. A collection containing items to be removed from the list.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">
  <code class="w3-codespan">NullPointerException</code> - If the collection is <em>null</em>.
 </td>
</tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Remove multiple items from a list:</p>
<pre class="w3-white language-java"><code>import java.util.LinkedList;
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_linkedlist_removeall2">Try it Yourself &raquo;</a></p>
</div>
