...
<html lang="en-US">
<head>
<title>Java LinkedList subList() Method</title>
<meta charset="utf-8">
...
<h1>Java LinkedList <span class="color_h1">subList()</span> Method</h1>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_linkedlist_sublist">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">subList()</code> method returns a new list (referred to as a <em>sublist</em>) which contains the items of the list between two indices.</p>
<p><strong>Note:</strong> The item at the last index is not included in the sublist.</p>
<p><strong>Note:</strong> The sublist is a <em>view</em> of the original list, which means that changing the sublist also changes the original list.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public List sublist(int <em>start</em>, int <em>end</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>start</em></td>
    <td>Required. The index where the sublist starts.</td>
  </tr>
  <tr>
    <td><em>end</em></td>
    <td>Required. The index where the sublist ends. The item at this position is not included in the sublist.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">A new <code class="w3-codespan">List</code> containing elements of the list.</td>
</tr>
<tr>
 <th style="width:20%">Throws:</th>
 <td style="width:80%">
  <code class="w3-codespan">IndexOutOfBoundsException</code> - If one of the indices is less than zero or greater than the size of the list.<br>
  <code class="w3-codespan">IllegalArgumentException</code> - If end index is less than the start index.<br>
...
<div class="w3-example">
<h3>Example</h3>
<p>A list can be changed by changing a sublist:</p>
<pre class="w3-white language-java"><code>import java.util.LinkedList;
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_linkedlist_sublist2">Try it Yourself &raquo;</a></p>
</div>
