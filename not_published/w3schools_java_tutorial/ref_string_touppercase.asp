...
<html lang="en-US">
<head>
<title>Java String toUpperCase() Method</title>
<meta charset="utf-8">
...
<h1>Java String <span class="color_h1">toUpperCase()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Convert a string to upper case and lower case letters:</p>
<pre class="language-java w3-white"><code>String txt = &quot;Hello World&quot;;
System.out.println(txt.toUpperCase());
System.out.println(txt.toLowerCase());</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_string_touppercase_lowercase">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>The <code class="w3-codespan">toUpperCase()</code> method converts a string to upper case letters.</p>
<p><strong>Note:</strong> The <a href="ref_string_tolowercase.asp">toLowerCase()</a> method converts a string to lower case letters.</p>

<hr>

<h2>Syntax</h2>

<pre class="language-java"><code>public String toUpperCase()
</code></pre>
...
<tr>
 <th style="width:21%">Returns:</th>
  <td>A <code class="w3-codespan">String</code> value, representing the new string converted to upper case</td>
</tr>
</table>
<br>
