...
<html lang="en-US">
<head>
<title>Java String hashCode() Method</title>
<meta charset="utf-8">
...
<h1>Java String <span class="color_h1">hashCode()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Return the hash code of a string:</p>
<pre class="language-java w3-white"><code>String myStr = &quot;Hello&quot;;
System.out.println(myStr.hashCode());</code></pre>
<p>
  <a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_string_hashcode">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>The <code class="w3-codespan">hashCode()</code> method returns the hash code of a string.</p>
<p>The hash code for a String object is computed like this:</p>
<pre class="language-java"><code>s[0]*31^(n-1) + s[1]*31^(n-2) + ... + s[n-1]
</code></pre>

<p>where s[i] is the ith character of the string, n is the length of the string, and ^ indicates exponentiation.</p>

<hr>

<h2>Syntax</h2>

<pre class="language-java"><code>public int hashCode()
</code></pre>
...
<tr>
 <th style="width:21%">Returns:</th>
  <td>An <code class="w3-codespan">int</code> value, representing the hash code of the string</td>
</tr>
</table>
<br>
