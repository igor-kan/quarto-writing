...
<html lang="en-US">
<head>
<title>Java How To Find the Greatest Common Divisor (GCD)</title>
<meta charset="utf-8">
...
<h1>Java How To <span class="color_h1">Find the GCD</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_howto_fibonacci.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_howto_check_prime_num.asp">Next &#10095;</a>
</div>
<hr>

<h2>Find the Greatest Common Divisor (GCD)</h2>
<p>The GCD (Greatest Common Divisor) is the largest number that divides two numbers without leaving a remainder.</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>int a = 36;
int b = 60;
int gcd = 1;
...
System.out.println(&quot;GCD: &quot; + gcd);</code></pre>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_howto_find_gcd">Try it Yourself &raquo;</a></p>
</div>

<p><b>Explanation:</b></p>
<p>We want the largest number that divides both <code class="w3-codespan">36</code> and <code class="w3-codespan">60</code> without a remainder.</p>
<ul>
  <li>The loop starts at <code class="w3-codespan">1</code> and goes up to the smaller number (36).</li>
  <li>At each step, we check if <code class="w3-codespan">i</code> divides both numbers (using <code class="w3-codespan">%</code>, the remainder operator).</li>
  <li>If it does, we update <code class="w3-codespan">gcd</code> to that value.</li>
</ul>
<p>For example:</p>
<ul>
  <li><code class="w3-codespan">36 % 12 == 0</code> and <code class="w3-codespan">60 % 12 == 0</code>, so 12 is a divisor of both.</li>
  <li>Later, the loop finds <code class="w3-codespan">gcd = 12</code> as the largest common divisor.</li>
</ul>
<p>So the program prints <code class="w3-codespan">GCD: 12</code>.</p>
<hr>
