...
<h1>Java <span class="color_h1">Iterator</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_linkedhashmap.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_algorithms.asp">Next &#10095;</a>
</div>
<hr>

<h2>Java Iterator</h2>
<p>An <code class="w3-codespan">Iterator</code> is an object that can be used to loop through <a href="java_collections.asp">collections</a>, like <a href="java_arraylist.asp"><code class="w3-codespan">ArrayList</code></a>
and <a href="java_hashset.asp"><code class="w3-codespan">HashSet</code></a>.</p>
<p>It is called an "iterator" because "iterating" is the technical term for looping.</p>
<p>To use an Iterator, you must import it from the <code class="w3-codespan">java.util</code> package.</p>
<hr>

<h2>Getting an Iterator</h2>
<p>The <code class="w3-codespan">iterator()</code> method can be used to get an <code class="w3-codespan">Iterator</code> for any collection:</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_iterator">Try it Yourself &raquo;</a>
</p>
</div>
<hr>

<h2>Looping Through a Collection</h2>
<p>To loop through a collection, use the <code class="w3-codespan">hasNext()</code> and <code class="w3-codespan">next()</code> methods of the <code class="w3-codespan">Iterator</code>:</p>
<div class="w3-example">
<h3>Example</h3>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_iterator_loop">Try it Yourself &raquo;</a>
</p>
</div>
<hr>
...
<h2>Removing Items from a Collection</h2>
<p>Iterators are designed to easily change the collections that they loop through. The <code class="w3-codespan">remove()</code> method can remove items from a collection while looping.</p>
<div class="w3-example">
<h3>Example</h3>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_iterator_remove">Try it Yourself &raquo;</a>
</p>
</div>
...
<h2>The var Keyword with Iterators</h2>

<p>
You can also use the <code class="w3-codespan">var</code> keyword with iterators.  
...
// With var
var it = cars.iterator();</code></pre>
  <p>
    <a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_iterator_var">Try it Yourself &raquo;</a>
  </p>
</div>

<p>
Here, <code class="w3-codespan">var</code> makes the iterator declaration shorter,  
but the actual type is still <code class="w3-codespan">Iterator&lt;String&gt;</code>.  
</p>
<hr>

<div>
<h2>Complete Iterator Reference</h2>
<p>For a complete reference of Iterator methods, go to our <a href="java_ref_iterators.asp">Java Iterator Reference</a>.</p>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_iterator.js"></div>
<hr>
