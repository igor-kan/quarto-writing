...
<html lang="en-US">
<head>
<title>Java String codePointCount() Method</title>
<meta charset="utf-8">
...
<h1>Java String <span class="color_h1">codePointCount()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Return the number of Unicode values found in a string:</p>
<pre class="language-java w3-white"><code>String myStr = &quot;Hello&quot;;
int result = myStr.codePointCount(0, 5);
System.out.println(result);</code></pre>
<p>
  <a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_string_codepointcount">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>The <code class="w3-codespan">codePointCount()</code> method returns the 
number of Unicode values found in a string.</p>
<p>Use the <em>startIndex</em> and <em>endIndex</em> parameters to specify where 
...
<pre class="language-java"><code>public int codePointCount(int <em>startIndex</em>, int <em>endIndex</em>)
</code></pre>
...
<table class="ws-table-all notranslate"> 
  <tbody><tr>
    ...
    <td>An <code class="w3-codespan">int</code> value, representing the index to 
    the first character in the string</td>
    </tr>
    <tr>
    <td><em>endIndex</em></td>
    <td>An <code class="w3-codespan">int</code> value, representing the index 
    after the last character in the string</td>
    </tr>
</tbody>
</table>
...
<tr>
 <th style="width:21%">Returns:</th>
  <td>An <code class="w3-codespan">int</code> value, representing the number of 
  Unicode values found in a string</td>
</tr>
<tr>
 <th style="width:21%">Throws:</th>
  <td><code class="w3-codespan">IndexOutOfBoundsException</code> - if startIndex 
  is negative, or endindex is larger than the length of the string, or 
  startIndex is larger than endIndex</td>
</tr>
<tr>
