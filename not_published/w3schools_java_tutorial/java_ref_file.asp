...
<html lang="en-US">
<head>
<title>Java File Reference</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1">File Class Methods</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_ref_scanner.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_ref_fileinputstream.asp">Next &#10095;</a>
</div>
<hr>

<h2>File Class Methods</h2>
<p>The <code class="w3-codespan">File</code> class (from <code class="w3-codespan">java.io</code>) is used to work with file and directory paths.  
It lets you create, delete, and get information about files and folders - but it does <strong>not</strong> read or write the contents.</p>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td>createNewFile()</td>
    <td>Creates a new, empty file if it does not already exist</td>
    <td>boolean</td>
  </tr>
  <tr>
    <td>delete()</td>
    <td>Deletes the file or directory</td>
    <td>boolean</td>
  </tr>
  <tr>
    <td>exists()</td>
    <td>Tests whether the file or directory exists</td>
    <td>boolean</td>
  </tr>
  <tr>
    <td>canRead()</td>
  ...
  <tr>
    <td>canWrite()</td>
    <td>Tests whether the application can write to the file</td>
    <td>boolean</td>
  </tr>
  <tr>
    <td>isFile()</td>
    <td>Returns true if the path represents a file</td>
    <td>boolean</td>
  </tr>
  <tr>
    <td>isDirectory()</td>
    <td>Returns true if the path represents a directory</td>
    <td>boolean</td>
  </tr>
  <tr>
    <td>length()</td>
  ...
  <tr>
    <td>getPath()</td>
    <td>Returns the pathname string</td>
    <td>String</td>
  </tr>
  <tr>
    <td>getParent()</td>
    <td>Returns the pathname string of the parent directory</td>
    <td>String</td>
  </tr>
  <tr>
    <td>list()</td>
    <td>Returns an array of names of files and directories in a directory</td>
    <td>String[]</td>
  </tr>
  <tr>
    <td>listFiles()</td>
    <td>Returns an array of <code class="w3-codespan">File</code> objects in a directory</td>
    <td>File[]</td>
  </tr>
  <tr>
    <td>mkdir()</td>
  ...
  <tr>
    <td>mkdirs()</td>
    <td>Creates a directory and any missing parent directories</td>
    <td>boolean</td>
  </tr>
  <tr>
    <td>renameTo()</td>
    <td>Renames the file or directory</td>
    <td>boolean</td>
  </tr>
  <tr>
    <td>setReadOnly()</td>
    <td>Marks the file as read-only</td>
    <td>boolean</td>
  </tr>
  <tr>
    <td>setWritable()</td>
    <td>Sets the writable permission</td>
    <td>boolean</td>
  </tr>
  <tr>
    <td>setReadable()</td>
    <td>Sets the readable permission</td>
    <td>boolean</td>
  </tr>
  <tr>
    <td>setExecutable()</td>
    <td>Sets the executable permission</td>
    <td>boolean</td>
  </tr>
  <tr>
    <td>canExecute()</td>
    <td>Tests whether the application can execute the file</td>
    <td>boolean</td>
  </tr>
</table>
...
<h2>Related Pages</h2>
<p><a href="java_files.asp">Java File Handling Tutorial</a></p>
