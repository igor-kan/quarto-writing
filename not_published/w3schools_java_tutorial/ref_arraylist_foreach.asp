...
<html lang="en-US">
<head>
<title>Java ArrayList forEach() Method</title>
<meta charset="utf-8">
...
<h1>Java ArrayList <span class="color_h1">forEach()</span> Method</h1>
...
<h3>Example</h3>
<p>Use a lambda expression in the <code class="w3-codespan">ArrayList</code>'s <code class="w3-codespan">forEach()</code> method to print every item in the list:</p>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_arraylist_foreach">Try it Yourself &raquo;</a></p>
</div>
<hr>
