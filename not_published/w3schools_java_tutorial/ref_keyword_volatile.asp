...
<h1>Java <span class="color_h1"> volatile</span> Keyword</h1>
<p>
...
<h3>Example</h3>
<p>Create a <code class="w3-codespan">volatile</code> attribute:</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_keyword_volatile">Try it Yourself &raquo;</a>
</p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">volatile</code> keyword is a modifier that ensures that an attribute's value is always the same when read from all threads.</p>
<p>Ordinarily the value of an attribute may be written into a thread's local cache and not updated in the main memory for some amount of time. In this case, other threads will see a different value for the attribute. The <code class="w3-codespan">volatile</code> keyword makes sure that threads always update the value of an attribute in main memory.</p>
<hr>
