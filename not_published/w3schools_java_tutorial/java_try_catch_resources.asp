...
<h1>Java <span class="color_h1">try-with-resources</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_exceptions_multiple.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_files.asp">Next &#10095;</a>
</div>
<hr>

<h2>Java Close Resources</h2>
<p>When working with files, streams, or other resources, it is important to <strong>close</strong> them after use. 
If you forget to close a resource, it may keep using memory or even prevent you from opening the file again until the program ends.</p>

<p><strong>Note:</strong> You have not yet learned about <a href="java_files.asp">files</a> and <a href="java_io_streams.asp">streams</a> in detail.  
These topics will come in the next chapters. For now, just focus on how <b>try-with-resources</b> works.</p>

<p>In older code, you had to close "resources" manually by calling their <code class="w3-codespan">close()</code> method:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_try_resources">Run Example &raquo;</a>
</div>
<hr>

<h2>Java try-with-resources</h2>

<p>Since Java 7, you can use <strong>try-with-resources</strong>.  
It is a special form of <code class="w3-codespan">try</code> that works with resources (like <a href="java_files.asp">files</a> and <a href="java_io_streams.asp">streams</a>).  
The resource is declared inside parentheses <code class="w3-codespan">try(...)</code>, and Java will close it automatically when the block finishes - even if an error occurs.</p>

<div class="w3-example">
<h3>Example (try-with-resources)</h3>
<pre class="language-java w3-white" data-line="7"><code>import java.io.FileOutputStream;
import java.io.IOException;
...
<p><a target="_blank" class="w3-btn" href="showjava.asp?filename=demo_try_resources_auto">Run Example &raquo;</a></p>
</div>

<hr>
<!--
<h2>Multiple Resources</h2>
<p>You can also manage <strong>more than one resource</strong> at a time. They are closed in the reverse order of being opened.</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>import java.io.BufferedReader;
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_try_resources_multi">Run Example &raquo;</a>
</div>
<p><strong>Explanation:</strong> This program opens two resources at the same time: 
a <code class="w3-codespan">BufferedReader</code> to read from <code class="w3-codespan">input.txt</code>, 
and a <code class="w3-codespan">FileWriter</code> to write into <code class="w3-codespan">output.txt</code>.  
The contents are copied line by line, and when finished, both resources are automatically closed in reverse order.</p>
<hr>
-->

<h2>Why use try-with-resources?</h2>
<ul>
  <li><strong>Safer</strong> - resources are always closed, even if an exception occurs.</li>
  <li><strong>Cleaner</strong> - no need to write <code class="w3-codespan">close()</code> calls.</li>
  <li><strong>Shorter code</strong> - less boilerplate, easier to read.</li>
</ul>

<div class="ws-note ws-panel">
<p><strong>Rule of thumb:</strong> Whenever you work with files, streams, or database connections, use try-with-resources to make sure they are closed properly.</p>
</div>
<p><strong>Next:</strong> Learn about how to <a href="java_files.asp">handle files in Java</a>.</p>
