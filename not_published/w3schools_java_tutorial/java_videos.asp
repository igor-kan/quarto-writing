...
<h1>Java <span class="color_h1">Videos</span></h1>

<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="java_examples.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="java_compiler.asp">Next &#10095;</a>
</div>

<hr>

<h2>Java Videos</h2>
<p>Watch our Java video tutorials on YouTube and learn Java step by step.</p>
<p>We have gathered a set of easy-to-follow video tutorials to help you get started with Java:</p>
<div class="w3-row-padding" style="margin-top:24px;margin-lefT:-16px;margin-right:-16px">

  <!-- 1) Java Introduction -->
  <div class="w3-half ws-video-col">
    <a href="https://youtu.be/t54pgbVy6t0&list=PLP9IO4UYNF0VT3LvP_Cl4EIEyVk-Q5DP3" class="ga-featured ga-youtube" target="_blank" style="text-decoration:none">
      <div class="ws-video-card">
        <h2>Java Introduction</h2>
        <div class="ws-video-thumb">
          <picture>
        <source srcset="images/img_java_intro.webp" type="image/webp" />
        <img src="images/img_java_intro.png" style="max-width:100%;height:auto;border-radius:6px" alt="Java Tutorial on YouTube" loading="lazy">
          </picture>
          <div class="ws-video-play">
            <picture>
              <source srcset="/images/yt_logo_rgb_dark.webp" type="image/webp">
              <img src="images/yt_logo_rgb_dark.png" alt="Java Tutorial on YouTube" loading="lazy">
            </picture>
          </div>
        </div>
      </div>
  ...
  <!-- 2) Java Get Started -->
  <div class="w3-half ws-video-col">
    <a href="https://youtu.be/zTEU-9kP66c?list=PLP9IO4UYNF0VT3LvP_Cl4EIEyVk-Q5DP3" class="ga-featured ga-youtube" target="_blank" style="text-decoration:none">
      <div class="ws-video-card">
        <h2>Java Get Started</h2>
        <div class="ws-video-thumb">
          <picture>
        <source srcset="images/img_java_getstarted.webp" type="image/webp" />
        <img src="images/img_java_getstarted.png" style="max-width:100%;height:auto;border-radius:6px" alt="Java Tutorial on YouTube" loading="lazy">
          </picture>
          <div class="ws-video-play">
            <picture>
              <source srcset="/images/yt_logo_rgb_dark.webp" type="image/webp">
  ...
  <!-- 3) Java Syntax -->
  <div class="w3-half ws-video-col">
    <a href="https://youtu.be/VR9IZcPOijY?list=PLP9IO4UYNF0VT3LvP_Cl4EIEyVk-Q5DP3" class="ga-featured ga-youtube" target="_blank" style="text-decoration:none">
      <div class="ws-video-card">

        <h2>Java Syntax</h2>
        <div class="ws-video-thumb">
          <picture>
        <source srcset="images/img_java_syntax.webp" type="image/webp" />
        <img src="images/img_java_syntax.png" style="max-width:100%;height:auto;border-radius:6px" alt="Java Tutorial on YouTube" loading="lazy">
          </picture>
          <div class="ws-video-play">
            <picture>
              <source srcset="/images/yt_logo_rgb_dark.webp" type="image/webp">
  ...
  <!-- 4) Java Output -->
  <div class="w3-half ws-video-col">
    <a href="https://youtu.be/BP3d7meXCmc?list=PLP9IO4UYNF0VT3LvP_Cl4EIEyVk-Q5DP3" class="ga-featured ga-youtube" target="_blank" style="text-decoration:none">
      <div class="ws-video-card">
        <h2>Java Output</h2>
        <div class="ws-video-thumb">
          <picture>
        <source srcset="images/img_java_output.webp" type="image/webp" />
        <img src="images/img_java_output.png" style="max-width:100%;height:auto;border-radius:6px" alt="Java Tutorial on YouTube" loading="lazy">
          </picture>
          <div class="ws-video-play">
            <picture>
              <source srcset="/images/yt_logo_rgb_dark.webp" type="image/webp">
  ...
  <!-- 5) Java Comments -->
  <div class="w3-half ws-video-col">
    <a href="https://youtu.be/mgWktMxvL7g?list=PLP9IO4UYNF0VT3LvP_Cl4EIEyVk-Q5DP3" class="ga-featured ga-youtube" target="_blank" style="text-decoration:none">
      <div class="ws-video-card">
        <h2>Java Comments</h2>
        <div class="ws-video-thumb">
          <picture>
        <source srcset="images/img_java_comments.webp" type="image/webp" />
        <img src="images/img_java_comments.png" style="max-width:100%;height:auto;border-radius:6px" alt="Java Tutorial on YouTube" loading="lazy">
          </picture>
          <div class="ws-video-play">
            <picture>
              <source srcset="/images/yt_logo_rgb_dark.webp" type="image/webp">
  ...
  <!-- 6) Java Variables -->
  <div class="w3-half ws-video-col">
    <a href="https://youtu.be/YF59k3gZeb4?list=PLP9IO4UYNF0VT3LvP_Cl4EIEyVk-Q5DP3" class="ga-featured ga-youtube" target="_blank" style="text-decoration:none">
      <div class="ws-video-card">
        <h2>Java Variables</h2>
        <div class="ws-video-thumb">
          <picture>
        <source srcset="images/img_java_variables.webp" type="image/webp" />
        <img src="images/img_java_variables.png" style="max-width:100%;height:auto;border-radius:6px" alt="Java Tutorial on YouTube" loading="lazy">
          </picture>
          <div class="ws-video-play">
            <picture>
              <source srcset="/images/yt_logo_rgb_dark.webp" type="image/webp">
  ...
  <!-- 7) Java Data Types -->
  <div class="w3-half ws-video-col">
    <a href="https://youtu.be/D3DqJrlckbs?list=PLP9IO4UYNF0VT3LvP_Cl4EIEyVk-Q5DP3" class="ga-featured ga-youtube" target="_blank" style="text-decoration:none">
      <div class="ws-video-card">
        <h2>Java Data Types</h2>
        <div class="ws-video-thumb">
          <picture>
        <source srcset="images/img_java_datatypes.webp" type="image/webp" />
        <img src="images/img_java_datatypes.png" style="max-width:100%;height:auto;border-radius:6px" alt="Java Tutorial on YouTube" loading="lazy">
          </picture>
          <div class="ws-video-play">
            <picture>
              <source srcset="/images/yt_logo_rgb_dark.webp" type="image/webp">
  ...
  <!-- 8) Java Type Casting -->
  <div class="w3-half ws-video-col">
    <a href="https://youtu.be/kFUqkaicfDw?list=PLP9IO4UYNF0VT3LvP_Cl4EIEyVk-Q5DP3" class="ga-featured ga-youtube" target="_blank" style="text-decoration:none">
      <div class="ws-video-card">
        <h2>Java Type Casting</h2>
        <div class="ws-video-thumb">
          <picture>
        <source srcset="images/img_java_type_casting.webp" type="image/webp" />
        <img src="images/img_java_type_casting.png" style="max-width:100%;height:auto;border-radius:6px" alt="Java Tutorial on YouTube" loading="lazy">
          </picture>
          <div class="ws-video-play">
            <picture>
              <source srcset="/images/yt_logo_rgb_dark.webp" type="image/webp">
  ...
  <!-- 9) Java Operators -->
  <div class="w3-half ws-video-col">
    <a href="https://youtu.be/RbjB3SIaabM?list=PLP9IO4UYNF0VT3LvP_Cl4EIEyVk-Q5DP3" class="ga-featured ga-youtube" target="_blank" style="text-decoration:none">
      <div class="ws-video-card">
        <h2>Java Operators</h2>
        <div class="ws-video-thumb">
          <picture>
        <source srcset="images/img_java_operators.webp" type="image/webp" />
        <img src="images/img_java_operators.png" style="max-width:100%;height:auto;border-radius:6px" alt="Java Tutorial on YouTube" loading="lazy">
          </picture>
          <div class="ws-video-play">
            <picture>
              <source srcset="/images/yt_logo_rgb_dark.webp" type="image/webp">
  ...
  <!-- 10) Java Strings -->
  <div class="w3-half ws-video-col">
    <a href="https://youtu.be/SkKmN9k5_mY?list=PLP9IO4UYNF0VT3LvP_Cl4EIEyVk-Q5DP3" class="ga-featured ga-youtube" target="_blank" style="text-decoration:none">
      <div class="ws-video-card">
        <h2>Java Strings</h2>
        <div class="ws-video-thumb">
          <picture>
        <source srcset="images/img_java_strings.webp" type="image/webp" />
        <img src="images/img_java_strings.png" style="max-width:100%;height:auto;border-radius:6px" alt="Java Tutorial on YouTube" loading="lazy">
          </picture>
          <div class="ws-video-play">
            <picture>
              <source srcset="/images/yt_logo_rgb_dark.webp" type="image/webp">
