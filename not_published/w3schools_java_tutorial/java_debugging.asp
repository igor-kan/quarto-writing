...
<h1>Java <span class="color_h1">Debugging</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_errors.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_try_catch.asp">Next &#10095;</a>
</div>
<hr>

<h2>Java Debugging</h2>
<p>After learning about common errors, the next step is understanding how to <strong>debug</strong> your Java code - that is, how to find and fix those errors effectively.</p>
<p>This page introduces simple debugging techniques that are useful for beginners and helpful even for experienced developers.</p>
<hr>

<h2>What is Debugging?</h2>
<p><strong>Debugging</strong> is the process of identifying and fixing errors or bugs in your code.</p>
<p>It often involves:</p>
<ul>
  <li>Reading error messages</li>
  <li>Tracing variable values step by step</li>
  <li>Testing small pieces of code independently</li>
</ul>

<div class="ws-note ws-panel">
  <p><strong>Tip:</strong> Debugging is a skill that improves with practice. The more you debug, the better you get at spotting problems quickly.</p>
</div>
<hr>

<h2>Print Statements for Debugging</h2>
<p>The most basic (and often most effective) way to debug Java code is to use <code class="w3-codespan">System.out.println()</code> to print values and check the flow of the program.</p>

<p>In this example, the first line <code class="w3-codespan">"Before division"</code> will print, but the second line is never reached because the program crashes due to division by zero:</p>
...
<code>
Before division<br>
Exception in thread "main" java.lang.ArithmeticException: / by zero</code>
</div>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_debugging_divzero">Try it Yourself &raquo;</a></p>
</div>

<div class="ws-note ws-panel">
  <p><strong>Tip:</strong> Add print statements before and after key lines of code to find out where things go wrong.</p>
</div>
<hr>

<h2>Check Variable Values</h2>
<p>If something unexpected happens, print out the values of your variables:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>int age = 17;
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_debugging_if">Try it Yourself &raquo;</a></p>
</div>
<div class="ws-note ws-panel">
<p><strong>Tip:</strong> This is a good way to test whether a condition is working correctly - try changing <code class="w3-codespan">age</code> to 18 or 19 and observe the output!</p>
</div>
...
<h2>Debugging with IDEs</h2>
<p>Modern IDEs like <strong>IntelliJ IDEA</strong>, <strong>Eclipse</strong>, and <strong>NetBeans</strong> come with built-in debugging tools.</p>
<ul>
  <li>Set <strong>breakpoints</strong> to pause the program at specific lines</li>
  <li>Step through code line by line</li>
  <li>Inspect variable values in real time</li>
</ul>

<div class="ws-note ws-panel">
  <p><strong>Tip:</strong> Use your IDE's debugger to find errors faster - it's more powerful than print statements alone!</p>
</div>
<hr>

<h2>Debugging Checklist</h2>
<ul>
  <li>Read the full error message, it often tells you exactly what's wrong</li>
  <li>Check if all variables are initialized before use</li>
  <li>Print variable values to trace the problem</li>
  <li>Watch for off-by-one errors in loops and arrays</li>
  <li>Comment out sections of code to find bugs</li>
</ul>

<p>In the next chapter, you will learn about how to handle errors gracefully in your programs with <a href="java_try_catch.asp">Java Exceptions</a>.</p>
