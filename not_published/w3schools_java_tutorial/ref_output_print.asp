...
<html lang="en-US">
<head>
<title>Java Output print() Method</title>
<meta charset="utf-8">
...
<h1>Java Output <span class="color_h1">print()</span> Method</h1>
...
<h3>Example</h3>
<p>Print some text to the console:</p>
<pre class="w3-white language-java"><code>System.out.print(&quot;Hello World! &quot;);
System.out.print(&quot;I will print on the same line.&quot;);</code></pre>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_output_print">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">print()</code> method prints text or values the console.</p>
<p><strong>Note:</strong> The <code class="w3-codespan">print()</code> method does not insert a new line at the end of the output. 
However, the <a href="ref_output_println.asp"><code class="w3-codespan">println()</code></a> 
method does.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>System.out.print(<em>argument</em>);</code></pre>
