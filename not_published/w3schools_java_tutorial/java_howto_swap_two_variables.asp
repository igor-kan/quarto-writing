...
<html lang="en-US">
<head>
<title>Java How To Swap Two Variables</title>
<meta charset="utf-8">
...
<h1>Java How To <span class="color_h1">Swap Two Variables</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_howto_add_two_numbers.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_howto_even_or_odd.asp">Next &#10095;</a>
</div>
<hr>

<h2>Swap Two Variables</h2>
<p>Exchange the values of two variables using a temporary variable:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>int a = 5;
int b = 10;
...
System.out.println("a = " + a + ", b = " + b);</code></pre>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_howto_swap_two_variables">Try it Yourself &raquo;</a></p>
</div>

<p><b>Explanation:</b> We save <code>a</code> in a temporary variable, move <code>b</code> into <code>a</code>, and then move the saved value into <code>b</code>.</p>
<hr>
