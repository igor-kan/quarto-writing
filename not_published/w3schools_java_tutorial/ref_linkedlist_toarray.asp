...
<html lang="en-US">
<head>
<title>Java LinkedList toArray() Method</title>
<meta charset="utf-8">
...
<h1>Java LinkedList <span class="color_h1">toArray()</span> Method</h1>
...
<h3>Example</h3>
<p>Get an array from an <code class="w3-codespan">LinkedList</code>:</p>
...
<p><a target="_blank" class="w3-btn " href="tryjava.asp?filename=demo_ref_linkedlist_toarray">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">toArray()</code> method returns an array containing all of the items in the list.</p>
<p>If no argument is passed then the type of the returned array will be <code class="w3-codespan">Object</code>. If an array is passed as an argument then this method will return an array with the same data type.</p>
<p>If the array in the argument is large enough to contain all of the list items then this method will return the argument itself after writing the list items into it.</p>
<hr>

<h2>Syntax</h2>
<p>One of the following:</p>
<pre class="language-java"><code>public Object[] toArray()</code></pre>
<pre class="language-java"><code>public T[] toArray(T[] <em>array</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>array</em></td>
    <td>Optional. An array which specifies the data type of the returned array and will be returned by the method if it has enough space for the items in the list. If the array is not large enough then the method returns a new array of the same data type.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">An array containing all of the elements of the <code class="w3-codespan">LinkedList</code> in order.</td>
</tr>
<tr>
 <th style="width:20%">Throws:</th>
 <td style="width:80%">
  <code class="w3-codespan">ArrayStoreException</code> - If the type of the array is not compatible with the type of the <code class="w3-codespan">LinkedList</code>.<br>
  <code class="w3-codespan">NullPointerException</code> - If the argument is <code class="w3-codespan">null</code>.
</td>
</tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Specify the return type of <code class="w3-codespan">toArray()</code>:</p>
<pre class="w3-white language-java"><code>import java.util.LinkedList;
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_linkedlist_toarray2">Try it Yourself &raquo;</a></p>
</div>
