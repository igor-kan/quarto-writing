...
<a class="w3-left w3-btn" href="java_challenges_booleans.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_conditions_else.asp">Next &#10095;</a>
</div>
<hr>

<h2>Java Conditions and If Statements</h2>

<p>Conditions and if statements let you control the flow of your program - deciding which code runs, and which code is skipped.</p>

<p>Think of it like real life: <em>If it rains, take an umbrella. Otherwise, do nothing.</em></p>

<p>Every <code class="w3-codespan">if</code> statement needs a condition that results in 
<code class="w3-codespan">true</code> or <code class="w3-codespan">false</code>.</p>
<p>This means <code class="w3-codespan">if</code> statements work hand-in-hand with 
<code class="w3-codespan"><a href="java_booleans.asp">boolean</a></code> values:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>boolean isRaining = true;
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_if_intro_boolean">Try it Yourself &raquo;</a>
</p>
</div>

<p>Most often, conditions are created using comparison operators, like the ones below:</p>
...
<ul>
  ...
  <li>Use <a href="java_conditions_else.asp"><code class="w3-codespan">else</code></a> to specify a block of code to be executed, if the same condition is false</li>
  <li>Use <a href="java_conditions_elseif.asp"><code class="w3-codespan">else if</code></a> to specify a new condition to test, if the first condition is false</li>
  <li>Use <a href="java_switch.asp"><code class="w3-codespan">switch</code></a> to specify many alternative blocks of code to be executed</li>
</ul>
...
<p>The <code class="w3-codespan">if</code> statement specifies a block of code to be executed if a condition is <code class="w3-codespan">true</code>:</p>

<div class="w3-example">
<h3>Syntax</h3>
<pre class="language-java w3-white"><code>if (condition) {
...
<p>The <em>condition</em> inside the <code class="w3-codespan">if</code> statement must result in a 
<code class="w3-codespan">boolean</code> value - it can be either a boolean expression 
(like <code class="w3-codespan">x &gt; y</code>) or a boolean variable (like <code class="w3-codespan">isLightOn</code>).</p>
<p>Also note that <code class="w3-codespan">if</code> is in lowercase letters. Uppercase letters (If or IF) will generate an error.</p>
</div>

<p>In the example below, we test two values to find out if 20 is greater than 18. If the condition is <code class="w3-codespan">true</code>, print some text:</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_if">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_if2">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>Comparison is also often used to check if two values are <em>equal</em>, using the <code class="w3-codespan">==</code> operator:</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_if_equal">Try it Yourself &raquo;</a>
</p>
</div>

<p>Here the condition <code class="w3-codespan">x == y</code> is true, because both <code class="w3-codespan">x</code> and <code class="w3-codespan">y</code> are 20, so the message "x is equal to y" is printed.</p>
...
<p>You can also test boolean variables directly in an <code class="w3-codespan">if</code> 
statement:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>boolean isLightOn = true;
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_if_boolean_var">Try it Yourself &raquo;</a>
</p>
</div>

<p><strong>Note:</strong> Writing <code class="w3-codespan">if (isLightOn)</code> is the same as writing <code class="w3-codespan">if (isLightOn == true)</code>, but shorter and easier to read.</p>

<p>Here is the same example with the value <code class="w3-codespan">false</code> to see that the program continues even when the code block does not run:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>boolean isLightOn = false;
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_if_boolean_false">Try it Yourself &raquo;</a>
</p>
</div>

<hr>

<h2>If Without Braces</h2>

<p>If an <code class="w3-codespan">if</code> statement has only one line of code, 
you can write it without curly braces <code class="w3-codespan">{ }</code>:</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_if_nobraces">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>Without braces, only the <strong>first line</strong> after the 
<code class="w3-codespan">if</code> belongs to it. 
Any other lines will run no matter what, which can lead to unexpected results:</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_if_nobraces_bug">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>To avoid mistakes, always use curly braces <code class="w3-codespan">{ }</code>. 
This makes it clear which lines belong to the <code class="w3-codespan">if</code> statement:</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_if_withbraces">Try it Yourself &raquo;</a>
</p>
</div>

<div class="ws-note ws-panel">
<p><strong>Tip:</strong> Always using braces <code class="w3-codespan">{ }</code> makes your code 
clearer, easier to read, and prevents subtle bugs.</p>
</div>

<hr>

<p>In the next chapters, you will also learn how to handle <code class="w3-codespan">else</code> (when the condition is false), 
<code class="w3-codespan">else if</code> (to test multiple conditions), and <code class="w3-codespan">switch</code> (to handle many possible values).</p>
<hr>
