...
<html lang="en-US">
<head>
<title>Java implements Keyword</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1"> implements</span> Keyword</h1>
<p>
...
<h3>Example</h3>
<p>An <code class="w3-codespan">interface</code> is an abstract "class" that is used to group related methods with "empty" bodies:</p>
...
class Pig <strong>implements</strong> Animal {
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_interface">Try it Yourself &raquo;</a>
</p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">implements</code> keyword is used to implement an <a href="ref_keyword_interface.asp"><code class="w3-codespan">interface</code></a>.</p>
<p>The <code class="w3-codespan">interface</code> keyword is used to declare a special type of class that only contains abstract methods.</p>
<p>To access the interface methods, the interface must be &quot;implemented&quot; 
(kinda like inherited) by another class with the <code class="w3-codespan">implements</code> 
keyword (instead of <code class="w3-codespan">extends</code>). The body of the 
interface method is provided by the &quot;implement&quot; class.</p>
...
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>interface FirstInterface {
...
class DemoClass implements<strong> FirstInterface, SecondInterface</strong> {
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_interface_multi">Try it Yourself &raquo;</a>
</p>
</div>
...
<h2>Related Pages</h2>
<p>Read more about interfaces in our <a href="java_interface.asp">Java Interface Tutorial</a>.</p>
