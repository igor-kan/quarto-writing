...
<html lang="en-US">
<head>
<title>Java String charAt() Method</title>
<meta charset="utf-8">
...
<h1>Java String <span class="color_h1">charAt()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Return the first character (0) of a string:</p>
<pre class="language-java w3-white"><code>String myStr = &quot;Hello&quot;;
char result = myStr.charAt(0);
System.out.println(result);</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_string_charat">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>The <code class="w3-codespan">charAt()</code> method returns the character at the specified index in a string.</p>
...
<pre class="language-java"><code>public char charAt(int <em>index</em>)
</code></pre>
...
<tr>
 <th style="width:21%">Returns:</th>
  <td>A <code class="w3-codespan">char</code> value at the specified index of this string.<br>The first char value is at index 0</td>
</tr>
<tr>
