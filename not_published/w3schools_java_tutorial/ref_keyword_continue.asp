...
<html lang="en-US">
<head>
<title>Java continue Keyword</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1"> continue</span> Keyword</h1>
<p>
...
<h3>Example</h3>
<p>Skip the iteration if the variable <code class="w3-codespan">i</code> is 4, but continue with the next iteration:</p>
<pre class="language-java w3-white"><code>for (int i = 0; i &lt; 10; i++) {
&nbsp; if (i == 4) {
&nbsp;&nbsp;&nbsp; continue;
&nbsp; }
...
<p>The <code class="w3-codespan">continue</code> keyword is used to end the current iteration in a <code class="w3-codespan">for</code> loop (or a <code class="w3-codespan">while</code> loop), and continues to the next iteration.</p>
<hr>
...
<pre class="language-java w3-white"><code>int i = 0;<br>while (i &lt; 10) {
&nbsp;&nbsp;if (i == 4) {
&nbsp;&nbsp;&nbsp; i++;
&nbsp;&nbsp;&nbsp;&nbsp;continue;
&nbsp;&nbsp;}
...
<p>Read more about for loops in our <a href="java_for_loop.asp">Java For Loops Tutorial</a>.</p>
<p>Read more about while loops in our <a href="java_while_loop.asp">Java While Loops Tutorial</a>.</p>
<p>Read more about break and continue in our <a href="java_break.asp">Java Break Tutorial</a>.</p>
<hr>
