...
<html lang="en-US">
<head>
<title>Java How To Count Character Frequency in a String</title>
<meta charset="utf-8">
...
<h1>Java How To - <span class="color_h1">Character Frequency in a String</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_howto_remove_whitespace.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_howto_sum_of_array_elements.asp">Next &#10095;</a>
</div>
<hr>

<h2>How To Count Character Frequency in a String</h2>
<p>Use a <code class="w3-codespan">HashMap</code> to count how many times each character appears:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>import java.util.HashMap;
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_howto_count_char_freq">Try it Yourself &raquo;</a></p>
</div>

<p><b>Explanation:</b>  
We loop through each character in the string and use a <code class="w3-codespan">HashMap</code> to keep track of counts.  
<br>- <code class="w3-codespan">freq.getOrDefault(c, 0)</code> means "get the current count of this character, or 0 if it hasn't been seen yet."  
<br>- We then add 1 and put the new value back in the map.  
<br>For the string <code class="w3-codespan">&quot;banana&quot;</code>, the result is <code class="w3-codespan">{a=3, b=1, n=2}</code>.</p>
<hr>
