...
<html lang="en-US">
<head>
<title>Java Strings - Special Characters</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1">Special Characters</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_strings_numbers.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_challenges_strings.asp">Next &#10095;</a>
</div>
<hr>

<h2>Strings - Special Characters</h2>

<p>Because strings must be written within quotes, Java will misunderstand this string, 
and generate an error:</p>

<div class="w3-example w3-pale-red">
<pre class="language-java w3-border-red w3-white"><code>String txt = &quot;We are the so-called &quot;Vikings&quot; from the north.&quot;;
</code></pre>
</div>
...
<h3>Example</h3>
<pre class="language-java w3-white"><code>String txt = &quot;We are the so-called \&quot;Vikings\&quot; from the north.&quot;;
</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_strings_double_quote">Try it Yourself &raquo;</a>
</p>
</div>
<p>The sequence <code class="w3-codespan">\'</code>&nbsp; inserts a single quote in a string:<p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>String txt = &quot;It\'s alright.&quot;;
</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_strings_single_quote">Try it Yourself &raquo;</a>
</p>
</div>
<p>The sequence <code class="w3-codespan">\\</code>&nbsp; inserts a single backslash in a string:<p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>String txt = &quot;The character \\ is called backslash.&quot;;
</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_strings_backslash">Try it Yourself &raquo;</a>
</p>
</div>

<p>Other common escape sequences that are valid in Java are:</p>
<table class="ws-table-all notranslate">
<tr>
  <th width="25%">Code</th>
  <th>Result</th>
...
<tr>
  <td>\n</td>
  <td>New Line</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryjava.asp?filename=demo_strings_newline">Try it &raquo;</a></td>
</tr>
<tr>
  <td>\t</td>
  <td>Tab</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryjava.asp?filename=demo_strings_tab">Try it &raquo;</a></td>
</tr>
<tr>
  <td>\b</td>
  <td>Backspace</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryjava.asp?filename=demo_strings_b">Try it &raquo;</a></td>
</tr>
<tr>
  <td>\r</td>
...
<p><strong>Note:</strong> Most of these escape codes are rarely used in modern programming. 
The most common ones are <code class="w3-codespan">\n</code> (new line), 
<code class="w3-codespan">\"</code> (double quote), and <code class="w3-codespan">\\</code> (backslash).</p>
</div>
...
<hr>
<div id="exercisecontainer" src="xrcise_strings_specchars.js"></div>
<hr>
