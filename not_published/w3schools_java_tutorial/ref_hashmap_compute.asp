...
<html lang="en-US">
<head>
<title>Java HashMap compute() Method</title>
<meta charset="utf-8">
...
<h1>Java HashMap <span class="color_h1">compute()</span> Method</h1>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_hashmap_compute">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">compute()</code> method changes the value of an entry or creates a new value if the entry does not exist. </p>
...
<h2>Syntax</h2>
<pre class="language-java"><code>public void compute(K <em>key</em>, BiFunction <em>function</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    ...
    <td>
      Required. A <code class="w3-codespan">BiFunction</code> object or lambda expression which computes the value of the entry.<br>
...
<tr>
 ...
 <td style="width:80%">The value computed by the function.</td>
</tr>
</table><hr>
