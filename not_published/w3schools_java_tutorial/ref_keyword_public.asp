...
<html lang="en-US">
<head>
<title>Java public Keyword</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1"> public</span> Keyword</h1>
<p>
...
<h3>Example</h3>
<p><code class="w3-codespan">Second</code> accesses a <code class="w3-codespan">public</code> <code class="w3-codespan">
Main</code> class with <code class="w3-codespan">public</code> attributes:</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava_multi.asp?filename=demo_mod_public2&multi=demo_mod_public2_multi">Try it Yourself &raquo;</a>
</p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">public</code> keyword is an access modifier used for classes, attributes, methods and constructors, making them accessible by any other class.</p>
<hr>
