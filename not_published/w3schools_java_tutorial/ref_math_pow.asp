...
<html lang="en-US">
<head>
<title>Java Math pow() Method</title>
<meta charset="utf-8">
...
<h1>Java Math <span class="color_h1">pow()</span> Method</h1>
...
<h3>Example</h3>
<p>Raise different numbers to different powers:</p>
<pre class="w3-white language-java"><code>System.out.println(Math.pow(2, 8));
System.out.println(Math.pow(3, 4));
System.out.println(Math.pow(9, 0.5));
System.out.println(Math.pow(8, -1));
System.out.println(Math.pow(10, -2));
</code></pre>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_math_pow">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">pow()</code> method raises a number to the power of another number.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public static double pow(double <em>base</em>, double <em>exponent</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>base</em></td>
    <td>Required. The base of the operation.</td>
  </tr>
  <tr>
    <td><em>exponent</em></td>
    <td>Required. The exponent of the operation.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">A <code class="w3-codespan">double</code> value representing the result of the base to the power of the exponent.</td>
</tr>
<tr>
