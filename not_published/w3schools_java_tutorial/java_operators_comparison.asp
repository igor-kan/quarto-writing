...
<h1>Java <span class="color_h1">Comparison Operators</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_operators_assign.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_operators_logical.asp">Next &#10095;</a>
</div>
<hr>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_oper_comparison">Try it Yourself &raquo;</a>
</p>
</div>
...
<td>Equal to</td>
<td>x == y</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryjava.asp?filename=demo_oper_compare1">Try it &raquo;</a></td>
</tr>
<tr>
<td>!=</td>
<td>Not equal</td>
<td>x != y</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryjava.asp?filename=demo_oper_compare2">Try it &raquo;</a></td>
</tr>
<tr>
<td>&gt;</td>
<td>Greater than</td>
<td>x &gt; y</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryjava.asp?filename=demo_oper_compare3">Try it &raquo;</a></td>
</tr>
<tr>
<td>&lt;</td>
<td>Less than</td>
<td>x &lt; y</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryjava.asp?filename=demo_oper_compare4">Try it &raquo;</a></td>
</tr>
  <tr>
<td>&gt;=</td>
<td>Greater than or equal to</td>
<td>x &gt;= y</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryjava.asp?filename=demo_oper_compare5">Try it &raquo;</a></td>
  </tr>
<tr>
<td>&lt;=</td>
<td>Less than or equal to</td>
<td>x &lt;= y</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryjava.asp?filename=demo_oper_compare6">Try it &raquo;</a></td>
</tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>int age = 18;

System.out.println(age &gt;= 18); // true, old enough to vote
System.out.println(age &lt; 18);  // false
</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_oper_compare_real">Try it Yourself &raquo;</a>
</p>
</div>
...
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>int passwordLength = 5;

System.out.println(passwordLength &gt;= 8); // false, too short
System.out.println(passwordLength &lt; 8);  // true, needs more characters
</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_oper_password_length">Try it Yourself &raquo;</a>
</p>
</div>
