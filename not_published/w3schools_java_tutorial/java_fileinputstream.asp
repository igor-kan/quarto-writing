...
<html lang="en-US">
<head>
<title>Java FileInputStream</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1">FileInputStream</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_io_streams.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_fileoutputstream.asp">Next &#10095;</a>
</div>
<hr>

<h2>FileInputStream</h2>
<p>So far, you have used the <code class="w3-codespan">Scanner</code> class to <a href="java_files_read.asp">read text files</a>. 
<code class="w3-codespan">Scanner</code> is very convenient for text because it can split input into lines, words, or numbers.  
However, sometimes you need more control. For example, when reading <strong>binary data</strong> (like images, audio, or PDFs), 
or when you need full control of raw bytes. In those cases, you use <code class="w3-codespan">FileInputStream</code>.</p>

<hr>

<h2>Read a Text File (Basic Example)</h2>
<p>This example uses <code class="w3-codespan">FileInputStream</code> to read a text file, one byte at a time, and print the result as characters:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>import java.io.FileInputStream;  // Import FileInputStream
...
<p><a target="_blank" class="w3-btn" href="showjava.asp?filename=demo_fileinputstream">Run Example &raquo;</a></p>
</div>

<p><strong>Explanation:</strong> This program opens <code class="w3-codespan">filename.txt</code>, 
reads it byte by byte, and prints the result as characters in the console.</p>

<hr>

<h2>Copy a Binary File (Real-World Example)</h2>
<p>The real strength of <code class="w3-codespan">FileInputStream</code> is that it can handle <strong>any file type</strong>, not just text.  
...
<p><strong>Note:</strong> The program also uses <a href="java_fileoutputstream.asp"><code class="w3-codespan">FileOutputStream</code></a>.  
While <code class="w3-codespan">FileInputStream</code> is used to <strong>read bytes</strong> from a file,  
<a href="java_fileoutputstream.asp"><code class="w3-codespan">FileOutputStream</code></a> is used to <strong>write bytes</strong> to a file.  
Together, they make it possible to copy any kind of file.</p>
<p>You will learn more about <a href="java_fileoutputstream.asp"><code class="w3-codespan">FileOutputStream</code> in the next chapter</a>.</p>
...
<ul>
  <li><a href="java_files_read.asp"><code class="w3-codespan">Scanner</code></a> - best for <strong>simple text</strong> and when you want to parse numbers or words easily.</li>
  <li><a href="java_bufferedreader.asp"><code class="w3-codespan">BufferedReader</code></a> - best for <strong>large text files</strong>, because it is faster and reads line by line.</li>
  <li><code class="w3-codespan">FileInputStream</code> - best for <strong>binary data</strong> (images, audio, PDFs) or when you need full control of raw bytes.</li>
</ul>
<hr>
