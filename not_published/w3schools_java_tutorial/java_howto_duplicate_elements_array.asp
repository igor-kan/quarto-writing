...
<html lang="en-US">
<head>
<title>Java How To Find Duplicate Elements in an Array</title>
<meta charset="utf-8">
...
<h1>Java How To <span class="color_h1">Find Duplicates in an Array</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_howto_remove_duplicates_array.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_howto_shuffle_array.asp">Next &#10095;</a>
</div>
<hr>

<h2>Find Duplicate Elements in an Array</h2>
<p>Print which elements appear more than once:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>int[] nums = {1, 2, 3, 2, 4, 5, 1};
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_howto_find_duplicate_array">Try it Yourself &raquo;</a></p>
</div>
<p><b>Explanation:</b> 
We go through the array one element at a time.  
<br>- The outer loop picks a number (like the first <code class="w3-codespan">1</code>).  
<br>- The inner loop compares it with all the numbers that come after it.  
<br>- If a match is found, we print it as a duplicate.  
<br>In this example, the program finds <code class="w3-codespan">2</code> twice and <code class="w3-codespan">1</code> twice, so it prints them as duplicates.</p>
<hr>
