...
<html lang="en-US">
<head>
<title>Java String isEmpty() Method</title>
<meta charset="utf-8">
...
<h1>Java String <span class="color_h1">isEmpty()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Find out if a string is empty or not:</p>
<pre class="language-java w3-white"><code>String myStr1 = &quot;Hello&quot;;
String myStr2 = &quot;&quot;;
System.out.println(myStr1.isEmpty());
System.out.println(myStr2.isEmpty());</code></pre>
<p>
  <a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_string_isempty">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>The <code class="w3-codespan">isEmpty()</code> method checks whether a string 
is empty or not.</p>
<p>This method returns true if the string is empty (<a href="ref_string_length.asp">length()</a> is 0), and false if not.</p>

<hr>

<h2>Syntax</h2>

<pre class="language-java"><code>public boolean isEmpty()
</code></pre>
...
<tr>
 <th style="width:21%">Returns:</th>
  <td>A <code class="w3-codespan">boolean</code> value:<br>
  <ul>
  <li><code class="w3-codespan">true</code> - The string is empty (length() is 0)</li>
  <li><code class="w3-codespan">false</code> - The string is not empty </li>
  </ul>
  </td>
</tr>
</table>
