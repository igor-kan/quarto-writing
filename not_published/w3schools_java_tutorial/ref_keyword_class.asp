...
<html lang="en-US">
<head>
<title>Java class Keyword</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1"> class</span> Keyword</h1>
<p>
...
<p>Every line of code that runs in Java must be inside a class. A class should always start with an uppercase first letter, and the name of the java file must match the class name.</p>
<p>A class is like an object constructor. See the example below to see how we can use it to create an object.</p>
<hr>

<h2>More Examples</h2>
<div class="w3-example">
<h3>Example</h3>
<p>Create an object of <code class="w3-codespan">Main</code> called "<code class="w3-codespan">myObj</code>&quot; and print the value of x:</p>
<pre class="language-java w3-white"><code>public class Main {
&nbsp; int x = 5;
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_class">Try it Yourself &raquo;</a>
</p>
</div>
<hr>

<h2>Related Pages</h2>
<p>Read more about classes and objects in our <a href="java_classes.asp">Java Classes/Objects Tutorial</a>.</p>
