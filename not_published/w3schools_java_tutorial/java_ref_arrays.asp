...
<html lang="en-US">
<head>
<title>Java Arrays Reference</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1">Arrays Class</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_ref_output.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_ref_arraylist.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">The Java <code class="w3-codespan">Arrays</code> class (found in <code class="w3-codespan">java.util</code>), has methods that allow you to manipulate arrays.</p>
<hr>


<h2>Arrays Methods</h2>
<p>A list of popular methods of the <code class="w3-codespan">Arrays</code> Class can be found in the table below:</p>
...
<table class="ws-table-all notranslate" style="margin:0">
  ...
  <tr>
    <td><a href="ref_arrays_compare.asp">compare()</a></td>
    <td>Compares two arrays</td>
  </tr>
  <tr>
    <td>copyOf()</td>
    <td>Creates a copy of an array with a new length</td>
  </tr>
  <tr>
    <td>deepEquals()</td>
    <td>Compares two multidimensional arrays to check whether they are deeply equal to each other</td>
  </tr>
  <tr>
    <td><a href="ref_arrays_equals.asp">equals()</a></td>
    <td>Checks if two arrays are equal</td>
  </tr>
  <tr>
    <td><a href="ref_arrays_fill.asp">fill()</a></td>
    <td>Fills an array with a specified value</td>
  </tr>
  <tr>
    <td>mismatch()</td>
    <td>Returns the index position of the first mismatch/conflict between two arrays</td>
  </tr>
  <tr>
    <td><a href="ref_arrays_sort.asp">sort()</a></td>
...
<table class="ws-table-all notranslate" style="margin:0">
  ...
  <tr>
    <td><a href="ref_arrays_length.asp">length</a></td>
    <td>Returns the length of an array</td>
  </tr>
</tbody>
</table>
</div>
<p>The <code class="w3-codespan">length</code> property is a built-in Java property, and does not belong to the Arrays class.</p>
