...
<html lang="en-US">
<head>
<title>Java Math signum() Method</title>
<meta charset="utf-8">
...
<h1>Java Math <span class="color_h1">signum()</span> Method</h1>
...
<h3>Example</h3>
<p>Return the sign of different numbers:</p>
<pre class="w3-white language-java"><code>System.out.println(Math.signum(12));
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_math_signum">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">signum()</code> method returns the sign of a number. A number's sign tells whether it is positive or negative. This method returns 1 for positive numbers, -1 for negative numbers and 0 for the number 0.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public static double signum(double <em>number</em>)</code></pre>
<pre class="language-java"><code>public static float signum(float <em>number</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>number</em></td>
    <td>Required. A number to find the sign of.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">A <code class="w3-codespan">double</code> or <code class="w3-codespan">float</code> value representing the sign of a number.<br>Returns 1 for positive numbers, -1 for negative numbers and 0 for the number 0.</td>
</tr>
<tr>
