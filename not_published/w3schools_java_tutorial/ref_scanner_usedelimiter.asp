...
<html lang="en-US">
<head>
<title>Java Scanner useDelimiter() Method</title>
<meta charset="utf-8">
...
<h1>Java Scanner <span class="color_h1">useDelimiter()</span> Method</h1>
...
<p>Read comma separated items:</p>
...
<p>The <code class="w3-codespan">useDelimiter()</code> method changes the delimiter used by the scanner. A delimiter is the sequence of characters which separates tokens in the data being scanned. It is described by a regular expression given by a string or a <code class="w3-codespan">Pattern</code> object.</p>
<p>Learn more about regular expressions in our <a href="java_regex.asp">Java RegEx tutorial</a>.</p>
<div class="w3-panel ws-note">
<p><strong>What is a token?</strong> </p>
  <p>A token is a sequence of characters separated from other tokens by delimiters. The default delimiter is a block of whitespace characters but it can be changed with this method.</p>
</div>
<hr>

<h2>Syntax</h2>
<p>One of the following:</p>
<pre class="language-java"><code>public Scanner useDelimiter(Pattern <em>pattern</em>)</code></pre>
<pre class="language-java"><code>public Scanner useDelimiter(String <em>pattern</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>pattern</em></td>
    <td>Required. A string or <code class="w3-codespan">Pattern</code> object. A regular expression defining which sequences of characters are considered delimiters.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">A reference to the <code class="w3-codespan">Scanner</code> object that this method belongs to, which allows for chaining configuration methods. An example of chaining is <code class="language-java">myObj.useDelimiter(",").setRadix(16);</code>.</td>
</tr>
</table>
