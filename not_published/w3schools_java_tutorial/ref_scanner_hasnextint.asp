...
<html lang="en-US">
<head>
<title>Java Scanner hasNextInt() Method</title>
<meta charset="utf-8">
...
<h1>Java Scanner <span class="color_h1">hasNextInt()</span> Method</h1>
...
<p>The <code class="w3-codespan">hasNextInt()</code> method returns <em>true</em> if the next token represents a number that can be stored by the <code class="w3-codespan">int</code> data type, which is any whole number between -2,147,483,648 and 2,147,483,647.</p>
...
<pre class="language-java"><code>public boolean hasNextInt()</code></pre>
<pre class="language-java"><code>public boolean hasNextInt(int <em>radix</em>)</code></pre>
...
<tr>
 ...
 <td style="width:80%">A <code class="w3-codespan">boolean</code> value which is true if the next token represents an <code class="w3-codespan">int</code> value.</td>
</tr>
<tr>
