...
<h1>Java <span class="color_h1">super</span></h1>
...
<h2>Java super Keyword</h2>
<p>In Java, the <code class="w3-codespan">super</code> keyword is used to refer to the <strong>parent class</strong> of a subclass.</p>
<p>The most common use of the <code class="w3-codespan">super</code> keyword is to eliminate the confusion between superclasses and subclasses that have methods with the same name.</p>
<p>It can be used in two main ways:</p>
<ul>
...
<h2>Access Parent Methods</h2>
<p>If a subclass has a method with the same name as one in its parent class, you can use <code class="w3-codespan">super</code> 
to call the parent version:</p>
...
<code>The animal makes a sound<br>The dog says: bow wow</code>
</div>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_super_methods">Try it Yourself &raquo;</a></p>
</div>

<div class="ws-note ws-panel">
  <p><strong>Note:</strong> Use <code class="w3-codespan">super</code> when you want to call a method from the parent class that has been overridden in the child class.</p>
</div>
<hr>

<h2>Access Parent Attributes</h2>
<p>You can also use <code class="w3-codespan">super</code> to access an attribute from the parent class if they have an attribute with the same name:</p>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_super_attribute">Try it Yourself &raquo;</a></p>
</div>
...
<h2>Call Parent Constructor</h2>
<p>Use <code class="w3-codespan">super()</code> to call the <a href="java_constructors.asp">constructor</a> of the parent class. This is especially useful for reusing initialization code.</p>
...
<p>Output:</p>
<div class="w3-black w3-padding">
<code>Animal is created<br>Dog is created</code>
</div>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_super_constructor">Try it Yourself &raquo;</a></p>
</div>

<div class="ws-note ws-panel">
  <p><strong>Note:</strong> The call to <code class="w3-codespan">super()</code> must be the <strong>first statement</strong> in the subclass constructor.</p>
</div>
<hr>
