...
<a class="w3-left w3-btn" href="java_debugging.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_exceptions_multiple.asp">Next &#10095;</a>
</div>
<hr>

<h2>Java Exceptions</h2>
<p>As mentioned in the <a href="java_errors.asp">Errors chapter</a>, different types of errors can occur while running a program - such as coding mistakes, invalid input, or unexpected situations.</p>
...
<p>Exception handling lets you catch and handle errors during runtime - so your program doesn't crash.</p>
<p>It uses different keywords:</p>
...
<p><strong>Note:</strong> <code class="w3-codespan">ArrayIndexOutOfBoundsException</code> occurs when you try to access an index number that does not exist.</p>
<a target="_blank" class="w3-btn w3-margin-bottom " href="tryjava.asp?filename=demo_try_error">Try it Yourself &raquo;</a>
</div>

<p>If an error occurs, we can use <code class="w3-codespan">try...catch</code> to catch the error and execute some code to handle it:</p>
<div class="w3-example">
<h3>Example</h3>
...
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="tryjava.asp?filename=demo_try_catch">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="tryjava.asp?filename=demo_try_catch_finally">Try it Yourself &raquo;</a>
</div>
<!--
<hr>
...
<p>The <code class="w3-codespan">throw</code> statement is used together with an <strong>exception type</strong>. There are many exception types available in Java: <code class="w3-codespan">ArithmeticException</code>, 
<code class="w3-codespan">FileNotFoundException</code>, <code class="w3-codespan">ArrayIndexOutOfBoundsException</code>, <code class="w3-codespan">SecurityException</code>, etc:</p>
<div class="w3-example">
<h3>Example</h3>
...
<p>The output will be:</p>
<div style="white-space: nowrap;;overflow-x:scroll;width:100%" class="w3-padding notranslate w3-black">
<code>
...
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="tryjava.asp?filename=demo_throw">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="tryjava.asp?filename=demo_throw2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Errors and Exception Types</h2>

<p>The table below shows some of the most common errors and exceptions in Java, with a short description of each:</p>
<div class="w3-responsive">
<table class="ws-table-all notranslate" style="margin:0">
  <tbody><tr>
    <th style="width:30%">Error/Exception</th>
    <th style="width:70%">Description</th>
  </tr>
  <tr>
    <td>ArithmeticError</td>
    <td>Occurs when a numeric calculation goes wrong</td>
  </tr>
  <tr>
    <td>ArrayIndexOutOfBoundsException</td>
    <td>Occurs when trying to access an index number that does not exist in an array</td>
  </tr>
  <tr>
    <td>ClassNotFoundException</td>
    <td>Occurs when trying to access a class that does not exist</td>
  </tr>
  <tr>
    <td>FileNotFoundException</td>
    <td>Occurs when a file cannot be accessed</td>
  </tr>
  <tr>
    <td>InputMismatchException</td>
    <td>Occurs when entering wrong input (e.g. text in a numerical input)</td>
  </tr>
  <tr>
    <td>IOException</td>
    <td>Occurs when an input or output operation fails</td>
  </tr>
  <tr>
    <td>NullPointerException</td>
    <td>Occurs when trying to access an object referece that is <code class="w3-codespan">null</code></td>
  </tr>
  <tr>
    <td>NumberFormatException</td>
    <td>Occurs when it is not possible to convert a specified string to a numeric type</td>
  </tr>
  <tr>
    <td>StringIndexOutOfBoundsException</td>
    <td>Occurs when trying to access a character in a String that does not exist</td>
  </tr>
</tbody>
</table>
</div>

<p><strong>Tip:</strong> For a list of all errors and exception types, go to our <a href="java_ref_errors.asp">Java Errors and Exception Types Reference</a>.</p>
<hr>
<div id="exercisecontainer" src="xrcise_try_catch.js"></div>
<hr>
