...
<html lang="en-US">
<head>
<title>Java Math toDegrees() Method</title>
<meta charset="utf-8">
...
<h1>Java Math <span class="color_h1">toDegrees()</span> Method</h1>
...
<h3>Example</h3>
<p>Convert radians to degrees for different angles:</p>
<pre class="w3-white language-java"><code>System.out.println(Math.toDegrees(1));
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_math_todegrees">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">toDegrees()</code> method converts an angle from radians to degrees.</p>
<p><strong>Tip:</strong> To convert from degrees to radians, look at the <a href="/java/ref_math_toradians.asp">toRadians()</a> method.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public static double toDegrees(double <em>angle</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>angle</em></td>
    <td>Required. An angle in radians.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">A <code class="w3-codespan">double</code> value representing an angle in degrees.</td>
</tr>
<tr>
