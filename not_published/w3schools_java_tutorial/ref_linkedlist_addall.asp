...
<html lang="en-US">
<head>
<title>Java LinkedList add() Method</title>
<meta charset="utf-8">
...
<h1>Java LinkedList <span class="color_h1">add()</span> Method</h1>
...
<h3>Example</h3>
<p>Add items from one list into another:</p>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_linkedlist_addall">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">addAll()</code> method adds all of the items from a collection to the list.</p>
<p>If an index is provided then the new items will be placed at the specified index, pushing all of the following elements in the list ahead.</p>
<p>If an index is not provided then the new items will be placed at the end of the list.</p>
<hr>

<h2>Syntax</h2>
<p>One of the following:</p>
<pre class="language-java"><code>public boolean addAll(Collection&lt;T&gt; <em>items</em>)</code></pre>
<pre class="language-java"><code>public boolean addAll(int <em>index</em>, Collection&lt;T&gt; <em>items</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>index</em></td>
    <td>Optional. The position in the list at which to add the items.</td>
  </tr>
  <tr>
    <td><em>items</em></td>
    <td>Required. A collection containing items to be added to the list.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%"><code class="w3-codespan">true</code> if the list changed and <code class="w3-codespan">false</code> otherwise.</td>
</tr>
<tr>
 <th style="width:20%">Throws:</th>
 <td style="width:80%">
  <code class="w3-codespan">IndexOutOfBoundsException</code> - If the index is less than zero or greater than the size of the list.<br>
  <code class="w3-codespan">NullPointerException</code> - If the collection is null.
 </td>
</tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Add items at a specified position in the list:</p>
<pre class="w3-white language-java"><code>import java.util.LinkedList;
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_linkedlist_addall2">Try it Yourself &raquo;</a></p>
</div>
