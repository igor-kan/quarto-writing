...
<html lang="en-US">
<head>
<title>Java Output Numbers / Print Numbers</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1">Output Numbers</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_output.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_challenges_output.asp">Next &#10095;</a>
</div>
<hr>

<h2>Print Numbers</h2>

<p>You can also use the <code class="w3-codespan">println()</code> method to 
print numbers.</p>
<p>However, unlike text, we don't put numbers inside double 
quotes:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>System.out.println(3);
System.out.println(358);
System.out.println(50000);</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_output_numbers1">Try it Yourself &raquo;</a>
</div>

<p>You can also perform mathematical calculations inside the <code class="w3-codespan">println()</code> method:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>System.out.println(3 + 3);</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_output_numbers">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>System.out.println(2 * 5);</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_output_numbers2">Try it Yourself &raquo;</a>
</div>
