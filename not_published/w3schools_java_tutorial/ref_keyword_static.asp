...
<html lang="en-US">
<head>
<title>Java static Keyword</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1"> static</span> Keyword</h1>
<p>
...
<h3>Example</h3>
<p>A <code class="w3-codespan">static</code> method can be 
accessed without creating an object of the class first:</p>
...
<p>The <code class="w3-codespan">static</code> keyword is a non-access modifier used for methods and attributes. Static methods/attributes can be accessed without creating an object of a class.</p>
<hr>
