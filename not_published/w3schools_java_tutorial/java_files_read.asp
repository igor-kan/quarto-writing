...
<h1>Java <span class="color_h1">Read Files</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_files_write.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_files_delete.asp">Next &#10095;</a>
</div>
<hr>

<h2>Read a File</h2>
<p>In the previous chapters, you learned how to create and write to a file.</p>
<p>In the 
following example, we use the <code class="w3-codespan">Scanner</code> class to 
<strong>read the contents</strong> of the text file we created in the previous chapter:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="showjava.asp?filename=demo_files_read">Run Example &raquo;</a>
</div>
<p><strong>Explanation:</strong> This program opens the file named <code class="w3-codespan">filename.txt</code> 
and reads it line by line using a <code class="w3-codespan">Scanner</code>.  
Each line is printed to the console.  
If the file cannot be found, the program will print <code class="w3-codespan">"An error occurred."</code> instead.</p>
<hr>

<h2>Get File Information</h2>
<p>To get more information about a file, use any of the <code class="w3-codespan">File</code> methods:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>import java.io.File;&nbsp; // Import the File class
...
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="showjava.asp?filename=demo_files_get">Run Example &raquo;</a>
</div>
...
<h2>Other Ways to Read Files</h2>
<p>There are several classes you can use to read files in Java:</p>
<ul>
  <li><code class="w3-codespan">Scanner</code> - best for <strong>simple text</strong> and when you want to parse numbers or words easily.</li>
  <li><code class="w3-codespan">BufferedReader</code> - best for <strong>large text files</strong>, because it is faster and reads line by line.</li>
...
<p>You will learn more about 
  <a href="java_fileinputstream.asp"><code class="w3-codespan">FileInputStream</code></a> and <a href="java_bufferedreader.asp"><code class="w3-codespan">BufferedReader</code></a> 
   in later chapters.
</p>
...
<p><strong>Tip:</strong> For a list of all Scanner methods, go to our <a href="java_ref_scanner.asp">Java Scanner Reference</a>.</p>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_files_read.js"></div>
<hr>
