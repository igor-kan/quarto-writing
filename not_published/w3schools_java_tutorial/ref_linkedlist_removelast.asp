...
<html lang="en-US">
<head>
<title>Java LinkedList removeLast() Method</title>
<meta charset="utf-8">
...
<h1>Java LinkedList <span class="color_h1">removeLast()</span> Method</h1>
...
<h3>Example</h3>
<p>Remove the last item in the list:</p>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_linkedlist_removelast">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">removeLast()</code> method removes the last item 
in a list.</p>
<p><strong>Tip:</strong> Use the <a href="ref_linkedlist_removefirst.asp"><code class="w3-codespan">removeFirst()</code></a> method to remove the first item 
in a list.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public T removeLast()</code></pre>
...
<tr>
 ...
 <td style="width:80%">The removed element (the last item in the list)</td>
</tr>
<tr>
