...
<html lang="en-US">
<head>
<title>Java Math atan2() Method</title>
<meta charset="utf-8">
...
<h1>Java Math <span class="color_h1">atan2()</span> Method</h1>
...
<h3>Example</h3>
<p>Return the angle in radians of the polar coordinates given rectangular coordinates:</p>
<pre class="w3-white language-java"><code>System.out.println(Math.atan2(0.5, 0.5));
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_math_atan2">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>

<p>The <code class="w3-codespan">atan2()</code> method returns the angle theta in radians from the conversion of rectangular coordinates (x, y) to polar coordinates (r, theta).</p>
<p>This is the same as calling <code class="w3-codespan">atan(y/x)</code> except that it takes into account negative values of x so that it can return angles outside of the range -PI/2 to PI/2.</p>
<div class="w3-panel ws-note">
<p><strong>Note:</strong> 
In the <code class="w3-codespan">atan2()</code> method the y coordinate goes first, then the x coordinate. This is because it is doing the division y / x.</p>
</div>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public static double atan2(double <em>y</em>, double <em>x</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>y</em></td>
    <td>Required. The y coordinate of the point to find the angle of.</td>
  </tr>
  <tr>
    <td><em>x</em></td>
    <td>Required. The x coordinate of the point to find the angle of.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">A <code class="w3-codespan">double</code> value representing the angle in radians that a point (x, y) makes around the origin (0, 0).</td>
</tr>
<tr>
