...
<html lang="en-US">
<head>
<title>Java Booleans Real Life Example</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1">Boolean Examples</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_booleans.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_challenges_booleans.asp">Next &#10095;</a>
</div>
<hr>
...
<strong>equal to</strong> the voting age limit, which is set to <code class="w3-codespan">18</code>:</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_booleans_age">Try it Yourself &raquo;</a>
</p>
</div>

<p>An even better approach would be to wrap the code above in an <code class="w3-codespan">if...else</code> statement, so we can perform 
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_booleans_age2">Try it Yourself &raquo;</a>
</p>
</div>
