...
<html lang="en-US">
<head>
<title>Java Scanner radix() Method</title>
<meta charset="utf-8">
...
<h1>Java Scanner <span class="color_h1">radix()</span> Method</h1>
...
<h3>Example</h3>
<p>Show the radix that is currently being used by the scanner:</p>
...
<p>The <code class="w3-codespan">radix()</code> method returns a number indicating the radix that the scanner uses to interpret whole numbers. The radix specifies how many different symbols can be used to represent each digit in a number. For example, a radix of 16 would allow the symbols 0 to 9 and A to F to be used as digits.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public int radix()</code></pre>

<h2>Technical Details</h2>
<table class="ws-table-all">
<tr>
 <th style="width:20%">Returns:</th>
 <td style="width:80%">An <code class="w3-codespan">int</code> value representing the radix used by the scanner.</td>
</tr>
</table>
