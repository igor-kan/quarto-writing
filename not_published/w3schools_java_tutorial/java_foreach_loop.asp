...
<h1>Java <span class="color_h1">For Each Loop</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_for_loop_nested.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_for_loop_reallife.asp">Next &#10095;</a>
</div>
<hr>

<h2>The for-each Loop</h2>
<p>There is also a "<b>for-each</b>" loop, which is used exclusively to loop through elements in an <a href="java_arrays.asp"><strong>array</strong></a> (or other <a href="java_data_structures.asp">data structures</a>):</p>

<div class="w3-example">
<h3>Syntax</h3>
<pre class="language-java w3-white"><code>for (<em>type</em> <em>variableName</em> : <em>arrayName</em>) {
&nbsp; <i>// code block to be executed</i>
}
</code></pre>
</div>

<p>The <strong>for-each</strong> loop is simpler and more readable than a regular <code class="w3-codespan">for</code> loop, since you don't need a counter (like <code class="w3-codespan">i &lt; array.length</code>).</p>
<p>The following example prints all elements in the <strong>cars</strong> array:</p>
<div class="w3-example">
<h3>Example</h3>
...
<p>Here is a similar example with numbers. We create an array of integers and use a <b>for-each</b> loop to print each value:</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_array_for_each2">Try it Yourself &raquo;</a>
</p>
</div>

<div class="ws-note w3-panel">
<p><strong>Note:</strong> Don't worry if you don't fully understand arrays yet. You will learn more about them in the <a href="java_arrays.asp">Java Arrays chapter</a>.</p>
</div>
...
<hr>
<div id="exercisecontainer" src="xrcise_foreach_loop.js"></div>
<hr>
