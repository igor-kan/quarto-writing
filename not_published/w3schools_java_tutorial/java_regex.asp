...
<h1>Java <span class="color_h1">Regular Expressions</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_annotations.asp">&#10094; Previous</a>
...
<p>Regular expressions can be used to perform all types of <strong>text search</strong> and <strong>text replace</strong>
operations.</p>
<p>Java does not have a built-in Regular Expression class, but we can import the <code class="w3-codespan">java.util.regex</code> 
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_regex">Try it Yourself &raquo;</a>
</p>
</div>
<h3>Example Explained</h3>
<p>In this example, The word "w3schools" is being searched for in a sentence.</p>
<p>First, the pattern is created using the <code class="w3-codespan">Pattern.compile()</code> method. The first parameter
...
<p>The <code class="w3-codespan">matcher()</code> method is used to search for the pattern in a string. It returns a Matcher
object which contains information about the search that was performed.</p>
<p>The <code class="w3-codespan">find()</code> method returns true if the pattern was found in the string and false if it was not
found.</p>
<hr>
...
<p>Flags in the <code class="w3-codespan">compile()</code> method change how the search is performed. Here are a few of
them:</p>
<ul>
...
<p>The first parameter of the <code class="w3-codespan">Pattern.compile()</code> method is the pattern. It describes what
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td>^</td>
    <td>Finds a match at the beginning of a string as in: ^Hello</td>
  </tr>
  <tr>
    <td>$</td>
