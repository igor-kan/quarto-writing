...
<h1>Java <span class="color_h1"> byte</span> Keyword</h1>
<p>
...
<p>The <code class="w3-codespan">byte</code> keyword is a data type that can store whole numbers from -128 to 127.</p>
<hr>
