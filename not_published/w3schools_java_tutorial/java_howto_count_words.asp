...
<html lang="en-US">
<head>
<title>Java How To Count Number of Words</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1">How To Count Words</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_howto_random_number.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_howto_count_vowels_string.asp">Next &#10095;</a>
</div>
<hr>

<h2>Count Number of Words in a String</h2>
<p>You can easily count the number of words in a string with the following example:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>String words = "One Two Three Four";
int countWords = words.split("\\s").length;
System.out.println(countWords);</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryjava.asp?filename=demo_howto_count_words">Try it Yourself &raquo;</a>
</div>
<p><b>Explanation:</b> The method <code class="w3-codespan">split(&quot;\\s&quot;)</code> breaks the string into an array wherever it finds a space.  
<br>In the example, the string <code class="w3-codespan">&quot;One Two Three Four&quot;</code> is split into 4 words.  
<br>The <code class="w3-codespan">length</code> of that array tells us the total number of words.</p>
<hr>
<h2>Related Pages</h2>
