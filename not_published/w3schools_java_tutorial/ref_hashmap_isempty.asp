...
<html lang="en-US">
<head>
<title>Java HashMap isEmpty() Method</title>
<meta charset="utf-8">
...
<h1>Java HashMap <span class="color_h1">isEmpty()</span> Method</h1>
...
<p><a target="_blank" class="w3-btn w3-margin-bottom" href="tryjava.asp?filename=demo_ref_hashmap_isempty">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">isEmpty()</code> method returns <code class="w3-codespan">true</code> if the map has no entries and <code class="w3-codespan">false</code> otherwise.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public boolean isEmpty()</code></pre>

<h2>Technical Details</h2>
<table class="ws-table-all">
<tr>
 <th style="width:20%">Returns:</th>
 <td style="width:80%"><code class="w3-codespan">true</code> if the map has no entries and <code class="w3-codespan">false</code> otherwise.</td>
</tr>
</table>
<hr>
