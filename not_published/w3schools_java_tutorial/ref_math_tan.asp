...
<html lang="en-US">
<head>
<title>Java Math tan() Method</title>
<meta charset="utf-8">
...
<h1>Java Math <span class="color_h1">tan()</span> Method</h1>
...
<pre class="w3-white language-java"><code>System.out.println(Math.tan(0.5));
System.out.println(Math.tan(-0.5));
System.out.println(Math.tan(1));
System.out.println(Math.tan(-3));
System.out.println(Math.tan(Math.PI/4));
</code></pre>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_math_tan">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">tan()</code> method returns the tangent of an angle.</p>
...
<h2>Syntax</h2>
<pre class="language-java"><code>public static double tan(double <em>angle</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>angle</em></td>
    <td>Required. An angle in radians to find the tangent of.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">A <code class="w3-codespan">double</code> value representing the tangent of an angle.</td>
</tr>
<tr>
