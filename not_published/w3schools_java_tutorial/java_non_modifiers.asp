...
<h1>Java <span class="color_h1">Non-Access Modifiers</span></h1>
...
<p>Non-access modifiers do not control visibility (like <code class="w3-codespan">public</code> or <code class="w3-codespan">private</code>), but instead add <strong>other features</strong> to classes, methods, and attributes.</p>

<p>The most commonly used non-access modifiers are <code class="w3-codespan">final</code>, <code class="w3-codespan">static</code>, and <code class="w3-codespan">abstract</code>.</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_mod_final2">Try it Yourself &raquo;</a>
</p>
</div>
<hr>
...
<h2>Static</h2>
<p>
A <code class="w3-codespan">static</code> method belongs to the class, not to any specific object. 
...
<h3>Example</h3>
<p>
A simple example showing how to call a <code class="w3-codespan">static</code> method directly:
</p>

<pre class="language-java w3-white" data-line="3,9,10"><code>public class Main {
&nbsp; // Static method
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_class_method_static">Try it Yourself &raquo;</a>
</p>
</div>
<div class="ws-note ws-panel">
<p><b>Note:</b> A <code class="w3-codespan">static</code> method belongs to the class itself. 
You can call it without creating an object, but it cannot use variables or methods that belong to an object.</p>
</div>
...
<div class="w3-example" style="padding-top:18px;">
<pre class="language-java w3-white" data-tab-header="Main.java" data-line="2,5,11"><code>// abstract class<br>abstract class Main {
...
<pre class="language-java w3-white" data-tab-header="Second.java"><code>// Code from filename: Second.java
class Second {
&nbsp; public static void main(String[] args) {
...
<p>
<a target="_blank" class="w3-btn" href="tryjava_multi.asp?filename=demo_mod_abstract_o&multi=demo_mod_abstract_o_multi">Try it Yourself &raquo;</a>
</p>
</div>
<hr>

<h2>Non-Access Modifiers List</h2>
...
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryjava.asp?filename=demo_inherit_final">Try it &raquo;</a></td>
</tr>
<tr>
...
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryjava_multi.asp?filename=demo_mod_abstract&multi=demo_mod_abstract_multi">Try it &raquo;</a></td>
</tr>
</tbody>
</table>
</div>
...
<tr>
  ...
  <td>Attributes and methods belong to the class, not to objects. 
      This means all objects share the same <code class="w3-codespan">static</code> attribute, 
      and <code class="w3-codespan">static</code> methods can be called without creating objects.</td>
</tr><tr>
<td><code class="w3-codespan">abstract</code></td>
<td>Can only be used in an abstract class, and can only be used on methods. The method does not have a body, for example 
<code class="w3-codespan">abstract void run();</code>. The body is provided by the 
