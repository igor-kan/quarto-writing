...
<html lang="en-US">
<head>
<title>Java double Keyword</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1"> double</span> Keyword</h1>
<p>
...
<p>The <code class="w3-codespan">double</code> keyword is a data type that can store fractional numbers from 1.7e&#8722;308 to 1.7e+308.</p>
<p>Note that you should end the value with a "d":</p>
<hr>
