...
<html lang="en-US">
<head>
<title>Java LinkedList iterator() Method</title>
<meta charset="utf-8">
...
<h1>Java LinkedList <span class="color_h1">iterator()</span> Method</h1>
...
<h3>Example</h3>
<p>Use an iterator to loop through a list:</p>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_linkedlist_iterator">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">iterator()</code> method returns an <code class="w3-codespan">Iterator</code> for the list.</p>
<p>To learn how to use iterators, see our <a href="java_iterator.asp">Java Iterator tutorial</a>.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public Iterator iterator()</code></pre>

<h2>Technical Details</h2>
<table class="ws-table-all">
<tr>
 <th style="width:20%">Returns:</th>
 <td style="width:80%">An <code class="w3-codespan">Iterator</code> object.</td>
</tr>
</table>
<hr>
