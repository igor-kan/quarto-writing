...
<html lang="en-US">
<head>
<title>Java Math log10() Method</title>
<meta charset="utf-8">
...
<h1>Java Math <span class="color_h1">log10()</span> Method</h1>
...
<h3>Example</h3>
<p>Return the base 10 logarithm for different numbers:</p>
<pre class="w3-white language-java"><code>System.out.println(Math.log10(120));
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_math_log10">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">log10()</code> method returns the base 10 logarithm of a number.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public static double log10(double <em>number</em>)</code></pre>
...
<tr>
 ...
 <td style="width:80%">A <code class="w3-codespan">double</code> value representing the base 10 logarithm of a number.</td>
</tr>
<tr>
