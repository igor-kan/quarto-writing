...
<h1>Java <span class="color_h1">Errors</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_date.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_debugging.asp">Next &#10095;</a>
</div>
<hr>

<h2>Java Errors</h2>
<p>Even experienced Java developers make mistakes. The key is learning how to <strong>spot</strong> and <strong>fix</strong> them!</p>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    ...
    <td>Detected by the compiler. Prevents code from running.</td>
  </tr>
  <tr>
    <td>Runtime Error</td>
    <td>Occurs while the program is running. Often causes crashes.</td>
  </tr>
  <tr>
    <td>Logical Error</td>
    <td>Code runs but gives incorrect results. Hardest to find.</td>
  </tr>
</table>
<hr>

<h2>Common Compile-Time Errors</h2>
<p>Compile-time errors occur when the program cannot compile due to syntax or type issues.</p>
<p>Here are some examples:</p>
<p><strong>1) Missing Semicolon</strong></p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white w3-border-red"><code>int x = 5
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_errors_semicolon">Try it Yourself &raquo;</a></p>
</div>

<div class="ws-note ws-panel">
<p><strong>Tip:</strong> Java requires a semicolon at the end of every statement (<code class="w3-codespan">int x = 5<strong>;</strong></code>).</p>
</div>

<p><strong>2) Undeclared Variables</strong></p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white  w3-border-red"><code>System.out.println(myVar);
</code></pre>
<p>Result:</p>
<div class="w3-black w3-padding">
<code>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_errors_undeclared">Try it Yourself &raquo;</a></p>
</div>

<div class="ws-note ws-panel">
<p><strong>Tip:</strong> You must declare a variable before using it (<code class="w3-codespan">int myVar = 50;</code>).</p>
</div>

<p><strong>3) Mismatched Types</strong></p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white w3-border-red"><code>int x = "Hello";
</code></pre>
<p>Result:</p>
<div class="w3-black w3-padding">
<code>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_errors_mismatch">Try it Yourself &raquo;</a></p>
</div>

<div class="ws-note ws-panel">
<p><strong>Tip:</strong> Make sure the value matches the variable type (<code class="w3-codespan">String x = "Hello";</code>).</p>
</div>
...
<p><strong>Runtime errors</strong> occur when the program compiles but crashes or behaves unexpectedly.</p>
<p>Here are some examples:</p>

<p><strong>1) Division by Zero</strong></p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white w3-border-red"><code>int x = 10;
int y = 0;
int result = x / y;
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_errors_zero">Try it Yourself &raquo;</a></p>
</div>

<p><strong>2) Array Index Out of Bounds</strong></p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white w3-border-red"><code>int[] numbers = {1, 2, 3};
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_errors_index">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Logical Errors</h2>
<p><strong>Logical errors</strong> happen when the code runs, but the result is not what you thought:</p>
...
int y = 2;
int sum = x - y;
System.out.println(&quot;x + y = &quot; + sum);</code></pre>
<p>Result:</p>
<div class="w3-black w3-padding">
<code>
  x + y = 8
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_errors_logical">Try it Yourself &raquo;</a></p>
</div>

<p><strong>Expected Result:</strong> <code class="w3-codespan">12</code></p>
<p>
<strong>Logical Error:</strong> The code mistakenly subtracts instead of adds.</p>

<div class="ws-note ws-panel">
<p><strong>Tip:</strong> Test your program with different inputs to catch logic flaws (try using <code class="w3-codespan">x + y</code> instead). 
This is part of <a href="java_debugging.asp">debugging</a>, which you will learn more about in the next chapter.</p>
</div>
<hr>
...
<ul>
  ...
  <li>Read the error message carefully. What line does it mention?</li>
  <li>Check for missing semicolons or braces</li>
  <li>Look for typos in variable or method names</li>
</ul>

<p>In the next chapter, you will learn how to <strong>debug your code</strong> - how to find and fix bugs/errors in your program.</p>
