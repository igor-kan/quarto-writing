...
<html lang="en-US">
<head>
<title>Java LinkedList contains() Method</title>
<meta charset="utf-8">
...
<h1>Java LinkedList <span class="color_h1">contains()</span> Method</h1>
...
<h3>Example</h3>
<p>Check if an item exists in a list:</p>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_linkedlist_contains">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">contains()</code> method returns <code class="w3-codespan">true</code> if an item exists in a list and <code class="w3-codespan">false</code> otherwise.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public boolean contains(Object <em>item</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>item</em></td>
    <td>Required. The item being tested</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%"><code class="w3-codespan">true</code> if the object exists in the list, <code class="w3-codespan">false</code> otherwise.</td>
</tr>
</table>
<hr>
