...
<h1>Java <span class="color_h1">Annotations</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_generics.asp">&#10094; Previous</a>
...
<p>Annotations are <strong>special notes</strong> you add to your Java code.  
They start with the <code class="w3-codespan">@</code> symbol.</p>

<p>They <strong>don't change how your program runs</strong>, but they give <strong>extra information</strong> to the compiler or tools.</p>
<hr>

<h2>Built-in Annotations</h2>

<p>Java includes several built-in annotations. Here are some of the most commonly used:</p>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><code class="w3-codespan">@Override</code></td>
    <td>Indicates that a method overrides a method in a superclass</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">@Deprecated</code></td>
    <td>Marks a method or class as outdated or discouraged from use</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">@SuppressWarnings</code></td>
    <td>Tells the compiler to ignore certain warnings</td>
  </tr>
</table>
...
<h2>@Override Annotation</h2>

<p>The <code class="w3-codespan">@Override</code> annotation helps the compiler 
check that a method really overrides a method from a superclass.</p>
<p>It's not required, but it's highly recommended because it helps catch errors.</p>
<p>In this example, we clearly indicate that we are overriding a method:</p>
...
<p><a target="_blank" class="w3-btn " href="tryjava.asp?filename=demo_annotations_override">Try it Yourself &raquo;</a></p>
</div>

<p>If you accidentally write the wrong method name (e.g. <code class="w3-codespan">makesound()</code>), 
the compiler will show an error like:</p>
<div class="w3-example">
  <h3>Example</h3>
...
class Dog extends Animal {<br>
&nbsp;&nbsp;@Override<br>
&nbsp;&nbsp;void makesound() { // Typo here!<br>
&nbsp;&nbsp;&nbsp;&nbsp;System.out.println("Woof!");<br>
&nbsp;&nbsp;}<br>
}<br><br>public class Main {<br>
&nbsp;&nbsp;public static void main(String[] args) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;Animal myDog = new Dog();<br>
&nbsp;&nbsp;&nbsp;&nbsp;myDog.makeSound();<br>
&nbsp;&nbsp;}<br>
}</div>
  <p>Result:</p>
  <div class="w3-padding w3-black">
<code>Main.java:8: error: method does not override or implement a method from a supertype<br>
&nbsp;&nbsp;@Override<br>
&nbsp;&nbsp;^<br>
1 error</code>
  </div>
<p><a target="_blank" class="w3-btn " href="tryjava.asp?filename=demo_annotations_override2">Try it Yourself &raquo;</a></p>
</div>
<p>That's the power of <code class="w3-codespan">@Override</code> - it prevents silent mistakes.</p>
<p>If you try to remove the <code class="w3-codespan">@Override</code> line in the example above, the compiler won't warn you, and the method won't override anything. Your program may still run, but it could behave unexpectedly because the intended method was never actually overridden.</p>
...
<h2>@Deprecated Annotation</h2>

<p>The <code class="w3-codespan">@Deprecated</code> annotation warns developers not to use a method because it may be removed or replaced in the future:</p>
...
&nbsp;&nbsp;@Deprecated<br>
&nbsp;&nbsp;static void oldMethod() {<br>
&nbsp;&nbsp;&nbsp;&nbsp;System.out.println("This method is outdated.");<br>
&nbsp;&nbsp;}<br><br>

&nbsp;&nbsp;public static void main(String[] args) {<br>
    &nbsp;&nbsp;&nbsp;&nbsp;oldMethod(); // This will show a warning in most IDEs<br>
&nbsp;&nbsp;}<br>
}
  </div>

<p><a target="_blank" class="w3-btn " href="tryjava.asp?filename=demo_annotations_deprecated">Try it Yourself &raquo;</a></p>
</div>

<p>Even though the method runs and prints the message, most IDEs or compilers will show a warning like this:</p>

  <div class="w3-padding w3-black">
<code>warning: [deprecation] oldMethod() in Main has been deprecated</code>
</div>
<hr>

<h2>@SuppressWarnings Annotation</h2>

<p>The <code class="w3-codespan">@SuppressWarnings</code> annotation tells the compiler to ignore specific warnings, like "unchecked" or "deprecation":</p>
...
&nbsp;&nbsp;public static void main(String[] args) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;ArrayList cars = new ArrayList();<br>
&nbsp;&nbsp;&nbsp;&nbsp;cars.add("Volvo");<br>
&nbsp;&nbsp;&nbsp;&nbsp;System.out.println(cars);<br>
&nbsp;&nbsp;}<br>
}
  </div>
...
<p><a target="_blank" class="w3-btn " href="tryjava.asp?filename=demo_annotations_suppresswarnings">Try it Yourself &raquo;</a></p>
</div>

<p>Using raw types like <code class="w3-codespan">ArrayList</code> without specifying a type (e.g. <code class="w3-codespan">ArrayList&lt;String&gt;</code>) usually causes an 
&quot;unchecked&quot; warning.</p>

<p>The annotation <code class="w3-codespan">@SuppressWarnings("unchecked")</code> 
tells the compiler to ignore that warning. This is useful when working with old code or when you're sure the operation is safe.</p>

<p>However, instead of hiding the warning, you can fix it like this:</p>
<div class="w3-example">
...
<p>This approach is type-safe and avoids the need for suppression.</p>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_generics.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_regex.asp">Next &#10095;</a>
