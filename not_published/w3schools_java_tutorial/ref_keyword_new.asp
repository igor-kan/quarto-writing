...
<h1>Java <span class="color_h1"> new</span> Keyword</h1>
<p>
...
&nbsp;&nbsp;&nbsp; Main <strong>myObj</strong> = <strong>new</strong> Main();
...
<p>The <code class="w3-codespan">new</code> keyword creates new objects.</p>
<hr>
