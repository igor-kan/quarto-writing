...
<h1>Java <span class="color_h1">Collections Framework</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_data_structures.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_list.asp">Next &#10095;</a>
</div>
<hr>

<h2>The Collections Framework</h2>
<p>Before we explore <code class="w3-codespan">ArrayList</code>, <code class="w3-codespan">HashSet</code>, <code class="w3-codespan">HashMap</code>, and other data structures in more detail, it's important to understand that all of these are part of something bigger 
- the <strong>Java Collections Framework</strong>.</p>

<p>The Java Collections Framework provides a set of <strong>interfaces</strong> (like <code class="w3-codespan">List</code>, <code class="w3-codespan">Set</code>, and <code class="w3-codespan">Map</code>) and 
a set of <strong>classes</strong> (<code class="w3-codespan">ArrayList</code>, <code class="w3-codespan">HashSet</code>, <code class="w3-codespan">HashMap</code>, 
etc.) that implement those interfaces.</p>
<p>All of these are part of the <code class="w3-codespan">java.util</code> 
package.</p>
<p>They are used to store, search, sort, and organize data more easily - all using standardized methods and patterns.</p>

<div class="ws-note ws-panel">
  <p><strong>Tip:</strong> Think of the Collections Framework as a toolbox.</p>
  <p>Interfaces like <code class="w3-codespan">List</code> define what tools can do, and classes like <code class="w3-codespan">ArrayList</code> are the actual tools that do the work.</p>
</div>

<hr>

<h2>Core Interfaces in the Collections Framework</h2>
<p>Here are some common interfaces, along with their classes:</p>
<table class="ws-table-all notranslate">
  ...
  <tr>
    ...
    <td><code class="w3-codespan">ArrayList</code>, <code class="w3-codespan">LinkedList</code></td>
    <td>Ordered collection that allows duplicates</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">Set</code></td>
    <td><code class="w3-codespan">HashSet</code>, <code class="w3-codespan">TreeSet</code>, <code class="w3-codespan">LinkedHashSet</code></td>
    <td>Collection of unique elements</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">Map</code></td>
    <td><code class="w3-codespan">HashMap</code>, <code class="w3-codespan">TreeMap</code>, <code class="w3-codespan">LinkedHashMap</code></td>
    <td>Stores key-value pairs with unique keys</td>
  </tr>
  <!--
  <tr>
    <td><code class="w3-codespan">Queue</code></td>
    <td><code class="w3-codespan">PriorityQueue</code>, <code class="w3-codespan">ArrayDeque</code>, <code class="w3-codespan">LinkedList</code></td>
    <td>Used to process elements in a specific order (FIFO)</td>
  </tr>
  -->
</table>
...
<div class="ws-note ws-panel">
  <p><strong>Note:</strong> <code class="w3-codespan">LinkedList</code> is special 
  - it can be used as both a <code class="w3-codespan">List</code> and a <code class="w3-codespan">Queue</code> depending on your needs.</p>
</div>
-->
...
<p>The table below gives an overview of the common data structure classes and their characteristics:</p>
<table class="ws-table-all notranslate">
  <tr>
    <th>Interface</th>
    <th>Class</th>
  ...
  <!-- LISTS -->
  <tr>
    <td rowspan="2"><a href="java_list.asp"><code class="w3-codespan">List</code></a></td>
    <td><a href="java_arraylist.asp"><code class="w3-codespan">ArrayList</code></a></td>
    <td>Resizable array that maintains order and allows duplicates</td>
  </tr>
  <tr class="ws-grey">
    <td><a href="java_linkedlist.asp"><code class="w3-codespan" style="margin-left:-8px">LinkedList</code></a></td>
    <td>List with fast insert and remove operations</td>
  </tr>

  <!-- SETS -->
  <tr class="w3-white">
    <td rowspan="3"><a href="java_set.asp"><code class="w3-codespan">Set</code></a></td>
    <td><a href="java_hashset.asp"><code class="w3-codespan">HashSet</code></a></td>
    <td>Unordered collection of unique elements</td>
  </tr>
  <tr>
    <td><a href="java_treeset.asp"><code class="w3-codespan" style="margin-left:-8px">TreeSet</code></a></td>
    <td>Sorted set of unique elements (natural order)</td>
  </tr>
  <tr class="w3-white">
    <td><a href="java_linkedhashset.asp"><code class="w3-codespan" style="margin-left:-8px">LinkedHashSet</code></a></td>
    <td>Maintains the order in which elements were inserted</td>
  </tr>

  <!-- MAPS -->
  <tr class="ws-grey">
    <td rowspan="3"><a href="java_map.asp"><code class="w3-codespan">Map</code></a></td>
    <td><a href="java_hashmap.asp"><code class="w3-codespan">HashMap</code></a></td>
    <td>Stores key/value pairs with no specific order</td>
  </tr>
  <tr>
    <td><a href="java_treemap.asp"><code class="w3-codespan" style="margin-left:-8px">TreeMap</code></a></td>
    <td>Sorted map based on the natural order of keys</td>
  </tr>
  <tr class="ws-grey">
    <td><a href="java_linkedhashmap.asp"><code class="w3-codespan" style="margin-left:-8px">LinkedHashMap</code></a></td>
    <td>Maintains the order in which keys were inserted</td>
  </tr>

  <!-- QUEUES 
  <tr class="w3-white">
    <td rowspan="4"><code class="w3-codespan">Queue</code></td>
  </tr>
  <tr class="w3-white">
    <td><code class="w3-codespan" style="margin-left:-8px">PriorityQueue</code></td>
    <td>Stores elements based on priority - the smallest (highest priority) comes out first</td>
  </tr>
  <tr class="w3-white">
    <td><code class="w3-codespan" style="margin-left:-8px">ArrayDeque</code></td>
    <td>A double-ended queue that lets you add or remove elements from both the front and the back</td>
  </tr>
  <tr>
    <td><code class="w3-codespan" style="margin-left:-8px">LinkedList</code></td>
    <td>Stores elements in a chain of nodes, where each element points to the next. Allows fast insertion and removal at both ends</td>
  </tr>-->
</table>
<div class="ws-note ws-panel">
<p>Use <code class="w3-codespan">List</code> classes when you care about order, you may have duplicates, and want to access elements by index.</p>
<p>Use <code class="w3-codespan">Set</code> classes when you need to store unique values only.</p>
<p>Use <code class="w3-codespan">Map</code> classes when you need to store pairs of keys and values, like a name and its phone number.</p>
</div>

<hr>

<h2>What's Next?</h2>
<p>In the next chapters, you will learn how to use each of these data structures in detail - how to add, remove, sort, and search elements, and choose the right structure for your task.</p>
