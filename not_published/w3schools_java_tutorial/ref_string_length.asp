...
<html lang="en-US">
<head>
<title>Java String length() Method</title>
<meta charset="utf-8">
...
<h1>Java String <span class="color_h1">length()</span> Method</h1>
...
System.out.println(txt.length());</code></pre>
<p>
  <a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_string_length">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>The <code class="w3-codespan">length()</code> method returns the length of a specified string.</p>
<p><strong>Note:</strong> The length of an empty string is 0.</p>

<hr>

<h2>Syntax</h2>

<pre class="language-java"><code>public int length()
</code></pre>
...
<tr>
 <th style="width:21%">Returns:</th>
  <td>An <code class="w3-codespan">int</code> value, representing the length of the string</td>
</tr>
</table>
<br>
