...
<html lang="en-US">
<head>
<title>Java HashMap containsValue() Method</title>
<meta charset="utf-8">
...
<h1>Java HashMap <span class="color_h1">containsValue()</span> Method</h1>
...
<h3>Example</h3>
<p>Check if a value exists in a map:</p>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_hashmap_containsvalue">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">containsValue()</code> method returns <code class="w3-codespan">true</code> if an entry with the specified value exists in the map and <code class="w3-codespan">false</code> otherwise.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public boolean containsValue(Object <em>value</em>)</code></pre>
...
<tr>
 ...
 <td style="width:80%"><code class="w3-codespan">true</code> if an entry with the specified value exists in the map, <code class="w3-codespan">false</code> otherwise.</td>
</tr>
</table>
<hr>
