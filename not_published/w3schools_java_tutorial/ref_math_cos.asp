...
<html lang="en-US">
<head>
<title>Java Math cos() Method</title>
<meta charset="utf-8">
...
<h1>Java Math <span class="color_h1">cos()</span> Method</h1>
...
<h3>Example</h3>
<p>Return the cosine of different angles:</p>
<pre class="w3-white language-java"><code>System.out.println(Math.cos(3));
System.out.println(Math.cos(-3));
System.out.println(Math.cos(0));
System.out.println(Math.cos(Math.PI));
System.out.println(Math.cos(Math.PI/2));
</code></pre>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_math_cos">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">cos()</code> method returns the cosine of an angle.</p>
<p><strong>Note:</strong> Angles are measured in radians.</p>
<p><strong>Tip:</strong> You can use the constant <span class="w3-codespan">Math.PI</span> to make fractions of PI for angles.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public static double cos(double <em>angle</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>angle</em></td>
    <td>Required. An angle in radians to find the cosine of.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">A <code class="w3-codespan">double</code> value representing the cosine of an angle.</td>
</tr>
<tr>
