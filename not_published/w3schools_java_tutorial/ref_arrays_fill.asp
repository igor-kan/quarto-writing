...
<html lang="en-US">
<head>
<title>Java Arrays fill() Method</title>
<meta charset="utf-8">
...
<h1>Java Arrays.<span class="color_h1">fill()</span> Method</h1>
...
<h3>Example</h3>
<p>Fill all the elements in an array with a &quot;Kiwi&quot; value:</p>
<pre class="language-java w3-white"><code>String[] fruits = {&quot;Banana&quot;, &quot;Orange&quot;, &quot;Apple&quot;, &quot;Mango&quot;};
Arrays.fill(fruits, &quot;Kiwi&quot;);</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_arrays_fill">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>The <code class="w3-codespan">fill()</code> method fills an array with a specified value.</p>
<p><strong>Note:</strong> The value must be of the same <a href="java_data_types.asp">data type</a> as the array.</p>
<p><strong>Tip:</strong> Start and end position can be specified. If not, all elements will be filled.</p>

<hr>

<h2>Syntax</h2>

<pre class="language-java"><code>Arrays.fill(<em>array</em>, <em>value</em>)</code></pre>
<pre class="language-java"><code>Arrays.fill(<em>array</em>, <em>start</em>, <em>end</em>, <em>value</em>)</code></pre>
...
<table class="ws-table-all notranslate"> 
  ...
  <tr>
    <td><em>array</em></td>
    <td>Required. The array to be filled</td>
  </tr>
  <tr>
    <td><em>start</em></td>
    <td>Optional. The index position of the first element (inclusive) to be 
    filled</td>
  </tr>
  <tr>
    <td><em>end</em></td>
    <td>Optional. The index position of the last element (exclusive) to be 
    filled</td>
  </tr>
  <tr>
    <td><em>value</em></td>
    <td>Required. The value to fill in the array</td>
  </tr>
</tbody>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Fill the last two elements:</p>
<pre class="language-java w3-white"><code>String[] fruits = {&quot;Banana&quot;, &quot;Orange&quot;, &quot;Apple&quot;, &quot;Mango&quot;};
Arrays.fill(fruits, 2, 4, &quot;Kiwi&quot;);</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_arrays_fill2">Try it Yourself &raquo;</a>
</p>
</div>
