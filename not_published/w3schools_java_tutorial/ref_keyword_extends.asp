...
<html lang="en-US">
<head>
<title>Java extends Keyword</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1"> extends</span> Keyword</h1>
<p>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_inherit">Try it Yourself &raquo;</a>
</p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">extends</code> keyword extends a class (indicates that a class is inherited from another class).</p>
...
<h2>Related Pages</h2>
<p>Read more about inheritance in our <a href="java_inheritance.asp">Java Inheritance Tutorial</a>.</p>
