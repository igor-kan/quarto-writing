...
<html lang="en-US">
<head>
<title>Java String codePointBefore() Method</title>
<meta charset="utf-8">
...
<h1>Java String <span class="color_h1">codePointBefore()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Return the Unicode of the first character in a string (the Unicode value 
  of &quot;H&quot; is 72):</p>
<pre class="language-java w3-white"><code>String myStr = &quot;Hello&quot;;
int result = myStr.codePointBefore(1);
System.out.println(result);</code></pre>
<p>
  <a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_string_codepointbefore">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>The <code class="w3-codespan">codePointBefore()</code> method returns the Unicode 
value of the character before the specified index in a string.</p>
<p>The index of the first character is 1, the second character is 2, and so on.</p> 
<p><strong>Note:</strong> The value 0 will generate an error, as this is a negative number (out 
of reach).</p>
...
<pre class="language-java"><code>public int codePointBefore(int <em>index</em>)
</code></pre>
...
<table class="ws-table-all notranslate"> 
  <tbody><tr>
    ...
    <tr>
    <td><em>index</em></td>
    <td>An <code class="w3-codespan">int</code> value, representing the index 
    following the Unicode that should be returned</td>
    </tr>
</tbody>
</table>
...
<tr>
 <th style="width:21%">Returns:</th>
  <td>An <code class="w3-codespan">int</code> value, representing the Unicode 
  value before the specified index </td>
</tr>
<tr>
 <th style="width:21%">Throws:</th>
  <td><code class="w3-codespan">IndexOutOfBoundsException</code> - if index is negative or not less than the length of 
