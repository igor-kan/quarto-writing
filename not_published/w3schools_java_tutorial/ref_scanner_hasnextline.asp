...
<html lang="en-US">
<head>
<title>Java Scanner hasNextLine() Method</title>
<meta charset="utf-8">
...
<h1>Java Scanner <span class="color_h1">hasNextLine()</span> Method</h1>
...
<p>The <code class="w3-codespan">hasNextLine()</code> method returns <em>true</em> if there is another line of text available in the scanner. A line of text is a sequence of one or more characters followed by either a new line character or the end of the scanner's content.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public boolean hasNextLine()</code></pre>

<h2>Technical Details</h2>
<table class="ws-table-all">
<tr>
 <th style="width:20%">Returns:</th>
 <td style="width:80%">A <code class="w3-codespan">boolean</code> value which is true if another line of text is available.</td>
</tr>
<tr>
