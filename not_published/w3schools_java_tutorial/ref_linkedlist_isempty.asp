...
<html lang="en-US">
<head>
<title>Java LinkedList isEmpty() Method</title>
<meta charset="utf-8">
...
<h1>Java LinkedList <span class="color_h1">isEmpty()</span> Method</h1>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_linkedlist_isempty">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">isEmpty()</code> method returns <code class="w3-codespan">true</code> if a list has no items and <code class="w3-codespan">false</code> otherwise.</p>
<hr>
...
<tr>
 ...
 <td style="width:80%"><code class="w3-codespan">true</code> if a list has no items and <code class="w3-codespan">false</code> otherwise.</td>
</tr>
</table><hr>
