...
<html lang="en-US">
<head>
<title>Java LinkedList set() Method</title>
<meta charset="utf-8">
...
<h1>Java LinkedList <span class="color_h1">set()</span> Method</h1>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_linkedlist_set">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">set()</code> method replaces an item at a specified position in the list and returns the item that was previously at that position.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public T set(int <em>index</em>, T <em>item</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>index</em></td>
    <td>Required. The position of the item to be replaced.</td>
  </tr>
  <tr>
    <td><em>item</em></td>
    <td>Required. The new item to be placed at the specified position.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">The item which was previously at the specified position in the list.</td>
</tr>
<tr>
