...
<a class="w3-left w3-btn" href="java_set.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_treeset.asp">Next &#10095;</a>
</div>
<hr>

<h2>Java HashSet</h2>
<p>A <code class="w3-codespan">HashSet</code> is a collection of elements where every element is 
...
<p>Now you can use methods like <code class="w3-codespan">add()</code>, <code class="w3-codespan">contains()</code>, and <code class="w3-codespan">remove()</code> to manage your collection of unique elements.</p>
<hr>

<h2>Add Elements</h2>
<p>To add elements to a <code class="w3-codespan">HashSet</code>, use the <code class="w3-codespan">add()</code> method:</p>
<div class="w3-example">
<h3>Example</h3>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_hashset_add">Try it Yourself &raquo;</a>
</p>
</div>
<p><strong>Note:</strong> In the example above, even though <code class="w3-codespan">"BMW"</code> is added twice, it only appears once in the set because sets do not allow duplicate elements.</p>
<hr>

<h2>Check If an Element Exists</h2>
<p>To check whether an element exists in a <code class="w3-codespan">HashSet</code>, use the <code class="w3-codespan">contains()</code> method:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>cars.contains(&quot;Mazda&quot;);
</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_hashset_contains">Try it Yourself &raquo;</a>
</p>
</div>
<hr>
...
<p>To remove an element, use the <code class="w3-codespan">remove()</code> method:</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_hashset_remove">Try it Yourself &raquo;</a>
</p>
</div>

<p>To remove all elements, use the <code class="w3-codespan">clear()</code> method:</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_hashset_clear">Try it Yourself &raquo;</a>
</p>
</div>
<hr>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_hashset_size">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>Loop through the elements of an <code class="w3-codespan">HashSet</code> with a <b>for-each</b> loop:</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_hashset_for_each">Try it Yourself &raquo;</a>
</p>
</div>
<hr>

<h2>Other Types</h2>
<p>Elements in an <code class="w3-codespan">HashSet</code> are actually objects. In the examples above, we created 
elements 
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_hashset_integer">Try it Yourself &raquo;</a>
</p>
</div>
<hr>
...
<p>
From Java 10, you can use the <code class="w3-codespan">var</code> keyword to declare a <code class="w3-codespan">HashSet</code> variable without writing the type twice.  
...
var cars = new HashSet&lt;String&gt;();
  ...
  <p>
    <a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_hashset_var">Try it Yourself &raquo;</a>
  </p>
</div>
...
<p><strong>Note:</strong> Sometimes you will see both <code class="w3-codespan">Set</code> and <code class="w3-codespan">HashSet</code> in Java code, like this:</p>

<div class="w3-example">
  <pre class="language-java w3-white"><code>import java.util.Set;
import java.util.HashSet;

Set&lt;String&gt; cars = new HashSet&lt;&gt;();</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_hashset_set">Try it Yourself &raquo;</a>
</p>
</div>
<p>This means the variable (cars) is declared as a <a href="java_set.asp"><code class="w3-codespan">Set</code></a> (the interface), but it stores a <code class="w3-codespan">HashSet</code> object (the actual set). Since <code class="w3-codespan">HashSet</code> implements the <code class="w3-codespan">Set</code> interface, this is possible.</p>
...
<p>In the next chapter, you will learn about <a href="java_treeset.asp"><code class="w3-codespan">TreeSet</code></a>, which stores unique elements <strong>in sorted order</strong>.</p>
<hr>
<div id="exercisecontainer" src="xrcise_hashset.js"></div>
<hr>
