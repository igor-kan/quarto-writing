...
<html lang="en-US">
<head>
<title>Java native Keyword</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1"> native</span> Keyword</h1>
<p>
...
<h3>Example</h3>
<p>Load a method from a compiled library:</p>
<pre class="w3-white language-java"><code>class Main {
  static {
...
<p>The <code class="w3-codespan">native</code> keyword declares a method as belonging to an external compiled library which is <em>native</em> to the operating system.</p>
<p>In order to use native methods, an external library must be loaded from a <code class="w3-codespan">.dll</code>, <code class="w3-codespan">.so</code> or similar kind of file. The compiled code in the external file should be written to support the Java Native Interface.</p>
