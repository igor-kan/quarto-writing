...
<html lang="en-US">
<head>
<title>Java How To Convert a String to an Array</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1">How To Convert a String to an Array</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_howto_check_anagram_strings.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_howto_remove_whitespace.asp">Next &#10095;</a>
</div>
<hr>

<h2>Convert a String to an Array</h2>
<p>There are many ways to convert a string to an array. The simplest way is to use the <code class="w3-codespan">toCharArray()</code> method:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Convert a string to a <code class="w3-codespan">char</code> array:</p>
<pre class="language-java w3-white"><code>// Create a string
String myStr = &quot;Hello&quot;;
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryjava.asp?filename=demo_howto_convert_string_to_array">Try it Yourself &raquo;</a>
</div>

<p><b>Explanation:</b> The method <code class="w3-codespan">toCharArray()</code> turns the string into an array of characters.  
Each letter of <code class="w3-codespan">&quot;Hello&quot;</code> becomes one element in the array, so <code class="w3-codespan">myArray[0]</code> is <code class="w3-codespan">H</code>.</p>

<p>You can also loop through the array to print all array elements:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryjava.asp?filename=demo_howto_convert_string_to_array_loop">Try it Yourself &raquo;</a>
</div>

<p><b>Explanation:</b> The loop goes through each element in the array and prints it.  
So for <code class="w3-codespan">&quot;Hello&quot;</code>, it prints the letters one by one: H, e, l, l, o.</p>
<hr>

<h2>Related Pages</h2>
<p><a href="java_strings.asp">Java Strings Tutorial</a></p>
<p><a href="java_arrays.asp">Java Array Tutorial</a></p>
<p><a href="ref_string_tochararray.asp">The toCharArray() String Method</a></p>
