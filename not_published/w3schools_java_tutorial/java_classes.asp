...
<p>In this example, we create a class named "<code class="w3-codespan">Main</code>&quot; with a 
...
<p>In Java, an object is created from a class. After defining a class, you can create objects from it using the <code class="w3-codespan">new</code> keyword:</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_class_multi_obj">Try it Yourself &raquo;</a>
</p>
</div>
...
<div class="w3-example" style="padding-top:18px;">
<pre class="language-java w3-white" data-tab-header="Second.java"><code>class Second {
&nbsp; public static void main(String[] args) {
&nbsp;&nbsp;&nbsp; Main <strong>myObj</strong> = new Main();
&nbsp;&nbsp;&nbsp; System.out.println(myObj.x);
&nbsp; }
...
<div class="w3-padding notranslate w3-black w3-margin-top">
  <code>5</code></div>
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryjava_multi.asp?filename=demo_classes&multi=demo_classes_multi">Try it Yourself &raquo;</a>
</div>
