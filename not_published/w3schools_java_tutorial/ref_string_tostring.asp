...
<html lang="en-US">
<head>
<title>Java String toString() Method</title>
<meta charset="utf-8">
...
<h1>Java String <span class="color_h1">toString()</span> Method</h1>
...
<h3>Example</h3>
<p>Return a string's value:</p>
<pre class="w3-white language-java"><code>String myStr = "Hello, World!";
System.out.println(myStr.toString());
</code></pre>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_string_tostring">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">toString()</code> method returns the string itself.</p>
<p>This method may seem redundant, but its purpose is to allow code that is treating the string as a more generalized object to know its string value without casting it to <code class="w3-codespan">String</code> type.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public String toString()</code></pre>

<h2>Technical Details</h2>
<table class="ws-table-all">
<tr>
 <th style="width:20%">Returns:</th>
 <td style="width:80%">The <code class="w3-codespan">String</code> object itself.</td>
</tr>
<tr>
