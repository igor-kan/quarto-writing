...
<html lang="en-US">
<head>
<title>Java String offsetByCodePoints() Method</title>
<meta charset="utf-8">
...
<h1>Java String <span class="color_h1">offsetByCodePoints()</span> Method</h1>
...
<h3>Example</h3>
<p>Get an index from a string which is offset from another index by a number of code points:</p>
<pre class="w3-white language-java"><code>String myStr = "Hello, World!";
int result = myStr.offsetByCodePoints(3, 2);
System.out.println(result);
</code></pre>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_string_offsetbycodepoints">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">offsetByCodePoints()</code> method returns an index in a string which is offset from another index by a specified number of code points.</p>
<p><strong>Note:</strong> A code point may be formed by more than one character. These code points will offset the index by more than 1.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public int offsetByCodePoints(int <em>index</em>, int <em>codePointOffset</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>index</em></td>
    <td>Required. Specifies the index in the string to measure the offset from.</td>
  </tr>
  <tr>
    <td><em>codePointOffset</em></td>
    <td>Required. Specifies the number of code points to offset by. Positive values will return a number greater than <em>index</em> and negative values will return a number less than <em>index</em>.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">An <code class="w3-codespan">int</code> representing the index which is <em>codePointOffset</em> code points away from <em>index</em>.</td>
</tr>
<tr>
 <th style="width:20%">Throws:</th>
 <td style="width:80%"><code class="w3-codespan">IndexOutOfBoundsException</code> - If <em>index</em> is negative or greater than the length of the string or if there are not enough code points in the string to offset by <em>codePointOffset</em>.</td>
</tr>
<tr>
