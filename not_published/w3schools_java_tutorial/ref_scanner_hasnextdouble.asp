...
<html lang="en-US">
<head>
<title>Java Scanner hasNextDouble() Method</title>
<meta charset="utf-8">
...
<h1>Java Scanner <span class="color_h1">hasNextDouble()</span> Method</h1>
...
<p>The <code class="w3-codespan">hasNextDouble()</code> method returns <em>true</em> if the next token represents a valid number.</p>
...
<h2>Syntax</h2>
<pre class="language-java"><code>public boolean hasNextDouble()</code></pre>

<h2>Technical Details</h2>
<table class="ws-table-all">
<tr>
 <th style="width:20%">Returns:</th>
 <td style="width:80%">A <code class="w3-codespan">boolean</code> value which is true if the next token represents a valid number.</td>
</tr>
<tr>
