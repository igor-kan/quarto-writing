...
<h1>Java <span class="color_h1">Delete Files</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_files_read.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_io_streams.asp">Next &#10095;</a>
</div>
<hr>

<h2>Delete a File</h2>
<p>To delete a file in Java, use the <code class="w3-codespan">delete()</code> method:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="showjava.asp?filename=demo_files_delete">Run Example &raquo;</a>
</div>
<hr>

<h2>Delete a Folder</h2>
<p>You can also delete a folder. However, it must be empty:</p>
<div class="w3-example">
<h3>Example</h3>
...
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="showjava.asp?filename=demo_files_delete_folder">Run Example &raquo;</a>
</div>
...
<hr>
<div id="exercisecontainer" src="xrcise_files_delete.js"></div>
<hr>
