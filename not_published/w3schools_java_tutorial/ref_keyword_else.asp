...
<h1>Java <span class="color_h1"> else</span> Keyword</h1>
<p>
...
<p>The <code class="w3-codespan">else</code> statement specifies a block of Java code to be executed if a condition is <code class="w3-codespan">false</code> in an <code class="w3-codespan">if</code> statement.</p>
