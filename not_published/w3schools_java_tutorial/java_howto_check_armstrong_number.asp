...
<html lang="en-US">
<head>
<title>Java How To Check Armstrong Number</title>
<meta charset="utf-8">
...
<h1>Java How To <span class="color_h1">Check Armstrong Number</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_howto_sum_of_digits.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_howto_random_number.asp">Next &#10095;</a>
</div>
<hr>

<h2>Check Armstrong Number</h2>
<p>An Armstrong number is equal to the sum of its digits raised to the power of the number of digits (e.g. 153).</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>int num = 153;
int original = num;
int result = 0;
...
System.out.println(original + (result == original ? &quot; is Armstrong&quot; : &quot; is not Armstrong&quot;));</code></pre>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_howto_check_armstrong_number">Try it Yourself &raquo;</a></p>
</div>
<p><b>Explanation:</b> 
An Armstrong number means: take each digit, raise it to the power of the number of digits, and add them together.  
<br>For <code class="w3-codespan">153</code> (3 digits):  
<br>- First digit: <code class="w3-codespan">1&sup3 = 1</code>  
<br>- Second digit: <code class="w3-codespan">5&sup3 = 125</code>  
<br>- Third digit: <code class="w3-codespan">3&sup3 = 27</code>  
<br>Now add them: <code class="w3-codespan">1 + 125 + 27 = 153</code>.  
<br>Since the sum is the same as the original number, <code class="w3-codespan">153</code> is an Armstrong number.</p>
<hr>
