...
<html lang="en-US">
<head>
<title>Java Print/Display Variables</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1">Print Variables</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_variables.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_variables_multiple.asp">Next &#10095;</a>
</div>
<hr>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_variables2">Try it Yourself &raquo;</a>
</p>
</div>
...
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>String firstName = "John ";
String lastName = "Doe";
String fullName = firstName + lastName;
System.out.println(fullName);
</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_variables3">Try it Yourself &raquo;</a>
</p>
</div>

<p>In Java, the <code class="w3-codespan">+</code> symbol has two meanings:</p>
<ul>
...
<p>For numeric values, the <code class="w3-codespan">+</code> character works as a mathematical <a href="java_operators.asp">operator</a> (notice that we use <code class="w3-codespan">int</code> (integer) variables here):</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_variables4">Try it Yourself &raquo;</a>
</p>
</div>

<p>From the example above, here's what happens step by step:</p>
<ul>
 <li><code class="w3-codespan">x</code> stores the value 5</li>
 <li><code class="w3-codespan">y</code> stores the value 6</li>
 <li><code class="w3-codespan">println()</code> displays the result of <code class="w3-codespan">x + y</code>, which is <strong>11</strong></li>
</ul>
...
<p>Be careful when combining text and numbers in the same line of code. Without parentheses, Java will treat the numbers as text after the first string:</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_variables_mix">Try it Yourself &raquo;</a>
</p>
</div>

<p><b>Explanation:</b></p>
<p>In the first line, Java combines <code class="w3-codespan">"The sum is "</code> with <code class="w3-codespan">x</code>, creating the string <code class="w3-codespan">"The sum is 5"</code>.  
Then <code class="w3-codespan">y</code> is added to that string, so it becomes <code class="w3-codespan">"The sum is 56"</code>.</p>
<p>
In the second line, the parentheses make sure <code class="w3-codespan">x + y</code> is calculated first (resulting in <code class="w3-codespan">11</code>),  
so the output is <code class="w3-codespan">"The sum is 11"</code>.
</p>

<hr>
<div id="exercisecontainer" src="xrcise_variables_print.js"></div>
<hr>
