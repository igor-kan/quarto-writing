...
<html lang="en-US">
<head>
<title>Java Output (System.out) Reference</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1">Output Methods</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_ref_math.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_ref_arrays.asp">Next &#10095;</a>
</div>
<hr>

<h2>Output Methods</h2>
<p>The <code class="w3-codespan">System.out</code> stream, short for "<strong>output</strong>", is used together with different methods to output values or print text to the console:</p>
...
<table class="ws-table-all notranslate" style="margin:0">
  ...
  <tr>
    <td><a href="ref_output_print.asp">print()</a></td>
    <td>Prints text or values the console</td>
  </tr>
  <tr>
    <td><a href="ref_output_printf.asp">printf()</a></td>
    <td>Prints formatted text or values to the console</td>
  </tr>
  <tr>
    <td><a href="ref_output_println.asp">println()</a></td>
    <td>Prints text or values to the console, followed by a new line</td>
  </tr>
</tbody>
</table>
</div>
