...
<html lang="en-US">
<head>
<title>Java String valueOf() Method</title>
<meta charset="utf-8">
...
<h1>Java String <span class="color_h1">valueOf()</span> Method</h1>
...
<h3>Example</h3>
<p>Return a string representation of different data types:</p>
<pre class="w3-white language-java"><code>char[] myArray = {'a', 'b', 'c'};
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_string_valueof">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">valueOf()</code> method returns the string representation of the specified value.</p>
<hr>

<h2>Syntax</h2>
<p>One of the following:</p>
<pre class="language-java"><code>public static String valueOf(boolean <em>data</em>)</code></pre>
<pre class="language-java"><code>public static String valueOf(char <em>data</em>)</code></pre>
<pre class="language-java"><code>public static String valueOf(char[] <em>data</em>)</code></pre>
<pre class="language-java"><code>public static String valueOf(char[] <em>data</em>, int <em>start</em>, int <em>length</em>)</code></pre>
<pre class="language-java"><code>public static String valueOf(double <em>data</em>)</code></pre>
<pre class="language-java"><code>public static String valueOf(float <em>data</em>)</code></pre>
<pre class="language-java"><code>public static String valueOf(int <em>data</em>)</code></pre>
<pre class="language-java"><code>public static String valueOf(long <em>data</em>)</code></pre>
<pre class="language-java"><code>public static String valueOf(Object <em>data</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>data</em></td>
    <td>Required. The data to be represented as a string.</td>
  </tr>
  <tr>
    <td><em>start</em></td>
    <td>Optional. If a <code class="w3-codespan">char</code> array is provided, a subset of the array can be represented. This argument specifies where the subset starts.</td>
  </tr>
  <tr>
    <td><em>length</em></td>
    <td>Optional. If a <code class="w3-codespan">char</code> array is provided, a subset of the array can be represented. This argument specifies the length of the subset.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">A <code class="w3-codespan">String</code> representation of the argument.</td>
</tr>
<tr>
 <th style="width:20%">Throws:</th>
 <td style="width:80%"><code class="w3-codespan">IndexOutOfBoundsException</code> - If <em>start</em> or <em>length</em> are negative or <em>start</em> + <em>length</em> is greater than the length of the array.</td>
</tr>
<tr>
 <th style="width:20%">Java version:</th>
 <td style="width:80%">Any</td>
</tr>
</table>
<br>
