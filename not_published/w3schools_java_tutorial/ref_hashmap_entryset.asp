...
<html lang="en-US">
<head>
<title>Java HashMap entrySet() Method</title>
<meta charset="utf-8">
...
<h1>Java HashMap <span class="color_h1">entrySet()</span> Method</h1>
...
<h3>Example</h3>
<p>Return all the entries in a map:</p>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_hashmap_entryset">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">entrySet()</code> method returns a set containing all of the entries in the map.</p>
<p>To learn about sets, see our <a href="java_hashset.asp">Java HashSet tutorial</a>.
<p><strong>Note:</strong> The returned set is a <em>view</em> of the map, which means that changing the set also changes the map.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public Set&lt; Map.Entry&lt;K,V&gt; &gt; entrySet()</code></pre>
...
<tr>
 ...
 <td style="width:80%">A set containing all of the entries in the map.</td>
</tr>
</table>
<hr>
...
<p><a href="java_hashset.asp">Java HashSet Tutorial</a></p>
<hr>
