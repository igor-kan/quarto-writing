...
<h1>Java <span class="color_h1">Files</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_try_catch_resources.asp">&#10094; Previous</a>
...
<div class="w3-bar-block ws-grey">
  <a href="java_files_create.asp" class="w3-bar-item w3-button w3-border-bottom">Create Files &raquo;</a>
  <a href="java_files_write.asp" class="w3-bar-item w3-button w3-border-bottom">Write to Files &raquo;</a>
  <a href="java_files_read.asp" class="w3-bar-item w3-button w3-border-bottom">Read Files &raquo;</a>
  <a href="java_files_delete.asp" class="w3-bar-item w3-button">Delete Files &raquo;</a>
</div>
