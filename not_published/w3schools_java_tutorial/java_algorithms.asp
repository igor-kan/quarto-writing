...
<h1>Java <span class="color_h1">Algorithms</span></h1>
...
<h2>Java Algorithms</h2>
<p>In the previous chapters, you learned how data structures (like <code class="w3-codespan">ArrayList</code>, 
<code class="w3-codespan">HashMap</code>, etc.) are used to store and organize data.</p>

<p><strong>Algorithms</strong> are used to solve problems by sorting, searching, and manipulating data structures.</p>

<p>In Java, many useful algorithms are already built into the 
<code class="w3-codespan">Collections</code> class (found in the <code class="w3-codespan">java.util</code> package), so you don't have to write them from scratch.</p>

<hr>


<h2>Searching</h2>
<p>To find elements in a list, Java provides helper methods. 
The most common is <code class="w3-codespan">Collections.binarySearch()</code>, which searches in a <strong>sorted list</strong>:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Search for an element in a sorted <code class="w3-codespan">ArrayList</code>:</p>
<pre class="language-java w3-white" data-line="11,12"><code>import java.util.*;
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_algorithm_search">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Sorting</h2>
<p>Sorting is one of the most common algorithms. 
With <code class="w3-codespan">ArrayList</code>, you can use <code class="w3-codespan">Collections.sort()</code> 
to sort the elements:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Sort a list of numbers:</p>
<pre class="language-java w3-white" data-line="12"><code>import java.util.*;
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_algorithm_sort">Try it Yourself &raquo;</a></p>
</div>

<p>You can also sort in reverse order with 
<code class="w3-codespan">Collections.sort(list, Collections.reverseOrder())</code>:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Sort an <code class="w3-codespan">ArrayList</code> in descending order:</p>
<pre class="language-java w3-white"  data-line="12"><code>import java.util.*;
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_algorithm_sort_reverse">Try it Yourself &raquo;</a></p>
</div>
...
<h2>Iterating</h2>
<p>Iterating (looping) through elements is another common algorithm. 
You can use the <a href="java_arrays_loop.asp"><strong>for-each</strong></a> loop or the <a href="java_iterator.asp"><code class="w3-codespan">Iterator</code></a> interface:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Loop through an <code class="w3-codespan">ArrayList</code> using for-each:</p>
<pre class="language-java w3-white" data-line="10"><code>import java.util.*;
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_algorithm_iterate">Try it Yourself &raquo;</a></p>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Loop through an <code class="w3-codespan">ArrayList</code> using an <code class="w3-codespan">Iterator</code>:</p>
<pre class="language-java w3-white" data-line="10,11,12,13"><code>import java.util.*;
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_algorithm_iterator">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Other Useful Algorithms</h2>
<p>The <code class="w3-codespan">Collections</code> class contains many more algorithms, such as:</p>
<ul>
  <li><code class="w3-codespan">Collections.max()</code> - find the largest element</li>
  <li><code class="w3-codespan">Collections.min()</code> - find the smallest element</li>
  <li><code class="w3-codespan">Collections.shuffle()</code> - randomly shuffle elements</li>
  <li><code class="w3-codespan">Collections.frequency()</code> - count how many times an element appears</li>
  <li><code class="w3-codespan">Collections.swap()</code> - swap two elements in a list</li>
</ul>
<p>In this example, we use <code class="w3-codespan">Collections.max()</code> and <code class="w3-codespan">Collections.min()</code> to find the largest and smallest element in an <code class="w3-codespan">ArrayList</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white" data-line="12,13"><code>import java.util.*;
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_algorithm_minmax">Try it Yourself &raquo;</a></p>
</div>
<p>Randomly shuffle an <code class="w3-codespan">ArrayList</code>:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white" data-line="11"><code>import java.util.*;
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_algorithm_shuffle">Try it Yourself &raquo;</a></p>
</div>

<p><code class="w3-codespan">Collections.frequency()</code> counts how many times an element appears in a list:</p>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_algorithm_frequency">Try it Yourself &raquo;</a></p>
</div>

<p><code class="w3-codespan">Collections.swap()</code> swaps two elements in a list:</p>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_algorithm_swap">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Summary</h2>
<ul>
  <li>An <strong>algorithm</strong> is a procedure to solve a problem.</li>
  <li>Java provides built-in algorithms in the <code class="w3-codespan">Collections</code> class.</li>
  <li>Common algorithms include <strong>searching</strong>, <strong>sorting</strong>, <strong>iterating</strong>, and finding <strong>min/max</strong>.</li>
  <li>Algorithms work together with data structures (like <a href="java_arraylist.asp"><code class="w3-codespan">ArrayList</code></a>, 
<a href="java_hashset.asp"><code class="w3-codespan">HashSet</code></a>, etc.) 
      to make your programs more powerful and efficient.</li>
</ul>
<hr>

<div>
<h2>Complete Collections Reference</h2>
<p>For a complete reference of all Collections methods, go to our <a href="java_ref_collections.asp">Java Collections Reference</a>.</p>
</div>
