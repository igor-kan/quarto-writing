...
<html lang="en-US">
<head>
<title>Java How To Remove Whitespace from a String</title>
<meta charset="utf-8">
...
<h1>Java How To - <span class="color_h1">Remove Whitespace from a String</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_howto_string_to_array.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_howto_count_char_freq.asp">Next &#10095;</a>
</div>
<hr>

<h2>Remove Whitespace from a String</h2>
<p>There are two common ways to remove whitespace in Java: using <code class="w3-codespan">trim()</code> and using <code class="w3-codespan">replaceAll()</code>.</p>

<hr>

<h2>Remove Whitespace at the Beginning and End</h2>
<p>The <code class="w3-codespan">trim()</code> method only removes whitespace from the start and end of the string.</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>String text = "   Java   ";
String trimmed = text.trim();

System.out.println(trimmed); // "Java"</code></pre>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_howto_remove_whitespace_trim">Try it Yourself &raquo;</a></p>
</div>

<p><b>Explanation:</b> <code class="w3-codespan">trim()</code> is useful when you only want to clean up leading and trailing spaces, but it will not touch spaces inside the string.</p>

<hr>

<h2>Remove All Whitespace</h2>
<p>If you want to remove <em>all</em> spaces, tabs, and newlines in a string, use <code class="w3-codespan">replaceAll()</code> with a regular expression.</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>String text = "  Java \t is \n fun  ";
String noSpaces = text.replaceAll("\\s+", "");

System.out.println(noSpaces); // "Javaisfun"</code></pre>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_howto_remove_whitespace">Try it Yourself &raquo;</a></p>
</div>

<p><b>Explanation:</b> The regular expression <code class="w3-codespan">\\s+</code> matches any whitespace character (spaces, tabs, newlines). Replacing them with an empty string removes all whitespace from the text.</p>
