...
<html lang="en-US">
<head>
<title>Java String substring() Method</title>
<meta charset="utf-8">
...
<h1>Java String <span class="color_h1">substring()</span> Method</h1>
...
<h3>Example</h3>
<p>Return a substring from a string:</p>
<pre class="w3-white language-java"><code>String myStr = "Hello, World!";
System.out.println(myStr.substring(7, 12));
</code></pre>
<p><a target="_blank" class="w3-btn w3-margin-bottom" href="tryjava.asp?filename=demo_ref_string_substring">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">substring()</code> method returns a substring from the string.</p>
<p>If the <em>end</em> argument is not specified then the substring will end at the end of the string.</p>
<hr>

<h2>Syntax</h2>
<p>One of the following:</p>
<pre class="language-java"><code>public String substring(int <em>start</em>, int <em>end</em>)</code></pre>
<pre class="language-java"><code>public String substring(int <em>start</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>start</em></td>
    <td>Required. The index of the character at which the substring starts.</td>
  </tr>
  <tr>
    <td><em>end</em></td>
    <td>Optional. The index after the last character of the substring.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">A <code class="w3-codespan">String</code> containing a substring of the string.</td>
</tr>
<tr>
 <th style="width:20%">Throws:</th>
 <td style="width:80%"><code class="w3-codespan">IndexOutOfBoundsException</code> - If <em>start</em> or <em>end</em> are negative or they are greater than the length of the string or if <em>start</em> is greater than <em>end</em>.</td>
</tr>
<tr>
