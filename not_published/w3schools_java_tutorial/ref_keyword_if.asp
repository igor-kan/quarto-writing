...
<h1>Java <span class="color_h1"> if</span> Keyword</h1>
<p>
...
<h3>Example</h3>
<p>Test two values to find out if 20 is greater than 
...
<p>The <code class="w3-codespan">if</code> statement specifies a block of Java code to be executed if a condition is <code class="w3-codespan">true</code>.</p>
...
<div class="w3-example">
<h3>Example</h3>
<p>Use the <code class="w3-codespan">if</code> statement to test variables:</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_if_else_if">Try it Yourself &raquo;</a>
</p>
</div>
...
<h2>Related Pages</h2>
<p>Read more about conditions in our <a href="java_conditions.asp">Java If...Else Tutorial</a>.</p>
