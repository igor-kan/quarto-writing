...
<html lang="en-US">
<head>
<title>Java Math acos() Method</title>
<meta charset="utf-8">
...
<h1>Java Math <span class="color_h1">acos()</span> Method</h1>
...
<pre class="language-java w3-white"><code>System.out.println(Math.acos(0.64));
System.out.println(Math.acos(-0.4));
System.out.println(Math.acos(0));
System.out.println(Math.acos(1));
System.out.println(Math.acos(-1));
System.out.println(Math.acos(2)); </code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_math_acos">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>The <code class="w3-codespan">acos()</code> method returns the arc cosine 
value of a number.</p>
<p><strong>Tip:</strong> acos(-1) returns the value of PI.</p>
...
<table class="ws-table-all notranslate"> 
  <tbody><tr>
    ...
    <tr>
    <td><em>number</em></td>
    <td>Required. A number to find the arc cosine of, in the range -1 to 1. If 
    the value is outside -1 to 1, it returns NaN (Not a Number).</td>
    </tr>
</tbody>
</table>
...
<tr>
 <th style="width:21%">Returns:</th>
  <td>A <code class="w3-codespan">double</code> value, representing the arc cosine of a number</td>
</tr>
</table>
<br>
