...
<html lang="en-US">
<head>
<title>Java Math nextUp() Method</title>
<meta charset="utf-8">
...
<h1>Java Math <span class="color_h1">nextUp()</span> Method</h1>
...
<h3>Example</h3>
<p>Find the next floating point number above different numbers:</p>
<pre class="w3-white language-java"><code>System.out.println(Math.nextUp(1.0f));
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_math_nextup">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">nextUp()</code> method returns the floating point number adjacent to a number in the positive direction, which is the lowest possible floating point number that is greater than the starting number.<p>
...
<pre class="language-java"><code>public static double nextUp(double <em>start</em>)</code></pre>
<pre class="language-java"><code>public static float nextUp(float <em>start</em>)</code></pre>
...
<tr>
 ...
 <td style="width:80%">A <code class="w3-codespan">double</code> or <code class="w3-codespan">float</code> value representing the floating point number adjacent to a starting number in the positive direction.</td>
</tr>
<tr>
