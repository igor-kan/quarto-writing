...
<h1>Java <span class="color_h1">this</span></h1>
...
<p>The <code class="w3-codespan">this</code> keyword in Java refers to the current object 
in a method or constructor.</p>
<p>The <code class="w3-codespan">this</code> keyword is often used to avoid confusion when class attributes have the same name as method or constructor parameters.</p>
<hr>

<h2>Accessing Class Attributes</h2>
<p>Sometimes a constructor or method has a parameter with the same name as a class variable. When this happens, the parameter temporarily <strong>hides</strong> the class variable inside that method or constructor.</p>

<p>To refer to the class variable and not the parameter, you can use the <code class="w3-codespan">this</code> keyword:</p>
...
<code>Value of x = 5</code>
</div>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_this_attributes">Try it Yourself &raquo;</a></p>
</div>

<div class="ws-note ws-panel">
  <p><strong>Tip:</strong> Think of <code class="w3-codespan">this.x = x;</code> as: 
  "<code class="w3-codespan">this.x</code> (the class variable) gets the value of <code class="w3-codespan">x</code> (the parameter)."</p>
<p>Without <code class="w3-codespan">this</code>, the code above <code class="w3-codespan">x = x;</code> would set the parameter <code class="w3-codespan">x</code> equal to itself, and the class variable would stay uninitialized (<code class="w3-codespan">0</code>).</p>
</div>
<hr>

<h2>Calling a Constructor from Another Constructor</h2>
<p>You can also use <code class="w3-codespan">this()</code> to call another constructor in the same class.</p>
<p>This is useful when you want to provide default values or reuse initialization code instead of repeating it.</p>
...
<p>Output:</p>
<div class="w3-black w3-padding">
<code>2020 Corvette<br>1969 Mustang</code>
</div>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_this_constructor">Try it Yourself &raquo;</a></p>
</div>

<div class="ws-note ws-panel">
  <p><strong>Note:</strong> The call to <code class="w3-codespan">this()</code> must be the <strong>first statement</strong> inside the constructor.</p>
</div>
...
<ul>
  <li>When a constructor or method has a parameter with the same name as a class variable, use <code class="w3-codespan">this</code> to update the class variable correctly.</li>
  <li>To call another constructor in the same class and reuse code.</li>
</ul>
<hr>
