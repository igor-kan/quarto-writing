...
<html lang="en-US">
<head>
<title>Java Scanner useLocale() Method</title>
<meta charset="utf-8">
...
<h1>Java Scanner <span class="color_h1">useLocale()</span> Method</h1>

<p><a class="w3-btn w3-white w3-border" href="java_ref_scanner.asp">&#10094; Scanner Methods</a></p>
...
<p>Read numbers from a different locale:</p>
<pre class="w3-white language-java"><code>// Create a scanner object
...
<p>The <code class="w3-codespan">useLocale()</code> method changes the locale used by the scanner. The locale determines how numbers are interpreted by deciding how digits are grouped, which character serves as a decimal point, etc.</p>
<h3>Locale objects</h3>
<p>The <code class="w3-codespan">useLocale()</code> method requires a <code class="w3-codespan">Locale</code> object as an argument. <code class="w3-codespan">Locale</code> objects represent a language or country and they are used by a variety of Java classes to handle formatting and interpreting data.</p>
<p>The easiest way to get a <code class="w3-codespan">Locale</code> object is by using one of the objects provided by attributes of the <code class="w3-codespan">Locale</code> class.</p>
<pre class="language-java"><code>myObj.useLocale(Locale.GERMANY));</code></pre>
<p>A list of available language and country attributes is shown below.</p>
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td>
      <code class="w3-codespan">Locale.CANADA</code><br>
      <code class="w3-codespan">Locale.CANADA_FRENCH</code><br>
      <code class="w3-codespan">Locale.CHINA</code><br>
      <code class="w3-codespan">Locale.FRANCE</code><br>
      <code class="w3-codespan">Locale.GERMANY</code><br>
      <code class="w3-codespan">Locale.ITALY</code><br>
      <code class="w3-codespan">Locale.JAPAN</code><br>
      <code class="w3-codespan">Locale.KOREA</code><br>
      <code class="w3-codespan">Locale.PRC</code><br>
      <code class="w3-codespan">Locale.TAIWAN</code><br>
      <code class="w3-codespan">Locale.UK</code><br>
      <code class="w3-codespan">Locale.US</code>
    </td>
    <td>
      <code class="w3-codespan">Locale.CHINESE</code><br>
      <code class="w3-codespan">Locale.ENGLISH</code><br>
      <code class="w3-codespan">Locale.FRENCH</code><br>
      <code class="w3-codespan">Locale.GERMAN</code><br>
      <code class="w3-codespan">Locale.ITALIAN</code><br>
      <code class="w3-codespan">Locale.JAPANESE</code><br>
      <code class="w3-codespan">Locale.KOREAN</code><br>
      <code class="w3-codespan">Locale.SIMPLIFIED_CHINESE</code><br>
      <code class="w3-codespan">Locale.TRADITIONAL_CHINESE</code>
    </td>
  </tr>
</table>
<p>If the country or language you need is not in the list then you can create a new <code class="w3-codespan">Locale</code> object using a language code and an optional country code. Most codes are two or three characters long and each code represents a language or a country.</p>
<pre class="language-java"><code>Locale spanish = new Locale("es");
...
<hr>
<h2>Syntax</h2>
<pre class="language-java"><code>public Scanner useLocale(Locale <em>locale</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>locale</em></td>
    <td>Required. A <code class="w3-codespan">Locale</code> object.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">A reference to the <code class="w3-codespan">Scanner</code> object that this method belongs to, which allows for chaining configuration methods. An example of chaining is <code class="language-java">myObj.useLocale(Language.GERMAN).useDelimiter(",");</code>.</td>
</tr>
</table>
<hr>
<p><a class="w3-btn w3-white w3-border" href="java_ref_scanner.asp">&#10094; Scanner Methods</a></p>
