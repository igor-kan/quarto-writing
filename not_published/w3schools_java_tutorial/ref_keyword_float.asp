...
<html lang="en-US">
<head>
<title>Java float Keyword</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1"> float</span> Keyword</h1>
<p>
...
<p>The <code class="w3-codespan">float</code> keyword is a data type that can store fractional numbers from 3.4e&#8722;038 to 3.4e+038.</p>
<p>Note that you should end the value with an "f":</p>
<hr>
