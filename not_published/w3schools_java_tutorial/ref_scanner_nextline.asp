...
<html lang="en-US">
<head>
<title>Java Scanner nextLine() Method</title>
<meta charset="utf-8">
...
<h1>Java Scanner <span class="color_h1">nextLine()</span> Method</h1>
...
<h3>Example</h3>
<p>Output the contents a file line by line:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_files_read">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">nextLine()</code> method returns a string containing all of the characters up to the next new line character in the scanner, or up to the end of the scanner if there are no more new line characters.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public String nextLine()</code></pre>

<h2>Technical Details</h2>
<table class="ws-table-all">
<tr>
 <th style="width:20%">Returns:</th>
 <td style="width:80%">A <code class="w3-codespan">String</code> value containing the next line of text in the scanner.</td>
</tr>
<tr>
 <th style="width:20%">Throws:</th>
 <td style="width:80%">
  <code class="w3-codespan">NoSuchElementException</code> - If there are no more lines in the scanner.<br>
