...
<html lang="en-US">
<head>
<title>Java LinkedList listIterator() Method</title>
<meta charset="utf-8">
...
<h1>Java LinkedList <span class="color_h1">listIterator()</span> Method</h1>
...
<h3>Example</h3>
<p>Use a <code class="w3-codespan">ListIterator</code> to loop forward and backward through a list:</p>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_linkedlist_listiterator">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">listIterator()</code> method returns a <code class="w3-codespan">ListIterator</code> for the list.</p>
<p>To learn how to use iterators, see our <a href="java_iterator.asp">Java Iterator tutorial</a>.</p>
<p>The <code class="w3-codespan">ListIterator</code> differs from an <code class="w3-codespan">Iterator</code> in that it can also traverse the list backwards.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public ListIterator listIterator()</code></pre>

<h2>Technical Details</h2>
<table class="ws-table-all">
<tr>
 <th style="width:20%">Returns:</th>
 <td style="width:80%">A <code class="w3-codespan">ListIterator</code> object.</td>
</tr>
</table>
<hr>
