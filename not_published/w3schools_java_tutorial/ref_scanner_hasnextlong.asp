...
<html lang="en-US">
<head>
<title>Java Scanner hasNextLong() Method</title>
<meta charset="utf-8">
...
<h1>Java Scanner <span class="color_h1">hasNextLong()</span> Method</h1>
...
<p>The <code class="w3-codespan">hasNextLong()</code> method returns <em>true</em> if the next token represents a number that can be stored by the <code class="w3-codespan">long</code> data type, which is any whole number between -9,223,372,036,854,775,808 and 9,223,372,036,854,775,807.</p>
...
<pre class="language-java"><code>public boolean hasNextLong()</code></pre>
<pre class="language-java"><code>public boolean hasNextLong(int <em>radix</em>)</code></pre>
...
<tr>
 ...
 <td style="width:80%">A <code class="w3-codespan">boolean</code> value which is true if the next token represents a <code class="w3-codespan">long</code> value.</td>
</tr>
<tr>
 <th style="width:20%">Throws:</th>
 <td style="width:80%"><code class="w3-codespan">IllegalStateException</code> - If the scanner has been closed.</td>
</tr>
</table>
<hr>
<p><a class="w3-btn w3-white w3-border" href="java_ref_scanner.asp">&#10094; Scanner Methods</a></p>
