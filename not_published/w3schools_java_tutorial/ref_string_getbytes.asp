...
<html lang="en-US">
<head>
<title>Java String getBytes() Method</title>
<meta charset="utf-8">
...
<h1>Java String <span class="color_h1">getBytes()</span> Method</h1>
...
<h3>Example</h3>
<p>Convert a string into a byte array:</p>
<pre class="w3-white language-java"><code>String myStr = "Hello";
byte[] result = myStr.getBytes();
System.out.println(result[0]);
</code></pre>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_string_getbytes">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">getBytes()</code> method converts a string into an array of bytes.</p>
<p>The encoding of the bytes depends on the charset argument.</p>
<p>If the charset argument is not provided then the bytes will be encoded using the system's default character set.</p>
<hr>

<h2>Syntax</h2>
<p>One of the following:</p>
<pre class="language-java"><code>public byte[] getBytes(Charset <em>charset</em>)</code></pre>
<pre class="language-java"><code>public byte[] getBytes()</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>charset</em></td>
    <td>Optional. A <code class="w3-codespan">Charset</code> object specifying which character set should be used when encoding the string as bytes.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">A <code class="w3-codespan">byte</code> array representing the bytes of the string with a specific encoding.</td>
</tr>
<tr>
 <th style="width:20%">Java version:</th>
 <td style="width:80%">Any. <em>charset</em> parameter added in version 1.6.</td>
</tr>
</table>
<br>
