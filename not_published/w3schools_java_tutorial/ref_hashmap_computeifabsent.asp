...
<html lang="en-US">
<head>
<title>Java HashMap computeIfAbsent() Method</title>
<meta charset="utf-8">
...
<h1>Java HashMap <span class="color_h1">computeIfAbsent()</span> Method</h1>
...
<h3>Example</h3>
<p>Compute a value for a new entry in a map:</p>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_hashmap_computeifabsent">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">computeIfAbsent()</code> method calculates a value for a new entry based on its key. If an entry with the specified key already exists and its value is not <code class="w3-codespan">null</code> then the map is not changed. </p>
<p>The value is computed using a function, which can be defined by a lambda expression that is compatible with the <code class="w3-codespan">apply()</code> method of Java's <code class="w3-codespan">Function</code> interface.</p>
<p>To learn about lambda expressions, see our <a href="java_lambda.asp">Java Lambda Expression tutorial</a>.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public void computeIfAbsent(K <em>key</em>, Function <em>function</em>)</code></pre>
<p><code class="w3-codespan">K</code> refers to the data type of the keys of the map.</p>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>key</em></td>
    <td>Required. Specifies the key of the entry.</td>
  </tr>
  <tr>
    <td><em>function</em></td>
    <td>
      Required. A <code class="w3-codespan">Function</code> object or lambda expression which computes the value of the entry.<br>
      The function has one parameter containing the key of the entry.
    </td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">If an entry with the specified key already exists then it returns the value of the entry, otherwise it returns the value computed by the function.</td>
</tr>
</table>
