...
<html lang="en-US">
<head>
<title>Java How To Count Digits in a String</title>
<meta charset="utf-8">
...
<h1>Java How To <span class="color_h1">Count Digits in a String</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_howto_remove_vowels_string.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_howto_reverse_string.asp">Next &#10095;</a>
</div>
<hr>

<h2>Count Digits in a String</h2>
<p>Go through each character and count how many are digits (0-9).</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>String text = &quot;W3Schools was founded in 1998&quot;;
int count = 0;
...
System.out.println(&quot;Digits: &quot; + count);</code></pre>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_howto_count_digits_string">Try it Yourself &raquo;</a></p>
</div>

<p><b>Explanation:</b> We loop through each character of the string. The method <code class="w3-codespan">Character.isDigit()</code> checks if the character is a digit. For the example above, the program finds 5 digits.</p>
<hr>
