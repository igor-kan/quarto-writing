...
<html lang="en-US">
<head>
<title>Java Scanner locale() Method</title>
<meta charset="utf-8">
...
<h1>Java Scanner <span class="color_h1">locale()</span> Method</h1>
...
<p>Show the locale that is currently being used by the scanner:</p>
...
<p>The <code class="w3-codespan">locale()</code> method returns a <code class="w3-codespan">Locale</code> object describing the locale used when interpreting numbers. The locale specifies formatting such as which character is used as a decimal point and how digits in large numbers are grouped.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public Locale locale()</code></pre>

<h2>Technical Details</h2>
<table class="ws-table-all">
<tr>
 <th style="width:20%">Returns:</th>
 <td style="width:80%">A <code class="w3-codespan">Locale</code> object describing the locale used by the scanner.</td>
</tr>
</table>
