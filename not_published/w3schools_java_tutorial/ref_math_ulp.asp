...
<html lang="en-US">
<head>
<title>Java Math ulp() Method</title>
<meta charset="utf-8">
...
<h1>Java Math <span class="color_h1">ulp()</span> Method</h1>

<p>
<a class="w3-btn w3-white w3-border" href="java_ref_math.asp">&#10094; Math Methods</a>
</p>
...
<h3>Example</h3>
<p>Find the unit of least precision for different numbers:</p>
<pre class="w3-white language-java"><code>System.out.println(Math.ulp(1.0));
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_math_ulp">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">ulp()</code> method returns the unit of least precision of a number.</p>
<p>The unit of least precision is the smallest step you can take up or down from a number. For example, the ulp for <code class="w3-codespan">50000000.0f</code> is 4.0, so the next number above it than can be represented with a <code class="w3-codespan">float</code> data type is <code class="w3-codespan">50000004.0f</code>.</p>
<p><strong>Note:</strong> The <code class="w3-codespan">double</code> data type has a lot more precision than the <code class="w3-codespan">float</code> data type, so the ulp is smaller.</p>
<p><strong>Note:</strong> Larger numbers have less precision than smaller numbers, that means the ulp is larger.</p>
<p><strong>Note:</strong> The sign of a number does not affect the ulp.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public static double ulp(double <em>number</em>)</code></pre>
<pre class="language-java"><code>public static float ulp(float <em>number</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>number</em></td>
    <td>Required. A floating point number.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">A <code class="w3-codespan">double</code> or <code class="w3-codespan">float</code> value representing the unit of least precision.</td>
</tr>
<tr>
