...
<html lang="en-US">
<head>
<title>Java HashMap getOrDefault() Method</title>
<meta charset="utf-8">
...
<h1>Java HashMap <span class="color_h1">getOrDefault()</span> Method</h1>
...
<h3>Example</h3>
<p>Output the value of an entry in a map, or "Unknown" if it does not exist:</p>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_hashmap_getordefault">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">getOrDefault()</code> method returns the value of the entry in the map which has a specified key. If the entry does not exist then the value of the second parameter is returned.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public V getOrDefault(Object <em>key</em>, V <em>def</em>)</code></pre>
<p><code class="w3-codespan">V</code> refers to the data type of the values of the map.</p>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>key</em></td>
    <td>Required. Specifies the key of the entry to get the value from.</td>
  </tr>
  <tr>
    <td><em>def</em></td>
    <td>Required. Specifies the default value to return if an entry is not found.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">The value of the entry with the specified key or the value of the <em>def</em> argument if an entry with that key does not exist.</td>
</tr>
</table>
<hr>
