...
<h2>Java Example</h2>
<p>Java is often used in everyday programming tasks, like saying hello to a user:</p>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_intro">Try it Yourself &raquo;</a></p>
</div>
...
<hr>
<h2>Get Started</h2>
<p>By the end of this tutorial, you will know how to write basic Java programs and apply your skills to real-life examples.</p>
<p>You don't need any prior programming experience - just curiosity and practice!</p>
<p>Follow the tutorial in order. Each chapter builds on the previous one.</p>
<a class="ws-btn ws-grey ws-hover-black" href="java_getstarted.asp">Get Started &raquo;</a>

<hr>
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: Java Introduction</h2>
  <a href="https://youtu.be/t54pgbVy6t0&list=PLP9IO4UYNF0VT3LvP_Cl4EIEyVk-Q5DP3" class="ga-featured ga-youtube" target="blank_" > 
