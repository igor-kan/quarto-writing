...
<html lang="en-US">
<head>
<title>Java String contentEquals() Method</title>
<meta charset="utf-8">
...
<h1>Java String <span class="color_h1">contentEquals()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Find out if a string contains a sequence of characters:</p>
<pre class="language-java w3-white"><code>String myStr = &quot;Hello&quot;;
System.out.println(myStr.contentEquals(&quot;Hello&quot;));&nbsp; // true
System.out.println(myStr.contentEquals(&quot;e&quot;));&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // false
System.out.println(myStr.contentEquals(&quot;Hi&quot;));&nbsp;&nbsp;&nbsp;&nbsp; // false</code></pre>
<p>
  <a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_string_contentequals">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>The <code class="w3-codespan">contentEquals()</code> method searches a string to find out if it contains the exact same sequence of characters in the specified string or StringBuffer.</p>
<p>Returns <code class="w3-codespan">true</code> if the characters exist and <code class="w3-codespan">false</code> if not.</p>
...
<pre class="language-java"><code>public boolean contentEquals(StringBuffer <em>chars</em>)
</code></pre>
<pre class="language-java"><code>public boolean contentEquals(CharSequence <em>chars</em>)
</code></pre>
...
<table class="ws-table-all notranslate"> 
  <tbody><tr>
    ...
    <tr>
    <td>StringBuffer <em>chars</em></td>
    <td>The StringBuffer
    to be searched for</td>
    </tr>
    <tr>
    <td>CharSequence <em>chars</em></td>
    <td>The sequence of characters
    to be searched for</td>
    </tr>
</tbody>
</table>
<div class="ws-note w3-panel">
<p>The StringBuffer class is like a String, only it can be modified, found in the java.lang package.</p>
<p>The CharSequence interface is a readable sequence of char values, found in the java.lang package.</p>
</div>
...
<tr>
 <th style="width:21%">Returns:</th>
  <td>A <code class="w3-codespan">boolean</code>, indicating whether the exact same sequence 
  of characters exist in the specified string (or StringBuffer):<ul>
  <li><code class="w3-codespan">true</code> - sequence of characters exists</li>
  <li><code class="w3-codespan">false</code> - sequence of characters do not exist</li>
  </ul></td>
</tr>
<tr>
 <th style="width:21%">Java Version:</th>
  <td>1.4 (contentEquals (StringBuffer <em>chars</em>))<br>
  1.5 (contentEquals (CharSequence <em>chars</em>))</td>
</tr>
</table>
<br>
