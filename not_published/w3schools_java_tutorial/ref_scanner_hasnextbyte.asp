...
<html lang="en-US">
<head>
<title>Java Scanner hasNextByte() Method</title>
<meta charset="utf-8">
...
<h1>Java Scanner <span class="color_h1">hasNextByte()</span> Method</h1>
...
<p>The <code class="w3-codespan">hasNextByte()</code> method returns <em>true</em> if the next token represents a number that can be stored by the <code class="w3-codespan">byte</code> data type, which is any whole number between -128 and 127.</p>
...
<pre class="language-java"><code>public boolean hasNextByte()</code></pre>
<pre class="language-java"><code>public boolean hasNextByte(int <em>radix</em>)</code></pre>
...
<tr>
 ...
 <td style="width:80%">A <code class="w3-codespan">boolean</code> value which is true if the next token represents a <code class="w3-codespan">byte</code> value.</td>
</tr>
<tr>
