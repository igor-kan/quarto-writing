...
<html lang="en-US">
<head>
<title>Java Math cosh() Method</title>
<meta charset="utf-8">
...
<h1>Java Math <span class="color_h1">cosh()</span> Method</h1>
...
<pre class="w3-white language-java"><code>System.out.println(Math.cosh(3));
System.out.println(Math.cosh(-3));
System.out.println(Math.cosh(0));
System.out.println(Math.cosh(1));
</code></pre>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_math_cosh">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">cosh()</code> method returns the hyperbolic cosine of a number.</p>
<p>The hyperbolic cosine is equivalent to <code class="w3-codespan">(Math.exp(number) + Math.exp(-number)) / 2</code>.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public static double cosh(double <em>number</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>number</em></td>
    <td>Required. A number to find the hyperbolic cosine of.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">A <code class="w3-codespan">double</code> value representing the hyperbolic cosine of a number.</td>
</tr>
<tr>
