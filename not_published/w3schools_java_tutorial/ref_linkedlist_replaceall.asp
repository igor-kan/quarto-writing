...
<html lang="en-US">
<head>
<title>Java LinkedList replaceAll() Method</title>
<meta charset="utf-8">
...
<h1>Java LinkedList <span class="color_h1">replaceAll()</span> Method</h1>
...
<h3>Example</h3>
<p>Add 1 to every number in a list:</p>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_linkedlist_replaceall">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">replaceAll()</code> method replaces every item in a list with the result of performing an operation on the item. The operation can be defined by a lambda expression that is compatible with Java's <code class="w3-codespan">UnaryOperator</code> interface.</p>
<p>To learn about lambda expressions, see our <a href="java_lambda.asp">Java Lambda Expression tutorial</a>.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public void replaceAll(UnaryOperator <em>operator</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    ...
    <td>Required. A <code class="w3-codespan">UnaryOperator</code> or lambda expression which operates on each item from the list.</td>
  </tr>
</table>
<hr>
...
<p><a href="java_lambda.asp">Java Lambda Expression Tutorial</a></p>
<hr>
