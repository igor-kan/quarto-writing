...
<html lang="en-US">
<head>
<title>Java module Keyword</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1"> module</span> Keyword</h1>
<p>
...
<p>The <code class="w3-codespan">module</code> keyword is used to declare a module. Following the keyword is the name of the module and braces which can contain directives describing the module.</p>
<p><strong>Note:</strong> The <code class="w3-codespan">module</code> keyword is meant to be used in the <em>module-info.java</em> file of a module.</p>
<p>The <code class="w3-codespan">module</code> keyword was new in Java 9.</p>
<hr>
