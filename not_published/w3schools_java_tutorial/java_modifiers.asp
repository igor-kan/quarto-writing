...
<a class="w3-left w3-btn" href="java_this.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_non_modifiers.asp">Next &#10095;</a>
</div>
<hr>
...
<li><strong><a href="java_non_modifiers.asp">Non-Access Modifiers</a></strong> - do not control access level, but provides other functionality</li>
</ul>
<hr>
...
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryjava.asp?filename=demo_mod_public">Try it &raquo;</a></td>
</tr>
<tr>
<td><em>default</em></td>
...
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryjava.asp?filename=demo_mod_default">Try it &raquo;</a></td>
</tr>
</tbody>
</table>
</div>
...
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryjava_multi.asp?filename=demo_mod_public2&multi=demo_mod_public2_multi">Try it &raquo;</a></td>
</tr>
<tr>
<td><code class="w3-codespan">private</code></td>
<td>The code is only accessible within the declared class</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryjava.asp?filename=demo_access_mod">Try it &raquo;</a></td>
</tr>
<tr>
<td><em>default</em></td>
...
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryjava.asp?filename=demo_mod_default2">Try it &raquo;</a></td>
</tr>
<tr>
...
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryjava.asp?filename=demo_mod_protected">Try it &raquo;</a></td>
</tr>
</tbody>
</table>
</div>
...
<h2>Public vs. Private Example</h2>
<p>In the example below, the class has one <code class="w3-codespan">public</code> attribute and one <code class="w3-codespan">private</code> 
attribute.</p>
<p>Think of it like real life:</p>
<ul>
  <li><code class="w3-codespan">public</code> - a public park, everyone can enter</li>
  <li><code class="w3-codespan">private</code> - your house key, only you can use it</li>
</ul>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>class Person {
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_access_public_private">Try it Yourself &raquo;</a>
</p>
</div>

<h3>Example explained</h3>
<p>Here, <code class="w3-codespan">name</code> is declared as <code class="w3-codespan">public</code>, so it can be accessed from outside the <code class="w3-codespan">Person</code> class.  
But <code class="w3-codespan">age</code> is declared as <code class="w3-codespan">private</code>, so it can only be used inside the <code class="w3-codespan">Person</code> class.</p>
<hr>
<div id="exercisecontainer" src="xrcise_modifiers.js"></div>
<hr>
