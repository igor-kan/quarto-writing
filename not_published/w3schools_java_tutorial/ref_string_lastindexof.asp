...
<html lang="en-US">
<head>
<title>Java String lastIndexOf() Method</title>
<meta charset="utf-8">
...
<h1>Java String <span class="color_h1">lastIndexOf()</span> Method</h1>
...
<pre class="language-java w3-white"><code>String myStr = &quot;Hello planet earth, you are a great planet.&quot;;
System.out.println(myStr.lastIndexOf(&quot;planet&quot;));</code></pre>
<p>
  <a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_string_lastindexof">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>The <code class="w3-codespan">lastIndexOf()</code> method returns the position of the last occurrence of specified character(s) in a string.</p>
<p><strong>Tip:</strong> Use the <a href="ref_string_indexof.asp">indexOf</a> method to return the position of the 
<strong>first</strong> occurrence of specified character(s) in a string.</p>
<hr>

<h2>Syntax</h2>
<p>One of the following:</p>
<pre class="language-java"><code>public int lastIndexOf(String <em>str</em>)
</code></pre>
<pre class="language-java"><code>public int lastIndexOf(String <em>str</em>, int <em>fromIndex</em>)
</code></pre>
<pre class="language-java"><code>public int lastIndexOf(int <em>char</em>)
</code></pre>
<pre class="language-java"><code>public int lastIndexOf(int <em>char</em>, int <em>fromIndex</em>)
</code></pre>
...
<table class="ws-table-all notranslate"> 
  <tbody><tr>
    ...
    <tr>
    <td><em>str</em></td>
    <td>A <code class="w3-codespan">String</code> value, representing the string 
    to search for</td>
    </tr>
    <tr>
    <td><em>fromIndex</em></td>
    <td>An <code class="w3-codespan">int</code> value, representing the index position to start the search from. If omitted, the default value is the length of the string</td>
    </tr>
    <tr>
    <td><em>char</em></td>
    <td>An <code class="w3-codespan">int</code> value, representing a single 
    character, e.g 'A', or a Unicode value</td>
    </tr>
</tbody>
</table>
...
<tr>
 <th style="width:21%">Returns:</th>
  <td>An <code class="w3-codespan">int</code> value, representing the index of the first occurrence of the 
  character in the string, or -1 if it never occurs</td>
</tr>
</table>
<hr>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Find the last occurrence of &quot;e&quot; in a string, starting the search at position 
  5:</p>
...
<p>
  <a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_string_lastindexof2">Try it Yourself &raquo;</a>
</p>
</div>
<hr>
<a class="w3-btn w3-white w3-border" href="java_ref_string.asp">&#10094; String Methods</a>
