...
<h1>Java <span class="color_h1"> final</span> Keyword</h1>
<p>
...
<h3>Example</h3>
<p>Set a variable to <code class="w3-codespan">final</code>, to prevent it from being overridden/modified:</p>
...
<p>The <code class="w3-codespan">final</code> keyword is a non-access modifier used for classes, attributes and methods, which makes them non-changeable (impossible to inherit or override).</p>
...
<h2>Related Pages</h2>
<p>Read more about attributes our <a href="java_class_attributes.asp">Java Class Attributes Tutorial</a>.</p>
