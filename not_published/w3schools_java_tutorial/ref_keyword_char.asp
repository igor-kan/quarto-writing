...
<h1>Java <span class="color_h1"> char</span> Keyword</h1>
<p>
...
<p>The <code class="w3-codespan">char</code> keyword is a data type that is used to store a single character.</p>
<p>A char value must be surrounded by single quotes, like 'A' or 'c'.</p>
<hr>
