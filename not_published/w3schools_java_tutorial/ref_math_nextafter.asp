...
<html lang="en-US">
<head>
<title>Java Math nextAfter() Method</title>
<meta charset="utf-8">
...
<h1>Java Math <span class="color_h1">nextAfter()</span> Method</h1>
...
<h3>Example</h3>
<p>Find the next floating point number for different numbers in different directions:</p>
<pre class="w3-white language-java"><code>System.out.println(Math.nextAfter(1, 2));
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_math_nextafter">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">nextAfter()</code> method returns the floating point number adjacent to a number x in the direction of a number y.</p>
<p>If y is greater than x then it looks for the lowest possible floating point number that is greater than x. If y is less than x then it looks for the highest possible floating point number that is less than x. If y is equal to x then this method returns x.<p>
<p>The return value for <code class="w3-codespan">double</code> type arguments will be closer to x than the return value for <code class="w3-codespan">float</code> type arguments.</p>
<hr>

<h2>Syntax</h2>
<p>One of the following:</p>
<pre class="language-java"><code>public static double nextAfter(double <em>x</em>, double <em>y</em>)</code></pre>
<pre class="language-java"><code>public static float nextAfter(float <em>x</em>, double <em>y</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>x</em></td>
    <td>Required. The number to start from.</td>
  </tr>
  <tr>
    <td><em>y</em></td>
    <td>Required. The direction to step towards.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">A <code class="w3-codespan">double</code> or <code class="w3-codespan">float</code> value representing the next floating point number from a starting point in a specified direction.</td>
</tr>
<tr>
  <th style="width:20%">Java version:</th>
  <td style="width:80%">1.6+</td>
</tr>
</table>
