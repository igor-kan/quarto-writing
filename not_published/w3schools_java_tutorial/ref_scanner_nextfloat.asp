...
<html lang="en-US">
<head>
<title>Java Scanner nextFloat() Method</title>
<meta charset="utf-8">
...
<h1>Java Scanner <span class="color_h1">nextFloat()</span> Method</h1>
...
<p>The <code class="w3-codespan">nextFloat()</code> method returns a <code class="w3-codespan">float</code> value containing the number represented by the next token.</p>
...
<h2>Syntax</h2>
<pre class="language-java"><code>public float nextFloat()</code></pre>

<h2>Technical Details</h2>
<table class="ws-table-all">
<tr>
 <th style="width:20%">Returns:</th>
 <td style="width:80%">A <code class="w3-codespan">float</code> value containing the number represented by the token.</td>
</tr>
<tr>
