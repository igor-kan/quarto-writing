...
<html lang="en-US">
<head>
<title>Java Arrays compare() Method</title>
<meta charset="utf-8">
...
<h1>Java Arrays.<span class="color_h1">compare()</span> Method</h1>
...
<pre class="language-java w3-white"><code>String[] cars = {&quot;Volvo&quot;, &quot;BMW&quot;, &quot;Tesla&quot;};
String[] cars2 = {&quot;Volvo&quot;, &quot;BMW&quot;, &quot;Tesla&quot;};

System.out.println(Arrays.compare(cars, cars2)); </code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_arrays_compare">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>The <code class="w3-codespan">compare()</code> method compares two arrays lexicographically.</p>

<hr>

<h2>Syntax</h2>

<pre class="language-java"><code>Arrays.compare(<em>array1</em>, <em>array2</em>)</code></pre>
...
<table class="ws-table-all notranslate"> 
  ...
  <tr>
    <td><em>array1</em></td>
    <td>Required. The array to compare with <em>array2</em></td>
  </tr>
  <tr>
    <td><em>array2</em></td>
    <td>Required. The array to be compared with <em>array1</em></td>
  </tr>
</tbody>
</table>
...
<tr>
 <th style="width:21%">Returns:</th>
  <td>Returns <code class="w3-codespan">0</code> if the arrays are equal.<br><br>Returns a negative integer if 
  the <em>array1</em> is less than <em>array2</em> lexicographically<br><br>
  Returns a positive integer if <em>array1</em> is greater than <em>array2</em> 
