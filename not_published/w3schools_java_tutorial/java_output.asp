...
<html lang="en-US">
<head>
<title>Java Output Values / Print Text</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1">Output / Print</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_challenges_syntax.asp">&#10094; Previous</a>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_output">Try it Yourself &raquo;</a>
</div>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_output_many">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Double Quotes</h2>
<p>Text must be wrapped inside double quotations marks <code class="w3-codespan">""</code>.</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_output_quotes_err">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_output_print">Try it Yourself &raquo;</a>
</div>
...
<p>In this tutorial, we will only use <code class="w3-codespan">println()</code> 
...
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: Java Output / Print</h2>
  <a href="https://youtu.be/BP3d7meXCmc&list=PLP9IO4UYNF0VT3LvP_Cl4EIEyVk-Q5DP3" class="ga-featured ga-youtube" target="blank_" > 
