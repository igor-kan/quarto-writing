...
<html lang="en-US">
<head>
<title>Java Math random() Method</title>
<meta charset="utf-8">
...
<h1>Java Math <span class="color_h1">random()</span> Method</h1>
...
<pre class="w3-white language-java"><code>System.out.println(Math.random());
</code></pre>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_math_random">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">random()</code> method returns a random number between 0 and 1. </p>
<p>This method never returns exactly 1, but it can return 0.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public static double random()</code></pre>

<h2>Technical Details</h2>
<table class="ws-table-all">
<tr>
 <th style="width:20%">Returns:</th>
 <td style="width:80%">A <code class="w3-codespan">double</code> value representing a randomly selected number between 0 and 1, excluding 1 itself.</td>
</tr>
<tr>
