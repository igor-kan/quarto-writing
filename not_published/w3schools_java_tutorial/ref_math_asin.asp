...
<html lang="en-US">
<head>
<title>Java Math asin() Method</title>
<meta charset="utf-8">
...
<h1>Java Math <span class="color_h1">asin()</span> Method</h1>
<p>
...
<pre class="w3-white language-java"><code>System.out.println(Math.asin(0.64));
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_math_asin">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">asin()</code> method returns the arc sine of a number in radians.</p>
<p><strong>Tip:</strong> asin(1) returns the value of PI/2.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public static double asin(double <em>number</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>number</em></td>
    <td>Required. A number to find the arc sine of, in the range -1 to 1. <br>If the value is outside -1 to 1, it returns NaN (Not a Number).</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">A <code class="w3-codespan">double</code> value representing the arc sine of a number in radians.</td>
</tr>
<tr>
