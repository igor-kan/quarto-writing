...
<html lang="en-US">
<head>
<title>Java String replace() Method</title>
<meta charset="utf-8">
...
<h1>Java String <span class="color_h1">replace()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Return a new string where all &quot;l&quot; characters are replaced with &quot;p&quot; characters:</p>
<pre class="language-java w3-white"><code>String myStr = &quot;Hello&quot;;
System.out.println(myStr.replace('l', 'p'));</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_string_replace">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>The <code class="w3-codespan">replace()</code> method searches a string for a specified 
character, and returns a new string where the specified character(s) are replaced.</p>

<hr>

<h2>Syntax</h2>

<pre class="language-java"><code>public String replace(char <em>searchChar</em>, char <em>newChar</em>)
</code></pre>
...
<table class="ws-table-all notranslate"> 
  <tbody><tr>
    ...
    <tr>
    <td><em>searchChar</em></td>
    <td>A <code class="w3-codespan">char</code>, representing the character that 
    will be replaced by the new character</td>
    </tr>
    <tr>
    <td><em>newChar</em></td>
    <td>A <code class="w3-codespan">char</code>, representing the character to 
    replace the <em>searchChar</em> with</td>
    </tr>
</tbody>
</table>
...
<tr>
 <th style="width:21%">Returns:</th>
  <td>A new <code class="w3-codespan">String</code>, where the specified character has been replaced by the new character(s)</td>
</tr>
</table>
<br>
