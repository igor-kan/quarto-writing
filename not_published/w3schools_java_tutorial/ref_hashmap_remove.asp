...
<html lang="en-US">
<head>
<title>Java HashMap remove() Method</title>
<meta charset="utf-8">
...
<h1>Java HashMap <span class="color_h1">remove()</span> Method</h1>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_hashmap_remove">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">remove()</code> method removes an entry with a specified key from the map. If a value is provided then the entry will only be removed if its value matches the specified value.</p>
<hr>

<h2>Syntax</h2>
<p>One of the following:</p>
<pre class="language-java"><code>public V remove(Object <em>key</em>)</code></pre>
<pre class="language-java"><code>public boolean remove(Object <em>key</em>, Object <em>value</em>)</code></pre>
<p><code class="w3-codespan">V</code> refers to the data type of the values in the map.</p>
...
<tr>
 ...
 <td style="width:80%">When a value is specified, it returns <code class="w3-codespan">true</code> if an entry was deleted and <code class="w3-codespan">false</code> otherwise. If no value is specified then it returns the value of the removed entry, or <code class="w3-codespan">null</code> if an entry with the specified key does not exist.</td>
</tr>
</table>
