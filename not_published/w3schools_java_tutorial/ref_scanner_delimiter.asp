...
<html lang="en-US">
<head>
<title>Java Scanner delimiter() Method</title>
<meta charset="utf-8">
...
<h1>Java Scanner <span class="color_h1">delimiter()</span> Method</h1>
...
<h3>Example</h3>
<p>Show the delimiter that is currently being used by the scanner:</p>
...
<p>The <code class="w3-codespan">delimiter()</code> method returns a <code class="w3-codespan">Pattern</code> object describing the sequence of characters which separates tokens in the data being scanned. The default delimiter is a sequence of whitespace characters, but it can be changed with the <code class="w3-codespan"><a href="ref_scanner_usedelimiter.asp">useDelimiter()</a></code> method.</p>
<p>Learn more about the <code class="w3-codespan">Pattern</code> object in our <a href="java_regex.asp">Java RegEx tutorial</a>.</p>
<div class="w3-panel ws-note">
<p><strong>What is a token?</strong> </p>
  <p>A token is a sequence of characters separated from other tokens by delimiters.</p>
</div>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public Pattern delimiter()</code></pre>

<h2>Technical Details</h2>
<table class="ws-table-all">
<tr>
 <th style="width:20%">Returns:</th>
 <td style="width:80%">A <code class="w3-codespan">Pattern</code> object describing the sequence of characters that the scanner uses as a delimiter.</td>
</tr>
</table>
<hr>
<p><a class="w3-btn w3-white w3-border" href="java_ref_scanner.asp">&#10094; Scanner Methods</a></p>
