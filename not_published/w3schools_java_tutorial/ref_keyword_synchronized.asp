...
<h1>Java <span class="color_h1"> synchronized</span> Keyword</h1>
<p>
...
<h3>Example</h3>
<p>Use the <code class="w3-codespan">synchronized</code> modifier to prevent race conditions between threads:</p>
<pre class="w3-white language-java"><code>public class Main implements Runnable {
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_keyword_synchronized">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">synchronized</code> keyword is a modifier that locks a method so that only one thread can use it at a time. This prevents problems that arise from race conditions between threads.</p>
<p>In the example above, removing the <code class="w3-codespan">synchronized</code> keyword from the <code class="w3-codespan">transfer()</code> method may cause the values of <code class="w3-codespan">a</code> and <code class="w3-codespan">b</code> to be modified by another thread in between operations. This would result in the total amount between the two variables to change.</p>
<hr>

<h2>Related Pages</h2>
<p>Read more about modifiers in our <a href="java_modifiers.asp">Java Modifiers Tutorial</a>.</p>
<p>Read more about threads in our <a href="java_threads.asp">Java Threads Tutorial</a>.</p>
