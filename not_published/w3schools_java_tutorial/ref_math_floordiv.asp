...
<html lang="en-US">
<head>
<title>Java Math floorDiv() Method</title>
<meta charset="utf-8">
...
<h1>Java Math <span class="color_h1">floorDiv()</span> Method</h1>
...
<h3>Example</h3>
<p>Perform integer divisions:</p>
<pre class="w3-white language-java"><code>System.out.println(Math.floorDiv(10, 5));
System.out.println(Math.floorDiv(10, 4));
System.out.println(Math.floorDiv(-10, 4));
System.out.println(Math.floorDiv(-10, 5));
</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryjava.asp?filename=demo_ref_math_floordiv">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">floorDiv()</code> method returns the division between two integers rounded down. This is different from an ordinary integer division in that negative results are rounded down away from zero instead of truncated towards it.</p>
<hr>

<h2>Syntax</h2>
<p>One of the following:</p>
<pre class="language-java"><code>public static int floorDiv(int <em>dividend</em>, int <em>divisor</em>)</code></pre>
<pre class="language-java"><code>public static long floorDiv(long <em>dividend</em>, long <em>divisor</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    ...
    <td>Required. The dividend of the division.</td>
  </tr>
  <tr>
    <td><em>divisor</em></td>
    <td>Required. The divisor of the division.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">An <code class="w3-codespan">int</code> or <code class="w3-codespan">long</code> value representing a division between two integers.</td>
</tr>
<tr>
