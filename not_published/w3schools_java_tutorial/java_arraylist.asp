...
<a class="w3-left w3-btn" href="java_list.asp">&#10094; Previous</a>
...
<p>An <code class="w3-codespan">ArrayList</code> is like a resizable <a href="java_arrays.asp">array</a>.</p>

<p>It is part of the <code class="w3-codespan">java.util</code> package and implements the <a href="java_list.asp"><code class="w3-codespan">List</code></a> interface.</p>

<p>The difference between a built-in <a href="java_arrays.asp">array</a> and an <code class="w3-codespan">ArrayList</code> in Java, is that the size of an array cannot be modified (if you want to 
add or remove elements to/from an array, you have to create a new one). While elements can be added and removed from an <code class="w3-codespan">ArrayList</code> whenever you want.</p>
<hr>

<h2>Create an ArrayList</h2>

<p>To use an <code class="w3-codespan">ArrayList</code>, you must first import it from <code class="w3-codespan">java.util</code>:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Create an <code class="w3-codespan">ArrayList</code> object called <strong>cars</strong> that will store strings:</p><pre class="language-java w3-white"><code>import java.util.ArrayList; // Import the ArrayList class

ArrayList&lt;String&gt; cars = new ArrayList&lt;String&gt;(); // Create an ArrayList object</code></pre>
</div>

<p>Now you can use methods like <code class="w3-codespan">add()</code>, <code class="w3-codespan">get()</code>, <code class="w3-codespan">set()</code>, and <code class="w3-codespan">remove()</code> to manage your list of elements.</p>
<hr>

<h2>Add Elements</h2>
<p>To add elements to an 
<code class="w3-codespan">ArrayList</code>, use the <code class="w3-codespan">add()</code> method:</p>
<div class="w3-example">
<h3>Example</h3>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_arraylist_add">Try it Yourself &raquo;</a>
</p>
</div>

<p>You can also add an element at a specified position by referring to the index 
number:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>import java.util.ArrayList;
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_arraylist_add2">Try it Yourself &raquo;</a>
</p></div>
<div class="ws-note w3-panel">
<p>An <code class="w3-codespan">ArrayList</code> keeps elements in the same order you add them, so the first item you add will be at index 0, the next at index 1, and so on.</p>
</div>

<hr>

<h2>Access an Element</h2>
...
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>cars.get(0);  // Get the first element
</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_arraylist_get">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_arraylist_set">Try it Yourself &raquo;</a>
</p>
</div>
<hr>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_arraylist_remove">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_arraylist_clear">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>To find out how many elements an <code class="w3-codespan">ArrayList</code> have, use the <code class="w3-codespan">size</code> method:</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_arraylist_size">Try it Yourself &raquo;</a>
</p>
</div>
<hr>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_arraylist_loop">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_arraylist_for_each">Try it Yourself &raquo;</a>
</p>
</div>
<hr>

<h2>Other Types</h2>
<p>Elements in an <code class="w3-codespan">ArrayList</code> are actually objects. In the examples above, we created elements 
(objects) of type "String". Remember that a <code class="w3-codespan">String</code> in Java is an object (not a primitive type). To use other types, such as <code class="w3-codespan">int</code>, you must specify an equivalent <a href="java_wrapper_classes.asp">wrapper class</a>: <code class="w3-codespan">Integer</code>. For other primitive types, 
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_arraylist_integer">Try it Yourself &raquo;</a>
</p>
</div>
<hr>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_arraylist_sort2">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_arraylist_sort">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>
From Java 10, you can use the <code class="w3-codespan">var</code> keyword to declare an <code class="w3-codespan">ArrayList</code> variable without writing the type twice.  
The compiler figures out the type from the value you assign.  
</p>

<p>
This makes code shorter, <strong>but many developers still use the full type for clarity</strong>.  
Since <code class="w3-codespan">var</code> is valid Java, you may see it in other code, so it's good to know that it exists:
</p>

<div class="w3-example">
  <h3>Example</h3>
  <pre class="language-java w3-white"><code>// Without var
ArrayList&lt;String&gt; cars = new ArrayList&lt;String&gt;();
...
var cars = new ArrayList&lt;String&gt;();
  ...
  <p>
    <a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_arraylist_var">Try it Yourself &raquo;</a>
  </p>
</div>
...
<p><strong>Note:</strong> Sometimes you will see both <code class="w3-codespan">List</code> and <code class="w3-codespan">ArrayList</code> in Java code, like this:</p>

<div class="w3-example">
  <pre class="language-java w3-white"><code>import java.util.List;
import java.util.ArrayList;

List&lt;String&gt; cars = new ArrayList&lt;&gt;();</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_arraylist_list">Try it Yourself &raquo;</a>
</p>
</div>
<p>This means the variable (cars) is declared as a <a href="java_list.asp"><code class="w3-codespan">List</code></a> (the interface), but it stores an <code class="w3-codespan">ArrayList</code> object (the actual list). Since <code class="w3-codespan">ArrayList</code> implements the <code class="w3-codespan">List</code> interface, this is possible.</p>
<p>It works the same way, but some developers prefer this style because it gives them more flexibility to change the type later.</p>
<hr>

<div>
<h2>Complete ArrayList Reference</h2>
<p>For a complete reference of ArrayList methods, go to our <a href="java_ref_arraylist.asp">Java ArrayList Reference</a>.</p>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_arraylist.js"></div>
<hr>
