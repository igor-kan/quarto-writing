...
<html lang="en-US">
<head>
<title>Java LinkedList removeIf() Method</title>
<meta charset="utf-8">
...
<h1>Java LinkedList <span class="color_h1">removeIf()</span> Method</h1>
...
<h3>Example</h3>
<p>Remove all even numbers from a list:</p>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_linkedlist_removeif">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">removeIf()</code> method removes all elements from this list for which a condition is satisfied. The condition can be defined by the return value of a lambda expression that is compatible with the <code class="w3-codespan">test()</code> method of Java's <code class="w3-codespan">Predicate</code> interface.</p>
<p>To learn about lambda expressions, see our <a href="java_lambda.asp">Java Lambda Expression tutorial</a>.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public boolean removeIf(Predicate <em>condition</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    ...
    <td>Required. A <code class="w3-codespan">Predicate</code> object or lambda expression which tests an item from the list.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%"><code class="w3-codespan">true</code> if any items were removed from the list, <code class="w3-codespan">false</code> otherwise.</td>
</tr>
</table>
