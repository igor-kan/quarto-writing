...
<html lang="en-US">
<head>
<title>Java interface Keyword</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1"> interface</span> Keyword</h1>
<p>
...
<p>To access the interface methods, the interface must be &quot;implemented&quot; 
(kinda like inherited) by another class with the <a href="ref_keyword_implements.asp"><code class="w3-codespan">implements</code></a> 
keyword (instead of <code class="w3-codespan">extends</code>). The body of the 
interface method is provided by the &quot;implement&quot; class.</p>
