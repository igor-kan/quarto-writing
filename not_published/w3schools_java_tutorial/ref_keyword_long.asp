...
<h1>Java <span class="color_h1"> long</span> Keyword</h1>
<p>
...
<p>The <code class="w3-codespan">long</code> keyword is a data type that can store whole numbers from -9223372036854775808 to 9223372036854775808.</p>
<p>Note that you should end the value with an "L":</p>
<hr>
