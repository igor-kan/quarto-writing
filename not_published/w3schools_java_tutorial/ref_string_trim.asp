...
<html lang="en-US">
<head>
<title>Java String trim() Method</title>
<meta charset="utf-8">
...
<h1>Java String <span class="color_h1">trim()</span> Method</h1>
...
<pre class="language-java w3-white"><code>String myStr = &quot;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Hello World!&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&quot;;
System.out.println(myStr);
System.out.println(myStr.trim());</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_string_trim">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>The <code class="w3-codespan">trim()</code> method removes whitespace from both ends of a string.</p>
<p><strong>Note:</strong> This method does not change the original string.</p>

<hr>

<h2>Syntax</h2>

<pre class="language-java"><code>public String trim()
</code></pre>
...
<tr>
 <th style="width:20%">Returns:</th>
  <td>A <code class="w3-codespan">String</code> value, which is a copy of the string, without leading and trailing whitespace</td>
</tr>
</table>
<br>
