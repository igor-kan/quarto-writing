...
<html lang="en-US">
<head>
<title>Java HashMap putAll() Method</title>
<meta charset="utf-8">
...
<h1>Java HashMap <span class="color_h1">putAll()</span> Method</h1>
...
<h3>Example</h3>
<p>Copy entries from one map into another:</p>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_hashmap_putall">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">putAll()</code> method writes all of the entries from another map into the map. If entries exist with the same keys then the values of these entries will be changed.</p>
<hr>

<h2>Syntax</h2>
<p>One of the following:</p>
<pre class="language-java"><code>public void putAll(Map<K,V> <em>map</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>map</em></td>
    <td>Required. Another map containing entries to be added to the map.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">
  <code class="w3-codespan">NullPointerException</code> - If the <em>map</em> argument is <code class="w3-codespan">null</code>.</code>
 </td>
</tr>
</table>
