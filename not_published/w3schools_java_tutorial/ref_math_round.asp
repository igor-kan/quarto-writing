...
<html lang="en-US">
<head>
<title>Java Math round() Method</title>
<meta charset="utf-8">
...
<h1>Java Math <span class="color_h1">round()</span> Method</h1>
...
<pre class="w3-white language-java"><code>System.out.println(Math.round(0.60));
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_math_round">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">round()</code> method rounds a number to the 
nearest integer.</p>
<hr>

<h2>Syntax</h2>
<p>One of the following:</p>
<pre class="language-java"><code>public static long round(double <em>number</em>)</code></pre>
<pre class="language-java"><code>public static int round(float <em>number</em>)</code></pre>
...
<tr>
 ...
 <td style="width:80%">A <code class="w3-codespan">long</code> value (if the argument is double) or <code class="w3-codespan">int</code> (if the argument is float) value representing the nearest integer to a number.</td>
</tr>
<tr>
