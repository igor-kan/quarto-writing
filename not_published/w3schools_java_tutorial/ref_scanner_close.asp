...
<html lang="en-US">
<head>
<title>Java Scanner close() Method</title>
<meta charset="utf-8">
...
<h1>Java Scanner <span class="color_h1">close()</span> Method</h1>
...
<h3>Example</h3>
<p>Use the <code class="w3-codespan">close()</code> method when finished reading from a file:</p>
<pre class="w3-white language-java"><code>import java.io.File;  // Import the File class
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showjava.asp?filename=demo_files_read">Run Example &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">close()</code> method closes the file or input stream that the scanner was reading. After calling the <code class="w3-codespan">close()</code> method, the current Scanner object can no longer be used.</p>
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> Closing a scanner that was created with <code class="w3-codespan">System.in</code> will close the <code class="w3-codespan">System.in</code> stream itself, making it unusable. It is best to only used the <code class="w3-codespan">close()</code> method with files.</p>
</div>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public void close()</code></pre>
<hr>

<h2>Related Pages</h2>
<p>Java Tutorial: <a href="java_files_create.asp">Create and Write Files</a>.</p>
<hr>
<p><a class="w3-btn w3-white w3-border" href="java_ref_scanner.asp">&#10094; Scanner Methods</a></p>
