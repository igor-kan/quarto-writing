...
<html lang="en-US">
<head>
<title>Java Arrays sort() Method</title>
<meta charset="utf-8">
...
<h1>Java Arrays.<span class="color_h1">sort()</span> Method</h1>

<p>
<a class="w3-btn w3-white w3-border" href="java_ref_arrays.asp">&#10094; Arrays Methods</a>
</p>
...
<pre class="language-java w3-white"><code>String[] cars = {&quot;Volvo&quot;, &quot;BMW&quot;, &quot;Tesla&quot;, &quot;Ford&quot;, &quot;Fiat&quot;, &quot;Mazda&quot;, &quot;Audi&quot;};
Arrays.sort(cars);</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_arrays_sort">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>The <code class="w3-codespan">sort()</code> method sorts an array in 
ascending order.</p>
<p>This method sorts arrays of strings alphabetically, and arrays 
of integers numerically.</p>

<hr>

<h2>Syntax</h2>

<pre class="language-java"><code>Arrays.sort(<em>array</em>)</code></pre>
<pre class="language-java"><code>Arrays.sort(<em>array</em>, <em>start</em>, <em>end</em>)</code></pre>
...
<table class="ws-table-all notranslate"> 
  ...
  <tr>
    <td><em>array</em></td>
    <td>Required. The array to be sorted</td>
  </tr>
  <tr>
    <td><em>start</em></td>
    <td>Optional. The index position of the first element (inclusive) to be sorted</td>
  </tr>
  <tr>
    <td><em>end</em></td>
    <td>Optional. The index position of the last element (exclusive) to be sorted</td>
  </tr>
</tbody>
</table>
...
<tr>
 <th style="width:21%">Java version:</th>
  <td>1.2 (<code class="w3-codespan">java.util</code>)</td>
</tr>
</table>
<hr>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Sort an integer array numerically:</p>
<pre class="language-java w3-white"><code>int[] myNum = {50, 10, 25, 1, 17, 99, 33};
Arrays.sort(myNum);</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_arrays_sort2">Try it Yourself &raquo;</a>
</p>
</div>

<div class="w3-example">
  <h3>Example</h3>
  <p>Sort an integer array numerically, but only sort from index 1 to 3:</p>
<pre class="language-java w3-white"><code>int[] myNum = {50, 10, 25, 1, 17, 99, 33};

// This will only sort the integers 10, 25, 1 and 17 from the myNum array
Arrays.sort(myNum, 1, 4);</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_arrays_sort3">Try it Yourself &raquo;</a>
</p>
</div>
