...
<html lang="en-US">
<head>
<title>Java Strings Concatenation</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1">String Concatenation</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_strings.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_strings_numbers.asp">Next &#10095;</a>
</div>
<hr>

<h2>String Concatenation</h2>

<p>The <code class="w3-codespan">+</code> operator can be used between strings to 
combine them. This is called <strong>concatenation</strong>:</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_strings_conc">Try it Yourself &raquo;</a>
</p>
</div>
...
<h2>Concatenation in Sentences</h2>

<p>You can use string concatenation to build sentences with both text and variables:</p>
...
<code>My name is John and I am 25 years old.</code>
</div>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_strings_conc_sentence">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>You can also use the <code class="w3-codespan">concat()</code> method to concatenate strings:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>String firstName = &quot;John &quot;;
String lastName = &quot;Doe&quot;;
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_strings_conc2">Try it Yourself &raquo;</a>
</p>
</div>

<p>You can also join more than two strings by chaining <code class="w3-codespan">concat()</code> calls:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>String a = "Java ";
String b = "is ";
String c = "fun!";
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_strings_concat3">Try it Yourself &raquo;</a>
</p>
</div>


<div class="ws-note ws-panel">
<p><strong>Note:</strong> While you can use <code class="w3-codespan">concat()</code> to join multiple strings, 
most developers prefer the <code class="w3-codespan">+</code> operator because it is shorter and easier to read.</p>
</div>
