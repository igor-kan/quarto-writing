...
<html lang="en-US">
<head>
<title>Java String contains() Method</title>
<meta charset="utf-8">
...
<h1>Java String <span class="color_h1">contains()</span> Method</h1>
...
<p>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="tryjava.asp?filename=demo_ref_string_contains">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>The <code class="w3-codespan">contains()</code> method checks whether a string contains a sequence of characters.</p>
...
<pre class="language-java"><code>public boolean contains(CharSequence <em>chars</em>)
</code></pre>
...
<tr>
 <th style="width:21%">Returns:</th>
  <td>A <code class="w3-codespan">boolean</code>, indicating whether a sequence 
  of characters exist in the specified string:<ul>
...
<tr>
 <th style="width:21%">Throws:</th>
  <td><code class="w3-codespan">NullPointerException</code> - if the returned value is null</td>
</tr>
<tr>
