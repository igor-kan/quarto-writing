...
<html lang="en-US">
<head>
<title>Java Scanner nextShort() Method</title>
<meta charset="utf-8">
...
<h1>Java Scanner <span class="color_h1">nextShort()</span> Method</h1>
...
<h3>Example</h3>
<p>Print the value of every short integer in the string:</p>
...
<p>The <code class="w3-codespan">nextShort()</code> method returns the <code class="w3-codespan">short</code> value of the number that the next token represents. The token must represent a whole number between -32,768 and 32,767.</p>
...
<pre class="language-java"><code>public short nextShort()</code></pre>
<pre class="language-java"><code>public short nextShort(int <em>radix</em>)</code></pre>
...
<tr>
 ...
 <td style="width:80%">The <code class="w3-codespan">short</code> value of the number that the next token represents.</td>
</tr>
<tr>
 <th style="width:20%">Throws:</th>
 <td style="width:80%">
  <code class="w3-codespan">InputMismatchException</code> - If the token does not represent a <code class="w3-codespan">short</code> type value.<br>
