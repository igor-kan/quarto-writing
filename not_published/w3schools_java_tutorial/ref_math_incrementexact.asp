...
<html lang="en-US">
<head>
<title>Java Math incrementExact() Method</title>
<meta charset="utf-8">
...
<h1>Java Math <span class="color_h1">incrementExact()</span> Method</h1>
...
<h3>Example</h3>
<p>Increment different numbers:</p>
<pre class="w3-white language-java"><code>System.out.println(Math.incrementExact(12002));
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryjava.asp?filename=demo_ref_math_incrementexact">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">incrementExact()</code> method returns 1 more than a specified integer and throws an exception if an overflow occurs. This prevents incorrect results that can occur from the overflow.</p>
<hr>

<h2>Syntax</h2>
<p>One of the following:</p>
<pre class="language-java"><code>public static int incrementExact(int <em>x</em>)</code></pre>
<pre class="language-java"><code>public static long incrementExact(long <em>x</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>x</em></td>
    <td>Required. An integer to increment from.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">An <code class="w3-codespan">int</code> or <code class="w3-codespan">long</code> value representing 1 more than an integer.</td>
</tr>
<tr>
 <th style="width:20%">Throws:</th>
 <td style="width:80%"> <code class="w3-codespan">ArithmeticException</code> - If the increment causes an overflow.</td>
</tr>
<tr>
