...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_linkedlist_add">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">add()</code> method adds an item to the list.</p>
<p>If an index is provided then the new item will be placed at the specified index, pushing all of the following elements in the list ahead by one.</p>
<p>If an index is not provided then the new item will be placed at the end of the list.</p>
<hr>

<h2>Syntax</h2>
<p>One of the following:</p>
<pre class="language-java"><code>public boolean add(T <em>item</em>)</code></pre>
<pre class="language-java"><code>public void add(int <em>index</em>, T <em>item</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>index</em></td>
    <td>Optional. The position in the list at which to add the item.</td>
  </tr>
  <tr>
    <td><em>item</em></td>
    <td>Required. The item to be added to the list.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">Nothing if an index is specified. When an index is not specified it returns <code class="w3-codespan">true</code> if the list changed and <code class="w3-codespan">false</code> if the list did not change.</td>
</tr>
<tr>
 <th style="width:20%">Throws:</th>
 <td style="width:80%"><code class="w3-codespan">IndexOutOfBoundsException</code> - If the index is less than zero or greater than the size of the list.</td>
</tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Add an item at a specified position in the list:</p>
<pre class="w3-white language-java"><code>import java.util.LinkedList;
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_linkedlist_add2">Try it Yourself &raquo;</a></p>
</div>
