...
<html lang="en-US">
<head>
<title>Java ArrayList clone() Method</title>
<meta charset="utf-8">
...
<h1>Java ArrayList <span class="color_h1">clone()</span> Method</h1>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_arraylist_clone">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">clone()</code> method returns a copy of the <code class="w3-codespan">ArrayList</code> as an <code class="w3-codespan">Object</code>.</p>
...
<p><strong>Note:</strong> Since the return type is <code class="w3-codespan">Object</code>, it must be <a href="java_type_casting.asp">type casted</a> in order to use it as an <code class="w3-codespan">ArrayList</code> as shown in the example above.</p>
<hr>
...
<tr>
 ...
 <td style="width:80%">A copy of the <code class="w3-codespan">ArrayList</code> object.</td>
</tr>
</table>
<hr>
