...
<html lang="en-US">
<head>
<title>Java Enum Constructor</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1">Enum Constructor</span></h1>
...
<h2>Enum Constructor</h2>
<p>An <code class="w3-codespan">enum</code> can also have a <strong>constructor</strong> just like a class.</p>
<p>The constructor is called automatically when the constants are created. You cannot call it yourself.</p>

<p>Here, each constant in the enum has a value (a string) that is set through the constructor:</p>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_enum_constructor">Try it Yourself &raquo;</a></p>
</div>
<p><strong>Note:</strong> The constructor for an enum <strong>must be private</strong>. If you don't write <code class="w3-codespan">private</code>, Java adds it automatically.</p>

<hr>

<h2>Loop Through Enum with Constructor</h2>
<p>You can also loop through the constants and print their values using the <code class="w3-codespan">values()</code> method:</p>
...
<code>
LOW: Low level<br>
MEDIUM: Medium level<br>
HIGH: High level
</code>
</div>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_enum_constructor_loop">Try it Yourself &raquo;</a></p>
</div>
