...
<a class="w3-left w3-btn" href="java_challenges_operators.asp">&#10094; Previous</a>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_strings">Try it Yourself &raquo;</a>
</p>
</div>
<hr>

<h2>String Length</h2>
<p>A String in Java is actually an object, which means it contains <strong>methods</strong> that can perform certain operations on strings.</p>
<p>For example, you can find the length of a string with the <code class="w3-codespan">length()</code> method:</p>
<div class="w3-example">
<h3>Example</h3>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_strings_length">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>There are many string methods available in Java.</p>
<p>For example:</p>
<ul>
  <li>The <code class="w3-codespan">toUpperCase()</code> method converts a string to <strong>upper case</strong> letters.</li>
  <li>The <code class="w3-codespan">toLowerCase()</code> method converts a string to <strong>lower case</strong> letters.</li>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_strings_touppercase">Try it Yourself &raquo;</a>
</p>
</div>
<hr>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_strings_indexof">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>You can use the <code class="w3-codespan">charAt()</code> method to access a character at a specific position in a string:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>String txt = "Hello";
System.out.println(txt.charAt(0));  // H
System.out.println(txt.charAt(4));  // o
</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_strings_charat">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>To compare two strings, you can use the <code class="w3-codespan">equals()</code> method:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>String txt1 = "Hello";
String txt2 = "Hello";
...
System.out.println(txt3.equals(txt4));  // false</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_strings_equals">Try it Yourself &raquo;</a>
</p>
</div>
<hr>
...
<p>The <code class="w3-codespan">trim()</code> method removes whitespace from the beginning and the end of a string:</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_strings_trim">Try it Yourself &raquo;</a>
</p>
</div>
...
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: Java Strings</h2>
  <a href="https://youtu.be/SkKmN9k5_mY&list=PLP9IO4UYNF0VT3LvP_Cl4EIEyVk-Q5DP3" class="ga-featured ga-youtube" target="blank_" > 
