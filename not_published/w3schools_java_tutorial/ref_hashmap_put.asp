...
<html lang="en-US">
<head>
<title>Java HashMap put() Method</title>
<meta charset="utf-8">
...
<h1>Java HashMap <span class="color_h1">put()</span> Method</h1>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_hashmap_put">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">put()</code> method writes an entry into the map. If an entry with the same key already exists then the value of that entry will be changed.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public V put(K <em>key</em>, V <em>value</em>)</code></pre>
...
<tr>
 ...
 <td style="width:80%">If an entry already existed with the specified key then it returns the value of that entry before overwriting it, otherwise it returns <code class="w3-codespan">null</code>.</td>
</tr>
</table>
<hr>
