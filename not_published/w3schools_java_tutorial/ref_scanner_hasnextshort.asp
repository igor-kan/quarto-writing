...
<html lang="en-US">
<head>
<title>Java Scanner hasNextShort() Method</title>
<meta charset="utf-8">
...
<h1>Java Scanner <span class="color_h1">hasNextShort()</span> Method</h1>
...
<p>The <code class="w3-codespan">hasNextShort()</code> method returns <em>true</em> if the next token represents a number that can be stored by the <code class="w3-codespan">short</code> data type, which is any whole number between -32,768 and 32,767.</p>
...
<p>If the <em>radix</em> parameter is used, then it interprets numbers using the radix. For example, a radix of 16 would interpret numbers as hexadecimal (digits 0 to 9 and A to F). If the <em>radix</em> parameter is not used then it interprets numbers using the scanner's radix, which is 10 by default but it can be changed with the <code class="w3-codespan"><a href="ref_scanner_usedelimiter.asp">useRadix()</a></code> method.</p>
...
<pre class="language-java"><code>public boolean hasNextShort()</code></pre>
<pre class="language-java"><code>public boolean hasNextShort(int <em>radix</em>)</code></pre>
...
<tr>
 ...
 <td style="width:80%">A <code class="w3-codespan">boolean</code> value which is true if the next token represents a <code class="w3-codespan">short</code> value.</td>
</tr>
<tr>
