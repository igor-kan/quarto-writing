...
<html lang="en-US">
<head>
<title>Java LinkedList sort() Method</title>
<meta charset="utf-8">
...
<h1>Java LinkedList <span class="color_h1">sort()</span> Method</h1>
...
<h3>Example</h3>
<p>Sort a list in alphabetical order:</p>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_linkedlist_sort">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">sort()</code> method sorts items in the list. A <code class="w3-codespan">Comparator</code> can be used to compare pairs of elements. The comparator can be defined by a lambda expression which is compatible with the <code class="w3-codespan">compare()</code> method of Java's <code class="w3-codespan">Comparator</code> interface.</p>
<p>If <code class="w3-codespan">null</code> is passed into the method then items will be sorted naturally based on their data type (e.g. alphabetically for strings, numerically for numbers). Non-primitive types must implement Java's <code class="w3-codespan">Comparable</code> interface in order to be sorted without a comparator.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public void sort(Comparator <em>compare</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>compare</em></td>
    <td>Required. A comparator or lambda expression which compares pairs of items in the list. Pass <code class="w3-codespan">null</code> to compare items naturally by their data type.</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Use a lambda expression to sort a list in reverse alphabetical order:</p>
<pre class="w3-white language-java"><code>import java.util.LinkedList;
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_linkedlist_sort2">Try it Yourself &raquo;</a></p>
</div>
