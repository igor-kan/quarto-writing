...
<h1>Java <span class="color_h1">BufferedReader</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_fileoutputstream.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_bufferedwriter.asp">Next &#10095;</a>
</div>
<hr>

<h2>BufferedReader and BufferedWriter</h2>
<p><code class="w3-codespan">BufferedReader</code> and <code class="w3-codespan">BufferedWriter</code> make reading and writing <strong>text files</strong> faster.</p>

<ul>
  <li><code class="w3-codespan">BufferedReader</code> lets you read text <strong>line by line</strong> with <code class="w3-codespan">readLine()</code>.</li>
  <li><code class="w3-codespan">BufferedWriter</code> lets you write text efficiently and add new lines with <code class="w3-codespan">newLine()</code>.</li>
</ul>

<p>These classes are usually combined with <code class="w3-codespan">FileReader</code> and <code class="w3-codespan">FileWriter</code>, 
which handle opening or creating the file. The buffered classes then make reading/writing <strong>faster</strong> by using a memory buffer.</p>
<hr>

<h2>Read a Text File (Line by Line)</h2>
<p>Use <code class="w3-codespan">BufferedReader</code> with <code class="w3-codespan">FileReader</code> to read each line of a file:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white" data-line="7"><code>import java.io.BufferedReader;
...
<code>
Some text from filename.txt</code>
</div>
<p><a target="_blank" class="w3-btn" href="showjava.asp?filename=demo_bufferedreader">Run Example &raquo;</a></p>
</div>
<hr>

<!--
<h2>Try-with-Resources</h2>
<p>All examples above use <strong>try-with-resources</strong>, which automatically closes the reader/writer for you.</p>
<div class="ws-note ws-panel">
<p><strong>Tip:</strong> Always close streams. Try-with-resources is the easiest way to avoid leaks.</p>
</div>
<hr>
-->
...
<hr>
<h2>Comparing File Reading Classes</h2>
<p>Java gives you several ways to read files. Here's when to pick each one:</p>

<ul>
  <li><a href="java_files_read.asp"><code class="w3-codespan">Scanner</code></a> - best for <strong>simple text</strong>. It can split text into lines, words, or numbers (e.g., <code class="w3-codespan">nextInt()</code>, <code class="w3-codespan">nextLine()</code>).</li>
  <li><code class="w3-codespan">BufferedReader</code> - best for <strong>large text files</strong>. It is faster, uses less memory, and can read full lines with <code class="w3-codespan">readLine()</code>.</li>
  <li><a href="java_fileinputstream.asp"><code class="w3-codespan">FileInputStream</code></a> - best for <strong>binary files</strong> (like images, PDFs, or audio)</li>
</ul>
<!--
<h2>Using Files Helper Methods (NIO)</h2>
<p>Modern Java also provides helpers in <code class="w3-codespan">java.nio.file.Files</code> for quick text I/O:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>import java.nio.file.Files;
...
public class Main {
  public static void main(String[] args) throws IOException {
    ...
    // Write (overwrites)
    Files.write(p, List.of("Line A", "Line B"));
  }
}
</code></pre>
<p><a target="_blank" class="w3-btn w3-margin-bottom" href="tryjava.asp?filename=demo_files_read_write">Try it Yourself &raquo;</a></p>
</div>
<p><strong>Note:</strong> These helpers are convenient for small/medium text files. For large files, prefer streaming with readers/writers.</p>
<hr>
<div class="ws-note ws-panel">
<h4>Common Errors</h4>
<ul>
  <li><strong>FileNotFoundException</strong> - happens if the file path is wrong or the file does not exist when trying to read it.</li>
  <li><strong>Access denied</strong> - you might not have permission to read or write in the folder (especially on system directories).</li>
  <li><strong>Overwriting files</strong> - <code class="w3-codespan">FileWriter</code> and <code class="w3-codespan">FileOutputStream</code> replace the file by default. Use append mode (<code class="w3-codespan">true</code>) if you don't want to lose data.</li>
  <li><strong>Wrong working directory</strong> - if you just write <code class="w3-codespan">"notes.txt"</code>, Java will look in the project's working directory. Use an absolute path if you are not sure.</li>
</ul>
</div>-->
