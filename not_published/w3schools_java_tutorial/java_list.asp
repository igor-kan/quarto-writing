...
<h1>Java <span class="color_h1">List</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_collections.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_arraylist.asp">Next &#10095;</a>
</div>
<hr>

<h2>Java List Interface</h2>
<p>The <code class="w3-codespan">List</code> interface is part of the <a href="java_collections.asp">Java Collections Framework</a> and represents an <strong>ordered collection</strong> of elements.</p>

<p>You can access elements by their index, add duplicates, and maintain the insertion order.</p>

<p>Since List is an interface, you cannot create a List object directly.</p>
<p>Instead, you use a class that implements the <code class="w3-codespan">List</code> interface, such as:</p><ul>
  <li><a href="java_arraylist.asp"><code class="w3-codespan">ArrayList</code></a> - like a resizable array with fast random access</li>
  <li><a href="java_linkedlist.asp"><code class="w3-codespan">LinkedList</code></a> - like a train of cars you can easily attach or remove</li>
</ul>

<div class="ws-note ws-panel">
  <p><strong>Tip:</strong> Use <code class="w3-codespan">List</code> when you care about order, you may have duplicates, and want to access elements by index.</p>
</div>
<hr>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><code class="w3-codespan">get()</code></td>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td>Faster performance for raw data</td>
    <td>More flexible and feature-rich</td>
  </tr>
  <tr>
    <td>Not part of Collections Framework</td>
    <td>Part of the Collections Framework</td>
  </tr>
</table>
...
<p>In the next chapters, you will learn how to use <a href="java_arraylist.asp"><code class="w3-codespan">ArrayList</code></a> and <a href="java_linkedlist.asp"><code class="w3-codespan">LinkedList</code></a>.</p>
