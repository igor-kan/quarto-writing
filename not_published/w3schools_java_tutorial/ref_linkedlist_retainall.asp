...
<html lang="en-US">
<head>
<title>Java LinkedList retainAll() Method</title>
<meta charset="utf-8">
...
<h1>Java LinkedList <span class="color_h1">retainAll()</span> Method</h1>
...
<h3>Example</h3>
<p>Remove items from a list which do not belong to a specified collection:</p>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_linkedlist_retainall">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">retainAll()</code> method removes all items from a list which <strong>do not</strong> belong to a specified collection.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public boolean retainAll(Collection <em>items</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>items</em></td>
    <td>Required. A collection containing the items to keep in the list while all others are removed.</td>
  </tr>
</table>
