...
<html lang="en-US">
<head>
<title>Java Math log1p() Method</title>
<meta charset="utf-8">
...
<h1>Java Math <span class="color_h1">log1p()</span> Method</h1>
...
<h3>Example</h3>
<p>Return the natural logarithm of 1 + x for different values of x:</p>
<pre class="w3-white language-java"><code>System.out.println(Math.log1p(6));
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_math_log1p">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">log1p()</code> method returns the natural logarithm of 1 + x for any number x.</p>
<p>The natural logarithm is the logarithm with base <em>e</em>. The value of <em>e</em> is approximately 2.718282 and it is available as the constant <code class="w3-codespan">Math.E</code> in Java.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public static double log1p(double <em>number</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>number</em></td>
    <td>Required. A value greater than or equal to -1. If the value is less than -1 the method returns NaN (Not a Number).</td>
  </tr>
</table>
...
<tr>
  ...
  <td style="width:80%">A <code class="w3-codespan">double</code> value representing the natural logarithm of 1 + x for a number x.</td>
</tr>
<tr>
