...
<html lang="en-US">
<head>
<title>Java BufferedReader Reference</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1">BufferedReader Methods</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_ref_fileoutputstream.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_ref_bufferedwriter.asp">Next &#10095;</a>
</div>
<hr>

<h2>BufferedReader Methods</h2>
<p>The <code class="w3-codespan">BufferedReader</code> class provides methods to read text efficiently:</p>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td>close()</td>
    <td>Closes the stream and releases system resources</td>
    <td>void</td>
  </tr>
  <tr>
    <td>mark()</td>
    <td>Marks the current position in the stream</td>
    <td>void</td>
  </tr>
  <tr>
    <td>markSupported()</td>
    <td>Checks if <code class="w3-codespan">mark()</code> and <code class="w3-codespan">reset()</code> are supported</td>
    <td>boolean</td>
  </tr>
  <tr>
    <td>read()</td>
  ...
  <tr>
    <td>read()</td>
    <td>Reads characters into an array or a portion of an array</td>
    <td>int</td>
  </tr>
  <tr>
    <td>readLine()</td>
    <td>Reads one full line of text</td>
    <td>String</td>
  </tr>
  <tr>
    <td>ready()</td>
  ...
  <tr>
    <td>reset()</td>
    <td>Resets the stream to the last marked position</td>
    <td>void</td>
  </tr>
  <tr>
    <td>skip()</td>
    <td>Skips over characters in the stream</td>
    <td>long</td>
  </tr>
  <tr>
    <td>lines()</td>
    <td>Returns a <code class="w3-codespan">Stream&lt;String&gt;</code> of all lines</td>
    <td>Stream&lt;String&gt;</td>
  </tr>
  <tr>
    <td>transferTo()</td>
    <td>Reads all characters and writes them to the given writer</td>
    <td>long</td>
  </tr>
</table>
...
<h2>Related Pages</h2>
<p><a href="java_io_streams.asp">Java I/O Streams Tutorial</a></p>
<p><a href="java_bufferedreader.asp">Java BufferedReader Tutorial</a></p>
