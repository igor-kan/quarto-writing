...
<h1>Java <span class="color_h1">Data Structures</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_bufferedwriter.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_collections.asp">Next &#10095;</a>
</div>
<hr>

<h2>Java Data Structures</h2>

<p>Data structures are ways to store and organize data so you can use it efficiently.</p>

<p>An <a href="java_arrays.asp">array</a> is an example of a data structure, which allows multiple elements to be stored in a single variable.</p>

<p></p>Java includes many other data structures as well, in the <code class="w3-codespan">java.util</code> package. Each is used to handle data in different ways.

<p>Some of the most common are:</p>
<ul>
<li><code class="w3-codespan">ArrayList</code></li>
<li><code class="w3-codespan">HashSet</code></li>
<li><code class="w3-codespan">HashMap</code></li>
</ul>

<div class="ws-note w3-panel">
  <p><strong>Tip:</strong> Data structures are like supercharged arrays - more flexible and feature-rich!</p>
</div>

<p>We'll explore all of these - and many more - in detail later, but for now, here's a quick introduction to each one.</p>
<hr>

<h2>ArrayList</h2>
<p>
  An <code class="w3-codespan">ArrayList</code> is a resizable array that can grow as needed.</p>
  <p>It allows you to store elements and access them by index.
</p>
<div class="w3-example">
  <h3>Example</h3>
  <pre class="language-java w3-white"><code>// Import the ArrayList class
...
public class Main {
  ...
  <p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_data_structure_arraylist">Try it Yourself &raquo;</a></p>
</div>

<hr>

<h2>HashSet</h2>
<p>A <code class="w3-codespan">HashSet</code> is a collection where every element is unique - no duplicates are allowed.</p>
<div class="w3-example">
  <h3>Example</h3>
...
public class Main {
  ...
  <p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_data_structure_hashset">Try it Yourself &raquo;</a></p>
</div>
<p><strong>Note:</strong> In the example above, even though BMW is added twice it only appears once in the set because every element in a set has to be unique.</p>
...
<h2>HashMap</h2>
<p>A <code class="w3-codespan">HashMap</code> stores <strong>key-value pairs</strong>, which are great when you want to store values and find them by a key (like a name or ID):</p>
<div class="w3-example">
  <h3>Example</h3>
...
public class Main {
  ...
  <p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_data_structure_hashmap">Try it Yourself &raquo;</a></p>
</div>
<hr>
...
<div class="w3-responsive">
  <table class="ws-table-all w3-bordered">
    ...
    <tr>
      ...
      <td>Yes</td>
      <td>Yes</td>
      <td>Accessing elements by index</td>
    </tr>
    <tr>
      <td>HashSet</td>
      ...
      <td>No</td>
      <td>No</td>
      <td>Avoiding duplicates, fast checks</td>
    </tr>
    <tr>
      <td>HashMap</td>
      <td>Key-value pairs</td>
      <td>No</td>
      <td>Yes (keys are unique)</td>
...
<h2>Queue</h2>
<p>
  A <code>Queue</code> follows the First-In-First-Out (FIFO) principle. In Java, you can implement a queue using the <code>Queue</code> interface, often with a <code>LinkedList</code>.
</p>
<div class="w3-example">
  <h3>Example: Using Queue</h3>
  <pre class="language-java w3-white"><code>import java.util.LinkedList;
import java.util.Queue;

public class ExampleQueue {
  public static void main(String[] args) {
    // Create a Queue of Strings using LinkedList
    Queue&lt;String&gt; queue = new LinkedList&lt;&gt;();
    queue.add("First");
    queue.add("Second");
    queue.add("Third");

    // Process the queue: remove and print each element
    while (!queue.isEmpty()) {
  ...
  <p><a target="_blank" class="w3-btn" href="">Try it Yourself &raquo;</a></p>
</div>
<p>
  Here, the <code>Queue</code> is implemented using a <code>LinkedList</code>. The <code>poll()</code> method retrieves and removes the head of the queue.
</p>
...
<h2>Stack</h2>
<p>
  A <code>Stack</code> follows the Last-In-First-Out (LIFO) principle. Java provides a built-in <code>Stack</code> class for this purpose.
</p>
<div class="w3-example">
  <h3>Example: Using Stack</h3>
  <pre class="language-java w3-white"><code>import java.util.Stack;
...
<p>
  This example demonstrates a <code>Stack</code> where the last element pushed is the first one popped off.
</p>
...
-->
<h2>Iterators</h2>
<p>When learning about data structures, you will often hear about iterators too.</p>
<p>An iterator is a way to loop through elements in a data structure.</p>
<p>It is called an &quot;iterator&quot; because &quot;iterating&quot; is the technical term for 
looping.</p>
<div class="w3-example">
  <h3>Example</h3>
  <p>Using an Iterator with ArrayList:</p>
...
public class Main {
  ...
  <p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_data_structure_iterator">Try it Yourself &raquo;</a></p>
</div>
