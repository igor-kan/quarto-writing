...
<h1>Java <span class="color_h1">Map</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_linkedhashset.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_hashmap.asp">Next &#10095;</a>
</div>
<hr>

<h2>Java Map Interface</h2>
<p>The <code class="w3-codespan">Map</code> interface is a part of the <a href="java_collections.asp">Java Collections Framework</a> and is used to store <strong>key-value pairs</strong>. Each key must be unique, but values can be duplicated.</p>

<p>A <code class="w3-codespan">Map</code> is useful when you want to associate a key (like a name or ID) with a value (like an age or description).</p>

<p>Common classes that implement <code class="w3-codespan">Map</code>:</p>
<ul>
  <li><a href="java_hashmap.asp"><code class="w3-codespan">HashMap</code></a> - fast and unordered</li>
  <li><a href="java_treemap.asp"><code class="w3-codespan">TreeMap</code></a> - sorted by key</li>
  <li><a href="java_linkedhashmap.asp"><code class="w3-codespan">LinkedHashMap</code></a> - ordered by insertion</li>
</ul>

<div class="ws-note ws-panel">
  <p><strong>Tip:</strong> Use a <code class="w3-codespan">Map</code> when you want to associate values with unique keys, like storing user IDs with names.</p>
</div>
<hr>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><code class="w3-codespan">put()</code></td>
  ...
  <tr>
    ...
    <td>Removes the key and its value</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">containsKey()</code></td>
    <td>Checks if the map contains the key</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">keySet()</code></td>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    ...
    <td>No (unless using TreeMap or LinkedHashMap)</td>
  </tr>
</table>

<p>Next, we'll look at how to use <code class="w3-codespan">HashMap</code> to store items in key/value pairs.</p>
