...
<html lang="en-US">
<head>
<title>Java System Reference</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1">System Methods</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_ref_collections.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_ref_errors.asp">Next &#10095;</a>
</div>
<hr>

<h2>System Methods</h2>
<p>The <code class="w3-codespan">System</code> class contains several useful methods for input, output, properties, time, and memory management.</p>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    ...
    <td>Returns the current time in milliseconds since January 1, 1970 (Unix epoch)</td>
    <td>long</td>
  </tr>

  <tr>
    <td>nanoTime()</td>
    <td>Returns the current value of the most precise available system timer, in nanoseconds</td>
    <td>long</td>
  </tr>

  <tr>
    <td>exit()</td>
    <td>Terminates the running Java program. A nonzero status indicates abnormal termination</td>
    <td>void</td>
  </tr>

  <tr>
    <td>gc()</td>
    <td>Suggests that the Java Virtual Machine run the garbage collector</td>
    <td>void</td>
  </tr>
  <tr>
    <td>getProperty()</td>
    <td>Gets the system property indicated by the key, or returns the default value if not found</td>
    <td>String</td>
  </tr>

  <tr>
    <td>getProperties()</td>
    <td>Returns all system properties as a <code class="w3-codespan">Properties</code> object</td>
    <td>Properties</td>
  </tr>

  <tr>
    <td>setProperty()</td>
    <td>Sets the system property indicated by the key</td>
    <td>String</td>
  </tr>

  <tr>
    <td>clearProperty()</td>
    <td>Removes the system property indicated by the key</td>
    <td>String</td>
  </tr>

  <tr>
    <td>arraycopy()</td>
    <td>Copies elements from the source array into the destination array</td>
    <td>void</td>
  </tr>

  <tr>
    <td>identityHashCode()</td>
    <td>Returns the default hash code of the given object (even if <code class="w3-codespan">hashCode()</code> is overridden)</td>
    <td>int</td>
  </tr>

  <tr>
    <td>lineSeparator()</td>
    <td>Returns the system-dependent line separator string (e.g., <code>"\n"</code> on Linux, <code>"\r\n"</code> on Windows)</td>
    <td>String</td>
  </tr>

  <tr>
    <td>getenv()</td>
    <td>Returns an unmodifiable map of the system environment variables</td>
    <td>Map&lt;String,String&gt;</td>
  </tr>

  <tr>
    <td>getenv()</td>
    <td>Returns the value of the specified environment variable, or <code>null</code> if it does not exist</td>
    <td>String</td>
  </tr>

  <tr>
    <td>in</td>
    <td>Standard input stream (usually the keyboard)</td>
    <td>InputStream</td>
  </tr>

  <tr>
    <td>out</td>
    <td>Standard output stream (usually the console). Often used with <code class="w3-codespan">println()</code></td>
    <td>PrintStream</td>
  </tr>

  <tr>
    <td>err</td>
    <td>Standard error output stream (usually the console)</td>
    <td>PrintStream</td>
  </tr>
</table>
</div>
