...
<html lang="en-US">
<head>
<title>Java Output printf() Method</title>
<meta charset="utf-8">
...
<h1>Java Output <span class="color_h1">printf()</span> Method</h1>

<p>
<a class="w3-btn w3-white w3-border" href="java_ref_output.asp">&#10094; Output Methods</a>
</p>
...
<h3>Example</h3>
<p>Print some formatted text to the console.</p>
<p>The <code class="w3-codespan">%s</code> character is a placeholder for the string "World":</p>
<pre class="w3-white language-java"><code>System.out.printf(&quot;Hello %s!&quot;, &quot;World&quot;);</code></pre>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_output_printf">Try it Yourself &raquo;</a></p>
</div>
<p><strong>Note:</strong> You will find more "Try it Yourself" examples at the bottom of this page.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">printf()</code> method outputs a formatted string.</p>
<p>Data from the additional arguments is formatted and written into placeholders 
in the formatted string, which are marked by a <code class="w3-codespan">%</code> symbol. The way in which arguments 
are formatted depends on the sequence of characters that follows the <code class="w3-codespan">%</code> symbol.</p>
...
<ul>
  ...
  <li><code class="w3-codespan">flags</code> - Optional. A sequence of any of the following characters:
    <ul>
      ...
      <li><code class="w3-codespan">,</code> - Groups digits (for example by thousands) and puts separators between the groups.</li>
    </ul>
  </li>
...
<tr>
  ...
  <td>
    ...
    <p><strong>Note:</strong> For any data other than positive integers this does not represent its real value.</p>
...
<h2>Syntax</h2>
<pre class="language-java"><code>System.out.printf(<em>locale</em>, <em>formatString</em>, <em>args</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    ...
    <td>
      ...
      indicating how to format them</td>
  </tr>
  <tr>
    <td><em>args</em></td>
    <td>Optional. Any number of additional arguments to the method, their values can be formatted and displayed in the 
    <em>formatString</em>.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">A <code class="w3-codespan">PrintStream</code> object.</td>
</tr>
<tr>
...
<div class="w3-example">
<h3>Example</h3>
<p>Print a formatted text containing a string and an integer:</p>
<pre class="w3-white language-java"><code>System.out.printf(&quot;Hello %s! One kilobyte is %,d bytes.&quot;, &quot;World&quot;, 1024);</code></pre>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_output_printf2">Try it Yourself &raquo;</a></p>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Format a floating point number in different ways:</p>
<pre class="w3-white language-java"><code>// Default
...
System.out.printf(&quot;%.2e&quot;, 123456.78);</code></pre>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_output_printf5">Try it Yourself &raquo;</a></p>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>A placeholder which uses all of the components:</p>
<pre class="w3-white language-java"><code>System.out.printf(&quot;%2$,3.2f %1$s&quot;, &quot;meters&quot;, 1260.5052);</code></pre>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_output_printf3">Try it Yourself &raquo;</a></p>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Use arguments in a different order:</p>
<pre class="w3-white language-java"><code>System.out.printf(&quot;%3$c %2$c %1$c&quot;, 'a', 'b', 'c');</code></pre>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_output_printf4">Try it Yourself &raquo;</a></p>
</div>
...
System.out.printf(&quot;%tc%n&quot;, date);</code></pre>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_output_printf6">Try it Yourself &raquo;</a></p>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Represent characters from their unicode code points:</p>
<pre class="w3-white language-java"><code>// Represent characters from their unicode code points
System.out.printf(&quot;%c%c%c%c%c%n&quot;, 72, 101, 108, 108, 111);

// Force unicode characters to uppercase
System.out.printf(&quot;%C%C%C%C%C&quot;, 72, 101, 108, 108, 111);</code></pre>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_output_printf7">Try it Yourself &raquo;</a></p>
</div>
