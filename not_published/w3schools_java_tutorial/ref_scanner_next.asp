...
<html lang="en-US">
<head>
<title>Java Scanner next() Method</title>
<meta charset="utf-8">
...
<h1>Java Scanner <span class="color_h1">next()</span> Method</h1>
...
<h3>Example</h3>
<p>Display the next token from the scanner:</p>
...
<p>The <code class="w3-codespan">next()</code> method returns a string containing the next token in the scanner.</p>
<p>If the <em>pattern</em> parameter is used, then it will throw an exception when the token does not match the regular expression specified by the parameter.</p>
...
<pre class="language-java"><code>public String next()</code></pre>
<pre class="language-java"><code>public String next(Pattern <em>pattern</em>)</code></pre>
<pre class="language-java"><code>public String next(String <em>pattern</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>pattern</em></td>
    <td>Optional. Specifies a regular expression that the next token must match in order to be valid.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">A <code class="w3-codespan">String</code> containing the next token in the scanner.</td>
</tr>
<tr>
 <th style="width:20%">Throws:</th>
 <td style="width:80%">
  <code class="w3-codespan">InputMismatchException</code> - If the token does not match the regular expression.<br>
