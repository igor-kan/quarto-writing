...
<html lang="en-US">
<head>
<title>Java LinkedList getFirst() Method</title>
<meta charset="utf-8">
...
<h1>Java LinkedList <span class="color_h1">getFirst()</span> Method</h1>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_linkedlist_getfirst">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">getFirst()</code> method returns the first item in a list.</p>
<p><strong>Tip:</strong> Use the <a href="ref_linkedlist_getlast.asp"><code class="w3-codespan">getLast()</code></a> method to get the last item 
in a list.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public T getFirst()</code></pre>
...
<tr>
 ...
 <td style="width:80%">The first element in the list</td>
</tr>
<tr>
