...
<h1>Java <span class="color_h1">Interview Questions</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_study_plan.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="default.asp">Next &#10095;</a>
</div>
<hr>

<h2>Java Interview Questions with Answers</h2>
...
<ul>
  ...
  <li>Java 8 and later features</li>
  <li>Practical coding and debugging</li>
</ul>

<hr>

<h2 class="interview-h2">Core Java Basics</h2>

<h3>1. What is a String in Java?</h3>
<p><strong>Answer:</strong></p>
<ul>
  <li>A String is used to store text.</li>
  <li>Examples: <code class="w3-codespan">"Hello"</code>, <code class="w3-codespan">"Java"</code>.</li>
</ul>
<hr>

<h3>2. What is the difference between == and equals()?</h3>

<p><strong>Answer:</strong></p>
<ul>
  <li><code class="w3-codespan">==</code> checks if two values come from the exact same object.</li>
  <li><code class="w3-codespan">equals()</code> checks if two values have the same value.</li>
</ul>
<div class="w3-example">
  <pre class="language-java w3-white"><code>String a = new String("Java");
String b = new String("Java");

System.out.println(a == b);        // false, different objects
System.out.println(a.equals(b));   // true, same value</code></pre>
</div>

<hr>

<h3>3. What is the purpose of the main() method in Java?</h3>

<p><strong>Answer:</strong></p>
<ul>
  <li>This is where the program starts running. Java looks for main() to begin executing the code.</li>
  <li>The method must look like this: <code class="w3-codespan">public static void main(String[] args)</code>.</li>
</ul>
...
<h3>4. What is the difference between primitive types and wrapper classes?</h3>

<p><strong>Answer:</strong></p>
<ul>
  <li>Primitive types (like <code class="w3-codespan">int</code>, <code class="w3-codespan">double</code>, <code class="w3-codespan">boolean</code>) store simple values directly.</li>
  <li>Wrapper classes (like <code class="w3-codespan">Integer</code>, <code class="w3-codespan">Double</code>, <code class="w3-codespan">Boolean</code>) store these values inside objects.</li>
  <li>Wrapper objects are often used when you work with collections such as <code class="w3-codespan">ArrayList</code>.</li>
</ul>

<hr>

<h3>5. What are variables in Java?</h3>

<p><strong>Answer:</strong></p>
<ul>
  <li>A variable is a name that stores a value in memory.</li>
  <li>In Java, you must write the type of the variable before the name.</li>
</ul>

<div class="w3-example">
  <pre class="language-java w3-white"><code>int age = 35;
double price = 19.99;
String name = "Jenny";</code></pre>
</div>

<hr>

<h3>6. What are Java data types?</h3>

<p><strong>Answer:</strong></p>
<ul>
  <li><strong>Primitive types</strong> store simple values: <code class="w3-codespan">byte</code>, <code class="w3-codespan">short</code>, <code class="w3-codespan">int</code>, <code class="w3-codespan">long</code>, <code class="w3-codespan">float</code>, <code class="w3-codespan">double</code>, <code class="w3-codespan">char</code>, <code class="w3-codespan">boolean</code>.</li>
  <li><strong>Reference types</strong> point to objects, for example <code class="w3-codespan">String</code>, arrays, and your own classes.</li>
</ul>

<hr>

<h3>7. How do conditionals (if/else) work in Java?</h3>

<p><strong>Answer:</strong> Conditional statements let your program choose what to do based on <code class="w3-codespan">true</code> or <code class="w3-codespan">false</code> tests.</p>

<div class="w3-example">
  <pre class="language-java w3-white"><code>int score = 85;
...
<h3>8. What is a loop in Java?</h3>

<p><strong>Answer:</strong></p>
<ul>
  <li>A loop repeats the same block of code several times.</li>
  <li>Java has <code class="w3-codespan">for</code>, <code class="w3-codespan">while</code>, and <code class="w3-codespan">do...while</code> loops.</li>
</ul>

<div class="w3-example">
  <pre class="language-java w3-white"><code>for (int i = 1; i &lt;= 5; i++) {
...
<h3>9. What is type casting in Java?</h3>

<p><strong>Answer:</strong></p>
<ul>
  <li><strong>Widening casting</strong> is when a smaller type is changed to a bigger type (for example <code class="w3-codespan">int</code> to <code class="w3-codespan">long</code>). Java does this automatically.</li>
  <li><strong>Narrowing casting</strong> is when a bigger type is changed to a smaller type (for example <code class="w3-codespan">double</code> to <code class="w3-codespan">int</code>). You must write the cast yourself.</li>
</ul>

<div class="w3-example">
  <pre class="language-java w3-white"><code>double x = 9.7;
int y = (int) x;   // narrowing cast, y becomes 9</code></pre>
</div>

<hr>

<h3>10. What is the difference between final and const in Java?</h3>

<p><strong>Answer:</strong></p>
<ul>
  <li><code class="w3-codespan">final</code> is used to make a variable that cannot be changed after it gets a value.</li>
  <li><code class="w3-codespan">const</code> is a reserved word in Java, but you do not use it.</li>
</ul>

<div class="w3-example">
  <pre class="language-java w3-white"><code>final int MAX_LIMIT = 100;
// MAX_LIMIT = 200;  // Error: you cannot change a final variable</code></pre>
</div>

<hr>

<h2 class="interview-h2">Object-Oriented Programming</h2>

<h3>11. What are the four main OOP principles?</h3>

<p><strong>Answer:</strong></p>
<ul>
  <li><strong>Encapsulation</strong> - Keep the data inside the class and use methods to work with it.</li>
  <li><strong>Inheritance</strong> - One class can reuse code from another class.</li>
  <li><strong>Polymorphism</strong> - The same method name can do different things depending on the object.</li>
  <li><strong>Abstraction</strong> - Show only what the user needs, hide the details.</li>
</ul>

<hr>

<h3>12. What is the difference between an abstract class and an interface?</h3>

<p><strong>Answer:</strong></p>
<ul>
  <li>An <strong>abstract class</strong> can have normal methods with code, abstract methods without code, and fields.</li>
  <li>An <strong>interface</strong> is mainly a list of methods that a class must implement. From Java 8, interfaces can also have <code class="w3-codespan">default</code> and <code class="w3-codespan">static</code> methods with code.</li>
</ul>

<hr>

<h3>13. What is the difference between method overloading and method overriding?</h3>

<p><strong>Answer:</strong></p>
<ul>
  <li><strong>Overloading</strong> - Same method name in the same class, but different parameters.</li>
  <li><strong>Overriding</strong> - A child class replaces a method from the parent class with its own version.</li>
</ul>
...
<h2 class="interview-h2">Collections and Generics</h2>

<h3>14. What is the difference between List, Set, and Map?</h3>

<p><strong>Answer:</strong></p>
<ul>
  <li><strong>List</strong> - Keeps elements in order and can contain duplicates.</li>
  <li><strong>Set</strong> - Does not allow duplicate elements.</li>
  <li><strong>Map</strong> - Stores key and value pairs. Each key is unique and points to one value.</li>
</ul>

<hr>

<h3>15. What is the difference between ArrayList and LinkedList?</h3>

<p><strong>Answer:</strong></p>
<ul>
  <li><strong>ArrayList</strong> uses a growable array inside. It is fast for reading by index (like <code class="w3-codespan">list.get(0)</code>).</li>
  <li><strong>LinkedList</strong> uses nodes that link to each other. It can be faster for adding and removing elements in the middle of the list.</li>
</ul>

<hr>

<h3>16. Why do we use generics in Java?</h3>

<p><strong>Answer:</strong> Generics let you tell a collection what type it should hold. This helps you find type errors at compile time and removes many casts.</p>

<hr>

<h2 class="interview-h2">Exceptions and Error Handling</h2>

<h3>17. What is the difference between checked and unchecked exceptions?</h3>

<p><strong>Answer:</strong></p>
<ul>
  <li><strong>Checked exceptions</strong> must be handled with <code class="w3-codespan">try/catch</code> or declared with <code class="w3-codespan">throws</code>. Example: <code class="w3-codespan">IOException</code>.</li>
  <li><strong>Unchecked exceptions</strong> happen while the program is running and do not need to be declared. Example: <code class="w3-codespan">NullPointerException</code>.</li>
</ul>

<hr>

<h3>18. What is the purpose of the finally block?</h3>

<p><strong>Answer:</strong> A <code class="w3-codespan">finally</code> block is used for code that should run at the end of a <code class="w3-codespan">try</code> block, whether there was an exception or not. It is often used to close files or release other resources.</p>

<hr>

<h2 class="interview-h2">Multithreading and Concurrency</h2>

<h3>19. How do you create a thread in Java?</h3>

<p><strong>Answer:</strong></p>
<ul>
  <li>Extend the <code class="w3-codespan">Thread</code> class and override the <code class="w3-codespan">run()</code> method.</li>
  <li>Or implement the <code class="w3-codespan">Runnable</code> interface and pass the object to a <code class="w3-codespan">Thread</code> object.</li>
</ul>

<hr>

<h3>20. What is the difference between start() and run() in a thread?</h3>

<p><strong>Answer:</strong></p>
<ul>
  <li><code class="w3-codespan">run()</code> has the code that should be executed by the thread.</li>
  <li><code class="w3-codespan">start()</code> tells the JVM to create a new thread and then call <code class="w3-codespan">run()</code> in that new thread.</li>
  <li>If you call <code class="w3-codespan">run()</code> directly, the code runs in the current thread, not in a new one.</li>
</ul>

<div class="w3-example">
  <pre class="language-java w3-white"><code>class MyThread extends Thread {
  public void run() {
...
<h2 class="interview-h2">Java 8 and Later</h2>

<h3>21. What is a lambda expression?</h3>

<p><strong>Answer:</strong> A lambda expression is a short way to write a method as an expression. It is often used when you need to pass small pieces of code to methods, for example when working with streams.</p>

<hr>

<h3>22. What is the Java Stream API?</h3>

<p><strong>Answer:</strong> The Stream API lets you work with collections in a simple way. You can filter, sort, and change data step by step, instead of writing many loops by hand.</p>

<hr>

<h2 class="interview-h2">Practical Coding and Debugging</h2>

<h3>23. What is the purpose of printing debug messages?</h3>

<p><strong>Answer:</strong></p>
<ul>
  <li>Debug messages show you what the program is doing while it runs.</li>
  <li>They help you see the values of variables at different points in the code.</li>
  <li>In Java, you often print debug messages with <code class="w3-codespan">System.out.println()</code>.</li>
</ul>

<div class="w3-example">
  <pre class="language-java w3-white"><code>int total = 50;
System.out.println("Debug: total = " + total);</code></pre>
</div>

<hr>

<h3>24. What does the term syntax error mean?</h3>

<p><strong>Answer:</strong></p>
<ul>
  <li>A syntax error means the code does not follow the rules of the Java language.</li>
  <li>The compiler finds syntax errors before the program can run.</li>
  <li>Examples are missing semicolons or a missing closing brace.</li>
</ul>

<div class="w3-example">
  <pre class="language-java w3-white"><code>// Syntax error: missing semicolon
int x = 10</code></pre>
</div>

<hr>

<h3>25. What is a runtime error?</h3>

<p><strong>Answer:</strong></p>
<ul>
  <li>A runtime error happens when the program is running.</li>
  <li>The code compiles, but something goes wrong while it is running.</li>
  <li>Example: dividing by zero, or using an array index that is outside the array.</li>
</ul>

<div class="w3-example">
  <pre class="language-java w3-white"><code>// Runtime error: division by zero
int x = 10 / 0;   // causes ArithmeticException</code></pre>
</div>

<hr>

<h3>26. What is the recommended way to close resources?</h3>

<p><strong>Answer:</strong> The recommended way is to use a try-with-resources block. Java will then close the resource for you when the block ends.</p>

<div class="w3-example">
  <pre class="language-java w3-white"><code>try (BufferedReader br = new BufferedReader(new FileReader("data.txt"))) {
