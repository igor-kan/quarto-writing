...
<html lang="en-US">
<head>
<title>Java HashMap values() Method</title>
<meta charset="utf-8">
...
<h1>Java HashMap <span class="color_h1">values()</span> Method</h1>
...
<h3>Example</h3>
<p>Return all the values in a map:</p>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_hashmap_values">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">values()</code> method returns a collection containing all of the values in the map.</p>
<p><strong>Note:</strong> The returned collection is a <em>view</em> of the map, which means that changing the collection also changes the map.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public Collection&lt;V&gt; values()</code></pre>
...
<tr>
 ...
 <td style="width:80%">A collection containing all of the values in the map.</td>
</tr>
</table>
