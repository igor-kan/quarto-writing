...
<html lang="en-US">
<head>
<title>Java Scanner nextDouble() Method</title>
<meta charset="utf-8">
...
<h1>Java Scanner <span class="color_h1">nextDouble()</span> Method</h1>
...
<h3>Example</h3>
<p>Print the value of every floating point number in the string:</p>
...
<p>The <code class="w3-codespan">nextDouble()</code> method returns a <code class="w3-codespan">double</code> value containing the number represented by the next token.</p>
<p>The scanner is able to interpret digit groupings, such as using a comma for separating groups of 3 digits. The format of the groupings and the character used as a decimal point depend on the locale settings of the scanner, which can be changed with the <code class="w3-codespan"><a href="ref_scanner_uselocale.asp">useLocale()</a></code> method.</p>
...
<h2>Syntax</h2>
<pre class="language-java"><code>public double nextDouble()</code></pre>

<h2>Technical Details</h2>
<table class="ws-table-all">
<tr>
 <th style="width:20%">Returns:</th>
 <td style="width:80%">A <code class="w3-codespan">double</code> value containing the number represented by the token.</td>
</tr>
<tr>
 <th style="width:20%">Throws:</th>
 <td style="width:80%">
  <code class="w3-codespan">InputMismatchException</code> - If the token does not represent a valid number.<br>
