...
<html lang="en-US">
<head>
<title>Java I/O Streams (Input/Output Streams)</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1">I/O Streams</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_files_delete.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_fileinputstream.asp">Next &#10095;</a>
</div>
<hr>

<h2>I/O Streams (Input/Output Streams)</h2>
<p>You've already seen how to create, read, and write simple text files.</p>
<p>In Java, there is an important difference between working with the <a href="java_files.asp"><code class="w3-codespan">File</code></a> class and working with <strong>I/O Streams</strong> (Input/Output Stream):</p>

<ul>
  <li>
    The <code class="w3-codespan">File</code> class (from <code class="w3-codespan">java.io</code>) is used to <strong>get information about files and directories</strong>:
    <ul>
      <li>Does the file exist?</li>
      <li>What is its name or size?</li>
      <li>Create or delete files and folders</li>
    </ul>
    <p><strong>But:</strong> the <code class="w3-codespan">File</code> class does <em>not</em> read or write the contents of the file.</p>
  </li>
</ul>

<p>So far, we have used <code class="w3-codespan">FileWriter</code> for writing text and 
<code class="w3-codespan">Scanner</code> for reading text. These are easy to use, 
but they are mainly designed for simple <strong>text files</strong>.</p>

<p><strong>I/O Streams</strong> are more flexible, because they work with text <strong>and binary data</strong> (like images, audio, PDFs).</p>
...
<ul>
  <li>
    ...
    Work with raw binary data (like images, audio, and PDF files).<br>
    Examples: <a href="java_fileinputstream.asp"><code class="w3-codespan">FileInputStream</code></a>, <a href="java_fileoutputstream.asp"><code class="w3-codespan">FileOutputStream</code></a>.
  </li><br>
  <li>
    <strong>Character Streams</strong><br>
    Work with text (characters and strings). These streams automatically handle character encoding.<br>
    Examples: <code class="w3-codespan">FileReader</code>, <code class="w3-codespan">FileWriter</code>, 
    <a href="java_bufferedreader.asp"><code class="w3-codespan">BufferedReader</code></a>, <a href="java_bufferedwriter.asp"><code class="w3-codespan">BufferedWriter</code></a>.
  </li>
</ul>

<p><strong>Tip:</strong> Use character streams when working with text, and byte streams when working with binary data.</p>


<!--
<p><strong>Note:</strong> Streams that work with <strong>bytes</strong> are subclasses of 
<code class="w3-codespan">InputStream</code> and <code class="w3-codespan">OutputStream</code>. 
Streams that work with <strong>characters</strong> (like 
<code class="w3-codespan">BufferedReader</code> and <code class="w3-codespan">BufferedWriter</code>) 
are part of the <code class="w3-codespan">Reader</code> and <code class="w3-codespan">Writer</code> classes.</p>
-->
