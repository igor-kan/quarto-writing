...
<html lang="en-US">
<head>
<title>Java String equalsIgnoreCase() Method</title>
<meta charset="utf-8">
...
<h1>Java String <span class="color_h1">equalsIgnoreCase()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Compare strings to find out if they are equal, ignoring case differences:</p>
<pre class="language-java w3-white"><code>String myStr1 = &quot;Hello&quot;;
String myStr2 = &quot;HELLO&quot;;
String myStr3 = &quot;Another String&quot;;
System.out.println(myStr1.equalsIgnoreCase(myStr2)); // true
System.out.println(myStr1.equalsIgnoreCase(myStr3)); // false</code></pre>
<p>
  <a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_string_equalsignorecase">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>The <code class="w3-codespan">equalsIgnoreCase()</code> method compares two strings, ignoring lower case and upper case differences.</p> 
<p>This method returns true if the strings are equal, and false if not.</p>

<p><strong>Tip:</strong> Use the <a href="ref_string_comparetoignorecase.asp">compareToIgnoreCase()</a> method to compare two strings lexicographically, ignoring case differences.</p>

<hr>

<h2>Syntax</h2>

<pre class="language-java"><code>public boolean equalsIgnoreCase(String <em>anotherString</em>)
</code></pre>
...
<table class="ws-table-all notranslate"> 
  <tbody><tr>
    ...
    <tr>
    <td><em>anotherString</em></td>
    <td>A <code class="w3-codespan">String</code>, representing the other string 
    to be compared</td>
    </tr>
</tbody>
</table>
...
<tr>
 <th style="width:21%">Returns:</th>
  <td>A <code class="w3-codespan">boolean</code> value:
  <ul>
  <li><code class="w3-codespan">true</code> - if the strings are equal, ignoring 
  case differences</li>
  <li><code class="w3-codespan">false</code> - if the strings are not equal</li>
 </ul>
</tr>
</table>
<br>
