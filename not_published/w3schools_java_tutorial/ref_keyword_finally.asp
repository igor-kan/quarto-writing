...
<html lang="en-US">
<head>
<title>Java finally Keyword</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1"> finally</span> Keyword</h1>
<p>
...
<h3>Example</h3>
<p>Execute code, after try...catch, regardless of the result:</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_try_catch_finally">Try it Yourself &raquo;</a>
</p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">finally</code> keyword is used to execute code (used with exceptions 
- try..catch statements) no matter if there is an exception or not.</p>
<hr>
