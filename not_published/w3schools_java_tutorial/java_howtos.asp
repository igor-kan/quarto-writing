...
<h1>Java <span class="color_h1">How To's</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_exam.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_howto_add_two_numbers.asp">Next &#10095;</a>
</div>
<hr>

<h2>Java How To's</h2>
<p>These examples show how to solve common tasks in Java.</p>
<hr>

<h3>Numbers</h3>
<ul>
  <li><a href="java_howto_add_two_numbers.asp">Add Two Numbers</a> - Add two numbers and print the result.</li>
  <li><a href="java_howto_swap_two_variables.asp">Swap Two Variables</a> - Exchange values between two variables.</li>
  <li><a href="java_howto_even_or_odd.asp">Even or Odd Number</a> - Check if a number is even or odd.</li>
  <li><a href="java_howto_reverse_number.asp">Reverse a Number</a> - Reverse a number.</li>
  <li><a href="java_howto_pos_or_neg.asp">Positive or Negative</a> - Check if a number is positive or negative.</li>
  <li><a href="java_howto_find_square_root.asp">Square Root</a> - Find the square root of a number.</li>
  <li><a href="java_howto_area_of_rectangle.asp">Area of Rectangle</a> - Calculate the area of a rectangle.</li>
  <li><a href="java_howto_convert_celsius.asp">Convert Celsius to Fahrenheit</a> - Convert a temperature from Celsius to Fahrenheit.</li>
  <li><a href="java_howto_sum_of_digits.asp">Sum of Digits</a> - Add up the digits of a number.</li>
  <li><a href="java_howto_check_armstrong_number.asp">Armstrong Number</a> - Check Armstrong number.</li>
  <li><a href="java_howto_random_number.asp">Random Number</a> - Generate a random number.</li>
</ul>
<hr>

<h3>Strings</h3>
<ul>
  <li><a href="java_howto_count_words.asp">Count Words</a> - Count how many words are in a sentence.</li>
  <li><a href="java_howto_count_vowels_string.asp">Count Vowels in a String</a> - Count how many vowels are in a string.</li>
  <li><a href="java_howto_remove_vowels_string.asp">Remove Vowels from a String</a> - Remove vowels from a string.</li>
  <li><a href="java_howto_count_digits_string.asp">Count Digits in a String</a> - Count digits in a string.</li>
  <li><a href="java_howto_reverse_string.asp">Reverse a String</a> - Reverse the characters in a string.</li>
  <li><a href="java_howto_palindrome_check.asp">Palindrome Check</a> - Check if a string is the same forward and backward.</li>
  <li><a href="java_howto_check_anagram_strings.asp">Check Anagram Strings</a> - Check if two strings contain the same characters in different order.</li>
  <li><a href="java_howto_string_to_array.asp">Convert String to Array</a> - Split a string into an array of words.</li>
  <li><a href="java_howto_remove_whitespace.asp">Remove Whitespace</a> - Delete spaces, tabs, and newlines from a string.</li>
  <li><a href="java_howto_count_char_freq.asp">Count Character Frequency</a> - Count how many times each character appears in a string.</li>
</ul>
<hr>

<h3>Arrays</h3>
<ul>
  <li><a href="java_howto_sum_of_array_elements.asp">Sum of Array Elements</a> - Add all the elements in an array.</li>
  <li><a href="java_howto_calculate_avg_array.asp">Find Array Average</a> - Calculate the average value of array elements.</li>
  <li><a href="java_howto_sort_an_array.asp">Sort an Array</a> - Sort array elements.</li>
  <li><a href="java_howto_find_smallest_array_el.asp">Find Smallest Element</a> - Find the lowest value in an array.</li>
  <li><a href="java_howto_largest_el_array.asp">Find Largest Element</a> - Find the largest value in an array.</li>
  <li><a href="java_howto_second_largest_array.asp">Second Largest Array</a> - Find the second largest value in an array.</li>
  <li><a href="java_howto_min_max_array.asp">Min and Max in Array</a> - Find the minimum and maximum value in an array.</li>
  <li><a href="java_howto_merge_two_arrays.asp">Merge Two Arrays</a> - Combine two arrays into one.</li>
  <li><a href="java_howto_remove_duplicates_array.asp">Remove Duplicates</a> - Remove duplicates from an array using a Set.</li>
  <li><a href="java_howto_duplicate_elements_array.asp">Find Duplicates</a> - Find duplicate elements in an array.</li>
  <li><a href="java_howto_shuffle_array.asp">Shuffle an Array</a> - Randomize the order of array elements.</li>
</ul>
<hr>

<h3>Algorithms</h3>
<ul>
  <li><a href="java_howto_factorial.asp">Factorial of a Number</a> - Find the factorial of a number.</li>
  <li><a href="java_howto_fibonacci.asp">Fibonacci Sequence</a> - Print the first 10 Fibonacci numbers.</li>
  <li><a href="java_howto_find_gcd.asp">Find GCD</a> - Find the Greatest Common Divisor (GCD).</li>
  <li><a href="java_howto_check_prime_num.asp">Check Prime Number</a> - Check if a number is prime.</li>
</ul>
...
<h3>Collections</h3>
<ul>
  <li><a href="java_howto_loop_through_arraylist.asp">ArrayList Loop</a> - Loop through an ArrayList.</li>
  <li><a href="java_howto_loop_through_hashmap.asp">HashMap Loop</a> - Loop through a HashMap.</li>
  <li><a href="java_howto_loop_through_enum.asp">Loop Through an Enum</a> - Iterate over enum values.</li>
</ul>
