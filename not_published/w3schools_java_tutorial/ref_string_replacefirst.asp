...
<html lang="en-US">
<head>
<title>Java String replaceFirst() Method</title>
<meta charset="utf-8">
...
<h1>Java String <span class="color_h1">replaceFirst()</span> Method</h1>
...
<h3>Example</h3>
<p>Replace the first match of a regular expression with a different substring:</p>
<pre class="w3-white language-java"><code>String myStr = "This is W3Schools";
String regex = "is";
System.out.println(myStr.replaceFirst(regex, "at"));
</code></pre>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_string_replacefirst">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">replaceFirst()</code> method replaces the first match of a regular expression in a string with a new substring.</p>
<p>Replacement strings may contain a backreference in the form $n where n is the index of a group in the pattern. In the returned string, instances of $n will be replaced with the substring that was matched by the group or, if $0 is used, by the whole expression. See "More Examples" below for an example of using a backreference.</p>
<p><strong>Tip:</strong> See the <a href="java_regex.asp">Java RegEx</a> tutorial to learn about regular expressions.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public String replaceFirst(String <em>regex</em>, String <em>replacement</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>regex</em></td>
    <td>Required. A regular expression defining what substrings to search for.</td>
  </tr>
  <tr>
    <td><em>replacement</em></td>
    <td>Required. The substring which will replace the first match.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">A copy of the string in which the first substring that matches the regular expression is replaced with a new substring.</td>
</tr>
<tr>
 <th style="width:20%">Throws:</th>
 <td style="width:80%"><code class="w3-codespan">PatternSyntaxException</code> - If the syntax of the regular expression is incorrect.</td>
</tr>
<tr>
 <th style="width:20%">Java version:</th>
 <td style="width:80%">1.4</td>
</tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Use a backreference to wrap the first number in parentheses:</p>
<pre class="w3-white language-java"><code>String myStr = "Quest complete! Earned 30 gold and 500 experience.";
String regex = "[0-9]+";
System.out.println(myStr.replaceFirst(regex, "($0)"));
</code></pre>
<p><a target="_blank" class="w3-btn w3-margin-bottom" href="tryjava.asp?filename=demo_ref_string_replacefirst2">Try it Yourself &raquo;</a></p>
</div>
<br>
