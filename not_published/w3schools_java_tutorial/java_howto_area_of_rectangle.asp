...
<html lang="en-US">
<head>
<title>Java How To Calculate the Area of a Rectangle</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1">How To Get the Area of a Rectangle</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_howto_find_square_root.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_howto_convert_celsius.asp">Next &#10095;</a>
</div>
<hr>

<h2>Area of Rectangle</h2>
<p>The area of a rectangle can be found by multiplying the length of the 
rectangle by the width:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>int length = 5; 
int width = 2; 
int area = length * width; 
System.out.println(&quot;Area of rectangle: &quot; + area); </code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryjava.asp?filename=demo_howto_area_of_rectangle">Try it Yourself &raquo;</a>
</div>
<p><b>Explanation:</b> We store the rectangle's length and width in two variables.  
<br>Then we multiply them (<code class="w3-codespan">length * width</code>) to get the area.  
<br>Finally, we print the result, which in this example is <code class="w3-codespan">10</code>.</p>
<hr>
