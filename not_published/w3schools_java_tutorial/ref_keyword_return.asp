...
<html lang="en-US">
<head>
<title>Java return Keyword</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1"> return</span> Keyword</h1>
<p>
...
<h3>Example</h3>
<p>A method with a return value:</p>
...
<p>The <code class="w3-codespan">return</code> keyword finishes the execution of a method, and can be used to return a value from a method.</p>
<hr>

<h2>More Examples</h2>
<p><strong>Tip:</strong> Use the <code class="w3-codespan"><a href="ref_keyword_void.asp">void</a></code> keyword to specify that a method should not have a return value:</p>
<div class="w3-example">
<h3>Example</h3>
