...
<html lang="en-US">
<head>
<title>Java How To Remove Vowels from a String</title>
<meta charset="utf-8">
...
<h1>Java How To <span class="color_h1">Remove Vowels from a String</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_howto_count_vowels_string.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_howto_count_digits_string.asp">Next &#10095;</a>
</div>
<hr>

<h2>Remove Vowels from a String</h2>
<p>Delete all vowels (<code class="w3-codespan">a, e, i, o, u</code>) from a string (case-insensitive).</p>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_howto_remove_vowels_string">Try it Yourself &raquo;</a></p>
</div>

<p><b>Explanation:</b> The regular expression <code class="w3-codespan">[aeiouAEIOU]</code> matches all vowels (both lowercase and uppercase). Replacing them with an empty string removes them. For <code class="w3-codespan">&quot;Hello Java&quot;</code>, the result is <code class="w3-codespan">&quot;Hll Jv&quot;</code>.</p>
<hr>
