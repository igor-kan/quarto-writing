...
<h1>Java <span class="color_h1"> this</span> Keyword</h1>
<p>
...
<h3>Example</h3>
<p>Using <code class="w3-codespan">this</code> with a class attribute (x):</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_this">Try it Yourself &raquo;</a>
</p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">this</code> keyword refers to the current object in a method or constructor.</p>
<p>The most common use of the <code class="w3-codespan">this</code> keyword is to eliminate 
the confusion between class attributes and parameters with the same name (because a class attribute is shadowed by a method or constructor parameter). If you omit the keyword in the example above, the output would be "0" instead of "5".</p>
<p><code class="w3-codespan">this</code> can also be used to:</p>
<ul>
...
<h2>Related Pages</h2>
<p>Read more about objects in our <a href="java_classes.asp">Java Classes/Objects Tutorial</a>.</p>
<p>Read more about constructors in our <a href="java_constructors.asp">Java Constructors Tutorial</a>.</p>
<p>Read more about methods in our <a href="java_methods.asp">Java Methods Tutorial</a>.</p>
