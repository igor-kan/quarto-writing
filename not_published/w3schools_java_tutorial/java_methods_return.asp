...
<html lang="en-US">
<head>
<title>Java Return Values</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1">Return</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_methods_param.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_challenges_methods_param.asp">Next &#10095;</a>
</div>
<hr>

<h2>Return Values</h2>
<p>In the <a href="java_methods_param.asp">previous page</a>, we used the <code class="w3-codespan">void</code> keyword in all examples (like <code class="w3-codespan">static <strong>void</strong> myMethod(int x)</code>), which indicates that the method should not return a value.</p>
<p>If you want the method to return a value, you can use a primitive data type (such as <code class="w3-codespan">int</code>, 
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_method_void">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_method_void2">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_method_void3">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>Here is a simple and fun "game example" using a method that returns a value, 
to show the double of the numbers 1 through 5 (using a <code class="w3-codespan">for</code> loop):</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_method_return_game">Try it Yourself &raquo;</a>
</p>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_methods_return.js"></div>
<hr>
