...
<html lang="en-US">
<head>
<title>Java LinkedList clear() Method</title>
<meta charset="utf-8">
...
<h1>Java LinkedList <span class="color_h1">clear()</span> Method</h1>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_linkedlist_clear">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">clear()</code> removes all items from the list.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public void clear()</code></pre><hr>
