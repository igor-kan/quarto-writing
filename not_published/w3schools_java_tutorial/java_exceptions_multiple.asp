...
<html lang="en-US">
<head>
<title>Java Multiple Exceptions</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1">Multiple Exceptions</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_try_catch.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_try_catch_resources.asp">Next &#10095;</a>
</div>
<hr>

<h2>Multiple Exceptions</h2>
<p>Sometimes, different errors (exceptions) can happen in the same <code class="w3-codespan">try</code> block. 
You can handle them with <strong>multiple catch blocks</strong>.</p>

<hr>

<h2>One try, Many catch</h2>
<p>You can add more than one <code class="w3-codespan">catch</code> block, and Java will run the first one that matches the thrown exception type:</p>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_exceptions_multiple">Try it Yourself &raquo;</a></p>
</div>
<p><strong>Explanation:</strong> Only the first exception (<code class="w3-codespan">ArrayIndexOutOfBoundsException</code>) is thrown, so only the first matching <code class="w3-codespan">catch</code> runs.</p>

<hr>

<h2>Order Matters</h2>
<p>You should always put <strong>more specific exceptions first</strong>, and <strong>general ones later</strong>. 
Otherwise, the general catch will grab the error and the specific ones will never run:</p>

<div class="w3-example">
<h3>Example (bad order)</h3>
<pre class="language-java w3-white" data-line="8"><code>try {
  int result = 10 / 0;
} 
catch (Exception e) {
...
<p><strong>Tip:</strong> Always put <code class="w3-codespan">Exception</code> (the general one) 
at the <strong>end</strong>.</p>
</div>

<hr>

<h2>Multi-Catch</h2>
<p>Since Java 7, you can catch <strong>multiple exceptions in one catch block</strong> using the <code class="w3-codespan">|</code> symbol. 
This is useful when different exceptions should be handled in the <strong>same way</strong>, so you don't have to repeat code:</p>
<div class="w3-example">
<h3>Example</h3>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_exceptions_multiple2">Try it Yourself &raquo;</a></p>
</div>
