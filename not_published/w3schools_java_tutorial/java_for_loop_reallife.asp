...
<html lang="en-US">
<head>
<title>Java Real-Life For Loop Examples</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1">For Loop Examples</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_foreach_loop.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_challenges_for_loop.asp">Next &#10095;</a>
</div>
<hr>

<h2>Real-Life Examples</h2>
<p>To demonstrate a practical example of the <strong>for loop</strong>, let's create a program that counts to 100 by tens:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>for (int i = 0; i &lt;= 100; i += 10) {
  System.out.println(i);
} </code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_for_loop_reallife">Try it Yourself &raquo;</a>
</p>
</div>

<p>In this example, we create a program that only print even values between 0 and 10:</p>
<div class="w3-example">
<h3>Example</h3>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_for_loop_reallife2">Try it Yourself &raquo;</a>
</p>
</div>
...
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>int number = 2;
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_for_loop_reallife3">Try it Yourself &raquo;</a>
</p>
</div>

<p>Here is a simple program that prints the seat numbers in a theater row:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>for (int seat = 1; seat &lt;= 5; seat++) {
  System.out.println("Seat number: " + seat);
}
</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_for_loop_reallife4">Try it Yourself &raquo;</a>
</p>
</div>

<p>Use a loop to calculate the factorial of a given number:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>int n = 5;
int fact = 1;
...
// Output: Factorial of 5 is 120</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_for_loop_reallife_factorial">Try it Yourself &raquo;</a>
</p>
</div>
