...
<a class="w3-right w3-btn" href="java_statements.asp">Next &#10095;</a>
</div>
<hr>
...
<h3>Example</h3>
<pre class="language-java w3-white" data-tab-header="Main.java"><code>public class Main {
...
The class name should always start with an uppercase first letter. In our example, we named the class <strong>Main</strong>.</p>

<p><strong>Note:</strong> Java is case-sensitive.  
<code class="w3-codespan">MyClass</code> and <code class="w3-codespan">myclass</code> would be treated as two completely different names.</p>
...
This is because Java uses the class name to find and run your code. If the names don't match, Java will give an error and the program will not run.</p>

<p>When saving the file, save it using the class name and add <code class="w3-codespan">.java</code> to the end of the filename.  
To run the example above on your computer, make sure that Java is properly installed:  
Go to the <a href="java_getstarted.asp">Get Started Chapter</a> for how to install Java. The output should be:</p>
...
<p>The <code class="w3-codespan">main()</code> method is required in every Java program. It is where the program starts running:</p>
<div class="w3-example">
<pre class="language-java w3-white"><code>public static void <strong>main</strong>(String[] args)
</code></pre>
</div>

<p>Any code placed inside the <code class="w3-codespan">main()</code> method will be executed.</p>

<p>For now, you don't need to understand the keywords <code class="w3-codespan">public</code>, <code class="w3-codespan">static</code>, and <code class="w3-codespan">void</code>.  
You will learn about them later in this tutorial.  
Just remember: <code class="w3-codespan">main()</code> is the starting point of every Java program.</p>
...
<p><strong>Note:</strong> The curly braces <code class="w3-codespan">{}</code> mark the beginning and the end of a block of code.</p>
...
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: Java Syntax</h2>
  <a href="https://youtu.be/VR9IZcPOijY&list=PLP9IO4UYNF0VT3LvP_Cl4EIEyVk-Q5DP3" class="ga-featured ga-youtube" target="blank_" > 
