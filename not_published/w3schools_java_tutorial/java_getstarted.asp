...
<h2>Get Started With Java</h2>
<p>At W3Schools, you can try Java without installing anything.</p>
<p>Our Online Java Editor runs directly in your browser, and shows both the code and the result:</p>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_helloworld">Try it Yourself &raquo;</a></p>
</div>
<p>This editor will be used in the entire tutorial to demonstrate the different aspects of Java.</p>
<hr>

<h2>Java Install</h2>
<p>However, if you want to run Java on your own computer, follow the instructions below.</p>
...
<p>If you do not have Java installed on your computer, you can download it at <a href="https://www.oracle.com/java/technologies/downloads/" target="_blank">oracle.com</a>.</p>
...
<p>Let's create our first Java file, called <code class="w3-codespan">Main.java</code>, which can be done in any text editor 
(like Notepad).</p>
<p>The file should contain a &quot;Hello World&quot; message, which is written with the 
following code:</p>

<div class="w3-example" style="padding-top:26px">
...
<a target="_blank" class="w3-btn w3-margin-top" href="tryjava.asp?filename=demo_helloworld">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: Java Get Started</h2>
  <a href="https://youtu.be/zTEU-9kP66c&list=PLP9IO4UYNF0VT3LvP_Cl4EIEyVk-Q5DP3" class="ga-featured ga-youtube" target="blank_" > 
