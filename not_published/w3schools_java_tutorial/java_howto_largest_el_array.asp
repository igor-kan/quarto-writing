...
<html lang="en-US">
<head>
<title>Java How To Find the Largest Element in an Array</title>
<meta charset="utf-8">
...
<h1>Java How To - <span class="color_h1">Largest Element in an Array</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_howto_find_smallest_array_el.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_howto_second_largest_array.asp">Next &#10095;</a>
</div>
<hr>

<h2>Find the Largest Element in an Array</h2>
<p>Scan the array and keep track of the biggest value found so far:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>int[] nums = {12, 7, 25, 3, 18};
int largest = nums[0];
...
System.out.println("Largest element: " + largest);</code></pre>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_howto_largest_in_array">Try it Yourself &raquo;</a></p>
</div>

<p><b>Explanation:</b> We start by assuming the first element is the largest. Then we loop through the array and update the variable whenever we find a bigger value.</p>
<hr>
