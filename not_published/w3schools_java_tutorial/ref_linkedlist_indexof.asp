...
<html lang="en-US">
<head>
<title>Java LinkedList indexOf() Method</title>
<meta charset="utf-8">
...
<h1>Java LinkedList <span class="color_h1">indexOf()</span> Method</h1>
...
<h3>Example</h3>
<p>Find the position of an item in a list:</p>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_linkedlist_indexof">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">indexOf()</code> method returns the position of the first occurrence of a value in the list. If the item is not found in the list then it returns -1.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public int indexOf(Object <em>item</em>)</code></pre>
...
<tr>
 ...
 <td style="width:80%">The position of the first occurrence of the item in the list, or -1 if the item is not found.</td>
</tr>
</table>
