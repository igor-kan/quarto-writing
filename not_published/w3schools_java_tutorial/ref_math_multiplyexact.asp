...
<html lang="en-US">
<head>
<title>Java Math multiplyExact() Method</title>
<meta charset="utf-8">
...
<h1>Java Math <span class="color_h1">multiplyExact()</span> Method</h1>
...
<h3>Example</h3>
<p>Multiply integers using <code class="w3-codespan">multiplyExact()</code>:</p>
<pre class="w3-white language-java"><code>System.out.println(Math.multiplyExact(96000, 1200));
System.out.println(Math.multiplyExact(-460, 95));
</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryjava.asp?filename=demo_ref_math_multiplyexact">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">multiplyExact()</code> method multiplies two integers and throws an exception if the result causes an overflow. This prevents incorrect results that can occur from multiplying really large numbers.</p>
<hr>

<h2>Syntax</h2>
<p>One of the following:</p>
<pre class="language-java"><code>public static int multiplyExact(int <em>x</em>, int <em>y</em>)</code></pre>
<pre class="language-java"><code>public static long multiplyExact(long <em>x</em>, long <em>y</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>x</em></td>
    <td>Required. The first number to be multiplied.</td>
  </tr>
  <tr>
    <td><em>y</em></td>
    <td>Required. The second number to be multiplied.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">An <code class="w3-codespan">int</code> or <code class="w3-codespan">long</code> value representing the multiplication of two numbers.</td>
</tr>
<tr>
 <th style="width:20%">Throws:</th>
 <td style="width:80%"> <code class="w3-codespan">ArithmeticException</code> - If the multiplication causes an overflow.</td>
</tr>
<tr>
