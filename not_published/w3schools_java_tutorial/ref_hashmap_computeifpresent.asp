...
<html lang="en-US">
<head>
<title>Java HashMap computeIfPresent() Method</title>
<meta charset="utf-8">
...
<h1>Java HashMap <span class="color_h1">computeIfPresent()</span> Method</h1>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_hashmap_computeifpresent">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">computeIfPresent()</code> method calculates a value for an entry based on its key. If an entry with the specified key does not exist or its value is <code class="w3-codespan">null</code> then the map is not changed. </p>
<p>The value is computed using a function, which can be defined by a lambda expression that is compatible with the <code class="w3-codespan">apply()</code> method of Java's <code class="w3-codespan">BiFunction</code> interface.</p>
<p>To learn about lambda expressions, see our <a href="java_lambda.asp">Java Lambda Expression tutorial</a>.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public void computeIfPresent(K <em>key</em>, BiFunction <em>function</em>)</code></pre>
...
<tr>
 ...
 <td style="width:80%">The value computed by the function or <em>null</em> if the map is not changed.</td>
</tr>
</table>
