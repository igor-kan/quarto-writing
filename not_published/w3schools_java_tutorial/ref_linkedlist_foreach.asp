...
<html lang="en-US">
<head>
<title>Java LinkedList forEach() Method</title>
<meta charset="utf-8">
...
<h1>Java LinkedList <span class="color_h1">forEach()</span> Method</h1>
...
<h3>Example</h3>
<p>Use a lambda expression in the <code class="w3-codespan">LinkedList</code>'s <code class="w3-codespan">forEach()</code> method to print every item in the list:</p>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_linkedlist_foreach">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">forEach()</code> method performs an action on every item in a list. The action can be defined by a lambda expression that is compatible with the <code class="w3-codespan">accept()</code> method of Java's <code class="w3-codespan">Consumer</code> interface.</p>
<p>To learn about lambda expressions, see our <a href="java_lambda.asp">Java Lambda Expression tutorial</a>.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public void forEach(Consumer <em>action</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>action</em></td>
    <td>Required. A <code class="w3-codespan">Consumer</code> object or lambda expression which performs an action on an item.</td>
  </tr>
</table>
...
<p><a href="java_lambda.asp">Java Lambda Expressions Tutorial</a></p>
<hr>
