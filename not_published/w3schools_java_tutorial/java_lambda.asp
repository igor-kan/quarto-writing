...
<style>
  ...
  .code-wrap {
    /* this flex container lets the code area expand to fill height */
    flex: 1;
    display: flex;
    flex-direction: column;
    margin-top:-16px;
  ...
  .code-wrap .w3-example {
    flex: 1;                  /* stretch example box */
    display: flex;
    flex-direction: column;
  }
  .code-wrap pre {
    flex: 1;                  /* stretch code block */
    margin: 0;
...
<h1>Java <span class="color_h1">Lambda Expressions</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_threads.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_advanced_sorting.asp">Next &#10095;</a>
</div>
<hr>

<h2>Java Lambda Expressions</h2>
<p>Lambda Expressions were added in Java 8.</p>
<p>A <strong>lambda expression</strong> is a short block of code that takes in parameters and returns a value. 
Lambdas look similar to methods, but they do not need a name, and they can be written right inside a method body.</p>
<hr>
...
<p>To use more than one parameter, wrap them in parentheses:</p>
<div class="w3-example">
<pre class="language-java w3-white"><code>(<em>parameter1</em>, <em>parameter2</em>) -> <em>expression</em></code></pre>
</div>

<p>Simple expressions must return a value immediately. They cannot contain multiple statements, such as loops or <code class="w3-codespan">if</code> conditions. 
To do more complex work, use a code block with curly braces. If the lambda should return a value, use the <code class="w3-codespan">return</code> keyword:</p>

<div class="w3-example">
<pre class="language-java w3-white"><code>(<em>parameter1</em>, <em>parameter2</em>) -> {
  // code block
  return <em>result</em>;
}</code></pre>
</div>
...
<h2>Using Lambda Expressions</h2>
<p>Lambdas are often passed as arguments to methods. For example, you can use a lambda in the 
<code class="w3-codespan">forEach()</code> method of an <code class="w3-codespan">ArrayList</code>:</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_lambda">Try it Yourself &raquo;</a>
</p>
</div>
<hr>
...
<h2>Lambdas in Variables</h2>
<p>A lambda expression can be stored in a variable. The variable's type must be an interface with exactly one method 
(a <strong>functional interface</strong>). The lambda must match that method's parameters and return type.</p>
<p>Java includes many built-in functional interfaces, such as <code class="w3-codespan">Consumer</code> (from the <code class="w3-codespan">java.util</code> package) used with lists.</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_lambda2">Try it Yourself &raquo;</a>
</p>
</div>
<hr>

<h2>Lambdas as Method Parameters</h2>
<p>You can also pass a lambda expression to a method. The method's parameter must be a functional interface. 
Calling the interface's method will then run the lambda expression:</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_lambda3">Try it Yourself &raquo;</a>
</p>
</div>
<hr>

<h2>Anonymous Class vs. Lambda Expression</h2>
<p>In Java 8+, you can often replace an 
<a href="java_anonymous.asp">anonymous class</a> with a <strong>lambda expression</strong> - 
but only if the interface is a <strong>functional interface</strong> (one abstract method).</p>

<h5>Example: Same task, two ways (interface with one method):</h5>
...
<pre class="language-java w3-white"><code>// Functional interface (one abstract method)
interface Greeting {
  void sayHello();
}
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_lambda_an1">Try it Yourself &raquo;</a>
</p>
      </div>
    </div>
  </div>
...
<pre class="language-java w3-white"><code>// Same functional interface
interface Greeting {
  void sayHello();
}
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_lambda_an2">Try it Yourself &raquo;</a>
</p>
      </div>
    </div>
  </div>
...
<p><strong>Rule of thumb:</strong> Use a <code class="w3-codespan">lambda</code> for short, single-method interfaces. 
Use an <a href="java_anonymous.asp">anonymous class</a> when you need to override multiple methods, add fields, or extend a class.</p>
</div>
