...
<html lang="en-US">
<head>
<title>Java String replaceAll() Method</title>
<meta charset="utf-8">
...
<h1>Java String <span class="color_h1">replaceAll()</span> Method</h1>
...
<h3>Example</h3>
<p>Replace every match of a regular expression with a substring:</p>
<pre class="w3-white language-java"><code>String myStr = "I love cats. Cats are very easy to love. Cats are very popular.";
String regex = "(?i)cat";
System.out.println(myStr.replaceAll(regex, "dog"));
</code></pre>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_string_replaceall">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">replaceAll()</code> method replaces all the matches of a regular expression in a string with a new substring.</p>
...
<h2>Syntax</h2>
<pre class="language-java"><code>public String replaceAll(String <em>regex</em>, String <em>replacement</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    ...
    <td>Required. The substring which will replace each match.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">A copy of the string in which matches of the regular expression are replaced with new substrings.</td>
</tr>
<tr>
...
<div class="w3-example">
<h3>Example</h3>
<p>Use a backreference to wrap numbers in parentheses:</p>
...
<p><a target="_blank" class="w3-btn w3-margin-bottom" href="tryjava.asp?filename=demo_ref_string_replaceall2">Try it Yourself &raquo;</a></p>
</div>
<br>
