...
<html lang="en-US">
<head>
<title>Java boolean Keyword</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1"> boolean</span> Keyword</h1>
<p>
...
<h3>Example</h3>
<p>A boolean data type with true or false values:</p>
...
<p>The <code class="w3-codespan">boolean</code> keyword is a data type that can only take the values <code class="w3-codespan">true</code> or <code class="w3-codespan">false</code>.</p>
<p>Boolean values are mostly used for conditional testing (read the <a href="java_booleans.asp">Java Booleans Tutorial</a> for more information).</p>
<hr>

<h2>Related Pages</h2>
<p>Read more about data types in our <a href="java_data_types.asp">Java Data Types Tutorial</a>.</p>
<p>Read more about booleans in our <a href="java_booleans.asp">Java Booleans Tutorial</a>.</p>
