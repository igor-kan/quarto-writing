...
<html lang="en-US">
<head>
<title>Java transient Keyword</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1"> transient</span> Keyword</h1>
<p>
...
<h3>Example</h3>
<p>The <code class="w3-codespan">transient</code> keyword prevents an attribute from being serialized:</p>
<pre class="w3-white language-java"><code>import java.io.*;
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_keyword_transient">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">transient</code> keyword is a modifier that tells Java to ignore an attribute when serializing an object.</p>
<hr>
