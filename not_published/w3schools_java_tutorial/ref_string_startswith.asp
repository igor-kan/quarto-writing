...
<html lang="en-US">
<head>
<title>Java String startsWith() Method</title>
<meta charset="utf-8">
...
<h1>Java String <span class="color_h1">startsWith()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Find out if the string starts with the specified characters:</p>
...
System.out.println(myStr.startsWith(&quot;o&quot;));&nbsp;&nbsp;&nbsp;&nbsp; // false</code></pre>
<p>
  <a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_string_startswith">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>The <code class="w3-codespan">startsWith()</code> method checks whether a 
string starts with the specified character(s).</p>
<p><strong>Tip:</strong> Use the <a href="ref_string_endswith.asp">endsWith()</a> method to check whether a string <strong>ends</strong> with the specified character(s).</p>

<hr>

<h2>Syntax</h2>

<pre class="language-java"><code>public boolean startsWith(String <em>chars</em>)
</code></pre>
...
<table class="ws-table-all notranslate"> 
  <tbody><tr>
    ...
    <tr>
    <td><em>chars</em></td>
    <td>A <code class="w3-codespan">String</code>, representing the character(s) to check for</td>
    </tr>
</tbody>
</table>
...
<tr>
 <th style="width:21%">Returns:</th>
  ...
  <ul>
  <li><code class="w3-codespan">true</code> - if the string starts with the specified character(s)</li>
  <li><code class="w3-codespan">false</code> - if the string does not start with the specified character(s)</li>
 </ul>
</tr>
</table>
<br>
