...
<html lang="en-US">
<head>
<title>Java String compareToIgnoreCase() Method</title>
<meta charset="utf-8">
...
<h1>Java String <span class="color_h1">compareToIgnoreCase()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Compare two strings, ignoring lower case and upper case differences:</p>
<pre class="language-java w3-white"><code>String myStr1 = &quot;HELLO&quot;;
String myStr2 = &quot;hello&quot;;
System.out.println(myStr1.compareToIgnoreCase(myStr2));</code></pre>
<p>
  <a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_string_comparetoignorecase">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>The <code class="w3-codespan">compareToIgnoreCase()</code> method compares two strings 
lexicographically, ignoring lower case and upper case differences.</p>
<p>The comparison is based on the Unicode value of each character in the 
string converted to lower case.</p>
<p>The method returns 0 if the string is equal to the other string, ignoring case differences.
...
<pre class="language-java"><code>public int compareToIgnoreCase(String <em>string2</em>)
</code></pre>
...
<tr>
 <th style="width:21%">Returns:</th>
  <td>An <code class="w3-codespan">int</code> value: 0 if the string is equal to the other string, ignoring case differences.<br>
