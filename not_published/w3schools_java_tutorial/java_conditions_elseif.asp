...
<html lang="en-US">
<head>
<title>Java The else if Statement</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1">Else If</span></h1>

<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_conditions_else.asp">&#10094; Previous</a>
...
<h3>Syntax</h3>
<pre class="language-java w3-white"><code>if (<em>condition1</em>) {
...
<em>If it rains, bring an umbrella. <strong>Else if</strong> it is sunny, wear sunglasses.
Else, just go outside normally.</em>
</p>
...
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white" data-line="5"><code>int weather = 2; // 1 = raining, 2 = sunny, 3 = cloudy
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_if_else_if_bool">
Try it Yourself &raquo;
</a>
</p>
</div>

<p>Since <code class="w3-codespan">weather</code> is <code class="w3-codespan">2</code>, the first condition (<code class="w3-codespan">weather == 1</code>) is not met, so the <code class="w3-codespan">if</code> block is skipped.  
The program then checks the <code class="w3-codespan">else if</code> condition (<code class="w3-codespan">weather == 2</code>), which is <code class="w3-codespan">true</code>.  
That means the <code class="w3-codespan">else if</code> block runs and prints "Wear sunglasses.".</p>
...
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white" data-line="5"><code>int time = 16;
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_if_else_if">
Try it Yourself &raquo;
</a>
</p>
</div>
...
Because of this, the <code class="w3-codespan">else if</code> block runs
and prints "Good day.".
</p>

<p>
If the value of <code class="w3-codespan">time</code> was 22,
none of the conditions would be true,
and the program would print "Good evening." instead:
</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white" data-line="7"><code>int time = 22;
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_if_else_if2">Try it Yourself &raquo;</a>
</p>
</div>
