...
<html lang="en-US">
<head>
<title>Java HashMap clear() Method</title>
<meta charset="utf-8">
...
<h1>Java HashMap <span class="color_h1">clear()</span> Method</h1>
...
<h3>Example</h3>
<p>Remove all items from a map:</p>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_hashmap_clear">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">clear()</code> method removes all entries from the map.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public void clear()</code></pre>
<hr>
