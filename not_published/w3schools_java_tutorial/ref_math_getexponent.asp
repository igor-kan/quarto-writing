...
<html lang="en-US">
<head>
<title>Java Math getExponent() Method</title>
<meta charset="utf-8">
...
<h1>Java Math <span class="color_h1">getExponent()</span> Method</h1>
...
<h3>Example</h3>
<p>Get the exponent of different floating point numbers:</p>
<pre class="w3-white language-java"><code>System.out.println(Math.getExponent(1));
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_math_getexponent">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">getExponent()</code> method returns the unbiased exponent of Java's internal representation of a floating point number.</p>
<p>Java represents every floating point number internally in the form m&middot;2<sup>x</sup>. The <code class="w3-codespan">getExponent()</code> method returns the value of <em>x</em> for any floating point number. The term <em>unbiased</em> refers to the fact that the exponent can only be represented internally as a positive number, so there is a positive bias to the exponent. When you subtract the bias from the exponent you get the <em>unbiased</em> (true) value of the exponent.</p>
<hr>

<h2>Syntax</h2>
<p>One of the following:</p>
<pre class="language-java"><code>public static int getExponent(double <em>number</em>)</code></pre>
<pre class="language-java"><code>public static int getExponent(float <em>number</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>number</em></td>
    <td>Required. A floating point number from which to get the exponent.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">An <code class="w3-codespan">int</code> value representing the unbiased exponent of Java's internal representation of a floating point number.</td>
</tr>
<tr>
