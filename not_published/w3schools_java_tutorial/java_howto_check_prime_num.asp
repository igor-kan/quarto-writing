...
<html lang="en-US">
<head>
<title>Java How To Check if a Number Is Prime</title>
<meta charset="utf-8">
...
<h1>Java How To - <span class="color_h1">Check if a Number Is Prime</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_howto_find_gcd.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_howto_loop_through_arraylist.asp">Next &#10095;</a>
</div>
<hr>

<h2>Check if a Number Is Prime</h2>
<p>A prime number is only divisible by 1 and itself.</p>
<p>To test if a number is prime, we try dividing it by every number from 2 up to its square root:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>int n = 29;  // Number used to check
boolean isPrime = n &gt; 1;
...
System.out.println(n + (isPrime ? &quot; is prime&quot; : &quot; is not prime&quot;));</code></pre>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_howto_prime_check">Try it Yourself &raquo;</a></p>
</div>

<p><b>Explanation:</b> We start with the number <code class="w3-codespan">29</code>. Since 29 is greater than 1, the loop checks if it can be divided evenly by any number from 2 up to the square root of 29 (about 5.38). The numbers 2, 3, 4, and 5 do not divide 29 without a remainder, so the program concludes that <code class="w3-codespan">29</code> is prime.</p>
<hr>
