...
<html lang="en-US">
<head>
<title>Java HashMap replace() Method</title>
<meta charset="utf-8">
...
<h1>Java HashMap <span class="color_h1">replace()</span> Method</h1>
...
<h3>Example</h3>
<p>Replace the values of entries in a map:</p>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_hashmap_replace">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">replace()</code> method writes a new value to an existing entry in the map. The entry can be specified by its key, or by both its key and value.</p>
<hr>

<h2>Syntax</h2>
<p>One of the following:</p>
<pre class="language-java"><code>public V replace(K <em>key</em>, V <em>newValue</em>)</code></pre>
<pre class="language-java"><code>public boolean replace(K <em>key</em>, V <em>oldValue</em>, V <em>newValue</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>key</em></td>
    <td>Required. The key of the entry to be removed.</td>
  </tr>
  <tr>
    <td><em>oldValue</em></td>
    <td>Optional. The value of the entry to be removed.</td>
  </tr>
  <tr>
    <td><em>newValue</em></td>
    <td>Required. The value to write into the entry.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">
  When the <em>oldValue</em> argument is specified, it returns <code class="w3-codespan">true</code> if the entry was replaced and <code class="w3-codespan">false</code> otherwise.<br>
  If the <em>oldValue</em> argument is not specified then it returns the value that the entry had before it was replaced, or <code class="w3-codespan">null</code> if an entry with the specified key does not exist.</td>
</tr>
</table>
<hr>
