...
<html lang="en-US">
<head>
<title>Java Math exp() Method</title>
<meta charset="utf-8">
...
<h1>Java Math <span class="color_h1">exp()</span> Method</h1>
...
<h3>Example</h3>
<p>Return <em>e</em> raised to the power of different numbers:</p>
<pre class="w3-white language-java"><code>System.out.println(Math.exp(0));
System.out.println(Math.exp(1));
System.out.println(Math.exp(10));
System.out.println(Math.exp(4.8));
System.out.println(Math.exp(Math.E));
</code></pre>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_math_exp">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">exp()</code> method returns <em>e</em> raised to the power of a number (<em>e</em><sup>x</sup>).</p>
...
<h2>Syntax</h2>
<pre class="language-java"><code>public static double exp(double <em>number</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>number</em></td>
    <td>Required. The power to which <em>e</em> is raised.</td>
  </tr>
</table>
...
<tr>
  ...
  <td style="width:80%">A <code class="w3-codespan">double</code> value representing the result of <em>e</em> to the power of a number.</td>
</tr>
<tr>
