...
<h1>Java <span class="color_h1">Statements</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_syntax.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_challenges_syntax.asp">Next &#10095;</a>
</div>
<hr>
...
<p>The following statement "instructs" the compiler to print the text "Java is fun!" to the screen:</p>

<div class="w3-example">
  <h3>Example</h3>
  <pre class="language-java w3-white"><code>System.out.println(&quot;Java is fun!");</code></pre>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="tryjava.asp?filename=demo_statements">Try it Yourself &raquo;</a>
</div>

<p>It is important that you end the statement with a semicolon <code class="w3-codespan">;</code>.</p>
<p>If you forget the semicolon (<code class="w3-codespan">;</code>), an error will occur and the program will not run:</p>

<div class="w3-example w3-pale-red">
  <h3>Example</h3>
  <pre class="language-java w3-white w3-border-red"><code>System.out.println(&quot;Java is fun!")</code></pre>
  <p>Result:</p>
  <div class="w3-padding notranslate w3-black">
    <code>error: ';' expected</code>
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="tryjava.asp?filename=demo_statements2">Try it Yourself &raquo;</a>
</div>
<div class="ws-note ws-panel">
<p><strong>Tip:</strong> You can think of a statement like a <em>sentence</em> in English. Just as sentences end with a period <code class="w3-codespan">.</code>, Java statements end with a semicolon <code class="w3-codespan">;</code>.</p>
</div>
...
<p>Most Java programs contain many statements.</p>
...
System.out.println("Learning Java is fun!");</code></pre>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="tryjava.asp?filename=demo_statements3">Try it Yourself &raquo;</a>
</div>

<h4>Example explained</h4>
<p>From the example above, we have three statements:</p>
<ol>
  <li><code class="w3-codespan">System.out.println("Hello World!");</code></li>
  <li><code class="w3-codespan">System.out.println("Have a good day!");</code></li>
  <li><code class="w3-codespan">System.out.println("Learning Java is fun!");</code></li>
</ol>
...
And at last, the third statement is executed (print "Learning Java is fun!" to the screen).</p>
