...
<html lang="en-US">
<head>
<title>Java Declare Multiple Variables</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1">Declare Multiple Variables</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_variables_print.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_variables_identifiers.asp">Next &#10095;</a>
</div>
<hr>

<h2>Declare Many Variables</h2>
<p>To declare more than one variable of the <strong>same type</strong>, you can 
...
<p>You can write:</p>
<pre class="language-java w3-white"><code>int x = 5, y = 6, z = 50;
System.out.println(x + y + z); // 61
</code></pre>

<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_variables5">Try it Yourself &raquo;</a>
</p>
</div>

<div class="ws-note ws-panel">
<p><b>Note:</b> Declaring many variables in one line is shorter, but writing one variable per line can sometimes make the code easier to read.</p>
</div>
...
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>int x, y, z;
x = y = z = 50;
System.out.println(x + y + z); // 150
</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_variables_multi2">Try it Yourself &raquo;</a>
</p>
</div>
