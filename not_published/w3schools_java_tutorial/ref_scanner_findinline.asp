...
<html lang="en-US">
<head>
<title>Java Scanner findInLine() Method</title>
<meta charset="utf-8">
...
<h1>Java Scanner <span class="color_h1">findInLine()</span> Method</h1>
...
// Close the scanner
myObj.close();</code></pre>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">findInLine()</code> method searches up to the next line break in the scanner for the first match of a regular expression provided by a <code class="w3-codespan">Pattern</code> object or a string. If a match is not found then it returns <code class="w3-codespan">null</code>.</p>
...
<pre class="language-java"><code>public String findInLine(Pattern <em>pattern</em>)</code></pre>
<pre class="language-java"><code>public String findInLine(String <em>pattern</em>)</code></pre>
