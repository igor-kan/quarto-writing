...
<html lang="en-US">
<head>
<title>Java Scanner hasNextFloat() Method</title>
<meta charset="utf-8">
...
<h1>Java Scanner <span class="color_h1">hasNextFloat()</span> Method</h1>
...
<p>The <code class="w3-codespan">hasNextFloat()</code> method returns <em>true</em> if the next token represents a valid number.</p>
...
<h2>Syntax</h2>
<pre class="language-java"><code>public boolean hasNextFloat()</code></pre>
