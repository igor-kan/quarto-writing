...
<h1>Java <span class="color_h1">Collections Class Methods</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_ref_iterators.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_ref_system.asp">Next &#10095;</a>
</div>
<hr>

<h2>Collections Methods</h2>
<p>The <code class="w3-codespan">Collections</code> class (in <code class="w3-codespan">java.util</code>) contains 
several useful methods for working with collections like <code class="w3-codespan">ArrayList</code>, 
<code class="w3-codespan">HashSet</code>, and <code class="w3-codespan">HashMap</code>.</p>

<div class="w3-responsive" style="margin-top:-16px;margin-botom:-16px">
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td>sort()</td>
    <td>Sorts the list in ascending order (according to natural ordering)</td>
    <td>void</td>
  </tr>

  <tr>
    <td>binarySearch()</td>
    <td>Searches for a key in a sorted list and returns its index (otherwise <code>&lt; 0</code>)</td>
    <td>int</td>
  </tr>

  <tr>
    <td>reverse()</td>
    <td>Reverses the order of elements in a list</td>
    <td>void</td>
  </tr>

  <tr>
    <td>reverseOrder()</td>
    <td>Returns a comparator that imposes the reverse of natural ordering</td>
    <td>Comparator</td>
  </tr>

  <tr>
    <td>shuffle()</td>
    <td>Randomly permutes the elements of a list</td>
    <td>void</td>
  </tr>

  <tr>
    <td>swap()</td>
    <td>Swaps the elements at the specified positions in a list</td>
    <td>void</td>
  </tr>

  <tr>
    <td>frequency()</td>
    <td>Returns the number of elements equal to the specified object</td>
    <td>int</td>
  </tr>

  <tr>
    <td>max()</td>
    <td>Returns the maximum element of a collection (according to natural ordering)</td>
    <td>T</td>
  </tr>

  <tr>
    <td>min()</td>
    <td>Returns the minimum element of a collection (according to natural ordering)</td>
    <td>T</td>
  </tr>

  <tr>
    <td>disjoint()</td>
    <td>Checks if two collections have no elements in common</td>
    <td>boolean</td>
  </tr>

  <tr>
    <td>copy()</td>
    <td>Copies all elements from one list into another</td>
    <td>void</td>
  </tr>

  <tr>
    <td>fill()</td>
    <td>Replaces all elements of the list with the specified object</td>
    <td>void</td>
  </tr>

  <tr>
    <td>replaceAll()</td>
    <td>Replaces all occurrences of one value with another in a list</td>
    <td>boolean</td>
  </tr>

  <tr>
    <td>unmodifiableList()</td>
    <td>Returns an unmodifiable (read-only) view of the specified list</td>
    <td>List</td>
  </tr>

  <tr>
    <td>unmodifiableSet()</td>
    <td>Returns an unmodifiable (read-only) view of the specified set</td>
    <td>Set</td>
  </tr>

  <tr>
    <td>unmodifiableMap()</td>
    <td>Returns an unmodifiable (read-only) view of the specified map</td>
    <td>Map</td>
  </tr>
</table>
</div>
...
<h2>Related Pages</h2>
<p><a href="java_algorithms.asp">Java Algorithms Tutorial</a></p>
<p><a href="java_data_structures.asp">Java Data Structures Tutorial</a></p>
