...
<html lang="en-US">
<head>
<title>Java String toLowerCase() Method</title>
<meta charset="utf-8">
...
<h1>Java String <span class="color_h1">toLowerCase()</span> Method</h1>
...
<p>The <code class="w3-codespan">toLowerCase()</code> method converts a string to lower case letters.</p>
<p><strong>Note:</strong> The <a href="ref_string_touppercase.asp">toUpperCase()</a> method converts a string to upper case letters.</p>

<hr>

<h2>Syntax</h2>

<pre class="language-java"><code>public String toLowerCase()
</code></pre>
...
<tr>
 <th style="width:21%">Returns:</th>
  <td>A <code class="w3-codespan">String</code> value, representing the new string converted to lower case</td>
</tr>
</table>
<br>
