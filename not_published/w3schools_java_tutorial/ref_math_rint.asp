...
<html lang="en-US">
<head>
<title>Java Math rint() Method</title>
<meta charset="utf-8">
...
<h1>Java Math <span class="color_h1">rint()</span> Method</h1>
...
<h3>Example</h3>
<p>Round numbers to the nearest integer:</p>
<pre class="w3-white language-java"><code>System.out.println(Math.rint(0.5));
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_math_rint">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">rint()</code> method rounds a number to the nearest integer. If there are two integers that are equally close to the number then the even integer will be returned.</p>
<p><strong>Note:</strong> This method is very similar to <code class="w3-codespan"><a href="ref_math_round.asp">round()</a></code>. The main differences between <code class="w3-codespan">rint()</code> and <code class="w3-codespan">round()</code> are:</p>
<ul>
  <li><code class="w3-codespan">round()</code> returns <code class="w3-codespan">long</code> or <code class="w3-codespan">int</code> data types while <code class="w3-codespan">rint()</code> returns a <code class="w3-codespan">double</code>.</li>
  <li>When the decimal part of the number is exactly 0.5, <code class="w3-codespan">rint()</code> returns the nearest even integer while <code class="w3-codespan">round()</code> returns the highest of the two nearest integers</li>
</ul>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public static double rint(double <em>number</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>number</em></td>
    <td>Required. A number to round.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">A <code class="w3-codespan">double</code> value representing the nearest integer to a number.</td>
</tr>
<tr>
