...
<html lang="en-US">
<head>
<title>Java FileOutputStream Reference</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1">FileOutputStream Methods</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_ref_fileinputstream.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_ref_bufferedreader.asp">Next &#10095;</a>
</div>
<hr>

<h2>FileOutputStream Methods</h2>
<p>The <code class="w3-codespan">FileOutputStream</code> class provides methods to write data (as bytes) to a file:</p>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td>flush()</td>
    <td>Flushes the stream - forces any buffered output bytes to be written immediately</td>
    <td>void</td>
  </tr>
  <tr>
    <td>write()</td>
    <td>Writes one byte, an array of bytes, or part of an array to the file</td>
    <td>void</td>
  </tr>
  <tr>
    <td>getFD()</td>
    <td>Returns the file descriptor object associated with the stream</td>
    <td>FileDescriptor</td>
  </tr>
  <tr>
    <td>getChannel()</td>
    <td>Returns the unique <code class="w3-codespan">FileChannel</code> object for this stream</td>
    <td>FileChannel</td>
  </tr>
</table>
<hr>
...
<p><a href="java_fileoutputstream.asp">Java FileOutputStream Tutorial</a></p>
