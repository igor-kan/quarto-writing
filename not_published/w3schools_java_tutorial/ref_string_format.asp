...
<html lang="en-US">
<head>
<title>Java String format() Method</title>
<meta charset="utf-8">
...
<h1>Java String <span class="color_h1">format()</span> Method</h1>

<p>
<a class="w3-btn w3-white w3-border" href="java_ref_string.asp">&#10094; String Methods</a>
</p>
...
<pre class="w3-white language-java"><code>String myStr = "Hello %s! One kilobyte is %,d bytes.";
String result = String.format(myStr, "World", 1024);
System.out.println(result);
</code></pre>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_string_format">Try it Yourself &raquo;</a></p>
</div>
<p><strong>Note:</strong> You will find more "Try it Yourself" examples at the bottom of this page.</p>

<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">format()</code> method returns a formatted string using a locale, format and additional arguments.</p>
<p>If a locale is not passed to this method then the locale given by <code class="w3-codespan">Locale.getDefault()</code> is used.</p>
<p>Data from the additional arguments is formatted and written into placeholders in the format string, which are marked by a % symbol. The way in which arguments are formatted depends on the sequence of characters that follows the % symbol.</p>

<h3>Placeholders</h3>
<p>The placeholders have the form <code class="w3-codespan">%[arg$][flags][width][.precision]conversion</code>. The components in [square brackets] are optional.</p>

<p>An explanation of each of the components:</p>
<ul>
  <li><code class="w3-codespan">arg$</code> - Optional. A number followed by a $ sign which indicates which of the additional arguments to use, argument numbers start at 1. This can be replaced with a <code class="w3-codespan">&lt;</code> which specifies that the argument from the previous placeholder should be used.</li>
  <li><code class="w3-codespan">flags</code> - Optional. A sequence of any of the following characters:
    <ul>
      <li><code class="w3-codespan">-</code> - Makes the output left-justified by adding any padding spaces to the right instead of to the left.</li>
      <li><code class="w3-codespan">#</code> - Shows an alternate representation of the formatted data depending on the conversion.</li>
      <li><code class="w3-codespan">+</code> - Causes positive numbers to always be prefixed with "+".</li>
      <li><code class="w3-codespan" style="white-space:pre"> </code> - (A space character) This prefixes a space to positive numbers, primarily so that the digits can be lined up with the digits of negative numbers.</li>
      <li><code class="w3-codespan">0</code> - Pads numbers with zeroes on the left.</li>
      <li><code class="w3-codespan">,</code> - Groups digits (for example by thousands) and puts separators between the groups. This is affected by the locale.</li>
      <li><code class="w3-codespan">(</code> - Encloses negative numbers in parentheses.</li>
    </ul>
  </li>
<li><code class="w3-codespan">width</code> - Optional. A whole number specifying the minimum number of characters that the output should occupy. If necessary spaces are added to the left to reach this number, or to the right if the <code class="w3-codespan">-</code> flag is used.</li>
  <li><code class="w3-codespan">.precision</code> Optional. A <code class="w3-codespan">.</code> followed by a whole number indicating how many decimal digits to show in the formatted data.</li>
  <li><code class="w3-codespan">conversion</code> - Required. A character which indicates how an argument's data should be represented. If the character is uppercase the data will be formatted in uppercase where possible. The list of possible characters is shown in the table below.</li>
</ul>
...
<tr>
  ...
  <td>Percent</td>
  <td>Displays a literal "%" character in the output.</td>
</tr>
<tr>
  <td><code class="w3-codespan">n</code></td>
  <td>Line break</td>
  <td>Displays a line break in the output.</td>
</tr>
<tr>
  <td><code class="w3-codespan">b</code> or <code class="w3-codespan">B</code></td>
  <td>Boolean</td>
  <td>Displays the boolean value of an argument as "true" or "false". If "B" is used then it displays "TRUE" or "FALSE" instead.</td>
</tr>
<tr>
  <td><code class="w3-codespan">h</code> or <code class="w3-codespan">H</code></td>
  <td>Hash code in hexadecimal</td>
  <td>
    Displays the hash code of the argument in hexadecimal by using its <a href="ref_string_hashcode.asp"><code class="w3-codespan">hashCode()</code></a> value. If <code class="w3-codespan">H</code> is used, the letters A to F are shown in uppercase.
    <p><strong>Note:</strong> This does not format a number as a hexadecimal integer. For hexadecimal integer formatting, use <code class="w3-codespan">x</code> or <code class="w3-codespan">X</code>.</p>
  </td>
</tr>
<tr>
  <td><code class="w3-codespan">s</code> or <code class="w3-codespan">S</code></td>
  <td>String</td>
  <td>Displays the default string representation of the argument. If "S" is used then the string will be converted to uppercase where possible.</td>
</tr>
<tr>
  <td><code class="w3-codespan">c</code> or <code class="w3-codespan">C</code></td>
  <td>Unicode character</td>
  <td>Displays a unicode character representation of the argument. For whole numbers, this is the unicode character that corresponds to the number. If "C" is used then the character will be converted to uppercase where possible.</td>
</tr>
<tr>
  <td><code class="w3-codespan">d</code></td>
  <td>Decimal integer</td>
  <td>Represents a whole number as a decimal integer.</td>
</tr>
<tr>
  <td><code class="w3-codespan">o</code></td>
  <td>Octal integer</td>
  <td>Represents a whole number as an octal integer. The "#" flag will prefix the number with "0".</td>
</tr>
<tr>
  <td><code class="w3-codespan">x</code> or <code class="w3-codespan">X</code></td>
  <td>Hexadecimal integer</td>
  <td>Represents a whole number as a hexadecimal integer. The "#" flag will prefix the number with "0x". If "X" is used then digits A to F and the letter X are shown in uppercase.</td>
</tr>
<tr>
  <td><code class="w3-codespan">e</code> or <code class="w3-codespan">E</code></td>
  <td>Scientific notation</td>
  <td>Represents a floating point number in scientific notation. If "E" is used then the letter "E" of the representation will be uppercase. The "#" flag will force a decimal point even if there are no decimal digits.</td>
</tr>
<tr>
  <td><code class="w3-codespan">f</code></td>
  <td>Floating point number</td>
  <td>Represents a floating point number. The "#" flag will force a decimal point even if there are no decimal digits.</td>
</tr>
<tr>
  <td><code class="w3-codespan">g</code> or <code class="w3-codespan">G</code></td>
  <td>General number</td>
  <td>Displays the shortest representation between <code class="w3-codespan">f</code> and <code class="w3-codespan">e</code> or <code class="w3-codespan">E</code> for a floating point number.</td>
</tr>
<tr>
  <td><code class="w3-codespan">a</code> or <code class="w3-codespan">A</code></td>
  <td>Hexadecimal floating point number</td>
  <td>Display a floating point number's internal representation with hexadecimal digits.</td>
</tr>
<tr>
  <td><code class="w3-codespan">t</code> or <code class="w3-codespan">T</code></td>
  <td>Time or date</td>
  <td>
    ...
    <p>The following characters can be used for date and time formatting:</p>
    <ul>
      <li>H - 24-hour format of an hour (00 to 23)</li>
      <li>I - 12-hour format of an hour (01 to 12)</li>
      <li>k - 24-hour format of an hour (0 to 23)</li>
      <li>l (lowercase 'L') - 12-hour format of an hour (1 to 12)</li>
      <li>M - Minutes with leading zeros (00 to 59)</li>
      <li>S - Seconds with leading zeros (00 to 59) (The value 60 may occur for leap seconds)</li>
      <li>L - Milliseconds with leading zeroes (000 to 999)</li>
      <li>N - Nanoseconds with leading zeroes (000000000 to 999999999)</li>
      <li>p - "am", "pm", "AM" or "PM" to indicate morning or afternoon</li>
      <li>z - Difference to Greenwich time (Example: -0800)</li>
      <li>Z - Timezone abbreviations (Examples: EST, MDT)</li>
      <li>s - The seconds since the Unix Epoch (January 1 1970 00:00:00 GMT)</li>
      <li>Q - The milliseconds since the Unix Epoch (January 1 1970 00:00:00 GMT)</li>
      <li>B - A full textual representation of a month (January through December)</li>
      <li>b or h - A short textual representation of a month (three letters)</li>
      <li>A - A full textual representation of a day (Example: Monday)</li>
      <li>a - A short textual representation of a day (Example: Mon)</li>
      <li>C - The first two digits of the year (For 1970, "19" would be shown)</li>
      <li>Y - A four digit representation of a year</li>
      <li>y - A two digit representation of a year</li>
      <li>j - The day of the year with leading zeroes (001 to 366)</li>
      <li>m - A numeric representation of a month (01 to 12)</li>
      <li>d - The day of the month (01 to 31)</li>
      <li>e - The day of the month without leading zeros (1 to 31)</li>
      <li>R - The time in 24-hour format (Example: 21:30)</li>
      <li>T - The time in 24-hour format with seconds (Example: 21:30:02)</li>
      <li>r - The time in 12-hour format with seconds (Example: 09:30:02 PM) ("AM" and "PM" are always uppercase)</li>
      <li>D - Date representation as month/day/year (Example: 12/17/23)</li>
      <li>F - Date representation as year-month-day (Example: 2023-12-17)</li>
      <li>c - Full date and time (Example: Thu Mar 28 10:51:00 EDT 2024)</li>
    </ul>
  </td>
</tr>
</table>
...
<pre class="language-java"><code>public static String format(Locale <em>locale</em>, String <em>format</em>, Object... <em>args</em>)</code></pre>
<pre class="language-java"><code>public static String format(String <em>format</em>, Object... <em>args</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>locale</em></td>
    <td>Optional. A locale used to determine some of the formatting, such as which characters are used for decimal points and grouping separators.</td>
  </tr>
  <tr>
    <td><em>format</em></td>
    <td>
  ...
  <tr>
    <td><em>args</em></td>
    <td>Optional. Any number of additional arguments to the method, their values can be formatted and displayed in the returned string.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">A <code class="w3-codespan">String</code> value formatted using the specified locale, format and arguments.</td>
</tr>
<tr>
 <th style="width:20%">Throws:</th>
 <td style="width:80%"><code class="w3-codespan">IllegalFormatException</code> - if the format string contains an invalid placeholder or a placeholder isn't compatible with the data type of the argument.</td>
</tr>
<tr>
 <th style="width:20%">Java version:</th>
 <td style="width:80%">1.5</td>
</tr>
</table>
<hr>
...
<div class="w3-example">
<h3>Example</h3>
<p>A placeholder which uses all of the components:</p>
<pre class="w3-white language-java"><code>String result = String.format("%2$,3.2f %1$s", "meters", 1260.5052);
System.out.println(result);
</code></pre>
<p>This is how each part of the placeholder <code class="w3-codespan">%2$,3.2f</code> works:</p>
<ul>
  <li><code class="w3-codespan">2$</code> indicates that the value of the second argument is used</li>
  <li><code class="w3-codespan">,</code> indicates that digits should be grouped (usually by thousands)</li>
  <li><code class="w3-codespan">3</code> indicates that the representation of the data should be at least 3 characters long</li>
  <li><code class="w3-codespan">.2</code> indicates that there should be two digits after the decimal point</li>
  <li><code class="w3-codespan">f</code> indicates that the data is being represented as a floating point number</li>
</ul>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_string_format2">Try it Yourself &raquo;</a></p>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Use arguments in a different order:</p>
<pre class="w3-white language-java"><code>String result = String.format("%3$c %2$c %1$c", 'a', 'b', 'c');
System.out.println(result);
</code></pre>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_string_format3">Try it Yourself &raquo;</a></p>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Format a floating point number:</p>
<pre class="w3-white language-java"><code>double myNumber = 123456.78;
String result;
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_string_format4">Try it Yourself &raquo;</a></p>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Format a date from a Unix timestamp:</p>
<pre class="w3-white language-java"><code>long date = 1711638903488L; // Unix timestamp (number of milliseconds since January 1, 1970)
String result
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_string_format5">Try it Yourself &raquo;</a></p>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Represent characters from their unicode code points:</p>
<pre class="w3-white language-java"><code>String result;
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_string_format6">Try it Yourself &raquo;</a></p>
</div>
<br>
