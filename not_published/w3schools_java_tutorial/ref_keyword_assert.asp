...
<html lang="en-US">
<head>
<title>Java assert Keyword</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1"> assert</span> Keyword</h1>
<p>
...
<p>Use assert to test the truth value of expressions:</p>
<pre class="w3-white language-java"><code>public class Main {
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_keyword_assert">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">assert</code> keyword evaluates a boolean expression and throws an <code class="w3-codespan">AssertionError</code> exception if the expression evaluates to <code class="w3-codespan">false</code>. When the exception is thrown we say that the assertion failed.</p>
<p>An optional expression can be added which will be used as the exception message if the assertion fails.</p>
<p>Assertions are disabled by default. <code class="w3-codespan">assert</code> statements are ignored unless assertions are enabled.</p>
<p>The purpose of assertions is to clearly mark where a program is doing something unintended when debugging and testing a program.</p>
<hr>
<p>
<a class="w3-btn w3-white w3-border" href="java_ref_keywords.asp">&#10094; Java Keywords</a>
</p>
