...
<html lang="en-US">
<head>
<title>Java Constants (final keyword)</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1">Constants (final)</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_variables_identifiers.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_variables_reallife.asp">Next &#10095;</a>
</div>
<hr>

<h2>Constants (final keyword)</h2>

<p>When you do not want a variable's value to change, use the <code class="w3-codespan">final</code> keyword.</p>

<p>A variable declared with <code class="w3-codespan">final</code> becomes a <strong>constant</strong>, which means unchangeable and read-only:</p>
...
<p>You should declare variables as <code class="w3-codespan">final</code> when their values 
should never change.  
For example, the number of minutes in an hour, or your birth 
year:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>final int MINUTES_PER_HOUR = 60;
final int BIRTHYEAR = 1980;</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_variables_final2">Try it Yourself &raquo;</a>
</p>
</div>

<div class="ws-note ws-panel">
<p><strong>Note:</strong> By convention, final variables in Java are usually 
written in upper case (e.g. <code class="w3-codespan">BIRTHYEAR</code>). It is not required, but useful 
for code readability and common for many programmers.</p>
</div>
