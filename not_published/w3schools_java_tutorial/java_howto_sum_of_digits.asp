...
<html lang="en-US">
<head>
<title>Java How To Sum of Digits of a Number</title>
<meta charset="utf-8">
...
<h1>Java How To - <span class="color_h1">Sum of Digits</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_howto_convert_celsius.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_howto_check_armstrong_number.asp">Next &#10095;</a>
</div>
<hr>

<h2>Sum of Digits of a Number</h2>
<p>Add up all digits (e.g., 352: 3 + 5 + 2 = 10):</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>int n = 352;
int sum = 0;
...
System.out.println("Sum of digits: " + sum);</code></pre>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_howto_sum_of_digits">Try it Yourself &raquo;</a></p>
</div>

<p><b>Explanation:</b> We use <code class="w3-codespan">n % 10</code> to extract the last digit, add it to the sum, and then remove the digit with <code class="w3-codespan">n /= 10</code>.</p>
<hr>
