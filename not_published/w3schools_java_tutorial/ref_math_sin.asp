...
<html lang="en-US">
<head>
<title>Java Math sin() Method</title>
<meta charset="utf-8">
...
<h1>Java Math <span class="color_h1">sin()</span> Method</h1>
...
<h3>Example</h3>
<p>Return the sine of different angles:</p>
<pre class="w3-white language-java"><code>System.out.println(Math.sin(3));
System.out.println(Math.sin(-3));
System.out.println(Math.sin(0));
System.out.println(Math.sin(Math.PI));
System.out.println(Math.sin(Math.PI/2));
</code></pre>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_math_sin">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">sin()</code> method returns the sine of an angle.</p>
...
<h2>Syntax</h2>
<pre class="language-java"><code>public static double sin(double <em>angle</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>angle</em></td>
    <td>Required. An angle in radians to find the sine of.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">A <code class="w3-codespan">double</code> value representing the sine of an angle.</td>
</tr>
<tr>
