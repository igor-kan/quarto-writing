...
<html lang="en-US">
<head>
<title>Java How To Convert Celsius to Fahrenheit</title>
<meta charset="utf-8">
...
<h1>Java How To - <span class="color_h1">Convert Celsius to Fahrenheit</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_howto_area_of_rectangle.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_howto_sum_of_digits.asp">Next &#10095;</a>
</div>
<hr>

<h2>Convert Celsius to Fahrenheit</h2>
<p>Use the formula <code class="w3-codespan">F = C * 9/5 + 32</code> to convert temperatures:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>double celsius = 23.5;
double fahrenheit = celsius * 9 / 5 + 32;

System.out.println(celsius + "C = " + fahrenheit + "F");</code></pre>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_howto_convert_celsius">Try it Yourself &raquo;</a></p>
</div>

<p><b>Explanation:</b> We apply the standard conversion formula. Multiplying by 9/5 and adding 32 converts Celsius into Fahrenheit.</p>
<hr>
