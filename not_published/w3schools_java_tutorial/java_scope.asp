...
<h2>Java Scope</h2>
<p>In Java, variables are only accessible inside the region where they are created. This is called
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_scope">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>Variables declared inside a block of code are only accessible by the code between the curly braces, and only after the line in which the variable was declared:</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_scope2">Try it Yourself &raquo;</a>
</p>
</div>

<div class="ws-note ws-panel">
<p>A block of code can stand alone, or be part of an <code class="w3-codespan">if</code>, <code class="w3-codespan">while</code>, or <code class="w3-codespan">for</code> statement.
In a <code class="w3-codespan">for</code> loop, the variable declared in the loop header (like <code class="w3-codespan">int i = 0</code>) only exists inside the loop.</p>
</div>
...
<h2>Loop Scope</h2>
<p>Variables declared inside a <code class="w3-codespan">for</code> loop only exist inside the loop:</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_scope_loop">Try it Yourself &raquo;</a>
</p>
</div>

<ul>
  <li>The <code class="w3-codespan">for</code> loop has its own block (<code class="w3-codespan">{ ... }</code>).</li>
  <li>The variable <code class="w3-codespan">i</code> declared in the loop header (<code class="w3-codespan">int i = 0</code>) is only accessible inside that loop block.</li>
  <li>Once the loop ends, <code class="w3-codespan">i</code> is destroyed, so you can't use it outside.</li>
</ul>

<h3>Why this matters</h3>
<p>Loop variables are not available outside the loop.</p>
  <p>You can safely reuse the same variable name (<code class="w3-codespan">i</code>, <code class="w3-codespan">j</code>, etc.) in different loops in the same method:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>public class Main {
&nbsp;&nbsp;public static void main(String[] args) {
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_scope_loop2">Try it Yourself &raquo;</a>
</p>
</div>
<!--
<hr>
...
<h2>Class Scope</h2>
<p>Variables declared inside a class but outside any method belong to the class structure.
These variables are called <strong>fields</strong> or <strong>instance variables</strong>.</p>
<p>Each object created from the class gets its own copy of the variable.</p>
<p>They can be accessed by all methods in the class, using an object:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>public class Main {
&nbsp;&nbsp;int x = 5; // Instance variable (field)

&nbsp;&nbsp;public static void main(String[] args) {
&nbsp;&nbsp;&nbsp;&nbsp;Main myObj = new Main();
&nbsp;&nbsp;&nbsp;&nbsp;System.out.println(myObj.x); // Accessed through an object
&nbsp;&nbsp;}
}</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_scope_class">Try it Yourself &raquo;</a>
</p>
</div>
<div class="ws-note w3-panel">
<p><strong>Note:</strong> You will learn more about classes and objects in the <a href="java_oop.asp">Java OOP chapters</a>.</p>
</div>-->
