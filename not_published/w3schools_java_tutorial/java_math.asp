...
<a class="w3-left w3-btn" href="java_challenges_strings.asp">&#10094; Previous</a>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_math_max">Try it Yourself &raquo;</a>
</p>
</div>
<hr>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_math_min">Try it Yourself &raquo;</a>
</p>
</div>
<hr>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_math_sqrt">Try it Yourself &raquo;</a>
</p>
</div>
<hr>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_math_abs">Try it Yourself &raquo;</a>
</p>
</div>
<hr>

<h2>Math.pow(<em>x, y</em>)</h2>
<p>The <code class="w3-codespan">Math.pow(<em>x, y</em>)</code> method returns the value of <em>x</em> raised to the power of <em>y</em>:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>Math.pow(2, 8);  // 256.0
</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_math_pow">Try it Yourself &raquo;</a>
</p>
</div>

<div class="ws-note ws-panel">
<p><strong>Note:</strong> <code class="w3-codespan">Math.pow(2, 8)</code> means 
<code class="w3-codespan">2</code> multiplied by itself 8 times:<br>
2 * 2 * 2 * 2 * 2 * 2 * 2 * 2 = 256</p>
<p><strong>Note:</strong> The <code class="w3-codespan">Math.pow()</code> method always returns a 
<code class="w3-codespan">double</code>, even if the result is a whole number.  
For example, <code class="w3-codespan">Math.pow(2, 8)</code> returns <code class="w3-codespan">256.0</code> (not <code class="w3-codespan">256</code>).</p>
</div>
<hr>

<h2>Rounding Methods</h2>
<p>Java has several methods for rounding numbers:</p>

<ul>
  <li><code class="w3-codespan">Math.round(x)</code> - rounds to the nearest integer</li>
  <li><code class="w3-codespan">Math.ceil(x)</code> - rounds up (returns the smallest integer greater than or equal to x)</li>
  <li><code class="w3-codespan">Math.floor(x)</code> - rounds down (returns the largest integer less than or equal to x)</li>
</ul>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>Math.round(4.6);  // 5
Math.ceil(4.1);   // 5.0
Math.floor(4.9);  // 4.0</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_math_rounding">Try it Yourself &raquo;</a>
</p>
</div>
<hr>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_math_random">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_math_random2">Try it Yourself &raquo;</a>
</p>
</div>

<div class="ws-note ws-panel">
<p><strong>Note:</strong> <code class="w3-codespan">Math.random()</code> returns a 
<code class="w3-codespan">double</code>. To get an integer, you need to <a href="java_type_casting.asp">cast</a> it with 
<code class="w3-codespan">(int)</code>.</p>
</div>
<hr>
