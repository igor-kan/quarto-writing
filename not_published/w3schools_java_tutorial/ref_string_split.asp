...
<html lang="en-US">
<head>
<title>Java String split() Method</title>
<meta charset="utf-8">
...
<h1>Java String <span class="color_h1">split()</span> Method</h1>
...
<pre class="w3-white language-java"><code style="text-align: right">String myStr = "Split a string by spaces, and also punctuation.";
String regex = "[,\\.\\s]";
String[] myArray = myStr.split(regex);
for (String s : myArray) {
  System.out.println(s);
}</code></pre>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_string_split">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">split()</code> method splits a string into an array of substrings using a regular expression as the separator.</p>
<p>If a limit is specified, the returned array will not be longer than the limit. The last element of the array will contain the remainder of the string, which may still have separators in it if the limit was reached.</p>
<p><strong>Tip:</strong> See the <a href="java_regex.asp">Java RegEx</a> tutorial to learn about regular expressions.</p>
<hr>

<h2>Syntax</h2>
<p>One of the following:</p>
<pre class="language-java"><code>public String[] split(String <em>regex</em>, int <em>limit</em>)</code></pre>
<pre class="language-java"><code>public String[] split(String <em>regex</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>regex</em></td>
    <td>Required. A regular expression defining the separators where the string is split.</td>
  </tr>
  <tr>
    <td><em>limit</em></td>
    <td>Optional. The maximum length of the returned array.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">A <code class="w3-codespan">String</code> array.</td>
</tr>
<tr>
