...
<h1>Java <span class="color_h1"> case</span> Keyword</h1>
<p>
...
<h3>Example</h3>
<p>Calculate the weekday name:</p>
...
<p>The <code class="w3-codespan">case</code> keyword marks a block of code in a <code class="w3-codespan"><a href="ref_keyword_switch.asp">switch</a></code> statement.</p>
<hr>
