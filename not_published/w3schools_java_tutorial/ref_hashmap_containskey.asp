...
<html lang="en-US">
<head>
<title>Java HashMap containsKey() Method</title>
<meta charset="utf-8">
...
<h1>Java HashMap <span class="color_h1">containsKey()</span> Method</h1>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_hashmap_containskey">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">containsKey()</code> method returns <code class="w3-codespan">true</code> if an entry with the specified key exists in the map and <code class="w3-codespan">false</code> otherwise.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public boolean containsKey(Object <em>key</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>key</em></td>
    <td>Required. The key to search for.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%"><code class="w3-codespan">true</code> if an entry with the specified key exists in the map, <code class="w3-codespan">false</code> otherwise.</td>
</tr>
</table>
