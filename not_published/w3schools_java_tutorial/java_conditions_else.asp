...
<html lang="en-US">
<head>
<title>Java The else Statement</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1">Else</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_conditions.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_conditions_elseif.asp">Next &#10095;</a>
</div>
<hr>

<h2>The else Statement</h2>
<p>The <code class="w3-codespan">else</code> statement lets you run a block of code 
when the condition in the <code class="w3-codespan"><a href="java_conditions.asp">if</a></code> statement is <code class="w3-codespan">false</code>.</p>
...
<p>Think of it like real life: <em>If it rains, bring an umbrella. <strong>Otherwise (else)</strong>, go outside without one</em>:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"  data-line="5"><code>boolean isRaining = false;
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_if_else_bool">Try it Yourself &raquo;</a>
</p>
</div>
<p>Since <code class="w3-codespan">isRaining</code> is false, the condition inside the <code class="w3-codespan">if</code> statement is not met.  
That means the <code class="w3-codespan">if</code> block is skipped, and the <code class="w3-codespan">else</code> block runs instead, printing "No rain today, no need for an umbrella!".</p>
<hr>

<h2>Another Example</h2>
<p>This example says good day or good evening depending on the time:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white" data-line="5"><code>int time = 20;
...
<h3>Notes</h3>
<ul>
  <li><code class="w3-codespan">else</code> does not have a condition - it runs when the <code class="w3-codespan">if</code> condition is <code class="w3-codespan">false</code>.</li>
  <li>Do not put a semicolon right after <code class="w3-codespan">if (condition)</code>. That would end the statement early and make <code class="w3-codespan">else</code> behave unexpectedly.</li>
</ul>
</div>
