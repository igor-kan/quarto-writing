...
<html lang="en-US">
<head>
<title>Java LinkedList size() Method</title>
<meta charset="utf-8">
...
<h1>Java LinkedList <span class="color_h1">size()</span> Method</h1>
...
<h3>Example</h3>
<p>Find out the size of a list:</p>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_linkedlist_size">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">size()</code> method indicates how many elements are in the list.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public int size()</code></pre>

<h2>Technical Details</h2>
<table class="ws-table-all">
<tr>
 <th style="width:20%">Returns:</th>
 <td style="width:80%">The number of elements in the list.</td>
</tr>
</table><hr>
