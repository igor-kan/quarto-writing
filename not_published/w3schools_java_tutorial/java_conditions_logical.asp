...
<html lang="en-US">
<head>
<title>Java Logical Operators in Conditions</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1">Logical Operators in Conditions</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_conditions_nested.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_conditions_reallife.asp">Next &#10095;</a>
</div>
<hr>

<h2>Logical Operators in Conditions</h2>

<p>You can combine or reverse conditions using <a href="java_operators.asp">logical operators</a>. 
...
<ul>
  ...
  <li><code class="w3-codespan">!</code> (NOT) - reverses a condition (true = false, false = true)</li>
</ul>
...
<pre class="language-java w3-white"><code>int a = 200;
int b = 33;
int c = 500;
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_if_and">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_if_or">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>Use NOT (<code class="w3-codespan">!</code>) to <strong>reverse</strong> a condition:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Test if <code>a</code> is <strong>not</strong> greater than <code>b</code>:</p>
<pre class="language-java w3-white"><code>int a = 33;
int b = 200;
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_if_not">Try it Yourself &raquo;</a>
</p>
</div>
...
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>boolean isLoggedIn = true;
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_if_security">Try it Yourself &raquo;</a>
</p>
</div>
<hr>
