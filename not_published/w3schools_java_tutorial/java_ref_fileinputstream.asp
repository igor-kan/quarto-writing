...
<html lang="en-US">
<head>
<title>Java FileInputStream Reference</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1">FileInputStream Methods</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_ref_file.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_ref_fileoutputstream.asp">Next &#10095;</a>
</div>
<hr>

<h2>FileInputStream Methods</h2>
<p>The <code class="w3-codespan">FileInputStream</code> class provides methods to read data (as bytes) from a file:</p>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td>read()</td>
    <td>Reads one byte of data</td>
    <td>int</td>
  </tr>
  <tr>
    <td>read()</td>
    <td>Reads bytes into an array (or part of an array)</td>
    <td>int</td>
  </tr>
  <tr>
    <td>skip()</td>
    <td>Skips over and discards <em>n</em> bytes of data</td>
    <td>long</td>
  </tr>
  <tr>
    <td>getFD()</td>
...
<p><a href="java_fileinputstream.asp">Java FileInputStream Tutorial</a></p>
