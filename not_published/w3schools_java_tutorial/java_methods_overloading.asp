...
<a class="w3-left w3-btn" href="java_challenges_methods_param.asp">&#10094; Previous</a>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_method_overloading">Try it Yourself &raquo;</a>
</p>
</div>
...
<div class="w3-example">
<h3>Example</h3>
<pre class="language-csharp w3-white"  data-line="1,5,10,11"><code>static int plusMethod(int x, int y) {
  return x + y;
}
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_method_overloading2">Try it Yourself &raquo;</a>
</p>
</div>
...
<hr>
<div id="exercisecontainer" src="xrcise_methods_overloading.js"></div>
<hr>
