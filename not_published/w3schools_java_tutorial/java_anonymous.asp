...
<html lang="en-US">
<head>
<title>Java Anonymous Class</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1">Anonymous Class</span></h1>
...
<p>An <strong>anonymous class</strong> is a class without a name. It is created and used at the same time.</p>
<p>You often use anonymous classes to <strong>override methods</strong> of an existing class or interface, without writing a separate class file.</p>
<p>Here, we create an anonymous class that extends another class and overrides its method:</p>

<div class="w3-example">
<pre class="language-java w3-white"><code>// Normal class
class Animal {
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_anonymous_class">Try it Yourself &raquo;</a></p>
</div>

<hr>

<h2>Anonymous Class from an Interface</h2>
<p>You can also use an anonymous class to implement an interface on the fly:</p>

<div class="w3-example">
<pre class="language-java w3-white"><code>// Interface
interface Greeting {
  void sayHello();
}
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_anonymous_interface">Try it Yourself &raquo;</a></p>
</div>

<div class="ws-note w3-panel">
<h4>When to Use Anonymous Classes?</h4>
<p>Use anonymous classes when you need to create a short class for one-time use. For example:</p>
<ul>
  <li>Overriding a method without creating a new subclass</li>
  <li>Implementing an interface quickly</li>
  <li>Passing small pieces of behavior as objects</li>
</ul>
</div>
