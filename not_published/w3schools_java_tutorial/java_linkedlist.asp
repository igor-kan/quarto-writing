...
<a class="w3-right w3-btn" href="java_sort_list.asp">Next &#10095;</a>
</div>
<hr>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_linkedlist_add">Try it Yourself &raquo;</a>
</p></div>
<hr>
...
<p>The <code class="w3-codespan">LinkedList</code> class has the same methods as <code class="w3-codespan">ArrayList</code> because both follow the <a href="java_list.asp"><code class="w3-codespan">List</code></a> interface.
This means you can add, change, remove, or clear elements in a <code class="w3-codespan">LinkedList</code> just like you would with an <code class="w3-codespan">ArrayList</code>.</p>
...
<p>The <code class="w3-codespan">LinkedList</code> stores its elements in "containers." The list has a link to the first container
...
<tr>
<td><code class="w3-codespan">addFirst()</code></td>
<td>Adds an element to the beginning of the list</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryjava.asp?filename=demo_linkedlist_addfirst">Try it &raquo;</a></td>
</tr>
<tr>
<td><code class="w3-codespan">addLast()</code></td>
<td>Add an element to the end of the list</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryjava.asp?filename=demo_linkedlist_addlast">Try it &raquo;</a></td>
</tr>

<tr>
<td><code class="w3-codespan">removeFirst()</code></td>
<td>Remove an element from the beginning of the list</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryjava.asp?filename=demo_linkedlist_removefirst">Try it &raquo;</a></td>
</tr>

<tr>
<td><code class="w3-codespan">removeLast()</code></td>
<td>Remove an element from the end of the list</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryjava.asp?filename=demo_linkedlist_removelast">Try it &raquo;</a></td>
</tr>

<tr>
<td><code class="w3-codespan">getFirst()</code></td>
<td>Get the element at the beginning of the list</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryjava.asp?filename=demo_linkedlist_getfirst">Try it &raquo;</a></td>
</tr>

<tr>
<td><code class="w3-codespan">getLast()</code></td>
<td>Get the element at the end of the list</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryjava.asp?filename=demo_linkedlist_getlast">Try it &raquo;</a></td>
</tr>
...
<p>
From Java 10, you can use the <code class="w3-codespan">var</code> keyword to declare a <code class="w3-codespan">LinkedList</code> variable without writing the type twice.  
...
var cars = new LinkedList&lt;String&gt;();
  ...
  <p>
    <a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_linkedlist_var">Try it Yourself &raquo;</a>
  </p>
</div>
...
<p><strong>Note:</strong> Sometimes you will see both <code class="w3-codespan">List</code> and <code class="w3-codespan">LinkedList</code> in Java code, like this:</p>

<div class="w3-example">
  <pre class="language-java w3-white"><code>import java.util.List;
import java.util.LinkedList;

List&lt;String&gt; cars = new LinkedList&lt;&gt;();</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_linkedlist_list">Try it Yourself &raquo;</a>
</p>
</div>
<p>This means the variable (cars) is declared as a <a href="java_list.asp"><code class="w3-codespan">List</code></a> (the interface), but it stores a <code class="w3-codespan">LinkedList</code> object (the actual list). Since <code class="w3-codespan">LinkedList</code> implements the <code class="w3-codespan">List</code> interface, this is possible.</p>
...
<div>
<h2>Complete LinkedList Reference</h2>
<p>For a complete reference of LinkedList methods, go to our <a href="java_ref_linkedlist.asp">Java LinkedList Reference</a>.</p>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_linkedlist.js"></div>
<hr>
