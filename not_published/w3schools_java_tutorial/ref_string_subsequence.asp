...
<html lang="en-US">
<head>
<title>Java String subSequence() Method</title>
<meta charset="utf-8">
...
<h1>Java String <span class="color_h1">subSequence()</span> Method</h1>
...
<h3>Example</h3>
<p>Return a sequence of characters from a string:</p>
<pre class="w3-white language-java"><code>String myStr = "Hello, World!";
System.out.println(myStr.subSequence(7, 12));
</code></pre>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_string_subsequence">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">subSequence()</code> method returns a subsequence from the string as a <code class="w3-codespan">CharSequence</code> object.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public CharSequence subSequence(int <em>start</em>, int <em>end</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>start</em></td>
    <td>Required. The index of the character at which the subsequence starts.</td>
  </tr>
  <tr>
    <td><em>end</em></td>
    <td>Required. The index after the last character of the subsequence.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">A <code class="w3-codespan">CharSequence</code> containing a subsequence of the string.</td>
</tr>
<tr>
 <th style="width:20%">Throws:</th>
 <td style="width:80%"><code class="w3-codespan">IndexOutOfBoundsException</code> - If <em>start</em> or <em>end</em> are negative, <em>start</em> is greater than <em>end</em> or <em>end</em> is greater than the length of the string.</td>
</tr>
<tr>
