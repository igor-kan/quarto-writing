...
<html lang="en-US">
<head>
<title>Java throw Keyword</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1"> throw</span> Keyword</h1>
<p>
...
&nbsp;&nbsp;&nbsp; if (age &lt; 18) {
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>throw</strong> new ArithmeticException(&quot;Access denied - You must be at least 18 years old.&quot;);
&nbsp;&nbsp;&nbsp; }
&nbsp;&nbsp;&nbsp; else {
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_throw">Try it Yourself &raquo;</a>
</p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">throw</code> keyword is used to create a custom error.</p>
...
<p>The exception type is often used together with a custom <strong>method</strong>, like in the example above.</p>
<p>Differences between <code class="w3-codespan">throw</code> and <a href="ref_keyword_throws.asp"><code class="w3-codespan">throws</code></a>:</p>
