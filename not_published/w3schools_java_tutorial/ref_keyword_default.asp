...
<html lang="en-US">
<head>
<title>Java default Keyword</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1"> default</span> Keyword</h1>
<p>
...
<h3>Example</h3>
<p>Specify some code to run if there is no case match in a switch block:</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_switch_default">Try it Yourself &raquo;</a>
</p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">default</code> keyword specifies the default block of code in a <code class="w3-codespan"><a href="ref_keyword_switch.asp">switch</a></code> statement.</p>
<p>The <code class="w3-codespan">default</code> keyword specifies some code to run if there is no case match in the switch.</p>
<p><strong>Note:</strong> if the <code class="w3-codespan">default</code> keyword is used 
as the last statement in a switch block, it does not need a <code class="w3-codespan">break</code>.</p>
<hr>


<h2>Related Pages</h2>
<p>Read more about the switch statement in our <a href="java_switch.asp">Java Switch Tutorial</a>.</p>
