...
<html lang="en-US">
<head>
<title>Java Online Compiler (Editor / Interpreter)</title>
<meta charset="utf-8">
...
/* Syntax highlighting */
.java-keyword  { color: #005cc5; }   /* public, class, static, void */
.java-type     { color: #d73a49; }   /* String */
.java-function,.java-main { color: #d73a49; }   /* main, println */
.java-string   { color: green; }     /* "Hello World!" */
.java-number   { color: #098658; }
.java-symbol   { color: #000000; }   /* ; . [] */
.java-brace    { color: #000000; }   /* {} () */
.java-object   { color: #000000; }   /* System, out */

.compiler-wrapper h3 {
  margin-bottom: 10px;
}

.compiler-wrapper ul.w3-ul li {
...
body.darktheme .java-keyword  { color: #c5a5c5; }
body.darktheme .java-type     { color: #faca6b; }
body.darktheme .java-function,.java-main { color: #82aaff; }
body.darktheme .java-string   { color: #c3e88d; }
body.darktheme .java-number   { color: #f78c6c; }
body.darktheme .java-symbol   { color: #f1f1f1; }
body.darktheme .java-brace    { color: #f1f1f1; }
body.darktheme .java-object   { color: #f1f1f1; }
...
<h1>Java <span class="color_h1">Online Compiler</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_videos.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_exercises.asp">Next &#10095;</a>
</div>
<hr>

<h2>Java Compiler (Editor)</h2>

<p>With our online Java compiler, you can edit Java code, and view the result in your browser.</p>
...
<div class="compiler-wrapper">
  ...
  <div class="compiler-body">
    ...
    <div class="editor">
<pre>
<span class="java-keyword">public</span> <span class="java-keyword">class</span> Main <span class="java-brace">{</span>
  <span class="java-keyword">public</span> <span class="java-keyword">static</span> <span class="java-keyword">void</span> <span class="java-function">main</span><span class="java-brace">(</span><span class="java-type">String</span><span class="java-symbol">[]</span> args<span class="java-brace">)</span> <span class="java-brace">{</span>
    <span class="java-object">System</span><span class="java-symbol">.</span><span class="java-object">out</span><span class="java-symbol">.</span><span class="java-function">println</span><span class="java-brace">(</span><span class="java-string">"Hello World!"</span><span class="java-brace">)</span><span class="java-symbol">;</span>
  <span class="java-brace">}</span>
<span class="java-brace">}</span>
</pre>
    </div>
...
Hello World!
  ...
  <div class="compiler-footer">
    <a href="tryjava.asp?filename=demo_compiler"
       target="_blank"
       class="ws-btn">
...
<h2>Build and Publish Java Projects</h2>

<p>If you want to create your own Java applications, <a href="/spaces/index.php">W3Schools Spaces</a> gives you an easy place to write, run, manage, and publish code online.</p>


<hr>
<div class="ws-note w3-panel" style="margin-top:20px;">
  <p>If you don't know Java, we suggest that you read our <a href="default.asp">Java Tutorial</a> from scratch.</p>
</div>
