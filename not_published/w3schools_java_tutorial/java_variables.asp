...
<p>To create a variable in Java, you need to:</p>
<ul>
  <li>Choose a <strong>type</strong> (like <code class="w3-codespan">int</code> or <code class="w3-codespan">String</code>)</li>
  <li>Give the variable a <strong>name</strong> (like <code class="w3-codespan">x</code>, <code class="w3-codespan">age</code>, or <code class="w3-codespan">name</code>)</li>
  <li>Optionally assign it a <strong>value</strong> using <code class="w3-codespan">=</code></li>
</ul>
...
<p>For example, if you want to store some text, you can use a <code class="w3-codespan">String</code>:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Create a variable called <strong>name</strong> of type <code class="w3-codespan">String</code> and assign it the value "<strong>John</strong>&quot;.<br>
Then we use <code class="w3-codespan">println()</code> to print the <strong>name</strong> variable:</p>
<pre class="language-java w3-white"><code>String name = "John";
System.out.println(name);
</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_variables">Try it Yourself &raquo;</a>
</p>
</div>

<p>To create a variable that should store a number, you can use <code class="w3-codespan">int</code>:</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_variables_int">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_variables_int2">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_variables_ow">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_variables_final">Try it Yourself &raquo;</a>
</p>
</div>
...
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: Java Variables</h2>
  <a href="https://youtu.be/YF59k3gZeb4&list=PLP9IO4UYNF0VT3LvP_Cl4EIEyVk-Q5DP3" class="ga-featured ga-youtube" target="blank_" > 
