...
<html lang="en-US">
<head>
<title>Java LinkedList remove() Method</title>
<meta charset="utf-8">
...
<h1>Java LinkedList <span class="color_h1">remove()</span> Method</h1>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_linkedlist_remove">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">remove()</code> method removes an item from the list, either by position or by value. If a position is specified then this method returns the removed item. If a value is specified then it returns <code class="w3-codespan">true</code> if the value was found and <code class="w3-codespan">false</code> otherwise.</p>
<p>If a value is specified and multiple elements in the list have the same value then only the first one is deleted.</p>
<p>If the list contains integers and you want to delete an integer based on its value you will need to pass an <code class="w3-codespan">Integer</code> object. See <em>More Examples</em> below for an example.</p>
<p>
<hr>

<h2>Syntax</h2>
<p>One of the following:</p>
<pre class="language-java"><code>public T remove(int <em>index</em>)</code></pre>
<pre class="language-java"><code>public boolean remove(Object <em>item</em>)</code></pre>
<p><code class="w3-codespan">T</code> refers to the data type of items in the list.</p>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>index</em></td>
    <td>Required. The position of the item to be deleted.</td>
  </tr>
  <tr>
    <td><em>item</em></td>
    <td>Required. The value of the item to be deleted.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">If an object was passed as an argument then it returns <code class="w3-codespan">true</code> if the object was found in the list and false otherwise. If an index was passed then it returns the object which was removed.</td>
</tr>
<tr>
 <th style="width:20%">Throws:</th>
 <td style="width:80%"><code class="w3-codespan">IndexOutOfBoundsException</code> - If the index is less than zero, equal to the size of the list or greater than the size of the list.</td>
</tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Remove an integer from the list by position and by value:</p>
<pre class="w3-white language-java"><code>import java.util.LinkedList;
...
<p><a target="_blank" class="w3-btn w3-margin-bottom" href="tryjava.asp?filename=demo_ref_linkedlist_remove2">Try it Yourself &raquo;</a></p>
</div>
