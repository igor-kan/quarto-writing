...
<html lang="en-US">
<head>
<title>Java Scanner nextBoolean() Method</title>
<meta charset="utf-8">
...
<h1>Java Scanner <span class="color_h1">nextBoolean()</span> Method</h1>
...
<h3>Example</h3>
<p>Print the first boolean value that is found:</p>
...
<p>The <code class="w3-codespan">nextBoolean()</code> method returns the boolean value that the next token represents. A token represents a boolean value if its value matches one of the strings "true" or "false". The match is case-insensitive, which means that values like "True" and "FALSE" also represent a boolean value.</p>
...
<h2>Syntax</h2>
<pre class="language-java"><code>public boolean nextBoolean()</code></pre>

<h2>Technical Details</h2>
<table class="ws-table-all">
<tr>
 <th style="width:20%">Returns:</th>
 <td style="width:80%">The <code class="w3-codespan">boolean</code> value that the next token represents.</td>
</tr>
<tr>
 <th style="width:20%">Throws:</th>
 <td style="width:80%">
  <code class="w3-codespan">InputMismatchException</code> - If the token does not represent a boolean value.<br>
