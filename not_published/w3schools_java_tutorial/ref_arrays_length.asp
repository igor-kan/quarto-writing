...
<html lang="en-US">
<head>
<title>Java Array length Property</title>
<meta charset="utf-8">
...
<h1>Java Array <span class="color_h1">length</span> Property</h1>
...
System.out.println(cars.length);</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_arrays_length">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>The <code class="w3-codespan">length</code> property returns the length of an array.</p>
<p>This is a built-in Java property, and does not belong to the <a href="java_ref_arrays.asp">Java Arrays Class</a>.</p>
<p><strong>Note:</strong> The <code class="w3-codespan">length</code> <strong>property </strong>must not be mistaken with the <a href="ref_string_length.asp"><code class="w3-codespan">length()</code></a>
<strong>method </strong>that is used for Strings.</p>
<hr>

<h2>Syntax</h2>

<pre class="language-java"><code><em>array</em>.length</code></pre>
<hr>
