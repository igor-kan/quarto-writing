...
<h1>Java <span class="color_h1">Type Casting</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_challenges_data_types.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_operators.asp">Next &#10095;</a>
</div>
<hr>

<h2>Java Type Casting</h2>
<p>Type casting means converting one data type into another.  
For example, turning an <code class="w3-codespan">int</code> into a <code class="w3-codespan">double</code>.</p>

<p>In Java, there are two main types of casting:</p>
<ul>
<li><strong>Widening Casting</strong> (automatic) - converting a smaller type to a larger type size<br>
...
<li><strong>Narrowing Casting</strong> (manual) - converting a larger type to a smaller type size<br>
...
<p>Widening casting is done automatically when passing a smaller size type into a larger size type.</p>
<p>This works because there is no risk of losing information.  
For example, an <code class="w3-codespan">int</code> value can safely fit inside a <code class="w3-codespan">double</code>:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>int myInt = 9;
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_casting_wide">Try it Yourself &raquo;</a>
</p>
</div>
<hr>

<h2>Narrowing Casting</h2>
<p>Narrowing casting must be done manually by placing the type in parentheses <code class="w3-codespan">()</code> in front of the value.</p>
<p>This is required because narrowing may result in data loss (for example, dropping decimals when converting a <code class="w3-codespan">double</code> to an <code class="w3-codespan">int</code>):</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>double myDouble = 9.78d;
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_casting_narrow">Try it Yourself &raquo;</a>
</p>
</div>
<hr>
...
<p>Here is a real-life example of type casting.  
We calculate the percentage of a user's score in relation to the maximum score in a game.</p>
<p>We use type casting to make sure that the result is a <strong>floating-point</strong> value, rather than an integer:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>// Set the maximum possible score in the game to 500
int maxScore = 500;
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_casting_reallife">Try it Yourself &raquo;</a>
</p>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_type_casting.js"></div>
<hr>
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: Java Type Casting</h2>
  <a href="https://youtu.be/kFUqkaicfDw&list=PLP9IO4UYNF0VT3LvP_Cl4EIEyVk-Q5DP3" class="ga-featured ga-youtube" target="blank_" > 
