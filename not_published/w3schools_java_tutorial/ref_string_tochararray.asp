...
<html lang="en-US">
<head>
<title>Java String toCharArray() Method</title>
<meta charset="utf-8">
...
<h1>Java String <span class="color_h1">toCharArray()</span> Method</h1>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_string_tochararray">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">toCharArray()</code> method returns a new <code class="w3-codespan">char</code> array representing the contents of the string.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public char[] toCharArray()</code></pre>
