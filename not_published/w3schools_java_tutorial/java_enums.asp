...
<h1>Java <span class="color_h1">Enums</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_anonymous.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_enum_constructor.asp">Next &#10095;</a>
</div>
<hr>

<h2>Enums</h2>
<p>An <code class="w3-codespan">enum</code> is a special "class" that represents a group of 
<strong>constants</strong> (unchangeable variables, like <code class="w3-codespan">final</code> variables).</p>
<p>To create an <code class="w3-codespan">enum</code>, use the <code class="w3-codespan">enum</code> keyword (instead of class or interface), and separate 
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryjava.asp?filename=demo_enums">Try it Yourself &raquo;</a>
</div>
...
<h2>Enum inside a Class</h2>

<p>You can also have an <code class="w3-codespan">enum</code> inside a class:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryjava.asp?filename=demo_enums_class">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Enum in a Switch Statement</h2>

<p>Enums are often used in <code class="w3-codespan">switch</code> statements to check for corresponding values:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryjava.asp?filename=demo_enums_switch">Try it Yourself &raquo;</a>
</div>
<hr>
...
<hr>
<h2>Loop Through an Enum</h2>

<p>The enum type has a <code class="w3-codespan">values()</code> method, which returns an array of all enum constants. This method is useful when you want to loop through the constants of an enum:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryjava.asp?filename=demo_enums_loop">Try it Yourself &raquo;</a>
</div>
<div class="ws-note w3-panel">
...
<p>Use enums when you have values that you know aren't going to change, like month days, days, colors, deck of cards, etc.</p></div>
<hr>
<div id="exercisecontainer" src="xrcise_enums.js"></div>
<hr>
