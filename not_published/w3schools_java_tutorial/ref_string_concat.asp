...
<html lang="en-US">
<head>
<title>Java String concat() Method</title>
<meta charset="utf-8">
...
<h1>Java String <span class="color_h1">concat()</span> Method</h1>
...
String lastName = &quot;Doe&quot;;
System.out.println(firstName.concat(lastName));</code></pre>
<p>
  <a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_string_concat">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>The <code class="w3-codespan">concat()</code> method appends (concatenate) a 
string to the end of another string.</p>

<hr>

<h2>Syntax</h2>

<pre class="language-java"><code>public String concat(String <em>string2</em>)
</code></pre>
...
<table class="ws-table-all notranslate"> 
  <tbody><tr>
    ...
    <tr>
    <td><em>string2</em></td>
    <td>A <code class="w3-codespan">String</code>, representing the string that 
    should be appended to the other string</td>
    </tr>
</tbody>
</table>
...
<tr>
 <th style="width:21%">Returns:</th>
  <td>A <code class="w3-codespan">String</code>, representing the text of the combined strings</td>
</tr>
</table>
<br>
