...
<html lang="en-US">
<head>
<title>Java Short Hand If...Else (Ternary Operator)</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1">Short Hand If...Else (Ternary Operator)</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_conditions_elseif.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_conditions_nested.asp">Next &#10095;</a>
</div>
<hr>

<h2>Short Hand if...else</h2>
<p>There is also a short-hand <a href="java_conditions_else.asp">if else</a>, which is known as the <strong>ternary 
operator</strong> because it consists of three operands.</p>
<p>It can be used to 
...
<h3>Syntax</h3>
<em><pre class="language-java w3-white"><code><em>variable</em> = (<em>condition</em>) ? <em>expressionTrue</em> : <em> expressionFalse</em>;
</code></pre></em>
</div>
...
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>int time = 20;
if (time &lt; 18) {
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_if_else">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_if_ternary">Try it Yourself &raquo;</a>
</p>
</div>

<p>You can also use the ternary operator directly inside <code class="w3-codespan">System.out.println()</code> without a temporary variable:</p>
<div class="w3-example">
  <h3>Example</h3>
  <pre class="language-java w3-white"><code>int time = 20;
System.out.println((time &lt; 18) ? "Good day." : "Good evening.");</code></pre>
  <p>
    <a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_if_ternary2">Try it Yourself &raquo;</a>
  </p>
</div>
...
<hr>
<h2>Nested Ternary (Optional)</h2>
<p>You can nest ternary operators to handle more than two possible outcomes, but this can make your code harder to read:</p>
<div class="w3-example">
  <h3>Example</h3>
  <pre class="language-java w3-white"><code>int time = 22;
String message = (time &lt; 12) ? "Good morning."
               : (time &lt; 18) ? "Good afternoon."
               : "Good evening.";
System.out.println(message);</code></pre>
  <p>
    <a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_if_ternary_nested">Try it Yourself &raquo;</a>
  </p>
</div>

<div class="ws-note ws-panel">
  <p><strong>Tip:</strong> Use the ternary operator for short, simple choices. For longer or more complex logic, the regular <code class="w3-codespan">if...else</code> is easier to read.</p>
</div>
