...
<html lang="en-US">
<head>
<title>Java How to Check Whether a Number is Even or Odd</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1">How To Find Even or Odd Numbers</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_howto_swap_two_variables.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_howto_reverse_number.asp">Next &#10095;</a>
</div>
<hr>
...
<h3>Example</h3>
<pre class="language-java w3-white"><code>int number = 5;
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryjava.asp?filename=demo_howto_even_or_odd">Try it Yourself &raquo;</a>
</div>

<p><b>Explanation:</b> The operator <code class="w3-codespan">%</code> gives the remainder when dividing a number.  
<br>- If <code class="w3-codespan">number % 2</code> equals <code class="w3-codespan">0</code>, the number divides evenly by 2, it is even.  
<br>- Otherwise, it has a remainder, it is odd.</p>

<hr>
<h2>Related Pages</h2>
<p><a href="java_data_types_numbers.asp">Java Numbers Tutorial</a></p>
<p><a href="java_operators.asp">Java Operators Tutorial</a></p>
