...
<html lang="en-US">
<head>
<title>Java instanceof Keyword</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1"> instanceof</span> Keyword</h1>
<p>
...
<h3>Example</h3>
<p>Check whether an object is an instance of a specific class:</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_instanceof">Try it Yourself &raquo;</a>
</p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">instanceof</code> keyword checks whether an object is an instance of a specific class or 
an interface.</p>
<p>The instanceof keyword compares the instance with type. The return value is either <code class="w3-codespan">true</code> or <code class="w3-codespan">false</code>.</p>
<hr>
