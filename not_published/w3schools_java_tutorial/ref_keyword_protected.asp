...
<html lang="en-US">
<head>
<title>Java protected Keyword</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1"> protected</span> Keyword</h1>
<p>
...
<h3>Example</h3>
<p>The <code class="w3-codespan">Student</code> subclass accesses a <code class="w3-codespan">Person</code> class with <code class="w3-codespan">protected</code> attributes:</p>
<pre class="language-java w3-white"><code>class Person {
&nbsp; <strong>protected</strong> String fname = &quot;John&quot;;
&nbsp; <strong>protected</strong> String lname = &quot;Doe&quot;;
&nbsp; <strong>protected</strong> String email = &quot;john@doe.com&quot;;
&nbsp; <strong>protected</strong> int age = 24;
}
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_mod_protected">Try it Yourself &raquo;</a>
</p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">protected</code> keyword is an access modifier used for attributes, methods and constructors, making them accessible in the same package and subclasses.</p>
<hr>
