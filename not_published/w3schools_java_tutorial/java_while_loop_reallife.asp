...
<html lang="en-US">
<head>
<title>Java Real-Life While Loop Examples</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1">While Loop Examples</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_while_loop_do.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_challenges_while_loop.asp">Next &#10095;</a>
</div>
<hr>

<h2>Real-Life Examples</h2>
<p>To demonstrate a practical example of the <strong>while loop</strong>, we have created a simple "countdown" program:</p>
...
System.out.println(&quot;Happy New Year!!&quot;);</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_while_loop_reallife">Try it Yourself &raquo;</a>
</p>
</div>

<p>To demonstrate a practical example of the <strong>while loop</strong> combined with an <strong>if else statement</strong>, let's say we play a game of Yatzy:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Print "Yatzy!" If the dice number is 6:</p>
<pre class="language-java w3-white"><code>int dice = 1;
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_while_loop_reallife2">Try it Yourself &raquo;</a>
</p>
</div>
