...
<html lang="en-US">
<head>
<title>Java HashMap putIfAbsent() Method</title>
<meta charset="utf-8">
...
<h1>Java HashMap <span class="color_h1">putIfAbsent()</span> Method</h1>
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_hashmap_putifabsent">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">putIfAbsent()</code> method writes an entry into the map. If an entry with the same key already exists and its value is not <code class="w3-codespan">null</code> then the map is not changed.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public V putIfAbsent(K <em>key</em>, V <em>value</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>key</em></td>
    <td>Required. The key of the map entry.</td>
  </tr>
  <tr>
    <td><em>value</em></td>
    <td>Required. The value of the map entry.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">If an entry exists with the specified key then it returns the value of that entry, otherwise it returns <em>null</em>.</td>
</tr>
</table>
