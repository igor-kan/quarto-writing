...
<html lang="en-US">
<head>
<title>Java Scanner findWithinHorizon() Method</title>
<meta charset="utf-8">
...
<h1>Java Scanner <span class="color_h1">findWithinHorizon()</span> Method</h1>
...
<h3>Example</h3>
<p>Find an email address in a line of text:</p>
...
<p>The <code class="w3-codespan">findWithinHorizon()</code> method searches through a specified number of characters for the first match of a regular expression provided by a <code class="w3-codespan">Pattern</code> object or a string. If a match is not found then it returns <code class="w3-codespan">null</code>.</p>
<p>The number of characters to search is specified by the <em>horizon</em> parameter, if it is set to zero then it continues searching without limit.</p>
<p>If a match is found the scanner advances to the first character following the match.</p>
<p>Learn more about the regular expressions in our <a href="java_regex.asp">Java RegEx tutorial</a>.</p>
<hr>

<h2>Syntax</h2>
<p>One of the following:</p>
<pre class="language-java"><code>public String findWithinHorizon(Pattern <em>pattern</em>, int <em>horizon</em>)</code></pre>
<pre class="language-java"><code>public String findWithinHorizon(String <em>pattern</em>, int <em>horizon</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>pattern</em></td>
    <td>Required. A string or <code class="w3-codespan">Pattern</code> object. Specifies the regular expression used in the search.</td>
  </tr>
  <tr>
    <td><em>horizon</em></td>
    <td>Required. Specifies a limit for how far ahead to search. If the value is zero then there is no limit.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%">A <code class="w3-codespan">String</code> containing the matched text or <code class="w3-codespan">null</code> if no match was found.</td>
</tr>
<tr>
 <th style="width:20%">Throws:</th>
 <td style="width:80%">
  <code class="w3-codespan">IllegalStateException</code> - If the scanner has been closed.<br>
  <code class="w3-codespan">IllegalArgumentException</code> - If the <em>horizon</em> parameter is negative.<br>
 </td>
</tr>
</table>
<hr>
