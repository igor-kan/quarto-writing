...
<html lang="en-US">
<head>
<title>Java Variables Real-Life Examples</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1">Variables - Examples</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_variables_final.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_challenges_variables.asp">Next &#10095;</a>
</div>
<hr>

<h2>Real-Life Examples</h2>
<p>Often in our examples, we simplify variable names to match their data type (myInt or myNum for <code class="w3-codespan">int</code> types, myChar for <code class="w3-codespan">char</code> types, and so on). This is done to avoid confusion.</p>
...
<h3>Example</h3>
<pre class="language-java w3-white"><code>// Student data
...
System.out.println(&quot;Student grade: &quot; + studentGrade);</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_variables_reallife">Try it Yourself &raquo;</a>
</p>
</div>
<hr>

<h2>Calculate the Area of a Rectangle</h2>
<p>In this real-life example, we create a program to calculate the area of a rectangle (by multiplying the length and width):</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-java w3-white"><code>// Create integer variables
int length = 4;
int width = 6;
int area;
...
System.out.println(&quot;Area of the rectangle is: &quot; + area);</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_variables_reallife2">Try it Yourself &raquo;</a>
</p>
</div>
