...
<html lang="en-US">
<head>
<title>Java Math expm1() Method</title>
<meta charset="utf-8">
...
<h1>Java Math <span class="color_h1">expm1()</span> Method</h1>
...
<h3>Example</h3>
<p>Return <em>e</em><sup>x</sup> - 1 for different values of x:</p>
<pre class="w3-white language-java"><code>System.out.println(Math.expm1(0));
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_math_expm1">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">expm1()</code> method returns the solution to <em>e</em><sup>x</sup> - 1 for any number x.</p>
<p><em>e</em> is the base of the natural system of logarithms (approximately 2.718282). In Java, the value of <em>e</em> is available as the constant <span class="w3-codespan">Math.E</span>.</p>
<hr>

<h2>Syntax</h2>
<pre class="language-java"><code>public static double expm1(double <em>number</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>number</em></td>
    <td>Required. The value of x in the formula <em>e</em><sup>x</sup> - 1.</td>
  </tr>
</table>
...
<tr>
  ...
  <td style="width:80%">A <code class="w3-codespan">double</code> value representing the solution to <em>e</em><sup>x</sup> - 1 for a number x.</td>
</tr>
<tr>
