...
<html lang="en-US">
<head>
<title>Java Identifiers (Variable Names)</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1">Identifiers</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_variables_multiple.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_variables_final.asp">Next &#10095;</a>
</div>
<hr>
...
<h3>Example</h3>
<pre class="language-java w3-white"><code>// Good
int minutesPerHour = 60;

// OK, but not so easy to understand what <strong>m</strong> actually is
int m = 60;
</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_variables_identifiers">Try it Yourself &raquo;</a>
</p>
</div>
...
<ul>
  ...
  <code class="w3-codespan">boolean</code>) cannot be used as names</li>
</ul>
<hr>

<h2>Invalid Identifiers</h2>
<p>Here are some examples of <strong>invalid</strong> identifiers that would cause errors:</p>

<div class="w3-example w3-pale-red">
<h3>Example</h3>
<pre class="language-java w3-white w3-border-red"><code>// Invalid identifiers:
