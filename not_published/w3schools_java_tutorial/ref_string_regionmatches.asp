...
<html lang="en-US">
<head>
<title>Java String regionMatches() Method</title>
<meta charset="utf-8">
...
<h1>Java String <span class="color_h1">regionMatches()</span> Method</h1>
...
<h3>Example</h3>
<p>Test if two string regions are equal:</p>
<pre class="w3-white language-java"><code>String myStr1 = "Hello, World!";
...
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_string_regionmatches">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">regionMatches()</code> method compares regions in two different strings to check if they are equal.</p>
<hr>

<h2>Syntax</h2>
<p>One of the following:</p>
<pre class="language-java"><code>public boolean regionMatches(boolean <em>ignoreCase</em>, int <em>offset</em>, String <em>other</em>, int <em>otherOffset</em>, int <em>length</em>)</code></pre>
<pre class="language-java"><code>public boolean regionMatches(int <em>offset</em>, String <em>other</em>, int <em>otherOffset</em>, int <em>length</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>ignoreCase</em></td>
    <td>Optional. When true the comparison between regions will be case-insensitive. Defaults to false.</td>
  </tr>
  <tr>
    <td><em>offset</em></td>
    <td>Required. The position in the string where the region starts.</td>
  </tr>
  <tr>
    <td><em>other</em></td>
    <td>Required. The string with the other region that is being compared.</td>
  </tr>
  <tr>
    <td><em>otherOffset</em></td>
    <td>Required. The position in the other string where the region starts.</td>
  </tr>
  <tr>
    <td><em>length</em></td>
    <td>Required. The size of the regions being compared.</td>
  </tr>
</table>
...
<tr>
 ...
 <td style="width:80%"><code class="w3-codespan">true</code> if the two regions are equal, <code class="w3-codespan">false</code> otherwise.</td>
</tr>
<tr>
