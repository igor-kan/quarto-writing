...
<html lang="en-US">
<head>
<title>Java Operator Precedence</title>
<meta charset="utf-8">
...
<h1>Java <span class="color_h1">Operator Precedence</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_operators_logical.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_challenges_operators.asp">Next &#10095;</a>
</div>
<hr>

<h2>Java Operator Precedence</h2>
<p>When a calculation contains more than one operator, Java follows <strong>order of operations</strong> rules to decide which part to calculate first.</p>
<p>For example, multiplication happens before addition:</p>

<div class="w3-example">
  <h3>Example</h3>
  <pre class="language-java w3-white"><code>int result1 = 2 + 3 * 4;     // 2 + 12 = 14
int result2 = (2 + 3) * 4;   // 5 * 4 = 20

System.out.println(result1);
System.out.println(result2);</code></pre>
  <p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_oper_precedence">Try it Yourself &raquo;</a></p>
</div>
...
<p>Here are some common operators, from highest to lowest priority:</p>
<ul>
...
<div class="w3-example">
  <h3>Example</h3>
  <pre class="language-java w3-white"><code>int result1 = 10 - 2 + 5;    // (10 - 2) + 5 = 13
int result2 = 10 - (2 + 5);  // 10 - 7 = 3

System.out.println(result1);
System.out.println(result2);</code></pre>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_oper_precedence2">Try it Yourself &raquo;</a></p>
</div>
...
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: Java Operators</h2>
  <a href="https://youtu.be/RbjB3SIaabM&list=PLP9IO4UYNF0VT3LvP_Cl4EIEyVk-Q5DP3" class="ga-featured ga-youtube" target="blank_" > 
    <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
      <div style="position:absolute;top:40%;text-align: center;margin:auto;">
        <picture>
          ...
          <img src="images/yt_logo_rgb_dark.png" style="width:30%;" alt="Java Tutorial on YouTube" loading="lazy">
        </picture>
      </div>
      <picture id="yt_div">
