...
<h1>Java <span class="color_h1"> abstract</span> Keyword</h1>
<p>
...
<pre class="language-java w3-white"><code>// Code from filename: Main.java
...
<p>The <code class="w3-codespan">abstract</code> keyword is a non-access modifier, used for classes and methods.</p>
<p><strong>Class:</strong> An abstract class is a restricted class that cannot be used to create objects (to access it, it must be inherited from another class).</p>
<p><strong>Method:</strong> An abstract method can only be used in an abstract class, and it does not have a body. The body is provided by the subclass (inherited from).</p>
<hr>
