...
<html lang="en-US">
<head>
<title>Java Math scalb() Method</title>
<meta charset="utf-8">
...
<h1>Java Math <span class="color_h1">scalb()</span> Method</h1>
...
<h3>Example</h3>
<p>Return numbers multiplied by powers of 2:</p>
<pre class="w3-white language-java"><code>System.out.println(Math.scalb(1.5, 4));
System.out.println(Math.scalb(1.0, 5));
System.out.println(Math.scalb(1.2, 0));
System.out.println(Math.scalb(1.85, 10));
</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryjava.asp?filename=demo_ref_math_scalb">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">scalb()</code> method returns the result of the formula <em>x</em>&middot;2<sup><em>y</em></sup> for a floating point number <em>x</em> and an integer <em>y</em>.</p>
<hr>

<h2>Syntax</h2>
<p>One of the following:</p>
<pre class="language-java"><code>public static double scalb(double <em>x</em>, int <em>y</em>)</code></pre>
<pre class="language-java"><code>public static float scalb(float <em>x</em>, int <em>y</em>)</code></pre>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>x</em></td>
    <td>Required. The number to be multiplied by the power of 2.</td>
  </tr>
  <tr>
    <td><em>y</em></td>
    <td>Required. The exponent for the base 2.</td>
  </tr>
</table>
...
<tr>
  ...
  <td style="width:80%">A <code class="w3-codespan">double</code> or <code class="w3-codespan">float</code> value representing the result of the formula <em>x</em>&middot;2<sup><em>y</em></sup>.</td>
</tr>
<tr>
