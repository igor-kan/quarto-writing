...
<h1>Java <span class="color_h1">Set</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_sort_list.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_hashset.asp">Next &#10095;</a>
</div>
<hr>

<h2>Java Set Interface</h2>
<p>The <code class="w3-codespan">Set</code> interface is part of the <a href="java_collections.asp">Java Collections Framework</a> and is used to store a collection of <strong>unique elements</strong>.</p>

<p>Unlike a <a href="java_list.asp"><code class="w3-codespan">List</code></a>, a <code class="w3-codespan">Set</code> does <strong>not allow duplicates</strong>, and it does not preserve the order of elements (unless you're using <a href="java_treeset.asp"><code class="w3-codespan">TreeSet</code></a> or <a href="java_linkedhashset.asp"><code class="w3-codespan">LinkedHashSet</code></a>).</p>

<p>Common classes that implement <code class="w3-codespan">Set</code>:</p>
<ul>
  <li><a href="java_hashset.asp"><code class="w3-codespan">HashSet</code></a> - fast and unordered</li>
  <li><a href="java_treeset.asp"><code class="w3-codespan">TreeSet</code></a> - sorted set</li>
  <li><a href="java_linkedhashset.asp"><code class="w3-codespan">LinkedHashSet</code></a> - ordered by insertion</li>
</ul>

<div class="ws-note ws-panel">
  <p><strong>Tip:</strong> Use a <code class="w3-codespan">Set</code> when you need to store unique values only.</p>
</div>
<hr>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><code class="w3-codespan">add()</code></td>
    <td>Adds an element if it's not already in the set</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">remove()</code></td>
    <td>Removes the element from the set</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">contains()</code></td>
    <td>Checks if the set contains the element</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">size()</code></td>
    <td>Returns the number of elements</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">clear()</code></td>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    ...
    <td>Does not guarantee order</td>
  </tr>
  <tr>
...
<p>Next, you'll explore the <code class="w3-codespan">HashSet</code> class in detail.</p>
