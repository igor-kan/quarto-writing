...
<html lang="en-US">
<head>
<title>Java Math abs() Method</title>
<meta charset="utf-8">
...
<h1>Java Math <span class="color_h1">abs()</span> Method</h1>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Return the absolute (positive) value of different numbers:</p>
<pre class="language-java w3-white"><code>System.out.println(Math.abs(-4.7));
System.out.println(Math.abs(4.7));
System.out.println(Math.abs(3)); </code></pre>
<p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_ref_math_abs">Try it Yourself &raquo;</a></p>
</div>
...
<p>The <code class="w3-codespan">abs()</code> method returns the absolute (positive) value of a number.</p>

<hr>

<h2>Syntax</h2>
<p>One of the following:</p>
<pre class="language-java"><code>public static double abs(double <em>number</em>)
</code></pre>
<pre class="language-java"><code>public static float abs(float <em>number</em>)
</code></pre>
<pre class="language-java"><code>public static int abs(int <em>number</em>)
</code></pre>
<pre class="language-java"><code>public static long abs(long <em>number</em>)
</code></pre>
...
<tr>
 <th style="width:21%">Returns:</th>
  <td>A <code class="w3-codespan">double</code>, <code class="w3-codespan">float</code>, <code class="w3-codespan">int</code> or <code class="w3-codespan">long</code> value 
  representing the absolute value of the specified number</td>
</tr>
</table>
<br>
