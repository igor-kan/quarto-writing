...
<a class="w3-left w3-btn" href="java_map.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_treemap.asp">Next &#10095;</a>
</div>
<hr>

<h2>Java HashMap</h2>

<p>A <code class="w3-codespan">HashMap</code> stores items in <strong>key/value pairs</strong>, where each key maps to a specific value.</p>

<p>
  It is part of the <code class="w3-codespan">java.util</code> package and implements the 
  <a href="java_map.asp"><code class="w3-codespan">Map</code></a> interface.
</p>

<p>Instead of accessing elements by an index (like with <a href="java_arraylist.asp">ArrayList</a>), you use a <strong>key</strong> to retrieve its associated <strong>value</strong>.</p>

<p>A <code class="w3-codespan">HashMap</code> can store many different combinations, such as:</p>

<ul>
  <li><code class="w3-codespan">String</code> keys and <code class="w3-codespan">Integer</code> values</li>
  <li><code class="w3-codespan">String</code> keys and <code class="w3-codespan">String</code> values</li>
</ul>
...
<p>
  Create a <code class="w3-codespan">HashMap</code> object called <code class="w3-codespan">capitalCities</code> that will store 
...
HashMap&lt;String, String&gt; capitalCities = new HashMap&lt;&gt;();</code></pre>
</div>
<p>
...
<h2>Add Items</h2>
<p>To add items to a <code class="w3-codespan">HashMap</code>, use the <code class="w3-codespan">put()</code> method:</p>
<div class="w3-example">
<h3>Example</h3>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_hashmap_put">Try it Yourself &raquo;</a>
</p>
</div>
<p><strong>Note:</strong> In the example above, if the same key (like "Norway") is added more than once, the <em>latest</em> value will overwrite the previous one, because keys in a <code class="w3-codespan">HashMap</code> must be unique.</p>
<hr>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_hashmap_get">Try it Yourself &raquo;</a>
</p>
</div>
<hr>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_hashmap_remove">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_hashmap_clear">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_hashmap_size">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_hashmap_loop_key">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_hashmap_loop_value">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_hashmap_loop_keyvalue">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_hashmap_integer">Try it Yourself &raquo;</a>
</p>
</div>
<hr>

<h2>When Order Matters</h2>
<p>In the next chapter, you will learn about <a href="java_treemap.asp"><code class="w3-codespan">TreeMap</code></a>, which stores key/value pairs <strong>in sorted order by key</strong>.</p>
<hr>

<h2>The var Keyword</h2>

<p>
From Java 10, you can use the <code class="w3-codespan">var</code> keyword to declare a <code class="w3-codespan">HashMap</code> variable without writing the type twice.  
...
var capitalCities = new HashMap&lt;String, String&gt;();
  ...
  <p>
    <a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_hashmap_var">Try it Yourself &raquo;</a>
  </p>
</div>
...
<p><strong>Note:</strong> Sometimes you will see both <code class="w3-codespan">Map</code> and <code class="w3-codespan">HashMap</code> in Java code, like this:</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_hashmap_map">Try it Yourself &raquo;</a>
</p>
</div>
<p>This means the variable (capitalCities) is declared as a <a href="java_map.asp"><code class="w3-codespan">Map</code></a> (the interface), but it stores a <code class="w3-codespan">HashMap</code> object (the actual map). Since <code class="w3-codespan">HashMap</code> implements the <code class="w3-codespan">Map</code> interface, this is possible.</p>
...
<div>
<h2>Complete HashMap Reference</h2>
<p>For a complete reference of HashMap methods, go to our <a href="java_ref_hashmap.asp">Java HashMap Reference</a>.</p>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_hashmap.js"></div>
<hr>
