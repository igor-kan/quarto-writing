...
<h1>Java <span class="color_h1">TreeMap</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="java_hashmap.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="java_linkedhashmap.asp">Next &#10095;</a>
</div>
<hr>

<h2>Java TreeMap</h2>

<p>A <code class="w3-codespan">TreeMap</code> is a collection that stores key/value pairs <strong>in sorted order by key</strong>.</p>
...
<div class="ws-note ws-panel">
  <p><strong>Tip:</strong> Unlike <a href="java_hashmap.asp"><code class="w3-codespan">HashMap</code></a>, which does not maintain order, <code class="w3-codespan">TreeMap</code> keeps its keys sorted.</p>
</div>

<hr>

<h2>Create a TreeMap</h2>
<p>Create a <code class="w3-codespan">TreeMap</code> that stores <code class="w3-codespan">String</code> keys and <code class="w3-codespan">String</code> values:</p>

<div class="w3-example">
  <h3>Example</h3>
  <pre class="language-java w3-white"><code>import java.util.TreeMap; // Import the TreeMap class

TreeMap&lt;String, String&gt; capitalCities = new TreeMap&lt;&gt;();</code></pre>
</div>

<p>
  Now you can use methods like <code class="w3-codespan">put()</code>, <code class="w3-codespan">get()</code>, 
  and <code class="w3-codespan">remove()</code> to manage sorted key/value pairs.
</p>

<hr>

<h2>Add Items</h2>
<p>Use the <code class="w3-codespan">put()</code> method to add key/value pairs:</p>

<div class="w3-example">
  <h3>Example</h3>
  <pre class="language-java w3-white"><code>import java.util.TreeMap;
...
public class Main {
  ...
  <p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_treemap_put">Try it Yourself &raquo;</a></p>
</div>
<div class="ws-note ws-panel">
  <p><strong>Output:</strong> The keys are sorted alphabetically (e.g., {Austria=Wien, England=London, India=New Dehli, Norway=Oslo, USA=Washington DC}).</p>
  <p><strong>Note:</strong> Duplicates like &quot;Norway&quot; will only appear once.</p>
</div>
...
<p>Use <code class="w3-codespan">get()</code> with the key to access its value:</p>

<div class="w3-example">
  <h3>Example</h3>
  <pre class="language-java w3-white"><code>capitalCities.get("England");</code></pre>
  <p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_treemap_get">Try it Yourself &raquo;</a></p>
</div>

<hr>

<h2>Remove Items</h2>
<p>Use <code class="w3-codespan">remove()</code> to delete a key/value pair by key:</p>

<div class="w3-example">
  <h3>Example</h3>
  <pre class="language-java w3-white"><code>capitalCities.remove("England");</code></pre>
  <p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_treemap_remove">Try it Yourself &raquo;</a></p>
</div>
...
<div class="w3-example">
  ...
  <p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_treemap_clear">Try it Yourself &raquo;</a></p>
</div>

<hr>

<h2>TreeMap Size</h2>
<p>Use <code class="w3-codespan">size()</code> to count the number of key/value pairs:</p>

<div class="w3-example">
  <h3>Example</h3>
  <pre class="language-java w3-white"><code>capitalCities.size();</code></pre>
  <p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_treemap_size">Try it Yourself &raquo;</a></p>
</div>
<p><strong>Note:</strong> The size only counts unique keys. If a key is added more than once, only the latest value is kept.</p>

<hr>

<h2>Loop Through a TreeMap</h2>
<p>Loop through the items of a <code class="w3-codespan">TreeMap</code> with a for-each loop.</p>
...
for (String i : capitalCities.keySet()) {
  ...
  <p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_treemap_loop_key">Try it Yourself &raquo;</a></p>
</div>
...
for (String i : capitalCities.values()) {
  ...
  <p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_treemap_loop_value">Try it Yourself &raquo;</a></p>
</div>
...
for (String i : capitalCities.keySet()) {
  ...
  <p><a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_treemap_loop_keyvalue">Try it Yourself &raquo;</a></p>
</div>

<hr>

<h2>TreeMap vs HashMap</h2>
<table class="ws-table-all notranslate">
  <tr>
    <th>Feature</th>
    <th><code class="w3-codespan">HashMap</code></th>
    <th><code class="w3-codespan">TreeMap</code></th>
  </tr>
  <tr>
    <td>Order</td>
  ...
  <tr>
    <td>Null Keys</td>
    <td>Allows one null key</td>
    <td>Does not allow null keys</td>
  </tr>
  <tr>
    <td>Performance</td>
    <td>Faster (no sorting)</td>
    <td>Slower (maintains sorted order)</td>
  </tr>
</table>

<div class="ws-note ws-panel">
  <p><strong>Tip:</strong> Use <a href="java_hashmap.asp"><code class="w3-codespan">HashMap</code></a> for performance, and <code class="w3-codespan">TreeMap</code> when you need sorted keys.</p>
</div>
<hr>
...
<p>
From Java 10, you can use the <code class="w3-codespan">var</code> keyword to declare a <code class="w3-codespan">TreeMap</code> variable without writing the type twice.  
...
var capitalCities = new TreeMap&lt;String, String&gt;();
  ...
  <p>
    <a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_treemap_var">Try it Yourself &raquo;</a>
  </p>
</div>
...
<p><strong>Note:</strong> Sometimes you will see both <code class="w3-codespan">Map</code> and <code class="w3-codespan">TreeMap</code> in Java code, like this:</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryjava.asp?filename=demo_treemap_map">Try it Yourself &raquo;</a>
</p>
</div>
<p>This means the variable (capitalCities) is declared as a <a href="java_map.asp"><code class="w3-codespan">Map</code></a> (the interface), but it stores a <code class="w3-codespan">TreeMap</code> object (the actual map). Since <code class="w3-codespan">TreeMap</code> implements the <code class="w3-codespan">Map</code> interface, this is possible.</p>
