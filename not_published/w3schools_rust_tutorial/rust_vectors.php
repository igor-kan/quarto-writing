...
ny:-->
    ...
    <h1>Rust <span class="color_h1">Vectors</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="rust_arrays.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="rust_tuples.php">Next &#10095;</a>
</div>
<hr>

<h2>Vectors</h2>

<p>A <strong>vector</strong> is a resizable array.  
Unlike regular arrays, vectors can grow or shrink in size.</p>
...
<p>To create a vector, use the <code class="w3-codespan">vec!</code> macro:</p>
...
<p>This creates a vector with three string elements.</p>

<hr>

<h2>Access Vector Elements</h2>

<p>You can access values in a vector using index numbers (just like arrays):</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
let fruits = vec!["apple", "banana", "orange"];<br>
println!("First fruit: {}", fruits[0]);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_vectors">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Change Vector Values</h2>

<p>To change a value in the vector, refer to the index number and assign a new 
value. </p>
<p>Remember to make the vector mutable (using the <code class="w3-codespan">mut</code> keyword):</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
let mut fruits = vec!["apple", "banana", "orange"];<br>
fruits[0] = "grape";<br>
println!("New first fruit: {}", fruits[0]);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_vectors_change">Try it Yourself &raquo;</a>
</div>
...
<h2>Add Elements to a Vector</h2>

<p>You can add a new element to the end of a vector using the <code class="w3-codespan">push()</code> 
method:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
let mut fruits = vec!["apple", "banana"];<br>
fruits.push("cherry");<br>
println!("{:?}", fruits); // ["apple", "banana", "cherry"]
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_vectors_add">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Remove Elements from a Vector</h2>

<p>To remove the last element from a vector, use <code class="w3-codespan">pop()</code>:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
let mut fruits = vec!["apple", "banana", "cherry"];<br>
fruits.pop();<br>
println!("{:?}", fruits); // ["apple", "banana"]
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_vectors_remove">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Add or Remove Elements at a Specified Index</h2>

<p>Rust vectors are designed to grow and shrink at the <strong>end</strong>, but you can also add or remove 
elements at the <strong>beginning</strong> 
or <strong>at a specified index</strong>.</p>

<p>Use <code class="w3-codespan">insert()</code> to add an item at a specified 
index:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Add "apple" to the beginning of the vector:</p>
<div class="w3-code notranslate javaHigh">
let mut fruits = vec!["banana", "orange"];<br>
fruits.insert(0, "apple");<br>
println!("{:?}", fruits); // ["apple", "banana", "orange"]
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_vectors_insert">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Add "apple" in the middle of the vector:</p>
<div class="w3-code notranslate javaHigh">
let mut fruits = vec!["banana", "orange"];<br>
fruits.insert(1, "apple");<br>
println!("{:?}", fruits); // ["banana", "apple", "orange"]
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_vectors_insert2">Try it Yourself &raquo;</a>
</div>


<h4>Remove the First Item</h4>

<p>Use <code class="w3-codespan">remove()</code> to remove an element from a specified 
index:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Remove the first item in the vector:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_vectors_remove2">Try it Yourself &raquo;</a>
</div>

<p><strong>Note:</strong> Adding or removing elements from the beginning is slower than at the end,  
because all the other elements have to shift positions.</p>
<hr>
<h2>Vector Length</h2>

<p>You can find out how many elements there are in a vector using the <code class="w3-codespan">.len()</code> method:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
let fruits = vec!["apple", "banana", "cherry"];<br>
println!("There are {} fruits.", fruits.len());
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_vectors_length">Try it Yourself &raquo;</a>
</div>
...
<p>Just like arrays, you can use a <code class="w3-codespan">for</code> loop to go through all the values in a vector:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_vectors_loop">Try it Yourself &raquo;</a>
</div>

<p><strong>Note:</strong> Use <code class="w3-codespan">&amp;fruits</code> to borrow the vector instead of moving it.</p>
<p>In Rust, borrowing means using a reference to a value instead of taking ownership of it.
When you loop through a vector without <code class="w3-codespan">&</code>, the values are moved out, and you can no longer use the vector.
But when you borrow the vector using <code class="w3-codespan">&</code>, you can still use it later in your program.</p>
<p>You can learn more about ownership in our chapters on <a href="rust_ownership.php">Ownership</a> and <a href="rust_borrowing_references.php">Borrowing and References</a>.</p>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="rust_arrays.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="rust_tuples.php">Next &#10095;</a>
