...
ny:-->
    ...
    <h1>Rust <span class="color_h1">Loops</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="rust_match.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="rust_loops_while.php">Next &#10095;</a>
</div>
<hr>
...
<p>Loops are handy because they save time, reduce errors, and they make code more readable. For example, instead of writing the same line 10 times to print some text, you can use a loop to repeat it for you.</p>
<p>Rust has three types of loops: <code class="w3-codespan">loop</code>, <code class="w3-codespan">while</code>, and <code class="w3-codespan">for</code>.</p>

<hr>

<h2><code class="w3-codespan">loop</code> </h2>
<p><code class='w3-codespan'>loop</code> is the simplest of Rust's three loop types.</p>
<p>It will run forever unless you tell it to stop:</p>


<div class="w3-example">
<div class="w3-code notranslate javaHigh">
  loop {<br>
&nbsp;&nbsp;println!("This will repeat forever!");<br>
  }
</div>
</div>

<p><strong>Warning:</strong> This loop never stops! You will need to press <code class="w3-codespan">Ctrl + C</code> to end the program.</p>


<p>To stop a loop, use the <code class="w3-codespan">break</code> keyword:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  let mut count = 1;<br><br>loop {<br>&nbsp; println!(&quot;Hello World!&quot;);<br><br>&nbsp; 
  if count == 3 {<br>&nbsp;&nbsp;&nbsp; break;<br>&nbsp; }<br><br>&nbsp; count 
  += 1;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_loop">Try it Yourself &raquo;</a>
</div>

<p>Example explained:</p>
<ul>
<li>This prints &quot;Hello World!&quot; 3 times.</li>
<li>It uses a counter to keep track of how many times it has looped.</li>
<li>The counter starts at 1 (<code class="w3-codespan">let mut count = 1;</code>).</li>
<li>Each time the loop runs, the counter goes up by 1: (<code class="w3-codespan">count += 1;</code>).</li>
<li>When it reaches 3, the loop stops.</li>
</ul>

<hr>

<h2>Return a Value</h2>
<p>You can also return a value from a <code class="w3-codespan">loop</code> using <code class="w3-codespan">break</code> with a value.</p>
<p>This lets you save the result of the loop into a variable:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  let mut count = 1;<br><br>let result = loop {<br>&nbsp; println!(&quot;Hello!&quot;);<br>
  <br>&nbsp; if count == 3 {<br>&nbsp;&nbsp;&nbsp; break count; // Stop the loop 
  and return the number 3<br>&nbsp; }<br><br>&nbsp; count += 1;<br>};<br><br>println!(&quot;The loop stopped at: {}&quot;, result);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_loop_return">Try it Yourself &raquo;</a>
</div>

<p>This loop prints "Hello!" until <code class='w3-codespan'>count</code> reaches 3, then stops and returns that number.</p>
<p><strong>Note:</strong> When you save the result of a loop into a variable, you must put a semicolon (<code class="w3-codespan">;</code>) at the end.</p>

<p><strong>Next:</strong> Learn how to use <code class="w3-codespan">while</code> loops to repeat code while a condition is true.</p>
