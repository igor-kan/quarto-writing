...
ny:-->
    ...
    <h1>Rust <span class="color_h1">Strings</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="rust_scope.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="rust_ownership.php">Next &#10095;</a>
</div>
<hr>

<h2>Strings</h2>

<p>Strings are used to store text.</p>

<p>You have already learned that you can use the <code class="w3-codespan">&amp;str</code> type to create a string:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  let greeting: &amp;str = "Hello";<br>
  println!("{}", 
  greeting);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_strings">Try it Yourself &raquo;</a>
</div>
<p><strong>Note</strong> that strings are surrounded by double quotes (<strong>"</strong>Hello<strong>"</strong>).</p>

<p>There are two main types of strings in Rust:</p>
<ul>
  <li><code class="w3-codespan">&amp;str</code> - is called "string slices", and is used for fixed text like <code class="w3-codespan">"Hello"</code></li>
  <li><code class="w3-codespan">String</code> - used when you need a string that can change</li>
</ul>

<p>In this chapter, you will mostly work with the <code class="w3-codespan">String</code> type because it is more flexible and can be changed over time.</p>

<hr>

<h2>Create a String</h2>

<p>You can create a <code class="w3-codespan">String</code> from a string literal using the <code class="w3-codespan">to_string()</code> method or the <code class="w3-codespan">String::from()</code> 
function:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
let text1 = "Hello World".to_string();</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_strings2">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
let text2 = String::from("Hello World");</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_strings3">Try it Yourself &raquo;</a>
</div>
<p>It is up to you which one to choose - both <code class="w3-codespan">to_string()</code> and <code class="w3-codespan">String::from()</code> are very common in Rust.</p>

<hr>

<h2>Change a String</h2>

<p>Strings are mutable, so you can change them if they are declared with <code class="w3-codespan">mut</code>.</p>

<p>Use <code class="w3-codespan">push_str()</code> to add text to a string:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
let mut greeting = String::from("Hello");<br>
greeting.push_str(" World");<br>
println!("{}", greeting); // Hello World
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_strings_change">Try it Yourself &raquo;</a>
</div>

<p>Use <code class="w3-codespan">push()</code> to add one character:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
let mut word = String::from("Hi");<br>
word.push('!');<br>
println!("{}", word); // Hi!
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_strings_char">Try it Yourself &raquo;</a>
</div>
...
<p>You can combine strings using the <code class="w3-codespan">format!</code> macro:</p>


<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  let s1 = String::from(&quot;Hello&quot;);<br>let s2 = String::from(&quot;World!&quot;);<br>let s3 
  = String::from(&quot;What a beautiful day!&quot;);<br>let result = format!(&quot;{} {} {}&quot;, 
  s1, s2, s3);<br>println!(&quot;{}&quot;, result);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_strings_concat">Try it Yourself &raquo;</a>
</div>

<p>You can also use the <code class="w3-codespan">+</code> operator to combine strings, but it can get messy with many values.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
let s1 = String::from("Hello");<br>
let s2 = String::from("World!");<br>let s3 = String::from(&quot;What a beautiful 
  day!&quot;);<br>
let result = s1 + " " + &amp;s2 + &quot; &quot; + &amp;s3;<br>
  println!(&quot;{}&quot;, result);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_strings_concat2">Try it Yourself &raquo;</a>
<p><strong>Note:</strong> You can only add a <code class="w3-codespan">&amp;str</code> to a <code class="w3-codespan">String</code> with <code class="w3-codespan">+</code>.  
That is why <code class="w3-codespan">&amp;s2</code> and <code class="w3-codespan">&amp;s3</code> (a string slice) is used here.</p>
</div>
<p><strong>Good to know:</strong> <code class="w3-codespan">format!</code> is often the preferred choice than using <code class="w3-codespan">+</code> for combining strings.</p>
<hr>

<h2>String Length</h2>

<p>You can use the <code class="w3-codespan">.len()</code> 
method to get the length of a string:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
let name = String::from("John");<br>
println!(&quot;Length: {}&quot;, name.len()); // 4</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_strings_length">Try it Yourself &raquo;</a>
</div>
<!--

<h2>Converting Between <code class="w3-codespan">&amp;str</code> and <code class="w3-codespan">String</code></h2>

<p>Sometimes you'll need to convert between fixed strings (<code class="w3-codespan">&amp;str</code>) and growable strings (<code class="w3-codespan">String</code>).</p>

<h4>Convert <code class="w3-codespan">&amp;str</code> to <code class="w3-codespan">String</code></h4>


<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  let text = &quot;Hello&quot;;<br>let string_version = String::from(text);<br>
  println!(&quot;{}&quot;, string_version);</div>
</div>

<h4>Convert <code class="w3-codespan">String</code> to <code class="w3-codespan">&amp;str</code></h4>

<p>Use <code class="w3-codespan">&</code> to get a string slice from a <code class="w3-codespan">String</code>:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
let name = String::from("Alice");<br>
let slice: &amp;str = &amp;name;<br>
println!("{}", slice);
</div>
</div>

<p><strong>Tip:</strong> You will often need <code class="w3-codespan">&amp;str</code> when passing strings to functions or printing them.</p>
<hr>
-->
