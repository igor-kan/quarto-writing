...
ny:-->
    ...
    <h1>Rust <span class="color_h1">Get Started</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="rust_intro.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="rust_syntax.php">Next &#10095;</a>
</div>
<hr>

<h2>Get Started With Rust</h2>
<p>At W3Schools, you can try Rust without installing anything.</p>
<p>Our Online Rust Editor runs directly in your browser, and shows both the code and the result:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="tryrust.php?filename=demo_helloworld">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Install Rust</h2>
<p>However, if you want to download and install rust, you can go to <a href="https://www.rust-lang.org/" target="_blank">rust-lang.org</a> and follow the instructions there.</p>
<p>Or, if you are using the terminal, you can run:</p>
<div class="w3-example">
<div class="w3-code notranslate javaHigh">
...
<p>After installing, check if Rust is installed correctly by running:</p>
<div class="w3-example">
<div class="w3-code notranslate javaHigh">
rustc --version
</div></div>
<p>The output will look something like this, depending on your version number:</p>
<div class="w3-example">
<div class="w3-code w3-black">
...
<p>Use Cargo to create a new Rust project:</p>
<div class="w3-example">
<div class="w3-code notranslate javaHigh">
...
<div class="w3-example">
<div class="w3-code w3-black">
&nbsp;&nbsp;&nbsp;&nbsp;Creating binary (application) `my_project` package<br>
note: see more `Cargo.toml` keys and their definitions at https://doc.rust-lang.org/cargo/reference/manifest.html
</div>
</div>


<p>This creates a folder called <code class='w3-codespan'>my_project</code> with the following files:</p>
<ul>
  <li><code class='w3-codespan'>Cargo.toml</code>: Project settings</li>
  <li><code class='w3-codespan'>src/main.rs</code>: Main Rust file</li>
</ul>

<p>The <code class="w3-codespan">main.rs</code> file contains this default code:</p>
<div class="w3-example">
<div class="w3-code notranslate javaHigh">
  fn main() {<br>&nbsp; println!(&quot;Hello, world!&quot;);<br>}</div>
</div>
...
<h2>Build and Run the Project</h2>
<p>Next, write the following code to go into the project folder:</p>
<div class="w3-example">
<div class="w3-code notranslate javaHigh">
cd my_project
</div></div>

<p>Then build and run the project:</p>
<div class="w3-example">
<div class="w3-code notranslate javaHigh">
cargo run
</div></div>
...
<p><strong>Congratulations!</strong> You have just run your first Rust program.</p>
