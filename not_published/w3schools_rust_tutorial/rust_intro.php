...
ny:-->
    ...
    <h1>Rust <span class="color_h1">Introduction</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="index.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="rust_getstarted.php">Next &#10095;</a>
</div>
<hr>
<h2>What is Rust?</h2>
<p>Rust is a modern programming language.</p>
<p>It is designed for performance, reliability, and safety - especially safe handling of memory.</p>
<hr>

<h2>Why Learn Rust?</h2>
<ul>
<li>It is one of the fastest-growing programming languages in the world</li>
  <li>Learning Rust makes it easier to pick up other languages like Java, 
  Python, C++, and C#, because the syntax is similar.</li>
  <li>Rust is very fast</li>
  <li>Rust requires less memory compared to many other languages</li>
  <li>Rust is used to build web servers, creating games, operating systems, and much more!</li>
</ul>
<hr>

<h2>Difference between Rust and C\C++</h2>
<ul>
<li>The main difference is that Rust is "safe by default".</li>
<li>In Rust, memory access is automatically checked by the compiler, which helps you avoid common bugs like crashes, leaks, and unsafe memory behavior.</li>
<li>In C and C++, you must manually manage memory, which can lead to errors if you are not careful</li>
</ul>
<hr>

<h2>Get Started</h2>
<p>This tutorial will teach you the basics of Rust.</p>
<p>It is not necessary to have any prior programming experience.</p>
<a class="ws-btn ws-black w3-round" href="rust_getstarted.php">Get Started &raquo;</a>
<hr>
