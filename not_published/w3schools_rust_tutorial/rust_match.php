...
ny:-->
    ...
    <h1>Rust <span class="color_h1">Match</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="rust_if_else.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="rust_loops.php">Next &#10095;</a>
</div>
<hr>

<h2>Match</h2>

<p>When you have many choices, using <code class='w3-codespan'>match</code> is easier than writing lots of <code class='w3-codespan'>if...else</code>.</p>

<p><code class="w3-codespan">match</code> is used to select one of many code blocks to be executed:</p>
...
&nbsp;&nbsp;match day {<br>
&nbsp;&nbsp;&nbsp;&nbsp;1 =&gt; println!("Monday"),<br>
&nbsp;&nbsp;&nbsp;&nbsp;2 =&gt; println!("Tuesday"),<br>
&nbsp;&nbsp;&nbsp;&nbsp;3 =&gt; println!("Wednesday"),<br>
&nbsp;&nbsp;&nbsp;&nbsp;4 =&gt; println!("Thursday"),<br>
&nbsp;&nbsp;&nbsp;&nbsp;5 =&gt; println!("Friday"),<br>
&nbsp;&nbsp;&nbsp;&nbsp;6 =&gt; println!("Saturday"),<br>
&nbsp;&nbsp;&nbsp;&nbsp;7 =&gt; println!("Sunday"),<br>
&nbsp;&nbsp;&nbsp;&nbsp;_ =&gt; println!("Invalid day."),<br>
&nbsp;&nbsp;}<br>
}
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_match">Try it Yourself &raquo;</a>
</div>

<p>Example explained:</p>
<ul>
  <li>The <code class="w3-codespan">match</code> variable (<strong>day</strong>) is evaluated once.</li>
  <li>The value of the day variable is compared with the values of each "branch"</li>
  <li>Each branch starts with a value, followed by <code class="w3-codespan">=></code> and a result</li>
  <li>If there is a match, the associated block of code is executed</li>
  <li><code class="w3-codespan">_</code> is used to specify some code to run if there is no match (like <code class="w3-codespan">default</code> in other languages).</li>
<li>In the example above, the value of <em>day</em> is <strong>4</strong>, meaning "Thursday" will be printed</li>
</ul>
...
<p>You can match multiple values at once using the <code class="w3-codespan">|</code> operator (OR):</p>
...
&nbsp;&nbsp;let day = 6;<br><br>
&nbsp;&nbsp;match day {<br>
&nbsp;&nbsp;&nbsp;&nbsp;1 | 2 | 3 | 4 | 5 =&gt; println!("Weekday"),<br>
&nbsp;&nbsp;&nbsp;&nbsp;6 | 7 =&gt; println!("Weekend"),<br>
&nbsp;&nbsp;&nbsp;&nbsp;_ =&gt; println!("Invalid day"),<br>
&nbsp;&nbsp;}<br>
}
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_match2">Try it Yourself &raquo;</a>
</div>
...
<h2><code class="w3-codespan">match</code> with a Return Value</h2>

<p>Just like <code class="w3-codespan">if</code>, <code class="w3-codespan">match</code> can also return a value:</p>
<p>This means you can save the result of a match into a variable:
</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_match_return">Try it Yourself &raquo;</a>
</div>

<p><strong>Note:</strong> Each part of the <code class='w3-codespan'>match</code> branches must be the same <strong>type</strong> - just like with <code class='w3-codespan'>if...else</code>.</p>
