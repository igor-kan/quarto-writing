...
ny:-->
    ...
    <h1>Rust <span class="color_h1">Booleans</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="rust_operators.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="rust_if_else.php">Next &#10095;</a>
</div>
<hr>
...
<p>For this, Rust has a <code class="w3-codespan">bool</code> data type, which is known as booleans.</p>

<p>Booleans represent values that are either <code class="w3-codespan">true</code> or <code class="w3-codespan">false</code>.</p>
<hr>

<h2>Creating Boolean Variables</h2>

<p>You can store a boolean value in a variable using the <code class="w3-codespan">bool</code> type:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  let is_programming_fun: bool = true;<br>
  let is_fish_tasty: bool = false;<br><br>
  println!("Is Programming Fun? {}", is_programming_fun);<br>
  println!("Is Fish Tasty? {}", is_fish_tasty);<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_bool">Try it Yourself &raquo;</a>
</div>

<p>Remember that Rust is smart enough to understand that <code class='w3-codespan'>true</code> and <code class='w3-codespan'>false</code> values are boolean values, meaning that you don't have to specify the <code class="w3-codespan">bool</code> 
keyword:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  let is_programming_fun = true;<br>let is_fish_tasty = false;<br><br>
  println!("Is Programming Fun? {}", is_programming_fun);<br>
  println!("Is Fish Tasty? {}", is_fish_tasty);<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_bool2">Try it Yourself &raquo;</a>
</div>


<hr>

<h2>Boolean from Comparison</h2>

<p>Most of the time, there is no need to type <code class="w3-codespan">true</code> or <code class="w3-codespan">false</code> yourself. Instead, boolean values come from comparing values using operators like <code class="w3-codespan">==</code> or <code class="w3-codespan">&gt;</code>:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  let age = 20;<br>
  let can_vote = age &gt;= 18;<br><br>
  println!("Can vote? {}", can_vote);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_bool3">Try it Yourself &raquo;</a>
</div>

<p>Here, <code class="w3-codespan">age &gt;= 18</code> returns <code class="w3-codespan">true</code>, as long as age is 18 or older.</p>
...
<h2>Using Booleans in <code class="w3-codespan">if</code> Statements</h2>

<p>Boolean values are often used in <code class="w3-codespan">if</code> statements to decide what code should run:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  let is_logged_in = true;<br><br>
  if is_logged_in {<br>
&nbsp;&nbsp;println!("Welcome back!");<br>
  } else {<br>
&nbsp;&nbsp;println!("Please log in.");<br>
  }<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_bool_if">Try it Yourself &raquo;</a>
</div>

<p>Cool, right? Booleans are the basis for all Rust comparisons and conditions. You will learn more about if and else statements in the next chapter.</p>
