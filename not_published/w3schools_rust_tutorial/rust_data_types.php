...
ny:-->
    ...
    <h1>Rust <span class="color_h1">Data Types</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="rust_variables.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="rust_constants.php">Next &#10095;</a>
</div>
<hr>

<h2>Data Types</h2>
<p>Unlike many other programming languages, variables in Rust do not need to be declared with a specified type (like "String" for text or "Int" for numbers, if you are familiar with those 
from <a href="/c/index.php">C</a> or <a href="/java/default.asp">Java</a>).</p>

<p>In Rust, the type of a variable is decided by the value you give it. Rust looks at the value and automatically chooses 
the right type:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
let my_num = 5;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// integer<br>
let my_double = 5.99;&nbsp;&nbsp;&nbsp;// float<br>
let my_letter = 'D';&nbsp;&nbsp;&nbsp;&nbsp;// character<br>
let my_bool = true;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// boolean<br>
let my_text = "Hello";&nbsp;&nbsp;// string<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_data_types">Try it Yourself &raquo;</a>
</div>

<p>However, it is possible to explicitly tell Rust what type a value should be:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
let my_num: i32 = 5;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// integer<br>
let my_double: f64 = 5.99;&nbsp;&nbsp;&nbsp;&nbsp;// float<br>
let my_letter: char = 'D';&nbsp;&nbsp;&nbsp;&nbsp;// character<br>
let my_bool: bool = true;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// boolean<br>
let my_text: &amp;str = "Hello";&nbsp;&nbsp;// string<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_data_types2">Try it Yourself &raquo;</a>
</div>

<p>You will learn more about when you need to specify the type later in this tutorial. Either way, it is good to understand what the different types mean.</p>

<p>Basic data types in Rust are divided into different groups:</p>

<ul>
  <li><strong>Numbers</strong> - Whole numbers and decimal numbers (<code class="w3-codespan">i32</code>, <code class="w3-codespan">f64</code>)</li>
  <li><strong>Characters</strong> - Single letters or symbols (<code class="w3-codespan">char</code>)</li>
  <li><strong>Strings</strong> - Text, a sequence of characters (<code class="w3-codespan">&amp;str</code>)</li>
  <li><strong>Booleans</strong> - True or false values (<code class="w3-codespan">bool</code>)</li>
</ul>
<hr>

<h2>Numbers</h2>
<p>Number types are divided into two groups: integer types and floating point types.</p>

<h3>Integer (i32)</h3>

<p>The <code class="w3-codespan">i32</code> type is used to store whole numbers, positive or negative (such as 123 or -456), without decimals:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  let age: i32 = 25;<br>
  println!("Age is: {}", age);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_data_types_int">Try it Yourself &raquo;</a>
</div>

<h3>Floating Point (f64)</h3>

<p>The <code class="w3-codespan">f64</code> type is used to store numbers containing one or more decimals:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  let price: f64 = 19.99;<br>
  println!("Price is: ${}", price);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_data_types_float">Try it Yourself &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">char</code> type is used to store a single character. A char value must be surrounded by single quotes, like 'A' or 'c':</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  let myGrade: char = 'B';<br>println!(&quot;{}&quot;, myGrade);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_data_types_char">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>The <code class="w3-codespan">&amp;str</code> type is used to store a sequence of characters (text). String values must be surrounded by double quotes:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  let name: &str = "John";<br>
  println!("Hello, {}!", name);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_data_types_str">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Booleans (bool)</h2>

<p>The <code class="w3-codespan">bool</code> type can only take the values <code class="w3-codespan">true</code> or <code class="w3-codespan">false</code>:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  let is_logged_in: bool = true;<br>
  println!("User logged in? {}", is_logged_in);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_data_types_bool">Try it Yourself &raquo;</a>
</div>
<hr>


<h2>Combining Data Types</h2>

<p>You can mix different types in the same program:</p>
...
<div class="w3-code notranslate javaHigh">
  let name = "John";<br>
  let age = 28;<br>
  let is_admin = false;<br>
  println!("Name: {}", name);<br>
  println!("Age: {}", age);<br>
  println!("Admin: {}", is_admin);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_data_types_combine">Try it Yourself &raquo;</a>
</div>
