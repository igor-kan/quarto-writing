<!DOCTYPE html>
<html lang="en-US">
<title>Rust If .. Else Conditions</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Rust <span class="color_h1">If .. Else Conditions</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="rust_booleans.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="rust_match.php">Next &#10095;</a>
</div>
<hr>

<h2>Conditions and If..Else</h2>

<p>You already know that Rust supports familiar comparison conditions from mathematics, such as:</p>
<ul>
...
<p>Rust has the following conditional statements:</p>
<ul>
  ...
  <code class="w3-codespan">false</code></li>
  <li>Use <a href="rust_match.php"><code class="w3-codespan">match</code></a> to specify many alternative blocks of code to be executed</li>
</ul>

<p><strong>Note:</strong> Unlike many other programming languages, <code class="w3-codespan">if..else</code> can be used as a statement or as an expression (to assign a value to a variable) in Rust. See an example at the bottom of the page to better understand it.</p>
<hr>

<h2><code class="w3-codespan">if</code></h2>

<p>Use <code class="w3-codespan">if</code> to specify a block of code to be 
executed if a condition is <code class="w3-codespan">true</code>.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  if 7 &gt; 5 {<br>&nbsp; println!(&quot;7 is greater than 5.&quot;);<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_if">Try it Yourself &raquo;</a>
</div>

<p>You can also test variables:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  let x = 7;<br>let y = 5;<br><br>if x &gt; y {<br>&nbsp; println!(&quot;x is greater 
  than y.&quot;);<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_if2">Try it Yourself &raquo;</a>
</div>

<hr>

<h2><code class="w3-codespan">if...else</code></h2>

<p>If the condition is not true, you can use <code class="w3-codespan">else</code> to run different code:</p>
...
<div class="w3-code notranslate javaHigh">
  let age = 16;<br><br>
  if age &gt;= 18 {<br>
&nbsp;&nbsp;println!("You can vote.");<br>
  } else {<br>
&nbsp;&nbsp;println!("You are too young to vote.");<br>
  }</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_if_else">Try it Yourself &raquo;</a>
</div>
...
<h2><code class="w3-codespan">else if</code></h2>

<p>You can check multiple conditions using <code class="w3-codespan">else if</code>:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_if_else_if">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Using <code class="w3-codespan">if</code> as an Expression</h2>

<p>In Rust, <code class="w3-codespan">if...else</code> can also be used as an <strong>expression</strong>.</p>
<p>This means you can assign the result of an <code class="w3-codespan">if</code> to a variable:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  let time = 20;<br>
  let greeting = if time &lt; 18 {<br>
&nbsp;&nbsp;"Good day."<br>
  } else {<br>
&nbsp;&nbsp;"Good evening."<br>
  };<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_if_expression">Try it Yourself &raquo;</a>
</div>

<p>When using <code class="w3-codespan">if</code> as an expression, you must include <code class="w3-codespan">else</code>. This ensures the result always has a value.</p>

<hr>

<h2>Simplified Syntax</h2>

<p>If each block only contains a single expression, you can write it in a shorter way on one line:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  let time = 20;<br>
  let greeting = if time &lt; 18 { "Good day." } else { "Good evening." };<br>
  println!("{}", greeting);<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_if_ternary">Try it Yourself &raquo;</a>
</div>

<p><strong>Tip:</strong> This works similarly to the ternary operator (<code class="w3-codespan"><em>condition 
</em>? <em>value1 </em>: <em>value2</em></code>) in languages like <a href="/java/default.asp">Java</a> or <a href="/c/index.php">C</a>. However, Rust does not have a ternary operator, but using <code class="w3-codespan">if...else</code> as an expression gives you the same effect.</p>
<hr>

<h2>Don't Mix Types</h2>

<p><strong>Note:</strong> The value from <code class='w3-codespan'>if</code> and <code class='w3-codespan'>else</code> must be the same type, like two pieces of text or two numbers (in the example above, both are strings).</p>

<p>When you mix types, like a string and an integer, you'll get an error:</p>
<div class="w3-example w3-pale-red">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh w3-border-red">
  let number = 5;<br>
  let result = if number &lt; 10 { "Too small" } else { 100 };<br>
  println!("{}", result);<br>
</div>
<p>Result:</p>
<div class="w3-black w3-padding w3-margin-bottom">
<code>error[E0308]: `if` and `else` have incompatible types</code>
</div>
</div>
<hr>
