...
ny:-->
    ...
    <h1>Rust <span class="color_h1">Variables</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="rust_comments.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="rust_data_types.php">Next &#10095;</a>
</div>
<hr>
...
<p>To create a variable in Rust, use the <code class="w3-codespan">let</code> keyword 
and specify the name of the variable (<em>name</em> in this example):</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  let name = &quot;John&quot;;<br>
  println!(&quot;My first name is: {}", name);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_variables">Try it Yourself &raquo;</a>
</div>

<h3>What is <code class="w3-codespan">{}</code>?</h3>

<p>Rust uses <code class="w3-codespan">{}</code> as a placeholder in <code class="w3-codespan">println!()</code> to show variable values.</p>

<p>In the example above, the output will be &quot;My first name is: John&quot;.</p>

<p>You can use as many placeholders as you like:</p>
...
<div class="w3-code notranslate javaHigh">
  let name = "John";<br>
  let age = 30;<br>
  println!("{} is {} years old.", name, age);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_variables2">Try it Yourself &raquo;</a>
</div>

<h3>Using Placeholders in Order</h3>

<p>When you use many placeholders, the values you pass are used in the same order.</p>

<p>In the example above:</p>
<ul>
  <li>The first <code class="w3-codespan">{}</code> gets replaced with <code class="w3-codespan">name</code> ("John")</li>
  <li>The second <code class="w3-codespan">{}</code> gets replaced with <code class="w3-codespan">age</code> (30)</li>
</ul>

<p><strong>Important:</strong> The order matters. If you switch the values, the output will change:</p>

<div class="w3-example">
<h3>Example</h3>
<p>This example shows wrong order:</p>
<div class="w3-code notranslate javaHigh">
  let name = "John";<br>
  let age = 30;<br>
  println!("{} is {} years old.", age, name);&nbsp; 
  // Outputs 30 is John years old</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_variables3">Try it Yourself &raquo;</a>
</div>
...
<h2>Variable Values Cannot be Changed by Default</h2>

<p>By default, variables in Rust cannot be changed after they are created:</p>
...
<div class="w3-code notranslate javaHigh w3-border-red">
  ...
  x = 10; // Error<br>
  println!("{}", x);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_variables4">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Change Variable Values</h2>

<p>If you want to change the value of a variable, you must use the <code class="w3-codespan">mut</code> keyword 
(which means mutable/changeable):</p>
...
<div class="w3-code notranslate javaHigh">
  ...
  x = 10;<br>
  println!("After: {}", x);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_variables5">Try it Yourself &raquo;</a>
</div>
<!--
<h3>Specifying a Type</h3>

<p>Rust can usually figure out the type of value you store in a variable based on what you write. But you can also tell Rust the exact type using a colon <code class="w3-codespan">:</code> followed by the type name:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
let age: i32 = 30;<br>
let price: f64 = 99.95;<br>
let is_active: bool = true;<br>
let name: &str = "Alice";
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="#">Try it Yourself &raquo;</a>
</div>

<p>Common types:</p>
<ul>
  <li><code class="w3-codespan">i32</code> whole number (integer)</li>
  <li><code class="w3-codespan">f64</code> number with decimals (floating point)</li>
  <li><code class="w3-codespan">bool</code> true or false</li>
  <li><code class="w3-codespan">&str</code> a piece of text (string)</li>
</ul>

<h3>Shadowing</h3>

<p>Rust lets you create a new variable with the same name as an earlier one. This is called <strong>shadowing</strong>.</p>

<p>Each time you use <code class="w3-codespan">let</code>, you're creating a brand new variable:</p>
...
<p>This does not change the original <code class="w3-codespan">x</code>. Each line creates a new version of <code class="w3-codespan">x</code>.</p>

<h3>Constants</h3>

<p>Use <code class="w3-codespan">const</code> to create a value that never changes, even while your program is running. Constants must always include a type, and they must be set to a value that is known when the program starts.</p>
...
<p><strong>Note:</strong> Constants are always immutable and can be used anywhere in your code.</p>
-->
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="rust_comments.php">&#10094; Previous</a>
