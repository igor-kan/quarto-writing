...
ny:-->
    ...
    <h1>Rust <span class="color_h1">Constants</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="rust_data_types.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="rust_operators.php">Next &#10095;</a>
</div>
<hr>

<h2>Constants</h2>

<p>Constant variables are used to store values that never change.</p>

<p>Unlike regular variables, constants must be defined with a <strong>type</strong> (e.g. <code class="w3-codespan">i32</code> or <code class="w3-codespan">char</code>).</p>

<hr>

<h2>Creating a Constant</h2>

<p>To create a constant, use the <code class="w3-codespan">const</code> keyword, 
followed by the name, type, and value:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
const BIRTHYEAR: i32 = 1980; <br>const 
  MINUTES_PER_HOUR: i32 = 60;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_const">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Constants Must Have a Type</h2>

<p>You must write the type when creating a constant. You cannot let 
Rust guess the type like you can with regular variables:</p>

<div class="w3-example w3-pale-red">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh w3-border-red">
const BIRTHYEAR: i32 = 1980; // Ok<br>
const BIRTHYEAR = 1980;&nbsp;// Error: missing type</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_const2">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Naming Rules</h2>

<p>Another thing about constants, is that it is considered good practice to declare them with uppercase.</p>

<p>It is not required, but useful for code readability and common for Rust programmers:</p>
<p>Examples:</p>
<ul>
  <li><code class="w3-codespan">MAX_SPEED</code></li>
  <li><code class="w3-codespan">PI</code></li>
  <li><code class="w3-codespan">MINUTES_PER_HOUR</code></li>
</ul>
<hr>
...
<table class="ws-table-all notranslate">
  <tr>
    <th>Feature</th>
    <th>Constant (<code class="w3-codespan">const</code>)</th>
    <th>Variable (<code class="w3-codespan">let</code>)</th>
  </tr>
  <tr>
    <td>Can change?</td>
    <td>No</td>
    <td>Yes, if <code class="w3-codespan">mut</code> is used</td>
  </tr>
  <tr>
    <td>Type required?</td>
    <td>Yes</td>
