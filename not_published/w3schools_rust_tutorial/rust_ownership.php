...
ny:-->
    ...
    <h1>Rust <span class="color_h1">Ownership</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="rust_strings.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="rust_borrowing_references.php">Next &#10095;</a>
</div>
<hr>

<h2>Ownership</h2>

<p>Rust uses "ownership" to manage memory in a safe way.</p>

<p>Every value in Rust has an <strong>owner</strong>. The owner is usually a variable.</p>
...
<ul>
  ...
  <li>When the owner goes out of scope, the value is deleted</li>
  <li>You can only have one owner at a time, unless you <a href="rust_borrowing_references.php">borrow</a> it (covered in the next chapter)</li>
</ul>

<hr>

<h2>Basic Ownership Example</h2>

<p>In this example, <code class="w3-codespan">a</code> owns the string. Then we move it to <code class="w3-codespan">
b</code>:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
let a = String::from("Hello");<br>
let b = a;<br><br>
  // println!(&quot;{}&quot;, a); Error: <strong>a</strong> no longer owns the value<br>
println!("{}", b); // Ok: b now owns the value
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_ownership">Try it Yourself &raquo;</a>
</div>

<p>When we assign <code class="w3-codespan">a</code> to <code class="w3-codespan">
b</code>, the ownership <strong>moves</strong>. This means only <code class="w3-codespan">b</code> can use the value now, because <code class="w3-codespan">a</code> is no longer valid.</p>

<p>But simple types like numbers, characters and booleans are <strong>copied</strong>, not 
moved.</p>
<p>This means you can still use the original variable after assigning it to 
another:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  let a = 5;<br>let b = a;<br>println!(&quot;a = {}&quot;, a);&nbsp; // Works<br>
  println!(&quot;b = {}&quot;, b);&nbsp; // Works</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_ownership2">Try it Yourself &raquo;</a>
</div>

<p>Here, <code class="w3-codespan">a</code> is <strong>copied</strong> into <code class="w3-codespan">b</code>, 
not moved, so you can still use <code class="w3-codespan">b</code>.</p>
...
<p>For other types, like <code class="w3-codespan">String</code>, if you really want to keep the original value and 
also assign it to another variable, you can use the <code class="w3-codespan">.clone()</code> method, which makes 
a copy of the data:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  let a = String::from(&quot;Hello&quot;);<br>let b = a.clone(); // Now both have the same 
  value<br><br>println!(&quot;a = {}&quot;, a);&nbsp; // Works<br>println!(&quot;b = {}&quot;, b);&nbsp; 
  // Works</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_ownership_clone">Try it Yourself &raquo;</a>
</div>
<p>However, if you don't need to own the value twice, using a reference (<code class="w3-codespan">&</code>) is usually better than cloning, which you will learn more about in the next chapter.</p>
<hr>

<h3>Why Ownership Matters</h3>

<ul>
  <li>Rust uses ownership to automatically free memory when it's no longer needed</li>
  <li>It prevents bugs like using memory that's already been deleted</li>
  <li>It is one of the reasons Rust is so safe and fast</li>
</ul>

<p><strong>Next:</strong> Learn about <b>borrowing</b> - how to let other parts of your program use a value without taking ownership.</p>
