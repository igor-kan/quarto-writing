...
ny:-->
    ...
    <h1>Rust <span class="color_h1">Functions</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="rust_loops_for.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="rust_scope.php">Next &#10095;</a>
</div>
<hr>
...
<p>Functions are used to organize your code, avoid repeating yourself, and make your program easier to understand.</p>

<hr>

<h2>Creating a Function</h2>

<p>To create a function, use the <code class="w3-codespan">fn</code> keyword, followed by the function name and a set of parentheses <code class="w3-codespan">()</code> 
and curly braces <code class="w3-codespan">{}</code>:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
fn <em>function_name</em>() {<br>
...
<p>Now that you have created a function, you can execute it by <strong>calling</strong> it.</p>

<p>To call a function, write the name of the function followed by two parantheses <code class="w3-codespan">()</code>.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  // Create a function<br>fn say_hello() {<br>
&nbsp;&nbsp;println!("Hello from a function!");<br>
}<br><br>
say_hello();
  // Call the function</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_functions">Try it Yourself &raquo;</a>
</div>
...
<p>You can send information into a function using parameters. Parameters are written inside the parentheses <code class="w3-codespan">()</code>.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
fn greet(name: &amp;str) {<br>
&nbsp;&nbsp;println!("Hello, {}!", name);<br>
}<br><br>
greet("John");
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_functions_param">Try it Yourself &raquo;</a>
</div>

<p>In this example, the function takes a string parameter called <code class="w3-codespan">name</code> and prints it in the 
greeting message.</p>
...
<p>Use the&nbsp; <code class="w3-codespan">-&gt;</code> 
symbol in the function header to show what type of value will be returned. </p>
<p>Inside the function, use the <code class="w3-codespan">return</code> 
keyword to send the value back:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_functions_return">Try it Yourself &raquo;</a>
</div>

<p>This function adds two numbers and returns the result.</p>
<p>In Rust, you can omit the <code class="w3-codespan">return</code> keyword. 
Just write the value on the last line of the function, <strong>without a semicolon</strong>:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_functions_return2">Try it Yourself &raquo;</a>
</div>

<p>The last line <code class="w3-codespan">a + b</code> is automatically returned.</p>

<p>Both examples do the same thing. It is up to you which one to use.</p>
...
<ul>
  ...
  <li>To avoid repeating the same code</li>
  <li>To make your programs easier to read and change</li>
</ul>
