...
ny:-->
    ...
    <h1>Rust <span class="color_h1">While Loops</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="rust_loops.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="rust_loops_for.php">Next &#10095;</a>
</div>
<hr>

<h2>The <code class="w3-codespan">while</code> Loop</h2>

<p>The <code class="w3-codespan">while</code> loop runs as long as a condition is <code class="w3-codespan">true</code>.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  let mut count = 1;<br><br>
  while count &lt;= 5 {<br>
&nbsp;&nbsp;println!("Count: {}", count);<br>
&nbsp;&nbsp;count += 1;<br>
  }</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_loop_while">Try it Yourself &raquo;</a>
</div>

<p>In the example above, the loop keeps running as long as the counter is less than or equal to 5.</p>
<p>It prints the numbers from 1 to 5, one on each line.</p><hr>

<h2>False Condition</h2>
<p>The while loop checks the condition before each loop, so if the condition is <code class="w3-codespan">false</code> at the start, the loop will not run at all:</p>
...
<h3>Example</h3>
  <div class="w3-code notranslate javaHigh w3-border-red">
    let count = 10;<br><br>
    while count &lt;= 5 {<br>
&nbsp;&nbsp;println!("This won't be printed.");<br>
    }</div>
</div>

<hr>

<h2>Stop a While Loop</h2>

<p>You can stop a <code class="w3-codespan">while</code> loop when you want by using <code class="w3-codespan">break</code>:</p>
...
&nbsp;&nbsp;&nbsp;&nbsp;break;<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;println!("Number: {}", num);<br>
&nbsp;&nbsp;num += 1;<br>
  }</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_loop_while_break">Try it Yourself &raquo;</a>
</div>

<p>This prints numbers from 1 to 5 (stops the loop when <code class="w3-codespan">num</code> 
reaches 6).</p>
<p><strong>Next:</strong> Learn how to use the <code class="w3-codespan">for</code> loop to go through a range of values.</p>
...
<p>You can skip a value by using the <code class="w3-codespan">continue</code> statement:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  let mut num = 1;<br><br>while num &lt;= 10 {<br>&nbsp; if num == 6 {<br>&nbsp;&nbsp;&nbsp; num += 1;<br>
  &nbsp;&nbsp;&nbsp; continue;<br>&nbsp; }<br><br>
  &nbsp;
  println!(&quot;Number: {}&quot;, num);<br>&nbsp; num += 1;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_loop_while_continue">Try it Yourself &raquo;</a>
</div>

<p>This prints numbers from 1 to 10, except for the number 6.</p>
<p><strong>Next:</strong> Learn how to use the <code class="w3-codespan">for</code> loop to go through a range of values.</p>
