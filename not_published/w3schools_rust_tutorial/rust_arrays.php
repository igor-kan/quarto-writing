...
ny:-->
    ...
    <h1>Rust <span class="color_h1">Arrays</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="rust_data_structures.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="rust_vectors.php">Next &#10095;</a>
</div>
<hr>
...
<p>You can create an array using square brackets <code class="w3-codespan">[ ]</code>, and separate the values with commas.</p>
<p><strong>Note:</strong> Make sure all values are of the same data type (integers in the example below):</p>
...
<p>This creates an array with five integers.</p>
...
<p>This statement accesses the value of the first element [<code class="w3-codespan">0</code>] in <code class="w3-codespan">numbers</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_arrays">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Change Array Values</h2>

<p>To change the value of a specified element, refer to the index number and assign a new 
value. </p>
<p>Remember to make the array mutable (using the <code class="w3-codespan">mut</code> keyword):</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
let mut numbers = [1, 2, 3, 4, 5];<br>
numbers[0] = 10;<br>
println!("The new first number is: {}", numbers[0]);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_arrays_change">Try it Yourself &raquo;</a>
</div>
...
<p>You can get the number of elements in an array using the <code class="w3-codespan">.len()</code> method:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_arrays_length">Try it Yourself &raquo;</a>
</div>
...
<p>You can loop through the array elements with the <code class="w3-codespan">for</code> loop.</p>
...
&nbsp;&nbsp;println!("I like {}.", fruit);<br>
}
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_arrays_loop">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Print the Entire Array</h2>
<p><strong>Note:</strong> When printing the whole array, you must use <code class="w3-codespan">{:?}</code> inside <code class="w3-codespan">println!</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  let numbers = [1, 2, 3, 4, 5];<br>println!(&quot;{:?}&quot;, numbers);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_arrays_entire">Try it Yourself &raquo;</a>
</div>

<p>If you are just printing one element from the array, you can use <code class="w3-codespan">{}</code>.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
let numbers = [1, 2, 3, 4, 5];<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_arrays_one">Try it Yourself &raquo;</a>
</div>

<div class="ws-note ws-panel">
<p><strong>To Sum Up:</strong></p>
<p>When printing a single element from an array, use <code class="w3-codespan">{}</code>.</p>
<p>When printing the entire array, use <code class="w3-codespan">{:?}</code>.</p>
<p>If you are wondering why we didn't use <code class="w3-codespan">{:?}</code> inside the loop (in the example earlier on this page), it is because in a loop, you are printing each single value from the array.
Since each value is a string, <code class="w3-codespan">{}</code> works. But to print the whole array, you need to use <code class="w3-codespan">{:?}</code>.</p>
<p>A good rule is to use <code class="w3-codespan">{}</code> for basic types like strings, numbers, and booleans, and <code class="w3-codespan">{:?}</code> for data structures like arrays and <a href="rust_vectors.php">vectors</a> - when printing the entire structure.</p>
</div>
<hr>

<h2>Fixed Size (Arrays) vs. Dynamic Size (Vectors)</h2>

<p>You will often hear the terms <strong>fixed size</strong> and <strong>dynamic size</strong> when talking about arrays in Rust.</p>

<p>This is because <strong>arrays in Rust have a fixed size</strong>, meaning you cannot add or remove elements after the array is created:</p>

<div class="w3-example w3-pale-red">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh w3-border-red">
// An array with 3 elements<br>
let mut cars = ["Volvo", "BMW", "Ford"];<br><br>

  // Trying to add another element (a fourth element) to the cars array will 
  result in an error<br>
cars[3] = "Mazda";&nbsp;&nbsp; // Error: index out of bounds</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_arrays_fixed">Try it Yourself &raquo;</a>
</div>

<h3>Vectors - Dynamic Size Example</h3>

<p>For operations that require adding and removing array elements, you can use
<strong>Vectors</strong>, which are resizable arrays.</p>

<p>The size of a vector is dynamic, meaning it can grow and shrink as needed.  
</p>
<p>You can use the <code class="w3-codespan">vec!</code> macro to create a 
vector:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
// A vector with 3 elements<br>
let mut cars = vec!["Volvo", "BMW", "Ford"];<br><br>
// Add another element<br>
cars.push("Mazda");<br><br>
println!("{:?}", cars); // ["Volvo", "BMW", "Ford", "Mazda"]
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_arrays_vector">Try it Yourself &raquo;</a>
</div>
<p>This was just a short introduction to vectors. You will learn more about them in the next chapter.</p>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="rust_data_structures.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="rust_vectors.php">Next &#10095;</a>
