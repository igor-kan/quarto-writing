...
ny:-->
    ...
    <h1>Rust <span class="color_h1">For Loop</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="rust_loops_while.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="rust_functions.php">Next &#10095;</a>
</div>
<hr>

<h2>The <code class="w3-codespan">for</code> Loop</h2>

<p>When you know exactly how many times you want to loop through a block of code, use the <code class="w3-codespan">for</code> loop together with the <code class="w3-codespan">in</code> keyword, instead of a <code class="w3-codespan">while</code> loop:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_loop_for">Try it Yourself &raquo;</a>
</div>

<p>This prints numbers from 1 to 5.</p>

<p><strong>Note:</strong> <code class="w3-codespan">1..6</code> means from 1 up to (but not including) 6.</p>
<p><strong>Note:</strong> Rust handles the counter variable (<code class="w3-codespan">i</code>) automatically, 
unlike many other programming languages. You 
don't need to declare or increment it manually.</p>
<hr>

<h2>Inclusive Range</h2>

<p>If you want to include the last number, use <code class="w3-codespan">..=</code> (two dots and an equals sign):</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_loop_for_range">Try it Yourself &raquo;</a>
</div>

<p>This prints numbers from 1 to 6, including 6.</p>
...
<p>You can also use <code class="w3-codespan">for</code> to go through each value in an array:</p>
...
<p>This prints each item in the array.</p>
-->
...
<p>Just like other loops, you can use <code class="w3-codespan">break</code> to stop the loop and <code class="w3-codespan">continue</code> to skip a value:</p>
...
&nbsp;&nbsp;&nbsp;&nbsp;continue; // skip 3<br>
  &nbsp;&nbsp;}<br>
&nbsp;&nbsp;if i == 5 {<br>
&nbsp;&nbsp;&nbsp;&nbsp;break; // stop before printing 5<br>
  &nbsp;&nbsp;}<br>
&nbsp;&nbsp;println!("i is: {}", i);<br>
  }</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_loop_for_break">Try it Yourself &raquo;</a>
</div>

<p>This prints 1, 2, and 4. It skips 3 and stops before 5.</p>

<hr>

<h2>Rust Loops Summary</h2>

<p style="margin-bottom:22px">Rust has three types of loops that let you run code over and over again. Each one is used in different situations:</p>


<h3>1. <code class="w3-codespan">loop</code></h3>

<p>The simplest kind of loop. It runs forever unless you stop it with <code class="w3-codespan">break</code>.</p>
...
<p>Use <code class="w3-codespan">loop</code> when you don't know in advance how many times to repeat.</p>

<hr>

<h3>2. <code class="w3-codespan">while</code></h3>

<p>Repeats code <strong>while a condition is true</strong>. It checks the condition before each loop.</p>
...
<p>Use <code class="w3-codespan">while</code> when you want to repeat code until something happens.</p>

<hr>

<h3>3. <code class="w3-codespan">for</code></h3>

<p>Repeats code a fixed number of times.</p>
...
<p>Use <code class="w3-codespan">for</code> when you know exactly what to loop through.</p>

<hr>

<h3>Extra Keywords</h3>

<p>You can use these in any loop:</p>

<ul>
  <li><code class="w3-codespan">break</code> - stop the loop</li>
  <li><code class="w3-codespan">continue</code> - skip a value in the loop</li>
</ul>
<hr>
<p>Now that you know how loops work, you are ready to start working with functions and reusable code!</p>
