...
ny:-->
    ...
    <h1>Rust <span class="color_h1">Scope</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="rust_functions.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="rust_strings.php">Next &#10095;</a>
</div>
<hr>

<h2>Scope</h2>

<p>Now that you understand how functions work, it is important to learn how variables act inside and outside of functions.</p>
<p><strong>Scope</strong> refers to where a variable is allowed to be used.</p>

<p>A variable only lives inside the block where it was created. A block is anything inside curly braces <code class="w3-codespan">{ }</code>.</p>

<hr>

<h2>Variable Inside a Function</h2>

<p>A variable created inside a function only exists inside that function:</p>
...
&nbsp;&nbsp;println!("{}", message);&nbsp; // You can access the message 
  ...
  outside of the function</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_scope">Try it Yourself &raquo;</a>
</div>

<p><strong>Note:</strong> The variable <code class="w3-codespan">message</code> only exists inside the function.  
Trying to use it outside the function will cause an error.</p>

<hr>

<h2>Variable Inside a Block</h2>

<p>You can also create blocks inside other code, like in <code class="w3-codespan">if</code> statements or loops.  
Variables created in these blocks are only valid inside them.</p>

<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate javaHigh w3-border-red">
    let score = 80;<br><br>if score &gt; 50 {<br>&nbsp; let result = "Pass";<br>&nbsp; 
    println!("Result: {}", result);<br>}<br><br>println!("Result: {}", result); 
    // Error: result is out of scope here<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_scope2">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Variables in the Same Scope</h2>

<p>In Rust, you <strong>can</strong> declare a new variable with the same name in the same scope using <code class="w3-codespan">let</code>. This is called <strong>shadowing</strong>:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_scope_shadowing">Try it Yourself &raquo;</a>
</div>

<p>The second <code class="w3-codespan">x</code> replaces the first one. The value <code class="w3-codespan">5</code> is no longer accessible after the second declaration.</p>

<p>This is different from languages that disallow reusing variable names. In Rust, it's a feature used to transform or update values safely.</p>


<p>You can also reuse a variable name inside a new block:</p>
...
{<br>
&nbsp;&nbsp;let x = 10;<br>
&nbsp;&nbsp;println!("Inside block: {}", x);<br>
}<br><br>
println!("Outside block: {}", x);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_scope3">Try it Yourself &raquo;</a>
</div>

<p>Here, the two <code class="w3-codespan">x</code> variables are in different scopes. The inner <code class="w3-codespan">x</code> only exists inside the block. Outside the block, the original value remains.</p>

<div class="ws-note ws-yellow">
<p><strong>Note:</strong> Even though shadowing is allowed, using the same name too often can make your code harder to read. Use clear names when possible.</p>
</div>
...
<p>Understanding scope helps you:</p>
<ul>
  <li>Know where a variable can be used</li>
  <li>Prevent naming conflicts</li>
  <li>Avoid errors when working with functions, loops, and conditionals</li>
</ul>
