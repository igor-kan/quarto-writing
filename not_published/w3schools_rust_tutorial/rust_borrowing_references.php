<!DOCTYPE html>
<html lang="en-US">
<title>Rust Borrowing and References</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Rust <span class="color_h1">Borrowing and References</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="rust_ownership.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="rust_data_structures.php">Next &#10095;</a>
</div>
<hr>

<h2>Borrowing and References</h2>

<p>Sometimes you want to use a value without taking ownership of it.</p>

<p>Rust lets you do this using a <strong>reference</strong> - this is called <strong>borrowing</strong>:</p>

<hr>

<h2>What is a Reference?</h2>

<p>A reference lets you look at a value without owning it.  
You create a reference using the <code class="w3-codespan">&amp;</code> symbol:</p>
...
let b = &amp;a;<br><br>
  println!(&quot;a = {}&quot;, a);<br>println!(&quot;b = {}&quot;, b);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_borrowing_references">Try it Yourself &raquo;</a>
</div>

<p>Since <code class="w3-codespan">b</code> is only borrowing the value, <code class="w3-codespan">
...
<p>If you want to <strong>change</strong> a value through a reference, you need to make the reference <code class="w3-codespan">mut</code>:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
let mut name = String::from("John");<br>
let name_ref = &amp;mut name;<br>
name_ref.push_str(" Doe");<br><br>
println!("{}", name_ref); // John Doe
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_borrowing_references">Try it Yourself &raquo;</a>
</div>
<p><strong>Note:</strong> You can only have one mutable reference to a value at a time!</p>

<hr>

<h2>Why Borrowing is Important</h2>
<p>Borrowing helps you reuse values safely, without giving them away.</p>
<ul>
  <li>It lets you use values without taking ownership</li>
  <li>It avoids cloning, which can be slow for large data</li>
  <li>It makes your programs safer and faster</li>
</ul>
