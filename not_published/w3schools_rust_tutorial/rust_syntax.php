...
ny:-->
    ...
    <h1>Rust <span class="color_h1">Syntax</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="rust_getstarted.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="rust_output.php">Next &#10095;</a>
</div>
<hr>

<h2>Syntax</h2>

<p>You have already seen the following code a couple of times in the first 
chapters. Let's break it down to understand it better:</p>
...
<p><strong>Line 1:</strong> <code class="w3-codespan">fn main()</code> is something that always appears at the beginning of every Rust program.
<code class="w3-codespan">main()</code> is called a <strong>function</strong>, and any code inside its curly brackets <code class="w3-codespan">{}</code> will be executed.</p>
<p><strong>Line 2:</strong> <code class="w3-codespan">println!()</code> is a <strong>macro</strong>, used to output/print text to the screen. In our example it will output "Hello World!". 
To end the code, you must remember a semicolon (<code class="w3-codespan">;</code>).</p>

<div class="ws-note w3-panel">
<p><strong>What is a macro?</strong></p>
  <p>A macro is like a function, but with an exclamation mark (<code class="w3-codespan">!</code>) after 
it. Don't worry about the terminology for now. For now, just know that macros 
  ...
  functions. You will learn more about macros later.</p>
  <p><strong>Good to know:</strong> The Rust compiler ignores white spaces.</p>
  <p>The code above could also been written as:<br>
<code class="w3-codespan">fn main(){println!("Hello World!");} </code></p>
<p><strong>However</strong>, multiple lines and indentation makes the code more readable.</p>
</div>
