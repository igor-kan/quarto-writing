...
ny:-->
    ...
    <h1>Rust <span class="color_h1">Tuples</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="rust_vectors.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="rust_hashmap.php">Next &#10095;</a>
</div>
<hr>

<h2>Tuples</h2>

<p>A <strong>tuple</strong> is a group of values of different types, stored in a single variable.</p>

<p>Tuples are useful when you want to return or work with multiple values together.</p>

<hr>

<h2>Create a Tuple</h2>

<p>Tuples are written using parentheses <code class="w3-codespan">()</code>, with values separated by commas:</p>
...
<p>This tuple contains a <code class="w3-codespan">&amp;str</code>, an <code class="w3-codespan">i32</code>, and a <code class="w3-codespan">bool</code>.</p>

<hr>

<h2>Access Tuple Values</h2>

<p>You can access tuple values by using a dot <code class="w3-codespan">.</code> followed by the index:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
let person = ("John", 30, true);<br>
println!("Name: {}", person.0);<br>
println!("Age: {}", person.1);<br>
println!("Is active: {}", person.2);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_tuples">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Unpack a Tuple</h2>
<p>When we create a tuple, we normally assign values to it. This is called "packing" a tuple:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
let person = ("Jenny", 45, false);<br>
</div>
</div>

<p>But, in Rust, we are also allowed to extract the values back into variables. This is called "unpacking":</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
let person = ("Jenny", 45, false);<br>
let (name, age, active) = person;<br><br>
println!("Name: {}", name);<br>
println!("Age: {}", age);<br>
println!("Active: {}", active);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_tuples_unpack">Try it Yourself &raquo;</a>
</div>
...
<h2>Return a Tuple from a Function</h2>
...
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  fn get_user() -&gt; (String, i32) {<br>&nbsp; (String::from(&quot;Liam&quot;), 25)<br>}<br>
  <br>fn main() {<br>&nbsp; let user = get_user();<br>&nbsp; println!(&quot;User: {} 
  ({} years old)&quot;, user.0, user.1);<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_tuples_functions">Try it Yourself &raquo;</a>
</div>
