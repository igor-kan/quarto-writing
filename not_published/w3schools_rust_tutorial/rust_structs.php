<!DOCTYPE html>
<html lang="en-US">
<title>Rust Structs (Structures)</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Rust <span class="color_h1">Structs</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="rust_hashmap.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="rust_enums.php">Next &#10095;</a>
</div>
<hr>

<h2>Structs</h2>

<p>A <strong>struct</strong> (short for "structure") is a custom data structure that lets you group related values together.</p>

<p>You can think of a struct like a mini-database for one thing, like a person with a name and age.</p>

<hr>

<h2>Create a Struct</h2>

<p>You define a struct using the <code class="w3-codespan">struct</code> keyword and place the fields (variables) inside:</p>
...
struct Person {<br>
&nbsp;&nbsp;name: String,<br>
&nbsp;&nbsp;age: u32,<br>&nbsp; can_vote: bool,<br>
}
</div>
</div>


<p>Once you have a struct, you can create an object of it.</p>
<p>Then, you can access the fields of the struct using dot syntax (<code class="w3-codespan">.</code>):</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  // Create a Struct called Person<br>struct Person {<br>
&nbsp;&nbsp;name: String,<br>
&nbsp;&nbsp;age: u32,<br>&nbsp; can_vote: bool,<br>
}<br><br>// Create a Person object<br>
let user = Person {<br>
&nbsp;&nbsp;name: String::from("John"),<br>
&nbsp;&nbsp;age: 35,<br>&nbsp; can_vote: true,<br>
};<br><br>// Access and print the values<br>println!(&quot;Name: {}&quot;, 
  user.name);<br>
  println!(&quot;Age: {}&quot;, user.age);<br>println!(&quot;Can vote? {}&quot;, 
  user.can_vote);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_structs">Try it Yourself &raquo;</a>
</div>
<div class="ws-note ws-panel">
<p>Fields are similar to variables, but they belong to a struct.
Since they are part of a larger structure (like Person or Car), they are called fields in Rust, not regular variables.</p>
</div>
<hr>

<h2>Change a Field</h2>

<p>To change a value inside a struct, you must make the struct object mutable by using <code class="w3-codespan">mut</code>:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  struct Person {<br>&nbsp; name: String,<br>&nbsp; age: u32,<br>}<br><br>let mut user = 
  Person {<br>&nbsp; name: String::from(&quot;John&quot;),<br>&nbsp; age: 35,<br>};<br><br>user.age = 
  36; // Change value of age<br>println!(&quot;Name: {}&quot;, user.name);<br>
  println!(&quot;Updated age: {}&quot;, user.age);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_structs_change">Try it Yourself &raquo;</a>
</div>
...
<ul>
  <li>To group related data in a clean way</li>
  <li>To make your code easier to read and maintain</li>
  <li>To create real-world examples, like users, books, cars, etc.</li>
</ul>
