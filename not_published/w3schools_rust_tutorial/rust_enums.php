...
ny:-->
    ...
    <h1>Rust <span class="color_h1">Enums</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="rust_structs.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="rust_exam.php">Next &#10095;</a>
</div>
<hr>

<h2>Enums</h2>

<p>An <strong>enum</strong> (short for "enumeration") is a way to define a type that can be one of a few different values.</p>

<p>Each value in the enum is called a <strong>variant</strong>.</p>

<p>Enums are useful when you want to represent a value that can only be one of a set of options - like days of the week, directions, or results like success and error.</p>

<hr>

<h2>Create an Enum</h2>

<p>To create an enum, use the <code class="w3-codespan">enum</code> keyword and add a set of named values (variants) separated by commas:</p>
...
<p>To use the enum, create a variable and assign it one of the enum's variants (use <code class="w3-codespan">::</code> to access a variant):</p>


<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  enum Direction {<br>&nbsp; Up,<br>&nbsp; Down,<br>&nbsp; Left,<br>&nbsp; 
  Right,<br>}<br><br>fn main() {<br>&nbsp; 
  let my_direction = Direction::Up;<br>&nbsp; println!(&quot;We are going up!&quot;);<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_enums">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Match on Enum Values</h2>

<p>Enums work great with the <code class="w3-codespan">match</code> statement.  
...
<div class="w3-code notranslate javaHigh">
  enum Direction {<br>&nbsp; Up,<br>&nbsp; Down,<br>&nbsp; Left,<br>&nbsp; 
  Right,<br>}<br><br>fn main() {<br>&nbsp; 
  let my_direction = Direction::Left;<br><br>&nbsp; match my_direction {<br>&nbsp;&nbsp;&nbsp; 
  Direction::Up =&gt; println!(&quot;Going up&quot;),<br>&nbsp;&nbsp;&nbsp; Direction::Down 
  =&gt; println!(&quot;Going down&quot;),<br>&nbsp;&nbsp;&nbsp; Direction::Left =&gt; 
  println!(&quot;Going left&quot;),<br>&nbsp;&nbsp;&nbsp; Direction::Right =&gt; 
  println!(&quot;Going right&quot;),<br>&nbsp; }<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_enums_match">Try it Yourself &raquo;</a>
</div>
...
<p>Enum variants can also hold data. This is useful when each variant needs to 
store extra information:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  enum LoginStatus {<br>&nbsp; Success(String),<br>&nbsp; Error(String),<br>}<br><br>fn 
  main() {<br>&nbsp; let result1 = LoginStatus::Success(String::from(&quot;Welcome, 
  John!&quot;));<br>&nbsp; let result2 = LoginStatus::Error(String::from(&quot;Incorrect 
  password&quot;));<br><br>&nbsp; match result1 {<br>&nbsp;&nbsp;&nbsp; 
  LoginStatus::Success(message) =&gt; println!(&quot;Success: {}&quot;, message),<br>&nbsp;&nbsp;&nbsp; 
  LoginStatus::Error(message) =&gt; println!(&quot;Error: {}&quot;, message),<br>&nbsp; }<br>
  }</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_enums_data">Try it Yourself &raquo;</a>
</div>
...
<ul>
  <li>To group related values into one type</li>
  <li>To make your code more readable and safe</li>
  <li>To handle different cases with <code class="w3-codespan">match</code></li>
</ul>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="rust_structs.php">&#10094; Previous</a>
