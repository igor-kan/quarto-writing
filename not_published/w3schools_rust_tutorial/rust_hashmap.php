...
ny:-->
    ...
    <h1>Rust <span class="color_h1">HashMap</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="rust_tuples.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="rust_structs.php">Next &#10095;</a>
</div>
<hr>

<h2>HashMap</h2>

<p>A <strong>HashMap</strong> is a collection of key/value pairs.</p>

<p>HashMaps are great when you want to store values and find them by a key.</p>

<p>To use HashMap, you must import it from Rust's standard library:</p>
...
<p>You can create a new, empty HashMap and add items to it:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  // Import HashMap<br>use std::collections::HashMap;<br><br>fn main() {<br>&nbsp; // Create a 
  HashMap called capitalCities<br>&nbsp; let mut capitalCities = HashMap::new();<br>
  <br>&nbsp; // Add keys and values (Country, City)<br>&nbsp; 
  capitalCities.insert(&quot;England&quot;, &quot;London&quot;);<br>&nbsp; 
  capitalCities.insert(&quot;Germany&quot;, &quot;Berlin&quot;);<br>&nbsp; 
  capitalCities.insert(&quot;Norway&quot;, &quot;Oslo&quot;);<br><br>&nbsp; println!(&quot;{:?}&quot;, 
  capitalCities);<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_hashmap">Try it Yourself &raquo;</a>
</div>
...
<p>You can use the <code class="w3-codespan">.get()</code> method to access a value in a HashMap by its key:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  let mut capitalCities = HashMap::new();<br><br>capitalCities.insert(&quot;England&quot;, 
  &quot;London&quot;);<br>capitalCities.insert(&quot;Germany&quot;, &quot;Berlin&quot;);<br>
  capitalCities.insert(&quot;Norway&quot;, &quot;Oslo&quot;);<br><br>if let Some(city) = 
  capitalCities.get(&quot;England&quot;) {<br>&nbsp; println!(&quot;The capital of 
  England is {}.&quot;, city);<br>} else {<br>&nbsp; println!(&quot;England is not in the 
  map.&quot;);<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_hashmap_access">Try it Yourself &raquo;</a>
</div>
...
<p>If you insert a new value using a key that already exists, the old value is replaced with the new one:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  let mut 
  capitalCities = HashMap::new();<br><br>capitalCities.insert(&quot;England&quot;, 
  &quot;London&quot;);<br>capitalCities.insert(&quot;England&quot;, &quot;Berlin&quot;);<br><br>println!(&quot;{:?}&quot;, capitalCities);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_hashmap_update">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Remove Values</h2>

<p>To remove a key from a HashMap, use the <code class="w3-codespan">.remove()</code> method:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  let mut capitalCities = HashMap::new();<br><br>// Add keys and values 
  (Country, City)<br>
  capitalCities.insert(&quot;England&quot;, &quot;London&quot;);<br>capitalCities.insert(&quot;Germany&quot;, 
  &quot;Berlin&quot;);<br>capitalCities.insert(&quot;Norway&quot;, &quot;Oslo&quot;);<br>
  <br>// Remove the key &quot;England&quot;<br>
  capitalCities.remove(&quot;England&quot;);<br><br>println!(&quot;{:?}&quot;, capitalCities);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_hashmap_remove">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Loop Through a HashMap</h2>

<p>You can use a <code class="w3-codespan">for</code> loop to go through all key/value pairs:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  let mut capitalCities = HashMap::new();<br><br>// Add keys and values 
  (Country, City)<br>capitalCities.insert(&quot;England&quot;, &quot;London&quot;);<br>
  capitalCities.insert(&quot;Germany&quot;, &quot;Berlin&quot;);<br>capitalCities.insert(&quot;Norway&quot;, 
  &quot;Oslo&quot;);<br><br>// Loop through the HashMap<br>for (country, city) in 
  &amp;capitalCities {<br>&nbsp; println!(&quot;The capital of {} is {}.&quot;, country, 
  city);<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_hashmap_loop">Try it Yourself &raquo;</a>
</div>

<hr>

<h3>Why Use HashMaps?</h3>

<ul>
  <li>To store data by key</li>
  <li>To quickly look up values</li>
  <li>To group related data (like names and scores)</li>
</ul>

<p><strong>Note:</strong> HashMaps require keys to be unique. Inserting the same key again will overwrite the old value.</p>
