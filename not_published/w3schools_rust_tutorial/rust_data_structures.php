<!DOCTYPE html>
<html lang="en-US">
<title>Rust Data Structures</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Rust <span class="color_h1">Data Structures</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="rust_borrowing_references.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="rust_arrays.php">Next &#10095;</a>
</div>
<hr>

<h2>Data Structures</h2>

<p>In Rust, data structures are used to store and organize values.</p>
<p>Rust provides many built-in data structures. Each is used to handle data in different ways.</p>
...
<h2>Arrays</h2>
<p>An array in Rust is a fixed-size list of values, all of the same type.</p>
<p>You cannot grow or shrink an array after it's created.</p>
<p>To access an array element, refer to its index number.</p>

<p>Array indexes start with 0: [0] is the first element,
[1] is the second element, etc.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  let fruits = [&quot;apple&quot;, &quot;banana&quot;, &quot;orange&quot;];<br>
  println!(&quot;Last fruit: {}&quot;, fruits[2]);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_data_structures_arrays">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Vectors</h2>
<p>A vector is a resizable array. Unlike regular arrays, vectors can grow or 
shrink in size.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  let mut fruits = vec![&quot;apple&quot;, &quot;banana&quot;];<br>fruits.push(&quot;cherry&quot;);<br><br>
  println!(&quot;Last fruit: {}&quot;, fruits[2]);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_data_structures_vectors">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Tuples</h2>
<p>A tuple can hold multiple values of different types. It is useful when grouping different types together.</p>
<p>You access tuple elements using a dot and an index number, like <code class="w3-codespan">person.1</code>, etc:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  let person = (&quot;John&quot;, 30, true);<br>println!(&quot;Name: {}&quot;, person.0);<br>
  println!(&quot;Age: {}&quot;, person.1);<br>println!(&quot;Is active: {}&quot;, person.2);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_data_structures_tuples">Try it Yourself &raquo;</a>
</div>
...
<h2>HashMaps</h2>
<p>A HashMap stores key-value pairs. It lets you look up a value using a key.</p>
<p>To use HashMap, you must import it from the standard library.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  // Import HashMap<br>use std::collections::HashMap;<br><br>fn main() {
  <br>&nbsp; let mut capitalCities = HashMap::new();<br>
  &nbsp; capitalCities.insert("France", "Paris");<br>
  &nbsp; capitalCities.insert("Japan", "Tokyo");<br><br>
  &nbsp;
  println!("Capital of Japan is {}", capitalCities["Japan"]);<br>} </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_data_structures_hashmap">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="ws-table-all w3-bordered">
  ...
  <tr>
    <td>Array</td>
    <td>Fixed-size list of same-type values</td>
    <td>No</td>
  </tr>
  <tr>
    <td>Vector (Vec)</td>
    <td>Growable list of same-type values</td>
    <td>Yes</td>
  </tr>
  <tr>
    <td>Tuple</td>
    <td>Group different types together</td>
    <td>No</td>
  </tr>
  <tr>
    <td>HashMap</td>
