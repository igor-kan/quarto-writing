...
ny:-->
    ...
    <h1>Rust <span class="color_h1">Operators</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="rust_constants.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="rust_booleans.php">Next &#10095;</a>
</div>
<hr>

<h2>Operators</h2>

<p>Operators are used to perform operations on values and variables.</p>

<p>Rust supports many common operators, like:</p>
...
<p>Arithmetic operators are used to do basic math:</p>

<table class="ws-table-all notranslate">
  <tr><th>Operator</th><th>Name</th><th>Example</th><th>Result</th></tr>
  <tr><td>+</td><td>Addition</td><td><code class="w3-codespan">5 + 3</code></td><td>8</td></tr>
  <tr><td>-</td><td>Subtraction</td><td><code class="w3-codespan">5 - 3</code></td><td>2</td></tr>
  <tr><td>*</td><td>Multiplication</td><td><code class="w3-codespan">5 * 3</code></td><td>15</td></tr>
  <tr><td>/</td><td>Division</td><td><code class="w3-codespan">10 / 2</code></td><td>5</td></tr>
  <tr><td>%</td><td>Remainder (modulus)</td><td><code class="w3-codespan">10 % 3</code></td><td>1</td></tr>
</table>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_operators_arit">Try it Yourself &raquo;</a>
</div>
...
<table class="ws-table-all notranslate">
  ...
  <tr><td>=</td><td><code class="w3-codespan">x = 5</code></td><td>Assign 5 to x</td></tr>
  <tr><td>+=</td><td><code class="w3-codespan">x += 3</code></td><td><code class="w3-codespan">x = x + 3</code></td></tr>
  <tr><td>-=</td><td><code class="w3-codespan">x -= 2</code></td><td><code class="w3-codespan">x = x - 2</code></td></tr>
  <tr><td>*=</td><td><code class="w3-codespan">x *= 4</code></td><td><code class="w3-codespan">x = x * 4</code></td></tr>
  <tr><td>/=</td><td><code class="w3-codespan">x /= 2</code></td><td><code class="w3-codespan">x = x / 2</code></td></tr>
  <tr><td>%=</td><td><code class="w3-codespan">x %= 2</code></td><td><code class="w3-codespan">x = x % 2</code></td></tr>
</table>
...
fn main() {<br>
&nbsp;&nbsp;let mut x = 10;<br>
&nbsp;&nbsp;println!("Start: {}", x);<br><br>

&nbsp;&nbsp;x += 5;<br>
&nbsp;&nbsp;println!("After += 5: {}", x);<br><br>

&nbsp;&nbsp;x -= 2;<br>
&nbsp;&nbsp;println!("After -= 2: {}", x);<br><br>

&nbsp;&nbsp;x *= 2;<br>
&nbsp;&nbsp;println!("After *= 2: {}", x);<br><br>

&nbsp;&nbsp;x /= 3;<br>
&nbsp;&nbsp;println!("After /= 3: {}", x);<br><br>

&nbsp;&nbsp;x %= 4;<br>
&nbsp;&nbsp;println!("After %= 4: {}", x);<br>
}
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_operators_assign">Try it Yourself &raquo;</a>
</div>
...
<p>Comparison operators compare values and return <code class="w3-codespan">true</code> or <code class="w3-codespan">false</code>:</p>

<table class="ws-table-all notranslate">
  <tr><th>Operator</th><th>Meaning</th><th>Example</th></tr>
  <tr><td>==</td><td>Equal to</td><td><code class="w3-codespan">5 == 5</code> is true</td></tr>
  <tr><td>!=</td><td>Not equal to</td><td><code class="w3-codespan">5 != 3</code> is true</td></tr>
  <tr><td>&gt;</td><td>Greater than</td><td><code class="w3-codespan">7 &gt; 3</code> is true</td></tr>
  <tr><td>&lt;</td><td>Less than</td><td><code class="w3-codespan">2 &lt; 5</code> is true</td></tr>
  <tr><td>&gt;=</td><td>Greater than or equal to</td><td><code class="w3-codespan">5 &gt;= 5</code> is true</td></tr>
  <tr><td>&lt;=</td><td>Less than or equal to</td><td><code class="w3-codespan">3 &lt;= 4</code> is true</td></tr>
</table>
...
&nbsp;&nbsp;let a = 5;<br>
&nbsp;&nbsp;let b = 10;<br><br>
&nbsp; println!(&quot;5 == 10: {}&quot;, a == b);<br>&nbsp; println!(&quot;5 != 10: {}&quot;, a != 
  b);<br>&nbsp; println!(&quot;5 &lt; 10: {}&quot;, a &lt; b);<br>&nbsp; println!(&quot;5 &gt;= 10: {}&quot;, 
  a &gt;= b);<br>
}
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_operators_compare">Try it Yourself &raquo;</a>
</div>
...
<p>Logical operators are used to work with boolean values:</p>

<table class="ws-table-all notranslate">
  <tr><th>Operator</th><th>Name</th><th>Description</th></tr>
  <tr><td>&&</td><td>AND</td><td>true if both values are true</td></tr>
  <tr><td>||</td><td>OR</td><td>true if at least one is true</td></tr>
  <tr><td>!</td><td>NOT</td><td>inverts the boolean value</td></tr>
</table>
...
<div class="w3-code notranslate javaHigh">
fn main() {<br>
&nbsp;&nbsp;let logged_in = true;<br>
&nbsp;&nbsp;let is_admin = false;<br><br>
&nbsp;&nbsp;println!("Is regular user: {}", logged_in &amp;&amp; !is_admin);<br>
&nbsp;&nbsp;println!("Has any access: {}", logged_in || is_admin);<br>
&nbsp;&nbsp;println!("Not logged in: {}", !logged_in);<br>
}
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryrust.php?filename=demo_operators_logical">Try it Yourself &raquo;</a>
</div>
