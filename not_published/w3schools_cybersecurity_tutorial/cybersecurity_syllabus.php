...
<html lang="en-US">
<head>
<title>Cyber Security Syllabus (Curriculum)</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Cyber Security <span class="color_h1">Syllabus</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="cybersecurity_quiz.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="cybersecurity_study_plan.php">Next &#10095;</a>
</div>
<hr>
<h2>Introduction</h2>
<style>
...
<p>The <a title="W3Schools Cyber Security Tutorial" href="index.php">W3Schools Cyber Security Tutorial</a> is comprehensive and beginner-friendly.</p>
<p>It will give you a fundamental knowledge of cyber security principles and practices.</p>
<p>It is designed for beginners and requires basic computer and networking knowledge.</p>
...
<p>The syllabus outline and its sequence are structured so you can learn cyber security step by step, from basic concepts to advanced security practices.</p>
<p><a title="W3Schools Cyber Security Tutorial" href="index.php" class="ws-btn">Get Started With Cyber Security &raquo;</a></p>
<hr>

<h2>Learning Outcomes</h2>
<ul>
    <li>Learn what cyber crime is and why it is important.</li>
    <li>Understand basic networking and the OSI model.</li>
    <li>Learn about common network attacks.</li>
    <li>Understand web application attacks and vulnerabilities.</li>
    <li>Learn the basics of security operations and defense strategies.</li>
</ul>
<div class="ws-note w3-panel">
<p><strong>Note:</strong> Are you a teacher teaching Cyber Security? <a href="/academy/index.php" target="_blank">W3Schools Academy</a> is a toolbox of features that can help you teach. It offers classroom features such as pre-built study plans, classroom administration and much more. Read more about <a href="/academy/index.php" target="_blank">Academy here</a>.</p>
</div>
<hr>

<h2>Which Subjects Are Cyber Security Relevant For?</h2>
<ul>
   <li style="margin-bottom:16px;"><strong>Network Security:</strong><br> Protecting networks from unauthorized access.</li>
   <li style="margin-bottom:16px;"><strong>Application Security:</strong><br> Securing software applications from threats.</li>
   <li style="margin-bottom:16px;"><strong>Information Security:</strong><br> Protecting sensitive data and systems.</li>
   <li style="margin-bottom:16px;"><strong>Cloud Security:</strong><br> Securing cloud-based resources and services.</li>
   <li style="margin-bottom:16px;"><strong>Incident Response:</strong><br> Handling and managing security incidents.</li>
   <li style="margin-bottom:16px;"><strong>Risk Management:</strong><br> Assessing and managing security risks.</li>
   <li><strong>Compliance:</strong><br> Meeting security regulations and standards.</li>
</ul>
<p><a title="W3Schools Cyber Security Tutorial" href="index.php" class="ws-btn" style="margin-top:8px">Get Started</a></p>
<hr>

<h2>Activities</h2>
<p>In this tutorial we offer different activities for you to learn Cyber Security for free:</p>
<ul>
    <li><a href="index.php" title="W3Schools Cyber Security Tutorial">Lessons</a></li>
    <li><a href="cybersecurity_quiz.php" title="W3Schools Cyber Security Quiz">Quizzes</a></li>
</ul>
<hr>
...
<ul class="link-boxes">
    <li><a href="index.php">CS HOME</a></li>
    <li><a href="cybersecurity_crime.php">CS Cyber Crime</a></li>
    <li><a href="cybersecurity_money.php">CS Money Making Threats</a></li>
    <li><a href="cybersecurity_dark_web.php">CS Dark Web</a></li>
    <li><a href="cybersecurity_networking.php">CS Networking Basics</a></li>
    <li><a href="cybersecurity_network_layer.php">CS Network Layer</a></li>
    <li><a href="cybersecurity_network_transport.php">CS Network Transport</a></li>
    <li><a href="cybersecurity_firewalls.php">CS Firewalls</a></li>
    <li><a href="cybersecurity_web_applications.php">CS Web Applications</a></li>
    <li><a href="cybersecurity_mapping_port_scanning.php">CS Mapping & Port Scanning</a></li>
    <li><a href="cybersecurity_network_attacks.php">CS Network Attacks</a></li>
    <li><a href="cybersecurity_web_applications_attacks.php">CS Web Application Attacks</a></li>
    <li><a href="cybersecurity_wifi_attacks.php">CS WIFI Attacks</a></li>
    <li><a href="cybersecurity_passwords.php">CS Passwords</a></li>
    <li><a href="cybersecurity_prenetration_testing.php">CS Penetration Testing & Social Engineering</a></li>
    <li><a href="cybersecurity_security_operations.php">CS Security Operations</a></li>
    <li><a href="cybersecurity_incident_response.php">CS Incident Response</a></li>
</ul>
</div>
<p><a title="W3Schools Cyber Security Tutorial" href="index.php" class="ws-btn">Get Started</a></p>
<hr>

<h2>Sandbox and Lab Environment</h2>
<p>Cyber Security, like any technical field, is best learned through hands-on practice.</p>
...
that allows you to practice basic security concepts for free.</p>
<p>Here you get a secure sandbox environment called Spaces, where you can practice security techniques and test security tools in real-time.</p>
<p>Spaces allow you to test, analyze, and implement security measures. This includes a W3Schools subdomain, hosting, and secure SSL certificates.</p>
...
<p>The Cyber Security exam is a test that summarizes the W3Schools Cyber Security syllabus.</p>
<p>After passing the exam you get the "Certified Cyber Security Professional" Certification.</p>
...
<div class="ws-grey w3-padding w3-round">
<a href="cybersecurity_exam.png" target="_blank"><img src="cybersecurity_exam.png" style="width: 100%" loading="lazy"></a>
</div>
<p><a class="ws-btn" href="https://campus.w3schools.com/collections/certifications/products/cyber-security-certificate" target="_blank">Buy Certificate &raquo;</a></p>
<hr>
