...
<html lang="en-US">
<head>
<title>Cyber Security Study Plan (Lesson Plan)</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Cyber Security <span class="color_h1">Study Plan</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="cybersecurity_syllabus.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="index.php">Next &#10095;</a>
</div>
<hr>
<h2>Introduction</h2>
<p>The Cyber Security study plan helps you teach your students Cyber Security step-by-step.</p>
<p>Creating a study plan for Cyber Security is easy.</p>
...
<p>Save time with pre-built teacher materials and study plans. Easily organize your class with a timeline from the introduction of Cyber Security to the final exam.</p>
<hr>
...
<p>W3Schools has everything you need to teach Cyber Security.</p>

<p>The Cyber Security training materials is available for you to include and use in your study plan:</p>
<ul>
  <li><a href="index.php" target="_blank">W3Schools Cyber Security Tutorial</a></li>
  <li><a href="cybersecurity_quiz.php" target="_blank">Cyber Security Quiz</a></li>
  <li>Cyber Security Challenges (Coding challenges)</li>
  <li><a href="cybersecurity_exam.php" target="_blank">Cyber Security Certification Exam (End of Pathway Exam)</a></li>
</ul>
<hr>

<h2>Cyber Security Syllabus</h2>
<p>
  With the Cybersecurity Syllabus, your students will start with the basics, like understanding common security threats and learning how to protect data, and move to more advanced topics, like encryption, network security. Each chapter includes simple examples, try-it-yourself sections, exercises, and quizzes to make learning easy, interactive, and fun.</p>
<p><a title="W3Schools Cyber Security Syllabus" href="cybersecurity_syllabus.php" target="_blank">Read more about Cyber Security Syllabus</a>.</p>
<hr>
...
<ol>
  ...
  <li style="margin-top:16px">
    ...
    <ul>
      <li>The Cyber Security study plan aligns with the Cyber Security Certification Exam.</li>
      <li>The exam can be taken at the end of the study plan, at your selected date.</li>
      <li>The exam summarizes the Cyber Security Tutorial.</li>
...
<p>For example, this is how a 3-week Cyber Security study plan could look like:</p>

<ul>
  <li>Week 1: Crime, Threats, and the Dark Web</li>
  <li>Week 2: Networking, Cyber Attacks</li>
  <li>Week 3: Cyber Defence, Cyber Security Certification Exam</li>
</ul>

<p>Image of Sample Cyber Security study plan:</p>
<a href="cybersecurity_study_plan.png" target="_blank" title="Cyber Security Study Plan"><img src="cybersecurity_study_plan.png" style="height:auto;max-width:100%;" loading="lazy"></a>
<hr>

<h2>Ready to get started?</h2>
<p>Start with <strong> Cyber Security Study Plans</strong> today.</p>
...
<p>Are you interested in learning how you can use <a href="/academy/index.php" target="_blank">W3Schools Academy</a> to Teach Cyber Security programming? </p>
