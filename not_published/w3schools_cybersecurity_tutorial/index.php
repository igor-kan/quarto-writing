...
<html lang="en-US">
<head>
<title>Cyber Security Tutorial</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>Cyber Security <span class="color_h1">Tutorial</span></h1>

<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="/default.asp">&#10094; Home</a>
<a class="w3-right w3-btn" href="cybersecurity_crime.php">Next &#10095;</a>
</div>
<div class="cert-section">
  <div class="cert-card">
    <div class="cert-card-header">
      <div class="cert-card-icon">
        <svg fill="#2C3E50" stroke="#2C3E50" stroke-width="0" viewBox="0 0 448 512" height="39" width="39" xmlns="http://www.w3.org/2000/svg"><path d="M400 224h-24v-72C376 68.2 307.8 0 224 0S72 68.2 72 152v72H48c-26.5 0-48 21.5-48 48v192c0 26.5 21.5 48 48 48h352c26.5 0 48-21.5 48-48V272c0-26.5-21.5-48-48-48zm-104 0H152v-72c0-39.7 32.3-72 72-72s72 32.3 72 72v72z"/></svg>
      </div>
      <h2 class="cert-card-title">Learn Cyber Security</h2>
    </div>
    <p class="cert-card-desc">Welcome to this introductory course in Cyber Security.</p>
    <p class="cert-card-desc">This course serves as an excellent primer to the many different domains of Cyber Security.</p>
    <div class="cert-card-bottom" style="margin-top:auto;padding-top:16px;">
      <a href="cybersecurity_crime.php" class="cert-card-btn">Learn Cyber Security now &#10095;</a>
    </div>
  </div>

  <div class="cert-info" style="padding:24px;display:flex;flex-direction:column;">
    <h3 class="cert-info-title">Become Cyber Security Certified</h3>
    <p class="cert-info-desc">Get certified with our Cyber Security exam, includes a professionally curated study kit to guide you from beginner to exam-ready.</p>
...
<a href="https://campus.w3schools.com/collections/course-catalog/products/cyber-security-course" class="cert-card-btn cert-btn-white" target="_blank" style="margin-top:12px;background:#fff;color:#000;border:2px solid #000;">Get Certified &#10095;</a>
        </div>
        <div class="cert-preview" style="flex:1 1 auto;padding:0;align-self:flex-start;">
          <svg class="cert-preview-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 560 400" role="img" aria-label="Cyber Security Certificate preview" style="width:100%;max-width:250px;height:auto;display:block;margin:0 0 0 auto;">
            ...
            <text x="280" y="212" text-anchor="middle" font-family="Source Sans Pro Topnav, sans-serif" font-size="13" fill="#475569">has passed the W3Schools Cyber Security Certification exam and is hereby declared a</text>
            <g transform="translate(256,222)">
              <svg fill="#2C3E50" stroke="#2C3E50" stroke-width="0" viewBox="0 0 448 512" height="48" width="32" xmlns="http://www.w3.org/2000/svg"><path d="M400 224h-24v-72C376 68.2 307.8 0 224 0S72 68.2 72 152v72H48c-26.5 0-48 21.5-48 48v192c0 26.5 21.5 48 48 48h352c26.5 0 48-21.5 48-48V272c0-26.5-21.5-48-48-48zm-104 0H152v-72c0-39.7 32.3-72 72-72s72 32.3 72 72v72z"/></svg>
            </g>
            <text x="280" y="300" text-anchor="middle" font-family="Source Sans Pro Topnav, sans-serif" font-size="18" font-weight="700" fill="#0f172a">Certified Cyber Security Professional</text>
...
<p>We have created 16 tutorial pages for you to learn the fundamentals of Cyber Security:</p>
<style>
.pelle-btn {
  width:260px;
  border-radius:5px;
...
<div style="text-align:center;">
  <div class="w3-row">
    <div class="w3-col m12 l12">
      <h3 style="text-align:center">Basic Cyber Security</h3>
      <a href="cybersecurity_crime.php" class="w3-btn pelle-btn">Cyber Crime</a>
      <div class="pelle-divider">&nbsp;</div>
      <a href="cybersecurity_money.php" class="w3-btn pelle-btn">Money Making Threats</a><br>
      <div class="pelle-divider">&nbsp;</div>
      <a href="cybersecurity_dark_web.php" class="w3-btn pelle-btn">Dark Web</a><br>
      <div class="pelle-divider">&nbsp;</div>
      <a href="cybersecurity_networking.php" class="w3-btn pelle-btn">Networking Basics</a><br>
      <div class="pelle-divider">&nbsp;</div>
      <a href="cybersecurity_network_layer.php" class="w3-btn pelle-btn">Network Layer</a><br>
      <div class="pelle-divider">&nbsp;</div>
      <a href="cybersecurity_network_transport.php" class="w3-btn pelle-btn">Network Transport</a><br>
      <div class="pelle-divider">&nbsp;</div>
      <a href="cybersecurity_firewalls.php" class="w3-btn pelle-btn">Firewalls</a><br>
      <div class="pelle-divider">&nbsp;</div>
      <a href="cybersecurity_web_applications.php" class="w3-btn pelle-btn">Web Applications</a><br>
      <div class="pelle-divider">&nbsp;</div>
      <a href="cybersecurity_mapping_port_scanning.php" class="w3-btn pelle-btn">Mapping &amp; Port Scanning</a><br>
      <div class="pelle-divider">&nbsp;</div>
      <a href="cybersecurity_network_attacks.php" class="w3-btn pelle-btn">Network Attacks</a><br>
      <div class="pelle-divider">&nbsp;</div>
      <a href="cybersecurity_web_applications_attacks.php" class="w3-btn pelle-btn">Web Application Attacks</a><br>
      <div class="pelle-divider">&nbsp;</div>
      <a href="cybersecurity_wifi_attacks.php" class="w3-btn pelle-btn">WIFI Attacks</a><br>
      <div class="pelle-divider">&nbsp;</div>
      <a href="cybersecurity_passwords.php" class="w3-btn pelle-btn">Passwords</a><br>
      <div class="pelle-divider">&nbsp;</div>
      <a href="cybersecurity_prenetration_testing.php" class="w3-btn pelle-btn">Penetration Testing<br>and<br>Social Engineering</a><br>
      <div class="pelle-divider">&nbsp;</div>
      <a href="cybersecurity_security_operations.php" class="w3-btn pelle-btn">Security Operations</a><br>
      <div class="pelle-divider">&nbsp;</div>
      <a href="cybersecurity_incident_response.php" class="w3-btn pelle-btn">Incident Response</a><br>
    </div>
  </div>
</div>
...
<p>Test your Cyber Security skills with a quiz test.</p>
<p><a href="cybersecurity_quiz.php" class="w3-button w3-blue">Start Cyber Security Quiz</a></p>
<hr>
<style>
.containerlog {
  display: flex;
