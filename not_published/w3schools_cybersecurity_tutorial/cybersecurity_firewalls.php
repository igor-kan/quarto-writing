...
<html lang="en-US">
<head>
<title>Cyber Security Firewalls</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h2 class="left"><span class="left_h2">Cyber Security</span></h2>
<a target="_top" href="index.php">CS HOME</a>
<a target="_top" href="cybersecurity_crime.php">CS Cyber Crime</a>
<a target="_top" href="cybersecurity_money.php">CS Money Making Threats</a>
<a target="_top" href="cybersecurity_dark_web.php" class="not-wired">CS Dark Web</a>
<br>
<h2 class="left"><span class="left_h2">Networking</span></h2>
<a target="_top" href="cybersecurity_networking.php">CS Networking Basics</a>
<a target="_top" href="cybersecurity_network_layer.php">CS Network Layer</a>
<a target="_top" href="cybersecurity_network_transport.php">CS Network Transport</a>
<a target="_top" href="cybersecurity_firewalls.php">CS Firewalls</a>
<a target="_top" href="cybersecurity_web_applications.php" class="not-wired">CS Web Applications</a>
<br>
<h2 class="left"><span class="left_h2">Cyber Attacks</span></h2>
<a target="_top" href="cybersecurity_mapping_port_scanning.php">CS<span style="font-size:90%"> Mapping &amp; Port Scanning</span></a>
<a target="_top" href="cybersecurity_network_attacks.php">CS Network Attacks</a>
<a target="_top" href="cybersecurity_web_applications_attacks.php">CS<span style="font-size:90%">  Web Application Attacks</span></a>
<a target="_top" href="cybersecurity_wifi_attacks.php">CS WIFI Attacks</a>
<a target="_top" href="cybersecurity_passwords.php">CS Passwords</a>
<a target="_top" href="cybersecurity_penetration_testing.php" class="not-wired">CS Penetration Testing &amp;<br>Social Engineering</a>
<br>

<h2 class="left"><span class="left_h2">Cyber Defence</span></h2>
<a target="_top" href="cybersecurity_security_operations.php">CS Security Operations</a>
<a target="_top" href="cybersecurity_incident_response.php" class="not-wired">CS Incident Response</a>
<br>

<h2 class="left"><span class="left_h2">Cyber Cert</span></h2>
<a target="_top" class="no-checkmark" href="cybersecurity_exam.php">CS Certificate</a>
<br>

<h2 class="left"><span class="left_h2">Cyber Quiz</span></h2>
<a target="_top" class="no-checkmark" href="cybersecurity_quiz.php">CS Quiz</a>
<a target="_top" class="no-checkmark" href="cybersecurity_syllabus.php">CS Syllabus</a>
<a target="_top" class="no-checkmark" href="cybersecurity_study_plan.php">CS Study Plan</a>
        <br><br>
    </div>
  </div>
</div>
...
ny:-->
    ...
    <h1>Cyber Security <span class="color_h1">Firewalls</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="cybersecurity_network_transport.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="cybersecurity_web_applications.php">Next &#10095;</a>
</div>
<hr>
<h2>Firewalls</h2>
<p>Firewalls are a central architectural element to any network. They are designed to keep out all network traffic, except traffic which we allow. Firewalls operate on Layer 4, typically controlling TCP and UDP access to internal assets. Next-Generation Firewalls operate on all the layers of the OSI model, including Layer 7.</p>
<p>Traffic entering a network, e.g. through a Firewall, is called ingress traffic. Traffic leaving is called egress.</p>
<hr>

<h2>Layer 4 Firewall</h2>
<p>The traditional Firewall is a Layer 4 Firewall with features such as:</p>
<ul>
  <li>NAT</li>
  <li>Routing</li>
  <li>Blocking or Allowing traffic</li>
  <li>Track active network connections</li>
  <li>Support VPN connections</li>
</ul>

<div class="w3-panel ws-note">
<strong>Note</strong>: These Firewalls are typically cheaper and offers more throughput on the network than a more modern Next-Generation Firewall.
</div>
<hr>

<h2>NGFW ("Next-Generation Firewalls")</h2>
<p>A modern Firewall has capabilities that range much wider than a a Layer 4 Firewall. These capabilities are typically security features.</p>
<p>A NGFW Firewall can also track active network connections, but is also typically capable of tracking:</p>
<ul>
  <li>Locations via geo-location databases. This means the Firewall can make blocking or allow actions based on the location of users. Location services are not always accurate and can often easily be bypassed using VPN services or by using other services like jump stations for attacks.</li>
  <li>Users</li>
  <li>Applications</li>
  <li>Sessions</li>
...
<p>Other features of a NGFW includes:</p>
<ul>
  <li>Identify and control applications on the network.</li>
  <li>It can be virtualized to run as a software Firewall.</li>
  <li>Often offers simple and intuitive management.</li>
  <li>Supports protecting against known threats via ("Intrusion Prevention System").</li>
  <li>Potential to detect and prevent unknown threats via sandboxing solutions.</li>
  <li>Offers a potential to manage unknown traffic, e.g. traffic which cannot be attributed to an application.</li>
  <li>Capabilities to terminate and inspect encrypted traffic.</li>
  <li>Can control users, not just system via respective IP addresses.</li>
</ul>
<p><img class="invert-on-dark" src="img_firewalls-1.png" alt="Firewall" style="width:100%;max-width:480px"></p>
<div class="w3-panel ws-note">
<strong>Note</strong>: Which features your NGFW comes with often greatly depends on which licenses have been purchased and the capacity of the hardware running the Firewall.
</div>
<hr>

<h2>Firewall Administration</h2>
<p>A Firewall can typically be administered via a proprietary management application, or via a web-browser accessing the Firewalls management via HTTP.</p>
<p>Management ports to Firewalls, including other management services of an organization, should ideally be segmented away from regular user access. Ideally the segmentation of management services is connected to an organizations user directory, for example Active Directory for Windows environments.</p>
...
<h2>Segmentation</h2>
<p>Firewalls can segment traffic between hosts and systems into segments, sometimes called zones. Each segment holds services which are allowed to communicate between one another.</p>
<p><img class="invert-on-dark" src="img_firewall-segmentation.svg" alt="Firewall Segmentation" style="width:100%;max-width:1280px"></p>
<p>Any connection to or from the segment should be carefully controlled by the Firewall, preventing any unauthorized connections to make successful connections. Smaller segments offer more segregation, but requires more management.</p>
<p>Without any segmentation, users and systems can talk directly to each other without the Firewalls enforcement. This is called a flat network.</p>
<p><img class="invert-on-dark" src="img_no-segmentation.svg" alt="Firewall No Segmentation" style="width:100%;max-width:1280px"></p>
<p>Adding more segmentation we can envision segments representing services, where each segment is a service provided in the organization. Each segment could contain the different servers responsible for making the service operational. Communications within the segment is allowed, but any access in and out from the segment is controlled by the Firewall.</p>
<p>Another segmentation idea would be to control segments based on their functions, for example clustering web applications within a segment with other web-applications, databases within one segment and other kinds of services within their segment.&nbsp;</p>
<div class="w3-panel ws-note"><strong>Note</strong>: A very common user directory is Microsoft's Windows Active Directory. It holds information about which users, computers and groupings the organization holds.&nbsp;</div>
<p><img class="invert-on-dark" src="img_more-segmentation.svg" alt="Firewall More Segmentation" style="width:100%;max-width:1280px"></p>
<p>The best and most secure kind of segmentation is called zero-trust architecture, forcing all systems on the network to explicitly be allowed to communicate to different services.</p>
<p>To ease management of Firewall rules, the Firewall management is ideally connected to the organizations user directory. This can allow Firewall administrators to create careful rules based on employee responsibilities, allowing the organization to add and remove permissions which are applied on the network without asking the Firewall administrators for changes anytime there is a role change. This is sometimes called user-based policy control. Examples include:</p>
<ul>
  <li>IT-Administrators should be able to use management protocols to the different services.</li>
  <li>HR employees should be allowed to access HTTPS to the HR platforms.</li>
  <li>Helpdesk employees can only access helpdesk related services.</li>
  <li>Unrecognizable users can be identified and provisioned accordingly.</li>
</ul>
<div class="w3-panel ws-note">
<strong>Note</strong>: A very common user directory is Microsoft's Windows Active Directory. It holds information about which users, computers and groupings the organization holds.
</div>
<hr>

<h2>IPS ("Intrusion Prevention System") and IDS ("Intrusion Detection System")</h2>
<p>Sometimes IPS and IDS systems are deployed as stand-alone systems on the network, but very often they are included in a NGFW.</p>
<p>IPS and IDS systems have signatures, algorithms and heuristics to detect attacks on the network or host. An IDS or IPS deployed on a host is called a HIDS ("Host Intrusion Detection System").</p>
<p><img class="invert-on-dark" src="img_ips.svg" alt="IPS" style="width:100%;max-width:640px"></p>
<p>In this course the term IDS and IPS is used interchangeably as the difference between them is often just a matter of configuration of how they operate. An IPS system is positioned in such a way it can detect and block threats, while an IDS system is only capable of detecting threats.</p>
<p>IPS systems can be used to detect and block attackers and often rely on frequent updates and inspection in encrypted traffic.</p>
<div class="ws-note w3-panel">
<strong>Note</strong>: A very useful feature of IDS and IPS is the frequent updates of new signatures of developing threats from the vendors. This allows defenders some reassurance that new threats will be blocked as the firewall is updated with new updates.
</div>

<hr>
<h2>Content and Application Filtering</h2>
<p>The Firewall can make attempts in understanding which applications and content is traversing the network. Such detection can further activate other security features like IPS to protect the systems between the Firewall.</p>
<h3>URL Filtering</h3>
<p>NGFW can also protect content accessed via HTTP. The Firewall can look up domains in a database containing lists of domains and respective categorization. Firewall can then enforce only acceptable categories of domains are allowed by users, for example news is allowed while gambling is not.</p>
<p><img class="invert-on-dark" src="img_urlfiltering.svg" alt="URL Filtering" style="width:100%;max-width:1280px"></p>
<p>Elements such as domain age and validity could also be checked, preventing users from visiting domains which has recently been created and not yet categorized, or checking for fraudulent activities by analyzing the content of the domain.</p>
<p>Instead of rejecting access to websites, the Firewall could intercept the request and send the user to what is called a captive web portal. On this portal the user could be warned about immediate danger or the violation of company policy in e.g. visiting unacceptable content. In some cases you could allow the user to provide a reason why they need to access the content, then let them continue if they have provided a reason.</p>
<p>Categories within domains can be many, for example websites hosting content related to:</p>
<ul>
  <li>Hacking</li>
  <li>Nudity</li>
  <li>Violence</li>
  ...
  <li>Entertainment</li>
  <li>Anonymizing services</li>
</ul>
<p><img class="invert-on-dark" src="img_urlfiltering-categories.png" alt="URL filtering categories" style="width:100%;max-width:1280px"></p>
<hr>

<h3>Applications</h3>
<p>The Firewall can try to determine which applications are in use, not just the protocols. Many protocols are capable of carrying other applications, for example HTTP can hold thousands of different applications. A Firewall can try to decode the network streams on Layer 4 and try to determine the content which is presented on Layer 7.</p>
<p><img class="invert-on-dark" src="img_content.svg" alt="Content" style="width:100%;max-width:1280px"></p>
<p>A screenshot shows what a user could see when an application has been blocked.</p>
<p><img class="invert-on-dark" src="img_application-control.png" alt="Application Control" style="width:100%;max-width:1280px"></p>
<hr>

<h2>Content Control</h2>
<p>As Applications are being identified, the Firewall could try to reveal specific content within the applications, for example content being downloaded:</p>
<ul>
...
<p><img class="invert-on-dark" src="img_contentcontrol.svg" alt="Content Control" style="width:100%;max-width:1280px"></p>
<p>In such files, the Firewall can try to identify malware, proprietary and confidential information not supposed to leave the network and much more.</p>
<p>The Firewall could support many different protocols and the content running through them, for example:</p>
<ul>
  <li>HTTP</li>
  <li>SMB</li>
  <li>FTP</li>
...
<hr>
<h2>Sandboxing</h2>
<p>In this context, sandboxing means to have a platform execute files, which are may be malicious. The sandbox records and monitors the activity of the file to see if it is malicious or not.</p>
<p><img class="invert-on-dark" src="img_sandboxing.svg" alt="Sandboxing" style="width:100%;max-width:1280px"></p>
<p>Sandboxing typically allows the Firewall to forward executable files to this platform and prevent users from downloading the file until a verdict has been made whether it is malicious or not.</p>
<p>A modern sandbox has capabilities to run files in multiple different platforms, for example:</p>
<ul>
  <li>Windows 7,8 and 10.</li>
  <li>Android phones.</li>
  <li>Linux</li>
</ul>
<p>Files which are interesting to execute and explore in a sandbox is more than just an executable file. Many files are capable of performing malicious actions on the operating system of our users:</p>
<ul>
  <li>ZIP files with content to run</li>
...
<p>There are many sandboxes online you can try yourself, outside of what a NGFW can provide:</p>
<ul>
  <li>https://www.joesandbox.com/</li>
  <li>https://www.virustotal.com/</li>
  <li>https://www.hybrid-analysis.com/</li>
  <li>https://any.run/</li>
</ul>
<hr>

<h2>Decrypting Traffic</h2>
<p>Many Firewalls support installing certificates which allows for decryption of traffic. If content is decrypted, content can then be inspected for threats.</p>
<p>Decryption can take place on Egress or Ingress traffic, or both. For Ingress traffic the Firewall could protect servers against incoming traffic. Egress traffic allows the Firewall to protect users and systems needing to communicate outbound.</p>
<p><img class="invert-on-dark" src="img_firewall-decrypt.png" alt="Firewall Decrypt" style="width:100%;max-width:1280px"></p>
<p>The Firewall will often avoid decrypting traffic such as health care and financial data as this may have privacy and other implications. Decryption of traffic requires more effort from the organization to distribute keys to clients which is used by the firewall to decrypt traffic.</p>
<div class="w3-panel ws-note">
<strong>Note:</strong> Remember Egress and Ingress traffic? Egress means traffic leaving the network, while Ingress means traffic arriving to the network.
</div>
<hr>

<h3>Unknown Traffic</h3>
<p>Some traffic can not be decrypted or understood fully by the Firewall. Many reasons can apply, for example a proprietary application sends data which the Firewall does not know of. Such traffic can also be categorized as Unknown. A Firewall administrator should consider blocking such applications, especially from networks which are considered high-risk.</p>
<p><img class="invert-on-dark" src="img_firewall-unknown-traffic.png" alt="Firewall Unknown Traffic" style="width:100%;max-width:320px"></p>
<hr>

<h2>WAF ("Web Application Firewall")</h2>
<p>While Firewalls can do a decent job, they often lack full understanding of what a protocol is capable off. Because of such, protocol specific firewalls are also developed where WAF is one of the more common ones.</p>
<p>A WAF allows more features specific to the HTTP protocol than a regular Firewall, making it more capable of stopping threats.</p>
<p>While a WAF tries to do a good job in blocking threats on HTTP, it often provides other very useful utilities for organizations making them very viable for much more than just blocking threats. Here are some examples:&nbsp;</p>
<ul>
  <li>WAF can help build redundancy, that is having multiple servers to present the same service. This allows for organizations to have a service in a higher available modus, allowing them to put a server offline while the other servers are still capable of serving users trying to access the service. This is useful as concepts like patching often requires you to restart the service, and the redundancy allows users to still access the service.</li>
  <li>A WAF can help enforce best practice security rules, for example a single place to maintain and enforce encryption, multi-factor authentication and other concepts which this class covers.</li>
  <li>It can be used to develop a single front and protection mechanism for multiple web-servers which are behind the WAF.</li>
</ul>

<div class="w3-panel ws-note">
<strong>Note:</strong> WAF's are a much more specialized firewall to counter threats on the HTTP protocol. It also typically holds functionality which is very convenient for administrators.
</div>
