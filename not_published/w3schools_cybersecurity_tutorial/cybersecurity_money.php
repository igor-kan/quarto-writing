...
<html lang="en-US">
<head>
<title>Cyber Security Money Making Threats</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Cyber Security <span class="color_h1">Money Making Threats</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="cybersecurity_crime.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="cybersecurity_dark_web.php">Next &#10095;</a>
</div>
<hr>
<h2>Driven by Money</h2>
<p>There are a few key threats organizations face frequently:</p>
<ul>
    <li>Ransomware files and systems are encrypted with attackers keys and they demand you to pay money to get your data back.</li>
    <li>Cryptocurrency miners; your systems are infected with a low-profile cryptocurrency mining tool. This tool uses the CPU to try make money on a cryptocurrency for the attackers.</li>
    <li>BEC ("Business Email Compromise"). Users get hacked through all sorts of methods and their emails are compromised. Via email compromise the attackers can intercept communications, for example an invoice, and try to redirect payments to other banks and accounts.</li>
</ul>
<p>There are plenty of ways of making money for cyber criminals, which attracts people and interest.</p>
<hr>
<h2>Value and Power</h2>
<p>There is value and power in many things related to IT, for example:</p>
<ul>
    <li>Bandwidth can be used to pressure businesses by targeting them with DDOS ("Distributed Denial of Service") attacks.</li>
    <li>Hacked systems may have sensitive information worth money, for example business proprietary information, online gaming assets, sensitive photographs and pictures.</li>
    <li>Attackers can install themselves in browsers and try to hijack the online banking use.</li>
</ul>
<p>The potential for criminals to make significant amounts of money within the cyber domain causes more and more criminal gangs and other opportunists to join in on the action and make our lives much harder.</p>
<hr>
<h2>Threatening for Money</h2>
<p>Another common attack cyber criminals perform to make money is the act of extortion, that is holding individuals hostage based on information they have on a individual, trying to make them pay money to be released from the extortion attempt. Consider the following common scenario:</p>
<ul>
  <li>A person meets up with someone online, the other party is actually a scam artists trying to trick the victim.</li>
  <li>They engage in interesting conversations and seem to make an immediate deep bond between one another.</li>
  <li>They might even engage in video conversations, but the scam artists is for example using recorded video or simply has an excuse for not being able to activate their microphone or web-camera.</li>
  <li>One thing might lead to another and the relationship could turn sexual. The scam artist tries to convince the victim in giving up personal pictures and recordings of themselves, likely in compromising situations.</li>
  <li>Once the scam artist receives this material, perhaps even returning fake pictures of innocent people in similar situations, the extortion begins.</li>
  <li>The scam artist can now threaten to release the compromising material to family members, co-workers and others, offering to delete the material if a sum of money is paid into the scam artists account.</li>
</ul>
<p><img class="invert-on-dark" src="img_scam-artist.png" alt="Scam Artist" style="width:100%;max-width:1278px"></p>
<p>Stories like these are far from uncommon, and there exists countless of different scenarios and opportunities for criminals to benefit from victims using the Internet without knowing the risks associated.</p>
<hr>
