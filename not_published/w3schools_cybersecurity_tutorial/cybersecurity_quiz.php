...
ny:-->
    ...
    <h1>Cyber Security <span class="color_h1">Quiz</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="cybersecurity_exam.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="cybersecurity_syllabus.php">Next &#10095;</a>
</div>
<hr>
<p class="intro">You can test your Cyber Security skills with W3Schools' Quiz.</p>
<hr><h2>The Test</h2>
<p>The test contains 25 questions and there is no time limit.</p>
<p>The test is not official, it's just a nice way to see how much you know, or don't know, about Cyber Security.</p>
...
<p>Good luck!</p>
<p><a href='/quiztest/quiztest.php?qtest=CYBERSECURITY' class="w3-btn w3-blue w3-round" style="margin-top:10px;padding:17px;font-size:17px">Start the Cyber Security Quiz &#10095;</a></p>
</div>
<div class="ws-note w3-panel">
  <p>If you don't know Cyber Security, we suggest that you read our <a href="index.php">Cyber Security Tutorial</a> from scratch.</p>
</div>
