...
<html lang="en-US">
<head>
<title>How To Get The Current Screen Size/Browser Window</title>
<meta charset="utf-8">
...
<h1>How TO - Get The Current Screen Size</h1>
<div class="w3-clear nextprev">
<a class="w3-left ws-btn" href="howto_js_get_url.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_js_element_iframe.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to get the current screen size/browser window with JavaScript.</p>
<hr>

<h2>Current Screen Size</h2>
<p>Use <code class="w3-codespan">window.innerWidth</code> and <code class="w3-codespan">window.innerHeight</code> 
to get the current screen size of a page.</p>
<p>This example displays the browser window's height and width (NOT including toolbars/scrollbars):

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
  var w = window.innerWidth;<br>var h = window.innerHeight;</div>
<a class="ws-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_js_get_current_window" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
<p>Read more about the <code class="w3-codespan">window</code> object in our <a href="/js/js_window.asp">JavaScript Window Tutorial</a>.</p>
</div>
