...
<div class="w3-clear nextprev">
  <a class="w3-left ws-btn" href="howto_js_dropdown_sidenav.asp">&#10094; Previous</a>
  <a class="w3-right ws-btn" href="howto_css_subnav.asp">Next &#10095;</a>
</div>
<hr>
...
<iframe src="tryhow_js_responsive_navbar_dropdown_ifr.htm" class="w3-border" style="width:100%;background-color:#fff;" id="myifr"></iframe>
<p><a target="_blank" href="tryit.asp?filename=tryhow_js_responsive_navbar_dropdown" class="ws-btn">Try it Yourself &raquo;</a></p>
...
<div class="w3-code notranslate cssHigh">
  ...
  &nbsp; background-color: #04AA6D;<br>&nbsp; color: white;<br>}<br><br>/* Hide the 
  ...
  a grey background to dropdown links on hover */<br>.dropdown-content a:hover {<br>
...
the user clicks on the icon */<br>function myFunction() {<br>&nbsp;&nbsp;var x = document.getElementById("myTopnav");<br>
  &nbsp; if (x.className 
=== "topnav") {<br>&nbsp;&nbsp;&nbsp; x.className += " 
responsive";<br>&nbsp;&nbsp;} else {<br>&nbsp;&nbsp;&nbsp; x.className = "topnav";<br>&nbsp;&nbsp;}<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_responsive_navbar_dropdown" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
