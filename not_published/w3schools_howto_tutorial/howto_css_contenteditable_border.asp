...
<html lang="en-US">
<head>
<title>How To Remove Contenteditable Border</title>
<meta charset="utf-8">
...
<h1>How TO - Remove Contenteditable Border</h1>
<div class="w3-clear nextprev">
<a class="w3-left ws-btn" href="howto_css_devices.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_css_placeholder.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to remove the border from an editable element.</p>
<hr>

<h2>Remove Contenteditable Border</h2>

<p>By default, when you write inside an element that has <code class="w3-codespan">contenteditable</code> set to <code class="w3-codespan">true</code>, that element gets a border around on focus. However, you can use CSS to remove the border:</p>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;p contenteditable=&quot;true&quot;&gt;This is an editable paragraph.&lt;/p&gt;<br></div>
</div>
<h5>Step 2) Add CSS:</h5>
<p>Use the <code class="w3-codespan">[<em>attribute</em>]</code> selector to select all elements that are contenteditable, and remove the border with the <code class="w3-codespan">outline</code> property:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  [contenteditable] {<br>&nbsp; outline: 0px solid transparent;<br>}<br></div>
 <a class="ws-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_css_contenteditable_border" target="_blank">Try it Yourself &raquo;</a>
</div>

<p><strong>Tip:</strong> Go to our <a href="/tags/att_global_contenteditable.asp">HTML contenteditable Attribute Reference</a> to learn 
more about the global contenteditable attribute.</p>
<p><strong>Tip:</strong> Go to our <a href="/cssref/sel_attribute.asp">CSS [<em>attribute</em>] Selector</a> to learn 
more about the [<em>attribute</em>] selector.</p>
