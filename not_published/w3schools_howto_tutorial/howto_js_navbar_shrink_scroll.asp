...
<div class="w3-clear nextprev">
  <a class="w3-left ws-btn" href="howto_js_navbar_hide_scroll.asp">&#10094; Previous</a>
  <a class="w3-right ws-btn" href="howto_js_navbar_sticky.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to resize a navigation bar on scroll with CSS and JavaScript.</p>
<hr>
<iframe src="tryhow_js_navbar_shrink_scroll.htm" style="width:100%;border:3px solid #e9e9e9;height:410px;padding:0;background-color:#fff"></iframe>
<p><a target="_blank" href="tryit.asp?filename=tryhow_js_navbar_shrink_scroll" class="ws-btn">Try it Yourself &raquo;</a></p>
<hr>
...
<a target="_blank" href="tryit.asp?filename=tryhow_js_navbar_shrink_scroll" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
