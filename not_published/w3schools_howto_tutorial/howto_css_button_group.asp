...
<a class="w3-left ws-btn" href="howto_css_breadcrumbs.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_css_button_group_vertical.asp">Next &#10095;</a>
</div>
<hr>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_button_group" class="ws-btn">Try it Yourself &raquo;</a></p>
<hr>
...
<div class="w3-code notranslate cssHigh">
  .btn-group button {<br>&nbsp; background-color: #04AA6D; /* Green 
  ...
  */<br>&nbsp; color: white; /* White text */<br>&nbsp; padding: 10px 
  ...
  buttons side by side */<br>}<br><br>.btn-group button:not(:last-child) {<br>&nbsp;&nbsp;border-right: none; /* Prevent double borders */<br>}<br><br>/* Clear floats (clearfix hack) */<br>.btn-group:after {<br>
  &nbsp; 
  content: &quot;&quot;;<br>&nbsp;&nbsp;clear: both;<br>&nbsp;&nbsp;display: 
  table;<br>}<br><br>/* Add a background color on hover */<br>.btn-group button:hover {<br>&nbsp;&nbsp;background-color: #3e8e41;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_button_group" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_button_group_justified" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
