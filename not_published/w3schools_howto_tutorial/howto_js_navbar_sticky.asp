...
<div class="w3-clear nextprev">
  <a class="w3-left ws-btn" href="howto_js_navbar_shrink_scroll.asp">&#10094; Previous</a>
  <a class="w3-right ws-btn" href="howto_css_navbar_image.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a "sticky" navbar with CSS.</p>
<hr>
<iframe src="tryhow_js_navbar_sticky.htm" style="background-color:white;width:100%;border:3px solid #e9e9e9;height:400px;padding:0"></iframe>
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_navbar_sticky" class="ws-btn">Try it Yourself &raquo;</a></p>
<hr>
...
<p>Style the navigation bar; add <code class="w3-codespan">position:sticky</code> and <code class="w3-codespan">top:0</code> to make the navbar 
stick when you reach its scroll position:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  /* Style the navbar */<br>#navbar {<br>&nbsp; position: sticky;<br>&nbsp; top: 
  ...
  padding: 14px;<br>&nbsp; text-decoration: none;<br>}<br><br>/* Page content */<br>.content {<br>&nbsp; padding: 16px;<br>}</div>
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_navbar_sticky" class="ws-btn">Try it Yourself &raquo;</a></p>
</div>
