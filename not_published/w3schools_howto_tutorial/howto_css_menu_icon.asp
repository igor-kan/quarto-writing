...
<div class="w3-clear nextprev">
  <a class="w3-left ws-btn" href="howto_css_icon_bar.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_js_accordion.asp">Next &#10095;</a>
</div>
<hr>
...
<p style="color:black">Menu Icon:</p>
<div style="display: inline-block;">
  <div class="bar1"></div>
  <div class="bar2"></div>
  <div class="bar3"></div>
</div>
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_menu_icon" class="ws-btn ws-green">Try it Yourself &raquo;</a></p>

</div>

<div class="w3-half" style="text-align:center;">
<p style="color:black">Animated Menu Icon (click on it):</p>
<div class="container" onclick="myFunction(this)">
  <div class="bar1"></div>
  <div class="bar2"></div>
  <div class="bar3"></div>
</div>
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_menu_icon_js" class="ws-btn ws-green">Try it Yourself &raquo;</a></p>
</div>
</div>
<script>
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_menu_icon" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
.bar1, .bar2, .bar3 {<br>&nbsp; width: 35px;<br>&nbsp;&nbsp;height: 5px;<br>&nbsp;&nbsp;background-color: #333;<br>
  &nbsp; 
margin: 6px 0;<br>&nbsp; transition: 0.4s;<br>}<br><br>/* Rotate first bar */<br>
  .change .bar1 {<br>&nbsp; transform: translate(0, 11px) rotate(-45deg);<br>}<br>
  <br>/* Fade out the second bar */<br>.change .bar2 {opacity: 0;}<br><br>/* 
  Rotate last bar */<br>.change .bar3 {<br>&nbsp; transform: translate(0, -11px) 
  rotate(45deg);<br>}</div>
</div>
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_menu_icon_js" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
