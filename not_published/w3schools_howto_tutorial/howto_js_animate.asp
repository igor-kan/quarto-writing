...
<a class="w3-left ws-btn" href="howto_syntax_highlight.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_js_string_length.asp">Next &#10095;</a>
</div>
<hr>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_js_animate_3" class="ws-btn">Try it Yourself &raquo;</a></p>
<hr>
...
&lt;/body&gt;<br>&lt;html&gt;<br></div>
 <a class="ws-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_js_animate_1" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
 ...
 400px;<br>&nbsp;&nbsp;position: relative;<br>&nbsp;&nbsp;background: yellow;<br>
 }<br><br>#myAnimation {<br>&nbsp;&nbsp;width: 50px;<br>&nbsp;&nbsp;height: 
 50px;<br>&nbsp;&nbsp;position: absolute;<br>&nbsp; 
 background: red;<br>}
</div>
 <a class="ws-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_js_animate_2" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate jsHigh">
 ...
 test for finished */) {<br>&nbsp;&nbsp;&nbsp;&nbsp;clearInterval(id);<br>&nbsp;&nbsp;} else {<br>&nbsp;&nbsp;&nbsp;&nbsp;/* code to change the element style */&nbsp; <br>
  &nbsp;&nbsp;}<br>}
</div>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
  var id = null;<br>function myMove() {<br>&nbsp; var elem = 
 document.getElementById(&quot;myAnimation&quot;); <br>&nbsp; var pos = 0;<br>&nbsp; 
  clearInterval(id);<br>&nbsp; id = setInterval(frame, 10);<br>&nbsp;&nbsp;function frame() {<br>&nbsp;&nbsp;&nbsp; if (pos == 
 350) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
 clearInterval(id);<br>&nbsp;&nbsp;&nbsp;&nbsp;} else {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
 pos++; <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;elem.style.top = pos + 'px'; <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;elem.style.left = pos + 'px'; <br>
  &nbsp;&nbsp;&nbsp;&nbsp;}<br>&nbsp;&nbsp;}<br>}</div>
 <a class="ws-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_js_animate_3" target="_blank">Try it Yourself &raquo;</a>
</div>

<br>
<div class="w3-clear nextprev">
<a class="w3-left ws-btn" href="howto_syntax_hightlight.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_js_string_length.asp">Next &#10095;</a>
</div>
<div
