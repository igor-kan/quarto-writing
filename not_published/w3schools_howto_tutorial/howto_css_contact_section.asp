...
<a class="w3-left ws-btn" href="howto_css_center_website.asp">&#10094; Previous</a>
  <a class="w3-right ws-btn" href="howto_css_about_page.asp">Next &#10095;</a>
</div>
<hr>
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_contact_section" class="ws-btn">Try it Yourself &raquo;</a>
<hr>
...
<div class="w3-code notranslate cssHigh">
  * {<br>&nbsp; box-sizing: border-box;<br>}<br><br>/* Style inputs */<br>input[type=text], select, textarea {<br>
  &nbsp; width: 100%;<br>&nbsp; 
  ...
  padding: 12px 20px;<br>&nbsp;&nbsp;border: none;<br>&nbsp;&nbsp;cursor: pointer;<br>}<br><br>input[type=submit]:hover {<br>&nbsp;&nbsp;background-color: #45a049;<br>}<br><br>/* Style the container/contact section 
  */<br>.container {<br>&nbsp;&nbsp;border-radius: 5px;<br>&nbsp;&nbsp;background-color: #f2f2f2;<br>&nbsp;&nbsp;padding: 10px;<br>}<br><br>/* Create two columns that float next to eachother 
  */<br>.column {<br>&nbsp; float: left;<br>&nbsp; 
  width: 50%;<br>&nbsp; margin-top: 6px;<br>&nbsp;&nbsp;padding: 20px;<br>}<br><br>/* Clear floats after the columns */<br>.row:after {<br>&nbsp;&nbsp;content: &quot;&quot;;<br>
  ...
  width: 100%;<br>&nbsp;&nbsp;&nbsp;&nbsp;margin-top: 0;<br>&nbsp;&nbsp;}<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_contact_section" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
