...
<html lang="en-US">
<head>
<title>How To Force (Always Show) Scrollbars With CSS</title>
<meta charset="utf-8">
...
<h1>How TO - Always Show Scrollbars</h1>
<div class="w3-clear nextprev">
  <a class="w3-left ws-btn" href="howto_css_hide_scrollbars.asp">&#10094; Previous</a>
  <a class="w3-right ws-btn" href="howto_css_devices.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to always show scrollbars with CSS.</p>
<hr>

<h2>How To Force / Always Show Scrollbars</h2>
<p>Add <code class="w3-codespan">overflow: scroll;</code> to show both the 
horizontal and vertical scrollbar:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  body {<br>&nbsp; overflow: scroll; /* Show scrollbars */<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_force_scrollbars" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>To only show the vertical scrollbar, or only the horizontal scrollbar, use <code class="w3-codespan">overflow-y</code> or <code class="w3-codespan">overflow-x</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  body {<br>&nbsp; overflow-y: scroll; /* Show vertical scrollbar */<br>&nbsp; 
  overflow-x: scroll; /* Show horizontal scrollbar */<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_force_scrollbars2" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
