...
<a class="w3-left ws-btn" href="howto_website.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_website_bootstrap4.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a responsive website with the Bootstrap CSS Framework.</p>
<hr>
<h2>Create a Website with Bootstrap 3</h2>
...
<div class="w3-row-padding" style="margin:16px -16px 0 -16px">
  <div class="w3-col m6">
    <a href="tryhow_website_bootstrap.htm" target="_blank" class="ws-btn w3-padding-large ws-black demobtnx w3-block">Demo</a>
  </div>
  <div class="w3-col m6">
    <a href="tryit.asp?filename=tryhow_website_bootstrap&stacked=h" target="_blank" class="ws-btn w3-padding-large w3-block">Try it Yourself</a>
  </div>
</div>
</div>
...
<p><strong>Note:</strong> The newest version of Bootstrap is <a href="/bootstrap5/index.php">Bootstrap 5</a>.</p>
