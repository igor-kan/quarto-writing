...
<a class="w3-left ws-btn" href="howto_js_curtain_menu.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_js_collapse_sidepanel.asp">Next &#10095;</a>
</div>
<hr>
...
<a href="javascript:void(0)">About</a>
 ...
 <p>Click on the button to open the collapsible sidebar:</p>
  <button class="ws-btn w3-dark-grey w3-padding w3-margin-bottom" onclick="openOffcanvas()">&#9776; Open Sidebar</button><br>
...
<a target="_blank" href="tryit.asp?filename=tryhow_js_collapse_sidebar" class="ws-btn">Try it Yourself &raquo;</a>
...
&lt;/div&gt;<br><br>&lt;div id=&quot;main&quot;&gt;<br>&nbsp; &lt;button class=&quot;openbtn&quot; onclick=&quot;openNav()&quot;&gt;&amp;#9776; 
  Open Sidebar&lt;/button&gt; <br>&nbsp; &lt;h2&gt;Collapsed Sidebar&lt;/h2&gt;<br>&nbsp; 
...
top: 0;<br>&nbsp; left: 0;<br>&nbsp;&nbsp;background-color: #111; /* Black*/<br>&nbsp;&nbsp;overflow-x: hidden; /* Disable horizontal scroll */<br>
  &nbsp; 
...
}<br><br>/* The sidebar links */<br>.sidebar a {<br>&nbsp;&nbsp;padding: 8px 8px 8px 32px;<br>&nbsp;&nbsp;text-decoration: none;<br>&nbsp;&nbsp;font-size: 25px;<br>&nbsp;&nbsp;color: #818181;<br>
  &nbsp; display: block;<br>&nbsp;&nbsp;transition: 0.3s;<br>}<br><br>/* When you mouse over the navigation links, 
change their color */<br>.sidebar a:hover {<br>&nbsp;&nbsp;color: #f1f1f1;<br>}<br><br>/* Position and style the close button (top 
...
font-size: 36px;<br>&nbsp; margin-left: 50px;<br>}<br><br>/* The 
  ...
  color: white;<br>&nbsp;&nbsp;padding: 10px 15px;<br>&nbsp;&nbsp;border: none;<br>}<br><br>.openbtn:hover {<br>&nbsp;&nbsp;background-color: #444;<br>}<br>
...
document.getElementById(&quot;mySidebar&quot;).style.width = &quot;0&quot;;<br>&nbsp;&nbsp;document.getElementById(&quot;main&quot;).style.marginLeft = &quot;0&quot;;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_collapse_sidebar" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
