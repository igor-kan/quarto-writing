...
<html lang="en-US">
<head>
<title>How To Create a Ribbon with CSS</title>
<meta charset="utf-8">
...
.btnx {
  ...
  font-size: 16px;
  cursor: pointer;
background-color: #282A35!important;color: white;
  position: relative;
  display:block;
}
...
<h1>How TO - CSS Ribbon</h1>
<div class="w3-clear nextprev">
  <a class="w3-left ws-btn" href="howto_css_labels.asp">&#10094; Previous</a>
  <a class="w3-right ws-btn" href="howto_css_tag_cloud.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a ribbon with CSS.</p>
<hr>

<button class="btnx">A button for something cool <span class="ribbonx">NEW</span></button>
<br>
<button class="btnx">A button for something cool <span class="ribbonx" style="background-color:#f44336;color:white">HOT</span></button>
<div class="w3-margin-top">
<a target="_blank" href="tryit.asp?filename=tryhow_css_ribbon" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div><hr>

<h2>How To Create a Ribbon</h2>
<h5>Step 1) Add HTML:</h5>
<p>In this example, the ribbon belongs to a button element:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;button class=&quot;btn&quot;&gt;A button for something cool &lt;span 
  class=&quot;ribbon&quot;&gt;NEW&lt;/span&gt;&lt;/button&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  .btn {<br>&nbsp; border: none;<br>&nbsp; border-radius: 5px;<br>&nbsp; 
  padding: 12px 20px;<br>&nbsp; font-size: 16px;<br>&nbsp; cursor: pointer;<br>&nbsp; 
  background-color: #282A35;<br>&nbsp; color: white;<br>&nbsp; position: 
  relative;<br>}<br><br>.ribbon {<br>&nbsp; width: 60px;<br>&nbsp; font-size: 14px;<br>&nbsp; padding: 
  4px;<br>&nbsp; position: absolute;<br>&nbsp; right: -25px;<br>&nbsp; top: 
  -12px;<br>&nbsp; text-align: center;<br>&nbsp; border-radius: 25px;<br>&nbsp; 
  transform: rotate(20deg);<br>&nbsp; background-color: #ff9800;<br>&nbsp; 
  color: white;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_ribbon" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
