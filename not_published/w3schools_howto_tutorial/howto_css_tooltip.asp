...
<a class="w3-left ws-btn" href="howto_html_email_field.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_css_display_element_hover.asp">Next &#10095;</a>
</div>
<hr>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_tooltip" class="ws-btn">Try it Yourself &raquo;</a></p>
...
relative;<br>&nbsp; display: inline-block;<br>&nbsp;&nbsp;border-bottom: 1px dotted black; /* If you want dots under the hoverable 
text */<br>}<br><br>/* Tooltip text */<br>.tooltip .tooltiptext 
{<br>&nbsp; visibility: hidden;<br>&nbsp; width: 
120px;<br>&nbsp; background-color: #555;<br>&nbsp; 
color: #fff;<br>&nbsp; text-align: center;<br>&nbsp;&nbsp;padding: 5px 0;<br>&nbsp; border-radius: 6px;<br><br>
  &nbsp; 
/* Position the tooltip text */<br>&nbsp; position: absolute;<br>&nbsp; 
z-index: 1;<br>&nbsp; bottom: 125%;<br>&nbsp;&nbsp;left: 
50%;<br>&nbsp; margin-left: -60px;<br><br>&nbsp;&nbsp;/* 
Fade in tooltip */<br>&nbsp;&nbsp;opacity: 0;<br>&nbsp;&nbsp;transition: opacity 0.3s;<br>}<br><br>/* Tooltip arrow */<br>.tooltip .tooltiptext::after 
{<br>&nbsp;&nbsp;content: &quot;&quot;;<br>&nbsp; position: 
absolute;<br>&nbsp; top: 100%;<br>&nbsp; left: 50%;<br>&nbsp;&nbsp;margin-left: -5px;<br>&nbsp; border-width: 5px;<br>&nbsp;&nbsp;border-style: solid;<br>&nbsp;&nbsp;border-color: #555 transparent 
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_tooltip" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
