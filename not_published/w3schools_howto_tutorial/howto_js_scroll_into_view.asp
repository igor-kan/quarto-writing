...
<html lang="en-US">
<head>
<title>How To Scroll Into View With JavaScript</title>
<meta charset="utf-8">
...
<h1>How TO - Scroll Into View</h1>
<div class="w3-clear nextprev">
<a class="w3-left ws-btn" href="howto_js_spread_operator.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_js_get_date.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to scroll into view with JavaScript.</p>
<hr>

<h2>The scrollIntoView() Method</h2>
<p>The <code class="w3-codespan">scrollIntoView()</code> method scrolls an element into the visible area of the browser window.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Scroll the element with id="content" into the visible area of the browser window:</p>
<div class="w3-code notranslate jsHigh">
  const element = document.getElementById(&quot;content&quot;);<br>
  element.scrollIntoView();</div>
<a class="ws-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_js_scroll_into_view" target="_blank">Try it Yourself &raquo;</a>
</div>

<p>Learn more about the <a href="/jsref/met_element_scrollintoview.asp">scrollIntoView()</a> method in our JavaScript Reference.</p>
