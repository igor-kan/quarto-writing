...
<div class="w3-clear nextprev">
  <a class="w3-left ws-btn" href="howto_css_text_buttons.asp">&#10094; Previous</a>
  <a class="w3-right ws-btn" href="howto_js_scroll_to_top.asp">Next &#10095;</a>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  .button {<br>&nbsp; background-color: #04AA6D;<br>&nbsp;&nbsp;border: none;<br>&nbsp; color: white;<br>
  &nbsp; 
  padding: 20px;<br>&nbsp; text-align: center;<br>&nbsp; 
  text-decoration: none;<br>&nbsp; display: inline-block;<br>&nbsp;&nbsp;font-size: 16px;<br>
  &nbsp; margin: 4px 2px;<br>}<br><br>.button1 {border-radius: 2px;}<br>.button2 
  {border-radius: 4px;}<br>.button3 {border-radius: 8px;}<br>.button4 
  {border-radius: 12px;}<br>.button5 {border-radius: 50%;}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_round_buttons" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
