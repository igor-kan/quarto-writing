...
<html lang="en-US">
<head>
<title>How To Make a Badge with CSS</title>
<meta charset="utf-8">
...
<div class="w3-clear nextprev">
  <a class="w3-left ws-btn" href="howto_css_loader.asp">&#10094; Previous</a>
  <a class="w3-right ws-btn" href="howto_css_star_rating.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a badge with CSS.</p>
<hr>
<h2>How To Create a Badge</h2>
<p>Badges can be used to add additional information to an element/content:</p>
<div class="w3-round w3-border w3-padding">
<h2>Example heading <span class="badge">New</span></h2>
<h3>Example heading <span class="badge">New</span></h3>
<h4>Example heading <span class="badge">New</span></h4>
<h5>Example heading <span class="badge">New</span></h5>
</div>
<p style="margin-top:26px"><a target="_blank" href="tryit.asp?filename=tryhow_css_badge" class="ws-btn">Try it Yourself &raquo;</a></p>
<hr>
...
<div class="w3-code notranslate cssHigh">
  .badge {<br>&nbsp; background-color: red;<br>&nbsp; color: white;<br>&nbsp; 
  padding: 4px 8px;<br>&nbsp; text-align: center;<br>&nbsp; border-radius: 5px;<br>
  }</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_badge" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
