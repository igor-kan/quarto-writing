...
<div class="w3-clear nextprev">
    <a class="w3-left ws-btn" href="howto_css_round_buttons.asp">&#10094; Previous</a>
  <a class="w3-right ws-btn" href="howto_css_login_form.asp">Next &#10095;</a>
</div>
<hr>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_js_scroll_to_top" class="ws-btn">Try it Yourself &raquo;</a></p>
<hr>
...
<div class="w3-code notranslate cssHigh">
  ...
  18px; /* Increase font size */<br>}<br><br>#myBtn:hover {<br>&nbsp;&nbsp;background-color: #555; /* Add a dark-grey background on hover */<br>}</div>
</div>
<hr>
...
<div class="w3-code notranslate jsHigh">
  // Get the button:<br>let mybutton = document.getElementById(&quot;myBtn&quot;);<br><br>// When the user scrolls down 20px from the top of the document, show the 
  ...
  mybutton.style.display = &quot;block&quot;;<br>&nbsp;&nbsp;} else {<br>&nbsp;&nbsp;&nbsp; 
  mybutton.style.display 
  = &quot;none&quot;;<br>&nbsp;&nbsp;}<br>}<br><br>// When the user clicks on the 
  button, scroll to the top of the document<br>function topFunction() {<br>&nbsp; 
  document.body.scrollTop = 0; // For Safari<br>&nbsp;&nbsp;document.documentElement.scrollTop = 0; // For Chrome, Firefox, IE and Opera<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_scroll_to_top" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
