...
<html lang="en-US">
<head>
<title>How To Create Text Dividers with CSS</title>
<meta charset="utf-8">
...
<h1>How TO - Text Divider</h1>
<div class="w3-clear nextprev">
  <a class="w3-left ws-btn" href="howto_css_dividers.asp">&#10094; Previous</a>
  <a class="w3-right ws-btn" href="howto_js_animate_icons.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a text divider with CSS.</p>
<hr>
<div class="divider">Lorem Ipsum</div>
<div class="divider">OR</div>
<div class="divider">AND</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_text_divider" class="ws-btn">Try it Yourself &raquo;</a>

<hr>

<h2>How To Create Responsive Text Dividers</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div class=&quot;divider&quot;&gt;Lorem Ipsum&lt;/div&gt;</div>
</div>
...
<div class="w3-code notranslate cssHigh">
  .divider {<br>&nbsp; font-size: 30px;<br>&nbsp; display: flex;<br>&nbsp; 
  align-items: center;<br>}<br><br>.divider::before, .divider::after {<br>&nbsp; flex: 1;<br>&nbsp; 
  content: '';<br>&nbsp; padding: 3px;<br>&nbsp; background-color: red;<br>&nbsp; 
  margin: 5px;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_text_divider" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
