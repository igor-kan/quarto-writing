...
<div class="w3-clear nextprev">
  <a class="w3-left ws-btn" href="howto_js_topnav.asp">&#10094; Previous</a>
  <a class="w3-right ws-btn" href="howto_css_topnav_split.asp">Next &#10095;</a>
</div>
<hr>
...
<ul id="myUl" class="topnav2">
  <li><a href="javascript:void(0);" class="ws-green">Home</a></li>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_js_topnav" class="ws-btn">Try it Yourself &raquo;</a></p>
...
/* 
  Add a black background color to the top navigation */<br>.topnav {<br>&nbsp;&nbsp;background-color: #333;<br>
...
Style the links inside the navigation bar */<br>.topnav a {<br>&nbsp; 
  ...
  */<br>.topnav a.active {<br>&nbsp; background-color: #04AA6D;<br>&nbsp; 
...
responsive";<br>&nbsp;&nbsp;} else {<br>&nbsp;&nbsp;&nbsp; x.className = "topnav";<br>
  &nbsp; }<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_topnav" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
