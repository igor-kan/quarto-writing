...
<html lang="en-US">
<head>
<title>How To Disable Resizing of Textarea</title>
<meta charset="utf-8">
...
<h1>How TO - Disable Resizing of Textarea</h1>
<div class="w3-clear nextprev">
  <a class="w3-left ws-btn" href="howto_css_placeholder.asp">&#10094; Previous</a>
  <a class="w3-right ws-btn" href="howto_css_disable_text_selection.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to disable the resize option of textareas.</p>
<hr>

<img src="textarea_resize2.png">
<hr>

<h2>Disable Resizing of Textarea</h2>
<p>You can use the <code class="w3-codespan">resize</code> property to specify whether a textarea should be 
resizable or not:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  textarea {<br>&nbsp; resize: none;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_disable_resize_textarea" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>


<p><strong>Tip:</strong> Go to our <a href="/cssref/css3_pr_resize.asp">CSS resize Reference</a> to learn 
more the resize property.</p>
