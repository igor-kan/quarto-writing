...
<a class="w3-left ws-btn" href="howto_css_login_form.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_css_checkout_form.asp">Next &#10095;</a>
</div>
<hr>
...
<button onclick="document.getElementById('id01').style.display='block'" class="ws-btn w3-blue w3-padding-large">Sign Up</button>
...
<p>
<a target="_blank" href="tryit.asp?filename=tryhow_css_signup_form_modal" class="ws-btn">Try it Yourself &raquo;</a>
</p>
<hr>
...
<div class="w3-code notranslate cssHigh">
  * {box-sizing: border-box}<br><br>/* Full-width input fields */<br>&nbsp; 
  ...
  #04AA6D;<br>&nbsp; color: white;<br>&nbsp; padding: 14px 20px;<br>&nbsp; 
  ...
  width: 100%;<br>&nbsp; }<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_signup_form" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  * {box-sizing: border-box}<br>/* Full-width input fields */<br>&nbsp; 
  ...
  buttons */<br>button {<br>&nbsp; background-color: #04AA6D;<br>&nbsp; color: 
...
&quot;none&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>}<br>
&lt;/script&gt;</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_signup_form_modal" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
