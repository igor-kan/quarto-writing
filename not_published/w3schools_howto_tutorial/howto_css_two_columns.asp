...
<a class="w3-left ws-btn" href="howto_css_example_website.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_css_three_columns.asp">Next &#10095;</a>
</div>
<hr>
...
<div class="w3-row">
<div class="w3-col s6" style="height:320px;padding:20px;background-color:#bbb;color:black">
<h2>Column 1</h2>
<p>Some text..</p>
</div>
<div class="w3-col s6" style="height:320px;padding:20px;background-color:#ccc;color:black">
<h2>Column 2</h2>
<p>Some text..</p>
</div>
</div>
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_two_columns" class="ws-btn">Try it Yourself &raquo;</a></p>
<hr>
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_two_columns" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_two_columns_flex" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate cssHigh">
  ...
  }<br><br>.right {<br>&nbsp;&nbsp;width: 75%;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_two_columns_unequal" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate cssHigh">
  ...
  screen and (max-width: 600px) {<br>&nbsp; .column {<br>&nbsp;&nbsp;&nbsp;&nbsp;width: 100%;<br>
  &nbsp;&nbsp;}<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_two_columns_responsive" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
