...
<a class="w3-left ws-btn" href="howto_js_vertical_tabs.asp">&#10094; Previous</a>
  <a class="w3-right ws-btn" href="howto_js_full_page_tabs.asp">Next &#10095;</a>
</div>
<hr>
...
<p style="margin-top:2px"><a target="_blank" href="tryit.asp?filename=tryhow_js_tab_header" class="ws-btn">Try it Yourself &raquo;</a></p>
...
<div class="w3-code notranslate cssHigh">
  /* Style the tab buttons */<br>.tablink {<br>&nbsp;&nbsp;background-color: #555;<br>
  &nbsp; color: white;<br>&nbsp; 
  float: left;<br>&nbsp; border: none;<br>&nbsp;&nbsp;outline: none;<br>&nbsp; cursor: pointer;<br>
  &nbsp; 
  padding: 14px 16px;<br>&nbsp; font-size: 17px;<br>&nbsp;&nbsp;width: 25%;<br>}<br>
  <br>/* Change background color of buttons on hover */<br>.tablink:hover {<br>&nbsp;&nbsp;background-color: #777;<br>}<br><br>/* Set default styles for tab content */<br>.tabcontent 
...
<div class="w3-code notranslate jsHigh">
  ...
  <br>&nbsp; // Remove the background color of all tablinks/buttons<br>&nbsp;&nbsp;tablinks = document.getElementsByClassName(&quot;tablink&quot;);<br>&nbsp;&nbsp;for (i = 0; i &lt; tablinks.length; i++) {<br>&nbsp;&nbsp;&nbsp;&nbsp;tablinks[i].style.backgroundColor = &quot;&quot;;<br>
  &nbsp;&nbsp;}<br>
  <br>&nbsp;&nbsp;// Show the specific tab content<br>&nbsp;&nbsp;document.getElementById(cityName).style.display = &quot;block&quot;;<br><br>&nbsp;&nbsp;// Add the specific color to the button used to open the tab content<br>&nbsp;&nbsp;elmnt.style.backgroundColor = color;<br>}<br><br>// Get the element with id=&quot;defaultOpen&quot; 
  and click on it<br>document.getElementById(&quot;defaultOpen&quot;).click();</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_tab_header" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
