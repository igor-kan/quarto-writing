...
<div class="w3-clear nextprev">
  <a class="w3-left ws-btn" href="howto_css_next_prev.asp">&#10094; Previous</a>
  <a class="w3-right ws-btn" href="howto_css_block_buttons.asp">Next &#10095;</a>
</div>
<hr>
...
<div style="padding:10px;border:3px solid #f1f1f1;background-color:white;">
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_dropdown_navbar_more" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<h3>Example Explained</h3>
...
&lt;a&gt; element, we have to float it to make sure that it stays next to the links.</p><p>The <code class="w3-codespan">.dropdown-content</code> class holds the actual dropdown menu. It is hidden by 
