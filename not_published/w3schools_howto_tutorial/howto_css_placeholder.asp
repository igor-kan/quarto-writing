...
.x::-webkit-input-placeholder { /* Old Chrome, Safari, Opera */
  color: red;
}
.x:-moz-placeholder { /* Firefox 4 to 18 */
  color:  red;
  opacity: 1;
}
.x::-moz-placeholder { /* Firefox 19+ */
  color: red;
  opacity: 1;
}
.x::-ms-input-placeholder { /* Edge 12-18 */
  color: red;
}
</style>
</head>
...
<a class="w3-left ws-btn" href="howto_css_contenteditable_border.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_css_disable_resize_textarea.asp">Next &#10095;</a>
</div>
<hr>
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_placeholder" class="ws-btn">Try it Yourself &raquo;</a>
<hr>
...
<p>In most browsers, the placeholder text is grey. To change this, style the placeholder with the 
<code class="w3-codespan">::placeholder</code> selector. Note that Firefox adds a lower opacity to the placeholder, so we use <code class="w3-codespan">opacity: 1</code> to fix this.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  ::placeholder {<br>&nbsp; color: red;<br>&nbsp;&nbsp;opacity: 1; /* Firefox */<br>}<br><br>::-ms-input-placeholder 
  { /* Edge 12 -18 */<br>&nbsp; color: red;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_placeholder" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p><strong>Tip:</strong> Read more about the ::placeholder selector in our CSS Reference: 
<a href="/cssref/sel_placeholder.asp">CSS ::placeholder selector</a>.</p>
