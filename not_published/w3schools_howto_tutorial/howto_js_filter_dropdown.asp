...
<a class="w3-left ws-btn" href="howto_js_filter_elements.asp">&#10094; Previous</a>
  <a class="w3-right ws-btn" href="howto_js_sort_list.asp">Next &#10095;</a>
</div>
<hr>
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_js_dropdown_filter" class="ws-btn w3-margin-top">Try it Yourself &raquo;</a>
...
background-color: #04AA6D;<br>&nbsp; color: white;<br>&nbsp; 
padding: 16px;<br>&nbsp; font-size: 16px;<br>&nbsp; 
border: none;<br>&nbsp; cursor: pointer;<br>}<br><br>/* Dropdown 
button on hover &amp; focus */<br>.dropbtn:hover, .dropbtn:focus {<br>&nbsp;&nbsp;background-color: #3e8e41;<br>}<br><br>/* The search field */<br>#myInput {<br>
  &nbsp; box-sizing: border-box;<br>&nbsp; background-image: url('searchicon.png');<br>&nbsp; 
...
absolute;<br>&nbsp;&nbsp;background-color: #f6f6f6;<br>&nbsp;&nbsp;min-width: 230px;<br>&nbsp;&nbsp;border: 1px solid #ddd;<br>&nbsp;&nbsp;z-index: 1;<br>}<br><br>/* Links inside the dropdown */<br>
.dropdown-content a {<br>&nbsp; color: black;<br>&nbsp;&nbsp;padding: 12px 16px;<br>&nbsp;&nbsp;text-decoration: none;<br>&nbsp;&nbsp;display: block;<br>}<br><br>/* Change color of dropdown links on hover */<br>
...
<div class="w3-code notranslate jsHigh">
  ...
  txtValue = a[i].textContent || a[i].innerText;<br>&nbsp;&nbsp;&nbsp; 
  if (txtValue.toUpperCase().indexOf(filter) &gt; -1) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  a[i].style.display = &quot;&quot;;<br>&nbsp;&nbsp;&nbsp; } else {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  a[i].style.display = &quot;none&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp; }<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_js_dropdown_filter" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
