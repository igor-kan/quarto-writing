...
<a class="w3-left ws-btn" href="howto_js_toggle_class.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_js_remove_class.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to add a class name to an element with JavaScript.</p>
<hr>
<button onclick="myFunction()" class="ws-btn w3-dark-grey w3-hover-black" style="box-shadow:none">Add Class</button>
...
<div class="w3-code notranslate cssHigh">
  ...
  25px;<br>&nbsp;&nbsp;background-color: coral;<br>&nbsp;&nbsp;color: white;<br>&nbsp;&nbsp;font-size: 25px;<br>}</div>
</div>
<hr>
...
<a target="_blank" href="tryit.asp?filename=tryhow_js_add_class" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
