...
<a class="w3-left ws-btn" href="howto_css_comparison_table.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_css_modals.asp">Next &#10095;</a>
</div>
<hr>
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_fullscreen_video" class="ws-btn w3-margin-bottom w3-margin-top">Try it Yourself &raquo;</a>
<hr>
...
<div class="w3-code notranslate cssHigh">
  /* Style the video: 100% width and height to cover the entire window */<br>#myVideo {<br>&nbsp;&nbsp;position: fixed;<br>
  &nbsp; right: 0;<br>&nbsp; bottom: 
  0;<br>&nbsp; min-width: 100%; <br>&nbsp; min-height: 
  100%;<br>}<br><br>/* Add some content at the bottom of the video/page */<br>
  .content {<br>&nbsp;&nbsp;position: fixed;<br>&nbsp;&nbsp;bottom: 0;<br>&nbsp;&nbsp;background: rgba(0, 0, 0, 0.5);<br>&nbsp;&nbsp;color: #f1f1f1;<br>
  &nbsp; width: 100%;<br>&nbsp;&nbsp;padding: 20px;<br>}<br><br>/* Style the button used to pause/play the video */<br>#myBtn {<br>&nbsp;&nbsp;width: 200px;<br>
  &nbsp; 
  font-size: 18px;<br>&nbsp; padding: 10px;<br>&nbsp; 
  border: none;<br>&nbsp; background: #000;<br>&nbsp;&nbsp;color: #fff;<br>&nbsp;&nbsp;cursor: pointer;<br>}<br><br>#myBtn:hover 
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_fullscreen_video" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
