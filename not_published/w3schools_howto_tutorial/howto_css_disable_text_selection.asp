...
<html lang="en-US">
<head>
<title>How To Disable Text Selection in HTML/CSS</title>
<meta charset="utf-8">
...
<h1>How TO - Disable Text Selection</h1>
<div class="w3-clear nextprev">
  <a class="w3-left ws-btn" href="howto_css_disable_resize_textarea.asp">&#10094; Previous</a>
  <a class="w3-right ws-btn" href="howto_css_text_selection.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to disable text selection in HTML with CSS.</p>
<hr>
...
<h2>Disable Text Selection</h2>
<p>You can use the <code class="w3-codespan">user-select</code> property to disable text selection of an element.</p>
<p>In web browsers, if you double-click on some text it will be 
selected/highlighted. This property can be used to prevent this.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  .prevent-select {<br>&nbsp; -webkit-user-select: none; /* Safari */<br>&nbsp; 
  -ms-user-select: none; /* IE 10 and IE 11 */<br>&nbsp; user-select: none; /* 
  Standard syntax */<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_disable_text_selection" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>


<p><strong>Tip:</strong> Go to our <a href="/cssref/css3_pr_user-select.asp">CSS user-select Reference</a> to learn 
more the user-select property.</p>
