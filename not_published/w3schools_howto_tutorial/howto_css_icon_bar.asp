...
<div class="w3-clear nextprev">
    <a class="w3-left ws-btn" href="default.asp">&#10094; Previous</a>
  <a class="w3-right ws-btn" href="howto_css_menu_icon.asp">Next &#10095;</a>
</div>
<hr>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_icon_bar_v" class="ws-btn ws-green">Try it Yourself &raquo;</a></p>
</div>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_icon_bar_h" class="ws-btn ws-green">Try it Yourself &raquo;</a></p>
...
.icon-bar a:hover {<br>&nbsp;&nbsp;background-color: #000; /* Add a hover 
  color */<br>}<br><br>.active {<br>&nbsp;&nbsp;background-color: #04AA6D; /* Add an active/current color */<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_icon_bar_v" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
width: 20%; /* Equal width (5 icons with 20% width each = 100%) */<br>&nbsp; padding: 12px 0; 
  ...
  /* Add transition for hover effects */<br>&nbsp;&nbsp;color: white; /* White text color */<br>
  &nbsp; font-size: 36px; /* 
  Increased font size */<br>}<br><br>.icon-bar a:hover {<br>&nbsp; 
background-color: #000; /* Add a hover color */<br>}<br><br>.active {<br>&nbsp; 
background-color: #04AA6D; /* Add an active/current color */<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_icon_bar_h" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Related Pages</h2>
