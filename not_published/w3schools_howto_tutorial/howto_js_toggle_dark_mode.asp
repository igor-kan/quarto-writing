...
<html lang="en-US">
<head>
<title>How To Toggle Between Dark and Light Mode</title>
<meta charset="utf-8">
...
<h1>How TO - Toggle Dark Mode</h1>
<div class="w3-clear nextprev">
<a class="w3-left ws-btn" href="howto_js_toggle_hide_show.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_js_toggle_text.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Switch between dark and light mode with CSS and JavaScript.</p>
<hr>
<iframe src="tryhow_js_toggle_dark_mode.htm" style="border:3px solid #f1f1f1;width:100%;height:350px"></iframe>
<p>
<a target="_blank" href="tryit.asp?filename=tryhow_js_toggle_dark_mode" class="ws-btn">Try it Yourself &raquo;</a>
</p>
<hr>

<h2>Toggle Class</h2>
<h5>Step 1) Add HTML:</h5>
<p>Use any element that should store the content you want to toggle the design 
for. In our example, we will use <code class="w3-codespan">&lt;body&gt;</code> for the sake of simplicity:</p>
...
<p>Style the <code class="w3-codespan">&lt;body&gt;</code> element and create a <code class="w3-codespan">.dark-mode</code> class for toggle:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  body {<br>&nbsp; padding: 25px;<br>&nbsp; background-color: white;<br>&nbsp; 
  color: black;<br>&nbsp; font-size: 25px;<br>}<br><br>.dark-mode {<br>&nbsp; background-color: black;<br>&nbsp; 
  color: white;<br>}</div>
</div>
<hr>
...
<p>Get the <code class="w3-codespan">&lt;body&gt;</code> element and toggle between the <code class="w3-codespan">.dark-mode</code> class:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
function myFunction() {<br>&nbsp; var element = 
  document.body;<br>
  &nbsp; element.classList.toggle(&quot;dark-mode&quot;);<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_toggle_dark_mode" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
