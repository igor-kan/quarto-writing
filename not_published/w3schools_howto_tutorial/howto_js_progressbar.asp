...
<a class="w3-left ws-btn" href="howto_js_scroll_indicator.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_css_skill_bar.asp">Next &#10095;</a>
</div>
<hr>
...
<br>
<button class="w3-button ws-green w3-left" onclick="move()">Run</button> <div class="w3-right" id="prlabel"></div>
...
grey;<br>
}<br><br>#myBar {<br>&nbsp;&nbsp;width: 1%;<br>&nbsp; height: 
   30px;<br>&nbsp;&nbsp;background-color: green;<br>}
</div>
</div>
...
<div class="w3-code notranslate jsHigh">
   var i = 0;<br>function move() {<br>&nbsp; if (i == 0) {<br>&nbsp;&nbsp;&nbsp; 
   i = 1;<br>&nbsp;&nbsp;&nbsp; var elem = document.getElementById("myBar");<br>&nbsp;&nbsp;&nbsp; 
   var width = 1;<br>&nbsp;&nbsp;&nbsp; var id = setInterval(frame, 10);<br>&nbsp;&nbsp;&nbsp; 
   function frame() {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if (width &gt;= 100) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
   clearInterval(id);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; i = 0;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
   } else {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; width++;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
   elem.style.width = width + "%";<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; 
   }<br>&nbsp; }<br>}</div>
<a class="ws-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_js_progressbar_3" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate cssHigh">
   ...
   30px;<br>&nbsp; background-color: #04AA6D;<br>&nbsp; 
   text-align: center; /* To center it horizontally (if you want) */<br>&nbsp; 
   line-height: 30px; /* To center it vertically */<br>&nbsp; color: 
   white; <br>}</div>
<a class="ws-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_js_progressbar_label" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate jsHigh">
   var i = 0;<br>function move() {<br>&nbsp; if (i == 0) {<br>&nbsp;&nbsp;&nbsp; 
   i = 1;<br>&nbsp;&nbsp;&nbsp; var elem = document.getElementById("myBar");<br>&nbsp;&nbsp;&nbsp; 
   var width = 10;<br>&nbsp;&nbsp;&nbsp; var id = setInterval(frame, 10);<br>&nbsp;&nbsp;&nbsp; 
   function frame() {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if (width &gt;= 100) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
   clearInterval(id);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; i = 0;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
   } else {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; width++;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
   elem.style.width = width + "%";<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
   elem.innerHTML = width + "%";<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; 
   }<br>&nbsp; }<br>}</div>
<a class="ws-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_js_progressbar_label_js" target="_blank">Try it Yourself &raquo;</a>
</div>
