...
<div class="w3-clear nextprev">
  <a class="w3-left ws-btn" href="howto_css_div_full_height.asp">&#10094; Previous</a>
  <a class="w3-right ws-btn" href="howto_css_custom_scrollbar.asp">Next &#10095;</a>
</div>
<hr>
...
<div class="w3-row-padding" style="margin:0 -24px">
  <div class="w3-third">
    <iframe src="tryhow_css_browser_window_ifr.htm" style="border:none;width:100%;height:195px;background-color:#fff;"></iframe>
    <a target="_blank" href="tryit.asp?filename=tryhow_css_browser_window" class="ws-btn" style="margin-left:10px">Try it Yourself &raquo;</a>
  </div>
  <div class="w3-twothird">
    <iframe src="tryhow_css_browser_window_ifr2.htm" style="border:none;width:100%;height:195px;background-color:#fff;"></iframe>
    <a target="_blank" href="tryit.asp?filename=tryhow_css_browser_window2" class="ws-btn" style="margin-left:10px">Try it Yourself &raquo;</a>
 </div>
</div>
<hr>
