...
<html lang="en-US">
<head>
<title>How To Remove The Decimal Part of a Number In JavaScript</title>
<meta charset="utf-8">
...
<h1>How TO - Remove Decimals of a Number</h1>
<div class="w3-clear nextprev">
<a class="w3-left ws-btn" href="howto_js_treeview.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_js_remove_property_object.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to remove the decimal part of a number in JavaScript.</p>
<hr>
<h2>Remove Decimals</h2>
<p>You can use the <code class="w3-codespan">Math.trunc()</code> method to remove the decimals of a number:</p>
...
<a class="ws-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_js_remove_decimals" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>

<p><strong>Tip:</strong> Learn more about the <a href="/jsref/jsref_trunc.asp">Math.trunc()</a> method in our JavaScript Reference.</p>
