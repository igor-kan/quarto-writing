...
<html lang="en-US">
<head>
<title>How To Create a Delete Confirmation Modal</title>
<meta charset="utf-8">
...
<h1>How TO - Delete Modal</h1>
<div class="w3-clear nextprev">
<a class="w3-left ws-btn" href="howto_css_modals.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_css_timeline.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a delete confirmation modal with CSS.</p>
<hr>

<p>Click on the button to open the modal:</p>
<button onclick="document.getElementById('id01').style.display='block'" class="ws-btn w3-blue w3-padding-large">Open Modal</button>
...
<div id="id01" class="w3-modal" style="cursor:pointer;background-color: rgba(0,0,0,0.75);">
  ...
  class="w3-container w3-text-white w3-display-topright w3-xxxlarge" style="right:50px;">&times;</span>
 <div class="w3-modal-content w3-card-4" style="max-width:600px;cursor:auto">

    <div class="w3-container w3-padding-32 w3-center">
    <h1>Delete Account</h1>
      <p>Are you sure you want to delete your account?</p> 
       <div class="w3-row">
       <div class="w3-half"><button onclick="document.getElementById('id01').style.display='none'" type="button" class="w3-button w3-block w3-grey w3-padding-16 w3-hover-grey w3-opacity-min w3-hover-opacity-off">Cancel</button></div>
      <div class="w3-half"><button onclick="document.getElementById('id01').style.display='none'" type="button" class="w3-button w3-block w3-red w3-padding-16 w3-hover-red w3-opacity-min w3-hover-opacity-off">Delete</button></div>
</div>
<br>
    </div>
...
<p>
<a target="_blank" href="tryit.asp?filename=tryhow_css_delete_modal" class="ws-btn">Try it Yourself &raquo;</a>
</p>
<hr>

<h2>How To Create a Delete Modal</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate htmlHigh">
    &lt;button onclick="document.getElementById('id01').style.display='block'"&gt;Open 
    Modal&lt;/button&gt;<br><br>&lt;div id="id01" class="modal"&gt;<br>&nbsp; &lt;span 
    onclick="document.getElementById('id01').style.display='none'" class="close" 
    title="Close Modal"&gt;&amp;times;&lt;/span&gt;<br>&nbsp; &lt;form class="modal-content" 
    action="/action_page.php"&gt;<br>&nbsp;&nbsp;&nbsp; &lt;div class="container"&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    &lt;h1&gt;Delete Account&lt;/h1&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;p&gt;Are you sure 
    you want to delete your account?&lt;/p&gt;<br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    &lt;div class="clearfix"&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;button 
    type="button"  
    class="cancelbtn"&gt;Cancel&lt;/button&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    &lt;button type="button" 
    class="deletebtn"&gt;Delete&lt;/button&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;/div&gt;<br>&nbsp;&nbsp;&nbsp; 
    &lt;/div&gt;<br>&nbsp; &lt;/form&gt;<br>&lt;/div&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  * {box-sizing: border-box}<br><br>/* Set a style for all buttons */<br>button 
  {<br>&nbsp; background-color: #04AA6D;<br>&nbsp; color: white;<br>&nbsp; 
  padding: 14px 20px;<br>&nbsp; margin: 8px 0;<br>&nbsp; border: none;<br>&nbsp; 
  cursor: pointer;<br>&nbsp; width: 100%;<br>&nbsp; opacity: 0.9;<br>}<br><br>
  button:hover {<br>&nbsp; opacity:1;<br>}<br><br>/* Float cancel and delete 
  buttons and add an equal width */<br>.cancelbtn, .deletebtn {<br>&nbsp; float: 
  left;<br>&nbsp; width: 50%;<br>}<br><br>/* Add a color to the cancel button */<br>
  .cancelbtn {<br>&nbsp; background-color: #ccc;<br>&nbsp; color: black;<br>}<br>
  <br>/* Add a color to the delete button */<br>.deletebtn {<br>&nbsp; 
  background-color: #f44336;<br>}<br><br>/* Add padding and center-align text to 
  the container */<br>.container {<br>&nbsp; padding: 16px;<br>&nbsp; 
  text-align: center;<br>}<br><br>/* The Modal (background) */<br>.modal {<br>&nbsp; 
  display: none; /* Hidden by default */<br>&nbsp; position: fixed; /* Stay in 
  place */<br>&nbsp; z-index: 1; /* Sit on top */<br>&nbsp; left: 0;<br>&nbsp; 
  top: 0;<br>&nbsp; width: 100%; /* Full width */<br>&nbsp; height: 100%; /* 
  Full height */<br>&nbsp; overflow: auto; /* Enable scroll if needed */<br>&nbsp; 
  background-color: #474e5d;<br>&nbsp; padding-top: 50px;<br>}<br><br>/* Modal 
  ...
  */<br>&nbsp; border: 1px solid #888;<br>&nbsp; width: 80%; /* Could be more or 
  less, depending on screen size */<br>}<br><br>/* Style the horizontal ruler */<br>
  hr {<br>&nbsp; border: 1px solid #f1f1f1;<br>&nbsp; margin-bottom: 25px;<br>}<br>
  <br>/* The Modal Close Button (x) */<br>.close {<br>&nbsp; position: absolute;<br>&nbsp; 
  right: 35px;<br>&nbsp; top: 15px;<br>&nbsp; font-size: 40px;<br>&nbsp; 
  font-weight: bold;<br>&nbsp; color: #f1f1f1;<br>}<br><br>.close:hover,<br>
  .close:focus {<br>&nbsp; color: #f44336;<br>&nbsp; cursor: pointer;<br>}<br>
  <br>/* Clear floats */<br>.clearfix::after {<br>&nbsp; content: "";<br>&nbsp; 
  clear: both;<br>&nbsp; display: table;<br>}<br><br>/* Change styles for cancel 
  button and delete button on extra small screens */<br>@media screen and 
  (max-width: 300px) {<br>&nbsp; .cancelbtn, .deletebtn {<br>&nbsp;&nbsp;&nbsp; 
  width: 100%;<br>&nbsp; }<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_delete_modal" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
