...
<html lang="en-US">
<head>
<title>How To Host a Static Website</title>
<meta charset="utf-8">
...
<h1>How To Host a Static Website</h1>
<div class="w3-clear nextprev">
<a class="w3-left ws-btn" href="howto_website_static.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_website.asp">Next &#10095;</a>
</div>

<div class="ws-info intro w3-panel">
<p>To host a static website, you need a web hosting provider.</p>
<p>W3Schools provides <a href="https://www.w3schools.com/spaces/" target="_blank">W3Schools Spaces</a> to host your static website.</p>
<p>With Spaces, you can easily host your website with a few clicks.</p>
<p>It allows you to make static sites with HTML, CSS, and JavaScript.</p>
</div>
<hr>

<h2>Hosting Made Easy</h2>
<p>W3Schools Spaces saves you time compared to traditional hosting.</p>
<p>You don't have to set up SSL certificates on your own.</p>
<p>Spaces are secure by default.</p>
<p>The complexity of hosting a website is hidden.</p>
<p>You can have your files up and running fast.</p>
<p>Edit the code directly in the browser!</p>
<hr>

<h2>Secure Website</h2>
<p>W3Schools handles the security for you.</p>
<p>Your Space runs on HTTPS protocol.</p>
<p>Each Space has an SSL certificate.</p>
<p>SSL certificate is a small file that secures your Space in more ways:</p>
<ul>
  <li>It keeps user data secure</li>
  <li>It prevents website attacks</li>
  <li>Encrypted website traffic</li>
  <li>Verifies website ownership</li>
</ul>
<p>Users are more likely to trust and visit a secure website.</p>
<div class="w3-panel ws-info">
  <p>The S in the HTTPS protocol stands for Secure.</p>
  <p>It makes your traffic encrypted and secure.</p>
</div>
<hr>
...
<p>The steps are explained in the follwing sections.</p>
<hr>

<h2>Create Your W3Schools Account</h2>
<p>To create an account, you need to <a href="https://profile.w3schools.com/signup">Sign up</a>.</p>
<p>Sign up with an email and a password.</p>
<img src="/images/spaces_signup.png" style="width:100%; max-width:1200px; height:auto" loading="lazy" alt="W3Spaces sign-up form image">
<p class="w3-small">W3Schools Spaces Signup Form</p>
<hr>

<h2>Create Your Space</h2>
<p>Make your account and head over to <a href="https://spaces.w3schools.com/" target="_blank">Spaces</a>.</p>
<p>There is a button named "Create a space" in the top right corner.</p>
<p>Clicking the button leads you to the space creation page.</p>
<img src="/images/spaces_templateornot.png" loading="lazy" style="width:100%; max-width:1200px; height:auto" alt="Create a space">
<p class="w3-small">Create a Space image</p>
<p>You can either start with a blank space or choose a <a href="https://www.w3schools.com/howto/howto_website_static.asp">template</a>.</p>
<p>Let's pick the blank space option and click "Continue".</p>
<hr>

<h2>Name Your Space</h2>
<p>Selecting the blank space option lets you name the space.</p>
<p>So give your space a cool name.</p>
<img src="/images/spaces_spacename.png" loading="lazy" style="width:100%; max-width:1200px; height:auto" alt="Create a space name">
<p class="w3-small">Naming your space image</p>
<div class="w3-panel ws-note">
  <p>Your Space name is a part of the Space URL.</p>
</div>
<p>Click the "Continue" button to move on.</p>
<hr>

<h2>Preview Your Spaces</h2>
<p>Choosing a name for your space takes you to the Spaces overview.</p>
<p>The overview is a summary of your Spaces.</p>
<p>Things you see in the summary are:</p>
<ul>
  <li>Space name</li>
  <li>Space URL</li>
  <li>Visitors number</li>
  <li>Data usage</li>
  <li>Storage usage</li>
  <li>Files number</li>
  <li>Additional actions button</li>
</ul>
<p>The Spaces summary help you see how much traffic you have per Space.</p>
<img src="/images/spaces_dashboard.png" loading="lazy" style="width:100%; max-width:1200px; height:auto" alt="Spaces summary">
<p class="w3-small">Spaces summary image</p>
<hr>

<h2>Upload Your Files</h2>
<p>To upload your files, first, you must open your Space file manager page.</p>
<p>You can upload your files by clicking on the "Upload files" button.</p>
<p>The "Upload files" button is found on the right side of the Spaces summary page.</p>
<img src="/images/spaces_filemanager.png" loading="lazy" style="width:100%; max-width:1200px; height:auto" alt="Space page">
<p class="w3-small">Spaces file manager image</p>
<p>You can create a new file with the "New file" button.</p>
<div class="w3-panel ws-info">
  <p>Note that the file for your home page must be named <strong>index.html</strong>.</p>
  <p>The file name <strong>index</strong> is what browsers will search for as your website starting page.</p>
</div>
<hr>

<h2>Preview Your Website</h2>
<p>Your space URL is a combination your Space name and <strong>w3spaces</strong> subdomain.</p>
<p>For example, if your Space is named <strong>jane-doe</strong>, your Space URL is <strong>jane-doe.w3spaces.com</strong>.</p>
<p>You can share your Space URL with others.</p>
<hr>

<h2>You Made It!</h2>
<p>Congratulations!</p>
<p>You successfully hosted your static website.</p>
<hr>

<div class="w3-panel ws-note"><p>Want to know how to make a website from scratch? Read our article on how to make a website from scratch.</p>
<a class="ws-btn ws-green" href="/howto/howto_make_a_website.asp">Start reading &raquo;</a>
</div>
<hr>
...
<div class="w3-center ws-black" style="color:white;margin-left:-32px;margin-right:-32px">
  <div style="opacity:0.96;margin:auto;padding:70px 20px;">
    ...
    <a href="/spaces/" class="ws-btn" target="_blank" style="border-radius:25px;font-size:22px;width:300px;padding: 11px 18px;margin-bottom:15px" title="Get Started With W3Spaces">Get Started for Free</a><br>
    <br>
