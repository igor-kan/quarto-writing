...
<button onclick="on()" class="w3-button ws-green">Turn on the overlay effect</button>
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_overlay" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_overlay_text" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>
