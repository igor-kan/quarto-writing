...
<a class="w3-left ws-btn" href="howto_js_collapse_sidebar.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_css_pagination.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a collapsible sidepanel menu.</p>
<hr>
<iframe src="tryhow_js_collapse_sidepanel.htm" style="background-color:white;border:3px solid #f1f1f1;width:100%;height:400px"></iframe>
<a target="_blank" href="tryit.asp?filename=tryhow_js_collapse_sidepanel" class="ws-btn w3-margin-top">Try it Yourself &raquo;</a>
...
*/<br>&nbsp;&nbsp;z-index: 1; /* Stay on top */<br>&nbsp;&nbsp;top: 0;<br>&nbsp;&nbsp;left: 0;<br>&nbsp;&nbsp;background-color: #111; /* Black*/<br>&nbsp;&nbsp;overflow-x: hidden; /* Disable horizontal scroll */<br>&nbsp;&nbsp;padding-top: 60px; /* Place content 60px from the top */<br>&nbsp;&nbsp;transition: 0.5s; /* 0.5 second transition effect to slide in the sidepanel */<br>
}<br><br>/* The sidepanel links */<br>.sidepanel a {<br>&nbsp;&nbsp;padding: 8px 8px 8px 32px;<br>&nbsp;&nbsp;text-decoration: none;<br>&nbsp;&nbsp;font-size: 25px;<br>&nbsp;&nbsp;color: #818181;<br>&nbsp;&nbsp;display: block;<br>&nbsp;&nbsp;transition: 0.3s;<br>}<br><br>/* When you mouse over the navigation links, 
...
font-size: 36px;<br>&nbsp; margin-left: 50px;<br>}<br><br>/* Style 
  the button that is used to open the sidepanel */<br>.openbtn {<br>&nbsp; font-size: 20px;<br>&nbsp; cursor: pointer;<br>&nbsp; background-color: #111;<br>&nbsp; 
