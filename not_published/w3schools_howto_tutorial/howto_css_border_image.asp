...
<h1>How TO - Add a Border to an Image</h1>
<div class="w3-clear nextprev">
<a class="w3-left ws-btn" href="howto_css_thumbnail.asp">&#10094; Previous</a>
  <a class="w3-right ws-btn" href="howto_css_team.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to add a border around an image.</p>
<hr>

<h2>Border Around an Image</h2>
<img src="img_nature.jpg" alt="Nature" style="width:150px;border: 6px solid green;">
<img src="img_snow.jpg" alt="Snow" style="width:150px;border: 6px solid #555;">
<hr>

<h2>How To Add a Border to an Image</h2>
<p>Use the <code class="w3-codespan">border</code> property to add a border to an &lt;img&gt; element:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  img {<br>&nbsp; border: 5px solid #555;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_border_image" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
