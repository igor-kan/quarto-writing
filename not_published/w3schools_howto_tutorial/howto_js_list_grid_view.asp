...
<a class="w3-left ws-btn" href="howto_js_expanding_grid.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_css_mixed_columns.asp">Next &#10095;</a>
</div>
<hr>
...
<div class="row">
  <div class="column" style="background-color:#aaa;color:#000;">
    <h2>Column 1</h2>
    <p>Some text..</p>
  </div>
  <div class="column" style="background-color:#bbb;color:#000;">
    <h2>Column 2</h2>
    <p>Some text..</p>
  </div>
</div>
<div class="row">
  <div class="column" style="background-color:#ccc;color:#000;">
    <h2>Column 3</h2>
    <p>Some text..</p>
  </div>
  <div class="column" style="background-color:#ddd;color:#000;">
    <h2>Column 4</h2>
    <p>Some text..</p>
  </div>
</div>
...
<br>
<a target="_blank" href="tryit.asp?filename=tryhow_js_list_grid_view" class="ws-btn">Try it Yourself &raquo;</a>
...
<div class="w3-code notranslate cssHigh">
  ...
  floats next to each other */<br>.column {<br>&nbsp;&nbsp;float: left;<br>&nbsp;&nbsp;width: 50%;<br>&nbsp;&nbsp;padding: 10px;<br>}<br><br>/* Clear floats after the columns */<br>.row:after 
  {<br>&nbsp; content: &quot;&quot;;<br>&nbsp;&nbsp;display: table;<br>&nbsp;&nbsp;clear: both;<br>}</div>
</div>
...
<a target="_blank" href="tryit.asp?filename=tryhow_js_list_grid_view" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
