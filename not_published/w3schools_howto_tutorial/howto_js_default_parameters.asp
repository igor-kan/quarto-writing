...
<html lang="en-US">
<head>
<title>How To Set Default Parameter Values for JavaScript Functions</title>
<meta charset="utf-8">
...
<h1>How TO - Set Default Parameters</h1>
<div class="w3-clear nextprev">
<a class="w3-left ws-btn" href="howto_js_exponentiation.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_js_random_number_two_nums.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to set default parameter values for JavaScript functions.</p>
<hr>

<h2>Default Parameters</h2>
<p>If a function in JavaScript is called with <strong>missing arguments</strong> (less than declared), the missing values are set to
...
<a class="ws-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_js_default_parameters" target="_blank">Try it Yourself &raquo;</a>
</div>
<p><a href="/js/js_es6.asp">ECMAScript 2015</a> allows default parameter values in the function 
declaration:

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
function myFunction (x, y = 2) {<br>&nbsp; // function code<br>}
</div>
<a class="ws-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_js_default_parameters2" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="ws-note w3-panel">
<p>Read more about functions in our <a href="/js/js_function_definition.asp">JavaScript Function Tutorial</a>.</p>
</div>
