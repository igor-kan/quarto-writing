...
<a class="w3-left ws-btn" href="howto_css_column_cards.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_css_blog_layout.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a responsive zig zag (alternating) layout with CSS.</p>
<hr>
<iframe src="tryhow_css_zig_zag_layout.htm" style="background-color:white;width:100%;xpadding:5px 10px;border:1px solid #ddd;height:400px;"></iframe>
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_zig_zag_layout&stacked=h" class="ws-btn">Try it Yourself &raquo;</a></p>
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_zig_zag_layout&stacked=h" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
