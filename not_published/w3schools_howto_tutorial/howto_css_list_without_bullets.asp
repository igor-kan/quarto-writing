...
<html lang="en-US">
<head>
<title>How To Create an Unordered List Without Bullets</title>
<meta charset="utf-8">
...
<h1>How TO - List Without Bullets</h1>
<div class="w3-clear nextprev">
<a class="w3-left ws-btn" href="howto_css_list_group_badges.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_css_responsive_text.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how create an unordered list without bullets, using CSS.</p>
<hr>

<h2>How To Create a List Without Bullets</h2>
<p>The <code class="w3-codespan">list-style-type:none</code> property can be 
used to remove the default markers/bullets in a list. Note that the list also has default margin 
and padding. To remove this as well, add <code class="w3-codespan">margin:0</code> and <code class="w3-codespan">padding:0</code> to &lt;ul&gt;:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  ul.no-bullets {<br>&nbsp; list-style-type: none; /* Remove bullets */<br>&nbsp; padding: 
  0; /* Remove padding */<br>&nbsp; margin: 0; /* Remove margins */<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_list_without_bullets" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
