...
<div class="w3-clear nextprev">
  <a class="w3-left ws-btn" href="howto_js_read_more.asp">&#10094; Previous</a>
  <a class="w3-right ws-btn" href="howto_css_download_button.asp">Next &#10095;</a>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  ...
  background-color: #04AA6D; /* Green background */<br>&nbsp; 
  border: none; /* Remove borders */<br>&nbsp; color: white; /* 
  White text */<br>&nbsp; padding: 12px 16px; /* Some padding */<br>&nbsp;&nbsp;font-size: 16px /* Set a font size */<br>
  }</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_loading_buttons" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
