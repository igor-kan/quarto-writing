...
<html lang="en-US">
<head>
<title>How To Make a Business Website</title>
<meta charset="utf-8">
...
<h1>How To Make a Business website</h1>
<div class="w3-clear nextprev">
<a class="w3-left ws-btn" href="howto_website_restaurant.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_make_a_webbook.asp">Next &#10095;</a>
</div>


    <div class="ws-info intro w3-panel">
      <p>A website is essential to the business brand.</p>
      <p>It can help you to generate leads.</p> 
      <p>It communicates information about the company and its services.</p>
      <p>Having a website is relevant for all businesses - start building yours today!</p>
      <a class="ws-btn" href="https://www.w3spaces.com" target="_blank">Create a business website for free &raquo;</a>
    </div>
    <hr>
    <h2>Why make a business website</h2>
      <p>The website gives credibility to the business.</p>
      <p>It is a good way of showing your business to potential clients and others.</p>
      <p>In addition, to keep people updated on your company news.</p>
      <p>The site can explain what your business is about.</p>
    <div class="w3-panel ws-note">
      <p>The business website will help you connect with people interested in your business. Make sure that it appears in a good and presentable way!</p>
    </div>
    <hr>
    <h2>What do I need to know to create my business website?</h2>
    <p>HTML, CSS, and JavaScript are the basic languages to create a website.</p>
    <p>It is all you need to make your business website.</p>
    <ol>
    ...
    <div class="w3-panel ws-info">
      <p>We have made many templates ready for you to use.</p>
      <p>Load the templates in <strong>W3Schools Spaces</strong>. Get started with building a website for your business in a few clicks.</p>
      <a class="ws-btn ws-green w3-white" href="/spaces/" target="_blank">Get started &raquo;</a>
      <p class="w3-small"><em>* no credit card required</em></p>
    </div>
    <hr>

    <h2>How do I get started</h2>
    <p>There are two ways to start building a business website.</p> 
    <p>Building from scratch or using a template.</p>
    <hr>
    <h2>Building a business webpage from scratch</h2>
    <p>A business website can have many different kinds of sections.</p>
    <p>There are a few important sections of the business website, summarized below:</p>
    <div class="w3-container w3-padding ws-light-green w3-section">
      <div>
        <p><strong>1. Hero.</strong></p>
        <p>The hero section is the first thing people see when they enter your business website.</p>
        <p>It is displayed under the menu.</p>
        <p>The hero section helps the reader understand what you offer, why someone should work with you, and the value you provide with your services.</p>
        <p>It often contains a call to action button like "get in touch", "explore services" or similar..</p>
      </div>
      <img src="https://businesswebsites.w3spaces.com/bilder/hero.png" loading="lazy" alt="hero section" style="width:700px;max-width:100%;">
    </div>
    <div class="w3-container w3-padding ws-light-green w3-section">
      <div>
        <p><strong>2. About Us section.</strong></p>
        <p>Give the reader a summary of your business.</p>
        <p>Include subjects such as your history, experience, what makes you stand out from others.</p>
        <p>Keep the text short.</p>
        <p>Structure the information in a way that is easy to read and understand.</p>
      </div>
      <img src="https://businesswebsites.w3spaces.com/bilder/about-us.png" loading="lazy" alt="about-us section" style="width:700px;max-width:100%;">
    </div>
    <div class="w3-container w3-padding ws-light-green w3-section">
      <div>
        <p><strong>3. Services section.</strong></p>
        <p>List the services that your business offer.</p>
        <p>Make sure that the services are well explained and understandable to the website visitors.</p>
      </div>
      <img src="https://businesswebsites.w3spaces.com/bilder/services.png" loading="lazy" alt="services section" style="width:700px;max-width:100%;">
    </div>
    <div class="w3-container w3-padding ws-light-green w3-section">
      <div>
        <p><strong>4. Contact section.</strong></p>
        <p>It contains contact information such as email address and phone number </p>
        <p>It can also have a contact form, location, business hours, links to social networks, etc.</p>
      </div>
      <img src="https://businesswebsites.w3spaces.com/bilder/contact.png" loading="lazy" alt="contact section" style="width:700px;max-width:100%;">
    </div>
    <div class="w3-container w3-padding ws-light-green w3-section">
      <div>
        <p><strong>5. Privacy policy section.</strong></p>
        <p>The privacy policy lets a visitor to your website know what you will do with their data.</p>
        <p>It is a must for every website that collects data.</p>
        <p>It explains how information is collected, how will it be used, is the data shared with 3rd parties, and how can a visitor access her personal information</p>
      </div>
      <img src="https://businesswebsites.w3spaces.com/bilder/privacy.png" loading="lazy" alt="contact section" style="width:700px;max-width:100%;">
    </div> 

    <h3>A business website can also contain either following sections:</h3>
    <ul>
...
<hr>
    ...
    <p>Starting with templates is a good way to get inspired and to learn.</p>
    <p>We have ready-made templates that you can use. Here are some examples:</p>
    <div class="w3-panel ws-info">
      <p>There are business website templates available in W3Schools Spaces. They can be loaded directly into the service.</p>
      <p>You can load the business website template in <strong>W3Schools Spaces</strong>. So get started with building a business website in a few clicks!</p>
      <a class="ws-btn ws-green w3-white" href="/spaces/" target="_blank">Get started &raquo;</a>
      <p class="w3-small"><em>* no credit card required</em></p>
    </div>
    <div class="w3-panel ws-yellow w3-padding-16 w3-card">
      <h3 class="w3-center">Business Consulting</h3>
      <div class="w3-content" style="max-width:800px">
        <a href="tryw3css_templates_marketing.htm" target="_blank" title="Business Demo"><img src="marketing.png" style="width:98%;margin:20px 0" alt="Business Template" loading="lazy"></a><br>
        <div class="w3-row">
          <div class="w3-col m6">
            <a href="tryw3css_templates_marketing.htm" target="_blank" class="ws-btn w3-padding-large w3-black" style="width:98.5%">Demo</a>
          </div>
          <div class="w3-col m6">
    ...
    <div class="w3-panel ws-yellow w3-padding-16 w3-card">
      <h3 class="w3-center">Business Startup</h3>
      <div class="w3-content" style="max-width:800px">
        <a href="tryw3css_templates_startup.htm" target="_blank" title="Business Demo"><img src="startup.png" style="width:98%;margin:20px 0" alt="Business Template" loading="lazy"></a><br>
        <div class="w3-row">
          <div class="w3-col m6">
            <a href="tryw3css_templates_startup.htm" target="_blank" class="ws-btn w3-padding-large w3-black" style="width:98.5%">Demo</a>
          </div>
          <div class="w3-col m6">
            <a href="tryit.asp?filename=tryw3css_templates_startup&amp;stacked=h" target="_blank" class="ws-btn w3-padding-large w3-dark-grey" style="width:98.5%">Try it Yourself</a>
          </div>
        </div>
      </div>
    </div> 
