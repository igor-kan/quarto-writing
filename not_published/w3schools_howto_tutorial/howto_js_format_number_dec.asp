...
<html lang="en-US">
<head>
<title>How To Format a Number with Two Decimals</title>
<meta charset="utf-8">
...
<h1>How TO - Format a Number with Two Decimals</h1>
<div class="w3-clear nextprev">
  <a class="w3-left ws-btn" href="howto_js_redirect_webpage.asp">&#10094; Previous</a>
  <a class="w3-right ws-btn" href="howto_css_zoom_hover.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to format a number with two decimals in JavaScript.</p>
<hr>
<h2>Format a Number with Two Decimals</h2>
<p>You can use the <code class="w3-codespan">toFixed()</code> method to format a 
number to only show two decimals. Note that the result is rounded (shows 5.57 instead of 5.56):</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
  let num = 5.56789;<br>let n = num.toFixed(2);&nbsp; // 5.57<br>
</div>
<a class="ws-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_js_format_number_dec" target="_blank">Try it Yourself &raquo;</a>
</div>

<p>If you want to display three decimals, just change the number to 3:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
  let num = 5.56789;<br>let n = num.toFixed(3);&nbsp; // 5.568<br>
</div>
<a class="ws-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_js_format_number_dec2" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>

<p><strong>Tip:</strong> Learn more about the <a href="/jsref/jsref_tofixed.asp">toFixed()</a> method in our JavaScript Reference.</p>
