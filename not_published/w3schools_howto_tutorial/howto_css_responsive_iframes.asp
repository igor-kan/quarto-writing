...
<html lang="en-US">
<head>
<title>How To Create Responsive Iframes</title>
<meta charset="utf-8">
...
<h1>How TO - Responsive Iframe</h1>
<div class="w3-clear nextprev">
<a class="w3-left ws-btn" href="howto_css_aspect_ratio.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_js_toggle_like.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create responsive iframes with CSS.</p>
<hr>

<h2>Responsive Iframes</h2>
<p>Create an iframe that will keep the aspect ratio (4:3, 16:9, etc.) when resized:</p>
...
television, and for YouTube videos).</p>
</div>
<hr>

<h2>How To - Responsive Iframes</h2>
<h5>Step 1) Add HTML:</h5>
<p>Use a container element, like &lt;div&gt;, and add the iframe inside of it:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;div class=&quot;container&quot;&gt; <br>&nbsp; &lt;iframe 
  class=&quot;responsive-iframe&quot; 
  src=&quot;https://www.youtube.com/embed/tgbNymZ7vqY&quot;&gt;&lt;/iframe&gt;<br>&lt;/div&gt;</div>
</div>
<hr>
...
<p>Add a percentage value for <code class="w3-codespan">padding-top</code> to 
maintain the aspect ratio of the container DIV. The following example will create an 
aspect ratio of 16:9, which is the default aspect ratio of YouTube videos.</p>

<div class="w3-example">
<h3>Example 16:9 Aspect Ratio</h3>
<div class="w3-code notranslate cssHigh">
  .container {<br>&nbsp; position: relative;<br>&nbsp; overflow: hidden;<br>&nbsp;&nbsp;width: 100%;<br>
  &nbsp; padding-top: 56.25%; /* <strong>16:9 Aspect 
Ratio (divide 9 by 16 = 0.5625)</strong> */<br>}<br><br>/* Then style the iframe to fit in the container 
  div with full height and width */<br>.responsive-iframe {<br>&nbsp; 
position: absolute;<br>&nbsp; top: 0;<br>&nbsp;&nbsp;left: 0;<br>&nbsp;&nbsp;bottom: 0;<br>&nbsp;&nbsp;right: 0;<br>&nbsp; 
  width: 100%;<br>&nbsp; height: 100%;<br>
}<br></div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_responsive_iframe_169" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_responsive_iframe_43" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
3:2 Aspect 
Ratio</strong> */<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_responsive_iframe_32" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
8:5 Aspect 
Ratio</strong> */<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_responsive_iframe_85" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example 1:1 Aspect Ratio (Height and Width is Always Equal)</h3>
<div class="w3-code notranslate cssHigh">
.container {<br>&nbsp; padding-top: 100%; /* <strong>
1:1 Aspect 
Ratio</strong> */<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_responsive_iframe_11" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
