...
<html lang="en-US">
<head>
<title>How To Create a Cascading Dropdown</title>
<meta charset="utf-8">
...
<h1>How TO - Cascading Dropdown List</h1>
<div class="w3-clear nextprev">
  <a class="w3-left ws-btn" href="howto_js_dropdown.asp">&#10094; Previous</a>
  <a class="w3-right ws-btn" href="howto_css_dropdown_navbar.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a cascading dropdown list with JavaScript.</p>
<hr>

<iframe src="tryhow_js_cascading_dropdown.htm" class="w3-border w3-border-light-grey" style="background-color:white;width:100%;border:none;height:250px;padding:0"></iframe>
<a target="_blank" href="tryit.asp?filename=tryhow_js_cascading_dropdown" class="ws-btn w3-margin-top">Try it Yourself &raquo;</a>
<hr>

<h2>Create Three Dropdown Lists</h2>
<p>Create three dropdown lists, inside an HTML form.</p>
<p>The second and third dropdown list will display different options, depending 
on the value selected in the parent dropdown list.</p>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;form name=&quot;form1&quot; id=&quot;form1&quot; action=&quot;/action_page.php&quot;&gt;<br>&nbsp; Subjects: 
  &lt;select name=&quot;subject&quot; id=&quot;subject&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;option value=&quot;&quot; 
  selected=&quot;selected&quot;&gt;Select subject&lt;/option&gt;<br>&nbsp; &lt;/select&gt;<br>&nbsp; &lt;br&gt;&lt;br&gt;<br>&nbsp; 
  Topics: &lt;select name=&quot;topic&quot; id=&quot;topic&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;option 
  value=&quot;&quot; selected=&quot;selected&quot;&gt;Please select subject first&lt;/option&gt;<br>&nbsp; 
  &lt;/select&gt;<br>&nbsp; &lt;br&gt;&lt;br&gt;<br>&nbsp; Chapters: &lt;select name=&quot;chapter&quot; id=&quot;chapter&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;option value=&quot;&quot; selected=&quot;selected&quot;&gt;Please select topic first&lt;/option&gt;<br>&nbsp; 
  &lt;/select&gt;<br>&nbsp; &lt;br&gt;&lt;br&gt;<br>&nbsp; &lt;input type=&quot;submit&quot; value=&quot;Submit&quot;&gt;
  <br>&lt;/form&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate jsHigh">
  var subjectObject = {<br>&nbsp; &quot;Front-end&quot;: {<br>&nbsp;&nbsp;&nbsp; 
  &quot;HTML&quot;: [&quot;Links&quot;, &quot;Images&quot;, &quot;Tables&quot;, &quot;Lists&quot;],<br>&nbsp;&nbsp;&nbsp; &quot;CSS&quot;: 
  [&quot;Borders&quot;, &quot;Margins&quot;, &quot;Backgrounds&quot;, &quot;Float&quot;],<br>&nbsp;&nbsp;&nbsp; 
  &quot;JavaScript&quot;: [&quot;Variables&quot;, &quot;Operators&quot;, &quot;Functions&quot;, &quot;Conditions&quot;] <br>&nbsp; 
  },<br>&nbsp; &quot;Back-end&quot;: {<br>&nbsp;&nbsp;&nbsp; &quot;PHP&quot;: [&quot;Variables&quot;, 
  &quot;Strings&quot;, &quot;Arrays&quot;],<br>&nbsp;&nbsp;&nbsp; &quot;SQL&quot;: [&quot;SELECT&quot;, &quot;UPDATE&quot;, 
  &quot;DELETE&quot;]<br>&nbsp; }<br>}<br>window.onload = function() {<br>&nbsp; 
  var subjectSel = document.getElementById(&quot;subject&quot;);<br>&nbsp; var topicSel 
  = document.getElementById(&quot;topic&quot;);<br>&nbsp; var chapterSel = 
  document.getElementById(&quot;chapter&quot;);<br>&nbsp; for (var x in subjectObject) 
  {<br>&nbsp;&nbsp;&nbsp; subjectSel.options[subjectSel.options.length] = new 
  Option(x, x);<br>&nbsp; }<br>&nbsp; subjectSel.onchange = function() {<br>&nbsp;&nbsp;&nbsp; 
  //empty Chapters- and Topics- dropdowns<br>&nbsp;&nbsp;&nbsp; chapterSel.length = 
  1;<br>&nbsp;&nbsp;&nbsp; topicSel.length = 1;<br>&nbsp;&nbsp;&nbsp; //display correct values <br>&nbsp;&nbsp;&nbsp; for (var y in subjectObject[this.value]) 
  {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; topicSel.options[topicSel.options.length] 
  = new Option(y, y);<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp; }<br>&nbsp; 
  topicSel.onchange = function() {<br>&nbsp;&nbsp;&nbsp; //empty Chapters 
  dropdown<br>&nbsp;&nbsp;&nbsp; chapterSel.length = 1;<br>&nbsp;&nbsp;&nbsp; //display correct values<br>&nbsp;&nbsp;&nbsp; var z = subjectObject[subjectSel.value][this.value];<br>&nbsp;&nbsp;&nbsp; 
  for (var i = 0; i &lt; z.length; i++) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  chapterSel.options[chapterSel.options.length] = new Option(z[i], z[i]);<br>&nbsp;&nbsp;&nbsp; 
  }<br>&nbsp; }<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_cascading_dropdown" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
