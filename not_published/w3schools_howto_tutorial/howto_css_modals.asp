...
<a class="w3-left ws-btn" href="howto_css_fullscreen_video.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_css_delete_modal.asp">Next &#10095;</a>
</div>
<hr>
...
<button onclick="document.getElementById('id01').style.display='block'" class="ws-btn w3-dark-grey" style="font-size:17px;padding:12px 35px">Open Modal</button>
...
<p></p>
<a target="_blank" href="tryit.asp?filename=tryhow_css_modal" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
<hr>
...
Enable scroll if needed */<br>&nbsp;&nbsp;background-color: rgb(0,0,0); /* Fallback color */<br>&nbsp;&nbsp;background-color: rgba(0,0,0,0.4); 
/* Black w/ opacity */<br>
}<br>
<br>/* Modal Content/Box */<br>.modal-content {<br>&nbsp;&nbsp;background-color: #fefefe;<br>
  &nbsp; margin: 15% auto; /* 15% 
...
.close:hover,<br>
.close:focus {<br>&nbsp; color: black;<br>&nbsp;&nbsp;text-decoration: none;<br>&nbsp;&nbsp;cursor: pointer;<br>}</div>
</div>
<!--
<h3>Example Explained</h3>
...
if (event.target == modal) {<br>&nbsp;&nbsp;&nbsp;&nbsp;modal.style.display = "none";<br>
  &nbsp; }<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_modal" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
.modal-body {padding: 2px 16px;}<br><br>/* Modal Footer */<br>.modal-footer {<br>
  &nbsp; 
padding: 2px 16px;<br>&nbsp; background-color: #5cb85c;<br>&nbsp;&nbsp;color: white;<br>}<br><br>/* Modal Content */<br>.modal-content {<br>&nbsp;&nbsp;position: relative;<br>&nbsp;&nbsp;background-color: #fefefe;<br>&nbsp;&nbsp;margin: auto;<br>&nbsp;&nbsp;padding: 0;<br>&nbsp;&nbsp;border: 1px solid #888;<br>&nbsp;&nbsp;width: 80%;<br>&nbsp;&nbsp;box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2),0 6px 20px 0 rgba(0,0,0,0.19);<br>&nbsp;&nbsp;animation-name: animatetop;<br>&nbsp;&nbsp;animation-duration: 0.4s<br>}<br><br>/* Add Animation */<br>@keyframes animatetop {<br>&nbsp;&nbsp;from {top: -300px; opacity: 0}<br>
  &nbsp; to {top: 0; opacity: 1}<br>
}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_modal2" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_modal_bottom" class="ws-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
