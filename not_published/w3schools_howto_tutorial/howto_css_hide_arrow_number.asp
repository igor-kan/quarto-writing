...
<html lang="en-US">
<head>
<title>How To Hide Arrows From Number Input</title>
<meta charset="utf-8">
...
<h1>How TO - Hide Arrows From Input Number</h1>
<div class="w3-clear nextprev">
  <a class="w3-left ws-btn" href="howto_html_clear_input.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_js_copy_clipboard.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to remove arrows/spinners from input type number with CSS.</p>
<hr>

<p><strong>Try to hover over both number inputs to see the difference:</strong></p>
<div class="w3-row-padding w3-light-grey w3-padding-16" style="padding-bottom:32px!important">
<div class="w3-half">
<p>Hidden arrows:</p>
<input class="x" type="number" value="5">
</div>
<div class="w3-half">
<p>Default:</p>
...
<p><strong>Notes on functionality:</strong> It is still possible to increment the number when you scroll inside the number input.</p>

<hr>

<h2>Remove Arrows/Spinners</h2>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  /* Chrome, Safari, Edge, Opera */<br>input::-webkit-outer-spin-button,<br>
  input::-webkit-inner-spin-button {<br>&nbsp; -webkit-appearance: none;<br>&nbsp; margin: 0;<br>
  }<br><br>/* Firefox */<br>input[type=number] {<br>&nbsp; -moz-appearance: textfield;<br>
  }<br></div>
 <a class="ws-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_css_hide_arrow_number" target="_blank">Try it Yourself &raquo;</a>
</div>
<p><strong>Tip:</strong> Go to our <a href="/html/html_forms.asp">HTML Form Tutorial</a> to learn 
more about HTML Forms.</p>
<p><strong>Tip:</strong> Go to our <a href="/tags/att_input_type_number.asp">HTML input type="number" reference</a> to learn 
more about inputs with type="number".</p>
