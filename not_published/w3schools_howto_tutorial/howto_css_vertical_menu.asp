...
<a class="w3-left ws-btn" href="howto_css_menu_horizontal_scroll.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_css_bottom_nav.asp">Next &#10095;</a>
</div>
<hr>
...
<a href="javascript:void(0)" class="w3-bar-item w3-button ws-green ws-hover-green">Home</a>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_vertical_menu" class="ws-btn">Try it Yourself &raquo;</a></p>
...
<div class="w3-code notranslate cssHigh">
  ...
  each other */<br>&nbsp;&nbsp;padding: 12px; /* Add some padding */<br>&nbsp;&nbsp;text-decoration: none; /* Remove underline from links */<br>}<br><br>.vertical-menu a:hover 
  {<br>&nbsp; background-color: #ccc; /* 
  Dark grey background on mouse-over */<br>}<br><br>.vertical-menu a.active {<br>&nbsp;&nbsp;background-color: #04AA6D; /* Add a green color to the &quot;active/current&quot; link 
  */<br>&nbsp;&nbsp;color: white;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_vertical_menu" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_vertical_menu_scroll" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
