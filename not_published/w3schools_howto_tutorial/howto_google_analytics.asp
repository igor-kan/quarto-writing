...
<a class="w3-left ws-btn" href="howto_google_fonts_pairings.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_js_weight_converter.asp">Next &#10095;</a>
</div>

<div class="ws-info intro w3-panel">
<p>Google Analytics is used to view and understand web traffic.</p>
<p>It is free and easy to use.</p>
<p>You can customize it for many use cases.</p>
<p>It works out of the box.</p>
<p>It is fast to set up. Get your insights today!</p>
</div>
<hr>

<div class="w3-panel ws-note">
    <p>Skip reading about Google Analytics. Take me directly to the first step. <span><a href="#step-1">Go to the first step</a></span></p>
</div>

<h2>What is Google Analytics</h2>
<p>Google Analytics is a web analytics solution.</p>
<p>It is developed and supported by Google.</p>
<p>The newest version is called Google Analytics 4.</p>
<p>It can be used to view data such as audience, page views, sessions and, demographics, and events.</p>

<h2>Why enable Google Analytics</h2>
<p>Understand your web traffic to make better decisions.</p>
<p>Understand and improve the sales funnel.</p>
<p>Learn from experimenting (for example, a/b tests).</p>


<div class="w3-panel ws-note">
    <p>Google has another solution called Google Optimize. This solution is made for testing.</p>
</div>
<hr>

<h2>Who is Google Analytics for</h2>
<p>Google Analytics is useful for anyone who has a website.</p>
<p>It gives you information about who uses your site and how they interact with it.</p>
<p>In addition, interface is easy to understand.</p>
<p>You do not need an analytics background to use and navigate the service.</p>
<hr>


<h2>How to set up Google Analytics step-by-step</h2>
<p>Google Analytics can be set up in two ways <strong>The Global Website Tag (gtag.js)</strong> or <strong>Google Tag Manager</strong>.</p>
<p>The easiest way is to use The Global Website Tag.</p>
<p>This tutorial will use the The Global Website Tag approach.</p>
<hr>
...
<a class="ws-btn ws-black w3-white" href="/spaces/" target="_blank">Start for free &#10095;</a>
</div>
<p>Create your <strong>index.html</strong> file so that you are ready to enter the code.</p>
<p><strong>All setup. Let's go!</strong></p>
<hr>

<h2>Set up Google Analytics: The Global Website Tag</h2>
<hr>

<h2 id="step-1">Step 1: Create a Google Analytics account</h2>
<p>Go to Analytics: <span><a href="https://google.com/analytics" target="_blank">Create an account or sign in to Analytics</a></span></p>
<p>The link in the paragraph above takes you to the Google Analytics landing page.</p>
<p>Click the "Start for free" button.</p>
<img src="Landingpage_Google_Analyitcs.png" style="width:100%; max-width:700px; height:auto" loading="lazy" alt="landing page">
<hr>
...
<h2>Step 2: Enter the welcome page</h2>
<p>After creating an account or signing in, you are welcomed to the solution.</p>
<p>Press the "Start measuring" button to proceed.</p>
<img src="welcome_to_analytics.png" style="width:100%; max-width:700px; height:auto" loading="lazy" alt="Welcome page">
<hr>

<h2>Step 3: Account setup</h2>
<p>You have two decisions to make here.</p>
<ol>
    <li>Enter your account name.</li>
    <li>Decide what data you want to share.</li>
    <li>Click the "Next" button.</li>
</ol>
<div class="ws-note w3-panel">
    <p>One account can have more than one tracking ID. You can track more than one website with an account.</p>
</div>
<img src="account_setup.png" style="width:100%; max-width:700px; height:auto" loading="lazy" alt="Account setup overview">
<hr>

<h2>Step 4: Property setup</h2>
<div class="ws-info w3-panel">
    <p>Property is the service you measure, such as a website, application, link tree, etc.</p>
</div>
<ol>
    <li>Enter a property name.</li>
    <li>Enter your time zone.</li>
    <li>Enter the currency that you use.</li>
    <li>Click the "Next" button.</li>
</ol>
<img src="property_setup.png" style="width:100%; max-width:700px; height:auto" loading="lazy" alt="Property setup overview">
<hr>


<h2>Step 5: Add business information</h2>
<p>Analytics uses the information to tailor your experience.</p>
<ol>
    <li>Select your industry category.</li>
    <li>Select business size.</li>
    <li>Tick the boxes for how you are planning to use Analytics.</li>
    <li>Click the "Create" button to proceed.</li>
</ol>
<img src="business_information.png" style="width:100%; max-width:700px; height:auto" loading="lazy" alt="Business information details">
<hr>

<h2>Step 6: Terms of Service Agreement</h2>
<p>Read and understand the terms of service.</p>
<p>Tick the GDPR box and click the "I accept" button if you agree.</p>
<img src="terms.png" style="width:100%; max-width:700px; height:auto" loading="lazy" alt="Terms and conditions overview">
<hr>

<h2>Step 7: Email subscriptions</h2>
<ol>
    <li>Tick or uncheck all boxes.</li>
    <li>Click the "Save" button to continue.</li>
</ol>
<img src="email_com.png" style="width:100%; max-width:700px; height:auto" loading="lazy" alt="Email communication overview">
<hr>

<h2>Step 8: Select platform</h2>
<p>Chose the platform where you are collecting data.</p>
<p>Then, click the relevant platform to continue.</p>
<div class="ws-info w3-panel">
<p>We are continuing with "Web" as the example in this tutorial.</p>
</div>
<img src="setup_datastream.png" style="width:100%; max-width:700px; height:auto" loading="lazy" alt="Select platform overview">
<hr>

<h2>Step 9: Data stream setup</h2>
<p>Enter data stream details.</p>
<ol>
    <li>The URL to your site.</li>
    <li>The name that you want to give the stream.</li>
    <li>Decide if you are to enable enhanced measurement or not.</li>
    <li>Click on the "Create stream" button to continue.</li>
    <div class="ws-info w3-panel">
        <p>The enhanced measurement can give the data more context. Improving your understanding of the traffic.</p>
    </div>
<img src="setup_datastream2.png" style="width:100%; max-width:700px; height:auto" loading="lazy" alt="Data stream setup overview">
<hr>

<h2>Step 10: Web stream overview</h2>
<p>Here you can see a detailed overview of the web stream.</p>
<img src="web_stream_details.png" style="width:100%; max-width:700px; height:auto" loading="lazy" alt="Web stream details overivew">
<p><strong>Here are the key takeaways from the overview.</strong></p>

<div class="w3-container w3-padding ws-light-green w3-section">
<div><p><span><strong>1. Stream URL.</strong></span></p>
<p>The Stream URL is the link to the connected site.</p>
</div>
<img src="stream_url.png" style="width:100%; max-width:700px; height:auto" alt="stream URL" loading="lazy">
</div>

<div class="w3-container w3-padding ws-light-green w3-section">
<div><p><span><strong>2. Measurement ID</strong></span></p>
<p>The Measurement ID is the identifier for your data stream.</p>
<p>It has a format of G-XXXXXXX.</p>
</div>
<img src="measurement_id.png" alt="measurement ID" style="width:100%; max-width:700px; height:auto" loading="lazy">
</div>
<div class="w3-panel ws-note">
    <p>Google Analytics 4 uses Measurement ID. Older versions use Tracking ID. You can not have both.</p>
    </div>

<div class="w3-container w3-padding ws-light-green w3-section">
<div><p><span><strong>3. Tagging instructions</strong></span></p>
<p>Decide to use <strong>Global site tag (gtag.js)</strong> or <strong>Tag manager</strong>.
<p>This tutorial will use the Global site tag.</p>
<p>Installing the Global site tag is the easiest and quickest way of getting it up and running.</p>
</div>
<img src="tagging_instructions.png" alt="tagging instructions" style="width:100%; max-width:700px; height:auto" loading="lazy">
</div>

<h2>Step 11: Global site tag (gtag.js)</h2>
<p>Click the "Global site tag (gtag.js)" row.</p>
<img src="global_site_tag.png" style="width:100%; max-width:700px; height:auto" loading="lazy" alt="Global site tag">
<p>Here you can see a code snippet.</p>
<p>The code snippet is a script to allow Google to measure data on your site.</p>
<p>You can see the Measurement ID in the second last line in the code snippet.</p>

<div class="w3-example">
<h3>The code snippet</h3>
<div class="w3-code notranslate htmlHigh">
&lt;!-- Global site tag (gtag.js) - Google Analytics --&gt;<br />
&lt;script async src=&quot;https://www.googletagmanager.com/gtag/js?id=G-DNJN1PF3CS&quot;&gt;&lt;/script&gt;<br />
&lt;script&gt;<br />
  window.dataLayer = window.dataLayer || [];<br />
  function gtag(){dataLayer.push(arguments);}<br />
  gtag('js', new Date());<br />
<br />
  gtag('config', 'G-XXXXXXX');<br />
&lt;/script&gt;
</div>
</div>
<hr>

<h2>Step 12: Enter the code snippet</h2>
<p>Copy the code snippet.</p>
<p>Make sure to include your Measurement ID.</p>
<p>Locate the &lt;head&gt; tag in your HTML.</p>
<p>Paste the code snippet just below the &lt;head&gt; tag.</p>
<p>Save and publish the code.</p>
<img src="add_codesnippet.png" style="width:100%; max-width:700px; height:auto" loading="lazy" alt="Add code snippet">
<div class="ws-note ws-info">
    <p>We used <span><a href="/spaces/" target="_blank">W3Schools Spaces</a></span> in this example.</p>
</div>
<hr>

<h2>Step 13: Test that it works</h2>
<p>Ensure that you have successfully saved and published the code snippet with the correct Measurement ID.</p>
<p>Open the URL for the site you have connected to the data stream.</p>
<p>Click on "Real time" on the menu to the left.</p>
<p>Confirm that you see yourself as an active user.</p>
<p><strong>Congrats. You have successfully enabled Google Analytics for your site!</strong></p>
<img src="realtime.png" style="width:100%; max-width:700px; height:auto" loading="lazy" alt="Analytics dashboard">
<hr>

<h2>Explore Google Analytics</h2>
<p>Recommended related topics are <strong>Tag manager</strong> and <strong>Events</strong></p>
<p>Spend time in the service to learn about your user activity, commerce, demographics, device, and referrals.</p>
<hr>

<div class="ws-note w3-panel" style="margin-top:24px">
<p><strong>Tip:</strong> Ever heard of W3Schools Spaces? It is a personal space where you can make a website from scratch or use a template.</p>
<p>It has everything you need in the browser.</p>
<p>Get started in a few clicks.</p>
  <a class="ws-btn" href="https://www.w3spaces.com" target="_blank" title="Get Started With W3Schools Spaces">Start now for free &#10095;</a>
