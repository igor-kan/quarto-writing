...
<a class="w3-left ws-btn" href="howto_css_style_header.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_css_two_columns.asp">Next &#10095;</a>
</div>
<hr>
...
<div class="w3-row-padding" style="margin:16px -16px 0 -16px">
  <div class="w3-col m6">
    <a href="tryhow_css_example_website.htm" target="_blank" class="ws-btn w3-padding-large w3-dark-grey w3-block">Demo</a>
  </div>
  <div class="w3-col m6">
    <a href="tryit.asp?filename=tryhow_css_example_website" target="_blank" class="ws-btn w3-padding-large w3-block">Try it Yourself</a>
  </div>
</div>
</div>
