...
<a class="w3-left ws-btn" href="howto_js_add_class.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_js_change_class.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to remove a class name from an element with JavaScript.</p>
<hr>
<button onclick="myFunction()" class="ws-btn w3-dark-grey w3-hover-black" style="box-shadow:none">Remove Class</button>

<div id="myDIV" class="mystylex">
...
<div class="w3-code notranslate cssHigh">
  ...
  25px;<br>&nbsp;&nbsp;background-color: coral;<br>&nbsp;&nbsp;color: white;<br>
  &nbsp; font-size: 25px;<br>}</div>
</div>
<hr>
...
<a target="_blank" href="tryit.asp?filename=tryhow_js_remove_class" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
