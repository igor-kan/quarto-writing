...
<a class="w3-left ws-btn" href="howto_css_force_scrollbars.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_css_contenteditable_border.asp">Next &#10095;</a>
</div>
<hr>
...
<div class="w3-row-padding" style="margin:16px -16px">
  <div class="w3-third">
    <a target="_blank" href="tryit.asp?filename=tryhow_css_device_smartphone" class="ws-btn w3-block w3-margin-bottom">Try Smartphone &raquo;</a>
  </div>
  
  <div class="w3-third">
    <a target="_blank" href="tryit.asp?filename=tryhow_css_device_tablet&stacked=h" class="ws-btn w3-block w3-margin-bottom">Try Tablet &raquo;</a>
  </div>
  <div class="w3-third">
    <a target="_blank" href="tryit.asp?filename=tryhow_css_device_laptop&stacked=h" class="ws-btn w3-block w3-margin-bottom">Try Laptop &raquo;</a>
  </div>
</div>
