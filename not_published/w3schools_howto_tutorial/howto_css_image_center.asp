...
<a class="w3-right ws-btn" href="howto_css_thumbnail.asp">Next &#10095;</a>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  ...
  width: 50%;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_image_center" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
<p>Note that it cannot be centered if the width is set to 100% (full-width).</p>
</div>
