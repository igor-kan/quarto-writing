...
<html lang="en-US">
<head>
<title>How To Create a Split Navigation Bar</title>
<meta charset="utf-8">
...
<h1>How TO - Split Navigation</h1>
<div class="w3-clear nextprev">
  <a class="w3-left ws-btn" href="howto_js_topnav_responsive.asp">&#10094; Previous</a>
  <a class="w3-right ws-btn" href="howto_css_navbar_icon.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a "split navigation" bar with CSS.</p>
<hr>
...
<ul id="myUl" class="topnav2">
  ...
  <li class="w3-hide-small"><a href="javascript:void(0);">Contact</a></li>
  <li class="right"><a href="javascript:void(0);">Help</a></li>
</ul>
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_topnav_split" class="ws-btn">Try it Yourself &raquo;</a></p>

<hr style="clear:both;">
<h2>Create A Split Navigation Bar</h2>
...
&lt;a href=&quot;#about&quot; class=&quot;split&quot;&gt;Help&lt;/a&gt;<br>&lt;/div&gt;</div>
</div>
<hr>
...
/* 
  Create a top navigation bar with a black background color&nbsp; */<br>.topnav {<br>&nbsp;&nbsp;background-color: #333;<br>
...
Style the links inside the navigation bar */<br>.topnav a {<br>&nbsp; 
  ...
  &nbsp; 
  background-color: #ddd;<br>&nbsp; color: black;<br>}<br><br>/* Create a 
  right-aligned (split) link inside the navigation bar */<br>.topnav 
  a.split {<br>&nbsp; float: right;<br>&nbsp;&nbsp;background-color: #04AA6D;<br>&nbsp;&nbsp;color: white;<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_topnav_split" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
