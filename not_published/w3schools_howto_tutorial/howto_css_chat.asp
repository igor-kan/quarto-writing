...
<a class="w3-left ws-btn" href="howto_css_coming_soon.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_js_popup_chat.asp">Next &#10095;</a>
</div>
<hr>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_chat" class="ws-btn">Try it Yourself &raquo;</a></p>
<hr>
...
<div class="w3-code notranslate cssHigh">
  ...
  chat container */<br>.darker {<br>&nbsp;&nbsp;border-color: #ccc;<br>&nbsp;&nbsp;background-color: #ddd;<br>}<br><br>
  /* Clear floats */<br>.container::after {<br>&nbsp; content: &quot;&quot;;<br>&nbsp; 
  clear: both;<br>&nbsp; display: table;<br>}<br><br>/* Style images 
  */<br>.container img {<br>&nbsp; float: left;<br>&nbsp;&nbsp;max-width: 60px;<br>&nbsp;&nbsp;width: 100%;<br>&nbsp;&nbsp;margin-right: 20px;<br>&nbsp;&nbsp;border-radius: 50%;<br>}<br><br>/* 
  Style the right image */<br>.container img.right 
  {<br>&nbsp;&nbsp;float: right;<br>&nbsp;&nbsp;margin-left: 20px;<br>&nbsp;&nbsp;margin-right:0;<br>}<br><br>/* Style time text */<br>.time-right {<br>
  &nbsp; float: right;<br>&nbsp;&nbsp;color: 
  #aaa;<br>}<br><br>/* Style time text */<br>.time-left {<br>&nbsp;&nbsp;float: left;<br>&nbsp;&nbsp;color: #999;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_chat" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>
<div class="w3-clear nextprev">
<a class="w3-left ws-btn" href="howto_css_coming_soon.asp">&#10094; Previous</a>
