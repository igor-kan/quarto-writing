...
<html lang="en-US">
<head>
<title>How To Use JavaScript Exponentiation</title>
<meta charset="utf-8">
...
<h1>How TO - JavaScript Exponentiation (**)</h1>
<div class="w3-clear nextprev">
<a class="w3-left ws-btn" href="howto_js_string_length.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_js_default_parameters.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to use JavaScript Exponentiation (**).</p>
<hr>

<h2>Exponentiation Operator</h2>
<p>The exponentiation operator (<code class="w3-codespan">**</code>) raises the 
first operand to the power of the second operand:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
  let x = 5;<br>let z = x ** 2; // result is 25</div>
<a class="ws-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_js_exp" target="_blank">Try it Yourself &raquo;</a>
</div>
<p><code class="w3-codespan">x ** y</code> produces the same result as <code class="w3-codespan">Math.pow(x, y)</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
  let x = 5;<br>let z = Math.pow(x,2); // result is 25</div>
<a class="ws-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_js_exp_pow" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Exponentiation Assignment</h2>
<p>The exponentiation assignment operator (<code class="w3-codespan">**=</code>) raises the value of a variable to the power of the right operand.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
  let x = 5;<br>x **= 2; // result 25</div>
<a class="ws-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_js_exp_assign" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
<p>Read more about JavaScript Operators in our <a href="/js/js_operators.asp">JavaScript Operator Tutorial</a>.</p>
</div>
