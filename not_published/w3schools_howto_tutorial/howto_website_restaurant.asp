...
<html lang="en-US">
<head>
<title>How To Make a Restaurant Website</title>
<meta charset="utf-8">
...
<h1>How To Make a Restaurant website</h1>
<div class="w3-clear nextprev">
<a class="w3-left ws-btn" href="howto_website_create_resume.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_website_business.asp">Next &#10095;</a>
</div>


<div class="w3-panel ws-info intro">
<p>The restaurant website helps to build the brand.</p>
<p>It lets people find you online.</p>
<p>People look online for contact details such as phone number, address, and opening times.</p>
<p>Let your clients book their tables online today!</p>
<a class="ws-btn w3-round" href="/spaces/" target="_blank">Create a website &raquo;</a>
</div>

<h2>Why create a restaurant website</h2>
<p>Present the site in the way that you want to appear.</p>
<p>Clients can find you by search.</p>
<p>Online reservations make it easier for clients to book tables.</p>
<p>Takeaway orders.</p>
<p>Make online payments possible.</p>

<div class="ws-note w3-panel">
    <p>There are no limitations of what you can do when building the website on your own.</p>
    </div>
<hr>


<h2>What do I need to know to build a restaurant website</h2>
<p>HTML, CSS, and JavaScript are the basic languages to build any website.</p>
<p>It is easy to make use of a template and personalize it. 
<ol>
...
<div class="w3-panel ws-info">
    <p>Building a website is fun - try it!</p>
</div>
<hr>

<h2>How do I get started</h2>
<p>There are two ways to get started.</p>
<p>Build from <strong>scratch</strong> or using a <strong>template</strong>.</p>
<hr>

<h2>Building from scratch</h2>
<p>Read here for how to create a static website from scratch <span><a href="/howto/howto_make_a_website.asp" target="_blank">How to Create a Webpage</a></span></p>
<p>Once you have made the layout. Add the four essential sections listed below:</p>

<div class="w3-container w3-padding ws-light-green w3-section">
<div><p><strong>1. Hero section.</strong></p>
<p>The hero section is the first impression of your website.</p>
<p>It helps the reader to understand what your restaurant is about.</p>
<p>It often displays a call-to-action button like "book a table" or "see our menu."</p> 
</div>
<img src="hero_section.png" alt="work experience section" style="width:700px;max-width:100%;">
</div>

<div class="w3-container w3-padding ws-light-green w3-section">
<div><p><strong>2. The menu.</strong></p>
<p>Having the menu available online lets the reader know what you are offering.</p>
<p>Use the menu to display deals and promotions.</p>
</div>
<img src="the_menu.png" alt="work experience section" style="width:700px;max-width:100%;">
</div>

<div class="w3-container w3-padding ws-light-green w3-section">
<div><p><strong>3. About the restaurant.</strong></p>
<p>Give the reader a summary of the restaurant and its history.</p>
<p>Help the reader to understand your passion for food.</p>
<p>Let them know about the experience that they can have with you.</p>
<p>Keep the text short.</p>
</div>
<img src="about_us.png" alt="work experience section" style="width:700px;max-width:100%;">
</div>

<div class="w3-container w3-padding ws-light-green w3-section">
<div><p><strong>4. Contact us.</strong></p>
<p>Let the reader know your location and how they can get in touch.</p>
<p>Add social media links to make it easier contact you.</p>
<p>Here you could also include a "book table" call to action.</p>
</div>
<img src="contact_us.png" alt="work experience section" style="width:700px;max-width:100%;">
</div>
<hr>
...
<p>It is easy to personalize a template.</p>

<div class="w3-panel ws-info">
      <p>Load the templates directly in W3Schools Spaces. Get started with editing your site in a few clicks.</p>
      <a class="ws-btn ws-green w3-white" href="/spaces/" target="_blank">Get started &#10095;</a>
      <p class="w3-small"><em>* no credit card required</em></p>
    </div>

<h2>Browse templates</h2>
<p>We have templates ready for you to use. Here are some examples:</p>

<div class="w3-panel ws-yellow w3-padding-16 w3-card">
<h3 class="w3-center">Pizza Restaurant Template</h3>
<div class="w3-content" style="max-width:800px">
<a href="/w3css/tryw3css_templates_pizza.htm" target="_blank" title="Pizza Restaurant Demo"><img src="hero_section.png" style="width:98%;margin:20px 0" alt="Pizza Restaurant Template"></a><br>
<div class="w3-row">
  <div class="w3-col m6">
    <a href="/w3css/tryw3css_templates_pizza.htm" target="_blank" class="ws-btn w3-padding-large ws-black" style="width:98.5%">Demo</a>
  </div>
  <div class="w3-col m6">
    <a href="/w3css/tryit.asp?filename=tryw3css_templates_pizza" target="_blank" class="ws-btn w3-padding-large ws-black" style="width:98.5%">Try it Yourself</a>
  </div>
</div>
</div>
</div>
...
<div class="w3-content" style="max-width:800px">
<a href="/w3css/tryw3css_templates_gourmet_catering.htm" target="_blank" title="Gourmet Catering Demo"><img src="le_catering.png" style="width:98%;margin:20px 0" alt="Gourmet Catering Template"></a><br>
<div class="w3-row">
  <div class="w3-col m6">
    <a href="/w3css/tryw3css_templates_gourmet_catering.htm" target="_blank" class="ws-btn w3-padding-large ws-black" style="width:98.5%">Demo</a>
  </div>
  <div class="w3-col m6">
    <a href="/w3css/tryit.asp?filename=tryw3css_templates_gourmet_catering&amp;stacked=h" target="_blank" class="ws-btn w3-padding-large ws-black" style="width:98.5%">Try it Yourself</a>
  </div>
</div>
</div>
</div>
...
<div class="w3-content" style="max-width:800px">
<a href="/w3css/tryw3css_templates_restaurant_modal.htm" target="_blank" title="Modal Restaurant Demo"><img src="modal_restaurant.png" style="width:98%;margin:20px 0" alt="Modal Restaurant Template"></a><br>
<div class="w3-row">
  <div class="w3-col m6">
    <a href="/w3css/tryw3css_templates_restaurant_modal.htm" target="_blank" class="ws-btn w3-padding-large ws-black" style="width:98.5%">Demo</a>
  </div>
  <div class="w3-col m6">
    <a href="/w3css/tryit.asp?filename=tryw3css_templates_restaurant_modal" target="_blank" class="ws-btn w3-padding-large ws-black" style="width:98.5%">Try it Yourself</a>
  </div>
</div>
</div>
</div>
