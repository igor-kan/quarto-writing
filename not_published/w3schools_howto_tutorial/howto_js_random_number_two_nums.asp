...
<html lang="en-US">
<head>
<title>How To Generate a Random Number Between Two Numbers</title>
<meta charset="utf-8">
...
<h1>How TO - Random Number Between Two Numbers</h1>
<div class="w3-clear nextprev">
<a class="w3-left ws-btn" href="howto_js_default_parameters.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_js_sort_numeric_array.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to get a random number between two numbers in JavaScript.</p>
<hr>

<h2>Random Numbers</h2>
<p>This JavaScript function always returns a random number between a minimum (included) and maximum 
number (excluded):</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
  function getRndInteger(min, max) {<br>&nbsp; return Math.floor(Math.random() * 
  (max - min) ) + min;<br>}</div>
<a class="ws-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_js_random_num_two_nums" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate jsHigh">
  function getRndInteger(min, max) {<br>&nbsp; return Math.floor(Math.random() * 
  (max - min + 1) ) + min;<br>}</div>
<a class="ws-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_js_random_num_two_nums2" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
<p>Read more about Random Numbers in our <a href="/js/js_random.asp">JavaScript Random Tutorial</a>.</p>
</div>
