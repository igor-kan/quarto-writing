...
<a class="w3-left ws-btn" href="howto_js_validation_empty_input.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_js_filter_table.asp">Next &#10095;</a>
</div>
<hr>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_js_filter_list" class="ws-btn">Try it Yourself &raquo;</a></p>
<hr>
...
}<br><br>#myUL li a {<br>&nbsp;&nbsp;border: 1px solid #ddd; /* Add a border to all links */<br>&nbsp; 
...
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;script&gt;<br>function myFunction() {<br>&nbsp;&nbsp;// Declare variables<br>
  &nbsp; var input, filter, 
ul, li, a, i, txtValue;<br>&nbsp; input = document.getElementById('myInput');<br>&nbsp; 
...
li.length; i++) {<br>&nbsp;&nbsp;&nbsp; a = li[i].getElementsByTagName(&quot;a&quot;)[0];<br>
  &nbsp;&nbsp;&nbsp; 
  txtValue = a.textContent || a.innerText;<br>&nbsp;&nbsp;&nbsp; 
...
&lt;/script&gt;<br></div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_filter_list" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
