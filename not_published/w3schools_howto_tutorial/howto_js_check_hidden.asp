...
<a class="w3-left ws-btn" href="howto_js_offline_detection.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_js_redirect_webpage.asp">Next &#10095;</a>
</div>
<hr>
...
<div class="w3-code notranslate jsHigh">
  ...
  &nbsp; if (window.getComputedStyle(x).display === &quot;none&quot;) {<br>&nbsp;&nbsp;&nbsp; // Do something..<br>&nbsp; 
  }<br>}<br>
</div>
<a class="ws-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_js_check_hidden" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate jsHigh">
  function myFunction() {<br>&nbsp; var x = document.getElementById(&quot;myDIV&quot;);<br>
  &nbsp; if (window.getComputedStyle(x).visibility === &quot;hidden&quot;) {<br>&nbsp;&nbsp;&nbsp; // Do something..<br>&nbsp; 
  }<br>}<br>
</div>
<a class="ws-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_js_check_hidden2" target="_blank">Try it Yourself &raquo;</a>
</div>
