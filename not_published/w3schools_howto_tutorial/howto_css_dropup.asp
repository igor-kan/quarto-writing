...
<div class="w3-clear nextprev">
  <a class="w3-left ws-btn" href="howto_css_subnav.asp">&#10094; Previous</a>
  <a class="w3-right ws-btn" href="howto_css_mega_menu.asp">Next &#10095;</a>
</div>
<hr>
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_dropup_hover" class="ws-btn w3-margin-top">Try it Yourself &raquo;</a>
...
.dropup-content a:hover {background-color: #ddd}<br><br>/* Show the 
  dropup menu on hover */<br>.dropup:hover .dropup-content {<br>&nbsp;&nbsp;display: block;<br>}<br><br>/* Change the background color of the dropup button when the 
  dropup content is shown */<br>.dropup:hover .dropbtn {<br>&nbsp;&nbsp;background-color: #2980B9;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_dropup_hover" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<h3>Example Explained</h3>
