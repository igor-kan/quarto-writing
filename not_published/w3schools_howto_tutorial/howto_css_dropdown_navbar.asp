...
<div class="w3-clear nextprev">
  <a class="w3-left ws-btn" href="howto_js_cascading_dropdown.asp">&#10094; Previous</a>
  <a class="w3-right ws-btn" href="howto_js_dropdown_sidenav.asp">Next &#10095;</a>
</div>
<hr>
...
<iframe src="tryhow_css_dropdown_navbar.htm" style="width:100%;border:none;height:200px;background-color:#fff;"></iframe>
</div>
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_dropdown_navbar" class="ws-btn">Try it Yourself &raquo;</a></p>
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_dropdown_navbar" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<h3>Example Explained</h3>
...
<p>The <code class="w3-codespan">.dropdown</code> class is the container for 
<code class="w3-codespan">.dropdown-content</code>. Since this is a &lt;div&gt; element, and not an 
&lt;a&gt; element, we have to float it to make sure that it stays next to the links.</p>
