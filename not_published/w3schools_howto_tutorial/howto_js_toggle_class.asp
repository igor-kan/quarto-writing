...
<a class="w3-left ws-btn" href="howto_js_toggle_text.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_js_add_class.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Toggle between adding and removing a class name from an element with JavaScript.</p>
<hr>
<button onclick="myFunction()" class="ws-btn w3-dark-grey w3-hover-black" style="box-shadow:none">Toggle Class</button>
...
<a target="_blank" href="tryit.asp?filename=tryhow_js_toggle_class" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
