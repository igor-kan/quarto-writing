...
<a class="w3-left ws-btn" href="howto_blog_developer_job.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_blog_hire_developers.asp">Next &#10095;</a>
</div>


<div class="ws-info intro w3-panel">
<p>A Front-End Developer is someone who creates websites and web applications.</p>
<p>The Front-End Developer creates things that the user sees.</p>
<p>It is a popular job, and everyone can become a Front-End Developer.</p>
</div>
<hr>

<h2>Why become a Front-End Developer</h2>
<p>It is fun and creative.</p>
<p>It is flexible - you can work from anywhere!</p>
<p>Many companies are looking for Front-End Developers.</p>
<hr>

<h2>What does a Front-End Developer do</h2>
<p>The main responsibility of a Front-End Developer is the <strong>User interface</strong>.</p>
<p>Simply put, create things that the user sees.</p>
<p><strong>Note:</strong> If you don't know what a Front-End Developer is, you can learn more about it in the <a href="/whatis/whatis_frontenddev.asp">What is a Front-End Developer</a> tutorial.</p>
...
<p>HTML, CSS, and JavaScript are the basic languages you need to know to create a website.</p>
<p>To become a Front-End Developer, start with the subjects below, in the following order:</p>
<p>You have to code to learn how to code. Practice a lot!</p>
...
<ol>
    ...
    <a class="ws-btn w3-round w3-margin-top w3-margin-bottom" href="/html/default.asp">Learn HTML &raquo;</a>
    <li><strong>Style with CSS.</strong> The next step is to learn CSS, to set the layout of your web page with beautiful colors, fonts, and much more.</li>
        <a class="ws-btn w3-round w3-margin-top w3-margin-bottom" href="/css/default.asp">Learn CSS &raquo;</a>
    <li><strong>Make it interactive with JavaScript.</strong> After studying HTML and CSS, you should learn JavaScript to create dynamic and interactive web pages for your users.</li>
        <a class="ws-btn w3-round w3-margin-top w3-margin-bottom" href="/js/default.asp">Learn JavaScript &raquo;</a>
</ol>

<div class="w3-panel ws-note"><p>Have you ever heard about <strong>W3Schools Spaces</strong>? Here you can create a website using HTML, CSS, and JavaScript.</p>
<a class="ws-btn ws-black" href="/spaces/" target="_blank">Get started for free &raquo;</a>
<p class="w3-small"><em>* no credit card required</em></p>
</div>

<p>Learn and practice JavaScript and CSS frameworks and libraries such as:
  <ul>
    <li><p><strong>Bootstrap</strong> - <span><a href="/bootstrap/bootstrap_ver.asp">Learn Bootstrap</a></span></p>
    <li><p><strong>SASS</strong> - <span><a href="/sass/default.asp"> Learn SASS</a></span></p>
    <li><p><strong>jQuery</strong> - <span><a href="/jquery/default.asp">Learn jQuery</a></span></p>
    <li><p><strong>React</strong> - <span><a href="/react/default.asp">Learn React</a></span></p>
    <li><p><strong>Version control with Git</strong> - <span><a href="/git/default.asp">Learn Git</a></span></p>
    </ul>
<p>Knowing the frameworks and libraries will make you more attractive in the job market.</p>
<div class="w3-panel ws-info">
  <p>Learning <strong>RESTful APIs</strong> is a bonus. This will allow you to connect the Front-End to the Back-End and its logic.</p>
  </div>
<hr>
...
<p>A Front-End Developer can have a big tool-box of skills.</p>
<p>Here are some:</p>
<ul>
  <li>Programming languages such as Python, PHP, and SQL</li>
...
<div class="w3-panel ws-note"><p>Want to get your first job? Read our article on how to get a developer job in Ten steps.</p>
<a class="ws-btn ws-green" href="/howto/howto_blog_developer_job.asp">Start reading &raquo;</a>
</div>
<hr>
