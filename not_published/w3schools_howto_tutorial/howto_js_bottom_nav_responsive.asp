...
<div class="w3-clear nextprev">
  <a class="w3-left ws-btn" href="howto_css_bottom_nav.asp">&#10094; Previous</a>
  <a class="w3-right ws-btn" href="howto_css_navbar_border.asp">Next &#10095;</a>
</div>
<hr>
...
<iframe src="tryhow_js_bottom_nav_tutorial.htm" style="background-color:white;height:300px;width:100%;border:3px solid #f1f1f1"></iframe>
<p><a target="_blank" href="tryit.asp?filename=tryhow_js_bottom_nav" class="ws-btn">Try it Yourself &raquo;</a></p>
...
/* Place the navbar at the bottom of the page, and make it stick */<br>.navbar {<br>&nbsp;&nbsp;background-color: #333;<br>&nbsp;&nbsp;overflow: hidden;<br>&nbsp;&nbsp;position: fixed;<br>&nbsp;&nbsp;bottom: 0;<br>&nbsp;&nbsp;width: 
  100%;<br>}<br><br>/* 
Style the links inside the navigation bar */<br>.navbar a {<br>&nbsp;&nbsp;float: left;<br>&nbsp;&nbsp;display: block;<br>&nbsp;&nbsp;color: #f2f2f2;<br>&nbsp;&nbsp;text-align: center;<br>
  &nbsp; 
  padding: 14px 16px;<br>&nbsp; text-decoration: none;<br>&nbsp;&nbsp;font-size: 17px;<br>}<br><br>/* Change the color of links on hover */<br>
...
/* Toggle between adding and removing the "responsive" class to 
  the navbar when 
the user clicks on the icon */<br>function myFunction() {<br>&nbsp;&nbsp;var x = document.getElementById("myNavbar");<br>
  &nbsp; if (x.className 
=== "navbar") {<br>&nbsp;&nbsp;&nbsp; x.className += " 
responsive";<br>&nbsp;&nbsp;} else {<br>&nbsp;&nbsp;&nbsp; x.className = "navbar";<br>
  &nbsp;&nbsp;}<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_bottom_nav" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
