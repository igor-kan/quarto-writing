...
<a class="w3-left ws-btn" href="howto_js_toggle_like.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_js_toggle_dark_mode.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Toggle between hiding and showing an element with JavaScript.</p>
<hr>
<button onclick="myFunction()" class="ws-btn w3-hover-black w3-dark-grey" style="box-shadow:none">Toggle Hide and Show</button>
...
=== &quot;none&quot;) {<br>&nbsp;&nbsp;&nbsp;&nbsp;x.style.display = &quot;block&quot;;<br>&nbsp;&nbsp;} else {<br>&nbsp;&nbsp;&nbsp;&nbsp;x.style.display = 
  &quot;none&quot;;<br>&nbsp; }<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_toggle_hide_show" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
