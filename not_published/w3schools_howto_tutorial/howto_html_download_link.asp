...
<div class="w3-clear nextprev">
  <a class="w3-left ws-btn" href="howto_css_shapes.asp">&#10094; Previous</a>
  <a class="w3-right ws-btn" href="howto_css_div_full_height.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a download link with HTML.</p>
<hr>
<h2>Download Link</h2>
<p>You can use the HTML <code class="w3-codespan">download</code> attribute to specify that the target will be downloaded when a user clicks on the hyperlink.</p>
...
<a class="ws-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_html_download_link" target="_blank">Try it Yourself &raquo;</a>
</div>
<p>The <code class="w3-codespan">download</code> attribute is only used if the <code class="w3-codespan">href</code> attribute is set.</p>
...
<a target="_blank" class="ws-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_html_download_link2">Try it Yourself &raquo;</a>
</div>
