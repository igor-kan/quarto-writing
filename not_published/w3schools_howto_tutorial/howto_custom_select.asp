...
<a class="w3-left ws-btn" href="howto_css_custom_checkbox.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_css_switch.asp">Next &#10095;</a>
</div>
<hr>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_custom_select" class="ws-btn">Try it Yourself &raquo;</a></p>
...
<div class="w3-code notranslate htmlHigh">
  &lt;!-- Wrap the select box in a &quot;.custom-select&quot; DIV element.<br>Remember 
...
<div class="w3-code notranslate cssHigh">
  ...
  position: relative;<br>&nbsp; font-family: Arial;<br>}<br><br>.custom-select select {<br>&nbsp; 
  display: none; /*hide original SELECT element: */<br>}<br><br>.select-selected {<br>&nbsp; 
  background-color: DodgerBlue;<br>}<br><br>/* Style the arrow inside the select 
  ...
  transparent transparent transparent;<br>}<br><br>
  ...
  rgba(0, 0, 0, 0.1) transparent;<br>&nbsp; cursor: pointer;<br>}<br><br>/* Style items (options): */<br>
  .select-items {<br>&nbsp; position: absolute;<br>&nbsp; background-color: 
  DodgerBlue;<br>&nbsp; top: 100%;<br>&nbsp; left: 0;<br>&nbsp; right: 0;<br>&nbsp; 
  z-index: 99;<br>}<br><br>/* Hide the items 
...
<div class="w3-code notranslate jsHigh">
  var x, i, j, l, ll, selElmnt, a, b, c;<br>/* Look for any elements with the class 
  &quot;custom-select&quot;: */<br>x = document.getElementsByClassName(&quot;custom-select&quot;);<br>
  l = x.length;<br>
  for (i = 0; i &lt; l; i++) {<br>&nbsp; selElmnt = x[i].getElementsByTagName(&quot;select&quot;)[0];<br>&nbsp; 
  ll = selElmnt.length;<br>&nbsp; /* 
  ...
  1; j &lt; ll; j++) {<br>&nbsp;&nbsp;&nbsp; /* For each option in the 
  ...
  this.nextSibling.classList.toggle(&quot;select-hide&quot;);<br>&nbsp;&nbsp;&nbsp;&nbsp;this.classList.toggle(&quot;select-arrow-active&quot;);<br>&nbsp; });<br>}<br><br>function closeAllSelect(elmnt) {<br>&nbsp; /* 
  A function that will 
  close all select boxes in the document,<br>&nbsp; except the current select 
  box: */<br>&nbsp; var x, y, i, xl, yl, arrNo = [];<br>&nbsp; x = 
  document.getElementsByClassName(&quot;select-items&quot;);<br>&nbsp; y = 
  document.getElementsByClassName(&quot;select-selected&quot;);<br>&nbsp; xl = 
  x.length;<br>&nbsp; yl = y.length;<br>&nbsp; for (i = 0; i &lt; 
  yl; i++) {<br>&nbsp;&nbsp;&nbsp; if (elmnt == y[i]) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  arrNo.push(i)<br>&nbsp;&nbsp;&nbsp; } else {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  y[i].classList.remove(&quot;select-arrow-active&quot;);<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp; 
  }<br>&nbsp; for (i = 0; i &lt; xl; i++) {<br>&nbsp;&nbsp;&nbsp; if (arrNo.indexOf(i)) 
  {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; x[i].classList.add(&quot;select-hide&quot;);<br>&nbsp;&nbsp;&nbsp; 
  }<br>&nbsp; }<br>}<br><br>/* If the user clicks anywhere outside the select box,<br>then 
  close all select boxes: */<br>document.addEventListener(&quot;click&quot;, closeAllSelect);</div>
<a target="_blank" href="tryit.asp?filename=tryhow_custom_select" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>
