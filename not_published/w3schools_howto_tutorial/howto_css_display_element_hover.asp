...
<html lang="en-US">
<head>
<title>How To Display an Element on Hover</title>
<meta charset="utf-8">
...
<h1>How TO - Display an Element on Hover</h1>
<div class="w3-clear nextprev">
  <a class="w3-left ws-btn" href="howto_css_tooltip.asp">&#10094; Previous</a>
  <a class="w3-right ws-btn" href="howto_js_popup.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to display an element on hover.</p>
<hr>
...
<h2>How To Display an Element on Hover</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div class=&quot;myDIV&quot;&gt;Hover over me.&lt;/div&gt;<br>&lt;div class=&quot;hide&quot;&gt;I am shown when 
  someone hovers over the div above.&lt;/div&gt;</div>
</div>
...
<div class="w3-code notranslate cssHigh">
  .hide {<br>&nbsp; display: none;<br>}<br><br>.myDIV:hover + .hide {<br>&nbsp; 
  display: block;<br>&nbsp; color: red;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_display_element_hover" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<h3>Example Explained</h3>
<p>The adjacent sibling selector (<code class="w3-codespan">+</code>) selects all elements that are the adjacent siblings of a specified element.</p>
<p>The word "adjacent" means "immediately following", and the example above selects all elements with <code class="w3-codespan">class=".hide"</code>, that are placed immediately after elements with <code class="w3-codespan">class=".myDIV</code>", on hover.</p>

<p>Go to our <a href="/css/css_combinators.asp">CSS Combinators Tutorial</a> to learn 
more about adjacent selectors.</p>
