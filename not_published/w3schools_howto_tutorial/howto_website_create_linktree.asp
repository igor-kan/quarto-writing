...
<html lang="en-US">
<head>
<title>How to Make a Link Tree Website</title>
<meta charset="utf-8">
...
<h1>How to make a link tree website</h1>
<div class="w3-clear nextprev">
<a class="w3-left ws-btn" href="howto_create_and_view.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_website_create_portfolio.asp">Next &#10095;</a>
</div>
    <div class="ws-info intro w3-panel">
      <p>A link tree website lets you share all your links on one site.</p>
      <p>It is a landing page where you can display the links to your social networks, blog posts, businesses, projects, and more.</p>
      <a class="ws-btn w3-margin-top" href="/spaces/" target="_blank">Create a link tree website for free &raquo;</a>
    </div>
    <hr>
    <h2>Why create a link tree website</h2>
    <p>The links website is great to grow your online presence.</p>
    <p>It makes it easy to share links for the places where you have content.</p>
    <p>In addition, the links website helps people to connect with you in more than one place.</p>
    <p>By creating the links website on your own, you have complete control of it.</p>
      <div class="w3-panel ws-note">
        <p>How the site looks reflect your brand. Design it the way you want to appear.</p>
        </div>
    <hr>

    <h2>What do I need to know to create my link tree website?</h2>
    <p>HTML, CSS, and JavaScript are the basic languages to create a website.</p>
    <p>It is all you need to make your links site.</p>
    <ol>
      <li><strong>Create the structure with HTML.</strong> The first thing you have to learn, is HTML, the standard markup language for creating web pages.</li>
      <a class="ws-btn w3-round w3-margin-top w3-margin-bottom" href="/html/default.asp" target="_blank">Learn HTML &#10095;</a>
      ...
      <a class="ws-btn w3-round w3-margin-top w3-margin-bottom" href="/css/default.asp" target="_blank">Learn CSS &#10095;</a>
      ...
      <a class="ws-btn w3-round w3-margin-top w3-margin-bottom" href="/js/default.asp" target="blank">Learn JavaScript &#10095;</a>
    </ol>
    <hr>
    
    <h2>How do I get started</h2>
    <p>There are two ways to start building a link tree website.</p>
    <p>Building from scratch or using a template.</p>


    <h2>Build with W3Schools Spaces</h2>
    <p>In Spaces, you can build and experiment with your link tree website.</p>
    <p>Here you can make static sites with HTML, CSS, and JavaScript.</p>
    <p>Everything you need right in the browser.</p>
    <a class="ws-btn w3-round ws-black" href="/spaces/" target="blank">Learn more &#10095;</a>
    <hr>

    <h2>Building a link tree webpage from scratch</h2>
    <p>The first thing you need to do is to build a layout, then add content.</p>
    <p>To create a website layout, go to our article on how to create a website: <span><a href="/howto/howto_make_a_website.asp" target="_blank">How to Create a Website</a></span></p>



    <p>Once you have made the layout. Create the two main sections listed below:</p>
    <div class="w3-container w3-padding w3-section">
      <div>
        <p><strong>1. Bio section.</strong></p>
        <p>The bio section is the first thing people see when visiting your link tree website.</p>
        <p>It is displayed on top of the link tree website.</p>
        <p>Keep it short and sweet.</p>
        <p>The bio section can contain your image, name, and your profession.</p>
        <p>People are more comfortable connecting with you if they know your name and how you look.</p>
      </div>
      <img src="img_link_tree_bio.jpeg" loading="lazy" alt="image section" style="width:700px;max-width:100%;">
    </div>
    <div class="w3-container w3-padding w3-section">
      <div>
        <p><strong>2. Links section.</strong></p>
        <p>The links section contains all the links you want to share.</p>
        <p>It is displayed under the bio section.</p>
        <p>Make sure that the links are well structured.</p>
      </div>
      <img src="img_link_tree_links.jpeg" loading="lazy" alt="links section" style="width:700px;max-width:100%;">
    </div>
    <hr>

    <h2>Building with a template</h2>
    <p>Starting with templates is an excellent way to get inspired and to learn.</p>
    <div class="w3-panel ws-info">
      <p>The link tree templates can be loaded directly in Spaces. Get started in a few clicks.</p>
      <p>Copy the code and paste it in the Spaces editor or save it to Spaces from the TryIt editor.</p>
      <a class="ws-btn ws-green" href="/spaces/" target="_blank">Get started &raquo;</a>
      <p class="w3-small"><em>* no credit card required</em></p>
    </div>
    <h2>Personalize the template</h2>
    <p>Here is a four-step approach to making the template your own.</p>
    <hr>

    <h2>Step One: Change the background</h2>
    <p>Find the background or background-image property in the code and change the URL.</p>
    <p>Read here for how to change a background image: <span><a href="/cssref/pr_background-image.asp" target="_blank">How to change background image</a></span></p>
    <hr>
...
<!-- <p class="adtext">Advertisement</p> -->
    ...
    <h2>Step Two: Add your picture</h2>
    <p>Find the &lt;img&gt; tag and change it to the URL to your picture.</p>
    <p>Read here for how to change an image: <span><a href="/html/html_images.asp" target="_blank">How to change an image</a></span></p>
    <hr>

    <h2>Step Three: Write your bio</h2>
    <p>Find the paragraph tags in the top of the code and change the text between the &lt;p&gt; and &lt;/p&gt; tags.</p>
    <p>Read here to learn more about paragraphs: <span><a href="/html/html_paragraphs.asp" target="_blank">About HTML paragraphs <p></a></span></p>
    <hr>

    <h2>Step Four: Add your links</h2>
    <p>Find the anchor tags and change the text in between of the &lt;a&gt; and &lt;/a&gt; tags.</p>
    <p>Read here to learn more about anchor tags: <span><a href="/tags/tag_a.asp" target="_blank">About HTML anchor tags <a></a></span></p>
<hr>

<h2>Browse and pick a template</h2>
<p>We have ready-made templates for you to use. Here are some examples:</p>

    <div class="w3-panel ws-yellow w3-padding-16 w3-card">
      <h3 class="w3-center">Social Links 1</h3>
      <div class="w3-content" style="max-width:800px">
        <a href="tryhow_website_link_tree1.htm" target="_blank" title="links demo"><img src="img_link_tree_template1.png" loading="lazy" style="width:98%;margin:20px 0" alt="Link Tree Template"></a><br>
        <div class="w3-row">
          <div class="w3-col m6">
            <a href="tryhow_website_link_tree1.htm" target="_blank" class="ws-btn w3-padding-large w3-black" style="width:98.5%">Demo</a>
          </div>
          <div class="w3-col m6">
            <a href="tryit.asp?filename=tryhow_website_link_tree1" target="_blank" class="ws-btn w3-padding-large w3-dark-grey" style="width:98.5%">Try it Yourself</a>
          </div>
        </div>
      </div>
    </div>
    <div class="w3-panel ws-yellow w3-padding-16 w3-card">
      <h3 class="w3-center">Social Links 2</h3>
      <div class="w3-content" style="max-width:800px">
        <a href="tryhow_website_link_tree2.htm" target="_blank" title="links demo"><img src="img_link_tree_template2.png" loading="lazy" style="width:98%;margin:20px 0" alt="Link Tree Template"></a><br>
        <div class="w3-row">
          <div class="w3-col m6">
            <a href="tryhow_website_link_tree2.htm" target="_blank" class="ws-btn w3-padding-large w3-black" style="width:98.5%">Demo</a>
          </div>
          <div class="w3-col m6">
            <a href="tryit.asp?filename=tryhow_website_link_tree2" target="_blank" class="ws-btn w3-padding-large w3-dark-grey" style="width:98.5%">Try it Yourself</a>
          </div>
        </div>
      </div>
    </div>
    <div class="w3-panel ws-yellow w3-padding-16 w3-card">
      <h3 class="w3-center">Social links 3</h3>
      <div class="w3-content" style="max-width:800px">
        <a href="tryhow_website_link_tree3.htm" target="_blank" title="links demo"><img src="img_link_tree_template3.png" loading="lazy" style="width:98%;margin:20px 0" alt="Link Tree Template"></a><br>
        <div class="w3-row">
          <div class="w3-col m6">
            <a href="tryhow_website_link_tree3.htm" target="_blank" class="ws-btn w3-padding-large w3-black" style="width:98.5%">Demo</a>
          </div>
          <div class="w3-col m6">
            <a href="tryit.asp?filename=tryhow_website_link_tree3" target="_blank" class="ws-btn w3-padding-large w3-dark-grey" style="width:98.5%">Try it Yourself</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="w3-center ws-black" style="color:white;margin-left:-32px;margin-right:-32px">
      <div style="opacity:0.96;margin:auto;padding:70px 20px;">
        ...
        <h3 style="margin-bottom:40px;font-family: 'Source Sans Pro', sans-serif;font-size:24px">Build your static website with W3Schools Spaces.</h3>
