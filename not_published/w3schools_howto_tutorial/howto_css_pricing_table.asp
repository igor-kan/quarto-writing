...
<a class="w3-left ws-btn" href="howto_js_shrink_header_scroll.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_css_parallax.asp">Next &#10095;</a>
</div>
<hr>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_pricing_table" class="ws-btn">Try it Yourself &raquo;</a></p>
...
float: left;<br>&nbsp;&nbsp;width: 33.3%;<br>&nbsp;&nbsp;padding: 8px;<br>}<br><br>/* Style the list */<br>.price {<br>
  &nbsp; 
...
border-bottom: 1px solid #eee;<br>&nbsp; padding: 20px;<br>&nbsp;&nbsp;text-align: center;<br>}<br><br>/* Grey list item */<br>.price .grey {<br>&nbsp;&nbsp;background-color: #eee;<br>&nbsp;&nbsp;font-size: 20px;<br>}<br><br>
/* The &quot;Sign Up&quot; button */<br>.button {<br>&nbsp;&nbsp;background-color: #04AA6D;<br>
  &nbsp; border: none;<br>&nbsp; 
...
100% <br>(to stack horizontally on small screens) */<br>@media only screen and (max-width: 600px) {<br>&nbsp;&nbsp;.columns {<br>&nbsp;&nbsp;&nbsp;&nbsp;width: 100%;<br>
  &nbsp;&nbsp;}<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_pricing_table" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>
<div class="w3-clear nextprev">
<a class="w3-left ws-btn" href="howto_js_shrink_header_scroll.asp">&#10094; Previous</a>
