...
<h1>How TO - Create a Free Website</h1>
<div class="w3-clear nextprev">
<a class="w3-left ws-btn" href="howto_js_element_iframe.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_make_a_website.asp">Next &#10095;</a>
</div>
<hr>
<div class="w3-panel ws-info intro">
<p>Build and host your website with W3Schools Spaces.</p>
<p>Get started with your free website in a few clicks.
<p>Everything you need right in the browser.
<p>It is easy to use - try it!</p>
<a class="ws-btn" href="https://www.w3spaces.com" style="margin-top:6px">Get started for free &raquo;</a>
</div>

<hr>
<h2>Create Your First Website with W3Schools Spaces</h2>
<p><a href="https://www.w3spaces.com">W3Schools Spaces</a> is a personal place where you can build and experiment with code and host your own website.</p>
<p>With W3Schools Spaces you can build with HTML, CSS and JavaScript.</p>
<p>Edit code directly in your browser.</p>
<p>Upload and host your files and images.</p>
<p><strong>Start to grow your online presence today!</strong></p>
<hr>

<h2>Why Build with W3Schools Spaces?</h2>
<p>Spaces is made by web developers for web developers.</p>
<ol>
  <li>The interface is simple and easy to use.</li>
  <li>Host and edit your files right in the browser.</li>
  <li>Templates.</li>
</ol>

<p>It is <strong>free</strong> to get started and you do not have to enter your credit card.</p>
<hr>

<h2>Edit and Preview Code</h2>
<p>The editor is easy to use - which helps you to focus on the most imporant things.</p>
<p>Check the responsiveness of your site with the different preview alternatives.</p>
<p><strong>Preview changes on your site, live!</strong></p>
<img src="/images/spaces_editor.png" style="width:100%; max-width:1200px; height:auto">
<hr>

<h2>Build From Anywhere</h2>
<p>Host your files and images in the cloud.</p>
<p>Keep organized by creating a structure with folders.</p>
<p><strong>Everything you need right in the browser.</strong></p>
<img src="/images/spaces_fileoverview.png" style="width:100%; max-width:1200px; height:auto" loading="lazy">

<hr>
<h2>Free Templates</h2>
<p>Browse and use our responsive website templates.</p>
<p>Modify, save, share, and use them in your projects.</p>
<img src="/images/spaces_templates.png" style="width:100%; max-width:1200px; height:auto" loading="lazy">
<div class="ws-info w3-panel">
    <p>The templates are powered by <strong><a href="/w3css/default.asp" target="_blank">W3.CSS</a></strong></p>
    </div>
<hr>
...
<p>HTML, CSS and JavaScript are the foundational languages to build a website.</p>
...
<ol>
    ...
    <a class="ws-btn w3-margin-top w3-margin-bottom" href="/html/default.asp" target="_blank">Learn HTML &raquo;</a>
    <li><strong>Style with CSS.</strong> The next step is to learn CSS, to set the layout of your web page with beautiful colors, fonts, and much more.</li>
        <a class="ws-btn w3-margin-top w3-margin-bottom" href="/css/default.asp" target="_blank">Learn CSS &raquo;</a>
    <li><strong>Make it interactive with JavaScript.</strong> After studying HTML and CSS, you should learn JavaScript to create dynamic and interactive web pages for your users.</li>
        <a class="ws-btn w3-margin-top w3-margin-bottom" href="/js/default.asp" target="blank">Learn JavaScript &raquo;</a>
</ol>
<div class="w3-panel ws-note"><p>Do not worry if you do not know how to code. The most important thing is to get hands on, early on. Learning how to code is best done with getting practical. Start to build something today!</p>
</div>
<hr>

<h2>Lets Get Started in a Few Steps</h2>
<p>Do you already have a W3Schools Account? If so, skip the first step</p>
<hr>

<h2>Step One: Sign Up For an Account</h2>
<p>To be able to use Spaces you need to sign up and get your account.</p>
<p>Lets get you set up!</p>
<p>Go to <span><a href="http://profile.w3schools.com/log-in?redirect_url=https%3A%2F%2Fspaces.w3schools.com%2Fcreatespace%2Fstepone" target="_blank">W3Schools Profile</a></span> - Click "<strong>Sign up</strong>" and enter your email and password, then click the "<strong>Sign up for free</strong>" button.
<img src="/images/spaces_signup.png" style="width:100%; max-width:1200px; height:auto" loading="lazy">
<p>Remember to <strong>validate</strong> your account in your email. Check the spam filter if you cannot find the validation email in your inbox.</p>
<div class="w3-panel ws-note">
<p>Get more information about how to sign up in our article - <span><a href="https://support.w3schools.com/hc/en-gb/articles/4402323148177-How-to-sign-up-or-create-an-account-"
 target="_blank">How to sign up</a></span></p>
 </div>
 <hr>

 <h2>Step Two: Start with a template or HTML skeleton</h2>
 <p>Go to <span><a href="http://profile.w3schools.com/log-in?redirect_url=https%3A%2F%2Fspaces.w3schools.com%2Fcreatespace%2Fstepone" target="_blank">W3Schools Spaces</a></span></p>
 <p>Select one of the options and click the "<strong>Continue</strong>" button.</p>
 <p>Do not worry too much about this decision. You can reset your Space and start over again whenever you want.</p>
<img src="/images/spaces_templateornot.png" loading="lazy" style="width:100%; max-width:1200px; height:auto">
<hr>

<h2>Step Three: Give your space a name</h2>
<p>Personalize your Space by giving it an amazing name.</p>
<p>You can not use special letters in the name, such as (#, ! or :). The only exception is dash ( - )
<img src="/images/spaces_spacename.png" loading="lazy" style="width:100%; max-width:1200px; height:auto">
<div class="w3-panel ws-note">
    <p>The name will be the link that you share with others to see your site. For example: <strong>yourname</strong>.w3spaces.com</p>
    </div>
    <hr>

<h2>Step Four: Enter your space</h2>
<p><strong>Great job!</strong> you made it to the dashboard.</p>
<p>In the dashboard you get an overview of your spaces and usage.</p>
<p>Enter your <strong>space</strong> and its <strong>File Overview</strong> by clicking somewhere on the space's row or click the button with the three dots to the right inside the row.</p>
<img src="/images/spaces_dashboard.png" loading="lazy" style="width:100%; max-width:1200px; height:auto">
<div class="w3-panel ws-note">
     <p>You can only have one space with the free plan. However, you can always <a href="https://order.w3schools.com" target="_blank">upgrade</a> to get more spaces.</p>
     </div>
<hr>

<h2>Step Five: Edit code or upload files</h2>
<p>This is where the magic happens!</p>
<p>Start to <strong>edit code</strong> or <strong>upload files</strong></p>
<ul>
<li>Edit code by clicking on the "<strong>Pen icon</strong>" to the right of the file that you want to edit.</li>
<li>Create new files by clicking on the "<strong>New file</strong>" button.</li>
<li>Upload files by clicking on the "<strong>Upload files</strong>" button.</li>
</ul>
<img src="/images/spaces_filemanager.png" loading="lazy" style="width:100%; max-width:1200px; height:auto">
<hr>

<h2>Step Six: Publish your site and share it with someone</h2>
<p><strong>This is the start of building your online presence.</strong></p>
<p>Learn, test, build, and go live with your space.</p>
<p>Create your website and share it with others.</p>
  <img src="/images/spaces_myfirstproject.png" loading="lazy" style="width:100%; max-width:1200px; height:auto">
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> Your space name with the .w3spaces.com extension is your shareable link. Read more about how to share your space in this article <span><a href="https://support.w3schools.com/hc/en-gb/articles/4410550301073" target="_blank">How can I share my space?</a></span></p>
</div>
<br>
...
<div class="w3-center ws-black" style="color:white;margin-left:-32px;margin-right:-32px">
  <div style="opacity:0.96;margin:auto;padding:70px 20px;">
    ...
    <h3 style="margin-bottom:40px;font-family: 'Source Sans Pro', sans-serif;font-size:24px">Build your own website with W3Schools Spaces.</h3>
...
<br>
<div class="w3-clear nextprev">
<a class="w3-left ws-btn" href="howto_make_a_website.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_make_a_website.asp">Next &#10095;</a>
</div>
<div
