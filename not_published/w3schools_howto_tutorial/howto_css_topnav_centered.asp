...
<div class="w3-clear nextprev">
  <a class="w3-left ws-btn" href="howto_css_topnav_right.asp">&#10094; Previous</a>
  <a class="w3-right ws-btn" href="howto_css_topnav_equal_width.asp">Next &#10095;</a>
</div>
<hr>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_topnav_centered" class="ws-btn">Try it Yourself &raquo;</a></p>
...
Style the links inside the navigation bar */<br>.topnav a {<br>&nbsp; float: 
  ...
  background-color: #04AA6D;<br>&nbsp; color: white;<br>}<br><br>/* Centered 
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_topnav_centered" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
