...
<a class="w3-left ws-btn" href="howto_google_charts.asp">&#10094; Previous</a>
  <a class="w3-right ws-btn" href="howto_google_fonts_pairings.asp">Next &#10095;</a>
</div>
<hr>
...
<a class="ws-btn w3-margin-bottom" href="tryit.asp?font=Sofia" target="_blank">Try it Yourself &raquo;</a>
</div>
...
function drawtable() {
  ...
  for (i = 0; i < l; i++) {
    ...
    txt += "<td><a target='_blank' class='ws-btn' href='tryit.asp?font=" + ff + "'>Try it</a></td>";
    txt += "</tr>";
  }
  txt += "</table>";        
