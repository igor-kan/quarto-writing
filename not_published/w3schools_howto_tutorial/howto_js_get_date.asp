...
<html lang="en-US">
<head>
<title>How To Get The Current Date With JavaScript</title>
<meta charset="utf-8">
...
<h1>How TO - Get Current Date With JavaScript</h1>
<div class="w3-clear nextprev">
<a class="w3-left ws-btn" href="howto_js_scroll_into_view.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_js_get_url.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to get the current date with JavaScript.</p>
<hr>

<h2>Current Date</h2>
<p>Use <code class="w3-codespan">new Date()</code> to get the current date:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
  const d = new Date();</div>
<a class="ws-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_js_get_date" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
<p>Read more about Dates in our <a href="/js/js_dates.asp">JavaScript Dates Tutorial</a>.</p>
</div>
