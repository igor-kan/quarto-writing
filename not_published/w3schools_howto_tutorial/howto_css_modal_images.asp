...
<a class="w3-left ws-btn" href="howto_js_slideshow_gallery.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_js_lightbox.asp">Next &#10095;</a>
</div>
<hr>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_modal_img" class="ws-btn">Try it Yourself &raquo;</a></p>
...
.modal {<br>&nbsp; display: none; /* Hidden by default */<br>&nbsp;&nbsp;position: fixed; /* Stay in place */<br>
  &nbsp; z-index: 1; /* 
...
*/<br>&nbsp; background-color: rgb(0,0,0); /* Fallback color */<br>&nbsp;&nbsp;background-color: rgba(0,0,0,0.9); /* Black w/ opacity */<br>}<br><br>/* 
...
Image (Image Text) - Same Width as the Image */<br>#caption {<br>&nbsp;&nbsp;margin: auto;<br>&nbsp;&nbsp;display: block;<br>&nbsp;&nbsp;width: 80%;<br>&nbsp;&nbsp;max-width: 700px;<br>&nbsp;&nbsp;text-align: center;<br>&nbsp;&nbsp;color: #ccc;<br>&nbsp;&nbsp;padding: 10px 0;<br>
  &nbsp; 
...
@keyframes zoom {<br>&nbsp;&nbsp;from {transform:scale(0)} <br>&nbsp;&nbsp;to {transform:scale(1)}<br>}<br><br>/* The Close Button */<br>.close {<br>&nbsp;&nbsp;position: 
absolute;<br>&nbsp; top: 15px;<br>&nbsp; right: 
35px;<br>&nbsp; color: #f1f1f1;<br>&nbsp;&nbsp;font-size: 
40px;<br>&nbsp;&nbsp;font-weight: bold;<br>&nbsp;&nbsp;transition: 0.3s;<br>}<br><br>.close:hover,<br>.close:focus {<br>&nbsp;&nbsp;color: #bbb;<br>&nbsp;&nbsp;text-decoration: none;<br>
  &nbsp; 
cursor: pointer;<br>}<br><br>/* 100% Image Width 
on Smaller Screens */<br>@media only screen and (max-width: 700px){<br>&nbsp;&nbsp;.modal-content {<br>&nbsp;&nbsp;&nbsp;&nbsp;width: 100%;<br>
  &nbsp;&nbsp;}<br>}</div>
</div>
<!--
<h3>Example Explained</h3>
...
document.getElementById("caption");<br>img.onclick = function(){<br>&nbsp;&nbsp;modal.style.display = "block";<br>&nbsp;&nbsp;modalImg.src = this.src;<br>&nbsp;&nbsp;captionText.innerHTML = 
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_modal_img" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
