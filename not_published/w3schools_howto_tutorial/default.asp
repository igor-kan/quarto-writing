...
<button
  onclick="document.getElementById('loginModal').style.display='block';document.getElementById('thishtpw').type = 'password'"
  class="w3-button w3-blue"
  style="font-size:17px;width:150px">Login
</button>
  ...
  class="w3-button w3-hover-text-grey w3-container w3-display-topright w3-xxlarge">&times;</span>
    ...
    <div class="w3-container">
      <div class="w3-section">
        ...
        <input class="w3-input w3-border" type="text" id="thishtpw" placeholder="Enter Password">
...
<script>
function click_232112() {
  document.getElementById('loginModal').style.display='block';
  document.getElementById('thishtpw').type = "password";  
}
  // Get the modal
...
<div class="w3-card-4 w3-container">
  ...
  <button class="w3-button w3-black w3-padding" onclick="openNav3();openOffcanvas();">Sidenav w/opacity</button>
  <div class="howto-container">
...
<div id="myModalLightbox" class="w3-modal w3-black" style="z-index:999">
...
<div class="w3-panel ws-note">
  <p>Ever heard about <strong>W3Schools Spaces</strong>? Here you can create your own website, or save your favorite code snippets.</p>
