...
<a class="w3-left ws-btn" href="howto_js_mobile_navbar.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_js_collapse_sidebar.asp">Next &#10095;</a>
</div>
<hr>
...
<div id="myNav3" class="hhoverlay">
  ...
  <button class="ws-btn w3-padding-large w3-dark-grey w3-mobile" onclick="openNav()">Slide Right</button><p class="w3-hide-large w3-hide-medium"></p>
  <button class="ws-btn w3-padding-large w3-dark-grey w3-mobile" onclick="openNav2()">Slide Down</button><p class="w3-hide-large w3-hide-medium"></p>
  <button class="ws-btn w3-padding-large w3-dark-grey w3-mobile" onclick="openNav3()">Show (No animation)</button>
...
<a target="_blank" href="tryit.asp?filename=tryhow_js_overlay" class="ws-btn w3-margin-top">Try it Yourself &raquo;</a>
...
background-color: rgb(0,0,0); /* Black fallback color */<br>&nbsp;&nbsp;background-color: rgba(0,0,0, 0.9); /* Black w/opacity */<br>
  &nbsp; 
...
<a target="_blank" href="tryit.asp?filename=tryhow_js_overlay" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
= &quot;100%&quot;;<br>}<br><br>/* Close */<br>function closeNav() {<br>&nbsp;&nbsp;document.getElementById(&quot;myNav&quot;).style.height = &quot;0%&quot;;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_overlay2" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
= &quot;block&quot;;<br>}<br><br>/* Close */<br>function closeNav() {<br>&nbsp;&nbsp;document.getElementById(&quot;myNav&quot;).style.display = &quot;none&quot;;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_overlay_no-anim" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
