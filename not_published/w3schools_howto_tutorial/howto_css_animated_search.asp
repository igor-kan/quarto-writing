...
<a class="w3-left ws-btn" href="howto_js_copy_clipboard.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_css_search_button.asp">Next &#10095;</a>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  input[type=text] {<br>&nbsp;&nbsp;width: 130px;<br>&nbsp;&nbsp;-webkit-transition: width 0.4s ease-in-out;<br>
  &nbsp; 
...
&nbsp;&nbsp;width: 100%;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_anim_search" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
