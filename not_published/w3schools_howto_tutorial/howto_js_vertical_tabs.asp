...
<a class="w3-left ws-btn" href="howto_js_tabs.asp">&#10094; Previous</a>
  <a class="w3-right ws-btn" href="howto_js_tab_header.asp">Next &#10095;</a>
</div>
<hr>
...
<iframe src="tryhow_js_vertical_tabs.htm" style="width:100%;height:425px;border:1px solid #f1f1f1;xmargin:0 -8px;background-color:#fff;"></iframe>
<p style="margin-top:7px"><a target="_blank" href="tryit.asp?filename=tryhow_js_vertical_tabs" class="ws-btn">Try it Yourself &raquo;</a></p>
<hr>
...
<div class="w3-code notranslate cssHigh">
  * {box-sizing: border-box}<br><br>/* Style the tab */<br>.tab {<br>&nbsp;&nbsp;float: left;<br>&nbsp;&nbsp;border: 1px solid #ccc;<br>
  ...
  outline: none;<br>&nbsp; text-align: left;<br>&nbsp;&nbsp;cursor: pointer;<br>&nbsp;&nbsp;transition: 0.3s;<br>}<br><br>/* Change 
  background color of buttons on hover */<br>.tab button:hover {<br>&nbsp;&nbsp;background-color: #ddd;<br>}<br><br>/* Create an active/current &quot;tab button&quot; 
...
<a target="_blank" href="tryit.asp?filename=tryhow_js_vertical_tabs" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
