...
<a class="w3-left ws-btn" href="howto_website_create_website.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_website_static.asp">Next &#10095;</a>
</div>
<hr>
...
<div class="w3-row-padding" style="margin:16px -16px 0 -16px">
  <div class="w3-col m6">
    <a href="tryhow_make_a_website.htm" target="_blank" class="ws-btn w3-padding-large w3-dark-grey w3-block">Demo</a>
  </div>
  <div class="w3-col m6">
    <a href="tryit.asp?filename=tryhow_make_a_website" target="_blank" class="ws-btn w3-padding-large w3-block">Try it Yourself</a>
  </div>
</div>
</div>
<hr>
...
<div class="ws-note w3-panel"><p><strong>Note:</strong> If you don't know HTML and CSS, <a href="/html/default.asp">we suggest that you 
  start by reading our HTML Tutorial</a>.</p>
</div>
...
<a target="_blank" href="tryit.asp?filename=tryhow_make_a_website_intro" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate cssHigh">
  .header {<br>&nbsp;&nbsp;padding: 80px; /* some padding */<br>&nbsp;&nbsp;text-align: center; /* center the text */<br>
  &nbsp; background: #1abc9c; 
  /* green background */<br>&nbsp; 
  color: white; /* white text color */<br>}<br><br>/* Increase the font size of the &lt;h1&gt; element */<br>
  .header h1 {<br>&nbsp; font-size: 40px;<br>}</div>
<p>
<a class="ws-btn" href="tryit.asp?filename=tryhow_make_a_website_header" target="_blank">Try it Yourself &raquo;</a></p>
</div>
...
<div class="w3-example">
<div class="w3-code notranslate cssHigh">
  /* Style the top navigation bar */<br>.navbar {<br>&nbsp;&nbsp;overflow: hidden; /* Hide overflow */<br>&nbsp;&nbsp;background-color: #333; 
  ...
  block, for responsive reasons (see below) */<br>&nbsp; color: white; /* White text color */<br>&nbsp; text-align: center; 
  /* Center the text */<br>&nbsp; 
...
<p>
<a class="ws-btn" href="tryit.asp?filename=tryhow_make_a_website_navbar" target="_blank">Try it Yourself &raquo;</a></p>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  ...
  */<br>&nbsp;&nbsp;padding: 20px; /* Some padding */<br>}<br><br>/* Main column */<br>.main {
  <br>&nbsp;&nbsp;flex: 70%; /* Set the width of the main content */<br>&nbsp;&nbsp;background-color: white; /* White background color */<br>&nbsp;&nbsp;padding: 20px; /* Some padding */<br>}<br></div>
<p>
<a class="ws-btn" href="tryit.asp?filename=tryhow_make_a_website_content" target="_blank">Try it Yourself &raquo;</a></p>
</div>
...
<div class="w3-code notranslate cssHigh">
  ...
  float: none;<br>&nbsp;&nbsp;&nbsp; width: 100%;<br>&nbsp;&nbsp;}<br>}<br></div>
<p>
<a class="ws-btn" href="tryit.asp?filename=tryhow_make_a_website_content_responsive" target="_blank">Try it Yourself &raquo;</a></p>
</div>
...
<div class="w3-example">
<div class="w3-code notranslate cssHigh">
  .footer {<br>&nbsp; padding: 20px; /* Some padding */<br>&nbsp;&nbsp;text-align: center; /* Center text*/<br>
  &nbsp; background: #ddd; 
  /* Grey background */<br>}</div>
<p>
<a class="ws-btn" href="tryit.asp?filename=tryhow_make_a_website_footer" target="_blank">Try it Yourself &raquo;</a></p>
</div>
<p>Congratulations! You have built a responsive website from scratch.</p>
<hr>

<h2>W3Schools Spaces</h2>
<p>If you want to create your own website and host your .html files, try our 
<strong>website builder</strong>, called <strong>W3schools Spaces</strong>:</p>
<div class="w3-light-grey w3-display-container w3-round w3-padding-large">
<p><img alt="W3Schools Spaces" src="/html/w3css_templatesny.jpg" class="w3-image" style="display:block;margin:auto;max-width:100%;"></p>
<a href="/spaces/" target="_blank" title="Get Your Own Website With W3schools Spaces" style="border-radius:25px;padding:12px 24px" class="ws-btn w3-display-middle">Get your own Website</a>
</div>
