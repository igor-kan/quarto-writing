...
<html lang="en-US">
<head>
<title>How To Make a Website with Bootstrap 5</title>
<meta charset="utf-8">
...
<h1>How TO - Make a Website with Bootstrap 5</h1>
<div class="w3-clear nextprev">
<a class="w3-left ws-btn" href="howto_website_bootstrap4.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_create_and_view.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a responsive website with Bootstrap 5.</p>
<hr>
<h2>Create a Website with Bootstrap 5</h2>
<div class="w3-content" style="max-width:1500px">
<iframe src="tryhow_website_bootstrap5.htm" class="w3-round" style="width:100%;border:5px solid #e9e9e9;height:600px"></iframe>
<div class="w3-row-padding" style="margin:16px -16px 0 -16px">
  <div class="w3-col m6">
    <a href="tryhow_website_bootstrap5.htm" target="_blank" class="ws-btn w3-padding-large ws-black w3-block demobtnx">Demo</a>
  </div>
  <div class="w3-col m6">
    <a href="tryit.asp?filename=tryhow_website_bootstrap5&stacked=h" target="_blank" class="ws-btn w3-padding-large w3-block">Try it Yourself</a>
  </div>
</div>
</div>
...
<p>Bootstrap 5 is the newest version of Bootstrap.</p>
  ...
  <p><strong>Tip:</strong> Ever heard about <strong>W3Schools Spaces</strong>? 
  Here you can create your Bootstrap website from scratch or use a template.</p>
...
<p><strong>Note:</strong> If you don't know Bootstrap, we suggest that you read our <a href="/bootstrap/default.asp">Bootstrap 3 Tutorial</a>, or our <a href="/bootstrap5/index.php">Bootstrap 5 Tutorial</a>.</p>
</div>
<!--
<hr>
