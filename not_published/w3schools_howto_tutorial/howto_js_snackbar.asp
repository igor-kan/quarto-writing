...
<a class="w3-left ws-btn" href="howto_css_responsive_floats.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_js_fullscreen.asp">Next &#10095;</a>
</div>
<hr>
...
<button onclick="myFunction()" class="ws-btn w3-dark-grey">Show Snackbar</button>
...
/* Hidden by default. Visible on click */<br>&nbsp;&nbsp;min-width: 250px; /* Set a default minimum width */<br>&nbsp;&nbsp;margin-left: -125px; /* Divide value of min-width by 2 */<br>&nbsp;&nbsp;background-color: #333; 
...
/* Add a z-index if needed */<br>&nbsp;&nbsp;left: 50%; /* Center the snackbar */<br>
  &nbsp; bottom: 30px; /* 
30px from the bottom */<br>}<br><br>/* Show the snackbar when clicking on a 
button (class added with JavaScript) */<br>#snackbar.show {<br>&nbsp;&nbsp;visibility: visible; /* Show the snackbar */<br>
  &nbsp; /* Add 
...
0;}<br>&nbsp;&nbsp;to {bottom: 30px; opacity: 1;}<br>}<br><br>@-webkit-keyframes fadeout {<br>&nbsp;&nbsp;from {bottom: 30px; opacity: 1;} <br>&nbsp;&nbsp;to {bottom: 0; 
opacity: 0;}<br>}<br><br>@keyframes 
fadeout {<br>&nbsp;&nbsp;from {bottom: 30px; opacity: 1;}<br>&nbsp;&nbsp;to {bottom: 0; opacity: 0;}<br>}</div>
</div>
<hr>
...
<div class="w3-code notranslate jsHigh">
   function myFunction() {<br>&nbsp; // Get the snackbar DIV<br>&nbsp;&nbsp;var x = document.getElementById(&quot;snackbar&quot;);<br><br>&nbsp; // Add 
the &quot;show&quot; class to DIV<br>&nbsp; x.className = &quot;show&quot;;<br><br>&nbsp;&nbsp;// After 3 seconds, remove the show class from DIV<br>&nbsp;&nbsp;setTimeout(function(){ x.className = x.className.replace(&quot;show&quot;, &quot;&quot;); }, 
3000);<br>}</div>
<a class="ws-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_js_snackbar" target="_blank">Try it Yourself &raquo;</a>
</div>
