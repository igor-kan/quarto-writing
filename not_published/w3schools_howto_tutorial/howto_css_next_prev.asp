...
<a class="w3-left ws-btn" href="howto_css_icon_buttons.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_css_more_button.asp">Next &#10095;</a>
</div>
<hr>
...
<div class="w3-bar">
  ...
  <button class="w3-button ws-green">Next &raquo;</button>
</div>
<br>
<div class="w3-bar">
...
<div class="w3-code notranslate cssHigh">
  ...
  color: black;<br>}<br><br>.next {<br>&nbsp;&nbsp;background-color: #04AA6D;<br>
  &nbsp; 
  color: white;<br>}<br><br>.round {<br>&nbsp; border-radius: 50%;<br>
  }</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_next_prev" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
