...
<a class="w3-left ws-btn" href="howto_css_hide_arrow_number.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_css_animated_search.asp">Next &#10095;</a>
</div>
<hr>
...
<div class="w3-code notranslate jsHigh">
  ...
  copyText.select(); <br>&nbsp; copyText.setSelectionRange(0, 99999); // For mobile 
  devices<br><br>&nbsp;&nbsp; 
  // Copy the text inside the text field<br>&nbsp; 
  navigator.clipboard.writeText(copyText.value);<br><br>&nbsp; // Alert the copied 
  text<br>&nbsp; alert(&quot;Copied the text: &quot; + copyText.value);<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_copy_clipboard" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a target="_blank" href="tryit.asp?filename=tryhow_js_copy_clipboard2" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
