...
<a class="w3-left ws-btn" href="howto_html_include.asp">&#10094; Previous</a>
	<a class="w3-right ws-btn" href="howto_css_loader.asp">Next &#10095;</a>
</div>
<hr>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_js_todo" class="ws-btn">Try it Yourself &raquo;</a></p>
<hr>
...
items */<br>ul li {<br>&nbsp;&nbsp;cursor: pointer;<br>&nbsp; position: relative;<br>
  &nbsp; 
padding: 12px 8px 12px 40px;<br>&nbsp; background: #eee;<br>&nbsp;&nbsp;font-size: 18px;<br>&nbsp;&nbsp;transition: 0.2s;<br><br>&nbsp;&nbsp;/* 
make the list items unselectable */<br>&nbsp;&nbsp;-webkit-user-select: none;<br>&nbsp;&nbsp;-moz-user-select: none;<br>
...
li.checked {<br>&nbsp;&nbsp;background: #888;<br>&nbsp;&nbsp;color: #fff;<br>&nbsp; text-decoration: line-through;<br>}<br>
<br>/* Add a &quot;checked&quot; mark when clicked on */<br>ul li.checked::before {<br>&nbsp;&nbsp;content: '';<br>
  &nbsp; 
position: absolute;<br>&nbsp; border-color: #fff;<br>&nbsp; 
border-style: solid;<br>&nbsp;&nbsp;border-width: 0 2px 2px 0;<br>&nbsp;&nbsp;top: 10px;<br>
  &nbsp; left: 16px;<br>&nbsp; 
transform: rotate(45deg);<br>&nbsp; height: 15px;<br>&nbsp; 
width: 7px;<br>}<br><br>/* Style the close button */<br>.close {<br>&nbsp; 
position: absolute;<br>&nbsp;&nbsp;right: 0;<br>&nbsp;&nbsp;top: 0;<br>&nbsp; padding: 12px 16px 12px 16px;<br>}<br><br>.close:hover {<br>
  &nbsp; background-color: #f44336;<br>&nbsp; 
color: white;<br>}<br>
<br>/* Style the header */<br>.header {<br>&nbsp; background-color: #f44336;<br>&nbsp; 
padding: 30px 40px;<br>&nbsp; color: white;<br>&nbsp;&nbsp;text-align: center;<br>}<br><br>/* Clear floats after the header */<br>.header:after {<br>
  &nbsp; 
content: &quot;&quot;;<br>&nbsp;&nbsp;display: table;<br>&nbsp;&nbsp;clear: both;<br>}<br><br>/* Style the input */<br>input {<br>&nbsp;&nbsp;margin: 0;<br>&nbsp;&nbsp;border: none;<br>&nbsp;&nbsp;border-radius: 0;<br>&nbsp;&nbsp;width: 75%;<br>&nbsp;&nbsp;padding: 10px;<br>&nbsp;&nbsp;float: left;<br>&nbsp;&nbsp;font-size: 16px;<br>}<br>
...
cursor: pointer;<br>&nbsp; transition: 0.3s;<br>&nbsp; 
  border-radius: 0;<br>}<br><br>.addBtn:hover {<br>&nbsp;&nbsp;background-color: #bbb;<br>}<br></div>
</div>
<hr>
...
<a target="_blank" href="tryit.asp?filename=tryhow_js_todo" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
