...
<html lang="en-US">
<head>
<title>How To Hide Scrollbars With CSS</title>
<meta charset="utf-8">
...
<h1>How TO - Hide Scrollbar</h1>
<div class="w3-clear nextprev">
  <a class="w3-left ws-btn" href="howto_css_custom_scrollbar.asp">&#10094; Previous</a>
  <a class="w3-right ws-btn" href="howto_css_force_scrollbars.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to hide scrollbars with CSS.</p>
<hr>

<h2>How To Hide Scrollbars</h2>
<p>Add <code class="w3-codespan">overflow: hidden;</code> to hide both the 
horizontal and vertical scrollbar.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  body {<br>&nbsp; overflow: hidden; /* Hide scrollbars */<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_hide_scrollbars" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>To only hide the vertical scrollbar, or only the horizontal scrollbar, use <code class="w3-codespan">overflow-y</code> or <code class="w3-codespan">overflow-x</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  body {<br>&nbsp; overflow-y: hidden; /* Hide vertical scrollbar */<br>&nbsp; 
  overflow-x: hidden; /* Hide horizontal scrollbar */<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_hide_scrollbars2" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="ws-note w3-panel">
<p>Note that <code class="w3-codespan">overflow: hidden</code> will also remove the functionality of the scrollbar. It is not possible to scroll inside the page.</p>
<p><strong>Tip:</strong> To learn more about the <code class="w3-codespan">overflow</code> property, go to our <a href="/css/css_overflow.asp">CSS Overflow Tutorial</a> or <a href="/cssref/pr_pos_overflow.asp">CSS overflow Property Reference</a>.</p>
</div>
<hr>
...
<hr>
<h2>Hide Scrollbars But Keep Functionality</h2>
<p>To hide the scrollbars, but still be able to keep scrolling, you can use the following code:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  /* Hide scrollbar for Chrome, Safari and Opera */<br>
  .example::-webkit-scrollbar {<br>&nbsp; display: none;<br>}<br><br>/* Hide scrollbar 
  for IE, Edge and Firefox */<br>.example {<br>&nbsp; -ms-overflow-style: none;&nbsp; /* 
  IE and Edge */<br>&nbsp; scrollbar-width: none;&nbsp; /* Firefox */<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_hide_scrollbar_keep_func" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>Webkit browsers, such as Chrome, Safari and Opera, supports the non-standard <code class="w3-codespan">::-webkit-scrollbar</code> pseudo element, which allows us to modify the look of the browser's scrollbar. IE and Edge supports the <code class="w3-codespan">-ms-overflow-style:</code> property, 
and Firefox supports the <code class="w3-codespan">scrollbar-width</code> property, which allows us to hide the scrollbar, but keep functionality.</p>
