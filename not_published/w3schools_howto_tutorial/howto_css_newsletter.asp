...
.x .container input[type=checkbox] {
    margin-top: 16px;
}
...
<div class="w3-clear nextprev">
  <a class="w3-left ws-btn" href="howto_css_form_icon.asp">&#10094; Previous</a>
  <a class="w3-right ws-btn" href="howto_css_stacked_form.asp">Next &#10095;</a>
</div>
<hr>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_newsletter" class="ws-btn">Try it Yourself &raquo;</a></p>
<hr>
...
<div class="w3-code notranslate cssHigh">
  ...
  <br>/* Add some padding and a grey background color to containers */<br>.container {<br>&nbsp;&nbsp;padding: 20px;<br>&nbsp;&nbsp;background-color: #f1f1f1;<br>}<br><br>/* Style the input elements and the 
  submit button */<br>
  ...
  opacity: 0.8;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_newsletter" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
