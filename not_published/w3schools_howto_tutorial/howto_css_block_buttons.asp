...
<div class="w3-clear nextprev">
  <a class="w3-left ws-btn" href="howto_css_more_button.asp">&#10094; Previous</a>
  <a class="w3-right ws-btn" href="howto_css_text_buttons.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to style block buttons (full-width) with CSS.</p>
<hr>

<button class="w3-button w3-block ws-green" style="padding:14px 28px">Block Button</button>
<hr>
...
<div class="w3-code notranslate cssHigh">
  .block {<br>&nbsp;&nbsp;display: block;<br>&nbsp;&nbsp;width: 100%;<br>&nbsp;&nbsp;border: none;<br>
  &nbsp; background-color: #04AA6D;<br>&nbsp; 
  padding: 14px 28px;<br>&nbsp; font-size: 16px;<br>&nbsp;&nbsp;cursor: pointer;<br>&nbsp;&nbsp;text-align: center;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_block_buttons" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
