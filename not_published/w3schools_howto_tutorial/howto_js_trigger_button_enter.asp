...
<a class="w3-left ws-btn" href="howto_js_detect_capslock.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_js_password_validation.asp">Next &#10095;</a>
</div>
<hr>
...
<div class="w3-code notranslate jsHigh">
  ...
  <br>// Execute a function when the user presses a key on the keyboard<br>input.addEventListener(&quot;keypress&quot;, 
  function(event) {<br>&nbsp; 
  // If the user presses the &quot;Enter&quot; key on the keyboard<br>&nbsp; if (event.key === 
  &quot;Enter&quot;) {<br>&nbsp;&nbsp;&nbsp; // Cancel the default action, if needed<br>&nbsp;&nbsp;&nbsp; event.preventDefault();<br>&nbsp;&nbsp;&nbsp; // Trigger the button element with a click<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;myBtn&quot;).click();<br>&nbsp; 
  }<br>});</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_trigger_button_enter" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p><strong>Tip:</strong> Learn more about the <a href="/jsref/event_key_key.asp">KeyboardEvent key Property</a> in our JavaScript Reference.</p>
