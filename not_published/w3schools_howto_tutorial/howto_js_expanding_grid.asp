...
<a class="w3-left ws-btn" href="howto_css_four_columns.asp">&#10094; Previous</a>
  <a class="w3-right ws-btn" href="howto_js_list_grid_view.asp">Next &#10095;</a>
</div>
<hr>
...
<a target="_blank" href="tryit.asp?filename=tryhow_js_expanding_grid" class="ws-btn">Try it Yourself &raquo;</a>
...
<div class="w3-code notranslate cssHigh">
  ...
  font-size: 25px;<br>&nbsp; cursor: pointer;<br>&nbsp;&nbsp;color: white;<br>}<br><br>.containerTab 
  {<br>&nbsp; padding: 20px;<br>&nbsp; color: white;<br>
  }<br><br>/* Clear floats after the 
  columns */<br>.row:after {<br>&nbsp; content: &quot;&quot;;<br>&nbsp;&nbsp;display: table;<br>
  &nbsp; clear: both;<br>}<br><br>/* Closable button inside the image */<br>.closebtn {<br>
  &nbsp; 
...
<div class="w3-code notranslate jsHigh">
  ...
  x[i].style.display = &quot;none&quot;;<br>&nbsp; }<br>&nbsp;&nbsp;document.getElementById(tabName).style.display = &quot;block&quot;;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_expanding_grid" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
