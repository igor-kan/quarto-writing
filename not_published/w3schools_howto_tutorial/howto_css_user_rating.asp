...
<a class="w3-left ws-btn" href="howto_css_star_rating.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_css_overlay.asp">Next &#10095;</a>
</div>
<hr>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_user_rating" class="ws-btn">Try it Yourself &raquo;</a></p>
<hr>
...
<div class="w3-code notranslate cssHigh">
  * {<br>&nbsp; box-sizing: border-box;<br>}<br><br>body {<br>&nbsp; 
  font-family: Arial;<br>&nbsp; margin: 0 auto; /* Center website */<br>&nbsp;&nbsp;max-width: 800px; /* Max width */<br>&nbsp;&nbsp;padding: 20px;<br>}<br><br>.heading {<br>&nbsp; font-size: 25px;<br>
  &nbsp; 
  margin-right: 25px;<br>}<br><br>.fa {<br>&nbsp; font-size: 25px;<br>}<br><br>.checked {<br>&nbsp;&nbsp;color: orange;<br>}<br><br>/* Three column layout */<br>.side {<br>
  &nbsp; 
  float: left;<br>&nbsp;&nbsp;width: 15%;<br>&nbsp;&nbsp;margin-top: 10px;<br>}<br><br>.middle {<br>&nbsp;&nbsp;float: left;<br>&nbsp;&nbsp;width: 70%;<br>&nbsp;&nbsp;margin-top: 10px;<br>}<br><br>/* Place text to the right */<br>
  .right {<br>&nbsp; text-align: right;<br>}<br><br>/* Clear floats after the columns 
  */<br>.row:after {<br>&nbsp;&nbsp;content: &quot;&quot;;<br>&nbsp;&nbsp;display: table;<br>&nbsp;&nbsp;clear: both;<br>}<br>
  ...
  background-color: #04AA6D;}<br>.bar-4 {width: 30%; height: 18px; 
  ...
  (max-width: 400px) {<br>&nbsp;&nbsp;.side, .middle {<br>&nbsp;&nbsp;&nbsp;&nbsp;width: 100%;<br>
  &nbsp;&nbsp;}<br>&nbsp;&nbsp;/* Hide the right 
  column on small screens */<br>&nbsp;&nbsp;.right {<br>&nbsp;&nbsp;&nbsp; 
  display: none;<br>&nbsp;&nbsp;}<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_user_rating" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>
<div class="w3-clear nextprev">
<a class="w3-left ws-btn" href="howto_css_star_rating.asp">&#10094; Previous</a>
