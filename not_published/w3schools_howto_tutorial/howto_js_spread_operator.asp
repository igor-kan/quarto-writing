...
<h1>How TO - The Spread Operator (...)</h1>
<div class="w3-clear nextprev">
<a class="w3-left ws-btn" href="howto_js_sort_numeric_array.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_js_scroll_into_view.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to use the three dots operator (...) a.k.a the spread operator in JavaScript.</p>
<hr>

<h2>The Spread Operator</h2>
<p>The JavaScript spread operator (<code class="w3-codespan">...</code>) expands 
an iterable (like an array) into more elements.</p>
<p>This allows us to quickly copy all or parts of an existing array into another 
array:</p>
...
<div class="w3-code notranslate jsHigh">
  const numbersOne = [1, 2, 3];<br>const numbersTwo = [4, 5, 6];<br>const 
  numbersCombined = [...numbersOne, ...numbersTwo];</div>
<a class="ws-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_js_spread_operator" target="_blank">Try it Yourself &raquo;</a>
</div>

<p>The spread operator is often used to extract only what's needed from an 
array:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
  const numbers = [1, 2, 3, 4, 5, 6];<br><br>const [one, two, ...rest] = 
  numbers;</div>
<a class="ws-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_js_spread_operator2" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
  const myVehicle = {<br>&nbsp; brand: 'Ford',<br>&nbsp; model: 'Mustang',<br>&nbsp; 
  color: 'red'<br>}<br><br>const updateMyVehicle = {<br>&nbsp; type: 'car',<br>&nbsp; year: 
  2021, <br>&nbsp; color: 'yellow'<br>}<br><br>const myUpdatedVehicle = {...myVehicle, 
  ...updateMyVehicle}</div>
<a class="ws-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_js_spread_operator3" target="_blank">Try it Yourself &raquo;</a>
</div>


<div class="ws-note w3-panel">
<p>Notice the properties that did not match were combined, but the property that did match, <code class="w3-codespan">color</code>, was overwritten by the last object that was passed, <code class="w3-codespan">updateMyVehicle</code>. The resulting color is now yellow.</p>
</div>
<p><strong>See also</strong>: <a href="/js/js_es6.asp">JavaScript ES6 Tutorial</a>.</p>
