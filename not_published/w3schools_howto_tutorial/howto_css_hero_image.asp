...
<div class="w3-clear nextprev">
  <a class="w3-left ws-btn" href="howto_css_form_on_image.asp">&#10094; Previous</a>
  <a class="w3-right ws-btn" href="howto_css_blurred_background.asp">Next &#10095;</a>
</div>
<hr>
...
<p style="margin-top:0"><a target="_blank" href="tryit.asp?filename=tryhow_css_hero_image" class="ws-btn">Try it Yourself &raquo;</a></p>
<hr>
...
<div class="w3-code notranslate cssHigh">
  ...
  */<br>&nbsp; height: 
  ...
  nicely on all screens */<br>&nbsp; background-position: center;<br>&nbsp;&nbsp;background-repeat: no-repeat;<br>
  &nbsp; background-size: cover;<br>&nbsp; 
  position: relative;<br>
  }<br><br>/* Place text in the middle of the image */<br>
  .hero-text {<br>&nbsp; 
  text-align: center;<br>&nbsp; position: absolute;<br>&nbsp;&nbsp;top: 50%;<br>&nbsp; left: 50%;<br>&nbsp;&nbsp;transform: 
  translate(-50%, -50%);<br>&nbsp;&nbsp;color: white;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_hero_image" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
