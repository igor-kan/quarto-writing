...
<a class="w3-left ws-btn" href="howto_css_portfolio_gallery.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_js_image_zoom.asp">Next &#10095;</a>
</div>
<hr>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_js_portfolio_gallery_filter" class="ws-btn">Try it Yourself &raquo;</a></p>
...
<div class="w3-code notranslate cssHigh">
  * {<br>&nbsp; box-sizing: border-box;<br>}<br><br>body {<br>&nbsp; 
  background-color: #f1f1f1;<br>&nbsp; padding: 20px;<br>&nbsp;&nbsp;font-family: Arial;<br>}<br><br>/* Center 
  website */<br>.main {<br>&nbsp;&nbsp;max-width: 1000px;<br>&nbsp; 
  margin: auto;<br>}<br><br>h1 {<br>&nbsp; 
  font-size: 50px;<br>&nbsp; word-break: break-all;<br>}<br><br>.row {<br>&nbsp;&nbsp;margin: 8px -16px;<br>}<br><br>/* Add padding BETWEEN each column (if you 
  want) */<br>.row,<br>.row &gt; 
  ...
  */<br>}<br>
  <br>/* Clear floats after rows */ <br>.row:after {<br>&nbsp;&nbsp;content: &quot;&quot;;<br>&nbsp;&nbsp;display: table;<br>&nbsp; 
  clear: both;<br>}<br><br>/* Content */<br>.content {<br>&nbsp; 
  background-color: white;<br>&nbsp; padding: 10px;<br>}<br><br>/* 
  The &quot;show&quot; class is added to the filtered elements */<br>.show {<br>
  &nbsp; display: block;<br>}<br>
...
<div class="w3-code notranslate jsHigh">
  ...
  <a class="ws-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_js_portfolio_gallery_filter" target="_blank">Try it Yourself &raquo;</a>
</div>
