...
<a class="w3-left ws-btn" href="howto_css_glowing_text.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_css_sticky_element.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a fixed/sticky footer with CSS.</p>
<hr>

<iframe src="tryhow_css_fixed_footer.htm" style="width:100%;height:300px;border:1px solid #999;background-color:#fff;"></iframe>
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_fixed_footer" class="ws-btn">Try it Yourself &raquo;</a></p>
...
<div class="w3-code notranslate htmlHigh">
  ...
  background-color: red;<br>&nbsp;&nbsp;color: white;<br>&nbsp;&nbsp;text-align: center;<br>}<br>&lt;/style&gt;<br><br>&lt;div class="footer"&gt;<br>&nbsp; &lt;p&gt;Footer&lt;/p&gt;<br>
  &lt;/div&gt;</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_fixed_footer" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
