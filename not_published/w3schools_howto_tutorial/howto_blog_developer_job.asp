...
<html lang="en-US">
<head>
<title>How To Get a Developer Job</title>
<meta charset="utf-8">
...
<h1>How TO - Get a Developer Job</h1>
<div class="w3-clear nextprev">
<a class="w3-left ws-btn" href="howto_js_speed_converter.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_blog_become_frontenddev.asp">Next &#10095;</a>
</div>
<hr>
<div class="ws-info intro w3-panel">
<p>Everyone can become a developer.</p>
<p>You can find lots of free content on the internet.</p>
<p>Landing your first developer job can be hard.</p>
<p>The most important thing is to never give up.</p>
<p>Practice every day to become better.</p>
</div>
<hr>

<h2>What does a developer do</h2>
<p>A developer is someone who make things happen on a computer.</p>
<p>This can be to create a website, web application, or to create a game.</p>
<p>It can be both a hobby, a job - or a jobby ;+]</p>
<p>It is creative and fun to build something that works!</p>

<h2>What does it take to become a developer</h2>
<p>Set a goal of which type of developer you want to become. E.G. <strong>Front-End</strong> or <strong>Back-End</strong>.</p>
<p>Decide which progamming languages to learn.</p>
<p><strong>Read, practice, and build with code.</strong></p>
<p>Get noticed by someone who can give you an opportunity.</p>
<p>Never give up.</p>
...
<div class="ws-note w3-panel">
  ...
  <p>You also think of Front-End as <strong>client-side</strong> and Back-End as <strong>server-side</strong>.</p>
</div>
  <hr>


<h2>Where do I start</h2>
<p>HTML, CSS and JavaScript are the basic languages that you need to know to create a website.</p>
<p>To become a web developer, start with the subjects below, in the following order:</p>
...
<ol>
    ...
    <a class="ws-btn w3-round w3-margin-top w3-margin-bottom" href="/html/default.asp" target="_blank"><span>Learn HTML &#10095;</span></a>
    <li><strong>Style with CSS.</strong> The next step is to learn CSS, to set the layout of your web page with beautiful colors, fonts, and much more.</li>
        <a class="ws-btn w3-round w3-margin-top w3-margin-bottom" href="/css/default.asp" target="_blank"><span>Learn CSS &#10095;</span></a>
    <li><strong>Make it interactive with JavaScript.</strong> After studying HTML and CSS, you should learn JavaScript to create dynamic and interactive web pages for your users.</li>
        <a class="ws-btn w3-round w3-margin-top w3-margin-bottom" href="/js/default.asp" target="blank" ><span>Learn JavaScript &#10095;</span></a>
</ol>

<div class="w3-panel ws-note"><p>Have you ever heard about <strong>W3Schools Spaces</strong>? Here you can build a website using HTML, CSS, and JavaScript.</p>
<a class="ws-btn ws-black" href="https://www.w3spaces.com" target="_blank">Get started for free &#10095;</a>
<p class="w3-small"><em>* no credit card required</em></p>
</div>

<p>Learn and practice JavaScript and CSS frameworks and libraries such as:
  <ul>
    <li><p><strong>Bootstrap</strong> - <span><a href="/bootstrap/bootstrap_ver.asp" target="_blank">Learn Bootstrap</a></span></p>
    <li><p><strong>SASS</strong> - <span><a href="/sass/default.asp" target="_blank"> Learn SASS</a></span></p>
    <li><p><strong>jQuery</strong> - <span><a href="/jquery/default.asp" target="_blank">Learn jQuery</a></span></p>
    <li><p><strong>React</strong> - <span><a href="/react/default.asp" target="_blank">Learn React</a></span></p>
    <li><p><strong>Version control with Git</strong> - <span><a href="/git/default.asp" target="_blank">Learn Git</a></span></p>
    </ul>
<p>Knowing the frameworks and libraries will make you more attractive in the job market.</p>

<h2>How can I learn Back-End?</h2>
<p>HTML, CSS, and JavaScript are used to create static websites.</p>
<p>To make the websites dynamic (databases, contact forms, user access, and so on) you need to use Back-End programming languages.</p>
<p>Here are some popular Back-End languages:</p>
  <ul>
    <li><p><strong>Node.js</strong> - <span><a href="/nodejs/default.asp" target="_blank">Learn Node.js</a></span></p>
    <li><p><strong>Python</strong> - <span><a href="/python/default.asp" target="_blank"> Learn Python</a></span></p>
    <li><p><strong>Java</strong> - <span><a href="/java/default.asp" target="_blank">Learn Java</a></span></p>
    <li><p><strong>Kotlin</strong> - <span><a href="/kotlin/index.php" target="_blank">Learn Kotlin</a></span></p>
    <li><p><strong>C#</strong> - <span><a href="/cs/index.php" target="_blank">Learn C#</a></span></p>
    <li><p>Browse our site for other popular languages - <span><a href="https://www.w3schools.com/" target="_blank">Visit W3Schools.com</a></span></p>

    </ul>

    <div class="ws-info w3-panel">
  <p>People who work with creating websites and web applications are called Front-End Developers.</p>
  <p>People who work with creating applications are called Back-End Developers.</p>
    <p>People who work with both Front-End and Back-End are called Fullstack Developers.</p>
  </div>
  <p>We recommend to begin your journey with Front-End.</p>
<hr>
...
<h2>How to get your first job in <strong>Ten</strong> steps</h2>
<p>There are many ways of getting your first job.</p>
<p>The order of the steps is a suggestion.</p>
<p><strong>You can do the steps in the order that you like.</strong><p/>
<hr>

<h2>Preparations: Set a goal</h2>
<p>Commit to your goal.</p>
<p>Create a plan.</p>
<p>Dedicate time every day and week for learning and practice.</p>
<p>Being consistent is the the most important thing!</p>
<hr>

<div class="ws-note w3-panel">
  <p>There is really no reason to pay for an expensive Bootcamp or monthly subscription to get access to content.</p>
  <p>You can find lots of free content open on the internet.</p>
  <p>Work your plan, build, and be consistent. <strong>You will be fine!</strong></p>
  </div>

<h2>Step One: Master the languages</h2>
<p>Read, practice and build with the languages that you have decided to learn.</p>
<p>Start with the frameworks and libraries once you feel confident with the main languages.</p>
<p>Always be building.</p>
<hr>

<h2>Step Two: Build an online resume</h2>
<p>An online resume is a digital version of a resume.</p>
...
<div class="ws-info w3-panel">
<p>Here is a tutorial on how to create your online resume: <span><a href="howto_website_create_resume.asp" target="_blank">How To Create an Online Resume</a></span></p>
</div>
<hr>

<h2>Step Three: Build a portfolio site</h2>
...
<div class="ws-info w3-panel">
<p>Here is a tutorial on how to create your portfolio: <span><a href="howto_website_create_portfolio.asp" target="_blank">How To Create a Portfolio</a></span></p>
</div>
<hr>

<h2>Step Four: Search and apply for relevant jobs (ongoing)</h2>
<p>Always be searching and applying for jobs.</p>
<p>Typical entry jobs are Intern or Junior Developer.</p>
<p>Remember that getting the first job is the hardest.</p>
<p>Landing the next one is easier.</p>
<hr>

<h2>Step Five: Look for freelance gigs</h2>
<p>Freelance gigs are good to build relevant work experience.</p>
<p>Create your profile with a gig platform.</p>
<p>Search and apply for relevant engagements.</p>
<p>Market your profile actively.</p>
<p>Add completed engagements to your Resume and Portfolio.</p>
<hr>

<h2>Step Six: Work on projects</h2>
<p>Working on your own projects improves your skills.</p>
<p>Share your completed projects with others.</p>
<p>Keep practicing. Consistency is the most important thing!</p>
<div class="w3-panel ws-info"><p>We have created a code editor for you called, <strong>W3Schools Spaces</strong>? Here you can build a website using HTML, CSS, and JavaScript.</p>
<a class="ws-btn ws-green" href="https://www.w3spaces.com" target="_blank">Get started for free &#10095;</a>
<p class="w3-small"><em>* no credit card required</em></p>
</div>
<hr>

<h2>Step Seven: Apply for internships</h2>
<p>Internships are one of the best ways to enter the job market.</p>
<p>It can help you to get relevant experience such as:</p>
<ul>
  <li>Working on solving real world problems</li>
  <li>Working as a team (this is important). To not only work solo</li>
  <li>Learning from others</li>
  <li>Getting feedback on your code</li>
  <li>Learning agile methods</li>
  <li>Get a chance to prove yourself with a company</li>
  </ul>
  <hr>

  <h2>Step Eight: Upload your code to Github and contribute</h2>
  <p>Github is an open-source repository.</p>
  <p>It is a community for programmers.</p>
  <p>Having your code on github allows for collaboration with others.</p>
  <p>Participating in an open-source project is a good way to get experience. Look for one!</p>
  <div class="ws-info w3-panel">
  <p>Here is a tutorial for you to learn Git: <span><a href="/git/default.asp" target="_blank">Learn Git</a></span></p>
  </div>
  <hr>

  <h2>Step Nine: Join a developer community</h2>
  <p>Community is a place where you can connect with others.</p>
  <p>Participating in a community can make the learning easier.</p>
  <p>Sharing different perspectives is a good way to learn.</p>
  <p>You can give back by contributing with what you have learned.</p>
  <p>Connect with others and network, so that you can get noticed.</p>
  <p>Maybe you can find a mentor in the community crowd?</p>

  <div class="w3-panel ws-note">
    <p>Joining a community is great to connect with other developers to learn, collaborate, and network.</p>
    <p>We have created a community for just this.</p>
    <a class="ws-btn ws-black w3-white" href="https://discord.gg/GVJeD3kWKj" target="_blank">Join the W3Schools Community &#10095;</a>
</div>
<hr>

<h2>Step Ten: Grow your online presence</h2>
<p>Showcase your work on social medias.</p>
<p>Contribute by writing relevant content such as.</p>
<ul>
  <li>Your projects</li>
  <li>Articles</li>
  <li>Contributions to an open-source platform</li>
  </ul>
<hr>
...
<div class="w3-center ws-black" style="color:white;margin-left:-32px;margin-right:-32px">
  <div style="opacity:0.96;margin:auto;padding:70px 20px;">
    ...
    <h3 style="margin-bottom:40px;font-family: 'Source Sans Pro', sans-serif;font-size:24px">Everything you need right in the browser. It is easy to use - try it!</h3>
    <a href="http://profile.w3schools.com/log-in?redirect_url=https%3A%2F%2Fspaces.w3schools.com%2Fcreatespace%2Fstepone" class="ws-btn" style="border-radius:25px;font-size:22px;width:300px;padding: 11px 18px;margin-bottom:15px" title="Get Started With W3Spaces">Get Started for Free</a><br>
    <br>
