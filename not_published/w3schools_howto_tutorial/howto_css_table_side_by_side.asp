...
<html lang="en-US">
<head>
<title>How To Create Side-by-side Tables</title>
<meta charset="utf-8">
...
<h1>How TO - Side-by-side Tables</h1>
<div class="w3-clear nextprev">
  <a class="w3-left ws-btn" href="howto_html_table_nested.asp">&#10094; Previous</a>
  <a class="w3-right ws-btn" href="howto_css_table_responsive.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create side-by-side tables with CSS.</p>
<hr>

<div class="w3-row-padding w3-hide-small" style="margin-left:-16px;margin-right:-16px">
<div class="w3-col s6">
<table class="ws-table-all w3-border">
  <tr>
    <th>Firstname</th>
    <th>Lastname</th> 
    <th>Age</th>
...
<h2>How To Place Tables Side by Side</h2>
<p>How to create side-by-side tables with the CSS <code class="w3-codespan">float</code> property:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  * {<br>&nbsp; box-sizing: border-box;<br>}<br><br>/* Create a two-column 
  layout */<br>.column {<br>&nbsp; float: left;<br>&nbsp; 
  width: 50%;<br>&nbsp; padding: 5px;<br>}<br><br>/* Clearfix (clear floats) */<br>.row::after {<br>&nbsp; 
  content: &quot;&quot;;<br>&nbsp; clear: both;<br>&nbsp; display: table;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_table_side_by_side&stacked=h" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p>How to create side-by-side tables with the CSS <code class="w3-codespan">flex</code> property:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  * {<br>&nbsp; box-sizing: border-box;<br>}<br><br>.row {<br>&nbsp; display: flex;<br>}<br><br>.column {<br>&nbsp; flex: 50%;<br>&nbsp; padding: 5px;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_table_side_by_side_flex&stacked=h" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
<p><strong>Note:</strong> Flexbox is not supported in Internet Explorer 10 and earlier versions. It is up to you if you want to use floats or flex. However, if you need support for IE10 and down, you should use float.</p>
...
<p>The example above will not look good on a mobile device, as two columns will take up too much space of the page. To create a responsive table, that should go from a two-column layout to a full-width layout on mobile devices, add the following media queries:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  /* Responsive layout - makes the two columns stack on top of each other 
  instead of next to each other on screens that are smaller than 600 px */<br>
  @media screen and (max-width: 600px) {<br>&nbsp; .column {<br>&nbsp;&nbsp;&nbsp; 
  width: 100%;<br>&nbsp; }<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_table_side_by_side2" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>


<p><strong>Tip:</strong> Go to our <a href="/css/css_table.asp">CSS Tables Tutorial</a> to learn more about 
how to style 
tables.</p>
<p><strong>Tip:</strong> Go to our <a href="/css/css_float.asp">CSS Float Tutorial</a> to learn more about the float property.</p>
<p><strong>Tip:</strong> Go to our <a href="/css/css3_flexbox.asp">CSS Flexbox Tutorial</a> to learn more about the flex property.</p>
