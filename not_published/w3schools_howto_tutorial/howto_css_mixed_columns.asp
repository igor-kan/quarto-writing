...
<a class="w3-left ws-btn" href="howto_js_list_grid_view.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_css_column_cards.asp">Next &#10095;</a>
</div>
<hr>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_mixed_columns" class="ws-btn">Try it Yourself &raquo;</a></p>
...
<div class="w3-code notranslate cssHigh">
  /* Create four equal columns that floats next to each other */<br>.column {<br>&nbsp;&nbsp;float: left;<br>
  &nbsp; width: 25%;<br>}<br><br>/* Clear floats */<br>
  ...
  .column {<br>&nbsp;&nbsp;&nbsp;&nbsp;width: 50%;<br>&nbsp;&nbsp;}<br>}<br><br>/* Responsive layout - makes the two columns 
  stack on top of each other instead of next to each other */<br>@media 
  screen and (max-width: 600px) {<br>&nbsp;&nbsp;.column {<br>&nbsp;&nbsp;&nbsp; 
  width: 100%;<br>&nbsp;&nbsp;}<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_mixed_columns" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
