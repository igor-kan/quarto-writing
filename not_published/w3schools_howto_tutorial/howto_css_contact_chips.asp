...
<div class="w3-clear nextprev">
  <a class="w3-left ws-btn" href="howto_css_overlay.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_css_cards.asp">Next &#10095;</a>
</div>
<hr>
...
border-radius: 25px;<br>&nbsp; background-color: #f1f1f1;<br>}<br><br>.chip img {<br>
  &nbsp; 
float: left;<br>&nbsp; margin: 0 10px 0 -25px;<br>&nbsp;&nbsp;height: 50px;<br>&nbsp;&nbsp;width: 50px;<br>
  &nbsp; 
border-radius: 50%;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_contact_chips" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
{<br>&nbsp;&nbsp;color: #000;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_contact_chips_close" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
