...
<div class="w3-clear nextprev">
  <a class="w3-left ws-btn" href="howto_css_display_element_hover.asp">&#10094; Previous</a>
  <a class="w3-right ws-btn" href="howto_js_collapsible.asp">Next &#10095;</a>
</div>
<hr>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_js_popup" class="ws-btn">Try it Yourself &raquo;</a></p>
<hr>
...
/* Popup container */<br>.popup {<br>&nbsp;&nbsp;position: relative;<br>&nbsp;&nbsp;display: inline-block;<br>&nbsp;&nbsp;cursor: pointer;<br>}<br><br>/* The actual popup (appears on top) 
*/<br>.popup .popuptext 
{<br>&nbsp;&nbsp;visibility: hidden;<br>&nbsp;&nbsp;width: 
160px;<br>&nbsp;&nbsp;background-color: #555;<br>&nbsp;&nbsp;color: #fff;<br>&nbsp; text-align: center;<br>&nbsp;&nbsp;border-radius: 6px;<br>&nbsp;&nbsp;padding: 8px 0;<br>&nbsp;&nbsp;position: absolute;<br>&nbsp;&nbsp;z-index: 1;<br>&nbsp;&nbsp;bottom: 125%;<br>&nbsp;&nbsp;left: 50%;<br>
  &nbsp; 
margin-left: -80px;<br>}<br><br>/* Popup arrow */<br>.popup .popuptext::after {<br>&nbsp;&nbsp;content: &quot;&quot;;<br>
  &nbsp; position: absolute;<br>&nbsp; 
top: 100%;<br>&nbsp;&nbsp;left: 50%;<br>&nbsp;&nbsp;margin-left: -5px;<br>&nbsp;&nbsp;border-width: 5px;<br>&nbsp;&nbsp;border-style: solid;<br>
...
myFunction() {<br>&nbsp;&nbsp;var popup = document.getElementById(&quot;myPopup&quot;);<br>&nbsp;&nbsp;popup.classList.toggle(&quot;show&quot;);<br>}<br>&lt;/script&gt;<br></div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_popup" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
