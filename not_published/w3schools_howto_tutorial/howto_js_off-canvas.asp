...
<a class="w3-left ws-btn" href="howto_js_fullscreen_overlay.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_css_sidenav_buttons.asp">Next &#10095;</a>
</div>
<hr>
...
<a href="javascript:void(0)">About</a>
  ...
  <button class="ws-btn w3-dark-grey w3-padding w3-margin-bottom" onclick="openOffcanvas()">Open Off-Canvas Menu</button><br>
  <button class="ws-btn w3-dark-grey w3-padding w3-margin-bottom" onclick="openNav3();openOffcanvas()">Off-Canvas Menu w/opacity</button><br>
...
<a target="_blank" href="tryit.asp?filename=tryhow_js_sidenav_push" class="ws-btn">Try it Yourself &raquo;</a>
...
top: 0;<br>&nbsp; left: 0;<br>&nbsp;&nbsp;background-color: #111; /* Black*/<br>&nbsp;&nbsp;overflow-x: hidden; /* Disable horizontal scroll */<br>&nbsp;&nbsp;padding-top: 60px; /* Place content 60px from the top */<br>&nbsp;&nbsp;transition: 0.5s; /* 0.5 second transition effect to slide in the sidenav */<br>
}<br><br>/* The navigation menu links */<br>.sidenav a {<br>&nbsp; padding: 8px 8px 8px 32px;<br>
  &nbsp; 
text-decoration: none;<br>&nbsp; font-size: 25px;<br>&nbsp; 
color: #818181;<br>&nbsp;&nbsp;display: block;<br>&nbsp;&nbsp;transition: 0.3s;<br>}<br><br>/* When you mouse over the navigation links, 
