...
<h1>How TO - Make a Static Website</h1>
<div class="w3-clear nextprev">
<a class="w3-left ws-btn" href="howto_website_host_staticwebsite.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_website.asp">Next &#10095;</a>
</div>

<div class="ws-info intro w3-panel">
<p>A static website has fixed content</p>
<p>It does not require programming languages to build one.</p>
<p>It is the easiest form of website to create.</p>
<p>Static websites are build of HTML, CSS, and JavaScript.</p>
<a class="ws-btn w3-round w3-margin-top margin-bottom" href="/spaces/" target="_blank">Get started for free &raquo;</a>
</div>
<hr>

<h2>Why create a static website?</h2>
<p>Static websites are quick and easy to create.</p>
<p>It is cheap to host.</p>
<p>Static websites are secure.</p>
<p>It is fun and you can create awesome sites with HTML, CSS, and JavaScript.</p>
<hr>


<h2>What do I need to know to build a static website</h2>
...
<ol>
    ...
    <a class="ws-btn w3-round w3-margin-top w3-margin-bottom" href="/html/default.asp" target="_blank">Learn HTML &raquo;</a>
    <li><strong>Style with CSS.</strong> The next step is to learn CSS, to set the layout of your web page with beautiful colors, fonts, and much more.</li>
        <a class="ws-btn w3-round w3-margin-top w3-margin-bottom" href="/css/default.asp" target="_blank">Learn CSS &raquo;</a>
    <li><strong>Make it interactive with JavaScript.</strong> After studying HTML and CSS, you should learn JavaScript to create dynamic and interactive web pages for your users.</li>
        <a class="ws-btn w3-round w3-margin-top w3-margin-bottom" href="/js/default.asp" target="blank">Learn JavaScript &raquo;</a>
</ol>
<div class="w3-panel ws-note"><p>The best way to learn is to get practical. Start building today!</p>
</div>
<hr>

<h2>Create a static website with W3Schools Spaces</h2>
<p>Spaces is a personal place where you can build and experiment with code and host your website.</p>
<p>With Spaces you can build static sites with HTML, CSS, and JavaScript.</p>
<p>Everything you need right in the browser.</p>
<a class="ws-btn w3-round margin-bottom" href="/howto/howto_website_create_website.asp" target="_blank">Learn more &raquo;</a>
<hr>

<h2>How do I get started</h2>
<p>There are two ways to start building a static website.</p>
<p>Building from <strong>scratch</strong> or using a <strong>template</strong>.</p>
<hr>
...
<h2>Building a static webpage from scratch</h2>
...
<div class="w3-panel ws-info">
    <p>There are many static website templates available in W3Schools Spaces. They can be loaded directly into the service.</p>
...
<a href="/w3css/tryw3css_templates_fashion_blog.htm" target="_blank" title="Fashion Blog Demo"><img src="img_temp_fashion_blog.png" style="width:98%;margin:20px 0" alt="Fashion Blog Template" loading="lazy"></a><br>
<div class="w3-row">
  <div class="w3-col m6">
    <a href="/w3css/tryw3css_templates_fashion_blog.htm" target="_blank" class="ws-btn w3-padding-large ws-black" style="width:98.5%">Demo</a>
  </div>
  <div class="w3-col m6">
    <a href="/w3css/tryit.asp?filename=tryw3css_templates_fashion_blog&amp;stacked=h" target="_blank" class="ws-btn w3-padding-large ws-black" style="width:98.5%">Try it Yourself</a>
  </div>
</div>
</div>
</div>
...
<div class="w3-content" style="max-width:800px">
<a href="/w3css/tryw3css_templates_photo3.htm" target="_blank" title="Photo Template"><img src="img_temp_photo.png" style="width:98%;margin:20px 0" alt="Photo Template" loading="lazy"></a><br>
<div class="w3-row">
  <div class="w3-col m6">
    <a href="/w3css/tryw3css_templates_photo3.htm" target="_blank" class="ws-btn w3-padding-large ws-black" style="width:98.5%">Demo</a>
  </div>
  <div class="w3-col m6">
    <a href="/w3css/tryit.asp?filename=tryw3css_templates_photo3&amp;stacked=h" target="_blank" class="ws-btn w3-padding-large ws-black" style="width:98.5%">Try it Yourself</a>
  </div>
</div>
</div>
</div>
...
<div class="w3-content" style="max-width:800px">
<a href="/w3css/tryw3css_templates_parallax.htm" target="_blank" title="Parallax Demo"><img src="img_temp_parallax.png" style="width:98%;margin:20px 0" alt="Parallax Template" loading="lazy"></a><br>
<div class="w3-row">
  <div class="w3-col m6">
    <a href="/w3css/tryw3css_templates_parallax.htm" target="_blank" class="ws-btn w3-padding-large ws-black" style="width:98.5%">Demo</a>
  </div>
  <div class="w3-col m6">
    <a href="/w3css/tryit.asp?filename=tryw3css_templates_parallax&amp;stacked=h" target="_blank" class="ws-btn w3-padding-large w3-black" style="width:98.5%">Try it Yourself</a>
  </div>
</div>
</div>
</div>
