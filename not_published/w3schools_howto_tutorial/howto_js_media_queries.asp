...
<a class="w3-left ws-btn" href="howto_js_draggable.asp">&#10094; Previous</a>
<a class="w3-right ws-btn" href="howto_syntax_highlight.asp">Next &#10095;</a>
</div>
<hr>
...
<div class="w3-code notranslate jsHigh">
  function myFunction(x) {<br>&nbsp; if (x.matches) { // If media query matches<br>&nbsp;&nbsp;&nbsp; 
  document.body.style.backgroundColor = &quot;yellow&quot;;<br>&nbsp; } else {<br>&nbsp;&nbsp;&nbsp; 
  document.body.style.backgroundColor = &quot;pink&quot;;<br>&nbsp; }<br>}<br><br>// 
  Create a MediaQueryList object<br>var x = window.matchMedia(&quot;(max-width: 
  700px)&quot;)<br><br>// Call listener function at run time<br>myFunction(x);<br>
  <br>// Attach listener function on state changes<br>
  x.addEventListener(&quot;change&quot;, function() {<br>&nbsp; myFunction(x);<br>});</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_matchmedia" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
