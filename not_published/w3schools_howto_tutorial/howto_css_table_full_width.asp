...
<html lang="en-US">
<head>
<title>How To Create a Full Width Table</title>
<meta charset="utf-8">
...
<h1>How TO - Full-width Table</h1>
<div class="w3-clear nextprev">
  <a class="w3-left ws-btn" href="howto_css_table_center.asp">&#10094; Previous</a>
  <a class="w3-right ws-btn" href="howto_html_table_nested.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a full-width table with CSS.</p>
<hr>

<p>A table that does not have a set <strong>width</strong>:</p>
<table class="w3-table w3-border" style="width:auto">
  <tr>
    <th>Firstname</th>
    <th>Lastname</th> 
    <th>Age</th>
...
<br>
<p>A <strong>full-width</strong> table:</p>
...
<h2>How To Create a Full-width Table</h2>
<p>To create a full-width table, use <code class="w3-codespan">width: 100%</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  table {<br>&nbsp; width: 100%;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_table_fullwidth" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
