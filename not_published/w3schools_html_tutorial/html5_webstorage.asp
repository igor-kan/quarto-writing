...
<hr>
<p class="intro">HTML Web Storage API; better than cookies.</p>
<hr>

<!--start-->
<h2>What is HTML Web Storage?</h2>
<p>With web storage, applications can store data locally within the user's browser.</p>
<p>Before HTML5, application data had to be stored in cookies, included in every server request. Web storage is more secure, and large amounts of data 
...
<ul>
  <li><code class="w3-codespan">window.localStorage</code> - stores data with no expiration date 
  (data is not lost when the browser tab is closed)</li>
...
<!--start-->
<h2>Test Web Storage API Support</h2>
<p>Before using web storage, we can quickly check browser support for localStorage and sessionStorage:</p>

<div class="w3-example">
<h3>Example</h3>
  <p>Test browser support:</p>
<div class="w3-code notranslate jsHigh">
  &lt;script&gt;<br>const x = document.getElementById(&quot;result&quot;);<br>if (typeof(Storage) 
  !== &quot;undefined&quot;) {<br>&nbsp; x.innerHTML = &quot;Your browser supports Web 
  storage!&quot;;<br>} else {<br>&nbsp; x.innerHTML = &quot;Sorry, no Web storage 
  support!&quot;;<br>}<br>&lt;/script&gt;
</div>
<a target="_blank" href="tryit.asp?filename=tryhtml5_webstorage_browsertest" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<p>The <code class="w3-codespan">localStorage</code> object stores the data with no expiration date. The data 
will not be lost when the browser is closed, and will be available the next day, week, or year.</p>
<div class="w3-example">
<h3>Example</h3>
  <p>Use <code class="w3-codespan">localStorage</code> to set and retrieve name 
  and value pairs:</p>
<div class="w3-code notranslate jsHigh">
  &lt;script&gt;<br>const x = document.getElementById(&quot;result&quot;);<br><br>if (typeof(Storage) 
  !== &quot;undefined&quot;) {<br>&nbsp; // Store<br>&nbsp; localStorage.setItem(&quot;lastname&quot;, 
  &quot;Smith&quot;);<br>&nbsp; localStorage.setItem(&quot;bgcolor&quot;, &quot;yellow&quot;);<br>&nbsp; // 
  Retrieve<br>&nbsp; x.innerHTML = localStorage.getItem(&quot;lastname&quot;);<br>&nbsp; 
  x.style.backgroundColor = localStorage.getItem(&quot;bgcolor&quot;);<br>} else {<br>&nbsp; 
  x.innerHTML = &quot;Sorry, no Web storage support!&quot;;<br>}<br>&lt;/script&gt;
</div>
...
<ul>
  <li>Use the <code class="w3-codespan">localStorage.setItem()</code> method to 
  create name/value pairs</li>
  <li>Use the <code class="w3-codespan">localStorage.getItem()</code> method to 
  retrieve the values set</li>
  <li>Retrieve the value of &quot;lastname&quot; and insert it into an element with id=&quot;result&quot;</li>
  <li>Retrieve the value of &quot;bgcolor&quot; and insert it into the style 
  backgroundColor of the element with id=&quot;result&quot;</li>
</ul>
...
<!--start-->
<h2>Counting Clicks with localStorage</h2>
...
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
  &lt;script&gt;<br>function clickCounter() {<br>&nbsp; const x = 
  document.getElementById(&quot;result&quot;);<br>&nbsp; if (typeof(Storage) !== 
  &quot;undefined&quot;) {<br>&nbsp;&nbsp;&nbsp; if (localStorage.clickcount) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  localStorage.clickcount = Number(localStorage.clickcount)+1;<br>&nbsp;&nbsp;&nbsp; 
  } else {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; localStorage.clickcount = 1;<br>&nbsp;&nbsp;&nbsp; 
  }<br>&nbsp;&nbsp;&nbsp; x.innerHTML = &quot;You have clicked the button &quot; + 
  localStorage.clickcount + &quot; time(s)!&quot;;<br>&nbsp; } else {<br>&nbsp;&nbsp;&nbsp; 
  x.innerHTML = &quot;Sorry, no Web storage support!&quot;;<br>&nbsp; }<br>}<br>&lt;/script&gt;</div>
...
<p>The <code class="w3-codespan">sessionStorage</code> object is equal to the <code class="w3-codespan">localStorage</code> object, <strong>except</strong> 
...
<div class="w3-code notranslate jsHigh">
  &lt;script&gt;<br>function clickCounter() {<br>&nbsp; const x = 
  document.getElementById(&quot;result&quot;);<br>&nbsp; if (typeof(Storage) !== 
  &quot;undefined&quot;) {<br>&nbsp;&nbsp;&nbsp; if (sessionStorage.clickcount) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  sessionStorage.clickcount = Number(sessionStorage.clickcount)+1;<br>&nbsp;&nbsp;&nbsp; 
  } else {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; sessionStorage.clickcount = 1;<br>&nbsp;&nbsp;&nbsp; 
  }<br>&nbsp;&nbsp;&nbsp; x.innerHTML = &quot;You have clicked the button &quot; + 
  sessionStorage.clickcount + &quot; time(s) in this session!&quot;;<br>&nbsp; } else {<br>&nbsp;&nbsp;&nbsp; 
  x.innerHTML = &quot;Sorry, no Web storage support!&quot;;<br>&nbsp; }<br>}<br>&lt;/script&gt;
</div>
