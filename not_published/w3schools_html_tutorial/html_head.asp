...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="html_challenges_filepaths.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="html_exercise_embed.asp?topic=head">Next &#10095;</a>
</div>
<hr>
...
<p>HTML metadata is data about the HTML document. Metadata is not displayed on 
the page.</p>
...
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: HTML Head</h2>
  <a href="https://youtu.be/WeuVX5x2MJE&list=PLP9IO4UYNF0VdAajP_5pYG-jG2JRrG72s" class="ga-featured ga-youtube" target="blank_" >
    <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
      ...
      <picture id="yt_div">
        <source srcset="images/21_html_head.webp" type="image/webp" />
        <img src="images/21_html_head.png" style="max-width:100%;height:auto;border-radius:6px" alt="Tutorial on YouTube" loading="lazy">
      </picture>
    </div>
  </a>
</div>
