...
<html lang="en-US">
<head>
<title>HTML HSL and HSLA Colors</title>
...
<h1>HTML <span class="color_h1">HSL and HSLA Colors</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="html_colors_hex.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="html_exercise_embed.asp?topic=colors">Next &#10095;</a>
</div>
<hr>
<p class="intro">HSL stands for hue, saturation, and lightness.</p>
<p class="intro">HSLA color values are an extension of HSL with an Alpha channel 
(opacity).</p>
<hr>
<!--start-->
...
adjusting the lightness from 0% to 100% to get darker/lighter shades:</p>
<div class="w3-example">
 <h3>Example</h3>
<div class="notranslate w3-white w3-container">
<div class="w3-row w3-center" style="line-height:80px;color:white;font-size:20px;font-weight:bold;font-family:Consolas, 'Courier New', Courier, monospace">
