...
<h1>HTML <span class="color_h1">Audio</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="html_challenges_video.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="html_challenges_audio.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">The HTML <code class="w3-codespan">&lt;audio&gt;</code> element is used to 
play an audio file on a web page.</p>
<hr>
<!--start-->
...
<p>To start an audio file automatically, use the <code class="w3-codespan">autoplay</code> attribute:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
...
autoplay</code> to let your audio file start playing automatically (but muted):</p>
...
<a target="_blank" href="tryit.asp?filename=tryhtml5_audio_autoplay_mute" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<p>For a full DOM reference, go to our <a href="/tags/ref_av_dom.asp">HTML Audio/Video DOM Reference</a>.</p>
<!--stop-->
<hr>
