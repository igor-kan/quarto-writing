...
<a class="w3-left w3-btn" href="html_challenges_iframes.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="html_exercise_embed.asp?topic=scripts">Next &#10095;</a>
</div>
<hr>
...
<p><a target="_blank" href="tryit.asp?filename=tryhtml_scripts_intro" class="w3-btn">Try it Yourself &raquo;</a></p>
</div>
<hr>
<!--start-->
<h2>The HTML &lt;script&gt; Tag</h2>
<p>The HTML <code class="w3-codespan">&lt;script&gt;</code> tag is used to define a client-side script 
(JavaScript).</p>
<p>The <code class="w3-codespan">&lt;script&gt;</code> element either contains script statements, or it points to an 
...
<p>To select an HTML element, JavaScript most often uses the 
...
<p>The HTML <code class="w3-codespan">&lt;noscript&gt;</code> tag defines an alternate content 
...
&lt;script&gt;<br>
 document.getElementById(&quot;demo&quot;).innerHTML = &quot;Hello JavaScript!&quot;;<br>
&lt;/script&gt;<br>&lt;noscript&gt;Sorry, your browser does not support JavaScript!&lt;/noscript&gt;</div>
...
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: HTML and JavaScript</h2>
  <a href="https://youtu.be/uSgcWDkwc3U&list=PLP9IO4UYNF0VdAajP_5pYG-jG2JRrG72s" class="ga-featured ga-youtube" target="blank_" >
    <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
      ...
      <picture id="yt_div">
        <source srcset="images/20_html_javascript.webp" type="image/webp" />
        <img src="images/20_html_javascript.png" style="max-width:100%;height:auto;border-radius:6px" alt="Tutorial on YouTube" loading="lazy">
      </picture>
    </div>
  </a>
</div>
