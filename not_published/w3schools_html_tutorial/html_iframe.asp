...
<a class="w3-left w3-btn" href="html_challenges_buttons.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="html_exercise_embed.asp?topic=iframe">Next &#10095;</a>
</div>
<hr>
<p class="intro">An HTML iframe is used to display a web page within a web page.</p>
<hr>
<!--start-->
<div style="width:100%;height:350px;overflow:hidden;">
<iframe src="default.asp" title="W3Schools HTML Tutorial" height="350px" width="99%"></iframe>
</div>
<hr>

<h2>HTML Iframe Syntax</h2>
<p>The HTML <code class="w3-codespan">&lt;iframe&gt;</code> tag specifies an 
inline frame.</p>
...
<p><strong>Tip:</strong> It is a good practice to always include a <code class="w3-codespan">
title</code> attribute for the <code class="w3-codespan">&lt;iframe&gt;</code>. 
This is used by screen readers to read out what the content of the iframe is.</p>
<!--stop-->
<hr>
<!--start-->
...
&lt;iframe src=&quot;demo_iframe.htm&quot; height=&quot;200&quot; width=&quot;300&quot; 
  title=&quot;Iframe Example&quot;&gt;&lt;/iframe&gt;</div>
...
<p>Or you can add the <code class="w3-codespan">style</code> attribute and use 
...
title</code> attribute (for screen readers)</li>
  <li>The <code class="w3-codespan">height</code> and <code class="w3-codespan">width</code> attributes specify the 
...
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: HTML Iframe</h2>
  <a href="https://youtu.be/qP23O70ve7k&list=PLP9IO4UYNF0VdAajP_5pYG-jG2JRrG72s" class="ga-featured ga-youtube" target="blank_" >
    <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
      ...
      <picture id="yt_div">
        <source srcset="images/19_html_iframe.webp" type="image/webp" />
        <img src="images/19_html_iframe.png" style="max-width:100%;height:auto;border-radius:6px" alt="Tutorial on YouTube" loading="lazy">
      </picture>
    </div>
  </a>
</div>
