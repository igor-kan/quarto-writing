...
<a class="w3-left w3-btn" href="html_challenges_basic.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="html_exercise_embed.asp?topic=elements">Next &#10095;</a>
</div>
<hr>
<p class="intro">An HTML element is defined by a start tag, some content, and an 
end tag.</p>
<hr>
<!--start-->
...
<span class="spes_tagname"><span class="spes_tag">&lt;</span>tagname<span class="spes_tag">&gt;</span></span>Content goes here...<span class="spes_tagname"><span class="spes_tag">&lt;</span>/tagname<span class="spes_tag">&gt;</span></span>
</div>
...
<p>The following example contains four HTML elements (<code class="w3-codespan">&lt;html&gt;</code>, <code class="w3-codespan">&lt;body&gt;</code>, <code class="w3-codespan">&lt;h1&gt;</code> 
and <code class="w3-codespan">&lt;p&gt;</code>):</p>
...
<p>The <code class="w3-codespan">&lt;html&gt;</code> element is the root element 
and it defines the whole HTML document.</p>
<p>It has a start tag <code class="w3-codespan">&lt;html&gt;</code> and an end tag <code class="w3-codespan">&lt;/html&gt;</code>.</p>
<p>Then, inside the <code class="w3-codespan">&lt;html&gt;</code> element there is 
...
<p>The <code class="w3-codespan">&lt;body&gt;</code> element defines the 
document's body.</p>
<p>It has a start tag <code class="w3-codespan">&lt;body&gt;</code> and an end tag <code class="w3-codespan">&lt;/body&gt;</code>.</p>
<p>Then, inside the <code class="w3-codespan">&lt;body&gt;</code> element there 
are two other elements:
<code class="w3-codespan">&lt;h1&gt;</code> and <code class="w3-codespan">
&lt;p&gt;</code>:</p>
<div class="w3-example">
<div class="w3-code notranslate htmlHigh">
 &lt;h1&gt;My First Heading&lt;/h1&gt;<br>&lt;p&gt;My first paragraph.&lt;/p&gt;</div></div>

<p>The <code class="w3-codespan">&lt;h1&gt;</code> element defines a heading.</p>
<p>It has a start tag <code class="w3-codespan">&lt;h1&gt;</code> and an end tag <code class="w3-codespan">&lt;/h1&gt;</code>:</p>
...
<p>The <code class="w3-codespan">&lt;p&gt;</code> element defines a paragraph.</p>
<p>It has a start tag <code class="w3-codespan">&lt;p&gt;</code> and an end tag <code class="w3-codespan">&lt;/p&gt;</code>:</p>
...
<p>The <code class="w3-codespan">&lt;br&gt;</code> tag defines a line break, and 
is an empty element without a closing tag:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;p&gt;This is a &lt;br&gt; paragraph with a line break.&lt;/p&gt;</div>
<a target="_blank" href="tryit.asp?filename=tryhtml_elements_br" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>HTML is Not Case Sensitive</h2>
<p>HTML tags are not case sensitive: <code class="w3-codespan">&lt;P&gt;</code> means the same as <code class="w3-codespan">&lt;p&gt;</code>.</p>
...
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: HTML Elements</h2>
  <a href="https://youtu.be/vIoO52MdZFE&list=PLP9IO4UYNF0VdAajP_5pYG-jG2JRrG72s" class="ga-featured ga-youtube" target="blank_" >
    <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
      ...
      <picture id="yt_div">
        <source srcset="images/03_html_elements.webp" type="image/webp" />
        <img src="images/03_html_elements.png" style="max-width:100%;height:auto;border-radius:6px" alt="Tutorial on YouTube" loading="lazy">
      </picture>
    </div>
  </a>
</div>
