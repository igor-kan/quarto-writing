...
<a class="w3-left w3-btn" href="html_challenges_css.asp">&#10094; Previous</a>
...
in the <code class="w3-codespan">href</code> attribute.</p>
...
<p>To use an image as a link, just put the <code class="w3-codespan">&lt;img&gt;</code> 
tag inside the <code class="w3-codespan">&lt;a&gt;</code> tag:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_links_email" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<div class="w3-example">
<h3>Example</h3>
<p>Use a full URL to link to a web page:&nbsp;</p>
<div class="w3-code notranslate htmlHigh">
...
<p>Link to a page located in the same folder as the current page:&nbsp;</p>
<div class="w3-code notranslate htmlHigh">
...
<ul>
  ...
  <li>Use the <code class="w3-codespan">&lt;img&gt;</code> element (inside <code class="w3-codespan">&lt;a&gt;</code>) 
  to use an image as a link</li>
  <li>Use the <code class="w3-codespan">
...
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: HTML Links</h2>
  <a href="https://youtu.be/HA6bByKdAQM&list=PLP9IO4UYNF0VdAajP_5pYG-jG2JRrG72s" class="ga-featured ga-youtube" target="blank_" >
    <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
      ...
      <picture id="yt_div">
        <source srcset="images/12_html_links.webp" type="image/webp" />
        <img src="images/12_html_links.png" style="max-width:100%;height:auto;border-radius:6px" alt="Tutorial on YouTube" loading="lazy">
      </picture>
    </div>
  </a>
</div>
