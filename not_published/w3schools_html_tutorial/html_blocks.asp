...
<a class="w3-left w3-btn" href="html_challenges_lists.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="html_exercise_embed.asp?topic=blocks">Next &#10095;</a>
</div>
<hr>
...
or a section in an HTML document.</p>
...
&lt;p&gt;Hello World&lt;/p&gt;<br>&lt;div&gt;Hello World&lt;/div&gt;</div>
...
<p>This is <span class="w3-theme-border" style="border-width:1px;border-style:solid;padding:5px">a &lt;span&gt; element 
...
<div class="ws-note w3-panel">
  <p><strong>Note:</strong> An inline element cannot contain a block-level 
  element!</p>
</div>
<!--stop-->
<hr>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_div" target="_blank">Try it Yourself &raquo;</a>
</div>

<p>You will learn more about the <code class="w3-codespan">&lt;div&gt;</code> element in the <a href="html_div.asp">next chapter</a>.</p>
<!--stop-->
<hr>
<!--start-->
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_span" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<ul>
  ...
  element and is often used as a container for other HTML elements</li>
...
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: HTML Block and Inline</h2>
  <a href="https://youtu.be/M4n-WSkehmI&list=PLP9IO4UYNF0VdAajP_5pYG-jG2JRrG72s" class="ga-featured ga-youtube" target="blank_" >
    <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
      ...
      <picture id="yt_div">
        <source srcset="images/16_html_block_and_inline.webp" type="image/webp" />
        <img src="images/16_html_block_and_inline.png" style="max-width:100%;height:auto;border-radius:6px" alt="Tutorial on YouTube" loading="lazy">
      </picture>
    </div>
  </a>
</div>
