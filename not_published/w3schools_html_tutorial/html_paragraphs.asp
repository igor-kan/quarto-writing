...
<a class="w3-left w3-btn" href="html_challenges_headings.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="html_exercise_embed.asp?topic=paragraphs">Next &#10095;</a>
</div>
<hr>
<p class="intro">A paragraph always starts on a new line, and is usually a block of text.</p>
<hr>
<!--start-->
...
<p>The <code class="w3-codespan">&lt;hr&gt;</code> tag is an empty tag, which means that it has no end tag.</p>
<!--stop-->
<hr>
<!--start-->
...
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: HTML Paragraphs</h2>
  <a href="https://youtu.be/qis4kAOThLw&list=PLP9IO4UYNF0VdAajP_5pYG-jG2JRrG72s" class="ga-featured ga-youtube" target="blank_" >
    <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
      ...
      <picture id="yt_div">
        <source srcset="images/06_html_paragraphs.webp" type="image/webp" />
        <img src="images/06_html_paragraphs.png" style="max-width:100%;height:auto;border-radius:6px" alt="Tutorial on YouTube" loading="lazy">
      </picture>
    </div>
  </a>
</div>
