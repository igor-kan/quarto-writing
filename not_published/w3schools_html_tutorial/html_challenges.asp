...
<html lang="en-US">
<head>
<title>HTML Code Challenges</title>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">Code Challenges</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="html_exercises.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="html_website.asp">Next &#10095;</a>
</div>
<hr>
<p>Test your HTML skills with code challenges from all categories:</p>

<div class="challenge_tiles">
<h2 class="heading">Code Challenges</h2>
<div class="challenge_toolbar">
  <input id="challenge_filter" type="search" placeholder="Filter challenges (e.g. forms, tables, video)" aria-label="Filter challenges">
</div>
...
(function() {
  ...
  overviews.forEach(function(overview) {
    var challengeLink = overview.querySelector('a[href*="html_challenges_"]');
    if (challengeLink) {
      ...
      var title = headerLink ? headerLink.textContent.trim() : href.replace('html_challenges_', '').replace('.asp', '');
      title = title.replace(/^HTML\s*/i, '');
...
<p>Code challenges are interactive coding exercises where you write HTML code to achieve a specific result.</p>
<p>Each challenge presents you with a goal and lets you practice writing real HTML code.</p>
