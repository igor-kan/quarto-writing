...
<a class="w3-left w3-btn" href="html_challenges_tables.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="html_lists_unordered.asp">Next &#10095;</a>
</div>
<hr>
...
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: HTML Lists</h2>
  <a href="https://youtu.be/-QuK8taGLCs&list=PLP9IO4UYNF0VdAajP_5pYG-jG2JRrG72s" class="ga-featured ga-youtube" target="blank_" >
    <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
      ...
      <picture id="yt_div">
        <source srcset="images/15_html_lists.webp" type="image/webp" />
        <img src="images/15_html_lists.png" style="max-width:100%;height:auto;border-radius:6px" alt="Tutorial on YouTube" loading="lazy">
      </picture>
    </div>
  </a>
</div>
