...
<h1>HTML <span class="color_h1">Unordered Lists</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="html_lists.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="html_lists_ordered.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">The HTML <code class="w3-codespan">&lt;ul&gt;</code> tag defines an unordered 
(bulleted) list.</p>
<hr>
<!--start-->
...
<p>
<a class="w3-btn" href="tryit.asp?filename=tryhtml_lists_unordered2" target="_blank">Try it Yourself &raquo;</a>
</p>
</div>
<!--stop-->
<hr>
...
list item marker. It can have one of the following values:</p>
...
<ul>
  ...
  <li>Use the CSS property <code class="w3-codespan">float:left</code> to display a list horizontally</li>
</ul>
<!--stop-->
<hr>
