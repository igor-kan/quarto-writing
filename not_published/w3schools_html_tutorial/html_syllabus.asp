...
<html lang="en-US">
<head>
<title>HTML Syllabus (Curriculum)</title>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">Syllabus</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="html_website.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="html_study_plan.asp">Next &#10095;</a>
</div>
<hr>
...
<p>The <a title="W3Schools HTML Tutorial" href="default.asp">W3Schools HTML Tutorial</a> is comprehensive and beginner-friendly.</p>
<p>It will give you a fundamental knowledge of HTML.</p>
...
<p>The syllabus outline and its sequence are structured so you can learn HTML step by step, from the introduction to creating your first application with HTML.</p>
<p><a title="W3Schools HTML Tutorial" href="html_intro.asp" class="ws-btn">Get Started With HTML &raquo;</a></p>
<hr>

<h2>Learning Outcomes</h2>
<ul>
  <li>Understand the basic structure of an HTML document.</li>
  <li>Make use of HTML tags (for example, headings, paragraphs, images, and links).</li>
  <li>Make and format lists, both ordered and unordered.</li>
  <li>Apply attributes to edit elements (e.g., colors, sizes, links).</li>
  <li>Make tables and forms.</li>
  <li>Add multimedia such as images and videos to a website.</li>
  <li>Use semantic tags for a well-structured website.</li>
  <li>Create hyperlinks to link websites.</li>
  <li>Create accessible websites with text, images, and links.</li>
</ul>
<div class="ws-note w3-panel">
<p><strong>Note:</strong> Are you a teacher teaching HTML? <a href="/academy/index.php" target="_blank">W3Schools Academy</a> is a toolbox of features that can help you teach. It offers classroom features such as pre-built study plans, classroom administration and much more. Read more about <a href="/academy/index.php" target="_blank">Academy here</a>.</p>
</div>
<hr>

<h2>Which Subjects Are HTML Relevant For?</h2>
<ul>
   <li style="margin-bottom:16px;"><strong>Web pages:</strong><br> HTML is the standard markup language for creating Web pages.</li>

  <li style="margin-bottom:16px;"><strong>Computer Science (CS) / Information Technology (IT):</strong><br> HTML is fundamental to understanding the internet, web development, and programming.</li>
  <li style="margin-bottom:16px;"><strong>Digital Media:</strong><br> Text, photos, and other media can be added to digital platforms using HTML, which is essential for content creation and management.</li>
  ...
  <li style="margin-bottom:16px;"><strong>Art and Design:</strong><br> HTML supports web design, creativity, and visual communication ideas that are all part of web design.</li>
  <li style="margin-bottom:16px;"><strong>STEM (Science, Technology, Engineering, Mathematics):</strong><br> Building web pages with HTML is a part of technology integration in STEM projects, teaching logical thinking and problem-solving.</li>
  <li><strong>Career and Technical Education (CTE):</strong><br> HTML is part of the curriculum for career-focused courses, especially those related to web development, IT support, and digital marketing.</li>
</ul>
<p><a title="W3Schools HTML Tutorial" href="html_intro.asp" class="ws-btn" style="margin-top:8px">Get Started</a></p>
<hr>

<h2>Activities</h2>
<p>In this tutorial we offer different activities for you to learn HTML for free:</p>
<ul>
    <li><a href="default.asp" title="W3Schools HTML Tutorial">Lessons</a></li>
    <li><a href="html_exercises.asp" title="W3Schools HTML Exercises">Exercises</a></li>
    <li><a href="html_quiz.asp" title="W3Schools HTML Quiz">Quizzes</a></li>
</ul>
...
<ul class="link-boxes">
    <li><a href="default.asp">HTML HOME</a></li>
    <li><a href="html_intro.asp">HTML Introduction</a></li>
    <li><a href="html_editors.asp">HTML Editors</a></li>
    <li><a href="html_basic.asp">HTML Basic</a></li>
    <li><a href="html_elements.asp">HTML Elements</a></li>
    <li><a href="html_attributes.asp">HTML Attributes</a></li>
    <li><a href="html_headings.asp">HTML Headings</a></li>
    <li><a href="html_paragraphs.asp">HTML Paragraphs</a></li>
    <li><a href="html_styles.asp">HTML Styles</a></li>
    <li><a href="html_formatting.asp">HTML Formatting</a></li>
    <li><a href="html_quotation_elements.asp">HTML Quotations</a></li>
    <li><a href="html_comments.asp">HTML Comments</a></li>
    <li><a href="html_colors.asp">HTML Colors</a></li>
    <li><a href="html_css.asp">HTML CSS</a></li>
    <li><a href="html_links.asp">HTML Links</a></li>
    <li><a href="html_images.asp">HTML Images</a></li>
    <li><a href="html_page_title.asp">HTML Page Title</a></li>
    <li><a href="html_favicon.asp">HTML Favicon</a></li>
    <li><a href="html_tables.asp">HTML Tables</a></li>
    <li><a href="html_lists.asp">HTML Lists</a></li>
    <li><a href="html_blocks.asp">HTML Block &amp; Inline</a></li>
    <li><a href="html_div.asp">HTML Div Element</a></li>
    <li><a href="html_classes.asp">HTML class Attribute</a></li>
    <li><a href="html_id.asp">HTML id Attribute</a></li>
    <li><a href="html_iframe.asp">HTML Iframes</a></li>
    <li><a href="html_scripts.asp">HTML JavaScript</a></li>
    <li><a href="html_filepaths.asp">HTML File Paths</a></li>
    <li><a href="html_head.asp">HTML Head Element</a></li>
    <li><a href="html_layout.asp">HTML Layout</a></li>
    <li><a href="html_responsive.asp">HTML Responsiv</a></li>
    <li><a href="html_computercode_elements.asp">HTML Computercode</a></li>
    <li><a href="html5_semantic_elements.asp">HTML Semantics</a></li>
    <li><a href="html5_syntax.asp">HTML Style Guide</a></li>
    <li><a href="html_entities.asp">HTML Entities</a></li>
    <li><a href="html_symbols.asp">HTML Symbols</a></li>
    <li><a href="html_emojis.asp">HTML Emojis</a></li>
    <li><a href="html_charset.asp">HTML Charset</a></li>
    <li><a href="html_urlencode.asp">HTML URL Encode</a></li>
    <li><a href="html_xhtml.asp">HTML vs. XHTML</a></li>
    <li><a href="html_forms.asp">HTML Forms</a></li>
    <li><a href="html_forms_attributes.asp">HTML From Attributes</a></li>
    <li><a href="html_form_elements.asp">HTML Form Elements</a></li>
    <li><a href="html_form_input_types.asp">HTML Input Types</a></li>
    <li><a href="html_form_attributes.asp">HTML Input Attributes</a></li>
    <li><a href="html_form_attributes.asp">HTML Input Form Attributes</a></li>
    <li><a href="html5_canvas.asp">HTML Canvas</a></li>
    <li><a href="html5_svg.asp">HTML SVG</a></li>
    <li><a href="html_media.asp">HTML Media</a></li>
    <li><a href="html5_video.asp">HTML Video</a></li>
    <li><a href="html5_audio.asp">HTML Audio</a></li>
    <li><a href="html_object.asp">HTML Plug-ins</a></li>
    <li><a href="html_youtube.asp">HTML YouTube</a></li>
    <li><a href="html5_geolocation.asp">HTML Geolocation</a></li>
    <li><a href="html5_draganddrop.asp">HTML Drag/Drop</a></li>
    <li><a href="html5_webstorage.asp">HTML Web Storage</a></li>
    <li><a href="html5_webworkers.asp">HTML Web Workers</a></li>
    <li><a href="html5_serversentevents.asp">HTML SSE</a></li>
</ul>
</div>
<p><a title="W3Schools HTML Tutorial" href="default.asp" class="ws-btn">Get Started</a></p>
<hr>

<h2>Sandbox and Lab Environment</h2>
<p>HTML, like any other coding language, is best learned by working hands-on with code.</p>
<p>Easily try code with our "Try it Yourself" editor.</p>
<p>Here, you can edit HTML code and view the result:</p>
...
that allows you to build, test and deploy static websites for free.</p>
...
<p>The HTML exam is a test that summarizes the W3Schools HTML syllabus.</p>
<p>After passing the exam you get the "Certified HTML Developer" Certification.</p>
...
<p><a class="ws-btn" href="https://campus.w3schools.com/collections/certifications/products/html-certificate" target="_blank">Buy Certificate &raquo;</a></p>
<hr>
