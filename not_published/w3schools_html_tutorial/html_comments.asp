...
<a class="w3-left w3-btn" href="html_challenges_quotations.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="html_exercise_embed.asp?topic=comments">Next &#10095;</a>
</div>
<hr>
<!--start-->
<p class="intro">HTML comments are not displayed in the browser, but they can 
help document your HTML source code.</p>
<hr>
...
<p>Notice that there is an exclamation point (!) in the start tag, but not in the 
end tag.</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_comment_hide" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<!--start-->
<p>You can also hide more than one line. Everything between the <code class="w3-codespan">&lt;!--</code> and the <code class="w3-codespan">--></code>
...
<div class="w3-example">
<h3>Example</h3>
<p>Hide a part of a paragraph:</p>
<div class="w3-code notranslate htmlHigh">
  &lt;p&gt;This &lt;!-- great text --&gt; is a paragraph.&lt;/p&gt;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_comment_inline" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: HTML Comments</h2>
  <a href="https://youtu.be/229HYq40vaA&list=PLP9IO4UYNF0VdAajP_5pYG-jG2JRrG72s" class="ga-featured ga-youtube" target="blank_" >
    <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
      ...
      <picture id="yt_div">
        <source srcset="images/09_html_comments.webp" type="image/webp" />
        <img src="images/09_html_comments.png" style="max-width:100%;height:auto;border-radius:6px" alt="Tutorial on YouTube" loading="lazy">
      </picture>
    </div>
  </a>
</div>
