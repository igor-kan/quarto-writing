...
<h1>HTML <span class="color_h1">Geolocation API</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="html5_api_whatis.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="html5_draganddrop.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">The Geolocation API is used to get the user's current location.</p>
<hr>

<!--start-->
<h2>Locate the User's Position</h2>
<p>The Geolocation API is used to access the user's current location.</p>
<p id="demo">Since this can compromise privacy, the location is not available unless the user approves it.</p>

<p><button class="w3-btn w3-blue w3-round" onclick="getLocation()">Try It</button></p>
<div id="mapholder"></div>
<script src="https://maps.google.com/maps/api/js?key=YOUR_KEY_HERE"></script>
<script>
...
<p><strong>Note:</strong> The Geolocation API is only available on secure contexts such as HTTPS.</p>
<p><strong>Tip:</strong> The Geolocation API is most accurate for devices with GPS, like smartphones or smartwatches.</p>
</div>
<!--stop-->
<hr>
...
<h2>Using HTML Geolocation API</h2>
<p>The Geolocation API is accessed via a call to <code class="w3-codespan">
navigator.geolocation</code>. This will cause the browser to ask the user for 
...
information (for example GPS).</p>
<p>The <code class="w3-codespan">getCurrentPosition()</code> method is used to return the user's 
current location.</p>
<p>The example below returns the latitude and longitude of the user's current 
location:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;script&gt;<br>const x = document.getElementById(&quot;demo&quot;);<br><br>
function getLocation() {<br>&nbsp;&nbsp;if (navigator.geolocation) {<br>
  &nbsp;&nbsp;&nbsp; navigator.geolocation.getCurrentPosition(success, error);<br>&nbsp;&nbsp;} else {<br>
  &nbsp;&nbsp;&nbsp; x.innerHTML = &quot;Geolocation is not supported by this browser.&quot;;<br>
  &nbsp;&nbsp;}<br>}<br><br>
 function success(position) {<br>&nbsp; x.innerHTML = &quot;Latitude: &quot; + position.coords.latitude + <br>&nbsp;&nbsp;&quot;&lt;br&gt;Longitude: &quot; + position.coords.longitude; <br>
 }<br><br>function error() {<br>&nbsp; alert(&quot;Sorry, no position available.&quot;);<br>
  }<br>&lt;/script&gt;</div>
...
<ul>
  ...
  <li>If Geolocation is supported, run the <code class="w3-codespan">getCurrentPosition()</code> method. If not, display a message to the user</li>
  <li>The success() function outputs the user's location in latitude and longitude</li>
  <li>The error() function alerts a text if the browser retrieves an error in <code class="w3-codespan">getCurrentPosition()</code></li>
</ul>
<!--stop-->
<hr>
...
<hr>
<!--start-->
<h2>Error Handling and Rejections</h2>
...
<p>Here is an example of a more specific error handling:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
 function error(error) {<br>&nbsp;&nbsp;switch(error.code) {<br>&nbsp;&nbsp;&nbsp; case error.PERMISSION_DENIED:<br>
...
<ul>
  <li><code class="w3-codespan">watchPosition()</code> - Returns the current 
  location of the user and continues to 
return updated location as the user moves (like the GPS in a car).</li>
...
function getLocation() {<br>
  &nbsp; if (navigator.geolocation) {<br>&nbsp;&nbsp;&nbsp; navigator.geolocation.watchPosition(success, 
  error);<br>&nbsp;&nbsp;} else {<br>
  &nbsp;&nbsp;&nbsp; x.innerHTML = &quot;Geolocation is not supported by this browser.&quot;;<br>
  &nbsp;&nbsp;}<br>}<br><br>
 function success(position) {<br>&nbsp; x.innerHTML = &quot;Latitude: &quot; + position.coords.latitude + <br>&nbsp;&nbsp;&quot;&lt;br&gt;Longitude: &quot; + position.coords.longitude; <br>
 }<br><br>function error(error) {<br>&nbsp; switch(error.code) {<br>&nbsp;&nbsp;&nbsp; 
  case error.PERMISSION_DENIED:<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; x.innerHTML = 
