...
body.darkpagetheme .cert-info-price span {
  color: #94a3b8;
}
...
<div class="cert-section">
  <div class="cert-card">
    <div style="display:none;font-size: 12px; font-weight: 600; color: #04AA6D; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 12px;">HTML Tutorial</div>
    <div class="cert-card-header">
      <div class="cert-card-icon">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#E34F26"><path d="M1.5 0h21l-1.91 21.563L11.977 24l-8.564-2.438L1.5 0zm7.031 9.75l-.232-2.718 10.059.003.23-2.622L5.412 4.41l.698 8.01h9.126l-.326 3.426-2.91.804-2.955-.81-.188-2.11H6.248l.33 4.171L12 19.351l5.379-1.443.744-8.157H8.531z"/></svg>
      </div>
      <h2 class="cert-card-title">Learn HTML</h2>
    </div>
    <p class="cert-card-desc">HTML is the standard markup language for Web pages.</p>
    <p class="cert-card-desc">With HTML you can create your own Website.</p>
    <p class="cert-card-desc">HTML is easy to learn - You will enjoy it!</p>
    <div class="cert-card-bottom" style="margin-top:auto;padding-top:16px;">
      <a href="html_intro.asp" class="cert-card-btn">Learn HTML now &#10095;</a>
    </div>
  </div>

  <div class="cert-info" style="padding:24px;display:flex;flex-direction:column;">
    <h3 class="cert-info-title">Become HTML Certified</h3>
    <p class="cert-info-desc">Get certified with our HTML exam, includes a professionally curated study kit to guide you from beginner to exam-ready.</p>
    <div class="cert-card-bottom" style="display:flex;flex-direction:column;margin-top:auto;">
      <div style="display:flex;align-items:flex-start;gap:0px;">
		...
		<a href="https://campus.w3schools.com/collections/course-catalog/products/html-course" class="cert-card-btn cert-btn-white" target="_blank" style="margin-top:12px;background:#fff;color:#000;border:2px solid #000;">Get Certified &#10095;</a>          
        </div>
        <div class="cert-preview" style="flex:1 1 auto;padding:0;align-self:flex-start;">
          <svg class="cert-preview-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 560 400" role="img" aria-label="HTML Certificate preview" style="width:100%;max-width:250px;height:auto;display:block;margin:0 0 0 auto;">
            ...
            <image x="476" y="34" width="48" height="48" href="https://api.qrserver.com/v1/create-qr-code/?data=https%3A%2F%2Fwww.w3schools.com&amp;size=120x120&amp;margin=0"/>
            ...
            <text x="280" y="212" text-anchor="middle" font-family="Source Sans Pro Topnav, sans-serif" font-size="13" fill="#475569">has passed the W3Schools HTML Certification exam and is hereby declared a</text>
            <g transform="translate(256,228)">
              <svg width="48" height="48" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#E34F26"><path d="M1.5 0h21l-1.91 21.563L11.977 24l-8.564-2.438L1.5 0zm7.031 9.75l-.232-2.718 10.059.003.23-2.622L5.412 4.41l.698 8.01h9.126l-.326 3.426-2.91.804-2.955-.81-.188-2.11H6.248l.33 4.171L12 19.351l5.379-1.443.744-8.157H8.531z"/></svg>
            </g>
            <text x="280" y="298" text-anchor="middle" font-family="Source Sans Pro Topnav, sans-serif" font-size="18" font-weight="700" fill="#0f172a">Certified HTML Developer</text>
...
<p><a href="html_examples.asp" class="ws-btn ws-grey w3-hover-green">See all HTML Examples</a></p>
<hr>
...
<div id="exercisecontainer" src="xrcise_links.js"></div>
<p><a class="w3-btn w3-margin-bottom ws-green" href="html_exercises.asp" style="border-radius:5px;font-size: 18px;padding-left:25px;padding-right:25px;font-family: 'Source Sans Pro', sans-serif;margin-top:6px;">See all HTML Exercises</a></p>
<hr>
...
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  ...
  <a href="https://youtu.be/BzYMFd-lQL4" class="ga-featured ga-youtube" target="blank_" >
    <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
      ...
      <picture id="yt_div">
        <source srcset="images/html_full_html_beginners.webp" type="image/webp" />
        <img src="images/html_full_html_beginners.png" style="max-width:100%;height:auto;border-radius:6px" alt="Tutorial on YouTube" loading="lazy">
      </picture>
    </div>
  </a>
</div>
