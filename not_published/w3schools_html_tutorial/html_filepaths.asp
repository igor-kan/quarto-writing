...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="html_challenges_scripts.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="html_challenges_filepaths.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">A file path describes the location of a file in a web site's folder structure.</p>
<hr>
...
<p>The &lt;img&gt; tag is explained in the chapter: <a href="html_images.asp">HTML Images</a>.</p>
</div>
<!--stop-->
<hr>
...
<p>In the following example, the file path points to a file in the images folder located 
at the root of the current website:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
...
<p>In the following example, the file path points to a file in the images folder located in the 
current folder:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
...
<p>In the following example, the file path points to a file in the images folder located in the 
folder one level up from the current folder:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;img src=&quot;../images/picture.jpg&quot; 
