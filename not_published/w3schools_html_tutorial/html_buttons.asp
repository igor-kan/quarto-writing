...
<h1>HTML <span class="color_h1">Buttons</span></h1>

<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="html_challenges_id.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="html_challenges_buttons.asp">Next &#10095;</a>
</div>

<hr>

<p class="intro">Buttons let users interact with a web page. They can submit forms, run JavaScript, or trigger different actions when clicked.</p>

<hr>

<!--start-->
<h2>HTML Button</h2>
<p>The HTML <code class="w3-codespan">&lt;button&gt;</code> element defines a clickable button.</p>
<p>By itself, the button does nothing until you add an action to it.</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_buttons_basic" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
...
<!--start-->
<h2>Styling HTML Buttons</h2>
<p>Buttons are often styled with CSS:</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_buttons_styled" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<p>Use the <code class="w3-codespan">disabled</code> attribute to make a button unclickable:</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_buttons_disabled" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p><strong>Tip:</strong> Disabled buttons cannot be clicked and usually appear faded.</p>
</div>
<!--stop-->
...
<p>You can run JavaScript when the user clicks a button using the <code class="w3-codespan">onclick</code> attribute:</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_buttons_javascript" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="ws-note w3-panel">
<p><strong>Note:</strong> You will learn more about JavaScript in our <a href="html_scripts.asp">HTML JavaScript</a> chapter.</p>
</div>
...
<p>The <code class="w3-codespan">type</code> attribute defines what a button does when clicked. There are three button types:</p>

<ul>
  <li><code class="w3-codespan">type="button"</code> - A normal clickable button (does nothing by default)</li>
  <li><code class="w3-codespan">type="submit"</code> - Submits a form</li>
  <li><code class="w3-codespan">type="reset"</code> - Resets all form fields</li>
</ul>

<div class="w3-example">
<div class="w3-code notranslate htmlHigh">
&lt;button type="button"&gt;Normal Button&lt;/button&gt;<br>
&lt;button type="submit"&gt;Submit&lt;/button&gt;<br>
&lt;button type="reset"&gt;Reset&lt;/button&gt;
</div>
</div>

<p>Buttons are often used inside <a href="html_forms.asp">forms</a>, which you will learn more about in a later chapter.</p>
<p>For now, just know that a <code class="w3-codespan">submit</code> button sends the form data to the server, while a <code class="w3-codespan">reset</code> button clears the form:</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_buttons_form" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> You should always specify the <code class="w3-codespan">type</code> attribute. Inside a form, the default type is <code class="w3-codespan">submit</code>, and browsers may behave differently if the type is omitted.</p>
</div>
<!--stop-->
<hr>

<h2>HTML Button Reference</h2>
...
<p><strong>Tip:</strong> For a complete list of all HTML tags, visit our <a href="/tags/default.asp">HTML Tag Reference</a>.</p>
<hr>
