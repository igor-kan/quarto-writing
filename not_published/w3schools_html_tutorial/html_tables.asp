...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="html_exercise_embed.asp?topic=page_title">&#10094; Previous</a>
...
<p>Everything between <code class="w3-codespan">&lt;td&gt;</code> and <code class="w3-codespan">&lt;/td&gt;</code> 
is the content of a table cell.</p>
...
<div class="w3-panel ws-note">
<p><strong>Note:</strong> There are times when a row can have fewer or more cells than another. You will learn about that in a later chapter.</p>
</div>
...
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: HTML Tables</h2>
  <a href="https://youtu.be/e62D-aayveY&list=PLP9IO4UYNF0VdAajP_5pYG-jG2JRrG72s" class="ga-featured ga-youtube" target="blank_" >
    <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
      ...
      <picture id="yt_div">
        <source srcset="images/14_html_tables.webp" type="image/webp" />
        <img src="images/14_html_tables.png" style="max-width:100%;height:auto;border-radius:6px" alt="Tutorial on YouTube" loading="lazy">
      </picture>
    </div>
  </a>
</div>
