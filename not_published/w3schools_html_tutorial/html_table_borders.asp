...
body.darkpagetheme .table1,body.darkpagetheme .table1 th,body.darkpagetheme .table1 td {
...
body.darkpagetheme .table2,body.darkpagetheme .table2 th,body.darkpagetheme .table2 td {
  border:1px solid #ddd;
}
...
body.darkpagetheme .table4,body.darkpagetheme .table4 th,body.darkpagetheme .table4 td {
  border-color:#282A35;
}
.table4 td {
  background-color:#96D4D4;
...
body.darkpagetheme .table5,body.darkpagetheme .table5 th,body.darkpagetheme .table5 td {
  border-color:#ddd;
}
.table6 th, .table6 td {
  border:1px solid black;
...
body.darkpagetheme .table6,body.darkpagetheme .table6 th,body.darkpagetheme .table6 td {
  border-color:#ddd;
}
...
body.darkpagetheme .table7,body.darkpagetheme .table7 th,body.darkpagetheme .table7 td {
  border-color:#ddd;
}
...
<h1>HTML <span class="color_h1">Table Borders</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="html_tables.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="html_table_sizes.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">HTML tables can have borders of different styles and shapes.</p>
<hr>
<!--start-->
<h2>How To Add a Border</h2>

<p>To add a border, use the CSS <code class="w3-codespan">border</code> property on 
<code class="w3-codespan">table</code>, <code class="w3-codespan">th</code>, and 
<code class="w3-codespan">td</code> elements:</p>
...
<p>To avoid having double borders like in the example above, set the CSS <code class="w3-codespan">border-collapse</code> 
property to <code class="w3-codespan">collapse</code>.</p>
...
<p>If you set a background color of each cell,
and give the border a white color (the same as the document background),
you get the impression of an invisible border:</p>
<table class="table4" style="width:30%;">
<tr>
<td>&nbsp;</td>
<td>&nbsp;</td>
<td>&nbsp;</td>
...
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
 table, th, td {<br>&nbsp;&nbsp;border: 1px solid white;<br>
  &nbsp;
 border-collapse: collapse;<br>}<br>th, td {<br>&nbsp; background-color: #96D4D4;<br>
  }</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_table_border_style" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Round Table Borders</h2>
<p>With the <code class="w3-codespan">border-radius</code> property, the borders get rounded corners:</p>
<table class="table5" style="width:30%;">
<tr>
<td>&nbsp;</td>
<td>&nbsp;</td>
<td>&nbsp;</td>
...
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
 table, th, td {<br>&nbsp;&nbsp;border: 1px solid 
  black;<br>
  &nbsp;
 border-radius: 10px;<br>}</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_table_border_round1" target="_blank">Try it Yourself &raquo;</a>
</div>


<hr>

<p>Skip the border around the table by leaving out <code class="w3-codespan">table</code> from the css selector:</p>
<table class="table6" style="width:30%;">
<tr>
<td>&nbsp;</td>
<td>&nbsp;</td>
<td>&nbsp;</td>
...
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
 th, td {<br>&nbsp;&nbsp;border: 1px solid 
  black;<br>
  &nbsp;
 border-radius: 10px;<br>}</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_table_border_round2" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Dotted Table Borders</h2>
<p>With the <code class="w3-codespan">border-style</code> property, you can set the 
appearance of the border.</p>

<table class="table7" style="width:30%;">
<tr>
<td>&nbsp;</td>
<td>&nbsp;</td>
<td>&nbsp;</td>
...
<div class="w3-code notranslate cssHigh">
 &nbsp;th, td {<br>&nbsp;
 border-style: dotted;<br>}</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_table_border_dotted" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Border Color</h2>
<p>With the <code class="w3-codespan">border-color</code> property, you can set the color of the border.</p>

<table class="table8" style="width:30%;">
<tr>
<td>&nbsp;</td>
<td>&nbsp;</td>
<td>&nbsp;</td>
...
<div class="w3-code notranslate cssHigh">
 &nbsp;th, td {<br>&nbsp;
 border-color: #96D4D4;<br>}</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_table_border_color" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
