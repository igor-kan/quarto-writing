...
<h1>HTML <span class="color_h1">Div Element</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="html_challenges_blocks.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="html_exercise_embed.asp?topic=div">Next &#10095;</a>
</div>
<hr>
<p class="intro">The <code class="w3-codespan">&lt;div&gt;</code> element is used as a container for other HTML elements.</p>
<hr>
<!--start-->
<h2>The &lt;div&gt; Element</h2>
<p>The <code class="w3-codespan">&lt;div&gt;</code> element is by default a 
block element, meaning that it takes all available width, and comes with line 
breaks before and after.</p>
...
<div class="w3-code notranslate htmlHigh">
  ...
  dolor sit amet.</div>
<h3>Result</h3>  
<div class="w3-white" style="padding:20px 10px;">
Lorem Ipsum<div style="background: #FFF4A3;color:#000;">
  I am a div
</div>
dolor sit amet.
</div>
<br>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_div1" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">&lt;div&gt;</code> element is often used to group sections of a web page together.</p>
...
<div class="w3-code notranslate htmlHigh">
&lt;div&gt;<br>
 &nbsp; &lt;h2&gt;London&lt;/h2&gt;<br>&nbsp; &lt;p&gt;London is the capital city of England.&lt;/p&gt;<br>&nbsp; 
  &lt;p&gt;London has over 9 million inhabitants.&lt;/p&gt;<br>
 &lt;/div&gt;
</div>
<h3>Result</h3>  
<div class="w3-white" style="padding:20px 10px;">
<div style="background-color:#FFF4A3;color:#000;padding:10px;xtext-align:center;">
  <h2>London</h2>
...
<br>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_div2" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<p>If you have a <code class="w3-codespan">&lt;div&gt;</code> element that is 
not 100% wide, and you want to center-align it, set the CSS
<code class="w3-codespan">margin</code> property to <code class="w3-codespan">
auto</code>.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;style&gt;<br>div {<br>&nbsp; width:300px;<br>&nbsp; margin:auto;<br>}<br>
  &lt;/style&gt;</div>
<h3>Result</h3>  
<div class="w3-white" style="padding:20px 10px;">
<div style="background-color:#FFF4A3;color:#000;padding:10px;xtext-align:center;width:300px;margin:auto;">
  <h2>London</h2>
  <p>London is the capital city of England.</p>
  <p>London has over 9 million inhabitants.</p>
</div>
...
<br>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_div3" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>You can have many <code class="w3-codespan">&lt;div&gt;</code> containers on the same page.</p>
...
&lt;div&gt;<br>
 &nbsp; &lt;h2&gt;London&lt;/h2&gt;<br>&nbsp; &lt;p&gt;London is the capital city of England.&lt;/p&gt;<br>&nbsp; 
  &lt;p&gt;London has over 9 million inhabitants.&lt;/p&gt;<br>
 &lt;/div&gt;<br><br>&lt;div&gt;<br>
 &nbsp; &lt;h2&gt;Oslo&lt;/h2&gt;<br>&nbsp; &lt;p&gt;Oslo is the capital city of 
  Norway.&lt;/p&gt;<br>&nbsp; 
  &lt;p&gt;Oslo has over 700,000 inhabitants.&lt;/p&gt;<br>
 &lt;/div&gt;<br><br>&lt;div&gt;<br>
 &nbsp; &lt;h2&gt;Rome&lt;/h2&gt;<br>&nbsp; &lt;p&gt;Rome is the capital city of 
  Italy.&lt;/p&gt;<br>&nbsp; 
  &lt;p&gt;Rome has over 4 million inhabitants.&lt;/p&gt;<br>
 &lt;/div&gt;
</div>
<h3>Result</h3> 
<div class="w3-white" style="padding:20px 10px;xtext-align:center">

<div style="background-color:#FFF4A3;color:#000;xpadding:10px;">
  <h2>London</h2>
  <p>London is the capital city of England.</p>
  <p>London has over 9 million inhabitants.</p>
</div>

<div style="background-color:#FFC0C7;color:#000;xpadding:10px;">
  <h2>Oslo</h2>
  <p>Oslo is the capital city of Norway.</p>
  <p>Oslo has over 700,000 inhabitants.</p>
</div>

<div style="background-color:#D9EEE1;color:#000;xpadding:10px;">
  <h2>Rome</h2>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_div4" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Aligning &lt;div&gt; elements side by side</h2>

<p>When building web pages, you often want to have two or more 
<code class="w3-codespan">&lt;div&gt;</code> elements side by side, like this:</p>
...
<p>There are different methods for aligning elements side by side, all include some CSS styling.
We will look at the most common methods:</p>
<!--stop-->
<hr>
<!--start-->
<h2>Float</h2>

<p>The CSS <code class="w3-codespan">float</code> property was not originally meant to align 
<code class="w3-codespan">&lt;div&gt;</code> elements side-by-side,
but has been used for this purpose for many years.</p>

<p>The CSS <code class="w3-codespan">float</code> property is used for positioning and formatting content 
and allows elements to be positioned horizontally, rather than vertically.</p>

<div class="w3-example">
<h3>Example</h3>
<p>How to use float to align div elements side by side:</p>
<div class="w3-code notranslate htmlHigh">
&lt;style&gt;<br>.mycontainer {<br>&nbsp; width:100%;<br>&nbsp; overflow:auto;<br>
  }<br>.mycontainer div {<br>&nbsp; width:33%; <br>&nbsp; float:left;<br>}<br>&lt;/style&gt;
</div>
<style>
div.demo1{
  padding:10px;
...
<h3>Result</h3>  
<div class="w3-white" style="padding:20px 10px;overflow:auto;">
<div class="demo1" style="background-color:#FFF4A3;color:#000">
  <h2>London</h2>
  <p>London is the capital city of England.</p>
  <p>London has over 9 million inhabitants.</p>
</div>

<div class="demo1" style="background-color:#FFC0C7;color:#000">
  <h2>Oslo</h2>
  <p>Oslo is the capital city of Norway.</p>
  <p>Oslo has over 700,000 inhabitants.</p>
</div>

<div class="demo1" style="background-color:#D9EEE1;color:#000">
  <h2>Rome</h2>
  <p>Rome is the capital city of Italy.</p>
  <p>Rome has over 4 million inhabitants.</p>
</div>
...
<br>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_div_float" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->

<p>Learn more about float in our <a href="/css/css_float.asp">CSS float tutorial</a>.</p>
<hr>
<!--start-->
<h2>Inline-block</h2>

<p>If you change the <code class="w3-codespan">&lt;div&gt;</code> element's 
<code class="w3-codespan">display</code> property from <code class="w3-codespan">block</code> to 
<code class="w3-codespan">inline-block</code>,
the <code class="w3-codespan">&lt;div&gt;</code> elements will no longer add a line break before and after,
and will be displayed side by side instead of on top of each other.</p>

<div class="w3-example">
<h3>Example</h3>
<p>How to use display: inline-block to align div elements side by side:</p>
<div class="w3-code notranslate htmlHigh">
&lt;style&gt;<br>div {<br>&nbsp; width: 30%;<br>&nbsp; display: 
  inline-block;<br>}<br>&lt;/style&gt;
</div>
<style>
div.demo2{
  padding:10px;
...
<h3>Result</h3>  
<div class="w3-white" style="padding:20px 10px;overflow:auto;">
<div class="demo2" style="background-color:#FFF4A3;color:#000">
  <h2>London</h2>
  <p>London is the capital city of England.</p>
  <p>London has over 9 million inhabitants.</p>
</div>

<div class="demo2" style="background-color:#FFC0C7;color:#000">
  <h2>Oslo</h2>
  <p>Oslo is the capital city of Norway.</p>
  <p>Oslo has over 700,000 inhabitants.</p>
</div>

<div class="demo2" style="background-color:#D9EEE1;color:#000">
  <h2>Rome</h2>
  <p>Rome is the capital city of Italy.</p>
  <p>Rome has over 4 million inhabitants.</p>
</div>
...
<br>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_div_inline-block" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>The CSS Flexbox Layout Module was introduced to make it easier to design flexible responsive layout
structure without using float or positioning.</p>

<p>To make the CSS flex method work, surround the <code class="w3-codespan">&lt;div&gt;</code> elements with another 
<code class="w3-codespan">&lt;div&gt;</code> element and give
it the status as a flex container.</p>

<div class="w3-example">
<h3>Example</h3>
<p>How to use flex to align div elements side by side:</p>
<div class="w3-code notranslate htmlHigh">
&lt;style&gt;<br>.mycontainer {<br>&nbsp; display: flex;<br>}<br>.mycontainer 
  &gt; div {<br>&nbsp; width:33%;<br>}<br>&lt;/style&gt;
</div>
<style>
div.demo3{
  display:flex;
...
<br>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_div_flex" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->

<p>Learn more about flex in our <a href="/css/css3_flexbox.asp">CSS flexbox tutorial</a>.</p>
...
<p>Sounds almost the same as flex, but has the ability to define more than one row and position each row 
individually.</p>
<p>The CSS grid method requires that you surround the <code class="w3-codespan">
&lt;div&gt;</code> elements with another <code class="w3-codespan">&lt;div&gt;</code> element and give
the status as a grid container, and you must specify the width of each column.</p>
<div class="w3-example">
  <h3>Example</h3>
<p>How to use grid to align &lt;div&gt; elements side by side:</p>
<div class="w3-code notranslate htmlHigh">
&lt;style&gt;<br>.grid-container {<br>&nbsp; display: grid;<br>&nbsp; 
  grid-template-columns: 33% 33% 33%;<br>}<br>&lt;/style&gt;
</div>
<style>
div.demo4{
  display: grid;
...
<br>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_div_grid" target="_blank">Try it Yourself &raquo;</a>
</div>

<!--stop-->
<p>Learn more about grid in our <a href="/css/css_grid.asp">CSS grid tutorial</a>.</p>
