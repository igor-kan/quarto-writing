...
<html lang="en-US">
<head>
<title>HTML Project: Personal Page</title>
<meta property="og:type" content="article">
<meta property="og:url" content="https://www.w3schools.com/html/html_project_bio.php">
<meta property="og:title" content="HTML Project: Personal Page">
<meta property="og:description" content="Write your first real HTML page. Build a personal bio with formatted text, a list, an image, and links.">
<meta property="og:image" content="https://www.w3schools.com/images/og/projects/HTMLBIO001.png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:title" content="HTML Project: Personal Page">
<meta name="twitter:description" content="Write your first real HTML page. Build a personal bio with formatted text, a list, an image, and links.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/projects/HTMLBIO001.png">
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>HTML Project: Personal Page</h1>
<p style="font-size:15px;color:#6b7280;margin:0 0 22px;line-height:1.5">
  Complete each step in the editor and watch the result as your page takes shape.</p>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="html_challenges_images.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="html_favicon.asp">Next &#10095;</a>
</div>
<hr>
<style id="starter-hero-css">
/* ──────────────────────────────────────────────────────────────
   .starter-* — unified hero shared by project.php (page mode) and
   workspace.php intro modal (modal mode). Visual style: green
   pill + bold headline + 3 bullets + green CTA on the left, a
   stacked browser-window mockup on the right.
   ────────────────────────────────────────────────────────────── */
...
.starter-hero{
  ...
  border-radius:12px;
  background:
    radial-gradient(circle at 18% 12%, rgba(4,170,109,.08), transparent 45%),
    radial-gradient(circle at 92% 88%, rgba(4,170,109,.05), transparent 50%),
    linear-gradient(180deg,#fbfdfc 0%,#f8faf9 100%);
...
.starter-hero::before{
  ...
  pointer-events:none;
  mask-image:linear-gradient(180deg,rgba(0,0,0,.6),rgba(0,0,0,0) 70%);
  -webkit-mask-image:linear-gradient(180deg,rgba(0,0,0,.6),rgba(0,0,0,0) 70%);
}
.starter-hero-left,.starter-hero-right{position:relative;z-index:1}
.starter-hero-left{display:flex;flex-direction:column;min-width:0}
/* social share bar — top-right corner of the hero (filled by /inc_share.inc) */
.starter-hero-share{position:absolute;top:22px;right:24px;z-index:6}
@media (max-width:700px){.starter-hero-share{position:static;display:flex;justify-content:flex-end;margin:0 0 4px}}
.starter-main-content{display:block}

/* ── Tech stack badges (replaces the old .starter-pill) ── */
.starter-tech-row{
...
/* Meta line + sec-links inline under the description */
.starter-meta-inline{
  display:flex; flex-wrap:wrap; align-items:center; gap:8px;
  font-size:14px; color:#64748b;
  margin:0 0 8px;
}
.starter-meta-inline strong{ color:#04AA6D; font-weight:700; }
.starter-meta-sep{ color:#cbd5e0; }
.starter-meta-pills{ display:inline-flex; flex-wrap:wrap; gap:6px; }
.starter-meta-pills .starter-tech-badge{ margin:0; }
body.darkpagetheme .starter-meta-inline{ color:#9fb0c0; }
body.darkpagetheme .starter-meta-sep{ color:#475569; }

.starter-sec-links-inline{
  margin:0 0 20px;
  border-bottom:1px solid #e5e7eb;
  padding-bottom:14px;
}
body.darkpagetheme .starter-sec-links-inline{ border-bottom-color:#2b3a4a; }
...
.starter-bullets-heading{
  font-size:13px; font-weight:700;
  text-transform:uppercase; letter-spacing:.6px;
  color:#64748b;
  margin:0 0 10px;
}
.starter-bullets{ list-style:none; padding:0; margin:0 0 28px; }
.starter-bullets li{
  display:flex; align-items:center; gap:10px;
  font-size:15px; color:#1f2937; padding:6px 0;
}
.starter-bullets .starter-check{
  flex:0 0 22px; width:22px; height:22px; border-radius:50%;
  background:#04AA6D;
  display:inline-flex; align-items:center; justify-content:center;
  color:#fff;
}
.starter-bullets .starter-check svg{display:block}
...
.starter-cta{
  ...
  box-shadow:0 1px 2px rgba(4,170,109,.2), 0 6px 16px rgba(4,170,109,.18);
  transition:background .15s ease, box-shadow .15s ease, transform .05s ease;
}
.starter-cta:hover{background:#059862;color:#fff;text-decoration:none;box-shadow:0 1px 2px rgba(4,170,109,.25), 0 8px 20px rgba(4,170,109,.22)}
.starter-cta:active{transform:translateY(1px)}
.starter-cta svg{display:block}

.starter-cta-locked{
  display:inline-flex; align-items:center; gap:8px;
  background:#fff; color:#1a202c; font-weight:700;
  padding:14px 28px; border:1px solid #d1d5db; border-radius:8px;
  text-decoration:none; font-size:15px; cursor:pointer; font-family:inherit;
}
.starter-cta-locked:hover{background:#f8fafc;border-color:#04AA6D;color:#1a202c;text-decoration:none}
.starter-cta-locked svg{color:#9ca3af}

.starter-cta-row{display:flex;align-items:center;flex-wrap:wrap;gap:18px;margin-bottom:10px}
.starter-cta-note{font-size:13px;color:#6b7280}
...
.starter-sec-link{
  ...
  padding:2px 0 3px; cursor:pointer; font-family:inherit;
  font-weight:500;
  transition:color .15s ease, border-color .15s ease;
}
.starter-sec-link:hover{color:#04AA6D;border-bottom-color:#04AA6D;text-decoration:none}
.starter-sec-link svg{display:block; flex:0 0 auto}
.starter-sec-link.is-active{
  color:#04AA6D; font-weight:700; border-bottom-color:#04AA6D;
}
body.darkpagetheme .starter-sec-link.is-active{color:#04AA6D}

/* ── Footer (CTA + sec-links) — ALWAYS visible across all 3 views ── */
.starter-footer{margin-top:auto}

/* ── Right column: stacked browser-window mockup ── */
.starter-hero-right{position:relative;min-height:340px}
.starter-mock-stack{position:relative;width:100%;max-width:520px;margin-left:auto}
.starter-mock-stack::before{
  content:''; position:absolute;
  top:24px; left:24px; right:-18px; bottom:-18px;
...
.starter-mock{
  ...
  background:#fff; border:1px solid #e5e7eb; border-radius:10px;
  overflow:hidden;
  box-shadow:0 18px 40px rgba(15,23,42,.12), 0 4px 8px rgba(15,23,42,.05);
}
.starter-mock-bar{
  display:flex; align-items:center; gap:10px;
  padding:9px 12px; background:#f3f4f6; border-bottom:1px solid #e5e7eb;
}
.starter-mock-dots{display:flex;gap:6px}
.starter-mock-dot{width:11px;height:11px;border-radius:50%;display:inline-block}
.starter-mock-dot.red{background:#ff5f57}
.starter-mock-dot.yel{background:#febc2e}
.starter-mock-dot.grn{background:#28c840}
.starter-mock-url{
  flex:1; background:#fff; border:1px solid #e5e7eb; border-radius:5px;
  font-size:12px; color:#6b7280; padding:4px 10px;
  font-family:Consolas,Menlo,monospace;
  white-space:nowrap; overflow:hidden; text-overflow:ellipsis;
}
.starter-mock-body{position:relative;background:#fff;height:340px;overflow:hidden}
.starter-mock-iframe,
.starter-mock-frame{width:100%;height:100%;border:0;display:block;background:#fff}
.starter-mock-picture{display:block;width:100%;height:100%}
.starter-mock-img{
...
.starter-mock-code .ckw{color:#cba6f7}
.starter-mock-code .cst{color:#a6e3a1}
.starter-mock-code .ccm{color:#6c7086;font-style:italic}
.starter-mock-code .cnm{color:#fab387}
.starter-mock-code .cfn{color:#89b4fa}
.starter-mock-terminal{
  margin:0; padding:18px 20px;
...
.starter-mock-terminal .tprompt{color:#7dd3fc}
.starter-mock-terminal .tdim{color:#64748b}
.starter-mock-terminal .tjson{color:#fde68a}

/* ── "How this works" inline reveal (used in both modes) ── */
.starter-howto-reveal{
  display:none;
  margin:14px 0 0;
  border:1px solid #e5e7eb;
  border-radius:10px;
...
.starter-howto-reveal.open{display:block;animation:starterFadeIn .25s ease}
@keyframes starterFadeIn{from{opacity:0;transform:translateY(-4px)}to{opacity:1;transform:none}}
.starter-howto-reveal h3{
  font-size:13px; font-weight:700; color:#64748b;
  margin:0 0 12px; text-transform:uppercase; letter-spacing:1px;
}
.starter-howto-list{ list-style:none; padding:0; margin:0; }
.starter-howto-list li{
  display:grid; grid-template-columns:32px 1fr;
  gap:12px; align-items:flex-start;
  padding:10px 0;
  border-bottom:1px solid rgba(148,163,184,.18);
  font-size:14px; line-height:1.5; color:#2D3748;
}
.starter-howto-list li:last-child{border-bottom:0}
.starter-howto-list .starter-howto-num{
  display:flex; align-items:center; justify-content:center;
  width:28px; height:28px; border-radius:50%;
  background:#04AA6D; color:#fff;
  font:700 12.5px 'Segoe UI', Arial, sans-serif;
}
.starter-howto-list strong{color:#1a202c}
.starter-howto-list code{
  color:crimson; background:rgba(222,222,222,.3);
  padding:0 4px; font-family:Consolas,Menlo,monospace; font-size:92%;
}

/* ── "How it's graded" inline reveal (modal mode only) — mirrors the
   .starter-howto-reveal panel style, but the body is a compact rubric
   table designed to fit inside the modal's ~1040px max-width. ── */
.starter-grading-reveal{
  display:none;
  margin:14px 0 0;
  border:1px solid #e5e7eb;
  border-radius:10px;
...
.starter-grading-reveal.open{display:block;animation:starterFadeIn .25s ease}
.starter-grading-reveal h3{
  font-size:13px; font-weight:700; color:#64748b;
  margin:0 0 6px; text-transform:uppercase; letter-spacing:1px;
}
.starter-grading-reveal .starter-grading-intro{
  font-size:13px; color:#475569; line-height:1.5; margin:0 0 12px;
}
.starter-grading-reveal .starter-grading-intro b{color:#04AA6D}
.starter-grading-scroll{
  /* Cap the rubric table at ~340px so a 10-step project with multi-line
     criteria scrolls inside the modal instead of pushing the CTA offscreen. */
  max-height:340px; overflow:auto;
  border:1px solid #e5e7eb; border-radius:6px;
}
.starter-grading-table{
  width:100%; border-collapse:separate; border-spacing:0;
  background:#fff;
  font-size:13px;
}
.starter-grading-table th{
  text-align:left; font-size:10.5px; font-weight:700; text-transform:uppercase;
  letter-spacing:.6px; padding:8px 10px; background:#f8fafc;
  border-bottom:1px solid #e5e7eb; color:#6b7280;
  position:sticky; top:0; z-index:1;
}
.starter-grading-table td{
  padding:8px 10px; border-bottom:1px solid #eef2f7;
  font-size:13px; color:#2d3748; vertical-align:top; line-height:1.45;
}
.starter-grading-table tr:last-child td{border-bottom:none}
.starter-grading-table .starter-grading-weight{color:#6b7280;font-weight:600;white-space:nowrap;text-align:right;font-size:12px}
.starter-grading-table .starter-grading-num{
  display:inline-flex; align-items:center; justify-content:center;
  width:20px; height:20px; border-radius:50%;
  background:#04AA6D; color:#fff; font-weight:700; font-size:11px; line-height:1;
}
.starter-grading-table .starter-grading-title{font-weight:700;color:#1a202c;display:block;margin-bottom:2px;font-size:13px}
.starter-grading-table .starter-grading-check{color:#4a5568;font-size:12.5px;line-height:1.45}
.starter-grading-table .starter-grading-check ul{margin:0;padding-left:16px}
.starter-grading-table .starter-grading-check li{margin:0;font-size:12.5px;line-height:1.45}
.starter-grading-table .starter-grading-nocheck{color:#94a3b8;font-style:italic;font-size:12.5px}

/* ── Dark theme ── */
body.darkpagetheme .starter-hero{
  background:
    radial-gradient(circle at 18% 12%, rgba(4,170,109,.10), transparent 45%),
    linear-gradient(180deg,#18222d 0%,#15202b 100%);
  background-color:#15202b;
  border-color:#2b3a4a;
}
body.darkpagetheme .starter-heading{color:#f3f4f6}
body.darkpagetheme .starter-desc{color:#9fb0c0}
body.darkpagetheme .starter-bullets li{color:#cbd5e0}
body.darkpagetheme .starter-bullets-heading{color:#9fb0c0}
body.darkpagetheme .starter-mock-bar{background:#1b2733;border-color:#2b3a4a}
body.darkpagetheme .starter-mock-url{background:#15202b;border-color:#2b3a4a;color:#9fb0c0}
body.darkpagetheme .starter-mock{background:#15202b;border-color:#2b3a4a}
body.darkpagetheme .starter-mock-stack::before{background:#15202b;border-color:#2b3a4a}
body.darkpagetheme .starter-sec-link{color:#9fb0c0}
body.darkpagetheme .starter-howto-reveal{background:#15202b;border-color:#2b3a4a}
body.darkpagetheme .starter-howto-list li{color:#cbd5e0;border-bottom-color:#233242}
body.darkpagetheme .starter-howto-list strong{color:#f3f4f6}
body.darkpagetheme .starter-grading-reveal{background:#15202b;border-color:#2b3a4a}
body.darkpagetheme .starter-grading-reveal .starter-grading-intro{color:#9fb0c0}
body.darkpagetheme .starter-grading-scroll{border-color:#2b3a4a}
body.darkpagetheme .starter-grading-table{background:#15202b}
body.darkpagetheme .starter-grading-table th{background:#1b2733;color:#9fb0c0;border-bottom-color:#314253}
body.darkpagetheme .starter-grading-table td{color:#cbd5e0;border-bottom-color:#233242}
body.darkpagetheme .starter-grading-table .starter-grading-title{color:#fff}
body.darkpagetheme .starter-grading-table .starter-grading-check{color:#a8b5c5}

/* ── Responsive ── */
@media(max-width:900px){
  .starter-hero{ grid-template-columns:1fr; padding:32px 28px; gap:28px; }
  .starter-heading{font-size:34px}
  .starter-mock-stack{margin-left:0;max-width:none}
  .starter-hero-right{min-height:0}
  .starter-mock-body{height:280px}
}
@media(max-width:500px){
  .starter-hero{padding:26px 20px}
  .starter-heading{font-size:28px}
  .starter-cta{display:flex;justify-content:center;width:100%;padding:14px 20px}
  .starter-cta-row{flex-direction:column;align-items:stretch;gap:12px}
  .starter-cta-note{text-align:center}
}

/* ── Modal-mode wrapper tweaks ── */
.starter-in-modal .starter-hero{
  margin:0;
  box-shadow:none;
  border:0;
  border-radius:0;
...
.starter-in-modal .starter-heading{font-size:36px}
.starter-in-modal .starter-mock-body{height:280px}
@media(max-width:880px){
  .starter-in-modal .starter-hero{ grid-template-columns:1fr; gap:24px; padding:26px 28px; }
  .starter-in-modal .starter-heading{font-size:28px}
}

/* ── Swap-view behaviour (both modes) ──
   Clicking "How it works" or "Grading" REPLACES the .starter-main-content
   block (pill, headline, description, bullets) with the explainer/grading
   panel. The .starter-footer (CTA + 3-link bar) stays put, so the user can
   switch back to "Instructions" from any view. The mockup on the right
   stays put across all 3 views. */
.starter-hero.showing-howto > .starter-hero-left > .starter-main-content,
.starter-hero.showing-grading > .starter-hero-left > .starter-main-content{
  display:none !important;
}
.starter-hero.showing-howto > .starter-hero-left > .starter-howto-reveal,
.starter-hero.showing-grading > .starter-hero-left > .starter-grading-reveal{
  display:block !important;
  background:transparent; border:0; padding:0; margin:0 0 18px;
  animation:starterFadeIn .2s ease;
  min-width:0;
}
.starter-hero.showing-grading .starter-grading-scroll{
  max-height:none;
}
/* The reveal headings get tighter spacing when they are the primary view. */
.starter-hero.showing-howto .starter-howto-reveal h3,
.starter-hero.showing-grading .starter-grading-reveal h3{
  margin-top:0;
}
</style>

<div class="starter-hero" id="starter-hero-HTMLBIO001-page">
    <div class="starter-hero-share" data-ws-share></div>
    <div class="starter-hero-left">
        <h2 class="starter-heading">Build your first HTML project, step-by-step</h2>
                  <p class="starter-desc">Write your first real HTML page.</p>
              <p class="starter-desc">Build a personal bio with formatted text, a list, an image, and links.</p>
          
        <p class="starter-meta-inline">
      <span>Easy</span>
      <span class="starter-meta-sep">&middot;</span>
      <strong>+70 XP</strong>
              <span class="starter-meta-sep">&middot;</span>
        <span class="starter-meta-pills" aria-label="Tech stack">
                      <span class="starter-tech-badge">HTML</span>
                  </span>
          </p>
    <div class="starter-sec-links starter-sec-links-inline">
      <button type="button"
              class="starter-sec-link is-active"
              data-starter-instructions-toggle="starter-hero-HTMLBIO001-page"
              aria-pressed="true">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><line x1="8" y1="6" x2="21" y2="6"/><line x1="8" y1="12" x2="21" y2="12"/><line x1="8" y1="18" x2="21" y2="18"/><line x1="3" y1="6" x2="3.01" y2="6"/><line x1="3" y1="12" x2="3.01" y2="12"/><line x1="3" y1="18" x2="3.01" y2="18"/></svg>
        Instructions
      </button>
      <button type="button"
              class="starter-sec-link"
              data-starter-howto-toggle="starter-howto-HTMLBIO001-page"
              aria-expanded="false"
              aria-controls="starter-howto-HTMLBIO001-page">
      ...
      <h4 class="starter-bullets-heading">What you will use in this project</h4>
      <ul class="starter-bullets">
                  <li>
            <span class="starter-check" aria-hidden="true">
            ...
            <span>Lists with &lt;ul&gt; and &lt;li&gt;</span>
          </li>
                  <li>
            <span class="starter-check" aria-hidden="true">
              <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
            </span>
            <span>Linking pages with &lt;a&gt;</span>
          </li>
                  <li>
            <span class="starter-check" aria-hidden="true">
              <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
            </span>
            <span>Embedding images with &lt;img&gt;</span>
          </li>
              </ul>
    </div>

        <div class="starter-howto-reveal" id="starter-howto-HTMLBIO001-page" role="region" aria-label="How it works">
      <h3>How it works</h3>
      <ol class="starter-howto-list">
        <li>
          <span class="starter-howto-num">1</span>
          <span><strong>Follow the steps on the left.</strong> Each dot in the stepper bar is one focused chunk of work. Read the instructions, the &ldquo;What to do&rdquo; checklist, and any hints.</span>
        </li>
        <li>
          <span class="starter-howto-num">2</span>
          <span><strong>Write your code on the right.</strong> The editor is yours. Files auto-save as you type. Use the <strong>Preview</strong> tab to see your work in action.</span>
        </li>
        <li>
          <span class="starter-howto-num">3</span>
          <span><strong>Click <code>Check code</code> when you&rsquo;re ready.</strong> We grade your work against the step&rsquo;s rubric and tell you exactly what passed and what still needs work.</span>
        </li>
        <li>
          <span class="starter-howto-num">4</span>
          <span><strong>Pass a step to move on.</strong> Build the project cumulatively. Pass every step to complete it and earn the full XP.</span>
        </li>
      </ol>
    </div>

            <div class="starter-grading-reveal" id="starter-grading-HTMLBIO001-page" role="region" aria-label="Grading">
      <h3>How it&rsquo;s graded</h3>
      <p class="starter-grading-intro">
        This project is broken into <b>5 steps</b>.
        Each one has its own pass criterion. Click <b>Check code</b> on every step
        to verify your progress and earn the full <b>+70 XP</b>.
      </p>
      <div class="starter-grading-scroll">
        <table class="starter-grading-table">
          <tr>
            <th style="width:36px">#</th>
            <th>Step &amp; pass criterion</th>
            <th style="width:64px">Weight</th>
          </tr>
                      <tr>
              <td><span class="starter-grading-num">1</span></td>
              <td>
                <span class="starter-grading-title">Heading and intro</span>
                                  <div class="starter-grading-check"><ul>
                                          <li>Page has exactly one &lt;h1&gt;</li>
                                          <li>Page has at least one intro paragraph</li>
                                      </ul></div>
                              </td>
              <td class="starter-grading-weight">25 pts</td>
            </tr>
                      <tr>
              <td><span class="starter-grading-num">2</span></td>
              <td>
                <span class="starter-grading-title">Format your about-me paragraph</span>
                                  <span class="starter-grading-check">About-me uses bold, italic, and &lt;mark&gt;</span>
                              </td>
              <td class="starter-grading-weight">20 pts</td>
            </tr>
                      <tr>
              <td><span class="starter-grading-num">3</span></td>
              <td>
                <span class="starter-grading-title">Add a list</span>
                                  <span class="starter-grading-check">Page has an &lt;h2&gt; heading, a &lt;ul&gt;, and at least three &lt;li&gt; items</span>
                              </td>
              <td class="starter-grading-weight">15 pts</td>
            </tr>
                      <tr>
              <td><span class="starter-grading-num">4</span></td>
              <td>
                <span class="starter-grading-title">Add an image</span>
                                  <span class="starter-grading-check">Page has an &lt;img&gt; with src and alt</span>
                              </td>
              <td class="starter-grading-weight">20 pts</td>
            </tr>
                      <tr>
              <td><span class="starter-grading-num">5</span></td>
              <td>
                <span class="starter-grading-title">Outbound links</span>
                                  <span class="starter-grading-check">Page has at least two &lt;a href&gt; links</span>
                              </td>
              <td class="starter-grading-weight">20 pts</td>
            </tr>
                  </table>
      ...
      <div class="starter-cta-row" id="starter-cta-row-HTMLBIO001-page">
                  <a href="/projects/workspace.php?project=HTMLBIO001"             class="starter-cta ga-featured ga-start-project-htmlbio001"
             id="starter-cta-btn-HTMLBIO001-page"
             data-cta-new-window="0">
            Start Building Now            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"/></svg>
          </a>
          <span class="starter-cta-note" id="starter-cta-note-HTMLBIO001-page">Opens an embedded code editor. No installs required.</span>
              </div>

    </div>
  </div>

  <div class="starter-hero-right">
    <div class="starter-mock-stack">
      <div class="starter-mock">
        <div class="starter-mock-bar">
          <span class="starter-mock-dots"><i></i><i></i><i></i></span>
          <span class="starter-mock-url">index.html</span>
        </div>
        <div class="starter-mock-body">
                      <picture class="starter-mock-picture">
                              <source type="image/webp" srcset="/projects/templates/HTMLBIO001/preview.webp">
                            <img src="/projects/templates/HTMLBIO001/preview.png"
                   alt="Personal Page preview"
                   class="starter-mock-img"
                   loading="lazy">
            </picture>
                  </div>
      </div>
...
<script>
(function () {
  function findHero(el) {
    while (el && el !== document) {
      if (el.classList && el.classList.contains('starter-hero')) return el;
      el = el.parentNode;
    }
    return null;
  }
  /* Refresh the .is-active marker + aria flags on the three sec-links
     within a hero so the user can always see which view they're on.
     `view` is one of 'instructions', 'howto', 'grading'. */
  function syncSecLinks(hero, view) {
    if (!hero) return;
    var instr = hero.querySelector('[data-starter-instructions-toggle]');
    var howto = hero.querySelector('[data-starter-howto-toggle]');
    var grade = hero.querySelector('[data-starter-grading-toggle]');
    if (instr) {
      if (view === 'instructions') instr.classList.add('is-active');
      else                         instr.classList.remove('is-active');
      instr.setAttribute('aria-pressed', view === 'instructions' ? 'true' : 'false');
    }
    if (howto) {
      if (view === 'howto') howto.classList.add('is-active');
      else                  howto.classList.remove('is-active');
      howto.setAttribute('aria-expanded', view === 'howto' ? 'true' : 'false');
    }
    if (grade) {
      if (view === 'grading') grade.classList.add('is-active');
      else                    grade.classList.remove('is-active');
      grade.setAttribute('aria-expanded', view === 'grading' ? 'true' : 'false');
    }
  }
  document.addEventListener('click', function (e) {
    var t = e.target;
    while (t && t !== document) {
      if (t.getAttribute && t.getAttribute('data-starter-howto-toggle')) {
        e.preventDefault();
        var id = t.getAttribute('data-starter-howto-toggle');
        var panel = document.getElementById(id);
        if (!panel) return;
        var hero = findHero(panel);
        if (!hero) return;
        hero.classList.remove('showing-grading');
        hero.classList.add('showing-howto');
        syncSecLinks(hero, 'howto');
        return;
      }
      t = t.parentNode;
    }
  ...
  document.addEventListener('click', function (e) {
    var t = e.target;
    while (t && t !== document) {
      if (t.getAttribute && t.getAttribute('data-starter-grading-toggle')) {
        e.preventDefault();
        var id = t.getAttribute('data-starter-grading-toggle');
        var panel = document.getElementById(id);
        if (!panel) return;
        var hero = findHero(panel);
        if (!hero) return;
        hero.classList.remove('showing-howto');
        hero.classList.add('showing-grading');
        syncSecLinks(hero, 'grading');
        return;
      }
      t = t.parentNode;
    }
  });
  /* "Instructions" link clears both swap classes — returns to main view. */
  document.addEventListener('click', function (e) {
    var t = e.target;
    while (t && t !== document) {
      if (t.getAttribute && t.getAttribute('data-starter-instructions-toggle')) {
        e.preventDefault();
        var heroId = t.getAttribute('data-starter-instructions-toggle');
        var hero = document.getElementById(heroId);
        if (hero) {
          hero.classList.remove('showing-howto', 'showing-grading');
          syncSecLinks(hero, 'instructions');
        }
        return;
      }
      t = t.parentNode;
  ...
  /* Legacy "Back to project" handler kept for any callers still emitting
     data-starter-back — clears both swap classes like Instructions does. */
  document.addEventListener('click', function (e) {
    var t = e.target;
    while (t && t !== document) {
      if (t.getAttribute && t.getAttribute('data-starter-back')) {
        e.preventDefault();
        var heroId = t.getAttribute('data-starter-back');
        var hero = document.getElementById(heroId);
        if (hero) {
          hero.classList.remove('showing-howto', 'showing-grading');
          syncSecLinks(hero, 'instructions');
  ...
  document.addEventListener('click', function (e) {
    var t = e.target;
    while (t && t !== document) {
      if (t.getAttribute && t.getAttribute('data-starter-modal-close') === '1') {
        e.preventDefault();
        if (typeof window.__w3pHideIntro === 'function') {
          window.__w3pHideIntro();
        } else {
