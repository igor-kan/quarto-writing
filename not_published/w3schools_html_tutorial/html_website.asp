...
<html lang="en-US">
<head>
<title>Create HTML Website Server | W3Schools.com | W3Schools Spaces</title>
<meta charset="utf-8">
...
<h1>HTML Website <span class="color_h1">Hosting</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="html_challenges.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="html_syllabus.asp">Next &#10095;</a>
</div>
<hr>
...
<div class="w3-center hero-background">
            <div class="w3-content">
                <div class="top-section" style="padding-top:100px; color: #ffffff;padding-left:25px;padding-right:25px;">
                    ...
                    <h1 class="hero-title" style="color: #ffffff;font-size: 58px;font-weight:700">Create Website with HTML</h1>
