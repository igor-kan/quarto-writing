...
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="tryit.asp?filename=tryhtml_div1">&lt;div&gt; elements come with linebreaks</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryhtml_div2">&lt;div&gt; as a container</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryhtml_div3">Center align a &lt;div&gt; element</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryhtml_div4">Multiple &lt;div&gt; elements</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryhtml_div_float">Floating &lt;div&gt; elements</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryhtml_div_inline-block">Position &lt;div&gt; elements with display:inline-block</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryhtml_div_flex">Position &lt;div&gt; elements with display:flex</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryhtml_div_grid">Position &lt;div&gt; elements with display:grid</a>
</div>
<p><a href="html_div.asp" class="ws-btn">Examples explained</a></p>
<hr>
