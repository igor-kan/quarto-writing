...
<h1>HTML <span class="color_h1">Semantic Elements</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="html_challenges_computercode.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="html_exercise_embed.asp?topic=semantic_elements">Next &#10095;</a>
</div>
<hr>
...
<p>Examples of <strong>semantic</strong> elements: <code class="w3-codespan">&lt;img&gt;</code>, <code class="w3-codespan">&lt;table&gt;</code>, and <code class="w3-codespan">&lt;article&gt;</code> - Clearly defines its content.</p>
<!--stop-->
<hr>
<!--start-->
...
<p>In HTML there are several semantic elements that can be used to define different parts of a web page:
&nbsp;</p>
...
<div style="width:260px;float:left;margin-bottom:15px;"><img alt="HTML Semantic Elements"
...
<p>According to W3C's HTML documentation: &quot;A section is a thematic grouping of content, typically with a heading.&quot;</p>
<p>Examples of where a <code class="w3-codespan">&lt;section&gt;</code> element can be used:</p>
<ul>
  <li>Chapters</li>
  <li>Introduction</li>
  <li>News items</li>
...
<p>A web page could normally be split into sections for introduction, 
...
<p>Examples of where the <code class="w3-codespan">&lt;article&gt;</code> element can be used:</p>
<ul>
  <li>Forum posts</li>
  <li>Blog posts</li>
  <li>User comments</li>
...
<div class="w3-example">
<h3>Example 2</h3>
<p>Use CSS to style the &lt;article&gt; element:</p>
<div class="w3-code notranslate htmlHigh">
  ...
  &lt;h2&gt;Google Chrome&lt;/h2&gt;<br>&nbsp;&nbsp;&nbsp; &lt;p&gt;Google Chrome is a web browser 
  developed by Google, released in 2008. Chrome is the world's most popular web 
  browser today!&lt;/p&gt;<br>&nbsp; &lt;/article&gt;<br>&nbsp; &lt;article class=&quot;browser&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;h2&gt;Mozilla Firefox&lt;/h2&gt;<br>&nbsp;&nbsp;&nbsp; &lt;p&gt;Mozilla Firefox is an 
  open-source web browser developed by Mozilla. Firefox has been the second most 
  popular web browser since January, 2018.&lt;/p&gt;<br>&nbsp; &lt;/article&gt;<br>&nbsp; 
  &lt;article class=&quot;browser&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;h2&gt;Microsoft Edge&lt;/h2&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;p&gt;Microsoft Edge is a web browser developed by Microsoft, released in 2015. 
  Microsoft Edge replaced Internet Explorer.&lt;/p&gt;<br>&nbsp; &lt;/article&gt;<br>
  &lt;/article&gt;<br><br>&lt;/body&gt;<br>&lt;/html&gt;
</div>
<a target="_blank" href="tryit.asp?filename=tryhtml5_article2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>So, you will find HTML pages with <code class="w3-codespan">&lt;section&gt;</code> elements 
...
<p>The <code class="w3-codespan">&lt;header&gt;</code> element represents a container for introductory content or 
a set of navigational links.</p>
<p>A <code class="w3-codespan">&lt;header&gt;</code> element typically contains:</p>
<ul>
  <li>one or more heading elements (&lt;h1&gt; - &lt;h6&gt;)</li>
  <li>logo or icon</li>
  <li>authorship information</li>
</ul>
<p><b>Note:</b> You can have several <code class="w3-codespan">&lt;header&gt;</code> elements in one 
HTML document. However, <code class="w3-codespan">&lt;header&gt;</code> cannot be placed within a <code class="w3-codespan">&lt;footer&gt;</code>, <code class="w3-codespan">&lt;address&gt;</code> or another <code class="w3-codespan">&lt;header&gt;</code> element.</p>
<div class="w3-example">
<h3>Example</h3>
...
<p>The <code class="w3-codespan">&lt;footer&gt;</code> element defines a footer for a document or section.</p>
<p>A <code class="w3-codespan">&lt;footer&gt;</code> element typically contains:</p>
<ul>
  <li>authorship information</li>
  <li>copyright 
information</li>
...
<p>You can have several <code class="w3-codespan">&lt;footer&gt;</code> elements in one document.</p>
<div class="w3-example">
<h3>Example</h3>
...
<p>The <code class="w3-codespan">&lt;aside&gt;</code> content should be 
indirectly related to the surrounding content.</p>
<div class="w3-example">
<h3>Example</h3>
...
<div class="w3-example">
<h3>Example 2</h3>
<p>Use CSS to style the &lt;aside&gt; element:</p>
<div class="w3-code notranslate htmlHigh">
  ...
  <br>&lt;p&gt;My family and I visited The Epcot 
  center this summer. The weather was nice, and Epcot was amazing! I had a great 
  summer together with my family!&lt;/p&gt;<br><br>&lt;aside&gt;<br>&lt;p&gt;The Epcot center is a 
  theme park at Walt Disney World Resort featuring exciting attractions, 
  international pavilions, award-winning fireworks and seasonal special 
  events.&lt;/p&gt;<br>&lt;/aside&gt;<br><br>&lt;p&gt;My family and I visited The Epcot center 
  this summer. The weather was nice, and Epcot was amazing! I had a great summer 
  together with my family!&lt;/p&gt;<br>&lt;p&gt;My family and I visited The Epcot center 
  this summer. The weather was nice, and Epcot was amazing! I had a great summer 
  together with my family!&lt;/p&gt;<br><br>&lt;/body&gt;<br>&lt;/html&gt;
</div>
<a target="_blank" href="tryit.asp?filename=tryhtml5_aside2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>HTML &lt;figure&gt; and &lt;figcaption&gt; Elements</h2>
<p>The <code class="w3-codespan">&lt;figure&gt;</code> tag specifies self-contained content, like illustrations, diagrams, photos, code listings, etc.</p>
<p>The <code class="w3-codespan">&lt;figcaption&gt;</code> tag defines a caption for a <code class="w3-codespan">&lt;figure&gt;</code> element. The <code class="w3-codespan">&lt;figcaption&gt;</code> element can be placed as the first or 
as the last child of a <code class="w3-codespan">&lt;figure&gt;</code> element.</p>
<p>The <code class="w3-codespan">&lt;img&gt;</code> element defines the actual image/illustration.&nbsp;</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;figure&gt;<br>
