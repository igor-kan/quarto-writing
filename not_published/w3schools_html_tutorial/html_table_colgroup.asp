...
<style>
.table1, .table1 th, .table1 td, .table2, .table2 th, .table2 td, .table3, .table3 th, .table3 td  {
  border:1px solid #282A35;
  border-collapse: collapse;
  font-size:12px
}
body.darkpagetheme .table1,body.darkpagetheme .table1 th,body.darkpagetheme .table1 td,body.darkpagetheme .table2,body.darkpagetheme .table2 th,body.darkpagetheme .table2 td,body.darkpagetheme .table3, .table3 th,body.darkpagetheme .table3 td  {
...
.table3 th,.table3 td {
  border:none;
  border-bottom:1px solid rgba(150, 212, 212,1);
}
...
<h1>HTML <span class="color_h1">Table Colgroup</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="html_table_styling.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="html_exercise_embed.asp?topic=tables">Next &#10095;</a>
</div>
<hr>
<p class="intro">The <code class="w3-codespan">&lt;colgroup&gt;</code> element is used to style specific 
...
<p>
If you want to style the first two columns of a table, use the <code class="w3-codespan">&lt;colgroup&gt;</code>
and <code class="w3-codespan">&lt;col&gt;</code>
elements.
</p>
...
<p>The <code class="w3-codespan">&lt;colgroup&gt;</code> element should be used as a container for the column 
specifications.</p>
<p>Each group is specified with a <code class="w3-codespan">&lt;col&gt;</code> element.</p>
<p>The <code class="w3-codespan">span</code> attribute specifies how many columns get the style.</p>
<p>The <code class="w3-codespan">style</code> attribute specifies the style to give the columns.</p>

<div class="w3-panel ws-note">
<p><b>Note:</b> There is a very limited selection of <a href="#legalcss">legal CSS properties for colgroups</a>.</p>
</div>
...
<div class="w3-code notranslate htmlHigh">
  &lt;table&gt;<br>&nbsp; &lt;colgroup&gt;<br>&nbsp;&nbsp;&nbsp; &lt;col span=&quot;2&quot; 
  style=&quot;background-color: #D6EEEE&quot;&gt;<br>&nbsp; &lt;/colgroup&gt;<br>
  &nbsp; &lt;tr&gt;<br>&nbsp;&nbsp;&nbsp; &lt;th&gt;MON&lt;/th&gt;<br>&nbsp;&nbsp;&nbsp; &lt;th&gt;TUE&lt;/th&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;th&gt;WED&lt;/th&gt;<br>&nbsp;&nbsp;&nbsp; &lt;th&gt;THU&lt;/th&gt;<br>... </div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_table_colgroup1" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
<p><b>Note:</b> The <code class="w3-codespan">&lt;colgroup&gt;</code> tag must be a 
child of a <code class="w3-codespan">&lt;table&gt;</code> element and should be placed 
before any other table elements, like <code class="w3-codespan">&lt;thead&gt;</code>,
<code class="w3-codespan">&lt;tr&gt;</code>, <code class="w3-codespan">&lt;td&gt;</code> 
etc., but after the <code class="w3-codespan">&lt;caption&gt;</code> element, if 
present.</p>
</div>
<!--stop-->
<hr>
<!--start-->
<a name="legalcss"><h2>Legal CSS Properties</h2></a>

<p>
There is only a very limited selection of CSS properties that are allowed to be used in the colgroup:</p>

<p>
<code class="w3-codespan"><a href="/cssref/pr_dim_width.php">width</a></code> property<br>
<code class="w3-codespan"><a href="/cssref/pr_class_visibility.php">visibility</a></code> property<br>
<code class="w3-codespan"><a href="/cssref/css3_pr_background.php">background</a></code> properties<br>
<code class="w3-codespan"><a href="/cssref/pr_border.php">border</a></code> properties</p>
...
<p>If you want to style multiple columns with different styles, use more than 
one
<code class="w3-codespan">&lt;col&gt;</code> element inside the
<code class="w3-codespan">&lt;colgroup&gt;</code>:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;table&gt;<br>&nbsp; &lt;colgroup&gt;<br>&nbsp;&nbsp;&nbsp; &lt;col span=&quot;2&quot; 
  style=&quot;background-color: #D6EEEE&quot;&gt;<br>&nbsp; &nbsp; &lt;col span=&quot;3&quot; 
  style=&quot;background-color: pink&quot;&gt;<br>&nbsp; &lt;/colgroup&gt;<br>&nbsp; &lt;tr&gt;<br>&nbsp;&nbsp;&nbsp; &lt;th&gt;MON&lt;/th&gt;<br>&nbsp;&nbsp;&nbsp; &lt;th&gt;TUE&lt;/th&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;th&gt;WED&lt;/th&gt;<br>&nbsp;&nbsp;&nbsp; &lt;th&gt;THU&lt;/th&gt;<br>... </div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_table_colgroup2" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>
If you want 
to style columns in the middle of a table, insert an &quot;empty&quot; 
<code class="w3-codespan">&lt;col&gt;</code> element (with no 
...
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;table&gt;<br>&nbsp; &lt;colgroup&gt;<br>&nbsp;&nbsp;&nbsp; &lt;col span=&quot;3&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;col 
  span=&quot;2&quot; 
  style=&quot;background-color: pink&quot;&gt;<br>&nbsp; &lt;/colgroup&gt;<br>&nbsp; &lt;tr&gt;<br>&nbsp;&nbsp;&nbsp; &lt;th&gt;MON&lt;/th&gt;<br>&nbsp;&nbsp;&nbsp; &lt;th&gt;TUE&lt;/th&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;th&gt;WED&lt;/th&gt;<br>&nbsp;&nbsp;&nbsp; &lt;th&gt;THU&lt;/th&gt;<br>... </div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_table_colgroup3" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<p>You can hide columns with the <code class="w3-codespan">visibility: collapse</code> property:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;table&gt;<br>&nbsp; &lt;colgroup&gt;<br>&nbsp;&nbsp;&nbsp; &lt;col span=&quot;2&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;col span=&quot;3&quot; 
  style=&quot;visibility: collapse&quot;&gt;<br>&nbsp; &lt;/colgroup&gt;<br>
  &nbsp; &lt;tr&gt;<br>&nbsp;&nbsp;&nbsp; &lt;th&gt;MON&lt;/th&gt;<br>&nbsp;&nbsp;&nbsp; &lt;th&gt;TUE&lt;/th&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;th&gt;WED&lt;/th&gt;<br>&nbsp;&nbsp;&nbsp; &lt;th&gt;THU&lt;/th&gt;<br>... </div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_table_colgroup4" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
