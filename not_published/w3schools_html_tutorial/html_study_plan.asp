...
<html lang="en-US">
<head>
<title>HTML Study Plan (Lesson Plan)</title>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">Study Plan</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="html_syllabus.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="html_interview_prep.asp">Next &#10095;</a>
</div>
<hr>

<h2>Introduction</h2>
<p>The HTML study plan helps you teach your students HTML step-by-step.</p>
<p>Creating a study plan for HTML is easy.</p>
...
<p>Save time with pre-built teacher materials and study plans. Easily organize your class with a timeline from the introduction of HTML to the final exam.</p>
<hr>
...
<p>W3Schools has everything you need to teach HTML.</p>

<p>The HTML training materials is available for you to include and use in your study plan:</p>
<ul>
  <li><a href="default.asp" target="_blank">W3Schools HTML Tutorial</a></li>
  <li><a href="HTML_exercises.asp" target="_blank">HTML Exercises</a></li>
  <li><a href="HTML_quiz.asp" target="_blank">HTML Quiz</a></li>
  <li>HTML Challenges (Coding challenges)</li>
  <li><a href="HTML_exam.asp" target="_blank">HTML Certification Exam (End of Pathway Exam)</a></li>
</ul>
<hr>

<h2>HTML Syllabus</h2>
<p>With the HTML Syllabus, your students will start with the basics, like creating simple web pages, and move to more advanced topics, like adding images, links, and forms. Each chapter has examples, try-its, exercises, and quizzes to make learning easy, interactive and fun.</p>
<p><a title="W3Schools HTML Syllabus" href="HTML_syllabus.asp" target="_blank">Read more about HTML Syllabus</a>.</p>
<hr>
...
<ol>
  ...
  <li style="margin-top:16px">
    ...
    <ul>
      <li>The HTML study plan aligns with the HTML Certification Exam.</li>
      <li>The exam can be taken at the end of the study plan, at your selected date.</li>
      <li>The exam summarizes the HTML Tutorial.</li>
...
<p>For example, this is how a 4-week HTML study plan could look like:</p>
<ul>
  <li>Week 1: Introduction and Basics, Formatting and Style, Colors, Links</li>
  <li>Week 2: Images, Tables, Lists</li>
  <li>Week 3: More HTML Elements, Logic, Forms</li>
  <li>Week 4: Graphics, Media, APIs, HTML Certification Exam</li>
</ul>

<p>Image of Sample HTML study plan:</p>
<a href="html_study_plan.png" target="_blank" title="HTML Study Plan"><img src="HTML_study_plan.png" style="height:auto;max-width:100%;"></a>
<hr>

<h2>Ready to get started?</h2>
<p>Start with <strong> HTML Study Plans</strong> today.</p>
...
<p>Are you interested in learning how you can use <a href="/academy/index.php" target="_blank">W3Schools Academy</a> to Teach HTML programming? </p>
