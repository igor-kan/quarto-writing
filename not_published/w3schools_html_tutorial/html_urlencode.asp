...
<hr>
<p class="intro">A URL is another word for a web address.</p>
<p class="intro">A URL can be composed of words (e.g. w3schools.com), or an Internet Protocol (IP) address (e.g. 192.68.20.50).</p>
...
<p>A Uniform Resource Locator (URL) is used to address a document (or other data) on the web.</p>
<p>A web address like <a target="_blank" href="https://www.w3schools.com/html/default.asp">
https://www.w3schools.com/html/default.asp</a> follows these syntax rules:</p>
...
<p>If you click "Submit", the browser will URL encode the input before it is sent to the server.</p>
<p>A page at the server will display the received input.</p>
<p>Try some other input and click Submit again.</p>
<!--stop-->
<hr>
<!--start-->
<h2>ASCII Encoding Examples</h2>
...
<p>For a complete reference of all URL encodings, visit our
