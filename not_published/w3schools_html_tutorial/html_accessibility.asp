...
.w3-row-padding .w3-half:nth-child(1) .w3-example{
  margin-right:0;
}
.w3-row-padding .w3-half:nth-child(2) .w3-example{
  margin-left:0;
}
...
<p>Always write HTML code with accessibility in mind!</p>
<p>Provide the user a good way to navigate and interact with your site. Make your HTML code 
as <strong>semantic</strong> as possible.</p>
<hr>
<h2>Semantic HTML</h2>
...
<code class="w3-codespan">&lt;div&gt;</code> element).</p>
...
<div class="w3-code notranslate htmlHigh">
  &lt;button&gt;Report an Error&lt;/button&gt;</div>
...
<p>Semantic HTML gives context to screen readers, which read the contents of a page out loud.</p> 
...
<a target="_blank" href="tryit.asp?filename=tryhtml_accessibility_headings" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p style="margin-top: 19px">Screen readers also use headings as a navigational 
tool. The different types of heading specify the outline of the page.
<code class="w3-codespan">&lt;h1&gt;</code> headings should be used for main headings, followed by <code class="w3-codespan">&lt;h2&gt;</code> headings, then the less important 
...
some reason cannot view it (because of slow connection, an error in the <code class="w3-codespan">
src</code> 
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_accessibility_images_alt" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_accessibility_images_wrongname" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Declare the Language</h2>
<p>You should always include the <code class="w3-codespan">lang</code> 
attribute inside the <code class="w3-codespan">&lt;html&gt;</code> tag, to declare the 
...
<p>Always use a clear language, that is easy to understand. Also try to avoid characters that 
...
<style>
.x a:focus,.x a:active.x a:visited {
  background-color: white !important;
}

</style>
<h2>Create Good Link Text</h2>
<p>A link text should explain clearly what information the reader will get by clicking on that link.</p>
...
<div class="w3-example">
<h3>Good</h3>
<div class="w3-code notranslate x" style="font-family: Verdana;font-size:15px">
...
<div class="w3-example">
<h3>Bad</h3>
<div class="w3-code notranslate x" style="border-color:red;font-family: Verdana;font-size:15px">
...
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> This page is an introduction in web accessibility. Visit our <a href="https://www.w3schools.com/accessibility/" alt="Accessibility Tutorial">Accessibility Tutorial</a> for more details.
</div>
