...
<a class="w3-left w3-btn" href="html_challenges_attributes.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="html_exercise_embed.asp?topic=headings">Next &#10095;</a>
</div>
<hr>
...
<p>For example:</p>
<ul>
  <li><code class="w3-codespan">&lt;h1&gt;</code> - Page title</li>
  <li><code class="w3-codespan">&lt;h2&gt;</code> - Section titles</li>
  <li><code class="w3-codespan">&lt;h3&gt;</code> - Sub-sections</li>
</ul>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;h1&gt;Travel Guide&lt;/h1&gt;<br><br>
&lt;h2&gt;Europe&lt;/h2&gt;<br>
&lt;h3&gt;France&lt;/h3&gt;<br>
&lt;h3&gt;Italy&lt;/h3&gt;<br><br>
&lt;h2&gt;Asia&lt;/h2&gt;<br>
...
<a target="_blank" href="tryit.asp?filename=tryhtml_headings_structure" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
<p><strong>Tip:</strong> Use only one <code class="w3-codespan">&lt;h1&gt;</code> per page - it represents the main topic or title.</p>
...
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  ...
  <a href="https://youtu.be/9gHPpwq6IaY&list=PLP9IO4UYNF0VdAajP_5pYG-jG2JRrG72s" class="ga-featured ga-youtube" target="blank_" >
    <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
      ...
      <picture id="yt_div" style="max-width:100%;height:auto;border-radius:6px">
        <source srcset="images/05_html_headings.webp" type="image/webp" />
        <img src="images/05_html_headings.png" style="max-width:100%;height:auto;border-radius:6px" alt="Tutorial on YouTube" loading="lazy">
      </picture>
    </div>
  </a>
</div>
