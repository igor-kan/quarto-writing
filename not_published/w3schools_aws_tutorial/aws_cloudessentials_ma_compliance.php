...
<a class="w3-left w3-btn" href="aws_cloudessentials_ma_cloudtrail.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_ma_auditing.php">Next &#10095;</a>
</div>
<hr>

<h2>What is Compliance?</h2>
<p>Compliance ensures your cloud resources and data adhere to regulations, industry standards, and internal policies. AWS helps by inheriting security controls, providing third-party validation, and offering on-demand compliance reports.</p>
<hr>

<h2>AWS Compliance Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M10_L04_20_Compliance_v01.mp4" type="video/mp4">
...
<h2>AWS Artifact</h2>
<p>AWS Artifact provides no-cost, on-demand access to AWS security and compliance reports and online agreements. Use it to manage agreements at scale, access compliance reports quickly, and assess third-party security.</p>

<h3>Agreements</h3>
<p>Review, accept, and manage agreements for individual accounts or all accounts in AWS Organizations. Different agreement types address specific regulations like HIPAA.</p>

<h3>Reports</h3>
<p>Access compliance reports from third-party auditors who have verified AWS compliance with global, regional, and industry-specific standards. Provide these artifacts to your auditors as evidence of AWS security controls.</p>
<hr>

<h2>Learn More</h2>
<ul>
  <li><a href="https://aws.amazon.com/compliance/programs/" target="_blank">AWS Compliance Programs</a> - Overview of compliance certifications and attestations</li>
  <li><a href="https://aws.amazon.com/compliance/resources/" target="_blank">Compliance Resources</a> - Whitepapers, guides, and best practices</li>
</ul>
<hr>

<div>
  <h2>AWS Cloud Exercises</h2>
  <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_sec_securityintroduction5" method="post" target="_blank">
    <h2>Test Yourself With Exercises</h2>
    <div class="exercisewindow">
      <h2>Exercise:</h2>
      <p>What is the name of AWS Artifacts two sub services?</p>
      <div class="exerciseprecontainer">
        <pre style="overflow: auto;">1. AWS Artifact <input name="ex1" maxlength="10" style="width: 120px;"></pre>
        <pre style="overflow: auto;">2. AWS Artifact <input name="ex2" maxlength="7" style="width: 90px;"></pre>
      </div>
      <br>
      <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
      <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_sec_securityintroduction5">Start the Exercise</a></p>
    </div>
  </form>
</div>
