...
<head>
  <title>Amazon SQS - Simple Queue Service</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Amazon SQS - Simple Queue Service</h1>


<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_awssns.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_awsmessagingcomparison.php">Next &#10095;</a>
</div>
<hr>

<h2>What is Amazon SQS?</h2>
<p>Amazon Simple Queue Service (SQS) is a message queuing service for communicating between software components. It sends, stores, and receives messages at any scale, ensuring messages aren't lost even when services are temporarily unavailable.</p>

<h3>How It Works</h3>
<p>An application places messages into a queue. A user or service retrieves the message, processes it, and removes it from the queue. Subscribers can be web apps, servers, Lambda functions, and more.</p>
<hr>

<h2>Amazon SQS Introduction Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/aws-sqs-introduction.mp4" type="video/mp4">
...
<div>
    ...
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_awssqs1" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>What kind of system is AWS SQS?</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">AWS SQS is a <input name="ex1" maxlength="7" style="width: 100px;"> service</pre>
        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_awssqs1">Start the Exercise</a></p>
      </div>
    </form>
  </div>
