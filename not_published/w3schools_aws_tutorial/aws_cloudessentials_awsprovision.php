...
<head>
  <title>AWS Cloud Resource Provisioning</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>AWS Cloud Resource Provisioning</h1>


<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_awsedgelocations.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_awsprovisionservices.php">Next &#10095;</a>
</div>
<hr>

<h2>Provisioning AWS Resources</h2>
<p>Provisioning means setting up and configuring the AWS services your application needs. There are three main ways to interact with AWS: the Management Console, the Command Line Interface (CLI), and Software Development Kits (SDKs).</p>
<hr>

<h2>Provisioning Video (Part 1)</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M02_L03_15_HowToProvisionAWSResources_v02_Final.mp4" type="video/mp4">
...
<h2>Ways to Interact with AWS</h2>

<h3>AWS Management Console</h3>
<p>A web-based interface for accessing and managing AWS services. It provides a visual way to configure resources and monitor your applications.</p>
<p>A mobile app is also available, best used for monitoring and accessing billing information.</p>

<h3>AWS Command Line Interface (CLI)</h3>
<p>A tool that lets you control multiple AWS services from the command line. CLI saves time when making API requests and allows you to automate actions with scripts.</p>
<p>Available on Windows, macOS, and Linux.</p>

<h3>Software Development Kits (SDKs)</h3>
<p>SDKs let you access AWS services through APIs designed for your programming language. They simplify integrating AWS into existing applications or building new ones.</p>
<p>AWS SDKs support languages including C++, Java, .NET, Python, and more.</p>
<hr>

<div>
    <h2>AWS Cloud Exercises</h2>
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_awsinfrastructure6" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>What are the three main ways to interact with AWS services?</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">1. AWS <input name="ex1" maxlength="10" style="width: 130px;"> Console</pre>
          <pre style="overflow: auto;">2. AWS Command <input name="ex2" maxlength="4" style="width: 90px;"> Interface</pre>
          <pre style="overflow: auto;">3. <input name="ex3" maxlength="8" style="width: 110px;"> Development <input name="ex4" maxlength="4" style="width: 60px;"></pre>
        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_awsinfrastructure6">Start the Exercise</a></p>
      </div>
    </form>
  </div>
