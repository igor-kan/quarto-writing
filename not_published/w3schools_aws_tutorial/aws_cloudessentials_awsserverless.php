...
<head>
  <title>AWS Cloud Serverless</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>AWS Cloud Serverless</h1>


<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_awsmessagingcomparison.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_awslambda.php">Next &#10095;</a>
</div>
<hr>

<h2>What is Serverless Computing?</h2>
<p>With serverless computing, you run applications without managing infrastructure. You focus on code while AWS handles servers, scaling, and maintenance.</p>
<hr>

<h2>AWS Compute Options Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M03_L01_05_Module3Introduction_v01_FINAL.mp4" type="video/mp4">
...
<h2>EC2 vs Serverless</h2>
<p>AWS offers different levels of control:</p>
<ul>
  <li><strong>EC2:</strong> You manage the server, install software, and handle updates</li>
  <li><strong>Serverless:</strong> You only write code, while AWS handles everything else</li>
</ul>

<img src="images/differenceec2serverless.png" alt="computing with virtual servers and serverless computing compared" style="width:500px;max-width:100%;">
<p class="w3-small">Image created by Amazon Web Services</p>
<hr>

<div>
    <h2>AWS Cloud Exercises</h2>
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_awsserverless1" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>AWS handles the infrastructure behind serverless. What is important to know?</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">I do not have to think about <input name="ex1" maxlength="7" style="width: 90px;"></pre>
          <pre style="overflow: auto;">I only have to think about <input name="ex2" maxlength="4" style="width: 60px;"></pre>

        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_awsserverless1">Start the Exercise</a></p>
      </div>
    </form>
  </div>
<hr>
