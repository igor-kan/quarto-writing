...
<a class="w3-left w3-btn" href="aws_cloudessentials_comparingamazonrdsandamazondynamodb.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_awsdms.php">Next &#10095;</a>
</div>
<hr>

<h2>What is Amazon Redshift?</h2>
<p>Amazon Redshift is a fully managed data warehouse service for big data analytics. It can analyze petabytes of data from multiple sources using SQL queries, ideal when data becomes too large for traditional databases.</p>
<p>Common use cases are: business intelligence, reporting dashboards, log analysis, and data lake analytics</p>
<hr>

<h2>Amazon Redshift Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/aws-cloud-practitioner-5-redshift.mp4" type="video/mp4">
...
<h2>How Redshift Works</h2>
<p>Redshift uses SQL, AWS-designed hardware, and <a href="https://www.w3schools.com/ai/ai_machine_learning.asp" target="_blank">machine learning</a> to deliver fast query performance on massive datasets.</p>
<img src="images/amazon-redshift.jpg" style="width:800px;max-width:100%;" loading="lazy" alt="How Amazon Redshift works">
<p class="w3-small">Image reference: <a href="https://aws.amazon.com/redshift/" target="_blank">aws.amazon.com/redshift</a></p>
<hr>

<div>
    <h2>AWS Cloud Exercises</h2>
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_amazonrds7" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>What kind of service is Amazon Redshift?</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">Amazon Redshift is a data <input name="ex1" maxlength="9" style="width: 110px;"> service</pre>
        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_amazonrds7">Start the Exercise</a></p>
      </div>
    </form>
  </div>
