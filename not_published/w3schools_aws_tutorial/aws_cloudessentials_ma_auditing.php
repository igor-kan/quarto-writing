...
<head>
  <title>Auditing AWS Resources</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Auditing AWS Resources</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_ma_compliance.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_ma_organizations.php">Next &#10095;</a>
</div>
<hr>

<h2>What is Auditing?</h2>
<p>Most companies require specific configuration guidelines for AWS resources. Auditing helps you assess and verify that your resources meet those rules and comply with security standards.</p>
<hr>

<h2>Auditing AWS Resources Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M10_L05_25_AuditingAWSResourcesForCompliance_v01_FINAL.mp4" type="video/mp4">
...
<h3>AWS Config</h3>
<p>Assess, audit, and evaluate the configurations of your AWS resources. Config tracks configuration changes and evaluates them against your desired state.</p>
<ul>
  <li>Evaluate configurations against a desired state</li>
  <li>Manage resource configuration changes</li>
  <li>Simplify troubleshooting and remediation</li>
  <li>Continually audit security monitoring and analysis</li>
</ul>

<h3>AWS Audit Manager</h3>
<p>Continually audits your AWS usage to simplify risk and compliance assessment. Helps collect evidence and manage audit data automatically.</p>
<ul>
  <li>Save time with automated evidence collection</li>
  <li>Streamline collaboration across teams</li>
  <li>Ensure audit integrity with read-only permissions</li>
  <li>Deploy internal risk assessments</li>
</ul>
