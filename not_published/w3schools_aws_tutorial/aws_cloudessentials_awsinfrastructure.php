...
<head>
  <title>AWS Cloud Infrastructure</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>AWS Cloud Infrastructure</h1>


<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_additionalcompute.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_awsregions.php">Next &#10095;</a>
</div>
<hr>

<h2>Introduction to AWS Global Infrastructure</h2>
<p>AWS operates data centers in multiple geographic locations worldwide. This lets you deploy applications close to your users for lower latency, or in specific regions for compliance requirements.</p>
<p>If one data center fails, others carry the workload, keeping your applications available.</p>
<hr>

<h2>AWS Global Infrastructure Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M04_L01_05_IntroductionToGoingGlobal_v02_FINAL.mp4" type="video/mp4">
...
<h2>Key Benefits of the Global Infrastructure</h2>

<h3>High Availability</h3>
<p>Your applications remain accessible even if one location fails.</p>

<h3>Agility</h3>
<p>Quickly adapt to changing requirements and deploy services rapidly.</p>

<h3>Elasticity</h3>
<p>Scale resources up or down automatically based on demand.</p>
<hr>

<h2>Infrastructure as Code</h2>
<p>AWS CloudFormation lets you automate deployment of cloud resources. Infrastructure as code (IaC) ensures consistent, reliable setup as your business grows.</p>
<hr>

<p>The following chapters cover AWS Global Infrastructure in detail.</p>
