...
<head>
  <title>AWS Data Protection</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>AWS Data Protection</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_sec_denialofserviceattacks.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_sec_detectionandresponse.php">Next &#10095;</a>
</div>
<hr>

<h2>Data Protection on AWS</h2>
<p>Encryption protects data by making it unreadable without a key. AWS provides encryption for data at rest (stored in databases, S3) and in transit (moving between locations using SSL/TLS).</p>
<hr>

<h2>Data Protection Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M09_L04_25_DataProtection_v02_FINAL.mp4" type="video/mp4">
...
<table class="ws-table-all">
  ...
  <tr>
    ...
    <td>Create and manage encryption keys. Control who can use them. Keys never leave AWS.</td>
  </tr>
  <tr>
    <td><strong>Amazon Macie</strong></td>
    <td>Uses ML to find sensitive data in S3. Helps meet compliance requirements.</td>
  </tr>
  <tr>
    <td><strong>AWS Certificate Manager</strong></td>
    <td>Manage SSL/TLS certificates for encrypting data in transit.</td>
  </tr>
</table>
<hr>
