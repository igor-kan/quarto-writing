...
<a class="w3-left w3-btn" href="aws_cloudessentials_databases.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_amazondynamodb.php">Next &#10095;</a>
</div>
<hr>

<h2>What is Amazon RDS?</h2>
<p>Amazon RDS (Relational Database Service) is a managed service for relational databases that use <a href="https://www.w3schools.com/sql/" target="_blank">SQL</a>. RDS handles backups, patching, and hardware provisioning automatically.</p>
<p>Supported database engines: Amazon Aurora, PostgreSQL, MySQL, MariaDB, Oracle, SQL Server</p>
<p>Common use cases are: web applications, enterprise workloads, e-commerce platforms</p>
<hr>

<h2>Amazon RDS Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M07_L02_10_AmazonRelationalDatabaseService_v02.mp4" type="video/mp4">
...
<h2>RDS Benefits</h2>
<ul>
  <li><strong>Multi-AZ deployment:</strong> Replicates data to a standby instance for high availability</li>
  <li><strong>Automated backups:</strong> Plus manual snapshots when needed</li>
  <li><strong>Read replicas:</strong> Offload traffic for better performance</li>
  <li><strong>Security:</strong> VPC isolation, encryption at rest and in transit</li>
</ul>
<hr>

<h2>Relational Database Example</h2>
<table class="ws-table-all w3-border w3-bordered w3-hoverable">
  <tr>
    <th>ID</th>
    <th>Product name</th>
    <th>Price</th>
...
<h2>Amazon Aurora</h2>
<p>Aurora is a high-performance database compatible with MySQL and PostgreSQL, delivering up to <strong>5x MySQL throughput</strong> and <strong>3x PostgreSQL throughput</strong>.</p>
<p>It creates six copies of data across three AZs, provides 99.99% availability, and automatically scales storage from 10 GB to 128 TB.</p>

<h3>Aurora Benefits</h3>
<ul>
  <li><strong>Distributed storage:</strong> Across multiple nodes for high performance</li>
  <li><strong>Continuous backup:</strong> To S3 with point-in-time recovery</li>
  <li><strong>Auto-failover:</strong> Redirects traffic to healthy replicas</li>
</ul>
<p><strong>Use cases:</strong> Gaming, media/content management, real-time analytics</p>
<hr>

<div>
    <h2>AWS Cloud Exercises</h2>
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_amazonrds1" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>What does Amazon RDS stand for?</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">AWS <input name="ex1" maxlength="10" style="width: 125px;"> Database Service</pre>
        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_amazonrds1">Start the Exercise</a></p>
      </div>
    </form>
  </div>
