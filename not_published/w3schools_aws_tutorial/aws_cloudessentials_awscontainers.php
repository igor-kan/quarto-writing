...
<a class="w3-left w3-btn" href="aws_cloudessentials_awslambda.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_awsecs.php">Next &#10095;</a>
</div>
<hr>

<h2>What are Containers?</h2>
<p>A container packages your application with everything it needs to run. Multiple containers can share the same server's operating system while keeping their applications and libraries isolated.</p>
<hr>

<h2>AWS Containers Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M03_L03_20_Containers_v02_FINAL.mp4" type="video/mp4">
...
<h3>Architecture</h3>
<img src="images/containers-architecture.png" alt="container architecture diagram" style="width:500px;max-width:100%;">
<p class="w3-small">Image created by Amazon Web Services</p>
<p>Multiple containers run on the same server, each with its own application, sharing the OS through a containerization platform.</p>

<h3>Deployment Consistency</h3>
<p>Containers keep the application environment identical everywhere, making deployments smoother and debugging easier.</p>
<hr>
<style>
.certtext {
  width:100%;
...
<h3>Scaling with Orchestration</h3>
<p>As applications grow from one host to hundreds of containers, orchestration tools automate deployment, scaling, and management.</p>
<img src="images/containers-scaling.png" alt="scaling from one host to many hosts with containers" style="width:700px;max-width:100%;">
<p class="w3-small">Image created by Amazon Web Services</p>
<hr>

<h2>AWS Container Services</h2>
<ul>
  <li><strong>Orchestration:</strong> <a href="aws_cloudessentials_awsecs.php">Amazon ECS</a> and <a href="aws_cloudessentials_awseks.php">Amazon EKS</a> - deploy, scale, and manage containers</li>
  <li><strong>Registry:</strong> Amazon ECR - store and version container images</li>
  <li><strong>Compute:</strong> <a href="aws_cloudessentials_awsfargate.php">AWS Fargate</a> - run containers without managing servers</li>
</ul>
<hr>

<div>
    <h2>AWS Cloud Exercises</h2>
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_awscontainers1" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>What does containers do?</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">Containers let you package code in a single <input name="ex1" maxlength="6" style="width: 80px;"></pre>
        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_awscontainers1">Start the Exercise</a></p>
      </div>
    </form>
  </div>
