...
ny:-->
    ...
    <h1>AWS Cloud Regions</h1>


<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_awsinfrastructure.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_awsavailabilityzones.php">Next &#10095;</a>
</div>
<hr>

<h2>What is an AWS Region?</h2>
<p>A Region is a geographic area containing AWS data centers. AWS has Regions across the globe, letting you choose where to run your applications and store your data.</p>
<hr>

<h2>AWS Regions Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M04_L02_10_HowToChooseARegion_v01_FINAL.mp4" type="video/mp4">
...
<p>Consider these factors when choosing a Region:</p>

<h3>Compliance</h3>
<p>Some regulations require data to stay within specific countries. For example, GDPR requires companies operating in the EU to choose Regions that meet its data protection requirements.</p>

<h3>Customer Proximity</h3>
<p>Selecting a Region near your customers reduces latency and improves their experience. For example, a Seattle-based company with Norwegian customers might run infrastructure locally but deploy customer-facing applications in a European Region.</p>

<h3>Feature Availability</h3>
<p>Not all Regions support all services. AWS constantly expands, but some features may only be available in specific Regions. For example, AWS GovCloud is only available in Regions designed for US government requirements.</p>

<h3>Pricing</h3>
<p>Costs vary by Region based on operational expenses, taxes, and local requirements. You will learn more about pricing in a later chapter.</p>
<hr>
<style>
.certtext {
  width:100%;
...
<div>
    ...
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_awsinfrastructure1" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>Where do AWS have their infrastructure?</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">AWS has a <input name="ex1" maxlength="6" style="width: 90px;"> infrastructure</pre>
        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_awsinfrastructure1">Start the Exercise</a></p>
      </div>
    </form>
  </div>
