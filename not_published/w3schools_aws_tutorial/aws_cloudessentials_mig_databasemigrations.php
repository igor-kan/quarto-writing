...
<a class="w3-left w3-btn" href="aws_cloudessentials_mig_migrationservices.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_mig_datatransferonline.php">Next &#10095;</a>
</div>
<hr>

<h2>Migrating Databases</h2>
<p>Migrating your database to the cloud provides an opportunity to redesign and improve your database architecture. You might also consider migrating to an AWS managed database service or an open source database to reduce licensing costs.</p>
<hr>

<h2>Database Migrations Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M12_L06_30_MigratingDatabases_to_AWS_v02_FINAL0.mp4" type="video/mp4">
...
<h2>Same Engine vs Different Engine</h2>
<p>Migrating to the <strong>same database engine</strong> (e.g., MySQL to Amazon RDS for MySQL) is straightforward.</p>
<p>Migrating to a <strong>different engine</strong> (e.g., Oracle to Amazon Aurora PostgreSQL) is more complex and may require application changes.</p>
<p>AWS calls these <em>homogeneous</em> (same engine) and <em>heterogeneous</em> (different engine) migrations.</p>
<p>AWS provides services to help with both types.</p>
<hr>

<h2>AWS Database Migration Service (AWS DMS)</h2>
<p>AWS DMS makes it possible to quickly and securely migrate databases and perform ongoing data replication tasks for live databases and data warehouses.</p>
<p>It provides a way to plan, assess, convert, and migrate databases even with data warehouses in one central tool.</p>

<h3>Benefits</h3>
<ul>
  <li>Maintain high availability and low downtime during the migration process</li>
  <li>Supports migrations to same or different database engines</li>
  <li>Migrate terabyte sized databases at a low cost</li>
</ul>

<h3>Use Cases</h3>
<ul>
  <li>Move to managed databases</li>
  <li>Remove licensing costs</li>
  <li>Replicate ongoing changes in your database</li>
  <li>Improve integration with data lakes</li>
</ul>
<hr>

<h2>AWS Schema Conversion Tool (AWS SCT)</h2>
<p>When migrating to a different database engine (heterogeneous migration), you need to recreate database schemas in the target. A schema defines the structure and organization of data, including table structures, field types, and relationships.</p>
<p>AWS SCT converts database schemas and code objects (like stored procedures, views, and functions) from one database engine to another. It can also estimate the effort required for a conversion, which helps with planning.</p>

<h3>Benefits</h3>
<ul>
  <li>Simplify database migrations by automating schema analysis, recommendations, and conversion at scale</li>
  <li>Compatible with popular databases and analytics services as source and target engines</li>
  <li>Save weeks or months of manual time and resources</li>
</ul>

<h3>Use Cases</h3>
<ul>
  <li>Move from commercial databases to open source databases</li>
  <li>Migrating large data warehouse workloads</li>
  <li>Modernize or update database schemas in place</li>
</ul>
