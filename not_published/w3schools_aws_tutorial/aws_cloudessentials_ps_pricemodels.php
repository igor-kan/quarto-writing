...
<head>
  <title>AWS Pricing Concepts</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>AWS Pricing Concepts</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_ps_freetier.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_ps_billingservices.php">Next &#10095;</a>
</div>
<hr>

<h2>AWS Pricing Overview</h2>
<p>AWS offers customers a pay-as-you-go approach for pricing for the vast majority of cloud services.</p>
<p>With AWS, customers pay only for the individual services they need, for as long as they use them, and without requiring long-term contracts or complex licensing.</p>
<hr>

<h2>AWS Pricing Concepts Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M11_L02_15_AWSPricingConcepts_v01_FINAL0.mp4" type="video/mp4">
...
<h2>Pay As You Go</h2>
<p>With pay as you go, you can adapt to changing business needs and reduce the risk of overprovisioning or missing capacity.</p>
<p>Pay only for the resources that you use.</p>
<hr>

<h2>Save When You Commit</h2>
<p>For certain services, such as Compute services on AWS, Savings Plans offer savings over On-Demand prices when you commit to a 1-year or 3-year plan.</p>
<hr>

<h2>Pay Less By Using More</h2>
<p>With AWS, you can realize important savings as your usage increases.</p>
<p>For some services, pricing is tiered, meaning the more you use, the less you pay.</p>
<hr>

<h2>Driving Factors of Cost</h2>
<p>There are three fundamental drivers of cost with AWS:</p>

<h3>Compute</h3>
<p>For compute resources, you pay by a certain span of time, like by the hour or by the second.</p>
<p>Unless you've made a reservation for which the cost is agreed upon beforehand, you pay from the time you launch a resource until the time you stop the instance.</p>

<h3>Storage</h3>
<p>Pricing for storage largely depends on how much storage you have provisioned or how much you are using.</p>
<p>For some storage options, such as Amazon S3, storage cost is tiered. This means you can optimize storage costs based on how frequently and quickly you need to access data.</p>

<h3>Data Transfer</h3>
<p>In most cases, there is no charge for inbound data transfer or for data transfer between AWS services within the same Region.</p>
<p>Outbound data transfer is aggregated across services and then charged at the outbound data transfer rate.</p>
<p>The more data you transfer, the less you pay per gigabyte.</p>
<hr>
...
<hr>
<p>Pricing examples:</p>
<ul>
  <li><a href="https://aws.amazon.com/lambda/pricing/" target="blank">AWS Lambda Pricing</a></li>
  <li><a href="https://aws.amazon.com/ec2/pricing/" target="_blank">AWS EC2 Pricing</a></li>
  <li><a href="https://aws.amazon.com/s3/pricing/" target="_blank">AWS S3 Pricing</a></li>
</ul>
<hr>

<div>
    <h2>AWS Cloud Exercises</h2>
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_ps_intro2" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>Name the tool that lets you create cost estimates on AWS</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">The name of the tool is AWS <input name="ex1" maxlength="7" style="width: 90px;"> <input name="ex1" maxlength="10" style="width: 125px;"></pre>
        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_ps_intro2">Start the Exercise</a></p>
      </div>
    </form>
  </div>
