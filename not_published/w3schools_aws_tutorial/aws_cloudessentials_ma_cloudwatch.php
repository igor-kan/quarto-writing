...
<a class="w3-left w3-btn" href="aws_cloudessentials_ma_monitoring.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_ma_cloudtrail.php">Next &#10095;</a>
</div>
<hr>

<h2>Amazon CloudWatch</h2>
<p>CloudWatch monitors your AWS resources and applications in real time, providing visibility into resource utilization, application performance, and operational health.</p>
<hr>

<h2>Amazon CloudWatch Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M10_L02_10_AmazonCloudWatch_v01_FINAL.mp4" type="video/mp4">
...
<h2>CloudWatch Features</h2>

<h3>Metrics</h3>
<p>Collects metrics from AWS resources, applications, and on-premises servers. <a href="https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/working_with_metrics.html" target="_blank" rel="noopener noreferrer">Learn more</a></p>

<h3>Alarms</h3>
<p>Define thresholds to trigger notifications or automatic actions. Example: stop idle services when utilization drops below a threshold. <a href="https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/AlarmThatSendsEmail.html" target="_blank" rel="noopener noreferrer">Learn more</a></p>

<h3>Dashboards</h3>
<p>Customizable views to monitor multiple resources at once.</p>
<img src="images/cloudwatchdashboard.png" style="width:800px;max-width:100%;" loading="lazy" alt="CloudWatch dashboard">
<p class="w3-small">Image created by Amazon Web Services</p>

<h3>Logs</h3>
<p>Centralize logs from all systems, applications, and AWS services.</p>
<hr>
...
<div>
    ...
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_ma_intro1" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>Fill in the blank</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">CloudWatch alarms are used to <input name="ex1" maxlength="7" style="width: 90px;"> resources</pre>
        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_ma_intro1">Start the Exercise</a></p>
      </div>
    </form>
  </div>
