...
<head>
  <title>AWS Cloud Exercises</title>
  <meta charset="utf-8">
...
ny:-->
    ...
    <h1>AWS Cloud Exercises</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="aws_exam.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_quiz.php">Next &#10095;</a>
</div>
<hr>
<p class="intro">You can test your AWS Cloud skills with W3Schools' Exercises.</p>
<hr><h2>Exercises</h2>
<p>We have gathered a variety of AWS Cloud exercises (with answers) for each AWS Cloud Chapter.</p>
...
<div class="ws-black w3-padding w3-margin-top w3-round">
  <h2>Start AWS Cloud Exercises</h2>
  <p>Good luck!</p>
  <p><a href="exercise.php?filename=exercise_cloudessentials_cloudcomputing1" target="_blank" class="ws-btn" style="margin-top:10px;padding:15px 25px;font-size:18px">Start AWS Cloud Exercises &#10095;</a></p>
</div>
<div class="ws-note w3-panel">
  <p>If you don't know AWS Cloud, we suggest that you read our <a href="index.php">AWS Cloud Tutorial</a> from scratch.</p>
</div>
<hr>
