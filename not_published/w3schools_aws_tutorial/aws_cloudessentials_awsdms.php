...
<head>
  <title>AWS DMS - Database Migration Service</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>AWS DMS - Database Migration Service</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_amazonredshift.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_additionaldatabaseservices.php">Next &#10095;</a>
</div>
<hr>

<h2>What is AWS DMS?</h2>
<p>AWS Database Migration Service moves data from a source database to a target database. Your source database remains operational during migration, minimizing downtime.</p>
<p>DMS supports a wide range of databases and is simple to use.</p>
<hr>

<h2>AWS DMS Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/aws-cloud-practitioner-5-db-migration-services.mp4" type="video/mp4">
...
<h2>Use Cases</h2>
<ul>
  <li>Test applications against production data without affecting it</li>
  <li>Combine multiple databases into one</li>
  <li>Replicate data to other sources for analytics or backup</li>
</ul>
<hr>

<div>
    <h2>AWS Cloud Exercises</h2>
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_amazonrds8" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>Fill in the blanks</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">AWS DMS is used to combine <input name="ex1" maxlength="8" style="width: 100px;"> databases into a <input name="ex2" maxlength="6" style="width: 75px;"> one</pre>
        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_amazonrds8">Start the Exercise</a></p>
      </div>
    </form>
  </div>
