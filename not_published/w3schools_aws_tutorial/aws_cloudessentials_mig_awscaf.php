...
<head>
  <title>AWS CAF - Cloud Adoption Framework</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>AWS CAF - Cloud Adoption Framework</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_mig_migrationandinnovationintroduction.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_mig_migrationstrategies.php">Next &#10095;</a>
</div>
<hr>
<h2>What is the AWS Cloud Adoption Framework (CAF)?</h2>
<p>When you migrate to the AWS Cloud, there are critical planning tasks, many groups of stakeholders, and best practices to consider. The AWS CAF is a framework that brings AWS experience and best practices to companies preparing to migrate.</p>
<p>The framework provides tools to help accelerate the migration journey, organize resources, and align management during the transition.</p>

<h3>Benefits</h3>
<ul>
  <li>Reduce business risk and improve sustainability</li>
  <li>Grow revenue by creating new products and services</li>
  <li>Reduce operational costs and increase productivity</li>
  <li>Improve customer experience</li>
</ul>

<h3>Use Cases</h3>
<ul>
  <li>Migrate technology like legacy infrastructure and applications</li>
  <li>Migrate and optimize business processes and operations</li>
  <li>Create new business models with the move to the cloud</li>
</ul>
<hr>

<h2>AWS CAF Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M12_L02_10_AWSCloudAdoptionFramework_v01_FINAL0.mp4" type="video/mp4">
...
<h2>The Six Perspectives</h2>
<p>AWS CAF has six focus areas, also called <strong>perspectives</strong>.</p>
<p>There are several groups of stakeholders and various parts of the business to consider in your migration planning and readiness.</p>
<hr>

<h2>Business Perspective</h2>
<p>The Business perspective makes sure that IT aligns with business needs and that IT investments link to key business results.</p>
<p>Use the Business perspective to create a strong business case for cloud adoption and prioritize cloud adoption initiatives.</p>
<p>Common roles to consider: Business managers, Finance managers, Budget owners, Strategy stakeholders</p>
<hr>

<h2>People Perspective</h2>
<p>The People perspective supports development of an organization-wide change management strategy for successful cloud adoption.</p>
<p>Use it to evaluate organizational structures and roles, assess new skill and process requirements, and identify gaps.</p>
<p>Common roles to consider: Human resources, Staffing, People managers</p>
<hr>

<h2>Governance Perspective</h2>
<p>The Governance perspective focuses on skills and processes to align IT strategy with business strategy.</p>
<p>Use it to understand how to update the staff skills and processes necessary to maintain business governance in the cloud.</p>
<p>Common roles to consider: CIO, Program managers, Enterprise architects, Business analysts, Portfolio managers</p>
<hr>
...
<h2>Platform Perspective</h2>
<p>The Platform perspective includes principles and patterns for implementing new solutions in the cloud and migrating on-premises workloads to the cloud.</p>
<p>Use a variety of architectural models to understand and communicate the structure of IT systems and their relationships.</p>
<p>Common roles to consider: CTO, IT managers, Solutions architects</p>
<hr>

<h2>Security Perspective</h2>
<p>The Security perspective makes sure that the organization meets security objectives for visibility, auditability, control, and agility.</p>
<p>Use AWS CAF to structure the selection and implementation of security controls that meet the organization's needs.</p>
<p>Common roles to consider: CISO, IT security managers, IT security analysts</p>
<hr>

<h2>Operations Perspective</h2>
...
<p>Define how day-to-day, quarter-to-quarter, and year-to-year business is conducted.</p>
<p>Common roles to consider: IT operations managers, IT support managers</p>
<hr>

<div>
    <h2>AWS Cloud Exercises</h2>
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_mig_migrationandinnovationintroduction1" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>Fill the blank</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">AWS CAF helps with <input name="ex1" maxlength="9" style="width: 120px;"> applications to the cloud</pre>
        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_mig_migrationandinnovationintroduction1">Start the Exercise</a></p>
      </div>
    </form>
  </div>
