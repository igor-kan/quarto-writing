...
ny:-->
    ...
    <h1>Amazon EC2 Intro</h1>


<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_infrastructure_intro.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_ec2instancetypes.php">Next &#10095;</a>
</div>
<hr>

<h2>AWS Compute Services</h2>
<p>Compute is one of AWS's core service categories. It provides the processing power to run your applications.</p>
<p>Amazon EC2 is the foundational compute service with virtual servers you can configure and control. In later sections, you'll also learn about serverless and container-based options.</p>
<hr>

<h2>Introduction to Amazon EC2 Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M02_L01_05_IntroductionToAmazonEC2_v01_FINAL.mp4" type="video/mp4">
...
<p>Amazon EC2 (Elastic Compute Cloud) provides virtual servers in the AWS Cloud. Get computing power on-demand without buying physical hardware, and scale capacity as needed.</p>
<p>EC2 uses <strong>multi-tenancy</strong> meaning multiple customers share the same physical hardware, but virtual machines remain isolated and secure. AWS manages this so you get dedicated resources without managing servers yourself.</p>
<hr>

<h2>Getting Started with EC2</h2>
<p>Working with EC2 involves three steps:</p>

<h3>1. Launch</h3>
<p>Select a template with your operating system and applications, choose an instance type (hardware configuration), and specify security settings to control network traffic.</p>

<h3>2. Connect</h3>
<p>Connect to your instance through various methods: remote desktop login, SSH, or programmatic access for applications.</p>

<h3>3. Use</h3>
<p>Run commands, install software, add storage, and manage files just like on a physical server.</p>
<hr>
<style>
.certtext {
  width:100%;
...
<a href="https://aws.amazon.com/ec2/" target="_blank">Learn more about Amazon EC2 here</a>
<hr>

<div>
    <h2>Amazon EC2 Exercises</h2>
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_ec2intro1" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>Complete the full name of Amazon EC2.</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">AWS <input name="ex1" maxlength="7" style="width: 90px;"> Cloud Compute</pre>
        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_ec2intro1">Start the Exercise</a></p>
      </div>
    </form>
  </div>
