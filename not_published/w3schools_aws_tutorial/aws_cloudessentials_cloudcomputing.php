...
<a class="w3-left w3-btn" href="aws_cloudessentials_getstarted.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_benefits.php">Next &#10095;</a>
</div>
<hr>

<h2>What is Cloud Computing?</h2>
<p>Cloud computing is the on-demand delivery of IT resources over the internet with pay-as-you-go pricing.</p>
<p>You only pay for what you use, and you can quickly access and scale resources like servers, storage, and databases as needed.</p>
<hr>

<h2>Cloud computing and the Client-Server Model</h2>
<p>Cloud computing is built on the client-server model. Your device (the client) sends requests over the internet to remote servers, which process them and return results.</p>

<img class="invert-on-dark" src="images/clientservermodel.png" alt="picture of the client-server model" style="width:500px;max-width:100%;">
<p class="w3-small">Image created by Amazon Web Services</p>
<hr>

<h2>AWS Cloud Computing Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M01_L02_10_WhatIsCloudComputing_v02_FINAL.mp4" type="video/mp4">
...
<p>There are three different kinds of deployment models:</p>
<ul>
    <li>Cloud-based</li>
    <li>On-premises</li>
    <li>Hybrid</li>
</ul>
<p>These models describe how compute resources are accessed: over the internet, locally, or using a combination of both.</p>
<h3>Cloud-Based Deployment</h3>
<p>Everything runs in the cloud. </p>
<p>You can build new applications or migrate existing ones, choosing your level of control, from managing virtual servers to using fully managed services.</p>
<p>Example: An application with virtual servers, databases, and networking components all hosted in the cloud.</p>

<h3>On-Premises Deployment</h3>
<p>Resources run in your own data center using virtualization and management tools.</p>
<p>Also known as private cloud deployment.</p>
<p>Modern virtualization helps maximize hardware utilization and simplifies resource management.</p>

<h3>Hybrid Deployment</h3>
<p>Connect cloud resources to on-premises infrastructure.</p>
<p>Useful when handling sensitive data or meeting specific regulatory requirements.</p>
<hr>
...
<!-- <p class="adtext">Advertisement</p> -->
    ...
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_cloudcomputing1" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>Insert the missing deployment model.</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">Cloud-based, on-premises, and <input name="ex1" maxlength="6" style="width: 80px;"></pre>
        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_cloudcomputing1">Start the Exercise</a></p>
      </div>
    </form>
  </div>
<hr>
