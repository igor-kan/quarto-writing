...
<head>
  <title>Amazon SNS - Simple Notification Service</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Amazon SNS - Simple Notification Service</h1>


<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_awseventbridge.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_awssqs.php">Next &#10095;</a>
</div>
<hr>

<h2>What is Amazon SNS?</h2>
<p>Amazon Simple Notification Service (SNS) is a fully managed messaging service for sending messages to multiple recipients (subscribers). It decouples distributed systems and microservices, and can send notifications to users via SMS, mobile push, or email.</p>
<hr>

<h2>Amazon SNS Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/SISNSX_11.mp4" type="video/mp4">
...
<p>SNS can publish messages to:</p>
<ul>
  <li>HTTP/HTTPS</li>
  <li>Email</li>
  <li>Amazon SQS</li>
...
<hr>
  ...
  <div>
    ...
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_awssns1" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>What is AWS SNS short for?</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">AWS <input name="ex1" maxlength="6" style="width: 80px;"> Notification <input name="ex2" maxlength="7" style="width: 90px;"></pre>
        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_awssns1">Start the Exercise</a></p>
      </div>
    </form>
  </div>
