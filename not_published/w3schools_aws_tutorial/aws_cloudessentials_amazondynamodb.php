...
<a class="w3-left w3-btn" href="aws_cloudessentials_amazonrds.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_comparingamazonrdsandamazondynamodb.php">Next &#10095;</a>
</div>
<hr>

<h2>What is Amazon DynamoDB?</h2>
<p>DynamoDB is a fully managed NoSQL database for key-value and document data. NoSQL databases use flexible schemas where each item has a key and attributes, but unlike relational databases, different items can have different attributes.</p>
<p>DynamoDB delivers <strong>single-digit millisecond response times</strong> at any scale by automatically spreading data across servers.</p>
<p>Common use cases are: gaming platforms, financial services, mobile apps with global users</p>
<hr>

<h2>Amazon DynamoDB Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M07_L03_15_AmazonDynamoDB_v01_FINAL.mp4" type="video/mp4">
...
<h2>DynamoDB Benefits</h2>
<ul>
  <li><strong>Auto-scaling:</strong> Throughput scales up or down based on usage</li>
  <li><strong>High availability:</strong> 99.999% availability across three facilities per Region</li>
  <li><strong>Encryption:</strong> All data automatically encrypted at rest</li>
</ul>
<hr>

<h2>NoSQL Database Example</h2>
  <table class="w3-table w3-border">
    ...
    <tr>
      ...
      <td>Name: Katherine Smith</td>
    </tr>
    <tr>
      <td class="w3-border-right">1</td>
      <td>Profession: Photographer</td>
    </tr>
    <tr>
      <td class="w3-border-right"></td>
      <td>Hobby: Reading</td>
...
<div>
    ...
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_amazonrds3" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>Fill in the blanks</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">Amazon DynamoDB is a non-<input name="ex1" maxlength="10" style="width: 125px;"> NoSQL <input name="ex2" maxlength="8" style="width: 125px;"></pre>
        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_amazonrds3">Start the Exercise</a></p>
      </div>
    </form>
  </div>
<hr>
