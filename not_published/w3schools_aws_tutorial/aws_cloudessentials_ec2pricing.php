...
<head>
  <title>AWS Cloud EC2 Pricing</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>AWS Cloud EC2 Pricing</h1>


<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_ec2instancetypes.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_ec2scaling.php">Next &#10095;</a>
</div>
<hr>

<h2>EC2 Pricing</h2>
<p>EC2 uses a pay-as-you-go model. You only pay for the compute time you use and there are several pricing options to optimize costs.</p>
<hr>

<h2>EC2 Pricing Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M02_L04_20_AmazonEC2Pricing_v01_FINAL.mp4" type="video/mp4">
...
<p>Pay by the hour or second (minimum 60 seconds) with no upfront costs. Best for short-term, unpredictable workloads. Instances run until you stop them.</p>

<h3>Savings Plans</h3>
<p>Commit to consistent usage (1 or 3 years) for discounted rates. Usage beyond your commitment is billed at on-demand prices.</p>

<h3>Reserved Instances</h3>
<p>Reserve capacity for 1 or 3 years for significant discounts (3-year gives the highest). Offers flexibility to modify Availability Zones or instance sizes within the same family.</p>
<hr>
<style>
.certtext {
  width:100%;
...
<p>Up to 90% savings by using AWS's spare capacity. Best for flexible workloads that can handle interruptions.</p>

<h3>Dedicated Hosts</h3>
<p>Physical servers fully dedicated to you. Most expensive option, but lets you use existing software licenses.</p>
<hr>

<div>
    <h2>AWS Cloud Exercises</h2>
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_ec2intro4" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>Which pricing model lets you pay only for what you use?</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">On <input name="ex1" maxlength="6" style="width: 80px;"> Instances</pre>
        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_ec2intro4">Start the Exercise</a></p>
      </div>
    </form>
  </div>
<hr>
