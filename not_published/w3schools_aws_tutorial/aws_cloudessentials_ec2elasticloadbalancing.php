...
<head>
  <title>AWS Cloud Elastic Load Balancing</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>AWS Cloud Elastic Load Balancing</h1>


<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_ec2autoscaling.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_messagingandqueuing.php">Next &#10095;</a>
</div>
<hr>

<h2>Elastic Load Balancing (ELB)</h2>
<p>Elastic Load Balancing (ELB) distributes incoming traffic across multiple EC2 instances. It acts as a single point of contact, spreading requests evenly so no single instance gets overloaded.</p>
<p>ELB works seamlessly with <a href="aws_cloudessentials_ec2autoscaling.php">EC2 Auto Scaling</a> to enhance performance and ensure high availability. It scales automatically with traffic at no additional hourly cost.</p>
<hr>

<h2>Directing Traffic with Elastic Load Balancing Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M02_L06_35_DirectingTrafficWithElasticLoadBalancing_v01_FINAL.mp4" type="video/mp4">
...
<h3>Key Benefits</h3>
<ul>
  <li><strong>Efficient distribution:</strong> Evenly spreads traffic, preventing overload on any single instance</li>
  <li><strong>Automatic scaling:</strong> Adjusts to traffic changes automatically</li>
  <li><strong>Simplified management:</strong> Handles maintenance, updates, and failover</li>
</ul>

<h3>Routing Methods (how we distribute traffic between instances)</h3>
<ul>
  <li><strong>Round Robin:</strong> Distributes traffic evenly in a cyclic manner</li>
  <li><strong>Least Connections:</strong> Routes to the server with fewest active connections</li>
  <li><strong>IP Hash:</strong> Uses client IP to consistently route to the same server</li>
  <li><strong>Least Response Time:</strong> Directs to the server with fastest response</li>
</ul>
<hr>

<div>
    <h2>AWS Cloud Exercises</h2>
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_ec2elasticloadbalancing1" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>What is the Elastic Load Balancing service a single point of contact for?</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">Incoming <input name="ex1" maxlength="3" style="width: 50px;"> traffic</pre>
        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_ec2elasticloadbalancing1">Start the Exercise</a></p>
      </div>
    </form>
  </div>
<hr>
