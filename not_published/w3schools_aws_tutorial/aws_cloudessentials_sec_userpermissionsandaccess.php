...
<head>
  <title>User Permissions and Access</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>User Permissions and Access</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_sec_sharedresponsibilitymodel.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_sec_denialofserviceattacks.php">Next &#10095;</a>
</div>
<hr>

<h2>What is AWS Identity and Access Management (IAM)?</h2>
<p>AWS Identity and Access Management (IAM) securely manages identities and access to AWS services. By default, all actions are denied - you must explicitly grant permission.</p>
<p>IAM follows the <strong>Principle of Least Privilege</strong>: only give people and systems access to what they need. It provides users, groups, roles, and policies to configure access based on your security needs.</p>
<hr>

<h2>User Permissions and Access Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M09_L02_10_UserPermissionsAndAccess_v01_FINAL.mp4" type="video/mp4">
...
<h3>Root User</h3>
<p>The account owner created when you first start an AWS account with full permissions. Best practices:</p>
<ul>
  <li>Use a strong password and enable MFA</li>
  <li>Avoid using root user for daily tasks</li>
  <li>Create IAM identities for daily work</li>
</ul>
<img src="images/aws-account-root-user.jpg" loading="lazy" alt="Image of creating and using the root user" style="width:1200px;max-width:100%;">
<p class="w3-small">Image created by Amazon Web Services</p>

<h3>IAM Users</h3>
<p>Represents a person or application that interacts with AWS. Created without permissions by default - create one IAM user per individual.</p>
<hr>
...
<h3>IAM Policies</h3>
<p>Documents that allow or deny permissions to AWS resources. Customize access for each user based on what they need.</p>
<img src="images/iam-policy-example.jpg" loading="lazy" alt="IAM policy example" style="width:800px;max-width:100%;">
<p class="w3-small">Image created by Amazon Web Services</p>

<h3>IAM Groups</h3>
<p>A collection of IAM users. Policies assigned to a group apply to all users in that group.</p>
<img src="images/aws-iam-group.jpg" loading="lazy" alt="IAM group structure" style="width:400px;max-width:100%;">
<p class="w3-small">Image created by Amazon Web Services</p>

<h3>IAM Roles</h3>
<p>An identity you can assume to gain temporary access to permissions. When assuming a role, you abandon previous permissions and take on the role's permissions. Best for temporary access scenarios.</p>
<hr>

<h2>Multi-factor Authentication (MFA)</h2>
<p>Requires at least two verification methods to log in, providing an extra security layer. Can use security codes sent to mobile devices or email.</p>
<hr>

<h2>Additional Services</h2>
<table class="ws-table-all">
  <tr>
    <th style="width:280px">Service</th>
    <th>What It Does</th>
  </tr>
  <tr>
    <td><strong>IAM Identity Center</strong></td>
    <td>Centralizes identity management and single sign-on across AWS accounts</td>
  </tr>
  <tr>
    <td><strong>AWS Secrets Manager</strong></td>
    <td>Securely manage and rotate credentials, API keys, and secrets</td>
  </tr>
  <tr>
    <td><strong>AWS Systems Manager</strong></td>
    <td>Centralized view of nodes with automated patching and management</td>
  </tr>
</table>
<hr>
...
<div>
    ...
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_sec_securityintroduction2" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>Fill in the blank</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">IAM user represents an <input name="ex1" maxlength="6" style="width: 90px;"> (person or application)</pre>
        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_sec_securityintroduction2">Start the Exercise</a></p>
      </div>
    </form>
  </div>
