...
<head>
  <title>AWS Cloud Benefits</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>AWS Cloud Benefits</h1>


<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_cloudcomputing.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_infrastructure_intro.php">Next &#10095;</a>
</div>
<hr>

<h2>Benefits of Cloud Computing</h2>
<p>Cloud computing offers benefits like cost savings, security, scalability, and flexibility.</p>
<hr>

<h2>AWS Cloud Benefits Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M01_L03_15_BenefitsOfTheCloud_v01_FINAL.mp4" type="video/mp4">
...
<h2>AWS highlights these six key benefits of cloud computing</h2>

<h3>1. Pay Only for What You Use</h3>
<p>No upfront investment in data centers or servers. Start using services immediately, scale as you grow, and pay only for what you consume.</p>

<h3>2. Benefit from Massive Economies of Scale</h3>
<p>Sharing infrastructure with hundreds of thousands of customers lowers costs for everyone, giving businesses of all sizes access to advanced technologies at lower rates.</p>

<h3>3. Stop Guessing Capacity</h3>
<p>No more unused servers or capacity limits. Scale freely based on actual demand and pay only for what you use.</p>
<hr>
<style>
.certtext {
  width:100%;
...
<hr>
<h3>4. Increase Speed and Agility</h3>
<p>Provision resources in minutes instead of weeks. This flexibility lets you experiment, innovate, and iterate faster.</p>

<h3>5. Stop Spending Money Running Data Centers</h3>
<p>Eliminate the overhead of managing physical infrastructure and focus on your applications and customers instead.</p>

<h3>6. Go Global in Minutes</h3>
<p>Deploy applications worldwide using AWS data centers across the globe. Select regions close to your users for low latency and better performance.</p>
<hr>

<div>
    <h2>AWS Cloud Exercises</h2>
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_benefits1" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>Insert the missing benefit of cloud computing.</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">Cost savings, scalability, flexibility, and <input name="ex1" maxlength="8" style="width: 100px;"></pre>
        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_benefits1">Start the Exercise</a></p>
      </div>
    </form>
  </div>
