...
<head>
  <title>AWS Cloud Get Started</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>AWS Cloud Get Started</h1>


<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_awscert.php">&#10094; Previous</a> 
<a class="w3-right w3-btn" href="aws_cloudessentials_cloudcomputing.php">Next &#10095;</a>
</div>
<hr>

<h2>Free AWS Account</h2>
<p>AWS offers a Free Tier with limited usage of services at no cost, letting you explore and experiment.</p>
<p>Let's create your free account!</p>
<hr>

<h2>How To Sign Up</h2>
<p><strong>Step 1</strong>: Go to the AWS website to get your free account: <span><a href="https://aws.amazon.com/free/" target="_blank">Sign up for free</a></span></p>
<img src="images/freetiersignup.png" loading="lazy" alt="AWS sign up page for free tier" style="width:700px;max-width:100%;">
<p><strong>Step 2</strong>: Click the "Create a free account" button.</p>
<img src="images/signupform.png" loading="lazy" alt="AWS free tier sign up form" style="width:700px;max-width:100%;">
  <p><strong>Step 3</strong>: Complete the registration steps.</p>
<div class="ws-note w3-panel">
    <p>AWS requires you to register a credit card and identity verification by phone number via text or voice. </p>
</div>
<img src="images/welcomepage.png" loading="lazy" alt="Welcome page with services" style="width:700px;max-width:100%;">
<p><strong>Congrats</strong> on getting your account set up! Click the "next" button to learn more!</p>
<hr>
