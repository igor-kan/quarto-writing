...
<head>
  <title>Introduction to Monitoring</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="aws_cloudessentials_ma_intro.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_ma_cloudwatch.php">Next &#10095;</a>
</div>
<hr>

<h2>What is Monitoring?</h2>
<p>Monitoring is the continuous process of collecting and tracking the health and performance of your AWS infrastructure, services, and applications. The goal is to ensure optimal performance and identify issues before they impact users.</p>
<hr>

<h2>Introduction to Monitoring Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M10_L01_05_IntroductionToMonitoring_v02_FINAL.mp4" type="video/mp4">
...
<ul>
  <li><strong>Security:</strong> Detect threats or anomalies in real time</li>
  <li><strong>Reliability:</strong> Track system health and availability</li>
  <li><strong>Performance:</strong> Optimize resources based on usage patterns</li>
  <li><strong>Costs:</strong> Monitor resource utilization and spending</li>
  <li><strong>Proactive response:</strong> Fix issues before they impact users</li>
</ul>
<p>Monitoring uses real-time tools, log analysis, and dashboards to give you visibility into your systems.</p>
<hr>
