...
<head>
  <title>AWS Additional Compute Services</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Additional Compute Services</h1>

<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_awsfargate.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_awsinfrastructure.php">Next &#10095;</a>
</div>
<hr>

<h2>Additional Compute Services</h2>
<p>Other than EC2, Lambda, and containers, AWS offers purpose-built compute services for specific needs: web application deployment, batch workloads, simple virtual servers, and hybrid cloud infrastructure.</p>
<hr>

<h2>Additional Compute Services Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M03_L04_30_AdditionalComputeServices_v03.mp4" type="video/mp4">
...
<p>Fully managed service that deploys, manages, and scales web applications. Upload your code and it handles infrastructure, scaling, and monitoring. Supports Java, .NET, Python, Node.js, Docker, and more.</p>
<p><strong>Good for:</strong> Web apps, APIs, mobile backends, microservices.</p>

<h3>AWS Batch</h3>
<p>Fully managed batch computing that automatically schedules and scales compute resources based on job requirements.</p>
<p><strong>Good for:</strong> Scientific computing, financial analysis, media transcoding, ML training.</p>

<h3>Amazon Lightsail</h3>
<p>Provides virtual servers, storage, and databases with predictable monthly pricing. Designed for users who want a simplified AWS experience.</p>
<p><strong>Good for:</strong> Basic web apps, low-traffic sites, dev/test environments, blogs.</p>

<h3>AWS Outposts</h3>
<p>Extends AWS infrastructure to your on-premises data center for a consistent hybrid cloud experience.</p>
<p><strong>Good for:</strong> Low-latency apps, remote data processing, regulatory compliance.</p>
<hr>
