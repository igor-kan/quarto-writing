...
<a class="w3-left w3-btn" href="aws_cloudessentials_ma_governance.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_ma_trustedadvisor.php">Next &#10095;</a>
</div>
<hr>

<h2>What is AWS Health?</h2>
<p>AWS Health is the go-to data source for events and changes affecting the health of your AWS Cloud resources. It notifies you about service events, planned changes, and account notifications to help you manage and take actions.</p>
<p>AWS Health provides timely and actionable guidance to remedy issues quickly.</p>
<hr>

<h2>AWS Health Dashboard</h2>
<p>View account-specific health information and get AWS Health event updates. You can also access AWS Health programmatically using the AWS Health API, which is available with AWS Premium Support.</p>

<h3>Benefits</h3>
<ul>
  <li>Centralized data source for events and changes</li>
  <li>Timely and actionable guidance for remediation</li>
  <li>Helps manage service health across your environment</li>
  <li>Integrated and automated to use at scale</li>
</ul>

<h3>Use Cases</h3>
<ul>
  <li>View account-specific health information</li>
  <li>Plan for lifecycle events</li>
  <li>Troubleshoot an incident</li>
</ul>
