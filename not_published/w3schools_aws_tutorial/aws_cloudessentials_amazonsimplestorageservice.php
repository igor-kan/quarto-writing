...
<a class="w3-left w3-btn" href="aws_cloudessentials_awsebs.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_amazonelasticfilesystem.php">Next &#10095;</a>
</div>
<hr>

<h2>What is Amazon S3?</h2>
<p>Amazon S3 (Simple Storage Service) is a fully managed object storage service with <strong>99.999999999% durability</strong>. It can store any type of file up to 5 TB per object, with virtually unlimited total capacity.</p>
<hr>

<h2>Amazon S3 Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M06_L03_25_AmazonSimpleStorageService_v02_FINAL.mp4" type="video/mp4">
...
<h2>Amazon S3 Concepts</h2>

<h3>Buckets and Objects</h3>
<p>A <strong>bucket</strong> is a container for objects with a globally unique name. An <strong>object</strong> consists of data (the file), metadata (information about it), and a key (unique identifier).</p>
<img class="invert-on-dark" src="images/object-storage.jpg" style="width:800px;max-width:100%;" loading="lazy" alt="Image of an object">
<p class="w3-small">Image created by Amazon Web Services</p>
<hr>

<h3>Security</h3>
<p>Everything in S3 is private by default. Grant access using:</p>
<ul>
  <li><strong>Bucket policies:</strong> Allow or deny actions on the bucket</li>
  <li><strong>Identity-based policies:</strong> Control user, group, or role permissions</li>
  <li><strong>Encryption:</strong> Protect data at rest and in transit</li>
</ul>
<hr>

<h3>Lifecycle Management</h3>
<p>Automate moving objects between storage classes with lifecycle rules:</p>
<ul>
  <li><strong>Transition actions:</strong> Move objects to cheaper storage classes over time</li>
  <li><strong>Expiration actions:</strong> Automatically delete objects after a set period</li>
</ul>
<hr>

<h2>Amazon S3 Storage Classes</h2>
<p>S3 offers different storage classes based on how often you access your data and how fast you need it.</p>

<h3>Frequently Accessed Data</h3>
<table class="ws-table-all">
  <tr>
    <th style="width:280px">Storage Class</th>
    <th>Best For</th>
  </tr>
  <tr>
    <td><strong>S3 Standard</strong></td>
    <td>Data accessed often. Stored in 3+ AZs. Highest availability, highest cost.</td>
  </tr>
  <tr>
    <td><strong>S3 Express One Zone</strong></td>
    <td>Fastest access (single-digit ms). 10x faster than Standard. 1 AZ.</td>
  </tr>
</table>
...
<h3>Infrequently Accessed Data</h3>
<table class="ws-table-all">
  <tr>
    <th style="width:280px">Storage Class</th>
    <th>Best For</th>
  ...
  <tr>
    ...
    <td>Data accessed less often. 3+ AZs. Lower storage cost, higher retrieval cost.</td>
  </tr>
  <tr>
    <td><strong>S3 One Zone-IA</strong></td>
    <td>Same as Standard-IA but stored in 1 AZ. Cheaper.</td>
  </tr>
  <tr>
    <td><strong>S3 Intelligent-Tiering</strong></td>
    <td>Unknown access patterns. Automatically moves data between tiers.</td>
  </tr>
</table>

<h3>Archive Storage (Glacier)</h3>
<table class="ws-table-all">
  <tr>
    <th style="width:280px">Storage Class</th>
    <th>Best For</th>
  ...
  <tr>
    ...
    <td>Rarely accessed, but need instant access. 68% cheaper than Standard-IA.</td>
  </tr>
  <tr>
    <td><strong>Glacier Flexible Retrieval</strong></td>
    <td>Accessed 1-2x per year. Retrieval: minutes to hours.</td>
  </tr>
  <tr>
    <td><strong>Glacier Deep Archive</strong></td>
    <td>Long-term storage (7-10+ years). Lowest cost. 12-hour retrieval.</td>
  </tr>
</table>
<hr>
...
<div>
    ...
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_storageanddatabases_introduction4" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>What type of files can be uploaded to Amazon S3?</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">S3 allows uploading <input name="ex1" maxlength="3" style="width: 60px;"> type of file</pre>
        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_storageanddatabases_introduction4">Start the Exercise</a></p>
      </div>
    </form>
  </div>
