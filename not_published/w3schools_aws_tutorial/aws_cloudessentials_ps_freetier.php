...
<a class="w3-left w3-btn" href="aws_cloudessentials_ps_intro.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_ps_pricemodels.php">Next &#10095;</a>
</div>
<hr>

<h2>Get an AWS Free Tier Account</h2>
<p>The AWS Free Tier lets you try services for free for the specified period.</p>
<p>It has three different offerings:</p>
<ul>
  <li>Always Free</li>
...
<div class="ws-note w3-panel">
  <p>Learn how to create your account at: <a href="aws_cloudessentials_getstarted.php" target="_blank">Get Started Chapter</a></p>
</div>
<hr>

<h2>Always Free</h2>
  <p>The offers in Always Free do not expire.</p>
  <p>Always Free is available to everyone.</p>
  <p>You need to have an account to get started.</p>
<hr>

<h2>12 Months Free</h2>
  <p>This offer is free for the first 12 months.</p>
  <p>It starts to count when you sign up with an account.</p>
  <p>With 12 Months Free, you get more data to play with.</p>
<hr>

<h2>Trials</h2>
<p>Trials are short-term offers.</p>
<p>It is for specific services.</p>
<p>The trial period starts when you activate the service.</p>
<p>The period length differs from service to service.</p>
<p>Examples: 30 days, 90 days, or 150 free hours of consumption.</p>
<hr>
...
<div>
    ...
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_ps_intro1" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>Fill in the missing offering in the Free Tier</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">Always Free</pre>
          <pre style="overflow: auto;">12 Months Free</pre>
          <pre style="overflow: auto;"><input name="ex1" maxlength="6" style="width: 90px;"></pre>
        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_ps_intro1">Start the Exercise</a></p>
      </div>
    </form>
  </div>
