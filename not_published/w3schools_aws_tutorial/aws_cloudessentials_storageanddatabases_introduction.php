...
<a class="w3-left w3-btn" href="aws_cloudessentials_globalarchitectures.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_instancestores.php">Next &#10095;</a>
</div>
<hr>

<h2>Introduction to AWS Storage</h2>
<p>AWS provides multiple storage options to meet different needs: block storage for EC2 instances, object storage for files and media, and file storage for shared access across applications.</p>
<hr>

<h2>Introduction to AWS Storage Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M06_L01_05_IntroToStorage_v01_FINAL.mp4" type="video/mp4">
...
<h2>AWS Storage Types</h2>

<h3>Block Storage</h3>
<p>Low-latency storage volumes that attach to EC2 instances like physical hard drives.</p>
<p>Examples of block storage:</p>
<ul>
  <li><strong>EC2 Instance Store:</strong> Temporary, high-performance storage</li>
  <li><strong>Amazon EBS:</strong> Persistent block storage volumes</li>
</ul>

<h3>Object Storage</h3>
<p>Manages data as objects with unlimited scalability for unstructured data like documents, images, and videos.</p>
<p>Examples of object storage:</p>
<ul>
  <li><strong>Amazon S3:</strong> Store and retrieve any amount of data</li>
</ul>

<h3>File Storage</h3>
<p>Shared file systems accessible over networks by multiple users and applications simultaneously.</p>
<p>Examples of file storage:</p>
<ul>
  <li><strong>Amazon EFS:</strong> Scalable NFS file system</li>
  <li><strong>Amazon FSx:</strong> Managed file storage for Windows, Lustre, and more</li>
</ul>
<hr>

<h2>Shared Responsibility for Storage</h2>
<ul>
  <li><strong>Fully managed:</strong> AWS handles everything. You only manage data, access, and configuration</li>
  <li><strong>Managed:</strong> AWS handles infrastructure. You only manage backups and encryption</li>
  <li><strong>Unmanaged:</strong> You handle everything. You manage data management, backups, and encryption</li>
</ul>
<hr>
