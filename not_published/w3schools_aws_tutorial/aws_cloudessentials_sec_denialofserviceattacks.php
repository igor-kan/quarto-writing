...
<head>
  <title>Protecting Networks and Applications</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Protecting Networks and Applications</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_sec_userpermissionsandaccess.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_sec_dataprotection.php">Next &#10095;</a>
</div>
<hr>

<h2>Protecting Networks and Applications</h2>
<p>Network and application protection is vital for a secure AWS environment. Attackers can overwhelm your applications with excessive traffic, denying service to legitimate users. AWS provides built-in infrastructure protection and specialized security services to prevent and mitigate this unwanted traffic.</p>
<hr>

<h2>Network and Application Protection Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M09_L03_20_NetworkAndApplicationProtection_v03_FINAL.mp4" type="video/mp4">
...
<p>An attacker floods a web application with excessive traffic, preventing legitimate requests from being served.</p>

<h3>DDoS (Distributed Denial of Service)</h3>
<p>Multiple infected computers (zombie bots) send excessive traffic simultaneously, making attacks harder to block.</p>
<hr>

<h2>Infrastructure Protection</h2>
<p>AWS automatically protects against low-level attacks through its global infrastructure spanning Regions, Availability Zones, and edge locations.</p>
<ul>
  <li><strong>Security Groups:</strong> Filter traffic at the network level using Region-wide capacity</li>
  <li><strong>Elastic Load Balancing:</strong> Handles traffic before your servers, preventing overload</li>
  <li><strong>AWS Regions:</strong> Massive capacity makes them extremely difficult to overwhelm</li>
</ul>
<hr>
...
<h3>AWS Shield</h3>
<p><strong>Standard:</strong> Free, automatic protection against common DDoS attacks with real-time detection and mitigation.</p>
<p><strong>Advanced:</strong> Paid service with detailed attack diagnostics, sophisticated DDoS protection, and integration with CloudFront, Route 53, and ELB. Can combine with AWS WAF for custom rules.</p>

<h3>AWS WAF</h3>
<p>Web application firewall that monitors incoming requests and checks IP addresses against access control lists (ACLs). Blocks requests from known malicious sources while allowing legitimate traffic.</p>
<hr>

<div>
    <h2>AWS Cloud Exercises</h2>
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_sec_securityintroduction6" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>What is the difference between DoS and DDoS?</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">The difference is that DDoS is a <input name="ex1" maxlength="11" style="width: 130px;"> attack</pre>
        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_sec_securityintroduction6">Start the Exercise</a></p>
      </div>
    </form>
  </div>
