...
<a class="w3-left w3-btn" href="aws_cloudessentials_awsbeanstalk.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_awsnetworking.php">Next &#10095;</a>
</div>
<hr>

<h2>AWS CloudFormation</h2>
<p>CloudFormation is an Infrastructure as Code (IaC) service that automates resource provisioning. You define your AWS resources in a template file, and CloudFormation provisions and configures them for you.</p>
<p>It automatically handles dependencies between resources, so you don't need to configure each one individually.</p>
<hr>

<h2>Infrastructure as Code Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M04_L03_20_InfrastructureAndAutomation_v01_FINAL.mp4" type="video/mp4">
...
<p>See the <a href="https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/Welcome.html">AWS CloudFormation documentation</a> for more details.</p>
<hr>

<div>
    <h2>AWS Cloud Exercises</h2>
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_awsinfrastructure9" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>What does CloudFormation helps you to do?</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">AWS CloudFormation helps to <input name="ex1" maxlength="8" style="width: 115px;"> resource provision</pre>
        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_awsinfrastructure9">Start the Exercise</a></p>
      </div>
    </form>
  </div>
