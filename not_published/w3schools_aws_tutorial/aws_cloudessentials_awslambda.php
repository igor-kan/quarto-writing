...
<a class="w3-left w3-btn" href="aws_cloudessentials_awsserverless.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_awscontainers.php">Next &#10095;</a>
</div>
<hr>

<h2>What is AWS Lambda?</h2>
<p>AWS Lambda is a serverless compute service that runs code in response to events. No servers to manage, automatic scaling, and you pay only for compute time used (down to the millisecond).</p>
<hr>

<h2>AWS Lambda Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M03_L02_10_AWSLambda_v02_FINAL.mp4" type="video/mp4">
...
<ol>
  <li><strong>Upload code:</strong> Deploy your code as a Lambda function</li>
  <li><strong>Set triggers:</strong> Configure events to trigger your code (AWS services, HTTP requests, schedules)</li>
  <li><strong>Code runs when triggered:</strong> Lambda executes and scales automatically when triggered</li>
  <li><strong>Pay only for compute time:</strong> Charged based on execution time and memory used</li>
</ol>
<p><strong>Analogy:</strong> Like a car, you only use fuel when driving. Lambda only runs (and charges) when your code executes.</p>
<hr>
<style>
.certtext {
  width:100%;
...
<h2>Lambda Features</h2>

<h3>Use Cases</h3>
<ul>
  <li><strong>Image processing:</strong> Resize images when uploaded</li>
  <li><strong>Real-time processing:</strong> Handle streaming data or in-game events</li>
  <li><strong>API backends:</strong> Run backend code for web and mobile apps</li>
</ul>

<h3>Supported Languages</h3>
<p>Python, Node.js, Java, C#, Go, Ruby, plus custom runtimes for other languages.</p>

<p>Learn more: <a href="https://aws.amazon.com/lambda/" target="_blank">AWS Lambda</a></p>
<hr>

 <div>
    <h2>AWS Cloud Exercises</h2>
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_awslambda1" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>What kind of service is AWS Lambda?</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">AWS Lambda is a <input name="ex1" maxlength="10" style="width: 125px;"> <input name="ex2" maxlength="7" style="width: 90px;"> service</pre>
        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_awslambda1">Start the Exercise</a></p>
      </div>
    </form>
  </div>
