...
<head>
  <title>AWS Cloud Security</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="aws_cloudessentials_aiml_datapipelines.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_sec_sharedresponsibilitymodel.php">Next &#10095;</a>
</div>
<hr>

<h2>What is Cloud Security?</h2>
<p>Building and maintaining a secure cloud environment requires protecting data, networks, and applications from threats. Security in the cloud is a shared responsibility between AWS and its customers.</p>
<p>AWS provides security mechanisms to prevent incidents, protect resources, and detect and respond to threats. This section covers the key concepts and services that help protect your cloud resources.</p>
<hr>

<h2>Introduction to Security Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M09_L01_05_IntroToSecurity_v01_FINAL.mp4" type="video/mp4">
...
<p>Verifies identity through credentials like username and password. Example: An employee logs in to an employee portal.</p>

<h3>Authorization</h3>
<p>Determines which actions a verified user can perform. Example: An employee can only access their own records.</p>

<img src="images/aws-authentication-authorization.png" alt="Authentication vs Authorization" style="max-width:600px;width:100%">
<hr>

<h2>AWS Security Controls</h2>
<p>AWS offers multiple security mechanisms to protect your cloud resources:</p>
<ul>
  <li><strong>Prevent:</strong> Security incidents through proper permission and access management</li>
  <li><strong>Protect:</strong> Networks, applications, and data</li>
  <li><strong>Detect and Respond:</strong> To security incidents as they occur</li>
</ul>
<hr>
