...
<head>
  <title>AWS Cloud Availability Zones</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>AWS Cloud Availability Zones</h1>


<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_awsregions.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_awsedgelocations.php">Next &#10095;</a>
</div>
<hr>

<h2>What is an Availability Zone (AZ)?</h2>
<p>An Availability Zone (AZ) is one or more data centers within a Region, each with independent power, networking, and connectivity. Every Region has at least three AZs.</p>
<p>AZs are physically separated to reduce disaster risk, yet close enough for low-latency communication between them.</p>
<hr>

<h2>Availability Zones Video</h2>
...
<h2>Availability Zones Illustration</h2>
<p>The diagram shows three US West Regions, each containing multiple Availability Zones. Zooming into N. California reveals three AZs (US-West-1A, 1B, 1C), each representing a group of data centers.</p>
<img src="images/availabilityzones.png" loading="lazy" alt="Regions, zones and Data Centers" style="width:700px;max-width:100%;">
...
<p>Deploy resources across multiple AZs so your application continues running even if one zone fails. This provides:</p>
<ul>
  <li><strong>High availability:</strong> Continuous operation without downtime</li>
  <li><strong>Agility:</strong> Quick adaptation to changing requirements</li>
  <li><strong>Elasticity:</strong> Automatic scaling based on demand</li>
</ul>
<hr>
    ...
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_awsinfrastructure3" method="post" target="_blank">
      ...
      <div class="exercisewindow">
        ...
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">Availability Zone is a single Data Center or a <input name="ex1" maxlength="5" style="width: 80px;"> of Data Centers</pre>
        </div>
        <br>
...
<hr>
<p>In the next chapter, you will learn about Edge Locations.</p>
<hr>
