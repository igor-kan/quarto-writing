...
<head>
  <title>AWS Generative AI Services</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>AWS Generative AI Services</h1>

<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_aiml_genai_intro.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_aiml_dataanalytics_intro.php">Next &#10095;</a>
</div>
<hr>

<h2>AWS Generative AI Services</h2>
<p>AWS provides several services for building and deploying generative AI applications, from pre-built models to fully managed foundation model access.</p>
<hr>

<h2>Amazon SageMaker JumpStart</h2>
<p>An ML hub within SageMaker AI that accelerates building and deploying models. Offers pre-built solutions for computer vision, NLP, and tabular data that can be fine-tuned and deployed with a few clicks.</p>
<p><strong>Use cases:</strong> Rapid model deployment, custom fine-tuning with domain data, ML experimentation and prototyping.</p>
<hr>

<h2>Amazon Bedrock</h2>
<p>A fully managed service providing access to foundation models from Amazon and leading AI providers (Claude, Stable Diffusion) through a single API. Experiment with FMs, fine-tune with your data, and integrate into AWS applications.</p>
<p><strong>Use cases:</strong> Enterprise generative AI apps, multimodal content generation, conversational AI with enterprise data.</p>
<hr>
...
<h2>Amazon Q</h2>
<p>A generative AI assistant that helps organizations streamline processes and improve productivity.</p>

<h3>Amazon Q Business</h3>
<p>Answers questions using your company's data repositories with secure connections to commonly used systems.</p>
<p><strong>Use cases:</strong> Information requests, automated workflows, insight extraction.</p>

<h3>Amazon Q Developer</h3>
<p>Provides code recommendations across C#, Java, JavaScript, Python, TypeScript, and more. Integrates with multiple IDEs and generates entire functions.</p>
<p><strong>Use cases:</strong> Faster code generation, improved reliability, automated code reviews.</p>
<hr>
