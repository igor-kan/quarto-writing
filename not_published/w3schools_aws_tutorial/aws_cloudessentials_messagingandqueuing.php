...
<head>
  <title>AWS Cloud Messaging and Queuing</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>AWS Cloud Messaging and Queuing</h1>


<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_ec2elasticloadbalancing.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_awseventbridge.php">Next &#10095;</a>
</div>
<hr>

<h2>Application Architecture</h2>
<p>There are two main approaches to connecting components in an application architecture:</p>

<h3>Monolithic</h3>
<p>All components are <strong>tightly coupled</strong> and run as a single unit. If one component fails, the entire application can go down.</p>

<h3>Microservices</h3>
<p>Components are <strong>loosely coupled</strong> and communicate through messaging. If one component fails, others continue working normally.</p>
<hr>
<style>
.certtext {
  width:100%;
...
<h2>Messaging and Queuing</h2>
<p>To handle communication in a microservices architecture, we use messaging and queuing to transmit data and fulfill requests.</p>
<p>AWS messaging services allows components to communicate asynchronously, so failures don't cascade through the application.</p>
<hr>

<h2>Messaging and Queuing Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M02_L07_45_MessagingAndQueuing_v02_FINAL.mp4" type="video/mp4">
...
<h2>AWS Messaging Services</h2>
<ul>
  <li><strong>Amazon EventBridge:</strong> Serverless event routing between apps, AWS services, and third-party software</li>
  <li><strong>Amazon SNS:</strong> Publish-subscribe service for sending messages to multiple subscribers</li>
  <li><strong>Amazon SQS:</strong> Message queuing for reliable component communication</li>
</ul>
<hr>

<div>
    <h2>AWS Cloud Exercises</h2>
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_messagingandqueuing1" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>What does components do with each other?</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">They <input name="ex1" maxlength="11" style="width: 150px;"></pre>
        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_messagingandqueuing1">Start the Exercise</a></p>
      </div>
    </form>
  </div>
<hr>
