...
<head>
  <title>Comparing AWS Storage Services</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Comparing AWS Storage Services</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_amazonelasticfilesystem.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_databases.php">Next &#10095;</a>
</div>
<hr>

<h2>Storage Services Overview</h2>
<p>AWS offers different storage types for different needs: block storage (EBS) for EC2 instances, object storage (S3) for files and media, and file storage (EFS) for shared access across instances.</p>
<hr>

<h2>Comparing Storage Services Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M06_L06_60_CloudInRealLifeComparingStorageServices_v01_FINAL.mp4" type="video/mp4">
...
<table class="ws-table-all">
  ...
  <tr>
    ...
    <td>Web/API access</td>
    <td>Multiple EC2 instances</td>
  </tr>
  <tr>
    <td><strong>Max size</strong></td>
    <td>16 TiB per volume</td>
    <td>5 TB per object</td>
    <td>Petabytes (auto-scales)</td>
  </tr>
  <tr>
    <td><strong>Strength</strong></td>
    <td>Low-latency performance</td>
    <td>High durability (11 nines)</td>
    <td>Shared access, elastic</td>
  </tr>
  <tr>
    <td><strong>Modification</strong></td>
    <td>Can modify in place</td>
    <td>Must re-upload</td>
    <td>Can modify in place</td>
  </tr>
</table>
...
<ul>
  <li><strong>EBS:</strong> Databases, boot volumes, applications needing fast read/write on a single instance</li>
  <li><strong>S3:</strong> Static files, backups, media storage, data lakes, web content</li>
  <li><strong>EFS:</strong> Shared file systems, content management, web serving across multiple instances</li>
</ul>  
<hr>

  <div>
    <h2>AWS Cloud Exercises</h2>
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_storageanddatabases_introduction7" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>Fill in the blanks</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">EBS stores data as <input name="ex1" maxlength="6" style="width: 75px;"></pre>
          <pre style="overflow: auto;">S3 stores data as <input name="ex2" maxlength="7" style="width: 80px;"></pre>
        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_storageanddatabases_introduction7">Start the Exercise</a></p>
      </div>
    </form>
  </div>
