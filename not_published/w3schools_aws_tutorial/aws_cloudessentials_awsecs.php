...
<head>
  <title>Amazon ECS - Elastic Container Service</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Amazon ECS - Elastic Container Service</h1>


<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_awscontainers.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_awseks.php">Next &#10095;</a>
</div>
<hr>

<h2>What is Amazon ECS?</h2>
<p>Amazon Elastic Container Service (ECS) is a container orchestration service for deploying, scaling, and managing containerized applications on AWS.</p>
<hr>
...
<h3>Launch Types</h3>
<ul>
  <li><strong>ECS with EC2:</strong> Full control over infrastructure for custom hardware or networking needs</li>
  <li><strong>ECS with Fargate:</strong> Serverless option - focus on code while AWS handles servers and scaling</li>
</ul>

<h3>Docker Support</h3>
<p>ECS supports <a href="https://www.docker.com/" target="_blank">Docker</a>, a platform for building, testing, and deploying applications. AWS supports both open-source and enterprise Docker editions.</p>

<p>Learn more: <a href="https://aws.amazon.com/ecs/" target="_blank">Amazon ECS</a></p>
<hr>

<div>
    <h2>AWS Cloud Exercises</h2>
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_awsecs1" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>Which platform do AWS ECS support? This platform lets you build, test, and deploy applications.</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">AWS ECS supports <input name="ex1" maxlength="6" style="width: 80px;"></pre>
        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_awsecs1">Start the Exercise</a></p>
      </div>
    </form>
  </div>
