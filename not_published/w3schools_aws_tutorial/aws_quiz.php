...
<head>
  <title>AWS Cloud Practitioner Preparation Quiz</title>
  <meta charset="utf-8">
...
ny:-->
    ...
    <h1>AWS Cloud Practitioner Preparation Quiz</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_exercises.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="ml/index.php">Next &#10095;</a>
</div>
<hr>
<p class="intro">You can use the AWS Cloud Practitioner Quiz to prepare for your certification exam.</p>
<hr><h2>The Test</h2>
<p>The test contains 40 questions and there is no time limit.</p>
<p>The test is not official, it's just a nice way to see how much you know, or don't know, about the AWS Cloud.</p>
...
<p>Good luck!</p>
<p><a href="/quiztest/quiztest.php?qtest=AWSCE" class="ws-btn w3-blue" style="margin-top:10px;padding:15px 25px;font-size:18px">Start the AWS Cloud Quiz &#10095;</a></p>
</div>
<div class="ws-note w3-panel">
  <p>If you don't know AWS Cloud, we suggest that you read our <a href="index.php">AWS Cloud Practitioner Tutorial</a> from scratch.</p>
</div>


<h2>AWS Cloud Practitioner Exam</h2>
<div class="w3-row" style="width:100%;padding:60px 30px;background-color:#282A35;border-radius:5px;">
  <div class="w3-container w3-mobile w3-cell w3-cell-middle" style="height:100%">
    <img src="images/awslogo.png" alt="AWS logo" style="width:300px;max-width:100%;">
  </div>
  <div class="w3-container w3-cell w3-mobile">
    <p style="font-size: 21px;font-family: 'Source Sans Pro', sans-serif;color: #FFF;">AWS offers a Certification Program for AWS Cloud Practitioner.</p>
    <p style="font-size: 18px;font-family: 'Source Sans Pro', sans-serif;color: #FFF;">Completing the exam grants the AWS Certified Cloud Practitioner title.</p>
    <p style="font-size: 18px;font-family: 'Source Sans Pro', sans-serif;color: #FFF;">This is for you who want to boost your skills and add credentials to your CV.</p>
  </div>
</div>
<hr>
...
<h2>Get a Certificate</h2>
  ...
  <img src="images/awscert.png" alt="AWS Certified Cloud Practitioner Badge" height="350" width="auto">
  </div>
</div>
</div>
<hr>
