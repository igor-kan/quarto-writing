...
<a class="w3-left w3-btn" href="aws_cloudessentials_ps_supportplans.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_ps_costoptimization.php">Next &#10095;</a>
</div>
<hr>

<h2>AWS Marketplace and AWS Partner Network</h2>
<p>AWS provides resources to help you find software solutions and professional expertise. The AWS Marketplace offers a digital catalog of software, while the AWS Partner Network (APN) connects you with certified partners for specialized solutions.</p>
<hr>

<h2>AWS Marketplace Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M11_L08_50_AWSMarketplaceAndAPN_v01_FINAL0.mp4" type="video/mp4">
...
<p>The AWS Marketplace is a digital catalog that includes thousands of software listings from independent software vendors.</p>
<p>You can use AWS Marketplace to find, test, and buy software that runs on AWS.</p>
<p>For each listing, you can access detailed information on pricing options and reviews from other AWS customers.</p>

<h3>Solutions and Services Include</h3>
<ul>
  <li><strong>Software as a Service (SaaS):</strong> Business applications, marketing tools, collaboration tools</li>
  <li><strong>Machine Learning and AI:</strong> Prebuilt models, ML algorithms for custom models</li>
  <li><strong>Data and Analytics:</strong> Business intelligence platforms, data integration tools</li>
</ul>
<img src="images/marketplacecategories.png" style="width:1200px;max-width:100%;" loading="lazy" alt="Overview over the different categories">
<p class="w3-small">Image created by Amazon Web Services</p>
<p>To explore more offerings, refer to <a href="https://aws.amazon.com/marketplace" target="_blank">AWS Marketplace</a>.</p>
<hr>

<h2>AWS Partner Network</h2>
<p>The AWS Partner Network (APN) is a global community that uses AWS technologies, programs, expertise, and tools to build solutions and services for customers.</p>
<p>Together, partners and AWS provide innovative solutions, solve technical challenges, and deliver customer value.</p>
<p>You can work with AWS Partners to create or use specialized solutions tailored to your unique business needs.</p>
<p>To learn more about working with AWS Partners, refer to <a href="https://aws.amazon.com/partners/" target="_blank">Engage with AWS Partners</a>.</p>

<h3>Benefits of Becoming an AWS Partner</h3>
<ul>
  <li><strong>Funding benefits:</strong> Various funding benefits to help build, market, and sell with AWS</li>
  <li><strong>AWS Partner events:</strong> Webinars, virtual workshops, and in-person learning opportunities</li>
  <li><strong>AWS Partner Training and Certification:</strong> Unique, partner-centered offerings from AWS Training and Certification</li>
</ul>
<hr>
...
<div>
    ...
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_ps_intro9" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>Fill in the blanks</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">In AWS Marketplace vendors can <input name="ex1" maxlength="4" style="width: 60px;"> and <input name="ex2" maxlength="4" style="width: 60px;"> software</pre>
        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_ps_intro9">Start the Exercise</a></p>
      </div>
    </form>
  </div>
