...
<head>
  <title>AWS Cloud Provision Services</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>AWS Cloud Provision Services</h1>

<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_awsprovision.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_awsbeanstalk.php">Next &#10095;</a>
</div>
<hr>

<h2>Managed Provisioning Tools</h2>
<p>In addition to manual provisioning, AWS offers two managed tools that simplify deployment: <strong>AWS Elastic Beanstalk</strong> and <strong>AWS CloudFormation</strong>.</p>
<hr>

<h2>Provisioning Video (Part 2)</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M02_L03_20_AmazonEC2Demonstration_v1.mp4" type="video/mp4">
...
<h2>Provisioning Tools Overview</h2>

<h3>AWS Elastic Beanstalk</h3>
<p>Provide your code and configuration settings, and Elastic Beanstalk automatically handles deployment, capacity adjustment, load balancing, auto-scaling, and health monitoring.</p>
<p>Ideal for quickly deploying web applications without managing underlying infrastructure.</p>
<hr>
<style>
.certtext {
  width:100%;
...
<p>Treat your infrastructure as code by defining resources in templates. Instead of manually provisioning through the console, you write code that creates and configures your entire environment.</p>
<p>Ideal for repeatable, version-controlled infrastructure deployments.</p>
<hr>
...
<div>
    ...
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_awsinfrastructure7" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>What are the names of the two managed tools that AWS offer?</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">1. AWS Elastic <input name="ex1" maxlength="9" style="width: 80x;"></pre>
          <pre style="overflow: auto;">2. AWS <input name="ex2" maxlength="14" style="width: 170px;"></pre>
        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_awsinfrastructure7">Start the Exercise</a></p>
      </div>
    </form>
  </div>
