...
<head>
  <title>AWS AI/ML Services</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>AWS AI/ML Services</h1>

<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_aiml_onaws.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_aiml_genai_intro.php">Next &#10095;</a>
</div>
<hr>

<h2>AWS AI/ML Services Overview</h2>
<p>AWS offers AI/ML a large number of services across three tiers. Here's a breakdown of the key services available at each level.</p>
<hr>

<h2>AI Services</h2>
<p>Pre-built models that work immediately. No ML knowledge required.</p>
<table class="ws-table-all">
  ...
  <tr>
    ...
    <td>Extract insights from text (sentiment, key phrases, language)</td>
  </tr>
  <tr>
    <td><strong>Amazon Polly</strong></td>
    <td>Convert text to lifelike speech in multiple languages</td>
  </tr>
  <tr>
    <td><strong>Amazon Transcribe</strong></td>
    <td>Convert speech to text with speaker identification</td>
  </tr>
  <tr>
    <td><strong>Amazon Translate</strong></td>
    <td>Translate text between languages in real-time</td>
  </tr>
  <tr>
    <td><strong>Amazon Kendra</strong></td>
    <td>Intelligent search that understands natural language</td>
  </tr>
  <tr>
    <td><strong>Amazon Rekognition</strong></td>
    <td>Analyze images and videos (objects, faces, text, scenes)</td>
  </tr>
  <tr>
    <td><strong>Amazon Textract</strong></td>
    <td>Extract text from documents, forms, and tables</td>
  </tr>
  <tr>
    <td><strong>Amazon Lex</strong></td>
    <td>Build chatbots with voice and text interfaces</td>
  </tr>
  <tr>
    <td><strong>Amazon Personalize</strong></td>
    <td>Create personalized recommendations from historical data</td>
  </tr>
</table>
<hr>
...
<h2>ML Services</h2>
<p>Build, train, and deploy your own ML models. AWS manages the infrastructure.</p>
...
<table class="ws-table-all">
  ...
  <tr>
    ...
    <td>Full ML platform with IDE for data scientists, no-code interface for business analysts, managed infrastructure, and automated MLOps workflows</td>
  </tr>
</table>
<hr>

<h2>ML Frameworks and Infrastructure</h2>
<p>Full control to build custom models from scratch. Requires ML expertise.</p>
...
<table class="ws-table-all">
  ...
  <tr>
    ...
    <td>Pre-built libraries (PyTorch, TensorFlow) for building custom models</td>
  </tr>
  <tr>
    <td><strong>ML Infrastructure</strong></td>
    <td>ML-optimized compute instances (EC2, EMR, ECS) for training and inference</td>
  </tr>
</table>
<hr>
