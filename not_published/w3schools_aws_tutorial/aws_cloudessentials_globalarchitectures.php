...
<head>
  <title>AWS Global Architectures</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Global Architectures</h1>

<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_awsglobalnetworking.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_storageanddatabases_introduction.php">Next &#10095;</a>
</div>
<hr>

<h2>Global Architectures</h2>
<p>AWS enables you to build applications that span multiple regions and data centers. Here are two common global architecture patterns:</p>
<ul>
  <li><strong>Direct Connect Failover:</strong> High-bandwidth dedicated connections with fault tolerance</li>
  <li><strong>Multi-Region Content Delivery:</strong> Global content distribution using CloudFront and Route 53</li>
</ul>
<hr>

<h2>Global Architectures Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M05_L06_30_CloudInRealLifeGlobalArchitectures_v02_FINAL.mp4" type="video/mp4">
...
<h3>Direct Connect Failover</h3>
<p>Use this pattern when you need high bandwidth dedicated connections for large data transfers and critical applications.</p>
<img src="images/aws-global-architectures-direct-connect.png" alt="AWS Direct Connect architecture with failover" style="width:100%;max-width:700px;">
<p class="w3-small">Image created by Amazon Web Services</p>
<ol>
  <li><strong>Customer network:</strong> Clients and servers requiring secure, high-bandwidth connections</li>
  <li><strong>Router/firewall:</strong> Connects customer network to Direct Connect</li>
  <li><strong>Multiple connections:</strong> Provides fault tolerance and increased bandwidth</li>
  <li><strong>Virtual private gateway:</strong> Routes traffic securely to VPC resources</li>
</ol>
<hr>

<h3>Multi-Region Content Delivery</h3>
<p>Use this pattern to deliver content globally with low latency using CloudFront and Route 53.</p>
<img src="images/aws-global-architectures-cloudfront-route53.png" alt="CloudFront and Route 53 multi-region architecture" style="width:100%;max-width:700px;">
<p class="w3-small">Image created by Amazon Web Services</p>
<ol>
  <li><strong>Users:</strong> Access website via custom domain; request goes to Route 53</li>
  <li><strong>Routing policy:</strong> Route 53 determines closest Region and edge location</li>
  <li><strong>Edge locations:</strong> CloudFront serves cached content from nearest location</li>
  <li><strong>Origin servers:</strong> Content fetched from origin across multiple AZs for high availability</li>
</ol>
<hr>
