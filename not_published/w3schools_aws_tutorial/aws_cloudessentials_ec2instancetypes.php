...
<head>
  <title>AWS Cloud EC2 Instance Types</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>AWS Cloud EC2 Instance Types</h1>


<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_ec2intro.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_ec2pricing.php">Next &#10095;</a>
</div>
<hr>

<h2>EC2 Instance Types</h2>
<p>EC2 offers different instance types optimized for different use cases. Each provides a specific combination of CPU, memory, storage, and networking.</p>
<p>When selecting, consider the following: Does my application need more processing power, memory, or fast storage?</p>
<hr>

<h2>EC2 Instance Types Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M02_L02_10_ALittleMoreAboutAmazonEC2_v02_FINAL.mp4" type="video/mp4">
...
<h2>Instance Type Categories</h2>

<h3>General Purpose</h3>
<p>Balances compute, memory, and networking. Best for varied workloads or when requirements are uncertain.</p>
<p>Use cases: web servers, code repositories, application servers, small/medium databases.</p>

<h3>Compute Optimized</h3>
<p>High-performance processors for compute-intensive tasks.</p>
<p>Use cases: gaming servers, high-performance computing (HPC), scientific modeling.</p>

<h3>Memory Optimized</h3>
<p>Fast processing of large datasets in memory.</p>
<p>Use cases: real-time analytics, high-performance databases, in-memory caching.</p>
<hr>
<style>
.certtext {
  width:100%;
...
<p>Uses hardware accelerators (GPUs) to boost data processing.</p>
<p>Use cases: graphics processing, machine learning, floating-point calculations.</p>

<h3>Storage Optimized</h3>
<p>High sequential read/write access to large datasets on local storage.</p>
<p>Use cases: data warehouses, distributed file systems, online transaction systems.</p>
<hr>

<div>
    <h2>AWS Cloud Exercises</h2>
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_ec2intro2" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>Which instaces are best used when you have compute-intensive needs?</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">The best used instances for this need are: <input name="ex1" maxlength="7" style="width: 90px;"> Optimized Instances</pre>
        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_ec2intro2">Start the Exercise</a></p>
      </div>
    </form>
  </div>
