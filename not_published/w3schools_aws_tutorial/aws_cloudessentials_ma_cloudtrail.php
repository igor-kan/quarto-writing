...
<a class="w3-left w3-btn" href="aws_cloudessentials_ma_cloudwatch.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_ma_compliance.php">Next &#10095;</a>
</div>
<hr>

<h2>AWS CloudTrail</h2>
<p>CloudTrail tracks user activity and API usage across AWS, on-premises, and other cloud providers. It provides a detailed history of API calls so you can track changes, identify who made them, and when.</p>
<p>Use CloudTrail for auditing, security monitoring, troubleshooting, and proving compliance.</p>
<hr>

<h2>AWS CloudTrail Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M10_L03_15_AmazonCloudTrail_v02_FINAL.mp4" type="video/mp4">
...
<h2>CloudTrail Features</h2>

<h3>Events</h3>
<p>Captures details about actions in your AWS account, such as API calls, console actions, and other activities. Event history provides a viewable, searchable, and immutable record of the past 90 days at no charge.</p>

<h3>Logs</h3>
<p>Delivers event log files to your S3 bucket for long-term storage. Securely stored logs can prove compliance with regulations like PCI and HIPAA.</p>

<h3>Insights</h3>
<p>Analyzes your normal patterns of API call volume and error rates. Generates alerts when activity deviates from normal patterns, helping detect anomalous behavior and unusual activity. <a href="https://docs.aws.amazon.com/awscloudtrail/latest/userguide/logging-insights-events-with-cloudtrail.html" target="_blank">Learn more</a></p>

  <div>
    <h2>AWS Cloud Exercises</h2>
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_ma_intro2" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>Fill in the blank</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">CloudTrail logs actions on your account as a <input name="ex1" maxlength="5" style="width: 80px;"></pre>
        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_ma_intro2">Start the Exercise</a></p>
      </div>
    </form>
  </div>
