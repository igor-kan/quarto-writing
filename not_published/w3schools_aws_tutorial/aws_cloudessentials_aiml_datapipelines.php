...
<head>
  <title>AWS Data Pipelines</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Data Pipelines on AWS</h1>

<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_aiml_dataanalytics_intro.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_sec_securityintroduction.php">Next &#10095;</a>
</div>
<hr>

<h2>Data Pipelines on AWS</h2>
<p>AWS provides services for each stage of data pipeline: ingestion, storage, cataloging, processing, and analysis. These services integrate together to build complete data workflows.</p>
<hr>

<h2>Data Pipelines on AWS Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M08_L08_25_UsingDataPipelinesOnAWS_v01_FINAL.mp4" type="video/mp4">
...
<p>Collect data and move it to storage. Use real-time when you need data immediately, batch when a small delay is acceptable.</p>
...
<table class="ws-table-all">
  ...
  <tr>
    ...
    <td>Collects large amounts of data in real-time from apps, devices, and sensors. Serverless and scales automatically.</td>
  </tr>
  <tr>
    <td><strong>Amazon Data Firehose</strong></td>
    <td>Collects data in near real-time (seconds). Fully managed - delivers data to storage automatically.</td>
  </tr>
</table>
<hr>

<h2>Data Storage</h2>
<p>Centralize data from multiple sources for analysis.</p>
...
<table class="ws-table-all">
  ...
  <tr>
    ...
    <td>Object storage for data lakes. Stores any amount of data (structured or unstructured). Scales automatically.</td>
  </tr>
  <tr>
    <td><strong>Amazon Redshift</strong></td>
    <td>Data warehouse for structured data. Stores petabytes of data with pay-as-you-go pricing.</td>
  </tr>
</table>
<hr>

<h2>Data Cataloging</h2>
<p>Organize and find your data across services.</p>
...
<table class="ws-table-all">
  ...
  <tr>
    ...
    <td>Central place to store information about your data. Makes it easy to find and use data across services.</td>
  </tr>
</table>
<hr>
...
<p>Clean and transform data for analysis.</p>
...
<table class="ws-table-all">
  ...
  <tr>
    ...
    <td>ETL service (Extract, Transform, Load). Prepares data for analysis. Works with the Glue Data Catalog.</td>
  </tr>
  <tr>
    <td><strong>Amazon EMR</strong></td>
    <td>Large-scale data processing. Supports Spark, Hadoop, and Hive. AWS manages the infrastructure.</td>
  </tr>
</table>
<hr>

<h2>Analysis and Visualization</h2>
<p>Query data and create visual insights.</p>
...
<table class="ws-table-all">
  ...
  <tr>
    ...
    <td>Run SQL queries on data in S3. Serverless - pay only for queries you run.</td>
  </tr>
  <tr>
    <td><strong>Amazon Redshift</strong></td>
    <td>Fast SQL queries on large datasets. Best for frequent, complex analytics.</td>
  </tr>
  <tr>
    <td><strong>Amazon QuickSight</strong></td>
    <td>Create dashboards and reports. Amazon Q lets you ask questions in plain English.</td>
  </tr>
  <tr>
    <td><strong>Amazon OpenSearch Service</strong></td>
    <td>Search your data with keywords or natural language. Real-time dashboards.</td>
  </tr>
</table>
<hr>
