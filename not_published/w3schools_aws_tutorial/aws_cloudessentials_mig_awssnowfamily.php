...
<head>
  <title>Transferring Data Offline</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Transferring Data Offline</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_mig_datatransferonline.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_clo_thecloudjourney.php">Next &#10095;</a>
</div>
<hr>

<h2>Offline Data Transfer</h2>
<p>Online migrations work for most customers, but some need to transfer data offline. This includes situations where bandwidth is limited, remote locations lack internet access, or when transferring petabytes of data would be faster with a physical device than over the network.</p>
<hr>

<h2>AWS Snowball Edge Storage Optimized Devices</h2>
<p>AWS Snowball Edge Storage Optimized devices are a great solution for offline data migration where connecting to the internet might not be an option.</p>
<p>These devices deliver high performance NVMe storage, making it possible to simplify multi-petabyte data migrations from on-premises locations to AWS.</p>
...
<h2>AWS Snow Family Devices</h2>
<p>AWS Snow Family is a group of physical devices that transport data in and out of AWS, capable of transferring up to exabytes of data.</p>

<h3>Device Types</h3>
<table class="ws-table-all w3-border w3-bordered w3-hoverable">
    <thead>
      <tr>
        <th class="w3-border-right">Snowball Edge Storage Optimized</th>
        <th>Snowball Edge Compute Optimized</th>
      </tr>
    </thead>
    <tbody>
    <tr>
      <td class="w3-border-right">Great for large-scale data migrations</td>
      <td>Great for services that require a large amount of computing resources</td>
    </tr>
    <tr>
      <td class="w3-border-right">80 TB of HDD storage space for object storage</td>
      <td>42 TB of HDD storage for object storage</td>
    </tr>
  </tbody>
</table>
<hr>
...
<div>
    ...
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_mig_migrationandinnovationintroduction4" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>Fill in the blank</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">AWS Snow Family devices can transfer up to <input name="ex1" maxlength="8" style="width: 110px;"> of data</pre>
        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_mig_migrationandinnovationintroduction4">Start the Exercise</a></p>
      </div>
    </form>
  </div>
