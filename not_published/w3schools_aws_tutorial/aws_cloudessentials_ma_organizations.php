...
<a class="w3-left w3-btn" href="aws_cloudessentials_ma_auditing.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_ma_governance.php">Next &#10095;</a>
</div>
<hr>

<h2>AWS Organizations</h2>
<p>As companies grow, managing multiple AWS accounts becomes challenging. AWS Organizations helps you centrally manage and govern your environment, automate account creation, and apply policies across groups of accounts.</p>
<hr>

<h2>AWS Organizations Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M10_L06_30_AWSOrganizations_v03_FINAL.mp4" type="video/mp4">
...
<ul>
  <li>Quickly scale by programmatically creating new AWS accounts</li>
  <li>Simplify permission management through Service Control Policies (SCPs)</li>
  <li>Manage and optimize costs across accounts</li>
  <li>Provide tools and access for security teams</li>
  <li>Share common resources across accounts</li>
</ul>
<hr>

<h2>Key Concepts</h2>
<img src="images/aws-organizations-hierarchy.png" alt="AWS Organizations Hierarchy" style="max-width:700px;width:100%">
<p>An organization is a collection of AWS accounts organized into a hierarchical tree structure with a root at the top and organizational units (OUs) nested under the root. Each account can be placed directly in the root or within an OU.</p>

<h3>Management Account</h3>
<p>The central AWS account that creates and manages the organization. When you create an organization, it automatically creates a root as the parent container for all accounts. The management account is responsible for overall control and governance.</p>

<h3>Organizational Unit (OU)</h3>
<p>A logical grouping of accounts within an AWS Organization. OUs can contain member accounts or nested OUs, allowing you to create a hierarchy that matches your business structure.</p>

<h3>Service Control Policies (SCP)</h3>
<p>Policies that restrict which AWS services, resources, and API actions users and roles in each account can access. SCPs can be applied to OUs or individual member accounts.</p>

<h3>Member Account</h3>
<p>Accounts that belong to the organization. They can be placed under an OU or directly under the root. Even accounts not in an OU benefit from features like consolidated billing.</p>
<hr>

<p>When designing your organization, consider the business, security, and regulatory needs of each department to decide how to group them into OUs. Learn more in the <a href="https://docs.aws.amazon.com/organizations/latest/userguide/orgs_introduction.html" target="_blank">AWS Organizations User Guide</a>.</p>
