...
ny:-->
    ...
    <h1>AWS Cloud Intro</h1>


<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="index.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_awscert.php">Next &#10095;</a>
</div>
<hr>

<h2>What is AWS Cloud?</h2>
<p>AWS (Amazon Web Services) is the world's most widely adopted cloud computing platform, providing online access to computing resources, storage, databases, and other IT services.</p>
<p>Launched in 2006 with Simple Storage Service (S3), AWS pioneered the cloud industry and now offers hundreds of services covering compute, storage, databases, machine learning, and more.</p>
<hr>

  <h2>Introduction to AWS Video</h2>
  <video width="100%" style="max-width:800px" controls>
    <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M01_L01_05_IntroductionToAWS_v02_FINAL.mp4" type="video/mp4">
