...
<head>
  <title>Transferring Data Online</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Transferring Data Online</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_mig_databasemigrations.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_mig_awssnowfamily.php">Next &#10095;</a>
</div>
<hr>

<h2>Online Data Transfer</h2>
<p>Beyond database migrations with AWS Database Migration Service (AWS DMS), several AWS services help transfer other types of data and files to the cloud over the network.</p>
<hr>

<h2>Considerations for Data Migration</h2>
<p>When you migrate data to the AWS Cloud, there are a few considerations to keep in mind:</p>
<ul>
  <li><strong>Security:</strong> Will it get there safely?</li>
  <li><strong>Data validation:</strong> Will it get there in one piece?</li>
  <li><strong>Scheduling:</strong> When is the best time?</li>
  <li><strong>Bandwidth requirements:</strong> Do you have enough?</li>
</ul>
<p>For the majority of data migration workloads, AWS DataSync will do the job.</p>
<hr>

<h2>AWS DataSync</h2>
<p>AWS DataSync is specifically designed for automating and accelerating data transfer.</p>
<p>DataSync simplifies and accelerates moving large amounts of data between on-premises storage and AWS storage services like Amazon S3.</p>
<p>It automates many aspects of the transfer process, including running instances, encryption, and network optimization.</p>

<hr>

<h2>AWS Transfer Family</h2>
<p>The AWS Transfer Family makes it possible to seamlessly manage and share data with simple, secure, and scalable file transfers.</p>
<p>This service provides fully managed support for secure file transfers over FTP, Secure File Transfer Protocol (SFTP), File Transfer Protocol Secure (FTPS), and other protocols.</p>
<p>It helps you transfer files directly into and out of AWS storage services like Amazon S3 and Amazon EFS.</p>
...
<p>AWS Direct Connect establishes a dedicated private connection between your network and your VPC in the AWS Cloud. Because it bypasses the public internet, it provides a fast, reliable, and secure way to transfer large amounts of data.</p>
