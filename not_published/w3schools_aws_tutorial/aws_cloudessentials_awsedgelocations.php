...
<head>
  <title>AWS Cloud Edge Locations</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>AWS Cloud Edge Locations</h1>


<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_awsavailabilityzones.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_awsprovision.php">Next &#10095;</a>
</div>
<hr>

<h2>What are AWS Edge Locations?</h2>
<p>AWS Edge Locations are strategically placed sites around the world that cache content to deliver data with lower latency. They are smaller facilities outside of standard Regions, positioned closer to end users.</p>
<hr>

<h2>Edge Location Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M04_L02_15_DivingDeeperIntoGlobalInfrastructure_v01_FINAL.mp4" type="video/mp4">
...
<p>Edge Locations use Amazon CloudFront, a content delivery network (CDN), that stores cached copies of your content at locations closer to your users. This results in faster loading times and a better user experience.</p>

<h3>CloudFront Use Cases</h3>
<ul>
  <li><strong>Streaming video:</strong> Videos play smoothly without buffering, even during peak times</li>
  <li><strong>Ecommerce:</strong> Product images and pages load quickly during busy shopping seasons</li>
  <li><strong>Mobile apps:</strong> Map data and images delivered quickly for responsive experiences</li>
</ul>
<hr>

<h2>Caching - How AWS Edge Locations Work</h2>
<p>Caching stores copies of frequently accessed data closer to users, reducing the need to fetch data from the origin server every time.</p>
<ol>
  <li>A user requests content (e.g., an image or video)</li>
  <li>If not cached, the content is fetched from the origin and stored at the Edge Location</li>
  <li>Future requests for the same content are served from the nearest Edge Location</li>
</ol>
<p>Content is delivered faster because it comes from the Edge Location nearest to the user, not the origin server.</p>
<hr>


<div>
    <h2>AWS Cloud Exercises</h2>
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_awsinfrastructure4" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>What is an Edge Location?</p>
        <div class="exerciseprecontainer">
        <pre style="overflow: auto;">An Edge Location is the site <input name="ex1" maxlength="7" style="width: 60px;"> your users.</pre>
        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_awsinfrastructure4">Start the Exercise</a></p>
      </div>
    </form>
  </div>
