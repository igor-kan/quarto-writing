...
<head>
  <title>Introduction to Well-Architected Solutions</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Introduction to Well-Architected Solutions</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_mig_awssnowfamily.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_clo_awswellarchitectedframework.php">Next &#10095;</a>
</div>
<hr>

<h2>Well-Architected Solutions</h2>
<p>Building reliable, secure, and efficient cloud applications requires more than just knowing AWS services. AWS provides the Well-Architected Framework to help you design and operate systems using best practices.</p>
<hr>

<h2>Introduction Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M13_L01_05_IntroToSpecializedServicesAndWell-ArchitectedSolutions_v010.mp4" type="video/mp4">
