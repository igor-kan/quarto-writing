...
<a class="w3-left w3-btn" href="aws_cloudessentials_comparingamazonebsandamazons3.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_amazonrds.php">Next &#10095;</a>
</div>
<hr>

<h2>AWS Database Services</h2>
<p>AWS offers database services for different needs: relational databases for structured data, NoSQL for flexible schemas, and specialized services for analytics and migration.</p>
<hr>

<h2>Database Types</h2>

<h3>Relational (SQL)</h3>
<p>Relational databases have data stored in tables with rows and columns, linked by relationships.</p>
<p>Examples of relational database services:</p>
<ul>
  <li><strong>Amazon RDS:</strong> Managed MySQL, PostgreSQL, MariaDB, Oracle, SQL Server</li>
  <li><strong>Amazon Aurora:</strong> High-performance MySQL/PostgreSQL-compatible</li>
</ul>

<h3>NoSQL</h3>
<p>NoSQL databases have data stored in flexible schemas, horizontal scaling for high throughput.</p>
<p>Examples of NoSQL database services:</p>
<ul>
  <li><strong>Amazon DynamoDB:</strong> Key-value and document database</li>
</ul>

<h3>Analytics & Migration</h3>
<p>Examples of analytics and migration services:</p>
<ul>
  <li><strong>Amazon Redshift:</strong> Data warehouse for analytics</li>
  <li><strong>AWS DMS:</strong> Database migration with minimal downtime</li>
</ul>
<hr>
