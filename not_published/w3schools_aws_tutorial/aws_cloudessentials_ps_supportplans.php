...
<a class="w3-left w3-btn" href="aws_cloudessentials_ps_billingservices.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_ps_marketplace.php">Next &#10095;</a>
</div>
<hr>

<h2>Types of AWS Support</h2>
<p>AWS offers a range of support plans tailored to meet the needs of different customers, from those just getting started to large enterprises with complex requirements.</p>
<p>Each plan builds onto the previous one, adding more advanced tools, personalized support, and faster response times.</p>
<hr>

<h2>AWS Support Plans Video</h2>
  <video width="100%" style="max-width:800px" controls>
    <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M11_L07_45_AWSSupportPlans_v01_FINAL0.mp4" type="video/mp4">
...
<h2>Basic Support</h2>
<p><strong>Included for all AWS customers</strong></p>
<ul>
  <li>Access to documentation, whitepapers, and AWS re:Post</li>
  <li>Core AWS Trusted Advisor checks</li>
  <li>Technical Account Management not included</li>
</ul>
<hr>

<h2>Developer Support</h2>
<p><strong>Recommended for experimenting or testing in AWS</strong></p>
<ul>
  <li>Response times: &lt; 24 hours for general guidance, &lt; 12 hours when systems impaired</li>
  <li>Best practice guidance</li>
  <li>Client-side diagnostic tools</li>
  <li>Building-block architecture support</li>
</ul>
<hr>

<h2>Business Support</h2>
<p><strong>Recommended minimum tier for production workloads in AWS</strong></p>
<ul>
  <li>Response times include: &lt; 4 hours when production system impaired, &lt; 1 hour when production system is down</li>
  <li>Full set of AWS Trusted Advisor checks</li>
  <li>Use-case guidance</li>
  <li>Limited support for third-party software</li>
</ul>
<hr>
...
<h2>Enterprise On-Ramp Support</h2>
<p><strong>Recommended for production and business critical workloads in AWS</strong></p>
<ul>
  <li>Response times: &lt; 30 minutes when business-critical system is down</li>
  <li>Full set of AWS Trusted Advisor checks</li>
  <li>A pool of technical account managers (TAMs) provide proactive guidance</li>
</ul>
<hr>

<h2>Enterprise Support</h2>
<p><strong>Recommended for business critical and mission critical workloads in AWS</strong></p>
<ul>
  <li>Response times: &lt; 15 minutes when business- or mission-critical system is down</li>
  <li>Full set of AWS Trusted Advisor checks and prioritized recommendations</li>
  <li>A designated TAM provides consultative architectural and operational guidance</li>
</ul>
<hr>

<h2>Technical Account Manager (TAM)</h2>
<p>A TAM is included with the Enterprise On-Ramp and Enterprise Support plans.</p>
<p>The TAM serves as your primary AWS contact, offering expert guidance on:</p>
<ul>
  <li>Using AWS services</li>
  <li>Optimizing architectures</li>
  <li>Managing costs</li>
  <li>Connecting you with AWS programs and experts</li>
</ul>
<hr>

<p>Read more about Support Plans at: <a href="https://aws.amazon.com/premiumsupport/plans/" target="_blank">AWS Support Plans Product Page</a></p>
<hr>

<div>
    <h2>AWS Cloud Exercises</h2>
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_ps_intro7" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>Fill in the missing Support Plans</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">1. <input name="ex1" maxlength="5" style="width: 80px;"></pre>
          <pre style="overflow: auto;">2. Developer</pre>
          <pre style="overflow: auto;">3. <input name="ex2" maxlength="8" style="width: 100px;"></pre>
          <pre style="overflow: auto;">4. Enterprise</pre>
        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_ps_intro7">Start the Exercise</a></p>
      </div>
    </form>
  </div>
