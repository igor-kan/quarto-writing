...
<head>
  <title>AWS Cloud Practitioner Wrap Up</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>AWS Cloud Practitioner Wrap Up</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_clo_specializedusecases.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_examprep.php">Next &#10095;</a>
</div>
<hr>

<h2>AWS Cloud Practitioner Wrap Up</h2>
<p>Join Morgan, Alan, and Rudy for some final thoughts and encouragement as you prepare for the AWS Cloud Practitioner certification exam.</p>
<hr>

<h2>Wrap Up Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M13_L05_05_Module13Conclusion_v01_FINAL0.mp4" type="video/mp4">
