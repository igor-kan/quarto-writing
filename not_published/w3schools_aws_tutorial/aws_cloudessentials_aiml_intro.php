...
<head>
  <title>AWS AI and Machine Learning Introduction</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>AWS AI and Machine Learning</h1>

<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_additionaldatabaseservices.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_aiml_onaws.php">Next &#10095;</a>
</div>
<hr>

<h2>What is AI and Machine Learning?</h2>
<p>Artificial Intelligence (AI) enables computers to perform tasks that typically require human intelligence, while Machine Learning (ML) trains systems to learn from data and improve over time.</p>
<p>From e-commerce to medical research, organizations use AI and ML to analyze data and innovate. AWS AI/ML solutions help you predict trends, automate processes, and derive actionable insights.</p>
<hr>

<h2>Introduction to AI and ML Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M08_L01_05_IntroToAIandMachineLearning_v01_FINAL.mp4" type="video/mp4">
...
<p>A broad field focused on developing intelligent systems capable of performing humanlike tasks such as reasoning, learning, and problem-solving.</p>

<h3>Machine Learning (ML)</h3>
<p>A subset of AI that trains machines to perform complex tasks without explicit instructions. ML finds patterns in historical data to produce a model that makes predictions on new data.</p>
<hr>
