...
ny:-->
    ...
    <h1>Shared Responsibility Model</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_sec_securityintroduction.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_sec_userpermissionsandaccess.php">Next &#10095;</a>
</div>
<hr>

<h2>What is the Shared Responsibility Model?</h2>
<p>The shared responsibility model divides security duties between AWS and you (the customer). AWS is responsible for security <strong>of</strong> the cloud, while you are responsible for security <strong>in</strong> the cloud.</p>
<p>Think of it this way: AWS secures the building, you secure what's inside your apartment.</p>
<hr>

<h2>Shared Responsibility Model Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M01_L05_35_TheAWSSharedResponsibilityModel_v01_FINAL.mp4" type="video/mp4">
...
<h3>AWS: Security OF the Cloud</h3>
<p>AWS protects the infrastructure running all services:</p>
<ul>
  <li><strong>Physical:</strong> Data centers, hardware, networking equipment</li>
  <li><strong>Global infrastructure:</strong> Regions, Availability Zones, Edge locations</li>
  <li><strong>Core services:</strong> Compute, storage, database, networking</li>
  <li><strong>Software:</strong> Virtualization and underlying software</li>
</ul>
<hr>
...
<h3>You: Security IN the Cloud</h3>
<p>You are responsible for everything you put in AWS:</p>
<ul>
  <li><strong>Your data:</strong> What you store and how you encrypt it</li>
  <li><strong>Access control:</strong> Who can access your resources</li>
  <li><strong>Configuration:</strong> Operating system, network, and firewall settings</li>
  <li><strong>Applications:</strong> The software you run and how you secure it</li>
</ul>
  <hr>

  <div>
    <h2>AWS Cloud Exercises</h2>
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_sec_securityintroduction1" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>Fill in the blank</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">Shared responsibility is about security being a <input name="ex1" maxlength="6" style="width: 90px;"> responsibility</pre>
        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_sec_securityintroduction1">Start the Exercise</a></p>
      </div>
    </form>
  </div>
