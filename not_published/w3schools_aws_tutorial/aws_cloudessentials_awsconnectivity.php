...
<head>
  <title>AWS Cloud Connectivity</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>AWS Cloud Connectivity</h1>


<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_awsnetworking.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_awssubnetandaccess.php">Next &#10095;</a>
</div>
<hr>

<h2>AWS Connectivity</h2>
<p>AWS provides several ways to connect to your cloud resources, from public internet access to dedicated private connections.</p>
<hr>

<h2>AWS Connectivity Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M05_L02_10_ConnectivityToAWS_v02_FINAL.mp4" type="video/mp4">
...
<p>An Amazon Virtual Private Cloud (VPC) lets you isolate your AWS resources in a private network you define. You control which sections of the AWS Cloud to include and how to restrict network traffic.</p>
<p>Resources within a VPC can be organized into subnets, which are sections that contain specific resources.</p>
<hr>

<h3>Internet Gateway</h3>
<p>An Internet Gateway connects your VPC to the public internet. Without it, resources in your VPC cannot be accessed from the internet.</p>
<img src="images/internetgateway.png" loading="lazy" alt="client sending traffic to VPC trough an internet gateway" style="width:700px;max-width:100%;">
...
<p>A Virtual Private Gateway creates an encrypted VPN connection between your private network and your VPC. It only allows traffic from approved networks, keeping your data secure.</p>
<img src="images/virtualprivategateway.png" loading="lazy" alt="protected traffic through VPN and Virtual Private Gateway" style="width:700px;max-width:100%;">
<p class="w3-small">Image created by Amazon Web Services</p>
<hr>

<h3>AWS Direct Connect</h3>
<p>Direct Connect provides a dedicated private connection between your data center and AWS. Unlike shared internet connections, this link is exclusively yours, providing consistent performance and enhanced security.</p>
<img src="images/directconnect.png" loading="lazy" alt="protected traffic through VPN and Virtual Private Gateway" style="width:700px;max-width:100%;">
<p class="w3-small">Image created by Amazon Web Services</p>
<hr>

<div>
    <h2>AWS Cloud Exercises</h2>
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_awsnetworking1" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>What is VPC short for?</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">VPC is short for Virtual <input name="ex1" maxlength="7" style="width: 90px;"> Cloud</pre>
        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_awsnetworking1">Start the Exercise</a></p>
      </div>
    </form>
  </div>
