...
<head>
  <title>AWS Instance Stores</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>AWS Instance Stores</h1>

<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_storageanddatabases_introduction.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_awsebs.php">Next &#10095;</a>
</div>
<hr>

<h2>What are Instance Stores?</h2>
<p>An Instance Store is block-level storage physically attached to the EC2 instance host computer. Data persists during reboots but is lost when the instance is stopped or terminated.</p>
<p><strong>Best for:</strong> Temporary storage needs like buffers, caches, and scratch data. Not recommended for data that needs to persist.</p>
<hr>

<h2>Instance Stores Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M06_L02_10_InstanceStoresAndAmazonElasticBlockStore_v01_FINAL.mp4" type="video/mp4">
...
<h2>Benefits of Instance Stores</h2>
<ul>
  <li><strong>Is included free:</strong> Comes attached to many EC2 instance types at no additional cost</li>
  <li><strong>Has high performance:</strong> Extremely low-latency storage directly attached to the host server</li>
</ul>
<hr>

<h2>Data Lifecycle of Instance Stores</h2>
<h4>When an EC2 instance with an attached instance store is running (or reboots) the data is stored on the instance store:</h4>
<img src="images/ec2_instance_with_attached_instance_store.jpg" style="width:400px;max-width:100%;" loading="lazy" alt="Image of an Amazon EC2 instance with a running attached instance store">
<p class="w3-small">Image created by Amazon Web Services</p>

<hr>
<h4>When the instance is stopped or terminated, all data on the instance store is deleted:</h4>
<div style="display:flex;flex-wrap:wrap;gap:20px;align-items:center;">
  <div>
    <img src="images/ec2_instance_stopped_or_terminated.jpg" style="width:400px;max-width:100%;" loading="lazy" alt="Image of an Amazon EC2 instance when it is stopped or terminated">
  </div>
  <div style="font-size:2em;">→</div>
  <div>
    <img src="images/data_on_ec2_instance_deleted.jpg" style="width:400px;max-width:100%;" loading="lazy" alt="Image of deleted data on the instance store">
  </div>
</div>
<p class="w3-small">Images created by Amazon Web Services</p>
<hr>
...
<div>
    ...
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_storageanddatabases_introduction1" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>Fill in the blank</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">Instance Stores provides <input name="ex1" maxlength="9" style="width: 115px;"> storage for Amazon EC2 instance</pre>
        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_storageanddatabases_introduction1">Start the Exercise</a></p>
      </div>
    </form>
  </div>
