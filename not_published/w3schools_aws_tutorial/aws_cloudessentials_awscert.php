...
ny:-->
    ...
    <h1>AWS Cloud Practitioner Certification</h1>


<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_intro.php">&#10094; Previous</a> 
<a class="w3-right w3-btn" href="aws_cloudessentials_getstarted.php">Next &#10095;</a>
</div>
<hr>
...
<div class="w3-row" style="width:100%;padding:60px 30px;background-color:#282A35;border-radius:5px;">
  ...
  <div class="w3-container w3-cell w3-mobile">
    ...
    <p style="font-size: 18px;font-family: 'Source Sans Pro', sans-serif;color: #FFF;">The certificate is for you who want to boost your skills and add credentials to your CV.</p>
  </div>
</div>
<hr>
...
<h2>Get a Certificate</h2>
  ...
  <img src="images/awscert.png" alt="AWS Certified Cloud Practitioner Badge" height="250" width="auto" style="margin:50px auto;">
  </div>
</div>
</div>
<hr>
...
<ul>
  ...
  <li>Prepare for the exam by completing the AWS Cloud Tutorial</li>
  <li>Study at your own speed</li>
  <li>Take the AWS Certified Cloud Practitioner exam</li>
  <li>Explore your options for what to do next!</li>
</ul>
<hr>
