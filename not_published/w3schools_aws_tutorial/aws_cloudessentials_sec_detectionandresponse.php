...
<head>
  <title>Detection and Response Services</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Detection and Response Services</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_sec_dataprotection.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_ma_intro.php">Next &#10095;</a>
</div>
<hr>

<h2>Detection and Response on AWS</h2>
<p>Detection finds security threats. Response is how you investigate and fix them. AWS provides integrated services that find vulnerabilities, detect threats, investigate issues, and centralize security management.</p>
<hr>

<h2>Detection and Incident Response Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M09_L05_30_DetectionAndIncidentResponse_v01_FINAL.mp4" type="video/mp4">
...
<h2>Detection and Response Services</h2>
<table class="ws-table-all">
  ...
  <tr>
    ...
    <td>Scans EC2, containers, and Lambda for vulnerabilities. Gives recommendations for fixes.</td>
  </tr>
  <tr>
    <td><strong>Amazon GuardDuty</strong></td>
    <td>Detects threats using ML. Monitors network activity and known malicious IPs.</td>
  </tr>
  <tr>
    <td><strong>Amazon Detective</strong></td>
    <td>Investigate threats after detection. Visualizations help find the root cause.</td>
  </tr>
  <tr>
    <td><strong>AWS Security Hub</strong></td>
    <td>Central dashboard for all security findings. Automates fixes.</td>
  </tr>
</table>
<hr>
...
<h2>Learn More</h2>
<ul>
  <li><a href="https://aws.amazon.com/products/security/" target="_blank">Security, Identity, and Compliance on AWS</a></li>
  <li><a href="https://aws.amazon.com/premiumsupport/knowledge-center/" target="_blank">AWS Knowledge Center</a></li>
...
<!-- <p class="adtext">Advertisement</p> -->
    ...
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_sec_securityintroduction8" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">

        <h2>Exercise:</h2>
        <p>What does Amazon GuardDuty monitor?</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">Amazon GuardDuty monitors <input name="ex1" maxlength="7" style="width: 100px;"> activity </pre>
        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_sec_securityintroduction8">Start the Exercise</a></p>
      </div>
    </form>
  </div>
