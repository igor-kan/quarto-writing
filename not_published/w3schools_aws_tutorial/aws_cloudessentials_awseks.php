...
<head>
  <title>Amazon EKS - Elastic Kubernetes Service</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Amazon EKS - Elastic Kubernetes Service</h1>
<div class="w3-clear nextprev">
    <a class="w3-left w3-btn" href="aws_cloudessentials_awsecs.php">&#10094; Previous</a>
    <a class="w3-right w3-btn" href="aws_cloudessentials_awsfargate.php">Next &#10095;</a>
</div>
<hr>

<h2>What is Amazon EKS?</h2>
<p>Amazon Elastic Kubernetes Service (EKS) is a fully managed service for running Kubernetes on AWS. It simplifies deploying, managing, and scaling containerized applications.</p>
<hr>

<h2>EKS Features</h2>

<h3>Kubernetes</h3>
<p>Kubernetes is open-source software for container orchestration with a large community providing ongoing support. AWS keeps EKS updated with the latest Kubernetes features.</p>

<h3>Launch Types</h3>
<ul>
  <li><strong>EKS with EC2:</strong> Full control over infrastructure for complex, large-scale workloads</li>
  <li><strong>EKS with Fargate:</strong> Kubernetes flexibility without managing servers</li>
</ul>

<p>Learn more: <a href="https://aws.amazon.com/eks/" target="_blank">Amazon EKS</a></p>
<hr>

<div>
    <h2>AWS Cloud Exercises</h2>
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_awseks1" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>AWS EKS is built for scaling with a service. What is the name of the service?</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">AWS EKS lets you run <input name="ex1" maxlength="10" style="width: 130px;"> on AWS</pre>
        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_awseks1">Start the Exercise</a></p>
      </div>
    </form>
  </div>
