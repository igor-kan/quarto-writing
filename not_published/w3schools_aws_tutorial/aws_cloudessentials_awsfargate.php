...
<a class="w3-left w3-btn" href="aws_cloudessentials_awseks.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_additionalcompute.php">Next &#10095;</a>
</div>
<hr>

<h2>What is AWS Fargate?</h2>
<p>AWS Fargate is a serverless compute engine for containers. No servers to provision or manage. Fargate handles the infrastructure so you can focus on developing your applications.</p>
<p>You pay only for the resources required to run your containers.</p>
<hr>

<h2>Fargate vs ECS/EKS</h2>
<p>Fargate is a container <strong>hosting platform</strong>, while <a href="aws_cloudessentials_awsecs.php">Amazon ECS</a> and <a href="aws_cloudessentials_awseks.php">Amazon EKS</a> are container <strong>orchestration services</strong>.</p>
<p>Fargate works with both ECS and EKS, providing the serverless compute layer while they handle orchestration.</p>
<hr>

<div>
    <h2>AWS Cloud Exercises</h2>
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_awsfargate1" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>What are one of the things that you do not have to think about when using Fargate?</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">Provision of <input name="ex1" maxlength="7" style="width: 90px;"></pre>
        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_awsfargate1">Start the Exercise</a></p>
      </div>
    </form>
  </div>
