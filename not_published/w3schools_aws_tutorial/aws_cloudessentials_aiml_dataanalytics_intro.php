...
<head>
  <title>AWS Data Analytics Introduction</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="aws_cloudessentials_aiml_genai_solutions.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_aiml_datapipelines.php">Next &#10095;</a>
</div>
<hr>

<h2>What is Data Analytics?</h2>
<p>Data Analytics is the process of extracting insights from data. AI/ML and data analytics both depend on clean, organized data. This section covers data pipelines (collecting and transforming data) and analytics (finding patterns and making decisions).</p>
<hr>

<h2>Introduction to Data Analytics Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M08_L07_20_IntroductionToDataAnalytics_v01_FINAL.mp4" type="video/mp4">
...
<h2>Data Pipelines and ETL</h2>
<p>Data must be in a format usable by analytics tools and AI algorithms. ETL (Extract, Transform, Load) processes handle this:</p>
<ol>
  <li><strong>Extract:</strong> Get data from various sources</li>
  <li><strong>Transform:</strong> Convert to a consistent, usable format</li>
  <li><strong>Load:</strong> Put into a destination system like a data warehouse</li>
</ol>
<p>Data pipelines automate ETL to make it efficient and repeatable. AWS provides integrated services for building custom pipelines.</p>
<hr>

<h2>Data Analytics Use Cases</h2>
<p>Analysts transform raw historical data to uncover insights and trends. Common applications include:</p>
<ul>
  <li>Loan companies explaining lending decisions</li>
  <li>Medical researchers analyzing clinical trial data</li>
  <li>Insurance companies creating transparent risk models for regulators</li>
</ul>
<hr>
