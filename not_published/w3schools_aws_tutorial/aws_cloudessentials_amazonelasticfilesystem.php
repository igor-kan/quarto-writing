...
ny:-->
    ...
    <h1>Amazon EFS - Elastic File System</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_amazonsimplestorageservice.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_comparingamazonebsandamazons3.php">Next &#10095;</a>
</div>
<hr>

<h2>What is Amazon EFS?</h2>
<p>Amazon EFS (Elastic File System) is a fully managed, scalable file storage service using the NFS protocol. It automatically scales to petabytes and allows multiple EC2 instances to access the same file system simultaneously.</p>
<hr>

<h2>Amazon EFS Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M06_L04_40_AmazonElasticFileSystem_v01_FINAL.mp4" type="video/mp4">
...
<h2>Amazon EFS Benefits</h2>
<ul>
  <li><strong>Multi-AZ redundancy:</strong> Replicates data across Availability Zones for high availability</li>
  <li><strong>Shared access:</strong> Thousands of concurrent NFS connections from multiple EC2 instances</li>
  <li><strong>Elastic storage:</strong> Grows and shrinks automatically - pay only for what you use</li>
</ul>
<hr>

<h2>Amazon EFS Features</h2>

<h3>Storage Classes</h3>
<ul>
  <li><strong>Standard:</strong> Multi-AZ resilience with highest durability and availability</li>
  <li><strong>One Zone:</strong> Single AZ storage at reduced cost</li>
  <li><strong>Archive:</strong> Lowest cost for rarely accessed data</li>
</ul>

<h3>Lifecycle Policies</h3>
<p>Automatically move data between storage classes based on access patterns:</p>
<ul>
  <li><strong>To Infrequent Access:</strong> Files not accessed for 30 days</li>
  <li><strong>To Archive:</strong> Files not accessed for 90 days</li>
  <li><strong>Back to Standard:</strong> Optionally restore when accessed</li>
</ul>
...
<div>
    ...
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_storageanddatabases_introduction8" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>Fill in the blanks</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">Scaling AWS EFS does not <input name="ex1" maxlength="7" style="width: 90px;"> applications</pre>
        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_storageanddatabases_introduction8">Start the Exercise</a></p>
      </div>
    </form>
  </div>
