...
<head>
  <title>AWS Cloud Networking</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>AWS Cloud Networking</h1>


<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_awscloudformation.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_awsconnectivity.php">Next &#10095;</a>
</div>
<hr>

<h2>Introduction to AWS Networking</h2>
<p>Networking refers to interconnected devices that exchange data and resources. In AWS, networking consists of the infrastructure and services that work together to host your applications and enable communication between them.</p>
<hr>

<h2>AWS Networking Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M05_L01_05_IntroductionToNetworking_v01_FINAL.mp4" type="video/mp4">
...
<p>How you connect your resources depends on your setup and requirements. The main building blocks are:</p>
<ul>
  <li><strong>Amazon VPC (Virtual Private Cloud):</strong> A logically isolated section of AWS where you launch resources in a virtual network you define.</li>
  <li><strong>Subnets:</strong> Sections of a VPC used to organize resources. Can be public (internet-facing) or private (internal only).</li>
</ul>
<hr>
