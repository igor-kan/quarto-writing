...
<head>
  <title>AWS Cloud Elastic Beanstalk</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>AWS Cloud Elastic Beanstalk</h1>

<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_awsprovisionservices.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_awscloudformation.php">Next &#10095;</a>
</div>
<hr>

<h2>AWS Elastic Beanstalk</h2>
<p>Elastic Beanstalk is a web infrastructure management service that handles deployment and scaling for web applications. It automatically manages setup, configuration, scaling, and provisioning of underlying AWS services.</p>
<p>Services managed by Elastic Beanstalk include: EC2, S3, RDS, and DynamoDB.</p>
<hr>

<h2>Elastic Beanstalk Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/SIBEAN-11.mp4" type="video/mp4">
...
<p>Elastic Beanstalk supports Docker, Go, Java, Java with Tomcat, .NET, Node.js, PHP, Python, and Ruby.</p>
<p>See the <a href="https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/concepts.platforms.html" target="_blank">AWS documentation</a> for the complete list of supported platforms.</p>
<hr>

<div>
    <h2>AWS Cloud Exercises</h2>
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_awsinfrastructure8" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>What kind of service is AWS Elastic Beanstalk?</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">Elastic Beanstalk is a web <input name="ex1" maxlength="14" style="width: 175px;"> management service</pre>
        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_awsinfrastructure8">Start the Exercise</a></p>
      </div>
    </form>
  </div>
