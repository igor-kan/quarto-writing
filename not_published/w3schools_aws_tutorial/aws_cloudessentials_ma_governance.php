...
ny:-->
    ...
    <h1>AWS Governance</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_ma_organizations.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_ma_health.php">Next &#10095;</a>
</div>
<hr>

<h2>Governance in the AWS Cloud</h2>
<p>As organizations scale, governing AWS accounts, services, and software licenses becomes challenging. AWS provides services to help enforce governance rules and meet company requirements: Control Tower, Service Catalog, and License Manager.</p>
<hr>

<h2>AWS Control Tower Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M10_L07_35_AWSControlTower_v02_FINAL.mp4" type="video/mp4">
...
<h2>Governance Services</h2>

<h3>AWS Control Tower</h3>
<p>Enforce and manage governance rules for security, operations, and compliance at scale across all your organizations and accounts.</p>
<ul>
  <li>Use preconfigured controls to quickly set up multi-account environments</li>
  <li>Built-in automation and third-party software integration</li>
  <li>Quickly deploy applications and provision compliant accounts</li>
</ul>

<h4>Key Features</h4>
<ul>
  <li><strong>Dashboard:</strong> Continuous oversight to see provisioned accounts and detect noncompliant resources</li>
  <li><strong>Account Factory:</strong> Configurable template that standardizes new account provisioning</li>
  <li><strong>Controls:</strong> High-level rules (guardrails) that provide governance for your AWS environment</li>
  <li><strong>Landing Zone:</strong> Well-architected multi-account environment based on best practices</li>
</ul>
<hr>

<h3>AWS Service Catalog</h3>
<p>Create, share, and organize a curated catalog of approved AWS resources. Deploy baseline networking and security tools for new accounts to govern consistently.</p>
<ul>
  <li>Quickly find and deploy approved, self-service cloud resources</li>
  <li>Improve governance over resources across multiple accounts</li>
  <li>Provision resources, apply access controls, and accelerate CI/CD pipelines</li>
</ul>
<hr>

<h3>AWS License Manager</h3>
<p>Manage software licenses and fine-tune licensing costs. With the Bring Your Own License (BYOL) model, you can use existing vendor licenses on AWS services like EC2 Dedicated Hosts and Amazon WorkSpaces.</p>
<ul>
  <li>Visibility and control over license usage</li>
  <li>Track and manage licenses across accounts</li>
  <li>Reduce noncompliance risk by enforcing license limits and blocking unauthorized launches</li>
  <li>Automate distribution and activation of software entitlements</li>
</ul>
