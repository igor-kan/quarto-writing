...
<a class="w3-left w3-btn" href="aws_cloudessentials_aiml_intro.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_aiml_solutions.php">Next &#10095;</a>
</div>
<hr>

<h2>AI/ML on AWS</h2>
<p>AWS provides AI/ML capabilities at different levels of complexity, allowing you to choose the right approach based on your expertise and requirements.</p>
<hr>

<h2>Machine Learning on AWS Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M08_L02_10_MachineLearningOnAWS_v02_FINAL.mp4" type="video/mp4">
...
<h2>Three Ways to Use AWS AI/ML Services</h2>
<p>AWS offers three tiers, from simple to advanced:</p>
<ul>
  <li><strong>AI Services:</strong> Ready-to-use models that work immediately. No ML knowledge needed.</li>
  <li><strong>ML Services:</strong> Build your own models with Amazon SageMaker AI. AWS manages the infrastructure.</li>
  <li><strong>ML Frameworks:</strong> Full control to build custom models from scratch. Requires ML expertise.</li>
</ul>
<p>Most beginners start with AI Services and move to more advanced options as needs grow.</p>
<hr>
