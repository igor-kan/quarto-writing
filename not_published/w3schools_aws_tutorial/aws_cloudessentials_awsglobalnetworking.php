...
<head>
  <title>AWS Cloud Global Networking</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>AWS Cloud Global Networking</h1>


<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_awssubnetandaccess.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_globalarchitectures.php">Next &#10095;</a>
</div>
<hr>

<h2>Global Networking</h2>
<p>AWS provides services to route users to your applications quickly and reliably, regardless of where they are in the world.</p>
<hr>

<h2>Global Networking Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M05_L05_25_GlobalNetworking_v01_FINAL.mp4" type="video/mp4">
...
<p>DNS acts like a phone book for the internet, connecting domain names (like w3schools.com) to IP addresses. It's how users find and access your website.</p>
<img src="images/dnsoverview.png" loading="lazy" alt="Overview of how DNS works" style="width:700px;max-width:100%;">
<p class="w3-small">Image created by Amazon Web Services</p>
<hr>

<h2>AWS Networking Services</h2>

<h3>Amazon Route 53</h3>
<p>Route 53 is AWS's DNS web service that routes users to your applications running on EC2, load balancers, or even infrastructure outside AWS. You can register new domains, transfer existing ones, and manage all DNS records in one place.</p>
<hr>
...
<h3>Route 53 + CloudFront Architecture</h3>
<p>Route 53 and CloudFront work together to deliver content efficiently:</p>
<img src="images/route53andcloudfront.png" loading="lazy" alt="Architecture combining Route 53 and CloudFront" style="width:700px;max-width:100%;">
<p class="w3-small">Image created by Amazon Web Services</p>
<ol>
  <li>User requests data from the application</li>
  <li>Route 53 resolves the domain to an IP address</li>
  <li>The request goes to the nearest CloudFront Edge Location</li>
  <li>CloudFront connects to the Application Load Balancer</li>
  <li>The Application Load Balancer forwards the request to an EC2 instance</li>
  <li>A response is returned to the user</li>
</ol>
<hr>

<h3>AWS Global Accelerator</h3>
<p>Global Accelerator routes traffic through the AWS private global network instead of the public internet, improving speed and reliability. It provides intelligent routing and automatic failover.</p>
<p><strong>Use cases:</strong> Gaming (reduced lag), financial services (reliable access during peak times).</p>
<hr>

<h2>Edge Services Summary</h2>
<ul>
  <li><strong>Route 53:</strong> Scalable cloud DNS service</li>
  <li><strong>CloudFront:</strong> CDN for low-latency content delivery</li>
  <li><strong>Global Accelerator:</strong> Routes traffic through AWS's private network for better performance</li>
</ul>
<hr>

<div>
    <h2>AWS Cloud Exercises</h2>
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_awsinfrastructure5" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>What does the DNS?</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">The DNS connects the IP address to the <input name="ex1" maxlength="6" style="width: 80px;"> name</pre>
        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_awsinfrastructure5">Start the Exercise</a></p>
      </div>
    </form>
  </div>
