...
<head>
  <title>Migration Services and Tools</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Migration Services and Tools</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_mig_migrationstrategies.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_mig_databasemigrations.php">Next &#10095;</a>
</div>
<hr>

<h2>AWS Migration Services</h2>
<p>No matter where you are in the migration process, AWS provides services and resources to support your journey. These services align with the three migration phases: Assess, Mobilize, and Migrate and Modernize.</p>
<hr>

<h2>Migration Services and Tools Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M12_L04_20_MigrationServicesAndTools_v02_FINAL0.mp4" type="video/mp4">
...
<h2>Assess Phase</h2>
<p>In the Assess phase, it is important to have the right tools to build the business case for your migration.</p>

<h3>Migration Evaluator</h3>
<p>The Migration Evaluator is a migration assessment service that helps you create a business case for AWS Cloud planning and migration.</p>
<p>It does this with a data driven approach, analyzing your current state, target state, and developing a migration readiness plan with projected cloud costs.</p>

<hr>

<h2>Mobilize Phase</h2>
<p>Let's look at two services that you might use in the Mobilize phase for discovery and planning.</p>

<h3>Application Discovery Service</h3>
<p>The Application Discovery Service discovers on-premises server inventory and connections.</p>
<p>It gathers configuration, performance, and connection details for both servers and databases to create a detailed migration plan.</p>
<hr>

<h3>Migration Hub</h3>
<p>The Migration Hub is a centralized hub to take you from discovery, assessment, planning, and execution of your migration.</p>
<p>It provides tools, guidance, and automated recommendations to collaborate with your team and track your migration.</p>
...
<h2>Migrate and Modernize Phase</h2>
<p>As you start moving resources to the cloud, you might continue to use Migration Hub to track your progress and modernize your applications.</p>

<h3>Application Migration Service</h3>
<p>Application Migration Service is a tool to move and improve your on-premises and cloud-based applications.</p>
<p>It helps customers streamline, expedite, and reduce the cost of migrating and modernizing applications.</p>

<hr>

<h2>Migration Resources</h2>
<p>When migrating to the AWS Cloud, if you need help and expertise, you don't have to go it alone.</p>
<p>You can work with the <a href="https://aws.amazon.com/migration/partner-solutions/" target="_blank">AWS Migration and Modernization Competency Partners</a> who specialize in specific phases of the migration or the type of help you need.</p>
