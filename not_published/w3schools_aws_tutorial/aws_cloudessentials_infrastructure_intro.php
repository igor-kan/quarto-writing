...
<head>
  <title>AWS Infrastructure Intro</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>AWS Infrastructure Intro</h1>

<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_benefits.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_ec2intro.php">Next &#10095;</a>
</div>
<hr>

<h2>AWS Global Infrastructure</h2>
<p>When you use AWS, your applications run on physical hardware located in data centers around the world. Understanding how this infrastructure is organized helps you design reliable, high-performing applications.</p>
<p>This section covers where AWS services run, what categories of services are available, and how security responsibilities are divided.</p>
<hr>

<h2>AWS Global Infrastructure Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M01_L04_20_IntroductionToTheAWSGlobalInfrastructure_v01_FINAL.mp4" type="video/mp4">
...
<p>AWS infrastructure consists of <strong>Regions</strong>. These are physical locations around the world, each containing multiple <strong>Availability Zones</strong> (isolated data centers with redundant power and networking).</p>
<p>This design provides high availability and fault tolerance. If one data center fails, others keep your application running.</p>
<hr>

<h2>AWS Service Categories</h2>
<p>AWS organizes its services into these core categories:</p>
<ul>
  <li><strong>Compute</strong> - Run applications (EC2, Lambda)</li>
  <li><strong>Storage</strong> - Store data (S3, EBS)</li>
  <li><strong>Networking</strong> - Connect resources (VPC, Route 53)</li>
  <li><strong>Databases</strong> - Manage data (RDS, DynamoDB)</li>
  <li><strong>Security</strong> - Control access (IAM, KMS)</li>
</ul>
<hr>

<h2>AWS Shared Responsibility Model</h2>
<p>Security in AWS is a shared responsibility between AWS and the customer.</p>
<p><strong>AWS is responsible for:</strong> Security <em>of</em> the cloud - protecting the infrastructure (hardware, software, networking, facilities).</p>
<p><strong>You are responsible for:</strong> Security <em>in</em> the cloud - managing your data, access controls, and encryption.</p>
<hr>
