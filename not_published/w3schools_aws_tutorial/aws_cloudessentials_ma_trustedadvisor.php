...
<a class="w3-left w3-btn" href="aws_cloudessentials_ma_health.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_ps_intro.php">Next &#10095;</a>
</div>
<hr>

<h2>What is AWS Trusted Advisor?</h2>
<p>Optimizing large-scale cloud deployments is an ongoing process. Trusted Advisor continuously evaluates your AWS environment using best practice checks across five categories: cost optimization, performance, security, fault tolerance, and service limits.</p>
<p>All AWS Support plans include access to dozens of checks. Business Support and advanced plans provide hundreds of checks.</p>
<hr>

<h2>AWS Trusted Advisor Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M10_L08_40_AWSTrustedAdvisor_v02.mp4" type="video/mp4">
...
<h2>Trusted Advisor Features</h2>

<h3>Check Categories</h3>
<ul>
  <li><strong>Cost optimization:</strong> Identify unused resources and opportunities to reduce spending</li>
  <li><strong>Performance:</strong> Improve speed and responsiveness of your applications</li>
  <li><strong>Security:</strong> Review permissions and identify security gaps</li>
  <li><strong>Fault tolerance:</strong> Increase availability and redundancy</li>
  <li><strong>Service limits:</strong> Track usage against service quotas</li>
</ul>

<h3>Dashboard</h3>
<p>Access Trusted Advisor from the AWS Management Console. The dashboard shows completed checks and results per category:</p>
<img src="images/trustedadvisordashboard.png" style="width:800px;max-width:100%;" loading="lazy" alt="TrustedAdvisorDashboard">
<p class="w3-small">Image created by Amazon Web Services</p>
<ul>
  <li><strong>Green check:</strong> No problems detected</li>
  <li><strong>Orange triangle:</strong> Recommended investigations</li>
  <li><strong>Red circle:</strong> Recommended actions</li>
</ul>
<hr>

<h2>IAM Access Analyzer</h2>
<p>While Trusted Advisor checks security at a high level, IAM Access Analyzer helps with fine-grained IAM permissions. It helps meet your least privilege goals by analyzing external access and validating that policies match your corporate security standards.</p>
<ul>
  <li>Refine and validate IAM policies</li>
  <li>Automate policy reviews</li>
  <li>Verify who can access what</li>
  <li>Remediate unused or overly broad access</li>
</ul>
<hr>

<p>Learn more: <a href="https://aws.amazon.com/premiumsupport/technology/trusted-advisor/" target="_blank">Trusted Advisor Product Page</a></p>
<hr>
...
<div>
    ...
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_ma_intro3" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>Fill in the missing category</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">1. Cost optimization</pre>
          <pre style="overflow: auto;">2. <input name="ex1" maxlength="11" style="width: 130px;"></pre>
          <pre style="overflow: auto;">3. Security</pre>
          <pre style="overflow: auto;">4. Fault tolerance</pre>
          <pre style="overflow: auto;">5. Service limits</pre>
        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_ma_intro3">Start the Exercise</a></p>
      </div>
    </form>
  </div>
