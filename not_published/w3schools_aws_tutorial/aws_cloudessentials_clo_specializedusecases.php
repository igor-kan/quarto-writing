...
ny:-->
    ...
    <h1>Specialized Use Cases</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_clo_specializedservices.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_clo_ninthrecap.php">Next &#10095;</a>
</div>
<hr>

<h2>Real-World Architectures</h2>
<p>Companies combine specialized AWS services to meet specific business needs. The following examples show how to combine services to solve common business problems.</p>
<hr>

<h2>Specialized Use Cases Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M13_L04_15_CloudInRealLifeSpecializedServiceUseCases_v01_FINAL0.mp4" type="video/mp4">
...
<h2>Serverless Web Backend Monitored by X-Ray</h2>
<p>This is a typical serverless web backend with X-Ray monitoring the environment.</p>

<h3>Architecture Components</h3>
<ol>
  <li><strong>Receive traffic</strong> - An Amazon API Gateway receives and validates HTTP requests</li>
  <li><strong>Trigger Lambda function</strong> - The API Gateway triggers a Lambda function that sends requests to Amazon DynamoDB</li>
  <li><strong>Monitor traffic</strong> - X-Ray traces requests through API Gateway, Lambda, DynamoDB and back to the client, helping developers troubleshoot any problems</li>
</ol>
...
<h2>Serverless Static Website with Contact Form</h2>
<p>This serverless setup demonstrates a static website with a contact form hosted on Amazon S3.</p>

<h3>Architecture Components</h3>
<ol>
  <li><strong>Accept customer input</strong> - Customers submit questions using a contact form housed on a static Amazon S3 website</li>
  <li><strong>Receive request</strong> - An API Gateway receives and validates the contact form request</li>
  <li><strong>Send email</strong> - The API Gateway invokes a Lambda function that sends an email to the business owner using Amazon SES</li>
</ol>
...
<h2>Customer Support with Callback Option</h2>
<p>This customer support solution provides an alternate channel and callback option so customers can avoid long wait times.</p>

<h3>Architecture Components</h3>
<ol>
  <li><strong>Initiate contact</strong> - A customer calls or texts a customer support center. Calls are placed into the Amazon Connect interactive voice response (IVR) system. Text messages are routed to Amazon Connect from CloudFront</li>
  <li><strong>Connect to agent</strong> - Amazon Connect tries to connect the customer with a live agent</li>
  <li><strong>Provide options</strong> - For calls with long wait lines, customers can choose to receive an agent callback or switch to text through a Lambda function</li>
</ol>
