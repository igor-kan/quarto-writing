...
<head>
  <title>AWS Cloud Auto Scaling</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>AWS Cloud Auto Scaling</h1>


<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_ec2scaling.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_ec2elasticloadbalancing.php">Next &#10095;</a>
</div>
<hr>

<h2>EC2 Auto Scaling</h2>
<p>When servers receive more requests than they can handle, it can cause timeouts and outages. EC2 Auto Scaling automatically adds or removes instances to match demand.</p>

<hr>
<h2>EC2 Scaling Video (Part 2)</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M02_L05_30_ScalingAmazonEC2Part2_v01_FINAL.mp4" type="video/mp4">
...
<h2>Two Approaches to EC2 Auto Scaling</h2>
<ul>
  <li><strong>Dynamic scaling:</strong> responds to changing demand in real-time</li>
  <li><strong>Predictive scaling:</strong> schedules instances based on predicted demand</li>
</ul>
<p>You can combine both approaches for faster scaling.</p>

<img src="images/demand.png" alt="Weekly demand with peak on Wednesday" style="width:400px;max-width:100%;">
<p class="w3-small">Image created by Amazon Web Services</p>

<h3>Auto Scaling Groups</h3>
<p>An Auto Scaling group is a collection of EC2 instances. You define capacity limits:</p>

<ul>
  <li><strong>Minimum:</strong> Always keep at least this many instances running</li>
  <li><strong>Desired:</strong> Ideal number of instances for normal traffic</li>
  <li><strong>Maximum:</strong> Never exceed this many instances (controls costs)</li>
</ul>

<p><strong>Example:</strong> Set min=2, desired=2, max=10. Normally 2 instances run. During traffic spikes, Auto Scaling adds up to 10, then scales back down when traffic drops.</p>
<hr>

<div>
    <h2>AWS Cloud Exercises</h2>
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_ec2intro7" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>What are the three types of configurations to control the instance capacity?</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">1. Minimum capacity</pre>
          <pre style="overflow: auto;">2. Desired <input name="ex1" maxlength="7" style="width: 90px;"></pre>
          <pre style="overflow: auto;">3. <input name="ex2" maxlength="7" style="width: 90px;"> capacity</pre>

        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_ec2intro7">Start the Exercise</a></p>
      </div>
    </form>
  </div>
