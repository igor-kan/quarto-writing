...
<head>
  <title>Cloud Migration and Innovation</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Cloud Migration and Innovation</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_ps_costoptimization.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_mig_awscaf.php">Next &#10095;</a>
</div>
<hr>

<h2>Introduction to Migration</h2>
<p>Cloud migration is the process of moving your organization's digital assets, IT resources, applications, and databases from on-premises infrastructure to the AWS Cloud. This involves strategic planning, implementation, and ongoing management. Large migrations are often completed in phases or stages rather than all at once.</p>
<hr>

<h2>Migration Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M12_L01_05_IntroductionToMigration_v010.mp4" type="video/mp4">
...
<h2>Three Phases of the Migration Process</h2>
<p>AWS helps guide companies through the migration process, which can be divided into three sequential phases.</p>
<p>From the first phase to the last, there are AWS services and tools to support your migration.</p>

<h3>1. Assess</h3>
<p>In this phase, you build the business case for the migration and assess your readiness.</p>
<p>One of the services used in this phase is the <strong>Migration Evaluator</strong>.</p>

<h3>2. Mobilize</h3>
<p>In this phase, you prepare the organization and mobilize the resources needed for the migration.</p>
<p>Two services you might use in this phase are <strong>AWS Application Discovery Service</strong> and the <strong>AWS Migration Hub</strong>.</p>

<h3>3. Migrate and Modernize</h3>
<p>In this phase, you use your strategy, plan, and the best practices to migrate and modernize.</p>
<p>Tools to support you include:</p>
<ul>
...
<p>While AWS Migration Hub helps you mobilize your resources, you can use it as a one-stop place to also manage during the migrate and modernize phase.</p>
<hr>
