...
<head>
  <title>AWS Cloud Subnet and Access</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>AWS Cloud Subnet and Access</h1>


<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_awsconnectivity.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_awsglobalnetworking.php">Next &#10095;</a>
</div>
<hr>

<h2>Subnets and Network Access</h2>
<p>Subnets let you organize resources within a VPC, while access control lists and security groups control what traffic can reach them.</p>
<hr>

<h2>Security Groups and Access Control Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M05_L03_15_SubnetsAndNetworkAccessControlLists_v02_FINAL.mp4" type="video/mp4">
...
<h2>Subnets</h2>
<p>A subnet is a section of a VPC that groups resources with similar security or operational needs. Public and private subnets can communicate with each other through secure channels.</p>

<h3>Public Subnets</h3>
<p>Contain resources accessible from the internet, such as public websites.</p>

<h3>Private Subnets</h3>
<p>Contain resources only accessible through the private network, such as databases with customer data.</p>
<hr>

<h2>Network Traffic</h2>
<p>Data travels across networks as <strong>packets</strong>. When a packet enters a VPC through an Internet Gateway, it must pass permission checks before entering a subnet: Who sent it? How will it communicate with the resources?</p>
<hr>

<h2>Access Control</h2>

<h3>Network Access Control Lists (ACLs)</h3>
<p>ACLs are firewalls that control inbound and outbound traffic at the subnet level. Packets on the approved list pass through; others are denied.</p>
<p>ACLs use <strong>stateless packet filtering</strong>: they check each packet against rules but have no memory of previous requests.</p>
<img src="images/statelesspacketfiltering.png" loading="lazy" alt="Checking if the traveler is on the list and forgets" style="width:700px;max-width:100%;">
<p class="w3-small">Image created by Amazon Web Services</p>
<p>See the <a href="https://docs.aws.amazon.com/vpc/latest/userguide/vpc-network-acls.html" target="_blank">AWS documentation on ACLs</a> for more details.</p>
<hr>
...
<p>Security Groups are firewalls that control traffic for specific EC2 instances. By default, they deny all inbound traffic and allow all outbound. You add rules to customize this behavior.</p>
<p>Security Groups use <strong>stateful packet filtering</strong>: they remember previous actions and allow return traffic automatically.</p>
<img src="images/statefulpacketfiltering.png" loading="lazy" alt="Firewall checks the access list and remembers" style="width:700px;max-width:100%;">
<p class="w3-small">Image created by Amazon Web Services</p>
<p>See the <a href="https://docs.aws.amazon.com/vpc/latest/userguide/VPC_SecurityGroups.html" target="_blank">AWS documentation on Security Groups</a> for more details.</p>
<hr>

<h2>Configuration Overview</h2>
<p>Both ACLs and Security Groups can be configured with custom rules for traffic control.</p>
<img src="images/overviewsecurity.png" loading="lazy" alt="Overview of network setup" style="width:700px;max-width:100%;">
<p class="w3-small">Image created by Amazon Web Services</p>
<hr>

<div>
    <h2>AWS Cloud Exercises</h2>
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_awsinfrastructure3" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>What is a subnet?</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">A subnet is a <input name="ex1" maxlength="7" style="width: 90px;"> of a VPC</pre>
        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_awsinfrastructure3">Start the Exercise</a></p>
      </div>
    </form>
  </div>
