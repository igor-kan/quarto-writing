...
<head>
  <title>Comparing Amazon RDS and Amazon DynamoDB</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Comparing Amazon RDS and DynamoDB</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_amazondynamodb.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_amazonredshift.php">Next &#10095;</a>
</div>
<hr>

<h2>RDS vs DynamoDB</h2>
<p>RDS and DynamoDB serve different needs. RDS is for relational data with complex queries. DynamoDB is for simple key-value lookups at massive scale.</p>
<hr>

<h2>Comparing Database Services Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/aws-cloud-practitioner-5-comparing-rds-and-dynamo.mp4" type="video/mp4">
...
<ul>
  <li><strong>RDS:</strong> Complex queries, joins, ACID (Atomicity, Consistency, Isolation, Durability) transactions, traditional applications</li>
  <li><strong>DynamoDB:</strong> High-traffic apps, gaming, IoT, real-time data at any scale</li>
</ul>  
<hr>
...
<!-- <p class="adtext">Advertisement</p> -->
    ...
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_amazonrds5" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>Fill in the blanks</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">Amazon RDS is a <input name="ex1" maxlength="10" style="width: 120px;"> database</pre>
          <pre style="overflow: auto;">Amazon DynamoDB is a <input name="ex2" maxlength="14" style="width: 150px;"> database</pre>
        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_amazonrds5">Start the Exercise</a></p>
      </div>
    </form>
  </div>
