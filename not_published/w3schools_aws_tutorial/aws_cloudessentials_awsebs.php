...
<a class="w3-left w3-btn" href="aws_cloudessentials_instancestores.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_amazonsimplestorageservice.php">Next &#10095;</a>
</div>
<hr>

<h2>What is AWS EBS?</h2>
<p>Amazon Elastic Block Store (EBS) provides persistent block-level storage volumes for EC2 instances. Unlike instance stores, EBS data persists even when the instance is stopped or terminated.</p>
<p>Common use cases are: database hosting, application backups, rapid deployment of dev environments.</p>
<hr>

<h2>EBS Benefits</h2>
<ul>
  <li><strong>Data persistence:</strong> Data remains available even if the EC2 instance stops</li>
  <li><strong>Migration:</strong> Move volumes between Availability Zones using snapshots</li>
  <li><strong>Flexibility:</strong> Attach volumes to different instance types, modify size and performance on the fly</li>
  <li><strong>Disaster recovery:</strong> Snapshots provide reliable backups across regions</li>
</ul>
<hr>
...
<p>EBS snapshots are incremental backups. The first backup copies all data; subsequent backups only copy changed blocks, saving storage costs.</p>
<img src="images/ebs_snapshots.jpg" alt="Amazon EBS snapshots" style="width:1200px;max-width:100%;" loading="lazy">
<p class="w3-small">Image created by Amazon Web Services</p>
<p>Snapshots are stored redundantly across multiple Availability Zones using Amazon S3. When you delete a snapshot, only data unique to that snapshot is removed.</p>
<hr>

<h3>Data Lifecycle Manager</h3>
<p>Automate snapshot creation, retention, and deletion. Schedule backups during off-peak hours and automatically delete outdated ones to control costs.</p>
<hr>

<div>
    <h2>AWS Cloud Exercises</h2>
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_storageanddatabases_introduction2" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>Fill in the blank</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">EBS is a service that provides <input name="ex1" maxlength="7" style="width: 90px;"> volumes</pre>
        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_storageanddatabases_introduction2">Start the Exercise</a></p>
      </div>
    </form>
  </div>
