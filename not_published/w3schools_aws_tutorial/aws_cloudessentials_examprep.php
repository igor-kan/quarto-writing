...
<head>
  <title>AWS Cloud Practitioner Exam Preparation Course</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>AWS Cloud Practitioner Exam Preparation Course</h1>
<div class="w3-clear nextprev">
    <a class="w3-left w3-btn" href="aws_cloudessentials_clo_ninthrecap.php">&#10094; Previous</a>
    <a class="w3-right w3-btn" href="aws_exam.php">Next &#10095;</a>
</div>
<hr>

<h2>AWS Cloud Practitioner Exam Prep</h2>
<p>W3Schools AWS Cloud Practitioner Tutorial is free.</p>
<p>The Tutorial is a complete AWS Certified Cloud Practitioner course.</p>
<p>It will help you prepare and increase your chances of passing the Exam.</p>
<div class="ws-info w3-panel">
  <p>You do not have to take the exam to read this tutorial</p>
  <p>The Tutorial is available and free for everyone.</p>
</div>
<hr>

<h2>Exam Subjects</h2>
<p>The Exam has four different subjects that you have to study.</p>
<ul>
...
<p>Read the AWS Exam Guide for more information about the subjects <a href="https://d1.awsstatic.com/training-and-certification/docs-cloud-practitioner/AWS-Certified-Cloud-Practitioner_Exam-Guide.pdf" target="_blank">Exam Guide</a></p>
<p>It is recommended to read the Exam Guide. It is a part of the preparation.</p>
</div>
  <hr>

<h2>Subject Exam Weight</h2>
<p>The Exam subjects are weighted.</p>
<p>The weighted numbers are estimated and might not be exact.</p>
<p>They should be used as a guide to help you understand what to study.</p>
<p>Some questions cover multiple subjects.</p>
<p>Here is an overview of the weighted subjects:</p>
...
<p>It is recommended to have a basic understanding of AWS Cloud and IT services before taking the Exam.</p>
<p>A rule of thumb is to have at least six months of experience with AWS Cloud.</p>
<p>However, there are no restrictions to take it earlier, as long as you have prepared well.</p>
<hr>

<h2>Exam Details</h2>
<p>The Exam consists of 65 multiple-choice questions. The Exam is time-limited to 90 minutes.</p>
<p>Candidates must have 70% correct answers to pass the Exam and become certified.</p>
<p>Unanswered questions count as incorrect. Always answer, even if you are guessing.</p>
<p>You can go back and review questions.</p>
...
<div class="w3-content" style="max-width:1400px">
  <div class="w3-col l6">
<h2>Schedule Exam</h2>
  <p>Getting a certificate proves your commitment to upgrade your skills and gives you the credibility needed for more responsibilities, larger projects, and a higher salary.</p>
  <p>Schedule your Exam today and get started!</p>
  <p>Study for free with W3Schools. Click the "Next" button to continue!</p>
  <p><a class="ws-btn w3-large" style="margin-top:15px;" href="https://aws.amazon.com/certification/certified-cloud-practitioner/" target="_blank">Schedule Exam &raquo;</a></p>
</div>
  <div class="w3-col l6 w3-center">
  <img src="images/awscert.png" alt="AWS Certified Cloud Practitioner Badge" height="250" width="auto" style="margin:30px auto;">
  </div>
</div>
</div>
<hr>
...
<div class="ws-note w3-panel">
  <p>If this is the first page you visit, we suggest reading our <a href="index.php">AWS Cloud Tutorial</a> from scratch.</p>
</div>
<hr>
