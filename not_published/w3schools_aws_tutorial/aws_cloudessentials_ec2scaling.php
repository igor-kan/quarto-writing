...
<head>
  <title>AWS Cloud EC2 Scaling</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>AWS Cloud EC2 Scaling</h1>


<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_ec2pricing.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_ec2autoscaling.php">Next &#10095;</a>
</div>
<hr>

<h2>EC2 Scaling</h2>
<p>Scaling means adjusting resources to match the current demand. A well-designed architecture handles traffic changes while you only pay for what you need.</p>
<hr>

<h2>EC2 Scaling Video (Part 1)</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M02_L05_25_ScalingAmazonEC2Part1_v01_FINAL.mp4" type="video/mp4">
...
<div>
    ...
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_cloudessentials_ec2intro6" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>What do we need to have in place to handle changes in demand?</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">We need to design a scalable <input name="ex1" maxlength="12" style="width: 150px;"></pre>
        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_ec2intro6">Start the Exercise</a></p>
      </div>
    </form>
  </div>
<hr>
