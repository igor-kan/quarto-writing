...
<head>
  <title>Seven Migration Strategies</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Seven Migration Strategies</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_mig_awscaf.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_mig_migrationservices.php">Next &#10095;</a>
</div>
<hr>
<h2>The Seven Rs</h2>
<p>When a company migrates to the AWS Cloud, they have many options. There are seven migration strategies to help them reach their goals, also known as the <strong>seven Rs</strong>:</p>
<ol>
  <li>Relocate</li>
  <li>Rehost</li>
  <li>Replatform</li>
...
<p>The company may choose certain strategies depending on its specific needs, application types, where the company starts, and the company's future plans.</p>
<p>Often, organizations will use a combination of these strategies across their application portfolio.</p>

<hr>
<h2>Cloud Migration Strategies Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M12_L03_15_Migration7Rs_v01_FINAL0.mp4" type="video/mp4">
...
<hr>
<h2>Relocate</h2>
<p>Relocating is changing the hosting location to the cloud.</p>
<p>This could be if applications are already virtual machines (VMs) or containers running on premises and then moving to the cloud.</p>
<hr>

<h2>Rehost</h2>
<p>Rehosting, also known as <strong>lift-and-shift</strong>, involves moving applications without changes.</p>
<p>In a scenario of a large legacy migration, in which the company is looking to implement its migration and scale quickly to meet a business case, the majority of applications are rehosted.</p>
<hr>

<h2>Replatform</h2>
<p>Replatforming, also known as <strong>lift, tinker, and shift</strong>, involves making a few cloud optimizations to realize a tangible benefit.</p>
<p>Optimization is achieved without changing the core architecture of the application.</p>
<hr>

<h2>Refactor</h2>
<p>Refactoring, also known as <strong>re-architecting</strong>, involves reimagining how an application is architected and developed by using features built for the cloud.</p>
<p>Refactoring is driven by a strong business need to add features, scale, or improve performance that would otherwise be difficult to achieve in the application's existing environment.</p>
<hr>

<h2>Repurchase</h2>
<p>Repurchasing involves moving from a traditional license to a <strong>software-as-a-service (SaaS)</strong> model.</p>
<p>For example, a business might choose to implement the repurchasing strategy by migrating from a customer relationship management (CRM) system to a new sales force software.</p>
<hr>
...
<h2>Retain</h2>
<p>Retaining consists of keeping applications that are critical for the business in the source environment.</p>
<p>This might include applications that require major refactoring before they can be migrated or work that can be postponed until a later time.</p>
<hr>

<h2>Retire</h2>
<p>Retiring is the process of removing applications that are no longer needed.</p>
<hr>

<div>
    <h2>AWS Cloud Exercises</h2>
    <form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_mig_migrationandinnovationintroduction3" method="post" target="_blank">
      <h2>Test Yourself With Exercises</h2>
      <div class="exercisewindow">
        <h2>Exercise:</h2>
        <p>Fill in the missing Migration Strategies</p>
        <div class="exerciseprecontainer">
          <pre style="overflow: auto;">1. Rehosting</pre>
          <pre style="overflow: auto;">2. <input name="ex1" maxlength="13" style="width: 150x;"></pre>
          <pre style="overflow: auto;">3. Refactoring</pre>
          <pre style="overflow: auto;">4. <input name="ex2" maxlength="12" style="width: 150px;"></pre>
          <pre style="overflow: auto;">5. Retaining</pre>
          <pre style="overflow: auto;">6. <input name="ex3" maxlength="8" style="width: 150px;"></pre>
        </div>
        <br>
        <button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
        <p><a target="_blank" href="exercise.php?filename=exercise_cloudessentials_mig_migrationandinnovationintroduction3">Start the Exercise</a></p>
      </div>
    </form>
  </div>
