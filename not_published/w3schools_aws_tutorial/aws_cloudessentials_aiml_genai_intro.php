...
<head>
  <title>AWS Generative AI Introduction</title>
  <!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Introduction to Generative AI on AWS</h1>

<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="aws_cloudessentials_aiml_solutions.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="aws_cloudessentials_aiml_genai_solutions.php">Next &#10095;</a>
</div>
<hr>

<h2>What is Generative AI?</h2>
<p>Generative AI creates new content such as text, images, videos, and music. It's powered by large ML models called foundation models (FMs) that are pre-trained on vast datasets and can be adapted for multiple tasks.</p>
<hr>

<h2>Generative AI on AWS Video</h2>
<video width="100%" style="max-width:800px" controls>
  <source src="https://1uln2hffm3.execute-api.eu-west-1.amazonaws.com/videos/M08_L06_15_GenerativeAIonAWS_v01_FINAL.mp4" type="video/mp4">
...
<h3>Deep Learning</h3>
<p>A subset of ML that uses layers of artificial neurons mimicking the human brain. Each layer processes and feeds information to the next until a final model is produced.</p>

<h3>Foundation Models</h3>
<p>Extremely large models pre-trained on vast data collections. Unlike traditional ML models trained for single tasks, FMs can be adapted for multiple purposes. Large language models (LLMs) are a popular type of FM trained for human language tasks.</p>
<hr>

<h2>AWS Generative AI Solutions</h2>
<table class="ws-table-all">
  ...
  <tr>
    <td><strong>Amazon SageMaker JumpStart</strong></td>
    <td>ML hub with FMs and pre-built solutions deployable in a few clicks</td>
  </tr>
  <tr>
    <td><strong>Amazon Bedrock</strong></td>
    <td>Fully managed service for deploying FMs from Amazon and leading AI providers</td>
  </tr>
  <tr>
    <td><strong>Amazon Q</strong></td>
    <td>AI assistant that integrates with company information repositories</td>
  </tr>
</table>
<hr>
