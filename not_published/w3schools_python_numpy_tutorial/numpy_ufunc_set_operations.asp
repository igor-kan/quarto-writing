...
<html lang="en-US">
<head>
<title>NumPy ufuncs - Set Operations</title>
<meta charset="utf-8">
...
<h1>NumPy Set Operations</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="numpy_ufunc_hyperbolic.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="numpy_exam.asp">Next &#10095;</a>
</div>
<hr>

<h2>What is a Set</h2>

<p>A set in mathematics is a collection of unique elements.</p>

<p>Sets are used for operations involving frequent intersection, union and difference operations.</p>

<hr>

<h2>Create Sets in NumPy</h2>

<p>We can use NumPy's <code class="w3-codespan">unique()</code> method to find unique elements from any array.
E.g. create a set array, but remember that the set arrays should only be 1-D arrays.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Convert following array with repeated elements to a set:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>
  arr = np.array([1, 1, 1, 2, 3, 4, 5, 5, 6, 7])<br><br>x = np.unique(arr)<br>
  <br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ufunc_set1">Try it Yourself &raquo;</a>
</div>
...
<p>To find the unique values of two arrays, use the <code class="w3-codespan">union1d()</code> method.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Find union of the following two set arrays:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br>
  <br>arr1 = np.array([1, 2, 3, 4])<br>arr2 = np.array([3, 4, 5, 6])<br><br>
  newarr = np.union1d(arr1, arr2)<br>
  <br>print(newarr)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ufunc_set2">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Finding Intersection</h2>

<p>To find only the values that are present in both arrays, use the <code class="w3-codespan">intersect1d()</code> method.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Find intersection of the following two set arrays:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br>
  <br>arr1 = np.array([1, 2, 3, 4])<br>arr2 = np.array([3, 4, 5, 6])<br><br>
  newarr = np.intersect1d(arr1, arr2, assume_unique=True)<br>
  <br>print(newarr)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ufunc_set3">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> the <code class="w3-codespan">intersect1d()</code> method takes an optional argument <code class="w3-codespan">assume_unique</code>,
   which if set to True can speed up computation. It should always be set to True when dealing with sets.</p>
</div>
...
<h2>Finding Difference</h2>

<p>To find only the values in the first set that is NOT present in the seconds set, use the <code class="w3-codespan">setdiff1d()</code> method.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Find the difference of the set1 from set2:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br>
  <br>set1 = np.array([1, 2, 3, 4])<br>set2 = np.array([3, 4, 5, 6])<br><br>
  newarr = np.setdiff1d(set1, set2, assume_unique=True)<br>
  <br>print(newarr)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ufunc_set5">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> the <code class="w3-codespan">setdiff1d()</code> method takes an optional argument <code class="w3-codespan">assume_unique</code>,
   which if set to True can speed up computation. It should always be set to True when dealing with sets.</p>
</div>


<hr>
<h2>Finding Symmetric Difference</h2>

<p>To find only the values that are NOT present in BOTH sets, use the <code class="w3-codespan">setxor1d()</code> method.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Find the symmetric difference of the set1 and set2:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br>
  <br>set1 = np.array([1, 2, 3, 4])<br>set2 = np.array([3, 4, 5, 6])<br><br>
  newarr = np.setxor1d(set1, set2, assume_unique=True)<br>
  <br>print(newarr)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ufunc_set4">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> the <code class="w3-codespan">setxor1d()</code> method takes an optional argument <code class="w3-codespan">assume_unique</code>,
   which if set to True can speed up computation. It should always be set to True when dealing with sets.</p>
</div>


<hr>
<div id="exercisecontainer" src="xrcise_ufunc_set_operations.js"></div>
<hr>
