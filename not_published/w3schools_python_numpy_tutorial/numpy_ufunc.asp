...
<html lang="en-US">
<head>
<title>Introduction to NumPy's ufuncs</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="numpy_random_zipf.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="numpy_ufunc_create_function.asp">Next &#10095;</a>
</div>
<hr>

<h2>What are ufuncs?</h2>
<p>ufuncs stands for "Universal Functions" and they are NumPy functions that
operate on the <code class="w3-codespan">ndarray</code> object.</p>

<!--<h2>Why Learn ufuncs?</h2>
<p>Most of the mathematics functions provided in NumPy are ufuncs,
knowing about them makes utilization of the mathematics routines in numpy more easy.</p>
-->
<h2>Why use ufuncs?</h2>
<p>ufuncs are used to implement <em>vectorization</em> in NumPy which is way faster than iterating over elements.</p>
<p>They also provide broadcasting and additional methods like reduce, accumulate etc. that are very helpful for computation.</p>
<p>ufuncs also take additional arguments, like:</p>
<p><code class="w3-codespan">where</code> boolean array or condition defining where the operations should take place.</p>
<p><code class="w3-codespan">dtype</code> defining the return type of elements.</p>
<p><code class="w3-codespan">out</code> output array where the return value should be copied.</p>
<hr>

<h2>What is Vectorization?</h2>

<p>Converting iterative statements into a vector based operation is called vectorization.</p>
<p>It is faster as modern CPUs are optimized for such operations.</p>

<h3>Add the Elements of Two Lists</h3>

<p>list 1: [1, 2, 3, 4]</p>
<p>list 2: [4, 5, 6, 7]</p>
 
<p>One way of doing it is to iterate over both of the lists and then sum each elements.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Without ufunc, we can use Python's built-in <code class="w3-codespan">zip()</code> method:</p>
<div class="w3-code notranslate pythonHigh">
  x = [1, 2, 3, 4]<br>y = [4, 5, 6, 7]<br>z = []<br><br>for i, j in zip(x, y):<br>&nbsp; 
  z.append(i + j)<br>print(z)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ufunc1">Try it Yourself &raquo;</a>
</div>

<p>NumPy has a ufunc for this, called <code class="w3-codespan">add(x, y)</code> 
that will produce the same result.</p>

<div class="w3-example">
<h3>Example</h3>
<p>With ufunc, we can use the <code class="w3-codespan">add()</code> function:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>x = [1, 2, 3, 4]<br>y = [4, 5, 6, 7]<br>z = np.add(x, y)<br><br>print(z)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ufunc2">Try it Yourself &raquo;</a>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_ufunc.js"></div>
