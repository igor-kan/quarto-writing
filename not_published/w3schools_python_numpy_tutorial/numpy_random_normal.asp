...
<a class="w3-left w3-btn" href="numpy_random_seaborn.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="numpy_random_binomial.asp">Next &#10095;</a>
</div>
<hr>

<h2>Normal Distribution</h2>

<p>The Normal Distribution is one of the most important distributions.</p>
<p>It is also called the Gaussian Distribution after the German mathematician 
Carl Friedrich Gauss.</p>

<p>It fits the probability distribution of many events, eg. IQ Scores, Heartbeat etc.</p>

<p>Use the <code class="w3-codespan">random.normal()</code> method to get a Normal Data Distribution.</p>

<p>It has three parameters:</p>

<p><code class="w3-codespan">loc</code> - (Mean) where the peak of the bell exists.</p>
<p><code class="w3-codespan">scale</code> - (Standard Deviation) how flat the graph distribution should be.</p>
<p><code class="w3-codespan">size</code> - The shape of the returned array.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Generate a random normal distribution of size 2x3:</p>
<div class="w3-code notranslate pythonHigh">
  from numpy import random<br><br>x = random.normal(size=(2, 3))<br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_random_normal1">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Generate a random normal distribution of size 2x3 with mean at 1 and standard deviation of 2:</p>
<div class="w3-code notranslate pythonHigh">
  from numpy import random<br><br>x = random.normal(loc=1, scale=2, size=(2, 3))<br>
  <br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_random_normal2">Try it Yourself &raquo;</a>
</div>


<hr>

<h2>Visualization of Normal Distribution</h2>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  from numpy import random<br>import matplotlib.pyplot as plt<br>import seaborn as sns<br><br>
  sns.displot(random.normal(size=1000), kind="kde")<br><br>plt.show()</div>
<h3>Result</h3>
<p><img src="normal_1.png" style="max-width:100%"></p>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_numpy_random_normal3">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> The curve of a Normal Distribution is also known as the Bell Curve because of the bell-shaped curve.</p>
</div>
...
<hr>
<div id="exercisecontainer" src="xrcise_random_normal.js"></div>
<hr>
