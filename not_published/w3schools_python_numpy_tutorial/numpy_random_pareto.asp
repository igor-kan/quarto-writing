...
<a class="w3-left w3-btn" href="numpy_random_rayleigh.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="numpy_random_zipf.asp">Next &#10095;</a>
</div>
<hr>

<h2>Pareto Distribution</h2>

<p>A distribution following Pareto's law i.e. 80-20 distribution (20% factors cause 80% outcome).</p>

<p>It has two parameter:</p>

<p><code class="w3-codespan">a</code> - shape parameter.</p>
<p><code class="w3-codespan">size</code> - The shape of the returned array.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Draw out a sample for pareto distribution with shape of 2 with size 2x3:</p>
<div class="w3-code notranslate pythonHigh">
  from numpy import random<br><br>x = random.pareto(a=2, size=(2, 3))<br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_random_pareto1">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Visualization of Pareto Distribution</h2>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  from numpy import random<br>import matplotlib.pyplot as plt<br>import seaborn as sns<br>
  <br>sns.displot(random.pareto(a=2, size=1000))<br><br>plt.show()</div>
<h3>Result</h3>
<p><img src="pareto_1.png" style="max-width:100%"></p>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_numpy_random_pareto2">Try it Yourself &raquo;</a>
</div>
...
<hr>
<div id="exercisecontainer" src="xrcise_random_pareto.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="numpy_random_rayleigh.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="numpy_random_zipf.asp">Next &#10095;</a>
