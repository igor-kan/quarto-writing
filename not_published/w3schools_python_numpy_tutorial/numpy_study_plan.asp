...
<html lang="en-US">
<head>
<title>NumPy Study Plan (Lesson Plan)</title>
<meta charset="utf-8">
...
<h1>NumPy <span class="color_h1">Study Plan</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="numpy_syllabus.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="default.asp">Next &#10095;</a>
</div>
<hr>
<h2>Introduction</h2>
<p>The NumPy study plan helps you teach your students NumPy step-by-step.</p>
<p>Creating a study plan for NumPy is easy.</p>
...
<p>Save time with pre-built teacher materials and study plans. Easily organize your class with a timeline from the introduction of NumPy to the final exam.</p>
<hr>
...
<p>W3Schools has everything you need to teach NumPy.</p>

<p>The NumPy training materials is available for you to include and use in your study plan:</p>
<ul>
  <li><a href="default.asp" target="_blank">W3Schools NumPy Tutorial</a></li>
  <li><a href="numpy_exercises.asp" target="_blank">NumPy Exercises</a></li>
  <li><a href="numpy_quiz.asp" target="_blank">NumPy Quiz</a></li>
  <li>NumPy Challenges (Coding challenges)</li>
  <li><a href="numpy_exam.asp" target="_blank">NumPy Certification Exam (End of Pathway Exam)</a></li>
</ul>
<hr>

<h2>NumPy Syllabus</h2>
<p>With the NumPy Syllabus, your students will start with the basics, like creating arrays and performing basic operations, and move to more advanced topics, like slicing arrays, working with array shapes, and performing mathematical calculations. Each chapter includes examples, try-it-yourself sections, exercises, and quizzes to make learning easy, interactive, and fun.</p>
<p><a title="W3Schools NumPy Syllabus" href="numpy_syllabus.asp" target="_blank">Read more about NumPy Syllabus</a>.</p>
<hr>
...
<ol>
  ...
  <li style="margin-top:16px">
    ...
    <ul>
      <li>The NumPy study plan aligns with the NumPy Certification Exam.</li>
      <li>The exam can be taken at the end of the study plan, at your selected date.</li>
      <li>The exam summarizes the NumPy Tutorial.</li>
...
<p>For example, this is how a 3-week NumPy study plan could look like:</p>

<ul>
  <li>Week 1: Introduction, Getting Started</li>
  <li>Week 2: Arrays</li>
  <li>Week 3: Random, ufunc, NumPy Certification Exam</li>
</ul>

<p>Image of Sample NumPy study plan:</p>
<a href="numpy_study_plan.png" target="_blank" title="NumPy Study Plan"><img src="numpy_study_plan.png" style="height:auto;max-width:100%;" loading="lazy"></a>
<hr>

<h2>Ready to get started?</h2>
<p>Start with <strong> NumPy Study Plans</strong> today.</p>
...
<p>Are you interested in learning how you can use <a href="/academy/index.php" target="_blank">W3Schools Academy</a> to Teach NumPy programming? </p>
