...
<html lang="en-US">
<head>
<title>NumPy ufuncs - Hyperbolic Functions</title>
<meta charset="utf-8">
...
<h1>NumPy Hyperbolic Functions</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="numpy_ufunc_trigonometric.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="numpy_ufunc_set_operations.asp">Next &#10095;</a>
</div>
<hr>

<h2>Hyperbolic Functions</h2>

<p>NumPy provides the ufuncs <code class="w3-codespan">sinh()</code>, <code class="w3-codespan">cosh()</code> and <code class="w3-codespan">tanh()</code> that take values in radians and produce the corresponding sinh, cosh and tanh values..</p>

<div class="w3-example">
<h3>Example</h3>
<p>Find sinh value of PI/2:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>
  x = np.sinh(np.pi/2)<br>
  <br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ufunc_hyperbolic1">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Find cosh values for all of the values in arr:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br>
  <br>arr = np.array([np.pi/2, np.pi/3, np.pi/4, np.pi/5])<br><br>x = 
  np.cosh(arr)<br>
  <br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ufunc_hyperbolic2">Try it Yourself &raquo;</a>
</div>
...
<p>Finding angles from values of hyperbolic sine, cos, tan. E.g. sinh, cosh and tanh inverse (arcsinh, arccosh, arctanh).</p>

<p>Numpy provides ufuncs <code class="w3-codespan">arcsinh()</code>, <code class="w3-codespan">arccosh()</code> and <code class="w3-codespan">arctanh()</code> that produce radian values for corresponding sinh, cosh and tanh values given.</p>
...
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br>
  <br>x = np.arcsinh(1.0)<br>
  <br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ufunc_hyperbolic3">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-example">
<h3>Example</h3>
<p>Find the angle for all of the tanh values in array:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr = np.array([0.1, 0.2, 0.5])<br><br>
  x = np.arctanh(arr)<br>
  <br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ufunc_hyperbolic4">Try it Yourself &raquo;</a>
</div>
...
<hr>
<div id="exercisecontainer" src="xrcise_ufunc_hyperbolic.js"></div>
<hr>
