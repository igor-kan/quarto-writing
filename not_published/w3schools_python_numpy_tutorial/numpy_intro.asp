...
<h1>NumPy <span class="color_h1">Introduction</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="default.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="numpy_getting_started.asp">Next &#10095;</a>
</div>
<hr>
...
<p>NumPy was created in 2005 by Travis Oliphant. It is an open source project 
and you can use it freely.</p>
...
<p>NumPy aims to provide an array object that is up to 50x faster than 
traditional Python lists.</p>
<p>The array object in NumPy is called <code class="w3-codespan">ndarray</code>, 
it provides a lot of supporting functions that make working with 
<code class="w3-codespan">ndarray</code> very easy.</p>
<p>Arrays are very frequently used in data science, where speed and resources 
are very important.</p>

<div class="w3-panel ws-note">
  <p><strong>Data Science:</strong> is a branch of computer science where we study how to store, use and analyze data for deriving information from it.</p>
</div>
<hr>
...
<hr>
<h2>Where is the NumPy Codebase?</h2>

<p>The source code for NumPy is located at this github repository 
<a href="https://github.com/numpy/numpy" target="_blank">https://github.com/numpy/numpy</a></p>


<div class="w3-panel ws-note">
  <p><strong>github:</strong> enables many people to work on the same 
  codebase.</p>
</div>
