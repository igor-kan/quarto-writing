...
<a class="w3-left w3-btn" href="numpy_random_exponential.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="numpy_random_rayleigh.asp">Next &#10095;</a>
</div>
<hr>

<h2>Chi Square Distribution</h2>

<p>Chi Square distribution is used  as a basis to verify the hypothesis.</p>

<p>It has two parameters:</p>

<p><code class="w3-codespan">df</code> - (degree of freedom).</p>
<p><code class="w3-codespan">size</code> - The shape of the returned array.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Draw out a sample for chi squared distribution with degree of freedom 2 with size 2x3:</p>
<div class="w3-code notranslate pythonHigh">
  from numpy import random<br><br>x = random.chisquare(df=2, size=(2, 3))<br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_random_chisquare1">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Visualization of Chi Square Distribution</h2>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  from numpy import random<br>import matplotlib.pyplot as plt<br>import seaborn as sns<br>
  <br>sns.displot(random.chisquare(df=1, size=1000), kind="kde")<br><br>plt.show()</div>
<h3>Result</h3>
<p><img src="chi_square_1.png" style="max-width:100%"></p>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_numpy_random_chisquare2">Try it Yourself &raquo;</a>
</div>
...
<hr>
<div id="exercisecontainer" src="xrcise_random_chisquare.js"></div>
<hr>
