...
<html lang="en-US">
<head>
<title>NumPy Array Copy vs View</title>
<meta charset="utf-8">
...
<h1>NumPy <span class="color_h1">Array Copy vs View</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="numpy_data_types.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="numpy_array_shape.asp">Next &#10095;</a>
</div>
<hr>

<h2>The Difference Between Copy and View</h2>

<p>The main difference between a copy and a view of an array is that
the copy is a new array, and the view is just a view of the original array.</p>
<p>The copy <em>owns</em> the data and any changes made to the copy will not 
affect original array, and any changes made to the original array will not 
affect the copy.</p>
<p>The view <em>does not own</em> the data and any changes made to the view will 
...
<h3>Example</h3>
<p>Make a copy, change the original array, and display both arrays:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr = np.array([1, 2, 3, 4, 5])<br>x = arr.copy()<br>
  arr[0] = 42<br>
  <br>print(arr) <br>print(x) </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_array_copy">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-example">
<h3>Example</h3>
<p>Make a view, change the original array, and display both arrays:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr = np.array([1, 2, 3, 4, 5])<br>x = arr.view()<br>arr[0] = 42<br>
  <br>print(arr) <br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_array_view1">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-example">
<h3>Example</h3>
<p>Make a view, change the view, and display both arrays:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr = np.array([1, 2, 3, 4, 5])<br>x = arr.view()<br>
  x[0] = 31<br>
  <br>print(arr) <br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_array_view2">Try it Yourself &raquo;</a>
</div>
...
<hr>
<h2>Check if Array Owns its Data</h2>
<p>As mentioned above, copies <em>owns</em> the data, and views <em>does not own</em> 
the data, but how can we check this?</p>

<p>Every NumPy array has the attribute <code class="w3-codespan">base</code> that 
returns <code class="w3-codespan">None</code> if the array owns the data.</p>
<p>Otherwise, the <code class="w3-codespan">base</code>&nbsp; attribute refers to the original object.

<div class="w3-example">
<h3>Example</h3>
<p>Print the value of the base attribute to check if an array owns it's data or 
not:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr = np.array([1, 2, 3, 4, 5])<br><br>x = arr.copy()<br>
  y = arr.view()<br><br>print(x.base)<br>print(y.base)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_array_base">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p>The copy returns <code class="w3-codespan">None</code>.<br>The view returns the original array.</p>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_copy_vs_view.js"></div>
<hr>
