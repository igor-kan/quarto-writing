...
<h1>Zipf Distribution</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="numpy_random_pareto.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="numpy_ufunc.asp">Next &#10095;</a>
</div>
<hr>

<p>Zipf distributions are used to sample data based on zipf's law.</p>

<div class="w3-panel ws-note">
  <p><strong>Zipf's Law:</strong>
...
<p><code class="w3-codespan">a</code> - distribution parameter.</p>
<p><code class="w3-codespan">size</code> - The shape of the returned array.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Draw out a sample for zipf distribution with distribution parameter 2 with size 2x3:</p>
<div class="w3-code notranslate pythonHigh">
  from numpy import random<br><br>x = random.zipf(a=2, size=(2, 3))<br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_random_zipf1">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Visualization of Zipf Distribution</h2>

<p>Sample 1000 points but plotting only ones with value &lt; 10 for more meaningful chart.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  from numpy import random<br>import matplotlib.pyplot as plt<br>import seaborn as sns<br>
  <br>x = random.zipf(a=2, size=1000)<br>sns.displot(x[x&lt;10])<br><br>plt.show()</div>
<h3>Result</h3>
<p><img src="zipf_1.png" style="max-width:100%"></p>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_numpy_random_zipf2">Try it Yourself &raquo;</a>
</div>
...
<hr>
<div id="exercisecontainer" src="xrcise_random_zipf.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="numpy_random_pareto.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="numpy_ufunc.asp">Next &#10095;</a>
