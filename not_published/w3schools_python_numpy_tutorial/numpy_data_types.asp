...
<h1>NumPy <span class="color_h1">Data Types</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="numpy_array_slicing.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="numpy_copy_vs_view.asp">Next &#10095;</a>
</div>
<hr>
...
<p>NumPy has some extra data types, and refer to data types with one 
character, like <code class="w3-codespan">i</code> for integers, <code class="w3-codespan">u</code> for unsigned integers etc.</p>
...
<h2>Checking the Data Type of an Array</h2>
<p>The NumPy array object has a property called <code class="w3-codespan">dtype</code> 
that returns the data type of the array:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Get the data type of an array object:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr = np.array([1, 2, 3, 4])<br><br>print(arr.dtype)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_datatypes_dtype">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Get the data type of an array containing strings:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr = np.array(['apple', 
  'banana', 'cherry'])<br><br>print(arr.dtype)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_datatypes_dtype2">Try it Yourself &raquo;</a>
</div>
...
<p>We use the <code class="w3-codespan">array()</code> function to create arrays, this function can take an optional argument: <code class="w3-codespan">dtype</code> 
that allows us to define the expected data type of the array elements:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Create an array with data type string:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr = np.array([1, 2, 3, 4], 
  dtype='S')<br><br>print(arr)<br>print(arr.dtype)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_datatypes">Try it Yourself &raquo;</a>
</div>


<p>For <code class="w3-codespan">i</code>, <code class="w3-codespan">u</code>, <code class="w3-codespan">f</code>, 
<code class="w3-codespan">S</code> and <code class="w3-codespan">U</code> we can define size as well.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Create an array with data type 4 bytes integer:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr = np.array([1, 2, 3, 4], 
  dtype='i4')<br><br>print(arr)<br>print(arr.dtype)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_datatypes2">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>What if a Value Can Not Be Converted?</h2>
<p>If a type is given in which elements can't be casted then NumPy will raise a ValueError.</p>


<div class="w3-panel ws-note">
  <p><strong>ValueError:</strong> In Python ValueError is raised when the type of passed argument to a function is unexpected/incorrect.</p>
</div>

<div class="w3-example w3-pale-red">
<h3>Example</h3>
<p>A non integer string like 'a' can not be converted to integer (will raise an error):</p>
<div class="w3-code notranslate pythonHigh w3-border-red">
  import numpy as np<br><br>arr = np.array(['a', '2', '3'], dtype='i')</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_datatype_error">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Converting Data Type on Existing Arrays</h2>
<p>The best way to change the data type of an existing array, is to make a copy 
of the array with the <code class="w3-codespan">astype()</code> method.</p>
<p>The <code class="w3-codespan">astype()</code> function creates a copy of the 
array, and allows you to specify the data type as a parameter.</p>

<p>The data type can be specified using a string, like <code class="w3-codespan">'f'</code> for float,
<code class="w3-codespan">'i'</code> for integer etc. or you can use the data type directly like
<code class="w3-codespan">float</code> for float and <code class="w3-codespan">int</code> for integer.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Change data type from float to integer by using <code class="w3-codespan">'i'</code> as parameter value:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr = np.array([1.1, 2.1, 3.1])<br>
  <br>newarr = arr.astype('i')<br><br>print(newarr)<br>print(newarr.dtype)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_array_astype">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Change data type from float to integer by using <code class="w3-codespan">int</code> as parameter value:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr = np.array([1.1, 2.1, 3.1])<br>
  <br>newarr = arr.astype(int)<br><br>print(newarr)<br>print(newarr.dtype)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_array_astype2">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Change data type from integer to boolean:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr = np.array([1, 0, 3])<br>
  <br>newarr = arr.astype(bool)<br><br>print(newarr)<br>print(newarr.dtype)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_array_astype3">Try it Yourself &raquo;</a>
</div>
