...
<html lang="en-US">
<head>
<title>NumPy ufuncs - Create Your Own Function</title>
<meta charset="utf-8">
...
<h1>Create Your Own ufunc</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="numpy_ufunc.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="numpy_ufunc_simple_arithmetic.asp">Next &#10095;</a>
</div>
<hr>

<h2>How To Create Your Own ufunc</h2>

<p>To create your own ufunc, you have to define a function, like you do with normal functions in Python, then you
add it to your NumPy ufunc library with the <code class="w3-codespan">frompyfunc()</code> method.</p>

<p>The <code class="w3-codespan">frompyfunc()</code> method takes the following arguments:</p>
...
<h3>Example</h3>
<p>Create your own ufunc for addition:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>def myadd(x, y):<br>&nbsp; 
  return x+y<br><br>myadd = np.frompyfunc(myadd, 2, 1)<br><br>print(myadd([1, 2, 
  3, 4], [5, 6, 7, 8]))</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ufunc_create1">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Check if a Function is a ufunc</h2>

<p>Check the <em>type</em> of a function to check if it is a ufunc or not.</p>

<p>A ufunc should return <code class="w3-codespan">&lt;class 'numpy.ufunc'&gt;</code>.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Check if a function is a ufunc:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>print(type(np.add))</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ufunc_create2">Try it Yourself &raquo;</a>
</div>

<p>If it is not a ufunc, it will return another type, like this built-in NumPy function for joining two or more arrays:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Check the type of another function: concatenate():</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>print(type(np.concatenate))</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ufunc_create3">Try it Yourself &raquo;</a>
</div>

<p>If the function is not recognized at all, it will return an error:</p>

<div class="w3-example w3-pale-red">
<h3>Example</h3>
<p>Check the type of something that does not exist. This will produce an error:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>print(type(np.blahblah))</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ufunc_create4">Try it Yourself &raquo;</a>
</div>

<p>To test if the function is a ufunc in an if statement, use the <code class="w3-codespan">numpy.ufunc</code> value 
(or <code class="w3-codespan">np.ufunc</code> if you use np as an alias for numpy):</p>

<div class="w3-example">
<h3>Example</h3>
<p>Use an if statement to check if the function is a ufunc or not:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>if type(np.add) == np.ufunc:<br>&nbsp; 
  print('add is ufunc')<br>else:<br>&nbsp; print('add is not ufunc')</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ufunc_create5">Try it Yourself &raquo;</a>
</div>
...
<hr>
<div id="exercisecontainer" src="xrcise_ufunc_create_function.js"></div>
<hr>
