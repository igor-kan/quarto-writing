...
<html lang="en-US">
<head>
<title>NumPy Sorting Arrays</title>
<meta charset="utf-8">
...
<h1>NumPy <span class="color_h1">Sorting Arrays</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="numpy_array_search.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="numpy_array_filter.asp">Next &#10095;</a>
</div>
<hr>

<h2>Sorting Arrays</h2>

<p>Sorting means putting elements in an <em>ordered sequence</em>.</p>

<p><em>Ordered sequence</em> is any sequence that has an order corresponding to elements, like numeric or alphabetical, ascending or descending.</p>

<p>The NumPy ndarray object has a function called <code class="w3-codespan">sort()</code>, 
...
<div class="w3-code notranslate pythonHigh">
  ...
  arr = np.array([3, 2, 0, 1])<br><br>print(np.sort(arr))</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_array_sort1">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> This method returns a copy of the array, leaving the 
  original array unchanged.</p>
</div>
...
<div class="w3-example">
<h3>Example</h3>
<p>Sort the array alphabetically:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>
  arr = np.array(['banana', 'cherry', 'apple'])<br><br>print(np.sort(arr))</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_array_sort2">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Sort a boolean array:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>
  arr = np.array([True, False, True])<br><br>print(np.sort(arr))</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_array_sort3">Try it Yourself &raquo;</a>
</div>
...
<h2>Sorting a 2-D Array</h2>

<p>If you use the sort() method on a 2-D array, both arrays will be sorted:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Sort a 2-D array:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr = np.array([[3, 2, 4], [5, 0, 1]])<br><br>print(np.sort(arr))</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_array_sort4">Try it Yourself &raquo;</a>
</div>
...
<p>NumPy supports following algorithms:</p>
<ul>
<li>Quicksort</li>
<li>Heapsort</li>
<li>Mergesort</li>
...
<p>We can specify the algorithm by using the <code class="w3-codespan">kind</code> parameter:

<div class="w3-example">
<h3>Example</h3>
<p>Sort with different algorithms:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr = np.array([[3, 2, 4], [5, 0, 1]])<br><br>
  print(np.sort(arr, kind='quicksort')) # default<br>print(np.sort(arr, 
  kind='heapsort'))<br>print(np.sort(arr, kind='mergesort'))<br>print(np.sort(arr, 
  kind='stable'))</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_array_sort5">Try it Yourself &raquo;</a>
</div>
