...
<a class="w3-left w3-btn" href="numpy_ufunc_rounding_decimals.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="numpy_ufunc_summations.asp">Next &#10095;</a>
</div>
<hr>

<h2>Logs</h2>

<p>NumPy provides functions to perform log at the base 2, e and 10.</p>

<p>We will also explore how we can take log for any base by creating a custom ufunc.</p>

<p>All of the log functions will place -inf or inf in the elements if the log can not be computed.</p>

<hr>

<h2>Log at Base 2</h2>

<p>Use the <code class="w3-codespan">log2()</code> function to perform log at the base 2.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Find log at base 2 of all elements of following array:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr = np.arange(1, 10)<br><br>print(np.log2(arr))</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ufunc_log1">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> The <code class="w3-codespan">arange(1, 10)</code> function returns an array 
  with integers starting from 1 (included) to 10 (not included).</p>
</div>

<hr>

<h2>Log at Base 10</h2>

<p>Use the <code class="w3-codespan">log10()</code> function to perform log at the base 10.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Find log at base 10 of all elements of following array:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr = np.arange(1, 10)<br><br>print(np.log10(arr))</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ufunc_log2">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Natural Log, or Log at Base e</h2>

<p>Use the <code class="w3-codespan">log()</code> function to perform log at the base e.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Find log at base e of all elements of following array:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr = np.arange(1, 10)<br><br>print(np.log(arr))</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ufunc_log3">Try it Yourself &raquo;</a>
</div>
...
<h2>Log at Any Base</h2>

<p>NumPy does not provide any function to take log at any base,
so we can use the <code class="w3-codespan">frompyfunc()</code> function along with inbuilt function <code class="w3-codespan">math.log()</code> with two input parameters and one output parameter:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  from math import log<br>import numpy as np<br><br>nplog = np.frompyfunc(log, 
  2, 1)<br><br>print(nplog(100, 15))</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ufunc_log4">Try it Yourself &raquo;</a>
</div>


<hr>
<div id="exercisecontainer" src="xrcise_ufunc_logs.js"></div>
<hr>
