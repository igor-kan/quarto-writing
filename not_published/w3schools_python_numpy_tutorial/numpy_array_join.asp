...
<html lang="en-US">
<head>
<title>NumPy Joining Array</title>
<meta charset="utf-8">
...
<h1>NumPy <span class="color_h1">Joining Array</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="numpy_array_iterating.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="numpy_array_split.asp">Next &#10095;</a>
</div>
<hr>
...
<p>We pass a sequence of arrays that we want to join to the
<code class="w3-codespan">concatenate()</code> function, along with the axis. If axis is not explicitly passed, it is taken as 0.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Join two arrays</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr1 = np.array([1, 2, 3])<br><br>arr2 = np.array([4, 
  5, 6])<br><br>arr = np.concatenate((arr1, arr2))<br><br>print(arr)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_array_join1">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr1 = np.array([[1, 2], [3, 4]])<br><br>arr2 = 
  np.array([[5, 6], [7, 8]])<br><br>arr = np.concatenate((arr1, arr2), axis=1)<br>
  <br>print(arr)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_array_join2">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Joining Arrays Using Stack Functions</h2>

<p>Stacking is same as concatenation, the only difference is that stacking is done along a new axis.</p>

<p>We can concatenate two 1-D arrays along the second axis which would result in putting them one over 
the other, ie. stacking.</p>

<p>We pass a sequence of arrays that we want to join to the
<code class="w3-codespan">stack()</code> method along with the axis. If axis is not explicitly passed it is taken as 0.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr1 = np.array([1, 2, 3])<br><br>arr2 = 
  np.array([4, 5, 6])<br><br>arr = np.stack((arr1, arr2), axis=1)<br><br>print(arr)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_array_join3">Try it Yourself &raquo;</a>
</div>
...
<h2>Stacking Along Rows</h2>

<p>NumPy provides a helper function: <code class="w3-codespan">hstack()</code> 
...
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr1 = np.array([1, 2, 3])<br><br>arr2 = np.array([4, 
  5, 6])<br><br>arr = np.hstack((arr1, arr2))<br><br>print(arr)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_array_join4">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Stacking Along Columns</h2>

<p>NumPy provides a helper function: <code class="w3-codespan">vstack() </code>&nbsp;to stack along columns.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr1 = np.array([1, 2, 3])<br><br>arr2 = np.array([4, 
  5, 6])<br><br>arr = np.vstack((arr1, arr2))<br><br>print(arr)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_array_join5">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Stacking Along Height (depth)</h2>

<p>NumPy provides a helper function: <code class="w3-codespan">dstack()</code> 
to stack along height, which is the same as depth.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr1 = np.array([1, 2, 3])<br><br>arr2 = np.array([4, 
  5, 6])<br><br>arr = np.dstack((arr1, arr2))<br><br>print(arr)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_array_join6">Try it Yourself &raquo;</a>
</div>

<!--
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> In <em>record</em> and <em>structured arrays</em> the term 
  <em>joining</em> makes more sense as they have named fields. Record and Structured arrays are a part of Intermediate to Advanced numpy.</p>
</div>
-->

<hr>
<div id="exercisecontainer" src="xrcise_array_join.js"></div>
<hr>
