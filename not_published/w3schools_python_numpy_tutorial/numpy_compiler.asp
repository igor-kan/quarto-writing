...
<html lang="en-US">
<head>
<title>NumPy Online Compiler (Editor / Interpreter)</title>
<meta charset="utf-8">
...
/* Syntax highlighting */
.py-keyword  { color: #005cc5; }
.py-function { color: #d73a49; }
.py-module   { color: #000000; }
.py-variable { color: #000000; }
.py-string   { color: green; }
.py-number   { color: #098658; }
...
<h1>NumPy <span class="color_h1">Online Compiler (Editor)</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="numpy_exam.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="numpy_quiz.asp">Next &#10095;</a>
</div>
<hr>

<h2>NumPy (Python) Editor</h2>

<p>With our &quot;Try it Yourself&quot; editor, you can edit Python code and use the NumPy module, and view the result in your browser.</p>
...
<div class="compiler-wrapper">
  ...
  <div class="compiler-body">
    ...
    <div class="editor">
<pre>
<span class="py-keyword">import</span> <span class="py-module">numpy</span> <span class="py-keyword">as</span> <span class="py-module">np</span>

<span class="py-variable">arr</span> <span class="py-symbol">=</span> <span class="py-module">np</span><span class="py-symbol">.</span><span class="py-function">array</span><span class="py-symbol">([</span><span class="py-number">1</span>, <span class="py-number">2</span>, <span class="py-number">3</span>, <span class="py-number">4</span>, <span class="py-number">5</span><span class="py-symbol">])</span>

<span class="py-function">print</span><span class="py-symbol">(</span><span class="py-variable">arr</span><span class="py-symbol">)</span>
<span class="py-function">print</span><span class="py-symbol">(</span><span class="py-function">type</span><span class="py-symbol">(</span><span class="py-variable">arr</span><span class="py-symbol">))</span>
</pre>
    </div>
...
&lt;class 'numpy.ndarray'&gt;
  ...
  <div class="compiler-footer">
    <a href="trypython.asp?filename=demo_numpy_editor"
       target="_blank"
       class="ws-btn">
...
<h2>Build and Publish NumPy Projects</h2>

<p>If you want to create your own website or build Python applications, <a href="/spaces/index.php">W3Schools Spaces</a> gives you an easy place to write, run, manage, and publish code online.</p>
