...
<html lang="en-US">
<head>
<title>NumPy ufuncs - LCM - Lowest Common Multiple</title>
<meta charset="utf-8">
...
<h1>NumPy LCM Lowest Common Multiple</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="numpy_ufunc_differences.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="numpy_ufunc_gcd.asp">Next &#10095;</a>
</div>
<hr>

<h2>Finding LCM (Lowest Common Multiple)</h2>

<p>The Lowest Common Multiple is the smallest number that is a common multiple of 
two numbers.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Find the LCM of the following two numbers:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>num1 = 4<br>num2 = 6<br><br>x = np.lcm(num1, num2)<br>
  <br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ufunc_lcm1">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p><strong>Returns:</strong> <code class="w3-codespan">12</code> because that is the lowest 
  common multiple of both numbers (4*3=12 and 6*2=12).</p>
</div>

<hr>

<h2>Finding LCM in Arrays</h2>

<p>To find the Lowest Common Multiple of all values in an array, you can use the <code class="w3-codespan">reduce()</code> method.</p>

<div class="w3-panel ws-note">
  <p>The <code class="w3-codespan">reduce()</code> method will use the ufunc, in this case the 
  <code class="w3-codespan">lcm()</code> function, on each element, and reduce the array 
  by one dimension.</p>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Find the LCM of the values of the following array:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr = np.array([3, 6, 9])<br><br>x = np.lcm.reduce(arr)<br>
  <br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ufunc_lcm2">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p><strong>Returns:</strong> <code class="w3-codespan">18</code> because that is the lowest 
  common multiple of all three numbers (3*6=18, 6*3=18 and 9*2=18).</p>
</div>


<div class="w3-example">
<h3>Example</h3>
<p>Find the LCM of all values of an array where the array contains all integers from 1 to 10:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr = np.arange(1, 11)<br><br>x = np.lcm.reduce(arr)<br>
  <br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ufunc_lcm3">Try it Yourself &raquo;</a>
</div>
...
<hr>
<div id="exercisecontainer" src="xrcise_ufunc_lcm.js"></div>
<hr>
