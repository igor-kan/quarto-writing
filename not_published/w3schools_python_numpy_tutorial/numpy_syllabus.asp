...
<html lang="en-US">
<head>
<title>NumPy Syllabus (Curriculum)</title>
<meta charset="utf-8">
...
<h1>NumPy <span class="color_h1">Syllabus</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="numpy_exercises.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="numpy_study_plan.asp">Next &#10095;</a>
</div>
<hr>
<h2>Introduction</h2>
<style>
...
<p>The <a title="W3Schools NumPy Tutorial" href="default.asp">W3Schools NumPy Tutorial</a> is comprehensive and beginner-friendly.</p>
<p>It will give you a fundamental knowledge of NumPy.</p>
<p>It is designed for beginners and requires only basic Python knowledge.</p>
...
<p>The syllabus outline and its sequence are structured so you can learn NumPy step by step, from the introduction to creating your first array operations.</p>
<p><a title="W3Schools NumPy Tutorial" href="numpy_intro.asp" class="ws-btn">Get Started With NumPy &raquo;</a></p>
<hr>

<h2>Learning Outcomes</h2>
<ul>
  <li>Understand the basic structure of NumPy arrays.</li>
  <li>Create and manipulate arrays efficiently.</li>
  <li>Perform mathematical operations on arrays.</li>
  <li>Apply array indexing and slicing.</li>
  <li>Use array functions and methods.</li>
  <li>Perform array reshaping and stacking.</li>
  <li>Work with random number generation.</li>
  <li>Apply linear algebra operations.</li>
  <li>Create efficient numerical computations.</li>
</ul>
<div class="ws-note w3-panel">
<p><strong>Note:</strong> Are you a teacher teaching NumPy? <a href="/academy/index.php" target="_blank">W3Schools Academy</a> is a toolbox of features that can help you teach. It offers classroom features such as pre-built study plans, classroom administration and much more. Read more about <a href="/academy/index.php" target="_blank">Academy here</a>.</p>
</div>
<hr>

<h2>Which Subjects Are NumPy Relevant For?</h2>
<ul>
   <li style="margin-bottom:16px;"><strong>Data Science:</strong><br> NumPy is essential for numerical computing and data manipulation.</li>
   <li style="margin-bottom:16px;"><strong>Scientific Computing:</strong><br> NumPy provides powerful tools for scientific calculations and analysis.</li>
   <li style="margin-bottom:16px;"><strong>Machine Learning:</strong><br> NumPy is fundamental for handling numerical data in Machine Learning applications.</li>
   <li style="margin-bottom:16px;"><strong>Statistics:</strong><br> NumPy offers efficient tools for statistical calculations.</li>
   <li style="margin-bottom:16px;"><strong>Image Processing:</strong><br> NumPy arrays are perfect for handling image data.</li>
   <li style="margin-bottom:16px;"><strong>Engineering:</strong><br> NumPy supports mathematical operations for engineering applications.</li>
   <li><strong>Research:</strong><br> NumPy is widely used in scientific research and data analysis.</li>
</ul>
<p><a title="W3Schools NumPy Tutorial" href="numpy_intro.asp" class="ws-btn" style="margin-top:8px">Get Started</a></p>
<hr>

<h2>Activities</h2>
<p>In this tutorial we offer different activities for you to learn NumPy for free:</p>
<ul>
    <li><a href="default.asp" title="W3Schools NumPy Tutorial">Lessons</a></li>
    <li><a href="numpy_exercises.asp" title="W3Schools NumPy Exercises">Exercises</a></li>
    <li><a href="numpy_quiz.asp" title="W3Schools NumPy Quiz">Quizzes</a></li>
</ul>
...
<ul class="link-boxes">
    <li><a href="default.asp">NumPy HOME</a></li>
    <li><a href="numpy_intro.asp">NumPy Intro</a></li>
    <li><a href="numpy_getting_started.asp">NumPy Getting Started</a></li>
    <li><a href="numpy_creating_arrays.asp">NumPy Creating Arrays</a></li>
    <li><a href="numpy_array_indexing.asp">NumPy Array Indexing</a></li>
    <li><a href="numpy_array_slicing.asp">NumPy Array Slicing</a></li>
    <li><a href="numpy_data_types.asp">NumPy Data Types</a></li>
    <li><a href="numpy_copy_vs_view.asp">NumPy Copy vs View</a></li>
    <li><a href="numpy_array_shape.asp">NumPy Array Shape</a></li>
    <li><a href="numpy_array_reshape.asp">NumPy Array Reshape</a></li>
    <li><a href="numpy_array_iterating.asp">NumPy Array Iterating</a></li>
    <li><a href="numpy_array_join.asp">NumPy Array Join</a></li>
    <li><a href="numpy_array_split.asp">NumPy Array Split</a></li>
    <li><a href="numpy_array_search.asp">NumPy Array Search</a></li>
    <li><a href="numpy_array_sort.asp">NumPy Array Sort</a></li>
    <li><a href="numpy_array_filter.asp">NumPy Array Filter</a></li>
    <li><a href="numpy_random.asp">Random Intro</a></li>
    <li><a href="numpy_random_distribution.asp">Data Distribution</a></li>
    <li><a href="numpy_random_permutation.asp">Random Permutation</a></li>
    <li><a href="numpy_random_seaborn.asp">Seaborn Module</a></li>
    <li><a href="numpy_random_normal.asp">Normal Distribution</a></li>
    <li><a href="numpy_random_binomial.asp">Binomial Distribution</a></li>
    <li><a href="numpy_random_poisson.asp">Poisson Distribution</a></li>
    <li><a href="numpy_random_uniform.asp">Uniform Distribution</a></li>
    <li><a href="numpy_random_logistic.asp">Logistic Distribution</a></li>
    <li><a href="numpy_random_multinomial.asp">Multinomial Distribution</a></li>
    <li><a href="numpy_random_exponential.asp">Exponential Distribution</a></li>
    <li><a href="numpy_random_chisquare.asp">Chi Square Distribution</a></li>
    <li><a href="numpy_random_rayleigh.asp">Rayleigh Distribution</a></li>
    <li><a href="numpy_random_pareto.asp">Pareto Distribution</a></li>
    <li><a href="numpy_random_zipf.asp">Zipf Distribution</a></li>
    <li><a href="numpy_ufunc.asp">ufunc Intro</a></li>
    <li><a href="numpy_ufunc_create_function.asp">ufunc Create Function</a></li>
    <li><a href="numpy_ufunc_simple_arithmetic.asp">ufunc Simple Arithmetic</a></li>
    <li><a href="numpy_ufunc_rounding_decimals.asp">ufunc Rounding Decimals</a></li>
    <li><a href="numpy_ufunc_logs.asp">ufunc Logs</a></li>
    <li><a href="numpy_ufunc_summations.asp">ufunc Summations</a></li>
    <li><a href="numpy_ufunc_products.asp">ufunc Products</a></li>
    <li><a href="numpy_ufunc_differences.asp">ufunc Differences</a></li>
    <li><a href="numpy_ufunc_lcm.asp">ufunc Finding LCM</a></li>
    <li><a href="numpy_ufunc_gcd.asp">ufunc Finding GCD</a></li>
    <li><a href="numpy_ufunc_trigonometric.asp">ufunc Trigonometric</a></li>
    <li><a href="numpy_ufunc_hyperbolic.asp">ufunc Hyperbolic</a></li>
    <li><a href="numpy_ufunc_set_operations.asp">ufunc Set Operations</a></li>
</ul>
</div>
<p><a title="W3Schools NumPy Tutorial" href="default.asp" class="ws-btn">Get Started</a></p>
<hr>


<h2>Sandbox and Lab Environment</h2>
<p>NumPy, like any other library, is best learned through hands-on practice.</p>
...
that allows you to build, test and deploy Python projects for free.</p>
<p>Here you get a secure sandbox environment called Spaces, where you can practice NumPy code and test projects in real-time.</p>
...
<h2>NumPy Certification</h2>
<p>W3Schools offers an end-of-pathway certification program.</p>
<p>Here you can take exams to get certified.</p>
<p>The NumPy exam is a test that summarizes the W3Schools NumPy syllabus.</p>
<p>After passing the exam you get the "Certified NumPy Developer" Certification.</p>
...
<div class="ws-grey w3-padding w3-round">
    <a href="numpy_exam.png" target="_blank"><img src="numpy_exam.png" style="width: 100%" loading="lazy"></a>
</div>
<p><a class="ws-btn" href="https://campus.w3schools.com/products/numpy-certification-exam" target="_blank">Buy Certificate &raquo;</a></p>
<hr>
