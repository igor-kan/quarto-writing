...
<a class="w3-left w3-btn" href="numpy_random_logistic.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="numpy_random_exponential.asp">Next &#10095;</a>
</div>
<hr>

<h2>Multinomial Distribution</h2>

<p>Multinomial distribution is a generalization of binomial distribution.</p>

<p>It describes outcomes of multi-nomial scenarios unlike binomial where scenarios must be only one of two.
e.g. Blood type of a population, dice roll outcome.</p>

<p>It has three parameters:</p>

<p><code class="w3-codespan">n</code> - number of times to run the experiment.</p>
<p><code class="w3-codespan">pvals</code> - list of probabilties of outcomes (e.g. [1/6, 1/6, 1/6, 1/6, 1/6, 1/6] for dice roll).</p>
<p><code class="w3-codespan">size</code> - The shape of the returned array.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Draw out a sample for dice roll:</p>
<div class="w3-code notranslate pythonHigh">
  from numpy import random<br><br>x = random.multinomial(n=6, pvals=[1/6, 1/6, 
  1/6, 1/6, 1/6, 1/6])<br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_random_multinomial1">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> Multinomial samples will NOT produce a single value! 
  They will produce one value for each <code class="w3-codespan">pval</code>.</p>
</div>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> As they are generalization of binomial distribution their visual representation and similarity of normal distribution is same as that of multiple binomial distributions.</p>
</div>
...
<hr>
<div id="exercisecontainer" src="xrcise_random_multinomial.js"></div>
<hr>
