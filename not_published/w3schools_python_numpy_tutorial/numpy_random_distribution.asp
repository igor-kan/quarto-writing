...
<html lang="en-US">
<head>
<title>Random Data Distribution</title>
<meta charset="utf-8">
...
<h1>Random Data Distribution</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="numpy_random.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="numpy_random_permutation.asp">Next &#10095;</a>
</div>
<hr>

<h2>What is Data Distribution?</h2>
<p>Data Distribution is a list of all possible values, and how often each value 
occurs.</p>
<p>Such lists are important when working with statistics and data science.</p>
<p>The random module offer methods that returns randomly generated data 
distributions.</p>
<hr>

<h2>Random Distribution</h2>

<p>A random distribution is a set of random numbers that follow a certain <em>probability density function</em>.</p>

<div class="w3-panel ws-note">
  <p><strong>Probability Density Function:</strong>
A function that describes a continuous probability. i.e. probability of all
values in an array.</p>
</div>

<p>We can generate random numbers based on defined probabilities using the 
<code class="w3-codespan">choice()</code> method of the 
<code class="w3-codespan">random</code> module.</p>
<p>The <code class="w3-codespan">choice()</code> method allows us to specify the probability for each value.</p>
<p>The probability is set by a number between 0 and 1, where 0 means that the 
value will never occur and 1 means that the value will always occur.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Generate a 1-D array containing 100 values, where each value has to be 3, 5, 
7 or 9.</p>
...
<div class="w3-code notranslate pythonHigh">
  from numpy import random<br><br>x = random.choice([3, 5, 7, 9], p=[0.1, 0.3, 
  0.6, 0.0], size=(100))<br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_random_distribution1">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p>The sum of all probability numbers should be 1.</p>
</div>

<p>Even if you run the example above 100 times, the value 9 will never occur.</p>
<p>You can return arrays of any shape and size by specifying the shape in the
<code class="w3-codespan">size</code> parameter.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Same example as above, but return a 2-D array with 3 rows, each containing 5 values.</p>
<div class="w3-code notranslate pythonHigh">
  from numpy import random<br><br>x = random.choice([3, 5, 7, 9], p=[0.1, 0.3, 
  0.6, 0.0], size=(3, 5))<br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_random_distribution2">Try it Yourself &raquo;</a>
</div>
...
<hr>
<div id="exercisecontainer" src="xrcise_random_distribution.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="numpy_random.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="numpy_random_permutation.asp">Next &#10095;</a>
