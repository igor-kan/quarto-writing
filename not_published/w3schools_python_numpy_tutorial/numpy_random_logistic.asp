...
<a class="w3-left w3-btn" href="numpy_random_uniform.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="numpy_random_multinomial.asp">Next &#10095;</a>
</div>
<hr>

<h2>Logistic Distribution</h2>

<p>Logistic Distribution is used to describe growth.</p>

<p>Used extensively in machine learning in logistic regression, neural networks etc.</p>

<p>It has three parameters:</p>

<p><code class="w3-codespan">loc</code> - mean, where the peak is. Default 0.</p>
<p><code class="w3-codespan">scale</code> - standard deviation, the flatness of distribution. Default 1.</p>
<p><code class="w3-codespan">size</code> - The shape of the returned array.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Draw 2x3 samples from a logistic distribution with mean at 1 and stddev 2.0:</p>
<div class="w3-code notranslate pythonHigh">
  from numpy import random<br><br>x = random.logistic(loc=1, scale=2, size=(2, 
  3))<br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_random_logistic1">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Visualization of Logistic Distribution</h2>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  from numpy import random<br>import matplotlib.pyplot as plt<br>import seaborn as sns<br>
  <br>sns.displot(random.logistic(size=1000), kind="kde")<br><br>plt.show()</div>
<h3>Result</h3>
<p><img src="logistic_1.png" style="max-width:100%"></p>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_numpy_random_logistic2">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Difference Between Logistic and Normal Distribution</h2>

<p>Both distributions are near identical, but logistic distribution has more area under the tails, 
meaning it represents more possibility of occurrence of an event further away from mean.</p>

<p>For higher value of scale (standard deviation) the normal and logistic distributions are near identical apart from the peak.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  from numpy import random<br>import matplotlib.pyplot as plt<br>import seaborn as sns<br>
  <br>data = {<br>&nbsp; &quot;normal&quot;: random.normal(scale=2, size=1000),<br>&nbsp; 
  &quot;logistic&quot;: random.logistic(size=1000)<br>}<br><br>sns.displot(data, kind=&quot;kde&quot;)<br><br>plt.show()</div>
<h3>Result</h3>
<p><img src="logistic_2.png" style="max-width:100%"></p>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_numpy_random_logistic3">Try it Yourself &raquo;</a>
</div>
...
<hr>
<div id="exercisecontainer" src="xrcise_random_logistic.js"></div>
<hr>
