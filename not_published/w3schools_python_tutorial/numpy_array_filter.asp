...
<html lang="en-US">
<head>
<title>NumPy Filter Array</title>
<meta charset="utf-8">
...
<h1>NumPy <span class="color_h1">Filter Array</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="numpy_array_sort.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="numpy_random.asp">Next &#10095;</a>
</div>
<hr>

<h2>Filtering Arrays</h2>

<p>Getting some elements out of an existing array and creating a new array out 
of them is called <em>filtering</em>.</p>
...
<p>If the value at an index is <code class="w3-codespan">True</code> that element is contained in the filtered array, if the value at that index is 
<code class="w3-codespan">False</code> that element is excluded from the filtered array.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Create an array from the elements on index 0 and 2:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr = np.array([41, 42, 43, 44])<br><br>x = [True, 
  False, True, False]<br><br>newarr = arr[x]<br><br>print(newarr)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_array_filter1">Try it Yourself &raquo;</a>
</div>

<p>The example above will return <code class="w3-codespan">[41, 43]</code>, why?</p>
<p>Because the new array contains only the values where the filter array had the value 
<code class="w3-codespan">True</code>, in this case, index 
0 and 2.</p>

<hr>

<h2>Creating the Filter Array</h2>

<p>In the example above we hard-coded the <code class="w3-codespan">True</code> 
and <code class="w3-codespan">False</code> values, but the common use is to create a filter array based on conditions.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Create a filter array that will return only values higher than 42:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr = np.array([41, 42, 43, 44])<br><br># 
  Create an empty list<br>filter_arr = []<br><br># go through each element in 
  arr<br>for element in arr:<br>&nbsp; # if the element is higher than 42, set 
  the value to True, otherwise False:<br>&nbsp; if element &gt; 42:<br>&nbsp;&nbsp;&nbsp; 
  filter_arr.append(True)<br>&nbsp; else:<br>&nbsp;&nbsp;&nbsp; filter_arr.append(False)<br>
  <br>newarr = arr[filter_arr]<br><br>print(filter_arr)<br>print(newarr)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_array_filter2">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-example">
<h3>Example</h3>
<p>Create a filter array that will return only even elements from the original 
array:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr = np.array([1, 2, 3, 4, 5, 6, 7])<br><br># 
  Create an empty list<br>filter_arr = []<br><br># go through each element in 
  arr<br>for element in arr:<br>&nbsp; # if the element is completely divisble 
  by 2, set the value to True, otherwise False<br>&nbsp; if element % 2 == 0:<br>&nbsp;&nbsp;&nbsp; 
  filter_arr.append(True)<br>&nbsp; else:<br>&nbsp;&nbsp;&nbsp; filter_arr.append(False)<br>
  <br>newarr = arr[filter_arr]<br><br>print(filter_arr)<br>print(newarr)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_array_filter3">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Creating Filter Directly From Array</h2>
...
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr = np.array([41, 42, 43, 44])<br><br>
  filter_arr = arr 
  &gt; 42<br><br>newarr = arr[filter_arr]<br><br>print(filter_arr)<br>print(newarr)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_array_filter4">Try it Yourself &raquo;</a>
</div>
...
array:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr = np.array([1, 2, 3, 4, 5, 6, 7])<br><br>filter_arr = arr 
  % 2 == 0<br><br>newarr = arr[filter_arr]<br><br>print(filter_arr)<br>print(newarr)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_array_filter5">Try it Yourself &raquo;</a>
</div>

<!--
<div class="w3-example">
<h3>Example</h3>
<p>Create a boolean index list for even odd condition:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr = np.array([1, 2, 3, 4, 5, 6, 7])<br><br>
  arr = arr 
  % 2 == 0<br><br>print(arr)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_indentation">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Create a boolean index list for perfect squares:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr = np.array([1, 2, 3, 4, 5, 6, 7])<br><br># 
  Square root of number - square root's integer part should be equal to zero ( 
  ie. there should be nothing in decimal part)<br>arr = (arr ** 0.5 - ( arr ** 
  0.5 ).astype('i')) == 0<br><br>print(arr)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_indentation">Try it Yourself &raquo;</a>
</div>
<div class="w3-panel ws-note">
  <p><strong>perfect square:</strong> A number that is square of an integer.</p>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Filter the array for even elements:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr = np.array([1, 2, 3, 4, 5, 6, 7])<br><br># 
  arr % 2 == 0 creates a boolean array and we pass it like boolean indexing<br>
  arr = arr[arr % 2 == 0]<br><br>print(arr)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_indentation">Try it Yourself &raquo;</a>
</div>
-->
<hr>
<div id="exercisecontainer" src="xrcise_array_filter.js"></div>
<hr>
