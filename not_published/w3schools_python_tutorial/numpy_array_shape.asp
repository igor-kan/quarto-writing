...
<h1>NumPy <span class="color_h1">Array Shape</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="numpy_copy_vs_view.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="numpy_array_reshape.asp">Next &#10095;</a>
</div>
<hr>
...
<h2>Get the Shape of an Array</h2>

<p>NumPy arrays have an attribute called <code class="w3-codespan">shape</code> that returns a tuple with each index having the number of corresponding elements.</p>
...
<div class="w3-code notranslate pythonHigh">
  ...
  [5, 6, 7, 8]])<br>
  <br>print(arr.shape)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_shape">Try it Yourself &raquo;</a>
</div>

<p>The example above returns <code class="w3-codespan">(2, 4)</code>, which means that the array has 2 dimensions, 
where the first dimension has 2 elements and the second has 4.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Create an array with 5 dimensions using <code class="w3-codespan">ndmin</code> using a vector with values 1,2,3,4 and verify that last dimension has value 4:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr = np.array([1, 2, 3, 4], ndmin=5)<br><br>print(arr)<br>
  print('shape of array :', arr.shape)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_shape_ndim">Try it Yourself &raquo;</a>
</div>

<h2>What does the shape tuple represent?</h2>
...
<hr>
<div id="exercisecontainer" src="xrcise_array_shape.js"></div>
<hr>
