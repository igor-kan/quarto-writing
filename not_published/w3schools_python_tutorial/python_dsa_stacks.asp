...
<html lang="en-US">
<head>
<title>Stacks with Python</title>
<meta charset="utf-8">
...
<h1>Stacks with Python</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_dsa_lists.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_dsa_queues.asp">Next &#10095;</a>
</div>
<hr>

<p class="intro">A stack is a linear data structure that follows the Last-In-First-Out (LIFO) principle.</p>
<p class="intro">Think of it like a stack of pancakes - you can only add or remove pancakes from the top.</p>
<hr>


<h2>Stacks</h2>
<p>A stack is a data structure that can hold many elements, and the last element added is the first one to be removed.</p>
<p>Like a pile of pancakes, the pancakes are both added and removed from the top. So when removing a pancake, it will always be the last pancake you added. This way of organizing elements is called LIFO: Last In First Out.</p>
...
<ul>
  ...
  <li><strong>Peek: </strong>Returns the top (last) element on the stack.</li>
...
<h2>Stack Implementation using Python Lists</h2>
<p>For Python lists (and arrays), a stack can look and behave like this:</p>
<div id="stacktest1" class="w3-codeline notranslate" style="margin: 10px 0;"></div>
Add: <button class="ws-btn" onclick="push_stack()">Push</button>
Remove: <button class="ws-btn" onclick="pop_stack()">Pop</button>
<script>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Using a Python list as a stack:</p>
  <div class="w3-code notranslate pythonHigh">
    ...
    stack.append('B')<br>
    stack.append('C')<br>
    print("Stack: ", stack)<br>
    <br>
    # Peek<br>
    topElement = stack[-1]<br>
    print("Peek: ", topElement)<br>
    <br>
    # Pop<br>
    poppedElement = stack.pop() <br>
    print("Pop: ", poppedElement)<br>
    <br>
    # Stack after Pop<br>
    print("Stack after Pop: ", stack)<br>
    <br>
    # isEmpty<br>
    isEmpty = not bool(stack)<br>
    print("isEmpty: ", isEmpty)<br>
    <br>
    # Size<br>
    print("Size: ",len(stack))
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dsa_stacks_list">Try it Yourself &raquo;</a>
  </div>

<p>While Python lists can be used as stacks, creating a dedicated <strong>Stack class</strong> provides better encapsulation and additional functionality:</p>
<div class="w3-example">
  <h3>Example</h3>
  <p>Creating a stack using class:</p>
  <div class="w3-code notranslate pythonHigh">
class Stack:<br>
...
myStack.push('C')<br>
<br>
print("Stack: ", myStack.stack)<br>
print("Pop: ", myStack.pop())<br>
print("Stack after Pop: ", myStack.stack)<br>
print("Peek: ", myStack.peek())<br>
print("isEmpty: ", myStack.isEmpty())<br>
print("Size: ", myStack.size())
</div>
  <a class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dsa_stacks_class" target="_blank">Run Example �</a>
</div>
<p>Reasons to implement stacks using lists/arrays:</p>
<ul>
...
<p>To better understand the benefits with using arrays or linked lists to implement stacks,
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Creating a Stack using a Linked List:</p>
  <div class="w3-code notranslate pythonHigh">
class Node:<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;self.size -= 1<br>
&nbsp;&nbsp;&nbsp;&nbsp;return popped_node.value<br>
<br>
&nbsp;&nbsp;def peek(self):<br>
&nbsp;&nbsp;&nbsp;&nbsp;if self.isEmpty():<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return "Stack is empty"<br>
&nbsp;&nbsp;&nbsp;&nbsp;return self.head.value<br>
<br>
&nbsp;&nbsp;def isEmpty(self):<br>
&nbsp;&nbsp;&nbsp;&nbsp;return self.size == 0<br>
<br>
&nbsp;&nbsp;def stackSize(self):<br>
&nbsp;&nbsp;&nbsp;&nbsp;return self.size<br>
<br>
&nbsp;&nbsp;def traverseAndPrint(self):<br>
&nbsp;&nbsp;&nbsp;&nbsp;currentNode = self.head<br>
&nbsp;&nbsp;&nbsp;&nbsp;while currentNode:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;print(currentNode.value, end=" -> ")<br>
...
myStack.push('C')<br>
<br>
print("LinkedList: ", end="")<br>
myStack.traverseAndPrint() <br>
print("Peek: ", myStack.peek())<br>
print("Pop: ", myStack.pop())<br>
print("LinkedList after Pop: ", end="")<br>
myStack.traverseAndPrint() <br>
print("isEmpty: ", myStack.isEmpty())<br>
print("Size: ", myStack.stackSize())</div>
  <a class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dsa_stacks_linkedlist" target="_blank">Run Example �</a>
</div>
...
<h2>Common Stack Applications</h2>

<p>Stacks are used in many real-world scenarios:</p>
<ul>
