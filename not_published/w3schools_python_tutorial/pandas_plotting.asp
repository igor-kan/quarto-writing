...
<h1>Pandas - <span class="color_h1">Plotting</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="pandas_correlations.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="pandas_exam.asp">Next &#10095;</a>
</div>
<hr>
<img src="img_pandas_plot.png" style="max-width:100%">
<hr>
<h2>Plotting</h2>

<p>Pandas uses the <code class="w3-codespan">plot()</code> method to create 
diagrams.</p>
<p>We can use Pyplot, a submodule of the Matplotlib library to visualize the 
diagram on the screen.</p>

<p>Read more about Matplotlib in our <a href="/python/matplotlib_intro.asp">Matplotlib Tutorial</a>.</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Import pyplot from Matplotlib and visualize our DataFrame:</p>
<div class="w3-code notranslate pythonHigh">
  import pandas as pd<br>import matplotlib.pyplot as plt<br><br>df = pd.read_csv('data.csv')<br>
  <br>df.plot()<br><br>plt.show()</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypandas.asp?filename=demo_pandas_plot">Try it Yourself &raquo;</a>
</div>

<p>The examples in this page uses a CSV file called: 'data.csv'.</p>
<p><a href="data.csv">Download data.csv</a> or <a href="data.csv.txt" target="_blank">Open 
data.csv</a></p>

<hr>

<h2>Scatter Plot</h2>
<p>Specify that you want a scatter plot with the <code class="w3-codespan">
kind</code> argument:</p>
<p><code class="w3-codespan">kind = 'scatter'</code></p>

<p>A scatter plot needs an x- and a y-axis.</p>

<p>In the example below we will use "Duration" for the x-axis
and "Calories" for the y-axis.</p>
<p>Include the x and y arguments like this:</p>
<p><code class="w3-codespan">x = 'Duration', y = 'Calories'</code></p>

<div class="w3-example">
  <h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  import pandas as pd<br>import matplotlib.pyplot as plt<br><br>df = pd.read_csv('data.csv')<br>
  <br>df.plot(kind = 'scatter', x = 'Duration', y = 'Calories')<br><br>plt.show()</div>
<h3>Result</h3>

<p><img src="img_pandas_plot_scatter.png" style="max-width:100%"></p>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypandas.asp?filename=demo_pandas_plot_scatter">Try it Yourself &raquo;</a>
...
<div class="w3-panel ws-note">
  <p>
    ...
    was <code class="w3-codespan">0.922721</code>, and we concluded with the fact that
    higher duration means more calories burned.</p>
<p>By looking at the scatterplot, I will agree.  </p>
</div>

<p>Let's create another scatterplot, where there is a bad relationship between the columns, like "Duration" and "Maxpulse", with the correlation <code class="w3-codespan">0.009403</code>:</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>A scatterplot where there are no relationship between the columns:</p>
<div class="w3-code notranslate pythonHigh">
  import pandas as pd<br>import matplotlib.pyplot as plt<br><br>df = pd.read_csv('data.csv')<br>
  <br>df.plot(kind = 'scatter', x = 'Duration', y = 'Maxpulse')<br><br>plt.show()</div>
<h3>Result</h3>

<p><img src="img_pandas_plot_scatter2.png" style="max-width:100%"></p>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypandas.asp?filename=demo_pandas_plot_scatter2">Try it Yourself &raquo;</a>
...
<h2>Histogram</h2>
<p>Use the <code class="w3-codespan">
kind</code> argument 
to specify that you want a histogram:</p>
<p><code class="w3-codespan">kind = 'hist'</code></p>

<p>A histogram needs only one column.</p>

<p>A histogram shows us the frequency of each interval, e.g. how many workouts lasted between 50 and 60 minutes?</p>

<p>In the example below we will use the "Duration" column to create the histogram:</p>

<div class="w3-example">
  <h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  df[&quot;Duration&quot;].plot(kind = 'hist')<br></div>
<h3>Result</h3>

<p><img src="img_pandas_plot_hist.png" style="max-width:100%"></p>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypandas.asp?filename=demo_pandas_plot_hist">Try it Yourself &raquo;</a>
...
<div class="w3-panel ws-note">
  <p>
    <strong>Note:</strong>
    The histogram tells us that there were over 100 workouts that lasted between 50 and 60 minutes.</p>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_plotting.js"></div>
<hr>
