...
<html lang="en-US">
<head>
<title>Pandas - Removing Duplicates</title>
<meta charset="utf-8">
...
<h1>Pandas - <span class="color_h1">Removing Duplicates</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="pandas_cleaning_wrong_data.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="pandas_correlations.asp">Next &#10095;</a>
</div>
<hr>

<h2>Discovering Duplicates</h2>

<p>Duplicate rows are rows 
that have been registered more than one time.</p>
...
<pre>
  ...
  10        60  '2020/12/11'    103       147     329.3<span style="background-color:rgba(255,255,255,0.2)">
  11        60  '2020/12/12'    100       120     250.7
  12        60  '2020/12/12'    100       120     250.7</span>
...
<p>By taking a look at our test data set, we can assume that row 11 and 12 are duplicates.</p>

<p>To discover duplicates, we can use the <code class="w3-codespan">duplicated()</code> method.</p>

<p>The <code class="w3-codespan">duplicated()</code> method returns a Boolean values for each row:</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Returns <code class="w3-codespan">True</code> for every row that is a duplicate, 
  otherwise <code class="w3-codespan">False</code>:</p>
<div class="w3-code notranslate pythonHigh">
  print(df.duplicated())<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypandas.asp?filename=demo_pandas_cleaning_duplicated">Try it Yourself &raquo;</a>
</div>
...
<p>To remove duplicates, use the <code class="w3-codespan">drop_duplicates()</code> method.</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Remove all duplicates:</p>
<div class="w3-code notranslate pythonHigh">
  df.drop_duplicates(inplace = True)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypandas.asp?filename=demo_pandas_cleaning_drop_duplicates">Try it Yourself &raquo;</a>
</div>
<div class="w3-panel ws-note">
  <p><strong>Remember:</strong> The <code class="w3-codespan">(inplace = True)</code> will 
  make sure that the method does NOT return a <em>new</em> DataFrame, but it will remove all 
  duplicates from the <em>original</em> DataFrame.</p>
</div>


<hr>
<div id="exercisecontainer" src="xrcise_cleaning_duplicates.js"></div>
<hr>
