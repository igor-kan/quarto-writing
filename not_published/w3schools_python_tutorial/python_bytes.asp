...
<h1>Python <span class="color_h1">bytes</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_range.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_bytearray.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<p class="intro"><code class="w3-codespan">bytes</code> is an immutable sequence of integers in the range 0-255, typically used for binary data such as files, network protocols, and text encoded as UTF-8 or other encodings.</p>

<h2>Creating bytes</h2>
<p>You can create <code class="w3-codespan">bytes</code> from a literal, by encoding a string, or from an iterable of integers.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Create <code class="w3-codespan">bytes</code> and check its type:</p>
<div class="w3-code notranslate pythonHigh">
x = b"Hello"<br>
print(x)<br>
print(type(x))
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_type_bytes">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Encode a string to bytes and specify an encoding:</p>
<div class="w3-code notranslate pythonHigh">
s = "café"<br>
b = s.encode("utf-8")<br>
print(b)          # b'caf\xc3\xa9'<br>
print(list(b))    # [99, 97, 102, 195, 169]
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_type_bytes2">Try it Yourself &raquo;</a>
</div>

<h2>Working with bytes</h2>
<p>Bytes are immutable and support many sequence operations like indexing, slicing, iteration, and membership tests.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Index, slice, and iterate:</p>
<div class="w3-code notranslate pythonHigh">
b = b"ABCDEF"<br>
print(b[0])     # 65<br>
print(b[1:4])   # b'BCD'<br>
for byte in b:<br>
&nbsp;&nbsp;print(byte, end=" ")
</div>
</div>

<h2>Decoding bytes</h2>
<p>Use <code class="w3-codespan">bytes.decode()</code> to get back a string:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
b = b"caf\xc3\xa9"<br>
...
<hr>
<h2>See also</h2>
<p>Reference: <a href="ref_func_bytes.asp">bytes()</a></p>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_bytes.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_range.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_bytearray.asp">Next &#10095;</a>
