...
<html lang="en-US">
<head>
<title>SciPy Statistical Significance Tests</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>SciPy <span class="color_h1">Statistical Significance Tests</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="scipy_interpolation.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="scipy_exam.php">Next &#10095;</a>
</div>
<hr>

<h2>What is Statistical Significance Test?</h2>
<p>In statistics, statistical significance means that the result that was produced has a reason behind it, it was not produced randomly, or by chance.</p>

<p>SciPy provides us with a module called <code class="w3-codespan">scipy.stats</code>, which has functions for performing statistical significance tests.

<p>Here are some techniques and keywords that are important when performing such tests:</p>
<hr>
<h3>Hypothesis in Statistics</h3>

<p>Hypothesis is an assumption about a parameter in population.</p>
<hr>
<h3>Null Hypothesis</h3>
<p>It assumes that the observation is not statistically significant.</p>
<hr>
<h3>Alternate Hypothesis</h3>
<p>It assumes that the observations are due to some reason.</p>

<p>It's alternate to Null Hypothesis.</p>

<p><strong>Example:</strong></p>
<p>For an assessment of a student we would take:</p>
<p><em>"student is worse than average"</em> - as a null hypothesis,
and:</p>
<p><em>"student is better than average"</em> - as an alternate hypothesis.</p>
<hr>
<h3>One tailed test</h3>
<p>When our hypothesis is testing for one side of the value only, it is called &quot;one tailed test&quot;.</p>

<p><strong>Example:</strong></p>
<p>For the null hypothesis:</p>
<p><em>"the mean is equal to k", </em>we can have alternate hypothesis:</p>
<p><em>"the mean is less than k",</em> or:</p>
<p><em>"the mean is greater than k"</em></p>
<hr>
<h3>Two tailed test</h3>
<p>When our hypothesis is testing for both side of the values.</p>

<p><strong>Example:</strong></p>
<p>For the null hypothesis:</p>
<p><em>"the mean is equal to k", </em>we can have alternate hypothesis:</p>
<p><em>"the mean is not equal to k"</em></p>
<p>In this case the mean is less than, or greater than k, and both sides are to be checked.</p>
<hr>
<h3>Alpha value</h3>
<p>Alpha value is the level of significance.</p>
<p><strong>Example:</strong></p>
<p>How close to extremes the data must be for null hypothesis to be rejected.</p>

<p>It is usually taken as 0.01, 0.05, or 0.1.</p>
<hr>
<h3>P value</h3>

<p>P value tells how close to extreme the data actually is.</p>

<p>P value and alpha values are compared to establish the statistical significance.</p>

<p>If p value &lt;= alpha we reject the null hypothesis and say that the data is statistically significant.
otherwise we accept the null hypothesis.</p>
<hr>
...
<p>T-tests are used to determine if there is significant differnce between means of two variables
and lets us know if they belong to the same distribution.</p>

<p>It is a two tailed test.</p>

<p>The function <code class="w3-codespan">ttest_ind()</code> takes two samples of same size and produces a tuple of t-statistic and p-value.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Find if the given values v1 and v2 are from same distribution:</p>
<div class="w3-code notranslate pythonHigh">
import numpy as np<br>
from scipy.stats import ttest_ind<br>
<br>
v1 = np.random.normal(size=100)<br>
v2 = np.random.normal(size=100)<br>
<br>
res = ttest_ind(v1, v2)<br>
<br>
print(res)
</div>
<h3>Result:</h3>
<p>
<pre style="color:#fff;background-color:rgb(40,44,52)!important">

  Ttest_indResult(statistic=0.40833510339674095, pvalue=0.68346891833752133)

</pre>
</p>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_scipy_stat_sign_ttest_ind">Try it Yourself &raquo;</a>
</div>

<p>If you want to return only the p-value, use the <code class="w3-codespan">pvalue</code> property:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
...<br>
res = ttest_ind(v1, v2).pvalue<br>
<br>
print(res)
</div>
<h3>Result:</h3>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_scipy_stat_sign_ttest_ind2">Try it Yourself &raquo;</a>
</div>
...
<p>KS test is used to check if given values follow a distribution.</p>

<p>The function takes the value to be tested, and the CDF as two parameters.</p>

<div class="w3-panel ws-note">
  <p>A <strong>CDF</strong> can be either a string or a callable function that returns the probability.</p>
</div>

<p>It can be used as a one tailed or two tailed test.</p>

<p>By default it is two tailed. We can pass parameter alternative as a string of one of two-sided, less, or greater.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Find if the given value follows the normal distribution:</p>
<div class="w3-code notranslate pythonHigh">
import numpy as np<br>
from scipy.stats import kstest<br>
<br>
v = np.random.normal(size=100)<br>
<br>
res = kstest(v, 'norm')<br>
<br>
print(res)
</div>
<h3>Result:</h3>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_scipy_stat_sign_kstest">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Statistical Description of Data</h2>

<p>In order to see a summary of values in an array, we can use the <code class="w3-codespan">describe()</code> function.</p>

<p>It returns the following description:</p>
...
<div class="w3-example">
<h3>Example</h3>
<p>Show statistical description of the values in an array:</p>
<div class="w3-code notranslate pythonHigh">
import numpy as np<br>
from scipy.stats import describe<br>
<br>
v = np.random.normal(size=100)<br>
res = describe(v)<br>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_scipy_stat_sign_describe">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Normality Tests (Skewness and Kurtosis)</h2>

<p>Normality tests are based on the skewness and kurtosis.</p>

<p>The <code class="w3-codespan">normaltest()</code> function returns p value for the null hypothesis:</p>

<p><em>"x comes from a normal distribution"</em>.</p>

<hr>
<h3>Skewness:</h3>

<p>A measure of symmetry in data.</p>

<p>For normal distributions it is 0.</p>

<p>If it is negative, it means the data is skewed left.</p>

<p>If it is positive it means the data is skewed right.</p>

<hr>

<h3>Kurtosis:</h3>

<p>A measure of whether the data is heavy or lightly tailed to a normal distribution.</p>

<p>Positive kurtosis means heavy tailed.</p>

<p>Negative kurtosis means lightly tailed.</p>
...
<div class="w3-example">
<h3>Example</h3>
<p>Find skewness and kurtosis of values in an array:</p>
<div class="w3-code notranslate pythonHigh">
import numpy as np<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_scipy_stat_sign_skew">Try it Yourself &raquo;</a>
</div>


<div class="w3-example">
<h3>Example</h3>
<p>Find if the data comes from a normal distribution:</p>
<div class="w3-code notranslate pythonHigh">
import numpy as np<br>
from scipy.stats import normaltest<br>
<br>
v = np.random.normal(size=100)<br>
<br>
print(normaltest(v))</div>
<h3>Result:</h3>
<p>
<pre style="color:#fff;background-color:rgb(40,44,52)!important">
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_scipy_stat_sign_normaltest">Try it Yourself &raquo;</a>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_statistical_significance_tests.js" data-extensions="php"></div>
<hr>
