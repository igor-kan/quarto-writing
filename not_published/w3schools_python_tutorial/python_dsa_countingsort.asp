...
<html lang="en-US">
<head>
<title>DSA Counting Sort with Python</title>
<meta charset="utf-8">
...
<h1>DSA <span class="color_h1">Counting Sort</span> with Python</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="python_dsa_quicksort.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="python_dsa_radixsort.asp">Next &#10095;</a>
</div>
<hr>
...
<h2>Implement Counting Sort in Python</h2>
<p>To implement the Counting Sort algorithm in a Python program, we need:</p>
<ol>
...
<h3>Example</h3>
<p>Using the Counting Sort algorithm in a Python program:</p>
<div class="w3-code notranslate pythonHigh">
def countingSort(arr):<br>
&nbsp;&nbsp;max_val = max(arr)<br>
&nbsp;&nbsp;count = [0] * (max_val + 1)<br>
<br>
&nbsp;&nbsp;while len(arr) > 0:<br>
&nbsp;&nbsp;&nbsp;&nbsp;num = arr.pop(0)<br>
&nbsp;&nbsp;&nbsp;&nbsp;count[num] += 1<br>
...
&nbsp;&nbsp;return arr<br>
<br>
mylist = [4, 2, 2, 6, 3, 3, 1, 6, 5, 2, 3]<br>
mysortedlist = countingSort(mylist)<br>

print(mysortedlist)
</div>
  <a class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dsa_countingsort" target="_blank">Run Example »</a>
</div>
<hr>
...
<img src="/dsa/img_runtime_countingSort.png" class="imgTut" alt="Time Complexity">
