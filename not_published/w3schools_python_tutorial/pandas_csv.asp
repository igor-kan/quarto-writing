...
<h1>Pandas <span class="color_h1">Read CSV</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="pandas_dataframes.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="pandas_json.asp">Next &#10095;</a>
</div>
<hr>

<h2>Read CSV Files</h2>

<p>A simple way to store big data sets is to use CSV files (comma separated 
files).</p>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Load the CSV into a DataFrame:</p>
...
<div class="w3-panel ws-note">
  <p><strong>Tip:</strong> use <code class="w3-codespan">to_string()</code> to print the entire 
  DataFrame.</p>
</div>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Print the DataFrame without the <code class="w3-codespan">to_string()</code> 
  method:</p>
<div class="w3-code notranslate pythonHigh">
  import pandas as pd<br><br>df = pd.read_csv('data.csv')<br><br>print(df)&nbsp;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypandas.asp?filename=demo_pandas_csv_reduced">Try it Yourself &raquo;</a>
</div>
...
<p>You can check your system's maximum rows with the <code class="w3-codespan">pd.options.display.max_rows</code> statement.</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Check the number of maximum returned rows:</p>
<div class="w3-code notranslate pythonHigh">
  import pandas as pd<br><br>print(pd.options.display.max_rows)&nbsp;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypandas.asp?filename=demo_pandas_csv_max_rows">Try it Yourself &raquo;</a>
</div>

<p>In my system the number is 60, which means that if the DataFrame contains more than 60 rows,
the <code class="w3-codespan">print(df)</code> statement will return only the headers and the first and last 5 rows.</p>

<p>You can change the maximum rows number with the same statement.</p>
<div class="w3-example">
  <h3>Example</h3>
  <p>Increase the maximum number of rows to display the entire DataFrame:</p>
<div class="w3-code notranslate pythonHigh">
  import pandas as pd<br><br>pd.options.display.max_rows 
  = 9999<br><br>df = pd.read_csv('data.csv')<br><br>print(df)&nbsp;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypandas.asp?filename=demo_pandas_csv_set_max_rows">Try it Yourself &raquo;</a>
</div>
...
<hr>
<div id="exercisecontainer" src="xrcise_csv.js"></div>
