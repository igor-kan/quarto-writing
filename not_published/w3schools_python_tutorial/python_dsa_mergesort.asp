...
<html lang="en-US">
<head>
<title>DSA Merge Sort with Python</title>
<meta charset="utf-8">
...
<h1>DSA <span class="color_h1">Merge Sort</span> with Python</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="python_dsa_radixsort.asp">&#10094; Previous</a>
...
<img src="/dsa/img_mergesort_long.png" alt="Merge Sort" class="imgTut">
...
<p>Let's try to do the sorting manually, just to get an even better understanding of how Merge Sort works before actually implementing it in a Python program.</p>
...
<h2>Implement Merge Sort in Python</h2>
...
<h3>Example</h3>
<p>Implementing the Merge Sort algorithm in Python:</p>
...
&nbsp;&nbsp;mid = len(arr) // 2<br>
&nbsp;&nbsp;leftHalf = arr[:mid]<br>
&nbsp;&nbsp;rightHalf = arr[mid:]<br>
<br>
&nbsp;&nbsp;sortedLeft = mergeSort(leftHalf)<br>
&nbsp;&nbsp;sortedRight = mergeSort(rightHalf)<br>
<br>
...
&nbsp;&nbsp;return result<br>
<br>
mylist = [3, 7, 6, -10, 15, 23.5, 55, -13]<br>
mysortedlist = mergeSort(mylist)<br>
print("Sorted array:", mysortedlist)</div>
  <a class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dsa_mergesort" target="_blank">Run Example »</a>
</div>
...
<div class="w3-example">
<h3>Example</h3>
<p>A Merge sort without recursion</p>
<div class="w3-code notranslate pythonHigh">
def merge(left, right):<br>
&nbsp;&nbsp;result = []<br>
&nbsp;&nbsp;i = j = 0<br>
...
<br>
def mergeSort(arr):<br>
&nbsp;&nbsp;step = 1  # Starting with sub-arrays of length 1<br>
&nbsp;&nbsp;length = len(arr)<br>
<br>
&nbsp;&nbsp;while step < length:<br>
&nbsp;&nbsp;&nbsp;&nbsp;for i in range(0, length, 2 * step):<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;left = arr[i:i + step]<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;right = arr[i + step:i + 2 * step]<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; merged = merge(left, right)<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; # Place the merged array back into the original array<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; for j, val in enumerate(merged):<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; arr[i + j] = val<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;step *= 2  # Double the sub-array length for the next iteration<br>
<br>
&nbsp;&nbsp;return arr<br>
<br>
mylist = [3, 7, 6, -10, 15, 23.5, 55, -13]<br>
mysortedlist = mergeSort(mylist)<br>
print(mysortedlist)</div>
  <a class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dsa_mergesort2" target="_blank">Run Example »</a>
</div>
...
<p>The time complexity for Merge Sort is: \( O( n \cdot \log n ) \)</p>
<p>And the time complexity is pretty much the same for different kinds of arrays.
...
<img src="/dsa/img_runtime_mergesort.png" class="imgTut" alt="Time Complexity">
