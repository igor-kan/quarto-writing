...
<html lang="en-US">
<head>
<title>NumPy ufuncs - Simple Arithmetic</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="numpy_ufunc_create_function.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="numpy_ufunc_rounding_decimals.asp">Next &#10095;</a>
</div>
<hr>

<h2>Simple Arithmetic</h2>

<p>You could use arithmetic operators <code class="w3-codespan">+</code>
...
functions that can take any array-like objects e.g. lists, tuples etc. and perform arithmetic <em>conditionally</em>.</p>

<div class="w3-panel ws-note">
  <p><strong>Arithmetic Conditionally:</strong> means that we can define conditions where the arithmetic operation should happen.</p>
</div>

<p>All of the discussed arithmetic functions take a <code class="w3-codespan">where</code> parameter in which we can specify that condition.</p>

<hr>

<h2>Addition</h2>

<p>The <code class="w3-codespan">add()</code> function sums the content of two arrays, and 
return the results in a new array.</p>

<!--
<p>It is a ufunc so it also takes <code class="w3-codespan">where</code>,
<code class="w3-codespan">dtype</code> dtype and <code class="w3-codespan">out</code>.</p>
-->
<div class="w3-example">
<h3>Example</h3>
<p>Add the values in arr1 to the values in arr2:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr1 = np.array([10, 11, 12, 13, 14, 15])<br>arr2 = 
  np.array([20, 
  21, 22, 23, 24, 25])<br><br>newarr = np.add(arr1, arr2)<br><br>print(newarr)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ufunc_arithmetic1">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p>The example above will return [30 32 34 36 38 40] which is the sums of 10+20, 11+21, 12+22 etc.</p>
</div>
<!--
<div class="w3-example">
<h3>Example</h3>
<p>Add all of the elements in the arrays where the elements of <code class="w3-codespan">arr1</code> are even:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr1 = np.array([10, 11, 12, 13, 14, 15])<br>arr2 = 
  np.array([20, 
  21, 22, 23, 24, 25])<br><br>newarr = np.add(arr1, arr2, where=arr1%2==0)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_random_number">Try it Yourself &raquo;</a>
</div>
-->
...
<p>The <code class="w3-codespan">subtract()</code> function subtracts the values from one array with the values from 
another array,
and return the results in a new array.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Subtract the values in arr2 from the values in arr1:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr1 = np.array([10, 20, 30, 40, 50, 60])<br>arr2 = 
  np.array([20, 
  21, 22, 23, 24, 25])<br><br>newarr = np.subtract(arr1, arr2)<br><br>
  print(newarr)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ufunc_arithmetic2">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p>The example above will return [-10  -1   8  17  26  35] which is the result of 10-20, 20-21, 30-22 etc.</p>
</div>
...
<p>The <code class="w3-codespan">multiply()</code> function multiplies the values from one array with the values from 
another array,
and return the results in a new array.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Multiply the values in arr1 with the values in arr2:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr1 = np.array([10, 20, 30, 40, 50, 60])<br>arr2 = 
  np.array([20, 
  21, 22, 23, 24, 25])<br><br>newarr = np.multiply(arr1, arr2)<br><br>
  print(newarr)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ufunc_arithmetic3">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p>The example above will return [200  420  660  920 1200 1500] which is the result of 10*20, 20*21, 30*22 etc.</p>
</div>
...
<p>The <code class="w3-codespan">divide()</code> function divides the values from one array with the values from another array,
and return the results in a new array.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Divide the values in arr1 with the values in arr2:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr1 = np.array([10, 20, 30, 40, 50, 60])<br>arr2 = 
  np.array([3, 
  5, 10, 8, 2, 33])<br><br>newarr = np.divide(arr1, arr2)<br><br>
  print(newarr)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ufunc_arithmetic4">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p>The example above will return [3.33333333  4.          3.          5.         25.          1.81818182] which is the result of 10/3, 20/5, 30/10 etc.</p>
</div>
...
<p>The <code class="w3-codespan">power()</code> function rises the values from the first array to the power of the values of the second array,
and return the results in a new array.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Raise the valules in arr1 to the power of values in arr2:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr1 = np.array([10, 20, 30, 40, 50, 60])<br>arr2 = 
  np.array([3, 
  5, 6, 8, 2, 33])<br><br>newarr = np.power(arr1, arr2)<br><br>
  print(newarr)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ufunc_arithmetic5">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p>The example above will return [1000       3200000     729000000 6553600000000          2500
             0] which is the result of 10*10*10, 20*20*20*20*20, 30*30*30*30*30*30 etc.</p>
</div>
...
<p>Both the <code class="w3-codespan">mod()</code> and the <code class="w3-codespan">remainder()</code> functions
return the remainder of the values in the first array corresponding to the values in the second array, and return the results in a new array.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Return the remainders:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr1 = np.array([10, 20, 30, 40, 50, 60])<br>arr2 = 
  np.array([3, 7, 9, 8, 2, 33])<br><br>newarr = np.mod(arr1, arr2)<br><br>
  print(newarr)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ufunc_arithmetic6">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p>The example above will return [1  6  3  0  0 27] which is the remainders when you divide 10 with 3 (10%3), 20 with 7 (20%7) 30 with 9 (30%9) etc.</p>
</div>

<p>You get the same result when using the <code class="w3-codespan">remainder()</code> function:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Return the remainders:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr1 = np.array([10, 20, 30, 40, 50, 60])<br>arr2 = 
  np.array([3, 7, 9, 8, 2, 33])<br><br>newarr = np.remainder(arr1, arr2)<br><br>
  print(newarr)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ufunc_arithmetic7">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Quotient and Mod</h2>

<p>The <code class="w3-codespan">divmod()</code> function
return both the quotient and the mod. The return value is two arrays, the 
first array contains the quotient and second array contains the mod.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Return the quotient and mod:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr1 = np.array([10, 20, 30, 40, 50, 60])<br>arr2 = 
  np.array([3, 7, 9, 8, 2, 33])<br><br>newarr = np.divmod(arr1, arr2)<br><br>
  print(newarr)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ufunc_arithmetic8">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p>The example above will return:<br>
(array([3,  2,  3,  5, 25,  1]),
 array([1,  6,  3,  0,  0, 27]))<br>
The first array represents the quotients, 
  (the integer value when you divide 10 with 3, 20 with 7, 30 with 9 etc.<br>The second array represents the 
  remainders of the same divisions.</p>
</div>
...
<p>Both the <code class="w3-codespan">absolute()</code> and the <code class="w3-codespan">abs()</code> functions
 do the same absolute operation element-wise but we should use <code class="w3-codespan">absolute()</code> 
 to avoid confusion with python's inbuilt <code class="w3-codespan">math.abs()</code></p>

<div class="w3-example">
<h3>Example</h3>
<p>Return the absolute values of the array:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>
  arr = np.array([-1, -2, 1, 2, 3, -4])<br><br>newarr = np.absolute(arr)<br><br>
  print(newarr)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ufunc_arithmetic9">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p>The example above will return [1 2 1 2 3 4].</p>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_ufunc_simple_arithmetic.js"></div>
<hr>
