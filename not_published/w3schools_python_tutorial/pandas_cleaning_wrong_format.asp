...
<html lang="en-US">
<head>
<title>Pandas - Cleaning Data of Wrong Format</title>
<meta charset="utf-8">
...
<h1>Pandas - <span class="color_h1">Cleaning Data of Wrong Format</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="pandas_cleaning_empty_cells.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="pandas_cleaning_wrong_data.asp">Next &#10095;</a>
</div>
<hr>

<h2>Data of Wrong Format</h2>

<p>Cells with data of wrong format can make it difficult, or even impossible, to analyze data.</p>

<p>To fix it, you have two options: remove the rows, or convert all cells in the 
columns into the same format.</p>

<hr>

<h2>Convert Into a Correct Format</h2>

<p>In our Data Frame, we have two cells with the wrong format. Check out row 22 
and 26, the 'Date' column should be a string that represents a date:</p>
...
<pre>
  ...
  21        60  '2020/12/21'    108       131     364.2<span style="background-color:rgba(255,255,255,0.1)">
  22        45           NaN    100       119     282.0</span>
  23        60  '2020/12/23'    130       101     300.0
  24        45  '2020/12/24'    105       132     246.0
  25        60  '2020/12/25'    102       126     334.5<span style="background-color:rgba(255,255,255,0.1)">
  26        60      20201226    100       120     250.0</span>
...
<p>Let's try to convert all cells in the 'Date' column into dates.</p>
<p>Pandas has a <code class="w3-codespan">to_datetime()</code> method for this:</p>
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate pythonHigh">
    ...
    <br>
    df = pd.read_csv('data.csv')<br><br>df['Date'] = pd.to_datetime(df['Date'], 
    format='mixed')<br>
    <br>
    print(df.to_string())<br>
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypandas.asp?filename=demo_pandas_cleaning_to_datetime">Try it Yourself &raquo;</a>
<p>Result:</p>
<div style="background-color:rgb(40,44,52);color:#fff;">
<pre>
  ...
  20        45  '2020/12/20'     97       125     243.0
  21        60  '2020/12/21'    108       131     364.2<span style="background-color:rgba(255,255,255,0.1)">
  22        45           NaT    100       119     282.0</span>
  23        60  '2020/12/23'    130       101     300.0
  24        45  '2020/12/24'    105       132     246.0
  25        60  '2020/12/25'    102       126     334.5<span style="background-color:rgba(255,255,255,0.1)">
  26        60  '2020/12/26'    100       120     250.0</span>
  27        60  '2020/12/27'     92       118     241.0
  28        60  '2020/12/28'    103       132       NaN
  29        60  '2020/12/29'    100       132     280.0
  30        60  '2020/12/30'    102       129     380.3
...
<p>As you can see from the result, the date in row 26 was fixed,
but the empty date in row 22 got a NaT (Not a Time) value, in other words an 
empty value. One way to deal with empty values is simply removing the entire row.</p>
...
<p>The result from the converting in the example above gave us a NaT value, which can be handled as a NULL value, and we can remove the row by using the 
<code class="w3-codespan">dropna()</code> method.</p>
<div class="w3-example">
  <h3>Example</h3>
  <p>Remove rows with a NULL value in the &quot;Date&quot; column:</p>
  <div class="w3-code notranslate pythonHigh">
    df.dropna(subset=['Date'], inplace = True)<br>
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypandas.asp?filename=demo_pandas_cleaning_dropnat">Try it Yourself &raquo;</a>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_cleaning_wrong_format.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="pandas_cleaning_empty_cells.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="pandas_cleaning_wrong_data.asp">Next &#10095;</a>
