...
<html lang="en-US">
<head>
<title>Introduction to Random Numbers in NumPy</title>
<meta charset="utf-8">
...
<h1>Random Numbers in NumPy</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="numpy_array_filter.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="numpy_random_distribution.asp">Next &#10095;</a>
</div>
<hr>

<h2>What is a Random Number?</h2>
<p>Random number does NOT mean a different number every time. Random means something that can
not be predicted logically.</p>

<h2>Pseudo Random and True Random.</h2>

<p>Computers work on programs, and programs are definitive set of instructions. So it means there must be some
algorithm to generate a random number as well.</p>

<p>If there is a program to generate random number it can be
predicted, thus it is not truly random.</p>

<p>Random numbers generated through a generation algorithm are called <em>pseudo random</em>.</p>

<p>Can we make truly random numbers?</p>

<p>Yes. In order to generate a truly random number on our computers we need to get the random data from some
outside source. This outside source is generally our keystrokes, mouse movements, data on network
etc.</p>

<p>We do not need truly random numbers, unless it is related to security (e.g. encryption keys) or the basis of
application is the randomness (e.g. Digital roulette wheels).</p>

<p>In this tutorial we will be using pseudo random numbers.</p>

<hr>

<h2>Generate Random Number</h2>

<p>NumPy offers the <code class="w3-codespan">random</code> module to work with random numbers.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Generate a random integer from 0 to 100:</p>
<div class="w3-code notranslate pythonHigh">
  from numpy import random<br><br>x = random.randint(100)<br><br>print(x)</div>
...
<h2>Generate Random Float</h2>

<p>The random module's <code class="w3-codespan">rand()</code> method returns a random float between 0 and 1.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Generate a random float from 0 to 1:</p>
<div class="w3-code notranslate pythonHigh">
  from numpy import random<br><br>x = random.rand()<br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_random_float">Try it Yourself &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">randint()</code> method takes a <code class="w3-codespan">size</code>
parameter where you can specify the shape of an array.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Generate a 1-D array containing 5 random integers from 0 to 100:</p>
<div class="w3-code notranslate pythonHigh">
  from numpy import random<br><br>x=random.randint(100, size=(5))<br><br>
  print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_random_array">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Generate a 2-D array with 3 rows, each row containing 5 random integers from 0 
to 100:</p>
<div class="w3-code notranslate pythonHigh">
  from numpy import random<br><br>x = random.randint(100, size=(3, 5))<br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_random_2d_array">Try it Yourself &raquo;</a>
</div>

<h3>Floats</h3>

<p>The <code class="w3-codespan">rand()</code> method also allows you to specify 
the shape of the array.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Generate a 1-D array containing 5 random floats:</p>
<div class="w3-code notranslate pythonHigh">
  from numpy import random<br><br>x = random.rand(5)<br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_random_1d_float">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Generate a 2-D array with 3 rows, each row containing 5 random numbers:</p>
<div class="w3-code notranslate pythonHigh">
  from numpy import random<br><br>x = random.rand(3, 5)<br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_random_2d_float">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Generate Random Number From Array</h2>

<p>The <code class="w3-codespan">choice()</code> method allows you to generate a random value based on an array of values.</p>

<p>The <code class="w3-codespan">choice()</code> method takes an array as a 
parameter and randomly returns one of the values.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Return one of the values in an array:</p>
<div class="w3-code notranslate pythonHigh">
  from numpy import random<br><br>x = random.choice([3, 5, 7, 9])<br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_random_array2">Try it Yourself &raquo;</a>
</div>

<p>The <code class="w3-codespan">choice()</code> method also allows you to return an <em>array</em> of values.</p>
<p>Add a <code class="w3-codespan">size</code> parameter to specify the shape of the array.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Generate a 2-D array that consists of the values in the array parameter (3, 
5, 7, and 9):</p>
<div class="w3-code notranslate pythonHigh">
  from numpy import random<br><br>x = random.choice([3, 5, 7, 9], size=(3, 5))<br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_random_array3">Try it Yourself &raquo;</a>
</div>


<hr>
<div id="exercisecontainer" src="xrcise_random.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="numpy_array_filter.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="numpy_random_distribution.asp">Next &#10095;</a>
