...
<a class="w3-left w3-btn" href="numpy_random_poisson.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="numpy_random_logistic.asp">Next &#10095;</a>
</div>
<hr>

<h2>Uniform Distribution</h2>

<p>Used to describe probability where every event has equal chances of occuring.</p>

<p>E.g. Generation of random numbers.</p>

<p>It has three parameters:</p>

<p><code class="w3-codespan">low</code> - lower bound - default 0.0</p>
<p><code class="w3-codespan">high</code> - upper bound - default 1.0</p>
<p><code class="w3-codespan">size</code> - The shape of the returned array</p>

<div class="w3-example">
<h3>Example</h3>
<p>Create a 2x3 uniform distribution sample:</p>
<div class="w3-code notranslate pythonHigh">
  from numpy import random<br><br>x = random.uniform(size=(2, 3))<br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_random_uniform1">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Visualization of Uniform Distribution</h2>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  from numpy import random<br>import matplotlib.pyplot as plt<br>import seaborn as sns<br>
  <br>sns.displot(random.uniform(size=1000), kind=&quot;kde&quot;)<br><br>plt.show()</div>
<h3>Result</h3>
<p><img src="uniform_1.png" style="max-width:100%"></p>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_numpy_random_uniform2">Try it Yourself &raquo;</a>
</div>
...
<hr>
<div id="exercisecontainer" src="xrcise_random_uniform.js"></div>
<hr>
