...
<html lang="en-US">
<head>
<title>Insertion Sort with Python</title>
<meta charset="utf-8">
...
<h1>Insertion Sort with Python</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="python_dsa_selectionsort.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="python_dsa_quicksort.asp">Next &#10095;</a>
</div>
<hr>

<h2>Insertion Sort</h2>
<p>The Insertion Sort algorithm uses one part of the array to hold the sorted values,
...
<p>Before we implement the Insertion Sort algorithm in a Python program, let's manually run through a short array, just to get the idea.</p>
...
<h2>Implement Insertion Sort in Python</h2>
<p>To implement the Insertion Sort algorithm in a Python program, we need:</p>
<ol>
...
<h3>Example</h3>
<p>Using the Insertion Sort on a Python list:</p>
...
&nbsp;&nbsp;insert_index = i<br>
&nbsp;&nbsp;current_value = mylist.pop(i)<br>
&nbsp;&nbsp;for j in range(i-1, -1, -1):<br>
&nbsp;&nbsp;&nbsp;&nbsp;if mylist[j] > current_value:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;insert_index = j<br>
&nbsp;&nbsp;mylist.insert(insert_index, current_value)<br>
<br>
print(mylist)
</div>
  <a class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dsa_insertionsort" target="_blank">Run Example »</a>
</div>
<hr>
...
<img src="/dsa/img_array_removed_shifting.png" class="imgTut" alt="Removing an element from an array">
...
<img src="/dsa/img_array_inserted_shifting.png" class="imgTut" alt="Inserting an element into an array">
...
<p>You can read more about how arrays are stored in memory <a href="/dsa/dsa_theory_linkedlists_memory.php#arraysInMemory">here</a>.</p>
<hr>

<h2>Improved Solution</h2>
<p>We can avoid most of these shift operations by only shifting the values necessary:</p>
<img src="/dsa/img_array_inserted_shifting_improved.png" class="imgTut" alt="Moving an element in an array efficiently">
...
<div class="w3-example">
<h3>Example</h3>
<p>Insert the improvements in the sorting algorithm:</p>
<div class="w3-code notranslate pythonHigh">
mylist = [64, 34, 25, 12, 22, 11, 90, 5]<br>
<br>
n = len(mylist)<br>
for i in range(1,n):<br>
&nbsp;&nbsp;insert_index = i<br>
&nbsp;&nbsp;current_value = mylist[i]<br>
&nbsp;&nbsp;for j in range(i-1, -1, -1):<br>
&nbsp;&nbsp;&nbsp;&nbsp; if mylist[j] > current_value:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; mylist[j+1] = mylist[j]<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; insert_index = j<br>
&nbsp;&nbsp;&nbsp;&nbsp; else:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; break<br>
&nbsp;&nbsp;mylist[insert_index] = current_value<br>
<br>
print(mylist)</div>
  <a class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dsa_insertionsort_improvements" target="_blank">Run Example »</a>
</div>
...
<p>We get time complexity for Insertion Sort: \( O( \frac{n}{2} \cdot n) = {O(n^2)} \)</p>

<p>The time complexity for Insertion Sort can be displayed like this:</p>
<img src="/dsa/img_runtime_bubbleSort.png" alt="Time Complexity for Insertion Sort">


<p>For Insertion Sort, there is a big difference between best, average and worst case scenarios.</p>
