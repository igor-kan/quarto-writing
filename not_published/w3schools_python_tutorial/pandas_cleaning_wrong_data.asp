...
<html lang="en-US">
<head>
<title>Pandas - Cleaning Data</title>
<meta charset="utf-8">
...
<h1>Pandas - <span class="color_h1">Fixing Wrong Data</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="pandas_cleaning_wrong_format.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="pandas_cleaning_duplicates.asp">Next &#10095;</a>
</div>
<hr>

<h2>Wrong Data</h2>

<p>&quot;Wrong data&quot; does not have to be &quot;empty cells&quot; or &quot;wrong format&quot;, it can  
just be wrong, like if someone registered &quot;199&quot; instead of &quot;1.99&quot;.</p>
<p>Sometimes you can spot wrong data by looking at the data set, because you have an expectation of what 
it should be.</p>

<p>If you take a look at our data set, you can see that in row 7, the duration is 450, but for all the other rows the duration is between 30 and 60.</p>

<p>It doesn't have to be wrong, but taking in consideration that this is the data set of someone's workout 
sessions,
we conclude with the fact that this person did not work out in 450 minutes.</p>
...
<pre>
  ...
  6         60  '2020/12/07'    110       136     374.0<span style="background-color:rgba(255,255,255,0.1)">
  7        450  '2020/12/08'    104       134     253.3</span>
...
<p>How can we fix wrong values, like the one for &quot;Duration&quot; in row 7?</p>
...
<p>In our example, it is most likely a typo, and the value should be &quot;45&quot; instead of &quot;450&quot;, and 
we 
could just insert &quot;45&quot; in row 7:</p>


<div class="w3-example">
  <h3>Example</h3>
  <p>Set &quot;Duration&quot; = 45 in row 7:</p>
<div class="w3-code notranslate pythonHigh">
  df.loc[7, 'Duration'] = 45<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypandas.asp?filename=demo_pandas_cleaning_wrong_data1">Try it Yourself &raquo;</a>
</div>

<p>For small data sets you might be able to replace the wrong data one by one, 
but not for big data sets.</p>
<p>To replace wrong data for larger data sets you can create some rules, e.g. 
set some boundaries for legal values, and replace any values that are outside of the 
boundaries.</p>
<div class="w3-example">
  <h3>Example</h3>
  <p>Loop through all values in the &quot;Duration&quot; column.</p>
  <p>If the value is higher than 120, set it to 120:</p>
<div class="w3-code notranslate pythonHigh">
  for x in df.index: <br>&nbsp; if df.loc[x, &quot;Duration&quot;] &gt; 120:<br>&nbsp;&nbsp;&nbsp; 
  df.loc[x, &quot;Duration&quot;] = 120</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypandas.asp?filename=demo_pandas_cleaning_wrong_data2">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Removing Rows</h2>
<p>Another way of handling wrong data is to remove the rows that contains wrong data.</p>

<p>This way you do not have to find out what to replace them with, and there is 
a good chance you do not need them to do your analyses.</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Delete rows where "Duration" is higher than 120:</p>
<div class="w3-code notranslate pythonHigh">
  for x in df.index: <br>&nbsp; if df.loc[x, &quot;Duration&quot;] &gt; 120:<br>&nbsp;&nbsp;&nbsp; 
  df.drop(x, inplace = True)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypandas.asp?filename=demo_pandas_cleaning_wrong_data3">Try it Yourself &raquo;</a>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_cleaning_wrong_data.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="pandas_cleaning_wrong_format.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="pandas_cleaning_duplicates.asp">Next &#10095;</a>
