...
<h1>Python <span class="color_h1">memoryview</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_bytearray.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_frozenset.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<p class="intro"><code class="w3-codespan">memoryview</code> provides a Python-level view of the internal data of an object that supports the buffer protocol (like <code class="w3-codespan">bytes</code> and <code class="w3-codespan">bytearray</code>), without copying the data.</p>

<h2>Creating a memoryview</h2>
<p>Wrap a bytes-like object with <code class="w3-codespan">memoryview()</code> to access its contents efficiently.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Create a memoryview from bytes and inspect its type:</p>
<div class="w3-code notranslate pythonHigh">
x = memoryview(bytes(5))<br>
print(x)<br>
print(type(x))<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_type_memoryview">Try it Yourself &raquo;</a>
</div>

<h2>Slicing and modifying via memoryview</h2>
<p>When the underlying object is mutable (e.g. <code class="w3-codespan">bytearray</code>), you can modify the data through the memoryview without copying.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Slice and assign through a memoryview:</p>
<div class="w3-code notranslate pythonHigh">
b = bytearray(b"abcdef")<br>
v = memoryview(b)<br>
print(v[1:4].tobytes())  # b'bcd'<br>
v[0] = ord('Z')          # modify original buffer<br>
print(b)                  # bytearray(b"Zbcdef")<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_type_memoryview2">Try it Yourself &raquo;</a>
</div>

<h2>Converting back</h2>
<p>Use <code class="w3-codespan">.tobytes()</code> or convert to <code class="w3-codespan">bytes()</code> when you need a copy of the data.</p>

<!--stop-->
<hr>
<!--start-->
<h2>See also</h2>
<p>Reference: <a href="ref_func_memoryview.asp">memoryview()</a></p>
<!--stop-->
<hr>
...
<hr>
<div id="exercisecontainer" src="xrcise_memoryview.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_bytearray.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_frozenset.asp">Next &#10095;</a>
