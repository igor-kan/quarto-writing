...
<a class="w3-left w3-btn" href="numpy_random_permutation.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="numpy_random_normal.asp">Next &#10095;</a>
</div>
<hr>
...
<img src="seaborn_2.png" style="max-width:100%">

<h2>Install Seaborn.</h2>

<p>If you have <a href="/python/default.asp">Python</a> and <a href="/python/python_pip.asp">PIP</a> already installed on a system, install it using this command:</p>

<div class="w3-example">
<div class="w3-code notranslate w3-black">
C:\Users\<em>Your Name</em>&gt;pip install seaborn</div>
</div>

<p>If you use Jupyter, install Seaborn using this command:</p>
...
<h2>Plotting a Displot</h2>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  import matplotlib.pyplot as plt<br>import seaborn as sns<br><br>sns.displot([0, 1, 
  2, 3, 4, 5])<br><br>
  plt.show()</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_numpy_random_seaborn_displot1">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Plotting a Displot Without the Histogram</h2>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  import matplotlib.pyplot as plt<br>import seaborn as sns<br><br>sns.displot([0, 1, 
  2, 3, 4, 5], kind="kde")<br><br>
  plt.show()</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_numpy_random_seaborn_displot2">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> We will be using: <code class="w3-codespan">sns.displot(arr, kind="kde")</code> to visualize random distributions in this tutorial.</p>
</div>
