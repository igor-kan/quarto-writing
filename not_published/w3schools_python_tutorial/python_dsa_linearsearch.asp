...
<html lang="en-US">
<head>
<title>Linear Search with Python</title>
<meta charset="utf-8">
...
<h1>Linear Search with Python</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="python_dsa_graphs.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="python_dsa_binarysearch.asp">Next &#10095;</a>
</div>
<hr>

<h2>Linear Search</h2>
<p>Linear search (or sequential search) is the simplest search algorithm. It checks each element one by one.</p>

<div id="vueApp">
  
  <p><input type="hidden" step="1" min="1" max="10" v-model="targetHeight" :disabled="inpIsDisabled"></p>
...
const app = Vue.createApp({
  data() {
    return {
      ...
      dice: [],
      keyNumber: 0,
      buttonText: 'Search for the value 4',
      targetPos: 0,
      targetHeight: 4,
      inpIsDisabled: false
    }
  ...
  methods: {
    action(){
      if(this.buttonText === "Search for the value 4") {
        this.linearSearch();
      }
      else {
        this.addDie50();
    ...
    async linearSearch() {
      ...
      if(this.currIndex===this.dice.length){
        ...
        this.msgDone = 'Found 4 at index: '+this.currIndex;
        this.buttonText = "Reset";
        this.btnIsDisabled = false;
    ...
    addDie50() {
      ...
      this.buttonText = "Search for the value 4";
      this.msgDone = '';
    }
  },
  mounted() {
...
<div class="ws-note">
<p>If the array is already sorted, it is better to use the much faster <a href="python_dsa_binarysearch.asp">Binary Search algorithm</a> that we will explore on the next page.</p>
</div>
...
<h2>Implement Linear Search in Python</h2>

<p>In Python, the fastest way check if a value exists in a list is to use the <code class="w3-codespan">in</code> operator.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Check if a value exists in a list:</p>
<div class="w3-code notranslate pythonHigh">
mylist = [3, 7, 2, 9, 5, 1, 8, 4, 6]<br>
<br>
if 4 in mylist:<br>
&nbsp;&nbsp;print("Found!")<br>
else:<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dsa_linearsearch">Try it Yourself &raquo;</a>
</div>

<p>But if you need to find the index of a value, you will need to implement a linear search:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Find the index of a value in a list:</p>
<div class="w3-code notranslate pythonHigh">  
def linearSearch(arr, targetVal):<br>
&nbsp;&nbsp;for i in range(len(arr)):<br>
&nbsp;&nbsp;&nbsp;&nbsp;if arr[i] == targetVal:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return i<br>
&nbsp;&nbsp;return -1<br>
<br>
mylist = [3, 7, 2, 9, 5, 1, 8, 4, 6]<br>
x = 4<br>
<br>
result = linearSearch(mylist, x)<br>
<br>
if result != -1:<br>
&nbsp;&nbsp;print("Found at index", result)<br>
else:<br>
&nbsp;&nbsp;print("Not found")</div>
  <a class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dsa_linearsearch_index" target="_blank">Run Example �</a>
</div>
...
<p>This means that time complexity for Linear Search is: \( O(n) \)</p>
<p>If we draw how much time Linear Search needs to find a value in an array of \(n\) values, we get this graph:</p>
<img src="/dsa/img_linearsearch_timecomplexity.png" class="imgTut" alt="Time Complexity">
<hr>
