...
<html lang="en-US">
<head>
<title>DSA Radix Sort with Python</title>
<meta charset="utf-8">
...
<h1>DSA <span class="color_h1">Radix Sort</span> with Python</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="python_dsa_countingsort.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="python_dsa_mergesort.asp">Next &#10095;</a>
</div>
<hr>
...
<h2>Implement Radix Sort in Python</h2>
...
<h3>Example</h3>
<p>Using the Radix Sort algorithm in a Python program:</p>
<div class="w3-code notranslate pythonHigh">
mylist = [170, 45, 75, 90, 802, 24, 2, 66]<br>
print("Original array:", mylist)<br>
radixArray = [[], [], [], [], [], [], [], [], [], []]<br>
maxVal = max(mylist)<br>
exp = 1<br>
<br>
while maxVal // exp > 0:<br>
<br>
&nbsp;&nbsp;while len(mylist) > 0:<br>
&nbsp;&nbsp;&nbsp;&nbsp;val = mylist.pop() <br>
&nbsp;&nbsp;&nbsp;&nbsp;radixIndex = (val // exp) % 10<br>
&nbsp;&nbsp;&nbsp;&nbsp;radixArray[radixIndex].append(val)<br>
<br>
&nbsp;&nbsp;for bucket in radixArray:<br>
&nbsp;&nbsp;&nbsp;&nbsp;while len(bucket) > 0:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;val = bucket.pop() <br>
...
<br>
print(mylist)</div>
  <a class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dsa_radixsort" target="_blank">Run Example »</a>
</div>
...
<div class="w3-example">
<h3>Example</h3>
<p>A Radix Sort algorithm that uses Bubble Sort:</p>
<div class="w3-code notranslate pythonHigh">
...
<br>                
def radixSortWithBubbleSort(arr):<br>
&nbsp;&nbsp;max_val = max(arr)<br>
&nbsp;&nbsp;exp = 1<br>
<br>
...
<br>
&nbsp;&nbsp;&nbsp;&nbsp;for num in arr:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;radixIndex = (num // exp) % 10<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;radixList[radixIndex].append(num)<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;for bucket in radixList:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;bubbleSort(bucket)<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;i = 0<br>
&nbsp;&nbsp;&nbsp;&nbsp;for bucket in radixList:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;for num in bucket:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;arr[i] = num<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;i += 1<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;exp *= 10<br>
...
mylist = [170, 45, 75, 90, 802, 24, 2, 66]<br>
<br>
radixSortWithBubbleSort(mylist)<br>
<br>
print(mylist)
</div>
  <a class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dsa_radixsort2" target="_blank">Run Example »</a>
</div>
<hr>

<h2>Radix Sort Time Complexity</h2>
<p>The time complexity for Radix Sort is: \( O(n \cdot k) \)</p>
...
<img src="/dsa/img_runtime_radixsort.png" class="imgTut" alt="Time Complexity">
