...
<a class="w3-left w3-btn" href="numpy_random_chisquare.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="numpy_random_pareto.asp">Next &#10095;</a>
</div>
<hr>

<h2>Rayleigh Distribution</h2>

<p>Rayleigh distribution is used in signal processing.</p>

<p>It has two parameters:</p>

<p><code class="w3-codespan">scale</code> - (standard deviation) decides how flat the distribution will be  default 1.0).</p>
<p><code class="w3-codespan">size</code> - The shape of the returned array.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Draw out a sample for rayleigh distribution with scale of 2 with size 2x3:</p>
<div class="w3-code notranslate pythonHigh">
  from numpy import random<br><br>x = random.rayleigh(scale=2, size=(2, 3))<br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_random_rayleigh1">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Visualization of Rayleigh Distribution</h2>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  from numpy import random<br>import matplotlib.pyplot as plt<br>import seaborn as sns<br>
  <br>sns.displot(random.rayleigh(size=1000), kind="kde")<br><br>plt.show()</div>
<h3>Result</h3>
<p><img src="rayleigh_1.png" style="max-width:100%"></p>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_numpy_random_rayleigh2">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Similarity Between Rayleigh and Chi Square Distribution</h2>
...
<hr>
<div id="exercisecontainer" src="xrcise_random_rayleigh.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="numpy_random_chisquare.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="numpy_random_pareto.asp">Next &#10095;</a>
