...
<html lang="en-US">
<head>
<title>NumPy ufuncs - GCD - Greatest Common Divisor</title>
<meta charset="utf-8">
...
<h1>NumPy GCD Greatest Common Divisor</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="numpy_ufunc_lcm.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="numpy_ufunc_trigonometric.asp">Next &#10095;</a>
</div>
<hr>

<h2>Finding GCD (Greatest Common Divisor)</h2>

<p>The GCD (Greatest Common Divisor), also known as HCF (Highest Common Factor) is the biggest number that is a common factor of both of the numbers.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Find the HCF of the following two numbers:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>num1 = 6<br>num2 = 9<br><br>x = np.gcd(num1, num2)<br>
  <br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ufunc_gcd1">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p><strong>Returns:</strong> <code class="w3-codespan">3</code> because that is the 
  highest number both numbers can be divided by (6/3=2 and 9/3=3).</p>
</div>

<hr>

<h2>Finding GCD in Arrays</h2>

<p>To find the Highest Common Factor of all values in an array, you can use the <code class="w3-codespan">reduce()</code> method.</p>

<div class="w3-panel ws-note">
  <p>The <code class="w3-codespan">reduce()</code> method will use the ufunc, in this case the
  <code class="w3-codespan">gcd()</code> function, on each element, and reduce the array 
  by one dimension.</p>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Find the GCD for all of the numbers in the following array:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr = np.array([20, 8, 32, 36, 16])<br><br>x = 
  np.gcd.reduce(arr)<br>
  <br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ufunc_gcd2">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p><strong>Returns:</strong> <code class="w3-codespan">4</code> because that is the 
  highest number all values can be divided by.</p>
</div>
...
<hr>
<div id="exercisecontainer" src="xrcise_ufunc_gcd.js"></div>
<hr>
