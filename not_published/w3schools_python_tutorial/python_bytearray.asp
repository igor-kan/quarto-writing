...
<h1>Python <span class="color_h1">bytearray</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_bytes.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_memoryview.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<p class="intro"><code class="w3-codespan">bytearray</code> is a mutable sequence of integers in the range 0-255. It is useful when you need a modifiable sequence of bytes.</p>

<h2>Creating bytearrays</h2>
<p>Create a <code class="w3-codespan">bytearray</code> from size, from an iterable of integers, or by decoding bytes.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Create and inspect a <code class="w3-codespan">bytearray</code>:</p>
<div class="w3-code notranslate pythonHigh">
x = bytearray(5)<br>
print(x)<br>
print(type(x))<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_type_bytearray">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Initialize from values and modify items (mutable):</p>
<div class="w3-code notranslate pythonHigh">
b = bytearray([65, 66, 67])<br>
print(b)        # bytearray(b'ABC')<br>
b[0] = 97       # change 'A' to 'a'<br>
print(b)        # bytearray(b'aBC')<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_type_bytearray2">Try it Yourself &raquo;</a>
</div>

<h2>Common operations</h2>
<ul>
<li>Supports indexing, slicing, appending, extending, and methods like <code class="w3-codespan">.find()</code> and <code class="w3-codespan">.replace()</code>.</li>
<li>Can be converted to <code class="w3-codespan">bytes</code> with <code class="w3-codespan">bytes(barr)</code>.</li>
</ul>

<div class="w3-example">
<h3>Example</h3>
<p>Append and decode:</p>
<div class="w3-code notranslate pythonHigh">
b = bytearray(b"Hello ")<br>
b.extend(b"World")<br>
print(b)<br>
print(b.decode("utf-8"))<br>
</div>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>See also</h2>
<p>Reference: <a href="ref_func_bytearray.asp">bytearray()</a></p>
<!--stop-->
<hr>
...
<hr>
<div id="exercisecontainer" src="xrcise_bytearray.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_bytes.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_memoryview.asp">Next &#10095;</a>
