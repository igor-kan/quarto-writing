...
<html lang="en-US">
<head>
<title>Pandas Getting Started</title>
<meta charset="utf-8">
...
<h1>Pandas <span class="color_h1">Getting Started</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="pandas_intro.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="pandas_series.asp">Next &#10095;</a>
</div>
<hr>

<h2>Installation of Pandas</h2>
<p>If you have <a href="/python/default.asp">Python</a> and <a href="/python/python_pip.asp">PIP</a> already installed on a system, then installation of Pandas is very easy.</p>
<p>Install it using this command:</p>

<div class="w3-example">
<div class="w3-code notranslate w3-black">
C:\Users\<em>Your Name</em>&gt;pip install pandas</div>
</div>
...
<h2>Import Pandas</h2>
<p>Once Pandas is installed, import it in your applications by adding the
<code class="w3-codespan">import</code> keyword:</p>
...
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  import pandas<br><br>mydataset = {<br>&nbsp; 'cars': [&quot;BMW&quot;, &quot;Volvo&quot;, &quot;Ford&quot;],
  <br>&nbsp; 'passings': [3, 7, 2]<br>}<br><br>myvar = pandas.DataFrame(mydataset)<br>
  <br>print(myvar)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_pandas1">Try it Yourself &raquo;</a>
</div>
...
<p>Pandas is usually imported under the <code class="w3-codespan">pd</code> 
alias.</p>

<div class="w3-panel ws-note">
  <p><strong>alias:</strong> In Python alias are an alternate name for referring 
  to the same thing.</p>
</div>

<p>Create an alias with the <code class="w3-codespan">as</code> keyword while importing:</p>
...
<p>Now the Pandas package can be referred to as <code class="w3-codespan">pd</code> instead of 
<code class="w3-codespan">pandas</code>.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
import pandas as pd
<br><br>mydataset = {<br>&nbsp; 'cars': [&quot;BMW&quot;, &quot;Volvo&quot;, &quot;Ford&quot;], <br>&nbsp; 'passings': 
  [3, 7, 2]<br>}<br><br>myvar = pd.DataFrame(mydataset)<br>
  <br>print(myvar)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_pandas_pd">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Checking Pandas Version</h2>
...
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  import pandas as pd<br><br>print(pd.__version__)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_pandas_version">Try it Yourself &raquo;</a>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_getting_started.js"></div>
<hr>
