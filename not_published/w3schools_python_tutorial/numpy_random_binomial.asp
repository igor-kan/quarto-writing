...
<a class="w3-left w3-btn" href="numpy_random_normal.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="numpy_random_poisson.asp">Next &#10095;</a>
</div>
<hr>

<h2>Binomial Distribution</h2>

<p>Binomial Distribution is a <em>Discrete Distribution</em>.</p>

<p>It describes the outcome of binary scenarios, e.g. toss of a coin, it will either be head or tails.</p>

<p>It has three parameters:</p>

<p><code class="w3-codespan">n</code> - number of trials.</p>
<p><code class="w3-codespan">p</code> - probability of occurrence of each trial (e.g. for toss of a coin 0.5 each).</p>
<p><code class="w3-codespan">size</code> - The shape of the returned array.</p>

<div class="w3-panel ws-note">
  <p><strong>Discrete Distribution:</strong>The distribution is defined at separate set of events,
   e.g. a coin toss's result is discrete as it can be only head or tails whereas height of people is continuous 
   as it can be 170, 170.1, 170.11 and so on.</p>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Given 10 trials for coin toss generate 10 data points:</p>
<div class="w3-code notranslate pythonHigh">
  from numpy import random<br><br>x = random.binomial(n=10, p=0.5, size=10)<br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_random_binomial1">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Visualization of Binomial Distribution</h2>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  from numpy import random<br>import matplotlib.pyplot as plt<br>import seaborn as sns<br>
  <br>sns.displot(random.binomial(n=10, p=0.5, size=1000))<br><br>plt.show()</div>
<h3>Result</h3>
<p><img src="bionomial_1.png" style="max-width:100%"></p>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_numpy_random_binomial2">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Difference Between Normal and Binomial Distribution</h2>

<p>The main difference is that normal distribution is continous whereas binomial is discrete,
but if there are enough data points it will be quite similar to normal distribution with certain loc and scale.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  from numpy import random<br>import matplotlib.pyplot as plt<br>import seaborn as sns<br>
  <br>data = {<br>&nbsp; &quot;normal&quot;: random.normal(loc=50, scale=5, size=1000),<br>&nbsp; 
  &quot;binomial&quot;: random.binomial(n=100, p=0.5, size=1000)<br>}<br><br>
  sns.displot(data, kind=&quot;kde&quot;)<br><br>plt.show()</div>
<h3>Result</h3>
<p><img src="binomial_2.png" style="max-width:100%"></p>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_numpy_random_binomial3">Try it Yourself &raquo;</a>
</div>
...
<hr>
<div id="exercisecontainer" src="xrcise_random_binomial.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="numpy_random_normal.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="numpy_random_poisson.asp">Next &#10095;</a>
