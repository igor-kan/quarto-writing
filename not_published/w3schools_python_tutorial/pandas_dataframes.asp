...
<h1>Pandas <span class="color_h1">DataFrames</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="pandas_series.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="pandas_csv.asp">Next &#10095;</a>
</div>
<hr>

<h2>What is a DataFrame?</h2>

<p>A Pandas DataFrame is a 2 dimensional data structure, like a 2 dimensional 
array, or a table with rows and columns.</p>
<div class="w3-example">
  <h3>Example</h3>
  <p>Create a simple Pandas DataFrame:</p>
<div class="w3-code notranslate pythonHigh">
import pandas as pd
<br><br>data = {<br>&nbsp; &quot;calories&quot;: [420, 380, 390],<br>&nbsp; &quot;duration&quot;: 
  [50, 40, 45]<br>}<br><br>#load data into a DataFrame object:<br>df = pd.DataFrame(data)<br>
  <br>print(df)&nbsp;
</div>
<h2>Result</h2>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_pandas_dataframes1">Try it Yourself &raquo;</a>
</div>
...
<p>Pandas use the <code class="w3-codespan">loc</code> attribute to return  
one or more specified row(s)</p>
<div class="w3-example">
  <h3>Example</h3>
  <p>Return row 0:</p>
<div class="w3-code notranslate pythonHigh">
#refer to the row index:<br>
print(df.loc[0])
</div>
<h2>Result</h2>
<div style="background-color:rgb(40,44,52);color:#fff;">
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_pandas_df_loc">Try it Yourself &raquo;</a>
</div>
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> This example returns a Pandas <strong>Series</strong>.</p>
</div>

<div class="w3-example">
  <h3>Example</h3>
  <p>Return row 0 and 1:</p>
<div class="w3-code notranslate pythonHigh">
#use a list of indexes:<br>
print(df.loc[[0, 1]])
</div>
<h2>Result</h2>
<div style="background-color:rgb(40,44,52);color:#fff;">
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_pandas_df_loc2">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> When using <code class="w3-codespan">[]</code>, the 
  result is a Pandas <strong>DataFrame</strong>.</p>
</div>
...
<p>With the <code class="w3-codespan">index</code> argument, you can name your own indexes.</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Add a list of names to give each row a name:</p>
<div class="w3-code notranslate pythonHigh">
import pandas as pd
<br><br>data = {<br>&nbsp; &quot;calories&quot;: [420, 380, 390],<br>&nbsp; &quot;duration&quot;: 
  [50, 40, 45]<br>}<br><br>df = pd.DataFrame(data, index = [&quot;day1&quot;, &quot;day2&quot;, 
  &quot;day3&quot;])<br>
  <br>print(df)&nbsp;
</div>
<h2>Result</h2>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_pandas_df_index">Try it Yourself &raquo;</a>
</div>

<h2>Locate Named Indexes</h2>
<p>
Use the named index in the <code class="w3-codespan">loc</code> attribute to return the specified row(s).
</p>
<div class="w3-example">
  <h3>Example</h3>
  <p>Return "day2":</p>
<div class="w3-code notranslate pythonHigh">
#refer to the named index:<br>
print(df.loc["day2"])
</div>
<h2>Result</h2>
<div style="background-color:rgb(40,44,52);color:#fff;">
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_pandas_df_named_index">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Load Files Into a DataFrame</h2>

<p>If your data sets are stored in a file, Pandas can load them into a DataFrame.</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Load a comma separated file (CSV file) into a DataFrame:</p>
<div class="w3-code notranslate pythonHigh">
  import pandas as pd<br><br>df = pd.read_csv('data.csv')<br><br>print(df)&nbsp;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypandas.asp?filename=demo_pandas_df">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p>You will learn more about importing files in the next chapters.</p>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_dataframes.js"></div>
<hr>
