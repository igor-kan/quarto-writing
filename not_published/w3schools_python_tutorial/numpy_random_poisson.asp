...
<a class="w3-left w3-btn" href="numpy_random_binomial.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="numpy_random_uniform.asp">Next &#10095;</a>
</div>
<hr>

<h2>Poisson Distribution</h2>

<p>Poisson Distribution is a <em>Discrete Distribution</em>.</p>

<p>It estimates how many times an event can happen in a specified time.
e.g. If someone eats twice a day what is the probability he will eat thrice?</p>

<p>It has two parameters:</p>

<p><code class="w3-codespan">lam</code> - rate or known number of occurrences e.g. 2 for above problem.</p>
<p><code class="w3-codespan">size</code> - The shape of the returned array.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Generate a random 1x10 distribution for occurrence 2:</p>
<div class="w3-code notranslate pythonHigh">
  from numpy import random<br><br>x = random.poisson(lam=2, size=10)<br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_random_poisson1">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Visualization of Poisson Distribution</h2>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  from numpy import random<br>import matplotlib.pyplot as plt<br>import seaborn as sns<br>
  <br>sns.displot(random.poisson(lam=2, size=1000))<br><br>plt.show()</div>
<h3>Result</h3>
<p><img src="poisson_1.png" style="max-width:100%"></p>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_numpy_random_poisson2">Try it Yourself &raquo;</a>
</div>
...
<h2>Difference Between Normal and Poisson Distribution</h2>

<p>Normal distribution is continuous whereas poisson is discrete.</p>

<p>But we can see that similar to binomial for a large enough poisson distribution it will become similar to normal distribution with certain std dev and mean.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  from numpy import random<br>import matplotlib.pyplot as plt<br>import seaborn as sns<br>
  <br>data = {<br>&nbsp; &quot;normal&quot;: random.normal(loc=50, scale=7, size=1000),<br>&nbsp; 
  &quot;poisson&quot;: random.poisson(lam=50, size=1000)<br>}<br><br>sns.displot(data, 
  kind=&quot;kde&quot;)<br><br>plt.show()</div>
<h3>Result</h3>
<p><img src="poisson2.png" style="max-width:100%"></p>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_numpy_random_poisson3">Try it Yourself &raquo;</a>
</div>


<hr>

<h2>Difference Between Binomial and Poisson Distribution </h2>

<p>Binomial distribution only has two possible outcomes, whereas poisson distribution 
can have unlimited possible outcomes.</p>

<p>But for very large <code class="w3-codespan">n</code> and near-zero <code class="w3-codespan">p</code> binomial 
distribution is near identical to poisson distribution such that <code class="w3-codespan">n * p</code> is nearly equal to <code class="w3-codespan">lam</code>.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  from numpy import random<br>import matplotlib.pyplot as plt<br>import seaborn as sns<br>
  <br>data = {<br>&nbsp; &quot;binomial&quot;: random.binomial(n=1000, p=0.01, size=1000),<br>&nbsp; 
  &quot;poisson&quot;: random.poisson(lam=10, size=1000)<br>}<br><br>sns.displot(data, 
  kind=&quot;kde&quot;)<br><br>plt.show()</div>
<h3>Result</h3>
<p><img src="poisson_3.png" style="max-width:100%"></p>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_numpy_random_poisson4">Try it Yourself &raquo;</a>
</div>


<hr>
<div id="exercisecontainer" src="xrcise_random_poisson.js"></div>
<hr>
