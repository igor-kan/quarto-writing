...
<html lang="en-US">
<head>
<title>NumPy ufuncs - Rouning Decimals</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="numpy_ufunc_simple_arithmetic.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="numpy_ufunc_logs.asp">Next &#10095;</a>
</div>
<hr>
...
<p>Remove the decimals, and return the float number closest to zero. Use the <code class="w3-codespan">trunc()</code> and <code class="w3-codespan">fix()</code> functions.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Truncate elements of following array:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr = np.trunc([-3.1666, 3.6667])<br><br>print(arr)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ufunc_rounding1">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Same example, using <code class="w3-codespan">fix()</code>:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr = np.fix([-3.1666, 3.6667])<br><br>print(arr)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ufunc_rounding1_2">Try it Yourself &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">around()</code> function increments preceding digit or decimal by 1 if >=5 else do nothing.</p>
<p>E.g. round off to 1 decimal point, 3.16666 is 3.2</p>

<div class="w3-example">
<h3>Example</h3>
<p>Round off 3.1666 to 2 decimal places:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr = np.around(3.1666, 2)<br><br>print(arr)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ufunc_rounding2">Try it Yourself &raquo;</a>
</div>
...
<p>The floor() function rounds off decimal to nearest lower integer.</p>

<p>E.g. floor of 3.166 is 3.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Floor the elements of following array:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr = np.floor([-3.1666, 
  3.6667])<br><br>print(arr)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ufunc_rounding3">Try it Yourself &raquo;</a>
</div>
...
<p>The ceil() function rounds off decimal to nearest upper integer.</p>

<p>E.g. ceil of 3.166 is 4.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Ceil the elements of following array:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr = np.ceil([-3.1666, 
  3.6667])<br><br>print(arr)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ufunc_rounding4">Try it Yourself &raquo;</a>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_ufunc_rounding_decimals.js"></div>
<hr>
