...
<html lang="en-US">
<head>
<title>NumPy Creating Arrays</title>
<meta charset="utf-8">
...
<h1>NumPy <span class="color_h1">Creating Arrays</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="numpy_getting_started.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="numpy_array_indexing.asp">Next &#10095;</a>
</div>
<hr>

<h2>Create a NumPy ndarray Object</h2>
<p>NumPy is used to work with arrays. The array object in NumPy is called
<code class="w3-codespan">ndarray</code>.</p>
<p>We can create a NumPy
<code class="w3-codespan">ndarray</code> object by using the <code class="w3-codespan">array()</code> function.</p>
...
<div class="w3-panel ws-note">
  <p><strong>type():</strong> This built-in Python function tells us the type of the object passed to it. Like in above code 
  it shows that <code class="w3-codespan">arr</code> is 
  <code class="w3-codespan">numpy.ndarray</code> type.</p>
</div>

<p>To create an <code class="w3-codespan">ndarray</code>,
we can pass a list, tuple or any array-like object into the <code class="w3-codespan">array()</code> 
method, and it will be converted into an
<code class="w3-codespan">ndarray</code>:</p>

<div class="w3-example">
<h3>Example</h3>
  <p>Use a tuple to create a NumPy array:</p>
<div class="w3-code notranslate pythonHigh">
import numpy as np
<br><br>
arr = np.array((1, 2, 3, 4, 5))<br><br>print(arr)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_create_array2">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-panel ws-note">
  <p><strong>nested array:</strong> are arrays that have arrays as their elements.</p>
</div>
...
<p>0-D arrays, 
or Scalars, are the elements in an array. Each value in an array is a 0-D array.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Create a 0-D array with value 42</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr = np.array(42)<br>
  <br>print(arr)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_create_array_0d">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-example">
<h3>Example</h3>
<p>Create a 1-D array containing the values 1,2,3,4,5:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr = np.array([1, 2, 3, 4, 5])<br>
  <br>print(arr)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_create_array_1d">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-panel ws-note">
<p>NumPy has a whole sub module dedicated towards matrix operations called
<code class="w3-codespan">numpy.mat</code></p>
</div>
...
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr = np.array([[1, 2, 3], [4, 5, 6]])<br>
  <br>print(arr)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_create_array_2d">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-example">
<h3>Example</h3>
<p>Create a 3-D array with two 2-D arrays, both containing two arrays with the 
values 1,2,3 and 4,5,6:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr = np.array([[[1, 2, 3], [4, 5, 6]], [[1, 2, 3], [4, 5, 6]]])<br>
  <br>print(arr)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_create_array_3d">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Check Number of Dimensions?</h2>

<p>NumPy Arrays provides the <code class="w3-codespan">ndim</code> attribute that returns an integer that tells us how many dimensions the array have.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Check how many dimensions the arrays have:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>a = np.array(42)<br>b = np.array([1, 2, 3, 4, 5])<br>
  c = np.array([[1, 2, 3], [4, 5, 6]])<br>d = np.array([[[1, 2, 3], [4, 5, 6]], [[1, 2, 3], [4, 5, 6]]])<br><br>print(a.ndim) <br>print(b.ndim) 
  <br>print(c.ndim) <br>print(d.ndim) </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ndim">Try it Yourself &raquo;</a>
</div>
...
<p>When the array is created, you can define the number of dimensions by using 
the <code class="w3-codespan">ndmin</code> argument.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Create an array with 5 dimensions and verify that it has 5 dimensions:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr = np.array([1, 2, 3, 4], ndmin=5)<br><br>print(arr)<br>
  print('number of dimensions :', arr.ndim) </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ndim5">Try it Yourself &raquo;</a>
</div>

<p>In this array the innermost dimension (5th dim) has 4 elements,
the 4th dim has 1 element that is the vector,
the 3rd dim has 1 element that is the matrix with the vector,
the 2nd dim has 1 element that is 3D array and 1st dim has 1 element that is a 4D array.</p>
<hr>
<div id="exercisecontainer" src="xrcise_creating_arrays.js"></div>
<hr>
