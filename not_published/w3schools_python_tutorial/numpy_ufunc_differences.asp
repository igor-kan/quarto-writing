...
<html lang="en-US">
<head>
<title>NumPy ufuncs - Differences</title>
<meta charset="utf-8">
...
<h1>NumPy Differences</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="numpy_ufunc_products.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="numpy_ufunc_lcm.asp">Next &#10095;</a>
</div>
<hr>

<h2>Differences</h2>

<p>A discrete difference means subtracting two successive elements.</p>

<p>E.g. for [1, 2, 3, 4], the discrete difference would be [2-1, 3-2, 4-3] = [1, 1, 1]</p>

<p>To find the discrete difference, use the <code class="w3-codespan">diff()</code> function.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Compute discrete difference of the following array:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr = np.array([10, 
  15, 25, 5])<br><br>newarr = np.diff(arr)<br><br>print(newarr)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ufunc_differences1">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p><strong>Returns:</strong> <code class="w3-codespan">[5  10 -20]</code> because 15-10=5, 25-15=10, and 5-25=-20</p>
</div>

<p>We can perform this operation repeatedly by giving parameter <code class="w3-codespan">n</code>.</p>
...
<div class="w3-example">
<h3>Example</h3>
<p>Compute discrete difference of the following array twice:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr = np.array([10, 
  15, 25, 5])<br><br>newarr = np.diff(arr, n=2)<br><br>print(newarr)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ufunc_differences2">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p><strong>Returns:</strong> <code class="w3-codespan">[5 -30]</code> because: 15-10=5, 25-15=10, and 5-25=-20 AND 10-5=5 and -20-10=-30</p>
</div>
<hr>
...
<hr>
<div id="exercisecontainer" src="xrcise_ufunc_differences.js"></div>
<hr>
