...
ny:-->
    ...
    <h1>SciPy <span class="color_h1">Optimizers</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="scipy_constants.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="scipy_sparse_data.php">Next &#10095;</a>
</div>
<hr>

<h2>Optimizers in SciPy</h2>
<p>Optimizers are a set of procedures defined in SciPy that either find the minimum value of 
a function, or the root of an equation.</p>

<hr>
<h2>Optimizing Functions</h2>
...
<h2>Roots of an Equation</h2>

<p>NumPy is capable of finding roots for polynomials and linear equations, but it can not find roots for <em>non</em> 
linear equations, like this one:</p>

<p><code class="w3-codespan">x + cos(x)</code></p>

<p>For that you can use SciPy's <code class="w3-codespan">optimize.root</code> function.</p>

<p>This function takes two required arguments:</P>

<p><em><strong>fun</strong></em> - a function representing an equation.</p>
<p><em><strong>x0</strong></em> - an initial guess for the root.</p>

<p>The function returns an object with information regarding the solution.</p>
<p>The actual solution is given under attribute <code class="w3-codespan">x</code> 
of the returned object:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Find root of the equation <code class="w3-codespan">x + cos(x)</code>:</p>
<div class="w3-code notranslate pythonHigh">
from scipy.optimize import root
<br>from math import cos
<br><br>
def eqn(x):<br>
&nbsp;&nbsp;return x + cos(x)<br>
<br>
  myroot = root(eqn, 0)<br><br>
print(myroot.x)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_scipy_optimizers_root">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> The returned object has much more information about 
  the solution.</p>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Print all information about the solution (not just <code class="w3-codespan">x</code> which is the root)</p>
<div class="w3-code notranslate pythonHigh">
print(myroot)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_scipy_optimizers_root2">Try it Yourself &raquo;</a>
</div>
...
<h2>Minimizing a Function</h2>

<p>A function, in this context, represents a curve, curves have <em>high points</em> and <em>low points</em>.</p>

<p>High points are called <em>maxima</em>.</p>
<p>Low points are called <em>minima</em>.</p>

<p>The highest point in the whole curve is called <em>global maxima</em>, whereas the rest of them are called <em>local maxima</em>.</p>
<p>The lowest point in whole curve is called <em>global minima</em>, whereas the rest of them are called <em>local minima</em>.</p>
<hr>
<h2>Finding Minima</h2>

<p>We can use <code class="w3-codespan">scipy.optimize.minimize()</code> function to minimize the function.</p>

<p>The <code class="w3-codespan">minimize()</code> function takes the following arguments:</p>

<p><em><strong>fun</strong></em> - a function representing an equation.</p>
<p><em><strong>x0</strong></em> - an initial guess for the root.</p>
<p><em><strong>method</strong></em> - name of the method to use. Legal values:<br>
&nbsp;&nbsp;&nbsp; <code class="w3-codespan">'CG'</code><br>
&nbsp;&nbsp;&nbsp; <code class="w3-codespan">'BFGS'</code><br>
&nbsp;&nbsp;&nbsp; <code class="w3-codespan">'Newton-CG'</code><br>
&nbsp;&nbsp;&nbsp; <code class="w3-codespan">'L-BFGS-B'</code><br>
&nbsp;&nbsp;&nbsp; <code class="w3-codespan">'TNC'</code><br>
&nbsp;&nbsp;&nbsp; <code class="w3-codespan">'COBYLA'</code><br>
&nbsp;&nbsp;&nbsp; <code class="w3-codespan">'SLSQP'</code></p>
<p><em><strong>callback</strong></em> - function called after each iteration of optimization.</p>
<p><em><strong>options</strong></em> - a dictionary defining extra params:
<div style="background-color:#f1f1f1;margin-left:20px;margin-top:-10px;">
<code class="w3-codespan">{<br>&nbsp;&nbsp;&nbsp;&nbsp;
 "disp": boolean - print detailed description
 <br>&nbsp;&nbsp;&nbsp;&nbsp; "gtol": number - the tolerance of the error<br>&nbsp; 
} </code>
</div>
</p>
...
<div class="w3-example">
<h3>Example</h3>
<p>Minimize the function <code class="w3-codespan">x^2 + x + 2</code> with <code class="w3-codespan">BFGS</code>:</p>
<div class="w3-code notranslate pythonHigh">
from scipy.optimize import minimize<br><br>
def eqn(x):<br>
&nbsp;&nbsp;return x**2 + x + 2<br>
<br>
  mymin = minimize(eqn, 0, method='BFGS')<br><br>
print(mymin)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_scipy_optimizers_minimize">Try it Yourself &raquo;</a>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_optimizers.js" data-extensions="php"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="scipy_constants.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="scipy_sparse_data.php">Next &#10095;</a>
