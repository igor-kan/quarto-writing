...
<html lang="en-US">
<head>
<title>Python Lists and Arrays</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">Lists and Arrays</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_dsa.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_dsa_stacks.asp">Next &#10095;</a>
</div>
<hr>

<p class="intro">In Python, lists are the built-in data structure that serves as a dynamic array.</p>
<p class="intro">Lists are ordered, mutable, and can contain elements of different types.</p>

<hr>

<h2>Lists</h2>
<p>A list is a built-in data structure in Python, used to store multiple elements.</p>
<p>Lists are used by many algorithms.</p>

<hr>

<h2>Creating Lists</h2>

<p>Lists are created using square brackets <code class="w3-codespan">[]</code>:</p>
...
x = []<br>
<br>
# List with initial values<br>
y = [1, 2, 3, 4, 5]<br>
<br>
# List with mixed types<br>
z = [1, "hello", 3.14, True]  
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dsa_lists1">Try it Yourself »</a>
</div>
...
<p>Python lists come with several built-in algorithms (called methods), to perform common operations like appending, sorting, and more.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Append one element to the list, and sort the list ascending:</p>
<div class="w3-code notranslate pythonHigh">
x = [9, 12, 7, 4, 11]<br>
<br>
# Add element:<br>
x.append(8)<br>
<br>
# Sort list ascending:<br>
x.sort()  
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dsa_lists2">Try it Yourself »</a>
</div>
    
<hr>

<h2>Create Algorithms</h2>
<p>Sometimes we want to perform actions that are not built into Python.</p>

<p>Then we can create our own algorithms.</p>

<p>For example, an algorithm can be used to find the lowest value in a list, like in the example below:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Create an algorithm to find the lowest value in a list:</p>
<div class="w3-code notranslate pythonHigh">
my_array = [7, 12, 9, 4, 11, 8]<br>
minVal = my_array[0]<br>
<br>
for i in my_array:<br>
&nbsp;&nbsp;if i < minVal:<br>
&nbsp;&nbsp;&nbsp;&nbsp;minVal = i<br>
<br>
print('Lowest value:', minVal)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dsa_lists3">Try it Yourself »</a>
</div>

<p>The algorithm above is very simple, and fast enough for small data sets,
    but if the data is big enough, any algorithm will take time to run.</p>
<p>This is where optimization comes in.</p>
<p>Optimization is an important part of algorithm development, and of course, an important part of DSA programming.</p>
...
<img class="tutImg" src="/dsa/img_runtime_findlowest.png" alt="Run Time">
...
<p>See <a href="/dsa/dsa_timecomplexity_theory.php">this page</a> for a more thorough explanation of what time complexity is.</p>
