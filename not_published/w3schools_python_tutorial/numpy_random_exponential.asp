...
<a class="w3-left w3-btn" href="numpy_random_multinomial.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="numpy_random_chisquare.asp">Next &#10095;</a>
</div>
<hr>

<h2>Exponential Distribution</h2>

<p>Exponential distribution is used for describing time till next event e.g. failure/success etc.</p>

<p>It has two parameters:</p>

<p><code class="w3-codespan">scale</code> - inverse of rate ( see lam in poisson distribution ) defaults to 1.0.</p>
<p><code class="w3-codespan">size</code> - The shape of the returned array.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Draw out a sample for exponential distribution with 2.0 scale with 2x3 size:</p>
<div class="w3-code notranslate pythonHigh">
  from numpy import random<br><br>x = random.exponential(scale=2, size=(2, 3))<br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_random_exponential1">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Visualization of Exponential Distribution</h2>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  from numpy import random<br>import matplotlib.pyplot as plt<br>import seaborn as sns<br>
  <br>sns.displot(random.exponential(size=1000), kind="kde")<br><br>plt.show()</div>
<h3>Result</h3>
<p><img src="exponential_1.png" style="max-width:100%"></p>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_numpy_random_exponential2">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Relation Between Poisson and Exponential Distribution</h2>
...
<hr>
<div id="exercisecontainer" src="xrcise_random_exponential.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="numpy_random_multinomial.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="numpy_random_chisquare.asp">Next &#10095;</a>
