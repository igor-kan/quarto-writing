...
<html lang="en-US">
<head>
<title>Python Binary Search Trees</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">Binary Search Trees</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_dsa_binarytrees.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_dsa_avltrees.asp">Next &#10095;</a>
</div>
<hr>
...
<p>A Binary Search Tree (BST) is a type of <a href="python_dsa_binarytrees.asp">Binary Tree data structure</a>, where the following properties must be true for any node "X" in the tree:</p>
<ul>
...
<p>The <strong>size</strong> of a tree is the number of nodes in it <code class="w3-codespan">(n)</code>.</p>
...
<h3>Example</h3>
<p>Traversal of a Binary Search Tree in Python</p>
...
root = TreeNode(13)<br>
node7 = TreeNode(7)<br>
node15 = TreeNode(15)<br>
node3 = TreeNode(3)<br>
node8 = TreeNode(8)<br>
node14 = TreeNode(14)<br>
node19 = TreeNode(19)<br>
node18 = TreeNode(18)<br>
<br>
root.left = node7<br>
root.right = node15<br>
<br>
node7.left = node3<br>
node7.right = node8<br>
<br>
node15.left = node14<br>
node15.right = node19<br>
<br>
node19.left = node18<br>
<br>
# Traverse<br>
inOrderTraversal(root)</div>
  <a class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dsa_binarysearchtree" target="_blank">Run Example »</a>
</div>
...
<p>Searching for a value in a BST is very similar to how we found a value using <a href="python_dsa_binarysearch.asp">Binary Search</a> on an array.</p>
...
<p>The algorithm can be implemented like this:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Search the Tree for the value "13"</p>
<div class="w3-code notranslate pythonHigh">
def search(node, target):<br>
&nbsp;&nbsp;if node is None:<br>
&nbsp;&nbsp;&nbsp;&nbsp;return None<br>
&nbsp;&nbsp;elif node.data == target:<br>
&nbsp;&nbsp;&nbsp;&nbsp;return node<br>
&nbsp;&nbsp;elif target < node.data:<br>
&nbsp;&nbsp;&nbsp;&nbsp;return search(node.left, target)<br>
&nbsp;&nbsp;else:<br>
&nbsp;&nbsp;&nbsp;&nbsp;return search(node.right, target)<br>
<br>
# Search for a value<br>
result = search(root, 13)<br>
if result:<br>
&nbsp;&nbsp;print(f"Found the node with value: {result.data}")<br>
else:<br>
&nbsp;&nbsp;print("Value not found in the BST.")</div>
  <a class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dsa_binarysearchtree_find" target="_blank">Run Example »</a>
</div>
<p>The time complexity for searching a BST for a value is <code class="w3-codespan">O(h)</code>, where <code class="w3-codespan">h</code> is the height of the tree.</p>
...
&nbsp;&nbsp;return node<br>
<br>
# Inserting new value into the BST<br>
insert(root, 10)
</div>
  <a class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dsa_binarysearchtree_insert" target="_blank">Run Example »</a>
</div>
<hr>
...
<p>This is how a function for finding the lowest value in the subtree of a BST node looks like:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Find the lowest value in a BST subtree</p>
<div class="w3-code notranslate pythonHigh">
...
<br>
# Find Lowest<br>
print("\nLowest value:",minValueNode(root).data)</div>
  <a class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dsa_binarysearchtree_lowest" target="_blank">Run Example »</a>
</div>
...
&nbsp;&nbsp;else:<br>
&nbsp;&nbsp;&nbsp;&nbsp;# Node with only one child or no child<br>
&nbsp;&nbsp;&nbsp;&nbsp;if not node.left:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;temp = node.right<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;node = None<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return temp<br>
&nbsp;&nbsp;&nbsp;&nbsp;elif not node.right:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;temp = node.left<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;node = None<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return temp<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;# Node with two children, get the in-order successor<br>
&nbsp;&nbsp;&nbsp;&nbsp;node.data = minValueNode(node.right).data<br>
&nbsp;&nbsp;&nbsp;&nbsp;node.right = delete(node.right, node.data)<br>
<br>
&nbsp;&nbsp;return node<br>
<br>
# Delete node 15<br>
delete(root,15)<br>
  ...
  <a class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dsa_binarysearchtree_delete" target="_blank">Run Example »</a>
</div>
...
<p>Searching a BST is just as fast as <a href="python_dsa_binarysearch.asp">Binary Search</a> on an array, with the same time complexity <code class="w3-codespan">O(log n)</code>.</p>
...
<p>On a Binary Search Tree, operations like inserting a new node, deleting a node, or searching for a node are actually <code class="w3-codespan">O(h)</code>. That means that the higher the tree is (<code class="w3-codespan">h</code>), the longer the operation will take.</p>  
<p>The reason why we wrote that searching for a value is <code class="w3-codespan">O(log n)</code> in the table above is because that is true if the tree is "balanced", like in the image below.</p>
<div class="figureWrap">
  <figure class="dsa_figure">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 350 320">
  <!-- 'R' node -->
...
<p>The exact way to tell that a Binary Tree is balanced is that the height of the left and right subtrees of any node only differs by one.
   In the image above, the left subtree of the root node has height <code class="w3-codespan">h=2</code>,
   and the right subtree has height <code class="w3-codespan">h=3</code>.</p>
<p>For a balanced BST, with a large number of nodes (big <code class="w3-codespan">n</code>),
  we get height <code class="w3-codespan">h &#8776; \log_2 n</code>, and therefore the time complexity for searching,
  deleting, or inserting a node can be written as <code class="w3-codespan">O(h) = O(\log n)</code>.</p>
<p>But, in case the BST is completely unbalanced, like in the image below, the height of the tree is approximately the same as the number of nodes,
   <code class="w3-codespan">h &#8776; n</code>, and we get time complexity <code class="w3-codespan">O(h) = O(n)</code> 
