...
#divAnim2 circle, #divAnim2 line, #divAnim2 text {
...
<h1>Python <span class="color_h1">AVL Trees</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_dsa_binarysearchtrees.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_dsa_graphs.asp">Next &#10095;</a>
</div>
...
<svg xmlns="http://www.w3.org/2000/svg" class="hidden-svg">
  <defs>
    ...
    <marker id="arrowheadRed" markerWidth="8" markerHeight="14" refX="0" refY="7" orient="auto" markerUnits="userSpaceOnUse">
        <line x1="0.5" y1="0.5" x2="7.5" y2="7.5" stroke-width="1.5"/>
        <line x1="0" y1="7" x2="6" y2="7" stroke-width="1"/>
        <line x1="0.5" y1="13.5" x2="7.5" y2="6.5" stroke-width="1.5"/>
    </marker>
...
<div class="ws-info">
    <p>The <strong>AVL</strong> Tree is a type of Binary Search Tree named after two Soviet inventors Georgy <strong>A</strong>delson-<strong>V</strong>elsky and Evgenii <strong>L</strong>andis who invented the AVL Tree in 1962.</p>
    <p>AVL trees are self-balancing, which means that the tree height is kept to a minimum so that a very fast runtime is guaranteed for searching, inserting and deleting nodes, with time complexity \(O( \log n)\).</p>
</div>

<h2>AVL Trees</h2>
<p>The only difference between a regular <a href="python_dsa_binarysearchtrees.asp">Binary Search Tree</a> and an AVL Tree is that AVL Trees do rotation operations in addition, to keep the tree balance.</p>
<p>A Binary Search Tree is in balance when the difference in height between left and right subtrees is less than 2.</p>
<p>By keeping balance, the AVL Tree ensures a minimum tree height, which means that search, insert, and delete operations can be done really fast.</p>
<div class="figureWrap" >
<figure class="dsa_figure">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 350 555">
    <!-- 'R' node -->
    <g class="root parent" transform="translate(-106,0)">
      ...
      <!-- 'B' node -->
    <g class="parent child" transform="translate(-60,85)">
      <circle cx="251" cy="100" r="20" class="node subtree15" />
      <text x="245" y="107" class="svgDataText subtree15">G</text>
    ...
    <g class="parent child" transform="translate(45,0)">
      <circle cx="100" cy="100" r="20" class="node" />
      <text x="94" y="107" class="svgDataText">E</text>
      <line x1="111" y1="118" x2="131" y2="160" class="branch height13 height15 subtree15" marker-end="url(#arrowhead)" />
  </g>
  
  
  <!-- 'D' node -->
  <g class="child leaf" id="aRight" transform="translate(110,238)">
      <circle cx="121" cy="207" r="20" class="node" />
      <text x="115" y="214" class="svgDataText">K</text>
  </g>
  
    <!-- 'E' node -->
  <g class="child leaf" transform="translate(-60,85)">
    <circle cx="212" cy="187" r="20" class="node subtree15 successor13" />
    <text x="206" y="193" class="svgDataText subtree15 successor13" >F</text>
  </g>
  
  <!-- 'F' node -->
  <g class="child parent" transform="translate(-60,85)">
    <circle cx="292" cy="187" r="20" class="node subtree15" />
    <text x="286" y="194" class="svgDataText subtree15">P</text>
  ...
  <text x="245" y="280" class="svgDataText subtree15">I</text>
  <line x1="260" y1="291" x2="280" y2="333" class="branch" marker-end="url(#arrowhead)" />
  </g>
  
  <line x1="260" y1="291" x2="280" y2="333" class="branch" marker-end="url(#arrowhead)" transform="translate(-20,172)" />
  
  <g class="child leaf" id="aLeft" transform="translate(230,325)">
      <circle cx="41" cy="207" r="20" class="node" />
      <text x="35" y="214" class="svgDataText">M</text>
  </g>
  </svg>
        <figcaption>Binary Search Tree<br>(unbalanced)<br>Height: 6</figcaption>
    </figure>
    <figure class="dsa_figure">
    ...
    <g class="root parent">
      <circle cx="170" cy="30" r="20" class="node" />
      <text x="164" y="37" class="svgDataText">G</text>
    ...
    <g class="parent child">
      ...
      <text x="74" y="127" class="svgDataText">E</text>
    ...
    <g class="parent child">
      ...
      <text x="265" y="127" class="svgDataText subtree15">K</text>
    ...
    <g class="child leaf" id="aLeft">
      <circle cx="41" cy="207" r="20" class="node" />
      <text x="35" y="213" class="svgDataText" >B</text>
    </g>
  
    <!-- 'F' node -->
    <g class="child leaf" id="aRight">
      <circle cx="121" cy="207" r="20" class="node" />
      <text x="115" y="213" class="svgDataText">F</text>
    </g>
  
    <!-- 'I' node -->
  <g class="child leaf">
    <circle cx="232" cy="207" r="20" class="node subtree15 successor13" />
    <text x="226" y="214" class="svgDataText subtree15 successor13" >I</text>
  </g>
  
  <!-- 'P' node -->
  <g class="child parent">
    <circle cx="312" cy="207" r="20" class="node subtree15" />
    <text x="306" y="214" class="svgDataText subtree15">P</text>
  ...
  <g class="child leaf">
    ...
    <text x="265" y="300" class="svgDataText subtree15">M</text>
  </g>
  </svg>
      <figcaption>AVL Tree<br>(self-balancing)<br>Height: 3</figcaption>
    </figure>
  </div>
  <p>The two trees above are both Binary Search Trees, they have the same nodes, and the same in-order traversal (alphabetical), but the height is very different because the AVL Tree has balanced itself.</p>
  <p>Step through the building of an AVL Tree in the animation below to see how the balance factors are updated, and how rotation operations are done when required to restore the balance.</p>
  <div id="divAnim1" class="divAnim">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 440 212" >
    <path d="M 4 17 A 30 30 0 0 1 51 11" 
        fill="none" stroke="red" stroke-width="1" class="arcRight" transform="translate(188,1)"
        marker-end="url(#arrowheadRed)"/>
    <path d="M 56 17 A 30 30 0 0 0 9 11" 
    fill="none" stroke="red" stroke-width="1" class="arcLeft" transform="translate(187,1)"
    marker-end="url(#arrowheadRed)"/>
  
    <!-- 'C' node -->
    <g class="child leaf C" id="aLeft">
      <text x="215" y="-52" class="svgBalFac">0</text>
      <circle cx="215" cy="-30" r="20" class="node" />
      <text x="209" y="-23" class="svgDataText" >C</text>
    </g>
  
    <!-- 'F' node -->
    <g class="child leaf F" id="aRight">
      <text x="215" y="-52" class="svgBalFac">0</text>
      <circle cx="215" cy="-30" r="20" class="node" />
      <text x="209" y="-23" class="svgDataText">F</text>
    </g>
  
    <line x1="0" y1="0" x2="23" y2="20" class="branch line1" marker-end="url(#arrowhead)" />
  
    <!-- 'G' node -->
    <g class="root parent G">
      <text x="215" y="-52" class="svgBalFac">0</text>
      <circle cx="215" cy="-30" r="20" class="node" />
      <text x="209" y="-23" class="svgDataText">G</text>
    </g>
    ...
    <!-- 'D' node -->
    <g class="root parent D">
      <text x="215" y="-52" class="svgBalFac">0</text>
      <circle cx="215" cy="-30" r="20" class="node" />
      <text x="209" y="-23" class="svgDataText">D</text>
    </g>
  
    <!-- 'B' node -->
    <g class="root parent B">
      <text x="215" y="-52" class="svgBalFac">0</text>
      <circle cx="215" cy="-30" r="20" class="node" />
      <text x="209" y="-23" class="svgDataText">B</text>
    </g>
  
    <!-- 'A' node -->
    <g class="root parent A">
      <text x="215" y="-52" class="svgBalFac">0</text>
      <circle cx="215" cy="-30" r="20" class="node" />
      <text x="209" y="-23" class="svgDataText">A</text>
    </g>
  
  </svg>
    <button onclick="tl1.play()">Insert C</button>
  </div>
  <script src="https://cdnjs.cloudflare.com/ajax/libs/animejs/3.2.1/anime.min.js" integrity="sha512-z4OUqw38qNLpn1libAN9BsoDx6nbNFio5lA6CuTp9NlK83b89hgyCVq+N5FdBJptINztxn1Z3SaKSKUS5UP60Q==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
  <script>
    // Create timeline.
    // Put pause() after every new animation is done.
    // Button resumes the timeline by calling tl1.play().
    let tl1;
    let playBtn = document.querySelector('#divAnim1 button');
    ...
    tl1 = anime.timeline({
      ...
      begin: function(anim){
        ...
        const elements = document.querySelectorAll('#divAnim1 .svgBalFac');
    ...
    .add({
      targets: '#divAnim1 .C .svgBalFac',
      opacity: 1,
      complete: function(anim){
        playBtn.innerHTML = 'Insert F';
        playBtn.disabled = false;
        tl1.pause();
      }
    })
    ...
    .add({
      ...
      opacity: [0,1],
      begin: function(anim){
        document.querySelector('#divAnim1 .C .svgBalFac').innerHTML = '+1';
      },
      complete: function(anim){
        playBtn.innerHTML = 'Insert G';
        playBtn.disabled = false;
        tl1.pause();
      }
    })
    ...
    .add({
      ...
      opacity: [0,1],
      begin: function(anim){
        document.querySelector('#divAnim1 .F .svgBalFac').innerHTML = '+1';
      }
    })
    .add({
      targets: '#divAnim1 .C .svgBalFac',
    ...
    .add({
      ...
      opacity: [0,1],
      begin: function(anim){
        document.querySelector('#divAnim1 .C .svgBalFac').innerHTML = '+2';
        document.querySelector('#divAnim1 .C .svgBalFac').classList.add('redText');
      }
    })
    .add({
      targets: '#divAnim1 .arcLeft',
      opacity: 1,
      complete: function(anim){
        playBtn.innerHTML = 'Rotate Left';
        playBtn.disabled = false;
        tl1.pause();
      }
    })
    ...
    .add({
      ...
      opacity: [0,1],
      begin: function(anim){
        document.querySelector('#divAnim1 .C .svgBalFac').innerHTML = '0';
        document.querySelector('#divAnim1 .C .svgBalFac').classList.remove('redText');
      }
    })
    .add({
      targets: '#divAnim1 .F .svgBalFac',
      opacity: [0,1],
      begin: function(anim){
        document.querySelector('#divAnim1 .F .svgBalFac').innerHTML = '0';
      },
      complete: function(anim){
        playBtn.innerHTML = 'Insert D';
        playBtn.disabled = false;
        tl1.pause();
      }
    })
    ...
    .add({
      ...
      opacity: [0,1],
      begin: function(anim){
        document.querySelector('#divAnim1 .B .svgBalFac').innerHTML = '-1';
      }
    })
    .add({
      targets: '#divAnim1 .C .svgBalFac',
    ...
    .add({
      ...
      opacity: [0,1],
      begin: function(anim){
        document.querySelector('#divAnim1 .F .svgBalFac').innerHTML = '-2';
        document.querySelector('#divAnim1 .F .svgBalFac').classList.add('redText');
      }
    })
    .add({
      targets: '#divAnim1 .arcRight',
      opacity: 1,
      complete: function(anim){
        playBtn.innerHTML = 'Rotate Right';
        playBtn.disabled = false;
        tl1.pause();
      }
    })
    ...
    .add({
      ...
      begin: function(anim){
        document.querySelector('#divAnim1 .F .svgBalFac').innerHTML = '0';
        document.querySelector('#divAnim1 .F .svgBalFac').classList.remove('redText');
      }
    })
    .add({
      complete: function(anim){
  ...
  <p>Continue reading to learn more about how the balance factor is calculated, how rotation operations are done, and how AVL Trees can be implemented.</p>
...
<!-- <p class="adtext">Advertisement</p> -->
  ...
  <h2>Left and Right Rotations</h2>
  <p>To restore balance in an AVL Tree, left or right rotations are done, or a combination of left and right rotations.</p>
  <p>The previous animation shows one specific left rotation, and one specific right rotation.</p>
  <p>But in general, left and right rotations are done like in the animation below.</p>
  <div id="divAnimGenRot" class="divAnim">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 440 240" >
    <style>
        #divAnimGenRot .subtree circle {
          opacity: 0.5;
          stroke-dasharray: 3;
        }
        #divAnimGenRot line {
    ...
    <!-- 'X' node -->
    <g class="child leaf X">
      <circle cx="125" cy="90" r="20" class="node" />
      <text x="119" y="97" class="svgDataText" >X</text>
    </g>
  
    <!-- 'Y' node -->
    <g class="child leaf Y">
      <circle cx="215" cy="40" r="20" class="node" />
      <text x="209" y="47" class="svgDataText">Y</text>
    </g>
  
    <g class="subtree g1">
      <circle cx="75" cy="150" r="10" class="node" />
      <line class="branch" x1="80" y1="160" x2="95" y2="200" />
      <line class="branch" x1="71" y1="160" x2="55" y2="200" />
      <circle cx="50" cy="210" r="10" class="node" />
      <circle cx="100" cy="210" r="10" class="node" />
    </g>
  
    <g class="subtree g2">
      <circle cx="175" cy="150" r="10" class="node" />
      <line class="branch" x1="180" y1="160" x2="195" y2="200" />
      <line class="branch" x1="171" y1="160" x2="155" y2="200" />
      <circle cx="150" cy="210" r="10" class="node" />
      <circle cx="200" cy="210" r="10" class="node" />
  </g>
  
  
  <g class="subtree g3">
      <circle cx="266" cy="97" r="10" class="node" />
      <line class="branch" x1="271" y1="107" x2="286" y2="147" />
      <line class="branch" x1="262" y1="107" x2="246" y2="147" />
      <circle cx="241" cy="157" r="10" class="node" />
      <circle cx="291" cy="157" r="10" class="node" />
  </g>
  
  
    <line x1="113" y1="107" x2="88" y2="136" class="branch line1" marker-end="url(#arrowhead)" />
    <line x1="137" y1="107" x2="162" y2="136" class="branch line2" marker-end="url(#arrowhead)" />
    <line x1="197" y1="49" x2="151" y2="78" class="branch line3" marker-end="url(#arrowhead)" />
    <line x1="230" y1="53" x2="255" y2="82" class="branch line4" marker-end="url(#arrowhead)" />
  
    </svg>
    <button onclick="toggleAnimation()">Rotate Right</button>
  </div>
  <script>
    let tlGenRot;
    let playBtnGenRot = document.querySelector('#divAnimGenRot button');
  
    tlGenRot = anime.timeline({
      autoplay: false,
      duration: 1000,
      direction: 'alternate',
    ...
    tlGenRot.add({
      targets: '#divAnimGenRot .g3',
      translateX: 86,
      translateY: 55
    })
    .add({
      targets: '#divAnimGenRot .line4',
      translateX: 86,
      translateY: 55
    },'-=1000')
    .add({
      targets: '#divAnimGenRot .Y',
      translateX: 86,
      translateY: 55
    },'-=1000')
    .add({
      targets: '#divAnimGenRot .line3',
      translateX: 80,
      x1: 151,
      x2: 197
    },'-=1000')
    .add({
      targets: '#divAnimGenRot .X',
      translateX: 90,
      translateY: -52
    },'-=1000')
    .add({
      targets: '#divAnimGenRot .line1',
      translateX: 90,
      translateY: -52
    },'-=1000')
    .add({
      targets: '#divAnimGenRot .g1',
      translateX: 90,
      translateY: -52
    },'-=1000')
    .add({
      targets: '#divAnimGenRot .line2',
      translateX: 123,
      x1: 162,
      x2: 137
    },'-=1000')
    .add({
      targets: '#divAnimGenRot .g2',
      translateX: 73
    },'-=1000');
  ...
  function toggleAnimation() {
    playBtnGenRot.disabled = true; // Disable the button at the start of the animation
  
    tlGenRot.update = function(anim) {
      if (anim.progress > 0 && anim.progress < 100) {
        playBtnGenRot.disabled = true; // Re-enable the button when the animation is complete
      }
      else {
        playBtnGenRot.disabled = false;
      }
      if(anim.progress >= 99){
        playBtnGenRot.innerHTML = "Rotate Left";
      }
      else if(anim.progress <= 1) {
        playBtnGenRot.innerHTML = "Rotate Right";
      }
    };
    if (directionForward) {
      tlGenRot.play();
  ...
  <p>Notice how the subtree changes its parent. Subtrees change parent in this way during rotation to maintain the correct in-order traversal, and to maintain the BST property that the left child is less than the right child, for all nodes in the tree.</p>
  <p>Also keep in mind that it is not always the root node that become unbalanced and need rotation.</p>
  <hr>
  
  
  <h2>The Balance Factor</h2>
  <p>A node's balance factor is the difference in subtree heights.</p>
  <p>The subtree heights are stored at each node for all nodes in an AVL Tree, and the balance factor is calculated based on its subtree heights to check if the tree has become out of balance.</p>
  <p>The height of a subtree is the number of edges between the root node of the subtree and the leaf node farthest down in that subtree.</p>
  <div class="ws-info" style="overflow: auto;">
    <p>The <strong>Balance Factor</strong> (\(BF\)) for a node (\(X\)) is the difference in height between its right and left subtrees.</p>
    <p><span class="math display">\[ BF(X) = height(rightSubtree(X)) - height(leftSubtree(X)) \]</span></p>
    <p>Balance factor values</p>
    <ul>
      <li>0: The node is in balance.</li>
      <li>more than 0: The node is "right heavy".</li>
      <li>less than 0: The node is "left heavy".</li>
    </ul>
    <p>If the balance factor is less than -1, or more than 1, for one or more nodes in the tree, the tree is considered not in balance, and a rotation operation is needed to restore balance.</p>
  </div>
  <p>Let's take a closer look at the different rotation operations that an AVL Tree can do to regain balance.</p>
  <hr>
  
  <h2>The Four "out-of-balance" Cases</h2>
  <p>When the balance factor of just one node is less than -1, or more than 1, the tree is regarded as out of balance, and a rotation is needed to restore balance.</p>
  <p>There are four different ways an AVL Tree can be out of balance, and each of these cases require a different rotation operation.</p>
  ...
  <p>See animations and explanations of these cases below.</p>
  <hr>
  ...
  <p>Step through the animation below to see the LL case, and how the balance is restored by a single right rotation.</p>
  <div id="divAnimLL" class="divAnim">
    ...
    <!-- 'Q' node -->
    <g class="child leaf Q">
      <text x="215" y="-52" class="svgBalFac">-1</text>
      <circle cx="215" cy="-30" r="20" class="node" />
      <text x="209" y="-23" class="svgDataText" >Q</text>
    </g>
  
    <line x1="23" y1="0" x2="0" y2="20" class="branch line1" marker-end="url(#arrowhead)"/>
  
    <!-- P' node -->
    <g class="root parent P">
      <text x="215" y="-52" class="svgBalFac">0</text>
      <circle cx="215" cy="-30" r="20" class="node" />
      <text x="209" y="-23" class="svgDataText">P</text>
    </g>
    ...
    <!-- 'L' node -->
    <g class="child leaf L">
      <text x="215" y="-52" class="svgBalFac">0</text>
      <circle cx="215" cy="-30" r="20" class="node" />
      <text x="209" y="-23" class="svgDataText">L</text>
    </g>
  
    <!-- 'C' node -->
    <g class="root parent C">
      <text x="215" y="-52" class="svgBalFac">0</text>
      <circle cx="215" cy="-30" r="20" class="node" />
      <text x="209" y="-23" class="svgDataText">C</text>
    </g>
    ...
    <line x1="0" y1="0" x2="23" y2="20" class="branch line6" marker-end="url(#arrowhead)" />
    
    <!-- 'K' node -->
    <g class="root parent K">
      <text x="215" y="-52" class="svgBalFac">0</text>
      <circle cx="215" cy="-30" r="20" class="node" />
      <text x="209" y="-23" class="svgDataText">K</text>
    </g>
  
    <line x1="0" y1="0" x2="23" y2="20" class="branch line7" marker-end="url(#arrowhead)" />
    ...
    <button onclick="tlLL.play()">Insert D</button>
  </div>
  <script>
    // Create timeline.
    // Put pause() after every new animation is done.
    ...
    tlLL.add({
      targets: '#divAnimLL .P .svgBalFac, #divAnimLL .Q .svgBalFac',
      opacity: 1,
      duration: 10,
      complete: function(anim){
        ...
        document.querySelector('#divAnimLL .Q .svgBalFac').innerHTML = "-1";
      }
    })
    .add({
      targets: '#divAnimLL .Q',
    ...
    .add({
      ...
      duration: 10,
      complete: function(anim){
        playBtnLL.innerHTML = 'Insert D';
        playBtnLL.disabled = false;
        tlLL.pause();
      }
    })
    .add({
      targets: '#divAnimLL .Q .svgBalFac',
      duration: 10,
      begin: function(anim){
    ...
    .add({
      targets: '#divAnimLL .D .svgBalFac',
      opacity: 1
    })
    .add({
      targets: '#divAnimLL .P .svgBalFac',
      opacity: [0,1],
      begin: function(anim){
        document.querySelector('#divAnimLL .P .svgBalFac').innerHTML = '-1';
      }
    })
    .add({
      targets: '#divAnimLL .Q .svgBalFac',
    ...
    .add({
      ...
      opacity: [0,1],
      begin: function(anim){
        document.querySelector('#divAnimLL .Q .svgBalFac').innerHTML = '-2';
        document.querySelector('#divAnimLL .Q .svgBalFac').classList.add('redText');
      }
    })
    .add({
    ...
    .add({
      ...
      opacity: [0,1],
      begin: function(anim){
        document.querySelector('#divAnimLL .Q .svgBalFac').classList.remove('redText');
        document.querySelector('#divAnimLL .Q .svgBalFac').innerHTML = 0;
      }
    })
    .add({
      targets: '#divAnimLL .P .svgBalFac',
      opacity: [0,1],
      begin: function(anim){
        document.querySelector('#divAnimLL .P .svgBalFac').innerHTML = 0;
      },
      complete: function(anim){
        playBtnLL.innerHTML = 'Insert L';
        playBtnLL.disabled = false;
        tlLL.pause();
      }
    })
    ...
    .add({
      ...
      opacity: [0,1],
      begin: function(anim){
        document.querySelector('#divAnimLL .D .svgBalFac').innerHTML = "+1";
      }
    })
    .add({
      targets: '#divAnimLL .P .svgBalFac',
    ...
    .add({
      ...
      opacity: [0,1],
      begin: function(anim){
        document.querySelector('#divAnimLL .D .svgBalFac').innerHTML = "0";
      }
    })
    .add({
      complete: function(anim){
        playBtnLL.innerHTML = 'Insert B';
        playBtnLL.disabled = false;
        tlLL.pause();
      }
    })
    ...
    .add({
      ...
      opacity: [0,1],
      begin: function(anim){
        document.querySelector('#divAnimLL .C .svgBalFac').innerHTML = '-1';
      }
    })
    .add({
      targets: '#divAnimLL .D .svgBalFac',
    ...
    .add({
      ...
      opacity: [0,1],
      begin: function(anim){
        document.querySelector('#divAnimLL .P .svgBalFac').classList.add('redText');
        document.querySelector('#divAnimLL .P .svgBalFac').innerHTML = '-2';
      }
    })
    .add({
      targets: '#divAnimLL .arcRight',
    ...
    .add({
      ...
      opacity: [0,1],
      begin: function(anim){
        document.querySelector('#divAnimLL .P .svgBalFac').classList.remove('redText');
        document.querySelector('#divAnimLL .P .svgBalFac').innerHTML = '0';
      }
    })
    .add({
  ...
  <ol>
    <li>When D is added, the balance factor of Q becomes -2, which means the tree is unbalanced. This is an LL case because both the unbalance node Q and its left child node P are left heavy (negative balance factors). A single right rotation at node Q restores the tree balance.</li>
    <li>After nodes L, C, and B are added, P's balance factor is -2, which means the tree is out of balance. This is also an LL case because both the unbalanced node P and its left child node D are left heavy. A single right rotation restores the balance.</li>
  </ol>
  <div class="ws-note">
    <p><strong>Note: </strong>The second time the LL case happens in the animation above, a right rotation is done, and L goes from being the right child of D to being the left child of P. Rotations are done like that to keep the correct in-order traversal ('B, C, D, L, P, Q' in the animation above). Another reason for changing parent when a rotation is done is to keep the BST property, that the left child is always lower than the node, and that the right child always higher.</p>
  </div>
  <hr>
  
  <h2>The Right-Right (RR) Case</h2>
  <p>A Right-Right case happens when a node is unbalanced and right heavy, and the right child node is also right heavy.</p>
  ...
  <div id="divAnimRR" class="divAnim">
    ...
    <!-- 'E' node -->
    <g class="child leaf E">
      <text x="215" y="-52" class="svgBalFac">0</text>
      <circle cx="215" cy="-30" r="20" class="node" />
      <text x="209" y="-23" class="svgDataText" >E</text>
    </g>
  
    <line x1="0" y1="0" x2="23" y2="20" class="branch line5" marker-end="url(#arrowhead)" />
  
    <!-- 'F' node -->
    <g class="child leaf F">
      <text x="215" y="-52" class="svgBalFac">0</text>
      <circle cx="215" cy="-30" r="20" class="node" />
      <text x="209" y="-23" class="svgDataText" >F</text>
    </g>
    ...
    <button onclick="tlRR.play()">Insert D</button>
  </div>
  <script>
    // Create timeline.
    // Put pause() after every new animation is done.
    ...
    .add({
      targets: '#divAnimRR .A .svgBalFac, #divAnimRR .B .svgBalFac',
      opacity: 1,
      duration: 10
    })
    .add({
    ...
    .add({
      targets: '#divAnimRR .D .svgBalFac',
      opacity: 1
    })
    .add({
      targets: '#divAnimRR .B .svgBalFac',
      opacity: [0,1],
      begin: function(anim){
        document.querySelector('#divAnimRR .B .svgBalFac').innerHTML = '+1';
      }
    })
    .add({
      targets: '#divAnimRR .A .svgBalFac',
      y: -50,
      duration: 20
    })
    .add({
      ...
      opacity: [0,1],
      begin: function(anim){
        document.querySelector('#divAnimRR .A .svgBalFac').classList.add('redText');
        document.querySelector('#divAnimRR .A .svgBalFac').innerHTML = '+2';
      }
    })
    .add({
    ...
    .add({
      ...
      opacity: [0,1],
      begin: function(anim){
        document.querySelector('#divAnimRR .A .svgBalFac').classList.remove('redText');
        document.querySelector('#divAnimRR .A .svgBalFac').innerHTML = '0';
      }
    })
    .add({
      targets: '#divAnimRR .B .svgBalFac',
      opacity: [0,1],
      begin: function(anim){
        document.querySelector('#divAnimRR .B .svgBalFac').innerHTML = '0';
      }
    })
    .add({
      complete: function(anim){
        playBtnRR.innerHTML = 'Insert E';
        playBtnRR.disabled = false;
        tlRR.pause();
      }
    })
    ...
    .add({
      ...
      opacity: [0,1],
      begin: function(anim){
        document.querySelector('#divAnimRR .D .svgBalFac').innerHTML = '+1';
      }
    })
    .add({
      targets: '#divAnimRR .B .svgBalFac',
    ...
    .add({
      ...
      opacity: [0,1],
      begin: function(anim){
        document.querySelector('#divAnimRR .D .svgBalFac').innerHTML = '0';
      }
    })
    .add({
      complete: function(anim){
        playBtnRR.innerHTML = 'Insert F';
        playBtnRR.disabled = false;
        tlRR.pause();
      }
    })
    ...
    .add({
      ...
      opacity: [0,1],
      begin: function(anim){
        document.querySelector('#divAnimRR .E .svgBalFac').innerHTML = '+1';
      }
    })
    .add({
      targets: '#divAnimRR .D .svgBalFac',
    ...
    .add({
      ...
      opacity: [0,1],
      begin: function(anim){
        document.querySelector('#divAnimRR .B .svgBalFac').classList.add('redText');
        document.querySelector('#divAnimRR .B .svgBalFac').innerHTML = '+2';
      }
    })
    .add({
      targets: '#divAnimRR .arcLeft',
    ...
    .add({
      ...
      opacity: [0,1],
      begin: function(anim){
        document.querySelector('#divAnimRR .B .svgBalFac').classList.remove('redText');
        document.querySelector('#divAnimRR .B .svgBalFac').innerHTML = '-1';
      }
    })
    .add({
    ...
    .add({
      ...
      opacity: [0,1],
      begin: function(anim){
        document.querySelector('#divAnimRR .E .svgBalFac').innerHTML = '0';
      }
    })
    .add({
      complete: function(anim){
  ...
  <ol>
    <li>When node D is inserted, A becomes unbalanced, and bot A and B are right heavy. A left rotation at node A restores the tree balance.</li>
    <li>After nodes E, C and F are inserted, node B becomes unbalanced. This is an RR case because both node B and its right child node D are right heavy. A left rotation restores the tree balance.</li>
  </ol>
  <hr>
  ...
  <p>In this LR case, a left rotation is first done on the left child node, and then a right rotation is done on the original unbalanced node.</p>
  <p>Step through the animation below to see how the Left-Right case can happen, and how the rotation operations are done to restore balance.</p>
  <div id="divAnimLR" class="divAnim">
    ...
    <button onclick="tlLR.play()">Insert D</button>
  </div>
  <script>
    // Create timeline.
    // Put pause() after every new animation is done.
    ...
    tlLR.add({
      targets: '#divAnimLR .E .svgBalFac, #divAnimLR .Q .svgBalFac',
      opacity: 1,
      duration: 10,
      complete: function(anim){
        ...
        document.querySelector('#divAnimLR .Q .svgBalFac').innerHTML = "-1";
      }
    })
    .add({
      targets: '#divAnimLR .Q',
    ...
    .add({
      targets: '#divAnimLR .E .svgBalFac',
      opacity: [0,1],
      begin: function(anim){
        document.querySelector('#divAnimLR .E .svgBalFac').innerHTML = '+1';
      }
    })
    .add({
      targets: '#divAnimLR .Q .svgBalFac',
      opacity: [0,1],
      begin: function(anim){
        document.querySelector('#divAnimLR .Q .svgBalFac').innerHTML = '-2';
        document.querySelector('#divAnimLR .Q .svgBalFac').classList.add('redText');
      }
    })
    .add({
    ...
    .add({
      ...
      opacity: [0,1],
      begin: function(anim){
        document.querySelector('#divAnimLR .E .svgBalFac').innerHTML = '0';
      }
    })
    .add({
      targets: '#divAnimLR .Q .svgBalFac',
      opacity: [0,1],
      begin: function(anim){
        document.querySelector('#divAnimLR .Q .svgBalFac').classList.remove('redText');
        document.querySelector('#divAnimLR .Q .svgBalFac').innerHTML = '0';
      },
      complete: function(anim){
        playBtnLR.innerHTML = 'Insert C';
        playBtnLR.disabled = false;
        tlLR.pause();
      }
    })
    ...
    .add({
      ...
      opacity: [0,1],
      begin: function(anim){
        document.querySelector('#divAnimLR .K .svgBalFac').innerHTML = '-1';
      },
      complete: function(anim){
        playBtnLR.innerHTML = 'Insert F';
        playBtnLR.disabled = false;
        tlLR.pause();
      }
    })
    ...
    .add({
      ...
      opacity: [0,1],
      begin: function(anim){
        document.querySelector('#divAnimLR .F .svgBalFac').innerHTML = '+1';
      }
    })
    .add({
      targets: '#divAnimLR .E .svgBalFac, #divAnimLR .K .svgBalFac',
      x: 213,
      y: -51,
      duration: 20
    })
    ...
    .add({
      ...
      opacity: [0,1],
      begin: function(anim){
        document.querySelector('#divAnimLR .K .svgBalFac').classList.add('redText');
        document.querySelector('#divAnimLR .K .svgBalFac').innerHTML = '-2';
      }
    })
    .add({
    ...
    .add({
      ...
      opacity: [0,1],
      begin: function(anim){
        document.querySelector('#divAnimLR .F .svgBalFac').innerHTML = '0';
      }
    })
    .add({
      targets: '#divAnimLR .K .svgBalFac',
      opacity: [0,1],
      begin: function(anim){
        document.querySelector('#divAnimLR .K .svgBalFac').classList.remove('redText');
        document.querySelector('#divAnimLR .K .svgBalFac').innerHTML = '0';
      }
    })
    .add({
      complete: function(anim){
  ...
  <p>As you are building the AVL Tree in the animation above, the Left-Right case happens 2 times, and rotation operations are required and done to restore balance:</p>
  <ol>
    <li>When K is inserted, node Q gets unbalanced with a balance factor of -2, so it is left heavy, and its left child E is right heavy, so this is a Left-Right case.</li>
    <li>After nodes C, F, and G are inserted, node K becomes unbalanced and left heavy, with its left child node E right heavy, so it is a Left-Right case.</li>
  </ol>
  <hr>
  ...
  <p>In this case we first do a right rotation on the unbalanced node's right child, and then we do a left rotation on the unbalanced node itself.</p>
  <p>Step through the animation below to see how the Right-Left case can occur, and how rotations are done to restore the balance.</p>
  <div id="divAnimRL" class="divAnim">
    ...
    <button onclick="tlRL.play()">Insert B</button>
  </div>
  <script>
    // Create timeline.
    // Put pause() after every new animation is done.
    ...
    tlRL.add({
      targets: '#divAnimRL .A .svgBalFac, #divAnimRL .F .svgBalFac',
      opacity: 1,
      duration: 10,
      complete: function(anim){
        ...
        document.querySelector('#divAnimRL .A .svgBalFac').innerHTML = "+1";
      }
    })
    .add({
      targets: '#divAnimRL .A',
    ...
    .add({
      targets: '#divAnimRL .B .svgBalFac',
      opacity: 1,
    })
    .add({
      targets: '#divAnimRL .F .svgBalFac',
      opacity: [0,1],
      y: -50,
      begin: function(anim){
        document.querySelector('#divAnimRL .F .svgBalFac').innerHTML = '-1';
      }
    })
    .add({
      targets: '#divAnimRL .A .svgBalFac',
      opacity: [0,1],
      y: -50,
      begin: function(anim){
        document.querySelector('#divAnimRL .A .svgBalFac').classList.add('redText');
        document.querySelector('#divAnimRL .A .svgBalFac').innerHTML = '+2';
      }
    })
    .add({
    ...
    .add({
      targets: '#divAnimRL .F .svgBalFac, #divAnimRL .A .svgBalFac',
      y: -52,
      duration: 1000
    },'-=1000')
    .add({
    ...
    .add({
      ...
      opacity: [0,1],
      begin: function(anim){
        document.querySelector('#divAnimRL .A .svgBalFac').classList.remove('redText');
        document.querySelector('#divAnimRL .A .svgBalFac').innerHTML = '0';
      }
    })
    .add({
      targets: '#divAnimRL .F .svgBalFac',
      opacity: [0,1],
      begin: function(anim){
        document.querySelector('#divAnimRL .F .svgBalFac').innerHTML = '0';
      }
    })
    .add({
      complete: function(anim){
        playBtnRL.innerHTML = 'Insert G';
        playBtnRL.disabled = false;
        tlRL.pause();
      }
    })
    ...
    .add({
      ...
      opacity: [0,1],
      begin: function(anim){
        document.querySelector('#divAnimRL .B .svgBalFac').innerHTML = '+1';
      }
    })
    .add({
      complete: function(anim){
        playBtnRL.innerHTML = 'Insert E';
        playBtnRL.disabled = false;
        tlRL.pause();
      }
    })
    ...
    .add({
      ...
      opacity: [0,1],
      begin: function(anim){
        document.querySelector('#divAnimRL .E .svgBalFac').innerHTML = '-1';
      }
    })
    .add({
      targets: '#divAnimRL .F .svgBalFac',
    ...
    .add({
      ...
      y: -50,
      begin: function(anim){
        document.querySelector('#divAnimRL .B .svgBalFac').classList.add('redText');
        document.querySelector('#divAnimRL .B .svgBalFac').innerHTML = '+2';
      }
    })
    .add({
      targets: '#divAnimRL .arcLeft, #divAnimRL .arcRight',
    ...
    .add({
      ...
      y: -52,
      begin: function(anim){
        document.querySelector('#divAnimRL .B .svgBalFac').classList.remove('redText');
        document.querySelector('#divAnimRL .B .svgBalFac').innerHTML = '0';
      }
    })
    .add({
      targets: '#divAnimRL .E .svgBalFac',
      opacity: [0,1],
      begin: function(anim){
        document.querySelector('#divAnimRL .E .svgBalFac').innerHTML = '0';
      }
    })
    .add({
      targets: '#divAnimRL .F .svgBalFac',
  ...
  <p>After inserting node B, we get a Right-Left case because node A becomes unbalanced and right heavy, and its right child is left heavy. To restore balance, a right rotation is first done on node F, and then a left rotation is done on node A.</p>
  <p>The next Right-Left case occurs after nodes G, E, and D are added. This is a Right-Left case because B is unbalanced and right heavy, and its right child F is left heavy. To restore balance, a right rotation is first done on node F, and then a left rotation is done on node B.</p>
  <hr>
  
  <a id="retracing"></a>
  <h2>Retracing in AVL Trees</h2>
  <p>After inserting or deleting a node in an AVL tree, the tree may become unbalanced. To find out if the tree is unbalanced, we need to update the heights and recalculate the balance factors of all ancestor nodes.</p>
  <p>This process, known as retracing, is handled through recursion. As the recursive calls propagate back to the root after an insertion or deletion, each ancestor node's height is updated and the balance factor is recalculated. If any ancestor node is found to have a balance factor outside the range of -1 to 1, a rotation is performed at that node to restore the tree's balance.</p>
  <p>In the simulation below, after inserting node F, the nodes C, E and H are all unbalanced, but since retracing works through recursion, the unbalance at node H is discovered and fixed first, which in this case also fixes the unbalance in nodes E and C.</p>
  <div id="divAnimSimul" class="divAnim">
    ...
    <!-- 'H' node -->
    <g class="root parent H">
      <text x="215" y="-52" class="svgBalFac">0</text>
      <circle cx="215" cy="-30" r="20" class="node" />
      <text x="209" y="-23" class="svgDataText">H</text>
    </g>
    ...
    <button onclick="tlSimul.play()">Insert F</button>
  </div>
  <script>
    // Create timeline.
    // Put pause() after every new animation is done.
    // Button resumes the timeline by calling tl1.play().
    let tlSimul;
    let playBtnSimul = document.querySelector('#divAnimSimul button');
  
    tlSimul = anime.timeline({
      autoplay: true,
      duration: 500,
      easing: 'easeInOutCirc',
      loop: false
    ...
    tlSimul.add({
      targets: '#divAnimSimul .A .svgBalFac, #divAnimSimul .B .svgBalFac, #divAnimSimul .C .svgBalFac, #divAnimSimul .D .svgBalFac, #divAnimSimul .E .svgBalFac, #divAnimSimul .G .svgBalFac, #divAnimSimul .H .svgBalFac',
      opacity: 1,
      duration: 10,
      complete: function(anim){
        document.querySelectorAll('#divAnimSimul .svgBalFac').forEach(function(element) {
          element.innerHTML = '0';
        });
        document.querySelector('#divAnimSimul .A .svgBalFac').innerHTML = "0";
        document.querySelector('#divAnimSimul .B .svgBalFac').innerHTML = "-1";
        document.querySelector('#divAnimSimul .C .svgBalFac').innerHTML = "+1";
        document.querySelector('#divAnimSimul .D .svgBalFac').innerHTML = "0";
        document.querySelector('#divAnimSimul .E .svgBalFac').innerHTML = "+1";
        document.querySelector('#divAnimSimul .G .svgBalFac').innerHTML = "0";
        document.querySelector('#divAnimSimul .H .svgBalFac').innerHTML = "-1";
      }
    })
    .add({
      targets: '#divAnimSimul .A .svgBalFac, #divAnimSimul .D .svgBalFac, #divAnimSimul .H .svgBalFac, #divAnimSimul .F .svgBalFac',
      x: 212,
      duration: 10
    })
    .add({
      targets: '#divAnimSimul .G .svgBalFac',
      x: 203,
      duration: 10
    })
    .add({
      targets: '#divAnimSimul .C',
      translateY: 70,
      duration: 10
    })
    .add({
      targets: '#divAnimSimul .D',
      translateX: 50,
      translateY: 200,
      duration: 10
    })
    .add({
      targets: '#divAnimSimul .H',
      translateX: 130,
      translateY: 200,
      duration: 10
    })
    .add({
      targets: '#divAnimSimul .E',
      translateX: 90,
      translateY: 120,
      duration: 10
    })
    .add({
      targets: '#divAnimSimul .G',
      translateX: 90,
      translateY: 280,
      duration: 10
    })
    .add({
      targets: '#divAnimSimul .B',
      translateX: -90,
      translateY: 120,
      duration: 10
    })
    .add({
      targets: '#divAnimSimul .A',
      translateX: -130,
      translateY: 200,
      duration: 10
    })
    .add({
      targets: '#divAnimSimul .line1',
      translateX: 150,
      translateY: 52,
      x1: 49,
      y2: 24,
    ...
    .add({
      complete: function(anim){
        playBtnSimul.innerHTML = 'Insert F';
        playBtnSimul.disabled = false;
        tlSimul.pause();
      }
    })
    .add({
      targets: '#divAnimSimul .F',
      translateY: 60,
      begin: function(anim){
        playBtnSimul.disabled = true;
      }
    })
    .add({
      targets: '#divAnimSimul .F',
    ...
    .add({
      targets: '#divAnimSimul .F .svgBalFac',
      opacity: 1
    })
    .add({
      targets: '#divAnimSimul .G .svgBalFac',
      ...
      x: 203,
      begin: function(anim){
        document.querySelector('#divAnimSimul .G .svgBalFac').innerHTML = '-1';
      }
    })
    .add({
      targets: '#divAnimSimul .H .svgBalFac',
      opacity: [0,1],
      y: -50,
      begin: function(anim){
        document.querySelector('#divAnimSimul .H .svgBalFac').classList.add('redText');
        document.querySelector('#divAnimSimul .H .svgBalFac').innerHTML = '-2';
      }
    })
    .add({
      targets: '#divAnimSimul .arcRight',
      translateX: 317,
      translateY: 131,
      duration: 10
    })
    ...
    .add({
      complete: function(anim){
        playBtnSimul.innerHTML = 'Rotate Right';
        playBtnSimul.disabled = false;
        tlSimul.pause();
      }
    })
    ...
    .add({
      targets: '#divAnimSimul .H',
      translateX: 170, // 40 left
      translateY: 280,  // 80 down
      duration: 1000
    })
    .add({
      targets: '#divAnimSimul .line6',
    ...
    .add({
      ...
      y: -52,
      begin: function(anim){
        document.querySelector('#divAnimSimul .H .svgBalFac').classList.remove('redText');
        document.querySelector('#divAnimSimul .H .svgBalFac').innerHTML = 0;
      }
    })
    .add({
      targets: '#divAnimSimul .G .svgBalFac',
  ...
  <p>After node F is inserted, the code will retrace, calculating balancing factors as it propagates back up towards the root node. When node H is reached and the balancing factor -2 is calculated, a right rotation is done. Only after this rotation is done, the code will continue to retrace, calculating balancing factors further up on ancestor nodes E and C.</p>
  <p>Because of the rotation, balancing factors for nodes E and C stay the same as before node F was inserted.</p>
  <hr>
  
  <h2>AVL Tree Implementation in Python</h2>
  <p>This code is based on the BST implementation on the <a href="python_dsa_binarysearchtrees.asp">previous page</a>, for inserting nodes.</p>
  <p>There is only one new attribute for each node in the AVL tree compared to the BST, and that is the height, but there are many new functions and extra code lines needed for the AVL Tree implementation because of how the AVL Tree rebalances itself.</p>
  <p>The implementation below builds an AVL tree based on a list of characters, to create the AVL Tree in the simulation above. The last node to be inserted 'F', also triggers a right rotation, just like in the simulation above.</p>
  <div class="w3-example">
  <h3>Example</h3>
  <p>Implement AVL Tree in Python:</p>
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;self.height = 1<br>
  <br>
  def getHeight(node):<br>
  &nbsp;&nbsp;if not node:<br>
  &nbsp;&nbsp;&nbsp;&nbsp;return 0<br>
  &nbsp;&nbsp;return node.height<br>
  <br>
  def getBalance(node):<br>
  &nbsp;&nbsp;if not node:<br>
  &nbsp;&nbsp;&nbsp;&nbsp;return 0<br>
  &nbsp;&nbsp;return getHeight(node.left) - getHeight(node.right)<br>
  <br>
  def rightRotate(y):<br>
  &nbsp;&nbsp;print('Rotate right on node',y.data)<br>
  &nbsp;&nbsp;x = y.left<br>
  &nbsp;&nbsp;T2 = x.right<br>
  &nbsp;&nbsp;x.right = y<br>
  &nbsp;&nbsp;y.left = T2<br>
  &nbsp;&nbsp;y.height = 1 + max(getHeight(y.left), getHeight(y.right))<br>
  &nbsp;&nbsp;x.height = 1 + max(getHeight(x.left), getHeight(x.right))<br>
  &nbsp;&nbsp;return x<br>
  <br>
  def leftRotate(x):<br>
  &nbsp;&nbsp;print('Rotate left on node',x.data)<br>
  &nbsp;&nbsp;y = x.right<br>
  &nbsp;&nbsp;T2 = y.left<br>
  &nbsp;&nbsp;y.left = x<br>
  &nbsp;&nbsp;x.right = T2<br>
  ...
  &nbsp;&nbsp;return y<br>
  <br>
  def insert(node, data):<br>
  &nbsp;&nbsp;if not node:<br>
  &nbsp;&nbsp;&nbsp;&nbsp;return TreeNode(data)<br>
  <br>
  ...
  <br>
  &nbsp;&nbsp;# Update the balance factor and balance the tree<br>
  &nbsp;&nbsp;node.height = 1 + max(getHeight(node.left), getHeight(node.right))<br>
  &nbsp;&nbsp;balance = getBalance(node)<br>
  <br>
  &nbsp;&nbsp;# Balancing the tree<br>
  &nbsp;&nbsp;# Left Left<br>
  &nbsp;&nbsp;if balance > 1 and getBalance(node.left) >= 0:<br>
  ...
  <br>
  &nbsp;&nbsp;# Right Right<br>
  &nbsp;&nbsp;if balance < -1 and getBalance(node.right) <= 0:<br>
  ...
  &nbsp;&nbsp;return node<br>
  <br>
  def inOrderTraversal(node):<br>
  &nbsp;&nbsp;if node is None:<br>
  &nbsp;&nbsp;&nbsp;&nbsp;return<br>
  &nbsp;&nbsp;inOrderTraversal(node.left)<br>
  &nbsp;&nbsp;print(node.data, end=", ")<br>
  &nbsp;&nbsp;inOrderTraversal(node.right)<br>
  <br>
  # Inserting nodes<br>
  root = None<br>
  letters = ['C', 'B', 'E', 'A', 'D', 'H', 'G', 'F']<br>
  for letter in letters:<br>
  &nbsp;&nbsp;root = insert(root, letter)<br>
  <br>
  inOrderTraversal(root)</div>
    <a class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dsa_avltrees" target="_blank">Run Example »</a>
  </div>
  <hr>
  
  <h2>AVL Delete Node Implementation</h2>
  <p>When deleting a node that is not a leaf node, the AVL Tree requires the <code class="w3-codespan">minValueNode()</code> function to find a node's next  node in the in-order traversal. This is the same as when deleting a node in a Binary Search Tree, as explained on the previous page.</p>
  <p>To delete a node in an AVL Tree, the same code to restore balance is needed as for the code to insert a node.</p>
  <div class="w3-example">
  <h3>Example</h3>
  <p>Delete Node:</p>
  <div class="w3-code notranslate pythonHigh">
  def minValueNode(node):<br>
  &nbsp;&nbsp;current = node<br>
  &nbsp;&nbsp;while current.left is not None:<br>
  &nbsp;&nbsp;&nbsp;&nbsp;current = current.left<br>
  &nbsp;&nbsp;return current<br>
  <br>
  def delete(node, data):<br>
  &nbsp;&nbsp;if not node:<br>
  &nbsp;&nbsp;&nbsp;&nbsp;return node<br>
  <br>
  &nbsp;&nbsp;if data < node.data:<br>
  &nbsp;&nbsp;&nbsp;&nbsp;node.left = delete(node.left, data)<br>
  &nbsp;&nbsp;elif data > node.data:<br>
  &nbsp;&nbsp;&nbsp;&nbsp;node.right = delete(node.right, data)<br>
  &nbsp;&nbsp;else:<br>
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return temp<br>
  <br>
  &nbsp;&nbsp;&nbsp;&nbsp;temp = minValueNode(node.right)<br>
  &nbsp;&nbsp;&nbsp;&nbsp;node.data = temp.data<br>
  &nbsp;&nbsp;&nbsp;&nbsp;node.right = delete(node.right, temp.data)<br>
  <br>
  &nbsp;&nbsp;return node<br>
  <br>
  def inOrderTraversal(node):<br>
  ...
  <br>
  inOrderTraversal(root)</div>
    <a class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dsa_avltrees_delete" target="_blank">Run Example »</a>
  </div>
  <hr>
  
  <h2>Time Complexity for AVL Trees</h2>
  <p>Take a look at the unbalanced Binary Search Tree below. Searching for "M" means that all nodes except 1 must be compared. But searching for "M" in the AVL Tree below only requires us to visit 4 nodes.</p>
  <p>So in worst case, algorithms like search, insert, and delete must run through the whole height of the tree. This means that keeping the height (h) of the tree low, like we do using AVL Trees, gives us a lower runtime.</p>
  <div class="figureWrap" >
  <figure class="dsa_figure">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 350 555">
    <!-- 'R' node -->
  ...
  <g class="child leaf" id="aLeft" transform="translate(230,325)">
      ...
      <text x="35" y="214" class="svgDataText">M</text>
        ...
        <figcaption>Binary Search Tree<br>(unbalanced)</figcaption>
    </figure>
    <figure class="dsa_figure">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 350 320" >
    <!-- 'G' node -->
  ...
  <g class="child leaf">
    ...
    <text x="265" y="300" class="svgDataText subtree15">M</text>
      ...
      <figcaption>AVL Tree<br>(self-balancing)</figcaption>
    </figure>
  </div>
  <p>See the comparison of the time complexities between Binary Search Trees and AVL Trees below, and how the time complexities relate to the height (\(h\)) of the tree, and the number of nodes (\(n\)) in the tree.</p>
  <ul>
    <li>The <strong>BST</strong> is not self-balancing. This means that a BST can be very unbalanced, almost like a long chain, where the height is nearly the same as the number of nodes. This makes operations like searching, deleting and inserting nodes slow, with time complexity \(O(h) = O(n)\).</li>
    <li>The <strong>AVL Tree</strong> however is self-balancing. That means that the height of the tree is kept to a minimum so that operations like searching, deleting and inserting nodes are much faster, with time complexity \(O(h) = O( \log n)\).</li>
  </ul>
  <hr>
  
  <h2>\(O( \log n)\) Explained</h2>
  <p>The fact that the time complexity is \(O(h) = O( \log n)\) for search, insert, and delete on an AVL Tree with height \(h\) and nodes \(n\) can be explained like this:</p>
  <p>Imagine a perfect Binary Tree where all nodes have two child nodes except on the lowest level, like the AVL Tree below.</p>
  <svg class="bigTree" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 360 270" >
    <!-- 'G' node -->
    <g class="root parent" transform="translate(3 -15)">
      <circle cx="170" cy="35" r="15" class="node" />
      <text x="164" y="42" class="svgDataText">H</text>
      <line x1="158" y1="45" x2="101" y2="100" class="branch" marker-end="url(#arrowhead)" />
      <line x1="182" y1="45" x2="250" y2="100" class="branch height13" marker-end="url(#arrowhead)" />
    </g>
  
    
  
    <g transform="translate(-187 -37)">
    <!-- 'K' node -->
    <g class="parent child">
      <circle cx="272" cy="137" r="15" class="node subtree15" />
      <text x="266" y="144" class="svgDataText subtree15">D</text>
      <line x1="264" y1="150" x2="244" y2="192" class="branch subtree15" marker-end="url(#arrowhead)" />
      <line x1="281" y1="150" x2="301" y2="192" class="branch height13 height15 subtree15" marker-end="url(#arrowhead)" />
    </g>
  
    <!-- 'I' node -->
  <g class="child leaf">
    <circle cx="232" cy="212" r="15" class="node subtree15 successor13" />
    <text x="226" y="219" class="svgDataText subtree15 successor13" >B</text>
  </g>
  
  <!-- 'P' node -->
  <g class="child parent">
    <circle cx="312" cy="212" r="15" class="node subtree15" />
    <text x="306" y="219" class="svgDataText subtree15">F</text>
  </g>
  
  <!-- 'M' node  -->
  <g class="child leaf">
    <line x1="306" y1="227" x2="297" y2="264" class="branch height13 height15 subtree15" marker-end="url(#arrowhead)" />
    <line x1="318" y1="227" x2="327" y2="264" class="branch height13 height15 subtree15" marker-end="url(#arrowhead)" />
    <circle cx="292" cy="287" r="15" class="node subtree15" />
    <text x="285" y="295" class="svgDataText subtree15">E</text>
    <circle cx="332" cy="287" r="15" class="node subtree15" />
    <text x="325" y="295" class="svgDataText subtree15">G</text>
  </g>
  <g class="child leaf" transform="translate(-80 0)">
    <line x1="306" y1="227" x2="297" y2="264" class="branch height13 height15 subtree15" marker-end="url(#arrowhead)" />
    <line x1="318" y1="227" x2="327" y2="264" class="branch height13 height15 subtree15" marker-end="url(#arrowhead)" />
    <circle cx="292" cy="287" r="15" class="node subtree15" />
    <text x="285" y="295" class="svgDataText subtree15">A</text>
    <circle cx="332" cy="287" r="15" class="node subtree15" />
    <text x="325" y="295" class="svgDataText subtree15">C</text>
  </g>
  </g>
  ...
  <g transform="translate(0 -37)">
    ...
    <g class="parent child">
      <circle cx="272" cy="137" r="15" class="node subtree15" />
      <text x="266" y="144" class="svgDataText subtree15">L</text>
      <line x1="264" y1="150" x2="244" y2="192" class="branch subtree15" marker-end="url(#arrowhead)" />
      <line x1="281" y1="150" x2="301" y2="192" class="branch height13 height15 subtree15" marker-end="url(#arrowhead)" />
    </g>
  ...
  <g class="child leaf">
    <circle cx="232" cy="212" r="15" class="node subtree15 successor13" />
    <text x="226" y="219" class="svgDataText subtree15 successor13" >J</text>
  </g>
  
  <!-- 'P' node -->
  <g class="child parent">
    <circle cx="312" cy="212" r="15" class="node subtree15" />
    <text x="306" y="219" class="svgDataText subtree15">N</text>
  </g>
  ...
  <g class="child leaf">
    ...
    <line x1="318" y1="227" x2="327" y2="264" class="branch height13 height15 subtree15" marker-end="url(#arrowhead)" />
    <circle cx="292" cy="287" r="15" class="node subtree15" />
    <text x="285" y="295" class="svgDataText subtree15">M</text>
    <circle cx="332" cy="287" r="15" class="node subtree15" />
    <text x="325" y="295" class="svgDataText subtree15">O</text>
  </g>
  <g class="child leaf" transform="translate(-80 0)">
    <line x1="306" y1="227" x2="297" y2="264" class="branch height13 height15 subtree15" marker-end="url(#arrowhead)" />
    <line x1="318" y1="227" x2="327" y2="264" class="branch height13 height15 subtree15" marker-end="url(#arrowhead)" />
    <circle cx="292" cy="287" r="15" class="node subtree15" />
    <text x="285" y="295" class="svgDataText subtree15">I</text>
    <circle cx="332" cy="287" r="15" class="node subtree15" />
    <text x="325" y="295" class="svgDataText subtree15">K</text>
  </g>
  </g>
  </svg>
  <p>The number of nodes on each level in such an AVL Tree are:</p>
  <p><span class="math display">\[1, 2, 4, 8, 16, 32, ..\]</span></p>
  <p>Which is the same as:</p>
  <p><span class="math display">\[2^0, 2^1, 2^2, 2^3, 2^4, 2^5, ..\]</span></p>
  <p>To get the number of nodes \(n\) in a perfect Binary Tree with height \(h=3\), we can add the number of nodes on each level together:</p>
  <p><span class="math display">\[n_3=2^0 + 2^1 + 2^2 + 2^3 = 15\]</span></p>
  <p>Which is actually the same as:</p>
  <p><span class="math display">\[n_3=2^4 - 1 = 15\]</span></p>
  <p>And this is actually the case for larger trees as well! If we want to get the number of nodes \(n \) in a tree with height \(h=5 \) for example, we find the number of nodes like this:</p>
  <p><span class="math display">\[n_5=2^6 - 1 = 63\]</span></p>
  <p>So in general, the relationship between the height \(h \) of a perfect Binary Tree and the number of nodes in it \(n \), can be expressed like this:</p>
  <p><span class="math display">\[n_h = 2^{h+1} - 1\]</span></p>
  <div class="ws-note">
    <p><strong>Note: </strong>The formula above can also be found by calculating the sum of the geometric series \(2^0 + 2^1 + 2^2+  2^3 + ... + 2^n \)</p>
  </div>
  <p>We know that the time complexity for searching, deleting, or inserting a node in an AVL tree is \(O(h) \), but we want to argue that the time complexity is actually \(O(\log(n)) \), so we need to find the height \(h\) described by the number of nodes \(n\):</p>
  ...
  \end{equation}
  \]</span></p>
  <p>How the last line above is derived might not be obvious, but for a Binary Tree with a lot of nodes (big \(n\)), the "+1" and "-1" terms are not important when we consider time complexity. For more details on how to calculate the time complexity using Big O notation, see <a href="/dsa/dsa_timecomplexity_theory.php">this page</a>.</p>
  <p>The math above shows that the time complexity for search, delete, and insert operations on an AVL Tree \(O(h) \), can actually be expressed as \(O(\log{n}) \), which is fast, a lot faster than the time complexity for BSTs which is \(O(n) \).</p>
  <hr>
