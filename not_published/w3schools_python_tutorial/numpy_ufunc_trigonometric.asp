...
<html lang="en-US">
<head>
<title>NumPy ufuncs - Trigonometric Functions</title>
<meta charset="utf-8">
...
<h1>NumPy Trigonometric Functions</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="numpy_ufunc_gcd.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="numpy_ufunc_hyperbolic.asp">Next &#10095;</a>
</div>
<hr>

<h2>Trigonometric Functions</h2>

<p>NumPy provides the ufuncs <code class="w3-codespan">sin()</code>, <code class="w3-codespan">cos()</code> and <code class="w3-codespan">tan()</code> that take values in radians and produce the corresponding sin, cos and tan 
values.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Find sine value of PI/2:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>x = np.sin(np.pi/2)<br>
  <br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ufunc_trigonometric1">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Find sine values for all of the values in arr:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br>
  <br>arr = np.array([np.pi/2, np.pi/3, np.pi/4, np.pi/5])<br><br>x = np.sin(arr)<br>
  <br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ufunc_trigonometric2">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Convert Degrees Into Radians</h2>

<p>By default all of the trigonometric functions take radians as parameters
but we can convert radians to degrees and vice versa as well in NumPy.</p>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> radians values are pi/180 * degree_values.</p>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Convert all of the values in following array arr to radians:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr = np.array([90, 180, 270, 360])<br><br>
  x = np.deg2rad(arr)<br>
  <br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ufunc_trigonometric3">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-example">
<h3>Example</h3>
<p>Convert all of the values in following array arr to degrees:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr = np.array([np.pi/2, np.pi, 1.5*np.pi, 2*np.pi])<br>
  <br>x = np.rad2deg(arr)<br>
  <br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ufunc_trigonometric4">Try it Yourself &raquo;</a>
</div>
...
<p>Finding angles from values of sine, cos, tan. E.g. sin, cos and tan inverse (arcsin, arccos, arctan).</p>

<p>NumPy provides ufuncs <code class="w3-codespan">arcsin()</code>, <code class="w3-codespan">arccos()</code> and <code class="w3-codespan">arctan()</code> that produce radian values for corresponding sin, cos and tan values given.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Find the angle of 1.0:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>x = np.arcsin(1.0)<br>
  <br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ufunc_trigonometric5">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Angles of Each Value in Arrays</h2>

<div class="w3-example">
<h3>Example</h3>
<p>Find the angle for all of the sine values in the array</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>arr = np.array([1, -1, 0.1])<br><br>x = 
  np.arcsin(arr)<br>
  <br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ufunc_trigonometric6">Try it Yourself &raquo;</a>
</div>
...
<p>Finding hypotenues using pythagoras theorem in NumPy.</p>

<p>NumPy provides the <code class="w3-codespan">hypot()</code> function that takes the base and perpendicular values and produces hypotenues based on pythagoras theorem.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Find the hypotenues for 4 base and 3 perpendicular:</p>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>base = 3<br>perp = 4<br><br>x = np.hypot(base, perp)<br>
  <br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_numpy_ufunc_trigonometric7">Try it Yourself &raquo;</a>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_ufunc_trigonometric.js"></div>
<hr>
