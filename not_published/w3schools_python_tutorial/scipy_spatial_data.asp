...
<html lang="en-US">
<head>
<title>SciPy Spatial Data</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>SciPy <span class="color_h1">Spatial Data</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="scipy_graphs.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="scipy_matlab_arrays.php">Next &#10095;</a>
</div>
<hr>

<h2>Working with Spatial Data</h2>
<p>Spatial data refers to data that is represented in a geometric space.</p>
<p>E.g. points on a coordinate system.</p>
<p>We deal with spatial data problems on many tasks.</p>
<p>E.g. finding if a point is inside a boundary or not.</p>
<p>SciPy provides us with the module <code class="w3-codespan">scipy.spatial</code>, which has 
...
<p>A Triangulation of a polygon is to divide the polygon into multiple
triangles with which we can compute an area of the polygon.</p>

<p>A Triangulation <em>with points</em> means creating surface composed triangles in which all
of the given points are on at least one vertex of any triangle in the surface.</p>
<p>One method to generate these triangulations through points is the <code class="w3-codespan">Delaunay()</code> Triangulation.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Create a triangulation from following points:</p>
...
<br>
simplices = Delaunay(points).simplices<br>
<br>
plt.triplot(points[:, 0], points[:, 1], simplices)<br>
plt.scatter(points[:, 0], points[:, 1], color='r')<br>
<br>
plt.show()
</div>
<h3>Result:</h3>
<p>
  <img src="../scipy_spatial_delaunay.png" style="max-width:100%">
</p>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_scipy_spatial_delaunay">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> The <code class="w3-codespan">simplices</code> property creates a generalization of the triangle notation.</p>
</div>
...
<p>A convex hull is the smallest polygon that covers all of the given points.</p>

<p>Use the <code class="w3-codespan">ConvexHull()</code> method to create a Convex Hull.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Create a convex hull for following points:</p>
<div class="w3-code notranslate pythonHigh">
import numpy as np<br>
...
<br>
hull = ConvexHull(points)<br>
hull_points = hull.simplices<br>
<br>
plt.scatter(points[:,0], points[:,1])<br>
for simplex in hull_points:<br>
&nbsp;&nbsp;plt.plot(points[simplex,0], points[simplex,1], 'k-')<br>
<br>
plt.show()
</div>
<h3>Result:</h3>
<p>
  <img src="../scipy_spatial_convexhull.png" style="max-width:100%">
</p>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_scipy_spatial_convexhull">Try it Yourself &raquo;</a>
</div>
...
<p>KDTrees are a datastructure optimized for nearest neighbor queries.</p>
<p>E.g. in a set of points using KDTrees we can efficiently ask which points are nearest to a certain given point.</p>

<p>The <code class="w3-codespan">KDTree()</code> method returns a KDTree object.</p>

<p>The <code class="w3-codespan">query()</code> method returns the distance to the nearest neighbor <em>and</em> 
the location of the neighbors.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Find the nearest neighbor to point (1,1):</p>
<div class="w3-code notranslate pythonHigh">
from scipy.spatial import KDTree<br>
<br>
points = [(1, -1), (2, 3), (-2, 3), (2, -3)]<br>
<br>
kdtree = KDTree(points)<br>
<br>
res = kdtree.query((1, 1))<br>
<br>
print(res)
</div>
<h3>Result:</h3>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_scipy_spatial_kdtree">Try it Yourself &raquo;</a>
</div>
...
<p>There are many Distance Metrics used to find various types of distances between two points in data science, Euclidean distsance, cosine distsance etc.</p>

<p>The distance between two vectors may not only be the length of straight line between them,
it can also be the angle between them from origin, or number of unit steps required etc.</p>

<p>Many of the Machine Learning algorithm's performance depends greatly on distance metrices.
E.g. "K Nearest Neighbors", or "K Means" etc.</p>

<p>Let us look at some of the Distance Metrices:</p>
<hr>

<h2>Euclidean Distance</h2>

<p>Find the euclidean distance between given points.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_scipy_spatial_euclidean">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Cityblock Distance (Manhattan Distance)</h2>

<p>Is the distance computed using 4 degrees of movement.</p>

<p>E.g. we can only move: up, down, right, or left, not diagonally.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Find the cityblock distance between given points:</p>
<div class="w3-code notranslate pythonHigh">
from scipy.spatial.distance import cityblock<br>
<br>
p1 = (1, 0)<br>
p2 = (10, 2)<br>
<br>
res = cityblock(p1, p2)<br>
<br>
print(res)
</div>
<h3>Result:</h3>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_scipy_spatial_cityblock">Try it Yourself &raquo;</a>
</div>
...
<p>Is the value of cosine angle between the two points A and B.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Find the cosine distsance between given points:</p>
<div class="w3-code notranslate pythonHigh">
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_scipy_spatial_cosine">Try it Yourself &raquo;</a>
</div>
...
<p>Is the proportion of bits where two bits are different.</p>
<p>It's a way to measure distance for binary sequences.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Find the hamming distance between given points:</p>
<div class="w3-code notranslate pythonHigh">
from scipy.spatial.distance import hamming<br>
<br>
p1 = (True, False, True)<br>
p2 = (False, True, True)<br>
<br>
res = hamming(p1, p2)<br>
<br>
print(res)
</div>
<h3>Result:</h3>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_scipy_spatial_hamming">Try it Yourself &raquo;</a>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_spatial_data.js" data-extensions="php"></div>
<hr>
