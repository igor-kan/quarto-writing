...
<html lang="en-US">
<head>
<title>DSA Quicksort with Python</title>
<meta charset="utf-8">
...
<h1>DSA <span class="color_h1">Quicksort</span> with Python</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="python_dsa_insertionsort.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="python_dsa_countingsort.asp">Next &#10095;</a>
</div>
<hr>
...
<h2>Implement Quicksort in Python</h2>
...
<p>To implement the Quicksort algorithm in a Python program, we need:</p>
<ol>
...
<h3>Example</h3>
<p>Using the Quicksort algorithm in a Python program:</p>
<div class="w3-code notranslate pythonHigh">
def partition(array, low, high):<br>
&nbsp;&nbsp;pivot = array[high]<br>
&nbsp;&nbsp;i = low - 1<br>
<br>
...
<br>
&nbsp;&nbsp;array[i+1], array[high] = array[high], array[i+1]<br>
&nbsp;&nbsp;return i+1<br>
<br>
def quicksort(array, low=0, high=None):<br>
&nbsp;&nbsp;if high is None:<br>
&nbsp;&nbsp;&nbsp;&nbsp;high = len(array) - 1<br>
<br>
&nbsp;&nbsp;if low < high:<br>
&nbsp;&nbsp;&nbsp;&nbsp;pivot_index = partition(array, low, high)<br>
&nbsp;&nbsp;&nbsp;&nbsp;quicksort(array, low, pivot_index-1)<br>
&nbsp;&nbsp;&nbsp;&nbsp;quicksort(array, pivot_index+1, high)<br>
<br>
mylist = [64, 34, 25, 5, 22, 11, 90, 12]<br>
quicksort(mylist)<br>
print(mylist)</div>
  <a class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dsa_quicksort" target="_blank">Run Example »</a>
</div>
<hr>
...
<img src="/dsa/img_runtime_quicksort.png" alt="Time Complexity">
