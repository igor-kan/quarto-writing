...
<h1>Kotlin <span class="color_h1">While Loop</span></h1>

<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="kotlin_when.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="kotlin_break.php">Next &#10095;</a>
</div>
<hr>
...
<h3>Syntax</h3>
<pre class="language-kotlin notranslate w3-white"><code>while (<em>condition</em>) {
  <i>// code block to be executed</i>
}</code></pre>
</div>

<p>In the example below, the code in the loop will run, over and over again, as long as 
the counter variable (i) is less than 5:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>var i = 0
while (i &lt; 5) {
  println(i)
  i++
} </code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_while_loop">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-example">
<h3>Syntax</h3>
<pre class="language-kotlin notranslate w3-white"><code>do {
  <i>// code block to be executed</i>
}
...
while (i &lt; 5) </code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_do_while_loop">Try it Yourself &raquo;</a>
</div>
