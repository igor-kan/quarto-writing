...
<h1>Kotlin <span class="color_h1">Constructors</span></h1>

<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="kotlin_classes.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="kotlin_class_functions.php">Next &#10095;</a>
</div>
<hr>

<h2>Kotlin Constructor</h2>
<p>In the previous chapter, we created an object of a class, and specified the properties inside the class, like this:</p>
...
<p>In Kotlin, there's a faster way of doing this, by using a <strong>constructor</strong>.</p>

<p>A 
constructor is like a special <a href="kotlin_functions.php">function</a>, and it is defined by using two parantheses <code class="w3-codespan">()</code> 
...
<p>The constructor will initialize the properties when you create an object of a class. Just remember to specify the 
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_constructor">Try it Yourself &raquo;</a>
</div>

<p>Now it's even easier to specify multiple objects of one class:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_constructor2">Try it Yourself &raquo;</a>
</div>
