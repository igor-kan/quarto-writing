...
<html lang="en-US">
<head>
<title>Kotlin Classes and Objects</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>Kotlin <span class="color_h1">Classes and Objects</span></h1>

<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="kotlin_oop.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="kotlin_constructors.php">Next &#10095;</a>
</div>
<hr>

<h2>Kotlin Classes/Objects</h2>
<p>Everything in Kotlin is associated with classes and objects, along with its properties and 
...
<p>To create a class, use the <code class="w3-codespan">class</code> keyword, and specify the name of the class:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Create a <strong>Car </strong>class along with some <strong>properties</strong> (brand, model and year)</p>
<pre class="language-kotlin notranslate w3-white"><code>class Car {
  var brand = &quot;&quot;
  var model = &quot;&quot;
  var year = 0
} </code></pre>
...
<p>A <strong>property </strong>is basically a <a href="kotlin_variables.php"><strong>variable</strong></a> that belongs to the class.</p>
  <p><strong>Good to Know:</strong> It is considered good practice to start the 
  name of a class with an upper case letter, for better organization.</p>
</div>
<hr>

<h2>Create an Object</h2>
<p>Now we can use the class named <strong>Car</strong> to create objects.</p>
<p>In the example below, we create an object of <strong>Car</strong> called
<strong>c1</strong>, and then we access the properties of <strong>c1</strong> by 
using the dot syntax (<code class="w3-codespan">.</code>), just like we did to 
access array and string properties:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>// Create a c1 object of the Car class
val c1 = Car()
...
println(c1.year)&nbsp;&nbsp;&nbsp; // Outputs 1969 </code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_classes">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>val c1 = Car()
c1.brand = &quot;Ford&quot;
c1.model = &quot;Mustang&quot;
c1.year = 1969
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_classes_multiple">Try it Yourself &raquo;</a>
</div>
<hr>
