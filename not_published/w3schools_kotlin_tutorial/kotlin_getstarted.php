...
<h1>Kotlin <span class="color_h1">Get Started</span></h1>

<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="kotlin_intro.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="kotlin_syntax.php">Next &#10095;</a>
</div>
<hr>

<h2>Kotlin IDE</h2>
<p>The easiest way to get started with Kotlin, is to use an IDE.</p>
<p>An IDE (Integrated Development Environment) is used to edit and compile code.</p>
<p>In this chapter, we will use IntelliJ (developed by the same people that created Kotlin) which is free to download from <a href="https://www.jetbrains.com/idea/download/" target="_blank">https://www.jetbrains.com/idea/download/</a>.</p>

<hr>

<h2>Kotlin Install</h2>
<p>Once IntelliJ is downloaded and installed, click on the 
<strong>New Project</strong> button to get started with IntelliJ:</p>
<img src="intellij.png" style="max-width:100%" class="w3-image">

<p>Then click on "Kotlin" in the left side menu, and enter a name for your project:</p>
<img src="intellij2.png" style="max-width:100%" class="w3-image">

<p>Next, we need to install something called JDK (Java Development Kit) to get 
...
<img src="intellij3.png" style="max-width:100%" class="w3-image">
<p>When the JDK is downloaded and installed, choose it from the select menu and 
then click on the &quot;Next&quot; button and at last &quot;Finish&quot;:</p>
<img src="intellij4.png" style="max-width:100%" class="w3-image">
<p>Now we can start working with our Kotlin project. Do not worry about all of the different buttons and functions in 
IntelliJ. For now, just open the src (source) folder, and follow the same steps as in the image below, to create a kotlin file:</p>
<img src="intellij5s.png" style="max-width:100%" class="w3-image">
<p>Select the "File" option and add a name to your Kotlin file, for example "Main":</p>
<img src="intellij6.png" style="max-width:100%" class="w3-image">
<p>You have now created your first Kotlin file (Main.kt). Let's add some Kotlin code to it, and run the program to see how it works. Inside the Main.kt file, add the following code:</p>
...
<img src="intellij7.png" style="max-width:100%" class="w3-image">
<p>Don't worry if you don't understand the code above - we will discuss it in detail in later chapters. For now, lets focus on how to run the code. Click on the Run button 
at the top navigation bar, then click "Run", and select "Mainkt". </p>
<p>Next, IntelliJ will build your project, and run the Kotlin file. The output 
will look something like this:</p>
<img src="intellij8.png" style="max-width:100%" class="w3-image">
<p>As you can see, the output of the code was &quot;Hello World&quot;, meaning that you have now written and executed your first Kotlin program!</p>
<hr>

<h2>Learning Kotlin At W3Schools</h2>
<p>When learning Kotlin at w3schools.com, you can use our "Try it Yourself" tool, which shows both the code and the result. This will make it easier for 
...
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="trykotlin.php?filename=demo_helloworld">Try it Yourself &raquo;</a>
</div>
