...
<h1>Kotlin <span class="color_h1">Ranges</span></h1>

<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="kotlin_for_loop.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="kotlin_functions.php">Next &#10095;</a>
</div>
<hr>

<h2>Kotlin Ranges</h2>

<p>With the <a href="kotlin_for_loop.php"><code class="w3-codespan">for</code> loop</a>, you can also create 
<strong>ranges</strong> of values with &quot;<code class="w3-codespan">..</code>":</p>

<div class="w3-example">
<h3>Example</h3>
<p>Print the whole alphabet:</p>
<pre class="language-kotlin notranslate w3-white"><code>for (chars in 'a'..'x') {
  println(chars)
}</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_ranges">Try it Yourself &raquo;</a>
</div>

<p>You can also create ranges of numbers:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>for (nums in 5..15) {
  println(nums)
} </code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_ranges2">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
<p><strong>Note:</strong> The first and last value is included in the range.</p>
</div>
<hr>

<h2>Check if a Value Exists</h2>
<p>You can also use the <code class="w3-codespan">in</code> operator to check if a value exists in 
a range:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>val nums = arrayOf(2, 4, 6, 8)
if (2 in nums) {
  println(&quot;It exists!&quot;)
} else {
  println(&quot;It does not exist.&quot;)
}</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_ranges_in">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>val cars = arrayOf(&quot;Volvo&quot;, &quot;BMW&quot;, &quot;Ford&quot;, &quot;Mazda&quot;)
if (&quot;Volvo&quot; in cars) {
  println(&quot;It exists!&quot;)
} else {
  println(&quot;It does not exist.&quot;)
} </code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_ranges_in2">Try it Yourself &raquo;</a>
</div>
<hr>
...
<h2>Break or Continue a Range</h2>
<p>You can also use the <code class="w3-codespan">break</code> and <code class="w3-codespan">continue</code> keywords in a range/<code class="w3-codespan">for</code> loop:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Stop the loop when <code class="w3-codespan">nums</code> is equal to <code class="w3-codespan">10</code>:</p>
<pre class="language-kotlin notranslate w3-white"><code>for (nums in 5..15) {
  if (nums == 10) {
    break
  }
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_ranges_break">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Skip the value of 10 in the loop, and continue with the next iteration:</p>
<pre class="language-kotlin notranslate w3-white"><code>for (nums in 5..15) {
  if (nums == 10) {
    continue
  }
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_ranges_continue">Try it Yourself &raquo;</a>
</div>
<hr>
