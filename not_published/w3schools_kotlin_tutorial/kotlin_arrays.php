...
<h1>Kotlin <span class="color_h1">Arrays</span></h1>

<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="kotlin_break.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="kotlin_for_loop.php">Next &#10095;</a>
</div>
<hr>

<h2>Kotlin Arrays</h2>
<p>Arrays are used to store multiple values in a single variable, instead of 
creating separate variables for each 
value.</p>
<p>To create an array, use the <code class="w3-codespan">arrayOf()</code> function, and place the 
...
<p>You can access an array element by referring to the <strong>index number</strong>, 
...
<pre class="language-kotlin notranslate w3-white"><code>val cars = arrayOf(&quot;Volvo&quot;, &quot;BMW&quot;, &quot;Ford&quot;, &quot;Mazda&quot;)
println(cars[0])
// Outputs Volvo </code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_array_access">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
<p><strong>Note:</strong> Just like with Strings, Array indexes start with 0: [0] is the first element. [1] is the second 
element, etc.</p>
</div>
<hr>
...
<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>cars[0] = &quot;Opel&quot;
</code></pre>
</div>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  val cars = arrayOf(&quot;Volvo&quot;, &quot;BMW&quot;, &quot;Ford&quot;, &quot;Mazda&quot;)<br>
  cars[0] = &quot;Opel&quot;<br>
  println(cars[0])<br>
  // Now outputs Opel instead of Volvo<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_array_change">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Array Length / Size</h2>
<p><!--In Kotlin, an Array is a non-primitive data type, which means that it is an object with different methods that can be used to obtain information about this specific object. For example,--> 
To find out how many elements an array have, use the <code class="w3-codespan">size</code> property:</p>
...
println(cars.size)
// Outputs 4 </code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_array_size">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>You can use the <code class="w3-codespan">in</code> operator to check if an element exists in 
an array:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>val cars = arrayOf(&quot;Volvo&quot;, &quot;BMW&quot;, &quot;Ford&quot;, &quot;Mazda&quot;)
...
<p>Often when you work with arrays, you need to loop through all of the 
elements.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_array_for_loop">Try it Yourself &raquo;</a>
</div>
<hr>
