  ...
  <div class="cert-card">
    <div class="cert-card-header">
      <div class="cert-card-icon">
        <svg xmlns="http://www.w3.org/2000/svg" width="39" height="39" fill="#7F52FF" viewBox="0 0 24 24"><path d="M24 24H0V0h24L12 12Z"/></svg>
      </div>
      <h2 class="cert-card-title">Learn Kotlin</h2>
    </div>
    <p class="cert-card-desc">Kotlin is a modern, trending programming language.</p>
    <p class="cert-card-desc">Kotlin is used to develop Android apps, server side apps, and much more.</p>
    <div class="cert-card-bottom" style="margin-top:auto;padding-top:16px;">
      <a href="kotlin_intro.php" class="cert-card-btn">Learn Kotlin now &#10095;</a>
    </div>
  </div>

  <div class="cert-info" style="padding:24px;display:flex;flex-direction:column;">
    <h3 class="cert-info-title">Become Kotlin Certified</h3>
    <p class="cert-info-desc">Get certified with our Kotlin exam, includes a professionally curated study kit to guide you from beginner to exam-ready.</p>
...
<a href="https://campus.w3schools.com/collections/course-catalog/products/learn-kotlin" class="cert-card-btn cert-btn-white" target="_blank" style="margin-top:12px;background:#fff;color:#000;border:2px solid #000;">Get Certified &#10095;</a>
        </div>
        <div class="cert-preview" style="flex:1 1 auto;padding:0;align-self:flex-start;">
          <svg class="cert-preview-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 560 400" role="img" aria-label="Kotlin Certificate preview" style="width:100%;max-width:250px;height:auto;display:block;margin:0 0 0 auto;">
            ...
            <text x="280" y="212" text-anchor="middle" font-family="Source Sans Pro Topnav, sans-serif" font-size="13" fill="#475569">has passed the W3Schools Kotlin Certification exam and is hereby declared a</text>
            <g transform="translate(248,222)">
              <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="#7F52FF" viewBox="0 0 24 24"><path d="M24 24H0V0h24L12 12Z"/></svg>
            </g>
            <text x="280" y="300" text-anchor="middle" font-family="Source Sans Pro Topnav, sans-serif" font-size="18" font-weight="700" fill="#0f172a">Certified Kotlin Developer</text>
...
<h2>Kotlin Quiz</h2>
<p>Learn by taking a quiz! This quiz will give you a signal of how much you know about Kotlin.</p>
<p><a href="kotlin_quiz.php" class="w3-button w3-blue w3-round" style="font-size:17px;font-family: 'Source Sans Pro', sans-serif;">Take the Kotlin Quiz</a></p>
<hr>
