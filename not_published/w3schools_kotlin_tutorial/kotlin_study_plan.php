...
<html lang="en-US">
<head>
<title>Kotlin Study Plan (Lesson Plan)</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>Kotlin <span class="color_h1">Study Plan</span></h1>

<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="kotlin_syllabus.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="index.php">Next &#10095;</a>
</div>
<hr>
<h2>Introduction</h2>
<p>The Kotlin study plan helps you teach your students Kotlin step-by-step.</p>
<p>Creating a study plan for Kotlin is easy.</p>
...
<p>Save time with pre-built teacher materials and study plans. Easily organize your class with a timeline from the introduction of Kotlin to the final exam.</p>
<hr>
...
<p>W3Schools has everything you need to teach Kotlin.</p>

<p>The Kotlin training materials is available for you to include and use in your study plan:</p>
<ul>
  <li><a href="index.php" target="_blank">W3Schools Kotlin Tutorial</a></li>
  <li><a href="kotlin_exercises.php" target="_blank">Kotlin Exercises</a></li>
  <li><a href="kotlin_quiz.php" target="_blank">Kotlin Quiz</a></li>
  <li>Kotlin Challenges (Coding challenges)</li>
  <li><a href="kotlin_exam.php" target="_blank">Kotlin Certification Exam (End of Pathway Exam)</a></li>
</ul>
<hr>

<h2>Kotlin Syllabus</h2>
<p>With the Kotlin Syllabus, your students will start with the basics, like understanding variables, data types, and simple syntax, and move to more advanced topics, like working with functions, classes, and null safety. Each chapter includes simple examples, try-it-yourself sections, exercises, and quizzes to make learning easy, interactive, and fun.</p>
<p><a title="W3Schools Kotlin Syllabus" href="kotlin_syllabus.php" target="_blank">Read more about Kotlin Syllabus</a>.</p>
<hr>
...
<ol>
  ...
  <li style="margin-top:16px">
    ...
    <ul>
      <li>The Kotlin study plan aligns with the Kotlin Certification Exam.</li>
      <li>The exam can be taken at the end of the study plan, at your selected date.</li>
      <li>The exam summarizes the Kotlin Tutorial.</li>
...
<p>For example, this is how a 3-week Kotlin study plan could look like:</p>

<ul>
  <li>Week 1: Fundamentals, Variables, Data Types &amp; Operators</li>
  <li>Week 2: Conditionals, Arrays, Loops</li>
  <li>Week 3: Functions, Classes, Kotlin Certification Exam</li>
</ul>

<p>Image of Sample Kotlin study plan:</p>
<a href="kotlin_study_plan.png" target="_blank" title="Kotlin Study Plan"><img src="kotlin_study_plan.png" style="height:auto;max-width:100%;" loading="lazy"></a>
<hr>

<h2>Ready to get started?</h2>
<p>Start with <strong> Kotlin Study Plans</strong> today.</p>
...
<p>Are you interested in learning how you can use <a href="/academy/index.php" target="_blank">W3Schools Academy</a> to Teach Kotlin programming? </p>
