...
<h1>Kotlin <span class="color_h1">Data Types</span></h1>

<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="kotlin_variables.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="kotlin_operators.php">Next &#10095;</a>
</div>
<hr>

<h2>Kotlin Data Types</h2>
<p>In Kotlin, the <em>type</em> of a variable is decided by its value:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>val myNum = 5&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Int
val myDoubleNum = 5.99&nbsp;&nbsp;&nbsp;&nbsp;// Double
val myLetter = 'D' &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;// Char
val myBoolean = true&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Boolean
val myText = &quot;Hello&quot; &nbsp;&nbsp;&nbsp;&nbsp; // String</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_data_types">Try it Yourself &raquo;</a>
</div>
<p>However, you learned from the previous chapter that it is possible to specify the type if you want:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>val myNum: Int = 5&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; // Int
val myDoubleNum: Double = 5.99&nbsp;&nbsp;&nbsp;&nbsp;// Double
val myLetter: Char = 'D' &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;// Char
val myBoolean: Boolean = true&nbsp; &nbsp;&nbsp; // Boolean
val myText: String = &quot;Hello&quot; &nbsp;&nbsp;&nbsp;&nbsp; // String</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_data_types2">Try it Yourself &raquo;</a>
</div>

<p>Sometimes you have to specify the type, and often you don't. Anyhow, it is 
good to know what the different types represent.
<p>You will learn more about <strong>when you need </strong>to specify the type later.</p>
...
<p><strong>Integer types</strong> store whole numbers, positive or negative (such as 123 or -456), without decimals. 
Valid types are <code class="w3-codespan">Byte</code>, <code class="w3-codespan">
Short</code>, <code class="w3-codespan">Int</code> 
and <code class="w3-codespan">Long</code>.</p>
<p><strong>Floating point types</strong> represent numbers with a fractional part, 
containing one or more decimals. There are two types: <code class="w3-codespan">
Float</code> and <code class="w3-codespan">Double</code>.</p>
<div class="ws-note w3-panel">
<p>If you don't specify the type for a numeric variable, it is most often 
returned as <code class="w3-codespan">Int</code> for whole numbers and <code class="w3-codespan">Double</code> for floating point numbers.</p>
</div>
<hr>
<h2>Integer Types</h2>
...
from -128 to 127. This can be used instead of <code class="w3-codespan">Int</code> or other integer types to 
save memory when you are certain that the value will be within -128 and 127:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>val myNum: Byte = 100
println(myNum)</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_type_byte">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>val myNum: Short = 5000
println(myNum)</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_type_short">Try it Yourself &raquo;</a>
</div>

<h3>Int</h3>
<p>The <code class="w3-codespan">Int</code> data type can store whole numbers 
from -2147483648 to 2147483647:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>val myNum: Int = 100000
println(myNum)</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_type_int">Try it Yourself &raquo;</a>
</div>

<h3>Long</h3>
<p>The <code class="w3-codespan">Long</code> data type can store whole numbers from -9223372036854775808 to 9223372036854775807. This is used when 
<code class="w3-codespan">Int</code> is not large enough to store the value. 
Optionally, you can end the value with an &quot;L&quot;:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>val myNum: Long = 15000000000L
println(myNum)</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_type_long">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Difference Between Int and Long</h2>
<p>A whole number is an <code class="w3-codespan">Int</code> as long as it is up to 2147483647. If it goes beyond 
that, it is defined as <code class="w3-codespan">Long</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>val myNum1 = 2147483647&nbsp; // Int
val myNum2 = 2147483648&nbsp; // Long</code></pre>
</div>
<hr>
...
<p>The <code class="w3-codespan">Float</code> and <code class="w3-codespan">Double</code> data types can store fractional numbers:</p>
<div class="w3-example">
<h3>Float Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>val myNum: Float = 5.75F
println(myNum)</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_type_float">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Double Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>val myNum: Double = 19.99
println(myNum)</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_type_double">Try it Yourself &raquo;</a>
</div>
...
<p>Also note that you should end the value of a <code class="w3-codespan">Float</code> type with an "F".</p>
</div>

<h3>Scientific Numbers</h3>
<p>A floating point number can also be a scientific number with an "e" or &quot;E&quot; to indicate the power of 10:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>val myNum1: Float = 35E3F
val myNum2: Double = 12E4
println(myNum1)
println(myNum2)</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_type_scientific">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Booleans</h2>
<p>The <code class="w3-codespan">Boolean</code> data type can only take the values <code class="w3-codespan">true</code> or <code class="w3-codespan">false</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>val isKotlinFun: Boolean = true
val isFishTasty: Boolean = false
println(isKotlinFun)&nbsp;&nbsp;&nbsp;// Outputs true
println(isFishTasty)&nbsp;&nbsp; // Outputs false </code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_booleans">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>val myGrade: Char = 'B'
println(myGrade)</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_type_char">Try it Yourself &raquo;</a>
</div>
<p>Unlike Java, you cannot use ASCII values to display certain characters. The 
value 66 would output a &quot;B&quot; in Java, but will generate an error in Kotlin:</p>

<div class="w3-example w3-pale-red">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white w3-border-red"><code>val myLetter: Char = 66
println(myLetter) // Error</code></pre>
</div>
<hr>

<h2>Strings</h2>
<p>The <code class="w3-codespan">String</code> data type is used to store a sequence of characters (text). String values must be surrounded by 
<strong>double</strong> quotes:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>val myText: String = &quot;Hello World&quot;
println(myText)</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_type_string">Try it Yourself &raquo;</a>
</div>
<p>You will learn more about strings in <a href="kotlin_strings.php">the Strings chapter</a>.</p>
<hr>

<h2>Arrays</h2>
<p>Arrays are used to store multiple values in a single variable, instead of declaring separate variables for each value.</p>
<p>You will learn more about arrays in <a href="kotlin_arrays.php">the Arrays chapter</a>.</p>
<hr>

<h2>Type Conversion</h2>
<p>Type conversion is when you convert the value of one data type to another type.</p>
<p>In Kotlin, numeric type conversion is different from <a href="/java/default.asp">Java</a>. For example, it is not possible to convert an <code class="w3-codespan">Int</code> type to a <code class="w3-codespan">Long</code> type with the following code:</p>
<div class="w3-example w3-pale-red">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white w3-border-red"><code>val x: Int = 5
val y: Long = x
println(y) // Error: Type mismatch </code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_type_conv">Try it Yourself &raquo;</a>
</div>
<p>To convert a numeric data type to another type, you must use one of the following functions: <code class="w3-codespan">toByte()</code>, <code class="w3-codespan">toShort()</code>, <code class="w3-codespan">toInt()</code>, <code class="w3-codespan">toLong()</code>, <code class="w3-codespan">toFloat()</code>, <code class="w3-codespan">toDouble()</code> or <code class="w3-codespan">toChar()</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>val x: Int = 5
val y: Long = x.toLong()
println(y)</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_type_conv2">Try it Yourself &raquo;</a>
</div>
<hr>
