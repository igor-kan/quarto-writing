...
<h1>Kotlin <span class="color_h1">For Loop</span></h1>

<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="kotlin_arrays.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="kotlin_ranges.php">Next &#10095;</a>
</div>
<hr>
...
elements.</p>
<p>To loop through array elements, use the <code class="w3-codespan">for</code> 
loop together with the <code class="w3-codespan">in</code> operator:</p>
...
<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>val nums = arrayOf(1, 5, 10, 15, 20)
for (x in nums) {
  println(x)
}</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_array_for_loop2">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Traditional For Loop</h2>
<p>Unlike Java and other programming languages, there is no traditional <code class="w3-codespan">for</code> loop 
in Kotlin.</p>
<p>In Kotlin, the <code class="w3-codespan">for</code> loop is used to loop through arrays, ranges, and other 
things that contains a 
countable number of values.</p>
<p>You will learn more about <strong>ranges</strong> in the next chapter - which 
