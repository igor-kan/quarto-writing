...
<h1>Kotlin <span class="color_h1">Functions</span></h1>

<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="kotlin_ranges.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="kotlin_oop.php">Next &#10095;</a>
</div>
<hr>

<p class="intro">A <strong>function</strong> is a block of code which only runs when it is called.</p>
<p class="intro">You can pass data, known as parameters, into a function.</p>
<p class="intro">Functions are used to perform certain actions, and they are also known as <strong>methods</strong>.</p>
<hr>

<h2>Predefined Functions</h2>
<p>So it turns out you already know what a function is. You have been using it 
the whole time through this tutorial!</p>
<p>For example, <code class="w3-codespan">println()</code> is a function. It is used to output/print text to the screen:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>fun main() {
  println(&quot;Hello World&quot;)
}</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom w3-round" href="trykotlin.php?filename=demo_helloworld">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Create Your Own Functions</h2>
<p>To create your own function, use the <code class="w3-codespan">fun</code> keyword, and write the name of the 
function, followed by parantheses <strong>()</strong>:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Create a function named &quot;myFunction&quot; that should output some text:</p>
<pre class="language-kotlin notranslate w3-white"><code>fun myFunction() {
...
<p>Now that you have created a function, you can execute it by <strong>calling</strong> 
it.</p>
<p>To call a function in Kotlin, write the name of the function followed by two 
parantheses <strong>()</strong>.</p>
<p>In the following example, <code class="w3-codespan">myFunction()</code> will 
...
// Outputs &quot;I just got executed!&quot; </code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_function">Try it Yourself &raquo;</a>
</div>

<p>A function can be called multiple times, if you want:</p>
...
// I just got executed!
// I just got executed!
// I just got executed! </code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_function_multiple">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>fun myFunction(fname: String) {
  println(fname + &quot; Doe&quot;)
}
...
// Jane Doe
// George Doe </code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_function_param">Try it Yourself &raquo;</a>
</div>
<hr>

<div class="ws-note w3-panel">
<p>When a <strong>parameter</strong> is passed to the function, it is called an <strong>argument</strong>. So, from the example above: <code class="w3-codespan">fname</code> is a <strong>parameter</strong>, while <code class="w3-codespan">
John</code>, <code class="w3-codespan">Jane</code> and <code class="w3-codespan">
...
<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>fun myFunction(fname: String, age: Int) {
...
// John is 35
// Jane is 32
// George is 15 </code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_function_param2">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
<p><strong>Note:</strong> When working with multiple parameters, the function call must 
have the same number of arguments as there are parameters, and the arguments must be passed in the same order.</p>
</div>
<hr>

<h2>Return Values</h2>
<p>In the examples above, we used functions to output a value. In the following example, we will use a function to 
<strong>return </strong>a value and assign it to a variable.</p>
<p>To return a value, use the <code class="w3-codespan">return</code> keyword, and specify the 
<strong>return type</strong> after 
the function's parantheses (<code class="w3-codespan">Int</code> in this example):</p>
<div class="w3-example">
<h3>Example</h3>
<p>A function with one <code class="w3-codespan">Int</code> parameter, and <code class="w3-codespan">Int</code> return type:</p>
<pre class="language-kotlin notranslate w3-white"><code>fun myFunction(x: Int): Int {
  return (x + 5)
}
...
// 8 (3 + 5) </code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_function_return">Try it Yourself &raquo;</a>
</div>

<p>Using two parameters:</p>
<div class="w3-example">
<h3>Example</h3>
<p>A function with two <code class="w3-codespan">Int</code> parameters, and <code class="w3-codespan">Int</code> return type:</p>
<pre class="language-kotlin notranslate w3-white"><code>fun myFunction(x: Int, y: Int): Int {
  return (x + y)
}
...
// 8 (3 + 5) </code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_function_return2">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Shorter Syntax for Return Values</h2>
<p>There is also a shorter syntax for returning values. You can use the <code class="w3-codespan">=</code> operator instead of <code class="w3-codespan">return</code> 
without specifying the return type. Kotlin is smart enough to automatically find out what it is:</p>
<div class="w3-example">
<h3>Example</h3>

<pre class="language-kotlin notranslate w3-white"><code>fun myFunction(x: Int, y: Int) = x + y
...
// 8 (3 + 5) </code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_function_assignment">Try it Yourself &raquo;</a>
</div>
<hr>
