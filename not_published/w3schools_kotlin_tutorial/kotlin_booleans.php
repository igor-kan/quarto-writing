...
<h1>Kotlin <span class="color_h1">Booleans</span></h1>

<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="kotlin_strings.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="kotlin_conditions.php">Next &#10095;</a>
</div>
<hr>
...
<p>For this, Kotlin has a <code class="w3-codespan">Boolean</code> data type, which can take the values <code class="w3-codespan">true</code> or <code class="w3-codespan">false</code>.</p>
<hr>

<h2>Boolean Values</h2>
<p>A boolean type can be declared with the <code class="w3-codespan">Boolean</code> keyword and can only take the values <code class="w3-codespan">true</code> or <code class="w3-codespan">false</code>:</p>
...
<p>Just like you have learned with other data types in the previous chapters, the example above can also be written without specifying the type, as Kotlin is smart enough to understand that the variables are Booleans:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>val isKotlinFun = true
val isFishTasty = false
println(isKotlinFun)&nbsp;&nbsp;&nbsp;// Outputs true
println(isFishTasty)&nbsp;&nbsp; // Outputs false </code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_booleans_without">Try it Yourself &raquo;</a>
</div>
...
<p>A Boolean expression <strong>returns </strong>a Boolean value: <code class="w3-codespan">true</code> or <code class="w3-codespan">false</code>.</p>
...
<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>val x = 10
val y = 9<br>println(x &gt; y) // Returns true, because 10 is greater than 9</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_booleans1">Try it Yourself &raquo;</a>
</div>
<p>Or even easier:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>println(10 &gt; 9) // Returns true, because 10 is greater than 9</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_booleans2">Try it Yourself &raquo;</a>
</div>
...
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>val x = 10;
println(x == 10); // Returns true, because the value of x is equal to 10</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_booleans3">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>println(10 == 15); // Returns false, because 10 is not equal to 15</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_booleans4">Try it Yourself &raquo;</a>
</div>
<div class="w3-panel ws-note">
<p>The Boolean value of an expression is the basis for all Kotlin comparisons and conditions.</p>
