...
<h1>Kotlin <span class="color_h1">Strings</span></h1>

<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="kotlin_operators.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="kotlin_booleans.php">Next &#10095;</a>
</div>
<hr>
...
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>var greeting = &quot;Hello&quot;</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_strings">Try it Yourself &raquo;</a>
</div>
<p>Unlike <a href="/java/default.asp">Java</a>, you do not have to specify that the variable should be a <code class="w3-codespan">String</code>. Kotlin is smart enough to understand that the greeting variable in the example 
above is a <code class="w3-codespan">String</code> because of the double quotes.</p>
<p>However, just like with other data types, you can specify the type if you insist:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>var greeting: String = &quot;Hello&quot;</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_strings2">Try it Yourself &raquo;</a>
</div>
<p><strong>Note:</strong> If you want to create a <code class="w3-codespan">String</code> without assigning the value (and assign the value later), you must specify the type while declaring the variable:</p>
<div class="w3-row-padding" style="margin:-16px">
<div class="w3-half">
<div class="w3-example">
<h3>Example</h3>
<p>This works fine:</p>
<pre class="language-kotlin notranslate w3-white"><code>var name: String
name = &quot;John&quot;
println(name)</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_variables3">Try it Yourself &raquo;</a>
</div>
</div>
...
<pre class="language-kotlin notranslate w3-white w3-border-red"><code>var name
name = &quot;John&quot;
println(name)</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_variables4">Try it Yourself &raquo;</a>
</div>
</div>
...
<h2>Access a String</h2>
<p>To access the characters (elements) of a string, you must refer to the <strong>index number</strong> 
inside <strong>square brackets.</strong></p>
<p>String indexes start with 0. In the example below, we access the first and third element in <code class="w3-codespan">
txt</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>var txt = &quot;Hello World&quot;
println(txt[0]) // first element (H)
println(txt[2]) // third element (l)</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_strings_access">Try it Yourself &raquo;</a>
</div>
<div class="w3-panel ws-note">
<p>[0] is the first element. [1] is the second element, [2] is the third element, etc.</p>
</div>
<hr>
...
<h2>String Length</h2>
<p>A String in Kotlin is an object, which contain properties and functions that can perform certain operations on strings, 
by writing a dot character (<code class="w3-codespan">.</code>) after the specific string variable. For example, the length of a string can be found with the <code class="w3-codespan">length</code> 
property:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>var txt = &quot;ABCDEFGHIJKLMNOPQRSTUVWXYZ&quot;
println(&quot;The length of the txt string is: &quot; + txt.length)</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_strings_length">Try it Yourself &raquo;</a>
</div>
...
<p>There are many string functions available, for example 
<code class="w3-codespan">uppercase()</code> and <code class="w3-codespan">lowercase()</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>var txt = &quot;Hello World&quot;
println(txt.uppercase())&nbsp;&nbsp; // Outputs &quot;HELLO WORLD&quot;
println(txt.lowercase())&nbsp;&nbsp; // Outputs &quot;hello world&quot;</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_strings_touppercase">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Comparing Strings</h2>
<p>The <code class="w3-codespan">compareTo(<em>string</em>)</code> function 
compares two strings and returns 0 if both are equal:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>var txt1 = &quot;Hello World&quot;<br>var txt2 = &quot;Hello World&quot;
println(txt1.compareTo(txt2))&nbsp; // Outputs 0 (they are equal)</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_strings_compareto">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Finding a String in a String</h2>
<p>The <code class="w3-codespan">indexOf()</code> function returns the <strong>index</strong> (the position) 
of the first occurrence of a specified text in a string 
(including whitespace):</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>var txt = "Please locate where 'locate' occurs!"
println(txt.indexOf("locate"))&nbsp; // Outputs 7</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_strings_indexof">Try it Yourself &raquo;</a>
</div>
<div class="w3-panel ws-note">
<p>Remember that Kotlin counts positions from zero.<br>0 is the first position in a 
...
<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>var txt1 = &quot;It's alright&quot;
var txt2 = &quot;That's great&quot;</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_strings_quotes">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>var firstName = "John"
var lastName = "Doe"
println(firstName + " " + lastName)</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_strings_conc">Try it Yourself &raquo;</a>
</div>
<div class="ws-note w3-panel"><p>Note that we have added an empty text (" ") to create a space between firstName and lastName on print.</p></div>
<p>You can also use the <code class="w3-codespan">plus()</code> function to concatenate two strings:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>var firstName = "John "
var lastName = "Doe"
println(firstName.plus(lastName))</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_strings_conc2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>String Templates/Interpolation</h2>
<p>Instead of concatenation, you can also use &quot;string templates&quot;, which is an 
easy way to add variables and expressions inside a string.</p>
<p>Just refer to the variable with the <code class="w3-codespan">$</code> symbol:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>var firstName = &quot;John&quot;
var lastName = &quot;Doe&quot;
println(&quot;My name is $firstName $lastName&quot;)</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_strings_template">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
<p>&quot;String Templates&quot; is a popular feature of Kotlin, as it reduces the amount 
