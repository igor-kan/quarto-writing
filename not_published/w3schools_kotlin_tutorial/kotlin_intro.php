...
<h1>Kotlin <span class="color_h1">Introduction</span></h1>

<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="index.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="kotlin_getstarted.php">Next &#10095;</a>
</div>
<hr>

<h2>What is Kotlin?</h2>
<p>Kotlin is a modern, trending programming language that was released in 2016 
by JetBrains.</p>
<p>It has become very popular since it is compatible with <a href="/java/default.asp">Java</a> (one of the most popular programming languages out there), which means that Java code (and libraries) can be 
used in Kotlin programs.</p>
<p>Kotlin is used for:</p>
...
<hr>
<h2>Get Started</h2>
<p>This tutorial will teach you the very basics of Kotlin.</p>
<p>It is not necessary to have any prior programming experience.</p>
<a class="ws-btn ws-black" href="kotlin_getstarted.php">Get Started &raquo;</a>
