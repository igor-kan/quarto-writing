...
<html lang="en-US">
<head>
<title>Kotlin Class Functions</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>Kotlin <span class="color_h1">Class Functions</span></h1>

<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="kotlin_constructors.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="kotlin_inheritance.php">Next &#10095;</a>
</div>
<hr>

<h2>Kotlin Class Functions</h2>
<p>You can also use <a href="kotlin_functions.php">functions</a> inside a class, to perfom certain actions:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Create a <code class="w3-codespan">drive()</code> function inside the 
<code class="w3-codespan">Car</code> class and call it:</p>
<pre class="language-kotlin notranslate w3-white"><code>class Car(var brand: String, var model: String, var year: Int) {
  // Class function
  fun drive() {
    println(&quot;Wrooom!&quot;)
  }
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_class_function">Try it Yourself &raquo;</a>
</div>
<div class="ws-note w3-panel">
<p><strong>Tip:</strong> When a function is declared inside a class, it is known as a <em>class function</em>, or 
<em>member function</em>.</p>
<p><strong>Note:</strong> When an object of the class is created, it has access to all of the class functions.</p>
</div>

<hr>

<h2>Class Function Parameters</h2>
<p>Just like with regular functions, you can pass parameters to a class function:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Create two functions: <code class="w3-codespan">drive()</code> and <code class="w3-codespan">speed()</code>, and pass parameters to the 
<code class="w3-codespan">speed()</code> function:</p>
<pre class="language-kotlin notranslate w3-white"><code>class Car(var brand: String, var model: String, var year: Int) {
  // Class function
  fun drive() {
    println(&quot;Wrooom!&quot;)
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_class_function2">Try it Yourself &raquo;</a>
</div>
