...
<h1>Kotlin <span class="color_h1">Variables</span></h1>

<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="kotlin_comments.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="kotlin_data_types.php">Next &#10095;</a>
</div>
<hr>

<h2>Kotlin Variables</h2>
<p>Variables are containers for storing data values.</p>
<p>To create a variable, use <code class="w3-codespan">var</code> or <code class="w3-codespan">val</code>, and assign a value to it with the equal sign (<code class="w3-codespan">=</code>):</p>
<div class="w3-example">
<h3>Syntax</h3>
<pre class="language-kotlin notranslate w3-white"><code>var <em>variableName</em> = <em>value</em>
val <em>variableName</em> = <em>value</em></code></pre>
</div>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>var name = &quot;John&quot;
val birthyear = 1975

println(name)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Print the value of name
println(birthyear)&nbsp;&nbsp;&nbsp;&nbsp; // Print the value of birthyear</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_variables1">Try it Yourself &raquo;</a>
</div>
<p>The difference between <code class="w3-codespan">var</code> and <code class="w3-codespan">val</code> is that variables declared 
with the <code class="w3-codespan">var</code> keyword 
<strong>can be changed/modified</strong>, while <code class="w3-codespan">val</code> variables 
<strong>cannot</strong>.</p>
<hr>

<h2>Variable Type</h2>
<p>Unlike many other programming languages, variables in Kotlin do not need to be declared with a specified 
...
<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>var name = &quot;John&quot;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // String (text)
val birthyear = 1975&nbsp;&nbsp; // Int (number)

println(name)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Print the value of name
println(birthyear)&nbsp;&nbsp;&nbsp;&nbsp; // Print the value of birthyear</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_variables">Try it Yourself &raquo;</a>
</div>
<p>Kotlin is smart enough to understand that <b>"John"</b> is a <code class="w3-codespan">String</code> (text), and that <b>1975</b> is an <code class="w3-codespan">Int</code> 
(number) variable.</p>
<p>However, it is possible to specify the type if you insist:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>var name: String = &quot;John&quot; // String
val birthyear: Int = 1975 // Int

println(name)
println(birthyear)</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_variables2">Try it Yourself &raquo;</a>
</div>

<p>You can also declare a variable without assigning the value, and assign the 
...
<p><strong>Note:</strong> You will learn more about <a href="kotlin_data_types.php">Data Types in the next chapter</a>.</p>
</div>
<hr>
...
<h2>Notes on <code class="w3-codespan">val</code></h2>
  <p>When you create a variable with the <code class="w3-codespan">val</code> keyword, the value 
  <strong>cannot</strong> be changed/reassigned.</p>
  <p>The following example will generate an error:</p>
<div class="w3-example w3-pale-red">
  <h3>Example</h3>
<pre class="language-kotlin notranslate w3-white w3-border-red"><code>val name = &quot;John&quot;
name = &quot;Robert&quot;&nbsp; // Error (Val cannot be reassigned)
println(name)</code></pre>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_variables5">Try it Yourself &raquo;</a>
  </div>
  
<p>When using <code class="w3-codespan">var</code>, you can change the value whenever you want:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>var name = &quot;John&quot;
name = &quot;Robert&quot;
println(name)</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_variables_change">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
 <h4>So When To Use <code class="w3-codespan">val</code>?</h4>
 <p>The <code class="w3-codespan">val</code> keyword is useful when you want a variable to always store the same value, like PI (3.14159...):</p>
 <div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>val pi = 3.14159265359
println(pi)</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_variables_pi">Try it Yourself &raquo;</a>
</div>
<!--
<p><strong>Tip:</strong> Keep in mind that it is much safer to create variables that can't be changed, as they can't be overwritten by other programs or people.</p>
-->
</div>
<hr>

<h2>Display Variables</h2>
<p>Like you have seen with the examples above, the <code class="w3-codespan">println()</code> method is often used to display variables.</p>
<p>To combine both text and a variable, use the <code class="w3-codespan">+</code> character:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>val name = &quot;John&quot;
println(&quot;Hello &quot; + name)</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_variables_println">Try it Yourself &raquo;</a>
</div>

<p>You can also use the <code class="w3-codespan">+</code> character to add a variable to another variable:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>val firstName = &quot;John &quot;
val lastName = &quot;Doe&quot;
val fullName = firstName + lastName
println(fullName)</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_variables_println2">Try it Yourself &raquo;</a>
</div>

<p>For numeric values, the <code class="w3-codespan">+</code> character works as 
a mathematical operator:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>val x = 5
val y = 6
println(x + y) // Print the value of x + y </code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_variables_println3">Try it Yourself &raquo;</a>
</div>
...
<ul>
  ...
  <li>Reserved words (like Kotlin keywords, such as <code class="w3-codespan">
  var</code> or 
