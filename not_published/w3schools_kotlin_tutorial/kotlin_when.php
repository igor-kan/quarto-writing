...
<html lang="en-US">
<head>
<title>Kotlin When Expressions</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>Kotlin <span class="color_h1">When</span></h1>

<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="kotlin_conditions.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="kotlin_while_loop.php">Next &#10095;</a>
</div>
<hr>

<h2>Kotlin when</h2>
<p>Instead of writing many <code class="w3-codespan">if..else</code> expressions, you can use the <code class="w3-codespan">when</code> 
expression, which is much easier to read.</p>

<p>It is used to select one of many code blocks to be executed:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Use the weekday number to calculate the weekday name:</p>
<pre class="language-kotlin notranslate w3-white"><code>val day = 4
...
// Outputs &quot;Thursday&quot; (day 4)</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_when">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
<p>The <code class="w3-codespan">when</code> expression is similar to the <code class="w3-codespan">switch</code> statement in Java.</p>

</div>
<p>This is how it works:</p>
<ul>
<li>The <code class="w3-codespan">when</code> variable (<strong>day</strong>) is evaluated once</li>
<li>The value of the <strong>day</strong> variable is compared with the values of each &quot;branch&quot;</li>
  <li>Each branch starts with a value, followed by an arrow (-&gt;) and a result</li>
  <li>If there is a match, the associated block of code is executed</li>
  <li><code class="w3-codespan">else</code> is used to specify some code to run if there is no match</li>
  <li>In the example above, the value of <code class="w3-codespan">day</code> is <code class="w3-codespan">4</code>, meaning "Thursday" will be printed</li>
</ul>
<hr>
