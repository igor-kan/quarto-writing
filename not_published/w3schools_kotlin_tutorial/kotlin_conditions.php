...
<html lang="en-US">
<head>
<title>Kotlin If ... Else Expressions</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>Kotlin <span class="color_h1">If ... Else</span></h1>

<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="kotlin_booleans.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="kotlin_when.php">Next &#10095;</a>
</div>
<hr>

<h2>Kotlin Conditions and If..Else</h2>

<p>You already know that Kotlin supports familiar comparison conditions from mathematics, such as:</p>
<ul>
...
<ul>
  ...
  <li>Use <code class="w3-codespan">when</code> to specify many alternative blocks of code to be executed</li>
</ul>
<p><strong>Note:</strong> Unlike Java, <code class="w3-codespan">if..else</code> can be used as a 
<strong>statement</strong> or as an <strong>expression</strong> (to assign a 
value to a variable) in Kotlin. See 
an example at the bottom of the page to better understand it.</p>
<hr>

<h2>Kotlin if</h2>

<p>Use <code class="w3-codespan">if</code> to specify a block of code to be executed if a condition is <code class="w3-codespan">true</code>.</p>

<div class="w3-example">
<h3>Syntax</h3>
<pre class="language-kotlin notranslate w3-white"><code>if (<em>condition</em>) {
...
<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>if (20 &gt; 18) {
&nbsp; println(&quot;20 is greater than 18&quot;)
}</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_if">Try it Yourself &raquo;</a>
</div>

<p>We can also test variables:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>val x = 20
val y = 18
if (x &gt; y) {
  println(&quot;x is greater than y&quot;)
}</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_if2">Try it Yourself &raquo;</a>
</div>
...
<h2>Kotlin else</h2>
<p>Use <code class="w3-codespan">else</code> to specify a block of code to be executed if the condition is <code class="w3-codespan">false</code>.</p>
...
<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>val time = 20
if (time &lt; 18) {
  println(&quot;Good day.&quot;)
} else {
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_if_else">Try it Yourself &raquo;</a>
</div>
<h4>Example explained</h4>
...
<p>Use <code class="w3-codespan">else if</code> to specify a new condition if the first condition is <code class="w3-codespan">false</code>.</p>

<div class="w3-example">
<h3>Syntax</h3>
<pre class="language-kotlin notranslate w3-white"><code>if (<em>condition1</em>) {
...
<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>val time = 22
if (time &lt; 10) {
...
// Outputs &quot;Good evening.&quot;</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_if_else_if">Try it Yourself &raquo;</a>
</div>
<h4>Example explained</h4>
...
<h2>Kotlin If..Else Expressions</h2>
<p>In Kotlin, you can also use <code class="w3-codespan">if..else</code> statements as expressions 
(assign a value to a variable and return it):</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>val time = 20
...
println(greeting)</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_if_else_exp">Try it Yourself &raquo;</a>
</div>
<div class="ws-note w3-panel">
<p>When using <code class="w3-codespan">if</code> as an expression, you must also include <code class="w3-codespan">else</code> (required).</p>
</div>

<p><strong>Note:</strong> You can ommit the curly braces <code class="w3-codespan">{}</code> 
when <code class="w3-codespan">if</code> has only one statement:</p>
<div class="w3-example">
<h3>Example</h3>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_if_else_exp2">Try it Yourself &raquo;</a>
</div>
<p><strong>Tip:</strong> This example is similar to the "ternary operator" (short hand if...else) in Java.</p>
