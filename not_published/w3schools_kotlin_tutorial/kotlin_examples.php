...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="kotlin_exam.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="kotlin_compiler.php">Next &#10095;</a>
</div>
<hr>

<h2>Kotlin Syntax and Output</h2>
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="trykotlin.php?filename=demo_output">
Output some text</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_output2">
Output text on new lines</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_output3">
Do a simple calculation</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_output_print">
Output some text with the print() function</a>

</div>
<a href="kotlin_output.php" class="ws-btn w3-margin-top">Output Explained</a>
<hr>

<h2>Kotlin Comments</h2>
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="trykotlin.php?filename=demo_comments_single">
Single-line comment before a line of code</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_comments_end">
Single-line comment at the end of a line of code</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_comments_multi">
Multi-line comment</a>
</div>
<a href="kotlin_comments.php" class="ws-btn w3-margin-top">Comments Explained</a>
<hr>

<h2>Kotlin Variables</h2>
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="trykotlin.php?filename=demo_variables">
Create two variables</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_variables2">
Create two variables and specify the data type</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_variables3">
Declare a variable without assigning the value</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_variables5">
Create variable that cannot be changed/reassigned</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_variables_println">
Combine both text and a variable</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_variables_println2">
Add a variable to another variable</a>
</div>
<a href="kotlin_variables.php" class="ws-btn w3-margin-top">Variables Explained</a>
<hr>

<h2>Kotlin Data Types</h2>
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="trykotlin.php?filename=demo_data_types">
Create different variables of different types</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_data_types2">
Create different variables of different types explicitly</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_type_byte">
Create a Byte type variable</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_type_short">
Create a Short type variable</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_type_int">
Create an Int type variable</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_type_long">
Create a Long type variable</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_type_float">
Create a Float type variable</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_type_double">
Create a Double type variable</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_booleans">
Create a Boolean type variable</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_type_char">
Create a Char type variable</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_type_string">
Create a String type variable</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_type_conv2">
Type conversion - Convert a data type to anoter type</a>
</div>
<a href="kotlin_data_types.php" class="ws-btn w3-margin-top">Data Types Explained</a>
<hr>


<h2>Kotlin Operators</h2>
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="trykotlin.php?filename=demo_oper">
Addition operator</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_oper_sub">
Subtraction operator</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_oper_mult">
Multiplication operator</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_oper_div">
Division operator</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_oper_mod">
Modulus operator</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_oper_inc">
Increment operator</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_oper_dec">
Decrement operator</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_oper_assignment1">
Assignment operator</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_oper_compare1">
Equal operator</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_oper_compare2">
Not equal operator</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_oper_compare3">
Greater than operator</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_oper_compare4">
Less than operator</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_oper_compare5">
Greater than or equal to operator</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_oper_compare6">
Less than or equal to operator</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_oper_logical1">
Logical and operator</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_oper_logical2">
Logical or operator</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_oper_logical3">
Logical not operator</a>

</div>
<a href="kotlin_operators.php" class="ws-btn w3-margin-top">Operators Explained</a>
<hr>
...
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="trykotlin.php?filename=demo_strings">
Create a string</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_strings2">
Create a string and specify the type</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_strings_access">
Access a string</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_strings_length">
Find the length of a string</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_strings_compareto">
Compare two strings</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_strings_indexof">
Find a string in a string</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_strings_conc">
Concatenate/merge two strings</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_strings_conc2">
Concatenate/merge two strings with the plus() function</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_strings_quotes">
Use quotes inside a string</a>
</div>
<a href="kotlin_strings.php" class="ws-btn w3-margin-top">Strings Explained</a>
<hr>

<h2>Kotlin Booleans</h2>
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="trykotlin.php?filename=demo_booleans_without">
Create a boolean</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_booleans">
Create a a boolean and specify the type</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_booleans1">
Compare two values</a>
</div>
<a href="kotlin_booleans.php" class="ws-btn w3-margin-top">Booleans Explained</a>
<hr>

<h2>Kotlin If...Else</h2>
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="trykotlin.php?filename=demo_if">
The if statement</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_if_else">
The else statement</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_if_else_if">
The else if statement</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_if_else_exp">
If..else expression</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_if_else_exp2">
Short hand if..else</a>

</div>
<a href="kotlin_conditions.php" class="ws-btn w3-margin-top">If...Else Explained</a>
<hr>

<h2>Kotlin When</h2>
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="trykotlin.php?filename=demo_when">
The when expression</a>

</div>
<a href="kotlin_when.php" class="ws-btn w3-margin-top">When Explained</a>
<hr>

<h2>Kotlin While Loop</h2>
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="trykotlin.php?filename=demo_while_loop">
Loop through a block of code using a while loop</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_do_while_loop">
Loop through a block of code using a do/while loop</a>

</div>
<a href="kotlin_while_loop.php" class="ws-btn w3-margin-top">While Loop Explained</a>
<hr>

<h2>Kotlin While Loop</h2>
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="trykotlin.php?filename=demo_break">
Jump out of a loop with the break statement</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_continue">
Skip a value in a loop with the continue statement</a>

</div>
<a href="kotlin_break.php" class="ws-btn w3-margin-top">Break/continue Explained</a>
<hr>

<h2>Kotlin Arrays</h2>
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="trykotlin.php?filename=demo_array_access">
Create and access an array</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_array_change">
Change an array element</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_array_size">
Find the length/size of an array</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_ranges_in2">
Check if an element exists in an array</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_array_for_loop">
Loop through an array</a>

</div>
<a href="kotlin_arrays.php" class="ws-btn w3-margin-top">Arrays Explained</a>
<hr>

<h2>Kotlin For Loops</h2>
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="trykotlin.php?filename=demo_array_for_loop">
Loop through an array of strings</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_array_for_loop2">
Loop through an array of integers</a>

</div>
<a href="kotlin_for_loop.php" class="ws-btn w3-margin-top">For loop Explained</a>
<hr>

<h2>Kotlin Ranges</h2>
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="trykotlin.php?filename=demo_ranges">
Create a range of characters</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_ranges2">
Create a range of numbers</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_ranges_in">
Check if a value exists in a range</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_ranges_break">
Using the break statement in a range</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_ranges_continue">
Using the continue statement in a range</a>

</div>
<a href="kotlin_ranges.php" class="ws-btn w3-margin-top">Ranges Explained</a>
<hr>

<h2>Kotlin Functions</h2>
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="trykotlin.php?filename=demo_function">
Create a function and call it</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_function_multiple">
Call a function multiple times</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_function_param">
Create a function with parameters</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_function_return">
Using the return keyword in a function</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_function_assignment">
Short hand syntax for return values</a>

</div>
<a href="kotlin_functions.php" class="ws-btn w3-margin-top">Functions Explained</a>
<hr>

<h2>Kotlin Classes</h2>
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="trykotlin.php?filename=demo_classes">
Create a class and an object of that class</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_classes_multiple">
Create multiple objects of one class</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_constructor2">
Create a constructor</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_class_function">
Create a class function</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_class_function2">
Create a class function with parameters</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="trykotlin.php?filename=demo_inheritance">
Create a class that should inherit properties of a parent class (inheritance)</a>

</div>
<a href="kotlin_classes.php" class="ws-btn w3-margin-top">Classes Explained</a>
<hr>
