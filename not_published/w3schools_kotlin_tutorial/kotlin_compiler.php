<!DOCTYPE html>
<html lang="en-US">
<title>Kotlin Online Compiler (Editor / Interpreter)</title>
<style>
...
.kt-keyword   { color: #005cc5; }
.kt-function  { color: #d73a49; }
.kt-string    { color: green; }
.kt-number    { color: #098658; }
.kt-brace     { color: #000000; }
.kt-symbol    { color: #000000; }
...
body.darkpagetheme .kt-keyword  { color: #c5a5c5; }
body.darkpagetheme .kt-function { color: #faca6b; }
body.darkpagetheme .kt-string   { color: #c3e88d; }
body.darkpagetheme .kt-number   { color: #f78c6c; }
body.darkpagetheme .kt-brace    { color: #f1f1f1; }
body.darkpagetheme .kt-symbol   { color: #f1f1f1; }
...
<h1>Kotlin <span class="color_h1">Compiler</span></h1>

<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="kotlin_examples.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="kotlin_exercises.php">Next &#10095;</a>
</div>
<hr>

<h2>Kotlin Compiler (Editor)</h2>

<p>With our online Kotlin compiler, you can edit Kotlin code, and view the result in your browser.</p>
...
<div class="compiler-wrapper">
  ...
  <div class="compiler-body">
    ...
    <div class="editor">
<pre>
<span class="kt-keyword">fun</span> <span class="kt-function">main</span><span class="kt-brace">()</span> <span class="kt-brace">{</span>
  <span class="kt-function">println</span><span class="kt-brace">(</span><span class="kt-string">"Hello World"</span><span class="kt-brace">)</span>
<span class="kt-brace">}</span>
</pre>
    </div>

    <div class="output">Hello World
    </div>

  </div>

  <div class="compiler-footer">
    <a href="trykotlin.php?filename=demo_helloworld"
       target="_blank"
       class="ws-btn">
...
<div class="ws-note w3-panel">
  <p>If you don't know Kotlin, we suggest that you read our <a href="index.php">Kotlin Tutorial</a> from scratch.</p>
</div>
