...
<html lang="en-US">
<head>
<title>Kotlin Inheritance</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>Kotlin <span class="color_h1">Inheritance</span></h1>

<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="kotlin_class_functions.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="kotlin_exam.php">Next &#10095;</a>
</div>
<hr>

<h2>Kotlin Inheritance (Subclass and Superclass)</h2>
<p>In Kotlin, it is possible to inherit class properties and functions from one class to another. We group the "inheritance concept" into two categories:</p>
...
<p>In the example below, <code class="w3-codespan">MyChildClass</code> (subclass) inherits the 
properties from the <code class="w3-codespan">
MyParentClass</code> class 
(superclass):</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-kotlin notranslate w3-white"><code>// Superclass<br>open class MyParentClass {
  val x = 5
}
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_inheritance">Try it Yourself &raquo;</a>
</div>

<h2>Example Explained</h2>

<p>Use the <code class="w3-codespan">open</code> keyword in front of the <strong>superclass</strong>/parent, 
to make this the class other classes should inherit properties and functions from.</p>
<p>To inherit from a class, specify the name of the <strong>subclass</strong>, followed by a colon <code class="w3-codespan">:</code>, 
and then the name of the <strong>superclass</strong>.</p>

<div class="ws-note w3-panel">
<h4>Why And When To Use "Inheritance"?</h4>
<p>- It is useful for code reusability: reuse properties and functions of an existing class when you create a new class.</p>
</div>
