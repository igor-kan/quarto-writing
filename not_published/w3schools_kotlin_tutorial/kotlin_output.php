...
<html lang="en-US">
<head>
<title>Kotlin Output (Print Text)</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>Kotlin <span class="color_h1">Output (Print Text)</span></h1>

<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="kotlin_syntax.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="kotlin_comments.php">Next &#10095;</a>
</div>
<hr>

<h2>Kotlin Output (Print)</h2>

<p>The <code class="w3-codespan">println()</code> function is used to output values/print text:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_output">Try it Yourself &raquo;</a>
</div>

<p>You can add as many <code class="w3-codespan">println()</code> functions as you want. Note that it will add a new line for each function:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_output2">Try it Yourself &raquo;</a>
</div>

<p>You can also print numbers, and perform mathematical calculations:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_output3">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>The print() function</h2>
<p>There is also a <code class="w3-codespan">print()</code> function, which is similar to <code class="w3-codespan">println()</code>. The only difference is that it does not insert a new line at the end of the output:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trykotlin.php?filename=demo_output_print">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
<p>Note that we have added a space character to create a space between the sentences.</p>
</div>
