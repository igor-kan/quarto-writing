...
<a class="w3-left w3-btn" href="ai_learning.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ai_data.asp">Next &#10095;</a>
</div>



<div class="ws-info w3-large">
<ul>
<li>Relationships</li>
<li>Labels</li>
<li>Features</li>
...
<h2>Machine Learning Relationships</h2>
<p>Machine learning systems uses <b>Relationships</b> between <b>Inputs</b> to produce <b>Predictions</b>.</p>
<p>In algebra, a relationship is often written as <b>y = ax + b</b>:</p>
<ul>
<li><b>y</b> is the label we want to predict</li>
<li><b>a</b> is the slope of the line</li>
<li><b>x</b> are the input values</li>
<li><b>b</b> is the intercept</li>
</ul>

<p>With ML, a relationship is written as <b>y = b + wx</b>:</p>
<ul>
<li><b>y</b> is the label we want to predict</li>
<li><b>w</b> is the weight (the slope)</li>
<li><b>x</b> are the features (input values)</li>
<li><b>b</b> is the intercept</li>
</ul>


<hr>
<h2>Machine Learning Labels</h2>
<p>In Machine Learning terminology, the <b>label</b> is the thing we want to <b>predict</b>.</p>
<p>It is like the <b>y</b> in a linear graph:</p>
<table class="ws-table-all w3-large">
<tr>
<td>Algebra</td>
...
<p>In Machine Learning terminology, the <b>features</b> are the <b>input</b>.</p>
<p>They are like the <b>x</b> values in a linear graph:</p>
<table class="ws-table-all w3-large">
<tr>
<td>Algebra</td>
<td>Machine Learning</td>
...
<p>Sometimes there can be many features (input values) with different weights:</p>
<p class="w3-large">y = b + w<sub>1</sub><b>x<sub>1</sub></b> + w<sub>2</sub><b>x<sub>2</sub></b>
+ w<sub>3</sub><b>x<sub>3</sub></b> + w<sub>4</sub><b>x<sub>4</sub></b></p>
...
<li>Machine Learning Phases</li>
</ul>
</div>
<hr>

<h2>Machine Learning Models</h2>
<p>A <b>Model</b> defines the relationship between the label (y) and the 
features (x).
<p>There are three phases in the life of a model:</p>
<ul>
...
<p>The goal of training is to create a model that can answer a question. Like 
what is the expected price for a house?</p>

<hr>
<h2>Machine Learning Inference</h2>
<p>Inference is when the trained model is used to infer (predict) values using 
live data. Like putting the model into production.</p>

<hr>
<h2>Machine Learning Phases</h2>
<p>Machine learning has two main phases:</p>
<p>1. <b>Training</b>:<br>Input data are used to calculate the parameters of the model.</p>
<p>2. <b>Inference</b>:<br>The &quot;trained&quot; model outputs correct data from any input.</p>
<hr>
...
<li>Self-Supervised Machine Learning</li>
</ul>
</div>

<hr>
<h2>Supervised Learning</h2>
<p>Supervised Machine Learning uses a set of input variables to predict the value of an output variable.</p>
<p>Supervised learning uses <b>labeled data</b> (data with known answers) to train
algorithms to:</p>
<ul>
<li>Classify Data</li>
<li>Predict Outcomes</li>
</ul> 
<p>Supervised learning can <b>classify</b> data like "What is spam in an e-mail",
based on known spam examples.</p>
<p>Supervised learning can <b>predict</b> outcomes like predicting what kind of video you like,
based on the videos you have played.</p>

<hr>
<h2>Unsupervised Learning</h2>
<p>Unsupervised Machine Learning uses patterns from any unlabeled dataset,
trying to understand patterns (or groupings) in the data.</p>
<p>Unsupervised learning is used to predict undefined relationships like 
meaningful patterns in data.</p>
<p>It is about creating computer algorithms than can improve themselves.</p>
<p>It is expected that machine learning will shift to unsupervised learning 
to allow programmers to solve problems without creating models.</p>
<hr>
<h2>Reinforcement Learning</h2>
<p>Reinforcement learning is based on non-supervised learning but receives feedback from the user
whether the decision is good or bad. The feedback contributes to improving the model.</p>
<hr>
<h2>Self-Supervised Learning</h2>
<p>Self-supervised learning is similar to unsupervised learning
because it works with data without human added labels.</p>
<p>The difference is that unsupervised learning uses clustering, grouping, and dimensionality reduction,
while self-supervised learning draw its own conclusions for regression and classification tasks.</p>
