...
<a class="w3-left w3-btn" href="ai_matrices.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ai_statistics.asp">Next &#10095;</a>
</div>

<div class="w3-panel ws-info">
<p>A Tensor is a <b>N-dimensional Matrix</b>:</p>
<ul>
<li>A Scalar is a 0-dimensional tensor</li>
<li>A Vector is a 1-dimensional tensor</li>
<li>A Matrix is a 2-dimensional tensor</li>
</ul>
<p>A <b>Tensor</b> is a generalization of <b>Vectors</b> and <b>Matrices</b> to higher dimensions.</p>
</div>
...
<hr>
<h2>Tensor Ranks</h2>
<p>The number of directions a tensor can have in a <b>N</b>-dimensional space, is called the <b>Rank</b> of the tensor.</p>
<p>The rank is denoted <b>R</b>.</p>
<p>A <b>Scalar</b> is a single number.</p>
<ul>
<li>It has 0 Axes</li>
<li>It has a <b>Rank of 0</b></li>
<li>It is a 0-dimensional Tensor</li>
</ul>

<p>A <b>Vector</b> is an array of numbers.</p>
<ul>
<li>It has 1 Axis</li>
<li>It has a <b>Rank of 1</b></li>
<li>It is a 1-dimensional Tensor</li>
</ul>

<p>A <b>Matrix</b> is a 2-dimensional array.</p>
<ul>
<li>It has 2 Axis</li>
<li>It has a <b>Rank of 2</b></li>
<li>It is a 2-dimensional Tensor</li>
</ul>

<hr>
<h2>Real Tensors</h2>
<p>Technically, all of the above are tensors, but when we speak of tensors, we generally 
speak of matrices with a dimension larger than 2 (<b>R &gt; 2</b>).</p>
<img alt="Tensor" src="img_tensor.jpg">
...
<p>Tensors are <b>N-dimensional Arrays</b>:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
...
<hr>
<h2>JavaScript Tensor Operations</h2>
<p>Programming tensor operations in JavaScript, can easily become a spaghetti of loops.</p>
<p>Using a JavaScript library will save you a lot of headache.</p>
<p>One of the most common libraries to use for tensor operations is called <b>tensorflow.js</b>.</p> 

<div class="w3-example">
<h3>Tensor Addition</h3>
<div class="w3-code notranslate jsHigh">
const tensorA = tf.tensor([[1, 2], [3, 4], [5, 6]]);<br>
const tensorB = tf.tensor([[1,-1], [2,-2], [3,-3]]);<br>
<br> 
// Tensor Addition<br>
const tensorAdd = tensorA.add(tensorB);<br>
<br>
// Result [ [2, 1], [5, 2], [8, 3] ]<br>
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_tensor_add">Try it Yourself &raquo;</a></p>
</div>

<div class="w3-example">
<h3>Tensor Subtraction</h3>
<div class="w3-code notranslate jsHigh">
const tensorA = tf.tensor([[1, 2], [3, 4], [5, 6]]);<br>
const tensorB = tf.tensor([[1,-1], [2,-2], [3,-3]]);<br>
<br> 
// Tensor Subtraction<br>
const tensorSub = tensorA.sub(tensorB);<br>
<br>
// Result [ [0, 3], [1, 6], [2, 9] ]<br>
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_tensor_sub">Try it Yourself &raquo;</a></p>
</div>
<p><a href="ai_tensorflow_intro.asp">Learn more about Tensorflow ...</a></p>
