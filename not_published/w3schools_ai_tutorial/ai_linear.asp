...
<a class="w3-left w3-btn" href="ai_mathematics.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ai_algebra.asp">Next &#10095;</a>
</div>
...
<p>A <b>Function </b> is special relationship where each input has an output.</p>
<p>A function is often written as <b>f(x)</b> where x is the input:</p>
...
<p>Results from f(x) = x</p> 
<table class="ws-table-all">
<tr><th>x</th><th>y</th><th>y = x</th></tr>
<tr><td>1</td><td>1</td><td>y = x = 1</td></tr>
<tr><td>2</td><td>2</td><td>y = x = 2</td></tr>
<tr><td>3</td><td>3</td><td>y = x = 3</td></tr>
<tr><td>4</td><td>4</td><td>y = x = 4</td></tr>
<tr><td>5</td><td>5</td><td>y = x = 5</td></tr>
</table>
...
// Display using Plotly
var data = [{x:xValues, y:yValues, type:"lines"}];
var layout = {title: "f(x) = 2x"};
Plotly.newPlot("myPlot2", data, layout);
</script>
<p>Results from f(x) = 2x</p> 
<table class="ws-table-all">
<tr><th>x</th><th>y</th><th>y = 2x</th></tr>
<tr><td>1</td><td>2</td><td>y = 2x = 2</td></tr>
<tr><td>2</td><td>4</td><td>y = 2x = 4</td></tr>
<tr><td>3</td><td>6</td><td>y = 2x = 6</td></tr>
<tr><td>4</td><td>8</td><td>y = 2x = 8</td></tr>
<tr><td>5</td><td>10</td><td>y = 2x = 10</td></tr>
</table>
<hr>
...
<p>A Linear Equation is an equation for a straight line:</p>
<ul>
<li>y = x</li>
<li>y = x*2</li>
<li>y = x*2 + 7</li>
...
for (var x = 0; x <= 10; x += 1) {
  ...
  x2Values.push(x);
  x3Values.push(x);
  y1Values.push(eval(exp3));
  y2Values.push(eval(exp2));
  y3Values.push(eval(exp1));
}
// Define Data
var data = [
...
var layout = {title: "[y=" + exp3 + "]  [y=" + exp2 + "]  [y=" + exp1 + "]"};
// Display using Plotly
Plotly.newPlot("myPlot4", data, layout);
</script>
<hr>
<h2>Non-Linear Equations</h2>
<p>A Linear Equation can NOT contain exponents or square roots:</p>
<ul>
<li>y = x**2</li>
<li>y = Math.sqrt(x)</li>
<li>y = Math.sin(x)</li>
...
<p>A Linear regression tries to model the relationship between two variables by fitting a linear graph to data.</p>
<p>One variable (x) is considered to be data, and the other (y) is considered to be dependent.</p>
<p>For example, a Linear Regression can be a model to relate the price of houses to their size.</p>
<hr>
<h2>Linear Least Squares</h2>
<p>Linear algebra is used to solve Linear Equations.</p>
<p>Linear Least Squares (LLS) is a set of formulations for solving statistical problems
involved in Linear Regression.</p>
