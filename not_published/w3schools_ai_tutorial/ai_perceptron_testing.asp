...
<html lang="en-US">
<head>
<title>Testing a Perceptron</title>
<meta charset="utf-8">
...
<h1>Testing a Perceptron</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="ai_training.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ai_learning.asp">Next &#10095;</a>
</div>

<div class="w3-panel ws-info">
<p>A Perceptron must be <b>Tested</b> and <b>Evaluated</b>.</p>
<p>A Perceptron must be tested against <b>Real Values</b>.</p>
</div>

<h2>Test Your Library</h2>
<p>Generate new unknown points and check if your Perceptron can guess the right answers:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Test Against Unknown Data<br>
const counter = 500;<br>
for (let i = 0; i &lt; counter; i++) {<br>
&nbsp;&nbsp;let x = Math.random() * xMax;<br>
&nbsp;&nbsp;let y = Math.random() * yMax;<br>
...
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_perceptron_8">Try it Yourself &raquo;</a></p>
</div>
<hr>
<h2>Count the Errors</h2>
<p>Add a counter to count the number of errors:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Test Against Unknown Data<br>
...
&nbsp;&nbsp;if (guess == 0) color = "blue";<br>
&nbsp;&nbsp;plotter.plotPoint(x, y, color);<br>
&nbsp;&nbsp;if ((y &gt; f(x) &amp;&amp; guess == 0) || (y &lt; f(x) &amp;&amp; guess == 1)) {errors++}<br>
}<br>
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_perceptron_9">Try it Yourself &raquo;</a></p>
</div>

<hr>
<h2>Tune the Perceptron</h2>
<p>How can you tune the Perceptron?</p>
<p>Here are some suggestions:</p>
<ul>
<li>Adjust the learning rate</li>
<li>Increase the number of training data</li>
<li>Increase the number of training iterations</li>
</ul>
