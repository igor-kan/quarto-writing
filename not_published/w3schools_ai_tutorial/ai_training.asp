...
<html lang="en-US">
<head>
<title>Training a Perceptron</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="ai_recognition.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ai_perceptron_testing.asp">Next &#10095;</a>
</div>

<div class="w3-panel ws-info">
<ul>
<li>Create a <b>Perceptron Object</b></li>
<li>Create a <b>Training Function</b></li>
<li><b>Train</b> the perceptron against correct answers</li>
</ul>
</div>

<h2>Training Task</h2>
<p>Imagine a straight line in a space with scattered x y points.</p>
<p>Train a perceptron to classify the points over and under the line.</p>
<canvas id="myCanvas1" width="800px" height="800px" style="width:100%;max-width:500px;border:1px solid black"></canvas>
<div><p id="demo1"></p></div>
<div id="myButton1"><button  class="w3-btn" onclick="myFunction()">Click to Train Me</button></div>

<hr>
<h2>Create a Perceptron Object</h2>
<p>Create a Perceptron object. Name it anything (like Perceptron).</p> 
<p>Let the perceptron accept two parameters:
<ol>
<li>The number of inputs (no)</li>
<li>The learning rate (learningRate).</li>
</ol>
<p>Set the default learning rate to 0.00001.</p>
<p>Then create random weights between -1 and 1 for each input.</p> 
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Perceptron Object<br>
function Perceptron(no, learningRate = 0.00001) {<br>
<br>
// Set Initial Values<br>
this.learnc = learningRate;<br>
this.bias = 1;<br>
<br>
// Compute Random Weights<br>
this.weights = [];<br>
for (let i = 0; i &lt;= no; i++) {<br>
&nbsp;&nbsp;this.weights[i] = Math.random() * 2 - 1;<br>
}<br>
<br>
// End Perceptron Object<br>
}
</div>
</div>

<div class="ws-note">
<h2>The Random Weights</h2>
<p>The Perceptron will start with a <b>random weight</b> for each input.</p>  
</div>

<div class="ws-note">
<h2>The Learning Rate</h2>
<p>For each mistake, while training the Perceptron, the weights will be adjusted with a small fraction.</p>
<p>This small fraction is the "<b>Perceptron's learning rate</b>".</p>
<p>In the Perceptron object we call it <b>learnc</b>.</p>
</div>

<div class="ws-note">
<h2>The Bias</h2>
<p>Sometimes, if both inputs are zero, the perceptron might produce an incorrect output.</p>
<p>To avoid this, we give the perceptron an extra input with the value of 1.</p>
<p>This is called a <b>bias</b>.</p>  
</div>
<hr>
...
<h2>Add an Activate Function</h2>
<p>Remember the perceptron algorithm:</p>
<ul>
<li>Multiply each input with the perceptron's weights</li>
<li>Sum the results</li>
<li>Compute the outcome</li>
</ul>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
this.activate = function(inputs) {<br>
&nbsp;&nbsp;let sum = 0;<br>
&nbsp;&nbsp;for (let i = 0; i &lt; inputs.length; i++) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;sum += inputs[i] * this.weights[i];<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;if (sum &gt; 0) {return 1} else {return 0}<br>
}
</div>
</div>
<p>The activation function will output:</p>
<ul>
<li>1 if the sum is greater than 0</li>
<li>0 if the sum is less than 0</li>
</ul>
<hr>
<h2>Create a Training Function</h2>
<p>The training function guesses the outcome based on the activate function.</p>
<p>Every time the guess is wrong, the perceptron should adjust the weights.</p> 
<p>After many guesses and adjustments, the weights will be correct.</p> 
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
this.train = function(inputs, desired) {<br>
&nbsp;&nbsp;inputs.push(this.bias);<br>
&nbsp;&nbsp;let guess = this.activate(inputs);<br>
&nbsp;&nbsp;let error = desired - guess;<br>
&nbsp;&nbsp;if (error != 0) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;for (let i = 0; i &lt; inputs.length; i++) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;this.weights[i] += this.learnc * error * inputs[i];<br>         
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>
}
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_perceptron_6">Try it Yourself &raquo;</a></p>
</div>
<hr>
<h2>Backpropagation</h2>
<p>After each guess, the perceptron calculates how wrong the guess was.</p>
<p>If the guess is wrong, the perceptron adjusts the bias and the weights
so that the guess will be a little bit more correct the next time.</p>
<p>This type of learning is called <b>backpropagation</b>.
<p>After trying (a few thousand times) your perceptron will become quite good at guessing.</p>
...
<p>Now you can include the library in HTML:</p>
...
<hr>
<h2>Use Your Library</h2>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Initiate Values<br>
const numPoints = 500;<br>
const learningRate = 0.00001;<br>
<br>
// Create a Plotter<br>
const plotter = new XYPlotter("myCanvas");<br>
plotter.transformXY();<br>
const xMax = plotter.xMax;<br>
const yMax = plotter.yMax;<br>
const xMin = plotter.xMin;<br>
const yMin = plotter.yMin;<br>
<br>
// Create Random XY Points<br>
const xPoints = [];<br>
const yPoints = [];<br>
for (let i = 0; i &lt; numPoints; i++) {<br>
&nbsp;&nbsp;xPoints[i] = Math.random() * xMax;<br>
&nbsp;&nbsp;yPoints[i] = Math.random() * yMax;<br>
}<br>
<br>
// Line Function<br>
function f(x) {<br>
...
<br>
//Plot the Line<br>
plotter.plotLine(xMin, f(xMin), xMax, f(xMax), "black");<br>
<br>
// Compute Desired Answers<br>
const desired = [];<br>
for (let i = 0; i &lt; numPoints; i++) {<br>
&nbsp;&nbsp;desired[i] = 0;<br>
&nbsp;&nbsp;if (yPoints[i] &gt; f(xPoints[i])) {desired[i] = 1}<br>
}<br>
<br>
// Create a Perceptron<br>
const ptron = new Perceptron(2, learningRate);<br>
<br>
// Train the Perceptron<br>
for (let j = 0; j &lt;= 10000; j++) {<br>
&nbsp;&nbsp;for (let i = 0; i &lt; numPoints; i++) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;ptron.train([xPoints[i], yPoints[i]], desired[i]);<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
// Display the Result<br>
for (let i = 0; i &lt; numPoints; i++) {<br>
&nbsp;&nbsp;const x = xPoints[i];<br>
&nbsp;&nbsp;const y = yPoints[i];<br>
&nbsp;&nbsp;let guess = ptron.activate([x, y, ptron.bias]);<br>
&nbsp;&nbsp;let color = "black";<br>
&nbsp;&nbsp;if (guess == 0) color = "blue";<br>
&nbsp;&nbsp;plotter.plotPoint(x, y, color);<br>
}
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_perceptron_7">Try it Yourself &raquo;</a></p>
</div>
...
// Create a Plotter
let plotter = new XYPlotter("myCanvas1");
plotter.transformXY();
let xMax = plotter.xMax;
let yMax = plotter.yMax;
let xMin = plotter.xMin;
let yMin = plotter.yMin;
...
let myTimer1 = setInterval(function(){
  let x = xPoints[count];
  let y = yPoints[count];
  let error = ptron.train([x,y], desired[count]);;
  let color = "black";
  if (desired[count] == 0) color = "red";
  plotter.plotPoint(x, y, color);
  if (count == numPoints-1) {
    clearInterval(myTimer1);
  }
  count++;
  document.getElementById(id).innerHTML = "Training Points: " + count;  
  },10,obj);
}
