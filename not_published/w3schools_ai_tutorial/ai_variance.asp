...
<html lang="en-US">
<head>
<title>Statistic Variability</title>
<meta charset="utf-8">
...
<h1>Statistic Variability (Spread)</h1>

<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="ai_statistics_descriptive.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ai_distribution.asp">Next &#10095;</a>
</div>

<div class="w3-panel ws-info">
<p><b>Descriptive Statistics</b> is broken down into <b>Tendency</b> and <b>Variability</b>.</p>
<p><b>Variability</b> uses these measures:</p>
<ul>
<li>Min and Max</li>
<li>Variance</li>
<li>Deviation</li>
...
<h2>The Variance</h2>
<p>In statistics, the <b>Variance</b> is the average of the squared differences from the <b>Mean Value</b>.</p>
<p>In other words, the variance describes how far a set of numbers is <b>Spread Out</b> from the mean (average) value.</p>
<p>Mean value is described in the previous chapter.</p>
...
// Calculate the Mean (m)<br>
let m = (7+8+8+9+9+9+10+11+14+14+15)/11;<br>
<br>
// Calculate the Sum of Squares (ss)<br>
let ss = (7-m)**2 + (8-m)**2 + (8-m)**2 + (9-m)**2 + (9-m)**2 + (9-m)**2 + (9-m)**2 + (10-m)**2 + (11-m)**2 + (14-m)**2 + (15-m)**2;<br>
<br>
// Calculate the Variance<br>
let variance = ss / 11;
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_variance">Try it Yourself &raquo;</a></p>
</div>
<div class="w3-example">
...
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_math_variance">Try it Yourself &raquo;</a></p>
</div>
...
<p><b>Standard Deviation</b> is a measure of how spread out numbers are.</p>
<p>The symbol is <b>σ</b> (Greek letter sigma).</p>
<p>The formula is the <b>&#8730;</b> variance (the square root of the variance).</p>
<div class="w3-example">
<p>The Standard Deviation is (in JavaScript):</p>
<div class="w3-code notranslate jsHigh">
// Calculate the Mean (m)<br>
let m = (7+8+8+9+9+9+10+11+14+15)/11;<br>
<br>
// Calculate the Sum of Squares (ss)<br>
let ss = (7-m)**2 + (8-m)**2 + (8-m)**2 + (9-m)**2 + (9-m)**2 + (9-m)**2 + (9-m)**2 + (10-m)**2 + (11-m)**2 + (14-m)**2 + (15-m)**2;<br>
<br>
// Calculate the Variance<br>
let variance = ss / 11;<br>
<br>
// Calculate the Standard Deviation<br>
let std = Math.sqrt(variance);
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_standard_deviation">Try it Yourself &raquo;</a></p>
</div>
<div class="ws-note">
<p><b>Deviation</b> is a measure of <b>Distance</b>.</p>
<p><b>How far</b> (on average), all values are from <b>the Mean</b> (the Middle).</p>
</div>

<div class="w3-example">
<p>Or if you use a math library like <b>math.js</b>:</p>
<div class="w3-code notranslate jsHigh">
const values = [7,8,8,9,9,9,9,10,11,14,15];<br>
let std = math.std(values, "uncorrected");
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_math_standard_deviation">Try it Yourself &raquo;</a></p>
</div>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="ai_statistics_descriptive.asp">&#10094; Previous</a>
