...
<h1>TensorFlow.js Visor</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="ai_tensorflow_model.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ai_tensorflow_example_2d.asp">Next &#10095;</a>
</div>

<div class="w3-panel ws-info">
<ul>
<li><b>TensorFlow Visor</b> is a graphic tools for visualizing <b>Machine Learning</b></li>
<li>It contains functions for visualizing <b>TensorFlow Models</b></li>
<li>Visualizations can be organized in <b>Visors</b> (modal browser windows)</li>
<li>Can be used with <b>Custom Tools</b> likes d3, Chart.js, and Plotly.js</li>
<li>Often called <b>tfjs-vis</b></li>
</ul>
</div>

<h2>Using tfjs-vis</h2>
<p>To use tfjs-vis, add the following script tag to your HTML file(s):</p>
...
const surface = document.getElementById('demo');<br>
const series = ['First', 'Second'];<br>
<br>
const serie1 = [];<br>
const serie2 = [];<br>
for (let i = 0; i &lt; 100; i++) {<br>
&nbsp;&nbsp;serie1[i] = {x:i, y:Math.random() * 100};<br>
&nbsp;&nbsp;serie2[i] = {x:i, y:Math.random() * 100};<br>
}<br>
<br>
const data = {values: [serie1, serie2], series}<br>
<br>
tfvis.render.scatterplot(surface, data);
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_tensorflow_tfjs_scatter">Try it Yourself &raquo;</a></p>
</div>
<p>Visualizations can be organized in a Visor (a modal browser window):</p>
<div class="w3-example">
<h3>Example with a Visor</h3>
<div class="w3-code notranslate jsHigh">
const series = ['First', 'Second'];<br>
<br>
const serie1 = [];<br>
...
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_tensorflow_visor_scatter">Try it Yourself &raquo;</a></p>
</div>
...
const surface = document.getElementById('demo');<br>
const data = [<br>
&nbsp;&nbsp;{index: 0, value: 100},<br>
&nbsp;&nbsp;{index: 1, value: 200},<br>
&nbsp;&nbsp;{index: 2, value: 150},<br>
&nbsp;&nbsp;{index: 2, value: 250},<br>
];<br>
<br>
tfvis.render.barchart(surface, data);
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_tensorflow_tfjs_bars">Try it Yourself &raquo;</a></p>
</div>
...
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_tensorflow_visor_bars">Try it Yourself &raquo;</a></p>
</div>
...
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_tensorflow_tfjs_lines">Try it Yourself &raquo;</a></p>
</div>
...
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_tensorflow_visor_lines">Try it Yourself &raquo;</a></p>
</div>
