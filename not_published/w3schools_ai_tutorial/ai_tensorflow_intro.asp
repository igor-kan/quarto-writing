...
<h1>TensorFlow.js Tutorial</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="ai_brainjs.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ai_tensorflow_operations.asp">Next &#10095;</a>
</div>
<hr>
<img alt="TensorFlow" style="width:300px" src="img_tensorflow.jpg">

<div class="w3-panel ws-info">
<h2>What is TensorFlow.js?</h2>

<p>Tensorflow is popular <b>JavaScript</b> library for <b>Machine Learning</b>.</p>
<p>Tensorflow lets us train and deploy machine learning in the <b>Browser</b>.</p>
<p>Tensorflow lets us add machine learning functions to any <b>Web Application</b>.</p>
</div>

<h2>Using TensorFlow</h2>
<p>To use TensorFlow.js, add the following script tag to your HTML file(s):</p>
...
<p>If you always want to use the latest version, drop the version number:</p>
<div class="w3-example">
<h3>Example 2</h3>
<div class="w3-code notranslate htmlHigh">
...
<p>TensorFlow was developed by the <b>Google Brain Team</b> for internal Google use,
but was released as open software in 2015.</p>
<p>In January 2019, Google developers released TensorFlow.js, the <b>JavaScript Implementation</b> of TensorFlow.</p>
<p>Tensorflow.js was designed to provide the same features as the original TensorFlow library written in Python.</p>

</div>

<hr>
<h2>Tensors</h2>
<p><b>TensorFlow.js</b> is a <b>JavaScript</b> library 
to define and operate on <b>Tensors</b>.</p>
<p>The main data type in TensorFlow.js is the <b>Tensor</b>.</p>
<p>A <b>Tensor</b> is much the same as a multidimensional array.</p>
<p>A <b>Tensor</b> contains values in one or more dimensions:</p>
<img alt="Tensor" style="width:336px" src="img_tensor_cube.jpg">
<p>A <b>Tensor</b> has the following main properties:</p>

<table class="ws-table-all">
<tr><th>Property</th><th>Description</th></tr>
<tr><td>dtype</td><td>The data type</td></tr>

<tr><td>rank</td><td>The number of dimensions</td></tr>
<tr><td>shape</td><td>The size of each dimension</td></tr>
</table>

<div class="ws-note">
<p>Sometimes in machine learning, the term "<b>dimension</b>" is used interchangeably with "<b>rank</b>.
<p>[10, 5] is a 2-dimensional tensor or a 2-rank tensor.</p> 
<p>In addition the term "dimensionality" can refer to the size of a one dimension.</p>
<p>Example: In the 2-dimensional tensor [10, 5], the dimensionality of the first dimension is 10.</p>
</div>
<hr>
...
<hr>
<h2>Creating a Tensor</h2>
<p>The main data type in TensorFlow is the <b>Tensor</b>.</p>
<p>A Tensor is created from any N-dimensional array with the <span class="w3-codespan">tf.tensor()</span> method:
<div class="w3-example">

<h3>Example 1</h3>
<div class="w3-code notranslate jsHigh">
const myArr = [[1, 2, 3, 4]];<br>
const tensorA = tf.tensor(myArr);
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_tensor_create">Try it Yourself &raquo;</a></p>
...
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_tensor_create1">Try it Yourself &raquo;</a></p>
...
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_tensor_create2">Try it Yourself &raquo;</a></p>

</div>

<hr>
<h2>Tensor Shape</h2>
<p>A Tensor can also be created from an <b>array</b> and a <b>shape</b> parameter:
<div class="w3-example">
<h3>Example1</h3>
<div class="w3-code notranslate jsHigh">
const myArr = [1, 2, 3, 4]:<br>
...
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_tensor_create_shape1">Try it Yourself &raquo;</a></p>
<h3>Example2</h3>
<div class="w3-code notranslate jsHigh">
const tensorA = tf.tensor([1, 2, 3, 4], [2, 2]);
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_tensor_create_shape2">Try it Yourself &raquo;</a></p>
<h3>Example3</h3>
<div class="w3-code notranslate jsHigh">
const myArr = [[1, 2], [3, 4]];<br>
const shape = [2, 2];<br>
...
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_tensor_create_shape3">Try it Yourself &raquo;</a></p>
</div>

<hr>
<h2>Retrieve Tensor Values</h2>
<p>You can get the <b>data</b> behind a tensor using <span class="w3-codespan">tensor.data()</span>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const myArr = [[1, 2], [3, 4]];<br>
const shape = [2, 2];<br>
const tensorA = tf.tensor(myArr, shape);<br>
tensorA.data().then(data =&gt; display(data));<br>
<br>
function display(data) {<br>
&nbsp;&nbsp;document.getElementById("demo").innerHTML = data;<br>
}
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_tensor_get_data">Try it Yourself &raquo;</a></p>
</div>
<p>You can get the <b>array</b> behind a tensor using <span class="w3-codespan">tensor.array()</span>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const myArr = [[1, 2], [3, 4]];<br>
const shape = [2, 2];<br>
const tensorA = tf.tensor(myArr, shape);<br>
tensorA.array().then(array =&gt; display(array[0]));<br>
<br>
function display(data) {<br>
&nbsp;&nbsp;document.getElementById("demo").innerHTML = data;<br>
}
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_tensor_get_array">Try it Yourself &raquo;</a></p>
<div class="w3-code notranslate jsHigh">
const myArr = [[1, 2], [3, 4]];<br>
const shape = [2, 2];<br>
const tensorA = tf.tensor(myArr, shape);<br>
tensorA.array().then(array =&gt; display(array[1]));<br>
<br>
function display(data) {<br>
&nbsp;&nbsp;document.getElementById("demo").innerHTML = data;<br>
}
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_tensor_get_array2">Try it Yourself &raquo;</a></p>

</div>

<p>You can get the <b>rank</b> of a tensor using <span class="w3-codespan">tensor.rank</span>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const myArr = [1, 2, 3, 4];<br>
...
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_tensor_get_rank">Try it Yourself &raquo;</a></p>
</div>

<p>You can get the <b>shape</b> of a tensor using <span class="w3-codespan">tensor.shape</span>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const myArr = [1, 2, 3, 4];<br>
...
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_tensor_get_shape">Try it Yourself &raquo;</a></p>
</div>

<p>You can get the <b>datatype</b> of a tensor using <span class="w3-codespan">tensor.dtype</span>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const myArr = [1, 2, 3, 4];<br>
...
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_tensor_get_dtype">Try it Yourself &raquo;</a></p>
</div>
<hr>
<h2>Tensor Data Types</h2>
<p>A Tensor can have the following data types:
<ul>
<li>bool</li>
<li>int32</li>
<li>float32 (default)</li>
<li>complex64</li>
<li>string</li>
</ul>
<p>When you create a tensor, you can specify the data type as the third parameter:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const myArr = [1, 2, 3, 4];<br>
...
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_tensor_create_dtype">Try it Yourself &raquo;</a></p>
</div>
