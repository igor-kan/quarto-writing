...
<a class="w3-left w3-btn" href="ai_linear_graphs.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ai_perceptrons.asp">Next &#10095;</a>
</div>
...
<p>Collecting data is the most important part of any Machine Intelligence 
projects.</p>
...
<hr>
<h2>Scatter Plots</h2>
<p>A <b>Scatter Plot</b> has points scattered over an area representing the 
relationship between two values.</p> 
...
<h2>Graphs</h2>
<p>A <b>Graph</b> can also be used to show the same values:</p>
<table class="ws-table-all">
<tr><td>Price</td><td>7</td><td>8</td><td>8</td><td>9</td><td>9</td><td>9</td><td>10</td><td>11</td><td>14</td><td>14</td><td>15</td></tr>
<tr><td>Size</td><td>50</td><td>60</td><td>70</td><td>80</td><td>90</td><td>100</td><td>
  110</td><td>120</td><td>130</td><td>140</td><td>150</td></tr>
...
<hr>
<h2>When to Use Scatter Plots</h2>
<p>Scatter plots are great for:
<ul>
<li>Seeing the "Big Picture"</li>
<li>Compare different values</li>
<li>Discovering potential trends</li>
<li>Discovering patterns in data</li>
<li>Discovering relationships between data</li>
<li>Discovering <b>Clusters</b> and <b>Correlations</b></li>
</ul>
...
plotXYArrays("myPlot21","scatter",xArray,yArray,layout);
plotXYArrays("myPlot22","lines",xArray,yArray, layout);

function plotXYArrays(id, type, xArray, yArray, layout) {
  let mode = "lines";
  let graph = "scatter";
  if (type == "scatter") {mode = "markers"};
  if (type == "bars") {graph = "bar"};
  Plotly.newPlot(id, [{x:xArray, y:yArray, mode:mode, type:graph}], layout);
}
</script>
