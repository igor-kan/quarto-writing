...
<h1>TensorFlow Models</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="ai_tensorflow_operations.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ai_tensorflow_visor.asp">Next &#10095;</a>
</div>
<br>
<div class="w3-center w3-border">
<h2>TesorFlow.js</h2>
<p class="w3-large">A JavaScript Library for</p>
<h3>Training and Deploying<br><b>Machine Learning Models</b><br>In the Browser</h3>
</div>
<img style="width:100%" src="img_tensorflow_model.jpg">
<hr>

<h2>Tensorflow Models</h2>
<p><b>Models</b> and <b>Layers</b> are important building blocks in <b>Machine Learning</b>.</p>
<p>For different Machine Learning tasks you must combine different types of Layers
into a Model that can be trained with data to predict future values.</p>

<p>TensorFlow.js is supporting different types of <b>Models</b> and different types of <b>Layers.</b></p>
<p>A TensorFlow <b>Model</b> is a <b>Neural Network</b> with one or more <b>Layers</b>.</p>
<hr>
<h2>A Tensorflow Project</h2>
<p>A Tensorflow project has this typical workflow:</p>
<ul>
<li>Collecting Data</li>
<li>Creating a Model</li>
<li>Adding Layers to the Model</li>
...
<hr>
<h2>Example</h2>
<p>Suppose you knew a function that defined a strait line:</p>
<p class="w3-large w3-serif"><i>Y = 1.2X + 5</i></p>
 
<p>Then you could calculate any y value with the JavaScript formula:</p>
...
<p>To demonstrate Tensorflow.js, we could train a Tensorflow.js model to
predict Y values based on X inputs.</p>

<div class="w3-container ws-note">
<h2>Note</h2>
<p>The TensorFlow model does not know the function.</p>
</div>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// Create Training Data<br>
const xs = tf.tensor([0, 1, 2, 3, 4]);<br>
const ys = xs.mul(1.2).add(5);<br>
<br>
// Define a Linear Regression Model<br>
const model = tf.sequential();<br>
model.add(tf.layers.dense({units:1, inputShape:[1]}));<br>
<br>
// Specify Loss and Optimizer<br>
model.compile({loss:'meanSquaredError', optimizer:'sgd'});<br>
<br>
// Train the Model<br>
model.fit(xs, ys, {epochs:500}).then(() =&gt; {myFunction()});<br>
<br>
// Use the Model<br>
...
&nbsp;&nbsp;const xArr = [];<br>
&nbsp;&nbsp;const yArr = [];<br>
&nbsp;&nbsp;for (let x = 0; x &lt;= xMax; x++) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;let result = model.predict(tf.tensor([Number(x)]));<br>
&nbsp;&nbsp;&nbsp;&nbsp;result.data().then(y =&gt; {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;xArr.push(x);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;yArr.push(Number(y));<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (x == xMax) {plot(xArr, yArr)};<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;}<br>
}
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_tensor_model_xy_plot">Try it Yourself &raquo;</a></p>
</div>
<h3>The example is explained below:</h3>
<hr>
...
<p>Create a tensor (xs) with 5 x values:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const xs = tf.tensor([0, 1, 2, 3, 4]);<br>
</div>
</div>
<p>Create a tensor (ys) with 5 correct y answers (multiply xs with 1.2 and add 5):</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const ys = xs.mul(1.2).add(5);<br>
</div>
...
<div class="ws-note">
<h2>Note</h2> 
<p>In a sequential model, the output from one layer is the input to the next layer.</p>
</div>
<hr>
<h2>Adding Layers</h2>
<p>Add one dense layer to the model.</p>
<p>The layer is only one unit (tensor) and the shape is 1 (one dimentional):</p>
...
<div class="ws-note"> 
<h2>Note</h2>
<p>in a dense the layer, every node is connected to every node in the preceding layer.</p>
</div>

<hr>
<h2>Compiling the Model</h2>
<p>Compile the model using meanSquaredError as loss function and
...
<hr>
<h2>Tensorflow Optimizers</h2>
<ul>
<li>Adadelta -Implements the Adadelta algorithm.</li>
<li>Adagrad - Implements the Adagrad algorithm.</li>
<li>Adam - Implements the Adam algorithm.</li>
<li>Adamax - Implements the Adamax algorithm.</li>
<li>Ftrl - Implements the FTRL algorithm.</li>
<li>Nadam - Implements the NAdam algorithm.</li>
<li>Optimizer - Base class for Keras optimizers.</li>
<li>RMSprop - Implements the RMSprop algorithm.</li>
<li>SGD - Stochastic Gradient Descent Optimizer.</li>
</ul>
<hr>
<h2>Training the Model</h2>
<p>Train the model (using xs and ys) with 500 repeats (epochs):</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
model.fit(xs, ys, {epochs:500}).then(() =&gt; {myFunction()});<br>
</div>
...
<p>After the model is trained, you can use it for many different purposes.</p>
<p>This example predicts 10 y values, given 10 x values, and calls a function to plot the predictions in a graph:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
function myFunction() {<br>
&nbsp;&nbsp;const xMax = 10;<br>
...
<p>This example predicts 10 y values, given 10 x values, and calls a function to display the values:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
function myFunction() {<br>
&nbsp;&nbsp;const xMax = 10;<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;xArr.push(x);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;yArr.push(Number(y));<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (x == xMax) {display(xArr, yArr)};<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;}<br>
}
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_tensor_model_xy_display">Try it Yourself &raquo;</a></p>
</div>
