...
<a class="w3-left w3-btn" href="ai_javascript.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ai_linear_graphs.asp">Next &#10095;</a>
</div>

<h2>Image Classification Example</h2>
<img id="myImage" src="pic1.jpg" style="width:100%;max-width:300px;cursor:pointer" >
<div id="myResult">Result here</div>
<p>
<button class="w3-button w3-block w3-red" onclick="classify()">Click to Classify 
Picture</button>
</p>
<p>
<button class="w3-button w3-block w3-green" onclick="changePicture()">Click to 
Change Picture</button>
</p>


<script>
// A variable to hold the classifier model
let classifier;

// Initialize the Image Classifier method with MobileNet using async/await
async function classify() {
  document.getElementById("myResult").innerHTML = "Scanning...";
  
  try {
    // 1. Load the model using modern version 1.0 syntax
    classifier = await ml5.imageClassifier("MobileNet");
    
    // 2. Select the image element
    let img = document.getElementById("myImage");
    
    // 3. Run classification and wait for the results
    let results = await classifier.classify(img);
    
    // 4. In Version 1.0, results are an object, not an array
    let label = results[0].label;
    let confidence = (results[0].confidence * 100).toFixed(2);
        
    document.getElementById("myResult").innerHTML = "Result: " + label + "<br>Confidence: " + confidence + "%";
  } catch (error) {
    console.error(error);
...
function changePicture() {
  let div = document.getElementById("myImage");
  let img = div.src;
  if (img.includes("pic1.jpg")) {div.src = "pic2.jpg"};
  if (img.includes("pic2.jpg")) {div.src = "pic3.jpg"};
  if (img.includes("pic3.jpg")) {div.src = "pic4.jpg"};
  if (img.includes("pic4.jpg")) {div.src = "pic5.jpg"};
  if (img.includes("pic5.jpg")) {div.src = "pic1.jpg"};
  document.getElementById("myResult").innerHTML = "";
}
</script>

<hr>
<h2>Artificial Music Intelligence</h2>
<p>Can an algorithm compose better music than a human?</p>
<p>David Cope is a former professor of music at the University of Santa Cruz 
(California).

<p>For over 30 years, David Cope has been developing Emmy or EMI (Experimental 
Musical Intelligence), an algorithm to compose music in the style of famous 
composers.</p>
<hr>
<h2>Bach, Larson, or EMI?</h2>
<p>In a test performed by professor Douglas Hofstadter of the University of 
Oregon, a pianist performed three musical pieces in the style of Bach:
<ul>
<li>One written by Bach</li>
<li>One written by Steve Larson</li>
<li>One written by EMI</li>
</ul>
<p>Dr. Larson was hurt when the audience concluded that his piece was written by 
EMI.</p>
<p>He felt better when the listeners decided that the piece composed by EMI was 
a genuine Bach.</p>
<p>Source: <a target="_blank"
href="https://www.nytimes.com/1997/11/11/science/undiscovered-bach-no-a-computer-wrote-it.html">
New York Times</a></p>

<img alt="Vivaldi" src="img_vivaldi.jpg" width="100%">
<p><a target="_blank" href="https://www.youtube.com/watch?v=2kuY3BrmTfQ">David 
Cope Emmy Vivaldi</a></p>

<hr>
<h2>Project Baseline</h2> 
<p><a target="_blank" href="https://www.projectbaseline.com/">Project Baseline</a>
is an initiative to make it easy for everyone to contribute to the map of human 
health and to participate in clinical research.</p>
<p>In Project Baseline, researchers, clinicians, engineers, designers, 
advocates, and volunteers, can collaborate building the next generation of 
healthcare tools and services.</p>
<img alt="Baseline" src="img_baseline.jpg" width="100%">

<hr>
<h2>Data Scientists</h2>
<p>Data Scientists can be experts in multiple disciplines:
<ul>
...
<p>Data Scientists also have significant big data experience: 
<ul>
...
<div class="ws-note">
<p><b>Artificial Intelligence</b> is a scientific discipline embracing several <b>
Data Science</b> fields ranging from narrow AI to strong AI, including machine 
learning, deep learning, big data and data mining.
</div>
...
<h2>Artificial Health Intelligence</h2>
<div class="ws-note">
<p>The <b>Corona Pandemic</b> pushed the need for optimizing <b>Medical 
Healthcare</b>.</p>
</div>
<p>Machine learning is a new technology that can provide better drug discovery, 
shorter development time, and lower drug costs.</p>
<p>Machine Learning enables healthcare to use "big data" for making better 
medical or clinical decisions.</p>

<hr>
<h2>FDA Statement</h2>
<p>Statement from FDA Commissioner Scott Gottlieb, M.D. on steps toward a new, 
tailored review framework for artificial intelligence-based medical devices:</p>
<div class="w3-panel w3-leftbar w3-sand">
<p class="w3-large w3-serif"><i>"Artificial intelligence and machine learning 
have the potential to fundamentally transform the delivery of health care. As 
technology and science advance, we can expect to see earlier disease detection, 
more accurate diagnosis, more targeted therapies and significant improvements in 
personalized medicine".</i></p>
</div>
