...
<a class="w3-left w3-btn" href="ai_graphics.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ai_plotly.asp">Next &#10095;</a>
</div>

<div class="w3-panel ws-info">
<p>HTML Canvas is perfect for <b>Scatter Plots</b></p>
<p>HTML Canvas is perfect for <b>Line Graphs</b></p>
<p>HTML Canvas is perfect for combining <b>Scatter</b> and <b>Lines</b></p>
</div>
...
for (let i = 0; i &lt; xArray.length-1; i++) {<br>
&nbsp;&nbsp;let x = xArray[i]*400/150;<br>
&nbsp;&nbsp;let y = yArray[i]*400/15;<br>
&nbsp;&nbsp;ctx.beginPath();<br>
&nbsp;&nbsp;ctx.ellipse(x, y, 2, 3, 0, 0, Math.PI * 2);<br>
&nbsp;&nbsp;ctx.fill();<br>
}
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_canvas_scatter">Try it Yourself &raquo;</a></p>
</div>
<hr>
<h2>Line Graphs</h2>
<div class="w3-example">
<h3>Source Code</h3>
<div class="w3-code notranslate jsHigh">
const xMax = canvas.height = canvas.width;<br>
const slope = 1.2;<br>
const intercept = 70;<br>
<br>
// Plot Line<br>
ctx.beginPath();<br>
ctx.moveTo(0, intercept);<br>
ctx.lineTo(xMax, xMax * slope + intercept);<br>
ctx.stroke();<br>
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_canvas_line">Try it Yourself &raquo;</a></p>
</div>
...
<h3>Source Code</h3>
<div class="w3-code notranslate jsHigh">
let xMax = canvas.height;<br>
let yMax = canvas.width;<br>
let slope = 1.2;<br>
let intercept = 70;<br>
<br>
const xArray = [50,60,70,80,90,100,110,120,130,140,150];<br>
...
ctx.fillStyle = "red";<br>
for (let i = 0; i &lt; xArray.length-1; i++) {<br>
&nbsp;&nbsp;let x = xArray[i] * xMax/150;<br>
&nbsp;&nbsp;let y = yArray[i] * yMax/15;<br>
&nbsp;&nbsp;ctx.beginPath();<br>
&nbsp;&nbsp;ctx.ellipse(x, y, 2, 3, 0, 0, Math.PI * 2);<br>
&nbsp;&nbsp;ctx.fill();<br>
}<br>
...
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_canvas_combined">Try it Yourself &raquo;</a></p>
</div>
<div class="w3-panel ws-info">

<p>Having a <b>Plotter Object</b> is nice when studying Artificial Intelligence:</p>
<ul>
<li>Makes AI more <b>Fun</b></li>
<li>Makes AI more <b>Visual</b></li>
<li>Makes AI more <b>Understandable</b></li>
</ul>
</div>
<canvas id="myCanvas" width="800px" height="400px" style="width:100%;max-width:500px;border:1px solid black"></canvas>

<hr>
<h2>Create a Plotter Object</h2>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
function XYPlotter(id) {<br><br>
this.canvas = document.getElementById(id);<br>
this.ctx = this.canvas.getContext("2d");<br>
this.xMin = 0;<br>
this.yMin = 0;<br>
this.xMax = this.canvas.width;<br>
this.yMax = this.canvas.height;<br>
.<br>
.<br>
</div>
</div>
...
<hr>
<h2>Add a Method for Plotting a Line</h2>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
this.plotLine = function(x0, y0, x, y, color) {<br>
&nbsp;&nbsp;this.ctx.moveTo(x0, y0);<br>
&nbsp;&nbsp;this.ctx.lineTo(x, y);<br>
&nbsp;&nbsp;this.ctx.strokeStyle = color;<br>
&nbsp;&nbsp;this.ctx.stroke();<br>
}
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_plotter_line">Try it Yourself &raquo;</a></p>
</div>
<hr>
<div id="midcontentadcontainer" style="overflow:auto;text-align:center">
<!-- MidContent -->
...
<hr>
<h2>Add a Method for Transforming XY Values</h2>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
this.transformXY = function() {<br>
&nbsp;&nbsp;this.ctx.transform(1, 0, 0, -1, 0, this.canvas.height)<br>
}
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_plotter_transform">Try it Yourself &raquo;</a></p>
</div>



<hr>
<h2>Add a Method for Plotting Points</h2>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
this.plotPoints = function(n, xArr, yArr, color, radius = 3) {<br>
&nbsp;&nbsp;for (let i = 0; i &lt; n; i++) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.ctx.fillStyle = color;<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.ctx.beginPath();<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.ctx.ellipse(xArr[i], yArr[i], radius, radius, 0, 0, Math.PI * 2);<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.ctx.fill();<br>
&nbsp;&nbsp;}<br>
}<br>
</div>
...
<hr>
<h2>Plot Some Random Points</h2>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create a Plotter<br>
let myPlotter = new XYPlotter("myCanvas");<br>
<br>
// Create random XY Points<br>
numPoints = 500;<br>
const xPoints = Array(numPoints).fill(0).map(function(){return Math.random() * myPlotter.xMax});<br>
const yPoints = Array(numPoints).fill(0).map(function(){return Math.random() * myPlotter.yMax});<br>
<br>
// Plot the Points<br>
myPlotter.plotPoints(numPoints, xPoints, yPoints, "blue");
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_plotter_points">Try it Yourself &raquo;</a></p>
</div>

<hr>
<h2>Put the Code in a Library</h2>
<div class="w3-example">
<h3>Source Code</h3>
<div class="w3-code notranslate jsHigh">
function XYPlotter(id) {<br><br>
...
<br>
// Transform XY Function<br>
this.transformXY = function() {<br>
&nbsp;&nbsp;this.ctx.transform(1, 0, 0, -1, 0, this.canvas.height)<br>
}<br>
<br>
// Pot Points Function<br>
this.plotPoints = function(n, xArr, yArr, color, radius = 3) {<br>
&nbsp;&nbsp;for (let i = 0; i &lt; n; i++) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.ctx.fillStyle = color;<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.ctx.beginPath();<br>
...
<p>Save it in a file (like "myplotlib.js")</p>
</div>
<h2>Use it in Your HTML Pages</h2>
<p>Now you can add your plotter object to your HTML pages:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;script src="myplotlib.js"&gt;&lt;/script&gt;
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_plotter_lib">Try it Yourself &raquo;</a></p>
</div>
