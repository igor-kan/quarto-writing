...
<a class="w3-left w3-btn" href="ai_statistics.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ai_variance.asp">Next &#10095;</a>
</div>

<div class="w3-panel ws-info">
<p><b>Descriptive Statistics</b> is broken down into <b>Tendency</b> and <b>Variability</b>.</p>
<p><b>Tendency</b> is about <b>Center Measures</b>:</p>
<ul>
<li>The <b>Mean</b> (the average value)</li>
<li>The <b>Median</b> (the mid point value)</li>
<li>The <b>Mode</b> (the most common value)</li>
</ul>
</div>

<h2>The Mean</h2>
<p>The <b>Mean Value</b> is the <b>Average</b> of all values.</p> 
<p>This table contains 11 values:</p>
<table class="ws-table-all">
<tr><td>7</td><td>8</td><td>8</td><td>9</td><td>9</td><td>9</td><td>10</td><td>11</td><td>14</td><td>14</td><td>15</td></tr>
</table>
<p>To find the <b>Mean Value</b>: Add all values and divide by the number of values.</p> 
<p>The <b>Mean Value</b> is:<br>
(7+8+8+9+9+9+10+11+14+14+15)/11 = 10.3636363636.</p>
<p>The <b>Mean</b> is the <b>Sum</b> divided by the <b>Count</b>.</p>
<div class="w3-example">
<p>Calculate the Mean Value:</p>
<div class="w3-code notranslate jsHigh">
let mean = (7+8+8+9+9+9+10+11+14+14+15)/11;<br>
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_mean">Try it Yourself &raquo;</a></p>
</div>
<div class="w3-example">
<p>Or use a math library like <b>math.js</b>:</p>
<div class="w3-code notranslate jsHigh">
const values = [7,8,8,9,9,9,10,11,14,14,15];<br>
let mean = math.mean(values);
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_math_mean">Try it Yourself &raquo;</a></p>
</div>
<hr>
<h2>The Median</h2>
<div class="w3-example">
<p>A list of speed values:</p>
<div class="w3-code notranslate">
99,86,87,88,111,86,103,87,94,78,77,85,86
</div>
</div>
<p>The <b>Median</b> is the value in the middle (after the values are sorted):</p>
<div class="w3-example">
<div class="w3-code notranslate">
77,78,85,86,86,86,<span class="w3-xlarge">87</span>,87,88,94,99,103,111
</div>
</div>
<div class="w3-example">
<p>Calculate the median:</p>
<div class="w3-code notranslate jsHigh">
const speed = [99,86,87,88,111,86,103,87,94,78,77,85,86];<br>
let median = math.median(speed);
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_math_median">Try it Yourself &raquo;</a></p>
</div>
<p>If there are two numbers in the middle, divide the sum of them by two.</p>
<div class="w3-example">
<div class="w3-code notranslate">
77,78,85,86,86,<span class="w3-xlarge">86,87</span>,87,88,94,99,103
</div>
</div>
<div class="w3-example">
<div class="w3-code notranslate">
...
<p>Calculate the median:</p>
<div class="w3-code notranslate jsHigh">
const speed = [99,86,87,88,86,103,87,94,78,77,85,86];<br>
let median = math.median(speed);
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_math_median2">Try it Yourself &raquo;</a></p>
</div>
...
<hr>
<h2>The Mode</h2>
<p>The <b>Mode Value</b> is the value that appears the most number of times:</p>
<div class="w3-example">
<div class="w3-code notranslate">
99,<span class="w3-xlarge">86</span>,87,88,111,<span class="w3-xlarge">86</span>,103,87,94,78,77,85,<span class="w3-xlarge">86</span>
</div>
</div>
<div class="w3-example">
<p>Calculate the mode:</p>
<div class="w3-code notranslate jsHigh">
const speed = [99,86,87,88,86,103,87,94,78,77,85,86];<br>
let mode = math.mode(speed);
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_math_mode">Try it Yourself &raquo;</a></p>
</div>
<hr>
<h2>Outliers</h2>
<p><b>Outliers</b> are values "<b>outside</b>" the other values:</p>
<div class="w3-example">
<div class="w3-code notranslate">
99,86,87,88,111,86,103,87,94,78,<span class="w3-xlarge">300</span>,85,86
</div>
</div>
<p>Outliers can change the mean a lot. Sometimes we don't use them (they might be an error),
or we use the median or the mode instead.</p>
<div class="w3-example">
<p>Calculate the Mean:</p>
<div class="w3-code notranslate jsHigh">
const values = [99,86,87,88,111,86,103,87,94,78,300,85,86];<br>
let mean = math.mean(values);
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_math_outlier">Try it Yourself &raquo;</a></p>
</div>
