...
<a class="w3-left w3-btn" href="ai_examples.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ai_scatter_plots.asp">Next &#10095;</a>
</div>

<div class="w3-panel ws-info">
<p>Machine Learning often uses line graphs to show relationships.</p>
<p>A line graph displays the values of a linear function: y = ax + b</p>
<p>Important keywords:</p>
<ul>
<li><b>Linear</b> (Straight)</li>
<li><b>Slope</b> (Angle)</li>
<li><b>Intercept</b> (Start value)</li>
</ul>
</div>

<h2>Linear</h2>
<p><b>Linear</b> means straight. A linear graph is a straight line.</p>
...
<br>
// Define Layout<br>
const layout = {title: "y = x"};<br>
<br>
// Display using Plotly<br>
Plotly.newPlot("myPlot", data, layout);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryai_plotly_function_linear1">Try it Yourself &raquo;</a>
</div>
...
<hr>
<h2>Slope</h2>
<p>The <b>slope</b> is the angle of the graph.</p>
<p>The slope is the <b>a</b> value in a linear graph:</p>
<p class="w3-xlarge">y = <b>a</b>x</p>
<p>In this example, <b>slope</b> = <b>1.2</b>:</p>
...
// Define Layout<br>
const layout = {title: "Slope=" + slope};<br>
<br>
// Display using Plotly<br>
Plotly.newPlot("myPlot", data, layout);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryai_plotly_function_linear2">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Intercept</h2>
<p>The <b>Intercept</b> is the start value of the graph.</p>
<p>The intercept is the <b>b</b> value in a linear graph:</p>
<p class="w3-xlarge">y = ax + <b>b</b></p>
<p>In this example, slope = 1.2 and <b>intercept</b> = <b>7</b>:</p>
...
<br>
// Define Layout<br>
const layout = {title: "Slope=" + slope + " Intercept=" + intercept};<br>
<br>
// Display using Plotly<br>
Plotly.newPlot("myPlot", data, layout);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryai_plotly_function_linear3">Try it Yourself &raquo;</a>
</div>
