...
<a class="w3-left w3-btn" href="ai_variance.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ai_probability.asp">Next &#10095;</a>
</div>

<div class="w3-panel ws-info">
<ul>
<li>What is <b>Normal Distribution?</b></li>
<li>What is <b>Margin of Error?</b></li>
<li>What is <b>Skewness?</b></li>
<li>What is <b>Kurtosis?</b></li>
</ul>
</div>

<h2>Normal Distribution</h2>
<p>The <b>Normal Distribution Curve</b> is a bell-shaped curve.</p>
<p>Each band of the curve has a width of <b>1 Standard Deviation</b>:</p>
<a title="D Wells, CC BY-SA 4.0 &lt;https://creativecommons.org/licenses/by-sa/4.0&gt;, via Wikimedia Commons"
target="_blank" href="https://commons.wikimedia.org/wiki/File:Standard_Normal_Distribution.png">
<img width="100%" alt="Standard Normal Distribution"
src="img_standard_normal_distribution.jpg"></a>

<p>Each band of the curve has a width of 1 Standard deviation from the <b>Mean Value</b>.</p>
<p>Values less than <b>1 Standard Deviation</b>
away account for <b>68.27%</b>.</p>
<p>Values less than <b>2 standard deviations</b> away account for <b>95.45%</b>.</p>
<p>Values less than <b>3 standard deviations</b> away account for <b>99.73%</b>.</p>
<p>What does it mean?</p>
<p>Most observations are within 1 standard deviation from the mean.</p>
<p>Almost all observations are within 2 standard deviations.</p>
<p>Practically all observations are within 3 standard deviations.</p>


<hr>
<h2>Normal Distribution Facts</h2>
<p>Normal distribution is <b>Symmetric</b>. The peak always divides the distribution in half.</p>
<p>Normal distribution is a <b>Probability</b> distribution.</p>
<p>A lot of observations follow the normal distribution:</p>
<ul>
<li>Your IQ</li>
<li>Your Weight</li>
<li>Your Height</li>
...
<p>Normal distribution shows that values near the mean
are more frequent than values far from the mean:</p>
<table class="ws-table-all">
<tr><th>Distance from the Mean Value</th><th>Percentage of the Population</th></tr>
<tr><td>1 Standard deviation</td><td>68.27%</td></tr>
<tr><td>2 Standard deviations</td><td>95.45%</td></tr>
<tr><td>3 Standard deviations</td><td>99.73%</td></tr>
</table>
<p>The <b>68–95–99.7 Rule</b> (aka The Empirical Rule), is a shorthand 
to remember the percentage of values that lie within the different bands of a normal distribution.</p>

<p>Normal distribution is also known as the <b>Gaussian Distribution</b> and the <b>Bell Curve</b>.</p>
<hr>
...
<p>Statisticians will always try to predict everything with 100% accuracy.</p>
<p>But, there will always be some uncertainty.</p> 
<p>The<b> Margin of Error</b> is the number that quantifies this statistical uncertainty.</p>
<p><b>Different margins</b> define different ranges for where we believe the correct answers can be found.</p>
<p><b>The acceptable margin</b> is a matter of judgment, and relative to how important the answer is.</p> 

<p>The more samples we collect, the lower the margin of error is:</p>
<p>
<br>
<a title="Zieben007, CC BY-SA 3.0 &lt;https://creativecommons.org/licenses/by-sa/3.0&gt;, via Wikimedia Commons"
target="_blank" href="https://commons.wikimedia.org/wiki/File:Margin-of-error-95.svg">
<img style="width:100%;max-width:600px" alt="Margin of Error" src="img_margin_of_error.png"></a>
</p>
<hr>
<h2>How to Interpret Margin of Error</h2>
<p>Suppose 55% of a sampled population say they plan to vote "Yes".</p>
<p>When projecting this to a whole population, you add/subtract the margin of error
to give a range of possible results.</p>
<p>With a margin of error of 3%, you are confident that between 52% and 58% will vote "Yes".</p>
<p>With a margin of error of 10%, you are confident that between 45% and 65% will vote "Yes".</p>

<hr>
<h2>Skewness</h2>
<p><b>Skewness</b> is a distortion (an asymmetry) from the bell curve (normal distribution).</p>
<a title="Rodolfo Hermans (Godot) at en.wikipedia., CC BY-SA 3.0 &lt;https://creativecommons.org/licenses/by-sa/3.0&gt;,via Wikimedia Commons" target="_blank" href="https://commons.wikimedia.org/wiki/File:Negative_and_positive_skew_diagrams_(English).svg">
<img style="width:100%;max-width:600px" alt="Skewness" src="img_skewness.png"></a>

<hr>
<h2>Kurtosis</h2>
<p><b>Kurtosis</b> is a also a distortion from the normal distribution (bell curve).</p>
<p>While skewness describes a unexpected values in one tail, kurtosis describes unexpected values in both tails.</p>
<img style="width:49%;max-width:600px" alt="Kurtosis" src="img_kurtosis_neg.jpg">
<p>Image: Negative kurtosis (lower than normal distribution).</p>
<img style="width:49%;max-width:600px" alt="Kurtosis" src="img_kurtosis_pos.jpg">
<p>Image: Positive kurtosis (higher than normal distribution).</p>
