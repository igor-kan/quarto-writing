...
<a class="w3-left w3-btn" href="ai_d3js.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ai_history_languages.asp">Next &#10095;</a>
</div>

<div class="w3-panel ws-info">
<p>About 70 000 years ago, something happened to the human brain.</p>
<p>Humans started to develop "Cognitive Intelligence":</p>
<ul>
<li>Being able to understand a language</li>
<li>Being able to understand numbers</li>
<li>Being able to understand abstract thinking</li>
</ul>
</div>

<h2>Words and Numbers</h2>
<p>Using words, was a big step in the development of human intelligence:</p>
<p>"Elephant" is more informative than "Big Animal".</p>
<p>Understanding numbers, was also a big step:</p>
<p>"5" or "50" is more informative than "few" or "many".</p>
<hr>

<h2>Languages</h2>
<p>"There is a lion behind the big oak" is more informative than shouting "Danger!".</p>
<p>Having a language is probably a key characteristic that distinguishes us from animals.</p>

<hr>
<h2>Abstract Thinking</h2>
<p>
<p>Abstract thinking is thinking about things that are <b>not concrete</b>,
like freedom, or ideas, or concepts.</p>
<div class="w3-row-padding w3-stretch">
<div class="w3-col l6 m6 s12">
<div class="w3-card">
<div class="w3-container w3-center">
<h3>Abstract</h3>
<img alt="Statue Liberty" src="img_statue_liberty.jpg" width="70%">
<p>A freedom figure</p>
</div>
...
<p>Many everyday behaviors use abstract thinking:</p>
<ul class="w3-ul">
<li>Using Concepts</li>
<li>Using Theories</li>
<li>Using Metaphors</li>
<li>Using Analogies</li>
<li>Using Imagination</li>
</ul>
<hr>
...
<p>There is <b>no</b> proven definition of <b>Intelligence</b>.</p>
<p>Intelligence can be defined as:</p>
<ul>
<li>Being able to understand abstract thinking</li>
<li>Being able to understand a language</li>
<li>Being able to understand numbers</li>
...
<p>Intelligence can be defined as a collection of knowledge:</p>
<div class="w3-panel w3-leftbar w3-sand">
  <p class="w3-large w3-serif">
  <i>"Intelligence could be defined as the process of obtaining knowledge by 
  efficient means."</i></p>
  <p>Yampolsky (2013)</p>
</div>

<p>The challenge of AI is to understand what intelligence is, and how intelligence works.</p>
<p>What is the difference between human knowledge and artificial intelligence?</p>
<p>Intelligence might be a type of algorithms in our brains or in our genes.</p>
<p>Later in this tutorial you will learn more about intelligent algorithms.</p>

<hr>
<h2>Is the Human Brain Superior?</h2>
<p>Can animals, birds, insects, or plants think?</p>
<p>Humans have bigger brains than animals.</p>
<p>Big dogs have bigger brains than small dogs. Are big dogs smarter?</p>
<p>Birds have very small brains, but they know they should not make children in the autumn,
and they know when to fly to the south.</p>
<p>Bees have even smaller brains, but they know how to communicate 
about where to find nectar.</p>
<p>Plants have no brain, but they know how to reproduce, and how to prepare for the winter.</p>
