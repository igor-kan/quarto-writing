...
<html lang="en-US">
<head>
<title>Machine Learning Data</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="ai_ml_terminology.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ai_clustering.asp">Next &#10095;</a>
</div>

<div class="w3-panel ws-info">
<p>Up to <b>80%</b> of a Machine Learning project is about <b>Collecting Data</b>:</p>
<ul>
<li>What data is <b>Required</b>?</li>
<li>What data is <b>Available</b>?
<li>How to <b>Select</b> the data?</li>
<li>How to <b>Collect</b> the data?</li>
<li>How to <b>Clean</b> the data?</li>
<li>How to <b>Prepare</b> the data?</li>
<li>How to <b>Use</b> the data?</li>
</ul>
</div>

<h2>What is Data?</h2>
<p>Data can be many things.</p>
<p>With Machine Learning, data is collections of facts:</p> 
<table class="ws-table-all">
<tr><th>Type</th><th>Examples</th></tr>
<tr><td>Numbers</td><td>Prices. Dates.</td></tr>
<tr><td>Measurements</td><td>Size. Height. Weight.</td></tr>

<tr><td>Words</td><td>Names and Places.</td></tr>
<tr><td>Observations</td><td>Counting Cars.</td></tr>
<tr><td>Descriptions</td><td>It is cold.</td></tr>
</table>
<hr>
<h2>Intelligence Needs Data</h2>
<p>Human intelligence needs data:</p>
<p>A real estate broker needs data about sold houses to estimate prices.</p>
<p>Artificial Intelligence also needs data:</p>
<p>A Machine Learning program needs data to estimate prices.</p>

<div class="ws-note">
<p>Data can help us to see and understand.</p>
<p>Data can help us to find new opportunities.</p>
<p>Data can help us to resolve misunderstandings.</p>
</div>
<hr>
<h2>Healthcare</h2>
<p>Healthcare and life sciences collect public health data and patient data
to learn how to improve patient care and save lives.</p>
<h2>Business</h2>
<p>The most successful companies in many sectors are data driven.
They use sophisticated data analytics to learn how the company can perform better.</p>
<h2>Finance</h2>
<p>Banks and insurance companies collect and evaluate data about customers, loans and deposits
to support strategic decision-making.</p>
<hr>
<h2>Storing Data</h2>
<p>The most common data to collect are Numbers and Measurements.</p>
<p>Often data are stored in arrays representing the relationship between values.</p>
<p>This table contains house prices versus size:</p>
<table class="ws-table-all">
<tr><td>Price</td><td>7</td><td>8</td><td>8</td><td>9</td><td>9</td><td>9</td><td>10</td><td>11</td><td>14</td><td>14</td><td>15</td></tr>
<tr><td>Size</td><td>50</td><td>60</td><td>70</td><td>80</td><td>90</td><td>100</td><td>
  110</td><td>120</td><td>130</td><td>140</td><td>150</td></tr>
</table>
<hr>

<h2>Quantitative vs. Qualitative</h2>
<p>Quantitative data are numerical:</p>
<ul>
<li>55 cars</li>
<li>15 meters</li>
<li>35 children</li>
...
<p>Qualitative data are descriptive:</p>
<ul>
<li>It is cold</li>
<li>It is long</li>
<li>It was fun</li>
...
<p>A <b>Census</b> is when we collect data for every member of a group.</p>
<p>A <b>Sample</b> is when we collect data for some members of a group.</p>

<p>If we wanted to know how many Americans smoke cigarettes,
we could ask every person in the US (a census),
or we could ask 10 000 people (a sample).</p>
<p>A census is <b>Accurate</b>, but hard to do. A sample is <b>Inaccurate</b>, but is easier to do.</p>
<hr>

<h2>Sampling Terms</h2>
<p>A <b>Population</b> is group of individuals (objects) we want to collect information from.</p>
<p>A <b>Census</b> is information about every individual in a population.</p>
<p>A <b>Sample</b> is information about a part of the population (In order to represent all).</p>
<hr>
<h2>Random Samples</h2>
<p>In order for a sample to represent a population, it must be collected randomly.</p>
<p>A <b>Random Sample</b>, is a sample where every member of the population has an 
equal chance to appear in the sample.</p>
<hr>
<h2>Sampling Bias</h2>
<p>A <b>Sampling Bias</b> (Error) occurs when samples are collected in such a way
that some individuals are less (or more) likely to be included in the sample.</p>
<hr>
<h2>Big Data</h2>
<p>Big data is data that is impossible for humans to process
without the assistance of advanced machines.</p>
<p>Big data does not have any definition in terms of size,
but datasets are becoming larger and larger as we continously collect more and more data
and store data at a lower and lower cost.</p>
<hr>
<h2>Data Mining</h2>
<p>With big data comes complicated data structures.</p>
<p>A huge part of big data processing is refining data.</p>
