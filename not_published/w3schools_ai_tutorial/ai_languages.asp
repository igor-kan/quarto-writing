...
<html lang="en-US">
<head>
<title>Machine Learning Languages</title>
<meta charset="utf-8">
...
<h1>Machine Learning Languages</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="ai_whatis.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ai_javascript.asp">Next &#10095;</a>
</div>

<div class="w3-panel ws-info">
<p><b>Programming languages</b> involved in <b>Machine Learning</b> and Artificial Intelligence are:</p>
<ul>
<li>LISP</li>
<li>R</li>
<li>Python</li>
...
<h2>LISP</h2>
<p><b>LISP</b> is the second oldest programming language in the world (1958), one year younger than Fortran (1957).</p>
<p>The term <b>Artificial Intelligence</b> was made up by <b>John McCarthy</b> who invented LISP.</p>
<p>LISP was founded on the theory of <b>Recursive Functions</b> (self modifying functions),
and this is very suitable for Machine Learning programs where 
"self-learning" is an important part of the program.</p>
<p>


<hr>
<img alt="R Logo" src="img_rlogo.png" width="70px">
<h2>The R Language</h2>
<p><b>R</b> is a programming language for <b>Graphics</b> and <b>Statistical</b> computing.</p>
<p>R is supported by the <a target="_blank" href="https://www.r-project.org/">R Foundation for Statistical Computing</a>.</p>
<p>R comes with a wide set of statistical and graphical techniques for:</p>
<ul> 
...
<hr>
<img alt="Python Logo" src="img_python_logo.png" width="200px">
<h2>Python</h2>
<p><b>Python</b> is a general-purpose coding language. It can be used for all types of programming and software development.</p>
<p>Python is typically used for server development, like building web apps for web servers.</p>
<p>Python is also typically used in <b>Data Science</b>.</p>
<p>An advantage for using Python is that it comes with some very suitable libraries:</p>
<ul>
...
<img width="100%" alt="Languages" src="img_languages_2020.jpg">
<p class="w3-center w3-text-grey"><a target="_blank" href="https://octoverse.github.com/">Source: Octoverse</a></p>

<hr>

<h2>C++</h2>
<p><b>C++</b> holds the title: "<b>The worlds fastest programming language</b>".</p>
<p>Because of the speed, C++ is a preferred language when programming Computer Games.</p>
<p>It provides faster execution and has less response time which is applied in search engines and development of computer games.
<p>Google uses C++ in Artificial Intelligence and Machine Learning programs for SEO (Search Engine Optimization).</p>
<p><b>SHARK </b> is a super-fast C++ library with support for supervised learning algorithms, linear regression,
neural networks, and clustering.</p>
<p><b>MLPACK</b> is also a super-fast machine learning library for C++.</p>
...
<hr>
<h2>Java</h2>
<p><b>Java</b> is another general-purpose coding language that can be used for all types of software development.</p>
<p>For Machine Learning, Java is mostly used to create algorithms, and neural networks.</p>

<hr>
<h2>SQL</h2>
<p><b>SQL</b> (Structured Query Language) is the most popular language for managing data.</p>
<p>Knowledge of SQL databases, tables and queries helps data scientists when dealing with data.</p>
<p>SQL is very convenient for storing, manipulating, and retrieving data in databases.</p>
