...
<html lang="en-US">
<head>
<title>The History of Numbers</title>
<meta charset="utf-8">
...
<h1>The History of Numbers</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="ai_history_languages.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ai_history_computers.asp">Next &#10095;</a>
</div>
<div class="w3-container ws-info">
<p>To understand AI, it is important to understand the concept of Numbers and Counting.</p>
</div>

<h2>AI is About Numbers</h2>
<p>Artificial Intelligence is all about <b>Numbers</b>.</p>
<p>Numbers are easy to understand: 1,2,3,4,5 ... 11,12,13,14,15.</p>
<p>Studies of animals indicates that even animals can understand some numbers:
<ul>
<li>2 Wives</li>
<li>8 Sons</li>
<li>5 Eggs</li>
...
<p>The need for numbers in the modern world is absolute. We cannot live without numbers:</p>
<ul>
<li>100 Dollar</li>
<li>Pi = 3.14</li>
<li>365 Days</li>
...
<hr>
<h2>AI is About Counting</h2>
<p>The concept of numbers leads to the concept of counting.</p>
<p>Imagine prehistoric thinking:</p>
<ul>
<li>How to count apples?</li>
<li>How to weigh corn?</li>
<li>How to pay?</li>
<li>How far is the ocean?</li> 
</ul>
<p>Artificial Intelligence is a result of the human need for calculations.</p>
<p>Counting is easy to understand: 2 + 2 = 4.</p>
<p>Studies of animals indicates that animals can only understand very simple counting.</p>
<p>How do Homo Sapiens deal with calculations?</p>
<p>Complex calculations are done by computers.</p>
<div class="w3-container ws-info">
<p>"Yes! Computers can be smarter than humans."</p>
</div>

<hr>
<h2>Babylonian Numbers (Base 60)</h2>
<p>We believe that the Babylonians started the development of complex counting.</p>
<p>The Babylonian number system has 60 different digits. It is a <b>Base 60</b> system.</p>
...
src="img_babylonian_numerals.jpg"></a>

<hr>
<h2>Two Babylonian Scientists</h2>
<p>About 6000 Years ago ...</p>
<p>Two Babylonian scientists were talking (writing numbers as dots on a paper):</p>
<div class="w3-panel ws-info">
<p>Scientist 1: "We need to invent a number system".</p>
<p>Scientist 2: "What?".</p>
<p>Scientist 1: "We need to give every number a name".</p>
<p>Scientist 2: "You mean like 1, 2, and 3".</p>
<p>Scientist 1: "Exactly!".</p>
<p>Scientist 2: "But why?".</p>
<p>Scientist 1: "How can I tell you I have 7 sons, if you don't know what 7 is?</p>
<p>Scientist 2: "Every number should have a name?".</p>
<p>Scientist 1: "Exactly!".</p>
<p>Scientist 2: "So, how many numbers do we need? 15?".</p>
<p>Scientist 1: "More. Some people have more than 15 sons".</p>
<p>Scientist 2: "Ok. 30 then. Just to be sure".</p>
<p>Scientist 1: "But people older than 30 should be able to tell their age".</p>
<p>Scientist 2: "Ok. 60 then".</p>
</div>

<hr>
<h2>Sexagesimal (base 60)</h2>
<p>The sexagesimal system (base 60):</p>
<ul>
<li>There are 60 seconds in one minute</li>
<li>There are 60 minutes in one hour</li>
</ul> 
<p>60 is very versatile. It can be divided by 1,2,3,4,5,6,10,12,15,30, and 60.</p>

<p>The Babylonian system was a place-value system, where the digits to
the left represented full values, much like our decimal system.</p>
<p>
1,5 means 65 (1 times 60, plus 5)<br>
3,30 means 210 (3 times 60, plus 30)<br>
</p>

<p>The reason why the Babylonians used 60 as the base,
was (we like to believe) that 60 is divisible with most numbers:
1,2,3,4,5,6,10,12,15,20,30, and 60.</p>
<p>The downside was that the user had to remember
60 different digits. But the system was smart. A lot of it is still in use today:</p>
<table class="ws-table-all">
<tr><th>What</th><th>We</th><th>Why</th></tr>
<tr><td>A full circle</td><td>360°</td><td>6 x 60 = 360</td></tr>
<tr><td>Half a circle</td><td>180°</td><td>3 x 60 = 180</td></tr>
<tr><td>One Hour</td><td>60°</td><td>1 x 60 = 60 minutes</td></tr>
</table>

<p>The Babylonians counted to 360 because of their sexagesimal (base-60) number system,
which they inherited from earlier Mesopotamian cultures.
This system led to many mathematical and astronomical conventions that we still use today,
including:

<h3>Dividing a circle into 360 degrees</h3>
<ul>
<li>The Babylonians observed that a year is roughly 360 days (based on early solar calendars).</li>
<li>They associated celestial movements with circular motion and divided the circle into 360 parts (degrees).</li>
</ul>

<h3>Using Base-60 (Sexagesimal) System</h3>

<ul>
<li>60 is a highly composite number, meaning it has many divisors (1, 2, 3, 4, 5, 6, 10, 12, 15, 20, 30, 60), making it useful for fractions and measurements.</li>
<li>360 is a multiple of 60 (60 × 6), which fits neatly into their mathematical framework.</li>
</ul>

<h3>Astronomical and Calendar Significance</h3>
<ul>
<li>The Babylonians tracked lunar and solar cycles, which were closely linked to the approximate 360-day year.</li>
<li>They divided the sky into 12 zodiac constellations, each spanning 30 degrees.</li>
</ul>

<h3>Influence on Time Measurement</h3>
<ul>
...
Their system was so effective that it persisted through Greek and Hellenistic astronomy and eventually shaped modern mathematics, geometry, and timekeeping.
<p>The origin of the <b>Sexagesimal system</b> (base 60) has been lost in history.</p>
<p>But it looks like it has been used in parallel with the <b>Dozenal system</b> since ancient times.</p>

<hr>
<h2>Dozenal (base 12)</h2>
<p>The dozenal system (base 12):</p>
<ul>
<li>There are 12 in a dozen</li>
<li>There are 12 hours in a day</li>
<li>There are 12 hours in a night</li>
<li>There are 12 months in a year</li>
</ul>

<p>12 is very versatile. It can be divided by 1,2,3,4,6,and 12.</p>
<hr>
...
<hr>
<h2>How to Count Dozenal</h2>
<p><b>With two hands, you can count to 60.</b></p>

<p>Each of your fingers have 3 joints:</p>

<table class="ws-table-all">
<tr>
<td><img width="100%" alt="12 Fingers" src="img_12_fingers.jpg"></td>
<td><img width="100%" alt="12 Fingers" src="img_12_fingers_right.jpg"></td>
</tr>
<tr>
<td>The thumb counts to 12 on left hand.</td>
<td>The right hand counts the number of left hands.</td>
</tr>
</table>
 
<ul>
<li>1 full hand = 12</li>
<li>2 full hands = 24</li>
<li>3 full hands = 36</li>
<li>4 full hands = 48</li>
<li>5 full hands = 60</li>
</ul>

<hr>
<h2>Roman Numbers (Base 10)</h2>
<p>Roman numbers originated in Rome and was used in Europe into the Middle Ages.</p>
<table class="ws-table-all">
<tr><td>Symbol:</td><td>I</td><td>V</td><td>X</td><td>L</td><td>C</td><td>D</td><td>M</td></tr>
<tr><td>Value:</td><td>1</td><td>5</td><td>10</td><td>50</td><td>100</td><td>500</td><td>1000</td></tr>
</table>
<p>The Romans used a <b>Base 10</b> system.
Possibly because they used their 10 fingers to count.</p>
<p>Today, most of the world use a <b>Base 10</b> number system:<br>
Western numbers, Chinese numbers, Brahmi numbers, Greek numbers, Hebrew numbers...</p>
<p>
5 means 5<br>
50 means 5 times 10<br>
500 means 5 times 100<br>
<br>
57 means 5 times 10, plus 7<br>
75 means 7 times 10, plus 5<br>
</p>
<hr>
<h2>Digital Numbers (Base 2)</h2>
<p>Humans can count with base 10 numbers, computers can not.</p>
<p>Electricity cannot count. Electricity can only be On and Off.
<p>Computers use Electricity or Magnetism to represent On and Off.</p>
<p>Computers use <b>Digital Numbers</b> like 11100110 (in contrast to <b>Base 10 Numbers</b> like 230).</p>
<p>Digital numbers (11100110) are also called <b>Binary Numbers</b>.</p>
<p>You will learn more about digital computers in the next chapter.</p>
<hr>
<h2>Man vs. Computer</h2>
<p>Computers can handle an unlimited amount of numbers.</p>
<p>Humans can not.</p>
