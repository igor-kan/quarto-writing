...
<h1>TensorFlow Example 2</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="ai_tensorflow_training.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ai_tensorflow_ex2_data.asp">Next &#10095;</a>
</div>

<h2>Input Data</h2>
<div id="plot1" style="height:300px;max-width:500px"></div>

<h2>Reduce Loss</h2>
<div id="plot2" style="height:300px;max-width:500px"></div>

<hr>
<h2>Explained</h2>
<p>The model above performs 4 important steps:</p>
<ul>
<li>It Collects Data</li>
<li>It Prepares Data</li>
<li>It Trains a Model</li>
<li>It Evaluates the Model</li>
</ul>
<p>In the next chapters you will learn how to program a copy of the above example.</p>
<p>You will learn how to fetch data, clean data, and plot data.</p>
<p>You will also learn how to build a TensorFlow model, and how to train the model.</p>
<ul>
<li><a href="ai_tensorflow_ex2_data.asp">Fetch and Clean Data</a></li>
<li><a href="ai_tensorflow_ex2_model.asp">Create a TensorFlow Model</a></li>
<li><a href="ai_tensorflow_ex2_training.asp">Train the Model</a></li>
</ul>
<hr>
<h2>Graphics (tfjs-vis)</h2>
<p>The graphics is displayed using the <a href="ai_tensorflow_visor.asp">tfjs-vis library</a>.
<p>tfjs-vis is a small library for in browser visualization intended for use with TensorFlow.js.</p>
<ul>
<p>Main Features are:</p>
<li>Graphic tools for visualizing <b>Machine Learning</b></li>
<li>Functions for visualizing <b>TensorFlow</b> Objects</li>
<li>Visualizations can be organized in a <b>Visor</b> (a modal browser window)</li>
...
<script src="script_houses.js"></script>
