...
<h1>Example 2 Data</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="ai_tensorflow_example_houses.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ai_tensorflow_ex2_model.asp">Next &#10095;</a>
</div>
<div class="ws-info">
<p>Example 2 uses the same source code as Example 1.</p>
<p>But, because another dataset is used, the code must collect other data.</p>
</div>

<h2>Data Collection</h2>

<p>The data used in Example 2, is a list of house objects:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
{<br>
   "Avg. Area Income": 79545.45857,<br>
   "Avg. Area House Age": 5.682861322,<br>
   "Avg. AreaNumberofRooms": 7.009188143,<br>
   "Avg. Area Number of Bedrooms": 4.09,<br>
   "Area Population": 23086.8005,<br>
   "Price": 1059033.558,<br>
},<br>
{<br>
   "Avg. Area Income": 79248.64245,<br>
   "Avg. Area House Age": 6.002899808,<br>
   "Avg. AreaNumberofRooms": 6.730821019,<br>
   "Avg. Area Number of Bedrooms": 3.09,<br>
   "Area Population": 40173.07217,<br>
   "Price": 1505890.915,<br>
},
</div>
</div>
<p>The dataset is a JSON file stored at:</p>
<div class="w3-responsive">
<a target="_blank" href="https://github.com/meetnandu05/ml1/blob/master/house.json">
https://github.com/meetnandu05/ml1/blob/master/house.json</a>
</div>


<hr>
<h2>Cleaning Data</h2>
<p>When preparing for machine learning, it is always important to:</p>
<ul>
<li>Remove the data you don't need</li>
<li>Clean the data from errors</li>
</ul>
<hr>
<h2>Remove Data</h2>
<p>A smart way to remove unnecessary data, it to extract <b>only the data you need</b>.</p>
<p>This can be done by iterating (looping over) your data with a <b>map function</b>.</p>
<p>The function below takes an object and returns <b>only x and y</b> from the object's
Horsepower and Miles_per_Gallon properties:</p> 
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
function extractData(obj) {<br>
&nbsp;&nbsp;return {x:obj.Horsepower, y:obj.Miles_per_Gallon};<br>
}
</div>
</div>
<hr>
...
<h2>Remove Errors</h2>
<p>Most datasets contain some type of errors.</p>
<p>A smart way to remove errors is to use a <b>filter function</b> to filter out the errors.</p>
<p>The code below returns false if on of the properties (x or y) contains a null value:</p>  
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
function removeErrors(obj) {<br>
&nbsp;&nbsp;return obj.x != null &amp;&amp; obj.y != null;<br>
}
</div>
</div>
...
<hr>
<h2>Fetching Data</h2>
<p>When you have your map and filter functions ready, you can write a function to fetch the data.</p>
<p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
async function runTF() {<br>
&nbsp;&nbsp;const jsonData = await fetch("cardata.json");<br>
&nbsp;&nbsp;let values = await jsonData.json();<br>
&nbsp;&nbsp;values = values.map(extractData).filter(removeErrors);<br>
}
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_tensorflow_ex2_data">Try it Yourself &raquo;</a></p>
</div>


<hr>
<h2>Plotting the Data</h2>
<p>Here is some code you can use to plot the data:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
function tfPlot(values, surface) {<br>
&nbsp;&nbsp;tfvis.render.scatterplot(surface,<br>
&nbsp;&nbsp;&nbsp;&nbsp;{values:values, series:['Original','Predicted']},<br>
&nbsp;&nbsp;&nbsp;&nbsp;{xLabel:'Rooms', yLabel:'Price',});<br>
}
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_tensorflow_ex2_plot">Try it Yourself &raquo;</a></p>
</div>
