...
<h1>History of Robots</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="ai_history_computers.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ai_history.asp">Next &#10095;</a>
</div>

<div class="w3-panel ws-info">
<ul>
<li>Industrial Robots</li>
<li>Artificial Intelligence Robots</li>
</ul>
</div>

<h2>Industrial Robots</h2>
<p>Industrial robots have been around for more than 50 years.</p>
<p>The first robot <b>patent</b> was applied for in 1954 and granted in 1961.</p>
<p>In 1969, Victor Scheinman invented the <b>Stanford Arm</b> (Stanford 
University),
and in 1972 he designed the <b>MIT Arm</b> for the MIT Artificial Intelligence Lab.</p>

<a title="ArnoldReinhold, CC BY-SA 4.0 &lt;https://creativecommons.org/licenses/by-sa/4.0&gt;, via Wikimedia Commons"
target="_blank" href="https://commons.wikimedia.org/wiki/File:Scheinman_MIT_Arm.agr.jpg">
<img style="width:80%;max-width:360px" alt="Scheinman MIT Arm" src="img_mit_arm.jpg"></a>

<p>These "robots" are not considered intelligent.
They are electrical machines designed to permit 6-axis arm movement.
But the new design allowed for a machine to follow a programmed path and opened up for 
"robot jobs" like car painting, welding and assembly.</p>

<p>The pioneering robot company Unimation (with support from General Motors)
took the Scheinman's design to the marked as the <b>PUMA</b> (Programmable Universal Machine for Assembly).</p>

<p><b>Most industrial robots are non-intelligent</b>.</p>

<p>Most modern robots are said to be <b>autonomous</b> or semi-autonomous because
they do not require much human input after they have been programmed.</p>

<p>A robot can easily be programmed to do a lot of different things (like on an assembly line),
but it will never change what it is doing. It will continue to the same job until you turn it off.</p>


<p>Robotic Bartenders on Quantum of the Seas - Royal Caribbean:</p>
<p>
<iframe width="360" height="240" src="https://www.youtube-nocookie.com/embed/TBF7EE2xnN4"
frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
allowfullscreen></iframe>
</p>

<p>Robots and Artificial Intelligence are two different things.</p>
<p>Robot technology is not a subset of Artificial Intelligence.</p>
<p>A robot is a physical thing. After 50 years of development, almost anything is programmable,
your radio, your watch, your phone, and even robots.</p>
...
<p>Artificial Intelligence can be built into robots,
and AI is a very exciting field in future robotics.</p> 
<p>Hanson Robotics' Sophia personifies some dreams for the future of AI.</p>
<p>Sophia is a combination of science, engineering, and artistry.
She is a human-crafted science fiction character depicting the future of AI and robotics.</p>

<a href="https://www.hansonrobotics.com/hanson-robots/">
<img alt="Sopia" width="360px" src="img_sophiarobot.gif"></a>

<h2>Can AI Robots Interact Socially?</h2>
<p>Yes, AI Robots can learn to interact socially.</p>
<p>Kismet (a MIT robot) is programmed to understand body language and voice inflection.
The creators study how human and babies interact, based on tone of speech and visual cue.</p>
<p>Kismet could be the foundation of a human-like learning system.</p>
<br><br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="ai_history_computers.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ai_history.asp">Next &#10095;</a>
