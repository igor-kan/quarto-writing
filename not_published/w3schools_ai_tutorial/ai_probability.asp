...
<a class="w3-left w3-btn" href="ai_distribution.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="default.asp">Next &#10095;</a>
</div>

<div class="ws-info">
<p><b>Probability</b> is about how <b>Likely</b> something is to occur,
or how likely something is true.</p>
<p>The mathematic probability is a <b>Number</b> between <b>0</b> and <b>1</b>.</p>
<p>0 indicates <b>Impossibility</b> and 1 indicates <b>Certainty</b>.</p>
</div>

<h2>The Probability of an Event</h2>

<p>The probability of an event is:</p>
<p>The number of ways the event can happen / The number of possible outcomes.</p>
<p><b>Probability = # of Ways / Outcomes</b></p>

<hr>

<h2>Tossing Coins</h2>
<img src="img_coin.jpg" alt="Coin" style="width:150px">
<img src="img_coin.jpg" alt="Coin" style="width:150px">

<p>When tossing a coin, there are two possible outcomes:</p>
<table class="ws-table-all" style="width:350px">
<tr><th>Way</th><th>Probability</th></tr>
<tr><td>Heads</td><td>1/2 = 0.5</td></tr>
<tr><td>Tails</td><td>1/2 = 0.5</td></tr>
</table>

<hr>
<h2>P(A) - The Probability</h2>
<p>The probability of an event <b>A</b> is often written as <b>P(A)</b>.

<p>When tossing two coins, there are 4 possible outcomes:</p>
<table class="ws-table-all" style="width:350px">
<tr><th>Event</th><th>P(A)</th></tr>
<tr><td>Heads + Heads</td><td>1/4 = 0.25</td></tr>
<tr><td>Tails + Tails</td><td>1/4 = 0.25</td></tr>
<tr><td>Heads + Tails</td><td>1/4 = 0.25</td></tr>
<tr><td>Tails + Heads</td><td>1/4 = 0.25</td></tr>
</table> 

<hr>
<h2>Throwing Dices</h2>
<img src="img_dice.jpg" alt="Dice" style="width:100px">
<img src="img_dice.jpg" alt="Dice" style="width:100px">
<img src="img_dice.jpg" alt="Dice" style="width:100px">

<p>When throwing a dice, there are 6 possible outcomes:</p>
<table class="ws-table-all" style="width:350px">
<tr><th>Event</th><th>P(A)</th></tr>
<tr><td>Lands on 1</td><td>1/6 = 0.166666</td></tr>
<tr><td>Lands on 2</td><td>1/6 = 0.166666</td></tr>
<tr><td>Lands on 3</td><td>1/6 = 0.166666</td></tr>
<tr><td>Lands on 4</td><td>1/6 = 0.166666</td></tr>
<tr><td>Lands on 5</td><td>1/6 = 0.166666</td></tr>
<tr><td>Lands on 6</td><td>1/6 = 0.166666</td></tr>
</table> 
<p>The possibility of throwing 3 fours at the same time is<br>
(1/6)<sup>3</sup> (Lands on 4 to the power of 3):<br>
<div class="w3-example">
<p>The possibility is:</p>
<div class="w3-code notranslate jsHigh">
let p = Math.pow(1/6, 3);<br>
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_math_possibility1">Try it Yourself &raquo;</a></p>
</div>
<p>The possibility of throwing 3 likes at the same time is 6 times larger:<br>
(lands on 1) + (Lands on 2) + ... + (Lands on 6)
<div class="w3-example">
<p>The possibility is:</p>
<div class="w3-code notranslate jsHigh">
let p = Math.pow(1/6, 3) * 6;<br>
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_math_possibility2">Try it Yourself &raquo;</a></p>
</div>
...
<ellipse
   ...
   cy="20"
   cx="20"
   style="fill:red;stroke:#000000;stroke-width:0.5;stroke-opacity:.5" />
<ellipse
   ry="15"
   rx="15"
   cy="20"
...
<ellipse
   ...
   cy="20"
   cx="80"
   style="fill:green;stroke:#000000;stroke-width:0.5;stroke-opacity:.5" />
<ellipse
   ry="15"
   rx="15"
   cy="20"
...
<ellipse
   ...
   cy="20"
   cx="120"
   style="fill:blue;stroke:#000000;stroke-width:0.5;stroke-opacity:.5" />
</g>
</svg>

<p>I have 6 balls in a bag: 3 reds, 2 are green, and 1 is blue.</p>
<p>Blindfolded. What is the probability that I pick a green one?</p>
<p>Number of <b>Ways</b> it can happen are 2 (there are 2 greens).</p>
<p>Number of <b>Outcomes</b> are 6 (there are 6 balls).</p>
<p><b>Probability = Ways / Outcomes</b></p>

<p>The probability that I pick a green one is 2 out of 6: 2/6 = 0.333333.</p>
<p>The probability is written P(green) = 0.333333.</p>
<table class="ws-table-all" style="width:350px">
<tr><th>P(A)</th><th>W/O</th><th>Probability</th></tr>
<tr><td>P(red)</td><td>3/6</td><td>0.5000000</td></tr>
<tr><td>P(green)</td><td>2/6</td><td>0.3333333</td></tr>
<tr><td>P(blue)</td><td>1/6</td><td>0.1666666</td></tr>
</table> 

<hr>
<h2>P(A) = P(B)</h2>
<table class="ws-table-all">
<tr><td>P(A) = P(B)</td><td>Event A and B have the same chance to occur</td></tr>
<tr><td>P(A) &gt; P(B)</td><td>Event A has a higher chance to occur</td></tr>
<tr><td>P(A) &lt; P(B)</td><td>Event A has a lower chance to occur</td></tr>
</table>
<p>For the 6 balls:</p>
<table class="ws-table-all">
<tr><td>P(red) &gt; P(green)</td><td>I am more likely to pick a red than a green</td></tr>
<tr><td>P(red) &gt; P(blue)</td><td>I am more likely to pick a red than a blue</td></tr>
<tr><td>P(green) &gt; P(blue)</td><td>I am more likely to pick a green than a blue</td></tr>
<tr><td>P(blue) &lt; P(green)</td><td>I am less likely to pick a blue than a green</td></tr>
<tr><td>P(blue) &lt; P(red)</td><td>I am less likely to pick a blue than a red</td></tr>
<tr><td>P(green) &lt; P(red)</td><td>I am less likely to pick a green than a red</td></tr>
</table>

<hr>
<h2>Choosing a King</h2>
<img src="img_king_card.jpg" alt="King" style="width:100px">

<p>The probability of choosing a king in a deck of cards is 4 in 52.</p>
<p>Number of <b>Ways</b> it can happen are 4 (there are 4 kings).</p>
<p>Number of <b>Outcomes</b> are 52 (there are 52 cards).</p>
<p><b>Probability = Ways / Outcomes</b></p>

<p>The probability is 4 out of 52: 4/52 = 0.076923.</p>
<p>The probability is written P(king) = 0.076923.</p>
