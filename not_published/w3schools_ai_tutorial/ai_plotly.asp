...
<a class="w3-left w3-btn" href="ai_canvas.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ai_chartjs.asp">Next &#10095;</a>
</div>

<div class="w3-panel ws-info">
<p><b>Plotly.js</b> is a charting library that
comes with over 40 chart types, 3D charts, statistical graphs, and SVG maps.</p>
</div>

<h2>Scatter Plots</h2>
<div id="myPlot21" style="width:100%;max-width:700px"></div>
<script>
...
Plotly.newPlot("myPlot21", data, layout);
</script>
<div class="w3-example">
<h3>Source Code</h3>
<div class="w3-code notranslate jsHigh">
const xArray = [50,60,70,80,90,100,110,120,130,140,150];<br>
const yArray = [7,8,8,9,9,9,10,11,14,14,15];<br><br>
// Define Data<br>
const data = [{<br>
&nbsp;&nbsp;x: xArray,<br>
&nbsp;&nbsp;y: yArray,<br>
...
// Define Layout<br>
const layout = {<br>
&nbsp;&nbsp;xaxis: {range: [40, 160], title: "Square Meters"},<br>
&nbsp;&nbsp;yaxis: {range: [5, 16], title: "Price in Millions"},<br>
&nbsp;&nbsp;title: "House Prices vs. Size"<br>
};<br><br>
Plotly.newPlot("myPlot", data, layout);
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_plotly_scatter">Try it Yourself &raquo;</a></p>
</div>
<hr>
<h2>Line Graphs</h2>

<div id="myPlot22" style="width:100%;max-width:700px"></div>
<script>
var xArray = [50,60,70,80,90,100,110,120,130,140,150];
var yArray = [7,8,8,9,9,9,10,11,14,14,15];
var data = [{x:xArray, y:yArray, mode:"lines", type:"scatter"}];
var layout = {
xaxis: {range: [40, 160], title: "Square Meters"},
yaxis: {range: [5, 16], title: "Price in Millions"},
title: "House Prices vs Size"
};
Plotly.newPlot("myPlot22", data, layout);
</script>
<div class="w3-example">
<h3>Source Code</h3>
<div class="w3-code notranslate jsHigh">
const xArray = [50,60,70,80,90,100,110,120,130,140,150];<br>
const yArray = [7,8,8,9,9,9,10,11,14,14,15];<br>
<br>
// Define Data<br>
const data = [{<br>
&nbsp;&nbsp;x: xArray,<br>
...
// Display using Plotly<br>
Plotly.newPlot("myPlot", data, layout);
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_plotly_lines">Try it Yourself &raquo;</a></p>
</div>
<hr>
...
<hr>
<h2>Linear Graphs</h2>
<div id="myPlot13" style="width:100%;max-width:700px"></div>
<script>
var exp = "x + 17";
// Generate values
var xValues = [];
...
Plotly.newPlot("myPlot13", data, layout);
</script>
...
const xValues = [];<br>
const yValues = [];<br>
for (let x = 0; x &lt;= 10; x += 1) {<br>
&nbsp;&nbsp;yValues.push(eval(exp));<br>
&nbsp;&nbsp;xValues.push(x);<br>
}<br>
<br>
// Define Data<br>
...
<br>
// Define Layout<br>
const layout = {title: "y = " + exp};<br>
<br>
// Display using Plotly<br>
Plotly.newPlot("myPlot", data, layout);
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_plotly_function_linear">Try it Yourself &raquo;</a></p>
</div>
...
<div id="myPlot14" style="width:100%;max-width:700px"></div>
...
// Display using Plotly
Plotly.newPlot("myPlot14", data, layout);
</script>
...
&nbsp;&nbsp;x2Values.push(x);<br>
&nbsp;&nbsp;x3Values.push(x);<br>
&nbsp;&nbsp;y1Values.push(eval(exp1));<br>
&nbsp;&nbsp;y2Values.push(eval(exp2));<br>
&nbsp;&nbsp;y3Values.push(eval(exp3));<br>
}<br>
<br>
// Define Data<br>
const data = [<br>
&nbsp;&nbsp;{x: x1Values, y: y1Values, mode:"lines"},<br>
&nbsp;&nbsp;{x: x2Values, y: y2Values, mode:"lines"},<br>
&nbsp;&nbsp;{x: x3Values, y: y3Values, mode:"lines"}<br>
];<br>
<br>
// Define Layout<br>
const layout = {title: "[y=" + exp1 + "]  [y=" + exp2 + "]  [y=" + exp3 + "]"};<br>
<br>
// Display using Plotly<br>
Plotly.newPlot("myPlot", data, layout);
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_plotly_function_linear_multiple">Try it Yourself &raquo;</a></p>
</div>


<hr>
<h2>Bar Charts</h2>
<div id="myPlot23" style="width:100%;max-width:700px"></div>
<script>
var xArray = ["Italy","France","Spain","USA","Argentina"];
var yArray = [55, 49, 44, 24, 15];
var data = [{x:xArray, y:yArray, type:"bar"}];
var layout = {title:"World Wide Wine Production"};
Plotly.newPlot("myPlot23", data, layout);
</script>

<div class="w3-example">
<h3>Source Code</h3>
<div class="w3-code notranslate jsHigh">
const xArray = ["Italy","France","Spain","USA","Argentina"];<br>
const yArray = [55, 49, 44, 24, 15];<br><br>
const data = [{<br>
&nbsp;&nbsp;x: xArray,<br>
&nbsp;&nbsp;y: yArray,<br>
&nbsp;&nbsp;type: "bar"&nbsp;
}];<br>
const layout = {title:"World Wide Wine Production"};<br><br>
Plotly.newPlot("myPlot", data, layout);
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_plotly_bars">Try it Yourself &raquo;</a></p>
</div>

<hr>
<h2>Horizontal Bar Charts</h2>
<div id="myPlot26" style="width:100%;max-width:700px"></div>
<script>
var xArray = [55, 49, 44, 24, 15];
var yArray = ["Italy ","France ","Spain ","USA ","Argentina "];
var data = [{x:xArray, y:yArray, type:"bar", orientation:"h", marker: {color: 'rgba(255,0,0,0.6)'}}];
var layout = {title:"World Wide Wine Production"};
Plotly.newPlot("myPlot26", data, layout);
</script>

<div class="w3-example">
<h3>Source Code</h3>
<div class="w3-code notranslate jsHigh">
const xArray = [55, 49, 44, 24, 15];<br>
const yArray = ["Italy","France","Spain","USA","Argentina"];<br>
<br>
const data = [{<br>
&nbsp;&nbsp;x: xArray,<br>
&nbsp;&nbsp;y: yArray,<br>
...
<br>
const layout = {title:"World Wide Wine Production"};<br>
<br>
Plotly.newPlot("myPlot", data, layout);
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_plotly_bars_horizontal">Try it Yourself &raquo;</a></p>
</div>

<hr>
<h2>Pie Charts</h2>
<div id="myPlot24" style="width:100%;max-width:700px"></div>
<script>
var xArray = ["Italy","France","Spain","USA","Argentina"];
var yArray = [55, 49, 44, 24, 15];
...
<p>To display a pie instead of bars, change x and y to labels and values, and change the type to "pie":</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const data = [{<br>
&nbsp;&nbsp;labels: xArray,<br>
...
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_plotly_pie">Try it Yourself &raquo;</a></p>
</div>

<hr>
<h2>Donut Charts</h2>
<div id="myPlot25" style="width:100%;max-width:700px"></div>
<script>
var xArray = ["Italy","France","Spain","USA","Argentina"];
var yArray = [55, 49, 44, 24, 15];
var data = [{labels:xArray, values:yArray, hole:.4, type:"pie"}];
var layout = {title:"World Wide Wine Production"};
Plotly.newPlot("myPlot25", data, layout);
</script>
<p>To display a donut instead of a pie, add a hole:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const data = [{<br>
&nbsp;&nbsp;labels: xArray,<br>
...
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_plotly_donut">Try it Yourself &raquo;</a></p>
</div>
...
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_plotly_function">Try it Yourself &raquo;</a></p>

<div class="w3-example">
<h3>Source Code</h3>
<div class="w3-code notranslate jsHigh">
let exp = "Math.sin(x)";<br>
<br>
// Generate values<br>
const xValues = [];<br>
const yValues = [];<br>
for (let x = 0; x &lt;= 10; x += 0.1) {<br>
&nbsp;&nbsp;yValues.push(eval(exp));<br>
&nbsp;&nbsp;xValues.push(x);<br>
}<br>
<br>
// Display using Plotly<br>
const data = [{x:xValues, y:yValues, mode:"lines"}];<br>
const layout = {title: "y = " + exp};<br>
Plotly.newPlot("myPlot", data, layout);
</div>
</div>
...
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_plotly_function_scatter">Try it Yourself &raquo;</a></p>
