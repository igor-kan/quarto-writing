...
<a class="w3-right w3-btn" href="ai_tensorflow_intro.asp">Next &#10095;</a>
</div>
...
<p>Building a neural network with Brain.js:</p>

<div class="w3-example">
<h3>Example:</h3>
<div class="w3-code notranslate jsHigh">
// Create a Neural Network<br>const network = new brain.NeuralNetwork();<br><br>
// Train the Network with 4 input objects<br>
network.train([<br>
 &nbsp;{input:[0,0], output:{zero:1}},<br>
 &nbsp;{input:[0,1], output:{one:1}},<br>
 &nbsp;{input:[1,0], output:{one:1},<br>
 &nbsp;{input:[1,1], output:{zero:1},<br>
]);<br><br>
// What is the expected output of [1,0]?<br>
result = network.run([1,0]);<br><br>
// Display the probability for "zero" and "one"<br>
... result["one"] + " " + result["zero"];
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryai_brain_xor" target="_blank">Try it Yourself &raquo;</a>
</div>
<h3>Example Explained:</h3>
<p>A Neural Network is created with: <code class="w3-codespan">new brain.NeuralNetwork()</code></p>
<p>The network is trained with <code class="w3-codespan">network.train([examples])</code></p>
<p>The examples represent 4 input values with a corresponding output value.</p>
<p>With <code class="w3-codespan">network.run([1,0])</code>, you ask "What is the likely output of [1,0]?"</p>
<p>The answer from the network is:</p>
<ul>
<li>one: 93% (close to 1)</li>
<li>zero: 6% (close to 0)</li>
</ul>
...
<h2>How to Predict a Contrast</h2>
<p>With CSS, colors can be set by RGB:</p>
<div class="w3-example">
 <h3>Example</h3>
...
<table class="ws-table-all notranslate">
 ...
 <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryai_colornames" target="_blank">Try it Yourself &raquo;</a>
</div>

<p>The example below demonstrates how to predict the darkness of a color:</p>

<div class="w3-example">
<h3>Example:</h3>
<div class="w3-code notranslate jsHigh">
// Create a Neural Network<br>
const net = new brain.NeuralNetwork();<br><br>
// Train the Network with 4 input objects<br>
net.train([<br>// White RGB(255, 255, 255)<br>
{input:[255/255, 255/255, 255/255], output:{light:1}},<br>
// Light grey (192,192,192)<br>
{input:[192/255, 192/255, 192/255], output:{light:1}},<br>
// Darkgrey (64, 64, 64)<br>
{ input:[65/255, 65/255, 65/255], output:{dark:1}},<br>
// Black (0, 0, 0)<br>{ input:[0, 0, 0], output:{dark:1}},<br>
]);<br><br>
// What is the expected output of Dark Blue (0, 0, 128)?<br>
let result = net.run([0, 0, 128/255]);<br><br>
// Display the probability of "dark" and "light"<br>
... result["dark"] + " " + result["light"];
</div>
  <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryai_brain_contrast" target="_blank">Try it Yourself &raquo;</a>
</div>
<h3>Example Explained:</h3>
<p>A Neural Network is created with: <code class="w3-codespan">new brain.NeuralNetwork()</code></p>
<p>The network is trained with <code class="w3-codespan">network.train([examples])</code></p>
<p>The examples represent 4 input values a corresponding output value.</p>
<p>With <code class="w3-codespan">network.run([0,0,128/255])</code>, you ask "What is the likely output of dark blue?"</p>
<p>The answer from the network is:
<ul>
<li>Dark: 95%</li>
<li>Light: 4% </li>
</ul>
<p>Why not edit the example to test the likely output of yellow or red?</p>
