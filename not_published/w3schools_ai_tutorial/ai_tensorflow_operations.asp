...
<html lang="en-US">
<head>
<title>TensorFlow Operations</title>
<meta charset="utf-8">
...
<h1>TensorFlow Operations</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="ai_tensorflow_intro.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ai_tensorflow_model.asp">Next &#10095;</a>
</div>
...
<h2>Tensor Addition</h2>
<p>You can add two tensors using <span class="w3-codespan">tensorA.add(tensorB)</span>:</p>
...
<br> 
// Tensor Addition<br>
const tensorNew = tensorA.add(tensorB);<br>
<br>
...
<hr>
<h2>Tensor Subtraction</h2>
<p>You can subtract two tensors using <span class="w3-codespan">tensorA.sub(tensorB)</span>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const tensorA = tf.tensor([[1, 2], [3, 4], [5, 6]]);<br>
...
const tensorNew = tensorA.sub(tensorB);<br>
<br>
...
<p>You can multiply two tensors using <span class="w3-codespan">tensorA.mul(tensorB)</span>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const tensorA = tf.tensor([1, 2, 3, 4]);<br>
const tensorB = tf.tensor([4, 4, 2, 2]);<br>
<br> 
// Tensor Multiplication<br>
const tensorNew = tensorA.mul(tensorB);<br>
<br>
// Result: [ 4, 8, 6, 8 ]<br>
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_tensor_multiply">Try it Yourself &raquo;</a></p>
</div>

<hr>
<h2>Tensor Division</h2>
<p>You can divide two tensors using <span class="w3-codespan">tensorA.div(tensorB)</span>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const tensorA = tf.tensor([2, 4, 6, 8]);<br>
const tensorB = tf.tensor([1, 2, 2, 2]);<br>
<br> 
// Tensor Division<br>
const tensorNew = tensorA.div(tensorB);<br>
<br>
// Result: [ 2, 2, 3, 4 ]<br>
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_tensor_divide">Try it Yourself &raquo;</a></p>
</div>

<hr>
<h2>Tensor Square</h2>
<p>You can square a tensor using <span class="w3-codespan">tensor.square()</span>:</p>
...
<br> 
// Tensor Square<br>
const tensorNew = tensorA.square();<br>
<br>
// Result [ 1, 4, 9, 16 ]<br>
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_tensor_square">Try it Yourself &raquo;</a></p>
</div>

<hr>
<h2>Tensor Reshape</h2>
<p>The number of elements in a tensor is the product of the sizes in the shape.</p>
<p>Since there can be different shapes with the same size,
it is often useful to reshape a tensor to other shapes with the same size.</p>
<p>You can reshape a tensor using <span class="w3-codespan">tensor.reshape()</span>:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const tensorA = tf.tensor([[1, 2], [3, 4]]);<br>
const tensorB = tensorA.reshape([4, 1]);<br>
<br>
// Result: [ [1], [2], [3], [4] ]
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_tensor_reshape">Try it Yourself &raquo;</a></p>
</div>
