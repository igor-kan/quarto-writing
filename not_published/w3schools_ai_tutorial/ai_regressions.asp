...
<a class="w3-left w3-btn" href="ai_clustering.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ai_neural_networks.asp">Next &#10095;</a>
</div>

<div class="w3-panel ws-info">
<p>A <b>Regression</b> is a method to determine the relationship between one variable (<b>y</b>)
and other variables (<b>x</b>).</p>
<p>In statistics, a <b>Linear Regression</b> is an approach to modeling a linear relationship
between y and x.</p>
<p>In Machine Learning, a Linear Regression is a supervised machine learning algorithm.</p>
</div>

<h2>Scatter Plot</h2>
<p>This is the <b>scatter plot</b> (from the previous chapter):</p>
<div id="myPlot1" style="width:100%;max-width:600px"></div>

<script>
var xArray = [50,60,70,80,90,100,110,120,130,140,150];
var yArray = [7,8,8,9,9,9,10,11,14,14,15];

var data = [{x:xArray, y:yArray, mode:"markers"}];
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryai_plotly_scatter">
  Try it Yourself »</a>
</div>

<hr>
<h2>Predicting Values</h2>
<p>From the scattered data above, how can we predict future prices?</p>
<ul>
<li>Use hand drawn linear graph</li>
<li>Model a linear relationship</li>
<li>Model a linear regression</li>
</ul>
<hr>
...
<h2>Linear Graphs</h2>
<p>This is a linear graph predicting prices based on the lowest and the highest price:</p>
<div id="myPlot2" style="width:100%;max-width:600px"></div>
...
<div class="w3-code notranslate jsHigh">
const xArray = [50,60,70,80,90,100,110,120,130,140,150];<br>
const yArray = [7,8,8,9,9,9,9,10,11,14,14,15];<br><br>
const data = [<br>
&nbsp;&nbsp;{x:xArray, y:yArray, mode:"markers"},<br>
&nbsp;&nbsp;{x:[50,150], y:[7,15], mode:"line"}<br>
];<br><br>
const layout = {<br>
&nbsp;&nbsp;xaxis: {range: [40, 160], title: "Square Meters"},<br>
&nbsp;&nbsp;yaxis: {range: [5, 16], title: "Price in Millions"},<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryai_plotly_regression1">
  Try it Yourself »</a>
</div>

<div class="ws-info">
<h2>From a Previous Chapter</h2>
<p>A linear graph can be written as <b>y = ax + b</b></p>
<p>Where:</p>
<ul>
<li><b>y</b> is the price we want to predict</li>
...
<p>This <b>Model</b> predicts prices using a linear relationship between price and size:</p>
...
<br>
// Calculate Slope<br>
let xSum = xArray.reduce(function(a, b){return a + b;}, 0);<br>
let ySum = yArray.reduce(function(a, b){return a + b;}, 0);<br>
let slope = ySum / xSum;<br>
<br>
// Generate values<br>
const xValues = [];<br>
const yValues = [];<br>
for (let x = 50; x &lt;= 150; x += 1) {<br>
&nbsp;&nbsp;xValues.push(x);<br>
&nbsp;&nbsp;yValues.push(x * slope);<br>
}<br>

</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryai_plotly_regression2">Try it Yourself &raquo;</a>
</div>
<p>In the example above, the slope is a calculated average and the intercept = 0.</p>

<hr>
<h2>Using a Linear Regression Function</h2>
<p>This <b>Model</b> predicts prices using a linear regression function:</p>
...
<br>
// Calculate Sums<br>
let xSum=0, ySum=0 , xxSum=0, xySum=0;<br>
let count = xArray.length;<br>
for (let i = 0, len = count; i &lt; count; i++) {<br>
&nbsp;&nbsp;xSum += xArray[i];<br>
&nbsp;&nbsp;ySum += yArray[i];<br>
&nbsp;&nbsp;xxSum += xArray[i] * xArray[i];<br>
&nbsp;&nbsp;xySum += xArray[i] * yArray[i];<br>
}<br>
<br>
// Calculate slope and intercept<br>
let slope = (count * xySum - xSum * ySum) / (count * xxSum - xSum * xSum);<br>
let intercept = (ySum / count) - (slope * xSum) / count;<br>
<br>
// Generate values<br>
const xValues = [];<br>
const yValues = [];<br>
for (let x = 50; x &lt;= 150; x += 1) {<br>
&nbsp;&nbsp;xValues.push(x);<br>
&nbsp;&nbsp;yValues.push(x * slope + intercept);<br>
}
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryai_plotly_regression3">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Polynomial Regression</h2>
<p>If scattered data points do not fit a linear regression (a straight line through the points),
the data may fit an polynomial regression.</p>
<p>A Polynomial Regression, like linear regression,
uses the relationship between the variables x and y to find the best way to draw a line through the data points.
<img alt="Polynormal Regression" src="img_polynomial_regression.png" style="width:100%;max-width:640px">
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="ai_clustering.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ai_neural_networks.asp">Next &#10095;</a>
