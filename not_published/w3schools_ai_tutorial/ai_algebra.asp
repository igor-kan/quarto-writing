...
<a class="w3-left w3-btn" href="ai_linear.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ai_vectors.asp">Next &#10095;</a>
</div>

<div class="w3-panel ws-info">
<p><b>Machine Learning</b> experts cannot live without <b>Linear Algebra</b>:</p>
<ul>
<li>ML make heavy use of <b>Scalars</b></li>
<li>ML make heavy use of <b>Vectors</b></li>
<li>ML make heavy use of <b>Matrices</b></li>
<li>ML make heavy use of <b>Tensors</b></li>
</ul>
<p>The purpose of this chapter is to highlight the parts of linear algebra that is used in data science projects
like machine learning and deep learning.</p>
</div>
...
<p><b>Vectors</b> and <b>Matrices</b> are the languages of data.</p>
<p>With ML, most things are done with vectors and matrices.</p>
<p>With vectors and matrices, you can <b>Discover Secrets</b>.</p> 

<hr>
<h2>Scalars</h2>
<p>In linear algebra, a scalar is a <b>single number</b>.</p>
<p>In JavaScript it can be written like a constant or a variable:</p>
...
<hr>
<h2>Vectors</h2>
<p>In linear algebra, a vector is an <b>array of numbers</b>.</p>
<p>In JavaScript, it can be written as an array:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const myArray = [50,60,70,80,90,100,110,120,130,140,150];<br>
myArray.length;&nbsp;&nbsp; // the length of myArray is 11
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryai_array" target="_blank">Try it Yourself &raquo;</a>
</div>

<p>An array can have multiple dimensions, but a vector is a <b>1-dimensional array</b>.</p>
<p>A vector can be written in many ways. The most common are:</p>
...
<table>
<tr>
<td width="100px"><img alt="Vector" src="img_vector.jpg"></td>
<td>
<p>The image to the left is a <b>Vector</b>.</p>
<p>The <b>Length</b> shows the <b>Magnitude</b>.</p>
<p>The <b>Arrow</b> shows the <b>Direction</b>.</p>
</td>
</tr>
</table>

<p><a href="ai_vectors.asp">Learn More ...</a></p>
...
<p>In linear algebra, a matrix is a <b>2-dimensional array</b>.</p>
...
<p>In JavaScript, a matrix is typically represented as a two-dimensional (2D) array,
meaning an array of arrays. Each inner array represents a row, and each element within
those arrays represents a column.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const myArray = [[1,2],[3,4],[5,6]];
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryai_array_dimension" target="_blank">Try it Yourself &raquo;</a>
</div>
<p><a href="ai_matrices.asp">Learn More ...</a></p>
<hr>

<h2>Tensors</h2>
<p>A Tensor is an <b>N-dimensional Matrix</b>.</p>
<table class="w3-large">
<tr>
<td>T =&nbsp;&nbsp;&nbsp;</td>
<td>
...
<p>In JavaScript, a tensor is an array with multiple indices (indexes).</p>
<p><a href="ai_tensors.asp">Learn More ...</a></p>

<div class="w3-panel ws-info w3-leftbar w3-sand">
<i>
<p class="w3-large w3-serif"><b>Linear Algebra</b> is the branch of mathematics that 
concerns <b>linear equations</b>
(and linear maps) and their representations in <b>vector spaces</b> and through <b>matrices</b>.</p>
<p class="w3-large w3-serif">Linear algebra is central to almost all areas of mathematics.</p>
</i>
<p>Wikipedia</p>
</div>
