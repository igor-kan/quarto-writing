...
.darktheme .matrix:before,.darktheme .matrix:after {
    border-color:#fff;
}
...
<a class="w3-left w3-btn" href="ai_vectors.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ai_tensors.asp">Next &#10095;</a>
</div>

<div class="w3-panel ws-info">
<p>A matrix is set of <b>Numbers</b>.</p>
<p>A matrix is an <b>Rectangular Array</b>.</p>
<p>A matrix is arranged in <b>Rows</b> and <b>Columns</b>.</p>
</div>

<h2>Matrix Dimensions</h2>

<p>This <b>Matrix</b> has <b>1</b> row and <b>3</b> columns:</p>
...
<p>The <b>Dimension</b> of the matrix is (<b>1</b>x<b>3</b>).</p>
<hr>
<p>This matrix has <b>2</b> rows and <b>3</b> columns:</p>
<table class="w3-large">
<tr>
<td>C =&nbsp;&nbsp;</td>
<td>
...
<p>The dimension of the matrix is (<b>2</b>x<b>3</b>).</p>

<hr>
<h2>Square Matrices</h2>
<p>A <b>Square Matrix</b> is a matrix with the same number of rows and columns.</p>
<p>An n-by-n matrix is known as a square matrix of order n.</p>
<p>A <b>2-by-2</b> matrix (Square matrix of order 2):</p>
<table class="w3-large">
<tr>
<td>C =&nbsp;&nbsp;</td>
<td>
...
<br>
<p>A <b>4-by-4</b> matrix (Square matrix of order 4):</p>
<table class="w3-large">
<tr>
<td>C =&nbsp;&nbsp;</td>
<td>
...
<p>A <b>Diagonal Matrix</b> has values on the diagonal entries, and <b>zero</b> on the rest:
<table class="w3-large">
<tr>
<td>C =&nbsp;&nbsp;&nbsp;</td>
<td>
...
<hr>
<h2>Scalar Matrices</h2>
<p>A <b>Scalar Matrix</b> has equal diagonal entries and <b>zero</b> on the rest:
<table class="w3-large">
<tr>
<td>C =&nbsp;&nbsp;&nbsp;</td>
<td>
...
<p>The <b>Identity Matrix</b> has <b>1</b> on the diagonal and <b>0</b> on the rest.</p>
<p>This is the matrix equivalent of 1. The symbol is <b>I</b>.</p>
...
<p>If you multiply any matrix with the identity matrix, the result equals the original.</p>

<hr>
<h2>The Zero Matrix</h2>
<p>The <b>Zero Matrix</b> (Null Matrix) has only zeros.</p>
...
<hr>
<h2>Equal Matrices</h2>
<p>Matrices are <b>Equal</b> if each element correspond:</p>
<table class="w3-large">
<tr>
<td>
<table class="matrix">
...
<hr>
<h2>Negative Matrices</h2>
<p>The <b>Negative</b> of a matrix is easy to understand:</p>
<table class="w3-large">
<tr>
<td>&nbsp;&nbsp;-&nbsp;&nbsp;</td>
<td>
...
<hr>
<h2>Linear Algebra in JavaScript</h2>

<p>In linear algebra, the most simple math object is the <b>Scalar</b>:</p>
...
<p>Another simple math object is the <b>Array</b>:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const array = [ 1, 2, 3 ];
</div>
...
<p>Matrices are <b>2-dimensional Arrays</b>:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
...
<p>Vectors can be written as <b>Matrices</b> with only one column:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const vector = [ [1],[2],[3] ];
</div>
...
<p>Vectors can also be written as <b>Arrays</b>:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const vector = [ 1, 2, 3 ];
</div>
...
<hr>
<h2>JavaScript Matrix Operations</h2>
<p>Programming matrix operations in JavaScript, can easily become a spaghetti of loops.</p>
<p>Using a JavaScript library will save you a lot of headache.</p>
<p>One of the most common libraries to use for matrix operations is called <b>math.js</b>.</p> 
<p>It can be added to your web page with one line of code:</p>
<div class="w3-example">
<h3>Using math.js</h3>
...
<p>If two matrices have the same dimension, we can add them:</p>
<table class="w3-large">
<tr><td>
<table class="matrix">
<tr>
...
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const mA = math.matrix([[1, 2], [3, 4], [5, 6]]);<br>
const mB = math.matrix([[1,-1], [2,-2], [3,-3]]);<br>
<br> 
// Matrix Addition<br>
const matrixAdd = math.add(mA, mB);<br>
<br>
// Result [ [2, 1], [5, 2], [8, 3] ]<br>
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_matrix_add">Try it Yourself &raquo;</a></p>
</div>

<hr>
<h2>Subtracting Matrices</h2>
<p>If two matrices have the same dimension, we can subtract them:</p>
<table class="w3-large">
<tr><td>
<table class="matrix">
<tr>
...
const matrixSub = math.subtract(mA, mB);<br>
<br>
// Result [ [0, 3], [1, 6], [2, 9] ]<br>
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_matrix_sub">Try it Yourself &raquo;</a></p>
</div>

<div class="ws-note">
<p>To add or subtract matrices, they must have the same dimension.</p>
</div>

<hr>
<h2>Scalar Multiplication</h2>

<p>While numbers in rows and columns are called <b>Matrices</b>, single numbers are called <b>Scalars</b>.</p>
<p>It is easy to multiply a matrix with a scalar. Just multiply each number in the matrix with the scalar:</p>
...
const matrixMult = math.multiply(2, mA);<br>
<br>
// Result [ [2, 4], [6, 8], [10, 12] ]<br>
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_matrix_mult_scalar">Try it Yourself &raquo;</a></p>
</div>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const mA = math.matrix([[0, 2], [4, 6], [8, 10]]);<br>
<br> 
// Matrix Division<br>
const matrixDiv = math.divide(mA, 2);<br>
<br>
// Result [ [0, 1], [2, 3], [4, 5] ]<br>
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_matrix_div_scalar">Try it Yourself &raquo;</a></p>
</div>
<hr>
<h2>Transpose a Matrix</h2>
<p>To transpose a matrix, means to replace rows with columns.</p>
<p>When you swap rows and columns, you rotate the matrix around it's diagonal.</p>
...
<p>Multiplying matrices is more difficult.</p>
<p>We can only multiply two matrices if the number of <b>colums</b> in matrix A is the same as the number of <b>rows</b> in matrix B.</p>
<p>Then, we need to compile a "dot product":</p>

<p>We need to multiply the numbers in each <b>column of A</b> with the numbers in each <b>row of B</b>, and then add the products:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const mA = math.matrix([1, 2, 3]);<br>
const mB = math.matrix([[1, 4, 7], [2, 5, 8], [3, 6, 9]]);<br>
<br> 
// Matrix Multiplication<br>
const matrixMult = math.multiply(mA, mB);<br>
<br>
// Result [14, 32, 50]<br>
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_matrix_mult">Try it Yourself &raquo;</a></p>
</div>
<h3>Explained:</h3>
<table class="w3-large">
<tr>
...
<table>
<tr>
  <td>(1,2,3) * (1,2,3) = 1x1 + 2x2 + 3x3 = </td><td>14</td>
</tr>
<tr>
  <td>(1,2,3) * (4,5,6) = 1x4 + 2x5 + 3x6 = </td><td>32</td>
</tr>
<tr>
  <td>(1,2,3) * (7,8,9) = 1x7 + 2x8 + 3x9 = </td><td>50</td>
</tr>
</table>

<p>If you know how to multiply matrices, you can solve many complex equations.</p>
<div class="ws-info">
<h2>Example</h2>
<p>You sell roses.</p>
<ul>
<li>Red roses are $3 each</li>
<li>White roses are $4 each</li>
<li>Yellow roses are $2 each</li>
</ul>
<ul>
<li>Monday you sold 260 roses</li>
<li>Tuesday you sold 200 roses</li>
<li>Wednesday you sold 120 roses</li>
</ul>
<p>What was the value of all the sales?</p>
</div>

<table class="ws-table-all">
<tr xclass="w3-large">
<td></td>
<td valign="bottom"><img alt="Red Rose" width="50px" src="icon_roses.jpg">$3</td>
<td><img alt="White" width="50px" src="icon_white_roses.jpg">$4</td>
<td><img alt="Yellow" width="50px" src="icon_rose_yellow.jpg">$2</td>
</tr>
<tr><td>Mon</td><td>120</td><td>80</td><td>60</td></tr>
<tr><td>Tue</td><td>90</td><td>70</td><td>40</td></tr>
<tr><td>Wed</td><td>60</td><td>40</td><td>20</td></tr>
</table>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const mA = math.matrix([3, 4, 2]);<br>
const mB = math.matrix([[120, 90, 60], [80, 70, 40], [60, 40, 20]);<br>
<br> 
// Matrix Multiplication<br>
const matrixMult = math.multiply(mA, mB);<br>
<br>
// Result [800, 630, 380]<br>
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_matrix_mult_ex">Try it Yourself &raquo;</a></p>
</div>
...
<table>
<tr>
  <td>(3,4,2) * (120,80,60)</td><td> = 3x120 + 4x80 + 2x60</td><td> = 800</td>
</tr>
<tr>
  <td>(3,4,2) * (90,70,40)</td><td> = 3x90 + 4x70 + 2x40</td><td> = 630</td>
</tr>
<tr>
  <td>(3,4,2) * (60,40,20)</td><td> = 3x60 + 4x40 + 2x20</td><td> = 380</td>
</tr>
</table>

<hr>
<h2>Matrix Factorization</h2>
<p>With AI, you need to know how to factorize a matrix.</p>
<p>Matrix factorization is a key tool in linear algebra, especially in Linear Least Squares.</p>
