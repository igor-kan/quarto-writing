...
<a class="w3-left w3-btn" href="ai_job_replacement.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ai_mathematics.asp">Next &#10095;</a>
</div>
...
<h2>What is Mind?</h2>
<p>There is <b>no</b> proven definition of <b>Mind</b>.</p>
<p>Mind can be defined as an instantiation of intelligence.</p>
<p>Mind can be defined as a collection of knowledge.</p>
<p>Is thinking, feeling, and meaning mind or know-how?</p>
<p>Is the Mind just a big computer?</p>

<hr>
<h2>Cognitive Science</h2>
<p>Cognitive science is the study of <b>mind processes</b>.</p>
<p>A cognitive scientist studies intelligence and behavior.</p> 
<p>Cognitive science focus on how brain cells process and transform information.</p>
<p>Cognitive Science also tries to learn how to develop intelligent computer algorithms.</p>

<a title="Hexagon_with_diagonals.svg: Charles Lowe
Human.svg: created by NASA
Phi.svg: jossi
Psi2.svg: Gdh
Lobes_of_the_brain_NL.svg: Mysid
Robot_icon.svg: Bilboq
Syntax_tree.svg: Aaron Rotenberg
derivative work: Charles Lowe, CC BY-SA 3.0 &lt;https://creativecommons.org/licenses/by-sa/3.0&gt;, via Wikimedia Commons"
target="_blank" href="https://commons.wikimedia.org/wiki/File:Cognitive_Science_Hexagon.svg">
<img style="width:100%;max-width:400px" alt="Cognitive Sciences" src="img_cognitive_sciences.png"></a>

<hr>
<h2>The Mental Model</h2>
<p>A mental model is an internal picture of the external reality.</p>
<p>Scientists expects that a model plays a major role in reasoning and decision-making (cognition).</p>
<p>Kenneth Craik suggested in 1943 that the mind constructs "small-scale models" of reality when trying to anticipate events.</p>
<div class="w3-panel w3-center w3-leftbar w3-sand">
<p><i class="w3-serif w3-large">
<span style="font-size:100px;line-height:0.6em;opacity:0.2">✔</span>
The image of the world around us, which we carry in our head, is just a model.<br>
Nobody in his head imagines all the world, government or country.
He has only selected concepts, and relationships between them, and uses those to represent the real system.</i><br>
Jay Wright Forrester, 1971.</p>
</div>
...
<hr>
<h2>Can AI Be Human?</h2>
<p>Scientists are trying to discover what separates human intelligence from artificial intelligence.</p>
<p>What is the status? What is the future?</p> 

<ul>
<li>Year 2000: <b>Reactive Machines</b></li>
<li>Year 2015: <b>Machine Learning</b></li>
<li>Year 2030: <b>Theory of Mind</b></li>
<li>Year 2050: <b>Self-Awareness</b></li>
</ul>

<hr>
<h2>Reactive Machines</h2>
<img style="width:100%;max-width:300px" alt="Chess" src="img_chess.jpg">

<p>Early AI systems were reactive. Reactive systems cannot use past experience.</p>
<p>In 1997 a reactive machine ("IBM Deep Blue") beat the world champion in chess.</p>
<p>"Deep Blue" could not think. But it was stored with information about the chess board,
and the rules for moving chess pieces.</p>
<p>"Deep Blue" won because it was programmed to calculate every move to win.</p>

<hr>
<h2>Machine Learning</h2>
<p>Today, AI systems can use some information from the past.</p>
<p>One example is self-driven cars. They can combine pre-programmed information with
information they collect while they learn how to drive.</p>

<hr>
<h2>Theory of Mind</h2>
<p><b>Theory of Mind</b> is a term from psychology about an individual's capacity for empathy
and understanding of others.</p>
<p>This is an awareness of others being like yourself, with individual needs and intentions.</p>

<p>One of the abilities language users have, is to communicate about things 
that are not concrete, like needs, ideas, or concepts.</p>


<p><a href="https://en.wikipedia.org/wiki/Simon_Baron-Cohen" target="_blank">Simon Baron-Cohen</a>,
British psychologist and professor at the University of Cambridge,
argues (1999) that "Theory of Mind" must have preceded languages,
based on knowledge about early human activities:</p>
<ul>
<li>Teaching</li>
<li>Building Shared Goals</li>
<li>Building Shared Plans</li>
<li>Intentional Communication</li>
<li>Intentional Sharing of Topic</li>
<li>Intentional Sharing of Focus</li>
<li>Intentional Persuasion</li>
<li>Intentional Pretending</li>
<li>Intentional Deception</li>
</ul>

<hr>
<h2>Self-Awareness</h2>
<p>In psychology, "Theory of Mind" means that people have thoughts, feelings and emotions
that affect their behavior.</p>
<p>Future AI systems must learn to understand that everyone (both people and AI objects)
have thoughts and feelings.</p>
<p>Future AI systems must know how to adjust their behavior to be able to walk among us.</p>

<p>The last step, before AI can be human, is machine consciousness.</p>
<p>We can not construct this software before we know much more about the human brain,
