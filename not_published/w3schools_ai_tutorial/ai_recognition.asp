...
<a class="w3-left w3-btn" href="ai_perceptrons.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ai_training.asp">Next &#10095;</a>
</div>

<div class="w3-panel ws-info">
<p><b>Neural Networks</b> are used in applications like Facial Recognition.</p>
<p>These applications use <b>Pattern Recognition</b>.</p>
<p>This type of <b>Classification</b> can be done with a <b>Perceptron</b>.</p>
<p>Perceptrons can be used to classify data into two parts.</p>
<p>Perceptrons are also known as a <b>Linear Binary Classifiers</b>.</p>
</div>

<h2>Pattern Classification</h2>
<p>Imagine a strait line (a linear graph) in a space with scattered x y points.</p>
<p>How can you classify the points over and under the line?</p>
...
<p>A perceptron can be trained to recognize the points over the line,
without knowing the formula for the line.</p>
<p><img alt="Perceptron" src="img_perceptron_bias.jpg" style="width:100%;max-width:500px"></p>
<hr>
...
<h2>How to Program a Perceptron</h2>
<p>To program a perceptron, we can use a simple JavaScript program that will:</p>
<ol>
<li>Create a simple plotter</li>
<li>Create 500 random x y points</li>
<li>Display the x y points</li>
<li>Create a line function: f(x)</li>
<li>Display the line</li>
<li>Compute the desired answers</li>
<li>Display the desired answers</li>
</ol>

<hr>
<h2>Create a Simple Plotter</h2>
<p>Creating a simple plotter object is described in the <a href="ai_canvas.asp">AI Canvas Chapter</a>.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const plotter = new XYPlotter("myCanvas");<br>
plotter.transformXY();<br><br>
...
<hr>
<h2>Create Random X Y Points</h2>
<p>Create as many xy points as wanted.</p>
<p>Let the x values be random (between 0 and maximum).</p>
<p>Let the y values be random (between 0 and maximum).</p>
<p>Display the points in the plotter:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_perceptron_3">Try it Yourself &raquo;</a></p>
</div>

<hr>
<h2>Create a Line Function</h2>
<p>Display the line in the plotter:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
function f(x) {<br>
...
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_perceptron_4">Try it Yourself &raquo;</a></p>

</div>

<hr>
<h2>Compute Correct Answers</h2>
<p>Compute the correct answers based on the line function:</p>
<p>y = x * 1.2 + 50.</p>
<p>The desired answer is 1 if y is over the line and 0 if y is under the line.</p>
<p>Store the desired answers in an array (desired[]).</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let desired = [];<br>
...
<hr>
<h2>Display the Correct Answers</h2>
<p>For each point, if desired[i] = 1 display a black point,
else display a blue point.</p>
...
for (let i = 0; i &lt; numPoints; i++) {<br>
&nbsp;&nbsp;let color = "blue";<br>
&nbsp;&nbsp;if (desired[i]) color = "black";<br>
&nbsp;&nbsp;plotter.plotPoint(xPoints[i], yPoints[i], color);<br>
}
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_perceptron_5">Try it Yourself &raquo;</a></p>
</div>

<hr>
<h2>How to Train a Perceptron</h2>
<p>In the next chapter, you will learn how to use the correct answers to:</p>
<p><b>Train a perceptron</b> to predict the output values of unknown input values.</p>
<br>
