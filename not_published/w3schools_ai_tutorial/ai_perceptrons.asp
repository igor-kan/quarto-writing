...
<a class="w3-left w3-btn" href="ai_neural_networks.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ai_recognition.asp">Next &#10095;</a>
</div>

<div class="w3-panel ws-info">
<p>A <b>Perceptron</b> is an <b>Artificial Neuron</b>.</p>
<p>It is the simplest possible <b>Neural Network</b>.</p>
<p><b>Neural Networks</b> are the building blocks of <b>Machine Learning</b>.</p>
</div>

<h2>Frank Rosenblatt</h2>
<p><b>Frank Rosenblatt</b> (1928 – 1971) was an American psychologist
notable in the field of Artificial Intelligence.</p>
<p>In <b>1957</b> he started something really big. He "invented" a <b>Perceptron</b> program,
on an IBM 704 computer at Cornell Aeronautical Laboratory.</p>
<p>Scientists had discovered that brain cells (<b>Neurons</b>)
receive input from our senses by electrical signals.</p>
<p>The Neurons, then again, use electrical signals to store information, and to make decisions based on previous input.</p>
<p>Frank had the idea that <b>Perceptrons</b> could simulate brain principles, with the ability to learn and make decisions.</p>

<hr>
<h2>The Perceptron</h2>
<p>The original <b>Perceptron</b> was designed to take a number of <b>binary</b> inputs, and produce one <b>binary</b>
output (0 or 1).</p>
<p>The idea was to use different <b>weights</b> to represent the importance of each <b>input</b>,
...
<p><img alt="Perceptron" style="width:100%;max-width:500px" src="img_perceptron.jpg"></p>

<hr>

<h2>Perceptron Example</h2>

<p>Imagine a perceptron (in your brain).</p>
<p>The perceptron tries to decide if you should go to a concert.</p>
<p>Is the artist good? Is the weather good?</p>
<p>What weights should these facts have?</p>

<table class="ws-table-all">
<tr>
<th>Criteria</th><th>Input</th><th>Weight</th>
</tr>
<tr><td>Artists is Good</td><td><b>x1</b> = 0 or 1</td><td><b>w1</b> = 0.7</td></tr>
<tr><td>Weather is Good</td><td><b>x2</b> = 0 or 1</td><td><b>w2</b> = 0.6</td></tr>
<tr><td>Friend will Come</td><td><b>x3</b> = 0 or 1</td><td><b>w3</b> = 0.5</td></tr>
<tr><td>Food is Served</td><td><b>x4</b> = 0 or 1</td><td><b>w4</b> = 0.3</td></tr>
<tr><td>Alcohol is Served</td><td><b>x5</b> = 0 or 1</td><td><b>w5</b> = 0.4</td></tr>
</table>

<hr>
<h2>The Perceptron Algorithm</h2>
<p>Frank Rosenblatt suggested this algorithm:</p>
<ol>
<li>Set a threshold value</li>
<li>Multiply all inputs with its weights</li>
<li>Sum all the results</li>
<li>Activate the output</li>
</ol>
<p><b>1. Set a threshold value</b>:</p>
<ul>
<li>Threshold = 1.5</li>
</ul>
<p><b>2. Multiply all inputs with its weights</b>:</p>
<ul>
<li>x1 * w1 = 1 * 0.7 = 0.7</li>
<li>x2 * w2 = 0 * 0.6 = 0</li>
<li>x3 * w3 = 1 * 0.5 = 0.5</li>
<li>x4 * w4 = 0 * 0.3 = 0</li>
<li>x5 * w5 = 1 * 0.4 = 0.4</li>
</ul>
<p><b>3. Sum all the results</b>:</p>
<ul>
<li>0.7 + 0 + 0.5 + 0 + 0.4 = 1.6 (The Weighted Sum)</li>
</ul>
<p><b>4. Activate the Output</b>:</p>
<ul>
<li>Return true if the sum &gt; 1.5 ("Yes I will go to the Concert")</li>
</ul>

<div class="ws-note">
<h2>Note</h2>
<p>If the weather weight is 0.6 for you, it might be different for someone else.
A higher weight means that the weather is more important to them.</p>
<p>If the threshold value is 1.5 for you, it might be different for someone else.
...
const threshold = 1.5;<br>
const inputs = [1, 0, 1, 0, 1];<br>
const weights = [0.7, 0.6, 0.5, 0.3, 0.4];<br>
<br>
let sum = 0;<br>
for (let i = 0; i &lt; inputs.length; i++) {<br>
&nbsp;&nbsp;sum += inputs[i] * weights[i];<br>
}<br>
<br>
const activate = (sum &gt; 1.5);
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_perceptron_1">Try it Yourself &raquo;</a></p>
</div>
...
<h2>Perceptron in AI</h2>
<p>A <b>Perceptron</b> is an <b>Artificial Neuron</b>.
<p>It is inspired by the function of a <b>Biological Neuron</b>.</p>
<p>It plays a crucial role in <b>Artificial Intelligence</b>.</p>
<p>It is an important building block in <b>Neural Networks</b>.</p>

<p>To understand the theory behind it, we can break down its components:</p>

<ol>
<li>Perceptron Inputs (nodes)</li>
<li>Node values (1, 0, 1, 0, 1)</li>
<li>Node Weights (0.7, 0.6, 0.5, 0.3, 0.4)</li>
<li>Summation</li>
<li>Treshold Value</li>
<li>Activation Function</li>
<li>Summation (sum &gt; treshold)</li>
</ol>

<hr>
<h3>1. Perceptron Inputs</h3>
<p>A perceptron receives one or more input.</p>
<p>Perceptron inputs are called <b>nodes</b>.</p>
<p>The nodes have both a <b>value</b> and a <b>weight</b>.</p>
<hr>
<h3>2. Node Values (Input Values)</h3>
<p>Input nodes have a binary value of <b>1</b> or <b>0</b>.</p>
<p>This can be interpreted as <b>true</b> or <b>false</b> / <b>yes</b> or <b>no</b>.</p>
<p>The values are: <span class="w3-codespan">1, 0, 1, 0, 1</span></p>
<hr>
<h3>3. Node Weights</h3>
<p>Weights are values assigned to each input.</p>
<p>Weights shows the <b>strength</b> of each node.</p>
<p>A higher value means that the input has a stronger influence on the output.</p>
<p>The weights are: <span class="w3-codespan">0.7, 0.6, 0.5, 0.3, 0.4</span></p>
<hr>
<h3>4. Summation</h3>
<p>The perceptron calculates the weighted sum of its inputs.</p>
<p>It multiplies each input by its corresponding weight and sums up the results.</p>
<p>The sum is: <span class="w3-codespan">0.7*1 + 0.6*0 + 0.5*1 + 0.3*0 + 0.4*1 = 1.6</span> 
<hr>
<h3>6. The Threshold</h3>
<p>The Threshold is the value needed for the perceptron to fire (outputs 1),
otherwise it remains inactive (outputs 0).</p>
<p>In the example, the treshold value is: <span class="w3-codespan">1.5</span> 
<hr>
<h3>5. The Activation Function</h3>
<p>After the summation, the perceptron applies the activation function.</p>
<p>The purpose is to introduce non-linearity into the output.
It determines whether the perceptron should fire or not based on the aggregated input.</p>
<p>The activation function is simple: <span class="w3-codespan">(sum &gt; treshold) == (1.6 &gt; 1.5)</span></p>
<hr>
<h3>The Output</h3>
<p>The final output of the perceptron is the result of the activation function.</p>
<p>It represents the perceptron's decision or prediction based on the input and the weights.</p>
<p>The activation function maps the the weighted sum into a binary value.</p>
<p>The binary <b>1</b> or <b>0</b> can be interpreted as <b>true</b> or <b>false</b> / <b>yes</b> or <b>no</b>.</p>
<p>The output is <b>1</b> because: <span class="w3-codespan">(sum &gt; treshold) == true</span>.</p> 
<hr>
<h2>Perceptron Learning</h2>
<p>The perceptron can learn from examples through a process called training.</p>
<p>During training, the perceptron adjusts its weights based on observed errors.
This is typically done using a learning algorithm such as the perceptron learning rule or a backpropagation algorithm.</p>

<p>The learning process presents the perceptron with labeled examples, where the desired output is known.
...
<p>The learning process allows the perceptron to learn the weights that enable it
to make accurate predictions for new, unknown inputs.</p>
<hr>
<div class="ws-note">
<h2>Note</h2>
<p>It is obvious a decisions can NOT be made by <b>One Neuron</b> alone.</p>
<p>Other neurons must provide more input:</p>
<ul>
<li>Is the artist good</li>
<li>Is the weather good</li>
<li>...</li>
</ul>
<p><b>Multi-Layer Perceptrons</b> can be used for more sophisticated decision making.</p>
</div>
<p>It's important to note that while perceptrons were influential in the development of artificial neural networks,
they are limited to learning linearly separable patterns.</p>
<p>However, by stacking multiple perceptrons together in layers and incorporating non-linear activation functions,
neural networks can overcome this limitation and learn more complex patterns.</p>

<hr>
<h2>Neural Networks</h2>
<p>The <b>Perceptron</b> defines the first step into <b>Neural Networks</b>:</p>

<img alt="Neural Networks" style="width:100%;max-width:400px" src="img_neural_networks.jpg">
<p>Perceptrons are often used as the building blocks for more complex neural networks, such as multi-layer perceptrons
(MLPs) or deep neural networks (DNNs).</p>
<p> By combining multiple perceptrons in layers and connecting them in a
