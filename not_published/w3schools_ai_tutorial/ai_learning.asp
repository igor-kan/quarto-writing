...
<a class="w3-left w3-btn" href="ai_perceptron_testing.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ai_ml_terminology.asp">Next &#10095;</a>
</div>

<div class="w3-panel ws-info">
<h2>Learning is Looping</h2>
<p>An ML model is <b>Trained</b> by <b>Looping</b> over data multiple times.</p>
<p>For each iteration, the <b>Weight Values</b> are adjusted.</p>
<p>Training is complete when the iterations fails to <b>Reduce the Cost</b>.</p>
</div>
...
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_train_regression">Try it Yourself &raquo;</a></p>
<hr>
<h2>Gradient Descent</h2>
<p><b>Gradient Descent</b> is a popular algorithm for solving AI problems.</p>
<p>A simple <b>Linear Regression Model</b> can be used to demonstrate a gradient descent.</p>
<p>The goal of a linear regression is to fit a linear graph to a set of (x,y) points.
This can be solved with a math formula. But a <b>Machine Learning Algorithm</b> can also solve this.</p>  
<p>This is what the example above does.</p>
<p>It starts with a scatter plot and a linear model (y = wx + b).</p>
<p>Then it trains the model to find a line that fits the plot.
This is done by altering the weight (slope) and the bias (intercept) of the line.</p>
<p>Below is the code for a <b>Trainer Object</b> that can solve this problem
(and many other problems).</p>
 
<hr>
<h2>A Trainer Object</h2>
<p>Create a Trainer object that can take any number of (x,y) values in two arrays (xArr,yArr).</p>
<p>Set weight to zero and the bias to 1.</p>
<p>A learning constant (learnc) has to be set, and a cost variable must be defined:</p>  
<div class="w3-example">
<p>Example</p>
<div class="w3-code notranslate jsHigh">
function Trainer(xArray, yArray) {<br>
&nbsp;&nbsp;this.xArr = xArray;<br>
&nbsp;&nbsp;this.yArr = yArray;<br>
&nbsp;&nbsp;this.points = this.xArr.length;<br>
&nbsp;&nbsp;this.learnc = 0.00001;<br>
&nbsp;&nbsp;this.weight = 0;<br>
&nbsp;&nbsp;this.bias = 1;<br>
&nbsp;&nbsp;this.cost;<br>
</div>
...
<h2>Cost Function</h2>
<p>A standard way to solve a regression problem is with an "Cost Function" that measures how good the solution is.</p>
<p>The function uses the weight and bias from the model (y = wx + b) and returns an error,
based on how well the line fits a plot.</p>
<p>The way to compute this error is to loop through all (x,y) points in the plot,
and sum the square distances between the y value of each point and the line.</p>
<p>The most conventional way is to square the distances (to ensure positive values)
and to make the error function differentiable.</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
this.costError = function() {<br>
&nbsp;&nbsp;total = 0;<br>
&nbsp;&nbsp;for (let i = 0; i &lt; this.points; i++) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;total += (this.yArr[i] - (this.weight * this.xArr[i] + this.bias)) **2;<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;return total / this.points;<br>
}
</div>
</div>
<div class="ws-note">
<p>Another name for the <b>Cost Function</b> is <b>Error Function</b>.</p> 
<p>The formula used in the function is actually this:</p>
<img style="width:100%;max-width:400px;border:1px solid black" alt="Formula" src="img_linear_regression_error.jpg">
<ul>
<li><b>E</b> is the error (cost)</li>
<li><b>N</b> is the total number of observations (points)</li>
<li><b>y</b> is the value (label) of each observation</li>
<li><b>x</b> is the value (feature) of each observation</li>
<li><b>m</b> is the slope (weight)</li>
<li><b>b</b> is intercept (bias)</li>
<li><b>mx + b</b> is the prediction</li>
<li><b>1/N * N∑1</b> is the squared mean value</li>
</ul>
</div>

<hr>
<h2>The Train Function</h2>
<p>We will now run a gradient descent.</p>
<p>The gradient descent algorithm should walk the cost function towards the best line.</p>
<p>Each iteration should update both m and b towards a line with a lower cost (error).</p>
<p>To do that, we add a train function that loops over all the data many times:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
this.train = function(iter) {<br>
&nbsp;&nbsp;for (let i = 0; i &lt; iter; i++) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.updateWeights();<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;this.cost = this.costError();<br>
}
</div>
</div>

<hr>
<h2>An Update Weights Function</h2>
<p>The train function above should update the weights and biases in each iteration.</p> 
<p>The direction to move is calculated using two partial derivatives:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
this.updateWeights = function() {<br>
&nbsp;&nbsp;let wx;<br>
&nbsp;&nbsp;let w_deriv = 0;<br>
&nbsp;&nbsp;let b_deriv = 0;<br>
&nbsp;&nbsp;for (let i = 0; i &lt; this.points; i++) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;wx = this.yArr[i] - (this.weight * this.xArr[i] + this.bias);<br>
&nbsp;&nbsp;&nbsp;&nbsp;w_deriv += -2 * wx * this.xArr[i];<br>
&nbsp;&nbsp;&nbsp;&nbsp;b_deriv += -2 * wx;<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;this.weight -= (w_deriv / this.points) * this.learnc;<br>
&nbsp;&nbsp;this.bias -= (b_deriv / this.points) * this.learnc;<br>
}<br>
</div>
</div>
...
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_train_regression_plotly">Try it Yourself &raquo;</a></p>
</div>
...
function train(iter) {
  ...
  myTrainer.weight.toFixed(2) + " + " + myTrainer.bias.toFixed(2) +
