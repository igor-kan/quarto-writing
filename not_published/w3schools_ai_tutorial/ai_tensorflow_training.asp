...
<html lang="en-US">
<head>
<title>TensorFlow Training</title>
<meta charset="utf-8">
...
<h1>Example 1 Training</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="ai_tensorflow_modelling.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ai_tensorflow_example_houses.asp">Next &#10095;</a>
</div>
<hr>
...
async function trainModel(model, inputs, labels, surface) {<br>
&nbsp;&nbsp;const batchSize = 25;<br>
&nbsp;&nbsp;const epochs = 50;<br>
&nbsp;&nbsp;const callbacks = tfvis.show.fitCallbacks(surface, ['loss'], {callbacks:['onEpochEnd']})<br>
&nbsp;&nbsp;return await model.fit(inputs, labels,<br>
&nbsp;&nbsp;&nbsp;&nbsp;{batchSize, epochs, shuffle:true, callbacks:callbacks}<br>
&nbsp;&nbsp;);<br>
}<br>
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_tensorflow_train">Try it Yourself &raquo;</a></p>
</div>
<p><span class="w3-codespan w3-border">epochs</span> defines how many iterations (loops) the model will do.</p>
<p><span class="w3-codespan w3-border">model.fit</span> is the function that runs the loops.</p>
<p><span class="w3-codespan w3-border">callbacks</span> defines the callback function to call
when the model wants to redraw the graphics.</p>
<hr>
<h2>Test the Model</h2>
<p>When a model is trained, it is important to test and evaluate it.</p>
<p>We do this by inspecting what the model predicts for a range of different inputs.</p>
<p>But, before we can do that, we have to un-normalize the data:
<div class="w3-example">
<h3>Un Normalize</h3>
<div class="w3-code notranslate jsHigh">
let unX = tf.linspace(0, 1, 100);<br>      
let unY = model.predict(unX.reshape([100, 1]));<br>  
<br>    
const unNormunX = unX.mul(inputMax.sub(inputMin)).add(inputMin);<br>
const unNormunY = unY.mul(labelMax.sub(labelMin)).add(labelMin);<br>
<br>
unX = unNormunX.dataSync();<br>
unY = unNormunY.dataSync();<br>
</div>
</div>
<p>Then we can look at the result:</p>
<div class="w3-example">
<h3>Plot the Result</h3>
<div class="w3-code notranslate jsHigh">
const predicted = Array.from(unX).map((val, i) =&gt; {<br>
  return {x: val, y: unY[i]}<br>
});<br>
<br>
// Plot the Result<br>
tfPlot([values, predicted], surface1)<br>
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryai_tensorflow_predict">Try it Yourself &raquo;</a></p>
</div>
