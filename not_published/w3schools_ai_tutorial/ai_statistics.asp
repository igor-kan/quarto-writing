...
<a class="w3-left w3-btn" href="ai_tensors.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ai_statistics_descriptive.asp">Next &#10095;</a>
</div>

<div class="w3-panel ws-info">
<p>Statistics are tools to get answers to questions about data:</p>
<ul>
<li>What is <b>Common?</b></li>
<li>What is <b>Expected?</b></li>
<li>What is <b>Normal?</b></li>
<li>What is the <b>Probability?</b></li>
</ul>
</div>

<h2>Inferential Statistics</h2>
<p><b>Inferential statistics</b> are methods for quantifying properties of a population
from a small <b>Sample</b>:</p>
...
<p>You take data from a sample and make a prediction about the whole population.</p>

<p>For example, you can stand in a shop and ask a <b>sample of 100 people</b> if they like chocolate.</p>
<p>From your research, using inferential statistics, you could predict that 91% of <b>all shoppers</b> like chocolate.
<hr>

<h2>Incredible Chocolate Facts</h2>
<p>Nine out of ten people love chocolate.</p>
<p>50% of the US population cannot live without chocolate every day.</p>

<div class="ws-note">
<p>You use <b>Inferential Statistics</b> to predict whole domains from small samples of data.</p>
</div>
<hr>
...
<p><b>Descriptive Statistics</b> summarizes (describes) observations from a set of data.</p>
<p>Since we register every newborn baby, we can tell that 51 out of 100 are boys.</p>
<p>From these collected numbers, we can predict a 51% chance that a new baby will be a boy.</p>
<p>It is a mystery that the ratio is not 50%, like basic biology would predict.
We only know that we have had this tilted sex ratio since the 17th century.</p> 

<div class="ws-note">
<h2>Note</h2>
<p>Raw observations are only data. They are not real knowledge.</p>
<p>You use <b>Descriptive Statistics</b> to transform raw observations into data that you can understand.
</div>

<hr>
<h2>Descriptive Statistics Measurements</h2>
<p>Descriptive statistics are broken down into different measures:</p>
<p><b>Tendency</b> (Measures of the Center)</p>
<ul>
<li>The Mean (the average value)value</li>
<li>The Median (the mid point value)</li>
<li>The Mode (the most common value)</li>
</ul>
<p><b>Spread</b> (Measures of Variability)</p>
<ul>
<li>Min and Max</li>
