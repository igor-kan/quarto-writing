...
<html lang="en-US">
<head>
<title>The History of Languages</title>
<meta charset="utf-8">
...
<h1>The History of Languages</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="ai_history_brain.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ai_history_numbers.asp">Next &#10095;</a>
</div>

<div class="w3-panel ws-info">
<p>A language is a structured system of communication.</p>
<p>The type of communication that involves the use of words.</p>
</div>

<h2>What is a Language?</h2>
<p>Apes and Whales communicate with each other. 
<p>Birds and Bees communicate with each other.</p>
<p>But only humans have developed a real Language.</p>

<p>No other species can express ideas using sentences constructed by a
set of words (with verbs and nouns).</p>
<p>This skill is remarkable. And what is even more remarkable: Even children master this skill.</p>

<hr>

<h2>Spoken Languages</h2>
<p>We are not sure of how old the spoken language is.
The topic is difficult to study because of the lack of evidence.</p>

<p>We don't know how it started. But we have a clue.</p>
<p>The great African apes, Pan and Gorilla, are our closest living relatives.
Why are they called "Apes"? Because they ape. Apes mime to get their message across.</p>

<p>It is assumed that the evolution of languages must have been a long process.
Our ancestors might have started speaking a million years ago,
but with fewer words, more miming, and no grammar.</p>

<div class="w3-panel ws-info">
<p class="w3-xlarge w3-center w3-serif">The Tower of Babel</p>

<p>
<a title="Pieter Brueghel the Elder, Public domain, via Wikimedia Commons"
...
<img width="100%" alt="Pieter Bruegel the Elder - The Tower of Babel (Vienna) - Google Art Project"
src="img_babel_tower.jpg"></a>
</p>
</div>

<h2>Cognitive Development</h2>

<p>According to <a href="https://scholar.google.no/scholar?q=The+Faculty+of+Language:+What+Is+It,+Who+Has+It,+and+How+Did+It+Evolve%3F&hl=en&as_sdt=0&as_vis=1&oi=scholart">
Hauser, Chomsky, and Fitch (2002)</a>, there are six aspects of language development:</p>
<ul>
<li>Theory of Mind</li>
<li>Understanding Vocal Signals</li>
<li>Understanding Imitation</li>
<li>Understanding Numbers</li>
<li>Understanding Intentional Communication</li>
<li>Understanding Non-linguistic Representations</li>
...
<p>Human languages contain a limited set of <b>Words </b>put together in <b>Sentences</b>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate">
I'm going on holiday in my new car.<br>
...
<p>Computers are programmed with a limited set of <b>Words</b>
put together in computer <b>Statements</b>:</p>
<div class="w3-example">
<h3>Example</h3>
...
<a class="w3-btn w3-margin-bottom" href="/js/tryit.asp?filename=tryjs_array_sort2" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Written Languages</h2>
<p>Egyptian and Sumerian are the earliest known written languages.</p>
<p>(The oldest written language in use today, is Chinese)</p>
<table class="ws-table-all">
<tr><td>3500 BC</td><td>Sumerian</td></tr>
<tr><td>3000 BC</td><td>Egyptian</td></tr>
<tr><td>1500 BC</td><td>Chinese</td></tr>
<tr><td>1500 BC</td><td>Vedic Sanskrit</td></tr>
<tr><td>1500 BC</td><td>Greek</td></tr>
<tr><td>1000 BC</td><td>Hebrew</td></tr>
<tr><td>900 BC</td><td>Aramaic</td></tr>
<tr><td>700 BC</td><td>Etruscan</td></tr>
<tr><td>500 BC</td><td>Tamil</td></tr>
<tr><td>700 BC</td><td>Latin</td></tr>
<tr><td>700 AC</td><td>Classical Sanskrit</td></tr>
<tr><td>500 AC</td><td>Arabic</td></tr>
<tr><td>400 AC</td><td>Gothic (German)</td></tr>
<tr><td>700 AC</td><td>English</td></tr>
<tr><td>700 AC</td><td>Japanese</td></tr>
<tr><td>800 AC</td><td>French</td></tr>
<tr><td>900 AC</td><td>Italian</td></tr>
<tr><td>1000 AC</td><td>Spanish</td></tr>
</table>
