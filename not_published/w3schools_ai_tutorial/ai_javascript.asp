...
<h1>Machine Learning in JavaScript</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="ai_languages.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ai_examples.asp">Next &#10095;</a>
</div>

<div class="w3-panel ws-info">
<p>Traditionally, Machine Learning applications are using R or Python.</p>
<p>But JavaScript has a great future as a Machine Learning language:</p>
<ul>
<li>JavaScript is well known. All developers can use it.</li>
<li>Security is built in. JavaScript cannot access your files.</li>
<li>JavaScript is faster than Python.</li>
<li>JavaScript can use hardware acceleration.</li>
<li>JavaScript runs in the browser</li>
</ul> 
</div>

<h2>JavaScript is Good for Machine Learning</h2>

<p>Machine Learning can be math-heavy. The nature of neural networks is highly technical,
and the jargon that goes along with it tends to scare people away.</p>
<p>
This is where JavaScript comes to help, with easy to understand software
to simplifying the process of creating and training neural networks.</p>
<p>With new Machine Learning libraries, JavaScript developers can add 
Machine Learning and Artificial Intelligence to web applications.</p>

<hr>
<h2>JavaScript Machine Learning Libraries</h2>

<div class="w3-panel ws-info">
<p><b>Machine Learning</b> in the <b>Browser</b> means:
<ul>
<li>Machine Learning in JavaScript</li>
<li>Machine Learning for the Web</li>
<li>Machine Learning for Everyone</li>
<li>Machine Learning on more Platforms</li>
</ul>
</div>
<h3>Advantages:</h3>
<ul>
<li>Easy to use. Nothing to install.</li>
<li>Powerful graphics. Browsers support WebGL.</li>
<li>Better privacy. Data can stay on the client.</li>
<li>More platforms. JavaScript runs on mobile devices.</li>
</ul>
<hr>
<h2>Brain.js</h2>
<p><b>Brain.js</b> is a JavaScript library that makes it easy to understand Neural Networks
because it hides the complexity of the mathematics.</p>
<p>Brain.js is simple to use. You do not need to know neural networks in details to work with Brain.js.</p>
<p>Brain.js provides multiple neural network implementations as different neural nets can be trained to do different things well.</p>
<p><a href="ai_brainjs.asp">Learn More ...</a>

<hr>


<h2>ml5.js</h2>
<p>ml5.js is trying to make machine learning more accessible to a wider audience.</p>
<p>The ml5 team is working to wrap machine learning functionality in friendlier ways.</p>
<p>The example below uses only <b>three lines</b> of code to classify an image:</p>


<div class="w3-example">
<div class="w3-code notranslate htmlHigh">
&lt;img id="myImage" src="pic1.jpg" width="100%"&gt;<br><br>
&lt;script&gt;<br>
const classifier =  ml5.imageClassifier('MobileNet');<br>
classifier.classify(document.getElementById("myImage"), gotResult);<br>
function gotResult(error, results)<br>
{ ... }<br>
&lt;/script&gt;<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryai_ml5_intro" target="_blank">Try it Yourself &raquo;</a>
</div>
<p>Try substitute pic1.jpg with pic2.jpg, pic3.jpg and pic4.jpg.</p>

<hr>
<h2>TensorFlow</h2>
<p><a target="_blank" href="https://playground.tensorflow.org/"><b>TensorFlow Playground</b></a> is a web application written in <b>d3.js</b>.</p>
<p>With TensorFlow Playground you can learn about <b>Neural Networks</b> (NN) without math.</p>
<p>In your own <b>Web Browser</b> you can create a Neural Network and see the result.</p>
<p>TensorFlow.js was previously called Tf.js and Deeplearn.js.</p>

<hr>
<h2>Math in the Browser</h2>
<p><b>Math.js</b> is an extensive math library for JavaScript and Node.js.</p>
<p>Math.js is powerful and easy to use.
It comes with a large set of built-in functions,
a flexible expression parser, and solutions to work with many data types like
numbers, big numbers, complex numbers, fractions, units, arrays, and matrices.</p>
...
<h2>Plotting in the Browser</h2>

<p>Here is a list of some JavaScript libraries to use for both Machine Learning graphs and other HTML charts:</p>
<ul>
<li><a href="ai_canvas.asp">HTML Canvas</a></li>
<li><a href="ai_plotly.asp">Plotly.js</a></li>
<li><a href="ai_chartjs.asp">Chart.js</a></li>
<li><a href="ai_google_chart.asp">Google Chart</a></li>
<li><a href="ai_d3js.asp">D3.js</a></li>
</ul>
<hr>
<h2>Plotting Equations</h2>

<p>
<label>Enter Equation:</label>
<input id="equation" class="w3-input" type="text" value="sin(x) * 2 + 17">
</p>
<div id="myPlot11"></div>
<button class="w3-btn w3-blue" onclick='plotExpression("scatter")'>Scatter</button>
<button class="w3-btn w3-blue" onclick='plotExpression("lines")'>Draw Line</button>
<p><a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryai_plotly_expression">Try it Yourself &raquo;</a></p>
<hr>
<h2>Plotting Values</h2>
<p>
<label>Enter X and Y Values:</label>
<input id="xvalues" class="w3-input" type="text" value="50,60,70,80,90,100,110,120,130,140,150">
<input id="yvalues" class="w3-input" type="text" value="7,8,8,9,9,9,10,11,14,14,15">
</p>

<div id="myPlot21"></div>
<button class="w3-btn w3-blue" onclick='plotXY("scatter")'>Scatter</button>
<button class="w3-btn w3-blue" onclick='plotXY("lines")'>Draw Lines</button>
<p><a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryai_plotly_xy">Try it Yourself &raquo;</a></p>

<script>
plotExpression("lines");
plotXY("lines");
function plotExpression(type) {
  try {
    // Compile expression
    ...
    // Display the plot
    plotXYArrays("myPlot11", type, xArray, yArray);
  }
  catch (err) {
    document.getElementById("myPlot11").innerHTML = err;
  }
}
function plotXY(type) {
  let xArray = document.getElementById("xvalues").value.split(',');
  let yArray = document.getElementById("yvalues").value.split(',');
  plotXYArrays("myPlot21", type, xArray, yArray);
}
function plotXYArrays(id, type, xArray, yArray) {
  let mode = "lines";
  let graph = "scatter";
  if (type == "scatter") {mode = "markers"}
  if (type == "bars") {graph = "bar"}
  Plotly.newPlot(id, [{x:xArray, y:yArray, mode:mode, type:graph}]);
}
</script>

<hr>
<h2>WebGL API</h2>
<p><b>WebGL</b> is a JavaScript API for rendering 2d and 3D graphics in any browser.</p>
<p>WebGL can run on both integrated and standalone graphic cards in any PC.</p>
<p>WebGL brings 3D graphics to the web browser. Major browser vendors Apple (Safari), Google (Chrome),
Microsoft (Edge), and Mozilla (Firefox) are members of the WebGL Working Group.</p>
<p><a target="_blank" href="https://akirodic.com/p/jellyfish/"><img width="80%" alt="JellyFish" src="img_jellyfish.jpg"></a></p>
