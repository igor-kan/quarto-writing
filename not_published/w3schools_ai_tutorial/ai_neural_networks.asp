...
<a class="w3-left w3-btn" href="ai_regressions.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ai_brainjs.asp">Next &#10095;</a>
</div>

<div class="w3-panel ws-info">
<p><b>The deep learning revolution</b> started around 2010.</p>
<p>Since then, Deep Learning has solved many &quot;unsolvable&quot; problems.</p>
<p>The deep learning revolution was not started by a single discovery.
It more or less happened when several needed factors were ready:</p>
<ul>
<li>Computers were fast enough</li>
<li>Computer storage was big enough</li>
<li>Better training methods were invented</li>
<li>Better tuning methods were invented</li>
</ul>
</div>

<hr>
<h2>Neurons</h2>
<p>Scientists agree that our brain has between 80 and 100 billion neurons.</p>
<p>These neurons have hundreds of billions connections between them.</p>
<img alt="Neurons" src="img_neurons.jpg" style="width:100%;max-width:400px">
<p class="w3-small w3-text-grey">Image credit: University of Basel, Biozentrum.</p>
<p>Neurons (aka Nerve Cells) are the fundamental units of our brain and nervous system.</p>
<p>The neurons are responsible for receiving input from the external world,
for sending output (commands to our muscles),
and for transforming the electrical signals in between.</p>

<hr>
<h2>Neural Networks</h2>
<p><b>Artificial Neural Networks</b> are normally called Neural Networks (NN).</p>
<p>Neural networks are in fact multi-layer <b>Perceptrons</b>.</p>
<p>The perceptron defines the first step into multi-layered neural networks.</p>   

<p><b>Neural Networks</b> are the essence of <b>Deep Learning</b>.</p>
<p><b>Neural Networks</b> are one of the most significant discoveries in history.</p>
<p>Neural Networks can solve problems that can NOT be solved by algorithms:</p>
<ul>
...
<p>Input data (Yellow) are processed against a hidden layer (Blue)
and modified against another hidden layer (Green) to produce the final output (Red).</p>
<img alt="Neural Networks" style="width:100%;max-width:500px" src="img_neural_networks.jpg">
<hr>
<h2>Tom Mitchell</h2>
<p>Tom Michael Mitchell (born 1951) is an American computer scientist and University Professor at the Carnegie Mellon University (CMU).</p>
<p>He is a former Chair of the Machine Learning Department at CMU.</p> 
<div class="w3-panel w3-leftbar w3-sand">
<p><i>"A computer program is said to learn from experience E with respect to some class of tasks T
and performance measure P, if its performance at tasks in T, as measured by P, improves with experience E."</i></p>
<p>Tom Mitchell (1999)</p>
</div>
<p>
E: Experience (the number of times).<br>
T: The Task (driving a car).<br>
P: The Performance (good or bad).<br>
</p>
<hr>


<h2>The Giraffe Story</h2>
<p>In 2015, <b>Matthew Lai</b>, a student at Imperial College in London created a neural network called <b>Giraffe</b>.</p>
<p>Giraffe could be trained in 72 hours to play chess at the same level as an international master.</p>
<p>Computers playing chess are not new, but the way this program was created was new.</p>
<p>Smart chess playing programs take years to build, while Giraffe was built in 72 hours with a neural network.</p>
...
<hr>
<h2>Deep Learning</h2>
<p>Classical programming uses programs (algorithms) to create results:</p>
<div class="w3-container w3-card">
<h3>Traditional Computing</h3>
<p class="w3-large">Data + Computer Algorithm = <b>Result</b></p>
</div>
<p>Machine Learning uses results to create programs (algorithms):</p>
<div class="w3-container w3-card">
<h3>Machine Learning</h3>
<p class="w3-large">Data + Result = <b>Computer Algorithm</b></p>
</div>


<hr>
<h2>Machine Learning</h2>
<p>Machine Learning is often considered equivalent with Artificial Intelligence.</p>
<p>This is not correct. Machine learning is a subset of Artificial Intelligence.</p>
<p>Machine Learning is a discipline of AI that uses data to teach machines.</p>
<div class="w3-panel w3-sand w3-card">
  <p class="w3-large w3-serif">
  <i>"Machine Learning is a field of study that gives computers the ability to learn without being programmed."</i></p>
  <p>Arthur Samuel (1959)</p>
</div>
<hr>
<h2>Intelligent Decision Formula</h2>
<ul>
<li>Save the result of all actions</li>
<li>Simulate all possible outcomes</li>
<li>Compare the new action with the old ones</li>
<li>Check if the new action is good or bad</li>
<li>Choose the new action if it is less bad</li>
<li>Do it all over again</li>
</ul>
<p>The fact that computers can do this millions of times, 
has proven that computers can make very intelligent decisions.</p>
