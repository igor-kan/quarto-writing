...
<html lang="en-US">
<head>
<title>Pandas Online Compiler (Editor / Interpreter)</title>
<meta charset="utf-8">
...
<h1>Pandas <span class="color_h1">Online Compiler (Editor)</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="pandas_exam.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="pandas_quiz.asp">Next &#10095;</a>
</div>
<hr>

<h2>Pandas (Python) Editor</h2>

<p>With our &quot;Try it Yourself&quot; editor, you can edit Python code and use the Pandas module, and view the result in your browser.</p>
...
<div class="compiler-wrapper">
  ...
  <div class="compiler-body">
    ...
    <div class="editor">
<pre>
<span class="py-keyword">import</span> <span class="py-module">pandas</span> <span class="py-keyword">as</span> <span class="py-module">pd</span>

<span class="py-variable">df</span> <span class="py-symbol">=</span> <span class="py-module">pd</span><span class="py-symbol">.</span><span class="py-function">read_csv</span><span class="py-symbol">(</span><span class="py-string">'data.csv'</span><span class="py-symbol">)</span>

<span class="py-function">print</span><span class="py-symbol">(</span><span class="py-variable">df</span><span class="py-symbol">.</span><span class="py-function">to_string</span><span class="py-symbol">())</span>
</pre>
    </div>

    <div class="output">
<pre style="margin:0;color:inherit;font:inherit;background:transparent;">
...
2          60    103       135     340.0
  ...
  <div class="compiler-footer">
    <a href="trypandas.asp?filename=demo_pandas_editor"
       target="_blank"
       class="ws-btn">
...
<h2>Build and Publish Pandas Projects</h2>
