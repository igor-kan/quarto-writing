...
<html lang="en-US">
<head>
<title>Pandas - Data Correlations</title>
<meta charset="utf-8">
...
<h1>Pandas - <span class="color_h1">Data Correlations</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="pandas_cleaning_wrong_data.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="pandas_plotting.asp">Next &#10095;</a>
</div>
<hr>

<h2>Finding Relationships</h2>

<p>A great aspect of the Pandas module is the <code class="w3-codespan">corr()</code> method.</p>

<p>The <code class="w3-codespan">corr()</code> method calculates the relationship between each column in your data set.</p>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Show the relationship between the columns:</p>
<div class="w3-code notranslate pythonHigh">
  df.corr()</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypandas.asp?filename=demo_pandas_corr">Try it Yourself &raquo;</a>
<h3>Result</h3>
...
<div class="w3-panel ws-note">
  <p>
    <strong>Note:</strong>
    The <code class="w3-codespan">corr()</code> method ignores &quot;not numeric&quot; 
    columns.
  </p>
</div>
...
<p>The Result of the <code class="w3-codespan">corr()</code> method is a table with a lot of numbers that represents
how well the relationship is between two columns.</p>

<p>The number varies from -1 to 1.</p>

<p>1 means that there is a 1 to 1 relationship (a perfect correlation),
and for this data set, each time a value went up in the first column, the other one went up as well.</p>

<p>0.9 is also a good relationship, and if you increase one value, the other will probably increase as well.</p>

<p>-0.9 would be just as good relationship as 0.9, but if you increase one value, the other will probably go down.</p>

<p>0.2 means NOT a good relationship, meaning that if one value goes up does not mean that the other will.</p>

<div class="w3-panel ws-note">
  <p>
    <strong>What is a good correlation?</strong>
    It depends on the use, but I think it is safe to say you have to have at least <code class="w3-codespan">0.6</code> (or <code class="w3-codespan">-0.6</code>) to call it a good correlation.
  </p>
</div>


<h3>Perfect Correlation:</h3>
<p>We can see that "Duration" and "Duration" got the number <code class="w3-codespan">1.000000</code>, which makes sense,
each column always has a perfect relationship with itself.</p>

<h3>Good Correlation:</h3>

<p>&quot;Duration&quot; and &quot;Calories&quot; got a <code class="w3-codespan">0.922721</code> correlation, 
...
of calories, you probably had a long work out.</p>

<h3>Bad Correlation:</h3>

<p>&quot;Duration&quot; and &quot;Maxpulse&quot; got a <code class="w3-codespan">0.009403</code> correlation, 
which is a very bad correlation, meaning that we can not predict the max pulse 
by just looking at the duration of the work out, and vice versa.</p>
...
<hr>
<div id="exercisecontainer" src="xrcise_correlations.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="pandas_cleaning_wrong_data.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="pandas_plotting.asp">Next &#10095;</a>
