...
<html lang="en-US">
<head>
<title>Pandas - DataFrame Reference</title>
<meta charset="utf-8">
...
<h1>Pandas - <span class="color_h1">DataFrame Reference</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="pandas_exam.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="default.asp">Next &#10095;</a>
</div>

<p>All properties and methods of the DataFrame object, with explanations and 
examples:</p>
...
<th>Description</th>
  ...
  <tr>
    <td><a href="ref_df_abs.asp">abs()</a></td><td>Return a DataFrame with the 
  absolute value of each value</td>
  </tr>
  <tr>
    <td><a href="ref_df_add.asp">add()</a></td><td>Adds the values of a DataFrame 
  with the specified value(s)</td>
  </tr>
  <tr>
    <td><a href="ref_df_add_prefix.asp">add_prefix()</a></td><td>Prefix all labels</td>
  </tr>
  <tr>
    <td><a href="ref_df_add_suffix.asp">add_suffix()</a></td><td>Suffix all labels</td>
  </tr>
  <tr>
    <td><a href="ref_df_agg.asp">agg()</a></td><td>Apply a function or a 
  function name to one of the axis of the DataFrame</td>
  </tr>
  <tr>
    <td><a href="ref_df_aggregate.asp">aggregate()</a></td><td>Apply a function 
  or a function name to one of the axis of the DataFrame</td>
  </tr>
  <tr>
    <td>align()</td><td>Aligns two DataFrames with a specified join method</td>
  </tr>
  <tr>
    <td><a href="ref_df_all.asp">all()</a></td><td>Return True if all values in the DataFrame are True, otherwise False</td>
  </tr>
  <tr>
    <td><a href="ref_df_any.asp">any()</a></td><td>Returns True if any of the values in the DataFrame are True, otherwise False</td>
  </tr>
  <tr>
    <td><a href="ref_df_append.asp">append()</a></td><td>Append new columns</td>
  </tr>
  <tr>
    <td><a href="ref_df_applymap.asp">applymap()</a></td><td>Execute a function for each element in the DataFrame </td>
  </tr>
  <tr>
    <td><a href="ref_df_apply.asp">apply()</a></td><td>Apply a function to one 
  of the axis of the DataFrame</td>
  </tr>
  <tr>
    <td><a href="ref_df_assign.asp">assign()</a></td><td>Assign new columns</td>
  </tr>
  <tr>
    <td><a href="ref_df_astype.asp">astype()</a></td><td>Convert the DataFrame into a specified dtype</td>
  </tr>
  <tr>
    <td><a href="ref_df_at.asp">at</a></td><td>Get or set the value of the item with the specified label</td>
  </tr>
  <tr>
    <td><a href="ref_df_axes.asp">axes</a></td><td>Returns the labels of the 
  rows and the columns of the DataFrame</td>
  </tr>
  <tr>
    <td><a href="ref_df_bfill.asp">bfill()</a></td><td>Replaces NULL values with the 
  value from the next row</td>
  </tr>
  <tr>
    <td><a href="ref_df_bool.asp">bool()</a></td><td>Returns the Boolean value of the DataFrame</td>
  </tr>
  <tr>
    <td><a href="ref_df_columns.asp">columns</a></td><td>Returns the column labels of the DataFrame</td>
  </tr>
  <tr>
    <td><a href="ref_df_combine.asp">combine()</a></td><td>Compare the values in 
  two DataFrames, and let a function decide which values to keep</td>
  </tr>
  <tr>
    <td><a href="ref_df_combine_first.asp">combine_first()</a></td><td>Compare 
  two DataFrames, and if the first DataFrame has a NULL value, it will be filled 
  with the respective value from the second DataFrame</td>
  </tr>
  <tr>
    <td>compare()</td><td>Compare two DataFrames and return the differences</td>
  </tr>
  <tr>
    <td><a href="ref_df_convert_dtypes.asp">convert_dtypes()</a></td><td>Converts the columns in the DataFrame into new dtypes</td>
  </tr>
  <tr>
    <td><a href="ref_df_corr.asp">corr()</a></td><td>Find the correlation (relationship) between each column</td>
  </tr>
  <tr>
    <td><a href="ref_df_count.asp">count()</a></td><td>Returns the number of not empty cells for each 
  column/row</td>
  </tr>
  <tr>
    <td><a href="ref_df_cov.asp">cov()</a></td><td>Find the covariance of the columns</td>
  </tr>
  <tr>
    <td><a href="ref_df_copy.asp">copy()</a></td><td>Returns a copy of the DataFrame</td>
  </tr>
  <tr>
    <td><a href="ref_df_cummax.asp">cummax()</a></td><td>Calculate the cumulative maximum 
  values of the DataFrame</td>
  </tr>
  <tr>
    <td><a href="ref_df_cummin.asp">cummin()</a></td><td>Calculate the 
  cumulative minmum values of the DataFrame</td>
  </tr>
  <tr>
    <td><a href="ref_df_cumprod.asp">cumprod()</a></td><td>Calculate the cumulative product 
  over the DataFrame</td>
  </tr>
  <tr>
    <td><a href="ref_df_cumsum.asp">cumsum()</a></td><td>Calculate the cumulative sum 
  over the DataFrame</td>
  </tr>
  <tr>
    <td><a href="ref_df_describe.asp">describe()</a></td><td>Returns a 
  description summary for each column in the DataFrame </td>
  </tr>
  <tr>
    <td><a href="ref_df_diff.asp">diff()</a></td><td>Calculate the difference 
  between a value and the value of the same column in the previous row</td>
  </tr>
  <tr>
    <td><a href="ref_df_div.asp">div()</a></td><td>Divides the values of a DataFrame with the 
  specified value(s)</td>
  </tr>
  <tr>
    <td style="height: 18px"><a href="ref_df_dot.asp">dot()</a></td><td style="height: 18px">Multiplies the values of 
  a DataFrame with values from another array-like object, and add the result</td>
  </tr>
  <tr>
    <td style="height: 23px"><a href="ref_df_drop.asp">drop()</a></td><td style="height: 23px">Drops the specified 
  rows/columns from the DataFrame</td>
  </tr>
  <tr>
    <td><a href="ref_df_drop_duplicates.asp">drop_duplicates()</a></td><td>Drops duplicate values from the DataFrame</td>
  </tr>
  <tr>
    <td><a href="ref_df_droplevel.asp">droplevel()</a></td><td>Drops the specified index/column(s)</td>
  </tr>
  <tr>
    <td><a href="ref_df_dropna.asp">dropna()</a></td><td>Drops all rows that 
  contains NULL values</td>
  </tr>
  <tr>
    <td><a href="ref_df_dtypes.asp">dtypes</a></td><td>Returns the dtypes of the columns of the DataFrame</td>
  </tr>
  <tr>
    <td><a href="ref_df_duplicated.asp">duplicated()</a></td><td>Returns True for duplicated rows, otherwise False</td>
  </tr>
  <tr>
    <td><a href="ref_df_empty.asp">empty</a></td><td>Returns True if the DataFrame is empty, otherwise False</td>
  </tr>
  <tr>
    <td><a href="ref_df_eq.asp">eq()</a></td><td>Returns True for values that 
  are equal to the specified value(s), otherwise False</td>
  </tr>
  <tr>
    <td><a href="ref_df_equals.asp">equals()</a></td><td>Returns True if two DataFrames are equal, otherwise False</td>
  </tr>
  <tr>
    <td><a href="ref_df_eval.asp">eval</a></td><td>Evaluate a specified string</td>
  </tr>
  <tr>
    <td><a href="ref_df_explode.asp">explode()</a></td><td>Converts each element into a row</td>
  </tr>
  <tr>
    <td><a href="ref_df_ffill.asp">ffill()</a></td><td>Replaces NULL values with the 
  value from the previous row</td>
  </tr>
  <tr>
    <td><a href="ref_df_fillna.asp">fillna()</a></td><td>Replaces NULL values with the specified value</td>
  </tr>
  <tr>
    <td><a href="ref_df_filter.asp">filter()</a></td><td>Filter the DataFrame according to the specified filter</td>
  </tr>
  <tr>
    <td><a href="ref_df_first.asp">first()</a></td><td>Returns the first rows of 
  a specified date selection</td>
  </tr>
  <tr>
    <td><a href="ref_df_floordiv.asp">floordiv()</a></td><td>Divides the values of 
  a DataFrame with the specified value(s), and floor the values</td>
  </tr>
  <tr>
    <td><a href="ref_df_ge.asp">ge()</a></td><td>Returns True for values greater 
  than, or equal to the specified value(s), otherwise False</td>
  </tr>
  <tr>
    <td><a href="ref_df_get.asp">get()</a></td><td>Returns the item of the specified key</td>
  </tr>
  <tr>
    <td><a href="ref_df_groupby.asp">groupby()</a></td><td>Groups the 
  rows/columns into specified groups</td>
  </tr>
  <tr>
    <td><a href="ref_df_gt.asp">gt()</a></td><td>Returns True for values greater than 
  the specified value(s), otherwise False</td>
  </tr>
  <tr>
    <td><a href="ref_df_head.asp">head()</a></td><td>Returns the header row and the first 5 rows, or the specified number of rows</td>
  </tr>
  <tr>
    <td><a href="ref_df_iat.asp">iat</a></td><td>Get or set the value of the item in the specified position</td>
  </tr>
  <tr>
    <td><a href="ref_df_idxmax.asp">idxmax()</a></td><td>Returns the label of the max value in the specified 
  axis</td>
  </tr>
  <tr>
    <td><a href="ref_df_idxmin.asp">idxmin()</a></td><td>Returns the label of the min value in the specified 
  axis</td>
  </tr>
  <tr>
    <td><a href="ref_df_iloc.asp">iloc</a></td><td>Get or set the values of a group of elements in the specified positions</td>
  </tr>
<tr>
  <td><a href="ref_df_index.asp">index</a></td>
  <td>Returns the row labels of the DataFrame</td>
</tr>
  <tr>
    <td><a href="ref_df_infer_objects.asp">infer_objects()</a></td><td>Change the dtype of the columns in the DataFrame</td>
  </tr>
  <tr>
    <td><a href="ref_df_info.asp">info()</a></td><td>Prints information about the DataFrame</td>
  </tr>
  <tr>
    <td><a href="ref_df_insert.asp">insert()</a></td><td>Insert a column in the DataFrame</td>
  </tr>
  <tr>
    <td><a href="ref_df_interpolate.asp">interpolate()</a></td><td>Replaces not-a-number values with the interpolated method</td>
  </tr>
  <tr>
    <td><a href="ref_df_isin.asp">isin()</a></td><td>Returns True if each elements in the DataFrame is in the 
    specified value</td>
  </tr>
  <tr>
    <td><a href="ref_df_isna.asp">isna()</a></td><td>Finds not-a-number values</td>
  </tr>
  <tr>
    <td><a href="ref_df_isnull.asp">isnull()</a></td><td>Finds NULL values</td>
  </tr>
  <tr>
    <td><a href="ref_df_items.asp">items()</a></td><td>Iterate over the columns of the DataFrame</td>
  </tr>
  <tr>
    <td><a href="ref_df_iteritems.asp">iteritems()</a></td><td>Iterate over the columns of the DataFrame</td>
  </tr>
  <tr>
    <td><a href="ref_df_iterrows.asp">iterrows()</a></td><td>Iterate over the rows of the DataFrame</td>
  </tr>
  <tr>
    <td><a href="ref_df_itertuples.asp">itertuples()</a></td><td>Iterate over the rows as named tuples</td>
  </tr>
  <tr>
    <td><a href="ref_df_join.asp">join()</a></td><td>Join columns of another DataFrame</td>
  </tr>
  <tr>
    <td><a href="ref_df_last.asp">last()</a></td><td>Returns the last rows of a 
  specified date selection</td>
  </tr>
  <tr>
    <td><a href="ref_df_le.asp">le()</a></td><td>Returns True for values less than, 
  or equal to the specified value(s), otherwise False</td>
  </tr>
  <tr>
    <td><a href="ref_df_loc.asp">loc</a></td><td>Get or set the value of a group of elements specified using their labels</td>
  </tr>
  <tr>
    <td><a href="ref_df_lt.asp">lt()</a></td><td>Returns True for values less than 
  the specified value(s), otherwise False</td>
  </tr>
  <tr>
    <td><a href="ref_df_keys.asp">keys()</a></td><td>Returns the keys of the info axis</td>
  </tr>
  <tr>
    <td>kurtosis()</td><td>Returns the kurtosis of the values in the specified 
  axis</td>
  </tr>
  <tr>
    <td style="height: 23px"><a href="ref_df_mask.asp">mask()</a></td><td style="height: 23px"> Replace all values where the specified condition is True</td>
  </tr>
  <tr>
    <td><a href="ref_df_max.asp">max()</a></td><td>Return the max of the values in the specified axis</td>
  </tr>
  <tr>
    <td><a href="ref_df_mean.asp">mean()</a></td><td>Return the mean of the values in the specified axis</td>
  </tr>
  <tr>
    <td><a href="ref_df_median.asp">median()</a></td><td>Return the median of the values in the specified axis</td>
  </tr>
  <tr>
    <td><a href="ref_df_melt.asp">melt()</a></td><td>Reshape the DataFrame from 
  a wide table to a long table</td>
  </tr>
  <tr>
    <td><a href="ref_df_memory_usage.asp">memory_usage()</a></td><td>Returns the memory usage of each column</td>
  </tr>
  <tr>
    <td><a href="ref_df_merge.asp">merge()</a></td><td>Merge DataFrame objects</td>
  </tr>
  <tr>
    <td><a href="ref_df_min.asp">min()</a></td><td>Returns the min of the values in the specified axis</td>
  </tr>
  <tr>
    <td><a href="ref_df_mod.asp">mod()</a></td><td>Modules (find the remainder) 
  of the values of a DataFrame</td>
  </tr>
  <tr>
    <td><a href="ref_df_mode.asp">mode()</a></td><td>Returns the mode of the values in the specified axis</td>
  </tr>
  <tr>
    <td><a href="ref_df_mul.asp">mul()</a></td><td>Multiplies the values of a DataFrame 
  with the specified value(s)</td>
  </tr>
  <tr>
    <td><a href="ref_df_ndim.asp">ndim</a></td><td>Returns the number of dimensions of the DataFrame</td>
  </tr>
  <tr>
    <td><a href="ref_df_ne.asp">ne()</a></td><td>Returns True for values that 
  are not equal to the specified value(s), otherwise False</td>
  </tr>
  <tr>
    <td><a href="ref_df_nlargest.asp">nlargest()</a></td><td>Sort the DataFrame by the specified columns, 
    descending, and return the specified number of rows</td>
  </tr>
  <tr>
    <td><a href="ref_df_notna.asp">notna()</a></td><td>Finds values that are not not-a-number</td>
  </tr>
  <tr>
    <td><a href="ref_df_notnull.asp">notnull()</a></td><td>Finds values that are not NULL</td>
  </tr>
  <tr>
    <td><a href="ref_df_nsmallest.asp">nsmallest()</a></td><td>Sort the DataFrame by the specified columns, 
    ascending, and return the specified number of rows</td>
  </tr>
  <tr>
    <td><a href="ref_df_nunique.asp">nunique()</a></td><td>Returns the number of 
  unique values in the specified axis</td>
  </tr>
  <tr>
    <td><a href="ref_df_pct_change.asp">pct_change()</a></td><td>Returns the percentage change between the previous 
  and the current value</td>
  </tr>
  <tr>
    <td><a href="ref_df_pipe.asp">pipe()</a></td><td>Apply a function to the 
  DataFrame</td>
  </tr>
  <tr>
    <td>pivot()</td><td>Re-shape the DataFrame</td>
  </tr>
  <tr>
    <td>pivot_table()</td><td>Create a spreadsheet pivot table as a DataFrame</td>
  </tr>
  <tr>
    <td><a href="ref_df_pop.asp">pop()</a></td><td>Removes an element from the DataFrame</td>
  </tr>
  <tr>
    <td style="height: 23px"><a href="ref_df_pow.asp">pow()</a></td>
    <td style="height: 23px">Raise the values of one DataFrame to the values of another 
    DataFrame</td>
  </tr>
  <tr>
    <td><a href="ref_df_prod.asp">prod()</a></td><td>Returns the product of all values in the specified axis</td>
  </tr>
  <tr>
    <td><a href="ref_df_product.asp">product()</a></td><td>Returns the product of the values in the specified 
  axis</td>
  </tr>
  <tr>
    <td><a href="ref_df_quantile.asp">quantile()</a></td><td>Returns the values at the specified quantile of the 
  specified axis</td>
  </tr>
  <tr>
    <td><a href="ref_df_query.asp">query()</a></td><td>Query the DataFrame</td>
  </tr>
  <tr>
    <td><a href="ref_df_radd.asp">radd()</a></td><td>Reverse-adds the values of one DataFrame with the values of 
  another DataFrame </td>
  </tr>
  <tr>
    <td><a href="ref_df_rdiv.asp">rdiv()</a></td><td>Reverse-divides the values of one DataFrame with the values of 
  another DataFrame </td>
  </tr>
  <tr>
    <td><a href="ref_df_reindex.asp">reindex()</a></td><td>Change the labels of the DataFrame</td>
  </tr>
  <tr>
    <td>reindex_like()</td><td>??</td>
  </tr>
  <tr>
    <td><a href="ref_df_rename.asp">rename()</a></td><td>Change the labels of the axes</td>
  </tr>
  <tr>
    <td><a href="ref_df_rename_axis.asp">rename_axis()</a></td><td>Change the name of the axis</td>
  </tr>
  <tr>
    <td>reorder_levels()</td><td>Re-order the index levels</td>
  </tr>
  <tr>
    <td><a href="ref_df_replace.asp">replace()</a></td><td>Replace the specified values</td>
  </tr>
  <tr>
    <td><a href="ref_df_reset_index.asp">reset_index()</a></td><td>Reset the index</td>
  </tr>
  <tr>
    <td><a href="ref_df_rfloordiv.asp">rfloordiv()</a></td><td>Reverse-divides the values of one DataFrame with the values 
  of another DataFrame </td>
  </tr>
  <tr>
    <td><a href="ref_df_rmod.asp">rmod()</a></td><td>Reverse-modules the values of one DataFrame to the values of 
  another DataFrame </td>
  </tr>
  <tr>
    <td><a href="ref_df_rmul.asp">rmul()</a></td><td>Reverse-multiplies the values of one DataFrame with the values of 
  another DataFrame </td>
  </tr>
  <tr>
    <td style="height: 23px"><a href="ref_df_round.asp">round()</a></td><td style="height: 23px">
  Returns a DataFrame with all values rounded into the specified format</td>
  </tr>
  <tr>
    <td><a href="ref_df_rpow.asp">rpow()</a></td><td>Reverse-raises the values of one DataFrame up to the values of 
  another DataFrame </td>
  </tr>
  <tr>
    <td><a href="ref_df_rsub.asp">rsub()</a></td><td>Reverse-subtracts the values of one DataFrame to the values of 
  another DataFrame </td>
  </tr>
  <tr>
    <td><a href="ref_df_rtruediv.asp">rtruediv()</a></td><td>Reverse-divides the values of one DataFrame with the values of 
  another DataFrame </td>
  </tr>
  <tr>
    <td><a href="ref_df_sample.asp">sample()</a></td><td>Returns a random selection elements</td>
  </tr>
  <tr>
    <td><a href="ref_df_sem.asp">sem()</a></td><td>Returns the standard error of the mean in the specified axis</td>
  </tr>
  <tr>
    <td><a href="ref_df_select_dtypes.asp">select_dtypes()</a></td><td>Returns a 
  DataFrame with columns of selected data types</td>
  </tr>
  <tr>
    <td><a href="ref_df_shape.asp">shape</a></td><td>Returns the number of rows 
  and columns of the DataFrame</td>
  </tr>
  <tr>
    <td><a href="ref_df_set_axis.asp">set_axis()</a></td><td>Sets the index of the specified axis</td>
  </tr>
  <tr>
    <td>set_flags()</td><td>Returns a new DataFrame with the specified flags</td>
  </tr>
  <tr>
    <td><a href="ref_df_set_index.asp">set_index()</a></td><td>Set the Index of the DataFrame</td>
  </tr>
  <tr>
    <td><a href="ref_df_size.asp">size</a></td><td>Returns the number of elements in the DataFrame</td>
  </tr>
  <tr>
    <td><a href="ref_df_skew.asp">skew()</a></td><td>Returns the skew of the values in the specified axis</td>
  </tr>
  <tr>
    <td><a href="ref_df_sort_index.asp">sort_index()</a></td><td>Sorts the DataFrame according to the labels</td>
  </tr>
  <tr>
    <td><a href="ref_df_sort_values.asp">sort_values()</a></td><td>Sorts the DataFrame according to the values</td>
  </tr>
  <tr>
    <td><a href="ref_df_squeeze.asp">squeeze()</a></td><td>Converts a single 
  column DataFrame into a Series</td>
  </tr>
  <tr>
    <td><a href="ref_df_stack.asp">stack()</a></td><td>Reshape the DataFrame 
    from a wide table to a long table</td>
  </tr>
  <tr>
    <td><a href="ref_df_std.asp">std()</a></td><td>Returns the standard deviation of the values in the 
  specified axis</td>
  </tr>
  <tr>
    <td><a href="ref_df_sum.asp">sum()</a></td><td>Returns the sum of the values in the specified axis</td>
  </tr>
  <tr>
    <td><a href="ref_df_sub.asp">sub()</a></td><td>Subtracts the values of a DataFrame 
  with the specified value(s)</td>
  </tr>
  <tr>
    <td>swaplevel()</td><td>Swaps the two specified levels</td>
  </tr>
  <tr>
    <td><a href="ref_df_t.asp">T</a></td><td>Turns rows into columns and columns 
  into rows</td>
  </tr>
  <tr>
    <td><a href="ref_df_tail.asp">tail()</a></td><td>Returns the headers and the last rows</td>
  </tr>
  <tr>
    <td><a href="ref_df_take.asp">take()</a></td><td>Returns the specified elements</td>
  </tr>
  <tr>
    <td>to_xarray()</td><td>Returns an xarray object</td>
  </tr>
<!--  <tr>
    <td><a href="ref_df_to_json.asp">to_json()</a></td><td>Returns the content 
    of the DataFrame as JSON</td>
  </tr>-->
  <tr>
    <td><a href="ref_df_transform.asp">transform()</a></td><td>Execute a function for each value in the 
  DataFrame</td>
  </tr>
  <tr>
    <td><a href="ref_df_transpose.asp">transpose()</a></td><td>Turns rows into 
  columns and columns into rows</td>
  </tr>
  <tr>
    <td><a href="ref_df_truediv.asp">truediv()</a></td><td>Divides the values of 
  a DataFrame with the specified value(s)</td>
  </tr>
  <tr>
    <td><a href="ref_df_truncate.asp">truncate()</a></td><td>Removes elements 
  outside of a specified set of values</td>
  </tr>
  <tr>
    <td><a href="ref_df_update.asp">update()</a></td><td>Update one DataFrame with the values from another 
    DataFrame</td>
  </tr>
  <tr>
    <td>value_counts()</td><td>Returns the number of unique rows</td>
  </tr>
<tr><td><a href="ref_df_values.asp">values</a></td><td>Returns the DataFrame as a NumPy array</td></tr>
  <tr>
    <td><a href="ref_df_var.asp">var()</a></td><td>Returns the variance of the values in the specified axis</td>
  </tr>
  <tr>
    <td><a href="ref_df_where.asp">where()</a></td><td>Replace all values where the specified condition is False</td>
  </tr>
  <tr>
    <td><a href="ref_df_xs.asp">xs()</a></td><td>Returns the cross-section of the DataFrame</td>
  </tr>
<tr><td><a href="ref_df_iter.asp">__iter__()</a></td><td>Returns an iterator of the info axes</td></tr>
<!--<tr><td>asfreq()</td><td>Convert TimeSeries</td></tr>
<tr><td>asof()</td><td>Returns the last rows before the specified condition</td></tr>
<tr><td>shift()</td><td>Shift index</td></tr>
<tr><td>first_valid_index()</td><td>Returns the index of the first valid value</td></tr>
<tr><td>last_valid_index()</td><td>Returns the index of the last valid value</td></tr>
<tr><td>resample()</td><td>Resample TimeSeries cells</td></tr>
<tr><td>tz_convert()</td><td>Convert time zone</td></tr>
<tr><td>tz_localize()</td><td>??</td></tr>
<tr><td>at_time()</td><td>Select time values with the exact time</td></tr>
<tr><td>between_time()</td><td>Select time values between the specified times</td></tr>
<tr><td>to_period()</td><td>Convert from DatetimeIndex to PeriodIndex</td></tr>
<tr><td>to_timestamp()</td><td>Convert to DatetimeIndex</td></tr>-->
</table>
