...
<h1>Pandas <span class="color_h1">Read JSON</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="pandas_csv.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="pandas_analyzing.asp">Next &#10095;</a>
</div>
<hr>
...
<p><a href="data.js" target="_blank">Open data.json</a>.</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Load the JSON file into a DataFrame:</p>
<div class="w3-code notranslate pythonHigh">
  import pandas as pd<br><br>df = pd.read_json('data.json')<br><br>print(df.to_string())&nbsp;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypandas.asp?filename=demo_pandas_json">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p><strong>Tip:</strong> use <code class="w3-codespan">to_string()</code> to print the entire DataFrame.</p>
</div>
...
<div class="w3-panel ws-note">
  ...
  <p>JSON objects have the same format as Python dictionaries.</p>
</div>

<p>If your JSON code is not in a file, but in a Python Dictionary, you can load it into a DataFrame 
directly:</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Load a Python Dictionary into a DataFrame:</p>
<div class="w3-code notranslate pythonHigh">
  import pandas as pd<br><br>data = {<br>&nbsp; &quot;Duration&quot;:{<br>&nbsp;&nbsp;&nbsp; 
  &quot;0&quot;:60,<br>&nbsp;&nbsp;&nbsp; &quot;1&quot;:60,<br>&nbsp;&nbsp;&nbsp; &quot;2&quot;:60,<br>&nbsp;&nbsp;&nbsp; 
  &quot;3&quot;:45,<br>&nbsp;&nbsp;&nbsp; &quot;4&quot;:45,<br>&nbsp;&nbsp;&nbsp; &quot;5&quot;:60<br>&nbsp; 
  },<br>&nbsp; &quot;Pulse&quot;:{<br>&nbsp;&nbsp;&nbsp; &quot;0&quot;:110,<br>&nbsp;&nbsp;&nbsp; 
  &quot;1&quot;:117,<br>&nbsp;&nbsp;&nbsp; &quot;2&quot;:103,<br>&nbsp;&nbsp;&nbsp; &quot;3&quot;:109,<br>&nbsp;&nbsp;&nbsp; 
  &quot;4&quot;:117,<br>&nbsp;&nbsp;&nbsp; &quot;5&quot;:102<br>&nbsp; },<br>&nbsp; &quot;Maxpulse&quot;:{<br>&nbsp;&nbsp;&nbsp; 
  &quot;0&quot;:130,<br>&nbsp;&nbsp;&nbsp; &quot;1&quot;:145,<br>&nbsp;&nbsp;&nbsp; &quot;2&quot;:135,<br>&nbsp;&nbsp;&nbsp; 
  &quot;3&quot;:175,<br>&nbsp;&nbsp;&nbsp; &quot;4&quot;:148,<br>&nbsp;&nbsp;&nbsp; &quot;5&quot;:127<br>&nbsp; 
  },<br>&nbsp; &quot;Calories&quot;:{<br>&nbsp;&nbsp;&nbsp; &quot;0&quot;:409,<br>&nbsp;&nbsp;&nbsp; 
  &quot;1&quot;:479,<br>&nbsp;&nbsp;&nbsp; &quot;2&quot;:340,<br>&nbsp;&nbsp;&nbsp; &quot;3&quot;:282,<br>&nbsp;&nbsp;&nbsp; 
  &quot;4&quot;:406,<br>&nbsp;&nbsp;&nbsp; &quot;5&quot;:300<br>&nbsp; }<br>}<br><br>
  df = pd.DataFrame(data)<br><br>print(df)&nbsp;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_pandas_json_dict">Try it Yourself &raquo;</a>
</div>
