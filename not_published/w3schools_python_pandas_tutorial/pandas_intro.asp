...
<html lang="en-US">
<head>
<title>Pandas Introduction</title>
<meta charset="utf-8">
...
<h1>Pandas <span class="color_h1">Introduction</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="default.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="pandas_getting_started.asp">Next &#10095;</a>
</div>
...
<p>Pandas allows us to analyze big data and make conclusions based on 
statistical theories.</p>
...
<div class="w3-panel ws-note">
  <div class="w3-hide-small" style="float:left;font-size:50px;color:#04AA6D;margin-right:20px;">:}</div>
...
<hr>
<h2>Where is the Pandas Codebase?</h2>
...
<div class="w3-panel ws-note">
 <div class="w3-hide-small" style="float:right;font-size:50px;color:#04AA6D">{:</div>
  <p style="margin-top:25px;"><strong>github:</strong> enables many people to work on the same 
  codebase.</p>
</div>
