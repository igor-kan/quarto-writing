...
<h1>Pandas - <span class="color_h1">Cleaning Data</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="pandas_analyzing.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="pandas_cleaning_empty_cells.asp">Next &#10095;</a>
</div>
<hr>

<h2>Data Cleaning</h2>

<p>Data cleaning means fixing bad data in your data set.</p>
...
<p>In this tutorial you will learn how to deal with all of them.</p>
<hr>

<h2>Our Data Set</h2>

<p>In the next chapters we will use this data set:</p>
...
<p>The data set contains some empty cells (&quot;Date&quot; in row 22, and "Calories" in row 18 and 28).</p>

<p>The data set contains wrong format ("Date" in row 26).</p>

<p>The data set contains wrong data ("Duration" in row 7).</p>

<p>The data set contains duplicates (row 11 and 12).</p>
