...
<html lang="en-US">
<head>
<title>Pandas - Analyzing DataFrames</title>
<meta charset="utf-8">
...
<h1>Pandas - <span class="color_h1">Analyzing DataFrames</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="pandas_json.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="pandas_cleaning.asp">Next &#10095;</a>
</div>
<hr>

<h2>Viewing the Data</h2>

<p>One of the most used method for getting a quick overview of the DataFrame, is the <code class="w3-codespan">head()</code> method.</p>

<p>The <code class="w3-codespan">head()</code> method returns the headers and 
a specified number of rows, starting from the top.</p>


<div class="w3-example">
  <h3>Example</h3>
  <p>Get a quick overview by printing the first 10 rows of the DataFrame:</p>
<div class="w3-code notranslate pythonHigh">
  import pandas as pd<br><br>df = pd.read_csv('data.csv')<br><br>print(df.head(10))</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypandas.asp?filename=demo_pandas_head10">Try it Yourself &raquo;</a>
</div>

<p>In our examples we will be using a CSV file called 'data.csv'.</p>
<p>Download <a href="data.csv">data.csv</a>, or open
<a href="data.csv.txt" target="_blank">data.csv</a> in your browser.</p>
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> if the number of rows is not specified, the <code class="w3-codespan">head()</code> method 
  will return 
  the top 5 rows.</p>
</div>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Print the first 5 rows of the DataFrame:</p>
<div class="w3-code notranslate pythonHigh">
  import pandas as pd<br><br>df = pd.read_csv('data.csv')<br><br>print(df.head())</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypandas.asp?filename=demo_pandas_head">Try it Yourself &raquo;</a>
</div>


<p>There is also a <code class="w3-codespan">tail()</code> method for viewing the 
<em>last</em> rows of the DataFrame.</p>

<p>The <code class="w3-codespan">tail()</code> method returns the headers and 
a specified number of rows, starting from the bottom.</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Print the last 5 rows of the DataFrame:</p>
<div class="w3-code notranslate pythonHigh">
  print(df.tail())&nbsp;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypandas.asp?filename=demo_pandas_tail">Try it Yourself &raquo;</a>
</div>
...
<h2>Info About the Data</h2>

<p>The DataFrames object has a method called <code class="w3-codespan">info()</code>, that 
gives you more information about 
the data set.</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Print information about the data:</p>
  <div class="w3-code notranslate pythonHigh">
    print(df.info())&nbsp;
  </div>
  <h2>Result</h2>
  ...
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypandas.asp?filename=demo_pandas_info">Try it Yourself &raquo;</a>
</div>

<h2>Result Explained</h2>

<p>The result tells us there are 169 rows and 4 columns:</p>
<div style="background-color:rgb(40,44,52);color:#fff;">
<pre>
...
<p>And the name of each column, with the data type:</p>
<div style="background-color:rgb(40,44,52);color:#fff;">
<pre>
...
<h2>Null Values</h2>
<p>The <code class="w3-codespan">info()</code> method also tells us how many Non-Null values there are present in each column,
and in our data set it seems like there are 164 of 169 Non-Null values in the "Calories" column.</p>
<p>Which means that there are 5 rows with no value at all, in the "Calories" column, for whatever reason.</p>
<p>Empty values, or Null values, can be bad when analyzing data,
and you should consider removing rows with empty values.
This is a step towards what is called <em>cleaning data</em>,
and you will learn more about that in the next chapters.</p>



<hr>
<div id="exercisecontainer" src="xrcise_analyzing.js"></div>
<hr>
