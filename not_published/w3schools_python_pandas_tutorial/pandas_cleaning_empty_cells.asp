...
<html lang="en-US">
<head>
<title>Pandas - Cleaning Empty Cells</title>
<meta charset="utf-8">
...
<h1>Pandas - <span class="color_h1">Cleaning Empty Cells</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="pandas_cleaning.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="pandas_cleaning_wrong_format.asp">Next &#10095;</a>
</div>
<hr>

<h2>Empty Cells</h2>

<p>Empty cells can potentially give you a wrong result when you analyze data.</p>

<hr>

<h2>Remove Rows</h2>
<p>One way to deal with empty cells is to remove rows that contain empty cells.</p>
<p>This is usually OK, since data sets can be very big, and removing a few rows 
will not have a big impact on the result.</p>


<div class="w3-example">
  <h3>Example</h3>
  <p>Return a new Data Frame with no empty cells:</p>
<div class="w3-code notranslate pythonHigh">
  import pandas as pd<br><br>df = pd.read_csv('data.csv')<br>
  <br>new_df = df.dropna()<br><br>print(new_df.to_string())<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypandas.asp?filename=demo_pandas_cleaning_dropna">Try it Yourself &raquo;</a>
</div>

<!--
<p>In our cleaning examples we will be using a CSV file called 'dirtydata.csv'.</p>
<p><a href="dirtydata.csv">Download dirtydata.csv</a>. or <a href="dirtydata.csv.txt" target="_blank">Open 
dirtydata.csv</a></p>
-->

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> By default, the <code class="w3-codespan">dropna()</code> method returns 
  a <em>new</em> DataFrame, and will not change the original.</p>
</div>

<p>If you want to change the original DataFrame, use the
<code class="w3-codespan">inplace = True</code> argument:</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Remove all rows with NULL values:</p>
<div class="w3-code notranslate pythonHigh">
  import pandas as pd<br><br>df = pd.read_csv('data.csv')<br><br>df.dropna(inplace = True)<br>
  <br>print(df.to_string())</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypandas.asp?filename=demo_pandas_cleaning_dropna2">Try it Yourself &raquo;</a>
</div>
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> Now, the <code class="w3-codespan">dropna(inplace = True)</code> will NOT return a new DataFrame, but it will remove all rows containing NULL values from the original DataFrame.</p>
</div>

<hr>
<h2>Replace Empty Values</h2>

<p>Another way of dealing with empty cells is to insert a <em>new</em> value instead.</p>

<p>This way you do not have to delete entire rows just because of some empty 
cells.</p>

<p>The <code class="w3-codespan">fillna()</code> method allows us to replace empty 
cells with a value:</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Replace NULL values with the number 130:</p>
<div class="w3-code notranslate pythonHigh">
  import pandas as pd<br><br>df = pd.read_csv('data.csv')<br><br>df.fillna(130, inplace = True)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypandas.asp?filename=demo_pandas_cleaning_fillna">Try it Yourself &raquo;</a>
</div>

<h3>Replace Only For Specified Columns</h3>

<p>The example above replaces all empty cells in the whole Data Frame.</p>

<p>To only replace empty values for one column,
specify the <em>column name</em> for the DataFrame:</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Replace NULL values in the &quot;Calories&quot; columns with the number 130:</p>
<div class="w3-code notranslate pythonHigh">
  import pandas as pd<br><br>df = pd.read_csv('data.csv')<br><br>
  df.fillna({&quot;Calories&quot;: 130}, inplace=True)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypandas.asp?filename=demo_pandas_cleaning_fillna2">Try it Yourself &raquo;</a>
</div>
...
<h2>Replace Using Mean, Median, or Mode</h2>
<p>A common way to replace empty cells, is to calculate the mean, median or mode value of the 
column.</p>
<p>Pandas uses the <code class="w3-codespan">mean()</code> 
<code class="w3-codespan">median()</code> and <code class="w3-codespan">mode()</code> methods to 
calculate the respective values for a specified column:</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Calculate the MEAN, and replace any empty values with it:</p>
<div class="w3-code notranslate pythonHigh">
  import pandas as pd<br><br>df = pd.read_csv('data.csv')<br>
  <br>x = df[&quot;Calories&quot;].mean()<br><br>df.fillna({&quot;Calories&quot;: x}, 
  inplace=True)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypandas.asp?filename=demo_pandas_cleaning_fillna_mean">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p><strong>Mean</strong> = the average value (the sum of all values divided by number of values).</p>
</div>

<div class="w3-example">
  <h3>Example</h3>
  <p>Calculate the MEDIAN, and replace any empty values with it:</p>
<div class="w3-code notranslate pythonHigh">
  import pandas as pd<br><br>df = pd.read_csv('data.csv')<br>
  <br>x = df[&quot;Calories&quot;].median()<br><br>df.fillna({&quot;Calories&quot;: x}, 
  inplace=True)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypandas.asp?filename=demo_pandas_cleaning_fillna3">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p><strong>Median</strong> = the value in the middle, after you have sorted all values 
  ascending.</p>
</div>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Calculate the MODE, and replace any empty values with it:</p>
<div class="w3-code notranslate pythonHigh">
  import pandas as pd<br><br>df = pd.read_csv('data.csv')<br>
  <br>x = df[&quot;Calories&quot;].mode()[0]<br><br>df.fillna({&quot;Calories&quot;: x}, 
  inplace=True)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypandas.asp?filename=demo_pandas_cleaning_fillna_mode">Try it Yourself &raquo;</a>
</div>
<div class="w3-panel ws-note">
  <p><strong>Mode</strong> = the value that appears most frequently.</p>
</div>


<hr>
<div id="exercisecontainer" src="xrcise_cleaning_empty_cells.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="pandas_cleaning.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="pandas_cleaning_wrong_format.asp">Next &#10095;</a>
