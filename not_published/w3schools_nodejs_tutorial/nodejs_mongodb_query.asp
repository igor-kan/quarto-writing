...
<meta name="title" property="og:title" content="Node.js MongoDB Query">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_mongodb_query.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="When finding documents in a collection, you can filter the result by using a query object.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js MongoDB Query">
<meta name="twitter:description" content="When finding documents in a collection, you can filter the result by using a query object.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_mongodb_query.png">
...
<div class="w3-code notranslate jsHigh">
  ...
  <strong>&nbsp; let query = { address: &quot;Park Lane 38&quot; };<br></strong>&nbsp; dbo.collection(&quot;customers&quot;).find(<strong>query</strong>).toArray(function(err, result) {<br>&nbsp;&nbsp;&nbsp; if (err) throw err;<br>&nbsp;&nbsp;&nbsp; console.log(result);<br>&nbsp;&nbsp;&nbsp; db.close();<br>&nbsp; 
  });<br>});</div>
...
<div class="w3-code notranslate jsHigh">
  ...
  let url = &quot;mongodb://localhost:27017/&quot;;<br><br>MongoClient.connect(url, function(err, db) {<br>&nbsp; if (err) throw err;<br>&nbsp; 
  let dbo = db.db(&quot;mydb&quot;);<br>
  &nbsp; let query = { address: <strong>/^S/</strong> };<br>&nbsp; dbo.collection(&quot;customers&quot;).find(query).toArray(function(err, result) {<br>&nbsp;&nbsp;&nbsp; if (err) throw err;<br>&nbsp;&nbsp;&nbsp; console.log(result);<br>&nbsp;&nbsp;&nbsp; db.close();<br>&nbsp; 
  });<br>});</div>
...
<hr>
<div id="exercisecontainer" src="xrcise_mongodb_query.js" data-extensions="asp"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_mongodb_find.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="nodejs_mongodb_sort.asp">Next &#10095;</a>
