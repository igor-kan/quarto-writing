...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Performance Hooks Module</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js Performance Hooks Module">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_perf_hooks.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="The perf_hooks module provides a set of APIs for performance measurement based on the W3C Performance Timeline specification.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Performance Hooks Module">
<meta name="twitter:description" content="The perf_hooks module provides a set of APIs for performance measurement based on the W3C Performance Timeline specification.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_perf_hooks.png">
...
<h1>Node.js Performance Hooks Module</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_http2.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="nodejs_vm.asp">Next &#10095;</a>
</div>


<hr>

<h2>What are Performance Hooks?</h2>
<p>The <code class="w3-codespan">perf_hooks</code> module provides a set of APIs for performance measurement based on the <a href="https://www.w3.org/TR/performance-timeline/" target="_blank">W3C Performance Timeline specification</a>.</p>
<p>These tools are essential for:</p>

<ul>
  <li>Measuring the time taken by specific operations</li>
  <li>Finding performance bottlenecks</li>
  <li>Comparing the performance of different implementations</li>
  <li>Tracking application performance over time</li>
</ul>

<p>The module includes several useful features such as high-resolution timers, performance marks, measures, observers, and histograms.</p>

<hr>

<h2>Using the Performance Hooks Module</h2>

<p>To use the Performance Hooks module, you need to require it in your code:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// Import the entire module<br>
const { performance, PerformanceObserver } = require('perf_hooks');<br>
<br>
// Or using destructuring for specific parts<br>
const { performance } = require('perf_hooks');
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_perf_hooks_require">Run example &raquo;</a>
</div>

<hr>

<h2>Basic Time Measurement</h2>

<p>The most basic use of the performance API is to measure elapsed time with high precision:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const { performance } = require('perf_hooks');<br>
<br>
// Get the current high-resolution time<br>
...
<br>
// Calculate and display the elapsed time in milliseconds<br>
console.log(`Operation took ${(endTime - startTime).toFixed(2)} milliseconds`);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_perf_hooks_now">Run example &raquo;</a>
</div>

<p>The <code class="w3-codespan">performance.now()</code> method returns a high-resolution timestamp in milliseconds, measured from the time the current Node.js process started.</p>
...
<h2>Performance Marks and Measures</h2>

<h3>Marks</h3>

<p>Performance marks are specific points in time that you want to track:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const { performance } = require('perf_hooks');<br>
<br>
// Create marks at specific points in your code<br>
performance.mark('startProcess');<br>
<br>
...
<br>
// Create another mark<br>
performance.mark('endProcess');<br>
<br>
// Get all the marks<br>
console.log(performance.getEntriesByType('mark'));
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_perf_hooks_marks">Run example &raquo;</a>
</div>

<h3>Measures</h3>

<p>Performance measures calculate the time duration between two marks:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const { performance } = require('perf_hooks');<br>
<br>
// Create a start mark<br>
performance.mark('start');<br>
<br>
// Simulate some work<br>
let result = 0;<br>
for (let i = 0; i &lt; 1000000; i++) {<br>
...
<br>
// Create an end mark<br>
performance.mark('end');<br>
<br>
// Create a measure between the two marks<br>
performance.measure('processTime', 'start', 'end');<br>
<br>
// Get the measure<br>
const measure = performance.getEntriesByName('processTime')[0];<br>
console.log(`Process took ${measure.duration.toFixed(2)} milliseconds`);<br>
<br>
// Clear marks and measures<br>
performance.clearMarks();<br>
performance.clearMeasures();
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_perf_hooks_measures">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">PerformanceObserver</code> allows you to observe performance events asynchronously:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const { performance, PerformanceObserver } = require('perf_hooks');<br>
<br>
// Create a performance observer<br>
const obs = new PerformanceObserver((items) => {<br>
&nbsp;&nbsp;// Process all entries<br>
&nbsp;&nbsp;const entries = items.getEntries();<br>
&nbsp;&nbsp;entries.forEach((entry) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Name: ${entry.name}, Type: ${entry.entryType}, Duration: ${entry.duration.toFixed(2)}ms`);<br>
&nbsp;&nbsp;});<br>
});<br>
<br>
// Subscribe to specific entry types<br>
obs.observe({ entryTypes: ['measure'] });<br>
<br>
// First task<br>
performance.mark('task1Start');<br>
// Simulate work<br>
setTimeout(() => {<br>
&nbsp;&nbsp;performance.mark('task1End');<br>
&nbsp;&nbsp;performance.measure('Task 1', 'task1Start', 'task1End');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Second task<br>
&nbsp;&nbsp;performance.mark('task2Start');<br>
&nbsp;&nbsp;setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;performance.mark('task2End');<br>
&nbsp;&nbsp;&nbsp;&nbsp;performance.measure('Task 2', 'task2Start', 'task2End');<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Clean up<br>
&nbsp;&nbsp;&nbsp;&nbsp;performance.clearMarks();<br>
&nbsp;&nbsp;&nbsp;&nbsp;performance.clearMeasures();<br>
&nbsp;&nbsp;&nbsp;&nbsp;obs.disconnect();<br>
&nbsp;&nbsp;}, 1000);<br>
}, 1000);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_perf_hooks_observer">Run example &raquo;</a>
</div>

<hr>

<h2>Performance Timeline API</h2>

<p>The Performance Timeline API provides methods to retrieve performance entries:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const { performance } = require('perf_hooks');<br>
<br>
// Create some performance entries<br>
performance.mark('mark1');<br>
performance.mark('mark2');<br>
<br>
let sum = 0;<br>
...
<br>
performance.mark('mark3');<br>
performance.measure('measure1', 'mark1', 'mark2');<br>
performance.measure('measure2', 'mark2', 'mark3');<br>
<br>
// Get all performance entries<br>
console.log('All entries:');<br>
console.log(performance.getEntries());<br>
<br>
// Get entries by type<br>
console.log('\nMarks:');<br>
console.log(performance.getEntriesByType('mark'));<br>
<br>
// Get entries by name<br>
console.log('\nMeasure 1:');<br>
console.log(performance.getEntriesByName('measure1'));
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_perf_hooks_timeline">Run example &raquo;</a>
</div>

<hr>

<h2>Performance Timing Levels</h2>

<p>Node.js provides different performance timing APIs with varying levels of precision:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const { performance, monitorEventLoopDelay } = require('perf_hooks');<br>
<br>
// 1. Date.now() - millisecond precision<br>
const dateStart = Date.now();<br>
const dateEnd = Date.now();<br>
console.log(`Date.now() difference: ${dateEnd - dateStart}ms`);<br>
<br>
// 2. process.hrtime() - nanosecond precision<br>
const hrStart = process.hrtime();<br>
const hrEnd = process.hrtime(hrStart);<br>
console.log(`process.hrtime() difference: ${hrEnd[0]}s ${hrEnd[1]}ns`);<br>
<br>
// 3. performance.now() - microsecond precision<br>
const perfStart = performance.now();<br>
const perfEnd = performance.now();<br>
console.log(`performance.now() difference: ${(perfEnd - perfStart).toFixed(6)}ms`);<br>
<br>
// 4. Event loop delay monitoring (available in Node.js 12.0.0+)<br>
const histogram = monitorEventLoopDelay({ resolution: 20 });<br>
histogram.enable();<br>
<br>
setTimeout(() => {<br>
&nbsp;&nbsp;histogram.disable();<br>
&nbsp;&nbsp;console.log('Event loop delay metrics:');<br>
&nbsp;&nbsp;console.log(`&nbsp;&nbsp;Min: ${histogram.min}ns`);<br>
&nbsp;&nbsp;console.log(`&nbsp;&nbsp;Max: ${histogram.max}ns`);<br>
&nbsp;&nbsp;console.log(`&nbsp;&nbsp;Mean: ${histogram.mean.toFixed(2)}ns`);<br>
&nbsp;&nbsp;console.log(`&nbsp;&nbsp;Stddev: ${histogram.stddev.toFixed(2)}ns`);<br>
&nbsp;&nbsp;console.log(`&nbsp;&nbsp;Percentiles: 50=${histogram.percentile(50).toFixed(2)}ns, 99=${histogram.percentile(99).toFixed(2)}ns`);<br>
}, 1000);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_perf_hooks_timing_levels">Run example &raquo;</a>
</div>

<hr>

<h2>Event Loop Monitoring</h2>

<p>The <code class="w3-codespan">monitorEventLoopDelay</code> function provides a way to monitor the delay in the event loop:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const { monitorEventLoopDelay } = require('perf_hooks');<br>
<br>
// Create a histogram<br>
const histogram = monitorEventLoopDelay({ resolution: 10 });<br>
<br>
// Enable monitoring<br>
histogram.enable();<br>
<br>
// Simulate load on the event loop<br>
const operations = [];<br>
for (let i = 0; i &lt; 10; i++) {<br>
&nbsp;&nbsp;operations.push(new Promise((resolve) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Simulate CPU-intensive work<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;let sum = 0;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;for (let j = 0; j &lt; 10000000; j++) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;sum += j;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;resolve(sum);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}, 100);<br>
...
<br>
// After all operations complete<br>
Promise.all(operations).then(() => {<br>
&nbsp;&nbsp;// Disable monitoring<br>
&nbsp;&nbsp;histogram.disable();<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Print statistics<br>
&nbsp;&nbsp;console.log('Event Loop Delay Statistics:');<br>
&nbsp;&nbsp;console.log(`&nbsp;&nbsp;Min: ${histogram.min}ns`);<br>
&nbsp;&nbsp;console.log(`&nbsp;&nbsp;Max: ${histogram.max}ns`);<br>
&nbsp;&nbsp;console.log(`&nbsp;&nbsp;Mean: ${histogram.mean.toFixed(2)}ns`);<br>
&nbsp;&nbsp;console.log(`&nbsp;&nbsp;Stddev: ${histogram.stddev.toFixed(2)}ns`);<br>
...
&nbsp;&nbsp;// Percentiles<br>
&nbsp;&nbsp;console.log('\nPercentiles:');<br>
&nbsp;&nbsp;[1, 10, 50, 90, 99, 99.9].forEach((p) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`&nbsp;&nbsp;p${p}: ${histogram.percentile(p).toFixed(2)}ns`);<br>
&nbsp;&nbsp;});<br>
});
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_perf_hooks_event_loop">Run example &raquo;</a>
</div>

<div class="w3-panel w3-note">
<p>Event loop monitoring is particularly useful for detecting when your application might be experiencing issues with responsiveness due to long-running tasks blocking the event loop.</p>
</div>

<hr>

<h2>Performance Tracking in Async Operations</h2>

<p>Tracking performance in asynchronous operations requires careful mark placement:</p>
...
<br>
// Create observer for the measures<br>
const obs = new PerformanceObserver((items) => {<br>
&nbsp;&nbsp;items.getEntries().forEach((entry) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`${entry.name}: ${entry.duration.toFixed(2)}ms`);<br>
&nbsp;&nbsp;});<br>
});<br>
obs.observe({ entryTypes: ['measure'] });<br>
<br>
// Measure async file read operation<br>
performance.mark('readStart');<br>
<br>
fs.readFile(__filename, (err, data) => {<br>
&nbsp;&nbsp;if (err) throw err;<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;performance.mark('readEnd');<br>
&nbsp;&nbsp;performance.measure('File Read', 'readStart', 'readEnd');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Measure async processing time<br>
&nbsp;&nbsp;performance.mark('processStart');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Simulate processing the file data<br>
&nbsp;&nbsp;setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const lines = data.toString().split('\n').length;<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;performance.mark('processEnd');<br>
&nbsp;&nbsp;&nbsp;&nbsp;performance.measure('File Processing', 'processStart', 'processEnd');<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`File has ${lines} lines`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Clean up<br>
&nbsp;&nbsp;&nbsp;&nbsp;performance.clearMarks();<br>
&nbsp;&nbsp;&nbsp;&nbsp;performance.clearMeasures();<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_perf_hooks_async">Run example &raquo;</a>
</div>

<hr>

<h2>Tracking Promises</h2>

<p>Measuring the performance of promises requires similar techniques:</p>
...
obs.observe({ entryTypes: ['measure'] });<br>
<br>
// Function that returns a promise<br>
function fetchData(delay) {<br>
&nbsp;&nbsp;return new Promise((resolve) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;resolve({ data: 'Sample data' });<br>
&nbsp;&nbsp;&nbsp;&nbsp;}, delay);<br>
&nbsp;&nbsp;});<br>
}<br>
<br>
// Function to process data<br>
function processData(data) {<br>
&nbsp;&nbsp;return new Promise((resolve) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;resolve({ processed: data.data.toUpperCase() });<br>
&nbsp;&nbsp;&nbsp;&nbsp;}, 200);<br>
&nbsp;&nbsp;});<br>
}<br>
<br>
// Measure Promise chain<br>
async function run() {<br>
&nbsp;&nbsp;performance.mark('fetchStart');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;const data = await fetchData(300);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;performance.mark('fetchEnd');<br>
&nbsp;&nbsp;performance.mark('processStart');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;const processed = await processData(data);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;performance.mark('processEnd');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Create measures<br>
&nbsp;&nbsp;performance.measure('Fetch Data', 'fetchStart', 'fetchEnd');<br>
&nbsp;&nbsp;performance.measure('Process Data', 'processStart', 'processEnd');<br>
&nbsp;&nbsp;performance.measure('Total Operation', 'fetchStart', 'processEnd');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;console.log('Result:', processed);<br>
}<br>
<br>
run().finally(() => {<br>
&nbsp;&nbsp;// Clear after execution<br>
&nbsp;&nbsp;performance.clearMarks();<br>
&nbsp;&nbsp;performance.clearMeasures();<br>
});
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_perf_hooks_promises">Run example &raquo;</a>
</div>

<hr>

<h2>Performance Timing Caveats</h2>

<p>When using performance APIs, be aware of certain caveats:</p>

<ul>
  <li>Timing resolution varies between platforms</li>
  <li>Clock drift can occur in long-running processes</li>
  <li>Background activity can affect timing measurements</li>
  <li>JavaScript JIT compilation can cause inconsistent first-run times</li>
</ul>
...
const { performance } = require('perf_hooks');<br>
<br>
// For accurate benchmarking, perform multiple runs<br>
function benchmark(fn, iterations = 1000) {<br>
&nbsp;&nbsp;// Warm-up run (for JIT optimization)<br>
&nbsp;&nbsp;fn();<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;const times = [];<br>
&nbsp;&nbsp;<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;times.push(end - start);<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Calculate statistics<br>
&nbsp;&nbsp;times.sort((a, b) => a - b);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;const sum = times.reduce((a, b) => a + b, 0);<br>
&nbsp;&nbsp;const avg = sum / times.length;<br>
&nbsp;&nbsp;const median = times[Math.floor(times.length / 2)];<br>
&nbsp;&nbsp;const min = times[0];<br>
&nbsp;&nbsp;const max = times[times.length - 1];<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;return {<br>
&nbsp;&nbsp;&nbsp;&nbsp;average: avg,<br>
&nbsp;&nbsp;&nbsp;&nbsp;median: median,<br>
&nbsp;&nbsp;&nbsp;&nbsp;min: min,<br>
&nbsp;&nbsp;&nbsp;&nbsp;max: max,<br>
&nbsp;&nbsp;&nbsp;&nbsp;samples: times.length<br>
&nbsp;&nbsp;};<br>
}<br>
<br>
// Example usage<br>
function testFunction() {<br>
&nbsp;&nbsp;// Function to benchmark<br>
&nbsp;&nbsp;let x = 0;<br>
...
<br>
const results = benchmark(testFunction);<br>
console.log('Benchmark Results:');<br>
console.log(`&nbsp;&nbsp;Samples: ${results.samples}`);<br>
console.log(`&nbsp;&nbsp;Average: ${results.average.toFixed(4)}ms`);<br>
console.log(`&nbsp;&nbsp;Median: ${results.median.toFixed(4)}ms`);<br>
console.log(`&nbsp;&nbsp;Min: ${results.min.toFixed(4)}ms`);<br>
console.log(`&nbsp;&nbsp;Max: ${results.max.toFixed(4)}ms`);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_perf_hooks_benchmarking">Run example &raquo;</a>
</div>
...
<p>The Node.js Performance Hooks API is based on the W3C Performance Timeline specification, but there are some differences compared to the browser's Performance API:</p>

<div class="w3-responsive">
<table class="ws-table-all">
  <tr>
    <th>Feature</th>
    <th>Browser Performance API</th>
    <th>Node.js Performance Hooks</th>
  </tr>
  <tr>
    <td>Time Origin</td>
    <td>Page navigation start</td>
  ...
  <tr>
    <td>User Timing (mark/measure)</td>
    <td>Available</td>
    <td>Available</td>
  </tr>
  <tr>
...
<h2>Practical Example: API Performance Monitoring</h2>

<p>A practical example of using performance hooks to monitor API endpoints:</p>
...
const port = 8080;<br>
<br>
// Set up performance observer for logging<br>
const obs = new PerformanceObserver((items) => {<br>
&nbsp;&nbsp;items.getEntries().forEach((entry) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`[${new Date().toISOString()}] ${entry.name}: ${entry.duration.toFixed(2)}ms`);<br>
&nbsp;&nbsp;});<br>
});<br>
obs.observe({ entryTypes: ['measure'] });<br>
<br>
// Middleware to track request processing time<br>
app.use((req, res, next) => {<br>
&nbsp;&nbsp;const start = performance.now();<br>
&nbsp;&nbsp;const requestId = `${req.method} ${req.url} ${Date.now()}`;<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Mark the start of request processing<br>
&nbsp;&nbsp;performance.mark(`${requestId}-start`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Override end method to capture when response is sent<br>
&nbsp;&nbsp;const originalEnd = res.end;<br>
&nbsp;&nbsp;res.end = function(...args) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;performance.mark(`${requestId}-end`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;performance.measure(<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`Request ${req.method} ${req.url}`,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`${requestId}-start`,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`${requestId}-end`<br>
&nbsp;&nbsp;&nbsp;&nbsp;);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Clean up marks<br>
&nbsp;&nbsp;&nbsp;&nbsp;performance.clearMarks(`${requestId}-start`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;performance.clearMarks(`${requestId}-end`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
...
<br>
app.get('/fast', (req, res) => {<br>
&nbsp;&nbsp;res.send('Fast response!');<br>
});<br>
<br>
app.get('/slow', (req, res) => {<br>
&nbsp;&nbsp;// Simulate a slow API endpoint<br>
&nbsp;&nbsp;setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.send('Slow response after delay');<br>
&nbsp;&nbsp;}, 500);<br>
});<br>
<br>
app.get('/process', (req, res) => {<br>
&nbsp;&nbsp;// Simulate CPU-intensive processing<br>
&nbsp;&nbsp;const requestId = `process-${Date.now()}`;<br>
&nbsp;&nbsp;performance.mark(`${requestId}-process-start`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;let result = 0;<br>
&nbsp;&nbsp;for (let i = 0; i &lt; 1000000; i++) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;result += Math.sqrt(i);<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;performance.mark(`${requestId}-process-end`);<br>
&nbsp;&nbsp;performance.measure(<br>
&nbsp;&nbsp;&nbsp;&nbsp;'CPU Processing',<br>
&nbsp;&nbsp;&nbsp;&nbsp;`${requestId}-process-start`,<br>
&nbsp;&nbsp;&nbsp;&nbsp;`${requestId}-process-end`<br>
&nbsp;&nbsp;);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;res.send(`Processed result: ${result}`);<br>
});<br>
<br>
// Start server<br>
app.listen(port, () => {<br>
&nbsp;&nbsp;console.log(`Performance monitoring example running at http://localhost:${port}`);<br>
});
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs.asp?filename=demo_perf_hooks_api_monitoring">Run example &raquo;</a>
</div>
...
<p>For production-grade applications, consider these advanced monitoring techniques:</p>

<h3>1. Memory Leak Detection</h3>
<p>Detect and analyze memory leaks using performance hooks and Node.js memory monitoring:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const { performance, PerformanceObserver } = require('perf_hooks');<br>
const { performance: perf } = require('process');<br>
<br>
class MemoryMonitor {<br>
&nbsp;&nbsp;constructor() {<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.leakThreshold = 10 * 1024 * 1024; // 10MB<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.checkInterval = 10000; // 10 seconds<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.interval = null;<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.lastMemoryUsage = process.memoryUsage();<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.leakDetected = false;<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Set up performance observer for GC events<br>
&nbsp;&nbsp;&nbsp;&nbsp;const obs = new PerformanceObserver((items) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;items.getEntries().forEach((entry) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (entry.name === 'gc') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;this.checkMemoryLeak();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;obs.observe({ entryTypes: ['gc'] });<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;start() {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Memory monitoring started');<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.interval = setInterval(() => this.checkMemoryLeak(), this.checkInterval);<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;stop() {<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (this.interval) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;clearInterval(this.interval);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Memory monitoring stopped');<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;checkMemoryLeak() {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const current = process.memoryUsage();<br>
&nbsp;&nbsp;&nbsp;&nbsp;const heapDiff = current.heapUsed - this.lastMemoryUsage.heapUsed;<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (heapDiff > this.leakThreshold) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;this.leakDetected = true;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.warn(`⚠️&nbsp;&nbsp;Possible memory leak detected: Heap increased by ${(heapDiff / 1024 / 1024).toFixed(2)}MB`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Memory snapshot:', {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;rss: this.formatMemory(current.rss),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;heapTotal: this.formatMemory(current.heapTotal),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;heapUsed: this.formatMemory(current.heapUsed),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;external: this.formatMemory(current.external)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Take a heap snapshot if needed<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (process.env.NODE_ENV === 'development') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;this.takeHeapSnapshot();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.lastMemoryUsage = current;<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;formatMemory(bytes) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;return `${(bytes / 1024 / 1024).toFixed(2)}MB`;<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;takeHeapSnapshot() {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const heapdump = require('heapdump');<br>
&nbsp;&nbsp;&nbsp;&nbsp;const filename = `heapdump-${Date.now()}.heapsnapshot`;<br>
&nbsp;&nbsp;&nbsp;&nbsp;heapdump.writeSnapshot(filename, (err, filename) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error('Failed to take heap snapshot:', err);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Heap snapshot written to ${filename}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
// Usage example<br>
const monitor = new MemoryMonitor();<br>
monitor.start();<br>
<br>
// Simulate a memory leak<br>
const leaks = [];<br>
setInterval(() => {<br>
&nbsp;&nbsp;for (let i = 0; i &lt; 1000; i++) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;leaks.push(new Array(1000).fill('*'.repeat(100)));<br>
&nbsp;&nbsp;}<br>
}, 1000);<br>
<br>
// Stop monitoring after 1 minute<br>
setTimeout(() => {<br>
&nbsp;&nbsp;monitor.stop();<br>
&nbsp;&nbsp;console.log('Memory monitoring completed');<br>
}, 60000);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_perf_hooks_memory_leak">Run example &raquo;</a>
</div>

<div class="w3-panel w3-note">
<p>Note: The memory leak detection example requires the <code class="w3-codespan">heapdump</code> package. Install it using <code class="w3-codespan">npm install heapdump</code>.</p>
</div>

<h3>2. Custom Performance Metrics</h3>
<p>Create and track custom performance metrics with detailed timing information:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const { performance, PerformanceObserver, PerformanceEntry } = require('perf_hooks');<br>
<br>
class PerformanceTracker {<br>
&nbsp;&nbsp;constructor() {<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.metrics = new Map();<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.observers = new Map();<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Set up default observer for custom metrics<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.setupDefaultObserver();<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;setupDefaultObserver() {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const obs = new PerformanceObserver((items) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;items.getEntries().forEach((entry) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (!this.metrics.has(entry.name)) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;this.metrics.set(entry.name, []);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;this.metrics.get(entry.name).push(entry);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Log detailed metrics<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;this.logMetric(entry);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;obs.observe({ entryTypes: ['measure'] });<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.observers.set('default', obs);<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;startTimer(name) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;performance.mark(`${name}-start`);<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;endTimer(name, attributes = {}) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;performance.mark(`${name}-end`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;performance.measure(name, {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;start: `${name}-start`,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;end: `${name}-end`,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;...attributes<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Clean up marks<br>
&nbsp;&nbsp;&nbsp;&nbsp;performance.clearMarks(`${name}-start`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;performance.clearMarks(`${name}-end`);<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;logMetric(entry) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const { name, duration, startTime, entryType, detail } = entry;<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`📊 [${new Date().toISOString()}] ${name}: ${duration.toFixed(2)}ms`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (detail) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('&nbsp;&nbsp; Details:', JSON.stringify(detail, null, 2));<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;getMetrics(name) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;return this.metrics.get(name) || [];<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;getStats(name) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const metrics = this.getMetrics(name);<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (metrics.length === 0) return null;<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;const durations = metrics.map(m => m.duration);<br>
&nbsp;&nbsp;&nbsp;&nbsp;const sum = durations.reduce((a, b) => a + b, 0);<br>
&nbsp;&nbsp;&nbsp;&nbsp;const avg = sum / durations.length;<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;return {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;count: durations.length,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;total: sum,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;average: avg,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;min: Math.min(...durations),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;max: Math.max(...durations),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;p90: this.percentile(durations, 90),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;p95: this.percentile(durations, 95),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;p99: this.percentile(durations, 99)<br>
&nbsp;&nbsp;&nbsp;&nbsp;};<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;percentile(arr, p) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (!arr.length) return 0;<br>
&nbsp;&nbsp;&nbsp;&nbsp;const sorted = [...arr].sort((a, b) => a - b);<br>
&nbsp;&nbsp;&nbsp;&nbsp;const pos = (sorted.length - 1) * p / 100;<br>
&nbsp;&nbsp;&nbsp;&nbsp;const base = Math.floor(pos);<br>
&nbsp;&nbsp;&nbsp;&nbsp;const rest = pos - base;<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (sorted[base + 1] !== undefined) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return sorted[base] + rest * (sorted[base + 1] - sorted[base]);<br>
&nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return sorted[base];<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
// Usage example<br>
const tracker = new PerformanceTracker();<br>
<br>
// Track a simple operation<br>
tracker.startTimer('database-query');<br>
setTimeout(() => {<br>
&nbsp;&nbsp;tracker.endTimer('database-query', {<br>
&nbsp;&nbsp;&nbsp;&nbsp;detail: {<br>
...
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Get statistics<br>
&nbsp;&nbsp;console.log('Stats:', tracker.getStats('database-query'));<br>
}, 200);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_perf_hooks_custom_metrics">Run example &raquo;</a>
</div>

<hr>

<h2>Distributed Tracing with Performance Hooks</h2>

<p>Implement distributed tracing across microservices using performance hooks:</p>
...
<br>
class Tracer {<br>
&nbsp;&nbsp;constructor(serviceName) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.serviceName = serviceName;<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.spans = new Map();<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.exportInterval = setInterval(() => this.exportSpans(), 10000);<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;startSpan(name, parentSpanId = null) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const spanId = crypto.randomBytes(8).toString('hex');<br>
&nbsp;&nbsp;&nbsp;&nbsp;const traceId = parentSpanId ? this.spans.get(parentSpanId)?.traceId : crypto.randomBytes(16).toString('hex');<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;const span = {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;id: spanId,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;traceId,<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;};<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.spans.set(spanId, span);<br>
&nbsp;&nbsp;&nbsp;&nbsp;return spanId;<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;endSpan(spanId, status = 'OK') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const span = this.spans.get(spanId);<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (!span) return;<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;span.endTime = performance.now();<br>
&nbsp;&nbsp;&nbsp;&nbsp;span.duration = span.endTime - span.startTime;<br>
&nbsp;&nbsp;&nbsp;&nbsp;span.status = status;<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Auto-export if this is a root span<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (!span.parentSpanId) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;this.exportSpan(span);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;return span;<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;addTag(spanId, key, value) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const span = this.spans.get(spanId);<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (span) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;span.tags[key] = value;<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;log(spanId, message, data = {}) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const span = this.spans.get(spanId);<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (span) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;span.logs.push({<br>
...
&nbsp;&nbsp;<br>
&nbsp;&nbsp;exportSpan(span) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// In a real application, this would send the span to a tracing backend<br>
&nbsp;&nbsp;&nbsp;&nbsp;// like Jaeger, Zipkin, or AWS X-Ray<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Exporting span:', JSON.stringify(span, null, 2));<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Clean up<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.spans.delete(span.id);<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;exportSpans() {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Export any remaining spans that have ended<br>
&nbsp;&nbsp;&nbsp;&nbsp;for (const [id, span] of this.spans.entries()) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (span.endTime) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;this.exportSpan(span);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;injectContext(spanId, headers = {}) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const span = this.spans.get(spanId);<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (!span) return headers;<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;return {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;...headers,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'x-trace-id': span.traceId,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'x-span-id': span.id,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'x-service': this.serviceName<br>
&nbsp;&nbsp;&nbsp;&nbsp;};<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;extractContext(headers) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const traceId = headers['x-trace-id'] || crypto.randomBytes(16).toString('hex');<br>
&nbsp;&nbsp;&nbsp;&nbsp;const parentSpanId = headers['x-span-id'] || null;<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;return { traceId, parentSpanId };<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
// Usage example<br>
const tracer = new Tracer('user-service');<br>
<br>
// Simulate a request<br>
function handleRequest(req) {<br>
&nbsp;&nbsp;const { traceId, parentSpanId } = tracer.extractContext(req.headers);<br>
&nbsp;&nbsp;const spanId = tracer.startSpan('handle-request', parentSpanId);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;tracer.addTag(spanId, 'http.method', req.method);<br>
&nbsp;&nbsp;tracer.addTag(spanId, 'http.url', req.url);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Simulate work<br>
&nbsp;&nbsp;setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Call another service<br>
&nbsp;&nbsp;&nbsp;&nbsp;const childSpanId = tracer.startSpan('call-auth-service', spanId);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;tracer.endSpan(childSpanId, 'OK');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// End the request<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;tracer.endSpan(spanId, 'OK');<br>
&nbsp;&nbsp;&nbsp;&nbsp;}, 100);<br>
&nbsp;&nbsp;}, 50);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;return { status: 'processing', traceId };<br>
}<br>
<br>
// Simulate an incoming request<br>
const request = {<br>
&nbsp;&nbsp;method: 'GET',<br>
&nbsp;&nbsp;url: '/api/users/123',<br>
&nbsp;&nbsp;headers: {}<br>
};<br>
<br>
const response = handleRequest(request);<br>
console.log('Response:', response);<br>
<br>
// Wait for spans to complete<br>
setTimeout(() => {}, 200);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_perf_hooks_tracing">Run example &raquo;</a>
</div>
...
<p>Advanced techniques for optimizing Node.js application performance:</p>

<h3>1. Worker Threads for CPU-Intensive Tasks</h3>
<p>Offload CPU-intensive operations to worker threads to prevent blocking the event loop:</p>
...
if (isMainThread) {<br>
&nbsp;&nbsp;// Main thread<br>
&nbsp;&nbsp;function runWorker(data) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;return new Promise((resolve, reject) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const start = performance.now();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const worker = new Worker(__filename, {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;workerData: data<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const result = await runWorker({<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;task: 'processData',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;data: Array(1000000).fill().map((_, i) => i)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
...
&nbsp;&nbsp;function processData(data) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Simulate CPU-intensive work<br>
&nbsp;&nbsp;&nbsp;&nbsp;return data.map(x => Math.sqrt(x) * Math.PI);<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const result = processData(workerData.data);<br>
&nbsp;&nbsp;&nbsp;&nbsp;parentPort.postMessage({<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;task: workerData.task,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;resultLength: result.length,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;sample: result.slice(0, 5)<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;} catch (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;parentPort.postMessage({ error: err.message });<br>
&nbsp;&nbsp;}<br>
}
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_perf_hooks_worker_threads">Run example &raquo;</a>
</div>

<h3>2. Efficient Data Processing</h3>
<p>Use streams and buffers for efficient large data processing:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const { Transform } = require('stream');<br>
const { performance } = require('perf_hooks');<br>
<br>
class ProcessingPipeline {<br>
&nbsp;&nbsp;constructor() {<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.startTime = performance.now();<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.processedItems = 0;<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;createTransformStream(transformFn) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;return new Transform({<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;objectMode: true,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;transform(chunk, encoding, callback) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const result = transformFn(chunk);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;this.processedItems++;<br>
...
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;async processData(data, batchSize = 1000) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const batches = [];<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Process in batches<br>
&nbsp;&nbsp;&nbsp;&nbsp;for (let i = 0; i &lt; data.length; i += batchSize) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const batch = data.slice(i, i + batchSize);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const processedBatch = await this.processBatch(batch);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;batches.push(processedBatch);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Log progress<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const progress = ((i + batchSize) / data.length * 100).toFixed(1);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Processed ${Math.min(i + batchSize, data.length)}/${data.length} (${progress}%)`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;return batches.flat();<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const results = [];<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Create a transform stream for processing<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const processor = this.createTransformStream((item) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Simulate processing<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;...item,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;processed: true,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;timestamp: new Date().toISOString()<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Process each item in the batch<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;for (const item of batch) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;processor.write(item);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;processor.end();<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
...
&nbsp;&nbsp;getStats() {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const endTime = performance.now();<br>
&nbsp;&nbsp;&nbsp;&nbsp;const duration = endTime - this.startTime;<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;return {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;processedItems: this.processedItems,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;duration: `${duration.toFixed(2)}ms`,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;itemsPerSecond: (this.processedItems / (duration / 1000)).toFixed(2)<br>
&nbsp;&nbsp;&nbsp;&nbsp;};<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
...
&nbsp;&nbsp;const testData = Array(10000).fill().map((_, i) => ({<br>
&nbsp;&nbsp;&nbsp;&nbsp;id: i,<br>
&nbsp;&nbsp;&nbsp;&nbsp;value: Math.random() * 1000<br>
&nbsp;&nbsp;}));<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;console.log('Starting data processing...');<br>
&nbsp;&nbsp;const pipeline = new ProcessingPipeline();<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Process data in batches<br>
&nbsp;&nbsp;const result = await pipeline.processData(testData, 1000);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Print statistics<br>
&nbsp;&nbsp;console.log('Processing complete!');<br>
&nbsp;&nbsp;console.log('Statistics:', pipeline.getStats());<br>
&nbsp;&nbsp;console.log('Sample result:', result[0]);<br>
}<br>
<br>
main().catch(console.error);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_perf_hooks_data_processing">Run example &raquo;</a>
</div>
...
<p>When conducting performance testing, follow these best practices:</p>

<ol>
  <li><strong>Test in Production-Like Environments</strong>
    <ul>
      <li>Use hardware similar to production</li>
      <li>Include realistic data volumes</li>
      <li>Simulate production traffic patterns</li>
    </ul>
  </li>
  <li><strong>Use Statistical Significance</strong>
    <ul>
      <li>Run multiple test iterations</li>
      <li>Calculate confidence intervals</li>
      <li>Ignore outliers appropriately</li>
    </ul>
  </li>
  <li><strong>Monitor System Resources</strong>
    <ul>
  ...
  <li><strong>Profile Before Optimizing</strong>
    <ul>
      <li>Identify actual bottlenecks</li>
      <li>Measure before and after changes</li>
      <li>Focus on high-impact optimizations</li>
    </ul>
  </li>
</ol>
...
<div id="exercisecontainer" src="xrcise_perf_hooks.js" data-extensions="asp"></div>
