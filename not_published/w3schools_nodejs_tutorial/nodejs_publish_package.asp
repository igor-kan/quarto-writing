...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Publish a Package</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js Publish a Package">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_publish_package.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="Publishing a package means making your Node.js module or project available for others to install and use via the npm registry.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Publish a Package">
<meta name="twitter:description" content="Publishing a package means making your Node.js module or project available for others to install and use via the npm registry.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_publish_package.png">
...
<h1>Node.js <span class="color_h1">Publish a Package</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_dependencies.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="nodejs_http.asp">Next &#10095;</a>
</div>
<hr>

<h2>What Does it Mean to Publish a Package?</h2>
<p>Publishing a package means making your Node.js module or project available for others to install and use via the npm registry.</p>
<p>This is how open-source libraries and tools are shared with the Node.js community.</p>
<p>When you publish a package, it becomes available for anyone to install using <code class="w3-codespan">npm install your-package-name</code>.</p>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> Make sure your package provides value, and that it is not a duplicate of an existing package on NPM.</p>
</div>
<hr>

<h2>Preparing Your Package</h2>

<h3>1. Initialize Package</h3>
<p>Create a new directory and initialize your package:</p>
...
<h3>2. Essential Files</h3>
<p>A package should include these key files:</p>
<ul>
  <li><strong>package.json</strong> - Metadata about your package</li>
  <li><strong>README.md</strong> - Documentation (supports Markdown)</li>
  <li><strong>index.js</strong> - Main entry point (or specify in package.json)</li>
  <li><strong>LICENSE</strong> - Terms of use (MIT, ISC, etc.)</li>
  <li><strong>.gitignore</strong> - To exclude node_modules, logs, etc.</li>
  <li><strong>.npmignore</strong> - Optional, to exclude files from the published package</li>
</ul>

<h3>3. Package.json Essentials</h3>
<p>Ensure your <code class="w3-codespan">package.json</code> has these minimum fields:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
{<br>
&nbsp;&nbsp;"name": "your-package-name",<br>
&nbsp;&nbsp;"version": "1.0.0",<br>
&nbsp;&nbsp;"description": "A brief description of your package",<br>
&nbsp;&nbsp;"main": "index.js",<br>
&nbsp;&nbsp;"scripts": {<br>
&nbsp;&nbsp;&nbsp;&nbsp;"test": "echo \"Error: no test specified\" && exit 1"<br>
&nbsp;&nbsp;},<br>
&nbsp;&nbsp;"keywords": ["keyword1", "keyword2"],<br>
&nbsp;&nbsp;"author": "Your Name &lt;your.email@example.com&gt;",<br>
&nbsp;&nbsp;"license": "MIT"<br>
}
</div>
</div>
...
<h2>Creating an npm Account</h2>

<h3>1. Sign Up</h3>
<p>Create an account at <a href="https://www.npmjs.com/signup" target="_blank">npmjs.com/signup</a> if you don't have one.</p>

<h3>2. Verify Your Email</h3>
<p>Check your email and verify your account before publishing.</p>

<h3>3. Login via CLI</h3>
...
<ul>
  <li>Username</li>
  <li>Password</li>
  <li>Email (must match your npm account)</li>
  <li>One-time password (if you have 2FA enabled)</li>
</ul>

<h3>4. Check Login Status</h3>
<div class="w3-example">
<div class="w3-code notranslate w3-black">
npm whoami
</div>
...
<h3>1. Check Name Availability</h3>
<div class="w3-example">
<div class="w3-code notranslate w3-black">
npm view &lt;package-name&gt;
</div>
</div>
<p>If the package with that name does not already exist, you can use that name.</p>
<p>If it does, you'll need to choose a different name in your <code class="w3-codespan">package.json</code>.</p>

<h3>2. Test Package Locally</h3>
<p>Before publishing, test your package locally:</p>
<div class="w3-example">
<div class="w3-code notranslate w3-black">
# In your package directory<br>
npm link<br>
<br>
# In another project directory<br>
npm link &lt;package-name&gt;
</div>
</div>

<h3>3. Publish to npm Registry</h3>
<div class="w3-example">
<div class="w3-code notranslate w3-black">
# First, make sure you're in the right directory<br>
cd path/to/your/package<br>
<br>
# Publish to the public npm registry<br>
npm publish
</div>
</div>

<h3>4. Publish with a Specific Tag</h3>
<div class="w3-example">
<div class="w3-code notranslate w3-black">
...
<h3>5. Publish a Public Package (if using npm paid account)</h3>
<div class="w3-example">
<div class="w3-code notranslate w3-black">
...
<h3>1. Update the Version Number</h3>
<p>Use semantic versioning (SemVer) to update your package version:</p>
<div class="w3-example">
<div class="w3-code notranslate w3-black">
# For a patch release (bug fixes)<br>
npm version patch<br>
<br>
# For a minor release (backward-compatible features)<br>
npm version minor<br>
<br>
# For a major release (breaking changes)<br>
npm version major
</div>
</div>

<h3>2. Update Changelog</h3>
<p>Update your CHANGELOG.md to document the changes in this version.</p>

<h3>3. Publish the Update</h3>
<div class="w3-example">
<div class="w3-code notranslate w3-black">
npm publish
</div>
...
<h3>4. Tag the Release (Optional)</h3>
<p>If you're using Git, create a tag for the release:</p>
<div class="w3-example">
<div class="w3-code notranslate w3-black">
git tag -a v1.0.0 -m "Initial release"<br>
git push origin v1.0.0
</div>
</div>
<hr>

<h2>Managing Published Packages</h2>

<h3>Unpublishing a Package</h3>
<p>To remove a package from the npm registry:</p>
<div class="w3-example">
<div class="w3-code notranslate w3-black">
# Unpublish a specific version<br>
npm unpublish &lt;package-name&gt;@&lt;version&gt;<br>
<br>
# Unpublish the entire package (only works within 72 hours of publishing)<br>
npm unpublish &lt;package-name&gt; --force
</div>
</div>
<div class="w3-panel ws-note">
<p><strong>Important:</strong> Unpublishing is strongly discouraged as it can break other projects that depend on your package. Instead, consider using <code class="w3-codespan">npm deprecate</code>.</p>
</div>

<h3>Deprecating a Package</h3>
<p>If you want to prevent users from installing a version but keep it available for existing users:</p>
<div class="w3-example">
<div class="w3-code notranslate w3-black">
# Deprecate a specific version<br>
npm deprecate &lt;package-name&gt;@&lt;version&gt; "message"<br>
<br>
# Example<br>npx deprecate my-package@1.0.0 "This version is no longer maintained. Please upgrade to v2.0.0"
</div>
</div>

<h3>Transferring Ownership</h3>
<p>To transfer a package to another user or organization:</p>
<div class="w3-example">
<div class="w3-code notranslate w3-black">
...
<ol>
  <li><strong>Follow Semantic Versioning</strong> - Use MAJOR.MINOR.PATCH version numbers appropriately</li>
  <li><strong>Write Good Documentation</strong> - Include clear usage examples in your README</li>
  <li><strong>Add Tests</strong> - Include unit tests and document how to run them</li>
  <li><strong>Use .npmignore</strong> - Only publish necessary files</li>
  <li><strong>Add Keywords</strong> - Help others discover your package</li>
  <li><strong>Choose the Right License</strong> - Make your terms clear to users</li>
  <li><strong>Maintain a Changelog</strong> - Document changes between versions</li>
  <li><strong>Use Continuous Integration</strong> - Automate testing and publishing</li>
</ol>
<hr>
<h2>Summary</h2>
<p>Publishing packages to npm is a great way to share your code with the Node.js community.</p>
<p>If you follow best practices and maintain your packages well, you can contribute valuable tools that others can build upon.</p>

<div class="w3-panel ws-note">
<p><strong>Remember:</strong> With great power comes great responsibility. When you publish a package, you're making a commitment to maintain it or clearly communicate its status to users.</p>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_publish_package.js" data-extensions="asp"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_dependencies.asp">&#10094; Previous</a>
