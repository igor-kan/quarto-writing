...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js package.json</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js package.json">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_package_json.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="package.json is a special file that describes your Node.js project.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js package.json">
<meta name="twitter:description" content="package.json is a special file that describes your Node.js project.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_package_json.png">
...
<h1>Node.js <span class="color_h1">package.json</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_npm.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="nodejs_scripts.asp">Next &#10095;</a>
</div>
<hr>

<h2>What is package.json?</h2>
<p><b>package.json</b> is a special file that describes your Node.js project.</p>
<p>It contains information about your app, such as its name, version, dependencies, scripts, and more.</p>
<p>This file is essential for managing and sharing Node.js projects, especially when using npm (Node Package Manager).</p>
<hr>

<h2>Creating package.json</h2>
<p>You can create a <b>package.json</b> file by running the following command in your project folder:</p>
<div class="w3-example">
<div class="w3-code notranslate w3-black">npm init</div>
</div>
<p>This command will ask you a series of questions about your project and generate a <b>package.json</b> file.</p>
<p>For a quick setup with default values, use:</p>
<div class="w3-example">
<div class="w3-code notranslate w3-black">npm init -y</div>
</div>
<hr>
...
<p>Here is a simple example of a <b>package.json</b> file:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
{<br>
&nbsp;&nbsp;"name": "my-node-app",<br>
&nbsp;&nbsp;"version": "1.0.0",<br>
&nbsp;&nbsp;"description": "A simple Node.js app",<br>
&nbsp;&nbsp;"main": "index.js",<br>
&nbsp;&nbsp;"scripts": {<br>
...
<p>This file describes the app, sets the main file to <code class="w3-codespan">index.js</code>, and defines a start script.</p>
<hr>

<h2>Adding Dependencies</h2>
<p>When you install a package with npm, it is added to the <code class="w3-codespan">dependencies</code> section of <b>package.json</b>:</p>
<div class="w3-example">
<div class="w3-code notranslate w3-black">npm install express</div>
</div>
<p>This command adds Express to your project and updates <b>package.json</b> automatically.</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
"dependencies": {<br>
&nbsp;&nbsp;"express": "^5.1.0"<br>
...
<h2>Common package.json Fields</h2>
...
&nbsp;&nbsp;"main": "index.js",<br>
&nbsp;&nbsp;"type": "module", // or "commonjs"<br>
&nbsp;&nbsp;"keywords": ["example", "package", "node"],<br>
&nbsp;&nbsp;"author": "Your Name <email@example.com>",<br>
&nbsp;&nbsp;"license": "MIT",<br>
&nbsp;&nbsp;"homepage": "https://example.com/my-package"<br>
}
</div>
</div>

<h3>Scripts</h3>
<p>Define custom scripts that can be run with <code class="w3-codespan">npm run &lt;script-name&gt;</code>:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
"scripts": {<br>
&nbsp;&nbsp;"start": "node index.js",<br>
...
<h3>Dependencies</h3>
<p>Specify project dependencies with version ranges:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
"dependencies": {<br>
&nbsp;&nbsp;"express": "^4.18.2",<br>
...
<p>Development-only dependencies (not installed in production):</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
"devDependencies": {<br>
&nbsp;&nbsp;"nodemon": "^2.0.22",<br>
...
<ul>
  <li><code class="w3-codespan">^4.17.21</code> - Compatible with 4.x.x (up to but not including 5.0.0)</li>
  <li><code class="w3-codespan">~4.17.21</code> - Patch updates only (4.17.x)</li>
  <li><code class="w3-codespan">4.17.21</code> - Exact version</li>
  <li><code class="w3-codespan">latest</code> - Latest stable version</li>
  <li><code class="w3-codespan">git+https://...</code> - Git repository</li>
</ul>

<h3>Engines</h3>
<p>Specify Node.js and npm version requirements:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
"engines": {<br>
&nbsp;&nbsp;"node": ">=14.0.0 <17.0.0",<br>
&nbsp;&nbsp;"npm": ">=6.0.0"<br>
}
</div>
</div>

<h3>Repository and Bugs</h3>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
"repository": {<br>
&nbsp;&nbsp;"type": "git",<br>
&nbsp;&nbsp;"url": "https://github.com/username/repo.git"<br>
},<br>
"bugs": {<br>
&nbsp;&nbsp;"url": "https://github.com/username/repo/issues"<br>
}
</div>
</div>
<hr>
<h2>Working with package.json</h2>

<h3>Adding Dependencies</h3>
<div class="w3-example">
<div class="w3-code notranslate w3-black">
# Install and save to dependencies<br>
npm install package-name<br><br>
# Install and save to devDependencies<br>
npm install --save-dev package-name<br><br>
# Install exact version<br>
...
npm update package-name<br><br>
# Update all packages<br>
npm update<br><br>
# Check for outdated packages<br>
npm outdated
</div>
</div>
...
<div class="w3-code notranslate w3-black">
# Run a script<br>
npm run script-name<br><br>
# Run start script (can be called with just 'npm start')<br>
npm start<br><br>
# Run test script (can be called with just 'npm test')<br>
npm test
</div>
</div>
<hr>
...
<ul>
  <li>Always specify exact versions in <code class="w3-codespan">dependencies</code> for production apps</li>
  <li>Use <code class="w3-codespan">npm ci</code> in CI/CD pipelines for reproducible builds</li>
  <li>Keep your <code class="w3-codespan">package-lock.json</code> file in version control</li>
  <li>Use <code class="w3-codespan">.npmignore</code> to exclude unnecessary files from published packages</li>
  <li>Regularly update dependencies to get security patches</li>
</ul>

<h2>Summary</h2>
<p><b>package.json</b> is the heart of any Node.js project, containing metadata, scripts, and dependency information.</p>
<p>Understanding its structure and fields is essential for effective Node.js development.</p>
<hr>
<div id="exercisecontainer" src="xrcise_package_json.js" data-extensions="asp"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_npm.asp">&#10094; Previous</a>
