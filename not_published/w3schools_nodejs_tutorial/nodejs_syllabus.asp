...
<html lang="en-US">
<head>
<title>Node.js Syllabus (Curriculum)</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js Syllabus (Curriculum)">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_syllabus.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="The W3Schools Node.js Tutorial is comprehensive and beginner-friendly.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Syllabus (Curriculum)">
<meta name="twitter:description" content="The W3Schools Node.js Tutorial is comprehensive and beginner-friendly.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_syllabus.png">
...
<h1>Node.js <span class="color_h1">Syllabus</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_practice.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="nodejs_study_plan.asp">Next &#10095;</a>
</div>
<hr>
...
<p>The <a title="W3Schools Node.js Tutorial" href="default.asp">W3Schools Node.js Tutorial</a> is comprehensive and beginner-friendly.</p>
<p>It will give you a fundamental knowledge of Node.js.</p>
...
<p>The syllabus outline and its sequence are structured so you can learn Node.js step by step, from the introduction to creating server-side applications.</p>
<p><a title="W3Schools Node.js Tutorial" href="nodejs_intro.asp" class="ws-btn">Get Started With Node.js &raquo;</a></p>
<hr>

<h2>Learning Outcomes</h2>
<ul>
  <li>Learn what Node.js is and set up your environment</li>
  <li>Create web servers with the HTTP module</li>
  <li>Work with built-in modules (File System, URL, Events)</li>
  <li>Use Node Package Manager (NPM) to manage packages</li>
  <li>Handle files (upload, read, create, update, delete)</li>
  <li>Send emails using Node.js</li>
  <li>Connect and work with MySQL database</li>
  <li>Create and manage MongoDB databases</li>
  <li>Build real-world applications with Node.js</li>
</ul>
<div class="ws-note w3-panel">
<p><strong>Note:</strong> Are you a teacher teaching Node.js? <a href="/academy/index.php" target="_blank">W3Schools Academy</a> is a toolbox of features that can help you teach. It offers classroom features such as pre-built study plans, classroom administration and much more. Read more about <a href="/academy/index.php" target="_blank">Academy here</a>.</p>
</div>
<hr>

<h2>Which Subjects Are Node.js Relevant For?</h2>
<ul>
   <li style="margin-bottom:16px;"><strong>Back-end Development:</strong><br> Node.js is essential for server-side application development.</li>
   <li style="margin-bottom:16px;"><strong>Web Development:</strong><br> Node.js enables full-stack JavaScript development.</li>
   <li style="margin-bottom:16px;"><strong>API Development:</strong><br> Node.js is perfect for building RESTful APIs and microservices.</li>
   <li style="margin-bottom:16px;"><strong>Real-time Applications:</strong><br> Node.js excels at handling real-time data and WebSocket connections.</li>
   <li style="margin-bottom:16px;"><strong>DevOps:</strong><br> Node.js is widely used for build tools and automation.</li>
   <li style="margin-bottom:16px;"><strong>Cloud Computing:</strong><br> Node.js is popular for cloud-native application development.</li>
   <li><strong>Enterprise Applications:</strong><br> Node.js supports building scalable enterprise solutions.</li>
</ul>
<p><a title="W3Schools Node.js Tutorial" href="nodejs_intro.asp" class="ws-btn" style="margin-top:8px">Get Started</a></p>
<hr>
...
<ul class="link-boxes">
    <li><a href="default.asp">Node.js HOME</a></li>
    <li><a href="nodejs_intro.asp">Node.js Intro</a></li>
    <li><a href="nodejs_get_started.asp">Node.js Get Started</a></li>
    <li><a href="nodejs_modules.asp">Node.js Modules</a></li>
    <li><a href="nodejs_http.asp">Node.js HTTP Module</a></li>
    <li><a href="nodejs_filesystem.asp">Node.js File System</a></li>
    <li><a href="nodejs_url.asp">Node.js URL Module</a></li>
    <li><a href="nodejs_npm.asp">Node.js NPM</a></li>
    <li><a href="nodejs_events.asp">Node.js Events</a></li>
    <li><a href="nodejs_uploadfiles.asp">Node.js Upload Files</a></li>
    <li><a href="nodejs_email.asp">Node.js Email</a></li>
    <li><a href="nodejs_mysql.asp">MySQL Get Started</a></li>
    <li><a href="nodejs_mysql_create_db.asp">MySQL Create Database</a></li>
    <li><a href="nodejs_mysql_create_table.asp">MySQL Create Table</a></li>
    <li><a href="nodejs_mysql_insert.asp">MySQL Insert Into</a></li>
    <li><a href="nodejs_mysql_select.asp">MySQL Select From</a></li>
    <li><a href="nodejs_mysql_where.asp">MySQL Where</a></li>
    <li><a href="nodejs_mysql_orderby.asp">MySQL Order By</a></li>
    <li><a href="nodejs_mysql_delete.asp">MySQL Delete</a></li>
    <li><a href="nodejs_mysql_drop_table.asp">MySQL Drop Table</a></li>
    <li><a href="nodejs_mysql_update.asp">MySQL Update</a></li>
    <li><a href="nodejs_mysql_limit.asp">MySQL Limit</a></li>
    <li><a href="nodejs_mysql_join.asp">MySQL Join</a></li>
    <li><a href="nodejs_mongodb.asp">MongoDB Get Started</a></li>
    <li><a href="nodejs_mongodb_create_db.asp">MongoDB Create DB</a></li>
    <li><a href="nodejs_mongodb_createcollection.asp">MongoDB Collection</a></li>
    <li><a href="nodejs_mongodb_insert.asp">MongoDB Insert</a></li>
    <li><a href="nodejs_mongodb_find.asp">MongoDB Find</a></li>
    <li><a href="nodejs_mongodb_query.asp">MongoDB Query</a></li>
    <li><a href="nodejs_mongodb_sort.asp">MongoDB Sort</a></li>
    <li><a href="nodejs_mongodb_delete.asp">MongoDB Delete</a></li>
    <li><a href="nodejs_mongodb_drop.asp">MongoDB Drop Collection</a></li>
    <li><a href="nodejs_mongodb_update.asp">MongoDB Update</a></li>
    <li><a href="nodejs_mongodb_limit.asp">MongoDB Limit</a></li>
    <li><a href="nodejs_mongodb_join.asp">MongoDB Join</a></li>
    <li><a href="nodejs_raspberrypi.asp">RasPi Get Started</a></li>
    <li><a href="nodejs_raspberrypi_gpio_intro.asp">RasPi GPIO Introduction</a></li>
    <li><a href="nodejs_raspberrypi_blinking_led.asp">RasPi Blinking LED</a></li>
    <li><a href="nodejs_raspberrypi_led_pushbutton.asp">RasPi LED & Pushbutton</a></li>
    <li><a href="nodejs_raspberrypi_flowing_leds.asp">RasPi Flowing LEDs</a></li>
    <li><a href="nodejs_raspberrypi_webserver_websocket.asp">RasPi WebSocket</a></li>
    <li><a href="nodejs_raspberrypi_rgb_led_websocket.asp">RasPi RGB LED WebSocket</a></li>
    <li><a href="nodejs_raspberrypi_components.asp">RasPi Components</a></li>
    <li><a href="nodejs_exam.asp">Node.js Certificate</a></li>
</ul>
</div>
<p><a title="W3Schools Node.js Tutorial" href="default.asp" class="ws-btn">Get Started</a></p>
<hr>

<h2>Sandbox and Lab Environment</h2>
<p>Node.js, like any other platform, is best learned through hands-on practice.</p>
<p>Try this example using our editor:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
  let http = require('http');<br><br>http.createServer(function (req, res) {<br>&nbsp;&nbsp;res.writeHead(200, {'Content-Type': 'text/plain'});<br>&nbsp;&nbsp;res.end('Hello World!');<br>}).listen(8080); </div>
...
that allows you to build, test and deploy Node.js applications.</p>
<p>Here you get a secure sandbox environment called Spaces, where you can practice Node.js code and test projects in real-time.</p>
...
<h2>Node.js Certification</h2>
<p>W3Schools offers an end-of-pathway certification program.</p>
<p>Here you can take exams to get certified.</p>
<p>The Node.js exam is a test that summarizes the W3Schools Node.js syllabus.</p>
<p>After passing the exam you get the "Certified Node.js Developer" Certification.</p>
<p>The certification exam is adaptive and graded; students will get a grade from intermediate, advanced to professional.</p>
<div class="ws-grey w3-padding w3-round">
<a href="nodejs_exam.png" target="_blank" title="Node.js Study Plan"><img src="nodejs_exam.png" style="height:auto;max-width:100%;" loading="lazy"></a>
</div>
<p><a class="ws-btn" href="https://campus.w3schools.com/collections/certifications/products/nodejs-certificate" target="_blank">Buy Certificate &raquo;</a></p>
<hr>
