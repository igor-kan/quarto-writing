...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js API Authentication</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js API Authentication">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_api_auth.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="API authentication is the process of verifying the identity of clients accessing your Node.js APIs.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js API Authentication">
<meta name="twitter:description" content="API authentication is the process of verifying the identity of clients accessing your Node.js APIs.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_api_auth.png">
...
<h1>Node.js <span class="color_h1">API Authentication Guide</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_rest_api.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="nodejs_frontend.asp">Next &#10095;</a>
</div>
<hr>
<h2>What is API Authentication?</h2>
<p>API authentication is the process of verifying the identity of clients accessing your Node.js APIs.</p>
<p>This comprehensive guide covers various authentication methods, security best practices, and implementation patterns to help you secure your Node.js applications effectively.</p>
<hr>
<h2 id="why-auth">Why API Authentication Matters</h2>

<p>In today's interconnected world, API security is not optional-it's a necessity. Proper authentication helps you:</p>
...
<div class="w3-panel w3-light-grey w3-padding-16 w3-card">
  <div class="w3-row-padding">
    <div class="w3-col m6">
      ...
      <ul>
        <li><strong>Access Control</strong>: Restrict API access to authorized users only</li>
        <li><strong>Data Protection</strong>: Safeguard sensitive information from unauthorized access</li>
        <li><strong>Identity Verification</strong>: Ensure users are who they claim to be</li>
      </ul>
    </div>
    <div class="w3-col m6">
      <h3>Business Benefits</h3>
      <ul>
        <li><strong>Usage Analytics</strong>: Track API usage by user/application</li>
        <li><strong>Monetization</strong>: Implement usage-based billing models</li>
        <li><strong>Compliance</strong>: Meet regulatory requirements (GDPR, HIPAA, etc.)</li>
      </ul>
    </div>
  </div>
</div>
<hr>
<h2 id="auth-methods">Authentication Methods Overview</h2>

<p>Different authentication methods serve different use cases. Here's a quick comparison:</p>

<div class="w3-responsive">
  <table class="ws-table-all w3-margin-bottom">
    <tr>
      <th>Method</th>
      <th>Best For</th>
      <th>Complexity</th>
...
<p>There are several approaches to API authentication in Node.js</p>
<hr>
<h2>Session-Based Authentication</h2>

<p>Session-based authentication uses cookies to maintain user state:</p>
...
<br>
// Parse request bodies<br>
app.use(bodyParser.json());<br>
app.use(bodyParser.urlencoded({ extended: true }));<br>
<br>
// Configure sessions<br>
app.use(session({<br>
&nbsp; secret: 'your-secret-key',<br>
&nbsp; resave: false,<br>
&nbsp; saveUninitialized: false,<br>
&nbsp; cookie: { secure: process.env.NODE_ENV === 'production', maxAge: 24 * 60 * 60 * 1000 } // 24 hours<br>
}));<br>
<br>
// Sample user database<br>
const users = [<br>
&nbsp; { id: 1, username: 'user1', password: 'password1' }<br>
];<br>
<br>
// Login route<br>
...
&nbsp; }<br>
&nbsp; <br>
&nbsp; // Store user information in session (excluding password)<br>
&nbsp; req.session.user = {<br>
&nbsp;&nbsp;&nbsp; id: user.id,<br>
&nbsp;&nbsp;&nbsp; username: user.username<br>
&nbsp; };<br>
&nbsp; <br>
&nbsp; res.json({ message: 'Login successful', user: req.session.user });<br>
});<br>
<br>
// Protected route<br>
app.get('/profile', (req, res) => {<br>
&nbsp; // Check if user is logged in<br>
&nbsp; if (!req.session.user) {<br>
&nbsp;&nbsp;&nbsp; return res.status(401).json({ message: 'Unauthorized' });<br>
&nbsp; }<br>
&nbsp; <br>
&nbsp; res.json({ message: 'Profile accessed', user: req.session.user });<br>
});<br>
<br>
// Logout route<br>
app.post('/logout', (req, res) => {<br>
&nbsp; // Destroy session<br>
&nbsp; req.session.destroy((err) => {<br>
&nbsp;&nbsp;&nbsp; if (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; return res.status(500).json({ message: 'Logout failed' });<br>
&nbsp;&nbsp;&nbsp; }<br>
&nbsp;&nbsp;&nbsp; res.json({ message: 'Logout successful' });<br>
&nbsp; });<br>
});<br>
<br>
// Start server<br>
app.listen(8080, () => {<br>
&nbsp; console.log('Server running on port 8080');<br>
});
</div>
</div>
<hr>
<h2>Token-Based Authentication (JWT)</h2>
<p>JSON Web Tokens (JWT) provide a stateless authentication mechanism that's compact and self-contained.</p>
<p>Unlike session-based authentication, <strong>token-based authentication (JWT) doesn't require a server to store session data</strong>.</p>
<p>This makes it ideal for stateless API architecture and microservices.</p>
...
app.use(bodyParser.json());<br>
<br>
const JWT_SECRET = 'your-jwt-secret-key';<br>
<br>
// Sample user database<br>
const users = [<br>
&nbsp; { id: 1, username: 'user1', password: 'password1', role: 'user' }<br>
];<br>
<br>
// Login route - generate token<br>
app.post('/login', (req, res) => {<br>
&nbsp; const { username, password } = req.body;<br>
<br>
&nbsp; // Find user<br>
...
<br>
&nbsp; // Sign token<br>
&nbsp; const token = jwt.sign(payload, JWT_SECRET, { expiresIn: '1h' });<br>
<br>
&nbsp; res.json({ message: 'Login successful', token });<br>
});<br>
<br>
// Middleware for JWT verification<br>
const authenticateJWT = (req, res, next) => {<br>
&nbsp; // Get auth header - The Authorization header is commonly used to send authentication tokens<br>
&nbsp; const authHeader = req.headers.authorization;<br>
<br>
&nbsp; if (!authHeader) {<br>
&nbsp;&nbsp;&nbsp; return res.status(401).json({ message: 'Authorization header missing' });<br>
&nbsp; }<br>
<br>
&nbsp; // Extract token from "Bearer &lt;token&gt;"<br>
&nbsp; const token = authHeader.split(' ')[1];<br>
<br>
&nbsp; if (!token) {<br>
&nbsp;&nbsp;&nbsp; return res.status(401).json({ message: 'Token missing' });<br>
&nbsp; }<br>
<br>
&nbsp; try {<br>
&nbsp;&nbsp;&nbsp; // Verify token<br>
...
<br>
&nbsp;&nbsp;&nbsp; // Attach user to request<br>
&nbsp;&nbsp;&nbsp; req.user = decoded;<br>
<br>
&nbsp;&nbsp;&nbsp; next();<br>
&nbsp; } catch (error) {<br>
&nbsp;&nbsp;&nbsp; return res.status(403).json({ message: 'Invalid or expired token' });<br>
&nbsp; }<br>
};<br>
<br>
// Protected route<br>
app.get('/profile', authenticateJWT, (req, res) => {<br>
&nbsp; res.json({ message: 'Profile accessed', user: req.user });<br>
});<br>
<br>
// Role-based route<br>
app.get('/admin', authenticateJWT, (req, res) => {<br>
&nbsp; // Check if user has admin role<br>
&nbsp; if (req.user.role !== 'admin') {<br>
&nbsp;&nbsp;&nbsp; return res.status(403).json({ message: 'Access denied: admin role required' });<br>
&nbsp; }<br>
<br>
&nbsp; res.json({ message: 'Admin panel accessed' });<br>
});<br>
<br>
// Start server<br>
app.listen(8080, () => {<br>
...
<h2 id="oauth2">OAuth 2.0 Authentication</h2>

<p>OAuth 2.0 is the industry-standard protocol for authorization, enabling applications to obtain limited access to user accounts on HTTP services.</p>
<p>It works by delegating user authentication to the service that hosts the user account.</p>

<h3>OAuth 2.0 Flow Overview</h3>
<ol>
  <li>User clicks "Login with [Provider]" in your app</li>
  <li>User is redirected to the provider's login page</li>
  <li>User authenticates and authorizes your app</li>
  <li>Provider redirects back to your app with an authorization code</li>
  <li>Your app exchanges the code for an access token</li>
  <li>Your app can now access the user's data (within the authorized scope)</li>
</ol>

<h3>Implementation with Passport.js</h3>

<div class="w3-example">
<h4>1. Install required packages:</h4>
<div class="w3-code notranslate bash">
npm install passport passport-google-oauth20 express-session
</div>
</div>

<div class="w3-example">
<h4>2. Set up OAuth 2.0 with Google:</h4>
<div class="w3-code notranslate jsHigh">
const express = require('express');<br>
...
const app = express();<br>
<br>
// Configure sessions for OAuth 2.0<br>
app.use(session({<br>
&nbsp; secret: 'your-secret-key',<br>
&nbsp; resave: false,<br>
&nbsp; saveUninitialized: false,<br>
...
<br>
// Configure Google OAuth 2.0 strategy<br>
passport.use(new GoogleStrategy({<br>
&nbsp;&nbsp;&nbsp; clientID: 'YOUR_GOOGLE_CLIENT_ID',<br>
&nbsp;&nbsp;&nbsp; clientSecret: 'YOUR_GOOGLE_CLIENT_SECRET',<br>
&nbsp;&nbsp;&nbsp; callbackURL: 'http://localhost:8080/auth/google/callback'<br>
&nbsp; },<br>
&nbsp; (accessToken, refreshToken, profile, done) => {<br>
&nbsp;&nbsp;&nbsp; // In a real app, you'd find or create a user in your database<br>
&nbsp;&nbsp;&nbsp; const user = {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; id: profile.id,<br>
...
<br>
// Serialize user for session<br>
passport.serializeUser((user, done) => {<br>
&nbsp; done(null, user);<br>
});<br>
<br>
// Deserialize user from session<br>
passport.deserializeUser((user, done) => {<br>
&nbsp; done(null, user);<br>
});<br>
<br>
// Routes for Google OAuth<br>
app.get('/auth/google',<br>
&nbsp; passport.authenticate('google', { scope: ['profile', 'email'] })<br>
);<br>
<br>
...
<br>
// Middleware to check authentication<br>
const isAuthenticated = (req, res, next) => {<br>
...
<br>
// Protected route<br>
app.get('/profile', isAuthenticated, (req, res) => {<br>
...
<p>API keys are a simple way to authenticate clients to your API.</p>
<p>They're best suited for server-to-server communication or when you need to identify the calling project without user context.</p>
<p><strong>Best Practices for API Keys:</strong></p>
<ul>
  <li>Store keys securely (environment variables, secret management services)</li>
  <li>Rotate keys regularly</li>
  <li>Use HTTPS to prevent key exposure</li>
  <li>Implement rate limiting per key</li>
</ul>

<h3>Implementation Example</h3>

<div class="w3-example">
<h4>1. API Key Middleware</h4>
<div class="w3-code notranslate jsHigh">
const express = require('express');<br>
const app = express();<br>
<br>
// In-memory storage for API keys (use a database in production)<br>
const apiKeys = new Map([<br>
&nbsp; ['abc123', { name: 'Mobile App', permissions: ['read:data'] }],<br>
&nbsp; ['def456', { name: 'Web Client', permissions: ['read:data', 'write:data'] }]<br>
]);<br>
<br>
// API key authentication middleware<br>
const authenticateApiKey = (req, res, next) => {<br>
&nbsp; const apiKey = req.headers['x-api-key'] || req.query.apiKey;<br>
<br>
&nbsp; if (!apiKey) {<br>
&nbsp;&nbsp;&nbsp; return res.status(401).json({ <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; error: 'API key is required',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; docs: 'https://your-api-docs.com/authentication'<br>
&nbsp;&nbsp;&nbsp; });<br>
&nbsp; }<br>
<br>
&nbsp; const keyData = apiKeys.get(apiKey);<br>
&nbsp; if (!keyData) {<br>
&nbsp;&nbsp;&nbsp; return res.status(403).json({ error: 'Invalid API key' });<br>
&nbsp; }<br>
<br>
&nbsp; // Attach key data to request for use in route handlers<br>
&nbsp; req.apiKey = keyData;<br>
&nbsp; next();<br>
};<br>
// Protected route using API key<br>
app.get('/api/data', authenticateApiKey, (req, res) => {<br>
&nbsp; res.json({ <br>
&nbsp;&nbsp;&nbsp; message: 'Access granted',<br>
&nbsp;&nbsp;&nbsp; client: req.apiKey.name,<br>
&nbsp;&nbsp;&nbsp; timestamp: new Date().toISOString()<br>
&nbsp; });<br>
});<br>
<br>
// Route to generate a new API key (protected by admin auth in real apps)<br>
app.post('/api/keys', (req, res) => {<br>
&nbsp; const { name, permissions } = req.body;<br>
&nbsp; const apiKey = generateApiKey(); // Implement your key generation logic<br>
&nbsp; apiKeys.set(apiKey, { name, permissions });<br>
&nbsp; res.status(201).json({ apiKey });<br>
});<br>
// Helper function to generate API keys<br>
function generateApiKey() {<br>
&nbsp; return [...Array(32)]<br>
&nbsp;&nbsp;&nbsp; .map(() => Math.floor(Math.random() * 16).toString(16))<br>
&nbsp;&nbsp;&nbsp; .join('');<br>
}<br>
// Start server<br>
...
<p>API keys are a simple way to authenticate requests to your API:</p>
...
const app = express();<br>
<br>
// Sample API keys database<br>
const apiKeys = [<br>
&nbsp; { key: 'api-key-1', owner: 'client1', permissions: ['read'] },<br>
&nbsp; { key: 'api-key-2', owner: 'client2', permissions: ['read', 'write'] }<br>
];<br>
<br>
// Middleware for API key authentication<br>
const authenticateApiKey = (req, res, next) => {<br>
&nbsp; // Get API key from header or query parameter<br>
&nbsp; const apiKey = req.headers['x-api-key'] || req.query.api_key;<br>
&nbsp; <br>
&nbsp; if (!apiKey) {<br>
&nbsp;&nbsp;&nbsp; return res.status(401).json({ message: 'API key missing' });<br>
&nbsp; }<br>
&nbsp; <br>
&nbsp; // Find API key in database<br>
&nbsp; const keyData = apiKeys.find(k => k.key === apiKey);<br>
&nbsp; <br>
&nbsp; if (!keyData) {<br>
&nbsp;&nbsp;&nbsp; return res.status(403).json({ message: 'Invalid API key' });<br>
&nbsp; }<br>
&nbsp; <br>
&nbsp; // Attach key data to request<br>
&nbsp; req.apiKeyData = keyData;<br>
&nbsp; <br>
&nbsp; next();<br>
};<br>
<br>
// Protected route with API key<br>
app.get('/data', authenticateApiKey, (req, res) => {<br>
&nbsp; res.json({<br>
&nbsp;&nbsp;&nbsp; message: 'Data accessed',<br>
&nbsp;&nbsp;&nbsp; client: req.apiKeyData.owner,<br>
&nbsp;&nbsp;&nbsp; data: { example: 'API data' }<br>
&nbsp; });<br>
});<br>
<br>
// Route requiring specific permission<br>
app.post('/data', authenticateApiKey, (req, res) => {<br>
&nbsp; // Check if client has write permission<br>
&nbsp; if (!req.apiKeyData.permissions.includes('write')) {<br>
&nbsp;&nbsp;&nbsp; return res.status(403).json({ message: 'Insufficient permissions' });<br>
&nbsp; }<br>
&nbsp; <br>
&nbsp; res.json({ message: 'Data created successfully' });<br>
});<br>
<br>
// Start server<br>
app.listen(8080, () => {<br>
...
<p>HTTP Basic authentication uses encoded credentials in the Authorization header:</p>
...
<br>
// Basic authentication middleware<br>
const basicAuth = (req, res, next) => {<br>
&nbsp; // Get Authorization header<br>
&nbsp; const authHeader = req.headers.authorization;<br>
&nbsp; <br>
&nbsp; if (!authHeader || !authHeader.startsWith('Basic ')) {<br>
&nbsp;&nbsp;&nbsp; // If no credentials provided, request authentication<br>
&nbsp;&nbsp;&nbsp; res.setHeader('WWW-Authenticate', 'Basic realm="API Authentication"');<br>
&nbsp;&nbsp;&nbsp; return res.status(401).json({ message: 'Authentication required' });<br>
&nbsp; }<br>
&nbsp; <br>
&nbsp; // Extract and decode credentials
&nbsp; const encodedCredentials = authHeader.split(' ')[1];<br>
&nbsp; const decodedCredentials = Buffer.from(encodedCredentials, 'base64').toString('utf-8');<br>
&nbsp; const [username, password] = decodedCredentials.split(':');<br>
&nbsp; <br>
...
&nbsp; <br>
&nbsp; // Attach user to request<br>
&nbsp; req.user = { username: user.username };<br>
&nbsp; <br>
&nbsp; next();<br>
};<br>
<br>
// Protected route<br>
app.get('/api/data', basicAuth, (req, res) => {<br>
&nbsp; res.json({<br>
&nbsp;&nbsp;&nbsp; message: 'Data accessed',<br>
&nbsp;&nbsp;&nbsp; user: req.user.username,<br>
&nbsp;&nbsp;&nbsp; data: { example: 'Sensitive data' }<br>
&nbsp; });<br>
});<br>
<br>
// Start server<br>
...
<p>Adding an extra layer of security with time-based one-time passwords (TOTP):</p>
...
const QRCode = require('qrcode');<br>
const jwt = require('jsonwebtoken');<br>
const app = express();<br>
<br>
app.use(bodyParser.json());<br>
<br>
// In-memory database (use a real database in production)<br>
const users = [];<br>
const JWT_SECRET = 'your-jwt-secret-key';<br>
<br>
// Step 1: Register a user and set up MFA<br>
app.post('/register', (req, res) => {<br>
&nbsp; const { username, password } = req.body;<br>
&nbsp; <br>
&nbsp; // Check if user already exists<br>
&nbsp; if (users.find(u => u.username === username)) {<br>
&nbsp;&nbsp;&nbsp; return res.status(400).json({ message: 'Username already exists' });<br>
&nbsp; }<br>
&nbsp; <br>
&nbsp; // Generate secret for TOTP<br>
&nbsp; const secret = speakeasy.generateSecret({<br>
&nbsp;&nbsp;&nbsp; name: `MyApp:${username}`<br>
&nbsp; });<br>
&nbsp; <br>
&nbsp; // Create user<br>
&nbsp; const newUser = {<br>
...
&nbsp;&nbsp;&nbsp; username,<br>
&nbsp;&nbsp;&nbsp; password, // In production, hash passwords!<br>
&nbsp;&nbsp;&nbsp; mfaSecret: secret.base32,<br>
&nbsp;&nbsp;&nbsp; mfaEnabled: false<br>
&nbsp; };<br>
&nbsp; <br>
&nbsp; users.push(newUser);<br>
&nbsp; <br>
&nbsp; // Generate QR code for TOTP setup<br>
&nbsp; QRCode.toDataURL(secret.otpauth_url, (err, dataUrl) => {<br>
&nbsp;&nbsp;&nbsp; if (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; return res.status(500).json({ message: 'Error generating QR code' });<br>
&nbsp;&nbsp;&nbsp; }<br>
&nbsp;&nbsp;&nbsp; <br>
&nbsp;&nbsp;&nbsp; res.json({<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; message: 'User registered. Please set up MFA.',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; user: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; id: newUser.id,<br>
...
<br>
// Step 2: Verify and enable MFA<br>
app.post('/verify-mfa', (req, res) => {<br>
&nbsp; const { username, token } = req.body;<br>
&nbsp; <br>
&nbsp; // Find user<br>
...
&nbsp; }<br>
&nbsp; <br>
&nbsp; // Verify token against user's secret<br>
&nbsp; const verified = speakeasy.totp.verify({<br>
&nbsp;&nbsp;&nbsp; secret: user.mfaSecret,<br>
&nbsp;&nbsp;&nbsp; encoding: 'base32',<br>
&nbsp;&nbsp;&nbsp; token<br>
&nbsp; });<br>
&nbsp; <br>
&nbsp; if (!verified) {<br>
&nbsp;&nbsp;&nbsp; return res.status(400).json({ message: 'Invalid MFA token' });<br>
&nbsp; }<br>
&nbsp; <br>
&nbsp; // Enable MFA for user<br>
&nbsp; user.mfaEnabled = true;<br>
&nbsp; <br>
&nbsp; res.json({ message: 'MFA enabled successfully' });<br>
});<br>
<br>
// Step 3: Login with MFA<br>
app.post('/login', (req, res) => {<br>
&nbsp; const { username, password } = req.body;<br>
&nbsp; <br>
&nbsp; // Find user<br>
...
&nbsp; }<br>
&nbsp; <br>
&nbsp; // Check if MFA is enabled<br>
&nbsp; if (user.mfaEnabled) {<br>
&nbsp;&nbsp;&nbsp; return res.json({<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; message: 'Password verified. MFA token required.',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; requireMFA: true,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; userId: user.id<br>
&nbsp;&nbsp;&nbsp; });<br>
&nbsp; }<br>
&nbsp; <br>
&nbsp; // If MFA not enabled, generate token directly<br>
...
<br>
// Step 4: Verify MFA token and complete login<br>
app.post('/verify-login', (req, res) => {<br>
&nbsp; const { userId, mfaToken } = req.body;<br>
&nbsp; <br>
&nbsp; // Find user<br>
&nbsp; const user = users.find(u => u.id === userId);<br>
&nbsp; <br>
&nbsp; if (!user) {<br>
&nbsp;&nbsp;&nbsp; return res.status(404).json({ message: 'User not found' });<br>
&nbsp; }<br>
...
&nbsp; <br>
&nbsp; if (!verified) {<br>
&nbsp;&nbsp;&nbsp; return res.status(401).json({ message: 'Invalid MFA token' });<br>
&nbsp; }<br>
&nbsp; <br>
...
<div class="w3-panel ws-warning">
  <p><strong>Important:</strong> Security is not optional when implementing authentication. Follow these best practices to protect your application and users.</p>
</div>
...
<div class="w3-row-padding">
  <div class="w3-col m6">
    ...
    <ul>
      <li><strong>Never store plain text passwords</strong> - Always use strong hashing algorithms like bcrypt or Argon2</li>
      <li><strong>Enforce strong passwords</strong> - Require minimum length, special characters, and numbers</li>
      <li><strong>Implement password rotation</strong> - Prompt users to change passwords periodically</li>
    </ul>

    <h3>Token Security</h3>
    <ul>
      <li><strong>Use short-lived access tokens</strong> - 15-60 minutes is typical</li>
      <li><strong>Implement refresh tokens</strong> - For obtaining new access tokens without re-authentication</li>
      <li><strong>Store tokens securely</strong> - Use HTTP-only, secure, same-site cookies for web apps</li>
    </ul>
  </div>
  ...
  <div class="w3-col m6">
    ...
    <ul>
      <li><strong>Always use HTTPS</strong> - Encrypt all traffic</li>
      <li><strong>Implement rate limiting</strong> - Prevent brute force attacks</li>
      <li><strong>Use security headers</strong> - Like CSP, X-Content-Type-Options, X-Frame-Options</li>
      <li><strong>Log and monitor</strong> - Keep audit logs of authentication attempts</li>
    </ul>

    <h3>OAuth 2.0 Security</h3>
    <ul>
      <li><strong>Use PKCE</strong> - For public clients (mobile/native apps)</li>
      <li><strong>Validate redirect URIs</strong> - Prevent open redirect vulnerabilities</li>
      <li><strong>Store client secrets securely</strong> - Never in version control</li>
    </ul>
  </div>
</div>

<h3>Example: Secure Password Hashing with bcrypt</h3>
<div class="w3-example">
  <div class="w3-code notranslate jsHigh">
    const bcrypt = require('bcrypt');<br>
    const saltRounds = 10;<br>
    <br>
    // Hashing a password<br>
    async function hashPassword(plainPassword) {<br>
    &nbsp; return await bcrypt.hash(plainPassword, saltRounds);<br>
    }<br>
    <br>
    // Verifying a password<br>
    async function verifyPassword(plainPassword, hashedPassword) {<br>
    &nbsp; return await bcrypt.compare(plainPassword, hashedPassword);<br>
    }<br>
  </div>
</div>

<p>When implementing API authentication, follow these security best practices:</p>

<ul>
  <li><strong>HTTPS Only</strong>: Always use HTTPS to encrypt data in transit</li>
  <li><strong>Password Hashing</strong>: Store only hashed passwords using bcrypt or Argon2</li>
  <li><strong>Token Management</strong>: Keep tokens short-lived and implement refresh tokens</li>
  ...
  <li><strong>Secure Headers</strong>: Implement security headers like HSTS and CSP</li>
  <li><strong>Audit Logging</strong>: Log authentication events for security monitoring</li>
</ul>

<h3>Example: Password Hashing with Bcrypt</h3>
...
const users = [];<br>
<br>
// Register route with password hashing<br>
...
&nbsp;&nbsp;&nbsp; if (users.find(u => u.username === username)) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; return res.status(400).json({ message: 'Username already taken' });<br>
&nbsp;&nbsp;&nbsp; }<br>
&nbsp;&nbsp;&nbsp; <br>
&nbsp;&nbsp;&nbsp; // Hash password<br>
&nbsp;&nbsp;&nbsp; const saltRounds = 10;<br>
&nbsp;&nbsp;&nbsp; const hashedPassword = await bcrypt.hash(password, saltRounds);<br>
&nbsp;&nbsp;&nbsp; <br>
&nbsp;&nbsp;&nbsp; // Create new user<br>
&nbsp;&nbsp;&nbsp; const newUser = {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; id: users.length + 1,<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; userId: newUser.id<br>
&nbsp;&nbsp;&nbsp; });<br>
&nbsp; } catch (error) {<br>
&nbsp;&nbsp;&nbsp; res.status(500).json({ message: 'Error registering user' });<br>
&nbsp; }<br>
});<br>
<br>
// Login route with password comparison<br>
...
&nbsp;&nbsp;&nbsp; }<br>
&nbsp;&nbsp;&nbsp; <br>
&nbsp;&nbsp;&nbsp; // Compare password with stored hash<br>
&nbsp;&nbsp;&nbsp; const passwordMatch = await bcrypt.compare(password, user.password);<br>
&nbsp;&nbsp;&nbsp; <br>
&nbsp;&nbsp;&nbsp; if (!passwordMatch) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; return res.status(401).json({ message: 'Invalid credentials' });<br>
&nbsp;&nbsp;&nbsp; }<br>
&nbsp;&nbsp;&nbsp; <br>
&nbsp;&nbsp;&nbsp; // In a real app, generate and return a token<br>
&nbsp;&nbsp;&nbsp; res.json({<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; message: 'Login successful',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; userId: user.id<br>
&nbsp;&nbsp;&nbsp; });<br>
&nbsp; } catch (error) {<br>
&nbsp;&nbsp;&nbsp; res.status(500).json({ message: 'Error logging in' });<br>
&nbsp; }<br>
});<br>
<br>
// Start server<br>
...
<h2>Combining Authentication Methods</h2>

<p>In real-world applications, you often need to combine multiple authentication methods:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// JWT authentication with API rate limiting and refresh tokens<br>
const express = require('express');<br>
const jwt = require('jsonwebtoken');<br>
...
app.use(bodyParser.json());<br>
<br>
// Configure rate limiting<br>
const loginLimiter = rateLimit({<br>
&nbsp; windowMs: 15 * 60 * 1000, // 15 minutes<br>
&nbsp; max: 5, // 5 attempts per window<br>
&nbsp; message: 'Too many login attempts, please try again later'<br>
});<br>
<br>
// JWT configuration<br>
const JWT_SECRET = 'your-jwt-secret-key';<br>
const JWT_REFRESH_SECRET = 'your-refresh-token-secret';<br>
<br>
// Token storage (use a database in production)<br>
const tokenBlacklist = new Set();<br>
const refreshTokens = new Set();<br>
<br>
// Login route with rate limiting<br>
app.post('/login', loginLimiter, (req, res) => {<br>
&nbsp; const { username, password } = req.body;<br>
&nbsp; <br>
&nbsp; // Authentication logic (simplified)<br>
&nbsp; if (username !== 'user1' || password !== 'password1') {<br>
&nbsp;&nbsp;&nbsp; return res.status(401).json({ message: 'Invalid credentials' });<br>
&nbsp; }<br>
&nbsp; <br>
&nbsp; // Generate tokens<br>
...
&nbsp;&nbsp;&nbsp; { id: 1, username },<br>
&nbsp;&nbsp;&nbsp; JWT_SECRET,<br>
&nbsp;&nbsp;&nbsp; { expiresIn: '15m' } // Short-lived access token<br>
&nbsp; );<br>
&nbsp; <br>
&nbsp; const refreshToken = jwt.sign(<br>
&nbsp;&nbsp;&nbsp; { id: 1, username },<br>
&nbsp;&nbsp;&nbsp; JWT_REFRESH_SECRET,<br>
&nbsp;&nbsp;&nbsp; { expiresIn: '7d' } // Longer-lived refresh token<br>
&nbsp; );<br>
&nbsp; <br>
&nbsp; // Store refresh token<br>
&nbsp; refreshTokens.add(refreshToken);<br>
&nbsp; <br>
&nbsp; res.json({<br>
&nbsp;&nbsp;&nbsp; message: 'Login successful',<br>
&nbsp;&nbsp;&nbsp; accessToken,<br>
...
<br>
// Refresh token route<br>
app.post('/refresh-token', (req, res) => {<br>
&nbsp; const { refreshToken } = req.body;<br>
&nbsp; <br>
&nbsp; if (!refreshToken) {<br>
&nbsp;&nbsp;&nbsp; return res.status(401).json({ message: 'Refresh token required' });<br>
&nbsp; }<br>
&nbsp; <br>
&nbsp; // Check if token exists and is not blacklisted<br>
&nbsp; if (!refreshTokens.has(refreshToken)) {<br>
&nbsp;&nbsp;&nbsp; return res.status(403).json({ message: 'Invalid refresh token' });<br>
&nbsp; }<br>
&nbsp; <br>
&nbsp; try {<br>
&nbsp;&nbsp;&nbsp; // Verify refresh token<br>
&nbsp;&nbsp;&nbsp; const decoded = jwt.verify(refreshToken, JWT_REFRESH_SECRET);<br>
&nbsp;&nbsp;&nbsp; <br>
&nbsp;&nbsp;&nbsp; // Generate new access token<br>
&nbsp;&nbsp;&nbsp; const accessToken = jwt.sign(<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; { id: decoded.id, username: decoded.username },<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; JWT_SECRET,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; { expiresIn: '15m' }<br>
&nbsp;&nbsp;&nbsp; );<br>
&nbsp;&nbsp;&nbsp; <br>
...
&nbsp;&nbsp;&nbsp; });<br>
&nbsp; } catch (error) {<br>
&nbsp;&nbsp;&nbsp; // Remove invalid refresh token<br>
&nbsp;&nbsp;&nbsp; refreshTokens.delete(refreshToken);<br>
&nbsp;&nbsp;&nbsp; <br>
&nbsp;&nbsp;&nbsp; return res.status(403).json({ message: 'Invalid or expired refresh token' });<br>
&nbsp; }<br>
});<br>
<br>
...
&nbsp;&nbsp;&nbsp; return res.status(401).json({ message: 'Authorization header required' });<br>
&nbsp; }<br>
&nbsp; <br>
&nbsp; const token = authHeader.split(' ')[1];<br>
&nbsp; <br>
&nbsp; // Check if token is blacklisted<br>
&nbsp; if (tokenBlacklist.has(token)) {<br>
&nbsp;&nbsp;&nbsp; return res.status(403).json({ message: 'Token revoked' });<br>
&nbsp; }<br>
&nbsp; <br>
&nbsp; try {<br>
&nbsp;&nbsp;&nbsp; // Verify token<br>
...
<br>
// Logout route<br>
app.post('/logout', authenticateJWT, (req, res) => {<br>
&nbsp; const authHeader = req.headers.authorization;<br>
&nbsp; const token = authHeader.split(' ')[1];<br>
&nbsp; const { refreshToken } = req.body;<br>
&nbsp; <br>
&nbsp; // Blacklist the current access token<br>
&nbsp; tokenBlacklist.add(token);<br>
&nbsp; <br>
&nbsp; // Remove refresh token if provided<br>
&nbsp; if (refreshToken) {<br>
&nbsp;&nbsp;&nbsp; refreshTokens.delete(refreshToken);<br>
&nbsp; }<br>
&nbsp; <br>
...
<br>
// Protected route<br>
app.get('/protected', authenticateJWT, (req, res) => {<br>
&nbsp; res.json({<br>
&nbsp;&nbsp;&nbsp; message: 'Protected resource accessed',<br>
&nbsp;&nbsp;&nbsp; user: req.user<br>
&nbsp; });<br>
});<br>
<br>
...
<h2>HTTP Headers for Authentication</h2>
<p>When implementing API authentication, the HTTP headers used are crucial:</p>
<ul>
  <li><strong>Authorization header</strong>: This is the standard HTTP header used for sending authentication tokens in most API authentication strategies including JWT, OAuth, and Basic Auth</li>
  <li>Common format: <code class="w3-codespan">Authorization: Bearer &lt;token&gt;</code> for JWT and OAuth 2.0</li>
  <li>Format for Basic Auth: <code class="w3-codespan">Authorization: Basic &lt;base64-encoded-credentials&gt;</code></li>
</ul>
<hr>
<h2>Authentication Strategies for Different API Types</h2>

<table class="ws-table-all">
  <tr>
    <th>API Type</th>
    <th>Recommended Authentication</th>
    <th>Considerations</th>
  </tr>
  <tr>
    <td>Public API</td>
    <td>API Keys</td>
    <td>Simple to implement, good for tracking usage</td>
  </tr>
  <tr>
    <td>Service-to-Service API</td>
    <td>JWT (stateless) or Mutual TLS</td>
    <td>Minimal overhead, high security</td>
  </tr>
  <tr>
    <td>Mobile/Web App API</td>
    <td>OAuth 2.0 + JWT</td>
    <td>Good user experience, handles third-party auth</td>
  </tr>
  <tr>
    <td>Single-Page Application API</td>
    <td>JWT with refresh tokens</td>
    <td>Works well with front-end frameworks</td>
  </tr>
  <tr>
    <td>IoT Device API</td>
    <td>Client certificates or API keys</td>
    <td>Handles limited device capabilities</td>
  </tr>
</table>
...
<p>You've now explored the essential authentication methods for Node.js APIs. Here's a quick recap of what we've covered:</p>
  
<div class="w3-row-padding">
<div class="w3-col m6">
  <h3>Authentication Methods</h3>
  <ul>
    <li><strong>Session-based</strong> - Traditional approach using server-side sessions</li>
    <li><strong>JWT Tokens</strong> - Stateless tokens for distributed systems</li>
    <li><strong>OAuth 2.0</strong> - Industry standard for third-party authentication</li>
    <li><strong>API Keys</strong> - Simple authentication for server-to-server communication</li>
  </ul>
</div>
<div class="w3-col m6">
...
<div id="exercisecontainer" src="xrcise_api_auth.js" data-extensions="asp"></div>
