...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Architecture</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js Architecture">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_architecture.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="Inside Node.js: the single-threaded, event-driven model that makes it fast.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Architecture">
<meta name="twitter:description" content="Inside Node.js: the single-threaded, event-driven model that makes it fast.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_architecture.png">
...
<h1>Node.js <span class="color_h1">Architecture</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_v8_engine.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="nodejs_event_loop.asp">Next &#10095;</a>
</div>
<hr>

<h2>What is Node.js Architecture?</h2>
<p>Node.js uses a <b>single-threaded, event-driven</b> architecture that is designed to handle many connections at once, efficiently and without blocking the main thread.</p>
<p>This makes Node.js ideal for building scalable network applications, real-time apps, and APIs.</p>

<div class="w3-panel ws-note">
  <p><strong>Key Characteristics:</strong> Non-blocking I/O, event-driven, single-threaded with event loop, asynchronous execution</p>
</div>
<hr>

<h2>Node.js Architecture Diagram</h2>
<p>Here is a simple overview of how Node.js processes requests:</p>
<div class="w3-panel ws-info">
  <p><b>1. Client Request Phase</b></p>
  <ul>
    <li>Clients send requests to the Node.js server</li>
    <li>Each request is added to the <strong>Event Queue</strong></li>
  </ul>
  
  <p><b>2. Event Loop Phase</b></p>
  <ul>
    <li>The Event Loop continuously checks the <strong>Event Queue</strong></li>
    <li>Picks up requests one by one in a loop</li>
  </ul>
  
  <p><b>3. Request Processing</b></p>
  <ul>
    <li>Simple (non-blocking) tasks are handled immediately by the main thread</li>
    <li>Complex/blocking tasks are offloaded to the Thread Pool</li>
  </ul>
  
  <p><b>4. Response Phase</b></p>
  <ul>
    <li>When blocking tasks complete, their callbacks are placed in the <strong>Callback Queue</strong></li>
    <li>Event Loop processes callbacks and sends responses</li>
  </ul>
</div>
<hr>
<h2>Non-blocking Examples</h2>
<div class="w3-example">
<h3>Example: Non-blocking File Read</h3>
<div class="w3-code notranslate jsHigh">
const fs = require('fs');<br>
console.log('Before file read');<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_architecture_nonblocking">Run example &raquo;</a>
</div>
<p>Notice how "After file read" is printed before the file contents, showing that Node.js does not wait for the file operation to finish.</p>

<div class="w3-example">
<h3>Example: Blocking vs Non-blocking Code</h3>
<div class="w3-code notranslate jsHigh">
// Blocking code example<br>
console.log('Start of blocking code');<br>
const data = fs.readFileSync('myfile.txt', 'utf8'); // Blocks here<br>
console.log('Blocking operation completed');<br>
<br>
// Non-blocking code example<br>console.log('Start of non-blocking code');<br>
fs.readFile('myfile.txt', 'utf8', (err, data) => {<br>
&nbsp;&nbsp;if (err) throw err;<br>
&nbsp;&nbsp;console.log('Non-blocking operation completed');<br>});<br>
console.log('This runs before the file is read');
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_architecture_blocking">Run example &raquo;</a>
</div>

<div class="w3-panel ws-note">
  <p><strong>Key Difference:</strong> The first example blocks the entire process until the file is read, while the second example allows other operations to continue while the file is being read.</p>
</div>
<hr>
...
<p>Node.js is particularly well-suited for:</p>
<ul>
  <li><b>I/O-bound applications</b> - File operations, database queries, network requests</li>
  <li><b>Real-time applications</b> - Chat apps, live notifications, collaboration tools</li>
  <li><b>APIs</b> - RESTful services, GraphQL APIs</li>
  <li><b>Microservices</b> - Small, independent services</li>
</ul>

<div class="w3-panel ws-warning">
  <p><strong>Note:</strong> Node.js may not be the best choice for CPU-intensive tasks as they can block the event loop. For such cases, consider:</p>
  <ul>
    <li>Using worker threads</li>
    <li>Creating a microservice in a more suitable language</li>
    <li>Using native add-ons</li>
  </ul>
</div>
<hr>
<h2>Summary</h2>
<p>Node.js is fast and efficient because it uses a non-blocking event loop and delegates heavy work to the system.</p>
<p>This allows it to handle thousands of connections at the same time, with minimal resources.</p>

<div class="w3-panel w3s-note">
  <h3>Key Benefits:</h3>
  <ul>
    <li>Handles many concurrent connections efficiently</li>
    <li>Great for I/O-bound applications</li>
    <li>Uses JavaScript on both client and server</li>
    <li>Large ecosystem of packages (npm)</li>
  </ul>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_architecture.js" data-extensions="asp"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_v8_engine.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="nodejs_event_loop.asp">Next &#10095;</a>
