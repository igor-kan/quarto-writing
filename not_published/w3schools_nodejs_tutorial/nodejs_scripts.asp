...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js NPM Scripts</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js NPM Scripts">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_scripts.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="NPM scripts are commands you define in your package.json file to automate tasks.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js NPM Scripts">
<meta name="twitter:description" content="NPM scripts are commands you define in your package.json file to automate tasks.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_scripts.png">
...
<h1>Node.js <span class="color_h1">NPM Scripts</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_package_json.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="nodejs_dependencies.asp">Next &#10095;</a>
</div>
<hr>

<h2>What are NPM Scripts?</h2>
<p>NPM scripts are commands you define in your <b>package.json</b> file to automate tasks like:</p>
<ul>
  <li>Running your app</li>
  <li>Testing</li>
  <li>Building</li>
  <li>Cleaning up files</li>
</ul>
<p>They make it easy to manage common tasks with simple commands.</p>
<hr>

<h2>Defining Scripts in package.json</h2>
<p>Inside <b>package.json</b>, the <code class="w3-codespan">scripts</code> section lets you name and define commands:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">{<br>
&nbsp;&nbsp;"scripts": {<br>
&nbsp;&nbsp;&nbsp;&nbsp;"start": "node index.js",<br>
&nbsp;&nbsp;&nbsp;&nbsp;"test": "echo \"Running tests...\" && exit 0",<br>
&nbsp;&nbsp;&nbsp;&nbsp;"dev": "nodemon index.js"<br>
&nbsp;&nbsp;}<br>
}</div>
</div>
<p>Each script can be run from the command line using <code class="w3-codespan">npm run &lt;script-name&gt;</code>.</p>
<hr>
...
<p>For the special <b>start</b> script, you can just use:</p>
<div class="w3-example">
<div class="w3-code notranslate w3-black">
npm start
</div>
</div>
<p>And for <b>test</b>:</p>
<div class="w3-example">
<div class="w3-code notranslate w3-black">
npm test
</div>
...
<h2>Common Uses for NPM Scripts</h2>
<ul>
  <li>Start your app</li>
  <li>Run tests</li>
  <li>Use tools like nodemon or webpack</li>
  <li>Build or bundle your code</li>
  <li>Lint or format your code</li>
</ul>
<hr>

<h2>Summary</h2>
<p>NPM scripts help automate and simplify project tasks.</p>
<p>Define them in <b>package.json</b> and run them easily with npm.</p>
<hr>
<div id="exercisecontainer" src="xrcise_scripts.js" data-extensions="asp"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_package_json.asp">&#10094; Previous</a>
