...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js EventEmitter Reference</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js EventEmitter Reference">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/ref_eventemitter.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="The EventEmitter is a module that facilitates communication between objects in Node.js.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js EventEmitter Reference">
<meta name="twitter:description" content="The EventEmitter is a module that facilitates communication between objects in Node.js.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/ref_eventemitter.png">
...
<h1>Node.js EventEmitter Reference</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="ref_buffer.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ref_worker.asp">Next &#10095;</a>
</div>

<hr>

<h2>EventEmitter Object</h2>
<p>The EventEmitter is a module that facilitates communication between objects in Node.js. It's at the core of Node's asynchronous event-driven architecture.</p>

<p>Many of Node's built-in modules inherit from EventEmitter, including HTTP servers, streams, and more.</p>

<h3>Import EventEmitter</h3>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// Method 1: Using require<br>
const EventEmitter = require('events');<br>
<br>
// Method 2: ES6 destructuring<br>
const { EventEmitter } = require('events');</div>
</div>
...
<br>
// Create a class that extends EventEmitter<br>
...
<br>
// Instantiate the extended class<br>
const myExtendedEmitter = new MyEmitter();</div>
</div>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    ...
    <td>Adds a listener to the end of the listeners array for the specified event. Alias for <code class="w3-codespan">on()</code>.</td>
  </tr>
  <tr>
    <td>emit(event, [arg1], [arg2], ...)</td>
    <td>Synchronously calls each of the listeners registered for the event, in the order they were registered, passing the supplied arguments to each.</td>
  </tr>
  <tr>
    <td>eventNames()</td>
    <td>Returns an array listing the events for which the emitter has registered listeners.</td>
  </tr>
  <tr>
    <td>getMaxListeners()</td>
    <td>Returns the current maximum listener value for the EventEmitter, set by <code class="w3-codespan">emitter.setMaxListeners(n)</code> or defaults to <code class="w3-codespan">EventEmitter.defaultMaxListeners</code>.</td>
  </tr>
  <tr>
    <td>listenerCount(event)</td>
    <td>Returns the number of listeners listening to the specified event.</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Alias for <code class="w3-codespan">removeListener()</code>.</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Adds a one-time listener for the event that will be removed after it is triggered once.</td>
  </tr>
  <tr>
    <td>prependListener(event, listener)</td>
    <td>Adds a listener to the beginning of the listeners array for the specified event.</td>
  </tr>
  <tr>
    <td>prependOnceListener(event, listener)</td>
    <td>Adds a one-time listener for the event to the beginning of the listeners array that will be removed after it is triggered once.</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Removes the specified listener from the listener array for the specified event.</td>
  </tr>
  <tr>
    <td>setMaxListeners(n)</td>
    <td>Sets the maximum number of listeners that can be added to an EventEmitter instance.</td>
  </tr>
  <tr>
    <td>rawListeners(event)</td>
    <td>Returns a copy of the array of listeners for the specified event, including any wrappers (like those created by <code class="w3-codespan">once()</code>).</td>
  </tr>
</table>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td>EventEmitter.defaultMaxListeners</td>
    <td>Sets the default maximum number of listeners for all EventEmitter instances. Default is 10.</td>
  </tr>
  <tr>
    <td>emitter.errorMonitor</td>
    <td>A static symbol that can be used to install a listener for only monitoring 'error' events.</td>
  </tr>
  <tr>
    <td>emitter.captureRejections</td>
    <td>When true, promise rejections are captured and emitted as 'error' events.</td>
  </tr>
</table>

<hr>

<h2>Basic EventEmitter Usage</h2>
...
<br>
// Emit the event<br>
myEmitter.emit('event');</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_ref_eventemitter_basic">Try it Yourself &raquo;</a>
</div>
<hr>
...
const myEmitter = new EventEmitter();<br>
<br>
// Event with multiple arguments<br>
myEmitter.on('status', (code, message) => {<br>
&nbsp;&nbsp;console.log(`Got status: ${code} ${message}`);<br>
});<br>
<br>
// Emit with arguments<br>
myEmitter.emit('status', 200, 'OK');</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_ref_eventemitter_args">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>One-time Event Listeners</h2>
...
const myEmitter = new EventEmitter();<br>
<br>
// Add one-time listener<br>
myEmitter.once('onetime', () => {<br>
&nbsp;&nbsp;console.log('This will be called only once');<br>
});<br>
<br>
// First emit - will trigger the listener<br>
myEmitter.emit('onetime');<br>
<br>
// Second emit - won't trigger the listener<br>
myEmitter.emit('onetime');</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_ref_eventemitter_once">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Error Events</h2>
...
const myEmitter = new EventEmitter();<br>
<br>
// Error event handler<br>
myEmitter.on('error', (err) => {<br>
&nbsp;&nbsp;console.error('Error occurred:', err.message);<br>
});<br>
<br>
// Emit an error event<br>
myEmitter.emit('error', new Error('Something went wrong'));<br>
<br>
// If no 'error' listener is added, Node will throw and crash<br>
// Always add an error handler!</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_ref_eventemitter_error">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Getting Event Names and Listeners</h2>
...
const myEmitter = new EventEmitter();<br>
<br>
// Add some listeners<br>
myEmitter.on('event1', () => console.log('Event 1'));<br>
myEmitter.on('event2', () => console.log('Event 2'));<br>
myEmitter.on('event2', () => console.log('Event 2 again'));<br>
<br>
// Get all event names<br>
console.log('Event names:', myEmitter.eventNames());<br>
<br>
// Get listeners for a specific event<br>
console.log('Listeners for event2:', myEmitter.listeners('event2'));<br>
<br>
// Count listeners<br>
console.log('Listener count for event2:', myEmitter.listenerCount('event2'));</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_ref_eventemitter_info">Try it Yourself &raquo;</a>
</div>
<hr>
...
const myEmitter = new EventEmitter();<br>
<br>
// Define listener function (needed for removal)<br>
function listener1() {<br>
&nbsp;&nbsp;console.log('Listener 1 executed');<br>
}<br>
<br>
function listener2() {<br>
&nbsp;&nbsp;console.log('Listener 2 executed');<br>
}<br>
<br>
<br>
// Add listeners<br>
myEmitter.on('event', listener1);<br>
myEmitter.on('event', listener2);<br>
<br>
console.log('Listeners before removal:', myEmitter.listenerCount('event'));<br>
<br>
// Remove a specific listener<br>
myEmitter.removeListener('event', listener1);<br>
// or using the alias: myEmitter.off('event', listener1);<br>
<br>
console.log('Listeners after removal:', myEmitter.listenerCount('event'));<br>
<br>
// Remove all listeners for an event<br>
myEmitter.removeAllListeners('event');<br>
<br>
console.log('Listeners after removeAll:', myEmitter.listenerCount('event'));</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_ref_eventemitter_remove">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Setting Maximum Listeners</h2>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const EventEmitter = require('events');<br>
<br>
// Set the default max listeners for all EventEmitter instances<br>
EventEmitter.defaultMaxListeners = 15;<br>
<br>
const myEmitter = new EventEmitter();<br>
<br>
// Set max listeners for a specific instance<br>
myEmitter.setMaxListeners(20);<br>
<br>
console.log('Default max listeners:', EventEmitter.defaultMaxListeners);<br>
console.log('myEmitter max listeners:', myEmitter.getMaxListeners());<br>
<br>
// Adding more than maxListeners will trigger a warning<br>
// The warning helps identify potential memory leaks</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_ref_eventemitter_max">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Order of Listeners</h2>
...
const myEmitter = new EventEmitter();<br>
<br>
// Default behavior: listeners execute in order they were added<br>
myEmitter.on('event', () => console.log('First listener'));<br>
myEmitter.on('event', () => console.log('Second listener'));<br>
<br>
// Prepend a listener (it will execute first)<br>
myEmitter.prependListener('event', () => console.log('Prepended listener'));<br>
<br>
// One-time prepended listener<br>
myEmitter.prependOnceListener('event', () => console.log('Prepended once listener'));<br>
<br>
<br>
// Emit the event<br>
myEmitter.emit('event');<br>
<br>
// Output will be:<br>
// Prepended once listener<br>
// Prepended listener<br>
// First listener<br>
// Second listener</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_ref_eventemitter_order">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Extending EventEmitter</h2>

<p>A common pattern in Node.js is to create a class that extends EventEmitter, adding custom functionality:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const EventEmitter = require('events');<br>
<br>
// Custom class that extends EventEmitter<br>
class MyApp extends EventEmitter {<br>
&nbsp;&nbsp;constructor() {<br>
&nbsp;&nbsp;&nbsp;&nbsp;super();<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.name = 'MyApp';<br>
&nbsp;&nbsp;}<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Processing data: ${data}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Emit events based on processing results<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (data.length > 10) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;this.emit('large-data', data);<br>
&nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;this.emit('small-data', data);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Emit completion event<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.emit('processed', data);<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
// Create an instance<br>
const app = new MyApp();<br>
<br>
// Register event listeners<br>
app.on('large-data', (data) => {<br>
&nbsp;&nbsp;console.log(`Large data detected: ${data.length} bytes`);<br>
});<br>
<br>
app.on('small-data', (data) => {<br>
&nbsp;&nbsp;console.log(`Small data detected: ${data.length} bytes`);<br>
});<br>
<br>
app.on('processed', (data) => {<br>
&nbsp;&nbsp;console.log('Processing completed');<br>
});<br>
<br>
// Use the app<br>
app.process('Hello');<br>
app.process('Hello, this is a longer string of data');</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_ref_eventemitter_extend">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Asynchronous vs. Synchronous</h2>

<p>EventEmitter calls all listeners synchronously in the order they were registered. Important for maintaining the expected execution order:</p>
...
myEmitter.on('event', () => {<br>
&nbsp;&nbsp;console.log('Listener executed');<br>
});<br>
<br>
// Emit event<br>
console.log('Before emit');<br>
myEmitter.emit('event');<br>
console.log('After emit');<br>
<br>
// Output:<br>
// Before emit<br>
// Listener executed<br>
// After emit</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_ref_eventemitter_sync">Try it Yourself &raquo;</a>
</div>

<p>To run listeners asynchronously, you can use setImmediate() or process.nextTick():</p>
...
const myEmitter = new EventEmitter();<br>
<br>
// Register async listener using setImmediate<br>
myEmitter.on('async-event', () => {<br>
&nbsp;&nbsp;setImmediate(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Async listener executed');<br>
&nbsp;&nbsp;});<br>
});<br>
<br>
console.log('Before emit');<br>
myEmitter.emit('async-event');<br>
console.log('After emit');<br>
<br>
// Output:<br>
// Before emit<br>
// After emit<br>
// Async listener executed</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_ref_eventemitter_async">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Promise Integration</h2>

<p>EventEmitter in modern Node.js versions can handle Promises and capture rejections:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const EventEmitter = require('events');<br>
<br>
// Enable capture rejections (Node.js 12.16.0+)<br>
const myEmitter = new EventEmitter({ captureRejections: true });<br>
<br>
// OR set it globally<br>
// EventEmitter.captureRejections = true;<br>
<br>
// Event handler that returns a Promise<br>
myEmitter.on('async-operation', async () => {<br>
&nbsp;&nbsp;// This rejected promise will be captured and converted to an 'error' event<br>
&nbsp;&nbsp;throw new Error('Async operation failed');<br>
});<br>
<br>
// Error handler<br>
myEmitter.on('error', (err) => {<br>
...
myEmitter.emit('async-operation');</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_eventemitter_promise">Run Example &raquo;</a>
</div>
<hr>
<h2>Real-World Example: HTTP Server</h2>

<p>EventEmitter powers many Node.js core modules. Here's how an HTTP server uses events:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const http = require('http');<br>
<br>
// HTTP Server is an EventEmitter<br>
const server = http.createServer();<br>
<br>
// Listen for 'request' events<br>
server.on('request', (request, response) => {<br>
&nbsp;&nbsp;console.log(`Received ${request.method} request for ${request.url}`);<br>
&nbsp;&nbsp;response.writeHead(200, { 'Content-Type': 'text/plain' });<br>
&nbsp;&nbsp;response.end('Hello World\n');<br>
});<br>
<br>
// Listen for 'connection' events<br>
server.on('connection', (socket) => {<br>
&nbsp;&nbsp;console.log('New client connection from', socket.remoteAddress);<br>
});<br>
<br>
// Listen for 'close' event<br>
server.on('close', () => {<br>
...
<br>
// Later, we can close the server<br>
// server.close();</div>
</div>
...
<h3>1. Always Listen for 'error' Events</h3>

<p>If an EventEmitter emits an 'error' event and there are no listeners, Node.js will throw the error and crash the process. Always add error handlers:</p>
...
const myEmitter = new EventEmitter();<br>
<br>
// Always add error handlers<br>
myEmitter.on('error', (err) => {<br>
&nbsp;&nbsp;console.error('Error occurred:', err);<br>
&nbsp;&nbsp;// Handle the error appropriately<br>
});</div>
</div>

<h3>2. Cleanup Listeners to Prevent Memory Leaks</h3>
...
&nbsp;&nbsp;const handler = () => console.log('Event handled');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Add the handler<br>
&nbsp;&nbsp;myEmitter.on('some-event', handler);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Return a cleanup function<br>
&nbsp;&nbsp;return function cleanup() {<br>
&nbsp;&nbsp;&nbsp;&nbsp;myEmitter.removeListener('some-event', handler);<br>
&nbsp;&nbsp;};<br>
}<br>
<br>
// Set up a handler<br>
const cleanup = setupHandler();<br>
<br>
// Later, when no longer needed<br>
cleanup();</div>
</div>

<h3>3. Use Named Functions for Removable Listeners</h3>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// BAD - Cannot remove this listener later<br>
emitter.on('event', () => console.log('Anonymous function'));<br>
<br>
// GOOD - Can be removed by reference<br>
function namedHandler() {<br>
&nbsp;&nbsp;console.log('Named function');<br>
}<br>
<br>
emitter.on('event', namedHandler);<br>
<br>
// Later<br>
emitter.removeListener('event', namedHandler);</div>
</div>
