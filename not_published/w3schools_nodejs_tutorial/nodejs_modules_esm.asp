...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js ES Modules</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js ES Modules">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_modules_esm.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="ES Modules (ESM) is the official standard format for packaging JavaScript code for reuse.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js ES Modules">
<meta name="twitter:description" content="ES Modules (ESM) is the official standard format for packaging JavaScript code for reuse.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_modules_esm.png">
...
<h1>Node.js <span class="color_h1">ES Modules</span></h1>
...
<h2 id="intro">Introduction to ES Modules</h2>
<p>ES Modules (ESM) is the official standard format for packaging JavaScript code for reuse.</p>
<p>It was introduced in ES6 (ES2015) and is now supported in Node.js.</p>
<p>Prior to ES Modules, Node.js exclusively used the CommonJS module format (require/exports). </p>
<p>Now developers can choose between CommonJS and ES Modules based on their project needs.</p>

<div class="w3-panel ws-info">
<p>ES Modules provides a more structured and statically analyzable way to work with modules compared to CommonJS, with benefits like tree-shaking for smaller builds.</p>
</div>
<hr>

<h2 id="vs">CommonJS vs ES Modules</h2>
<p>Here's how CommonJS and ES Modules differ:</p>
...
<td>.js (default)</td>
<td>.mjs (or .js with proper config)</td>
</tr>
<tr>
<td>Import Syntax</td>
<td>require()</td>
...
<td>Static (parsed before execution)</td>
</tr>
<tr>
...
// app.mjs (ES Module)<br>
import { add, subtract } from './math.mjs';<br>
console.log(add(5, 3)); // 8
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_esm_basic">Run example &raquo;</a>
</div>
<hr>

<h2 id="enabling">Enabling ES Modules</h2>
<p>There are several ways to enable ES Modules in Node.js:</p>

<h3>1. Using the .mjs File Extension</h3>
<p>The simplest way is to use the .mjs extension for your files.</p>
<p>Node.js will automatically treat these files as ES Modules.</p>

<h3>2. Setting "type": "module" in package.json</h3>
<p>To use ES Modules with regular .js files, add the following to your package.json:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
{<br>
&nbsp;&nbsp;"name": "my-package",<br>
...
<p>With this setting, all .js files in your project will be treated as ES Modules.</p>

<h3>3. Using the --input-type=module Flag</h3>
<p>For scripts run directly with the node command, you can specify the module system:</p>
<div class="w3-example">
...
<p><strong>Note:</strong> If you're working with a codebase that primarily uses CommonJS but you want to use ES Modules in one file, using the .mjs extension is the most explicit and least error-prone approach.</p>
</div>
<hr>
...
<h2 id="syntax">Import and Export Syntax</h2>
<p>ES Modules provide more flexible ways to import and export code compared to CommonJS.</p>

<h3>Export Syntax</h3>
<div class="w3-example">
<h4>Named Exports</h4>
<div class="w3-code notranslate jsHigh">
// Multiple named exports<br>
export function sayHello() {<br>
&nbsp;&nbsp;console.log('Hello');<br>
}<br><br>
export function sayGoodbye() {<br>
&nbsp;&nbsp;console.log('Goodbye');<br>
}<br><br>
// Alternative: export list at the end<br>
function add(a, b) {<br>
&nbsp;&nbsp;return a + b;<br>
}<br><br>
function subtract(a, b) {<br>
...
<div class="w3-code notranslate jsHigh">
// Only one default export per module<br>
export default function() {<br>
&nbsp;&nbsp;console.log('I am the default export');<br>
}<br><br>
// Or with a named function/class/object<br>
function mainFunction() {<br>
&nbsp;&nbsp;return 'Main functionality';<br>
}<br><br>
...
<h4>Mixed Exports</h4>
<div class="w3-code notranslate jsHigh">
// Combining default and named exports<br>
export const VERSION = '1.0.0';<br><br>
function main() {<br>
&nbsp;&nbsp;console.log('Main function');<br>
}<br><br>
...
<div class="w3-code notranslate jsHigh">
// Import specific named exports<br>
import { sayHello, sayGoodbye } from './greetings.mjs';<br>
sayHello(); // Hello<br><br>
// Rename imports to avoid naming conflicts<br>
import { add as sum, subtract as minus } from './math.mjs';<br>
console.log(sum(5, 3)); // 8<br><br>
// Import all named exports as an object<br>
import * as math from './math.mjs';<br>
...
<div class="w3-code notranslate jsHigh">
// Import the default export<br>
import mainFunction from './main.mjs';<br>
mainFunction();<br><br>
// You can name the default import anything you want<br>
import anyNameYouWant from './main.mjs';<br>
anyNameYouWant();
</div>
</div>

<div class="w3-example">
<h4>Importing Both Default and Named Exports</h4>
<div class="w3-code notranslate jsHigh">
// Import both default and named exports<br>
import main, { VERSION } from './main.mjs';<br>
console.log(VERSION); // 1.0.0<br>
main(); // Main function
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_esm_import_export">Run example &raquo;</a>
</div>
<hr>

<h2 id="dynamic">Dynamic Imports</h2>
<p>ES Modules support dynamic imports, allowing you to load modules conditionally or on-demand.</p>

<div class="w3-example">
<h3>Example: Dynamic Imports</h3>
<div class="w3-code notranslate jsHigh">
// app.mjs<br>
async function loadModule(moduleName) {<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Dynamic import returns a promise<br>
&nbsp;&nbsp;&nbsp;&nbsp;const module = await import(`./${moduleName}.mjs`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;return module;<br>
&nbsp;&nbsp;} catch (error) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error(`Failed to load ${moduleName}:`, error);<br>
&nbsp;&nbsp;}<br>
}<br><br>
// Load a module based on a condition<br>
const moduleName = process.env.NODE_ENV === 'production' ? 'prod' : 'dev';<br><br>
loadModule(moduleName).then(module => {<br>
&nbsp;&nbsp;module.default(); // Call the default export<br>
});<br><br>
// Or with simpler await syntax<br>
(async () => {<br>
&nbsp;&nbsp;const mathModule = await import('./math.mjs');<br>
&nbsp;&nbsp;console.log(mathModule.add(10, 5)); // 15<br>
})();
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_esm_dynamic">Run example &raquo;</a>
</div>

<div class="w3-panel ws-note">
<p><strong>Use Case:</strong> Dynamic imports are great for code-splitting, lazy-loading modules, or conditionally loading modules based on runtime conditions.</p>
</div>
<hr>

<h2 id="toplevels">Top-level Await</h2>
<p>Unlike CommonJS, ES Modules support top-level await, allowing you to use await outside of async functions at the module level.</p>

<div class="w3-example">
<h3>Example: Top-level Await</h3>
<div class="w3-code notranslate jsHigh">
// data-loader.mjs<br>
// This would cause an error in CommonJS or in a script<br>
// But works at the top level in an ES Module<br><br>
console.log('Loading data...');<br><br>
// Top-level await - the module's execution pauses here<br>
const response = await fetch('https://jsonplaceholder.typicode.com/todos/1');<br>
const data = await response.json();<br><br>
console.log('Data loaded!');<br><br>
export { data };<br><br>
// When another module imports this one, it will only get the exports<br>
// after all the top-level await operations have completed
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_esm_toplevel_await">Run example &raquo;</a>
</div>

<p>Top-level await is especially useful for:</p>
<ul>
  <li>Loading configuration from files or remote sources</li>
  <li>Connecting to databases before exporting functionality</li>
  <li>Conditional imports or module initialization</li>
</ul>
<hr>

<h2 id="bestpractices">Best Practices</h2>
<p>When working with ES Modules in Node.js, follow these best practices:</p>

<h3>1. Be Clear About File Extensions</h3>
<p>Always include file extensions in your import statements for local files:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// Good<br>
import { someFunction } from './utils.mjs';<br><br>
// Bad - might not work depending on configuration<br>
import { someFunction } from './utils';
</div>
</div>

<h3>2. Use Directory Indexes Properly</h3>
<p>For directory imports, create index.mjs files:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// utils/index.mjs<br>
export * from './string-utils.mjs';<br>
export * from './number-utils.mjs';<br><br>
// app.mjs<br>
import { formatString, add } from './utils/index.mjs';
</div>
</div>

<h3>3. Choose the Right Export Style</h3>
<p>Use named exports for multiple functions/values, and default exports for main functionality:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// For libraries with many utilities, use named exports<br>
export function validate() { /* ... */ }<br>
export function format() { /* ... */ }<br><br>
// For components or classes that are the primary export<br>
export default class UserService { /* ... */ }
</div>
</div>

<h3>4. Handle the Transition from CommonJS</h3>
<p>When working with a codebase that mixes CommonJS and ES Modules:</p>
<ul>
  <li>ES Modules can import from CommonJS modules using default import</li>
  <li>CommonJS can require() ES Modules only with dynamic import()</li>
  <li>Use the compatibility helpers in the Node.js 'module' package for interoperability</li>
</ul>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// Importing CommonJS module from ESM<br>
import fs from 'fs'; // The default import is module.exports<br><br>
// Importing ESM from CommonJS (Node.js 12+)<br>
// In a CommonJS module:<br>
(async () => {<br>
&nbsp;&nbsp;const { default: myEsmModule } = await import('./my-esm-module.mjs');<br>
})();
</div>
</div>

<h3>5. Dual Package Hazard</h3>
<p>For npm packages that support both module systems, use the "exports" field in package.json to specify different entry points:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
{<br>
&nbsp;&nbsp;"name": "my-package",<br>
...
<div class="w3-panel ws-info">
<p><strong>Node.js Support:</strong> ES Modules are fully supported in Node.js since v12, with better support in v14+.</p>
<p>For older versions, you may need a transpiler like Babel.</p>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_modules_esm.js" data-extensions="asp"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_modules.asp">&#10094; Previous</a>
