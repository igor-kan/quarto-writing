...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Hmac Reference</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js Hmac Reference">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/ref_hmac.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="The Hmac class is part of Node.js's crypto module. It provides a way to create cryptographic HMAC (Hash-based Message Authentication Code) digests.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Hmac Reference">
<meta name="twitter:description" content="The Hmac class is part of Node.js's crypto module. It provides a way to create cryptographic HMAC (Hash-based Message Authentication Code) digests.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/ref_hmac.png">
...
<h1>Node.js Hmac Reference</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="ref_hash.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ref_sign.asp">Next &#10095;</a>
</div>
...
<p>The Hmac class is part of Node.js's <code class="w3-codespan">crypto</code> module. It provides a way to create cryptographic HMAC (Hash-based Message Authentication Code) digests. HMAC instances are created using the <code class="w3-codespan">crypto.createHmac()</code> method.</p>

<p>HMAC combines a cryptographic hash function with a secret key to produce a message authentication code, providing both data integrity and authentication.</p>
...
<br>
// Create an Hmac object<br>
const hmac = crypto.createHmac('sha256', 'your-secret-key');
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_hmac_import">Run example &raquo;</a>
</div>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td>hmac.update(data[, inputEncoding])</td>
    <td>Updates the Hmac content with the given <code class="w3-codespan">data</code>. If <code class="w3-codespan">inputEncoding</code> is provided, <code class="w3-codespan">data</code> is a string using the specified encoding; otherwise, <code class="w3-codespan">data</code> is a Buffer, TypedArray, or DataView. This method can be called multiple times with new data.</td>
  </tr>
  <tr>
    <td>hmac.digest([encoding])</td>
    <td>Calculates the HMAC digest of all the data passed to the Hmac using <code class="w3-codespan">hmac.update()</code>. If <code class="w3-codespan">encoding</code> is provided, a string is returned; otherwise, a Buffer is returned. After this method is called, the Hmac object can no longer be used.</td>
  </tr>
</table>

<hr>

<h2>Basic Hmac Example</h2>

<p>The following example demonstrates how to create an HMAC digest of a string:</p>
...
<br>
// Secret key<br>
const secretKey = 'my-secret-key';<br>
<br>
// Create an Hmac object<br>
const hmac = crypto.createHmac('sha256', secretKey);<br>
<br>
// Update the hmac with data<br>
hmac.update(data);<br>
<br>
// Get the digest in hex format<br>
const digest = hmac.digest('hex');<br>
<br>
console.log('Data:', data);<br>
console.log('Secret Key:', secretKey);<br>
console.log('HMAC-SHA256:', digest);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_hmac_basic">Run example &raquo;</a>
</div>
...
<h2>Comparing Different HMAC Algorithms</h2>

<p>This example compares different hash algorithms with HMAC:</p>
...
<br>
// Data to authenticate<br>
const data = 'Node.js Crypto HMAC Example';<br>
<br>
// Secret key<br>
const secretKey = 'my-secret-key';<br>
<br>
// Function to create HMAC with different algorithms<br>
function createHmacWithAlgorithm(algorithm, data, key) {<br>
&nbsp;&nbsp;const hmac = crypto.createHmac(algorithm, key);<br>
&nbsp;&nbsp;hmac.update(data);<br>
&nbsp;&nbsp;return hmac.digest('hex');<br>
}<br>
<br>
// Test various HMAC algorithms<br>
...
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const digest = createHmacWithAlgorithm(algorithm, data, secretKey);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`HMAC-${algorithm}: ${digest}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Length: ${digest.length / 2} bytes (${digest.length * 4} bits)`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('------------------------------------');<br>
&nbsp;&nbsp;} catch (error) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`HMAC-${algorithm}: Not supported - ${error.message}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('------------------------------------');<br>
&nbsp;&nbsp;}<br>
});
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_hmac_compare">Run example &raquo;</a>
</div>

<hr>

<h2>HMAC with Multiple Updates</h2>

<p>You can update an HMAC with multiple pieces of data before calculating the digest:</p>
...
const hmac = crypto.createHmac('sha256', secretKey);<br>
<br>
// Update the hmac with multiple pieces of data<br>
hmac.update('First part of the data.');<br>
hmac.update(' Second part of the data.');<br>
hmac.update(' Third part of the data.');<br>
<br>
...
console.log('Secret Key:', secretKey);<br>
console.log('HMAC-SHA256:', digest);<br>
<br>
// You can achieve the same result with a single update<br>
const singleHmac = crypto.createHmac('sha256', secretKey);<br>
singleHmac.update('First part of the data. Second part of the data. Third part of the data.');<br>
const singleDigest = singleHmac.digest('hex');<br>
<br>
console.log('Single update HMAC matches multiple updates?', singleDigest === digest);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_hmac_multiple">Run example &raquo;</a>
</div>

<hr>

<h2>HMAC with Different Encodings</h2>

<p>You can get an HMAC digest in different encodings:</p>
...
const secretKey = 'my-secret-key';<br>
<br>
// Function to create HMAC and get digest in different encodings<br>
function createHmacWithEncoding(algorithm, data, key, encoding) {<br>
&nbsp;&nbsp;const hmac = crypto.createHmac(algorithm, key);<br>
&nbsp;&nbsp;hmac.update(data);<br>
&nbsp;&nbsp;return hmac.digest(encoding);<br>
}<br>
<br>
// Create HMAC with SHA-256 and display in different encodings<br>
console.log(`Data: "${data}"`);<br>
console.log(`Secret Key: "${secretKey}"`);<br>
console.log(`HMAC-SHA256 (hex): ${createHmacWithEncoding('sha256', data, secretKey, 'hex')}`);<br>
console.log(`HMAC-SHA256 (base64): ${createHmacWithEncoding('sha256', data, secretKey, 'base64')}`);<br>
console.log(`HMAC-SHA256 (base64url): ${createHmacWithEncoding('sha256', data, secretKey, 'base64url')}`);<br>
console.log(`HMAC-SHA256 (binary): ${createHmacWithEncoding('sha256', data, secretKey, 'binary')}`);<br>
<br>
// Get the digest as a Buffer (no encoding)<br>
const hmac = crypto.createHmac('sha256', secretKey);<br>
hmac.update(data);<br>
const buffer = hmac.digest();<br>
console.log('HMAC-SHA256 (Buffer):', buffer);<br>
console.log('Buffer length:', buffer.length, 'bytes');
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_hmac_encodings">Run example &raquo;</a>
</div>

<hr>

<h2>File Authentication with HMAC</h2>

<p>You can create an HMAC digest of a file's contents:</p>
...
<br>
// Function to create HMAC for a file using streams<br>
function createHmacForFile(filePath, algorithm, key) {<br>
&nbsp;&nbsp;return new Promise((resolve, reject) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Create Hmac object<br>
&nbsp;&nbsp;&nbsp;&nbsp;const hmac = crypto.createHmac(algorithm, key);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
...
<br>
// Secret key<br>
const secretKey = 'file-authentication-key';<br>
<br>
...
<br>
// Create HMAC for the file with different algorithms<br>
Promise.all([<br>
&nbsp;&nbsp;createHmacForFile(filePath, 'md5', secretKey),<br>
&nbsp;&nbsp;createHmacForFile(filePath, 'sha1', secretKey),<br>
&nbsp;&nbsp;createHmacForFile(filePath, 'sha256', secretKey)<br>
])<br>
.then(([md5Digest, sha1Digest, sha256Digest]) => {<br>
&nbsp;&nbsp;console.log(`File: ${filePath}`);<br>
&nbsp;&nbsp;console.log(`Secret Key: ${secretKey}`);<br>
&nbsp;&nbsp;console.log(`HMAC-MD5: ${md5Digest}`);<br>
&nbsp;&nbsp;console.log(`HMAC-SHA1: ${sha1Digest}`);<br>
&nbsp;&nbsp;console.log(`HMAC-SHA256: ${sha256Digest}`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Store the HMAC for later verification<br>
&nbsp;&nbsp;fs.writeFileSync(`${filePath}.hmac`, sha256Digest);<br>
&nbsp;&nbsp;console.log(`HMAC stored in: ${filePath}.hmac`);<br>
})<br>
.catch(error => {<br>
&nbsp;&nbsp;console.error('Error creating HMAC for file:', error.message);<br>
});
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_hmac_file">Run example &raquo;</a>
</div>

<hr>

<h2>Verifying File Integrity with HMAC</h2>

<p>This example demonstrates how to verify a file's integrity using a previously generated HMAC:</p>
...
const fs = require('fs');<br>
<br>
// Function to create HMAC for a file<br>
function createHmacForFile(filePath, algorithm, key) {<br>
&nbsp;&nbsp;return new Promise((resolve, reject) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const hmac = crypto.createHmac(algorithm, key);<br>
&nbsp;&nbsp;&nbsp;&nbsp;const stream = fs.createReadStream(filePath);<br>
...
<br>
// Function to verify file integrity<br>
async function verifyFileIntegrity(filePath, storedHmacPath, algorithm, key) {<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Read the stored HMAC<br>
&nbsp;&nbsp;&nbsp;&nbsp;const storedHmac = fs.readFileSync(storedHmacPath, 'utf8').trim();<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Calculate the current HMAC<br>
&nbsp;&nbsp;&nbsp;&nbsp;const currentHmac = await createHmacForFile(filePath, algorithm, key);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Compare the HMACs<br>
&nbsp;&nbsp;&nbsp;&nbsp;const isValid = currentHmac === storedHmac;<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;return {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;isValid,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;storedHmac,<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;};<br>
&nbsp;&nbsp;} catch (error) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;throw new Error(`Verification failed: ${error.message}`);<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
// Secret key (must be the same as used to create the original HMAC)<br>
const secretKey = 'file-authentication-key';<br>
<br>
// Example usage<br>
const filePath = 'example.txt';<br>
const hmacPath = `${filePath}.hmac`;<br>
<br>
// Verify the file integrity<br>
verifyFileIntegrity(filePath, hmacPath, 'sha256', secretKey)<br>
&nbsp;&nbsp;.then(result => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`File: ${filePath}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`HMAC file: ${hmacPath}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Integrity verified: ${result.isValid}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (!result.isValid) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Stored HMAC:', result.storedHmac);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Current HMAC:', result.currentHmac);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('The file has been modified!');<br>
&nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('The file is intact and has not been tampered with.');<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;})<br>
&nbsp;&nbsp;.catch(error => {<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_hmac_verify">Run example &raquo;</a>
</div>
...
<p>HMAC can work with different types of keys:</p>
...
<br>
// Data to authenticate<br>
const data = 'Data to authenticate with HMAC';<br>
<br>
// Function to create HMAC with different key types<br>
function createHmacWithKey(algorithm, data, key, keyType) {<br>
&nbsp;&nbsp;const hmac = crypto.createHmac(algorithm, key);<br>
&nbsp;&nbsp;hmac.update(data);<br>
&nbsp;&nbsp;return {<br>
&nbsp;&nbsp;&nbsp;&nbsp;keyType,<br>
&nbsp;&nbsp;&nbsp;&nbsp;hmac: hmac.digest('hex')<br>
&nbsp;&nbsp;};<br>
}<br>
<br>
console.log(`Data: "${data}"`);<br>
...
<br>
// 1. String key<br>
const stringKey = 'my-secret-key';<br>
console.log(createHmacWithKey('sha256', data, stringKey, 'String key'));<br>
<br>
// 2. Buffer key<br>
const bufferKey = Buffer.from('buffer-secret-key');<br>
console.log(createHmacWithKey('sha256', data, bufferKey, 'Buffer key'));<br>
<br>
// 3. TypedArray key<br>
const uint8ArrayKey = new Uint8Array([72, 101, 108, 108, 111]); // "Hello" in ASCII<br>
console.log(createHmacWithKey('sha256', data, uint8ArrayKey, 'Uint8Array key'));<br>
<br>
// 4. DataView key<br>
const arrayBuffer = new ArrayBuffer(5);<br>
const dataView = new DataView(arrayBuffer);<br>
dataView.setUint8(0, 72);&nbsp;&nbsp;// H<br>
dataView.setUint8(1, 101); // e<br>
dataView.setUint8(2, 108); // l<br>
dataView.setUint8(3, 108); // l<br>
dataView.setUint8(4, 111); // o<br>
console.log(createHmacWithKey('sha256', data, dataView, 'DataView key'));<br>
<br>
// 5. KeyObject (recommended for sensitive keys)<br>
const keyObject = crypto.createSecretKey(Buffer.from('key-object-secret'));<br>
console.log(createHmacWithKey('sha256', data, keyObject, 'KeyObject'));
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_hmac_key_types">Run example &raquo;</a>
</div>

<hr>

<h2>HMAC for API Authentication</h2>

<p>HMAC is commonly used for API authentication, where the server and client share a secret key:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const crypto = require('crypto');<br>
<br>
// Simulated API request<br>
function createApiRequest(apiKey, secretKey, method, path, queryParams, body, timestamp) {<br>
&nbsp;&nbsp;// Create the string to sign<br>
&nbsp;&nbsp;const stringToSign = [<br>
&nbsp;&nbsp;&nbsp;&nbsp;method.toUpperCase(),<br>
&nbsp;&nbsp;&nbsp;&nbsp;path,<br>
&nbsp;&nbsp;&nbsp;&nbsp;new URLSearchParams(queryParams).toString(),<br>
&nbsp;&nbsp;&nbsp;&nbsp;typeof body === 'string' ? body : JSON.stringify(body || {}),<br>
&nbsp;&nbsp;&nbsp;&nbsp;timestamp<br>
&nbsp;&nbsp;].join('\n');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Create HMAC signature<br>
&nbsp;&nbsp;const hmac = crypto.createHmac('sha256', secretKey);<br>
&nbsp;&nbsp;hmac.update(stringToSign);<br>
&nbsp;&nbsp;const signature = hmac.digest('hex');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Return the request with authentication headers<br>
&nbsp;&nbsp;return {<br>
&nbsp;&nbsp;&nbsp;&nbsp;url: `https://api.example.com${path}?${new URLSearchParams(queryParams)}`,<br>
&nbsp;&nbsp;&nbsp;&nbsp;method,<br>
&nbsp;&nbsp;&nbsp;&nbsp;headers: {<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;},<br>
&nbsp;&nbsp;&nbsp;&nbsp;body: body || {},<br>
&nbsp;&nbsp;&nbsp;&nbsp;// For debugging/verification<br>
&nbsp;&nbsp;&nbsp;&nbsp;stringToSign<br>
&nbsp;&nbsp;};<br>
}<br>
<br>
// Simulate API server verification<br>
function verifyApiRequest(apiKey, secretKey, method, path, queryParams, body, timestamp, signature) {<br>
&nbsp;&nbsp;// Recreate the string that was signed<br>
&nbsp;&nbsp;const stringToSign = [<br>
&nbsp;&nbsp;&nbsp;&nbsp;method.toUpperCase(),<br>
&nbsp;&nbsp;&nbsp;&nbsp;path,<br>
&nbsp;&nbsp;&nbsp;&nbsp;new URLSearchParams(queryParams).toString(),<br>
...
&nbsp;&nbsp;].join('\n');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Verify HMAC signature<br>
&nbsp;&nbsp;const hmac = crypto.createHmac('sha256', secretKey);<br>
&nbsp;&nbsp;hmac.update(stringToSign);<br>
&nbsp;&nbsp;const expectedSignature = hmac.digest('hex');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;return {<br>
&nbsp;&nbsp;&nbsp;&nbsp;isValid: crypto.timingSafeEqual(<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Buffer.from(signature, 'hex'),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Buffer.from(expectedSignature, 'hex')<br>
&nbsp;&nbsp;&nbsp;&nbsp;),<br>
&nbsp;&nbsp;&nbsp;&nbsp;expectedSignature<br>
&nbsp;&nbsp;};<br>
}<br>
<br>
// API credentials<br>
const apiKey = 'user123';<br>
const secretKey = 'very-secret-api-key';<br>
<br>
// Create a request<br>
const timestamp = new Date().toISOString();<br>
const request = createApiRequest(<br>
&nbsp;&nbsp;apiKey,<br>
&nbsp;&nbsp;secretKey,<br>
&nbsp;&nbsp;'POST',<br>
&nbsp;&nbsp;'/api/v1/users',<br>
&nbsp;&nbsp;{ filter: 'active' },<br>
&nbsp;&nbsp;{ name: 'John Doe', email: 'john@example.com' },<br>
&nbsp;&nbsp;timestamp<br>
);<br>
<br>
console.log('API Request:');<br>
console.log(`URL: ${request.url}`);<br>
console.log(`Method: ${request.method}`);<br>
console.log('Headers:', request.headers);<br>
console.log('Body:', request.body);<br>
console.log('\nString that was signed:');<br>
console.log(request.stringToSign);<br>
<br>
// Server verifies the request<br>
const verification = verifyApiRequest(<br>
&nbsp;&nbsp;apiKey,<br>
&nbsp;&nbsp;secretKey,<br>
&nbsp;&nbsp;'POST',<br>
&nbsp;&nbsp;'/api/v1/users',<br>
...
&nbsp;&nbsp;{ name: 'John Doe', email: 'john@example.com' },<br>
&nbsp;&nbsp;timestamp,<br>
&nbsp;&nbsp;request.headers['X-Signature']<br>
);<br>
<br>
console.log('\nVerification result:');<br>
console.log(`Is signature valid? ${verification.isValid}`);<br>
<br>
// Try with tampered data<br>
const tamperedVerification = verifyApiRequest(<br>
&nbsp;&nbsp;apiKey,<br>
&nbsp;&nbsp;secretKey,<br>
&nbsp;&nbsp;'POST',<br>
&nbsp;&nbsp;'/api/v1/users',<br>
&nbsp;&nbsp;{ filter: 'active' },<br>
&nbsp;&nbsp;{ name: 'Jane Doe', email: 'jane@example.com' }, // Changed body<br>
&nbsp;&nbsp;timestamp,<br>
&nbsp;&nbsp;request.headers['X-Signature']<br>
);<br>
<br>
console.log('\nTampered verification result:');<br>
console.log(`Is signature valid? ${tamperedVerification.isValid}`);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_hmac_api_auth">Run example &raquo;</a>
</div>

<hr>

<h2>HMAC vs Plain Hash</h2>

<p>This example demonstrates the difference between a plain hash and an HMAC:</p>
...
<br>
// Data and keys<br>
const data = 'Message to authenticate';<br>
const key1 = 'secret-key-1';<br>
const key2 = 'secret-key-2';<br>
<br>
// Plain SHA-256 hash (no key)<br>
function createHash(data) {<br>
&nbsp;&nbsp;const hash = crypto.createHash('sha256');<br>
&nbsp;&nbsp;hash.update(data);<br>
&nbsp;&nbsp;return hash.digest('hex');<br>
}<br>
<br>
// HMAC-SHA-256 (with key)<br>
function createHmac(data, key) {<br>
...
// Compare results<br>
console.log(`Data: "${data}"`);<br>
console.log('\nPlain SHA-256 (no key):');<br>
console.log(createHash(data));<br>
<br>
console.log('\nHMAC-SHA-256 with key1:');<br>
console.log(createHmac(data, key1));<br>
<br>
console.log('\nHMAC-SHA-256 with key2:');<br>
console.log(createHmac(data, key2));<br>
<br>
// Demonstrate hash extension attack vulnerability<br>
// This is a simplified illustration - actual extension attacks are more complex<br>
console.log('\nHash Extension Attack Vulnerability:');<br>
<br>
const originalData = 'original-message';<br>
const originalHash = createHash(originalData);<br>
console.log(`Original data: "${originalData}"`);<br>
console.log(`Original SHA-256: ${originalHash}`);<br>
<br>
// Attacker doesn't know the original data, but knows its hash<br>
// and wants to append malicious data<br>
const appendedData = 'malicious-appendage';<br>
const combinedData = `${originalData}${appendedData}`;<br>
const combinedHash = createHash(combinedData);<br>
console.log(`Appended data: "${appendedData}"`);<br>
console.log(`Combined data: "${combinedData}"`);<br>
console.log(`Combined SHA-256: ${combinedHash}`);<br>
console.log('With plain hash, an attacker who knows the hash of original data can compute valid hash for combined data without knowing the original data');<br>
<br>
// HMAC is not vulnerable to extension attacks<br>
console.log('\nHMAC Protection:');<br>
const originalHmac = createHmac(originalData, key1);<br>
const combinedHmac = createHmac(combinedData, key1);<br>
console.log(`Original HMAC: ${originalHmac}`);<br>
console.log(`Combined HMAC: ${combinedHmac}`);<br>
console.log('With HMAC, an attacker cannot compute a valid HMAC for combined data without knowing the secret key');<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_hmac_vs_hash">Run example &raquo;</a>
</div>
...
<p>When using HMAC, consider these security best practices:</p>

<ol>
  <li><strong>Use strong hash algorithms</strong>: Prefer SHA-256, SHA-384, SHA-512, or SHA-3 over MD5 and SHA-1.</li>
  <li><strong>Use a strong, random key</strong>: The key should be at least as long as the hash output (e.g., 32 bytes for SHA-256).</li>
  <li><strong>Keep the key secret</strong>: The security of HMAC depends on the secrecy of the key.</li>
  <li><strong>Use constant-time comparison</strong>: When verifying HMAC values, use <code class="w3-codespan">crypto.timingSafeEqual()</code> to avoid timing attacks.</li>
  <li><strong>Use modern key management</strong>: Consider using the KeyObject API or a key management service for sensitive keys.</li>
  <li><strong>Consider HMAC's purpose</strong>: HMAC provides data integrity and authentication, not confidentiality. For encryption, combine HMAC with encryption algorithms.</li>
</ol>

<hr>

<h2>Common Use Cases for HMAC</h2>

<ul>
  <li><strong>API Authentication</strong>: Signing API requests to verify the sender's identity and data integrity.</li>
  <li><strong>Message Authentication</strong>: Ensuring messages haven't been tampered with during transmission.</li>
  <li><strong>Cookie/Token Verification</strong>: Creating and verifying signed cookies or tokens in web applications.</li>
  <li><strong>File Integrity Verification</strong>: Checking that files haven't been modified or corrupted.</li>
  <li><strong>Password Storage</strong>: Though specialized algorithms like bcrypt are preferred, HMAC can be used as part of a password hashing scheme.</li>
  <li><strong>Key Derivation</strong>: As a component in key derivation functions like HKDF.</li>
</ul>
