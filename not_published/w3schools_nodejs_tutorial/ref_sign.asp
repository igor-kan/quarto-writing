...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Sign Reference</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js Sign Reference">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/ref_sign.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="The Sign class is part of Node.js's crypto module. It provides a way to generate cryptographic digital signatures.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Sign Reference">
<meta name="twitter:description" content="The Sign class is part of Node.js's crypto module. It provides a way to generate cryptographic digital signatures.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/ref_sign.png">
...
<h1>Node.js Sign Reference</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="ref_hmac.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ref_verify.asp">Next &#10095;</a>
</div>
...
<p>The Sign class is part of Node.js's <code class="w3-codespan">crypto</code> module. It provides a way to generate cryptographic digital signatures. Sign instances are created using the <code class="w3-codespan">crypto.createSign()</code> method.</p>

<p>Digital signatures allow you to verify the authenticity and integrity of a message, ensuring that it was created by a known sender and was not altered in transit.</p>
...
<br>
// Create a Sign object<br>
const sign = crypto.createSign('RSA-SHA256');
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_sign_import">Run example &raquo;</a>
</div>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td>sign.update(data[, inputEncoding])</td>
    <td>Updates the Sign content with the given <code class="w3-codespan">data</code>. If <code class="w3-codespan">inputEncoding</code> is provided, <code class="w3-codespan">data</code> is a string using the specified encoding; otherwise, <code class="w3-codespan">data</code> is a Buffer, TypedArray, or DataView. This method can be called multiple times with new data.</td>
  </tr>
  <tr>
    <td>sign.sign(privateKey[, outputEncoding])</td>
    <td>Calculates the signature on all the data passed to the Sign using <code class="w3-codespan">sign.update()</code>. <code class="w3-codespan">privateKey</code> is a string or buffer containing the PEM-encoded private key, or a KeyObject of type 'private'. If <code class="w3-codespan">outputEncoding</code> is provided, a string is returned; otherwise, a Buffer is returned.</td>
  </tr>
</table>

<hr>

<h2>Basic Sign Example</h2>

<p>The following example demonstrates how to create a digital signature of a message:</p>
...
<br>
// Generate a keypair for this example<br>
...
<br>
// For this example, generate keys in memory<br>
// In a real application, you would load existing keys from storage<br>
const { privateKey, publicKey } = generateKeyPair();<br>
<br>
// Message to sign<br>
const message = 'This is a message to be signed';<br>
<br>
// Create a Sign object<br>
...
<br>
// Sign the message with the private key<br>
const signature = sign.sign(privateKey, 'hex');<br>
<br>
console.log('Message:', message);<br>
console.log('Signature:', signature);<br>
<br>
// We'll save these for the verification example<br>
fs.writeFileSync('message.txt', message);<br>
fs.writeFileSync('signature.hex', signature);<br>
fs.writeFileSync('public_key.pem', publicKey);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_sign_basic">Run example &raquo;</a>
</div>
...
<h2>Signing with Different Algorithms</h2>

<p>The Sign class supports various signature algorithms, depending on the crypto provider:</p>
...
<br>
// Message to sign<br>
const message = 'Message to sign with different algorithms';<br>
<br>
// Function to sign with a specific algorithm<br>
function signWithAlgorithm(algorithm, privateKey, message) {<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const sign = crypto.createSign(algorithm);<br>
&nbsp;&nbsp;&nbsp;&nbsp;sign.update(message);<br>
&nbsp;&nbsp;&nbsp;&nbsp;return sign.sign(privateKey, 'hex');<br>
&nbsp;&nbsp;} catch (error) {<br>
...
console.log('RSA-SHA256:', signWithAlgorithm('SHA256', rsaKeys.privateKey, message));<br>
console.log('RSA-SHA384:', signWithAlgorithm('SHA384', rsaKeys.privateKey, message));<br>
console.log('RSA-SHA512:', signWithAlgorithm('SHA512', rsaKeys.privateKey, message));<br>
<br>
console.log('-----------------------------------------------');<br>
<br>
// ECDSA signatures<br>
console.log('ECDSA-SHA256:', signWithAlgorithm('SHA256', ecKeys.privateKey, message));<br>
console.log('ECDSA-SHA384:', signWithAlgorithm('SHA384', ecKeys.privateKey, message));
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_sign_algorithms">Run example &raquo;</a>
</div>

<p>The available signature algorithms depend on your Node.js version and the installed OpenSSL version. Common signature algorithms include:</p>
...
<table class="ws-table-all">
  ...
  <tr>
    <td>RSA-SHA256</td>
    <td>RSA signature with SHA-256 hash</td>
    <td>RSA</td>
  </tr>
  <tr>
    <td>RSA-SHA384</td>
    <td>RSA signature with SHA-384 hash</td>
    <td>RSA</td>
  </tr>
  <tr>
    <td>RSA-SHA512</td>
    <td>RSA signature with SHA-512 hash</td>
    <td>RSA</td>
  </tr>
  <tr>
    <td>RSA-PSS-SHA256</td>
    <td>RSA-PSS signature with SHA-256 hash</td>
    <td>RSA</td>
  </tr>
  <tr>
    <td>ECDSA-SHA256</td>
    <td>ECDSA signature with SHA-256 hash</td>
    <td>EC</td>
  </tr>
  <tr>
    <td>ECDSA-SHA384</td>
    <td>ECDSA signature with SHA-384 hash</td>
    <td>EC</td>
  </tr>
  <tr>
    <td>Ed25519</td>
    <td>EdDSA signature using Curve25519</td>
    <td>Ed25519</td>
  </tr>
  <tr>
    <td>Ed448</td>
    <td>EdDSA signature using Curve448</td>
    <td>Ed448</td>
  </tr>
</table>
...
<h2>Signing with Multiple Updates</h2>

<p>You can update a Sign object with multiple pieces of data before calculating the signature:</p>
...
const sign = crypto.createSign('SHA256');<br>
<br>
// Update with multiple pieces of data<br>
...
const signature = sign.sign(privateKey, 'hex');<br>
<br>
console.log('Combined message: First part of the message. Second part of the message. Third part of the message.');<br>
console.log('Signature:', signature);<br>
<br>
// You can achieve the same result with a single update<br>
const singleSign = crypto.createSign('SHA256');<br>
singleSign.update('First part of the message. Second part of the message. Third part of the message.');<br>
const singleSignature = singleSign.sign(privateKey, 'hex');<br>
<br>
console.log('Single update signature matches multiple updates?', singleSignature === signature);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_sign_multiple">Run example &raquo;</a>
</div>
...
<p>You can create a digital signature for a file's contents:</p>
...
const fs = require('fs');<br>
<br>
// Function to sign a file<br>
function signFile(filePath, privateKey, algorithm = 'SHA256') {<br>
&nbsp;&nbsp;return new Promise((resolve, reject) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Create Sign object<br>
&nbsp;&nbsp;&nbsp;&nbsp;const sign = crypto.createSign(algorithm);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
...
<br>
// Save the public key for verification<br>
fs.writeFileSync('public_key_file.pem', publicKey);<br>
<br>
// Example usage (adjust file path as needed)<br>
const filePath = 'example_to_sign.txt';<br>
<br>
...
<br>
// Sign the file<br>
signFile(filePath, privateKey)<br>
&nbsp;&nbsp;.then(signature => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`File: ${filePath}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Signature: ${signature}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Save the signature for later verification<br>
&nbsp;&nbsp;&nbsp;&nbsp;fs.writeFileSync(`${filePath}.sig`, signature);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Signature saved to: ${filePath}.sig`);<br>
&nbsp;&nbsp;})<br>
&nbsp;&nbsp;.catch(error => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error('Error signing file:', error.message);<br>
&nbsp;&nbsp;});
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_sign_file">Run example &raquo;</a>
</div>

<hr>

<h2>Using Different Types of Keys</h2>

<p>The Sign class can work with different formats of private keys:</p>
...
<br>
// Message to sign<br>
const message = 'Message to sign with different key formats';<br>
<br>
// Function to sign with different key formats<br>
function signWithKey(privateKey, keyFormat) {<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const sign = crypto.createSign('SHA256');<br>
&nbsp;&nbsp;&nbsp;&nbsp;sign.update(message);<br>
&nbsp;&nbsp;&nbsp;&nbsp;return {<br>
...
<br>
// Generate a new RSA key pair<br>
const { privateKey: pemPrivateKey, publicKey } = crypto.generateKeyPairSync('rsa', {<br>
&nbsp;&nbsp;modulusLength: 2048,<br>
&nbsp;&nbsp;publicKeyEncoding: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;type: 'spki',<br>
&nbsp;&nbsp;&nbsp;&nbsp;format: 'pem'<br>
...
console.log(`Message: "${message}"`);<br>
<br>
// 1. Sign with PEM-encoded private key (string)<br>
console.log('\n1. PEM-encoded private key (string):');<br>
console.log(signWithKey(pemPrivateKey, 'PEM string'));<br>
<br>
// 2. Sign with PEM-encoded private key (buffer)<br>
console.log('\n2. PEM-encoded private key (buffer):');<br>
console.log(signWithKey(Buffer.from(pemPrivateKey), 'PEM buffer'));<br>
<br>
// 3. Sign with KeyObject<br>
console.log('\n3. KeyObject:');<br>
const keyObject = crypto.createPrivateKey(pemPrivateKey);<br>
console.log(signWithKey(keyObject, 'KeyObject'));<br>
<br>
// 4. Sign with PassThrough crypto engine (if available)<br>
try {<br>
&nbsp;&nbsp;// Note: This might not be available in all Node.js versions/configurations<br>
&nbsp;&nbsp;console.log('\n4. Private key with engine:');<br>
&nbsp;&nbsp;const engineKey = {<br>
&nbsp;&nbsp;&nbsp;&nbsp;key: pemPrivateKey,<br>
&nbsp;&nbsp;&nbsp;&nbsp;padding: crypto.constants.RSA_PKCS1_PADDING<br>
&nbsp;&nbsp;};<br>
&nbsp;&nbsp;console.log(signWithKey(engineKey, 'Key with options'));<br>
} catch (error) {<br>
&nbsp;&nbsp;console.log('\n4. Private key with engine:');<br>
&nbsp;&nbsp;console.log({ format: 'Key with options', error: error.message });<br>
}<br>
<br>
// 5. Sign with JSON Web Key (JWK)<br>
// Note: This requires conversion, as Node.js doesn't directly support JWK for sign<br>
console.log('\n5. JWK (requires conversion):');<br>
try {<br>
&nbsp;&nbsp;// This is a simplified example - actual JWK handling would be more complex<br>
&nbsp;&nbsp;const pemToJwk = require('pem-jwk').pem2jwk; // You would need to install this package<br>
&nbsp;&nbsp;const jwk = pemToJwk(pemPrivateKey);<br>
&nbsp;&nbsp;console.log({ format: 'JWK', note: 'JWK needs to be converted to PEM or KeyObject first' });<br>
} catch (error) {<br>
&nbsp;&nbsp;console.log({ format: 'JWK', note: 'Example requires pem-jwk package' });<br>
}
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_sign_key_types">Run example &raquo;</a>
</div>

<hr>

<h2>Complete Sign and Verify Example</h2>

<p>This example demonstrates the full process of creating and verifying a digital signature:</p>
...
<br>
// Original message<br>
const message = 'This is the original message to sign and verify';<br>
...
console.log(`Signature: ${signature}`);<br>
<br>
// Verify the message (using the Verify class)<br>
...
&nbsp;&nbsp;return verify.verify(publicKey, signature, 'hex');<br>
}<br>
<br>
// Verify the original message<br>
const isValidOriginal = verifySignature(message, signature, publicKey);<br>
console.log(`Original message verification: ${isValidOriginal}`);<br>
<br>
// Try to verify a tampered message<br>
const tamperedMessage = message + ' with some tampering';<br>
const isValidTampered = verifySignature(tamperedMessage, signature, publicKey);<br>
console.log(`Tampered message verification: ${isValidTampered}`);<br>
<br>
// Try to use a different public key<br>
const { publicKey: differentPublicKey } = crypto.generateKeyPairSync('rsa', {<br>
&nbsp;&nbsp;modulusLength: 2048,<br>
&nbsp;&nbsp;publicKeyEncoding: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;type: 'spki',<br>
&nbsp;&nbsp;&nbsp;&nbsp;format: 'pem'<br>
...
<br>
const isValidDifferentKey = verifySignature(message, signature, differentPublicKey);<br>
console.log(`Verification with different public key: ${isValidDifferentKey}`);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_sign_complete">Run example &raquo;</a>
</div>

<hr>

<h2>DSA and ECDSA Signatures</h2>

<p>This example demonstrates using DSA and ECDSA for digital signatures:</p>
...
<br>
// Message to sign<br>
const message = 'Message for DSA and ECDSA signatures';<br>
<br>
// Generate ECDSA key pair<br>
function generateECKeyPair(curveName = 'prime256v1') {<br>
&nbsp;&nbsp;return crypto.generateKeyPairSync('ec', {<br>
&nbsp;&nbsp;&nbsp;&nbsp;namedCurve: curveName,<br>
&nbsp;&nbsp;&nbsp;&nbsp;publicKeyEncoding: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;type: 'spki',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;format: 'pem'<br>
&nbsp;&nbsp;&nbsp;&nbsp;},<br>
&nbsp;&nbsp;&nbsp;&nbsp;privateKeyEncoding: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;type: 'sec1', // or 'pkcs8'<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;format: 'pem'<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;});<br>
}<br>
<br>
// Function to sign and verify with a specific algorithm and key pair<br>
function testSignatureAlgorithm(algorithm, keyType, keyPair, message) {<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Sign the message<br>
&nbsp;&nbsp;&nbsp;&nbsp;const sign = crypto.createSign(algorithm);<br>
&nbsp;&nbsp;&nbsp;&nbsp;sign.update(message);<br>
&nbsp;&nbsp;&nbsp;&nbsp;const signature = sign.sign(keyPair.privateKey, 'hex');<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Verify the signature<br>
&nbsp;&nbsp;&nbsp;&nbsp;const verify = crypto.createVerify(algorithm);<br>
&nbsp;&nbsp;&nbsp;&nbsp;verify.update(message);<br>
&nbsp;&nbsp;&nbsp;&nbsp;const isValid = verify.verify(keyPair.publicKey, signature, 'hex');<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;return {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;algorithm: `${keyType}-${algorithm}`,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;signatureLength: signature.length / 2, // Convert hex to bytes<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;isValid<br>
&nbsp;&nbsp;&nbsp;&nbsp;};<br>
&nbsp;&nbsp;} catch (error) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;return {<br>
...
<br>
// Test ECDSA with different curves<br>
const curves = ['prime256v1', 'secp384r1', 'secp521r1'];<br>
<br>
console.log(`Message: "${message}"`);<br>
console.log('\nECDSA Signatures:');<br>
<br>
curves.forEach(curve => {<br>
&nbsp;&nbsp;const ecKeyPair = generateECKeyPair(curve);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Test with different hash algorithms<br>
&nbsp;&nbsp;const hashAlgos = ['SHA256', 'SHA384', 'SHA512'];<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;hashAlgos.forEach(hashAlgo => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const result = testSignatureAlgorithm(hashAlgo, `ECDSA-${curve}`, ecKeyPair, message);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(result);<br>
&nbsp;&nbsp;});<br>
});<br>
<br>
// Test EdDSA if available<br>
try {<br>
&nbsp;&nbsp;console.log('\nEdDSA Signatures:');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Ed25519<br>
&nbsp;&nbsp;const ed25519KeyPair = crypto.generateKeyPairSync('ed25519', {<br>
&nbsp;&nbsp;&nbsp;&nbsp;publicKeyEncoding: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;type: 'spki',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;format: 'pem'<br>
&nbsp;&nbsp;&nbsp;&nbsp;},<br>
...
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Sign with Ed25519<br>
&nbsp;&nbsp;const sign = crypto.createSign('SHA512'); // Hash algorithm is ignored for Ed25519<br>
&nbsp;&nbsp;sign.update(message);<br>
&nbsp;&nbsp;const signature = sign.sign(ed25519KeyPair.privateKey, 'hex');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Verify with Ed25519<br>
&nbsp;&nbsp;const verify = crypto.createVerify('SHA512');<br>
&nbsp;&nbsp;verify.update(message);<br>
&nbsp;&nbsp;const isValid = verify.verify(ed25519KeyPair.publicKey, signature, 'hex');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;console.log({<br>
&nbsp;&nbsp;&nbsp;&nbsp;algorithm: 'Ed25519',<br>
&nbsp;&nbsp;&nbsp;&nbsp;signatureLength: signature.length / 2,<br>
&nbsp;&nbsp;&nbsp;&nbsp;isValid<br>
&nbsp;&nbsp;});<br>
} catch (error) {<br>
&nbsp;&nbsp;console.log({<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_sign_ecdsa">Run example &raquo;</a>
</div>

<hr>

<h2>Signing with OpenSSL Options</h2>

<p>Advanced signing with specific OpenSSL options:</p>
...
<br>
// Message to sign<br>
const message = 'Message to sign with different options';<br>
<br>
...
<br>
console.log(`Message: "${message}"`);<br>
console.log('\nRSA Signatures with Different Options:');<br>
<br>
// 1. Standard PKCS#1 v1.5 padding (default)<br>
...
// 2. PSS padding<br>
console.log('\n2. PSS padding:');<br>
const sig2 = signWithOptions('SHA256', message, privateKey, {<br>
&nbsp;&nbsp;padding: crypto.constants.RSA_PKCS1_PSS_PADDING,<br>
&nbsp;&nbsp;saltLength: 32<br>
});<br>
console.log(sig2);<br>
<br>
// 3. Different salt lengths with PSS padding<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;saltLength<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Salt length ${saltLength}: ${sigSalt.substring(0, 64)}...`);<br>
&nbsp;&nbsp;} catch (error) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Salt length ${saltLength}: Error - ${error.message}`);<br>
&nbsp;&nbsp;}<br>
});<br>
<br>
// 4. Try to use no padding (will likely fail for signatures)<br>
console.log('\n4. No padding (expect error):');<br>
const sig4 = signWithOptions('SHA256', message, privateKey, {<br>
&nbsp;&nbsp;padding: crypto.constants.RSA_NO_PADDING<br>
});<br>
console.log(sig4);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_sign_options">Run example &raquo;</a>
</div>
...
<p>When using digital signatures, consider these security best practices:</p>

<ol>
  <li><strong>Use strong keys</strong>: For RSA, use at least 2048 bits. For ECDSA, use curves like prime256v1 (P-256) or stronger.</li>
  <li><strong>Use modern signature algorithms</strong>: Prefer RSA-PSS over PKCS#1 v1.5, and consider ECDSA or EdDSA for better performance.</li>
  <li><strong>Protect private keys</strong>: Store private keys securely, possibly using a hardware security module (HSM) or key management service.</li>
  <li><strong>Use strong hash algorithms</strong>: Always use SHA-256 or stronger for the underlying hash function.</li>
  <li><strong>Validate data before signing</strong>: Ensure you're signing the intended data to avoid signing malicious content.</li>
  <li><strong>Consider key rotation</strong>: Regularly update your signing keys, especially for long-term applications.</li>
  <li><strong>Use KeyObject</strong>: When possible, use the KeyObject API for better security and to prevent sensitive key material from being directly accessible.</li>
</ol>

<hr>

<h2>Common Use Cases for Digital Signatures</h2>

<ul>
  <li><strong>Code Signing</strong>: Signing software packages, executables, or scripts to verify their authenticity and integrity.</li>
  <li><strong>Document Signing</strong>: Creating legally binding electronic signatures for PDFs and other documents.</li>
  <li><strong>JWT Signing</strong>: Signing JSON Web Tokens (JWTs) for secure authentication and authorization.</li>
  <li><strong>API Authentication</strong>: Verifying the identity of API clients and ensuring request integrity.</li>
  <li><strong>Certificate Signing</strong>: Creating and validating certificate chains in a PKI system.</li>
  <li><strong>Secure Communication</strong>: Authenticating messages in secure communication protocols.</li>
</ul>
