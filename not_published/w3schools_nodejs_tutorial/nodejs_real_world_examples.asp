...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Real-World Examples</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js Real-World Examples">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_real_world_examples.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="Practical, real-world Node.js examples - from REST APIs to file processing and real-time apps.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Real-World Examples">
<meta name="twitter:description" content="Practical, real-world Node.js examples - from REST APIs to file processing and real-time apps.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_real_world_examples.png">
...
<h1>Node.js <span class="color_h1">Real-World Examples</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_zlib.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="nodejs_raspberrypi.asp">Next &#10095;</a>
</div>
<hr>

<h2 id="rest-api">RESTful API with Express</h2>
<p>One of the most common Node.js applications is building RESTful APIs. Here's an example of a simple but practical Todo API with Express:</p>

<div class="w3-example">
<h3>Example: Todo API with Express</h3>
<div class="w3-code notranslate jsHigh">
const express = require('express');<br>
const app = express();<br>
<br>
// In-memory data store (in a real app, you would use a database)<br>
let todos = [<br>
&nbsp;&nbsp;{ id: 1, title: 'Learn Node.js', completed: false },<br>
&nbsp;&nbsp;{ id: 2, title: 'Build a REST API', completed: false }<br>
];<br>
<br>
// Middleware<br>
...
<br>
// GET all todos<br>
app.get('/todos', (req, res) => {<br>
&nbsp;&nbsp;res.json(todos);<br>
});<br>
<br>
// GET a single todo<br>
app.get('/todos/:id', (req, res) => {<br>
&nbsp;&nbsp;const todo = todos.find(t => t.id === parseInt(req.params.id));<br>
&nbsp;&nbsp;if (!todo) return res.status(404).json({ error: 'Todo not found' });<br>
&nbsp;&nbsp;res.json(todo);<br>
});<br>
<br>
// POST a new todo<br>
app.post('/todos', (req, res) => {<br>
&nbsp;&nbsp;if (!req.body.title) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;return res.status(400).json({ error: 'Title is required' });<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;const newTodo = {<br>
&nbsp;&nbsp;&nbsp;&nbsp;id: todos.length > 0 ? Math.max(...todos.map(t => t.id)) + 1 : 1,<br>
&nbsp;&nbsp;&nbsp;&nbsp;title: req.body.title,<br>
&nbsp;&nbsp;&nbsp;&nbsp;completed: req.body.completed || false<br>
&nbsp;&nbsp;};<br>
&nbsp;&nbsp;<br>
...
<br>
// PUT (update) a todo<br>
app.put('/todos/:id', (req, res) => {<br>
&nbsp;&nbsp;const todo = todos.find(t => t.id === parseInt(req.params.id));<br>
&nbsp;&nbsp;if (!todo) return res.status(404).json({ error: 'Todo not found' });<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;if (req.body.title) todo.title = req.body.title;<br>
&nbsp;&nbsp;if (req.body.completed !== undefined) todo.completed = req.body.completed;<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;res.json(todo);<br>
});<br>
<br>
// DELETE a todo<br>
app.delete('/todos/:id', (req, res) => {<br>
&nbsp;&nbsp;const index = todos.findIndex(t => t.id === parseInt(req.params.id));<br>
&nbsp;&nbsp;if (index === -1) return res.status(404).json({ error: 'Todo not found' });<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;const deletedTodo = todos[index];<br>
...
<p>This example demonstrates a complete CRUD (Create, Read, Update, Delete) API with proper error handling and status codes.</p>
<hr>
...
<h2 id="auth-system">Authentication System</h2>
<p>Most applications need authentication. Here's an example of JWT-based authentication in Node.js:</p>

<div class="w3-example">
<h3>Example: JWT Authentication with Express</h3>
<div class="w3-code notranslate jsHigh">
const express = require('express');<br>
...
app.use(express.json());<br>
<br>
// In a real app, use a database<br>
const users = [];<br>
<br>
// Secret key for JWT<br>
const JWT_SECRET = process.env.JWT_SECRET || 'your-secret-key';<br>
<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return res.status(400).json({ error: 'Username already exists' });<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
...
&nbsp;&nbsp;} catch (error) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.status(500).json({ error: 'Registration failed' });<br>
&nbsp;&nbsp;}<br>
});<br>
<br>
// Login<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;if (!user) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return res.status(401).json({ error: 'Invalid credentials' });<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Check password<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{ userId: user.id, username: user.username },<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;JWT_SECRET,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{ expiresIn: '1h' }<br>
&nbsp;&nbsp;&nbsp;&nbsp;);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.json({ token });<br>
&nbsp;&nbsp;} catch (error) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.status(500).json({ error: 'Authentication failed' });<br>
&nbsp;&nbsp;}<br>
});<br>
<br>
// Middleware to verify JWT token<br>
...
&nbsp;&nbsp;<br>
&nbsp;&nbsp;if (!token) return res.status(401).json({ error: 'Authentication required' });<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;jwt.verify(token, JWT_SECRET, (err, user) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (err) return res.status(403).json({ error: 'Invalid or expired token' });<br>
&nbsp;&nbsp;&nbsp;&nbsp;req.user = user;<br>
&nbsp;&nbsp;&nbsp;&nbsp;next();<br>
&nbsp;&nbsp;});<br>
}<br>
<br>
// Protected route example<br>
app.get('/profile', authenticateToken, (req, res) => {<br>
&nbsp;&nbsp;res.json({ user: req.user });<br>
});<br>
<br>
app.listen(8080, () => {<br>
&nbsp;&nbsp;console.log('Authentication server running on port 8080');<br>
});
</div>
</div>
<hr>

<h2 id="file-upload">File Upload Service</h2>
<p>Node.js makes it easy to handle file uploads, which is common in many web applications:</p>

<div class="w3-example">
<h3>Example: File Upload with Express and Multer</h3>
<div class="w3-code notranslate jsHigh">
const express = require('express');<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;// Generate unique filename with original extension<br>
&nbsp;&nbsp;&nbsp;&nbsp;const uniqueSuffix = Date.now() + '-' + Math.round(Math.random() * 1E9);<br>
&nbsp;&nbsp;&nbsp;&nbsp;const ext = path.extname(file.originalname);<br>
&nbsp;&nbsp;&nbsp;&nbsp;cb(null, file.fieldname + '-' + uniqueSuffix + ext);<br>
&nbsp;&nbsp;}<br>
});<br>
<br>
// File filter function<br>
const fileFilter = (req, file, cb) => {<br>
&nbsp;&nbsp;// Accept images and PDFs only<br>
&nbsp;&nbsp;if (file.mimetype.startsWith('image/') || file.mimetype === 'application/pdf') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;cb(null, true);<br>
&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;cb(new Error('Unsupported file type'), false);<br>
&nbsp;&nbsp;}<br>
};<br>
<br>
...
&nbsp;&nbsp;limits: { fileSize: 5 * 1024 * 1024 } // 5MB limit<br>
});<br>
<br>
// Serve upload form<br>
app.get('/', (req, res) => {<br>
&nbsp;&nbsp;res.sendFile(path.join(__dirname, 'public', 'index.html'));<br>
});<br>
<br>
// Single file upload endpoint<br>
app.post('/upload/single', upload.single('file'), (req, res) => {<br>
&nbsp;&nbsp;if (!req.file) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;return res.status(400).json({ error: 'No file uploaded' });<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;res.json({<br>
&nbsp;&nbsp;&nbsp;&nbsp;message: 'File uploaded successfully',<br>
&nbsp;&nbsp;&nbsp;&nbsp;file: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;filename: req.file.filename,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;originalname: req.file.originalname,<br>
...
<br>
// Multiple file upload endpoint (max 5)<br>
app.post('/upload/multiple', upload.array('files', 5), (req, res) => {<br>
&nbsp;&nbsp;if (!req.files || req.files.length === 0) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;return res.status(400).json({ error: 'No files uploaded' });<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;res.json({<br>
&nbsp;&nbsp;&nbsp;&nbsp;message: `${req.files.length} files uploaded successfully`,<br>
&nbsp;&nbsp;&nbsp;&nbsp;files: req.files.map(file => ({<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;filename: file.filename,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;originalname: file.originalname,<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;// Multer-specific errors<br>
&nbsp;&nbsp;&nbsp;&nbsp;return res.status(400).json({ error: err.message });<br>
&nbsp;&nbsp;} else if (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Other errors<br>
...
<br>
app.listen(8080, () => {<br>
&nbsp;&nbsp;console.log('File upload server running on port 8080');<br>
});
</div>
</div>
<hr>

<h2 id="microservice">Microservice Architecture</h2>
<p>Node.js is ideal for building microservices. Here's a simple example of a microservice with health checks and proper separation of concerns:</p>

<div class="w3-example">
<h3>Example: Product Catalog Microservice</h3>
<div class="w3-code notranslate jsHigh">
// src/index.js<br>
const express = require('express');<br>
const routes = require('./routes');<br>
const errorHandler = require('./middleware/errorHandler');<br>
const logger = require('./middleware/logger');<br>
...
&nbsp;&nbsp;res.status(200).json({ status: 'ok', service: 'product-catalog', timestamp: new Date() });<br>
});<br>
<br>
// Routes<br>
app.use('/api/products', routes.productRoutes);<br>
<br>
// Error handling<br>
app.use(errorHandler);<br>
<br>
// Start server<br>
app.listen(config.PORT, () => {<br>
&nbsp;&nbsp;console.log(`Product catalog service running on port ${config.PORT}`);<br>
});<br>
<br>
// Handle graceful shutdown<br>
process.on('SIGTERM', () => {<br>
&nbsp;&nbsp;console.log('SIGTERM received, shutting down gracefully');<br>
...
<div class="w3-code notranslate jsHigh">
// src/routes/productRoutes.js<br>
const express = require('express');<br>
const productController = require('../controllers/productController');<br>
<br>
const router = express.Router();<br>
<br>
router.get('/', productController.getAllProducts);<br>
router.get('/:id', productController.getProductById);<br>
router.post('/', productController.createProduct);<br>
router.put('/:id', productController.updateProduct);<br>
router.delete('/:id', productController.deleteProduct);<br>
<br>
...
<div class="w3-panel ws-info">
  <p><strong>Best Practice:</strong> In a real microservice architecture, each service would have its own repository, deployment pipeline, and database.</p>
</div>
<hr>

<h2 id="task-scheduler">Task Scheduler</h2>
<p>Node.js can efficiently handle scheduled tasks and background jobs:</p>

<div class="w3-example">
<h3>Example: Cron-like Task Scheduler</h3>
<div class="w3-code notranslate jsHigh">
const cron = require('node-cron');<br>
const nodemailer = require('nodemailer');<br>
const express = require('express');<br>
<br>
const app = express();<br>
<br>
// Configure mail transporter (this is just an example)<br>
...
<br>
// Schedule a task to run every day at 9:00 AM<br>
cron.schedule('0 9 * * *', async () => {<br>
&nbsp;&nbsp;console.log('Running daily report task');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Generate report data (in a real app, fetch from database)<br>
&nbsp;&nbsp;&nbsp;&nbsp;const reportData = {<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;};<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Send email with report<br>
&nbsp;&nbsp;&nbsp;&nbsp;await transporter.sendMail({<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;from: 'system@example.com',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;to: 'admin@example.com',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;subject: `Daily Report - ${reportData.date}`,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;html: `<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;h1&gt;Daily Report&lt;/h1&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;p&gt;&lt;strong&gt;Date:&lt;/strong&gt; ${reportData.date}&lt;/p&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;h2&gt;Key Metrics&lt;/h2&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;ul&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;li&gt;Users: ${reportData.metrics.users}&lt;/li&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;li&gt;Orders: ${reportData.metrics.orders}&lt;/li&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;li&gt;Revenue: $${reportData.metrics.revenue}&lt;/li&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/ul&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Daily report email sent successfully');<br>
&nbsp;&nbsp;} catch (error) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error('Error sending daily report:', error);<br>
&nbsp;&nbsp;}<br>
});<br>
<br>
// Schedule database backup every Sunday at midnight<br>
cron.schedule('0 0 * * 0', () => {<br>
&nbsp;&nbsp;console.log('Running weekly database backup');<br>
&nbsp;&nbsp;// In a real app, you would run a database backup command here<br>
});<br>
<br>
// Clean up temporary files every hour<br>
cron.schedule('0 * * * *', () => {<br>
&nbsp;&nbsp;console.log('Cleaning up temporary files');<br>
&nbsp;&nbsp;// In a real app, you would delete old temporary files here<br>
});<br>
<br>
// API to add a one-time job<br>
const scheduledJobs = new Map();<br>
app.use(express.json());<br>
<br>
app.post('/schedule-job', (req, res) => {<br>
&nbsp;&nbsp;const { id, scheduledTime, task } = req.body;<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;if (!id || !scheduledTime || !task) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;return res.status(400).json({ error: 'Missing required parameters' });<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;const jobTime = new Date(scheduledTime).getTime();<br>
&nbsp;&nbsp;const currentTime = Date.now();<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;if (jobTime &lt;= currentTime) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;return res.status(400).json({ error: 'Scheduled time must be in the future' });<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Schedule the job<br>
&nbsp;&nbsp;const timeout = setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Executing job: ${id}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;// In a real app, use a job queue like Bull to handle the tasks<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Task: ${task}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;scheduledJobs.delete(id);<br>
&nbsp;&nbsp;}, jobTime - currentTime);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;scheduledJobs.set(id, { timeout, scheduledTime, task });<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;res.status(201).json({ <br>
&nbsp;&nbsp;&nbsp;&nbsp;message: 'Job scheduled successfully',<br>
&nbsp;&nbsp;&nbsp;&nbsp;job: { id, scheduledTime, task }<br>
&nbsp;&nbsp;});<br>
});<br>
<br>
// Start server<br>
app.listen(8080, () => {<br>
&nbsp;&nbsp;console.log('Task scheduler running on port 8080');<br>
});
</div>
</div>
<hr>

<h2 id="real-time-analytics">Real-time Analytics Dashboard</h2>

<p>Track and visualize application metrics in real-time with WebSockets and Chart.js:</p>

<div class="w3-example">
<h3>Example: Real-time Analytics Server</h3>
<div class="w3-code notranslate jsHigh">
const express = require('express');<br>
...
&nbsp;&nbsp;cors: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;origin: '*', // In production, replace with your frontend domain<br>
&nbsp;&nbsp;&nbsp;&nbsp;methods: ['GET', 'POST']<br>
&nbsp;&nbsp;}<br>
});<br>
<br>
// In-memory store for analytics data (use a database in production)<br>
const analyticsData = {<br>
&nbsp;&nbsp;pageViews: {},<br>
&nbsp;&nbsp;activeUsers: new Set(),<br>
&nbsp;&nbsp;events: []<br>
};<br>
<br>
// Track page views<br>
app.use((req, res, next) => {<br>
&nbsp;&nbsp;const page = req.path;<br>
&nbsp;&nbsp;analyticsData.pageViews[page] = (analyticsData.pageViews[page] || 0) + 1;<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Emit update to all connected clients<br>
&nbsp;&nbsp;io.emit('analytics:update', {<br>
&nbsp;&nbsp;&nbsp;&nbsp;type: 'pageView',<br>
&nbsp;&nbsp;&nbsp;&nbsp;data: { page, count: analyticsData.pageViews[page] }<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;next();<br>
});<br>
...
app.post('/track', express.json(), (req, res) => {<br>
&nbsp;&nbsp;const { event, data } = req.body;<br>
&nbsp;&nbsp;const eventId = uuidv4();<br>
&nbsp;&nbsp;const timestamp = new Date().toISOString();<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;const eventData = { id: eventId, event, data, timestamp };<br>
&nbsp;&nbsp;analyticsData.events.push(eventData);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Keep only the last 1000 events<br>
&nbsp;&nbsp;if (analyticsData.events.length > 1000) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;analyticsData.events.shift();<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Emit event to all connected clients<br>
&nbsp;&nbsp;io.emit('analytics:event', eventData);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;res.status(201).json({ success: true, eventId });<br>
});<br>
<br>
// WebSocket connection handling<br>
io.on('connection', (socket) => {<br>
&nbsp;&nbsp;const userId = socket.handshake.query.userId || 'anonymous';<br>
&nbsp;&nbsp;analyticsData.activeUsers.add(userId);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Send initial data to the newly connected client<br>
&nbsp;&nbsp;socket.emit('analytics:init', {<br>
&nbsp;&nbsp;&nbsp;&nbsp;pageViews: analyticsData.pageViews,<br>
&nbsp;&nbsp;&nbsp;&nbsp;activeUsers: analyticsData.activeUsers.size,<br>
&nbsp;&nbsp;&nbsp;&nbsp;recentEvents: analyticsData.events.slice(-50)<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Update all clients about the new active user count<br>
&nbsp;&nbsp;io.emit('analytics:update', {<br>
&nbsp;&nbsp;&nbsp;&nbsp;type: 'activeUsers',<br>
&nbsp;&nbsp;&nbsp;&nbsp;data: analyticsData.activeUsers.size<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Handle disconnection<br>
&nbsp;&nbsp;socket.on('disconnect', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;analyticsData.activeUsers.delete(userId);<br>
&nbsp;&nbsp;&nbsp;&nbsp;io.emit('analytics:update', {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;type: 'activeUsers',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;data: analyticsData.activeUsers.size<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Handle custom events from the client<br>
&nbsp;&nbsp;socket.on('analytics:event', (data) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const eventId = uuidv4();<br>
&nbsp;&nbsp;&nbsp;&nbsp;const timestamp = new Date().toISOString();<br>
&nbsp;&nbsp;&nbsp;&nbsp;const eventData = { id: eventId, ...data, timestamp, userId };<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;analyticsData.events.push(eventData);<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (analyticsData.events.length > 1000) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;analyticsData.events.shift();<br>
...
<br>
// API to get analytics data<br>
app.get('/api/analytics', (req, res) => {<br>
&nbsp;&nbsp;res.json({<br>
&nbsp;&nbsp;&nbsp;&nbsp;pageViews: analyticsData.pageViews,<br>
&nbsp;&nbsp;&nbsp;&nbsp;activeUsers: analyticsData.activeUsers.size,<br>
&nbsp;&nbsp;&nbsp;&nbsp;totalEvents: analyticsData.events.length,<br>
&nbsp;&nbsp;&nbsp;&nbsp;recentEvents: analyticsData.events.slice(-50)<br>
&nbsp;&nbsp;});<br>
});<br>
<br>
// Serve the dashboard<br>
app.use(express.static('public'));<br>
<br>
const PORT = process.env.PORT || 3000;<br>
server.listen(PORT, () => {<br>
&nbsp;&nbsp;console.log(`Analytics server running on port ${PORT}`);<br>
&nbsp;&nbsp;console.log(`Dashboard available at http://localhost:${PORT}/dashboard.html`);<br>
});
</div>
</div>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> For production use, consider persisting analytics data to a database and implementing proper authentication.</p>
</div>

<hr>

<h2 id="best-practices">Best Practices for Real-World Node.js Applications</h2>
<p>When building production Node.js applications, follow these best practices:</p>

<div class="w3-row-padding">
  <div class="w3-half">
    <h3>Application Structure</h3>
    <ul>
      <li>Use a clear project structure (MVC or similar)</li>
      <li>Separate business logic from routes</li>
      <li>Keep configuration in environment variables</li>
      <li>Use dependency injection where appropriate</li>
    </ul>
    
    <h3>Error Handling</h3>
    <ul>
      <li>Implement global error handling middleware</li>
      <li>Log errors with proper context</li>
      <li>Return appropriate HTTP status codes</li>
      <li>Handle uncaught exceptions and unhandled promises</li>
    </ul>
  </div>
  ...
  <div class="w3-half">
    ...
    <ul>
      ...
      <li>Implement rate limiting for APIs</li>
    ...
    <ul>
      <li>Use compression for HTTP responses</li>
      <li>Implement proper caching strategies</li>
      <li>Consider using a cluster or PM2 for multi-core utilization</li>
...
<div class="w3-panel ws-info">
  <p><strong>Pro Tip:</strong> For production applications, always include comprehensive monitoring, logging, and alerting to quickly identify and resolve issues.</p>
</div>
<hr>

<div id="exercisecontainer" src="xrcise_real_world_examples.js" data-extensions="asp"></div>
<hr>
