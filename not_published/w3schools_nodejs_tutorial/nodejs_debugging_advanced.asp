...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Advanced Debugging</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js Advanced Debugging">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_debugging_advanced.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="Effective debugging is a critical skill for Node.js developers.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Advanced Debugging">
<meta name="twitter:description" content="Effective debugging is a critical skill for Node.js developers.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_debugging_advanced.png">
...
<h1>Node.js <span class="color_h1">Advanced Debugging</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_websockets.asp">&lt; Previous</a>
<a class="w3-right w3-btn" href="nodejs_testing.asp">Next &gt;</a>
</div>
<hr>

<h2 id="intro">Introduction to Advanced Debugging</h2>
<p>Effective debugging is a critical skill for Node.js developers.</p>
<p>While <code class="w3-codespan">console.log()</code> is useful for basic debugging, advanced techniques allow you to diagnose complex issues like memory leaks, performance bottlenecks, and race conditions.</p>

<p>This tutorial covers advanced debugging techniques and tools to help you solve challenging problems in your Node.js applications.</p>

<p>Advanced debugging tools provide capabilities like:</p>
<ul>
  <li>Setting breakpoints and stepping through code execution</li>
  <li>Inspecting variable values at runtime</li>
  <li>Visualizing memory consumption and finding leaks</li>
  <li>Profiling CPU usage to identify performance bottlenecks</li>
  <li>Analyzing asynchronous call stacks</li>
</ul>
<hr>

<h2 id="devtools">Debugging with Chrome DevTools</h2>
<p>Node.js includes built-in support for the Chrome DevTools debugging protocol, allowing you to use the powerful Chrome DevTools interface to debug your Node.js applications.</p>

<h3>Starting Node.js in Debug Mode</h3>
<p>There are several ways to start your application in debug mode:</p>

<div class="w3-example">
<h3>Standard Debug Mode</h3>
<div class="w3-code notranslate">
node --inspect app.js
</div>
<p>This starts your app normally but enables the inspector on port 9229.</p>

<h3>Break on Start</h3>
<div class="w3-code notranslate">
node --inspect-brk app.js
</div>
<p>This pauses execution at the first line of code, allowing you to set up breakpoints before execution begins.</p>

<h3>Custom Port</h3>
<div class="w3-code notranslate">
node --inspect=127.0.0.1:9222 app.js
</div>
<p>This uses a custom port for the inspector.</p>
</div>

<h3>Connecting to the Debugger</h3>
<p>After starting your Node.js application with the inspect flag, you can connect to it in several ways:</p>

<ol>
  <li><strong>Chrome DevTools:</strong> Open Chrome and navigate to <code class="w3-codespan">chrome://inspect</code>.<br>
    You should see your Node.js application listed under "Remote Target."<br>
    Click "inspect" to open DevTools connected to your application:<br>
    <source srcset="img_chrome_debugger.png" type="image/png" style="max-width:100%;">
      <img src="img_chrome_debugger.png" alt="Chrome DevTools for Node.js" style="width:100%;max-width:500px">
    </picture> </li>
      
  <li><strong>DevTools URL:</strong> Open the URL shown in the terminal<br>
    (usually something like <code class="w3-codespan">devtools://devtools/bundled/js_app.html?experiments=true&v8only=true&ws=127.0.0.1:9229/...</code>).</li>
</ol>



<h3>Using DevTools for Debugging</h3>
<p>Once connected, you can use the full power of Chrome DevTools:</p>

<ul>
  <li><strong>Sources Panel:</strong> Set breakpoints, step through code, and watch variables</li>
  <li><strong>Call Stack:</strong> View the current execution stack, including async call chains</li>
  <li><strong>Scope Variables:</strong> Inspect local and global variables at each breakpoint</li>
  <li><strong>Console:</strong> Evaluate expressions in the current context</li>
  <li><strong>Memory Panel:</strong> Take heap snapshots and analyze memory usage</li>
</ul>

<div class="w3-panel ws-note">
<p><strong>Pro Tip:</strong> Use the Sources panel's "Pause on caught exceptions" feature (the pause button with curved lines) to automatically break when an error occurs.</p>
</div>
...
<h2 id="vscode">Debugging in VS Code</h2>
<p>Visual Studio Code provides excellent built-in debugging capabilities for Node.js applications.</p>

<h3>Setting Up Node.js Debugging in VS Code</h3>
<p>You can start debugging your Node.js application in VS Code in several ways:</p>

<ol>
  <li><strong>launch.json Configuration:</strong> Create a <code class="w3-codespan">.vscode/launch.json</code> file to define how VS Code should launch or attach to your application.</li>
  <li><strong>Auto-Attach:</strong> Enable auto-attach in VS Code settings to automatically debug any Node.js process started with the <code class="w3-codespan">--inspect</code> flag.</li>
  <li><strong>JavaScript Debug Terminal:</strong> Use the JavaScript Debug Terminal in VS Code to automatically debug any Node.js process started from that terminal.</li>
</ol>

<div class="w3-example">
<h3>Example launch.json Configuration</h3>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"skipFiles": ["&lt;node_internals&gt;/**"]<br>
&nbsp;&nbsp;&nbsp;&nbsp;},<br>
&nbsp;&nbsp;&nbsp;&nbsp;{<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"type": "node",<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"request": "attach",<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"name": "Attach to Process",<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"port": 9229<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;]<br>
}
...
<h3>VS Code Debugging Features</h3>
<p>VS Code provides powerful debugging capabilities:</p>

<ul>
  <li><strong>Breakpoints:</strong> Set, disable, and enable breakpoints by clicking in the gutter of your code editor.</li>
  <li><strong>Conditional Breakpoints:</strong> Right-click on a breakpoint to set a condition that must be true for the breakpoint to trigger.</li>
  <li><strong>Logpoints:</strong> Add logging without modifying code by setting logpoints that print messages to the console when hit.</li>
  <li><strong>Watch Expressions:</strong> Monitor the value of variables and expressions as you step through code.</li>
  <li><strong>Call Stack:</strong> View and navigate the call stack, including asynchronous frames.</li>
</ul>

<div class="w3-panel ws-info">
<p><strong>Note:</strong> VS Code can also debug TypeScript files directly, with source maps enabling debugging of the original TypeScript code rather than the transpiled JavaScript.</p>
</div>
<hr>

<h2 id="debug-module">Using the Debug Module</h2>
<p>The <code class="w3-codespan">debug</code> module is a lightweight debugging utility that allows you to add conditional logging to your Node.js applications without cluttering your code with <code class="w3-codespan">console.log</code> statements.</p>

<h3>Installing the Debug Module</h3>
<div class="w3-code notranslate">
npm install debug
</div>

<h3>Basic Usage of Debug</h3>
<p>The debug module lets you create namespaced debug functions that can be enabled or disabled via environment variables:</p>

<div class="w3-example">
<h3>Example: Using the Debug Module</h3>
<div class="w3-code notranslate jsHigh">
// Create namespaced debuggers for different parts of your application<br>
const debug = require('debug');<br>
<br>
const debugServer = debug('app:server');<br>
const debugDatabase = debug('app:database');<br>
const debugAuth = debug('app:auth');<br>
<br>
// Use the debuggers in your code<br>
debugServer('Server starting on port %d', 8080);<br>
debugDatabase('Connected to database: %s', 'mongodb://localhost');<br>
debugAuth('User %s authenticated', 'john@example.com');<br>
<br>
...
<p>To see the debug output, set the <code class="w3-codespan">DEBUG</code> environment variable to a comma-separated list of namespace patterns:</p>

<div class="w3-example">
<h3>Enable All Debug Output</h3>
<div class="w3-code notranslate">
DEBUG=app:* node app.js
</div>

<h3>Enable Specific Namespaces</h3>
<div class="w3-code notranslate">
DEBUG=app:server,app:auth node app.js
</div>

<h3>Enable All but Exclude Some</h3>
<div class="w3-code notranslate">
DEBUG=app:*,-app:database node app.js
</div>
</div>

<h3>Debug Output Features</h3>
<ul>
  <li>Each namespace has a unique color for easy visual identification</li>
  <li>Timestamps show when each message was logged</li>
  <li>Supports formatted output similar to <code class="w3-codespan">console.log</code></li>
  <li>Shows the difference in milliseconds from the previous log of the same namespace</li>
</ul>

<div class="w3-panel ws-note">
<p><strong>Best Practice:</strong> Use specific namespaces for different components of your application to make it easier to filter debug output based on what you're currently troubleshooting.</p>
</div>
<hr>

<h2 id="memory-leaks">Finding and Fixing Memory Leaks</h2>
<p>Memory leaks in Node.js applications can cause performance degradation and eventual crashes.</p>
<p>Detecting and fixing memory leaks is a crucial debugging skill.</p>

<h3>Common Causes of Memory Leaks in Node.js</h3>
<ul>
  <li><strong>Global Variables:</strong> Objects stored in global scope that are never cleaned up</li>
  <li><strong>Closures:</strong> Functions that maintain references to large objects or variables</li>
  <li><strong>Event Listeners:</strong> Listeners that are added but never removed</li>
  <li><strong>Caches:</strong> In-memory caches that grow without bounds</li>
  <li><strong>Timers:</strong> Timers (setTimeout/setInterval) that aren't cleared</li>
  <li><strong>Promises:</strong> Unhandled promises or promise chains that never resolve</li>
</ul>

<h3>Detecting Memory Leaks</h3>
<p>Several approaches can help you detect memory leaks:</p>

<h4>1. Monitor Memory Usage</h4>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// Monitor memory usage<br>
function logMemoryUsage() {<br>
&nbsp;&nbsp;const memoryUsage = process.memoryUsage();<br>
&nbsp;&nbsp;console.log('Memory usage:');<br>
&nbsp;&nbsp;console.log(`RSS: ${Math.round(memoryUsage.rss / 1024 / 1024)} MB`);<br>
&nbsp;&nbsp;console.log(`Heap Total: ${Math.round(memoryUsage.heapTotal / 1024 / 1024)} MB`);<br>
&nbsp;&nbsp;console.log(`Heap Used: ${Math.round(memoryUsage.heapUsed / 1024 / 1024)} MB`);<br>
}<br>
<br>
// Log memory usage every 30 seconds<br>
setInterval(logMemoryUsage, 30000);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_debugging_adv_memory">Run example &raquo;</a>
</div>

<h4>2. Take Heap Snapshots with Chrome DevTools</h4>
<p>Heap snapshots provide a detailed view of memory allocation:</p>
<ol>
  <li>Start your app with <code class="w3-codespan">node --inspect app.js</code></li>
  <li>Connect with Chrome DevTools</li>
  <li>Go to the Memory tab</li>
  <li>Take heap snapshots at different points</li>
  <li>Compare snapshots to find objects that are growing in number or size</li>
</ol>

<h4>3. Use Memory Profiling Tools</h4>
<ul>
  <li><code class="w3-codespan">clinic doctor</code>: Identify memory issues in your application</li>
  <li><code class="w3-codespan">clinic heap</code>: Visualize heap memory usage</li>
  <li><code class="w3-codespan">memwatch-next</code>: Library to detect memory leaks</li>
</ul>

<h3>Example: Memory Leak in a Node.js Server</h3>
<p>Here's an example showing a common memory leak pattern in a Node.js server:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const http = require('http');<br>
<br>
// This object will store data for each request (memory leak!)<br>
const requestData = {};<br>
<br>
const server = http.createServer((req, res) => {<br>
&nbsp;&nbsp;// Generate a unique request ID<br>
&nbsp;&nbsp;const requestId = Date.now() + Math.random().toString(36).substring(2, 15);<br>
<br>
&nbsp;&nbsp;// Store data in the global object (THIS IS THE MEMORY LEAK)<br>
&nbsp;&nbsp;requestData[requestId] = {<br>
&nbsp;&nbsp;&nbsp;&nbsp;url: req.url,<br>
&nbsp;&nbsp;&nbsp;&nbsp;method: req.method,<br>
&nbsp;&nbsp;&nbsp;&nbsp;headers: req.headers,<br>
&nbsp;&nbsp;&nbsp;&nbsp;timestamp: Date.now(),<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Create a large object to make the leak more obvious<br>
&nbsp;&nbsp;&nbsp;&nbsp;payload: Buffer.alloc(1024 * 1024) // Allocate 1MB per request<br>
&nbsp;&nbsp;};<br>
<br>
&nbsp;&nbsp;// Log memory usage after each request<br>
&nbsp;&nbsp;const memoryUsage = process.memoryUsage();<br>
&nbsp;&nbsp;console.log(`Memory usage after request ${requestId}:`);<br>
&nbsp;&nbsp;console.log(`- Heap Used: ${Math.round(memoryUsage.heapUsed / 1024 / 1024)} MB`);<br>
&nbsp;&nbsp;console.log(`- Request count: ${Object.keys(requestData).length}`);<br>
<br>
&nbsp;&nbsp;res.end('Request processed');<br>
});<br>
<br>
server.listen(8080);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_debugging_adv_mem_leak">Run example &raquo;</a>
</div>

<h3>Fixing the Memory Leak</h3>
<p>Here's how to fix the memory leak in the example above:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const http = require('http');<br>
<br>
// This object will store data for each request<br>
const requestData = {};<br>
<br>
const server = http.createServer((req, res) => {<br>
&nbsp;&nbsp;const requestId = Date.now() + Math.random().toString(36).substring(2, 15);<br>
<br>
<br>
&nbsp;&nbsp;// Store data in the global object<br>
&nbsp;&nbsp;requestData[requestId] = {<br>
&nbsp;&nbsp;&nbsp;&nbsp;url: req.url,<br>
&nbsp;&nbsp;&nbsp;&nbsp;method: req.method,<br>
&nbsp;&nbsp;&nbsp;&nbsp;timestamp: Date.now()<br>
&nbsp;&nbsp;};<br>
<br>
&nbsp;&nbsp;// Clean up after the response is sent (FIX FOR THE MEMORY LEAK)<br>
&nbsp;&nbsp;res.on('finish', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;delete requestData[requestId];<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Cleaned up request ${requestId}`);<br>
&nbsp;&nbsp;});<br>
<br>
&nbsp;&nbsp;res.end('Request processed');<br>
});<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_debugging_adv_mem_leak_fix">Run example &raquo;</a>
</div>

<div class="w3-panel ws-warning">
<p><strong>Important:</strong> Always implement proper cleanup routines for resources like event listeners, timers, and cached objects.</p>
<p>Consider using weak references or implementing time-based expiration for cached items.</p>
</div>
<hr>

<h2 id="cpu-profiling">CPU Profiling and Performance</h2>
<p>CPU profiling helps identify performance bottlenecks in your Node.js application by showing which functions consume the most CPU time.</p>

<h3>CPU Profiling Methods</h3>

<h4>1. Built-in Node.js Profiler</h4>
<p>Node.js includes a built-in V8 profiler that you can use to generate CPU profiles:</p>

<div class="w3-example">
<h3>Using the Built-in V8 Profiler</h3>
<div class="w3-code notranslate">
# Generate CPU profile<br>
node --prof app.js<br>
<br>
# Convert the generated log file to a readable format<br>
node --prof-process isolate-0xnnnnnnnnnnnn-v8.log > processed.txt
</div>
</div>

<p>The processed output shows where time is spent in your application, sorted by the percentage of total program execution time.</p>

<h4>2. Chrome DevTools CPU Profiler</h4>
<ol>
  <li>Start your app with <code class="w3-codespan">node --inspect app.js</code></li>
  <li>Connect with Chrome DevTools</li>
  <li>Go to the Performance tab</li>
  <li>Click Record</li>
  <li>Perform the actions you want to profile</li>
  <li>Stop the recording</li>
  <li>Analyze the flame chart</li>
</ol>


<h4>3. Third-Party Profiling Tools</h4>
<ul>
  <li><code class="w3-codespan">clinic flame</code>: Generate flame graphs for CPU profiling</li>
  <li><code class="w3-codespan">0x</code>: Flamegraph generation tool</li>
  <li><code class="w3-codespan">v8-profiler</code>: Programmatically collect V8 CPU profiles</li>
</ul>

<h3>Example: Identifying CPU Bottlenecks</h3>
<p>This example demonstrates how to identify inefficient code patterns:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// Inefficient recursive Fibonacci function<br>
function inefficientFibonacci(n) {<br>
&nbsp;&nbsp;if (n &lt;= 1) return n;<br>
&nbsp;&nbsp;return inefficientFibonacci(n - 1) + inefficientFibonacci(n - 2);<br>
}<br>
<br>
// More efficient iterative Fibonacci function<br>
function efficientFibonacci(n) {<br>
&nbsp;&nbsp;if (n &lt;= 1) return n;<br>
<br>
&nbsp;&nbsp;let a = 0, b = 1, temp;<br>
...
function comparePerformance(n) {<br>
&nbsp;&nbsp;console.log(`Calculating Fibonacci(${n})`);<br>
<br>
&nbsp;&nbsp;// Time the inefficient version<br>
&nbsp;&nbsp;const inefficientStart = process.hrtime.bigint();<br>
&nbsp;&nbsp;const inefficientResult = inefficientFibonacci(n);<br>
&nbsp;&nbsp;const inefficientEnd = process.hrtime.bigint();<br>
&nbsp;&nbsp;const inefficientTime = Number(inefficientEnd - inefficientStart) / 1_000_000; // in ms<br>
<br>
&nbsp;&nbsp;// Time the efficient version<br>
&nbsp;&nbsp;const efficientStart = process.hrtime.bigint();<br>
&nbsp;&nbsp;const efficientResult = efficientFibonacci(n);<br>
&nbsp;&nbsp;const efficientEnd = process.hrtime.bigint();<br>
&nbsp;&nbsp;const efficientTime = Number(efficientEnd - efficientStart) / 1_000_000; // in ms<br>
<br>
&nbsp;&nbsp;console.log(`Inefficient: ${inefficientResult} (${inefficientTime.toFixed(2)} ms)`);<br>
&nbsp;&nbsp;console.log(`Efficient: ${efficientResult} (${efficientTime.toFixed(2)} ms)`);<br>
&nbsp;&nbsp;console.log(`Speedup: ${Math.round(inefficientTime / efficientTime)}x`);<br>
}<br>
<br>
// Run the comparison<br>
comparePerformance(30);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_debugging_cpu_profiling">Run example &raquo;</a>
</div>

<h3>Optimizing CPU-Intensive Code</h3>
<p>Common techniques for optimizing CPU-intensive Node.js code include:</p>

<ul>
  <li><strong>Avoid Recursion:</strong> Use iterative approaches for better performance</li>
  <li><strong>Memoization:</strong> Cache results of expensive function calls</li>
  <li><strong>Offload to Worker Threads:</strong> Move CPU-intensive work to separate threads</li>
  <li><strong>Use Native Modules:</strong> For very performance-critical code, consider C++ addons</li>
  <li><strong>Avoid Blocking the Event Loop:</strong> Break large tasks into smaller chunks</li>
</ul>
<hr>

<h2 id="async-debugging">Debugging Asynchronous Code</h2>
<p>Asynchronous code can be challenging to debug due to its non-linear execution flow and complex error propagation.</p>

<h3>Common Challenges in Async Debugging</h3>
<ul>
  <li><strong>Lost Error Context:</strong> Errors thrown in callbacks may lose their stack trace</li>
  <li><strong>Callback Hell:</strong> Nested callbacks make it hard to trace execution flow</li>
  <li><strong>Promise Chains:</strong> Errors may be swallowed if not properly caught</li>
  <li><strong>Race Conditions:</strong> Timing-dependent bugs that are hard to reproduce</li>
  <li><strong>Unhandled Rejections:</strong> Promises that reject without catch handlers</li>
</ul>

<h3>Async Debugging Techniques</h3>

<h4>1. Use Async/Await with Try/Catch</h4>
<p>Async/await makes asynchronous code easier to debug by allowing you to use traditional try/catch blocks:</p>
...
&nbsp;&nbsp;&nbsp;&nbsp;throw error; // Re-throw for upper layers to handle<br>
&nbsp;&nbsp;}<br>
}
</div>
</div>

<h4>2. Set Breakpoints in Async Code</h4>
<p>When debugging in Chrome DevTools or VS Code, you can set breakpoints inside async functions and promise callbacks.</p>
<p>The debugger will pause execution at those points, allowing you to inspect the current state.</p>

<h4>3. Enable Async Stack Traces</h4>
<p>Modern debuggers can capture and display async stack traces, showing the complete chain of asynchronous operations:</p>
<ul>
  <li>In Chrome DevTools, enable "Async" in the call stack pane</li>
  <li>In VS Code, this is enabled by default</li>
</ul>

<h3>Example: Debugging Async Code</h3>
<p>Here's an example demonstrating async debugging techniques:</p>
...
<br>
// Convert callbacks to promises<br>
const readFile = util.promisify(fs.readFile);<br>
<br>
// Function with a nested chain of async operations<br>
async function processUserData(userId) {<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Processing data for user ${userId}...`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Fetch user data<br>
&nbsp;&nbsp;&nbsp;&nbsp;const userData = await fetchUserData(userId);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`User data retrieved: ${userData.name}`);<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Get user posts<br>
&nbsp;&nbsp;&nbsp;&nbsp;const posts = await getUserPosts(userId);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Retrieved ${posts.length} posts for user`);<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Process posts (this will cause an error for userId = 3)<br>
&nbsp;&nbsp;&nbsp;&nbsp;const processedPosts = posts.map(post => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;id: post.id,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;title: post.title.toUpperCase(),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;contentLength: post.content.length,  // Will fail if content is undefined<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;};<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;return { user: userData, posts: processedPosts };<br>
&nbsp;&nbsp;  } catch (error) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error('Error processing user data:', error);<br>
&nbsp;&nbsp;&nbsp;&nbsp;throw error;<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
// Simulated API call<br>
function fetchUserData(userId) {<br>
&nbsp;&nbsp;return new Promise((resolve, reject) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (userId <= 0) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;reject(new Error('Invalid user ID'));<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;resolve({ id: userId, name: `User ${userId}` });<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;}, 500);<br>
&nbsp;&nbsp;});<br>
}<br>
...
function getUserPosts(userId) {<br>
&nbsp;&nbsp;return new Promise((resolve) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Bug: post with undefined content for userId 3<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (userId === 3) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;resolve([<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{ id: 1, title: 'First Post', content: 'Content' },<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{ id: 2, title: 'Second Post', content: undefined }<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;]);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;resolve([<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{ id: 1, title: 'First Post', content: 'Content' },<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{ id: 2, title: 'Second Post', content: 'More content' }<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;]);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;}, 300);<br>
&nbsp;&nbsp;});<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_debugging_adv_async_error">Run example &raquo;</a>
</div>

<div class="w3-panel ws-note">
<p><strong>Debugging Tips for Async Code:</strong></p>
<ul>
  <li>Use async/await for more linear, debuggable code</li>
  <li>Add correlation IDs to track operations across async boundaries</li>
  <li>Listen for <code class="w3-codespan">unhandledRejection</code> and <code class="w3-codespan">uncaughtException</code> events</li>
  <li>Use <code class="w3-codespan">console.trace()</code> to log stack traces at specific points</li>
  <li>Set <code class="w3-codespan">NODE_DEBUG=*</code> to see internal Node.js debug logs</li>
</ul>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_debugging_advanced.js" data-extensions="asp"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_websockets.asp">&lt; Previous</a>
