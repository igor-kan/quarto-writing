...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Worker Threads Module</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js Worker Threads Module">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_worker_threads.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="Worker Threads run JavaScript in parallel across multiple threads for CPU-intensive work in Node.js.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Worker Threads Module">
<meta name="twitter:description" content="Worker Threads run JavaScript in parallel across multiple threads for CPU-intensive work in Node.js.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_worker_threads.png">
...
<h1>Node.js Worker Threads Module</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_cluster.asp">&lt; Previous</a>
<a class="w3-right w3-btn" href="nodejs_microservices.asp">Next &gt;</a>
</div>

<hr>
<h2>What are Worker Threads?</h2>

<p>Worker Threads are a feature introduced in Node.js (initially in v10.5.0 as an experimental feature and stabilized in v12) that allows JavaScript code to run in parallel across multiple CPU cores.</p>
<p>Unlike the <code class="w3-codespan">child_process</code> or <code class="w3-codespan">cluster</code> modules, which create separate Node.js processes, Worker Threads can share memory and run true parallel JavaScript code.</p>

<p>The Node.js Worker Threads module addresses the limitations of Node.js's single-threaded nature for CPU-intensive tasks.</p>
<p>While Node.js excels at I/O-bound operations thanks to its asynchronous event loop, it can struggle with CPU-bound tasks that can block the main thread and affect application performance.</p>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> Worker Threads are different from Web Workers in browsers, although they share similar concepts. Node.js Worker Threads are specifically designed for the Node.js runtime environment.</p>
</div>
...
<p>Worker Threads are most useful for:</p>
<ul>
  <li>CPU-intensive operations (large calculations, data processing)</li>
  <li>Parallel processing of data</li>
  <li>Operations that would otherwise block the main thread</li>
</ul>

<p>They are <strong>not</strong> necessary for:</p>
<ul>
  <li>I/O-bound operations (file system, network)</li>
  <li>Operations that already use asynchronous APIs</li>
  <li>Simple tasks that complete quickly</li>
</ul>

<hr>

<h2>Importing the Worker Threads Module</h2>

<p>The Worker Threads module is included in Node.js by default. You can use it by requiring it in your script:</p>
...
<table class="ws-table-all">
  ...
  <tr>
    <td><code class="w3-codespan">Worker</code></td>
    <td>Class for creating new worker threads</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">isMainThread</code></td>
    <td>Boolean that is true if the code is running in the main thread, false if it's running in a worker</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">parentPort</code></td>
    <td>If this thread is a worker, this is a MessagePort allowing communication with the parent thread</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">workerData</code></td>
    <td>Data passed when creating the worker thread</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">MessageChannel</code></td>
    <td>Creates a communication channel (pair of connected MessagePort objects)</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">MessagePort</code></td>
    <td>Interface for sending messages between threads</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">threadId</code></td>
    <td>Unique identifier for the current thread</td>
  </tr>
</table>
</div>
...
<h2>Creating Your First Worker Thread</h2>

<p>Let's create a simple example where the main thread creates a worker to perform a CPU-intensive task:</p>
...
<br>
// Function to create a new worker<br>
function runWorker(workerData) {<br>
&nbsp;&nbsp;return new Promise((resolve, reject) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Create a new worker<br>
&nbsp;&nbsp;&nbsp;&nbsp;const worker = new Worker('./worker.js', { workerData });<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Listen for messages from the worker<br>
&nbsp;&nbsp;&nbsp;&nbsp;worker.on('message', resolve);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Listen for errors<br>
&nbsp;&nbsp;&nbsp;&nbsp;worker.on('error', reject);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Listen for worker exit<br>
...
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Send data to the worker and get the result<br>
&nbsp;&nbsp;&nbsp;&nbsp;const result = await runWorker('Hello from main thread!');<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Worker result:', result);<br>
&nbsp;&nbsp;} catch (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error('Worker error:', err);<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
...
<br>
// Receive message from the main thread<br>
console.log('Worker received:', workerData);<br>
<br>
// Simulate CPU-intensive task<br>
function performCPUIntensiveTask() {<br>
&nbsp;&nbsp;// Simple example: Sum up to a large number<br>
&nbsp;&nbsp;let result = 0;<br>
&nbsp;&nbsp;for (let i = 0; i &lt; 1_000_000; i++) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;result += i;<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;return result;<br>
}<br>
<br>
// Perform the task<br>
const result = performCPUIntensiveTask();<br>
<br>
// Send the result back to the main thread<br>
parentPort.postMessage({<br>
&nbsp;&nbsp;receivedData: workerData,<br>
&nbsp;&nbsp;calculatedSum: result<br>
});
</div>
</div>
...
<p>In this example:</p>
<ol>
  <li>The main thread creates a worker with some initial data</li>
  <li>The worker performs a CPU-intensive calculation</li>
  <li>The worker sends the result back to the main thread</li>
  <li>The main thread receives and processes the result</li>
</ol>

<h3>Key Concepts in the Example</h3>

<ul>
  <li>The <code class="w3-codespan">Worker</code> constructor takes the path to the worker script and an options object</li>
  <li>The <code class="w3-codespan">workerData</code> option is used to pass initial data to the worker</li>
  <li>The worker communicates back to the main thread using <code class="w3-codespan">parentPort.postMessage()</code></li>
  <li>Event handlers (<code class="w3-codespan">message</code>, <code class="w3-codespan">error</code>, <code class="w3-codespan">exit</code>) are used to manage the worker lifecycle</li>
</ul>

<hr>

<h2>Communication Between Threads</h2>

<p>Worker threads communicate by passing messages.</p>
<p>The communication is bidirectional, meaning both the main thread and workers can send and receive messages.</p>

<h3>Main Thread to Worker</h3>
...
<br>
// Create a worker<br>
const worker = new Worker('./message_worker.js');<br>
<br>
// Send messages to the worker<br>
worker.postMessage('Hello worker!');<br>
worker.postMessage({ type: 'task', data: [1, 2, 3, 4, 5] });<br>
<br>
// Receive messages from the worker<br>
worker.on('message', (message) => {<br>
&nbsp;&nbsp;console.log('Main thread received:', message);<br>
});<br>
<br>
// Handle worker completion<br>
worker.on('exit', (code) => {<br>
&nbsp;&nbsp;console.log(`Worker exited with code ${code}`);<br>
});
</div>
</div>
...
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// message_worker.js<br>
const { parentPort } = require('worker_threads');<br>
<br>
// Receive messages from the main thread<br>
parentPort.on('message', (message) => {<br>
&nbsp;&nbsp;console.log('Worker received:', message);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Process different message types<br>
&nbsp;&nbsp;if (typeof message === 'object' && message.type === 'task') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const result = processTask(message.data);<br>
&nbsp;&nbsp;&nbsp;&nbsp;parentPort.postMessage({ type: 'result', data: result });<br>
&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Echo the message back<br>
&nbsp;&nbsp;&nbsp;&nbsp;parentPort.postMessage(`Worker echoing: ${message}`);<br>
&nbsp;&nbsp;}<br>
});<br>
<br>
// Example task processor<br>
function processTask(data) {<br>
...
<div class="w3-panel ws-note">
<p><strong>Note:</strong> Messages passed between threads are copied by value (serialized), not shared by reference.</p>
<p>This means that when you send an object from one thread to another, changes to the object in one thread will not affect the copy in the other thread.</p>
</div>

<hr>

<h2>CPU-Intensive Task Example</h2>

<p>Here's a more practical example that demonstrates the advantage of using worker threads for CPU-intensive tasks:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// fibonacci.js<br>
const { Worker, isMainThread, parentPort, workerData } = require('worker_threads');<br>
<br>
// Recursive Fibonacci function (deliberately inefficient to simulate CPU load)<br>
...
<br>
if (isMainThread) {<br>
&nbsp;&nbsp;// This code runs in the main thread<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Function to run a worker<br>
&nbsp;&nbsp;function runFibonacciWorker(n) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;return new Promise((resolve, reject) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const worker = new Worker(__filename, { workerData: n });<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;worker.on('message', resolve);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;worker.on('error', reject);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;worker.on('exit', (code) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (code !== 0) {<br>
...
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Measure execution time with and without workers<br>
&nbsp;&nbsp;async function run() {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const numbers = [40, 41, 42, 43];<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Using a single thread (blocking)<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.time('Single thread');<br>
&nbsp;&nbsp;&nbsp;&nbsp;for (const n of numbers) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Fibonacci(${n}) = ${fibonacci(n)}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.timeEnd('Single thread');<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Using worker threads (parallel)<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.time('Worker threads');<br>
&nbsp;&nbsp;&nbsp;&nbsp;const results = await Promise.all(<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;numbers.map(n => runFibonacciWorker(n))<br>
&nbsp;&nbsp;&nbsp;&nbsp;);<br>
&nbsp;&nbsp;&nbsp;&nbsp;for (let i = 0; i &lt; numbers.length; i++) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Fibonacci(${numbers[i]}) = ${results[i]}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.timeEnd('Worker threads');<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;run().catch(err => console.error(err));<br>
} else {<br>
&nbsp;&nbsp;// This code runs in worker threads<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Calculate Fibonacci number<br>
&nbsp;&nbsp;const result = fibonacci(workerData);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Send the result back to the main thread<br>
&nbsp;&nbsp;parentPort.postMessage(result);<br>
}</div>
</div>

<p>This example calculates Fibonacci numbers using both a single-threaded approach and a multi-threaded approach with worker threads.</p>
<p>On a multi-core CPU, the worker threads version should be significantly faster because it can utilize multiple CPU cores to calculate the Fibonacci numbers in parallel.</p>

<div class="w3-panel ws-warning">
<p><strong>Warning:</strong> While worker threads can significantly improve performance for CPU-bound tasks, they do come with overhead for creation and communication. For very small tasks, this overhead might outweigh the benefits.</p>
</div>

<hr>

<h2>Sharing Data with Worker Threads</h2>

<p>There are several ways to share data between threads:</p>

<ol>
  <li><strong>Passing copies:</strong> The default behavior when using <code class="w3-codespan">postMessage()</code></li>
  <li><strong>Transferring ownership:</strong> Using the <code class="w3-codespan">transferList</code> parameter of <code class="w3-codespan">postMessage()</code></li>
  <li><strong>Sharing memory:</strong> Using <code class="w3-codespan">SharedArrayBuffer</code></li>
</ol>

<h3>Transferring ArrayBuffers</h3>

<p>When you transfer an ArrayBuffer, you're transferring ownership of the buffer from one thread to another, without copying the data. This is more efficient for large data:</p>
...
const { Worker } = require('worker_threads');<br>
<br>
// Create a large buffer<br>
const buffer = new ArrayBuffer(100 * 1024 * 1024); // 100MB<br>
const view = new Uint8Array(buffer);<br>
<br>
// Fill with data<br>
for (let i = 0; i &lt; view.length; i++) {<br>
&nbsp;&nbsp;view[i] = i % 256;<br>
}<br>
<br>
console.log('Buffer created in main thread');<br>
console.log('Buffer byteLength before transfer:', buffer.byteLength);<br>
<br>
// Create a worker and transfer the buffer<br>
const worker = new Worker('./transfer_worker.js');<br>
worker.on('message', (message) => {<br>
&nbsp;&nbsp;console.log('Message from worker:', message);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// After transfer, the buffer is no longer usable in main thread<br>
&nbsp;&nbsp;console.log('Buffer byteLength after transfer:', buffer.byteLength);<br>
});<br>
<br>
// Transfer ownership of the buffer to the worker<br>
worker.postMessage({ buffer }, [buffer]);</div>
</div>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// transfer_worker.js<br>
const { parentPort } = require('worker_threads');<br>
<br>
parentPort.on('message', ({ buffer }) => {<br>
&nbsp;&nbsp;const view = new Uint8Array(buffer);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Calculate sum to verify data<br>
&nbsp;&nbsp;let sum = 0;<br>
&nbsp;&nbsp;for (let i = 0; i &lt; view.length; i++) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;sum += view[i];<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;console.log('Buffer received in worker');<br>
&nbsp;&nbsp;console.log('Buffer byteLength in worker:', buffer.byteLength);<br>
&nbsp;&nbsp;console.log('Sum of all values:', sum);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Send confirmation back<br>
&nbsp;&nbsp;parentPort.postMessage('Buffer processed successfully');<br>
});</div>
</div>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> After transferring an ArrayBuffer, the original buffer becomes unusable (its byteLength becomes 0).</p>
<p>The receiving thread gains full access to the buffer.</p>
</div>

<hr>

<h2>Sharing Memory with SharedArrayBuffer</h2>

<p>For scenarios where you need to share data between threads without copying or transferring, the <code class="w3-codespan">SharedArrayBuffer</code> provides a way to access the same memory from multiple threads.</p>

<div class="w3-panel ws-warning">
<p><strong>Warning:</strong> <code class="w3-codespan">SharedArrayBuffer</code> may be disabled in some Node.js versions due to security considerations related to Spectre vulnerabilities. Check your Node.js version documentation for details on how to enable it if needed.</p>
</div>
...
const { Worker } = require('worker_threads');<br>
<br>
// Create a shared buffer<br>
const sharedBuffer = new SharedArrayBuffer(4 * 10); // 10 Int32 values<br>
const sharedArray = new Int32Array(sharedBuffer);<br>
<br>
// Initialize the shared array<br>
for (let i = 0; i &lt; sharedArray.length; i++) {<br>
&nbsp;&nbsp;sharedArray[i] = i;<br>
}<br>
<br>
console.log('Initial shared array in main thread:', [...sharedArray]);<br>
<br>
// Create a worker that will update the shared memory<br>
const worker = new Worker('./shared_worker.js', { <br>
&nbsp;&nbsp;workerData: { sharedBuffer }<br>
});<br>
<br>
worker.on('message', (message) => {<br>
&nbsp;&nbsp;console.log('Message from worker:', message);<br>
&nbsp;&nbsp;console.log('Updated shared array in main thread:', [...sharedArray]);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// The changes made in the worker are visible here<br>
&nbsp;&nbsp;// because we're accessing the same memory<br>
});</div>
</div>
...
// shared_worker.js<br>
const { parentPort, workerData } = require('worker_threads');<br>
const { sharedBuffer } = workerData;<br>
<br>
// Create a new view on the shared buffer<br>
const sharedArray = new Int32Array(sharedBuffer);<br>
<br>
console.log('Initial shared array in worker:', [...sharedArray]);<br>
<br>
// Modify the shared memory<br>
for (let i = 0; i &lt; sharedArray.length; i++) {<br>
&nbsp;&nbsp;// Double each value<br>
&nbsp;&nbsp;sharedArray[i] = sharedArray[i] * 2;<br>
}<br>
<br>
console.log('Updated shared array in worker:', [...sharedArray]);<br>
<br>
// Notify the main thread<br>
parentPort.postMessage('Shared memory updated');
</div>
</div>

<h3>Synchronizing Access with Atomics</h3>

<p>When multiple threads access shared memory, you need a way to synchronize access to prevent race conditions.</p>
<p>The <code class="w3-codespan">Atomics</code> object provides methods for atomic operations on shared memory arrays.</p>
...
const { Worker } = require('worker_threads');<br>
<br>
// Create a shared buffer with control flags and data<br>
const sharedBuffer = new SharedArrayBuffer(4 * 10);<br>
const sharedArray = new Int32Array(sharedBuffer);<br>
<br>
// Initialize values<br>
sharedArray[0] = 0; // Control flag: 0 = main thread's turn, 1 = worker's turn<br>
sharedArray[1] = 0; // Data value to increment<br>
<br>
// Create workers<br>
const workerCount = 4;<br>
const workerIterations = 10;<br>
const workers = [];<br>
<br>
console.log(`Creating ${workerCount} workers with ${workerIterations} iterations each`);<br>
<br>
for (let i = 0; i &lt; workerCount; i++) {<br>
&nbsp;&nbsp;const worker = new Worker('./atomics_worker.js', { <br>
&nbsp;&nbsp;&nbsp;&nbsp;workerData: { sharedBuffer, id: i, iterations: workerIterations }<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;workers.push(worker);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;worker.on('exit', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Worker ${i} exited`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// If all workers have exited, show final value<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (workers.every(w => w.threadId === -1)) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Final value: ${sharedArray[1]}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Expected value: ${workerCount * workerIterations}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;});<br>
}<br>
<br>
// Signal to the first worker to start<br>
Atomics.store(sharedArray, 0, 1);<br>
...
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// atomics_worker.js<br>
const { parentPort, workerData } = require('worker_threads');<br>
const { sharedBuffer, id, iterations } = workerData;<br>
<br>
// Create a typed array from the shared memory<br>
const sharedArray = new Int32Array(sharedBuffer);<br>
<br>
for (let i = 0; i &lt; iterations; i++) {<br>
&nbsp;&nbsp;// Wait for this worker's turn<br>
&nbsp;&nbsp;while (Atomics.load(sharedArray, 0) !== id + 1) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Wait for notification<br>
&nbsp;&nbsp;&nbsp;&nbsp;Atomics.wait(sharedArray, 0, Atomics.load(sharedArray, 0));<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Increment the shared counter<br>
&nbsp;&nbsp;const currentValue = Atomics.add(sharedArray, 1, 1);<br>
&nbsp;&nbsp;console.log(`Worker ${id} incremented counter to ${currentValue + 1}`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Signal to the next worker<br>
&nbsp;&nbsp;const nextWorkerId = (id + 1) % (iterations === 0 ? 1 : iterations);<br>
&nbsp;&nbsp;Atomics.store(sharedArray, 0, nextWorkerId + 1);<br>
&nbsp;&nbsp;Atomics.notify(sharedArray, 0);<br>
}<br>
<br>
// Exit the worker<br>
parentPort.close();</div>
</div>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> The <code class="w3-codespan">Atomics</code> object provides methods like <code class="w3-codespan">load</code>, <code class="w3-codespan">store</code>, <code class="w3-codespan">add</code>, <code class="w3-codespan">wait</code>, and <code class="w3-codespan">notify</code> for synchronizing access to shared memory and implementing coordination patterns between threads.</p>
</div>

<hr>

<h2>Creating a Worker Pool</h2>

<p>For most applications, you'll want to create a pool of workers to handle multiple tasks concurrently.</p>
<p>Here's an implementation of a simple worker pool:</p>
...
<br>
class WorkerPool {<br>
&nbsp;&nbsp;constructor(workerScript, numWorkers = os.cpus().length) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.workerScript = workerScript;<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.numWorkers = numWorkers;<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.workers = [];<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.freeWorkers = [];<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.tasks = [];<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
...
&nbsp;&nbsp;<br>
&nbsp;&nbsp;_initialize() {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Create all workers<br>
&nbsp;&nbsp;&nbsp;&nbsp;for (let i = 0; i &lt; this.numWorkers; i++) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;this._createWorker();<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;_createWorker() {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const worker = new Worker(this.workerScript);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;worker.on('message', (result) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Get the current task<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const { resolve } = this.tasks.shift();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Resolve the task with the result<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;resolve(result);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Add this worker back to the free workers pool<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;this.freeWorkers.push(worker);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Process the next task if any<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;this._processQueue();<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;worker.on('error', (err) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// If a worker errors, terminate it and create a new one<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error(`Worker error: ${err}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;this._removeWorker(worker);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;this._createWorker();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Process the next task<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (this.tasks.length > 0) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const { reject } = this.tasks.shift();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;reject(err);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;this._processQueue();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;worker.on('exit', (code) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (code !== 0) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error(`Worker exited with code ${code}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;this._removeWorker(worker);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;this._createWorker();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Add to free workers<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.workers.push(worker);<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.freeWorkers.push(worker);<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;_removeWorker(worker) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Remove from the workers arrays<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.workers = this.workers.filter(w => w !== worker);<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.freeWorkers = this.freeWorkers.filter(w => w !== worker);<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;_processQueue() {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// If there are tasks and free workers, process the next task<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (this.tasks.length > 0 && this.freeWorkers.length > 0) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const { taskData } = this.tasks[0];<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const worker = this.freeWorkers.pop();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;worker.postMessage(taskData);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Run a task on a worker<br>
&nbsp;&nbsp;runTask(taskData) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;return new Promise((resolve, reject) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const task = { taskData, resolve, reject };<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;this.tasks.push(task);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;this._processQueue();<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Close all workers when done<br>
&nbsp;&nbsp;close() {<br>
&nbsp;&nbsp;&nbsp;&nbsp;for (const worker of this.workers) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;worker.terminate();<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>
}<br>
...
<p>Using the worker pool:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// pool_usage.js<br>
const WorkerPool = require('./worker_pool');<br>
const path = require('path');<br>
<br>
// Create a worker pool with the worker script<br>
const pool = new WorkerPool(path.resolve(__dirname, 'pool_worker.js'));<br>
<br>
// Function to run tasks on the pool<br>
async function runTasks() {<br>
&nbsp;&nbsp;const tasks = [<br>
&nbsp;&nbsp;&nbsp;&nbsp;{ type: 'fibonacci', data: 40 },<br>
&nbsp;&nbsp;&nbsp;&nbsp;{ type: 'factorial', data: 15 },<br>
&nbsp;&nbsp;&nbsp;&nbsp;{ type: 'prime', data: 10000000 },<br>
&nbsp;&nbsp;&nbsp;&nbsp;{ type: 'fibonacci', data: 41 },<br>
&nbsp;&nbsp;&nbsp;&nbsp;{ type: 'factorial', data: 16 },<br>
&nbsp;&nbsp;&nbsp;&nbsp;{ type: 'prime', data: 20000000 },<br>
&nbsp;&nbsp;&nbsp;&nbsp;{ type: 'fibonacci', data: 42 },<br>
&nbsp;&nbsp;&nbsp;&nbsp;{ type: 'factorial', data: 17 },<br>
&nbsp;&nbsp;];<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;console.time('All tasks');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Run all tasks in parallel<br>
&nbsp;&nbsp;&nbsp;&nbsp;const results = await Promise.all(<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;tasks.map(task => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.time(`Task: ${task.type}(${task.data})`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return pool.runTask(task)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;.then(result => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.timeEnd(`Task: ${task.type}(${task.data})`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return result;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;})<br>
&nbsp;&nbsp;&nbsp;&nbsp;);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Log results<br>
&nbsp;&nbsp;&nbsp;&nbsp;for (let i = 0; i &lt; tasks.length; i++) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`${tasks[i].type}(${tasks[i].data}) = ${results[i].result}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;} catch (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error('Error running tasks:', err);<br>
&nbsp;&nbsp;} finally {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.timeEnd('All tasks');<br>
&nbsp;&nbsp;&nbsp;&nbsp;pool.close();<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
runTasks().catch(console.error);</div>
</div>
...
<br>
// Prime count function<br>
function countPrimes(max) {<br>
&nbsp;&nbsp;const sieve = new Uint8Array(max);<br>
&nbsp;&nbsp;let count = 0;<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;for (let i = 2; i &lt; max; i++) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (!sieve[i]) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;count++;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;for (let j = i * 2; j &lt; max; j += i) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;sieve[j] = 1;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>
...
<br>
// Handle messages from the main thread<br>
parentPort.on('message', (task) => {<br>
&nbsp;&nbsp;const { type, data } = task;<br>
&nbsp;&nbsp;let result;<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Perform different calculations based on task type<br>
&nbsp;&nbsp;switch (type) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;case 'fibonacci':<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;result = fibonacci(data);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;break;<br>
&nbsp;&nbsp;&nbsp;&nbsp;case 'factorial':<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;result = factorial(data);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;break;<br>
&nbsp;&nbsp;&nbsp;&nbsp;case 'prime':<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;result = countPrimes(data);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;break;<br>
&nbsp;&nbsp;&nbsp;&nbsp;default:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;throw new Error(`Unknown task type: ${type}`);<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Send the result back<br>
&nbsp;&nbsp;parentPort.postMessage({ result });<br>
});</div>
</div>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> This worker pool implementation handles task scheduling, worker errors, and automatic worker replacement.</p>
<p>It's a good starting point for real-world applications but can be expanded with features like worker timeouts and prioritized tasks.</p>
</div>

<hr>

<h2>Practical Application: Image Processing</h2>

<p>Image processing is a perfect use case for worker threads as it's both CPU-intensive and easily parallelizable.</p>
<p>Here's an example of parallel image processing:</p>
...
<br>
// Function to process an image in a worker<br>
function processImageInWorker(imagePath, options) {<br>
&nbsp;&nbsp;return new Promise((resolve, reject) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const worker = new Worker('./image_worker.js', {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;workerData: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;imagePath,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;options<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
...
<br>
// Main function to process multiple images in parallel<br>
async function processImages() {<br>
&nbsp;&nbsp;const images = [<br>
&nbsp;&nbsp;&nbsp;&nbsp;{ path: 'image1.jpg', options: { grayscale: true } },<br>
&nbsp;&nbsp;&nbsp;&nbsp;{ path: 'image2.jpg', options: { blur: 5 } },<br>
&nbsp;&nbsp;&nbsp;&nbsp;{ path: 'image3.jpg', options: { sharpen: 10 } },<br>
&nbsp;&nbsp;&nbsp;&nbsp;{ path: 'image4.jpg', options: { resize: { width: 800, height: 600 } } }<br>
&nbsp;&nbsp;];<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;console.time('Image processing');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Process all images in parallel<br>
&nbsp;&nbsp;&nbsp;&nbsp;const results = await Promise.all(<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;images.map(img => processImageInWorker(img.path, img.options))<br>
&nbsp;&nbsp;&nbsp;&nbsp;);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('All images processed successfully');<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Results:', results);<br>
&nbsp;&nbsp;} catch (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error('Error processing images:', err);<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;console.timeEnd('Image processing');<br>
}<br>
<br>
// Note: This is a conceptual example.<br>
// In a real application, you would use an image processing library like sharp or jimp<br>
// and provide actual image files.<br>
// processImages().catch(console.error);<br>
...
// image_worker.js<br>
const { parentPort, workerData } = require('worker_threads');<br>
const { imagePath, options } = workerData;<br>
<br>
// In a real application, you would import an image processing library here<br>
// const sharp = require('sharp');<br>
<br>
// Simulate image processing<br>
function processImage(imagePath, options) {<br>
&nbsp;&nbsp;console.log(`Processing image: ${imagePath} with options:`, options);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Simulate processing time based on options<br>
&nbsp;&nbsp;let processingTime = 500; // Base time in ms<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;if (options.grayscale) processingTime += 200;<br>
&nbsp;&nbsp;if (options.blur) processingTime += options.blur * 50;<br>
&nbsp;&nbsp;if (options.sharpen) processingTime += options.sharpen * 30;<br>
&nbsp;&nbsp;if (options.resize) processingTime += 300;<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Simulate the actual processing<br>
&nbsp;&nbsp;return new Promise(resolve => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Return simulated result<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;resolve({<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;imagePath,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;outputPath: `processed_${imagePath}`,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;processing: options,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;dimensions: options.resize || { width: 1024, height: 768 },<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;size: Math.floor(Math.random() * 1000000) + 500000 // Random file size<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;}, processingTime);<br>
&nbsp;&nbsp;});<br>
}<br>
<br>
// Process the image and send the result back<br>
processImage(imagePath, options)<br>
&nbsp;&nbsp;.then(result => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;parentPort.postMessage(result);<br>
&nbsp;&nbsp;})<br>
&nbsp;&nbsp;.catch(err => {<br>
...
<h2>Worker Threads vs. Child Process and Cluster</h2>

<p>It's important to understand when to use Worker Threads versus other Node.js concurrency mechanisms:</p>
...
<table class="ws-table-all">
  ...
  <tr>
    <td>Shared Memory</td>
    <td>Yes (via SharedArrayBuffer)</td>
    <td>No (IPC only)</td>
    <td>No (IPC only)</td>
  </tr>
  <tr>
    <td>Resource Usage</td>
    <td>Lower (shared V8 instance)</td>
  ...
  <tr>
    <td>Isolation</td>
    <td>Lower (shares event loop)</td>
    <td>Higher (full process isolation)</td>
    <td>Higher (full process isolation)</td>
  </tr>
  <tr>
    <td>Failure Impact</td>
    <td>Can affect parent thread</td>
    <td>Limited to child process</td>
    <td>Limited to worker process</td>
  </tr>
  <tr>
    <td>Best For</td>
    <td>CPU-intensive tasks</td>
    <td>Running different programs</td>
    <td>Scaling applications</td>
  </tr>
</table>
</div>
...
<ul>
  <li>CPU-bound tasks like number crunching, image processing, or compression</li>
  <li>When shared memory is needed for better performance</li>
  <li>When you need to run parallel JavaScript code within a single Node.js instance</li>
</ul>

<h3>When to Use Child Process</h3>
<ul>
  <li>Running external programs or commands</li>
  <li>Executing tasks in different languages</li>
  <li>When you need stronger isolation between the main process and the spawned processes</li>
</ul>

<h3>When to Use Cluster</h3>
<ul>
  <li>Scaling an HTTP server across multiple cores</li>
  <li>Load balancing incoming connections</li>
  <li>Improving application resilience and uptime</li>
</ul>
...
<ol>
  <li><strong>Don't overuse threads:</strong> Only use worker threads for CPU-intensive tasks that would otherwise block the main thread.</li>
  <li><strong>Consider the overhead:</strong> Creating threads has overhead. For very short tasks, this overhead might outweigh the benefits.</li>
  <li><strong>Use a worker pool:</strong> Reuse workers for multiple tasks instead of creating and destroying them for each task.</li>
  <li><strong>Minimize data transfer:</strong> Transfer ownership with ArrayBuffer or use SharedArrayBuffer when working with large amounts of data.</li>
  <li><strong>Handle errors properly:</strong> Always catch errors from workers and have a strategy for worker failures.</li>
  <li><strong>Monitor worker lifecycles:</strong> Keep track of worker health and restart them if they crash.</li>
  <li><strong>Use appropriate synchronization:</strong> Use Atomics for coordinating access to shared memory.</li>
  <li><strong>Benchmark your solution:</strong> Always measure the performance improvement to ensure threads are actually helping.</li>
</ol>

<div class="w3-panel ws-warning">
<p><strong>Warning:</strong> Threading adds complexity to your code. Only use worker threads when you have a genuine need for parallel execution. For I/O-bound operations, Node.js's built-in asynchronous APIs are usually more efficient.</p>
</div>
...
<p>The Worker Threads module provides true multithreading capabilities in Node.js, enabling CPU-intensive tasks to run in parallel without blocking the main event loop.</p>

<p>In this tutorial, we've covered:</p>
<ul>
  <li>Sharing data between threads using <code class="w3-codespan">SharedArrayBuffer</code></li>
  <li>Synchronizing thread access with <code class="w3-codespan">Atomics</code></li>
  <li>Creating a reusable worker pool for efficient task management</li>
  <li>Practical applications like parallel image processing</li>
  <li>Comparison with other Node.js concurrency models</li>
  <li>Best practices for using worker threads effectively</li>
</ul>

<hr>

<div id="exercisecontainer" src="xrcise_worker_threads.js" data-extensions="asp"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_cluster.asp">&lt; Previous</a>
