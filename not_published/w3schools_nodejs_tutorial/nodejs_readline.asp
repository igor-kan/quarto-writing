...
<meta name="title" property="og:title" content="Node.js Readline Module">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_readline.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="The Readline module reads input from a stream like process.stdin one line at a time.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Readline Module">
<meta name="twitter:description" content="The Readline module reads input from a stream like process.stdin one line at a time.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_readline.png">
...
<h1>Node.js Readline Module</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_util.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="nodejs_es6.asp">Next &#10095;</a>
</div>

<hr>
<h2>Introduction to the Readline Module</h2>

<p>The Readline module is a core Node.js module that provides an interface for reading data from a Readable stream (like <code class="w3-codespan">process.stdin</code>) one line at a time.</p>
...
<div class="w3-row-padding">
  <div class="w3-half">
    <div class="w3-panel w3-light-grey w3-padding w3-round">
      ...
      <ul>
        <li>Interactive command-line applications</li>
        <li>Configuration wizards and setup tools</li>
        <li>Command-line games</li>
        <li>REPL (Read-Eval-Print Loop) environments</li>
        <li>Processing large text files line by line</li>
        <li>Building custom shells and CLIs</li>
      </ul>
    </div>
  </div>
  <div class="w3-half">
    <div class="w3-panel w3-light-grey w3-padding w3-round">
      <h4>Key Features</h4>
      <ul>
        <li>Line-by-line input processing</li>
        <li>Customizable prompts and formatting</li>
        <li>Tab completion support</li>
        <li>History management</li>
        <li>Event-driven interface</li>
        <li>Promise-based API support</li>
      </ul>
    </div>
  </div>
</div>
...
<p><strong>Note:</strong> The Readline module is built into Node.js, so no additional installation is required.</p>
<p>It's perfect for any application that needs to interact with users through the command line or process text input in a line-oriented way.</p>
</div>

<hr>

<h2>Getting Started with Readline</h2>

<p>Here's a quick example of using the Readline module to create a simple interactive command-line application:</p>

<div class="w3-example">
<h3>Basic Interactive Prompt</h3>
<div class="w3-code notranslate jsHigh">const readline = require('readline');<br>
<br>
// Create interface for input/output<br>
const rl = readline.createInterface({<br>
&nbsp;&nbsp;input: process.stdin,<br>
&nbsp;&nbsp;output: process.stdout<br>
});<br>
<br>
// Ask a question and handle the response<br>
rl.question('What is your name? ', (name) => {<br>
&nbsp;&nbsp;console.log(`Hello, ${name}!`);<br>
<br>
&nbsp;&nbsp;// Ask follow-up question<br>
&nbsp;&nbsp;rl.question('How old are you? ', (age) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`In 5 years, you'll be ${parseInt(age) + 5} years old.`);<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Close the interface when done<br>
&nbsp;&nbsp;&nbsp;&nbsp;rl.close();<br>
&nbsp;&nbsp;});<br>
});<br>
<br>
// Handle application exit<br>
rl.on('close', () => {<br>
&nbsp;&nbsp;console.log('Goodbye!');<br>
&nbsp;&nbsp;process.exit(0);<br>
});</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_readline_quickstart">Run example &raquo;</a>
</div>
...
<p>The Readline module can be imported in several ways depending on your module system and needs:</p>

<div class="w3-example">
<h3>CommonJS (Node.js default)</h3>
<div class="w3-code notranslate jsHigh">// Basic require<br>
const readline = require('readline');<br>
<br>
// Import specific methods using destructuring<br>
const { createInterface } = require('readline');<br>
<br>
// Create interface with default settings<br>
const rl = createInterface({<br>
&nbsp;&nbsp;input: process.stdin,<br>
&nbsp;&nbsp;output: process.stdout<br>
});</div>
</div>
...
<div class="w3-code notranslate jsHigh">// Using default import<br>
import readline from 'readline';<br>
<br>
// Using named imports<br>
import { createInterface } from 'readline';<br>
<br>
// Dynamic import (Node.js 14+)<br>
const { createInterface } = await import('readline');<br>
<br>
// Create interface<br>
const rl = createInterface({<br>
&nbsp;&nbsp;input: process.stdin,<br>
...
<div class="w3-panel ws-note">
<p><strong>Best Practice:</strong> Always close the readline interface using <code class="w3-codespan">rl.close()</code> when you're done with it to free up system resources and allow your program to exit cleanly.</p>
</div>

<hr>

<h2>Creating a Readline Interface</h2>

<p>The <code class="w3-codespan">createInterface</code> method is the main way to create a readline interface. It takes an options object with several configuration properties:</p>

<div class="w3-example">
<h3>Basic Interface Creation</h3>
<div class="w3-code notranslate jsHigh">const readline = require('readline');<br>
<br>
// Create a basic interface<br>
const rl = readline.createInterface({<br>
&nbsp;&nbsp;input: process.stdin,    // Readable stream to listen to<br>
&nbsp;&nbsp;output: process.stdout,   // Writable stream to write to<br>
&nbsp;&nbsp;prompt: '> ',             // Prompt to display (default: '> ')<br>
});</div>
</div>
...
<ul>
  <li><code class="w3-codespan">input</code>: The Readable stream to listen to (default: <code class="w3-codespan">process.stdin</code>)</li>
  <li><code class="w3-codespan">output</code>: The Writable stream to write to (default: <code class="w3-codespan">process.stdout</code>)</li>
  <li><code class="w3-codespan">prompt</code>: The prompt string to use (default: '> ')</li>
  <li><code class="w3-codespan">terminal</code>: If true, treats the output as a TTY (default: <code class="w3-codespan">output.isTTY</code>)</li>
  <li><code class="w3-codespan">historySize</code>: Maximum number of history entries (default: 30)</li>
  <li><code class="w3-codespan">removeHistoryDuplicates</code>: If true, removes duplicate history entries (default: false)</li>
  <li><code class="w3-codespan">completer</code>: Optional function for tab auto-completion</li>
  <li><code class="w3-codespan">crlfDelay</code>: Delay between CR and LF (default: 100ms)</li>
  <li><code class="w3-codespan">escapeCodeTimeout</code>: Time to wait for character escape sequences (default: 500ms)</li>
</ul>
</div>

<div class="w3-example">
<h3>Advanced Interface Example</h3>
<div class="w3-code notranslate jsHigh">const readline = require('readline');<br>
const fs = require('fs');<br>
<br>
// Create an interface with advanced options<br>
const rl = readline.createInterface({<br>
&nbsp;&nbsp;input: fs.createReadStream('input.txt'),  // Read from file<br>
&nbsp;&nbsp;output: process.stdout,                  // Write to console<br>
&nbsp;&nbsp;terminal: false,                         // Input is not a terminal<br>
&nbsp;&nbsp;historySize: 100,                        // Larger history<br>
&nbsp;&nbsp;removeHistoryDuplicates: true,           // Don't store duplicate commands<br>
&nbsp;&nbsp;prompt: 'CLI> ',                         // Custom prompt<br>
&nbsp;&nbsp;crlfDelay: Infinity,                     // Handle all CR/LF as single line break<br>
&nbsp;&nbsp;escapeCodeTimeout: 200                   // Faster escape code detection<br>
});<br>
<br>
// Handle each line from the file<br>
rl.on('line', (line) => {<br>
&nbsp;&nbsp;console.log(`Processing: ${line}`);<br>
});<br>
<br>
// Handle end of file<br>
rl.on('close', () => {<br>
&nbsp;&nbsp;console.log('Finished processing file');<br>
});</div>
</div>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> When creating interfaces for file processing, set <code class="w3-codespan">terminal: false</code> to disable TTY-specific features and improve performance.</p>
</div>

<hr>

<h2>Basic Readline Methods</h2>

<p>The Readline module provides several methods for interacting with the user. Here are the most commonly used ones:</p>


<h3>1. <code class="w3-codespan">rl.question(query, callback)</code></h3>
<p>Displays a query to the user and invokes the callback with the user's response. This is one of the most commonly used methods for simple user interactions.</p>
<div class="w3-example">
<h4>Basic Example</h4>
<div class="w3-code notranslate jsHigh">const readline = require('readline');<br>
const rl = readline.createInterface({<br>
...
<div class="w3-example">
<h4>Nested Questions Example</h4>
<div class="w3-code notranslate jsHigh">function askQuestion(query) {<br>
&nbsp;&nbsp;return new Promise(resolve => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;rl.question(query, resolve);<br>
&nbsp;&nbsp;});<br>
}<br>
<br>
async function userSurvey() {<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const name = await askQuestion('What is your name? ');<br>
&nbsp;&nbsp;&nbsp;&nbsp;const age = await askQuestion('How old are you? ');<br>
&nbsp;&nbsp;&nbsp;&nbsp;const email = await askQuestion('What is your email? ');<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('\n=== User Information ===');<br>
...
<div class="w3-panel ws-note">
<p><strong>Best Practices for <code class="w3-codespan">rl.question()</code>:</strong></p>
<ul>
  <li>Always handle errors in the callback function</li>
  <li>Consider using promises or async/await for better flow control with multiple questions</li>
  <li>Validate user input before processing</li>
  <li>Always close the interface when done to free up resources</li>
</ul>
</div>


<h3>2. <code class="w3-codespan">rl.prompt([preserveCursor])</code></h3>
<p>Writes the current prompt to output and waits for user input. The optional <code class="w3-codespan">preserveCursor</code> parameter (boolean) determines if the cursor position should be preserved.</p>
<div class="w3-example">
<h4>Basic Prompt Example</h4>
<div class="w3-code notranslate jsHigh">const readline = require('readline');<br>
const rl = readline.createInterface({<br>
&nbsp;&nbsp;input: process.stdin,<br>
&nbsp;&nbsp;output: process.stdout,<br>
...
<br>
// Display initial prompt<br>
rl.prompt();<br>
<br>
// Handle each line of input<br>
rl.on('line', (line) => {<br>
&nbsp;&nbsp;const input = line.trim();<br>
<br>
&nbsp;&nbsp;switch (input) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;case 'hello':<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;break;<br>
&nbsp;&nbsp;&nbsp;&nbsp;case 'time':<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Current time: ${new Date().toLocaleTimeString()}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;break;<br>
&nbsp;&nbsp;&nbsp;&nbsp;case 'exit':<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;rl.close();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return;<br>
&nbsp;&nbsp;&nbsp;&nbsp;default:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`You entered: ${input}`);<br>
&nbsp;&nbsp;}<br>
<br>
&nbsp;&nbsp;// Show the prompt again<br>
&nbsp;&nbsp;rl.prompt();<br>
});<br>
<br>
// Handle application exit<br>
...
<div class="w3-panel ws-note">
<p><strong>Tips for Using Prompts:</strong></p>
<ul>
  <li>Use <code class="w3-codespan">rl.setPrompt()</code> to change the prompt string dynamically</li>
  <li>For multi-line prompts, include line breaks in the prompt string</li>
  <li>Consider using a library like <code class="w3-codespan">chalk</code> to add colors to your prompts</li>
  <li>Remember to call <code class="w3-codespan">rl.prompt()</code> after handling each input to show the prompt again</li>
</ul>
</div>


<h3>3. <code class="w3-codespan">rl.write(data[, key])</code></h3>
<p>Writes data to the output stream. The optional <code class="w3-codespan">key</code> parameter can be used to simulate key presses.</p>
<div class="w3-example">
<h4>Write Example</h4>
<div class="w3-code notranslate jsHigh">const readline = require('readline');<br>
const rl = readline.createInterface({<br>
...
rl.write('='.repeat(30) + '\n\n');<br>
<br>
// Pre-fill a default value<br>
rl.question('Enter your username: ', (username) => {<br>
&nbsp;&nbsp;console.log(`Hello, ${username}!`);<br>
<br>
&nbsp;&nbsp;// Simulate typing a default value<br>
&nbsp;&nbsp;rl.write('default@example.com');<br>
<br>
&nbsp;&nbsp;// Move cursor to the beginning of the line<br>
&nbsp;&nbsp;rl.write(null, { ctrl: true, name: 'a' });<br>
<br>
&nbsp;&nbsp;rl.question('Enter your email: ', (email) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Your email is: ${email}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;rl.close();<br>
&nbsp;&nbsp;});<br>
});</div>
</div>
...
<div class="w3-panel ws-note">
<p><strong>Common Use Cases for <code class="w3-codespan">rl.write()</code>:</strong></p>
<ul>
  <li>Displaying headers or section titles</li>
  <li>Providing default values in prompts</li>
  <li>Simulating user input for testing</li>
  <li>Creating custom input formatting</li>
</ul>
</div>


<h3>4. <code class="w3-codespan">rl.close()</code></h3>
<p>Closes the readline interface and releases control of the input and output streams. This is important to free up system resources and allow your program to exit cleanly.</p>
<div class="w3-example">
<h4>Proper Cleanup Example</h4>
<div class="w3-code notranslate jsHigh">const readline = require('readline');<br>
const rl = readline.createInterface({<br>
&nbsp;&nbsp;input: process.stdin,<br>
&nbsp;&nbsp;output: process.stdout<br>
...
&nbsp;&nbsp;// (e.g., close database connections, write logs, etc.)<br>
<br>
&nbsp;&nbsp;// Close the readline interface<br>
&nbsp;&nbsp;rl.close();<br>
}<br>
<br>
// Handle Ctrl+C<br>
rl.on('SIGINT', () => {<br>
&nbsp;&nbsp;console.log('\nReceived SIGINT. Exiting...');<br>
&nbsp;&nbsp;exitApp();<br>
});<br>
<br>
// Handle normal exit<br>
rl.on('close', () => {<br>
&nbsp;&nbsp;console.log('Goodbye!');<br>
&nbsp;&nbsp;process.exit(0);<br>
});<br>
...
console.log('Application started. Press Ctrl+C to exit.');<br>
rl.prompt();</div>
</div>


<h3>5. <code class="w3-codespan">rl.pause()</code> and <code class="w3-codespan">rl.resume()</code></h3>
<p>These methods allow you to temporarily pause and resume the input stream, which can be useful for controlling the flow of user input.</p>
<div class="w3-example">
<h4>Pause/Resume Example</h4>
<div class="w3-code notranslate jsHigh">const readline = require('readline');<br>
const rl = readline.createInterface({<br>
&nbsp;&nbsp;input: process.stdin,<br>
&nbsp;&nbsp;output: process.stdout<br>
...
<br>
let isPaused = false;<br>
<br>
console.log('Type "pause" to pause input, "resume" to continue, or "exit" to quit');<br>
<br>
rl.on('line', (input) => {<br>
&nbsp;&nbsp;const command = input.trim().toLowerCase();<br>
<br>
&nbsp;&nbsp;switch (command) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;case 'pause':<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (!isPaused) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Input paused. Type "resume" to continue...');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;rl.pause();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;isPaused = true;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;break;<br>
...
<div class="w3-panel ws-note">
<p><strong>When to Use Pause/Resume:</strong></p>
<ul>
  <li>When performing long-running operations that shouldn't be interrupted by user input</li>
  <li>When temporarily disabling user input during certain operations</li>
  <li>When implementing a paging mechanism for long outputs</li>
  <li>When you need to throttle input processing</li>
</ul>
</div>
...
<table class="ws-table-all">
  ...
  <tr>
    <td><code class="w3-codespan">rl.question(query, callback)</code></td>
    <td>Displays the query and waits for user input, then invokes the callback with the user's answer</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">rl.prompt([preserveCursor])</code></td>
    <td>Displays the configured prompt for user input</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">rl.write(data[, key])</code></td>
    <td>Writes data to the output stream, can also simulate keypress events</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">rl.close()</code></td>
    <td>Closes the readline interface and relinquishes control of the input and output streams</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">rl.pause()</code></td>
    <td>Pauses the readline input stream</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">rl.resume()</code></td>
    <td>Resumes the readline input stream</td>
  </tr>
</table>
</div>
...
<h2>Using Promises with Readline</h2>

<p>The Readline module's callback-based API can be wrapped in promises for more modern, async/await friendly code:</p>
...
<br>
// Promise-based question function<br>
function askQuestion(query) {<br>
&nbsp;&nbsp;return new Promise(resolve => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;rl.question(query, resolve);<br>
&nbsp;&nbsp;});<br>
}<br>
<br>
// Using async/await with readline<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`In 5 years, you'll be ${parseInt(age) + 5} years old.`);<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;const location = await askQuestion('Where do you live? ');<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`${location} is a great place!`);<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Thank you for your answers!');<br>
&nbsp;&nbsp;} catch (error) {<br>
...
<h2>Creating an Interactive CLI Menu</h2>

<p>You can use the Readline module to create interactive menus for command-line applications:</p>
...
// Menu options<br>
const menu = {<br>
&nbsp;&nbsp;1: 'Show current time',<br>
&nbsp;&nbsp;2: 'Show system info',<br>
&nbsp;&nbsp;3: 'Show memory usage',<br>
&nbsp;&nbsp;4: 'Exit'<br>
};<br>
<br>
// Function to display menu<br>
function displayMenu() {<br>
&nbsp;&nbsp;console.log('\n===== MAIN MENU =====');<br>
&nbsp;&nbsp;for (const [key, value] of Object.entries(menu)) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`${key}: ${value}`);<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;console.log('====================\n');<br>
}<br>
<br>
// Function to handle menu selection<br>
async function handleMenu() {<br>
&nbsp;&nbsp;let running = true;<br>
<br>
&nbsp;&nbsp;while (running) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;displayMenu();<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;const answer = await askQuestion('Select an option: ');<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;switch (answer) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;case '1':<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Current time: ${new Date().toLocaleTimeString()}`);<br>
...
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;case '2':<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('System info:');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Platform: ${process.platform}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Node.js version: ${process.version}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Process ID: ${process.pid}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;break;<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;case '3':<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const memory = process.memoryUsage();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Memory usage:');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;for (const [key, value] of Object.entries(memory)) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`${key}: ${Math.round(value / 1024 / 1024 * 100) / 100} MB`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;break;<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;case '4':<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Exiting program. Goodbye!');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;running = false;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;break;<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;default:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Invalid option. Please try again.');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (running) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;await askQuestion('\nPress Enter to continue...');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.clear(); // Clear console for better UX<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
...
<p>Besides interactive input, the Readline module can also read files line by line, which is useful for processing large text files efficiently:</p>
...
const readline = require('readline');<br>
<br>
// Create a readable stream for the file<br>
const fileStream = fs.createReadStream('example.txt');<br>
<br>
// Create the readline interface<br>
const rl = readline.createInterface({<br>
&nbsp;&nbsp;input: fileStream,<br>
&nbsp;&nbsp;crlfDelay: Infinity // Recognize all instances of CR LF as a single line break<br>
});<br>
<br>
// Counter for line numbers<br>
let lineNumber = 0;<br>
<br>
// Process file line by line<br>
rl.on('line', (line) => {<br>
&nbsp;&nbsp;lineNumber++;<br>
&nbsp;&nbsp;console.log(`Line ${lineNumber}: ${line}`);<br>
});<br>
<br>
// Handle end of file<br>
rl.on('close', () => {<br>
&nbsp;&nbsp;console.log(`Finished reading file with ${lineNumber} lines.`);<br>
});</div>
</div>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> This approach is memory-efficient for large files as it processes one line at a time rather than loading the entire file into memory.</p>
</div>
...
<p>Tab completion enhances the user experience by providing command and file path suggestions. The Readline module allows you to implement custom completion logic:</p>

<div class="w3-panel ws-note">
<p><strong>How Tab Completion Works:</strong></p>
<ul>
  <li>User presses the Tab key</li>
  <li>Readline calls your completer function with the current line and cursor position</li>
  <li>Your function returns completion suggestions</li>
  <li>Readline displays the completions or auto-completes if there's only one match</li>
</ul>
</div>
...
<br>
// Available commands for autocompletion<br>
const commands = ['help', 'exit', 'list', 'clear', 'info', 'version', 'history'];<br>
<br>
// Create the readline interface with a completer function<br>
const rl = readline.createInterface({<br>
&nbsp;&nbsp;input: process.stdin,<br>
&nbsp;&nbsp;output: process.stdout,<br>
&nbsp;&nbsp;prompt: 'myapp> ',<br>
&nbsp;&nbsp;completer: function(line) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Command completion<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (!line.includes(' ')) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const hits = commands.filter(c => c.startsWith(line));<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Show all completions if none matches<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return [hits.length ? hits : commands, line];<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;// File path completion (for commands like "list ")<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (line.startsWith('list ')) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const dir = line.split(' ')[1] || '.';<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;let completions = fs.readdirSync(dir);<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Add trailing slash to directories<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;completions = completions.map(file => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const fullPath = path.join(dir, file);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return fs.statSync(fullPath).isDirectory() ? file + '/' : file;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const hits = completions.filter(c => c.startsWith(line.split(' ')[1] || ''));<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return [hits.length ? hits : completions, line.split(' ')[1] || ''];<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;} catch (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return [[], line];<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
...
&nbsp;&nbsp;switch (true) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;case line === 'help':<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Available commands:');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;commands.forEach(cmd => console.log(`  ${cmd}`));<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;break;<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;case line === 'exit':<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Goodbye!');<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return;<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;case line.startsWith('list'):<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const dir = line.split(' ')[1] || '.';<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const files = fs.readdirSync(dir);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Contents of ${dir}:`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;files.forEach(file => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const stats = fs.statSync(path.join(dir, file));<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`  ${file}${stats.isDirectory() ? '/' : ''}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;} catch (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error(`Error listing directory: ${err.message}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;break;<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;case line === 'clear':<br>
...
<br>
&nbsp;&nbsp;&nbsp;&nbsp;case line === 'info':<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Node.js CLI Example');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Version: 1.0.0`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;break;<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;case line === 'version':<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Node.js version: ${process.version}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;break;<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;case line === 'history':<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Note: This requires storing history manually<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('History feature not fully implemented.');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;break;<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;case line === '':<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Do nothing for empty lines<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;break;<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;default:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Unknown command: ${line}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Type "help" for available commands');<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;rl.prompt();<br>
}).on('close', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('CLI terminated.');<br>
&nbsp;&nbsp;&nbsp;&nbsp;process.exit(0);<br>
});<br>
<br>
// Handle Ctrl+C<br>
rl.on('SIGINT', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;rl.question('Are you sure you want to exit? (y/n) ', (answer) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (answer.toLowerCase() === 'y') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;rl.close();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;rl.prompt();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
...
<p>The Readline module excels at handling multi-line input, making it perfect for text editors, code editors, or any application that needs to collect multiple lines of text from users. Here's how to implement it effectively:</p>

<div class="w3-panel ws-note">
<p><strong>Multi-Line Input Strategies:</strong></p>
<ul>
  <li><strong>End Marker:</strong> Use a special sequence (like <code class="w3-codespan">.end</code>) to signal the end of input</li>
  <li><strong>Bracket Matching:</strong> Automatically detect when all opened brackets/parentheses are closed</li>
  <li><strong>Dedicated Command:</strong> Provide a specific command to submit multi-line input</li>
  <li><strong>Timeout-Based:</strong> Use a timer to detect when the user is done typing</li>
</ul>
</div>
...
<br>
console.log('Enter your multi-line input. Type ".end" on a new line to finish:');<br>
rl.prompt();<br>
<br>
// Store lines<br>
const lines = [];<br>
...
// Handle input<br>
rl.on('line', (line) => {<br>
&nbsp;&nbsp; // Check for end command<br>
&nbsp;&nbsp; if (line.trim() === '.end') {<br>
&nbsp;&nbsp;&nbsp;&nbsp; console.log('\nYour complete input:');<br>
&nbsp;&nbsp;&nbsp;&nbsp; console.log('-'.repeat(30));<br>
&nbsp;&nbsp;&nbsp;&nbsp; console.log(lines.join('\n'));<br>
&nbsp;&nbsp;&nbsp;&nbsp; console.log('-'.repeat(30));<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp; // Process the input (example: count words)<br>
&nbsp;&nbsp;&nbsp;&nbsp; const text = lines.join(' ');<br>
&nbsp;&nbsp;&nbsp;&nbsp; const wordCount = text.split(/\s+/).filter(Boolean).length;<br>
&nbsp;&nbsp;&nbsp;&nbsp; const charCount = text.length;<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp; console.log(`\nStatistics:`);<br>
&nbsp;&nbsp;&nbsp;&nbsp; console.log(`Lines: ${lines.length}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp; console.log(`Words: ${wordCount}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp; console.log(`Characters: ${charCount}`);<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp; rl.close();<br>
&nbsp;&nbsp;&nbsp;&nbsp; return;<br>
&nbsp;&nbsp;}<br>
<br>
&nbsp;&nbsp;// Add line to collection<br>
&nbsp;&nbsp;lines.push(line);<br>
&nbsp;&nbsp;rl.prompt();<br>
});</div>
</div>
...
<h2>Building a Simple REPL</h2>

<p>A Read-Eval-Print Loop (REPL) is an interactive programming environment that reads user input, evaluates it, and prints the result.</p>
<p>The Readline module is perfect for building custom REPLs. Here's a comprehensive guide to creating your own:</p>

<div class="w3-panel ws-note">
<p><strong>Key Components of a REPL:</strong></p>
<ul>
  <li><strong>Read:</strong> Accept user input line by line</li>
  <li><strong>Eval:</strong> Parse and evaluate the input</li>
  <li><strong>Print:</strong> Display the result or any output</li>
  <li><strong>Loop:</strong> Return to the input prompt for the next command</li>
  <li><strong>Special Commands:</strong> Handle commands like <code class="w3-codespan">.help</code>, <code class="w3-codespan">.exit</code></li>
  <li><strong>Error Handling:</strong> Gracefully handle syntax errors and exceptions</li>
</ul>
</div>
...
<br>
// Create context for evaluating code<br>
const context = vm.createContext({<br>
&nbsp;&nbsp;console,<br>
&nbsp;&nbsp;Number,<br>
&nbsp;&nbsp;String,<br>
&nbsp;&nbsp;Array,<br>
&nbsp;&nbsp;Object,<br>
&nbsp;&nbsp;// Add any other global variables you want to make available<br>
&nbsp;&nbsp;// You can also add your own functions<br>
&nbsp;&nbsp;add: (a, b) => a + b,<br>
&nbsp;&nbsp;multiply: (a, b) => a * b<br>
});<br>
<br>
console.log('Simple JavaScript REPL (Press Ctrl+C to exit)');<br>
console.log('Type JavaScript code and press Enter to evaluate');<br>
<br>
// Show the prompt<br>
rl.prompt();<br>
<br>
// Track multi-line input<br>
let buffer = '';<br>
<br>
// Handle input<br>
rl.on('line', (line) => {<br>
&nbsp;&nbsp;// Add the line to our buffer<br>
&nbsp;&nbsp;buffer += line;<br>
<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Try to evaluate the code<br>
&nbsp;&nbsp;&nbsp;&nbsp;const result = vm.runInContext(buffer, context);<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Display the result<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('\x1b[33m%s\x1b[0m', '=> ' + result);<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Reset the buffer after successful evaluation<br>
&nbsp;&nbsp;&nbsp;&nbsp;buffer = '';<br>
&nbsp;&nbsp;} catch (error) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// If it's a syntax error and might be due to incomplete input,<br>
&nbsp;&nbsp;&nbsp;&nbsp;// continue collecting input<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (error instanceof SyntaxError && <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;error.message.includes('Unexpected end of input')) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Continue in multi-line mode<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;rl.setPrompt('... ');<br>
&nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// It's a real error, show it and reset buffer<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error('\x1b[31m%s\x1b[0m', 'Error: ' + error.message);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;buffer = '';<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;rl.setPrompt('js> ');<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;// If there's pending input, clear it<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('\nInput cleared');<br>
&nbsp;&nbsp;&nbsp;&nbsp;buffer = '';<br>
&nbsp;&nbsp;&nbsp;&nbsp;rl.setPrompt('js> ');<br>
&nbsp;&nbsp;&nbsp;&nbsp;rl.prompt();<br>
&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Otherwise exit<br>
&nbsp;&nbsp;&nbsp;&nbsp;rl.question('\nAre you sure you want to exit? (y/n) ', (answer) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (answer.toLowerCase() === 'y') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Goodbye!');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;rl.close();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
...
<ol>
  <li><strong>Always close the interface</strong>: Call <code class="w3-codespan">rl.close()</code> when you're done to clean up resources.</li>
  <li><strong>Handle errors</strong>: Implement error handling for all readline operations.</li>
  <li><strong>Use promises</strong>: Wrap callback-based methods in promises for cleaner async code.</li>
  <li><strong>Consider UX</strong>: Provide clear prompts and feedback to users.</li>
  <li><strong>Use event handlers</strong>: Leverage the event-based nature of readline for complex interactions.</li>
  <li><strong>Memory management</strong>: Be careful with large files; process them line by line.</li>
  <li><strong>Add keyboard shortcuts</strong>: Implement handlers for common keyboard shortcuts (Ctrl+C, Ctrl+D).</li>
</ol>

<hr>

<h2>Readline vs. Other Input Methods</h2>
...
<table class="ws-table-all">
  ...
  <tr>
    <td>Readline</td>
    <td>Line-by-line processing, interactive input, history, completion</td>
    <td>More code for complex interfaces</td>
    <td>CLIs, interactive prompts, REPLs</td>
  </tr>
  <tr>
    <td>process.stdin</td>
    <td>Low-level control, raw data</td>
    <td>Harder to use, manual buffering</td>
    <td>Binary input, custom protocols</td>
  </tr>
  <tr>
    <td>Inquirer.js (3rd party)</td>
    <td>Rich UI, many input types, validation</td>
    <td>External dependency</td>
    <td>Complex forms, surveys, config wizards</td>
  </tr>
  <tr>
    <td>Commander.js (3rd party)</td>
    <td>Command definition, option parsing</td>
    <td>Less interactive</td>
    <td>Command-line tools with arguments</td>
  </tr>
</table>
</div>
...
<p>The Node.js Readline module provides a simple yet powerful way to create interactive command-line interfaces, process text input line by line, and build tools that require user interaction.</p>
<p>It's particularly useful for:</p>

<ul>
  <li>Creating interactive command prompts</li>
  <li>Building CLI applications with user input</li>
  <li>Processing files line by line</li>
  <li>Implementing custom REPL environments</li>
  <li>Developing text-based interfaces and games</li>
</ul>

<p>While simple on the surface, combining Readline with promises, event handling, and proper UX considerations allows you to build sophisticated command-line applications that provide a great user experience.</p>

<hr>


<div id="exercisecontainer" src="xrcise_readline.js" data-extensions="asp"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_util.asp">&#10094; Previous</a>
