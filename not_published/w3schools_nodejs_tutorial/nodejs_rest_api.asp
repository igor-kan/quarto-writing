...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js REST API</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js REST API">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_rest_api.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="REST (Representational State Transfer) is an architectural style for designing networked applications that has become the standard for web services.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js REST API">
<meta name="twitter:description" content="REST (Representational State Transfer) is an architectural style for designing networked applications that has become the standard for web services.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_rest_api.png">
...
<h1>Node.js <span class="color_h1">RESTful API</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="nodejs_middleware.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="nodejs_api_auth.asp">Next &#10095;</a>
</div>
<hr>

<h2 id="intro">Understanding RESTful APIs</h2>

<p>REST (Representational State Transfer) is an architectural style for designing networked applications that has become the standard for web services.</p>
<p>RESTful APIs provide a flexible, lightweight way to integrate applications and enable communication between different systems.</p>
<p><strong>Core Concepts:</strong></p>
<ul>
  <li><strong>Resources:</strong> Everything is a resource (user, product, order)</li>
  <li><strong>Representations:</strong> Resources can have multiple representations (JSON, XML, etc.)</li>
  <li><strong>Stateless:</strong> Each request contains all necessary information</li>
  <li><strong>Uniform Interface:</strong> Consistent way to access and manipulate resources</li>
</ul>

<p>RESTful APIs use HTTP requests to perform CRUD operations (Create, Read, Update, Delete) on resources, which are represented as URLs.</p>

<p>REST is stateless, meaning each request from a client to a server must contain all the information needed to understand and process the request.</p>

<div class="w3-panel ws-info">
<p>Unlike SOAP or RPC, REST is not a protocol but an architectural style that leverages existing web standards like HTTP, URI, JSON, and XML.</p>
</div>
<hr>

<h2 id="principles">Core REST Principles</h2>

<p>Understanding these principles is crucial for designing effective RESTful APIs.</p>
<p>They ensure your API is scalable, maintainable, and easy to use.</p>
<p><strong>Key Principles in Practice:</strong></p>
<ul>
  <li><strong>Resource-Based:</strong> Focus on resources rather than actions</li>
  <li><strong>Stateless:</strong> Each request is independent and self-contained</li>
  <li><strong>Cacheable:</strong> Responses define their cacheability</li>
  <li><strong>Uniform Interface:</strong> Consistent resource identification and manipulation</li>
  <li><strong>Layered System:</strong> Client doesn't need to know about the underlying architecture</li>
</ul>
<p>The core principles of REST architecture include:</p>

<ol>
  <li><strong>Client-Server Architecture</strong>: Separation of concerns between the client and the server</li>
  ...
  <li><strong>Layered System</strong>: A client cannot tell whether it is connected directly to the end server</li>
  <li><strong>Uniform Interface</strong>: Resources are identified in requests, resources are manipulated through representations, self-descriptive messages, and HATEOAS (Hypertext As The Engine Of Application State)</li>
</ol>
<hr>

<h2 id="methods">HTTP Methods and Their Usage</h2>

<p>RESTful APIs use standard HTTP methods to perform operations on resources.</p>
<p>Each method has specific semantics and should be used appropriately.</p>
<p><strong>Idempotency and Safety:</strong></p>
<ul>
  <li><strong>Safe Methods:</strong> GET, HEAD, OPTIONS (should not modify resources)</li>
  <li><strong>Idempotent Methods:</strong> GET, PUT, DELETE (multiple identical requests = same effect as one)</li>
  <li><strong>Non-Idempotent:</strong> POST, PATCH (may have different effects with multiple calls)</li>
</ul>
<p>Always use the most specific method that matches your operation's intent.</p>
...
<tr>
  <td>PUT</td>
  <td>Update a resource completely</td>
...
<h3>Example: Using Different HTTP Methods</h3>
<div class="w3-code notranslate jsHigh">
const express = require('express');<br>
const app = express();<br>
<br>
// Middleware for parsing JSON<br>
...
<br>
// GET - Retrieve a specific user<br>
...
<br>
// PUT - Update a user completely<br>
...
<br>
// DELETE - Remove a user<br>
app.delete('/api/users/:id', (req, res) => {<br>
&nbsp;&nbsp;const userIndex = users.findIndex(u => u.id === parseInt(req.params.id));<br>
&nbsp;&nbsp;if (userIndex === -1) return res.status(404).json({ message: 'User not found' });<br>
<br>
&nbsp;&nbsp;const deletedUser = users.splice(userIndex, 1);<br>
&nbsp;&nbsp;res.json(deletedUser[0]);<br>
});<br>
<br>
app.listen(8080, () => {<br>
&nbsp;&nbsp;console.log('REST API server running on port 8080');<br>
});</div>
</div>
<hr>
...
<h2 id="structure">RESTful API Structure and Design</h2>

<p>A well-designed API follows consistent patterns that make it intuitive and easy to use. Good API design is crucial for developer experience and long-term maintainability.</p>
<p><strong>Design Considerations:</strong></p>
<ul>
  <li><strong>Resource Naming:</strong> Use nouns, not verbs (e.g., <code class="w3-codespan">/users</code> not <code class="w3-codespan">/getUsers</code>)</li>
  <li><strong>Pluralization:</strong> Use plural for collections (<code class="w3-codespan">/users/123</code> not <code class="w3-codespan">/user/123</code>)</li>
  <li><strong>Hierarchy:</strong> Nest resources to show relationships (<code class="w3-codespan">/users/123/orders</code>)</li>
  <li><strong>Filtering/Sorting:</strong> Use query parameters for optional operations</li>
  <li><strong>Versioning Strategy:</strong> Plan for API versioning from the start (e.g., <code class="w3-codespan">/v1/users</code> vs <code class="w3-codespan">/v2/users</code>).</li>
</ul>
<p>A well-structured API follows these conventions:</p>

<ul>
  <li><strong>Use nouns for resources</strong>: /users, /products, /orders (not /getUsers)</li>
  <li><strong>Use plurals for collections</strong>: /users instead of /user</li>
  <li><strong>Nest resources for relationships</strong>: /users/123/orders</li>
  <li><strong>Use query parameters for filtering</strong>: /products?category=electronics&min_price=100</li>
  <li><strong>Keep URLs consistent</strong>: Choose a convention (kebab-case, camelCase) and stick to it</li>
</ul>

<div class="w3-example">
<h3>Example: Well-structured API Routes</h3>
<div class="w3-code notranslate jsHigh">
// Good API structure<br>
app.get('/api/products', getProducts);<br>
app.get('/api/products/:id', getProductById);<br>
app.get('/api/products/:id/reviews', getProductReviews);<br>
app.get('/api/users/:userId/orders', getUserOrders);<br>
app.post('/api/orders', createOrder);<br>
<br>
// Filtering and pagination<br>
app.get('/api/products?category=electronics&sort=price&limit=10&page=2');</div>
</div>
<hr>

<h2 id="implementation">Building REST APIs with Node.js and Express</h2>

<p>Node.js with Express.js provides an excellent foundation for building RESTful APIs.</p>
<p>The following sections outline best practices and patterns for implementation.</p>
<p><strong>Key Components:</strong></p>
<ul>
  <li><strong>Express Router:</strong> For organizing routes</li>
  <li><strong>Middleware:</strong> For cross-cutting concerns</li>
  <li><strong>Controllers:</strong> For handling request logic</li>
  <li><strong>Models:</strong> For data access and business logic</li>
  <li><strong>Services:</strong> For complex business logic</li>
</ul>
<p>Express.js is the most popular framework for building REST APIs in Node.js.</p>
...
<div class="w3-example">
<h3>Example: Setting Up Express Router</h3>
<div class="w3-code notranslate jsHigh">
// routes/users.js<br>
const express = require('express');<br>
const router = express.Router();<br>
const { getUsers, getUserById, createUser, updateUser, deleteUser } = require('../controllers/userController');<br>
<br>
router.get('/', getUsers);<br>
...
<br>
app.listen(8080, () => {<br>
&nbsp;&nbsp;console.log('Server is running on port 8080');<br>
});</div>
</div>
<hr>

<h2 id="controllers">Controllers and Models</h2>
<p>Separating concerns between routes, controllers, and models improves code organization and maintainability:</p>

<div class="w3-example">
<h3>Example: Controller Implementation</h3>
<div class="w3-code notranslate jsHigh">
// controllers/userController.js<br>
const User = require('../models/User');<br>
<br>
const getUsers = async (req, res) => {<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const users = await User.findAll();<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.status(200).json(users);<br>
&nbsp;&nbsp;} catch (error) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.status(500).json({ message: 'Error retrieving users', error: error.message });<br>
&nbsp;&nbsp;}<br>
};<br>
<br>
const getUserById = async (req, res) => {<br>
&nbsp;&nbsp;try {<br>
...
&nbsp;&nbsp;} catch (error) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.status(500).json({ message: 'Error retrieving user', error: error.message });<br>
&nbsp;&nbsp;}<br>
};<br>
<br>
const createUser = async (req, res) => {<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const user = await User.create(req.body);<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.status(201).json(user);<br>
&nbsp;&nbsp;} catch (error) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.status(400).json({ message: 'Error creating user', error: error.message });<br>
&nbsp;&nbsp;}<br>
};<br>
<br>
module.exports = { getUsers, getUserById, createUser };</div>
</div>
<hr>

<h2 id="versioning">API Versioning</h2>
<p>Versioning helps you evolve your API without breaking existing clients.</p>
<p>Common approaches include:</p>

<ul>
  <li><strong>URI Path Versioning</strong>: /api/v1/users</li>
  <li><strong>Query Parameter</strong>: /api/users?version=1</li>
  <li><strong>Custom Header</strong>: X-API-Version: 1</li>
  <li><strong>Accept Header</strong>: Accept: application/vnd.myapi.v1+json</li>
</ul>

<div class="w3-example">
<h3>Example: URI Path Versioning</h3>
<div class="w3-code notranslate jsHigh">
const express = require('express');<br>
const app = express();<br>
<br>
// Version 1 routes<br>
const v1UserRoutes = require('./routes/v1/users');<br>
app.use('/api/v1/users', v1UserRoutes);<br>
<br>
// Version 2 routes with new features<br>
const v2UserRoutes = require('./routes/v2/users');<br>
app.use('/api/v2/users', v2UserRoutes);<br>
<br>
app.listen(8080);</div>
</div>
<hr>
...
<p>Always validate incoming requests to ensure data integrity and security.</p>
<p>Libraries like Joi or express-validator can help:</p>

<div class="w3-example">
<h3>Example: Request Validation with Joi</h3>
<div class="w3-code notranslate jsHigh">
const express = require('express');<br>
...
const userSchema = Joi.object({<br>
&nbsp;&nbsp;name: Joi.string().min(3).required(),<br>
&nbsp;&nbsp;email: Joi.string().email().required(),<br>
&nbsp;&nbsp;age: Joi.number().integer().min(18).max(120)<br>
});<br>
<br>
app.post('/api/users', (req, res) => {<br>
&nbsp;&nbsp;// Validate request body<br>
&nbsp;&nbsp;const { error } = userSchema.validate(req.body);<br>
&nbsp;&nbsp;if (error) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;return res.status(400).json({ message: error.details[0].message });<br>
&nbsp;&nbsp;}<br>
<br>
&nbsp;&nbsp;// Process valid request<br>
&nbsp;&nbsp;// ...<br>
...
<p>Implement consistent error handling to provide clear feedback to API consumers:</p>

<div class="w3-example">
<h3>Example: Centralized Error Handling</h3>
<div class="w3-code notranslate jsHigh">
// utils/errorHandler.js<br>
class AppError extends Error {<br>
&nbsp;&nbsp;constructor(statusCode, message) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;super(message);<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.statusCode = statusCode;<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.status = `${statusCode}`.startsWith('4') ? 'fail' : 'error';<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.isOperational = true;<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;Error.captureStackTrace(this, this.constructor);<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
module.exports = { AppError };<br>
<br>
// middleware/errorMiddleware.js<br>
const errorHandler = (err, req, res, next) => {<br>
&nbsp;&nbsp;err.statusCode = err.statusCode || 500;<br>
&nbsp;&nbsp;err.status = err.status || 'error';<br>
<br>
&nbsp;&nbsp;// Different error responses for development and production<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Production: don't leak error details<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (err.isOperational) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;res.status(err.statusCode).json({<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;status: err.status,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;message: err.message<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Programming or unknown errors<br>
...
<br>
module.exports = { errorHandler };<br>
<br>
// Usage in app.js<br>
const { errorHandler } = require('./middleware/errorMiddleware');<br>
const { AppError } = require('./utils/errorHandler');<br>
<br>
// This route throws a custom error<br>
app.get('/api/error-demo', (req, res, next) => {<br>
&nbsp;&nbsp;next(new AppError(404, 'Resource not found'));<br>
});<br>
<br>
// Error handling middleware (must be last)<br>
...
<p>Tools like Swagger/OpenAPI can automatically generate documentation from code:</p>

<div class="w3-example">
<h3>Example: Swagger Documentation</h3>
<div class="w3-code notranslate jsHigh">
const express = require('express');<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;title: 'User API',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;version: '1.0.0',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;description: 'A simple Express User API'<br>
&nbsp;&nbsp;&nbsp;&nbsp;},<br>
&nbsp;&nbsp;&nbsp;&nbsp;servers: [<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;url: 'http://localhost:8080',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;description: 'Development server'<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;]<br>
&nbsp;&nbsp;},<br>
&nbsp;&nbsp;apis: ['./routes/*.js'] // Path to the API routes folders<br>
};<br>
<br>
const swaggerDocs = swaggerJsDoc(swaggerOptions);<br>
app.use('/api-docs', swaggerUi.serve, swaggerUi.setup(swaggerDocs));<br>
<br>
/**<br>
 * @swagger<br>
 * /api/users:<br>
...
<h2 id="testing">Testing APIs</h2>
<p>Testing is critical for API reliability.</p>
<p>Use libraries like Jest, Mocha, or Supertest:</p>

<div class="w3-example">
<h3>Example: API Testing with Jest and Supertest</h3>
<div class="w3-code notranslate jsHigh">
// tests/users.test.js<br>
const request = require('supertest');<br>
const app = require('../app');<br>
<br>
describe('User API', () => {<br>
&nbsp;&nbsp;describe('GET /api/users', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;it('should return all users', async () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const res = await request(app).get('/api/users');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;expect(res.statusCode).toBe(200);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;expect(Array.isArray(res.body)).toBeTruthy();<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;describe('POST /api/users', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;it('should create a new user', async () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const userData = {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;name: 'Test User',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;email: 'test@example.com'<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;};<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const res = await request(app)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;.post('/api/users')<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;.send(userData);<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;expect(res.statusCode).toBe(201);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;expect(res.body).toHaveProperty('id');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;expect(res.body.name).toBe(userData.name);<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;it('should validate request data', async () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const invalidData = {<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;.send(invalidData);<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;expect(res.statusCode).toBe(400);<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;});<br>
});</div>
</div>
...
<ul>
  <li><strong>Follow REST principles</strong> and use appropriate HTTP methods</li>
  <li><strong>Use consistent naming conventions</strong> for endpoints</li>
  <li><strong>Structure your API logically</strong> with resource-based URLs</li>
  <li><strong>Return appropriate status codes</strong> in responses</li>
  <li><strong>Implement proper error handling</strong> with clear messages</li>
  <li><strong>Use pagination</strong> for large data sets</li>
  <li><strong>Version your API</strong> to maintain backward compatibility</li>
  <li><strong>Validate all input</strong> to prevent security issues</li>
  <li><strong>Document your API</strong> thoroughly</li>
  <li><strong>Write comprehensive tests</strong> to ensure reliability</li>
  <li><strong>Use HTTPS</strong> for all production APIs</li>
  <li><strong>Implement rate limiting</strong> to prevent abuse</li>
</ul>
<hr>
<div id="exercisecontainer" src="xrcise_rest_api.js" data-extensions="asp"></div>
<hr>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="nodejs_middleware.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="nodejs_api_auth.asp">Next &#10095;</a>
