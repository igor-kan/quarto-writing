...
<meta name="title" property="og:title" content="Node.js DNS Module">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_dns.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="The DNS (Domain Name System) module provides functionality for name resolution in Node.js.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js DNS Module">
<meta name="twitter:description" content="The DNS (Domain Name System) module provides functionality for name resolution in Node.js.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_dns.png">
...
<a class="w3-left w3-btn" href="nodejs_timers.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="nodejs_assert.asp">Next &#10095;</a>
</div>

<hr>
<h2>Introduction to the DNS Module</h2>

<p>The DNS (Domain Name System) module provides functionality for name resolution in Node.js.</p>
<p>It offers two main APIs:</p>

<ol>
  <li><strong>Callback-based API</strong>: Traditional Node.js style with callback functions</li>
  <li><strong>Promise-based API</strong>: Modern async/await support via <code class="w3-codespan">dns.promises</code></li>
</ol>

<p>Key features include:</p>
<ul>
  <li>Resolving domain names to IP addresses (A/AAAA records)</li>
  <li>Performing reverse DNS lookups (PTR records)</li>
  <li>Querying various DNS record types (MX, TXT, SRV, etc.)</li>
  <li>Creating custom DNS resolvers with specific settings</li>
  <li>Configuring DNS server settings programmatically</li>
</ul>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> The DNS module can operate in two distinct modes - using the operating system's facilities or performing direct network DNS queries.</p>
<p>This affects how hostname resolution works in your application.</p>
</div>

<hr>

<h2>Getting Started with DNS</h2>

<p>Here's a quick example of using the DNS module to look up a domain's IP address:</p>

<div class="w3-example">
<h3>Basic DNS Lookup</h3>
<div class="w3-code notranslate jsHigh">const dns = require('dns');<br>
<br>
// Look up a domain name<br>
dns.lookup('example.com', (err, address, family) => {<br>
&nbsp;&nbsp;if (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error('Lookup error:', err);<br>
&nbsp;&nbsp;&nbsp;&nbsp;return;<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;console.log(`IP address: ${address}`);<br>
&nbsp;&nbsp;console.log(`IP version: IPv${family}`);<br>
});</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_dns_quickstart">Run example &raquo;</a>
</div>

<hr>
<h2>Importing and Setup</h2>

<p>To use the DNS module, you can import it in your Node.js application using either the callback or promise-based API:</p>

<div class="w3-example">
<h3>Callback-based API</h3>
<div class="w3-code notranslate jsHigh">// Import the DNS module<br>const dns = require('dns');<br>
<br>// Example usage<br>dns.lookup('example.com', (err, address, family) => {<br>&nbsp;&nbsp;if (err) throw err;<br>&nbsp;&nbsp;console.log(`Resolved: ${address} (IPv${family})`);<br>});</div>
</div>

<div class="w3-example">
<h3>Promise-based API (Node.js 10.0.0+)</h3>
<div class="w3-code notranslate jsHigh">// Import the promises API<br>const { promises: dns } = require('dns');<br>
// Or: const dns = require('dns').promises;<br>
// Example with async/await<br>async function lookupDomain(domain) {<br>&nbsp;&nbsp;try {<br>&nbsp;&nbsp;&nbsp;&nbsp;const address = await dns.lookup(domain);<br>&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Resolved: ${address.address} (IPv${address.family})`);<br>&nbsp;&nbsp;} catch (err) {<br>&nbsp;&nbsp;&nbsp;&nbsp;console.error('Lookup failed:', err);<br>&nbsp;&nbsp;}<br>}<br>
lookupDomain('example.com');</div>
</div>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> The promise-based API is generally preferred for new code as it works better with modern async/await patterns and provides better error handling.</p>
</div>

<hr>

<h2>Basic DNS Lookups</h2>

<p>The DNS module provides several methods for looking up domain names and IP addresses. The most common operations are:</p>

<ul>
  <li><code class="w3-codespan">dns.lookup()</code>: Uses the operating system's facilities to resolve hostnames</li>
  <li><code class="w3-codespan">dns.resolve*()</code>: Performs DNS queries directly to name servers</li>
  <li><code class="w3-codespan">dns.reverse()</code>: Performs reverse DNS lookups (IP to hostname)</li>
</ul>

<h3>Resolving Domain Names to IP Addresses</h3>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">const dns = require('dns');<br>
<br>
// Callback-based API<br>
dns.lookup('www.example.com', (err, address, family) => {<br>
&nbsp;&nbsp;if (err) throw err;<br>
&nbsp;&nbsp;console.log('IP address: %s', address);<br>
&nbsp;&nbsp;console.log('IP version: IPv%s', family);<br>
});</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_dns_lookup">Run example &raquo;</a>
</div>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">const dns = require('dns').promises;<br>
<br>
// Promise-based API<br>
async function lookupExample() {<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const result = await dns.lookup('www.example.com');<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('IP address:', result.address);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('IP version: IPv' + result.family);<br>
&nbsp;&nbsp;} catch (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error('Lookup failed:', err);<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
lookupExample();</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_dns_promises_lookup">Run example &raquo;</a>
</div>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> The <code class="w3-codespan">dns.lookup()</code> method uses the operating system's facilities for name resolution and does not necessarily perform any network communication.</p>
</div>

<h3>Looking Up All IP Addresses for a Domain</h3>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">const dns = require('dns');<br>
<br>
// Get all IPv4 addresses<br>
dns.resolve4('www.google.com', (err, addresses) => {<br>
&nbsp;&nbsp;if (err) throw err;<br>
<br>
&nbsp;&nbsp;console.log('IPv4 addresses:');<br>
&nbsp;&nbsp;addresses.forEach(address => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`  ${address}`);<br>
&nbsp;&nbsp;});<br>
<br>  
// Perform a reverse lookup on the first IP<br>
&nbsp;&nbsp;dns.reverse(addresses[0], (err, hostnames) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (err) throw err;<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Reverse lookup for ${addresses[0]}:`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;hostnames.forEach(hostname => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`  ${hostname}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;});<br>
});</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_dns_resolve4">Run example &raquo;</a>
</div>
...
<p>The DNS module supports lookups for various DNS record types:</p>
...
<table class="ws-table-all">
  ...
  <tr>
    <td><code class="w3-codespan">resolve4()</code></td>
    <td>A</td>
    <td>IPv4 addresses</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">resolve6()</code></td>
    <td>AAAA</td>
    <td>IPv6 addresses</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">resolveMx()</code></td>
    <td>MX</td>
    <td>Mail exchange records</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">resolveTxt()</code></td>
    <td>TXT</td>
    <td>Text records</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">resolveSrv()</code></td>
    <td>SRV</td>
    <td>Service records</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">resolveNs()</code></td>
    <td>NS</td>
    <td>Name server records</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">resolveCname()</code></td>
    <td>CNAME</td>
    <td>Canonical name records</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">resolveSoa()</code></td>
    <td>SOA</td>
    <td>Start of authority records</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">resolvePtr()</code></td>
    <td>PTR</td>
    <td>Pointer records</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">resolveNaptr()</code></td>
    <td>NAPTR</td>
    <td>Name authority pointer records</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">resolveAny()</code></td>
    <td>ANY</td>
    <td>Any records</td>
  </tr>
</table>
...
<h2>Advanced DNS Operations</h2>

<h3>1. Custom DNS Resolution</h3>

<p>Create a custom DNS resolver with specific settings for more control over DNS lookups:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">const dns = require('dns');<br>
<br>
// Create a new resolver<br>
const resolver = new dns.Resolver();<br>
<br>
// Set custom server (Google's public DNS)<br>
resolver.setServers(['8.8.8.8', '8.8.4.4']);<br>
<br>
// Use the custom resolver<br>
resolver.resolve4('www.example.com', (err, addresses) => {<br>
&nbsp;&nbsp;if (err) throw err;<br>
<br>
&nbsp;&nbsp;console.log('Addresses resolved using Google DNS:');<br>
&nbsp;&nbsp;addresses.forEach(addr => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`  ${addr}`);<br>
&nbsp;&nbsp;});<br>
});<br>
<br>
// See what servers are configured<br>
console.log('Current resolver servers:', resolver.getServers());</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_dns_resolver">Run example &raquo;</a>
</div>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> Creating a custom resolver is useful when you want to use specific DNS servers instead of the system's defaults, or when you need different settings for different lookups.</p>
</div>

<hr>

<h3>2. Network vs. Operating System Level Resolution</h3>

<p>The DNS module offers two different approaches to name resolution:</p>
...
<table class="ws-table-all">
  ...
  <tr>
    <td><code class="w3-codespan">dns.lookup()</code></td>
    <td>Uses <code class="w3-codespan">getaddrinfo()</code> system call</td>
    <td>No direct network calls</td>
    <td>Follows local configuration (hosts file, etc.)</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">dns.resolve*(), dns.reverse()</code></td>
    <td>Makes actual network requests</td>
    <td>Always connects to DNS servers</td>
    <td>Bypasses local configuration, direct DNS queries</td>
  </tr>
</table>
</div>

<div class="w3-panel ws-warning">
<p><strong>Warning:</strong> Due to these differences, the results from <code class="w3-codespan">dns.lookup()</code> and <code class="w3-codespan">dns.resolve*()</code> methods may not always match, especially in environments with custom host configurations.</p>
</div>
...
<p>Robust DNS handling requires proper error management. Here's how to handle common DNS errors and implement retry logic:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">const dns = require('dns');<br>
<br>
function lookupWithErrorHandling(domain) {<br>
&nbsp;&nbsp;dns.lookup(domain, (err, address, family) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error(`DNS lookup failed for ${domain}`);<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Check specific error codes<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; switch (err.code) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; case 'ENOTFOUND':<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; console.error('  Domain name not found');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; break;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; case 'ETIMEDOUT':<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; console.error('  DNS lookup timed out');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; break;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; case 'ENODATA':<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; console.error('  Domain exists but no data of requested type');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; break;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; case 'ESERVFAIL':<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; console.error('  DNS server returned general failure');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; break;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; default:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; console.error(`  Error code: ${err.code}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; }<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; return;<br>
&nbsp;&nbsp;&nbsp;&nbsp; }<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp; console.log(`DNS lookup successful for ${domain}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp; console.log(`  IP address: ${address}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp; console.log(`  IP version: IPv${family}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp; });<br>
}<br>
<br>
// Test with valid and invalid domains<br>
lookupWithErrorHandling('www.google.com');<br>
lookupWithErrorHandling('this-domain-does-not-exist-123456789.com');</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_dns_errors">Run example &raquo;</a>
</div>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> DNS errors can be temporary due to network issues or DNS propagation delays.</p>
<p>In production applications, you might want to implement retry logic with exponential backoff.</p>
</div>
...
<p>DNS lookups can be a performance bottleneck in applications. Here are strategies to optimize DNS resolution:</p>

<h3>1. Caching</h3>
<p>Implement a simple DNS cache to avoid repeated lookups for the same domain:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">const dns = require('dns');<br>const util = require('util');<br>
const lookup = util.promisify(dns.lookup);<br>
const dnsCache = new Map();<br>
async function cachedLookup(domain) {<br>&nbsp;&nbsp;if (dnsCache.has(domain)) {<br>&nbsp;&nbsp;&nbsp;&nbsp;console.log('Cache hit for:', domain);<br>&nbsp;&nbsp;&nbsp;&nbsp;return dnsCache.get(domain);<br>&nbsp;&nbsp;}<br>
&nbsp;&nbsp;console.log('Cache miss for:', domain);<br>&nbsp;&nbsp;const result = await lookup(domain);<br>&nbsp;&nbsp;dnsCache.set(domain, result);<br>&nbsp;&nbsp;return result;<br>}<br>
// Example usage<br>(async () => {<br>&nbsp;&nbsp;const domains = ['google.com', 'facebook.com', 'google.com'];<br>&nbsp;&nbsp;for (const domain of domains) {<br>&nbsp;&nbsp;&nbsp;&nbsp;const result = await cachedLookup(domain);<br>&nbsp;&nbsp;&nbsp;&nbsp;console.log(`${domain} → ${result.address}`);<br>&nbsp;&nbsp;}<br>})();</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_dns_cache">Run example &raquo;</a>
</div>

<h3>2. Parallel Lookups</h3>
<p>Use <code class="w3-codespan">Promise.all()</code> to perform multiple DNS lookups in parallel:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">const dns = require('dns').promises;<br>
async function lookupMultiple(domains) {<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const lookups = domains.map(domain => dns.lookup(domain));<br>
&nbsp;&nbsp;&nbsp;&nbsp;const results = await Promise.all(lookups);<br>
&nbsp;&nbsp;&nbsp;&nbsp;return domains.map((domain, i) => ({<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;domain,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;...results[i]<br>
&nbsp;&nbsp;&nbsp;&nbsp;}));<br>
&nbsp;&nbsp;} catch (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error('One or more lookups failed:', err);<br>
&nbsp;&nbsp;&nbsp;&nbsp;throw err;<br>
&nbsp;&nbsp;}<br>
}<br>
// Example usage<br>
lookupMultiple(['google.com', 'facebook.com', 'github.com'])<br>
&nbsp;&nbsp;.then(results => console.log(results))<br>
&nbsp;&nbsp;.catch(console.error);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_dns_parallel">Run example &raquo;</a>
</div>

<h3>3. Custom Resolvers and Timeouts</h3>
<p>Configure custom DNS servers and timeouts for better control:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">const dns = require('dns');<br>
const { Resolver } = dns;<br>
<br>
// Create a custom resolver with timeout<br>
const resolver = new Resolver();<br>
resolver.setServers(['8.8.8.8', '1.1.1.1']); // Google and Cloudflare DNS<br>
// Set timeout for all operations (in ms)<br>
const TIMEOUT = 2000;<br>
async function resolveWithTimeout(domain, rrtype = 'A') {<br>
&nbsp;&nbsp;return new Promise((resolve, reject) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const timer = setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;reject(new Error(`DNS query timed out after ${TIMEOUT}ms`));<br>
&nbsp;&nbsp;&nbsp;&nbsp;}, TIMEOUT);<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;resolver.resolve(domain, rrtype, (err, addresses) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;clearTimeout(timer);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (err) return reject(err);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;resolve(addresses);<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;});<br>
}<br>
// Example usage<br>
resolveWithTimeout('example.com')<br>
&nbsp;&nbsp;.then(console.log)<br>
&nbsp;&nbsp;.catch(console.error);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_dns_custom_resolver">Run example &raquo;</a>
</div>
<hr>

<h2>DNS Module vs. Third-Party DNS Libraries</h2>

<div class="w3-container w3-responsive">
<table class="ws-table-all">
  <tr>
    <th>Feature</th>
    <th>Node.js DNS Module</th>
  ...
  <tr>
    <td>Feature set</td>
    <td>Basic DNS operations</td>
    <td>Often more comprehensive</td>
  </tr>
  <tr>
    <td>Caching</td>
    <td>Not built-in</td>
    <td>Often includes caching</td>
  </tr>
  <tr>
    <td>Advanced features</td>
    <td>Limited</td>
    <td>May include DNSSEC, DoH, DoT support</td>
  </tr>
  <tr>
    <td>Performance</td>
    <td>Good for basic use</td>
    <td>May be optimized for specific use cases</td>
  </tr>
</table>
</div>

<p>Popular third-party DNS libraries for Node.js include:</p>
<ul>
  <li><code class="w3-codespan">dns-packet</code>: Low-level DNS packet encoding/decoding</li>
  <li><code class="w3-codespan">native-dns</code>: More complete DNS implementation</li>
  <li><code class="w3-codespan">dns2</code>: Modern DNS library with promise support</li>
</ul>
...
<p>The Node.js DNS module provides essential functionality for interacting with the Domain Name System. Key features include:</p>

<ul>
  <li>Looking up IP addresses for domain names</li>
  <li>Resolving various DNS record types (A, AAAA, MX, TXT, etc.)</li>
  <li>Performing reverse DNS lookups</li>
  <li>Creating custom resolvers with specific settings</li>
  <li>Both callback-based and promise-based APIs</li>
</ul>

<p>Understanding the DNS module is crucial for applications that need to interact with network resources by domain name, implement custom name resolution logic, or verify domain-related information.</p>

<hr>
<div id="exercisecontainer" src="xrcise_dns.js" data-extensions="asp"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_timers.asp">&#10094; Previous</a>
