...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Hash Reference</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js Hash Reference">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/ref_hash.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="The Hash class is part of Node.js's crypto module. It provides a way to create cryptographic hash digests of data.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Hash Reference">
<meta name="twitter:description" content="The Hash class is part of Node.js's crypto module. It provides a way to create cryptographic hash digests of data.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/ref_hash.png">
...
<h1>Node.js Hash Reference</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="ref_ecdh.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ref_hmac.asp">Next &#10095;</a>
</div>
...
<p>The Hash class is part of Node.js's <code class="w3-codespan">crypto</code> module. It provides a way to create cryptographic hash digests of data. Hash instances are created using the <code class="w3-codespan">crypto.createHash()</code> method.</p>

<p>Hash functions are one-way functions that map data of arbitrary size to a fixed-size value called a digest. They are designed to be fast to compute but practically impossible to reverse.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_hash_import">Run example &raquo;</a>
</div>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td>hash.update(data[, inputEncoding])</td>
    <td>Updates the hash content with the given <code class="w3-codespan">data</code>. If <code class="w3-codespan">inputEncoding</code> is provided, <code class="w3-codespan">data</code> is a string using the specified encoding; otherwise, <code class="w3-codespan">data</code> is a Buffer, TypedArray, or DataView. This method can be called multiple times with new data.</td>
  </tr>
  <tr>
    <td>hash.digest([encoding])</td>
    <td>Calculates the digest of all the data passed to the hash using <code class="w3-codespan">hash.update()</code>. If <code class="w3-codespan">encoding</code> is provided, a string is returned; otherwise, a Buffer is returned. After this method is called, the Hash object can no longer be used.</td>
  </tr>
  <tr>
    <td>hash.copy()</td>
    <td>Creates a new Hash object that contains a deep copy of the internal state of the current Hash object. This is useful when you want to generate multiple hashes based on the same partial data.</td>
  </tr>
</table>
...
<p>Node.js supports many hash algorithms. You can get a list of all supported algorithms with:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const crypto = require('crypto');<br>
<br>
// Get all supported hash algorithms<br>
console.log(crypto.getHashes());
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_hash_algorithms">Run example &raquo;</a>
</div>
...
<table class="ws-table-all">
  ...
  <tr>
    ...
    <td>Fast, but cryptographically broken</td>
    <td>Only for non-security purposes (e.g., checksums)</td>
  </tr>
  <tr>
    <td>sha1</td>
    <td>160 bits (20 bytes)</td>
    <td>Fast, but cryptographically broken</td>
    <td>Only for non-security purposes</td>
  </tr>
  <tr>
    <td>sha256</td>
    <td>256 bits (32 bytes)</td>
    <td>Part of SHA-2 family</td>
    <td>General cryptographic use</td>
  </tr>
  <tr>
    <td>sha512</td>
  ...
  <tr>
    <td>sha3-256</td>
    <td>256 bits (32 bytes)</td>
    <td>Part of SHA-3 family</td>
    <td>Modern cryptographic applications</td>
  </tr>
  <tr>
    <td>sha3-512</td>
    <td>512 bits (64 bytes)</td>
...
<h2>Basic Hash Example</h2>

<p>The following example demonstrates how to create a hash digest of a string:</p>
...
hash.update(data);<br>
<br>
// Get the digest in hex format<br>
const digest = hash.digest('hex');<br>
<br>
console.log('Data:', data);<br>
console.log('SHA-256 Hash:', digest);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_hash_basic">Run example &raquo;</a>
</div>

<hr>

<h2>Comparing Different Hash Algorithms</h2>

<p>This example compares different hash algorithms:</p>
...
<br>
// Data to hash<br>
const data = 'Node.js Crypto Hash Example';<br>
<br>
// Function to hash data with different algorithms<br>
function hashWithAlgorithm(algorithm, data) {<br>
&nbsp;&nbsp;const hash = crypto.createHash(algorithm);<br>
&nbsp;&nbsp;hash.update(data);<br>
&nbsp;&nbsp;return hash.digest('hex');<br>
}<br>
<br>
// Test various hash algorithms<br>
const algorithms = ['md5', 'sha1', 'sha256', 'sha512', 'sha3-256', 'sha3-512'];<br>
<br>
console.log(`Data: "${data}"`);<br>
console.log('------------------------------------');<br>
<br>
algorithms.forEach(algorithm => {<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const digest = hashWithAlgorithm(algorithm, data);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`${algorithm}: ${digest}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Length: ${digest.length / 2} bytes (${digest.length * 4} bits)`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('------------------------------------');<br>
&nbsp;&nbsp;} catch (error) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`${algorithm}: Not supported - ${error.message}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('------------------------------------');<br>
&nbsp;&nbsp;}<br>
});
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_hash_compare">Run example &raquo;</a>
</div>

<hr>

<h2>Hashing with Multiple Updates</h2>

<p>You can update a hash with multiple pieces of data before calculating the digest:</p>
...
const hash = crypto.createHash('sha256');<br>
<br>
// Update the hash with multiple pieces of data<br>
hash.update('First part of the data.');<br>
hash.update(' Second part of the data.');<br>
hash.update(' Third part of the data.');<br>
<br>
// Calculate the final digest<br>
const digest = hash.digest('hex');<br>
<br>
console.log('Combined data: First part of the data. Second part of the data. Third part of the data.');<br>
console.log('SHA-256 Hash:', digest);<br>
<br>
// You can achieve the same result with a single update<br>
const singleHash = crypto.createHash('sha256');<br>
singleHash.update('First part of the data. Second part of the data. Third part of the data.');<br>
const singleDigest = singleHash.digest('hex');<br>
<br>
console.log('Single update hash matches multiple updates?', singleDigest === digest);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_hash_multiple">Run example &raquo;</a>
</div>

<hr>

<h2>Hash with Different Encodings</h2>

<p>You can get a hash digest in different encodings:</p>
...
<br>
// Data to hash<br>
const data = 'Hello, Node.js!';<br>
<br>
// Function to hash data and get digest in different encodings<br>
function hashWithEncoding(algorithm, data, encoding) {<br>
&nbsp;&nbsp;const hash = crypto.createHash(algorithm);<br>
&nbsp;&nbsp;hash.update(data);<br>
&nbsp;&nbsp;return hash.digest(encoding);<br>
}<br>
<br>
// Hash the data with SHA-256 and display in different encodings<br>
console.log(`Data: "${data}"`);<br>
console.log(`SHA-256 (hex): ${hashWithEncoding('sha256', data, 'hex')}`);<br>
console.log(`SHA-256 (base64): ${hashWithEncoding('sha256', data, 'base64')}`);<br>
console.log(`SHA-256 (base64url): ${hashWithEncoding('sha256', data, 'base64url')}`);<br>
console.log(`SHA-256 (binary): ${hashWithEncoding('sha256', data, 'binary')}`);<br>
<br>
// Get the digest as a Buffer (no encoding)<br>
const hash = crypto.createHash('sha256');<br>
hash.update(data);<br>
const buffer = hash.digest();<br>
console.log('SHA-256 (Buffer):', buffer);<br>
console.log('Buffer length:', buffer.length, 'bytes');
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_hash_encodings">Run example &raquo;</a>
</div>
...
<p>You can hash the contents of a file:</p>
...
<br>
// Function to hash a file using streams<br>
function hashFile(filePath, algorithm) {<br>
&nbsp;&nbsp;return new Promise((resolve, reject) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Create hash object<br>
&nbsp;&nbsp;&nbsp;&nbsp;const hash = crypto.createHash(algorithm);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;stream.on('error', (error) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;reject(error);<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;});<br>
}<br>
<br>
// Example usage (adjust file path as needed)<br>
const filePath = 'example.txt';<br>
<br>
// Create a test file if it doesn't exist<br>
if (!fs.existsSync(filePath)) {<br>
&nbsp;&nbsp;fs.writeFileSync(filePath, 'This is a test file for hashing.\n'.repeat(100));<br>
&nbsp;&nbsp;console.log(`Created test file: ${filePath}`);<br>
}<br>
<br>
// Hash the file with different algorithms<br>
Promise.all([<br>
&nbsp;&nbsp;hashFile(filePath, 'md5'),<br>
&nbsp;&nbsp;hashFile(filePath, 'sha1'),<br>
&nbsp;&nbsp;hashFile(filePath, 'sha256')<br>
])<br>
.then(([md5Digest, sha1Digest, sha256Digest]) => {<br>
&nbsp;&nbsp;console.log(`File: ${filePath}`);<br>
&nbsp;&nbsp;console.log(`MD5: ${md5Digest}`);<br>
&nbsp;&nbsp;console.log(`SHA-1: ${sha1Digest}`);<br>
&nbsp;&nbsp;console.log(`SHA-256: ${sha256Digest}`);<br>
})<br>
.catch(error => {<br>
&nbsp;&nbsp;console.error('Error hashing file:', error.message);<br>
});
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_hash_file">Run example &raquo;</a>
</div>

<hr>

<h2>Using hash.copy()</h2>

<p>The <code class="w3-codespan">hash.copy()</code> method allows you to create a copy of a hash object:</p>
...
const hash = crypto.createHash('sha256');<br>
<br>
// Update with common data<br>
hash.update('Common prefix data');<br>
<br>
// Create a copy<br>
const hashCopy = hash.copy();<br>
<br>
// Update the original hash with more data<br>
hash.update(' with additional data for original');<br>
const originalDigest = hash.digest('hex');<br>
<br>
// Update the copy with different data<br>
hashCopy.update(' with different data for copy');<br>
const copyDigest = hashCopy.digest('hex');<br>
<br>
console.log('Original hash:', originalDigest);<br>
console.log('Copy hash:', copyDigest);<br>
console.log('Are they different?', originalDigest !== copyDigest);<br>
<br>
// This is useful when you want to create multiple hash variations<br>
// from a common starting point, without recalculating the common portion
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_hash_copy">Run example &raquo;</a>
</div>

<hr>

<h2>Hash Performance Comparison</h2>

<p>This example compares the performance of different hash algorithms:</p>
...
<br>
// Data to hash (1MB of random data)<br>
const data = crypto.randomBytes(1024 * 1024);<br>
<br>
// Function to measure hash algorithm performance<br>
function measureHashPerformance(algorithm, iterations = 100) {<br>
&nbsp;&nbsp;// Ensure the algorithm is supported<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;crypto.createHash(algorithm);<br>
&nbsp;&nbsp;} catch (error) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;return { algorithm, error: error.message };<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
...
&nbsp;&nbsp;const totalTime = endTime - startTime;<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;return {<br>
&nbsp;&nbsp;&nbsp;&nbsp;algorithm,<br>
&nbsp;&nbsp;&nbsp;&nbsp;iterations,<br>
&nbsp;&nbsp;&nbsp;&nbsp;totalTimeMs: totalTime.toFixed(2),<br>
&nbsp;&nbsp;&nbsp;&nbsp;timePerHashMs: (totalTime / iterations).toFixed(4),<br>
&nbsp;&nbsp;&nbsp;&nbsp;hashesPerSecond: Math.floor(iterations / (totalTime / 1000))<br>
&nbsp;&nbsp;};<br>
}<br>
<br>
// Test various hash algorithms<br>
...
const results = [];<br>
<br>
console.log('Measuring hash performance for 1MB of data...');<br>
<br>
algorithms.forEach(algorithm => {<br>
&nbsp;&nbsp;results.push(measureHashPerformance(algorithm));<br>
});<br>
<br>
// Display results in a table format<br>
console.table(results);<br>
<br>
// Display relative performance (normalized to the fastest algorithm)<br>
console.log('\nRelative Performance:');<br>
<br>
// Find the fastest algorithm<br>
const fastest = results.reduce((prev, current) => {<br>
&nbsp;&nbsp;if (current.error) return prev;<br>
&nbsp;&nbsp;return (prev && prev.hashesPerSecond > current.hashesPerSecond) ? prev : current;<br>
}, null);<br>
<br>
if (fastest) {<br>
&nbsp;&nbsp;results.forEach(result => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (!result.error) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const relativeSpeed = (result.hashesPerSecond / fastest.hashesPerSecond).toFixed(2);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`${result.algorithm}: ${relativeSpeed}x (${result.hashesPerSecond} hashes/sec)`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`${result.algorithm}: Error - ${result.error}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;});<br>
}
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_hash_performance">Run example &raquo;</a>
</div>
...
<div class="w3-panel ws-warning">
  <p><strong>Warning:</strong> The following example demonstrates password hashing with general-purpose hash functions. For secure password storage, use specialized algorithms like bcrypt, scrypt, or Argon2, which are specifically designed for password hashing and include salt and work factors.</p>
</div>

<p>This example shows how to hash passwords with a salt:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const crypto = require('crypto');<br>
<br>
// Function to hash a password with a salt<br>
function hashPassword(password, salt) {<br>
&nbsp;&nbsp;// Create hash object<br>
&nbsp;&nbsp;const hash = crypto.createHash('sha256');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Update with salt and password<br>
&nbsp;&nbsp;hash.update(salt);<br>
...
function generateSalt() {<br>
&nbsp;&nbsp;return crypto.randomBytes(16).toString('hex');<br>
}<br>
<br>
// Example usage<br>
const password = 'mySecurePassword123';<br>
<br>
// For a new user, generate a salt and hash the password<br>
const salt = generateSalt();<br>
const hashedPassword = hashPassword(password, salt);<br>
<br>
console.log('Password:', password);<br>
console.log('Salt:', salt);<br>
console.log('Hashed Password:', hashedPassword);<br>
<br>
// To verify a password, hash it with the same salt and compare<br>
function verifyPassword(password, salt, storedHash) {<br>
&nbsp;&nbsp;const hash = hashPassword(password, salt);<br>
&nbsp;&nbsp;return hash === storedHash;<br>
}<br>
<br>
// Check correct password<br>
console.log('Verification with correct password:', <br>
&nbsp;&nbsp;verifyPassword(password, salt, hashedPassword));<br>
<br>
// Check incorrect password<br>
console.log('Verification with incorrect password:', <br>
&nbsp;&nbsp;verifyPassword('wrongPassword', salt, hashedPassword));<br>
<br>
// Note: For production, use crypto.pbkdf2, bcrypt, scrypt, or Argon2 instead
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_hash_password">Run example &raquo;</a>
</div>

<h3>Better Password Hashing with crypto.pbkdf2</h3>

<p>A more secure approach to password hashing using PBKDF2:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const crypto = require('crypto');<br>
<br>
// Secure password hashing with PBKDF2<br>
function hashPasswordSecure(password, salt, iterations = 100000) {<br>
&nbsp;&nbsp;return new Promise((resolve, reject) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;crypto.pbkdf2(<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;password,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;salt,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;iterations,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;64,&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Key length in bytes<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'sha512', // Hash function<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(err, derivedKey) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (err) reject(err);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;resolve(derivedKey.toString('hex'));<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;);<br>
&nbsp;&nbsp;});<br>
}<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;// For a new user, generate a salt and hash the password<br>
&nbsp;&nbsp;&nbsp;&nbsp;const salt = generateSalt();<br>
&nbsp;&nbsp;&nbsp;&nbsp;const iterations = 100000; // Higher is more secure but slower<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Password:', password);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Salt:', salt);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Iterations:', iterations);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;const hashedPassword = await hashPasswordSecure(password, salt, iterations);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Hashed Password:', hashedPassword);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// To verify a password<br>
&nbsp;&nbsp;&nbsp;&nbsp;const verifyCorrect = await hashPasswordSecure(password, salt, iterations) === hashedPassword;<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Verification with correct password:', verifyCorrect);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;const verifyWrong = await hashPasswordSecure('wrongPassword', salt, iterations) === hashedPassword;<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Verification with incorrect password:', verifyWrong);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// For storage, you would save: salt, iterations, and hashedPassword<br>
&nbsp;&nbsp;} catch (error) {<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_hash_password_secure">Run example &raquo;</a>
</div>
...
<p>Hash collisions occur when two different inputs produce the same hash value. This example demonstrates how to check for hash collisions:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const crypto = require('crypto');<br>
<br>
// Function to generate random string<br>
function generateRandomString(length) {<br>
&nbsp;&nbsp;return crypto.randomBytes(length).toString('hex').substring(0, length);<br>
}<br>
<br>
// Function to find a partial hash collision (first few characters match)<br>
function findPartialCollision(targetLength) {<br>
&nbsp;&nbsp;const hashMap = new Map();<br>
&nbsp;&nbsp;let attempts = 0;<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;console.log(`Searching for partial SHA-256 collisions (first ${targetLength} characters)...`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;while (true) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;attempts++;<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Generate a random input<br>
&nbsp;&nbsp;&nbsp;&nbsp;const input = generateRandomString(8);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Hash the input<br>
&nbsp;&nbsp;&nbsp;&nbsp;const hash = crypto.createHash('sha256').update(input).digest('hex');<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Get the target portion of the hash<br>
&nbsp;&nbsp;&nbsp;&nbsp;const targetPortion = hash.substring(0, targetLength);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Check if we've seen this target portion before<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (hashMap.has(targetPortion)) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const previousInput = hashMap.get(targetPortion);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Found a collision after ${attempts} attempts!`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Input 1: "${previousInput}"`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Input 2: "${input}"`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`SHA-256 (Input 1): ${crypto.createHash('sha256').update(previousInput).digest('hex')}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`SHA-256 (Input 2): ${hash}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Both hashes start with: ${targetPortion}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;attempts,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;input1: previousInput,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;input2: input,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;collidingPrefix: targetPortion<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;};<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Store this hash<br>
&nbsp;&nbsp;&nbsp;&nbsp;hashMap.set(targetPortion, input);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Show progress<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (attempts % 100000 === 0) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Checked ${attempts} values, ${hashMap.size} unique prefixes found...`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Safety limit<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (attempts >= 1000000) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Reached attempt limit without finding a collision.');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;break;<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;return { attempts, collisionFound: false };<br>
}<br>
<br>
// Find a collision for the first few characters (increase for more challenge)<br>
findPartialCollision(4);<br>
<br>
// Note: Finding a full collision for SHA-256 is computationally infeasible<br>
// This example only demonstrates partial collisions
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_hash_collision">Run example &raquo;</a>
</div>

<hr>

<h2>Incremental Hash Processing</h2>

<p>When working with large amounts of data, you can process it incrementally:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const crypto = require('crypto');<br>
<br>
// Simulate processing a large file in chunks<br>
function processLargeDataIncrementally() {<br>
&nbsp;&nbsp;// Create a hash object<br>
&nbsp;&nbsp;const hash = crypto.createHash('sha256');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Simulate reading data in chunks<br>
&nbsp;&nbsp;const totalChunks = 10;<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;console.log(`Processing data in ${totalChunks} chunks...`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;for (let i = 0; i &lt; totalChunks; i++) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// In a real scenario, this would be data read from a file or stream<br>
&nbsp;&nbsp;&nbsp;&nbsp;const chunk = `Chunk ${i + 1} of data with some random content: ${crypto.randomBytes(10).toString('hex')}`;<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Processing chunk ${i + 1}/${totalChunks}, size: ${chunk.length} bytes`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Update the hash with this chunk<br>
&nbsp;&nbsp;&nbsp;&nbsp;hash.update(chunk);<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Calculate final hash after all chunks are processed<br>
&nbsp;&nbsp;const finalHash = hash.digest('hex');<br>
&nbsp;&nbsp;console.log('Final SHA-256 hash:', finalHash);<br>
}<br>
<br>
// Run the example<br>
processLargeDataIncrementally();
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_hash_incremental">Run example &raquo;</a>
</div>
...
<p>When using hash functions, consider these security best practices:</p>

<ol>
  <li><strong>Choose secure algorithms</strong>: For security-critical applications, use SHA-256, SHA-512, SHA-3, or newer hash functions. Avoid MD5 and SHA-1 for security purposes.</li>
  <li><strong>Use purpose-specific functions</strong>: For password hashing, use specialized functions like bcrypt, scrypt, or Argon2 instead of general-purpose hash functions.</li>
  <li><strong>Always use salts with passwords</strong>: When storing password hashes, always use a unique random salt for each password.</li>
  <li><strong>Consider HMAC for message authentication</strong>: When verifying data integrity with a secret key, use HMAC instead of plain hashes.</li>
  <li><strong>Be aware of length extension attacks</strong>: Some hash functions (SHA-256, SHA-512, but not SHA-3) are vulnerable to length extension attacks when used naively for message authentication.</li>
  <li><strong>Keep dependencies updated</strong>: Security vulnerabilities in cryptographic implementations are regularly discovered and patched.</li>
</ol>
