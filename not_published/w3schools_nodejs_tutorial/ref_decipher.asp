...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Decipher Reference</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js Decipher Reference">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/ref_decipher.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="The Decipher class is part of Node.js's crypto module. It provides a way to decrypt data that was encrypted using the Cipher class.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Decipher Reference">
<meta name="twitter:description" content="The Decipher class is part of Node.js's crypto module. It provides a way to decrypt data that was encrypted using the Cipher class.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/ref_decipher.png">
...
<h1>Node.js Decipher Reference</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="ref_cipher.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ref_diffiehellman.asp">Next &#10095;</a>
</div>

<hr>

<h2>Decipher Object</h2>

<p>The Decipher class is part of Node.js's <code class="w3-codespan">crypto</code> module. It provides a way to decrypt data that was encrypted using the Cipher class. Decipher instances are created using the <code class="w3-codespan">crypto.createDecipheriv()</code> method.</p>

<div class="w3-panel w3-note">
  <p><strong>Note:</strong> The <code class="w3-codespan">crypto.createDecipher()</code> method is deprecated since Node.js v10.0.0 due to security concerns. Always use <code class="w3-codespan">crypto.createDecipheriv()</code> instead, which requires an explicit initialization vector (IV).</p>
</div>
...
<br>
// Create a decipher with createDecipheriv<br>
const algorithm = 'aes-256-cbc';<br>
const key = Buffer.from('your-encryption-key-in-hex', 'hex'); // 32 bytes for AES-256<br>
const iv = Buffer.from('your-iv-in-hex', 'hex');              // 16 bytes for AES<br>
const decipher = crypto.createDecipheriv(algorithm, key, iv);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_decipher_import">Run example &raquo;</a>
</div>

<hr>

<h2>Decipher Methods</h2>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td>decipher.update(data[, inputEncoding][, outputEncoding])</td>
    <td>Updates the decipher with <code class="w3-codespan">data</code>. If <code class="w3-codespan">inputEncoding</code> is provided, <code class="w3-codespan">data</code> is a string using the specified encoding. If <code class="w3-codespan">outputEncoding</code> is specified, the returned value will be a string using the specified encoding. If not, a Buffer is returned.</td>
  </tr>
  <tr>
    <td>decipher.final([outputEncoding])</td>
    <td>Returns any remaining deciphered contents. If <code class="w3-codespan">outputEncoding</code> is specified, a string is returned; otherwise, a Buffer is returned.</td>
  </tr>
  <tr>
    <td>decipher.setAAD(buffer[, options])</td>
    <td>When using an AEAD algorithm (like GCM or CCM), sets the Additional Authenticated Data (AAD).</td>
  </tr>
  <tr>
    <td>decipher.setAuthTag(buffer)</td>
    <td>When using an AEAD algorithm, sets the authentication tag that will be used to verify the data's integrity.</td>
  </tr>
  <tr>
    <td>decipher.setAutoPadding([autoPadding])</td>
    <td>When <code class="w3-codespan">autoPadding</code> is true (default), padding is automatically removed from the result. Disable when the data was not padded or was manually unpadded.</td>
  </tr>
</table>
...
<h2>Basic Decryption Example</h2>

<p>The following example demonstrates how to decrypt data that was encrypted with AES-256-CBC:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const crypto = require('crypto');<br>
<br>
// Encryption key and initialization vector<br>
// In a real application, these would be securely stored and retrieved<br>
const key = Buffer.from('1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef', 'hex');<br>
const iv = Buffer.from('1234567890abcdef1234567890abcdef', 'hex');<br>
<br>
// Encrypted text (from a previous encryption)<br>
const encryptedText = '7a9c2c7157819144ede3cb9532263cb97c94a7b45d95163bb79aa1af55d4101d';<br>
<br>
// Create a decipher<br>
const algorithm = 'aes-256-cbc';<br>
const decipher = crypto.createDecipheriv(algorithm, key, iv);<br>
<br>
// Decrypt the data<br>
let decrypted = decipher.update(encryptedText, 'hex', 'utf8');<br>
decrypted += decipher.final('utf8');<br>
<br>
console.log('Encrypted Text:', encryptedText);<br>
console.log('Decrypted Text:', decrypted);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_decipher_basic">Run example &raquo;</a>
</div>

<hr>

<h2>Complete Encryption/Decryption Example</h2>

<p>Here's a complete example showing both encryption and decryption:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const crypto = require('crypto');<br>
<br>
// The message to encrypt<br>
const message = 'This is a secret message that needs to be encrypted';<br>
<br>
// Generate encryption key and IV<br>
const key = crypto.randomBytes(32);<br>
const iv = crypto.randomBytes(16);<br>
<br>
// Encryption function using Cipher<br>
function encrypt(text) {<br>
&nbsp;&nbsp;// Create cipher<br>
...
<br>
// Decryption function using Decipher<br>
function decrypt(encryptedText) {<br>
&nbsp;&nbsp;// Create decipher with the same key and IV<br>
...
const encryptedMessage = encrypt(message);<br>
console.log('Original Message:', message);<br>
console.log('Encrypted Message:', encryptedMessage);<br>
<br>
// Decrypt the message<br>
const decryptedMessage = decrypt(encryptedMessage);<br>
console.log('Decrypted Message:', decryptedMessage);<br>
<br>
// Verify the result<br>
console.log('Decryption successful:', message === decryptedMessage);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_decipher_complete">Run example &raquo;</a>
</div>

<hr>

<h2>Decrypting Binary Data</h2>

<p>You can decrypt binary data such as encrypted files:</p>
...
<br>
// Read the encryption key and IV (saved during encryption)<br>
const key = Buffer.from(fs.readFileSync('encryption_key.txt', 'utf8'), 'hex');<br>
const iv = Buffer.from(fs.readFileSync('encryption_iv.txt', 'utf8'), 'hex');<br>
<br>
// Create read and write streams<br>
const readStream = fs.createReadStream('encrypted.jpg.enc');<br>
const writeStream = fs.createWriteStream('decrypted.jpg');<br>
<br>
// Create decipher stream<br>
const decipher = crypto.createDecipheriv('aes-256-cbc', key, iv);<br>
<br>
// Decrypt the file<br>
readStream<br>
...
&nbsp;&nbsp;console.log('File decryption completed');<br>
});</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_decipher_binary">Run example &raquo;</a>
</div>

<hr>

<h2>Using AEAD Decryption</h2>

<p>Authenticated Encryption with Associated Data (AEAD) provides both confidentiality and data integrity. Here's how to decrypt data that was encrypted with an AEAD algorithm:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const crypto = require('crypto');<br>
<br>
// Encryption values (would be stored and retrieved securely in a real application)<br>
const key = Buffer.from('1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef', 'hex');<br>
const iv = Buffer.from('123456789012123456789012', 'hex'); // 12 bytes for GCM<br>
const encryptedData = 'af56c283ae95963c1e1877adb558d860';<br>
const authTag = Buffer.from('1234567890abcdef1234567890abcdef', 'hex');<br>
const associatedData = 'Additional data that was authenticated';<br>
<br>
// Create decipher using AES-GCM<br>
const decipher = crypto.createDecipheriv('aes-256-gcm', key, iv);<br>
<br>
// Set the Additional Authenticated Data (AAD)<br>
decipher.setAAD(Buffer.from(associatedData));<br>
<br>
// Set the authentication tag<br>
decipher.setAuthTag(authTag);<br>
<br>
try {<br>
&nbsp;&nbsp;// Decrypt the data<br>
...
&nbsp;&nbsp;decrypted += decipher.final('utf8');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;console.log('Decrypted Text:', decrypted);<br>
&nbsp;&nbsp;console.log('Authentication verified successfully');<br>
} catch (error) {<br>
&nbsp;&nbsp;console.error('Authentication failed:', error.message);<br>
&nbsp;&nbsp;// If authentication fails, the decryption will throw an error<br>
}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_decipher_aead">Run example &raquo;</a>
</div>

<hr>

<h2>AEAD Complete Example</h2>

<p>Here's a complete example of AEAD encryption and decryption:</p>
...
<br>
// Data to encrypt<br>
const plainText = 'Secret message';<br>
const associatedData = 'Additional data to authenticate';<br>
<br>
// Generate key and IV (nonce)<br>
const key = crypto.randomBytes(32);<br>
const iv = crypto.randomBytes(12); // 12 bytes (96 bits) is recommended for GCM<br>
<br>
// === ENCRYPTION ===<br>
// Create cipher using AES-GCM<br>
const cipher = crypto.createCipheriv('aes-256-gcm', key, iv);<br>
<br>
// Set the Additional Authenticated Data (AAD)<br>
cipher.setAAD(Buffer.from(associatedData));<br>
<br>
// Encrypt the data<br>
let encrypted = cipher.update(plainText, 'utf8', 'hex');<br>
encrypted += cipher.final('hex');<br>
<br>
// Get the authentication tag<br>
const authTag = cipher.getAuthTag();<br>
<br>
console.log('Encrypted Text:', encrypted);<br>
console.log('Auth Tag (hex):', authTag.toString('hex'));<br>
console.log('Associated Data:', associatedData);<br>
<br>
// === DECRYPTION ===<br>
// Create decipher<br>
const decipher = crypto.createDecipheriv('aes-256-gcm', key, iv);<br>
...
&nbsp;&nbsp;<br>
&nbsp;&nbsp;console.log('Decrypted Text:', decrypted);<br>
&nbsp;&nbsp;console.log('Decryption successful:', plainText === decrypted);<br>
} catch (error) {<br>
&nbsp;&nbsp;console.error('Decryption failed:', error.message);<br>
}<br>
<br>
// === DECRYPTION WITH WRONG AUTH TAG (will fail) ===<br>
try {<br>
&nbsp;&nbsp;const wrongDecipher = crypto.createDecipheriv('aes-256-gcm', key, iv);<br>
&nbsp;&nbsp;wrongDecipher.setAAD(Buffer.from(associatedData));<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Set a wrong authentication tag<br>
&nbsp;&nbsp;const wrongAuthTag = crypto.randomBytes(16);<br>
&nbsp;&nbsp;wrongDecipher.setAuthTag(wrongAuthTag);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Try to decrypt<br>
&nbsp;&nbsp;let wrongDecrypted = wrongDecipher.update(encrypted, 'hex', 'utf8');<br>
&nbsp;&nbsp;wrongDecrypted += wrongDecipher.final('utf8'); // This will throw<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;console.log('Should not reach here');<br>
} catch (error) {<br>
&nbsp;&nbsp;console.error('Decryption with wrong auth tag failed (expected):', error.message);<br>
}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_decipher_aead_complete">Run example &raquo;</a>
</div>

<hr>

<h2>Manual Padding Control</h2>

<p>You can control the padding behavior for decryption manually:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const crypto = require('crypto');<br>
<br>
// Generate key and IV<br>
const key = crypto.randomBytes(32);<br>
const iv = crypto.randomBytes(16);<br>
<br>
// Data to encrypt<br>
const plainText = 'This is a test message';<br>
<br>
// First encrypt with disabled auto padding<br>
const cipher = crypto.createCipheriv('aes-256-cbc', key, iv);<br>
cipher.setAutoPadding(false);<br>
<br>
// Manually pad to block size (16 bytes for AES)<br>
function padToBlockSize(text, blockSize = 16) {<br>
&nbsp;&nbsp;const padLength = blockSize - (text.length % blockSize);<br>
&nbsp;&nbsp;return text + '\0'.repeat(padLength);<br>
}<br>
<br>
// Encrypt manually padded data<br>
const paddedText = padToBlockSize(plainText);<br>
let encrypted = cipher.update(paddedText, 'utf8', 'hex');<br>
encrypted += cipher.final('hex');<br>
<br>
// Now decrypt with auto padding disabled<br>
function decryptWithPadding(encryptedText, usePadding) {<br>
&nbsp;&nbsp;const decipher = crypto.createDecipheriv('aes-256-cbc', key, iv);<br>
&nbsp;&nbsp;decipher.setAutoPadding(usePadding);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;let decrypted = decipher.update(encryptedText, 'hex', 'utf8');<br>
&nbsp;&nbsp;&nbsp;&nbsp;decrypted += decipher.final('utf8');<br>
...
<br>
// With auto padding (default)<br>
console.log('With auto padding:', decryptWithPadding(encrypted, true));<br>
<br>
// Without auto padding (will include padding bytes)<br>
const manualDecrypted = decryptWithPadding(encrypted, false);<br>
console.log('Without auto padding:', manualDecrypted);<br>
<br>
// Manually remove padding (trim null bytes)<br>
function removeNullPadding(paddedText) {<br>
&nbsp;&nbsp;return paddedText.replace(/\0+$/, '');<br>
}<br>
<br>
console.log('With manual padding removal:', removeNullPadding(manualDecrypted));</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_decipher_padding">Run example &raquo;</a>
</div>
...
<p>Decrypt data that was encrypted using a password-derived key:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const crypto = require('crypto');<br>
<br>
// Password and salt (from the encryption process)<br>
const password = 'mysecretpassword';<br>
const salt = Buffer.from('0123456789abcdef0123456789abcdef', 'hex');<br>
<br>
// Encrypted data and IV from the encryption process<br>
const encryptedData = '7a9c2c7157819144ede3cb9532263cb97c94a7b45d95163bb79aa1af55d4101d';<br>
const iv = Buffer.from('0123456789abcdef0123456789abcdef', 'hex');<br>
<br>
// Generate a key from the password<br>
function getKeyFromPassword(password, salt) {<br>
&nbsp;&nbsp;// Use PBKDF2 to derive a key from the password<br>
&nbsp;&nbsp;return crypto.pbkdf2Sync(password, salt, 100000, 32, 'sha256');<br>
}<br>
<br>
// Decrypt data<br>
function decryptWithPassword(encryptedText, password, salt, iv) {<br>
&nbsp;&nbsp;// Generate key from password<br>
&nbsp;&nbsp;const key = getKeyFromPassword(password, salt);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Create decipher<br>
&nbsp;&nbsp;const decipher = crypto.createDecipheriv('aes-256-cbc', key, iv);<br>
&nbsp;&nbsp;<br>
...
try {<br>
&nbsp;&nbsp;// Decrypt the data<br>
&nbsp;&nbsp;const decryptedText = decryptWithPassword(encryptedData, password, salt, iv);<br>
&nbsp;&nbsp;console.log('Decrypted:', decryptedText);<br>
} catch (error) {<br>
&nbsp;&nbsp;console.error('Decryption failed:', error.message);<br>
}<br>
<br>
// Try with wrong password<br>
try {<br>
&nbsp;&nbsp;const wrongPassword = 'wrongpassword';<br>
&nbsp;&nbsp;const decryptedWithWrongPass = decryptWithPassword(encryptedData, wrongPassword, salt, iv);<br>
&nbsp;&nbsp;console.log('Decrypted with wrong password:', decryptedWithWrongPass);<br>
} catch (error) {<br>
&nbsp;&nbsp;console.log('Decryption with wrong password failed (expected):', error.message);<br>
}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_decipher_password">Run example &raquo;</a>
</div>

<hr>

<h2>Complete Password-Based Example</h2>

<p>Here's a complete example of password-based encryption and decryption:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const crypto = require('crypto');<br>
<br>
// Password and message<br>
const password = 'mysecretpassword';<br>
const message = 'This is a secret message protected by a password';<br>
<br>
// Password-based encryption<br>
function encryptWithPassword(text, password) {<br>
&nbsp;&nbsp;// Generate a random salt<br>
&nbsp;&nbsp;const salt = crypto.randomBytes(16);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Derive a key from the password<br>
&nbsp;&nbsp;const key = crypto.pbkdf2Sync(password, salt, 100000, 32, 'sha256');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Generate random IV<br>
&nbsp;&nbsp;const iv = crypto.randomBytes(16);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Create cipher<br>
&nbsp;&nbsp;const cipher = crypto.createCipheriv('aes-256-cbc', key, iv);<br>
...
&nbsp;&nbsp;encrypted += cipher.final('hex');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Return all values needed for decryption<br>
&nbsp;&nbsp;return {<br>
...
<br>
// Password-based decryption<br>
function decryptWithPassword(encryptedInfo, password) {<br>
&nbsp;&nbsp;// Parse the values<br>
...
<br>
// Encrypt the message<br>
const encryptedInfo = encryptWithPassword(message, password);<br>
console.log('Encrypted information:', encryptedInfo);<br>
<br>
// Decrypt the message<br>
const decryptedMessage = decryptWithPassword(encryptedInfo, password);<br>
console.log('Decrypted message:', decryptedMessage);<br>
console.log('Decryption successful:', message === decryptedMessage);<br>
<br>
// Try with wrong password<br>
try {<br>
&nbsp;&nbsp;const wrongPassword = 'wrongpassword';<br>
&nbsp;&nbsp;const decryptedWithWrong = decryptWithPassword(encryptedInfo, wrongPassword);<br>
&nbsp;&nbsp;console.log('Decrypted with wrong password:', decryptedWithWrong);<br>
} catch (error) {<br>
&nbsp;&nbsp;console.log('Decryption with wrong password failed (expected):', error.message);<br>
}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_decipher_password_complete">Run example &raquo;</a>
</div>
...
<p>Decryption can fail for various reasons. It's important to handle these errors properly:</p>
...
const iv = crypto.randomBytes(16);<br>
<br>
// Create sample encrypted data<br>
const cipher = crypto.createCipheriv('aes-256-cbc', key, iv);<br>
const validEncrypted = cipher.update('valid data', 'utf8', 'hex') + cipher.final('hex');<br>
<br>
// Function to attempt decryption and handle errors<br>
function tryDecrypt(encryptedText, decryptKey, decryptIv) {<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const decipher = crypto.createDecipheriv('aes-256-cbc', decryptKey, decryptIv);<br>
&nbsp;&nbsp;&nbsp;&nbsp;const decrypted = decipher.update(encryptedText, 'hex', 'utf8') + decipher.final('utf8');<br>
&nbsp;&nbsp;&nbsp;&nbsp;return { success: true, data: decrypted };<br>
&nbsp;&nbsp;} catch (error) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;return { success: false, error: error.message };<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
// Case 1: Correct key and IV<br>
const result1 = tryDecrypt(validEncrypted, key, iv);<br>
console.log('Case 1 (correct key and IV):', result1);<br>
<br>
// Case 2: Wrong key<br>
const wrongKey = crypto.randomBytes(32);<br>
const result2 = tryDecrypt(validEncrypted, wrongKey, iv);<br>
console.log('Case 2 (wrong key):', result2);<br>
<br>
// Case 3: Wrong IV<br>
const wrongIv = crypto.randomBytes(16);<br>
const result3 = tryDecrypt(validEncrypted, key, wrongIv);<br>
console.log('Case 3 (wrong IV):', result3);<br>
<br>
// Case 4: Invalid encrypted data<br>
const result4 = tryDecrypt('invalidhexdata', key, iv);<br>
console.log('Case 4 (invalid data):', result4);<br>
<br>
// Case 5: Corrupted encrypted data<br>
const corruptedData = validEncrypted.substring(0, validEncrypted.length - 2);<br>
const result5 = tryDecrypt(corruptedData, key, iv);<br>
console.log('Case 5 (corrupted data):', result5);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_decipher_errors">Run example &raquo;</a>
</div>
...
<ul>
  <li><strong>Use <code class="w3-codespan">createDecipheriv()</code> instead of the deprecated <code class="w3-codespan">createDecipher()</code></strong>: This ensures you're explicitly providing the IV.</li>
  <li><strong>Secure key and IV storage</strong>: Store encryption keys securely, consider using a key management service.</li>
  <li><strong>Verify decryption</strong>: When possible, include a way to verify that decryption was successful (e.g., using authenticated encryption).</li>
  <li><strong>Protect against chosen-ciphertext attacks</strong>: Use authenticated encryption (AEAD) to prevent tampering with encrypted data.</li>
  <li><strong>Handle errors securely</strong>: Avoid leaking information about the decryption process in error messages.</li>
  <li><strong>Use constant-time comparison</strong>: When verifying authentication tags or other sensitive values, use constant-time comparisons to prevent timing attacks.</li>
</ul>
