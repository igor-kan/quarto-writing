...
<meta name="title" property="og:title" content="Node.js Net Module">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_net.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="The Net module is one of Node.js's core networking modules, allowing you to create TCP servers and clients.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Net Module">
<meta name="twitter:description" content="The Net module is one of Node.js's core networking modules, allowing you to create TCP servers and clients.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_net.png">
...
<a class="w3-left w3-btn" href="nodejs_tls.asp">&lt; Previous</a>
<a class="w3-right w3-btn" href="nodejs_zlib.asp">Next &gt;</a>
</div>


<hr>

<h2>Introduction to the Net Module</h2>

<p>The Net module is one of Node.js's core networking modules, allowing you to create TCP servers and clients. TCP (Transmission Control Protocol) is a reliable, ordered, and error-checked delivery of a stream of bytes between applications running on networked devices.</p>

<p>Unlike the HTTP module, which is built on top of the Net module, the Net module provides lower-level networking capabilities, giving you more control over the communication protocol.</p>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> The Net module is best suited for scenarios where you need a custom TCP protocol or want to implement your own application-level protocol on top of TCP.</p>
</div>

<hr>

<h2>Importing the Net Module</h2>

<p>To use the Net module, you need to import it in your Node.js application:</p>
...
<p>The Net module makes it easy to create a TCP server that listens for connections:</p>
...
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Set encoding to utf8 so we receive strings instead of Buffer objects<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;console.error('Socket error:', err);<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
...
<br>
// Start the server and listen on port 8080<br>
server.listen(8080, () => {<br>
&nbsp;&nbsp;console.log('TCP Server running on port 8080');<br>
});
</div>
</div>
...
<p>In this example:</p>
<ul>
  <li><code class="w3-codespan">net.createServer()</code> creates a new TCP server</li>
  <li>The callback function is called when a client connects</li>
  <li>The <code class="w3-codespan">socket</code> object represents the connection to the client</li>
  <li>We set up event handlers for <code class="w3-codespan">data</code>, <code class="w3-codespan">end</code>, and <code class="w3-codespan">error</code> events</li>
  <li><code class="w3-codespan">server.listen(8080)</code> starts the server on port 8080</li>
</ul>
...
<p>You can also create a TCP client to connect to a TCP server:</p>
...
const client = net.createConnection({ port: 8080 }, () => {<br>
...
&nbsp;&nbsp;client.write('More data from client');<br>
});<br>
<br>
...
<p>In this example:</p>
<ul>
  <li><code class="w3-codespan">net.createConnection()</code> creates a client connection to a TCP server</li>
  <li>We provide the port (and optionally host) to connect to</li>
  <li>The callback function is called when the connection is established</li>
  <li>We set up event handlers for <code class="w3-codespan">data</code>, <code class="w3-codespan">end</code>, and <code class="w3-codespan">error</code> events</li>
</ul>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> To test the client and server together, run the server script in one terminal and the client script in another terminal.</p>
</div>

<hr>

<h2>Socket Properties and Methods</h2>

<p>The Socket object provided to the server connection callback and returned by <code class="w3-codespan">createConnection()</code> has many useful properties and methods:</p>
...
<table class="ws-table-all">
  ...
  <tr>
    <td><code class="w3-codespan">socket.write(data[, encoding][, callback])</code></td>
    <td>Writes data to the socket, optionally with the specified encoding</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">socket.end([data][, encoding][, callback])</code></td>
    <td>Closes the socket after all data is written and flushed</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">socket.setEncoding(encoding)</code></td>
    <td>Sets the encoding for data received on the socket</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">socket.setTimeout(timeout[, callback])</code></td>
    <td>Sets the socket to timeout after the specified number of milliseconds of inactivity</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">socket.setKeepAlive([enable][, initialDelay])</code></td>
    <td>Enables/disables keep-alive functionality</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">socket.address()</code></td>
    <td>Returns an object with connection's address, family, and port</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">socket.remoteAddress</code></td>
    <td>Remote IP address as a string</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">socket.remotePort</code></td>
    <td>Remote port as a number</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">socket.localAddress</code></td>
    <td>Local IP address the server is listening on</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">socket.localPort</code></td>
    <td>Local port the server is listening on</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">socket.bytesRead</code></td>
    <td>Number of bytes received</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">socket.bytesWritten</code></td>
...
<h2>Server Properties and Methods</h2>

<p>The Server object returned by <code class="w3-codespan">createServer()</code> has these useful properties and methods:</p>
...
<table class="ws-table-all">
  ...
  <tr>
    <td><code class="w3-codespan">server.listen(port[, hostname][, backlog][, callback])</code></td>
    <td>Starts the server listening for connections</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">server.close([callback])</code></td>
    <td>Stops the server from accepting new connections</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">server.address()</code></td>
    <td>Returns an object with server's address info</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">server.maxConnections</code></td>
    <td>Set this property to reject connections when the connection count exceeds it</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">server.connections</code></td>
    <td>Number of concurrent connections</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">server.listening</code></td>
    <td>Boolean indicating whether the server is listening</td>
  </tr>
</table>
</div>
...
<h2>Creating a Chat Server</h2>

<p>Let's create a simple chat server that broadcasts messages to all connected clients:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const net = require('net');<br>
<br>
// Store all client connections<br>
const clients = [];<br>
<br>
// Create a chat server<br>
const server = net.createServer((socket) => {<br>
&nbsp;&nbsp;// Generate a client ID<br>
&nbsp;&nbsp;const clientId = `${socket.remoteAddress}:${socket.remotePort}`;<br>
&nbsp;&nbsp;console.log(`Client connected: ${clientId}`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Set encoding<br>
&nbsp;&nbsp;socket.setEncoding('utf8');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Add client to the list<br>
&nbsp;&nbsp;clients.push(socket);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Send welcome message<br>
&nbsp;&nbsp;socket.write(`Welcome to the chat server! There are ${clients.length} users online.\r\n`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Broadcast message to all clients except the sender<br>
&nbsp;&nbsp;function broadcast(message, sender) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;clients.forEach(client => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (client !== sender) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;client.write(message);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Notify all clients about the new connection<br>
&nbsp;&nbsp;broadcast(`User ${clientId} joined the chat.\r\n`, socket);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Handle client messages<br>
&nbsp;&nbsp;socket.on('data', (data) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`${clientId}: ${data.trim()}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Broadcast the message to all other clients<br>
&nbsp;&nbsp;&nbsp;&nbsp;broadcast(`${clientId}: ${data}`, socket);<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Handle client disconnection<br>
&nbsp;&nbsp;socket.on('end', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Client disconnected: ${clientId}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Remove client from the list<br>
&nbsp;&nbsp;&nbsp;&nbsp;const index = clients.indexOf(socket);<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (index !== -1) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;clients.splice(index, 1);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Notify all clients about the disconnection<br>
&nbsp;&nbsp;&nbsp;&nbsp;broadcast(`User ${clientId} left the chat.\r\n`, null);<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Handle errors<br>
&nbsp;&nbsp;socket.on('error', (err) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error(`Socket error from ${clientId}:`, err);<br>
&nbsp;&nbsp;});<br>
});<br>
<br>
// Start the server<br>
...
&nbsp;&nbsp;console.log(`Chat server running on port ${PORT}`);<br>
});<br>
<br>
...
<p>To connect to this chat server, you can use a TCP client or a terminal tool like telnet:</p>
...
<p>You can also create a dedicated chat client using the Net module:</p>
...
<br>
// Create interface for reading from the terminal<br>
...
const client = net.createConnection({ port: 8080 }, () => {<br>
&nbsp;&nbsp;console.log('Connected to chat server');<br>
&nbsp;&nbsp;console.log('Type a message and press Enter to send');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Start reading user input<br>
&nbsp;&nbsp;rl.prompt();<br>
});<br>
<br>
// Set encoding<br>
...
// Handle data from server<br>
client.on('data', (data) => {<br>
&nbsp;&nbsp;// Move cursor to beginning of line and clear it<br>
&nbsp;&nbsp;process.stdout.write('\r\x1b[K');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Print the server message<br>
&nbsp;&nbsp;console.log(data.trim());<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Re-display the prompt<br>
&nbsp;&nbsp;rl.prompt();<br>
});<br>
<br>
// Handle connection end<br>
...
rl.on('line', (input) => {<br>
&nbsp;&nbsp;// Send the user input to the server<br>
&nbsp;&nbsp;client.write(input);<br>
&nbsp;&nbsp;rl.prompt();<br>
});<br>
<br>
// Close the connection when the user exits<br>
rl.on('close', () => {<br>
&nbsp;&nbsp;console.log('Exiting chat...');<br>
&nbsp;&nbsp;client.end();<br>
});
</div>
</div>
...
<h2>Building a Simple Protocol</h2>

<p>One of the advantages of using the Net module is the ability to create your own application protocols. Let's create a simple JSON-based protocol:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const net = require('net');<br>
<br>
// Create a server that supports a JSON-based protocol<br>
const server = net.createServer((socket) => {<br>
&nbsp;&nbsp;console.log('Client connected');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Buffer for incoming data<br>
&nbsp;&nbsp;let buffer = '';<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Handle data<br>
&nbsp;&nbsp;socket.on('data', (data) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Add the new data to our buffer<br>
&nbsp;&nbsp;&nbsp;&nbsp;buffer += data.toString();<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Process complete messages<br>
&nbsp;&nbsp;&nbsp;&nbsp;let boundary = buffer.indexOf('\n');<br>
&nbsp;&nbsp;&nbsp;&nbsp;while (boundary !== -1) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Extract the complete message<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const message = buffer.substring(0, boundary);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;buffer = buffer.substring(boundary + 1);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Process the message<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const parsedMessage = JSON.parse(message);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Received message:', parsedMessage);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Handle different message types<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;switch (parsedMessage.type) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;case 'greeting':<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;socket.write(JSON.stringify({<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;type: 'welcome',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;message: `Hello, ${parsedMessage.name}!`,<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;socket.write(JSON.stringify({<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;type: 'response',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;queryId: parsedMessage.queryId,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;result: handleQuery(parsedMessage.query),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;timestamp: Date.now()<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}) + '\n');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;break;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;socket.write(JSON.stringify({<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;type: 'error',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;message: 'Unknown message type',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;timestamp: Date.now()<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}) + '\n');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;} catch (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error('Error processing message:', err);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;socket.write(JSON.stringify({<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;type: 'error',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;message: 'Invalid JSON format',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;timestamp: Date.now()<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}) + '\n');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Look for the next message<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;boundary = buffer.indexOf('\n');<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Handle disconnection<br>
&nbsp;&nbsp;socket.on('end', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Client disconnected');<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
...
<br>
// Simple function to handle queries<br>
function handleQuery(query) {<br>
&nbsp;&nbsp;if (query === 'time') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;return { time: new Date().toISOString() };<br>
&nbsp;&nbsp;} else if (query === 'stats') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;return { <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;uptime: process.uptime(),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;memory: process.memoryUsage(),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;platform: process.platform<br>
&nbsp;&nbsp;&nbsp;&nbsp;};<br>
&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;return { error: 'Unknown query' };<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
// Start the server<br>
const PORT = 8080;<br>
server.listen(PORT, () => {<br>
&nbsp;&nbsp;console.log(`JSON protocol server running on port ${PORT}`);<br>
});
</div>
</div>

<p>And here's a client that uses this protocol:</p>
...
&nbsp;&nbsp;&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const parsedMessage = JSON.parse(message);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Received from server:', parsedMessage);<br>
&nbsp;&nbsp;&nbsp;&nbsp;} catch (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error('Error parsing message:', err);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Look for the next message<br>
&nbsp;&nbsp;&nbsp;&nbsp;boundary = buffer.indexOf('\n');<br>
...
<br>
// Helper function to send messages<br>
function send(message) {<br>
&nbsp;&nbsp;const jsonString = JSON.stringify(message) + '\n';<br>
&nbsp;&nbsp;console.log('Sending:', message);<br>
&nbsp;&nbsp;client.write(jsonString);<br>
}<br>
<br>
// Handle connection end<br>
client.on('end', () => {<br>
...
<br>
// Close the connection after some time<br>
setTimeout(() => {<br>
...
<div class="w3-panel ws-note">
<p><strong>Note:</strong> In this protocol, we use JSON for message serialization and newline characters (\n) as message boundaries. This makes it easy to parse messages and allows for a variety of message types and payloads.</p>
</div>
...
<p>To handle inactive connections, you can set a timeout on the socket:</p>
...
&nbsp;&nbsp;console.log('Client connected');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Set a timeout of 10 seconds<br>
&nbsp;&nbsp;socket.setTimeout(10000);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Handle timeout<br>
&nbsp;&nbsp;socket.on('timeout', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Socket timeout');<br>
...
&nbsp;&nbsp;// Handle data<br>
&nbsp;&nbsp;socket.on('data', (data) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Received: ${data.toString().trim()}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;socket.write(`Echo: ${data}`);<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Handle disconnection<br>
...
<br>
server.listen(8080, () => {<br>
&nbsp;&nbsp;console.log('Server with timeout running on port 8080');<br>
});
</div>
</div>
...
<h2>Working with IPC (Inter-Process Communication)</h2>

<p>The Net module can also create IPC (Inter-Process Communication) servers and clients using Unix domain sockets or named pipes on Windows:</p>
...
<br>
// Define the path for the IPC socket<br>
const socketPath = path.join(__dirname, 'ipc-socket');<br>
<br>
// Create an IPC server<br>
const server = net.createServer((socket) => {<br>
&nbsp;&nbsp;console.log('Client connected to IPC server');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;socket.on('data', (data) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Received via IPC: ${data.toString().trim()}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;socket.write(`Echo: ${data}`);<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;socket.on('end', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Client disconnected from IPC server');<br>
&nbsp;&nbsp;});<br>
});<br>
<br>
// Start the IPC server<br>
server.listen(socketPath, () => {<br>
&nbsp;&nbsp;console.log(`IPC server running at ${socketPath}`);<br>
});<br>
<br>
// Clean up the socket file when the server closes<br>
server.on('close', () => {<br>
&nbsp;&nbsp;console.log('Cleaning up socket file');<br>
&nbsp;&nbsp;require('fs').unlinkSync(socketPath);<br>
});<br>
<br>
// Handle process termination<br>
process.on('SIGINT', () => {<br>
&nbsp;&nbsp;server.close(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('IPC server closed');<br>
&nbsp;&nbsp;&nbsp;&nbsp;process.exit(0);<br>
&nbsp;&nbsp;});<br>
});
</div>
...
const socketPath = path.join(__dirname, 'ipc-socket');<br>
<br>
// Create an IPC client<br>
const client = net.createConnection({ path: socketPath }, () => {<br>
&nbsp;&nbsp;console.log('Connected to IPC server');<br>
&nbsp;&nbsp;client.write('Hello from IPC client!');<br>
});<br>
<br>
client.on('data', (data) => {<br>
&nbsp;&nbsp;console.log(`Received from IPC server: ${data.toString().trim()}`);<br>
&nbsp;&nbsp;client.end();<br>
});<br>
<br>
client.on('end', () => {<br>
...
<div class="w3-panel ws-note">
<p><strong>Note:</strong> IPC connections using Unix domain sockets or named pipes are generally faster and more secure than TCP connections because they don't use the network stack and are restricted to the local machine.</p>
</div>
...
<ol>
  <li><strong>Error Handling:</strong> Always handle socket errors to prevent your application from crashing.</li>
  <li><strong>Timeouts:</strong> Implement timeouts to handle inactive connections and prevent resource leaks.</li>
  <li><strong>Keep-Alive:</strong> Use keep-alive for long-lived connections to detect disconnections.</li>
  <li><strong>Buffering:</strong> Implement proper message framing and buffering for your protocol to handle partial messages.</li>
  <li><strong>Connection Limits:</strong> Set <code class="w3-codespan">server.maxConnections</code> to avoid overwhelming your server.</li>
  <li><strong>Graceful Shutdown:</strong> Implement proper cleanup when shutting down servers to release resources.</li>
  <li><strong>Binary Data:</strong> Use Buffer objects for binary data transmission rather than strings to avoid encoding issues.</li>
  <li><strong>Backpressure:</strong> Check the return value of <code class="w3-codespan">socket.write()</code> to handle backpressure when the client can't keep up.</li>
</ol>

<hr>

<h2>Net Module vs. HTTP Module</h2>
...
<table class="ws-table-all">
  ...
  <tr>
    ...
    <td>Custom (you define it)</td>
    <td>HTTP request/response</td>
  </tr>
  <tr>
    <td>Abstraction Level</td>
    <td>Lower-level, more control</td>
    <td>Higher-level, easier to use</td>
  </tr>
  <tr>
    <td>Use Case</td>
    <td>Custom protocols, performance-critical apps</td>
    <td>Web applications, REST APIs</td>
  </tr>
</table>
</div>

<p>Use the Net module when:</p>
<ul>
  <li>You need to implement a custom protocol</li>
  <li>You want maximum control over the communication</li>
  <li>You need to optimize for performance</li>
  <li>You're building a non-HTTP TCP server (chat, game, etc.)</li>
</ul>

<p>Use the HTTP module when:</p>
<ul>
  <li>You're building a web server or API</li>
  <li>You need HTTP-specific features like request routing, headers, etc.</li>
  <li>You want to use higher-level web frameworks like Express</li>
</ul>
...
<p>The Node.js Net module provides powerful tools for creating TCP servers and clients. It offers:</p>
<ul>
  <li>Low-level socket access for custom protocols</li>
  <li>Asynchronous, event-driven API for handling connections</li>
  <li>Support for both TCP/IP and IPC communication</li>
  <li>Building blocks for higher-level protocols</li>
</ul>

<p>While it requires more manual work than higher-level modules like HTTP, the Net module gives you the flexibility to implement exactly the protocol you need for your application.</p>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> Always monitor your TCP server's performance using tools like <code class="w3-codespan">netstat</code>, <code class="w3-codespan">ss</code>, or <code class="w3-codespan">lsof</code> to identify bottlenecks and connection issues.</p>
</div>

<hr>

<div id="exercisecontainer" src="xrcise_net.js" data-extensions="asp"></div>
