...
<meta name="title" property="og:title" content="Node.js Raspberry Pi Webserver with WebSocket">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_raspberrypi_webserver_websocket.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="WebSocket enables bidirectional communication in real time over the web.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Raspberry Pi Webserver with WebSocket">
<meta name="twitter:description" content="WebSocket enables bidirectional communication in real time over the web.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_raspberrypi_webserver_websocket.png">
...
<iframe style="aspect-ratio: 16 / 9;width: 100%; max-width:960px;" src="https://www.youtube.com/embed/iedgqPJ0xX8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
<p>webserver.js:</p>
  <div class="w3-code notranslate jsHigh">
    ...
    create server with function handler()<br>let fs = require('fs'); //require filesystem module<br><br>http.listen(8080); //listen to port 8080<br><br>
...
<p>index.html:</p>
  <div class="w3-code notranslate htmlHigh">
    &lt;!DOCTYPE html&gt;<br>&lt;html&gt;<br>&lt;body&gt;<br><br>&lt;h1&gt;Control LED light&lt;/h1&gt;<br>&lt;input 
    id=&quot;light&quot; type=&quot;checkbox&quot;&gt;LED<br><br>&lt;/body&gt;<br>&lt;/html&gt;</div>
</div>
...
<p>index.html:</p>
  <div class="w3-code notranslate htmlHigh">
    &lt;!DOCTYPE html&gt;<br>&lt;html&gt;<br>&lt;body&gt;<br><br>&lt;h1&gt;Control LED 
    light&lt;/h1&gt;<br>&lt;p&gt;&lt;input type=&quot;checkbox&quot; id=&quot;light&quot;&gt;&lt;/p&gt;<br><br>&lt;script src=&quot;https://cdnjs.cloudflare.com/ajax/libs/socket.io/2.0.3/socket.io.js&quot;&gt;&lt;/script&gt; 
    &lt;!-- include socket.io client side script --&gt;<br>&lt;script&gt;<br>let socket = io(); 
    //load socket.io-client and connect to the host that serves the page<br>
    window.addEventListener(&quot;load&quot;, function(){ //when page loads<br>&nbsp; let 
    ...
    push button status to back to server<br>});<br>&lt;/script&gt;<br><br>&lt;/body&gt;<br>&lt;/html&gt;</div>
</div>
...
<p>webserver.js:</p>
  <div class="w3-code notranslate jsHigh">
    let http = require('http').createServer(handler); //require http server, and 
    create server with function handler()<br>let fs = require('fs'); //require filesystem module<br>let io 
    ...
    let lightvalue = 0; //static variable for current status<br>&nbsp; socket.on('light', 
...
<p>webserver.js:</p>
  <div class="w3-code notranslate jsHigh">
    ...
    create server with function handler()<br>let fs = require('fs'); //require filesystem module<br>let io 
    = require('socket.io')(http) //require socket.io module and pass the http 
    object (server)<br>let Gpio = require('onoff').Gpio; //include onoff to 
    interact with the GPIO<br>let LED = new Gpio(4, 'out'); //use GPIO pin 4 as 
    output<br>let pushButton = new Gpio(17, 'in', 'both'); //use GPIO pin 17 as 
    ...
    return res.end();<br>&nbsp; });<br>}<br><br>
    io.sockets.on('connection', function (socket) {// WebSocket Connection<br>&nbsp; 
    let lightvalue = 0; //static variable for current status<br>&nbsp; 
