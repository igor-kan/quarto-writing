...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Logging</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js Logging">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_logging.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="Effective logging helps you debug, monitor, and understand your Node.js applications in production.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Logging">
<meta name="twitter:description" content="Effective logging helps you debug, monitor, and understand your Node.js applications in production.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_logging.png">
...
<h1>Node.js Logging</h1> 
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_dev_vs_prod.asp">&lt; Previous</a>
<a class="w3-right w3-btn" href="nodejs_monitoring_observability.asp">Next &gt;</a>
</div>
<hr>

<h2>Why Logging Matters</h2>

<p>Effective logging is essential for several reasons:</p>

<ul>
  <li><strong>Debugging:</strong> Understand what's happening inside your application</li>
  <li><strong>Troubleshooting:</strong> Diagnose issues in production environments</li>
  <li><strong>Monitoring:</strong> Track application health and performance</li>
  <li><strong>Auditing:</strong> Record important events for compliance and security</li>
  <li><strong>Analytics:</strong> Gather data about application usage and behavior</li>
</ul>

<hr>

<h2>Basic Logging with Console</h2>

<p>Node.js provides built-in console methods for basic logging:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// Basic logging<br>
console.log('Info message');<br>
console.error('Error message');<br>
console.warn('Warning message');<br>
console.debug('Debug message');<br>
<br>
// Log objects<br>
const user = { id: 1, name: 'John', roles: ['admin', 'user'] };<br>
console.log('User object:', user);<br>
<br>
// Table output for arrays or objects<br>
console.table([<br>
&nbsp;&nbsp;{ name: 'John', age: 30, role: 'admin' },<br>
&nbsp;&nbsp;{ name: 'Jane', age: 25, role: 'user' },<br>
&nbsp;&nbsp;{ name: 'Bob', age: 40, role: 'guest' }<br>
]);<br>
<br>
// Timing operations<br>
console.time('operation');<br>
// Perform some operations...<br>
for (let i = 0; i &lt; 1000000; i++) {<br>
&nbsp;&nbsp;// Do something<br>
}<br>
console.timeEnd('operation'); // Outputs: operation: 4.269ms<br>
<br>
// Grouping related logs<br>
console.group('User Processing');<br>
console.log('Loading user data...');<br>
console.log('Validating user...');<br>
console.log('Updating user profile...');<br>
console.groupEnd();<br>
<br>
// Stack trace<br>
console.trace('Trace message');</div>
</div>

<h3>Console Limitations</h3>
<p>While the console is convenient, it has significant limitations for production use:</p>
<ul>
  <li>No built-in log levels for filtering</li>
  <li>No log rotation or file management</li>
  <li>No structured output formats like JSON</li>
  <li>Limited integration with monitoring systems</li>
</ul>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> Console methods are synchronous when outputting to terminals/files and can impact performance if used frequently in production.</p>
</div>
...
<p>Structured logging formats log messages as data objects (typically JSON) rather than plain text, making them easier to parse, search, and analyze.</p>

<h3>Benefits of Structured Logging</h3>
<ul>
  <li>Consistent format for machine readability</li>
  <li>Better searchability and filtering</li>
  <li>Simplified integration with log aggregation tools</li>
  <li>Enhanced context with metadata</li>
</ul>

<div class="w3-example">
<h3>Example of a Structured Log Entry (JSON)</h3>
<div class="w3-code notranslate">
{<br>
&nbsp;&nbsp;"timestamp": "2023-11-28T15:24:39.123Z",<br>
&nbsp;&nbsp;"level": "error",<br>
&nbsp;&nbsp;"message": "Failed to connect to database",<br>
&nbsp;&nbsp;"service": "user-service",<br>
&nbsp;&nbsp;"context": {<br>
&nbsp;&nbsp;&nbsp;&nbsp;"requestId": "req-123-456",<br>
&nbsp;&nbsp;&nbsp;&nbsp;"userId": "user-789",<br>
&nbsp;&nbsp;&nbsp;&nbsp;"databaseHost": "db.example.com"<br>
&nbsp;&nbsp;},<br>
&nbsp;&nbsp;"error": {<br>
&nbsp;&nbsp;&nbsp;&nbsp;"name": "ConnectionError",<br>
...
<h2>Popular Node.js Logging Libraries</h2>

<h3>Winston</h3>
<p>Winston is a versatile logging library with support for multiple transports (outputs):</p>

<div class="w3-example">
<h3>Basic Winston Setup</h3>
<div class="w3-code notranslate jsHigh">
...
&nbsp;&nbsp;defaultMeta: { service: 'user-service' },<br>
&nbsp;&nbsp;transports: [<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Write logs to a file<br>
&nbsp;&nbsp;&nbsp;&nbsp;new winston.transports.File({ filename: 'error.log', level: 'error' }),<br>
&nbsp;&nbsp;&nbsp;&nbsp;new winston.transports.File({ filename: 'combined.log' }),<br>
&nbsp;&nbsp;],<br>
});<br>
<br>
// If not in production, also log to the console<br>
if (process.env.NODE_ENV !== 'production') {<br>
&nbsp;&nbsp;logger.add(new winston.transports.Console({<br>
&nbsp;&nbsp;&nbsp;&nbsp;format: winston.format.simple(),<br>
&nbsp;&nbsp;}));<br>
}<br>
<br>
// Usage<br>
logger.log('info', 'Hello distributed log files!');<br>
logger.info('Hello again distributed logs');<br>
logger.error('Something went wrong', { additionalInfo: 'error details' });</div>
</div>

<h3>Custom Winston Formats</h3>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const winston = require('winston');<br>
const { format } = winston;<br>
const { combine, timestamp, label, printf } = format;<br>
<br>
// Custom format<br>
const myFormat = printf(({ level, message, label, timestamp }) => {<br>
&nbsp;&nbsp;return `${timestamp} [${label}] ${level}: ${message}`;<br>
});<br>
<br>
const logger = winston.createLogger({<br>
&nbsp;&nbsp;format: combine(<br>
&nbsp;&nbsp;&nbsp;&nbsp;label({ label: 'API Service' }),<br>
&nbsp;&nbsp;&nbsp;&nbsp;timestamp(),<br>
&nbsp;&nbsp;&nbsp;&nbsp;myFormat<br>
&nbsp;&nbsp;),<br>
&nbsp;&nbsp;transports: [<br>
...
<br>
logger.info('Application started');</div>
</div>

<h3>Pino</h3>
<p>Pino is designed to be a low-overhead logger with optimal performance:</p>

<div class="w3-example">
<h3>Basic Pino Setup</h3>
<div class="w3-code notranslate jsHigh">
const pino = require('pino');<br>
<br>
// Create a logger<br>
const logger = pino({<br>
&nbsp;&nbsp;level: 'info',<br>
&nbsp;&nbsp;timestamp: pino.stdTimeFunctions.isoTime,<br>
&nbsp;&nbsp;base: { pid: process.pid, hostname: require('os').hostname() }<br>
});<br>
<br>
// Usage<br>
logger.info('Application started');<br>
logger.info({ user: 'john' }, 'User logged in');<br>
logger.error({ err: new Error('Connection failed') }, 'Database connection error');</div>
</div>

<h3>Pino with Express</h3>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const express = require('express');<br>
const pino = require('pino');<br>
const pinoHttp = require('pino-http');<br>
<br>
const app = express();<br>
const logger = pino();<br>
const httpLogger = pinoHttp({ logger });<br>
<br>
// Add request logging middleware<br>
app.use(httpLogger);<br>
<br>
app.get('/', (req, res) => {<br>
&nbsp;&nbsp;req.log.info('User accessed homepage');<br>
&nbsp;&nbsp;res.send('Hello World!');<br>
});<br>
<br>
app.get('/error', (req, res) => {<br>
&nbsp;&nbsp;req.log.error('Something went wrong');<br>
&nbsp;&nbsp;res.status(500).send('Error!');<br>
});<br>
<br>
app.listen(8080, () => {<br>
&nbsp;&nbsp;logger.info('Server started on port 8080');<br>
});</div>
</div>

<h3>Bunyan</h3>
<p>Bunyan is a structured logging library with a CLI for viewing logs:</p>

<div class="w3-example">
<h3>Basic Bunyan Setup</h3>
<div class="w3-code notranslate jsHigh">
const bunyan = require('bunyan');<br>
<br>
// Create a logger<br>
const logger = bunyan.createLogger({<br>
&nbsp;&nbsp;name: 'myapp',<br>
&nbsp;&nbsp;streams: [<br>
&nbsp;&nbsp;&nbsp;&nbsp;{<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;level: 'info',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;stream: process.stdout<br>
&nbsp;&nbsp;&nbsp;&nbsp;},<br>
&nbsp;&nbsp;&nbsp;&nbsp;{<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;level: 'error',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;path: 'error.log'<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;],<br>
&nbsp;&nbsp;serializers: bunyan.stdSerializers<br>
});<br>
<br>
// Usage<br>
logger.info('Application started');<br>
...
<h2>Application Logging Best Practices</h2>

<h3>Log Levels</h3>
<p>Use appropriate log levels to categorize the importance and urgency of log messages:</p>

<ul>
  <li><strong>error:</strong> Runtime errors, exceptions, and failures that require attention</li>
  <li><strong>warn:</strong> Warning conditions that don't stop the application but indicate potential issues</li>
  <li><strong>info:</strong> Informational messages about application events and milestones</li>
  <li><strong>debug:</strong> Detailed diagnostic information useful during development</li>
  <li><strong>trace:</strong> Very detailed debugging information (method entry/exit, variable values)</li>
</ul>

<h3>What to Log</h3>

<div class="w3-panel ws-note">
<p><strong>DO LOG:</strong></p>
<ul>
  <li>Application startup/shutdown events</li>
  <li>Authentication and authorization events</li>
  <li>API requests and responses</li>
  <li>Database operations and performance metrics</li>
  <li>Errors and exceptions with context</li>
  <li>Resource usage and performance metrics</li>
...
<ul>
  <li>Passwords, tokens, API keys, or other credentials</li>
  <li>Personally identifiable information (PII) without proper safeguards</li>
  <li>Credit card numbers, social security numbers, or other sensitive data</li>
  <li>Session IDs or cookies</li>
  <li>Encryption keys</li>
</ul>
</div>

<h3>Contextual Logging</h3>
<p>Include relevant context with each log entry to make troubleshooting easier:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const winston = require('winston');<br>
<br>
// Create a base logger<br>
const logger = winston.createLogger({<br>
&nbsp;&nbsp;level: 'info',<br>
&nbsp;&nbsp;format: winston.format.json(),<br>
&nbsp;&nbsp;transports: [new winston.transports.Console()]<br>
});<br>
<br>
// Create a child logger with request context<br>
function createRequestLogger(req) {<br>
&nbsp;&nbsp;return logger.child({<br>
&nbsp;&nbsp;&nbsp;&nbsp;requestId: req.id,<br>
&nbsp;&nbsp;&nbsp;&nbsp;method: req.method,<br>
&nbsp;&nbsp;&nbsp;&nbsp;url: req.url,<br>
&nbsp;&nbsp;&nbsp;&nbsp;ip: req.ip,<br>
&nbsp;&nbsp;&nbsp;&nbsp;userId: req.user ? req.user.id : 'anonymous'<br>
&nbsp;&nbsp;});<br>
}<br>
<br>
// Usage in Express middleware<br>
app.use((req, res, next) => {<br>
&nbsp;&nbsp;req.id = generateRequestId();<br>
&nbsp;&nbsp;req.logger = createRequestLogger(req);<br>
&nbsp;&nbsp;req.logger.info('Request received');<br>
<br>
...
<br>
function generateRequestId() {<br>
&nbsp;&nbsp;return Date.now().toString(36) + Math.random().toString(36).substring(2);<br>
}</div>
</div>

<hr>

<h2>Log Management and Analysis</h2>

<h3>Log Rotation</h3>
<p>Prevent log files from growing too large by implementing log rotation:</p>

<div class="w3-example">
<h3>Winston with rotating file transport</h3>
<div class="w3-code notranslate jsHigh">
const winston = require('winston');<br>
require('winston-daily-rotate-file');<br>
<br>
const transport = new winston.transports.DailyRotateFile({<br>
&nbsp;&nbsp;filename: 'application-%DATE%.log',<br>
&nbsp;&nbsp;datePattern: 'YYYY-MM-DD',<br>
&nbsp;&nbsp;zippedArchive: true,<br>
&nbsp;&nbsp;maxSize: '20m',<br>
&nbsp;&nbsp;maxFiles: '14d'<br>
});<br>
<br>
...
&nbsp;&nbsp;transports: [<br>
&nbsp;&nbsp;&nbsp;&nbsp;transport,<br>
&nbsp;&nbsp;&nbsp;&nbsp;new winston.transports.Console()// Optional console transport<br>
&nbsp;&nbsp;]<br>
});<br>
<br>
logger.info('Hello rotated logs');</div>
</div>

<h3>Centralized Logging</h3>
<p>For applications running across multiple servers or containers, centralize your logs for easier analysis:</p>

<div class="w3-example">
<h3>Winston with Elasticsearch transport</h3>
<div class="w3-code notranslate jsHigh">
const winston = require('winston');<br>
require('winston-elasticsearch');<br>
<br>
const esTransportOpts = {<br>
&nbsp;&nbsp;level: 'info',<br>
&nbsp;&nbsp;clientOpts: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;node: 'http://localhost:9200'<br>
&nbsp;&nbsp;},<br>
&nbsp;&nbsp;indexPrefix: 'app-logs'<br>
};<br>
<br>
const logger = winston.createLogger({<br>
&nbsp;&nbsp;transports: [<br>
&nbsp;&nbsp;&nbsp;&nbsp;new winston.transports.Elasticsearch(esTransportOpts),<br>
&nbsp;&nbsp;&nbsp;&nbsp;new winston.transports.Console()// Optional console transport<br>
&nbsp;&nbsp;]<br>
});<br>
<br>
logger.info('This log will go to Elasticsearch');</div>
</div>

<h3>Popular Log Management Systems</h3>
<ul>
  <li><strong>ELK Stack</strong> (Elasticsearch, Logstash, Kibana): Comprehensive logging stack</li>
  <li><strong>Graylog</strong>: Centralized log management with a focus on security</li>
  <li><strong>Fluentd/Fluent Bit</strong>: Log collection and forwarding</li>
  <li><strong>Loki</strong>: Lightweight log aggregation system</li>
  <li><strong>Commercial options</strong>: Datadog, New Relic, Splunk, LogDNA, Loggly</li>
</ul>

<hr>

<h2>Logging in Production</h2>

<h3>Performance Considerations</h3>
<ul>
  <li><strong>Use asynchronous logging</strong> to avoid blocking the event loop</li>
  <li><strong>Buffer logs</strong> for better performance</li>
  <li><strong>Adjust log levels</strong> to reduce volume in production</li>
  <li><strong>Sample high-volume logs</strong> rather than logging every occurrence</li>
</ul>

<h3>Security Considerations</h3>
<ul>
  <li><strong>Sanitize sensitive data</strong> before logging</li>
  <li><strong>Protect log files</strong> with appropriate permissions</li>
  <li><strong>Use encryption</strong> when transmitting logs</li>
  <li><strong>Implement retention policies</strong> for log data</li>
  <li><strong>Verify compliance</strong> with relevant regulations (GDPR, HIPAA, etc.)</li>
</ul>

<div class="w3-example">
<h3>Data Sanitization Example</h3>
<div class="w3-code notranslate jsHigh">
const winston = require('winston');<br>
<br>
// Custom format to sanitize sensitive data<br>
const sanitizeFormat = winston.format((info) => {<br>
&nbsp;&nbsp;if (info.user && info.user.password) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;info.user.password = '[REDACTED]';<br>
&nbsp;&nbsp;}<br>
<br>
&nbsp;&nbsp;if (info.user && info.user.creditCard) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;info.user.creditCard = '[REDACTED]';<br>
&nbsp;&nbsp;}<br>
<br>
&nbsp;&nbsp;if (info.headers && info.headers.authorization) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;info.headers.authorization = '[REDACTED]';<br>
&nbsp;&nbsp;}<br>
<br>
&nbsp;&nbsp;return info;<br>
});<br>
...
<br>
// This sensitive data will be sanitized in the logs<br>
logger.info({<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;creditCard: '4111-1111-1111-1111'<br>
&nbsp;&nbsp;},<br>
&nbsp;&nbsp;headers: {<br>
...
<h3>Debug Module</h3>
<p>The <code class="w3-codespan">debug</code> module provides a lightweight way to add conditional debug logging:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const debug = require('debug');<br>
<br>
// Create named debuggers<br>
const dbDebug = debug('app:db');<br>
const apiDebug = debug('app:api');<br>
const authDebug = debug('app:auth');<br>
<br>
// Usage<br>
dbDebug('Connected to database');<br>
apiDebug('API request received at /users');<br>
authDebug('User authenticated: %o', { id: 123, roles: ['admin'] });<br>
<br>
// Enable with environment variable:<br>
// DEBUG=app:* node app.js<br>
// or<br>
// DEBUG=app:db,app:auth node app.js</div>
</div>

<h3>Correlation IDs</h3>
<p>Track requests across multiple services using correlation IDs:</p>
...
<br>
// Correlation ID middleware<br>
app.use((req, res, next) => {<br>
&nbsp;&nbsp;// Extract correlation ID from the request header or generate a new one<br>
&nbsp;&nbsp;const correlationId = req.headers['x-correlation-id'] || uuidv4();<br>
<br>
&nbsp;&nbsp;// Add it to the response headers<br>
&nbsp;&nbsp;res.setHeader('x-correlation-id', correlationId);<br>
<br>
&nbsp;&nbsp;// Add it to the request object<br>
&nbsp;&nbsp;req.correlationId = correlationId;<br>
<br>
&nbsp;&nbsp;// Create a request-specific logger<br>
&nbsp;&nbsp;req.logger = logger.child({ correlationId });<br>
<br>
&nbsp;&nbsp;req.logger.info({<br>
&nbsp;&nbsp;&nbsp;&nbsp;message: 'Request received',<br>
&nbsp;&nbsp;&nbsp;&nbsp;method: req.method,<br>
&nbsp;&nbsp;&nbsp;&nbsp;url: req.url<br>
&nbsp;&nbsp;});<br>
<br>
...
// Routes<br>
app.get('/', (req, res) => {<br>
&nbsp;&nbsp;req.logger.info('Processing home request');<br>
&nbsp;&nbsp;res.send('Hello World');<br>
});<br>
<br>
app.get('/error', (req, res) => {<br>
&nbsp;&nbsp;req.logger.error('Error occurred in request');<br>
&nbsp;&nbsp;res.status(500).send('Error');<br>
});<br>
<br>
app.listen(8080, () => {<br>
...
<h2>Summary</h2>
<ul>
  <li>Effective logging is crucial for debugging, monitoring, and troubleshooting Node.js applications</li>
  <li>Use structured logging with JSON format for better searchability and analysis</li>
  <li>Choose appropriate logging libraries like Winston, Pino, or Bunyan based on your needs</li>
  <li>Apply best practices: use proper log levels, include context, and protect sensitive data</li>
  <li>Implement log rotation and centralized logging for production environments</li>
  <li>Consider performance and security implications when designing your logging strategy</li>
  <li>Use correlation IDs to track requests through distributed systems</li>
</ul>

<hr>
<div id="exercisecontainer" src="xrcise_logging.js" data-extensions="asp"></div>
<hr>
<br>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="nodejs_deployment_modern.asp">&lt; Previous</a>
  <a class="w3-right w3-btn" href="nodejs_monitoring_observability.asp">Next &gt;</a>
</div>
