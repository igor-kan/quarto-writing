...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Promises</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js Promises">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_promises.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="Promises in Node.js provide a cleaner way to handle asynchronous operations compared to traditional callbacks.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Promises">
<meta name="twitter:description" content="Promises in Node.js provide a cleaner way to handle asynchronous operations compared to traditional callbacks.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_promises.png">
...
<h1>Node.js <span class="color_h1">Promises</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_async.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="nodejs_async_await.asp">Next &#10095;</a>
</div>
<hr>

<h2 id="intro">Introduction to Promises</h2>
<p>Promises in Node.js provide a cleaner way to handle asynchronous operations compared to traditional callbacks.</p>
<p>Promises represent the completion (or failure) of an asynchronous operation and its result.</p>
...
<div class="w3-panel ws-note">
  ...
  <p>Once a promise is settled (either fulfilled or rejected), its state cannot change.</p>
</div>
<hr>

<h2 id="why">Benefits of Using Promises</h2>
<div class="w3-example">
  <h3>With Callbacks</h3>
  <div class="w3-code notranslate jsHigh">
  getUser(id, (err, user) => {<br>
  &nbsp;&nbsp;if (err) return handleError(err);<br>
  &nbsp;&nbsp;getOrders(user.id, (err, orders) => {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;if (err) return handleError(err);<br>
  &nbsp;&nbsp;&nbsp;&nbsp;// Process orders...<br>
  &nbsp;&nbsp;});<br>
  });
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate jsHigh">
  getUser(id)<br>
  &nbsp;&nbsp;.then(user => getOrders(user.id))<br>
  &nbsp;&nbsp;.then(orders => processOrders(orders))<br>
  &nbsp;&nbsp;.catch(handleError);
  </div>
</div>
...
<div class="w3-panel ws-info">
  ...
  <ul>
    <li>Flatter code structure (avoids callback hell)</li>
    <li>Better error handling with single <code class="w3-codespan">.catch()</code></li>
    <li>Easier to compose and chain operations</li>
    <li>Built-in support for parallel operations</li>
  </ul>
</div>
<div class="w3-example">
<h3>Callback Hell Example (Without Promises)</h3>
<div class="w3-code notranslate jsHigh">
fs.readFile('file1.txt', (err, data1) => {<br>
&nbsp;&nbsp;if (err) throw err;<br>
&nbsp;&nbsp;fs.readFile('file2.txt', (err, data2) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (err) throw err;<br>
&nbsp;&nbsp;&nbsp;&nbsp;fs.readFile('file3.txt', (err, data3) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (err) throw err;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Use data1, data2, and data3<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;});<br>
});
</div>
...
<h2 id="create">Creating and Using Promises</h2>
<p>Promises can be created using the <code class="w3-codespan">Promise</code> constructor, which accepts an executor function with two parameters: <code class="w3-codespan">resolve</code> and <code class="w3-codespan">reject</code>.</p>
<div class="w3-example">
<h3>Basic Promise Creation</h3>
<div class="w3-code notranslate jsHigh">
// Create a new Promise<br>
const myPromise = new Promise((resolve, reject) => {<br>
&nbsp;&nbsp;// Simulate an async operation (e.g., API call, file read)<br>
&nbsp;&nbsp;setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const success = Math.random() > 0.5;<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (success) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;resolve('Operation completed successfully');<br>
&nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;reject(new Error('Operation failed'));<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp}, 1000); // Simulate delay<br>
});<br><br>
// Using the Promise<br>
myPromise<br>
&nbsp;&nbsp;.then(result => console.log('Success:', result))<br>
&nbsp;&nbsp;.catch(error => console.error('Error:', error.message));
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_promises_basic">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example: Reading a File with Promises</h3>
<div class="w3-code notranslate jsHigh">
const fs = require('fs').promises;<br>
const promise1 = Promise.resolve('First result');<br>
const promise2 = new Promise((resolve) => setTimeout(() => resolve('Second result'), 1000));<br>
const promise3 = fs.readFile('myfile.txt', 'utf8'); // Read local file instead of fetch<br>
<br>
Promise.all([promise1, promise2, promise3])<br>
&nbsp;&nbsp;.then(results => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Results:', results);<br>
&nbsp;&nbsp;&nbsp;&nbsp;// results[0] is from promise1<br>
&nbsp;&nbsp;&nbsp;&nbsp;// results[1] is from promise2<br>
&nbsp;&nbsp;&nbsp;&nbsp;// results[2] is the content of myfile.txt<br>
&nbsp;&nbsp;})<br>
&nbsp;&nbsp;.catch(error => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error('Error in one of the promises:', error);<br>
&nbsp;&nbsp;});
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_promises_readfile">Run example &raquo;</a>
</div>
<hr>
...
<h2 id="chaining">Promise Chaining</h2>
<p>Promises can be chained to execute asynchronous operations in sequence, with each <code class="w3-codespan">.then()</code> receiving the result of the previous operation.</p>
<div class="w3-example">
<h3>Example: Promise Chaining</h3>
<div class="w3-code notranslate jsHigh">
function getUser(userId) {<br>
&nbsp;&nbsp;return new Promise((resolve, reject) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Simulating database call<br>
&nbsp;&nbsp;&nbsp;&nbsp;setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;resolve({ id: userId, name: 'John' });<br>
&nbsp;&nbsp;&nbsp;&nbsp;}, 1000);<br>
&nbsp;&nbsp;});<br>
}<br><br>
function getUserPosts(user) {<br>
&nbsp;&nbsp;return new Promise((resolve, reject) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Simulating API call<br>
&nbsp;&nbsp;&nbsp;&nbsp;setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;resolve(['Post 1', 'Post 2', 'Post 3']);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}, 1000);<br>
&nbsp;&nbsp;});<br>
}<br><br>
// Chain the promises<br>
getUser(123)<br>
&nbsp;&nbsp;.then(user => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('User:', user);<br>
&nbsp;&nbsp;&nbsp;&nbsp;return getUserPosts(user);<br>
&nbsp;&nbsp;})<br>
&nbsp;&nbsp;.then(posts => {<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_promises_chaining">Try it Yourself &raquo;</a>
</div>
<hr>

<h2 id="methods">Promise Methods</h2>
  ...
  <div class="w3-third">
    <div class="w3-container w3-padding">
      ...
      <ul class="w3-ul w3-border">
        <li><code class="w3-codespan">then(onFulfilled, onRejected)</code><br>Handles fulfillment or rejection</li>
        <li><code class="w3-codespan">catch(onRejected)</code><br>Handles rejections</li>
        <li><code class="w3-codespan">finally(onFinally)</code><br>Runs after promise settles</li>
      </ul>
    </div>
  </div>
  <div class="w3-third">
    <div class="w3-container w3-padding">
      ...
      <ul class="w3-ul w3-border">
        <li><code class="w3-codespan">Promise.all(iterable)</code><br>Waits for all promises to resolve</li>
        <li><code class="w3-codespan">Promise.race(iterable)</code><br>Waits for first promise to settle</li>
        <li><code class="w3-codespan">Promise.allSettled(iterable)</code><br>Waits for all to settle</li>
      </ul>
    </div>
  </div>
  <div class="w3-third">
    <div class="w3-container w3-padding">
      ...
      <ul class="w3-ul w3-border">
        <li><code class="w3-codespan">Promise.resolve(value)</code><br>Creates a resolved promise</li>
        <li><code class="w3-codespan">Promise.reject(reason)</code><br>Creates a rejected promise</li>
      </ul>
    </div>
  </div>
</div>
<hr>
<h2>Promise.then()</h2>
<p>The <code class="w3-codespan">then()</code> method takes up to two arguments. The arguments are callback functions for the success and failure cases for the Promise.</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
myPromise<br>
&nbsp;&nbsp;.then(<br>
&nbsp;&nbsp;&nbsp;&nbsp;result => console.log(result),<br>
&nbsp;&nbsp;&nbsp;&nbsp;error => console.error(error)<br>
&nbsp;&nbsp;);
</div>
</div>
<hr>
<h2>Promise.catch()</h2>
<p>The <code class="w3-codespan">catch()</code> method handles rejected promises and is equivalent to <code class="w3-codespan">.then(null, errorHandler)</code>.</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
myPromise<br>
...
<p>The <code class="w3-codespan">finally()</code> method executes code regardless of whether the promise is fulfilled or rejected.</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
myPromise<br>
&nbsp;&nbsp;.then(result => console.log(result))<br>
...
<p><code class="w3-codespan">Promise.all()</code> is used to run multiple promises in parallel, and wait for ALL of them to complete. It fails fast if any promise rejects.</p>
<div class="w3-example">
<h3>Example: Running Multiple Promises in Parallel</h3>
<div class="w3-code notranslate jsHigh">
const fs = require('fs').promises;<br>
const promise1 = Promise.resolve('First result');<br>
const promise2 = new Promise((resolve) => setTimeout(() => resolve('Second result'), 1000));<br>
const promise3 = fs.readFile('data.txt', 'utf8'); // Read local file instead of fetch<br>
<br>
Promise.all([promise1, promise2, promise3])<br>
&nbsp;&nbsp;.then(results => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Results:', results);<br>
&nbsp;&nbsp;&nbsp;&nbsp;// results[0] is from promise1<br>
&nbsp;&nbsp;&nbsp;&nbsp;// results[1] is from promise2<br>
&nbsp;&nbsp;&nbsp;&nbsp;// results[2] is the content of data.txt<br>
&nbsp;&nbsp;})<br>
&nbsp;&nbsp;.catch(error => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error('Error in one of the promises:', error);<br>
&nbsp;&nbsp;});
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_promises_all">Run example &raquo;</a>
</div>

<hr>
<h2>Promise.race() for First Result</h2>
<p><code class="w3-codespan">Promise.race()</code> is useful when you need the result of the first settled promise, whether it's fulfilled or rejected.</p>

<div class="w3-example">
<h3>Example: Timeout Pattern with Promise.race()</h3>
<div class="w3-code notranslate jsHigh">
const promise1 = new Promise(resolve => setTimeout(() => resolve('First result'), 1000));<br>
const promise2 = new Promise(resolve => setTimeout(() => resolve('Second result'), 500));<br>
<br>
Promise.race([promise1, promise2])<br>
&nbsp;&nbsp;.then(result => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Fastest result:', result);<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Will log 'Second result' because promise2 is faster<br>
&nbsp;&nbsp;});</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_promises_race">Try it Yourself &raquo;</a>
</div>
<hr>

<h2 id="error">Error Handling in Promises</h2>
<p>Proper error handling is important.</p>
<p>Promises provide several ways to handle errors:</p>
<div class="w3-example">
<h3>Example: Error Handling in Promise</h3>
<div class="w3-code notranslate jsHigh">
...
fetchData()<br>
&nbsp;&nbsp;.then(<br>
&nbsp;&nbsp;&nbsp;&nbsp;data => console.log('Data:', data),<br>
&nbsp;&nbsp;&nbsp;&nbsp;error => console.log('Error handled in then:', error.message)<br>
&nbsp;&nbsp;);<br><br>
// Alternative method using catch<br>
fetchData()<br>
&nbsp;&nbsp;.then(data => console.log('Data:', data))<br>
&nbsp;&nbsp;.catch(error => console.log('Error handled in catch:', error.message));
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_promises_error">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
<p><strong>Best Practice:</strong> Always include error handling with promises using <code class="w3-codespan">.catch()</code> to prevent unhandled promise rejections, which can lead to silent failures and memory leaks.</p>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_promises.js" data-extensions="asp"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_async.asp">&#10094; Previous</a>
