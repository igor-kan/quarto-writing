...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Socket.IO</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js Socket.IO">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_socketio.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="Socket.IO is a powerful JavaScript library that enables real-time, bidirectional, and event-based communication between web clients and servers.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Socket.IO">
<meta name="twitter:description" content="Socket.IO is a powerful JavaScript library that enables real-time, bidirectional, and event-based communication between web clients and servers.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_socketio.png">
...
<a class="w3-left w3-btn" href="nodejs_graphql.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="nodejs_websockets.asp">Next &#10095;</a>
</div>

<hr>

<h2 id="what-is">What is Socket.IO?</h2>


<p>Socket.IO is a powerful JavaScript library that enables real-time, bidirectional, and event-based communication between web clients and servers. It's designed to work on every platform, browser, or device, focusing equally on reliability and speed.</p>

<h3>Key Features</h3>
<ul>
  <li><strong>Real-time bidirectional communication</strong> - Enables instant data transfer between clients and servers</li>
  <li><strong>Automatic reconnection</strong> - Handles disconnections and reconnections automatically</li>
  <li><strong>Room support</strong> - Easily create channels for group communication</li>
  <li><strong>Binary support</strong> - Send and receive binary data (ArrayBuffer, Blob, File, etc.)</li>
  <li><strong>Multiplexing</strong> - Handle multiple sockets with namespaces</li>
  <li><strong>Fallback options</strong> - Automatically falls back to HTTP long-polling if WebSockets aren't available</li>
</ul>
...
<p>Socket.IO consists of two parts:</p>
<ul>
  <li>A client-side library that runs in the browser</li>
  <li>A server-side library for Node.js</li>
</ul>

<hr>

<h2 id="installation">Installing Socket.IO</h2>

<h3>Server-Side Installation</h3>
<p>Install Socket.IO in your Node.js project using npm or yarn:</p>
...
<p>Choose one of the following methods to include the client library:</p>
<div class="w3-example">
<h4>Option 1: CDN (Quick Start)</h4>
<div class="w3-code notranslate htmlHigh">
  &lt;script src="https://cdn.socket.io/4.5.0/socket.io.min.js"&gt;&lt;/script&gt;
</div>
</div>
<div class="w3-example">
<h4>Option 2: NPM (Recommended for Production)</h4>
<div class="w3-code notranslate">
# Install the client library<br>
...
<div class="w3-example">
<h4>Option 3: Using ES6 Modules</h4>
...
<table class="ws-table-all w3-margin-top">
  ...
  <tr>
    <td>v4.x</td>
    <td>v12.22.0+</td>
    <td>Chrome 49+, Firefox 53+, Safari 10+</td>
  </tr>
  <tr>
    <td>v3.x</td>
    <td>v10.0.0+</td>
  ...
  <tr>
    <td>v2.x</td>
    <td>v6.0.0+</td>
    <td>Chrome 5+, Firefox 6+, Safari 5.1+</td>
  </tr>
</table>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> For production, it's recommended to use the same version on both client and server.</p>
</div>
...
<hr>
<h2>Simple Chat Application with Socket.IO</h2>

<p>Let's build a simple real-time chat application using Node.js and Socket.IO.</p>
<p>This example doesn't require any login and demonstrates the basic functionality.</p>

<h3>Create the Server (app.js)</h3>

<p>Create a new file named <code class="w3-codespan">app.js</code> with the following content:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
...
<br>
// Socket.IO connection handler<br>
io.on('connection', (socket) => {<br>
&nbsp;&nbsp;console.log('A user connected');<br>
<br>
&nbsp;&nbsp;// Handle new messages<br>
&nbsp;&nbsp;socket.on('chat message', (msg) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Message received:', msg);<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;console.log('A user disconnected');<br>
&nbsp;&nbsp;});<br>
});<br>
<br>
...
<h3>Create the Client (public/index.html)</h3>

<p>Create a <code class="w3-codespan">public</code> directory and add an <code class="w3-codespan">index.html</code> file with this content:</p>
<div class="w3-example">
<div class="w3-code notranslate htmlHigh">
&lt;!DOCTYPE html&gt;<br>
&lt;html&gt;<br>
&lt;head&gt;<br>
&nbsp;&nbsp;&lt;title&gt;Simple Chat&lt;/title&gt;<br>
&nbsp;&nbsp;&lt;style&gt;<br>
&nbsp;&nbsp;body { <br>
&nbsp;&nbsp;&nbsp;&nbsp;margin: 0; <br>
&nbsp;&nbsp;&nbsp;&nbsp;padding: 20px; <br>
...
&nbsp;&nbsp;&lt;form id="form" action="#"&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;input id="input" autocomplete="off" placeholder="Type your message..." /&gt;<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;e.preventDefault();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const message = input.value.trim();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (message) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Emit the message to the server<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;socket.emit('chat message', message);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Clear the input<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;input.value = '';<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Listen for incoming messages<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;socket.on('chat message', (msg) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const item = document.createElement('li');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;item.textContent = msg;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;messages.appendChild(item);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Scroll to the bottom<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;messages.scrollTop = messages.scrollHeight;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;/script&gt;<br>
&lt;/body&gt;<br>
&lt;/html&gt;
...
<li>Open your browser and navigate to <code class="w3-codespan">http://localhost:3000</code></li>
<li>Open multiple browser windows to see the real-time updates</li>
</ol>

<h3>How It Works</h3>

<ol>
    <li>The server uses Express to serve the static files and handle the Socket.IO connection</li>
    <li>When a client connects, they can send messages that get broadcast to all connected clients</li>
    <li>The client-side JavaScript handles sending and receiving messages in real-time</li>
</ol>

<h3>Next Steps</h3>

<p>Once you have this basic version working, you might want to add:</p>
<ul>
    <li>Usernames for each message</li>
    <li>User join/leave notifications</li>
    <li>Different chat rooms</li>
    <li>Message persistence</li>
    <li>User authentication</li>
</ul>

<div class="w3-panel w3-note">
    <p><strong>Note:</strong> This is a basic example for demonstration purposes. In a production environment, you would want to add proper error handling, input validation, and security measures.</p>
</div>

<hr>

<h2>Adding Usernames</h2>

<p>Let's enhance our chat by adding usernames to messages. First, modify the server to handle usernames:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// In app.js, modify the connection handler<br>
io.on('connection', (socket) => {<br>
&nbsp;&nbsp;console.log('A user connected');<br>
<br>
&nbsp;&nbsp;// Store username with socket<br>
&nbsp;&nbsp;socket.username = 'Anonymous';
<br>
&nbsp;&nbsp;// Handle new messages with username<br>
&nbsp;&nbsp;socket.on('chat message', (msg) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;io.emit('chat message', {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;username: socket.username,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;message: msg,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;timestamp: new Date().toISOString()<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;});
<br>
&nbsp;&nbsp;// Handle username change<br>
&nbsp;&nbsp;socket.on('set username', (username) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const oldUsername = socket.username;<br>
&nbsp;&nbsp;&nbsp;&nbsp;socket.username = username || 'Anonymous';<br>
&nbsp;&nbsp;&nbsp;&nbsp;io.emit('user joined', {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;oldUsername: oldUsername,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;newUsername: socket.username<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;});<br>
<br>
&nbsp;&nbsp;// Handle disconnection<br>
&nbsp;&nbsp;socket.on('disconnect', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('A user disconnected');<br>
&nbsp;&nbsp;&nbsp;&nbsp;io.emit('user left', { username: socket.username });<br>
&nbsp;&nbsp;});<br>
});<br>
</div>
</div>

<p>Now, update the client to handle usernames:</p>

<div class="w3-example">
<div class="w3-code notranslate htmlHigh">
&lt;!-- Add username input at the top of the chat --&gt;<br>
&lt;div id="username-container"&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;input type="text" id="username-input" placeholder="Enter your username" /&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;button id="set-username"&gt;Set Username&lt;/button&gt;<br>
&lt;/div&gt;<br>
<br>
&lt;script&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Add username handling<br>
&nbsp;&nbsp;&nbsp;&nbsp;const usernameInput = document.getElementById('username-input');<br>
&nbsp;&nbsp;&nbsp;&nbsp;const setUsernameBtn = document.getElementById('set-username');<br>
&nbsp;&nbsp;&nbsp;&nbsp;let currentUsername = 'Anonymous';<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;setUsernameBtn.addEventListener('click', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const newUsername = usernameInput.value.trim();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (newUsername) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;socket.emit('set username', newUsername);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;currentUsername = newUsername;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;usernameInput.value = '';<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Update message display to show usernames<br>
&nbsp;&nbsp;&nbsp;&nbsp;socket.on('chat message', (data) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const item = document.createElement('li');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;item.innerHTML = `&lt;strong&gt;${data.username}:&lt;/strong&gt; ${data.message}`;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;messages.appendChild(item);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;messages.scrollTop = messages.scrollHeight;<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Handle user join notifications<br>
&nbsp;&nbsp;&nbsp;&nbsp;socket.on('user joined', (data) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const item = document.createElement('li');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;item.className = 'system-message';<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (data.oldUsername === 'Anonymous') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;item.textContent = `${data.newUsername} has joined the chat`;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;item.textContent = `${data.oldUsername} is now known as ${data.newUsername}`;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;messages.appendChild(item);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;messages.scrollTop = messages.scrollHeight;<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Handle user leave notifications<br>
&nbsp;&nbsp;&nbsp;&nbsp;socket.on('user left', (data) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const item = document.createElement('li');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;item.className = 'system-message';<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;item.textContent = `${data.username} has left the chat`;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;messages.appendChild(item);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;messages.scrollTop = messages.scrollHeight;<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&lt;/script&gt;<br>
...
<h2>Adding Chat Rooms</h2>

<p>Let's add the ability to create and join different chat rooms. First, update the server:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// In app.js, add room handling<br>
const rooms = new Set(['general', 'random']);<br>
<br>
io.on('connection', (socket) => {<br>
&nbsp;&nbsp;// ... existing code ...<br>
<br>
&nbsp;&nbsp;// Join a room<br>
&nbsp;&nbsp;socket.on('join room', (room) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Leave all rooms except the default one<br>
&nbsp;&nbsp;&nbsp;&nbsp;socket.rooms.forEach(r => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (r !== socket.id) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;socket.leave(r);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;socket.emit('left room', r);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Join the new room<br>
&nbsp;&nbsp;&nbsp;&nbsp;socket.join(room);<br>
&nbsp;&nbsp;&nbsp;&nbsp;socket.emit('joined room', room);<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Notify others in the room<br>
&nbsp;&nbsp;&nbsp;&nbsp;socket.to(room).emit('room message', {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;username: 'System',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;message: `${socket.username} has joined the room`,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;timestamp: new Date().toISOString()<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;});<br>
<br>
&nbsp;&nbsp;// Handle room creation<br>
&nbsp;&nbsp;socket.on('create room', (roomName) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (!rooms.has(roomName)) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;rooms.add(roomName);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;io.emit('room created', roomName);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;});<br>
<br>
&nbsp;&nbsp;// Modify message handler to send to room<br>
&nbsp;&nbsp;socket.on('chat message', (data) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const room = Array.from(socket.rooms).find(r => r !== socket.id) || 'general';<br>
&nbsp;&nbsp;&nbsp;&nbsp;io.to(room).emit('chat message', {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;username: socket.username,<br>
...
<p>Update the client to handle rooms:</p>

<div class="w3-example">
<div class="w3-code notranslate htmlHigh">
&lt;div id="chat-container"&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;div id="sidebar"&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;h3&gt;Rooms&lt;/h3&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;ul id="room-list"&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;li class="room active" data-room="general"&gt;General&lt;/li&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;li class="room" data-room="random"&gt;Random&lt;/li&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/ul&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;div id="create-room"&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;input type="text" id="new-room" placeholder="New room name" /&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;button id="create-room-btn"&gt;Create Room&lt;/button&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/div&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;/div&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;div id="chat-area"&gt;<br>
...
&lt;script&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Room handling<br>
&nbsp;&nbsp;&nbsp;&nbsp;const roomList = document.getElementById('room-list');<br>
&nbsp;&nbsp;&nbsp;&nbsp;const newRoomInput = document.getElementById('new-room');<br>
&nbsp;&nbsp;&nbsp;&nbsp;const createRoomBtn = document.getElementById('create-room-btn');<br>
&nbsp;&nbsp;&nbsp;&nbsp;let currentRoom = 'general';<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Join room when clicking on room in the list<br>
&nbsp;&nbsp;&nbsp;&nbsp;roomList.addEventListener('click', (e) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (e.target.classList.contains('room')) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const room = e.target.dataset.room;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;socket.emit('join room', room);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;currentRoom = room;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;document.querySelectorAll('.room').forEach(r => r.classList.remove('active'));<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;e.target.classList.add('active');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Create new room<br>
&nbsp;&nbsp;&nbsp;&nbsp;createRoomBtn.addEventListener('click', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const roomName = newRoomInput.value.trim();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (roomName && !document.querySelector(`[data-room="${roomName}"]`)) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;socket.emit('create room', roomName);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;newRoomInput.value = '';<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Handle new room creation<br>
&nbsp;&nbsp;&nbsp;&nbsp;socket.on('room created', (roomName) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const roomItem = document.createElement('li');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;roomItem.className = 'room';<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;roomItem.dataset.room = roomName;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;roomItem.textContent = roomName;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;roomList.appendChild(roomItem);<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Handle room join confirmation<br>
&nbsp;&nbsp;&nbsp;&nbsp;socket.on('joined room', (room) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const item = document.createElement('li');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;item.className = 'system-message';<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;item.textContent = `You joined ${room}`;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;messages.appendChild(item);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;currentRoom = room;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;messages.scrollTop = messages.scrollHeight;<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Handle room messages<br>
&nbsp;&nbsp;&nbsp;&nbsp;socket.on('room message', (data) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const item = document.createElement('li');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;item.className = 'system-message';<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;item.textContent = data.message;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;messages.appendChild(item);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;messages.scrollTop = messages.scrollHeight;<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&lt;/script&gt;<br>
...
<h2>Adding User List and Typing Indicators</h2>

<p>Let's enhance our chat with a user list and typing indicators. First, update the server to track users and typing status:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// In app.js, track users and typing status<br>
const usersInRooms = new Map();<br>
const typingUsers = new Map();<br>
<br>
io.on('connection', (socket) => {<br>
&nbsp;&nbsp; // ... existing code ...<br>
<br>
&nbsp;&nbsp; // Initialize user data<br>
&nbsp;&nbsp; socket.on('join room', (room) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp; // ... existing join room code ...<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp; // Initialize user data for the room<br>
&nbsp;&nbsp;&nbsp;&nbsp; if (!usersInRooms.has(room)) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; usersInRooms.set(room, new Map());<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; typingUsers.set(room, new Set());<br>
&nbsp;&nbsp;&nbsp;&nbsp; }<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp; // Add user to room<br>
&nbsp;&nbsp;&nbsp;&nbsp; usersInRooms.get(room).set(socket.id, {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; username: socket.username,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; id: socket.id<br>
&nbsp;&nbsp;&nbsp;&nbsp; });<br>
&nbsp;&nbsp;&nbsp;&nbsp; <br>
&nbsp;&nbsp;&nbsp;&nbsp; // Send updated user list to room<br>
&nbsp;&nbsp;&nbsp;&nbsp; updateUserList(room);<br>
&nbsp;&nbsp; });<br>
<br>
&nbsp;&nbsp; // Handle typing status<br>
&nbsp;&nbsp; socket.on('typing', (isTyping) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp; const room = Array.from(socket.rooms).find(r => r !== socket.id);<br>
&nbsp;&nbsp;&nbsp;&nbsp; if (!room) return;<br>
&nbsp;&nbsp;&nbsp;&nbsp; <br>
&nbsp;&nbsp;&nbsp;&nbsp; if (isTyping) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; typingUsers.get(room).add(socket.username);<br>
&nbsp;&nbsp;&nbsp;&nbsp; } else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; typingUsers.get(room).delete(socket.username);<br>
&nbsp;&nbsp;&nbsp;&nbsp; }<br>
&nbsp;&nbsp;&nbsp;&nbsp; <br>
&nbsp;&nbsp;&nbsp;&nbsp; // Notify room about typing users<br>
&nbsp;&nbsp;&nbsp;&nbsp; io.to(room).emit('typing users', Array.from(typingUsers.get(room)));<br>
&nbsp;&nbsp; });<br>
<br>
&nbsp;&nbsp; // Handle disconnection<br>
&nbsp;&nbsp; socket.on('disconnect', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp; // Remove from all rooms<br>
&nbsp;&nbsp;&nbsp;&nbsp; Array.from(usersInRooms.entries()).forEach(([room, users]) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if (users.has(socket.id)) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; users.delete(socket.id);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; typingUsers.get(room)?.delete(socket.username);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; updateUserList(room);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; }<br>
&nbsp;&nbsp;&nbsp;&nbsp; }<br>
...
&nbsp;&nbsp; });<br>
<br>
&nbsp;&nbsp; // Helper function to update user list for a room<br>
&nbsp;&nbsp; function updateUserList(room) {<br>
&nbsp;&nbsp;&nbsp;&nbsp; const users = Array.from(usersInRooms.get(room)?.values() || []);<br>
&nbsp;&nbsp;&nbsp;&nbsp; io.to(room).emit('user list', {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; room: room,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; users: users.map(u => ({<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; username: u.username,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; isTyping: typingUsers.get(room)?.has(u.username) || false<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; }))<br>
&nbsp;&nbsp;&nbsp;&nbsp; });<br>
&nbsp;&nbsp; }<br>
&nbsp;&nbsp; });<br>
...
<p>Update the client to show the user list and handle typing indicators:</p>
...
&nbsp;&nbsp;&nbsp;&nbsp;&lt;h3&gt;Rooms&lt;/h3&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;ul id="room-list"&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;!-- Room list will be populated here --&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;/ul&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;div id="create-room"&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;input type="text" id="new-room" placeholder="New room name" /&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;button id="create-room-btn"&gt;Create Room&lt;/button&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;/div&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;h3&gt;Users in Room&lt;/h3&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;ul id="user-list"&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;!-- User list will be populated here --&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;/ul&gt;<br>
&nbsp;&nbsp;&lt;/div&gt;<br>
&nbsp;&nbsp;&lt;div id="chat-area"&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;div id="typing-indicator"&gt;&lt;/div&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;div id="messages"&gt;&lt;/div&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;form id="form"&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;input id="input" autocomplete="off" placeholder="Type a message..." /&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;button&gt;Send&lt;/button&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;/form&gt;<br>
&nbsp;&nbsp;&lt;/div&gt;<br>
&lt;/div&gt;<br>
...
&nbsp;&nbsp; // ... existing code ...<br>
<br>
&nbsp;&nbsp; const userList = document.getElementById('user-list');<br>
&nbsp;&nbsp; const typingIndicator = document.getElementById('typing-indicator');<br>
&nbsp;&nbsp; const messageInput = document.getElementById('input');<br>
&nbsp;&nbsp; let typingTimeout;<br>
<br>
&nbsp;&nbsp; // Handle typing events<br>
&nbsp;&nbsp; messageInput.addEventListener('input', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp; // User is typing<br>
&nbsp;&nbsp;&nbsp;&nbsp; if (!typingTimeout) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; socket.emit('typing', true);<br>
&nbsp;&nbsp;&nbsp;&nbsp; }<br>
&nbsp;&nbsp;&nbsp;&nbsp; <br>
&nbsp;&nbsp;&nbsp;&nbsp; // Clear previous timeout<br>
&nbsp;&nbsp;&nbsp;&nbsp; clearTimeout(typingTimeout);<br>
&nbsp;&nbsp;&nbsp;&nbsp; <br>
&nbsp;&nbsp;&nbsp;&nbsp; // Set a timeout to indicate user stopped typing<br>
&nbsp;&nbsp;&nbsp;&nbsp; typingTimeout = setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; socket.emit('typing', false);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; typingTimeout = null;<br>
&nbsp;&nbsp;&nbsp;&nbsp; }, 1000);<br>
&nbsp;&nbsp; });<br>
<br>
&nbsp;&nbsp; // Handle form submission<br>
&nbsp;&nbsp; form.addEventListener('submit', (e) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp; e.preventDefault();<br>
&nbsp;&nbsp;&nbsp;&nbsp; if (messageInput.value.trim()) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; socket.emit('chat message', {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; message: messageInput.value,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; room: currentRoom<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; });<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; messageInput.value = '';<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Clear typing status<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if (typingTimeout) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; clearTimeout(typingTimeout);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; typingTimeout = null;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; socket.emit('typing', false);<br>
...
<br>
&nbsp;&nbsp; // Update user list<br>
&nbsp;&nbsp; socket.on('user list', (data) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp; if (data.room === currentRoom) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; userList.innerHTML = '';<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; data.users.forEach(user => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; const userItem = document.createElement('li');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; userItem.textContent = user.username;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if (user.isTyping) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; userItem.innerHTML += ' &lt;span class="typing"&gt;typing...&lt;/span&gt;';<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; }<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; userList.appendChild(userItem);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; });<br>
&nbsp;&nbsp;&nbsp;&nbsp; }<br>
&nbsp;&nbsp; });<br>
<br>
&nbsp;&nbsp; // Update typing indicator<br>
&nbsp;&nbsp; socket.on('typing users', (usernames) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp; const typingUsers = usernames.filter(u => u !== currentUsername);<br>
&nbsp;&nbsp;&nbsp;&nbsp; if (typingUsers.length > 0) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; typingIndicator.textContent = `${typingUsers.join(', ')} ${typingUsers.length > 1 ? 'are' : 'is'} typing...`;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; typingIndicator.style.display = 'block';<br>
&nbsp;&nbsp;&nbsp;&nbsp; } else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; typingIndicator.style.display = 'none';<br>
&nbsp;&nbsp;&nbsp;&nbsp; }<br>
&nbsp;&nbsp; });<br>
&lt;/script&gt;<br>
<br>
&lt;style&gt;<br>
&nbsp;&nbsp; /* Add to existing styles */<br>
&nbsp;&nbsp; #typing-indicator {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; color: #666;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; font-style: italic;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; font-size: 0.9em;<br>
...
<h2>Client-Side API Overview</h2>

<p>The client-side Socket.IO API provides methods for:</p>

<ul>
  <li><code class="w3-codespan">io()</code> - Connects to the server</li>
  <li><code class="w3-codespan">socket.emit()</code> - Sends an event to the server</li>
  <li><code class="w3-codespan">socket.on()</code> - Listens for events from the server</li>
  <li><code class="w3-codespan">socket.disconnect()</code> - Disconnects from the server</li>
</ul>
...
<p>Socket.IO uses an event-based architecture for communication. Here are some key events:</p>

<h3>Built-in Events</h3>
<ul>
  <li><code class="w3-codespan">connect</code> - Fired upon connection</li>
  <li><code class="w3-codespan">disconnect</code> - Fired upon disconnection</li>
  <li><code class="w3-codespan">error</code> - Fired upon an error</li>
  <li><code class="w3-codespan">reconnect</code> - Fired upon successful reconnection</li>
  <li><code class="w3-codespan">reconnect_attempt</code> - Fired upon reconnection attempt</li>
</ul>

<hr>

<h2>Socket.IO Middleware</h2>

<p>Socket.IO allows you to define middleware functions for authentication and other purposes:</p>
...
io.use((socket, next) => {<br>
&nbsp;&nbsp;const token = socket.handshake.auth.token;<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;if (!token) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;return next(new Error('Authentication error: Token missing'));<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Verify token (example with JWT)<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const user = jwt.verify(token, 'your-secret-key');<br>
&nbsp;&nbsp;&nbsp;&nbsp;socket.user = user;<br>
&nbsp;&nbsp;&nbsp;&nbsp;next();<br>
&nbsp;&nbsp;} catch (error) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;next(new Error('Authentication error: Invalid token'));<br>
&nbsp;&nbsp;}<br>
});<br>
<br>
io.on('connection', (socket) => {<br>
&nbsp;&nbsp;console.log(`Authenticated user connected: ${socket.user.username}`);<br>
});</div>
</div>

<hr>

<h2>Socket.IO vs Native WebSockets</h2>
...
&nbsp;&nbsp;&nbsp;&nbsp;<th>Feature</th>
&nbsp;&nbsp;&nbsp;&nbsp;<th>Socket.IO</th>
&nbsp;&nbsp;&nbsp;&nbsp;<th>Native WebSockets</th>
&nbsp;&nbsp;</tr>
&nbsp;&nbsp;<tr>
&nbsp;&nbsp;&nbsp;&nbsp;<td>Fallback Mechanisms</td>
&nbsp;&nbsp;&nbsp;&nbsp;<td>Yes (HTTP long-polling, etc.)</td>
&nbsp;&nbsp;&nbsp;&nbsp;<td>No</td>
&nbsp;&nbsp;</tr>
&nbsp;&nbsp;<tr>
&nbsp;&nbsp;&nbsp;&nbsp;<td>Automatic Reconnection</td>
&nbsp;&nbsp;&nbsp;&nbsp;<td>Yes</td>
&nbsp;&nbsp;&nbsp;&nbsp;<td>No (must implement)</td>
&nbsp;&nbsp;</tr>
&nbsp;&nbsp;<tr>
&nbsp;&nbsp;&nbsp;&nbsp;<td>Broadcasting</td>
&nbsp;&nbsp;&nbsp;&nbsp;<td>Built-in</td>
...
&nbsp;&nbsp;<tr>
&nbsp;&nbsp;&nbsp;&nbsp;<td>Packet Size</td>
&nbsp;&nbsp;&nbsp;&nbsp;<td>Larger (protocol overhead)</td>
&nbsp;&nbsp;&nbsp;&nbsp;<td>Smaller</td>
&nbsp;&nbsp;</tr>
&nbsp;&nbsp;<tr>
&nbsp;&nbsp;&nbsp;&nbsp;<td>Binary Data</td>
...
<p>Socket.IO is preferred when you need reliability, compatibility, and higher-level features, while native WebSockets are more lightweight and have less overhead.</p>
<hr>

<div id="exercisecontainer" src="xrcise_socketio.js" data-extensions="asp"></div>
