...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Error Handling</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js Error Handling">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_error_handling.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="Errors are inevitable in any program, but how you handle them makes all the difference.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Error Handling">
<meta name="twitter:description" content="Errors are inevitable in any program, but how you handle them makes all the difference.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_error_handling.png">
...
<h1>Node.js <span class="color_h1">Error Handling</span></h1>
...
<p>Errors are inevitable in any program, but how you handle them makes all the difference. In Node.js, proper error handling is crucial because:</p>
<ul>
  <li>It prevents applications from crashing unexpectedly</li>
  <li>It provides meaningful feedback to users</li>
  <li>It makes debugging easier with proper error context</li>
  <li>It helps maintain application stability in production</li>
  <li>It ensures resources are properly cleaned up</li>
</ul>
<hr>

<h2>Common Error Types in Node.js</h2>
<p>Understanding different error types helps in handling them appropriately:</p>

<div class="w3-example">
<h3>1. Standard JavaScript Errors</h3>
<div class="w3-code notranslate jsHigh">
// SyntaxError<br>
JSON.parse('{invalid json}');<br><br>

// TypeError<br>
null.someProperty;<br><br>
...
<div class="w3-example">
<h3>2. System Errors</h3>
<div class="w3-code notranslate jsHigh">
// ENOENT: No such file or directory<br>
const fs = require('fs');<br>
fs.readFile('nonexistent.txt', (err) => {<br>
&nbsp;&nbsp;console.error(err.code); // 'ENOENT'<br>
});<br><br>

// ECONNREFUSED: Connection refused<br>
const http = require('http');<br>
const req = http.get('http://nonexistent-site.com', (res) => {});<br>
req.on('error', (err) => {<br>
&nbsp;&nbsp;console.error(err.code); // 'ECONNREFUSED' or 'ENOTFOUND'<br>
});
</div>
</div>
<hr>
<h2>Basic Error Handling</h2>
<p>Node.js follows several patterns for error handling:</p>

<h3>Error-First Callbacks</h3>
<p>The most common pattern in Node.js core modules where the first argument to a callback is an error object (if any occurred).</p>
<div class="w3-example">
<h3>Example: Error-First Callback</h3>
<div class="w3-code notranslate jsHigh">
const fs = require('fs');<br><br>

function readConfigFile(filename, callback) {<br>
&nbsp;&nbsp;fs.readFile(filename, 'utf8', (err, data) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Handle specific error types<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (err.code === 'ENOENT') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return callback(new Error(`Config file ${filename} not found`));<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;} else if (err.code === 'EACCES') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return callback(new Error(`No permission to read ${filename}`));<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// For all other errors<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return callback(err);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br><br>
    
&nbsp;&nbsp;&nbsp;&nbsp;// Process data if no error<br>
&nbsp;&nbsp;&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const config = JSON.parse(data);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;callback(null, config);<br>
&nbsp;&nbsp;&nbsp;&nbsp;} catch (parseError) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;callback(new Error(`Invalid JSON in ${filename}`));<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;});<br>
}<br>
<br>
// Usage<br>
readConfigFile('config.json', (err, config) => {<br>
&nbsp;&nbsp;if (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error('Failed to read config:', err.message);<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Handle the error (e.g., use default config)<br>
&nbsp;&nbsp;&nbsp;&nbsp;return;<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;console.log('Config loaded successfully:', config);<br>
});
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_error_callback">Run example &raquo;</a>
</div>
<hr>

<h2>Modern Error Handling</h2>

<h3>Using try...catch with Async/Await</h3>
<p>With async/await, you can use try/catch blocks for both synchronous and asynchronous code:</p>
<div class="w3-example">
<h3>Example: try/catch with Async/Await</h3>
<div class="w3-code notranslate jsHigh">
const fs = require('fs').promises;<br><br>

async function loadUserData(userId) {<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const data = await fs.readFile(`users/${userId}.json`, 'utf8');<br>
&nbsp;&nbsp;&nbsp;&nbsp;const user = JSON.parse(data);<br><br>
    
&nbsp;&nbsp;&nbsp;&nbsp;if (!user.email) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;throw new Error('Invalid user data: missing email');<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br><br>
    
&nbsp;&nbsp;&nbsp;&nbsp;return user;<br>
&nbsp;&nbsp;} catch (error) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Handle different error types<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (error.code === 'ENOENT') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;throw new Error(`User ${userId} not found`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;} else if (error instanceof SyntaxError) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;throw new Error('Invalid user data format');<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Re-throw other errors<br>
&nbsp;&nbsp;&nbsp;&nbsp;throw error;<br>
&nbsp;&nbsp;} finally {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Cleanup code that runs whether successful or not<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Finished processing user ${userId}`);<br>
&nbsp;&nbsp;}<br>
}<br><br>
...
(async () => {<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const user = await loadUserData(123);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('User loaded:', user);<br>
&nbsp;&nbsp;} catch (error) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error('Failed to load user:', error.message);<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Handle error (e.g., show to user, retry, etc.)<br>
&nbsp;&nbsp;}<br>
})();
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_error_async">Run example &raquo;</a>
</div>
<hr>
...
<p>For unexpected errors, you can listen for <b>uncaughtException</b> to perform cleanup before exiting:</p>
<div class="w3-example">
<h3>Example: Global Error Handlers</h3>
<div class="w3-code notranslate jsHigh">
// Handle uncaught exceptions (synchronous errors)<br>
process.on('uncaughtException', (error) => {<br>
&nbsp;&nbsp;console.error('UNCAUGHT EXCEPTION! Shutting down...');<br>
&nbsp;&nbsp;console.error(error.name, error.message);<br><br>
  
&nbsp;&nbsp;// Perform cleanup (close database connections, etc.)<br>
&nbsp;&nbsp;server.close(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Process terminated due to uncaught exception');<br>
&nbsp;&nbsp;&nbsp;&nbsp;process.exit(1); // Exit with failure<br>
&nbsp;&nbsp;});<br>
});<br><br>

// Handle unhandled promise rejections<br>
process.on('unhandledRejection', (reason, promise) => {<br>
&nbsp;&nbsp;console.error('UNHANDLED REJECTION! Shutting down...');<br>
&nbsp;&nbsp;console.error('Unhandled Rejection at:', promise, 'Reason:', reason);<br><br>
  
&nbsp;&nbsp;// Close server and exit<br>
&nbsp;&nbsp;server.close(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;process.exit(1);<br>
&nbsp;&nbsp;});<br>
});<br><br>

// Example of an unhandled promise rejection<br>
Promise.reject(new Error('Something went wrong'));<br><br>

// Example of an uncaught exception<br>
setTimeout(() => {<br>
&nbsp;&nbsp;throw new Error('Uncaught exception after timeout');<br>
}, 1000);
</div>
</div>
<hr>
    ...
    <div class="w3-half">
      <div class="w3-panel w3-pale-green w3-padding">
        ...
        <ul>
          ...
          <li>Use custom error types for different scenarios</li>
          <li>Clean up resources in finally blocks</li>
          <li>Validate input to catch errors early</li>
        </ul>
      </div>
    </div>
    <div class="w3-half">
      <div class="w3-panel w3-pale-red w3-padding">
        <h4>Don't</h4>
        <ul>
          <li>Ignore errors (empty catch blocks)</li>
          <li>Expose sensitive error details to clients</li>
          <li>Use try/catch for flow control</li>
          <li>Swallow errors without logging them</li>
          <li>Continue execution after unrecoverable errors</li>
        </ul>
      </div>
    </div>
  </div>
...
&nbsp;&nbsp;constructor(message, field) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;super(message);<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.name = 'ValidationError';<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.field = field;<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.statusCode = 400;<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
class NotFoundError extends Error {<br>
&nbsp;&nbsp;constructor(resource) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;super(`${resource} not found`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.name = 'NotFoundError';<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.statusCode = 404;<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
// Usage<br>
...
&nbsp;&nbsp;if (!id) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;throw new ValidationError('User ID is required', 'id');<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;// ...<br>
}</div>
</div>
<hr>
<h2>Summary</h2>
<p>Effective error handling is a critical aspect of building robust Node.js applications.</p>
<p>By understanding different error types, using appropriate patterns, and following best practices, you can create applications that are more stable, maintainable, and user-friendly.</p>

<p>Remember that good error handling is not just about preventing crashes-it's about providing meaningful feedback, maintaining data integrity, and ensuring a good user experience even when things go wrong.</p>
<hr>
<div id="exercisecontainer" src="xrcise_error_handling.js" data-extensions="asp"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_async.asp">&#10094; Previous</a>
