...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js TypeScript</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js TypeScript">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_typescript.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="TypeScript is a superset of JavaScript that adds optional static typing.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js TypeScript">
<meta name="twitter:description" content="TypeScript is a superset of JavaScript that adds optional static typing.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_typescript.png">
...
<h1>Node.js <span class="color_h1">TypeScript</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_process_management.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="nodejs_typescript_advanced.asp">Next &#10095;</a>
</div>
<hr>

<h2>What is TypeScript?</h2>
<p><b>TypeScript</b> is a superset of JavaScript that adds optional static typing.</p>
<p>It helps you catch errors early and write safer, more maintainable code.</p>
<p>Take a look at our <a href="/typescript/index.php">TypeScript tutorial</a> for more details.</p>
<hr>

<h2>Using TypeScript with Node.js</h2>
<p>To use TypeScript in Node.js projects, you need to install TypeScript and a type definition manager:</p>
...
<p>Write your code in <code class="w3-codespan">.ts</code> files and compile them to JavaScript with:</p>
<div class="w3-example">
<div class="w3-code notranslate w3-black">
tsc yourfile.ts
</div>
...
<h2>Setting Up a TypeScript Project</h2>

<div class="w3-example">
<h4>1. Initialize a new Node.js project</h4>
<div class="w3-code notranslate w3-black">
npm init -y</div>
</div>

<div class="w3-example">
<h4>2. Install TypeScript and type definitions</h4>
<div class="w3-code notranslate w3-black">
npm install --save-dev typescript @types/node</div>
</div>

<div class="w3-example">
<h4>3. Initialize TypeScript configuration</h4>
<div class="w3-code notranslate w3-black">
npx tsc --init</div>
</div>
...
let count: number = 10;<br>
let name: string = 'TypeScript';<br>
<br>
// Arrays<br>
let numbers: number[] = [1, 2, 3];<br>
let names: Array&lt;string&gt; = ['Alice', 'Bob'];<br>
<br>
// Tuples<br>
let user: [string, number] = ['Alice', 25];<br>
<br>
// Enums<br>
enum Color {Red, Green, Blue}<br>
let color: Color = Color.Green;</div>
</div>

<div class="w3-example">
<h4>2. Interfaces and Types</h4>
<div class="w3-code notranslate jsHigh">
// Interface
interface User {<br>
&nbsp;&nbsp;id: number;<br>
...
function printUser(user: User) {<br>
...
<h2>TypeScript with Node.js</h2>

<div class="w3-example">
<h4>1. Creating a Simple HTTP Server</h4>
<div class="w3-code notranslate jsHigh">
// server.ts<br>
...
<div class="w3-example">
<h4>2. Using TypeScript with Express</h4>
<div class="w3-code notranslate w3-black">
# Install required packages<br>
npm install express<br>
npm install --save-dev @types/express</div>
<br>
<div class="w3-code notranslate jsHigh">
// app.ts<br>
...
let users: User[] = [];<br>
// Get all users<br>
app.get('/users', (req: Request, res: Response) => {<br>
&nbsp;&nbsp;res.json(users);<br>
});<br>
// Add new user<br>
app.post('/users', (req: Request, res: Response) => {<br>
...
<div class="w3-example">
<h4>tsconfig.json</h4>
<div class="w3-code notranslate jsHigh">{<br>
&nbsp;&nbsp;"compilerOptions": {<br>
&nbsp;&nbsp;&nbsp;&nbsp;"target": "es2018",<br>
&nbsp;&nbsp;&nbsp;&nbsp;"module": "commonjs",<br>
&nbsp;&nbsp;&nbsp;&nbsp;"outDir": "./dist",<br>
...
&nbsp;&nbsp;},<br>
&nbsp;&nbsp;"include": ["src/**/*"],<br>
&nbsp;&nbsp;"exclude": ["node_modules"]<br>}</div>
</div>

<div class="w3-panel ws-note">
<p><strong>Key Compiler Options:</strong></p>
<ul>
  <li><code class="w3-codespan">target</code>: Specify ECMAScript target version</li>
  <li><code class="w3-codespan">module</code>: Specify module code generation</li>
  <li><code class="w3-codespan">strict</code>: Enable all strict type checking options</li>
  <li><code class="w3-codespan">outDir</code>: Redirect output structure to the directory</li>
  <li><code class="w3-codespan">rootDir</code>: Specify the root directory of input files</li>
</ul>
</div>
<hr>
...
<ul>
  ...
  <li><strong>Better IDE Support</strong>: Superior autocompletion and code navigation</li>
  <li><strong>Self-Documenting Code</strong>: Types serve as documentation</li>
  <li><strong>Easier Refactoring</strong>: Safely rename variables and update code</li>
  <li><strong>Gradual Adoption</strong>: Add types incrementally to existing JavaScript code</li>
</ul>
</div>
...
<ul>
  ...
  <li>APIs where type safety is critical</li>
  <li>Projects that will be maintained long-term</li>
  <li>When working with complex data structures</li>
</ul>
</div>
<hr>
