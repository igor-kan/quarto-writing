...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Environment Variables</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js Environment Variables">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_environment.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="Environment variables are dynamic named values that can affect how running processes behave on a computer.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Environment Variables">
<meta name="twitter:description" content="Environment variables are dynamic named values that can affect how running processes behave on a computer.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_environment.png">
...
<h1>Node.js <span class="color_h1">Environment Variables</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_test_runner.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="nodejs_dev_vs_prod.asp">Next &#10095;</a>
</div>
<hr>

<h2>What are Environment Variables?</h2>
<p>Environment variables are dynamic named values that can affect how running processes behave on a computer.</p>
<p>They are part of the environment in which a process runs and are used to configure applications without changing the code.</p>

<div class="w3-panel ws-note">
  <p><strong>Key Benefits:</strong></p>
  <ul>
    <li>Store configuration separate from code</li>
    <li>Keep sensitive information out of version control</li>
    <li>Configure applications differently across environments</li>
    <li>Change application behavior without code changes</li>
  </ul>
</div>
...
<h2>Accessing Environment Variables in Node.js</h2>
<p>Node.js provides the <code class="w3-codespan">process.env</code> object to access environment variables.</p>
<p>This object contains all the environment variables available to the current process.</p>

<h3>Basic Usage</h3>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// Access a single environment variable<br>
const nodeEnv = process.env.NODE_ENV || 'development';<br>
console.log(`Running in ${nodeEnv} mode`);<br>
<br>
// Access multiple variables with destructuring<br>const { PORT = 3000, HOST = 'localhost' } = process.env;<br>console.log(`Server running at http://${HOST}:${PORT}`);<br>
<br>
// Check if running in production<br>if (process.env.NODE_ENV === 'production') {<br>
&nbsp;&nbsp;console.log('Production optimizations enabled');<br>
&nbsp;&nbsp;// Enable production features<br>}
</div>
</div>

<h3>Common Built-in Environment Variables</h3>
<div class="w3-responsive">
  <table class="ws-table-all notranslate">
    ...
    <tr>
      <td><code class="w3-codespan">NODE_ENV</code></td>
      <td>Current environment (development, test, production)</td>
      <td><code class="w3-codespan">production</code></td>
    </tr>
    <tr>
      <td><code class="w3-codespan">PORT</code></td>
      <td>Port number for the server to listen on</td>
      <td><code class="w3-codespan">3000</code></td>
    </tr>
    <tr>
      <td><code class="w3-codespan">PATH</code></td>
      <td>System path for executable lookup</td>
      <td><code class="w3-codespan">/usr/local/bin:/usr/bin</code></td>
    </tr>
    <tr>
      <td><code class="w3-codespan">HOME</code></td>
      <td>User's home directory</td>
      <td><code class="w3-codespan">/Users/username</code></td>
    </tr>
  </table>
</div>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> Always provide default values when accessing environment variables to prevent <code class="w3-codespan">undefined</code> values in your application.</p>
</div>
...
<p>There are several ways to set environment variables for your Node.js application, depending on your development workflow and deployment environment.</p>

<h3>1. Command Line (Temporary)</h3>
<p>Set variables directly in the command line when starting your application:</p>
...
<h4>macOS/Linux (Multiple Lines)</h4>
<div class="w3-code notranslate w3-black">
export PORT=3000<br>
...
<h3>2. Using .env Files with dotenv</h3>
<p>For development, use a <code class="w3-codespan">.env</code> file to store environment variables locally:</p>

<div class="w3-example">
<h4>1. Install dotenv package</h4>
<div class="w3-code notranslate w3-black">
npm install dotenv
</div>
...
DB_USER=admin<br>
DB_PASS=your_secure_password<br>
API_KEY=your_api_key_here</div>

<h4>3. Load .env in your application</h4>
<div class="w3-code notranslate jsHigh">
...
&nbsp;&nbsp;password: process.env.DB_PASS<br>
};<br>
<br>
console.log(`Server running on port ${port}`);</div>
</div>

<div class="w3-panel ws-warning">
  <p><strong>Important:</strong> Never commit <code class="w3-codespan">.env</code> files to version control. Add <code class="w3-codespan">.env</code> to your <code class="w3-codespan">.gitignore</code> file.</p>
</div>

<h3>3. Production Environment Variables</h3>
<p>In production, set environment variables using your hosting provider's configuration:</p>
...
<h4>Linux/Systemd Service</h4>
<div class="w3-code notranslate w3-black">
# /etc/systemd/system/your-app.service<br>
[Service]<br>
Environment="NODE_ENV=production"<br>
Environment="PORT=3000"</div>
</div>
<hr>

<h2>Using dotenv for Local Development</h2>
<p>The <b>dotenv</b> package lets you load environment variables from a <code class="w3-codespan">.env</code> file:</p>
<div class="w3-example">
<div class="w3-code notranslate w3-black">
# .env file<br>
API_KEY=abcdef12345
...
<p>Load the variables in your app:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
require('dotenv').config();<br>
...
<h2>Summary</h2>
<p>Environment variables help you keep sensitive data and configuration out of your code.</p>
<p>Use <code class="w3-codespan">process.env</code> and tools like dotenv to manage them easily in Node.js.</p>
<hr>
<div id="exercisecontainer" src="xrcise_environment.js" data-extensions="asp"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_test_runner.asp">&#10094; Previous</a>
