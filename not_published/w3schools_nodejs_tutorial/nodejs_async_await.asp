...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Async/Await</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js Async/Await">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_async_await.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="Async/await is a modern way to handle asynchronous operations in Node.js, building on top of Promises to create even more readable code.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Async/Await">
<meta name="twitter:description" content="Async/await is a modern way to handle asynchronous operations in Node.js, building on top of Promises to create even more readable code.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_async_await.png">
...
<h1>Node.js <span class="color_h1">Async/Await</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_promises.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="nodejs_error_handling.asp">Next &#10095;</a>
</div>
<hr>

<h2 id="intro">Introduction to Async/Await</h2>
<p>Async/await is a modern way to handle asynchronous operations in Node.js, building on top of Promises to create even more readable code.</p>
<p>Introduced in Node.js 7.6 and standardized in ES2017, async/await allows you to write asynchronous code that looks and behaves more like synchronous code.</p>
<p>Async/await is basically Promises with a more readable syntax. This makes your code cleaner and more maintainable.</p>

<div class="w3-panel ws-info">
<p>Async/await makes asynchronous code look and more feel like synchronous code. It does not block the main thread, but is easy to follow and understand.</p>
</div>
<hr>

<h2 id="syntax">Syntax and Usage</h2>
<p>The syntax consists of two keywords:</p>
<ul>
  <li><code class="w3-codespan">async</code>: Used to declare an asynchronous function that returns a Promise</li>
  <li><code class="w3-codespan">await</code>: Used to pause execution until a Promise is resolved, can only be used inside async functions</li>
</ul>

<div class="w3-example">
<h3>Example: Basic Async/Await</h3>
<div class="w3-code notranslate jsHigh">
async function getData() {<br>
&nbsp;&nbsp;console.log('Starting...');<br>
&nbsp;&nbsp;const result = await someAsyncOperation();<br>
&nbsp;&nbsp;console.log(`Result: ${result}`);<br>
&nbsp;&nbsp;return result;<br>
}<br><br>
function someAsyncOperation() {<br>
&nbsp;&nbsp;return new Promise(resolve => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;setTimeout(() => resolve('Operation completed'), 1000);<br>
&nbsp;&nbsp;});<br>
}<br><br>
// Call the async function<br>
getData().then(data => console.log('Final data:', data));
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_async_await_basic">Run example &raquo;</a>
</div>

<div class="w3-example">
<h3>Example: Reading a File with Async/Await</h3>
<div class="w3-code notranslate jsHigh">
const fs = require('fs').promises;<br><br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_async_await_readfile">Run example &raquo;</a>
</div>
<hr>
...
<p>One of the advantages of async/await is that you can use traditional try/catch blocks for error handling, making your code more readable.</p>

<div class="w3-example">
<h3>Example: Error Handling with Async/Await</h3>
<div class="w3-code notranslate jsHigh">
async function fetchUserData() {<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const response = await fetch('https://api.example.com/users/1');<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (!response.ok) {<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;return user;<br>
&nbsp;&nbsp;} catch (error) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error('Error fetching user data:', error);<br>
&nbsp;&nbsp;&nbsp;&nbsp;throw error; // Re-throw the error if needed<br>
&nbsp;&nbsp;}<br>
}
</div>
</div>

<p>You can also mix async/await with Promise <code class="w3-codespan">.catch()</code> for different scenarios:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// Using catch with an async function<br>
fetchUserData().catch(error => {<br>
&nbsp;&nbsp;console.log('Caught outside of async function:', error.message);<br>
});
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_async_await_error">Run example &raquo;</a>
</div>
<hr>

<h2 id="parallel">Running Promises in Parallel</h2>
<p>Although async/await makes code look synchronous, sometimes you need to run operations in parallel for better performance.</p>

<div class="w3-example">
<h3>Example: Sequential vs Parallel Operations</h3>
<div class="w3-code notranslate jsHigh">
...
// Sequential operation - takes ~3 seconds<br>
...
// Parallel operation - takes ~1 second<br>
...
// Demo<br>
async function runDemo() {<br>
&nbsp;&nbsp;console.log('Running sequentially...');<br>
&nbsp;&nbsp;const seqResults = await fetchSequential();<br>
&nbsp;&nbsp;console.log(seqResults);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;console.log('\nRunning in parallel...');<br>
&nbsp;&nbsp;const parResults = await fetchParallel();<br>
&nbsp;&nbsp;console.log(parResults);<br>
}<br><br>
runDemo();
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_async_await_parallel">Run example &raquo;</a>
</div>
<hr>

<h2 id="compare">Async/Await vs Promises vs Callbacks</h2>
<p>Let's see how the same task is handled with different asynchronous patterns:</p>

<h3>With Callbacks</h3>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
function getUser(userId, callback) {<br>
&nbsp;&nbsp;setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;callback(null, { id: userId, name: 'John' });<br>
&nbsp;&nbsp;}, 1000);<br>
}<br><br>
function getUserPosts(user, callback) {<br>
&nbsp;&nbsp;setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;callback(null, ['Post 1', 'Post 2']);<br>
&nbsp;&nbsp;}, 1000);<br>
}<br><br>
// Using callbacks<br>
getUser(1, (error, user) => {<br>
&nbsp;&nbsp;if (error) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error(error);<br>
&nbsp;&nbsp;&nbsp;&nbsp;return;<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;console.log('User:', user);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;getUserPosts(user, (error, posts) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (error) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error(error);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return;<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Posts:', posts);<br>
&nbsp;&nbsp;});<br>
});
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_async_await_callbacks">Try it Yourself &raquo;</a>
</div>

<h3>With Promises</h3>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
function getUserPromise(userId) {<br>
&nbsp;&nbsp;return new Promise(resolve => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;resolve({ id: userId, name: 'John' });<br>
&nbsp;&nbsp;&nbsp;&nbsp;}, 1000);<br>
&nbsp;&nbsp;});<br>
}<br><br>
function getUserPostsPromise(user) {<br>
&nbsp;&nbsp;return new Promise(resolve => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;resolve(['Post 1', 'Post 2']);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}, 1000);<br>
&nbsp;&nbsp;});<br>
}<br><br>
// Using promises<br>
...
&nbsp;&nbsp;.then(user => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('User:', user);<br>
&nbsp;&nbsp;&nbsp;&nbsp;return getUserPostsPromise(user);<br>
&nbsp;&nbsp;})<br>
&nbsp;&nbsp;.then(posts => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Posts:', posts);<br>
&nbsp;&nbsp;})<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_async_await_promise">Try it Yourself &raquo;</a>
</div>
...
async function getUserAndPosts() {<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const user = await getUserPromise(1);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('User:', user);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;const posts = await getUserPostsPromise(user);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Posts:', posts);<br>
&nbsp;&nbsp;} catch (error) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error(error);<br>
&nbsp;&nbsp;}<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_async_await_comparison">Try it Yourself &raquo;</a>
</div>
...
<tr>
<td>Callbacks</td>
<td>- Simple to understand<br>- Widely supported</td>
<td>- Callback hell<br>- Error handling is complex<br>- Hard to reason about</td>
</tr>
<tr>
<td>Promises</td>
<td>- Chaining with .then()<br>- Better error handling<br>- Composable</td>
<td>- Still requires nesting for complex flows<br>- Not as readable as async/await</td>
</tr>
<tr>
<td>Async/Await</td>
<td>- Clean, synchronous-like code<br>- Easy error handling with try/catch<br>- Easier debugging</td>
<td>- Requires understanding of Promises<br>- Easy to accidentally block execution</td>
</tr>
</table>
<hr>

<h2 id="bestpractices">Best Practices</h2>
<p>When working with async/await in Node.js, follow these best practices:</p>

<ol>
  <li><strong>Remember that async functions always return Promises</strong>
  <div class="w3-example">
  <div class="w3-code notranslate jsHigh">
  async function myFunction() {<br>
  &nbsp;&nbsp;return 'Hello';<br>
  }<br><br>
  // This returns a Promise that resolves to 'Hello', not the string 'Hello' directly<br>
  const result = myFunction();<br>
  console.log(result); // Promise { 'Hello' }<br><br>
  // You need to await it or use .then()<br>
  myFunction().then(message => console.log(message)); // Hello
  </div>
  </div>
  </li>
  
  <li><strong>Use Promise.all for concurrent operations</strong>
  <p>When operations can run in parallel, use <code class="w3-codespan">Promise.all</code> to improve performance.</p>
  </li>
  
  <li><strong>Always handle errors</strong>
  <p>Use try/catch blocks or chain a <code class="w3-codespan">.catch()</code> to the async function call.</p>
  </li>
  
  <li><strong>Avoid mixing async/await with callbacks</strong>
  <p>Convert callback-based functions to Promises using util.promisify or custom wrappers.</p>
  <div class="w3-example">
  <div class="w3-code notranslate jsHigh">
  const util = require('util');<br>
  const fs = require('fs');<br><br>
  // Convert callback-based function to Promise-based<br>
  const readFile = util.promisify(fs.readFile);<br><br>
  async function readFileContents() {<br>
  &nbsp;&nbsp;const data = await readFile('file.txt', 'utf8');<br>
  &nbsp;&nbsp;return data;<br>
  }
  </div>
  </div>
  ...
  <li><strong>Create clean async functions</strong>
  <p>Keep async functions focused on a single responsibility.</p>
  </li>
</ol>

<div class="w3-panel ws-note">
<p><strong>Best Practice:</strong> Be aware of the "top-level await" feature available in ECMAScript modules (ESM) in Node.js 14.8.0 and above, which allows using await outside of async functions at the module level.</p>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_async_await.js" data-extensions="asp"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_promises.asp">&#10094; Previous</a>
