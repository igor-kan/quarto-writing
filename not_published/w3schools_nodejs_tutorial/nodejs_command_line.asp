...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Command Line Usage</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js Command Line Usage">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_command_line.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="Run scripts and pass arguments to Node.js straight from the command line.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Command Line Usage">
<meta name="twitter:description" content="Run scripts and pass arguments to Node.js straight from the command line.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_command_line.png">
...
<h1>Node.js Command Line Usage</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_vs_browser.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="nodejs_v8_engine.asp">Next &#10095;</a>
</div>
<hr>

<p>Node.js provides a powerful command line interface (CLI) that allows you to run JavaScript files, manage packages, debug applications, and more.</p>
<p>This guide covers the essential commands and techniques every Node.js developer should know.</p>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> All commands should be run in a terminal or command prompt.</p>
  <p>On Windows, you can use Command Prompt, PowerShell, or Windows Terminal.</p>
  <p>On macOS/Linux, use Terminal.</p>
</div>

<hr>
<h2>Basic Node.js Commands</h2>
<p>These are the most common commands you'll use when working with Node.js applications:</p>
<div class="w3-example">
<h3>Run a JavaScript file</h3>
<div class="w3-code notranslate jsHigh"># Run a JavaScript file<br>
node app.js<br>
<br>
# Run with additional arguments<br>
node app.js arg1 arg2<br>
<br>  
# Run in watch mode (restarts on file changes)<br>
node --watch app.js
</div>
</div>
...
<p>The Node.js REPL (Read-Eval-Print Loop) is an interactive shell for executing JavaScript code.</p>
<p>The REPL is started by running <code class="w3-codespan">node</code> in the terminal:</p>
<div class="w3-example">
<h3>Using the REPL</h3>
<div class="w3-code notranslate jsHigh">
> const name = 'Node.js';<br>
...
<p>Access command line arguments using <code class="w3-codespan">process.argv</code>:</p>
<div class="w3-example">
<h3>Command Line Arguments</h3>
<div class="w3-code notranslate jsHigh">
// args.js<br>
console.log('All arguments:', process.argv);<br>
console.log('First argument:', process.argv[2]);<br>
console.log('Second argument:', process.argv[3]);<br>
<br>
// Example usage:<br>// node args.js hello world<br>// Output:<br>// All arguments: ['/path/to/node', '/path/to/args.js', 'hello', 'world']<br>
...
<p>Access and set environment variables:</p>
<div class="w3-example">
<h3>Environment Variables</h3>
<div class="w3-code notranslate jsHigh">
// env.js<br>
console.log('Environment:', process.env.NODE_ENV || 'development');<br>
console.log('Custom variable:', process.env.MY_VARIABLE);<br>
console.log('Database URL:', process.env.DATABASE_URL || 'Not set');<br>
<br>
// Example usage with environment variables:<br>
// NODE_ENV=production MY_VARIABLE=test node env.js<br>
</div>
</div>
<div class="w3-example">
<h3>Set Environment Variables</h3>
<div class="w3-code notranslate jsHigh">
# Set environment variables when running<br>
...
<hr>
<h2>Debugging Node.js Applications</h2>
<p>Node.js includes a powerful debugging system that integrates with Chrome DevTools:</p>
<div class="w3-example">
<h3>Basic Debugging Commands</h3>
<div class="w3-code notranslate jsHigh">
# Start with inspector (listens on default port 9229)<br>
node --inspect app.js<br>
<br>
# Break on first line of application<br>
node --inspect-brk app.js<br>
<br>
# Specify a custom port<br>
node --inspect=9222 app.js<br>
<br>
# Enable remote debugging (be careful with this in production)<br>
node --inspect=0.0.0.0:9229 app.js
</div>
</div>

<div class="w3-example">
<h3>Using Chrome DevTools for Debugging</h3>
<ol>
  <li>Start your application with <code class="w3-codespan">node --inspect app.js</code></li>
  <li>Open Chrome and navigate to <code class="w3-codespan">chrome://inspect</code></li>
  <li>Click on "Open dedicated DevTools for Node"</li>
  <li>Set breakpoints and debug your application</li>
</ol>
</div>
<hr>
<h2>Common CLI Tools</h2>
<p>Node.js comes with several useful command-line tools:</p>

<div class="w3-example">
<h3>Node Version Manager (nvm)</h3>
<div class="w3-code notranslate">
# Install and use different Node.js versions<br>
nvm install 18.16.0  # Install specific version<br>
nvm use 18.16.0      # Switch to version<br>
...
<div class="w3-code notranslate">
# Common npm commands<br>
npm init             # Initialize a new project<br>
npm install          # Install dependencies<br>
npm update           # Update packages<br>
npm audit            # Check for vulnerabilities
</div>
</div>

<hr>
<h2>Common Command Line Flags</h2>
<p>Node.js provides several command-line flags to control its behavior. Here are some of the most useful ones:</p>

<div class="w3-example">
<h3>Basic Flags</h3>
<div class="w3-code notranslate">
# Show Node.js version<br>
node --version  # or -v<br>
<br>
# Show V8 version<br>
node --v8-options<br>
<br>
# Show command-line help<br>
node --help</div>
</div>
...
<div class="w3-code notranslate">
# Check syntax without executing<br>
node --check app.js<br>
<br>
# Show stack traces for warnings<br>
node --trace-warnings app.js<br>
<br>
# Set max memory (in MB)<br>
node --max-old-space-size=4096 app.js<br>
<br>
# Preload a module before execution<br>
node --require dotenv/config app.js</div>
</div>

<div class="w3-example">
<h3>Performance and Optimization</h3>
<div class="w3-code notranslate">
# Enable ES module loader<br>
node --experimental-modules app.mjs<br>
<br>
# Enable experimental features<br>
node --experimental-repl-await<br>
<br>
# Enable experimental worker threads<br>
node --experimental-worker</div>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_command_line.js" data-extensions="asp"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_vs_browser.asp">&#10094; Previous</a>
