...
<meta name="title" property="og:title" content="Node.js Crypto Module">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_crypto.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="The Crypto module is a built-in Node.js module that provides cryptographic functionality.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Crypto Module">
<meta name="twitter:description" content="The Crypto module is a built-in Node.js module that provides cryptographic functionality.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_crypto.png">
...
<h1>Node.js Crypto Module</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_buffer.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="nodejs_timers.asp">Next &#10095;</a>
</div>

<hr>

<h2>What is the Crypto Module?</h2>

<p>The Crypto module is a built-in Node.js module that provides cryptographic functionality including:</p>

<ul>
  <li>Hash functions (SHA-256, SHA-512, etc.)</li>
  <li>HMAC (Hash-based Message Authentication Code)</li>
  <li>Symmetric encryption (AES, DES, etc.)</li>
  <li>Asymmetric encryption (RSA, ECDSA, etc.)</li>
  <li>Digital signatures and verification</li>
  <li>Secure random number generation</li>
</ul>

<p>The Crypto module is essential for applications that need to handle sensitive information securely.</p>

<p>The Crypto module wraps the OpenSSL library, providing access to well-established and tested cryptographic algorithms.</p>

<p>This module is often used to handle sensitive data, such as:</p>
<ul>
  <li>User authentication and password storage</li>
...
<p>Here's a quick example of using the Crypto module to hash a string:</p>

<div class="w3-example">
<h3>Basic Hashing Example</h3>
<div class="w3-code notranslate jsHigh">const crypto = require('crypto');<br>
<br>
// Create a SHA-256 hash of a string<br>
const hash = crypto.createHash('sha256')<br>
&nbsp; .update('Hello, Node.js!')<br>
&nbsp; .digest('hex');<br>
console.log('SHA-256 Hash:', hash);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_crypto_quickstart">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Installing the Crypto Module</h2>

<p>The Crypto module is included in Node.js by default.</p>
...
<p>Hashing is a one-way transformation of data into a fixed-length string of characters.</p>
<p>Hash functions have several important properties:</p>

<ul>
  <li><strong>Deterministic:</strong> Same input always produces the same output</li>
  <li><strong>Fixed Length:</strong> Output is always the same size regardless of input size</li>
  <li><strong>One-Way:</strong> Extremely difficult to reverse the process</li>
  <li><strong>Avalanche Effect:</strong> Small changes in input produce significant changes in output</li>
</ul>
...
<ul>
  ...
  <li>Content addressing (e.g., Git, IPFS)</li>
</ul>
<hr>
...
const hash = crypto.createHash('sha256');<br>
<br>
// Update the hash with data<br>
hash.update('Hello, World!');<br>
<br>
// Get the digest in hexadecimal format<br>
const digest = hash.digest('hex');<br>
console.log(digest);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_crypto_hash">Try it Yourself &raquo;</a>
</div>

<p>In this example:</p>
<ul>
  <li><code class="w3-codespan">createHash()</code> creates a hash object with the specified algorithm</li>
  <li><code class="w3-codespan">update()</code> updates the hash content with the given data</li>
  <li><code class="w3-codespan">digest()</code> calculates the digest and outputs it in the specified format</li>
</ul>
<hr>
...
<div class="w3-example">
<div class="w3-code notranslate jsHigh">const crypto = require('crypto');<br>
const data = 'Hello, World!';<br>
<br>
// MD5 (not recommended for security-critical applications)<br>
const md5 = crypto.createHash('md5').update(data).digest('hex');<br>
console.log('MD5:', md5);<br>
<br>
// SHA-1 (not recommended for security-critical applications)<br>
const sha1 = crypto.createHash('sha1').update(data).digest('hex');<br>
console.log('SHA-1:', sha1);<br>
<br>
// SHA-256<br>
const sha256 = crypto.createHash('sha256').update(data).digest('hex');<br>
console.log('SHA-256:', sha256);<br>
<br>
// SHA-512<br>
const sha512 = crypto.createHash('sha512').update(data).digest('hex');<br>
console.log('SHA-512:', sha512);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_crypto_hash_algorithms">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-warning">
<p><strong>Warning:</strong> MD5 and SHA-1 are considered cryptographically weak and should not be used for security-critical applications.</p>
<p>Use SHA-256, SHA-384, or SHA-512 instead.</p>
</div>
<hr>
<h2>Password Security</h2>

<p>When handling passwords, it's crucial to use specialized password hashing functions that are designed to be computationally expensive to prevent brute-force attacks.</p>
<p>Here's why simple hashes are insufficient:</p>

<div class="w3-panel ws-warning">
<p><strong>Never store passwords in plain text or with simple hashes like MD5 or SHA-1.</strong></p>
<p>These can be easily cracked using rainbow tables or brute-force attacks.</p>
</div>

<h3>Key Concepts for Password Security</h3>

<ol>
  <li><strong>Salting:</strong> Add a unique random value to each password before hashing</li>
  <li><strong>Key Stretching:</strong> Make the hashing process intentionally slow to prevent brute-force attacks</li>
  <li><strong>Work Factor:</strong> Control how computationally intensive the hashing process is</li>
</ol>

<p>Here's how to properly hash passwords in Node.js:</p>

<div class="w3-panel ws-note">
<p><strong>What is a salt?</strong><br>
A salt is a random string that is unique to each user.</p>
<p>It's combined with the password before hashing to ensure that even if two users have the same password, their hashes will be different.</p>
<p>This prevents attackers from using precomputed tables (like rainbow tables) to crack multiple passwords at once.</p>
</div>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">const crypto = require('crypto');<br>
<br>
// Function to hash a password<br>
function hashPassword(password) {<br>
&nbsp;&nbsp;// Generate a random salt (16 bytes)<br>
&nbsp;&nbsp;const salt = crypto.randomBytes(16).toString('hex');<br>
<br>
&nbsp;&nbsp;// Use scrypt for password hashing (recommended)<br>
&nbsp;&nbsp;const hash = crypto.scryptSync(password, salt, 64).toString('hex');<br>
<br>
&nbsp;&nbsp;// Return both salt and hash for storage<br>
&nbsp;&nbsp;return { salt, hash };<br>
}<br>
<br>
// Function to verify a password<br>
function verifyPassword(password, salt, hash) {<br>
&nbsp;&nbsp;const hashedPassword = crypto.scryptSync(password, salt, 64).toString('hex');<br>
&nbsp;&nbsp;return hashedPassword === hash;<br>
}<br>
<br>
// Example usage<br>
const password = 'mySecurePassword';<br>
<br>
// Hash the password for storage<br>
const { salt, hash } = hashPassword(password);<br>
console.log('Salt:', salt);<br>
console.log('Hash:', hash);<br>
<br>
// Verify a login attempt<br>
const isValid = verifyPassword(password, salt, hash);<br>
console.log('Password valid:', isValid); // true<br>
<br>
const isInvalid = verifyPassword('wrongPassword', salt, hash);<br>
console.log('Wrong password valid:', isInvalid); // false</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_crypto_password_hash">Run example &raquo;</a>
</div>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> For password hashing in a production environment, consider using a dedicated library like <code class="w3-codespan">bcrypt</code> or <code class="w3-codespan">argon2</code> that is specifically designed for secure password handling.</p>
</div>
...
<p>HMAC is a specific type of message authentication code (MAC) involving a cryptographic hash function and a secret cryptographic key.</p>
<p>It provides both data integrity and authentication.</p>

<h3>When to Use HMAC</h3>
<ul>
  <li>API request verification</li>
  <li>Secure cookies and sessions</li>
  <li>Data integrity checks</li>
  <li>Webhook verification</li>
</ul>

<h3>HMAC Security Properties</h3>
<ul>
  <li><strong>Message Integrity:</strong> Any change to the message will produce a different HMAC</li>
  <li><strong>Authenticity:</strong> Only parties with the secret key can generate valid HMACs</li>
  <li><strong>No Encryption:</strong> HMAC doesn't encrypt the message, only verifies its integrity</li>
</ul>
...
<br>
// Secret key<br>
const secretKey = 'mySecretKey';<br>
<br>
// Create an HMAC<br>
const hmac = crypto.createHmac('sha256', secretKey);<br>
<br>
// Update with data<br>
hmac.update('Hello, World!');<br>
<br>
// Get the digest<br>
const hmacDigest = hmac.digest('hex');<br>
console.log('HMAC:', hmacDigest);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_crypto_hmac">Try it Yourself &raquo;</a>
</div>

<h3>HMAC for Message Verification</h3>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">const crypto = require('crypto');<br>
<br>
// Function to create an HMAC for a message<br>
function createSignature(message, key) {<br>
&nbsp;&nbsp;const hmac = crypto.createHmac('sha256', key);<br>
&nbsp;&nbsp;hmac.update(message);<br>
&nbsp;&nbsp;return hmac.digest('hex');<br>
}<br>
<br>
// Function to verify a message's signature<br>
function verifySignature(message, signature, key) {<br>
&nbsp;&nbsp;const expectedSignature = createSignature(message, key);<br>
&nbsp;&nbsp;return crypto.timingSafeEqual(<br>
&nbsp;&nbsp;&nbsp;&nbsp;Buffer.from(signature, 'hex'),<br>
&nbsp;&nbsp;&nbsp;&nbsp;Buffer.from(expectedSignature, 'hex')<br>
&nbsp;&nbsp;);<br>
}<br>
<br>
// Example usage<br>
const secretKey = 'verySecretKey';<br>
const message = 'Important message to verify';<br>
<br>
// Sender creates a signature<br>
const signature = createSignature(message, secretKey);<br>
console.log('Message:', message);<br>
console.log('Signature:', signature);<br>
<br>
// Receiver verifies the signature<br>
try {<br>
&nbsp;&nbsp;const isValid = verifySignature(message, signature, secretKey);<br>
&nbsp;&nbsp;console.log('Signature valid:', isValid); // true<br>
<br>
&nbsp;&nbsp;// Try with a tampered message<br>
&nbsp;&nbsp;const isInvalid = verifySignature('Tampered message', signature, secretKey);<br>
&nbsp;&nbsp;console.log('Tampered message valid:', isInvalid); // false<br>
} catch (error) {<br>
&nbsp;&nbsp;console.error('Verification error:', error.message);<br>
}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_crypto_hmac_verification">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> Always use <code class="w3-codespan">timingSafeEqual()</code> for cryptographic comparisons to prevent timing attacks.</p>
</div>
...
<p>It's generally faster than asymmetric encryption and is ideal for:</p>

<ul>
  <li>Bulk data encryption</li>
  <li>Database encryption</li>
  <li>Filesystem encryption</li>
  <li>Secure messaging (combined with key exchange)</li>
</ul>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    ...
    <td>256 bits</td>
    <td>128 bits</td>
    <td>Current standard, widely used</td>
  </tr>
  <tr>
    <td>ChaCha20</td>
    <td>256 bits</td>
    <td>512 bits</td>
    <td>Faster in software, used in TLS 1.3</td>
  </tr>
  <tr>
    <td>3DES</td>
    <td>168 bits</td>
    <td>64 bits</td>
    <td>Legacy, not recommended for new systems</td>
  </tr>
  <tr>
    <td>Blowfish</td>
    <td>32-448 bits</td>
    <td>64 bits</td>
    <td>Legacy, use Twofish or AES instead</td>
  </tr>
</table>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> Always use authenticated encryption modes like AES-GCM or AES-CCM when possible, as they provide both confidentiality and authenticity.</p>
</div>
<hr>
...
<div class="w3-code notranslate jsHigh">const crypto = require('crypto');<br>
<br>
// Function to encrypt data<br>
function encrypt(text, key) {<br>
&nbsp;&nbsp;// Generate a random initialization vector<br>
&nbsp;&nbsp;const iv = crypto.randomBytes(16);<br>
<br>
&nbsp;&nbsp;// Create cipher with AES-256-CBC<br>
...
<br>
&nbsp;&nbsp;// Return both the encrypted data and the IV<br>
&nbsp;&nbsp;return {<br>
...
<br>
// Function to decrypt data<br>
function decrypt(encryptedData, iv, key) {<br>
&nbsp;&nbsp;// Create decipher<br>
&nbsp;&nbsp;const decipher = crypto.createDecipheriv(<br>
&nbsp;&nbsp;&nbsp;&nbsp;'aes-256-cbc',<br>
&nbsp;&nbsp;&nbsp;&nbsp;key,<br>
&nbsp;&nbsp;&nbsp;&nbsp;Buffer.from(iv, 'hex')<br>
&nbsp;&nbsp;);<br>
<br>
&nbsp;&nbsp;// Decrypt the data<br>
&nbsp;&nbsp;let decrypted = decipher.update(encryptedData, 'hex', 'utf8');<br>
...
<br>
// Example usage<br>
// Note: In a real application, use a properly generated and securely stored key<br>
const key = crypto.scryptSync('secretPassword', 'salt', 32); // 32 bytes = 256 bits<br>
const message = 'This is a secret message';<br>
<br>
// Encrypt<br>
const { iv, encryptedData } = encrypt(message, key);<br>
console.log('Original:', message);<br>
console.log('Encrypted:', encryptedData);<br>
console.log('IV:', iv);<br>
<br>
// Decrypt<br>
const decrypted = decrypt(encryptedData, iv, key);<br>
console.log('Decrypted:', decrypted);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_crypto_aes">Run example &raquo;</a>
</div>

<div class="w3-panel ws-warning">
<p><strong>Warning:</strong> Never reuse the same initialization vector (IV) with the same key.</p>
<p>Always generate a new random IV for each encryption operation.</p>
</div>
<hr>
<h2>Other Symmetric Algorithms</h2>

<p>The Crypto module supports various symmetric encryption algorithms.</p>
<p>You can see the available ciphers with:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">const crypto = require('crypto');<br>
<br>
// List available cipher algorithms<br>
console.log(crypto.getCiphers());</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_crypto_ciphers">Try it Yourself &raquo;</a>
</div>
...
<p>Asymmetric encryption (public-key cryptography) uses a pair of mathematically related keys:</p>

<ul>
  <li><strong>Public Key:</strong> Can be shared publicly, used for encryption</li>
  <li><strong>Private Key:</strong> Must be kept secret, used for decryption</li>
</ul>

<h3>Common Use Cases</h3>

<ul>
  <li>Secure key exchange (e.g., TLS/SSL handshake)</li>
  <li>Digital signatures</li>
  <li>Email encryption (PGP/GPG)</li>
  <li>Blockchain and cryptocurrencies</li>
</ul>

<h3>Common Asymmetric Algorithms</h3>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    ...
    <td>2048+ bits</td>
    <td>High</td>
    <td>Widely used, good compatibility</td>
  </tr>
  <tr>
    <td>ECDSA</td>
    <td>256-521 bits</td>
    <td>High</td>
    <td>Used in TLS 1.3, Bitcoin</td>
  </tr>
  <tr>
    <td>Ed25519</td>
    <td>256 bits</td>
    <td>Very High</td>
    <td>Modern, efficient, used in SSH</td>
  </tr>
</table>

<div class="w3-panel ws-warning">
<p><strong>Performance Note:</strong> Asymmetric encryption is much slower than symmetric encryption.</p>
<p>For encrypting large amounts of data, use a hybrid approach:</p>
<ol>
  <li>Generate a random symmetric key</li>
  <li>Encrypt your data with the symmetric key</li>
...
&nbsp;&nbsp;return crypto.generateKeyPairSync('rsa', {<br>
&nbsp;&nbsp;&nbsp;&nbsp;modulusLength: 2048, // Key size in bits<br>
&nbsp;&nbsp;&nbsp;&nbsp;publicKeyEncoding: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;type: 'spki',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;format: 'pem'<br>
&nbsp;&nbsp;&nbsp;&nbsp;},<br>
&nbsp;&nbsp;&nbsp;&nbsp;privateKeyEncoding: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;type: 'pkcs8',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;format: 'pem'<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;});<br>
...
function encryptWithPublicKey(text, publicKey) {<br>
&nbsp;&nbsp;const buffer = Buffer.from(text, 'utf8');<br>
&nbsp;&nbsp;const encrypted = crypto.publicEncrypt(<br>
&nbsp;&nbsp;&nbsp;&nbsp;{<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;key: publicKey,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;padding: crypto.constants.RSA_PKCS1_OAEP_PADDING<br>
&nbsp;&nbsp;&nbsp;&nbsp;},<br>
&nbsp;&nbsp;&nbsp;&nbsp;buffer<br>
&nbsp;&nbsp;);<br>
&nbsp;&nbsp;return encrypted.toString('base64');<br>
}<br>
<br>
// Decrypt with private key<br>
function decryptWithPrivateKey(encryptedText, privateKey) {<br>
&nbsp;&nbsp;const buffer = Buffer.from(encryptedText, 'base64');<br>
&nbsp;&nbsp;const decrypted = crypto.privateDecrypt(<br>
&nbsp;&nbsp;&nbsp;&nbsp;{<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;key: privateKey,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;padding: crypto.constants.RSA_PKCS1_OAEP_PADDING<br>
&nbsp;&nbsp;&nbsp;&nbsp;},<br>
&nbsp;&nbsp;&nbsp;&nbsp;buffer<br>
&nbsp;&nbsp;);<br>
&nbsp;&nbsp;return decrypted.toString('utf8');<br>
}<br>
<br>
// Generate keys<br>
const { publicKey, privateKey } = generateKeyPair();<br>
console.log('Public Key:', publicKey.substring(0, 50) + '...');<br>
console.log('Private Key:', privateKey.substring(0, 50) + '...');<br>
<br>
// Example usage<br>
const message = 'This message is encrypted with RSA';<br>
const encrypted = encryptWithPublicKey(message, publicKey);<br>
console.log('Encrypted:', encrypted.substring(0, 50) + '...');<br>
<br>
const decrypted = decryptWithPrivateKey(encrypted, privateKey);<br>
console.log('Decrypted:', decrypted);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_crypto_rsa">Run example &raquo;</a>
</div>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> RSA is typically used for encrypting small amounts of data (like encryption keys) due to performance constraints.</p>
<p>For larger data, use a hybrid approach: encrypt the data with a symmetric algorithm (like AES) and encrypt the symmetric key with RSA.</p>
</div>
...
<p>Digital signatures provide a way to verify the authenticity and integrity of messages, software, or digital documents.</p>
...
<br>
// Function to sign a message<br>
function signMessage(message, privateKey) {<br>
&nbsp;&nbsp;const signer = crypto.createSign('sha256');<br>
&nbsp;&nbsp;signer.update(message);<br>
&nbsp;&nbsp;return signer.sign(privateKey, 'base64');<br>
}<br>
<br>
// Function to verify a signature<br>
function verifySignature(message, signature, publicKey) {<br>
&nbsp;&nbsp;const verifier = crypto.createVerify('sha256');<br>
&nbsp;&nbsp;verifier.update(message);<br>
&nbsp;&nbsp;return verifier.verify(publicKey, signature, 'base64');<br>
}<br>
<br>
// Example usage<br>
const message = 'This message needs to be signed';<br>
const signature = signMessage(message, privateKey);<br>
console.log('Message:', message);<br>
console.log('Signature:', signature.substring(0, 50) + '...');<br>
<br>
// Verify the signature<br>
const isValid = verifySignature(message, signature, publicKey);<br>
console.log('Signature valid:', isValid); // true<br>
<br>
// Verify with a modified message<br>
const isInvalid = verifySignature('Modified message', signature, publicKey);<br>
console.log('Modified message valid:', isInvalid); // false</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_crypto_signature">Run example &raquo;</a>
</div>
...
<p>Generating secure random data is important for many cryptographic operations, such as creating keys, salts, and initialization vectors.</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">const crypto = require('crypto');<br>
<br>
// Generate random bytes<br>
const randomBytes = crypto.randomBytes(16);<br>
console.log('Random bytes:', randomBytes.toString('hex'));<br>
<br>
// Generate a random string (Base64)<br>
const randomString = crypto.randomBytes(32).toString('base64');<br>
console.log('Random string:', randomString);<br>
<br>
// Generate a random number between 1 and 100<br>
function secureRandomNumber(min, max) {<br>
&nbsp;&nbsp;// Ensure we have enough randomness<br>
&nbsp;&nbsp;const range = max - min + 1;<br>
&nbsp;&nbsp;const bytesNeeded = Math.ceil(Math.log2(range) / 8);<br>
&nbsp;&nbsp;const maxValue = 256 ** bytesNeeded;<br>
<br>
&nbsp;&nbsp;// Generate random bytes and convert to a number<br>
&nbsp;&nbsp;const randomBytes = crypto.randomBytes(bytesNeeded);<br>
&nbsp;&nbsp;const randomValue = randomBytes.reduce((acc, byte, i) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;return acc + byte * (256 ** i);<br>
&nbsp;&nbsp;}, 0);<br>
<br>
&nbsp;&nbsp;// Scale to our range and shift by min<br>
&nbsp;&nbsp;return min + Math.floor((randomValue * range) / maxValue);<br>
}<br>
<br>
// Example: Generate 5 random numbers<br>
for (let i = 0; i &lt; 5; i++) {<br>
&nbsp; console.log(`Random number ${i+1}:`, secureRandomNumber(1, 100));<br>
}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_crypto_random">Run example &raquo;</a>
</div>
...
<p>When using the Crypto module, keep these best practices in mind:</p>

<ul>
  <li><strong>Use modern algorithms:</strong> Avoid MD5, SHA-1, and other outdated algorithms</li>
  <li><strong>Secure key management:</strong> Store keys securely, rotate them regularly, and never hardcode them</li>
  <li><strong>Use random IVs:</strong> Generate a new random IV for each encryption operation</li>
  <li><strong>Add authentication:</strong> Use authenticated encryption modes like GCM when possible</li>
  <li><strong>Constant-time comparisons:</strong> Always use <code class="w3-codespan">crypto.timingSafeEqual()</code> for comparing security-critical values</li>
  <li><strong>Key derivation:</strong> Use appropriate key derivation functions like scrypt, bcrypt, or PBKDF2 for password-based keys</li>
  <li><strong>Stay updated:</strong> Keep Node.js updated to get security fixes and support for newer algorithms</li>
  <li><strong>Follow standards:</strong> Adhere to established cryptographic standards and protocols</li>
</ul>

<div class="w3-panel ws-warning">
<p><strong>Warning:</strong> Cryptography is complex, and mistakes can lead to serious security vulnerabilities.</p>
<p>When implementing critical security features, consider consulting a security specialist or using well-established libraries designed for specific cryptographic tasks.</p>
</div>
...
<p>The Node.js Crypto module provides a wide range of cryptographic functionality:</p>

<ul>
  <li>Hash functions for data integrity and fingerprinting</li>
  <li>HMAC for authentication and integrity checks</li>
  <li>Symmetric encryption for securing data with shared keys</li>
  <li>Asymmetric encryption for secure communication and digital signatures</li>
  <li>Random data generation for cryptographic operations</li>
  <li>Digital signatures for authenticity verification</li>
</ul>

<p>By understanding and properly implementing these cryptographic concepts, you can build secure applications that protect sensitive data and communications.</p>

<hr>

<div id="exercisecontainer" src="xrcise_crypto.js" data-extensions="asp"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_buffer.asp">&#10094; Previous</a>
