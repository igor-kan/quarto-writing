...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Test Runner</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js Test Runner">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_test_runner.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="The built-in node:test module provides a lightweight, no-dependency framework for writing and running JavaScript tests directly in Node.js.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Test Runner">
<meta name="twitter:description" content="The built-in node:test module provides a lightweight, no-dependency framework for writing and running JavaScript tests directly in Node.js.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_test_runner.png">
...
<h1>Node.js <span class="color_h1">Test Runner</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_testing_frameworks.asp">&lt; Previous</a>
<a class="w3-right w3-btn" href="nodejs_environment.asp">Next &gt;</a>
</div>
<hr>

<h2>Introduction to Node.js Test Runner</h2>
<p>The built-in <code class="w3-codespan">node:test</code> module provides a lightweight, no-dependency framework for writing and running JavaScript tests directly in Node.js.</p>
<p>Introduced as a stable API in Node.js 20, it's designed to be a fast, modern alternative to external testing frameworks.</p>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> The Node.js Test Runner is stable as of Node.js v20.</p>
  <p>Some advanced features may be experimental in earlier versions.</p>
</div>
...
<div class="w3-row-padding" style="margin:0 -16px">
  <div class="w3-half">
    <div class="w3-panel w3-light-grey w3-padding-16">
      ...
      <ul>
        <li><strong>Zero Configuration:</strong> Works out of the box with no setup</li>
        <li><strong>Dual Module Support:</strong> Native ESM and CommonJS compatibility</li>
        <li><strong>Parallel Execution:</strong> Tests run concurrently by default</li>
        <li><strong>Test Isolation:</strong> Each test runs in its own context</li>
      </ul>
    </div>
  </div>
  <div class="w3-half">
    <div class="w3-panel w3-light-grey w3-padding-16">
      ...
      <ul>
        <li><strong>Async Support:</strong> First-class async/await handling</li>
        <li><strong>Test Hooks:</strong> Before/After hooks for setup/teardown</li>
        <li><strong>Mocking:</strong> Built-in test doubles and spies</li>
        <li><strong>Code Coverage:</strong> Integration with Node.js coverage tools</li>
      </ul>
    </div>
  </div>
</div>
...
<p>Let's create and run a basic test using the Node.js Test Runner.</p>
<p>You'll need Node.js 16.17.0 or later installed.</p>

<div class="w3-example">
<h4>1. Create a test file (test/example.test.js)</h4>
<div class="w3-code notranslate jsHigh">
// Load the test module<br>
const test = require('node:test');<br>
// Use strict assertion mode for better error messages<br>
const assert = require('node:assert/strict');<br>
<br>
// Simple synchronous test<br>test('basic arithmetic', (t) => {<br>
&nbsp;&nbsp;// Assert that 1 + 1 equals 2<br>
&nbsp;&nbsp;assert.equal(1 + 1, 2, '1 + 1 should equal 2');<br>
<br>
&nbsp;&nbsp;// Deep equality check for objects/arrays<br>
&nbsp;&nbsp;assert.deepEqual(<br>
&nbsp;&nbsp;&nbsp;&nbsp;{ a: 1, b: { c: 2 } },<br>
&nbsp;&nbsp;&nbsp;&nbsp;{ a: 1, b: { c: 2 } }<br>
&nbsp;&nbsp;);<br>});
<br>
// Asynchronous test with async/await<br>
test('async test', async (t) => {<br>
&nbsp;&nbsp;const result = await Promise.resolve('async result');<br>
&nbsp;&nbsp;assert.strictEqual(result, 'async result');<br>
});
</div>
</div>

<div class="w3-example">
<h4>2. Run the test</h4>
<div class="w3-code notranslate">
# Run all test files in the test directory<br>
node --test<br>
<br>
# Run a specific test file<br>
node --test test/example.test.js<br>
<br>
# Run with coverage reporting<br>
NODE_V8_COVERAGE=coverage node --test
</div>
<a class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_test_runner" target="_blank">Run Example &raquo;</a>
</div>

<h3>Test Structure and Organization</h3>
<p>For larger projects, organize your tests in a structured way:</p>
...
<h3>Test Hooks</h3>
<p>Use hooks to set up and clean up test environments:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const { test, describe, before, after, beforeEach, afterEach } = require('node:test');<br>
const assert = require('node:assert/strict');<br>
<br>
describe('Test Suite with Hooks', (t) => {<br>
&nbsp;&nbsp;let testData = [];<br>
<br>
&nbsp;&nbsp;// Runs once before all tests<br>
&nbsp;&nbsp;before(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Running before all tests');<br>
&nbsp;&nbsp;&nbsp;&nbsp;testData = [1, 2, 3];<br>
&nbsp;&nbsp;});<br>
<br>
&nbsp;&nbsp;// Runs before each test<br>
&nbsp;&nbsp;beforeEach((t) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Running before each test');<br>
&nbsp;&nbsp;});<br>
<br>
&nbsp;&nbsp;test('array length', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;assert.strictEqual(testData.length, 3);<br>
&nbsp;&nbsp;});<br>
<br>
&nbsp;&nbsp;// Runs after each test<br>
&nbsp;&nbsp;afterEach(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Running after each test');<br>
&nbsp;&nbsp;});<br>
<br>
&nbsp;&nbsp;// Runs once after all tests<br>
&nbsp;&nbsp;after(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Running after all tests');<br>
&nbsp;&nbsp;&nbsp;&nbsp;testData = [];<br>
&nbsp;&nbsp;});<br>});
</div>
</div>
...
<br>
test('basic test', () => {<br>
&nbsp;&nbsp;assert.equal(1 + 1, 2);<br>
});</div>
</div>

<h3>Running Tests</h3>
<p>Run tests using the <code class="w3-codespan">--test</code> flag:</p>
...
<p>You can also run all test files in a directory:</p>
...
<p>This will run all files with names matching these patterns:</p>
<ul>
  <li><code class="w3-codespan">**/*.test.js</code></li>
  <li><code class="w3-codespan">**/*.spec.js</code></li>
  <li><code class="w3-codespan">**/test-*.js</code></li>
  <li><code class="w3-codespan">**/test/*.js</code></li>
</ul>
...
<p>For asynchronous code, use an async test function:</p>
...
test('async test', async () => {<br>
&nbsp;&nbsp;// Simulate async operation<br>
&nbsp;&nbsp;const result = await Promise.resolve(42);<br>
&nbsp;&nbsp;assert.equal(result, 42);<br>
});<br>
<br>
// Using callbacks with done (older style)<br>
test('callback test', (t, done) => {<br>
&nbsp;&nbsp;setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;assert.equal(1 + 1, 2);<br>
&nbsp;&nbsp;&nbsp;&nbsp;done();<br>
&nbsp;&nbsp;}, 100);<br>
...
<h3>Subtests (Nested Tests)</h3>
<p>You can organize related tests using subtests:</p>
...
import assert from 'node:assert/strict';<br>
<br>
test('math operations', async (t) => {<br>
&nbsp;&nbsp;await t.test('addition', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;assert.equal(1 + 1, 2);<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;await t.test('multiplication', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;assert.equal(2 * 3, 6);<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;await t.test('division', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;assert.equal(10 / 2, 5);<br>
&nbsp;&nbsp;});<br>
});</div>
</div>

<h3>Setup and Teardown (Test Fixtures)</h3>
<p>For tests that need setup and teardown, use the <code class="w3-codespan">t.before()</code> and <code class="w3-codespan">t.after()</code> hooks:</p>
...
import assert from 'node:assert/strict';<br>
<br>
test('using test fixtures', async (t) => {<br>
&nbsp;&nbsp;// Setup - runs before the test<br>
&nbsp;&nbsp;t.before(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Setting up test resources');<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Example: Create test database, mock services, etc.<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Actual test<br>
&nbsp;&nbsp;await t.test('my test with fixtures', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;assert.equal(1 + 1, 2);<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Teardown - runs after the test<br>
&nbsp;&nbsp;t.after(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Cleaning up test resources');<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Example: Delete test database, restore mocks, etc.<br>
&nbsp;&nbsp;});<br>
});</div>
</div>

<h3>Skipping and Todo Tests</h3>
<p>You can mark tests to be skipped or as todos:</p>
...
<br>
// Skip this test<br>
test('skipped test', { skip: true }, () => {<br>
&nbsp;&nbsp;// This won't run<br>
});<br>
<br>
// Skip with a reason<br>
test('skipped with reason', { skip: 'working on this later' }, () => {<br>
&nbsp;&nbsp;// This won't run<br>
});<br>
<br>
// Mark as TODO<br>
test('todo test', { todo: true }, () => {<br>
&nbsp;&nbsp;// This won't run, but will be reported as TODO<br>
});<br>
<br>
// Conditional skip<br>
test('conditional skip', { skip: process.platform === 'win32' }, () => {<br>
&nbsp;&nbsp;// This will be skipped on Windows<br>
});</div>
</div>

<h2>Assertions</h2>
<p>The Node.js Test Runner works with the built-in <code class="w3-codespan">assert</code> module. For stricter equality checks, use <code class="w3-codespan">assert/strict</code>.</p>
...
<br>
// Equality checks<br>
assert.equal(1, 1);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Loose equality (==)<br>
assert.strictEqual(1, 1);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Strict equality (===)<br>
assert.deepEqual({a: 1}, {a: 1});&nbsp;&nbsp; // Deep equality for objects<br>
assert.deepStrictEqual({a: 1}, {a: 1}); // Strict deep equality<br>
<br>
// Truthiness checks<br>
assert.ok(true);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Checks if value is truthy<br>
assert.ok(1);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Also truthy<br>
<br>
// Comparing values<br>
assert.notEqual(1, 2);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Check inequality<br>
assert.notStrictEqual(1, '1');&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Check strict inequality<br>
<br>
// Throwing errors<br>
assert.throws(() => { throw new Error('Boom!'); }); // Check if function throws<br>
assert.doesNotThrow(() => { return 42; });&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Check if no error thrown<br>
<br>
// Async assertions<br>
await assert.rejects(&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Check if Promise rejects<br>
&nbsp;&nbsp;async () => { throw new Error('Async boom!'); }<br>
);</div>
</div>
<hr>
<h2>Working with Mocks</h2>
<p>The Node.js Test Runner doesn't include built-in mocking, but you can:</p>

<ul>
  <li>Use dependency injection to provide test doubles</li>
  <li>Create simple mock functions and objects</li>
  <li>Integrate with third-party mocking libraries if needed</li>
</ul>

<div class="w3-example">
<h4>Simple Mock Example</h4>
<div class="w3-code notranslate jsHigh">
import test from 'node:test';<br>
import assert from 'node:assert/strict';<br>
<br>
// Function we want to test<br>
function processUser(user, logger) {<br>
&nbsp;&nbsp;if (!user.name) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;logger.error('User has no name');<br>
&nbsp;&nbsp;&nbsp;&nbsp;return false;<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;logger.info(`Processing user: ${user.name}`);<br>
&nbsp;&nbsp;return true;<br>
}<br>
<br>
// Test with a mock logger<br>
test('processUser logs correctly', () => {<br>
&nbsp;&nbsp;// Create a mock logger<br>
&nbsp;&nbsp;const mockCalls = [];<br>
&nbsp;&nbsp;const mockLogger = {<br>
&nbsp;&nbsp;&nbsp;&nbsp;error: (msg) => mockCalls.push(['error', msg]),<br>
&nbsp;&nbsp;&nbsp;&nbsp;info: (msg) => mockCalls.push(['info', msg])<br>
&nbsp;&nbsp;};<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Test with valid user<br>
&nbsp;&nbsp;const validResult = processUser({name: 'Alice'}, mockLogger);<br>
&nbsp;&nbsp;assert.strictEqual(validResult, true);<br>
&nbsp;&nbsp;assert.deepStrictEqual(mockCalls[0], ['info', 'Processing user: Alice']);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Reset mock calls<br>
&nbsp;&nbsp;mockCalls.length = 0;<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Test with invalid user<br>
&nbsp;&nbsp;const invalidResult = processUser({}, mockLogger);<br>
&nbsp;&nbsp;assert.strictEqual(invalidResult, false);<br>
&nbsp;&nbsp;assert.deepStrictEqual(mockCalls[0], ['error', 'User has no name']);<br>
});</div>
</div>
<hr>
<h2>Testing Real Examples</h2>

<h3>Testing a Utility Function</h3>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// utils.js<br>
exports.formatPrice = function(price) {<br>
&nbsp;&nbsp;if (typeof price !== 'number' || isNaN(price)) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;throw new Error('Price must be a valid number');<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;return `$${price.toFixed(2)}`;<br>
};<br>
<br>
// utils.test.js<br>
const test = require('node:test');<br>
const assert = require('node:assert/strict');<br>
const { formatPrice } = require('./utils');<br>
<br>
// Test cases<br>
test('formatPrice formats numbers as currency strings', (t) => {<br>
&nbsp;&nbsp;assert.equal(formatPrice(10), '$10.00');<br>
&nbsp;&nbsp;assert.equal(formatPrice(10.5), '$10.50');<br>
&nbsp;&nbsp;assert.equal(formatPrice(0), '$0.00');<br>
});<br>
<br>
// Test for error<br>
test('formatPrice throws error for invalid inputs', (t) => {<br>
&nbsp;&nbsp;assert.throws(() => formatPrice('not a number'), {<br>
&nbsp;&nbsp;&nbsp;&nbsp;message: 'Price must be a valid number'<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;assert.throws(() => formatPrice(NaN));<br>
&nbsp;&nbsp;assert.throws(() => formatPrice());<br>
});
</div>
</div>

<h3>Testing an API Endpoint</h3>
...
&nbsp;&nbsp;// Simplified - in real app would fetch from database<br>
&nbsp;&nbsp;if (userId === 1) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.json({ id: 1, name: 'John Doe', email: 'john@example.com' });<br>
&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.status(404).json({ error: 'User not found' });<br>
&nbsp;&nbsp;}<br>
});<br>
<br>
...
const app = require('./userService');<br>
<br>
test('GET /users/:id returns correct user', async (t) => {<br>
&nbsp;&nbsp;// Start the server<br>
&nbsp;&nbsp;const server = http.createServer(app);<br>
&nbsp;&nbsp;await new Promise(resolve => server.listen(0, resolve));<br>
&nbsp;&nbsp;const port = server.address().port;<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Make request to our API<br>
&nbsp;&nbsp;&nbsp;&nbsp;const response = await fetch(`http://localhost:${port}/users/1`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;assert.equal(response.status, 200, 'Status should be 200');<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;const user = await response.json();<br>
&nbsp;&nbsp;&nbsp;&nbsp;assert.deepStrictEqual(user, {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;id: 1,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;name: 'John Doe',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;email: 'john@example.com'<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Test not found case<br>
&nbsp;&nbsp;&nbsp;&nbsp;const notFoundResponse = await fetch(`http://localhost:${port}/users/999`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;assert.equal(notFoundResponse.status, 404, 'Status should be 404');<br>
&nbsp;&nbsp;} finally {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Clean up - close the server<br>
&nbsp;&nbsp;&nbsp;&nbsp;await new Promise(resolve => server.close(resolve));<br>
&nbsp;&nbsp;}<br>
});</div>
</div>
<hr>
...
<p>You can specify different output formats for test results:</p>
...
<p>Available reporters include:</p>
<ul>
  <li><code class="w3-codespan">spec</code> - Detailed hierarchical view</li>
  <li><code class="w3-codespan">dot</code> - Minimal dots output</li>
  <li><code class="w3-codespan">tap</code> - Test Anything Protocol format</li>
  <li><code class="w3-codespan">junit</code> - JUnit XML format</li>
</ul>

<h3>Filtering Tests</h3>
<p>You can filter which tests to run using patterns:</p>
...
<p>This runs only tests with "user" in their name.</p>

<h3>Watch Mode</h3>
<p>For development, you can run tests in watch mode to automatically rerun when files change:</p>
...
<hr>
<h2>Comparison with Other Testing Frameworks</h2>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><strong>Assertion Library</strong></td>
    <td>node:assert</td>
    <td>Jest Expect</td>
    <td>Chai/Sinon</td>
    <td>Jest-compatible</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>✅ With NODE_V8_COVERAGE</td>
    <td>✅ Built-in</td>
    <td>❌ Needs nyc/istanbul</td>
    <td>✅ Built-in</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Built-in solution, simple projects</td>
    <td>Full-featured testing</td>
    <td>Flexible testing</td>
    <td>Vite projects, ESM</td>
  </tr>
</table>
</div>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> The Node.js Test Runner is ideal for projects that want a lightweight, zero-dependency testing solution that's built into Node.js itself.</p>
  <p>For more complex testing needs, Jest or Mocha might be better choices.</p>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_test_runner.js" data-extensions="asp"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_testing_frameworks.asp">&lt; Previous</a>
