...
<meta name="title" property="og:title" content="Node.js MongoDB Delete">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_mongodb_delete.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="To delete a record, or document as it is called in MongoDB, we use the deleteOne() method.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js MongoDB Delete">
<meta name="twitter:description" content="To delete a record, or document as it is called in MongoDB, we use the deleteOne() method.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_mongodb_delete.png">
...
<div class="w3-code notranslate jsHigh">
  ...
  let url = &quot;mongodb://localhost:27017/&quot;;<br><br>
  MongoClient.connect(url, function(err, db) {<br>&nbsp; if (err) throw err;<br>&nbsp; 
  let dbo = db.db(&quot;mydb&quot;);<br>
  <strong>&nbsp; let myquery = { address: 'Mountain 21' };<br></strong>&nbsp; 
...
<div class="w3-code notranslate jsHigh">
  ...
  MongoClient.connect(url, function(err, db) {<br>&nbsp; if (err) throw err;<br>&nbsp; 
  let dbo = db.db(&quot;mydb&quot;);<br>
  <strong>&nbsp; let myquery = { address: /^O/ };<br></strong>&nbsp; 
...
<hr>
<div id="exercisecontainer" src="xrcise_mongodb_delete.js" data-extensions="asp"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_mongodb_sort.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="nodejs_mongodb_drop.asp">Next &#10095;</a>
