...
<meta name="title" property="og:title" content="Node.js Assert Module">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_assert.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="The Assert module provides a simple yet powerful set of assertion tests for validating invariants in your code.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Assert Module">
<meta name="twitter:description" content="The Assert module provides a simple yet powerful set of assertion tests for validating invariants in your code.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_assert.png">
...
<h1>Node.js Assert Module</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_dns.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="nodejs_util.asp">Next &#10095;</a>
</div>
<hr>

<h2>What is the Assert Module?</h2>

<p>The Assert module provides a simple yet powerful set of assertion tests for validating invariants in your code.</p>
<p>It's a core Node.js module that doesn't require installation.</p>

<p>Key features include:</p>
<ul>
  <li>Simple truthy/falsy assertions</li>
  <li>Strict and loose equality checks</li>
  <li>Deep object comparison</li>
  <li>Error throwing and handling</li>
  <li>Support for async/await patterns</li>
</ul>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> While not as feature-rich as testing frameworks like Jest or Mocha, the Assert module is lightweight and perfect for simple testing needs or when you want to avoid external dependencies.</p>
</div>

<hr>

<h2>Getting Started with Assert</h2>

<p>Here's a quick example of using the Assert module to test a simple function:</p>

<div class="w3-example">
<h3>Basic Assertion Example</h3>
<div class="w3-code notranslate jsHigh">const assert = require('assert').strict;<br>
<br>
// Function to test<br>
function add(a, b) {<br>
&nbsp;&nbsp;if (typeof a !== 'number' || typeof b !== 'number') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;throw new TypeError('Inputs must be numbers');<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;return a + b;<br>
}<br>
// Test cases<br>
assert.strictEqual(add(2, 3), 5, '2 + 3 should equal 5');<br>
// Test error case<br>
assert.throws(<br>
&nbsp;&nbsp;() => add('2', 3),<br>
&nbsp;&nbsp;TypeError,<br>
&nbsp;&nbsp;'Should throw TypeError for non-number input'<br>
);<br>
console.log('All tests passed!');</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_assert_quickstart">Run example &raquo;</a>
</div>
<hr>

<h2>Importing and Setup</h2>

<p>There are several ways to import and use the Assert module in your Node.js application:</p>

<div class="w3-example">
<h3>CommonJS Import (Node.js)</h3>
...
<br>
// Destructuring specific methods<br>
const { strictEqual, deepStrictEqual, throws } = require('assert');<br>
<br>
// For async/await tests<br>
const { rejects, doesNotReject } = require('assert').strict;</div>
</div>
...
<br>
// Using strict mode with ESM<br>
import { strict as assert } from 'assert';<br>
<br>
// Importing specific methods<br>
import { strictEqual, deepStrictEqual } from 'assert';<br>
<br>
// Dynamic import<br>
const { strict: assert } = await import('assert');</div>
</div>

<div class="w3-panel ws-info">
<p><strong>Best Practice:</strong> The strict mode is recommended as it provides more accurate comparisons and better error messages.</p>
<p>It's also more aligned with future versions of Node.js where strict mode will be the default.</p>
</div>
...
<h2>Core Assertion Methods</h2>

<p>The Assert module provides several methods for making assertions about values in your code.</p>
<p>These methods form the foundation of testing with the Assert module.</p>

<h3>assert(value[, message])</h3>
<p>Tests if a value is truthy. If the value is falsy, an AssertionError is thrown.</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">const assert = require('assert');<br>
<br>
// This will pass<br>
assert(true);<br>
assert(1);<br>
...
<br>
try {<br>
&nbsp;&nbsp;// This will throw an AssertionError<br>
&nbsp;&nbsp;assert(false, 'This value is not truthy');<br>
} catch (err) {<br>
&nbsp;&nbsp;console.error(`Error: ${err.message}`);<br>
}<br>
<br>
try {<br>
&nbsp;&nbsp;// These will also throw errors<br>
&nbsp;&nbsp;assert(0);<br>
&nbsp;&nbsp;assert('');<br>
&nbsp;&nbsp;assert(null);<br>
&nbsp;&nbsp;assert(undefined);<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_assert_basic">Run example &raquo;</a>
</div>

<h3>assert.ok(value[, message])</h3>
<p>This is an alias for <code class="w3-codespan">assert()</code>.</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">const assert = require('assert');<br>
<br>
// These assertions are equivalent<br>
assert.ok(true, 'This value is truthy');<br>
assert(true, 'This value is truthy');</div>
</div>
...
<p>The Assert module provides multiple ways to compare values, each with different behaviors regarding type coercion and object comparison.</p>

<h3><code class="w3-codespan">assert.equal(actual, expected[, message])</code></h3>
<p>Tests shallow, coercive equality between the actual and expected parameters using the equality operator (<code class="w3-codespan">==</code>).</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">const assert = require('assert');<br>
<br>
// These will pass (coercive equality)<br>
assert.equal(1, 1);<br>
assert.equal('1', 1);  // String is coerced to number<br>
assert.equal(true, 1); // Boolean is coerced to number<br>
<br>
try {<br>
&nbsp;&nbsp;// This will throw an error<br>
&nbsp;&nbsp;assert.equal(1, 2, '1 is not equal to 2');<br>
} catch (err) {<br>
&nbsp;&nbsp;console.error(`Error: ${err.message}`);<br>
}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_assert_equal">Run example &raquo;</a>
</div>

<h3><code class="w3-codespan">assert.strictEqual(actual, expected[, message])</code></h3>
<p>Tests strict equality between the actual and expected parameters using the strict equality operator (<code class="w3-codespan">===</code>).</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">const assert = require('assert');<br>
<br>
// This will pass<br>
assert.strictEqual(1, 1);<br>
<br>
try {<br>
&nbsp;&nbsp;// These will throw errors (strict equality)<br>
&nbsp;&nbsp;assert.strictEqual('1', 1, 'String "1" is not strictly equal to number 1');<br>
&nbsp;&nbsp;assert.strictEqual(true, 1, 'true is not strictly equal to 1');<br>
} catch (err) {<br>
&nbsp;&nbsp;console.error(`Error: ${err.message}`);<br>
}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_assert_strictequal">Run example &raquo;</a>
</div>

<div class="w3-panel ws-note">
<p><strong>Best Practice:</strong> It's recommended to use <code class="w3-codespan">strictEqual()</code> over <code class="w3-codespan">equal()</code> to avoid unexpected type coercion issues.</p>
</div>
<hr>
<h2>Object and Array Comparison</h2>

<p>When working with objects and arrays, you'll need to use deep equality checks to compare their contents rather than just their references.</p>
<p>For comparing objects and arrays, Node.js provides deep equality functions:</p>

<h4><code class="w3-codespan">assert.deepEqual(actual, expected[, message])</code></h4>
<p>Tests for deep equality between the actual and expected parameters with loose equality (<code class="w3-codespan">==</code>).</p>

<h4><code class="w3-codespan">assert.deepStrictEqual(actual, expected[, message])</code></h4>
<p>Tests for deep equality between the actual and expected parameters with strict equality (<code class="w3-codespan">===</code>).</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">const assert = require('assert');<br>
<br>
// Objects with the same structure<br>
const obj1 = { a: 1, b: { c: 2 } };<br>
const obj2 = { a: 1, b: { c: 2 } };<br>
const obj3 = { a: '1', b: { c: '2' } };<br>
<br>
// These will pass<br>
assert.deepEqual(obj1, obj2);<br>
assert.deepStrictEqual(obj1, obj2);<br>
<br>
// This will pass (loose equality)<br>
assert.deepEqual(obj1, obj3);<br>
<br>
try {<br>
&nbsp;&nbsp;// This will throw an error (strict equality)<br>
&nbsp;&nbsp;assert.deepStrictEqual(obj1, obj3, 'Objects are not strictly deep-equal');<br>
} catch (err) {<br>
&nbsp;&nbsp;console.error(`Error: ${err.message}`);<br>
}<br>
<br>
...
const arr2 = [1, 2, [3, 4]];<br>
const arr3 = ['1', '2', ['3', '4']];<br>
<br>
// These will pass<br>
assert.deepEqual(arr1, arr2);<br>
assert.deepStrictEqual(arr1, arr2);<br>
<br>
// This will pass (loose equality)<br>
assert.deepEqual(arr1, arr3);<br>
<br>
try {<br>
&nbsp;&nbsp;// This will throw an error (strict equality)<br>
&nbsp;&nbsp;assert.deepStrictEqual(arr1, arr3, 'Arrays are not strictly deep-equal');<br>
} catch (err) {<br>
&nbsp;&nbsp;console.error(`Error: ${err.message}`);<br>
}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_assert_deepequal">Run example &raquo;</a>
</div>

<hr>

<h2>Inequality and Negation</h2>

<p>Just as important as checking for equality is verifying that values are not equal when they shouldn't be.</p>

<h3><code class="w3-codespan">assert.notEqual(actual, expected[, message])</code></h3>
<p>Tests shallow, coercive inequality using the inequality operator (<code class="w3-codespan">!=</code>).</p>

<h3><code class="w3-codespan">assert.notStrictEqual(actual, expected[, message])</code></h3>
<p>Tests strict inequality using the strict inequality operator (<code class="w3-codespan">!==</code>).</p>
...
assert.notStrictEqual('1', 1);<br>
<br>
try {<br>
&nbsp;&nbsp;// This will throw an error<br>
&nbsp;&nbsp;assert.notEqual(1, '1', '1 is coercively equal to "1"');<br>
} catch (err) {<br>
&nbsp;&nbsp;console.error(`Error: ${err.message}`);<br>
}<br>
<br>
try {<br>
&nbsp;&nbsp;// This will throw an error<br>
&nbsp;&nbsp;assert.notStrictEqual(1, 1, '1 is strictly equal to 1');<br>
} catch (err) {<br>
&nbsp;&nbsp;console.error(`Error: ${err.message}`);<br>
}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_assert_notequal">Run example &raquo;</a>
</div>
<hr>
<h2>Deep Inequality</h2>

<h4><code class="w3-codespan">assert.notDeepEqual(actual, expected[, message])</code></h4>
<p>Tests for deep inequality with loose inequality.</p>

<h4><code class="w3-codespan">assert.notDeepStrictEqual(actual, expected[, message])</code></h4>
<p>Tests for deep inequality with strict inequality.</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">const assert = require('assert');<br>
<br>
const obj1 = { a: 1, b: 2 };<br>
const obj2 = { a: 1, b: 3 };<br>
const obj3 = { a: '1', b: '2' };<br>
<br>
// These will pass<br>
assert.notDeepEqual(obj1, obj2);<br>
assert.notDeepStrictEqual(obj1, obj2);<br>
assert.notDeepStrictEqual(obj1, obj3);<br>
<br>
try {<br>
&nbsp;&nbsp;// This will throw an error (loose equality)<br>
&nbsp;&nbsp;assert.notDeepEqual(obj1, obj3, 'obj1 is loosely deep-equal to obj3');<br>
} catch (err) {<br>
&nbsp;&nbsp;console.error(`Error: ${err.message}`);<br>
}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_assert_notdeepequal">Run example &raquo;</a>
</div>
...
<p>Testing that your code throws the expected errors is a critical part of writing robust applications.</p>
<p>The Assert module provides several methods for this purpose.</p>

<h3><code class="w3-codespan">assert.throws(fn[, error][, message])</code></h3>
<p>Expects the function <code class="w3-codespan">fn</code> to throw an error. If not, an AssertionError is thrown.</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">const assert = require('assert');<br>
<br>
// Function that throws an error<br>
function throwingFunction() {<br>
&nbsp;&nbsp;throw new Error('Error thrown');<br>
}<br>
<br>
// This will pass<br>
assert.throws(throwingFunction);<br>
<br>
// Check for a specific error message<br>
assert.throws(<br>
&nbsp;&nbsp;throwingFunction,<br>
&nbsp;&nbsp;/Error thrown/,<br>
...
<br>
// Check for a specific error type<br>
assert.throws(<br>
&nbsp;&nbsp;throwingFunction,<br>
&nbsp;&nbsp;Error,<br>
&nbsp;&nbsp;'Wrong error type'<br>
...
<br>
// Check with a validation function<br>
assert.throws(<br>
&nbsp;&nbsp;throwingFunction,<br>
&nbsp;&nbsp;function(err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;return err instanceof Error && /thrown/.test(err.message);<br>
&nbsp;&nbsp;},<br>
...
&nbsp;&nbsp;// This will throw an AssertionError<br>
&nbsp;&nbsp;assert.throws(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// This function doesn't throw<br>
&nbsp;&nbsp;&nbsp;&nbsp;return 'no error';<br>
&nbsp;&nbsp;}, 'Expected function to throw');<br>
} catch (err) {<br>
&nbsp;&nbsp;console.error(`Error: ${err.message}`);<br>
}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_assert_throws">Run example &raquo;</a>
</div>

<h3><code class="w3-codespan">assert.doesNotThrow(fn[, error][, message])</code></h3>
<p>Expects the function <code class="w3-codespan">fn</code> to not throw an error. If it does, the error is propagated.</p>
...
<br>
try {<br>
&nbsp;&nbsp;// This will throw the original error<br>
&nbsp;&nbsp;assert.doesNotThrow(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;throw new Error('This will be thrown');<br>
&nbsp;&nbsp;}, 'Unexpected error');<br>
} catch (err) {<br>
&nbsp;&nbsp;console.error(`Error: ${err.message}`);<br>
}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_assert_doesnotthrow">Run example &raquo;</a>
</div>
...
<p>Modern JavaScript makes heavy use of asynchronous patterns.</p>
<p>The Assert module provides utilities for testing both Promise-based and callback-based asynchronous code.</p>

<h3><code class="w3-codespan">assert.rejects(asyncFn[, error][, message])</code></h3>
<p>Awaits the <code class="w3-codespan">asyncFn</code> promise or async function and expects it to reject.</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">const assert = require('assert');<br>
<br>
async function asyncTest() {<br>
&nbsp;&nbsp;// Function that returns a rejecting promise<br>
&nbsp;&nbsp;function failingAsyncFunction() {<br>
&nbsp;&nbsp;&nbsp;&nbsp;return Promise.reject(new Error('Async error'));<br>
&nbsp;&nbsp;}<br>
<br>
&nbsp;&nbsp;// This will pass<br>
&nbsp;&nbsp;await assert.rejects(<br>
&nbsp;&nbsp;&nbsp;&nbsp;failingAsyncFunction(),<br>
&nbsp;&nbsp;&nbsp;&nbsp;/Async error/<br>
&nbsp;&nbsp;);<br>
<br>
&nbsp;&nbsp;// This will also pass<br>
&nbsp;&nbsp;await assert.rejects(<br>
&nbsp;&nbsp;&nbsp;&nbsp;async () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;throw new Error('Async function error');<br>
&nbsp;&nbsp;&nbsp;&nbsp;},<br>
&nbsp;&nbsp;&nbsp;&nbsp;{<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;name: 'Error',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;message: 'Async function error'<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;);<br>
<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// This will throw an AssertionError<br>
&nbsp;&nbsp;&nbsp;&nbsp;await assert.rejects(<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Promise.resolve('success'),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'Expected promise to reject'<br>
&nbsp;&nbsp;&nbsp;&nbsp;);<br>
&nbsp;&nbsp;} catch (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error(`Error: ${err.message}`);<br>
&nbsp;&nbsp;}<br>
...
<br>
// Run the async test<br>
asyncTest().catch(err => console.error(`Unhandled error: ${err.message}`));</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_assert_rejects">Run example &raquo;</a>
</div>

<h3><code class="w3-codespan">assert.doesNotReject(asyncFn[, error][, message])</code></h3>
<p>Awaits the <code class="w3-codespan">asyncFn</code> promise or async function and expects it to fulfill.</p>
...
&nbsp;&nbsp;await assert.doesNotReject(<br>
&nbsp;&nbsp;&nbsp;&nbsp;async () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return 'async function success';<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;);<br>
<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// This will throw the original rejection reason<br>
&nbsp;&nbsp;&nbsp;&nbsp;await assert.doesNotReject(<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Promise.reject(new Error('Failure')),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'Expected promise to fulfill'<br>
&nbsp;&nbsp;&nbsp;&nbsp;);<br>
&nbsp;&nbsp;} catch (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error(`Error: ${err.message}`);<br>
&nbsp;&nbsp;}<br>
...
// Run the async test<br>
asyncTest().catch(err => console.error(`Unhandled error: ${err.message}`));</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_assert_doesnotreject">Run example &raquo;</a>
</div>

<hr>

<h2>Other Assertion Methods</h2>

<h3><code class="w3-codespan">assert.match(string, regexp[, message])</code></h3>
<p>Expects the string input to match the regular expression.</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">const assert = require('assert');<br>
<br>
// This will pass<br>
assert.match('I love Node.js', /Node\.js/);<br>
<br>
try {<br>
&nbsp;&nbsp;// This will throw an AssertionError<br>
&nbsp;&nbsp;assert.match('Hello World', /Node\.js/, 'String does not match the pattern');<br>
} catch (err) {<br>
&nbsp;&nbsp;console.error(`Error: ${err.message}`);<br>
}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_assert_match">Run example &raquo;</a>
</div>

<h3><code class="w3-codespan">assert.fail([message])</code></h3>
<p>Throws an AssertionError with the provided message or a default message.</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">const assert = require('assert');<br>
<br>
try {<br>
&nbsp;&nbsp;// This always throws an AssertionError<br>
&nbsp;&nbsp;assert.fail('This test always fails');<br>
} catch (err) {<br>
&nbsp;&nbsp;console.error(`Error: ${err.message}`);<br>
}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_assert_fail">Run example &raquo;</a>
</div>
...
<p>Node.js provides a strict mode for assertions which uses strict equality for all comparisons.</p>
<p>It's recommended to use strict mode for more predictable results.</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">// Import the strict version of assert<br>
const assert = require('assert').strict;<br>
<br>
// These are equivalent<br>
assert.strictEqual(1, 1);<br>
assert.equal(1, 1);  // In strict mode, this is the same as strictEqual<br>
<br>
// These are equivalent<br>
assert.deepStrictEqual({ a: 1 }, { a: 1 });<br>
assert.deepEqual({ a: 1 }, { a: 1 });  // In strict mode, this is the same as deepStrictEqual<br>
<br>
try {<br>
&nbsp;&nbsp;// This will throw an error in strict mode<br>
&nbsp;&nbsp;assert.equal('1', 1);<br>
} catch (err) {<br>
&nbsp;&nbsp;console.error(`Error: ${err.message}`);<br>
}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_assert_strict">Run example &raquo;</a>
</div>

<hr>

<h2>When to Use Node.js Assert vs Testing Frameworks</h2>

<h3>Use Node.js Assert When:</h3>
<ul>
  <li>Writing simple scripts or small utilities</li>
  <li>Creating quick tests during development</li>
  <li>You want to avoid external dependencies</li>
  <li>Building internal Node.js modules</li>
</ul>

<h3>Use a Testing Framework (Jest, Mocha, etc.) When:</h3>
<ul>
  <li>Working on larger projects</li>
  <li>You need features like test runners, reporters, and mocking</li>
  <li>Building applications that require comprehensive test coverage</li>
  <li>You need better error reporting and test organization</li>
</ul>

<div class="w3-panel w3-note">
<p>For serious application testing, consider using the built-in <a href="nodejs_test_runner.asp">Node.js Test Runner</a> introduced in Node.js v18 or a dedicated testing framework like Jest, Mocha, or AVA.</p>
</div>

<hr>

<div id="exercisecontainer" src="xrcise_assert.js" data-extensions="asp"></div>
