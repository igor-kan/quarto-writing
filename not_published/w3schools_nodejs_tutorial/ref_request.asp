...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Request Reference</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js Request Reference">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/ref_request.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="The HTTP Request object is created internally by Node.js and passed as the first parameter to the request event callback when making HTTP requests.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Request Reference">
<meta name="twitter:description" content="The HTTP Request object is created internally by Node.js and passed as the first parameter to the request event callback when making HTTP requests.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/ref_request.png">
...
<h1>Node.js Request Reference</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="ref_agent.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ref_response.asp">Next &#10095;</a>
</div>
...
<p>The HTTP Request object is created internally by Node.js and passed as the first parameter to the request event callback when making HTTP requests. It represents an incoming message from the client when used with HTTP servers, or an outgoing message when used with HTTP clients.</p>

<p>There are two main types of Request objects in Node.js:</p>

<ul>
  <li><code class="w3-codespan">http.ClientRequest</code> - Created when making outgoing HTTP requests</li>
  <li><code class="w3-codespan">http.IncomingMessage</code> - Received by the server when handling client requests</li>
</ul>

<hr>

<h2>ClientRequest Object</h2>

<p>The <code class="w3-codespan">http.ClientRequest</code> object is an instance of <code class="w3-codespan">Writable Stream</code> created when calling <code class="w3-codespan">http.request()</code> or <code class="w3-codespan">http.get()</code>. It represents an outgoing HTTP request that you send to a server.</p>

<h3>Creating a ClientRequest</h3>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const http = require('http');<br>
<br>
// Create a client request<br>
...
&nbsp;&nbsp;// Handle response (IncomingMessage)<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_request_create">Run example &raquo;</a>
</div>

<hr>

<h2>ClientRequest Properties</h2>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    ...
    <td>A boolean indicating if the request has been aborted.</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Reference to the underlying socket. Alias of <code class="w3-codespan">request.connection</code>.</td>
  </tr>
  <tr>
    <td>request.finished</td>
    <td>A boolean indicating if the request has completed sending data.</td>
  </tr>
  <tr>
    <td>request.path</td>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td>request.abort()</td>
    <td>Marks the request as aborted.</td>
  </tr>
  <tr>
    <td>request.destroy([error])</td>
    <td>Destroys the request. Optionally emits the passed error.</td>
  </tr>
  <tr>
    <td>request.end([data[, encoding]][, callback])</td>
    <td>Finishes sending the request. If any parts of the body are unsent, it will flush them to the stream.</td>
  </tr>
  <tr>
    <td>request.flushHeaders()</td>
    <td>Flushes the request headers.</td>
  </tr>
  <tr>
    <td>request.getHeader(name)</td>
    <td>Gets the value of a header which has already been queued but not sent.</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Sets a single header value for headers object.</td>
  </tr>
  <tr>
    <td>request.setNoDelay([noDelay])</td>
    <td>Sets the socket's <code class="w3-codespan">noDelay</code> option.</td>
  </tr>
  <tr>
    <td>request.setSocketKeepAlive([enable][, initialDelay])</td>
    <td>Sets the socket's <code class="w3-codespan">keepAlive</code> option.</td>
  </tr>
  <tr>
    <td>request.setTimeout(timeout[, callback])</td>
    <td>Sets the timeout value for the request.</td>
  </tr>
  <tr>
    <td>request.write(chunk[, encoding][, callback])</td>
    <td>Sends a chunk of the body.</td>
  </tr>
</table>

<hr>

<h2>ClientRequest Events</h2>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td>'abort'</td>
    <td>Emitted when the request has been aborted.</td>
  </tr>
  <tr>
    <td>'connect'</td>
    <td>Emitted when a server responds to a request with a CONNECT method.</td>
  </tr>
  <tr>
    <td>'continue'</td>
    <td>Emitted when the server sends a '100 Continue' HTTP response.</td>
  </tr>
  <tr>
    <td>'information'</td>
    <td>Emitted when the server sends a 1xx response (excluding 101 Upgrade).</td>
  </tr>
  <tr>
    <td>'response'</td>
    <td>Emitted when a response is received to this request. This event is emitted only once.</td>
  </tr>
  <tr>
    <td>'socket'</td>
    <td>Emitted when a socket is assigned to this request.</td>
  </tr>
  <tr>
    <td>'timeout'</td>
    <td>Emitted when the request times out.</td>
  </tr>
  <tr>
    <td>'upgrade'</td>
    <td>Emitted when the server responds with an upgrade.</td>
  </tr>
  <tr>
    <td>'close'</td>
    <td>Emitted when the request is closed.</td>
  </tr>
  <tr>
    <td>'error'</td>
    <td>Emitted when an error occurs.</td>
  </tr>
</table>

<hr>

<h2>IncomingMessage Object</h2>

<p>The <code class="w3-codespan">http.IncomingMessage</code> object is created by an HTTP server and passed as the first argument to the 'request' event. It represents an incoming message, typically a request from a client or a response from a server.</p>

<h3>Accessing IncomingMessage on a Server</h3>
...
&nbsp;&nbsp;// 'req' is an IncomingMessage object<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_request_incoming">Run example &raquo;</a>
</div>

<hr>

<h2>IncomingMessage Properties</h2>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    ...
    <td>The HTTP version sent by the client (e.g., '1.1', '1.0').</td>
  </tr>
  <tr>
    <td>message.method</td>
    <td>The request method as a string (only for request objects).</td>
  </tr>
  <tr>
    <td>message.rawHeaders</td>
    <td>The raw request/response headers list exactly as they were received.</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>The HTTP response status code (only for response objects).</td>
  </tr>
  <tr>
    <td>message.statusMessage</td>
    <td>The HTTP response status message (only for response objects).</td>
  </tr>
  <tr>
  ...
  <tr>
    <td>message.url</td>
    <td>The request URL string (only for request objects).</td>
  </tr>
</table>

<hr>

<h2>IncomingMessage Methods</h2>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    ...
    <td>Destroys the message. Optionally emits the passed error.</td>
  </tr>
  <tr>
    <td>message.setTimeout(msecs, callback)</td>
    <td>Sets the socket's timeout value.</td>
  </tr>
</table>

<hr>

<h2>Basic GET Request Example</h2>

<p>A basic example using <code class="w3-codespan">http.get()</code> to make a GET request:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const http = require('http');<br>
<br>
// Make a simple GET request<br>
http.get('http://example.com', (res) => {<br>
&nbsp;&nbsp;const { statusCode } = res;<br>
&nbsp;&nbsp;const contentType = res.headers['content-type'];<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;console.log(`Status Code: ${statusCode}`);<br>
&nbsp;&nbsp;console.log(`Content-Type: ${contentType}`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;let error;<br>
&nbsp;&nbsp;if (statusCode !== 200) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;error = new Error(`Request Failed. Status Code: ${statusCode}`);<br>
&nbsp;&nbsp;} else if (!/^text\/html/.test(contentType)) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;error = new Error(`Invalid content-type. Expected text/html but received ${contentType}`);<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;if (error) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error(error.message);<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Consume response data to free up memory<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.resume();<br>
&nbsp;&nbsp;&nbsp;&nbsp;return;<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
...
&nbsp;&nbsp;let rawData = '';<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Collect response data as it arrives<br>
&nbsp;&nbsp;res.on('data', (chunk) => { rawData += chunk; });<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Process the complete response<br>
&nbsp;&nbsp;res.on('end', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Response length: ${rawData.length} characters`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('First 100 characters:');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(rawData.substring(0, 100) + '...');<br>
&nbsp;&nbsp;&nbsp;&nbsp;} catch (e) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error(e.message);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;});<br>
}).on('error', (e) => {<br>
&nbsp;&nbsp;console.error(`Got error: ${e.message}`);<br>
});
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_request_get">Run example &raquo;</a>
</div>
...
<p>Making a POST request with data:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const http = require('http');<br>
<br>
// Data to send in the POST request<br>
const postData = JSON.stringify({<br>
&nbsp;&nbsp;'name': 'John Doe',<br>
&nbsp;&nbsp;'email': 'john@example.com',<br>
&nbsp;&nbsp;'message': 'Hello from Node.js HTTP client!'<br>
});<br>
<br>
// Request options<br>
const options = {<br>
&nbsp;&nbsp;hostname: 'postman-echo.com',<br>
&nbsp;&nbsp;port: 80,<br>
&nbsp;&nbsp;path: '/post',<br>
&nbsp;&nbsp;method: 'POST',<br>
&nbsp;&nbsp;headers: {<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(JSON.stringify(parsedData, null, 2));<br>
&nbsp;&nbsp;&nbsp;&nbsp;} catch (e) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// If not JSON, show as text<br>
...
<br>
req.on('error', (e) => {<br>
&nbsp;&nbsp;console.error(`Problem with request: ${e.message}`);<br>
});<br>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_request_post">Run example &raquo;</a>
</div>

<hr>

<h2>Handling Request Headers</h2>

<p>Working with request headers:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const http = require('http');<br>
<br>
// Create a server to demonstrate request headers<br>
const server = http.createServer((req, res) => {<br>
&nbsp;&nbsp;// Display request information<br>
&nbsp;&nbsp;console.log(`Request received: ${req.method} ${req.url}`);<br>
&nbsp;&nbsp;console.log(`HTTP Version: ${req.httpVersion}`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Display standard headers<br>
&nbsp;&nbsp;console.log('\nStandard Headers:');<br>
&nbsp;&nbsp;const stdHeaders = ['host', 'user-agent', 'accept', 'accept-language', 'content-type', 'content-length'];<br>
&nbsp;&nbsp;stdHeaders.forEach(header => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (req.headers[header]) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`${header}: ${req.headers[header]}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Display raw headers (name-value pairs)<br>
&nbsp;&nbsp;console.log('\nRaw Headers:');<br>
&nbsp;&nbsp;for (let i = 0; i &lt; req.rawHeaders.length; i += 2) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`${req.rawHeaders[i]}: ${req.rawHeaders[i+1]}`);<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Create response<br>
&nbsp;&nbsp;res.writeHead(200, {'Content-Type': 'text/html'});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Send response with headers information<br>
&nbsp;&nbsp;res.end(`<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;!DOCTYPE html&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;html&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;head&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;title&gt;Request Headers&lt;/title&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;/head&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;body&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;h1&gt;Your Request Headers&lt;/h1&gt;<br>
...
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Make a request to demonstrate headers<br>
&nbsp;&nbsp;const req = http.request({<br>
&nbsp;&nbsp;&nbsp;&nbsp;hostname: 'localhost',<br>
&nbsp;&nbsp;&nbsp;&nbsp;port: PORT,<br>
&nbsp;&nbsp;&nbsp;&nbsp;path: '/headers-demo',<br>
&nbsp;&nbsp;&nbsp;&nbsp;method: 'GET',<br>
&nbsp;&nbsp;&nbsp;&nbsp;headers: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'User-Agent': 'Node.js HTTP Client',<br>
...
&nbsp;&nbsp;<br>
&nbsp;&nbsp;req.on('error', (e) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error(`Demo request error: ${e.message}`);<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;req.end();<br>
});
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_request_headers">Run example &raquo;</a>
</div>
...
<p>Using a request to upload a file:</p>
...
<br>
// Create a sample file for upload<br>
const sampleFile = path.join(__dirname, 'upload-sample.txt');<br>
fs.writeFileSync(sampleFile, 'This is a sample file for upload demonstration.\n'.repeat(10));<br>
<br>
// Function to create multipart form-data boundary and body<br>
function createMultipartFormData(fields, files) {<br>
&nbsp;&nbsp;const boundary = `----NodeJSUploadExample${Math.random().toString(16).substr(2)}`;<br>
&nbsp;&nbsp;let body = '';<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Add regular fields<br>
&nbsp;&nbsp;Object.keys(fields).forEach(field => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;body += `--${boundary}\r\n`;<br>
...
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Add files<br>
&nbsp;&nbsp;Object.keys(files).forEach(fileField => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const filePath = files[fileField];<br>
...
<br>
// Prepare form data<br>
const formData = createMultipartFormData(<br>
&nbsp;&nbsp;{ <br>
&nbsp;&nbsp;&nbsp;&nbsp;name: 'Node.js Upload Example',<br>
&nbsp;&nbsp;&nbsp;&nbsp;description: 'Uploading a file using HTTP client request'<br>
&nbsp;&nbsp;},<br>
&nbsp;&nbsp;{<br>
&nbsp;&nbsp;&nbsp;&nbsp;file: sampleFile<br>
&nbsp;&nbsp;}<br>
...
// Request options<br>
const options = {<br>
&nbsp;&nbsp;hostname: 'httpbin.org',<br>
&nbsp;&nbsp;port: 80,<br>
&nbsp;&nbsp;path: '/post',<br>
&nbsp;&nbsp;method: 'POST',<br>
&nbsp;&nbsp;headers: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;'Content-Type': `multipart/form-data; boundary=${formData.boundary}`,<br>
&nbsp;&nbsp;&nbsp;&nbsp;'Content-Length': Buffer.byteLength(formData.body)<br>
&nbsp;&nbsp;}<br>
};<br>
<br>
// Create the request<br>
const req = http.request(options, (res) => {<br>
&nbsp;&nbsp;console.log(`Upload Status: ${res.statusCode}`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;let responseData = '';<br>
&nbsp;&nbsp;res.setEncoding('utf8');<br>
&nbsp;&nbsp;<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const response = JSON.stringify(JSON.parse(responseData), null, 2);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(response);<br>
&nbsp;&nbsp;&nbsp;&nbsp;} catch (e) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(responseData);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Clean up sample file<br>
...
<br>
req.on('error', (e) => {<br>
&nbsp;&nbsp;console.error(`Upload error: ${e.message}`);<br>
});<br>
<br>
// Send the form data<br>
req.write(formData.body);<br>
req.end();<br>
<br>
console.log('Uploading file...');
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_request_upload">Run example &raquo;</a>
</div>

<hr>

<h2>Handling Request Timeouts</h2>

<p>Setting and handling request timeouts:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const http = require('http');<br>
<br>
// Create a request with timeout<br>
const req = http.request({<br>
&nbsp;&nbsp;hostname: 'example.com',<br>
&nbsp;&nbsp;port: 80,<br>
&nbsp;&nbsp;path: '/',<br>
&nbsp;&nbsp;method: 'GET',<br>
&nbsp;&nbsp;timeout: 8080 // 3 second timeout<br>
}, (res) => {<br>
&nbsp;&nbsp;console.log(`STATUS: ${res.statusCode}`);<br>
&nbsp;&nbsp;res.resume(); // Consume response data<br>
});<br>
<br>
// Handle timeout event<br>
req.on('timeout', () => {<br>
&nbsp;&nbsp;console.log('Request timed out after 3 seconds');<br>
&nbsp;&nbsp;req.abort(); // Abort the request<br>
});<br>
<br>
// Handle errors, including those caused by abort()<br>
req.on('error', (err) => {<br>
&nbsp;&nbsp;console.error(`Request error: ${err.message}`);<br>
});<br>
<br>
// End the request<br>
req.end();
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_request_timeout">Run example &raquo;</a>
</div>
...
<ol>
  <li><strong>Error handling</strong>: Always attach an error event handler to HTTP requests.</li>
  <li><strong>Consume response data</strong>: Always consume response data, even if you don't need it, to prevent memory leaks.</li>
  <li><strong>Set timeouts</strong>: Set appropriate timeouts to prevent hanging requests.</li>
  <li><strong>Content-Length</strong>: Always specify Content-Length for POST/PUT requests to ensure data is sent correctly.</li>
  <li><strong>End the request</strong>: Always call <code class="w3-codespan">request.end()</code> to finish sending the request.</li>
  <li><strong>Handle redirects</strong>: Be aware that Node.js does not follow redirects automatically - you need to handle them.</li>
  <li><strong>Reuse connections</strong>: Use a custom Agent with keepAlive for multiple requests to the same server.</li>
</ol>
