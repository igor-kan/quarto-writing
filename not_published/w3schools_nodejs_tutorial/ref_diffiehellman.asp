...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js DiffieHellman Reference</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js DiffieHellman Reference">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/ref_diffiehellman.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="The DiffieHellman class in Node.js's crypto module implements the Diffie-Hellman key exchange protocol.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js DiffieHellman Reference">
<meta name="twitter:description" content="The DiffieHellman class in Node.js's crypto module implements the Diffie-Hellman key exchange protocol.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/ref_diffiehellman.png">
...
<h1>Node.js DiffieHellman Reference</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="ref_decipher.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ref_ecdh.asp">Next &#10095;</a>
</div>
...
<p>The DiffieHellman class is part of Node.js's <code class="w3-codespan">crypto</code> module. It implements the Diffie-Hellman key exchange protocol, which allows two parties to securely establish a shared secret over an insecure channel.</p>
...
<br>
// Create a DiffieHellman instance<br>
const dh = crypto.createDiffieHellman(2048); // 2048-bit prime length
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_diffiehellman_import">Run example &raquo;</a>
</div>
...
<table class="ws-table-all notranslate">
  <tr>
    <th style="width:33%">Method</th>
    <th>Description</th>
  </tr>
  <tr>
    <td>dh.generateKeys([encoding])</td>
    <td>Generates private and public Diffie-Hellman key values. If <code class="w3-codespan">encoding</code> is provided, a string is returned; otherwise, a Buffer is returned.</td>
  </tr>
  <tr>
    <td>dh.computeSecret(otherPublicKey[, inputEncoding][, outputEncoding])</td>
    <td>Computes the shared secret using the other party's public key. If <code class="w3-codespan">inputEncoding</code> is provided, <code class="w3-codespan">otherPublicKey</code> is expected to be a string; otherwise, a Buffer, TypedArray, or DataView. If <code class="w3-codespan">outputEncoding</code> is provided, a string is returned; otherwise, a Buffer is returned.</td>
  </tr>
  <tr>
    <td>dh.getPrime([encoding])</td>
    <td>Returns the Diffie-Hellman prime. If <code class="w3-codespan">encoding</code> is provided, a string is returned; otherwise, a Buffer is returned.</td>
  </tr>
  <tr>
    <td>dh.getGenerator([encoding])</td>
    <td>Returns the Diffie-Hellman generator. If <code class="w3-codespan">encoding</code> is provided, a string is returned; otherwise, a Buffer is returned.</td>
  </tr>
  <tr>
    <td>dh.getPublicKey([encoding])</td>
    <td>Returns the Diffie-Hellman public key. If <code class="w3-codespan">encoding</code> is provided, a string is returned; otherwise, a Buffer is returned.</td>
  </tr>
  <tr>
    <td>dh.getPrivateKey([encoding])</td>
    <td>Returns the Diffie-Hellman private key. If <code class="w3-codespan">encoding</code> is provided, a string is returned; otherwise, a Buffer is returned.</td>
  </tr>
  <tr>
    <td>dh.setPublicKey(publicKey[, encoding])</td>
    <td>Sets the Diffie-Hellman public key. If <code class="w3-codespan">encoding</code> is provided, <code class="w3-codespan">publicKey</code> is expected to be a string; otherwise, a Buffer, TypedArray, or DataView.</td>
  </tr>
  <tr>
    <td>dh.setPrivateKey(privateKey[, encoding])</td>
    <td>Sets the Diffie-Hellman private key. If <code class="w3-codespan">encoding</code> is provided, <code class="w3-codespan">privateKey</code> is expected to be a string; otherwise, a Buffer, TypedArray, or DataView.</td>
  </tr>
  <tr>
    <td>dh.verifyError</td>
    <td>A bit field of flags indicating any errors that occurred during initialization or validation checks.</td>
  </tr>
</table>
...
<p>There are multiple ways to create a DiffieHellman instance:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const crypto = require('crypto');<br>
<br>
// Method 1: Generate a new DH group with specified prime length<br>
const dh1 = crypto.createDiffieHellman(2048);<br>
console.log('Generated prime length:', dh1.getPrime().length * 8, 'bits');<br>
<br>
// Method 2: Create a DH group using a predefined prime<br>
const prime = Buffer.from('prime-number-in-hex', 'hex');<br>
const dh2 = crypto.createDiffieHellman(prime);<br>
<br>
// Method 3: Create a DH group using a predefined prime and generator<br>
const generator = Buffer.from('02', 'hex'); // Often 2, 5, or other small values<br>
const dh3 = crypto.createDiffieHellman(prime, generator);<br>
<br>
// Method 4: Using predefined groups with getDiffieHellman()<br>
const predefinedGroupName = 'modp14'; // RFC 3526 2048-bit MODP Group<br>
const dh4 = crypto.getDiffieHellman(predefinedGroupName);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_diffiehellman_create">Run example &raquo;</a>
</div>

<p>The <code class="w3-codespan">getDiffieHellman()</code> method supports the following predefined groups:</p>
...
<p>The following example demonstrates the basic Diffie-Hellman key exchange between two parties (Alice and Bob):</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const crypto = require('crypto');<br>
<br>
// Alice generates parameters and keys<br>
console.log('Alice: Creating DiffieHellman instance...');<br>
const alice = crypto.createDiffieHellman(2048);<br>
const aliceKeys = alice.generateKeys();<br>
<br>
// Bob also needs parameters from Alice<br>
console.log('Alice: Sending parameters to Bob...');<br>
const p = alice.getPrime();<br>
const g = alice.getGenerator();<br>
<br>
// Bob creates a DiffieHellman instance with the same parameters<br>
console.log('Bob: Creating DiffieHellman instance with Alice\'s parameters...');<br>
const bob = crypto.createDiffieHellman(p, g);<br>
const bobKeys = bob.generateKeys();<br>
<br>
// Exchange public keys (over an insecure channel)<br>
console.log('Exchanging public keys...');<br>
const alicePublicKey = alice.getPublicKey();<br>
const bobPublicKey = bob.getPublicKey();<br>
<br>
// Alice computes the shared secret using Bob's public key<br>
console.log('Alice: Computing shared secret...');<br>
const aliceSecret = alice.computeSecret(bobPublicKey);<br>
<br>
// Bob computes the shared secret using Alice's public key<br>
console.log('Bob: Computing shared secret...');<br>
const bobSecret = bob.computeSecret(alicePublicKey);<br>
<br>
// Both secrets should be the same<br>
console.log('Alice\'s secret:', aliceSecret.toString('hex'));<br>
console.log('Bob\'s secret:', bobSecret.toString('hex'));<br>
console.log('Do they match?', aliceSecret.equals(bobSecret));<br>
<br>
// This shared secret can now be used as a key for symmetric encryption
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_diffiehellman_basic">Run example &raquo;</a>
</div>
...
<p>For standardized applications, using predefined groups can ensure compatibility:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const crypto = require('crypto');<br>
<br>
// Using the RFC 3526 MODP Group 14 (2048 bits)<br>
console.log('Alice: Creating DiffieHellman using predefined group...');<br>
const alice = crypto.getDiffieHellman('modp14');<br>
alice.generateKeys();<br>
<br>
// Bob also uses the same predefined group<br>
console.log('Bob: Creating DiffieHellman using predefined group...');<br>
const bob = crypto.getDiffieHellman('modp14');<br>
bob.generateKeys();<br>
<br>
// Exchange public keys (over an insecure channel)<br>
console.log('Exchanging public keys...');<br>
...
const bobPublicKey = bob.getPublicKey();<br>
<br>
// Compute shared secrets<br>
const aliceSecret = alice.computeSecret(bobPublicKey);<br>
const bobSecret = bob.computeSecret(alicePublicKey);<br>
<br>
// Verify that the shared secrets match<br>
console.log('Do the shared secrets match?', aliceSecret.equals(bobSecret));<br>
<br>
// Output information about the group<br>
console.log('Group prime size:', alice.getPrime().length * 8, 'bits');<br>
console.log('Generator value:', alice.getGenerator().toString('hex'));
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_diffiehellman_predefined">Run example &raquo;</a>
</div>
...
<p>This example shows a complete scenario of using Diffie-Hellman to establish a shared key for AES encryption:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const crypto = require('crypto');<br>
<br>
// Create DiffieHellman instances for Alice and Bob<br>
const alice = crypto.createDiffieHellman(2048);<br>
alice.generateKeys();<br>
<br>
// Bob uses Alice's parameters<br>
const bob = crypto.createDiffieHellman(alice.getPrime(), alice.getGenerator());<br>
bob.generateKeys();<br>
<br>
...
const bobSecret = bob.computeSecret(alicePublicKey);<br>
<br>
// Use the shared secret as a key for encryption<br>
// First, derive a suitable key using a hash function<br>
function deriveKey(secret, salt, keyLength) {<br>
&nbsp;&nbsp;return crypto.pbkdf2Sync(secret, salt, 1000, keyLength, 'sha256');<br>
}<br>
<br>
// Alice sends an encrypted message to Bob<br>
function encrypt(text, secret) {<br>
&nbsp;&nbsp;// Create a salt and derive a key<br>
&nbsp;&nbsp;const salt = crypto.randomBytes(16);<br>
&nbsp;&nbsp;const key = deriveKey(secret, salt, 32); // 32 bytes for AES-256<br>
...
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Return everything Bob needs to decrypt<br>
&nbsp;&nbsp;return {<br>
&nbsp;&nbsp;&nbsp;&nbsp;salt: salt.toString('hex'),<br>
&nbsp;&nbsp;&nbsp;&nbsp;iv: iv.toString('hex'),<br>
&nbsp;&nbsp;&nbsp;&nbsp;encrypted<br>
&nbsp;&nbsp;};<br>
}<br>
<br>
// Bob decrypts the message from Alice<br>
function decrypt(encryptedInfo, secret) {<br>
&nbsp;&nbsp;// Parse values<br>
&nbsp;&nbsp;const salt = Buffer.from(encryptedInfo.salt, 'hex');<br>
&nbsp;&nbsp;const iv = Buffer.from(encryptedInfo.iv, 'hex');<br>
&nbsp;&nbsp;const encrypted = encryptedInfo.encrypted;<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Derive the same key<br>
&nbsp;&nbsp;const key = deriveKey(secret, salt, 32);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Decrypt the message<br>
&nbsp;&nbsp;const decipher = crypto.createDecipheriv('aes-256-cbc', key, iv);<br>
&nbsp;&nbsp;let decrypted = decipher.update(encrypted, 'hex', 'utf8');<br>
&nbsp;&nbsp;decrypted += decipher.final('utf8');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;return decrypted;<br>
}<br>
<br>
// Alice encrypts a message using the shared secret<br>
const message = 'Hello Bob, this is a secret message from Alice!';<br>
console.log('Original message:', message);<br>
<br>
const encryptedMessage = encrypt(message, aliceSecret);<br>
console.log('Encrypted message:', encryptedMessage);<br>
<br>
// Bob decrypts the message using his shared secret<br>
const decryptedMessage = decrypt(encryptedMessage, bobSecret);<br>
console.log('Decrypted message:', decryptedMessage);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_diffiehellman_encryption">Run example &raquo;</a>
</div>
...
<p>When you need specific parameters for Diffie-Hellman:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const crypto = require('crypto');<br>
<br>
// Custom prime and generator values<br>
// These would normally be carefully chosen for security<br>
const primeHex = `<br>
&nbsp;&nbsp;ffffffffffffffffc90fdaa22168c234c4c6628b80dc1cd129024e088a67cc74<br>
&nbsp;&nbsp;020bbea63b139b22514a08798e3404ddef9519b3cd3a431b302b0a6df25f1437<br>
&nbsp;&nbsp;4fe1356d6d51c245e485b576625e7ec6f44c42e9a637ed6b0bff5cb6f406b7ed<br>
&nbsp;&nbsp;ee386bfb5a899fa5ae9f24117c4b1fe649286651ece45b3dc2007cb8a163bf05<br>
&nbsp;&nbsp;98da48361c55d39a69163fa8fd24cf5f83655d23dca3ad961c62f356208552bb<br>
&nbsp;&nbsp;9ed529077096966d670c354e4abc9804f1746c08ca18217c32905e462e36ce3b<br>
&nbsp;&nbsp;e39e772c180e86039b2783a2ec07a28fb5c55df06f4c52c9de2bcbf695581718<br>
&nbsp;&nbsp;3995497cea956ae515d2261898fa051015728e5a8aacaa68ffffffffffffffff<br>
`.replace(/\s+/g, '');<br>
<br>
const prime = Buffer.from(primeHex, 'hex');<br>
const generator = Buffer.from('02', 'hex');<br>
<br>
// Create DiffieHellman with custom parameters<br>
const dh = crypto.createDiffieHellman(prime, generator);<br>
<br>
// Generate keys<br>
dh.generateKeys();<br>
<br>
// Verify the parameters<br>
console.log('Using custom prime of length:', prime.length * 8, 'bits');<br>
console.log('Generator:', generator.toString('hex'));<br>
<br>
// Validation<br>
console.log('Verify error code:', dh.verifyError);<br>
if (dh.verifyError) {<br>
&nbsp;&nbsp;console.error('The parameters did not pass validation!');<br>
} else {<br>
&nbsp;&nbsp;console.log('The parameters passed validation.');<br>
}<br>
<br>
// Output public and private keys<br>
console.log('Public key length:', dh.getPublicKey().length * 8, 'bits');<br>
console.log('Private key length:', dh.getPrivateKey().length * 8, 'bits');
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_diffiehellman_custom">Run example &raquo;</a>
</div>
...
<p>You can specify encodings when working with DiffieHellman keys:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const crypto = require('crypto');<br>
<br>
// Create DiffieHellman instance<br>
const dh = crypto.createDiffieHellman(1024);<br>
<br>
// Generate keys<br>
dh.generateKeys();<br>
<br>
// Get keys and parameters with different encodings<br>
console.log('With Buffer (default):');<br>
console.log('&nbsp;&nbsp;- Prime:', dh.getPrime());<br>
console.log('&nbsp;&nbsp;- Generator:', dh.getGenerator());<br>
console.log('&nbsp;&nbsp;- Public Key:', dh.getPublicKey());<br>
console.log('&nbsp;&nbsp;- Private Key:', dh.getPrivateKey());<br>
<br>
console.log('\nWith hex encoding:');<br>
console.log('&nbsp;&nbsp;- Prime:', dh.getPrime('hex'));<br>
console.log('&nbsp;&nbsp;- Generator:', dh.getGenerator('hex'));<br>
console.log('&nbsp;&nbsp;- Public Key:', dh.getPublicKey('hex'));<br>
console.log('&nbsp;&nbsp;- Private Key:', dh.getPrivateKey('hex'));<br>
<br>
console.log('\nWith base64 encoding:');<br>
console.log('&nbsp;&nbsp;- Prime:', dh.getPrime('base64'));<br>
console.log('&nbsp;&nbsp;- Generator:', dh.getGenerator('base64'));<br>
console.log('&nbsp;&nbsp;- Public Key:', dh.getPublicKey('base64'));<br>
console.log('&nbsp;&nbsp;- Private Key:', dh.getPrivateKey('base64'));<br>
<br>
// Set keys using specific encoding<br>
const newPublicKey = crypto.randomBytes(dh.getPrime().length - 10);<br>
dh.setPublicKey(newPublicKey);<br>
console.log('\nAfter setting new public key:');<br>
console.log('&nbsp;&nbsp;- Public Key (hex):', dh.getPublicKey('hex'));
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_diffiehellman_encoding">Run example &raquo;</a>
</div>
...
<p>Error handling is important when working with cryptographic operations:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const crypto = require('crypto');<br>
<br>
// Function to safely create DiffieHellman<br>
function createDHSafely(options) {<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;let dh;<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (typeof options === 'number') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Create with prime length<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;dh = crypto.createDiffieHellman(options);<br>
&nbsp;&nbsp;&nbsp;&nbsp;} else if (options.group) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Create with predefined group<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;dh = crypto.getDiffieHellman(options.group);<br>
&nbsp;&nbsp;&nbsp;&nbsp;} else if (options.prime) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Create with custom prime and optional generator<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const prime = Buffer.from(options.prime, options.encoding || 'hex');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const generator = options.generator ? <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Buffer.from(options.generator, options.encoding || 'hex') : <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;undefined;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;dh = generator ? <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;crypto.createDiffieHellman(prime, generator) : <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;crypto.createDiffieHellman(prime);<br>
&nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;throw new Error('Invalid options for DiffieHellman creation');<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Check for errors<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (dh.verifyError) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const errors = [];<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Check specific error flags<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (dh.verifyError & crypto.constants.DH_CHECK_P_NOT_SAFE_PRIME)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;errors.push('DH_CHECK_P_NOT_SAFE_PRIME');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (dh.verifyError & crypto.constants.DH_CHECK_P_NOT_PRIME)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;errors.push('DH_CHECK_P_NOT_PRIME');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (dh.verifyError & crypto.constants.DH_UNABLE_TO_CHECK_GENERATOR)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;errors.push('DH_UNABLE_TO_CHECK_GENERATOR');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (dh.verifyError & crypto.constants.DH_NOT_SUITABLE_GENERATOR)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;errors.push('DH_NOT_SUITABLE_GENERATOR');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;throw new Error(`DiffieHellman parameter validation failed: ${errors.join(', ')}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;return dh;<br>
&nbsp;&nbsp;} catch (error) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error('Error creating DiffieHellman instance:', error.message);<br>
&nbsp;&nbsp;&nbsp;&nbsp;throw error;<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
// Test with valid options<br>
try {<br>
&nbsp;&nbsp;const dh1 = createDHSafely(2048);<br>
&nbsp;&nbsp;console.log('Successfully created DH with 2048-bit prime');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;const dh2 = createDHSafely({ group: 'modp14' });<br>
&nbsp;&nbsp;console.log('Successfully created DH with predefined group modp14');<br>
} catch (error) {<br>
&nbsp;&nbsp;console.error('Error in valid tests:', error.message);<br>
}<br>
<br>
// Test with invalid options<br>
try {<br>
&nbsp;&nbsp;// Invalid prime value<br>
&nbsp;&nbsp;const invalidPrime = '12345'; // Too short, not a prime<br>
&nbsp;&nbsp;const dh3 = createDHSafely({ <br>
&nbsp;&nbsp;&nbsp;&nbsp;prime: invalidPrime,<br>
&nbsp;&nbsp;&nbsp;&nbsp;encoding: 'hex' <br>
&nbsp;&nbsp;});<br>
} catch (error) {<br>
&nbsp;&nbsp;console.error('Expected error with invalid prime:', error.message);<br>
}<br>
<br>
try {<br>
&nbsp;&nbsp;// Invalid group name<br>
&nbsp;&nbsp;const dh4 = createDHSafely({ group: 'nonexistent-group' });<br>
} catch (error) {<br>
&nbsp;&nbsp;console.error('Expected error with invalid group:', error.message);<br>
}
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_diffiehellman_errors">Run example &raquo;</a>
</div>
...
<p>When using Diffie-Hellman key exchange, consider these security best practices:</p>

<ol>
  <li><strong>Use appropriate key sizes</strong>: For modern applications, use at least 2048-bit primes.</li>
  <li><strong>Use validated groups</strong>: Whenever possible, use standardized groups like those defined in RFCs.</li>
  <li><strong>Protect private keys</strong>: Never expose private keys in logs, debugging output, or client-side code.</li>
  <li><strong>Add authentication</strong>: Pure Diffie-Hellman is vulnerable to man-in-the-middle attacks. Consider using authenticated key exchange protocols like ECDHE with digital signatures.</li>
  <li><strong>Check parameter validation</strong>: Always check <code class="w3-codespan">dh.verifyError</code> to ensure the parameters are valid.</li>
  <li><strong>Use ephemeral keys</strong>: Generate new keys for each session to provide forward secrecy.</li>
  <li><strong>Derive encryption keys properly</strong>: Don't use the shared secret directly as an encryption key. Use a key derivation function (KDF) like HKDF or PBKDF2.</li>
</ol>
...
<p>Diffie-Hellman (DH) and Elliptic Curve Diffie-Hellman (ECDH) are both key exchange protocols, but ECDH offers advantages:</p>
...
<table class="ws-table-all">
  ...
  <tr>
    <td>Key Size</td>
    <td>Typically 2048-4096 bits</td>
    <td>Typically 256-384 bits</td>
  </tr>
  <tr>
    <td>Performance</td>
    <td>Slower, requires more computation</td>
    <td>Faster, more efficient</td>
  </tr>
  <tr>
    <td>Security Level</td>
    <td>2048-bit DH ≈ 112-bit security</td>
    <td>256-bit ECDH ≈ 128-bit security</td>
  </tr>
  <tr>
    <td>Memory Usage</td>
    <td>Higher</td>
  ...
  <tr>
    <td>Modern Usage</td>
    <td>Less common in new designs</td>
    <td>More common in new protocols</td>
  </tr>
</table>

<p>For most modern applications, ECDH is preferred due to its better performance and smaller key sizes.</p>
