...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Frameworks</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js Frameworks">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_frameworks.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="Node.js frameworks provide structure, organization, and common utilities for building web applications, APIs, and more.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Frameworks">
<meta name="twitter:description" content="Node.js frameworks provide structure, organization, and common utilities for building web applications, APIs, and more.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_frameworks.png">
...
<a class="w3-left w3-btn" href="nodejs_linting_formatting.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="nodejs_express.asp">Next &#10095;</a>
</div>
...
<p>Node.js frameworks provide structure, organization, and common utilities for building web applications, APIs, and more.</p>
<p>They help developers create applications faster by providing ready-made solutions to common development challenges.</p>

<p>Advantages of using a framework:</p>

<ul>
  <li><strong>Productivity</strong>: Frameworks provide pre-built solutions for common tasks like routing, middleware management, and templating.</li>
  <li><strong>Standardization</strong>: They establish patterns and structures that make code more maintainable and easier to understand.</li>
  <li><strong>Community</strong>: Popular frameworks have large communities, extensive documentation, and many third-party plugins or extensions.</li>
  <li><strong>Security</strong>: Well-maintained frameworks often include built-in security features and best practices.</li>
  <li><strong>Performance</strong>: Many frameworks are optimized for performance and provide tools for caching, load balancing, and more.</li>
</ul>

<hr>

<h2>Types of Node.js Frameworks</h2>

<p>Node.js frameworks can be broadly categorized based on their design philosophy and features.</p>
<p>Understanding these categories helps in selecting the right framework for your project's needs.</p>

<h3>Full-Stack Frameworks</h3>

<p>These frameworks provide solutions for both front-end and back-end development, often with integrated templating engines, ORM systems, and more.</p>
<p><strong>Examples:</strong> Meteor, Sails.js, AdonisJS</p>
<p><strong>Use When:</strong> Building complete web applications with both frontend and backend components</p>


<h3>Minimalist/Micro Frameworks</h3>

<p>These frameworks focus on being lightweight and provide only the essential features, letting developers add what they need.</p>
<p><strong>Examples:</strong> Express.js, Koa, Fastify</p>
<p><strong>Use When:</strong> Building APIs or simple web services where you want maximum control</p>

<h3>REST API Frameworks</h3>

<p>Specialized frameworks designed for building RESTful APIs with features like automatic validation, documentation, and versioning.</p>
<p><strong>Examples:</strong> LoopBack, NestJS, Restify</p>
<p><strong>Use When:</strong> Building robust, production-ready APIs with minimal boilerplate</p>

<h3>Real-Time Frameworks</h3>

<p>Frameworks optimized for real-time applications with built-in support for WebSockets and server-sent events.</p>
<p><strong>Examples:</strong> Socket.io, Sails.js, FeathersJS</p>
<p><strong>Use When:</strong> Building chat applications, live updates, or any real-time features</p>

<hr>

<h2>Popular Node.js Frameworks</h2>

<p>Here's a comprehensive comparison of the most popular Node.js frameworks, their features, and when to use them.</p>

<div class="w3-panel w3-light-grey">
  <h4>Framework Selection Criteria</h4>
  <p>When choosing a framework, consider these factors:</p>
  <ul>
    <li><strong>Project Requirements:</strong> Does the framework support your specific needs?</li>
    <li><strong>Learning Curve:</strong> How quickly can your team become productive?</li>
    <li><strong>Performance:</strong> Does it meet your performance requirements?</li>
    <li><strong>Community & Support:</strong> Is there active development and community support?</li>
    <li><strong>Ecosystem:</strong> Are there plugins and middleware available?</li>
  </ul>
</div>
...
<hr>
<h2>Express.js</h2>
<p>Express is the most popular and widely used Node.js framework, known for its simplicity and flexibility.</p>
<p><strong>Ideal for:</strong> Building web applications and APIs of any size</p>
<p><strong>Learning Curve:</strong> Low to Moderate</p>
<p><strong>Performance:</strong> Good for most use cases</p>
<p><strong>Ecosystem:</strong> Largest in the Node.js ecosystem</p>
...
<br>
app.listen(port, () => {<br>
&nbsp;&nbsp;console.log(`Express server running at http://localhost:${port}`);<br>
});<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs.asp?filename=demo_frameworks_express">Run example &raquo;</a>
</div>

<p><strong>Key Features:</strong></p>
<ul>
  <li>Minimal and flexible web framework</li>
  <li>Robust routing system</li>
  <li>HTTP utilities and middleware</li>
  <li>Template engine support</li>
  <li>Serves as the foundation for many other frameworks</li>
</ul>

<p><strong>Best For:</strong> General-purpose web applications, APIs, and as a foundation for more specialized frameworks.</p>
<p>Express.js is covered more closely in our <a href="nodejs_express.asp">Express.js chapter</a>.</p>
<hr>
<h2>Nest.js</h2>

<p>Nest.js is a progressive framework inspired by Angular, built with TypeScript, and designed for building efficient, scalable server-side applications.</p>
<p><strong>Ideal for:</strong> Enterprise applications, microservices, and complex APIs</p>
<p><strong>Learning Curve:</strong> Moderate to High (especially without Angular experience)</p>
<p><strong>Performance:</strong> Excellent, built on top of Express or Fastify</p>
<p><strong>Ecosystem:</strong> Growing rapidly with strong corporate backing</p>
...
&nbsp;&nbsp;@Get()<br>
&nbsp;&nbsp;getHello(): string {<br>
&nbsp;&nbsp;&nbsp;&nbsp;return 'Hello World from Nest.js!';<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
// main.ts<br>
...
<br>
async function bootstrap() {<br>
&nbsp;&nbsp;const app = await NestFactory.create(AppModule);<br>
&nbsp;&nbsp;await app.listen(8080);<br>
&nbsp;&nbsp;console.log(`Nest.js server running at http://localhost:8080`);<br>
}<br>
bootstrap();
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs.asp?filename=demo_frameworks_nestjs">Run example &raquo;</a>
</div>
...
<ul>
  ...
  <li>Compatible with most Express middleware</li>
  <li>Built-in support for GraphQL, WebSockets, and microservices</li>
  <li>Strong typing and solid architectural patterns</li>
</ul>

<p><strong>Best For:</strong> Enterprise applications, complex APIs, and microservices architectures, particularly for teams familiar with Angular.</p>

<hr>
<h2>Fastify</h2>

<p>Fastify is a web framework focused on providing the best developer experience with minimal overhead and maximum performance.</p>
<p><strong>Ideal for:</strong> High-performance APIs and services</p>
<p><strong>Learning Curve:</strong> Low to Moderate</p>
<p><strong>Performance:</strong> One of the fastest Node.js frameworks</p>
<p><strong>Ecosystem:</strong> Growing, with good plugin support</p>
...
<br>
// Declare a route<br>
fastify.get('/', async (request, reply) => {<br>
&nbsp;&nbsp;return { hello: 'Hello World from Fastify!' };<br>
});<br>
<br>
// Run the server<br>
const start = async () => {<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;await fastify.listen({ port });<br>
&nbsp;&nbsp;&nbsp;&nbsp;fastify.log.info(`Fastify server running at http://localhost:${port}`);<br>
&nbsp;&nbsp;} catch (err) {<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_frameworks_fastify">Run example &raquo;</a>
</div>

<p><strong>Key Features:</strong></p>
<ul>
  <li>Highly performant (up to 2x faster than Express)</li>
  <li>Schema-based validation using JSON Schema</li>
  <li>Plugin architecture</li>
  <li>Built-in logger</li>
  <li>Asynchronous by default</li>
  <li>TypeScript support</li>
</ul>

<p><strong>Best For:</strong> High-performance applications, APIs where speed is critical, and projects that benefit from schema validation.</p>

<hr>
<h2>Koa.js</h2>

<p>Created by the team behind Express, Koa aims to be a smaller, more expressive, and more robust foundation for web applications and APIs.</p>
<p><strong>Ideal for:</strong> Modern web applications and APIs using async/await</p>
<p><strong>Learning Curve:</strong> Moderate (requires understanding of async/await)</p>
<p><strong>Performance:</strong> Excellent, lighter than Express</p>
<p><strong>Ecosystem:</strong> Good, though smaller than Express</p>
...
const port = 8080;<br>
<br>
// Response middleware<br>
app.use(async ctx => {<br>
&nbsp;&nbsp;ctx.body = 'Hello World from Koa.js!';<br>
});<br>
<br>
app.listen(port, () => {<br>
&nbsp;&nbsp;console.log(`Koa server running at http://localhost:${port}`);<br>
});</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs.asp?filename=demo_frameworks_koa">Run example &raquo;</a>
</div>

<p><strong>Key Features:</strong></p>
<ul>
  <li>Modern middleware architecture using async/await</li>
  <li>Streamlined error handling</li>
  <li>No bundled middleware, keeping it light</li>
  <li>Better error handling through try/catch</li>
  <li>Cleaner, more expressive codebase than Express</li>
</ul>

<p><strong>Best For:</strong> Developers who want more control over their middleware stack and prefer a more modern approach than Express.</p>

<hr>
<h2>Hapi.js</h2>

<p>Hapi.js is a rich framework for building applications and services, focusing on configuration rather than code and built-in support for input validation, caching, and error handling.</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const Hapi = require('@hapi/hapi');<br>
<br>
const init = async () => {<br>
&nbsp;&nbsp;const server = Hapi.server({<br>
&nbsp;&nbsp;&nbsp;&nbsp;port: 8080,<br>
&nbsp;&nbsp;&nbsp;&nbsp;host: 'localhost'<br>
&nbsp;&nbsp;});<br>
<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;method: 'GET',<br>
&nbsp;&nbsp;&nbsp;&nbsp;path: '/',<br>
&nbsp;&nbsp;&nbsp;&nbsp;handler: (request, h) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return 'Hello World from Hapi.js!';<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;});<br>
<br>
&nbsp;&nbsp;await server.start();<br>
&nbsp;&nbsp;console.log(`Hapi server running at ${server.info.uri}`);<br>
};<br>
<br>
init();</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs.asp?filename=demo_frameworks_hapi">Run example &raquo;</a>
</div>
...
<ul>
  ...
  <li>Built-in validation with Joi</li>
  <li>Caching</li>
  <li>Plugin system</li>
  <li>Detailed API documentation</li>
</ul>

<p><strong>Best For:</strong> Enterprise-level applications and teams that prefer configuration over code.</p>

<hr>
<h2>Adonis.js</h2>

<p>Adonis.js is a full-stack MVC framework for Node.js, inspired by Laravel.</p>
<p>It provides a stable ecosystem to write server-side web applications.</p>
...
'use strict'<br>
<br>
const Route = use('Route')<br>
<br>
Route.get('/', () => {<br>
&nbsp;&nbsp;return 'Hello World from Adonis.js!'<br>
})<br>
<br>
// server.js<br>
const { Ignitor } = require('@adonisjs/ignitor')<br>
<br>
new Ignitor(require('@adonisjs/fold'))<br>
&nbsp;&nbsp;.appRoot(__dirname)<br>
&nbsp;&nbsp;.fireHttpServer()<br>
&nbsp;&nbsp;.catch(console.error)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_frameworks_adonis">Run example &raquo;</a>
</div>

<p><strong>Key Features:</strong></p>
<ul>
  <li>MVC architecture</li>
  <li>Built-in ORM (Lucid)</li>
...
<p><strong>Best For:</strong> Full-stack applications, especially for developers familiar with Laravel or other MVC frameworks.</p>

<hr>

<h2>Socket.io</h2>

<p>While not a traditional web framework, Socket.io is essential for real-time, bidirectional communication between web clients and servers.</p>
...
&nbsp;&nbsp;console.log(`Socket.io server running at http://localhost:${port}`);<br>
});</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs.asp?filename=demo_frameworks_socketio">Run example &raquo;</a>
</div>

<p><strong>Best For:</strong> Real-time applications like chat applications, live dashboards, and collaborative tools.</p>

<hr>
<h2>Meteor</h2>

<p>Meteor is an ultra-simple, full-stack JavaScript platform for building modern web and mobile applications.</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// server/main.js<br>
import { Meteor } from 'meteor/meteor';<br>
import { LinksCollection } from '/imports/api/links';<br>
<br>
function insertLink({ title, url }) {<br>
&nbsp;&nbsp;LinksCollection.insert({title, url, createdAt: new Date()});<br>
}<br>
<br>
Meteor.startup(() => {<br>
&nbsp;&nbsp;// If the Links collection is empty, add some data.<br>
&nbsp;&nbsp;if (LinksCollection.find().count() === 0) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;insertLink({<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;title: 'W3Schools.com',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;url: 'https://www.w3schools.com'<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;}<br>
});</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs.asp?filename=demo_frameworks_meteor">Run example &raquo;</a>
</div>

<p><strong>Best For:</strong> Full-stack JavaScript applications, particularly when the same codebase should run on both client and server.</p>

<hr>
<h2>Loopback</h2>

<p>LoopBack is a highly extensible, open-source Node.js framework based on Express that enables you to quickly create dynamic end-to-end REST APIs.</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// src/controllers/hello.controller.ts<br>
import {get} from '@loopback/rest';<br>
<br>
export class HelloController {<br>
&nbsp;&nbsp;@get('/hello')<br>
&nbsp;&nbsp;hello(): string {<br>
&nbsp;&nbsp;&nbsp;&nbsp;return 'Hello World from LoopBack!';<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
// src/application.ts<br>
import {ApplicationConfig} from '@loopback/core';<br>
import {RestApplication} from '@loopback/rest';<br>
import {HelloController} from './controllers/hello.controller';<br>
<br>
export class MyApplication extends RestApplication {<br>
&nbsp;&nbsp;constructor(options: ApplicationConfig = {}) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;super(options);<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.controller(HelloController);<br>
&nbsp;&nbsp;}<br>
}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs.asp?filename=demo_frameworks_loopback">Run example &raquo;</a>
</div>

<p><strong>Best For:</strong> Building APIs quickly with minimal coding, especially when connecting to various data sources.</p>

<hr>

<h2>API-Focused Frameworks</h2>
<p>These frameworks are designed specifically for building APIs and RESTful web services.</p>
<hr>
<h2>Restify</h2>

<p>Restify is a framework designed specifically for building RESTful web services.</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const restify = require('restify');<br>
<br>
const server = restify.createServer();<br>
const port = 8080;<br>
<br>
server.get('/', function(req, res, next) {<br>
&nbsp;&nbsp;res.send('Hello World from Restify!');<br>
&nbsp;&nbsp;next();<br>
});<br>
<br>
server.listen(port, function() {<br>
&nbsp;&nbsp;console.log(`Restify server running at http://localhost:${port}`);<br>
});</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs.asp?filename=demo_frameworks_restify">Run example &raquo;</a>
</div>

<p><strong>Best For:</strong> Building RESTful APIs at scale, particularly when DTrace observability is important.</p>

<hr>
<h2>Strapi</h2>

<p>Strapi is a headless CMS and API generator that lets you build APIs without writing any code.</p>

<div class="w3-example">
<div class="w3-code notranslate">
// Strapi is typically configured through a UI interface rather than code<br>
<br>
// Example of programmatically creating content from a controller<br>
module.exports = {<br>
&nbsp;&nbsp;async create(ctx) {<br>
&nbsp;&nbsp;&nbsp;&nbsp; // Create a new article<br>
&nbsp;&nbsp;&nbsp;&nbsp; const entity = await strapi.services.article.create(ctx.request.body);<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp; // Return the created article<br>
&nbsp;&nbsp;&nbsp;&nbsp; return entity;<br>
&nbsp;&nbsp;}<br>
};</div>
</div>

<p><strong>Best For:</strong> Content-heavy applications, headless CMS needs, and rapid API development with a visual interface.</p>

<hr>

<h2>Choosing the Right Framework</h2>

<p>Selecting the right framework depends on your project's requirements, your team's expertise, and your specific goals. Consider these factors:</p>

<h3>Performance Requirements</h3>
<ul>
  <li>For maximum performance: <strong>Fastify</strong></li>
  <li>For balanced performance and features: <strong>Express</strong> or <strong>Koa</strong></li>
</ul>

<h3>Project Type</h3>
<ul>
  <li>REST APIs: <strong>Express</strong>, <strong>Fastify</strong>, or <strong>Restify</strong></li>
  <li>Full-stack applications: <strong>Adonis.js</strong>, <strong>Meteor</strong>, or <strong>Next.js</strong></li>
  <li>Enterprise applications: <strong>Nest.js</strong> or <strong>Loopback</strong></li>
  <li>Real-time applications: <strong>Socket.io</strong> with <strong>Express</strong> or <strong>Koa</strong></li>
</ul>

<h3>Team Experience</h3>
<ul>
  <li>JavaScript developers: <strong>Express</strong> or <strong>Koa</strong></li>
  <li>TypeScript developers: <strong>Nest.js</strong></li>
  <li>Angular developers: <strong>Nest.js</strong></li>
  <li>Laravel/PHP developers: <strong>Adonis.js</strong></li>
</ul>

<h3>Learning Curve</h3>
<ul>
  <li>Easiest to learn: <strong>Express</strong></li>
  <li>Moderate learning curve: <strong>Koa</strong>, <strong>Fastify</strong>, <strong>Hapi</strong></li>
  <li>Steeper learning curve: <strong>Nest.js</strong>, <strong>Adonis.js</strong></li>
</ul>

<h3>Framework Popularity</h3>
<p>The popularity of a framework affects community support, available resources, and longevity. As of 2023, framework popularity (from highest to lowest) is roughly:</p>
<ol>
  <li><strong>Express.js</strong></li>
  <li><strong>Nest.js</strong></li>
  <li><strong>Fastify</strong></li>
  <li><strong>Koa.js</strong></li>
  <li><strong>Hapi.js</strong></li>
</ol>
...
<p>This comparison table helps you quickly evaluate different Node.js frameworks based on key criteria:</p>

<table class="ws-table-all w3-striped">
  ...
  <tr>
    ...
    <td>Low</td>
    <td>Partial</td>
    <td>General-purpose web apps, APIs</td>
  </tr>
  <tr>
    <td>Nest.js</td>
    <td>Full-featured</td>
    ...
    <td>High</td>
    <td>Excellent</td>
    <td>Enterprise apps, complex APIs</td>
  </tr>
  <tr>
    <td>Fastify</td>
    <td>Minimalist</td>
  ...
  <tr>
    ...
    <td>Medium</td>
    <td>Good</td>
    <td>Modern, async-focused apps</td>
  </tr>
  <tr>
    <td>Hapi.js</td>
    <td>Full-featured</td>
    ...
    <td>Medium</td>
    <td>Good</td>
    <td>Enterprise apps, configuration-driven</td>
  </tr>
  <tr>
    <td>Adonis.js</td>
    <td>Full-stack MVC</td>
    <td>Good</td>
    <td>High</td>
    <td>Excellent</td>
  ...
  <tr>
    ...
    <td>Medium</td>
    <td>Good</td>
    <td>Reactive full-stack apps</td>
  </tr>
  <tr>
    <td>Loopback</td>
    <td>API-focused</td>
    ...
    <td>Medium</td>
    <td>Excellent</td>
    <td>API generation with minimal coding</td>
  </tr>
  <tr>
    <td>Strapi</td>
    <td>Headless CMS</td>
    ...
    <td>Low (UI)</td>
    <td>Good</td>
    <td>Content management, API creation</td>
  </tr>
</table>

<h2>Getting Started with a Framework</h2>

<div class="w3-example">
    <h4>Basic Project Setup Example (Express)</h4>
  <div class="w3-code notranslate">
    # Create a new project directory<br>
    mkdir my-express-app<br>
    cd my-express-app<br>
    <br>
    # Initialize npm and install Express<br>
    npm init -y<br>
    npm install express<br>
    <br>
    # Create main application file (app.js)<br>
    touch app.js
  </div>
</div>
...
│   └── env.js       # Environment variables<br>
...
<h4>Choose Express.js if:</h4>
<ul>
  <li>You're new to Node.js</li>
  <li>You need maximum flexibility</li>
  <li>You want the largest ecosystem</li>
  <li>You're building a REST API or traditional web app</li>
</ul>


<h4>Choose NestJS if:</h4>
<ul>
  <li>You're building an enterprise application</li>
  <li>You prefer TypeScript</li>
  <li>You need dependency injection</li>
  <li>You're familiar with Angular</li>
</ul>


<h4>Choose Fastify if:</h4>
<ul>
  <li>Performance is critical</li>
  <li>You're building JSON APIs</li>
  <li>You want built-in schema validation</li>
  <li>You prefer async/await</li>
</ul>
<h4>Choose Koa if:</h4>
<ul>
  <li>You want a more modern Express alternative</li>
  <li>You prefer using async/await</li>
  <li>You need better error handling</li>
  <li>You want more control over the request/response cycle</li>
</ul>
<hr>
...
<div class="w3-panel w3-light-grey">
  <p>Now that you're familiar with Node.js frameworks, you might want to:</p>
  <ol>
    <li>Dive deeper into <a href="nodejs_express.asp">Express.js</a>, the most popular Node.js framework</li>
    <li>Learn about <a href="nodejs_restful_apis.asp">building RESTful APIs</a> with Node.js</li>
    <li>Explore <a href="nodejs_authentication.asp">authentication</a> in Node.js applications</li>
    <li>Discover how to <a href="nodejs_deployment.asp">deploy Node.js applications</a> to production</li>
  </ol>
</div>
...
<div id="exercisecontainer" src="xrcise_frameworks.js" data-extensions="asp"></div>
