...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Socket Reference</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js Socket Reference">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/ref_socket.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="The Socket class is a duplex stream that allows for reading and writing data across network connections.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Socket Reference">
<meta name="twitter:description" content="The Socket class is a duplex stream that allows for reading and writing data across network connections.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/ref_socket.png">
...
<h1>Node.js Socket Reference</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="ref_verify.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ref_readstream.asp">Next &#10095;</a>
</div>
...
<p>The Socket class is a duplex stream that allows for reading and writing data across network connections. It is used for both client and server connections in Node.js's <code class="w3-codespan">net</code> module.</p>

<p>A Socket represents a TCP or IPC connection to a remote endpoint, providing methods and events for managing the connection lifecycle and transferring data.</p>

<h3>Import Net Module</h3>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// Import the net module<br>
const net = require('net');<br>
<br>
// Create a Socket<br>
const socket = new net.Socket();
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_socket_import">Run example &raquo;</a>
</div>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    ...
    <td>The number of bytes in the write buffer that have not yet been sent.</td>
  </tr>
  <tr>
    <td>socket.bytesRead</td>
    <td>The number of bytes received by the socket.</td>
  </tr>
  <tr>
    <td>socket.bytesWritten</td>
    <td>The number of bytes sent by the socket.</td>
  </tr>
  <tr>
    <td>socket.connecting</td>
    <td>Boolean indicating if the socket is connecting.</td>
  </tr>
  <tr>
    <td>socket.destroyed</td>
    <td>Boolean indicating if the socket has been destroyed.</td>
  </tr>
  <tr>
    <td>socket.localAddress</td>
    <td>The local IP address of the socket.</td>
  </tr>
  <tr>
    <td>socket.localPort</td>
    <td>The local port of the socket.</td>
  </tr>
  <tr>
    <td>socket.remoteAddress</td>
    <td>The remote IP address of the socket.</td>
  </tr>
  <tr>
    <td>socket.remoteFamily</td>
    <td>The IP family of the remote socket (e.g., 'IPv4' or 'IPv6').</td>
  </tr>
  <tr>
    <td>socket.remotePort</td>
    <td>The remote port of the socket.</td>
  </tr>
</table>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td>socket.connect(options[, connectListener])</td>
    <td>Connects the socket to the specified address and port. <code class="w3-codespan">options</code> can include <code class="w3-codespan">port</code>, <code class="w3-codespan">host</code>, <code class="w3-codespan">localAddress</code>, <code class="w3-codespan">localPort</code>, and more.</td>
  </tr>
  <tr>
    <td>socket.connect(path[, connectListener])</td>
    <td>Connects the socket to the specified IPC path.</td>
  </tr>
  <tr>
    <td>socket.connect(port[, host][, connectListener])</td>
    <td>Connects the socket to the specified port and host.</td>
  </tr>
  <tr>
    <td>socket.destroy([error])</td>
    <td>Destroys the socket. If <code class="w3-codespan">error</code> is provided, it will be emitted in an 'error' event.</td>
  </tr>
  <tr>
    <td>socket.end([data][, encoding][, callback])</td>
    <td>Sends optional <code class="w3-codespan">data</code> and closes the socket, indicating no more data will be sent.</td>
  </tr>
  <tr>
    <td>socket.pause()</td>
    <td>Pauses the reading of data, allowing buffering of incoming data.</td>
  </tr>
  <tr>
    <td>socket.resume()</td>
    <td>Resumes reading data after a call to <code class="w3-codespan">socket.pause()</code>.</td>
  </tr>
  <tr>
    <td>socket.setEncoding([encoding])</td>
    <td>Sets the socket to encode data in the specified encoding (default is <code class="w3-codespan">null</code>, which means Buffer objects are returned).</td>
  </tr>
  <tr>
    <td>socket.setKeepAlive([enable][, initialDelay])</td>
    <td>Enables/disables keep-alive functionality with optional <code class="w3-codespan">initialDelay</code> in milliseconds.</td>
  </tr>
  <tr>
    <td>socket.setNoDelay([noDelay])</td>
    <td>Enables/disables Nagle's algorithm. When set to <code class="w3-codespan">true</code>, data is sent immediately rather than buffered.</td>
  </tr>
  <tr>
    <td>socket.setTimeout(timeout[, callback])</td>
    <td>Sets a timeout for the socket after which a 'timeout' event will be emitted if there's no activity.</td>
  </tr>
  <tr>
    <td>socket.write(data[, encoding][, callback])</td>
    <td>Writes data to the socket. Returns <code class="w3-codespan">true</code> if data was flushed, or <code class="w3-codespan">false</code> if it was buffered.</td>
  </tr>
</table>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td>'close'</td>
    <td>Emitted when the socket is fully closed. The argument <code class="w3-codespan">hadError</code> indicates if the socket was closed due to an error.</td>
  </tr>
  <tr>
    <td>'connect'</td>
  ...
  <tr>
    <td>'data'</td>
    <td>Emitted when data is received. The argument is the received data (Buffer or String).</td>
  </tr>
  <tr>
    <td>'drain'</td>
    <td>Emitted when the write buffer becomes empty.</td>
  </tr>
  <tr>
    <td>'end'</td>
    <td>Emitted when the other end of the socket signals the end of transmission.</td>
  </tr>
  <tr>
    <td>'error'</td>
    <td>Emitted when an error occurs. The 'close' event will be emitted directly after this event.</td>
  </tr>
  <tr>
    <td>'lookup'</td>
    <td>Emitted after resolving the hostname but before connecting. Includes details about the lookup.</td>
  </tr>
  <tr>
    <td>'ready'</td>
    <td>Emitted when a socket is ready to be used.</td>
  </tr>
  <tr>
    <td>'timeout'</td>
    <td>Emitted if the socket times out from inactivity. It's just a notification - the socket will not be closed automatically.</td>
  </tr>
</table>

<hr>

<h2>Creating a TCP Client</h2>

<p>This example shows how to create a TCP client that connects to a server:</p>
...
const client = new net.Socket();<br>
<br>
// Connect to a server<br>
client.connect(8080, '127.0.0.1', () => {<br>
&nbsp;&nbsp;console.log('Connected to server');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Send data to the server<br>
&nbsp;&nbsp;client.write('Hello, server! From client.');<br>
});<br>
<br>
// Handle data received from the server<br>
client.on('data', (data) => {<br>
&nbsp;&nbsp;console.log(`Received from server: ${data.toString()}`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Close the connection after receiving a response<br>
&nbsp;&nbsp;client.end();<br>
});<br>
<br>
// Handle connection closure<br>
client.on('close', () => {<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_socket_client">Run example &raquo;</a>
</div>
...
<p>This example demonstrates creating a TCP server that handles socket connections:</p>
...
&nbsp;&nbsp;// 'socket' is the client connection - an instance of net.Socket<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;console.log(`Client connected: ${socket.remoteAddress}:${socket.remotePort}`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Set encoding<br>
&nbsp;&nbsp;socket.setEncoding('utf8');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Handle data from client<br>
&nbsp;&nbsp;socket.on('data', (data) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Received from client: ${data}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Echo the data back to the client<br>
&nbsp;&nbsp;&nbsp;&nbsp;socket.write(`You said: ${data}`);<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Handle client disconnection<br>
&nbsp;&nbsp;socket.on('end', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Client disconnected');<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Handle socket errors<br>
&nbsp;&nbsp;socket.on('error', (err) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error(`Socket error: ${err.message}`);<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Send a welcome message to the client<br>
&nbsp;&nbsp;socket.write('Welcome to the TCP server!\n');<br>
});<br>
<br>
// Start the server on port 8080<br>
server.listen(8080, '127.0.0.1', () => {<br>
&nbsp;&nbsp;console.log('Server listening on port 8080');<br>
});<br>
<br>
// Handle server errors<br>
server.on('error', (err) => {<br>
&nbsp;&nbsp;console.error(`Server error: ${err.message}`);<br>
});
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_socket_server">Run example &raquo;</a>
</div>
...
<p>This example demonstrates how to set and handle socket timeouts:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const net = require('net');<br>
<br>
// Create a server with timeouts<br>
const server = net.createServer((socket) => {<br>
&nbsp;&nbsp;console.log('Client connected');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Set socket timeout to 10 seconds<br>
&nbsp;&nbsp;socket.setTimeout(10000);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Handle socket timeout<br>
&nbsp;&nbsp;socket.on('timeout', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Socket timeout - no activity for 10 seconds');<br>
&nbsp;&nbsp;&nbsp;&nbsp;socket.write('You have been inactive for too long. The connection will be closed.');<br>
&nbsp;&nbsp;&nbsp;&nbsp;socket.end();<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Handle data<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;socket.write('Data received');<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Each time we receive data, the timeout is reset<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Timeout timer reset');<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Handle socket closure<br>
&nbsp;&nbsp;socket.on('close', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Socket closed');<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
...
&nbsp;&nbsp;console.log(`Timeout example server running on port ${PORT}`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// For testing: create a client that connects but doesn't send data<br>
&nbsp;&nbsp;const client = new net.Socket();<br>
&nbsp;&nbsp;client.connect(PORT, '127.0.0.1', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Test client connected');<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// We'll send a message after 5 seconds (before timeout)<br>
&nbsp;&nbsp;&nbsp;&nbsp;setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;client.write('Hello after 5 seconds');<br>
&nbsp;&nbsp;&nbsp;&nbsp;}, 5000);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// We won't send anything else, so the connection should timeout<br>
&nbsp;&nbsp;&nbsp;&nbsp;// after another 10 seconds<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;client.on('data', (data) => {<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_socket_timeout">Run example &raquo;</a>
</div>
...
<p>This example shows how to configure various socket options:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const net = require('net');<br>
<br>
// Create a socket with options<br>
const socket = new net.Socket();<br>
<br>
// Configure socket options<br>
socket.setKeepAlive(true, 1000); // Enable keep-alive with 1 second initial delay<br>
socket.setNoDelay(true); // Disable Nagle's algorithm (no buffering)<br>
<br>
// Connect to a server<br>
socket.connect({<br>
&nbsp;&nbsp;port: 80,<br>
&nbsp;&nbsp;host: 'example.com',<br>
&nbsp;&nbsp;family: 4, // IPv4<br>
&nbsp;&nbsp;localAddress: '0.0.0.0', // Local interface to bind to<br>
&nbsp;&nbsp;localPort: 8000 // Local port to bind to<br>
}, () => {<br>
&nbsp;&nbsp;console.log('Connected with options');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Display socket information<br>
&nbsp;&nbsp;console.log(`Local address: ${socket.localAddress}:${socket.localPort}`);<br>
&nbsp;&nbsp;console.log(`Remote address: ${socket.remoteAddress}:${socket.remotePort}`);<br>
&nbsp;&nbsp;console.log(`Remote family: ${socket.remoteFamily}`);<br>
&nbsp;&nbsp;<br>
...
let responseData = '';<br>
socket.on('data', (data) => {<br>
&nbsp;&nbsp;const chunk = data.toString();<br>
&nbsp;&nbsp;responseData += chunk;<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Show first line of the response<br>
&nbsp;&nbsp;if (responseData.includes('\r\n') && !socket.firstLineShown) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const firstLine = responseData.split('\r\n')[0];<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`First line of response: ${firstLine}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;socket.firstLineShown = true;<br>
&nbsp;&nbsp;}<br>
});<br>
<br>
// Handle end of data<br>
socket.on('end', () => {<br>
&nbsp;&nbsp;console.log('Response complete');<br>
&nbsp;&nbsp;console.log(`Total bytes received: ${socket.bytesRead}`);<br>
&nbsp;&nbsp;console.log(`Total bytes sent: ${socket.bytesWritten}`);<br>
});<br>
<br>
// Handle errors<br>
socket.on('error', (err) => {<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_socket_options">Run example &raquo;</a>
</div>

<hr>

<h2>Working with Socket Buffers</h2>

<p>This example demonstrates socket buffering and the 'drain' event:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const net = require('net');<br>
<br>
// Create server to demonstrate buffer handling<br>
const server = net.createServer((socket) => {<br>
&nbsp;&nbsp;console.log('Client connected');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Make buffer small to demonstrate filling it faster<br>
&nbsp;&nbsp;socket.bufferSize = 1024; // Note: This doesn't actually limit the buffer size<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Send a slow response to the client to demonstrate buffering<br>
&nbsp;&nbsp;socket.on('data', (data) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Received data: ${data.toString().trim()}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Sending large response...');<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Function to write data until buffer is full<br>
&nbsp;&nbsp;&nbsp;&nbsp;const writeUntilBufferFull = () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Generate some data to send<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const chunk = 'x'.repeat(1024);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Keep writing until the buffer is full (write returns false)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;let i = 0;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;while (i &lt; 100) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const canContinue = socket.write(`Chunk ${i}: ${chunk}\n`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Wrote chunk ${i}, buffer full? ${!canContinue}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// If the buffer is full, wait for it to drain<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (!canContinue) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Buffer is full after ${i} writes. Current buffer size: ${socket.bufferSize} bytes`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Stop writing and wait for the 'drain' event<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;socket.once('drain', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Buffer drained, resuming writes');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;writeUntilBufferFull();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;i++;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// All chunks written<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('All data sent');<br>
...
const PORT = 8082;<br>
server.listen(PORT, () => {<br>
&nbsp;&nbsp;console.log(`Buffer demonstration server running on port ${PORT}`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// For demonstration, create a client that connects and sends a message<br>
&nbsp;&nbsp;const client = new net.Socket();<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;client.connect(PORT, '127.0.0.1', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Test client connected');<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Send a message after 1 second<br>
&nbsp;&nbsp;&nbsp;&nbsp;setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;client.write('Please send me a large response');<br>
&nbsp;&nbsp;&nbsp;&nbsp;}, 1000);<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;let receivedData = 0;<br>
&nbsp;&nbsp;client.on('data', (data) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;receivedData += data.length;<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Client received ${data.length} bytes, total: ${receivedData}`);<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;client.on('end', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Client disconnected after receiving ${receivedData} bytes`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;process.exit(0);<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;client.on('error', (err) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error(`Client error: ${err.message}`);<br>
&nbsp;&nbsp;});<br>
});
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_socket_buffer">Run example &raquo;</a>
</div>

<hr>

<h2>IPC Socket Communication</h2>

<p>This example demonstrates Inter-Process Communication (IPC) using Unix domain sockets:</p>
...
<br>
// IPC path - depending on OS<br>
const socketPath = process.platform === 'win32' <br>
&nbsp;&nbsp;? path.join('\\\\?\\pipe', process.cwd(), 'ipc-demo.sock')<br>
&nbsp;&nbsp;: path.join(process.cwd(), 'ipc-demo.sock');<br>
<br>
// Remove existing socket file if it exists (Unix only)<br>
if (process.platform !== 'win32' && fs.existsSync(socketPath)) {<br>
&nbsp;&nbsp;fs.unlinkSync(socketPath);<br>
}<br>
<br>
// Create IPC server<br>
const server = net.createServer((socket) => {<br>
&nbsp;&nbsp;console.log('Client connected to IPC socket');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;socket.on('data', (data) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const message = data.toString().trim();<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Server received: ${message}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Echo back<br>
&nbsp;&nbsp;&nbsp;&nbsp;socket.write(`Echo: ${message}`);<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;socket.on('end', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Client disconnected from IPC socket');<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
...
// Handle server errors<br>
server.on('error', (err) => {<br>
&nbsp;&nbsp;console.error(`IPC server error: ${err.message}`);<br>
});<br>
<br>
// Start IPC server<br>
server.listen(socketPath, () => {<br>
&nbsp;&nbsp;console.log(`IPC server listening on ${socketPath}`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Create client that connects to the IPC socket<br>
&nbsp;&nbsp;const client = new net.Socket();<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;client.on('data', (data) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Client received: ${data.toString().trim()}`);<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;client.on('end', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Disconnected from IPC server');<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;client.on('error', (err) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error(`IPC client error: ${err.message}`);<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Connect to the IPC server<br>
&nbsp;&nbsp;client.connect(socketPath, () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Connected to IPC server');<br>
&nbsp;&nbsp;&nbsp;&nbsp;client.write('Hello via IPC socket');<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Send multiple messages<br>
&nbsp;&nbsp;&nbsp;&nbsp;setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;client.write('Message 1');<br>
&nbsp;&nbsp;&nbsp;&nbsp;}, 1000);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;client.write('Message 2');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;client.end(); // Close after sending the last message<br>
&nbsp;&nbsp;&nbsp;&nbsp;}, 2000);<br>
&nbsp;&nbsp;});<br>
});<br>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_socket_ipc">Run example &raquo;</a>
</div>

<hr>

<h2>Half-Closed Sockets</h2>

<p>This example demonstrates half-closed connections where one side has ended their write stream but can still receive data:</p>
...
&nbsp;&nbsp;console.log('Client connected');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Send initial message<br>
&nbsp;&nbsp;socket.write('Welcome to the half-close demonstration server\n');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Handle data from client<br>
&nbsp;&nbsp;socket.on('data', (data) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Server received: ${data.toString().trim()}`);<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Handle socket end (client ended their write stream)<br>
&nbsp;&nbsp;socket.on('end', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Client ended their write stream (half-closed)');<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// We can still write to the client after they've ended their write stream<br>
&nbsp;&nbsp;&nbsp;&nbsp;socket.write('You have ended your side of the connection, but I can still talk to you.');<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Close our side after a delay<br>
&nbsp;&nbsp;&nbsp;&nbsp;setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Server now closing its write stream');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;socket.end('Goodbye! Closing my side of the connection now.');<br>
&nbsp;&nbsp;&nbsp;&nbsp;}, 8080);<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Handle complete socket closure<br>
&nbsp;&nbsp;socket.on('close', (hadError) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Socket fully closed. Had error: ${hadError}`);<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;socket.on('error', (err) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error(`Socket error: ${err.message}`);<br>
...
const PORT = 8083;<br>
server.listen(PORT, () => {<br>
&nbsp;&nbsp;console.log(`Half-close demonstration server running on port ${PORT}`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Create a client for demonstration<br>
&nbsp;&nbsp;const client = new net.Socket();<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;client.connect(PORT, '127.0.0.1', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Client connected');<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// After a delay, end the client write stream (half-close)<br>
&nbsp;&nbsp;&nbsp;&nbsp;setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Client ending its write stream (half-closing)');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;client.end();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// We can't write anymore, but we can still receive data<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Client waiting to receive more data...');<br>
&nbsp;&nbsp;&nbsp;&nbsp;}, 2000);<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Handle data from server<br>
&nbsp;&nbsp;client.on('data', (data) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Client received: ${data.toString().trim()}`);<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Handle server closing its write stream<br>
&nbsp;&nbsp;client.on('end', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Server ended its write stream, connection fully closed');<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Handle complete connection closure<br>
&nbsp;&nbsp;client.on('close', (hadError) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Client connection fully closed. Had error: ${hadError}`);<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;client.on('error', (err) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error(`Client error: ${err.message}`);<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_socket_half_close">Run example &raquo;</a>
</div>

<hr>

<h2>Best Practices for Socket Programming</h2>

<p>When working with sockets in Node.js, consider these best practices:</p>

<ol>
  <li><strong>Error handling</strong>: Always handle the 'error' event to prevent unhandled exceptions.</li>
  <li><strong>Clean up resources</strong>: Ensure sockets are properly closed to avoid memory leaks.</li>
  <li><strong>Buffer management</strong>: Monitor <code class="w3-codespan">socket.bufferSize</code> and use the 'drain' event to avoid memory issues when sending large amounts of data.</li>
  <li><strong>Timeouts</strong>: Set appropriate timeouts with <code class="w3-codespan">socket.setTimeout()</code> to handle stale connections.</li>
  <li><strong>Keep-alive</strong>: Configure keep-alive settings for long-running connections.</li>
  <li><strong>Data encoding</strong>: Set appropriate encoding with <code class="w3-codespan">socket.setEncoding()</code> or handle binary data appropriately.</li>
  <li><strong>Security</strong>: For secure communication, use the TLS/SSL module (<code class="w3-codespan">tls</code>) instead of raw TCP sockets.</li>
  <li><strong>Backpressure</strong>: Pay attention to the return value of <code class="w3-codespan">socket.write()</code> to handle backpressure.</li>
</ol>
