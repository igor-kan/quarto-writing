...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Cipher Reference</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js Cipher Reference">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/ref_cipher.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="The Cipher class is part of Node.js's crypto module. It provides a way to encrypt data using various algorithms.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Cipher Reference">
<meta name="twitter:description" content="The Cipher class is part of Node.js's crypto module. It provides a way to encrypt data using various algorithms.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/ref_cipher.png">
...
<h1>Node.js Cipher Reference</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="ref_worker.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ref_decipher.asp">Next &#10095;</a>
</div>
...
<p>The Cipher class is part of Node.js's <code class="w3-codespan">crypto</code> module. It provides a way to encrypt data using various algorithms. Cipher instances are created using the <code class="w3-codespan">crypto.createCipheriv()</code> method.</p>

<div class="w3-panel w3-note">
  <p><strong>Note:</strong> The <code class="w3-codespan">crypto.createCipher()</code> method is deprecated since Node.js v10.0.0 due to security concerns. Always use <code class="w3-codespan">crypto.createCipheriv()</code> instead, which requires an explicit initialization vector (IV).</p>
</div>
...
<br>
// Create a cipher with createCipheriv<br>
const algorithm = 'aes-256-cbc';<br>
const key = crypto.randomBytes(32);  // 32 bytes for AES-256<br>
const iv = crypto.randomBytes(16);   // 16 bytes for AES<br>
const cipher = crypto.createCipheriv(algorithm, key, iv);</div>
</div>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td>cipher.update(data[, inputEncoding][, outputEncoding])</td>
    <td>Updates the cipher with <code class="w3-codespan">data</code>. If <code class="w3-codespan">inputEncoding</code> is provided, <code class="w3-codespan">data</code> is a string using the specified encoding. If <code class="w3-codespan">outputEncoding</code> is specified, the returned value will be a string using the specified encoding. If not, a Buffer is returned.</td>
  </tr>
  <tr>
    <td>cipher.final([outputEncoding])</td>
    <td>Returns any remaining enciphered contents. If <code class="w3-codespan">outputEncoding</code> is specified, a string is returned; otherwise, a Buffer is returned.</td>
  </tr>
  <tr>
    <td>cipher.setAAD(buffer[, options])</td>
    <td>When using an AEAD algorithm (like GCM or CCM), sets the Additional Authenticated Data (AAD).</td>
  </tr>
  <tr>
    <td>cipher.getAuthTag()</td>
    <td>When using an AEAD algorithm, this method returns a Buffer containing the authentication tag.</td>
  </tr>
  <tr>
    <td>cipher.setAutoPadding([autoPadding])</td>
    <td>When <code class="w3-codespan">autoPadding</code> is true (default), padding is applied. Disable when the data has been padded manually.</td>
  </tr>
</table>
...
<h2>Basic Encryption Example</h2>

<p>The following example demonstrates how to encrypt data using the AES-256-CBC algorithm:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const crypto = require('crypto');<br>
<br>
// Generate encryption key and initialization vector<br>
// In a real application, you would securely store and retrieve these values<br>
const key = crypto.randomBytes(32); // Key for AES-256 (32 bytes)<br>
const iv = crypto.randomBytes(16);  // IV for AES (16 bytes)<br>
<br>
// Create a cipher<br>
const algorithm = 'aes-256-cbc';<br>
...
<br>
// Data to encrypt<br>
const plainText = 'This is a secret message';<br>
<br>
// Encrypt the data<br>
let encrypted = cipher.update(plainText, 'utf8', 'hex');<br>
encrypted += cipher.final('hex');<br>
<br>
console.log('Original Text:', plainText);<br>
console.log('Encrypted Text:', encrypted);<br>
console.log('Key (hex):', key.toString('hex'));<br>
console.log('IV (hex):', iv.toString('hex'));<br>
<br>
// The encrypted message, key, and IV would be needed for decryption</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_ref_cipher_basic">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Encrypting with Different Algorithms</h2>

<p>Node.js supports numerous encryption algorithms. Here's how to use different ones:</p>
...
const plainText = 'Hello, this is a test message';<br>
<br>
// Function to encrypt data with different algorithms<br>
function encryptWithAlgorithm(algorithm, keySize, ivSize, plainText) {<br>
&nbsp;&nbsp;// Generate key and IV<br>
&nbsp;&nbsp;const key = crypto.randomBytes(keySize);<br>
&nbsp;&nbsp;const iv = crypto.randomBytes(ivSize);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Create cipher<br>
&nbsp;&nbsp;const cipher = crypto.createCipheriv(algorithm, key, iv);<br>
&nbsp;&nbsp;<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;algorithm,<br>
&nbsp;&nbsp;&nbsp;&nbsp;encrypted,<br>
&nbsp;&nbsp;&nbsp;&nbsp;key: key.toString('hex'),<br>
&nbsp;&nbsp;&nbsp;&nbsp;iv: iv.toString('hex')<br>
&nbsp;&nbsp;};<br>
}<br>
<br>
// Test different algorithms<br>
const algorithms = [<br>
&nbsp;&nbsp;{ name: 'aes-128-cbc', keySize: 16, ivSize: 16 },<br>
&nbsp;&nbsp;{ name: 'aes-192-cbc', keySize: 24, ivSize: 16 },<br>
&nbsp;&nbsp;{ name: 'aes-256-cbc', keySize: 32, ivSize: 16 },<br>
&nbsp;&nbsp;{ name: 'aes-256-gcm', keySize: 32, ivSize: 16 }<br>
];<br>
<br>
algorithms.forEach(algo => {<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const result = encryptWithAlgorithm(algo.name, algo.keySize, algo.ivSize, plainText);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Encrypted with ${result.algorithm}: ${result.encrypted}`);<br>
&nbsp;&nbsp;} catch (error) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error(`Error with ${algo.name}: ${error.message}`);<br>
&nbsp;&nbsp;}<br>
});</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_ref_cipher_algorithms">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Encrypting Binary Data</h2>

<p>You can encrypt binary data as well as text:</p>
...
const readStream = fs.createReadStream('input.jpg');<br>
const writeStream = fs.createWriteStream('encrypted.jpg.enc');<br>
<br>
// Create cipher stream<br>
...
&nbsp;&nbsp;.pipe(writeStream);<br>
<br>
// Save the key and IV for decryption<br>
fs.writeFileSync('encryption_key.txt', key.toString('hex'));<br>
fs.writeFileSync('encryption_iv.txt', iv.toString('hex'));<br>
<br>
writeStream.on('finish', () => {<br>
&nbsp;&nbsp;console.log('File encryption completed');<br>
});</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_cipher_binary">Run example &raquo;</a>
</div>

<hr>

<h2>Using AEAD Encryption</h2>

<p>Authenticated Encryption with Associated Data (AEAD) provides both confidentiality and data integrity:</p>
...
<br>
// Create cipher using AES-GCM (an AEAD algorithm)<br>
...
<br>
// All this information is needed for decryption and verification</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_cipher_aead">Run example &raquo;</a>
</div>
...
<p>You can control the padding behavior manually:</p>
...
<br>
// Function to encrypt with different padding options<br>
function encryptWithPadding(usePadding) {<br>
&nbsp;&nbsp;// Create cipher<br>
&nbsp;&nbsp;const cipher = crypto.createCipheriv('aes-256-cbc', key, iv);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Set padding option<br>
&nbsp;&nbsp;cipher.setAutoPadding(usePadding);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Encrypt data<br>
&nbsp;&nbsp;&nbsp;&nbsp;let encrypted = cipher.update(plainText, 'utf8', 'hex');<br>
...
<br>
// With default padding (true)<br>
console.log('With padding:', encryptWithPadding(true));<br>
<br>
// Without padding<br>
// This will likely fail unless data length is a multiple of the block size<br>
console.log('Without padding:', encryptWithPadding(false));<br>
<br>
// Example with manual padding to block size (16 bytes for AES)<br>
function manualPadding(text) {<br>
&nbsp;&nbsp;const blockSize = 16;<br>
&nbsp;&nbsp;const padLength = blockSize - (text.length % blockSize);<br>
&nbsp;&nbsp;return text + '\0'.repeat(padLength);<br>
}<br>
<br>
// Create cipher without auto padding<br>
const cipher = crypto.createCipheriv('aes-256-cbc', key, iv);<br>
cipher.setAutoPadding(false);<br>
<br>
// Manually pad the data<br>
const paddedText = manualPadding(plainText);<br>
console.log('Original length:', plainText.length);<br>
console.log('Padded length:', paddedText.length);<br>
<br>
// Encrypt manually padded data<br>
let encrypted = cipher.update(paddedText, 'utf8', 'hex');<br>
encrypted += cipher.final('hex');<br>
console.log('With manual padding:', encrypted);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_cipher_padding">Run example &raquo;</a>
</div>
...
<br>
// Decryption function (using the Decipher class)<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_cipher_complete">Run example &raquo;</a>
</div>

<hr>

<h2>Encryption with a Password</h2>

<p>For many applications, you might want to derive an encryption key from a password:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const crypto = require('crypto');<br>
<br>
// Password and salt<br>
...
&nbsp;&nbsp;encrypted += cipher.final('hex');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Return encrypted data and IV (we'll need both for decryption)<br>
&nbsp;&nbsp;return {<br>
&nbsp;&nbsp;&nbsp;&nbsp;iv: iv.toString('hex'),<br>
...
&nbsp;&nbsp;// Get the key from the password<br>
&nbsp;&nbsp;const key = getKeyFromPassword(<br>
&nbsp;&nbsp;&nbsp;&nbsp;password, <br>
&nbsp;&nbsp;&nbsp;&nbsp;Buffer.from(encryptedInfo.salt, 'hex')<br>
&nbsp;&nbsp;);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Get the IV from encryptedInfo<br>
...
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Decrypt data<br>
&nbsp;&nbsp;let decrypted = decipher.update(encryptedInfo.encryptedData, 'hex', 'utf8');<br>
&nbsp;&nbsp;decrypted += decipher.final('utf8');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;return decrypted;<br>
}<br>
<br>
// Test encryption with password<br>
const message = 'Secret message protected by a password';<br>
const encryptedInfo = encryptWithPassword(message, password);<br>
<br>
console.log('Encrypted:', encryptedInfo);<br>
<br>
// Test decryption with password<br>
const decryptedMessage = decryptWithPassword(encryptedInfo, password);<br>
console.log('Decrypted:', decryptedMessage);<br>
<br>
// Try with wrong password<br>
try {<br>
&nbsp;&nbsp;const wrongPassword = 'wrongpassword';<br>
&nbsp;&nbsp;const failedDecryption = decryptWithPassword(encryptedInfo, wrongPassword);<br>
&nbsp;&nbsp;console.log('Decrypted with wrong password:', failedDecryption);<br>
} catch (error) {<br>
&nbsp;&nbsp;console.log('Decryption failed with wrong password:', error.message);<br>
}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_cipher_password">Run example &raquo;</a>
</div>
...
<p>Node.js supports many encryption algorithms. You can get a list of all supported algorithms with:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const crypto = require('crypto');<br>
<br>
// Get all supported cipher algorithms<br>
console.log(crypto.getCiphers());</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_cipher_algorithms_list">Run example &raquo;</a>
</div>
...
<table class="ws-table-all">
  ...
  <tr>
    ...
    <td>16</td>
    <td>16</td>
    <td>AES with 128-bit key in CBC mode</td>
  </tr>
  <tr>
    <td>aes-192-cbc</td>
    <td>24</td>
    <td>16</td>
    <td>AES with 192-bit key in CBC mode</td>
  </tr>
  <tr>
    <td>aes-256-cbc</td>
    <td>32</td>
    <td>16</td>
    <td>AES with 256-bit key in CBC mode</td>
  </tr>
  <tr>
    <td>aes-128-gcm</td>
    <td>16</td>
    <td>12</td>
    <td>AES with 128-bit key in GCM mode (AEAD)</td>
  </tr>
  <tr>
    <td>aes-256-gcm</td>
    <td>32</td>
    <td>12</td>
    <td>AES with 256-bit key in GCM mode (AEAD)</td>
  </tr>
  <tr>
...
<ul>
  <li><strong>Use <code class="w3-codespan">createCipheriv()</code> instead of the deprecated <code class="w3-codespan">createCipher()</code></strong>: This ensures you're explicitly providing the IV.</li>
  <li><strong>Generate secure random keys and IVs</strong>: Always use <code class="w3-codespan">crypto.randomBytes()</code> to generate these values.</li>
  <li><strong>Never reuse IVs with the same key</strong>: This can severely weaken the encryption.</li>
  <li><strong>Prefer authenticated encryption (AEAD)</strong>: Algorithms like AES-GCM or ChaCha20-Poly1305 provide both confidentiality and integrity.</li>
  <li><strong>Securely store keys</strong>: Never hardcode keys in your application code.</li>
  <li><strong>Use key derivation functions</strong>: When deriving keys from passwords, use PBKDF2, Scrypt, or Argon2 with appropriate parameters.</li>
  <li><strong>Keep your Node.js version updated</strong>: Cryptographic vulnerabilities are fixed in security updates.</li>
</ul>
