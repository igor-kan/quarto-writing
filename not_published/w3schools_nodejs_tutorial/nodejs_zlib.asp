...
<meta name="title" property="og:title" content="Node.js Zlib Module">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_zlib.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="The Zlib module provides bindings to the zlib and brotli libraries for compressing and decompressing data.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Zlib Module">
<meta name="twitter:description" content="The Zlib module provides bindings to the zlib and brotli libraries for compressing and decompressing data.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_zlib.png">
...
<h1>Node.js Zlib Module</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_net.asp">&lt; Previous</a>
<a class="w3-right w3-btn" href="nodejs_real_world_examples.asp">Next &gt;</a>
</div>

<hr>

<h2>Introduction to the Zlib Module</h2>

<p>The Zlib module provides bindings to the zlib and brotli compression libraries, enabling you to:</p>
<ul>
  <li>Compress and decompress files and data streams</li>
  <li>Implement HTTP compression</li>
  <li>Work with compressed file formats (.gz, .zip)</li>
  <li>Optimize bandwidth usage in web applications</li>
</ul>

<hr>

<h2>Importing the Zlib Module</h2>
...
<p>The Zlib module supports several compression methods:</p>
...
<table class="ws-table-all">
  ...
  <tr>
    <td>Gzip/Gunzip</td>
    <td>The most widely used compression format, especially for web content</td>
  </tr>
  <tr>
    <td>Deflate/Inflate</td>
    <td>The raw deflate algorithm without headers or checksums</td>
  </tr>
  <tr>
    <td>DeflateRaw/InflateRaw</td>
    <td>Raw deflate algorithm with custom header and checksum handling</td>
  </tr>
  <tr>
    <td>Brotli</td>
    <td>Modern compression algorithm offering better ratios (added in Node.js 10.16.0)</td>
  </tr>
</table>
</div>
...
<h2>Basic Compression and Decompression</h2>
...
<br>
const input = 'This is some text that will be compressed using the zlib module in Node.js.';<br>
<br>
// Compress data using gzip<br>
zlib.gzip(input, (err, compressed) => {<br>
&nbsp;&nbsp;if (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error('Compression error:', err);<br>
&nbsp;&nbsp;&nbsp;&nbsp;return;<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;console.log('Original size:', input.length, 'bytes');<br>
&nbsp;&nbsp;console.log('Compressed size:', compressed.length, 'bytes');<br>
&nbsp;&nbsp;console.log('Compression ratio:', Math.round(100 - (compressed.length / input.length * 100)) + '%');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Decompress the data<br>
&nbsp;&nbsp;zlib.gunzip(compressed, (err, decompressed) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error('Decompression error:', err);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return;<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Decompressed data:', decompressed.toString());<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Successfully decompressed:', input === decompressed.toString());<br>
&nbsp;&nbsp;});<br>
});
</div>
</div>
...
<br>
// Convert callback-based functions to promise-based<br>
const gzipPromise = promisify(zlib.gzip);<br>
const gunzipPromise = promisify(zlib.gunzip);<br>
<br>
async function compressAndDecompress(input) {<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Compress<br>
&nbsp;&nbsp;&nbsp;&nbsp;const compressed = await gzipPromise(input);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Original size:', input.length, 'bytes');<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Compressed size:', compressed.length, 'bytes');<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Decompress<br>
&nbsp;&nbsp;&nbsp;&nbsp;const decompressed = await gunzipPromise(compressed);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Decompressed data:', decompressed.toString());<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Success:', input === decompressed.toString());<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
...
<br>
// Example usage<br>
const testData = 'This is some test data that will be compressed with the zlib module.';<br>
...
<p>The Zlib module can be used with streams for processing large files or data:</p>
...
<br>
// Compress a file<br>
function compressFile(inputPath) {<br>
&nbsp;&nbsp;const outputPath = inputPath + '.gz';<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Create read and write streams<br>
&nbsp;&nbsp;const input = fs.createReadStream(inputPath);<br>
&nbsp;&nbsp;const output = fs.createWriteStream(outputPath);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Create gzip transform stream<br>
&nbsp;&nbsp;const gzip = zlib.createGzip();<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Pipe data through the compression stream<br>
&nbsp;&nbsp;input.pipe(gzip).pipe(output);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Handle events<br>
&nbsp;&nbsp;input.on('error', (err) => console.error('Input error:', err));<br>
&nbsp;&nbsp;gzip.on('error', (err) => console.error('Compression error:', err));<br>
&nbsp;&nbsp;output.on('error', (err) => console.error('Output error:', err));<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;output.on('finish', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`File compressed successfully: ${outputPath}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Get file sizes for comparison<br>
&nbsp;&nbsp;&nbsp;&nbsp;const inputStats = fs.statSync(inputPath);<br>
&nbsp;&nbsp;&nbsp;&nbsp;const outputStats = fs.statSync(outputPath);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Original size: ${inputStats.size} bytes`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Compressed size: ${outputStats.size} bytes`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Compression ratio: ${Math.round(100 - (outputStats.size / inputStats.size * 100))}%`);<br>
&nbsp;&nbsp;});<br>
}<br>
<br>
// Decompress a file<br>
function decompressFile(inputPath) {<br>
&nbsp;&nbsp;// Remove .gz extension for output path<br>
&nbsp;&nbsp;const outputPath = inputPath.endsWith('.gz') <br>
&nbsp;&nbsp;&nbsp;&nbsp;? inputPath.slice(0, -3) <br>
&nbsp;&nbsp;&nbsp;&nbsp;: inputPath + '.uncompressed';<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Create streams<br>
&nbsp;&nbsp;const input = fs.createReadStream(inputPath);<br>
&nbsp;&nbsp;const output = fs.createWriteStream(outputPath);<br>
...
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Pipe data through decompression stream<br>
&nbsp;&nbsp;input.pipe(gunzip).pipe(output);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Handle events<br>
&nbsp;&nbsp;input.on('error', (err) => console.error('Input error:', err));<br>
&nbsp;&nbsp;gunzip.on('error', (err) => console.error('Decompression error:', err));<br>
&nbsp;&nbsp;output.on('error', (err) => console.error('Output error:', err));<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;output.on('finish', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`File decompressed successfully: ${outputPath}`);<br>
&nbsp;&nbsp;});<br>
}<br>
<br>
// Example usage (assuming you have a text file)<br>
// compressFile('example.txt');<br>
// decompressFile('example.txt.gz');<br>
<br>
// Note: Uncomment the above lines to actually run the compression/decompression<br>
console.log('This example shows how to compress and decompress files using streams.');<br>
console.log('Create a text file named "example.txt" and uncomment the function calls to test.');
</div>
</div>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> Using streams is memory-efficient for processing large files since the entire file doesn't need to be loaded into memory at once.</p>
</div>
...
<p>The Zlib module is commonly used for HTTP compression to reduce bandwidth usage:</p>
...
const zlib = require('zlib');<br>
<br>
// Create an HTTP server with compression<br>
const server = http.createServer((req, res) => {<br>
&nbsp;&nbsp;// Sample response content<br>
&nbsp;&nbsp;const responseBody = `<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;!DOCTYPE html&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;html&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;head&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;title&gt;Zlib Compression Example&lt;/title&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;/head&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;body&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;h1&gt;HTTP Compression with Zlib&lt;/h1&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;p&gt;This content is being compressed with Gzip before sending to your browser.&lt;/p&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;p&gt;Compression reduces bandwidth usage and improves page load times.&lt;/p&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${'&lt;p&gt;This paragraph is repeated to demonstrate compression efficiency.&lt;/p&gt;'.repeat(50)}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;/body&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;/html&gt;<br>
&nbsp;&nbsp;`;<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Check if client accepts gzip encoding<br>
&nbsp;&nbsp;const acceptEncoding = req.headers['accept-encoding'] || '';<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Set content type<br>
&nbsp;&nbsp;res.setHeader('Content-Type', 'text/html');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Compress response if client supports it<br>
&nbsp;&nbsp;if (/\bgzip\b/.test(acceptEncoding)) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Client supports gzip<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.setHeader('Content-Encoding', 'gzip');<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Compress and send<br>
&nbsp;&nbsp;&nbsp;&nbsp;zlib.gzip(responseBody, (err, compressed) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (err) {<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;} else if (/\bdeflate\b/.test(acceptEncoding)) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Client supports deflate<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.setHeader('Content-Encoding', 'deflate');<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Compress and send<br>
&nbsp;&nbsp;&nbsp;&nbsp;zlib.deflate(responseBody, (err, compressed) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;res.statusCode = 500;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;res.end('Internal Server Error');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return;<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// No compression supported<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.end(responseBody);<br>
&nbsp;&nbsp;}<br>
});<br>
<br>
// Start server on port 8080<br>
const PORT = 8080;<br>
server.listen(PORT, () => {<br>
&nbsp;&nbsp;console.log(`Server running at http://localhost:${PORT}/`);<br>
&nbsp;&nbsp;console.log('Open this URL in your browser to see compression in action');<br>
&nbsp;&nbsp;console.log('The browser will automatically decompress the content');<br>
});
</div>
</div>
...
<h2>Working with Brotli Compression</h2>

<p>Brotli is a modern compression algorithm that often achieves better compression ratios than Gzip:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const zlib = require('zlib');<br>
<br>
// Sample data to compress<br>
const input = 'This is some test data that will be compressed with different algorithms for comparison.'.repeat(20);<br>
<br>
// Compare compression methods<br>
function compareCompression() {<br>
&nbsp;&nbsp;console.log(`Original data size: ${input.length} bytes`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Gzip compression<br>
&nbsp;&nbsp;zlib.gzip(input, (err, gzipped) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error('Gzip error:', err);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return;<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Gzip size: ${gzipped.length} bytes (${Math.round(100 - (gzipped.length / input.length * 100))}% reduction)`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Deflate compression<br>
&nbsp;&nbsp;&nbsp;&nbsp;zlib.deflate(input, (err, deflated) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error('Deflate error:', err);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Deflate size: ${deflated.length} bytes (${Math.round(100 - (deflated.length / input.length * 100))}% reduction)`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Brotli compression (if available)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (typeof zlib.brotliCompress === 'function') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;zlib.brotliCompress(input, (err, brotli) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error('Brotli error:', err);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Brotli size: ${brotli.length} bytes (${Math.round(100 - (brotli.length / input.length * 100))}% reduction)`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Brotli compression not available in this Node.js version');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;});<br>
}<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_zlib_brotli">Run example &raquo;</a>
</div>

<div class="w3-panel w3-note">
<p><strong>Note:</strong> Brotli compression is available in Node.js 10.16.0 and later versions. It typically achieves better compression ratios but may be slower than Gzip.</p>
</div>
...
<p>You can customize compression behavior with options:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const zlib = require('zlib');<br>
<br>
const input = 'This is example content for compression with custom options.'.repeat(50);<br>
<br>
// Test different compression levels<br>
function testCompressionLevels() {<br>
&nbsp;&nbsp;console.log(`Original size: ${input.length} bytes`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Default compression (level 6)<br>
&nbsp;&nbsp;zlib.gzip(input, (err, compressed) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (err) throw err;<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Default compression (level 6): ${compressed.length} bytes`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Fastest compression (level 1)<br>
&nbsp;&nbsp;&nbsp;&nbsp;zlib.gzip(input, { level: 1 }, (err, fastCompressed) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (err) throw err;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Fast compression (level 1): ${fastCompressed.length} bytes`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Best compression (level 9)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;zlib.gzip(input, { level: 9 }, (err, bestCompressed) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (err) throw err;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Best compression (level 9): ${bestCompressed.length} bytes`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;});<br>
}<br>
<br>
// Test compression with custom memory usage<br>
function testMemoryLevels() {<br>
&nbsp;&nbsp;// Memory levels: 1 (lowest) to 9 (highest)<br>
&nbsp;&nbsp;zlib.gzip(input, { memLevel: 9 }, (err, compressed) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (err) throw err;<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`High memory usage (memLevel 9): ${compressed.length} bytes`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;zlib.gzip(input, { memLevel: 4 }, (err, lowMemCompressed) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (err) throw err;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Low memory usage (memLevel 4): ${lowMemCompressed.length} bytes`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;});<br>
}<br>
<br>
// Run tests<br>
testCompressionLevels();<br>
setTimeout(testMemoryLevels, 1000); // Slight delay to separate console output
</div>
</div>

<p>Common Zlib options include:</p>
<ul>
  <li><code class="w3-codespan">level</code>: Compression level (0-9, 0=none, 9=best)</li>
  <li><code class="w3-codespan">memLevel</code>: Memory usage (1-9, 1=lowest, 9=highest)</li>
  <li><code class="w3-codespan">strategy</code>: Compression strategy (e.g., Z_DEFAULT_STRATEGY)</li>
  <li><code class="w3-codespan">dictionary</code>: Pre-defined dictionary for compression</li>
  <li><code class="w3-codespan">windowBits</code>: Window size logarithm</li>
</ul>
...
<p>Proper error handling is crucial when working with compression:</p>
...
const fs = require('fs');<br>
<br>
// Function to safely decompress data<br>
function safeDecompress(compressedData) {<br>
&nbsp;&nbsp;return new Promise((resolve, reject) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;zlib.gunzip(compressedData, { finishFlush: zlib.constants.Z_SYNC_FLUSH }, (err, result) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Handle specific error types<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (err.code === 'Z_DATA_ERROR') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;reject(new Error('Invalid or corrupt compressed data'));<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;} else if (err.code === 'Z_BUF_ERROR') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;reject(new Error('Incomplete compressed data'));<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;reject(err);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return;<br>
...
<br>
// Example usage with error handling<br>
async function demonstrateErrorHandling() {<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Valid compression<br>
&nbsp;&nbsp;&nbsp;&nbsp;const validData = await zlib.gzipSync('This is valid data');<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Successfully compressed valid data');<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Try to decompress valid data<br>
&nbsp;&nbsp;&nbsp;&nbsp;const result = await safeDecompress(validData);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Successfully decompressed:', result.toString());<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Try to decompress invalid data<br>
&nbsp;&nbsp;&nbsp;&nbsp;const invalidData = Buffer.from('This is not compressed data');<br>
&nbsp;&nbsp;&nbsp;&nbsp;await safeDecompress(invalidData);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;} catch (err) {<br>
...
const path = require('path');<br>
<br>
// Compress log files and add timestamp<br>
function compressLogFile(logFilePath) {<br>
&nbsp;&nbsp;// Generate output path with timestamp<br>
&nbsp;&nbsp;const timestamp = new Date().toISOString().replace(/:/g, '-');<br>
&nbsp;&nbsp;const basename = path.basename(logFilePath);<br>
&nbsp;&nbsp;const outputPath = path.join(<br>
&nbsp;&nbsp;&nbsp;&nbsp;path.dirname(logFilePath),<br>
&nbsp;&nbsp;&nbsp;&nbsp;`${basename}-${timestamp}.gz`<br>
&nbsp;&nbsp;);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Create streams<br>
&nbsp;&nbsp;const input = fs.createReadStream(logFilePath);<br>
&nbsp;&nbsp;const output = fs.createWriteStream(outputPath);<br>
&nbsp;&nbsp;const gzip = zlib.createGzip();<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Pipe the streams<br>
...
&nbsp;&nbsp;// Handle events<br>
&nbsp;&nbsp;output.on('finish', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Log file compressed: ${outputPath}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Optionally, clear the original log file<br>
&nbsp;&nbsp;&nbsp;&nbsp;fs.writeFile(logFilePath, '', err => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error(`Error clearing log file: ${err.message}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Original log file cleared: ${logFilePath}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;input.on('error', err => console.error(`Read error: ${err.message}`));<br>
&nbsp;&nbsp;gzip.on('error', err => console.error(`Compression error: ${err.message}`));<br>
&nbsp;&nbsp;output.on('error', err => console.error(`Write error: ${err.message}`));<br>
}<br>
<br>
// Example usage<br>
// compressLogFile('server.log');<br>
<br>
// Note: Uncomment the line above to compress an actual log file<br>
console.log('This example shows how to compress log files with timestamps.');
</div>
</div>

<h3>2. API Response Compression</h3>
...
const zlib = require('zlib');<br>
<br>
// Sample API data (imagine this is from a database)<br>
const apiData = {<br>
&nbsp;&nbsp;users: Array.from({ length: 100 }, (_, i) => ({<br>
&nbsp;&nbsp;&nbsp;&nbsp;id: i + 1,<br>
&nbsp;&nbsp;&nbsp;&nbsp;name: `User ${i + 1}`,<br>
&nbsp;&nbsp;&nbsp;&nbsp;email: `user${i + 1}@example.com`,<br>
&nbsp;&nbsp;&nbsp;&nbsp;role: i % 3 === 0 ? 'admin' : 'user',<br>
&nbsp;&nbsp;&nbsp;&nbsp;created: new Date().toISOString(),<br>
&nbsp;&nbsp;&nbsp;&nbsp;profile: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;bio: `This is a sample bio for user ${i + 1}. It contains some text to demonstrate compression.`,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;interests: ['programming', 'reading', 'hiking', 'cooking', 'music'],<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;settings: {<br>
...
<br>
// Create a simple API server<br>
const server = http.createServer((req, res) => {<br>
&nbsp;&nbsp;// Only handle GET requests to /api/users<br>
&nbsp;&nbsp;if (req.method === 'GET' && req.url === '/api/users') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Convert data to JSON string<br>
&nbsp;&nbsp;&nbsp;&nbsp;const jsonData = JSON.stringify(apiData);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Check if client accepts compression<br>
&nbsp;&nbsp;&nbsp;&nbsp;const acceptEncoding = req.headers['accept-encoding'] || '';<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Set JSON content type<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.setHeader('Content-Type', 'application/json');<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Compress based on accepted encoding<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (/\bgzip\b/.test(acceptEncoding)) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;res.setHeader('Content-Encoding', 'gzip');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Compress and send<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;zlib.gzip(jsonData, (err, compressed) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;res.statusCode = 500;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;res.end(JSON.stringify({ error: 'Compression failed' }));<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Original size: ${jsonData.length} bytes`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Compressed size: ${compressed.length} bytes`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Compression ratio: ${Math.round(100 - (compressed.length / jsonData.length * 100))}%`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;res.end(compressed);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// No compression<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Sending uncompressed response: ${jsonData.length} bytes`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;res.end(jsonData);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Not found<br>
...
&nbsp;&nbsp;console.log('Test the API by visiting: http://localhost:8080/api/users');<br>
});
</div>
</div>
...
<p>Zlib offers different compression strategies that can be more effective for certain types of data:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const zlib = require('zlib');<br>
<br>
// Sample data with repeated patterns (good for RLE)<br>
const repeatedData = 'ABC'.repeat(1000);<br>
<br>
// Test different compression strategies<br>
function testStrategies(data) {<br>
&nbsp;&nbsp;const strategies = [<br>
&nbsp;&nbsp;&nbsp;&nbsp;{ name: 'DEFAULT_STRATEGY', value: zlib.constants.Z_DEFAULT_STRATEGY },<br>
&nbsp;&nbsp;&nbsp;&nbsp;{ name: 'FILTERED', value: zlib.constants.Z_FILTERED },<br>
&nbsp;&nbsp;&nbsp;&nbsp;{ name: 'HUFFMAN_ONLY', value: zlib.constants.Z_HUFFMAN_ONLY },<br>
&nbsp;&nbsp;&nbsp;&nbsp;{ name: 'RLE', value: zlib.constants.Z_RLE },<br>
&nbsp;&nbsp;&nbsp;&nbsp;{ name: 'FIXED', value: zlib.constants.Z_FIXED }<br>
&nbsp;&nbsp;];<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;console.log(`Original size: ${data.length} bytes`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;strategies.forEach(({ name, value }) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const compressed = zlib.gzipSync(data, { strategy: value });<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`${name.padEnd(20)}: ${compressed.length.toString().padEnd(5)} bytes`);<br>
&nbsp;&nbsp;});<br>
}<br>
<br>
...
<h3>2. Custom Dictionaries</h3>
<p>For specific data patterns, custom dictionaries can improve compression ratio:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const zlib = require('zlib');<br>
<br>
// Create a custom dictionary with common terms<br>
const dictionary = Buffer.from('username,password,email,first_name,last_name,created_at,updated_at,status,active,inactive,pending,admin,user,role,permissions');<br>
<br>
// Sample data that benefits from the dictionary<br>
const userData = JSON.stringify({<br>
&nbsp;&nbsp;username: 'johndoe',<br>
...
&nbsp;&nbsp;updated_at: new Date().toISOString()<br>
});<br>
<br>
// Compress with and without dictionary<br>
const compressedWithout = zlib.deflateSync(userData);<br>
const compressedWith = zlib.deflateSync(userData, { dictionary });<br>
<br>
console.log('Original size:', Buffer.byteLength(userData), 'bytes');<br>
console.log('Compressed without dictionary:', compressedWithout.length, 'bytes');<br>
console.log('Compressed with dictionary:', compressedWith.length, 'bytes');<br>
console.log('Improvement:', Math.round((1 - (compressedWith.length / compressedWithout.length)) * 100) + '%');<br>
<br>
// Decompress with dictionary<br>
const decompressed = zlib.inflateSync(compressedWith, { dictionary });<br>
console.log('Decompressed matches original:', decompressed.toString() === userData);
</div>
</div>

<h3>3. Progressive Compression</h3>
<p>Process data in chunks as it becomes available:</p>
...
<br>
class ProgressTracker extends Transform {<br>
&nbsp;&nbsp;constructor(options = {}) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;super(options);<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.processedBytes = 0;<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.startTime = Date.now();<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;_transform(chunk, encoding, callback) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.processedBytes += chunk.length;<br>
&nbsp;&nbsp;&nbsp;&nbsp;const elapsed = (Date.now() - this.startTime) / 1000;<br>
&nbsp;&nbsp;&nbsp;&nbsp;const rate = (this.processedBytes / 1024 / 1024 / elapsed).toFixed(2);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;process.stdout.write(`\rProcessed: ${(this.processedBytes / 1024 / 1024).toFixed(2)} MB | ` +<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; `Rate: ${rate} MB/s`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.push(chunk);<br>
&nbsp;&nbsp;&nbsp;&nbsp;callback();<br>
...
<br>
// Simulate processing a large file<br>
function processLargeFile() {<br>
&nbsp;&nbsp;const gzip = zlib.createGzip({ level: 6 });<br>
&nbsp;&nbsp;const progress = new ProgressTracker();<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Generate 100MB of random data<br>
&nbsp;&nbsp;const data = Buffer.alloc(1024 * 1024 * 100);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Create a readable stream from buffer<br>
&nbsp;&nbsp;const { Readable } = require('stream');<br>
&nbsp;&nbsp;const readable = Readable.from(data);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;console.log('Starting compression...');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;readable<br>
&nbsp;&nbsp;&nbsp;&nbsp;.pipe(progress)<br>
&nbsp;&nbsp;&nbsp;&nbsp;.pipe(gzip)<br>
&nbsp;&nbsp;&nbsp;&nbsp;.pipe(process.stdout);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;gzip.on('end', () => {<br>
...
<br>
// Uncomment to run (creates a large file)<br>
// processLargeFile();
</div>
</div>
...
<ul>
  <li><strong>Compression level trade-offs</strong>: Higher levels = better compression but slower processing</li>
  <li><strong>Memory usage</strong>: Compression can be memory-intensive, especially with high levels</li>
  <li><strong>When to compress</strong>: Only compress data that benefits from compression (text, JSON, etc.)</li>
  <li><strong>Already compressed data</strong>: Don't compress files that are already compressed (images, videos, etc.)</li>
  <li><strong>Streaming</strong>: Use streams for large files to avoid memory issues</li>
  <li><strong>Thread pool usage</strong>: Zlib operations use libuv's thread pool; configure with UV_THREADPOOL_SIZE if needed</li>
</ul>
...
<p>The Node.js Zlib module provides essential compression and decompression functionality for:</p>

<ul>
  <li>Reducing file sizes and bandwidth usage</li>
  <li>Working with compressed formats</li>
  <li>Implementing HTTP compression</li>
  <li>Processing large data efficiently using streams</li>
</ul>

<p>Key features include:</p>

<ul>
  <li>Support for multiple compression algorithms (Gzip, Deflate, Brotli)</li>
  <li>Both synchronous and asynchronous APIs</li>
  <li>Stream-based processing for memory efficiency</li>
  <li>Configurable compression levels and options</li>
</ul>

<p>Understanding the Zlib module is essential for optimizing data transfer and storage in Node.js applications.</p>

<hr>


<div id="exercisecontainer" src="xrcise_zlib.js" data-extensions="asp"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_net.asp">&#10094; Previous</a>
