...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js WebAssembly</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js WebAssembly">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_webassembly.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="WebAssembly (Wasm) is a binary instruction format designed as a portable compilation target for high-level languages like C, C++, and Rust.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js WebAssembly">
<meta name="twitter:description" content="WebAssembly (Wasm) is a binary instruction format designed as a portable compilation target for high-level languages like C, C++, and Rust.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_webassembly.png">
...
<h1>Node.js <span class="color_h1">WebAssembly</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_microservices.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="nodejs_http2.asp">Next &#10095;</a>
</div>
<hr>

<h2 id="intro">What is WebAssembly?</h2>
<p><b>WebAssembly (Wasm)</b> is a binary instruction format designed as a portable compilation target for high-level languages like C, C++, and Rust.</p>
<p>Key characteristics of WebAssembly include:</p>
<ul>
  <li><b>Binary format</b> - Compact size that loads and executes faster than JavaScript</li>
  <li><b>Near-native performance</b> - Executes at speeds close to native machine code</li>
  <li><b>Platform independent</b> - Runs on browsers, Node.js, and other environments</li>
  <li><b>Safety</b> - Executes in a sandboxed environment with a strong security model</li>
</ul>
<p>Unlike JavaScript, WebAssembly is a low-level binary format that isn't meant to be written by hand.</p>
<p>Instead, you compile code from other languages into WebAssembly.</p>
<hr>

<h2 id="nodejs-support">WebAssembly Support in Node.js</h2>
<p>Node.js provides built-in support for WebAssembly through the global <code class="w3-codespan">WebAssembly</code> object (just like in browsers).</p>
<p>To check if your Node.js version supports WebAssembly:</p>

<div class="w3-example">
<h3>Example: Check WebAssembly Support</h3>
<div class="w3-code notranslate jsHigh">
console.log(typeof WebAssembly === 'object');<br>
console.log(WebAssembly);
</div>
</div>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> WebAssembly support was first added in Node.js v8.0.0 and has improved in subsequent versions.</p>
</div>
<hr>
...
<h2 id="using">Using WebAssembly in Node.js</h2>
<p>The WebAssembly API in Node.js provides several methods for working with WebAssembly modules:</p>
...
<table class="ws-table-all">
  ...
  <tr>
    <td><code class="w3-codespan">WebAssembly.compile()</code></td>
    <td>Compiles WebAssembly binary code into a WebAssembly module</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">WebAssembly.instantiate()</code></td>
    <td>Compiles and instantiates WebAssembly code</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">WebAssembly.validate()</code></td>
    <td>Validates a WebAssembly binary format</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">WebAssembly.Module</code></td>
    <td>Represents a compiled WebAssembly module</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">WebAssembly.Instance</code></td>
    <td>Represents an instantiated WebAssembly module</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">WebAssembly.Memory</code></td>
    <td>Represents WebAssembly memory</td>
  </tr>
</table>

<p>Here's a basic example of loading and running a WebAssembly module:</p>

<div class="w3-example">
<h3>Example: Running WebAssembly in Node.js</h3>
<div class="w3-code notranslate jsHigh">
const fs = require('fs');<br>
<br>
// Read the WebAssembly binary file<br>
const wasmBuffer = fs.readFileSync('./simple.wasm');<br>
<br>
// Compile and instantiate the module<br>
WebAssembly.instantiate(wasmBuffer).then(result => {<br>
&nbsp;&nbsp;const instance = result.instance;<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Call the exported 'add' function<br>
&nbsp;&nbsp;const sum = instance.exports.add(2, 3);<br>
&nbsp;&nbsp;console.log('2 + 3 =', sum); // Output: 2 + 3 = 5<br>
});
</div>
</div>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> The <code class="w3-codespan">simple.wasm</code> file in this example would be a compiled WebAssembly module that exports an <code class="w3-codespan">add</code> function.</p>
  <p>You would typically create this by compiling C, C++, or Rust code.</p>
</div>
<hr>

<h2 id="languages">Working with Different Languages</h2>
<p>You can compile various languages to WebAssembly for use in Node.js:</p>

<h3>C/C++ with Emscripten</h3>
<p><a href="https://emscripten.org/" target="_blank">Emscripten</a> is a compiler toolchain for C/C++ that outputs WebAssembly.</p>

<div class="w3-example">
<h4>Example C Code (add.c):</h4>
<div class="w3-code notranslate">
#include &lt;emscripten.h&gt;<br>
<br>
EMSCRIPTEN_KEEPALIVE<br>
int add(int a, int b) {<br>
&nbsp;&nbsp;return a + b;<br>
}
</div>

<h4>Compile to WebAssembly:</h4>
<div class="w3-code notranslate">
emcc add.c -s WASM=1 -s EXPORTED_FUNCTIONS='["_add"]' -o add.js
</div>
</div>

<h3>Rust with wasm-pack</h3>
<p><a href="https://rustwasm.github.io/wasm-pack/" target="_blank">wasm-pack</a> is a tool for building Rust-generated WebAssembly.</p>

<div class="w3-example">
<h4>Example Rust Code (src/lib.rs):</h4>
<div class="w3-code notranslate">
use wasm_bindgen::prelude::*;<br>
<br>
#[wasm_bindgen]<br>
pub fn add(a: i32, b: i32) -> i32 {<br>
&nbsp;&nbsp;  a + b<br>
}
</div>

<h4>Build with wasm-pack:</h4>
<div class="w3-code notranslate">
...
<h2 id="advanced">Advanced WebAssembly Usage</h2>

<h3>1. Working with Complex Data Structures</h3>
<p>Passing complex data between JavaScript and WebAssembly requires careful memory management:</p>

<div class="w3-example">
<h4>Example: Passing Arrays to WebAssembly</h4>
<div class="w3-code notranslate jsHigh">
// JavaScript code<br>
const wasmModule = await WebAssembly.instantiate(wasmBuffer, {<br>
&nbsp;&nbsp;env: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;memory: new WebAssembly.Memory({ initial: 1 })<br>
&nbsp;&nbsp;}<br>});<br>

// Allocate memory for an array of 10 integers (4 bytes each)<br>
const arraySize = 10;<br>
const ptr = wasmModule.exports.alloc(arraySize * 4);<br>
const intArray = new Int32Array(wasmModule.exports.memory.buffer, ptr, arraySize);<br>

// Fill array with values<br>
for (let i = 0; i &lt; arraySize; i++) {<br>
&nbsp;&nbsp;intArray[i] = i * 2;<br>
}<br>
// Call WebAssembly function to process the array<br>
const sum = wasmModule.exports.processArray(ptr, arraySize);<br>
console.log('Sum of array:', sum);<br>
// Don't forget to free the memory<br>
wasmModule.exports.dealloc(ptr, arraySize * 4);
</div>

<h4>Corresponding C Code (compiled to WebAssembly):</h4>
<div class="w3-code notranslate">
#include &lt;stdlib.h&gt;<br>
<br>
int* alloc(int size) {<br>
&nbsp;&nbsp;return (int*)malloc(size);<br>
}<br>
<br>
void dealloc(int* ptr, int size) {<br>
&nbsp;&nbsp;free(ptr);<br>
}<br>
<br>
int processArray(int* array, int length) {<br>
&nbsp;&nbsp;int sum = 0;<br>
...
<h3>2. Multithreading with WebAssembly</h3>
<p>WebAssembly supports multithreading through Web Workers and SharedArrayBuffer:</p>

<div class="w3-example">
<h4>Example: Parallel Processing with WebAssembly</h4>
<div class="w3-code notranslate jsHigh">
// main.js<br>
const workerCode = `<br>
&nbsp;&nbsp;const wasmModule = await WebAssembly.instantiate(wasmBuffer, {<br>
&nbsp;&nbsp;&nbsp;&nbsp;env: { memory: new WebAssembly.Memory({ initial: 1, shared: true }) }<br>
&nbsp;&nbsp;});<br>
  <br>
&nbsp;&nbsp;self.onmessage = (e) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const { data, start, end } = e.data;<br>
&nbsp;&nbsp;&nbsp;&nbsp;const result = wasmModule.exports.processChunk(data, start, end);<br>
&nbsp;&nbsp;&nbsp;&nbsp;self.postMessage({ result });<br>
&nbsp;&nbsp;};<br>
`;<br>
<br>
// Create worker pool<br>
const workerCount = navigator.hardwareConcurrency || 4;<br>
const workers = Array(workerCount).fill().map(() => {<br>
&nbsp;&nbsp;const blob = new Blob([workerCode], { type: 'application/javascript' });<br>
&nbsp;&nbsp;return new Worker(URL.createObjectURL(blob));<br>
});<br>
<br>
// Process data in parallel<br>
async function processInParallel(data, chunkSize) {<br>
&nbsp;&nbsp;const results = [];<br>
&nbsp;&nbsp;let completed = 0;<br>
  <br>
&nbsp;&nbsp;return new Promise((resolve) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;workers.forEach((worker, i) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const start = i * chunkSize;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const end = Math.min(start + chunkSize, data.length);<br>
      <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;worker.onmessage = (e) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;results[i] = e.data.result;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;completed++;<br>
        <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (completed === workerCount) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;resolve(results);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;};<br>
      <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;worker.postMessage({ data, start, end });<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;});<br>
}
</div>
...
<h3>3. Debugging WebAssembly</h3>
<p>Debugging WebAssembly can be challenging, but modern tools can help:</p>

<div class="w3-example">
<h4>Using Source Maps with Emscripten</h4>
<div class="w3-code notranslate">
# Compile with debugging information and source maps<br>
...
<ol>
  ...
  <li>Find your WebAssembly file in the file tree</li>
  <li>Set breakpoints and inspect variables as with JavaScript</li>
</ol>

<hr>
<h2 id="real-world">Real-World WebAssembly Examples</h2>

<h3>1. Image Processing with WebAssembly</h3>
<p>WebAssembly excels at CPU-intensive tasks like image processing:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// JavaScript wrapper for WebAssembly image processing<br>
async function applyFilter(imageData, filterType) {<br>
&nbsp;&nbsp;const { instance } = await WebAssembly.instantiate(wasmBuffer, {<br>
&nbsp;&nbsp;&nbsp;&nbsp;env: { memory: new WebAssembly.Memory({ initial: 1 }) }<br>
&nbsp;&nbsp;});<br>
  <br>
&nbsp;&nbsp;const { width, height, data } = imageData;<br>
  <br>
&nbsp;&nbsp;// Allocate memory for image data<br>
&nbsp;&nbsp;const imageDataSize = width * height * 4; // RGBA<br>
&nbsp;&nbsp;const imageDataPtr = instance.exports.alloc(imageDataSize);<br>
  <br>
&nbsp;&nbsp;// Copy image data to WebAssembly memory<br>
&nbsp;&nbsp;const wasmMemory = new Uint8Array(instance.exports.memory.buffer);<br>
&nbsp;&nbsp;wasmMemory.set(new Uint8Array(data.buffer), imageDataPtr);<br>
  <br>
&nbsp;&nbsp;// Apply filter<br>
&nbsp;&nbsp;instance.exports.applyFilter(imageDataPtr, width, height, filterType);<br>
  <br>
&nbsp;&nbsp;// Copy result back to ImageData<br>
&nbsp;&nbsp;const resultData = new Uint8ClampedArray(<br>
&nbsp;&nbsp;&nbsp;&nbsp;wasmMemory.slice(imageDataPtr, imageDataPtr + imageDataSize)<br>
&nbsp;&nbsp;);<br>
  <br>
&nbsp;&nbsp;// Free allocated memory<br>
&nbsp;&nbsp;instance.exports.dealloc(imageDataPtr, imageDataSize);<br>
  <br>
&nbsp;&nbsp;return new ImageData(resultData, width, height);<br>
}
</div>
</div>

<h3>2. Cryptography</h3>
<p>High-performance cryptographic operations with WebAssembly:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// Example: Using the Web Crypto API with WebAssembly<br>
async function encryptData(data, keyMaterial) {<br>
&nbsp;&nbsp;// Import WebAssembly crypto module<br>
&nbsp;&nbsp;const { instance } = await WebAssembly.instantiateStreaming(<br>
&nbsp;&nbsp;&nbsp;&nbsp;fetch('crypto.wasm'),<br>
&nbsp;&nbsp;&nbsp;&nbsp;{ env: { memory: new WebAssembly.Memory({ initial: 1 }) } }<br>
&nbsp;&nbsp;);<br>
  <br>
&nbsp;&nbsp;// Generate IV (Initialization Vector)<br>
&nbsp;&nbsp;const iv = window.crypto.getRandomValues(new Uint8Array(12));<br>
  <br>
&nbsp;&nbsp;// Prepare data<br>
&nbsp;&nbsp;const dataBytes = new TextEncoder().encode(JSON.stringify(data));<br>
&nbsp;&nbsp;const dataPtr = instance.exports.alloc(dataBytes.length);<br>
&nbsp;&nbsp;new Uint8Array(instance.exports.memory.buffer, dataPtr, dataBytes.length)<br>
&nbsp;&nbsp;&nbsp;&nbsp;.set(dataBytes);<br>
  <br>
&nbsp;&nbsp;// Encrypt data using WebAssembly<br>
&nbsp;&nbsp;const encryptedDataPtr = instance.exports.encrypt(dataPtr, dataBytes.length);<br>
  <br>
&nbsp;&nbsp;// Get encrypted data from WebAssembly memory<br>
&nbsp;&nbsp;const encryptedData = new Uint8Array(<br>
&nbsp;&nbsp;&nbsp;&nbsp;instance.exports.memory.buffer,<br>
&nbsp;&nbsp;&nbsp;&nbsp;encryptedDataPtr,<br>
&nbsp;&nbsp;&nbsp;&nbsp;dataBytes.length // In real usage, you'd track the actual encrypted size<br>
&nbsp;&nbsp;);<br>
  <br>
&nbsp;&nbsp;// Clean up<br>
&nbsp;&nbsp;instance.exports.dealloc(dataPtr, dataBytes.length);<br>
  <br>
&nbsp;&nbsp;return {<br>
&nbsp;&nbsp;&nbsp;&nbsp;iv: Array.from(iv),<br>
&nbsp;&nbsp;&nbsp;&nbsp;encryptedData: Array.from(encryptedData)<br>
&nbsp;&nbsp;};<br>
}
</div>
</div>
...
<p>WebAssembly in Node.js offers several advantages:</p>

<ul>
  <li><b>Performance</b> - Near-native execution speed for computationally intensive tasks</li>
  <li><b>Language choice</b> - Use languages like C, C++, Rust, Go, and others in your Node.js apps</li>
  <li><b>Code reuse</b> - Reuse existing libraries and codebases from other languages</li>
  <li><b>Isomorphic code</b> - Share WebAssembly modules between browser and server</li>
</ul>
...
<p>To demonstrate the performance benefits, let's compare JavaScript and WebAssembly implementations of a recursive Fibonacci function:</p>

<div class="w3-example">
<h4>JavaScript Implementation:</h4>
<div class="w3-code notranslate jsHigh">
// Recursive Fibonacci in JavaScript (inefficient for demonstration)<br>
function fibonacciJS(n) {<br>
&nbsp;&nbsp;if (n &lt;= 1) return n;<br>
&nbsp;&nbsp;return fibonacciJS(n - 1) + fibonacciJS(n - 2);<br>
}
</div>

<h4>C Implementation (to be compiled to WebAssembly):</h4>
<div class="w3-code notranslate">
#include &lt;emscripten.h&gt;<br>
<br>
// WebAssembly-optimized Fibonacci function<br>
EMSCRIPTEN_KEEPALIVE<br>
int fibonacci_wasm(int n) {<br>
&nbsp;&nbsp;if (n &lt;= 1) return n;<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;int a = 0, b = 1, temp;<br>
...
<h4>Performance Comparison Code:</h4>
<div class="w3-code notranslate jsHigh">
const fs = require('fs');<br>
const path = require('path');<br>
<br>
// Read the WebAssembly binary file<br>
const wasmBuffer = fs.readFileSync('./fibonacci.wasm');<br>
<br>
// JavaScript implementation for comparison<br>
function fibonacciJS(n) {<br>
&nbsp;&nbsp;if (n &lt;= 1) return n;<br>
&nbsp;&nbsp;return fibonacciJS(n - 1) + fibonacciJS(n - 2);<br>
}<br>
<br>
// Compile and instantiate the WebAssembly module<br>
WebAssembly.instantiate(wasmBuffer).then(result => {<br>
&nbsp;&nbsp;const { fibonacci_wasm } = result.instance.exports;<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Test with a value that's computationally expensive<br>
&nbsp;&nbsp;const n = 40;<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Measure WebAssembly performance<br>
&nbsp;&nbsp;const wasmStart = performance.now();<br>
&nbsp;&nbsp;const wasmResult = fibonacci_wasm(n);<br>
&nbsp;&nbsp;const wasmEnd = performance.now();<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Measure JavaScript performance<br>
&nbsp;&nbsp;const jsStart = performance.now();<br>
&nbsp;&nbsp;const jsResult = fibonacciJS(n);<br>
&nbsp;&nbsp;const jsEnd = performance.now();<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;console.log(`Fibonacci(${n})`);<br>
&nbsp;&nbsp;console.log(`WebAssembly: ${wasmResult} (${(wasmEnd - wasmStart).toFixed(2)} ms)`);<br>
&nbsp;&nbsp;console.log(`JavaScript: ${jsResult} (${(jsEnd - jsStart).toFixed(2)} ms)`);<br>
});
</div>
</div>

<div class="w3-panel ws-info">
<p>The WebAssembly version uses an iterative algorithm that is much faster than the recursive approach.</p>
<p>Even with identical algorithms, WebAssembly typically performs better for CPU-intensive operations due to its compiled nature.</p>
</div>

<h3>Real-World Applications</h3>
<p>Here are some popular libraries that use WebAssembly with Node.js:</p>

<table class="ws-table-all w3-hoverable">
  <tr>
    <th>Library</th>
    <th>Purpose</th>
    <th>Languages</th>
  ...
  <tr>
    <td>ffmpeg.wasm</td>
    <td>Video and audio processing</td>
    <td>C</td>
  </tr>
  <tr>
    <td>sql.js</td>
    <td>SQLite for JavaScript</td>
    <td>C</td>
  </tr>
  <tr>
    <td>zxing-wasm</td>
...
<p>WebAssembly modules operate on a linear memory, which is a contiguous, mutable array of bytes that is accessible from both WebAssembly and JavaScript.</p>

<h3>Understanding WebAssembly Memory</h3>
<p>WebAssembly memory is organized into pages, where each page is 64KB (65,536 bytes).</p>
<p>The memory can be created either by JavaScript or by the WebAssembly module itself.</p>

<ul>
  <li><strong>initial</strong>: The initial number of pages (minimum size)</li>
  <li><strong>maximum</strong>: Optional maximum number of pages the memory can grow to</li>
  <li><strong>shared</strong>: Whether the memory can be shared between workers (for multithreading)</li>
</ul>

<div class="w3-example">
<h3>Creating and Accessing WebAssembly Memory</h3>
<div class="w3-code notranslate jsHigh">
// Create a new WebAssembly Memory instance with 1 page (64KB) initially,<br>
// and a maximum of 10 pages (640KB)<br>
const memory = new WebAssembly.Memory({ <br>
&nbsp;&nbsp;initial: 1, <br>
&nbsp;&nbsp;maximum: 10 <br>
});<br>
<br>
// Access the memory as a typed array in JavaScript<br>
let bytes = new Uint8Array(memory.buffer);<br>
<br>
// Write data to memory<br>
for (let i = 0; i &lt; 10; i++) {<br>
&nbsp;&nbsp;bytes[i] = i * 10; // Write values 0, 10, 20, ..., 90<br>
}<br>
<br>
// Read data from memory<br>
console.log('Memory contents:', bytes.slice(0, 10));<br>
<br>
// Grow the memory by 1 page (returns the previous size in pages)<br>
const previousPages = memory.grow(1);<br>
console.log(`Memory grown from ${previousPages} to ${memory.buffer.byteLength / 65536} pages`);<br>
<br>
// IMPORTANT: After growing memory, we need to create a new view<br>
// because the ArrayBuffer is detached when memory grows<br>
bytes = new Uint8Array(memory.buffer);<br>
console.log('Memory size now:', bytes.length, 'bytes');
</div>
</div>

<div class="w3-panel ws-warning">
<p><strong>Warning:</strong> When WebAssembly memory grows, the underlying ArrayBuffer is detached and a new one is created.</p>
<p>This means any JavaScript TypedArray views of the memory must be recreated after growing memory.</p>
</div>

<h3>Using Different TypedArray Views</h3>
<p>You can create different views of the same memory to interpret the data in various ways:</p>

<div class="w3-example">
<h3>Working with Different Data Types</h3>
<div class="w3-code notranslate jsHigh">
const memory = new WebAssembly.Memory({ initial: 1 });<br>
<br>
// Different views of the same memory<br>
const bytes = new Uint8Array(memory.buffer);   // Unsigned 8-bit integers<br>
const ints = new Int32Array(memory.buffer);    // Signed 32-bit integers<br>
const floats = new Float32Array(memory.buffer); // 32-bit floating point<br>
<br>
// Write an integer at the beginning of memory<br>
ints[0] = 42;<br>
<br>
// The same memory location viewed as bytes<br>
console.log('42 as bytes:', Array.from(bytes.slice(0, 4)));<br>
<br>
// Write a float<br>
floats[1] = 3.14159;<br>
<br>
// View the float as bytes and as an integer<br>
const floatByteOffset = 1 * Float32Array.BYTES_PER_ELEMENT;<br>
const floatIntValue = ints[floatByteOffset / Int32Array.BYTES_PER_ELEMENT];<br>
console.log('3.14159 as bytes:', Array.from(bytes.slice(floatByteOffset, floatByteOffset + 4)));<br>
console.log('3.14159 as int32:', floatIntValue);
</div>
</div>

<h3>Image Processing Example</h3>
<p>Here's a practical example of using WebAssembly memory for image processing:</p>

<div class="w3-example">
<h3>WebAssembly C Code for Grayscale Conversion</h3>
<div class="w3-code notranslate">
#include &lt;emscripten.h&gt;<br>
#include &lt;stdint.h&gt;<br>
<br>
// WebAssembly optimized grayscale conversion<br>
EMSCRIPTEN_KEEPALIVE<br>
void grayscale_wasm(uint8_t* pixels, int length) {<br>
&nbsp;&nbsp;// Process each pixel (RGBA format)<br>
&nbsp;&nbsp;for (int i = 0; i &lt; length; i += 4) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Calculate grayscale value using luminance formula<br>
&nbsp;&nbsp;&nbsp;&nbsp;uint8_t gray = (uint8_t)(<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(0.299 * pixels[i]) +&nbsp;&nbsp;&nbsp;&nbsp; // Red<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(0.587 * pixels[i + 1]) + // Green<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(0.114 * pixels[i + 2])&nbsp;&nbsp; // Blue<br>
&nbsp;&nbsp;&nbsp;&nbsp;);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Set RGB channels to gray value<br>
&nbsp;&nbsp;&nbsp;&nbsp;pixels[i] = gray;&nbsp;&nbsp;&nbsp;&nbsp; // Red<br>
&nbsp;&nbsp;&nbsp;&nbsp;pixels[i + 1] = gray; // Green<br>
&nbsp;&nbsp;&nbsp;&nbsp;pixels[i + 2] = gray; // Blue<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Alpha channel (pixels[i + 3]) remains unchanged<br>
&nbsp;&nbsp;}<br>
}
</div>

<h3>Node.js Code to Use the WebAssembly Module</h3>
<div class="w3-code notranslate jsHigh">
const fs = require('fs');<br>
const wasmBuffer = fs.readFileSync('./image_processing.wasm');<br>
<br>
// Sample image data (RGBA format, 2x2 pixel image)<br>
const imageData = new Uint8Array([<br>
&nbsp;&nbsp;255, 0, 0, 255,&nbsp;&nbsp;&nbsp;&nbsp;// Red pixel<br>
&nbsp;&nbsp;0, 255, 0, 255,&nbsp;&nbsp;&nbsp;&nbsp;// Green pixel<br>
&nbsp;&nbsp;0, 0, 255, 255,&nbsp;&nbsp;&nbsp;&nbsp;// Blue pixel<br>
&nbsp;&nbsp;255, 255, 0, 255&nbsp;&nbsp; // Yellow pixel<br>
]);<br>
<br>
// Instantiate the WebAssembly module<br>
WebAssembly.instantiate(wasmBuffer, {<br>
&nbsp;&nbsp;env: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;memory: new WebAssembly.Memory({ initial: 1 })<br>
&nbsp;&nbsp;}<br>
}).then(result => {<br>
&nbsp;&nbsp;const instance = result.instance;<br>
&nbsp;&nbsp;const { grayscale_wasm } = instance.exports;<br>
&nbsp;&nbsp;const memory = instance.exports.memory;<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Get a view of the WebAssembly memory<br>
&nbsp;&nbsp;const wasmMemory = new Uint8Array(memory.buffer);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Copy image data to WebAssembly memory<br>
&nbsp;&nbsp;wasmMemory.set(imageData);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Process the image (convert to grayscale)<br>
&nbsp;&nbsp;grayscale_wasm(0, imageData.length);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Get processed image data from WebAssembly memory<br>
&nbsp;&nbsp;const processedData = wasmMemory.slice(0, imageData.length);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;console.log('Original image:', imageData);<br>
&nbsp;&nbsp;console.log('Grayscale image:', processedData);<br>
});<br>
// Write data to memory<br>
bytes[0] = 123;<br>
<br>
console.log(bytes[0]); // Output: 123<br>
<br>
// Grow the memory by 1 page (to 128KB total)<br>
memory.grow(1);<br>
<br>
...
<h2 id="integration">Integration with JavaScript</h2>
<p>WebAssembly and JavaScript can work together seamlessly in Node.js:</p>

<div class="w3-example">
<h3>Example: JavaScript and WebAssembly Integration</h3>
<div class="w3-code notranslate jsHigh">
const fs = require('fs');<br>
const wasmBuffer = fs.readFileSync('./math.wasm');<br>
<br>
// JavaScript function that will use WebAssembly<br>
async function calculateFactorial(n) {<br>
&nbsp;&nbsp;// Instantiate the module<br>
&nbsp;&nbsp;const result = await WebAssembly.instantiate(wasmBuffer);<br>
&nbsp;&nbsp;const wasm = result.instance.exports;<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Use the WebAssembly factorial function<br>
&nbsp;&nbsp;return wasm.factorial(n);<br>
}<br>
<br>
// Use our mixed JS/WebAssembly function<br>
async function main() {<br>
&nbsp;&nbsp;console.log('Calculating factorials:');<br>
&nbsp;&nbsp;for (let i = 1; i &lt;= 10; i++) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const result = await calculateFactorial(i);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`${i}! = ${result}`);<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
...
<div class="w3-panel ws-info">
  <p><strong>Best Practice:</strong> Use WebAssembly for performance-critical parts of your application while keeping the application logic in JavaScript for better developer experience.</p>
</div>
<hr>

<h2>Summary</h2>
<p>WebAssembly extends Node.js capabilities by allowing you to:</p>
<ul>
  <li>Run code compiled from languages like C, C++, and Rust</li>
  <li>Achieve near-native performance for computationally intensive tasks</li>
  <li>Reuse existing codebases and libraries from other languages</li>
  <li>Share code between browser and server environments</li>
</ul>
<p>This makes Node.js a more versatile platform for a wider range of applications, especially those requiring high performance.</p>
<hr>

<div id="exercisecontainer" src="xrcise_webassembly.js" data-extensions="asp"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_microservices.asp">&#10094; Previous</a>
