...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Worker Reference</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js Worker Reference">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/ref_worker.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="The Worker class in the cluster module creates child processes that run at the same time and share server ports.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Worker Reference">
<meta name="twitter:description" content="The Worker class in the cluster module creates child processes that run at the same time and share server ports.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/ref_worker.png">
...
<h1>Node.js Worker Reference</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="ref_eventemitter.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ref_cipher.asp">Next &#10095;</a>
</div>
...
<p>The Worker class is part of the Node.js <code class="w3-codespan">cluster</code> module, which enables the creation of child processes (workers) that run simultaneously and share server ports. This is particularly useful for taking advantage of multi-core systems to handle load.</p>

<h3>Import Worker</h3>
<p>Worker objects are created automatically when using the cluster module:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// Workers are created via the cluster module<br>
const cluster = require('cluster');<br>
<br>
// To access a Worker object<br>
if (cluster.isPrimary) {<br>
&nbsp;&nbsp;// Fork workers<br>
&nbsp;&nbsp;const worker = cluster.fork();<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Now 'worker' is a Worker object<br>
}</div>
</div>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td>worker.id</td>
    <td>Each worker is assigned a unique id.</td>
  </tr>
  <tr>
    <td>worker.process</td>
    <td>All workers are created using <code class="w3-codespan">child_process.fork()</code>, and this property contains the result of that call.</td>
  </tr>
  <tr>
    <td>worker.exitedAfterDisconnect</td>
    <td>This property is <code class="w3-codespan">true</code> if the worker exited due to <code class="w3-codespan">.kill()</code> or <code class="w3-codespan">.disconnect()</code>, otherwise it's <code class="w3-codespan">undefined</code>.</td>
  </tr>
  <tr>
    <td>worker.isConnected()</td>
    <td>Returns <code class="w3-codespan">true</code> if the worker is connected to its primary, otherwise <code class="w3-codespan">false</code>.</td>
  </tr>
  <tr>
    <td>worker.isDead()</td>
    <td>Returns <code class="w3-codespan">true</code> if the worker's process is terminated (by signal or exit code), otherwise <code class="w3-codespan">false</code>.</td>
  </tr>
</table>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    ...
    <td>In a worker, this function closes all servers, waits for the 'close' event on those servers, and then disconnects the IPC channel.<br><br>In the primary, an internal message is sent to the worker causing it to call <code class="w3-codespan">.disconnect()</code> on itself.</td>
  </tr>
  <tr>
    <td>worker.kill([signal='SIGTERM'])</td>
    <td>Kills the worker process. This function is the same as <code class="w3-codespan">worker.process.kill()</code>. The optional <code class="w3-codespan">signal</code> parameter specifies what signal to send to the worker.</td>
  </tr>
  <tr>
    <td>worker.send(message[, sendHandle[, options]][, callback])</td>
    <td>Sends a message to the worker that is received as a 'message' event. Uses <code class="w3-codespan">child_process.send()</code> internally.</td>
  </tr>
</table>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td>'disconnect'</td>
    <td>Emitted after a worker IPC channel has disconnected. This occurs when a worker exits gracefully, is killed, or is disconnected manually (using <code class="w3-codespan">worker.disconnect()</code>).</td>
  </tr>
  <tr>
    <td>'error'</td>
    <td>Emitted if the worker thread throws an uncaught exception.</td>
  </tr>
  <tr>
    <td>'exit'</td>
    <td>Emitted when the worker process terminates. Listener receives arguments <code class="w3-codespan">(code, signal)</code> where <code class="w3-codespan">code</code> is the exit code and <code class="w3-codespan">signal</code> is the name of the signal that caused the process to terminate.</td>
  </tr>
  <tr>
    <td>'listening'</td>
    <td>Emitted when a server within a worker starts listening for connections. Listener receives arguments <code class="w3-codespan">(address)</code> with information about the address being used.</td>
  </tr>
  <tr>
    <td>'message'</td>
    <td>Emitted when a worker receives a message. Listener receives arguments <code class="w3-codespan">(message, handle)</code> where <code class="w3-codespan">message</code> is the sent message and <code class="w3-codespan">handle</code> is a net.Socket or net.Server object or undefined.</td>
  </tr>
  <tr>
    <td>'online'</td>
    <td>Emitted when the worker process is forked and ready to receive messages.</td>
  </tr>
</table>

<hr>

<h2>Basic Cluster Example</h2>

<p>Here's a basic example of using cluster with Worker objects to create a multi-process HTTP server:</p>
...
<br>
if (cluster.isPrimary) {<br>
&nbsp;&nbsp;console.log(`Primary ${process.pid} is running`);<br>
<br>
&nbsp;&nbsp;// Fork workers<br>
...
&nbsp;&nbsp;}<br>
<br>
&nbsp;&nbsp;// Listen for dying workers<br>
&nbsp;&nbsp;cluster.on('exit', (worker, code, signal) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Worker ${worker.process.pid} died with code: ${code} and signal: ${signal}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Starting a new worker');<br>
&nbsp;&nbsp;&nbsp;&nbsp;cluster.fork();<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Event handlers for Worker objects<br>
&nbsp;&nbsp;cluster.on('fork', (worker) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Worker ${worker.id} (PID: ${worker.process.pid}) has been forked`);<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;cluster.on('online', (worker) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Worker ${worker.id} is online`);<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;cluster.on('listening', (worker, address) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Worker ${worker.id} is listening on ${address.address}:${address.port}`);<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;cluster.on('disconnect', (worker) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Worker ${worker.id} has disconnected`);<br>
&nbsp;&nbsp;});<br>
<br>
} else {<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_worker_basic">Run example &raquo;</a>
</div>
...
<p>You can send messages between the primary process and worker processes:</p>
...
<br>
if (cluster.isPrimary) {<br>
&nbsp;&nbsp;// Keep track of http requests<br>
&nbsp;&nbsp;let numRequests = 0;<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Create two workers<br>
&nbsp;&nbsp;const worker1 = cluster.fork();<br>
&nbsp;&nbsp;const worker2 = cluster.fork();<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Count requests<br>
&nbsp;&nbsp;function messageHandler(msg) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (msg.cmd && msg.cmd === 'notifyRequest') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;numRequests += 1;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Total requests: ${numRequests}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Listen for messages from workers<br>
&nbsp;&nbsp;worker1.on('message', messageHandler);<br>
&nbsp;&nbsp;worker2.on('message', messageHandler);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Send periodic messages to workers<br>
&nbsp;&nbsp;setInterval(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Send a message to both workers<br>
&nbsp;&nbsp;&nbsp;&nbsp;worker1.send({ cmd: 'updateTime', time: Date.now() });<br>
&nbsp;&nbsp;&nbsp;&nbsp;worker2.send({ cmd: 'updateTime', time: Date.now() });<br>
&nbsp;&nbsp;}, 5000);<br>
<br>
} else {<br>
&nbsp;&nbsp;// Worker process<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Track the last update time<br>
&nbsp;&nbsp;let lastUpdate = Date.now();<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Receive messages from the primary<br>
&nbsp;&nbsp;process.on('message', (msg) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (msg.cmd && msg.cmd === 'updateTime') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;lastUpdate = msg.time;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Worker ${process.pid} received time update: ${new Date(lastUpdate)}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Create an HTTP server<br>
&nbsp;&nbsp;http.createServer((req, res) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Notify the primary about the request<br>
&nbsp;&nbsp;&nbsp;&nbsp;process.send({ cmd: 'notifyRequest' });<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_worker_communication">Run example &raquo;</a>
</div>
...
<p>Handling graceful shutdown of workers is important for production applications:</p>
...
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Graceful shutdown function<br>
&nbsp;&nbsp;const shutdown = () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Primary: starting graceful shutdown...');<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Disconnect all workers<br>
&nbsp;&nbsp;&nbsp;&nbsp;for (const worker of workers) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Disconnecting worker ${worker.id}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;worker.disconnect();<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Exit after a timeout if workers haven't exited<br>
&nbsp;&nbsp;&nbsp;&nbsp;setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Primary: some workers did not exit, forcing shutdown');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;process.exit(1);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}, 5000);<br>
&nbsp;&nbsp;};<br>
<br>
...
&nbsp;&nbsp;cluster.on('exit', (worker, code, signal) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Worker ${worker.process.pid} died (${signal || code}). ` +<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`exitedAfterDisconnect: ${worker.exitedAfterDisconnect}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// If it's a planned disconnect, don't restart<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (!worker.exitedAfterDisconnect) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Worker died unexpectedly, replacing it...');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;workers.push(cluster.fork());<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Check if all workers are gone<br>
&nbsp;&nbsp;&nbsp;&nbsp;let activeWorkers = 0;<br>
&nbsp;&nbsp;&nbsp;&nbsp;for (const id in cluster.workers) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;activeWorkers++;<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Active workers: ${activeWorkers}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (activeWorkers === 0) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('All workers have exited, shutting down primary');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;process.exit(0);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;});<br>
<br>
&nbsp;&nbsp;// Handle signals for graceful shutdown<br>
&nbsp;&nbsp;process.on('SIGTERM', shutdown);<br>
...
&nbsp;&nbsp;console.log(`Worker ${process.pid} started`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Handle disconnect signal from primary<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Forcefully exit after timeout<br>
&nbsp;&nbsp;&nbsp;&nbsp;setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Worker ${process.pid} timed out closing server, forcing exit`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;process.exit(1);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}, 2000);<br>
&nbsp;&nbsp;});<br>
}</div>
...
<h2>Worker Zero-Downtime Restart</h2>

<p>Implementing a zero-downtime restart pattern for rolling worker updates:</p>
...
&nbsp;&nbsp;}<br>
<br>
&nbsp;&nbsp;// Store worker refs<br>
&nbsp;&nbsp;let workers = Object.values(cluster.workers);<br>
<br>
&nbsp;&nbsp;// Restart one worker at a time<br>
&nbsp;&nbsp;function restartWorker(workerIndex) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const worker = workers[workerIndex];<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Restarting worker #${worker.id}`);<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Create a new worker<br>
&nbsp;&nbsp;&nbsp;&nbsp;const newWorker = cluster.fork();<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Add the new worker to our array<br>
&nbsp;&nbsp;&nbsp;&nbsp;workers.push(newWorker);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// When the new worker is online, disconnect the old worker<br>
&nbsp;&nbsp;&nbsp;&nbsp;newWorker.on('online', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (worker) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`New worker #${newWorker.id} is online, disconnecting old worker #${worker.id}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;worker.disconnect();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;// When the old worker is disconnected, remove it from the array<br>
&nbsp;&nbsp;&nbsp;&nbsp;worker.on('disconnect', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Worker #${worker.id} disconnected`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;workers = workers.filter(w => w.id !== worker.id);<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Continue the process if there are more workers to restart<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (workerIndex + 1 &lt; workers.length) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;restartWorker(workerIndex + 1);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}, 5000);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>
<br>
&nbsp;&nbsp;// Example: trigger a rolling restart after 15 seconds<br>
&nbsp;&nbsp;setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Starting rolling restart of workers...');<br>
&nbsp;&nbsp;&nbsp;&nbsp;restartWorker(0);<br>
&nbsp;&nbsp;}, 15000);<br>
<br>
&nbsp;&nbsp;// Additional event handlers<br>
&nbsp;&nbsp;cluster.on('exit', (worker, code, signal) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Worker ${worker.process.pid} exited with code ${code}`);<br>
&nbsp;&nbsp;});<br>
<br>
} else {<br>
&nbsp;&nbsp;// Worker process<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_worker_zero_downtime">Run example &raquo;</a>
</div>

<hr>

<h2>Worker Status Monitoring</h2>

<p>Monitoring worker status and collecting metrics:</p>
...
&nbsp;&nbsp;}<br>
<br>
&nbsp;&nbsp;// Store metrics for each worker<br>
&nbsp;&nbsp;const workerMetrics = {};<br>
<br>
&nbsp;&nbsp;// Set up metrics collection<br>
&nbsp;&nbsp;for (const worker of workers) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;workerMetrics[worker.id] = {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;id: worker.id,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;pid: worker.process.pid,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;requests: 0,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;errors: 0,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;lastActive: Date.now(),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;memoryUsage: {}<br>
&nbsp;&nbsp;&nbsp;&nbsp;};<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Handle messages from workers<br>
&nbsp;&nbsp;&nbsp;&nbsp;worker.on('message', (msg) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (msg.type === 'metrics') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Update metrics<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;workerMetrics[worker.id] = {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;...workerMetrics[worker.id],<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;...msg.data,<br>
...
&nbsp;&nbsp;}).listen(8001);<br>
<br>
&nbsp;&nbsp;console.log('Primary: Monitoring server running on port 8001');<br>
<br>
&nbsp;&nbsp;// Check for unresponsive workers<br>
&nbsp;&nbsp;setInterval(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const now = Date.now();<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;for (const worker of workers) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const metrics = workerMetrics[worker.id];<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// If worker hasn't reported in 30 seconds<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (now - metrics.lastActive > 80800) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.warn(`Worker ${worker.id} appears unresponsive, restarting...`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Kill the unresponsive worker<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;worker.kill();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Fork a replacement<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const newWorker = cluster.fork();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Set up metrics for new worker<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;workerMetrics[newWorker.id] = {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;id: newWorker.id,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;pid: newWorker.process.pid,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;requests: 0,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;errors: 0,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;lastActive: Date.now(),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;memoryUsage: {}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;};<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Replace in workers array<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const index = workers.indexOf(worker);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (index !== -1) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;workers[index] = newWorker;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Clean up old metrics<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;delete workerMetrics[worker.id];<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}, 10000);<br>
<br>
...
&nbsp;&nbsp;let errorCount = 0;<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Report metrics to primary every 5 seconds<br>
&nbsp;&nbsp;setInterval(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;process.send({<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;type: 'metrics',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;data: {<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;memoryUsage: process.memoryUsage()<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;}, 5000);<br>
<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;} catch (error) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;errorCount++;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error(`Worker ${process.pid} error:`, error);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}).listen(8000);<br>
}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_worker_monitoring">Run example &raquo;</a>
</div>

<hr>

<h2>Worker Best Practices</h2>

<h3>1. Ensure State Isolation</h3>
<p>Keep worker processes stateless or ensure proper state management:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// BAD - State shared across forked processes won't work as expected<br>
let requestCount = 0;<br>
<br>
// GOOD - Each worker has its own isolated state<br>
if (cluster.isPrimary) {<br>
&nbsp;&nbsp;// Primary logic<br>
} else {<br>
&nbsp;&nbsp;// Worker-specific state<br>
&nbsp;&nbsp;let workerRequestCount = 0;<br>
}</div>
</div>

<h3>2. Handle Unexpected Worker Termination</h3>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
if (cluster.isPrimary) {<br>
&nbsp;&nbsp;cluster.on('exit', (worker, code, signal) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (code !== 0 && !worker.exitedAfterDisconnect) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Worker ${worker.id} crashed. Restarting...`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;cluster.fork();<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;});<br>
}</div>
...
<h3>3. Use Worker Sticky Sessions</h3>
...
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Create routes based on connection's remote IP<br>
&nbsp;&nbsp;cluster.on('connection', (connection, address) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Calculate which worker gets connection based on IP<br>
&nbsp;&nbsp;&nbsp;&nbsp;const worker = Object.values(cluster.workers)[<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Number(address.toString().split(':')[3]) % Object.keys(cluster.workers).length<br>
&nbsp;&nbsp;&nbsp;&nbsp;];<br>
&nbsp;&nbsp;&nbsp;&nbsp;worker.send('sticky-session:connection', connection);<br>
&nbsp;&nbsp;});<br>
} else {<br>
&nbsp;&nbsp;// Worker code<br>
&nbsp;&nbsp;http.createServer((req, res) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.end(`Handled by worker ${process.pid}`);<br>
&nbsp;&nbsp;}).listen(8000, () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Worker ${process.pid} listening`);<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Receive sticky connections<br>
&nbsp;&nbsp;process.on('message', (message, connection) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (message !== 'sticky-session:connection') return;<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Emulate a connection event on the server<br>
&nbsp;&nbsp;&nbsp;&nbsp;server.emit('connection', connection);<br>
&nbsp;&nbsp;&nbsp;&nbsp;connection.resume();<br>
&nbsp;&nbsp;});<br>
}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_worker_sticky">Run example &raquo;</a>
</div>
