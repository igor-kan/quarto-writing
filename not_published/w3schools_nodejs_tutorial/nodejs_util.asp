...
<meta name="title" property="og:title" content="Node.js Util Module">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_util.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="The Util module is a core Node.js module that provides a collection of utility functions for common tasks.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Util Module">
<meta name="twitter:description" content="The Util module is a core Node.js module that provides a collection of utility functions for common tasks.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_util.png">
...
<h1>Node.js Util Module</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_assert.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="nodejs_readline.asp">Next &#10095;</a>
</div>
<hr>
<h2>What is the Util Module?</h2>

<p>The Util module is a core Node.js module that provides a collection of utility functions for common tasks.</p>
<p>It's like a Swiss Army knife for Node.js developers, offering solutions for:</p>

<div class="w3-row-padding">
  <div class="w3-half">
    <div class="w3-panel w3-light-grey w3-padding w3-round">
      <h4>Common Use Cases</h4>
      <ul>
        <li>Formatting strings with placeholders</li>
        <li>Inspecting objects for debugging</li>
        <li>Converting between callbacks and Promises</li>
        <li>Type checking and validation</li>
        <li>Handling deprecation warnings</li>
  ...
  <div class="w3-half">
    <div class="w3-panel w3-light-grey w3-padding w3-round">
      ...
      <ul>
        ...
        <li>Performance-optimized utilities</li>
        <li>Consistent with Node.js core</li>
        <li>Great for debugging and development</li>
        <li>Useful for production code</li>
      </ul>
    </div>
  </div>
</div>
...
<p><strong>Note:</strong> While some functions in the Util module are designed for internal use by Node.js itself, many are valuable tools for developers building Node.js applications.</p>
<p>The module is included with Node.js, so no installation is required.</p>
</div>

<hr>

<h2>Getting Started with Util</h2>

<p>Here's a practical example that demonstrates several utilities from the Util module in action:</p>

<div class="w3-example">
<h3>Basic Usage Example</h3>
<div class="w3-code notranslate jsHigh">const util = require('util');<br>
const fs = require('fs');<br>
<br>
// Convert callback-based fs.readFile to Promise-based<br>
const readFile = util.promisify(fs.readFile);<br>
// Format strings with placeholders<br>
const greeting = util.format('Hello, %s! Today is %s', 'Developer', new Date().toDateString());<br>
console.log(greeting);<br>
// Inspect an object with custom options<br>
const obj = {<br>
&nbsp;&nbsp;name: 'Test',<br>
&nbsp;&nbsp;nested: { a: 1, b: [2, 3] },<br>
&nbsp;&nbsp;fn: function() { return 'test'; }<br>
};<br>
console.log(util.inspect(obj, { colors: true, depth: 2 }));<br>
// Use debug logging<br>
const debug = util.debuglog('app');<br>
debug('This will only show if NODE_DEBUG=app');<br>
// Example of using promisify with async/await<br>
async function readConfig() {<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const data = await readFile('package.json', 'utf8');<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Package name:', JSON.parse(data).name);<br>
&nbsp;&nbsp;} catch (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error('Error reading config:', err);<br>
&nbsp;&nbsp;}<br>
}<br>
readConfig();</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_util_quickstart">Run Example &raquo;</a>
</div>
...
<p>The Util module can be imported in several ways depending on your module system and needs:</p>

<div class="w3-example">
<h3>CommonJS (Node.js default)</h3>
<div class="w3-code notranslate jsHigh">// Import the entire module<br>
const util = require('util');<br>
<br>
// Import specific functions using destructuring<br>
const { promisify, inspect, format } = require('util');<br>
<br>
// Using strict mode (recommended)<br>
const assert = require('assert').strict;<br>
<br>
// For TypeScript users<br>
// import * as util from 'util';<br>
// import { promisify, inspect } from 'util';</div>
</div>

<div class="w3-example">
<h3>ES Modules (Node.js 12+)</h3>
<div class="w3-code notranslate jsHigh">// Default import<br>
import util from 'util';<br>
<br>
// Named imports<br>
import { promisify, inspect } from 'util';<br>
<br>
// Rename imports<br>
import { promisify as pify } from 'util';<br>
<br>
// Dynamic import (Node.js 14+)<br>
const { promisify } = await import('util');<br>
<br>
// Using with TypeScript types<br>
// import * as util from 'util';<br>
// import type { InspectOptions } from 'util';</div>
</div>

<div class="w3-panel ws-note">
<p><strong>Best Practice:</strong> For better tree-shaking and smaller bundles, prefer destructuring imports of only the functions you need.</p>
<p>The Util module is quite large, and you typically only use a small subset of its functionality.</p>
</div>

<hr>

<h2>String Formatting and Inspection</h2>

<p>The Util module provides powerful tools for formatting strings and inspecting objects, which are particularly useful for logging and debugging.</p>

<h3>util.format(format[, ...args])</h3>
<p>Returns a formatted string using the first argument as a printf-like format string.</p>
<p>This is similar to <code class="w3-codespan">console.log()</code> but returns the formatted string instead of printing it.</p>

<div class="w3-panel ws-note">
<p><strong>Format Specifiers:</strong></p>
<ul>
  <li><code class="w3-codespan">%s</code> - String</li>
  <li><code class="w3-codespan">%d</code> - Number (both integer and float)</li>
  <li><code class="w3-codespan">%i</code> - Integer</li>
  <li><code class="w3-codespan">%f</code> - Floating point value</li>
  <li><code class="w3-codespan">%j</code> - JSON (replaced with <code class="w3-codespan">'[Circular]'</code> if the argument contains circular references)</li>
  <li><code class="w3-codespan">%o</code> - Object (inspect the object)</li>
  <li><code class="w3-codespan">%O</code> - Object (inspect the object, with full detail)</li>
  <li><code class="w3-codespan">%%</code> - Single percent sign ('%')</li>
</ul>
</div>
...
<br>
// Basic formatting<br>
const formatted = util.format('Hello, %s!', 'World');<br>
console.log(formatted); // 'Hello, World!'<br>
<br>
// Multiple placeholders<br>
const multiFormatted = util.format(<br>
&nbsp;&nbsp;'My name is %s. I am %d years old and I love %s.',<br>
&nbsp;&nbsp;'Kai',<br>
&nbsp;&nbsp;30,<br>
&nbsp;&nbsp;'Node.js'<br>
);<br>
console.log(multiFormatted);<br>
// 'My name is Kai. I am 30 years old and I love Node.js.'<br>
<br>
// Available specifiers<br>
const specifiers = util.format(<br>
&nbsp;&nbsp;'String: %s, Number: %d, JSON: %j, Character: %c',<br>
&nbsp;&nbsp;'hello',<br>
&nbsp;&nbsp;42,<br>
&nbsp;&nbsp;{ name: 'Object' },<br>
&nbsp;&nbsp;65&nbsp;&nbsp;// ASCII code for 'A'<br>
);<br>
console.log(specifiers);<br>
<br>
// Extra arguments are concatenated with spaces<br>
const extra = util.format('Hello', 'World', 'from', 'Node.js');<br>
console.log(extra); // 'Hello World from Node.js'</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_util_format">Try it Yourself &raquo;</a>
</div>

<h3>util.inspect(object[, options])</h3>
<p>Returns a string representation of an object, useful for debugging.</p>
<p>This is what Node.js uses internally for printing objects to the console.</p>

<div class="w3-panel ws-note">
<p><strong>Common Use Cases:</strong></p>
<ul>
  <li>Debugging complex objects</li>
  <li>Creating human-readable object representations</li>
  <li>Logging objects with circular references</li>
  <li>Customizing object display in logs</li>
</ul>
</div>
...
<ul>
  <li><code class="w3-codespan">showHidden</code> - Show non-enumerable properties (default: false)</li>
  <li><code class="w3-codespan">depth</code> - Number of levels to recurse (default: 2, null for unlimited)</li>
  <li><code class="w3-codespan">colors</code> - Add ANSI color codes (default: false)</li>
  <li><code class="w3-codespan">customInspect</code> - Use custom inspect functions (default: true)</li>
  <li><code class="w3-codespan">showProxy</code> - Show Proxy details (default: false)</li>
  <li><code class="w3-codespan">maxArrayLength</code> - Maximum number of array elements to include (default: 100)</li>
  <li><code class="w3-codespan">breakLength</code> - Length at which to break object keys (default: 60)</li>
  <li><code class="w3-codespan">compact</code> - Break properties onto new lines (default: true for arrays, false for objects)</li>
  <li><code class="w3-codespan">sorted</code> - Sort properties (default: false, true for alphabetical, function for custom sort)</li>
</ul>
</div>
...
<br>
// Default inspection<br>
console.log(util.inspect(obj));<br>
<br>
// Custom options<br>
console.log(util.inspect(obj, {<br>
&nbsp;&nbsp;colors: true,        // Add ANSI color codes<br>
&nbsp;&nbsp;depth: 0,            // Only inspect the first level<br>
&nbsp;&nbsp;showHidden: true,    // Show non-enumerable properties<br>
&nbsp;&nbsp;compact: false,      // Don't format objects on a single line<br>
&nbsp;&nbsp;showProxy: true,     // Show proxy details<br>
&nbsp;&nbsp;maxArrayLength: 3,   // Limit array elements displayed<br>
&nbsp;&nbsp;breakLength: 50,     // Line break after 50 characters<br>
&nbsp;&nbsp;sorted: true         // Sort object properties alphabetically<br>
}));<br>
<br>
// Circular references<br>
const circular = { name: 'Circular' };<br>
circular.self = circular;<br>
console.log(util.inspect(circular));</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_util_inspect">Try it Yourself &raquo;</a>
</div>

<h3>util.inspect.custom</h3>
<p>Symbol used to customize object inspection.</p>
<p>This allows objects to define their own string representation when inspected.</p>

<div class="w3-panel ws-note">
<p><strong>Best Practices:</strong></p>
<ul>
  <li>Use <code class="w3-codespan">util.inspect.custom</code> for custom inspection rather than <code class="w3-codespan">inspect()</code> method for better compatibility</li>
  <li>Keep the custom inspection output concise and informative</li>
  <li>Include important object state in the output</li>
  <li>Consider performance for frequently inspected objects</li>
  <li>Handle circular references to prevent infinite recursion</li>
</ul>
</div>
...
const util = require('util');<br>
<br>
// Class with custom inspection<br>
class Person {<br>
&nbsp;&nbsp;constructor(name, age) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.name = name;<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.age = age;<br>
&nbsp;&nbsp;&nbsp;&nbsp;this._private = 'hidden information';<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Custom inspect method<br>
&nbsp;&nbsp;[util.inspect.custom](depth, options) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;return `Person(${this.name}, ${this.age})`;<br>
&nbsp;&nbsp;}<br>
}<br>
const kai = new Person('Kai', 30);<br>
<br>
// Custom inspection is used<br>
console.log(util.inspect(kai));  // Person(Kai, 30)<br>
<br>
// Directly using console.log also uses custom inspection<br>
console.log(kai);  // Person(Kai, 30)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_util_inspect_custom">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Promises and Async Utilities</h2>

<p>Node.js's Util module provides several utilities for working with asynchronous code, making it easier to work with both callback-based and Promise-based APIs.</p>

<h3>util.promisify(original)</h3>
<p>Converts a callback-based function following the Node.js callback pattern to a function that returns a Promise.</p>
<p>This is useful for working with older Node.js APIs that use callbacks.</p>

<div class="w3-panel ws-note">
<p><strong>When to use <code class="w3-codespan">util.promisify</code>:</strong></p>
<ul>
  <li>Working with older Node.js APIs that use callbacks</li>
  <li>Converting callback-based libraries to use Promises</li>
  <li>Simplifying async/await code by removing callbacks</li>
  <li>Working with functions that follow the Node.js callback pattern (error-first, single result)</li>
</ul>
</div>
...
<ul>
  <li>Only works with functions that follow the Node.js callback pattern: <code class="w3-codespan">(err, value) => {}</code></li>
  <li>Doesn't work with functions that return multiple values in the callback</li>
  <li>Custom promisification may be needed for more complex APIs</li>
</ul>
</div>
...
const fs = require('fs');<br>
<br>
// Convert fs.readFile from callback-based to Promise-based<br>
const readFilePromise = util.promisify(fs.readFile);<br>
<br>
// Now we can use it with async/await or Promise chaining<br>
async function readFileExample() {<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Using the promisified function<br>
&nbsp;&nbsp;&nbsp;&nbsp;const data = await readFilePromise('package.json', 'utf8');<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('File content:', data.substring(0, 100) + '...');<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Error handling with try/catch<br>
&nbsp;&nbsp;&nbsp;&nbsp;return 'File read successfully';<br>
&nbsp;&nbsp;} catch (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error('Error reading file:', err.message);<br>
&nbsp;&nbsp;&nbsp;&nbsp;return 'Error reading file';<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
readFileExample().then(result => {<br>
&nbsp;&nbsp;console.log('Result:', result);<br>
});</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_util_promisify">Run example &raquo;</a>
</div>

<h3>util.callbackify(original)</h3>
<p>Converts a function that returns a Promise to a function that follows the Node.js callback pattern.</p>
<p>This is useful for working with older Node.js APIs that expect callback functions.</p>

<div class="w3-panel ws-note">
<p><strong>When to use <code class="w3-codespan">util.callbackify</code>:</strong></p>
<ul>
  <li>Integrating Promise-based code with callback-based APIs</li>
  <li>Maintaining backward compatibility in libraries</li>
  <li>Working with APIs that expect Node.js-style callbacks</li>
  <li>Gradually migrating from callbacks to Promises</li>
</ul>
</div>
...
<p><strong>Best Practices:</strong></p>
<ul>
  <li>Prefer using Promises directly when possible</li>
  <li>Document that the function uses callbacks in its JSDoc</li>
  <li>Consider providing both Promise and callback interfaces in your APIs</li>
  <li>Handle Promise rejections properly in the callback</li>
</ul>
</div>
...
const util = require('util');<br>
<br>
// A Promise-based function<br>
async function fetchUserData(id) {<br>
&nbsp;&nbsp;if (!id) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;throw new Error('ID is required');<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Simulate API request<br>
&nbsp;&nbsp;return {<br>
&nbsp;&nbsp;&nbsp;&nbsp;id,<br>
&nbsp;&nbsp;&nbsp;&nbsp;name: `User ${id}`,<br>
...
<br>
// Convert to callback-based<br>
const fetchUserDataCallback = util.callbackify(fetchUserData);<br>
<br>
// Using the callback-based function<br>
fetchUserDataCallback(1, (err, user) => {<br>
&nbsp;&nbsp;if (err) {<br>
...
<br>
// Error handling<br>
fetchUserDataCallback(null, (err, user) => {<br>
&nbsp;&nbsp;if (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error('Error occurred:', err.message);<br>
&nbsp;&nbsp;&nbsp;&nbsp;return;<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;console.log('User data:', user); // This won't execute<br>
});</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_util_callbackify">Run example &raquo;</a>
</div>

<h3>util.promisify.custom</h3>
<p>Symbol to customize promisification behavior. This allows you to provide a custom implementation when a function is promisified.</p>

<div class="w3-panel ws-note">
<p><strong>Use cases for custom promisification:</strong></p>
<ul>
  <li>Functions that don't follow the standard callback pattern</li>
  <li>APIs that return multiple values in the callback</li>
  <li>Custom error handling or transformation of results</li>
  <li>Optimizing performance for specific use cases</li>
  <li>Adding additional functionality during promisification</li>
</ul>
</div>
...
const util = require('util');<br>
<br>
// Function with custom promisification<br>
function doSomething(options, callback) {<br>
&nbsp;&nbsp;callback(null, 'regular result');<br>
}<br>
<br>
// Define custom promisification<br>
doSomething[util.promisify.custom] = (options) => {<br>
&nbsp;&nbsp;return Promise.resolve('custom promisified result');<br>
};<br>
<br>
// Use the custom promisification<br>
const promisified = util.promisify(doSomething);<br>
<br>
// Compare the results<br>
async function compareResults() {<br>
&nbsp;&nbsp;// Original function with callback<br>
&nbsp;&nbsp;doSomething({}, (err, result) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Callback result:', result);<br>
&nbsp;&nbsp;});<br>
<br>
&nbsp;&nbsp;// Custom promisified function<br>
&nbsp;&nbsp;const customResult = await promisified({});<br>
&nbsp;&nbsp;console.log('Promisified result:', customResult);<br>
}<br>
<br>
compareResults();</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_util_promisify_custom">Run example &raquo;</a>
</div>

<hr>

<h2>Type Checking Utilities</h2>

<p>The Util module provides comprehensive type checking utilities that are more reliable than JavaScript's <code class="w3-codespan">typeof</code> operator, especially for built-in objects and Node.js-specific types.</p>

<div class="w3-panel ws-note">
<p><strong>Why use <code class="w3-codespan">util.types</code>?</strong></p>
<ul>
  <li>More accurate than <code class="w3-codespan">typeof</code> for many built-in types</li>
  <li>Consistent behavior across Node.js versions</li>
  <li>Works with Node.js-specific types like <code class="w3-codespan">Buffer</code></li>
  <li>Better performance than manual type checking in many cases</li>
  <li>Handles edge cases properly (e.g., cross-realm objects)</li>
</ul>
</div>
...
&nbsp;&nbsp;new Date(),<br>
&nbsp;&nbsp;/regex/,<br>
&nbsp;&nbsp;Buffer.from('buffer'),<br>
&nbsp;&nbsp;new Error('error')<br>
];<br>
<br>
// Check types for each value<br>
values.forEach(value => {<br>
&nbsp;&nbsp;console.log(`Value: ${util.inspect(value)}`);<br>
&nbsp;&nbsp;console.log(`- isArray: ${util.types.isArrayBuffer(value)}`);<br>
&nbsp;&nbsp;console.log(`- isDate: ${util.types.isDate(value)}`);<br>
&nbsp;&nbsp;console.log(`- isRegExp: ${util.types.isRegExp(value)}`);<br>
&nbsp;&nbsp;console.log(`- isNativeError: ${util.types.isNativeError(value)}`);<br>
&nbsp;&nbsp;console.log(`- isPromise: ${util.types.isPromise(value)}`);<br>
&nbsp;&nbsp;console.log(`- isPrimitive: ${util.isPrimitive(value)}`);<br>
&nbsp;&nbsp;console.log(`- isString: ${util.isString(value)}`);<br>
&nbsp;&nbsp;console.log(`- isNumber: ${util.isNumber(value)}`);<br>
&nbsp;&nbsp;console.log(`- isBoolean: ${util.isBoolean(value)}`);<br>
&nbsp;&nbsp;console.log(`- isSymbol: ${util.types.isSymbol(value)}`);<br>
&nbsp;&nbsp;console.log(`- isNull: ${value === null}`);<br>
&nbsp;&nbsp;console.log(`- isUndefined: ${value === undefined}`);<br>
&nbsp;&nbsp;console.log(`- isFunction: ${util.types.isFunction(value)}`);<br>
&nbsp;&nbsp;console.log(`- isBuffer: ${Buffer.isBuffer(value)}`);<br>
&nbsp;&nbsp;console.log('---');<br>
});</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_util_types">Run example &raquo;</a>
</div>

<div class="w3-panel ws-note">
<p>Many of the type-checking functions in <code class="w3-codespan">util</code> are deprecated in favor of <code class="w3-codespan">util.types</code> or JavaScript's built-in type checking methods like <code class="w3-codespan">Array.isArray()</code>.</p>
</div>

<h3>util.types</h3>
<p>The <code class="w3-codespan">util.types</code> provides type checking functions for various JavaScript types and Node.js-specific objects:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const util = require('util');<br>
<br>
// JavaScript built-in types<br>
console.log('util.types.isDate(new Date()):', <br>
&nbsp;&nbsp;util.types.isDate(new Date()));<br>
console.log('util.types.isRegExp(/test/):', <br>
&nbsp;&nbsp;util.types.isRegExp(/test/));<br>
console.log('util.types.isPromise(Promise.resolve()):', <br>
&nbsp;&nbsp;util.types.isPromise(Promise.resolve()));<br>
<br>
// Node.js-specific types<br>
console.log('util.types.isArrayBuffer(new ArrayBuffer(0)):', <br>
&nbsp;&nbsp;util.types.isArrayBuffer(new ArrayBuffer(0)));<br>
console.log('util.types.isSharedArrayBuffer(new SharedArrayBuffer(0)):', <br>
&nbsp;&nbsp;util.types.isSharedArrayBuffer(new SharedArrayBuffer(0)));<br>
console.log('util.types.isUint8Array(new Uint8Array()):', <br>
&nbsp;&nbsp;util.types.isUint8Array(new Uint8Array()));<br>
<br>
// More advanced types<br>
console.log('util.types.isProxy(new Proxy({}, {})):', <br>
&nbsp;&nbsp;util.types.isProxy(new Proxy({}, {})));<br>
console.log('util.types.isExternal(Requiring C++ binding):', <br>
&nbsp;&nbsp;'Not demonstrated in this example');</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_util_types_specific">Run example &raquo;</a>
</div>

<hr>

<h2>Deprecation Utilities</h2>

<p>Node.js provides utilities to help manage API deprecations, making it easier to evolve your codebase while maintaining backward compatibility.</p>

<div class="w3-panel ws-note">
<p><strong>Deprecation Strategy:</strong></p>
<ol>
  <li>Mark deprecated functions with <code class="w3-codespan">util.deprecate()</code></li>
  <li>Provide clear migration instructions in the deprecation message</li>
  <li>Include a deprecation code for easier tracking</li>
  <li>Document the deprecation in your API docs</li>
  <li>Remove deprecated functionality in a future major version</li>
</ol>
</div>

<h3>util.deprecate(fn, msg[, code])</h3>
<p>Marks a function as deprecated, issuing a warning when it's called.</p>
...
function oldFunction(x, y) {<br>
&nbsp;&nbsp;return x + y;<br>
}<br>
<br>
// Deprecate the function<br>
const deprecatedFunction = util.deprecate(<br>
&nbsp;&nbsp;oldFunction,<br>
&nbsp;&nbsp;'oldFunction() is deprecated. Use newFunction() instead.',<br>
&nbsp;&nbsp;'DEP0001'<br>
);<br>
<br>
// New function<br>
function newFunction(x, y) {<br>
&nbsp;&nbsp;return x + y;<br>
}<br>
<br>
// Using the deprecated function will show a warning<br>
console.log('Result:', deprecatedFunction(5, 10));<br>
<br>
// Using the new function<br>
console.log('Result:', newFunction(5, 10));</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_util_deprecate">Run example &raquo;</a>
</div>

<h3>Managing Deprecation Warnings</h3>

<p>You can control the display of deprecation warnings using environment variables:</p>

<div class="w3-example">
<div class="w3-code notranslate">
# Show all deprecation warnings<br>
NODE_OPTIONS='--trace-deprecation'<br>
<br>
# Show only the first occurrence of each deprecation<br>
NODE_OPTIONS='--no-deprecation'<br>
<br>
# Silence all deprecation warnings<br>
NODE_OPTIONS='--no-warnings'<br>
<br>
# Turn deprecation warnings into exceptions<br>
NODE_OPTIONS='--throw-deprecation'</div>
</div>
...
<p>Node.js provides several utilities to aid in debugging and development, making it easier to diagnose issues and understand application behavior.</p>

<h3>util.debuglog(section)</h3>
<p>Creates a function that conditionally writes debug messages to <code class="w3-codespan">stderr</code> based on the <code class="w3-codespan">NODE_DEBUG</code> environment variable.</p>
<p>This is a lightweight alternative to full-featured logging libraries.</p>

<div class="w3-panel ws-note">
<p><strong>Best Practices for Debug Logging:</strong></p>
<ul>
  <li>Use descriptive section names that match your application's modules</li>
  <li>Include relevant context in debug messages</li>
  <li>Use string placeholders for better performance</li>
  <li>Keep debug messages concise but informative</li>
  <li>Consider the performance impact of computing values for debug messages</li>
</ul>
</div>

<div class="w3-panel ws-note">
<p><strong>Example Usage:</strong></p>
<div class="w3-code notranslate">// Enable debug logging for specific modules<br>
// NODE_DEBUG=app,db node your-app.js<br>
<br>
// In your application<br>
const debugApp = util.debuglog('app');<br>
const debugDB = util.debuglog('db');<br>
<br>
// These will only log when 'app' is in NODE_DEBUG<br>
debugApp('Application started with config: %j', config);<br>
<br>
// These will only log when 'db' is in NODE_DEBUG<br>
debugDB('Connected to database: %s', connectionString);<br>
<br>
// Enable all debug logs (not recommended in production)<br>
// NODE_DEBUG=* node your-app.js</div>
</div>
...
const util = require('util');<br>
<br>
// Create debug loggers for different sections<br>
const debugApp = util.debuglog('app');<br>
const debugDB = util.debuglog('db');<br>
const debugAuth = util.debuglog('auth');<br>
<br>
// These messages only appear when NODE_DEBUG includes 'app'<br>
debugApp('Application starting...');<br>
debugApp('Configuration loaded from %j', { source: 'config.json' });<br>
<br>
// These messages only appear when NODE_DEBUG includes 'db'<br>
debugDB('Connected to database');<br>
debugDB('Query executed: %s', 'SELECT * FROM users');<br>
<br>
// These messages only appear when NODE_DEBUG includes 'auth'<br>
debugAuth('User authenticated: %s', 'john.doe');<br>
<br>
// To see these messages, run your app with:<br>
// NODE_DEBUG=app,db node your-app.js<br>
console.log('Application running normally (this always shows)');</div>
</div>
<hr>

<div id="exercisecontainer" src="xrcise_util.js" data-extensions="asp"></div>
