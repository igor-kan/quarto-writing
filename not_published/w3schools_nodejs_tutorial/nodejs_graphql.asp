...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js GraphQL</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js GraphQL">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_graphql.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="GraphQL is a query language for APIs and a runtime for executing those queries against your data.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js GraphQL">
<meta name="twitter:description" content="GraphQL is a query language for APIs and a runtime for executing those queries against your data.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_graphql.png">
...
<h1>Node.js <span class="color_h1">GraphQL</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="nodejs_mongodb_join.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="nodejs_socketio.asp">Next &#10095;</a>
</div>
<hr>

<h2 id="intro">What is GraphQL?</h2>
<p>GraphQL is a query language for APIs and a runtime for executing those queries against your data. It was developed by Facebook in 2012 and publicly released in 2015.</p>

<h3>Key Features</h3>
<ul>
  <li><strong>Client-specified queries</strong>: Request exactly what you need, nothing more</li>
  <li><strong>Single endpoint</strong>: Access all resources through one endpoint</li>
  <li><strong>Strongly typed</strong>: Clear schema defines available data and operations</li>
  <li><strong>Hierarchical</strong>: Queries match the shape of your data</li>
  <li><strong>Self-documenting</strong>: Schema serves as documentation</li>
</ul>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> Unlike REST, GraphQL lets clients specify exactly what data they need, reducing over-fetching and under-fetching of data.</p>
</div>

<hr>

<h2 id="setup">Getting Started with GraphQL in Node.js</h2>

<h3>Prerequisites</h3>
<ul>
  <li>Node.js installed (v14 or later recommended)</li>
  <li>Basic knowledge of JavaScript and Node.js</li>
  <li>npm or yarn package manager</li>
</ul>

<hr>
<h3>Step 1: Set Up a New Project</h3>
<div class="w3-example">
  <p>Create a new directory and initialize a Node.js project:</p>
  <div class="w3-code notranslate">
    mkdir graphql-server<br>
    cd graphql-server<br>
    npm init -y
  </div>
</div>
...
<div class="w3-example">
  ...
  <p>This installs:</p>
  <ul>
    <li><code class="w3-codespan">express</code>: Web framework for Node.js</li>
    <li><code class="w3-codespan">express-graphql</code>: Middleware for creating a GraphQL HTTP server</li>
    <li><code class="w3-codespan">graphql</code>: The JavaScript reference implementation of GraphQL</li>
  </ul>
</div>
...
<hr>
<h3>Step 3: Create a Basic GraphQL Server</h3>

<h4>3.1 Define Your Data Model</h4>
<div class="w3-example">
  <p>Create a new file <code class="w3-codespan">server.js</code> and start by defining your data model using GraphQL's Schema Definition Language (SDL):</p>
  <div class="w3-code notranslate jsHigh">
    const express = require('express');<br>
    const { graphqlHTTP } = require('express-graphql');<br>
    const { buildSchema } = require('graphql');<br>
    <br>
    // Sample data<br>
    const books = [<br>
    &nbsp;&nbsp;{ <br>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;year: 1960,<br>
    &nbsp;&nbsp;&nbsp;&nbsp;genre: 'Southern Gothic'<br>
    &nbsp;&nbsp;}<br>
    ];</div>
</div>

<h4>3.2 Define the GraphQL Schema</h4>
<div class="w3-example">
<p>Add the schema definition to your <code class="w3-codespan">server.js</code> file:</p>
<div class="w3-code notranslate jsHigh">
// Define the schema using GraphQL schema language<br>
const schema = buildSchema(`<br>
&nbsp;&nbsp;# A book has a title, author, and publication year<br>
&nbsp;&nbsp;type Book {<br>
&nbsp;&nbsp;&nbsp;&nbsp;id: ID!<br>
&nbsp;&nbsp;&nbsp;&nbsp;title: String!<br>
&nbsp;&nbsp;&nbsp;&nbsp;author: String!<br>
...
&nbsp;&nbsp;}<br>
<br>
&nbsp;&nbsp;# The "Query" type is the root of all GraphQL queries<br>
&nbsp;&nbsp;type Query {<br>
&nbsp;&nbsp;&nbsp;&nbsp;# Get all books<br>
&nbsp;&nbsp;&nbsp;&nbsp;books: [Book!]!<br>
&nbsp;&nbsp;&nbsp;&nbsp;# Get a specific book by ID<br>
&nbsp;&nbsp;&nbsp;&nbsp;book(id: ID!): Book<br>
&nbsp;&nbsp;&nbsp;&nbsp;# Search books by title or author<br>
&nbsp;&nbsp;&nbsp;&nbsp;searchBooks(query: String!): [Book!]!<br>
&nbsp;&nbsp;}<br>
`);</div>
</div>

<h4>3.3 Implement Resolvers</h4>
<div class="w3-example">
<p>Add resolver functions to fetch the actual data:</p>
<div class="w3-code notranslate jsHigh">
// Define resolvers for the schema fields<br>
const root = {<br>
&nbsp;&nbsp;// Resolver for fetching all books<br>
&nbsp;&nbsp;books: () => books,<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Resolver for fetching a single book by ID<br>
&nbsp;&nbsp;book: ({ id }) => books.find(book => book.id === id),<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Resolver for searching books<br>
&nbsp;&nbsp;searchBooks: ({ query }) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const searchTerm = query.toLowerCase();<br>
&nbsp;&nbsp;&nbsp;&nbsp;return books.filter(<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;book => <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;book.title.toLowerCase().includes(searchTerm) ||<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;book.author.toLowerCase().includes(searchTerm)<br>
&nbsp;&nbsp;&nbsp;&nbsp;);<br>
&nbsp;&nbsp;}<br>
};</div>
</div>

<h4>3.4 Set Up the Express Server</h4>
<div class="w3-example">
<p>Complete the server setup:</p>
<div class="w3-code notranslate jsHigh">
// Create an Express app<br>
const app = express();<br>
<br>
// Set up the GraphQL endpoint<br>
app.use('/graphql', graphqlHTTP({<br>
&nbsp;&nbsp;schema: schema,<br>
&nbsp;&nbsp;rootValue: root,<br>
&nbsp;&nbsp;// Enable the GraphiQL interface for testing<br>
&nbsp;&nbsp;graphiql: true,<br>
}));<br>
<br>
// Start the server<br>
const PORT = 4000;<br>
app.listen(PORT, () => {<br>
&nbsp;&nbsp;console.log(`Server running at http://localhost:${PORT}/graphql`);<br>
});</div>
</div>

<h3>Step 4: Run and Test Your GraphQL Server</h3>

<h4>4.1 Start the Server</h4>
<div class="w3-example">
<p>Run your server with Node.js:</p>
<div class="w3-code notranslate">
node server.js</div>
<p>You should see the message: <code class="w3-codespan">Server running at http://localhost:4000/graphql</code></p>
</div>

<h4>4.2 Test with GraphiQL</h4>
<p>Open your browser and navigate to <code class="w3-codespan">http://localhost:4000/graphql</code> to access the GraphiQL interface.</p>

<h5>Example Query: Get All Books</h5>
<div class="w3-example">
<div class="w3-code notranslate">
{<br>
&nbsp;&nbsp;books {<br>
...
<h5>Example Query: Get a Single Book</h5>
<div class="w3-example">
<div class="w3-code notranslate">
{<br>
&nbsp;&nbsp;book(id: "1") {<br>
...
<h5>Example Query: Search Books</h5>
<div class="w3-example">
<div class="w3-code notranslate">
{<br>
&nbsp;&nbsp;searchBooks(query: "Gatsby") {<br>
&nbsp;&nbsp;&nbsp;&nbsp;title<br>
&nbsp;&nbsp;&nbsp;&nbsp;author<br>
&nbsp;&nbsp;&nbsp;&nbsp;year<br>
&nbsp;&nbsp;}<br>
...
<h2 id="mutations">Handling Mutations</h2>
<p>Mutations are used to modify data on the server. Let's add the ability to add, update, and delete books.</p>

<h3>1. Update the Schema</h3>
<div class="w3-example">
<p>Add the Mutation type to your schema:</p>
<div class="w3-code notranslate jsHigh">
const schema = buildSchema(`<br>
&nbsp;&nbsp;# ... (previous types remain the same) ...<br>
<br>
&nbsp;&nbsp;# Input type for adding/updating books<br>
&nbsp;&nbsp;input BookInput {<br>
&nbsp;&nbsp;&nbsp;&nbsp;title: String<br>
&nbsp;&nbsp;&nbsp;&nbsp;author: String<br>
&nbsp;&nbsp;&nbsp;&nbsp;year: Int<br>
...
&nbsp;&nbsp;type Mutation {<br>
&nbsp;&nbsp;&nbsp;&nbsp;# Add a new book<br>
&nbsp;&nbsp;&nbsp;&nbsp;addBook(input: BookInput!): Book!<br>
&nbsp;&nbsp;&nbsp;&nbsp;# Update an existing book<br>
&nbsp;&nbsp;&nbsp;&nbsp;updateBook(id: ID!, input: BookInput!): Book<br>
&nbsp;&nbsp;&nbsp;&nbsp;# Delete a book<br>
&nbsp;&nbsp;&nbsp;&nbsp;deleteBook(id: ID!): Boolean<br>
&nbsp;&nbsp;}<br>
`);
</div>
</div>

<h3>2. Implement Mutation Resolvers</h3>
<div class="w3-example">
<p>Update your root resolver object to include the mutation resolvers:</p>
<div class="w3-code notranslate jsHigh">
const root = {<br>
&nbsp;&nbsp;// ... (previous query resolvers remain the same) ...<br>
<br>
&nbsp;&nbsp;// Mutation resolvers<br>
&nbsp;&nbsp;addBook: ({ input }) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const newBook = {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;id: String(books.length + 1),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;...input<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
...
&nbsp;&nbsp;},<br>
<br>
&nbsp;&nbsp;updateBook: ({ id, input }) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const bookIndex = books.findIndex(book => book.id === id);<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (bookIndex === -1) return null;<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;const updatedBook = {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;...books[bookIndex],<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;...input<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;books[bookIndex] = updatedBook;<br>
&nbsp;&nbsp;&nbsp;&nbsp;return updatedBook;<br>
&nbsp;&nbsp;},<br>
<br>
&nbsp;&nbsp;deleteBook: ({ id }) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const bookIndex = books.findIndex(book => book.id === id);<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (bookIndex === -1) return false;<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;books.splice(bookIndex, 1);<br>
&nbsp;&nbsp;&nbsp;&nbsp;return true;<br>
&nbsp;&nbsp;}<br>
};</div>
</div>

<h3>3. Testing Mutations</h3>
...
<div class="w3-example">
<p>Always handle errors properly in your resolvers:</p>
<div class="w3-code notranslate jsHigh">
const root = {<br>
&nbsp;&nbsp;book: ({ id }) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const book = books.find(book => book.id === id);<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (!book) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;throw new Error('Book not found');<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;return book;<br>
&nbsp;&nbsp;},<br>
&nbsp;&nbsp;// ... other resolvers<br>
...
<p>Validate input data before processing:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const { GraphQLError } = require('graphql');<br>
<br>
const root = {<br>
&nbsp;&nbsp;addBook: ({ input }) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (input.year && (input.year &lt; 0 || input.year > new Date().getFullYear() + 1)) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;throw new GraphQLError('Invalid publication year', {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;extensions: { code: 'BAD_USER_INPUT' }<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;// ... rest of the resolver<br>
&nbsp;&nbsp;}<br>
};</div>
</div>

<h3>3. N+1 Problem</h3>
<p>Use DataLoader to batch and cache database queries:</p>
<div class="w3-example">
<div class="w3-code notranslate">
...
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const DataLoader = require('dataloader');<br>
<br>
// Create a loader for books<br>
const bookLoader = new DataLoader(async (ids) => {<br>
&nbsp;&nbsp;// This would be a database query in a real app<br>
&nbsp;&nbsp;return ids.map(id => books.find(book => book.id === id));<br>
});<br>
<br>
const root = {<br>
&nbsp;&nbsp;book: ({ id }) => bookLoader.load(id),<br>
&nbsp;&nbsp;// ... other resolvers<br>
};</div>
</div>
...
<ul>
  <li>Connect to a real database (MongoDB, PostgreSQL, etc.)</li>
  <li>Implement authentication and authorization</li>
  <li>Add subscriptions for real-time updates</li>
  <li>Explore Apollo Server for more advanced features</li>
  <li>Learn about schema stitching and federation for microservices</li>
</ul>

<div class="w3-panel ws-note">
  <p><strong>Tip:</strong> Always use variables in your GraphQL operations for better reusability and security.</p>
</div>

<hr>

<h2 id="schema">GraphQL Schemas and Types</h2>
<p>GraphQL schemas define the structure of your API and the types of data that can be requested.</p>

<h3>Type System</h3>
<p>GraphQL uses a type system to define the shape of your data. Here are the basic scalar types:</p>
...
<table class="ws-table-all w3-margin-top">
  ...
  <tr>
    ...
    <td><code class="w3-codespan">42</code></td>
  </tr>
  <tr>
    <td>Float</td>
    <td>Signed double-precision floating-point value</td>
    <td><code class="w3-codespan">3.14</code></td>
  </tr>
  <tr>
    <td>String</td>
    <td>UTF-8 character sequence</td>
    <td><code class="w3-codespan">"Hello, GraphQL!"</code></td>
  </tr>
  <tr>
    <td>Boolean</td>
    <td>true or false</td>
    <td><code class="w3-codespan">true</code>, <code class="w3-codespan">false</code></td>
  </tr>
  <tr>
    <td>ID</td>
    <td>Unique identifier, serialized as a String</td>
    <td><code class="w3-codespan">"5f8a8d8e8f8c8d8b8a8e8f8c"</code></td>
  </tr>
</table>

<hr>
<div id="exercisecontainer" src="xrcise_graphql.js" data-extensions="asp"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_mongodb_join.asp">&#10094; Previous</a>
