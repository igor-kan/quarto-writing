...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js WriteStream Reference</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js WriteStream Reference">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/ref_writestream.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="A WriteStream lets you write data to a destination such as a file or network connection in Node.js.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js WriteStream Reference">
<meta name="twitter:description" content="A WriteStream lets you write data to a destination such as a file or network connection in Node.js.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/ref_writestream.png">
...
<h1>Node.js WriteStream Reference</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="ref_readstream.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ref_server.asp">Next &#10095;</a>
</div>

<hr>

<h2>WriteStream Object</h2>

<p>A WriteStream is a stream that allows you to write data to a destination. Node.js provides WriteStream implementations for different use cases, such as writing to files (<code class="w3-codespan">fs.WriteStream</code>) or standard output (<code class="w3-codespan">process.stdout</code>).</p>

<p>WriteStreams implement the <code class="w3-codespan">stream.Writable</code> interface, which means they provide methods and events for writing data asynchronously and handling backpressure.</p>

<h3>Common WriteStream Types</h3>

<ul>
  <li><code class="w3-codespan">fs.WriteStream</code> - For writing to files</li>
  <li><code class="w3-codespan">process.stdout</code> and <code class="w3-codespan">process.stderr</code> - For writing to standard output and error</li>
  <li><code class="w3-codespan">net.Socket</code> (when writing) - For writing to network connections</li>
  <li><code class="w3-codespan">http.ServerResponse</code> - For writing HTTP responses</li>
</ul>

<hr>

<h2>WriteStream Properties</h2>

<p>Here are the properties commonly available on Node.js WriteStream objects, primarily based on the <code class="w3-codespan">fs.WriteStream</code> implementation:</p>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td>writeStream.bytesWritten</td>
    <td>The number of bytes written so far.</td>
  </tr>
  <tr>
    <td>writeStream.path</td>
    <td>The file path that this WriteStream is writing to (<code class="w3-codespan">fs.WriteStream</code> only).</td>
  </tr>
  <tr>
    <td>writeStream.pending</td>
    <td>If <code class="w3-codespan">true</code>, the underlying file has not been opened yet.</td>
  </tr>
  <tr>
    <td>writeStream.writableHighWaterMark</td>
    <td>Returns the highWaterMark value for this WriteStream.</td>
  </tr>
  <tr>
    <td>writeStream.writableLength</td>
    <td>Returns the number of bytes (or objects) in the write queue ready to be written.</td>
  </tr>
  <tr>
    <td>writeStream.writableEnded</td>
    <td>Becomes <code class="w3-codespan">true</code> after <code class="w3-codespan">end()</code> has been called.</td>
  </tr>
  <tr>
    <td>writeStream.writableFinished</td>
    <td>Becomes <code class="w3-codespan">true</code> after the 'finish' event is emitted.</td>
  </tr>
  <tr>
    <td>writeStream.writableObjectMode</td>
    <td>Indicates whether the WriteStream is in object mode.</td>
  </tr>
  <tr>
    <td>writeStream.destroyed</td>
    <td>Indicates if the stream has been destroyed.</td>
  </tr>
</table>
...
<h2>WriteStream Methods</h2>

<p>Here are the most important methods available on WriteStream objects:</p>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td>writeStream.write(chunk[, encoding][, callback])</td>
    <td>Writes <code class="w3-codespan">chunk</code> to the stream. Returns <code class="w3-codespan">true</code> if the data was handled completely, or <code class="w3-codespan">false</code> if it was buffered. The <code class="w3-codespan">callback</code> is called when the chunk is flushed.</td>
  </tr>
  <tr>
    <td>writeStream.end([chunk][, encoding][, callback])</td>
    <td>Signals that no more data will be written to the WriteStream. If <code class="w3-codespan">chunk</code> is provided, it's equivalent to <code class="w3-codespan">writeStream.write(chunk, encoding)</code> followed by <code class="w3-codespan">writeStream.end(callback)</code>.</td>
  </tr>
  <tr>
    <td>writeStream.cork()</td>
    <td>Forces all written data to be buffered in memory, which will be flushed when <code class="w3-codespan">uncork()</code> or <code class="w3-codespan">end()</code> is called.</td>
  </tr>
  <tr>
    <td>writeStream.uncork()</td>
    <td>Flushes all data buffered since <code class="w3-codespan">cork()</code> was called.</td>
  </tr>
  <tr>
    <td>writeStream.destroy([error])</td>
    <td>Destroys the stream, and optionally emits an error event. After this call, the WriteStream is no longer usable.</td>
  </tr>
  <tr>
    <td>writeStream.setDefaultEncoding(encoding)</td>
    <td>Sets the default encoding for strings written to the stream.</td>
  </tr>
</table>

<hr>

<h2>WriteStream Events</h2>

<p>WriteStream objects emit the following events:</p>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td>'close'</td>
    <td>Emitted when the stream and any of its underlying resources have been closed.</td>
  </tr>
  <tr>
    <td>'drain'</td>
    <td>Emitted when the write buffer becomes empty and it's safe to write again. This is used for flow control when <code class="w3-codespan">write()</code> returns <code class="w3-codespan">false</code>.</td>
  </tr>
  <tr>
    <td>'error'</td>
    <td>Emitted if an error occurred during writing.</td>
  </tr>
  <tr>
    <td>'finish'</td>
    <td>Emitted after <code class="w3-codespan">end()</code> is called and all data has been processed.</td>
  </tr>
  <tr>
    <td>'open'</td>
    <td>Emitted when the underlying resource (e.g., file descriptor) has been opened (<code class="w3-codespan">fs.WriteStream</code> specific).</td>
  </tr>
  <tr>
    <td>'pipe'</td>
    <td>Emitted when the <code class="w3-codespan">pipe()</code> method is called on a ReadStream, adding this WriteStream as its destination.</td>
  </tr>
  <tr>
    <td>'unpipe'</td>
    <td>Emitted when the <code class="w3-codespan">unpipe()</code> method is called on a ReadStream that previously piped to this WriteStream.</td>
  </tr>
  <tr>
    <td>'ready'</td>
    <td>Emitted when the stream is ready to be used.</td>
  </tr>
</table>
...
<p>This example shows how to create a file WriteStream and write data to it:</p>
...
<br>
// Define the output file path<br>
const outputFile = path.join(__dirname, 'writestream-example.txt');<br>
<br>
// Create a WriteStream to write to the file<br>
const writeStream = fs.createWriteStream(outputFile, {<br>
&nbsp;&nbsp;// Options<br>
&nbsp;&nbsp;flags: 'w',&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// 'w' for write (overwrites existing file)<br>
&nbsp;&nbsp;encoding: 'utf8',&nbsp;&nbsp;&nbsp;&nbsp;// Set the encoding for strings<br>
&nbsp;&nbsp;mode: 0o666,&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // File mode (permissions)<br>
&nbsp;&nbsp;autoClose: true&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Automatically close the file descriptor when the stream ends<br>
});<br>
<br>
console.log('File WriteStream properties:');<br>
console.log(`- Path: ${writeStream.path}`);<br>
console.log(`- Pending: ${writeStream.pending}`);<br>
console.log(`- High Water Mark: ${writeStream.writableHighWaterMark} bytes`);<br>
<br>
// Handle stream events<br>
writeStream.on('open', (fd) => {<br>
&nbsp;&nbsp;console.log(`File opened with descriptor: ${fd}`);<br>
});<br>
<br>
writeStream.on('ready', () => {<br>
&nbsp;&nbsp;console.log('WriteStream is ready');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Write data to the stream<br>
...
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// End the stream after writing all data<br>
&nbsp;&nbsp;writeStream.end('This is the final line.\n', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Finished writing to the file');<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Total bytes written: ${writeStream.bytesWritten}`);<br>
&nbsp;&nbsp;});<br>
});<br>
<br>
// Handle drain event (when buffer is empty)<br>
writeStream.on('drain', () => {<br>
&nbsp;&nbsp;console.log('Write buffer drained');<br>
});<br>
<br>
// Handle finish event (after end() and all data is flushed)<br>
writeStream.on('finish', () => {<br>
&nbsp;&nbsp;console.log('All writes have been completed');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Read back the file contents to verify<br>
&nbsp;&nbsp;fs.readFile(outputFile, 'utf8', (err, data) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (err) {<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('\nFile content:');<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('-'.repeat(20));<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(data);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('-'.repeat(20));<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Clean up the sample file<br>
&nbsp;&nbsp;&nbsp;&nbsp;fs.unlink(outputFile, (err) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error(`Error removing file: ${err.message}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Sample file removed');<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;});<br>
});<br>
<br>
writeStream.on('close', () => {<br>
&nbsp;&nbsp;console.log('Stream closed');<br>
});<br>
<br>
writeStream.on('error', (err) => {<br>
&nbsp;&nbsp;console.error(`Error: ${err.message}`);<br>
});
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_writestream_file">Run example &raquo;</a>
</div>
...
<p>This example demonstrates how to handle backpressure when writing large amounts of data:</p>
...
<br>
// Define the output file path<br>
const backpressureFile = path.join(__dirname, 'backpressure-example.txt');<br>
<br>
// Create a WriteStream with a small highWaterMark to demonstrate backpressure<br>
const writeStream = fs.createWriteStream(backpressureFile, {<br>
&nbsp;&nbsp;highWaterMark: 1024 // 1KB buffer (small to demonstrate backpressure)<br>
});<br>
<br>
// Counter for how many chunks we've written<br>
let chunksWritten = 0;<br>
let drainEvents = 0;<br>
<br>
// Function to write data until backpressure occurs<br>
function writeChunks() {<br>
&nbsp;&nbsp;console.log('Writing chunks...');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Create a large chunk of data<br>
&nbsp;&nbsp;const chunk = 'a'.repeat(256); // 256 bytes per chunk<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Try to write many chunks<br>
&nbsp;&nbsp;let canContinue = true;<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;while (canContinue && chunksWritten &lt; 100) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Attempt to write the chunk<br>
&nbsp;&nbsp;&nbsp;&nbsp;canContinue = writeStream.write(`Chunk ${chunksWritten}: ${chunk}\n`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;chunksWritten++;<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (chunksWritten % 10 === 0) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Wrote ${chunksWritten} chunks so far`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// If canContinue is false, we hit backpressure<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (!canContinue) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Backpressure hit after ${chunksWritten} chunks. Waiting for drain...`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Wait for the drain event before continuing<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;writeStream.once('drain', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;drainEvents++;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Drain event #${drainEvents} occurred. Resuming writes...`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;writeChunks(); // Continue writing<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// If we've written all chunks, end the stream<br>
&nbsp;&nbsp;if (chunksWritten >= 100) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;writeStream.end('\nAll chunks have been written.\n', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Ended the WriteStream after writing all chunks');<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
// Start writing chunks when the stream is ready<br>
writeStream.on('ready', () => {<br>
&nbsp;&nbsp;console.log('WriteStream is ready with highWaterMark =', <br>
&nbsp;&nbsp;&nbsp;&nbsp;writeStream.writableHighWaterMark, 'bytes');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Start writing chunks<br>
&nbsp;&nbsp;writeChunks();<br>
});<br>
<br>
// Handle finish event<br>
writeStream.on('finish', () => {<br>
&nbsp;&nbsp;console.log('\nWrite operation completed');<br>
&nbsp;&nbsp;console.log(`Total chunks written: ${chunksWritten}`);<br>
&nbsp;&nbsp;console.log(`Total drain events: ${drainEvents}`);<br>
&nbsp;&nbsp;console.log(`Total bytes written: ${writeStream.bytesWritten}`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Clean up the sample file<br>
&nbsp;&nbsp;fs.unlink(backpressureFile, (err) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error(`Error removing file: ${err.message}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return;<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_writestream_backpressure">Run example &raquo;</a>
</div>

<hr>

<h2>Using cork() and uncork()</h2>

<p>This example demonstrates using <code class="w3-codespan">cork()</code> and <code class="w3-codespan">uncork()</code> to batch writes together:</p>
...
const path = require('path');<br>
<br>
// Define the output file paths<br>
const uncorkedFile = path.join(__dirname, 'uncorked-example.txt');<br>
const corkedFile = path.join(__dirname, 'corked-example.txt');<br>
<br>
// Function to run the demonstration<br>
function demonstrateCorkUncork() {<br>
&nbsp;&nbsp;console.log('Demonstrating cork() and uncork() methods');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// 1. Write without corking<br>
&nbsp;&nbsp;const uncorkedStream = fs.createWriteStream(uncorkedFile);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;uncorkedStream.on('finish', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Uncorked stream finished. Bytes written: ${uncorkedStream.bytesWritten}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// 2. Now write with corking<br>
&nbsp;&nbsp;&nbsp;&nbsp;const corkedStream = fs.createWriteStream(corkedFile);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;corkedStream.on('finish', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Corked stream finished. Bytes written: ${corkedStream.bytesWritten}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Compare files<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;fs.readFile(uncorkedFile, 'utf8', (err, uncorkedData) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error(`Error reading uncorked file: ${err.message}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;fs.readFile(corkedFile, 'utf8', (err, corkedData) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error(`Error reading corked file: ${err.message}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('\nFile comparison:');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`- Uncorked file size: ${uncorkedData.length} bytes`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`- Corked file size: ${corkedData.length} bytes`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`- Content identical: ${uncorkedData === corkedData}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Clean up sample files<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;fs.unlinkSync(uncorkedFile);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;fs.unlinkSync(corkedFile);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Sample files removed');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Start cork operation<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Writing with cork()...');<br>
&nbsp;&nbsp;&nbsp;&nbsp;corkedStream.cork();<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Write multiple chunks of data<br>
&nbsp;&nbsp;&nbsp;&nbsp;for (let i = 0; i &lt; 1000; i++) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;corkedStream.write(`Line ${i}: This data is being corked.\n`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Uncork to flush the buffer - in real applications, you might cork/uncork<br>
&nbsp;&nbsp;&nbsp;&nbsp;// multiple times to batch writes together<br>
&nbsp;&nbsp;&nbsp;&nbsp;corkedStream.uncork();<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// End the stream<br>
&nbsp;&nbsp;&nbsp;&nbsp;corkedStream.end();<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Write without corking<br>
&nbsp;&nbsp;console.log('Writing without cork()...');<br>
&nbsp;&nbsp;for (let i = 0; i &lt; 1000; i++) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;uncorkedStream.write(`Line ${i}: This data is not being corked.\n`);<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// End the stream<br>
&nbsp;&nbsp;uncorkedStream.end();<br>
}<br>
<br>
// Run the demonstration<br>
demonstrateCorkUncork();
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_writestream_cork">Run example &raquo;</a>
</div>
...
<p>This example shows how to use the <code class="w3-codespan">process.stdout</code> WriteStream:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// process.stdout is a WriteStream<br>
<br>
// Basic writing to stdout<br>
process.stdout.write('Hello, ');<br>
process.stdout.write('world!\n');<br>
<br>
// Check if stdout supports color (most terminals do)<br>
const supportsColor = process.stdout.hasColors && process.stdout.hasColors();<br>
<br>
// Simple formatting if color is supported<br>
if (supportsColor) {<br>
&nbsp;&nbsp;// ANSI escape codes for colors<br>
&nbsp;&nbsp;const colors = {<br>
&nbsp;&nbsp;&nbsp;&nbsp;red: '\x1b[31m',<br>
&nbsp;&nbsp;&nbsp;&nbsp;green: '\x1b[32m',<br>
&nbsp;&nbsp;&nbsp;&nbsp;yellow: '\x1b[33m',<br>
...
table.forEach(row => {<br>
&nbsp;&nbsp;process.stdout.write(`${row[0].padEnd(10)}${row[1].padEnd(5)}${row[2]}\n`);<br>
});<br>
<br>
// Progress bar example<br>
process.stdout.write('\nProgress Bar Example:\n');<br>
<br>
function showProgress(percent) {<br>
&nbsp;&nbsp;const width = 40;<br>
&nbsp;&nbsp;const completed = Math.floor(width * (percent / 100));<br>
&nbsp;&nbsp;const remaining = width - completed;<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Create the progress bar<br>
&nbsp;&nbsp;const bar = '[' + '#'.repeat(completed) + ' '.repeat(remaining) + ']';<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Use \r to return to the beginning of the line<br>
&nbsp;&nbsp;process.stdout.write(`\r${bar} ${percent}%`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// When complete, add a newline<br>
&nbsp;&nbsp;if (percent === 100) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;process.stdout.write('\nComplete!\n');<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
// Simulate progress<br>
let progress = 0;<br>
const progressInterval = setInterval(() => {<br>
&nbsp;&nbsp;progress += 10;<br>
&nbsp;&nbsp;showProgress(progress);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;if (progress >= 100) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;clearInterval(progressInterval);<br>
&nbsp;&nbsp;}<br>
}, 300);<br>
<br>
// Note: The progress bar example is more effective in a terminal<br>
// than in the W3Schools TryIt editor
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_writestream_stdout">Run example &raquo;</a>
</div>

<hr>

<h2>HTTP WriteStream Example</h2>

<p>This example shows how to use a WriteStream to handle HTTP response data:</p>
...
&nbsp;&nbsp;// res is an http.ServerResponse, which is a WriteStream<br>
&nbsp;&nbsp;console.log(`Received ${req.method} request to ${req.url}`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Set response headers<br>
&nbsp;&nbsp;res.setHeader('Content-Type', 'text/html');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Check if the client requested a streaming response<br>
&nbsp;&nbsp;if (req.url === '/stream') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Demonstrate streaming a large response<br>
&nbsp;&nbsp;&nbsp;&nbsp;streamLargeResponse(res);<br>
&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Default handler - show links to examples<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.writeHead(200, {'Content-Type': 'text/html'});<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.end(`<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;!DOCTYPE html&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;html&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;head&gt;&lt;title&gt;HTTP WriteStream Example&lt;/title&gt;&lt;/head&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;body&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;h1&gt;HTTP WriteStream Examples&lt;/h1&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;ul&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;li&gt;&lt;a href="/stream"&gt;Stream a large response&lt;/a&gt;&lt;/li&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/ul&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/body&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/html&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;`);<br>
...
<br>
// Function to stream a large response piece by piece<br>
function streamLargeResponse(res) {<br>
&nbsp;&nbsp;// Set appropriate headers<br>
&nbsp;&nbsp;res.writeHead(200, {<br>
&nbsp;&nbsp;&nbsp;&nbsp;'Content-Type': 'text/html',<br>
&nbsp;&nbsp;&nbsp;&nbsp;'Transfer-Encoding': 'chunked'&nbsp;&nbsp;// Enable chunked transfer encoding<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&lt;html&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;head&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;title&gt;Streaming Response Example&lt;/title&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;style&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;body { font-family: Arial, sans-serif; margin: 20px; }<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;.chunk { padding: 10px; margin: 5px; background-color: #f0f0f0; }<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/style&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;/head&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;body&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;h1&gt;Streaming Response Example&lt;/h1&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;p&gt;This response is being streamed in chunks with delays between them.&lt;/p&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;div id="chunks"&gt;<br>
&nbsp;&nbsp;`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Number of chunks to send<br>
&nbsp;&nbsp;const totalChunks = 10;<br>
&nbsp;&nbsp;let sentChunks = 0;<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Function to send a chunk<br>
&nbsp;&nbsp;function sendChunk() {<br>
&nbsp;&nbsp;&nbsp;&nbsp;sentChunks++;<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;const now = new Date().toISOString();<br>
&nbsp;&nbsp;&nbsp;&nbsp;const chunk = `<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;div class="chunk"&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;h3&gt;Chunk ${sentChunks} of ${totalChunks}&lt;/h3&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;p&gt;Sent at: ${now}&lt;/p&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;p&gt;Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam vehicula magna eros, <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;eget gravida dolor fermentum non.&lt;/p&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/div&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;`;<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Write the chunk to the response<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.write(chunk);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// If we've sent all chunks, end the response<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (sentChunks >= totalChunks) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Write HTML footer<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;res.end(`<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/div&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;p&gt;All chunks have been sent.&lt;/p&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/body&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/html&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Finished streaming response');<br>
&nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Otherwise, schedule the next chunk<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;setTimeout(sendChunk, 500); // Send a chunk every 500ms<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Start sending chunks<br>
&nbsp;&nbsp;console.log('Starting to stream response');<br>
&nbsp;&nbsp;sendChunk();<br>
}<br>
<br>
// Start the server<br>
...
&nbsp;&nbsp;console.log(`HTTP WriteStream example server running at http://localhost:${PORT}`);<br>
});<br>
<br>
// Note: To see this in action, you need to run the server and open the browser at <br>
// http://localhost:8080
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_writestream_http">Run example &raquo;</a>
</div>

<hr>

<h2>Error Handling with WriteStreams</h2>

<p>This example demonstrates proper error handling with WriteStreams:</p>
...
const path = require('path');<br>
<br>
// Function to write to a file with proper error handling<br>
function writeWithErrorHandling(filePath, data) {<br>
&nbsp;&nbsp;console.log(`Attempting to write to: ${filePath}`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Create the WriteStream<br>
&nbsp;&nbsp;const writeStream = fs.createWriteStream(filePath);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Set up promise to capture result or error<br>
&nbsp;&nbsp;return new Promise((resolve, reject) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Handle errors<br>
&nbsp;&nbsp;&nbsp;&nbsp;writeStream.on('error', (err) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error(`Error writing to ${filePath}: ${err.message}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Make sure the stream is destroyed properly<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;writeStream.destroy();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;reject(err);<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Handle successful completion<br>
&nbsp;&nbsp;&nbsp;&nbsp;writeStream.on('finish', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Successfully wrote ${writeStream.bytesWritten} bytes to ${filePath}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;resolve(writeStream.bytesWritten);<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Write the data<br>
&nbsp;&nbsp;&nbsp;&nbsp;writeStream.write(data, (err) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error(`Error during write operation: ${err.message}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// The 'error' event will also be emitted in this case<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Data written successfully, ending stream');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;writeStream.end();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;});<br>
...
<br>
// Test with valid and invalid file paths<br>
const validPath = path.join(__dirname, 'valid-path.txt');<br>
const invalidPath = path.join('/', 'invalid', 'path', 'file.txt'); // Likely to be invalid on most systems<br>
<br>
// Example 1: Writing to a valid path<br>
console.log('Example 1: Writing to a valid path');<br>
writeWithErrorHandling(validPath, 'This is test content for error handling example')<br>
&nbsp;&nbsp;.then(bytesWritten => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Verified: ${bytesWritten} bytes written`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Clean up the test file<br>
&nbsp;&nbsp;&nbsp;&nbsp;fs.unlinkSync(validPath);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Test file removed');<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Example 2: Writing to an invalid path<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('\nExample 2: Writing to an invalid path');<br>
&nbsp;&nbsp;&nbsp;&nbsp;return writeWithErrorHandling(invalidPath, 'This should fail');<br>
&nbsp;&nbsp;})<br>
&nbsp;&nbsp;.catch(err => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Error caught in Promise catch:', err.message);<br>
&nbsp;&nbsp;});<br>
<br>
// Example 3: Demonstrating destroyed streams<br>
console.log('\nExample 3: Demonstrating destroyed streams');<br>
<br>
function demonstrateDestroyedStream() {<br>
&nbsp;&nbsp;const destroyTestFile = path.join(__dirname, 'destroy-test.txt');<br>
&nbsp;&nbsp;const writeStream = fs.createWriteStream(destroyTestFile);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;writeStream.on('error', (err) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error(`Destruction error: ${err.message}`);<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;writeStream.on('close', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Destroyed stream closed');<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Clean up if the file was created<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (fs.existsSync(destroyTestFile)) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;fs.unlinkSync(destroyTestFile);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Destroy test file removed');<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Write some data<br>
...
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Destroy the stream with an error<br>
&nbsp;&nbsp;console.log('Deliberately destroying the stream');<br>
&nbsp;&nbsp;writeStream.destroy(new Error('Stream manually destroyed'));<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Attempt to write after destruction (should fail silently)<br>
&nbsp;&nbsp;const writeResult = writeStream.write('This should not be written');<br>
&nbsp;&nbsp;console.log(`Attempt to write after destruction returned: ${writeResult}`);<br>
}<br>
<br>
demonstrateDestroyedStream();
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_writestream_error">Run example &raquo;</a>
</div>

<hr>

<h2>Best Practices for WriteStreams</h2>

<p>When working with WriteStreams in Node.js, consider these best practices:</p>

<ol>
&nbsp;&nbsp;<li><strong>Always handle errors</strong>: Always listen for and handle 'error' events from WriteStreams to prevent unhandled exceptions.</li>
&nbsp;&nbsp;<li><strong>Handle backpressure</strong>: Pay attention to the return value of <code class="w3-codespan">write()</code> and use the 'drain' event to control flow and prevent memory issues.</li>
  <li><strong>Use cork() for batching</strong>: Use <code class="w3-codespan">cork()</code> and <code class="w3-codespan">uncork()</code> to batch write operations, improving performance for many small writes.</li>
  <li><strong>Clean up resources</strong>: Ensure streams are properly closed with <code class="w3-codespan">end()</code> or destroyed with <code class="w3-codespan">destroy()</code> when no longer needed.</li>
  <li><strong>Set appropriate buffer sizes</strong>: Use the <code class="w3-codespan">highWaterMark</code> option to control memory usage, especially when dealing with high-throughput applications.</li>
  <li><strong>Use pipe() when possible</strong>: The <code class="w3-codespan">pipe()</code> method automatically handles backpressure and is typically the best way to connect streams.</li>
  <li><strong>Consider encoding</strong>: Set the appropriate encoding with <code class="w3-codespan">setDefaultEncoding()</code> when working with text.</li>
  <li><strong>Use stream.finished()</strong>: For cleanup, consider using <code class="w3-codespan">stream.finished()</code> from the <code class="w3-codespan">stream</code> module to detect when a stream is no longer writable or has experienced an error or premature close.</li>
</ol>
