...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Verify Reference</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js Verify Reference">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/ref_verify.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="The Verify class is part of Node.js's crypto module.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Verify Reference">
<meta name="twitter:description" content="The Verify class is part of Node.js's crypto module.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/ref_verify.png">
...
<h1>Node.js Verify Reference</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="ref_sign.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ref_socket.asp">Next &#10095;</a>
</div>
...
<p>The Verify class is part of Node.js's <code class="w3-codespan">crypto</code> module.</p>
<p>It provides a way to verify cryptographic digital signatures.</p>
<p>Verify instances are created using the <code class="w3-codespan">crypto.createVerify()</code> method.</p>

<p>Verify is used in conjunction with the Sign class to validate that a message was signed by a known sender and was not altered in transit.</p>

<h3>Import Crypto Module</h3>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// Import the crypto module<br>
const crypto = require('crypto');<br>
<br>
// Create a Verify object<br>
const verify = crypto.createVerify('RSA-SHA256');
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_verify_import">Run example &raquo;</a>
</div>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td>verify.update(data[, inputEncoding])</td>
    <td>Updates the Verify content with the given <code class="w3-codespan">data</code>. If <code class="w3-codespan">inputEncoding</code> is provided, <code class="w3-codespan">data</code> is a string using the specified encoding; otherwise, <code class="w3-codespan">data</code> is a Buffer, TypedArray, or DataView. This method can be called multiple times with new data.</td>
  </tr>
  <tr>
    <td>verify.verify(object, signature[, signatureEncoding])</td>
    <td>Verifies the provided data using the given <code class="w3-codespan">object</code> and <code class="w3-codespan">signature</code>. <code class="w3-codespan">object</code> is a string containing a PEM-encoded public key, a KeyObject of type 'public', or an X.509 certificate. If <code class="w3-codespan">signatureEncoding</code> is provided, <code class="w3-codespan">signature</code> is a string using the specified encoding; otherwise it is a Buffer, TypedArray, or DataView. Returns <code class="w3-codespan">true</code> if the signature is valid, <code class="w3-codespan">false</code> otherwise.</td>
  </tr>
</table>

<hr>

<h2>Basic Verify Example</h2>

<p>The following example demonstrates how to verify a digital signature of a message:</p>
...
<br>
// Load the message, signature, and public key<br>
// In a real application, these would typically come from files or network<br>
// For this example, we'll try to load from the files created in the Sign example<br>
let message, signature, publicKey;<br>
<br>
try {<br>
&nbsp;&nbsp;message = fs.readFileSync('message.txt', 'utf8');<br>
&nbsp;&nbsp;signature = fs.readFileSync('signature.hex', 'utf8');<br>
&nbsp;&nbsp;publicKey = fs.readFileSync('public_key.pem', 'utf8');<br>
} catch (error) {<br>
&nbsp;&nbsp;// If files don't exist, create example data<br>
&nbsp;&nbsp;const { privateKey, publicKey: newPublicKey } = crypto.generateKeyPairSync('rsa', {<br>
...
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;message = 'This is a message to be verified';<br>
&nbsp;&nbsp;publicKey = newPublicKey;<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Create a signature for the example<br>
&nbsp;&nbsp;const sign = crypto.createSign('SHA256');<br>
&nbsp;&nbsp;sign.update(message);<br>
&nbsp;&nbsp;signature = sign.sign(privateKey, 'hex');<br>
}<br>
<br>
// Create a Verify object<br>
const verify = crypto.createVerify('SHA256');<br>
<br>
// Update with the message<br>
verify.update(message);<br>
<br>
// Verify the signature with the public key<br>
const isValid = verify.verify(publicKey, signature, 'hex');<br>
<br>
console.log('Message:', message);<br>
console.log('Signature:', signature);<br>
console.log('Is signature valid?', isValid);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_verify_basic">Run example &raquo;</a>
</div>
...
<h2>Verifying with Different Algorithms</h2>

<p>The Verify class supports various signature algorithms:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const crypto = require('crypto');<br>
<br>
// Generate key pairs for different algorithms<br>
function generateRSAKeyPair() {<br>
...
<br>
function generateECKeyPair() {<br>
&nbsp;&nbsp;return crypto.generateKeyPairSync('ec', {<br>
&nbsp;&nbsp;&nbsp;&nbsp;namedCurve: 'prime256v1',<br>
&nbsp;&nbsp;&nbsp;&nbsp;publicKeyEncoding: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;type: 'spki',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;format: 'pem'<br>
&nbsp;&nbsp;&nbsp;&nbsp;},<br>
...
<br>
// Generate different key pairs<br>
const rsaKeys = generateRSAKeyPair();<br>
const ecKeys = generateECKeyPair();<br>
<br>
// Message to sign and verify<br>
const message = 'Message to verify with different algorithms';<br>
<br>
// Function to sign and verify with a specific algorithm<br>
function testSignatureVerification(algorithm, privateKey, publicKey, message) {<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Sign the message<br>
&nbsp;&nbsp;&nbsp;&nbsp;const sign = crypto.createSign(algorithm);<br>
&nbsp;&nbsp;&nbsp;&nbsp;sign.update(message);<br>
&nbsp;&nbsp;&nbsp;&nbsp;const signature = sign.sign(privateKey, 'hex');<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Verify the signature<br>
&nbsp;&nbsp;&nbsp;&nbsp;const verify = crypto.createVerify(algorithm);<br>
&nbsp;&nbsp;&nbsp;&nbsp;verify.update(message);<br>
&nbsp;&nbsp;&nbsp;&nbsp;const isValid = verify.verify(publicKey, signature, 'hex');<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Try to verify with a tampered message<br>
&nbsp;&nbsp;&nbsp;&nbsp;const tamperedVerify = crypto.createVerify(algorithm);<br>
&nbsp;&nbsp;&nbsp;&nbsp;tamperedVerify.update(message + ' (tampered)');<br>
&nbsp;&nbsp;&nbsp;&nbsp;const isTamperedValid = tamperedVerify.verify(publicKey, signature, 'hex');<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;return {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;algorithm,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;isValid,<br>
...
<br>
// Test various signature algorithms<br>
console.log(`Message: "${message}"`);<br>
console.log('-----------------------------------------------');<br>
<br>
// RSA signatures with different hash algorithms<br>
console.log('RSA Signatures:');<br>
['SHA256', 'SHA384', 'SHA512'].forEach(hash => {<br>
&nbsp;&nbsp;console.log(testSignatureVerification(hash, rsaKeys.privateKey, rsaKeys.publicKey, message));<br>
});<br>
<br>
console.log('-----------------------------------------------');<br>
<br>
// ECDSA signatures<br>
console.log('ECDSA Signatures:');<br>
['SHA256', 'SHA384'].forEach(hash => {<br>
&nbsp;&nbsp;console.log(testSignatureVerification(hash, ecKeys.privateKey, ecKeys.publicKey, message));<br>
});
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_verify_algorithms">Run example &raquo;</a>
</div>

<hr>

<h2>Verifying with Multiple Updates</h2>

<p>You can update a Verify object with multiple pieces of data:</p>
...
const { privateKey, publicKey } = crypto.generateKeyPairSync('rsa', {<br>
&nbsp;&nbsp;modulusLength: 2048,<br>
&nbsp;&nbsp;publicKeyEncoding: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;type: 'spki',<br>
&nbsp;&nbsp;&nbsp;&nbsp;format: 'pem'<br>
...
<br>
// Create a signature with multiple updates<br>
const sign = crypto.createSign('SHA256');<br>
sign.update('First part of the message. ');<br>
sign.update('Second part of the message. ');<br>
sign.update('Third part of the message.');<br>
const signature = sign.sign(privateKey, 'hex');<br>
<br>
console.log('Signature created with multiple updates');<br>
<br>
// Create a Verify object<br>
const verify = crypto.createVerify('SHA256');<br>
<br>
// Verify with multiple updates matching the original<br>
verify.update('First part of the message. ');<br>
verify.update('Second part of the message. ');<br>
verify.update('Third part of the message.');<br>
const isValidMultiple = verify.verify(publicKey, signature, 'hex');<br>
<br>
console.log('Verification with matching multiple updates:', isValidMultiple);<br>
<br>
// Verify with a single update containing the same data<br>
const verifySingle = crypto.createVerify('SHA256');<br>
verifySingle.update('First part of the message. Second part of the message. Third part of the message.');<br>
const isValidSingle = verifySingle.verify(publicKey, signature, 'hex');<br>
<br>
console.log('Verification with single update of same data:', isValidSingle);<br>
<br>
// Try to verify with different updates<br>
const verifyDifferent = crypto.createVerify('SHA256');<br>
verifyDifferent.update('First part of the message. ');<br>
verifyDifferent.update('Modified second part. ');<br>
verifyDifferent.update('Third part of the message.');<br>
const isValidDifferent = verifyDifferent.verify(publicKey, signature, 'hex');<br>
<br>
console.log('Verification with different updates:', isValidDifferent);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_verify_multiple">Run example &raquo;</a>
</div>

<hr>

<h2>Verifying File Signatures</h2>

<p>This example demonstrates verifying a digital signature for a file:</p>
...
const fs = require('fs');<br>
<br>
// Function to verify a file's signature<br>
function verifyFile(filePath, signaturePath, publicKey, algorithm = 'SHA256') {<br>
&nbsp;&nbsp;return new Promise((resolve, reject) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Read the signature<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const signature = fs.readFileSync(signaturePath, 'utf8');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Create Verify object<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const verify = crypto.createVerify(algorithm);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Create read stream for the file<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const readStream = fs.createReadStream(filePath);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Handle stream events<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;readStream.on('data', (data) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;verify.update(data);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
...
<br>
// For this example, create a file, sign it, and verify it<br>
const filePath = 'example_to_verify.txt';<br>
const signaturePath = `${filePath}.sig`;<br>
const publicKeyPath = 'verify_public_key.pem';<br>
<br>
// Create a test environment if files don't exist<br>
if (!fs.existsSync(filePath) || !fs.existsSync(signaturePath) || !fs.existsSync(publicKeyPath)) {<br>
&nbsp;&nbsp;console.log('Creating test environment...');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Generate a keypair<br>
&nbsp;&nbsp;const { privateKey, publicKey } = crypto.generateKeyPairSync('rsa', {<br>
&nbsp;&nbsp;&nbsp;&nbsp;modulusLength: 2048,<br>
...
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Save the public key<br>
&nbsp;&nbsp;fs.writeFileSync(publicKeyPath, publicKey);<br>
&nbsp;&nbsp;<br>
...
&nbsp;&nbsp;// Sign the file<br>
&nbsp;&nbsp;const sign = crypto.createSign('SHA256');<br>
&nbsp;&nbsp;const fileContent = fs.readFileSync(filePath);<br>
&nbsp;&nbsp;sign.update(fileContent);<br>
&nbsp;&nbsp;const signature = sign.sign(privateKey, 'hex');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Save the signature<br>
&nbsp;&nbsp;fs.writeFileSync(signaturePath, signature);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;console.log('Test environment created');<br>
}<br>
<br>
// Load the public key<br>
const publicKey = fs.readFileSync(publicKeyPath, 'utf8');<br>
<br>
// Verify the file signature<br>
verifyFile(filePath, signaturePath, publicKey)<br>
&nbsp;&nbsp;.then(isValid => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`File: ${filePath}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Signature: ${signaturePath}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Verification result: ${isValid ? 'Valid signature' : 'Invalid signature'}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Demonstrate a tampered file<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (isValid) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const tamperedFilePath = `${filePath}.tampered`;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;fs.copyFileSync(filePath, tamperedFilePath);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Make a small change to the file<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const content = fs.readFileSync(tamperedFilePath, 'utf8');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;fs.writeFileSync(tamperedFilePath, content.replace('verification', 'TAMPERED'));<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Verify the tampered file with the original signature<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return verifyFile(tamperedFilePath, signaturePath, publicKey)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;.then(isTamperedValid => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`\nTampered file: ${tamperedFilePath}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Verification result: ${isTamperedValid ? 'Valid signature (unexpected!)' : 'Invalid signature (expected)'}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;})<br>
&nbsp;&nbsp;.catch(error => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error('Error verifying file:', error.message);<br>
&nbsp;&nbsp;});
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_verify_file">Run example &raquo;</a>
</div>

<hr>

<h2>Verifying with Different Key Types</h2>

<p>The Verify class can work with different formats of public keys:</p>
...
<br>
// Message to sign and verify<br>
const message = 'Message to verify with different key formats';<br>
<br>
// Function to sign and verify with different key formats<br>
function verifyWithKeyFormat(publicKey, keyFormat, algorithm = 'SHA256') {<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Generate keypair for test<br>
&nbsp;&nbsp;&nbsp;&nbsp;const { privateKey, publicKey: generatedPublicKey } = crypto.generateKeyPairSync('rsa', {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;modulusLength: 2048,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;publicKeyEncoding: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;type: 'spki',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;format: 'pem'<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Sign the message with private key<br>
&nbsp;&nbsp;&nbsp;&nbsp;const sign = crypto.createSign(algorithm);<br>
&nbsp;&nbsp;&nbsp;&nbsp;sign.update(message);<br>
&nbsp;&nbsp;&nbsp;&nbsp;const signature = sign.sign(privateKey, 'hex');<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Verify with the provided public key format<br>
&nbsp;&nbsp;&nbsp;&nbsp;const verify = crypto.createVerify(algorithm);<br>
&nbsp;&nbsp;&nbsp;&nbsp;verify.update(message);<br>
&nbsp;&nbsp;&nbsp;&nbsp;return {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;format: keyFormat,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;isValid: verify.verify(publicKey, signature, 'hex')<br>
&nbsp;&nbsp;&nbsp;&nbsp;};<br>
&nbsp;&nbsp;} catch (error) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;return {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;format: keyFormat,<br>
...
<br>
// Generate an RSA key pair<br>
const { privateKey, publicKey: pemPublicKey } = crypto.generateKeyPairSync('rsa', {<br>
&nbsp;&nbsp;modulusLength: 2048,<br>
&nbsp;&nbsp;publicKeyEncoding: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;type: 'spki',<br>
&nbsp;&nbsp;&nbsp;&nbsp;format: 'pem'<br>
...
<br>
// Sign the message for verification tests<br>
const sign = crypto.createSign('SHA256');<br>
sign.update(message);<br>
const signature = sign.sign(privateKey, 'hex');<br>
<br>
// Function to verify with different key formats<br>
function testVerifyWithKey(publicKey, keyFormat) {<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const verify = crypto.createVerify('SHA256');<br>
&nbsp;&nbsp;&nbsp;&nbsp;verify.update(message);<br>
&nbsp;&nbsp;&nbsp;&nbsp;return {<br>
...
<br>
console.log(`Message: "${message}"`);<br>
console.log('Signature:', signature.substring(0, 32) + '...');<br>
<br>
// 1. Verify with PEM-encoded public key (string)<br>
console.log('\n1. PEM-encoded public key (string):');<br>
console.log(testVerifyWithKey(pemPublicKey, 'PEM string'));<br>
<br>
// 2. Verify with PEM-encoded public key (buffer)<br>
console.log('\n2. PEM-encoded public key (buffer):');<br>
console.log(testVerifyWithKey(Buffer.from(pemPublicKey), 'PEM buffer'));<br>
<br>
// 3. Verify with KeyObject<br>
console.log('\n3. KeyObject:');<br>
const keyObject = crypto.createPublicKey(pemPublicKey);<br>
console.log(testVerifyWithKey(keyObject, 'KeyObject'));<br>
<br>
// 4. Try to verify with X.509 certificate<br>
console.log('\n4. X.509 Certificate (simulated):');<br>
console.log({<br>
&nbsp;&nbsp;format: 'X.509 Certificate',<br>
&nbsp;&nbsp;note: 'In a real scenario, you would load an X.509 certificate containing the public key'<br>
});<br>
<br>
// 5. Try to verify with JWK (requires conversion)<br>
console.log('\n5. JWK (requires conversion):');<br>
console.log({<br>
&nbsp;&nbsp;format: 'JWK',<br>
&nbsp;&nbsp;note: 'JWK needs to be converted to PEM or KeyObject first'<br>
});
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_verify_key_types">Run example &raquo;</a>
</div>

<hr>

<h2>Verifying with Advanced Options</h2>

<p>Verifying signatures with specific OpenSSL options:</p>
...
<br>
// Message to sign<br>
const message = 'Message to verify with different options';<br>
<br>
// Function to sign with specific options<br>
function signWithOptions(algorithm, message, privateKey, options = {}) {<br>
&nbsp;&nbsp;// Create private key with options<br>
&nbsp;&nbsp;const keyWithOptions = {<br>
&nbsp;&nbsp;&nbsp;&nbsp;key: privateKey,<br>
&nbsp;&nbsp;&nbsp;&nbsp;...options<br>
&nbsp;&nbsp;};<br>
&nbsp;&nbsp;<br>
...
&nbsp;&nbsp;const sign = crypto.createSign(algorithm);<br>
&nbsp;&nbsp;sign.update(message);<br>
&nbsp;&nbsp;return sign.sign(keyWithOptions, 'hex');<br>
}<br>
<br>
// Function to verify with specific options<br>
function verifyWithOptions(algorithm, message, publicKey, signature, options = {}) {<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Create public key with options<br>
&nbsp;&nbsp;&nbsp;&nbsp;const keyWithOptions = {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;key: publicKey,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;...options<br>
&nbsp;&nbsp;&nbsp;&nbsp;};<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;const verify = crypto.createVerify(algorithm);<br>
&nbsp;&nbsp;&nbsp;&nbsp;verify.update(message);<br>
&nbsp;&nbsp;&nbsp;&nbsp;return verify.verify(keyWithOptions, signature, 'hex');<br>
&nbsp;&nbsp;} catch (error) {<br>
...
console.log(`Message: "${message}"`);<br>
<br>
// 1. Sign and verify with standard PKCS#1 v1.5 padding (default)<br>
const sig1 = signWithOptions('SHA256', message, privateKey);<br>
console.log('\n1. Standard PKCS#1 v1.5 padding:');<br>
console.log('Signature:', sig1.substring(0, 32) + '...');<br>
console.log('Verification result:', verifyWithOptions('SHA256', message, publicKey, sig1));<br>
<br>
// 2. Sign and verify with PSS padding<br>
const pssOptions = {<br>
&nbsp;&nbsp;padding: crypto.constants.RSA_PKCS1_PSS_PADDING,<br>
&nbsp;&nbsp;saltLength: 32<br>
};<br>
const sig2 = signWithOptions('SHA256', message, privateKey, pssOptions);<br>
console.log('\n2. PSS padding:');<br>
console.log('Signature:', sig2.substring(0, 32) + '...');<br>
console.log('Verification result (matching options):', <br>
&nbsp;&nbsp;verifyWithOptions('SHA256', message, publicKey, sig2, pssOptions));<br>
console.log('Verification result (default options):', <br>
&nbsp;&nbsp;verifyWithOptions('SHA256', message, publicKey, sig2));<br>
<br>
// 3. Verify with PSS padding and different salt lengths<br>
console.log('\n3. PSS padding with different salt lengths:');<br>
[20, 32, 48].forEach(saltLength => {<br>
&nbsp;&nbsp;const sigSalt = signWithOptions('SHA256', message, privateKey, {<br>
&nbsp;&nbsp;&nbsp;&nbsp;padding: crypto.constants.RSA_PKCS1_PSS_PADDING,<br>
&nbsp;&nbsp;&nbsp;&nbsp;saltLength<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;console.log(`Salt length ${saltLength}:`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Try to verify with correct salt length<br>
&nbsp;&nbsp;console.log(`&nbsp;&nbsp;- Verify with correct salt length (${saltLength}):`, <br>
&nbsp;&nbsp;&nbsp;&nbsp;verifyWithOptions('SHA256', message, publicKey, sigSalt, {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;padding: crypto.constants.RSA_PKCS1_PSS_PADDING,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;saltLength<br>
&nbsp;&nbsp;&nbsp;&nbsp;}));<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Try to verify with wrong salt length<br>
&nbsp;&nbsp;const wrongSaltLength = saltLength + 10;<br>
&nbsp;&nbsp;console.log(`&nbsp;&nbsp;- Verify with wrong salt length (${wrongSaltLength}):`, <br>
&nbsp;&nbsp;&nbsp;&nbsp;verifyWithOptions('SHA256', message, publicKey, sigSalt, {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;padding: crypto.constants.RSA_PKCS1_PSS_PADDING,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;saltLength: wrongSaltLength<br>
&nbsp;&nbsp;&nbsp;&nbsp;}));<br>
});
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_verify_options">Run example &raquo;</a>
</div>

<hr>

<h2>Certificate-Based Verification</h2>

<p>Verifying signatures using X.509 certificates:</p>
...
const fs = require('fs');<br>
<br>
// Function to simulate a certificate-based verification<br>
function demonstrateCertificateVerification() {<br>
&nbsp;&nbsp;console.log('Certificate-Based Verification Demonstration');<br>
&nbsp;&nbsp;console.log('-------------------------------------------');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;console.log('In a real application, you would:');<br>
&nbsp;&nbsp;console.log('1. Obtain an X.509 certificate containing the signer\'s public key');<br>
&nbsp;&nbsp;console.log('2. Verify the certificate\'s trust chain');<br>
&nbsp;&nbsp;console.log('3. Extract the public key from the certificate');<br>
&nbsp;&nbsp;console.log('4. Use that public key to verify the signature');<br>
&nbsp;&nbsp;<br>
...
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// In a real app, you'd have a certificate with the public key<br>
&nbsp;&nbsp;const mockCertificate = `-----BEGIN CERTIFICATE-----<br>
(This would be a real X.509 certificate containing the public key)<br>
-----END CERTIFICATE-----`;<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Message to sign<br>
&nbsp;&nbsp;const message = 'Message signed with a certificate-backed key';<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Sign the message<br>
&nbsp;&nbsp;const sign = crypto.createSign('SHA256');<br>
&nbsp;&nbsp;sign.update(message);<br>
...
&nbsp;&nbsp;console.log('1. Extract public key from certificate (simulated)');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// In a real scenario, you'd extract the public key from the certificate<br>
&nbsp;&nbsp;// For this example, we'll use our generated public key directly<br>
&nbsp;&nbsp;console.log('2. Verify the signature using the extracted public key');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;const verify = crypto.createVerify('SHA256');<br>
&nbsp;&nbsp;verify.update(message);<br>
&nbsp;&nbsp;const isValid = verify.verify(publicKey, signature, 'hex');<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_verify_certificate">Run example &raquo;</a>
</div>
...
<p>When verifying digital signatures, consider these security best practices:</p>

<ol>
  <li><strong>Trust management</strong>: Validate the source of the public key used for verification. Don't trust a public key unless it comes from a trusted source.</li>
  <li><strong>Certificate validation</strong>: When using certificates, verify the entire certificate chain and check certificate revocation status.</li>
  <li><strong>Matching signing algorithm</strong>: Ensure the verification algorithm matches the signing algorithm, including any options like padding or salt length.</li>
  <li><strong>Input validation</strong>: Validate and sanitize any data before verification to prevent injection attacks.</li>
  <li><strong>Fail securely</strong>: Always default to rejecting signatures that fail verification for any reason.</li>
  <li><strong>Keep verification code simple</strong>: Complexity increases the risk of verification bypass vulnerabilities.</li>
  <li><strong>Consider timing attacks</strong>: Signature verification may be vulnerable to timing attacks in some implementations.</li>
</ol>

<hr>

<h2>Common Use Cases for Signature Verification</h2>

<ul>
  <li><strong>Software Updates</strong>: Verifying the authenticity of updates before installation.</li>
  <li><strong>Document Verification</strong>: Ensuring digitally signed documents haven't been modified.</li>
  <li><strong>API Authentication</strong>: Verifying the identity of API requests.</li>
  <li><strong>JWT Validation</strong>: Verifying JSON Web Token signatures.</li>
  <li><strong>Certificate Chain Validation</strong>: Verifying signatures in a certificate chain.</li>
  <li><strong>Secure Communication</strong>: Authenticating messages in secure protocols.</li>
</ul>
