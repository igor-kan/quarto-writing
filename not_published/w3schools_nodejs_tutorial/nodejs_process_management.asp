...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Process Management</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js Process Management">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_process_management.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="Process management in Node.js is about controlling your application's lifecycle.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Process Management">
<meta name="twitter:description" content="Process management in Node.js is about controlling your application's lifecycle.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_process_management.png">
...
<h1>Node.js <span class="color_h1">Process Management</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_es6.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="nodejs_typescript.asp">Next &#10095;</a>
</div>
<hr>

<h2>What is Process Management?</h2>
<p>Process management in Node.js is about controlling your application's lifecycle.</p>
<p>It includes:</p>
<ul>
  <li>Starting and stopping applications</li>
  <li>Restarting after crashes</li>
  <li>Monitoring performance</li>
  <li>Handling system signals</li>
  <li>Managing environment variables</li>
</ul>
<hr>

<h2>Accessing Process Information</h2>
<p>The <code class="w3-codespan">process</code> object gives you details about and control over the current Node.js process.</p>
<p>Here are some useful properties:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// Process identification<br>
console.log('Process ID (PID):', process.pid);<br>
<br>
// Platform information<br>
console.log('Platform:', process.platform);<br>
console.log('Node.js version:', process.version);<br>
<br>
// Memory usage (in bytes)<br>
console.log('Memory usage:', process.memoryUsage());<br>
<br>
// Command line arguments<br>
console.log('Arguments:', process.argv);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_process_info">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Exiting a Process</h2>
<p>You can control when your Node.js program stops using these methods:</p>

<div class="w3-example">
<h4>1. Normal Exit</h4>
<div class="w3-code notranslate jsHigh">
// Exit with success (status code 0)<br>
process.exit();<br>
<br>
// Or explicitly<br>
process.exit(0);</div>
...
<div class="w3-example">
<h4>2. Exit with Error</h4>
<div class="w3-code notranslate jsHigh">
// Exit with error (status code 1)<br>
process.exit(1);</div>
</div>

<div class="w3-example">
<h4>3. Before Exit Event</h4>
<div class="w3-code notranslate jsHigh">
// Run cleanup before exiting<br>
process.on('beforeExit', (code) => {<br>
&nbsp;&nbsp;console.log('About to exit with code:', code);<br>
});</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_process_exit">Try it Yourself &raquo;</a>
</div>
...
<h2>Handling Process Events</h2>
<p>Node.js processes can respond to system signals and events.</p>
<p>Here are the most common ones:</p>

<div class="w3-example">  
<h4>1. Handling Ctrl+C (SIGINT)</h4>
<div class="w3-code notranslate jsHigh">
// Handle Ctrl+C<br>
process.on('SIGINT', () => {<br>
console.log('\nGot SIGINT. Press Control-D to exit.');<br>
// Perform cleanup if needed<br>
process.exit(0);</div>
</div>

<div class="w3-example">
<h4>2. Handling Process Termination (SIGTERM)</h4>
<div class="w3-code notranslate jsHigh">
process.on('SIGTERM', () => {<br>
&nbsp;&nbsp;console.log('Received SIGTERM. Cleaning up...');<br>
&nbsp;&nbsp;// Perform cleanup if needed<br>
&nbsp;&nbsp;process.exit(0);<br>
});</div>
</div>
...
<div class="w3-example">
<h4>3. Uncaught Exceptions</h4>
<div class="w3-code notranslate jsHigh">
process.on('uncaughtException', (err) => {<br>
&nbsp;&nbsp;console.error('Uncaught Exception:', err);<br>
&nbsp;&nbsp;// Perform cleanup if needed<br>
&nbsp;&nbsp;process.exit(1); // Exit with error<br>
});</div>
</div>
<hr>

<h2>Process Managers</h2>
<p>For production environments, use a process manager to keep your application running smoothly.</p>
<p><b>PM2</b> is the most popular choice:</p>

<h3>1. Install PM2 Globally</h3>
<div class="w3-example">
<div class="w3-code notranslate w3-black">
npm install -g pm2</div>
</div>

<h3>2. Basic PM2 Commands</h3>
<div class="w3-example">
<div class="w3-code notranslate w3-black">
# Start an application<br>
pm2 start app.js<br>
<br>
# List all running applications<br>
pm2 list<br>
<br>
...
pm2 stop app_name<br>
<br>
# Restart an application<br>
pm2 restart app_name<br>
<br>
# Delete an application from PM2<br>
pm2 delete app_name</div>
</div>

<h3>3. PM2 Configuration</h3>
<p>Create an ecosystem file for advanced configuration:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
...
<p>PM2 provides many other features like load balancing, monitoring, and log management.</p>
<hr>

<h2 id="env-vars">Environment Variables</h2>
<p>Environment variables are key-value pairs that configure your application's behavior in different environments.</p>

<div class="w3-example">
<h4>Accessing Environment Variables</h4>
<div class="w3-code notranslate jsHigh">
// Get a specific environment variable<br>
const apiKey = process.env.API_KEY;<br>
<br>
// Set a default value if not defined<br>
const port = process.env.PORT || 3000;<br>
<br>
// Check if running in production<br>
const isProduction = process.env.NODE_ENV === 'production';<br>
<br>
// List all environment variables<br>console.log('Environment variables:', process.env);</div>
</div>

<div class="w3-example">
<h4>Loading Environment Variables from .env File</h4>
<div class="w3-code notranslate w3-black">
# Install dotenv package<br>
npm install dotenv</div>
<br>
<div class="w3-code notranslate jsHigh">
// Load environment variables from .env file<br>
require('dotenv').config();<br>
<br>
// Now you can access variables from .env<br>
console.log('Database URL:', process.env.DATABASE_URL);</div>
</div>

<div class="w3-panel ws-note">
<p><strong>Best Practices for Environment Variables:</strong></p>
<ul>
  <li>Never commit sensitive data to version control</li>
  <li>Use <code class="w3-codespan">.env</code> for local development</li>
  <li>Set environment variables in production through your hosting platform</li>
  <li>Document all required environment variables in your README</li>
</ul>
</div>
<hr>

<h2 id="child-processes">Child Processes</h2>
<p>Node.js can run system commands and other scripts using the <code class="w3-codespan">child_process</code> module.</p>

<div class="w3-example">
<h4>1. Execute a Simple Command</h4>
<div class="w3-code notranslate jsHigh">
const { exec } = require('child_process');<br>
<br>
exec('ls -la', (error, stdout, stderr) => {<br>
&nbsp;&nbsp;if (error) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error(`Error: ${error.message}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;return;<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;if (stderr) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error(`stderr: ${stderr}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;return;<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;console.log(`Output: ${stdout}`);<br>});</div>
</div>

<div class="w3-example">
<h4>2. Using spawn for Large Output</h4>
<div class="w3-code notranslate jsHigh">
const { spawn } = require('child_process');<br>
<br>
// Better for large data output<br>
const child = spawn('find', ['/', '-type', 'f']);<br>

child.stdout.on('data', (data) => {<br>
&nbsp;&nbsp;console.log(`Found file: ${data}`);<br>});<br>

child.stderr.on('data', (data) => {<br>
&nbsp;&nbsp;console.error(`Error: ${data}`);<br>});<br>

child.on('close', (code) => {<br>
&nbsp;&nbsp;console.log(`Child process exited with code ${code}`);<br>});</div>
</div>
<hr>

<h2>Process Monitoring and Performance</h2>

<div class="w3-example">
<h4>1. Memory Usage</h4>
<div class="w3-code notranslate jsHigh">
// Get memory usage in MB<br>
function getMemoryUsage() {<br>
&nbsp;&nbsp;const used = process.memoryUsage();<br>
&nbsp;&nbsp;return {<br>
&nbsp;&nbsp;&nbsp;&nbsp;rss: `${Math.round(used.rss / 1024 / 1024 * 100) / 100} MB`,<br>
&nbsp;&nbsp;&nbsp;&nbsp;heapTotal: `${Math.round(used.heapTotal / 1024 / 1024 * 100) / 100} MB`,<br>
&nbsp;&nbsp;&nbsp;&nbsp;heapUsed: `${Math.round(used.heapUsed / 1024 / 1024 * 100) / 100} MB`,<br>
&nbsp;&nbsp;&nbsp;&nbsp;external: `${Math.round(used.external / 1024 / 1024 * 100) / 100} MB`<br>
&nbsp;&nbsp;};<br>
}<br>
<br>
// Monitor memory usage every 5 seconds<br>
setInterval(() => {<br>
&nbsp;&nbsp;console.log('Memory usage:', getMemoryUsage());<br>}, 5000);</div>
</div>
...
<br>
// Do some CPU-intensive work<br>
for (let i = 0; i &lt; 1000000000; i++) {}<br>
<br>
const endUsage = process.cpuUsage(startUsage);<br>
console.log('CPU usage (user):', endUsage.user / 1000, 'ms');<br>
console.log('CPU usage (system):', endUsage.system / 1000, 'ms');</div>
</div>
<hr>

<h2>Key Takeaways</h2>
<ul>
  <li><strong>Process Object</strong>: Access system and process information</li>
  <li><strong>Process Control</strong>: Start, stop, and manage application lifecycle</li>
  <li><strong>Environment Variables</strong>: Configure app behavior across different environments</li>
  <li><strong>Child Processes</strong>: Run system commands and other scripts</li>
  <li><strong>Error Handling</strong>: Handle uncaught exceptions and rejections</li>
  <li><strong>Signals</strong>: Respond to system signals like SIGINT and SIGTERM</li>
  <li><strong>PM2</strong>: Essential for production process management</li>
  <li><strong>Performance Monitoring</strong>: Track memory and CPU usage</li>
</ul>

<p>Effective process management is crucial for building reliable and maintainable Node.js applications, especially in production environments.</p>
<hr>
<div id="exercisecontainer" src="xrcise_process_management.js" data-extensions="asp"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_es6.asp">&#10094; Previous</a>
