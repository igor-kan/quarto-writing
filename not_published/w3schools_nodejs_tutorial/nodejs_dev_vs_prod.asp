...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js: Development vs Production</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js: Development vs Production">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_dev_vs_prod.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="The key differences between development and production in Node.js, and best practices for managing both environments.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js: Development vs Production">
<meta name="twitter:description" content="The key differences between development and production in Node.js, and best practices for managing both environments.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_dev_vs_prod.png">
...
<h1>Node.js: <span class="color_h1">Development vs Production</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_environment.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="nodejs_ci_cd.asp">Next &#10095;</a>
</div>
<hr>
<h2>Differences between Development and Production</h2>
<p>This page covers the key differences between development and production environments in Node.js applications and best practices for managing both effectively.</p>
    ...
    <div class="w3-half">
      <div class="w3-panel w3-pale-red w3-leftbar w3-border-red">
        ...
        <ul>
          ...
          <li>Minified and bundled code</li>
          <li>Real data/services</li>
        </ul>
      </div>
    </div>
  </div>
...
<h2>The NODE_ENV Environment Variable</h2>

<p>In Node.js, the <code class="w3-codespan">NODE_ENV</code> environment variable is a convention used to determine the environment in which an application is running.</p>
<p>It's commonly set to either 'development' or 'production', though other values like 'test' or 'staging' are also used.</p>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> Many Node.js frameworks and libraries (like Express, React, Vue, etc.) use <code class="w3-codespan">NODE_ENV</code> to enable or disable certain features and optimizations.</p>
</div>

<h3>Setting NODE_ENV</h3>

<div class="w3-example">
<h4>Command Line</h4>
<div class="w3-code notranslate w3-black">
# Windows Command Prompt<br>
set NODE_ENV=production<br>
node app.js<br>
<br>
...
<div class="w3-code notranslate jsonHigh">
{<br>
&nbsp;&nbsp;"scripts": {<br>
&nbsp;&nbsp;&nbsp;&nbsp;"start": "NODE_ENV=production node app.js",<br>
&nbsp;&nbsp;&nbsp;&nbsp;"dev": "NODE_ENV=development nodemon app.js",<br>
...
<div class="w3-example">
<h4>Using cross-env (cross-platform)</h4>
<div class="w3-code notranslate w3-black">
...
<h3>Using NODE_ENV in Your Application</h3>

<div class="w3-example">
  <div class="w3-code notranslate jsHigh">
// Simple environment check<br>
const isProduction = process.env.NODE_ENV === 'production';<br>
const isDevelopment = !isProduction;<br>
<br>
// Environment-specific configuration<br>
const config = {<br>
&nbsp; port: process.env.PORT || 3000,<br>
&nbsp; db: {<br>
&nbsp;&nbsp;&nbsp;host: isProduction ? 'prod-db.example.com' : 'localhost',<br>
&nbsp;&nbsp;&nbsp;name: isProduction ? 'myapp_prod' : 'myapp_dev'<br>
&nbsp;},<br>
&nbsp; logging: {<br>
&nbsp;&nbsp;&nbsp;level: isProduction ? 'warn' : 'debug',<br>
&nbsp;&nbsp;&nbsp;prettyPrint: !isProduction<br>
&nbsp; }<br>
};<br>
<br>
// Express.js example<br>
const express = require('express');<br>
const app = express();</div>
</div>
<div class="w3-panel ws-note">
<p><strong>Note:</strong> Setting <code class="w3-codespan">NODE_ENV=production</code> can improve application performance by up to 35%, as some packages apply optimizations based on this setting.</p>
</div>
...
<p>Different environments typically require different configurations for databases, APIs, logging, and other services.</p>

<h3>Environment-Specific Configuration</h3>

<div class="w3-example">
<h3>Configuration with dotenv</h3>
<div class="w3-code notranslate jsHigh">
// Install dotenv: npm install dotenv<br>
require('dotenv').config(); // Loads .env file contents into process.env<br>
<br>
// config.js<br>
module.exports = {<br>
&nbsp;&nbsp;development: {<br>
&nbsp;&nbsp;&nbsp; port: 8080,<br>
&nbsp;&nbsp;&nbsp; database: 'mongodb://localhost:27017/myapp_dev',<br>
&nbsp;&nbsp;&nbsp; logLevel: 'debug',<br>
&nbsp;&nbsp;&nbsp; apiKeys: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; thirdPartyService: process.env.DEV_API_KEY<br>
&nbsp;&nbsp;&nbsp; }<br>
&nbsp;&nbsp;},<br>
&nbsp;&nbsp;test: {<br>
&nbsp;&nbsp;&nbsp; port: 3001,<br>
&nbsp;&nbsp;&nbsp; database: 'mongodb://localhost:27017/myapp_test',<br>
&nbsp;&nbsp;&nbsp; logLevel: 'info',<br>
&nbsp;&nbsp;&nbsp; apiKeys: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; thirdPartyService: process.env.TEST_API_KEY<br>
&nbsp;&nbsp;&nbsp; }<br>
&nbsp;&nbsp;},<br>
&nbsp;&nbsp;production: {<br>
...
&nbsp;&nbsp;&nbsp; logLevel: 'error',<br>
&nbsp;&nbsp;&nbsp; apiKeys: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; thirdPartyService: process.env.PROD_API_KEY<br>
&nbsp;&nbsp;&nbsp; }<br>
&nbsp;&nbsp;}<br>
};<br>
<br>
const env = process.env.NODE_ENV || 'development';<br>
module.exports.current = module.exports[env];</div>
</div>

<h3>Configuration Files</h3>
<p>Common approaches to configuration management include:</p>

<ul>
  <li><strong>Environment files:</strong> Using <code class="w3-codespan">.env</code> files with the <code class="w3-codespan">dotenv</code> package</li>
  <li><strong>Configuration objects:</strong> Creating environment-specific configuration objects</li>
  <li><strong>Configuration services:</strong> Using external services like AWS Parameter Store, Vault, or Consul</li>
</ul>

<div class="w3-panel ws-warning">
<p><strong>Security Warning:</strong> Never commit sensitive information like API keys, database credentials, or secrets to version control. Always use environment variables or secure configuration services for sensitive data.</p>
</div>
...
<p>Error handling strategies should differ between development and production environments:</p>

<div class="w3-panel ws-info">
  <h4>Development Environment</h4>
  <ul>
    <li>Display detailed error messages and stack traces</li>
    <li>Use verbose logging to aid debugging</li>
    <li>Crash early on errors to identify issues quickly</li>
    <li>Enable source maps for better debugging</li>
    <li>Provide interactive debugging tools</li>
  </ul>
</div>
<div class="w3-panel ws-warning">
  <h4>Production Environment</h4>
  <ul>
    <li>Hide implementation details from error responses</li>
    <li>Log errors for internal use but return generic error messages</li>
...
<div class="w3-example">
<h3>Environment-Specific Error Handling</h3>
<div class="w3-code notranslate jsHigh">
const express = require('express');<br>
...
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Some operation that might fail<br>
&nbsp;&nbsp;&nbsp;&nbsp;throw new Error('Something went wrong');<br>
&nbsp;&nbsp;} catch (error) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Log the error internally (always do this)<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error('Error occurred:', error);<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Provide different responses based on environment<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (process.env.NODE_ENV === 'production') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// In production: generic error message<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return res.status(500).json({<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;error: 'An unexpected error occurred'<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// In development: detailed error information<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return res.status(500).json({<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;error: error.message,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;stack: error.stack,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;details: 'This detailed error is only shown in development'<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>
});<br>
...
<p>Logging requirements differ significantly between development and production:</p>

<div class="w3-panel ws-info">
<h4>Development Logging</h4>
<ul>
<li>Verbose logging with detailed information</li>
    <li>Human-readable format with colors</li>
    <li>Console output for immediate feedback</li>
    <li>Debug and trace level logging enabled</li>
    <li>No log rotation needed</li>
  </ul>
</div>
<div class="w3-panel ws-warning">
  ...
  <ul>
    ...
    <li>Appropriate log levels (warn/error)</li>
...
<div class="w3-example">
<h3>Environment-Specific Logging with Winston</h3>
<div class="w3-code notranslate jsHigh">
const winston = require('winston');<br>
<br>
// Define different logging configurations per environment<br>
const logger = winston.createLogger({<br>
&nbsp;&nbsp;level: process.env.NODE_ENV === 'production' ? 'info' : 'debug',<br>
&nbsp;&nbsp;format: process.env.NODE_ENV === 'production' <br>
&nbsp;&nbsp;&nbsp;&nbsp;? winston.format.json()<br>
&nbsp;&nbsp;&nbsp;&nbsp;: winston.format.combine(<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;winston.format.colorize(),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;winston.format.simple()<br>
&nbsp;&nbsp;&nbsp;&nbsp;),<br>
&nbsp;&nbsp;defaultMeta: { service: 'user-service' },<br>
&nbsp;&nbsp;transports: [<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Always log errors to a file<br>
&nbsp;&nbsp;&nbsp;&nbsp;new winston.transports.File({<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;filename: 'error.log',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;level: 'error'<br>
&nbsp;&nbsp;&nbsp;&nbsp;}),<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;// In production, save all logs to a file<br>
&nbsp;&nbsp;&nbsp;&nbsp;...(process.env.NODE_ENV === 'production'<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;? [new winston.transports.File({ filename: 'combined.log' })]<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: []),<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;// In development, log to the console<br>
&nbsp;&nbsp;&nbsp;&nbsp;...(process.env.NODE_ENV !== 'production'<br>
...
logger.debug('This debug message appears only in development');</div>
</div>

<p>For more details on logging, see the <a href="nodejs_logging.asp">Node.js Logging</a> tutorial.</p>

<hr>

<h2>Performance Optimizations</h2>

<p>Production environments should be optimized for performance and reliability:</p>

<div class="w3-panel ws-info">
<h4>Development Focus</h4>
<ul>
<li>Fast refresh and hot module replacement</li>
  <li>Source maps for debugging</li>
  <li>Detailed error overlays</li>
  <li>Unminified code</li>
...
<ul>
  <li>Optimized code bundling and minification</li>
  <li>Caching strategies</li>
  <li>Cluster mode to utilize multiple CPU cores</li>
  <li>Memory and CPU optimizations</li>
  <li>Content compression</li>
</ul>

<div class="w3-example">
<h3>Running in Cluster Mode in Production</h3>
<div class="w3-code notranslate jsHigh">
const cluster = require('cluster');<br>
const http = require('http');<br>
const numCPUs = require('os').cpus().length;<br>
<br>
if (process.env.NODE_ENV === 'production' && cluster.isMaster) {<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;// Replace the dead worker<br>
&nbsp;&nbsp;&nbsp;&nbsp;cluster.fork();<br>
&nbsp;&nbsp;});<br>
} else {<br>
&nbsp;&nbsp;// Workers can share a TCP connection<br>
...
<p>Security practices should be more stringent in production environments:</p>

<h3>Production Security Measures</h3>
<ul>
  ...
  <li><strong>HTTPS:</strong> Encrypt all communications</li>
  <li><strong>Dependency scanning:</strong> Check for vulnerabilities in dependencies</li>
</ul>

<div class="w3-example">
<h3>Security Middleware for Production</h3>
<div class="w3-code notranslate jsHigh">
const express = require('express');<br>
...
const app = express();<br>
<br>
// Apply security middleware in production<br>
if (process.env.NODE_ENV === 'production') {<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;res.redirect(`https://${req.header('host')}${req.url}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;next();<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;});<br>
...
<p>For applications using TypeScript, Babel, or other build tools, the build process differs between environments:</p>
...
<ul>
  ...
  <li>Less aggressive optimizations</li>
</ul>

<h3>Production Build</h3>
<ul>
  <li>Minification and tree shaking</li>
  <li>Bundling and code splitting</li>
  <li>Ahead-of-time compilation</li>
  <li>No source maps (or external source maps)</li>
</ul>

<div class="w3-example">
<h3>webpack.config.js for Different Environments</h3>
<div class="w3-code notranslate jsHigh">
const path = require('path');<br>
const TerserPlugin = require('terser-webpack-plugin');<br>
<br>
module.exports = (env, argv) => {<br>
&nbsp;&nbsp;const isProduction = argv.mode === 'production';<br>
<br>
&nbsp;&nbsp;return {<br>
&nbsp;&nbsp;&nbsp;&nbsp;entry: './src/index.js',<br>
&nbsp;&nbsp;&nbsp;&nbsp;output: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;path: path.resolve(__dirname, 'dist'),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;filename: isProduction<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;? 'bundle.[contenthash].js'<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: 'bundle.js'<br>
&nbsp;&nbsp;&nbsp;&nbsp;},<br>
&nbsp;&nbsp;&nbsp;&nbsp;mode: isProduction ? 'production' : 'development',<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Generate source maps in development but not production<br>
&nbsp;&nbsp;&nbsp;&nbsp;devtool: isProduction ? false : 'eval-source-map',<br>
&nbsp;&nbsp;&nbsp;&nbsp;optimization: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;minimize: isProduction,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;minimizer: isProduction ? [<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;new TerserPlugin({<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;terserOptions: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;compress: true,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;mangle: true<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;] : [],<br>
&nbsp;&nbsp;&nbsp;&nbsp;},<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Add development server configuration for non-production<br>
&nbsp;&nbsp;&nbsp;&nbsp;...(isProduction ? {} : {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;devServer: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;contentBase: './dist',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;hot: true<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;"dev": "nodemon src/server.ts",<br>
&nbsp;&nbsp;&nbsp;&nbsp;"build": "tsc",<br>
&nbsp;&nbsp;&nbsp;&nbsp;"build:prod": "tsc && webpack --mode=production",<br>
...
<ul>
  ...
  <li>Docker containers for dependencies</li>
  <li>Integrated development environment (IDE) tools</li>
</ul>

<h3>Production</h3>
<ul>
  <li>Process managers (PM2, Forever)</li>
...
<div class="w3-example">
<h3>PM2 Ecosystem File for Production</h3>
<div class="w3-code notranslate">
// ecosystem.config.js<br>
module.exports = {<br>
&nbsp;&nbsp;apps: [{<br>
&nbsp;&nbsp;&nbsp;&nbsp;name: "my-app",<br>
&nbsp;&nbsp;&nbsp;&nbsp;script: "./dist/server.js",<br>
&nbsp;&nbsp;&nbsp;&nbsp;instances: "max",<br>
...
<p>For more details on deployment, see the <a href="nodejs_deployment.asp">Node.js Deployment</a> tutorial.</p>

<hr>

<h2>Testing Environments</h2>

<p>Different environments have different testing requirements:</p>
...
<h3>Staging/QA Environment</h3>
<ul>
  <li>End-to-end tests</li>
  <li>Performance testing</li>
  <li>Configuration similar to production</li>
  <li>Mock data or sanitized production data</li>
</ul>
...
<ul>
  ...
  <li>Load testing (during off-peak hours)</li>
</ul>
...
<p>Store environment-specific configuration in environment variables, not in code.</p>

<h3>2. Automate Environment Setup</h3>
<p>Use tools like Docker, Vagrant, or cloud templates to create consistent environments.</p>

<h3>3. Implement Feature Flags</h3>
<p>Use feature flags to enable features selectively in different environments.</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const featureFlags = {<br>
&nbsp;&nbsp;development: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;newUserInterface: true,<br>
&nbsp;&nbsp;&nbsp;&nbsp;experimentalFeature: true,<br>
&nbsp;&nbsp;&nbsp;&nbsp;betaAnalytics: true<br>
&nbsp;&nbsp;},<br>
&nbsp;&nbsp;production: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;newUserInterface: false,<br>
...
<br>
const env = process.env.NODE_ENV || 'development';<br>
const features = featureFlags[env];<br>
<br>
if (features.newUserInterface) {<br>
&nbsp;&nbsp;// Enable the new UI<br>
}<br>
</div>
</div>

<h3>4. Implement Continuous Integration/Continuous Deployment (CI/CD)</h3>
<p>Automate testing and deployment across environments to ensure consistency.</p>

<h3>5. Monitor and Alert</h3>
<p>Set up comprehensive monitoring and alerting in production environments.</p>

<h3>6. Document Environment Differences</h3>
<p>Maintain clear documentation of environment-specific configurations and requirements.</p>

<hr>

<h2>Summary</h2>
<ul>
  <li>Use the <code class="w3-codespan">NODE_ENV</code> environment variable to distinguish between development and production environments</li>
  <li>Implement environment-specific configuration management</li>
  <li>Handle errors differently in development (verbose) and production (secure)</li>
  <li>Adjust logging strategies based on the environment</li>
  <li>Apply performance optimizations and security measures in production</li>
  <li>Use different build and deployment processes for each environment</li>
  <li>Follow best practices for environment management, including automation and documentation</li>
</ul>
<div id="exercisecontainer" src="xrcise_dev_vs_prod.js" data-extensions="asp"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_environment.asp">&lt; Previous</a>
