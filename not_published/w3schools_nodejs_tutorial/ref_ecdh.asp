...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js ECDH Reference</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js ECDH Reference">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/ref_ecdh.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="The ECDH (Elliptic Curve Diffie-Hellman) class is part of Node.js's crypto module.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js ECDH Reference">
<meta name="twitter:description" content="The ECDH (Elliptic Curve Diffie-Hellman) class is part of Node.js's crypto module.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/ref_ecdh.png">
...
<h1>Node.js ECDH Reference</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="ref_diffiehellman.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ref_hash.asp">Next &#10095;</a>
</div>
...
<p>The ECDH (Elliptic Curve Diffie-Hellman) class is part of Node.js's <code class="w3-codespan">crypto</code> module. It implements the Elliptic Curve Diffie-Hellman key exchange protocol, which allows two parties to securely establish a shared secret over an insecure channel using elliptic curve cryptography.</p>

<p>ECDH offers advantages over traditional Diffie-Hellman key exchange, including smaller key sizes, faster computation, and equivalent security strength.</p>
...
<br>
// Create an ECDH instance with a specific curve<br>
const ecdh = crypto.createECDH('prime256v1'); // Also known as P-256 or secp256r1
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_ecdh_import">Run example &raquo;</a>
</div>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td>ecdh.generateKeys([encoding[, format]])</td>
    <td>Generates private and public EC Diffie-Hellman key values. If <code class="w3-codespan">encoding</code> is provided, a string is returned; otherwise, a Buffer is returned. The <code class="w3-codespan">format</code> argument specifies point encoding and can be 'compressed', 'uncompressed', or 'hybrid'.</td>
  </tr>
  <tr>
    <td>ecdh.computeSecret(otherPublicKey[, inputEncoding][, outputEncoding])</td>
  ...
  <tr>
    <td>ecdh.getPrivateKey([encoding])</td>
    <td>Returns the EC Diffie-Hellman private key. If <code class="w3-codespan">encoding</code> is provided, a string is returned; otherwise, a Buffer is returned.</td>
  </tr>
  <tr>
    <td>ecdh.getPublicKey([encoding][, format])</td>
    <td>Returns the EC Diffie-Hellman public key. If <code class="w3-codespan">encoding</code> is provided, a string is returned; otherwise, a Buffer is returned. The <code class="w3-codespan">format</code> argument specifies point encoding and can be 'compressed', 'uncompressed', or 'hybrid'.</td>
  </tr>
  <tr>
    <td>ecdh.setPrivateKey(privateKey[, encoding])</td>
    <td>Sets the EC Diffie-Hellman private key. If <code class="w3-codespan">encoding</code> is provided, <code class="w3-codespan">privateKey</code> is expected to be a string; otherwise, a Buffer, TypedArray, or DataView.</td>
  </tr>
</table>
...
<p>Node.js supports various elliptic curves for ECDH. You can get a list of all supported curves with:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const crypto = require('crypto');<br>
<br>
// Get all supported elliptic curves<br>
console.log(crypto.getCurves());
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_ecdh_curves">Run example &raquo;</a>
</div>

<p>Common curves for ECDH include:</p>
...
<p>The following example demonstrates the basic ECDH key exchange between two parties (Alice and Bob):</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const crypto = require('crypto');<br>
<br>
// Alice creates an ECDH instance and generates keys<br>
console.log('Alice: Creating ECDH instance...');<br>
const alice = crypto.createECDH('prime256v1');<br>
alice.generateKeys();<br>
<br>
// Bob creates an ECDH instance and generates keys<br>
console.log('Bob: Creating ECDH instance...');<br>
const bob = crypto.createECDH('prime256v1');<br>
bob.generateKeys();<br>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_ecdh_basic">Run example &raquo;</a>
</div>

<hr>

<h2>ECDH with Different Encoding Formats</h2>

<p>ECDH supports different public key encoding formats:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const crypto = require('crypto');<br>
<br>
// Create an ECDH instance<br>
const ecdh = crypto.createECDH('prime256v1');<br>
ecdh.generateKeys();<br>
<br>
// Get public key in different formats<br>
const uncompressedKey = ecdh.getPublicKey('hex', 'uncompressed');<br>
const compressedKey = ecdh.getPublicKey('hex', 'compressed');<br>
const hybridKey = ecdh.getPublicKey('hex', 'hybrid');<br>
<br>
console.log('Uncompressed public key:', uncompressedKey);<br>
console.log('Compressed public key:', compressedKey);<br>
console.log('Hybrid public key:', hybridKey);<br>
<br>
// Get key length in each format<br>
console.log('\nKey lengths:');<br>
console.log('Uncompressed:', Buffer.from(uncompressedKey, 'hex').length, 'bytes');<br>
console.log('Compressed:', Buffer.from(compressedKey, 'hex').length, 'bytes');<br>
console.log('Hybrid:', Buffer.from(hybridKey, 'hex').length, 'bytes');<br>
<br>
// Use a public key in different formats<br>
const otherEcdh = crypto.createECDH('prime256v1');<br>
otherEcdh.generateKeys();<br>
<br>
// Another party can use any format to compute the same secret<br>
const secret1 = otherEcdh.computeSecret(<br>
&nbsp;&nbsp;Buffer.from(uncompressedKey, 'hex')<br>
);<br>
<br>
const secret2 = otherEcdh.computeSecret(<br>
&nbsp;&nbsp;Buffer.from(compressedKey, 'hex')<br>
);<br>
<br>
console.log('\nSame secret computed from different formats?', <br>
&nbsp;&nbsp;secret1.equals(secret2));
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_ecdh_formats">Run example &raquo;</a>
</div>

<hr>

<h2>ECDH with Encryption</h2>

<p>This example shows a complete scenario of using ECDH to establish a shared key for AES encryption:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const crypto = require('crypto');<br>
<br>
// Create ECDH instances for Alice and Bob<br>
const alice = crypto.createECDH('prime256v1');<br>
alice.generateKeys();<br>
<br>
const bob = crypto.createECDH('prime256v1');<br>
...
const message = 'Hello Bob, this is a secret message from Alice using ECDH!';<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_ecdh_encryption">Run example &raquo;</a>
</div>

<hr>

<h2>Setting Private Key Manually</h2>

<p>You can manually set a private key instead of generating one:</p>
...
const ecdh = crypto.createECDH('prime256v1');<br>
<br>
// Generate a random private key (32 bytes for prime256v1)<br>
const privateKey = crypto.randomBytes(32);<br>
console.log('Private key (hex):', privateKey.toString('hex'));<br>
<br>
// Set the private key<br>
ecdh.setPrivateKey(privateKey);<br>
<br>
// Derive the public key from the private key<br>
const publicKey = ecdh.getPublicKey('hex', 'uncompressed');<br>
console.log('Public key (hex):', publicKey);<br>
<br>
// You can also set the private key from a hex string<br>
const ecdh2 = crypto.createECDH('prime256v1');<br>
ecdh2.setPrivateKey(privateKey.toString('hex'), 'hex');<br>
<br>
// Check if both instances generate the same public key<br>
const publicKey2 = ecdh2.getPublicKey('hex', 'uncompressed');<br>
console.log('Same public keys:', publicKey === publicKey2);<br>
<br>
// This is useful for deterministic key generation or when loading keys from storage
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_ecdh_set_private">Run example &raquo;</a>
</div>

<hr>

<h2>ECDH with Different Curves</h2>

<p>This example shows how to use different elliptic curves with ECDH:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const crypto = require('crypto');<br>
<br>
// Function to perform ECDH key exchange with a specific curve<br>
function testCurve(curveName) {<br>
&nbsp;&nbsp;console.log(`\nTesting curve: ${curveName}`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Create ECDH instances<br>
&nbsp;&nbsp;&nbsp;&nbsp;const alice = crypto.createECDH(curveName);<br>
&nbsp;&nbsp;&nbsp;&nbsp;alice.generateKeys();<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;const bob = crypto.createECDH(curveName);<br>
&nbsp;&nbsp;&nbsp;&nbsp;bob.generateKeys();<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Exchange public keys<br>
&nbsp;&nbsp;&nbsp;&nbsp;const alicePublicKey = alice.getPublicKey();<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;const bobSecret = bob.computeSecret(alicePublicKey);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Check if secrets match<br>
&nbsp;&nbsp;&nbsp;&nbsp;const match = aliceSecret.equals(bobSecret);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Output results<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Public key size: ${alicePublicKey.length} bytes`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Shared secret size: ${aliceSecret.length} bytes`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Secrets match: ${match}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;return match;<br>
&nbsp;&nbsp;} catch (error) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error(`Error with curve ${curveName}: ${error.message}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;return false;<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
// Test different curves<br>
const curves = [<br>
&nbsp;&nbsp;'prime256v1',&nbsp;&nbsp;// P-256 / secp256r1<br>
&nbsp;&nbsp;'secp384r1',&nbsp;&nbsp; // P-384<br>
&nbsp;&nbsp;'secp521r1',&nbsp;&nbsp; // P-521<br>
&nbsp;&nbsp;'secp256k1',&nbsp;&nbsp; // Bitcoin curve<br>
&nbsp;&nbsp;'curve25519'&nbsp;&nbsp; // Ed25519 curve (if supported)<br>
];<br>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_ecdh_curves_compare">Run example &raquo;</a>
</div>
...
<p>This example compares the performance of ECDH with traditional Diffie-Hellman:</p>
...
<br>
// Function to measure DH key generation time<br>
function measureDH(bits) {<br>
&nbsp;&nbsp;const startTime = performance.now();<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;const dh = crypto.createDiffieHellman(bits);<br>
&nbsp;&nbsp;dh.generateKeys();<br>
&nbsp;&nbsp;<br>
...
<br>
// Function to measure ECDH key generation time<br>
function measureECDH(curve) {<br>
&nbsp;&nbsp;const startTime = performance.now();<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;const ecdh = crypto.createECDH(curve);<br>
&nbsp;&nbsp;ecdh.generateKeys();<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;const endTime = performance.now();<br>
&nbsp;&nbsp;return endTime - startTime;<br>
...
<br>
// Function to measure secret computation time<br>
function measureSecretComputation(type, params) {<br>
&nbsp;&nbsp;let alice, bob;<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Create instances and generate keys<br>
&nbsp;&nbsp;if (type === 'DH') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;alice = crypto.createDiffieHellman(params);<br>
&nbsp;&nbsp;&nbsp;&nbsp;alice.generateKeys();<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;bob = crypto.createDiffieHellman(alice.getPrime(), alice.getGenerator());<br>
&nbsp;&nbsp;&nbsp;&nbsp;bob.generateKeys();<br>
&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;alice = crypto.createECDH(params);<br>
&nbsp;&nbsp;&nbsp;&nbsp;alice.generateKeys();<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;bob = crypto.createECDH(params);<br>
&nbsp;&nbsp;&nbsp;&nbsp;bob.generateKeys();<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Exchange public keys<br>
...
&nbsp;&nbsp;const bobPublicKey = bob.getPublicKey();<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Measure time for computing secrets<br>
&nbsp;&nbsp;const startTime = performance.now();<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;alice.computeSecret(bobPublicKey);<br>
&nbsp;&nbsp;bob.computeSecret(alicePublicKey);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;const endTime = performance.now();<br>
&nbsp;&nbsp;return endTime - startTime;<br>
}<br>
...
console.log('Key Generation Performance:');<br>
console.log(`DH (1024 bits): ${measureDH(1024).toFixed(2)} ms`);<br>
console.log(`DH (2048 bits): ${measureDH(2048).toFixed(2)} ms`);<br>
console.log(`ECDH (P-256): ${measureECDH('prime256v1').toFixed(2)} ms`);<br>
console.log(`ECDH (P-384): ${measureECDH('secp384r1').toFixed(2)} ms`);<br>
console.log(`ECDH (P-521): ${measureECDH('secp521r1').toFixed(2)} ms`);<br>
<br>
console.log('\nSecret Computation Performance:');<br>
console.log(`DH (1024 bits): ${measureSecretComputation('DH', 1024).toFixed(2)} ms`);<br>
console.log(`DH (2048 bits): ${measureSecretComputation('DH', 2048).toFixed(2)} ms`);<br>
console.log(`ECDH (P-256): ${measureSecretComputation('ECDH', 'prime256v1').toFixed(2)} ms`);<br>
console.log(`ECDH (P-384): ${measureSecretComputation('ECDH', 'secp384r1').toFixed(2)} ms`);<br>
console.log(`ECDH (P-521): ${measureSecretComputation('ECDH', 'secp521r1').toFixed(2)} ms`);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_ecdh_performance">Run example &raquo;</a>
</div>

<hr>

<h2>ECDH Key Pair Generation for TLS</h2>

<p>This example shows how to generate ECDH key pairs for use with TLS:</p>
...
<br>
// Function to generate and save ECDH keys for TLS<br>
function generateEcdhKeysForTLS(curveName, keyFilePrefix) {<br>
&nbsp;&nbsp;// Create ECDH instance<br>
&nbsp;&nbsp;const ecdh = crypto.createECDH(curveName);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Generate keys<br>
&nbsp;&nbsp;ecdh.generateKeys();<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Get keys in PEM format<br>
&nbsp;&nbsp;const privateKey = ecdh.getPrivateKey('hex');<br>
&nbsp;&nbsp;const publicKey = ecdh.getPublicKey('hex', 'uncompressed');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Save keys to files<br>
&nbsp;&nbsp;fs.writeFileSync(`${keyFilePrefix}_private.hex`, privateKey);<br>
&nbsp;&nbsp;fs.writeFileSync(`${keyFilePrefix}_public.hex`, publicKey);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;console.log(`Generated ECDH key pair using ${curveName}`);<br>
&nbsp;&nbsp;console.log(`Private key saved to ${keyFilePrefix}_private.hex`);<br>
&nbsp;&nbsp;console.log(`Public key saved to ${keyFilePrefix}_public.hex`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;return {<br>
&nbsp;&nbsp;&nbsp;&nbsp;curve: curveName,<br>
&nbsp;&nbsp;&nbsp;&nbsp;privateKey,<br>
...
<br>
// Generate keys for different curves<br>
generateEcdhKeysForTLS('prime256v1', 'ecdh_p256');<br>
generateEcdhKeysForTLS('secp384r1', 'ecdh_p384');<br>
<br>
console.log("\nThese keys can be used for ECDHE (Ephemeral ECDH) in TLS connections.");<br>
console.log("In a real application, you would use these with the TLS module or a library like Node.js's tls module.");
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_ecdh_tls">Run example &raquo;</a>
</div>
...
<p>When using ECDH key exchange, consider these security best practices:</p>

<ol>
  <li><strong>Choose appropriate curves</strong>: For most applications, P-256 (prime256v1) provides a good balance of security and performance. For higher security requirements, consider P-384 or P-521.</li>
  <li><strong>Avoid weak or deprecated curves</strong>: Some curves are known to have weaknesses. Always use standard curves recommended by security authorities.</li>
  <li><strong>Use ephemeral keys</strong>: Generate new ECDH key pairs for each session to provide forward secrecy.</li>
  <li><strong>Add authentication</strong>: Pure ECDH (like DH) is vulnerable to man-in-the-middle attacks. Consider using authenticated key exchange protocols like ECDHE with digital signatures.</li>
  ...
  <li><strong>Validate public keys</strong>: Validate that received public keys are valid points on the elliptic curve to prevent invalid-curve attacks.</li>
</ol>

<hr>

<h2>Comparing DH and ECDH</h2>

<p>This table compares traditional Diffie-Hellman with Elliptic Curve Diffie-Hellman:</p>

<table class="ws-table-all">
  <tr>
    <th>Feature</th>
    <th>Diffie-Hellman</th>
    <th>ECDH</th>
  </tr>
  <tr>
    <td>Key Size</td>
  ...
  <tr>
    ...
    <td>More common in new protocols (TLS 1.3, etc.)</td>
  </tr>
  <tr>
    <td>Implementation</td>
    <td>Simpler mathematics</td>
    <td>More complex elliptic curve operations</td>
  </tr>
</table>

<p>For most modern applications, ECDH is preferred due to its better performance and smaller key sizes while providing equivalent or better security.</p>
