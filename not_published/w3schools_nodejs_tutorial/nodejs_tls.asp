...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js TLS/SSL Module</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js TLS/SSL Module">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_tls.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="The TLS/SSL module provides secure, encrypted communication over a network in Node.js.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js TLS/SSL Module">
<meta name="twitter:description" content="The TLS/SSL module provides secure, encrypted communication over a network in Node.js.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_tls.png">
...
<h1>Node.js TLS/SSL Module</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_vm.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="nodejs_net.asp">Next &#10095;</a>
</div>

<hr>

<h2>What is TLS/SSL?</h2>

<p>Transport Layer Security (TLS) and its predecessor, Secure Socket Layer (SSL), are protocols that provide secure communication over a computer network. They ensure:</p>

<ul>
  <li><strong>Privacy</strong>: Communications are encrypted to prevent eavesdropping</li>
  <li><strong>Data integrity</strong>: Message contents cannot be modified without detection</li>
  <li><strong>Authentication</strong>: The identities of the communicating parties can be verified</li>
</ul>

<p>TLS/SSL is commonly used for securing:</p>
<ul>
  <li>Web browsing (HTTPS)</li>
  <li>Email transmissions (SMTP, IMAP, POP3)</li>
...
<h2>Using the TLS Module</h2>

<p>To use the TLS module in Node.js, you need to require it:</p>
...
<p>Here's how to create a basic TLS server:</p>
...
<br>
// Server options with TLS certificates<br>
const options = {<br>
&nbsp;&nbsp;key: fs.readFileSync(path.join(__dirname, 'server-key.pem')),<br>
&nbsp;&nbsp;cert: fs.readFileSync(path.join(__dirname, 'server-cert.pem')),<br>
&nbsp;&nbsp;// Request client certificate (optional)<br>
&nbsp;&nbsp;requestCert: true,<br>
&nbsp;&nbsp;// Reject connections without authorized certificates (optional)<br>
&nbsp;&nbsp;rejectUnauthorized: false<br>
};<br>
<br>
// Create TLS server<br>
const server = tls.createServer(options, (socket) => {<br>
&nbsp;&nbsp;console.log('Server connected', <br>
&nbsp;&nbsp;&nbsp;&nbsp;socket.authorized ? 'authorized' : 'unauthorized');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Set encoding for data<br>
&nbsp;&nbsp;socket.setEncoding('utf8');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Handle incoming data<br>
&nbsp;&nbsp;socket.on('data', (data) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Received:', data);<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Echo back the data<br>
&nbsp;&nbsp;&nbsp;&nbsp;socket.write(`You said: ${data}`);<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Handle socket closure<br>
&nbsp;&nbsp;socket.on('end', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Socket ended');<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Write welcome message<br>
...
&nbsp;&nbsp;console.log(`TLS server running on port ${port}`);<br>
});
</div>
</div>

<div class="w3-panel ws-note">
<p>This example requires certificate files (<code class="w3-codespan">server-key.pem</code> and <code class="w3-codespan">server-cert.pem</code>). For development purposes, you can generate self-signed certificates using OpenSSL.</p>
</div>

<h3>Generating Self-Signed Certificates for Development</h3>

<p>You can use OpenSSL to generate self-signed certificates for development and testing:</p>

<div class="w3-example">
<div class="w3-code notranslate">
# Generate CA certificate<br>
openssl genrsa -out ca-key.pem 2048<br>
openssl req -new -x509 -key ca-key.pem -out ca-cert.pem -days 365<br>
<br>
# Generate server certificate<br>
openssl genrsa -out server-key.pem 2048<br>
openssl req -new -key server-key.pem -out server-csr.pem<br>
openssl x509 -req -in server-csr.pem -CA ca-cert.pem -CAkey ca-key.pem -CAcreateserial -out server-cert.pem -days 365<br>
<br>
# Generate client certificate (optional, for mutual authentication)<br>
openssl genrsa -out client-key.pem 2048<br>
openssl req -new -key client-key.pem -out client-csr.pem<br>
...
<p>Creating a client that connects to a TLS server:</p>
...
// Client options<br>
const options = {<br>
&nbsp;&nbsp;// For mutual authentication (optional)<br>
&nbsp;&nbsp;key: fs.readFileSync(path.join(__dirname, 'client-key.pem')),<br>
&nbsp;&nbsp;cert: fs.readFileSync(path.join(__dirname, 'client-cert.pem')),<br>
&nbsp;&nbsp;// Server name for Server Name Indication (SNI)<br>
&nbsp;&nbsp;servername: 'localhost',<br>
&nbsp;&nbsp;// CA certificate to verify the server (optional)<br>
&nbsp;&nbsp;ca: fs.readFileSync(path.join(__dirname, 'ca-cert.pem')),<br>
&nbsp;&nbsp;// Reject unauthorized certificates<br>
&nbsp;&nbsp;rejectUnauthorized: true<br>
};<br>
<br>
// Connect to server<br>
const client = tls.connect(8000, 'localhost', options, () => {<br>
&nbsp;&nbsp;// Check if authorized<br>
&nbsp;&nbsp;console.log('Client connected',<br>
&nbsp;&nbsp;&nbsp;&nbsp;client.authorized ? 'authorized' : 'unauthorized');<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;if (!client.authorized) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Reason:', client.authorizationError);<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Send data to server<br>
&nbsp;&nbsp;client.write('Hello from TLS client!');<br>
});<br>
<br>
// Set encoding for received data<br>
client.setEncoding('utf8');<br>
<br>
// Handle received data<br>
client.on('data', (data) => {<br>
&nbsp;&nbsp;console.log('Received from server:', data);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Send another message<br>
&nbsp;&nbsp;client.write('How are you?');<br>
});<br>
<br>
// Handle errors<br>
client.on('error', (error) => {<br>
&nbsp;&nbsp;console.error('Connection error:', error);<br>
});<br>
<br>
// Handle connection end<br>
client.on('end', () => {<br>
&nbsp;&nbsp;console.log('Server ended connection');<br>
});<br>
<br>
// Close connection after 5 seconds<br>
setTimeout(() => {<br>
&nbsp;&nbsp;console.log('Closing connection');<br>
&nbsp;&nbsp;client.end();<br>
}, 5000);
</div>
</div>
...
<h2>Server and Client Options</h2>

<p>Both <code class="w3-codespan">tls.createServer()</code> and <code class="w3-codespan">tls.connect()</code> accept various options to configure the TLS connection:</p>

<h3>Common Options</h3>
<ul>
  <li><code class="w3-codespan">key</code>: Private key in PEM format</li>
  <li><code class="w3-codespan">cert</code>: Certificate in PEM format</li>
  <li><code class="w3-codespan">ca</code>: Trusted CA certificates</li>
  <li><code class="w3-codespan">ciphers</code>: Cipher suite specification string</li>
  <li><code class="w3-codespan">minVersion</code>: Minimum TLS version to allow</li>
  <li><code class="w3-codespan">maxVersion</code>: Maximum TLS version to allow</li>
</ul>

<h3>Server-specific Options</h3>
<ul>
  <li><code class="w3-codespan">requestCert</code>: Whether to request a certificate from clients</li>
  <li><code class="w3-codespan">rejectUnauthorized</code>: Whether to reject clients with invalid certificates</li>
  <li><code class="w3-codespan">SNICallback</code>: Function to handle SNI from the client</li>
</ul>

<h3>Client-specific Options</h3>
<ul>
  <li><code class="w3-codespan">servername</code>: Server name for SNI</li>
  <li><code class="w3-codespan">checkServerIdentity</code>: Function to verify server hostname</li>
  <li><code class="w3-codespan">session</code>: A Buffer instance containing TLS session</li>
</ul>
...
const fs = require('fs');<br>
<br>
// Comprehensive server options<br>
const serverOptions = {<br>
&nbsp;&nbsp;// Key and certificate<br>
&nbsp;&nbsp;key: fs.readFileSync('server-key.pem'),<br>
&nbsp;&nbsp;cert: fs.readFileSync('server-cert.pem'),<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Certificate Authority<br>
&nbsp;&nbsp;ca: [fs.readFileSync('ca-cert.pem')],<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Protocol version control<br>
&nbsp;&nbsp;minVersion: 'TLSv1.2',<br>
&nbsp;&nbsp;maxVersion: 'TLSv1.3',<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Cipher control<br>
&nbsp;&nbsp;ciphers: 'ECDHE-RSA-AES128-GCM-SHA256:ECDHE-RSA-AES256-GCM-SHA384',<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Client authentication<br>
&nbsp;&nbsp;requestCert: true,<br>
&nbsp;&nbsp;rejectUnauthorized: true,<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Server Name Indication handling<br>
&nbsp;&nbsp;SNICallback: (servername, cb) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Different certificates for different servernames<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (servername === 'example.com') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;cb(null, tls.createSecureContext({<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;key: fs.readFileSync('example-key.pem'),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;cert: fs.readFileSync('example-cert.pem')<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}));<br>
&nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Default certificate<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;cb(null, tls.createSecureContext({<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;key: fs.readFileSync('default-key.pem'),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;cert: fs.readFileSync('default-cert.pem')<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}));<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>
};<br>
<br>
// Example client options<br>
const clientOptions = {<br>
&nbsp;&nbsp;key: fs.readFileSync('client-key.pem'),<br>
&nbsp;&nbsp;cert: fs.readFileSync('client-cert.pem'),<br>
&nbsp;&nbsp;ca: [fs.readFileSync('ca-cert.pem')],<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;servername: 'example.com',<br>
&nbsp;&nbsp;minVersion: 'TLSv1.2',<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Custom identity check function<br>
&nbsp;&nbsp;checkServerIdentity: (hostname, cert) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Custom validation logic<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (hostname !== cert.subject.CN) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return new Error(`Certificate CN does not match hostname: ${hostname}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;return undefined; // No error<br>
&nbsp;&nbsp;},<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Session reuse<br>
&nbsp;&nbsp;session: savedTlsSession, // Previously saved session<br>
};
</div>
</div>
...
<h2>Secure HTTP Server (HTTPS)</h2>

<p>While the TLS module can be used directly, for HTTPS servers, Node.js provides a higher-level <code class="w3-codespan">https</code> module built on top of TLS:</p>
...
&nbsp;&nbsp;res.end('&lt;h1&gt;Secure HTTPS Server&lt;/h1&gt;&lt;p&gt;This connection is encrypted using TLS.&lt;/p&gt;');<br>
}).listen(443, () => {<br>
&nbsp;&nbsp;console.log('HTTPS server running on port 443');<br>
});
</div>
</div>
<p>The HTTPS module provides a more convenient way to create secure HTTP servers, but it uses the TLS module under the hood.</p>
<hr>
<h2>TLS with Express</h2>
<p>You can also create an HTTPS server with Express:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
...
// Define routes<br>
app.get('/', (req, res) => {<br>
&nbsp;&nbsp;res.send('&lt;h1&gt;Secure Express App&lt;/h1&gt;&lt;p&gt;This connection is encrypted using TLS.&lt;/p&gt;');<br>
});<br>
<br>
app.get('/api/data', (req, res) => {<br>
&nbsp;&nbsp;res.json({<br>
&nbsp;&nbsp;&nbsp;&nbsp;message: 'This is sensitive data',<br>
...
<br>
// Create HTTPS server with Express app<br>
const port = 443;<br>
https.createServer(options, app).listen(port, () => {<br>
&nbsp;&nbsp;console.log(`Secure Express app running on port ${port}`);<br>
});
</div>
</div>
...
<p>TLS uses certificates to verify the identity of servers and optionally clients. Here's an example showing how to implement custom certificate verification:</p>
...
const fs = require('fs');<br>
<br>
// Custom verification function<br>
function validateCertificate(cert) {<br>
&nbsp;&nbsp;// Basic certificate info<br>
&nbsp;&nbsp;console.log('Certificate subject:', cert.subject);<br>
&nbsp;&nbsp;console.log('Certificate issuer:', cert.issuer);<br>
&nbsp;&nbsp;console.log('Valid from:', cert.valid_from);<br>
&nbsp;&nbsp;console.log('Valid to:', cert.valid_to);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Check certificate validity period<br>
&nbsp;&nbsp;const now = new Date();<br>
&nbsp;&nbsp;const validFrom = new Date(cert.valid_from);<br>
&nbsp;&nbsp;const validTo = new Date(cert.valid_to);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;if (now &lt; validFrom || now > validTo) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;return { valid: false, reason: 'Certificate is not within its validity period' };<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Additional checks could include:<br>
&nbsp;&nbsp;// - Certificate revocation status<br>
&nbsp;&nbsp;// - Certificate chain validation<br>
&nbsp;&nbsp;// - Public key strength<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;return { valid: true };<br>
}<br>
<br>
// Create TLS client with custom validation<br>
const options = {<br>
&nbsp;&nbsp;ca: [fs.readFileSync('ca-cert.pem')],<br>
&nbsp;&nbsp;checkServerIdentity: (hostname, cert) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// First check the certificate against our custom rules<br>
&nbsp;&nbsp;&nbsp;&nbsp;const validationResult = validateCertificate(cert);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (!validationResult.valid) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return new Error(validationResult.reason);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Then verify the hostname matches the certificate<br>
&nbsp;&nbsp;&nbsp;&nbsp;const certCN = cert.subject.CN;<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (hostname !== certCN && <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;!cert.subjectaltname || <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;!cert.subjectaltname.includes(hostname)) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return new Error(`Certificate name mismatch: ${hostname} !== ${certCN}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
...
<br>
// Connect to server with custom verification<br>
const client = tls.connect(8000, 'example.com', options, () => {<br>
&nbsp;&nbsp;if (client.authorized) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Connection authorized');<br>
&nbsp;&nbsp;&nbsp;&nbsp;client.write('Secure message');<br>
&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Connection not authorized:', client.authorizationError);<br>
&nbsp;&nbsp;}<br>
});<br>
<br>
// Handle connection events<br>
client.on('error', (error) => {<br>
&nbsp;&nbsp;console.error('TLS error:', error);<br>
});<br>
<br>
client.on('end', () => {<br>
&nbsp;&nbsp;console.log('Connection ended');<br>
});
</div>
</div>
...
<p>Session resumption allows clients to reconnect to a server without performing a full TLS handshake, improving performance:</p>
...
&nbsp;&nbsp;sessionTimeout: 300, // Session timeout in seconds<br>
&nbsp;&nbsp;ticketKeys: Buffer.from('0123456789abcdef0123456789abcdef'), // 32 bytes for key encryption<br>
};<br>
<br>
// Create TLS server<br>
const server = tls.createServer(serverOptions, (socket) => {<br>
&nbsp;&nbsp;console.log('Client connected');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Check if this is a resumed session<br>
&nbsp;&nbsp;if (socket.isSessionReused()) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Session reused!');<br>
&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('New session');<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;socket.on('data', (data) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Received:', data.toString());<br>
&nbsp;&nbsp;&nbsp;&nbsp;socket.write('Hello back!');<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;socket.on('end', () => {<br>
...
<br>
server.listen(8443, () => {<br>
&nbsp;&nbsp;console.log('TLS server listening on port 8443');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// First client connection<br>
&nbsp;&nbsp;connectClient(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Second client connection - should use session resumption<br>
&nbsp;&nbsp;&nbsp;&nbsp;connectClient();<br>
&nbsp;&nbsp;});<br>
});<br>
<br>
// Function to create a client with session resumption<br>
let savedSession = null;<br>
<br>
function connectClient(callback) {<br>
&nbsp;&nbsp;const clientOptions = {<br>
&nbsp;&nbsp;&nbsp;&nbsp;rejectUnauthorized: false, // For self-signed certificates<br>
&nbsp;&nbsp;&nbsp;&nbsp;session: savedSession // Use saved session if available<br>
&nbsp;&nbsp;};<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;const client = tls.connect(8443, 'localhost', clientOptions, () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Client connected. Authorized:', client.authorized);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Using session resumption:', client.isSessionReused());<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Save the session for future connections<br>
&nbsp;&nbsp;&nbsp;&nbsp;savedSession = client.getSession();<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Send data<br>
&nbsp;&nbsp;&nbsp;&nbsp;client.write('Hello server!');<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Close after a short delay<br>
&nbsp;&nbsp;&nbsp;&nbsp;setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;client.end();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (callback) setTimeout(callback, 100);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}, 100);<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;client.on('data', (data) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Client received:', data.toString());<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;client.on('error', (err) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error('Client error:', err);<br>
&nbsp;&nbsp;});<br>
}
</div>
</div>
...
<p>SNI allows a server to present different certificates for different hostnames on the same IP address and port:</p>
...
const path = require('path');<br>
<br>
// Load different certificates for different domains<br>
const serverOptions = {<br>
&nbsp;&nbsp;SNICallback: (servername, cb) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`SNI request for: ${servername}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Different certificate contexts based on hostname<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (servername === 'example.com') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const context = tls.createSecureContext({<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;key: fs.readFileSync(path.join(__dirname, 'example.com-key.pem')),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;cert: fs.readFileSync(path.join(__dirname, 'example.com-cert.pem'))<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;cb(null, context);<br>
&nbsp;&nbsp;&nbsp;&nbsp;} <br>
&nbsp;&nbsp;&nbsp;&nbsp;else if (servername === 'another.com') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const context = tls.createSecureContext({<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;key: fs.readFileSync(path.join(__dirname, 'another.com-key.pem')),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;cert: fs.readFileSync(path.join(__dirname, 'another.com-cert.pem'))<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;cb(null, context);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Default certificate<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const context = tls.createSecureContext({<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;key: fs.readFileSync(path.join(__dirname, 'default-key.pem')),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;cert: fs.readFileSync(path.join(__dirname, 'default-cert.pem'))<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;cb(null, context);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;},<br>
&nbsp;&nbsp;// Default keys and certificates (used as a fallback)<br>
&nbsp;&nbsp;key: fs.readFileSync(path.join(__dirname, 'default-key.pem')),<br>
&nbsp;&nbsp;cert: fs.readFileSync(path.join(__dirname, 'default-cert.pem'))<br>
};<br>
<br>
...
<br>
server.listen(8443, () => {<br>
&nbsp;&nbsp;console.log('TLS SNI server running on port 8443');<br>
});
</div>
</div>
...
<h2>Advanced Certificate Management</h2>

<p>Proper certificate management is crucial for secure TLS communications. Here are some advanced techniques:</p>

<h3>1. Certificate Chain and Multiple CAs</h3>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const tls = require('tls');<br>
const fs = require('fs');<br>
const path = require('path');<br>
<br>
// Load multiple CA certificates<br>
const caCerts = [<br>
&nbsp;&nbsp;fs.readFileSync(path.join(__dirname, 'ca1-cert.pem')),<br>
&nbsp;&nbsp;fs.readFileSync(path.join(__dirname, 'ca2-cert.pem')),<br>
&nbsp;&nbsp;fs.readFileSync(path.join(__dirname, 'intermediate-cert.pem'))<br>
];<br>
<br>
// Server with multiple CA certificates<br>
const serverOptions = {<br>
&nbsp;&nbsp;key: fs.readFileSync(path.join(__dirname, 'server-key.pem')),<br>
&nbsp;&nbsp;cert: fs.readFileSync(path.join(__dirname, 'server-cert.pem')),<br>
&nbsp;&nbsp;ca: caCerts,&nbsp;&nbsp;// Array of CA certificates<br>
&nbsp;&nbsp;requestCert: true,<br>
&nbsp;&nbsp;rejectUnauthorized: true<br>
};<br>
<br>
const server = tls.createServer(serverOptions, (socket) => {<br>
&nbsp;&nbsp;console.log('Client connected:', socket.authorized ? 'Authorized' : 'Unauthorized');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Get peer certificate<br>
&nbsp;&nbsp;const cert = socket.getPeerCertificate();<br>
&nbsp;&nbsp;console.log('Client certificate subject:', cert.subject);<br>
&nbsp;&nbsp;console.log('Issuer:', cert.issuer.CN);<br>
&nbsp;&nbsp;<br>
...
&nbsp;&nbsp;console.log('TLS server running on port 8000');<br>
});
</div>
</div>

<h3>2. Certificate Revocation with CRL</h3>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const tls = require('tls');<br>
const fs = require('fs');<br>
...
<br>
// Load CRL (Certificate Revocation List)<br>
const crl = fs.readFileSync('revoked-certs.pem');<br>
<br>
// Parse CRL to check against<br>
const checkRevocation = (cert) => {<br>
&nbsp;&nbsp;// In a real application, you would parse the CRL and check<br>
&nbsp;&nbsp;// if the certificate's serial number is in the revocation list<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// For demonstration, we'll just check against a known revoked serial<br>
&nbsp;&nbsp;const revokedSerials = [<br>
&nbsp;&nbsp;&nbsp;&nbsp;'0123456789ABCDEF', // Example revoked serial<br>
&nbsp;&nbsp;&nbsp;&nbsp;'FEDCBA9876543210'<br>
&nbsp;&nbsp;];<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;const certInfo = crypto.certificateVerify(<br>
&nbsp;&nbsp;&nbsp;&nbsp;cert.raw, <br>
&nbsp;&nbsp;&nbsp;&nbsp;'sha256', <br>
&nbsp;&nbsp;&nbsp;&nbsp;Buffer.from(''), <br>
&nbsp;&nbsp;&nbsp;&nbsp;Buffer.from('')<br>
&nbsp;&nbsp;);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;return !revokedSerials.includes(certInfo.serialNumber.toString('hex').toUpperCase());<br>
};<br>
<br>
const server = tls.createServer({<br>
&nbsp;&nbsp;key: fs.readFileSync('server-key.pem'),<br>
&nbsp;&nbsp;cert: fs.readFileSync('server-cert.pem'),<br>
&nbsp;&nbsp;requestCert: true,<br>
&nbsp;&nbsp;rejectUnauthorized: true,<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Custom certificate validation<br>
&nbsp;&nbsp;checkServerIdentity: (host, cert) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (!checkRevocation(cert)) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return new Error('Certificate has been revoked');<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;return undefined; // No error means certificate is valid<br>
&nbsp;&nbsp;}<br>
}, (socket) => {<br>
&nbsp;&nbsp;// Handle connection<br>
&nbsp;&nbsp;console.log('Client connected:', socket.authorized ? 'Authorized' : 'Unauthorized');<br>
...
<h3>3. Automatic Certificate Management with Let's Encrypt</h3>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const tls = require('tls');<br>
const https = require('https');<br>
...
<br>
class TLSCertManager {<br>
&nbsp;&nbsp;constructor(domain, email) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.domain = domain;<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.email = email;<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.certDir = path.join(__dirname, 'certs', domain);<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.ensureCertDir();<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;ensureCertDir() {<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (!fs.existsSync(this.certDir)) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;fs.mkdirSync(this.certDir, { recursive: true });<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;async getCertificates() {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const keyPath = path.join(this.certDir, 'privkey.pem');<br>
&nbsp;&nbsp;&nbsp;&nbsp;const certPath = path.join(this.certDir, 'cert.pem');<br>
&nbsp;&nbsp;&nbsp;&nbsp;const chainPath = path.join(this.certDir, 'chain.pem');<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Check if certificates exist and are valid<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (this.certsValid(keyPath, certPath, chainPath)) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;key: fs.readFileSync(keyPath),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;cert: fs.readFileSync(certPath),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ca: fs.readFileSync(chainPath)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;};<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Use certbot to obtain new certificates<br>
&nbsp;&nbsp;&nbsp;&nbsp;return await this.obtainCertificates();<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;certsValid(keyPath, certPath, chainPath) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (!fs.existsSync(keyPath) || !fs.existsSync(certPath) || !fs.existsSync(chainPath)) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return false;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Check if certificate is valid for at least 7 more days<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const cert = fs.readFileSync(certPath);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const notAfter = cert.toString().match(/Not After : (.*?)\n/)[1];<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const expiryDate = new Date(notAfter);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const now = new Date();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return (expiryDate - now) > 7 * 24 * 60 * 60 * 1000; // 7 days in ms<br>
&nbsp;&nbsp;&nbsp;&nbsp;} catch (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error('Error checking certificate validity:', err);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return false;<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;async obtainCertificates() {<br>
&nbsp;&nbsp;&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// This is a simplified example - in production, use a proper ACME client<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Obtaining new certificates from Let\'s Encrypt...');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// In a real application, you would use an ACME client like 'greenlock' or 'acme'<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// This is just a placeholder to illustrate the concept<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;execSync(`certbot certonly --standalone -d ${this.domain} --email ${this.email} --agree-tos --non-interactive`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Copy certificates to our certs directory<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const certs = {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;key: fs.readFileSync(`/etc/letsencrypt/live/${this.domain}/privkey.pem`),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;cert: fs.readFileSync(`/etc/letsencrypt/live/${this.domain}/cert.pem`),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ca: fs.readFileSync(`/etc/letsencrypt/live/${this.domain}/chain.pem`)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;};<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Save certificates for future use<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;fs.writeFileSync(path.join(this.certDir, 'privkey.pem'), certs.key);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;fs.writeFileSync(path.join(this.certDir, 'cert.pem'), certs.cert);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;fs.writeFileSync(path.join(this.certDir, 'chain.pem'), certs.ca);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return certs;<br>
&nbsp;&nbsp;&nbsp;&nbsp;} catch (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error('Failed to obtain certificates:', err);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;throw err;<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
// Usage example<br>
async function createSecureServer() {<br>
&nbsp;&nbsp;const certManager = new TLSCertManager('example.com', 'admin@example.com');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const certs = await certManager.getCertificates();<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;server.listen(443, () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('HTTPS server running on port 443');<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Schedule certificate renewal check (e.g., daily)<br>
&nbsp;&nbsp;&nbsp;&nbsp;setInterval(async () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;await certManager.getCertificates();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;} catch (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error('Certificate renewal check failed:', err);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;}, 24 * 60 * 60 * 1000); // Check daily<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;} catch (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error('Failed to start secure server:', err);<br>
&nbsp;&nbsp;&nbsp;&nbsp;process.exit(1);<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
...
<div class="w3-panel ws-note">
<p><strong>Note:</strong> The Let's Encrypt example is simplified. In production, use a well-maintained ACME client library and follow Let's Encrypt's rate limits and best practices.</p>
</div>
...
<p>When using TLS in production applications, consider these security best practices:</p>

<h3>1. Use Strong TLS Versions</h3>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const options = {<br>
&nbsp;&nbsp;// Disable older TLS versions<br>
&nbsp;&nbsp;minVersion: 'TLSv1.2',<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Explicitly disallow TLS 1.0 and 1.1<br>
&nbsp;&nbsp;secureOptions: crypto.constants.SSL_OP_NO_TLSv1 | <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; crypto.constants.SSL_OP_NO_TLSv1_1<br>
};
</div>
</div>

<h3>2. Configure Strong Cipher Suites</h3>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const options = {<br>
&nbsp;&nbsp;// Prioritize modern, secure cipher suites<br>
&nbsp;&nbsp;ciphers: [<br>
...
<h3>3. Use Perfect Forward Secrecy</h3>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// Cipher suites with ECDHE (Elliptic Curve Diffie-Hellman Ephemeral) support PFS<br>
const options = {<br>
&nbsp;&nbsp;ciphers: 'ECDHE-RSA-AES128-GCM-SHA256:ECDHE-RSA-AES256-GCM-SHA384'<br>
};
</div>
...
<h3>4. Implement OCSP Stapling (Online Certificate Status Protocol)</h3>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const tls = require('tls');<br>
const https = require('https');<br>
...
&nbsp;&nbsp;requestOCSP: true,<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// OCSP response cache timeout (in milliseconds)<br>
&nbsp;&nbsp;ocspCache: new tls.OCSPCache({<br>
&nbsp;&nbsp;&nbsp;&nbsp;max: 1000,&nbsp;&nbsp;// Maximum number of cached responses<br>
&nbsp;&nbsp;&nbsp;&nbsp;maxAge: 60 * 60 * 1000&nbsp;&nbsp;// Cache for 1 hour<br>
&nbsp;&nbsp;})<br>
};<br>
<br>
// Create HTTPS server with OCSP stapling<br>
const server = https.createServer(serverOptions, (req, res) => {<br>
&nbsp;&nbsp;res.writeHead(200);<br>
&nbsp;&nbsp;res.end('Hello with OCSP stapling!\n');<br>
});<br>
<br>
// Handle OCSP request errors<br>
server.on('OCSPRequest', (cert, issuer, callback) => {<br>
&nbsp;&nbsp;if (!cert || !issuer) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;return callback(new Error('No certificate or issuer provided'));<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Get OCSP URL from certificate<br>
&nbsp;&nbsp;const ocspUrl = tls.getOCSPURL(cert);<br>
&nbsp;&nbsp;if (!ocspUrl) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;return callback(new Error('No OCSP URL in certificate'));<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;console.log('OCSP request for:', cert.subject.CN);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// In a real application, you would make an OCSP request here<br>
&nbsp;&nbsp;// and return the response via the callback<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// For demonstration, we'll just return a dummy response<br>
&nbsp;&nbsp;const ocspResponse = Buffer.from('OCSP response would go here');<br>
&nbsp;&nbsp;callback(null, ocspResponse);<br>
});<br>
<br>
server.listen(443, () => {<br>
&nbsp;&nbsp;console.log('HTTPS server with OCSP stapling running on port 443');<br>
});<br>
<br>
// Client that verifies OCSP stapling<br>
const clientOptions = {<br>
&nbsp;&nbsp;host: 'example.com',<br>
&nbsp;&nbsp;port: 443,<br>
&nbsp;&nbsp;rejectUnauthorized: true,<br>
&nbsp;&nbsp;requestOCSP: true&nbsp;&nbsp;// Request OCSP stapling from server<br>
};<br>
<br>
const req = https.request(clientOptions, (res) => {<br>
&nbsp;&nbsp;console.log('Response status code:', res.statusCode);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Get the OCSP response from the server<br>
&nbsp;&nbsp;const ocspResponse = res.socket.getOCSPResponse();<br>
&nbsp;&nbsp;if (ocspResponse) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Received OCSP response');<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Verify the OCSP response here<br>
&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('No OCSP response received');<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;res.on('data', (chunk) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Received data:', chunk.toString());<br>
&nbsp;&nbsp;});<br>
});<br>
<br>
req.on('error', (err) => {<br>
&nbsp;&nbsp;console.error('Request error:', err);<br>
});<br>
<br>
req.end();
</div>
...
<h3>5. ALPN and SNI Support</h3>

<p>Application-Layer Protocol Negotiation (ALPN) and Server Name Indication (SNI) are important TLS extensions that enable protocol negotiation and virtual hosting:</p>
...
const path = require('path');<br>
<br>
// Server with ALPN and SNI support<br>
const serverOptions = {<br>
&nbsp;&nbsp;// ALPN protocols in order of preference<br>
&nbsp;&nbsp;ALPNProtocols: ['h2', 'http/1.1'],<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// SNI callback for multiple domains<br>
&nbsp;&nbsp;SNICallback: (servername, cb) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('SNI request for:', servername);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;let context;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Create different contexts for different domains<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (servername === 'example.com') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;context = tls.createSecureContext({<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;key: fs.readFileSync(path.join(__dirname, 'example.com-key.pem')),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;cert: fs.readFileSync(path.join(__dirname, 'example.com-cert.pem')),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Enable OCSP stapling for this domain<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;requestOCSP: true,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Custom cipher suites for this domain<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ciphers: [<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'TLS_AES_256_GCM_SHA384',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'TLS_CHACHA20_POLY1305_SHA256',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'TLS_AES_128_GCM_SHA256'<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Default context for other domains<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;context = tls.createSecureContext({<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;key: fs.readFileSync(path.join(__dirname, 'default-key.pem')),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;cert: fs.readFileSync(path.join(__dirname, 'default-cert.pem')),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Less strict ciphers for legacy clients<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ciphers: [<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'TLS_AES_256_GCM_SHA384',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'TLS_CHACHA20_POLY1305_SHA256',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'TLS_AES_128_GCM_SHA256',<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Set ALPN protocols for this context<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;context.setALPNProtocols(['h2', 'http/1.1']);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Return the created context<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (cb) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;cb(null, context);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return context;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;} catch (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error('SNI callback error:', err);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (cb) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;cb(err);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;throw err;<br>
...
&nbsp;&nbsp;},<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Default key and cert (used if SNI is not supported by client)<br>
&nbsp;&nbsp;key: fs.readFileSync(path.join(__dirname, 'default-key.pem')),<br>
&nbsp;&nbsp;cert: fs.readFileSync(path.join(__dirname, 'default-cert.pem'))<br>
};<br>
<br>
// Create HTTP/2 server with ALPN and SNI<br>
const http2Server = http2.createSecureServer(serverOptions, (req, res) => {<br>
&nbsp;&nbsp;const protocol = req.socket.alpnProtocol;<br>
&nbsp;&nbsp;res.writeHead(200);<br>
&nbsp;&nbsp;res.end(`Hello from ${req.socket.servername} using ${protocol}\n`);<br>
});<br>
<br>
http2Server.on('error', (err) => {<br>
&nbsp;&nbsp;console.error('HTTP/2 server error:', err);<br>
});<br>
<br>
http2Server.on('stream', (stream, headers) => {<br>
&nbsp;&nbsp;const protocol = stream.session.alpnProtocol;<br>
&nbsp;&nbsp;const hostname = stream.session.servername || 'unknown';<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;stream.respond({<br>
...
<br>
// Create HTTPS server with ALPN and SNI<br>
const httpsServer = https.createServer(serverOptions, (req, res) => {<br>
&nbsp;&nbsp;const protocol = req.socket.alpnProtocol;<br>
&nbsp;&nbsp;res.writeHead(200, { 'Content-Type': 'text/plain' });<br>
&nbsp;&nbsp;res.end(`Hello from ${req.socket.servername} using ${protocol || 'HTTP/1.1'}\n`);<br>
});<br>
<br>
// Handle upgrade to HTTP/2<br>
httpsServer.on('upgrade', (req, socket, head) => {<br>
&nbsp;&nbsp;const protocol = req.socket.alpnProtocol;<br>
&nbsp;&nbsp;if (protocol === 'h2') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;http2Server.emit('connection', socket);<br>
&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;socket.destroy();<br>
&nbsp;&nbsp;}<br>
});<br>
...
const PORT = 443;<br>
<br>
httpsServer.listen(PORT, () => {<br>
&nbsp;&nbsp;console.log(`HTTPS server running on port ${PORT}`);<br>
});<br>
<br>
// Client example<br>
function makeRequest(hostname, port = 443) {<br>
&nbsp;&nbsp;const options = {<br>
&nbsp;&nbsp;&nbsp;&nbsp;hostname,<br>
&nbsp;&nbsp;&nbsp;&nbsp;port,<br>
&nbsp;&nbsp;&nbsp;&nbsp;path: '/',<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;rejectUnauthorized: false, // For testing with self-signed certs<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Custom check for server identity<br>
&nbsp;&nbsp;&nbsp;&nbsp;checkServerIdentity: (host, cert) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Implement custom certificate validation<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return undefined; // No error means success<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;};<br>
<br>
&nbsp;&nbsp;const req = https.request(options, (res) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Status: ${res.statusCode}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('ALPN Protocol:', res.socket.alpnProtocol);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Negotiated Protocol:', res.socket.getProtocol());<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;let data = '';<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.on('data', (chunk) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;data += chunk;<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.on('end', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Response:', data.trim());<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;});<br>
<br>
&nbsp;&nbsp;req.on('error', (err) => {<br>
...
<br>
// Example usage<br>
// makeRequest('example.com');<br>
// makeRequest('another-domain.com');<br>
</div>
</div>

<h3>6. Use HTTP Strict Transport Security (HSTS)</h3>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// In an Express application<br>
app.use((req, res, next) => {<br>
&nbsp;&nbsp;res.setHeader('Strict-Transport-Security', 'max-age=31536000; includeSubDomains; preload');<br>
&nbsp;&nbsp;next();<br>
});
</div>
</div>
...
<div id="exercisecontainer" src="xrcise_tls.js" data-extensions="asp"></div>
