...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Message Reference</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js Message Reference">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/ref_message.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="The http.IncomingMessage object represents the incoming HTTP request or response in Node.js.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Message Reference">
<meta name="twitter:description" content="The http.IncomingMessage object represents the incoming HTTP request or response in Node.js.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/ref_message.png">
...
<h1>Node.js Message Reference</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="ref_response.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ref_interface.asp">Next &#10095;</a>
</div>

<hr>

<h2>HTTP Message Object</h2>

<p>The <code class="w3-codespan">http.IncomingMessage</code> object is created by the <code class="w3-codespan">http.Server</code> or <code class="w3-codespan">http.ClientRequest</code> and passed as the first argument to the 'request' and 'response' event respectively. It is used to access response status, headers, and data.</p>

<p>This message object represents both:</p>
<ul>
  <li>The HTTP request received by the server (passed to the 'request' event)</li>
  <li>The HTTP response received by the client (passed to the 'response' event)</li>
</ul>

<p>It implements the <code class="w3-codespan">Readable Stream</code> interface, allowing you to consume the message body.</p>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    ...
    <td>A boolean indicating if the entire message has been received and parsed.</td>
  </tr>
  <tr>
    <td>message.headers</td>
    <td>The request/response headers object.</td>
  </tr>
  <tr>
    <td>message.httpVersion</td>
    <td>The HTTP version sent by the client. Typically either '1.0' or '1.1'.</td>
  </tr>
  <tr>
    <td>message.method</td>
    <td>The request method as a string (e.g., 'GET', 'POST'). Only valid for request messages from http.Server.</td>
  </tr>
  <tr>
    <td>message.rawHeaders</td>
    <td>The raw request/response headers list exactly as they were received. The odd-numbered entries are key names, and the even-numbered entries are values.</td>
  </tr>
  <tr>
    <td>message.rawTrailers</td>
    <td>The raw request/response trailer keys and values exactly as they were received.</td>
  </tr>
  <tr>
    <td>message.socket</td>
    <td>The <code class="w3-codespan">net.Socket</code> object associated with the connection.</td>
  </tr>
  <tr>
    <td>message.statusCode</td>
    <td>The HTTP response status code. Only valid for response messages from http.ClientRequest.</td>
  </tr>
  <tr>
    <td>message.statusMessage</td>
    <td>The HTTP response status message. Only valid for response messages from http.ClientRequest.</td>
  </tr>
  <tr>
    <td>message.trailers</td>
    <td>The request/response trailer headers object.</td>
  </tr>
  <tr>
    <td>message.url</td>
    <td>The request URL string. Only valid for request messages from http.Server.</td>
  </tr>
</table>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td>message.destroy([error])</td>
    <td>Calls <code class="w3-codespan">destroy()</code> on the socket that received this message. If <code class="w3-codespan">error</code> is provided, an 'error' event is emitted and the error is passed as an argument.</td>
  </tr>
  <tr>
    <td>message.setTimeout(msecs, callback)</td>
    <td>Calls <code class="w3-codespan">socket.setTimeout(msecs, callback)</code>.</td>
  </tr>
</table>

<hr>

<h2>Message as a Readable Stream</h2>

<p>Because <code class="w3-codespan">http.IncomingMessage</code> implements the Readable Stream interface, it includes all stream methods like <code class="w3-codespan">read()</code>, <code class="w3-codespan">pipe()</code>, and events like 'data', 'end', and 'error'.</p>

<hr>

<h2>Examples</h2>

<h3>Server-side Message (Request)</h3>

<p>This example demonstrates handling the IncomingMessage object on the server side:</p>
...
&nbsp;&nbsp;// 'req' is the IncomingMessage object<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Basic message properties<br>
&nbsp;&nbsp;console.log('HTTP Version:', req.httpVersion);<br>
&nbsp;&nbsp;console.log('Method:', req.method);<br>
&nbsp;&nbsp;console.log('URL:', req.url);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Parse the URL<br>
&nbsp;&nbsp;const parsedUrl = url.parse(req.url, true);<br>
&nbsp;&nbsp;console.log('Pathname:', parsedUrl.pathname);<br>
&nbsp;&nbsp;console.log('Query:', parsedUrl.query);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Headers<br>
&nbsp;&nbsp;console.log('Headers:', req.headers);<br>
&nbsp;&nbsp;console.log('User-Agent:', req.headers['user-agent']);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Raw headers with keys and values as separate array elements<br>
&nbsp;&nbsp;console.log('Raw Headers:', req.rawHeaders);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Socket information<br>
&nbsp;&nbsp;console.log('Remote Address:', req.socket.remoteAddress);<br>
&nbsp;&nbsp;console.log('Remote Port:', req.socket.remotePort);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Reading the message body (if any)<br>
&nbsp;&nbsp;let body = [];<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Request body:', body);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Now that we have the body, send a response<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.writeHead(200, { 'Content-Type': 'application/json' });<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.end(JSON.stringify({<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;httpVersion: req.httpVersion,<br>
...
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Make a test request<br>
&nbsp;&nbsp;http.request({<br>
&nbsp;&nbsp;&nbsp;&nbsp;hostname: 'localhost',<br>
&nbsp;&nbsp;&nbsp;&nbsp;port: PORT,<br>
&nbsp;&nbsp;&nbsp;&nbsp;path: '/test?param1=value1&param2=value2',<br>
&nbsp;&nbsp;&nbsp;&nbsp;method: 'POST',<br>
&nbsp;&nbsp;&nbsp;&nbsp;headers: {<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}, (res) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.resume(); // Consume response data<br>
&nbsp;&nbsp;}).end('{"message":"Hello from the client!"}');<br>
});
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_message_server">Run example &raquo;</a>
</div>

<hr>

<h3>Client-side Message (Response)</h3>

<p>This example demonstrates handling the IncomingMessage object on the client side:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const http = require('http');<br>
<br>
// Make an HTTP request<br>
const req = http.request('http://example.com', (res) => {<br>
&nbsp;&nbsp;// 'res' is the IncomingMessage object (response)<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Basic message properties<br>
&nbsp;&nbsp;console.log('Status Code:', res.statusCode);<br>
&nbsp;&nbsp;console.log('Status Message:', res.statusMessage);<br>
&nbsp;&nbsp;console.log('HTTP Version:', res.httpVersion);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Headers<br>
&nbsp;&nbsp;console.log('Headers:', res.headers);<br>
&nbsp;&nbsp;console.log('Content-Type:', res.headers['content-type']);<br>
&nbsp;&nbsp;console.log('Raw Headers:', res.rawHeaders);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Socket information<br>
&nbsp;&nbsp;console.log('Remote Address:', res.socket.remoteAddress);<br>
&nbsp;&nbsp;console.log('Remote Port:', res.socket.remotePort);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Reading the message body<br>
&nbsp;&nbsp;let body = [];<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Data events emit when chunks of the body are received<br>
&nbsp;&nbsp;res.on('data', (chunk) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;body.push(chunk);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Received chunk of', chunk.length, 'bytes');<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// End event is emitted when the entire body has been received<br>
&nbsp;&nbsp;res.on('end', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;body = Buffer.concat(body).toString();<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Body length:', body.length);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Body preview:', body.substring(0, 100) + '...');<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Check trailers (if any)<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Trailers:', res.trailers);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Raw Trailers:', res.rawTrailers);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Check if message is complete<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Message complete:', res.complete);<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Handle message errors<br>
&nbsp;&nbsp;res.on('error', (err) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error('Response error:', err);<br>
&nbsp;&nbsp;});<br>
});<br>
<br>
// Handle request errors<br>
req.on('error', (err) => {<br>
&nbsp;&nbsp;console.error('Request error:', err);<br>
});<br>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_message_client">Run example &raquo;</a>
</div>

<hr>

<h3>Handling Message Body with Streams</h3>

<p>This example demonstrates using stream methods to handle a message body:</p>
...
<br>
// Create a server to handle file uploads<br>
const server = http.createServer((req, res) => {<br>
&nbsp;&nbsp;if (req.method === 'POST' && req.url === '/upload') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Create a write stream to a file<br>
&nbsp;&nbsp;&nbsp;&nbsp;const filePath = path.join(__dirname, 'uploaded-file.txt');<br>
&nbsp;&nbsp;&nbsp;&nbsp;const fileStream = fs.createWriteStream(filePath);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Pipe the request body directly to the file<br>
&nbsp;&nbsp;&nbsp;&nbsp;req.pipe(fileStream);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Handle completion<br>
&nbsp;&nbsp;&nbsp;&nbsp;fileStream.on('finish', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Get file stats to check size<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;fs.stat(filePath, (err, stats) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error('Error getting file stats:', err);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;res.writeHead(500, {'Content-Type': 'text/plain'});<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;res.end('Error processing upload');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Send response<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}));<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`File uploaded to ${filePath}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`File size: ${stats.size} bytes`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Clean up the file after a delay<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;fs.unlink(filePath, (err) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (err) console.error('Error removing uploaded file:', err);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;else console.log('Uploaded file removed');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}, 5000);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error('File write error:', err);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;res.writeHead(500, {'Content-Type': 'text/plain'});<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;res.end('Error saving file');<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;req.on('error', (err) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error('Request error:', err);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;fileStream.destroy(err);<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;} <br>
&nbsp;&nbsp;else if (req.method === 'GET' && req.url === '/') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Provide a simple HTML form for uploading<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/head&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;body&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;h1&gt;Upload a Text File&lt;/h1&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;form action="/upload" method="post" enctype="multipart/form-data"><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;input type="file" name="file" accept=".txt"><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;button type="submit">Upload&lt;/button><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/form&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;p&gt;Note: This is a simple example. A real implementation would need to parse multipart form data.&lt;/p&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/body&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/html&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;`);<br>
&nbsp;&nbsp;} <br>
&nbsp;&nbsp;else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Handle all other requests<br>
...
&nbsp;&nbsp;console.log(`Server running at http://localhost:${PORT}/`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Make a test upload<br>
&nbsp;&nbsp;setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const req = http.request({<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;hostname: 'localhost',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;port: PORT,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;path: '/upload',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;method: 'POST',<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;}, (res) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;let data = '';<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;res.on('data', (chunk) => { data += chunk; });<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;res.on('end', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Upload response:', data);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;req.on('error', (e) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error('Test request error:', e.message);<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Write some content to upload<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_message_stream">Run example &raquo;</a>
</div>

<hr>

<h3>Handling Message Trailers</h3>

<p>This example demonstrates handling HTTP trailers (headers that come after the message body):</p>
...
<br>
// Create an HTTP server that sends trailers<br>
const server = http.createServer((req, res) => {<br>
&nbsp;&nbsp;// Inform the client we'll be sending trailers<br>
&nbsp;&nbsp;res.writeHead(200, {<br>
&nbsp;&nbsp;&nbsp;&nbsp;'Content-Type': 'text/plain',<br>
&nbsp;&nbsp;&nbsp;&nbsp;'Transfer-Encoding': 'chunked', // Required for trailers<br>
&nbsp;&nbsp;&nbsp;&nbsp;'Trailer': 'Content-MD5, X-Response-Time' // Declare which trailers will be sent<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Write some response data<br>
&nbsp;&nbsp;res.write('Beginning of the response\n');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Simulate processing time<br>
&nbsp;&nbsp;setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.write('Middle of the response\n');<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Final part of the body<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;res.write('End of the response\n');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Add trailers<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;res.addTrailers({<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'Content-MD5': 'e4e68fb7bd0e697a0ae8f1bb342846d3', // Would normally be the hash of the body<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'X-Response-Time': `${Date.now() - req.start}ms` // Processing time<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// End the response<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;res.end();<br>
...
<br>
// Track request start time<br>
server.on('request', (req) => {<br>
&nbsp;&nbsp;req.start = Date.now();<br>
});<br>
<br>
// Start server<br>
const PORT = 8080;<br>
...
&nbsp;&nbsp;console.log(`Server running at http://localhost:${PORT}/`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Make a request to test trailers<br>
&nbsp;&nbsp;http.get(`http://localhost:${PORT}`, (res) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Response status:', res.statusCode);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Response headers:', res.headers);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Check if trailers are declared<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (res.headers.trailer) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Trailer headers declared:', res.headers.trailer);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;res.on('data', (chunk) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;body += chunk;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Received chunk:', chunk.toString());<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// The 'end' event is emitted when the entire body has been received<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.on('end', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Complete response body:', body);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Trailers received:', res.trailers);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Server should close after test is complete<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;server.close();<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;}).on('error', (err) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error('Request error:', err);<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_message_trailers">Run example &raquo;</a>
</div>

<hr>

<h3>Handling Large Messages with Flow Control</h3>

<p>This example demonstrates handling large message bodies with flow control:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const http = require('http');<br>
<br>
// Create a server to handle large uploads with flow control<br>
const server = http.createServer((req, res) => {<br>
&nbsp;&nbsp;if (req.method === 'POST' && req.url === '/large-upload') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Set up variables to track data<br>
&nbsp;&nbsp;&nbsp;&nbsp;let dataSize = 0;<br>
&nbsp;&nbsp;&nbsp;&nbsp;let chunks = 0;<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Switch to pause mode (by default it's in flowing mode)<br>
&nbsp;&nbsp;&nbsp;&nbsp;req.pause();<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Incoming large upload - using flow control');<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Process data in chunks<br>
&nbsp;&nbsp;&nbsp;&nbsp;function processNextChunk() {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Resume the stream to get more data<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;req.resume();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Set a timeout to pause after a bit<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Pause the stream again<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;req.pause();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Processed chunk ${++chunks}, total ${dataSize} bytes so far`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// If there's more data to process, schedule the next chunk<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Otherwise, wait for 'end' event to finish<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (!req.complete) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Schedule next chunk processing<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;setTimeout(processNextChunk, 100);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}, 100); // Process for 100ms, then pause<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Listen for data events<br>
&nbsp;&nbsp;&nbsp;&nbsp;req.on('data', (chunk) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;dataSize += chunk.length;<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Handle request end<br>
&nbsp;&nbsp;&nbsp;&nbsp;req.on('end', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Upload complete: ${dataSize} bytes received in ${chunks} chunks`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Send a response<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;res.writeHead(200, {'Content-Type': 'application/json'});<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;res.end(JSON.stringify({<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;success: true,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;bytesReceived: dataSize,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;chunks: chunks<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}));<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;res.writeHead(500, {'Content-Type': 'text/plain'});<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;res.end('Error processing upload: ' + err.message);<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Start processing<br>
&nbsp;&nbsp;&nbsp;&nbsp;processNextChunk();<br>
...
&nbsp;&nbsp;console.log(`Server running at http://localhost:${PORT}/`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Create a test client to simulate large upload<br>
&nbsp;&nbsp;console.log('Simulating large upload...');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;const req = http.request({<br>
&nbsp;&nbsp;&nbsp;&nbsp;hostname: 'localhost',<br>
&nbsp;&nbsp;&nbsp;&nbsp;port: PORT,<br>
&nbsp;&nbsp;&nbsp;&nbsp;path: '/large-upload',<br>
&nbsp;&nbsp;&nbsp;&nbsp;method: 'POST',<br>
&nbsp;&nbsp;&nbsp;&nbsp;headers: {<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.on('end', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Server response:', responseData);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Close the server after the test<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;server.close();<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;req.on('error', (err) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error('Upload request error:', err);<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Generate and send a large body in chunks<br>
&nbsp;&nbsp;function sendChunk(i, total) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (i >= total) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// All chunks sent, end the request<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;req.end();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return;<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Create a 10KB chunk<br>
&nbsp;&nbsp;&nbsp;&nbsp;const chunk = Buffer.alloc(10240);<br>
&nbsp;&nbsp;&nbsp;&nbsp;chunk.fill(65 + (i % 26)); // Fill with repeating letters<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Write the chunk<br>
&nbsp;&nbsp;&nbsp;&nbsp;const canContinue = req.write(chunk);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Log progress<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (i % 10 === 0) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Sent chunk ${i}/${total} (${i * 10240} bytes)`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// If we can continue writing, schedule next chunk<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (canContinue) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Schedule next chunk<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;setImmediate(() => sendChunk(i + 1, total));<br>
&nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// If backpressure is applied, wait for drain event<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Backpressure applied, waiting for drain');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;req.once('drain', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Drained, continuing upload');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;sendChunk(i + 1, total);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Start sending chunks (50 chunks = ~500KB)<br>
&nbsp;&nbsp;sendChunk(0, 50);<br>
});
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_message_flow">Run example &raquo;</a>
</div>
...
<ol>
  <li><strong>Check for complete messages</strong>: Use <code class="w3-codespan">message.complete</code> to ensure the entire message has been received.</li>
  <li><strong>Handle errors</strong>: Always listen for the 'error' event on message objects.</li>
  <li><strong>Flow control</strong>: For large messages, use <code class="w3-codespan">pause()</code> and <code class="w3-codespan">resume()</code> to control data flow.</li>
  <li><strong>Stream processing</strong>: Use stream methods like <code class="w3-codespan">pipe()</code> for efficient processing of message bodies.</li>
  <li><strong>Memory management</strong>: For large messages, process data in chunks rather than loading the entire message into memory.</li>
  <li><strong>URL parsing</strong>: Use the <code class="w3-codespan">url</code> module to parse URL strings from <code class="w3-codespan">request.url</code>.</li>
  <li><strong>Header handling</strong>: Be aware that HTTP headers are case-insensitive, but Node.js converts them to lowercase.</li>
</ol>
