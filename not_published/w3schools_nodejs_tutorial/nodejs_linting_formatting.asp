...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Linting & Formatting</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js Linting &amp; Formatting">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_linting_formatting.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="Consistent code quality and style is important for Node.js projects, especially in team environments.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Linting &amp; Formatting">
<meta name="twitter:description" content="Consistent code quality and style is important for Node.js projects, especially in team environments.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_linting_formatting.png">
...
<h1>Node.js <span class="color_h1">Linting & Formatting</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_typescript_advanced.asp">&lt; Previous</a>
<a class="w3-right w3-btn" href="nodejs_frameworks.asp">Next &gt;</a>
</div>
<hr>
<h2>Code Quality</h2>
<p>Consistent code quality and style is important for Node.js projects, especially in team environments.</p>
<p>It helps with:</p>
<ul>
  <li>Readability and maintainability of code</li>
  <li>Early bug detection and prevention</li>
  <li>Consistent coding style across the team</li>
  <li>Automated code reviews</li>
  <li>Better developer experience</li>
</ul>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> This guide covers both JavaScript and TypeScript tooling, as they share similar linting and formatting ecosystems.</p>
</div>

<hr>

<h2>ESLint: JavaScript/TypeScript Linting</h2>

<p>ESLint is the most popular JavaScript/TypeScript linting tool that helps identify and report on patterns found in your code. It's highly configurable and supports:</p>
<ul>
  <li>Custom rules and configurations</li>
  <li>TypeScript support through <code class="w3-codespan">@typescript-eslint/parser</code></li>
  <li>Plugin ecosystem for framework-specific rules</li>
  <li>Automatic fixing of common issues</li>
</ul>
...
<h3>Comprehensive ESLint Configuration</h3>
<p>Here's a more complete <code class="w3-codespan">.eslintrc.json</code> configuration for a Node.js project with TypeScript support:</p>
<div class="w3-example">
<div class="w3-code notranslate">
{<br>
&nbsp;&nbsp;"env": {<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;"indent": ["error", 2],<br>
&nbsp;&nbsp;&nbsp;&nbsp;"no-console": "warn",<br>
&nbsp;&nbsp;&nbsp;&nbsp;"no-unused-vars": "warn"<br>
&nbsp;&nbsp;}<br>
}</div>
</div>

<h3>Advanced ESLint Usage</h3>
<p>Beyond basic linting, ESLint offers powerful features for maintaining code quality:</p>

<h4>Common Commands</h4>
<div class="w3-example">
<div class="w3-code notranslate">
# Lint all JavaScript/TypeScript files<br>
npx eslint .<br>
<br>
# Fix auto-fixable issues<br>
npx eslint --fix .<br>
<br>
# Lint specific file<br>
npx eslint src/index.js</div>
</div>
...
<p>Prettier is an opinionated code formatter that enforces a consistent style by parsing your code and re-printing it with its own rules. It supports:</p>
<ul>
  <li>JavaScript, TypeScript, JSX, CSS, SCSS, JSON, and more</li>
  <li>Opinionated defaults with minimal configuration</li>
  <li>Integration with ESLint and other tools</li>
  <li>Support for editor integration</li>
</ul>

<div class="w3-panel ws-note">
  <p><strong>Tip:</strong> Use Prettier for formatting and ESLint for catching potential errors and enforcing code patterns.</p>
</div>
...
<h3>Comprehensive Prettier Configuration</h3>
<p>Here's a well-documented <code class="w3-codespan">.prettierrc</code> configuration with common options:</p>
<div class="w3-example">
<div class="w3-code notranslate">
{<br>
&nbsp;&nbsp;"semi": true,<br>
...
<h3>Advanced Prettier Usage</h3>
<p>Prettier can be customized and integrated into your workflow in various ways:</p>
...
<br>
# Check formatting without making changes<br>
npx prettier --check .<br>
<br>
# Format specific file<br>
npx prettier --write src/index.js</div>
</div>

<h3>Seamless ESLint + Prettier Integration</h3>
<p>To avoid conflicts between ESLint and Prettier, set up proper integration:</p>

<div class="w3-panel ws-warning">
  <p><strong>Important:</strong> Always install and configure these packages to prevent rule conflicts:</p>
</div>
<div class="w3-example">
<div class="w3-code notranslate">
...
<p>Then update your ESLint config:</p>
<div class="w3-example">
<div class="w3-code notranslate">
{<br>
&nbsp;&nbsp;"extends": [<br>
...
<h2>Advanced Editor Integration</h2>

<div class="w3-panel ws-note">
  <p><strong>Pro Tip:</strong> Set up your editor to automatically fix and format code on save for maximum productivity.</p>
</div>

<h3>VS Code: Ultimate Setup</h3>
<p>For the best development experience in VS Code, follow these steps:</p>
...
<ol>
  <li>Install the following extensions:
    <ul>
      ...
      <li>Error Lens (for inline error highlighting)</li>
    </ul>
  </li>
  <li>Configure your VS Code settings.json:</li>
</ol>
<ol>
  <li>Install the ESLint and Prettier extensions</li>
  <li>Add these settings to your VS Code settings.json:</li>
</ol>
...
<h3>Other Editor Setups</h3>
<p>Here are setup instructions for other popular editors:</p>
<ul>
  <li><strong>WebStorm/IntelliJ</strong>: Built-in support for ESLint and Prettier</li>
  <li><strong>Atom</strong>: Install linter-eslint and prettier-atom packages</li>
  <li><strong>Sublime Text</strong>: Install SublimeLinter and SublimeLinter-eslint</li>
</ul>

<hr>

<h2>Git Hooks with Husky & lint-staged</h2>

<p>Prevent bad code from being committed by setting up pre-commit hooks that automatically format and lint your code:</p>

<div class="w3-panel ws-note">
  <p><strong>Why use pre-commit hooks?</strong> They ensure consistent code quality across your team by automatically fixing style issues before code is committed.</p>
</div>

<p>Ensure code quality before commits with pre-commit hooks:</p>
...
<h3>1. Monorepo Setup</h3>
<p>For projects using a monorepo structure:</p>
<div class="w3-example">
<div class="w3-code notranslate">
// In your root package.json<br>
{<br>
&nbsp;&nbsp;"workspaces": ["packages/*"],<br>
&nbsp;&nbsp;"scripts": {<br>
&nbsp;&nbsp;&nbsp;&nbsp;"lint": "yarn workspaces run lint",<br>
&nbsp;&nbsp;&nbsp;&nbsp;"format": "prettier --write \"**/*.{js,jsx,ts,tsx,json,md}\""<br>
&nbsp;&nbsp;},<br>
&nbsp;&nbsp;"devDependencies": {<br>
&nbsp;&nbsp;&nbsp;&nbsp;"@typescript-eslint/eslint-plugin": "^5.0.0",<br>
&nbsp;&nbsp;&nbsp;&nbsp;"@typescript-eslint/parser": "^5.0.0",<br>
&nbsp;&nbsp;&nbsp;&nbsp;"eslint": "^8.0.0",<br>
&nbsp;&nbsp;&nbsp;&nbsp;"eslint-config-prettier": "^8.3.0",<br>
&nbsp;&nbsp;&nbsp;&nbsp;"eslint-plugin-prettier": "^4.0.0",<br>
&nbsp;&nbsp;&nbsp;&nbsp;"husky": "^7.0.4",<br>
&nbsp;&nbsp;&nbsp;&nbsp;"lint-staged": "^12.0.0",<br>
&nbsp;&nbsp;&nbsp;&nbsp;"prettier": "^2.5.0",<br>
&nbsp;&nbsp;&nbsp;&nbsp;"typescript": "^4.5.0"<br>
&nbsp;&nbsp;},<br>
&nbsp;&nbsp;"lint-staged": {<br>
...
<p>For large projects, optimize ESLint performance:</p>
<div class="w3-example">
<div class="w3-code notranslate">
// .eslintrc.js<br>
module.exports = {<br>
&nbsp;&nbsp;cache: true, // Enable caching<br>
&nbsp;&nbsp;cacheLocation: '.eslintcache', // Cache file location<br>
&nbsp;&nbsp;ignorePatterns: ['**/node_modules/**', '**/dist/**'], // Ignore patterns<br>
&nbsp;&nbsp;parserOptions: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;project: './tsconfig.json', // Only for TypeScript<br>
&nbsp;&nbsp;&nbsp;&nbspprojectFolderIgnoreList: ['**/node_modules/**']<br>
&nbsp;&nbsp;}<br>
};</div>
</div>

<h3>3. EditorConfig for Cross-Editor Consistency</h3>
<p>Add a <code class="w3-codespan">.editorconfig</code> file to maintain consistent coding styles across different editors and IDEs:</p>
<div class="w3-example">
<div class="w3-code notranslate">
# EditorConfig is awesome: https://EditorConfig.org<br>
root = true<br>
<br>
[*]<br>
charset = utf-8<br>
...
<br>
[*.{cmd,sh}]<br>
indent_style = tab</div>
</div>

<h3>4. CI/CD Integration</h3>
<p>Add linting and formatting checks to your CI/CD pipeline:</p>
<div class="w3-example">
<div class="w3-code notranslate">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- run: npm ci<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- run: npm run lint<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- run: npm run format:check</div>
</div>

<h3>Linting Best Practices</h3>
<ul>
  <li>Start with a base config (like <code class="w3-codespan">eslint:recommended</code>) and extend as needed</li>
  <li>Be consistent with rule severity levels (error, warn, off)</li>
  <li>Document rule exceptions with comments when necessary</li>
  <li>Regularly update your ESLint and plugin versions</li>
  <li>Use TypeScript-specific rules when working with TypeScript</li>
</ul>

<h3>Formatting Best Practices</h3>
<ul>
  <li>Keep line lengths reasonable (80-120 characters)</li>
  <li>Use consistent quote style (single or double quotes)</li>
  <li>Be consistent with semicolon usage</li>
  <li>Use trailing commas in objects and arrays for cleaner diffs</li>
  <li>Configure your editor to format on save</li>
</ul>

<h3>Team Workflow</h3>
<ul>
  <li>Share ESLint and Prettier configs across the team</li>
  <li>Include linting and formatting in CI/CD pipelines</li>
  <li>Use pre-commit hooks to catch issues early</li>
  <li>Document your code style decisions</li>
  <li>Regularly review and update your code style guide</li>
</ul>

<hr>
<div id="exercisecontainer" src="xrcise_linting_formatting.js" data-extensions="asp"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_typescript_advanced.asp">&lt; Previous</a>
