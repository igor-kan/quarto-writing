...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Server Reference</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js Server Reference">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/ref_server.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="Server objects in Node.js are used to create network servers.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Server Reference">
<meta name="twitter:description" content="Server objects in Node.js are used to create network servers.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/ref_server.png">
...
<h1>Node.js Server Reference</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="ref_writestream.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ref_agent.asp">Next &#10095;</a>
</div>
...
<p>Server objects in Node.js are used to create network servers. Different modules provide their own Server implementations:</p>

<ul>
  <li><code class="w3-codespan">http.Server</code> - For creating HTTP servers</li>
  <li><code class="w3-codespan">https.Server</code> - For creating HTTPS servers</li>
  <li><code class="w3-codespan">net.Server</code> - For creating TCP servers</li>
  <li><code class="w3-codespan">tls.Server</code> - For creating TLS/SSL servers</li>
</ul>

<p>These server objects handle client connections, process requests, and deliver responses as appropriate for their respective protocols.</p>

<hr>

<h2>Common Server Methods</h2>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td>server.listen([port][, host][, backlog][, callback])</td>
    <td>Starts the server listening for connections. The callback is executed when the server has been bound.</td>
  </tr>
  <tr>
    <td>server.close([callback])</td>
    <td>Stops the server from accepting new connections. The callback is called when all connections are closed.</td>
  </tr>
  <tr>
    <td>server.address()</td>
    <td>Returns the bound address, the address family name, and port of the server.</td>
  </tr>
  <tr>
    <td>server.getConnections(callback)</td>
    <td>Asynchronously gets the number of concurrent connections on the server.</td>
  </tr>
</table>

<hr>

<h2>Common Server Events</h2>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td>'close'</td>
    <td>Emitted when the server closes.</td>
  </tr>
  <tr>
    <td>'connection'</td>
    <td>Emitted when a new connection is made.</td>
  </tr>
  <tr>
    <td>'error'</td>
...
<p>The HTTP server in Node.js is created using the <code class="w3-codespan">http.createServer()</code> method:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_server_http">Run example &raquo;</a>
</div>
...
<p>The HTTPS server requires SSL certificates and is created using the <code class="w3-codespan">https.createServer()</code> method:</p>
...
<br>
// SSL options - in a production environment, use properly signed certificates<br>
const options = {<br>
&nbsp;&nbsp;key: fs.readFileSync('server-key.pem'),&nbsp;&nbsp;// Path to your key file<br>
&nbsp;&nbsp;cert: fs.readFileSync('server-cert.pem') // Path to your certificate file<br>
};<br>
<br>
// Create an HTTPS server<br>
const server = https.createServer(options, (req, res) => {<br>
&nbsp;&nbsp;res.writeHead(200, {'Content-Type': 'text/plain'});<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_server_https">Run example &raquo;</a>
</div>

<hr>

<h2>TCP Server (net.Server)</h2>

<p>A TCP server is created using the <code class="w3-codespan">net.createServer()</code> method:</p>
...
const PORT = 8888;<br>
server.listen(PORT, () => {<br>
&nbsp;&nbsp;console.log(`TCP server listening on port ${PORT}`);<br>
});<br>
<br>
// Get server information after it's listening<br>
server.on('listening', () => {<br>
&nbsp;&nbsp;const address = server.address();<br>
&nbsp;&nbsp;console.log(`Server info: ${JSON.stringify(address)}`);<br>
});
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_server_tcp">Run example &raquo;</a>
</div>

<hr>

<h2>TLS/SSL Server</h2>

<p>A secure TLS/SSL server is created using the <code class="w3-codespan">tls.createServer()</code> method:</p>
...
&nbsp;&nbsp;requestCert: true,<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Reject connections without certificates (optional)<br>
&nbsp;&nbsp;rejectUnauthorized: false<br>
};<br>
<br>
// Create a TLS server<br>
const server = tls.createServer(options, (socket) => {<br>
&nbsp;&nbsp;console.log('Client connected securely');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Check if client provided a certificate<br>
&nbsp;&nbsp;if (socket.authorized) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Client authorized');<br>
&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Client unauthorized');<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Handle data from client<br>
&nbsp;&nbsp;socket.on('data', (data) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Received: ${data}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;socket.write(`Secure echo: ${data}`);<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Handle client disconnection<br>
&nbsp;&nbsp;socket.on('end', () => {<br>
...
const PORT = 8443;<br>
server.listen(PORT, () => {<br>
&nbsp;&nbsp;console.log(`TLS server listening on port ${PORT}`);<br>
});
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_server_tls">Run example &raquo;</a>
</div>

<hr>

<h2>HTTP Server with Routing</h2>

<p>A more complete HTTP server with basic routing:</p>
...
<br>
// Create an HTTP server with routing<br>
const server = http.createServer((req, res) => {<br>
&nbsp;&nbsp;// Parse the URL<br>
&nbsp;&nbsp;const parsedUrl = url.parse(req.url, true);<br>
&nbsp;&nbsp;const path = parsedUrl.pathname;<br>
&nbsp;&nbsp;const trimmedPath = path.replace(/^\/+|\/+$/g, '');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Get the HTTP method<br>
&nbsp;&nbsp;const method = req.method.toLowerCase();<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Get query parameters<br>
&nbsp;&nbsp;const queryParams = parsedUrl.query;<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Log the request<br>
&nbsp;&nbsp;console.log(`Request received: ${method} ${trimmedPath}`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Route handler<br>
&nbsp;&nbsp;let response = {<br>
&nbsp;&nbsp;&nbsp;&nbsp;status: 404,<br>
&nbsp;&nbsp;&nbsp;&nbsp;contentType: 'application/json',<br>
&nbsp;&nbsp;&nbsp;&nbsp;payload: { message: 'Not Found' }<br>
&nbsp;&nbsp;};<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Basic routing<br>
&nbsp;&nbsp;if (method === 'get') {<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;payload: '&lt;h1&gt;Home Page&lt;/h1&gt;&lt;p&gt;Welcome to the server&lt;/p&gt;'<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;};<br>
&nbsp;&nbsp;&nbsp;&nbsp;} else if (trimmedPath === 'api/users') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// API route - list users<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;response = {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;status: 200,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;contentType: 'application/json',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;payload: { <br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;};<br>
&nbsp;&nbsp;&nbsp;&nbsp;} else if (trimmedPath.startsWith('api/users/')) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// API route - get user by ID<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const userId = trimmedPath.split('/')[2];<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;response = {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;status: 200,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;contentType: 'application/json',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;payload: { id: userId, name: `User ${userId}` }<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;};<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Return the response<br>
&nbsp;&nbsp;res.setHeader('Content-Type', response.contentType);<br>
&nbsp;&nbsp;res.writeHead(response.status);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Convert payload to string if it's an object<br>
&nbsp;&nbsp;const payloadString = typeof response.payload === 'object' <br>
&nbsp;&nbsp;&nbsp;&nbsp;? JSON.stringify(response.payload) <br>
&nbsp;&nbsp;&nbsp;&nbsp;: response.payload;<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;res.end(payloadString);<br>
});<br>
<br>
// Start the server<br>
const PORT = 8080;<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_server_routing">Run example &raquo;</a>
</div>

<hr>

<h2>Server Timeouts and Limits</h2>

<p>Configuring server timeouts and connection limits:</p>
...
// Create an HTTP server<br>
const server = http.createServer((req, res) => {<br>
&nbsp;&nbsp;// Simulating a delayed response<br>
&nbsp;&nbsp;setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.writeHead(200, {'Content-Type': 'text/plain'});<br>
...
<br>
// Configure server timeouts<br>
server.timeout = 10000; // 10 seconds (default is 120000 or 2 minutes)<br>
server.keepAliveTimeout = 5000; // 5 seconds (default is 5000)<br>
server.maxHeadersCount = 1000; // Maximum headers count (default is 2000)<br>
server.maxRequestsPerSocket = 100; // Max requests per socket (Node.js 14+)<br>
<br>
// Start the server<br>
const PORT = 8080;<br>
server.listen(PORT, () => {<br>
&nbsp;&nbsp;console.log(`Server with timeouts configured at http://localhost:${PORT}/`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Display the server configuration<br>
&nbsp;&nbsp;console.log(`Server timeout: ${server.timeout}ms`);<br>
&nbsp;&nbsp;console.log(`Keep-alive timeout: ${server.keepAliveTimeout}ms`);<br>
&nbsp;&nbsp;console.log(`Max headers count: ${server.maxHeadersCount}`);<br>
&nbsp;&nbsp;console.log(`Max requests per socket: ${server.maxRequestsPerSocket || 'N/A'}`);<br>
});
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_server_timeouts">Run example &raquo;</a>
</div>
...
<p>Creating an HTTP/2 server (introduced in Node.js v8.4.0):</p>
...
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;stream.end('&lt;h1&gt;HTTP/2 Server&lt;/h1&gt;&lt;p&gt;This page was served via HTTP/2&lt;/p&gt;');<br>
});<br>
<br>
// Start the server<br>
const PORT = 8443;<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_server_http2">Run example &raquo;</a>
</div>
...
<ol>
  <li><strong>Error handling</strong>: Always handle server errors by listening for the 'error' event.</li>
  <li><strong>Graceful shutdown</strong>: Implement proper shutdown procedures using <code class="w3-codespan">server.close()</code>.</li>
  <li><strong>Timeouts</strong>: Configure appropriate timeouts to prevent resource exhaustion.</li>
  <li><strong>Clustering</strong>: Use the <code class="w3-codespan">cluster</code> module to utilize multiple CPU cores.</li>
  <li><strong>HTTPS/TLS</strong>: Use secure servers for production applications.</li>
  <li><strong>Connection limits</strong>: Set appropriate limits based on your server's capabilities.</li>
  <li><strong>Monitoring</strong>: Implement monitoring for connections, requests, and response times.</li>
</ol>
