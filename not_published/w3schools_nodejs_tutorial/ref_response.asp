...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Response Reference</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js Response Reference">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/ref_response.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="The HTTP Response object in Node.js (http.ServerResponse) is created internally by an HTTP server, not by the user.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Response Reference">
<meta name="twitter:description" content="The HTTP Response object in Node.js (http.ServerResponse) is created internally by an HTTP server, not by the user.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/ref_response.png">
...
<h1>Node.js Response Reference</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="ref_request.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ref_message.asp">Next &#10095;</a>
</div>

<hr>

<h2>HTTP Response Object</h2>

<p>The HTTP Response object in Node.js (<code class="w3-codespan">http.ServerResponse</code>) is created internally by an HTTP server, not by the user. It's passed as the second parameter to the 'request' event callback function.</p>

<p>This object is used to return data to the client and implements the <code class="w3-codespan">Writable Stream</code> interface. The response object is how the server sends data back to the client that made the request.</p>

<h3>Using the Response Object</h3>
...
&nbsp;&nbsp;// 'res' is the ServerResponse object<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_response_basic">Run example &raquo;</a>
</div>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td>response.finished</td>
    <td>A boolean indicating if the response has completed.</td>
  </tr>
  <tr>
    <td>response.headersSent</td>
    <td>A boolean indicating if headers were sent to the client.</td>
  </tr>
  <tr>
    <td>response.sendDate</td>
    <td>When true, the Date header will be automatically generated and sent in the response if it's not already set. Default: true.</td>
  </tr>
  <tr>
    <td>response.statusCode</td>
    <td>The status code that will be sent to the client (e.g., 200, 404, 500).</td>
  </tr>
  <tr>
    <td>response.statusMessage</td>
    <td>The status message that will be sent to the client.</td>
  </tr>
  <tr>
    <td>response.socket</td>
    <td>Reference to the underlying socket.</td>
  </tr>
  <tr>
    <td>response.writableEnded</td>
    <td>A boolean indicating whether <code class="w3-codespan">response.end()</code> has been called.</td>
  </tr>
  <tr>
    <td>response.writableFinished</td>
    <td>A boolean indicating if all data has been flushed to the underlying system.</td>
  </tr>
</table>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    ...
    <td>Adds HTTP trailing headers to the response.</td>
  </tr>
  <tr>
    <td>response.cork()</td>
    <td>Forces buffering of data written to the response.</td>
  </tr>
  <tr>
    <td>response.end([data[, encoding]][, callback])</td>
    <td>Signals to the server that all response headers and body have been sent.</td>
  </tr>
  <tr>
    <td>response.flushHeaders()</td>
    <td>Flushes the response headers.</td>
  </tr>
  <tr>
    <td>response.getHeader(name)</td>
    <td>Gets the value of an outgoing header that's already been queued but not sent.</td>
  </tr>
  <tr>
    <td>response.getHeaderNames()</td>
    <td>Returns an array containing the names of headers that have been queued for an outgoing message.</td>
  </tr>
  <tr>
    <td>response.getHeaders()</td>
    <td>Returns a shallow copy of the current outgoing headers.</td>
  </tr>
  <tr>
    <td>response.hasHeader(name)</td>
    <td>Returns <code class="w3-codespan">true</code> if the header identified by <code class="w3-codespan">name</code> is currently set.</td>
  </tr>
  <tr>
    <td>response.removeHeader(name)</td>
    <td>Removes a header that's queued for sending.</td>
  </tr>
  <tr>
    <td>response.setHeader(name, value)</td>
    <td>Sets a single header value for the header object.</td>
  </tr>
  <tr>
    <td>response.setTimeout(msecs[, callback])</td>
    <td>Sets the timeout value of the socket.</td>
  </tr>
  <tr>
    <td>response.uncork()</td>
    <td>Flushes the data buffered by <code class="w3-codespan">cork()</code>.</td>
  </tr>
  <tr>
    <td>response.write(chunk[, encoding][, callback])</td>
    <td>Sends a chunk of the response body.</td>
  </tr>
  <tr>
    <td>response.writeContinue()</td>
    <td>Sends an HTTP/1.1 100 Continue message to the client.</td>
  </tr>
  <tr>
    <td>response.writeHead(statusCode[, statusMessage][, headers])</td>
    <td>Sends a response header to the request.</td>
  </tr>
  <tr>
    <td>response.writeProcessing()</td>
    <td>Sends an HTTP/1.1 102 Processing message to the client.</td>
  </tr>
</table>

<hr>

<h2>Basic Response Example</h2>

<p>A basic example of using various response methods:</p>
...
// Create an HTTP server<br>
const server = http.createServer((req, res) => {<br>
&nbsp;&nbsp;// Set status code and message<br>
&nbsp;&nbsp;res.statusCode = 200;<br>
&nbsp;&nbsp;res.statusMessage = 'OK';<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Set headers<br>
&nbsp;&nbsp;res.setHeader('Content-Type', 'text/html');<br>
&nbsp;&nbsp;res.setHeader('X-Powered-By', 'Node.js');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Log response information<br>
&nbsp;&nbsp;console.log(`Response status: ${res.statusCode} ${res.statusMessage}`);<br>
&nbsp;&nbsp;console.log(`Headers sent: ${res.headersSent}`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Send additional headers using writeHead (overwrites previously set ones)<br>
&nbsp;&nbsp;res.writeHead(200, {<br>
&nbsp;&nbsp;&nbsp;&nbsp;'Content-Type': 'text/html',<br>
&nbsp;&nbsp;&nbsp;&nbsp;'X-Custom-Header': 'Custom Value'<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Check headers sent now<br>
&nbsp;&nbsp;console.log(`Headers sent after writeHead: ${res.headersSent}`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Write response body in chunks<br>
...
&nbsp;&nbsp;res.end();<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Log completion status<br>
&nbsp;&nbsp;console.log(`Response finished: ${res.finished}`);<br>
&nbsp;&nbsp;console.log(`Response writableEnded: ${res.writableEnded}`);<br>
&nbsp;&nbsp;console.log(`Response writableFinished: ${res.writableFinished}`);<br>
});<br>
<br>
// Start the server<br>
const PORT = 8080;<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_response_example">Run example &raquo;</a>
</div>
...
<p>Different ways to set response headers:</p>
...
const server = http.createServer((req, res) => {<br>
&nbsp;&nbsp;// Method 1: Set individual headers with setHeader<br>
&nbsp;&nbsp;res.setHeader('Content-Type', 'application/json');<br>
&nbsp;&nbsp;res.setHeader('Cache-Control', 'max-age=3600');<br>
&nbsp;&nbsp;res.setHeader('X-Custom-Header', 'Method 1');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Get a header value<br>
&nbsp;&nbsp;const contentType = res.getHeader('Content-Type');<br>
&nbsp;&nbsp;console.log(`Content-Type header: ${contentType}`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Check if a header exists<br>
&nbsp;&nbsp;console.log(`Has Cache-Control header: ${res.hasHeader('Cache-Control')}`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Get all header names<br>
&nbsp;&nbsp;console.log('Header names:', res.getHeaderNames());<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Get all headers as an object<br>
&nbsp;&nbsp;console.log('All headers:', res.getHeaders());<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Remove a header<br>
&nbsp;&nbsp;res.removeHeader('X-Custom-Header');<br>
&nbsp;&nbsp;console.log(`After removal, has X-Custom-Header: ${res.hasHeader('X-Custom-Header')}`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Method 2: Set multiple headers with writeHead<br>
&nbsp;&nbsp;res.writeHead(200, {<br>
&nbsp;&nbsp;&nbsp;&nbsp;'Content-Type': 'application/json',<br>
&nbsp;&nbsp;&nbsp;&nbsp;'X-Custom-Header': 'Method 2',<br>
&nbsp;&nbsp;&nbsp;&nbsp;'X-Powered-By': 'Node.js'<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Send JSON response<br>
&nbsp;&nbsp;const responseObject = {<br>
&nbsp;&nbsp;&nbsp;&nbsp;message: 'Headers demonstration',<br>
&nbsp;&nbsp;&nbsp;&nbsp;headers: Object.fromEntries(<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Object.entries(res.getHeaders())<br>
&nbsp;&nbsp;&nbsp;&nbsp;),<br>
&nbsp;&nbsp;&nbsp;&nbsp;headersSent: res.headersSent<br>
&nbsp;&nbsp;};<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;res.end(JSON.stringify(responseObject, null, 2));<br>
});<br>
<br>
// Start server<br>
const PORT = 8080;<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_response_headers">Run example &raquo;</a>
</div>
...
<p>Setting different HTTP status codes:</p>
...
<br>
// Create an HTTP server that demonstrates different status codes<br>
const server = http.createServer((req, res) => {<br>
&nbsp;&nbsp;// Parse the request URL<br>
&nbsp;&nbsp;const parsedUrl = url.parse(req.url, true);<br>
&nbsp;&nbsp;const path = parsedUrl.pathname;<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Set Content-Type header<br>
&nbsp;&nbsp;res.setHeader('Content-Type', 'text/html');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Handle different paths with different status codes<br>
&nbsp;&nbsp;if (path === '/') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// 200 OK<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.writeHead(200, 'OK');<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.end(`<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;h1&gt;HTTP Status Codes Demo&lt;/h1&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;p&gt;This page demonstrates different HTTP status codes.&lt;/p&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;ul&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;li&gt;&lt;a href="/"&gt;200 OK (this page)&lt;/a&gt;&lt;/li&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;li&gt;&lt;a href="/redirect"&gt;301 Moved Permanently&lt;/a&gt;&lt;/li&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;li&gt;&lt;a href="/not-modified"&gt;304 Not Modified&lt;/a&gt;&lt;/li&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;li&gt;&lt;a href="/bad-request"&gt;400 Bad Request&lt;/a&gt;&lt;/li&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;li&gt;&lt;a href="/unauthorized"&gt;401 Unauthorized&lt;/a&gt;&lt;/li&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;li&gt;&lt;a href="/forbidden"&gt;403 Forbidden&lt;/a&gt;&lt;/li&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;li&gt;&lt;a href="/not-found"&gt;404 Not Found&lt;/a&gt;&lt;/li&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;li&gt;&lt;a href="/server-error"&gt;500 Internal Server Error&lt;/a&gt;&lt;/li&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/ul&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;`);<br>
&nbsp;&nbsp;} <br>
&nbsp;&nbsp;else if (path === '/redirect') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// 301 Moved Permanently<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.writeHead(301, {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'Location': '/'<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.end();<br>
&nbsp;&nbsp;} <br>
&nbsp;&nbsp;else if (path === '/not-modified') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// 304 Not Modified<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.writeHead(304);<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.end();<br>
&nbsp;&nbsp;} <br>
&nbsp;&nbsp;else if (path === '/bad-request') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// 400 Bad Request<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.writeHead(400, 'Bad Request');<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.end(`<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;h1&gt;400 Bad Request&lt;/h1&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;p&gt;The server could not understand the request due to invalid syntax.&lt;/p&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;p&gt;&lt;a href="/"&gt;Go back to home&lt;/a&gt;&lt;/p&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;`);<br>
&nbsp;&nbsp;} <br>
&nbsp;&nbsp;else if (path === '/unauthorized') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// 401 Unauthorized<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.writeHead(401, {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'WWW-Authenticate': 'Basic realm="Access to the site"'<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.end(`<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;h1&gt;401 Unauthorized&lt;/h1&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;p&gt;Authentication is required but was not provided.&lt;/p&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;p&gt;&lt;a href="/"&gt;Go back to home&lt;/a&gt;&lt;/p&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;`);<br>
&nbsp;&nbsp;} <br>
&nbsp;&nbsp;else if (path === '/forbidden') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// 403 Forbidden<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.writeHead(403, 'Forbidden');<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.end(`<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;h1&gt;403 Forbidden&lt;/h1&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;p&gt;The server understood the request but refuses to authorize it.&lt;/p&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;p&gt;&lt;a href="/"&gt;Go back to home&lt;/a&gt;&lt;/p&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;`);<br>
&nbsp;&nbsp;} <br>
&nbsp;&nbsp;else if (path === '/not-found') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// 404 Not Found<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.writeHead(404, 'Not Found');<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.end(`<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;h1&gt;404 Not Found&lt;/h1&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;p&gt;The requested resource could not be found on this server.&lt;/p&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;p&gt;&lt;a href="/"&gt;Go back to home&lt;/a&gt;&lt;/p&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;`);<br>
&nbsp;&nbsp;} <br>
&nbsp;&nbsp;else if (path === '/server-error') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// 500 Internal Server Error<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.writeHead(500, 'Internal Server Error');<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.end(`<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;h1&gt;500 Internal Server Error&lt;/h1&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;p&gt;The server has encountered a situation it doesn't know how to handle.&lt;/p&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;p&gt;&lt;a href="/"&gt;Go back to home&lt;/a&gt;&lt;/p&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;`);<br>
&nbsp;&nbsp;} <br>
&nbsp;&nbsp;else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Default: 404 Not Found<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.writeHead(404, 'Not Found');<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.end(`<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;h1&gt;404 Not Found&lt;/h1&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;p&gt;The requested resource could not be found on this server.&lt;/p&gt;<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_response_status">Run example &raquo;</a>
</div>
...
<p>Using the response object to stream data:</p>
...
// Create an HTTP server<br>
const server = http.createServer((req, res) => {<br>
&nbsp;&nbsp;const parsedUrl = new URL(req.url, 'http://localhost');<br>
&nbsp;&nbsp;const pathname = parsedUrl.pathname;<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Handle different paths<br>
&nbsp;&nbsp;if (pathname === '/') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Send a regular response<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.writeHead(200, {'Content-Type': 'text/html'});<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.end(`<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;h1&gt;Streaming Examples&lt;/h1&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;ul&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;li&gt;&lt;a href="/stream-text"&gt;Stream a large text response&lt;/a&gt;&lt;/li&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;li&gt;&lt;a href="/stream-file"&gt;Stream a file&lt;/a&gt;&lt;/li&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;li&gt;&lt;a href="/stream-json"&gt;Stream a JSON response&lt;/a&gt;&lt;/li&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/ul&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;`);<br>
&nbsp;&nbsp;} <br>
&nbsp;&nbsp;else if (pathname === '/stream-text') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Stream a large text response<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.writeHead(200, {'Content-Type': 'text/plain'});<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;let count = 1;<br>
&nbsp;&nbsp;&nbsp;&nbsp;const max = 10;<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Write response in chunks with delay<br>
&nbsp;&nbsp;&nbsp;&nbsp;const interval = setInterval(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;res.write(`Chunk ${count} of data\n`.repeat(20));<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (count >= max) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;clearInterval(interval);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;res.end('\nStreaming complete!');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;count++;<br>
&nbsp;&nbsp;&nbsp;&nbsp;}, 500);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;req.on('close', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;clearInterval(interval);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Client closed connection');<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;} <br>
&nbsp;&nbsp;else if (pathname === '/stream-file') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Create a sample file<br>
&nbsp;&nbsp;&nbsp;&nbsp;const filePath = path.join(__dirname, 'sample-large-file.txt');<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Get file stats<br>
&nbsp;&nbsp;&nbsp;&nbsp;const stat = fs.statSync(filePath);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Set headers<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.writeHead(200, {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'Content-Type': 'text/plain',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'Content-Length': stat.size<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Handle file stream errors<br>
&nbsp;&nbsp;&nbsp;&nbsp;fileStream.on('error', (err) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error(`Error streaming file: ${err.message}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;res.end('Error streaming file');<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Clean up after response is sent<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.on('finish', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;fs.unlink(filePath, (err) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (err) console.error(`Error deleting sample file: ${err.message}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;} <br>
&nbsp;&nbsp;else if (pathname === '/stream-json') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Stream a large JSON response<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;let isFirst = true;<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Write JSON objects with delay<br>
&nbsp;&nbsp;&nbsp;&nbsp;const interval = setInterval(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Add comma for all but first item<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (!isFirst) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;res.write(',\n');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;isFirst = false;<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;data: `Sample data for item ${count}`<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;};<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Write the object as JSON<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;res.write(JSON.stringify(obj, null, 2));<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (count >= max) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;clearInterval(interval);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// End JSON array<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;req.on('close', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;clearInterval(interval);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Client closed connection during JSON streaming');<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;} <br>
&nbsp;&nbsp;else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Handle unknown paths<br>
...
const PORT = 8080;<br>
server.listen(PORT, () => {<br>
&nbsp;&nbsp;console.log(`Streaming server running at http://localhost:${PORT}/`);<br>
});
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_response_stream">Run example &raquo;</a>
</div>
...
<p>Compressing responses with gzip or deflate:</p>
...
const server = http.createServer((req, res) => {<br>
&nbsp;&nbsp;// Get the Accept-Encoding header<br>
&nbsp;&nbsp;const acceptEncoding = req.headers['accept-encoding'] || '';<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Create a sample response (large string)<br>
&nbsp;&nbsp;const sampleData = 'This is a sample text that will be compressed. '.repeat(1000);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Function to send the response with appropriate headers<br>
&nbsp;&nbsp;function sendResponse(data, encoding) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Set Content-Encoding header if compression is used<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (encoding) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;res.setHeader('Content-Encoding', encoding);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.setHeader('Content-Type', 'text/plain');<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.setHeader('Vary', 'Accept-Encoding');<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.writeHead(200);<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.end(data);<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Check what encodings the client supports<br>
&nbsp;&nbsp;if (/\bgzip\b/.test(acceptEncoding)) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Client supports gzip<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Using gzip compression');<br>
&nbsp;&nbsp;&nbsp;&nbsp;zlib.gzip(sampleData, (err, compressed) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error('Gzip compression failed:', err);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;sendResponse(sampleData); // Fall back to uncompressed<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;sendResponse(compressed, 'gzip');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Original size: ${sampleData.length}, Compressed size: ${compressed.length}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Compression ratio: ${(compressed.length / sampleData.length * 100).toFixed(2)}%`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;} else if (/\bdeflate\b/.test(acceptEncoding)) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Client supports deflate<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Using deflate compression');<br>
&nbsp;&nbsp;&nbsp;&nbsp;zlib.deflate(sampleData, (err, compressed) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error('Deflate compression failed:', err);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;sendResponse(sampleData); // Fall back to uncompressed<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;sendResponse(compressed, 'deflate');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Original size: ${sampleData.length}, Compressed size: ${compressed.length}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Compression ratio: ${(compressed.length / sampleData.length * 100).toFixed(2)}%`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;} else if (/\bbr\b/.test(acceptEncoding)) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Client supports Brotli (if Node.js version supports it)<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (typeof zlib.brotliCompress === 'function') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Using Brotli compression');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;zlib.brotliCompress(sampleData, (err, compressed) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error('Brotli compression failed:', err);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;sendResponse(sampleData); // Fall back to uncompressed<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;sendResponse(compressed, 'br');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Original size: ${sampleData.length}, Compressed size: ${compressed.length}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Compression ratio: ${(compressed.length / sampleData.length * 100).toFixed(2)}%`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Brotli not supported in this Node.js version');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;sendResponse(sampleData); // Fall back to uncompressed<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// No compression supported by client<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('No compression used');<br>
&nbsp;&nbsp;&nbsp;&nbsp;sendResponse(sampleData);<br>
&nbsp;&nbsp;}<br>
});<br>
<br>
// Start the server<br>
const PORT = 8080;<br>
server.listen(PORT, () => {<br>
&nbsp;&nbsp;console.log(`Compression server running at http://localhost:${PORT}/`);<br>
});
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_response_compression">Run example &raquo;</a>
</div>
...
<ol>
  <li><strong>Always set Content-Type</strong>: Always set the appropriate Content-Type header for your responses.</li>
  <li><strong>Use proper status codes</strong>: Use appropriate HTTP status codes to indicate the result of the request.</li>
  <li><strong>Set proper headers</strong>: Set appropriate headers like Cache-Control, Content-Length, etc.</li>
  <li><strong>Handle errors properly</strong>: Return appropriate status codes (4xx, 5xx) with meaningful error messages.</li>
  <li><strong>Stream large responses</strong>: For large responses, use streaming instead of loading everything into memory.</li>
  <li><strong>Implement compression</strong>: Use compression for text-based responses to reduce bandwidth usage.</li>
  <li><strong>Security headers</strong>: Include security headers like Content-Security-Policy, X-Content-Type-Options, etc.</li>
  <li><strong>Always end the response</strong>: Always call <code class="w3-codespan">response.end()</code> to finalize the response.</li>
</ol>
