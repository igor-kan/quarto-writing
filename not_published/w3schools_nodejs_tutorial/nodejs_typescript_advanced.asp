...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Advanced TypeScript</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js Advanced TypeScript">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_typescript_advanced.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="This guide dives into advanced TypeScript features and patterns specifically useful for Node.js applications.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Advanced TypeScript">
<meta name="twitter:description" content="This guide dives into advanced TypeScript features and patterns specifically useful for Node.js applications.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_typescript_advanced.png">
...
<h1>Node.js <span class="color_h1">Advanced TypeScript</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_typescript.asp">&lt; Previous</a>
<a class="w3-right w3-btn" href="nodejs_linting_formatting.asp">Next &gt;</a>
</div>

<hr>

<h2>Advanced TypeScript for Node.js</h2>
<p>This guide dives into advanced TypeScript features and patterns specifically useful for Node.js applications.</p>
<div class="w3-panel ws-note">
  <p>For comprehensive TypeScript documentation, visit <a href="/typescript/index.php" target="_blank">TypeScript Tutorial</a>.</p>
</div>

<h2>Advanced Type System Features</h2>
<p>TypeScript's type system provides powerful tools for creating robust and maintainable Node.js applications.</p>
<p>Here are the key features:</p>

<h3>1. Union and Intersection Types</h3>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// Union type<br>
function formatId(id: string | number) {<br>
&nbsp;&nbsp;return `ID: ${id}`;<br>
}<br>
<br>
// Intersection type<br>
type User = { name: string } & { id: number };</div>
</div>

<h3>2. Type Guards</h3>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
type Fish = { swim: () => void };<br>
type Bird = { fly: () => void };<br>
<br>
function isFish(pet: Fish | Bird): pet is Fish {<br>
&nbsp;&nbsp;return 'swim' in pet;<br>
}</div>
</div>

<h3>3. Advanced Generics</h3>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// Generic function with constraints<br>
function getProperty&lt;T, K extends keyof T>(obj: T, key: K): T[K] {<br>
&nbsp;&nbsp;return obj[key];<br>
}<br>
<br>
// Generic interface with default type<br>
interface PaginatedResponse&lt;T = any> {<br>
&nbsp;&nbsp;data: T[];<br>
&nbsp;&nbsp;total: number;<br>
&nbsp;&nbsp;page: number;<br>
&nbsp;&nbsp;limit: number;<br>
...
<br>
// Using generic types with async/await in Node.js<br>
...
<h3>4. Mapped and Conditional Types</h3>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// Mapped types<br>
type ReadonlyUser = {<br>
&nbsp;&nbsp;readonly [K in keyof User]: User[K];<br>
};<br>
<br>
// Conditional types<br>
type NonNullableUser = NonNullable&lt;User | null | undefined>; // User<br>
<br>
// Type inference with conditional types<br>type GetReturnType&lt;T> = T extends (...args: any[]) => infer R ? R : never;<br>
function getUser() {<br>&nbsp;&nbsp;return { id: 1, name: 'Alice' } as const;<br>}<br>
type UserReturnType = GetReturnType&lt;typeof getUser>; // { readonly id: 1; readonly name: "Alice"; }</div>
</div>

<h3>5. Type Inference and Type Guards</h3>
<p>TypeScript's type inference and type guards help create type-safe code with minimal annotations:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// Type inference with variables<br>
const name = 'Alice'; // TypeScript infers type: string<br>
const age = 30;       // TypeScript infers type: number<br>
const active = true;  // TypeScript infers type: boolean<br>
<br>
// Type inference with arrays<br>
const numbers = [1, 2, 3]; // TypeScript infers type: number[]<br>
const mixed = [1, 'two', true]; // TypeScript infers type: (string | number | boolean)[]<br>
<br>
// Type inference with functions<br>
function getUser() {<br>
&nbsp;&nbsp;return { id: 1, name: 'Alice' }; // Return type inferred as { id: number; name: string; }<br>
}<br>
<br>
const user = getUser(); // user inferred as { id: number; name: string; }<br>
console.log(user.name); // Type checking works on inferred properties</div>
</div>
...
<hr>
<h2>Advanced TypeScript Patterns for Node.js</h2>

<p>These patterns help build more maintainable and type-safe Node.js applications:</p>

<h3>1. Advanced Decorators</h3>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// Parameter decorator with metadata<br>
function validateParam(target: any, key: string, index: number) {<br>
&nbsp;&nbsp;const params = Reflect.getMetadata('design:paramtypes', target, key) || [];<br>
&nbsp;&nbsp;console.log(`Validating parameter ${index} of ${key} with type ${params[index]?.name}`);<br>
}<br>
<br>
// Method decorator with factory<br>
function logExecutionTime(msThreshold = 0) {<br>
&nbsp;&nbsp;return function (target: any, key: string, descriptor: PropertyDescriptor) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const originalMethod = descriptor.value;<br>
&nbsp;&nbsp;&nbsp;&nbsp;descriptor.value = async function (...args: any[]) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const start = Date.now();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const result = await originalMethod.apply(this, args);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const duration = Date.now() - start;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (duration > msThreshold) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.warn(`[Performance] ${key} took ${duration}ms`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return result;<br>
&nbsp;&nbsp;&nbsp;&nbsp;};<br>
&nbsp;&nbsp;};<br>
}<br>
class ExampleService {<br>
&nbsp;&nbsp;@logExecutionTime(100)<br>
&nbsp;&nbsp;async fetchData(@validateParam url: string) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Implementation<br>
&nbsp;&nbsp;}<br>
}</div>
</div>

<h3>2. Advanced Utility Types</h3>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
...
// Create a type with specific properties as required<br>
type AtLeast&lt;T, K extends keyof T> = Partial&lt;T> & Pick&lt;T, K>;<br>
type UserCreateInput = AtLeast&lt;User, 'name' | 'email'>; // Only name is required<br>
<br>
// Create a type that makes specific properties required<br>
WithRequired&lt;T, K extends keyof T> = T & { [P in K]-?: T[P] };<br>
type UserWithEmail = WithRequired&lt;User, 'email'>;<br>
<br>
// Extract function return type as a type<br>
type UserFromAPI = Awaited&lt;ReturnType&lt;typeof fetchUser>>;</div>
</div>

<h3>3. Type-Safe Event Emitters</h3>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
import { EventEmitter } from 'events';<br>
<br>
type EventMap = {<br>
&nbsp;&nbsp;login: (userId: string) => void;<br>
&nbsp;&nbsp;logout: (userId: string, reason: string) => void;<br>
&nbsp;&nbsp;error: (error: Error) => void;<br>
};<br>
<br>
class TypedEventEmitter&lt;T extends Record&lt;string, (...args: any[]) => void>> {<br>
&nbsp;&nbsp;private emitter = new EventEmitter();<br>
<br>
&nbsp;&nbsp;on&lt;K extends keyof T>(event: K, listener: T[K]): void {<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.emitter.on(event as string, listener as any);<br>
&nbsp;&nbsp;}<br>
<br>
&nbsp;&nbsp;emit&lt;K extends keyof T>(<br>
&nbsp;&nbsp;&nbsp;&nbsp;event: K,<br>
&nbsp;&nbsp;&nbsp;&nbsp;...args: Parameters&lt;T[K]><br>
&nbsp;&nbsp;): boolean {<br>
&nbsp;&nbsp;&nbsp;&nbsp;return this.emitter.emit(event as string, ...args);<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
// Usage<br>
const userEvents = new TypedEventEmitter&lt;EventMap>();<br>
userEvents.on('login', (userId) => {<br>
&nbsp;&nbsp;console.log(`User ${userId} logged in`);<br>
});<br>
<br>
// TypeScript will show an error for incorrect argument types<br>
// userEvents.emit('login', 123);<br>
// Error: Argument of type 'number' is not assignable to 'string'</div>
</div>
<hr>
<h2>TypeScript Best Practices for Node.js</h2>

<div class="w3-panel ws-note">
  <p><strong>Key Takeaways:</strong></p>
  <ul>
    <li>Leverage TypeScript's advanced type system for better code safety and developer experience</li>
    <li>Use generics to create flexible and reusable components without losing type safety</li>
    <li>Implement decorators for cross-cutting concerns like logging, validation, and performance monitoring</li>
    <li>Utilize utility types to transform and manipulate types without code duplication</li>
    <li>Create type-safe abstractions for Node.js-specific patterns like event emitters and streams</li>
  </ul>
</div>
...
<div class="w3-panel w3-warning">
  ...
  <ul>
    <li>Be mindful of complex types that might impact compilation time</li>
    <li>Use <code class="w3-codespan">type</code> over <code class="w3-codespan">interface</code> for complex type operations</li>
    <li>Consider using <code class="w3-codespan">as const</code> for literal types when appropriate</li>
    <li>Use <code class="w3-codespan">unknown</code> instead of <code class="w3-codespan">any</code> for type-safe dynamic typing</li>
  </ul>
</div>

<div class="w3-panel ws-note">
  <p>For comprehensive TypeScript documentation and examples, visit our <a href="/typescript/index.php" target="_blank">TypeScript Tutorial</a>.</p>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_typescript_advanced.js" data-extensions="asp"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_typescript.asp">&lt; Previous</a>
<a class="w3-right w3-btn" href="nodejs_linting_formatting.asp">Next &gt;</a>
