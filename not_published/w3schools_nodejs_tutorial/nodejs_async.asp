...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Asynchronous Programming</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js Asynchronous Programming">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_async.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="Callbacks, promises, and async/await for writing non-blocking Node.js code.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Asynchronous Programming">
<meta name="twitter:description" content="Callbacks, promises, and async/await for writing non-blocking Node.js code.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_async.png">
...
<h1>Node.js <span class="color_h1">Asynchronous Programming</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_event_loop.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="nodejs_promises.asp">Next &#10095;</a>
</div>
<hr>

<h2>What is Asynchronous Programming?</h2>
<p>In Node.js, <b>asynchronous</b> operations let your program do other work while waiting for tasks like file I/O or network requests to complete.</p>
<p>This non-blocking approach enables Node.js to handle thousands of concurrent connections efficiently.</p>
<hr>

<h2>Sync vs Async: Key Differences</h2>
<div class="w3-row-padding" style="margin:0 -16px">
  <div class="w3-half">
    <div class="w3-container ws-note w3-padding">
      <h3>Synchronous</h3>
      <ul>
        <li>Blocks execution until complete</li>
        <li>Simple to understand</li>
        <li>Can cause delays</li>
        <li>Uses functions like <code class="w3-codespan">readFileSync</code></li>
      </ul>
    </div>
  </div>
  <div class="w3-half">
    <div class="w3-container ws-info w3-padding">
      <h3>Asynchronous</h3>
      <ul>
...
<h3>Example: Synchronous File Read</h3>
<div class="w3-code notranslate jsHigh">
const fs = require('fs');<br>
<br>
console.log('1. Starting sync read...');<br>
const data = fs.readFileSync('myfile.txt', 'utf8');<br>
console.log('2. File contents:', data);<br>
console.log('3. Done reading file');
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_async_sync">Run example &raquo;</a>
</div>
<p>Output will be in order: 1 → 2 → 3 (blocks between each step)</p>
<div class="w3-example">
<h3>Example: Asynchronous File Read</h3>
<div class="w3-code notranslate jsHigh">
const fs = require('fs');<br>
<br>
console.log('1. Starting async read...');<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_async_async">Run example &raquo;</a>
</div>
<p>Output order: 1 → 3 → 2 (doesn't wait for file read to complete)</p>
<hr>
...
<hr>
<h2>Avoiding Callback Hell</h2>
<div class="w3-example">
  <h3>Problem: Nested Callbacks (Callback Hell)</h3>
  <div class="w3-code notranslate jsHigh">
  getUser(userId, (err, user) => {<br>
  &nbsp;&nbsp;if (err) return handleError(err);<br>
  &nbsp;&nbsp;getOrders(user.id, (err, orders) => {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;if (err) return handleError(err);<br>
  &nbsp;&nbsp;&nbsp;&nbsp;processOrders(orders, (err) => {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (err) return handleError(err);<br>
...
<div class="w3-example">
  <h3>Solution: Use Promises</h3>
  <div class="w3-code notranslate jsHigh">
  getUser(userId)<br>
  &nbsp;&nbsp;.then(user => getOrders(user.id))<br>
  &nbsp;&nbsp;.then(orders => processOrders(orders))<br>
  &nbsp;&nbsp;.then(() => console.log('All done!'))<br>
  &nbsp;&nbsp;.catch(handleError);
  </div>
</div>
<div class="w3-example">
  <h3>Even Better: Async/Await</h3>
  <div class="w3-code notranslate jsHigh">
  async function processUser(userId) {<br>
  &nbsp;&nbsp;try {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;const user = await getUser(userId);<br>
  &nbsp;&nbsp;&nbsp;&nbsp;const orders = await getOrders(user.id);<br>
  &nbsp;&nbsp;&nbsp;&nbsp;await processOrders(orders);<br>
  &nbsp;&nbsp;&nbsp;&nbsp;console.log('All done!');<br>
  &nbsp;&nbsp;} catch (err) {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;handleError(err);<br>
  &nbsp;&nbsp;}<br>
...
<br>
console.log('1. Reading file...');<br>
fs.readFile('myfile.txt', 'utf8')<br>
&nbsp;&nbsp;.then(data => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('3. File content:', data);<br>
&nbsp;&nbsp;})<br>
...
<div class="w3-example">
  <h3>2. Async/Await (Recommended)</h3>
<div class="w3-code notranslate jsHigh">
async function readFiles() {<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('1. Starting to read files...');<br>
&nbsp;&nbsp;&nbsp;&nbsp;const data1 = await fs.readFile('file1.txt', 'utf8');<br>
&nbsp;&nbsp;&nbsp;&nbsp;const data2 = await fs.readFile('file2.txt', 'utf8');<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('2. Files read successfully!');<br>
&nbsp;&nbsp;&nbsp;&nbsp;return { data1, data2 };<br>
&nbsp;&nbsp;} catch (error) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error('Error reading files:', error);<br>
&nbsp;&nbsp;}<br>
}
</div>
</div>
...
<div class="w3-example">
  <h3>Do This</h3>
  <div class="w3-code notranslate jsHigh">
  // Use async/await for better readability<br>
  async function getUserData(userId) {<br>
  &nbsp;&nbsp;try {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;const user = await User.findById(userId);<br>
  &nbsp;&nbsp;&nbsp;&nbsp;const orders = await Order.find({ userId });<br>
  &nbsp;&nbsp;&nbsp;&nbsp;return { user, orders };<br>
  &nbsp;&nbsp;} catch (error) {
  &nbsp;&nbsp;&nbsp;&nbsp;console.error('Failed to fetch user data:', error);<br>
  &nbsp;&nbsp;&nbsp;&nbsp;throw error; // Re-throw or handle appropriately<br>
  &nbsp;&nbsp;}<br>
  }
  </div>
</div>
<div class="w3-example">
  <h3>Not This</h3>
  <div class="w3-code notranslate jsHigh">
  // Nested callbacks are hard to read and maintain<br>
  User.findById(userId, (err, user) => {<br>
  &nbsp;&nbsp;if (err) return console.error(err);<br>
  &nbsp;&nbsp;Order.find({ userId }, (err, orders) => {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;if (err) return console.error(err);<br>
  &nbsp;&nbsp;&nbsp;&nbsp;// Process orders...<br>
  &nbsp;&nbsp;});<br>
  });
...
<hr>
  ...
  <h3>Key Takeaways</h3>
  <ul>
    <li>✅ Use <code class="w3-codespan">async/await</code> for better readability</li>
    <li>✅ Always handle errors with <code class="w3-codespan">try/catch</code></li>
    <li>✅ Run independent operations in parallel with <code class="w3-codespan">Promise.all</code></li>
    <li>❌ Avoid mixing sync and async code patterns</li>
    <li>❌ Don't forget to <code class="w3-codespan">await</code> promises</li>
  </ul>
<div class="w3-example">
  <h4>Example: Parallel Execution</h4>
  <div class="w3-code notranslate jsHigh">
  // Run multiple async operations in parallel<br>
  async function fetchAllData() {<br>
  &nbsp;&nbsp;try {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;const [users, products, orders] = await Promise.all([<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;User.find(),<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Product.find(),<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Order.find()<br>
  &nbsp;&nbsp;&nbsp;&nbsp;]);<br>
  &nbsp;&nbsp;&nbsp;&nbsp;return { users, products, orders };<br>
  &nbsp;&nbsp;} catch (error) {<br>
...
<h2>Why Use Asynchronous Code?</h2>
<p>Asynchronous code lets Node.js handle many requests at once, without waiting for slow operations like file or database access.</p>
<p>This makes Node.js great for servers and real-time apps.</p>
<hr>

<h2>Summary</h2>
<div class="w3-panel ws-note">
  <h3>Asynchronous Programming in Node.js</h3>
  <ul>
    <li>Node.js uses an event loop for non-blocking I/O</li>
    <li>Modern async code uses <code class="w3-codespan">async/await</code> with Promises</li>
    <li>Always handle errors in async operations</li>
    <li>Use <code class="w3-codespan">Promise.all</code> for parallel operations</li>
    <li>Avoid callback hell with proper async patterns</li>
  </ul>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_async.js" data-extensions="asp"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_event_loop.asp">&#10094; Previous</a>
