...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Performance Diagnostics</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js Performance Diagnostics">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_performance.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="Node.js offers various tools and techniques for diagnosing performance issues.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Performance Diagnostics">
<meta name="twitter:description" content="Node.js offers various tools and techniques for diagnosing performance issues.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_performance.png">
...
<h1>Node.js Performance Diagnostics</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_monitoring_observability.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="nodejs_child_process.asp">Next &#10095;</a>
</div>
<hr>
<h2>Why Performance Matters</h2>
<p>Node.js offers various tools and techniques for diagnosing performance issues.</p>
<p>This guide covers built-in tools, and popular third-party solutions, for comprehensive performance analysis.</p>

<div class="w3-panel ws-note">
  <p><strong>Performance Tip:</strong> Always measure before optimizing.</p>
  <p>Use the techniques in this guide to identify actual bottlenecks rather than guessing where performance issues might be.</p>
</div>
...
<p>Performance in Node.js applications can be affected by several factors:</p>

<ul>
  <li>CPU-intensive operations that block the event loop</li>
  <li>Memory leaks and excessive garbage collection</li>
  <li>I/O bottlenecks (database queries, file operations, network requests)</li>
  <li>Inefficient code and algorithms</li>
  <li>Event loop congestion</li>
</ul>

<p>Diagnosing these issues requires a methodical approach and the right tools.</p>

<hr>

<h2>Built-in Diagnostic Tools</h2>

<h3>console.time() and console.timeEnd()</h3>

<p>The simplest way to measure how long an operation takes:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// Measure execution time<br>
console.time('operation');<br>
<br>
// Some operation to measure<br>
const array = Array(1000000).fill().map((_, i) => i);<br>
array.sort((a, b) => b - a);<br>
<br>
console.timeEnd('operation');<br>
// Output: operation: 123.45ms</div>
</div>

<h3>Process Statistics</h3>

<p>Node.js provides access to process statistics through the <code class="w3-codespan">process</code> global object:</p>
...
console.log(`  External: ${Math.round(memoryUsage.external / 1024 / 1024)} MB`);<br>
<br>
// CPU usage<br>
const startUsage = process.cpuUsage();<br>
<br>
// Simulate CPU work<br>
const now = Date.now();<br>
while (Date.now() - now &lt; 500); // Busy wait for 500ms<br>
<br>
const endUsage = process.cpuUsage(startUsage);<br>
console.log('CPU Usage:');<br>
console.log(`  User: ${endUsage.user / 1000}ms`);<br>
console.log(`  System: ${endUsage.system / 1000}ms`);<br>
<br>
// Uptime<br>
console.log(`Process uptime: ${process.uptime().toFixed(2)} seconds`);</div>
</div>
...
<h2>Node.js Performance Hooks</h2>

<p>Since Node.js 8.5.0, the <code class="w3-codespan">perf_hooks</code> module provides tools for measuring performance:</p>
...
<br>
// Subscribe to performance events<br>
obs.observe({ entryTypes: ['measure'] });<br>
<br>
// Mark the beginning of an operation<br>
...
<br>
// Mark the end and measure<br>
performance.mark('end');<br>
performance.measure('Data processing time', 'start', 'end');<br>
<br>
// Clean up marks<br>
performance.clearMarks();</div>
</div>

<hr>

<h2>Advanced CPU Profiling</h2>

<div class="w3-panel w3-pale-yellow w3-leftbar">
  <h4>When to Use CPU Profiling</h4>
  <ul>
    <li>Identifying hot functions consuming excessive CPU time</li>
    <li>Finding optimization opportunities in synchronous code</li>
    <li>Analyzing event loop blocking operations</li>
    <li>Comparing performance before and after optimizations</li>
  </ul>
</div>

<h3>1. V8 Profiler with Source Maps</h3>

<p>For applications using TypeScript or transpiled JavaScript, source maps are essential for meaningful profiling results:</p>

<p>Node.js allows accessing the V8 profiler directly for CPU profiling:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const v8Profiler = require('v8-profiler-node8');<br>
const fs = require('fs');<br>
const path = require('path');<br>
<br>
// Enable source map support for accurate profiling<br>require('source-map-support').install();<br>
<br>
// Start CPU profiling with source map support<br>v8Profiler.setGenerateType(1); // Include type information<br>const profile = v8Profiler.startProfiling('CPU profile', true);<br>
<br>// Run code to profile<br>function fibonacci(n) {<br>
&nbsp;&nbsp;if (n <= 1) return n;<br>
&nbsp;&nbsp;return fibonacci(n - 1) + fibonacci(n - 2);<br>}<br>
<br>// Simulate both CPU and I/O work<br>function processData() {<br>&nbsp;&nbsp;const start = Date.now();<br>&nbsp;&nbsp;fibonacci(35);<br>&nbsp;&nbsp;console.log(`CPU work took: ${Date.now() - start}ms`);<br>  <br>&nbsp;&nbsp;// Simulate async work<br>&nbsp;&nbsp;setImmediate(() => {<br>&nbsp;&nbsp;&nbsp;&nbsp;const asyncStart = Date.now();<br>&nbsp;&nbsp;&nbsp;&nbsp;fibonacci(30);<br>&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Async work took: ${Date.now() - asyncStart}ms`);<br>&nbsp;&nbsp;});<br>}<br>
<br>processData();<br>
<br>// Stop profiling after async work completes<br>setTimeout(() => {<br>&nbsp;&nbsp;const profile = v8Profiler.stopProfiling('CPU profile');<br>&nbsp;&nbsp;profile.export((error, result) => {<br>&nbsp;&nbsp;&nbsp;&nbsp;const filename = path.join(__dirname, 'profile.cpuprofile');<br>&nbsp;&nbsp;&nbsp;&nbsp;fs.writeFileSync(filename, result);<br>&nbsp;&nbsp;&nbsp;&nbsp;console.log(`CPU profile saved to ${filename}`);<br>&nbsp;&nbsp;&nbsp;&nbsp;profile.delete();<br>&nbsp;&nbsp;});<br>}, 1000);</div>
</div>

<p>To use the above example, you need to install the v8-profiler package:</p>
...
<p>The generated <code class="w3-codespan">.cpuprofile</code> file can be loaded in Chrome DevTools for visualization.</p>

<h3>2. Node.js Built-in Profiling</h3>

<p>Node.js has built-in profiling capabilities that can be accessed through command-line flags:</p>

<div class="w3-example">
<div class="w3-code notranslate">
# Start a Node.js application with profiling enabled<br>
node --prof app.js<br>
<br>
# Process the generated log file<br>
node --prof-process isolate-0xNNNNNNNN-NNNN-v8.log > processed.txt</div>
</div>

<hr>

<h2>Advanced Memory Profiling</h2>

<div class="w3-panel ws-info">
  <p><strong>Memory Leak Detection Tip:</strong> Compare multiple heap snapshots taken at different times to identify objects that aren't being garbage collected as expected.</p>
</div>

<h3>Heap Snapshots with Chrome DevTools</h3>

<p>Heap snapshots can help identify memory leaks by capturing the memory state at a specific moment:</p>
...
const path = require('path');<br>
<br>
// Generate some data that might leak<br>let leakyData = [];<br>
function potentiallyLeaky() {<br>&nbsp;&nbsp;const data = {<br>&nbsp;&nbsp;&nbsp;&nbsp;id: Date.now(),<br>&nbsp;&nbsp;&nbsp;&nbsp;content: Array(1000).fill('potentially leaky data'),<br>&nbsp;&nbsp;&nbsp;&nbsp;timestamp: new Date().toISOString()<br>&nbsp;&nbsp;};<br>&nbsp;&nbsp;leakyData.push(data);<br>}<nobr>&nbsp;</nobr><br>
// Simulate a memory leak with different retention patterns<br>setInterval(() => {<br>&nbsp;&nbsp;potentiallyLeaky();<br>&nbsp;&nbsp;// Keep only the last 100 items to simulate a partial leak<br>&nbsp;&nbsp;if (leakyData.length > 100) {<br>&nbsp;&nbsp;&nbsp;&nbsp;leakyData = leakyData.slice(-100);<br>&nbsp;&nbsp;}<br>}, 100);<br>
// Take heap snapshots at intervals<br>function takeHeapSnapshot(prefix) {<br>&nbsp;&nbsp;const filename = path.join(__dirname, `${prefix}-${Date.now()}.heapsnapshot`);<br>&nbsp;&nbsp;heapdump.writeSnapshot(filename, (err, filename) => {<br>&nbsp;&nbsp;&nbsp;&nbsp;if (err) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error('Failed to take heap snapshot:', err);<br>&nbsp;&nbsp;&nbsp;&nbsp;} else {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Heap snapshot saved to ${filename}`);<br>&nbsp;&nbsp;&nbsp;&nbsp;}<br>&nbsp;&nbsp;});<br>}<br>
// Initial snapshot
takeHeapSnapshot('heap-initial');<br>
// Take periodic snapshots<br>setInterval(() => {
&nbsp;&nbsp;takeHeapSnapshot('heap-periodic');<br>}, 10000);<br>
// Force garbage collection before final snapshot<br>
setTimeout(() => {<br>
&nbsp;&nbsp;if (global.gc) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;global.gc();<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Garbage collection forced');<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;takeHeapSnapshot('heap-final');<br>
}, 30000);</div>
</div>

<p>To use the above example, you need to install the heapdump package:</p>
...
<p>Heap snapshots can be analyzed in Chrome DevTools to identify memory leaks.</p>

<hr>

<h2>Event Loop and Latency Analysis</h2>

<div class="w3-panel ws-note">
  <h4>Event Loop Metrics to Monitor</h4>
  <ul>
    <li>Event loop lag (time between event loop ticks)</li>
    <li>Active handles and requests</li>
    <li>Pending async operations</li>
    <li>Garbage collection pauses</li>
  </ul>
</div>

<p>The event loop is central to Node.js performance. Blocking it causes performance degradation:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const toobusy = require('toobusy-js');<br>
const http = require('http');<br>
<br>
// Configure thresholds (in milliseconds)<br>
toobusy.maxLag(100); // Maximum allowed lag before considering server too busy<br>
toobusy.interval(500); // Check interval for event loop lag<br>
<br>
// Create HTTP server with event loop monitoring<br>
const server = http.createServer((req, res) => {<br>
&nbsp;&nbsp;// Check if event loop is overloaded<br>
&nbsp;&nbsp;if (toobusy()) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.statusCode = 503; // Service Unavailable<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.setHeader('Retry-After', '10');<br>
&nbsp;&nbsp;&nbsp;&nbsp;return res.end(JSON.stringify({<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;error: 'Server is too busy',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;message: 'Please try again later',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;status: 503<br>
&nbsp;&nbsp;&nbsp;&nbsp;}));<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;// Simulate some work based on URL<br>
&nbsp;&nbsp;if (req.url === '/compute') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// CPU-intensive work<br>
&nbsp;&nbsp;&nbsp;&nbsp;let sum = 0;<br>
&nbsp;&nbsp;&nbsp;&nbsp;for (let i = 0; i &lt; 1e7; i++) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;sum += Math.random();<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.end(`Computed: ${sum}`);<br>
&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Normal response<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.end('OK');<br>
&nbsp;&nbsp;}<br>
...
// Monitor event loop lag and memory usage<br>
setInterval(() => {<br>
&nbsp;&nbsp;const lag = toobusy.lag();<br>
&nbsp;&nbsp;const mem = process.memoryUsage();<br>
&nbsp;&nbsp;console.log(`Event loop lag: ${lag}ms`);<br>
&nbsp;&nbsp;console.log(`Memory usage: ${Math.round(mem.heapUsed / 1024 / 1024)}MB / ${Math.round(mem.heapTotal / 1024 / 1024)}MB`);<br>
}, 1000);<br>
...
<p>To use the above example, you need to install the toobusy-js package:</p>
...
<p>Flame graphs provide a visual representation of CPU sampling, helping to identify where time is spent in your application:</p>

<div class="w3-example">
<div class="w3-code notranslate">
# Using 0x for flame graphs (install globally)<br>
npm install -g 0x<br>
<br>
# Run your application with 0x<br>
0x app.js<br>
<br>
# A browser will open with the flame graph visualization when the process exits</div>
</div>
...
<p>Benchmarking helps compare different implementations to choose the most efficient one:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const Benchmark = require('benchmark');<br>
const suite = new Benchmark.Suite;<br>
<br>
// Add tests<br>
suite<br>
&nbsp;&nbsp;.add('RegExp#test', function() {<br>
&nbsp;&nbsp;&nbsp;&nbsp;/o/.test('Hello World!');<br>
&nbsp;&nbsp;})<br>
&nbsp;&nbsp;.add('String#indexOf', function() {<br>
&nbsp;&nbsp;&nbsp;&nbsp;'Hello World!'.indexOf('o') > -1;<br>
&nbsp;&nbsp;})<br>
&nbsp;&nbsp;.add('String#includes', function() {<br>
&nbsp;&nbsp;&nbsp;&nbsp;'Hello World!'.includes('o');<br>
&nbsp;&nbsp;})<br>
&nbsp;&nbsp;// Add listeners<br>
&nbsp;&nbsp;.on('cycle', function(event) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(String(event.target));<br>
&nbsp;&nbsp;})<br>
&nbsp;&nbsp;.on('complete', function() {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Fastest is ' + this.filter('fastest').map('name'));<br>
&nbsp;&nbsp;})<br>
&nbsp;&nbsp;// Run benchmarks<br>
&nbsp;&nbsp;.run({ 'async': true });</div>
</div>

<p>To use the above example, you need to install the benchmark package:</p>
...
<h2>Node.js Inspector</h2>

<p>Node.js has an integrated debugger and profiler accessible through Chrome DevTools:</p>

<div class="w3-example">
<div class="w3-code notranslate">
# Start an application with the inspector<br>
node --inspect app.js<br>
<br>
# Start and immediately break (for debugging)<br>
node --inspect-brk app.js</div>
</div>

<p>Open Chrome and navigate to <code class="w3-codespan">chrome://inspect</code> to access DevTools for your Node.js application. This provides access to:</p>
...
<h2>Clinic.js Suite</h2>

<p>Clinic.js is a collection of tools for diagnosing performance issues in Node.js applications:</p>

<div class="w3-example">
<div class="w3-code notranslate">
# Install the Clinic.js suite<br>
npm install -g clinic<br>
<br>
# Use Doctor to identify issues<br>
clinic doctor -- node app.js<br>
<br>
# Use Flame to generate CPU flame graphs<br>
clinic flame -- node app.js<br>
<br>
# Use Bubbleprof for async operations analysis<br>
clinic bubbleprof -- node app.js</div>
</div>

<hr>

<h2>Practical Performance Diagnosis</h2>

<h3>Step 1: Establish Baseline Metrics</h3>

<p>Before optimizing, establish baseline metrics for your application:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const autocannon = require('autocannon');<br>
const { writeFileSync } = require('fs');<br>
<br>
// Run a benchmark against your application<br>
const result = autocannon({<br>
...
<br>
// Save the results<br>
result.on('done', (results) => {<br>
&nbsp;&nbsp;console.log('Baseline performance metrics:');<br>
&nbsp;&nbsp;console.log(` Requests/sec: ${results.requests.average}`);<br>
&nbsp;&nbsp;console.log(` Latency: ${results.latency.average}ms`);<br>
<br>
&nbsp;&nbsp;writeFileSync('baseline-metrics.json', JSON.stringify(results, null, 2));<br>
});</div>
</div>

<h3>Step 2: Identify Bottlenecks</h3>

<p>Use profiling to identify bottlenecks:</p>

<ol>
  <li>CPU profiling for compute-intensive operations</li>
  <li>Memory snapshots for memory leaks</li>
  <li>Flame graphs for call stack analysis</li>
  <li>Event loop monitoring for I/O and callback delays</li>
</ol>

<h3>Step 3: Fix and Verify</h3>

<p>After applying optimizations, verify improvements against your baseline.</p>
...
<p>Signs: Increasing memory usage over time that doesn't plateau.</p>

<p>Solutions:</p>
<ul>
  <li>Take heap snapshots at intervals and compare</li>
  <li>Check for global variables, event listeners, and closures that retain references</li>
  <li>Implement proper cleanup when objects are no longer needed</li>
</ul>

<h3>2. Long-Running Operations</h3>

<p>Signs: High event loop lag, inconsistent response times.</p>

<p>Solutions:</p>
<ul>
  <li>Move CPU-intensive work to worker threads</li>
  <li>Break long tasks into smaller chunks using setImmediate/process.nextTick</li>
  <li>Consider offloading to dedicated services</li>
</ul>

<h3>3. Inefficient Database Queries</h3>

<p>Signs: Slow response times, high latency.</p>

<p>Solutions:</p>
<ul>
  <li>Profile database operations</li>
  <li>Optimize queries with proper indexing</li>
  <li>Use connection pooling</li>
  <li>Implement caching for frequently accessed data</li>
</ul>

<hr>
<div id="exercisecontainer" src="xrcise_performance.js" data-extensions="asp"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_monitoring_observability.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="nodejs_child_process.asp">Next &#10095;</a>
