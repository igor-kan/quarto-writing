...
<meta name="title" property="og:title" content="Node.js OS Module">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_os.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="The OS module in Node.js provides a powerful set of utilities for interacting with the underlying operating system.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js OS Module">
<meta name="twitter:description" content="The OS module in Node.js provides a powerful set of utilities for interacting with the underlying operating system.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_os.png">
...
<h1>Node.js <span class="color_h1">OS Module</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_path.asp">&lt; Previous</a>
<a class="w3-right w3-btn" href="nodejs_url.asp">Next &gt;</a>
</div>

<hr>
<h2>What is the OS Module?</h2>

<p>The OS module in Node.js provides a powerful set of utilities for interacting with the underlying operating system.</p>
<p></p>It offers a cross-platform way to access system-related information and perform common operating system tasks.</p>

<div class="w3-panel ws-note">
  <p><strong>Key Features:</strong></p>
  <ul>
    <li>Retrieve system information (CPU, memory, platform, etc.)</li>
    <li>Access user and network information</li>
    <li>Work with file paths and directories in a cross-platform way</li>
    <li>Monitor system resources and performance</li>
    <li>Handle operating system signals and errors</li>
  </ul>
</div>

<hr>

<h2>Getting Started with the OS Module</h2>

<h3>Importing the Module</h3>
<p>The OS module is a core Node.js module, so no installation is needed.</p>
<p>You can import it using CommonJS or ES modules syntax:</p>
...
<div class="w3-example">
  <h4>ES Modules (Node.js 14+ or with "type": "module" in package.json)</h4>
  <div class="w3-code notranslate jsHigh">
...
<p>Here's a quick example showing some common OS module methods:</p>
...
<div class="w3-example">
  ...
  console.log(`OS Platform: ${os.platform()}`);<br>
  console.log(`OS Type: ${os.type()}`);<br>
  console.log(`OS Release: ${os.release()}`);<br>
  console.log(`CPU Architecture: ${os.arch()}`);<br>
  console.log(`Hostname: ${os.hostname()}`);<br>
  <br>
  // Memory information<br>
  const totalMemGB = (os.totalmem() / (1024 * 1024 * 1024)).toFixed(2);<br>
  const freeMemGB = (os.freemem() / (1024 * 1024 * 1024)).toFixed(2);<br>
  console.log(`Memory: ${freeMemGB}GB free of ${totalMemGB}GB`);<br>
  <br>
  // User information<br>
  const userInfo = os.userInfo();<br>
  console.log(`Current User: ${userInfo.username}`);<br>
  console.log(`Home Directory: ${os.homedir()}`);
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_os_basic_usage">Try it Yourself &raquo;</a>
</div>
...
<h2>OS Module Reference</h2>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> All OS module methods are synchronous and return results immediately.</p>
  <p>For performance-critical applications, consider caching the results of methods that might be called frequently, such as <code class="w3-codespan">os.cpus()</code> or <code class="w3-codespan">os.networkInterfaces()</code>.</p>
</div>
<hr>
<h2>System Information</h2>

<h3>os.arch()</h3>
<p>Returns the operating system CPU architecture for which the Node.js binary was compiled.</p>

<div class="w3-example">
  <div class="w3-code notranslate jsHigh">
  const os = require('os');<br>
  <br>
  // Get CPU architecture<br>
  console.log(`CPU Architecture: ${os.arch()}`);<br>
  <br>
  // Common values:<br>
  // - 'x64' for 64-bit systems<br>
  // - 'arm' for ARM processors<br>
  // - 'arm64' for 64-bit ARM<br>
  // - 'ia32' for 32-bit x86<br>
  // - 'mips' for MIPS processors
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_os_arch">Try it Yourlself &raquo;</a>
</div>

<h3>os.platform()</h3>
<p>Returns a string identifying the operating system platform.</p>

<div class="w3-example">
  <div class="w3-code notranslate jsHigh">
  const os = require('os');<br>
  <br>
  // Get platform information<br>
  const platform = os.platform();<br>
  console.log(`Platform: ${platform}`);<br>
  <br>
  // Common values:<br>
  // - 'darwin' for macOS<br>
  // - 'win32' for Windows (both 32-bit and 64-bit)<br>
  // - 'linux' for Linux<br>
  // - 'freebsd' for FreeBSD<br>
  // - 'openbsd' for OpenBSD
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_os_platform">Try it Yourself &raquo;</a>
</div>

<h3>os.type()</h3>
<p>Returns the operating system name as returned by <code class="w3-codespan">uname</code> on POSIX systems, or from the <code class="w3-codespan">ver</code> command on Windows.</p>
...
<div class="w3-example">
  ...
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_os_type">Try it Yourself &raquo;</a>
</div>

<h3>os.release()</h3>
<p>Returns the operating system release number.</p>

<div class="w3-example">
  <div class="w3-code notranslate jsHigh">
  const os = require('os');<br>
  <br>
  // Get OS release information<br>
  console.log(`OS Release: ${os.release()}`);<br>
  <br>
  // Examples:<br>
  // - '10.0.19044' on Windows 10<br>
  // - '21.6.0' on macOS Monterey<br>
  // - '5.15.0-46-generic' on Ubuntu
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_os_release">Try it Yourself &raquo;</a>
</div>

<h3>os.version()</h3>
<p>Returns a string identifying the kernel version. On Windows, this includes build information.</p>
...
<div class="w3-example">
  ...
  console.log(`Kernel Version: ${os.version()}`);<br>
  <br>
  // Example output:<br>
  // - Windows: 'Windows 10 Enterprise 10.0.19044'<br>
  // - Linux: '#49-Ubuntu SMP Tue Aug 2 08:49:28 UTC 2022'<br>
  // - macOS: 'Darwin Kernel Version 21.6.0: ...'
  </div>
</div>
<hr>
<h2>User and Environment</h2>

<h3>os.userInfo()</h3>
<p>Returns information about the currently effective user.</p>
...
<div class="w3-example">
  ...
  const user = os.userInfo();<br>
  console.log('User Information:');<br>
  console.log(`- Username: ${user.username}`);<br>
  console.log(`- User ID: ${user.uid}`);<br>
  console.log(`- Group ID: ${user.gid}`);<br>
  console.log(`- Home Directory: ${user.homedir}`);<br>
  <br>
  // On Windows, you can also get the user's domain<br>
  if (os.platform() === 'win32') {<br>
  &nbsp;&nbsp;console.log(`- Domain: ${user.domain || 'N/A'}`);<br>
  }<br>
  <br>
  // Note: user.shell is only available on POSIX platforms<br>
  if (user.shell) {<br>
  &nbsp;&nbsp;console.log(`- Default Shell: ${user.shell}`);<br>
  }
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_os_userinfo">Run Example &raquo;</a>
</div>
...
<div class="w3-example">
  ...
  <br>
  // Get the home directory<br>
  const homeDir = os.homedir();<br>
  console.log(`Home Directory: ${homeDir}`);<br>
  <br>
  // Example: Create a path to a config file in the user's home directory<br>
  const configPath = path.join(homeDir, '.myapp', 'config.json');<br>
  console.log(`Config file will be saved to: ${configPath}`);
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_os_homedir">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-example">
  ...
  const os = require('os');<br>
  <br>
  // Get the system hostname<br>
  const hostname = os.hostname();<br>
  console.log(`Hostname: ${hostname}`);<br>
  <br>
  // Example: Use hostname in logging or configuration<br>
  console.log(`Server started on ${hostname} at ${new Date().toISOString()}`);
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_os_hostname">Try it Yourself &raquo;</a>
</div>

<h3>os.tmpdir()</h3>
<p>Returns the operating system's default directory for temporary files.</p>

<div class="w3-example">
  <div class="w3-code notranslate jsHigh">
  const os = require('os');<br>
  <br>
  // Get the system default temp dir<br>
  console.log(`Temporary Directory: ${os.tmpdir()}`);  
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_os_tmpdir">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-example">
  ...
  const os = require('os');<br>
  <br>
  // Get CPU information<br>
  const cpus = os.cpus();<br>
  console.log(`Number of CPU Cores: ${cpus.length}`);<br>
  <br>
  // Display information about each CPU core<br>
  cpus.forEach((cpu, index) => {<br>
  &nbsp;&nbsp;console.log(`\nCPU Core ${index + 1}:`);<br>
  &nbsp;&nbsp;console.log(`- Model: ${cpu.model}`);<br>
  &nbsp;&nbsp;console.log(`- Speed: ${cpu.speed} MHz`);<br>
  &nbsp;&nbsp;console.log('- Times (ms):', {
  &nbsp;&nbsp;&nbsp;&nbsp;user: cpu.times.user,<br>
  &nbsp;&nbsp;&nbsp;&nbsp;nice: cpu.times.nice,<br>
  &nbsp;&nbsp;&nbsp;&nbsp;sys: cpu.times.sys,<br>
  &nbsp;&nbsp;&nbsp;&nbsp;idle: cpu.times.idle,<br>
  &nbsp;&nbsp;&nbsp;&nbsp;irq: cpu.times.irq<br>
  &nbsp;&nbsp;});<br>
  });
  <br>
  // Calculate total CPU usage (example, requires two measurements)<br>
  function calculateCpuUsage(prevCpus) {<br>
  &nbsp;&nbsp;const currentCpus = os.cpus();<br>
  &nbsp;&nbsp;const usage = [];<br>
  <br>
  &nbsp;&nbsp;for (let i = 0; i < currentCpus.length; i++) {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;const current = currentCpus[i];<br>
  &nbsp;&nbsp;&nbsp;&nbsp;const prev = prevCpus ? prevCpus[i] : { times: { user: 0, nice: 0, sys: 0, idle: 0, irq: 0 } };<br>
  <br>
  &nbsp;&nbsp;&nbsp;&nbsp;const prevIdle = prev.times.idle;<br>
  &nbsp;&nbsp;&nbsp;&nbsp;const idle = current.times.idle - prevIdle;<br>
  <br>
  &nbsp;&nbsp;&nbsp;&nbsp;let total = 0;<br>
  &nbsp;&nbsp;&nbsp;&nbsp;for (const type in current.times) {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;total += current.times[type] - (prev.times[type] || 0);<br>
  &nbsp;&nbsp;&nbsp;&nbsp;}<br>
  <br>
  &nbsp;&nbsp;&nbsp;&nbsp;const usagePercent = ((1 - idle / total) * 100).toFixed(1);<br>
  &nbsp;&nbsp;&nbsp;&nbsp;usage.push(parseFloat(usagePercent));<br>
  &nbsp;&nbsp;}<br>
  <br>
  &nbsp;&nbsp;return {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;perCore: usage,<br>
  &nbsp;&nbsp;&nbsp;&nbsp;average: (usage.reduce((a, b) => a + b, 0) / usage.length).toFixed(1),<br>
  &nbsp;&nbsp;&nbsp;&nbsp;cpus: currentCpus<br>
  &nbsp;&nbsp;};<br>
  }<br>
  <br>
  // Example usage of CPU usage calculation<br>
  console.log('\nCPU Usage (requires two measurements):');<br>
  const firstMeasure = os.cpus();<br>
  <br>
  // Simulate some CPU work<br>
  for (let i = 0; i &lt; 1000000000; i++) {}<br>
  const usage = calculateCpuUsage(firstMeasure);<br>
  console.log(`Average CPU Usage: ${usage.average}%`);
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_os_cpus">Try it Yourself &raquo;</a>
</div>

<h4>os.totalmem() and os.freemem()</h4>
<p>Return the total and free system memory in bytes, respectively.</p>

<div class="w3-example">
  <div class="w3-code notranslate jsHigh">
  const os = require('os');<br>
  <br>
  // Format bytes to human-readable format<br>
  function formatBytes(bytes, decimals = 2) {<br>
  &nbsp;&nbsp;if (bytes === 0) return '0 Bytes';<br>
  &nbsp;&nbsp;const k = 1024;<br>
  &nbsp;&nbsp;const dm = decimals &lt; 0 ? 0 : decimals;<br>
  &nbsp;&nbsp;const sizes = ['Bytes', 'KB', 'MB', 'GB', 'TB', 'PB', 'EB', 'ZB', 'YB'];<br>
  &nbsp;&nbsp;const i = Math.floor(Math.log(bytes) / Math.log(k));<br>
  &nbsp;&nbsp;return parseFloat((bytes / Math.pow(k, i)).toFixed(dm)) + ' ' + sizes[i];<br>
  }<br>
  <br>
  // Get memory information<br>
  const totalMem = os.totalmem();<br>
  const freeMem = os.freemem();<br>
  const usedMem = totalMem - freeMem;<br>
  const usagePercent = ((usedMem / totalMem) * 100).toFixed(2);<br>
  <br>
  console.log('Memory Information:');<br>
  console.log(`- Total Memory: ${formatBytes(totalMem)}`);<br>
  console.log(`- Free Memory: ${formatBytes(freeMem)} (${((freeMem / totalMem) * 100).toFixed(2)}%)`);<br>
  console.log(`- Used Memory: ${formatBytes(usedMem)} (${usagePercent}%)`);<br>
  <br>
  // Example: Check if there's enough free memory<br>
  const MIN_FREE_MEMORY = 200 * 1024 * 1024; // 200MB<br>
  if (freeMem &lt; MIN_FREE_MEMORY) {<br>
  &nbsp;&nbsp;console.warn('Warning: Low on memory!');<br>
  } else {<br>
  &nbsp;&nbsp;console.log('System has sufficient memory available');<br>
  }
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_os_memory">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-example">
  ...
  const os = require('os');<br>
  <br>
  // Get load averages<br>
  const loadAverages = os.loadavg();<br>
  console.log('System Load Averages (1, 5, 15 min):', loadAverages);<br>
  <br>
  // On Linux/Unix, load average represents the average system load over the last 1, 5, and 15 minutes<br>
  // The values represent the number of processes in the system run queue<br>
  const [oneMin, fiveMin, fifteenMin] = loadAverages;<br>
  const cpuCount = os.cpus().length;<br>
  <br>
  console.log(`1-minute load average: ${oneMin.toFixed(2)} (${(oneMin / cpuCount * 100).toFixed(1)}% of ${cpuCount} cores)`);<br>
  console.log(`5-minute load average: ${fiveMin.toFixed(2)}`);<br>
  console.log(`15-minute load average: ${fifteenMin.toFixed(2)}`);<br>
  <br>
  // Example: Check if system is under heavy load<br>
  const isSystemOverloaded = oneMin &gt; cpuCount * 1.5;<br>
  if (isSystemOverloaded) {<br>
  &nbsp;&nbsp;console.warn('Warning: System is under heavy load!');<br>
  } else {<br>
  &nbsp;&nbsp;console.log('System load is normal');<br>
  }
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_os_loadavg">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Network Information</h2>

<h4>os.networkInterfaces()</h4>
<p>Returns an object containing network interfaces that have been assigned a network address.</p>

<div class="w3-example">
  <div class="w3-code notranslate jsHigh">
  const os = require('os');<br>
  <br>
  // Get network interfaces information<br>
  const networkInterfaces = os.networkInterfaces();<br>
  <br>
  console.log('Network Interfaces:');<br>
  <br>
  // Iterate over each network interface<br>
  Object.entries(networkInterfaces).forEach(([name, addresses]) => {<br>
  &nbsp;&nbsp;console.log(`\nInterface: ${name}`);<br>
  &nbsp;&nbsp;addresses.forEach((address) => {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;console.log(`- Family: ${address.family}`);<br>
  &nbsp;&nbsp;&nbsp;&nbsp;console.log(`  Address: ${address.address}`);<br>
  &nbsp;&nbsp;&nbsp;&nbsp;console.log(`  Netmask: ${address.netmask}`);<br>
  &nbsp;&nbsp;&nbsp;&nbsp;console.log(`  MAC: ${address.mac || 'N/A'}`);<br>
  &nbsp;&nbsp;&nbsp;&nbsp;console.log(`  Internal: ${address.internal}`);<br>
  &nbsp;&nbsp;});<br>
  });<br>
  <br>
  // Example: Find the first non-internal IPv4 address<br>
  function getLocalIpAddress() {<br>
  &nbsp;&nbsp;const interfaces = os.networkInterfaces();<br>
  &nbsp;&nbsp;for (const name of Object.keys(interfaces)) {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;for (const iface of interfaces[name]) {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (iface.family === 'IPv4' && !iface.internal) {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return iface.address;<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
  &nbsp;&nbsp;&nbsp;&nbsp;}<br>
  &nbsp;&nbsp;}<br>
  &nbsp;&nbsp;return '127.0.0.1'; // Fallback to localhost<br>
  }<br>
  <br>
  const localIp = getLocalIpAddress();<br>
  console.log(`\nLocal IP Address: ${localIp}`);
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_os_network">Try it Yourself &raquo;</a>
</div>
...
const os = require('os');<br>
<br>
// Get system uptime in seconds<br>
const uptime = os.uptime();<br>
console.log(`System Uptime: ${uptime} seconds`);<br>
<br>
// Format uptime in a more readable way<br>
const uptimeDays = Math.floor(uptime / (60 * 60 * 24));<br>
const uptimeHours = Math.floor((uptime % (60 * 60 * 24)) / (60 * 60));<br>
const uptimeMinutes = Math.floor((uptime % (60 * 60)) / 60);<br>
const uptimeSeconds = Math.floor(uptime % 60);<br>
<br>
console.log(`System has been running for: ${uptimeDays} days, ${uptimeHours} hours, ${uptimeMinutes} minutes, ${uptimeSeconds} seconds`);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_os_uptime">Try it Yourself &raquo;</a>
</div>

<h3>os.networkInterfaces()</h3>
<p>Returns an object containing information about network interfaces.</p>
...
const networkInterfaces = os.networkInterfaces();<br>
console.log('Network Interfaces:');<br>
console.log(JSON.stringify(networkInterfaces, null, 2));<br>
<br>
// Iterate through network interfaces<br>
Object.keys(networkInterfaces).forEach((interfaceName) => {<br>
&nbsp;&nbsp;console.log(`\nInterface: ${interfaceName}`);<br>
<br>
&nbsp;&nbsp;networkInterfaces[interfaceName].forEach((interface) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`  Address Family: ${interface.family}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`  IP Address: ${interface.address}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`  Netmask: ${interface.netmask}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (interface.mac) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`  MAC Address: ${interface.mac}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`  Internal: ${interface.internal ? 'Yes' : 'No'}`);<br>
&nbsp;&nbsp;});<br>
});<br>
<br>
// Function to get primary IPv4 address (non-internal)<br>
function getPrimaryIPv4Address() {<br>
&nbsp;&nbsp;const interfaces = os.networkInterfaces();<br>
&nbsp;&nbsp;for (const name of Object.keys(interfaces)) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;for (const interface of interfaces[name]) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Skip internal and non-IPv4 addresses<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (!interface.internal && interface.family === 'IPv4') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return interface.address;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;return 'No IPv4 address found';<br>
}<br>
<br>
console.log(`\nPrimary IPv4 Address: ${getPrimaryIPv4Address()}`);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_os_networkinterfaces">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>OS Constants and Utilities</h2>

<h4>os.constants</h4>
<p>Returns an object containing commonly used operating system specific constants for error codes, process signals, and more.</p>

<div class="w3-example">
  <div class="w3-code notranslate jsHigh">
  const os = require('os');<br>
  <br>
  // Get all signal constants<br>
  console.log('Signal Constants:', os.constants.signals);<br>
  <br>
  // Example: Handle common signals<br>
  process.on('SIGINT', () => {<br>
  &nbsp;&nbsp;console.log('Received SIGINT. Performing cleanup...');<br>
  &nbsp;&nbsp;process.exit(0);<br>
  });<br>
  <br>
  process.on('SIGTERM', () => {<br>
  &nbsp;&nbsp;console.log('Received SIGTERM. Shutting down gracefully...');<br>
  &nbsp;&nbsp;process.exit(0);<br>
  });<br>
  <br>
  console.log('Process is running. Press Ctrl+C to exit.');
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_os_constants">Try it Yourself &raquo;</a>
</div>

<h4>os.EOL</h4>
<p>Returns the end-of-line marker for the current operating system.</p>
...
<div class="w3-example">
  ...
  <br>
  // Get the end-of-line marker for the current OS<br>
  console.log('End of Line character:', JSON.stringify(os.EOL));<br>
  <br>
  // Example: Write a file with platform-specific line endings<br>
  const lines = [<br>
  &nbsp;&nbsp;'First line',<br>
  &nbsp;&nbsp;'Second line',<br>
  &nbsp;&nbsp;'Third line'<br>
  ...
  <br>
  // Join lines with the correct EOL character<br>
  const content = lines.join(os.EOL);<br>
  fs.writeFileSync('output.txt', content);<br>
  console.log('File written with platform-appropriate line endings');
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_os_eol">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Best Practices</h2>

<div class="w3-panel ws-note">
  <h4>1. Handle Paths Correctly</h4>
  <p>Always use <code class="w3-codespan">path.join()</code> instead of string concatenation for file paths to ensure cross-platform compatibility.</p>
  
  <div class="w3-code notranslate">
  // Good<br>
  const filePath = path.join(os.homedir(), 'app', 'config.json');<br>
  <br>
  // Bad (won't work on Windows)<br>
  const badPath = `${os.homedir()}/app/config.json`;
  </div>
</div>

<div class="w3-panel ws-note">
  <h4>2. Be Cautious with os.EOL</h4>
  <p>When writing files, be aware of line endings. Use <code class="w3-codespan">os.EOL</code> for cross-platform compatibility.</p>
  
  <div class="w3-code notranslate">
  const content = `First Line${os.EOL}Second Line${os.EOL}Third Line`;<br>
  fs.writeFileSync('output.txt', content, 'utf8');
  </div>
</div>

<div class="w3-panel ws-note">
  <h4>3. Handle Memory Constraints</h4>
  <p>Check available memory before performing memory-intensive operations.</p>
  
  <div class="w3-code notranslate">
  const MIN_FREE_MEMORY_MB = 500; // 500MB minimum free memory<br>
  <br>
  function canPerformMemoryIntensiveOperation() {<br>
  &nbsp;&nbsp;const freeMemMB = os.freemem() / (1024 * 1024);<br>
  &nbsp;&nbsp;return freeMemMB > MIN_FREE_MEMORY_MB;<br>
  }<br>
  <br>
  if (!canPerformMemoryIntensiveOperation()) {<br>
  &nbsp;&nbsp;console.warn('Not enough free memory to perform this operation');<br>
  &nbsp;&nbsp;// Handle the error appropriately<br>
  }
  </div>
</div>
...
<h3>System Information Dashboard</h3>
<p>This example creates a comprehensive system information report:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const os = require('os');<br>
<br>
function getSystemInfo() {<br>
&nbsp;&nbsp;const info = {<br>
&nbsp;&nbsp;&nbsp;&nbsp;os: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;type: os.type(),<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;uptime: formatUptime(os.uptime())<br>
&nbsp;&nbsp;&nbsp;&nbsp;},<br>
&nbsp;&nbsp;&nbsp;&nbsp;user: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;username: os.userInfo().username,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;homedir: os.homedir(),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;tempdir: os.tmpdir()<br>
&nbsp;&nbsp;&nbsp;&nbsp;},<br>
&nbsp;&nbsp;&nbsp;&nbsp;memory: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;total: formatBytes(os.totalmem()),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;free: formatBytes(os.freemem()),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;usage: `${((1 - os.freemem() / os.totalmem()) * 100).toFixed(2)}%`<br>
&nbsp;&nbsp;&nbsp;&nbsp;},<br>
&nbsp;&nbsp;&nbsp;&nbsp;cpu: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;model: os.cpus()[0].model,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;cores: os.cpus().length,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;speed: `${os.cpus()[0].speed} MHz`<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;};<br>
<br>
&nbsp;&nbsp;return info;<br>
...
&nbsp;&nbsp;const days = Math.floor(seconds / (60 * 60 * 24));<br>
&nbsp;&nbsp;const hours = Math.floor((seconds % (60 * 60 * 24)) / (60 * 60));<br>
&nbsp;&nbsp;const minutes = Math.floor((seconds % (60 * 60)) / 60);<br>
&nbsp;&nbsp;const secs = Math.floor(seconds % 60);<br>
<br>
&nbsp;&nbsp;return `${days}d ${hours}h ${minutes}m ${secs}s`;<br>
}<br>
<br>
function formatBytes(bytes) {<br>
&nbsp;&nbsp;const sizes = ['Bytes', 'KB', 'MB', 'GB', 'TB'];<br>
&nbsp;&nbsp;if (bytes === 0) return '0 Bytes';<br>
&nbsp;&nbsp;const i = parseInt(Math.floor(Math.log(bytes) / Math.log(1024)));<br>
&nbsp;&nbsp;return `${(bytes / Math.pow(1024, i)).toFixed(2)} ${sizes[i]}`;<br>
}<br>
<br>
// Display the system information dashboard<br>
const systemInfo = getSystemInfo();<br>
console.log('======= SYSTEM INFORMATION DASHBOARD =======');<br>
console.log(JSON.stringify(systemInfo, null, 2));<br>
<br>
// Display in a more formatted way<br>
console.log('\n======= FORMATTED SYSTEM INFORMATION =======');<br>
console.log(`OS: ${systemInfo.os.type} (${systemInfo.os.platform} ${systemInfo.os.architecture})`);<br>
console.log(`Version: ${systemInfo.os.release}`);<br>
console.log(`Hostname: ${systemInfo.os.hostname}`);<br>
console.log(`Uptime: ${systemInfo.os.uptime}`);<br>
console.log(`User: ${systemInfo.user.username}`);<br>
console.log(`Home Directory: ${systemInfo.user.homedir}`);<br>
console.log(`CPU: ${systemInfo.cpu.model}`);<br>
console.log(`Cores: ${systemInfo.cpu.cores}`);<br>
console.log(`Speed: ${systemInfo.cpu.speed}`);<br>
console.log(`Memory Total: ${systemInfo.memory.total}`);<br>
console.log(`Memory Free: ${systemInfo.memory.free}`);<br>
console.log(`Memory Usage: ${systemInfo.memory.usage}`);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_os_system_info">Run Example &raquo;</a>
</div>

<h3>Resource Monitor</h3>
<p>This example creates a basic resource monitor that updates every second:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const os = require('os');<br>
<br>
function monitorResources() {<br>
&nbsp;&nbsp;console.clear(); // Clear console for a cleaner display<br>
<br>
&nbsp;&nbsp;const now = new Date().toLocaleTimeString();<br>
&nbsp;&nbsp;console.log(`======= RESOURCE MONITOR (${now}) =======`);<br>
<br>
&nbsp;&nbsp;// CPU Usage<br>
&nbsp;&nbsp;const cpus = os.cpus();<br>
&nbsp;&nbsp;console.log(`\nCPU Cores: ${cpus.length}`);<br>
<br>
&nbsp;&nbsp;// Calculate CPU usage (this is approximate since we need two measurements)<br>
&nbsp;&nbsp;const cpuUsage = cpus.map((cpu, index) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const total = Object.values(cpu.times).reduce((acc, tv) => acc + tv, 0);<br>
&nbsp;&nbsp;&nbsp;&nbsp;const idle = cpu.times.idle;<br>
&nbsp;&nbsp;&nbsp;&nbsp;const usage = ((total - idle) / total * 100).toFixed(1);<br>
&nbsp;&nbsp;&nbsp;&nbsp;return `Core ${index}: ${usage}% used`;<br>
&nbsp;&nbsp;});<br>
<br>
...
<br>
&nbsp;&nbsp;console.log('\nMemory Usage:');<br>
&nbsp;&nbsp;console.log(`Total: ${formatBytes(totalMem)}`);<br>
&nbsp;&nbsp;console.log(`Used: ${formatBytes(usedMem)} (${(usedMem / totalMem * 100).toFixed(1)}%)`);<br>
&nbsp;&nbsp;console.log(`Free: ${formatBytes(freeMem)} (${(freeMem / totalMem * 100).toFixed(1)}%)`);<br>
<br>
&nbsp;&nbsp;// System Uptime<br>
&nbsp;&nbsp;console.log(`\nSystem Uptime: ${formatUptime(os.uptime())}`);<br>
<br>
&nbsp;&nbsp;// Process Info<br>
&nbsp;&nbsp;console.log('\nProcess Information:');<br>
&nbsp;&nbsp;console.log(`PID: ${process.pid}`);<br>
&nbsp;&nbsp;console.log(`Memory Usage: ${formatBytes(process.memoryUsage().rss)}`);<br>
&nbsp;&nbsp;console.log(`User: ${os.userInfo().username}`);<br>
}<br>
<br>
function formatBytes(bytes) {<br>
&nbsp;&nbsp;const sizes = ['Bytes', 'KB', 'MB', 'GB', 'TB'];<br>
...
monitorResources();<br>
<br>
// Update every second (note: in a real application, you might not want<br>
// to update this frequently as it uses CPU resources)<br>
const intervalId = setInterval(monitorResources, 1000);<br>
<br>
// In a real application, you would need to handle cleanup:<br>
// clearInterval(intervalId);<br>
<br>
// For this example, we'll run for 10 seconds then stop<br>
console.log('Monitor will run for 10 seconds...');<br>
setTimeout(() => {<br>
&nbsp;&nbsp;clearInterval(intervalId);<br>
&nbsp;&nbsp;console.log('\nResource monitoring stopped.');<br>
}, 10000);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_os_resource_monitor">Run Example &raquo;</a>
</div>

<h3>Platform-Specific Behavior</h3>
<p>This example demonstrates how to adapt your application's behavior based on the operating system:</p>
...
const path = require('path');<br>
<br>
// Function to determine a good location for app data based on the OS<br>
function getAppDataPath(appName) {<br>
&nbsp;&nbsp;const platform = os.platform();<br>
<br>
&nbsp;&nbsp;let appDataPath;<br>
<br>
&nbsp;&nbsp;switch (platform) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;case 'win32': // Windows<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;appDataPath = path.join(process.env.APPDATA || '', appName);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;break;<br>
&nbsp;&nbsp;&nbsp;&nbsp;case 'darwin': // macOS<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;appDataPath = path.join(os.homedir(), 'Library', 'Application Support', appName);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;break;<br>
&nbsp;&nbsp;&nbsp;&nbsp;case 'linux': // Linux<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;appDataPath = path.join(os.homedir(), '.config', appName);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;break;<br>
&nbsp;&nbsp;&nbsp;&nbsp;default: // Fallback for other platforms<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;appDataPath = path.join(os.homedir(), `.${appName}`);<br>
&nbsp;&nbsp;}<br>
<br>
&nbsp;&nbsp;return appDataPath;<br>
}<br>
<br>
// Function to get appropriate command based on OS<br>
function getOpenCommand() {<br>
&nbsp;&nbsp;const platform = os.platform();<br>
<br>
&nbsp;&nbsp;switch (platform) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;case 'win32': // Windows<br>
...
const appDataPath = getAppDataPath(appName);<br>
const openCommand = getOpenCommand();<br>
<br>
console.log(`OS Platform: ${os.platform()}`);<br>
console.log(`OS Type: ${os.type()}`);<br>
console.log(`Recommended App Data Path: ${appDataPath}`);<br>
console.log(`Open Command: ${openCommand}`);<br>
<br>
// Example of platform-specific behavior<br>
console.log('\nPlatform-Specific Actions:');<br>
<br>
if (os.platform() === 'win32') {<br>
&nbsp;&nbsp;console.log('- Using Windows-specific registry functions');<br>
&nbsp;&nbsp;console.log('- Setting up Windows service');<br>
} else if (os.platform() === 'darwin') {<br>
&nbsp;&nbsp;console.log('- Using macOS keychain for secure storage');<br>
&nbsp;&nbsp;console.log('- Setting up launchd agent');<br>
} else if (os.platform() === 'linux') {<br>
&nbsp;&nbsp;console.log('- Using Linux systemd for service management');<br>
&nbsp;&nbsp;console.log('- Setting up dbus integration');<br>
}<br>
<br>
// Example of checking for available memory and adjusting behavior<br>
const availableMemGB = os.freemem() / (1024 * 1024 * 1024);<br>
console.log(`\nAvailable Memory: ${availableMemGB.toFixed(2)} GB`);<br>
<br>
if (availableMemGB &lt; 0.5) {<br>
&nbsp;&nbsp;console.log('Low memory mode activated: reducing cache size and disabling features');<br>
} else if (availableMemGB > 4) {<br>
&nbsp;&nbsp;console.log('High memory mode activated: increasing cache size and enabling all features');<br>
} else {<br>
&nbsp;&nbsp;console.log('Standard memory mode activated: using default settings');<br>
}<br>
<br>
// Example of CPU core detection for parallel processing<br>
const cpuCount = os.cpus().length;<br>
console.log(`\nCPU Cores: ${cpuCount}`);<br>
<br>
const recommendedWorkers = Math.max(1, cpuCount - 1); // Leave one core for the system<br>
console.log(`Recommended worker processes: ${recommendedWorkers}`);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_os_platform_specific">Try it Yourself &raquo;</a>
</div>
...
<p>The Node.js OS module provides a powerful set of tools for interacting with the operating system.</p>
<p>With it, you can:</p>

<ul>
  <li>Retrieve system information such as CPU architecture, platform, and release version</li>
  <li>Monitor memory usage and CPU performance</li>
  <li>Access user information like home directory and username</li>
  <li>Get network interface information</li>
  <li>Determine system uptime</li>
  <li>Use operating system-specific constants and end-of-line markers</li>
</ul>

<p>These capabilities are particularly useful for:</p>

<ul>
  <li>Building cross-platform applications that adapt to the host environment</li>
  <li>Monitoring system resources</li>
  <li>Creating diagnostic tools</li>
  <li>Making path and file-related operations that work correctly across different operating systems</li>
  <li>Optimizing application performance based on available system resources</li>
</ul>

<p>By using the OS module, you can make your Node.js applications more robust, efficient, and adaptable to different operating environments.</p>

<hr>


<div id="exercisecontainer" src="xrcise_os.js" data-extensions="asp"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_path.asp">&#10094; Previous</a>
