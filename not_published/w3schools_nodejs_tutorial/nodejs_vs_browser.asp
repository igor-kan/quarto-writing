...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js vs Browser</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js vs Browser">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_vs_browser.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="How running JavaScript in Node.js differs from running it in the browser.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js vs Browser">
<meta name="twitter:description" content="How running JavaScript in Node.js differs from running it in the browser.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_vs_browser.png">
...
<h1>Node.js <span class="color_h1">vs Browser</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_js_requirements.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="nodejs_command_line.asp">Next &#10095;</a>
</div>
<hr>

<h2 id="differences">Key Differences</h2>
<p>Node.js and browsers both run JavaScript, but they have different environments and capabilities.</p>
<p>Node.js is designed for server-side development, while browsers are for client-side applications.</p>

<ul>
  <li><b>APIs:</b> Node.js provides APIs for file system, networking, and OS, which browsers do not.<br>
    Browsers provide DOM, fetch, and UI APIs not available in Node.js.</li>
  <li><b>Global Objects:</b> Node.js uses <code class="w3-codespan">global</code>; browsers use <code class="w3-codespan">window</code> or <code class="w3-codespan">self</code>.</li>
  <li><b>Modules:</b> Node.js uses CommonJS (<code class="w3-codespan">require</code>) and ES modules (<code class="w3-codespan">import</code>); browsers use ES modules or plain <code class="w3-codespan">&lt;script&gt;</code> tags.</li>
  <li><b>Security:</b> Browsers run in a sandbox with limited access; Node.js has full access to the file system and network.</li>
  <li><b>Event Loop:</b> Both environments use an event loop, but Node.js has additional APIs for timers, process, etc.</li>
  <li><b>Environment Variables:</b> Node.js can access environment variables (<code class="w3-codespan">process.env</code>); browsers cannot.</li>
  <li><b>Package Management:</b> Node.js uses npm/yarn; browsers use CDNs or bundlers.</li>
</ul>
<p>This page explains the key differences, with examples for each environment.</p>
<hr>
<h2 id="examples">Examples</h2>
<div class="w3-example">
<h3>Global Objects</h3>
<div class="w3-code notranslate jsHigh">// Node.js<br>
global.mylet = 42;<br>
console.log(global.mylet); // 42<br>
</div>
<div class="w3-code notranslate jsHigh">
// Browser<br>
window.mylet = 42;<br>
console.log(window.mylet); // 42<br>
</div>
</div>
...
<div class="w3-code notranslate jsHigh">
// Browser<br>
// Not allowed for security reasons<br>
</div>
</div>
...
https.get('https://example.com', res => {<br>
&nbsp;&nbsp;let data = '';<br>
&nbsp;&nbsp;res.on('data', chunk => data += chunk);<br>
&nbsp;&nbsp;res.on('end', () => console.log(data));<br>
});<br>
</div>
<div class="w3-code notranslate jsHigh">
// Browser<br>
...
<div class="w3-example">
<h3>Modules</h3>
<div class="w3-code notranslate jsHigh">// Node.js (CommonJS)<br>
const fs = require('fs');<br>
</div>
<div class="w3-code notranslate jsHigh">
// Node.js & Browser (ES Modules)<br>
// import fs from 'fs'; // Node.js only, not browser<br>
// import _ from 'https://cdn.jsdelivr.net/npm/lodash-es/lodash.js'; // Browser<br>
</div>
</div>
...
<tr><th>Feature</th><th>Node.js</th><th>Browser</th></tr>
<tr><td>File System Access</td><td>Yes</td><td>No</td></tr>
<tr><td>Networking (TCP/UDP)</td><td>Yes</td><td>No</td></tr>
<tr><td>DOM Access</td><td>No</td><td>Yes</td></tr>
<tr><td>Global Object</td><td>global</td><td>window/self</td></tr>
<tr><td>Modules</td><td>CommonJS/ESM</td><td>ESM/Scripts</td></tr>
<tr><td>Environment Variables</td><td>Yes (<code class="w3-codespan">process.env</code>)</td><td>No</td></tr>
<tr><td>Security</td><td>Full OS access</td><td>Sandboxed</td></tr>
<tr><td>Package Management</td><td>npm/yarn</td><td>CDN/Bundler</td></tr>
</table>
<hr>
<div id="exercisecontainer" src="xrcise_vs_browser.js" data-extensions="asp"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_js_requirements.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="nodejs_command_line.asp">Next &#10095;</a>
