...
<meta name="title" property="og:title" content="Node.js NPM">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_npm.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="NPM is a package manager for Node.js packages, or modules if you like.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js NPM">
<meta name="twitter:description" content="NPM is a package manager for Node.js packages, or modules if you like.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_npm.png">
...
<a class="w3-left w3-btn" href="nodejs_modules_esm.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="nodejs_package_json.asp">Next &#10095;</a>
</div>
<hr>
<h2>What is NPM?</h2>
<p>NPM is a package manager for Node.js packages, or modules if you like.</p>
<p><a href="https://www.npmjs.com" target="_blank">www.npmjs.com</a> hosts thousands of free packages to download and use.</p>
<p>The NPM program is installed on your computer when you install Node.js</p>
<div class="w3-panel ws-note">
  <p>If you installed Node.js, NPM is already ready to run on your computer!</p>
</div>
...
<p>NPM creates a folder named &quot;node_modules&quot;, where the package will be placed.</p>
<p>All packages you install in the future will be placed in this folder.</p>
...
<p>Include the &quot;upper-case&quot; package the same way you include any other module:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
let uc = require('upper-case');</div>
</div>
...
<p>Packages can be installed globally, making them available as command-line tools anywhere on your system.</p>
<p>Global packages are typically used for CLI tools and utilities.</p>

<div class="w3-example">
<h3>Install a package globally:</h3>
<div class="w3-code notranslate w3-black">
...
<div class="w3-example">
<h3>Example: Install the http-server package globally</h3>
<div class="w3-code notranslate w3-black">
npm install -g http-server
</div>
<p>After installation, you can run the package from any directory:</p>
<div class="w3-code notranslate w3-black">
http-server
</div>
</div>
...
<div class="w3-panel ws-note">
<p><strong>Note:</strong> On some systems, you might need administrator/root privileges to install packages globally.</p>
<p>On Unix-like systems, use <code class="w3-codespan">sudo</code> before the command.</p>
</div>
<hr>

<h2>Updating Packages</h2>
<p>To keep your packages up to date, you can update them using the following commands:</p>
...
<div class="w3-example">
<h3>Update all packages in your project:</h3>
<div class="w3-code notranslate w3-black">
npm update
</div>
</div>
...
<div class="w3-panel ws-note">
<p><strong>Tip:</strong> To update npm itself, run: <code class="w3-codespan">npm install -g npm@latest</code></p>
</div>
<hr>

<h2>Uninstalling a Package</h2>
<p>To remove a package that you no longer need, you can use the uninstall command:</p>
...
<div class="w3-example">
<h3>Remove a package and its dependencies:</h3>
<div class="w3-code notranslate w3-black">
...
<div class="w3-panel ws-note">
<p><strong>Note:</strong> The <code class="w3-codespan">--save</code> flag updates your package.json file to remove the dependency.</p>
<p>For older versions of npm, you might need to use <code class="w3-codespan">--save-dev</code> for development dependencies.</p>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_npm.js" data-extensions="asp"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_modules_esm.asp">&#10094; Previous</a>
