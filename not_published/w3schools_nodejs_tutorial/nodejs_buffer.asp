...
<meta name="title" property="og:title" content="Node.js Buffer Module">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_buffer.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="The Buffer module in Node.js is used to handle binary data.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Buffer Module">
<meta name="twitter:description" content="The Buffer module in Node.js is used to handle binary data.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_buffer.png">
...
<a class="w3-left w3-btn" href="nodejs_streams.asp">&lt; Previous</a>
<a class="w3-right w3-btn" href="nodejs_crypto.asp">Next &gt;</a>
</div>

<hr>
<h2>What is the Buffer Module?</h2>

<p>The Buffer module in Node.js is used to handle binary data.</p>
<p>Buffers are similar to arrays of integers but are fixed-length and correspond to raw memory allocations outside the V8 JavaScript engine.</p>

<p>Node.js provides the Buffer class as a global object, so you don't need to require or import it explicitly.</p>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> Since Node.js v6.0.0, the Buffer constructor is deprecated in favor of the new Buffer methods.</p>
<p>Using the constructor could lead to security vulnerabilities due to uninitialized memory.</p>
</div>

<hr>

<h2>Getting Started with Buffers</h2>

<p>Buffers in Node.js are used to handle binary data directly.</p>
<p>They are similar to arrays of integers but are fixed in size and represent raw memory allocations outside the V8 heap.</p>

<div class="w3-example">
<h3>Basic Buffer Example</h3>
<div class="w3-code notranslate jsHigh">// Create a buffer from a string<br>
const buf = Buffer.from('Hello, Node.js!');<br>
<br>
// Buffers can be converted to strings<br>
console.log(buf.toString()); // 'Hello, Node.js!'<br>
<br>
// Access individual bytes<br>
console.log(buf[0]); // 72 (ASCII for 'H')<br>
<br>
// Buffers have a fixed length<br>
console.log(buf.length); // 15</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_buffer_basic">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Creating Buffers</h2>

<p>There are several ways to create buffers in Node.js, each with different performance and safety characteristics:</p>

<p>There are several ways to create buffers in Node.js:</p>

<h3>1. Buffer.alloc()</h3>
<p>Creates a new Buffer of the specified size, initialized with zeros.</p>
<p>This is the safest way to create a new buffer as it ensures no old data is present.</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">// Create a buffer of 10 bytes filled with zeros<br>
const buffer1 = Buffer.alloc(10);<br>
console.log(buffer1);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_buffer_alloc">Run example &raquo;</a>
</div>

<h3>2. Buffer.allocUnsafe()</h3>
<p>Creates a new Buffer of the specified size, but doesn't initialize the memory.</p>
<p>This is faster than <code class="w3-codespan">Buffer.alloc()</code> but may contain old or sensitive data.</p>
<p>Always fill the buffer before use if security is a concern.</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">// Create an uninitialized buffer of 10 bytes<br>
const buffer2 = Buffer.allocUnsafe(10);<br>
console.log(buffer2);<br>
<br>
// Fill the buffer with zeros for security<br>
buffer2.fill(0);<br>
console.log(buffer2);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_buffer_allocunsafe">Run example &raquo;</a>
</div>

<div class="w3-panel ws-warning">
<p><strong>Warning:</strong> <code class="w3-codespan">Buffer.allocUnsafe()</code> is faster than <code class="w3-codespan">Buffer.alloc()</code> but can expose sensitive data.</p>
<p>Only use it when you understand the security implications and plan to immediately fill the entire buffer.</p>
</div>

<h3>3. Buffer.from()</h3>
<p>Creates a new Buffer from various sources like strings, arrays, or ArrayBuffer. This is the most flexible way to create buffers from existing data.</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">// Create a buffer from a string<br>
const buffer3 = Buffer.from('Hello, World!');<br>
console.log(buffer3);<br>
<br>
console.log(buffer3.toString());<br>
<br>
// Create a buffer from an array of integers<br>
const buffer4 = Buffer.from([65, 66, 67, 68, 69]);<br>
console.log(buffer4);<br>
<br>
console.log(buffer4.toString());<br>
<br>
// Create a buffer from another buffer<br>
const buffer5 = Buffer.from(buffer4);<br>
console.log(buffer5);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_buffer_from">Run example &raquo;</a>
</div>
...
<p>You can write data to a buffer using various methods:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">// Create an empty buffer<br>
const buffer = Buffer.alloc(10);<br>
<br>
// Write a string to the buffer<br>
buffer.write('Hello');<br>
console.log(buffer);<br>
<br>
console.log(buffer.toString());<br>
<br>
// Write bytes at specific positions<br>
buffer[5] = 44; // ASCII for ','<br>
buffer[6] = 32; // ASCII for space<br>
buffer.write('Node', 7);<br>
console.log(buffer.toString());</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_buffer_write">Run example &raquo;</a>
</div>

<h3>Reading from Buffers</h3>
<p>You can read data from a buffer using various methods:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">// Create a buffer from a string<br>
const buffer = Buffer.from('Hello, Node.js!');<br>
<br>
// Read the entire buffer as a string<br>
console.log(buffer.toString());<br>
<br>
// Read a portion of the buffer (start at position 7, end before position 11)<br>
console.log(buffer.toString('utf8', 7, 11));<br>
<br>
// Read a single byte<br>
console.log(buffer[0]);<br>
<br>
// Convert the ASCII code to a character<br>
console.log(String.fromCharCode(buffer[0]));</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_buffer_read">Run example &raquo;</a>
</div>

<h3>Iterating Through Buffers</h3>
<p>Buffers can be iterated like arrays:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">// Create a buffer from a string<br>
const buffer = Buffer.from('Hello');<br>
<br>
// Iterate using for...of loop<br>
for (const byte of buffer) {<br>
  console.log(byte);<br>
}<br>
<br>
// Iterate using forEach<br>
buffer.forEach((byte, index) => {<br>
&nbsp;&nbsp;console.log(`Byte at position ${index}: ${byte}`);<br>
});</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_buffer_iterate">Run example &raquo;</a>
</div>
...
<h3>Buffer.compare()</h3>
<p>Compares two buffers and returns a number indicating whether the first one comes before, after, or is the same as the second one in sort order:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">const buffer1 = Buffer.from('ABC');<br>
const buffer2 = Buffer.from('BCD');<br>
const buffer3 = Buffer.from('ABC');<br>
<br>
console.log(Buffer.compare(buffer1, buffer2));<br>
console.log(Buffer.compare(buffer2, buffer1));<br>
console.log(Buffer.compare(buffer1, buffer3));</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_buffer_compare">Run example &raquo;</a>
</div>

<h3>buffer.copy()</h3>
<p>Copies data from one buffer to another:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">// Create source and target buffers<br>
const source = Buffer.from('Hello, World!');<br>
const target = Buffer.alloc(source.length);<br>
<br>
// Copy from source to target<br>
source.copy(target);<br>
<br>
console.log(target.toString());<br>
<br>
// Create a target buffer for partial copy<br>
const partialTarget = Buffer.alloc(5);<br>
<br>
// Copy only part of the source (starting at index 7)<br>
source.copy(partialTarget, 0, 7);<br>
<br>
console.log(partialTarget.toString());</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_buffer_copy">Run example &raquo;</a>
</div>

<h3>buffer.slice()</h3>
<p>Creates a new buffer that references the same memory as the original, but with offset and cropped to the given end:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">const buffer = Buffer.from('Hello, World!');<br>
<br>
// Create a slice from position 7 to the end<br>
const slice = buffer.slice(7);<br>
console.log(slice.toString());<br>
<br>
// Create a slice from position 0 to 5<br>
const slice2 = buffer.slice(0, 5);<br>
console.log(slice2.toString());<br>
<br>
// Important: slices share memory with original buffer<br>
slice[0] = 119; // ASCII for 'w' (lowercase)<br>
console.log(slice.toString());<br>
console.log(buffer.toString());</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_buffer_slice">Run example &raquo;</a>
</div>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> Since <code class="w3-codespan">buffer.slice()</code> creates a view of the same memory, modifying either the original buffer or the slice will affect the other.</p>
</div>

<h3>buffer.toString()</h3>
<p>Decodes a buffer to a string using a specified encoding:</p>
...
<br>
// Specify encoding<br>
console.log(buffer.toString('utf8'));<br>
<br>
// Decode only a portion of the buffer<br>
console.log(buffer.toString('utf8', 0, 5));<br>
<br>
// Using different encodings<br>
const hexBuffer = Buffer.from('48656c6c6f', 'hex');<br>
console.log(hexBuffer.toString());<br>
<br>
const base64Buffer = Buffer.from('SGVsbG8=', 'base64');<br>
console.log(base64Buffer.toString());</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_buffer_tostring">Run example &raquo;</a>
</div>

<h3>buffer.equals()</h3>
<p>Compares two buffers for content equality:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">const buffer1 = Buffer.from('Hello');<br>
const buffer2 = Buffer.from('Hello');<br>
const buffer3 = Buffer.from('World');<br>
<br>
console.log(buffer1.equals(buffer2));<br>
<br>
console.log(buffer1.equals(buffer3));<br>
<br>
console.log(buffer1 === buffer2);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_buffer_equals">Run example &raquo;</a>
</div>

<hr>

<h2>Working with Encodings</h2>
<p>Buffers work with various encodings when converting between strings and binary data:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">// Create a string<br>
const str = 'Hello, World!';<br>
<br>
// Convert to different encodings<br>
const utf8Buffer = Buffer.from(str, 'utf8');<br>
console.log('UTF-8:', utf8Buffer);<br>
<br>
const base64Str = utf8Buffer.toString('base64');<br>
console.log('Base64 string:', base64Str);<br>
<br>
const hexStr = utf8Buffer.toString('hex');<br>
console.log('Hex string:', hexStr);<br>
<br>
// Convert back to original<br>
const fromBase64 = Buffer.from(base64Str, 'base64').toString('utf8');<br>
console.log('From Base64:', fromBase64);<br>
<br>
const fromHex = Buffer.from(hexStr, 'hex').toString('utf8');<br>
console.log('From Hex:', fromHex);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_buffer_encodings">Run example &raquo;</a>
</div>

<p>Supported encodings in Node.js include:</p>
<ul>
  <li><strong>utf8</strong>: Multi-byte encoded Unicode characters (default)</li>
  <li><strong>ascii</strong>: ASCII characters only (7-bit)</li>
  <li><strong>latin1</strong>: Latin-1 encoding (ISO 8859-1)</li>
  <li><strong>base64</strong>: Base64 encoding</li>
  <li><strong>hex</strong>: Hexadecimal encoding</li>
  <li><strong>binary</strong>: Binary encoding (deprecated)</li>
  <li><strong>ucs2/utf16le</strong>: 2 or 4 bytes, little-endian encoded Unicode characters</li>
</ul>

<hr>

<h2>Advanced Buffer Operations</h2>

<h3>Concatenating Buffers</h3>
<p>You can combine multiple buffers into one using <code class="w3-codespan">Buffer.concat()</code>:</p>

<div class="w3-example">
<h4>Example</h4>
<div class="w3-code notranslate jsHigh">const buf1 = Buffer.from('Hello, ');<br>
const buf2 = Buffer.from('Node.js!');<br>
<br>
// Concatenate buffers<br>
const combined = Buffer.concat([buf1, buf2]);<br>
console.log(combined.toString()); // 'Hello, Node.js!'<br>
<br>
// With a maximum length parameter<br>
const partial = Buffer.concat([buf1, buf2], 5);<br>
console.log(partial.toString()); // 'Hello'</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_buffer_concat">Run example &raquo;</a>
</div>

<h3>Searching in Buffers</h3>
<p>Buffers provide methods to search for values or sequences:</p>

<div class="w3-example">
<h4>Example</h4>
<div class="w3-code notranslate jsHigh">const buf = Buffer.from('Hello, Node.js is awesome!');<br>
<br>
// Find the first occurrence of a value<br>
console.log(buf.indexOf('Node')); // 7<br>
<br>
// Check if buffer contains a value<br>
console.log(buf.includes('awesome')); // true<br>
<br>
// Find the last occurrence of a value<br>
console.log(buf.lastIndexOf('e')); // 24</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_buffer_search">Run example &raquo;</a>
</div>

<h3>Buffer and Streams</h3>
<p>Buffers are commonly used with streams for efficient data processing:</p>

<div class="w3-example">
<h4>Example</h4>
<div class="w3-code notranslate jsHigh">const fs = require('fs');<br>
const { Transform } = require('stream');<br>
<br>
// Create a transform stream that processes data in chunks<br>
const transformStream = new Transform({<br>
&nbsp; transform(chunk, encoding, callback) {<br>
&nbsp;&nbsp; // Process each chunk (which is a Buffer)<br>
&nbsp;&nbsp; const processed = chunk.toString().toUpperCase();<br>
&nbsp;&nbsp; this.push(Buffer.from(processed));<br>
&nbsp;&nbsp; callback();<br>
&nbsp; }<br>
});<br>
// Create a read stream from a file<br>
const readStream = fs.createReadStream('input.txt');<br>
// Create a write stream to a file<br>
const writeStream = fs.createWriteStream('output.txt');<br>
// Process the file in chunks<br>
readStream.pipe(transformStream).pipe(writeStream);</div>
</div>
<hr>
<h2>Buffer and File System</h2>
<p>Buffers are commonly used for file system operations:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">const fs = require('fs');<br>
<br>
// Write buffer to file<br>
const writeBuffer = Buffer.from('Hello, Node.js!');<br>
fs.writeFile('buffer.txt', writeBuffer, (err) => {<br>
&nbsp;&nbsp;if (err) throw err;<br>
&nbsp;&nbsp;console.log('File written successfully');<br>
<br>
&nbsp;&nbsp;// Read file into buffer<br>
&nbsp;&nbsp;fs.readFile('buffer.txt', (err, data) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (err) throw err;<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// 'data' is a buffer<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Read buffer:', data);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Buffer content:', data.toString());<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Read only part of the file into a buffer<br>
&nbsp;&nbsp;&nbsp;&nbsp;const smallBuffer = Buffer.alloc(5);<br>
&nbsp;&nbsp;&nbsp;&nbsp;fs.open('buffer.txt', 'r', (err, fd) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (err) throw err;<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Read 5 bytes starting at position 7<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;fs.read(fd, smallBuffer, 0, 5, 7, (err, bytesRead, buffer) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (err) throw err;<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Partial read:', buffer.toString());<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Output: Node.<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;fs.close(fd, (err) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (err) throw err;<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_buffer_fs">Run example &raquo;</a>
</div>
<hr>

<h2>Buffer Performance Considerations</h2>

<ul>
  <li><strong>Memory Usage:</strong> Buffers consume memory outside the JavaScript heap, which can be both an advantage (less garbage collection pressure) and a disadvantage (must be carefully managed)</li>
  <li><strong>Allocation:</strong> <code class="w3-codespan">Buffer.allocUnsafe()</code> is faster than <code class="w3-codespan">Buffer.alloc()</code> but comes with security considerations</li>
  <li><strong>String Conversion:</strong> Converting large buffers to strings or vice versa can be expensive</li>
  <li><strong>Pooling:</strong> For applications that frequently create small buffers, consider implementing a buffer pool to reduce allocation overhead</li>
</ul>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">// Simple buffer pool implementation<br>
class BufferPool {<br>
&nbsp;&nbsp;constructor(bufferSize = 1024, poolSize = 10) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.bufferSize = bufferSize;<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.pool = Array(poolSize).fill().map(() => Buffer.alloc(bufferSize));<br><br>
&nbsp;&nbsp;&nbsp;&nbsp;this.used = Array(poolSize).fill(false);<br>
&nbsp;&nbsp;}<br>
<br>
&nbsp;&nbsp;// Get a buffer from the pool<br>
&nbsp;&nbsp;get() {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const index = this.used.indexOf(false);<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (index === -1) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Pool is full, create a new buffer<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; console.log('Pool full, allocating new buffer');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; return Buffer.alloc(this.bufferSize);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.used[index] = true;<br>
&nbsp;&nbsp;&nbsp;&nbsp;return this.pool[index];<br>
&nbsp;&nbsp;}<br>
<br>
&nbsp;&nbsp;// Return a buffer to the pool<br>
&nbsp;&nbsp;release(buffer) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const index = this.pool.indexOf(buffer);<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (index !== -1) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Zero the buffer for security<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; buffer.fill(0);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.used[index] = false;<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br> 
&nbsp;&nbsp;}<br>
}<br>
<br>
// Usage example<br>
const pool = new BufferPool(10, 3); // 3 buffers of 10 bytes each<br>
<br>
const buf1 = pool.get();<br>
const buf2 = pool.get();<br>
const buf3 = pool.get();<br>
const buf4 = pool.get(); // This will allocate a new buffer<br>
<br>
buf1.write('Hello');<br>
console.log(buf1.toString()); // Hello<br>
<br>
// Return buf1 to the pool<br>
pool.release(buf1);<br>
<br>
// Get another buffer (should reuse buf1)<br>
const buf5 = pool.get();<br>
console.log(buf5.toString()); // Should be empty (zeros)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_buffer_pool">Run example &raquo;</a>
</div>

<hr>

<h2>Buffer Security Considerations</h2>

<div class="w3-panel ws-warning">
<p><strong>Security Warning:</strong> Buffers can contain sensitive data from memory.</p>
<p>Always be cautious when handling buffers, especially when they might be exposed to users or logged.</p>
</div>

<h3>Best Practices:</h3>
<ul>
  <li>Avoid using <code class="w3-codespan">Buffer.allocUnsafe()</code> unless performance is critical and you immediately fill the buffer</li>
  <li>Zero-fill buffers after use when they contained sensitive information</li>
  <li>Be careful when sharing buffer instances or slices, as changes are reflected across all references</li>
  <li>Validate buffer inputs when receiving binary data from external sources</li>
</ul>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">// Example: Safely handling sensitive data<br>
function processPassword(password) {<br>
&nbsp;&nbsp;// Create a buffer to hold the password<br>
&nbsp;&nbsp;const passwordBuffer = Buffer.from(password);<br>
<br>
&nbsp;&nbsp;// Process the password (e.g., hashing)<br>
&nbsp;&nbsp;const hashedPassword = hashPassword(passwordBuffer);<br>
<br>
&nbsp;&nbsp;// Zero out the original password buffer for security<br>
&nbsp;&nbsp;passwordBuffer.fill(0);<br>
<br>
&nbsp;&nbsp;return hashedPassword;<br>
}<br>
<br>
// Simple hashing function for demonstration<br>
function hashPassword(buffer) {<br>
&nbsp;&nbsp;// In a real application, you would use a cryptographic hash function<br>
&nbsp;&nbsp;// This is a simplified example<br>
&nbsp;&nbsp;let hash = 0;<br>
&nbsp;&nbsp;for (let i = 0; i &lt; buffer.length; i++) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;hash = ((hash &lt; 5) - hash) + buffer[i];<br>
&nbsp;&nbsp;&nbsp;&nbsp;hash |= 0; // Convert to 32-bit integer<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;return hash.toString(16);<br>
}<br>
<br>
// Usage<br>
const password = 'secret123';<br>
const hashedPassword = processPassword(password);<br>
console.log('Hashed password:', hashedPassword);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_buffer_security">Run example &raquo;</a>
</div>
...
<p>The Node.js Buffer class is an essential tool for working with binary data. Key points to remember:</p>

<ul>
  <li>Buffers provide a way to handle binary data in JavaScript</li>
  <li>Use <code class="w3-codespan">Buffer.alloc()</code>, <code class="w3-codespan">Buffer.from()</code>, and <code class="w3-codespan">Buffer.allocUnsafe()</code> to create buffers</li>
  <li>Buffers can be manipulated with methods like <code class="w3-codespan">write()</code>, <code class="w3-codespan">toString()</code>, <code class="w3-codespan">slice()</code>, and <code class="w3-codespan">copy()</code></li>
  <li>Buffers support various encodings including UTF-8, Base64, and Hex</li>
  <li>Buffers are commonly used in file I/O, network operations, and binary data processing</li>
  <li>Consider performance and security implications when working with buffers</li>
</ul>

<hr>
<div id="exercisecontainer" src="xrcise_buffer.js" data-extensions="asp"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_streams.asp">&lt; Previous</a>
