...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js ES6+ Features</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js ES6+ Features">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_es6.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="ES6 (ECMAScript 2015) and later versions add powerful new features to JavaScript that make your code more expressive, concise, and safer.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js ES6+ Features">
<meta name="twitter:description" content="ES6 (ECMAScript 2015) and later versions add powerful new features to JavaScript that make your code more expressive, concise, and safer.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_es6.png">
...
<h1>Node.js <span class="color_h1">ES6+ Features</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_readline.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="nodejs_process_management.asp">Next &#10095;</a> 
</div>
<hr>

<h2>What is ES6+?</h2>
<p>ES6 (ECMAScript 2015) and later versions add powerful new features to JavaScript that make your code more expressive, concise, and safer.</p>
<p>Node.js has excellent support for modern JavaScript features.</p>

<div class="w3-panel ws-info">
<p><strong>Node.js Compatibility:</strong> All modern versions of Node.js (10+) have excellent support for ES6+ features.</p>
<p>Newer versions support even more recent JavaScript additions from ES2020 and beyond.</p>
</div>

<p>These modern JavaScript features help you:</p>
<ul>
  <li>Write cleaner, more readable code</li>
  <li>Avoid common JavaScript pitfalls</li>
  <li>Create more maintainable applications</li>
  <li>Reduce the need for external libraries</li>
</ul>
<hr>

<h2 id="let-const">let and const</h2>
<p>The <code class="w3-codespan">let</code> and <code class="w3-codespan">const</code> keywords replaced <code class="w3-codespan">var</code> as the preferred way to declare variables:</p>
<ul>
  <li><code class="w3-codespan">let</code> allows you to declare variables that can be reassigned</li>
  <li><code class="w3-codespan">const</code> declares variables that cannot be reassigned (but object properties can still be modified)</li>
  <li>Both are block-scoped, unlike <code class="w3-codespan">var</code> which is function-scoped</li>
</ul>

<div class="w3-example">
<h3>Example: let and const</h3>
<div class="w3-code notranslate jsHigh">
// Using let (can be changed)<br>
let score = 10;<br>
score = 20;
<br>
// Using const (cannot be reassigned)<br>
const MAX_USERS = 100;<br>

<br>// Block scope with let<br>
if (true) {<br>
&nbsp;&nbsp;let message = 'Hello';<br>
&nbsp;&nbsp;console.log(message); // Works here<br>
}
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_es6_letconst">Try it Yourself &raquo;</a>
</div>
<hr>

<h2 id="arrow">Arrow Functions</h2>
<p>Arrow functions provide a concise syntax for writing functions and automatically bind <code class="w3-codespan">this</code> to the surrounding context.</p>

<p>Key benefits of arrow functions:</p>
<ul>
  <li>Shorter syntax for simple functions</li>
  <li>Implicit return for one-line expressions</li>
  <li>Lexical <code class="w3-codespan">this</code> binding (arrow functions don't create their own <code class="w3-codespan">this</code> context)</li>
</ul>

<div class="w3-example">
<h3>Example: Arrow Functions</h3>
<div class="w3-code notranslate jsHigh">
...
<br>
// Arrow function (same as above)<br>
...
<br>
// No parameters (parentheses needed)<br>
const sayHello = () => 'Hello!';<br>
<br>
// Using with array methods<br>
const numbers = [1, 2, 3];<br>
const doubled = numbers.map(num => num * 2);<br>
console.log(doubled);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_es6_arrow">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-warning">
<p><strong>When NOT to use arrow functions:</strong></p>
<ul>
  <li>Object methods (where you need `this` to reference the object)</li>
  <li>Constructor functions (arrow functions can't be used with `new`)</li>
  <li>Event handlers where `this` should refer to the element</li>
</ul>
</div>
...
<p>Template literals (template strings) provide an elegant way to create strings with embedded expressions using backticks (<code class="w3-codespan">`</code>).</p>

<p>Key features of template literals:</p>
<ul>
  <li>String interpolation with <code class="w3-codespan">${expression}</code> syntax</li>
  <li>Multi-line strings without escape characters</li>
  <li>Tagged templates for advanced string processing</li>
</ul>

<div class="w3-example">
<h3>Example: Template Literals</h3>
<div class="w3-code notranslate jsHigh">
// Basic string interpolation<br>
const name = 'Alice';<br>
...
const price = 10;<br>
const tax = 0.2;<br>
console.log(`Total: $${price * (1 + tax)}`);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_es6_template">Try it Yourself &raquo;</a>
</div>
<hr>

<h2 id="destructuring">Destructuring</h2>
<p>Destructuring allows you to extract values from arrays or properties from objects into distinct variables with a concise syntax.</p>

<p>Key features of destructuring:</p>
<ul>
  <li>Extract multiple values in a single statement</li>
  <li>Assign default values to extracted properties</li>
  <li>Rename properties during extraction</li>
  <li>Skip elements in arrays</li>
  <li>Extract deeply nested properties</li>
</ul>

<div class="w3-example">
<h3>Example: Object Destructuring</h3>
<div class="w3-code notranslate jsHigh">
// Basic object destructuring<br>
const user = { name: 'Alice', age: 30, location: 'New York' };<br>
const { name, age } = user;<br>
console.log(name, age);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_es6_destruct_obj">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example: Array Destructuring</h3>
<div class="w3-code notranslate jsHigh">
// Basic array destructuring<br>
const colors = ['red', 'green', 'blue'];<br>
const [first, second, third] = colors;<br>
console.log(first, second, third);<br>
<br>
// Skipping elements<br>
const [primary, , tertiary] = colors;<br>
console.log(primary, tertiary);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_es6_destruct_array">Try it Yourself &raquo;</a>
</div>
<hr>

<h2 id="spread">Spread and Rest Operators</h2>
<p>The spread and rest operators (both written as <code class="w3-codespan">...</code>) allow you to work with multiple elements more efficiently.</p>

<ul>
  <li><strong>Spread operator</strong>: Expands iterables (arrays, objects, strings) into individual elements</li>
  <li><strong>Rest operator</strong>: Collects multiple elements into a single array or object</li>
</ul>

<div class="w3-example">
<h3>Example: Spread Operator</h3>
<div class="w3-code notranslate jsHigh">
// Array spread - combining arrays<br>
const numbers = [1, 2, 3];<br>
const moreNumbers = [4, 5, 6];<br>
const combined = [...numbers, ...moreNumbers];<br>
console.log(combined);<br>
<br>
// Array spread - converting string to array of characters<br>
const chars = [...'hello'];<br>
console.log(chars);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_es6_spread">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example: Rest Operator</h3>
<div class="w3-code notranslate jsHigh">
// Rest parameter in functions<br>
function sum(...numbers) {<br>
&nbsp;&nbsp;return numbers.reduce((total, num) => total + num, 0);<br>
}<br>
console.log(sum(1, 2, 3, 4, 5));</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_es6_rest">Try it Yourself &raquo;</a>
</div>
<hr>

<h2 id="default">Default Parameters</h2>
<p>ES6+ allows you to specify default values for function parameters, eliminating the need for manual parameter checking in many cases.</p>

<p>Key benefits of default parameters:</p>
<ul>
  <li>Cleaner function definitions without manual checking</li>
  <li>More explicit function signatures</li>
  <li>Default values are only used when parameters are undefined or not provided</li>
  <li>Default values can be expressions, not just simple values</li>
</ul>

<div class="w3-example">
<h3>Example: Default Parameters</h3>
<div class="w3-code notranslate jsHigh">
// Basic default parameter<br>
function greet(name = 'Guest') {<br>
&nbsp;&nbsp;return `Hello, ${name}!`;<br>
}<br>
<br>
console.log(greet());<br>
console.log(greet('Kai'));</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_es6_default">Try it Yourself &raquo;</a>
</div>
<hr>

<h2 id="classes">Classes</h2>
<p>ES6 introduced class syntax to JavaScript, providing a clearer and more concise way to create objects and implement inheritance.</p>
<p>Under the hood, JavaScript classes are still based on prototypes.</p>

<p>Key features of JavaScript classes:</p>
<ul>
  <li>Cleaner syntax for creating constructor functions and methods</li>
  <li>Built-in support for inheritance using <code class="w3-codespan">extends</code></li>
  <li>Static methods attached to the class, not instances</li>
  <li>Getter and setter methods for more controlled property access</li>
  <li>Private fields for better encapsulation (ES2022+)</li>
</ul>
<div class="w3-example">
<h3>Example: Class Basics</h3>
<div class="w3-code notranslate jsHigh">
// Simple class with constructor and method<br>
class Person {<br>
...
<br>
// Create an instance<br>const person = new Person('Alice', 25);<br>console.log(person.greet()); // Hello, I'm Alice!
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_es6_classes_basic">Try it Yourself &raquo;</a>
</div>
...
<br>
const dog = new Dog('Rex');<br>console.log(dog.speak());
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_es6_classes_inheritance">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example: Private Class Fields (ES2022+)</h3>
<div class="w3-code notranslate jsHigh">
// Class with private field (# prefix)<br>
class Counter {<br>
&nbsp;&nbsp;#count = 0;  // Private field<br>
<br>
&nbsp;&nbsp;increment() {<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.#count++;<br>
&nbsp;&nbsp;}<br>
...
console.log(counter.getCount());<br>
// console.log(counter.#count); // Error: Private field
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_es6_classes_private">Run Example &raquo;</a>
</div>
<hr>

<h2 id="promises">Promises and Async/Await</h2>
<p>Modern JavaScript provides powerful tools for handling asynchronous operations, making it much easier to work with code that involves delays, API calls, or I/O operations.</p>
<hr>
<h2>Promises</h2>
<p>Promises represent values that may not be available yet.</p>
<p>They provide a more elegant way to handle asynchronous operations compared to callbacks.</p>
...
<div class="w3-example">
<h3>Example: Basic Promises</h3>
<div class="w3-code notranslate jsHigh">
// Creating a promise<br>
const fetchData = () => {<br>
&nbsp;&nbsp;return new Promise((resolve, reject) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp; // Simulating an API call<br>
&nbsp;&nbsp;&nbsp;&nbsp; setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; const data = { id: 1, name: 'Product' };<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; const success = true;<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if (success) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; resolve(data);  // Fulfilled with data<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; } else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; reject(new Error('Failed to fetch data')); // Rejected with error<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; }<br>
&nbsp;&nbsp;&nbsp;&nbsp; }, 1000);<br>
&nbsp;&nbsp;});<br>
};<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;return data.id; // Return value is passed to the next .then()<br>
&nbsp;&nbsp;})<br>
&nbsp;&nbsp;.then(id => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Processing ID:', id);<br>
&nbsp;&nbsp;})<br>
&nbsp;&nbsp;.catch(error => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error('Error:', error.message);<br>
&nbsp;&nbsp;})<br>
&nbsp;&nbsp;.finally(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Operation completed (success or failure)');<br>
&nbsp;&nbsp;});<br>
<br>
console.log('Continuing execution while fetch happens in background');</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_es6_promises">Run Example &raquo;</a>
</div>
<hr>
<h2>Async/Await</h2>
<p>Async/await (introduced in ES2017) provides a cleaner syntax for working with promises, making asynchronous code look and behave more like synchronous code.</p>

<div class="w3-example">
<h3>Example: Async/Await</h3>
<div class="w3-code notranslate jsHigh">
// Function that returns a promise<br>
const fetchUser = (id) => {<br>
&nbsp;&nbsp;return new Promise((resolve, reject) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (id > 0) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;resolve({ id, name: `User ${id}` });<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; } else {<br>
...
async function getUserData(id) {<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Fetching user...');<br>
&nbsp;&nbsp;&nbsp;&nbsp;const user = await fetchUser(id); // Waits for the promise to resolve<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('User data:', user);<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;// You can use the result directly<br>
&nbsp;&nbsp;&nbsp;&nbsp;return `${user.name}'s profile`;<br>
&nbsp;&nbsp;} catch (error) {<br>
&nbsp;&nbsp;&nbsp;&nbsp; // Handle errors with try/catch<br>
&nbsp;&nbsp;&nbsp;&nbsp; console.error('Error fetching user:', error.message);<br>
&nbsp;&nbsp;&nbsp;&nbsp; return 'Guest profile';<br>
&nbsp;&nbsp; }<br>
}<br>
<br>
// Async functions always return promises<br>
console.log('Starting...');<br>
getUserData(1)<br>
&nbsp;&nbsp;.then(result => console.log('Result:', result))<br>
&nbsp;&nbsp;.catch(error => console.error('Unexpected error:', error));<br>
console.log('This runs before getUserData completes');</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_es6_async_await">Run Example &raquo;</a>
</div>

<div class="w3-panel w3-warning">
<p><strong>Common Async/Await Mistakes:</strong></p>
<ul>
  <li>Forgetting that async functions always return promises</li>
  <li>Not handling errors with try/catch</li>
  <li>Running operations sequentially when they could run in parallel</li>
  <li>Using await outside of an async function</li>
  <li>Awaiting non-promise values (unnecessary but harmless)</li>
</ul>
</div>
<hr>

<h2 id="modules">ES Modules</h2>
<p>ES Modules (ESM) provide a standardized way to organize and share code. They were introduced in ES2015 and are now supported natively in Node.js.</p>

<p>Key benefits of ES Modules:</p>
<ul>
  <li>Static module structure (imports are analyzed at compile time)</li>
  <li>Default and named exports/imports</li>
...
<p>File: app.js</p>
<div class="w3-code notranslate jsHigh">
// Import default export<br>
import Calculator from './math.js';<br>
<br>
// Import named exports<br>
import { PI, add, multiply } from './math.js';<br>
<br>
// Import with alias<br>
import { add as mathAdd } from './math.js';<br>
<br>
// Import all exports as a namespace<br>
import * as MathUtils from './math.js';<br>
<br>
const calc = new Calculator();<br>
console.log(calc.subtract(10, 5)); // 5<br>
<br>
console.log(add(2, 3));        // 5<br>
console.log(mathAdd(4, 5));    // 9<br>
console.log(MathUtils.PI);     // 3.14159<br>
console.log(MathUtils.multiply(2, 3)); // 6</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_es6_modules">Run Example &raquo;</a>
</div>

<p>To use ES Modules in Node.js, you can either:</p>
<ol>
  <li>Use the <code class="w3-codespan">.mjs</code> extension for module files</li>
  <li>Add <code class="w3-codespan">"type": "module"</code> to your package.json</li>
  <li>Use the <code class="w3-codespan">--experimental-modules</code> flag (older Node.js versions)</li>
</ol>

<div class="w3-panel w3-note">
<p>The CommonJS module system (<code class="w3-codespan">require()</code> and <code class="w3-codespan">module.exports</code>) is still widely used in Node.js. ES Modules and CommonJS can coexist in the same project, but they have different semantics.</p>
</div>
<hr>

<h2 id="enhanced">Enhanced Object Literals</h2>
<p>ES6+ introduced several improvements to object literals that make object creation more concise and expressive.</p>

<div class="w3-example">
<h3>Example: Enhanced Object Literals</h3>
<div class="w3-code notranslate jsHigh">
// Property shorthand<br>
const name = 'Alice';<br>
const age = 30;<br>
<br>
// Instead of {name: name, age: age}<br>
const person = { name, age };<br>
console.log(person);<br>
<br>
// Method shorthand<br>
const calculator = {<br>
&nbsp;&nbsp;// Instead of add: function(a, b) { ... }<br>
&nbsp;&nbsp;add(a, b) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;return a + b;<br>
&nbsp;&nbsp;},<br>
&nbsp;&nbsp;subtract(a, b) {<br>
...
console.log(calculator.add(5, 3));</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_es6_enhanced_objects">Try it Yourself &raquo;</a>
</div>
<hr>

<h2 id="optional">Optional Chaining and Nullish Coalescing</h2>
<p>Modern JavaScript introduces syntax to safely access nested properties and provide fallback values.</p>

<h3>Optional Chaining (?.)</h3>
<p>Optional chaining lets you access deeply nested object properties without worrying about null or undefined values in the chain.</p>

<div class="w3-example">
<h3>Example: Optional Chaining</h3>
<div class="w3-code notranslate jsHigh">
function getUserCity(user) {<br>
&nbsp;&nbsp;return user?.address?.city;<br>
}<br>
<br>
const user1 = {<br>
&nbsp;&nbsp;name: 'Alice',<br>
&nbsp;&nbsp;address: { city: 'New York', country: 'USA' }<br>
};<br>
<br>
const user2 = {<br>
&nbsp;&nbsp;name: 'Bob'<br>
...
const user3 = null;<br>
<br>
console.log(getUserCity(user1)); // 'New York'<br>
console.log(getUserCity(user2)); // undefined<br>
console.log(getUserCity(user3)); // undefined</div>
</div>

<h3>Nullish Coalescing (??)</h3>
<p>The nullish coalescing operator (??) provides a default value when a value is null or undefined (but not for other falsy values like 0 or "").</p>

<div class="w3-example">
<h3>Example: Nullish Coalescing</h3>
<div class="w3-code notranslate jsHigh">
function calculatePrice(price, tax) {<br>
&nbsp;&nbsp;// Only uses default if tax is null or undefined<br>
&nbsp;&nbsp;return price + (tax ?? 0.1) * price;<br>
}<br>
<br>
console.log(calculatePrice(100, 0));    // 100 (correct! tax of 0 was used)<br>
console.log(calculatePrice(100, null)); // 110 (using default)</div>
</div>
<hr>

<h2 id="async-patterns">Modern Asynchronous Patterns</h2>

<p>Modern JavaScript provides powerful patterns for handling asynchronous operations. Understanding when to use sequential vs parallel execution can significantly improve your application's performance.</p>

<div class="w3-panel ws-note">
<p><strong>Sequential vs Parallel Execution:</strong></p>
<ul>
  <li><strong>Sequential:</strong> Operations run one after another, each waiting for the previous to complete</li>
  <li><strong>Parallel:</strong> Operations run simultaneously, which is more efficient when operations are independent</li>
</ul>
</div>

<div class="w3-example">
<h3>Example: Sequential Execution</h3>
<div class="w3-code notranslate jsHigh">
// Helper function to simulate an API call<br>
function fetchData(id) {<br>
&nbsp;&nbsp;return new Promise(resolve => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;setTimeout(() => resolve(`Data for ID ${id}`), 1000);<br>
&nbsp;&nbsp;});<br>
}<br>
<br>
// Sequential execution (~3 seconds total)<br>
async function fetchSequential() {<br>
&nbsp;&nbsp;console.time('sequential');<br>
&nbsp;&nbsp;const data1 = await fetchData(1);<br>
&nbsp;&nbsp;const data2 = await fetchData(2);<br>
&nbsp;&nbsp;const data3 = await fetchData(3);<br>
&nbsp;&nbsp;console.timeEnd('sequential');<br>
&nbsp;&nbsp;return [data1, data2, data3];<br>
}<br>
<br>
// Run the sequential example<br>fetchSequential().then(results => {<br>&nbsp;&nbsp;console.log('Sequential results:', results);<br>});</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_es6_sequential">Run Example &raquo;</a>
</div>

<div class="w3-example">
<h3>Example: Parallel Execution</h3>
<div class="w3-code notranslate jsHigh">
// Parallel execution (~1 second total)<br>
async function fetchParallel() {<br>
&nbsp;&nbsp;console.time('parallel');<br>
&nbsp;&nbsp;const results = await Promise.all([<br>
&nbsp;&nbsp;&nbsp;&nbsp;fetchData(1),<br>
&nbsp;&nbsp;&nbsp;&nbsp;fetchData(2),<br>
&nbsp;&nbsp;&nbsp;&nbsp;fetchData(3)<br>
&nbsp;&nbsp;]);<br>
&nbsp;&nbsp;console.timeEnd('parallel');<br>
&nbsp;&nbsp;return results;<br>
}<br>
<br>
// Run the parallel example<br>fetchParallel().then(results => {<br>&nbsp;&nbsp;console.log('Parallel results:', results);<br>});</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_es6_parallel">Run Example &raquo;</a>
</div>

<div class="w3-panel w3-warning">
<p><strong>When to Use Each Pattern:</strong></p>
<ul>
  <li>Use <strong>sequential</strong> when operations depend on previous results</li>
  <li>Use <strong>parallel</strong> when operations are independent and can run simultaneously</li>
  <li>Be mindful of rate limits when making parallel API calls</li>
  <li>Consider using libraries like <code class="w3-codespan">p-queue</code> for controlled concurrency</li>
</ul>
</div>
...
<h2>Summary</h2>
<p>ES6+ introduced numerous features that have transformed JavaScript programming, making code more readable, maintainable, and robust:</p>

<ul>
  <li><strong>let/const</strong>: Block-scoped variables with clearer semantics</li>
  <li><strong>Arrow functions</strong>: Concise syntax and lexical <code class="w3-codespan">this</code> binding</li>
  ...
  <li><strong>Spread/rest operators</strong>: Work with collections more efficiently</li>
  <li><strong>Default parameters</strong>: Simpler function definitions</li>
  <li><strong>Classes</strong>: Cleaner syntax for object-oriented programming</li>
  <li><strong>Promises and async/await</strong>: Better asynchronous code management</li>
  <li><strong>ES Modules</strong>: Standardized code organization</li>
  <li><strong>Enhanced object literals</strong>: More concise object syntax</li>
  <li><strong>Optional chaining & nullish coalescing</strong>: Safer property access and defaults</li>
</ul>

<p>These modern features are fully supported in current Node.js versions, allowing you to write cleaner, more expressive code while avoiding common JavaScript pitfalls.</p>
<hr>
<div id="exercisecontainer" src="xrcise_es6.js" data-extensions="asp"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_readline.asp">&#10094; Previous</a>
