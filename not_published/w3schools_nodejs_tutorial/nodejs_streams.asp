...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Streams</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js Streams">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_streams.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="In Node.js, streams are collections of data, which might not be available in full at once and don't have to fit in memory.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Streams">
<meta name="twitter:description" content="In Node.js, streams are collections of data, which might not be available in full at once and don't have to fit in memory.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_streams.png">
...
<h1>Node.js <span class="color_h1">Streams</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_events.asp">&lt; Previous</a>
<a class="w3-right w3-btn" href="nodejs_buffer.asp">Next &gt;</a>
</div>

<hr>
<h2>What are Streams?</h2>
<p>In Node.js, streams are collections of data, which might not be available in full at once and don't have to fit in memory.</p>
<p>Think of them as conveyor belts that move data from one place to another, allowing you to work with each piece as it arrives rather than waiting for the whole dataset.</p>
<p>Streams are one of Node.js's most powerful features and are used extensively in:</p>
<ul>
  <li>File system operations (reading/writing files)</li>
...
<p>Streams are one of the fundamental concepts in Node.js for handling data efficiently.</p>
<p>They allow you to process data in chunks as it becomes available, rather than loading everything into memory at once.</p>

<div class="w3-example">
<h3>Basic Stream Example</h3>
<div class="w3-code notranslate jsHigh">const fs = require('fs');<br>
<br>
// Create a readable stream from a file<br>
...
<br>
// Pipe the data from readable to writable stream<br>
readableStream.pipe(writableStream);<br>
<br>
// Handle completion and errors<br>
writableStream.on('finish', () => {<br>
&nbsp; console.log('File copy completed!');<br>
});<br>
<br>
readableStream.on('error', (err) => {<br>
&nbsp; console.error('Error reading file:', err);<br>
});<br>
<br>
writableStream.on('error', (err) => {<br>
&nbsp; console.error('Error writing file:', err);<br>
});</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_streams_basic">Run example &raquo;</a>
</div>
<hr>

<h2>Why Use Streams?</h2>

<p>There are several advantages to using streams:</p>

<ul>
  <li><strong>Memory Efficiency:</strong> Process large files without loading them entirely into memory</li>
  <li><strong>Time Efficiency:</strong> Start processing data as soon as you have it, instead of waiting for all the data</li>
  <li><strong>Composability:</strong> Build powerful data pipelines by connecting streams</li>
  <li><strong>Better User Experience:</strong> Deliver data to users as it becomes available (e.g., video streaming)</li>
</ul>

<div class="w3-panel ws-note">
<p>Imagine reading a 1GB file on a server with 512MB of RAM:</p>
<ul>
  <li><strong>Without streams:</strong> You'd crash the process attempting to load the entire file into memory</li>
  <li><strong>With streams:</strong> You process the file in small chunks (e.g., 64KB at a time)</li>
</ul>
</div>

<hr>

<h2>Core Stream Types</h2>

<p>Node.js provides four fundamental types of streams, each serving a specific purpose in data handling:</p>
...
<table class="ws-table-all">
  ...
  <tr>
    ...
    <td>Streams from which data can be read (data source)</td>
    <td>fs.createReadStream(), HTTP responses, process.stdin</td>
  </tr>
  <tr>
    <td><strong>Writable</strong></td>
    <td>Streams to which data can be written (data destination)</td>
    <td>fs.createWriteStream(), HTTP requests, process.stdout</td>
  </tr>
  <tr>
    <td><strong>Duplex</strong></td>
    <td>Streams that are both Readable and Writable</td>
    <td>TCP sockets, Zlib streams</td>
  </tr>
  <tr>
    <td><strong>Transform</strong></td>
    <td>Duplex streams that can modify or transform data as it's written and read</td>
    <td>Zlib streams, crypto streams</td>
  </tr>
</table>
</div>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> All streams in Node.js are instances of EventEmitter, which means they emit events that can be listened to and handled.</p>
</div>
...
<p>Readable streams let you read data from a source. Examples include:</p>
<ul>
...
<h3>Creating a Readable Stream</h3>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">const fs = require('fs');<br>
<br>
// Create a readable stream from a file<br>
const readableStream = fs.createReadStream('myfile.txt', {<br>
&nbsp;&nbsp;encoding: 'utf8',<br>
&nbsp;&nbsp;highWaterMark: 64 * 1024 // 64KB chunks<br>
});<br>
<br>
// Events for readable streams<br>
...
&nbsp;&nbsp;console.log('No more data to read.');<br>
});<br>
<br>
readableStream.on('error', (err) => {<br>
&nbsp;&nbsp;console.error('Error reading from stream:', err);<br>
});</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_streams_readable">Run example &raquo;</a>
</div>

<h3>Reading Modes</h3>

<p>Readable streams operate in one of two modes:</p>

<ul>
  <li><strong>Flowing Mode:</strong> Data is read from the source and provided to your application as quickly as possible using events</li>
  <li><strong>Paused Mode:</strong> You must explicitly call <code class="w3-codespan">stream.read()</code> to get chunks of data from the stream</li>
</ul>
...
<br>
// Paused mode example<br>
const readableStream = fs.createReadStream('myfile.txt', {<br>
&nbsp;&nbsp;encoding: 'utf8',<br>
&nbsp;&nbsp;highWaterMark: 64 * 1024 // 64KB chunks<br>
});<br>
<br>
// Manually consume the stream using read()<br>
readableStream.on('readable', () => {<br>
&nbsp;&nbsp;let chunk;<br>
&nbsp;&nbsp;while (null !== (chunk = readableStream.read())) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Read ${chunk.length} bytes of data.`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(chunk);<br>
&nbsp;&nbsp;}
});<br>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_streams_paused_mode">Run example &raquo;</a>
</div>
...
<p>Writable streams let you write data to a destination. Examples include:</p>
<ul>
...
<h3>Creating a Writable Stream</h3>
...
writableStream.write('Hello, ');<br>
writableStream.write('World!');<br>
writableStream.write('\nWriting to a stream is easy!');<br>
<br>
// End the stream<br>
writableStream.end();<br>
<br>
// Events for writable streams<br>
writableStream.on('finish', () => {<br>
&nbsp;&nbsp;console.log('All data has been written to the file.');<br>
});<br>
<br>
writableStream.on('error', (err) => {<br>
&nbsp;&nbsp;console.error('Error writing to stream:', err);<br>
});</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_streams_writable">Run example &raquo;</a>
</div>

<h3>Handling Backpressure</h3>

<p>When writing to a stream, if the data is being written faster than it can be processed, backpressure occurs.</p>
<p>The <code class="w3-codespan">write()</code> method returns a boolean indicating if it's safe to continue writing.</p>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;i--;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (i === 0) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Last time, close the stream<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;writableStream.write('Last chunk!\n');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;writableStream.end();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Continue writing data<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const data = `Data chunk ${i}\n`;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Write and check if we should continue<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ok = writableStream.write(data);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;while (i > 0 && ok);<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (i > 0) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// We need to wait for the drain event before writing more<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;writableStream.once('drain', write);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;write();<br>
}<br>
...
writeData();<br>
writableStream.on('finish', () => {<br>
&nbsp;&nbsp;console.log('All data written successfully.');<br>
});</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_streams_backpressure">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">pipe()</code> method connects a readable stream to a writable stream, automatically managing the flow of data and handling backpressure.</p>
<p>It's the easiest way to consume streams.</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const fs = require('fs');<br>
<br>
// Create readable and writable streams<br>
const readableStream = fs.createReadStream('source.txt');<br>
const writableStream = fs.createWriteStream('destination.txt');<br>
<br>
// Pipe the readable stream to the writable stream<br>
readableStream.pipe(writableStream);<br>
<br>
// Handle completion and errors<br>
readableStream.on('error', (err) => {<br>
&nbsp;&nbsp;console.error('Read error:', err);<br>
});<br>
<br>
writableStream.on('error', (err) => {<br>
&nbsp;&nbsp;console.error('Write error:', err);<br>
});<br>
<br>
writableStream.on('finish', () => {<br>
&nbsp;&nbsp;console.log('File copy completed!');<br>
});</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_streams_pipe">Run example &raquo;</a>
</div>

<h3>Chaining Pipes</h3>

<p>You can chain multiple streams together using <code class="w3-codespan">pipe()</code>.</p>
<p>This is especially useful when working with transform streams.</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">const fs = require('fs');<br>
const zlib = require('zlib');<br>
<br>
// Create a pipeline to read a file, compress it, and write to a new file<br>
fs.createReadStream('source.txt')<br>
&nbsp;&nbsp;.pipe(zlib.createGzip())  // Compress the data<br>
&nbsp;&nbsp;.pipe(fs.createWriteStream('destination.txt.gz'))<br>
&nbsp;&nbsp;.on('finish', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('File compressed successfully!');<br>
&nbsp;&nbsp;});</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_streams_pipe_chain">Run example &raquo;</a>
</div>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> The <code class="w3-codespan">pipe()</code> method returns the destination stream, which enables chaining.</p>
</div>

<hr>

<h2>Duplex and Transform Streams</h2>

<h3>Duplex Streams</h3>

<p>Duplex streams are both readable and writable, like a two-way pipe.</p>
<p>A TCP socket is a good example of a duplex stream.</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">const net = require('net');<br>
<br>
// Create a TCP server<br>
const server = net.createServer((socket) => {<br>
&nbsp;&nbsp;// 'socket' is a duplex stream<br>
<br>
&nbsp;&nbsp;// Handle incoming data (readable side)<br>
&nbsp;&nbsp;socket.on('data', (data) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Received:', data.toString());<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Echo back (writable side)<br>
&nbsp;&nbsp;&nbsp;&nbsp;socket.write(`Echo: ${data}`);<br>
&nbsp;&nbsp;});<br>
<br>
&nbsp;&nbsp;socket.on('end', () => {<br>
...
&nbsp;&nbsp;console.log('Server listening on port 8080');<br>
});<br>
<br>
// To test, you can use a tool like netcat or telnet:<br>
// $ nc localhost 8080<br>
// or create a client:<br>
/*<br>
const client = net.connect({ port: 8080 }, () => {<br>
&nbsp;&nbsp;console.log('Connected to server');<br>
&nbsp;&nbsp;client.write('Hello from client!');<br>
});<br>
<br>
client.on('data', (data) => {<br>
&nbsp;&nbsp;console.log('Server says:', data.toString());<br>
&nbsp;&nbsp;client.end(); // Close the connection<br>
});<br>
*/
</div>
</div>
...
<p>Transform streams are duplex streams that can modify data as it passes through.</p>
<p>They're ideal for processing data in pipelines.</p>
...
const fs = require('fs');<br>
<br>
// Create a transform stream that converts text to uppercase<br>
class UppercaseTransform extends Transform {<br>
&nbsp;&nbsp;_transform(chunk, encoding, callback) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Transform the chunk to uppercase<br>
&nbsp;&nbsp;&nbsp;&nbsp;const upperChunk = chunk.toString().toUpperCase();<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Push the transformed data<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.push(upperChunk);<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Signal that we're done with this chunk<br>
&nbsp;&nbsp;&nbsp;&nbsp;callback();<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
// Create an instance of our transform stream<br>
const uppercaseTransform = new UppercaseTransform();<br>
<br>
// Create a readable stream from a file<br>
const readableStream = fs.createReadStream('input.txt');<br>
<br>
// Create a writable stream to a file<br>
const writableStream = fs.createWriteStream('output-uppercase.txt');<br>
<br>
// Pipe the data through our transform stream<br>
readableStream<br>
&nbsp;&nbsp;.pipe(uppercaseTransform)<br>
&nbsp;&nbsp;.pipe(writableStream)<br>
&nbsp;&nbsp;.on('finish', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Transformation completed!');<br>
&nbsp;&nbsp;});</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_streams_transform">Run example &raquo;</a>
</div>
...
<p>All streams are instances of EventEmitter and emit several events:</p>

<h3>Readable Stream Events</h3>
<ul>
  <li><code class="w3-codespan">data</code>: Emitted when the stream has data available to read</li>
  <li><code class="w3-codespan">end</code>: Emitted when there's no more data to be consumed</li>
  <li><code class="w3-codespan">error</code>: Emitted if an error occurs while reading</li>
  <li><code class="w3-codespan">close</code>: Emitted when the stream's underlying resource has been closed</li>
  <li><code class="w3-codespan">readable</code>: Emitted when data is available to be read</li>
</ul>

<h3>Writable Stream Events</h3>
<ul>
  <li><code class="w3-codespan">drain</code>: Emitted when the stream is ready to accept more data after a <code class="w3-codespan">write()</code> method has returned <code class="w3-codespan">false</code></li>
  <li><code class="w3-codespan">finish</code>: Emitted when all data has been flushed to the underlying system</li>
  <li><code class="w3-codespan">error</code>: Emitted if an error occurs while writing</li>
  <li><code class="w3-codespan">close</code>: Emitted when the stream's underlying resource has been closed</li>
  <li><code class="w3-codespan">pipe</code>: Emitted when the <code class="w3-codespan">pipe()</code> method is called on a readable stream</li>
  <li><code class="w3-codespan">unpipe</code>: Emitted when the <code class="w3-codespan">unpipe()</code> method is called on a readable stream</li>
</ul>

<hr>

<h2>The stream.pipeline() Method</h2>

<p>The <code class="w3-codespan">pipeline()</code> function (available since Node.js v10.0.0) is a more robust way to pipe streams together, especially for error handling.</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const { pipeline } = require('stream');<br>
const fs = require('fs');<br>
const zlib = require('zlib');<br>
<br>
// Create a pipeline that handles errors properly<br>
pipeline(<br>
&nbsp;&nbsp;fs.createReadStream('source.txt'),<br>
&nbsp;&nbsp;zlib.createGzip(),<br>
&nbsp;&nbsp;fs.createWriteStream('destination.txt.gz'),<br>
&nbsp;&nbsp;(err) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error('Pipeline failed:', err);<br>
&nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Pipeline succeeded!');<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>
);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_streams_pipeline">Run example &raquo;</a>
</div>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> <code class="w3-codespan">pipeline()</code> will properly clean up all the streams if an error occurs in any of them, preventing potential memory leaks.</p>
</div>

<hr>

<h2>Object Mode Streams</h2>

<p>By default, streams work with strings and Buffer objects.</p>
<p>However, streams can be set to 'object mode' to work with JavaScript objects.</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const { Readable, Writable, Transform } = require('stream');<br>
<br>
// Create a readable stream in object mode<br>
const objectReadable = new Readable({<br>
&nbsp;&nbsp;objectMode: true,<br>
&nbsp;&nbsp;read() {} // Implementation required but can be no-op<br>
});<br>
<br>
// Create a transform stream in object mode<br>
const objectTransform = new Transform({<br>
&nbsp;&nbsp;objectMode: true,<br>
&nbsp;&nbsp;transform(chunk, encoding, callback) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Add a property to the object<br>
&nbsp;&nbsp;&nbsp;&nbsp;chunk.transformed = true;<br>
&nbsp;&nbsp;&nbsp;&nbsp;chunk.timestamp = new Date();<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.push(chunk);<br>
&nbsp;&nbsp;&nbsp;&nbsp;callback();<br>
&nbsp;&nbsp;}
});<br>
<br>
// Create a writable stream in object mode<br>
const objectWritable = new Writable({<br>
&nbsp;&nbsp;objectMode: true,<br>
&nbsp;&nbsp;write(chunk, encoding, callback) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Received object:', chunk);<br>
&nbsp;&nbsp;&nbsp;&nbsp;callback();<br>
&nbsp;&nbsp;}
});<br>
<br>
// Connect the streams<br>
objectReadable<br>
&nbsp;&nbsp;.pipe(objectTransform)<br>
&nbsp;&nbsp;.pipe(objectWritable);<br>
<br>
// Push some objects to the stream<br>
objectReadable.push({ name: 'Object 1', value: 10 });<br>
objectReadable.push({ name: 'Object 2', value: 20 });<br>
objectReadable.push({ name: 'Object 3', value: 30 });<br>
objectReadable.push(null); // Signal the end of data</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_streams_object_mode">Run example &raquo;</a>
</div>
...
<h3>1. Error Handling with pipeline()</h3>
<p>The <code class="w3-codespan">pipeline()</code> method is the recommended way to handle errors in stream chains:</p>

<div class="w3-example">
<h4>Example</h4>
<div class="w3-code notranslate jsHigh">const { pipeline } = require('stream');<br>
const fs = require('fs');<br>
const zlib = require('zlib');<br>
<br>
pipeline(<br>
...
&nbsp; zlib.createGzip(),<br>
&nbsp; fs.createWriteStream('output.txt.gz'),<br>
&nbsp; (err) => {<br>
&nbsp;&nbsp; if (err) {<br>
&nbsp;&nbsp;&nbsp; console.error('Pipeline failed:', err);<br>
&nbsp;&nbsp; } else {
...
<h3>2. Object Mode Streams</h3>
<p>Streams can work with JavaScript objects instead of just strings and buffers:</p>

<div class="w3-example">
<h4>Example</h4>
<div class="w3-code notranslate jsHigh">const { Readable } = require('stream');<br>
<br>
// Create a readable stream in object mode<br>
const objectStream = new Readable({<br>
&nbsp; objectMode: true,<br>
&nbsp; read() {}<br>
});<br>
// Push objects to the stream<br>
objectStream.push({ id: 1, name: 'Alice' });<br>
objectStream.push({ id: 2, name: 'Bob' });<br>
objectStream.push(null); // Signal end of stream<br>
// Consume the stream<br>
objectStream.on('data', (obj) => {<br>
&nbsp; console.log('Received:', obj);<br>
});</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_streams_object">Run example &raquo;</a>
</div>
...
<p>Streams are used extensively in HTTP requests and responses.</p>
...
&nbsp;&nbsp;if (req.url === '/') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Send a simple response<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.writeHead(200, { 'Content-Type': 'text/html' });<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.end('&lt;h1&gt;Stream Demo&lt;/h1&gt;&lt;p&gt;Try &lt;a href="/file"&gt;streaming a file&lt;/a&gt; or &lt;a href="/video"&gt;streaming a video&lt;/a&gt;.&lt;/p&gt;');<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;else if (req.url === '/file') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Stream a large text file<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.writeHead(200, { 'Content-Type': 'text/plain' });<br>
&nbsp;&nbsp;&nbsp;&nbsp;const fileStream = fs.createReadStream('largefile.txt', 'utf8');<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Pipe the file to the response (handles backpressure automatically)<br>
&nbsp;&nbsp;&nbsp;&nbsp;fileStream.pipe(res);<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Handle errors<br>
&nbsp;&nbsp;&nbsp;&nbsp;fileStream.on('error', (err) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error('File stream error:', err);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;res.statusCode = 500;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;res.end('Server Error');<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;else if (req.url === '/video') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Stream a video file with proper headers<br>
&nbsp;&nbsp;&nbsp;&nbsp;const videoPath = 'video.mp4';<br>
&nbsp;&nbsp;&nbsp;&nbsp;const stat = fs.statSync(videoPath);<br>
&nbsp;&nbsp;&nbsp;&nbsp;const fileSize = stat.size;<br>
&nbsp;&nbsp;&nbsp;&nbsp;const range = req.headers.range;<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (range) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Handle range requests for video seeking<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const parts = range.replace(/bytes=/, "").split("-");<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const start = parseInt(parts[0], 10);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const end = parts[1] ? parseInt(parts[1], 10) : fileSize - 1;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const chunksize = (end - start) + 1;<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const videoStream = fs.createReadStream(videoPath, { start, end });<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;res.writeHead(206, {<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;videoStream.pipe(res);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// No range header, send entire video<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;res.writeHead(200, {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'Content-Length': fileSize,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'Content-Type': 'video/mp4'<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;fs.createReadStream(videoPath).pipe(res);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}&br>
&nbsp;&nbsp;else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// 404 Not Found<br>
...
<h3>Processing Large CSV Files</h3>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const fs = require('fs');<br>
const { Transform } = require('stream');<br>
const csv = require('csv-parser'); // npm install csv-parser<br>
<br>
// Create a transform stream to filter and transform CSV data<br>
const filterTransform = new Transform({<br>
&nbsp;&nbsp;objectMode: true,<br>
&nbsp;&nbsp;transform(row, encoding, callback) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Only pass through rows that meet our criteria<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (parseInt(row.age) > 18) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Modify the row<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;row.isAdult = 'Yes';<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Push the transformed row<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;this.push(row);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;callback();<br>
...
<br>
// Create a writable stream for the results<br>
const results = [];<br>
const writeToArray = new Transform({<br>
&nbsp;&nbsp;objectMode: true,<br>
&nbsp;&nbsp;transform(row, encoding, callback) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;results.push(row);<br>
&nbsp;&nbsp;&nbsp;&nbsp;callback();<br>
...
<br>
// Create the processing pipeline<br>
fs.createReadStream('people.csv')<br>
&nbsp;&nbsp;.pipe(csv())<br>
&nbsp;&nbsp;.pipe(filterTransform)<br>
&nbsp;&nbsp;.pipe(writeToArray)<br>
&nbsp;&nbsp;.on('finish', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Processed ${results.length} records:`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(results);<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;})<br>
&nbsp;&nbsp;.on('error', (err) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error('Error processing CSV:', err);<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;});
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_streams_csv">Run example &raquo;</a>
</div>
...
<ul>
  <li><strong>Error Handling:</strong> Always handle error events on streams to prevent application crashes.</li>
  <li><strong>Use pipeline():</strong> Prefer <code class="w3-codespan">stream.pipeline()</code> over <code class="w3-codespan">.pipe()</code> for better error handling and cleanup.</li>
  <li><strong>Handle Backpressure:</strong> Respect the return value of <code class="w3-codespan">write()</code> to avoid memory issues.</li>
  <li><strong>End Streams:</strong> Always call <code class="w3-codespan">end()</code> on writable streams when you're done.</li>
  <li><strong>Avoid Synchronous Operations:</strong> Don't block the event loop with synchronous operations inside stream handlers.</li>
  <li><strong>Buffer Size:</strong> Be mindful of highWaterMark (buffer size) settings.</li>
</ul>

<div class="w3-panel ws-warning">
<p><strong>Warning:</strong> Mishandling streams can lead to memory leaks and performance issues.</p>
<p>Always handle errors and end streams properly.</p>
</div>
...
<p>Streams are a fundamental concept in Node.js that allow for efficient data handling. They:</p>

<ul>
  <li>Process data piece by piece without loading everything into memory</li>
  <li>Provide better memory efficiency for large datasets</li>
  <li>Allow processing to start before all data is available</li>
  <li>Enable powerful data processing pipelines</li>
  <li>Are used extensively in core Node.js APIs</li>
</ul>

<hr>


<div id="exercisecontainer" src="xrcise_streams.js" data-extensions="asp"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_events.asp">&lt; Previous</a>
