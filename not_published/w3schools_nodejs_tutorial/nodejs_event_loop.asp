...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Event Loop</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js Event Loop">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_event_loop.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="How the event loop handles many operations at once without blocking.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Event Loop">
<meta name="twitter:description" content="How the event loop handles many operations at once without blocking.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_event_loop.png">
...
<h1>Node.js <span class="color_h1">Event Loop</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_architecture.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="nodejs_async.asp">Next &#10095;</a>
</div>
<hr>

<h2>What is the Event Loop?</h2>
<p>The <b>event loop</b> is what makes Node.js non-blocking and efficient.</p>
<p>It handles asynchronous operations by delegating tasks to the system and processing their results through callbacks, allowing Node.js to manage thousands of concurrent connections with a single thread.</p>
<hr>

<h2>How the Event Loop Works</h2>
<p>Node.js follows these steps to handle operations:</p>
<ol>
  <li>Execute the main script (synchronous code)</li>
  <li>Process any microtasks (Promises, process.nextTick)</li>
  <li>Execute timers (setTimeout, setInterval)</li>
  <li>Run I/O callbacks (file system, network operations)</li>
  <li>Process setImmediate callbacks</li>
  <li>Handle close events (like socket.on('close'))</li>
</ol>
<div class="w3-example">
<h3>Example: Event Loop Order</h3>
<div class="w3-code notranslate jsHigh">
console.log('First');<br>
setTimeout(() => console.log('Third'), 0);<br>
Promise.resolve().then(() => console.log('Second'));<br>
console.log('Fourth');
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_eventloop_order">Try it Yourself &raquo;</a>
</div>
<p>This demonstrates the execution order:</p>
<ol>
  <li>Sync code runs first ('First', 'Fourth')</li>
  <li>Microtasks (Promises) run before the next phase ('Second')</li>
  <li>Timers execute last ('Third')</li>
</ol>
...
<p>The event loop processes different types of callbacks in this order:</p>
<ol>
  <li><b>Timers</b>: <code class="w3-codespan">setTimeout</code>, <code class="w3-codespan">setInterval</code></li>
  <li><b>I/O Callbacks</b>: Completed I/O operations</li>
  <li><b>Poll</b>: Retrieve new I/O events</li>
  <li><b>Check</b>: <code class="w3-codespan">setImmediate</code> callbacks</li>
  <li><b>Close</b>: Cleanup callbacks (like <code class="w3-codespan">socket.on('close')</code>)</li>
</ol>

<div class="w3-note ws-info">
  <p><b>Note:</b> Between each phase, Node.js runs microtasks (Promises) and <code class="w3-codespan">process.nextTick</code> callbacks.</p>
</div>

<div class="w3-example">
<h3>Example: Event Loop Phases</h3>
<div class="w3-code notranslate jsHigh">
console.log('1. Start');<br>
<br>
// Next tick queue<br>
process.nextTick(() => console.log('2. Next tick'));<br>
<br>
// Microtask queue (Promise)<br>
Promise.resolve().then(() => console.log('3. Promise'));<br>
<br>
// Timer phase<br>
setTimeout(() => console.log('4. Timeout'), 0);<br>
<br>
// Check phase<br>
setImmediate(() => console.log('5. Immediate'));<br>
<br>
console.log('6. End');<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_eventloop_phases">Try it Yourself &raquo;</a>
</div>

<p>The output will be:</p>
<pre class="w3-codespan">
1. Start
6. End
2. Next tick
3. Promise
...
<p>This shows the priority order: sync code > nextTick > Promises > Timers > Check phase.</p>

<hr>

<h2>Why is the Event Loop Important?</h2>
<p>The event loop enables Node.js to handle thousands of concurrent connections with a single thread, making it perfect for:</p>
<ul>
...
<h2>Summary</h2>
<ul>
  <li>Node.js uses an event loop to handle async operations</li>
  <li>Different types of callbacks have different priorities</li>
  <li>Microtasks (Promises) run before the next event loop phase</li>
  <li>This non-blocking model enables high concurrency</li>
</ul>
<hr>
<div id="exercisecontainer" src="xrcise_event_loop.js" data-extensions="asp"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_architecture.asp">&#10094; Previous</a>
