...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Express.js</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js Express.js">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_express.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="Express.js (or simply Express) is the most popular Node.js web application framework, designed for building web applications and APIs.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Express.js">
<meta name="twitter:description" content="Express.js (or simply Express) is the most popular Node.js web application framework, designed for building web applications and APIs.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_express.png">
...
<a class="w3-left w3-btn" href="nodejs_frameworks.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="nodejs_middleware.asp">Next &#10095;</a>
</div>
...
<p>Express.js (or simply Express) is the most popular Node.js web application framework, designed for building web applications and APIs.</p>
<p>It's often called the de facto standard server framework for Node.js.</p>
<p><strong>Key Characteristics:</strong></p>
<ul>
  <li>Minimal and flexible</li>
  <li>Unopinionated (you decide how to structure your app)</li>
  <li>Lightweight and fast</li>
  <li>Extensible through middleware</li>
  <li>Huge ecosystem of plugins and extensions</li>
</ul>


<h3>Why Choose Express.js?</h3>

<p>Express provides a thin layer of fundamental web application features without obscuring Node.js features.</p>
<p>It offers:</p>
<ul>
  <li>A robust routing system</li>
  <li>HTTP helpers (redirection, caching, etc.)</li>
  <li>Support for middleware to respond to HTTP requests</li>
  <li>A templating engine for dynamic HTML rendering</li>
...
<div class="w3-panel ws-note">
  <p>Express can be added to any Node.js project. Here's how to get started with a new Express application.</p>
</div>
...
<ul>
  <li>Node.js installed (v14.0.0 or later recommended)</li>
  <li>npm (comes with Node.js) or yarn</li>
  <li>A code editor (VS Code, WebStorm, etc.)</li>
</ul>

<h3>Installing Express</h3>

<p>To use Express in your Node.js application, you first need to install it:</p>
...
<p>To install Express and save it in your package.json dependencies:</p>
...
<p>Let's create a simple "Hello World" application with Express.</p>
<p>This example demonstrates the basic structure of an Express application.</p>
<p><strong>Key Components:</strong></p>
<ul>
  <li>Importing the Express module</li>
  <li>Creating an Express application instance</li>
...
const port = 8080;<br>
<br>
// Define a route for GET requests to the root URL<br>
app.get('/', (req, res) => {<br>
&nbsp;&nbsp;res.send('Hello World from Express!');<br>
});<br>
<br>
// Start the server<br>
app.listen(port, () => {<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs.asp?filename=demo_express_hello">Run example &raquo;</a>
</div>

<p>Save this code in a file named <code class="w3-codespan">app.js</code> and run it with Node.js:</p>
...
<p>Then, open your browser and navigate to <code class="w3-codespan">http://localhost:8080</code> to see the "Hello World" message.</p>

<hr>

<h2>Basic Routing</h2>

<p>Routing refers to how an application responds to client requests to specific endpoints (URIs) using different HTTP methods (GET, POST, PUT, DELETE, etc.).</p>
<p>Express provides simple methods to define routes that correspond to HTTP methods:</p>
<ul>
  <li><code class="w3-codespan">app.get()</code> - Handle GET requests</li>
  <li><code class="w3-codespan">app.post()</code> - Handle POST requests</li>
  <li><code class="w3-codespan">app.put()</code> - Handle PUT requests</li>
  <li><code class="w3-codespan">app.delete()</code> - Handle DELETE requests</li>
  <li><code class="w3-codespan">app.all()</code> - Handle all HTTP methods</li>
</ul>
...
const port = 8080;<br>
<br>
// Respond to GET request on the root route<br>
app.get('/', (req, res) => {<br>
&nbsp;&nbsp;res.send('GET request to the homepage');<br>
});<br>
<br>
// Respond to POST request on the root route<br>
app.post('/', (req, res) => {<br>
&nbsp;&nbsp;res.send('POST request to the homepage');<br>
});<br>
<br>
// Respond to GET request on the /about route<br>
app.get('/about', (req, res) => {<br>
&nbsp;&nbsp;res.send('About page');<br>
});<br>
<br>
// Catch all other routes<br>
app.all('*', (req, res) => {<br>
&nbsp;&nbsp;res.status(404).send('404 - Page not found');<br>
});<br>
<br>
// Start the server<br>
app.listen(port, () => {<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs.asp?filename=demo_express_routing">Run example &raquo;</a>
</div>

<h3>Route Parameters</h3>

<p>Route parameters are named URL segments that capture values at specific positions in the URL.</p>
<p>They are specified in the path with a colon <code class="w3-codespan">:</code> prefix.</p>
<p><strong>Example:</strong> <code class="w3-codespan">/users/:userId/books/:bookId</code></p>
<p>In this example, <code class="w3-codespan">userId</code> and <code class="w3-codespan">bookId</code> are route parameters that can be accessed via <code class="w3-codespan">req.params</code>.</p>
...
const port = 8080;<br>
<br>
// Route with parameters<br>
app.get('/users/:userId/books/:bookId', (req, res) => {<br>
&nbsp;&nbsp;// Access parameters using req.params<br>
&nbsp;&nbsp;res.send(`User ID: ${req.params.userId}, Book ID: ${req.params.bookId}`);<br>
});<br>
<br>
app.listen(port, () => {<br>
&nbsp;&nbsp;console.log(`Example app listening at http://localhost:${port}`);<br>
});</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs.asp?filename=demo_express_route_params">Run example &raquo;</a>
</div>

<h3>Query Parameters</h3>

<p>Query parameters are key-value pairs that appear after the <code class="w3-codespan">?</code> in a URL.</p>
<p>They are automatically parsed by Express and available in <code class="w3-codespan">req.query</code>.</p>
<p><strong>Example URL:</strong> <code class="w3-codespan">http://example.com/search?q=express&page=2</code></p>
<p>In this URL, <code class="w3-codespan">q=express</code> and <code class="w3-codespan">page=2</code> are query parameters that can be accessed as <code class="w3-codespan">req.query.q</code> and <code class="w3-codespan">req.query.page</code>.</p>
...
const port = 8080;<br>
<br>
// Route handling query parameters<br>
app.get('/search', (req, res) => {<br>
&nbsp;&nbsp;// Access query parameters using req.query<br>
&nbsp;&nbsp;const { q, category } = req.query;<br>
&nbsp;&nbsp;res.send(`Search query: ${q}, Category: ${category || 'none'}`);<br>
});<br>
<br>
app.listen(port, () => {<br>
&nbsp;&nbsp;console.log(`Example app listening at http://localhost:${port}`);<br>
});</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs.asp?filename=demo_express_query_params">Run example &raquo;</a>
</div>

<p>Access this route with a URL like: <code class="w3-codespan">http://localhost:8080/search?q=express&category=framework</code></p>
...
<ul>
  <li>The request object (<code class="w3-codespan">req</code>)</li>
  <li>The response object (<code class="w3-codespan">res</code>)</li>
  <li>The next middleware function in the stack (<code class="w3-codespan">next</code>)</li>
</ul>
<p>Middleware can:</p>
<ul>
...
<div class="w3-panel w3-light-grey">
  <p>Express includes several useful middleware functions:</p>
  <ul>
...
const port = 8080;<br>
<br>
// Middleware to parse JSON request bodies<br>
app.use(express.json());<br>
<br>
// Middleware to parse URL-encoded request bodies<br>
app.use(express.urlencoded({ extended: true }));<br>
<br>
// Middleware to serve static files from a directory<br>
app.use(express.static('public'));<br>
<br>
<br>
// POST route that uses JSON middleware<br>
app.post('/api/users', (req, res) => {<br>
&nbsp;&nbsp;// req.body contains the parsed JSON data<br>
&nbsp;&nbsp;console.log(req.body);<br>
&nbsp;&nbsp;res.status(201).json({ message: 'User created', user: req.body });<br>
});<br>
<br>
app.listen(port, () => {<br>
&nbsp;&nbsp;console.log(`Example app listening at http://localhost:${port}`);<br>
});</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs.asp?filename=demo_express_builtin_middleware">Run example &raquo;</a>
</div>
...
<p>Error handling in Express is done through special middleware functions that have four arguments:</p>
<p><code class="w3-codespan">(err, req, res, next)</code>.</p>
<p><strong>Key Points:</strong></p>
<ul>
  <li>Error-handling middleware must have four arguments</li>
  <li>It should be defined after other <code class="w3-codespan">app.use()</code> and route calls</li>
  <li>You can have multiple error-handling middleware functions</li>
  <li>Use <code class="w3-codespan">next(err)</code> to pass errors to the next error handler</li>
</ul>

<p>Express comes with a default error handler to catch errors that occur during request processing:</p>
...
const port = 8080;<br>
<br>
// Route that may throw an error<br>
app.get('/error', (req, res) => {<br>
&nbsp;&nbsp;// Simulating an error<br>
&nbsp;&nbsp;throw new Error('Something went wrong!');<br>
});<br>
<br>
// Route that uses next(error) for asynchronous code<br>
app.get('/async-error', (req, res, next) => {<br>
&nbsp;&nbsp;// Simulating an asynchronous operation that fails<br>
&nbsp;&nbsp;setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Something that might fail<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const result = nonExistentFunction(); // This will throw an error<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;res.send(result);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;catch (error) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;next(error); // Pass errors to Express<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;}, 100);<br>
});<br>
<br>
// Custom error handling middleware<br>
// Must have four parameters to be recognized as an error handler<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs.asp?filename=demo_express_error_handling">Run example &raquo;</a>
</div>
...
<p>Express can serve static files like images, CSS, and JavaScript using the built-in <code class="w3-codespan">express.static</code> middleware.</p>
<p><strong>Best Practices:</strong></p>
<ul>
  <li>Place static files in a dedicated directory (commonly <code class="w3-codespan">public</code> or <code class="w3-codespan">static</code>)</li>
  <li>Mount the static middleware before your routes</li>
  <li>Consider using a CDN in production for better performance</li>
  <li>Set appropriate cache headers for static assets</li>
</ul>

<p>To serve static files such as images, CSS files, and JavaScript files, use the <code class="w3-codespan">express.static</code> built-in middleware function:</p>
...
app.use(express.static('public'));<br>
<br>
// You can also specify a virtual path prefix<br>
app.use('/static', express.static('public'));<br>
<br>
// Using absolute path (recommended)<br>
app.use('/assets', express.static(path.join(__dirname, 'public')));<br>
<br>
app.get('/', (req, res) => {<br>
&nbsp;&nbsp;res.send(`<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;h1&gt;Static Files Example&lt;/h1&gt;<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs.asp?filename=demo_express_static_files">Run example &raquo;</a>
</div>

<p>This assumes you have a directory named <code class="w3-codespan">public</code> in the same directory as your script with subdirectories for images, CSS, and JavaScript files.</p>

<hr>

<h2>Routing in Separate Files</h2>

<p>For better organization, you can define routes in separate files using Express Router:</p>

<h3>routes/users.js</h3>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const express = require('express');<br>
...
&nbsp;&nbsp;console.log('Users Router Time:', Date.now());<br>
&nbsp;&nbsp;next();<br>
});<br>
<br>
// Define routes<br>
router.get('/', (req, res) => {<br>
&nbsp;&nbsp;res.send('Users home page');<br>
});<br>
<br>
router.get('/:id', (req, res) => {<br>
&nbsp;&nbsp;res.send(`User profile for ID: ${req.params.id}`);<br>
});<br>
<br>
module.exports = router;</div>
</div>

<h3>routes/products.js</h3>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const express = require('express');<br>
const router = express.Router();<br>
...
// Define routes<br>
router.get('/', (req, res) => {<br>
&nbsp;&nbsp;res.send('Products list');<br>
});<br>
<br>
router.get('/:id', (req, res) => {<br>
&nbsp;&nbsp;res.send(`Product details for ID: ${req.params.id}`);<br>
});<br>
<br>
module.exports = router;</div>
</div>

<h3>app.js (main file)</h3>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const express = require('express');<br>
const usersRouter = require('./routes/users');<br>
const productsRouter = require('./routes/products');<br>
<br>
const app = express();<br>
const port = 8080;<br>
<br>
...
app.use('/products', productsRouter);<br>
<br>
app.get('/', (req, res) => {<br>
&nbsp;&nbsp;res.send('Main application home page');<br>
});<br>
<br>
app.listen(port, () => {<br>
&nbsp;&nbsp;console.log(`Example app listening at http://localhost:${port}`);<br>
});</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs.asp?filename=demo_express_separate_routes">Run example &raquo;</a>
</div>
...
<p>Express can be configured with template engines to generate dynamic HTML:</p>
...
const port = 8080;<br>
<br>
// Set the view engine to EJS<br>
app.set('view engine', 'ejs');<br>
<br>
// Set the directory where templates are located<br>
app.set('views', './views');<br>
<br>
// Route that renders a template<br>
app.get('/', (req, res) => {<br>
&nbsp;&nbsp;const data = {<br>
&nbsp;&nbsp;&nbsp;&nbsp;title: 'Express Template Example',<br>
&nbsp;&nbsp;&nbsp;&nbsp;message: 'Hello from EJS!',<br>
&nbsp;&nbsp;&nbsp;&nbsp;items: ['Item 1', 'Item 2', 'Item 3']<br>
&nbsp;&nbsp;};<br>
<br>
&nbsp;&nbsp;// Renders the views/index.ejs template<br>
...
<p>To use this example, you'll need to install the EJS template engine:</p>
...
<p>And create a file at <code class="w3-codespan">views/index.ejs</code>:</p>
...
<h2>Building a RESTful API</h2>

<p>Express is commonly used to build RESTful APIs. That is covered in our <a href="nodejs_rest_api.asp">Node.js Express REST API</a> chapter.</p>
...
<p>The Express Application Generator is a tool that helps you quickly create an Express application skeleton.</p>
<p><strong>Key Features:</strong></p>
<ul>
  <li>Creates a well-structured application</li>
  <li>Sets up a development environment</li>
  <li>Configures common middleware</li>
  <li>Includes error handling</li>
  <li>Supports various template engines</li>
</ul>
<p><strong>Installation:</strong> <code class="w3-codespan">npm install -g express-generator</code></p>
<p><strong>Usage:</strong> <code class="w3-codespan">express --view=pug myapp</code></p>

<p>Express provides an application generator tool to quickly create an application skeleton:</p>

<div class="w3-example">
<div class="w3-code notranslate">
# Install the generator globally<br>
npm install -g express-generator<br>
<br>
# Create a new Express application<br>
express --view=ejs myapp<br>
<br>
...
<p>This creates an application with the following directory structure:</p>
...
<div class="w3-panel ws-note">
  <p>Follow these best practices to build robust, maintainable Express applications:</p>
  <ul>
    <li><strong>Project Structure:</strong> Organize your code by feature or component</li>
    <li><strong>Environment Variables:</strong> Use <code class="w3-codespan">dotenv</code> for configuration</li>
    <li><strong>Error Handling:</strong> Centralize error handling</li>
    <li><strong>Logging:</strong> Use a logging library like <code class="w3-codespan">morgan</code> or <code class="w3-codespan">winston</code></li>
    <li><strong>Security:</strong> Implement security best practices (helmet, rate limiting, etc.)</li>
    <li><strong>Validation:</strong> Validate input using libraries like <code class="w3-codespan">express-validator</code></li>
    <li><strong>Testing:</strong> Write tests using <code class="w3-codespan">jest</code>, <code class="w3-codespan">mocha</code>, or similar</li>
  </ul>
</div>
...
<div class="w3-panel ws-info">
  <p>When deploying to production, consider these additional practices:</p>
  <ul>
    <li>Set <code class="w3-codespan">NODE_ENV</code> to "production"</li>
    <li>Use a process manager like PM2 or Forever</li>
    <li>Enable compression with <code class="w3-codespan">compression</code> middleware</li>
    <li>Use a reverse proxy like Nginx</li>
    <li>Implement proper logging and monitoring</li>
    <li>Set up proper error tracking</li>
  </ul>
</div>

<h3>Security Best Practices</h3>
<ul>
  <li>Use Helmet to secure your Express apps by setting various HTTP headers</li>
...
<br>
// Other middleware and routes<br>
// ...</div>
</div>

<h3>Performance Best Practices</h3>
<ul>
  <li>Use compression middleware to compress responses</li>
  <li>Implement proper caching strategies</li>
  <li>Consider using a reverse proxy (like Nginx) in front of your Express app</li>
...
<div id="exercisecontainer" src="xrcise_express.js" data-extensions="asp"></div>
