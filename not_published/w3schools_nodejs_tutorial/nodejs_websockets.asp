...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js WebSockets</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js WebSockets">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_websockets.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="WebSockets provide a persistent connection between client and server, allowing for real-time, bidirectional communication.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js WebSockets">
<meta name="twitter:description" content="WebSockets provide a persistent connection between client and server, allowing for real-time, bidirectional communication.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_websockets.png">
...
<h1>Node.js <span class="color_h1">WebSockets</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_socketio.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="nodejs_debugging_advanced.asp">Next &#10095;</a>
</div>
<hr>

<h2 id="intro">Introduction to WebSockets</h2>
<p>WebSockets provide a persistent connection between client and server, allowing for real-time, bidirectional communication.</p>
<p>This is different from traditional HTTP, which follows a request-response model.</p>

<h4>Key Benefits of WebSockets</h4>
<ul>
<li><strong>Real-time updates</strong>: Instantly push data to clients</li>
  <li><strong>Efficient</strong>: No need for repeated HTTP requests</li>
  <li><strong>Bidirectional</strong>: Both client and server can send messages</li>
  <li><strong>Low latency</strong>: Messages are sent immediately</li>
</ul>

<hr>

<h2 id="vs-http">WebSockets vs HTTP</h2>
<p>Understanding the difference between WebSockets and HTTP is crucial for building real-time applications effectively.</p>

<div class="w3-responsive">
  <table class="ws-table-all w3-striped">
    <tr>
      <th style="width:20%">Feature</th>
      <th style="width:40%">WebSockets</th>
      <th style="width:40%">HTTP</th>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Minimal after handshake</td>
      <td>Headers with every request</td>
    </tr>
    <tr>
      <td><strong>Use Case</strong></td>
      <td>Real-time applications</td>
      <td>Traditional web pages, APIs</td>
    </tr>
    <tr>
      <td><strong>Example</strong></td>
      <td>Chat apps, live feeds</td>
      <td>Loading web pages, form submissions</td>
    </tr>
  </table>
</div>

<div class="w3-panel ws-tip">
  <p><strong>Pro Tip:</strong> WebSockets begin with an HTTP handshake (status code 101) before upgrading to the WebSocket protocol (ws:// or wss://).</p>
</div>
<hr>
...
<h2 id="setup">Setting Up WebSockets</h2>

<h3>1. Install the ws Module</h3>
<p>First, create a new directory for your project and initialize it:</p>

<div class="w3-example">
  <div class="w3-code notranslate">
    mkdir websocket-demo<br>
    cd websocket-demo<br>
    npm init -y
  </div>
</div>

<p>Then, install the <code class="w3-codespan">ws</code> package:</p>
...
<div class="w3-panel w3-note">
  <p><strong>Note:</strong> The <code class="w3-codespan">ws</code> module is a simple, fast, and thoroughly tested WebSocket client and server implementation.</p>
</div>
<hr>

<h2 id="server">Creating a WebSocket Server</h2>

<p>Let's create a simple WebSocket server that echoes back any message it receives.</p>
<p>Create a new file called <code class="w3-codespan">server.js</code>:</p>

<div class="w3-example">
  <h3>Example: WebSocket Echo Server</h3>
  <div class="w3-code notranslate jsHigh">
  const WebSocket = require('ws');<br>
  <br>
  // Create a WebSocket server on port 8080<br>
  const wss = new WebSocket.Server({ port: 8080 });<br>
  <br>
  console.log('WebSocket server is running on ws://localhost:8080');<br>
  <br>
  // Connection event handler<br>
  wss.on('connection', (ws) => {<br>
  &nbsp;&nbsp;console.log('New client connected');<br>
  &nbsp;&nbsp;<br>
  &nbsp;&nbsp;// Send a welcome message to the client<br>
  &nbsp;&nbsp;ws.send('Welcome to the WebSocket server!');<br>
  <br>
  &nbsp;&nbsp;// Message event handler<br>
  &nbsp;&nbsp;ws.on('message', (message) => {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;console.log(`Received: ${message}`);<br>
  &nbsp;&nbsp;&nbsp;&nbsp;// Echo the message back to the client<br>
  &nbsp;&nbsp;&nbsp;&nbsp;ws.send(`Server received: ${message}`);<br>
  &nbsp;&nbsp;});<br>
  <br>
  &nbsp;&nbsp;// Close event handler<br>
  &nbsp;&nbsp;ws.on('close', () => {<br>
...
<ol>
  <li>We import the <code class="w3-codespan">ws</code> module</li>
  <li>Create a new WebSocket server on port 8080</li>
  <li>Set up event handlers for connections, messages, and disconnections</li>
  <li>Echo back any received messages to the client</li>
</ol>

<h4>Try It Out</h4>
<p>1. Save the code above as <code class="w3-codespan">server.js</code></p>
<p>2. Run the server: <code class="w3-codespan">node server.js</code></p>
<p>3. The server will start and listen on <code class="w3-codespan">ws://localhost:8080</code></p>
<hr>

<h2 id="client">Creating a WebSocket Client</h2>

<p>Now that we have a WebSocket server, let's create clients to connect to it. We'll create both a Node.js client and a browser client.</p>

<h3>1. Node.js Client</h3>
<p>Create a new file called <code class="w3-codespan">client.js</code>:</p>
...
<div class="w3-example">
  <div class="w3-code notranslate jsHigh">
    ...
    <br>
    // Create readline interface for user input<br>
    const rl = readline.createInterface({<br>
    &nbsp;&nbsp;input: process.stdin,<br>
    &nbsp;&nbsp;output: process.stdout<br>
    });<br>
    <br>
    // Connect to the WebSocket server<br>
    const ws = new WebSocket('ws://localhost:8080');<br>
    <br>
    // Connection opened<br>
    ws.on('open', () => {<br>
    &nbsp;&nbsp;console.log('Connected to the WebSocket server');<br>
    &nbsp;&nbsp;promptForMessage();<br>
    });<br>
    <br>
    // Listen for messages from the server<br>
    ws.on('message', (message) => {<br>
    &nbsp;&nbsp;console.log(`Server: ${message}`);<br>
    });<br>
    <br>
    // Handle errors<br>
    ...
    <br>
    // Handle connection close<br>
    ws.on('close', () => {<br>
    &nbsp;&nbsp;console.log('Disconnected from the server');<br>
    &nbsp;&nbsp;process.exit(0);<br>
    });<br>
    <br>
    // Function to prompt user for messages<br>
    function promptForMessage() {<br>
    &nbsp;&nbsp;rl.question('Enter a message (or "exit" to quit): ', (message) => {<br>
    &nbsp;&nbsp;&nbsp;&nbsp;if (message.toLowerCase() === 'exit') {<br>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ws.close();<br>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;rl.close();<br>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return;<br>
    &nbsp;&nbsp;&nbsp;&nbsp;}<br>
...
<h4>How to Use the Node.js Client</h4>
<ol>
  <li>Save the code above as <code class="w3-codespan">client.js</code></li>
  <li>Make sure the WebSocket server is running</li>
  <li>Run the client: <code class="w3-codespan">node client.js</code></li>
  <li>Type messages and press Enter to send them to the server</li>
  <li>Type "exit" to quit</li>
</ol>

<h3>2. Browser Client</h3>
<p>Let's create a simple HTML page with JavaScript to connect to our WebSocket server.</p>
<p>Create a file named <code class="w3-codespan">index.html</code>:</p>
...
<div class="w3-example">
  <div class="w3-code notranslate htmlHigh">
    ...
    &lt;html&gt;<br>
    &lt;head&gt;<br>
    &nbsp;&nbsp;&lt;title&gt;WebSocket Client&lt;/title&gt;<br>
    &nbsp;&nbsp;&lt;style&gt;<br>
    &nbsp;&nbsp;&nbsp;&nbsp;body {<br>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;}<br>
    &nbsp;&nbsp;&nbsp;&nbsp;.message { margin: 5px 0; }<br>
    &nbsp;&nbsp;&lt;/style&gt;<br>
    &lt;/head&gt;<br>
    &lt;body&gt;<br>
    &nbsp;&nbsp;&lt;h1&gt;WebSocket Client&lt;/h1&gt;<br>
    &nbsp;&nbsp;&lt;div id="status"&gt;Connecting to server...&lt;/div&gt;<br>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;const messageInput = document.getElementById('messageInput');<br>
    <br>
    &nbsp;&nbsp;&nbsp;&nbsp;// Connect to the WebSocket server<br>
    &nbsp;&nbsp;&nbsp;&nbsp;const ws = new WebSocket('ws://localhost:8080');<br>
    <br>
    &nbsp;&nbsp;&nbsp;&nbsp;// Connection opened<br>
    &nbsp;&nbsp;&nbsp;&nbsp;ws.onopen = () => {<br>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;status.textContent = 'Connected to server';<br>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;message.className = 'message';<br>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;message.textContent = event.data;<br>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;// Handle errors<br>
    &nbsp;&nbsp;&nbsp;&nbsp;ws.onerror = (error) => {<br>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;status.textContent = 'Error: ' + error.message;<br>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;status.style.color = 'red';<br>
    &nbsp;&nbsp;&nbsp;&nbsp;};<br>
    <br>
    &nbsp;&nbsp;&nbsp;&nbsp;// Handle connection close<br>
    &nbsp;&nbsp;&nbsp;&nbsp;ws.onclose = () => {<br>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;status.textContent = 'Disconnected from server';<br>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;status.style.color = 'red';<br>
    &nbsp;&nbsp;&nbsp;&nbsp;};<br>
    <br>
    &nbsp;&nbsp;&nbsp;&nbsp;// Function to send a message<br>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;}<br>
    <br>
    &nbsp;&nbsp;&nbsp;&nbsp;// Send message on Enter key<br>
    &nbsp;&nbsp;&nbsp;&nbsp;messageInput.addEventListener('keypress', (e) => {<br>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (e.key === 'Enter') {<br>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;sendMessage();<br>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
    &nbsp;&nbsp;&nbsp;&nbsp;});<br>
  ...
  <a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs.asp?filename=demo_websocket_browser">Try it Yourself &raquo;</a>
</div>

<h4>How to Use the Browser Client</h4>
<ol>
  <li>Save the code above as <code class="w3-codespan">index.html</code></li>
  <li>Make sure the WebSocket server is running</li>
  <li>Open the HTML file in a web browser</li>
  <li>Type messages in the input field and click Send or press Enter</li>
</ol>

<div class="w3-panel w3-pale-yellow">
  <p><strong>Note:</strong> For the browser client to work, you'll need to serve the HTML file through a web server (like <code class="w3-codespan">http-server</code> or <code class="w3-codespan">live-server</code>) due to browser security restrictions.</p>
</div>

<h3>3. Testing the Application</h3>
<ol>
  <li>Start the WebSocket server: <code class="w3-codespan">node server.js</code></li>
  <li>Open multiple browser windows with the client HTML page</li>
  <li>Send messages from different clients and see them appear in real-time</li>
  <li>You can also run the Node.js client alongside the browser clients</li>
</ol>

<div class="w3-panel ws-info">
  <h4>Understanding the Implementation</h4>
  <ul>
    <li>The server maintains a set of all connected clients</li>
    <li>When a message is received from one client, it's broadcast to all others</li>
    <li>The client handles connection, disconnection, and error events</li>
    <li>Messages are displayed in real-time as they're received</li>
  </ul>
</div>
<hr>

<h2 id="events">WebSocket Events</h2>
<p>WebSockets use an event-driven model. Here are the key events:</p>
...
<table class="ws-table-all">
  ...
  <tr>
    <td><code class="w3-codespan">connection</code> (server)</td>
    <td>Fired when a client connects to the server</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">open</code> (client)</td>
    <td>Fired when the connection is established</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">message</code></td>
    <td>Fired when a message is received</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">error</code></td>
    <td>Fired when an error occurs</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">close</code></td>
    <td>Fired when the connection is closed</td>
  </tr>
</table>
<hr>

<h2 id="realworld">Real-world Applications</h2>
<p>WebSockets are used in a variety of real-world applications:</p>

<ul>
  <li><strong>Chat Applications:</strong> Instant message delivery</li>
  <li><strong>Live Dashboards:</strong> Real-time updates of metrics and data</li>
  <li><strong>Collaborative Tools:</strong> Multiple users editing the same document</li>
  <li><strong>Gaming:</strong> Multiplayer online games requiring fast interactions</li>
  <li><strong>Financial Platforms:</strong> Real-time stock tickers and trading platforms</li>
  <li><strong>IoT Applications:</strong> Monitoring and controlling connected devices</li>
</ul>
<hr>
<h2 id="advanced">Advanced WebSocket Features</h2>

<h3>1. Binary Data Transfer</h3>
<p>WebSockets support sending binary data, which is more efficient for certain types of data:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
  // Sending binary data (server-side)<br>
  const buffer = Buffer.from([0x48, 0x65, 0x6c, 0x6c, 0x6f]); // 'Hello' in binary<br>
  ws.send(buffer, { binary: true });<br>
  <br>
  // Receiving binary data (client-side)<br>
  ws.binaryType = 'arraybuffer';<br>
  ws.onmessage = (event) => {<br>
  &nbsp;&nbsp;if (event.data instanceof ArrayBuffer) {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;const view = new Uint8Array(event.data);<br>
  &nbsp;&nbsp;&nbsp;&nbsp;console.log('Received binary data:', view);<br>
  &nbsp;&nbsp;}<br>
  };
</div>
</div>

<h3>2. Heartbeats and Connection Monitoring</h3>
<p>Implement heartbeats to detect and handle disconnections:</p>
<div class="w3-example"> 
<div class="w3-code notranslate jsHigh">
  // Server-side heartbeat<br>
  function setupHeartbeat(ws) {<br>
  &nbsp;&nbsp;ws.isAlive = true;<br>
  &nbsp;&nbsp;ws.on('pong', () => { ws.isAlive = true; });<br>
  }<br>
  <br>
  // Ping all clients every 30 seconds<br>
  const interval = setInterval(() => {<br>
  &nbsp;&nbsp;wss.clients.forEach((ws) => {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;if (ws.isAlive === false) return ws.terminate();<br>
  &nbsp;&nbsp;&nbsp;&nbsp;ws.isAlive = false;<br>
  &nbsp;&nbsp;&nbsp;&nbsp;ws.ping();<br>
  &nbsp;&nbsp;});<br>
  }, 30000);<br>
  <br>
  // Clean up on server close<br>
  wss.on('close', () => {<br>
...
<p>Always authenticate WebSocket connections:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
  ...
  const wss = new WebSocket.Server({ noServer: true });<br>
  <br>
  // Handle upgrade with authentication<br>
  server.on('upgrade', (request, socket, head) => {<br>
  &nbsp;&nbsp;try {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;const token = request.url.split('token=')[1];<br>
  &nbsp;&nbsp;&nbsp;&nbsp;if (!token) throw new Error('No token provided');<br>
  &nbsp;&nbsp;&nbsp;&nbsp;<br>
  &nbsp;&nbsp;&nbsp;&nbsp;// Verify JWT token<br>
  &nbsp;&nbsp;&nbsp;&nbsp;jwt.verify(token, 'your-secret-key', (err, decoded) => {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (err) {<br>
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Proceed with WebSocket handshake<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;wss.handleUpgrade(request, socket, head, (ws) => {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ws.user = decoded; // Attach user data to WebSocket<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;wss.emit('connection', ws, request);<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
  &nbsp;&nbsp;&nbsp;&nbsp;});<br>
  &nbsp;&nbsp;} catch (error) {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;socket.write('HTTP/1.1 401 Unauthorized\r\n\r\n');<br>
...
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
  const rateLimit = require('ws-rate-limit');<br>
  <br>
  // Limit to 100 messages per minute per connection<br>
  const limiter = rateLimit({<br>
  &nbsp;&nbsp;windowMs: 60 * 1000, // 1 minute<br>
  &nbsp;&nbsp;max: 100,<br>
  &nbsp;&nbsp;message: 'Too many messages, please slow down!',<br>
  });<br>
  <br>
  wss.on('connection', (ws) => {<br>
  &nbsp;&nbsp;limiter(ws);<br>
  &nbsp;&nbsp;// ... rest of your connection handler<br>
  });
</div>
</div>

<h3>3. Input Validation</h3>
<p>Always validate incoming messages:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const Joi = require('joi');<br>
<br>
  const messageSchema = Joi.object({<br>
  &nbsp;&nbsp;type: Joi.string().valid('chat', 'join', 'leave').required(),<br>
  &nbsp;&nbsp;username: Joi.string().alphanum().min(3).max(30),<br>
  &nbsp;&nbsp;message: Joi.string().max(1000),<br>
  &nbsp;&nbsp;room: Joi.string().alphanum().max(50),<br>
  });<br>
  <br>
  ws.on('message', (data) => {<br>
  &nbsp;&nbsp;try {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;const message = JSON.parse(data);<br>
  &nbsp;&nbsp;&nbsp;&nbsp;const { error, value } = messageSchema.validate(message);<br>
  &nbsp;&nbsp;&nbsp;&nbsp;if (error) {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;throw new Error(`Invalid message: ${error.details[0].message}`);<br>
  &nbsp;&nbsp;&nbsp;&nbsp;}<br>
  &nbsp;&nbsp;&nbsp;&nbsp;// Process valid message...<br>
  &nbsp;&nbsp;} catch (err) {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;ws.send(JSON.stringify({ error: err.message }));<br>
  &nbsp;&nbsp;}<br>
  });
</div>
</div>
...
<h3>Compression</h3>
<p>Enable per-message deflate to reduce bandwidth usage:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
  const WebSocket = require('ws');<br>
  <br>
  const wss = new WebSocket.Server({<br>
  &nbsp;&nbsp;port: 8080,<br>
  &nbsp;&nbsp;perMessageDeflate: {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;zlibDeflateOptions: {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;chunkSize: 1024,<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;memLevel: 7,<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;level: 3<br>
  &nbsp;&nbsp;&nbsp;&nbsp;},<br>
  &nbsp;&nbsp;&nbsp;&nbsp;zlibInflateOptions: {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;chunkSize: 10 * 1024<br>
  &nbsp;&nbsp;&nbsp;&nbsp;},<br>
  &nbsp;&nbsp;&nbsp;&nbsp;// Other options<br>
  &nbsp;&nbsp;&nbsp;&nbsp;clientNoContextTakeover: true,<br>
  &nbsp;&nbsp;&nbsp;&nbsp;serverNoContextTakeover: true,<br>
  &nbsp;&nbsp;&nbsp;&nbsp;concurrencyLimit: 10,<br>
  &nbsp;&nbsp;}<br>
  });
</div>
</div>
...
<div class="w3-panel ws-info">
  <p><strong>Best Practice:</strong> For production applications, consider using libraries like Socket.IO which provides additional features like fallbacks for browsers that don't support WebSockets.</p>
</div>
<hr>

<div id="exercisecontainer" src="xrcise_websockets.js" data-extensions="asp"></div>
<hr>
