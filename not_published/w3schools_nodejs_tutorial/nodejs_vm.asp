...
<meta name="title" property="og:title" content="Node.js VM Module">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_vm.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="The VM (Virtual Machine) module allows you to compile and run code within isolated contexts.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js VM Module">
<meta name="twitter:description" content="The VM (Virtual Machine) module allows you to compile and run code within isolated contexts.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_vm.png">
...
<h1>Node.js VM Module</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_perf_hooks.asp">&lt; Previous</a>
<a class="w3-right w3-btn" href="nodejs_tls.asp">Next &gt;</a>
</div>

<hr>

<h2>Introduction to the VM Module</h2>

<p>The VM (Virtual Machine) module allows you to compile and run code within isolated contexts.</p>
<p>This is useful for:</p>
<ul>
  <li>Running untrusted code safely in a sandbox</li>
  <li>Evaluating JavaScript code dynamically</li>
  <li>Creating plugins and extension systems</li>
  <li>Building custom scripting environments</li>
  <li>Testing code in isolation</li>
</ul>

<div class="w3-panel ws-warning">
<p><strong>Warning:</strong> While the VM module provides isolation from the main JavaScript environment, it is not a completely secure sandbox. It should not be used as the sole security mechanism for running untrusted code.</p>
</div>

<hr>

<h2>Importing the VM Module</h2>

<p>To use the VM module, you need to import it in your Node.js application:</p>
...
<p>The VM module has several key components:</p>
...
<table class="ws-table-all">
  ...
  <tr>
    <td><code class="w3-codespan">Script</code></td>
    <td>A compiled JavaScript code that can be executed multiple times in different contexts</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">Context</code></td>
    <td>An isolated global object where scripts execute, similar to a sandboxed environment</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">ContextifiedObject</code></td>
    <td>An object that has been associated with a VM context and serves as its global object</td>
  </tr>
</table>
</div>
...
<h2>Basic Usage: Running JavaScript in a Context</h2>

<p>The simplest way to use the VM module is to run code in a context:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const vm = require('vm');<br>
<br>
// Create a context object<br>
const context = { x: 2 };<br>
<br>
// Compile and run a script in the context<br>
vm.createContext(context);<br>
vm.runInContext('x = x * 2; y = 10;', context);<br>
<br>
// Inspect the modified context<br>
...
<p>In this example:</p>
<ol>
  <li>We create a context object with a variable <code class="w3-codespan">x</code></li>
  <li>We "contextify" this object using <code class="w3-codespan">vm.createContext()</code></li>
  <li>We run JavaScript code in this context that modifies <code class="w3-codespan">x</code> and creates <code class="w3-codespan">y</code></li>
  <li>The changes are reflected in the context object</li>
</ol>

<hr>

<h2>VM Module Methods</h2>
...
<table class="ws-table-all">
  ...
  <tr>
    <td><code class="w3-codespan">vm.Script(code[, options])</code></td>
    <td>Creates a new Script object that represents compiled code</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">script.runInContext(contextObject[, options])</code></td>
    <td>Runs the compiled code in the specified context</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">script.runInNewContext([contextObject][, options])</code></td>
    <td>Runs the compiled code in a new context</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">script.runInThisContext([options])</code></td>
    <td>Runs the compiled code in the current context</td>
  </tr>
</table>
</div>
...
<table class="ws-table-all">
  ...
  <tr>
    <td><code class="w3-codespan">vm.createContext([contextObject][, options])</code></td>
    <td>Creates a new context which can be used for script execution</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">vm.isContext(object)</code></td>
    <td>Checks if an object has been contextified</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">vm.runInContext(code, contextObject[, options])</code></td>
    <td>Compiles and executes code in the given context</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">vm.runInNewContext(code[, contextObject][, options])</code></td>
    <td>Compiles and executes code in a new context</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">vm.runInThisContext(code[, options])</code></td>
    <td>Compiles and executes code in the current context</td>
  </tr>
</table>
</div>
...
<h2>Creating and Compiling Scripts</h2>

<p>For better performance when executing the same code multiple times, you can pre-compile it using the <code class="w3-codespan">Script</code> class:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const vm = require('vm');<br>
<br>
// Compile the script once<br>
const script = new vm.Script('x += 40; let z = 30;');<br>
<br>
// Create multiple contexts<br>
const context1 = { x: 10 };<br>
const context2 = { x: 20 };<br>
<br>
// Contextify the objects<br>
vm.createContext(context1);<br>
vm.createContext(context2);<br>
<br>
// Run the same script in different contexts<br>
script.runInContext(context1);<br>
script.runInContext(context2);<br>
<br>
console.log(context1); // Outputs: { x: 50, z: 30 }<br>
console.log(context2); // Outputs: { x: 60, z: 30 }
</div>
</div>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> Compiling scripts separately is more efficient when you need to execute the same code multiple times, as the parsing and compilation steps happen only once.</p>
</div>

<hr>

<h2>Different Ways to Run Code</h2>

<h3>1. runInContext</h3>
<p>Runs code in a previously created context:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const vm = require('vm');<br>
<br>
const context = { value: 10 };<br>
vm.createContext(context);<br>
<br>
// Run directly<br>
vm.runInContext('value += 5', context);<br>
console.log(context.value); // 15<br>
<br>
// Compile then run<br>
const script = new vm.Script('value *= 2');<br>
script.runInContext(context);<br>
console.log(context.value); // 30
</div>
</div>

<h3>2. runInNewContext</h3>
<p>Creates a new context and runs code in it:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const vm = require('vm');<br>
<br>
// No need to call createContext first<br>
const context = { value: 10 };<br>
vm.runInNewContext('value += 5; result = value * 2;', context);<br>
<br>
console.log(context); // { value: 15, result: 30 }
</div>
</div>

<h3>3. runInThisContext</h3>
<p>Runs code in the current V8 context (similar to <code class="w3-codespan">eval</code> but safer):</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const vm = require('vm');<br>
<br>
// Define a variable in the current scope<br>
const locallet = 20;<br>
let result;<br>
<br>
// This won't have access to localVar<br>
vm.runInThisContext('result = (typeof locallet !== "undefined" ? locallet : "not defined")');<br>
console.log(result); // 'not defined'<br>
<br>
// But it can access globals<br>
global.globallet = 30;<br>
vm.runInThisContext('result = globalVar');<br>
console.log(result); // 30<br>
<br>
// Compare with eval, which CAN access local variables<br>
eval('result = localVar');<br>
console.log(result); // 20
</div>
</div>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> <code class="w3-codespan">runInThisContext</code> is similar to <code class="w3-codespan">eval</code>, but it doesn't have access to local variables in the scope it was called from. This makes it somewhat safer, as it reduces the risk of code injection affecting local variables.</p>
</div>
<hr>

<h2>Working with the Timeout Option</h2>

<p>You can set a timeout for script execution to prevent infinite loops or long-running scripts:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const vm = require('vm');<br>
<br>
const context = { result: 0 };<br>
vm.createContext(context);<br>
<br>
try {<br>
&nbsp;&nbsp;// This should timeout after 1000ms (1 second)<br>
&nbsp;&nbsp;vm.runInContext(`<br>
&nbsp;&nbsp;&nbsp;&nbsp;let counter = 0;<br>
&nbsp;&nbsp;&nbsp;&nbsp;while (true) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;counter++;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;result = counter;<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;`, context, { timeout: 1000 });<br>
} catch (err) {<br>
&nbsp;&nbsp;console.error(`Execution timed out: ${err.message}`);<br>
&nbsp;&nbsp;console.log(`Results before timeout: counter reached ${context.result}`);<br>
}
</div>
</div>

<div class="w3-panel ws-warning">
<p><strong>Warning:</strong> The timeout option doesn't guarantee that execution will stop exactly at the specified time. The actual timeout may vary slightly.</p>
</div>

<hr>

<h2>Controlling Access to Node.js Core Modules</h2>

<p>By default, code run in VM contexts doesn't have access to Node.js core modules. You can control which modules are available:</p>
...
<br>
// Create a sandbox with controlled access to core modules<br>
const sandbox = {<br>
&nbsp;&nbsp;// Allow limited access to console<br>
&nbsp;&nbsp;console: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;log: console.log,<br>
&nbsp;&nbsp;&nbsp;&nbsp;error: console.error<br>
&nbsp;&nbsp;},<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Provide controlled access to fs module<br>
&nbsp;&nbsp;fs: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;readFileSync: fs.readFileSync<br>
&nbsp;&nbsp;},<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Custom utility<br>
&nbsp;&nbsp;util: {<br>
...
&nbsp;&nbsp;},<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// No access to process, child_process, etc.<br>
};<br>
<br>
vm.createContext(sandbox);<br>
<br>
// Run code with limited access<br>
try {<br>
&nbsp;&nbsp;vm.runInContext(`<br>
&nbsp;&nbsp;&nbsp;&nbsp;// We can use the allowed methods<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Running in sandbox');<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('2 + 3 =', util.add(2, 3));<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Try to read a safe file<br>
&nbsp;&nbsp;&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const content = fs.readFileSync('example.txt', 'utf8');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('File content:', content);<br>
&nbsp;&nbsp;&nbsp;&nbsp;} catch (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error('File read error:', err.message);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Try to access process (should fail)<br>
&nbsp;&nbsp;&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Process info:', process.version);<br>
&nbsp;&nbsp;&nbsp;&nbsp;} catch (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error('Cannot access process:', err.message);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;`, sandbox);<br>
} catch (err) {<br>
&nbsp;&nbsp;console.error('Sandbox execution failed:', err);<br>
}
</div>
</div>

<div class="w3-panel ws-warning">
<p><strong>Warning:</strong> While you can limit access to certain modules, this approach isn't completely secure. A determined attacker might still find ways to escape the sandbox. For truly secure sandboxing, consider additional isolation techniques or specialized libraries.</p>
</div>

<hr>

<h2>Building a Simple Template Engine</h2>

<p>The VM module can be used to create a simple template engine:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const vm = require('vm');<br>
<br>
function renderTemplate(template, data) {<br>
&nbsp;&nbsp;// Create template function - replace {{ let }} with values<br>
&nbsp;&nbsp;const templateScript = `<br>
&nbsp;&nbsp;&nbsp;&nbsp;function template(data) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;let output = \`${template.replace(/\{\{\s*(\w+)\s*\}\}/g, '${data.$1}')}\`;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return output;<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;template(data);<br>
&nbsp;&nbsp;`;<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Create a context with the data<br>
&nbsp;&nbsp;const context = { data };<br>
&nbsp;&nbsp;vm.createContext(context);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Execute the template function<br>
&nbsp;&nbsp;return vm.runInContext(templateScript, context);<br>
}<br>
<br>
// Example usage<br>
const template = `<br>
...
&nbsp;&nbsp;&lt;h1&gt;{{ title }}&lt;/h1&gt;<br>
&nbsp;&nbsp;&lt;p&gt;Welcome, {{ name }}!&lt;/p&gt;<br>
&nbsp;&nbsp;&lt;p&gt;Today is {{ date }}&lt;/p&gt;<br>
&lt;/body&gt;<br>
&lt;/html&gt;<br>
`;<br>
<br>
const data = {<br>
&nbsp;&nbsp;title: 'My Template Page',<br>
&nbsp;&nbsp;name: 'User',<br>
&nbsp;&nbsp;date: new Date().toLocaleDateString()<br>
};<br>
<br>
const rendered = renderTemplate(template, data);<br>
console.log(rendered);
</div>
</div>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> While this example demonstrates a simple use case, production template engines like Handlebars or EJS are more robust and secure. This example is vulnerable to injection attacks if user data isn't properly escaped.</p>
</div>

<hr>

<h2>Creating a Plugin System</h2>

<p>The VM module is useful for creating plugin systems where plugins can be loaded and executed in isolation:</p>
...
<br>
class PluginSystem {<br>
&nbsp;&nbsp;constructor() {<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.plugins = new Map();<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.api = {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;version: '1.0.0',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;registerHook: this.registerHook.bind(this),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;utils: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;add: (a, b) => a + b,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;multiply: (a, b) => a * b,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;formatDate: (date) => new Date(date).toLocaleDateString()<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;};<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.hooks = {<br>
...
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Register a plugin hook<br>
&nbsp;&nbsp;registerHook(hookName, callback) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (this.hooks[hookName]) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;this.hooks[hookName].push(callback);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Registered ${hookName} hook`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error(`Invalid hook name: ${hookName}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Load a plugin from file<br>
&nbsp;&nbsp;loadPlugin(pluginName, pluginCode) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Loading plugin: ${pluginName}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Create a sandbox for this plugin<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const sandbox = {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;log: (msg) => console.log(`[${pluginName}] ${msg}`),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;error: (msg) => console.error(`[${pluginName}] ${msg}`)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;},<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;setTimeout,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;clearTimeout,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;api: this.api<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;};<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Create context and run the plugin code<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const context = vm.createContext(sandbox);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;vm.runInContext(pluginCode, context);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Store the loaded plugin<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;this.plugins.set(pluginName, {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;name: pluginName,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;sandbox<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Successfully loaded plugin: ${pluginName}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;} catch (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error(`Error loading plugin ${pluginName}:`, err.message);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Run all hooks of a specific type<br>
&nbsp;&nbsp;async runHooks(hookName, data) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Running ${hookName} hooks...`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;for (const hook of this.hooks[hookName]) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const result = await hook(data);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Hook result:`, result);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;} catch (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error(`Error in ${hookName} hook:`, err.message);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Load all plugins from a directory<br>
&nbsp;&nbsp;loadPluginsFromDirectory(directory) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const files = fs.readdirSync(directory);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;for (const file of files) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (file.endsWith('.js')) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const pluginName = path.basename(file, '.js');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const pluginPath = path.join(directory, file);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const pluginCode = fs.readFileSync(pluginPath, 'utf8');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;this.loadPlugin(pluginName, pluginCode);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;} catch (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error('Error loading plugins directory:', err.message);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Run the plugin system<br>
&nbsp;&nbsp;async run(data) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;await this.runHooks('init', data);<br>
&nbsp;&nbsp;&nbsp;&nbsp;await this.runHooks('process', data);<br>
&nbsp;&nbsp;&nbsp;&nbsp;await this.runHooks('shutdown', data);<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
// Example plugin code (normally this would be in a separate file)<br>
const examplePlugin = `<br>
// Register initialization hook<br>
api.registerHook('init', async (data) => {<br>
&nbsp;&nbsp;console.log('Plugin initializing with data:', data);<br>
&nbsp;&nbsp;return 'Initialization complete';<br>
});<br>
<br>
// Register processing hook<br>
api.registerHook('process', async (data) => {<br>
&nbsp;&nbsp;console.log('Processing data');<br>
&nbsp;&nbsp;return {<br>
&nbsp;&nbsp;&nbsp;&nbsp;processed: true,<br>
&nbsp;&nbsp;&nbsp;&nbsp;sum: api.utils.add(data.x, data.y),<br>
&nbsp;&nbsp;&nbsp;&nbsp;product: api.utils.multiply(data.x, data.y),<br>
&nbsp;&nbsp;&nbsp;&nbsp;date: api.utils.formatDate(new Date())<br>
&nbsp;&nbsp;};<br>
});<br>
<br>
// Register shutdown hook<br>
api.registerHook('shutdown', async () => {<br>
&nbsp;&nbsp;console.log('Plugin shutting down');<br>
&nbsp;&nbsp;return 'Shutdown complete';<br>
});<br>
<br>
console.log('Plugin loaded with API version', api.version);<br>
`;<br>
<br>
// Create and run the plugin system<br>
(async () => {<br>
&nbsp;&nbsp;const system = new PluginSystem();<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Load plugins<br>
&nbsp;&nbsp;system.loadPlugin('example', examplePlugin);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// You could also load from a directory<br>
&nbsp;&nbsp;// system.loadPluginsFromDirectory('./plugins');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Run the system<br>
&nbsp;&nbsp;await system.run({ x: 5, y: 10 });<br>
})();
</div>
</div>
...
<ol>
  <li><strong>Don't rely solely on the VM module for security</strong>: Use additional security measures for untrusted code.</li>
  <li><strong>Limit resources</strong>: Set timeouts and memory limits for executed code.</li>
  <li><strong>Control access</strong>: Only provide necessary functionality to the sandbox.</li>
  <li><strong>Validate inputs</strong>: Carefully validate all inputs before processing them in a VM.</li>
  <li><strong>Consider process isolation</strong>: For highest security, run untrusted code in separate processes or containers.</li>
</ol>

<h3>Performance Best Practices</h3>
<ol>
  <li><strong>Compile scripts once</strong>: Use <code class="w3-codespan">new vm.Script()</code> for code that will be executed multiple times.</li>
  <li><strong>Reuse contexts</strong>: Creating new contexts is expensive, so reuse when possible.</li>
  <li><strong>Limit context size</strong>: Keep contexts small to improve performance.</li>
  <li><strong>Be cautious with large data</strong>: Passing large data structures between contexts can be inefficient.</li>
</ol>

<hr>

<h2>VM Module vs. eval()</h2>

<p>The VM module provides several advantages over using <code class="w3-codespan">eval()</code>:</p>
...
<table class="ws-table-all">
  ...
  <tr>
    <td>Access to local variables</td>
    <td>No (with runInThisContext)</td>
    <td>Yes</td>
  </tr>
  <tr>
    <td>Isolation</td>
    <td>Better (separate contexts)</td>
    <td>None (same context)</td>
  </tr>
  <tr>
    <td>Security</td>
    <td>Better (controlled context)</td>
    <td>Worse (can access everything)</td>
  </tr>
  <tr>
    <td>Performance for repeated execution</td>
    <td>Better (can pre-compile)</td>
    <td>Worse (compiles each time)</td>
  </tr>
  <tr>
    <td>Control over execution</td>
    <td>More (timeouts, etc.)</td>
    <td>Less</td>
  </tr>
</table>
</div>
...
<h2>Limitations of the VM Module</h2>

<ol>
  <li><strong>Not a complete sandbox</strong>: VM contexts don't provide true isolation like separate processes.</li>
  <li><strong>No CPU or memory limits</strong>: Cannot restrict resource usage directly (only timeout is available).</li>
  <li><strong>Prototype pollution risks</strong>: Code in VM contexts can still potentially modify JavaScript prototypes.</li>
  <li><strong>Synchronous execution</strong>: Running code blocks the event loop (unless you run it in a worker thread).</li>
  <li><strong>Debugging challenges</strong>: Debugging code running in VM contexts can be difficult.</li>
</ol>

<div class="w3-panel ws-warning">
<p><strong>Warning:</strong> For critical security applications, consider using more robust sandboxing solutions like separate processes with the <code class="w3-codespan">child_process</code> module, containers, or specialized libraries like <code class="w3-codespan">vm2</code>.</p>
</div>
...
<p>The Node.js VM module provides a way to execute JavaScript code in isolated V8 contexts. It's useful for:</p>

<ul>
  <li>Running code dynamically with some level of isolation</li>
  <li>Creating plugin systems that can be extended safely</li>
  <li>Building template engines and scripting environments</li>
  <li>Testing code in controlled contexts</li>
</ul>

<p>While not a complete security solution for running untrusted code, the VM module offers more isolation than <code class="w3-codespan">eval()</code> and is a valuable tool for JavaScript evaluation within Node.js applications.</p>

<hr>

<h2>Advanced Context Management</h2>
<p>Learn how to create and manage complex VM contexts with custom globals and modules:</p>

<h3>1. Creating a Custom Context with Global Variables</h3>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const vm = require('vm');<br>
const util = require('util');<br>
<br>
// Create a custom context with specific global variables<br>
const context = {<br>
&nbsp;&nbsp;console: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;log: (...args) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Custom console.log implementation<br>
...
&nbsp;&nbsp;},<br>
&nbsp;&nbsp;// Add custom utilities<br>
&nbsp;&nbsp;utils: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;formatDate: () => new Date().toISOString(),<br>
&nbsp;&nbsp;&nbsp;&nbsp;generateId: () => Math.random().toString(36).substr(2, 9)<br>
&nbsp;&nbsp;},<br>
&nbsp;&nbsp;// Add a safe require function<br>
&nbsp;&nbsp;require: (moduleName) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const allowedModules = ['path', 'url', 'util'];<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (!allowedModules.includes(moduleName)) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;throw new Error(`Module '${moduleName}' is not allowed`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;return require(moduleName);<br>
&nbsp;&nbsp;}<br>
};<br>
<br>
// Contextify the object<br>
vm.createContext(context);<br>
<br>
// Run code in the custom context<br>
const code = `<br>
&nbsp;&nbsp;console.log('Current time:', utils.formatDate());<br>
&nbsp;&nbsp;console.log('Generated ID:', utils.generateId());<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const fs = require('fs'); // This will throw an error<br>
&nbsp;&nbsp;} catch (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error('Security error:', err.message);<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// This will work as it's an allowed module<br>
&nbsp;&nbsp;const path = require('path');<br>
&nbsp;&nbsp;console.log('Current directory:', path.dirname('/path/to/file.txt'));<br>
`;<br>
<br>
try {<br>
&nbsp;&nbsp;vm.runInContext(code, context, { filename: 'custom-context.js' });<br>
} catch (err) {<br>
&nbsp;&nbsp;console.error('Script execution failed:', err);<br>
}
</div>
</div>

<h3>2. Module System in VM</h3>
<p>Implement a simple module system within a VM context:</p>
...
const path = require('path');<br>
<br>
class VMModuleSystem {<br>
&nbsp;&nbsp;constructor(basePath = '.') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.basePath = path.resolve(basePath);<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.cache = new Map();<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.context = vm.createContext({<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;module: { exports: {} },<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;exports: {},<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console: console,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;require: this.require.bind(this),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;__dirname: this.basePath,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;__filename: path.join(this.basePath, 'main.js')<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;require(modulePath) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Handle core modules<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (require.resolve.paths(modulePath) === null) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return require(modulePath);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Resolve the module path<br>
&nbsp;&nbsp;&nbsp;&nbsp;const resolvedPath = this.resolveModule(modulePath);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Check cache<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (this.cache.has(resolvedPath)) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return this.cache.get(resolvedPath).exports;<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Create new module<br>
&nbsp;&nbsp;&nbsp;&nbsp;const module = { exports: {} };<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.cache.set(resolvedPath, module);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Read and execute the module<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const code = fs.readFileSync(resolvedPath, 'utf8');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const wrapper = `(function(module, exports, require, __dirname, __filename) {${code}\n})`;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const script = new vm.Script(wrapper, {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;filename: resolvedPath,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;lineOffset: 0,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;displayErrors: true<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const localRequire = (path) => this.require(path);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;localRequire.resolve = (request) => this.resolveModule(request, resolvedPath);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;script.runInNewContext({<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;module: module,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;exports: module.exports,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;require: localRequire,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;__dirname: path.dirname(resolvedPath),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;__filename: resolvedPath<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return module.exports;<br>
&nbsp;&nbsp;&nbsp;&nbsp;} catch (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;this.cache.delete(resolvedPath);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;throw err;<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;resolveModule(request, parentPath) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Try to resolve as a file<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (request.startsWith('./') || request.startsWith('../')) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const resolved = path.resolve(path.dirname(parentPath || this.basePath), request);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Try with .js extension<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const stats = fs.statSync(resolved + '.js');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (stats.isFile()) return resolved + '.js';<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;} catch (e) {}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Try as directory with index.js<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const indexPath = path.join(resolved, 'index.js');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const stats = fs.statSync(indexPath);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (stats.isFile()) return indexPath;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;} catch (e) {}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Try as file without extension<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const stats = fs.statSync(resolved);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (stats.isFile()) return resolved;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;} catch (e) {}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Try to resolve as a module<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return require.resolve(request);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;} catch (e) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;throw new Error(`Cannot find module '${request}'`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;} catch (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;throw new Error(`Cannot find module '${request}': ${err.message}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;runFile(filePath) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const absolutePath = path.resolve(this.basePath, filePath);<br>
&nbsp;&nbsp;&nbsp;&nbsp;return this.require(absolutePath);<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
// Example usage<br>
const moduleSystem = new VMModuleSystem(__dirname);<br>
<br>
try {<br>
&nbsp;&nbsp;// This will execute the file in the VM with the custom module system<br>
&nbsp;&nbsp;moduleSystem.runFile('example-module.js');<br>
} catch (err) {<br>
&nbsp;&nbsp;console.error('Module execution failed:', err);<br>
}
</div>
</div>
...
<p>When using the VM module, security should be your top priority. Here are some best practices:</p>
...
<br>
// UNSAFE: Directly executing untrusted code<br>
function unsafeEval(code) {<br>
&nbsp;&nbsp;// This is dangerous as it has access to the entire Node.js environment<br>
&nbsp;&nbsp;return vm.runInThisContext(code);<br>
}<br>
<br>
// SAFER: Isolated context with limited access<br>
function safeEval(code, timeout = 1000) {<br>
&nbsp;&nbsp;// Create a context with only the necessary globals<br>
&nbsp;&nbsp;const context = {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;log: console.log,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;error: console.error<br>
&nbsp;&nbsp;&nbsp;&nbsp;},<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Add safe utilities<br>
&nbsp;&nbsp;&nbsp;&nbsp;Math: Object.create(null),<br>
&nbsp;&nbsp;&nbsp;&nbsp;JSON: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;parse: JSON.parse,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;stringify: JSON.stringify<br>
&nbsp;&nbsp;&nbsp;&nbsp;},<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Add a safe setTimeout with limits<br>
&nbsp;&nbsp;&nbsp;&nbsp;setTimeout: (fn, delay) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (delay > 1000) delay = 1000; // Cap delay at 1 second<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return setTimeout(fn, delay);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;};<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Copy safe methods from Math<br>
&nbsp;&nbsp;Object.getOwnPropertyNames(Math)<br>
&nbsp;&nbsp;&nbsp;&nbsp;.filter(prop => typeof Math[prop] === 'function')<br>
&nbsp;&nbsp;&nbsp;&nbsp;.forEach(prop => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;context.Math[prop] = Math[prop];<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Create the context without prototype access<br>
&nbsp;&nbsp;const sandbox = vm.createContext(context, {<br>
&nbsp;&nbsp;&nbsp;&nbsp;name: 'sandbox',<br>
&nbsp;&nbsp;&nbsp;&nbsp;codeGeneration: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;strings: false,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;wasm: false<br>
...
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Run the code with a timeout<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const script = new vm.Script(`<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(function() {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"use strict";<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${code}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;})();<br>
&nbsp;&nbsp;&nbsp;&nbsp;`, {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;filename: 'sandbox.js',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;lineOffset: 0,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;displayErrors: true,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;timeout: timeout,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;microtaskMode: 'afterEvaluate'<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;return script.runInContext(sandbox, { timeout });<br>
&nbsp;&nbsp;} catch (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error('Script execution failed:', err.message);<br>
&nbsp;&nbsp;&nbsp;&nbsp;throw new Error('Script execution failed');<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
// Example of safe evaluation<br>
try {<br>
&nbsp;&nbsp;const result = safeEval(`<br>
&nbsp;&nbsp;&nbsp;&nbsp;function add(a, b) { return a + b; }<br>
&nbsp;&nbsp;&nbsp;&nbsp;add(2, 3);<br>
&nbsp;&nbsp;`);<br>
&nbsp;&nbsp;console.log('Safe evaluation result:', result); // Outputs: 5<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// This will be caught by our safe evaluator<br>
&nbsp;&nbsp;safeEval('process.exit(1)');<br>
} catch (err) {<br>
&nbsp;&nbsp;console.error('Caught error:', err.message);<br>
}<br>
<br>
// Example of security risks<br>
console.log('\nTesting security risks:');<br>
<br>
try {<br>
&nbsp;&nbsp;console.log('1. Accessing process:');<br>
&nbsp;&nbsp;safeEval('process.versions.node');<br>
} catch (err) {<br>
&nbsp;&nbsp;console.log('✓ Blocked access to process object');<br>
}<br>
<br>
try {<br>
&nbsp;&nbsp;console.log('2. Infinite loop:');<br>
&nbsp;&nbsp;safeEval('while(true){}');<br>
} catch (err) {<br>
&nbsp;&nbsp;console.log('✓ Caught infinite loop with timeout');<br>
}<br>
<br>
try {<br>
&nbsp;&nbsp;console.log('3. Prototype pollution:');<br>
&nbsp;&nbsp;safeEval('({}).constructor.prototype.polluted = true');<br>
&nbsp;&nbsp;console.log('✓ Blocked prototype pollution');<br>
} catch (err) {<br>
&nbsp;&nbsp;console.log('✓ Blocked prototype pollution');<br>
}
</div>
...
<div class="w3-panel ws-note">
<p><strong>Important:</strong> The VM module is not a security boundary. For running truly untrusted code, consider using dedicated sandboxing solutions like Docker, AWS Lambda, or Google Cloud Functions.</p>
</div>
...
<p>Optimize VM performance with these techniques:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const vm = require('vm');<br>
const { performance, PerformanceObserver } = require('perf_hooks');<br>
<br>
// 1. Compile once, run many times<br>
const expensiveCalculation = new vm.Script(`<br>
&nbsp;&nbsp;function calculate(n) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;let result = 0;<br>
&nbsp;&nbsp;&nbsp;&nbsp;for (let i = 0; i &lt; n; i++) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;result += Math.sqrt(i) * Math.PI;<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;return result;<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Return the function reference<br>
&nbsp;&nbsp;calculate;<br>
`);<br>
<br>
// Create a context<br>
const context = { Math };<br>
vm.createContext(context);<br>
<br>
// Run once to get the function<br>
const calculate = expensiveCalculation.runInContext(context);<br>
<br>
// Now we can call the function multiple times without recompiling<br>
console.log('Result (n=1000):', calculate(1000));<br>
console.log('Result (n=2000):', calculate(2000));<br>
<br>
// 2. Use code caching for better performance<br>
const cache = new Map();<br>
<br>
function compileWithCache(code, filename) {<br>
&nbsp;&nbsp;if (cache.has(code)) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Using cached script for ${filename}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;return cache.get(code);<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;console.log(`Compiling script for ${filename}`);<br>
&nbsp;&nbsp;const script = new vm.Script(code, {<br>
&nbsp;&nbsp;&nbsp;&nbsp;filename,<br>
&nbsp;&nbsp;&nbsp;&nbsp;cachedData: null, // Will be populated on first run<br>
&nbsp;&nbsp;&nbsp;&nbsp;produceCachedData: true<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;cache.set(code, script);<br>
&nbsp;&nbsp;return script;<br>
}<br>
<br>
// 3. Measure performance<br>
function measurePerformance() {<br>
&nbsp;&nbsp;const obs = new PerformanceObserver((items) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const entry = items.getEntries()[0];<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`\nExecution time for ${entry.name}: ${entry.duration.toFixed(2)}ms`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;performance.clearMarks();<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;obs.observe({ entryTypes: ['measure'] });<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Test with different script sizes<br>
&nbsp;&nbsp;const smallScript = new vm.Script('let sum = 0; for (let i = 0; i &lt; 1000; i++) sum += i; return sum;');<br>
&nbsp;&nbsp;const largeScript = new vm.Script(`<br>
&nbsp;&nbsp;&nbsp;&nbsp;function processData(data) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return data.map(x => ({<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;...x,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;processed: true,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;timestamp: Date.now(),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;hash: require('crypto').createHash('md5').update(JSON.stringify(x)).digest('hex')<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}));<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Process sample data<br>
&nbsp;&nbsp;&nbsp;&nbsp;const data = Array(1000).fill(null).map((_, i) => ({ id: i, value: Math.random() }));<br>
&nbsp;&nbsp;&nbsp;&nbsp;return processData(data);<br>
&nbsp;&nbsp;`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Measure execution<br>
&nbsp;&nbsp;performance.mark('small-start');<br>
&nbsp;&nbsp;smallScript.runInThisContext();<br>
&nbsp;&nbsp;performance.mark('small-end');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;performance.mark('large-start');<br>
&nbsp;&nbsp;largeScript.runInThisContext();<br>
&nbsp;&nbsp;performance.mark('large-end');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;performance.measure('Small script execution', 'small-start', 'small-end');<br>
&nbsp;&nbsp;performance.measure('Large script execution', 'large-start', 'large-end');<br>
}<br>
<br>
// Run performance test<br>
measurePerformance();<br>
<br>
// 4. Reuse contexts for better performance<br>
function createOptimizedContext() {<br>
&nbsp;&nbsp;const context = {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Only include what's necessary<br>
&nbsp;&nbsp;&nbsp;&nbsp;console: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;log: console.log,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;error: console.error<br>
&nbsp;&nbsp;&nbsp;&nbsp;},<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Add required globals<br>
&nbsp;&nbsp;&nbsp;&nbsp;setTimeout,<br>
&nbsp;&nbsp;&nbsp;&nbsp;clearTimeout,<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Add custom utilities<br>
&nbsp;&nbsp;&nbsp;&nbsp;utils: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;formatNumber: n => new Intl.NumberFormat().format(n),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;formatDate: d => d.toISOString()<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;};<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Create context once<br>
&nbsp;&nbsp;vm.createContext(context);<br>
&nbsp;&nbsp;return context;<br>
}<br>
<br>
// Reuse the same context for multiple scripts<br>
const sharedContext = createOptimizedContext();<br>
<br>
// Run multiple scripts with the same context<br>
function runWithSharedContext(code) {<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const script = new vm.Script(code);<br>
&nbsp;&nbsp;&nbsp;&nbsp;return script.runInContext(sharedContext);<br>
&nbsp;&nbsp;} catch (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error('Script execution failed:', err);<br>
&nbsp;&nbsp;&nbsp;&nbsp;throw err;<br>
&nbsp;&nbsp;}<br>
...
<br>
// Example usage<br>
const script1 = 'console.log("Script 1:", utils.formatNumber(1234567.89));';<br>
const script2 = 'console.log("Script 2:", utils.formatDate(new Date()));';<br>
<br>
runWithSharedContext(script1);<br>
...
<ol>
  <li><strong>Pre-compile scripts</strong> when possible to avoid recompilation overhead</li>
  <li><strong>Reuse contexts</strong> instead of creating new ones for each execution</li>
  <li><strong>Minimize context size</strong> by only including necessary globals</li>
  <li><strong>Use code caching</strong> for frequently executed scripts</li>
  <li><strong>Monitor performance</strong> to identify bottlenecks</li>
  <li><strong>Consider worker threads</strong> for CPU-intensive operations</li>
</ol>
</div>
<hr>

<div id="exercisecontainer" src="xrcise_vm.js" data-extensions="asp"></div>
