...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js ReadStream Reference</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js ReadStream Reference">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/ref_readstream.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="A ReadStream lets you read data from a source such as a file or network connection in Node.js.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js ReadStream Reference">
<meta name="twitter:description" content="A ReadStream lets you read data from a source such as a file or network connection in Node.js.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/ref_readstream.png">
...
<h1>Node.js ReadStream Reference</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="ref_socket.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ref_writestream.asp">Next &#10095;</a>
</div>

<hr>

<h2>ReadStream Object</h2>

<p>A ReadStream is a stream that allows you to read data from a resource. Node.js provides ReadStream implementations for different use cases, such as reading from files (<code class="w3-codespan">fs.ReadStream</code>) or standard input (<code class="w3-codespan">process.stdin</code>).</p>

<p>ReadStreams implement the <code class="w3-codespan">stream.Readable</code> interface, which means they provide methods and events for reading data asynchronously, handling backpressure, and working with different stream modes (flowing/paused).</p>

<h3>Common ReadStream Types</h3>

<ul>
  <li><code class="w3-codespan">fs.ReadStream</code> - For reading from files</li>
  <li><code class="w3-codespan">process.stdin</code> - For reading from standard input</li>
  <li><code class="w3-codespan">net.Socket</code> (when reading) - For reading from network connections</li>
  <li><code class="w3-codespan">http.IncomingMessage</code> - For reading HTTP request bodies</li>
</ul>

<hr>

<h2>ReadStream Properties</h2>

<p>Here are the properties commonly available on Node.js ReadStream objects, primarily based on the <code class="w3-codespan">fs.ReadStream</code> implementation:</p>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td>readStream.bytesRead</td>
    <td>The number of bytes that have been read so far.</td>
  </tr>
  <tr>
    <td>readStream.path</td>
    <td>The file path that this ReadStream is reading from (<code class="w3-codespan">fs.ReadStream</code> only).</td>
  </tr>
  <tr>
    <td>readStream.pending</td>
    <td>If <code class="w3-codespan">true</code>, the underlying file has not been opened yet.</td>
  </tr>
  <tr>
    <td>readStream.readableHighWaterMark</td>
    <td>Returns the highWaterMark value for this ReadStream.</td>
  </tr>
  <tr>
    <td>readStream.readableLength</td>
    <td>Returns the number of bytes (or objects) in the read queue ready to be read.</td>
  </tr>
  <tr>
    <td>readStream.readableEnded</td>
    <td>Becomes <code class="w3-codespan">true</code> when the 'end' event is emitted.</td>
  </tr>
  <tr>
    <td>readStream.readableFlowing</td>
    <td>Indicates the state of the ReadStream (null, false, or true).</td>
  </tr>
  <tr>
    <td>readStream.destroyed</td>
...
<h2>ReadStream Methods</h2>

<p>Here are the most important methods available on ReadStream objects:</p>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td>readStream.read([size])</td>
    <td>Reads and returns data from the internal buffer. If no data is available, returns <code class="w3-codespan">null</code>. If <code class="w3-codespan">size</code> is specified, attempts to read that many bytes.</td>
  </tr>
  <tr>
    <td>readStream.pause()</td>
    <td>Pauses the reading of data, switching the stream out of flowing mode.</td>
  </tr>
  <tr>
    <td>readStream.resume()</td>
    <td>Resumes reading after a call to <code class="w3-codespan">pause()</code>, switching the stream into flowing mode.</td>
  </tr>
  <tr>
    <td>readStream.pipe(destination[, options])</td>
    <td>Attaches a Writable stream to the ReadStream, automatically managing the flow so that the destination will not be overwhelmed by a faster ReadStream.</td>
  </tr>
  <tr>
    <td>readStream.unpipe([destination])</td>
    <td>Detaches a Writable stream previously attached using <code class="w3-codespan">pipe()</code>.</td>
  </tr>
  <tr>
    <td>readStream.unshift(chunk[, encoding])</td>
    <td>Pushes a chunk of data back into the internal buffer, which will be returned by the next <code class="w3-codespan">read()</code> call.</td>
  </tr>
  <tr>
    <td>readStream.wrap(stream)</td>
    <td>Wraps an old-style readable stream as a new-style readable stream.</td>
  </tr>
  <tr>
    <td>readStream.destroy([error])</td>
    <td>Destroys the stream, and optionally emits an error event. After this call, the ReadStream is no longer usable.</td>
  </tr>
  <tr>
    <td>readStream.setEncoding(encoding)</td>
    <td>Sets the character encoding for data read from the stream. If set, the stream will decode the data to strings instead of <code class="w3-codespan">Buffer</code> objects.</td>
  </tr>
</table>

<hr>

<h2>ReadStream Events</h2>

<p>ReadStream objects emit the following events:</p>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td>'data'</td>
    <td>Emitted when data is available to be read from the stream. The data will be either a Buffer or a string, depending on the encoding set with <code class="w3-codespan">setEncoding()</code>.</td>
  </tr>
  <tr>
    <td>'end'</td>
    <td>Emitted when there is no more data to be consumed from the stream.</td>
  </tr>
  <tr>
    <td>'error'</td>
    <td>Emitted if an error occurred during reading. The stream is closed after this event.</td>
  </tr>
  <tr>
    <td>'open'</td>
    <td>Emitted when the underlying resource (e.g., file descriptor) has been opened (<code class="w3-codespan">fs.ReadStream</code> specific).</td>
  </tr>
  <tr>
    <td>'readable'</td>
    <td>Emitted when there is data available to be read from the stream or when the end of the stream has been reached.</td>
  </tr>
  <tr>
    <td>'ready'</td>
  ...
  <tr>
    <td>'pause'</td>
    <td>Emitted when the stream is paused.</td>
  </tr>
  <tr>
    <td>'resume'</td>
    <td>Emitted when the stream is resumed.</td>
  </tr>
</table>
...
<p>This example shows how to create a file ReadStream and read data from it:</p>
...
<br>
// Create a sample file for the example<br>
const sampleFile = path.join(__dirname, 'readstream-example.txt');<br>
fs.writeFileSync(sampleFile, 'This is a test file.\nIt has multiple lines.\nEach line has its own content.\nStreaming makes file reading efficient.');<br>
<br>
// Create a ReadStream to read from the file<br>
const readStream = fs.createReadStream(sampleFile, {<br>
&nbsp;&nbsp;// Options<br>
&nbsp;&nbsp;encoding: 'utf8',&nbsp;&nbsp;// Set the encoding (utf8, ascii, binary, etc.)<br>
&nbsp;&nbsp;highWaterMark: 64, // Buffer size in bytes<br>
&nbsp;&nbsp;autoClose: true&nbsp;&nbsp;&nbsp;&nbsp;// Automatically close the file descriptor when the stream ends<br>
});<br>
<br>
console.log('File ReadStream properties:');<br>
console.log(`- Path: ${readStream.path}`);<br>
console.log(`- Pending: ${readStream.pending}`);<br>
console.log(`- High Water Mark: ${readStream.readableHighWaterMark} bytes`);<br>
<br>
// Handle stream events<br>
readStream.on('open', (fd) => {<br>
&nbsp;&nbsp;console.log(`File opened with descriptor: ${fd}`);<br>
});<br>
<br>
readStream.on('ready', () => {<br>
&nbsp;&nbsp;console.log('ReadStream is ready');<br>
});<br>
<br>
// Handle data events<br>
readStream.on('data', (chunk) => {<br>
&nbsp;&nbsp;console.log('\nReceived chunk:');<br>
&nbsp;&nbsp;console.log('-'.repeat(20));<br>
&nbsp;&nbsp;console.log(chunk);<br>
&nbsp;&nbsp;console.log('-'.repeat(20));<br>
&nbsp;&nbsp;console.log(`Bytes read so far: ${readStream.bytesRead}`);<br>
});<br>
<br>
readStream.on('end', () => {<br>
&nbsp;&nbsp;console.log('\nReached end of file');<br>
&nbsp;&nbsp;console.log(`Total bytes read: ${readStream.bytesRead}`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Clean up the sample file<br>
&nbsp;&nbsp;fs.unlinkSync(sampleFile);<br>
&nbsp;&nbsp;console.log('Sample file removed');<br>
});<br>
<br>
readStream.on('close', () => {<br>
&nbsp;&nbsp;console.log('Stream closed');<br>
});<br>
<br>
readStream.on('error', (err) => {<br>
&nbsp;&nbsp;console.error(`Error: ${err.message}`);<br>
});
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_readstream_file">Run example &raquo;</a>
</div>

<hr>

<h2>Controlling Stream Flow</h2>

<p>This example demonstrates how to control the flow of data with <code class="w3-codespan">pause()</code> and <code class="w3-codespan">resume()</code>:</p>
...
const path = require('path');<br>
<br>
// Create a large sample file for the flow control example<br>
const flowFile = path.join(__dirname, 'flow-control-example.txt');<br>
let sampleContent = '';<br>
for (let i = 1; i &lt;= 1000; i++) {<br>
&nbsp;&nbsp;sampleContent += `This is line ${i} of the test file.\n`;<br>
}<br>
fs.writeFileSync(flowFile, sampleContent);<br>
<br>
// Create a ReadStream<br>
const readStream = fs.createReadStream(flowFile, {<br>
&nbsp;&nbsp;encoding: 'utf8',<br>
&nbsp;&nbsp;highWaterMark: 1024 // 1KB buffer<br>
});<br>
<br>
let chunkCount = 0;<br>
let totalBytes = 0;<br>
...
<br>
// Handle data chunks with flow control<br>
readStream.on('data', (chunk) => {<br>
&nbsp;&nbsp;chunkCount++;<br>
&nbsp;&nbsp;totalBytes += chunk.length;<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;console.log(`Chunk #${chunkCount} received, size: ${chunk.length} bytes`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Pause the stream every 5 chunks to demonstrate flow control<br>
&nbsp;&nbsp;if (chunkCount % 5 === 0 && !isPaused) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('\nPausing the stream for 1 second...');<br>
&nbsp;&nbsp;&nbsp;&nbsp;isPaused = true;<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Pause the stream<br>
&nbsp;&nbsp;&nbsp;&nbsp;readStream.pause();<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Resume after 1 second<br>
&nbsp;&nbsp;&nbsp;&nbsp;setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Resuming the stream...\n');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;isPaused = false;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;readStream.resume();<br>
&nbsp;&nbsp;&nbsp;&nbsp;}, 1000);<br>
&nbsp;&nbsp;}<br>
});<br>
<br>
readStream.on('end', () => {<br>
&nbsp;&nbsp;console.log(`\nFinished reading file. Received ${chunkCount} chunks, ${totalBytes} bytes total.`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Clean up the sample file<br>
&nbsp;&nbsp;fs.unlinkSync(flowFile);<br>
&nbsp;&nbsp;console.log('Sample file removed');<br>
});<br>
<br>
readStream.on('error', (err) => {<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_readstream_flow">Run example &raquo;</a>
</div>

<hr>

<h2>Using the read() Method</h2>

<p>This example demonstrates using the <code class="w3-codespan">read()</code> method in the 'readable' event:</p>
...
const readableFile = path.join(__dirname, 'readable-example.txt');<br>
fs.writeFileSync(readableFile, 'ABCDEFGHIJKLMNOPQRSTUVWXYZ'.repeat(100));<br>
<br>
// Create a ReadStream without auto-flowing<br>
const readStream = fs.createReadStream(readableFile, {<br>
&nbsp;&nbsp;highWaterMark: 32 // Small buffer to demonstrate multiple reads<br>
});<br>
<br>
console.log('Using the readable event and read() method:');<br>
<br>
// Using the 'readable' event for manual reading<br>
readStream.on('readable', () => {<br>
&nbsp;&nbsp;let chunk;<br>
&nbsp;&nbsp;// read() returns null when there is no more data to read<br>
&nbsp;&nbsp;while (null !== (chunk = readStream.read(16))) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Read ${chunk.length} bytes: ${chunk.toString('utf8').substring(0, 10)}...`);<br>
&nbsp;&nbsp;}<br>
});<br>
<br>
readStream.on('end', () => {<br>
&nbsp;&nbsp;console.log('End of stream reached');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Clean up the sample file<br>
&nbsp;&nbsp;fs.unlinkSync(readableFile);<br>
&nbsp;&nbsp;console.log('Sample file removed');<br>
});<br>
<br>
readStream.on('error', (err) => {<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_readstream_read">Run example &raquo;</a>
</div>

<hr>

<h2>Piping between Streams</h2>

<p>This example demonstrates how to use <code class="w3-codespan">pipe()</code> to send data from a ReadStream to a WriteStream:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const fs = require('fs');<br>
const path = require('path');<br>
const zlib = require('zlib');<br>
<br>
// Source and destination file paths<br>
const sourceFile = path.join(__dirname, 'pipe-source-example.txt');<br>
const destFile = path.join(__dirname, 'pipe-destination.txt');<br>
const compressedFile = path.join(__dirname, 'pipe-compressed.gz');<br>
<br>
// Create sample content<br>
fs.writeFileSync(sourceFile, 'This is the source content for the pipe example.\n'.repeat(100));<br>
<br>
// Create ReadStream and various WriteStreams<br>
const readStream = fs.createReadStream(sourceFile);<br>
const writeStream = fs.createWriteStream(destFile);<br>
const compressStream = zlib.createGzip(); // Compression transform stream<br>
const compressedWriteStream = fs.createWriteStream(compressedFile);<br>
<br>
// Pipe the ReadStream directly to the WriteStream<br>
readStream.pipe(writeStream);<br>
<br>
// Listen for completion events<br>
writeStream.on('finish', () => {<br>
&nbsp;&nbsp;console.log(`File copied from ${sourceFile} to ${destFile}`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Create a new ReadStream to demonstrate chained pipes<br>
&nbsp;&nbsp;const readStream2 = fs.createReadStream(sourceFile);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Chain multiple pipes: read -> compress -> write<br>
&nbsp;&nbsp;readStream2.pipe(compressStream).pipe(compressedWriteStream);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;compressedWriteStream.on('finish', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`File compressed from ${sourceFile} to ${compressedFile}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Compare file sizes<br>
&nbsp;&nbsp;&nbsp;&nbsp;const originalSize = fs.statSync(sourceFile).size;<br>
&nbsp;&nbsp;&nbsp;&nbsp;const compressedSize = fs.statSync(compressedFile).size;<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Original size: ${originalSize} bytes`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Compressed size: ${compressedSize} bytes`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Compression ratio: ${(compressedSize / originalSize * 100).toFixed(2)}%`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Clean up files after demonstration<br>
&nbsp;&nbsp;&nbsp;&nbsp;[sourceFile, destFile, compressedFile].forEach(file => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;fs.unlinkSync(file);<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('All sample files removed');<br>
&nbsp;&nbsp;});<br>
});<br>
<br>
// Handle errors<br>
readStream.on('error', (err) => console.error(`Read error: ${err.message}`));<br>
writeStream.on('error', (err) => console.error(`Write error: ${err.message}`));<br>
compressStream.on('error', (err) => console.error(`Compression error: ${err.message}`));<br>
compressedWriteStream.on('error', (err) => console.error(`Compressed write error: ${err.message}`));
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_readstream_pipe">Run example &raquo;</a>
</div>
...
<p>This example shows how to use the <code class="w3-codespan">process.stdin</code> ReadStream:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// process.stdin is a ReadStream<br>
<br>
console.log('Enter some text (press Ctrl+D or Ctrl+C to end input):');<br>
<br>
// Set the encoding to utf8 to get strings instead of Buffer objects<br>
process.stdin.setEncoding('utf8');<br>
<br>
let inputData = '';<br>
<br>
// Handle data from stdin<br>
process.stdin.on('data', (chunk) => {<br>
&nbsp;&nbsp;console.log(`Received chunk: "${chunk.trim()}"`);<br>
&nbsp;&nbsp;inputData += chunk;<br>
});<br>
<br>
// Handle the end of input<br>
process.stdin.on('end', () => {<br>
&nbsp;&nbsp;console.log('\nEnd of input.');<br>
&nbsp;&nbsp;console.log(`Total input received: ${inputData.length} characters`);<br>
&nbsp;&nbsp;console.log('You entered:');<br>
&nbsp;&nbsp;console.log('-'.repeat(20));<br>
&nbsp;&nbsp;console.log(inputData);<br>
&nbsp;&nbsp;console.log('-'.repeat(20));<br>
});<br>
<br>
// Handle Ctrl+C (SIGINT)<br>
process.on('SIGINT', () => {<br>
&nbsp;&nbsp;console.log('\nInput interrupted with Ctrl+C');<br>
&nbsp;&nbsp;process.exit();<br>
});<br>
<br>
// Note: This example requires user input in a terminal<br>
// Can't be effectively demonstrated in the W3Schools TryIt editor
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_readstream_stdin">Run example &raquo;</a>
</div>

<hr>

<h2>HTTP ReadStream Example</h2>

<p>This example shows how to use a ReadStream to handle HTTP request data:</p>
...
&nbsp;&nbsp;// req is an http.IncomingMessage, which is a ReadStream<br>
&nbsp;&nbsp;console.log(`Received ${req.method} request to ${req.url}`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Set response headers<br>
&nbsp;&nbsp;res.setHeader('Content-Type', 'text/plain');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Handle different types of requests<br>
&nbsp;&nbsp;if (req.method === 'GET') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.end('Send a POST request with a body to see the ReadStream in action');<br>
&nbsp;&nbsp;} <br>
&nbsp;&nbsp;else if (req.method === 'POST') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Set encoding for the request stream<br>
&nbsp;&nbsp;&nbsp;&nbsp;req.setEncoding('utf8');<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;let body = '';<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Handle data events from the request stream<br>
&nbsp;&nbsp;&nbsp;&nbsp;req.on('data', (chunk) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Received chunk of ${chunk.length} bytes`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;body += chunk;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Implement a simple flood protection<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (body.length > 1e6) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// If body is too large, destroy the stream<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;body = '';<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;res.writeHead(413, {'Content-Type': 'text/plain'});<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;res.end('Request entity too large');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;req.destroy();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Handle the end of the request stream<br>
&nbsp;&nbsp;&nbsp;&nbsp;req.on('end', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('End of request data');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Try to parse as JSON<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const data = JSON.parse(body);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Parsed JSON data:', data);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Send a response<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}));<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;} catch (e) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// If not valid JSON, just echo back the raw data<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Could not parse as JSON, treating as plain text');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
...
&nbsp;&nbsp;} <br>
&nbsp;&nbsp;else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// For other HTTP methods<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.writeHead(405, {'Content-Type': 'text/plain'});<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.end('Method not allowed');<br>
&nbsp;&nbsp;}<br>
});<br>
<br>
// Start the server<br>
...
&nbsp;&nbsp;console.log(`HTTP ReadStream example server running at http://localhost:${PORT}`);<br>
&nbsp;&nbsp;console.log('To test:');<br>
&nbsp;&nbsp;console.log(`1. Open http://localhost:${PORT} in a browser for GET request`);<br>
&nbsp;&nbsp;console.log(`2. Use curl or Postman to send POST requests with a body to http://localhost:${PORT}`);<br>
});<br>
<br>
// Note: To test with curl:<br>
// curl -X POST -H "Content-Type: application/json" -d '{"name":"John","age":30}' http://localhost:8080<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_readstream_http">Run example &raquo;</a>
</div>

<hr>

<h2>Error Handling with ReadStreams</h2>

<p>This example demonstrates proper error handling with ReadStreams:</p>
...
const path = require('path');<br>
<br>
// Function to create and handle a ReadStream with proper error handling<br>
function readWithErrorHandling(filePath) {<br>
&nbsp;&nbsp;console.log(`Attempting to read: ${filePath}`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Create the ReadStream<br>
&nbsp;&nbsp;const readStream = fs.createReadStream(filePath);<br>
&nbsp;&nbsp;<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;readStream.on('end', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Successfully read ${readStream.bytesRead} bytes from ${filePath}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;resolve(data);<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Handle errors<br>
&nbsp;&nbsp;&nbsp;&nbsp;readStream.on('error', (err) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error(`Error reading ${filePath}: ${err.message}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;reject(err);<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Handle stream closure (always happens, even if there's an error)<br>
&nbsp;&nbsp;&nbsp;&nbsp;readStream.on('close', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Stream for ${filePath} closed`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;});<br>
}<br>
<br>
// Test with both existing and non-existing files<br>
const existingFile = path.join(__dirname, 'test-existing.txt');<br>
const nonExistingFile = path.join(__dirname, 'non-existing-file.txt');<br>
<br>
// Create the test file<br>
fs.writeFileSync(existingFile, 'This is test content for error handling example');<br>
<br>
// Example 1: Reading an existing file<br>
console.log('Example 1: Reading an existing file');<br>
readWithErrorHandling(existingFile)<br>
&nbsp;&nbsp;.then(data => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('File content:', data);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Example 2: Reading a non-existing file<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('\nExample 2: Reading a non-existing file');<br>
&nbsp;&nbsp;&nbsp;&nbsp;return readWithErrorHandling(nonExistingFile);<br>
&nbsp;&nbsp;})<br>
&nbsp;&nbsp;.catch(err => {<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;if (fs.existsSync(existingFile)) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;fs.unlinkSync(existingFile);<br>
...
fs.writeFileSync(destroyTestFile, 'A'.repeat(10000));<br>
<br>
const destroyStream = fs.createReadStream(destroyTestFile);<br>
<br>
destroyStream.on('data', (chunk) => {<br>
&nbsp;&nbsp;console.log(`Received ${chunk.length} bytes before destroying the stream`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Destroy the stream after receiving the first chunk<br>
&nbsp;&nbsp;console.log('Deliberately destroying the stream');<br>
&nbsp;&nbsp;destroyStream.destroy(new Error('Stream manually destroyed'));<br>
});<br>
<br>
destroyStream.on('error', (err) => {<br>
&nbsp;&nbsp;console.error(`Destruction error: ${err.message}`);<br>
});<br>
<br>
destroyStream.on('close', () => {<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_readstream_error">Run example &raquo;</a>
</div>

<hr>

<h2>Best Practices for ReadStreams</h2>

<p>When working with ReadStreams in Node.js, consider these best practices:</p>

<ol>
  <li><strong>Always handle errors</strong>: Always listen for and handle 'error' events from ReadStreams to prevent unhandled exceptions.</li>
  <li><strong>Clean up resources</strong>: Ensure streams are properly closed or destroyed when no longer needed.</li>
  <li><strong>Use pipe() for most cases</strong>: The <code class="w3-codespan">pipe()</code> method automatically handles backpressure and is typically the best way to connect streams.</li>
  <li><strong>Set appropriate buffer sizes</strong>: Use the <code class="w3-codespan">highWaterMark</code> option to control memory usage, especially for large files.</li>
  <li><strong>Choose the right mode</strong>: Understand the difference between flowing and paused modes, and use the appropriate one for your use case.</li>
  <li><strong>Consider encoding</strong>: Set the appropriate encoding with <code class="w3-codespan">setEncoding()</code> if you're working with text.</li>
  <li><strong>Use stream.finished()</strong>: For cleanup, consider using <code class="w3-codespan">stream.finished()</code> from the <code class="w3-codespan">stream</code> module to detect when a stream is no longer readable, writable or has experienced an error or premature close.</li>
  <li><strong>Avoid reading entire files into memory</strong>: Use streams instead of methods like <code class="w3-codespan">fs.readFile()</code> for large files to avoid memory issues.</li>
</ol>
