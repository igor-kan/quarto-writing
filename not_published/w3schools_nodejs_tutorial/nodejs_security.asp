...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Security</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js Security">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_security.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="Security is critically important for Node.js applications for several reasons.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Security">
<meta name="twitter:description" content="Security is critically important for Node.js applications for several reasons.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_security.png">
...
<h1>Node.js <span class="color_h1">Security</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_ci_cd.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="nodejs_deployment_modern.asp">Next &#10095;</a>
</div>
<hr>

<h2>Why Security Matters in Node.js</h2>
<p>Security is critically important for Node.js applications for several reasons:</p>
<ul>
  <li><b>JavaScript Ecosystem Size:</b> The npm registry contains over 1.5 million packages, making it difficult to verify the security of all dependencies</li>
  <li><b>Server-Side Execution:</b> Unlike client-side JavaScript, Node.js has access to file systems, networks, and other sensitive resources</li>
  <li><b>Default Permissiveness:</b> Node.js has few security restrictions by default, making secure coding practices essential</li>
  <li><b>Event-Driven Architecture:</b> Asynchronous operations can create complex execution flows that may hide security flaws</li>
</ul>

<p>When Node.js applications are compromised, attackers might:</p>
<ul>
  <li>Access sensitive user data</li>
  <li>Manipulate application behavior</li>
  <li>Use your server for cryptocurrency mining</li>
  <li>Launch attacks against other systems</li>
  <li>Damage your organization's reputation</li>
</ul>
<hr>

<h2>Common Security Vulnerabilities in Node.js</h2>
...
<table class="ws-table-all">
  ...
  <tr>
    ...
    <td>Inserting malicious code into inputs processed by the application (SQL, NoSQL, OS commands)</td>
    <td>Data theft, unauthorized access, service disruption</td>
  </tr>
  <tr>
    <td><strong>Cross-Site Scripting (XSS)</strong></td>
    <td>Injecting client-side scripts into web pages viewed by other users</td>
    <td>Session hijacking, credential theft, defacement</td>
  </tr>
  <tr>
    <td><strong>Broken Authentication</strong></td>
    <td>Flaws in authentication mechanisms that allow credential compromise</td>
    <td>Account takeover, privilege escalation</td>
  </tr>
  <tr>
    <td><strong>Insecure Dependencies</strong></td>
    <td>Using third-party packages with known vulnerabilities</td>
    <td>Inheriting all vulnerabilities from dependencies</td>
  </tr>
  <tr>
    <td><strong>Information Exposure</strong></td>
    <td>Leaking sensitive data through error messages, logs, or responses</td>
    <td>System information disclosure, data leakage</td>
  </tr>
  <tr>
    <td><strong>Cross-Site Request Forgery</strong></td>
    <td>Tricking users into making unwanted actions on a web application they're authenticated to</td>
    <td>Performing unauthorized operations on behalf of users</td>
  </tr>
  <tr>
    <td><strong>Security Misconfiguration</strong></td>
    <td>Improper configuration of security settings in Node.js applications</td>
    <td>Various security gaps and vulnerabilities</td>
  </tr>
  <tr>
    <td><strong>Path Traversal</strong></td>
    <td>Accessing files and directories outside of intended application paths</td>
    <td>Unauthorized file access, code execution</td>
  </tr>
</table>
</div>
...
<p>Never trust user input. Always validate and sanitize all data that comes from outside your application.</p>

<div class="w3-example">
<h4>Example: Input Validation with Express-Validator</h4>
<div class="w3-code notranslate jsHigh">
const express = require('express');<br>
const { body, validationResult } = require('express-validator');<br>
const app = express();<br>
<br>
app.use(express.json());<br>
<br>
// Define validation rules<br>
const userValidationRules = [<br>
&nbsp;&nbsp;body('email').isEmail().normalizeEmail(),<br>
&nbsp;&nbsp;body('password').isLength({ min: 8 }),<br>
&nbsp;&nbsp;body('age').isInt({ min: 18 }).toInt(),<br>
&nbsp;&nbsp;body('name').trim().escape().notEmpty()<br>
];<br>
<br>
// Apply validation<br>
app.post('/register', userValidationRules, (req, res) => {<br>
...
&nbsp;&nbsp;}<br>
<br>
&nbsp;&nbsp;// Process validated data<br>
&nbsp;&nbsp;const { email, password, age, name } = req.body;<br>
&nbsp;&nbsp;// ... safe to use validated data<br>
<br>
&nbsp;&nbsp;res.status(201).json({ message: 'User registered successfully' });<br>
});</div>
</div>

<h3>2. Protection Against Injection Attacks</h3>
<p>Prevent SQL, NoSQL, command injection, and similar attacks by using parameterized queries and avoiding direct concatenation of user input.</p>

<div class="w3-example">
<h4>Example: SQL Injection Prevention</h4>
<div class="w3-code notranslate jsHigh">
// VULNERABLE - DO NOT USE<br>
function searchUsersUnsafe(name) {<br>
&nbsp;&nbsp;// Direct string concatenation - VULNERABLE TO INJECTION<br>
&nbsp;&nbsp;return db.query(`SELECT * FROM users WHERE name LIKE '%${name}%'`);<br>
}<br>
<br>
// SAFE - USE THIS APPROACH<br>
function searchUsersSafe(name) {<br>
&nbsp;&nbsp;// Parameterized query - PROTECTED AGAINST INJECTION<br>
&nbsp;&nbsp;return db.query('SELECT * FROM users WHERE name LIKE ?', [`%${name}%`]);<br>
}</div>
</div>

<h3>3. Cross-Site Scripting (XSS) Prevention</h3>
<p>Protect against XSS by properly encoding output and using Content Security Policy (CSP).</p>

<div class="w3-example">
<h4>Example: XSS Prevention</h4>
<div class="w3-code notranslate jsHigh">
const express = require('express');<br>
const app = express();<br>
<br>
// VULNERABLE - Direct insertion of user input into HTML<br>
app.get('/unsafe', (req, res) => {<br>
&nbsp;&nbsp;const userInput = req.query.message || '';<br>
&nbsp;&nbsp;res.send(`&lt;div&gt;Your message: ${userInput}&lt;/div&gt;`);<br>
});<br>
<br>
// SAFE - Encoding user input<br>
app.get('/safe', (req, res) => {<br>
&nbsp;&nbsp;const userInput = req.query.message || '';<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Encode HTML special characters<br>
&nbsp;&nbsp;const safeInput = userInput<br>
&nbsp;&nbsp;&nbsp;&nbsp;.replace(/&/g, '&amp;')<br>
&nbsp;&nbsp;&nbsp;&nbsp;.replace(/&lt;/g, '&lt;')<br>
&nbsp;&nbsp;&nbsp;&nbsp;.replace(/>/g, '&gt;')<br>
&nbsp;&nbsp;&nbsp;&nbsp;.replace(/"/g, '&quot;')<br>
&nbsp;&nbsp;&nbsp;&nbsp;.replace(/'/g, '&#039;');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;res.send(`&lt;div&gt;Your message: ${safeInput}&lt;/div&gt;`);<br>
});</div>
</div>

<h3>4. Keep Dependencies Up-to-Date</h3>
<p>Regularly check for and update vulnerable dependencies using <code class="w3-codespan">npm audit</code> and other security tools.</p>

<div class="w3-example">
<h4>Checking for Vulnerabilities</h4>
<div class="w3-code notranslate w3-black">
# Check for vulnerable dependencies<br>
npm audit<br>
<br>
# Automatically fix vulnerabilities when possible<br>
npm audit fix<br>
<br>
# Check for vulnerable dependencies in production only<br>
npm audit --production<br>
<br>
# Generate a detailed report<br>
npm audit --json > audit-report.json</div>
</div>

<h3>5. Secure Authentication Practices</h3>
<p>Implement authentication securely with proper password hashing, account lockouts, and multi-factor authentication.</p>

<div class="w3-example">
<h4>Example: Secure Password Hashing</h4>
<div class="w3-code notranslate jsHigh">
...
<br>
// Hash password with PBKDF2<br>
function hashPassword(password, salt) {<br>
&nbsp;&nbsp;return crypto.pbkdf2Sync(password, salt, 10000, 64, 'sha512').toString('hex');<br>
}<br>
<br>
// Register a new user with secure password storage<br>
function registerUser(username, password) {<br>
&nbsp;&nbsp;// Generate unique salt for this user<br>
&nbsp;&nbsp;const salt = generateSalt();<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Hash the password with the salt<br>
&nbsp;&nbsp;const hashedPassword = hashPassword(password, salt);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Store username, hashedPassword, and salt in database<br>
&nbsp;&nbsp;// NEVER store plaintext passwords<br>
&nbsp;&nbsp;return { username, hashedPassword, salt };<br>
}<br>
<br>
// Verify a login attempt<br>
function verifyUser(username, password, storedHash, storedSalt) {<br>
&nbsp;&nbsp;// Hash the provided password with the stored salt<br>
&nbsp;&nbsp;const hashedAttempt = hashPassword(password, storedSalt);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Time-constant comparison to prevent timing attacks<br>
&nbsp;&nbsp;return crypto.timingSafeEqual(<br>
&nbsp;&nbsp;&nbsp;&nbsp;Buffer.from(hashedAttempt, 'hex'),<br>
&nbsp;&nbsp;&nbsp;&nbsp;Buffer.from(storedHash, 'hex')<br>
&nbsp;&nbsp;);<br>
}</div>
</div>

<h3>6. Use Security Headers</h3>
<p>Implement HTTP security headers to protect against various attacks. Use packages like Helmet.js to simplify this.</p>

<div class="w3-example">
<h4>Example: Using Helmet.js</h4>
<div class="w3-code notranslate jsHigh">
const express = require('express');<br>
const helmet = require('helmet');<br>
const app = express();<br>
<br>
// Apply all security headers with default settings<br>
app.use(helmet());<br>
<br>
// Or customize specific headers<br>
app.use(helmet({<br>
&nbsp;&nbsp;contentSecurityPolicy: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;directives: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;defaultSrc: ["'self'"],<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;scriptSrc: ["'self'", "'unsafe-inline'", 'trusted-cdn.com']<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;},<br>
&nbsp;&nbsp;// Prevent clickjacking<br>
&nbsp;&nbsp;frameguard: { action: 'deny' },<br>
&nbsp;&nbsp;// Strict-Transport-Security<br>
&nbsp;&nbsp;hsts: { maxAge: 15552000, includeSubDomains: true }<br>
}));</div>
</div>

<h3>7. Use HTTPS</h3>
<p>Always use HTTPS in production environments to encrypt data in transit.</p>

<div class="w3-example">
<h4>Example: Setting up HTTPS in Express</h4>
<div class="w3-code notranslate jsHigh">
...
const app = express();<br>
<br>
// Your Express routes here<br>
app.get('/', (req, res) => {<br>
&nbsp;&nbsp;res.send('Secure HTTPS Server');<br>
});<br>
<br>
...
&nbsp;&nbsp;// Modern, secure TLS options<br>
&nbsp;&nbsp;minVersion: 'TLSv1.2',<br>
&nbsp;&nbsp;ciphers: 'ECDHE-RSA-AES128-GCM-SHA256:ECDHE-ECDSA-AES128-GCM-SHA256'<br>
};<br>
<br>
...
<h3>8. Protect Sensitive Data</h3>
<p>Store sensitive data securely using environment variables and dedicated secret management solutions.</p>

<div class="w3-example">
<h4>Example: Using Environment Variables</h4>
<div class="w3-code notranslate jsHigh">
// Load environment variables from .env file in development<br>
if (process.env.NODE_ENV !== 'production') {<br>
&nbsp;&nbsp;require('dotenv').config();<br>
}<br>
<br>
// Access environment variables<br>
const dbConnection = {<br>
&nbsp;&nbsp;host: process.env.DB_HOST,<br>
&nbsp;&nbsp;username: process.env.DB_USER,<br>
&nbsp;&nbsp;password: process.env.DB_PASSWORD,<br>
&nbsp;&nbsp;database: process.env.DB_NAME<br>
};<br>
<br>
// Never log sensitive information<br>
console.log('Connected to database:', dbConnection.host);<br>
// DON'T DO THIS: console.log('Database connection:', dbConnection);</div>
</div>

<div class="w3-panel ws-warning">
  <p><strong>Important:</strong> Never commit sensitive data to version control. Use <code class="w3-codespan">.gitignore</code> to exclude <code class="w3-codespan">.env</code> files.</p>
</div>
<hr>

<h2>Dependency Vulnerability Management</h2>
<p>Node.js applications typically have numerous dependencies, each potentially introducing security vulnerabilities.</p>
<p>Proper dependency management is essential for maintaining application security.</p>

<h3>Using npm audit</h3>
<p>The <code class="w3-codespan">npm audit</code> command scans your dependency tree and identifies packages with known vulnerabilities:</p>

<div class="w3-example">
<div class="w3-code notranslate w3-black">
# Run a basic audit<br>
npm audit<br>
<br>
# Fix vulnerabilities automatically (when possible)<br>
npm audit fix<br>
<br>
# Fix vulnerabilities that might require major version updates<br>
npm audit fix --force</div>
</div>

<div class="w3-panel ws-info">
<p>The output of <code class="w3-codespan">npm audit</code> includes:</p>
<ul>
  <li>Vulnerability severity (low, moderate, high, critical)</li>
  <li>Affected package and vulnerable version range</li>
  <li>Description of the vulnerability</li>
  <li>Path to the vulnerable dependency</li>
  <li>Recommended actions to fix the issue</li>
</ul>
</div>

<h3>Vulnerability Prevention Strategies</h3>
<ul>
  <li><strong>Lock Dependencies:</strong> Use package-lock.json or yarn.lock to lock dependency versions</li>
  <li><strong>Set Minimum Versions:</strong> Use version ranges with minimum bounds (e.g., <code class="w3-codespan">"express": "^4.17.1"</code>)</li>
  <li><strong>Automated Scanning:</strong> Integrate security scanning into your CI/CD pipeline</li>
  <li><strong>Consider Alternatives:</strong> For problematic packages, research alternatives with better security records</li>
</ul>
...
<table class="ws-table-all">
  ...
  <tr>
    ...
    <td>Scans dependencies, provides automated fix PRs, and monitors applications continuously</td>
  </tr>
  <tr>
    <td><strong>SonarQube</strong></td>
    <td>Detects vulnerabilities, code smells, and maintainability issues in your code</td>
  </tr>
  <tr>
  ...
  <tr>
    <td><strong>WhiteSource Bolt</strong></td>
    <td>Continuous security and compliance for open source components</td>
  </tr>
</table>
</div>
<hr>
...
<h3>Rate Limiting</h3>
<p>Protect your API from abuse or brute force attacks by implementing rate limiting:</p>

<div class="w3-example">
<h4>Example: Rate Limiting with Express-Rate-Limit</h4>
<div class="w3-code notranslate jsHigh">
const express = require('express');<br>
const rateLimit = require('express-rate-limit');<br>
const app = express();<br>
<br>
// Basic rate limiter: max 100 requests per 15 minutes per IP<br>
...
<br>
// Apply rate limiting to all requests<br>
app.use(limiter);<br>
<br>
// Or apply to specific routes<br>
const loginLimiter = rateLimit({<br>
&nbsp;&nbsp;windowMs: 60 * 60 * 1000, // 1 hour<br>
&nbsp;&nbsp;max: 5, // 5 failed attempts per hour<br>
&nbsp;&nbsp;message: 'Too many login attempts, please try again after an hour'<br>
});<br>
<br>
...
<p>Prevent Cross-Site Request Forgery attacks by implementing CSRF tokens:</p>

<div class="w3-example">
<h4>Example: CSRF Protection with csurf</h4>
<div class="w3-code notranslate jsHigh">
const express = require('express');<br>
...
<br>
// Initialize CSRF protection<br>
const csrfProtection = csrf({ cookie: true });<br>
<br>
// Form display route with CSRF token<br>
app.get('/form', csrfProtection, (req, res) => {<br>
&nbsp;&nbsp;res.send(`<br>
...
<br>
// Form submission route with CSRF validation<br>
app.post('/process', csrfProtection, (req, res) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// If we get here, CSRF token was valid<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.send('Data processed successfully');<br>
});<br>
<br>
// CSRF errors will be caught here<br>
app.use((err, req, res, next) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp; if (err.code === 'EBADCSRFTOKEN') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Handle CSRF token errors<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; res.status(403).send('CSRF token validation failed');<br>
&nbsp;&nbsp;&nbsp;&nbsp; } else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; next(err);<br>
&nbsp;&nbsp;&nbsp;&nbsp; }<br>
});</div>
...
<p>CSP helps prevent XSS and data injection attacks by controlling which resources can be loaded by the browser:</p>

<div class="w3-example">
<h4>Example: Setting Up CSP</h4>
<div class="w3-code notranslate jsHigh">
const express = require('express');<br>
const helmet = require('helmet');<br>
const app = express();<br>
<br>
// Detailed CSP configuration<br>
app.use(helmet.contentSecurityPolicy({<br>
&nbsp;&nbsp;directives: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;defaultSrc: ["'self'"],  // Only allow resources from same origin<br>
&nbsp;&nbsp;&nbsp;&nbsp;scriptSrc: ["'self'", "'unsafe-inline'", 'trusted-cdn.com'],<br>
&nbsp;&nbsp;&nbsp;&nbsp;styleSrc: ["'self'", "'unsafe-inline'", 'trusted-cdn.com'],<br>
&nbsp;&nbsp;&nbsp;&nbsp;imgSrc: ["'self'", 'data:', 'trusted-cdn.com', 'another-trusted-cdn.com'],<br>
&nbsp;&nbsp;&nbsp;&nbsp;connectSrc: ["'self'", 'api.example.com'], // API endpoints<br>
&nbsp;&nbsp;&nbsp;&nbsp;fontSrc: ["'self'", 'fonts.googleapis.com', 'fonts.gstatic.com'],<br>
&nbsp;&nbsp;&nbsp;&nbsp;objectSrc: ["'none'"],  // Prevent object, embed, and applet elements<br>
&nbsp;&nbsp;&nbsp;&nbsp;mediaSrc: ["'self'"],   // Audio and video sources<br>
&nbsp;&nbsp;&nbsp;&nbsp;frameSrc: ["'self'"],   // Frames<br>
&nbsp;&nbsp;&nbsp;&nbsp;sandbox: ['allow-forms', 'allow-scripts', 'allow-same-origin'],<br>
&nbsp;&nbsp;&nbsp;&nbsp;reportUri: '/csp-violation-report'<br>
&nbsp;&nbsp;}<br>
}));<br>
<br>
// Route to handle CSP violation reports<br>
app.post('/csp-violation-report', (req, res) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Log CSP violations<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('CSP Violation:', req.body);<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.status(204).end();<br>
});</div>
</div>

<h3>Security Logging and Monitoring</h3>
<p>Implement comprehensive logging to detect and respond to security incidents:</p>

<div class="w3-example">
<h4>Example: Security Logging with Winston</h4>
<div class="w3-code notranslate jsHigh">
const winston = require('winston');<br>
const express = require('express');<br>
const app = express();<br>
<br>
// Create a security logger<br>
const securityLogger = winston.createLogger({<br>
&nbsp;&nbsp;level: 'info',<br>
&nbsp;&nbsp;format: winston.format.combine(<br>
&nbsp;&nbsp;&nbsp;&nbsp;winston.format.timestamp(),<br>
&nbsp;&nbsp;&nbsp;&nbsp;winston.format.json()<br>
&nbsp;&nbsp;),<br>
&nbsp;&nbsp;defaultMeta: { service: 'security-service' },<br>
&nbsp;&nbsp;transports: [<br>
&nbsp;&nbsp;&nbsp;&nbsp;new winston.transports.File({ filename: 'security-events.log' })<br>
&nbsp;&nbsp;]<br>
});<br>
<br>
// Log authentication attempts<br>
app.post('/login', (req, res) => {<br>
&nbsp;&nbsp;const { username } = req.body;<br>
&nbsp;&nbsp;const ip = req.ip;<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Authentication logic here...<br>
&nbsp;&nbsp;const success = true; // Replace with actual auth logic<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Log the authentication attempt<br>
&nbsp;&nbsp;securityLogger.info({<br>
&nbsp;&nbsp;&nbsp;&nbsp;event: 'authentication_attempt',<br>
&nbsp;&nbsp;&nbsp;&nbsp;username,<br>
&nbsp;&nbsp;&nbsp;&nbsp;ip,<br>
&nbsp;&nbsp;&nbsp;&nbsp;success,<br>
...
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Continue with login response...<br>
});<br>
<br>
// Log access to sensitive resources<br>
app.get('/admin', (req, res) => {<br>
&nbsp;&nbsp;securityLogger.info({<br>
&nbsp;&nbsp;&nbsp;&nbsp;event: 'admin_access',<br>
&nbsp;&nbsp;&nbsp;&nbsp;user: req.user?.id,<br>
&nbsp;&nbsp;&nbsp;&nbsp;ip: req.ip,<br>
...
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Continue with admin page response...<br>
});</div>
</div>
<hr>
<h2>Secure Development Lifecycle (SDLC)</h2>

<p>Building secure Node.js applications requires integrating security throughout the entire development process.</p>
<p>Follow these SDLC best practices:</p>

<div class="w3-row-padding">
  <div class="w3-half">
    <h3>1. Requirements & Design Phase</h3>
    <ul>
      <li>Define security requirements and compliance needs</li>
      <li>Perform threat modeling to identify potential risks</li>
      <li>Design with security principles in mind (least privilege, defense in depth)</li>
      <li>Choose secure frameworks and libraries</li>
    </ul>
  </div>
  <div class="w3-half">
    <h3>2. Development Phase</h3>
    <ul>
      <li>Use secure coding standards and linters</li>
...
<div class="w3-row-padding">
  <div class="w3-half">
    ...
    <ul>
      <li>Conduct static application security testing (SAST)</li>
      <li>Perform dynamic application security testing (DAST)</li>
      <li>Run dependency vulnerability scans</li>
  ...
  <div class="w3-half">
    ...
    <ul>
      <li>Use secure configuration management</li>
...
<h3>Example: Secure Development Checklist</h3>

<div class="w3-example">
<div class="w3-code notranslate">
// package.json example with security-related scripts<br>
{<br>
&nbsp;&nbsp;"name": "secure-node-app",<br>
&nbsp;&nbsp;"version": "1.0.0",<br>
&nbsp;&nbsp;"scripts": {<br>
&nbsp;&nbsp;&nbsp;&nbsp;"start": "node app.js",<br>
&nbsp;&nbsp;&nbsp;&nbsp;"test": "jest",<br>
&nbsp;&nbsp;&nbsp;&nbsp;"lint": "eslint . --ext .js",<br>
&nbsp;&nbsp;&nbsp;&nbsp;"audit": "npm audit --production --audit-level=high",<br>
&nbsp;&nbsp;&nbsp;&nbsp;"check-vuln": "npx snyk test",<br>
&nbsp;&nbsp;&nbsp;&nbsp;"security-check": "npm-run-all --parallel lint audit check-vuln",<br>
&nbsp;&nbsp;&nbsp;&nbsp;"precommit": "npm run security-check"<br>
&nbsp;&nbsp;},<br>
&nbsp;&nbsp;"dependencies": {<br>
...
&nbsp;&nbsp;"devDependencies": {<br>
&nbsp;&nbsp;&nbsp;&nbsp;"eslint": "^8.0.0",<br>
&nbsp;&nbsp;&nbsp;&nbsp;"eslint-plugin-security": "^1.5.0",<br>
&nbsp;&nbsp;&nbsp;&nbsp;"jest": "^29.0.0",<br>
&nbsp;&nbsp;&nbsp;&nbsp;"npm-run-all": "^4.1.5",<br>
&nbsp;&nbsp;&nbsp;&nbsp;"snyk": "^1.1000.0"<br>
&nbsp;&nbsp;},<br>
&nbsp;&nbsp;"husky": {<br>
&nbsp;&nbsp;&nbsp;&nbsp;"hooks": {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"pre-commit": "npm run security-check"<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>
}</div>
</div>
...
<div class="w3-panel ws-note">
  <p><strong>Tip:</strong> Integrate security checks into your CI/CD pipeline to automatically catch security issues before they reach production.</p>
</div>

<hr>
<h2>Summary</h2>
<p>Security is a continuous process, not a one-time implementation.</p>
<p>Follow these best practices to protect your Node.js applications:</p>

<ul>
  <li>Validate and sanitize all input</li>
  <li>Protect against common attacks (XSS, CSRF, injections)</li>
  <li>Keep dependencies updated and regularly audit them</li>
  <li>Implement secure authentication and session management</li>
  <li>Use HTTPS and proper security headers</li>
  <li>Store sensitive data securely</li>
  <li>Implement rate limiting and monitoring</li>
  <li>Follow established security guidelines (OWASP)</li>
</ul>

<p>Remember that security is only as strong as the weakest link in your application.</p>
<p>Regular security reviews and penetration testing are recommended for all production applications.</p>
<hr>
<div id="exercisecontainer" src="xrcise_security.js" data-extensions="asp"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_ci_cd.asp">&#10094; Previous</a>
