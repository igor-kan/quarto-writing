...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Interface Reference</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js Interface Reference">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/ref_interface.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="The Interface class in the readline module reads data from a stream like process.stdin one line at a time.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Interface Reference">
<meta name="twitter:description" content="The Interface class in the readline module reads data from a stream like process.stdin one line at a time.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/ref_interface.png">
...
<h1>Node.js Interface Reference</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="ref_message.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="nodejs_compiler.asp">Next &#10095;</a>
</div>
...
<p>The <code class="w3-codespan">Interface</code> class is part of the <code class="w3-codespan">readline</code> module in Node.js. It provides a way to read data from a Readable stream (such as <code class="w3-codespan">process.stdin</code>) one line at a time. It's commonly used for creating command-line interfaces (CLIs) and interactive prompts.</p>

<h3>Importing the readline Module</h3>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// Import the readline module<br>
const readline = require('readline');<br>
<br>
// Create an Interface instance<br>
const rl = readline.createInterface({<br>
&nbsp;&nbsp;input: process.stdin,<br>
&nbsp;&nbsp;output: process.stdout<br>
});
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trynodejs.asp?filename=demo_ref_interface_import">Try it Yourself &raquo;</a>
</div>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td>rl.line</td>
    <td>The current input line being processed.</td>
  </tr>
  <tr>
    <td>rl.cursor</td>
    <td>The cursor position in the current line.</td>
  </tr>
  <tr>
    <td>rl.input</td>
    <td>The Readable stream being used.</td>
  </tr>
  <tr>
    <td>rl.output</td>
    <td>The Writable stream being used.</td>
  </tr>
  <tr>
    <td>rl.terminal</td>
    <td>A boolean indicating if the stream should be treated like a TTY and have ANSI/VT100 escape codes written to it.</td>
  </tr>
  <tr>
    <td>rl.history</td>
    <td>The history buffer if one was provided. This is not available when using the Promise-based API.</td>
  </tr>
</table>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td>rl.question(query, callback)</td>
    <td>Displays the <code class="w3-codespan">query</code> to the user and waits for their input. Once they provide it, calls <code class="w3-codespan">callback</code> with the user's input as its first argument.</td>
  </tr>
  <tr>
    <td>rl.close()</td>
    <td>Closes the Interface instance, relinquishing control over the input and output streams.</td>
  </tr>
  <tr>
    <td>rl.pause()</td>
    <td>Pauses the readline input stream, allowing it to be resumed later.</td>
  </tr>
  <tr>
    <td>rl.resume()</td>
  ...
  <tr>
    <td>rl.write(data[, key])</td>
    <td>Writes <code class="w3-codespan">data</code> to the output stream. The <code class="w3-codespan">key</code> argument can be an object with special characters like <code class="w3-codespan">ctrl</code> or <code class="w3-codespan">meta</code>.</td>
  </tr>
  <tr>
    <td>rl.prompt([preserveCursor])</td>
    <td>Displays the prompt for the user to input. If <code class="w3-codespan">preserveCursor</code> is <code class="w3-codespan">true</code>, the cursor position isn't reset.</td>
  </tr>
  <tr>
    <td>rl.getPrompt()</td>
    <td>Returns the current prompt string.</td>
  </tr>
  <tr>
    <td>rl.setPrompt(prompt)</td>
    <td>Sets the prompt string that will be displayed when <code class="w3-codespan">rl.prompt()</code> is called.</td>
  </tr>
</table>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td>'close'</td>
    <td>Emitted when the Interface instance is closed.</td>
  </tr>
  <tr>
    <td>'line'</td>
    <td>Emitted when the user submits a line of input by pressing the Enter key.</td>
  </tr>
  <tr>
    <td>'pause'</td>
    <td>Emitted when the input stream is paused.</td>
  </tr>
  <tr>
    <td>'resume'</td>
    <td>Emitted when the input stream is resumed.</td>
  </tr>
  <tr>
    <td>'SIGCONT'</td>
    <td>Emitted when a Node.js process previously paused with Ctrl+Z (SIGTSTP) is resumed.</td>
  </tr>
  <tr>
    <td>'SIGINT'</td>
    <td>Emitted when Ctrl+C is pressed, known as SIGINT.</td>
  </tr>
  <tr>
    <td>'SIGTSTP'</td>
    <td>Emitted when Ctrl+Z is pressed, known as SIGTSTP.</td>
  </tr>
  <tr>
    <td>'history'</td>
    <td>Emitted whenever the history changes.</td>
  </tr>
</table>
...
<p>This example demonstrates the basic usage of the Interface object to create a simple command-line prompt:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const readline = require('readline');<br>
<br>
// Create interface for reading from stdin and writing to stdout<br>
const rl = readline.createInterface({<br>
&nbsp;&nbsp;input: process.stdin,<br>
&nbsp;&nbsp;output: process.stdout<br>
});<br>
<br>
// Ask a question and get the user's input<br>
rl.question('What is your name? ', (name) => {<br>
&nbsp;&nbsp;console.log(`Hello, ${name}!`);<br>
<br>
&nbsp;&nbsp;// Ask another question<br>
&nbsp;&nbsp;rl.question('How are you today? ', (response) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Glad to hear: ${response}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
...
rl.on('close', () => {<br>
&nbsp;&nbsp;console.log('Interface closed. Goodbye!');<br>
});
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_interface_basic">Run example &raquo;</a>
</div>

<hr>

<h2>Promise-based API Example</h2>

<p>Node.js v17+ provides a promise-based API for readline:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// For Node.js v17 and above:<br>
const readline = require('readline/promises');<br>
const { stdin: input, stdout: output } = require('process');<br>
<br>
async function askQuestions() {<br>
&nbsp;&nbsp;const rl = readline.createInterface({ input, output });<br>
<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Ask questions sequentially<br>
&nbsp;&nbsp;&nbsp;&nbsp;const name = await rl.question('What is your name? ');<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Hello, ${name}!`);<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;const age = await rl.question('How old are you? ');<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`You are ${age} years old.`);<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;const location = await rl.question('Where do you live? ');<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`${location} is a nice place!`);<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Summary<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('\nSummary:');<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Name: ${name}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Age: ${age}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Location: ${location}`);<br>
&nbsp;&nbsp;} finally {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Make sure to close the interface<br>
&nbsp;&nbsp;&nbsp;&nbsp;rl.close();<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
// Run the async function<br>
askQuestions()<br>
&nbsp;&nbsp;.then(() => console.log('Questions completed!'))<br>
&nbsp;&nbsp;.catch(err => console.error('Error:', err));
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_interface_promise">Run example &raquo;</a>
</div>

<hr>

<h2>Command Line Interface Example</h2>

<p>Building a simple command-line interface with history support:</p>
...
<br>
// History file path<br>
const historyFile = path.join(__dirname, '.command_history');<br>
<br>
// Load command history if it exists<br>
let commandHistory = [];<br>
try {<br>
&nbsp;&nbsp;if (fs.existsSync(historyFile)) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;commandHistory = fs.readFileSync(historyFile, 'utf8')<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;.split('\n')<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;.filter(cmd => cmd.trim());<br>
&nbsp;&nbsp;}<br>
} catch (err) {<br>
&nbsp;&nbsp;console.error('Error loading history:', err.message);<br>
}<br>
<br>
// Create the interface with custom configuration<br>
const rl = readline.createInterface({<br>
&nbsp;&nbsp;input: process.stdin,<br>
&nbsp;&nbsp;output: process.stdout,<br>
&nbsp;&nbsp;prompt: 'cli> ',<br>
&nbsp;&nbsp;historySize: 100,<br>
&nbsp;&nbsp;history: commandHistory<br>
});<br>
<br>
...
&nbsp;&nbsp;help: () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('\nAvailable commands:');<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('&nbsp;&nbsp;help&nbsp;&nbsp;&nbsp;&nbsp; - Show this help message');<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('&nbsp;&nbsp;hello&nbsp;&nbsp;&nbsp;&nbsp;- Say hello');<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('&nbsp;&nbsp;date&nbsp;&nbsp;&nbsp;&nbsp; - Show current date and time');<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('&nbsp;&nbsp;clear&nbsp;&nbsp;&nbsp;&nbsp;- Clear the console');<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('&nbsp;&nbsp;exit&nbsp;&nbsp;&nbsp;&nbsp; - Exit the CLI');<br>
&nbsp;&nbsp;&nbsp;&nbsp;rl.prompt();<br>
&nbsp;&nbsp;},<br>
&nbsp;&nbsp;hello: () => {<br>
...
&nbsp;&nbsp;},<br>
&nbsp;&nbsp;date: () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(new Date().toLocaleString());<br>
&nbsp;&nbsp;&nbsp;&nbsp;rl.prompt();<br>
&nbsp;&nbsp;},<br>
&nbsp;&nbsp;clear: () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;process.stdout.write('\x1Bc');<br>
&nbsp;&nbsp;&nbsp;&nbsp;rl.prompt();<br>
&nbsp;&nbsp;},<br>
&nbsp;&nbsp;exit: () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Save command history to file<br>
&nbsp;&nbsp;&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;fs.writeFileSync(historyFile, rl.history.join('\n'));<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Command history saved to ${historyFile}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;} catch (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error('Error saving history:', err.message);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
...
console.log('Simple CLI Example');<br>
...
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;const command = input.toLowerCase();<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;if (commands[command]) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;commands[command]();<br>
&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Command not found: ${input}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Type "help" for available commands');<br>
&nbsp;&nbsp;&nbsp;&nbsp;rl.prompt();<br>
&nbsp;&nbsp;}<br>
}).on('close', () => {<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;commands.exit();<br>
&nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Operation cancelled');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;rl.prompt();<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;});<br>
});
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_interface_cli">Run example &raquo;</a>
</div>

<hr>

<h2>Interactive Password Input</h2>

<p>Creating a password input that masks the entered characters:</p>
...
<br>
// Function to prompt for masked input<br>
function promptPassword(query) {<br>
&nbsp;&nbsp;return new Promise((resolve) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Create a hidden readline instance to control input/output<br>
&nbsp;&nbsp;&nbsp;&nbsp;const stdin = process.stdin;<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Save the original configuration<br>
&nbsp;&nbsp;&nbsp;&nbsp;const originalStdinIsTTY = stdin.isTTY;<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (originalStdinIsTTY) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;stdin.setRawMode(true);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;let password = '';<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Write the query<br>
&nbsp;&nbsp;&nbsp;&nbsp;process.stdout.write(query);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (originalStdinIsTTY) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;stdin.setRawMode(false);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;stdin.removeListener('data', onData);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;process.stdout.write('\n');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;resolve(password);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Backspace<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (key.toString() === '\u0008' || key.toString() === '\u007f') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (password.length > 0) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;password = password.slice(0, -1);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;process.stdout.write('\b \b'); // Erase last character<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Regular character<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;password += key.toString();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;process.stdout.write('*'); // Show asterisk for each character<br>
&nbsp;&nbsp;&nbsp;&nbsp;};<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;stdin.on('data', onData);<br>
&nbsp;&nbsp;});<br>
}<br>
<br>
// Example usage<br>
async function login() {<br>
&nbsp;&nbsp;const username = await new Promise((resolve) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;rl.question('Username: ', (answer) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;resolve(answer);<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;const password = await promptPassword('Password: ');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;console.log(`\nAttempting login for user: ${username}`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Simulate authentication check<br>
&nbsp;&nbsp;if (username === 'admin' && password === 'password') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Login successful!');<br>
&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Invalid username or password');<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;rl.close();<br>
}<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_interface_password">Run example &raquo;</a>
</div>

<hr>

<h2>Interactive Menu Example</h2>

<p>Creating an interactive menu with options:</p>
...
<br>
// Menu options<br>
const menuOptions = [<br>
&nbsp;&nbsp;{ id: 1, name: 'View Profile' },<br>
&nbsp;&nbsp;{ id: 2, name: 'Edit Settings' },<br>
&nbsp;&nbsp;{ id: 3, name: 'Check Messages' },<br>
&nbsp;&nbsp;{ id: 4, name: 'Log Out' },<br>
&nbsp;&nbsp;{ id: 5, name: 'Exit' }<br>
];<br>
<br>
// Display the menu<br>
...
&nbsp;&nbsp;console.log('\n===== MAIN MENU =====');<br>
&nbsp;&nbsp;menuOptions.forEach(option => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`${option.id}. ${option.name}`);<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;console.log('====================');<br>
}<br>
<br>
// Process the selected option<br>
function processOption(option) {<br>
&nbsp;&nbsp;const selectedOption = menuOptions.find(item => item.id === parseInt(option));<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;if (!selectedOption) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Invalid option. Please try again.');<br>
&nbsp;&nbsp;&nbsp;&nbsp;return promptUser();<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;console.log(`\nYou selected: ${selectedOption.name}`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Handle each option<br>
&nbsp;&nbsp;switch (selectedOption.id) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;case 1:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Displaying user profile...');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Name: John Doe');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Email: john@example.com');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Role: Administrator');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;break;<br>
&nbsp;&nbsp;&nbsp;&nbsp;case 2:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Opening settings menu...');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('(Settings options would be displayed here)');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;break;<br>
&nbsp;&nbsp;&nbsp;&nbsp;case 3:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Checking messages...');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('You have no new messages.');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;break;<br>
&nbsp;&nbsp;&nbsp;&nbsp;case 4:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Logging out...');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('You have been logged out successfully.');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return rl.close();<br>
&nbsp;&nbsp;&nbsp;&nbsp;case 5:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Exiting the application...');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return rl.close();<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Return to the menu after a short delay<br>
&nbsp;&nbsp;setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;promptUser();<br>
&nbsp;&nbsp;}, 1500);<br>
}<br>
<br>
// Prompt the user to select an option<br>
function promptUser() {<br>
&nbsp;&nbsp;displayMenu();<br>
&nbsp;&nbsp;rl.question('Select an option: ', (answer) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;processOption(answer);<br>
&nbsp;&nbsp;});<br>
}<br>
<br>
// Start the menu<br>
console.log('Welcome to the Interactive Menu Example');<br>
promptUser();<br>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_interface_menu">Run example &raquo;</a>
</div>
...
<ol>
  <li><strong>Always close the interface</strong>: Be sure to call <code class="w3-codespan">rl.close()</code> when you're done to free up resources.</li>
  <li><strong>Handle Ctrl+C</strong>: Listen for the 'SIGINT' event to handle program termination gracefully.</li>
  <li><strong>Use promise-based API</strong>: For Node.js v17 and above, consider using the promise-based API for cleaner async code.</li>
  <li><strong>Save history</strong>: For CLI applications, save and restore command history to provide a better user experience.</li>
  <li><strong>Handle errors</strong>: Always handle potential errors when interacting with the user.</li>
  <li><strong>Provide clear prompts</strong>: Make sure your prompts clearly indicate what type of input is expected.</li>
  <li><strong>Validate input</strong>: Always validate user input before processing it.</li>
</ol>
