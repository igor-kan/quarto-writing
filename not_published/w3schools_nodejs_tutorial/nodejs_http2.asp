...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js HTTP/2 Module</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js HTTP/2 Module">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_http2.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="The HTTP/2 module implements the HTTP/2 protocol, with better performance, server push, and header compression.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js HTTP/2 Module">
<meta name="twitter:description" content="The HTTP/2 module implements the HTTP/2 protocol, with better performance, server push, and header compression.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_http2.png">
...
<h1>Node.js HTTP/2 Module</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_webassembly.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="nodejs_perf_hooks.asp">Next &#10095;</a>
</div>

<hr>

<h2>What is HTTP/2?</h2>
<p>The Node.js HTTP/2 module provides an implementation of the HTTP/2 protocol, offering improved performance, server push capabilities, header compression, and multiplexing over a single connection.</p>
<p>HTTP/2 improves upon HTTP/1.1 with several key features:</p>

<ul>
  <li><strong>Binary protocol</strong>: HTTP/2 uses a binary format for data transfer rather than the text format of HTTP/1.1, making it more efficient to parse.</li>
  <li><strong>Multiplexing</strong>: Multiple requests and responses can be sent over a single connection simultaneously.</li>
  <li><strong>Header compression</strong>: HTTP/2 compresses headers to reduce overhead.</li>
  <li><strong>Server push</strong>: Servers can proactively send resources to clients before they request them.</li>
  <li><strong>Stream prioritization</strong>: Resources can be delivered with different priorities.</li>
</ul>

<hr>

<h2>Using the HTTP/2 Module</h2>

<p>In Node.js, the HTTP/2 module can be accessed using:</p>
...
<p>The HTTP/2 module is stable as of Node.js v10.0.0. It's important to note that HTTP/2 requires a secure connection (HTTPS) in most browsers, so most examples will use TLS/SSL.</p>
</div>

<hr>

<h2>Creating an HTTP/2 Server</h2>

<p>Here's an example of creating a basic HTTP/2 server using TLS:</p>
...
<br>
// Read the TLS certificate and key<br>
const options = {<br>
&nbsp;&nbsp;key: fs.readFileSync(path.join(__dirname, 'server.key')),<br>
&nbsp;&nbsp;cert: fs.readFileSync(path.join(__dirname, 'server.crt'))<br>
};<br>
<br>
// Create an HTTP/2 server<br>
const server = http2.createSecureServer(options);<br>
<br>
// Handle stream events<br>
server.on('stream', (stream, headers) => {<br>
&nbsp;&nbsp;// Get the path from headers<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;':status': 200<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;stream.end('&lt;h1&gt;Hello from HTTP/2!&lt;/h1&gt;');<br>
&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;stream.respond({<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;':status': 404<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;stream.end('Not found');<br>
&nbsp;&nbsp;}<br>
});<br>
<br>
// Start the server<br>
...
<div class="w3-panel ws-note">
<p>This example assumes you have TLS certificate files. For development, you can generate self-signed certificates using OpenSSL. For production, use a trusted certificate authority.</p>
</div>

<p>You can also create an HTTP/2 server without TLS (for direct HTTP/2 connections without encryption):</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const http2 = require('http2');<br>
<br>
// Create an HTTP/2 server without TLS<br>
const server = http2.createServer();<br>
<br>
server.on('stream', (stream, headers) => {<br>
&nbsp;&nbsp;stream.respond({<br>
&nbsp;&nbsp;&nbsp;&nbsp;'content-type': 'text/html',<br>
&nbsp;&nbsp;&nbsp;&nbsp;':status': 200<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;stream.end('&lt;h1&gt;Hello from HTTP/2 without TLS!&lt;/h1&gt;');<br>
});<br>
<br>
server.listen(8080);
</div>
...
<p>Most modern browsers only support HTTP/2 over TLS, so the insecure HTTP/2 server will typically only work with dedicated HTTP/2 clients that explicitly support cleartext HTTP/2.</p>
</div>
...
<p>Creating an HTTP/2 client to connect to an HTTP/2 server:</p>
...
<br>
// Create a client<br>
const client = http2.connect('https://localhost:8080', {<br>
&nbsp;&nbsp;// For self-signed certificates in development<br>
...
<br>
// Create a request<br>
const req = client.request({ ':path': '/' });<br>
<br>
// Handle response data<br>
req.on('response', (headers) => {<br>
&nbsp;&nbsp;console.log('Status:', headers[':status']);<br>
...
<p>HTTP/2 uses streams for communication between client and server. Each stream represents an independent, bidirectional sequence of frames exchanged between the client and server.</p>

<h3>Stream Events</h3>

<p>Important stream events include:</p>

<ul>
  <li><code class="w3-codespan">'headers'</code>: Emitted when headers are received</li>
  <li><code class="w3-codespan">'data'</code>: Emitted when a chunk of data is received</li>
  <li><code class="w3-codespan">'end'</code>: Emitted when the stream is finished</li>
  <li><code class="w3-codespan">'error'</code>: Emitted when an error occurs</li>
</ul>
...
<br>
// Create a server<br>
const server = http2.createSecureServer({<br>
&nbsp;&nbsp;key: fs.readFileSync(path.join(__dirname, 'server.key')),<br>
&nbsp;&nbsp;cert: fs.readFileSync(path.join(__dirname, 'server.crt'))<br>
});<br>
<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;console.error('Stream error:', error);<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;stream.on('close', () => {<br>
...
<p>Server push allows the server to proactively send resources to the client before they are explicitly requested. This can improve performance by eliminating round-trip delays.</p>
...
<br>
server.on('stream', (stream, headers) => {<br>
&nbsp;&nbsp;const requestPath = headers[':path'];<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;if (requestPath === '/') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Push CSS and JavaScript resources<br>
&nbsp;&nbsp;&nbsp;&nbsp;stream.pushStream({ ':path': '/style.css' }, (err, pushStream) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error('Error pushing stream:', err);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;pushStream.end('body { color: blue; }');<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;stream.pushStream({ ':path': '/script.js' }, (err, pushStream) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error('Error pushing stream:', err);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;pushStream.end('console.log("Hello from HTTP/2 server push!");');<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Send the main HTML document<br>
&nbsp;&nbsp;&nbsp;&nbsp;stream.respond({<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'content-type': 'text/html',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;':status': 200<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;html&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;head&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;title&gt;HTTP/2 Server Push Example&lt;/title&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;link rel="stylesheet" href="/style.css"><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;script src="/script.js">&lt;/script&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/head&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;body&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;h1&gt;HTTP/2 Server Push Demo&lt;/h1&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;p&gt;CSS and JavaScript were pushed by the server!&lt;/p&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/body&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;/html&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;`);<br>
&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Serve pushed resources if requested directly<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (requestPath === '/style.css') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;stream.respond({<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'content-type': 'text/css',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;':status': 200<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;stream.end('body { color: blue; }');<br>
&nbsp;&nbsp;&nbsp;&nbsp;} else if (requestPath === '/script.js') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;stream.respond({<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'content-type': 'application/javascript',<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;':status': 200<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;stream.end('console.log("Hello from HTTP/2 server push!");');<br>
&nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Not found<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;stream.respond({ ':status': 404 });<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;stream.end('Not found');<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>
});<br>
...
<h2>HTTP/2 Headers</h2>

<p>HTTP/2 uses a different format for headers. Notably, all headers are lowercase, and request pseudo-headers start with a colon (:).</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const http2 = require('http2');<br>
<br>
// HTTP/2 pseudo-headers<br>
const {<br>
&nbsp;&nbsp;HTTP2_HEADER_METHOD,<br>
&nbsp;&nbsp;HTTP2_HEADER_PATH,<br>
&nbsp;&nbsp;HTTP2_HEADER_AUTHORITY,<br>
&nbsp;&nbsp;HTTP2_HEADER_SCHEME,<br>
&nbsp;&nbsp;HTTP2_HEADER_STATUS<br>
} = http2.constants;<br>
<br>
// Create a client<br>
const client = http2.connect('https://localhost:8080', {<br>
...
<br>
// Send a request with custom headers<br>
const req = client.request({<br>
&nbsp;&nbsp;[HTTP2_HEADER_METHOD]: 'GET',<br>
&nbsp;&nbsp;[HTTP2_HEADER_PATH]: '/',<br>
&nbsp;&nbsp;[HTTP2_HEADER_AUTHORITY]: 'localhost:8080',<br>
&nbsp;&nbsp;[HTTP2_HEADER_SCHEME]: 'https',<br>
&nbsp;&nbsp;'user-agent': 'node-http2/client',<br>
&nbsp;&nbsp;'custom-header': 'custom-value'<br>
});<br>
<br>
req.on('response', (headers) => {<br>
&nbsp;&nbsp;console.log('Response status:', headers[HTTP2_HEADER_STATUS]);<br>
&nbsp;&nbsp;console.log('Response headers:', headers);<br>
});<br>
<br>
req.on('data', (chunk) => {<br>
&nbsp;&nbsp;console.log('Received data:', chunk.toString());<br>
...
<p>HTTP/2 allows configuring various protocol settings:</p>
...
&nbsp;&nbsp;// HTTP/2 settings<br>
&nbsp;&nbsp;settings: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Max concurrent streams per connection<br>
&nbsp;&nbsp;&nbsp;&nbsp;maxConcurrentStreams: 100,<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Initial window size for flow control<br>
&nbsp;&nbsp;&nbsp;&nbsp;initialWindowSize: 1024 * 1024, // 1MB<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Enable server push<br>
&nbsp;&nbsp;&nbsp;&nbsp;enablePush: true<br>
&nbsp;&nbsp;}<br>
};<br>
<br>
...
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;stream.end('&lt;h1&gt;HTTP/2 Server with Custom Settings&lt;/h1&gt;');<br>
});<br>
<br>
server.listen(8080);
</div>
...
<h2>Compatibility with HTTP/1.1</h2>

<p>HTTP/2 servers can also handle HTTP/1.1 requests, providing a seamless upgrade path:</p>
...
const path = require('path');<br>
<br>
// For HTTP/2 secure server<br>
const options = {<br>
&nbsp;&nbsp;key: fs.readFileSync(path.join(__dirname, 'server.key')),<br>
&nbsp;&nbsp;cert: fs.readFileSync(path.join(__dirname, 'server.crt')),<br>
&nbsp;&nbsp;allowHTTP1: true // Allow HTTP/1.1 connections<br>
};<br>
<br>
const server = http2.createSecureServer(options);<br>
<br>
// Handler function for both HTTP/1.1 and HTTP/2<br>
const handler = (req, res) => {<br>
&nbsp;&nbsp;res.writeHead(200, { 'Content-Type': 'text/plain' });<br>
&nbsp;&nbsp;res.end(`Hello from ${req.httpVersion} server!`);<br>
};<br>
<br>
// HTTP/1.1 compatibility request handler<br>
server.on('request', handler);<br>
<br>
// HTTP/2 specific stream handler<br>
server.on('stream', (stream, headers) => {<br>
&nbsp;&nbsp;stream.respond({<br>
&nbsp;&nbsp;&nbsp;&nbsp;'content-type': 'text/plain',<br>
&nbsp;&nbsp;&nbsp;&nbsp;':status': 200<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;stream.end(`Hello from HTTP/2 stream API!`);<br>
});<br>
<br>
server.listen(8080, () => {<br>
&nbsp;&nbsp;console.log('Server running at https://localhost:8080/');<br>
});
</div>
</div>
...
<p>While HTTP/2 offers performance improvements, it's important to optimize your usage:</p>

<ol>
  <li><strong>Connection Reuse</strong> - With HTTP/2, you should aim to use a single connection for multiple requests, rather than creating new connections.</li>
  <li><strong>Proper Stream Management</strong> - Remember to close streams when they're no longer needed, and monitor the number of concurrent streams.</li>
  <li><strong>Server Push Strategy</strong> - Only push resources that are likely to be needed. Excessive pushing can waste bandwidth and resources.</li>
  <li><strong>Header Compression</strong> - Take advantage of HTTP/2's header compression by minimizing the number and size of custom headers.</li>
</ol>
...
<p>Key differences between HTTP/2 and HTTP/1.1:</p>
...
<table class="ws-table-all">
  ...
  <tr>
    <td>Protocol Format</td>
    <td>Text-based</td>
    <td>Binary-based</td>
  </tr>
  <tr>
    <td>Multiplexing</td>
    <td>No (requires multiple connections)</td>
...
<h2>Real-World Example: Serving a Complete Website</h2>

<p>A complete example of serving a website with HTTP/2:</p>
...
const fs = require('fs');<br>
const path = require('path');<br>
const mime = require('mime-types');<br>
<br>
const options = {<br>
&nbsp;&nbsp;key: fs.readFileSync(path.join(__dirname, 'server.key')),<br>
&nbsp;&nbsp;cert: fs.readFileSync(path.join(__dirname, 'server.crt'))<br>
...
const server = http2.createSecureServer(options);<br>
<br>
// Serve files from the public directory<br>
const publicDir = path.join(__dirname, 'public');<br>
<br>
server.on('stream', (stream, headers) => {<br>
&nbsp;&nbsp;const reqPath = headers[':path'] === '/' ? '/index.html' : headers[':path'];<br>
&nbsp;&nbsp;const filePath = path.join(publicDir, reqPath);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Basic security check to prevent path traversal<br>
&nbsp;&nbsp;if (!filePath.startsWith(publicDir)) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;stream.respond({ ':status': 403 });<br>
&nbsp;&nbsp;&nbsp;&nbsp;stream.end('Forbidden');<br>
&nbsp;&nbsp;&nbsp;&nbsp;return;<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Determine content type<br>
&nbsp;&nbsp;&nbsp;&nbsp;const contentType = mime.lookup(filePath) || 'application/octet-stream';<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Serve the file<br>
&nbsp;&nbsp;&nbsp;&nbsp;stream.respond({<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;fileStream.pipe(stream);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;fileStream.on('error', (err) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error('File stream error:', err);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;stream.close(http2.constants.NGHTTP2_INTERNAL_ERROR);<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;});<br>
});<br>
<br>
server.listen(8080, () => {<br>
&nbsp;&nbsp;console.log('HTTP/2 server running at https://localhost:8080/');<br>
});
</div>
</div>

<p>This example requires the mime-types package:</p>
...
<h2>Advanced Stream Management</h2>
<p>HTTP/2's stream management capabilities allow for efficient handling of multiple concurrent requests. Here's an advanced example demonstrating stream prioritization and flow control:</p>
...
const fs = require('fs');<br>
<br>
// Create a server with custom settings<br>
const server = http2.createSecureServer({<br>
&nbsp;&nbsp;key: fs.readFileSync('server.key'),<br>
&nbsp;&nbsp;cert: fs.readFileSync('server.crt'),<br>
&nbsp;&nbsp;settings: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;initialWindowSize: 65535,&nbsp;&nbsp;// 64KB initial window<br>
&nbsp;&nbsp;&nbsp;&nbsp;maxConcurrentStreams: 100,<br>
&nbsp;&nbsp;&nbsp;&nbsp;enablePush: true<br>
&nbsp;&nbsp;}<br>
});<br>
<br>
server.on('stream', (stream, headers) => {<br>
&nbsp;&nbsp;// Get priority information<br>
&nbsp;&nbsp;const weight = stream.priority && stream.priority.weight || 1;<br>
&nbsp;&nbsp;const parent = stream.priority && stream.priority.parent ? 'with parent' : 'no parent';<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;console.log(`New stream ${stream.id} (weight: ${weight}, ${parent})`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Handle different priority levels<br>
&nbsp;&nbsp;if (headers[':path'] === '/high-priority') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;stream.priority({ weight: 256, exclusive: true });<br>
&nbsp;&nbsp;&nbsp;&nbsp;stream.respond({ ':status': 200, 'content-type': 'text/plain' });<br>
&nbsp;&nbsp;&nbsp;&nbsp;stream.end('High priority content');<br>
&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Default priority<br>
&nbsp;&nbsp;&nbsp;&nbsp;stream.respond({ ':status': 200, 'content-type': 'text/plain' });<br>
&nbsp;&nbsp;&nbsp;&nbsp;stream.end('Standard priority content');<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Handle stream errors<br>
&nbsp;&nbsp;stream.on('error', (error) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error(`Stream ${stream.id} error:`, error);<br>
&nbsp;&nbsp;&nbsp;&nbsp;stream.end();<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Handle stream close<br>
&nbsp;&nbsp;stream.on('close', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Stream ${stream.id} closed`);<br>
&nbsp;&nbsp;});<br>
});<br>
<br>
server.listen(8443);
...
<p>Proper error handling is crucial for reliable HTTP/2 applications. Here's how to implement comprehensive error handling:</p>
...
const readFile = promisify(fs.readFile);<br>
<br>
async function startServer() {<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const [key, cert] = await Promise.all([<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;readFile('server.key'),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;readFile('server.crt')<br>
&nbsp;&nbsp;&nbsp;&nbsp;]);<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;const server = http2.createSecureServer({ key, cert });<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Global error handler<br>
&nbsp;&nbsp;&nbsp;&nbsp;server.on('error', (err) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error('Server error:', err);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Implement proper error recovery<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Handle uncaught exceptions<br>
&nbsp;&nbsp;&nbsp;&nbsp;process.on('uncaughtException', (err) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error('Uncaught exception:', err);<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Stream handler with error boundaries<br>
&nbsp;&nbsp;&nbsp;&nbsp;server.on('stream', (stream, headers) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;try {<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;throw new Error('Random error for demonstration');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;stream.respond({ ':status': 200 });<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;stream.end('Success!');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;} catch (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;handleStreamError(stream, err);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}, 100);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;} catch (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;handleStreamError(stream, err);<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;function handleStreamError(stream, error) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error('Stream error:', error);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (!stream.destroyed) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;stream.respond({<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;':status': 500,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'content-type': 'text/plain'<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;stream.end('Internal Server Error');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;server.listen(8443, () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Server running on https://localhost:8443');<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;} catch (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error('Failed to start server:', err);<br>
&nbsp;&nbsp;&nbsp;&nbsp;process.exit(1);<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
...
<p>Optimizing HTTP/2 performance requires understanding its unique characteristics. Here are key strategies:</p>
...
<br>
class HTTP2ConnectionPool {<br>
&nbsp;&nbsp;constructor() {<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.connections = new Map();<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;async getConnection(url) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const { origin } = new URL(url);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (!this.connections.has(origin)) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const client = http2.connect(origin, { <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;rejectUnauthorized: false // Only for development<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Handle connection errors<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;client.on('error', (err) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error('Connection error:', err);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;this.connections.delete(origin);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Remove connection when closed<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;client.on('close', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;this.connections.delete(origin);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;this.connections.set(origin, {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;client,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;lastUsed: Date.now(),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;inUse: 0<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;const conn = this.connections.get(origin);<br>
&nbsp;&nbsp;&nbsp;&nbsp;conn.lastUsed = Date.now();<br>
&nbsp;&nbsp;&nbsp;&nbsp;conn.inUse++;<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;return {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;client: conn.client,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;release: () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;conn.inUse--;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;};<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Clean up idle connections<br>
&nbsp;&nbsp;startCleanup(interval = 30000) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;setInterval(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const now = Date.now();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;for (const [origin, conn] of this.connections.entries()) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (conn.inUse === 0 && (now - conn.lastUsed) > 60000) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;conn.client.destroy();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;this.connections.delete(origin);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;}, interval);<br>
...
<br>
// Usage example<br>
const pool = new HTTP2ConnectionPool();<br>
pool.startCleanup();<br>
<br>
async function makeRequest(url) {<br>
&nbsp;&nbsp;const { client, release } = await pool.getConnection(url);<br>
&nbsp;&nbsp;return new Promise((resolve, reject) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const req = client.request({ ':path': new URL(url).pathname });<br>
&nbsp;&nbsp;&nbsp;&nbsp;let data = '';<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;req.on('response', (headers) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Status:', headers[':status']);<br>
...
<h3>2. Header Compression Optimization</h3>
<p>HTTP/2 uses HPACK compression for headers. Optimize by:</p>
<ul>
  <li>Minimizing cookie sizes</li>
  <li>Using short but descriptive header names</li>
  <li>Avoiding duplicate headers</li>
  <li>Using HTTP/2-specific headers when possible</li>
</ul>
...
<p>When using HTTP/2, follow these security practices:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const http2 = require('http2');<br>
const fs = require('fs');<br>
const { createSecureContext } = require('tls');<br>
<br>
// Security headers middleware<br>
function securityHeaders(req, res, next) {<br>
&nbsp;&nbsp;// Set security headers<br>
...
&nbsp;&nbsp;res.setHeader('Content-Security-Policy', "default-src 'self'");<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Remove server header<br>
&nbsp;&nbsp;res.removeHeader('X-Powered-By');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;next();<br>
}<br>
<br>
// Create secure server with modern TLS settings<br>
const options = {<br>
&nbsp;&nbsp;key: fs.readFileSync('server.key'),<br>
&nbsp;&nbsp;cert: fs.readFileSync('server.crt'),<br>
&nbsp;&nbsp;secureOptions: <br>
...
const server = http2.createSecureServer(options);<br>
<br>
// Apply security middleware<br>
server.on('request', (req, res) => {<br>
&nbsp;&nbsp;securityHeaders(req, res, () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Request handling logic<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.setHeader('Content-Type', 'text/plain');<br>
&nbsp;&nbsp;&nbsp;&nbsp;res.end('Secure HTTP/2 Response');<br>
&nbsp;&nbsp;});<br>
});<br>
<br>
// Handle TLS errors<br>
server.on('tlsClientError', (err, tlsSocket) => {<br>
&nbsp;&nbsp;console.error('TLS Error:', err);<br>
&nbsp;&nbsp;tlsSocket.destroy();<br>
});<br>
<br>
server.listen(8443);
</div>
...
<h3>1. API Gateway with HTTP/2</h3>
<p>Building a high-performance API gateway with HTTP/2:</p>
...
// Service registry<br>
const services = {<br>
&nbsp;&nbsp;'/users': 'http://users-service:3000',<br>
&nbsp;&nbsp;'/products': 'http://products-service:3000',<br>
&nbsp;&nbsp;'/orders': 'http://orders-service:3000'<br>
};<br>
<br>
...
&nbsp;&nbsp;<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Find matching service<br>
&nbsp;&nbsp;&nbsp;&nbsp;const servicePath = Object.keys(services).find(prefix => <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;path.startsWith(prefix)<br>
&nbsp;&nbsp;&nbsp;&nbsp;);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (!servicePath) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;stream.respond({ ':status': 404 });<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return stream.end('Not Found');<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;const targetUrl = new URL(path.slice(servicePath.length), services[servicePath]);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Forward request to target service<br>
&nbsp;&nbsp;&nbsp;&nbsp;const client = http2.connect(targetUrl.origin);<br>
&nbsp;&nbsp;&nbsp;&nbsp;const req = client.request({<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;...headers,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;':path': targetUrl.pathname + targetUrl.search,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;':method': method,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;':authority': targetUrl.host<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Pipe the response back to client<br>
&nbsp;&nbsp;&nbsp;&nbsp;req.pipe(stream);<br>
&nbsp;&nbsp;&nbsp;&nbsp;stream.pipe(req);<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Handle errors<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (!stream.destroyed) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;stream.respond({ ':status': 502 });<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;stream.end('Bad Gateway');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;stream.on('error', (err) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error('Stream error:', err);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;req.destroy();<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;} catch (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error('Gateway error:', err);<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (!stream.destroyed) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;stream.respond({ ':status': 500 });<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;stream.end('Internal Server Error');<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>
});<br>
...
<h3>2. Real-Time Data Streaming</h3>
<p>Efficient real-time data streaming with HTTP/2:</p>
...
<br>
// In-memory storage for active streams<br>
const streams = new Set();<br>
<br>
// Broadcast data to all connected clients<br>
function broadcast(data) {<br>
&nbsp;&nbsp;const payload = JSON.stringify(data);<br>
&nbsp;&nbsp;for (const stream of streams) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;stream.write(`data: ${payload}\n\n`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;} catch (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error('Stream write error:', err);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;streams.delete(stream);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
// Simulate data updates<br>
setInterval(() => {<br>
&nbsp;&nbsp;broadcast({<br>
&nbsp;&nbsp;&nbsp;&nbsp;time: new Date().toISOString(),<br>
&nbsp;&nbsp;&nbsp;&nbsp;value: Math.random() * 100<br>
&nbsp;&nbsp;});<br>
}, 1000);<br>
<br>
server.on('stream', (stream, headers) => {<br>
&nbsp;&nbsp;// Only handle GET requests<br>
&nbsp;&nbsp;if (headers[':method'] !== 'GET') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;stream.respond({ ':status': 405 });<br>
&nbsp;&nbsp;&nbsp;&nbsp;return stream.end();<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Set up Server-Sent Events headers<br>
&nbsp;&nbsp;stream.respond({<br>
...
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Add to active streams<br>
&nbsp;&nbsp;streams.add(stream);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Handle client disconnect<br>
&nbsp;&nbsp;stream.on('close', () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;streams.delete(stream);<br>
&nbsp;&nbsp;});<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Send initial data<br>
&nbsp;&nbsp;stream.write('event: connect\ndata: Connected\n\n');<br>
});<br>
<br>
server.listen(8443, () => {<br>
&nbsp;&nbsp;console.log('HTTP/2 Server running on https://localhost:8443');<br>
});
</div>
</div>
...
<div id="exercisecontainer" src="xrcise_http2.js" data-extensions="asp"></div>
