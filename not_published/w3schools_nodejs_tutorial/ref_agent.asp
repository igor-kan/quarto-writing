...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Agent Reference</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js Agent Reference">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/ref_agent.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="The Agent class in Node.js is responsible for managing connection persistence and reuse for HTTP/HTTPS client requests.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Agent Reference">
<meta name="twitter:description" content="The Agent class in Node.js is responsible for managing connection persistence and reuse for HTTP/HTTPS client requests.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/ref_agent.png">
...
<h1>Node.js Agent Reference</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="ref_server.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ref_request.asp">Next &#10095;</a>
</div>
...
<p>The Agent class in Node.js is responsible for managing connection persistence and reuse for HTTP/HTTPS client requests. It maintains a queue of pending requests for a given host and port, reusing a single socket connection for each in-flight request to that host and port.</p>

<p>There are two primary Agent implementations:</p>
<ul>
  <li><code class="w3-codespan">http.Agent</code> - For managing HTTP connections</li>
  <li><code class="w3-codespan">https.Agent</code> - For managing HTTPS connections</li>
</ul>

<h3>Importing Agent</h3>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// Import HTTP module<br>
const http = require('http');<br>
<br>
// The default agent<br>
const defaultAgent = http.globalAgent;<br>
<br>
// Create a custom agent<br>
const customAgent = new http.Agent({<br>
&nbsp;&nbsp;keepAlive: true,<br>
&nbsp;&nbsp;maxSockets: 25<br>
});
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_agent_import">Run example &raquo;</a>
</div>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td>agent.freeSockets</td>
    <td>An object which contains sockets currently awaiting use by the Agent when <code class="w3-codespan">keepAlive</code> is enabled. Not to be modified directly.</td>
  </tr>
  <tr>
    <td>agent.maxFreeSockets</td>
    <td>Sets the maximum number of sockets that will be left open in the free state. Only relevant if <code class="w3-codespan">keepAlive</code> is set to <code class="w3-codespan">true</code>. Default: 256.</td>
  </tr>
  <tr>
    <td>agent.maxSockets</td>
    <td>Sets the maximum number of sockets the agent can have open per origin. Default: Infinity.</td>
  </tr>
  <tr>
    <td>agent.maxTotalSockets</td>
    <td>Sets the maximum number of sockets that can be open on all origins. Default: Infinity.</td>
  </tr>
  <tr>
    <td>agent.requests</td>
    <td>An object which contains queued requests that have not yet been assigned to sockets. Not to be modified directly.</td>
  </tr>
  <tr>
    <td>agent.sockets</td>
    <td>An object which contains arrays of sockets currently in use by the Agent. Not to be modified directly.</td>
  </tr>
</table>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td>agent.createConnection(options[, callback])</td>
    <td>Creates a socket/stream to be used for HTTP requests. By default, this function uses <code class="w3-codespan">net.createConnection()</code> but it can be overridden.</td>
  </tr>
  <tr>
    <td>agent.destroy()</td>
    <td>Destroys any sockets that are currently in use by the agent.</td>
  </tr>
  <tr>
    <td>agent.getName(options)</td>
    <td>Gets a unique name for a set of request options, to determine if a connection can be reused.</td>
  </tr>
  <tr>
    <td>agent.keepSocketAlive(socket)</td>
    <td>Called when <code class="w3-codespan">socket</code> is detached from a request and could be persisted by the Agent. Default behavior is to add socket to the <code class="w3-codespan">freeSockets</code> list.</td>
  </tr>
  <tr>
    <td>agent.reuseSocket(socket, request)</td>
    <td>Called when <code class="w3-codespan">socket</code> is attached to <code class="w3-codespan">request</code> after being persisted because of the keep-alive options.</td>
  </tr>
</table>

<hr>

<h2>Using the Default Agent</h2>

<p>By default, HTTP/HTTPS client requests use the global agent (<code class="w3-codespan">http.globalAgent</code> or <code class="w3-codespan">https.globalAgent</code>):</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const http = require('http');<br>
<br>
// Make a request using the default agent<br>
http.get('http://example.com', (res) => {<br>
&nbsp;&nbsp;console.log(`Status Code: ${res.statusCode}`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Display global agent information<br>
&nbsp;&nbsp;const agent = http.globalAgent;<br>
&nbsp;&nbsp;console.log(`Current sockets: ${Object.keys(agent.sockets).length}`);<br>
&nbsp;&nbsp;console.log(`Free sockets: ${Object.keys(agent.freeSockets).length}`);<br>
&nbsp;&nbsp;console.log(`Queued requests: ${Object.keys(agent.requests).length}`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Consume response data<br>
&nbsp;&nbsp;res.resume();<br>
}).on('error', (err) => {<br>
&nbsp;&nbsp;console.error(`Error: ${err.message}`);<br>
});
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_agent_default">Run example &raquo;</a>
</div>

<hr>

<h2>Creating a Custom Agent</h2>

<p>You can create a custom agent with specific settings:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const http = require('http');<br>
<br>
// Create a custom agent with keep-alive enabled<br>
const keepAliveAgent = new http.Agent({<br>
&nbsp;&nbsp;keepAlive: true,&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Keep connections open for reuse<br>
&nbsp;&nbsp;keepAliveMsecs: 1000,&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Milliseconds to wait before sending TCP KeepAlive packet<br>
&nbsp;&nbsp;maxSockets: 10,&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Maximum number of sockets per host<br>
&nbsp;&nbsp;maxFreeSockets: 5,&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Maximum number of idle sockets when keepAlive is true<br>
&nbsp;&nbsp;timeout: 60000,&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Socket timeout in milliseconds<br>
&nbsp;&nbsp;scheduling: 'fifo'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // FIFO request scheduling (instead of LIFO) <br>
});<br>
<br>
// Make a request using the custom agent<br>
const options = {<br>
&nbsp;&nbsp;hostname: 'example.com',<br>
&nbsp;&nbsp;path: '/',<br>
&nbsp;&nbsp;method: 'GET',<br>
&nbsp;&nbsp;agent: keepAliveAgent&nbsp;&nbsp;&nbsp;&nbsp; // Use our custom agent<br>
};<br>
<br>
const req = http.request(options, (res) => {<br>
&nbsp;&nbsp;console.log(`Status Code: ${res.statusCode}`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Display custom agent information<br>
&nbsp;&nbsp;console.log(`Current sockets: ${Object.keys(keepAliveAgent.sockets).length}`);<br>
&nbsp;&nbsp;console.log(`Free sockets: ${Object.keys(keepAliveAgent.freeSockets).length}`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Consume response data<br>
&nbsp;&nbsp;res.resume();<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Make a second request to demonstrate socket reuse<br>
&nbsp;&nbsp;setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Making second request to demonstrate socket reuse...');<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;http.request(options, (res2) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Second request status: ${res2.statusCode}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Current sockets: ${Object.keys(keepAliveAgent.sockets).length}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Free sockets: ${Object.keys(keepAliveAgent.freeSockets).length}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Cleanup<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;keepAliveAgent.destroy();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Agent destroyed');<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}, 1000);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;res2.resume();<br>
&nbsp;&nbsp;&nbsp;&nbsp;}).end();<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_agent_custom">Run example &raquo;</a>
</div>
...
<p>For HTTPS requests, you can create an HTTPS-specific agent with additional SSL/TLS options:</p>
...
<br>
// Create a custom HTTPS agent with SSL options<br>
const httpsAgent = new https.Agent({<br>
&nbsp;&nbsp;keepAlive: true,<br>
&nbsp;&nbsp;maxSockets: 10,<br>
&nbsp;&nbsp;// SSL/TLS options<br>
&nbsp;&nbsp;ca: fs.readFileSync('ca-cert.pem'),&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Certificate authority<br>
&nbsp;&nbsp;cert: fs.readFileSync('client-cert.pem'), // Client certificate<br>
&nbsp;&nbsp;key: fs.readFileSync('client-key.pem'),&nbsp;&nbsp; // Client private key<br>
&nbsp;&nbsp;// Additional TLS options<br>
&nbsp;&nbsp;rejectUnauthorized: true,&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Verify server certificate <br>
&nbsp;&nbsp;secureProtocol: 'TLSv1_2_method',&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Use TLS v1.2<br>
&nbsp;&nbsp;ciphers: 'HIGH:!aNULL:!MD5',&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Set allowed ciphers<br>
&nbsp;&nbsp;honorCipherOrder: true&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Honor cipher order<br>
});<br>
<br>
// Make a secure request using the HTTPS agent<br>
const options = {<br>
&nbsp;&nbsp;hostname: 'secure-example.com',<br>
&nbsp;&nbsp;path: '/',<br>
&nbsp;&nbsp;method: 'GET',<br>
&nbsp;&nbsp;agent: httpsAgent<br>
};<br>
...
&nbsp;&nbsp;console.log(`Status Code: ${res.statusCode}`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Display the TLS/SSL-specific information<br>
&nbsp;&nbsp;console.log(`TLS Protocol: ${res.socket.getProtocol()}`);<br>
&nbsp;&nbsp;console.log(`Cipher: ${res.socket.getCipher().name}`);<br>
&nbsp;&nbsp;console.log(`Server Certificate Valid: ${res.socket.authorized}`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Consume response data<br>
&nbsp;&nbsp;res.resume();<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Cleanup<br>
&nbsp;&nbsp;setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;httpsAgent.destroy();<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('HTTPS Agent destroyed');<br>
&nbsp;&nbsp;}, 1000);<br>
});<br>
<br>
req.on('error', (err) => {<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_agent_https">Run example &raquo;</a>
</div>

<hr>

<h2>Disabling Connection Pooling</h2>

<p>You can disable connection pooling by setting the agent to <code class="w3-codespan">false</code>:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const http = require('http');<br>
<br>
// Make a request with agent: false to disable connection pooling<br>
const options = {<br>
&nbsp;&nbsp;hostname: 'example.com',<br>
&nbsp;&nbsp;path: '/',<br>
&nbsp;&nbsp;method: 'GET',<br>
&nbsp;&nbsp;agent: false&nbsp;&nbsp;// Disable connection pooling<br>
};<br>
<br>
const req = http.request(options, (res) => {<br>
&nbsp;&nbsp;console.log(`Status Code: ${res.statusCode}`);<br>
&nbsp;&nbsp;console.log('Using a new connection (no agent)');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Consume response data<br>
&nbsp;&nbsp;res.resume();<br>
});<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_agent_disabled">Run example &raquo;</a>
</div>

<hr>

<h2>Connection Pooling Example</h2>

<p>This example demonstrates the performance benefits of connection pooling with multiple requests:</p>
...
<br>
// Function to make multiple requests with a given agent<br>
async function makeMultipleRequests(useAgent, numRequests = 10) {<br>
&nbsp;&nbsp;// Define the target<br>
&nbsp;&nbsp;const hostname = 'example.com';<br>
&nbsp;&nbsp;const path = '/';<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Choose agent<br>
&nbsp;&nbsp;const agent = useAgent ? new http.Agent({ keepAlive: true }) : false;<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;console.log(`Making ${numRequests} requests with ${useAgent ? 'custom agent' : 'no agent'}`);<br>
&nbsp;&nbsp;const startTime = performance.now();<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Make multiple requests<br>
&nbsp;&nbsp;for (let i = 0; i &lt; numRequests; i++) {<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;req.on('error', (err) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error(`Request ${i + 1} error: ${err.message}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;reject(err);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;req.end();<br>
&nbsp;&nbsp;&nbsp;&nbsp;}).catch(() => {}); // Catch to continue the loop even if a request fails<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;const endTime = performance.now();<br>
&nbsp;&nbsp;console.log(`Time taken: ${(endTime - startTime).toFixed(2)}ms`);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Cleanup<br>
&nbsp;&nbsp;if (useAgent && agent) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;agent.destroy();<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
...
async function runComparison() {<br>
&nbsp;&nbsp;console.log('Testing HTTP request performance with and without Agent');<br>
&nbsp;&nbsp;console.log('----------------------------------------------------');<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// With no agent (no connection pooling)<br>
&nbsp;&nbsp;const timeWithoutAgent = await makeMultipleRequests(false);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;console.log(''); // Separator<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// With agent (connection pooling)<br>
&nbsp;&nbsp;const timeWithAgent = await makeMultipleRequests(true);<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;console.log(''); // Separator<br>
&nbsp;&nbsp;console.log('Results:');<br>
&nbsp;&nbsp;console.log(`Without agent: ${timeWithoutAgent.toFixed(2)}ms`);<br>
&nbsp;&nbsp;console.log(`With agent: ${timeWithAgent.toFixed(2)}ms`);<br>
&nbsp;&nbsp;console.log(`Difference: ${(timeWithoutAgent - timeWithAgent).toFixed(2)}ms`);<br>
&nbsp;&nbsp;console.log(`Performance improvement: ${(100 * (timeWithoutAgent - timeWithAgent) / timeWithoutAgent).toFixed(2)}%`);<br>
}<br>
<br>
// Run the comparison<br>
runComparison().catch(console.error);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_agent_pooling">Run example &raquo;</a>
</div>

<hr>

<h2>Creating a Proxy Agent</h2>

<p>You can extend the Agent class to create a proxy agent:</p>
...
<br>
// A simple HTTP proxy agent implementation<br>
class HttpProxyAgent extends http.Agent {<br>
&nbsp;&nbsp;constructor(proxyUri, options = {}) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;super(options);<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.proxyUri = new URL(proxyUri);<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;<br>
&nbsp;&nbsp;// Override createConnection to connect through the proxy<br>
&nbsp;&nbsp;createConnection(options, callback) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Connect to the proxy server<br>
&nbsp;&nbsp;&nbsp;&nbsp;const proxySocket = net.connect({<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;host: this.proxyUri.hostname,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;port: this.proxyUri.port || 80,<br>
&nbsp;&nbsp;&nbsp;&nbsp;}, () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Create the HTTP CONNECT request to the target through the proxy<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;proxySocket.write(<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`CONNECT ${options.host}:${options.port} HTTP/1.1\r\n` +<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`Host: ${options.host}:${options.port}\r\n` +<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`Proxy-Connection: keep-alive\r\n` +<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Add proxy authentication if provided<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(this.proxyUri.username && this.proxyUri.password<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;? `Proxy-Authorization: Basic ${Buffer.from(<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`${this.proxyUri.username}:${this.proxyUri.password}`<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;).toString('base64')}\r\n`<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: '') +<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'\r\n'<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Data handler for proxy response<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;let proxyResponse = '';<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const onData = (chunk) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;proxyResponse += chunk.toString();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Check if we've received the full proxy response<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (proxyResponse.includes('\r\n\r\n')) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Parse status line<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const statusLine = proxyResponse.split('\r\n')[0];<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const statusCode = parseInt(statusLine.split(' ')[1], 10);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// If the proxy connection was successful<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (statusCode === 200) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Remove data listener, we don't need it anymore<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;proxySocket.removeListener('data', onData);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Callback with the socket<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;callback(null, proxySocket);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Proxy connection failed<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;proxySocket.destroy();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;callback(new Error(`Proxy connection failed: ${statusLine}`));<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;};<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;proxySocket.on('data', onData);<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Handle socket errors<br>
&nbsp;&nbsp;&nbsp;&nbsp;proxySocket.on('error', (err) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;callback(err);<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;return proxySocket;<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
// Example usage of the proxy agent<br>
const proxyAgent = new HttpProxyAgent('http://proxy.example.com:8080', {<br>
&nbsp;&nbsp;keepAlive: true<br>
});<br>
<br>
// Make a request through the proxy<br>
const options = {<br>
&nbsp;&nbsp;hostname: 'target-site.com',<br>
&nbsp;&nbsp;path: '/',<br>
&nbsp;&nbsp;method: 'GET',<br>
&nbsp;&nbsp;agent: proxyAgent<br>
};<br>
...
&nbsp;&nbsp;// Cleanup<br>
&nbsp;&nbsp;setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;proxyAgent.destroy();<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Proxy Agent destroyed');<br>
&nbsp;&nbsp;}, 1000);<br>
});<br>
<br>
req.on('error', (err) => {<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_ref_agent_proxy">Run example &raquo;</a>
</div>
...
<ol>
  <li><strong>Use keepAlive</strong>: Enable <code class="w3-codespan">keepAlive</code> for persistent connections to improve performance when making multiple requests to the same server.</li>
  <li><strong>Set maxSockets</strong>: Limit <code class="w3-codespan">maxSockets</code> to prevent overwhelming the target server or your own system's resources.</li>
  <li><strong>Clean up</strong>: Call <code class="w3-codespan">agent.destroy()</code> when the agent is no longer needed to free up resources.</li>
  <li><strong>Use custom agents</strong>: Create different agent instances for different connection requirements or target servers.</li>
  <li><strong>Monitor agent health</strong>: Track the number of active and free sockets to detect connection issues.</li>
  <li><strong>Security</strong>: For HTTPS agents, always set appropriate SSL/TLS options and keep security settings up to date.</li>
  <li><strong>Error handling</strong>: Always handle potential errors in HTTP requests.</li>
</ol>
