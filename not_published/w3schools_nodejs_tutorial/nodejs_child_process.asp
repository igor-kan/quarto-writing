...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Child Process Module</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">

<meta name="title" property="og:title" content="Node.js Child Process Module">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_child_process.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="The Child Process module is a built-in Node.js module that allows you to create and manage child processes.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Child Process Module">
<meta name="twitter:description" content="The Child Process module is a built-in Node.js module that allows you to create and manage child processes.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_child_process.png">
...
<h1>Node.js Child Process Module</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_performance.asp">&lt; Previous</a>
<a class="w3-right w3-btn" href="nodejs_cluster.asp">Next &gt;</a>
</div>

<hr>
<h2>What is the Child Process Module?</h2>
<p>The Child Process module is a built-in Node.js module that allows you to create and manage child processes.</p>
<p>It provides several ways to execute external commands and communicate with subprocess instances.</p>

<p>This capability is essential for tasks like:</p>
<ul>
  <li>Running system commands from your Node.js application</li>
  <li>Executing CPU-intensive tasks in separate processes</li>
  <li>Running multiple processes in parallel to utilize multiple CPU cores</li>
  <li>Interfacing with external programs and scripts</li>
</ul>

<hr>

<h2>Importing the Child Process Module</h2>

<p>The Child Process module is included in Node.js by default.</p>
<p>You can use it by requiring it in your script:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const childProcess = require('child_process');<br>
<br>
// Or using destructuring to access specific methods<br>
...
<h2>Methods for Creating Child Processes</h2>

<p>The Child Process module provides four primary methods for creating and managing child processes, each with different behaviors and use cases:</p>
...
<table class="ws-table-all">
  ...
  <tr>
    <td><code class="w3-codespan">exec()</code></td>
    <td>Spawns a shell and executes a command, buffering the output</td>
    <td>When you need to run a shell command and get the entire output at once</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">execFile()</code></td>
    <td>Similar to <code class="w3-codespan">exec()</code> but doesn't spawn a shell</td>
    <td>More efficient for executing file-based commands without shell interpretation</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">spawn()</code></td>
    <td>Spawns a new process without creating a shell, with streaming I/O</td>
    <td>When dealing with long-running processes or large output</td>
  </tr>
  <tr>
    <td><code class="w3-codespan">fork()</code></td>
    <td>A special case of <code class="w3-codespan">spawn()</code> for creating Node.js processes</td>
    <td>When you need to run another Node.js module as a separate process with IPC</td>
  </tr>
</table>
</div>
...
<p>The <code class="w3-codespan">exec()</code> method creates a shell and executes a command within that shell.</p>
<p>It buffers the entire output and provides it via a callback when the command completes.</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const { exec } = require('child_process');<br>
<br>
// Execute the 'ls -la' command (or 'dir' on Windows)<br>
const command = process.platform === 'win32' ? 'dir' : 'ls -la';<br>
<br>
exec(command, (error, stdout, stderr) => {<br>
&nbsp;&nbsp;if (error) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error(`Error executing command: ${error.message}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;return;<br>
&nbsp;&nbsp;}<br>
<br>
&nbsp;&nbsp;if (stderr) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error(`Command stderr: ${stderr}`);<br>
&nbsp;&nbsp;}<br>
<br>
...
// With options<br>
exec('echo $HOME', {<br>
&nbsp;&nbsp;env: { HOME: '/custom/home/directory' }<br>
}, (error, stdout, stderr) => {<br>
&nbsp;&nbsp;console.log(`Custom home directory: ${stdout.trim()}`);<br>
});</div>
</div>

<div class="w3-panel ws-warning">
<p><strong>Warning:</strong> Never pass unsanitized user input to <code class="w3-codespan">exec()</code> as it runs commands with full shell syntax, which can lead to command injection attacks.</p>
</div>

<h3>exec() with Promise</h3>

<p>Using a promise wrapper to handle the callback:</p>
...
<br>
// Convert exec to a promise-based function<br>
const execPromise = util.promisify(exec);<br>
<br>
async function executeCommand(command) {<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const { stdout, stderr } = await execPromise(command);<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (stderr) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error(`Command stderr: ${stderr}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
...
<br>
// Using the promise-based function<br>
executeCommand('node --version')<br>
&nbsp;&nbsp;.then(version => console.log(`Node.js version: ${version.trim()}`))<br>
&nbsp;&nbsp;.catch(err => console.error('Failed to get Node.js version'));<br>
</div>
</div>

<hr>

<h2>The execFile() Method</h2>

<p>The <code class="w3-codespan">execFile()</code> method is similar to <code class="w3-codespan">exec()</code>, but it doesn't spawn a shell.</p>
<p>It's more efficient for executing external binaries.</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const { execFile } = require('child_process');<br>
<br>
// Execute 'node' with arguments<br>
execFile('node', ['--version'], (error, stdout, stderr) => {<br>
&nbsp;&nbsp;if (error) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error(`Error executing file: ${error.message}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;return;<br>
&nbsp;&nbsp;}<br>
<br>
&nbsp;&nbsp;console.log(`Node.js version: ${stdout.trim()}`);<br>
});<br>
<br>
// On Windows, execute a batch file<br>
if (process.platform === 'win32') {<br>
&nbsp;&nbsp;execFile('C:\\Windows\\System32\\cmd.exe', ['/c', 'echo Hello from batch!'], (error, stdout, stderr) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (error) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error(`Error: ${error.message}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return;<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Output: ${stdout.trim()}`);<br>
&nbsp;&nbsp;});<br>
}</div>
</div>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> <code class="w3-codespan">execFile()</code> is more secure than <code class="w3-codespan">exec()</code> for running commands with user input, as it doesn't process shell metacharacters.</p>
</div>
...
<p>The <code class="w3-codespan">spawn()</code> method launches a new process with the given command.</p>
<p>Unlike <code class="w3-codespan">exec()</code>, it doesn't buffer the output, instead providing stream-based access to stdout and stderr.</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const { spawn } = require('child_process');<br>
<br>
// Spawn a process to list files<br>
const ls = process.platform === 'win32'<br>
&nbsp;&nbsp;? spawn('cmd', ['/c', 'dir'])<br>
&nbsp;&nbsp;: spawn('ls', ['-la']);<br>
<br>
// Handle process output streams<br>
ls.stdout.on('data', (data) => {<br>
&nbsp;&nbsp;console.log(`stdout: ${data}`);<br>
});<br>
<br>
ls.stderr.on('data', (data) => {<br>
&nbsp;&nbsp;console.error(`stderr: ${data}`);<br>
});<br>
<br>
ls.on('close', (code) => {<br>
...
<br>
// Spawn with options<br>
const grep = spawn('grep', ['hello', 'input.txt'], {<br>
&nbsp;&nbsp;cwd: '/tmp',         // Working directory<br>
&nbsp;&nbsp;env: { ...process.env, CUSTOM_ENV: 'value' },<br>
&nbsp;&nbsp;stdio: 'pipe',       // Configure stdio<br>
&nbsp;&nbsp;detached: false,     // Process group behavior<br>
&nbsp;&nbsp;shell: false         // Whether to run in a shell<br>
});<br>
<br>
// Handling errors<br>
grep.on('error', (err) => {<br>
&nbsp;&nbsp;console.error(`Failed to start subprocess: ${err.message}`);<br>
});</div>
</div>

<h3>When to Use spawn()</h3>

<p><code class="w3-codespan">spawn()</code> is especially useful for:</p>
<ul>
  <li>Long-running processes (like server processes or watchers)</li>
  <li>Processes that produce large amounts of output</li>
  <li>When you need to process data as it's generated, rather than waiting for completion</li>
</ul>

<h3>Using spawn() with stdin</h3>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const { spawn } = require('child_process');<br>
<br>
// Spawn a process that reads from stdin<br>
const process = spawn('wc', ['-w']); // Word count<br>
<br>
// Send data to the process's stdin<br>
process.stdin.write('Hello world from Node.js!');<br>
process.stdin.end(); // Signal the end of input<br>
<br>
// Capture output<br>
process.stdout.on('data', (data) => {<br>
&nbsp;&nbsp;console.log(`Number of words: ${data}`);<br>
});</div>
</div>
...
<p>The <code class="w3-codespan">fork()</code> method is a special case of <code class="w3-codespan">spawn()</code> specifically for creating Node.js processes. It sets up an IPC channel that allows sending messages between the parent and child processes.</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// In the main file (parent.js)<br>
const { fork } = require('child_process');<br>
<br>
// Fork a child process<br>
const child = fork('child.js');<br>
<br>
// Send a message to the child<br>
child.send({ message: 'Hello from parent' });<br>
<br>
// Receive messages from the child<br>
child.on('message', (message) => {<br>
&nbsp;&nbsp;console.log('Message from child:', message);<br>
});<br>
<br>
// Handle child process exit<br>
...
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// In the child file (child.js)<br>
console.log('Child process started', process.pid);<br>
<br>
// Listen for messages from the parent<br>
process.on('message', (message) => {<br>
&nbsp;&nbsp;console.log('Message from parent:', message);<br>
<br>
&nbsp;&nbsp;// Send a message back to the parent<br>
&nbsp;&nbsp;process.send({ response: 'Hello from child' });<br>
<br>  
&nbsp;&nbsp;// After 3 seconds, exit the process<br>
&nbsp;&nbsp;setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;process.exit(0);<br>
&nbsp;&nbsp;}, 8080);<br>
});</div>
...
<h3>Benefits of fork()</h3>

<ul>
  <li>Each forked process gets its own V8 instance and memory</li>
  <li>Isolates CPU-intensive work from the main event loop</li>
  <li>Allows communication between processes via messages</li>
  <li>Helps utilize multiple CPU cores</li>
</ul>
...
<p>Child processes created with <code class="w3-codespan">fork()</code> can communicate with the parent process through a built-in IPC channel using <code class="w3-codespan">send()</code> and the <code class="w3-codespan">message</code> event.</p>

<h3>Sending Complex Data</h3>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// In parent.js<br>
const { fork } = require('child_process');<br>
const child = fork('worker.js');<br>
<br>
// Send different types of data<br>
child.send({<br>
&nbsp;&nbsp;command: 'compute',<br>
&nbsp;&nbsp;data: [1, 2, 3, 4, 5],<br>
&nbsp;&nbsp;options: {<br>
...
child.on('message', (result) => {<br>
&nbsp;&nbsp;console.log('Computation result:', result);<br>
&nbsp;&nbsp;child.disconnect(); // Clean up the IPC channel<br>
});</div>
</div>
...
&nbsp;&nbsp; if (msg.command === 'compute') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const result = msg.data.map(num => num * msg.options.multiply - msg.options.subtract);<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Send the result back to the parent<br>
&nbsp;&nbsp;&nbsp;&nbsp;process.send({ result });<br>
&nbsp;&nbsp;}<br>
});</div>
</div>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> The messages are serialized using JSON, so you can only send JSON-compatible data (objects, arrays, strings, numbers, booleans, and null).</p>
</div>

<hr>

<h2>Managing Child Processes</h2>

<h3>Killing a Child Process</h3>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const { spawn } = require('child_process');<br>
<br>
// Spawn a long-running process<br>
const child = spawn('node', ['-e', `<br>
&nbsp;&nbsp;setInterval(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Still running...', Date.now());<br>
&nbsp;&nbsp;}, 1000);<br>
`]);<br>
<br>
...
<br>
// Kill the process after 5 seconds<br>
setTimeout(() => {<br>
&nbsp;&nbsp;console.log('Killing the child process...');<br>
<br>
&nbsp;&nbsp;// Send a SIGTERM signal<br>
&nbsp;&nbsp;child.kill('SIGTERM');<br>
<br>
&nbsp;&nbsp;// Alternative: child.kill() - uses SIGTERM by default<br>
}, 5000);<br>
<br>
// Handle the exit event<br>
child.on('exit', (code, signal) => {<br>
&nbsp;&nbsp;console.log(`Child process exited with code ${code} and signal ${signal}`);<br>
});</div>
</div>

<h3>Detached Processes</h3>

<p>You can create detached child processes that continue running independently of the parent:</p>
...
<br>
// Create a detached process<br>
const child = spawn('node', ['long_running_script.js'], {<br>
&nbsp;&nbsp;detached: true,<br>
&nbsp;&nbsp;stdio: ['ignore',<br>
&nbsp;&nbsp;&nbsp;&nbsp;fs.openSync('output.log', 'w'),<br>
&nbsp;&nbsp;&nbsp;&nbsp;fs.openSync('error.log', 'w')<br>
&nbsp;&nbsp;]<br>
});<br>
<br>
// Unref the child to allow the parent to exit independently<br>
child.unref();<br>
<br>
console.log(`Started detached process with PID: ${child.pid}`);<br>
console.log('Parent will exit while child continues running.');<br>
<br>
// The parent can now exit, and the child will continue running</div>
</div>
...
<h3>Creating a Simple Task Queue</h3>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// In tasks.js (parent)<br>
const { fork } = require('child_process');<br>
...
<br>
&nbsp;&nbsp;runNext() {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// If we have tasks and available workers<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (this.tasks.length > 0 && this.workers.length &lt; this.maxWorkers) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const task = this.tasks.shift();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;const worker = fork('worker.js');<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Starting worker for task ${task.id}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;this.workers.push(worker);<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;worker.send(task);<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;worker.on('message', (result) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Task ${task.id} completed with result:`, result);<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Remove this worker from our workers list<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;this.workers = this.workers.filter(w => w !== worker);<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Run the next task if we have one<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;this.runNext();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;worker.on('error', (err) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error(`Worker for task ${task.id} had an error:`, err);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;this.workers = this.workers.filter(w => w !== worker);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;this.runNext();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (code !== 0) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.error(`Worker for task ${task.id} exited with code ${code}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;id: i,<br>
&nbsp;&nbsp;&nbsp;&nbsp;type: 'calculation',<br>
&nbsp;&nbsp;&nbsp;&nbsp;data: Array.from({ length: 1000000 }, () => Math.random())<br>
&nbsp;&nbsp;});<br>
}</div>
</div>
...
<div class="w3-code notranslate jsHigh">
// In worker.js<br>
process.on('message', (task) => {<br>
&nbsp;&nbsp;console.log(`Worker ${process.pid} received task ${task.id}`);<br>
<br>  
&nbsp;&nbsp;// Simulate CPU-intensive work<br>
&nbsp;&nbsp;let result;<br>
<br>
&nbsp;&nbsp;if (task.type === 'calculation') {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// For example, find sum and average<br>
&nbsp;&nbsp;&nbsp;&nbsp;const sum = task.data.reduce((acc, val) => acc + val, 0);<br>
&nbsp;&nbsp;&nbsp;&nbsp;const avg = sum / task.data.length;<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;result = { sum, avg };<br>
&nbsp;&nbsp;}<br>
<br>
&nbsp;&nbsp;// Send result back to parent<br>
&nbsp;&nbsp;process.send({ taskId: task.id, result });<br>
<br>
&nbsp;&nbsp;// Exit this worker<br>
&nbsp;&nbsp;process.exit(0);<br>
});</div>
...
<h3>Running External Applications</h3>
...
const fs = require('fs');<br>
<br>
// Function to convert a video using ffmpeg<br>
function convertVideo(inputFile, outputFile, options = {}) {<br>
&nbsp;&nbsp;return new Promise((resolve, reject) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Make sure input file exists<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (!fs.existsSync(inputFile)) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return reject(new Error(`Input file ${inputFile} does not exist`));<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Prepare ffmpeg arguments<br>
&nbsp;&nbsp;&nbsp;&nbsp;const args = ['-i', inputFile];<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (options.scale) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;args.push('-vf', `scale=${options.scale}`);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (options.format) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;args.push('-f', options.format);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;args.push(outputFile);<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Spawn ffmpeg process<br>
&nbsp;&nbsp;&nbsp;&nbsp;const ffmpeg = spawn('ffmpeg', args);<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Collect output for logging<br>
&nbsp;&nbsp;&nbsp;&nbsp;let stdoutData = '';<br>
&nbsp;&nbsp;&nbsp;&nbsp;let stderrData = '';<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;ffmpeg.stdout.on('data', (data) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;stdoutData += data;<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;ffmpeg.stderr.on('data', (data) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;stderrData += data;<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Handle process completion<br>
&nbsp;&nbsp;&nbsp;&nbsp;ffmpeg.on('close', (code) => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (code === 0) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;resolve({<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;inputFile,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;outputFile,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;stdout: stdoutData,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;stderr: stderrData<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Handle process errors<br>
&nbsp;&nbsp;&nbsp;&nbsp;ffmpeg.on('error', reject);<br>
&nbsp;&nbsp;&nbsp;});<br>
}<br>
<br>
// Example usage (commented out)<br>
/*<br>
convertVideo('input.mp4', 'output.webm', {<br>
&nbsp;&nbsp;scale: '640:480',<br>
&nbsp;&nbsp;format: 'webm'<br>
})<br>
&nbsp;&nbsp;.then(result => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Video conversion successful!');<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Output file: ${result.outputFile}`)<br>;
&nbsp;&nbsp;})<br>
&nbsp;&nbsp;.catch(error => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.error('Video conversion failed:', error.message);<br>
&nbsp;&nbsp;});<br>
*/</div>
</div>
...
<ul>
  <li><strong>Input Sanitization:</strong> Always sanitize user inputs to prevent command injection attacks, especially with <code class="w3-codespan">exec()</code></li>
  <li><strong>Resource Management:</strong> Monitor and handle the resources (memory, file descriptors) used by child processes</li>
  <li><strong>Error Handling:</strong> Always have proper error handling for child processes</li>
  <li><strong>Choose the Right Method:</strong>
    <ul>
      <li>Use <code class="w3-codespan">exec()</code> for simple commands with limited output</li>
      <li>Use <code class="w3-codespan">spawn()</code> for long-running processes or large outputs</li>
      <li>Use <code class="w3-codespan">fork()</code> for CPU-intensive Node.js operations</li>
    </ul>
  </li>
  <li><strong>Cleanup:</strong> Properly kill child processes when they're no longer needed</li>
  <li><strong>Limit Concurrency:</strong> Control the number of concurrent child processes to avoid system overload</li>
</ul>

<div class="w3-panel ws-warning">
<p><strong>Warning:</strong> Running too many child processes can quickly exhaust system resources. Always implement rate limiting and concurrency control.</p>
</div>
...
<ul>
  <li><strong>Command Injection:</strong> Never pass unsanitized user input directly to <code class="w3-codespan">exec()</code> or <code class="w3-codespan">spawn()</code></li>
  <li><strong>Environment Variables:</strong> Be careful with passing environment variables to child processes</li>
  <li><strong>File Access:</strong> Understand the permissions that child processes may have</li>
  <li><strong>Resource Limits:</strong> Consider implementing timeouts and memory limits for child processes</li>
</ul>

<hr>
<div id="exercisecontainer" src="xrcise_child_process.js" data-extensions="asp"></div>
<hr>
<br>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="nodejs_performance.asp">&lt; Previous</a>
