...
<meta name="title" property="og:title" content="Node.js Timers Module">
<meta name="Keywords" content="HTML, Python, CSS, SQL, JavaScript, How to, PHP, Java, C, C++, C#, jQuery, Bootstrap, Colors, W3.CSS, XML, MySQL, Icons, NodeJS, React, Graphics, Angular, R, AI, Git, Data Science, Code Game, Tutorials, Programming, Web Development, Training, Learning, Quiz, Exercises, Courses, Lessons, References, Examples, Learn to code, Source code, Demos, Tips, Website">
<meta name="Description" content="Well organized and easy to understand Web building tutorials with lots of examples of how to use HTML, CSS, JavaScript, SQL, Python, PHP, Bootstrap, Java, XML and more.">
<meta property="og:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_timers.png">
<meta property="og:image:type" content="image/png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:description" content="The Timers module provides functions that help schedule code execution at specific times or intervals.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@w3schools">
<meta name="twitter:title" content="Node.js Timers Module">
<meta name="twitter:description" content="The Timers module provides functions that help schedule code execution at specific times or intervals.">
<meta name="twitter:image" content="https://www.w3schools.com/images/og/nodejs/nodejs_timers.png">
...
<h1>Node.js Timers Module</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="nodejs_crypto.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="nodejs_dns.asp">Next &#10095;</a>
</div>
<hr>
<h2>What is the Timers Module?</h2>

<p>The Timers module provides functions that help schedule code execution at specific times or intervals.</p>
<p>Unlike browser JavaScript, Node.js timing functions are provided as part of the Timers module, though they are available globally without requiring an explicit import.</p>

<p>Key features include:</p>
<ul>
  <li>Delayed execution with <code class="w3-codespan">setTimeout()</code></li>
  <li>Repeated execution with <code class="w3-codespan">setInterval()</code></li>
  <li>Immediate execution in the next event loop with <code class="w3-codespan">setImmediate()</code></li>
  <li>Promise-based APIs for modern async/await patterns</li>
</ul>

<p>These capabilities are essential for building responsive applications, implementing polling, handling delayed operations, and more.</p>

<hr>

<h2>Getting Started with Timers</h2>

<p>Here's a quick example of using the Timers module to schedule code execution:</p>

<div class="w3-example">
<h3>Basic Timer Example</h3>
<div class="w3-code notranslate jsHigh">const { setTimeout, setInterval, setImmediate } = require('timers');<br>
<br>
console.log('Starting timers...');<br>
<br>
// Execute once after delay<br>
setTimeout(() => {<br>
&nbsp; console.log('This runs after 1 second');<br>
}, 1000);<br>
<br>
// Execute repeatedly at interval<br>
let counter = 0;<br>
const interval = setInterval(() => {<br>
&nbsp;&nbsp;counter++;<br>
&nbsp;&nbsp;console.log(`Interval tick ${counter}`);<br>
&nbsp;&nbsp;if (counter >= 3) clearInterval(interval);<br>
}, 1000);<br>
<br>
// Execute in the next event loop iteration<br>
setImmediate(() => {<br>
&nbsp;&nbsp;console.log('This runs in the next iteration of the event loop');<br>
});<br>
<br>
console.log('Timers scheduled');</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_timers_quickstart">Run example &raquo;</a>
</div>
<hr>

<h2>Using the Timers Module</h2>

<p>The Timers module's functions are available globally, so you don't need to require them explicitly.</p>
<p>However, if you want to access advanced features or for clarity, you can import the module:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const timers = require('timers');<br>
<br>
// Or, for the promises API (Node.js 15.0.0+)<br>
...
<h2>setTimeout() and clearTimeout()</h2>

<p>The <code class="w3-codespan">setTimeout()</code> function schedules execution of a callback after a specified amount of time (in milliseconds).</p>
<p>It returns a <code class="w3-codespan">Timeout</code> object that can be used to cancel the timeout.</p>

<h3>Common Use Cases</h3>
<ul>
  <li>Delaying execution of non-critical tasks</li>
  <li>Implementing timeouts for operations</li>
  <li>Breaking up CPU-intensive tasks</li>
...
// Basic usage<br>
setTimeout(() => {<br>
&nbsp;&nbsp;console.log('This message is displayed after 2 seconds');<br>
}, 2000);<br>
<br>
// With arguments<br>
setTimeout((name) => {<br>
...
<br>
// Storing and clearing a timeout<br>
const timeoutId = setTimeout(() => {<br>
&nbsp;&nbsp;console.log('This will never be displayed');<br>
}, 5000);<br>
<br>
// Cancel the timeout before it executes<br>
clearTimeout(timeoutId);<br>
console.log('Timeout has been cancelled');
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_timers_settimeout">Run example &raquo;</a>
</div>

<h3>Promise-Based setTimeout</h3>

<p>Node.js 15.0.0 and later provide a promises-based API for timers:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const { setTimeout } = require('timers/promises');<br>
<br>
async function delayedGreeting() {<br>
&nbsp;&nbsp;console.log('Starting...');<br>
<br>
&nbsp;&nbsp;// Wait for 2 seconds<br>
&nbsp;&nbsp;await setTimeout(2000);<br>
<br>
&nbsp;&nbsp;console.log('After 2 seconds');<br>
<br>
&nbsp;&nbsp;// Wait for 1 second with a value<br>
&nbsp;&nbsp;const result = await setTimeout(1000, 'Hello, World!');<br>
<br>
&nbsp;&nbsp;console.log('After 1 more second:', result);<br>
}<br>
<br>
delayedGreeting().catch(console.error);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_timers_settimeout_promise">Run example &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">setInterval()</code> function calls a function repeatedly at specified intervals (in milliseconds).</p>
<p>It returns an <code class="w3-codespan">Interval</code> object that can be used to stop the interval.</p>

<h3>Common Use Cases</h3>
<ul>
  <li>Polling for updates</li>
  <li>Running periodic maintenance tasks</li>
  <li>Implementing heartbeat mechanisms</li>
  <li>Updating UI elements at regular intervals</li>
</ul>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> The actual interval between executions may be longer than specified if the event loop is blocked by other operations.</p>
</div>
...
&nbsp;&nbsp;counter++;<br>
&nbsp;&nbsp;console.log(`Interval executed ${counter} times`);<br>
<br>
&nbsp;&nbsp;// Stop after 5 executions<br>
&nbsp;&nbsp;if (counter >= 5) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;clearInterval(intervalId);<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Interval stopped');<br>
&nbsp;&nbsp;}<br>
}, 1000);<br>
<br>
// Interval with arguments<br>
const nameInterval = setInterval((name) => {<br>
&nbsp;&nbsp;console.log(`Hello, ${name}!`);<br>
}, 2000, 'Node.js');<br>
<br>
// Stop the name interval after 6 seconds<br>
setTimeout(() => {<br>
&nbsp;&nbsp;clearInterval(nameInterval);<br>
&nbsp;&nbsp;console.log('Name interval stopped');<br>
}, 6000);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_timers_setinterval">Run example &raquo;</a>
</div>

<h3>Promise-Based setInterval</h3>

<p>Using the promises API for intervals:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const { setInterval } = require('timers/promises');<br>
<br>
async function repeatedGreeting() {<br>
&nbsp;&nbsp;console.log('Starting interval...');<br>
<br>
&nbsp;&nbsp;// Create an async iterator from setInterval<br>
&nbsp;&nbsp;const interval = setInterval(1000, 'tick');<br>
<br>
&nbsp;&nbsp;// Limit to 5 iterations<br>
&nbsp;&nbsp;let counter = 0;<br>
<br>
&nbsp;&nbsp;for await (const tick of interval) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(counter + 1, tick);<br>
&nbsp;&nbsp;&nbsp;&nbsp;counter++;<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (counter >= 5) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;break; // Exit the loop, stopping the interval<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>
<br>
&nbsp;&nbsp;console.log('Interval finished');<br>
}<br>
<br>
repeatedGreeting().catch(console.error);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_timers_setinterval_promise">Run example &raquo;</a>
</div>

<hr>

<h2>setImmediate() and clearImmediate()</h2>

<p>The <code class="w3-codespan">setImmediate()</code> function schedules a callback to run in the next iteration of the event loop, after I/O events but before timers.</p>
<p>It's similar to using <code class="w3-codespan">setTimeout(callback, 0)</code> but more efficient.</p>

<h3>When to Use setImmediate()</h3>
<ul>
  <li>When you want to execute code after the current operation completes</li>
  <li>To break up long-running operations into smaller chunks</li>
  <li>To ensure callbacks run after I/O operations complete</li>
  <li>In recursive functions to prevent stack overflows</li>
</ul>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">console.log('Start');<br>
<br>
setTimeout(() => {<br>
&nbsp;&nbsp;console.log('setTimeout callback');<br>
}, 0);<br>
<br>
setImmediate(() => {<br>
&nbsp;&nbsp;console.log('setImmediate callback');<br>
});<br>
<br>
process.nextTick(() => {<br>
...
<br>
console.log('End');</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_timers_setimmediate">Run example &raquo;</a>
</div>

<p>The execution order will typically be:</p>
<ol>
  <li>Start</li>
  <li>End</li>
  <li>nextTick callback</li>
  <li>setTimeout callback or setImmediate callback (order can vary)</li>
</ol>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> The order of execution between <code class="w3-codespan">setTimeout(0)</code> and <code class="w3-codespan">setImmediate()</code> can be unpredictable when called from the main module.</p>
<p>However, inside an I/O callback, <code class="w3-codespan">setImmediate()</code> will always execute before any timers.</p>
</div>

<h3>Canceling an Immediate</h3>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const immediateId = setImmediate(() => {<br>
&nbsp;&nbsp;console.log('This will not be displayed');<br>
});<br>
<br>
clearImmediate(immediateId);<br>
console.log('Immediate has been cancelled');</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_timers_clearimmediate">Run example &raquo;</a>
</div>
...
<p>Although not part of the Timers module, <code class="w3-codespan">process.nextTick()</code> is a related function that defers a callback until the next iteration of the event loop, but executes it before any I/O events or timers.</p>

<h3>Key Characteristics</h3>
<ul>
  <li>Runs before any I/O events or timers</li>
  <li>Higher priority than <code class="w3-codespan">setImmediate()</code></li>
  <li>Processes all queued callbacks before the event loop continues</li>
  <li>Can lead to I/O starvation if overused</li>
</ul>

<h3>When to Use process.nextTick()</h3>
<ul>
  <li>To ensure a callback runs after the current operation but before any I/O</li>
  <li>To break up long-running operations</li>
  <li>To allow event handlers to be set up after an object is created</li>
  <li>To ensure consistent API behavior (e.g., making constructors work with or without `new`)</li>
</ul>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">console.log('Start');<br>
<br>
// Schedule three different types of callbacks<br>
setTimeout(() => {<br>
&nbsp;&nbsp;console.log('setTimeout executed');<br>
}, 0);<br>
<br>
setImmediate(() => {<br>
&nbsp;&nbsp;console.log('setImmediate executed');<br>
});<br>
<br>
process.nextTick(() => {<br>
&nbsp;&nbsp;console.log('nextTick executed');<br>
});<br>
<br>
console.log('End');</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_timers_nexttick">Run example &raquo;</a>
</div>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> <code class="w3-codespan">process.nextTick()</code> fires immediately on the same phase of the event loop, while <code class="w3-codespan">setImmediate()</code> fires on the following iteration or 'tick' of the event loop.</p>
</div>

<hr>
<h2>Advanced Timer Patterns</h2>

<h3>Debouncing</h3>
<p>Prevent a function from being called too frequently by delaying its execution:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">function debounce(func, delay) {<br>
&nbsp;&nbsp;let timeoutId;<br>
...
// Example usage<br>
const handleResize = debounce(() => {<br>
&nbsp;&nbsp;console.log('Window resized');<br>}, 300);<br>
// Call handleResize() on window resize</div>
</div>

<h3>Throttling</h3>
<p>Limit how often a function can be called over time:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">function throttle(func, limit) {<br>
&nbsp;&nbsp;let inThrottle = false;<br>
&nbsp;&nbsp;return function(...args) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (!inThrottle) {<br>
...
// Example usage<br>
const handleScroll = throttle(() => {<br>
&nbsp;&nbsp;console.log('Handling scroll');<br>}, 200);<br>
// Call handleScroll() on window scroll</div>
</div>

<h3>Sequential Timeouts</h3>
<p>Execute a series of operations with delays between them:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">function sequentialTimeouts(callbacks, delay = 1000) {<br>
&nbsp;&nbsp;let index = 0;<br>
&nbsp;&nbsp;function next() {<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (index < callbacks.length) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;callbacks[index]();<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;index++;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;setTimeout(next, delay);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;next();<br>
}<br>
// Example usage<br>
sequentialTimeouts([<br>
...
<hr>
<h2>Timer Behavior and Best Practices</h2>

<h3>Timer Precision and Performance</h3>

<p>Node.js timers are not precise to the millisecond. The actual delay might be slightly longer due to:</p>

<ul>
  <li>System load and CPU usage</li>
  <li>Event loop blocking operations</li>
  <li>Other timers and I/O operations</li>
  <li>System timer resolution (typically 1-15ms)</li>
</ul>

<h4>Measuring Timer Accuracy</h4>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">const desiredDelay = 100; // 100ms<br>
const start = Date.now();<br>
<br>
setTimeout(() => {<br>
&nbsp;&nbsp;const actualDelay = Date.now() - start;<br>
&nbsp;&nbsp;console.log(`Desired delay: ${desiredDelay}ms`);<br>
&nbsp;&nbsp;console.log(`Actual delay: ${actualDelay}ms`);<br>
&nbsp;&nbsp;console.log(`Difference: ${actualDelay - desiredDelay}ms`);<br>
}, desiredDelay);</div>
</div>

<h3>Memory and Resource Management</h3>

<p>Proper management of timers is crucial to prevent memory leaks and excessive resource usage:</p>

<h4>Common Memory Leak Patterns</h4>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">// Leak: Interval keeps running even if not needed<br>
function startService() {<br>
&nbsp;&nbsp;setInterval(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;fetchData();<br>
&nbsp;&nbsp;}, 1000);<br>
}<br>
// Leak: Timeout with closure over large object<br>
function processData(data) {<br>
&nbsp;&nbsp;setTimeout(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log('Processing complete');<br>
&nbsp;&nbsp; // 'data' is kept in memory until the timeout fires<br>
&nbsp;&nbsp;}, 10000, data);<br>
}</div>
</div>
...
<ul>
  <li>Always clear intervals and timeouts when they're no longer needed</li>
  <li>Store timer IDs in a way that allows for cleanup</li>
  <li>Be cautious with closures in timer callbacks</li>
  <li>Use <code class="w3-codespan">clearTimeout()</code> and <code class="w3-codespan">clearInterval()</code> in cleanup functions</li>
</ul>

<p>Remember to clear timers when they're no longer needed, especially in long-running applications, to prevent memory leaks:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// Bad practice in a server context<br>
function startServer() {<br>
&nbsp;&nbsp;setInterval(() => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// This interval will run forever and prevent proper cleanup<br>
...
&nbsp;&nbsp;}, 60000);<br>
<br>
&nbsp;&nbsp;// Store the interval ID for later cleanup<br>
&nbsp;&nbsp;return {<br>
&nbsp;&nbsp;&nbsp;&nbsp;stop: () => {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;clearInterval(intervalId);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Server stopped');<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;};<br>
}<br>
<br>
// Example usage<br>
const server = startServer();<br>
<br>
// Stop the server after 3 minutes<br>
setTimeout(() => {<br>
&nbsp;&nbsp;server.stop();<br>
}, 180000);</div>
</div>

<h3>Zero-Delay Timeouts</h3>

<p>When using <code class="w3-codespan">setTimeout(callback, 0)</code>, the callback doesn't execute immediately.</p>
<p>It executes after the current event loop cycle completes, which can be used to "break up" CPU-intensive tasks:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
function processArray(array, processFunction) {<br>
&nbsp;&nbsp;const chunkSize = 1000;<br>
&nbsp;&nbsp;let index = 0;<br>
<br>
&nbsp;&nbsp;function processChunk() {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const chunk = array.slice(index, index + chunkSize);<br>
&nbsp;&nbsp;&nbsp;&nbsp;chunk.forEach(processFunction);<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;index += chunkSize;<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (index &lt; array.length) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;setTimeout(processChunk, 0); // Yield to the event loop<br>
&nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log('Processing complete');<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;}<br>
...
<br>
// Example usage<br>
const bigArray = Array(10000).fill().map((_, i) => i);<br>
<br>
console.log('Starting processing...');<br>
processArray(bigArray, (item) => {<br>
&nbsp;&nbsp;// Simple processing<br>
&nbsp;&nbsp;if (item % 5000 === 0) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log(`Processed item ${item}`);<br>
&nbsp;&nbsp;}<br>
});<br>
console.log('This will log before processing completes');</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_timers_zero_delay">Run example &raquo;</a>
</div>

<hr>

<div id="exercisecontainer" src="xrcise_timers.js" data-extensions="asp"></div>
