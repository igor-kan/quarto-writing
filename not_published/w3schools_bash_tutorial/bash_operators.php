...
ny:-->
    ...
    <h1>Bash Operators</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_data_types.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_conditions.php">Next &#10095;</a>
</div>

<hr>

<h2>Understanding Bash Operators</h2>
<p>This section provides an overview of operators used in Bash scripting, including comparison, string, arithmetic, logical, and file test operators.</p>

<hr>

<h2>Comparison Operators</h2>
<ul>
<li><code class="language-bash">-eq</code>: Equal to</li>
<li><code class="language-bash">-ne</code>: Not equal to</li>
<li><code class="language-bash">-lt</code>: Less than</li>
<li><code class="language-bash">-le</code>: Less than or equal to</li>
<li><code class="language-bash">-gt</code>: Greater than</li>
<li><code class="language-bash">-ge</code>: Greater than or equal to</li>
</ul>
<hr>
<h2>String Comparison Operators</h2>
<ul>
<li><code class="language-bash">=</code>: Equal to</li>
<li><code class="language-bash">!=</code>: Not equal to</li>
<li><code class="language-bash">&lt;</code>: Less than, in ASCII alphabetical order</li>
<li><code class="language-bash">&gt;</code>: Greater than, in ASCII alphabetical order</li>
</ul>
<hr>
...
<ul>
<li><code class="language-bash">+</code>: Addition</li>
<li><code class="language-bash">-</code>: Subtraction</li>
<li><code class="language-bash">*</code>: Multiplication</li>
<li><code class="language-bash">/</code>: Division</li>
<li><code class="language-bash">%</code>: Modulus (remainder of division)</li>
<li>For exponentiation, use external tools like <code class="language-bash">bc</code> or <code class="language-bash">awk</code>.</li>
</ul>
<hr>
<h2>Logical Operators</h2>
<ul>
<li><code class="language-bash">&&</code>: Logical AND</li>
<li><code class="language-bash">||</code>: Logical OR</li>
<li><code class="language-bash">!</code>: Logical NOT</li>
</ul>
<hr>
<h2>File Test Operators</h2>
<ul>
<li><code class="language-bash">-e</code>: Checks if a file exists</li>
<li><code class="language-bash">-d</code>: Checks if a directory exists</li>
<li><code class="language-bash">-f</code>: Checks if a file is a regular file</li>
<li><code class="language-bash">-s</code>: Checks if a file is not empty</li>
</ul>
