...
<html lang="en-US">
<head>
<title>Bash pwd Command - Print Working Directory</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Bash <code class="language-bash">pwd</code> Command - Print Working Directory</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_cd.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_echo.php">Next &#10095;</a>
</div>
<hr>
<h2>Using the <code class="language-bash">pwd</code> Command</h2>
<p>The <code class="language-bash">pwd</code> command shows you the full path of the folder you're currently in.</p>

<hr>

<h2>Basic Usage</h2>
<p>To see the full path of the current folder, just type <code class="language-bash">pwd</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<div>
<pre class="command-line" data-output="2"><code class="language-bash">pwd
/home/user/my_directory</code></pre>
</div>
</div>
...
<p>The <code class="language-bash">pwd</code> command supports a few options to customize its output:</p>
<ul>
<li><code class="language-bash">-L</code>: Display the logical current working directory</li>
<li><code class="language-bash">-P</code>: Display the physical current working directory (without symbolic links)</li>
</ul>

<hr>
<h2><code class="language-bash">-L</code> Option: Logical Path</h2>
<p>The <code class="language-bash">-L</code> option shows the logical path, including any symbolic links.</p>
<p>This is the default behavior of <code class="language-bash">pwd</code>.</p>
<div class="w3-example">
<h3>Example: Logical Path</h3>
<div>
<pre class="command-line" data-output="2"><code class="language-bash">pwd -L
/home/user/my_directory</code></pre>
</div>
</div>
<hr>
...
<h2><code class="language-bash">-P</code> Option: Physical Path</h2>
<p>The <code class="language-bash">-P</code> option shows the physical path, resolving any symbolic links to their actual locations.</p>
<p>This is useful when you need to know the exact physical directory structure.</p>
<div class="w3-example">
<h3>Example: Physical Path</h3>
<div>
<pre class="command-line"><code class="language-bash">pwd -P</code></pre>
</div>
</div>

<hr>

<h2>Why Knowing Your Current Directory is Important</h2>
<p>Knowing which folder you're in is important when moving around the filesystem. It helps you make sure you're in the right place when running commands that use relative paths.</p>

<hr>
<h2>Common Use Cases for <code class="language-bash">pwd</code></h2>
<ul>
<li><strong>Running Scripts:</strong> Make sure your script is using the right files and folders.</li>
<li><strong>Managing Files:</strong> Check where you are before copying or moving files to avoid mistakes.</li>
<li><strong>Fixing Problems:</strong> Knowing your current folder can help you solve path-related issues.</li>
</ul>

<hr>
<div id="exercisecontainer" src="xrcise_pwd.js" data-extensions="php"></div>
<hr>
