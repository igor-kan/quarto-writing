...
<html lang="en-US">
<head>
<title>Bash ps Command - Snapshot of Current Processes</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Bash <code class="language-bash">ps</code> Command - Snapshot of Current Processes</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_head.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_top.php">Next &#10095;</a>
</div>
<hr>

<h2>Using the <code class="language-bash">ps</code> Command</h2>
<p>The <code class="language-bash">ps</code> command is used to report a snapshot of current processes.</p>
<p>It's a useful tool for monitoring and managing processes on your system.</p>

<p>All examples below use a hypothetical process list for demonstration:</p>
<pre><code class="language-bash">PID TTY          TIME CMD
...
<p>The <code class="language-bash">ps</code> command output consists of several columns, each representing different aspects of the system's processes:</p>
<ul>
...
<li><strong>TIME</strong>: Total CPU time used by the process.</li>
<li><strong>CMD</strong>: The command that started the process.</li>
</ul>

<hr>

<h2>Basic Usage</h2>
<p>To display a snapshot of current processes, use <code class="language-bash">ps</code>:</p>
<div class="w3-example">
<h3>Example: Basic Usage</h3>
<div>
<pre class="command-line" data-output="2-5"><code class="language-bash">ps
PID TTY          TIME CMD
1234 pts/0    00:00:01 bash
5678 pts/1    00:00:02 python
9101 pts/2    00:00:03 node</code></pre>
</div>
</div>
<hr>
...
<h2>Options</h2>
<p>The <code class="language-bash">ps</code> command has options to change how it works:</p>
<ul>
<li><code class="language-bash">-e</code> - Show all processes</li>
<li><code class="language-bash">-f</code> - Show detailed information</li>
<li><code class="language-bash">-u</code> - Show processes for a specific user</li>
<li><code class="language-bash">-a</code> - Show all processes with a terminal</li>
<li><code class="language-bash">-x</code> - Show processes without a terminal</li>
</ul>
<hr>
<h2>Show All Processes</h2>
<p>The <code class="language-bash">-e</code> option allows you to show all processes.</p>
<div class="w3-example">
<h3>Example: Show All Processes</h3>
<div>
<pre class="command-line" data-output="2-5"><code class="language-bash">ps -e
PID TTY          TIME CMD
1234 pts/0    00:00:01 bash
5678 pts/1    00:00:02 python
9101 pts/2    00:00:03 node</code></pre>
...
<p>The <code class="language-bash">-f</code> option allows you to show detailed information.</p>
<div class="w3-example">
<h3>Example: Show Detailed Information</h3>
<div>
<pre class="command-line" data-output="2-5"><code class="language-bash">ps -f
UID        PID  PPID  C STIME TTY          TIME CMD
user      1234     1  0 08:00 pts/0    00:00:01 bash
user      5678  1234  0 08:01 pts/1    00:00:02 python
user      9101  5678  0 08:02 pts/2    00:00:03 node</code></pre>
</div>
</div>

<hr>

<h2>Show Processes for a Specific User</h2>
<p>The <code class="language-bash">-u</code> option allows you to show processes for a specific user.</p>
<div class="w3-example">
<h3>Example: Show Processes for a Specific User</h3>
<div>
<pre class="command-line" data-output="2-4"><code class="language-bash">ps -u user
PID TTY          TIME CMD
1234 pts/0    00:00:01 bash
5678 pts/1    00:00:02 python</code></pre>
</div>
</div>

<hr>

<h2>Show Processes with a Terminal</h2>
<p>The <code class="language-bash">-a</code> option allows you to show all processes with a terminal.</p>
<div class="w3-example">
<h3>Example: Show Processes with a Terminal</h3>
<div>
<pre class="command-line" data-output="2-4"><code class="language-bash">ps -a
PID TTY          TIME CMD
1234 pts/0    00:00:01 bash
5678 pts/1    00:00:02 python</code></pre>
</div>
...
<h2>Show Processes without a Terminal</h2>
<p>The <code class="language-bash">-x</code> option allows you to show processes without a terminal.</p>
<div class="w3-example">
<h3>Example: Show Processes without a Terminal</h3>
<div>
<pre class="command-line" data-output="2-5"><code class="language-bash">ps -x
PID TTY          TIME CMD
9101 ?        00:00:03 node</code></pre>
</div>
</div>
...
<p>Options can be combined to provide more detailed output. For example, <code class="language-bash">ps -ef</code> shows all processes with detailed information.</p>
<div class="w3-example">
<h3>Example: Combine Options</h3>
<div>
<pre class="command-line" data-output="2-5"><code class="language-bash">ps -ef
UID        PID  PPID  C STIME TTY          TIME CMD
user      1234     1  0 08:00 pts/0    00:00:01 bash
user      5678  1234  0 08:01 pts/1    00:00:02 python
user      9101  5678  0 08:02 pts/2    00:00:03 node</code></pre>
...
<hr>
<div id="exercisecontainer" src="xrcise_ps.js" data-extensions="php"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_head.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_top.php">Next &#10095;</a>
