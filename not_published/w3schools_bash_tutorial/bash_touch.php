...
<html lang="en-US">
<head>
<title>Bash touch Command - Change File Timestamps</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Bash <code class="language-bash">touch</code> Command - Change File Timestamps</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_rm.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_mkdir.php">Next &#10095;</a>
</div>

<hr>
<h2>Using the <code class="language-bash">touch</code> Command</h2>
<p>The <code class="language-bash">touch</code> command is used to change file timestamps or create an empty file if it doesn't exist.</p>
<p>It's often used to create placeholder files or update timestamps for build systems.</p>

<hr>

<h2>Basic Usage</h2>
<p>To update the access and modification times of a file, use <code class="language-bash">touch filename</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<div>
<pre class="command-line"><code class="language-bash">touch file.txt</code></pre>
</div>
</div>
...
<h2>Options</h2>
<p>The <code class="language-bash">touch</code> command has options to change how it works:</p>
<ul>
<li><code class="language-bash">-a</code> - Update only when the file was last read</li>
<li><code class="language-bash">-m</code> - Update only when the file was last changed</li>
<li><code class="language-bash">-t</code> - Set the timestamp to a specific time</li>
<li><code class="language-bash">-c</code> - Do not create any files</li>
</ul>

<hr>
<h2><code class="language-bash">-a</code> Option: Change Access Time</h2>
<p>The <code class="language-bash">-a</code> option lets you update the access time of a file.</p>
<div class="w3-example">
<h3>Example: Change Access Time</h3>
<div>
<pre class="command-line"><code class="language-bash">touch -a file.txt</code></pre>
</div>
</div>
<hr>
...
<h2><code class="language-bash">-m</code> Option: Change Modification Time</h2>
<p>The <code class="language-bash">-m</code> option lets you update only the modification time of a file.</p>
<div class="w3-example">
<h3>Example: Change Modification Time</h3>
<div>
<pre class="command-line" data-output="2,5"><code class="language-bash">ls -l
-rw-r--r-- 1 user 197609 208 Apr  9 06:24 my_file.txt
touch -m my_file.txt
ls -l
-rw-r--r-- 1 user 197609 208 Apr  9 08:25 my_file.txt</code></pre>
</div>
</div>

<hr>

<h2><code class="language-bash">-t</code> Option: Set Specific Timestamp</h2>
<p>The <code class="language-bash">-t</code> option allows you to set the timestamp to a specific time.</p>
<div class="w3-example">
<h3>Example: Set Specific Timestamp</h3>
<div>
<pre class="command-line" data-output="2,5"><code class="language-bash">ls -l
-rw-r--r-- 1 user 197609 208 Apr  9 06:24 my_file.txt
touch -t 202501010000 my_file.txt
ls -l
-rw-r--r-- 1 user 197609 208 Jan  1 00:00 my_file.txt</code></pre>
</div>
</div>

<hr>

<h2><code class="language-bash">-c</code> Option: Do Not Create Files</h2>
<p>The <code class="language-bash">-c</code> option tells <code class="language-bash">touch</code> not to create any files if they do not exist.</p>
<p>This is useful when you want to update timestamps without accidentally creating new files.</p>
<div class="w3-example">
<h3>Example: Do Not Create Files</h3>
<div>
<pre class="command-line"><code class="language-bash">touch -c non_existent_file.txt</code></pre>
</div>
</div>

<hr>

<h2>Using <code class="language-bash">touch</code> with Wildcards</h2>
<p>Wildcards allow you to update timestamps on multiple files at once.</p>
<p>For example, <code class="language-bash">touch *.txt</code> will update the timestamps of all text files in the directory.</p>
<div class="w3-example">
<h3>Example: Using Wildcards</h3>
<div>
<pre class="command-line"><code class="language-bash">touch *.txt</code></pre>
</div>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_touch.js" data-extensions="php"></div>
<hr>
