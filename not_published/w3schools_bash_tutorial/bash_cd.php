...
<html lang="en-US">
<head>
<title>Bash cd - Change Directory</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Bash <code class="language-bash">cd</code> - Change Directory</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_ls.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_pwd.php">Next &#10095;</a>
</div>
<hr>

<h2>Using the <code class="language-bash">cd</code> Command</h2>
<p>The <code class="language-bash">cd</code> command is used to change the current working directory in the terminal.</p>


<hr>

<h2>Basic Usage</h2>
<p>To change to a specific directory, use <code class="language-bash">cd directory_name</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<div>
<pre class="command-line"><code class="language-bash">cd my_directory</code></pre>
</div>
</div>
...
<p>The <code class="language-bash">cd</code> command supports several useful options for navigating directories:</p>
<ul>
<li><code class="language-bash">cd ..</code>: Move up one directory level</li>
<li><code class="language-bash">cd ~</code>: Change to the home directory</li>
<li><code class="language-bash">cd -</code>: Switch to the previous directory</li>
<li><code class="language-bash">cd /</code>: Change to the root directory</li>
</ul>

<hr>
<h2><code class="language-bash">cd ..</code> Option: Move Up One Directory Level</h2>
<p>The <code class="language-bash">cd ..</code> command lets you go to the folder above your current one.</p>
<p>It's useful when you need to go to the parent folder.</p>
<div class="w3-example">
<h3>Example</h3>
<div>
<pre class="command-line"><code class="language-bash">cd ..</code></pre>
</div>
</div>
<hr>
...
<h2><code class="language-bash">cd ~</code> Option: Change to Home Directory</h2>
<p>The <code class="language-bash">cd ~</code> command takes you to your home directory, which is the default directory for your user account.</p>
<p>This option is useful when you need to return to your starting point after navigating through various directories.</p>
<div class="w3-example">
<h3>Example</h3>
<div>
<pre class="command-line"><code class="language-bash">cd ~</code></pre>
...
<hr>
<h2><code class="language-bash">cd -</code> Option: Switch to Previous Directory</h2>
<p>The <code class="language-bash">cd -</code> command switches your working directory to the previous one you were in.</p>
<p>This option is useful for toggling between two directories without needing to type their full paths repeatedly.</p>
<div class="w3-example">
<h3>Example</h3>
<div>
<pre class="command-line"><code class="language-bash">cd -</code></pre>
...
<hr>
<h2><code class="language-bash">cd /</code> Option: Change to Root Directory</h2>
<p>The <code class="language-bash">cd /</code> command takes you to the root directory of the file system.</p>
<p>This option is useful when you need to access system-wide files or directories.</p>
<div class="w3-example">
<h3>Example</h3>
<div>
<pre class="command-line"><code class="language-bash">cd /</code></pre>
...
<p>The <code class="language-bash">cd</code> command itself does not support combining options, but you can use it in conjunction with other commands to enhance navigation efficiency.</p>
<p>For example, using <code class="language-bash">cd</code> with <code class="language-bash">ls</code> can quickly show you the contents of a directory you navigate to:</p>
<div class="w3-example">
<h3>Example: Change and List</h3>
<div>
<pre class="command-line" data-output="2-3"><code class="language-bash">cd my_directory && ls
copy_of_my_file.txt  Cosmere_RPG_Beta_Rules_Preview.pdf
images/  my_file.txt  myfolder/  report.csv  voiceover.wav</code></pre>
</div>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_cd.js" data-extensions="php"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_ls.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_pwd.php">Next &#10095;</a>
