...
<html lang="en-US">
<head>
<title>Bash cat Command - Concatenate and Display Files</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Bash <code class="language-bash">cat</code> Command - Concatenate and Display Files</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_echo.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_cp.php">Next &#10095;</a>
</div>
<hr>
<h2>Using the <code class="language-bash">cat</code> Command</h2>
<p>The <code class="language-bash">cat</code> command is used to show the content of files in the terminal.</p>
<p>You can also use it to combine multiple files into one.</p>
<hr>
<h2>Basic Usage</h2>
<p>To display the content of a file, use <code class="language-bash">cat filename</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<div>
<pre class="command-line" data-output="2-6"><code class="language-bash">cat my_file.txt
...
is popular because it's powerful and easy to use.</code></pre>
</div>
</div>
<hr>
<h2>Options</h2>
<p>The <code class="language-bash">cat</code> command has options to change how it shows text:</p>
<ul>
<li><code class="language-bash">-n</code> - Add numbers to each line</li>
<li><code class="language-bash">-b</code> - Add numbers only to lines with text</li>
<li><code class="language-bash">-s</code> - Remove extra empty lines</li>
<li><code class="language-bash">-v</code> - Show non-printing characters (except for tabs and end of line)</li>
</ul>

<hr>
<h2><code class="language-bash">-n</code> Option: Number All Lines</h2>
<p>The <code class="language-bash">-n</code> option adds numbers to each line of the output.</p>
<div class="w3-example">
<h3>Example: Number All Lines</h3>
<div>
<pre class="command-line" data-output="2-6"><code class="language-bash">cat -n my_file.txt
    ...
    5  is popular because it's powerful and easy to use.</code></pre>
</div>
</div>
<hr>
...
<h2><code class="language-bash">-b</code> Option: Number Non-Blank Lines</h2>
<p>The <code class="language-bash">-b</code> option adds numbers only to lines with text, ignoring blank lines.</p>
<div class="w3-example">
<h3>Example: Number Non-Blank Lines</h3>
<div>
<pre class="command-line" data-output="2-6"><code class="language-bash">cat -b my_file.txt
    1  Understanding Shells
    2  A shell is a text-based interface that lets you talk to your computer.

    3  There are different types of shells. Bash (Bourne Again SHell)
    4  is popular because it's powerful and easy to use.</code></pre>
</div>
</div>
<hr>
<h2><code class="language-bash">-s</code> Option: Suppress Repeated Empty Lines</h2>
<p>The <code class="language-bash">-s</code> option removes extra empty lines from the output, leaving only a single blank line where multiple ones existed.</p>
<div class="w3-example">
<h3>Example: Suppress Repeated Empty Lines</h3>
<div>
<pre class="command-line" data-output="2-6"><code class="language-bash">cat -s my_file.txt
Understanding Shells
A shell is a text-based interface that lets you talk to your computer.
There are different types of shells. Bash (Bourne Again SHell)
is popular because it's powerful and easy to use.</code></pre>
...
<hr>
<h2><code class="language-bash">-v</code> Option: Show Non-Printing Characters</h2>
<p>The <code class="language-bash">-v</code> option makes non-printing characters visible, except for tabs and end-of-line characters.</p>
<p>This is useful for debugging files with hidden characters.</p>
<div class="w3-example">
<h3>Example: Show Non-Printing Characters</h3>
<div>
<pre class="command-line"><code class="language-bash">cat -v my_file.txt</code></pre>
</div>
</div>
<hr>
<h2>Concatenate Two Files</h2>
<p>The <code class="language-bash">cat</code> command can be used to concatenate multiple files into one.</p>
<p>This is useful for combining files or appending content to an existing file.</p>
<div class="w3-example">
<h3>Example: Concatenate Two Files</h3>
<div>
<pre class="command-line"><code class="language-bash">cat file1.txt file2.txt > combined.txt</code></pre>
<p>This command takes the contents of <code class="language-bash">file1.txt</code> and <code class="language-bash">file2.txt</code> and writes them into <code class="language-bash">combined.txt</code>.</p>
</div>
</div>

<hr>
<h2>Using <code class="language-bash">cat</code> with Piping</h2>
<p>The <code class="language-bash">cat</code> command is often used with piping to send the content of files to other commands.</p>
<p>This is useful for processing text data.</p>
<div class="w3-example">
<h3>Example</h3>
<div>
<pre class="command-line" data-output="2-3"><code class="language-bash">cat my_file.txt | grep "shells"
Understanding Shells
There are different types of shells. Bash (Bourne Again SHell)</code></pre>
</div>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_cat.js" data-extensions="php"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_echo.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_cp.php">Next &#10095;</a>
