...
<html lang="en-US">
<head>
<title>Bash scp Command - Secure Copy</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Bash <code class="language-bash">scp</code> Command - Secure Copy</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_ssh.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_rsync.php">Next &#10095;</a>
</div>

<hr>
<h2>Using the <code class="language-bash">scp</code> Command</h2>
<p>The <code class="language-bash">scp</code> command is used to securely copy files between hosts on a network.</p>

<hr>

<h2>Basic Usage</h2>
<p>To copy a file to a remote host, use <code class="language-bash">scp file user@hostname:/path</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<div>
<pre class="command-line" data-output="2-3"><code class="language-bash">scp file.txt user@example.com:/home/user/
...
<h2>Options</h2>
<p>The <code class="language-bash">scp</code> command supports various options to customize its behavior:</p>
<ul>
<li><code class="language-bash">-r</code> - Recursively copy entire directories</li>
<li><code class="language-bash">-P</code> - Specify the port to connect to on the remote host</li>
<li><code class="language-bash">-i</code> - Specify an identity (private key) file</li>
<li><code class="language-bash">-C</code> - Enable compression</li>
<li><code class="language-bash">-v</code> - Enable verbose mode</li>
<li><code class="language-bash">-l</code> - Limit the bandwidth used by the copy</li>
</ul>
<hr>
...
<h2>Option: -r (Recursive Copy)</h2>
<p>The <code class="language-bash">-r</code> option allows you to recursively copy entire directories.</p>
<div class="w3-example">
<h3>Example: Recursive Copy</h3>
<div>
<pre class="command-line" data-output="2-6"><code class="language-bash">scp -r /path/to/directory user@example.com:/home/user/
user@example.com's password: 
...
<h2>Option: -P (Port)</h2>
<p>The <code class="language-bash">-P</code> option allows you to specify a port to connect to on the remote host.</p>
<p>By default, SCP uses port 22.</p>
<div class="w3-example">
<h3>Example: Specify Port</h3>
<div>
<pre class="command-line" data-output="2-3"><code class="language-bash">scp -P 2222 file.txt user@example.com:/home/user/
user@example.com's password: 
file.txt</code></pre>
</div>
</div>
...
<div>
<pre class="command-line" data-output="2"><code class="language-bash">scp -i /path/to/private_key file.txt user@example.com:/home/user/
file.txt</code></pre>
</div>
</div>
<hr>
...
<p>The <code class="language-bash">-C</code> option enables compression, which can speed up file transfer by reducing the amount of data sent over the network.</p>
<div class="w3-example">
<h3>Example: Enable Compression</h3>
<div>
<pre class="command-line" data-output="2-3"><code class="language-bash">scp -C file.txt user@example.com:/home/user/
user@example.com's password: 
file.txt</code></pre>
</div>
</div>
...
<p>The <code class="language-bash">-v</code> option enables verbose mode, providing detailed output about the file transfer process.</p>
<p>This is helpful for debugging.</p>
<div class="w3-example">
<h3>Example: Verbose Mode</h3>
<div>
<pre class="command-line" data-output="2-4"><code class="language-bash">scp -v file.txt user@example.com:/home/user/
...
<h2>Option: -l (Limit Bandwidth)</h2>
<p>The <code class="language-bash">-l</code> option allows you to limit the bandwidth used by the copy. This is useful for managing network resources.</p>
<div class="w3-example">
<h3>Example: Limit Bandwidth</h3>
<div>
<pre class="command-line" data-output="2-3"><code class="language-bash">scp -l 100 file.txt user@example.com:/home/user/
user@example.com's password: 
file.txt</code></pre>
</div>
</div>
<hr>
<h2>Understanding SCP Output</h2>
<p>The output of the <code class="language-bash">scp</code> command will vary depending on the options used. Here are some common elements:</p>
<ul>
<li><strong>Transfer Progress:</strong> Shows progress of the file transfer.</li>
<li><strong>File Size:</strong> The size of the file being transferred.</li>
<li><strong>Transfer Speed:</strong> The speed at which the file is being transferred.</li>
<li><strong>Time Remaining:</strong> Estimated time remaining for the transfer to complete.</li>
</ul>
<hr>
<div id="exercisecontainer" src="xrcise_scp.js" data-extensions="php"></div>
<hr>
