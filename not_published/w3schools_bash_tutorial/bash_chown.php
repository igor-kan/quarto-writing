...
<html lang="en-US">
<head>
<title>Bash chown Command - Change File Ownership</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Bash <code class="language-bash">chown</code> Command - Change File Ownership</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_chmod.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_chgrp.php">Next &#10095;</a>
</div>
<hr>

<h2>Using the <code class="language-bash">chown</code> Command</h2>
<p>The <code class="language-bash">chown</code> command is used to change the ownership of files and directories in Unix-like operating systems.</p>
<p>It allows you to set which user and group own a file.</p>
<hr>

<h2>Syntax</h2>
<p>The basic syntax of the <code class="language-bash">chown</code> command is:</p>
<div class="notranslate">
<pre><code class="language-bash">chown [options] user[:group] file1 [file2 ...]</code></pre>
</div>
<hr>
<h2>Options</h2>
<p>The <code class="language-bash">chown</code> command has several options to customize its behavior:</p>
<ul>
...
<hr>
<h2>Option: -R</h2>
<p>The <code class="language-bash">-R</code> option allows you to change ownership for files and directories recursively. This is useful when you want to apply the same ownership to all files and subdirectories within a directory.</p>
<div class="w3-example">
<h3>Example: Change Ownership Recursively</h3>
<div>
<pre class="command-line" data-output="2-3"><code class="language-bash">chown -R user:group /path/to/directory
changed ownership of 'file1' to user:group
changed ownership of 'file2' to user:group</code></pre>
</div>
</div>
...
<div>
<pre class="command-line" data-output="2"><code class="language-bash">chown -v user file.txt
changed ownership of 'file.txt' to user</code></pre>
</div>
</div>

<hr>
<h2>Common Uses</h2>
<p>The <code class="language-bash">chown</code> command is commonly used to:</p>
<ul>
<li>Transfer file ownership to another user.</li>
<li>Set group ownership for shared files.</li>
<li>Ensure that files have the correct ownership for security purposes.</li>
</ul>

<hr>
<div id="exercisecontainer" src="xrcise_chown.js" data-extensions="php"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_chmod.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_chgrp.php">Next &#10095;</a>
