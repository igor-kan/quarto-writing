...
<html lang="en-US">
<head>
<title>Bash cp - Copy Files and Directories</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Bash <code class="language-bash">cp</code> - Copy Files and Directories</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_cat.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_mv.php">Next &#10095;</a>
</div>
<hr>

<h2>Using the <code class="language-bash">cp</code> Command</h2>
<p>The <code class="language-bash">cp</code> command is used to copy files and directories from one location to another</p>
<p>It's like making a duplicate of your file or folder.</p>

<hr>

<h2>Basic Usage</h2>
<p>To copy a file, use <code class="language-bash">cp source_file destination_file</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<div>
<pre class="command-line"><code class="language-bash">cp my_file.txt copy_of_my_file.txt</code></pre>
</div>
</div>
...
<h2>Options</h2>
<p>The <code class="language-bash">cp</code> command has options to change how it works:</p>
<ul>
<li><code class="language-bash">-r</code> - Copy all files and folders inside a directory</li>
<li><code class="language-bash">-i</code> - Ask before replacing files</li>
<li><code class="language-bash">-u</code> - Copy only if the source is newer</li>
<li><code class="language-bash">-v</code> - Verbose mode, show files being copied</li>
</ul>

<hr>
<h2><code class="language-bash">-v</code> Option: Verbose Mode</h2>
<p>The <code class="language-bash">-v</code> option enables verbose mode, which displays the files being copied in the terminal.</p>
<p>This is useful for tracking the copy process, especially when dealing with many files.</p>
<div class="w3-example">
<h3>Example: Verbose Mode</h3>
<div>
<pre class="command-line" data-output="2"><code class="language-bash">cp -v my_file.txt copy_of_my_file.txt
'my_file.txt' -> 'copy_of_my_file.txt'</code></pre>
</div>
</div>
...
<h2>Copy Directories Recursively</h2>
<p>The <code class="language-bash">-r</code> option lets you copy entire directories, including all files and subdirectories.</p>
<div class="w3-example">
<h3>Example: Copy Directories</h3>
<div>
<pre class="command-line"><code class="language-bash">cp -r images images2</code></pre>
</div>
</div>

<hr>

<h2>Prompt Before Overwrite</h2>
<p>The <code class="language-bash">-i</code> option will prompt you before overwriting files, helping you avoid accidental replacements.</p>
<div class="w3-example">
<h3>Example: Prompt Before Overwrite</h3>
<div>
<pre class="command-line" data-output="2"><code class="language-bash">cp -i my_file.txt copy_of_my_file.txt
cp: overwrite copy_of_my_file.txt?</code></pre>
</div>
</div>
<hr>

<h2>Copy Only Newer Files</h2>
<p>The <code class="language-bash">-u</code> option copies files only if the source file is newer than the destination file.</p>
<div class="w3-example">
<h3>Example: Copy Only Newer Files</h3>
<div>
<pre class="command-line"><code class="language-bash">cp -u new_file.txt existing_file.txt</code></pre>
</div>
</div>
<hr>

<h2>Using <code class="language-bash">cp</code> with Wildcards</h2>
<p>Wildcards allow you to copy multiple files at once. For example, <code class="language-bash">cp *.txt /destination/</code> will copy all text files to the destination folder.</p>
<div class="w3-example">
<h3>Example: Using Wildcards</h3>
<div>
<pre class="command-line"><code class="language-bash">cp *.txt /destination/</code></pre>
</div>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_cp.js" data-extensions="php"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_cat.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_mv.php">Next &#10095;</a>
