...
<html lang="en-US">
<head>
<title>Bash sort Command - Sort Lines of Text Files</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Bash <code class="language-bash">sort</code> Command - Sort Lines of Text Files</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_cut.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_tail.php">Next &#10095;</a>
</div>
<hr>
<h2>Using the <code class="language-bash">sort</code> Command</h2>
<p>The <code class="language-bash">sort</code> command is used to sort lines of text files.</p>
<p>It's a handy tool for organizing data in files.</p>
<hr>

<h2>Basic Usage</h2>
<p>To sort a file, use <code class="language-bash">sort filename</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<div>
<pre class="command-line" data-output="2-7"><code class="language-bash">sort fruits.txt
apples,1
bananas,2
bananas,4
kiwis,3
...
<h2>Options</h2>
<p>The <code class="language-bash">sort</code> command has options to change how it works:</p>
<ul>
<li><code class="language-bash">-r</code> - Sort in reverse order</li>
<li><code class="language-bash">-n</code> - Sort numbers correctly</li>
<li><code class="language-bash">-k</code> - Sort by a specific column</li>
<li><code class="language-bash">-u</code> - Remove duplicate lines</li>
<li><code class="language-bash">-t</code> - Specify a delimiter for fields</li>
</ul>
<hr>
...
<h2>Sort in Reverse Order</h2>
<p>The <code class="language-bash">-r</code> option allows you to sort in reverse order.</p>
<p>Without this option, <code class="language-bash">sort</code> arranges lines in ascending order.</p>
<div class="w3-example">
<h3>Example: Sort in Reverse Order</h3>
<div>
<pre class="command-line" data-output="2-7"><code class="language-bash">sort -r fruits.txt
oranges,20
kiwis,3
kiwis,3
bananas,4
...
<hr>
<h2>Specify a Delimiter for Fields</h2>
<p>The <code class="language-bash">-t</code> option specifies a delimiter for fields, which is useful for sorting files with a specific field separator.</p>
<p>Without this option, <code class="language-bash">sort</code> assumes whitespace as the default delimiter.</p>
<div class="w3-example">
<h3>Example: Specify a Delimiter for Fields</h3>
<div>
<pre class="command-line" data-output="2-7"><code class="language-bash">sort -t "," -k2,2 fruits.txt
apples,1
bananas,2
oranges,20
kiwis,3
...
<p>This example also uses <code class="language-bash">-k</code> to sort by the second column.</p>
<hr>
<h2>Sort by a Specific Column</h2>
<p>The <code class="language-bash">-k</code> option allows you to sort by a specific column.</p>
<p>Without this option, <code class="language-bash">sort</code> uses the entire line as the key.</p>
<div class="w3-example">
<h3>Example: Sort by a Specific Column</h3>
<div>
<pre class="command-line" data-output="2-7"><code class="language-bash">sort -t "," -k2,2 fruits.txt
apples,1
bananas,2
...
<hr>
<h2>Sort Numbers Correctly</h2>
<p>The <code class="language-bash">-n</code> option allows you to sort numbers correctly.</p>
<p>Without this option, numbers are sorted lexicographically, meaning "10" would come before "2".</p>
<div class="w3-example">
<h3>Example: Sort Numbers Correctly</h3>
<div>
<pre class="command-line" data-output="2-7"><code class="language-bash">sort -t "," -n -k2,2 fruits.txt
apples,1
bananas,2
kiwis,3
kiwis,3
...
<p>The <code class="language-bash">-u</code> option removes duplicate lines from the output. Without this option, duplicate lines are retained.</p>
<div class="w3-example">
<h3>Example: Remove Duplicate Lines</h3>
<div>
<pre class="command-line" data-output="2-6"><code class="language-bash">sort -u fruits.txt
apples,1
bananas,2
bananas,4
kiwis,3
...
<h2>Complex Sorting</h2>
<p>Sort can perform complex sorting tasks. For example, <code class="language-bash">sort -t "," -k1,1 -k2,2r fruits.txt</code> sorts by the first column, and then by the second column in reverse order.</p>
<div class="w3-example">
<h3>Example: Complex Sorting</h3>
<div>
<pre class="command-line" data-output="2-7"><code class="language-bash">sort -t "," -k1,1 -k2,2r fruits.txt
apples,1
bananas,4
bananas,2
kiwis,3
...
<hr>
<div id="exercisecontainer" src="xrcise_sort.js" data-extensions="php"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_cut.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_tail.php">Next &#10095;</a>
