...
<a class="w3-left w3-btn" href="bash_conditions.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_functions.php">Next &#10095;</a>
</div>
<hr>

<h2>Using Loops in Bash</h2>
<p>This section covers the use of loops in Bash scripting, including for, while, and until loops.</p>

<hr>

<h2>For Loops</h2>
<p>For loops allow you to iterate over a list of items or a range of numbers. They are useful for repeating tasks a specific number of times.</p>
<p>The <code class="language-bash">for</code> keyword is followed by a variable name, a range of values, and a <code class="language-bash">do</code> keyword, which marks the start of the loop block.</p>
<div class="w3-example">
<h3>Example: For Loop</h3>
<div>
<pre><code class="language-bash"># For loop example
for i in {1..5}; do
  echo "Iteration $i"
done</code></pre>
</div>
...
<p>They are useful for tasks that need to repeat until a certain condition changes.</p>
<p>The condition is enclosed in square brackets <code class="language-bash">[ ]</code>, and the loop ends with <code class="language-bash">done</code>.</p>
<div class="w3-example">
<h3>Example: While Loop</h3>
<div>
<pre><code class="language-bash"># While loop example
count=1
while [ $count -le 5 ]; do
  echo "Count is $count"
  ((count++))
...
<h2>Until Loops</h2>
<p>Until loops are similar to while loops, but they execute until a specified condition becomes true.</p>
<p>The condition is enclosed in square brackets <code class="language-bash">[ ]</code>, and the loop ends with <code class="language-bash">done</code>.</p>
<div class="w3-example">
<h3>Example: Until Loop</h3>
<div>
<pre><code class="language-bash"># Until loop example
count=1
until [ $count -gt 5 ]; do
  echo "Count is $count"
  ((count++))
...
<p>Break and continue statements are used to control loop execution. <code class="language-bash">break</code> exits the loop, while <code class="language-bash">continue</code> skips to the next iteration.</p>
<p>These statements are typically used inside conditional blocks to alter the flow of the loop.</p>
<div class="w3-example">
<h3>Example: Break and Continue</h3>
<div>
<pre><code class="language-bash"># Break and continue example
for i in {1..5}; do
  if [ $i -eq 3 ]; then
    continue
  fi
...
<h2>Nested Loops</h2>
<p>Nested loops allow you to place one loop inside another, enabling more complex iteration patterns.</p>
<p>Each loop must be closed with its own <code class="language-bash">done</code>.</p>
<div class="w3-example">
<h3>Example: Nested Loops</h3>
<div>
<pre><code class="language-bash"># Nested loops example
for i in {1..3}; do
  for j in {1..2}; do
...
<hr>
<div id="exercisecontainer" src="xrcise_loops.js" data-extensions="php"></div>
<hr>
