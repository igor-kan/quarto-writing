...
<html lang="en-US">
<head>
<title>Bash zip Command - Package and compress (archive) files</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Bash <code class="language-bash">zip</code> Command - Package and compress (archive) files</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_rsync.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_unzip.php">Next &#10095;</a>
</div>

<hr>
<h2>Using the <code class="language-bash">zip</code> Command</h2>
<p>The <code class="language-bash">zip</code> command is used to package and compress files into a ZIP archive.</p>
<hr>

<h2>Basic Usage</h2>
<p>To create a ZIP archive, use <code class="language-bash">zip archive.zip file1 file2</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<div>
<pre class="command-line" data-output="2-3"><code class="language-bash">zip archive.zip file1 file2
adding: file1 (stored 0%)
adding: file2 (stored 0%)</code></pre>
</div>
</div>

<hr>

<h2>ZIP Options Overview</h2>
<p>Here are some common options you can use with the <code class="language-bash">zip</code> command:</p>
<ul>
<li><code class="language-bash">-r</code> - Recursively zip directories</li>
<li><code class="language-bash">-u</code> - Update files in the archive if they are newer</li>
<li><code class="language-bash">-d</code> - Delete files from the archive</li>
<li><code class="language-bash">-e</code> - Encrypt the contents of the ZIP archive</li>
<li><code class="language-bash">-x</code> - Exclude specific files from being zipped</li>
</ul>
<hr>

<h2>Option: -r (Recursive)</h2>
<p>The <code class="language-bash">-r</code> option allows you to zip directories and their contents recursively.</p>
<div class="w3-example">
<h3>Example: Recursive Zip</h3>
<div>
<pre class="command-line" data-output="2-6"><code class="language-bash">zip -r archive.zip folder/
adding: folder/ (stored 0%)
adding: folder/file1 (stored 0%)
adding: folder/file2 (stored 0%)
adding: folder/subfolder/ (stored 0%)
adding: folder/subfolder/file3 (stored 0%)</code></pre>
</div>
</div>
<hr>
...
<p>The <code class="language-bash">-u</code> option updates files in the archive only if they are newer than the existing files.</p>
<div class="w3-example">
<h3>Example: Update Archive</h3>
<div>
<pre class="command-line" data-output="2-3"><code class="language-bash">zip -u archive.zip file1 file2
updating: file1 (deflated 60%)
updating: file2 (deflated 60%)</code></pre>
</div>
</div>
<hr>

<h2>Option: -d (Delete)</h2>
<p>The <code class="language-bash">-d</code> option deletes specified files from the archive.</p>
<div class="w3-example">
<h3>Example: Delete from Archive</h3>
<div>
<pre class="command-line" data-output="2"><code class="language-bash">zip -d archive.zip file1
deleting: file1</code></pre>
</div>
</div>
<hr>

<h2>Option: -e (Encrypt)</h2>
<p>The <code class="language-bash">-e</code> option encrypts the contents of the ZIP archive, requiring a password to unzip.</p>
<div class="w3-example">
<h3>Example: Encrypt Archive</h3>
<div>
<pre class="command-line" data-output="2-3"><code class="language-bash">zip -e archive.zip file1 file2
Enter password:
...
<h2>Option: -x (Exclude)</h2>
<p>The <code class="language-bash">-x</code> option excludes specific files from being added to the archive.</p>
<div class="w3-example">
<h3>Example: Exclude Files</h3>
<div>
<pre class="command-line" data-output="2"><code class="language-bash">zip archive.zip file1 file2 -x file2
adding: file1 (stored 0%)</code></pre>
</div>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_zip.js" data-extensions="php"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_rsync.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_unzip.php">Next &#10095;</a>
