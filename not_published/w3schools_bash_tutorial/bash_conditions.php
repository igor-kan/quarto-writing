...
<a class="w3-left w3-btn" href="bash_operators.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_loops.php">Next &#10095;</a>
</div>
<hr>

<h2>Using If...Else Statements in Bash</h2>
<p>This section explains how to use conditional statements in Bash scripting.</p>


<hr>

<h2>If Statements</h2>
<p>If statements allow you to execute code based on a condition. If the condition is true, the code block will run.</p>
<p>The condition is enclosed in square brackets <code class="language-bash">[ ]</code> and the statement ends with <code class="language-bash">fi</code>, which is <code class="language-bash">if</code> spelled backward, marking the end of the if block.</p>
<div class="w3-example">
<h3>Example: If Statement</h3>
<div>
<pre><code class="language-bash"># Basic if statement
num=15
if [ $num -gt 10 ]; then
...
<p>If...else statements provide a way to execute one block of code if a condition is true and another block if it is false.</p>
<p>The <code class="language-bash">else</code> keyword introduces the alternative block, and the statement ends with <code class="language-bash">fi</code>.</p>
<div class="w3-example">
<h3>Example: If...Else Statement</h3>
<div>
<pre><code class="language-bash"># If...else statement
num=8
if [ $num -gt 10 ]; then
  echo "Number is greater than 10"
else
...
<p>Elif statements allow you to check multiple conditions in sequence. If the first condition is false, the next one is checked.</p>
<p>The <code class="language-bash">elif</code> keyword stands for "else if," and the statement still ends with <code class="language-bash">fi</code>.</p>
<div class="w3-example">
<h3>Example: Elif Statement</h3>
<div>
<pre><code class="language-bash"># If...elif...else statement
num=10
if [ $num -gt 10 ]; then
  echo "Number is greater than 10"
elif [ $num -eq 10 ]; then
...
<p>Nested if statements allow you to place an if statement inside another if statement, enabling more complex logic.</p>
<p>Each if block must be closed with its own <code class="language-bash">fi</code>.</p>
<div class="w3-example">
<h3>Example: Nested If Statement</h3>
<div>
<pre><code class="language-bash"># Nested if statement
num=5
if [ $num -gt 0 ]; then
  if [ $num -lt 10 ]; then
