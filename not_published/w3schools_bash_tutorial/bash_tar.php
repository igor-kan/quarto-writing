...
<html lang="en-US">
<head>
<title>Bash tar Command - An archiving utility</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Bash <code class="language-bash">tar</code> Command - An archiving utility</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_unzip.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_permissions.php">Next &#10095;</a>
</div>

<hr>
<h2>Using the <code class="language-bash">tar</code> Command</h2>
<p>The <code class="language-bash">tar</code> command is used to create, maintain, modify, and extract files from an archive file.</p>

<hr>

<h2>TAR Options Overview</h2>
<p>Here are some common options you can use with the <code class="language-bash">tar</code> command:</p>
<ul>
<li><code class="language-bash">-c</code> - Create a new archive</li>
<li><code class="language-bash">-x</code> - Extract files from an archive</li>
<li><code class="language-bash">-t</code> - List the contents of an archive</li>
<li><code class="language-bash">-z</code> - Filter the archive through gzip</li>
<li><code class="language-bash">-v</code> - Verbosely list files processed</li>
<li><code class="language-bash">-f</code> - Specify the filename of the archive</li>
</ul>
<hr>

<h2>Option: -c (Create)</h2>
<p>The <code class="language-bash">-c</code> option creates a new archive with the specified files.</p>
<div class="w3-example">
<h3>Example: Create Archive</h3>
<div>
<pre class="command-line" data-output="2-3"><code class="language-bash">tar -cvf archive.tar file1 file2
file1
file2</code></pre>
</div>
</div>
...
<h2>Option: -x (Extract)</h2>
<p>The <code class="language-bash">-x</code> option extracts files from an archive.</p>
<div class="w3-example">
<h3>Example: Extract Files</h3>
<div>
<pre class="command-line" data-output="2-3"><code class="language-bash">tar -xvf archive.tar
file1
file2</code></pre>
</div>
</div>
...
<h2>Option: -t (List)</h2>
<p>The <code class="language-bash">-t</code> option lists the contents of an archive without extracting them.</p>
<div class="w3-example">
<h3>Example: List Archive Contents</h3>
<div>
<pre class="command-line" data-output="2-3"><code class="language-bash">tar -tvf archive.tar
-rw-r--r-- user/user 1234 2025-04-10 12:00 file1
-rw-r--r-- user/user 5678 2025-04-10 12:00 file2</code></pre>
</div>
</div>
<hr>

<h2>Option: -z (Gzip)</h2>
<p>The <code class="language-bash">-z</code> option filters the archive through gzip, compressing or decompressing it.</p>
<div class="w3-example">
<h3>Example: Gzip Compression</h3>
<div>
<pre class="command-line" data-output="2-3"><code class="language-bash">tar -czvf archive.tar.gz file1 file2
file1
file2</code></pre>
</div>
</div>
...
<h2>Option: -f (File)</h2>
<p>The <code class="language-bash">-f</code> option specifies the filename of the archive to create or operate on. It should be used as the last option before the archive name.</p>
<div class="w3-example">
<h3>Example: Specify Archive Filename</h3>
<div>
<pre class="command-line" data-output="2-3"><code class="language-bash">tar -cvf archive.tar file1 file2
file1
file2</code></pre>
...
<p>The <code class="language-bash">-v</code> option provides verbose output, listing files as they are processed.</p>
<div class="w3-example">
...
<hr>
<div id="exercisecontainer" src="xrcise_tar.js" data-extensions="php"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_unzip.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_permissions.php">Next &#10095;</a>
