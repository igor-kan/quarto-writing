...
<a class="w3-left w3-btn" href="bash_variables.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_operators.php">Next &#10095;</a>
</div>

<hr>
<h2>Understanding Bash Data Types</h2>
<p>This section introduces the different data types available in Bash scripting.</p>


<hr>

<h2>Strings</h2>
<p>Strings are sequences of characters used to store text. They can be manipulated using various string operations such as concatenation and substring extraction.</p>
<div class="w3-example">
<h3>Example: Strings</h3>
<div>
<pre><code class="language-bash"># String example
greeting="Hello, World!"
name="Alice"
full_greeting="$greeting, $name!"
echo $full_greeting</code></pre>
</div>
</div>
<hr>

<h2>Numbers</h2>
<p>Numbers in Bash can be used for arithmetic operations. Bash supports integer arithmetic natively, such as addition, subtraction, multiplication, and division.</p>
<div class="w3-example">
<h3>Example: Numbers</h3>
<div>
<pre><code class="language-bash"># Number example
num1=5
num2=10
sum=$((num1 + num2))
...
product=$((num1 * num2))
quotient=$((num2 / num1))
echo "Sum: $sum, Difference: $difference, Product: $product, Quotient: $quotient"</code></pre>
</div>
</div>
<hr>
...
<h2>Arrays</h2>
<p>Arrays are used to store multiple values in a single variable. Each element in an array is accessed using an index. You can iterate over arrays and modify elements.</p>
<div class="w3-example">
<h3>Example: Arrays</h3>
<div>
<pre><code class="language-bash"># Array example
...
<p>Associative arrays allow you to use named keys to access values. They are similar to dictionaries in other programming languages. You can add or remove keys and values.</p>
<div class="w3-example">
<h3>Example: Associative Arrays</h3>
<div>
<pre><code class="language-bash"># Associative array example
declare -A colors
colors[apple]="red"
...
echo ${colors[grape]} # purple</code></pre>
</div>
</div>
<hr>

<h2>Data Type Limitations</h2>
<p>Bash does not support floating-point arithmetic natively. For such operations, consider using external tools like <code class="language-bash">bc</code> or <code class="language-bash">awk</code>.</p>
<hr>
