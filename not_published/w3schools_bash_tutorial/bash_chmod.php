...
<html lang="en-US">
<head>
<title>Bash chmod Command - Change File Permissions</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Bash <code class="language-bash">chmod</code> Command - Change File Permissions</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_permissions.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_chown.php">Next &#10095;</a>
</div>
<hr>

<h2>Using the <code class="language-bash">chmod</code> Command</h2>
<p>The <code class="language-bash">chmod</code> command is used to change the file permissions in Unix-like operating systems.</p>
<p>It allows you to set who can read, write, or execute a file.</p>


<hr>

<h2>Syntax</h2>
<p>The basic syntax of the <code class="language-bash">chmod</code> command is:</p>
<div class="notranslate">
<pre><code class="language-bash">chmod [options] mode[,mode] file1 [file2 ...]</code></pre>
</div>
<hr>
<h2>Options</h2>
<p>The <code class="language-bash">chmod</code> command has several options to customize its behavior:</p>
<ul>
...
<hr>
<h2>Option: -R</h2>
<p>The <code class="language-bash">-R</code> option allows you to change permissions for files and directories recursively.</p>
<p>This is useful when you want to apply the same permissions to all files and subdirectories within a directory.</p>
<div class="w3-example">
<h3>Example: Change Permissions Recursively</h3>
<div>
<pre class="command-line" data-output="2-3"><code class="language-bash">chmod -R 755 /path/to/directory
changed permissions of 'file1' to 0755
changed permissions of 'file2' to 0755</code></pre>
</div>
</div>
...
<div>
<pre class="command-line" data-output="2"><code class="language-bash">chmod -v 644 file.txt
mode of 'file.txt' changed from 0644 (rw-r--r--) to 0644 (rw-r--r--)</code></pre>
</div>
</div>

<hr>
<h2>Common Uses</h2>
<p>The <code class="language-bash">chmod</code> command is commonly used to:</p>
<ul>
<li>Set executable permissions for scripts.</li>
<li>Restrict access to sensitive files.</li>
<li>Ensure that files have the correct permissions for sharing.</li>
</ul>

<hr>
<div id="exercisecontainer" src="xrcise_chmod.js" data-extensions="php"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_permissions.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_chown.php">Next &#10095;</a>
