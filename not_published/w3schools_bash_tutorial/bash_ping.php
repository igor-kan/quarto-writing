...
<html lang="en-US">
<head>
<title>Bash ping Command - Send Request to Network Hosts</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Bash <code class="language-bash">ping</code> Command - Send Request to Network Hosts</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_uptime.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_curl.php">Next &#10095;</a>
</div>
<hr>
<h2>Using the <code class="language-bash">ping</code> Command</h2>
<p>The <code class="language-bash">ping</code> command is used to send ICMP ECHO_REQUEST to network hosts.</p>
<p>It's a useful tool for checking network connectivity and diagnosing network issues.</p>

<hr>
<h2>Basic Usage</h2>
<p>To ping a host, use <code class="language-bash">ping hostname</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<div>
<pre class="command-line" data-output="2-11"><code class="language-bash">ping google.com
...
Approximate round trip times in milli-seconds:
    Minimum = 38ms, Maximum = 79ms, Average = 54ms</code></pre>
</div>
</div>
<hr>
<h2>Options</h2>
<p>The <code class="language-bash">ping</code> command has options to change how it works:</p>
<ul>
<li><code class="language-bash">-c</code> - Send a specific number of ping requests</li>
<li><code class="language-bash">-i</code> - Wait a specific number of seconds between sending each packet</li>
<li><code class="language-bash">-t</code> - Set the IP Time to Live (TTL)</li>
<li><code class="language-bash">-q</code> - Quiet output, only show summary</li>
<li><code class="language-bash">-s</code> - Specify the number of data bytes to be sent</li>
</ul>
<hr>
...
<h2>Send a Specific Number of Ping Requests</h2>
<p>The <code class="language-bash">-c</code> option allows you to send a specific number of ping requests.</p>
<p>This is useful for limiting the number of packets sent.</p>
<div class="w3-example">
<h3>Example: Send a Specific Number of Ping Requests</h3>
<div>
<pre class="command-line" data-output="2-10"><code class="language-bash">ping -c 4 google.com
...
round-trip min/avg/max/stddev = 14.2/14.3/14.5/0.1 ms</code></pre>
</div>
</div>

<hr>
<h2>Understanding Ping Results</h2>
<p>The output of the <code class="language-bash">ping</code> command provides several key pieces of information:</p>
<ul>
<li><strong>Bytes:</strong> The size of the ICMP packet sent</li>
<li><strong>Time:</strong> The round-trip time it took for the packet to reach the host and return, measured in milliseconds</li>
<li><strong>TTL (Time to Live):</strong> The remaining lifespan of the packet, which decreases by one for each hop</li>
<li><strong>Packet Loss:</strong> The percentage of packets that were lost during transmission</li>
<li><strong>Round-Trip Time Statistics:</strong> Includes minimum, average, maximum, and standard deviation of the round-trip times</li>
</ul>
<p>In the example above:</p>
<ul>
<li>Each packet is 64 bytes</li>
<li>The round-trip times vary slightly, indicating network latency</li>
<li>The TTL value is 118, showing the packet's remaining lifespan</li>
<li>There is 0.0% packet loss, indicating a stable connection</li>
<li>The round-trip time statistics provide insights into network performance</li>
</ul>

<hr>

<h2>Wait a Specific Number of Seconds Between Sending Each Packet</h2>
<p>The <code class="language-bash">-i</code> option allows you to wait a specific number of seconds between sending each packet.</p>
<p>This can be useful for reducing network traffic when using <code class="language-bash">ping</code>.</p>
<div class="w3-example">
<h3>Example: Wait a Specific Number of Seconds Between Sending Each Packet</h3>
<div>
<pre class="command-line" data-output="2-8"><code class="language-bash">ping -i 2 google.com
PING google.com (172.217.14.206): 56 data bytes
64 bytes from 172.217.14.206: icmp_seq=0 ttl=118 time=14.5 ms
64 bytes from 172.217.14.206: icmp_seq=1 ttl=118 time=14.2 ms
...
<hr>
<h2>Set the IP Time to Live (TTL)</h2>
<p>The <code class="language-bash">-t</code> option allows you to set the IP Time to Live (TTL).</p>
<p>This determines the maximum number of hops a packet can take before being discarded.</p>
<div class="w3-example">
<h3>Example: Set the IP Time to Live (TTL)</h3>
<div>
<pre class="command-line" data-output="2-7"><code class="language-bash">ping -t 64 google.com
PING google.com (172.217.14.206): 56 data bytes
64 bytes from 172.217.14.206: icmp_seq=0 ttl=64 time=14.5 ms

--- google.com ping statistics ---
1 packets transmitted, 1 packets received, 0.0% packet loss
round-trip min/avg/max/stddev = 14.5/14.5/14.5/0.0 ms</code></pre>
</div>
</div>

<hr>
<h2>Quiet Output</h2>
<p>The <code class="language-bash">-q</code> option enables quiet output, only showing the summary of the ping results.</p>
<p>This is useful for scripts or when you only need the final statistics.</p>
<div class="w3-example">
<h3>Example: Quiet Output</h3>
<div>
<pre class="command-line" data-output="2-4"><code class="language-bash">ping -c 4 -q google.com
--- google.com ping statistics ---
4 packets transmitted, 4 packets received, 0.0% packet loss
round-trip min/avg/max/stddev = 14.2/14.3/14.5/0.1 ms</code></pre>
</div>
...
<hr>
<h2>Specify Data Bytes</h2>
<p>The <code class="language-bash">-s</code> option allows you to specify the number of data bytes to be sent.</p>
<p>This can be useful for testing network performance with different packet sizes.</p>
<div class="w3-example">
<h3>Example: Specify Data Bytes</h3>
<div>
<pre class="command-line" data-output="2-7"><code class="language-bash">ping -s 128 google.com
...
<div id="exercisecontainer" src="xrcise_ping.js" data-extensions="php"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_uptime.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_curl.php">Next &#10095;</a>
