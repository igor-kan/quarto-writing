...
<html lang="en-US">
<head>
<title>Bash Commands Overview</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Bash <span class="color_h1">Commands Overview</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_getstarted.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_ls.php">Next &#10095;</a>
</div>
<hr>
<h2>Common Bash Commands</h2>
<p>Bash commands are how you interact with the operating system and perform tasks.</p>
<p>Common commands:</p>
<ul>
<li><a href="bash_ls.php"><code class="language-bash">ls</code></a> - List directory contents</li>
<li><a href="bash_cd.php"><code class="language-bash">cd</code></a> - Change the current directory</li>
<li><a href="bash_pwd.php"><code class="language-bash">pwd</code></a> - Print the current working directory</li>
<li><a href="bash_echo.php"><code class="language-bash">echo</code></a> - Display a line of text</li>
<li><a href="bash_cat.php"><code class="language-bash">cat</code></a> - Concatenate and display files</li>
<li><a href="bash_cp.php"><code class="language-bash">cp</code></a> - Copy files and directories</li>
<li><a href="bash_mv.php"><code class="language-bash">mv</code></a> - Move or rename files</li>
<li><a href="bash_rm.php"><code class="language-bash">rm</code></a> - Delete files or folders</li>
<li><a href="bash_touch.php"><code class="language-bash">touch</code></a> - Create an empty file or update its time</li>
<li><a href="bash_mkdir.php"><code class="language-bash">mkdir</code></a> - Create a new folder</li>
</ul>
<p>All these commands and more are explained in the following chapters.</p>
<hr>

<h2>Example</h2>
<p>Here's an example using some of these commands:</p>
<div class="w3-example">
<h3>Example</h3>
<div>
<pre class="command-line" data-output="5" ><code class="language-bash">mkdir my_directory
cd my_directory
touch my_file.txt
ls
my_file.txt</code></pre>
</div>
</div>
