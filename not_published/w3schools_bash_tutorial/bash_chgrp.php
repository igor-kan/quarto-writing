...
<html lang="en-US">
<head>
<title>Bash chgrp Command - Change Group Ownership</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Bash <code class="language-bash">chgrp</code> Command - Change Group Ownership</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_chown.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_syntax.php">Next &#10095;</a>
</div>
<hr>

<h2>Using the <code class="language-bash">chgrp</code> Command</h2>
<p>The <code class="language-bash">chgrp</code> command is used to change the group ownership of files and directories in Unix-like operating systems. It allows you to set which group owns a file.</p>

<hr>

<h2>Syntax</h2>
<p>The basic syntax of the <code class="language-bash">chgrp</code> command is:</p>
<div class="notranslate">
<pre><code class="language-bash">chgrp [options] group file1 [file2 ...]</code></pre>
</div>
<hr>
<h2>Options</h2>
<p>The <code class="language-bash">chgrp</code> command has several options to customize its behavior:</p>
<ul>
<li><code class="language-bash">-R</code>: Change files and directories recursively.</li>
<li><code class="language-bash">-v</code>: Output a diagnostic for every file processed.</li>
</ul>

<hr>
<h2>Option: -R</h2>
<p>The <code class="language-bash">-R</code> option allows you to change group ownership for files and directories recursively. This is useful when you want to apply the same group ownership to all files and subdirectories within a directory.</p>
<div class="w3-example">
<h3>Example: Change Group Ownership Recursively</h3>
<div>
<pre class="command-line" data-output="2-3"><code class="language-bash">chgrp -R group /path/to/directory
changed group of 'file1' to group
changed group of 'file2' to group</code></pre>
</div>
</div>
...
<h2>Option: -v</h2>
<p>The <code class="language-bash">-v</code> option provides verbose output, showing a diagnostic message for each file processed by the command.</p>
<div class="w3-example">
<h3>Example: Verbose Output</h3>
<div>
<pre class="command-line" data-output="2"><code class="language-bash">chgrp -v group file.txt
changed group of 'file.txt' to group</code></pre>
</div>
</div>

<hr>
<h2>Common Uses</h2>
<p>The <code class="language-bash">chgrp</code> command is commonly used to:</p>
<ul>
<li>Transfer group ownership to another group.</li>
<li>Set group ownership for shared files.</li>
<li>Ensure that files have the correct group ownership for security purposes.</li>
</ul>

<hr>
<div id="exercisecontainer" src="xrcise_chgrp.js" data-extensions="php"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_chown.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_syntax.php">Next &#10095;</a>
