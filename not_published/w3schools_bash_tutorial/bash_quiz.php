...
ny:-->
    ...
    <h1>Bash <span class="color_h1">Quiz</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_exercises.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="index.php">Next &#10095;</a>
</div>
<hr>
<p class="intro">You can test your Bash skills with W3Schools' Quiz.</p>
<hr>
<h2>The Test</h2>
<p>The test contains 25 questions and there is no time limit.</p>
<p>The test is not official, it's just a nice way to see how much you know about Bash.</p>
...
<p>Good luck!</p>
<p><a href='/quiztest/quiztest.php?qtest=BASH' class="w3-btn w3-blue w3-round" style="margin-top:10px;padding:17px;font-size:17px">Start the Bash Quiz &#10095;</a></p>
</div>
<div class="ws-note w3-panel">
  <p>If you do not know Bash, we suggest that you read our <a href="index.php">Bash Tutorial</a> from scratch.</p>
</div>
<hr>
