...
<html lang="en-US">
<head>
<title>Bash rm Command - Remove Files or Directories</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Bash <code class="language-bash">rm</code> Command - Remove Files or Directories</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_mv.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_touch.php">Next &#10095;</a>
</div>
<hr>
<h2>Using the <code class="language-bash">rm</code> Command</h2>
<p>The <code class="language-bash">rm</code> command is used to remove files or directories.</p>
<p>Be careful, as removed files cannot be easily recovered.</p>
<hr>

<h2>Basic Usage</h2>
<p>To remove a file, use <code class="language-bash">rm filename</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<div>
<pre class="command-line"><code class="language-bash">rm my_file.txt</code></pre>
</div>
</div>
...
<h2>Options</h2>
<p>The <code class="language-bash">rm</code> command has options to change how it works:</p>
<ul>
<li><code class="language-bash">-r</code> - Delete a folder and everything inside it</li>
<li><code class="language-bash">-i</code> - Ask before deleting each file</li>
<li><code class="language-bash">-f</code> - Force delete without asking</li>
<li><code class="language-bash">-v</code> - Verbose mode, show files being removed</li>
</ul>
...
<p>The <code class="language-bash">-v</code> option enables verbose mode, which displays the files being removed in the terminal.</p>
<p>This is useful for tracking the removal process, especially when dealing with many files.</p>
<div class="w3-example">
<h3>Example: Verbose Mode</h3>
<div>
<pre class="command-line" data-output="2"><code class="language-bash">rm -v my_new_file.txt
removed 'my_new_file.txt'</code></pre>
</div>
</div>

<hr>

<h2>Remove Directories Recursively</h2>
<p>The <code class="language-bash">-r</code> option allows you to delete directories and all their contents.</p>
<div class="w3-example">
<h3>Example: Remove Directories</h3>
<div>
<pre class="command-line"><code class="language-bash">rm -r directory</code></pre>
</div>
</div>
<hr>

<h2>Prompt Before Removal</h2>
<p>The <code class="language-bash">-i</code> option will prompt you before each file is deleted, helping you avoid accidental deletions.</p>
<div class="w3-example">
<h3>Example: Prompt Before Removal</h3>
<div>
<pre class="command-line" data-output="2"><code class="language-bash">rm -i my_file.txt
rm: remove regular file 'my_file.txt'?</code></pre>
</div>
</div>
<hr>

<h2>Force Removal</h2>
<p>The <code class="language-bash">-f</code> option forces deletion without any prompts.</p>
<div class="w3-example">
<h3>Example: Force Removal</h3>
<div>
<pre class="command-line"><code class="language-bash">rm -f file.txt</code></pre>
</div>
</div>
<hr>

<h2>Using <code class="language-bash">rm</code> Safely</h2>
<p>Always double-check the files and directories you are about to delete, especially when using the <code class="language-bash">-r</code> and <code class="language-bash">-f</code> options.</p>
<div class="w3-example">
<h3>Tip: Safe Deletion</h3>
<div>
<pre class="command-line" data-output="2"><code class="language-bash">rm -i -r images
rm: descend into directory 'images'?</code></pre>
</div>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_rm.js" data-extensions="php"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_mv.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_touch.php">Next &#10095;</a>
