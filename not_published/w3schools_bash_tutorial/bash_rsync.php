...
<html lang="en-US">
<head>
<title>Bash rsync Command - Remote (and local) File-copying</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Bash <code class="language-bash">rsync</code> Command - Remote (and local) File-copying</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_scp.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_zip.php">Next &#10095;</a>
</div>

<hr>
<h2>Using the <code class="language-bash">rsync</code> Command</h2>
<p>The <code class="language-bash">rsync</code> command is used to efficiently transfer and synchronize files across computer systems, by checking the timestamp and size of files.</p>

<hr>

<h2>Basic Usage</h2>
<p>To synchronize a directory to a remote host, use <code class="language-bash">rsync -avz source user@hostname:/path</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<div>
<pre class="command-line"><code class="language-bash">rsync -avz /local/dir/ user@example.com:/remote/dir/</code></pre>
</div>
</div>
<hr>
<h2>Understanding Rsync Output</h2>
<p>The output of the <code class="language-bash">rsync</code> command can vary depending on the options used. Here are some common elements:</p>
<ul>
<li><strong>File List:</strong> Lists the files being transferred.</li>
<li><strong>Transfer Progress:</strong> Shows the progress of each file transfer.</li>
<li><strong>Compression Ratio:</strong> Indicates the effectiveness of compression if used.</li>
<li><strong>Speed:</strong> The speed at which files are being transferred.</li>
</ul>

<hr>

<h2>Rsync Options Overview</h2>
<p>Here are some common options you can use with the <code class="language-bash">rsync</code> command:</p>
<ul>
<li><code class="language-bash">-a</code> - Archive mode</li>
<li><code class="language-bash">-v</code> - Increase verbosity</li>
<li><code class="language-bash">-z</code> - Compress file data</li>
<li><code class="language-bash">--delete</code> - Delete extraneous files</li>
<li><code class="language-bash">-r</code> - Recurse into directories</li>
<li><code class="language-bash">-u</code> - Skip files that are newer on the receiver</li>
<li><code class="language-bash">--progress</code> - Show progress during transfer</li>
</ul>
<hr>
...
<h2>Option: -a (Archive Mode)</h2>
<p>The <code class="language-bash">-a</code> option enables archive mode, which preserves permissions, times, symbolic links, and more. It's like a combination of several options.</p>
<div class="w3-example">
<h3>Example: Archive Mode</h3>
<div>
<pre class="command-line"><code class="language-bash">rsync -a /local/dir/ user@example.com:/remote/dir/</code></pre>
</div>
</div>
<hr>

<h2>Option: -v (Verbose)</h2>
<p>The <code class="language-bash">-v</code> option increases verbosity, providing detailed output of the rsync process.</p>
<div class="w3-example">
<h3>Example: Verbose Output</h3>
<div>
<pre class="command-line"><code class="language-bash">rsync -av /local/dir/ user@example.com:/remote/dir/</code></pre>
</div>
</div>
<hr>

<h2>Option: -z (Compression)</h2>
<p>The <code class="language-bash">-z</code> option compresses file data during transfer, which can speed up the transfer process.</p>
<div class="w3-example">
<h3>Example: Enable Compression</h3>
<div>
<pre class="command-line"><code class="language-bash">rsync -az /local/dir/ user@example.com:/remote/dir/</code></pre>
</div>
</div>
<hr>

<h2>Option: --delete</h2>
<p>The <code class="language-bash">--delete</code> option deletes files from the destination that are not present in the source.</p>
<div class="w3-example">
<h3>Example: Delete Extraneous Files</h3>
<div>
<pre class="command-line"><code class="language-bash">rsync -avz --delete /local/dir/ user@example.com:/remote/dir/</code></pre>
</div>
</div>
<hr>

<h2>Option: -r (Recursive)</h2>
<p>The <code class="language-bash">-r</code> option allows rsync to recurse into directories, copying all files and subdirectories.</p>
<div class="w3-example">
<h3>Example: Recursive Copy</h3>
<div>
<pre class="command-line"><code class="language-bash">rsync -ar /local/dir/ user@example.com:/remote/dir/</code></pre>
</div>
</div>
<hr>

<h2>Option: -u (Update)</h2>
<p>The <code class="language-bash">-u</code> option skips files that are newer on the receiver, avoiding overwriting newer files.</p>
<div class="w3-example">
<h3>Example: Skip Newer Files</h3>
<div>
<pre class="command-line"><code class="language-bash">rsync -avu /local/dir/ user@example.com:/remote/dir/</code></pre>
</div>
</div>
<hr>

<h2>Option: --progress</h2>
<p>The <code class="language-bash">--progress</code> option shows progress during transfer, providing detailed information about the transfer status.</p>
<div class="w3-example">
<h3>Example: Show Progress</h3>
<div>
<pre class="command-line"><code class="language-bash">rsync --progress /local/dir/ user@example.com:/remote/dir/</code></pre>
</div>
</div>
...
<p>Common issues with rsync include "Permission Denied" or "Connection Timeout". Here are some troubleshooting tips:</p>
<ul>
<li><strong>Permission Denied:</strong> Ensure you have the correct permissions on both the source and destination directories. Check user permissions and SSH key access.</li>
<li><strong>Connection Timeout:</strong> Verify network connectivity and ensure the remote server is reachable. Check firewall settings and SSH configurations.</li>
</ul>
<hr>
<hr>
<div id="exercisecontainer" src="xrcise_rsync.js" data-extensions="php"></div>
<hr>
