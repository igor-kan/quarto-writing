...
ny:-->
    ...
    <h1>Bash <span class="color_h1">Variables</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_bunzip2.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_data_types.php">Next &#10095;</a>
</div>
<hr>
<h2>Understanding Variables in Bash</h2>
<p>Variables in Bash are used to store data that can be used and manipulated throughout your script or command-line session. Bash variables are untyped, meaning they can hold any type of data.</p>
<hr>

<h2>Declaring Variables</h2>
<p>Variables are declared by simply assigning a value to a name. There should be no spaces around the equal sign:</p>
<ul>
<li><code class="language-bash">variable_name=value</code></li>
<li>To access the value of a variable, prefix it with a dollar sign: <code class="language-bash">$variable_name</code></li>
</ul>
...
echo "Hello, $name!"
number=42
echo "The number is $number"</code></pre>
</div>
</div>
...
<p>Environment variables are special variables that affect the way processes run on your system. They are often used to store system-wide values like the location of executables or the default editor.</p>
<div class="w3-example">
<h3>Example: Using Environment Variables</h3>
<div>
<pre><code class="language-bash"># Display the PATH environment variable
echo "Your PATH is $PATH"</code></pre>
</div>
</div>
<hr>
...
<p>Local variables are only available within the block of code in which they are defined, such as within a function. Global variables are accessible from anywhere in the script.</p>
<div class="w3-example">
<h3>Example: Local Variable</h3>
<div>
<pre><code class="language-bash"># Define a local variable in a function
my_function() {
...
<h2>Common Variable Operations</h2>
<p>Variables can be used in various operations, such as concatenation and arithmetic.</p>
<ul>
<li><strong>Concatenation:</strong> Combine strings using variables.</li>
<li><strong>Arithmetic:</strong> Perform calculations using variables.</li>
</ul>
<div class="w3-example">
<h3>Example: Variable Operations</h3>
<div>
<pre><code class="language-bash"># Concatenation
greeting="Hello, "
name="World"
echo "$greeting$name"
