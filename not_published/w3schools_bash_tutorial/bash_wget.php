...
<html lang="en-US">
<head>
<title>Bash wget Command - Non-Interactive Network Downloader</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Bash <code class="language-bash">wget</code> Command - Non-Interactive Network Downloader</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_curl.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_ssh.php">Next &#10095;</a>
</div>

<hr>
<h2>Using the <code class="language-bash">wget</code> Command</h2>
<p>The <code class="language-bash">wget</code> command is used to download files from the web.</p>
<p>It's a powerful tool for downloading single files, entire websites, or even batch downloads.</p>

<hr>

<h2>Basic Usage</h2>
<p>To download a file, use <code class="language-bash">wget url</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<div>
<pre class="command-line"><code class="language-bash">wget http://example.com/file.txt</code></pre>
</div>
</div>
...
<h2>Options</h2>
<p>The <code class="language-bash">wget</code> command has options to change how it works:</p>
<ul>
<li><code class="language-bash">-b</code> - Run in the background</li>
<li><code class="language-bash">-q</code> - Quiet mode (no output)</li>
<li><code class="language-bash">-r</code> - Download directories recursively</li>
<li><code class="language-bash">-c</code> - Continue getting a partially-downloaded file</li>
<li><code class="language-bash">--limit-rate</code> - Limit download speed</li>
</ul>
<hr>
...
<p>The <code class="language-bash">-b</code> option allows you to run <code>wget</code> in the background.</p>
<p>This is useful for long downloads that you don't want to monitor continuously.</p>
<div class="w3-example">
<h3>Example: Run in the Background</h3>
<div>
<pre class="command-line"><code class="language-bash">wget -b http://example.com/file.txt</code></pre>
</div>
</div>
<hr>
<h2>Quiet Mode</h2>
<p>The <code class="language-bash">-q</code> option allows you to run <code>wget</code> in quiet mode.</p>
<p>This is useful for scripts or automated tasks where output is not needed.</p>
<div class="w3-example">
<h3>Example: Quiet Mode</h3>
<div>
<pre class="command-line"><code class="language-bash">wget -q http://example.com/file.txt</code></pre>
</div>
</div>
<hr>
<h2>Recursive Downloads</h2>
<p>The <code class="language-bash">-r</code> option allows you to download directories recursively.</p>
<p>This is useful for downloading entire websites or directories.</p>
<div class="w3-example">
<h3>Example: Recursive Downloads</h3>
<div>
<pre class="command-line"><code class="language-bash">wget -r http://example.com/directory/</code></pre>
</div>
</div>
<hr>
<h2>Continue Getting a Partially-Downloaded File</h2>
<p>The <code class="language-bash">-c</code> option allows you to continue downloading a file that was partially downloaded. This is useful for resuming interrupted downloads.</p>
<div class="w3-example">
<h3>Example: Continue Download</h3>
<div>
<pre class="command-line"><code class="language-bash">wget -c http://example.com/largefile.zip</code></pre>
</div>
</div>
<hr>
<h2>Limit Download Speed</h2>
<p>The <code class="language-bash">--limit-rate</code> option allows you to limit the download speed. This is useful for managing bandwidth usage.</p>
<div class="w3-example">
<h3>Example: Limit Download Speed</h3>
<div>
<pre class="command-line"><code class="language-bash">wget --limit-rate=200k http://example.com/file.txt</code></pre>
</div>
</div>
<hr>
<h2>Understanding Wget Output</h2>
<p>The output of the <code class="language-bash">wget</code> command can vary depending on the options used. Here are some common elements:</p>
<ul>
<li><strong>Download Progress:</strong> Shows the progress of the download.</li>
<li><strong>File Size:</strong> The size of the file being downloaded.</li>
<li><strong>Download Speed:</strong> The speed at which the file is being downloaded.</li>
<li><strong>Time Remaining:</strong> Estimated time remaining for the download to complete.</li>
</ul>
<hr>
<h2>Batch Downloads</h2>
<p>Wget can be used for batch downloads. For example, <code class="language-bash">wget -r http://example.com/directory/</code> downloads all files in a directory.</p>
<div class="w3-example">
<h3>Example: Batch Downloads</h3>
<div>
<pre class="command-line"><code class="language-bash">wget -r http://example.com/directory/</code></pre>
</div>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_wget.js" data-extensions="php"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_curl.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_ssh.php">Next &#10095;</a>
