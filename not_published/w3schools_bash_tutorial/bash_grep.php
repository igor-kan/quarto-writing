...
<html lang="en-US">
<head>
<title>Bash grep Command - Search Text Using Patterns</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Bash <code class="language-bash">grep</code> Command - Search Text Using Patterns</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_alias.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_awk.php">Next &#10095;</a>
</div>
<hr>

<h2>Using the <code class="language-bash">grep</code> Command</h2>
<p>The <code class="language-bash">grep</code> command is used to search for text patterns within files.</p>
<p>It's a powerful way to find specific text in large files or across many files.</p>
<hr>

<h2>Basic Usage</h2>
<p>To search for a pattern in a file, use <code class="language-bash">grep 'pattern' filename</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<div>
<pre class="command-line" data-output="2-3"><code class="language-bash">grep 'shell' file.txt
...
<h2>Options</h2>
<p>The <code class="language-bash">grep</code> command has options to change how it works:</p>
<ul>
<li><code class="language-bash">-i</code> - Search ignoring case differences (uppercase or lowercase)</li>
<li><code class="language-bash">-r</code> - Search through all files in a directory and its subdirectories</li>
<li><code class="language-bash">-v</code> - Find lines that do not match the pattern</li>
</ul>
<hr>
<h2>Ignore Case</h2>
<p>The <code class="language-bash">-i</code> option lets you search without worrying about case sensitivity.</p>
<div class="w3-example">
<h3>Example: Ignore Case</h3>
<div>
<pre class="command-line" data-output="2-4"><code class="language-bash">grep -i 'shell' file.txt
...
<p>The <code class="language-bash">-r</code> option allows you to search through all files in a directory and its subdirectories.</p>
<div class="w3-example">
<h3>Example: Recursive Search</h3>
<div>
<pre class="command-line" data-output="2-10"><code class="language-bash">grep -r 'search_term' /home/user/my_directory
...
/home/user/my_file.txt:There are different types of shells. Bash (Bourne Again SHell)</code></pre>
</div>
</div>
...
<h2>Invert Match</h2>
<p>The <code class="language-bash">-v</code> option finds lines that do not match the pattern.</p>
<div class="w3-example">
<h3>Example: Invert Match</h3>
<div>
<pre class="command-line" data-output="2-3"><code class="language-bash">grep -v 'shell' my_file.txt
Understanding Shells
</code></pre>
</div>
</div>
...
<h2>Using <code class="language-bash">grep</code> with Regular Expressions</h2>
<p>Regular expressions allow you to search for complex patterns.</p>
<p>For example, <code class="language-bash">grep '^[A-Za-z]' file.txt</code> finds lines starting with a letter.</p>
<div class="w3-example">
<h3>Example: Regular Expressions</h3>
<div>
<pre class="command-line" data-output="2-5"><code class="language-bash">grep '^[A-Za-z]' my_file.txt
Understanding Shells
A shell is a text-based interface that lets you talk to your computer.
...
<hr>
<div id="exercisecontainer" src="xrcise_grep.js" data-extensions="php"></div>
<hr>
