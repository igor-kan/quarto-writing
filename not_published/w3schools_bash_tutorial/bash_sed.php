...
<html lang="en-US">
<head>
<title>Bash sed Command - Stream Editor</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Bash <code class="language-bash">sed</code> Command - Stream Editor</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_awk.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_cut.php">Next &#10095;</a>
</div>

<hr>
<h2>Using the <code class="language-bash">sed</code> Command</h2>
<p>The <code class="language-bash">sed</code> command is a stream editor used to perform basic text transformations on an input stream (a file or input from a pipeline).</p>
<p>It's a powerful tool for making quick edits to files or streams of data.</p>
<p>All examples below use the <code>example_text.txt</code> file:</p>
...
<h2>Basic Usage</h2>
<p>To replace the first occurrence of a pattern in a file, use <code class="language-bash">sed 's/old/new/' filename</code>:</p>
<div class="w3-example">
<h3>Example: Replace Text</h3>
<div>
<pre class="command-line" data-output="2-4"><code class="language-bash">sed 's/World/Bash/' example_text.txt
Hello Bash
Line 1
Line 2</code></pre>
</div>
...
<h2>Options</h2>
<p>The <code class="language-bash">sed</code> command has options to change how it works:</p>
<ul>
<li><code class="language-bash">-i</code> - Edit files directly without needing to save separately</li>
<li><code class="language-bash">-e</code> - Add the script to the commands to be executed</li>
<li><code class="language-bash">-n</code> - Don't automatically print lines</li>
<li><code class="language-bash">-r</code> - Use extended regular expressions</li>
<li><code class="language-bash">-f</code> - Add script from a file</li>
<li><code class="language-bash">-l</code> - Specify line length for <code class="language-bash">l</code> command</li>
</ul>
<hr>
...
<h2>Edit Files In Place</h2>
<p>The <code class="language-bash">-i</code> option allows you to edit files directly without needing to save separately.</p>
<p>Without this option, <code class="language-bash">sed</code> outputs the result to the standard output, and you must redirect it to a file to save changes.</p>
<div class="w3-example">
<h3>Example: Edit Files In Place</h3>
<div>
<pre class="command-line" data-output="3-5"><code class="language-bash">sed -i 's/World/Bash/g' example_text.txt
...
<h2>Suppress Printing</h2>
<p>The <code class="language-bash">-n</code> option suppresses automatic printing of pattern space.</p>
<p>By default, <code class="language-bash">sed</code> prints each line of input to the output. Using <code class="language-bash">-n</code> allows you to control which lines are printed, typically with the <code class="language-bash">p</code> command.</p>
<div class="w3-example">
<h3>Example: Suppress Printing</h3>
<div>
<pre class="command-line" data-output="2"><code class="language-bash">sed -n 's/World/Bash/p' example_text.txt
Hello Bash</code></pre>
</div>
</div>
...
<p>The <code class="language-bash">-r</code> option allows the use of extended regular expressions, which provide more powerful pattern matching capabilities than basic regular expressions.</p>
<p>Without this option, <code class="language-bash">sed</code> uses basic regular expressions.</p>
<div class="w3-example">
<h3>Example: Extended Regular Expressions</h3>
<div>
<pre class="command-line" data-output="2-4"><code class="language-bash">sed -r 's/(World|Line)/Hello/g' example_text.txt
Hello Hello
Hello 1
Hello 2</code></pre>
</div>
...
<h2>Script from a File</h2>
<p>The <code class="language-bash">-f</code> option allows you to add a script from a file, which is useful for executing complex or multiple <code class="language-bash">sed</code> commands.</p>
<p>Without this option, you must specify the script directly in the command line.</p>

<p>Content of <code>script.sed</code> file:</p>
<pre><code class="language-bash">s/World/Bash/g</code></pre>

<div class="w3-example">
<h3>Example: Script from a File</h3>
<div>
<pre class="command-line" data-output="2-4"><code class="language-bash">sed -f script.sed example_text.txt
Hello Bash
Line 1
Line 2</code></pre>
</div>
...
<h2>Specify Line Length</h2>
<p>The <code class="language-bash">-l</code> option specifies the line length for the <code class="language-bash">l</code> command, which prints lines with non-printable characters.</p>
<p>This option is useful for formatting output when dealing with long lines.</p>
<div class="w3-example">
<h3>Example: Specify Line Length</h3>
<div>
<pre class="command-line" data-output="2-8"><code class="language-bash">sed -l 10 'l' example_text.txt
Hello Wor\
ld$
Hello World
Line 1$
...
<p>This option appends a <code>$</code> at the end of each line to indicate the end of the line.</p>
<hr>

<h2>Redirect Output to a File</h2>
<p>To save the changes made by <code class="language-bash">sed</code> to a file, you can redirect the output to a new file. This is useful when you don't want to overwrite the original file.</p>
<div class="w3-example">
<h3>Example: Redirect Output</h3>
<div>
<pre class="command-line" data-output="3-5"><code class="language-bash">sed 's/World/Bash/' example_text.txt > new_example_text.txt
...
<h2>Using <code class="language-bash">sed</code> for Advanced Text Processing</h2>
<p>Sed can perform advanced text processing tasks. For example, <code class="language-bash">sed 's/^/Prefix: /' example_text.txt</code> adds a prefix to each line.</p>
<div class="w3-example">
<h3>Example: Advanced Text Processing</h3>
<div>
<pre class="command-line" data-output="2-4"><code class="language-bash">sed 's/^/Prefix: /' example_text.txt
Prefix: Hello World
Prefix: Line 1
...
<p>When using <code class="language-bash">sed</code>, you might encounter errors such as:</p>
<ul>
<li>"sed: command garbled" - Check your command syntax.</li>
<li>"sed: can't read file" - Ensure the file path is correct and accessible.</li>
</ul>
<p>Debugging tips include using <code class="language-bash">echo</code> to print intermediate results and verify command logic.</p>
<hr>
<div id="exercisecontainer" src="xrcise_sed.js" data-extensions="php"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_awk.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_cut.php">Next &#10095;</a>
