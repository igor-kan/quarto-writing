...
<html lang="en-US">
<head>
<title>Bash mkdir Command - Make Directories</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Bash <code class="language-bash">mkdir</code> Command - Make Directories</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_touch.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_man.php">Next &#10095;</a>
</div>

<hr>
<h2>Using the <code class="language-bash">mkdir</code> Command</h2>
<p>The <code class="language-bash">mkdir</code> command is used to create new directories.</p>
<p>It's a simple way to organize files into folders.</p>

<hr>

<h2>Basic Usage</h2>
<p>To create a new directory, use <code class="language-bash">mkdir directory_name</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<div>
<pre class="command-line"><code class="language-bash">mkdir new_directory</code></pre>
</div>
</div>
...
<p>The <code class="language-bash">mkdir</code> command has several options to customize its behavior:</p>
<ul>
<li><code class="language-bash">-p</code> - Create parent directories as needed</li>
<li><code class="language-bash">-v</code> - Show a message for each created directory</li>
<li><code class="language-bash">-m</code> - Set file mode (permissions)</li>
</ul>

<hr>
<h2><code class="language-bash">-p</code> Option: Create Parent Directories</h2>
<p>The <code class="language-bash">-p</code> option lets you create parent directories as needed.</p>
<div class="w3-example">
<h3>Example: Create Parent Directories</h3>
<div>
<pre class="command-line"><code class="language-bash">mkdir -p parent/child</code></pre>
</div>
</div>
...
<h2><code class="language-bash">-v</code> Option: Verbose Output</h2>
<p>The <code class="language-bash">-v</code> option prints a message for each directory created, which is helpful for tracking what happens.</p>
<div class="w3-example">
<h3>Example: Verbose Output</h3>
<div>
<pre class="command-line" data-output="2"><code class="language-bash">mkdir -v new_directory
mkdir: created directory 'new_directory'</code></pre>
</div>
</div>

<hr>

<h2><code class="language-bash">-m</code> Option: Set File Mode</h2>
<p>The <code class="language-bash">-m</code> option allows you to set the file mode (permissions) for the new directories.</p>
<p>This is useful for ensuring the correct permissions are set at creation.</p>
<div class="w3-example">
<h3>Example: Set File Mode</h3>
<div>
<pre class="command-line"><code class="language-bash">mkdir -m 755 new_directory</code></pre>
</div>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_mkdir.js" data-extensions="php"></div>
<hr>
