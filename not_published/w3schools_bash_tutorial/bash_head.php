...
<html lang="en-US">
<head>
<title>Bash head Command - Display the beginning of a file</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Bash <code class="language-bash">head</code> Command - Display the beginning of a file</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_tail.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_ps.php">Next &#10095;</a>
</div>
<hr>

<h2>Using the <code class="language-bash">head</code> Command</h2>
<p>The <code class="language-bash">head</code> command is used to display the first part of files.</p>
<p>It's particularly useful for previewing the start of a file to understand its structure.</p>

<p>All examples below use the <code>logfile.txt</code> file:</p>
<pre><code class="language-bash">line 01
line 02
line 03
line 04
line 05
...
<h2>Basic Usage</h2>
<p>The <code class="language-bash">head</code> command displays the first 10 lines of a file by default:</p>
<div class="w3-example">
<h3>Example: Display First 10 Lines</h3>
<div>
<pre class="command-line" data-output="2-11"><code class="language-bash">head logfile.txt
line 01
line 02
line 03
line 04
...
<h2>Options</h2>
<p>The <code class="language-bash">head</code> command has several options used to customize its behavior:</p>
<ul>
<li><code class="language-bash">-n [number]</code>: Display the first [number] lines of the file.</li>
<li><code class="language-bash">-c [number]</code>: Display the first [number] bytes of the file.</li>
</ul>
<hr>
<h2>Option: -n [number]</h2>
<p>The <code class="language-bash">-n</code> option allows you to specify the number of lines to display from the start of the file. By default, <code class="language-bash">head</code> shows the first 10 lines.</p>
<div class="w3-example">
<h3>Example: Display First 5 Lines</h3>
<div>
<pre class="command-line" data-output="2-6"><code class="language-bash">head -n 5 logfile.txt
line 01
line 02
line 03
line 04
...
<p>The <code class="language-bash">-c</code> option allows you to display the first [number] bytes of a file instead of lines.</p>
<div class="w3-example">
<h3>Example: Display First 20 Bytes</h3>
<div>
<pre class="command-line" data-output="2-4"><code class="language-bash">head -c 20 logfile.txt
line 01
line 02
line </code></pre>
</div>
...
<hr>
<h2>Option: Multiple Files</h2>
<p>The <code class="language-bash">head</code> command can be used to display the beginning of multiple files. By default, it prints the file name as a header before the content of each file.</p>
<div class="w3-example">
<h3>Example: Display First 3 Lines of Multiple Files</h3>
<div>
<pre class="command-line" data-output="2-10"><code class="language-bash">head -n 3 logfile.txt logfile2.txt
==> logfile.txt <==
line 01
line 02
line 03
...
<h2>Option: -q</h2>
<p>The <code class="language-bash">-q</code> option suppresses the printing of headers when multiple files are being processed. This is useful when you want to view the contents of multiple files without the file names being printed.</p>
<div class="w3-example">
<h3>Example: Suppress Headers</h3>
<div>
<pre class="command-line" data-output="2-7"><code class="language-bash">head -q -n 3 logfile.txt logfile2.txt
line 01
line 02
line 03
line 01
...
<hr>
<h2>Common Uses</h2>
<p>The <code class="language-bash">head</code> command is commonly used to:</p>
<ul>
<li>Preview the start of a file to understand its structure.</li>
<li>Quickly check the contents of a file without opening it fully.</li>
<li>Extract the header information from a data file.</li>
</ul>
<hr>
<div id="exercisecontainer" src="xrcise_head.js" data-extensions="php"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_tail.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_ps.php">Next &#10095;</a>
