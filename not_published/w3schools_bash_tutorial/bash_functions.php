...
<a class="w3-left w3-btn" href="bash_loops.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_arrays.php">Next &#10095;</a>
</div>

<hr>
<h2>Defining Functions</h2>
<p>To define a function in Bash, use the following syntax. The function name is followed by parentheses, and the function body is enclosed in curly braces:</p>
<div class="w3-example">
<h3>Example: Define a Function</h3>
<div>
<pre><code class="language-bash">my_function() {
  echo "Hello, World!"
}</code></pre>
</div>
</div>
<p class="ws-note">It's a good practice to use descriptive names for functions.</p>
<hr>
<h2>Calling Functions</h2>
<p>In Bash, execute (or call) a function by using its name.</p>
<p>Functions can be called multiple times, which helps in reusing code:</p>
<div class="w3-example">
<h3>Example: Call a Function</h3>
<div>
<pre><code class="language-bash">my_function</code></pre>
</div>
</div>
<hr>
...
<p>Functions can accept arguments, return values, and use local variables. Here's an example of a function that takes an argument and uses a local variable:</p>
<div class="w3-example">
<h3>Example: Advanced Function Features</h3>
<div>
...
<p>You can also return values from functions using <code>echo</code> or the <code>return</code> statement:</p>
<div class="w3-example">
...
result=$(add 5 3)
echo "The sum is $result"</code></pre>
</div>
</div>
<hr>
