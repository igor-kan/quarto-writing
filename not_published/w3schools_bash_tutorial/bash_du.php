...
<html lang="en-US">
<head>
<title>Bash du Command - File Space Usage</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Bash <code class="language-bash">du</code> Command - File Space Usage</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_df.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_free.php">Next &#10095;</a>
</div>
<hr>
<h2>Using the <code class="language-bash">du</code> Command</h2>
<p>The <code class="language-bash">du</code> command is used to estimate file space usage.</p>
<p>It's helpful for finding out how much space files and directories take up.</p>
<p>All examples below use a hypothetical output for demonstration:</p>

<pre><code class="language-bash">8.0K    ./dir1
12K     ./dir2
20K     .
</code></pre>
...
<p>The <code class="language-bash">du</code> command output consists of two columns:</p>
<ul>
<li><strong>Size</strong>: The amount of disk space used by the file or directory.</li>
<li><strong>Path</strong>: The file or directory path.</li>
</ul>

<hr>

<h2>Basic Usage</h2>
<p>To display file space usage, use <code class="language-bash">du</code>:</p>
<div class="w3-example">
<h3>Example: Basic Usage</h3>
<div>
<pre class="command-line" data-output="2-4"><code class="language-bash">du
8.0K    ./dir1
12K     ./dir2
20K     .</code></pre>
</div>
...
<h2>Options</h2>
<p>The <code class="language-bash">du</code> command has options to change how it works:</p>
<ul>
<li><code class="language-bash">-h</code> - Show sizes in human-readable format (e.g., KB, MB)</li>
<li><code class="language-bash">-s</code> - Show only the total size for each item</li>
<li><code class="language-bash">-a</code> - Show sizes for all files, not just directories</li>
<li><code class="language-bash">-c</code> - Produce a grand total</li>
<li><code class="language-bash">--max-depth=N</code> - Limit the depth of directory traversal</li>
</ul>
<hr>
...
<div>
<pre class="command-line" data-output="2-4"><code class="language-bash">du -h
8.0K    ./dir1
12K     ./dir2
20K     .</code></pre>
</div>
...
<h2>Show Only Total Size</h2>
<p>The <code class="language-bash">-s</code> option allows you to show only the total size for each item.</p>
<div class="w3-example">
<h3>Example: Show Only Total Size</h3>
<div>
<pre class="command-line" data-output="2"><code class="language-bash">du -s
20K     .</code></pre>
</div>
</div>
...
<h2>Show Sizes for All Files</h2>
<p>The <code class="language-bash">-a</code> option allows you to show sizes for all files, not just directories.</p>
<div class="w3-example">
<h3>Example: Show Sizes for All Files</h3>
<div>
<pre class="command-line" data-output="2-6"><code class="language-bash">du -a
4.0K    ./file1
4.0K    ./file2
8.0K    ./dir1
12K     ./dir2
...
<h2>Produce a Grand Total</h2>
<p>The <code class="language-bash">-c</code> option allows you to produce a grand total.</p>
<div class="w3-example">
<h3>Example: Produce a Grand Total</h3>
<div>
<pre class="command-line" data-output="2-5"><code class="language-bash">du -c
8.0K    ./dir1
12K     ./dir2
20K     .
40K     total</code></pre>
...
<h2>Limit Directory Traversal Depth</h2>
<p>The <code class="language-bash">--max-depth=N</code> option allows you to limit the depth of directory traversal.</p>
<p>This can be useful for summarizing disk usage at a specific directory level.</p>
<div class="w3-example">
<h3>Example: Limit Directory Traversal Depth</h3>
<div>
<pre class="command-line" data-output="2-4"><code class="language-bash">du --max-depth=1
8.0K    ./dir1
12K     ./dir2
20K     .</code></pre>
<p>In this example, <code class="language-bash">du --max-depth=1</code> shows the space used by each directory at the top level, without diving deeper into subdirectories.</p>
</div>
</div>

<div class="w3-example">
<h3>Example: Limit Directory Traversal Depth to 2</h3>
<div>
<pre class="command-line" data-output="2-6"><code class="language-bash">du --max-depth=2
4.0K    ./dir1/subdir1
8.0K    ./dir1
6.0K    ./dir2/subdir2
12K     ./dir2
20K     .</code></pre>
<p>Here, <code class="language-bash">du --max-depth=2</code> provides a summary of disk usage up to two levels deep, including subdirectories.</p>
</div>
</div>
...
<p>Options can be combined to provide more detailed output. For example, <code class="language-bash">du -h --max-depth=1</code> shows sizes in human-readable format with limited directory depth.</p>
<div class="w3-example">
<h3>Example: Combine Options</h3>
<div>
<pre class="command-line" data-output="2-4"><code class="language-bash">du -h --max-depth=1
8.0K    ./dir1
12K     ./dir2
20K     .</code></pre>
</div>
...
<hr>
<div id="exercisecontainer" src="xrcise_du.js" data-extensions="php"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_df.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_free.php">Next &#10095;</a>
