...
ny:-->
    ...
    <h1>Bash <code class="language-bash">alias</code></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_man.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_grep.php">Next &#10095;</a>
</div>
<hr>

<h2>Understanding <code class="language-bash">alias</code></h2>
<p>Aliases in Bash allow you to create shortcuts for long or frequently used commands. This makes it easier to execute complex commands with a simple keyword.</p>


<hr>

<h2>Creating Aliases</h2>
<p>To create an alias, use the syntax <code class="language-bash">alias name='command'</code>, where <code class="language-bash">name</code> is the shortcut you want to use, and <code class="language-bash">command</code> is the full command you want to run.</p>

<h3>Example: Simple Alias - List</h3>
<div class="w3-example">
<pre class="command-line"><code class="language-bash">alias ll='ls -la'</code></pre>
</div>
<p>In this example, <code class="language-bash">ll</code> lists all files in long format.</p>

<h3>Example: Simple Alias - Git Status</h3>
<div class="w3-example">
<pre class="command-line"><code class="language-bash">alias gs='git status'</code></pre>
</div>
<p>In this example, <code class="language-bash">gs</code> is a shortcut for <code class="language-bash">git status</code>.</p>
<hr>

<h2>Managing Aliases</h2>
<p>To view all current aliases, use the <code class="language-bash">alias</code> command without arguments.</p>

<h3>Example: Viewing Aliases</h3>
<div class="w3-example">
<pre class="command-line" data-output="2-3"><code class="language-bash">alias
alias ll='ls -l'
alias gs='git status'</code></pre>
</div>

<p>To remove an alias, use <code class="language-bash">unalias name</code>.</p>

<h3>Example: Removing an Alias</h3>
<div class="w3-example">
<pre class="command-line"><code class="language-bash">unalias gs</code></pre>
</div>
<hr>
...
<p>To make an alias permanent, add it to your <code class="language-bash">~/.bashrc</code> or <code class="language-bash">~/.bash_profile</code> file.</p>

<h3>Example: Adding Permanent Alias - Open Editor</h3>
<div class="w3-example">
<pre class="command-line"><code class="language-bash">nano ~/.bashrc</code></pre>
</div>

<h3>Example: Adding Permanent Alias - Add Alias</h3>
<div class="w3-example">
<pre class="command-line" data-output="1"><code class="language-bash">alias ll='ls -la'</code></pre>
</div>

<h3>Example: Adding Permanent Alias - Save and Apply</h3>
<div class="w3-example">
<pre class="command-line"><code class="language-bash">source ~/.bashrc</code></pre>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_alias.js" data-extensions="php"></div>
<hr>
