...
<html lang="en-US">
<head>
<title>Bash free Command - Display Free and Used Memory</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Bash <code class="language-bash">free</code> Command - Display Free and Used Memory</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_du.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_kill.php">Next &#10095;</a>
</div>
<hr>
<h2>Using the <code class="language-bash">free</code> Command</h2>
<p>The <code class="language-bash">free</code> command is used to display the amount of free and used memory in the system.</p>
<p>It's useful for monitoring memory usage and managing system resources.</p>

<hr>
<h2>Basic Usage</h2>
<p>To display memory usage, use <code class="language-bash">free</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<div>
<pre class="command-line" data-output="2-4"><code class="language-bash">free -k
              total        used        free      shared  buff/cache   available
Mem:        8176588     1376568     5869188      146532     1051172     6352280
Swap:       2097148           0     2097148</code></pre>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trybash.php?filename=demo_bash_free">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Options</h2>
<p>The <code class="language-bash">free</code> command has options to change how it works:</p>
<ul>
<li><code class="language-bash">-h</code> - Show memory in human-readable format (e.g., KB, MB, GB)</li>
<li><code class="language-bash">-b</code> - Show memory in bytes</li>
<li><code class="language-bash">-k</code> - Show memory in kilobytes (KB)</li>
<li><code class="language-bash">-m</code> - Show memory in megabytes (MB)</li>
<li><code class="language-bash">-g</code> - Show memory in gigabytes (GB)</li>
<li><code class="language-bash">-s [interval]</code> - Continuously display memory usage at specified intervals</li>
<li><code class="language-bash">-t</code> - Display total memory</li>
</ul>
<hr>
...
<h2>Show Memory in Human-Readable Format</h2>
<p>The <code class="language-bash">-h</code> option allows you to show memory in a human-readable format, such as KB, MB, or GB.</p>
<p>Without this option, memory is displayed in kilobytes by default.</p>
<div class="w3-example">
<h3>Example: Show Memory in Human-Readable Format</h3>
<div>
<pre class="command-line" data-output="2-4"><code class="language-bash">free -h
              total        used        free      shared  buff/cache   available
...
<h2>Show Memory in Bytes</h2>
<p>The <code class="language-bash">-b</code> option allows you to show memory in bytes, providing a more precise measurement.</p>
<p>Without this option, memory is displayed in kilobytes by default.</p>
<div class="w3-example">
<h3>Example: Show Memory in Bytes</h3>
<div>
<pre class="command-line" data-output="2-4"><code class="language-bash">free -b
              total        used        free      shared  buff/cache   available
Mem:     8374145024   1409286144   6008344576    149946368   1076512768   6563766272
Swap:    2147479552           0   2147479552</code></pre>
</div>
</div>

<hr>

<h2>Show Memory in Kilobytes</h2>
<p>The <code class="language-bash">-k</code> option allows you to show memory in kilobytes.</p>
<p>This is the default behavior of the <code class="language-bash">free</code> command.</p>
<div class="w3-example">
<h3>Example: Show Memory in Kilobytes</h3>
<div>
<pre class="command-line" data-output="2-4"><code class="language-bash">free -k
              total        used        free      shared  buff/cache   available
Mem:        8176588     1376568     5869188      146532     1051172     6352280
...
<h2>Show Memory in Megabytes</h2>
<p>The <code class="language-bash">-m</code> option allows you to show memory in megabytes, which can be easier to read for larger memory sizes.</p>
<p>Without this option, memory is displayed in kilobytes by default.</p>
<div class="w3-example">
<h3>Example: Show Memory in Megabytes</h3>
<div>
<pre class="command-line" data-output="2-4"><code class="language-bash">free -m
              total        used        free      shared  buff/cache   available
...
<h2>Show Memory in Gigabytes</h2>
<p>The <code class="language-bash">-g</code> option allows you to show memory in gigabytes, which is useful for systems with large amounts of memory.</p>
<p>Without this option, memory is displayed in kilobytes by default.</p>
<div class="w3-example">
<h3>Example: Show Memory in Gigabytes</h3>
<div>
<pre class="command-line" data-output="2-4"><code class="language-bash">free -g
              total        used        free      shared  buff/cache   available
Mem:              7           1           5           0           1           6
Swap:             1           0           1</code></pre>
</div>
...
<h2>Continuously Display Memory Usage</h2>
<p>The <code class="language-bash">-s</code> option allows you to continuously display memory usage at specified intervals. This is useful for monitoring memory usage over time.</p>
<div class="w3-example">
<h3>Example: Continuously Display Memory Usage</h3>
<div>
<pre class="command-line"><code class="language-bash">free -s 5</code></pre>
<p>This command will update the memory usage every 5 seconds.</p>
</div>
</div>

<hr>

<h2>Display Total Memory</h2>
<p>The <code class="language-bash">-t</code> option includes a line showing the total memory (used + free) for both RAM and swap. This provides a quick overview of total memory resources.</p>
<div class="w3-example">
<h3>Example: Display Total Memory</h3>
<div>
<pre class="command-line" data-output="2-5"><code class="language-bash">free -t
              total        used        free      shared  buff/cache   available
Mem:        8176588     1376568     5869188      146532     1051172     6352280
Swap:       2097148           0     2097148
Total:     10273736     1376568     7966336</code></pre>
</div>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_free.js" data-extensions="php"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_du.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_kill.php">Next &#10095;</a>
