...
<html lang="en-US">
<head>
<title>Bash unzip Command - Extract from ZIP archive</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Bash <code class="language-bash">unzip</code> Command - Extract from ZIP archive</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_zip.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_tar.php">Next &#10095;</a>
</div>

<hr>
<h2>Using the <code class="language-bash">unzip</code> Command</h2>
<p>The <code class="language-bash">unzip</code> command is used to extract compressed files from a ZIP archive.</p>
<hr>

<h2>Basic Usage</h2>
<p>To extract files from a ZIP archive, use <code class="language-bash">unzip archive.zip</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<div>
<pre class="command-line" data-output="2-4"><code class="language-bash">unzip archive.zip
Archive: archive.zip
inflating: file1
inflating: file2</code></pre>
</div>
</div>

<hr>

<h2>Unzip Options Overview</h2>
<p>Here are some common options you can use with the <code class="language-bash">unzip</code> command:</p>
<ul>
<li><code class="language-bash">-l</code> - List archive files</li>
<li><code class="language-bash">-t</code> - Test compressed archive files</li>
<li><code class="language-bash">-d</code> - Extract files into a different directory</li>
<li><code class="language-bash">-o</code> - Overwrite existing files without prompting</li>
<li><code class="language-bash">-x</code> - Exclude specific files from being extracted</li>
</ul>
<hr>

<h2>Option: -l (List)</h2>
<p>The <code class="language-bash">-l</code> option lists all the files in the ZIP archive without extracting them.</p>
<div class="w3-example">
<h3>Example: List Files</h3>
<div>
<pre class="command-line" data-output="2-7"><code class="language-bash">unzip -l archive.zip
...
<h2>Option: -t (Test)</h2>
<p>The <code class="language-bash">-t</code> option tests the integrity of the files in the ZIP archive.</p>
<div class="w3-example">
<h3>Example: Test Archive</h3>
<div>
<pre class="command-line" data-output="2-5"><code class="language-bash">unzip -t archive.zip
Archive: archive.zip
testing: file1 OK
testing: file2 OK
No errors detected in compressed data of archive.zip</code></pre>
</div>
</div>
<hr>

<h2>Option: -d (Extract to Directory)</h2>
<p>The <code class="language-bash">-d</code> option extracts files to a specified directory.</p>
<div class="w3-example">
<h3>Example: Extract to Directory</h3>
<div>
<pre class="command-line" data-output="2-4"><code class="language-bash">unzip -d /path/to/extract/ archive.zip
Archive: archive.zip
  inflating: /path/to/extract/file1
  inflating: /path/to/extract/file2</code></pre>
</div>
</div>
<hr>

<h2>Option: -o (Overwrite)</h2>
<p>The <code class="language-bash">-o</code> option overwrites existing files without prompting.</p>
<div class="w3-example">
<h3>Example: Overwrite Files</h3>
<div>
<pre class="command-line" data-output="2-4"><code class="language-bash">unzip -o archive.zip
Archive: archive.zip
replacing: file1
replacing: file2</code></pre>
</div>
</div>
<hr>

<h2>Option: -x (Exclude)</h2>
<p>The <code class="language-bash">-x</code> option excludes specific files from being extracted.</p>
<div class="w3-example">
<h3>Example: Exclude Files</h3>
<div>
<pre class="command-line" data-output="2-3"><code class="language-bash">unzip archive.zip -x file1
Archive: archive.zip
  inflating: file2</code></pre>
</div>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_unzip.js" data-extensions="php"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_zip.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_tar.php">Next &#10095;</a>
