...
<html lang="en-US">
<head>
<title>Bash df Command - File System Disk Space Usage</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Bash <code class="language-bash">df</code> Command - File System Disk Space Usage</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_top.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_du.php">Next &#10095;</a>
</div>
<hr>

<h2>Using the <code class="language-bash">df</code> Command</h2>
<p>The <code class="language-bash">df</code> command is used to report file system disk space usage.</p>
<p>It's a useful tool for checking available storage on your system.</p>

<p>All examples below use a hypothetical output for demonstration:</p>
...
<p>The <code class="language-bash">df</code> command output consists of several columns, each representing different aspects of the file system's disk usage:</p>
<ul>
<li><strong>Filesystem</strong>: The name of the file system.</li>
<li><strong>1K-blocks</strong>: Total size of the file system in 1K blocks.</li>
<li><strong>Used</strong>: Amount of space used.</li>
<li><strong>Available</strong>: Amount of space available for use.</li>
<li><strong>Use%</strong>: Percentage of space used.</li>
<li><strong>Mounted on</strong>: Directory where the file system is mounted.</li>
</ul>

<hr>

<h2>Basic Usage</h2>
<p>To display disk space usage, use <code class="language-bash">df</code>:</p>
<div class="w3-example">
<h3>Example: Basic Usage</h3>
<div>
<pre class="command-line" data-output="2-5"><code class="language-bash">df
Filesystem     1K-blocks    Used Available Use% Mounted on
/dev/sda1       20480000 1024000  19456000   5% /
tmpfs            4096000       0   4096000   0% /dev/shm
/dev/sdb1       10240000  512000   9728000   5% /mnt/data</code></pre>
</div>
</div>
...
<h2>Options</h2>
<p>The <code class="language-bash">df</code> command has options to change how it works:</p>
<ul>
<li><code class="language-bash">-h</code> - Show sizes in human-readable format (e.g., KB, MB)</li>
<li><code class="language-bash">-a</code> - Show all file systems, even empty ones</li>
<li><code class="language-bash">-T</code> - Show the type of file system</li>
<li><code class="language-bash">-i</code> - Show inode usage</li>
<li><code class="language-bash">-P</code> - Use POSIX output format</li>
</ul>
<hr>
<h2>Show Sizes in Human-Readable Format</h2>
<p>The <code class="language-bash">-h</code> option allows you to show sizes in human-readable format.</p>
<div class="w3-example">
<h3>Example: Show Sizes in Human-Readable Format</h3>
<div>
<pre class="command-line" data-output="2-5"><code class="language-bash">df -h
Filesystem      Size  Used Avail Use% Mounted on
/dev/sda1        20G  1.0G   19G   5% /
tmpfs           4.0G     0  4.0G   0% /dev/shm
/dev/sdb1        10G  500M  9.5G   5% /mnt/data</code></pre>
</div>
</div>

<hr>

<h2>Show All File Systems</h2>
<p>The <code class="language-bash">-a</code> option allows you to show all file systems, even empty ones.</p>
<div class="w3-example">
<h3>Example: Show All File Systems</h3>
<div>
<pre class="command-line" data-output="2-6"><code class="language-bash">df -a
Filesystem     1K-blocks    Used Available Use% Mounted on
/dev/sda1       20480000 1024000  19456000   5% /
tmpfs            4096000       0   4096000   0% /dev/shm
/dev/sdb1       10240000  512000   9728000   5% /mnt/data
...
<h2>Show File System Type</h2>
<p>The <code class="language-bash">-T</code> option allows you to show the type of file system.</p>
<div class="w3-example">
<h3>Example: Show File System Type</h3>
<div>
<pre class="command-line" data-output="2-5"><code class="language-bash">df -T
Filesystem     Type     1K-blocks    Used Available Use% Mounted on
/dev/sda1      ext4      20480000 1024000  19456000   5% /
tmpfs          tmpfs      4096000       0   4096000   0% /dev/shm
/dev/sdb1      ext4      10240000  512000   9728000   5% /mnt/data</code></pre>
</div>
</div>

<p><strong>File System Type:</strong> This indicates the format and structure used to store and organize data on a disk.</p>
<p>Common file system types include <code class="language-bash">ext4</code>, <code class="language-bash">ntfs</code>, and <code class="language-bash">vfat</code>.</p>
<p>Each type has its own features, limitations, and compatibility with operating systems.</p>
<hr>

<h2>Show Inode Usage</h2>
<p>The <code class="language-bash">-i</code> option allows you to show inode usage.</p>
<div class="w3-example">
<h3>Example: Show Inode Usage</h3>
<div>
<pre class="command-line" data-output="2-5"><code class="language-bash">df -i
Filesystem     Inodes IUsed IFree IUse% Mounted on
/dev/sda1     1310720  2560 1308160    1% /
tmpfs         1048576     1 1048575    1% /dev/shm
/dev/sdb1      655360   100  655260    1% /mnt/data</code></pre>
</div>
</div>
<p><strong>Inodes:</strong> Inodes are data structures used by many file systems to store information about files and directories, such as their size, owner, permissions, and timestamps.</p>
<p>Each file or directory has a unique inode. The <code class="language-bash">df -i</code> command shows inode usage, which can be important for systems with many small files.</p>
<hr>

<h2>Use POSIX Output Format</h2>
<p>The <code class="language-bash">-P</code> option allows you to use the POSIX output format.</p>
<div class="w3-example">
<h3>Example: Use POSIX Output Format</h3>
<div>
<pre class="command-line" data-output="2-5"><code class="language-bash">df -P
...
<p><strong>POSIX:</strong> POSIX (Portable Operating System Interface) is a set of standards specified by the IEEE for maintaining compatibility between operating systems.</p>
<p>The <code class="language-bash">df -P</code> option provides output in a POSIX-compliant format, ensuring consistency across different environments and systems.</p>
<hr>

<h2>Combining Options</h2>
<p>Options can be combined to provide more detailed output.</p>
<p>For example, <code class="language-bash">df -hT</code> shows sizes in human-readable format along with the file system type.</p>
<div class="w3-example">
<h3>Example: Combine Options</h3>
<div>
<pre class="command-line" data-output="2-5"><code class="language-bash">df -hT
Filesystem     Type     Size  Used Avail Use% Mounted on
/dev/sda1      ext4      20G  1.0G   19G   5% /
tmpfs          tmpfs    4.0G     0  4.0G   0% /dev/shm
/dev/sdb1      ext4      10G  500M  9.5G   5% /mnt/data</code></pre>
</div>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_df.js" data-extensions="php"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_top.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_du.php">Next &#10095;</a>
