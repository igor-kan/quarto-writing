...
<html lang="en-US">
<head>
<title>Bash tail Command - Display Last Part of Files</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Bash <code class="language-bash">tail</code> Command - Display Last Part of Files</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_sort.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_head.php">Next &#10095;</a>
</div>

<hr>
<h2>Using the <code class="language-bash">tail</code> Command</h2>
<p>The <code class="language-bash">tail</code> command is used to display the last part of files.</p>
<p>It's particularly useful for viewing the end of log files or any file that is being updated in real-time.</p>
<hr>

<h2>Syntax</h2>
<p>The basic syntax of the <code class="language-bash">tail</code> command is:</p>

<div class="notranslate">
<pre class="command-line"><code class="language-bash">tail [OPTION]... [FILE]...</code></pre>  
</div>

<div class="w3-example">
<h3>Example</h3>
<div>
<pre class="command-line" data-output="2-11"><code class="language-bash">tail logfile.txt
line 91
line 92
line 93
line 94
...
<h2>Options</h2>
<p>The <code class="language-bash">tail</code> command has several options to customize its behavior:</p>
<ul>
<li><code class="language-bash">-n [number]</code>: Display the last [number] lines of the file.</li>
<li><code class="language-bash">-f</code>: Follow the file as it grows, useful for monitoring log files.</li>
<li><code class="language-bash">-c [number]</code>: Display the last [number] bytes of the file.</li>
<li><code class="language-bash">--pid=[pid]</code>: Terminate after the process with the given PID dies.</li>
<li><code class="language-bash">--retry</code>: Keep trying to open a file even if it is inaccessible.</li>
</ul>
...
<h2>Option: -n [number]</h2>
<p>The <code class="language-bash">-n</code> option allows you to specify the number of lines to display from the end of the file.</p>
<p>By default, <code class="language-bash">tail</code> shows the last 10 lines.</p>
<div class="w3-example">
<h3>Example: Display Last 5 Lines</h3>
<div>
<pre class="command-line" data-output="2-6"><code class="language-bash">tail -n 5 logfile.txt
line 96
line 97
line 98
line 99
...
<hr>
<h2>Option: -f</h2>
<p>The <code class="language-bash">-f</code> option is used to follow a file as it grows, which is particularly useful for monitoring log files in real-time.</p>
<div class="w3-example">
<h3>Example: Follow Log File</h3>
<div>
<pre class="command-line" data-output="2-12"><code class="language-bash">tail -f logfile.txt
line 91
line 92
line 93
line 94
...
<hr>
<h2>Option: -c [number]</h2>
<p>The <code class="language-bash">-c</code> option allows you to display the last [number] bytes of a file instead of lines.</p>
<div class="w3-example">
<h3>Example: Display Last 20 Bytes</h3>
<div>
<pre class="command-line" data-output="2-3"><code class="language-bash">tail -c 20 logfile.txt

end of logfile.txt</code></pre>
</div>
</div>

<hr>
<h2>Option: --pid=[pid]</h2>
<p>The <code class="language-bash">--pid</code> option terminates tailing after the process with the given PID dies. This is useful for stopping the tail operation when a related process ends.</p>
<div class="w3-example">
<h3>Example: Terminate After Process Ends</h3>
<div>
<pre class="command-line"><code class="language-bash">tail -f --pid=1234 logfile.txt
line 91
line 92
line 93
...</code></pre>
...
<hr>
<h2>Option: --retry</h2>
<p>The <code class="language-bash">--retry</code> option makes <code class="language-bash">tail</code> keep trying to open a file even if it is inaccessible. This is useful for files that may be temporarily unavailable.</p>
<div class="w3-example">
<h3>Example: Retry Opening File</h3>
<div>
<pre class="command-line"><code class="language-bash">tail --retry -f logfile.txt
...
<hr>
<h2>Use Cases</h2>
<p>Common scenarios where the <code class="language-bash">tail</code> command is beneficial include:</p>
<ul>
<li>Monitoring server logs to detect issues in real-time.</li>
<li>Checking the latest entries in a continuously updated file.</li>
<li>Debugging applications by reviewing recent log entries.</li>
</ul>
<hr>
<div id="exercisecontainer" src="xrcise_tail.js" data-extensions="php"></div>
<hr>
