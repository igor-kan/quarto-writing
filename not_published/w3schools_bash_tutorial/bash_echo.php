...
<html lang="en-US">
<head>
<title>Bash echo Command - Display Text</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Bash <code class="language-bash">echo</code> Command - Display Text</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_pwd.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_cat.php">Next &#10095;</a>
</div>
<hr>

<h2>Using the <code class="language-bash">echo</code> Command</h2>
<p>The <code class="language-bash">echo</code> command is used to show a line of text or a variable's value in the terminal.</p>

<hr>
<h2>Basic Usage</h2>
<p>To display a simple message, use <code class="language-bash">echo "message"</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<div>
<pre class="command-line" data-output="2"><code class="language-bash">echo "Hello, World!"
Hello, World!</code></pre>
</div>
</div>
<hr>
<h2>Options Overview</h2>
<p>The <code class="language-bash">echo</code> command has several options to customize its output:</p>
<ul>
<li><code class="language-bash">-n</code> - Don't add a new line at the end</li>
<li><code class="language-bash">-e</code> - Allow special characters like <code class="language-bash">\n</code> for new lines</li>
<li><code class="language-bash">-E</code> - Don't allow special characters (default)</li>
</ul>

<hr>
<h2><code class="language-bash">-n</code> Option: No Trailing Newline</h2>
<p>The <code class="language-bash">-n</code> option prevents <code class="language-bash">echo</code> from adding a newline at the end of the output.</p>
<p>This is useful when you want to continue output on the same line.</p>
<div class="w3-example">
<h3>Example: No Trailing Newline</h3>
<div>
<pre class="command-line" data-output="2"><code class="language-bash">echo -n "Hello,";echo " World!"
Hello, World!</code></pre>
</div>
</div>
<hr>
...
<h2><code class="language-bash">-e</code> Option: Enable Backslash Escapes</h2>
<p>The <code class="language-bash">-e</code> option enables the use of backslash escapes like <code class="language-bash">\n</code> for new lines, <code class="language-bash">\t</code> for tabs, etc.</p>
<p>This allows for more formatted output.</p>
<div class="w3-example">
<h3>Example: Enable Backslash Escapes</h3>
<div>
<pre class="command-line" data-output="2-3"><code class="language-bash">echo -e "Hello\nWorld!"
Hello
World!</code></pre>
</div>
</div>
...
<hr>
<h2><code class="language-bash">-E</code> Option: Disable Backslash Escapes</h2>
<p>The <code class="language-bash">-E</code> option disables the use of backslash escapes, which is the default behavior.</p>
<p>This ensures that the text is output exactly as typed.</p>
<div class="w3-example">
<h3>Example: Disable Backslash Escapes</h3>
<div>
<pre class="command-line" data-output="2-3"><code class="language-bash">echo -E "Hello\nWorld!"
Hello\nWorld!</code></pre>
</div>
...
<hr>
<h2>Using <code class="language-bash">echo</code> in Scripts</h2>
<p>The <code class="language-bash">echo</code> command is often used in scripts for debugging or logging information. It helps you see what's happening in your script by printing messages to the terminal.</p>
<div class="w3-example">
<h3>Example in a Script</h3>
<div>
...
<hr>
<div id="exercisecontainer" src="xrcise_echo.js" data-extensions="php"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_pwd.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_cat.php">Next &#10095;</a>
