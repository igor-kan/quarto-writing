...
ny:-->
    ...
    <h1>Getting Started with <span class="color_h1">Bash</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_intro.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_commands.php">Next &#10095;</a>
</div>
<hr>
<h2>Setting Up Bash</h2>
<p>Most Unix/Linux systems come with Bash pre-installed.</p>
<p>To check if Bash is installed, open a terminal and type:</p>
<div>
<pre class="command-line"><code class="language-bash">bash --version</code></pre>
</div>
<p>If Bash isn't installed, you can install it using your system's package manager.</p>
<p>For example, on Ubuntu/Debian, type:</p>
<div>
<pre class="command-line"><code class="language-bash">sudo apt-get install bash</code></pre>
</div>
<p>On macOS, you can install Bash via Homebrew:</p>
<div>
<pre class="command-line"><code class="language-bash">brew install bash</code></pre>
</div>
<p>On Windows, you can use WSL (Windows Subsystem for Linux) to run Linux or just use Git Bash for Windows.</p>
<hr>
...
<p>This command shows the Bash version installed on your system.</p>
<p>You can also write scripts (a list of commands) in a file with a <code class="language-bash">.sh</code> extension:</p>
<p><strong>Simple Script Example:</strong></p>
<pre><code class="language-bash"> #!/bin/bash
echo "Hello, Bash!"</code></pre>
<p>Save this in a file called <code class="language-bash">hello.sh</code> and run it with:</p>
<div class="w3-example">
  <h3>Example</h3>
<pre class="command-line" data-output="2" data-user="user" data-host="localhost"><code class="language-shell">bash hello.sh
Hello, Bash!</code></pre>
</div>
<hr>
