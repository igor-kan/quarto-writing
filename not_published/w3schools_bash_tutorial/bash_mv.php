...
<html lang="en-US">
<head>
<title>Bash mv Command - Move or Rename Files</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Bash <code class="language-bash">mv</code> Command - Move or Rename Files</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_cp.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_rm.php">Next &#10095;</a>
</div>

<hr>
<h2>Using the <code class="language-bash">mv</code> Command</h2>
<p>The <code class="language-bash">mv</code> command is used to move or rename files and directories.</p>
<p>It's like changing where a file is or what it's called.</p>

<hr>

<h2>Basic Usage</h2>
<p>To move a file, use <code class="language-bash">mv source_file destination_directory</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<div>
<pre class="command-line"><code class="language-bash">mv my_file.txt /path/to/destination/</code></pre>
</div>
</div>
...
<p>To rename a file, use <code class="language-bash">mv old_name new_name</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<div>
<pre class="command-line"><code class="language-bash">mv old_name.txt new_name.txt</code></pre>
</div>
</div>
<hr>
...
<p>The <code class="language-bash">mv</code> command has several options to customize its behavior:</p>
<ul>
<li><code class="language-bash">-i</code> - Ask before replacing files</li>
<li><code class="language-bash">-u</code> - Move only if the source is newer</li>
<li><code class="language-bash">-v</code> - Verbose mode, show files being moved</li>
</ul>
<hr>
<h2><code class="language-bash">-i</code> Option: Prompt Before Overwrite</h2>
...
<div>
<pre class="command-line" data-output="2"><code class="language-bash">mv -i my_file.txt myfolder/
mv: overwrite 'myfolder/my_file.txt'?</code></pre>
</div>
</div>

<hr>
<h2><code class="language-bash">-u</code> Option: Move Only Newer Files</h2>
<p>The <code class="language-bash">-u</code> option moves files only if the source file is newer than the destination file.</p>
<div class="w3-example">
<h3>Example: Move Only Newer Files</h3>
<div>
<pre class="command-line"><code class="language-bash">mv -u new_file.txt /path/to/destination/</code></pre>
</div>
</div>

<hr>
<h2><code class="language-bash">-v</code> Option: Verbose Mode</h2>
<p>The <code class="language-bash">-v</code> option enables verbose mode, which displays the files being moved in the terminal.</p>
<p>This is useful for tracking the move process, especially when dealing with many files.</p>
<div class="w3-example">
<h3>Example: Verbose Mode</h3>
<div>
<pre class="command-line" data-output="2"><code class="language-bash">mv -v my_file.txt myfolder/new_directory/  
renamed 'my_file.txt' -> 'myfolder/new_directory/my_file.txt'</code></pre>
</div>
</div>

<hr>

<h2>Using <code class="language-bash">mv</code> with Wildcards</h2>
<p>Wildcards allow you to move multiple files at once. For example, <code class="language-bash">mv *.txt /destination/</code> will move all text files to the destination folder.</p>
<div class="w3-example">
<h3>Example: Using Wildcards</h3>
<div>
<pre class="command-line"><code class="language-bash">mv *.txt /destination/</code></pre>
</div>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_mv.js" data-extensions="php"></div>
<hr>
