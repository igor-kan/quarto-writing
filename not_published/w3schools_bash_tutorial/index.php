...
ny:-->
    ...
    <h1>Bash <span class="color_h1">Tutorial</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="/default.asp">&#10094; Home</a>
<a class="w3-right w3-btn" href="bash_intro.php">Next &#10095;</a>
</div>
  ...
  <div class="cert-card">
    <div class="cert-card-header">
      <div class="cert-card-icon">
        <svg xmlns="http://www.w3.org/2000/svg" width="39" height="39" fill="#000000" viewBox="0 0 24 24"><path d="M21.038,4.9l-7.577-4.498C13.009,0.134,12.505,0,12,0c-0.505,0-1.009,0.134-1.462,0.403L2.961,4.9 C2.057,5.437,1.5,6.429,1.5,7.503v8.995c0,1.073,0.557,2.066,1.462,2.603l7.577,4.497C10.991,23.866,11.495,24,12,24 c0.505,0,1.009-0.134,1.461-0.402l7.577-4.497c0.904-0.537,1.462-1.529,1.462-2.603V7.503C22.5,6.429,21.943,5.437,21.038,4.9z M15.17,18.946l0.013,0.646c0.001,0.078-0.05,0.167-0.111,0.198l-0.383,0.22c-0.061,0.031-0.111-0.007-0.112-0.085L14.57,19.29 c-0.328,0.136-0.66,0.169-0.872,0.084c-0.04-0.016-0.057-0.075-0.041-0.142l0.139-0.584c0.011-0.046,0.036-0.092,0.069-0.121 c0.012-0.011,0.024-0.02,0.036-0.026c0.022-0.011,0.043-0.014,0.062-0.006c0.229,0.077,0.521,0.041,0.802-0.101 c0.357-0.181,0.596-0.545,0.592-0.907c-0.003-0.328-0.181-0.465-0.613-0.468c-0.55,0.001-1.064-0.107-1.072-0.917 c-0.007-0.667,0.34-1.361,0.889-1.8l-0.007-0.652c-0.001-0.08,0.048-0.168,0.111-0.2l0.37-0.236 c0.061-0.031,0.111,0.007,0.112,0.087l0.006,0.653c0.273-0.109,0.511-0.138,0.726-0.088c0.047,0.012,0.067,0.076,0.048,0.151 l-0.144,0.578c-0.011,0.044-0.036,0.088-0.065,0.116c-0.012,0.012-0.025,0.021-0.038,0.028c-0.019,0.01-0.038,0.013-0.057,0.009 c-0.098-0.022-0.332-0.073-0.699,0.113c-0.385,0.195-0.52,0.53-0.517,0.778c0.003,0.297,0.155,0.387,0.681,0.396 c0.7,0.012,1.003,0.318,1.01,1.023C16.105,17.747,15.736,18.491,15.17,18.946z M19.143,17.859c0,0.06-0.008,0.116-0.058,0.145 l-1.916,1.164c-0.05,0.029-0.09,0.004-0.09-0.056v-0.494c0-0.06,0.037-0.093,0.087-0.122l1.887-1.129 c0.05-0.029,0.09-0.004,0.09,0.056V17.859z M20.459,6.797l-7.168,4.427c-0.894,0.523-1.553,1.109-1.553,2.187v8.833 c0,0.645,0.26,1.063,0.66,1.184c-0.131,0.023-0.264,0.039-0.398,0.039c-0.42,0-0.833-0.114-1.197-0.33L3.226,18.64 c-0.741-0.44-1.201-1.261-1.201-2.142V7.503c0-0.881,0.46-1.702,1.201-2.142l7.577-4.498c0.363-0.216,0.777-0.33,1.197-0.33 c0.419,0,0.833,0.114,1.197,0.33l7.577,4.498c0.624,0.371,1.046,1.013,1.164,1.732C21.686,6.557,21.12,6.411,20.459,6.797z"/></svg>
      </div>
      <h2 class="cert-card-title">Learn Bash</h2>
    </div>
    <p class="cert-card-desc">Bash is used to write scripts and run commands on Linux systems.</p>
    <p class="cert-card-desc">It helps automate tasks, manage system operations, and boost productivity.</p>
    <div class="cert-card-bottom" style="margin-top:auto;padding-top:16px;">
      <a href="bash_intro.php" class="cert-card-btn">Learn Bash now &#10095;</a>
    </div>
  </div>

  <div class="cert-info" style="padding:24px;display:flex;flex-direction:column;">
    <h3 class="cert-info-title">Become Bash Certified</h3>
    <p class="cert-info-desc">Get certified with our Bash exam, includes a professionally curated study kit to guide you from beginner to exam-ready.</p>
...
<a href="https://campus.w3schools.com/collections/certifications/products/bash-certification-exam" class="cert-card-btn cert-btn-white" target="_blank" style="margin-top:12px;background:#fff;color:#000;border:2px solid #000;">Get Certified &#10095;</a>
        </div>
        <div class="cert-preview" style="flex:1 1 auto;padding:0;align-self:flex-start;">
          <svg class="cert-preview-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 560 400" role="img" aria-label="Bash Certificate preview" style="width:100%;max-width:250px;height:auto;display:block;margin:0 0 0 auto;">
            ...
            <text x="280" y="212" text-anchor="middle" font-family="Source Sans Pro Topnav, sans-serif" font-size="13" fill="#475569">has passed the W3Schools Bash Certification exam and is hereby declared a</text>
            <g transform="translate(248,222)">
              <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="#000000" viewBox="0 0 24 24"><path d="M21.038,4.9l-7.577-4.498C13.009,0.134,12.505,0,12,0c-0.505,0-1.009,0.134-1.462,0.403L2.961,4.9 C2.057,5.437,1.5,6.429,1.5,7.503v8.995c0,1.073,0.557,2.066,1.462,2.603l7.577,4.497C10.991,23.866,11.495,24,12,24 c0.505,0,1.009-0.134,1.461-0.402l7.577-4.497c0.904-0.537,1.462-1.529,1.462-2.603V7.503C22.5,6.429,21.943,5.437,21.038,4.9z M15.17,18.946l0.013,0.646c0.001,0.078-0.05,0.167-0.111,0.198l-0.383,0.22c-0.061,0.031-0.111-0.007-0.112-0.085L14.57,19.29 c-0.328,0.136-0.66,0.169-0.872,0.084c-0.04-0.016-0.057-0.075-0.041-0.142l0.139-0.584c0.011-0.046,0.036-0.092,0.069-0.121 c0.012-0.011,0.024-0.02,0.036-0.026c0.022-0.011,0.043-0.014,0.062-0.006c0.229,0.077,0.521,0.041,0.802-0.101 c0.357-0.181,0.596-0.545,0.592-0.907c-0.003-0.328-0.181-0.465-0.613-0.468c-0.55,0.001-1.064-0.107-1.072-0.917 c-0.007-0.667,0.34-1.361,0.889-1.8l-0.007-0.652c-0.001-0.08,0.048-0.168,0.111-0.2l0.37-0.236 c0.061-0.031,0.111,0.007,0.112,0.087l0.006,0.653c0.273-0.109,0.511-0.138,0.726-0.088c0.047,0.012,0.067,0.076,0.048,0.151 l-0.144,0.578c-0.011,0.044-0.036,0.088-0.065,0.116c-0.012,0.012-0.025,0.021-0.038,0.028c-0.019,0.01-0.038,0.013-0.057,0.009 c-0.098-0.022-0.332-0.073-0.699,0.113c-0.385,0.195-0.52,0.53-0.517,0.778c0.003,0.297,0.155,0.387,0.681,0.396 c0.7,0.012,1.003,0.318,1.01,1.023C16.105,17.747,15.736,18.491,15.17,18.946z M19.143,17.859c0,0.06-0.008,0.116-0.058,0.145 l-1.916,1.164c-0.05,0.029-0.09,0.004-0.09-0.056v-0.494c0-0.06,0.037-0.093,0.087-0.122l1.887-1.129 c0.05-0.029,0.09-0.004,0.09,0.056V17.859z M20.459,6.797l-7.168,4.427c-0.894,0.523-1.553,1.109-1.553,2.187v8.833 c0,0.645,0.26,1.063,0.66,1.184c-0.131,0.023-0.264,0.039-0.398,0.039c-0.42,0-0.833-0.114-1.197-0.33L3.226,18.64 c-0.741-0.44-1.201-1.261-1.201-2.142V7.503c0-0.881,0.46-1.702,1.201-2.142l7.577-4.498c0.363-0.216,0.777-0.33,1.197-0.33 c0.419,0,0.833,0.114,1.197,0.33l7.577,4.498c0.624,0.371,1.046,1.013,1.164,1.732C21.686,6.557,21.12,6.411,20.459,6.797z"/></svg>
            </g>
            <text x="280" y="300" text-anchor="middle" font-family="Source Sans Pro Topnav, sans-serif" font-size="18" font-weight="700" fill="#0f172a">Certified Bash Developer</text>
...
<h2>Understanding Shells</h2>
<p>A shell is a text-based interface that lets you talk to your computer.</p>
<p>There are different types of shells, but Bash (Bourne Again SHell) is the most popular because it's powerful and easy to use.</p>
<p><strong>Types of Shells:</strong></p>
<ul>
  <li><strong>Bourne Shell (sh):</strong> The original Unix shell, developed by Stephen Bourne.</li>
  <li><strong>C Shell (csh):</strong> Known for its C-like syntax, popular for interactive use.</li>
  <li><strong>Korn Shell (ksh):</strong> Combines features of sh and csh, offering advanced scripting capabilities.</li>
  <li><strong>Bash (Bourne Again SHell):</strong> An improved version of sh, with additional features like command history and tab completion.</li>
</ul>
<p><strong>Why Use Bash?</strong></p>
<ul>
  <li>It is widely available on Unix/Linux systems, making scripts portable.</li>
  <li>Supports powerful scripting features, including loops, conditionals, and functions.</li>
  <li>Provides command history and tab completion for ease of use.</li>
  <li>Can be integrated with other Unix/Linux tools for automation.</li>
</ul>
<hr>

<h2>Learning by Examples</h2>
<p>In this tutorial, we will show you Bash commands like this:</p>

<div class="w3-example">
  <h3>Example</h3>
<pre class="command-line" data-output="2-7" data-user="user" data-host="localhost"><code class="language-shell">bash --version
...
<p>Don't worry! We will keep it really simple, and learning this way gives you a good grasp of how Bash works.</p>
<p>In the code above, you can see commands (input) and output.</p>
<p>Lines like this are commands we input:</p>
<div class="w3-example">
  <h3>Example</h3>
<pre class="command-line" data-user="user" data-host="localhost"><code class="language-shell">bash --version</code></pre>
</div>
<p>Lines like this are the output/response to our commands:</p>
<div class="w3-example">
  <h3>Example</h3>
<pre class="command-line" data-output="1-6"><code class="language-shell">GNU bash, version 5.2.21(1)-release (x86_64-pc-linux-gnu)
Copyright (C) 2022 Free Software Foundation, Inc.
License GPLv3+: GNU GPL version 3 or later
...
<p>In general, lines with <code class="language-shell">$</code> in front of it is input. These are the commands you can copy and run in your terminal.</p>
<hr>
<h2>Bash Exercises</h2>
<p>Many chapters in this tutorial end with an exercise where you can check your level of knowledge.</p>
<div id="exercisecontainer" src="xrcise_getstarted.js" data-extensions="php"></div>
<p><a class="w3-btn w3-margin-bottom ws-green" href="bash_exercises.php" style="border-radius:5px;font-size: 18px;padding-left:25px;padding-right:25px;font-family: 'Source Sans Pro', sans-serif;margin-top:6px;">See all Bash Exercises</a></p>
<hr>
...
<h2>Bash Quiz</h2>
<p>Learn by taking a quiz! The quiz will give you a signal of how much you know about Bash.</p>
<p><a href="bash_quiz.php" class="w3-button w3-blue w3-round">Start Bash Quiz</a></p>
<hr>
