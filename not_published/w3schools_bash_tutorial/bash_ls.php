...
<html lang="en-US">
<head>
<title>Bash ls Command - List Directory Contents</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<!-- [END] inc_meta.inc -->
<link rel="stylesheet" href="prism_coy.css">
</head>
<body>
...
ny:-->
    ...
    <h1>Bash <code class="language-bash">ls</code> Command - List Directory Contents</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bash_commands.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bash_cd.php">Next &#10095;</a>
</div>
<hr>
<h2>Using the <code class="language-bash">ls</code> Command</h2>

<p>The <code class="language-bash">ls</code> command is used to list the contents of a directory.</p>
<p>The <code class="language-bash">ls</code> command can display files, directories, and information about them.</p>

<hr>

<h2>Basic Usage</h2>
<p>To see what's in the current folder, use <code class="language-bash">ls</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<div>
<pre class="command-line" data-output="2-3"><code class="language-bash">ls
Cosmere_RPG_Beta_Rules_Preview.pdf  images/
my_file.txt  report.csv  voiceover.wav</code></pre>
</div>
</div>
...
<p>The <code class="language-bash">ls</code> command has a variety of options to customize its output:</p>
<ul>
<li><code class="language-bash">-l</code> - Long listing format</li>
<li><code class="language-bash">-a</code> - Include hidden files</li>
<li><code class="language-bash">-h</code> - Human-readable sizes</li>
<li><code class="language-bash">-t</code> - Sort by modification time</li>
<li><code class="language-bash">-r</code> - Reverse order while sorting</li>
<li><code class="language-bash">-R</code> - List subdirectories recursively</li>
<li><code class="language-bash">-S</code> - Sort by file size</li>
<li><code class="language-bash">-1</code> - List one file per line</li>
<li><code class="language-bash">-d</code> - List directories themselves, not their contents</li>
<li><code class="language-bash">-F</code> - Append indicator (one of */=@|) to entries</li>
</ul>

<hr>
<h2>Long Listing Format</h2>
<p>The <code class="language-bash">-l</code> option gives you detailed information about files and folders.</p>
<p>It displays information such as:
    <ul>
...
<p>This format is useful for getting a comprehensive overview of the file attributes.</p>
<div class="w3-example">
<h4>Example: Long Listing Format</h4>
<div>
<pre class="command-line" data-output="2-7"><code class="language-bash">ls -l
total 24232
...
-rw-r--r-- 1 user 197609   720974 Apr  9 07:47 voiceover.wav</code></pre>
</div>
</div>
<hr>
...
<p>The <code class="language-bash">-a</code> option includes hidden files in the listing.</p>
<p>Hidden files in Unix/Linux systems start with a dot (e.g., <code class="language-bash">.bashrc</code>).</p>
<p>This option is helpful when you need to view or manage configuration files that are not visible by default.</p>
<div class="w3-example">
<h4>Example: Including Hidden Files</h4>
<div>
<pre class="command-line" data-output="2-3"><code class="language-bash">ls -a
./  ../  .my_secret_file  Cosmere_RPG_Beta_Rules_Preview.pdf
images/  my_file.txt  report.csv  voiceover.wav</code></pre>
</div>
</div>
<hr>
<h2>Human-Readable Sizes</h2>
<p>The <code class="language-bash">-h</code> option makes file sizes easier to read by converting byte counts into kilobytes (K), megabytes (M), gigabytes (G), etc.</p>
<p>This option is particularly useful when you want to quickly assess the size of files and directories without manually converting bytes.</p>
<div class="w3-example">
<h4>Example: Human-Readable Sizes</h4>
<div>
<pre class="command-line" data-output="2-7"><code class="language-bash">ls -lh
total 24M
...
-rw-r--r-- 1 user 197609 705K Apr  9 07:47 voiceover.wav</code></pre>
</div>
</div>
<hr>
<h2>Sorting by Time</h2>
<p>The <code class="language-bash">-t</code> option sorts files and directories by modification time, with the most recently modified files first.</p>
<p>This option is useful when you want to see the most recently updated files first.</p>
<div class="w3-example">
<h4>Example: Sorting by Time</h4>
<div>
<pre class="command-line" data-output="2-3"><code class="language-bash">ls -t
images/  my_file.txt  report.csv  voiceover.wav
Cosmere_RPG_Beta_Rules_Preview.pdf</code></pre>
</div>
</div>
<hr>
<h2>Reverse Order</h2>
<p>The <code class="language-bash">-r</code> option reverses the order of the sort.</p>
<p>When used in combination with other options like <code class="language-bash">-t</code>, it can display the oldest files first.</p>
<p>This option is useful for reversing the default sorting behavior to meet specific needs.</p>
<div class="w3-example">
<h4>Example: Reverse Order</h4>
<div>
<pre class="command-line" data-output="2-3"><code class="language-bash">ls -r
...
<p>The <code class="language-bash">-R</code> option lists directories and their contents recursively.</p>
<p>This is useful for viewing the entire directory tree.</p>
<div class="w3-example">
<h4>Example: Recursive Listing</h4>
<div>
<pre class="command-line" data-output="2-12"><code class="language-bash">ls -R
.:
...
./myfolder/new_directory:</code></pre>
</div>
</div>

<hr>
<h2>Sort by Size</h2>
<p>The <code class="language-bash">-S</code> option sorts files by size, with the largest files first.</p>
<p>This is helpful for quickly identifying large files in a directory.</p>
<div class="w3-example">
<h4>Example: Sort by Size</h4>
<div>
<pre class="command-line" data-output="2-3"><code class="language-bash">ls -S
Cosmere_RPG_Beta_Rules_Preview.pdf  voiceover.wav  report.csv
copy_of_my_file.txt  my_file.txt  images/  myfolder/</code></pre>
</div>
</div>

<hr>
<h2>One File per Line</h2>
<p>The <code class="language-bash">-1</code> option lists one file per line, which is useful for scripts or when piping output to other commands.</p>
<div class="w3-example">
<h4>Example: One File per Line</h4>
<div>
<pre class="command-line" data-output="2-6"><code class="language-bash">ls -1
Cosmere_RPG_Beta_Rules_Preview.pdf
images/
my_file.txt
report.csv
voiceover.wav</code></pre>
</div>
</div>

<hr>
<h2>Directories Only</h2>
<p>The <code class="language-bash">-d</code> option lists directories themselves rather than their contents.</p>
<p>This is useful for seeing directory names without contents.</p>
<div class="w3-example">
<h4>Example: Directories Only</h4>
<div>
<pre class="command-line" data-output="2"><code class="language-bash">ls -d */
images//  myfolder//</code></pre>
</div>
</div>

<hr>
<h2>Append Indicator</h2>
<p>The <code class="language-bash">-F</code> option appends an indicator character to entries (e.g., <code>/</code> for directories, <code>*</code> for executables).</p>
<div class="w3-example">
<h4>Example: Append Indicator</h4>
<div>
<pre class="command-line" data-output="2-3"><code class="language-bash">ls -F
Cosmere_RPG_Beta_Rules_Preview.pdf  images/
my_file.txt  report.csv  voiceover.wav</code></pre>
</div>
</div>
...
<hr>
<h2>Using Multiple Options</h2>
<p>You can combine multiple options to create more complex commands.</p>
<p>For example, <code class="language-bash">ls -l -a</code> will display a detailed listing of all files and directories, including hidden files.</p>
<div class="w3-example">
<h3>Example</h3>
<div>
<pre class="command-line" data-output="2-10"><code class="language-bash">ls -l -a
total 24248
...
<p>You can also combine multiple options without a space between them. For example, <code class="language-bash">ls -la</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<div>
<pre class="command-line" data-output="2-10"><code class="language-bash">ls -la
total 24248
drwxr-xr-x 1 user 197609        0 Apr  9 07:53 ./
drwxr-xr-x 1 user 197609        0 Apr  9 07:42 ../
-rw-r--r-- 1 user 197609      890 Apr  9 07:48 .my_secret_file
...
<hr>
<div id="exercisecontainer" src="xrcise_ls.js" data-extensions="php"></div>
<hr>
...
<script src="prism_coy.js"></script>
<div
