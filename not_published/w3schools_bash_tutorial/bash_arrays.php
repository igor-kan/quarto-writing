...
<a class="w3-left w3-btn" href="bash_functions.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="index.php">Next &#10095;</a>
</div>
<hr>

<h2>Working with Arrays in Bash</h2>
<p>This section explains how to create and manipulate arrays in Bash scripts.</p>
<p>Arrays allow you to store multiple values in a single variable, making data management easier.</p>

<hr>

<h2>Creating Arrays</h2>
<p>To create an array in Bash, use the following syntax.</p>
<p>Arrays can store multiple values, and each value is indexed starting from zero:</p>
<div class="w3-example">
<h3>Example: Create an Array</h3>
<div>
<pre><code class="language-bash">my_array=("value1" "value2" "value3")</code></pre>
</div>
</div>
<p>Use descriptive names for arrays to indicate their purpose.</p>
<hr>
<h2>Accessing Array Elements</h2>
<p>To access elements in a Bash array, use the index of the element.</p>
<p>The index is specified in square brackets:</p>
<div class="w3-example">
<h3>Example: Access Array Elements</h3>
<div>
<pre><code class="language-bash">echo ${my_array[0]}</code></pre>
</div>
</div>
<hr>
...
<p>You can modify elements in a Bash array by specifying the index and assigning a new value:</p>
<div class="w3-example">
<h3>Example: Modify Array Elements</h3>
<div>
<pre><code class="language-bash">my_array[1]="new_value"</code></pre>
</div>
</div>
<hr>
