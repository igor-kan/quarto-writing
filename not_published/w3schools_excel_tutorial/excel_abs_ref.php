...
<html lang="en-US">
<head>
<title>Excel Absolute References</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>Excel <span class="color_h1">Absolute References</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_rel_ref.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_addition.php">Next &#10095;</a>
</div>
<hr>

<h2>Absolute References</h2>

<p>Absolute reference is when a reference has the dollar sign (<code class="w3-codespan">$</code>).</p>

<p>It locks a reference in the formula. </p>

<p>Add <code class="w3-codespan">$</code> to the formula to use absolute references.</p>

<p>The dollar sign has three different states:</p>

<ul>
<li>Absolute for column and row. The reference is absolutely locked.
<br>
Example <code class="w3-codespan">=$A$1</code></li><br>

<li>Absolute for the column. The reference is locked to that column. The row remains relative.
<br>
Example <code class="w3-codespan">=$A1</code>
</li><br>
<li>Absolute for the row. The reference is locked to that row. The column remains relative.
<br>
Example <code class="w3-codespan">=A$1</code>
</li>
</ul>

<p>Let's have a look at an example helping the Pokemon trainers to calculate prices for Pokeballs</p>

<p>Type or copy the following data:</p>

<div class="w3-example">
<h3>Example</h3>
    <div class="w3-code notranslate" style="position:relative">
<img src="abs_ref1.png" style="max-width:100%">
    <textarea id="demo_excel_formulas" style="display:none">
Trainers	Pokeballs	Cost
Iva	2	
Liam	5	
Pablo	10	
Jenny	7	
...
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_abs_ref">Try it Yourself &raquo;</a>
</p>
</div>


<p><strong>Data explained</strong></p>
<ul>
...
<p><strong>Help them to calculate the prices for the Pokeballs.</strong></p>

<p>The price's reference is <code class="w3-codespan">B11</code>, we do not want the fill function to change this, so we lock it. </p>

<p>The reference is absolutely locked by using the formula <code class="w3-codespan">$B$11</code>.</p>

<p>How to do it, step by step:</p>

<ol>
<li>Type <code class="w3-codespan">C2(=)</code></li>
<li>Select <code class="w3-codespan">B11</code></li>
<li>Type (<code class="w3-codespan">$</code>) before the <code class="w3-codespan">B</code> and <code class="w3-codespan">11</code> (<code class="w3-codespan">$B$11</code>)</li>
<li>Type (<code class="w3-codespan">*</code>)</li>
<li>Select <code class="w3-codespan">B2</code></li>
<li>Hit enter</li>
<li>Auto fill <code class="w3-codespan">C2:C7</code></li>
</ol>

<img src="abs_ref2.png" style="max-width:100%">
<br><br>
<img src="abs_ref3.png" style="max-width:100%">
<br><br>
<img src="abs_ref4.png" style="max-width:100%">
...
<br><br>
<img src="abs_ref5.png" style="max-width:100%">
<br><br>
<div class="w3-example">
<div class="w3-code notranslate" style="position:relative">
<img src="abs_ref6.png" style="max-width:100%">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_abs_ref_filled">Try it Yourself &raquo;</a>
</p>
</div>

<p><strong>Congratulations!</strong> You successfully calculated the prices for the Pokeballs using an absolute reference. 
</p>
<hr>

<div>
<form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_rel_ref2" method="post" target="_blank">
<h2>Test Yourself With Exercises</h2>
<div class="exercisewindow">
<h2>Excel Exercise:</h2>
<p>Type reference <code class="w3-codespan">A1</code> as <strong>absolute</strong>:</p>
<div class="exerciseprecontainer">
<pre style="overflow: auto;">
<input name="ex1" maxlength="1" style="width: 15px;">A$1
</pre>
</div>
<br>
<button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
<p><a target="_blank" href="exercise.php?filename=exercise_rel_ref2">Start the Exercise</a></p>
</div>
</form>
</div>
<hr>
