<!DOCTYPE html>
<html lang="en-US">
<head><title>Excel COUNTIFS Function</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_countif.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_if.php">Next &#10095;</a>
</div>
<hr>

<h2>COUNTIFS Function</h2>

<p>The <strong>COUNTIFS</strong> function is a premade function in Excel, which counts cells in a range based on one or more <strong>true</strong> or <strong>false</strong> <strong>condition</strong>.</p>
<p>It is typed <code class="w3-codespan">=COUNTIFS</code>:</p>
<div class="w3-example">
  <div class="w3-code notranslate">
  =COUNTIFS(<strong>criteria_range1</strong>, <strong>criteria1</strong>, <strong>[criteria_range2, criteria2]</strong>, ...)
  </div>
</div>
...
<h2>Example COUNTIFS function</h2>

<p>Find the number of 1st Generation Water type Pokemon:</p>
<p>The conditions are that the type is &quot;Water&quot; and Generation is 1.</p>
<p><img src="img_excel_countifs.png" style="max-width:100%"></p>
<div class="w3-panel ws-note">
    <p><strong>Note:</strong> The full dataset continues after row 14, all the way down to row 759.</p>
  </div>
<p>Example <strong>COUNTIFS</strong> function, step by step:</p>
<ol>
  <li>Select the cell <code class="w3-codespan">G3</code></li>
  <li>Type <code class="w3-codespan">=COUNTIFS</code></li>
  <li>Double click the <strong>COUNTIFS</strong> command</li>
</ol>
<p><img src="img_excel_countifs2.png" style="max-width:100%"></p>
<ol start="4">
  <li>Specify the range for the type <code class="w3-codespan">B2:B759</code> (the Type 1 values)</li>
  <li>Type <code class="w3-codespan">,</code></li>
  <li>Specify the criteria (the cell <code class="w3-codespan">E3</code>, which has the value &quot;Water&quot;)</li>
  <li>Type <code class="w3-codespan">,</code></li>
  <li>Specify the range for the second condition<code class="w3-codespan">C2:C759</code> (the Generation values)</li>
  <li>Type <code class="w3-codespan">,</code></li>
  <li>Specify the criteria (the cell <code class="w3-codespan">F3</code>, which has the value &quot;1&quot;)</li>
  <li>Hit enter</li>
</ol>
<div class="w3-panel ws-info">
  <p><strong>Note:</strong> You can add more conditions by repeating steps 7-10 before hitting enter.</p>
</div>
...
<p><img src="img_excel_countifs3.png" style="max-width:100%"></p>
<p>The function now counts the number of 1st Generation Water type Pokemon.</p>
<p>The function can be repeated for Water type Pokemon for the following Generations to compare them:</p>
<p><img src="img_excel_countifs4.png" style="max-width:100%"></p>
<div class="w3-panel ws-note">
...
<p>Now, we can see the total number of Water type Pokemon between generations 1-4:</p>
<p><img src="img_excel_countifs5.png" style="max-width:100%"></p>
<br>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_countif.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_if.php">Next &#10095;</a>
