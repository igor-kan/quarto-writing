<!DOCTYPE html>
<html lang="en-US">
<head><title>Excel Conditional Formatting</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_table_style.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_highlight_cell_rules.php">Next &#10095;</a>
</div>
<hr>
<h2>Conditional Formatting</h2>
<p>Conditional formatting is used to change the appearance of cells in a range based on your specified <strong>conditions</strong>.</p>
<p></p>
<p>The conditions are rules based on specified numerical values or matching text.</p>
<div class="w3-panel ws-info">
    <p>Changing the appearance of cells can visually highlight interesting data points for analysis.</p>
</div>
<p>The browser version of Excel provides a number of built-in conditions and appearances:</p>
<p><img src="img_excel_cf_menu.png"></p>
<div class="w3-panel ws-note">
    <p><strong>Note:</strong> The web browser version of Excel only offers a selection of built-in conditional formatting options.</p>
    <p>The Excel application has the option of creating fully customized conditional formatting rules.</p>
</div>
<hr>
<h2>Conditional Formatting Example</h2>
<p>Here, the Speed values of each pokemon is formatted with a <strong>Color Scale</strong>:</p>
<p><img src="img_excel_cf_intro.png" style="max-width:100%"></p>
<div class="w3-panel ws-info">
    <p><strong>Note:</strong> Excel has several different color scales to pick from.</p>
</div>
<hr>
...
<div class="w3-example">
    ...
    <img src="img_excel_cf_intro2.png" style="max-width:100%">
    <textarea id="demo_excel_cf_intro" style="display:none">
        Name	Type 1	Speed
        Bulbasaur	Grass	45
        Ivysaur	Grass	60
        Venusaur	Grass	80
    ...
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_cf_intro')" title="Copy values to clipboard">Copy</button>
    </div>
<p>
</p>
</div>
<p>Conditional formatting, step by step:</p>
<ol>
    <li>Select the range of Speed values <code class="w3-codespan">C2:C9</code></li>
</ol>
<p><img src="img_excel_cf_intro3.png" style="max-width:100%"></p>
<ol start="2">
...
<p>Charizard has the highest Speed value (100) and Squirtle has the lowest Speed value (43).</p>
