...
<html lang="en-US">
<head>
<title>Excel MAX Function</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>Excel <span class="color_h1">MAX Function</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_lower.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_median.php">Next &#10095;</a>
</div>
<hr>

<h2>MAX Function</h2>

<p>The <strong>MAX</strong> function is a premade function in Excel, which finds the highest number in a range.</p>
<p>It is typed <code class="w3-codespan">=MAX</code></p>
<div class="ws-note w3-panel">
<p>The function ignores cells with text. It will only work for cells with numbers.</p>
<p><strong>Note:</strong> There is another function called <a href="excel_min.php">MIN</a>, which finds the lowest value in a range, the opposite of <strong>MAX</strong>.</p>
</div>

<p>How to use the <code class="w3-codespan">=MAX</code> function:</p>
<ol>
<li>Select a cell (<code class="w3-codespan">G5</code>)</li>
<li>Type <code class="w3-codespan">=MAX</code></li>
<li>Double click the <strong>MAX</strong> command</li>
<li>Select a range (<code class="w3-codespan">D2:D21</code>)</li>
<li>Hit enter</li>
</ol>

<p>Let's have a look at an example!</p>

<p>Find the Pokemon which has the highest total stats in the range <code class="w3-codespan">D2:D21</code>:</p>
<div class="w3-example">
    <div class="w3-code notranslate" style="position:relative">
    <img src="max1.png" style="max-width:100%">
    <textarea id="demo_excel_max" style="display:none">
    Name	Type 1	Type 2	Total stats		
    Mankey	Fighting		305		
    Poliwrath	Water	Fighting	510		
    Victreebel	Grass	Poison	490		
    Tentacool	Water	Poison	335		
    Magneton	Electric	Steel	465		MAX
    ...
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_max')" title="Copy values to clipboard">Copy</button>
    </div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_max">Try it Yourself &raquo;</a>
</p>
</div>

<p><img src="max2.png" style="max-width:100%"></p>
...
<p><img src="max3.png" style="max-width:100%"></p>
<div class="w3-example">
<div class="w3-code notranslate" style="position:relative">
<img src="max4.png" style="max-width:100%">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_max_finished">Try it Yourself &raquo;</a>
</p>
</div>

<p><strong>That's great!</strong> The function has successfully found the highest value, <code class="w3-codespan">525</code>. Cloyster has the highest Total stats of the Pokemons in the range <code class="w3-codespan">D2:D21</code>.</p>

<p>Let's add text to a cell in the range <code class="w3-codespan">D2:21</code> to see what happens. Type Alakazam to <code class="w3-codespan">D8</code>.</p>

<p><img src="max5.png" style="max-width:100%"></p>

<p><strong>Nice going.</strong> The function ignores the text typed in the range. <code class="w3-codespan">510</code> is returned as the new highest value, since the old one was replaced with text. Poliwrath is now the Pokemon with the highest Total stats in the range <code class="w3-codespan">D2:D21</code>.</p>
