<!DOCTYPE html>
<html lang="en-US">
<head><title>How to Convert Time to Seconds using Excel</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>How to Convert Time to Seconds using Excel</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_xor.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_howto_find_the_difference_between_two_times.php">Next &#10095;</a>
</div>
<hr>

<p class="intro">Learn how to convert time to Seconds using Excel.</p>
<hr>
...
<h2>86400 Explained<h2>
  <p>Excel uses a 24-hour system.</p>
  <p>Each <strong>day</strong> has <strong>24 hours</strong>.</p>
  <p>One <strong>hour</strong> is <strong>60 minutes</strong>.</p>
  <p>One <strong>minute</strong> is <strong>60 seconds</strong>.</p>
  <p><code class="w3-codespan">24</code>(hours) * <code class="w3-codespan">60</code>(minutes) * <code class="w3-codespan">60</code> (seconds) = <code class="w3-codespan">86400</code>
<hr>

<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate">
  <code class="w3-codespan">00:01 * 86400 = 60</code>
  </div>
</div>
<p>The example returns <code class="w3-codespan">60</code> because one minute (<code class="w3-codespan">00:01</code>) is 60 seconds.</p>
<hr>

<h2>Explanation</h2>
<p>Each day has 24 hours.</p>
<p>Each hour can be understood as a percentage of the total hours of the day.</p>
<ul>
  <li>01:00 = 1/24</li>
  <li>02:00 = 2/24</li>
  <li>03:00 = 3/24</li>
...
<p>The percentage can be used to find the seconds.</p>

<div class="w3-example">
  <h3>Example (15:00)</h3>
  <div class="w3-code notranslate">
  <code class="w3-codespan"> 15:00 * 86400 = 54000</code>
  </div>
</div>
<p>Fifteen hours equals <code class="w3-codespan">54000</code> seconds.</p>
<p><code class="w3-codespan">15:00</code> is 15/24 (<code class="w3-codespan">0.625</code>).</p>
<div class="w3-example">
  <div class="w3-code notranslate">
  <code class="w3-codespan"> 0.625 * 86400 = 54000</code>
  </div>
</div>

<div class="w3-example">
<h3>Multiply to get 86400</h3>
  <div class="w3-code notranslate">
  <code class="w3-codespan"> 24 (hours) * 60 (minutes) * 60 (seconds) = 86400</code>
  </div>
</div>
<hr>
