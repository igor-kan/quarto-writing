<!DOCTYPE html>
<html lang="en-US">
<head><title>Excel RAND Function</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_or.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_right.php">Next &#10095;</a>
</div>
<hr>

<h2>RAND Function</h2>

<p>The <strong>RAND</strong> function is used to generate random numbers.</p>
<p>It is typed <code class="w3-codespan">=RAND</code></p>
<div class="w3-panel ws-info">
  <p>Rand can be used to generate any random number.</p>
  <p>You can define limits, create random data sets and much more.</p>
</div>
<p>To use the default <strong>RAND</strong> function, write:</p>
<div class="w3-example">
<div class="w3-code notranslate">
  =RAND()
  </div>
</div>
<p>To use the <strong>RAND</strong> function to receive a random number up to a certain value, write:</p>
<div class="w3-example">
<div class="w3-code notranslate">
  =RAND()*<strong>value</strong>
  </div>
</div>
<p>To use the <strong>RAND</strong> function to receive a whole number, write:</p>
<div class="w3-example">
<div class="w3-code notranslate">
  =<strong>INT</strong>(RAND())
  </div>
</div>
<hr>
<h2>How to Use RAND Function</h2>

<p>To receive a random number, use <strong>RAND</strong>.</p>
<h5><strong>Step 1)</strong> Start the RAND function</h5>
<ol>
  <li>Select a cell <code class="w3-codespan">A1</code></li>
  <li>Type <code class="w3-codespan">=RAND</code></li>
  <li>Double click the <strong>RAND</strong> command</li>
</ol>
<div class="w3-example">
<div class="w3-code notranslate" style="position:relative">
<img src="img_excel_rand1.png" style="max-width:550px; height:auto; width:100%;">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_rand">Try it Yourself &raquo;</a>
</p>
</div>
<h5><strong>Step 2)</strong> Close the function</h5>
<ol>
  <li>Close the function with (<code class="w3-codespan">)</code>)</li>
  <li>Hit enter</li>
</ol>
<p><img src="img_excel_rand2.png" style="max-width:300px; height:auto; width:100%;"></p>
<p>The random number has been generated!</p>
<p><img src="img_excel_rand3.png" style="max-width:300px; height:auto; width:100%;"></p>
<hr>
<h2>How to Use RAND Function With a Defined Limit Value.</h2>
<ol>
  <li>Define the limit (<code class="w3-codespan">*10</code>)</li>
  <li>Hit enter</li>
</ol>
<p><img src="img_excel_rand4.png" style="max-width:300px; height:auto; width:100%;"></p>
<p>A random number between 0 and 10 has been generated!</p>
<p><img src="img_excel_rand5.png" style="max-width:300px; height:auto; width:100%;"></p>
...
<h2>How to Receive a Whole Number Using The RAND Function.</h2>
<ol>
  <li>Add (<code class="w3-codespan">INT</code>) before the <strong>RAND</strong> function</li>
  <li>Hit enter</li>
</ol>
<p><img src="img_excel_rand6.png" style="max-width:300px; height:auto; width:100%;"></p>
<p>A random whole number between 0 and 10 has been generated!</p>
<p><img src="img_excel_rand7.png" style="max-width:300px; height:auto; width:100%;"></p>
<hr>
<h2>How to Generate Multiple Random Numbers.</h2>
<ol>
  <li>Drag the bottom right corner of the cell down to generate more numbers.</li>
</ol>
<p><img src="img_excel_rand8.png" style="max-width:300px; height:auto; width:100%;"></p>
<p>10 random numbers were generated in the <strong>A</strong> column!</p>
<div class="w3-example">
<div class="w3-code notranslate" style="position:relative">
<img src="img_excel_rand9.png" style="max-width:300px; height:auto; width:100%;">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_rand_finished">Try it Yourself &raquo;</a>
</p>
</div>
<hr>
