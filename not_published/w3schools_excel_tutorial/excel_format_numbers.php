...
<html lang="en-US">
<head>
<title>Excel Format Numbers</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>Excel <span class="color_h1">Number Formats</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_format_borders.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_format_grids.php">Next &#10095;</a>
</div>
<hr>

<h2>Number Formats</h2>

<p>The default Number format is <strong>General</strong>.</p> 

<p>Why change number formats?</p>
<ul>
<li>Make data explainable</li>
<li>Prepare data for functions, so that Excel understands what kind of data you are working with.</li>
</ul>

<p>Examples of number formats:</p>
<ul>
<li>General</li>
<li>Number</li>
<li>Currency</li>
...
<p>Number formats can be changed by clicking the Number format dropdown, accessed in the Ribbon, found in the Numbers group.</p>

<p><img src="numbers1.png" style="max-width:100%"></p>

<div class="ws-note w3-panel">
<p><strong>Note:</strong> You can switch the Ribbon view to access more Number format options.</p>
</div>

<p><img src="numbers2.png" style="max-width:100%"></p>

<p><strong>Example</strong></p>
<p>In the example we have cells that represent prices, which can be formatted as Currency.</p>

<p>Let's try to change the format of the prices to the Currency Number format.</p>

<p>Step by step:</p>
<ol>
<li>Mark the range <code class="w3-codespan">B2:C8</code></li>
<li>Click the Number format dropdown menu</li>
<li>Click the <strong>Currency </strong>format</li>
</ol>
<p><img src="numbers3.png" style="max-width:100%"></p>
<p><img src="numbers4.png" style="max-width:100%"></p>
<p><strong>That's it!</strong> The Number format was changed from <strong>General </strong>to <strong>Currency</strong>.</p>

<div class="ws-note w3-panel">
<p><strong>Note: </strong>It will use your local currency by default.</p>
</div>

<p>Now, do the same for <code class="w3-codespan">B10</code>, <code class="w3-codespan">B11</code> and <code class="w3-codespan">B13</code>:</p>
<p><img src="numbers5.png" style="max-width:100%"></p>

<p>Did you make it? </p>

<div class="ws-note w3-panel">
<p><strong>Note: </strong>The currency can be changed. For example instead of using <strong>USD </strong>like in the example you can decide for <strong>$</strong> or <strong>EUR</strong>. It is changed in the dropdrop menu, clicking the <strong>More Number Formats</strong> in the bottom of the menu. Then, clicking on <strong>Currency</strong>. </p>
</div>

<p>Notice that the numbers look like a mess. Let's solve that by decreasing the decimals. This helps to make the presentation more neat.</p>
<hr>
...
<p>The number of decimals can be increased and decreased.</p>

<p>There are two commands:</p>
<ul>
<li>Increase Decimal</li>
<li>Decrease Decimal</li>
</ul>
<p>Clicking them reduces or increases the number of decimals.</p>

<p>The commands can be found next to the Number format dropdown menu.</p>

<div class="w3-row-padding">
<div class="w3-col s6">
<p><img src="decimals1.png" style="max-width:100%"></p>
</div>
<div class="w3-col s6">
<p><img src="decimals2.png" style="max-width:100%"></p>
</div>
</div>

<div class="ws-note w3-panel">
<p><strong>Note:</strong> Decreasing Decimals can make Excel round up or down numbers as more decimals get removed. This may be confusing if you are working on advanced calculations which require accurate numbers.</p>
</div>

<p>Let's clean this up, step by step:</p>
<ol>
<li>Mark the range <code class="w3-codespan">B2:C8</code></li>
<li>Click the <strong>Decrease Decimal </strong>button two times</li>
</ol>

<p><img src="decimals3.png" style="max-width:100%"></p>

<p><strong>Great!</strong></p>

<p>Do the same for <code class="w3-codespan">B10</code>, <code class="w3-codespan">B11</code> and <code class="w3-codespan">B13</code>:</p>

<p><img src="decimals4.png" style="max-width:100%"></p>

<p><strong>That looks a lot better!</strong></p>

<div class="ws-note w3-panel">
<strong>Pro tip:</strong> The arrow in the angle in the top left corner by 
  <strong>row 1</strong> and <strong>column A</strong> can be clicked to mark all cells in the sheet. This can be useful if you want to change the Number format or change Decimals for all cells.
</div>
<p><img src="decimals5.png" style="max-width:100%"></p>
<hr>

<h2>Chapter summary</h2>
<p>Number formats can be changed to make the spreadsheet more understandable or to prepare cells for functions. You can increase and decrease decimals to make the presentation neat.</p> 
<hr>
