...
<h1>Excel Table Design</h1>

<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_tables.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_table_resizing.php">Next &#10095;</a>
</div>
...
<p>Tables can be customized and styled in a few clicks.</p>

<p>Converting a range into a table gives access to a menu called "Table Design".</p>

<p><img src="img_excel_tables_7.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<p>The menu appears when selecting a cell in the table's range.</p>

<p>This menu has options and commands such as:</p>

<ul>
  <li>Resize</li>
  <li>Remove duplicates</li>
  <li>Convert to range</li>
  <li>Style options (Total row, Header row, Banded row etc..)</li>
  <li>Formatting</li>
</ul>
...
<p>Excel gives tables default names such as: Table 1, Table 2, Table 3 and so on.</p>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> Tables cannot be renamed in the Excel online version. </p>
</div>

<p>The name of the table can be found in the Table Design tab</p>

<ol>
  <li>Select the table</li>
  <li>Click the Table design menu</li>
  <li>See the name input field</li>
</ol>

<p><img src="img_excel_tables_8.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<div class="w3-panel ws-info">
  <p><strong>Note:</strong> It is useful to know the table names when you have many tables in a workbook and are referring to them in formulas.</p>
</div>

<p>In the next chapter you will learn about resizing a table.</p>
