...
<html lang="en-US">
<head>
<title>Excel STDEV.S Function</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>Excel <span class="color_h1">STDEV.S Function</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_stdevp.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_sum.php">Next &#10095;</a>
</div>
<hr>

<h2>STDEV.S Function</h2>

<p>The <strong>STDEV.S</strong> function is a premade function in Excel, which calculates the <strong>Standard Deviation (Std)</strong> for a sample.</p>
<p>It is typed <code class="w3-codespan">=STDEV.S</code></p>
<div class="ws-note w3-panel">
<p><strong>Note:</strong> This function ignores cells with text and logic. </p>
<p><strong>Note:</strong> Standard deviation (&#963;) measures how far a 'typical' observation is from the average of the data (&#956;). You can read more about standard deviation in our <a href="https://www.w3schools.com/statistics/statistics_standard_deviation.php">Statistics - Standard Deviation Tutorial</a>.</p>
<p><strong>Tip:</strong> There is another function called <a href="excel_stdevp.php">STDEV.P</a> that can be used if you  have the data for the entire population. 
</p>
</div>

<p>How to use the <code class="w3-codespan">=STDEV.S</code> function:</p>
<ol>
<li>Select a cell (<code class="w3-codespan">H5</code>)</li>
<li>Type <code class="w3-codespan">=STDEV.S</code></li>
<li>Double click the <strong>STDEV.S</strong> command</li>
<li>Select a range (<code class="w3-codespan">E2:E21</code>)</li>
<li>Hit enter</li>
</ol>

<p>Let's have a look at an example!</p>

<p>Find the Standard Deviation for the sample of Pokemon total stats in the range <code class="w3-codespan">E2:E21</code>:</p>
<div class="w3-example">
    <div class="w3-code notranslate" style="position:relative">
    <img src="stddevs.png" style="max-width:100%">
    <textarea id="demo_excel_stdevs" style="display:none">
    #	Name	Type 1	Type 2	Total		
    1	Bulbasaur	Grass	Poison	318		
    2	Ivysaur	Grass	Poison	405		
    3	Venusaur	Grass	Poison	525		
    4	Charmander	Fire		309		STDEV.S
    ...
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_stdevs')" title="Copy values to clipboard">Copy</button>
    </div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_stdevs">Try it Yourself &raquo;</a>
</p>
</div>

<p><img src="stddevs2.png" style="max-width:100%"></p>
...
<p><img src="stddevs3.png" style="max-width:100%"></p>
<div class="w3-example">
<div class="w3-code notranslate" style="position:relative">
<img src="stddevs4.png" style="max-width:100%">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_stdevs_finished">Try it Yourself &raquo;</a>
</p>
</div>

<p><strong>That's the way!</strong> The <strong>STDEV.S</strong> function has successfully returned the <strong>Standard Deviation</strong> <code class="w3-codespan">113,2319</code> for the sample of Pokemons Total stats.</p>
