...
<html lang="en-US">
<head>
<title>Excel Overview - Ribbon and Sheet</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>Excel <span class="color_h1">Overview</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_get_started.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_syntax.php">Next &#10095;</a>
</div>
<hr>

<h2>Overview</h2>
<p>This chapter is about giving you an overview of Excel. Excel's structure is made of two pieces, the <strong>Ribbon </strong>and the <strong>Sheet</strong>. 
</p>
<p>Have a look at the picture below. The <strong>Ribbon</strong> is marked with a red rectangle and the 
<strong>Sheet</strong> is marked with a yellow rectangle:
</p>
<img src="rib_sheet.jpg" style="max-width:100%">

<p>First, let's start with explaining the <strong>Ribbon</strong>.</p>
<hr>

<h2>The Ribbon explained</h2>
<p>The <strong>Ribbon</strong> provides shortcuts to Excel commands. A command is an action that allows you to make something happen. This can for example be to: insert a table, change the font size, or to change the color of a cell.</p> 
<p>The <strong>Ribbon</strong> may look crowded and hard to understand at first. Don't be scared, It will become easier to navigate and use as you learn more. Most of the time we tend to use the same functionalities over again.</p>
<p>The <strong>Ribbon</strong> is made up by the <strong>App launcher</strong>, <strong>Tabs</strong>, <strong>Groups </strong>and <strong>Commands</strong>. In this section we will explain the different parts of the 
<strong>Ribbon</strong>.</p>
<img src="overview_ribbon.jpg" style="max-width:100%;margin-bottom:16px">

<h3>App launcher</h3>
<p>The App launcher icon has nine dots and is called the Office 365 navigation bar. It allows you to access the different parts of the Office 365 suite, such as Word, PowerPoint and Outlook. App launcher can be used to switch seamlessly between the Office 365 applications.</p>

<h3>Tabs</h3>
<p>The tab is a menu with sub divisions sorted into groups. The tabs allow users to quickly navigate between options of menus which display different groups of functionality.</p>

<h3>Groups</h3>
<p>The groups are sets of related commands. The groups are separated by the thin vertical line break.</p>

<h3>Commands</h3>
<p>The commands are the buttons that you use to do actions.</p>

<p>Now, let's have a look at the <strong>Sheet</strong>. Soon you will be able to understand the relationship between the
<strong>Ribbon</strong> and the <strong>Sheet</strong>, and you can make things happen.</p>
<hr>

<h2>The Sheet explained</h2>
<p>The <strong>Sheet</strong> is a set of rows and columns. It forms the same pattern as we have in math exercise books, the rectangle boxes formed by the pattern are called cells.</p>
<p>Values can be typed to cells.</p>
<p>Values can be both numbers and letters:</p>

<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate" style="position:relative">
    <img src="overview_ribbon2.jpg" style="max-width:100%;">
     <textarea id="demo_excel_sheet" style="display:none">
1	Hello World     
</textarea>
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_sheet')" title="Copy values to clipboard">Copy</button>
   </div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_overview">Try it Yourself &raquo;</a>
</p>
</div>
  
<div class="ws-note w3-panel">

<p>Each cell has its unique reference, which is its coordinates, this is where the columns and rows intersect.</p>
</div>

<p>Let's break this up and explain by an example</p>

<p>Have a look at the picture below. Hello world was typed in cell <code class="w3-codespan">C4</code>. The reference can be found by clicking on the relevant cell and seeing the reference in the 
<strong>Name Box</strong> to the left, which tells you that the cell's reference is <code class="w3-codespan">C4</code>.</p>
<img src="cell_address.jpg" style="max-width:100%;">

<p>Another way to find the reference is to first find the column, in this case <code class="w3-codespan">C</code>, then map that towards the row, in this case <code class="w3-codespan">4</code>, which gives us the reference of <code class="w3-codespan">C4</code>.</p>

<div class="ws-note w3-panel">
<p><strong>Note:</strong> The reference of the cell is its coordinates. For example, <code class="w3-codespan">C4</code> has the coordinates of column <code class="w3-codespan">C</code> and row <code class="w3-codespan">4</code>. You find the cell in the intersection of the two. The letter is always the column and the number is always the row.</p>
</div>
<hr>
...
<p>You start with one <strong>Sheet</strong> by default when you create a new workbook. You can have many sheets in a workbook. New sheets can be added and removed. Sheets can be named to making it easier to work with data sets.</p>

<p><strong>Are you up for the challenge?</strong> Let's create two new sheets and give them useful names.</p>

<p>First, click the plus icon, shown in the picture below, create two new sheets:</p>

<img src="add_new.jpg" style="max-width:100%;">
<div class="ws-note w3-panel">
<p><strong>Tip:</strong> You can use the hotkey <strong>Shift + F11</strong> to create new sheets. Try it!</p>
</div>

<p>Second, right click with your mouse on the relevant sheet and click rename:</p>
<img src="rename.jpg" style="max-width:100%;">

<p>Third, enter useful names for the three sheets:</p>
<img src="add_sheet_rename.jpg" style="max-width:100%;">

<p>In this example we used the names <strong>Data Visualization</strong>, <strong>Data Structure</strong> and <strong>Raw Data</strong>. This is a typical structure when you are working with data.</p>
<p><strong>Good job!</strong> You have now created your first workbook with three named sheets!</p>
<hr>

<h2>Chapter Summary</h2>

<p>The workbook has two main components: the <strong>Ribbon</strong> and the 
<strong>Sheet</strong>. 
<p>The <strong>Ribbon </strong>is used to navigate and access commands.</p>
<p>The <strong>Sheet </strong>is made up of columns and rows, which make cells.</p> 
<p>Each cell has its unique reference. You can add new sheets to your workbook and name them.</p>

<p>In the next chapters you will learn more about the sheet, formulas, ranges and functions.</p>
