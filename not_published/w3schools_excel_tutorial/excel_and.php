<!DOCTYPE html>
<html lang="en-US">
<head><title>Excel AND Function</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<div class="w3-clear nextprev">
  ...
  <a class="w3-right w3-btn" href="excel_average.php">Next &#10095;</a>
</div>
<hr>

<h2>AND Function</h2>

<p>The <strong>AND</strong> function is a premade function in Excel, which returns <strong>TRUE</strong> or <strong>FALSE</strong> based on two or more <strong>conditions</strong>.</p>
<p>It is typed <code class="w3-codespan">=AND</code> and takes two or more conditions.</p>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> The AND function is often used together with the <a href="excel_if.php">IF function</a>.</p>
</div>
<div class="w3-example">
  <div class="w3-code notranslate">
    =AND(<strong>[logical1]</strong>, <strong>[logical2]</strong>, ...)
  </div>
</div>
...
<h2>Example AND Function</h2>

<p>Check if the Pokemon type is fire <strong>and</strong> has speed <strong>greater than</strong> 70:</p>
<p>The function returns &quot;TRUE&quot; or &quot;FALSE&quot;.</p>
<div class="w3-example">
    <div class="w3-code notranslate" style="position:relative">
    <img src="img_excel_and.png" style="max-width:100%">
    <textarea id="demo_excel_and" style="display:none">
    Name	Type 1	Speed	Fire Type AND more than 70 Speed
      Bulbasaur	Grass	45	
      Ivysaur	Grass	60	
      Venusaur	Grass	80	
      Charmander	Fire	65	
    ...
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_and')" title="Copy values to clipboard">Copy</button>
    </div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_and">Try it Yourself &raquo;</a>
</p>
</div>
<p>Example <strong>AND</strong> function, step by step:</p>
<ol>
  <li>Select the cell <code class="w3-codespan">D2</code></li>
  <li>Type <code class="w3-codespan">=AND</code></li>
  <li>Double click the <strong>AND</strong> command</li>
</ol>
<p><img src="img_excel_and2.png" style="max-width:100%"></p>
<ol start="4">
  <li>Specify the first condition <code class="w3-codespan">B2="Fire"</code></li>
  <li>Type <code class="w3-codespan">,</code></li>
  <li>Specify the second condition <code class="w3-codespan">C2>70</code></li>
  <li>Hit enter</li>
</ol>
<div class="w3-panel ws-info">
  <p><strong>Note:</strong> You can add more conditions by repeating steps 5-6 before hitting enter.</p>
</div>
<p><img src="img_excel_and3.png" style="max-width:100%"></p>
<p>Since the value in cell <code class="w3-codespan">B2</code> is not &quot;Fire&quot; the first condition is <strong>FALSE</strong>.</p>
<p>Since the value in cell <code class="w3-codespan">C2</code> is less than 70 the second condition is also <strong>FALSE</strong>.</p>
<p><strong>All</strong> conditions need to be <strong>TRUE</strong> for the AND function to return <strong>TRUE</strong>.</p>
<div class="w3-panel ws-note">
...
<p><img src="img_excel_and4.png" style="max-width:100%"></p>
Now, each row has a check for Fire Type <strong>and</strong> Speed greater than 70:
<div class="w3-example">
<div class="w3-code notranslate" style="position:relative">
<img src="img_excel_and5.png" style="max-width:100%">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_and_finished">Try it Yourself &raquo;</a>
</p>
</div>
<p>Only Charmeleon and Charizard both have Fire type and speed greater than 70, so the function returns &quot;TRUE&quot;.</p>
<hr>
...
<h2>Example AND Function (with IF)</h2>

<p>Combining the AND function with an <a href="excel_if.php">IF function</a> lets you check <strong>multiple</strong> conditions for the IF function:</p><div class="w3-panel ws-note">
...
<p>The AND function takes the place of the <code class="w3-codespan">logical_test</code> condition.</p>
<p>Here, the <strong>IF</strong> function returns "Yes" or "No".</p>
<p>Example <strong>AND</strong> function as the condition for <strong>IF</strong> function, step by step:</p>
<ol>
...
<p><img src="img_excel_if_and.png" style="max-width:100%"></p>
<ol start="4">
  <li>Type <code class="w3-codespan">AND</code></li>
  <li>Double click the <strong>AND</strong> command </li>
</ol>
<p><img src="img_excel_if_and2.png" style="max-width:100%"></p>
<ol start="7">
  <li>Specify the first condition <code class="w3-codespan">B2="Fire"</code></li>
  <li>Type <code class="w3-codespan">,</code></li>
  <li>Specify the second condition <code class="w3-codespan">C2>70</code></li>
  <li>Type <code class="w3-codespan">),</code></li>
  <li>Specify the value <code class="w3-codespan">"Yes"</code> for when both conditions are <strong>TRUE</strong></li>
  <li>Type <code class="w3-codespan">,</code></li>
  <li>Specify the value <code class="w3-codespan">"No"</code> for when either, or both, conditions are <strong>FALSE</strong></li>
  <li>Type <code class="w3-codespan">)</code> and hit enter</li>
</ol>
<p><img src="img_excel_if_and3.png" style="max-width:100%"></p>
<p>The function can be repeated with the <a href="excel_filling.php">filling function</a> for each row to perform the same check for each Pokemon:</p>
<p><img src="img_excel_if_and4.png" style="max-width:100%"></p>
<p>Now each row has a check for both being Fire type and Speed greater than 70:</p>
<div class="w3-example">
<div class="w3-code notranslate" style="position:relative">
<img src="img_excel_if_and5.png" style="max-width:100%">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_and_if_finished">Try it Yourself &raquo;</a>
</p>
</div>
<p>Only Charmeleon and Charizard both have Fire type and speed greater than 70, so the function returns &quot;Yes&quot;.</p>
<hr>
