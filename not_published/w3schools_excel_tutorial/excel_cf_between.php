<!DOCTYPE html>
<html lang="en-US">
<head><title>Excel Highlight Cell Rules - Between</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Excel Highlight Cell Rules - Between</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_cf_less_than.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_cf_equal_to.php">Next &#10095;</a>
</div>
<hr>
<h2>Highlight Cell Rules - Between</h2>
...
<p></p>
<p><strong>Between...</strong> is one of the options for the condition.</p>
<p>Here is the Highlight Cell Rules part of the conditional formatting menu:</p>
<p><img src="img_excel_hcr_menu.png"></p>
<hr>
<h2>Highlight Cell Rule - Between Example</h2>
<p>The &quot;Between...&quot; Highlight Cell Rule will highlight a cell with one of the appearance options based on the cell value being <strong>between</strong> two specified values.</p>
<p>The specified values are typically numbers, but can also be text values.</p>
<p>In this example, the specified values will be &quot;79&quot; and &quot;100&quot;.</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_cf_between">Try it Yourself &raquo;</a>
</p>
...
<p>&quot;Between...&quot; Highlight Cell Rule, step by step:</p>
<ol>
...
<ol start="2">
    ...
    <li>Select <strong>Between...</strong> from the menu</li>
</ol>
<p><img src="img_excel_hcr_bw_menu.png"></p>
<p>This will open a dialog box where you can specify the value and the appearance option.</p>
<ol start="5">
    <li>Enter <code class="w3-codespan">79</code> and <code class="w3-codespan">100</code> into the input fields</li>
    <li>Select the appearance option &quot;Yellow Fill with Dark Yellow Text&quot; from the dropdown menu</li>
</ol>
<p><img src="img_excel_cf_bw2.png" style="max-width:100%"></p>
<p>Now, the cells with values between &quot;79&quot; and &quot;100&quot; will be highlighted in yellow:</p>
<p><img src="img_excel_cf_bw3.png" style="max-width:100%"></p>
<p>Notice that Gyarados' Defense and Special Defense, which are 79 and 100, are highlighted.</p>
<p>The <strong>Between...</strong> condition <strong>includes</strong> the specified values. This is different from the <a href="excel_cf_greater_than.php">Greater Than...</a> and <a href="excel_cf_less_than.php">Less Than...</a> conditions, which do <strong>not</strong> include the specified values.</p>
