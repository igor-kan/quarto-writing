<!DOCTYPE html>
<html lang="en-US">
<head><title>Excel XOR Function</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_vlookup.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_howto_convert_time_to_seconds.php">Next &#10095;</a>
</div>
<hr>

<h2>XOR Function</h2>

<p>The <strong>XOR</strong> function is a premade function in Excel, which returns <strong>TRUE</strong> or <strong>FALSE</strong> based on two or more <strong>conditions</strong>.</p>
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> The XOR function is often used together with the <a href="excel_if.php">IF function</a>.</p>
</div>
<p>It is typed <code class="w3-codespan">=XOR</code>:</p>
<div class="w3-example">
  <div class="w3-code notranslate">
    =XOR(<strong>[logical1]</strong>, <strong>[logical2]</strong>, ...)
  </div>
</div>
<p>The <strong>conditions</strong> are referred to as <code class="w3-codespan">[logical1]</code>, <code class="w3-codespan">[logical2]</code>, and so on.</p>
<p>The conditions can check things like:</p>
<ul>
  <li>If a number is <strong>greater than</strong> another number <code class="w3-codespan">&gt;</code></li>
  <li>If a number is <strong>smaller than</strong> another number <code class="w3-codespan">&lt;</code></li>
  <li>If a number or text is <strong>equal</strong> to something <code class="w3-codespan">=</code></li>
</ul>
<p>For two conditions, you can think of the XOR function as:
&quot;<strong>either</strong> this <strong>or</strong> that, but <strong>not both</strong>&quot;</p>

<div class="w3-panel ws-note">
    <p><strong>Note:</strong> The different parts of the function are separated by a symbol, like comma <code class="w3-codespan">,</code> or semicolon <code class="w3-codespan">;</code></p>
    <p>The symbol depends on your <a href="excel_format_settings.php">Language Settings</a>.</p>
</div>

<hr>

<h2>Example XOR Function</h2>

<p>Check if the Pokemon type is either Fire type <strong>OR</strong> has HP <strong>less than</strong> 60, but <strong>not both</strong>:</p>
<p>The function returns &quot;TRUE&quot; or &quot;FALSE&quot;.</p>
<div class="w3-example">
    <div class="w3-code notranslate" style="position:relative">
    <img src="img_excel_xor.png" style="max-width:100%">
    <textarea id="demo_excel_xor" style="display:none">
    Name	Type 1	HP	EITHER Fire Type OR less than 60 HP
    Bulbasaur	Grass	45	
    Ivysaur	Grass	60	
    Venusaur	Grass	80	
    Charmander	Fire	39	
    ...
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_xor')" title="Copy values to clipboard">Copy</button>
    </div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_xor">Try it Yourself &raquo;</a>
</p>
</div>
<p>Example <strong>XOR</strong> function, step by step:</p>
<ol>
  <li>Select the cell <code class="w3-codespan">D2</code></li>
  <li>Type <code class="w3-codespan">=XOR</code></li>
  <li>Double click the <strong>XOR</strong> command</li>
</ol>
<p><img src="img_excel_xor2.png" style="max-width:100%"></p>
<ol start="4">
  <li>Specify the first condition <code class="w3-codespan">B2="Fire"</code></li>
  <li>Type <code class="w3-codespan">,</code></li>
  <li>Specify the second condition <code class="w3-codespan">C2<60</code></li>
  <li>Hit enter</li>
</ol>
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> You can add more conditions by repeating steps 5-6 before hitting enter.</p>
  <p>The XOR function returns "TRUE" if an <strong>odd</strong> number (1,3,5,..) of conditions are <strong>TRUE.</strong></p>
</div>
<p><img src="img_excel_xor3.png" style="max-width:100%"></p>
<p>Since the value in cell <code class="w3-codespan">B2</code> is not &quot;Fire&quot; the first condition is <strong>FALSE</strong>.</p>
<p>Since the value in cell <code class="w3-codespan">C2</code> is less than 60 the second condition is 
<strong>TRUE</strong>.</p>
<p>For two conditions, <strong>only one</strong> condition should to be  <strong>TRUE</strong> for the XOR function to return <strong>TRUE</strong>.</p>
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> Text values needs to be in quotes: " "</p>
</div>
<hr>

<p>The function can be repeated with the <a href="excel_filling.php">filling function</a> for each row to perform the same check for each Pokemon:</p>
<p><img src="img_excel_xor4.png" style="max-width:100%"></p>
<p>Now, each row has a check for Fire Type <strong>or</strong> HP less than 60, but <strong>not both</strong>:</p>
<div class="w3-example">
<div class="w3-code notranslate" style="position:relative">
<img src="img_excel_xor5.png" style="max-width:100%">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_xor_finished">Try it Yourself &raquo;</a>
</p>
</div>
<p>For example:</p>
<ul>
    <li>Ivysaur is <strong>not</strong> Fire type, but it also does not have <strong>less</strong> than 60 defense, so the function returns &quot;FALSE&quot;.</li>
    <li>Charmeleon <strong>is</strong> Fire type, and has <strong>less</strong> than 60 defense, so the function returns &quot;FALSE&quot;</li>
    <li>Wartortle is <strong>not</strong> Fire type, but has <strong>less</strong> than 60 defense, so the function returns &quot;TRUE&quot; </li>
</ul>
<hr>
...
<h2>Example XOR Function (with IF)</h2>

<p>Combining the XOR function with an <a href="excel_if.php">IF function</a> lets you check <strong>multiple</strong> conditions for the IF function:</p><div class="w3-panel ws-note">
  <p><strong>Note:</strong> The IF function lets you specify the return values.</p>
</div>
<p>The IF function is typed <code class="w3-codespan">=IF</code> and has 3 parts:</p>
<div class="w3-example">
  <div class="w3-code notranslate">
  =IF(<strong>logical_test</strong>, <strong>[value_if_true]</strong>, <strong>[value_if_false]</strong>)
  </div>
</div>
<p>The XOR function takes the place of the <code class="w3-codespan">logical_test</code> condition.</p>
<p>Here, the <strong>IF</strong> function returns "Yes" or "No".</p>
<p>Example <strong>XOR</strong> function as the condition for <strong>IF</strong> function, step by step:</p>
<ol>
  <li>Select cell <code class="w3-codespan">C2</code></li>
  <li>Type <code class="w3-codespan">=IF</code></li>
  <li>Double click the <strong>IF</strong> command</li>
</ol>
<p><img src="img_excel_if_xor.png" style="max-width:100%"></p>
<ol start="4">
  <li>Type <code class="w3-codespan">XOR</code></li>
  <li>Double click the <strong>XOR</strong> command </li>
</ol>
<p><img src="img_excel_if_xor2.png" style="max-width:100%"></p>
<ol start="7">
  <li>Specify the first condition <code class="w3-codespan">B2="Fire"</code></li>
  <li>Type <code class="w3-codespan">,</code></li>
  <li>Specify the second condition <code class="w3-codespan">C2<60</code></li>
  <li>Type <code class="w3-codespan">),</code></li>
  <li>Specify the value <code class="w3-codespan">"Yes"</code> for when just one condition is <strong>TRUE</strong></li>
  <li>Type <code class="w3-codespan">,</code></li>
  <li>Specify the value <code class="w3-codespan">"No"</code> for when both are <strong>FALSE</strong>, or <strong>TRUE</strong> at the same time</li>
  <li>Type <code class="w3-codespan">)</code> and hit enter</li>
</ol>
<p><img src="img_excel_if_xor3.png" style="max-width:100%"></p>
<p>The function can be repeated with the <a href="excel_filling.php">filling function</a> for each row to perform the same check for each Pokemon:</p>
<p><img src="img_excel_if_xor4.png" style="max-width:100%"></p>
<p>Now, each row has a check for Water Type <strong>or</strong> Defense greater than 60, but <strong>not both</strong>:</p>
<div class="w3-example">
<div class="w3-code notranslate" style="position:relative">
<img src="img_excel_if_xor5.png" style="max-width:100%">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_xor_if_finished">Try it Yourself &raquo;</a>
</p>
</div>
<p>For example:</p>
<ul>
    <li>Ivysaur is <strong>not</strong> Fire type, but it also does not have <strong>less</strong> than 60 defense, so the function returns &quot;No&quot;.</li>
    <li>Charmeleon <strong>is</strong> Fire type, and has <strong>less</strong> than 60 defense, so the function returns &quot;No&quot;</li>
    <li>Wartortle is <strong>not</strong> Fire type, but has <strong>less</strong> than 60 defense, so the function returns &quot;Yes&quot; </li>
</ul>
<br>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_vlookup.php">&#10094; Previous</a>
