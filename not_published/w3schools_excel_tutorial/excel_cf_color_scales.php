<!DOCTYPE html>
<html lang="en-US">
<head><title>Excel Conditional Formatting - Color Scales</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_cf_data_bars.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_cf_icon_sets.php">Next &#10095;</a>
</div>
<hr>

<h2>Color Scales</h2>

<p>Color Scales are premade types of conditional formatting in Excel used to highlight cells in a range to indicate how large the cell values are compared to the other values in the range.</p>
<p>Here is the Color Scales part of the conditional formatting menu:</p>
<p><img src="img_excel_cf_intro4.png"  style="max-width:100%"></p>
<hr>

<h2>Color Scale Formatting Example</h2>

<p>Highlight the Speed values of each Pokemon with <strong>Color Scale</strong> conditional formatting.</p>
<div class="w3-example">
    <h3>Example</h3>
    <div class="w3-code notranslate" style="position:relative">
    <img src="img_excel_cf_cs.png" style="max-width:100%">
    <textarea id="demo_excel_cf_cs" style="display:none">
        Name	Type 1	Speed
        Geodude	Rock	20
        Graveler	Rock	35
        Golem	Rock	45
    ...
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_cf_cs')" title="Copy values to clipboard">Copy</button>
    </div>
</div>
<p>Color Scales, step by step:</p>
<ol>
    <li>Select the range of Speed values <code class="w3-codespan">C2:C8</code></li>
</ol>
<p><img src="img_excel_cf_cs2.png" style="max-width:100%"></p>
<ol start="2">
    <li>Click on the Conditional Formatting icon <img src="img_excel_cf_icon.png" style="max-width:100%"> in the ribbon, from the <strong>Home</strong> menu</li>
    <li>Select <strong>Color Scales</strong> from the drop-down menu</li>
</ol>
<p><img src="img_excel_cf_intro4.png" style="max-width:100%"></p>
<p>There are 12 Color Scale options with different color variations.</p>
<p>The color on the top of the icon <img src="img_excel_cf_cs_icon.png" style="max-width:100%"> will apply to the highest values.</p>
<ol start="4">
    <li>Click on the &quot;Green - Yellow - Red Colour Scale&quot; icon</li>
</ol>
<hr>

<p><img src="img_excel_cf_intro5.png" style="max-width:100%"></p>
<p>Now, the Speed value cells will have a colored background highlighting:</p>
<p><img src="img_excel_cf_cs3.png" style="max-width:100%"></p>
<p>Dark green is used for the highest values, and dark red for the lowest values.</p>
<p>Rapidash has the highest Speed value (105) and Slowpoke has the lowest Speed value (15).</p>
<p>All the cells in the range gradually change color from green, yellow, orange, then red.</p>
<div class="w3-panel ws-note">
    <p><strong>Note:</strong> The color formatting is <strong>relative</strong> to the <strong>smallest</strong> and <strong>largest</strong> cell values in the range.</p>
</div>
<p>Let's see what happens if we add a fictional Pokemon with an even slower Speed value than Slowpoke:</p>
<p><img src="img_excel_cf_cs4.png" style="max-width:100%"></p>
<p>Now, the fictional Slowestpoke has the lowest Speed value of 1, which is highlighted in dark red.</p>
<p>Notice that the color of Slowpoke's Speed value now is highlighted in orange instead of dark red.</p>
<p>Let's see what happens if we add another fictional Pokemon that is faster than any of the other Pokemon:</p>
<p><img src="img_excel_cf_cs5.png" style="max-width:100%"></p>
<p>The fictional Fastestpoke has a higher Speed value (200) than any of the other pokemon and is highlighted in dark green.</p>
<p>Rapidash' Speed value of 105 is no longer the highest value and is highlighted with a lighter green.</p>
<p>Notice that the Speed values of the other Pokemon also change as the highest value in the range is now 200 instead of 105.</p>
<div class="w3-panel ws-note">
