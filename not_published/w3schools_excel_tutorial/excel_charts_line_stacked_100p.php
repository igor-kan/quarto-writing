...
<html lang="en-US">
<head>
<title>Excel 100% Stacked Line Charts</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>Excel 100% Stacked Line Charts</h1>

<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_charts_line_stacked.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_charts_radar.php">Next &#10095;</a>
</div>

<hr>

<h2>100% Stacked Line</h2>

<p>100% Stacked Line charts show the <strong> proportion of contribution to trends</strong> in the data.</p>

<p>This is done by scaling the lines so that the total is 100%.</p>

<p>100% Stacked Line charts are used with data which can be placed in an order, from low to high.</p>

<p>The charts are used when you have <strong>more than one</strong> data column which all add up to the total trend.</p>
...
<p>Let's see how the average stats add up across Pokemon generations</p>
...
<ol start="2"><li>Click on the <strong>Insert</strong> menu, then click on the Line menu (<img src="img_excel_line_menu.png" width="40" height="60" style="border: 1px solid rgb(220, 220, 220)">) and choose <strong>100% Stacked Line</strong> (<img src="img_excel_chart_line_icon_3.png" width="35" height="35" style="border: 1px solid rgb(220, 220, 220)">) from the drop-down menu</li></ol>

<p><img src="img_excel_chart_line_15.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<p>You should get the chart below:</p>

<p><img src="img_excel_chart_line_16.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<p>The chart gives a visual overview for the average Pokemon stats over generations.</p>

<p>The blue line shows how much the average HP contribute to the overall. The orange line shows how much the average Attack contribute to the total and finally, the gray line shows all the sum of all the stats scaled to 100%.</p>

<p>This chart shows that in the second generation, HP contributes more to the overall compared to other generations.</p>
...
<h2>100% Stacked Line with Markers</h2>

<p>100% stacked line with markers highlights data points with markers on a 100% stacked line chart.</p>
...
<ol start="2"><li>Click on the <strong>Insert</strong> menu, then click on the Line menu (<img src="img_excel_line_menu.png" width="40" height="60" style="border: 1px solid rgb(220, 220, 220)">) and choose <strong>100% Stacked Line with Markers</strong> (<img src="img_excel_chart_line_icon_6.png" width="35" height="35" style="border: 1px solid rgb(220, 220, 220)">) from the drop-down menu</li></ol>

<p><img src="img_excel_chart_line_17.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<p>You should get the chart below:</p>

<p><img src="img_excel_chart_line_18.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<p>The chart gives a visual overview for the average Pokemon stats over generations.</p>

<p>The blue line shows how much the average HP contribute to the overall. The line orange line shows how much the average Attack contribute to the total and finally, the gray line shows all the sum of all the stats scaled to 100%.</p>

<p>This chart shows that in the 2nd generation, HP contributes more to the overall compared to other generations.</p>
<hr>
