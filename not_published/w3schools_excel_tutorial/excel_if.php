<!DOCTYPE html>
<html lang="en-US">
<head><title>Excel IF Function</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_countifs.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_ifs.php">Next &#10095;</a>
</div>
<hr>

<h2>IF Function</h2>

<p>The <strong>IF</strong> function is a premade function in Excel, which returns values based on a <strong>true</strong> or <strong>false</strong> <strong>condition</strong>.</p>
<p>It is typed <code class="w3-codespan">=IF</code> and has 3 parts:</p>
...
<p>The <strong>condition</strong> is referred to as <code class="w3-codespan">logical_test</code>, which can check things like:</p>
<ul>
...
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> You can decide both the return values and the condition.</p>
</div>
<div class="w3-panel ws-note">
...
<h2>Example IF function (equal to)</h2>

<p>Check if the Pokemon type is grass:</p>
<p>The condition is if the &quot;Type 1&quot; value for the Pokemon is &quot;Grass&quot;.</p>
<p>The function returns &quot;Yes&quot; or &quot;No&quot;.</p>
<div class="w3-example">
  <div class="w3-code notranslate" style="position:relative">
  <img src="img_excel_if_grass.png" style="max-width:100%">
  <textarea id="demo_excel_if" style="display:none">
  ...
  <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_if')" title="Copy values to clipboard">Copy</button>
  </div>
<p><a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_if">Try it Yourself &raquo;</a></p>
</div>
<hr>

<p>Example <strong>IF</strong> function, step by step:</p>
<ol>
...
<p><img src="img_excel_if_grass2.png" style="max-width:100%"></p>
<ol start="4">
  <li>Specify the condition <code class="w3-codespan">B2="Grass"</code></li>
  <li>Type <code class="w3-codespan">,</code></li>
  <li>Specify the value <code class="w3-codespan">"Yes"</code> for when the condition is <strong>TRUE</strong></li>
  <li>Type <code class="w3-codespan">,</code></li>
  <li>Specify the value <code class="w3-codespan">"No"</code> for when the condition is <strong>FALSE</strong></li>
  <li>Hit enter</li>
</ol>
<p><img src="img_excel_if_grass3.png" style="max-width:100%"></p>
<p>Since the value in cell <code class="w3-codespan">B2</code> is &quot;Grass&quot;, the condition is <strong>true</strong> and the function will return &quot;Yes&quot;.</p>
<div class="w3-panel ws-note">
...
<p><img src="img_excel_if_grass4.png" style="max-width:100%"></p>
<p>Now, each row has a check for Grass Type:</p>
<div class="w3-example">
<div class="w3-code notranslate" style="position:relative">
<img src="img_excel_if_grass5.png" style="max-width:100%">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_if_grass_finished">Try it Yourself &raquo;</a>
</p>
</div>
<hr>
...
<h2>Example IF Function (greater than)</h2>

<p>Check if the Pokemon's total stats is <strong>greater than</strong> 500:</p>
<p>The function returns &quot;Yes&quot; or &quot;No&quot;.</p>
<div class="w3-example">
  <div class="w3-code notranslate" style="position:relative">
  <img src="img_excel_if_greater_than.png" style="max-width:100%">
  <textarea id="demo_google_sheets_if2" style="display:none">
  Name	Type 1	Total	More than 500 Total Stats
  Bulbasaur	Grass	318	
  Ivysaur	Grass	405	
  Venusaur	Grass	525	
  Charmander	Fire	309	
  ...
  <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_google_sheets_if2')" title="Copy values to clipboard">Copy</button>
  </div>
<p><a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_if">Try it Yourself &raquo;</a></p>
</div>
<p>Example <strong>IF</strong> function, step by step:</p>
...
<p><img src="img_excel_if_greater_than2.png" style="max-width:100%"></p>
<ol start="4">
  <li>Specify the condition <code class="w3-codespan">C2&gt;500</code></li>
  <li>Type <code class="w3-codespan">,</code></li>
  <li>Specify the value <code class="w3-codespan">"Yes"</code> for when the condition is <strong>TRUE</strong></li>
  <li>Type <code class="w3-codespan">,</code></li>
  <li>Specify the value <code class="w3-codespan">"No"</code> for when the condition is <strong>FALSE</strong></li>
...
<p><img src="img_excel_if_greater_than3.png" style="max-width:100%"></p>
<p>Since the value in cell <code class="w3-codespan">C2</code> is 318, the condition is <strong>false</strong> and the function will return &quot;No&quot;.</p>
<p>The function can be repeated with the <a href="excel_filling.php">filling function</a> for each row to perform the same check for each Pokemon:</p>
<p><img src="img_excel_if_greater_than4.png" style="max-width:100%"></p>
<p>Now, each row has a check for having more than 500 total stats:</p>
<div class="w3-example">
<div class="w3-code notranslate" style="position:relative">
<img src="img_excel_if_greater_than5.png" style="max-width:100%">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_if_greater_finished">Try it Yourself &raquo;</a>
</p>
</div>
<br>
<div class="w3-clear nextprev">
