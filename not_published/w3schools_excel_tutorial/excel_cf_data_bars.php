<!DOCTYPE html>
<html lang="en-US">
<head><title>Excel Conditional Formatting - Data Bars</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_cf_above_below_average.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_cf_color_scales.php">Next &#10095;</a>
</div>
<hr>
<h2>Data Bars</h2>
<p>Data Bars are premade types of conditional formatting in Excel used to add colored bars to cells in a range to indicate how large the cell values are compared to the other values.</p>
<p>Here is the Data Bars part of the conditional formatting menu:</p>
<p><img src="img_excel_db_menu.png"  style="max-width:100%"></p>
<hr>
<h2>Data Bars Example</h2>
<div class="w3-example">
    <h3>Example</h3>
    <div class="w3-code notranslate" style="position:relative">
    <img src="img_excel_cf_db.png" style="max-width:100%">
    <textarea id="demo_excel_db" style="display:none">
        Name	Type 1	Speed
        Onix	Rock	70
        Drowzee	Psychic	42
        Hypno	Psychic	67
        ...
        Electrode	Electric	140
        Exeggcute	Grass	40
        Exeggutor	Grass	55
    </textarea>
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_db')" title="Copy values to clipboard">Copy</button>
    </div>
</div>
...
<div class="w3-panel ws-note">
    <p><strong>Note:</strong> The size of the data bars depends on the <strong>smallest</strong> and <strong>largest</strong> cell value in the range.</p>
</div>
<hr>

<p>Let's apply the <strong>Data Bars</strong> conditional formatting to the Speed values.</p>
<p>&quot;Data Bars&quot;, step by step:</p>
<ol>
    <li>Select the range <code class="w3-codespan">C2:C10</code> for Speed values</li>
</ol>
<p><img src="img_excel_cf_db2.png" style="max-width:100%"></p>
<ol start="2">
    ...
    <li>Select <strong>Data Bars</strong> from the drop-down menu</li>
    <li>Select the &quot;Green Data Bars&quot; color option from the <strong>Gradient Fill</strong> menu</li>
</ol>
<p><img src="img_excel_db_menu2.png"  style="max-width:100%"></p>
<div class="w3-panel ws-note">
    <p><strong>Note:</strong> Both <strong>Gradient Fill</strong> and <strong>Solid Fill</strong> work the same way. The only difference between those, and the color options are aesthetic.</p>
</div>
<p>Now, all of the Speed value cells have a green bar showing how big the value is compared to the other values in the range:</p>
<p><img src="img_excel_cf_db3.png" style="max-width:100%"></p>
<p>Electrode has the highest value, 140, so the bar fills the entire cell.</p>
<p>The other bars are scaled relative to the highest value and 0 by default.</p>
<p>Exeggcute has the lowest value, 40, so this is the shortest bar. Though, it is larger than 0, so there is still a small bar.</p>
<p>Let's see what happens if we add a fictional Pokemon with a 0 Speed value:</p>
<p><img src="img_excel_cf_db4.png" style="max-width:100%"></p>
<p>The fictional Neutrinode has a Speed value of 0, so this becomes an invisible &quot;minimum&quot; bar.</p>
<p>Let's see what happens if we add another fictional Pokemon with a negative Speed value:</p>
<p><img src="img_excel_cf_db5.png" style="max-width:100%"></p>
<p>Now, the fictional Positrode has the lowest Speed value, -140, so this becomes an invisible &quot;minimum&quot; bar.</p>
<p><strong>Notice that all the other bars have now been scaled relative to the new minimum (-140).</strong></p>
<p>Neutrinode's Speed value of 0 is now in the middle between -140 and 140, so the cell has a bar filling half the cell.</p>
<p>Electrode still has the highest Speed value, 140, so this bar still fills the entire cell.</p>
<div class="w3-panel ws-note">
