...
<h1>Excel <span class="color_h1">Format Painter</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_formatting.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_format_colors.php">Next &#10095;</a>
</div>
<hr>

<h2>Format Painter</h2>

<p>The format painter is a command which lets you copy formatting from one cell to another. </p>

<p>It is a great tool, which saves you lots of time!</p>

<p>The Format painter can be used to copy to single cells or ranges. </p>

<p>Format Painter is used by clicking on its button in the Ribbon, found in the Clipboard group.</p>

<p><img src="format_painter1.png" style="max-width:100%"></p>
...
<ol>
<li>Select the cell that you want to copy</li>
<li>Click the Format Painter button</li>
<li>Select a cell or range</li>
</ol>

<p>Let's try some examples and copy formats with Colors and font Characteristics, such as bold, italic and underline:</p>

<p><img src="format_painter2.png" style="max-width:100%"></p>

<p>Copy the red color from <code class="w3-codespan">A1</code> to <code class="w3-codespan">B1</code>.</p>

<p>Step by step:</p>
<ol>
<li>Select <code class="w3-codespan">A1</code></li>
<li>Click the <strong>Format Painter</strong> button</li>
<li>Select <code class="w3-codespan">B1</code></li>
</ol>
<p><img src="format_painter3.png" style="max-width:100%"></p>
<p><img src="format_painter4.png" style="max-width:100%"></p>
<p><img src="format_painter5.png" style="max-width:100%"></p>

<p>Notice the dotted border around <code class="w3-codespan">A1</code>. This indicates that the format is copied and ready for pasting. Let's paste it to <code class="w3-codespan">B1</code>!</p>
<p><img src="format_painter6.png" style="max-width:100%"></p>

<p><strong>Great job!</strong></p>
<hr>

<h2>Copy and Paste Color to Multiple Cells</h2>
<p>Copy <code class="w3-codespan">B2</code> to <code class="w3-codespan">C2</code>. That is right, let's try to paste to a range of two cells!</p>
<ol>
<li>Select <code class="w3-codespan">A2</code></li>
<li>Click the <strong>Format Painter</strong> button</li>
<li>Select <code class="w3-codespan">B2</code> and hold an drag to <code class="w3-codespan">C2</code></li>
</ol>

<p><img src="format_painter7.png" style="max-width:100%"></p>
<p><img src="format_painter8.png" style="max-width:100%"></p>
<p><img src="format_painter9.png" style="max-width:100%"></p>
<p><img src="format_painter10.png" style="max-width:100%"></p>

<p><strong>That's the way!</strong> The format painter can be used for single cells and on ranges.</p>
<hr>
...
<h2>Copy Font Characteristics</h2>
<p>Last example. Copy the Font Characteristics from <code class="w3-codespan">A4:A6</code> to <code class="w3-codespan">B4:B6</code>.</p>

<p>Step by step:</p>

<ol>
<li>Mark <code class="w3-codespan">A4:A6</code></li>
<li>Click the <strong>Format Painter </strong>button</li>
<li>Drag and mark <code class="w3-codespan">B4:B6</code></li>
</ol>

<p><img src="format_painter11.png" style="max-width:100%"></p>
<p><img src="format_painter12.png" style="max-width:100%"></p>
<p><img src="format_painter13.png" style="max-width:100%"></p>
<p><img src="format_painter14.png" style="max-width:100%"></p>
