...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_syntax.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_filling.php">Next &#10095;</a>
</div>
<hr>

<h2>Ranges</h2>

<p>Range is an important part of Excel because it allows you to work with selections of cells.</p>
...
<p>Before having a look at the different operations for selection, we will introduce the Name Box. </p>
<hr>

<h2>The Name Box</h2>
<p>The Name Box shows you the reference of which cell or range you have selected. It can also be used to select cells or ranges by typing their values.</p>

<img src="name_box.png" style="max-width:100%">

<p>You will learn more about the Name Box later in this chapter.</p>
<hr>

<h2>Selecting a Cell</h2>

<p>Cells are selected by clicking them with the left mouse button or by navigating to them with the keyboard arrows.</p>

<p>It is easiest to use the mouse to select cells.</p>

<p>To select cell <code class="w3-codespan">A1</code>, click on it:</p>
<img src="select_cell.png" style="max-width:100%">
<hr>

<h2>Selecting Multiple Cells</h2>
<p>More than one cell can be selected by pressing and holding down <strong>CTRL </strong>or <strong>Command </strong>and left clicking the cells. Once finished with selecting, you can let go of <strong>CTRL </strong>or <strong>Command</strong>.</p>

<p>Lets try an example: Select the cells <code class="w3-codespan">A1</code>, <code class="w3-codespan">A7</code>, <code class="w3-codespan">C1</code>, <code class="w3-codespan">C7</code> and <code class="w3-codespan">B4</code>.</p>

<p>Did it look like the picture below?</p>
<img src="select_cells.png" style="max-width:100%">
<hr>

<h2>Selecting a Column</h2>

<p>Columns are selected by left clicking it. This will select all cells in the sheet related to the column.</p>

<p>To select <strong>column A</strong>, click on the letter A in the column bar:</p>
<img src="select_col.png" style="max-width:100%">
<hr>

<h2>Selecting a Row</h2>
<p>Rows are selected by left clicking it. This will select all the cells in the sheet related to that row.</p>

<p>To select <strong>row 1</strong>, click on its number in the row bar:</p>
<img src="select_row.png" style="max-width:100%">
<hr>
...
<h2>Selecting the Entire Sheet</h2>
<p>The entire spreadsheet can be selected by clicking the triangle in the top-left corner of the spreadsheet: <img src="img_excel_ranges_entire_spreadsheet_icon.png"></p>
<p><img src="img_excel_ranges_entire_spreadsheet.png"></p>
<p>Now, the whole spreadsheet is selected:</p>
<p><img src="img_excel_ranges_entire_spreadsheet2.png"></p>
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> You can also select the entire spreadsheet by pressing <code class="w3-codespan">Ctrl+A</code> for Windows, or <code class="w3-codespan">Cmd+A</code> for MacOS.</p>
</div>
<hr>

<h2>Selection of Ranges</h2>

<p>Selection of cell ranges has many use areas and it is one of the most important concepts of Excel. Do not think too much about how it is used with values. You will learn about this in a later chapter. For now let's focus on how to select ranges.</p>
...
<p>The easiest way is drag and mark. Let's keep it simple and start there.</p>

<p>How to drag and mark a range, step-by-step:</p>
<ol>
...
<p>Let's have a look at an example for how to mark the range <code class="w3-codespan">A1:E10</code>.</p>

<div class="ws-note w3-panel">
<p><strong>Note:</strong> You will learn about why the range is called <code class="w3-codespan">A1:E10</code> after this example.
</p>
</div>
<hr>


<p>Select cell <code class="w3-codespan">A1</code>:</p>
<img src="select_cell.png" style="max-width:100%">

<p>Press and hold <code class="w3-codespan">A1</code> with the left mouse button. Move to the mouse pointer to mark the selection range. The grey area helps us to see the covered range.</p>
<p>Let go of the left mouse button when you have marked the range <code class="w3-codespan">A1:E10</code>:</p>
<img src="select_range.png" style="max-width:100%">

<p>You have successfully selected the range <code class="w3-codespan">A1:E10</code>. <strong>Well done!</strong></p>
...
<strong>:</strong> in between.<strong></strong>

<p><strong>Top left corner reference : Right bottom corner reference</strong></p>
<p>The range shown in the picture has the value of <code class="w3-codespan">A1:E10</code>:</p>
<img src="select_range2.png" style="max-width:100%">
<p>The best way for now is to use the drag and mark method as it is easier and more visual.</p>
<p>In the next chapter you will learn about filling and how this applies to the ranges that we have just learned.</p>
<hr>

<div>
<form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_ranges1" method="post" target="_blank">
<h2>Test Yourself With Exercises</h2>
<div class="exercisewindow">
<h2>Excel Exercise:</h2>
<p>Type the cell reference for <strong>Column A, Row 1</strong>:</p>
<div class="exerciseprecontainer">
<pre style="overflow: auto;">
A<input name="ex1" maxlength="1" style="width: 15px;">
</pre>
</div>
<br>
<button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
<p><a target="_blank" href="exercise.php?filename=exercise_ranges1">Start the Exercise</a></p>
</div>
</form>
</div>
<br>
