...
<html lang="en-US">
<head>
<title>Excel Radar Charts</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>Excel Radar Charts</h1>

<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_charts_line_stacked_100p.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_charts_customization.php">Next &#10095;</a>
</div>
...
<p>Radar charts show multivariate data as values relative to a center point.</p>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> Multivariate data has more than one variables. For example, a dataset containing age and height is multivariate because it has two variables.</p>
</div>

<p><img src="img_excel_radar_chart_10.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>


<p>Radar charts can only show data that can be ordered from low to high.</p>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> Data which can be placed in an order, from low to high, like numbers and letter grades from A to F are called ordinal data. You can read more about ordinal data at <a href="https://www.w3schools.com/statistics/statistics_measurement_levels.php">Statistics - Measurement Levels.</a></p>
</div>

<p>Radar charts are suited for showing <strong>similarities</strong> and <strong>outliers</strong> in the data.</p>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> An outlier is a data point that has <strong>unusually</strong> large/small values compared to the rest of the data.</p>
</div>

<p>Excel has three types of radar charts:</p>

<ul>
  <li>Radar (<img src="img_excel_chart_radar_icon_1.png" width="40" height="40" style="border: 1px solid rgb(220, 220, 220)">)</li>
  <li>Radar with markers (<img src="img_excel_chart_radar_icon_2.png" width="40" height="40" style="border: 1px solid rgb(220, 220, 220)">)</li>
  <li>Filled radar (<img src="img_excel_chart_radar_icon_3.png" width="40" height="40" style="border: 1px solid rgb(220, 220, 220)">)</li>
</ul>

<div class="w3-panel ws-info">
  <p><strong>Note:</strong> Radar chart is also known as <strong>web chart</strong>, <strong>spider chart</strong> and <strong>star chart</strong>.</p>
</div>
...
<p>Radar charts show data as as vertices on a polygon.</p>

<p>The relevant distance from the center of the polygon shows the value of the data point.</p>

<h3>Example</h3>

<p>Let's compare the stats for Bulbasaur, Charmander and Squirtle.</p>

<p>Copy the values to follow along:</p>

<div class="w3-example">
  <div class="w3-code notranslate" style="position:relative">
  <img src="img_excel_chart_intro_6.png" style="max-width:100%; border: 1px solid rgb(220, 220, 220); max-width:100%">
  <textarea id="demo_img_excel_chart_intro_6" style="display:none">
    Name	HP	Attack	Defense	Sp. Atk	Sp. Def	Speed
    Bulbasaur	45	49	49	65	65	45
    Charmander	39	52	43	60	50	65
    Squirtle	44	48	65	50	64	43
  </textarea>
  <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_img_excel_chart_intro_6')" title="Copy values to clipboard">Copy</button>
  </div>
</div>

<ol start="1"><li>Select the range <code class="w3-codespan">A1:G4</code></li></ol>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> This menu is accessed by <a href="https://www.w3schools.com/excel/excel_formatting.php">expanding the ribbon</a>.</p>
</div>

<ol start="2"><li>Click on the <strong>Insert</strong> menu, then click on the Other Charts menu (<img src="img_excel_other_menu.png" width="40" height="60" style="border: 1px solid rgb(220, 220, 220)">) and choose <strong>Radar</strong> (<img src="img_excel_chart_radar_icon_1.png" width="40" height="40" style="border: 1px solid rgb(220, 220, 220)">) from the drop-down menu</li></ol>

<p><img src="img_excel_radar_chart_1.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<p>You should get the chart below:</p>

<p><img src="img_excel_radar_chart_2.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<p>The chart gives a visual overview for the Pokemon stats. </p>

<p>Bulbasaur is shown in blue, Charmander in orange and Squirtle in gray.</p>

<p>The chart shows that Charmander has the highest speed and lowest special defense. Squirtle has the highest defense and lowest special attack. The three Pokemon have similar HP and attack stats.</p>

<hr>

<h2>Radar With Markers</h2>

<p>Radar with Markers is similar to radar chart. The only difference is that the data points are highlighted with markers.</p>

<h3>Example</h3>

<p>Let's compare the stats for Bulbasaur evolutions to Ivysaur and Venusaur.</p>

<p>Copy the values to follow along:</p>

<div class="w3-example">
  <div class="w3-code notranslate" style="position:relative">
  <img src="img_excel_radar_chart_3.png" style="max-width:100%; border: 1px solid rgb(220, 220, 220); max-width:100%">
  <textarea id="demo_img_excel_radar_chart_3" style="display:none">
    Name	HP	Attack	Defense	Sp. Atk	Sp. Def	Speed
    Bulbasaur	45	49	49	65	65	45
    Ivysaur	60	62	63	80	80	60
    Venusaur	80	82	83	100	100	80
  </textarea>
  <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_img_excel_radar_chart_3')" title="Copy values to clipboard">Copy</button>
  </div>
</div>
...
<ol start="2"><li>Click on the <strong>Insert</strong> menu, then click on the Other Charts menu (<img src="img_excel_other_menu.png" width="40" height="60" style="border: 1px solid rgb(220, 220, 220)">) and choose <strong>Radar with Markers</strong> (<img src="img_excel_chart_radar_icon_2.png" width="40" height="40" style="border: 1px solid rgb(220, 220, 220)">) from the drop-down menu</li></ol>

<p><img src="img_excel_radar_chart_4.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<p>You should get the chart below:</p>

<p><img src="img_excel_radar_chart_5.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<p>The chart gives a visual overview for the Pokemon stats. </p>

<p>Bulbasaur is shown in blue, Ivysaur in orange and Venusaur in gray.</p>

<p>The chart shows that with each evolution, the stats increase in a similar manner.</p>

<hr>

<h2>Filled Radar</h2>

<p>Filled radar is similar to radar chart. The only difference is that inside the charts are filled with color.</p>
...
<ol start="2"><li>Click on the <strong>Insert</strong> menu, then click on the Other Charts menu (<img src="img_excel_other_menu.png" width="40" height="60" style="border: 1px solid rgb(220, 220, 220)">) and choose <strong>Radar</strong> (<img src="img_excel_chart_radar_icon_3.png" width="40" height="40" style="border: 1px solid rgb(220, 220, 220)">) from the drop-down menu</li></ol>

<p><img src="img_excel_radar_chart_6.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<p>You should get the chart below:</p>

<p><img src="img_excel_radar_chart_7.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<p>The chart gives a visual overview for the Pokemon stats. </p>

<p>Bulbasaur is shown in blue, Charmander in orange and Squirtle in gray.</p>

<p>The chart shows that Charmander has the highest speed.</p>

<p>Note that since the charts are overshadowing each other, the chart cannot give any more information.</p>

<div class="w3-panel ws-warning">
  <p><strong>Caution:</strong> It's better to avoid using filled radar charts with multiple data columns because some data columns can overshadow others.</p>
</div>

<h3>Example (The Extreme Case)</h3>
...
<ol start="2"><li>Click on the <strong>Insert</strong> menu, then click on the Other Charts menu (<img src="img_excel_other_menu.png" width="40" height="60" style="border: 1px solid rgb(220, 220, 220)">) and choose <strong>Radar with Markers</strong> (<img src="img_excel_chart_radar_icon_3.png" width="40" height="40" style="border: 1px solid rgb(220, 220, 220)">) from the drop-down menu</li></ol>

<p><img src="img_excel_radar_chart_8.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<p>You should get the chart below:</p>

<p><img src="img_excel_radar_chart_9.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<p>In this chart, Venusaur, which is shown in gray, overshadows all the other Pokemon.</p>

<p>The only information this chart gives is that Venusaur has larger or equal stat values than both Bulbasaur and Ivysaur.</p>
<hr>
