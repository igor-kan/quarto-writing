...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_cf_manage_rules.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_charts_bar.php">Next &#10095;</a>
</div>
...
<p>Charts are visual representations of data used to make it more understandable.</p>

<p>Commonly used charts are:</p>
...
<p>Different charts are used for different types of data.</p>

<div class="w3-panel ws-info">
  <p><strong>Note:</strong> Charts are also called graphs and visualizations.</p>
</div>

<p><img src="img_excel_chart_intro_1.svg" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<p>The chart above is a column chart representing the number of Pokemons in each generation.</p>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> In some cases the data has to be processed before plotted into a chart.</p>
</div>

<p>Charts can easily be created in a few steps in Excel.</p>

<hr>

<h2>Creating a Chart in Excel</h2>

<p>Creating a chart, step by step:</p>

<ol><li><p>Select the range <code class="w3-codespan">A1:A8</code></p></li></ol>

<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate" style="position:relative">
  <img src="img_excel_chart_intro_2.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%">
  <textarea id="demo_img_excel_chart_intro_2" style="display:none">
    1
    2
    3
    4
  ...
  <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_img_excel_chart_intro_2')" title="Copy values to clipboard">Copy</button>
  </div>
</div>


<ol start = "2"><li><p>Click on the <strong>Insert</strong> menu, then click on the Line menu (<img src="img_excel_line_menu.png" width="30" height="40" style="border: 1px solid rgb(220, 220, 220)">) and choose <strong>Line</strong> (<img src="img_excel_line_icon.png" width="30" height="30" style="border: 1px solid rgb(220, 220, 220)">) from the drop-down menu</p></li></ol>
...
<p><img src="img_excel_chart_intro_3_4.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<p>You should now get this chart:</p>
<p><img src="img_excel_chart_intro_5_5.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>
<p><strong>Excellent!</strong> You have now created your first chart.</p>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> The cells 9 and 10 were not selected in the range, and therefore not included in the graph.</p>
</div>
...
<h2>Creating Another Chart in Excel</h2>

<p>Lets compare the stats for the Pokemons; Charmander, Squirtle and Bulbasaur using a column chart.</p>

<ol><li>Select the range <code class="w3-codespan">A1:G4</code></li></ol>
<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate" style="position:relative">
...
<ol start="2"><li>Click on the <strong>insert</strong> menu, then click on the column menu (<img src="img_excel_column_menu.png" width="30" height="40" style="border: 1px solid rgb(220, 220, 220)">) and choose <strong>Clustered Column</strong> (<img src="img_excel_chart_intro_20.png" width="30" height="30" style="border: 1px solid rgb(220, 220, 220)">) from the drop-down menu</li></ol>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> This menu is accessed by <a href="https://www.w3schools.com/excel/excel_formatting.php">expanding the ribbon</a>.</p>
</div>

<p><img src="img_excel_chart_intro_3_7.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>


<p>You should now get this chart:</p>
<p><img src="img_excel_chart_intro_8_5.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>


<!-- <p>The chart gives a visual overview for the Pokemons stats. For example, Charmander is represented by the orange bar and has the highest stats among the three in speed. Charmander is the fastest. The grey bar represents Squirtle and is the highest in defense, Squirtle has the most defense.</p> -->
<p>The chart gives a visual overview for the Pokemons stats. </p>
<p>Charmander, represented by the orange bars, and has the highest speed. Squirtle, represented by the gray bars, has the highest defense.</p>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> The default chart title is "Chart Title". It can be changed. You will learn about <a href="excel_charts_customization.php">chart customization</a> in a later chapter.</p>
</div>

<!-- <hr>

<h2>Chart Types in Excel</h2>

<p>Excel has the following chart types:</p>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    ...
    <td>Description</td>
    <td>
      <a href="column_charts.php"><img src="baar_1.svg" alt="Column" width="40" height="40" style="border: 1px solid rgb(0, 0, 0)"></a>
      <a href="column_charts.php"><img src="bar_1.svg" alt="Stacked Column" width="40" height="40" style="border: 1px solid rgb(0, 0, 0)"></a>
      <a href="column_charts.php"><img src="bar_3.png" alt="100% Stacked Column" width="40" height="40" style="border: 1px solid rgb(0, 0, 0)"></a>
    </td>
  </tr>
  <tr>
    <td>Line charts</td>
