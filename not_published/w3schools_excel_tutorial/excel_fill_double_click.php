<!DOCTYPE html>
<html lang="en-US">
<head><title>Excel Double Click to Fill</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Excel Double Click to Fill</h1>
<div class="w3-clear nextprev">
    <a class="w3-left w3-btn" href="excel_filling.php">&#10094; Previous</a>
    <a class="w3-right w3-btn" href="excel_move_cells.php">Next &#10095;</a>
</div>
<hr>
<h2>Double Click to Fill</h2>
<p>The <strong>fill function</strong> can be <strong>double clicked</strong> to complete formulas in a range:</p>
<p><img src="img_excel_dc_fill.png" style="max-width:100%"></p>
<div class="w3-panel ws-note">
    <p><strong>Note:</strong> For the double click to work it has to see a recognizable pattern.</p>
    <p>For example: by using headers, or with the formulas in the columns or rows next to the data.</p>
</div>
<h3>Double Click to Fill Example</h3>
<p>Let's use the Double click fill function to calculate the Attack<code class="w3-codespan">B2:B20</code> + Defense <code class="w3-codespan">C2:C20</code> for the Pokemons in the range <code class="w3-codespan">D2:D20</code>.</p>
<ol>
...
<div class="w3-example">
    ...
    <img src="img_excel_dc_fill2.png" style="max-width:100%">
    <textarea id="demo_excel_dc_fill" style="display:none">
        Name	Attack	Defense
        Caterpie	30	35
        Metapod	20	55
        Butterfree	45	50
    ...
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_dc_fill')" title="Copy values to clipboard">Copy</button>
    </div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_dc_fill">Try it Yourself &raquo;</a>
</p>
</div>
...
<ol start="3">
    ...
    <li>Type <code class="w3-codespan">+</code></li>
    <li>Select <code class="w3-codespan">C2</code></li>
</ol>
<p><img src="img_excel_dc_fill3.png" style="max-width:100%"></p>
<ol start="6">
    <li>Hit enter</li>
</ol>
<p><img src="img_excel_dc_fill4.png" style="max-width:100%"></p>
<ol start="7">
    <li>Double click the fill function</li>
</ol>
<p><img src="img_excel_dc_fill5.png" style="max-width:100%"></p>
<p><strong>Way to go!</strong> The function understands the pattern and completes the calculation for <code class="w3-codespan">D2:D20</code>. Note that it stops when there is no more data to calculate, at row <strong>20</strong>. </p>
<hr>
...
<p>Delete values in the range <code class="w3-codespan">D1:D20</code></p>
<p>Enter the formula &quot;=B2+C2&quot; in <code class="w3-codespan">E2</code> </p>
<div class="w3-panel ws-note">
    <p><strong>Note:</strong> There is no header for Columns <strong>D</strong> and <strong>E</strong>. There are blank cells in between.</p>
</div>
<p>Double click the fill function.</p>
<p><img src="img_excel_dc_fill6.png" style="max-width:100%"></p>
<p><strong>Waiting...</strong></p>
<p><img src="img_excel_dc_fill7.png" style="max-width:100%"></p>
<p>The fill function is just loading without filling the rows. It is not understanding the pattern.</p>
<p><strong>Give it more clues.</strong></p>
<p>Add a header to see what happens. Enter &quot;Atk+def&quot; in <code class="w3-codespan">E1</code></p>
<p>Double click the fill function.</p>
<p><img src="img_excel_dc_fill8.png" style="max-width:100%"></p>
<p><strong>Loading... Still nothing...</strong></p>
<p>One more header. Enter &quot;Random&quot; in <code class="w3-codespan">D1</code></p>
<p>Double click the fill function.</p>
<p><strong>Is the gap closed?</strong></p>
<p><img src="img_excel_dc_fill9.png" style="max-width:100%"></p>
<p><strong>There we go!</strong> The function recognised the pattern and filled in the formulas for each row.</p>
<p>Adding headers helped the function to understand the relationship between the data.</p>
