...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_table_resizing.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_convert_table_to_range.php">Next &#10095;</a>
</div>
...
<p>Excel has a command to remove duplicates in tables.</p>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> Duplicates are extra copies of values.</p>
</div>

<p>Removing duplicates are helpful when cleaning a dataset and you do not want to include copies.</p>

<p>The Remove Duplicate function is found in the Ribbon under the Table Design tab.</p>

<p><img src="img_excel_tables_24.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<p>The command allows you to specify the column where you want to find and remove duplicates.</p>

<p>Once applied it will return the number of deleted values and how many unique ones that remains.</p>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> The remove duplicate command will not ask for which duplicates to delete. Make sure that it does not delete useful data.</p>
</div>

<h3>Examples - Remove Duplicates command</h3>

<p>Lets try an example removing the duplicate Pokemon in the range <code class="w3-codespan">A1:E13</code></p>

<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate" style="position:relative">
  <img src="img_excel_tables_25.png" style="max-width:100%;">
  <textarea id="demo_img_excel_tables_25" style="display:none">
  ...
  <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_img_excel_tables_25')" title="Copy values to clipboard">Copy</button>
  </div>
<p>
</p>
</div>
...
<img src="img_excel_tables_26.png" style="max-width:100%;">

<ol start="2"><li>Click the Table Design tab (<img src="img_excel_tables_27.png" style="max-width:100%;border: 1px solid rgb(220, 220, 220)">)</li></ol>
<ol start="3"><li>Click the Remove Duplicates command (<img src="img_excel_tables_28.png" style="max-width:100%;border: 1px solid rgb(220, 220, 220)">)</li></ol>

<ol start="4"><li>Leave all columns checked</li></ol>
<ol start="5"><li>Click OK</li></ol>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> Unchecking a column means that it will not remove duplicates for that column.</p>
</div>

<p><img src="img_excel_tables_29.png" style="max-width:100%;"></p>
<p><img src="img_excel_tables_30.png" style="max-width:100%;"></p>

<p>The command returns the number of found and removed duplicates and how many unique ones that remain.</p>

<ol start="6"><li>Click OK</li></ol>
<p><img src="img_excel_tables_31.png" style="max-width:100%;"></p>

<p>The remove duplicates command has successfully removed the 9 duplicate Pokemon from the range and the table has been resized accordingly. The remaining 3 values are unique.</p>
