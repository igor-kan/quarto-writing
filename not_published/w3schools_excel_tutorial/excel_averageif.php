<!DOCTYPE html>
<html lang="en-US">
<head><title>Excel AVERAGEIF Function</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_average.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_averageifs.php">Next &#10095;</a>
</div>
<hr>

<h2>AVERAGEIF Function</h2>

<p>The <strong>AVERAGEIF</strong> function is a premade function in Excel, which calculates the <a href="https://www.w3schools.com/statistics/statistics_mean.php">average</a> of a range based on a <strong>true</strong> or <strong>false</strong> <strong>condition</strong>.</p>
<p>It is typed <code class="w3-codespan">=AVERAGEIF</code> and has three parts:</p>
<div class="w3-example">
  <div class="w3-code notranslate">
    =AVERAGEIF(<strong>range</strong>, <strong>criteria</strong>, <strong>[average_range]</strong>)
  </div>
</div>
<p>The <strong>condition</strong> is referred to as <code class="w3-codespan">criteria</code>, which can check things like:</p>
<ul>
...
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> The <code class="w3-codespan">[average_range]</code> is optional.</p>
  <p>If not specified, the function calculates the average of the same range as condition.</p>
</div>
<div class="w3-panel ws-note">
...
<h2>Example AVERAGEIF function</h2>

<p>Find the average speed of Grass type Pokemon:</p>
<p>The condition is that the type is &quot;Grass&quot;.</p>
<div class="w3-example">
    <div class="w3-code notranslate" style="position:relative">
    <img src="img_excel_averageif.png" style="max-width:100%">
    <textarea id="demo_excel_averageif" style="display:none">
    Name	Type 1	Speed			
    Bulbasaur	Grass	45		Type	Average Speed
    Ivysaur	Grass	60		Grass	
    Venusaur	Grass	80		Fire	
    Charmander	Fire	65		Water	
    Charmeleon	Fire	80			
    Charizard	Fire	100			
    Squirtle	Water	43			
    Wartortle	Water	58			
    ...
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_averageif')" title="Copy values to clipboard">Copy</button>
    </div>
</div>
<hr>

<p>Example <strong>AVERAGEIF</strong> function, step by step:</p>
<ol>
  <li>Select the cell <code class="w3-codespan">F3</code></li>
  <li>Type <code class="w3-codespan">=AVERAGEIF</code></li>
  <li>Double click the <strong>AVERAGEIF</strong> command</li>
</ol>
<p><img src="img_excel_averageif2.png" style="max-width:100%"></p>
<ol start="4">
  <li>Specify the range for the condition <code class="w3-codespan">B2:B10</code> (the Type 1 values)</li>
  <li>Type <code class="w3-codespan">,</code></li>
  <li>Specify the criteria (the cell <code class="w3-codespan">E3</code>, which has the value "Grass")</li>
  <li>Type <code class="w3-codespan">,</code></li>
  <li>Specify the range for the average <code class="w3-codespan">C2:C10</code> (the Speed values)</li>
  <li>Hit enter</li>
</ol>
<p><img src="img_excel_averageif3.png" style="max-width:100%"></p>
<p>The function now calculates the average speed value of the Grass type Pokemon: Bulbasaur, Ivysaur and Venusaur.</p>
<p>The function can be repeated for Fire and Water type Pokemon to compare them:</p>
<p><img src="img_excel_averageif4.png" style="max-width:100%"></p>
<div class="w3-panel ws-note">
...
<p>Now, we can see the average speed values of each type:</p>
<p><img src="img_excel_averageif5.png" style="max-width:100%"></p>
