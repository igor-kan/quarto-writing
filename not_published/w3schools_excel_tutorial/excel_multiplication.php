...
<html lang="en-US">
<head>
<title>Excel Multiplication Operator</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>Excel <span class="color_h1">Multiplication Operator</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_subtraction.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_division.php">Next &#10095;</a>
</div>
<hr>

<h2>Multiplication Operator</h2>

<p>Multiplication uses the <code class="w3-codespan">*</code> symbol in Excel.</p>

<p>How to multiply cells:</p>
<ol>
...
<p>You can add more cells to formula by typing (*) between the cells.</p>

<p>Let's have a look at some examples. </p>
<hr>

<h2>Multiplying Manual Entries</h2>
...
<li>Type <code class="w3-codespan">2*2</code></li>
<li>Hit enter</li>
</ol>

<p><img src="multi1.png" style="max-width:100%"></p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate" style="position:relative">
<img src="multi2.png" style="max-width:100%">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_multiply_manual">Try it Yourself &raquo;</a>
</p>
</div>
<hr>

<h2>Multiplying Two Cells</h2>
<p>Let's  add some numbers to work with. Type the following values:</p>
<p><img src="multi3.png" style="max-width:100%"></p>
...
<p><img src="multi4.png" style="max-width:100%"></p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate" style="position:relative">
<img src="multi5.png" style="max-width:100%">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_multiply_two">Try it Yourself &raquo;</a>
</p>
</div>
...
<h2>Multiplying Using Absolute Reference</h2>

<p>You can lock a cell and multiply it with other cells.</p>

<p>How to do it, step by step:</p>
<ol>
<li>Select a cell and type (<code class="w3-codespan">=</code>)</li>
<li>Select the cell you want to lock and add two dollar signs (<code class="w3-codespan">$</code>) before the column and row</li>
<li>Type (<code class="w3-codespan">*</code>)</li>
<li>Select another cell</li>
<li>Hit enter</li>
<li>Fill the range</li>
</ol>
<p>Let's have a look at an example where we multiply <code class="w3-codespan">B(5)</code> with the range <code class="w3-codespan">A1:A10</code> using <a href="excel_abs_ref.php">absolute reference</a> and the <a href="excel_filling.php">fill function</a>.</p>

<p>Type the values:</p>
<p><img src="multi6.png" style="max-width:100%"></p>
...
<p><img src="multi7.png" style="max-width:100%"></p>
<p><img src="multi8.png" style="max-width:100%"></p>
<p><img src="multi9.png" style="max-width:100%"></p>
<p><img src="multi10.png" style="max-width:100%"></p>
<p><img src="multi11.png" style="max-width:100%"></p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate" style="position:relative">
<img src="multi12.png" style="max-width:100%">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_multiply_abs">Try it Yourself &raquo;</a>
</p>
</div>

<p><strong>You got it!</strong> You have successfully used <a href="excel_abs_ref.php">absolute reference</a> to multiply <code class="w3-codespan">B1(5)</code> with the range <code class="w3-codespan">A1:A10</code>. </p>
