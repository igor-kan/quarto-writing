<!DOCTYPE html>
<html lang="en-US">
<head><title>Excel SUMIFS Function</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_sumif.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_trim.php">Next &#10095;</a>
</div>
<hr>

<h2>SUMIFS Function</h2>

<p>The <strong>SUMIFS</strong> function is a premade function in Excel, which calculates the sum of a range based on one or more <strong>true</strong> or <strong>false</strong> <strong>condition</strong>.</p>
<p>It is typed <code class="w3-codespan">=SUMIFS</code>:</p>
<div class="w3-example">
  <div class="w3-code notranslate">
  =SUMIFS(<strong>sum_range</strong>, <strong>criteria_range1</strong>, <strong>criteria1</strong>, <strong>[criteria_range2, criteria2] ...</strong>)
  </div>
</div>
<p>The <strong>conditions</strong> are referred to as <code class="w3-codespan">criteria1</code>, <code class="w3-codespan">criteria2</code>, and so on, which can check things like:</p>
<ul>
...
<p>The <code class="w3-codespan">[sum_range]</code> is the range where the function calculates the sum.</p>
...
<h2>Example SUMIFS function</h2>

<p>Find the sum of total stats for Water type 1st Generation Pokemon:</p>
<p>The conditions are that the type is &quot;Water&quot; and Generation is 1.</p>
<p><img src="img_excel_sumifs.png" style="max-width:100%"></p>
<div class="w3-panel ws-note">
    <p><strong>Note:</strong> The full dataset continues after row 14, all the way down to row 759.</p>
</div>
<p>Example <strong>SUMIFS</strong> function, step by step:</p>
<ol>
  <li>Select the cell <code class="w3-codespan">H3</code></li>
  <li>Type <code class="w3-codespan">=SUMIFS</code></li>
  <li>Double click the <strong>SUMIFS</strong> command</li>
</ol>
<hr>

<p><img src="img_excel_sumifs2.png" style="max-width:100%"></p>
<ol start="4">
  <li>Specify the range for the sum <code class="w3-codespan">C2:C759</code> (the Total values)</li>
  <li>Type <code class="w3-codespan">,</code></li>
  <li>Specify the range for the first condition<code class="w3-codespan">B2:B759</code> (the Type 1 values)</li>
  <li>Type <code class="w3-codespan">,</code></li>
  <li>Specify the criteria (the cell <code class="w3-codespan">F3</code>, which has the value "Water")</li>
  <li>Type <code class="w3-codespan">,</code></li>
  <li>Specify the range for the second condition<code class="w3-codespan">D2:D759</code> (the Generation values)</li>
  <li>Type <code class="w3-codespan">,</code></li>
...
<p><img src="img_excel_sumifs3.png" style="max-width:100%"></p>
<p>The function now calculates the sum of total stats for the 1st Generation Water type Pokemon.</p>
<p>The function can be repeated for the following Generations to compare them:</p>
<p><img src="img_excel_sumifs4.png" style="max-width:100%"></p>
<div class="w3-panel ws-note">
...
<p>Now, we can see the sum of total stats of Water type Pokemon between generations:</p>
<p><img src="img_excel_sumifs5.png" style="max-width:100%"></p>
