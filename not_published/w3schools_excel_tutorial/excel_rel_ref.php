...
<html lang="en-US">
<head>
<title>Excel Relative and Absolute References</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>Excel <span class="color_h1">Relative References</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_formulas.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_abs_ref.php">Next &#10095;</a>
</div>
<hr>
...
<p>The dollar sign (<code class="w3-codespan">$</code>) is used to make references absolute.</p>

<p>Example of relative reference: <code class="w3-codespan">A1</code></p>
<p>Example of absolute reference: <code class="w3-codespan">$A$1</code></p>
...
<p>Let's have a look at a relative reference example, helping the Pokemon trainers to count their Pokeballs (<code class="w3-codespan">B2:B7</code>) and Great balls (<code class="w3-codespan">C2:C7</code>).</p>

<div class="w3-example">
    <h3>Example</h3>
    <div class="w3-code notranslate" style="position:relative">
<img src="rel_ref1.png" style="max-width:100%">
    <textarea id="demo_excel_rel_ref" style="display:none">
Trainers	Pokeballs	Great balls
Iva	2	3
Liam	5	5
Pablo	10	2
Jenny	7	1
Iben	6	2
Kasper	3	4    </textarea>
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_rel_ref')" title="Copy values to clipboard">Copy</button>
    </div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_rel_ref">Try it Yourself &raquo;</a>
</p>
</div>



<p>The result is: <code class="w3-codespan">D2(5)</code>:</p>
<img src="rel_ref2.png" style="max-width:100%">

<p>Next, fill the range <code class="w3-codespan">D2:D7</code>:</p>
<img src="rel_ref3.png" style="max-width:100%">
<br><br>
<img src="rel_ref4.png" style="max-width:100%">
<p>The references being relative allows the fill function to continue the formula for rows downwards.</p>

<p>Have a look at the formulas in <code class="w3-codespan">D2:D7</code>. Notice that it calculates the next row as you fill. </p>
<div class="w3-example">
    <div class="w3-code notranslate" style="position:relative">
<img src="rel_ref5.png" style="max-width:100%">
    </div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_rel_ref_filled">Try it Yourself &raquo;</a>
</p>
</div>
<hr>
...
<p>Let's try an example <strong>that will not work</strong>.</p>
<p>Fill <code class="w3-codespan">D2:G2</code>, filling to the <strong>right </strong>instead of downwards. Resulting in strange numbers:</p>
<img src="rel_ref6.png" style="max-width:100%">

<p>Have a look at the formulas.</p>
<img src="rel_ref7.png" style="max-width:100%">
...
<div>
<form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_rel_ref1" method="post" target="_blank">
<h2>Test Yourself With Exercises</h2>
<div class="exercisewindow">
<h2>Excel Exercise:</h2>
<p>Type reference <code class="w3-codespan">B2</code> as <strong>relative</strong>:</p>
...
<p><a target="_blank" href="exercise.php?filename=exercise_rel_ref1">Start the Exercise</a></p>
</div>
</form>
</div>
<hr>
