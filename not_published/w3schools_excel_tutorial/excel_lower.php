<!DOCTYPE html>
<html lang="en-US">
<head><title>Excel LOWER Function</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_left.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_max.php">Next &#10095;</a>
</div>
<hr>

<h2>LOWER Function</h2>

<p>The <strong>LOWER</strong> function is used to lowercase text in a cell.</p>
<p>Changing the letter case of your cell values can be great when there is a lot of case inconsistency 
    among the cell inputs or when preparing your dataset for case-sensitive usage.</p>
<p>It is typed <code class="w3-codespan">=LOWER</code></p>
<p>If you want to use the function on a single cell, write:</p>
<div class="w3-example">
<div class="w3-code notranslate">
  =LOWER(<strong>cell</strong>)
  </div>
</div>
<p>If you want to use the function on a range of cells, write:</p>
<div class="w3-example">
<div class="w3-code notranslate">
  =LOWER(<strong>start cell</strong>:<strong>end cell</strong>)
  </div>
</div>
<div class="w3-panel ws-info">
  <p><strong>A</strong> is uppercase.</p>
  <p><strong>a</strong> is lowercase.</p>
</div>
<hr>

<h2>How to Use LOWER Function</h2>

<p>To lower the text within an Excel cell, use <strong>LOWER</strong>.</p>
<h5><strong>Step 1)</strong> Start the LOWER function</h5>
<ol>
  <li>Select a cell <code class="w3-codespan">E2</code></li>
  <li>Type <code class="w3-codespan">=LOWER</code></li>
  <li>Double click the <strong>LOWER</strong> command</li>
</ol>
<div class="w3-example">
    <div class="w3-code notranslate" style="position:relative">
    <img src="img_excel_lower1.png" style="max-width:550px; height:auto; width:100%;">
    <textarea id="demo_excel_lower" style="display:none">
    ...
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_lower')" title="Copy values to clipboard">Copy</button>
    </div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_lower">Try it Yourself &raquo;</a>
</p>
</div>
<div class="w3-panel ws-info">
...
<h5><strong>Step 2)</strong> Define the cell</h5>
<ol>
  <li>Select a cell (<code class="w3-codespan">A2</code>)</li>
  <li>Hit enter</li>
</ol>
<p><img src="img_excel_lower2.png" style="max-width:550px; height:auto; width:100%;"></p>
<p>The letter case of cell <code class="w3-codespan">A2</code> has been changed!</p>
<p><img src="img_excel_concat3.png" style="max-width:550px; height:auto; width:100%;"></p>
<h5><strong>Step 3)</strong> Define the range to use the <strong>LOWER</strong> function on multiple cells</h5>
<ol>
  <li>Select the starting cell (<code class="w3-codespan">A2</code>)</li>
  <li>Add a colon (<code class="w3-codespan">:</code>)</li>
  <li>Select the ending cell (<code class="w3-codespan">B21</code>)</li>
  <li>Hit enter</li>
</ol>
<p><img src="img_excel_lower4.png" style="max-width:550px; height:auto; width:100%;"></p>
<div class="w3-example">
<div class="w3-code notranslate" style="position:relative">
<img src="img_excel_lower5.png" style="max-width:550px; height:auto; width:100%;">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_lower_finished">Try it Yourself &raquo;</a>
</p>
</div>
