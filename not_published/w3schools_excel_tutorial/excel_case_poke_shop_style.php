...
<html lang="en-US">
<head>
<title>Excel Case: Poke Mart Shop Cart, Styling</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>Excel <span class="color_h1">Case: Poke Mart, Styling</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_case_poke_shop.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_and.php">Next &#10095;</a>
</div>
<hr>

<h2>Case: Poke Mart, Styling</h2>
<p>This case is about helping the Poke Mart merchant to style the shop cart overview. You will practice the skills that you have learned in the chapters about formatting and styling.</p>

<p>Did you solve the first case about the Shop Cart?  We will reuse that data. <a href="excel_case_poke_shop.php">Check it out here</a>.</p>

<p>You do not need the calculations to complete the case. Type the following data:</p>

<div class="w3-example">
    <h3>Example</h3>
    <div class="w3-code notranslate" style="position:relative">
    <img src="case_style1.png" style="max-width:100%">
    <textarea id="demo_excel_poke_shop" style="display:none">
Item	Item price	Price   	Shop cart		
Pokeball	200	0	0		
Great ball	600	0	0		
Ultra ball	1200	0	0		
Potion	300	0	0		
...
Total					    </textarea>
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_poke_shop')" title="Copy values to clipboard">Copy</button>
  </div>
  <p>
  <a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_case_poke_style">Try it Yourself &raquo;</a>
  </p>
</div>


<p>Merchant: Oh boy! I am glad that you are here to help. This colorless Shop Cart has been declining our sales. Let's give it a lift!</p>

<p>To complete this case you need to:</p>
<ul>
<li>Hide grids</li>
<li>Add colors</li>
<li>Change fonts</li>
<li>Format numbers</li>
<li>Finish the last calculation</li>
</ul>
<p><strong>Ready?</strong></p>

<p>Start by removing the grids</p>

<ol>
<li>Click view</li>
<li>Uncheck gridlines</li>
</ol>

<p><img src="grids1.png" style="max-width:100%"></p>

<p>Like this:</p>

<p><img src="case_style2.png" style="max-width:100%"></p>

<p>Make space for the heading by creating a new row <code class="w3-codespan">1</code>.</p>

<ol>
<li>Right click row <code class="w3-codespan">1</code></li>
<li>Insert new row</li>
</ol>

<p><img src="case_style3.png" style="max-width:100%"></p>
<p><img src="case_style4.png" style="max-width:100%"></p>

<p><strong>That's a start!</strong> You have created a new row <code class="w3-codespan">1</code>.</p>

<p>Make space for the header, increase the row height to 40 pixels.

<div class="ws-note w3-panel">
<p><strong>Note:</strong> You will see the border size box which indicates the pixels when you start to drag the border.</p>
</div>

<ol>
<li>Drag <strong>Row 1</strong> border to 40 pixels</li>
</ol>
<p><img src="case_style5.png" style="max-width:100%"></p>


<p>Merge <code class="w3-codespan">A1:D1</code> to create one big cell for the header.</p>

<ol>
<li>Select <code class="w3-codespan">A1:D1</code></li>
<li>Click the <strong>Merge </strong>button in the Ribbon</li>
</ol>
<p><img src="case_style6.png" style="max-width:100%"></p>
<p><img src="case_style7.png" style="max-width:100%"></p>
<p><img src="case_style8.png" style="max-width:100%"></p>

<p><strong>Great job! </strong>Now there is a big merged cell ready for the header.</p>

<p>Type Poke Mart in the merged range <code class="w3-codespan">A1:D1</code></p>

<ol>
<li>Select <code class="w3-codespan">A1:D1</code>(click the merged range)</li>
<li>Type <strong>Poke Mart</strong></li>
<li>Hit enter</li>
</ol>

<p><img src="case_style9.png" style="max-width:100%"></p>

<p>The header font is a bit small, huh?</p> 

<p>Change the header font to <strong>size 20</strong> and make it <strong>Bold</strong></p>

<ol>
<li>Select <code class="w3-codespan">A1:D1</code> (the merged range)</li>
<li>Change to font size <code class="w3-codespan">20</code></li>
<li>Click the <strong>Bold </strong>command or use keyboard shortcut <strong>CTRL + B</strong> or <strong>Command + B</strong></li>
</ol>
...
<p><img src="case_style10.png" style="max-width:100%"></p>
<p><img src="case_style11.png" style="max-width:100%"></p>

<p>That's the way! The header looks better now.</p>
<p>For all cells, change the font to Arial and align text for <code class="w3-codespan">A2:F14</code> to Center.</p>

<ol>
<li>Select all cells by clicking the angle icon in the top left corner of the sheet</li>
<li>Change all fonts to <strong>Arial</strong></li>
<li>Mark <code class="w3-codespan">A2:F14</code></li>
<li>Click the <strong>Align button</strong> in the Ribbon</li>
<li>Click the <strong>Align Center</strong> command</li>
</ol>

<p><img src="case_style12.png" style="max-width:100%"></p>
<p><img src="case_style13.png" style="max-width:100%"></p>
<p><img src="case_style13_5.png" style="max-width:100%"></p>
<p><img src="case_style14.png" style="max-width:100%"></p>

<p><strong>Good job!</strong> You have changed the fonts for all text to <strong>Arial </strong>and aligned <code class="w3-codespan">A2:F14</code> to the <strong>Center</strong>.</p>

<p>It's time to get some colors in there.</p>
<ol>
<li>Select range <code class="w3-codespan">A1:D1</code> (the merged cells)</li>
<li>Apply standard <strong>Red </strong>color</li>
<li>Select <code class="w3-codespan">A2:D2</code></li>
<li>Apply <strong>HEX </strong>code <code class="w3-codespan">2a75bb</code></li>
<li>Select <code class="w3-codespan">D3:D9</code></li>
<li>Apply <strong>RGB </strong>code <code class="w3-codespan">255 203 5</code></li>
<li>Select <strong>F12</strong></li>
<li>Apply <strong>HEX </strong>code <code class="w3-codespan">ffcb05</code></li>
</ol>

<p><img src="case_style15.png" style="max-width:100%"></p>
<p><img src="case_style16.png" style="max-width:100%"></p>
<p><img src="case_style17.png" style="max-width:100%"></p>
<p><img src="case_style18.png" style="max-width:100%"></p>

<div class="ws-note w3-panel">
<p>The two last colors used are the same. Same color, HEX and RGB are different.</p>
<p><strong>Note:</strong> Coloring the input fields can be helpful for those who will use the spreadsheet. In this case we marked the input fields with the yellow color: <code class="w3-codespan">ffcb05</code>.</p>
</div>

<p>Next, change text colors</p>

<ol>
<li>Select <code class="w3-codespan">A1:D4</code></li>
<li>Change text color to <strong>white</strong></li>
<li>Select <code class="w3-codespan">A2:A4</code></li>
<li>Change text color to <strong>white</strong></li>
</ol>
<p><img src="case_style19.png" style="max-width:100%"></p>


<p><strong>That is great!</strong> You got this.</p>

<p>Change the Number formats for the prices to Currency and remove the decimals.</p> 
<ol>
<li>Select <code class="w3-codespan">B3:C14</code></li>
<li>Change Number format to <strong>Currency</strong></li>
<li>Click <strong>decrease decimals</strong> two times (<strong>2</strong>)</li>
</ol>
<p><img src="case_style20.png" style="max-width:100%"></p>
<p><img src="case_style21.png" style="max-width:100%"></p>
<p><img src="case_style22.png" style="max-width:100%"></p>
<p><img src="case_style23.png" style="max-width:100%"></p>

<p><strong>The final touch!</strong></p>

<p>Add borders to make the numbers more readable.</p>

<ol>
<li><code class="w3-codespan">B11</code>: Underline</li>
<li><code class="w3-codespan">B14</code>: Double bottom border</li>
<li><code class="w3-codespan">E12:F12</code>: Thick outside borders</li>
</ol>

<ol>
<li>Select <code class="w3-codespan">B11</code></li>
<li>Add <strong>Underline border</strong></li>
<li>Select <code class="w3-codespan">B14</code></li>
<li>Add <strong>Double bottom border</strong></li>
<li>Select <code class="w3-codespan">E12:F12</code></li>
<li>Add <strong>Thick outside borders</strong></li>
</ol>
<p><img src="case_style24.png" style="max-width:100%"></p>
<p><img src="case_style25.png" style="max-width:100%"></p>
<p><img src="case_style26.png" style="max-width:100%"></p>
<p><img src="case_style27.png" style="max-width:100%"></p>

<p><strong>Almost there!</strong></p>

<p>Do the final calculation for total and add the final Bold fonts.</p>

<ol>
<li>Select <code class="w3-codespan">B14</code></li>
<li>Type <code class="w3-codespan">=</code></li>
<li>Select <code class="w3-codespan">B11</code></li>
<li>Type <code class="w3-codespan">-</code></li>
<li>Select <code class="w3-codespan">B12</code></li>
<li>Hit enter</li>
<li>Select <code class="w3-codespan">A14:B14</code></li>
<li>Make the range <strong>bold</strong></li>
<li>Select <code class="w3-codespan">A2:D2</code></li>
<li>Make the range <strong>bold</strong></li>
</ol>
<p><img src="case_style28.png" style="max-width:100%"></p>
<p><img src="case_style29.png" style="max-width:100%"></p>
<p><img src="case_style30.png" style="max-width:100%"></p>

<p>Add test values:</p>

<ol>
<li>Type <code class="w3-codespan">D3(5)</code></li>
<li>Type <code class="w3-codespan">D4(2)</code></li>
<li>Type <code class="w3-codespan">D6(5)</code></li>
<li>Type <code class="w3-codespan">D9(10)</code></li>
</ol>

<p><img src="case_style31.png" style="max-width:100%"></p>

<p><strong>Congratulations!</strong> You have successfully completed all tasks for the Poke Mart merchant.</p>

<ol>
<li>Hide grids - <strong>Check</strong></li>
<li>Add colors - <strong>Check</strong></li>
<li>Change fonts - <strong>Check</strong></li>
<li>Format numbers - <strong>Check</strong></li>
<li>Finish the last calculation - <strong>Check</strong></li>
</ol>
<hr>
