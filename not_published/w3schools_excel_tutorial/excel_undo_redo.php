...
<html lang="en-US">
<head>
<title>Excel Undo and Redo</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>Excel <span class="color_h1">Undo and Redo</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_delete_cells.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_formulas.php">Next &#10095;</a>
</div>
<hr>

<h2>Undo</h2>

<p>The Undo function lets you reverse an action.</p>

<p>Undo is helpful if you regret an action and want to go back to how it was before.</p>
...
<p>1) Pressing the Undo button in the Ribbon:</p>
<img src="undo.png" style="max-width:100%">


<p>2) Using the keyboard shortcut CTRL + Z / Command + Z</p>

<p>Let's have a look at an example:</p>

<img src="undo2.png" style="max-width:100%">
<br><br>
<img src="undo3.png" style="max-width:100%">

<div class="ws-note w3-panel">
<p>Note: It is recommended to practice using the keyboard shortcut. It saves you time!</p>
</div>
...
<h2>Redo</h2>
<p>The Redo function has the opposite effect as Undo, it reverses the Undo action.</p>

<p>Redo is helpful if you regret using Undo.</p>
...
<p>1) Pressing the Redo button in the Ribbon:</p>
<img src="redo.png" style="max-width:100%">

<p>2) Using the keyboard shortcut CTRL + Y / Command + Y</p>

<p><strong>Tip:</strong> Practice for yourself to get familiar with Undo and Redo.</p>
<hr>

<div>
<form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_undo_redo1" method="post" target="_blank">
<h2>Test Yourself With Exercises</h2>
<div class="exercisewindow">
<h2>Excel Exercise:</h2>
<p>Complete the keyboard shortcut for the Undo command (for Windows and MAC):</p>
<div class="exerciseprecontainer">
<pre style="overflow: auto;">
CTRL + <input name="ex1" maxlength="1" style="width: 15px;">
Command + <input name="ex2" maxlength="1" style="width: 15px;">
</pre>
</div>

<br>
<button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
<p><a target="_blank" href="exercise.php?filename=exercise_undo_redo1">Start the Exercise</a></p>
</div>
</form>
</div>
