...
<html lang="en-US">
<head>
<title>Excel VLOOKUP Function</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>Excel <span class="color_h1">VLOOKUP Function</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_trim.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_xor.php">Next &#10095;</a>
</div>
<hr>

<h2>VLOOKUP Function</h2>

<p>The <strong>VLOOKUP</strong> function is a premade function in Excel, which 
allows searches across columns.</p>
<p>It is typed <code class="w3-codespan">=VLOOKUP</code> and has the following parts:</p>
<div class="w3-example">
  <div class="w3-code notranslate">
    =VLOOKUP(<strong>lookup_value</strong>, <strong>table_array</strong>, 
<strong>col_index_num</strong>, [<strong>range_lookup</strong>])</div>
</div>


<div class="ws-note w3-panel">
<p><strong>Note:</strong> The column which holds the data used to lookup must always be to the left.</p>
</div>
...
<p><strong>Lookup_value:</strong> Select the cell where search values will be entered.</p>
<p><strong>Table_array:</strong> The table range, including all cells in the table.</p>
<p><strong>Col_index_num:</strong> The data which is being looked up. The input 
is the number of the column, counted from the left:</p>
<p><img src="vlookup_col.png" style="max-width:100%"></p>

<p><strong>Range_lookup:</strong> TRUE if numbers (1) or FALSE if text (0). </p>
<div class="ws-note w3-panel">
<p><strong>Note: </strong>Both 1 / 0 and True / False can be used in <strong>Range_lookup</strong>.</p>
</div>
<p>How to use the <strong>VLOOKUP</strong> function.</p>

<ol>
<li>Select a cell (<code class="w3-codespan">H4</code>)</li>
<li>Type <code class="w3-codespan">=VLOOKUP</code></li>
<li>Double click the VLOOKUP command</li>
<li>Select the cell where search value will be entered (<code class="w3-codespan">H3</code>)</li>
<li>Type (<code class="w3-codespan">,</code>)</li>
<li>Mark table range (<code class="w3-codespan">A2:E21</code>)</li>
<li>Type (<code class="w3-codespan">,</code>)</li>
<li>Type the number of the column, counted from the left (<code class="w3-codespan">2</code>)</li>
<li>Type True (1) or False (0) (<code class="w3-codespan">1</code>)</li>
<li>Hit enter</li>
<li>Enter a value in the cell selected for the Lookup_value <code class="w3-codespan">H3(7)</code></li>
</ol>

<p>Let's have a look at an example!</p>

<p>Use the <strong>VLOOKUP </strong>function to find the Pokemon names based on their <strong>ID#</strong>:</p>

<p><img src="vlookup1.png" style="max-width:100%"></p>

<p><code class="w3-codespan">H4</code> is where the search result is displayed. In this case, the Pokemons names based on their ID#.</p>
<p><img src="vlookup2.png" style="max-width:100%"></p>
<p><img src="vlookup3.png" style="max-width:100%"></p>

<p><code class="w3-codespan">H3</code> selected as <strong>lookup_value</strong>. This is the cell where the search query is entered. In this case the Pokemons <strong>ID#</strong>.</p>
<p><img src="vlookup4.png" style="max-width:100%"></p>
<p><img src="vlookup5.png" style="max-width:100%"></p>

<p>The range of the table is marked at <strong>table_array</strong>, in this example <code class="w3-codespan">A2:E21</code>.</p>
<p><img src="vlookup6.png" style="max-width:100%"></p>

<p>The number <code class="w3-codespan">2</code> is entered as <strong>col_index_number</strong>. This is the second column from the left and is the data that is being looked up.</p>
<p><img src="vlookup7.png" style="max-width:100%"></p>
<p>An illustration for selecting <strong>col_index_number</strong> <code class="w3-codespan">2</code>.</p>
<p><img src="vlookup_col2.png" style="max-width:100%"></p>

<p>Ok, so next - <code class="w3-codespan">1</code> <strong>(True) </strong>is entered as <strong>range_lookup</strong>. This is because the most left column has numbers only. If it was text, <code class="w3-codespan">
0</code> <strong>(False)</strong> would have been used.</p>
<p><img src="vlookup8.png" style="max-width:100%"></p>

<p><strong>Good job!</strong> The function returns the <code class="w3-codespan">#N/A</code> value. This is because there have not been entered any value to the Search ID# <code class="w3-codespan">H3</code>.</p>

<p>Let us feed a value to it, type <code class="w3-codespan">H3(7)</code>:</p>
<p><img src="vlookup9.png" style="max-width:100%"></p>

<p><strong>Have a look at that!</strong> The <strong>VLOOKUP</strong> function has successfully found the Pokemon Squirtle which has the ID# <code class="w3-codespan">7</code>.</p>

<p>One more time, type <code class="w3-codespan">(H3)4</code>:</p>
<p><img src="vlookup10.png" style="max-width:100%"></p>

<p><strong>It still works!</strong> The function returned Charmanders name, which has <code class="w3-codespan">4</code> as its ID#. <strong>That's great</strong>.</p>
