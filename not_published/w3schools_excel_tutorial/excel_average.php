...
<html lang="en-US">
<head>
<title>Excel AVERAGE Function</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>Excel <span class="color_h1">AVERAGE Function</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_and.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_averageif.php">Next &#10095;</a>
</div>
<hr>

<h2>AVERAGE Function</h2>

<p>The <strong>AVERAGE</strong> function is a premade function in Excel, which calculates the average (arithmetic mean).</p>
<p>It is typed <code class="w3-codespan">=AVERAGE</code></p>
<p>It adds the range and divides it by the number of observations.</p>

<p><strong>Example:</strong></p>

The average of (2, 3, 4) is 3.<br>
...
<p><strong>Note:</strong> There are multiple types of mean values. The most common type of mean is the arithmetic mean. You can learn more about the arithmetic mean here: <a href="https://www.w3schools.com/statistics/statistics_mean.php">Statistics Mean Tutorial</a>.</p>
<p><strong>Note:</strong> The <strong>AVERAGE </strong>function ignores cells with text. </p>
</div>

<p>Let's have a look at an example where we help the Pokemon trainers to calculate the average of Pokeballs per trainer.</p>
<hr>

<p>How to use the <code class="w3-codespan">=AVERAGE</code> function, step by step:</p>
<ol>
<li>Select a cell (<code class="w3-codespan">F2</code>)</li>
<li>Type <code class="w3-codespan">=AVERAGE</code></li>
<li>Double click the <strong>AVERAGE</strong> command</li>
<li>Select a range (<code class="w3-codespan">B2:E2</code>)</li>
<li>Hit enter</li>
<li>Next, Fill <code class="w3-codespan">F2:F7</code></li>
</ol>
<div class="w3-example">
    <div class="w3-code notranslate" style="position:relative">
    <img src="average1.png" style="max-width:100%">
    <textarea id="demo_excel_average" style="display:none">
    Trainer	Pokeball	Great Ball	Ultraball	Master Ball	Average
    Iva	10	4	1	1	
    Liam	12	3	0	1	
    Jenny	15	1	3	1	
    Iben	4	2	6	0	
    ...
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_average')" title="Copy values to clipboard">Copy</button>
    </div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_average">Try it Yourself &raquo;</a>
</p>
</div>

<p><img src="average3.png" style="max-width:100%"></p>
<p><img src="average4.png" style="max-width:100%"></p>
<p><img src="average5.png" style="max-width:100%"></p>
<div class="w3-example">
<div class="w3-code notranslate" style="position:relative">
<img src="average6.png" style="max-width:100%">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_average_finished">Try it Yourself &raquo;</a>
</p>
</div>

<p><strong>Good job! </strong>You have successfully calculated the average using the <strong>AVERAGE </strong>function.</p>
...
<p>Example using cells with text:</p>
<p><img src="average7.png" style="max-width:100%"></p>
<p>The function ignores cells with text and completes the calculation.</p>
