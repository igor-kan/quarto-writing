...
<html lang="en-US">
<head>
<title>Excel Addition Operator</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>Excel <span class="color_h1">Addition Operator</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_abs_ref.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_subtraction.php">Next &#10095;</a>
</div>
<hr>

<h2>Addition Operator</h2>

<p>Addition uses the <code class="w3-codespan">+</code> symbol in Excel, and is also known as <strong>plus</strong>.</p>

<p>There are two ways to do addition in Excel. Either by using the <code class="w3-codespan">+</code> symbol in a formula or by using the<strong> SUM</strong> function.</p>

<p>How to add cells:</p>
<ol>
<li>Select a cell and type (<code class="w3-codespan">=</code>)</li>
<li>Select a cell</li>
...
<p>You can add more cells to the formula by typing (+) between the cells.</p>

<p>Let's have a look at some examples. </p>
<hr>

<h2>Adding Two Manual Entries</h2>

<ul>
<li>Type <code class="w3-codespan">A1(=)</code></li>
<li>Type <code class="w3-codespan">5+5</code></li>
<li>Hit enter</li>
</ul>

<img src="addition1.png" style="max-width:100%">
<br><br>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate" style="position:relative">
<img src="addition2.png" style="max-width:100%">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_addition_manual">Try it Yourself &raquo;</a>
</p>
</div>

<p><strong>Congratulations!</strong> You have successfully added <code class="w3-codespan">5+5=10</code>.</p>
<hr>

<h2>Adding Two Cells</h2>

<p>First let's add some numbers to work with. Type the following values:</p>

<img src="addition3.png" style="max-width:100%">

<p>How to do it, step by step:</p>
<ol>
<li>Type <code class="w3-codespan">B1(=)</code></li>
<li>Select <code class="w3-codespan">A1</code></li>
<li>Type (<code class="w3-codespan">+</code>)</li>
<li>Select <code class="w3-codespan">A2</code></li>
<li>Hit enter</li>
</ol>
<img src="addition4.png" style="max-width:100%">
<br><br>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate" style="position:relative">
<img src="addition5.png" style="max-width:100%">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_addition_two">Try it Yourself &raquo;</a>
</p>
</div>
<p><strong>Great!</strong> <code class="w3-codespan">30</code> is the result by adding <code class="w3-codespan">A1</code> and <code class="w3-codespan">A2</code>.</p>
<hr>

<h2>Adding Several Cells</h2>
<p>First let's  add some numbers to work with. Type the following values:</p>
<img src="addition6.png" style="max-width:100%">

<p>Step by step to add several cells:</p>
<ol>
<li>Type <code class="w3-codespan">B1(=)</code></li>
<li>Select <code class="w3-codespan">A1</code></li>
<li>Type (<code class="w3-codespan">+</code>)</li>
<li>Select <code class="w3-codespan">A2</code></li>
<li>Type (<code class="w3-codespan">+</code>)</li>
<li>Select <code class="w3-codespan">A3</code></li>
<li>Type (<code class="w3-codespan">+</code>)</li>
<li>Select <code class="w3-codespan">A4</code></li>
<li>Type (<code class="w3-codespan">+</code>)</li>
<li>Select <code class="w3-codespan">A5</code></li>
<li>Hit enter</li>
</ol>
<img src="addition7.png" style="max-width:100%">
<br><br>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate" style="position:relative">
<img src="addition8.png" style="max-width:100%">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_addition_several">Try it Yourself &raquo;</a>
</p>
</div>

<p><strong>Good job!</strong> You have successfully added five cells!</p>
<hr>
...
<h2>Adding with SUM</h2>
<p>Let's keep the numbers from the last exercise. If you did last exercise, remove the value in <code class="w3-codespan">B1</code>. </p>
<img src="addition6.png" style="max-width:100%">

<p>Step by step to add with SUM:</p>
<ol>
<li>Type <code class="w3-codespan">B1(=SUM)</code></li>
<li>Double click the <code class="w3-codespan">SUM</code> command</li>
<li>Mark the range <code class="w3-codespan">A1:A5</code></li>
<li>Hit enter</li>
</ol>
<img src="addition9.png" style="max-width:100%">
<br><br>
<img src="addition10.png" style="max-width:100%">
<br><br>
<img src="addition11.png" style="max-width:100%">
<br><br>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate" style="position:relative">
<img src="addition12.png" style="max-width:100%">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_addition_sum">Try it Yourself &raquo;</a>
</p>
</div>

<div class="ws-note w3-panel">
<p><strong>Note:</strong> <code class="w3-codespan">SUM</code> saves you time! Keep practicing this function.</p>
</div>
<hr>

<h2>Adding Using Absolute Reference</h2>

<p>You can also lock a cell and add it to other cells.</p>

<p>How to do it, step by step:</p>
<ol>
<li>Select a cell and type (<code class="w3-codespan">=</code>)</li>
<li>Select the cell you want to lock, add two dollar signs (<code class="w3-codespan">$</code>) before the column and row</li>
<li>Type (<code class="w3-codespan">+</code>)</li>
<li>Fill a range</li>
</ol>

<p>Let's have a look at an example where we add <code class="w3-codespan">B(5)</code> to the range <code class="w3-codespan">A1:A10</code> using absolute reference and the fill function.</p>

<p>Type the values:</p>
<img src="addition13.png" style="max-width:100%">

<p>Step by step:</p>
<ol>
<li>Type <code class="w3-codespan">C1(=)</code></li>
<li>Select <code class="w3-codespan">B1</code></li>
<li>Type dollar sign before column and row <code class="w3-codespan">$B$1</code></li>
<li>Type (<code class="w3-codespan">+</code>)</li>
<li>Select <code class="w3-codespan">A1</code></li>
<li>Hit enter</li>
<li>Fill the range <code class="w3-codespan">C1:C10</code></li>
</ol>
<img src="addition14.png" style="max-width:100%">
<br><br>
<img src="addition15.png" style="max-width:100%">
<br><br>
<img src="addition16.png" style="max-width:100%">
<br><br>
<img src="addition17.png" style="max-width:100%">
<br><br>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate" style="position:relative">
<img src="addition18.png" style="max-width:100%">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_addition_abs">Try it Yourself &raquo;</a>
</p>
</div>

<p><strong>Great!</strong> You have successfully used absolute reference to add <code class="w3-codespan">B1(5)</code> with the range <code class="w3-codespan">A1:A10</code>.</p>
<hr>

<div>
<form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_addition1" method="post" target="_blank">
<h2>Test Yourself With Exercises</h2>
<div class="exercisewindow">
<h2>Excel Exercise:</h2>
<p>Type the symbol that Excel uses for addition:</p>
<div class="exerciseprecontainer">
<pre style="overflow: auto;">
<input name="ex1" maxlength="1" style="width: 15px;">
</pre>
</div>
<br>
<button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
<p><a target="_blank" href="exercise.php?filename=exercise_addition1">Start the Exercise</a></p>
</div>
</form>
</div>
