<!DOCTYPE html>
<html lang="en-US">
<head><title>Excel Bar Charts</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Excel Bar Charts</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_charts.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_charts_stacked.php">Next &#10095;</a>
</div>
...
<p>Bar charts show the data as horizontal bars.</p>

<p><img src="img_excel_bar_chart_1.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<p>The chart above represents the number of Pokemons in each generation. </p>

<p>Similar to column charts, bar charts are suited for representing values of <strong>qualitative</strong> (<strong>categorical</strong>) data.</p>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> You can read more qualitative (categorical) data at <a href="https://www.w3schools.com/statistics/statistics_data_types.php">Statistics Data Types</a>.</p>
</div>

<p>There are three different type of bar charts:</p>

<ul>
  <li>Clustered bar(<img src="img_excel_chart_bar_icon_1.png" width="30" height="30" style="border: 1px solid rgb(220, 220, 220)">)</li>
  <li>Stacked bar(<img src="img_excel_chart_bar_icon_2.png" width="30" height="30" style="border: 1px solid rgb(220, 220, 220)">)</li>
  <li>100% stacked bar(<img src="img_excel_chart_bar_icon_3.png" width="30" height="30" style="border: 1px solid rgb(220, 220, 220)">)</li>
</ul>
...
<p>Clustered Bar charts are used when the value of data is important but the order is not.</p>

<h3>Example With One Data Column</h3>

<p>We want to find the number of generation 1 Pokemons with types "Grass", "Fire", "Water" and "Bug".</p>
...
<img src="img_excel_chart_intro_24.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%">

<ol start="2"><li>Click on the <strong>insert</strong> menu, then click on the bar menu (<img src="img_excel_bar_menu.png" width="30" height="40" style="border: 1px solid rgb(220, 220, 220)">) and choose <strong>Clustered Bar</strong> (<img src="img_excel_chart_bar_icon_1.png" width="30" height="30" style="border: 1px solid rgb(220, 220, 220)">) from the drop-down menu</li></ol>
...
<p><img src="img_excel_chart_bar_1.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>



<p><strong>Well Done!</strong> Following the steps above will give you the chart below.</p>
<p><img src="img_excel_chart_bar_2.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>


<p>The chart gives a visual overview for the "Grass", "Fire", "Water" and "Bug" type Pokemons in generation 1.</p>

<p>Type "Water" has the most Pokemons in the first generation.</p>

<h3>Example With Two Data Columns</h3>

<p>Now let's do the same for generation 2 Pokemons and compare the results with the last example.</p>
...
<p><img src="img_excel_chart_bar_3.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<p>You should get the chart below:</p>

<p><img src="img_excel_chart_bar_4.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<p>The chart gives a visual overview for the "Grass", "Fire", "Water" and "Bug" type Pokemons in generation 1 and 2.</p>

<p>Generation 1 is shown in blue and generation 2 is shown in orange. </p>

<p>Type "Water" has the most Pokemons in both generations<p>

<p>Also, all the types in generation 2 have less members than generation 1.</p>
<hr>
