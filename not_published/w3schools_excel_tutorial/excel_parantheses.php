...
<h1>Excel <span class="color_h1">Parentheses</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_division.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_functions.php">Next &#10095;</a>
</div>
<hr>

<h2>Parentheses</h2>

<p>Parentheses <code class="w3-codespan">()</code> is used to change the order of an operation.</p>

<p>Using parentheses makes Excel do the calculation for the numbers inside the parentheses first, before calculating the rest of the formula.</p> 

<p>Parentheses are added by typing <code class="w3-codespan">()</code> on both sides of numbers, like <code class="w3-codespan">(1+2)</code>.</p> 

<h3>Examples</h3>

<p><strong>No parentheses</strong></p>
<p><code class="w3-codespan">=10+5*2</code></p>
<p>The result is <code class="w3-codespan">20</code> because it calculates (<code class="w3-codespan">10+10</code>)</p>

<p><strong>With parentheses</strong></p>
<p><code class="w3-codespan">=(10+5)*2</code></p>
<p>The result is <code class="w3-codespan">30</code> because it calculates <code class="w3-codespan">(15)*2</code></p>

<p><strong>Formulas can have groups of parentheses.</strong></p>
<p><code class="w3-codespan">=(10+5)+(2*4)+(4/2)</code></p>

<div class="ws-note w3-panel">
<p><strong>Note:</strong> Cells can be used as values in the formulas inside parentheses, like <code class="w3-codespan">=(A1+A2)*B5</code>. We have used manual entries in our examples to keep things simple.</p>
</div>

<p>Let's have a look at some real examples in Excel.</p>
<hr>

<h2>Without Parentheses</h2>
<p><img src="parantheses1.png" style="max-width:100%"></p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate" style="position:relative">
<img src="parantheses2.png" style="max-width:100%">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_parantheses_no">Try it Yourself &raquo;</a>
</p>
</div>

<p>The result is <code class="w3-codespan">17</code>, the calculation is <code class="w3-codespan">2+15</code>. It uses <code class="w3-codespan">15</code> because <code class="w3-codespan">3*5=15</code>.</p>
<hr>

<h2>With One Parentheses</h2>
<p><img src="parantheses3.png" style="max-width:100%"></p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate" style="position:relative">
<img src="parantheses4.png" style="max-width:100%">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_parantheses_one">Try it Yourself &raquo;</a>
</p>
</div>

<p>The result is <code class="w3-codespan">25</code>, the calculation is <code class="w3-codespan">5*5</code>. It uses <code class="w3-codespan">5</code> because it has calculated numbers inside the parentheses <code class="w3-codespan">(2+3)=5</code> first.</p>
<hr>
...
<h2>With Many Parentheses</h2>
<p><img src="parantheses5.png" style="max-width:100%"></p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate" style="position:relative">
<img src="parantheses6.png" style="max-width:100%">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_parantheses_many">Try it Yourself &raquo;</a>
</p>
</div>
<p>The result is <code class="w3-codespan">17</code>, the calculation is <code class="w3-codespan">5+8+4</code>. The numbers inside the parentheses are calculated first.</p>
<hr>

<h2>Nesting Parentheses</h2>
<p>When using more advanced formulas you may need to nest parentheses. You can look at this like an onion, which has many layers. Excel will calculate the numbers inside the parentheses first, layer by layer, starting with the inner layer.</p>

<p><strong>Example no nesting</strong></p>

<p><code class="w3-codespan">=2*2+3*4+5*5*2</code></p>

<p>It calculates the values flat as you would do with a calculator.</p>

<p><strong>Example nesting</strong></p>
<p><code class="w3-codespan">=((2*2)+(3*4)+(5*5))*2</code></p>

<p>Let's break it down and explain.</p>

<p>Nesting creates layers like an onion. You can have many layers. This example uses two, the inner and outer layers.</p>

<p><img src="parantheses_nesting.jpg" style="max-width:100%"></p>

<p>It starts with calculating the numbers in the inner layer:</p>

<ol>
<li>
<code class="w3-codespan">=((2*2)+(3*4)+(5*5))*2</code> 
</li>
<li>

<code class="w3-codespan">=((4)+(12)+25))*2</code>
	Calculates the inner layer
</li>
<li>

<code class="w3-codespan">=(41)*2</code>
Calculates the outer layer
</li>
<li>

<code class="w3-codespan">82</code>
</li>
</ol>
<hr>

<h2>Chapter Summary</h2>
<p>Parentheses can be used to change the order of an operation. The numbers inside the parentheses gets calculated first. A formula can have sets of parentheses. More advanced formulas can use nesting to create layers of operations, like an onion. It calculates the inner layer first, then the next, and so on.</p> 
<hr>

<div>
<form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_parantheses1" method="post" target="_blank">
<h2>Test Yourself With Exercises</h2>
<div class="exercisewindow">
<h2>Excel Exercise:</h2>
<p>Type the value that the formula returns: <code class="w3-codespan">=10+10*2</code></p>
<div class="exerciseprecontainer">
<pre style="overflow: auto;">
<input name="ex1" maxlength="2" style="width: 25px;">
</pre>
</div>
<br>
<button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
<p><a target="_blank" href="exercise.php?filename=exercise_parantheses1">Start the Exercise</a></p>
</div>
</form>
</div>
