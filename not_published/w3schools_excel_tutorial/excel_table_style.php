...
<h1>Excel Table Style</h1>

<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_convert_table_to_range.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_conditional_formatting.php">Next &#10095;</a>
</div>
...
<p>Excel has many ready to use styles which can be applied for tables.</p>

<p>Table styles is to change the appearance of the table.</p>
...
<p>The table style is <strong>Blue, Table Style Medium 2</strong> by default.</p>

<p>Example: <strong>Blue, Table Style Medium 2</strong>, which is how the default looks like.</p>
<p><img src="img_excel_tables_36.png" style="max-width:100%;"></p>

<p>Excel has three main categories for Table styles:</p>
...
<p>The table style can be applied in a few steps.</p>

<h3>Example - Applying Light Style</h3>

<p>Type or copy the values to follow along:</p>
<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate" style="position:relative">
  <img src="img_excel_tables_33.png" style="max-width:100%;">
  <textarea id="demo_img_excel_tables_33" style="display:none">
  ...
  <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_img_excel_tables_33')" title="Copy values to clipboard">Copy</button>
  </div>
<p>
</p>
</div>
...
<ol start="1"><li>Select a cell in the table range</li></ol>
<p><img src="img_excel_tables_34.png" style="max-width:100%;"></p>
<ol start="2"><li>Click the Design Table tab (<img src="img_excel_tables_27.png" style="max-width:100%;border: 1px solid rgb(220, 220, 220)">)</li></ol>
<ol start="3"><li>Click on the Table Styles option button</ol>
<p><img src="img_excel_tables_37.png" style="max-width:100%;"></p>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> The Table Style that is already applied has a green rectangle around it. In this case Blue, Table Style Medium 2.</p>
</div>

<p>Clicking the Table Style option button opens a menu with different style options.</p>

<p>Here the three categories are presented; Light, Medium and Dark.</p>
...
<ol start="4"><li>Click on the <strong>Light</strong>, <strong>Green</strong>, <strong>Table Style Light 21</strong>. Found in the Light category.</li></ol>
<p><img src="img_excel_tables_38.png" style="max-width:100%;"></p>

<p><img src="img_excel_tables_39.png" style="max-width:100%;"></p>
<p><strong>Well done!</strong> The formatting of the table has changed to the light green style.</p>

<p>Apply <strong>Gray, Table Style Dark 4</strong>. Found in the Dark category.</p>

<p><img src="img_excel_tables_40.png" style="max-width:100%;"></p>

<p><strong>Did you make it?</strong></p>

<p><img src="img_excel_tables_41.png" style="max-width:100%;"></p>

<div class="w3-panel ws-info">
  <p><strong>Note:</strong> Get familiar with the Table Styles. Try different options to see how they look.</p>
</div>
