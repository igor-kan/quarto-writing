...
<html lang="en-US">
<head>
<title>Excel STDEV.P Function</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>Excel <span class="color_h1">STDEV.P Function</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_right.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_stdevs.php">Next &#10095;</a>
</div>
<hr>

<h2>STDEV.P Function</h2>

<p>The <strong>STDEV.P</strong> function is a premade function in Excel, which calculates the <strong>Standard Deviation (Std)</strong> for the entire population.</p>
<p>It is typed <code class="w3-codespan">=STDEV.P</code></p>
...
<p><strong>Tip:</strong> There is another function called <a href="excel_stdevs.php">STDEV.S</a> that can be used if you have the data for a sample. </p>
</div>

<p>How to use the <code class="w3-codespan">=STDEV.P</code> function:</p>
<ol>
<li>Select a cell (<code class="w3-codespan">H5</code>)</li>
<li>Type <code class="w3-codespan">=STDEV.P</code></li>
<li>Double click the <strong>STDEV.P</strong> command</li>
<li>Select a range (<code class="w3-codespan">E2:E755</code>), including all Pokemons</li>
<li>Hit enter</li>
</ol>

<p>Let's have a look at an example!</p>

<p>Find the Standard Deviation of Pokemon total stats in the range <code class="w3-codespan">E2:E755</code>:</p>

<div class="w3-example">
<div class="w3-code notranslate" style="position:relative">
<img src="stdevp.png" style="max-width:100%">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_stdevp">Try it Yourself &raquo;</a>
</p>
</div>
<div class="ws-note w3-panel">
<p>The picture is not showing all rows. The range is <code class="w3-codespan">E2:E755</code> (753 rows).</p>
</div>

<p><img src="stdevp2.png" style="max-width:100%"></p>
<p><img src="stdevp3.png" style="max-width:100%"></p>
<div class="w3-example">
<div class="w3-code notranslate" style="position:relative">
<img src="stdevp4.png" style="max-width:100%">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_stdevp_finished">Try it Yourself &raquo;</a>
</p>
</div>

<p>The <strong>STDEV.P</strong> function has successfully returned the <strong>Standard Deviation</strong> for the whole population as <code class="w3-codespan">113,4497844</code>.</p>
<hr>
