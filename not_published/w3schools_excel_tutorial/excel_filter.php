...
<html lang="en-US">
<head>
<title>Excel Data Analysis - Filter</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>Excel <span class="color_h1">Filter</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_sort.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_tables.php">Next &#10095;</a>
</div>
<hr>

<h2>Excel Filter</h2>

<p>Filters can be applied to sort and hide data. It makes data analysis easier.</p>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> Filter is similar to formatting a table, but it can be applied and deactivated.</p>
</div>

<p>The menu is accessed in the default Ribbon view or in the <strong>Data</strong> section in the navigation bar.</p>

<p><img src="filter_1.png" style="max-width:100%;"></p>

<hr>

<h2>Applying Filter</h2>

<p>Filters are applied by selecting a range and clicking the <strong>Filter</strong> command.</p>

<p>It is important to have a row of headers when applying filters. Having headers is useful to make the data understandable.</p>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> Filters are applied to the top row in a range.</p>
</div>

<p>Like in the example below, the dedicated row is row <strong>1</strong>.</p>
<div class="w3-example">
    <div class="w3-code notranslate" style="position:relative">
<p><img src="filter_2.png" style="max-width:100%;"></p>
    <textarea id="demo_excel_filter" style="display:none">
...
20	Raticate	Normal		413</textarea>
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_filter')" title="Copy values to clipboard">Copy</button>
    </div>
<p>
</p>
</div>
...
<p>Let's apply filters to the data set, step by step.</p>

<ol><li><p>Select range <strong>A1:E1</strong></p></li></ol>
<p><img src="filter_2.png" style="max-width:100%;"></p>
<ol start="2"><li><p>Click the <strong>Sort & Filter</strong> menu</p></li></ol>
<ol start="3"><li><p>Click the <strong>Filter</strong> command</p></li></ol>
<p><img src="filter_3.png" style="max-width:100%;"></p>

<img src="filter_3.png" style="max-width:100%;">

<p>New buttons have been added to the cells in the top row. This indicates that the <strong>Filter</strong> was successfully applied. The buttons can be clicked to access the different <strong>Sort & Filter</strong> options. </p>
...
<h2>A Non-Working Example</h2>

<p>Lets delete row <strong>1</strong> (the header row) and apply filters to the new row <strong>1</strong>, to see what happens.</p>

<p><img src="filter_4.png" style="max-width:100%;"></p>

<p>The filter is applied and has replaced the header row. It is important to dedicate a header row for the filter.</p>

<hr>

<h2>Filter options</h2>

<p>The filter options allow for sorting and filtering.</p>

<p>Applying filter keeps the relationship between the columns while sorting and filtering.</p>

<p><img src="filter_5.png" style="max-width:100%;"></p>

<p>Clicking the options button opens the menu.</p>

<p><img src="filter_6.png" style="max-width:100%;"></p>

<hr>

<h2>Sorting</h2>

<p>Ranges can be sorted and the relationship between the columns is kept.</p>

<p><strong>Sort Ascending (A-Z)</strong> sorted from smallest to largest.</p>

<p><strong>Sort Descending (Z-A)</strong> sorts from largest to smallest.</p>

<p>You can read more about Sorting in a previous <a href="excel_sort.php">chapter</a>.</p>

<hr>

<h2>Filtering</h2>

<p>Filters can be applied to hide and sort data.</p>

<p>This is helpful for analysis, to select the data that you want to see or not.</p>

<br>

<h3>Example Filter</h3>

<p>Use the filter option to filter on Pokemon that is <strong>Type 1, Bug</strong>.</p>

<p><img src="filter_7.png" style="max-width:100%;"></p>

<p>Step by step</p>

<ol><li><p>Click the drop down menu on <strong>C1</strong> (<img src="dropdown_filter.png" width="20" height="20" style="border: 1px solid rgb(0, 0, 0)">) and choose the <strong>Filter</strong> option. This is the Column which holds the <strong>Type 1</strong> data.</p></li></ol>
<p><img src="filter_8.png" style="max-width:100%;"></p>

<div class="w3-panel ws-note">
<p><strong>Note:</strong>  "Items" are the different categories in that column; Grass, Fire, Water and so on.</p>
</div>
<p>All items are checked by default. The checked items are the ones that are shown. Uncheck to hide.</p>

<ol start="2"><li><p>Uncheck all items, except <strong>Bug</strong>, which is the type that we want to show.</p></li></ol>
<p><img src="filter_9.png" style="max-width:100%;"></p>

<ol start="3"><li><p>Click OK</p></li></ol>
<p><img src="filter_10.png" style="max-width:100%;"></p>


<p><img src="filter_11.png" style="max-width:100%;"></p>

<p><strong>Good job!</strong> The range was successfully sorted by <strong>Type 1, Bug</strong>. All shown Pokemons are <strong>Bug</strong> type. </p>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> The unchecked rows are hidden, not deleted.</p>
</div>

<p>This is explained by looking at the row numbers. The numbers are jumping from 1 to 11 and 16 to 22. The rows in between are hidden.</p>

<p><img src="filter_12.png" style="max-width:100%;"></p>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> Checking the items will have the rows shown again.</p>
</div>
...
<p>Use the filter option to filter the Pokemons which have <strong>Type 1</strong>, <strong>Bug</strong> and <strong>Type 2</strong>, <strong>Poison</strong>.</p>

<ol>
  <li>Click the filter option in <strong>D1</strong></li>
  <li>Uncheck all items except <strong>Poison</strong></li>
  <li>click <strong>OK</strong></li>
</ol>

<p><img src="filter_13.png"></p>

<p><strong>That is on point!</strong> We have sorted the range based on <strong>Type 1</strong>, <strong>Bug</strong> and <strong>Type 2</strong>, <strong>Poison</strong>. The filter option is helpful to make ranges easier to analyse. </p>
<script>
