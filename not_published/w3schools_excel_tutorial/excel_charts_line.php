...
<h1>Excel Line Charts</h1>

<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_charts_pie.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_charts_line_stacked.php">Next &#10095;</a>
</div>
...
<p>Line charts show the data as a continuous line.</p>

<p>Line charts are typically used for showing <strong>trends</strong> over time.</p>

<p>In Line charts, the horizontal axis typically represents time.</p>

<p>Line charts are used with data which can be placed in an order, from low to high.</p>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> Data which can be placed in an order, from low to high, like numbers and letter grades from A to F are called <strong>ordinal data</strong>. You can read more about ordinal data at <a href="https://www.w3schools.com/statistics/statistics_measurement_levels.php">Statistics - Measurement Levels.</a></p>
</div>

<p>Excel has six types of line charts:</p>

<ul>
  <li>Line (<img src="img_excel_chart_line_icon_1.png" width="35" height="35" style="border: 1px solid rgb(220, 220, 220)">)</li>
  <li>Line with Markers (<img src="img_excel_chart_line_icon_4.png" width="35" height="35" style="border: 1px solid rgb(220, 220, 220)">)</li>
  <li>Stacked Line (<img src="img_excel_chart_line_icon_2.png" width="35" height="35" style="border: 1px solid rgb(220, 220, 220)">)</li>
  <li>Stacked Line with Markers (<img src="img_excel_chart_line_icon_5.png" width="35" height="35" style="border: 1px solid rgb(220, 220, 220)">)</li>
  <li>100% Stacked Line (<img src="img_excel_chart_line_icon_3.png" width="35" height="35" style="border: 1px solid rgb(220, 220, 220)">)</li>
  <li>100% Stacked Line with Markers (<img src="img_excel_chart_line_icon_6.png" width="35" height="35" style="border: 1px solid rgb(220, 220, 220)">)</li>
</ul>
...
<p>Line charts are used for showing data ordered from low to high.</p>

<h3>Example</h3>

<p>Let's see the stats change for Bulbasaur evolutions.</p>
...
<ol start="1"><li>Select the range <code class="w3-codespan">A1:C4</code> for labels and data</li></ol>
...
<ol start="2"><li>Click on the <strong>Insert</strong> menu, then click on the Line menu (<img src="img_excel_line_menu.png" width="40" height="60" style="border: 1px solid rgb(220, 220, 220)">) and choose <strong>Line</strong> (<img src="img_excel_chart_line_icon_1.png" width="35" height="35" style="border: 1px solid rgb(220, 220, 220)">) from the drop-down menu</li></ol>

<p><img src="img_excel_chart_line_1.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<p>You should get the chart below:</p>

<p><img src="img_excel_chart_line_2.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<p>The chart gives a visual overview for the Pokemon stats. </p>

<p>Bulbasaur evolutions are shown on the horizontal axis.</p>

<p>HP stat is shown in blue and Attack stat is shown in orange.</p>

<p>The chart shows that with each evolution, the stats increase.</p>

<p><strong>Fantastic!</strong> Now let's plot more stats on the chart.</p>

<ol start="1"><li>Select the range <code class="w3-codespan">A1:D4</code> for labels and data</li></ol>

<ol start="2"><li>Click on the <strong>Insert</strong> menu, then click on Line menu (<img src="img_excel_line_menu.png" width="40" height="60" style="border: 1px solid rgb(220, 220, 220)">) and choose <strong>Line</strong> (<img src="img_excel_chart_line_icon_1.png" width="35" height="35" style="border: 1px solid rgb(220, 220, 220)">) from the drop-down menu</li></ol>

<p><img src="img_excel_chart_line_3.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<p>You should get the chart below:</p>

<p><img src="img_excel_chart_line_4.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<p><strong>Wait a minute</strong>. Something doesn't seem right.</p>

<p>Suddenly, Bulbasaur's evolutions are not shown on the horizontal axis. Instead, it is the stats.</p>

<p>What's happening?</p>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> Excel checks the number of rows and columns included in the chart and automatically places the larger number on the horizontal axis.</p>
</div>

<p>Luckily, there is a simple fix.</p>

<p>Click on the the chart, then chick on the Chart tab and finally Click on Switch Row/Column.</p>

<p><img src="img_excel_chart_line_5.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<p>The outcome is this chart which has Bulbasaur evolutions on the horizontal axis.</p>

<p><img src="img_excel_chart_line_7.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>
...
<h2>Line with Markers</h2>

<p>Line with markers highlights data points with markers on a line chart.</p>

<h3>Example</h3>

<p>Let's chart the average HP, Attack and Defense over all the Pokemon generations.</p>

<p>Copy the values to follow along:</p>

<div class="w3-example">
  <p>Note: This data is rounded to one decimal.</p>
  <div class="w3-code notranslate" style="position:relative">
  <img src="img_excel_chart_line_8.png" style="max-width:100%; border: 1px solid rgb(220, 220, 220); max-width:100%">
  <textarea id="demo_img_excel_chart_line_8" style="display:none">
    Gen	Avg HP	Avg Attack	Avg Defense
    Gen 1	64,7	73,9	69,6
    Gen 2	70,6	68,3	69,5
    Gen 3	65,6	75,8	70,5
    Gen 4	72,6	80,5	77,3
    Gen 5	71,6	82,2	72,0
    Gen 6	68,5	74,8	76,3
  </textarea>
  <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_img_excel_chart_line_8')" title="Copy values to clipboard">Copy</button>
  </div>
</div>

<ol start="1"><li>Select the range <code class="w3-codespan">A1:D7</code> for labels and data</li></ol>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> This menu is accessed by <a href="https://www.w3schools.com/excel/excel_formatting.php">expanding the ribbon</a>.</p>
</div>

<ol start="2"><li>Click on the <strong>Insert</strong> menu, then click on the Line menu (<img src="img_excel_line_menu.png" width="40" height="60" style="border: 1px solid rgb(220, 220, 220)">) and choose <strong>Line with Markers</strong> (<img src="img_excel_chart_line_icon_1.png" width="35" height="35" style="border: 1px solid rgb(220, 220, 220)">) from the drop-down menu</li></ol>

<p><img src="img_excel_chart_line_9.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<p>You should get the chart below:</p>

<p><img src="img_excel_chart_line_10.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<p>The chart gives a visual overview for average Pokemon stats over generations. </p>

<p>Average HP is shown in blue, average attack is shown in orange and average defense is shown in gray.</p>

<p>The horizontal axis shows the generations.</p>

<p>This chart shows that the average of all stats in the 2nd generation is very close to each other and 5th generation Pokemon have on average the highest attack.</p>
<hr>
