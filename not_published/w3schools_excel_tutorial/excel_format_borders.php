...
<html lang="en-US">
<head>
<title>Excel Format Borders</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>Excel <span class="color_h1">Format Borders</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_format_fonts.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_format_numbers.php">Next &#10095;</a>
</div>
<hr>

<h2>Format Borders</h2>
<p>Borders can be added and removed. Colors and style can be changed.</p> 

<p>Why format borders?</p>
<ul>
<li>Make the document more readable and understandable</li>
<li>Emphasizing key points</li>
</ul>
<p>The Borders menu is accessed in the Ribbon, in the Font group.</p>

<p><img src="borders1.png" style="max-width:100%"></p>

<p>The button remembers the border you used last time.</p>
<hr>

<h2>Adding Borders</h2>
<p>Borders are added by clicking the <strong>Borders </strong>button.</p>

<p>The default border is black underline.</p>

<p>Changing the border type, style or color is a choice you make.</p> 

<p>The option button next to the Border command gives options for more types of borders.</p>

<p>Clicking the option button gives an overview of the different border options.</p>
<p><img src="borders2.png" style="max-width:100%"></p>

<p><strong>Example:</strong></p>
<p><img src="borders3.png" style="max-width:100%"></p>
<hr>

<h2>Border Colors</h2>
<p>Colored borders are added by selecting a color before adding the border.</p>

<p>The color can be changed in the Border Color menu:</p>
<p><img src="borders4.png" style="max-width:100%"></p>
<p><strong>Example:</strong></p>

<p><img src="borders5.png" style="max-width:100%"></p>
<hr>
...
<p>Borders styles can be changed.</p>

<p>The menu is accessed in the Border Style menu.</p>

<p>Excel offers 6 different border styles:</p>
<ul>
<li>Solid line</li>
<li>Dashed line</li>
<li>Dotted line</li>
...
<p><img src="borders6.png" style="max-width:100%"></p>

<hr>

<h2>Chapter Summary</h2>

<p>Borders can be added with different colors and styles. The border button remembers the border settings used the last time. The options are accessed from the border options button, next to the border button.</p>

<p>In the next chapter you will learn about Number formats.</p>
<hr>
