<!DOCTYPE html>
<html lang="en-US">
<head><title>Excel Highlight Cell Rules - Text That Contains</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Excel HCR - Text That Contains</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_cf_equal_to.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_cf_date_occurring.php">Next &#10095;</a>
</div>
<hr>
<h2>Highlight Cell Rules - Text That Contains</h2>
...
<p></p>
<p><strong>Text That Contains...</strong> is one of the options for the condition.</p>
...
<hr>
<h2>Highlight Cell Rule - Text That Contains Example (with Text)</h2>
<p>The &quot;Text That Contains...&quot; Highlight Cell Rule will highlight a cell with one of the appearance options based on <strong>a part of the cell value</strong> containing your specified value.</p>
<p>The specified value is typically text, but also works with a numerical value.</p>
<p>In this example, the specified value will be &quot;Pidge&quot;.</p>
<div class="w3-example">
    <h3>Example</h3>
    <div class="w3-code notranslate" style="position:relative">
    <img src="img_excel_cf_ttc.png" style="max-width:100%">
    <textarea id="demo_excel_cf_ttc" style="display:none">
      Name	Type 1	HP	Attack	Defense	Sp. Atk	Sp. Def	Speed
      Pidgey	Normal	40	45	40	35	35	56
      Pidgeotto	Normal	63	60	55	50	50	71
      Pidgeot	Normal	83	80	75	70	70	101
      Rattata	Normal	30	56	35	25	35	72
      Raticate	Normal	55	81	60	50	70	97
      Spearow	Normal	40	60	30	31	31	70
      Fearow	Normal	65	90	65	61	61	100
    </textarea>
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_cf_ttc')" title="Copy values to clipboard">Copy</button>
    </div>
</div>
...
<p>Let's apply the rule to the Name values.</p>
<p>&quot;Text That Contains...&quot; Highlight Cell Rule, step by step:</p>
<ol>
    <li>Select the range <code class="w3-codespan">A2:A8</code> for the Name values</li>
</ol>
<p><img src="img_excel_cf_ttc2.png" style="max-width:100%"></p>
<ol start="2">
    ...
    <li>Select <strong>Text That Contains...</strong> from the menu</li>
</ol>
<p><img src="img_excel_hcr_ttc_menu.png" style="max-width:100%"></p>
<p>This will open a dialog box where you can specify the value and the appearance option.</p>
<ol start="5">
    <li>Enter <code class="w3-codespan">Pidge</code> into the input field</li>
    <li>Select the appearance option &quot;Yellow Fill with Dark Yellow Text&quot; from the dropdown menu</li>
</ol>
<p><img src="img_excel_cf_ttc3.png" style="max-width:100%"></p>
<p>Now, the cells with values Text That Contains &quot;Pidge&quot; will be highlighted in yellow:</p>
<p><img src="img_excel_cf_ttc4.png" style="max-width:100%"></p>
<p>The names &quot;Pidgey&quot;, &quot;Pidgeot&quot;, and &quot;Pidgeotto&quot; all start with &quot;Pidge&quot;, so all these cells are highlighted.</p>
<div class="w3-panel ws-note">
    <p><strong>Note:</strong> The <strong>Text That Contains</strong> rule works with any part of the cell values.</p>
...
<h2>Highlight Cell Rule - Text That Contains Example 2 (with Text)</h2>
<p>The &quot;Text That Contains...&quot; Highlight Cell Rule will highlight a cell with one of the appearance options based on <strong>a part of the cell value</strong> containing your specified value.</p>
<p>The specified value is typically text, but also works with a numerical value.</p>
<p>In this example, the specified value will be &quot;row&quot;.</p>
<div class="w3-example">
    <h3>Example</h3>
    <div class="w3-code notranslate" style="position:relative">
    <img src="img_excel_cf_ttc.png" style="max-width:100%">
...
<p><img src="img_excel_hcr_ttc_menu.png"></p>
<p>This will open a dialog box where you can specify the value and the appearance option.</p>
<ol start="5">
    <li>Enter <code class="w3-codespan">row</code> into the input field</li>
    <li>Select the appearance option &quot;Yellow Fill with Dark Yellow Text&quot; from the dropdown menu</li>
</ol>
<p><img src="img_excel_cf_ttc5.png" style="max-width:100%"></p>
<p>Now, the cells with values Text That Contains &quot;row&quot; will be highlighted in yellow:</p>
<p><img src="img_excel_cf_ttc6.png" style="max-width:100%"></p>
<p>The names &quot;Spearow&quot; and &quot;Fearow&quot; both end with &quot;row&quot;, so both cells are highlighted.</p>
<div class="w3-panel ws-note">
    <p><strong>Note:</strong> You can remove the Highlight Cell Rules with <a href="excel_cf_manage_rules.php">Manage Rules</a>.</p>
</div>
<hr>
<h2>Highlight Cell Rule - Text That Contains Example (with Numbers)</h2>
<p>The &quot;Text That Contains...&quot; Highlight Cell Rule also works with numbers.</p>
<p>In this example, the specified text value will be &quot;7&quot;.</p>
<div class="w3-example">
    <h3>Example</h3>
    <div class="w3-code notranslate" style="position:relative">
    <img src="img_excel_cf_ttc.png" style="max-width:100%">
...
<p>You can <a href="excel_ranges.php">choose any range</a> for where the Highlight Cell Rule should apply. It can be a few cells, a single column, a single row, or a combination of multiple cells, rows and columns.</p>
<p>Let's apply the rule to all the different stat values.</p>
<p>&quot;Text That Contains...&quot; Highlight Cell Rule, step by step:</p>
<ol>
    <li>Select the range <code class="w3-codespan">C2:H8</code> for all the stat values</li>
</ol>
<p><img src="img_excel_cf_ttc7.png" style="max-width:100%"></p>
<ol start="2">
    <li>Click on the Conditional Formatting icon <img src="img_excel_cf_icon.png" style="max-width:100%"> in the ribbon, from <strong>Home</strong> menu</li>
    <li>Select <strong>Highlight Cell Rules</strong> from the drop-down menu</li>
    <li>Select <strong>Text That Contains...</strong> from the menu</li>
...
<p>This will open a dialog box where you can specify the value and the appearance option.</p>
<ol start="5">
    <li>Enter <code class="w3-codespan">7</code> into the input field</li>
    <li>Select the appearance option &quot;Green Fill with Dark Green Text&quot; from the dropdown menu</li>
</ol>
<p><img src="img_excel_cf_ttc8.png" style="max-width:100%"></p>
<p>Now, the cells with values That Contains &quot;7&quot; anywhere will be highlighted in green:</p>
<p><img src="img_excel_cf_ttc9.png" style="max-width:100%"></p>
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> The <strong>Text That Contains...</strong> Highlight Cell Rule will highlight cells that have values with <strong>any part</strong> matching the specified value.</p>
  <p>You can use the <a href="excel_cf_equal_to.php">Equal To...</a> rule for highlighting cells that <strong>exactly</strong> match the specified value.</p>
</div>
<hr>
