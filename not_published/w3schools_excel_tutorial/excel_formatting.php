...
<h1>Excel <span class="color_h1">Formatting</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_functions.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_format_painter.php">Next &#10095;</a>
</div>
<hr>
...
<p>There are two ways to access the styling commands in Excel:</p>
<ol>
<li>The Ribbon</li>
<li>Formatting menu, by right clicking cells</li>
</ol>

<p>Read more about the Ribbon in the <a href="excel_overview.php">Excel overview chapter.</a></p>
<hr>

<h2>Styling Commands in Ribbon</h2>
<p><img src="formatting1.jpg" style="max-width:100%"></p>

<p>The Ribbon can be expanded by clicking the arrow/caret-down icon on the right side. This gives access to more commands:</p>
<p><img src="formatting2.jpg" style="max-width:100%"></p>
<p><img src="formatting3.png" style="max-width:100%"></p>
...
<h2>Styling Commands, Right Clicking Cells</h2>
<p>You can also right-click on any cell to style it:</p>
<p><img src="formatting4.jpg" style="max-width:100%"></p>
<p>Styling commands can be accessed from both views.</p>
<hr>

<h2>Chapter summary</h2>
<p>Formatting is used to make spreadsheets more readable. There are many ways to add styles. The most common ones are; Color, Font, Number format and Grids.</p> 
