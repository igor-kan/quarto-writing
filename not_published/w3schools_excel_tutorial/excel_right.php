<!DOCTYPE html>
<html lang="en-US">
<head><title>Excel RIGHT Function</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_rand.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_stdevp.php">Next &#10095;</a>
</div>
<hr>

<h2>RIGHT Function</h2>

<p>The <strong>RIGHT</strong> function is used to retrieve a chosen amount of characters, counting from the right side of an Excel cell.
 The chosen number has to be greater than 0 and is set to 1 by default.</p>
<p>It is typed <code class="w3-codespan">=RIGHT</code></p>
<p>If you want to use the function on a single cell, write:</p>
<div class="w3-example">
<div class="w3-code notranslate">
  =RIGHT(<strong>cell</strong>)
  </div>
</div>
<p>If you want to use the function on a range of cells, write:</p>
<div class="w3-example">
<div class="w3-code notranslate">
  =RIGHT(<strong>start cell</strong>:<strong>end cell</strong>)
  </div>
</div>
<hr>

<h2>How to use RIGHT Function</h2>

<p>To retrieve values from the right side of an Excel cell, use <strong>RIGHT</strong>.</p>
<hr>
<h5><strong>Step 1)</strong> Start the RIGHT function</h5>
<ol>
  <li>Select a cell <code class="w3-codespan">E2</code></li>
  <li>Type <code class="w3-codespan">=RIGHT</code></li>
  <li>Double click the <strong>RIGHT</strong> command</li>
</ol>
<hr>
<div class="w3-example">
    <div class="w3-code notranslate" style="position:relative">
    <img src="img_excel_right1.png" style="max-width:550px; height:auto; width:100%;">
    <textarea id="demo_excel_right" style="display:none">
    ...
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_right')" title="Copy values to clipboard">Copy</button>
    </div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_right">Try it Yourself &raquo;</a>
</p>
</div>
...
<h5><strong>Step 2)</strong> Enter values to the RIGHT function</h5>
<ol start="4">
  <li>Select a cell (<code class="w3-codespan">A2</code>)</li>
  <li>Hit enter</li>
</ol>
<p><img src="img_excel_right2.png" style="max-width:550px; height:auto; width:100%;"></p>
<p><img src="img_excel_right3.png" style="max-width:550px; height:auto; width:100%;"></p>
<p><code class="w3-codespan">=RIGHT(A2)</code> uses the default funcion of <strong>RIGHT</strong> and retrieves the last symbol from the <code class="w3-codespan">A2</code> cell.</p>
<h3>How to use the <strong>RIGHT</strong> function with a defined length of characters</h3>
<h5><strong>Step 1)</strong> Start the RIGHT function</h5>
<ol>
  <li>Select a cell <code class="w3-codespan">E2</code></li>
  <li>Type <code class="w3-codespan">=RIGHT</code></li>
...
<p><img src="img_excel_right4.png" style="max-width:550px; height:auto; width:100%;"></p>
...
<p>The function returns the last 3 symbols from cell <code class="w3-codespan">A2</code>.</p>
<p><img src="img_excel_right5.png" style="max-width:550px; height:auto; width:100%;"></p>
<hr>
<h3>How to use the <strong>RIGHT</strong> function used on a range of cells</h3>
<h5><strong>Step 1)</strong> Start the RIGHT function</h5>
<ol>
  <li>Select a cell <code class="w3-codespan">E2</code></li>
  <li>Type <code class="w3-codespan">=RIGHT</code></li>
...
<p><img src="img_excel_right6.png" style="max-width:550px; height:auto; width:100%;"></p>
...
<p>The function returns the last 3 symbols from each cell within the range <code class="w3-codespan">A2:A4</code>.</p>
<div class="w3-example">
<div class="w3-code notranslate" style="position:relative">
<img src="img_excel_right7.png" style="max-width:550px; height:auto; width:100%;">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_right_finished">Try it Yourself &raquo;</a>
</p>
</div>
