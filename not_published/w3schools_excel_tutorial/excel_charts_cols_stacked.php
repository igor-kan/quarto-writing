<!DOCTYPE html>
<html lang="en-US">
<head><title>Excel Stacked Column Charts</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Excel Stacked Column Charts</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_charts_cols.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_charts_pie.php">Next &#10095;</a>
</div>
...
<p>Stacked Column charts are used to highlights the <strong>total</strong> amount of contribution for each category.</p>

<p>This is done by stacking columns on top of each other.</p>

<p>The charts are used when you have more than one data column.</p>

<h3>Example</h3>

<p>We want to find out the <strong>total</strong> number of generation 1 and 2 Pokemons in each of these type 1 categories: "Grass", "Fire", "Water" and "Bug".</p>
...
<ol>
  <li>Select the range <code class="w3-codespan">A1:C5</code></li>
</ol>
<p><img src="img_excel_chart_intro_26.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<ol start="2"><li>Click on the <strong>insert</strong> menu, then click on the column menu (<img src="img_excel_column_menu.png" width="30" height="40" style="border: 1px solid rgb(220, 220, 220)">) and choose <strong>Clustered Column</strong> (<img src="img_excel_chart_intro_21.png" width="30" height="30" style="border: 1px solid rgb(220, 220, 220)">) from the drop-down menu</li></ol>
...
<p><img src="img_excel_chart_column_3.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<p>Following the steps above, you will get the following chart:</p>
<p><img src="img_excel_chart_column_4.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<p>The chart gives a visual overview for the <strong>total</strong> number of "Grass", "Fire", "Water" and "Bug" type Pokemons in both generation 1 and 2.</p>

<p>Generation 1 Pokemons are shown in blue and generation 2 Pokemons are shown in orange. </p>

<p>This chart shows that "Water" type Pokemons are the most common and "Fire" type Pokemons are the least common.</p>
...
<p>100% Stacked Column is used to highlights the <strong>proportion</strong> of contribution for each data column in a category.</p>

<p>This is done by scaling the <strong>total</strong> value of each category in a stacked column chart to 100.</p>

<p>The charts are used when you have more than one data column.</p>

<h3>Example</h3>

<p>We want to find out the <strong>proportion</strong> of Pokemon types "Grass", "Fire", "Water" and "Bug" in generation 1 and 2.</p>
...
<ol start="2"><li>Click on the <strong>insert</strong> menu, then click on the column menu (<img src="img_excel_column_menu.png" width="30" height="40" style="border: 1px solid rgb(220, 220, 220)">) and choose <strong>Clustered Column</strong> (<img src="img_excel_chart_intro_22.png" width="30" height="30" style="border: 1px solid rgb(220, 220, 220)">) from the drop-down menu</li></ol>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> This menu is accessed by <a href="https://www.w3schools.com/excel/excel_formatting.php">expanding the ribbon</a>.</p>
</div>

<p><img src="img_excel_chart_column_5.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<p>Following the steps above, you will get the following chart:</p>
<p><img src="img_excel_chart_column_6.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<p>The chart gives a visual overview for the <strong>proportion</strong> of "Grass", "Fire", "Water" and "Bug" type Pokemons in both generation 1 and 2.</p>

<p>Generation 1 Pokemons are shown in blue and generation 2 Pokemons are shown in orange. </p>

<p>This chart shows that more than half of Pokemons are in generation 1.</p>
<hr>
