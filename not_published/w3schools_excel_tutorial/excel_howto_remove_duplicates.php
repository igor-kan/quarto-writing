<!DOCTYPE html>
<html lang="en-US">
<head><title>How to Remove Duplicates with Excel</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>How to Remove Duplicates with Excel</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_howto_net_present_value.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_exam.php">Next &#10095;</a>
</div>
<hr>

<p class="intro">Learn how to remove duplicates with Excel.</p>
<p>Removing duplicates manually can be time-consuming when working with large data sets.</p>
<p>The Remove Duplicates function in Excel makes removing duplicates easy.</p>

<hr>
<p>The <strong>Remove Duplicates</strong> function <img src="img_excel_remove_duplicates_function.png" style="max-width:130px; height:auto; width:100%; border: solid 0.5px;" alt="Remove duplicates button"> is used to remove duplicate entries.</p>
<p>Duplicate entries are values that two or more are the same.<p>
<p>This can be both numbers and text inputs.</p>
<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate">
  <code class="w3-codespan">A1(5), A2(5), A3(2)</code>
  </div>
</div>
<p><code class="w3-codespan">A1</code> and <code class="w3-codespan">A2</code> are duplicates since they have the same values.</p>
<hr>

<h2>How to remove duplicate values</h2>
<h5><strong>Step 1)</strong> Select a range:</h5>
<p>Select the <a href="https://www.w3schools.com/excel/excel_ranges.php" alt="Range chapter">range</a> where you want to remove duplicate values.</p>
<p>A minimum of two cells needs to have values.</p>
<img src="img_excel_select_a_range.png" style="max-width:550px; height: auto; width:100%; border: solid 0.5px;" alt="Selected range">
<div class="w3-panel ws-note">
  <p>Excel will automatically include related cells.</p>
  <p>This helps so that you do not break the relationship between the cells.</p>
</div>
<hr>

<h5><strong>Step 2)</strong> Click the Remove Duplicates button:</h5>
<p>Find the button under the Data tab in the <a href="https://www.w3schools.com/excel/excel_overview.php" target="_blank" alt="Overview chapter">ribbon</a>.</p>
<p>Start the command by pressing the button.</p>
<img src="img_excel_remove_duplicates_button.png" style="max-width:800px; height: auto; width:100%;" alt="Remove duplicates button">

<h5><strong>Step 3)</strong> Select columns:</h5>
<p>Select one or more columns that have values.</p>
<p>Press the "OK" button once you have selected the columns.</p>
<img src="img_excel_select_columns_duplicate_values.png" style="max-width:550px; height: auto; width:100%; border: solid 0.2px;" alt="Select columns to remove duplicate values">
<hr>

<h2>Duplicates removed</h2>
<p>When the columns have been selected, and you have pressed the "OK" button, the duplicates have been removed.</p>
<h5><strong>Example:</strong></h5>
<p>In this example, we will remove the duplicates for <strong>Column B (Age)</strong>.</p>
<br>
<p>Select <strong>Column B (Age)</strong>:</p>
<img src="img_excel_remove_duplicates_for_column_b.png" style="max-width:550px; height: auto; width:100%; border: solid 0.2px;" alt="Select Column B">
<p>Press the <strong>"OK"</strong> button...</p>
<img src="img_excel_press_ok_button.png" style="max-width:550px; height: auto; width:100%; border: solid 0.2px;" alt="Duplicates removed">
<p>1 duplicate value was <strong>removed</strong>.</p>
<p>3 unique values remain.</p>
<div class="ws-note w3-panel">
  <p><strong>Tip:</strong> Use the Remove Duplicate function with care for large data sets.</p>
  <p>If used wrong, it might remove useful data.</p>
</div>
<hr>
