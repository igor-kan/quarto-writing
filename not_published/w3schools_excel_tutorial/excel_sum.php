...
<html lang="en-US">
<head>
<title>Excel SUM Function</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>Excel <span class="color_h1">SUM Function</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_stdevs.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_sumif.php">Next &#10095;</a>
</div>
<hr>

<h2>SUM Function</h2>

<p>The <strong>SUM</strong> function is a premade function in Excel, which adds numbers in a range.</p>
<p>It is typed <code class="w3-codespan">=SUM</code></p>
<p><strong>Note:</strong> The <code class="w3-codespan">=SUM</code> function adds cells in a range, both negative and positive.</p>
<p>How to use the <code class="w3-codespan">=SUM</code> function:</p>
<ol>
<li>Select a cell</li>
<li>Type <code class="w3-codespan">=SUM</code></li>
<li>Double click the <strong>SUM </strong>command</li>
...
<div class="w3-example">
    ...
    <img src="sum2.png" style="max-width:100%">
    <textarea id="demo_excel_sum" style="display:none">
    ...
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_sum')" title="Copy values to clipboard">Copy</button>
    </div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_sum">Try it Yourself &raquo;</a>
</p>
</div>

<p><img src="sum3.png" style="max-width:100%"></p>
<p><img src="sum4.png" style="max-width:100%"></p>
<div class="w3-example">
<div class="w3-code notranslate" style="position:relative">
<img src="sum5.png" style="max-width:100%">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_sum_finished">Try it Yourself &raquo;</a>
</p>
</div>

<p><strong>Great job!</strong> You have successfully calculated the sum of the stats using the <code class="w3-codespan">=SUM</code> function. The Pokemon's stats have a total sum of <code class="w3-codespan">3092</code>.</p>

<p>Let's change one of the values in the range, to see what happens. Type <code class="w3-codespan">D7(350)</code>:</p>

<p><img src="sum6.png" style="max-width:100%"></p>
<hr>


<p><strong>Rattata</strong> total stats was changed from <code class="w3-codespan">(D7)253</code> to <code class="w3-codespan">(D7)350</code>. </p>

<p>The <strong>SUM</strong> function updated the total sum from <code class="w3-codespan">D12(3092)</code> to <code class="w3-codespan">D12(3189)</code>.</p>

<p>It updates the <strong>SUM</strong> when values inside of the range are changed.</p>

<p>Lets change <strong>Rattata </strong>stats to a negative number to see what happens. Type <code class="w3-codespan">D7(-350)</code>:</p>

<p><img src="sum7.png" style="max-width:100%"></p>

<p>The <strong>SUM</strong> is updated to <code class="w3-codespan">D12(2489)</code>. Adding a negative number subtracts that value from the range.</p>

<p>The <code class="w3-codespan">=SUM</code> function adds both positive and negative numbers.</p>
