...
<h1>Excel <span class="color_h1">Study Plan</span></h1>

<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_syllabus.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_training.php">Next &#10095;</a>
</div>
<hr>

<h2>Introduction</h2>
<p>The Excel study plan helps you teach your students Excel step-by-step.</p>
<p>Creating a study plan for Excel is easy.</p>
...
<p>Save time with pre-built teacher materials and study plans. Easily organize your class with a timeline from the introduction of Excel to the final exam.</p>
<hr>
...
<p>W3Schools has everything you need to teach Excel.</p>

<p>The Excel training materials is available for you to include and use in your study plan:</p>
<ul>
  <li><a href="index.php" target="_blank">W3Schools Excel Tutorial</a></li>
  <li><a href="excel_exercises.php" target="_blank">Excel Exercises</a></li>
  <li>Excel Challenges (Coding challenges)</li>
  <li><a href="excel_exam.php" target="_blank">Excel Certification Exam (End of Pathway Exam)</a></li>
</ul>
<hr>

<h2>Excel Syllabus</h2>
<p>With the Excel Syllabus, your students will start with the basics, like understanding cells, rows, and columns, and move to more advanced topics, like creating formulas, using functions, and analyzing data with charts and pivot tables. Each chapter includes examples, try-it-yourself sections, exercises, and quizzes to make learning easy, interactive, and fun.</p>
<p><a title="W3Schools Excel Syllabus" href="excel_syllabus.php" target="_blank">Read more about Excel Syllabus</a>.</p>
<hr>
...
<ol>
  ...
  <li style="margin-top:16px">
    ...
    <ul>
      <li>The Excel study plan aligns with the Excel Certification Exam.</li>
      <li>The exam can be taken at the end of the study plan, at your selected date.</li>
      <li>The exam summarizes the Excel Tutorial.</li>
...
<p>Some would like more intensive pace, e.g. 3 weeks, others 6 or more weeks.</p>
<p>It is completely up to you.</p>
<p>For example, this is how a 3-week Excel study plan could look like:</p>

<ul>
  <li>Week 1: Introduction, Basic use, Formulas</li>
  <li>Week 2: Arithmetic Operators, Formatting, Sort &amp; Filter, Tables, Highlight Cell Rules, Top Bottom Rules</li>
  <li>Week 3: Data Analysis Extras, Charts, Table Pivot, Case, Functions, Excel Certification Exam</li>
</ul>

<p>Image of Sample Excel study plan:</p>
<a href="excel_study_plan.png" target="_blank" title="Excel Study Plan"><img src="excel_study_plan.png" style="height:auto;max-width:100%;" loading="lazy"></a>
<hr>

<h2>Ready to get started?</h2>
<p>Start with <strong> Excel Study Plans</strong> today.</p>
...
<p>Are you interested in learning how you can use <a href="/academy/index.php" target="_blank">W3Schools Academy</a> to Teach Excel programming? </p>
