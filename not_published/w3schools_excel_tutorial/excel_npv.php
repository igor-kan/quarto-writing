<!DOCTYPE html>
<html lang="en-US">
<head><title>Excel NPV Function</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_mode.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_or.php">Next &#10095;</a>
</div>
<hr>

<h2>NPV Function</h2>

<p>The <strong>NPV</strong> function is used to calculate the <strong>N</strong>et <strong>P</strong>resent <strong>V</strong>alue (NPV)
<p>It is typed <code class="w3-codespan">=NPV</code></p>
<div class="w3-example">
<div class="w3-code notranslate">
  =NPV(<strong>rate</strong>, <strong>value1</strong>, <strong>value2</strong>, ...)
  </div>
</div>
<p><strong>rate</strong>: The Discount rate.</p>
<p><strong>value</strong>: The cells where the cash flows are.</p>

<hr>

<h2>How to Use NPV Excel Function</h2>

<p>To calculate and find out whether an investment is positive in the future, use <strong>NPV</strong>.</p>
<hr>

<h5><strong>Step 1)</strong> Type the <strong>rate</strong> value</h5>
<p>The rate is the required Discount Rate that you want to use.</p>
<p>We will use <code class="w3-codespan">10%</code> in this example.</p>
<ol>
  <li>Select cell (<code class="w3-codespan">B9</code>)</li>
  <li>Type <code class="w3-codespan">10%</code></li>
  <li>Hit enter</li>
</ol>
<p>Ensure that you enter the value as percentage(%).</p>
<p><img src="img_excel_npv_type_rate.png" style="max-width:800px; height:auto; width:100%;"></p>
<hr>

<h5><strong>Step 2)</strong> Start the <strong>NPV</strong> function</h5>
<ol start="4">
  <li>Select a cell (<code class="w3-codespan">E9</code>)</li>
  <li>Type <code class="w3-codespan">=NPV</code></li>
  <li>Double click the <strong>NPV</strong> command</li>
</ol>
<hr>
<div class="w3-example">
    <div class="w3-code notranslate" style="position:relative">
    <img src="img_excel_npv_function_setup.png" style="max-width:800px; height:auto; width:100%;">
...
Discount Rate			NPV							
    ...
    <p><a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_npv">Try it Yourself &raquo;</a></p>
</div>
...
<h5><strong>Step 3)</strong> Add <strong>values</strong> to the function</h5>
<p>Let us add the <strong>rate</strong> and the <strong>values</strong> from 1 to 10 to the function.</p>
<ol start="7">
  <li>Select cell (<code class="w3-codespan">B9</code>)</li>
  <li>Type <code class="w3-codespan">,</code> or <code class="w3-codespan">;</code></li>
  <li>Select the range (<code class="w3-codespan">B2:K2</code>)</li>
  <li>Hit enter</li>
</ol>
...
<p><img src="img_excel_npv_values_added_to_function.png" style="max-width:800px; height:auto; width:100%;"></p>
<div class="w3-example">
<div class="w3-code notranslate" style="position:relative">
<img src="img_excel_npv_function_completed.png" style="max-width:800px; height:auto; width:100%;">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_npv_finished">Try it Yourself &raquo;</a>
</p>
</div>
<hr>
<p>Did you calculate <strong>377,87</strong>?</p>
<p><strong>Congratulations!</strong> you have just calculated the NPV for ten years using a discount rate of 10%</p>
