<!DOCTYPE html>
<html lang="en-US">
<head><title>Excel LEFT Function</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_ifs.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_lower.php">Next &#10095;</a>
</div>
<hr>

<h2>LEFT Function</h2>

<p>The <strong>LEFT</strong> function is used to retrieve a chosen amount of characters, counting from the left side of an Excel cell.
 The chosen number has to be greater than 0 and is set to 1 by default.</p>
<p>It is typed <code class="w3-codespan">=LEFT</code></p>
<p>If you want to use the function on a single cell, write:</p>
<div class="w3-example">
<div class="w3-code notranslate">
  =LEFT(<strong>cell</strong>)
  </div>
</div>
<p>If you want to use the function on a range of cells, write:</p>
<div class="w3-example">
<div class="w3-code notranslate">
  =LEFT(<strong>start cell</strong>:<strong>end cell</strong>)
  </div>
</div>
<hr>

<h2>How to Use LEFT Function</h2>

<p>To retrieve values from the left side of an Excel cell, use <strong>LEFT</strong>.</p>
<hr>

<h5><strong>Step 1)</strong> Start the LEFT function</h5>
<ol>
  <li>Select a cell <code class="w3-codespan">E2</code></li>
  <li>Type <code class="w3-codespan">=LEFT</code></li>
  <li>Double click the <strong>LEFT</strong> command</li>
</ol>
<hr>
<div class="w3-example">
    <div class="w3-code notranslate" style="position:relative">
    <img src="img_excel_left1.png" style="max-width:550px; height:auto; width:100%;">
    <textarea id="demo_excel_left" style="display:none">
    ...
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_left')" title="Copy values to clipboard">Copy</button>
    </div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_left">Try it Yourself &raquo;</a>
</p>
</div>
...
<h5><strong>Step 2)</strong> Enter values to the LEFT function</h5>
<ol start="4">
  <li>Select a cell (<code class="w3-codespan">A2</code>)</li>
  <li>Hit enter</li>
</ol>
<p><img src="img_excel_left2.png" style="max-width:550px; height:auto; width:100%;"></p>
<p><img src="img_excel_left3.png" style="max-width:550px; height:auto; width:100%;"></p>
<p><code class="w3-codespan">=LEFT(A2)</code> uses the default funcion of <strong>LEFT</strong> and retrieves the first symbol from the <code class="w3-codespan">A2</code> cell.</p>
...
<h3>How to Use the <strong>LEFT</strong> Function with a Defined Length of Characters</h3>
<p>Learn to use <code class="w3-codespan">=LEFT</code> to get more than one character.</p>
<h5><strong>Step 1)</strong> Start the LEFT function</h5>
<ol>
  <li>Select a cell <code class="w3-codespan">E2</code></li>
  <li>Type <code class="w3-codespan">=LEFT</code></li>
...
<p><img src="img_excel_left4.png" style="max-width:550px; height:auto; width:100%;"></p>
<h5><strong>Step 2)</strong> Select cells and set the number of characters</h5>
<ol start="4">
  <li>Enter the cell name (<code class="w3-codespan">A2</code>) and define the length of characters you want to retrieve, using a <code class="w3-codespan">,</code> as a delimiter (<code class="w3-codespan">A2,3</code>)</li>
  <li>Hit enter</li>
</ol>
<p>The function returns the first 3 characters from cell <code class="w3-codespan">A2</code>.</p>
<p><img src="img_excel_left5.png" style="max-width:550px; height:auto; width:100%;"></p>
<h3>How to use the <strong>LEFT</strong> Function on a Range of Cells</h3>
<h5><strong>Step 1)</strong> Start the LEFT function</h5>
<ol>
  <li>Select a cell <code class="w3-codespan">E2</code></li>
  <li>Type <code class="w3-codespan">=LEFT</code></li>
...
<p><img src="img_excel_left6.png" style="max-width:550px; height:auto; width:100%;"></p>
<h5><strong>Step 2)</strong> Select cells and number of characters</h5>
<ol start="4">
  <li>Select the cells (<code class="w3-codespan">A2:A4</code>) and define the length of characters you want to retrieve, using a <code class="w3-codespan">,</code> as a delimiter (<code class="w3-codespan">A2:A4,3</code>)</li>
  <li>Hit enter</li>
</ol>
<p>The function returns the first 3 characters from each cell within the range <code class="w3-codespan">A2:A4</code>.</p>
<div class="w3-example">
<div class="w3-code notranslate" style="position:relative">
<img src="img_excel_left7.png" style="max-width:550px; height:auto; width:100%;">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_left_finished">Try it Yourself &raquo;</a>
</p>
</div>
