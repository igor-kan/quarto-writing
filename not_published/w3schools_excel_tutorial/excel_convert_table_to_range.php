...
<h1>Excel Converting a Table to Range</h1>

<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_table_removing_duplicates.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_table_style.php">Next &#10095;</a>
</div>

<hr>

<p>Tables can be reversed and converted back to range.</p>

<p>Tables can be converted to ranges by selecting a cell in the table range and clicking on the Convert to Range command.</p>

<p>The command to convert to range is found in the Table Design tab, in the Tools group.</p>
<p><img src="img_excel_tables_32.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<h3>Example - Convert Table to Range</h3>

<p>Type or copy the values to follow the example.</p>
...
<ol start="1"><li>Select a cell in the table range (<code class="w3-codespan">A1:F16</code>)</li></ol>
...
<ol start="3"><li>Click the Convert to Range command (<img src="img_excel_tables_35.png" style="max-width:100%;border: 1px solid rgb(220, 220, 220)">)</li></ol>

<p><img src="img_excel_tables_36.png" style="max-width:100%;"></p>

<p>The table is now converted into a range and it no longer has the table options available.</p>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> The cell formatting is kept for the range after the conversion.</p>
</div>
<hr>
