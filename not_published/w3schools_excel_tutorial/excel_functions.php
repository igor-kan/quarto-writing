...
<h1>Excel <span class="color_h1">Functions</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_parantheses.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_formatting.php">Next &#10095;</a>
</div>
<hr>

<h2>Functions</h2>

<p>Excel has many premade formulas, called <strong>functions</strong>.</p>

<p>Functions are typed by <code class="w3-codespan">=</code> and the functions name.</p>

<p>For example <code class="w3-codespan">=SUM</code></p>

<p>Once you have typed the function name you need to apply it to a range.</p>

<p>For example <code class="w3-codespan">=SUM(A1:A5)</code></p>

<p>The range is always inside of parentheses.</p>

<div class="w3-responsive" style="margin-top:-16px">
...
<tr>
<td><a href="excel_and.php">=AND</a></td>
<td>Returns TRUE or FALSE based on two or more conditions</td>
</tr>
<tr>
<td><a href="excel_average.php">=AVERAGE</a></td>
<td>Calculates the average (arithmetic mean)</td>
</tr>
<tr>
<td><a href="excel_averageif.php">=AVERAGEIF</a></td>
<td>Calculates the average of a range based on a TRUE or FALSE condition</td>
</tr>
<tr>
<td><a href="excel_averageifs.php">=AVERAGEIFS</a></td>
<td>Calculates the average of a range based on one or more TRUE/FALSE 
conditions</td>
</tr>
<tr>
<td><a href="excel_concat.php">=CONCAT</a></td>
<td>Links together the content of multiple cells</td>
</tr>
<tr>
<td><a href="excel_count.php">=COUNT</a></td>
<td>Counts cells with numbers in a range</td>
</tr>
<tr>
<td><a href="excel_counta.php">=COUNTA</a></td>
<td>Counts all cells in a range that has values, both numbers and letters</td>
</tr>
<tr>
<td><a href="excel_countblank.php">=COUNTBLANK</a></td>
<td>Counts blank cells in a range</td>
</tr>
<tr>
<td><a href="excel_countif.php">=COUNTIF</a></td>
<td>Counts cells as specified</td>
</tr>
<tr>
<td><a href="excel_countifs.php">=COUNTIFS</a></td>
<td>Counts cells in a range based on one or more TRUE or FALSE condition</td>
</tr>
<tr>
<td><a href="excel_if.php">=IF</a></td>
<td>Returns values based on a TRUE or FALSE condition</td>
</tr>
<tr>
<td><a href="excel_ifs.php">=IFS</a></td>
<td>Returns values based on one or more TRUE or FALSE conditions</td>
</tr>
<tr>
<td><a href="excel_left.php">=LEFT</a></td>
<td>Returns values from the left side of a cell</td>
</tr>
<tr>
<td><a href="excel_lower.php">=LOWER</a></td>
<td>Reformats content to lowercase</td>
</tr>
<tr>
<td><a href="excel_max.php">=MAX</a></td>
<td>Returns the highest value in a range</td>
</tr>
<tr>
<td><a href="excel_median.php">=MEDIAN</a></td>
<td>Returns the middle value in the data</td>
</tr>
<tr>
<td><a href="excel_min.php">=MIN</a></td>
<td>Returns the lowest value in a range</td>
</tr>
<tr>
<td><a href="excel_mode.php">=MODE</a></td>
<td>Finds the number seen most times. The function always returns a single number</td>
</tr>
<tr>
<td><a href="excel_npv.php">=NPV</a></td>
<td>The NPV function is used to calculate the Net Present Value (NPV)</td>
</tr>
<tr>
<td><a href="excel_or.php">=OR</a></td>
<td>Returns TRUE or FALSE based on two or more conditions</td>
</tr>
<tr>
<td><a href="excel_rand.php">=RAND</a></td>
<td>Generates a random number</td>
</tr>
<tr>
<td><a href="excel_right.php">=RIGHT</a></td>
<td>Returns values from the right side of a cell</td>
</tr>
<tr>
<td><a href="excel_stdevp.php">=STDEV.P</a></td>
<td>Calculates the Standard Deviation (Std) for the entire population</td>
</tr>
<tr>
<td><a href="excel_stdevs.php">=STDEV.S</a></td>
<td>Calculates the Standard Deviation (Std) for a sample</td>
</tr>
<tr>
<td><a href="excel_sum.php">=SUM</a></td>
<td>Adds together numbers in a range</td>
</tr>
<tr>
<td><a href="excel_sumif.php">=SUMIF</a></td>
<td>Calculates the sum of values in a range based on a TRUE or FALSE condition</td>
</tr>
<tr>
<td><a href="excel_sumifs.php">=SUMIFS</a></td>
<td>Calculates the sum of a range based on one or more TRUE or FALSE condition</td>
</tr>
<tr>
<td><a href="excel_trim.php">=TRIM</a></td>
<td>Removes irregular spacing, leaving one space between each value</td>
</tr>
<tr>
<td><a href="excel_vlookup.php">=VLOOKUP</a></td>
<td>Allows vertical searches for values in a table</td>
</tr>
<tr>
<td><a href="excel_xor.php">=XOR</a></td>
<td>Returns TRUE or FALSE based on two or more conditions</td>
</tr>
</tbody>
</table>
