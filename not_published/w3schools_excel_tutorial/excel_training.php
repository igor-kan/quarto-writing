<!DOCTYPE html>
<html lang="en-US">
<head><title>Excel Training</title>
<meta property="og:description" content="Excel Training">  
</head>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Excel Training</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_study_plan.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="excel_keyboard_shortcuts.php">Next &#10095;</a>
</div>
<hr>

<div class="w3-panel ws-info">
  <p><strong>Introduction:</strong> Excel is a standard language for storing, manipulating and retrieving data in databases.</p>
  <p>W3Schools offers an Excel training course that covers Excel foundations and more.</p>
  <p>The course includes the W3Schools <strong>Certified Excel Practitioner</strong> certification.</p>
  <p>The Excel training is relevant for companies and schools that want to certify their employees or students.</p>
  ...
  <p>Remember that you can always learn for free on W3Schools with the <a href="https://www.w3schools.com/excel/index.php" target="_blank">Excel Tutorial</a>.</p>
...
<h2>Excel Training with W3Schools</h2>
...
<p>With the W3Schools Academy pricing model, it is now one of the worlds most affordable quality Excel training options there is.</p>
...
<p>The Certificate Course includes all the training materials to pass the <strong>Certified Excel Practitoner</strong> certification exam.</p>
...
<p>When the learner passes the exam, the learner will get the <strong>Certified Excel Practitoner</strong> certification.</p>
<p>The exam is a multiple choice exam with 60 questions and a duration of 60 minutes.</p>
<p>Image of a Excel Certificate:</p>
<img src="excel_certification.png" style="max-width:100%;height:auto;" class="w3-image" loading="lazy">
...
<p>You can read more about the certificate here: <a href="excel_exam.asp" target="_blank">Excel Certificate</a></p>
<hr>
...
<img src="excel_class.png" style="max-width:100%;height:auto;" class="w3-image" loading="lazy">
...
<p>This includes Excel exercises, quizzes and a final exam.</p>
<p>Stay engaged with hands-on coding challenges that help you practice and test what you've learned.</p>
<p>Image of one of the activity types in the course, a Excel Exercise:</p>
<img src="excel_exercise.png" style="max-width:100%;height:auto;" class="w3-image" loading="lazy">
<p>Excel is best learned by doing, and this is why we have included a lot of exercises in the course.</p>
<hr>
...
<table class="ws-table-all" style="width:100%; border-collapse: collapse; margin: 25px 0;">
  ...
  <tr>
    ...
    <td style="padding:16px; border:1px solid #ddd;">40 hours on average</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td style="padding:16px; border:1px solid #ddd;">Certified Excel Practitioner</td>
  </tr>
  <tr>
...
<ol>
  ...
  <li>Assign the Excel course to your class</li>
