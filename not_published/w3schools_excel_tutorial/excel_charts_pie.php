...
<h1>Excel Pie Charts</h1>

<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_charts_cols_stacked.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_charts_line.php">Next &#10095;</a>
</div>
...
<p>Pie charts arrange the data as slices in a circle.</p>

<p>Pie charts are used for representing values of <strong>qualitative</strong> (<strong>categorical</strong>) data.</p>

<p>Pie charts show the contribution of each category to the total.</p>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> You can read more about qualitative (categorical) data at <a href="https://www.w3schools.com/statistics/statistics_data_types.php">Statistics Data Types</a>.</p>
</div>

<p>Excel has two types of pie charts:</p>

<ul>
  <li>2-D pie (<img src="img_excel_chart_pie_icon_1.png" width="30" height="30" style="border: 1px solid rgb(220, 220, 220)">)</li>
  <li>Doughnut (<img src="img_excel_chart_pie_icon_2.png" width="30" height="30" style="border: 1px solid rgb(220, 220, 220)">)</li>
</ul>
...
<p>2-D pie charts are used when you only have <strong>one</strong> data column.</p>

<h3>Example</h3>

<p>Showing the proportion of 1st generation Grass, Fire, Water, and Bug type Pokemon.</p>

<p>You can copy the values to follow along:</p>

<div class="w3-example">
  <div class="w3-code notranslate" style="position:relative">
  <img src="img_excel_chart_intro_23.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%">
  <textarea id="demo_img_excel_chart_intro_23" style="display:none">
  ...
  <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_img_excel_chart_intro_23')" title="Copy values to clipboard">Copy</button>
  </div>
</div>

<ol><li>Select the range <code class="w3-codespan">A1:B5</code></li></ol>
<p><img src="img_excel_chart_intro_24.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<ol start="2"><li>Click on the <strong>Insert</strong> menu, then click on the Pie menu (<img src="img_excel_pie_menu.png" width="30" height="40" style="border: 1px solid rgb(220, 220, 220)">) and choose <strong>Pie</strong> (<img src="img_excel_chart_pie_icon_1.png" width="30" height="30" style="border: 1px solid rgb(220, 220, 220)">) from the drop-down menu</li></ol>
...
<p><img src="img_excel_chart_pie_1.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<p>You should get the chart below:</p>

<p><img src="img_excel_chart_pie_2.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<p>The chart gives a visual overview of the number of 1st generation Grass, Fire, Water and Bug type Pokemon.</p>

<p>Type "Grass" is shown in blue, "Fire" in orange, "Water" in gray and "Bug" in yellow.</p>

<p>Type "Water" has the most Pokemon in the first generation.</p>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> The chart can be customized by adding labels. This can make it easier to understand the differences between categories.</p>
</div>
...
<p>Doughnut charts arrange the data as slices in a circle with hollow center.</p>

<p>Doughnut charts are often used when you have more than one data column.</p>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> A doughnut chart with one data column shows the same information as a 2-D pie chart.</p>
</div>

<h3>Example</h3>

<p>We want to find the proportion of types "Grass", "Fire", "Water" and "Bug". in generation 1 Pokemon and compare it to the proportions in generation 2.</p>
...
<div class="w3-example">
  ...
  <ol><li>Select the range <code class="w3-codespan">A1:C5</code></li></ol>
  <p><img src="img_excel_chart_intro_26.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<ol start="2"><li>Click on the <strong>Insert</strong> menu, then click on the Pie menu (<img src="img_excel_pie_menu.png" width="30" height="40" style="border: 1px solid rgb(220, 220, 220)">) and choose <strong>Doughnut</strong> (<img src="img_excel_chart_pie_icon_2.png" width="30" height="30" style="border: 1px solid rgb(220, 220, 220)">) from the drop-down menu</li></ol>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> This menu is accessed by <a href="https://www.w3schools.com/excel/excel_formatting.php">expanding the ribbon</a>.</p>
</div>

<p><img src="img_excel_chart_pie_3.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<p>Following the steps above, you will get the following chart:</p>
<p><img src="img_excel_chart_pie_4.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<p>The chart gives a visual overview of the number of 1st and 2nd generation Grass, Fire, Water and Bug type Pokemon.</p>

<p>Generation 1 Pokemon are shown in the inner circle and generation 2 Pokemon are shown in the outer circle.</p>

<p>Type "Grass" is shown in blue, "Fire" in orange, "Water" in gray and "Bug" in yellow.</p>

<p>This chart shows that "Water" type Pokemon are the most common in both generations.</p>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> The chart can be customized by adding labels. This can make it easier to understand the differences between different categories.</p>
</div>


<div class="w3-panel ws-warning">
  <p><strong>Note:</strong> Based on this chart, you cannot say which generation has more Pokemon.</p>
</div>
<hr>
