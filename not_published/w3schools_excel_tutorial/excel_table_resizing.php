...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_table_design.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_table_removing_duplicates.php">Next &#10095;</a>
</div>
...
<p>The size of a table can be changed.</p>

<p>Resizing is to increase or decrease the range of the table.</p>

<p>There are three ways to resize a table</p>
<hr>
...
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> Resizing will continue formatting and formulas. This will be covered in a later chapter.</p>
</div>

<hr>

<h2>Resize Table Command</h2>

<p>The resize table command allows you to change the size of the table by entering a range.</p>

<p>For example by entering <code class="w3-codespan">A1:D10</code>.</p>

<p>The command is found in the Ribbon under the Table Design tab.</p>

<p><img src="img_excel_tables_9.png" style="max-width:100%;"></p>

<h3>Example - Resizing a Table</h3>

<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate" style="position:relative">
  <img src="img_excel_tables_10.png" style="max-width:100%;">
  <textarea id="demo_img_excel_tables_10" style="display:none">
  ...
  <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_img_excel_tables_10')" title="Copy values to clipboard">Copy</button>
  </div>
<p>
</p>
</div>

<p>Convert the range into a table.</p>

<p>Lets resize the table from range <code class="w3-codespan">A1:F12</code> to <code class="w3-codespan">A1:F20</code></p>
<p><img src="img_excel_tables_11.png" style="max-width:100%;"></p>

<ol start="1"><li>Select the table</li></ol>
<ol start="2"><li>Click the Table Design menu</li></ol>
<p><img src="img_excel_tables_9.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<ol start="3"><li>Click the Resize Table command (<img src="img_excel_tables_12.png" width="90" height="30"  style="border: 1px solid rgb(220, 220, 220)">)</li></ol>

<p>Clicking the Resize Table command allows you to set a new range for the table.</p>

<ol start="4"><li>Click the range input field</li></ol>
<ol start="5"><li>Type the new range, <code class="w3-codespan">A1:F20</code></li></ol>
<p><img src="img_excel_tables_13.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<ol start="6"><li>Click OK</li></ol>
<p><img src="img_excel_tables_14.png" style="max-width:100%;"></p>


<p><strong>Great!</strong> The table has been resized to from <code class="w3-codespan">A1:F12</code> to <code class="w3-codespan">A1:F20</code>.</p>
...
<p>The table can be resized by dragging its corner.</p>
<p><img src="img_excel_tables_15.png" style="max-width:100%;"></p>

<h3>Example - Dragging to Resize, Smaller</h3>

<p>Change the tables size from <code class="w3-codespan">A1:F12</code> to <code class="w3-codespan">A1:D5</code></p>
<p><img src="img_excel_tables_16.png" style="max-width:100%;"></p>

<ol start="1"><li>Press and hold the bottom right corner of the table (<img src="img_excel_tables_42.png" style="max-width:100%;border: 1px solid rgb(220, 220, 220)">)</li></ol>
<ol start="2"><li>Move the pointer, marking the range <code class="w3-codespan">A1:D5</code></li></ol>
<p><img src="img_excel_tables_17.png" style="max-width:100%;"></p>

<p>The table range has been changed from <code class="w3-codespan">A1:F12</code> to <code class="w3-codespan">A1:D5</code>.</p>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> Cells outside of the table range are no longer included in the table. The connection between the cells created by the table is broken and they no longer have the table formatting.</p>
</div>
<p>Let's try to sort the Pokemon by their names to see what happens.</p>

<ol start="1"><li>Click the filter option in <code class="w3-codespan">A1</code></li></ol>
<ol start="2"><li>Sort by Ascending (A-Z)</li></ol>
<p><img src="img_excel_tables_18.png" style="max-width:100%;"></p>
<p><img src="img_excel_tables_19.png" style="max-width:100%;"></p>

<p>The filter option only includes the Pokemon in the tables range (<code class="w3-codespan">A1:A5</code>). The connection to the cells outside of the table is broken.</p>

<p>Lets resize again, this time bigger.</p>

<h3>Example - Dragging to Resize, Bigger</h3>

<p>Change the tables size from <code class="w3-codespan">A1:D5</code> to <code class="w3-codespan">A1:G13</code></p>

<ol start="1"><li>Press and hold the bottom right corner of the table (<img src="img_excel_tables_42.png" style="max-width:100%;border: 1px solid rgb(220, 220, 220)">)</li></ol>
<ol start="2"><li>Move the pointer to mark <code class="w3-codespan">A1:G13</code></li></ol>

<p><img src="img_excel_tables_20.png" style="max-width:100%;"></p>

<p>The table range has been changed from <code class="w3-codespan">A1:D5</code> to <code class="w3-codespan">A1:G13</code>. </p>

<p>The rest of the cells are now included again, and the connection between the cells is back.</p>

<p>Let's try to filter the Pokemon by their names to see what happens.</p>

<ol start="1"><li>Click the filter option in <code class="w3-codespan">A1</code></li></ol>
<ol start="2"><li>Sort by Ascending (A-Z)</li></ol>
<p><img src="img_excel_tables_20.png" style="max-width:100%;"></p>

<p><strong>Nice!</strong> The table has successfully sorted the Pokemon in the range <code class="w3-codespan">A1:A12</code> by their names. </p>

<p><strong>Oh wait. Something has changed. A new column (<code class="w3-codespan">G</code>) has appeared...</strong></p>

<p><img src="img_excel_tables_22.png" style="max-width:100%;"></p>

<p>Increasing the table size will continue the formatting, formulas and add new columns.</p>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong>  It  will not overwrite the name for existing headers. It will use the value that is typed in the header cell.</p>
</div>

<p>The header name can be changed.</p>

<ol start="1"><li>Double click <code class="w3-codespan">G1</code></li></ol>
<ol start="2"><li>Delete the text</li></ol>
<ol start="3"><li>Type "Mighty" to  <code class="w3-codespan">G1</code></li></ol>

<p><img src="img_excel_tables_23.png" style="max-width:100%;"></p>

<h3>Another Example - Resize By Adding Columns</h3>

<p>The table is automatically increased when new headers next to the table are added.</p>

<ol>
  <li>Type "Mew" to  <code class="w3-codespan">H1</code></li>
  <li>Hit enter</li>
  <li>Type "Two" to <code class="w3-codespan">I1</code></li>
  <li>Hit enter</li>
</ol>

<p><img src="img_excel_tables_21.png" style="max-width:100%;"></p>

<p>New columns with appropriate rows are automatically added when new headers are typed.</p>

<p>In the next chapter you will learn about removing duplicates.</p>
