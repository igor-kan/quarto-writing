<!DOCTYPE html>
<html lang="en-US">
<head><title>Excel Conditional Formatting - Top/Bottom Rules</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_cf_duplicate_unique.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_cf_above_below_average.php">Next &#10095;</a>
</div>
<hr>
<h2>Top/Bottom Rules</h2>
<p>Top/Bottom Rules are premade types of conditional formatting in Excel used to change the appearance of cells in a range based on your specified <strong>conditions</strong>.</p>
<p>Here is the Top/Bottom Rules part of the conditional formatting menu:</p>
<p><img src="img_excel_tbr_menu.png"  style="max-width:100%"></p>
<hr>
<h2>Appearance Options</h2>
<p>The web browser version of Excel offers the following appearance options for conditionally formatted cells:</p>
<ul>
...
<p>Here is how the options look in a spreadsheet:</p>
<p><img src="img_excel_hcr_options.png" style="max-width:100%"></p>
<hr>
<h2>Top/Bottom 10 Items Example</h2>
<p>The &quot;Top 10 Items...&quot; and &quot;Bottom 10 Items...&quot; rules will highlight cells with one of the appearance options based on the cell value being the top or bottom values in a range.</p>
<div class="w3-panel ws-note">
    <p><strong>Note:</strong> The default number of items is 10, but you can specify any whole number up to 1000 for Top/Bottom Items to be highlighted.</p>
</div>
<div class="w3-example">
    <h3>Example</h3>
    <div class="w3-code notranslate" style="position:relative">
    <img src="img_excel_cf_tbr.png" style="max-width:100%">
    <textarea id="demo_excel_tbr" style="display:none">
        Name	Type 1	Speed
        Bulbasaur	Grass	45
        Ivysaur	Grass	60
        Venusaur	Grass	80
    ...
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_tbr')" title="Copy values to clipboard">Copy</button>
    </div>
</div>
<p>You can <a href="excel_ranges.php">choose any range</a> for where the Highlight Cell Rule should apply. It can be a few cells, a single column, a single row, or a combination of multiple cells, rows and columns.</p>
<p>Let's first apply the <strong>Top 10 Items...</strong> rule to the Speed values.</p>
<p>&quot;Top 10 Items...&quot; Rule, step by step:</p>
<ol>
    <li>Select the range <code class="w3-codespan">C2:C31</code> for Speed values</li>
</ol>
<p><img src="img_excel_cf_tbr2.png" style="max-width:100%"></p>
<ol start="2">
    <li>Click on the Conditional Formatting icon <img src="img_excel_cf_icon.png" style="max-width:100%"> in the ribbon, from <strong>Home</strong> menu</li>
    <li>Select <strong>Top/Bottom Rules</strong> from the drop-down menu</li>
    <li>Select <strong>Top 10 Items...</strong> from the menu</li>
</ol>
<p><img src="img_excel_tbr_t10_menu.png"  style="max-width:100%"></p>
<p>This will open a dialog box where you can specify the value and the appearance option.</p>
<ol start="5">
    <li>Leave the default value <code class="w3-codespan">10</code> in the input field</li>
    <li>Select the appearance option &quot;Green Fill with Dark Green Text&quot; from the dropdown menu</li>
</ol>
<p><img src="img_excel_cf_tbr3.png" style="max-width:100%"></p>
<p>Now, the 10 cells with the top values will be highlighted in green:</p>
<p><img src="img_excel_cf_tbr4.png" style="max-width:100%"></p>
<p><strong>Great! Now, the top 10 Speed values are easily identified.</strong></p>
<p>Let's try the same with the bottom 10 Speed values.</p>
<div class="w3-panel ws-info">
    <p><strong>Note:</strong> Multiple rules can be applied to the same range.</p>
</div>
<p>Repeat the steps, but instead choose <strong>Bottom 10 Items...</strong> in the menu and select the &quot;Light Red Fill with Dark Red Text&quot; appearance option.</p>
<p>Now, the slowest values are also highlighted:</p>
<p><img src="img_excel_cf_tbr5.png" style="max-width:100%"></p>
<p>Notice that there are actually 11 items highlighted in red. Why could this be?</p>
<p>Let's <a href="excel_sort.php">sort the table</a> with descending Speed values for a clue:</p>
<p><img src="img_excel_cf_tbr6.png" style="max-width:100%"></p>
<p>We can see that both Pidgey and Nidorina have a Speed of 56. So, they are tied for the 10th bottom value.</p>
<div class="w3-panel ws-note">
    <p><strong>Note:</strong> When using the <strong>Top/Bottom 10...</strong> conditional formatting, values that tie will <strong>all</strong> be highlighted.</p>
</div>
<hr>
...
<h2>Top/Bottom 10&#37; Example</h2>
<p>The &quot;Top 10&#37;...&quot; and &quot;Bottom 10&#37;...&quot; rules will highlight cells with one of the appearance options based on the cell value being the top or bottom <strong>percent of values</strong> in a range.</p>
<div class="w3-panel ws-note">
    <p><strong>Note:</strong> The default percent of items is 10, but you can specify any whole number up to 100 for Top/Bottom Percent to be highlighted.</p>
</div>
<p>Let's apply Top and Bottom 10&#37; rules to the same dataset with sorted Speed values:</p>
<div class="w3-example">
    <h3>Example</h3>
    <div class="w3-code notranslate" style="position:relative">
    <img src="img_excel_cf_tbr7.png" style="max-width:100%">
    <textarea id="demo_excel_tbr2" style="display:none">
        Name	Type 1	Speed
        Raichu	Electric	110
        Pidgeot	Normal	101
        Charizard	Fire	100
    ...
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_tbr2')" title="Copy values to clipboard">Copy</button>
    </div>
</div>
<p>You can <a href="excel_ranges.php">choose any range</a> for where the Highlight Cell Rule should apply. It can be a few cells, a single column, a single row, or a combination of multiple cells, rows and columns.</p>
<p>Let's first apply the <strong>Bottom 10&#37;...</strong> rule to the Speed values.</p>
<p>&quot;Bottom 10&#37;...&quot; Rule, step by step:</p>
<ol>
    <li>Select the range <code class="w3-codespan">C2:C31</code> for Speed values</li>
</ol>
<p><img src="img_excel_cf_tbr8.png" style="max-width:100%"></p>
<ol start="2">
    <li>Click on the Conditional Formatting icon <img src="img_excel_cf_icon.png" style="max-width:100%"> in the ribbon, from <strong>Home</strong> menu</li>
    <li>Select <strong>Top/Bottom Rules</strong> from the drop-down menu</li>
    <li>Select <strong>Bottom 10&#37;...</strong> from the menu</li>
</ol>
<p><img src="img_excel_tbr_b10p_menu.png"  style="max-width:100%"></p>
<p>This will open a dialog box where you can specify the value and the appearance option.</p>
<ol start="5">
    <li>Leave the default value <code class="w3-codespan">10</code> in the input field</li>
    <li>Select the appearance option &quot;Light Red Fill with Dark Red Text&quot; from the dropdown menu</li>
</ol>
<p><img src="img_excel_cf_tbr9.png" style="max-width:100%"></p>
<p>Now, the bottom 10&#37; of cells will be highlighted in red:</p>
<p><img src="img_excel_cf_tbr10.png" style="max-width:100%"></p>
<p><strong>Notice that there are 3 highlighted cells.</strong></p>
<p>There are 30 cells in the range, so 10&#37; of that is 3 cells.</p>
<div class="w3-panel ws-note">
    <p><strong>Note:</strong> The number of cells will be rounded <strong>down</strong> to the closest whole number based on the percent.</p>
    <p>For example:</p>
    <ul>
        <li>6&#37; of 30 is 1.8, which will be rounded <strong>down</strong> to 1 cell</li>
        <li>7&#37; of 30 is 2.1, which will be rounded <strong>down</strong> to 2 cells</li>
    </ul>
</div>
<p>Let's try the same with the top 10&#37; Speed values.</p>
<p>Repeat the steps, but instead choose <strong>Top 10&#37;...</strong> in the menu and select the &quot;Green Fill with Dark Green Text&quot; appearance option.</p>
<p>Now, the fastest values are also highlighted:</p>
<p><img src="img_excel_cf_tbr11.png" style="max-width:100%"></p>
<p>Notice that there are actually 4 items highlighted in green.</p>
<p>We can see that both Charizard and Fearow have a Speed of 100. So, they are tied for the 3rd top value.</p>
<p>Both are included in the top 10&#37; and are highlighted.</p>
<div class="w3-panel ws-note">
    <p><strong>Note:</strong> You can remove the Highlight Cell Rules with <a href="excel_cf_manage_rules.php">Manage Rules</a>.</p>
</div>
<hr>
