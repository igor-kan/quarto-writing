...
<html lang="en-US">
<head>
<title>Excel MODE Function</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>Excel <span class="color_h1">MODE Function</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_min.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_npv.php">Next &#10095;</a>
</div>
<hr>

<h2>MODE Function</h2>

<p>The <strong>MODE</strong> function is a premade function in Excel, which is used to find the number seen most times.</p>
<p>This function always returns a single number.</p>
<p>It is typed <code class="w3-codespan">=MODE.SNGL</code></p>
<p>It returns the most occurring number in a range or array.</p>
<div class="ws-note w3-panel">
<p><strong>Note:</strong> The mode is a type of average value, which describes where most of the data is located. You can read more about mode in our: <a href="https://www.w3schools.com/statistics/statistics_mode.php">Statistics Mode Tutorial</a>.</p>
</div>

<p>Let's have a look at an example where we help the Pokemon trainers to calculate the mode of numbers of Pokeballs. </p>


<p>How to use the <code class="w3-codespan">=MODE</code> function, step by step:</p>
<ol>
<li>Select a cell (<code class="w3-codespan">B10</code>)</li>
<li>Type <code class="w3-codespan">=MODE</code></li>
<li>Double click the <strong>MODE.SNGL</strong> command</li>
<li>Select a range (<code class="w3-codespan">B2:E7</code>)</li>
<li>Hit enter</li>
</ol>
<div class="w3-example">
    <div class="w3-code notranslate" style="position:relative">
    <img src="mode1.png" style="max-width:100%">
    <textarea id="demo_excel_mode" style="display:none">
    ...
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_mode')" title="Copy values to clipboard">Copy</button>
    </div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_mode">Try it Yourself &raquo;</a>
</p>
</div>

<p><img src="mode2.png" style="max-width:100%"></p>
<p><img src="mode3.png" style="max-width:100%"></p>
<hr>

<p><img src="mode4.png" style="max-width:100%"></p>
<div class="w3-example">
<div class="w3-code notranslate" style="position:relative">
<img src="mode5.png" style="max-width:100%">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_mode_finished">Try it Yourself &raquo;</a>
</p>
</div>

<p>It returns the number <code class="w3-codespan">1</code> which is seen 7x times. The closest number to it is <code class="w3-codespan">3</code> and <code class="w3-codespan">4</code> which are seen 3x times each.</p>
