<!DOCTYPE html>
<html lang="en-US">
<head><title>Excel Column Charts</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Excel Column Charts</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_charts_stacked.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_charts_cols_stacked.php">Next &#10095;</a>
</div>
...
<p>Column charts show the data as vertical bars.</p>

<p><img src="img_excel_chart_intro_1.svg" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>


<p>Column charts are suited for representing values of <strong>qualitative</strong> (<strong>categorical</strong>) data.</p>
...
<p>Excel has three different types of column charts:</p>

<ul>
  <li>Clustered column(<img src="img_excel_chart_intro_20.png" width="30" height="30" style="border: 1px solid rgb(220, 220, 220)">)</li>
  <li>Stacked column(<img src="img_excel_chart_intro_21.png" width="30" height="30" style="border: 1px solid rgb(220, 220, 220)">)</li>
  <li>100% Stacked column(<img src="img_excel_chart_intro_22.png" width="30" height="30" style="border: 1px solid rgb(220, 220, 220)">)</li>
</ul>
...
<p>Clustered Column charts are used when the value of data is important but the order is not.</p>
...
<p><img src="img_excel_chart_column_1.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>
...
<p><strong>Nicely Done!</strong> Following the steps above will give you the chart below.</p>
<p><img src="img_excel_chart_intro_25.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>
...
<p><img src="img_excel_chart_column_2.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<p>You should get the chart below:</p>

<p><img src="img_excel_chart_intro_27.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>
...
<p>Also, there are more Pokemons in generation 1 than 2.<p>
