<!DOCTYPE html>
<html lang="en-US">
<head><title>Excel Highlight Cell Rules - Greater Than</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Excel HCR - Greater Than</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_highlight_cell_rules.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_cf_less_than.php">Next &#10095;</a>
</div>
<hr>
<h2>Highlight Cell Rules - Greater Than</h2>
...
<p></p>
<p><strong>Greater Than...</strong> is one of the options for the condition.</p>
...
<hr>
<h2>Highlight Cell Rule - Greater Than Example</h2>
<p>The &quot;Greater Than...&quot; Highlight Cell Rule will highlight a cell with one of the appearance options based on the cell value being <strong>greater than</strong> to your specified value.</p>
<p>The specified value is typically a number, but it also works with a text value.</p>
<p>In this example, the specified value will be &quot;65&quot;.</p>
...
<p>Let's apply the rule to the HP values.</p>
<p>&quot;Greater Than...&quot; Highlight Cell Rule, step by step:</p>
<ol>
    <li>Select the range <code class="w3-codespan">C2:C8</code> for HP values</li>
</ol>
<p><img src="img_excel_cf_gt.png" style="max-width:100%"></p>
<ol start="2">
    ...
    <li>Select <strong>Greater Than...</strong> from the menu</li>
</ol>
<p><img src="img_excel_hcr_gt_menu.png" style="max-width:100%"></p>
<p>This will open a dialog box where you can specify the value and the appearance option.</p>
<ol start="5">
    <li>Enter <code class="w3-codespan">65</code> into the input field</li>
    <li>Select the appearance option &quot;Green Fill with Dark Green Text&quot; from the dropdown menu</li>
</ol>
<p><img src="img_excel_cf_gt2.png" style="max-width:100%"></p>
<p>Now, the cells with values greater than &quot;65&quot; will be highlighted in green:</p>
<p><img src="img_excel_cf_gt3.png" style="max-width:100%"></p>
<p>Gyarados, Lapras and Vaporeon have HP values greater than 65, so they are highlighted.</p>
<div class="w3-panel ws-note">
    <p><strong>Note:</strong> Jolteon's HP value is 65, but is not highlighted, since the rule does not include the specified value itself.</p>
</div>
<div class="w3-panel ws-note">
...
<h2>Highlight Cell Rule - Greater Than Example (with Text)</h2>
<p>The &quot;Greater Than...&quot; Highlight Cell Rule also works with text values.</p>
<p>Excel will use alphabetical order (A-Z) to highlight the text values that start with a letter that is <strong>later</strong> in the alphabet than the specified value.</p>
<p>In this example, the specified text value will be &quot;Gyarados&quot;.</p>
<div class="w3-example">
    <h3>Example</h3>
    <div class="w3-code notranslate" style="position:relative">
    <img src="img_excel_hcr_intro.png" style="max-width:100%">
...
<p>&quot;Greater Than...&quot; Highlight Cell Rule, step by step:</p>
<ol>
    <li>Select the range <code class="w3-codespan">A2:A8</code> for Name values</li>
</ol>
<p><img src="img_excel_cf_gt4.png" style="max-width:100%"></p>
<ol start="2">
    <li>Click on the Conditional Formatting icon <img src="img_excel_cf_icon.png" style="max-width:100%"> in the ribbon, from <strong>Home</strong> menu</li>
    <li>Select <strong>Highlight Cell Rules</strong> from the drop-down menu</li>
    <li>Select <strong>Greater Than...</strong> from the menu</li>
...
<p>This will open a dialog box where you can specify the value and the appearance option.</p>
<ol start="5">
    <li>Enter <code class="w3-codespan">Gyarados</code> into the input field</li>
    <li>Select the appearance option &quot;Yellow Fill with Dark Yellow Text&quot; from the dropdown menu</li>
</ol>
<p><img src="img_excel_cf_gt5.png" style="max-width:100%"></p>
<p>Now, the cells with text values <strong>later</strong> in the alphabet than &quot;Gyarados&quot; will be highlighted in yellow:</p>
<p><img src="img_excel_cf_gt6.png" style="max-width:100%"></p>
<p>Magikarp starts with &quot;M&quot;, Lapras with &quot;L&quot;, Vaporeon with &quot;V&quot;, and Jolteon with &quot;J&quot;.</p>
<p>&quot;M&quot;,  &quot;L&quot;, &quot;V&quot;, and &quot;J&quot; are all <strong>later</strong> in the alphabet than &quot;G&quot;, which Gyarados starts with, so these all are highlighted.</p>
<p><strong>But, what about the rest of the letters in the text value?</strong></p>
<p>Let's see what happens if we add a fictional pokemon with a new name:</p>
<p><img src="img_excel_cf_gt7.png" style="max-width:100%"></p>
<p>Notice that the fictional &quot;Gzarados&quot; is highlighted.</p>
<p>The Excel condition checks each letter in the specified text value from left to right.</p>
<p>Because the &quot;z&quot; in &quot;G<strong>z</strong>arados&quot; comes <strong>later</strong> in the alphabet than the &quot;y&quot; in &quot;G<strong>y</strong>arados&quot;, this is considered <strong>Greater Than</strong> and is highlighted.</p>
<hr>
