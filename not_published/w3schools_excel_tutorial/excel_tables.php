...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_filter.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_table_design.php">Next &#10095;</a>
</div>
...
<p>Ranges can be converted into tables.</p>

<p>Tables make it easier to structure and organize data.</p>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> The filter function is similar to a table. The filter can be better used if the only function needed is to sort and filter data.</p>
</div>

<p>Tables connect cells in a range and put it into a fixed structure.</p>

<p>The cells in the table range share the same formatting.</p>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> Tables can be used to prepare data for charts and pivot tables.</p>
</div>

<p>Tables allow for options such as:</p>
...
<div class="w3-panel ws-info">
  <p><strong>Note:</strong> Tables can be <a href="excel_convert_table_to_range.php">converted back to range</a>.</p>
</div>

<h3>Example</h3>

<p>Formatting a range into a table will give it a new form with a fixed structure. Tables open access to new functionality such as: filtering, automations and styling.</p>

<p><img src="img_excel_tables_1.png" style="max-width:100%;"></p>

<h3>Example (Converting a Range to Table)</h3>

<p>How to convert range to table, step by step.</p>
...
<div class="w3-example">
  ...
  <img src="img_excel_tables_2.png" style="max-width:100%;">
  <textarea id="demo_img_excel_tables_2" style="display:none">
    ...
    SlowbroMega Slowbro	Water	Psychic	95	75	110
    Magnemite	Electric	Steel	25	35	70
    Magneton	Electric	Steel	50	60	95
    Farfetch'd	Normal	Flying	52	65	55
  </textarea>
  <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_img_excel_tables_2')" title="Copy values to clipboard">Copy</button>
  </div>
<p>
</p>
</div>
...
<ol start="1"><li>Select range <code class="w3-codespan">A1:F22</code></li></ol>
<p><img src="img_excel_tables_3.png" style="max-width:100%;"></p>

<ol start="2"><li>Click <strong>Insert</strong>, then Table (<img src="img_excel_table_menu.png" width="70" height="30" style="border: 1px solid rgb(220, 220, 220)">), in the Ribbon.</li></ol>
<p><img src="img_excel_tables_4.png" style="max-width:100%;"></p>

<ol start="3"><li>Click OK</ol>
<p><img src="img_excel_tables_5.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> The range (<code class="w3-codespan">A1:F22</code>) already has headers in row 1. Unchecking the "My table has headers" option allows you to create a dedicated header if you do not already have it.</p>
</div>

<p><img src="img_excel_tables_6.png" style="max-width:100%;"></p>

<p><strong>Good job!</strong> The range <code class="w3-codespan">A1:F22</code> was successfully converted from range to table.</p>

<p>The range is now a fixed table structure and new options such as sorting and filtering are now enabled.</p>

<p>Applying the filter keeps the relationship between the columns while sorting and filtering.</p>

<div class="w3-panel ws-info">
  <p><strong>Note:</strong> Read more about <a href="excel_filter.php">Filtering</a> and <a href="excel_sort.php">Sorting</a> in previous chapters.</p>
</div>

<p>In the next chapter you will learn about Table Design.</p>
