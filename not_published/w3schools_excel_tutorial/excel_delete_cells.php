...
<html lang="en-US">
<head>
<title>Excel Delete Cells</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>Excel <span class="color_h1">Delete Cells</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_add_cells.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_undo_redo.php">Next &#10095;</a>
</div>
<hr>
...
<img src="delete.png" style="max-width:100%">
<p>Pressing the delete button:</p>
<img src="delete_1.png" style="max-width:100%">
<hr>
<h3>Example 2</h3>

<img src="delete_2.png" style="max-width:100%">
<p>Pressing the delete button:</p>
<img src="delete_3.png" style="max-width:100%">
...
<p>With formatting:</p>
<img src="delete_4.png" style="max-width:100%">
<p>Pressing the delete button:</p>

<img src="delete_5.png" style="max-width:100%">
...
<div>
<form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_add_cells2" method="post" target="_blank">
<h2>Test Yourself With Exercises</h2>
<div class="exercisewindow">
<h2>Excel Exercise:</h2>
<p>Complete the name of the <strong>command </strong>for removing columns:</p>
...
<p><a target="_blank" href="exercise.php?filename=exercise_add_cells2">Start the Exercise</a></p>
</div>
</form>
</div>
