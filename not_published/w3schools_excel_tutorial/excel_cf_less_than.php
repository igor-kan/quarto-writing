<!DOCTYPE html>
<html lang="en-US">
<head><title>Excel Highlight Cell Rules - Less Than</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Excel HCR - Less Than</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_cf_greater_than.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_cf_equal_to.php">Next &#10095;</a>
</div>
<hr>
<h2>Highlight Cell Rules - Less Than</h2>
<p>Highlight Cell Rules is a premade type of conditional formatting in Excel used to change the appearance of cells in a range based on your specified <strong>conditions</strong>.</p>
<p></p>
<p><strong>Less Than...</strong> is one of the options for the condition.</p>
<p>Here is the Highlight Cell Rules part of the conditional formatting menu:</p>
<p><img src="img_excel_hcr_menu.png" style="max-width:100%"></p>
<hr>
<h2>Highlight Cell Rule - Less Than Example</h2>
<p>The &quot;Less Than...&quot; Highlight Cell Rule will highlight a cell with one of the appearance options based on the cell value being <strong>less than</strong> to your specified value.</p>
<p>The specified value is typically a number, but it also works with a text value.</p>
<p>In this example, the specified value will be &quot;55&quot;.</p>
<div class="w3-example">
    <h3>Example</h3>
    <div class="w3-code notranslate" style="position:relative">
    <img src="img_excel_hcr_intro.png" style="max-width:100%">
    <textarea id="demo_excel_hcr_intro" style="display:none">
        Name	Type 1	HP	Attack	Defense	Sp. Atk	Sp. Def	Speed
        Magikarp	Water	20	10	55	15	20	80
        Gyarados	Water	95	125	79	60	100	81
        Lapras	Water	130	85	80	85	95	60
    ...
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_hcr_intro')" title="Copy values to clipboard">Copy</button>
    </div>
</div>
...
<p>Let's apply the rule to the Attack values.</p>
<p>&quot;Less Than...&quot; Highlight Cell Rule, step by step:</p>
<ol>
    <li>Select the range <code class="w3-codespan">D2:D8</code> for Attack values</li>
</ol>
<p><img src="img_excel_cf_lt.png" style="max-width:100%"></p>
<ol start="2">
    ...
    <li>Select <strong>Highlight Cell Rules</strong> from the drop-down menu</li>
    <li>Select <strong>Less Than...</strong> from the menu</li>
</ol>
<p><img src="img_excel_hcr_lt_menu.png" style="max-width:100%"></p>
<p>This will open a dialog box where you can specify the value and the appearance option.</p>
<ol start="5">
    <li>Enter <code class="w3-codespan">55</code> into the input field</li>
    <li>Select the appearance option &quot;Light Red Fill with Dark Red Text&quot; from the dropdown menu</li>
</ol>
<p><img src="img_excel_cf_lt2.png" style="max-width:100%"></p>
<p>Now, the cells with values less than &quot;55&quot; will be highlighted in red:</p>
<p><img src="img_excel_cf_lt3.png" style="max-width:100%"></p>
<p>Only Magikarp and Ditto have Attack values less than 55, so these values are highlighted.</p>
<div class="w3-panel ws-note">
    <p><strong>Note:</strong> Eevees's Attack value is 55, but is not highlighted, since the rule does not include the specified value itself.</p>
</div>
<div class="w3-panel ws-note">
...
<h2>Highlight Cell Rule - Less Than Example (with Text)</h2>
<p>The &quot;Less Than...&quot; Highlight Cell Rule also works with text values.</p>
<p>Excel will use alphabetical order (A-Z) to highlight the text values that start with a letter that is <strong>earlier</strong> in the alphabet than the specified value
    <p>In this example, the specified text value will be &quot;Electric&quot;.</p>
<div class="w3-example">
    <h3>Example</h3>
    <div class="w3-code notranslate" style="position:relative">
    <img src="img_excel_hcr_intro.png" style="max-width:100%">
...
<p>You can <a href="excel_ranges.php">choose any range</a> for where the Highlight Cell Rule should apply. It can be a few cells, a single column, a single row, or a combination of multiple cells, rows and columns.</p>
<p>Let's apply the rule to the Type 1 values.</p>
<p>&quot;Less Than...&quot; Highlight Cell Rule, step by step:</p>
<ol>
    <li>Select the range <code class="w3-codespan">B2:B8</code> for Type 1 values</li>
</ol>
<p><img src="img_excel_cf_lt4.png" style="max-width:100%"></p>
<ol start="2">
    <li>Click on the Conditional Formatting icon <img src="img_excel_cf_icon.png" style="max-width:100%"> in the ribbon, from <strong>Home</strong> menu</li>
    <li>Select <strong>Highlight Cell Rules</strong> from the drop-down menu</li>
    <li>Select <strong>Less Than...</strong> from the menu</li>
...
<p>This will open a dialog box where you can specify the value and the appearance option.</p>
<ol start="5">
    <li>Enter <code class="w3-codespan">Electric</code> into the input field</li>
    <li>Select the appearance option &quot;Yellow Fill with Dark Yellow Text&quot; from the dropdown menu</li>
</ol>
<p><img src="img_excel_cf_lt5.png" style="max-width:100%"></p>
<p>Now, the cells with text values earlier in the alphabet than &quot;Electric&quot; will be highlighted in yellow:</p>
<p><img src="img_excel_hcr_intro.png" style="max-width:100%"></p>
<p><strong>Nothing seems to have changed!</strong></p>
<p>Water starts with &quot;W&quot; and Normal starts with &quot;N&quot;.</p>
<p>&quot;W&quot;and &quot;N&quot; are all <strong>later</strong> in the alphabet than &quot;E&quot;, which Electric starts with, so <strong>none</strong> of these are highlighted.</p>
<div class="w3-panel ws-note">
    <p><strong>Note:</strong> The specified value &quot;Electric&quot; itself is also <strong>not highlighted</strong>, because the rule only highlights text values that are earlier in the alphabet.</p>
</div>
<p><strong>So, what about the rest of the letters in the text value?</strong></p>
<p>Let's see what happens if we add a fictional pokemon with a new Name and Type:</p>
<p><img src="img_excel_cf_lt7.png" style="max-width:100%"></p>
<p>Notice that the fictional &quot;Ficteon&quot; has the type &quot;Eclectic&quot;, which is highlighted.</p>
<p>The Excel condition checks each letter in the specified text value from left to right.</p>
<p>Because the &quot;c&quot; in &quot;E<strong>c</strong>lectic&quot; comes <strong>earlier</strong> in the alphabet than the &quot;l&quot; in &quot;E<strong>l</strong>ectric&quot;, this is considered <strong>Less Than</strong> and is highlighted.</p>
