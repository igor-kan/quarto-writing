...
<html lang="en-US">
<head>
<title>Excel MEDIAN Function</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>Excel <span class="color_h1">MEDIAN Function</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_max.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_min.php">Next &#10095;</a>
</div>
<hr>

<h2>MEDIAN Function</h2>

<p>The <strong>MEDIAN</strong> function is a premade function in Excel, which returns the middle value in the data.</p>
<p>It is typed <code class="w3-codespan">=MEDIAN</code></p>
<div class="ws-note w3-panel">
<p><strong>Note:</strong> The median is a type of average value, which describes where the center of the data is located. You can learn about median in our <a href="https://www.w3schools.com/statistics/statistics_median.php">Statistics Median Tutorial</a>.</p>
</div>

<p>Calculating the median manually requires that the data is sorted and arranged from low to high. This is not necessary using the MEDIAN function, it does it for you.</p>

<p>How to use the <code class="w3-codespan">=MEDIAN</code> function, step by step:</p>
<ol>
<li>Select a cell (<code class="w3-codespan">H2</code>)</li>
<li>Type <code class="w3-codespan">=MEDIAN</code></li>
<li>Double click the <strong>MEDIAN</strong> command</li>
<li>Select a range (<code class="w3-codespan">A2:G2</code>)</li>
<li>Hit enter</li>
</ol>

<div class="w3-example">
<div class="w3-code notranslate" style="position:relative">
<img src="median1.png" style="max-width:100%">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_median">Try it Yourself &raquo;</a>
</p>
</div>
<p><img src="median3.png" style="max-width:100%"></p>
<hr>

<p><img src="median4.png" style="max-width:100%"></p>
<div class="w3-example">
<div class="w3-code notranslate" style="position:relative">
<img src="median5.png" style="max-width:100%">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_median_finished">Try it Yourself &raquo;</a>
</p>
</div>

<p><strong>Great!</strong> You successfully found the median using the <code class="w3-codespan">=MEDIAN</code> function.</p>

<p>Note that it found the value in the middle of the data, which is <code class="w3-codespan">D2(2)</code>, the one that is marked red:</p>
<p><img src="median6.png" style="max-width:100%"></p>
