<!DOCTYPE html>
<html lang="en-US">
<head><title>Excel Conditional Formatting - Manage Rules</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>Excel Manage Rules</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_cf_icon_sets.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_charts.php">Next &#10095;</a>
</div>
<hr>

<h2>Excel Manage Rules</h2>

<p>Conditional Formatting rules can be managed and removed using the <strong>Clear Rules</strong> and <strong>Manage Rules</strong> features.</p>
<p>Here is the Clear Rules part of the conditional formatting menu:</p>
<p><img src="img_excel_cf_clear_rules_menu.png"  style="max-width:100%"></p>
<p>You can remove all the rules from a <strong>selected range of cells</strong> or from the entire spreadsheet using the <strong>Clear Rules</strong> menu options.</p>
<hr>



<h2>Conditional Formatting - Manage Rules Example</h2>

<p>You can also use the <strong>Manage Rules</strong> menu option to clear conditional formatting rules.</p>
<p>Let's remove the <strong>Color Scale</strong> rule applied to all the Stat values:</p>
<p><img src="img_excel_cf_manage_rules.png" style="max-width:100%"></p>
<p>Select the range <code class="w3-codespan">C2:H9</code>.</p>
<p>Select <strong>Manage Rules</strong> option from the Conditional Formatting menu <img src="img_excel_cf_icon.png"  style="max-width:100%"> in the <strong>Home</strong> menu.</p>
<p><img src="img_excel_cf_manage_rules_menu.png"  style="max-width:100%"></p>
<p>This box will appear on the right-hand side of your spreadsheet:</p>
<p><img src="img_excel_cf_manage_rules_box.png"  style="max-width:100%"></p>
<p>This will show all the active rules that are applied to the selected range.</p>
<p>It will also indicate which cells the rule is applied to. Which, in this example, is <code class="w3-codespan">C2:H9</code>.</p>
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> In the web browswer version of Excel, the only thing that can be managed is removing the rules.</p>
</div>
<p><img src="img_excel_cf_manage_rules_box2.png"  style="max-width:100%"></p>
<p>Clicking on the recycling bin icon will remove a particular rule.</p>
<p><img src="img_excel_cf_manage_rules2.png"  style="max-width:100%"></p>
<p>Now, the cells no longer have conditional formatting.</p>
