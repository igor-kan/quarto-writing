...
<html lang="en-US">
<head>
<title>Excel MIN Function</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>Excel <span class="color_h1">MIN Function</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_median.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_mode.php">Next &#10095;</a>
</div>
<hr>

<h2>MIN Function</h2>

<p>The <strong>MIN</strong> function is a premade function in Excel, which finds the lowest number in a range.</p>
<p>It is typed <code class="w3-codespan">=MIN</code></p>
<div class="ws-note w3-panel">
<p>The function ignores cells with text. It will only work for cells with numbers.</p>
<p><strong>Note:</strong> There is another function called <a href="excel_max.php">MAX</a>, which finds the highest value in a range, the opposite of <strong>MIN</strong>.</p>
</div>


<p>How to use the <code class="w3-codespan">=MIN</code> function:</p>
<ol>
<li>Select a cell (<code class="w3-codespan">G5</code>)</li>
<li>Type <code class="w3-codespan">=MIN</code></li>
<li>Double click the <strong>MIN</strong> command</li>
...
<p>Find the Pokemon which has the lowest total stats in the range <code class="w3-codespan">D2:D21</code>:</p>
<div class="w3-example">
    <div class="w3-code notranslate" style="position:relative">
    <img src="min1.png" style="max-width:100%">
    <textarea id="demo_excel_min" style="display:none">
    Name	Type 1	Type 2	Total stats		
    Mankey	Fighting		305		
    Poliwrath	Water	Fighting	510		
    Victreebel	Grass	Poison	490		
    Tentacool	Water	Poison	335		
    Magneton	Electric	Steel	465		MIN
    ...
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_min')" title="Copy values to clipboard">Copy</button>
    </div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_min">Try it Yourself &raquo;</a>
</p>
</div>

<p><img src="min3.png" style="max-width:100%"></p>
...
<p><img src="min4.png" style="max-width:100%"></p>
<div class="w3-example">
<div class="w3-code notranslate" style="position:relative">
<img src="min5.png" style="max-width:100%">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_min_finished">Try it Yourself &raquo;</a>
</p>
</div>

<p><strong>Look at that!</strong> The function has successfully found the lowest value, <code class="w3-codespan">200</code>. Magikarp has the lowest Total stats of the Pokemons in the range <code class="w3-codespan">D2:D21</code>.</p>

<p>Let's add text to a cell in the range <code class="w3-codespan">D2:21</code> to see what happens. Type Kadabra to <code class="w3-codespan">D21</code>.</p>
<p><img src="min6.png" style="max-width:100%"></p>

<p><strong>Right on!</strong> The function ignores the text typed in the range. <code class="w3-codespan">253</code> is returned as the new lowest value, as the old one was replaced with text. Rattata is now the Pokemon with the lowest Total stats in the range <code class="w3-codespan">D2:D21</code>.</p>
