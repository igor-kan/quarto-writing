...
<html lang="en-US">
<head>
<title>Excel Format Fonts</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>Excel <span class="color_h1">Format Fonts</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_format_painter.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_format_borders.php">Next &#10095;</a>
</div>
<hr>

<h2>Format Fonts</h2>
<p>You can format fonts in four different ways: color, font name, size and other characteristics.</p>
<hr>

<h2>Font Color</h2>

<p>The default color for fonts is black.</p>

<p>Colors are applied to fonts by using the "<strong>Font color</strong>" function. </p>

<p>How to apply colors to fonts</p>
<ol>
<li>Select cell</li>
<li>Select font color</li>
<li>Type text</li>
</ol>
<p>The font color goes for both numbers and text. </p>

<p>The <strong>Font color</strong> command remembers the color used last time.</p>
<div class="ws-note w3-panel">
<p><strong>Note:</strong> Custom colors are applied in the same way for both cells and fonts. You can read more about it in the <a href="excel_format_colors.php">Apply colors to cells chapter</a>.</p>
</div>

<p>Lets try an example, step by step:</p>
<ol>
<li>Select standard font color Red</li>
<li>Type A1(Hello)</li>
<li>Hit enter</li>
<li>Select standard font color Green</li>
<li>Type B1(World!)</li>
<li>Hit enter</li>
</ol>

<p><img src="fonts1.png" style="max-width:100%"></p>
<p><img src="fonts2.png" style="max-width:100%"></p>
<p><img src="fonts3.png" style="max-width:100%"></p>
<p><img src="fonts4.png" style="max-width:100%"></p>
<hr>
...
<p>The default font in Excel is <strong>Calibri</strong>.</p>

<p>The font name can be changed for both numbers and text.</p>

<p>Why change the font name in Excel?</p>
<ul>
<li>Make the data easier to read</li>
<li>Make the presentation more appealing</li>
</ul>

<p>How to change the font name:</p>
<ol>
<li>Select a range</li>
<li>Click the font name drop down menu</li>
<li>Select a font</li>
</ol>
...
<ol>
<li>Select <code class="w3-codespan">A1:C4</code></li>
<li>Click the font name drop down menu</li>
<li>Select <strong>Arial</strong></li>
</ol>

<p>The example has both text (<code class="w3-codespan">A1:B1</code>) and numbers (<code class="w3-codespan">A4:C4</code>)</p>
<p><img src="fonts5.png" style="max-width:100%"></p>
<p><img src="fonts6.png" style="max-width:100%"></p>

<p><strong>Good job!</strong> You have successfully changed the fonts from <strong>Calibri </strong>to <strong>Arial </strong>for the range <code class="w3-codespan">A1:C4</code>. </p>
<p><img src="fonts7.png" style="max-width:100%"></p>
<hr>

<h2>Font Size</h2>
<p>To change the <strong>font size</strong> of the font, just click on the font size drop down menu:</p>

<p><img src="fontsize1.png" style="max-width:100%"></p>
<hr>

<h2>Font Characteristics</h2>
<p>You can apply different characteristics to fonts such as:</p>
<ul>
<li><strong>Bold</strong></li>
<li><i>Italic</i></li>
<li style="text-decoration:underline">Underlined</li>
<li style="text-decoration:line-through">Strike though</li>
</ul>

<p>The commands can be found below the font name drop down menu:</p>
<p><img src="fonts8.png" style="max-width:100%"></p>


<p><strong>Bold </strong>is applied by either clicking the Bold (B) icon in the Ribbon or using the keyboard shortcut CTRL + B or Command + B</p>
<p><em>Italic </em>is applied by either clicking the Italic (I) icon or using the keyboard shortcut CTRL + I or Command + I</p>
<p><span style="text-decoration:underline">Underline</span> is applied by either clicking the Underline (U) icon or using the keyboard shortcut CTRL + U or Command + U </p>
<p><span style="text-decoration:line-through">Strikethrough</span> is applied by either clicking the Strikethrough (ab) icon or using the keyboard shortcut CTRL + 5 or Command + Shift + X</p>
<hr>

<h2>Chapter Summary</h2>
<p>Fonts can be changed in four different ways: color, font name, size and other characteristics. The fonts are changed to make the spreadsheet more readable and delicate. </p>
<hr>
