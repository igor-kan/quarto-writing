...
<html lang="en-US">
<head>
<title>Excel COUNTA Function</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>Excel <span class="color_h1">COUNTA Function</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_count.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_countblank.php">Next &#10095;</a>
</div>
<hr>

<h2>COUNTA Function</h2>

<p>The <strong>COUNTA</strong> function is a premade function in Excel, which counts all cells in a range that has values, both numbers and letters.</p>
<p>It is typed <code class="w3-codespan">=COUNTA</code></p>
<p>How to use the <code class="w3-codespan">=COUNTA</code> function:</p>
<ol>
<li>Select a cell</li>
<li>Type <code class="w3-codespan">=COUNTA</code></li>
<li>Double click the <strong>COUNTA</strong> command</li>
...
<p>Apply the <code class="w3-codespan">=COUNTA</code> function to range <code class="w3-codespan">A2:A21</code>, counting Pokemons by their names, which are letters only:</p>
<div class="w3-example">
    <div class="w3-code notranslate" style="position:relative">
    <img src="counta1.png" style="max-width:100%">
    <textarea id="demo_excel_counta" style="display:none">
    ...
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_counta')" title="Copy values to clipboard">Copy</button>
    </div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_counta">Try it Yourself &raquo;</a>
</p>
</div>

<p><strong>COUNTA</strong> function, step by step:</p>
<ol>
<li>Select <code class="w3-codespan">A23</code></li>
<li>Type <code class="w3-codespan">=COUNTA</code></li>
<li>Double click <strong>COUNTA</strong> in the menu</li>
<li>Select range <code class="w3-codespan">A2:A21</code></li>
<li>Hit enter</li>
</ol>

<p><img src="counta3.png" style="max-width:100%"></p>
...
<p><img src="counta4.png" style="max-width:100%"></p>
<div class="w3-example">
<div class="w3-code notranslate" style="position:relative">
<img src="counta5.png" style="max-width:100%">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_counta_finished">Try it Yourself &raquo;</a>
</p>
</div>

<p>The <code class="w3-codespan">COUNTA</code> function has successfully counted 20 cells with values in the range <code class="w3-codespan">A2:A21</code>.</p>

<p>Lets apply the <code class="w3-codespan">COUNTA</code> function to <code class="w3-codespan">D2:D21</code>. Counting a range with numbers only. </p>

<p><img src="counta6.png" style="max-width:100%"></p>
<p><img src="counta7.png" style="max-width:100%"></p>

<p><strong>That is great!</strong> The <code class="w3-codespan">COUNTA</code> function counts cells in a range with values both numbers and letters.</p>
