<!DOCTYPE html>
<html lang="en-US">
<head><title>Excel Above and Below Average Rules</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>Excel Above and Below Average Rules</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_cf_top_bottom_rules.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_cf_data_bars.php">Next &#10095;</a>
</div>
<hr>

<h2>Above and Below Average Rules</h2>

<p>Above and Below Average Rules are premade types of conditional formatting in Excel used to change the appearance of cells in a range based on your specified <strong>conditions</strong>.</p>
<p>Above and Below Average Rules are found in the <strong>Top/Bottom Rules</strong> part of the conditional formatting menu:</p>
...
<h2>Above and Below Average Example</h2>

<p>The &quot;Above Average&quot; rule will highlight cells with one of the appearance options based on the cell value being the above the average value in a range.</p>
<div class="w3-panel ws-note">
    <p><strong>Note:</strong> You can use Excel to calcluate the <a href="excel_average.php">the average value</a> of a range, like in the example data below:</p>
</div>
<div class="w3-example">
    <h3>Example</h3>
    <div class="w3-code notranslate" style="position:relative">
    <img src="img_excel_cf_aba.png" style="max-width:100%">
    <textarea id="demo_excel_aba" style="display:none">
        Name	Type 1	HP
        Nidoking	Poison	81
        Clefairy	Fairy	70
        Clefable	Fairy	95
        Vulpix	Fire	38
        Ninetales	Fire	73
        Jigglypuff	Normal	115
        Wigglytuff	Normal	140
        Zubat	Poison	40
        Golbat	Poison	75
        Oddish	Grass	45
        Average		77.2
    </textarea>
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_aba')" title="Copy values to clipboard">Copy</button>
    </div>
</div>
<div class="w3-panel ws-note">
    <p><strong>Note:</strong> The Average value row is separated from the data with a visual border. Check out how to add this in the  <a href="excel_format_borders.php">format borders chapter</a>.</p>
</div>
...
<p>Let's first apply the <strong>Above Average</strong> rule to the HP values.</p>
<p>&quot;Above Average&quot; Rule, step by step:</p>
<ol>
    <li>Select the range <code class="w3-codespan">C2:C11</code> for HP values</li>
</ol>
<p><img src="img_excel_cf_aba2.png" style="max-width:100%"></p>
<ol start="2">
    ...
    <li>Select <strong>Above Average</strong> from the menu</li>
</ol>
<p><img src="img_excel_aba_menu.png"  style="max-width:100%"></p>
...
<p><img src="img_excel_cf_aba3.png" style="max-width:100%"></p>
<p>Now, the cells with above average HP values (more than 77.2) will be highlighted in green:</p>
<p><img src="img_excel_cf_aba4.png" style="max-width:100%"></p>
<p>Let's try the same with the below average HP values.</p>
<div class="w3-panel ws-info">
    <p><strong>Note:</strong> Multiple rules can be applied to the same range.</p>
</div>
<p>Repeat the steps, but instead choose <strong>Below Average</strong> in the menu and select the &quot;Light Red Fill with Dark Red Text&quot; appearance option.</p>
<p>Now, the below average values are also highlighted:</p>
<p><img src="img_excel_cf_aba5.png" style="max-width:100%"></p>
<div class="w3-panel ws-note">
    <p><strong>Note:</strong> You can remove the Highlight Cell Rules with <a href="excel_cf_manage_rules.php">Manage Rules</a>.</p>
</div>
<p>Notice that there are more below average values than above average values. Why could this be?</p>
<p>The number of above or below average value cells in a range will depend on the actual values in the range.</p>
<p>If some values in the range are extra large this will increase the average by a lot.</p>
<p>Let's add a fictional Pokemon with a very high HP stat value to illustrate this:</p>
<p><img src="img_excel_cf_aba6.png" style="max-width:100%"></p>
<p>The fictional Wigglytuffest has 1000 HP, which increases the average value all the way up to more than 161.</p>
<p>Now, only Wigglytuffest has an above average HP stat value, and every other Pokemon has below average HP stat values.</p>
<div class="w3-panel ws-note">
    <p><strong>Note:</strong> This kind of average value is referred to as <strong>the mean</strong>.</p>
    <p>You can learn more about different kinds of average values are calculated in the <a href="https://www.w3schools.com/statistics/statistics_mean.php">Statistics - Average chapter</a>.</p>
</div>
<hr>
