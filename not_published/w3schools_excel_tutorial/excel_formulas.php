...
<h1>Excel <span class="color_h1">Formulas</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_undo_redo.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_rel_ref.php">Next &#10095;</a>
</div>
<hr>

<h2>Formulas</h2>

<p>A formula in Excel is used to do mathematical calculations. Formulas always start with the equal sign (<code class="w3-codespan">=</code>) typed in the cell, followed by your calculation.</p> 

<p>Formulas can be used for calculations such as:</p>
<ul>
<li><code class="w3-codespan">=1+1</code></li>
<li><code class="w3-codespan">=2*2</code></li>
<li><code class="w3-codespan">=4/2=2</code></li>
</ul>
...
<img src="formulas.png" style="max-width:100%">
    <textarea id="demo_excel_formulas" style="display:none">
2
4
</textarea>
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_formulas')" title="Copy values to clipboard">Copy</button>
    </div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_formulas_values">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>Step by step:</p>
<ol>
<li>Select <code class="w3-codespan">C1</code> and type (<code class="w3-codespan">=</code>)</li>
<li>Left click <code class="w3-codespan">A1</code></li>
<li>Type (<code class="w3-codespan">+</code>)</li>
<li>Left click <code class="w3-codespan">A2</code></li>
<li>Press enter</li>
</ol>

<img src="formulas1.png" style="max-width:100%">
<br><br>
<img src="formulas2.png" style="max-width:100%">

<p><strong>You got it!</strong> You have successfully calculated <code class="w3-codespan">A1(2) + A2(4) = C1(6)</code>.</p>

<div class="ws-note w3-panel">
<p><strong>Note:</strong> Using cells to make calculations is an important part of Excel and you will use this alot as you learn.</p>
</div>

<p>Lets change from addition to multiplication, by replacing the (+) with a (*). It should now be <code class="w3-codespan">=A1*A2</code>, press enter to see what happens. </p>

<img src="formulas3.png" style="max-width:100%">
<p>You got <code class="w3-codespan">C1(8)</code>, right? <strong>Well done!</strong></p>
<div class="w3-example">
<div class="w3-code notranslate" style="position:relative">
<img src="formulas4.png" style="max-width:100%">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_formulas_multiply">Try it Yourself &raquo;</a>
</p>
</div>

<p>Excel is great in this way. It allows you to add values to cells and make you do calculations on them.</p>

<p>Now, try to change the multiplication (<code class="w3-codespan">*</code>) to subtraction (<code class="w3-codespan">-</code>) and dividing (<code class="w3-codespan">/</code>). </p>
...
<h3>Example</h3>
    <div class="w3-code notranslate" style="position:relative">
<img src="formulas_pokeballs.png" style="max-width:100%">
    <textarea id="demo_excel_formulas_pokeballs" style="display:none">
Trainers	Pokeball	Great Balls	Ultra Balls
Iva	2	3	1
Liam	5	5	2
Adora	10	2	3</textarea>
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_formulas_pokeballs')" title="Copy values to clipboard">Copy</button>
    </div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_formulas_pokeballs">Try it Yourself &raquo;</a>
</p>
</div>

<p>The data explained:</p>
<ul>
<li>Column <code class="w3-codespan">A</code>: Pokemon Trainers</li>
<li>Row <code class="w3-codespan">1</code>: Types of Pokeballs</li>
<li>Range <code class="w3-codespan">B2:D4</code>: Amount of Pokeballs, Great balls and Ultra balls</li>
</ul>

<div class="ws-note w3-panel">
<p><strong>Note:</strong> It is important to practice reading data to understand its context. In this example you should focus on the trainers and their Pokeballs, which have three different types: Pokeball, Great ball and Ultra ball.
</p>
</div>
<hr>
...
<p>Let's help Iva to count her Pokeballs. You find Iva in <code class="w3-codespan">A2(Iva)</code>. The values in <code class="w3-codespan">row 2 B2(2), C2(3), D2(1)</code> belong to her.</p>

<p>Count the Pokeballs, step by step:</p>
<ol>
<li>Select cell <code class="w3-codespan">E2</code> and type (<code class="w3-codespan">=</code>)</li>
<li>Left click <code class="w3-codespan">B2</code></li>
<li>Type (<code class="w3-codespan">+</code>)</li>
<li>Left click <code class="w3-codespan">C2</code></li>
<li>Type (<code class="w3-codespan">+</code>)</li>
<li>Left click <code class="w3-codespan">D2</code></li>
<li>Hit enter</li>
</ol>
<img src="formulas_pokeballs2.png" style="max-width:100%">
<br><br>
<img src="formulas_pokeballs3.png" style="max-width:100%">
<p>Did you get the value <code class="w3-codespan">E2(6)</code>? <strong>Good job!</strong> You have helped Iva to count her Pokeballs.</p>

<p>Now, let's help Liam and Adora with counting theirs.</p>

<p>Do you remember the <a href="excel_filling.php">fill function</a> that we learned about earlier? It can be used to continue calculations sidewards, downwards and upwards. Let's try it!</p>

<p>Lets use the fill function to continue the formula, step by step:</p>
<ol>
<li>Select <code class="w3-codespan">E2</code></li>
<li>Fill <code class="w3-codespan">E2:E4</code></li>
</ol>

<img src="formulas_pokeballs4.png" style="max-width:100%">

<p><strong>That is cool, right?</strong> The fill function continued the calculation that you used for Iva and was able to understand that you wanted to count the cells in the next rows as well. </p>

<p>Now we have counted the Pokeballs for all three; Iva(<code class="w3-codespan">6</code>), Liam(<code class="w3-codespan">12</code>) and Adora(<code class="w3-codespan">15</code>). </p>

<p>Let's see how many Pokeballs Iva, Liam and Adora have in total.</p>

<p>The total is called <strong>SUM</strong> in Excel.</p>

<p>There are two ways to calculate the <strong>SUM</strong>. </p>
...
<p>Excel has many pre-made functions available for you to use. The <strong>SUM
</strong>function is one of the most used ones. You will learn more about functions in a later chapter.</p>

<p>Let's try both approaches.</p>

<div class="ws-note w3-panel">
<p><strong>Note:</strong> You can navigate to the cells with your keyboard arrows instead of left clicking them. Try it!</p>
</div>

<p>Sum by adding cells, step by step:</p>

<ol>
<li>Select cell E5, and type <code class="w3-codespan">=</code></li>
<li>Left click <code class="w3-codespan">E2</code></li>
<li>Type (<code class="w3-codespan">+</code>)</li>
<li>Left click <code class="w3-codespan">E3</code></li>
<li>Type (<code class="w3-codespan">+</code>)</li>
<li>Left click <code class="w3-codespan">E4</code></li>
<li>Hit enter</li>
</ol>

<img src="formulas_pokeballs5.png" style="max-width:100%">
<br><br>
<div class="w3-example">
<div class="w3-code notranslate" style="position:relative">
<img src="formulas_pokeballs6.png" style="max-width:100%">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_formulas_adding">Try it Yourself &raquo;</a>
</p>
</div>

<p>The result is <code class="w3-codespan">E5(33)</code>.</p>

<p>Let's try the <strong>SUM</strong> function. </p>

<p>Remember to delete the values that you currently have in <code class="w3-codespan">E5</code>.</p>

<p><strong>SUM</strong> function, step by step:</p>
<ol>
<li>Type <code class="w3-codespan">E5(=)</code></li>
<li>Write <strong>SUM</strong></li>
<li>Double click <strong>SUM</strong> in the menu</li>
<li>Mark the range <code class="w3-codespan">E2:E4</code></li>
<li>Hit enter</li>
</ol>
<img src="formulas_pokeballs7.png" style="max-width:100%">
<br><br>
<img src="formulas_pokeballs8.png" style="max-width:100%">
<br><br>
<div class="w3-example">
<div class="w3-code notranslate" style="position:relative">
<img src="formulas_pokeballs9.png" style="max-width:100%">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_formulas_sum">Try it Yourself &raquo;</a>
</p>
</div>

<p><strong>Great job!</strong> You have successfully calculated the <strong>SUM</strong> using the <strong>SUM </strong>function.</p>
<p>Iva, Liam and Adora have <code class="w3-codespan">33</code> Pokeballs in total.</p> 

<p>Let's change a value to see what happens. Type <code class="w3-codespan">B2(7)</code>:</p>
<img src="formulas_pokeballs10.png" style="max-width:100%">

<p>The value in cell <code class="w3-codespan">B2</code> was changed from <code class="w3-codespan">2</code> to <code class="w3-codespan">7</code>. Notice that the formulas are doing calculations when we change the value in the cells, and the <strong>SUM </strong>is updated from <code class="w3-codespan">33</code> to <code class="w3-codespan">38</code>. It allows us to change values that are used by the formulas, and the calculations remain.
</p>
<hr>

<h2>Chapter Summary</h2>
<p>Values used in formulas can be typed directly and by using cells. The formula updates the result if you change the value of cells, which is used in the formula. The fill function can be used to continue your formulas upwards, downwards and sidewards. Excel has pre-built functions, such as <strong>SUM</strong>. </p>

<p>In the next chapter you will learn about relative and absolute references.</p>
<hr>

<div>
<form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_formulas1" method="post" target="_blank">
<h2>Test Yourself With Exercises</h2>
<div class="exercisewindow">
<h2>Excel Exercise:</h2>
<p>Complete the Excel formula:</p>
<div class="exerciseprecontainer">
<pre style="overflow: auto;">
<input name="ex1" maxlength="1" style="width: 15px;">8+10
</pre>
</div>
<br>
<button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
<p><a target="_blank" href="exercise.php?filename=exercise_formulas1">Start the Exercise</a></p>
</div>
</form>
</div>
