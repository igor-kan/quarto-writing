<!DOCTYPE html>
<html lang="en-US">
<head><title>Excel Stacked Bar Charts</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Excel Stacked Bar Charts</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_charts_bar.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_charts_cols.php">Next &#10095;</a>
</div>
...
<p>Stacked bar charts are used to highlights the <strong>total</strong> amount of contribution for each category.</p>

<p>This is done by stacking the bars at the end of each other.</p>
...
<ol start="2"><li>Click on the <strong>insert</strong> menu, then click on the bar menu (<img src="img_excel_bar_menu.png" width="30" height="40" style="border: 1px solid rgb(220, 220, 220)">) and choose <strong>Stacked Bar</strong> (<img src="img_excel_chart_bar_icon_2.png" width="30" height="30" style="border: 1px solid rgb(220, 220, 220)">) from the drop-down menu</li></ol>
...
<p><img src="img_excel_chart_bar_4_5.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<p>Following the steps above, you will get the following chart:</p>
<p><img src="img_excel_chart_bar_4_6.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>
...
<p>100% Stacked Bar is used to highlights the <strong>proportion</strong> of contribution for each data column in a category.</p>

<p>This is done by scaling the <strong>total</strong> value of each category in a stacked bar chart to 100.</p>
...
<ol start="2"><li>Click on the <strong>insert</strong> menu, then click on the bar menu (<img src="img_excel_bar_menu.png" width="30" height="40" style="border: 1px solid rgb(220, 220, 220)">) and choose <strong>100% Stacked Bar</strong> (<img src="img_excel_chart_bar_icon_3.png" width="30" height="30" style="border: 1px solid rgb(220, 220, 220)">) from the drop-down menu</li></ol>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> This menu is accessed by <a href="https://www.w3schools.com/excel/excel_formatting.php">expanding the ribbon</a>.</p>
</div>

<p><img src="img_excel_chart_bar_5.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<p>Following the steps above, you will get the following chart:</p>
<p><img src="img_excel_chart_bar_6.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>
