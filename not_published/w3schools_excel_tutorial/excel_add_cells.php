...
<h1>Excel <span class="color_h1">Add Cells</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_move_cells.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_delete_cells.php">Next &#10095;</a>
</div>
<hr>
...
<p>Let's try to create a new column <code class="w3-codespan">B</code>.</p>
<div class="w3-example">
<h3>Example</h3>
    <div class="w3-code notranslate" style="position:relative">
<img src="add.png" style="max-width:100%">
    <textarea id="demo_excel_add_cells" style="display:none">
	Health	Attack
Charmander	309	39
Pikachu	320	35
Bulbasaur	318	45
Squirtle	314	44
    ...
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_add_cells')" title="Copy values to clipboard">Copy</button>
    </div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_add_cells_1">Try it Yourself &raquo;</a>
</p>
</div>

<p>Right click on the column and select "Insert Columns":</p>
<img src="add2.png" style="max-width:100%">
<p>And a new column is created:</p>
<img src="add3.png" style="max-width:100%">

<p>Next, we need to get some Pokemon trainers in there. Type or copy the following data in the new column <code class="w3-codespan">B</code>:</p>
<div class="w3-example">
<h3>Example</h3>
    <div class="w3-code notranslate" style="position:relative">
<img src="add4.png" style="max-width:100%">
    <textarea id="demo_excel_add_cells2" style="display:none">
	Trainer	Health	Attack
Charmander	Iva	309	39
Pikachu	Iva	320	35
Bulbasaur	Liam	318	45
Squirtle	Liam	314	44    </textarea>
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_add_cells2')" title="Copy values to clipboard">Copy</button>
    </div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_add_cells_2">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>Let's try to create a new row <code class="w3-codespan">4</code>.</p>
<img src="add_row.png" style="max-width:100%">
<br><br><br>
<img src="add_row2.png" style="max-width:100%">

<p>We forgot to add Iva's Pokemon, <strong>Marowak</strong>. Lets add his data to the new row <code class="w3-codespan">4</code>, by typing or copying the following values:</p>

<div class="w3-example">
<h3>Example</h3>
    <div class="w3-code notranslate" style="position:relative">
<img src="add_row3.png" style="max-width:100%">
    <textarea id="demo_excel_add_cells3" style="display:none">
	Trainer	Health	Attack
Charmander	Iva	309	39
Pikachu	Iva	320	35
Marowak	Iva	425	60
Bulbasaur	Liam	318	45
Squirtle	Liam	314	44   </textarea>
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_add_cells3')" title="Copy values to clipboard">Copy</button>
    </div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_add_cells_3">Try it Yourself &raquo;</a>
</p>
</div>
...
<div>
<form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_add_cells1" method="post" target="_blank">
<h2>Test Yourself With Exercises</h2>
<div class="exercisewindow">
<h2>Excel Exercise:</h2>
<p>Complete the name of the <strong>command </strong>for adding columns:</p>
<div class="exerciseprecontainer">
<pre style="overflow: auto;">
<input name="ex1" maxlength="6" style="width: 65px;"> Columns
</pre>
</div>

<br>
<button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
<p><a target="_blank" href="exercise.php?filename=exercise_add_cells1">Start the Exercise</a></p>
</div>
</form>
</div>
