<!DOCTYPE html>
<html lang="en-US">
<head><title>Excel Highlight Cell Rules - A Date Occurring</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Excel HCR - A Date Occurring</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_cf_text_that_contains.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_cf_duplicate_unique.php">Next &#10095;</a>
</div>
<hr>
<h2>Highlight Cell Rules - A Date Occurring</h2>
...
<p></p>
<p><strong>A Date Occurring...</strong> is one of the options for the condition.</p>
...
<hr>
<h2>Highlight Cell Rule - A Date Occurring Example</h2>
<p>The &quot;A Date Occurring...&quot; Highlight Cell Rule will highlight a cell with one of the appearance options based on the cell value relative to a specified time frame.</p>
<p>The time frame can be:</p>
<ul>
  <li>Yesterday</li>
  <li>Today</li>
  <li>Tomorrow</li>
...
<p>In this example, the specified time frame will be &quot;next month&quot;.</p>
<div class="w3-example">
    <h3>Example</h3>
    <div class="w3-code notranslate" style="position:relative">
    <img src="img_excel_cf_ado.png" style="max-width:100%">
    <textarea id="demo_excel_hcr_intro" style="display:none">
      Name	Type 1	Birthday	Year
      Bulbasaur	Grass	27-Feb	1996
      Charmander	Fire	27-Feb	1996
      Squirtle	Water	27-Feb	1996
      Chikorita	Grass	21-Nov	1999
      Cyndaquil	Fire	21-Nov	1999
      Totodile	Water	21-Nov	1999
      Treecko	Grass	21-Nov	2002
      Torchic	Fire	21-Nov	2002
      Mudkip	Water	21-Nov	2002
      Turtwig	Grass	28-Sep	2006
      Chimchar	Fire	28-Sep	2006
      Piplup	Water	28-Sep	2006
      Snivy	Grass	18-Sep	2010
      Tepig	Fire	18-Sep	2010
      Oshawott	Water	18-Sep	2010
      Chespin	Grass	12-Oct	2013
      Fennekin	Fire	12-Oct	2013
      Froakie	Water	12-Oct	2013
    </textarea>
...
<p>Let's apply the rule to the Birthday values.</p>
<p>&quot;A Date Occurring...&quot; Highlight Cell Rule, step by step:</p>
<ol>
    <li>Select the range <code class="w3-codespan">C2:C19</code> for the Birthday values</li>
</ol>
<p><img src="img_excel_cf_ado2.png" style="max-width:100%"></p>
<ol start="2">
    ...
    <li>Select <strong>A Date Occurring...</strong> from the menu</li>
</ol>
<p><img src="img_excel_hcr_ado_menu.png" style="max-width:100%"></p>
<p>This will open a dialog box where you can specify the value and the appearance option.</p>
<ol start="5">
    <li>Select &quot;Next Month&quot; from the dropdown menu</li>
    <li>Select the appearance option &quot;Yellow Fill with Dark Yellow Text&quot; from the dropdown menu</li>
</ol>
<p><img src="img_excel_cf_ado3.png" style="max-width:100%"></p>
<p>Now, the cells with values A Date Occurring next month will be highlighted in yellow:</p>
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> In this example, the next month happens to be <strong>September</strong>.</p>
</div>
<p><img src="img_excel_cf_ado4.png" style="max-width:100%"></p>
<p>Turtwig, Chimchar, Piplup, Snivy, Tepig, and Oshawott all have birthdays in September, so their cells are highlighted.</p>
<div class="w3-panel ws-note">
