...
<html lang="en-US">
<head>
<title>Excel COUNT Function</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>Excel <span class="color_h1">COUNT Function</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_concat.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_counta.php">Next &#10095;</a>
</div>
<hr>

<h2>COUNT Function</h2>

<p>The <strong>COUNT</strong> function is a premade function in Excel, which counts cells with numbers in a range.</p>
<p>It is typed <code class="w3-codespan">=COUNT</code></p>
<p><strong>Note:</strong> The <strong>COUNT</strong> function only counts cells with numbers, <strong>not </strong>cells <strong>with letters</strong>. The <a href="excel_counta.php">COUNTA</a> function is better used if the cells have letters.</p>
<p>How to use the <code class="w3-codespan">=COUNT</code> function:</p>
<ol>
<li>Select a cell</li>
<li>Type <code class="w3-codespan">=COUNT</code></li>
<li>Double click the <strong>COUNT </strong>command</li>
...
<p>Apply the <code class="w3-codespan">=COUNT</code>  function to range <code class="w3-codespan">D2:D21</code>. Counting the cells of Pokemon Total stats, which is numbers only:</p>
<div class="w3-example">
    <div class="w3-code notranslate" style="position:relative">
    <img src="count1.png" style="max-width:100%">
    <textarea id="demo_excel_count" style="display:none">
    Name	Type 1	Type 2	Total stats
    Mankey	Fighting		305
    Poliwrath	Water	Fighting	510
    Victreebel	Grass	Poison	490
    Tentacool	Water	Poison	335
    Magneton	Electric	Steel	465
    Dewgong	Water	Ice	475
    ...
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_count')" title="Copy values to clipboard">Copy</button>
    </div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_count">Try it Yourself &raquo;</a>
</p>
</div>

<p><strong>COUNT</strong> function, step by step:</p>
<ol>
<li>Select <code class="w3-codespan">D23</code></li>
<li>Type <code class="w3-codespan">=COUNT</code></li>
<li>Double click <strong>COUNT </strong>in the menu</li>
<li>Select range <code class="w3-codespan">D2:D21</code></li>
<li>Hit enter</li>
</ol>

<p><img src="count2.png" style="max-width:100%"></p>

<p><strong>Note:</strong> The <code class="w3-codespan">=COUNT</code> function only counts cells with numbers in a range.</p>
<p><img src="count3.png" style="max-width:100%"></p>
<div class="w3-example">
<div class="w3-code notranslate" style="position:relative">
<img src="count4.png" style="max-width:100%">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_count_finished">Try it Yourself &raquo;</a>
</p>
</div>

<p>That's it! The <code class="w3-codespan">=COUNT</code> function successfully counted 20 cells with numbers.</p>
<hr>
...
<p>Now, let us try an example that will not work.</p>

<p>Apply the <code class="w3-codespan">=COUNT</code> function to the range <code class="w3-codespan">A2:A21</code>, which only has cells with letters.</p>

<p><img src="count5.png" style="max-width:100%"></p>
<p><img src="count6.png" style="max-width:100%"></p>

<p>It returns the value <code class="w3-codespan">0</code>, no cells with numbers found. Range <code class="w3-codespan">A2:A21</code> only had cells with letters.</p>
