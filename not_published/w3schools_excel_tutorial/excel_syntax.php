...
<h1>Excel <span class="color_h1">Syntax</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_overview.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_ranges.php">Next &#10095;</a>
</div>
<hr>

<h2>Syntax</h2>

<p>A formula in Excel is used to do mathematical calculations. Formulas always start with the equal sign <code class="w3-codespan">=</code> typed in the cell, followed by your calculation. 
</p>

<div class="ws-note w3-panel">
<p><strong>Note:</strong> You claim the cell by selecting it and typing the equal sign (<code class="w3-codespan">=</code>)</p>
</div>

<h3>Creating formulas, step by step</h3>
<ul>
<li>Select a cell</li>
...
<p>For example <code class="w3-codespan">=1+1</code> is the formula to calculate <strong>1+1=2</strong></p>

<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate" style="position:relative">
    <img src="excel_new.png" style="max-width:100%">
    <textarea id="demo_excel_syntax1" style="display:none">=1+1</textarea>
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_syntax1')" title="Copy values to clipboard">Copy</button>
  </div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_get_started">Try it Yourself &raquo;</a>
</p>
</div>

<div class="ws-note w3-panel">
<p><strong>Note:</strong> The value of a cell is communicated by <strong>reference(value)</strong> for example <code class="w3-codespan">A1(2)</code></p>
</div>
<hr>

<h2>Using Formulas with Cells</h2>
<p>You can type values to cells and use them in your formulas.</p>

<p>Lets type some dummy values to get started. Double click the cells to type values into them. Go ahead and type:</p>

<ul>
<li><code class="w3-codespan">A1(309)</code></li>
<li><code class="w3-codespan">A2(320)</code></li>
<li><code class="w3-codespan">B1(39)</code></li>
<li><code class="w3-codespan">B2(35)</code></li>
</ul>
<p>Compare with the picture shown below:</p>

<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate" style="position:relative">
<img src="excel_new2.png" style="max-width:100%">
     <textarea id="demo_excel_syntax2" style="display:none">
309	39
320	35
</textarea>
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_syntax2')" title="Copy values to clipboard">Copy</button>
   </div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_syntax_values">Try it Yourself &raquo;</a>
</p>
</div>

<div class="ws-note w3-panel">
<p><strong>Note:</strong> Type values by selecting a cell, claim it by entering the equal sign (<code class="w3-codespan">=</code>) 
and then type your value. For example <code class="w3-codespan">=309</code>.</p>
</div>

<p><strong>Well done!</strong> You have successfully typed values to cells and now we can use them to create formulas.
</p>

<p>Here is how to do it, step by step.</p>
<ol>
<li>Select the cell <code class="w3-codespan">C1</code></li>
<li>Type the equal sign (=)</li>
<li>Left click on <code class="w3-codespan">A1</code>, the cell that has the <code class="w3-codespan">(309)</code> value</li>
<li>Type the minus sign (<code class="w3-codespan">-</code>)</li>
<li>Left click on <code class="w3-codespan">B2</code>, the cell that has the <code class="w3-codespan">(35)</code> value</li>
<li>Hit enter</li>
</ol>

<div class="ws-note w3-panel">
<p><strong>Tip:</strong> The formula can be typed directly without clicking the cells. The typed formula would be the same as the value in <code class="w3-codespan">C1</code> <code class="w3-codespan">(=A1-B2)</code>. </p>
</div>
...
<div class="w3-half"><img src="excel_new3.png" style="max-width:100%">
</div>
<div class="w3-half"><img src="excel_new4.png" style="max-width:100%"></div>
</div>
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_syntax_sub1">Try it Yourself &raquo;</a>
</p>
</div>

<p>The result after hitting the enter button is <code class="w3-codespan">C1(274)</code>. Did you make it? 
</p>
<hr>
...
<p>Let's try one more example, this time let's make the formula <code class="w3-codespan">=A2-B1</code>. </p>

<p>Here is how to do it, step by step.</p>
<ol>
<li>Select the cell <code class="w3-codespan">C2</code></li>
<li>Type the equal sign (=)</li>
<li>Left click <code class="w3-codespan">A2</code>, the cell that has the <code class="w3-codespan">(320)</code> value</li>
<li>Type the minus sign (<code class="w3-codespan">-</code>)</li>
<li>Left click <code class="w3-codespan">B1</code>, the cell that has the <code class="w3-codespan">(39)</code> value</li>
...
<div class="w3-code notranslate" style="position:relative">
<div class="w3-row-padding" style="margin-left:-16px;margin-right:-16px;">
<div class="w3-half"><img src="excel_new5.png" style="max-width:100%">
</div>
<div class="w3-half"><img src="excel_new6.png" style="max-width:100%"></div>
</div>
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_syntax_sub2">Try it Yourself &raquo;</a>
</p>
</div>

<p>You got the result <code class="w3-codespan">C2(281)</code>, right? <strong>Way to go!</strong></p>

<div class="ws-note w3-panel">
<p><strong>Note:</strong> You can make formulas with all four arithmetic operations, such as addition (+), subtraction (-), multiplication (*) and division (/).</p>
</div>

<p>Here are some examples:</p>

<ul>
<li><code class="w3-codespan">=2+4 gives you 6</code></li>
<li><code class="w3-codespan">=4-2 gives you 2</code></li>
<li><code class="w3-codespan">=2*4 gives you 8</code></li>
<li><code class="w3-codespan">=2/4 gives you 0.5</code></li>
</ul>

<p>In the next chapter you will learn about <strong>Ranges </strong>and how data 
can be moved in the <strong>Sheet</strong>.</p> 
...
function copyFormulas(elementId){
  ...
  .then(() => { alert("Copied the values.\nIt can now be pasted into the Excel spreadsheet.") })
  .catch((error) => { alert(`Copy failed! ${error}`) })
}
</script>

<div>
<form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_syntax1" method="post" target="_blank">
...
<input name="ex1" maxlength="1" style="width: 15px;">1+1
</pre>
</div>
<br>
