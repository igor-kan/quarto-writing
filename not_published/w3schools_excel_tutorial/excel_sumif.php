<!DOCTYPE html>
<html lang="en-US">
<head><title>Excel SUMIF Function</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_sum.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_sumifs.php">Next &#10095;</a>
</div>
<hr>

<h2>SUMIF Function</h2>

<p>The <strong>SUMIF</strong> function is a premade function in Excel, which calculates the sum of values in a range based on a <strong>true</strong> or <strong>false</strong> <strong>condition</strong>.</p>
<p>It is typed <code class="w3-codespan">=SUMIF</code>:</p>
<div class="w3-example">
  <div class="w3-code notranslate">
    =SUMIF(<strong>range</strong>, <strong>criteria</strong>, <strong>[sum_range]</strong>)
  </div>
</div>
...
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> The <code class="w3-codespan">[sum_range]</code> is optional.</p>
  <p>If not specified, the function calculates the sum of the same range as the condition.</p>
</div>
<div class="w3-panel ws-note">
...
<h2>Example SUMIF function</h2>

<p>Find the sum of Total stats for Grass type Pokemon:</p>
<p>The condition is that the type is &quot;Grass&quot;.</p>
<div class="w3-example">
    <div class="w3-code notranslate" style="position:relative">
    <img src="img_excel_sumif.png" style="max-width:100%">
    <textarea id="demo_excel_sumif" style="display:none">
    Name	Type 1	Total			
    Bulbasaur	Grass	318		Type	Total Sum
    Ivysaur	Grass	405		Grass	
    Venusaur	Grass	525		Fire	
    Charmander	Fire	309		Water	
    Charmeleon	Fire	405			
    Charizard	Fire	534			
    Squirtle	Water	314			
    Wartortle	Water	405			
    ...
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_sumif')" title="Copy values to clipboard">Copy</button>
    </div>
</div>
<hr>

<p>Example <strong>SUMIF</strong> function, step by step:</p>
<ol>
  <li>Select the cell <code class="w3-codespan">F3</code></li>
  <li>Type <code class="w3-codespan">=SUMIF</code></li>
  <li>Double click the <strong>SUMIF</strong> command</li>
</ol>
<p><img src="img_excel_sumif2.png" style="max-width:100%"></p>
<ol start="4">
  ...
  <li>Type <code class="w3-codespan">,</code></li>
  <li>Specify the range for the sum <code class="w3-codespan">C2:C10</code> (the Total values)</li>
  <li>Type <code class="w3-codespan">,</code></li>
  <li>Hit enter</li>
</ol>
<p><img src="img_excel_sumif3.png" style="max-width:100%"></p>
<p>The function now sums the Total stats for Grass type Pokemon.</p>
<p>The function can be repeated for the other Pokemon types to compare them:</p>
<p><img src="img_excel_sumif4.png" style="max-width:100%"></p>
<div class="w3-panel ws-note">
...
<p>Now, we can see the sum of total stats for the different types of Pokemon:</p>
<p><img src="img_excel_sumif5.png" style="max-width:100%"></p>
