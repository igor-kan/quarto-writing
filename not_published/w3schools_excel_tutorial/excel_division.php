...
<html lang="en-US">
<head>
<title>Excel Division Operator</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>Excel <span class="color_h1">Division Operator</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_multiplication.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_parantheses.php">Next &#10095;</a>
</div>
<hr>

<h2>Division Operator</h2>

<p>Division uses the <code class="w3-codespan">/</code> symbol in Excel.</p>

<p>How to do division cells:</p>
<ol>
...
<li>Type <code class="w3-codespan">4/2</code></li>
<li>Hit enter</li>
</ol>

<p><img src="divide1.png" style="max-width:100%"></p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate" style="position:relative">
<img src="divide2.png" style="max-width:100%">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_divide_manual">Try it Yourself &raquo;</a>
</p>
</div>
<hr>

<h2>Dividing Two Cells</h2>
<p>Let's add some numbers to work with. Type the following values:</p>
<p><img src="divide3.png" style="max-width:100%"></p>
...
<p><img src="divide4.png" style="max-width:100%"></p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate" style="position:relative">
<img src="divide5.png" style="max-width:100%">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_divide_two">Try it Yourself &raquo;</a>
</p>
</div>
<hr>
...
<h2>Dividing Using Absolute Reference</h2>

<p>You can lock a cell and divide it with other cells.</p>

<p>How to do it, step by step:</p>
<ol>
<li>Select a cell and type (<code class="w3-codespan">=</code>)</li>
<li>Select the dividend</li>
<li>Type (<code class="w3-codespan">/</code>)</li>
<li>Select the divisor lock and add two dollar signs (<code class="w3-codespan">$</code>) before the column and row</li>
<li>Hit enter</li>
<li>Fill the range</li>
</ol>

<div class="ws-note w3-panel">
<p><strong>Note: </strong>Dividend is the number being divided by the divisor.</p>
</div>

<p>Let's have a look at an example where we divide <code class="w3-codespan">B(5)</code> with the range <code class="w3-codespan">A1:A10</code> using absolute reference and fill function.</p>

<p>Type the values:</p>
<p><img src="divide6.png" style="max-width:100%"></p>
...
<li>Select <code class="w3-codespan">A1</code></li>
<li>Type (<code class="w3-codespan">/</code>)</li>
<li>Select <code class="w3-codespan">B1</code> type dollar sign before column and row <code class="w3-codespan">$B$1</code></li>
<li>Hit enter</li>
<li>Fill <code class="w3-codespan">C1:C10</code></li>
</ol>

<p><img src="divide7.png" style="max-width:100%"></p>
<p><img src="divide8.png" style="max-width:100%"></p>
<p><img src="divide9.png" style="max-width:100%"></p>
<p><img src="divide10.png" style="max-width:100%"></p>
<p><img src="divide11.png" style="max-width:100%"></p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate" style="position:relative">
<img src="divide12.png" style="max-width:100%">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_divide_abs">Try it Yourself &raquo;</a>
</p>
</div>

<p><strong>Good job!</strong> You have successfully used absolute reference to divide <code class="w3-codespan">B1(5)</code> with the range <code class="w3-codespan">A1:A10</code>.</p>
<hr>
