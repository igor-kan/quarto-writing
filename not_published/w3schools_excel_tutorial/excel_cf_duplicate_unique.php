...
<h1>Excel HCR - Duplicate and Unique Values</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_cf_date_occurring.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_cf_top_bottom_rules.php">Next &#10095;</a>
</div>
<hr>

<h2>Highlight Cell Rules - Duplicate and Unique Values</h2>
...
<p><strong>Duplicate Values..</strong> is one of the options for the condition, and can check for both <strong>duplicate</strong> and <strong>unique</strong> values.</p>
...
<h2>Highlight Cell Rule - Duplicate Value Example</h2>

<p>The &quot;Duplicate Values...&quot; Highlight Cell Rule will highlight a cell with one of the appearance options based on the cell value being the <strong>same</strong> as other cells in the range.</p>
<div class="w3-example">
    <h3>Example</h3>
    <div class="w3-code notranslate" style="position:relative">
    <img src="img_excel_cf_duv.png" style="max-width:100%">
    <textarea id="demo_excel_cf_duv" style="display:none">Name	Type 1	HP	Attack	Defense	Sp. Atk	Sp. Def	Speed
    ...
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_cf_duv')" title="Copy values to clipboard">Copy</button>
    </div>
</div>
...
<p>Let's apply the rule to all of the cell values.</p>
<p>&quot;Duplicate Values...&quot; Highlight Cell Rule, step by step:</p>
<ol>
    <li>Select the range <code class="w3-codespan">A2:H8</code></li>
</ol>
<p><img src="img_excel_cf_duv2.png" style="max-width:100%"></p>
<ol start="2">
    ...
    <li>Select <strong>Duplicate Values...</strong> from the menu</li>
</ol>
<p><img src="img_excel_hcr_duv_menu.png" style="max-width:100%"></p>
...
<p><img src="img_excel_cf_duv3.png" style="max-width:100%"></p>
<p>Now, all the cells in the range that have the <strong>same</strong> value as another cell are highlighted in yellow:</p>
<p><img src="img_excel_cf_duv4.png" style="max-width:100%"></p>
<p>All of Ditto's stat values are 48 and all of Mew's stat values are 100, so they are all highlighted.</p>
<p>All of the Dittos and all of the Normal Type values are also highlighted.</p>
...
<h2>Highlight Cell Rule - Unique Value Example</h2>

<p>The &quot;Duplicate Values...&quot; Highlight Cell Rule can also find and highlight <strong>Unique Values</strong>.</p>
<p>Let's apply this to the same set of data:</p>
<div class="w3-example">
    <h3>Example</h3>
    <div class="w3-code notranslate" style="position:relative">
    <img src="img_excel_cf_duv.png" style="max-width:100%">
    <textarea id="demo_excel_cf_duv" style="display:none">
...
<p>This will open a dialog box where you can specify the value and the appearance option.</p>
<ol start="5">
    <li>Select <strong>Unique</strong> from the dropdown menu</li>
    <li>Select the appearance option &quot;Green Fill with Dark Green Text&quot; from the dropdown menu</li>
</ol>
<p><img src="img_excel_cf_duv5.png" style="max-width:100%"></p>
<p>Now, the cells with <strong>unique</strong> values will be highlighted in green:</p>
<p><img src="img_excel_cf_duv6.png" style="max-width:100%"></p>
<p>Mew and Psychic only appears once in the range, so these values are highlighted.</p>
<div class="w3-panel ws-note">
    <p><strong>Note:</strong> You can remove the unwanted duplicates from a table with <a href="excel_table_removing_duplicates.php">Removing Duplicate Function</a>.</p>
</div>
<hr>
