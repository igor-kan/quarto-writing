...
<h1>Excel <span class="color_h1">Move Cells</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_fill_double_click.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_add_cells.php">Next &#10095;</a>
</div>
<hr>

<h2>Moving Cells</h2>

<p>There are two ways to move cells: <strong>Drag and drop</strong> or by <strong>copy and paste</strong>.</p>
<hr>

<h2>Drag and Drop</h2>

<p>Let's start by typing or copying some values that we can work with:</p>


<div class="w3-example">
<h3>Example</h3>
    <div class="w3-code notranslate" style="position:relative">
   <img src="move_cells.png" style="max-width:100%">
    <textarea id="demo_excel_move_cells" style="display:none">
309	39
320	35
318	45
314	44
    </textarea>
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_move_cells')" title="Copy values to clipboard">Copy</button>
    </div>
<p>
</p>
</div>

<p>Next, start by marking the area <code class="w3-codespan">A1:B4</code>:</p>
<img src="move_cells2.png" style="max-width:100%">

<p>You can drag and drop the range by pressing and holding the left mouse button on the border. The mouse cursor will change to the move symbol when you hover over the border.</p>
<p>Drag and drop it when you see the symbol.</p> 

<p>Move the range to <code class="w3-codespan">B2:C5</code> as shown in the picture:</p>
<img src="move_cells3.png" style="max-width:100%">

<p><strong>Great!</strong> Now you have created more space, so that we have room for more data.</p>

<div class="ws-note w3-panel">
<p><strong>Note:</strong> It is important to give context to the data, making the spreadsheet easy to understand. This can be done by adding text which explains the data.</p>
</div>

<p>Let's go ahead and give the data more context. Type or copy the following values:</p>

<div class="w3-example">
<h3>Example</h3>
    <div class="w3-code notranslate" style="position:relative">
<img src="move_cells4.png" style="max-width:100%">
    <textarea id="demo_excel_move_cells2" style="display:none">
	Health	Attack
Charmander	309	39
Pikachu	320	35
Bulbasaur	318	45
Squirtle	314	44    </textarea>
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_move_cells2')" title="Copy values to clipboard">Copy</button>
    </div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_move_cells_context">Try it Yourself &raquo;</a>
</p>
</div>

<p>Yes, that is right, we are looking at Pokemons! Giving context to the data is always helpful.</p>

<p>Next, lets see how we can move data by using cut and paste.</p>
...
<p>Ranges can be moved by cutting and pasting values from one place to another.</p>

<div class="ws-note w3-panel">
<p><strong>Tip:</strong> You can cut using the hotkey CTRL+X and paste by CTRL+V. This saves you time.</p>
</div>

<p>Mark the range <code class="w3-codespan">A1:C5</code></p>

<p>Right click the marked area, and click on the "Cut" command, which has scissors as its icon:</p>
<img src="cut1.png" style="max-width:100%">

<p>Cutting makes the range white-grey with dotted borders. This indicates that the range is cutted and ready for pasting.
</p>
<img src="cut2.png" style="max-width:100%">

<p>Right click the paste destination <code class="w3-codespan">B6</code> and left click the paste icon.</p>

<img src="paste1.png" style="max-width:100%">
<br><br><br>
<img src="paste2.png" style="max-width:100%">

<p>You have successfully cutted and pasted the range from <code class="w3-codespan">A1:C5</code> to <code class="w3-codespan">B6:D10</code>.</p>
<hr>

<h2>Copy and paste</h2>
<p>Copy and paste works in the same way as cut and paste. The difference is that it does not remove the original cells.</p>
<p>Let's copy the cells back from <code class="w3-codespan">B6:D10</code> to <code class="w3-codespan">A1:C5</code>.</p>

<div class="ws-note w3-panel">
<p><strong>Tip:</strong> You can copy using the hotkey CTRL+C and paste by CTRL+V. This saves you time. Try it!</p>
</div>

<p>Mark the range <code class="w3-codespan">B6:D10</code>.</p>
<hr>

<p>Right click the marked area, and click on the "Copy" command which has two papers as its icon.</p>
<img src="copy.png" style="max-width:100%">
<p>Copying gives the range a dotted green border. This indicates that the range is copied and ready for pasting.</p>
<img src="copy2.png" style="max-width:100%">
<p>Right click the paste destination <code class="w3-codespan">A1</code> and left click the paste icon:</p>
<img src="paste_copy.png" style="max-width:100%">
<br><br><br>
<img src="paste_copy2.png" style="max-width:100%">

<p>The difference between cutting and copying, is that cutting removes the originals, while copying leaves the originals.</p>

<p>Next, let's delete the original data and keep the data in the <code class="w3-codespan">A1:C5</code> range.</p>
<hr>

<h2>Delete Data</h2>
<p>Select the original cells and remove them by pressing the "Delete" button on the keyboard:</p> 
<img src="delete1.png" style="max-width:100%">
<br><br><br>
<img src="delete2.png" style="max-width:100%">
...
<div>
<form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_move_cells1" method="post" target="_blank">
<h2>Test Yourself With Exercises</h2>
<div class="exercisewindow">
<h2>Excel Exercise:</h2>
<p>Type the cell in the bottom right corner of the range <code class="w3-codespan">B2:C5</code>:</p>
<div class="exerciseprecontainer">
<pre style="overflow: auto;">
C<input name="ex1" maxlength="1" style="width: 15px;">
</pre>
</div>

<br>
<button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
<p><a target="_blank" href="exercise.php?filename=exercise_move_cells1">Start the Exercise</a></p>
</div>
</form>
</div>
