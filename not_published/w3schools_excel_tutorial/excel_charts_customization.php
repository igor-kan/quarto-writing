...
<html lang="en-US">
<head>
<title>Excel Chart Customization</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>Excel <span class="color_h1">Chart Customization</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_charts_radar.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_table_pivot_intro.php">Next &#10095;</a>
</div>
...
<p>Charts in Excel can be customized.</p>

<p>Customization can be helpful to make the data easier to understand. For example to highlight key points, give additional information and make it look better.</p>

<p>Excel has many options for how to customize a chart. You will learn more about the different options in this chapter.</p>

<p><img src="img_excel_chart_intro_9.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<p>This doughnut chart shows the ratio of different Pokemon types in generations 1 and 2.</p>
<p>The "Water" type, shown in gray has the most Pokemons in both generations. Then there are types "Bug", shown in yellow, "Grass", shown in blue and "Fire", shown in orange.</p>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> Different charts can be customized in different ways.</p>
</div>
...
<p>Excel charts can be moved around the spreadsheet.</p>

<p>How to move a chart, step by step:</p>

<ol><li><p>Select the chart by clicking on it.</p></li></ol>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> Selecting a chart highlights its borders.</p>
</div>

<p><img src="img_excel_chart_intro_11.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<ol start = "2"><li><p>Drag the chart and place it where you want</p></li></ol>
<p><img src="img_excel_chart_intro_12.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>
...
<h2>Resizing Charts</h2>

<p>Excel charts can be resized.</p>

<p>Resizing will scale all the elements in the chart except the text.</p>

<p>How to resize a chart, step by step:</p>

<ol start = "1"><li><p>Select the chart by clicking on it.</p></li></ol>

<ol start = "2"><li><p>Click and drag one of the 8 points shown on the chart border and drag them</p></li></ol>

<p><img src="img_excel_chart_intro_13.6.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> The arrows in the image above are pointing to where you can drag to resize the chart.</p>
</div>
<p><img src="img_excel_chart_intro_14.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>
<p>The chart is now resized. This can be done as many times as needed to get the right size.</p>

<hr>

<h2>Changing The Chart Title</h2>

<p>The default chart title in Excel is "Chart Title". This is not informative. The title should describe the chart.</p>

<p>Changing the title, step by step:</p>

<ol start = "1"><li><p>Double click on the chart</p></li></ol>
<p><img src="img_excel_chart_intro_16.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>
<p>This opens up a menu on the right side of your screen.</p>

<ol start = "2"><li><p>Find "Chart Title" text in the newly opened menu and change it</p></li></ol>
<p><img src="img_excel_chart_intro_17.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>
<p><img src="img_excel_chart_intro_18.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<p>Now, the title has changed to "Pokemon Stats".</p>
<p><img src="img_excel_chart_intro_19.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> You can remove the chart title by clicking on it and pressing the <code class="w3-codespan">Delete</code>key on your keyboard.</p>
</div>
...
<p>Charts can be customized in different ways, here are some elements you can change:</p>
<ul>
  <li>Legends</li>
  <li>Axis</li>
  <li>Data labels</li>
