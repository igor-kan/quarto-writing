...
<html lang="en-US">
<head>
<title>Excel Case: Poke Mart Shop Cart</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>Excel <span class="color_h1">Case: Poke Mart Shop Cart</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_table_pivot_intro.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_case_poke_shop_style.php">Next &#10095;</a>
</div>
<hr>

<h2>Case: Poke Mart Shop Cart</h2>
<p>In this case we help the Poke Mart merchant to create a shop cart overview with prices, discount and total price. You will practice the skills that you have learned in the earlier chapters.</p>

<p>Copy values or type the following data:</p>
<div class="w3-example">
    <h3>Example</h3>
    <div class="w3-code notranslate" style="position:relative">
    <img src="case1.png" style="max-width:100%">
...
Total			
  ...
  <p>
  <a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_case_poke_shop">Try it Yourself &raquo;</a>
  </p>
</div>

<p>To solve the case we need to complete the following:</p>
<ul>
<li>Prices for items (<code class="w3-codespan">C2:C8</code>)</li>
<li>Sub total (<code class="w3-codespan">B10</code>)</li>
<li>Add discount (<code class="w3-codespan">B11</code>)</li>
<li>Total price (<code class="w3-codespan">B13</code>)</li>
</ul>

<p><strong>Are you ready?</strong></p>

<p>Start by creating the first formula for <code class="w3-codespan">Item price*Shop</code> cart. We want the price to change when we change items in the Shop cart. Use the fill function on the range <code class="w3-codespan">D2:D8</code> afterwards to save time. </p>

<p>Step by step:</p>
<ol>
<li>Select <code class="w3-codespan">C2</code>, type (<code class="w3-codespan">=</code>)</li>
<li>Select <code class="w3-codespan">B2</code></li>
<li>Type (<code class="w3-codespan">*</code>)</li>
<li>Select <code class="w3-codespan">D2</code></li>
<li>Hit enter</li>
</ol>

<p><img src="case2.png" style="max-width:100%"></p>

<p><img src="case3.png" style="max-width:100%"></p>
<p>Test the formula by Typing <code class="w3-codespan">D2(1)</code>:</p>
<p><img src="case4.png" style="max-width:100%"></p>

<p>Did you get <code class="w3-codespan">C2(200)</code>? That matches the price for one Pokeball! 
<strong>Good job!</strong></p>

<p>We need the same formula for <code class="w3-codespan">C2:C8</code>, let's fill it downwards!</p>

<div class="ws-note w3-panel">
<p><strong>Note:</strong> We need relative references as we want the fill function to continue the formula to the next rows.</p>
</div>

<p><img src="case5.png" style="max-width:100%"></p>

<p>Fill <code class="w3-codespan">D2:D8</code> to double check the prices:</p>
<p><img src="case_6.png" style="max-width:100%"></p>


<p><strong>That looks right!</strong></p>
...
<p>Let us find the subtotal by using the <code class="w3-codespan">SUM</code> function on the <code class="w3-codespan">C2:C8</code> range.</p>

<ol>
<li>Type <code class="w3-codespan">B10(=SUM)</code></li>
<li>Double click the <code class="w3-codespan">SUM</code> function</li>
<li>Mark the range <code class="w3-codespan">C2:C8</code></li>
<li>Hit enter</li>
</ol>

<p><img src="case6.png" style="max-width:100%"></p>
<p><img src="case7.png" style="max-width:100%"></p>
<p><img src="case8.png" style="max-width:100%"></p>
<p><img src="case9.png" style="max-width:100%"></p>

<p><strong>Well done!</strong> You have successfully calculated the subtotal using the <code class="w3-codespan">SUM</code> function.</p>

<p>Next, let's add a  <code class="w3-codespan">10%</code> discount. Type <code class="w3-codespan">F11(10)</code>:</p>
<p><img src="case10.png" style="max-width:100%"></p>

<p>Apply the discount to the subtotal:</p>
<ol>
<li>Select <code class="w3-codespan">B11</code>, type (<code class="w3-codespan">=</code>)</li>
<li>Type <code class="w3-codespan">(F11/100)*B10</code></li>
<li>Hit enter</li>
</ol>

<div class="ws-note w3-panel">
<p><strong>Note:</strong> The <code class="w3-codespan">(F11/100)</code> was used to change the value <code class="w3-codespan">10</code> to <code class="w3-codespan">0.1</code>, which is <code class="w3-codespan">10%</code>.</p>
</div>

<p><img src="case11.png" style="max-width:100%"></p>
<p><img src="case12.png" style="max-width:100%"></p>

<p>Subtract the discount <code class="w3-codespan">B11</code> from the subtotal <code class="w3-codespan">B10</code> to calculate the total.</p>

<ol>
<li>Select B13 type (<code class="w3-codespan">=</code>)</li>
<li>Select the minuend <code class="w3-codespan">B10</code></li>
<li>Type (<code class="w3-codespan">-</code>)</li>
<li>Select the subtrahend <code class="w3-codespan">B11</code></li>
<li>Hit enter</li>
</ol>

<p><img src="case13.png" style="max-width:100%"></p>
<p><img src="case14.png" style="max-width:100%"></p>

<p><strong>That is great!</strong></p>

<p>You have completed all the tasks for the Poke Mart merchant.</p>
<ul>
<li>
Prices for items<br>
Range <code class="w3-codespan">C2:D8</code> calculates the prices by multiplying item price and shop cart
</li>
<br>

<li>
Sub total<br>
The <code class="w3-codespan">SUM</code> function adds the range <code class="w3-codespan">C2:C8</code>
</li>
<br>
...
<code class="w3-codespan">F11(10)</code> into the formula in <code class="w3-codespan">B11</code>
</li>
<br>
...
<p>Try changing the amounts in the shop cart and discount to see how the calculations adapt!</p>
<div class="w3-example">
    <div class="w3-code notranslate" style="position:relative">
    <img src="case15.png" style="max-width:100%">
    </div>
  <p>
  <a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_case_poke_shop_finished">Try it Yourself &raquo;</a>
  </p>
</div>

<p><strong>Case completed! Good job!</strong></p>
<br>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_table_pivot_intro.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_case_poke_shop_style.php">Next &#10095;</a>
