...
<h1>Excel <span class="color_h1">Fill</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_ranges.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_fill_double_click.php">Next &#10095;</a>
</div>
<hr>

<h2>Filling</h2>

<p>Filling makes your life easier and is used to fill ranges with values, so that you do not have to type manual entries.</p>
...
<p>For now, do not think of functions. We will cover that in a later chapter.</p>

<hr>

<h2>How To Fill</h2>

<p>Filling is done by selecting a cell, clicking the fill icon and selecting the range using drag and mark while holding the left mouse button down.</p>

<p>The fill icon is found in the bottom right corner of the cell and has the icon of a small square. Once you hover over it your mouse pointer will change its icon to a thin cross.</p>

<img src="fill_cross.png" style="max-width:100%">

<p>Click the fill icon and hold down the left mouse button, drag and mark the range that you want to cover.</p>

<p>In this example, cell <code class="w3-codespan">A1</code> was selected and the range <code class="w3-codespan">A1:A10</code> was marked.</p>

<img src="fill_cross2.png" style="max-width:100%">
...
<p>Filling can be used for copying. It can be used for both numbers and words.</p>

<p>Let's have a look at numbers first.</p>

<p>In this example we have typed the value <code class="w3-codespan">A1(1)</code>:</p>
<img src="fill_cross3.png" style="max-width:100%">

<p>Filling the range <code class="w3-codespan">A1:A10</code> creates <strong>ten copies</strong> of 
<strong>1</strong>:</p>

<img src="fill_cross4.png" style="max-width:100%">

<p>The same principle goes for text.</p>

<p>In this example we have typed <code class="w3-codespan">A1(Hello World)</code>.</p>
<p>Filling the range <code class="w3-codespan">A1:A10</code> creates ten copies of "Hello World":</p>
<img src="fill_helloworld.png" style="max-width:100%">
...
<h2>Fill Sequences</h2>

<p>Filling can be used to create sequences. A sequence is an order or a pattern. We can use the filling function to continue the order that has been set.</p> 
...
<p>Start with typing <code class="w3-codespan">A1(1)</code>:</p>
<img src="fill_seq.png" style="max-width:100%">

<p>First we will show an example which does not work, then we will do a working one. Ready?</p>

<p>Lets type the value (<code class="w3-codespan">1</code>) into the cell <code class="w3-codespan">A2</code>, which is what we have in <code class="w3-codespan">A1</code>. Now we have the same values in both <code class="w3-codespan">A1</code> and <code class="w3-codespan">A2</code>.</p>
<img src="fill_seq2.png" style="max-width:100%">
<p>Let's use the fill <strong>function </strong>from <code class="w3-codespan">A1:A10</code> to see what happens. Remember to mark both values before you fill the range.</p> 
<img src="fill_seq3.png" style="max-width:100%">
<p>What happened is that we got the same values as we did with copying. This is because the fill function assumes that we want to create copies as we had two of the same values in both the cells <code class="w3-codespan">A1(1)</code> and <code class="w3-codespan">A2(1)</code>. 
</p>

<p>Change the value of <code class="w3-codespan">A2(1)</code> to <code class="w3-codespan">A2(2)</code>. We now have two different values in the cells <code class="w3-codespan">A1(1)</code> and <code class="w3-codespan">A2(2)</code>. Now, fill <code class="w3-codespan">A1:A10</code> 
again. Remember to mark both the values (holding down shift) before you fill the 
range:</p>

<img src="fill_seq4.png" style="max-width:100%">
<p><strong>Congratulations!</strong> You have now counted from 1 to 10. </p>

<p>The fill function understands the pattern typed in the cells and continues it for us. 
</p>
<p>That is why it created copies when we had entered the value (<code class="w3-codespan">1</code>) in both cells, 
as it saw no pattern. When we entered (<code class="w3-codespan">1</code>) and (<code class="w3-codespan">2</code>) in the cells it was able to understand the pattern and that the next cell <code class="w3-codespan">A3</code> should be (<code class="w3-codespan">3</code>).
</p>

<p>Let's create another sequence. Type <code class="w3-codespan">A1(2)</code> and <code class="w3-codespan">A2(4)</code>:</p>

<img src="fill_seq5.png" style="max-width:100%">

<p>Now, fill <code class="w3-codespan">A1:A10</code>:</p>
<img src="fill_seq6.png" style="max-width:100%">

<p>It counts from <code class="w3-codespan">2 to 20</code> in the range <code class="w3-codespan">A1:A10</code>.</p>
<p>This is because we created an order with <code class="w3-codespan">A1(2)</code> and <code class="w3-codespan">A2(4)</code>.</p>
<p>Then it fills the next cells, <code class="w3-codespan">A3(6)</code>, <code class="w3-codespan">A4(8)</code>, <code class="w3-codespan">A5(10)</code> and so on. The fill function understands the pattern and helps us continue it.</p> 

<hr>

<h2>Sequence of Dates</h2>
<p>The fill function can also be used to fill dates.</p>
<div class="ws-note">
  <p><strong>Note: </strong>The date format depends on you <a href="excel_format_settings.php">regional language settings</a>.</p>
  <p>For example <code class="w3-codespan">14.03.2023</code> vs. <code class="w3-codespan">3/14/2023</code>.</p>
</div>
<p>Test it by typing <code class="w3-codespan">A1(29.07.2021)</code>:</p>

<img src="fill_dates.png" style="max-width:100%">
<p>And fill the range <code class="w3-codespan">A1:A10</code>:</p>
<img src="fill_dates2.png" style="max-width:100%">

<p>The fill function has filled 10 days from <code class="w3-codespan">A1(29.07.2021)</code> to <code class="w3-codespan">A10(07.08.2021)</code>.</p>
<p>Note that it switched from July to August in cell <code class="w3-codespan">A4</code>. It knows the calendar and will count real dates.</p>
<hr>

<h2>Combining Words and Letters</h2>
<p>Words and letters can also be combined.</p>

<p>Type <code class="w3-codespan">A1(Hello 1)</code> and <code class="w3-codespan">A2(Hello 2)</code>:</p>
<img src="fill_words_num.png" style="max-width:100%">
<p>Next, fill <code class="w3-codespan">A1:A10</code> to see what happens:</p>
<img src="fill_words_num2.png" style="max-width:100%">
<p>The result is that it counts from <code class="w3-codespan">A1(Hello 1)</code> to <code class="w3-codespan">A10(Hello 10)</code>. Only the numbers have changed.</p>
<p>It recognised the pattern of the numbers and continued it for us. Words and numbers can be combined, as long as you use a recognizable pattern for the numbers.</p>
<hr>

<div>
<form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_filling1" method="post" target="_blank">
<h2>Test Yourself With Exercises</h2>
<div class="exercisewindow">
<h2>Excel Exercise:</h2>
<p>Complete the sequence of numbers:</p>
<div class="exerciseprecontainer">
<pre style="overflow: auto;">
A1(1)
A2(2)
A3<input name="ex1" maxlength="3" style="width: 35px;">
</pre>
</div>

<br>
<button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
<p><a target="_blank" href="exercise.php?filename=exercise_filling1">Start the Exercise</a></p>
</div>
</form>
</div>
