...
<html lang="en-US">
<head>
<title>Introduction Excel PivotTable</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>Introduction Excel PivotTable</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_charts_customization.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_case_poke_shop.php">Next &#10095;</a>
</div>
<hr>

<h2>PivotTable</h2>

<p>PivotTable is a functionality in Excel which helps you organize and analyze data.</p>
<p>It lets you add and remove values, perform calculations, and to filter and sort data sets.</p>
<p>PivotTable helps you structure and organize data to understand large data sets.</p>

<div class="ws-info w3-panel">
  <p>The data that you use needs to be in tabular format.</p>
  <p>The tabular form is data in a table format (rows and columns).</p>
</div>
<hr>

<h2>How a PivotTable Works</h2>
<p>PivotTables have four main components:</p>
<ol>
  
<li><strong>Columns</strong></li>
  <p>Columns are vertical tabular data.</p>
  <p>The column includes the unique header, which is on the top.</p>
  <p>The header defines which data you are seeing listed downwards.</p>
  <p>In this example, <strong>D5(Sum of Attack)</strong> is the header.</p>
  <p><code class="w3-codespan">D6(110), D7(100), D8(50), D9(73)</code>, and so on are the data.</p>
  <p><img src="img_excel_pivot_table_column.png" style="max-width:550px; height:auto; width:100%; border: solid 0.5px;" alt="Pivot Table Column Highlighted"></p>

  <li><strong>Rows</strong></li>
  <p>Rows are horizontal tabular data.</p>
  <p>Data in the same row are related.</p>
  <p>In this example, <strong>A8(Alakazam)</strong> is the Pokemon name.</p>
  <p><code class="w3-codespan">B8(500), C8(55), D8(50), E8(45)</code> represents the pokemons stats.</p>
  <p>The type of stats is read in the header in the columns.</p>
  <p><img src="img_excel_table_pivot_row.png" style="max-width:550px; height:auto; width:100%; border: solid 0.5px;" alt="Pivot Table Row Highlighted"></p>
  
  <li><strong>Filters</strong></li>
  <p>Filters are used to select what data you see.</p>
  <p>In this example, there are two filters enabled: <strong>Generation</strong> and <strong>Type 1</strong>.</p>
  <p>The filters are set to <code class="w3-codespan">Generation (1)</code> and <code class="w3-codespan">Type (Psychic)</code>.</p>
  <p>We will only see Generation 1 pokemon that is Type 1, Psychic.</p>
  <p>All pokemon in the table below the filter are of this generation and type.</p>
  <p><img src="img_excel_table_pivot_filter.png" style="max-width:550px; height:auto; width:100%; border: solid 0.5px;" alt="Pivot Table Filter Highlighted"></p>
  <p>Filter view:</p>
  <p><img src="img_excel_table_pivot_filter_view.png" style="max-width:300px; height:auto; width:100%; border: solid 0.5px;" alt="Pivot Table Filter view"></p>

  <hr>
  <a href="https://campus.w3schools.com/collections/certifications/products/excel-certificate" target="_blank" alt="W3Schools Excel Certificate Exam">
<img src="img_excel_certificate.png" alt="W3Schools Excel Certificate" style="width: 100%; max-width: 750px; height: auto;"></a>
<hr>

  <li><strong>Values</strong></li>
  <p>Values define how you present the data.</p>
  <p>You can define how you <strong>Summarize</strong> and <strong>Show</strong> values.</p>
  <p>In this example, values are defined for the range <code class="w3-codespan">B5:E5</code>.</p>
  <p>The range <code class="w3-codespan">B5:E5</code> has all the same value setting: <strong>Sum</strong></p>
  <p>The Sum is summarized in the range <code class="w3-codespan">B14:E14</code>.</p>
  <p><img src="img_excel_table_pivot_values.png" style="max-width:550px; height:auto; width:100%; border: solid 0.5px;" alt="Pivot Table Value Range Highlighted"></p>
  <p>Values settings view:</p>
  <p>You can change the name and settings of the values.</p>
  <p><img src="img_excel_table_pivot_values_view.png" style="max-width:300px; height:auto; width:100%; border: solid 0.5px;" alt="Pivot Value settings view"></p>
</ol>
...
<h2>Fields and layout</h2>
<p>The TablePivot is displayed how by your settings.</p>
<p>The <strong>PivotTable Fields panel</strong> is used to change how you see the data.</p>
<p>The settings can be separated in two: <strong>Fields</strong> and <strong>Layout</strong>.</p>
<p><img src="img_excel_table_pivot_panel.png" style="max-width:800px; height:auto; width:100%; border: solid 0.5px;" alt="Fields and Layout"></p>
<ol>
  <li><strong>Fields</strong></li>
  <p>The checkboxes can be selected or unselected to display or change the property of the data.</p>
  <p>In this example, the checkbox for <strong>Speed</strong> is selected.</p>
  <p>Speed is now displayed in the table.</p>
  <p><img src="img_excel_table_pivot_fields_panel.png" style="max-width:800px; height:auto; width:100%; border: solid 0.5px;" alt="Fields in panel"></p>
  <p>You can click the downwards arrow to change how the data is presented.</p>
  <p><img src="img_excel_table_pivot_fields_panel_properties.png" style="max-width:300px; height:auto; width:100%; border: solid 0.5px;" alt="Fields properties"></p>
...
<p><img src="img_excel_table_pivot_fields_panel_drag_and_drop.png" style="max-width:300px; height:auto; width:100%; border: solid 0.5px;" alt="Drag and drop to display data"></p>
  <p>In this example, we will drag and drop <strong>Sp. def</strong> to <strong>Values</strong>.</p>
  <p><img src="img_excel_table_pivot_fields_added_spdef.png" style="max-width:800px; height:auto; width:100%; border: solid 0.5px;" alt="Added SP def to table"></p>
  <p>Sp. Def is now displayed in the table.</p>
<p>The settings of the fields that you have moved to the right side can be changed.</p>
<p>Click the downwards arrow to access the settings.</p>
<p>This is possible in the four areas (Filters, rows, columns and, values).</p>
<p><img src="img_excel_table_pivot_settings_layout.png" style="max-width:300px; height:auto; width:100%; border: solid 0.5px;" alt="Change settings layout fields"></p>
<h2>Chapter summary<h2>
  <p>TablePivot can be used both simple and advanced.</p>
  <p>It can be set up in many different ways.</p>
  <p>You can configure on many different layers cross filters, rows, columns and values.</p>
  <p>How you set it up depends on your needs and how you want to present the data.</p>
