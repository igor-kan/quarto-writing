<!DOCTYPE html>
<html lang="en-US">
<head><title>Excel Highlight Cell Rules - Equal To</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Excel HCR - Equal To</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_cf_between.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_cf_text_that_contains.php">Next &#10095;</a>
</div>
<hr>
<h2>Highlight Cell Rules - Equal To</h2>
...
<p></p>
<p><strong>Equal To...</strong> is one of the options for the condition.</p>
...
<hr>
<h2>Highlight Cell Rule - Equal To Example (with Numbers)</h2>
<p>The &quot;Equal To...&quot; Highlight Cell Rule will highlight a cell with one of the appearance options based on the cell value being <strong>equal</strong> to your specified value.</p>
<p>The specified value could be a particular number or particular text.</p>
<p>In this example, the specified value will be &quot;48&quot;.</p>
...
<p>Let's apply the rule to all of the different stat values.</p>
<p>&quot;Equal To...&quot; Highlight Cell Rule, step by step:</p>
<ol>
    <li>Select the range <code class="w3-codespan">C2:H8</code> for all of the stat values</li>
</ol>
<p><img src="img_excel_hcr_intro2.png" style="max-width:100%"></p>
<ol start="2">
    ...
    <li>Select <strong>Equal To...</strong> from the menu</li>
</ol>
<p><img src="img_excel_hcr_eq_menu.png" style="max-width:100%"></p>
<p>This will open a dialog box where you can specify the value and the appearance option.</p>
<ol start="5">
    <li>Enter <code class="w3-codespan">48</code> into the input field</li>
    <li>Select the appearance option &quot;Yellow Fill with Dark Yellow Text&quot; from the dropdown menu</li>
</ol>
<p><img src="img_excel_hcr_intro3.png" style="max-width:100%"></p>
<p>Now, the cells with values equal to &quot;48&quot; will be highlighted in yellow:</p>
<p><img src="img_excel_hcr_intro4.png" style="max-width:100%"></p>
<p>All of Ditto's stat values are 48, so they are highlighted.</p>
...
<h2>Highlight Cell Rule - Equal To Example (with Text)</h2>
<p>The &quot;Equal To...&quot; Highlight Cell Rule also works with text values.</p>
<p>In this example, the specified text value will be &quot;Magikarp&quot;.</p>
<div class="w3-example">
    <h3>Example</h3>
    <div class="w3-code notranslate" style="position:relative">
    <img src="img_excel_hcr_intro.png" style="max-width:100%">
...
<p>This will open a dialog box where you can specify the value and the appearance option.</p>
<ol start="5">
    <li>Enter <code class="w3-codespan">Magikarp</code> into the input field</li>
    <li>Select the appearance option &quot;Yellow Fill with Dark Yellow Text&quot; from the dropdown menu</li>
</ol>
<p><img src="img_excel_cf_eq.png" style="max-width:100%"></p>
<p>Now, the cells with text values equal to &quot;Magikarp&quot; will be highlighted in yellow:</p>
<p><img src="img_excel_cf_eq2.png" style="max-width:100%"></p>
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> The <strong>Equal To...</strong> Highlight Cell Rule will highlight cells that <strong>exactly</strong> match the specified value.</p>
  <p>You can use the <a href="excel_cf_text_that_contains.php">Text That Contains</a> rule for highlighting cells that have values with <strong>any part</strong> matching the specified value.</p>
</div>
<hr>
