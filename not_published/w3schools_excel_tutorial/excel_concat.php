<!DOCTYPE html>
<html lang="en-US">
<head><title>Excel CONCAT Function</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_averageifs.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_count.php">Next &#10095;</a>
</div>
<hr>

<h2>CONCAT Function</h2>
<p>To concatenate is to link something together.</p>
<p>CONCAT is a function in Excel and is short for concatenate.</p>
<p>The <strong>CONCAT</strong> function is used to link multiple cells without adding any delimiters between the combined cell values.</p>
<p>It is typed <code class="w3-codespan">=CONCAT</code></p>
<div class="w3-example">
<div class="w3-code notranslate">
  =CONCAT(<strong>cell1</strong>, <strong>delimiter</strong>, <strong>cell2</strong>)
  </div>
</div>
<hr>
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> Delimiters are spacing or symbols used to seperate content elements apart from each other.</p>
</div>
<div class="w3-example">
  <h3>Example of delimiters</h3>
  <div class="w3-code notranslate">
...
<div class="w3-panel ws-info">
  <p><strong>Info:</strong> CONCAT is a new version of the old CONCATENATE function. Recent versions of Excel do not 
accept the old CONCATENATE function as it is only compatible with earlier versions of Excel. To use COCATENATE in the latest
versions of Excel, use CONCAT.</p>
</div>
<hr>

<h2>How to Use CONCAT Function</h2>

<p>To combine values from multiple Excel cells, use <strong>CONCAT</strong>.</p>
<div class="w3-panel ws-note">
  ...
  <p>The symbol depends on your <a href="excel_format_settings.php" target="_blank">Language Settings</a>.</p>
</div>
<hr>
<h5><strong>Step 1)</strong> Start the CONCAT function</h5>
<ol>
  <li>Select a cell <code class="w3-codespan">E2</code></li>
  <li>Type <code class="w3-codespan">=CONCAT</code></li>
  <li>Double click the <strong>CONCAT</strong> command</li>
</ol>
<div class="w3-example">
    <div class="w3-code notranslate" style="position:relative">
    <img src="img_excel_concat1.png" style="max-width:550px; height:auto; width:100%;">
    <textarea id="demo_excel_concat" style="display:none">
    ...
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_concat')" title="Copy values to clipboard">Copy</button>
    </div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_concat">Try it Yourself &raquo;</a>
</p>
</div>
<div class="w3-panel ws-info">
  <h5><strong>Follow along the tutorial by trying it yourself!</strong></h5>
  <p>Copy the values in the example above and try it on your own!</p>
</div>
...
<h5><strong>Step 2)</strong> Link cells</h5>
<ol start="4">
  <li>Select a cell (<code class="w3-codespan">A2</code>)</li>
  <li>Add a comma (<code class="w3-codespan">,</code>)</li>
  <li>Add a space inside of quotation marks to create a delimiter (<code class="w3-codespan">" "</code>)</li>
  <li>Select another cell (<code class="w3-codespan">A3</code>)</li>
  <li>Hit enter</li>
</ol>
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> The <strong>CONCAT</strong> function does not provide any delimiters between cell values used 
  in the funtion. If you want your cell values to be displayed with delimiters, you have to add the delimiters between the
  selected cells. You can use any symbol as a demiliter, if you want the delimiter to be a space, enter <code class="w3-codespan">" "</code>.</p>
</div>
<hr>
<p><img src="img_excel_concat2.png" style="max-width:550px; height:auto; width:100%;"></p>
<p>The function returns the content of <code class="w3-codespan">A2</code> and <code class="w3-codespan">A3</code> separated with a <code class="w3-codespan">" "</code> dilimiter.</p>
<p><img src="img_excel_concat3.png" style="max-width:550px; height:auto; width:100%;"></p>
<p>You can also use more symbols as a demilter, such as adding the word <code class="w3-codespan">" and "</code>.</p>
<p><img src="img_excel_concat4.png" style="max-width:550px; height:auto; width:100%;"></p>
<p><img src="img_excel_concat5.png" style="max-width:550px; height:auto; width:100%;"></p>
<p>The <strong>CONCAT</strong> function accepts cell values of both text and numbers, you can combine them in any way you prefer.</p>
<p>Combine the cell values with text strings as delimiters to make the output more descriptive!</p>
<p><img src="img_excel_concat6.png" style="max-width:550px; height:auto; width:100%;"></p>
<div class="w3-example">
<div class="w3-code notranslate" style="position:relative">
<img src="img_excel_concat7.png" style="max-width:550px; height:auto; width:100%;">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_concat_finished">Try it Yourself &raquo;</a>
</p>
</div>
