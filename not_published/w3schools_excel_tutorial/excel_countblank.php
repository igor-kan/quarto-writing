...
<html lang="en-US">
<head>
<title>Excel COUNTBLANK Function</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>Excel <span class="color_h1">COUNTBLANK Function</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_counta.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_countif.php">Next &#10095;</a>
</div>
<hr>

<h2>COUNTBLANK Function</h2>

<p>The <strong>COUNTBLANK</strong> function is a premade function in Excel, which counts blank cells in a range.</p>
<p>It is typed <code class="w3-codespan">=COUNTBLANK</code></p>
<p><strong>Note:</strong> The <strong>COUNTBLANK</strong> function is helpful to find empty cells in a range.</p>
<p>How to use the <code class="w3-codespan">=COUNTBLANK</code> function:</p>
<ol>
<li>Select a cell</li>
<li>Type <code class="w3-codespan">=COUNTBLANK</code></li>
<li>Double click the <strong>COUNTBLANK</strong> command</li>
...
<p>Apply the <code class="w3-codespan">=COUNTBLANK</code> function to range <code class="w3-codespan">C2:C21</code>, to find the Pokemons which do not have a 2nd Type:</p>
<div class="w3-example">
    <div class="w3-code notranslate" style="position:relative">
    <img src="countblank1.png" style="max-width:100%">
    <textarea id="demo_excel_countblank" style="display:none">
    ...
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_countblank')" title="Copy values to clipboard">Copy</button>
    </div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_countblank">Try it Yourself &raquo;</a>
</p>
</div>

<p><strong>COUNTBLANK</strong> function, step by step:</p>
<ol>
<li>Select <code class="w3-codespan">C23</code></li>
<li>Write <code class="w3-codespan">=COUNTBLANK</code></li>
<li>Double click <strong>COUNTBLANK</strong> in the menu</li>
<li>Select range <code class="w3-codespan">C2:C21</code></li>
<li>Hit enter</li>
</ol>

<p><img src="countblank2.png" style="max-width:100%"></p>

<p><img src="countblank3.png" style="max-width:100%"></p>
<div class="w3-example">
<div class="w3-code notranslate" style="position:relative">
<img src="countblank4.png" style="max-width:100%">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_countblank_finished">Try it Yourself &raquo;</a>
</p>
</div>
<p>The <code class="w3-codespan">COUNTBLANK</code> function successfully counted <code class="w3-codespan">8</code> blank cells in the range <code class="w3-codespan">C2:C21</code>.</p>
