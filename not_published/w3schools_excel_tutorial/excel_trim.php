<!DOCTYPE html>
<html lang="en-US">
<head><title>Excel TRIM Function</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_sumifs.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_vlookup.php">Next &#10095;</a>
</div>
<hr>

<h2>TRIM Function</h2>

<p>The <strong>TRIM</strong> function is premade in Excel and used to remove irregular text spacing and keep single spaces between words.</p>
<p>It is typed <code class="w3-codespan">=TRIM</code></p>
<p>If you want to use the function on a single cell, write:</p>
<div class="w3-example">
<div class="w3-code notranslate">
  =TRIM(<strong>cell</strong>)
  </div>
</div>
<p>If you want to use the function on a range of cells, write:</p>
<div class="w3-example">
<div class="w3-code notranslate">
  =TRIM(<strong>start cell</strong>:<strong>end cell</strong>)
  </div>
</div>
<hr>
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> Irregular spacing is unnecessary spacing within the dataset that can occur before, after or between
text or numbers within a cell.</p>
</div>
<hr>
<h2>Example TRIM Function</h2>

<p>Use <strong>Trim</strong> to tidy up irregular spaces in the dataset within the range <code class="w3-codespan">A2:C21</code>.</p>
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> To define the range, separate the range values with a colon symbol <code class="w3-codespan">:</code></p>
</div>
<hr>
<h2>How to Use TRIM Function</h2>
<h5><strong>Step 1)</strong> Start the TRIM function</h5>
<ol>
  <li>Select a cell <code class="w3-codespan">E2</code></li>
  <li>Type <code class="w3-codespan">=TRIM</code></li>
  <li>Double click the <strong>TRIM</strong> command</li>
</ol>
<p><img src="img_excel_trim1.png" style="max-width:550px; height:auto; width:100%;"></p>
<h5><strong>Step 2)</strong> Select a range of cells to be used in the TRIM function</h5>
<ol start="4">
  <li>Select a range (<code class="w3-codespan">A2:C21</code>)</li>
  <li>Hit enter</li>
</ol>
...
<div class="w3-example">
    ...
    <img src="img_excel_trim2.png" style="max-width:550px; height:auto; width:100%;">
...
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_trim">Try it Yourself &raquo;</a>
</p>
</div>
<div class="w3-panel ws-info">
  <h5><strong>Try it yourself!</strong></h5>
  <p>Copy the values in the example above and try it on your own!</p>
  <p>The range of values will be tidied up.</p>
</div>
<p>The function returns a dataset formatted without irregular spaces:</p>
<p><img src="img_excel_trim3.png" style="max-width:550px; height:auto; width:100%;"></p>
<h5><strong>Step 3)</strong> Use the TRIM function with spacing between text:</h5>
<p>Use <code class="w3-codespan">=TRIM</code> function by following the steps in the example above to format the text:</p>
<p><img src="img_excel_trim4.png" style="max-width:550px; height:auto; width:100%;"></p>
<p>The text looks much better now!</p>
<div class="w3-example">
<div class="w3-code notranslate" style="position:relative">
<img src="img_excel_trim5.png" style="max-width:550px; height:auto; width:100%;">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_trim_finished">Try it Yourself &raquo;</a>
</p>
</div>
