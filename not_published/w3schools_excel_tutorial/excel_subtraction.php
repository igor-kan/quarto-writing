...
<html lang="en-US">
<head>
<title>Excel Subtraction Operator</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>Excel <span class="color_h1">Subtraction Operator</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_addition.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_multiplication.php">Next &#10095;</a>
</div>
<hr>

<h2>Subtraction Operator</h2>

<p>Subtraction uses the <code class="w3-codespan">-</code> symbol, and is also known as <strong>minus</strong>.</p>

<p>How to subtract cells:</p>
<ol>
<li>Select a cell and type (<code class="w3-codespan">=</code>)</li>
<li>Select the minuend</li>
<li>Type (<code class="w3-codespan">-</code>)</li>
<li>Select the subtrahend</li>
<li>Hit enter</li>
</ol>

<div class="ws-note w3-panel">
<p>Note: The minuend is the number to which the subtrahend subtracts from.</p>
</div>

<p>You can add more cells to the formula by typing (<code class="w3-codespan">-</code>) between the cells.</p>

<p>Let's have a look at some examples.</p>
<hr>

<h2>Subtracting Two Manual Entries</h2>

<p>Let's start with adding in a formula. Start with a clean sheet</p>

<p>Step by step:</p>
<ol>
<li>Type <code class="w3-codespan">A1(=)</code></li>
<li>Type <code class="w3-codespan">100-50</code></li>
<li>Hit enter</li>
</ol>
<img src="subtraction1.png" style="max-width:100%">
<br><br>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate" style="position:relative">
<img src="subtraction2.png" style="max-width:100%">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_subtraction_manual">Try it Yourself &raquo;</a>
</p>
</div>

<p><strong>Tip:</strong> You can add more values into the formula by typing (-) between the cells.</p>
<hr>

<h2>Subtracting Using Two Cells</h2>
<p>Let's add some numbers to work with. Type the following values:</p>
<img src="subtraction3.png" style="max-width:100%">

<p>Subtracting using two cells, step by step:</p>
<ol>
<li>Type <code class="w3-codespan">A3(=)</code></li>
<li>Select <code class="w3-codespan">A1</code></li>
<li>Type (<code class="w3-codespan">-</code>)</li>
<li>Select <code class="w3-codespan">A2</code></li>
<li>Hit enter</li>
</ol>
<img src="subtraction4.png" style="max-width:100%">
<br><br>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate" style="position:relative">
<img src="subtraction5.png" style="max-width:100%">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_subtraction_two">Try it Yourself &raquo;</a>
</p>
</div>
<hr>
...
<h2>Subtracting Using Many Cells</h2>
<p>Let's subtract using many cells. First, type the following values:</p>
<img src="subtraction6.png" style="max-width:100%">
...
<p><img src="subtraction7.png" style="max-width:100%"></p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate" style="position:relative">
<img src="subtraction8.png" style="max-width:100%">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_subtraction_many">Try it Yourself &raquo;</a>
</p>
</div>
<hr>

<h2>Subtracting Using Absolute Reference</h2>
<p>You can lock a cell and subtract it from other cells.</p>
...
<li>Select the minuend</li>
<li>Type (<code class="w3-codespan">-</code>)</li>
<li>Select the subtrahend and add two dollar signs (<code class="w3-codespan">$</code>) before the column and row</li>
<li>Hit enter</li>
<li>Fill the range</li>
</ol>

<div class="ws-note w3-panel">
<p><strong>Note:</strong> The minuend is the number to which the subtrahend subtracts from.</p>
</div>

<p>Let's have a look at an example where we subtract <code class="w3-codespan">B(5)</code> from the range <code class="w3-codespan">A1:A10</code> using absolute reference and fill function.</p>

<p>Type the values:</p>
<p><img src="subtraction9.png" style="max-width:100%"></p>
...
<li>Select <code class="w3-codespan">A1</code></li>
<li>Type (<code class="w3-codespan">-</code>)</li>
<li>Select <code class="w3-codespan">B1</code> and type dollar sign before column and row <code class="w3-codespan">$B$1</code></li>
<li>Hit enter</li>
<li>Fill <code class="w3-codespan">C1:C10</code></li>
</ol>
<p><img src="subtraction10.png" style="max-width:100%"></p>
<p><img src="subtraction11.png" style="max-width:100%"></p>
<p><img src="subtraction12.png" style="max-width:100%"></p>
<p><img src="subtraction13.png" style="max-width:100%"></p>
<p><img src="subtraction14.png" style="max-width:100%"></p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate" style="position:relative">
<img src="subtraction15.png" style="max-width:100%">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_subtraction_abs">Try it Yourself &raquo;</a>
</p>
</div>
<p><strong>You got it!</strong> You have successfully used absolute reference to subtract <code class="w3-codespan">B1(5)</code> from the minuend range <code class="w3-codespan">A1:A10</code>.</p>
