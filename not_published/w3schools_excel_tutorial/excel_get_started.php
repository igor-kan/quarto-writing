...
<h1>Excel <span class="color_h1">Get Started</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_introduction.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_overview.php">Next &#10095;</a>
</div>
<hr>

<h2>Office 365</h2>
<p>The easiest way to get started with Excel, is to use Office 365.</p>
<p>Office 365 does not require downloading and installation of the program. It simply runs in your browser.</p>
<p>In our tutorial we will use Office 365, which can be accessed from <a href="https://www.office.com" target="_blank">www.office.com</a>.</p>
<hr>

<h2>Install</h2>
<p>Once you have successfully logged into Office through <a href="https://www.office.com" target="_blank">www.office.com</a>, 
click on the Excel icon on the left side to enter the application:</p>
<img src="office1.jpg" style="max-width:100%">
<p>After entering the Excel application, click on the New blank workbook button to get started with a new workbook.</p>
<img src="office2.jpg" style="max-width:100%">
<p>Enter a name for your workbook, and hit the enter button:</p>
<img src="excel_first.png" style="max-width:100%">

<p>The Excel view has columns and rows, similar to a squared math exercise book.</p>
<p>Do not worry if the functionality looks overwhelming at first. You will get comfortable as you learn more in the chapters to come.</p>
<p>For now focus on the rows, columns, and the cells.</p>

<p>Ok. Let's make a function!</p>
<ul>
<li>First, double click the cell <code class="w3-codespan">A1</code>, the one that is marked with the green rectangle in the picture.</li>
<li>Second, type <code class="w3-codespan">=1+1</code>.</li>
<li>Third, hit the <strong>enter</strong> button:</li>
</ul>

<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate" style="position:relative">
  <img src="excel2.png" style="max-width:600px; height:auto; width:100%;">
    <textarea id="demo_excel_get_started" style="display:none">=1+1</textarea>
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_get_started')" title="Copy values to clipboard">Copy</button>
  </div>
<p>
...
<p><strong>Congratulations!</strong> You have typed your first function,
<strong>1+1=2</strong>.
</p>
