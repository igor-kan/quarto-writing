...
<html lang="en-US">
<head>
<title>Excel Data Analysis - Sort</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>Excel <span class="color_h1">Sort</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_format_settings.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_filter.php">Next &#10095;</a>
</div>
<hr>

<h2>Excel Sorting</h2>

<p>Ranges can be sorted using the <strong>Sort Ascending</strong> and <strong>Sort Descending</strong> commands.</p>

<p><strong>Sort Ascending</strong>: from smallest to largest.</p>

<p><strong>Sort Descending</strong>: from largest to smallest.</p>

<p>The sort commands work for text too, using A-Z order.</p>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> To sort a range that has more than one column, the whole range has to be selected. Sorting just one can breaks the relationship between columns.</p>
  <p>This is shown in an example later in this chapter.</p>
</div>

<p>The commands are found in the Ribbon under the <strong>Sort & Filter</strong> menu (<img src="filter_icon.png" style="width:40px" style="border: 1px solid rgb(0, 0, 0)">)</p>

<p><img src="sort_1.png" style="max-width:100%;"></p>

<hr>

<h2>Example Sort (text)</h2>

<p>Sort the Pokemons in the range <strong>A2:A21</strong> by their <strong>Name</strong>, ascending from smallest to largest (A-Z).</p>

<ol>
  <li>Select <strong>A2:A21</strong></li>
  <li>Open the <strong>Sort & Filter</strong> menu</li>
  <li>Click <strong>Sort Ascending</strong></li>
</ol>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> <strong>A1</strong> is not included as it is the header for the column. This is the row that is dedicated to the filter. Including it will blend it with the rest.</p>
</div>

<div class="w3-example">
<h3>Example</h3>
    <div class="w3-code notranslate" style="position:relative">
<p><img src="sort_2.png" style="max-width:100%;"></p>
    <textarea id="demo_excel_sort_text" style="display:none">
Name
Bulbasaur
Ivysaur
Venusaur
...
Rattata
Raticate</textarea>
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_sort_text')" title="Copy values to clipboard">Copy</button>
    </div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_sort_text">Try it Yourself &raquo;</a>
</p>
</div>


<p><img src="sort_3.png" style="max-width:100%;"></p>
<p><img src="sort_4.png" style="max-width:100%;"></p>

<p>The <strong>Sort Ascending</strong> function successfully sorted the Pokemons by their <strong>Name</strong> ascending from A-Z.</p>

<div class="w3-panel ws-info">
  <p>Try again, this time with <strong>Sort Descending</strong> to see what that looks like! </p>
</div>
...
<h2>Example Sort (numbers)</h2>

<p>Sort the Pokemons ascending by their <strong>Total stats</strong> from smallest to largest.</p>

<ol><li><p>Select <strong>A2:A21</strong></p></li></ol>

<div class="w3-example">
<h3>Example</h3>
    <div class="w3-code notranslate" style="position:relative">
<p><img src="sort_5.png" style="max-width:100%;"></p>
    <textarea id="demo_excel_sort_nums" style="display:none">
Total stats
318
405
525
...
253
413</textarea>
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_sort_nums')" title="Copy values to clipboard">Copy</button>
    </div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_sort_nums">Try it Yourself &raquo;</a>
</p>
</div>


<ol start="2"><li><p>Open the <strong>Sort & Filter</strong> menu</p></li></ol>
<p><img src="sort_6.png" style="max-width:100%;"></p>
<ol start="3"><li><p>Click <strong>Sort Ascending</strong></p></li></ol>
<p><img src="sort_7.png" style="max-width:100%;"></p>

<p><strong>Great!</strong> The Pokemons were successfully sorted by their <strong>Total stats</strong> from smallest to largest. The sort commands work for both text and numbers.</p>

<hr>

<h2>A Non-Working Example (sorting one column in a range)</h2>

<p>In this example we have two columns with related data. Column <strong>A</strong> is the Pokemons <strong>Names</strong> and Column <strong>B</strong> is their <strong>Total stats</strong>. Try sorting just one of the columns (<strong>A2:A21</strong>) ascending by their <strong>Names</strong>.</p>

<p><img src="sort_8.png" style="max-width:100%;"></p>

<p>The attempt to sort results in a warning.</p>

<p><img src="sort_9.png" style="max-width:100%;"></p>

<p>It is not recommended to sort the names alone because it will break the relationship between the Pokemons <strong>Names</strong> and their <strong>Total stats</strong>.</p>

<p><strong>Click "Just sort" to see what happens.</strong></p>

<p><img src="sort_10.png" style="max-width:100%;"></p>

<p>This breaks the relationship with Column <strong>A</strong> and <strong>B</strong>. The Pokemons now have wrong Total stats.</p>

<p>Clicking the other option in the warning "Expand and Sort" makes the sort function include Column <strong>B</strong> and sorts them in relation to each other.</p>

<hr>

<h2>Sorting More Than One Column</h2>

<p>Select the whole range when sorting ranges with more than one column.</p>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> When sorting multiple columns, it will always sort by the first column (leftmost).</p>
</div>

<p><img src="sort_11.png" style="max-width:100%;"></p>

<p>Select <strong>A2:B21</strong> and sort the range ascending.</p>

<p><img src="sort_12.png" style="max-width:100%;"></p>

<p>By selecting range <strong>A2:B21</strong> it sorts correctly, keeping the relationship between the data (Column <strong>A</strong> and <strong>B</strong>).</p>

<p>In the next chapter you will learn about <strong>Filter</strong>.</p>
