...
<html lang="en-US">
<head>
<title>Excel Stacked Line Charts</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>Excel Stacked Line Charts</h1>

<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_charts_line.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_charts_line_stacked_100p.php">Next &#10095;</a>
</div>
...
<p>Stacked Line charts show the <strong>contribution to trends</strong> in the data.</p>

<p>This is done by stacking lines on top of each other.</p>

<p>Stacked Line charts are used with data which can be placed in an order, from low to high.</p>
...
<ol start="2"><li>Click on the <strong>Insert</strong> menu, then click on the Line menu (<img src="img_excel_line_menu.png" width="40" height="60" style="border: 1px solid rgb(220, 220, 220)">) and choose <strong>Stacked Line</strong> (<img src="img_excel_chart_line_icon_2.png" width="35" height="35" style="border: 1px solid rgb(220, 220, 220)">) from the drop-down menu</li></ol>

<p><img src="img_excel_chart_line_11.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<p>You should get the chart below:</p>

<p><img src="img_excel_chart_line_12.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<p>The chart gives a visual overview for the average Pokemon stats over generations.</p>

<p>The blue line shows the average HP, the orange line show the addition of average HP and Average attack. Finally, the gray line shows the sum of all the stats once all the average stats are added.</p>

<p>This chart shows that 4th generation Pokemon have the highest stats on average.</p>
...
<h2>Stacked Line with Markers</h2>

<p>Stacked line with markers highlights data points with markers on a stacked line chart.</p>
...
<ol start="2"><li>Click on the <strong>Insert</strong> menu, then click on the Line menu (<img src="img_excel_line_menu.png" width="40" height="60" style="border: 1px solid rgb(220, 220, 220)">) and choose <strong>Stacked Line with Markers</strong> (<img src="img_excel_chart_line_icon_5.png" width="35" height="35" style="border: 1px solid rgb(220, 220, 220)">) from the drop-down menu</li></ol>

<p><img src="img_excel_chart_line_13.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>

<p>You should get the chart below:</p>

<p><img src="img_excel_chart_line_14.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>
