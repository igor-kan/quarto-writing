...
<html lang="en-US">
<head>
<title>Excel Format Colors</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>Excel <span class="color_h1">Format Colors</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_format_painter.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_format_fonts.php">Next &#10095;</a>
</div>
<hr>

<h2>Colors</h2>

<p>Colors are specified by selection or by using Hexadecimal and RGB codes.</p>

<div class="ws-note w3-panel">
<p><strong>Tip:</strong> You can learn more about colors in our <a href="https://www.w3schools.com/colors/default.asp">HTML/CSS Colors Tutorial.</a></p>
</div>

<hr>

<h2>Theme and Standard Colors</h2>

<p>Excel has a set of themes and standard colors available for use. You select a color by clicking it:</p>

<p><img src="colors1.png" style="max-width:100%"></p>

<p>The "<strong>More Colors</strong>" option allows you to select custom colors by entering a RGB or HEX code.</p>
<p><img src="colors2.png" style="max-width:100%"></p>
<hr>

<h2>Hexadecimal Colors</h2>
<p>Excel supports Hexadecimal color values </p>
<p>A hexadecimal color is specified with: <code class="w3-codespan">#<span style="color:red">RR</span><span style="color:green">GG</span><span style="color:blue">BB</span></code>.</p>
<p>RR (red), GG (green) and BB (blue) are hexadecimal integers between 00 and FF specifying the intensity of the color.</p>
<p>For example, #0000FF is displayed as blue, because the blue component is set to its highest value (FF) and the others are set to 00.</p>
<hr>

<h2>RGB Colors</h2>
<p>Excel supports RGB color values.</p>
<p>An RGB color value is specified with: <code class="w3-codespan">rgb( <span style="color:red">RED</span> , <span style="color:green">GREEN</span> , <span style="color:blue">BLUE</span> )</code>.</p>
...
<div class="ws-note w3-panel">
<p><strong>Tip:</strong> Try W3schools.com color picker to find your color! <a href="https://www.w3schools.com/colors/colors_picker.asp">https://www.w3schools.com/colors/colors_picker.asp</a></p>
</div>
<hr>
...
<p>Colors can be applied to cells, text and borders.</p>
<p>Colors are applied to cells by using the "<strong>Fill color</strong>" function.</p>

<p>How to apply colors to cells:</p>
<ol>
<li>Select color</li>
<li>Select range</li>
<li>Click the Fill Color button</li>
</ol>
<p>The "<strong>Fill color</strong>" button remembers the color you used the last time.</p>
<p><img src="colors3.png" style="max-width:100%"></p>

<p>Color options are explored by clicking on the arrow-down icon (<img src="down_arrow.png" style="max-width:100%">), 
next to the Fill color command:</p>
<p><img src="colors4.png" style="max-width:100%"></p>
<p>The option allows selection of theme colors, standard colors or use of HEX or RGB codes by clicking on the More Colors option:</p>
<p><img src="colors5.png" style="max-width:100%"></p>
<p>Colors are made from red, green, blue and are universal. Entering a color in one way will give you the code in the other. For example if you enter a HEX code, it will give you the RGB code for the same color.</p>

<p><strong>Let's try some examples.</strong></p>

<p>Starting with <strong>theme </strong>and <strong>standard </strong>colors:</p>
<p><img src="colors6.png" style="max-width:100%"></p>
<p><img src="colors7.png" style="max-width:100%"></p>
<p><strong>Great!</strong></p>

<p>Try to apply the following colors:</p>
<ul>
<li>Theme color blue (accent 5) to A3:F3.</li>
<li>Theme color green (accent 6) and A5:F5.</li>
</ul>

<p><img src="colors8.png" style="max-width:100%"></p>

<p>Did you make it?</p>

<p>Let's apply colors using HEX and RGB codes.</p>

<p>Apply HEX code #ffcb05 to A7:F7:</p>

<p>Step by step:</p>
<ol>
<li>Select <code class="w3-codespan">A7:F7</code></li>
<li>Open color options</li>
<li>Click <strong>More colors</strong></li>
<li>Insert <code class="w3-codespan">#ffcb05</code> in the <strong>HEX</strong> input field</li>
<li>Hit enter</li>
</ol>
<p><img src="colors9.png" style="max-width:100%"></p>
<p><img src="colors10.png" style="max-width:100%"></p>
<p><img src="colors11.png" style="max-width:100%"></p>

<p>Notice that applying the HEX code gives the RGB code for the same color, and shows where that color is positioned on the color map.</p>
<p><img src="colors12.png" style="max-width:100%"></p>

<p>Apply RGB code <code class="w3-codespan">60</code>, <code class="w3-codespan">90</code>, <code class="w3-codespan">166</code> to <code class="w3-codespan">A9:F9</code></p>

<p>Step by step:</p>
<ul>
<li>Select <code class="w3-codespan">A9:F9</code></li>
<li>Open color options</li>
<li>Click More colors</li>
<li>Insert <code class="w3-codespan">60</code>, <code class="w3-codespan">90</code>, <code class="w3-codespan">166</code> in the <strong> RGB</strong> input field</li>
<li>Hit enter</li>
</ul>
<p><img src="colors13.png" style="max-width:100%"></p>
<p><img src="colors14.png" style="max-width:100%"></p>
<p><img src="colors15.png" style="max-width:100%"></p>
<p><img src="colors16.png" style="max-width:100%"></p>
<p>Notice that entering the RGB code also gives the HEX code and shows you where the color is positioned on the color map.</p>

<p><strong>Well done!</strong> You have successfully applied colors using the standard, theme, HEX and RGB codes.</p>
<hr>
