<!DOCTYPE html>
<html lang="en-US">
<head><title>Excel AVERAGEIFS Function</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_averageif.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_concat.php">Next &#10095;</a>
</div>
<hr>

<h2>AVERAGEIFS Function</h2>

<p>The <strong>AVERAGEIFS</strong> function is a premade function in Excel, which calculates the <a href="https://www.w3schools.com/statistics/statistics_mean.php">average</a> of a range based on one or more <strong>true</strong> or <strong>false</strong> <strong>condition</strong>.</p>
<p>It is typed <code class="w3-codespan">=AVERAGEIFS</code>:</p>
<div class="w3-example">
  <div class="w3-code notranslate">
    =AVERAGEIFS(<strong>average_range</strong>, <strong>criteria_range1</strong>, <strong>criteria1, ...</strong>)
  </div>
</div>
<p>The <strong>conditions</strong> are referred to as <code class="w3-codespan">critera1, criteria2, ..</code> and so on, which can check things like:</p>
<ul>
...
<p>The <code class="w3-codespan">criteria_range1</code>, <code class="w3-codespan">criteria_range2</code>, and so on, are the ranges where the function check for the conditions.</p>
<p>The <code class="w3-codespan">average_range</code> is the range where the function calculates the average.</p>
...
<h2>Example AVERAGEIFS function</h2>

<p>Find the average defense of Grass type 1st Generation Pokemon:</p>
<p>The conditions are that the type is &quot;Grass&quot; and Generation is 1.</p>
<div class="w3-example">
    <div class="w3-code notranslate" style="position:relative">
    <img src="img_excel_averageifs.png" style="max-width:100%">
    <textarea id="demo_excel_averageifs" style="display:none">
    Name	Type 1	Defense	Generation				
    Bulbasaur	Grass	49	1		Type	Gen.	Average Defense
    Ivysaur	Grass	63	1		Grass	1	
    Venusaur	Grass	83	1		Fire	1	
    Charmander	Fire	43	1		Grass	2	
    Charmeleon	Fire	58	1		Fire	2	
    Charizard	Fire	78	1				
    Chikorita	Grass	65	2				
    Bayleef	Grass	80	2				
    Meganium	Grass	100	2				
    Cyndaquil	Fire	43	2				
    Quilava	Fire	58	2				
    Typhlosion	Fire	78	2				
    </textarea>
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_averageifs')" title="Copy values to clipboard">Copy</button>
    </div>
</div>

<p>Example <strong>AVERAGEIFS</strong> function, step by step:</p>
<ol>
  <li>Select the cell <code class="w3-codespan">H3</code></li>
  <li>Type <code class="w3-codespan">=AVERAGEIFS</code></li>
  <li>Double click the <strong>AVERAGEIFS</strong> command</li>
</ol>
<p><img src="img_excel_averageifs2.png" style="max-width:100%"></p>
<ol start="4">
  <li>Specify the range for the average <code class="w3-codespan">C2:C13</code> (the Defense values)</li>
  <li>Type <code class="w3-codespan">,</code></li>
  <li>Specify the range for the first condition<code class="w3-codespan">B2:B13</code> (the Type 1 values)</li>
  <li>Type <code class="w3-codespan">,</code></li>
  <li>Specify the criteria (the cell <code class="w3-codespan">F3</code>, which has the value "Grass")</li>
  <li>Type <code class="w3-codespan">,</code></li>
  <li>Specify the range for the second condition<code class="w3-codespan">D2:D13</code> (the Generation values)</li>
  <li>Type <code class="w3-codespan">,</code></li>
  <li>Specify the criteria (the cell <code class="w3-codespan">G3</code>, which has the value "1")</li>
  <li>Hit enter</li>
</ol>
...
<div class="w3-panel ws-info">
  <p><strong>Note:</strong> You can add more conditions by repeating steps 9-12 before hitting enter.</p>
</div>
<p><img src="img_excel_averageifs3.png" style="max-width:100%"></p>
<p>The function now calculates the average defense value of the 1st Generation Grass type Pokemon: Bulbasaur, Ivysaur and Venusaur.</p>
<p>The function can be repeated for Fire type Pokemon and 2nd Generation to compare them:</p>
<p><img src="img_excel_averageifs4.png" style="max-width:100%"></p>
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> You can use the <a href="excel_filling.php">filling function</a> for the other rows, but make sure to use <a href="excel_abs_ref.php">absolute references</a> for the ranges.</p>
</div>
<p>Now, we can see the average defense values of each type between generations:</p>
<p><img src="img_excel_averageifs5.png" style="max-width:100%"></p>
<p>Notice how the 2nd Generation Grass type Pokemon got more defense, but the Fire type stayed the same.</p>
<br>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_averageif.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_concat.php">Next &#10095;</a>
