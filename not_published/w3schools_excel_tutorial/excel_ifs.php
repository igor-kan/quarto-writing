<!DOCTYPE html>
<html lang="en-US">
<head><title>Excel IFS Function</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_if.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_left.php">Next &#10095;</a>
</div>
<hr>

<h2>IFS Function</h2>

<p>The <strong>IFS</strong> function is a premade function in Excel, which returns values based on one or more <strong>true</strong> or <strong>false</strong> <strong>conditions</strong>.</p>
<p>It is typed <code class="w3-codespan">=IFS</code> and has two or more parts:</p>
<div class="w3-example">
  <div class="w3-code notranslate">
  =IFS(<strong>logical_test1</strong>, <strong>value_if_true1</strong>, <strong>[logical_test2, value_if_true2]</strong>, <strong>[logical_test3;</strong> ...)
  </div>
</div>
<p>The <strong>conditions</strong> are referred to as <code class="w3-codespan">logical_test1, logical_test2, ...</code>, which can check things like:</p>
<ul>
...
<p>Each condition is connected with a return value.</p>
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> More than one condition can be true so the function will return the value for the first true condition.</p>
</div>
<div class="w3-panel ws-note">
...
<h2>Example IFS function</h2>

<p>Make categories for how fast the Pokemon are:</p>
<p>The conditions and return values are:</p>
<ul>
    <li>Speed <strong>more than</strong> 90: "Fast"</li>
    <li>Speed <strong>more than</strong> 50: "Normal"</li>
    <li>Speed <strong>less than or equal to</strong> 50: "Slow"</li>
</ul>
<div class="w3-example">
    <div class="w3-code notranslate" style="position:relative">
    <img src="img_excel_ifs.png" style="max-width:100%">
    <textarea id="demo_excel_ifs" style="display:none">
    ...
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_ifs')" title="Copy values to clipboard">Copy</button>
    </div>
    <p>
    <a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_ifs">Try it Yourself &raquo;</a>
    </p>
</div>
...
<p>Example <strong>IFS</strong> function, step by step:</p>
<ol>
  <li>Select the cell <code class="w3-codespan">D2</code></li>
  <li>Type <code class="w3-codespan">=IFS</code></li>
  <li>Double click the <strong>IFS</strong> command</li>
</ol>
<p><img src="img_excel_ifs2.png" style="max-width:100%"></p>
<ol start="4">
  <li>Specify the first condition <code class="w3-codespan">C2>90</code></li>
  <li>Type <code class="w3-codespan">,</code></li>
  <li>Specify the value <code class="w3-codespan">"Fast"</code> for when the first condition is <strong>TRUE</strong></li>
  <li>Type <code class="w3-codespan">,</code></li>
  <li>Specify the second condition <code class="w3-codespan">C2>50</code></li>
  <li>Type <code class="w3-codespan">,</code></li>
  <li>Specify the value <code class="w3-codespan">"Normal"</code> for when the second condition is <strong>TRUE</strong></li>
  <li>Type <code class="w3-codespan">,</code></li>
  <li>Specify the third condition <code class="w3-codespan">C2<=50</code></li>
  <li>Type <code class="w3-codespan">,</code></li>
  <li>Specify the value <code class="w3-codespan">"Slow"</code> for when the third condition is <strong>TRUE</strong></li>
  <li>Hit enter</li>
</ol>
<p><img src="img_excel_ifs3.png" style="max-width:100%"></p>
<p>Since the value in cell <code class="w3-codespan">C2</code> is &quot;45&quot;, the first and second conditions are <strong>false</strong>, and third condition is <strong>true</strong> (less than or equal to 50), the function will return &quot;Slow&quot;.</p>
<div class="w3-panel ws-note">
...
<p><img src="img_excel_ifs4.png" style="max-width:100%"></p>
<div class="w3-panel ws-note">
    <p><strong>Note:</strong> The third condition <code class="w3-codespan"><=50</code> includes <code class="w3-codespan">=</code> so that 50 is included in &quot;less than or <strong>equal</strong> to 50&quot;</p>
  </div>
<p>Now, each Pokemon has a speed category:</p>
<div class="w3-example">
<div class="w3-code notranslate" style="position:relative">
<img src="img_excel_ifs5.png" style="max-width:100%">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_ifs_finished">Try it Yourself &raquo;</a>
</p>
</div>
<br>
<div class="w3-clear nextprev">
