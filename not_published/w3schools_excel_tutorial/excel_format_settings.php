<!DOCTYPE html>
<html lang="en-US">
<head><title>Excel Regional Format Settings</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>Excel Regional Format Settings</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_format_grids.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_sort.php">Next &#10095;</a>
</div>
<hr>
<h2>Regional Format Settings</h2>
<p>Excel provides regional formatting settings for different languages and styles of presenting information.</p>
<p>Regional settings affects a number of things, like:</p>
<ul>
    <li>Calendar date formatting</li>
    <li>Decimal numbers</li>
    <li>Default currency formatting</li>
    <li>Formula delimiters</li>
</ul>
<p><strong>Formula delimiters</strong> are the symbols used to separate arguments in a function.</p>
<p>The most common symbols are comma <code class="w3-codespan">,</code> and semicolon <code class="w3-codespan">;</code></p>
<p>For example, the <strong>English</strong> regional language setting uses commas:</p>
<div class="w3-example">
    <div class="w3-code notranslate">
    =AND(<strong>[logical1]</strong>, <strong>[logical2]</strong>, ...)
    </div>
</div>
<p>While <strong>German</strong> regional language settings uses semicolons:</p>
<div class="w3-example">
  <div class="w3-code notranslate">
  =AND(<strong>[logical1]</strong>; <strong>[logical2]</strong>; ...)
</div>
...
<hr>
<h2>Example Regional Format Settings</h2>
<p>Here are the date, decimal number, and formula delimiters shown with <strong>English (US)</strong> settings:</p>
<p><img src="img_excel_us_formats.png" style="max-width:100%"></p>
<p>Here are the date, decimal number, and formula delimiters shown with <strong>German</strong> settings:</p>
<p><img src="img_excel_german_formats.png" style="max-width:100%"></p>
<p>Notice that the English (US) formatting uses month/day/year and the German formatting uses day.month.year for calendar dates.</p>
<p>The English (US) formatting also uses a period (<code class="w3-codespan">.</code>) for the decimal symbol and the German formatting uses a comma (<code class="w3-codespan">,</code>).</p>
<div class="w3-panel ws-note">
    <p><strong>Note:</strong> Changing the regional format settings will <strong>automatically</strong> convert any existing values and formulas in your spreadsheet.
</div>
<hr>
...
<h2>Changing Regional Format Settings</h2>
<p>Changing Regional Format Settings is accessed in the options part of the <strong>File</strong> menu:</p>
<p><img src="img_excel_regional_settings.png" style="max-width:100%"></p>
<p>Selecting this option will open a dialog box where you can choose your preferred regional language settings:</p>
<p><img src="img_excel_language_selection.png" style="max-width:100%"></p>
<hr>
