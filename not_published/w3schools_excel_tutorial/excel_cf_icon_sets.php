<!DOCTYPE html>
<html lang="en-US">
<head><title>Excel Conditional Formatting - Icon Sets</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_cf_color_scales.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_cf_manage_rules.php">Next &#10095;</a>
</div>
<hr>

<h2>Icon Sets</h2>

<p>Icon Sets are premade types of conditional formatting in Excel used to add icons to cells in a range to indicate how large the cell values are compared to the other values in the range.</p>
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> Icon Sets can be used together with other conditional formatting rules.</p>
</div>
<hr>

<h2>Icon Sets Options</h2>

<p>Excel has a number of different icon sets, organized as:</p>
<h3>Directional</h3>
<img src="img_excel_cf_is_d.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%">
<h3>Shapes</h3>
<img src="img_excel_cf_is_s.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%">
<h3>Indicators</h3>
<img src="img_excel_cf_is_i.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%">
<h3>Ratings</h3>
<img src="img_excel_cf_is_r.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%">
<hr>
<div id="midcontentadcontainer" style="overflow:auto;text-align:center">
<!-- MidContent -->
<!-- <p class="adtext">Advertisement</p> -->
</div><hr>
<h2>Icon Set Formatting Example</h2>
<p>Add icons to the Speed values of each Pokemon with <strong>Icon Set</strong> conditional formatting.</p>
<div class="w3-example">
    <h3>Example</h3>
    <div class="w3-code notranslate" style="position:relative">
    <img src="img_excel_cf_is.png" style="max-width:100%">
    <textarea id="demo_excel_cf_is" style="display:none">
      Bulbasaur	Grass	45
      Ivysaur	Grass	60
      Venusaur	Grass	80
      Charmander	Fire	65
    ...
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_cf_is')" title="Copy values to clipboard">Copy</button>
    </div>
</div>
<p>Icon Sets, step by step:</p>
<ol>
    <li>Select the range of Speed values <code class="w3-codespan">C2:C10</code></li>
</ol>
<p><img src="img_excel_cf_is2.png" style="max-width:100%"></p>
<ol start="2">
    <li>Click on the Conditional Formatting icon <img src="img_excel_cf_icon.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"> in the ribbon, from the <strong>Home</strong> menu</li>
    <li>Select <strong>Icon Sets</strong> from the drop-down menu</li>    <li>Click on the &quot;3 Traffic Lights (Unrimmed)&quot; option</li>
</ol>
<p><img src="img_excel_cf_is_menu.png" style="max-width:100%"></p>
<p>Now, the Speed value cells will have icons indicating how large the values are compared to the other values in the range:</p>
<p><img src="img_excel_cf_is3.png" style="border: 1px solid rgb(220, 220, 220); max-width:100%"></p>
<p>The green traffic light is used for the highest values, yellow for the middle values, and red for the lowest values.</p>
<p>Excel automatically calculates and chooses which values get which colored traffic light icon.</p>
<div class="w3-panel ws-note">
