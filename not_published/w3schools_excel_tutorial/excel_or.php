<!DOCTYPE html>
<html lang="en-US">
<head><title>Excel OR Function</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_npv.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_rand.php">Next &#10095;</a>
</div>
<hr>

<h2>OR Function</h2>

<p>The <strong>OR</strong> function is a premade function in Excel, which returns <strong>TRUE</strong> or <strong>FALSE</strong> based on two or more <strong>conditions</strong>.</p>
<p>It is typed <code class="w3-codespan">=OR</code>.</p>
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> The OR function is often used together with the <a href="excel_if.php">IF function</a>.</p>
</div>
<div class="w3-example">
  <div class="w3-code notranslate">
    =OR(<strong>[logical1]</strong>, <strong>[logical2]</strong>, ...)
  </div>
</div>
...
<h2>Example OR Function</h2>

<p>Check if the Pokemon type is water <strong>OR</strong> has defense <strong>greater than</strong> 60:</p>
<p>The function returns &quot;TRUE&quot; or &quot;FALSE&quot;.</p>
<div class="w3-example">
    <div class="w3-code notranslate" style="position:relative">
    <img src="img_excel_or.png" style="max-width:100%">
    <textarea id="demo_excel_or" style="display:none">
    ...
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_or')" title="Copy values to clipboard">Copy</button>
    </div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_or">Try it Yourself &raquo;</a>
</p>
</div>
<p>Example <strong>OR</strong> function, step by step:</p>
<ol>
  <li>Select the cell <code class="w3-codespan">D2</code></li>
  <li>Type <code class="w3-codespan">=OR</code></li>
  <li>Double click the <strong>OR</strong> command</li>
</ol>
<p><img src="img_excel_or2.png" style="max-width:100%"></p>
<ol start="4">
  <li>Specify the first condition <code class="w3-codespan">B2="Water"</code></li>
...
<p><img src="img_excel_or3.png" style="max-width:100%"></p>
<p>Since the value in cell <code class="w3-codespan">B2</code> is not &quot;Water&quot; the first condition is <strong>FALSE</strong>.</p>
<p>Since the value in cell <code class="w3-codespan">C2</code> is less than 60 the second condition is also <strong>FALSE</strong>.</p>
<p><strong>At least one</strong> condition need to be <strong>TRUE</strong> for the OR function to return <strong>TRUE</strong>.</p>
<div class="w3-panel ws-note">
...
<p><img src="img_excel_or4.png" style="max-width:100%"></p>
<p>Now, each row has a check for Water Type <strong>or</strong> Defense greater than 60:</p>
<div class="w3-example">
<div class="w3-code notranslate" style="position:relative">
<img src="img_excel_or5.png" style="max-width:100%">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_or_finished">Try it Yourself &raquo;</a>
</p>
</div>
<p>For example:</p>
<ul>
  <li>Ivysaur is <strong>not</strong> Water type, but it has <strong>more</strong> than 60 defense, so the function returns &quot;TRUE&quot;.</li>
  <li>Charmeleon is <strong>not</strong> Water type, and has <strong>less</strong> than 60 defense, so the function returns &quot;FALSE&quot;</li>
  <li>Wartortle is <strong>both</strong> Water type and has <strong>more</strong> than 60 defense, so the function returns &quot;TRUE&quot; </li>
</ul>
<hr>
...
<h2>Example OR Function (with IF)</h2>

<p>Combining the OR function with an <a href="excel_if.php">IF function</a> lets you check <strong>multiple</strong> conditions for the IF function:</p><div class="w3-panel ws-note">
...
<p>The OR function takes the place of the <code class="w3-codespan">logical_test</code> condition.</p>
<p>Here, the <strong>IF</strong> function returns "Yes" or "No".</p>
<p>Example <strong>OR</strong> function as the condition for <strong>IF</strong> function, step by step:</p>
<ol>
  <li>Select cell <code class="w3-codespan">D2</code></li>
  <li>Type <code class="w3-codespan">=IF</code></li>
  <li>Double click the <strong>IF</strong> command</li>
</ol>
<p><img src="img_excel_if_or.png" style="max-width:100%"></p>
<ol start="4">
  <li>Type <code class="w3-codespan">OR</code></li>
  <li>Double click the <strong>OR</strong> command </li>
</ol>
<p><img src="img_excel_if_or2.png" style="max-width:100%"></p>
<ol start="7">
  <li>Specify the first condition <code class="w3-codespan">B2="Water"</code></li>
  <li>Type <code class="w3-codespan">,</code></li>
  <li>Specify the second condition <code class="w3-codespan">C2>60</code></li>
  <li>Type <code class="w3-codespan">),</code></li>
  <li>Specify the value <code class="w3-codespan">"Yes"</code> for when either or both conditions are <strong>TRUE</strong></li>
  <li>Type <code class="w3-codespan">,</code></li>
  <li>Specify the value <code class="w3-codespan">"No"</code> for when both conditions are <strong>FALSE</strong></li>
  <li>Type <code class="w3-codespan">)</code> and hit enter</li>
</ol>
<p><img src="img_excel_if_or3.png" style="max-width:100%"></p>
<p>The function can be repeated with the <a href="excel_filling.php">filling function</a> for each row to perform the same check for each Pokemon:</p>
<p><img src="img_excel_if_or4.png" style="max-width:100%"></p>
<p>Now, each row has a check for Water Type <strong>or</strong> Defense greater than 60:</p>
<div class="w3-example">
<div class="w3-code notranslate" style="position:relative">
<img src="img_excel_if_or5.png" style="max-width:100%">
</div>
<p>
<a target="_blank" class="w3-btn" href="tryexcel.php?filename=demo_func_or_if_finished">Try it Yourself &raquo;</a>
</p>
</div>
<p>For example:</p>
<ul>
    <li>Ivysaur is <strong>not</strong> Water type, but it has <strong>more</strong> than 60 defense, so the function returns &quot;Yes&quot;.</li>
    <li>Charmeleon is <strong>not</strong> Water type, and has <strong>less</strong> than 60 defense, so the function returns &quot;No&quot;</li>
    <li>Wartortle is <strong>both</strong> Water type and has <strong>more</strong> than 60 defense, so the function returns &quot;Yes&quot; </li>
</ul>
<hr>
