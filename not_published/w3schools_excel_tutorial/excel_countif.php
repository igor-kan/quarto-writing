...
<h1>Excel <span class="color_h1">COUNTIF Function</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_countblank.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_countifs.php">Next &#10095;</a>
</div>
<hr>

<h2>COUNTIF Function</h2>

<p>The <strong>COUNTIF</strong> function is a premade function in Excel, which counts cells as specified.</p>
<p>It is typed <code class="w3-codespan">=COUNTIF</code></p>
<div class="ws-note w3-panel">
<p><strong>NOTE:</strong> The <strong>COUNTIF </strong>function can have basic or more advanced uses. This covers the basic use for how to count specific numbers and words.</p>
</div>
<p>Numbers (e.g. 90) and words (e.g. "Water") can be specified.</p>

<p>How to use the <code class="w3-codespan">=COUNTIF</code> function:</p>
<ol>
<li>Select a cell</li>
<li>Type <code class="w3-codespan">=COUNTIF</code></li>
<li>Double click the <strong>COUNTIF</strong> command</li>
<li>Select a range</li>
<li>Type <code class="w3-codespan">,</code></li>
<li>Select a cell (the criteria, the value that you want to count)</li>
<li>Hit enter</li>
</ol>
...
<p>Apply the <code class="w3-codespan">COUNTIF</code> function to range <code class="w3-codespan">B2:B21</code>, to count how many Pokemons we have in the different types:</p>
<div class="w3-example">
    <div class="w3-code notranslate" style="position:relative">
    <img src="countif.png" style="max-width:100%">
    <textarea id="demo_excel_countif" style="display:none">
    Name	Type 1	Type 2	Total stats		
    Mankey	Fighting		305		
    Poliwrath	Water	Fighting	510		
    Victreebel	Grass	Poison	490		
    Tentacool	Water	Poison	335		Grass
    Magneton	Electric	Steel	465		Water
    Dewgong	Water	Ice	475		Electric
    Cloyster	Water	Ice	525		Fighting
    Onix	Rock	Ground	385		Rock
    Dragonair	Dragon		420		Dragon
    Pidgeotto	Normal	Flying	349		Normal
    Rattata	Normal		253		Bug
    Beedrill	Bug	Poison	395		Poison
    Doduo	Normal	Flying	310		Fire
    Kingler	Water		475		Ghost
    Nidoqueen	Poison	Ground	505		
    ...
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_countif')" title="Copy values to clipboard">Copy</button>
    </div>
</div>
<p>We want the <code class="w3-codespan">COUNTIF</code> function to count the types of Pokemons, in the range <code class="w3-codespan">G5:G15</code>:</p>


<p><img src="countif2.png" style="max-width:100%"></p>

<p><img src="countif3.png" style="max-width:100%"></p>

<p>The <code class="w3-codespan">,</code> is typed after the range is selected, which tells the function what you are looking to count.</p>


<p><img src="countif4.png" style="max-width:100%"></p>
<p><img src="countif5.png" style="max-width:100%"></p>
<p><img src="countif6.png" style="max-width:100%"></p>
<hr>

<p>The <code class="w3-codespan">COUNTIF</code> function has successfully counted <code class="w3-codespan">1</code> Grass Pokemon, which is Victreebel (<code class="w3-codespan">A4</code>).</p>

<p>Let's count the Water Pokemons in <code class="w3-codespan">G6</code></p>

<p>The same steps apply</p>
<ol>
<li>Select <code class="w3-codespan">G6</code></li>
<li>Type <code class="w3-codespan">=COUNTIF</code></li>
<li>Select <code class="w3-codespan">B2:B21</code></li>
<li>Type (<code class="w3-codespan">,</code>)</li>
<li>Select <code class="w3-codespan">F6</code> (Specifying Water as criteria)</li>
<li>Hit enter</li>
</ol>

<p><img src="countif7.png" style="max-width:100%"></p>
<p><img src="countif8.png" style="max-width:100%"></p>


<p>That is great! The <code class="w3-codespan">COUNTIF</code> function has counted <code class="w3-codespan">6</code> Water Pokemons in <code class="w3-codespan">B2:B21</code>.</p>

<p>Let's count the rest of the types more effectively. We want to continue the function from <code class="w3-codespan">G6:G15</code>. Making use of the <a href="excel_filling.php">Filling Function</a> and <a href="excel_abs_ref.php">Absolute References</a>.</p>

<p>Step by step:</p>
<ol>
<li>Double click <code class="w3-codespan">G6</code></li>
<li>Lock the range references absolute (<code class="w3-codespan">B2:B21</code>). Type dollar signs before the columns and row. Type 4 dollar signs in total. <code class="w3-codespan">=COUNTIF($B$2:$B$21,F6)</code>.

<strong>Note:</strong> We want <code class="w3-codespan">F6</code> to remain relative. Because we want it to move downwards. Do not add dollar signs ($) to it.</li>


<li>Hit enter</li>
<li>Fill the range <code class="w3-codespan">G6:G15</code></li>
</ol>
<p><img src="countif9.png" style="max-width:100%"></p>
<p><img src="countif10.png" style="max-width:100%"></p>
<p><img src="countif11.png" style="max-width:100%"></p>

<p>That saved us alot of time! <strong>Good job!</strong></p>
<hr>
...
<p>Fill <code class="w3-codespan">G5:G15</code> without locking the references to see what happens.</p>
<p><img src="countif12.png" style="max-width:100%"></p>

<p>If the references for the range are kept relative, the fill function will move the range downwards, including blank cells and missing the range where the data is. </p>
<hr>
