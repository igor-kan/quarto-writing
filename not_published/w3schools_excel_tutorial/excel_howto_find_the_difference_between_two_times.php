<!DOCTYPE html>
<html lang="en-US">
<head><title>How to Find the Difference Between Two Times Using Excel</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>How to Find the Difference Between Two Times Using Excel</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_howto_convert_time_to_seconds.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_howto_net_present_value.php">Next &#10095;</a>
</div>
<hr>

<p class="intro">Learn how to find the difference between two times using Excel.</p>
<hr>
<p>Time can be converted into seconds using Excel.</p>
<p>The number <code class="w3-codespan">86400</code> can be used to convert time to seconds.</p>
<img src="img_excel_conversion_number.png" style="max-width:550px; height:auto; width:100%; border: solid 0.5px;" alt="Conversion number 86400">
<p>Read more about 86400 in the <a href="excel_howto_convert_time_to_seconds.php" target="_blank">How to Convert Time to Seconds Chapter</a></p>
<hr>

<h2>How to find the difference between two times?</h2>
<h5><strong>Step 1)</strong> Create a sheet and set up values:</h5>
<p>In this example, we will find the seconds between <code class="w3-codespan">14:00(A2)</code>Time A and <code class="w3-codespan">16:00(A3)</code> Time B.</p>
...
<div class="w3-example">
    ...
    <img src="img_excel_time_calculation_setup_seconds.png" style="max-width:550px; height:auto; width:100%;" alt="Time to seconds setup">
    <textarea id="demo_excel_trim" style="display:none">
    Time	Seconds			Conversion number	86400
Time A	14:00				Minutes	60
Time B	16:00				Hours	60
    ...
    <button class="w3-btn ws-copy-btn" onclick="copyFormulas('demo_excel_trim')" title="Copy values to clipboard">Copy</button>
    </div>
</div>
<hr>
<div class="ws-note ws-info">
  <p><strong>Info:</strong></p>
  <p>Excel can change the format when you use the 86400 number.</p>
  <p>Make sure to change the format back to number if it changes to time format.</p>
</div> 
<hr>

<h5><strong>Step 2)</strong> Convert time to seconds:</h5>
<p>Let us multiply the time by 86400.</p>
<p>Select cell <code class=w3-codespan>C2</code></p>
<p>Convert time to seconds for <strong>Time A:</strong></p>
<div class="w3-example">
  <h3>Calculation</h3>
  <div class="w3-code notranslate">
  <code class="w3-codespan"> B2(14:00) * G1(86400) = 50400</code>
  </div>
<img src="img_excel_find_seconds.png" style="max-width:550px; height: auto; width:100%;" alt="Time to seconds">
</div>
<p>Repeat the same for <strong>Time B: </strong>(<code class="w3-codespan">B3(16:00) * G1(86400)</code>)</p>
<hr>


<h5><strong>Step 3)</strong> Find the difference in seconds:</h5>
<p>Select cell <code class=w3-codespan>F9</code></p>
<p>Deduct <strong>Time B</strong> from <strong>Time A</strong> to find the difference.</p>
<p>Use the converted seconds to calculate (the numbers in Column C).</p>
<div class="w3-example">
  <h3>Calculation</h3>
  <div class="w3-code notranslate">
  <code class="w3-codespan"> C3(57600) - C2(50400) = 7200 Seconds</code>
  </div>
<img src="img_excel_difference_time_a_time_b.png" style="max-width:550px; height: auto; width:100%;" alt="Difference between Time A and Time B">
</div>
...
<h5><strong>Step 4)</strong> Convert Seconds to Minutes:</h5>
<p>Divide the seconds on 60 to find the minutes.</p>
<p>Select cell <code class=w3-codespan>F10</code></p>
<div class="w3-example">
  <h3>Calculation</h3>
  <div class="w3-code notranslate">
  <code class="w3-codespan"> F9(7200) / G2(60) = 120 Minutes</code>
  </div>
<img src="img_excel_convert_to_minutes.png" style="max-width:550px; height: auto; width:100%;" alt="Seconds converted to minutes">
</div>
<hr>

<h5><strong>Step 5)</strong> Convert Minutes to Hours:</h5>
<p>Divide the minutes on 60 to find the hours.</p>
<p>Select cell <code class=w3-codespan>F11</code></p>
<div class="w3-example">
  <h3>Calculation</h3>
  <div class="w3-code notranslate">
  <code class="w3-codespan"> F9(120) / G3(60) = 2 Hours</code>
  </div>
<img src="img_excel_convert_to_hours.png" style="max-width:550px; height: auto; width:100%;" alt="Seconds converted to minutes">
</div>
<hr>
<p><strong>Good job!</strong></p>
<p>You have successfully found the time between two times, <code class="w3-codespan">14:00</code> and <code class="w3-codespan">16:00</code>.</p>
<p>In this case, the right answer was <code class="w3-codespan">7200 Seconds or 120 Minutes or 2 hours</code>.</p>
