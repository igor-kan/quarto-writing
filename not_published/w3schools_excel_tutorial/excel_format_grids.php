...
<html lang="en-US">
<head>
<title>Excel Format Grids</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>Excel <span class="color_h1">Format Grids</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="excel_format_numbers.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="excel_format_settings.php">Next &#10095;</a>
</div>
<hr>

<h2>Grids</h2>

<p>By default, gridlines are displayed in Excel.</p>

<p>However, grids can be removed.</p>

<p>Why remove grids?</p>
<ul>
<li>Make the spreadsheet more readable</li>
<li>Make the spreadsheet more delicate</li>
</ul>

<p>How to remove grids</p>
<ol>
<li>Click view in the Ribbon navigation bar</li>
<li>Uncheck gridlines</li>
</ol>

<p><img src="grids1.png" style="max-width:100%"></p>

<p><strong>Example before removing gridlines:</strong></p>
<p><img src="grids2.png" style="max-width:100%"></p>
<p><strong>Example after:</strong></p>
<p><img src="grids3.png" style="max-width:100%"></p>

<div class="ws-note w3-panel">
<p><strong>Note:</strong> Removing gridlines, removes gridlines for all cells in the spreadsheet.</p>
</div>
<hr>
