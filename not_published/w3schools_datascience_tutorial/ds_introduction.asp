...
<h1>Data Science <span class="color_h1">Introduction</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="default.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ds_data.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Data Science is a combination of multiple disciplines that uses statistics, 
data analysis, and machine learning to analyze data and to extract knowledge and insights from it.</p>
<hr>

<h2>What is Data Science?</h2>
<p>Data Science is about data gathering, analysis and decision-making.</p>
<p>Data Science is about finding patterns in data, through analysis, and make 
future predictions.</p>
<p>By using Data Science, companies are able to make:</p>
<ul>
  <li>Better decisions (should we choose A or B)</li>
  <li>Predictive analysis (what will happen next?)</li>
  <li>Pattern discoveries (find pattern, or maybe hidden information in the 
  data)</li>
</ul>
<hr>

<h2>Where is Data Science Needed?</h2>
<p>Data Science is used in many industries 
in the world today, e.g. banking, consultancy, healthcare, and manufacturing.</p>
<p>Examples of where Data Science is needed:</p>
<div class="w3-panel ws-info">
  <ul>
    <li>For route planning: To discover the best routes to ship</li>
    <li>To foresee delays for flight/ship/train etc. (through predictive 
    analysis)</li>
    <li>To create promotional offers</li>
    <li>To find the best suited time to deliver goods</li>
    <li>To forecast the next years revenue for a company</li>
    <li>To analyze health benefit of training</li>
    <li>To predict who will win elections</li>
  </ul>
</div>  
<p>Data Science can be applied in nearly every part of a business where data is available. Examples are:</p>
<div class="w3-panel ws-info">
  <ul>
...
<h2>How Does a Data Scientist Work?</h2>
<p>A Data Scientist requires expertise in several 
backgrounds: </p>
<ul>
...
<p>A Data Scientist must find patterns within the data. Before he/she can find 
the patterns, he/she must organize the data in a standard format.</p>
<p>Here is how a Data Scientist works:</p>
<ol>
  <li><strong>Ask the right questions</strong> - To understand the business 
  problem.</li>
  <li><strong>Explore and collect data</strong> - From database, web logs, 
  customer feedback, etc.</li>
  <li><strong>Extract the data</strong> - Transform the data to a standardized 
format.</li>
  <li><strong>Clean the data</strong> - Remove erroneous values from the data.</li>
  <li><strong>Find and replace missing values</strong> - Check for 
missing values and replace them with a suitable value (e.g. an average value).</li>
  <li><strong>Normalize data</strong> - Scale the values in a practical range 
  (e.g. 140 cm is smaller than 1,8 m. However, the number 140 
is larger than 1,8. - so scaling is important).</li>
  <li><strong>Analyze data, find patterns and make future predictions</strong>.</li>
  <li><strong>Represent the result </strong>- Present the result with useful 
  insights in a way the &quot;company&quot; can understand.</li>
</ol>

<hr>

<h2>Where to Start?</h2>
<p>In this tutorial, we will start by presenting what data is and how data can be analyzed.</p>
<p>You will learn how to use statistics and mathematical functions to make 
predictions.</p>
