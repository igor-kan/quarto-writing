...
<html lang="en-US">
<head>
<title>Data Science Linear Regression Case</title>
<meta charset="utf-8">
...
<h1>Data Science <span class="color_h1">- Linear Regression Case</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="ds_linear_regression_rsquared.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="ds_exam.asp">Next &#10095;</a>
</div>
<hr>

<h2>Case: Use Duration + Average_Pulse to Predict Calorie_Burnage</h2>
<p>Create a Linear Regression Table with Average_Pulse and Duration as Explanatory Variables:</p>
<div class="w3-example">
  <h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  import pandas as pd<br>import statsmodels.formula.api as smf<br><br>full_health_data = pd.read_csv(&quot;data.csv&quot;, header=0, sep=&quot;,&quot;)<br>
  <br>model = smf.ols('Calorie_Burnage ~ Average_Pulse + Duration', data = full_health_data)<br>results 
  = model.fit()<br>print(results.summary())</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_linear_regression_case">Try it Yourself &raquo;</a>
</div>
<h3>Example Explained:</h3>
<ul>
  <li>Import the library statsmodels.formula.api as smf. Statsmodels 
  is a statistical library in Python.</li>
  <li>Use the full_health_data set.</li>
  <li>Create a model based on Ordinary Least Squares with smf.ols(). Notice that 
  the explanatory variable 
must be written first in the parenthesis. Use the full_health_data data set.</li>
  <li>By calling .fit(), you obtain the variable results. This holds a lot of 
  information about the regression model.</li>
  <li>Call summary() to get the table with the results of linear regression.</li>
</ul>

<h3>Output:</h3>
<img src="img_lr_table_case.png" style="max-width:100%;height:auto" alt="Linear Regression Table Case">
...
<h2>Define the Linear Regression Function in Python </h2>
<p>Define the linear regression function in Python to perform predictions.</p>
<p>What is Calorie_Burnage if:</p>
<ul>
  <li>Average pulse is 110 and duration of the training session is 60 minutes? </li>
  <li>Average pulse is 140 and duration of the training session is 45 minutes?</li>
  <li>Average pulse is 175 and duration of the training session is 20 minutes?</li>
</ul>
<div class="w3-example">
  <h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  def Predict_Calorie_Burnage(Average_Pulse, 
Duration):<br>&nbsp;return(3.1695*Average_Pulse + 5.8434 * Duration - 334.5194)<br><br>print(Predict_Calorie_Burnage(110,60))<br>print(Predict_Calorie_Burnage(140,45))<br>print(Predict_Calorie_Burnage(175,20))</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_lr_case">Try it Yourself &raquo;</a>
</div>

<p>The Answers:</p>
<ul>
  <li>Average pulse is 110 and duration of the training session is 60 minutes = 365 Calories</li>
  <li>Average pulse is 140 and duration of the training session is 45 minutes = 372 Calories</li>
  <li>Average pulse is 175 and duration of the training session is 20 minutes = 337 Calories
  </li>
</ul>
<hr>

<h2>Access the Coefficients </h2>
<p>Look at the coefficients:</p>
<ul>
  <li>Calorie_Burnage increases with 3.17 if Average_Pulse increases by one. </li>
  <li>Calorie_Burnage increases with 5.84 if Duration increases by one.</li>
</ul>
<hr>

<h2>Access the P-Value</h2>
<p>Look at the P-value for each coefficient.</p>
<ul>
  <li>P-value is 0.00 for Average_Pulse, Duration and the Intercept.</li>
  <li>The P-value is statistically significant for all of the variables, as it is less than 0.05.</li>
</ul>
<p>So here we can conclude that Average_Pulse and Duration has a relationship with Calorie_Burnage.</p>
<hr>

<h2>Adjusted R-Squared</h2>
<p>There is a problem with R-squared if we have more than one explanatory variable. </p>
<p>R-squared will almost always increase if we add more variables, and will never decrease. </p>
<p>This is because we are adding more data points around the linear regression function. </p>
<p>If we add random variables that does not affect Calorie_Burnage, we risk to falsely conclude that the 
linear regression function is a good fit. Adjusted R-squared adjusts for this problem. </p>
<p>It is therefore better to look at the adjusted R-squared value if we have more than one explanatory variable. </p>
<p>The Adjusted R-squared is 0.814.</p>
<p>The value of R-Squared is always between 0 to 1 (0% to 100%).</p>
<ul>
  <li>A high R-Squared value means that many data points are close to the linear regression function line.</li>
  <li>A low R-Squared value means that the linear regression function line does not fit the data well. 
  </li>
</ul>
<p>Conclusion: The model fits the data point well!</p>
