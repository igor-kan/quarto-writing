...
<html lang="en-US">
<head>
<title>Data Science Linear Regression Table</title>
<meta charset="utf-8">
...
<h1>Data Science <span class="color_h1">- Regression Table</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="ds_linear_regression.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="ds_linear_regression_info.asp">Next &#10095;</a>
</div>
<hr>

<h2>Regression Table</h2>
<p>The output from linear regression can be summarized in a regression table.</p>
<p>The content of the table includes:</p>
<ul>
  ...
  <li>Other information that we will not cover in this module </li>
</ul>
<hr>

<h2>Regression Table with Average_Pulse as Explanatory Variable</h2>
<img src="img_lr_table.png" style="max-width:100%;height:auto" alt="Linear Regression Table">
<p>You can now begin your journey on analyzing advanced output!</p>
<hr>

<h2>Create a Linear Regression Table in Python</h2>
<p>Here is how to create a linear regression table in Python:</p>
...
<div class="w3-code notranslate pythonHigh">
  ...
  <br>model = smf.ols('Calorie_Burnage ~ Average_Pulse', data = 
full_health_data)<br>results = model.fit()<br>print(results.summary())</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_linear_regression_table">Try it Yourself &raquo;</a>
