...
<html lang="en-US">
<head>
<title>Data Science Statistics Correlation vs Causality</title>
<meta charset="utf-8">
...
<h1>Data Science <span class="color_h1">- Statistics Correlation vs. Causality</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="ds_stat_correlation_matrix.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="ds_linear_regression.asp">Next &#10095;</a>
</div>
<hr>
...
<ul>
  <li>During the summer, the sale of ice cream at a beach increases </li>
  <li>Simultaneously, drowning accidents also increase as well</li>
</ul>
<p>Does this 
...
<h2>The Beach Example in Python</h2>
<p>Here, we constructed a fictional data set for you to try: </p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  import pandas as pd<br>import matplotlib.pyplot as plt<br><br>
  Drowning_Accident = [20,40,60,80,100,120,140,160,180,200]<br>Ice_Cream_Sale = 
  [20,40,60,80,100,120,140,160,180,200]<br>Drowning = {&quot;Drowning_Accident&quot;: 
  [20,40,60,80,100,120,140,160,180,200],<br>&quot;Ice_Cream_Sale&quot;: 
  [20,40,60,80,100,120,140,160,180,200]}<br>Drowning = pd.DataFrame(data=Drowning)<br>
  <br>Drowning.plot(x=&quot;Ice_Cream_Sale&quot;, y=&quot;Drowning_Accident&quot;, kind=&quot;scatter&quot;)<br>
  plt.show()<br><br>correlation_beach = Drowning.corr()<br>
  print(correlation_beach)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_corr_cas">Try it Yourself &raquo;</a>
</div>
<p>Output:</p>
<img src="img_tryit_corr_cas.png" style="max-width:100%;height:auto" alt="Correlation vs. Causality">
<hr>

<h2>Correlation vs Causality - The Beach Example </h2>
<p>In other words: can we use ice cream sale to predict drowning accidents? </p>
<p>The answer is - Probably not. </p>
<p>It is likely that these two variables are accidentally correlating with each other.</p>
<p>What causes drowning then?</p>
<ul>
  ...
  <li>Alcohol (mis)use</li>
  <li>etc.</li>
</ul>
<p>Let us reverse the argument:</p>
<p>Does a low correlation coefficient (close to zero) mean that change in x does not affect y?</p>
<p>Back to the question: </p>
<ul>
  <li>Can we conclude that Average_Pulse does not affect Calorie_Burnage because of a low correlation 
coefficient? </li>
</ul>
<p>The answer is no.</p>
<p>There is an important difference between correlation and causality: </p>
<ul>
  <li>Correlation is a number that measures how 
closely the data are related</li>
  <li>Causality is the conclusion that x causes y.</li>
</ul>
<div class="w3-panel ws-note">
<p><strong>Tip:</strong> Always critically reflect over the concept of causality when doing predictions!</p>
</div>
