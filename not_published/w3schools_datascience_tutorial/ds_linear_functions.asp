...
<html lang="en-US">
<head>
<title>Data Science Linear Functions</title>
<meta charset="utf-8">
...
<h1>Data Science <span class="color_h1">- Linear Functions</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="ds_analyze_data.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="ds_linear_functions_graphic.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Mathematical functions are important to know as a data 
scientist, because we want to make predictions and interpret them.</p>
<hr>

<h2>Linear Functions</h2>
<p>In mathematics a function is used to relate one variable to another variable.</p>
<p>Suppose we consider the relationship between calorie burnage and average 
...
upon the average pulse.</p>
<p>Furthermore, it may be reasonable to assume that as the average pulse 
increases, so will the calorie burnage. Calorie burnage and average pulse are 
the two variables being considered.</p>
<p>Because the calorie burnage depends upon the average pulse, we say that 
calorie burnage is the dependent variable and the average pulse is the 
independent variable.</p>
<p>The relationship between a dependent and an independent variable can often be 
expressed mathematically using a formula (function).</p>
<p><strong>A linear function has one independent variable (x) and one dependent variable 
(y), and has the following form:</strong></p>
<div class="w3-code notranslate">
<div>
  y = f(x) = ax + b </div></div>

<p>This function is used to calculate a value for the dependent variable when we 
choose a value for the independent variable.</p>

<p>Explanation:</p>
<ul>
  <li>f(x) = the output (the dependant variable)</li>
  <li>x = the input (the independant variable)</li>
  <li>a = slope = is the coefficient of the independent variable. It gives the 
  rate of change of the dependent variable</li>
  <li>b = intercept = is the value of the dependent 
...
<h2>Linear Function With One Explanatory Variable</h2>
<p>A function with one explanatory variable means that we use one variable for 
prediction.</p>
<p>Let us say we want to predict calorie burnage using average pulse. We have 
the following formula: &nbsp;</p>
<div class="w3-code notranslate">
<div>f(x) = 2x + 80</div></div>

<p>Here, the numbers and variables means:</p>
<ul>
  <li>f(x) = The output. This number is where we get the predicted value of 
  Calorie_Burnage</li>
  <li>x = The input, which is Average_Pulse</li>
  <li>2 = Slope = Specifies how much Calorie_Burnage increases if Average_Pulse 
  increases by one. It tells us how &quot;steep&quot; the diagonal line is
  </li>
  <li>80 = Intercept = A fixed value. It is the value of the dependent variable 
  when x = 0</li>
</ul>
<hr>

<h2>Plotting a Linear Function</h2>
<p>The term linearity means a &quot;straight line&quot;. So, if you show a linear function 
graphically, the line will always be a straight line. The line can slope 
upwards, downwards, and in some cases may be horizontal or vertical.</p>
<p>Here is a graphical representation of the mathematical function above:</p>
<img src="img_linearity.png" style="max-width:100%;height:auto" alt="Linear function">
<h3>Graph Explanations:</h3>
<ul>
  <li>The horizontal axis is generally called the x-axis. Here, it 
represents Average_Pulse.</li>
  <li>The vertical axis is generally called 
the y-axis. Here, it represents Calorie_Burnage.</li>
  <li>Calorie_Burnage is a function of Average_Pulse, because 
Calorie_Burnage is assumed to be dependent on Average_Pulse.</li>
  <li>In other words, we 
use Average_Pulse to predict Calorie_Burnage. </li>
  <li>The blue (diagonal) line 
