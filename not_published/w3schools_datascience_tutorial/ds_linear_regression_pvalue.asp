...
<html lang="en-US">
<head>
<title>Data Science Linear Regression P-Value</title>
<meta charset="utf-8">
...
<h1>Data Science <span class="color_h1">- Regression Table: P-Value</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="ds_linear_regression_coeff.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="ds_linear_regression_rsquared.asp">Next &#10095;</a>
</div>
<hr>

<h2>The &quot;Statistics of the Coefficients Part&quot; in Regression Table</h2>
<img src="img_lr_table_coeff_stat.png" style="max-width:100%;height:auto" alt="Regression Table - Stats of Coefficients">
<p>Now, we want to test if the coefficients from the linear regression function has a significant impact on 
the dependent variable (Calorie_Burnage).</p>
<p>This means that we want to prove that it exists a relationship between Average_Pulse and Calorie_Burnage, using statistical tests. </p>
<p>There are four components that explains the statistics of the coefficients:</p>
<ul>
  <li><strong>std err</strong> stands for Standard Error</li>
  <li><strong>t</strong> is the &quot;t-value&quot; of the coefficients</li>
  <li><strong>P&gt;|t|</strong> is called the &quot;P-value&quot;</li>
  <li>&nbsp;<strong>[0.025&nbsp; 0.975]</strong> represents the confidence interval of the coefficients</li>
</ul>
<p>We will focus on understanding the &quot;P-value&quot; in this module.</p>
<hr>

<h2>The P-value</h2>
<p>The P-value is a statistical number to conclude if there is a relationship between Average_Pulse and Calorie_Burnage.</p>
<p>We test if the true value of the coefficient is equal to zero (no relationship). The statistical test for this is called Hypothesis testing.</p>
<ul>
  <li>A low P-value (&lt; 0.05) means that the coefficient is likely not to equal zero.</li>
  <li>A high P-value (&gt; 0.05) means that we cannot conclude that the explanatory variable affects the dependent variable (here: if Average_Pulse affects 
Calorie_Burnage).</li>
  <li>A high P-value is also called an insignificant P-value. </li>
</ul>
<hr>

<h2>Hypothesis Testing</h2>
<p>Hypothesis testing is a statistical procedure to test if your results are valid. </p>
<p>In our example, we are testing if the true coefficient of Average_Pulse and the intercept is equal to zero. </p>
<p>Hypothesis test has two statements. The null hypothesis and the alternative hypothesis. </p>
<ul>
  <li>The null hypothesis can be shortly written as H0</li>
  <li>The alternative hypothesis can be shortly written as HA</li>
</ul>
<p>Mathematically written:</p>
<div class="w3-code notranslate">
<div>
  H0: Average_Pulse = 0 <br>HA: Average_Pulse &#8800; 0<br>H0: Intercept = 
0 <br>HA: Intercept &#8800; 0 </div></div>

<p>The sign &#8800; means &quot;not equal to&quot;</p>
<hr>

<h2>Hypothesis Testing and P-value </h2>
<p>The null hypothesis can either be rejected or not.</p>
<p>If we reject the null hypothesis, we conclude that it exist a relationship between Average_Pulse and Calorie_Burnage. The P-value is 
used for this conclusion.</p>
<p>A common threshold of the P-value is 0.05. </p>
<p><strong>Note:</strong> A P-value of 0.05 means that 5% of the times, we will falsely reject the null hypothesis. It means that we accept that 5% of the times, we 
might falsely have concluded a relationship.</p>
<p>If the P-value is lower than 0.05, we can reject the null hypothesis and conclude that it exist a relationship between the variables.
</p>
<p>However, the P-value of Average_Pulse is 0.824. So, we cannot conclude a relationship between Average_Pulse 
and Calorie_Burnage.</p>
<p>It means that there is a 82.4% chance that the true coefficient of Average_Pulse is zero.</p>
<p>The intercept is used to adjust the regression function's ability to predict more precisely. It is therefore 
uncommon to interpret the P-value of the intercept.</p>
