...
<html lang="en-US">
<head>
<title>Data Science What is Data?</title>
<meta charset="utf-8">
...
<h1>Data Science <span class="color_h1">- What is Data?</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="ds_introduction.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ds_database.asp">Next &#10095;</a>
</div>
<hr>

<h2>What is Data?</h2>

<p>Data is a collection of information.</p>
<p>One purpose of Data Science is to structure data, making it interpretable and easy to work with.</p>
<p>Data can be categorized into two groups:</p>
<ul>
...
<p>Unstructured data is not organized. We must organize the data for analysis purposes.</p>
<div class="w3-row">
<p class="w3-half"><img src="img_unstructured_data.png" alt="Unstructured Data" style="width:100%;max-width:300px"></p>
<p class="w3-half"><img src="img_unstructured_data2.png" alt="Unstructured Data" style="width:100%;max-width:300px"></p>
</div>
<hr>

<h2>Structured Data</h2>
<p>Structured data is organized and easier to work with.</p>
<p><img src="img_structured_data.png" alt="Structured Data" style="width:100%;max-width:300px"></p>
<hr>

<h2>How to Structure Data?</h2>
<p>We can use an array or a database table to structure or present data.  </p>
<p>Example of an array:</p>
<div class="w3-code notranslate">
<div>[80, 85, 90, 95, 100, 105, 110, 115, 120, 125]</div></div>

<p>The following example shows how to create an array in Python:</p>
<div class="w3-example">
  <h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  Array = [80, 85, 90, 95, 100, 105, 110, 115, 120, 125]<br>print(Array)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_data_array">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
<p>It is common to work with very large data sets in Data Science.</p>
<p>In this tutorial we will try to make it as easy as possible to understand the concepts of 
Data Science. We will therefore work with a small data set that is easy to interpret.</p>
</div>
