...
<html lang="en-US">
<head>
<title>Data Science - Python DataFrame</title>
<meta charset="utf-8">
...
<h1>Data Science <span class="color_h1">- Python DataFrame</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="ds_python.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ds_functions.asp">Next &#10095;</a>
</div>
<hr>

<h2>Create a DataFrame with Pandas</h2>
<p>A data frame is a structured representation of data. </p>
<p>Let's define a data frame with 3 columns and 5 rows with fictional numbers:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  import pandas as pd<br><br>d = {'col1': [1, 2, 3, 4, 7], 'col2': [4, 5, 6, 9, 
  5], 'col3': [7, 8, 12, 1, 11]}<br><br>df = pd.DataFrame(data=d)<br><br>
  print(df)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dataframe">Try it Yourself &raquo;</a>
</div>
<h3>Example Explained</h3>
<ul>
  <li>Import the Pandas library as pd</li>
  <li>Define data with column and rows in a variable named d</li>
  <li>Create a data frame using the function pd.DataFrame()</li>
  <li>The data frame contains 3 columns and 5 rows</li>
  <li>Print the data frame output with the print() function</li>
</ul>
<div class="w3-panel ws-note">
  <p>We write <strong>pd.</strong> in front of <strong>DataFrame()</strong> to let Python know that we want to activate the DataFrame() function from the Pandas library.</p>
  <p>Be aware of the capital D and F in DataFrame!</p>
</div>
<hr>

<h2>Interpreting the Output</h2>
<p>This is the output:</p>
<p><img src="img_dataframe_output.png" alt="Dataframe Output" style="max-width:100%;height:auto"></p>
<p>We see that "col1", "col2" and "col3" are the names of the columns.</p>
<p>Do not be confused about the vertical numbers ranging from 0-4. They tell us the information about the position of the rows.</p>
<p>In Python, the numbering of rows starts with zero.</p>
<p>Now, we can use Python to count the columns and rows.</p>

<p>We can use df.shape[1] to find the number of columns:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Count the number of columns:</p>
<div class="w3-code notranslate pythonHigh">
count_column = df.shape[1]<br>print(count_column)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dataframe_columns">Try it Yourself &raquo;</a>
</div>

<p>We can use df.shape[0] to find the number of rows:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Count the number of rows:</p>
<div class="w3-code notranslate pythonHigh">
count_row = df.shape[0]<br>print(count_row)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_dataframe_rows">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
<h3>Why Can We Not Just Count the Rows and Columns Ourselves?</h3>
  <p>If we work with larger data sets with many columns and rows, it will be confusing to count it by yourself. 
You risk to count it wrongly.
If we use the built-in functions in Python correctly, we assure that the count is correct.</p>
</div>
