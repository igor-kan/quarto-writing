...
<html lang="en-US">
<head>
<title>Data Science Linear Regression Table Info</title>
<meta charset="utf-8">
...
<h1>Data Science <span class="color_h1">- Regression Table - Info</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="ds_linear_regression_table.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="ds_linear_regression_coeff.asp">Next &#10095;</a>
</div>
<hr>

<h2>The &quot;Information Part&quot; in Regression Table</h2>
<img src="img_lr_table_info.png" style="max-width:100%;height:auto" alt="Regression Table - Info">
<ul>
  <li><strong>Dep. Variable:</strong> is short for &quot;Dependent Variable&quot;. Calorie_Burnage is 
  here the dependent variable. The Dependent variable is here assumed to be explained by Average_Pulse.</li>
  <li><strong>Model:</strong> OLS is short for Ordinary Least Squares. This is a type of model that uses the Least Square method.</li>
  <li><strong>Date:</strong> and <strong>Time:</strong> shows the date and time the output was calculated in Python.</li>
</ul>
