...
<html lang="en-US">
<head>
<title>Data Science Functions</title>
<meta charset="utf-8">
...
<h1>Data Science <span class="color_h1">Functions</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="ds_python_dataframe.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="ds_analyze_data.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">This chapter shows three commonly used functions when working 
with Data Science: max(), min(), and mean().</p>
<hr>
...
<p>The data set above consists of 6 variables, each with 10 observations:</p>
<ul>
  <li><strong>Duration</strong> - How long lasted the training session in minutes?</li>
  <li><strong>Average_Pulse</strong> - What was the average pulse of the training session? This is measured by beats per minute</li>
  <li><strong>Max_Pulse</strong> - What was the max pulse of the training session?</li>
  <li><strong>Calorie_Burnage</strong> - How much calories were burnt on the training session?</li>
  <li><strong>Hours_Work</strong> - How many hours did we work at our job before the training session?</li>
  <li><strong>Hours_Sleep</strong> - How much did we sleep the night before the training session?</li>
</ul>
<div class="w3-panel ws-info">
  <p>We use underscore (_) to separate strings because Python cannot read space as separator.</p>
</div>
<hr>
...
<p>The Python <code class="w3-codespan">max()</code> function is used to find the highest value in an array. </p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  Average_pulse_max = max(80, 85, 90, 95, 100, 105, 110, 115, 120, 125)<br><br>print 
  (Average_pulse_max)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_function_max">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>The min() function</h2>
<p>The Python <code class="w3-codespan">min()</code> function is used to find the lowest value in an array. </p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  Average_pulse_min = min(80, 85, 90, 95, 100, 105, 110, 115, 120, 125)<br><br>print 
  (Average_pulse_min)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_function_min">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>The mean() function</h2>
<p>The NumPy <code class="w3-codespan">mean()</code> function is used to find the average value of an array.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>Calorie_burnage = 
  [240, 250, 260, 270, 280, 290, 300, 310, 320, 330]<br><br>Average_calorie_burnage = 
  np.mean(Calorie_burnage)<br><br>print(Average_calorie_burnage)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_function_mean">Try it Yourself &raquo;</a>
</div>
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> We write <strong>np.</strong> in front of <strong>mean</strong> to let Python know that we want to activate the <strong>mean</strong> function from the <strong>Numpy</strong> library.</p>
</div>
