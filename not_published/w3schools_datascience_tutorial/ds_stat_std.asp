...
<html lang="en-US">
<head>
<title>Data Science Statistics Standard Deviation</title>
<meta charset="utf-8">
...
<h1>Data Science <span class="color_h1">- Statistics Standard Deviation</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="ds_stat_percentiles.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="ds_stat_variance.asp">Next &#10095;</a>
</div>
<hr>

<h2>Standard Deviation</h2>
<p>Standard deviation is a number that describes how spread out the observations are.</p>
<img src="img_stat_std.png" style="max-width:100%;height:auto" alt="Standard Deviation">
<p>A mathematical function will have difficulties in predicting precise values, 
if the observations are &quot;spread&quot;. Standard deviation is a measure of uncertainty.</p>
...
<p><strong>Tip:</strong> Standard Deviation is often represented by the symbol Sigma: &#963;</p>
</div>

<p>We can use the <code class="w3-codespan">std()</code> function from Numpy to find the standard deviation of a variable:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
import numpy as np<br><br>std = np.std(full_health_data)<br>print(std)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython_multi_csv.asp?filename=demo_stat_std&multi=demo_data_full_multi">Try it Yourself &raquo;</a>
</div>
<p>The output:</p>
<img src="img_stat_std2.png" style="max-width:100%;height:auto" alt="Standard Deviation">
<p>What does these numbers mean? </p>
<hr>

<h2>Coefficient of Variation</h2>
<p>The coefficient of variation is used to get an idea of how large the standard deviation is.</p>
<p>Mathematically, the coefficient of variation is defined as:</p>
<div class="w3-code notranslate">
<div>Coefficient of Variation = Standard Deviation / Mean</div></div>
<p>&nbsp;We can do this in Python if we proceed with the following code: </p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>cv = np.std(full_health_data) / np.mean(full_health_data)<br>
  print(cv)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython_multi_csv.asp?filename=demo_stat_cv&multi=demo_data_full_multi">Try it Yourself &raquo;</a>
</div>
<p>The output:</p>
<img src="img_stat_cv2.png" style="max-width:100%;height:auto" alt="Coefficient of Variation">
<p>We see that the variables Duration, Calorie_Burnage and Hours_Work has a high 
Standard Deviation compared to Max_Pulse, Average_Pulse and Hours_Sleep. </p>
