...
<html lang="en-US">
<head>
<title>Data Science Statistics Variance</title>
<meta charset="utf-8">
...
<h1>Data Science <span class="color_h1">- Statistics Variance</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="ds_stat_std.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="ds_stat_correlation.asp">Next &#10095;</a>
</div>
<hr>
...
deviation. Or the other way around, if you multiply the standard deviation by itself, you get the variance!</p>
<p>We will first use the data set with 10 observations to give an example of how we can calculate the variance:</p>
...
<p><strong>Tip:</strong> Variance is often represented by the symbol Sigma Square: &#963;^2</p>
</div>
<hr>

<h2>Step 1 to Calculate the Variance: Find the Mean</h2>
<p>We want to find the variance of Average_Pulse.</p>
<p>1. Find the mean:</p>
<div class="w3-code notranslate">
<div>
(80+85+90+95+100+105+110+115+120+125) / 10 = 102.5
</div></div>
<p>The mean is 102.5</p>
<hr>

<h2>Step 2: For Each Value - Find the Difference From the Mean</h2>
<p>2. Find the difference from the mean for each value:</p>
<div class="w3-code notranslate">
<div>
...
<h2>Step 3: For Each Difference - Find the Square Value</h2>
<p>3. Find the square value for each difference:</p>
<div class="w3-code notranslate">
<div>
  ...
  17.5^2 = 306.25<br>22.5^2 = 506.25</div></div>
<p><strong>Note:</strong> We must square the values to get the total spread.</p>
<hr>
...
<h2>Step 4: The Variance is the Average Number of These Squared Values</h2>
<p>4. Sum the squared values and find the average:</p>
<div class="w3-code notranslate">
<div>
  (506.25 + 306.25 + 156.25 + 56.25 + 6.25 + 6.25 + 56.25 + 156.25 + 306.25 + 
  506.25) / 10 = 206.25</div></div>
<p>The variance is 206.25. </p>
<hr>

<h2>Use Python to Find the Variance of health_data</h2>
<p>We can use the <code class="w3-codespan">var()</code> function from Numpy to find the 
variance (remember that we now use the first data set with 10 observations): </p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
import numpy as np<br><br>var = np.var(health_data)<br>print(var)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython_multi_csv.asp?filename=demo_stat_variance&multi=demo_data_multi">Try it Yourself &raquo;</a>
</div>
<p>The output:</p>
<img src="img_stat_var.png" style="max-width:100%;height:auto" alt="Variance">
<hr>

<h2>Use Python to Find the Variance of Full Data Set</h2>
<p>Here we calculate the variance for each column for the full data set: </p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
import numpy as np<br><br>var_full = np.var(full_health_data)<br>print(var_full)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython_multi_csv.asp?filename=demo_stat_variance_full&multi=demo_data_full_multi">Try it Yourself &raquo;</a>
</div>
<p>The output:</p>
<img src="img_stat_var_full.png" style="max-width:100%;height:auto" alt="Variance">
<br>
<br>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="ds_stat_std.asp">&#10094; Previous</a>
