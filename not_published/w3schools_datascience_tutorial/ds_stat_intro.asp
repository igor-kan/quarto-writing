...
<html lang="en-US">
<head>
<title>Data Science Statistics Intro</title>
<meta charset="utf-8">
...
<h1>Data Science <span class="color_h1">- Intro to Statistics</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="ds_linear_slope.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="ds_stat_percentiles.asp">Next &#10095;</a>
</div>
<hr>
<h2>Introduction to Statistics</h2>
<p>Statistics is the science of analyzing data.</p>
<p>When we have created a model for prediction, we must assess the prediction's 
reliability. </p>
<p>After all, what is a prediction worth, if we cannot rely on it?</p>
<hr>
<h2>Descriptive Statistics</h2>
<p>We will first cover some basic descriptive statistics.</p>
<p>Descriptive statistics summarizes important features of a data set such as: </p>
<ul>
  <li>Count</li>
  <li>Sum</li>
...
<p>It is a good starting point to become familiar with the data. </p>
<p>We can use the <code class="w3-codespan">describe()</code> function in Python to summarize the data:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  print (full_health_data.describe())</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython_multi_csv.asp?filename=demo_stat_describe&multi=demo_data_full_multi">Try it Yourself &raquo;</a>
</div>
<p>Output:</p>

<img src="img_stat_describe.png" style="max-width:100%;height:auto" alt="Stat Describe">

<p>Do you see anything interesting here?</p>
