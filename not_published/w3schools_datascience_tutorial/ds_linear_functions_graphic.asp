...
<html lang="en-US">
<head>
<title>Data Science Plotting Linear Functions</title>
<meta charset="utf-8">
...
<h1>Data Science <span class="color_h1">- Plotting Linear Functions</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="ds_linear_functions.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="ds_linear_slope.asp">Next &#10095;</a>
</div>
<hr>
<h2>The Sports Watch Data Set</h2>
<p>Take a look at our health data set:</p>
...
<h2>Plot the Existing Data in Python</h2>
<p>Now, we can first plot the values of Average_Pulse against Calorie_Burnage using the matplotlib library.</p>
<p>The <code class="w3-codespan">plot()</code> function is used to make a 2D hexagonal binning plot of points x,y:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  import matplotlib.pyplot as plt<br><br>health_data.plot(x ='Average_Pulse', 
  y='Calorie_Burnage', kind='line'),<br>plt.ylim(ymin=0)<br>plt.xlim(xmin=0)<br>
  <br>plt.show()</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython_multi_csv.asp?filename=demo_function_plot&multi=demo_data_multi">Try it Yourself &raquo;</a>
</div>
...
<ul>
  ...
  on. Here, we want the axis to begin from zero</li>
  <li>plt.show() shows us the output</li>
</ul>
<p>The code above will produce the following result:</p>
<img src="img_linearity2.png" style="max-width:100%;height:auto" alt="Linear function">
<h3>The Graph Output</h3>
<p>As we can see, there is a relationship between Average_Pulse and 
Calorie_Burnage. Calorie_Burnage increases proportionally with Average_Pulse. It means that we can use Average_Pulse to predict Calorie_Burnage. </p>
<hr>
...
<h2>Why is The Line Not Fully Drawn Down to The y-axis?</h2>
<p>The reason is that we do not have observations where Average_Pulse or 
Calorie_Burnage are equal to zero. 80 is the first observation of Average_Pulse 
and 240 is the first observation of Calorie_Burnage.</p>
<img src="img_linearity3.png" style="max-width:100%;height:auto" alt="Linear function">

<p>Look at the line. What happens to calorie burnage if average pulse increases from 80 to 90?</p>
<img src="img_linearity4.png" style="max-width:100%;height:auto" alt="Linear function">
<p>We can use the diagonal line to find the mathematical function to predict calorie burnage.</p>
<p>As it turns out:</p>
<ul>
  <li>If the average pulse is 80, the calorie burnage is 240</li>
  <li>If the average pulse is 90, the calorie burnage is 260</li>
  <li>If the average pulse is 100, the calorie burnage is 280</li>
</ul>
<p>There is a pattern. If average pulse increases by 10, the calorie burnage increases by 20.</p>
