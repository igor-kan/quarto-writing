...
<html lang="en-US">
<head>
<title>Data Science Statistics Correlation Matrix</title>
<meta charset="utf-8">
...
<h1>Data Science <span class="color_h1">- Statistics Correlation Matrix</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="ds_stat_correlation.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="ds_stat_correlation_causality.asp">Next &#10095;</a>
</div>
<hr>
<h2>Correlation Matrix</h2>
<p>A matrix is an array of numbers arranged in rows and columns.</p>
<p>A correlation matrix is simply a table showing the correlation coefficients 
between variables.</p>
<p>Here, the variables are represented in the 
first row, and in the first column:</p>
<img src="img_corr_matrix_table.png" style="max-width:100%;height:auto" alt="Correlation Matrix">
<p>The table above has used data from the full health data set.</p>
<p>Observations:</p>
<ul>
  <li>We observe that Duration and Calorie_Burnage are closely related, with a 
  correlation coefficient of 0.89. This makes sense as the longer we train, the 
  more calories we burn</li>
  <li>We observe that there is almost no linear relationships between 
  Average_Pulse and Calorie_Burnage (correlation coefficient of 0.02)</li>
  <li>Can we conclude that Average_Pulse does not affect Calorie_Burnage? No. We 
  will come back to answer this question later!</li>
</ul>
<hr>
<h2>Correlation Matrix in Python </h2>
<p>We can use the <code class="w3-codespan">corr()</code> function in Python to create a correlation matrix. We 
also use the <code class="w3-codespan">round()</code> function to round the output to two decimals:</p>
<div class="w3-example">
  <h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  Corr_Matrix = round(full_health_data.corr(),2)<br>print(Corr_Matrix)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython_multi_csv.asp?filename=demo_stat_matrix&multi=demo_data_full_multi">Try it Yourself &raquo;</a>
</div>
<p>Output:</p>
<img src="img_stat_matrix.png" style="max-width:100%;height:auto" alt="Correlation Matrix">
<hr>
...
<h2>Using a Heatmap</h2>
<p>We can use a Heatmap to Visualize the Correlation Between Variables:</p>
<img src="img_stat_heatmap.png" style="max-width:100%;height:auto" alt="Correlation Heatmap">
<p>The closer the correlation coefficient is to 1, the greener the squares get.</p>
<p>The closer the correlation coefficient is to -1, the browner the squares 
get. </p>
<hr>

<h2>Use Seaborn to Create a Heatmap</h2>
<p>We can use the Seaborn library to create a correlation heat map (Seaborn is a visualization library based on matplotlib):</p>
<div class="w3-example">
  <h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  import matplotlib.pyplot as plt<br>import seaborn as sns<br><br>correlation_full_health = 
full_health_data.corr()<br><br>axis_corr = sns.heatmap(<br>
correlation_full_health,<br>vmin=-1, vmax=1, center=0,<br>cmap=sns.diverging_palette(50, 
500, n=500),<br>square=True<br>)<br><br>plt.show()</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_stat_corr_matrix">Try it Yourself &raquo;</a>

</div>
<h3>Example Explained:</h3>
<ul>
  <li>Import the library seaborn as sns.</li>
  <li>Use the full_health_data set.</li>
  <li>Use sns.heatmap() to tell 
Python that we want a heatmap to visualize the correlation matrix.</li>
  <li>Use 
the correlation matrix. Define the maximal and minimal values of the heatmap. 
Define that 0 is the center.</li>
  <li>Define the colors with sns.diverging_palette. n=500 
means that we want 500 types of color in the same color palette.</li>
  <li>square = True means that we want to see squares.</li>
</ul>
