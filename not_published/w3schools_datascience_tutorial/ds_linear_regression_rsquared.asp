...
<html lang="en-US">
<head>
<title>Data Science Linear Regression R-Squared</title>
<meta charset="utf-8">
...
<h1>Data Science <span class="color_h1">- Regression Table: R-Squared</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="ds_linear_regression_pvalue.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="ds_linear_regression_case.asp">Next &#10095;</a>
</div>
<hr>

<h2>R - Squared</h2>
<p>R-Squared and Adjusted R-Squared describes how well the linear regression model fits the data points:</p>
<img src="img_lr_table_r.png" style="max-width:100%;height:auto" alt="Regression Table - Stats of Coefficients">
...
<h2>Visual Example of a Low R - Squared Value (0.00)</h2>
<p>Our regression model shows a R-Squared value of zero, which means that the 
linear regression function line does not fit the data well.</p>
<p>This can be visualized when we plot the linear regression function 
through the data points of Average_Pulse and Calorie_Burnage.</p>
<img src="img_lr_low_r.png" style="max-width:100%;height:auto" alt="Low R - Squared Value (0.00)">
<hr>
...
<h2>Visual Example of a High R - Squared Value (0.79) </h2>
<p>However, if we plot <strong>Duration</strong> and <strong>Calorie_Burnage</strong>, the R-Squared increases. 
Here, we see that the data points are close to the linear regression function line:</p>
<img src="img_lr_high_r.png" style="max-width:100%;height:auto" alt="Low R - Squared Value (0.00)">
...
<div class="w3-code notranslate pythonHigh">
  ...
  <br>x = full_health_data[&quot;Duration&quot;]<br>y = 
full_health_data [&quot;Calorie_Burnage&quot;]<br><br>slope, intercept, r, p, std_err = 
stats.linregress(x, y)<br><br>def myfunc(x):<br>&nbsp;return slope * x + intercept<br>
<br>mymodel = list(map(myfunc, x))<br><br>print(mymodel)<br><br>plt.scatter(x, 
y)<br>plt.plot(x, mymodel)<br>plt.ylim(ymin=0, ymax=2000)<br>plt.xlim(xmin=0, 
xmax=200)<br>plt.xlabel(&quot;Duration&quot;)<br>plt.ylabel (&quot;Calorie_Burnage&quot;)<br>
<br>plt.show()</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython_multi_csv.asp?filename=demo_lr_least_square_dur_cal&multi=demo_data_full_multi">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Summary - Predicting Calorie_Burnage with Average_Pulse </h2>
<p>How can we summarize the linear regression function with Average_Pulse as explanatory variable? </p>
<ul>
  <li>Coefficient of 0.3296, which means that Average_Pulse has a very small effect on Calorie_Burnage.</li>
  <li>High P-value (0.824), which means that we cannot conclude a relationship between Average_Pulse and Calorie_Burnage.</li>
  <li>R-Squared value of 0, which means that the linear regression function line does not fit the data well.</li>
</ul>
