...
<html lang="en-US">
<head>
<title>Data Science Linear Regression</title>
<meta charset="utf-8">
...
<h1>Data Science <span class="color_h1">- Linear Regression</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="ds_stat_correlation_causality.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="ds_linear_regression_table.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">We are missing one important variable that affects Calorie_Burnage, which is the Duration of the training session.</p>
<p class="intro">Duration in combination with Average_Pulse will together explain Calorie_Burnage more precisely. </p>
<hr>

<h2>Linear Regression </h2>
<p>The term regression is used when you try to find the relationship between variables.</p>
<p>In Machine Learning and in statistical modeling, that relationship is used to predict the outcome of events.</p>
<p>In this module, we will cover the following questions:</p>
<ul>
...
<p>Linear regression uses the least square method.</p>
<p>The concept is to draw a line through all the plotted data points. The line 
is positioned in a way that it minimizes the distance to all of the data points.</p>
<p>The distance is called &quot;residuals&quot; or &quot;errors&quot;. </p>
<p>The red dashed lines represents the distance from the data points to the drawn mathematical function.</p>
<img src="img_least_square.png" style="max-width:100%;height:auto" alt="Linear Regression - Least Square">
<hr>
...
<h2>Linear Regression Using One Explanatory Variable </h2>
<p>In this example, we will try to predict Calorie_Burnage with Average_Pulse using Linear Regression:</p>
...
<div class="w3-code notranslate pythonHigh">
  ...
  <br>plt.scatter(x, y)<br>plt.plot(x, slope * x + intercept)<br>plt.ylim(ymin=0, ymax=2000)<br>
  plt.xlim(xmin=0, xmax=200)<br>plt.xlabel(&quot;Average_Pulse&quot;)<br>plt.ylabel (&quot;Calorie_Burnage&quot;)<br>
  plt.show()</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython_multi_csv.asp?filename=demo_lr_least_square&multi=demo_data_full_multi">Try it Yourself &raquo;</a>
</div>
<h3>Example Explained:</h3>
<ul>
  <li>Import 
the modules you need: Pandas, matplotlib and Scipy</li>
  <li>Isolate Average_Pulse as x. Isolate Calorie_burnage as y</li>
  <li>Get important key values with: slope, intercept, r, p, std_err = stats.linregress(x, y)</li>
  <li>Create a function that uses the slope and intercept values to return a new value. This new value represents where on the y-axis the corresponding x value 
  will be placed</li>
  <li>Run each value of the x array through the function. This will result in a new array with new values for the y-axis: mymodel = list(map(myfunc, x))</li>
  <li>Draw the original scatter plot: plt.scatter(x, y)</li>
  <li>Draw the line of linear regression: plt.plot(x, mymodel)</li>
  <li>Define maximum and minimum values of the axis</li>
  <li>Label the axis: &quot;Average_Pulse&quot; and &quot;Calorie_Burnage&quot;</li>
</ul>
<h3>Output:</h3>
<img src="img_tryit_lr_least_square.png" style="max-width:100%;height:auto" alt="Linear Regression - One variable - Least Square">

<div class="w3-panel ws-note">
<p>Do you think that the line is able to predict Calorie_Burnage precisely?</p>
<p>We will show that the variable Average_Pulse alone is not enough to make precise prediction of Calorie_Burnage. </p>
</div>
