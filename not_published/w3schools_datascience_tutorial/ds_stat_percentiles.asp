...
<html lang="en-US">
<head>
<title>Data Science Statistics Percentiles</title>
<meta charset="utf-8">
...
<h1>Data Science <span class="color_h1">- Statistics Percentiles</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="ds_stat_intro.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="ds_stat_std.asp">Next &#10095;</a>
</div>
<hr>
<h2>25%, 50% and 75% - Percentiles</h2>
...
<img src="img_stat_percentiles.png" style="max-width:100%;height:auto" alt="Percentiles">

<p>Let us try to explain it by some examples, using Average_Pulse. </p>
<ul>
  <li>The 25% percentile of Average_Pulse means that 25% of all of the training 
...
beats per minute or higher</li>
  <li>The 75% percentile of Average_Pulse means that 75% of all the training 
...
<h3>Task: Find the 10% percentile for Max_Pulse</h3>
<p>The following example shows how to do it in Python:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  import numpy as np<br><br>Max_Pulse= full_health_data[&quot;Max_Pulse&quot;]<br>
percentile10 = np.percentile(Max_Pulse, 10)<br>print(percentile10)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython_multi_csv.asp?filename=demo_stat_percentile&multi=demo_data_full_multi">Try it Yourself &raquo;</a>
</div>
<ul>
  <li>Max_Pulse = full_health_data[&quot;Max_Pulse&quot;] - Isolate the variable Max_Pulse from the full health data set.</li>
  <li>np.percentile() is used to define that we want the 10% percentile from Max_Pulse.</li>
</ul>
<p>The 10% percentile of Max_Pulse is 120. This means that 10% of all the training sessions have a Max_Pulse of 120 or lower.</p>
