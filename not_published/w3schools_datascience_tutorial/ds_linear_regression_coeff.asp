...
<html lang="en-US">
<head>
<title>Data Science Linear Regression Coefficients</title>
<meta charset="utf-8">
...
<h1>Data Science <span class="color_h1">- Regression Table - Coefficients</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="ds_linear_regression_info.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="ds_linear_regression_pvalue.asp">Next &#10095;</a>
</div>
<hr>

<h2>The &quot;Coefficients Part&quot; in Regression Table</h2>
<img src="img_lr_table_coeff.png" style="max-width:100%;height:auto" alt="Regression Table - Coefficients">
<ul>
  <li><strong>Coef</strong> is short for coefficient. It is the output of the linear regression 
function.</li>
</ul>
<p>The linear regression function can be rewritten mathematically as:</p>
<div class="w3-code notranslate">
<div>
  Calorie_Burnage = 0.3296 * Average_Pulse + 346.8662 </div></div>

<p>These numbers means:</p>
<ul>
  <li>If Average_Pulse increases by 1, Calorie_Burnage increases by 0.3296 (or 0,3 
  rounded)</li>
  <li>If 
Average_Pulse = 0, the Calorie_Burnage is equal to 346.8662 (or 
346.9 rounded).</li>
  <li>Remember that the intercept is used to adjust the model's precision of 
  predicting!</li>
</ul>
<p>Do you think that this is a good model?</p>
<hr>
...
<p>What is Calorie_Burnage if Average_Pulse is: 120, 130, 150, 180?</p>
<div class="w3-example">
  <h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
def Predict_Calorie_Burnage(Average_Pulse):<br>&nbsp;return(0.3296*Average_Pulse + 
346.8662)<br><br>print(Predict_Calorie_Burnage(120))<br>print(Predict_Calorie_Burnage(130))<br>print(Predict_Calorie_Burnage(150))<br>print(Predict_Calorie_Burnage(180))</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_lr">Try it Yourself &raquo;</a>
</div>
