...
<html lang="en-US">
<head>
<title>Data Science Slope and Intercept</title>
<meta charset="utf-8">
...
<h1>Data Science <span class="color_h1">- Slope and Intercept</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="ds_linear_functions_graphic.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="ds_stat_intro.asp">Next &#10095;</a>
</div>
<hr>
<h2>Slope and Intercept</h2>
<p>Now we will explain how we found the slope and intercept of our function:</p>
<div class="w3-code notranslate">
<div>f(x) = 2x + 80</div></div>
<p>The image below points to the Slope - which indicates how steep the line is, 
...
<img src="img_linearity5.png" style="max-width:100%;height:auto" alt="Linear function">
<hr>

<h2>Find The Slope</h2>
<p>The slope is defined as how much calorie burnage increases, if average pulse increases by one. 
It tells us how &quot;steep&quot; the diagonal line is. </p>
<p>We can find the slope by using the proportional difference of two points from the graph.</p>
<ul>
  <li>If the average pulse is 80, the calorie burnage is 240</li>
  <li>If the average pulse is 90, the calorie burnage is 260</li>
</ul>
<p>We see that if average pulse increases with 10, the calorie burnage increases by 20.</p>
<div class="w3-code notranslate">
<div>Slope = 20/10 = 2</div></div>
<p>The slope is 2.</p>
<h3>Mathematically, Slope is Defined as:</h3>
<div class="w3-code notranslate">
<div>Slope = f(x2) - f(x1) / x2-x1</div></div>
<p>f(x2) = Second observation of Calorie_Burnage = 260<br>f(x1) = First 
...
<p>Be consistent to define the observations in the correct order! If not, the 
prediction will not be correct!</p>
</div>

<h3>Use Python to Find the Slope </h3>
<p>Calculate the slope with the following code:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  def slope(x1, y1, x2, y2):<br>&nbsp; s = (y2-y1)/(x2-x1)<br>&nbsp; return s<br><br>
print (slope(80,240,90,260))</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_slope">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Find The Intercept</h2>
<p>The intercept is used to fine tune the functions ability to predict Calorie_Burnage.</p>
<p>The intercept is where the diagonal line crosses the y-axis, if it were fully drawn.</p>
<p>The intercept is the value of y, when x = 0.</p>
<p>Here, we see that if average pulse (x) is zero, then the calorie burnage (y) is 80.</p>
<p>So, the intercept is 80.</p>
<p>Sometimes, the intercept has a practical meaning. Sometimes not.</p>
<p><strong>Does it make sense that average pulse is zero?</strong></p>
<p>No, you would be dead and you certainly would not burn any calories.</p>
<p>However, we need to include the intercept in order to complete the 
mathematical function's ability to predict Calorie_Burnage correctly.</p>
<p>Other examples where the intercept of a mathematical function can have a practical meaning: </p>
<ul>
  <li>Predicting next years revenue by using marketing expenditure (How much 
revenue will we have next year, if marketing expenditure is zero?). It is likely 
to assume that a company will still have some revenue even though if it does not spend money on marketing.</li>
  <li>Fuel usage with speed (How much fuel do we use if speed is equal to 0 mph?). 
A car that uses gasoline will still use fuel when it is idle.</li>
</ul>
<hr>
...
<h2>Find the Slope and Intercept Using Python</h2>
<p>The <code class="w3-codespan">np.polyfit()</code> function returns the slope and intercept.</p>
<p>If we proceed with the following code, we can both get the slope and intercept from the function.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  import pandas as pd<br>import numpy as np<br><br>health_data = pd.read_csv("data.csv", header=0, sep=",")<br>
  <br>x = health_data[&quot;Average_Pulse&quot;]<br>y = health_data[&quot;Calorie_Burnage&quot;]<br>
slope_intercept = np.polyfit(x,y,1)<br><br>print(slope_intercept)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython_multi_csv.asp?filename=demo_slope_intercept&multi=demo_data_multi">Try it Yourself &raquo;</a>
</div>
<h3>Example Explained:</h3>
<ul>
  <li>Isolate the variables Average_Pulse (x) and Calorie_Burnage (y) 
from health_data.</li>
  <li>Call the np.polyfit() function.</li>
  <li>The last parameter of the function specifies the degree of the function, which in this case 
is &quot;1&quot;. </li>
</ul>

<div class="w3-panel ws-note">
<p><strong>Tip:</strong> linear functions = 1.degree function. In our example, the function is linear, which is in the 1.degree. That means 
that all coefficients (the numbers) are in the power of one.</p>
</div>

<p>We have now calculated the slope (2) and the intercept (80).

We can write the mathematical function as follow: </p>
<p>Predict Calorie_Burnage by using a mathematical expression:</p>
<div class="w3-code notranslate">
<div>f(x) = 2x + 80</div></div>
<h3>Task:</h3>
<p>Now, we want to predict calorie burnage if average pulse 
is 135.</p>
<p>Remember that the intercept is a constant. A constant is a number that 
does not change.</p>
<p>We can now substitute the input x with 135:</p>
<div class="w3-code notranslate">
<div>f(135) = 2 * 135 + 80 = 350</div></div>
<p>If average pulse is 135, the calorie burnage is 350.</p>
<hr>

<h2>Define the Mathematical Function in Python</h2>
<p>Here is the exact same mathematical function, but in Python. The function 
returns 2*x + 80, with x as the input:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  def my_function(x):<br>&nbsp; return 2*x + 80<br><br>
print (my_function(135))</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_function">Try it Yourself &raquo;</a>
</div>
<p>Try to replace x with 140 and 150.</p>
<hr>

<h2>Plot a New Graph in Python</h2>
<p>Here, we plot the same graph as earlier, but formatted the axis a little bit.</p>
<p>Max value of the y-axis is now 400 and for x-axis is 150:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  import matplotlib.pyplot as plt<br><br>health_data.plot(x ='Average_Pulse', 
  y='Calorie_Burnage', kind='line'),<br>plt.ylim(ymin=0, ymax=400)<br>plt.xlim(xmin=0, 
  xmax=150)<br>
  <br>plt.show()</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython_multi_csv.asp?filename=demo_function_plot2&multi=demo_data_multi">Try it Yourself &raquo;</a>
</div>
<h3>Example Explained</h3>
<ul>
  <li>Import the pyplot module of the matplotlib library</li>
  <li>Plot the data from Average_Pulse against Calorie_Burnage</li>
  <li><code>kind='line'</code> tells us which type of plot we want. Here, we 
  want to have a straight line</li>
  <li>plt.ylim() and plt.xlim() tells us what value we want the axis to start 
  and stop on.</li>
  <li>plt.show() shows us the output</li>
</ul>
