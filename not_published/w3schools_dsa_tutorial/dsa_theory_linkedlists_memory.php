...
<html lang="en-US">
<head>
<title>DSA Linked Lists in Memory</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>DSA <span class="color_h1">Linked Lists in Memory</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="dsa_theory_linkedlists.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="dsa_data_linkedlists_types.php">Next &#10095;</a>
</div>
<hr>
...
<p>Let's imagine that we want to store the integer "17" in a variable <span class="w3-codespan">myNumber</span>. For simplicity, let's assume the integer is stored as two bytes (16 bits), and the address in memory to <span class="w3-codespan">myNumber</span> is <span class="w3-codespan">0x7F25</span>.</p>
<p><span class="w3-codespan">0x7F25</span> is actually the address to the first of the two bytes of memory where the <span class="w3-codespan">myNumber</span> integer value is stored. When the computer goes to <span class="w3-codespan">0x7F25</span> to read an integer value, it knows that it must read both the first and the second byte, since integers are two bytes on this specific computer.</p>
<p>The image below shows how the variable <span class="w3-codespan">myNumber = 17</span> is stored in memory.</p>
<img src="img_linkedlists_memory_new.png" class="imgTut" alt="A variable stored in memory">
...
<p>The image below shows how an array of integers <span class="w3-codespan">myArray = [3,5,13,2]</span> is stored in memory. We use a simple kind of memory here with two bytes for each integer, like in the previous example, just to get the idea.</p>
<img src="img_linkedlists_arraymemory_new.png" class="imgTut" alt="An array stored in memory">
<p>The computer has only got the address of the first byte of <span class="w3-codespan">myArray</span>, so to access the 3rd element with code <span class="w3-codespan">myArray[2]</span> the computer starts at <span class="w3-codespan">0x7F23</span> and jumps over the two first integers. The computer knows that an integer is stored in two bytes, so it jumps 2x2 bytes forward from <span class="w3-codespan">0x7F23</span> and reads value 13 starting at address <span class="w3-codespan">0x7F27</span>.</p>
...
<p>You can read more about arrays on <a href="dsa_data_arrays.php">this previous DSA tutorial page</a>.</p>
<hr>
...
<img src="img_linkedlists_memory2_new.png" class="imgTut" alt="Linked list nodes in memory">
...
<img src="img_linkedlists_singlenode.svg" class="imgTut" alt="Linked list single node">
<p>If we put the same four nodes from the previous example together using this new visualization, it looks like this:</p>
<img src="img_linkedlists_exwithvalues.svg" class="imgTut" alt="Linked list example with addresses and values.">
...
<h2>Memory in Modern Computers</h2>
...
<div class="w3-example">
  ...
  <pre class="language-c notranslate w3-white"><code>#include &lt;stdio.h&gt;
...
int main() {
  ...
  <a class="w3-btn w3-margin-bottom" href="trydsa.php?filename=demo_linkedLists_memoryInfo" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">createNode()</code> function allocates memory for a new node, fills in the data part of the node with an integer given as an argument to the function, and returns the pointer (memory address) to the new node.</p>
<p>The <code class="w3-codespan">printList()</code> function is just for going through the linked list and printing each node's value.</p>
<p>Inside the <code class="w3-codespan">main()</code> function, four nodes are created, linked together, printed, and then the memory is freed. It is good practice to free memory after we are done using it to avoid memory leaks. Memory leak is when memory is not freed after use, gradually taking up more and more memory.</p>
<div class="w3-example">
  <h3>Example</h3>
...
int main() {
  ...
  <a class="w3-btn w3-margin-bottom" href="trydsa.php?filename=demo_linkedlists_singlyc" target="_blank">Try it Yourself &raquo;</a>
</div>
<p>To print the linked list in the code above, the <code class="w3-codespan">printList()</code> function goes from one node to the next using the "next" pointers, and that is called "traversing" or "traversal" of the linked list. You will learn more about linked list traversal and other linked list operations on the <a href="dsa_algo_linkedlists_operations.php">Linked Lists Oprations page</a>.</p>
<hr>

<h2>Linked List Implementation in Python and Java</h2>
<p>We will now implement this same linked list using Python and Java instead.</p>
<img src="img_linkedlists_exwithvalues.svg" class="imgTut" alt="Linked list example with addresses and values.">
<p>In the Python code below, the <code class="w3-codespan">Node</code> class represents what a node is: the node contains data and a link to the next node.</p>
<p>The <code class="w3-codespan">Node</code> class is used to to create four nodes, the nodes are then linked together, and printed at the end.</p>
<p>As you can see, the Python code is a lot shorter than the C code, and perhaps better if you just want to understand the concept of linked lists, and not how linked lists are stored in memory.</p>
<p>The Java code is very similar to the Python code. Click the "Run Example" button below and choose the "Java" tab to see the Java code.</p>
<div class="w3-example">
  <h3>Example</h3>
  <p>A basic linked list in Python:</p>
...
print("null")</code></pre>
  <a class="w3-btn w3-margin-bottom" href="trydsa.php?filename=demo_linkedlists_singlyjavapython" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>

<div>
<h2>DSA Exercises</h2>
<form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_theory_linkedlists2" method="post" target="_blank">
<h2>Test Yourself With Exercises</h2>
<div class="exercisewindow">
<h2>Exercise:</h2>
<p>What is a benefit of using Linked Lists?</p>
<div class="exerciseprecontainer">
<pre style="overflow: auto;">
A good thing about Linked Lists 
is that when inserting or 
removing a node, other elements 
do not have to be <input name="ex1" maxlength="7" style="width: 8ch;"> in memory.
</pre>
</div>
<br>
<button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
<p><a target="_blank" href="exercise.php?filename=exercise_theory_linkedlists2">Start the Exercise</a></p>
</div>
</form>
</div>
<hr>
