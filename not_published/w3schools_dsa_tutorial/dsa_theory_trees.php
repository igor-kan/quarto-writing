...
ny:-->
    ...
    <h1>DSA <span class="color_h1">Trees</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="dsa_data_hashmaps.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="dsa_data_binarytrees.php">Next &#10095;</a>
</div>
<hr>

<h2>Trees</h2>
<p>The Tree data structure is similar to <a href="dsa_theory_linkedlists.php">Linked Lists</a> in that each node contains data and can be linked to other nodes.</p>
...
<p>The data structure is called a "tree" because it looks like a tree, only upside down, just like in the image below.</p>
...
<h2>Tree Terminology and Rules</h2>
<p>Learn words used to describe the tree data structure by using the interactive tree visualization below.</p>
<div id="divAnim">
  <div id="wrapper">
    <div id="menu">
    <p><label><input type="radio" value="all" name="rbgTree" checked onchange="showTree(this.value)">The whole tree</label></p>
    <p><label><input type="radio" value="root" name="rbgTree" onchange="showTree(this.value)">Root node</label></p>
    <p><label><input type="radio" value="branches" name="rbgTree" onchange="showTree(this.value)">Edges</label></p>
    <p><label><input type="radio" value="nodes" name="rbgTree" onchange="showTree(this.value)">Nodes</label></p>
    ...
    <p><label><input type="radio" value="parents" name="rbgTree" onchange="showTree(this.value)">Parent nodes</label></p>
    <p><label><input type="radio" value="height" name="rbgTree" onchange="showTree(this.value)">Tree height (h=2)</label></p>
    <p><label><input type="radio" value="nodes" name="rbgTree" onchange="showTree(this.value)">Tree size (n=10)</label></p>
    </div>
    <div id="svgDiv"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 420 250" id="svgAnim" class="dsa_svg">
<defs>
  <style>
  ...
  <g class="root parent">
    <circle cx="170" cy="30" r="20" class="node" />
    <text x="164" y="37" class="svgDataText">R</text>
    <line x1="155" y1="45" x2="101" y2="100" class="branch height" marker-end="url(#arrowhead)" />
    <line x1="170" y1="50" x2="170" y2="91" class="branch" marker-end="url(#arrowhead)" />
    <line x1="185" y1="45" x2="250" y2="100" class="branch" marker-end="url(#arrowhead)" />
  </g>
  ...
  <g class="parent child">
    ...
    <text x="73" y="126" class="svgDataText">A</text>
    <line x1="70" y1="138" x2="50" y2="180" class="branch" marker-end="url(#arrowhead)" />
    <line x1="90" y1="138" x2="110" y2="180" class="branch height" marker-end="url(#arrowhead)" />
  </g>
  <!-- 'B' node -->
  <g class="child leaf">
    <circle cx="170" cy="120" r="20" class="node" />
...
<p>The first node in a tree is called the <strong>root</strong> node.</p>
<p>A link connecting one node to another is called an <strong>edge</strong>.</p>
<p>A <strong>parent</strong> node has links to its <strong>child</strong> nodes. Another word for a parent node is <strong>internal</strong> node.</p>
<p>A node can have zero, one, or many child nodes.</p>
<p>A node can only have one parent node.</p>
<p>Nodes without links to other child nodes are called <strong>leaves</strong>, or <strong>leaf nodes</strong>.</p>
<p>The <strong>tree height</strong> is the maximum number of edges from the root node to a leaf node. The height of the tree above is 2.</p>
<p>The <strong>height of a node</strong> is the maximum number of edges between the node and a leaf node.</p>
<p>The <strong>tree size</strong> is the number of nodes in the tree.</p>
<hr>
...
<div>
<h2>DSA Exercises</h2>
<form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_theory_trees1" method="post" target="_blank">
<h2>Test Yourself With Exercises</h2>
<div class="exercisewindow">
<h2>Exercise:</h2>
<p>In a Tree data structure, like the one below: </p>
<img style="width: 100%; max-width: 300px;" src="img_exercises_trees.png" alt="A tree data structure">
<p>What are nodes C, D, E, and G called?</p>
<div class="exerciseprecontainer">
<pre style="overflow: auto;">
Nodes C, D, E, and G 
are called <input name="ex1" maxlength="5" style="width: 6ch;"> nodes.
</pre>
</div>
<br>
<button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
<p><a target="_blank" href="exercise.php?filename=exercise_theory_trees1">Start the Exercise</a></p>
</div>
</form>
</div>
<hr>
