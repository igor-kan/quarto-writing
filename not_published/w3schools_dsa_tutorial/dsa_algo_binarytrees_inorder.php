...
<html lang="en-US">
<head>
<title>DSA In-order Traversal</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>DSA <span class="color_h1">In-order Traversal</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="dsa_algo_binarytrees_preorder.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="dsa_algo_binarytrees_postorder.php">Next &#10095;</a>
</div>
...
<p>In-order Traversal is a type of Depth First Search, where each node is visited in a certain order. Read more about Binary Tree traversals in general <a href="dsa_data_binarytrees.php#traversal">here</a>.</p>
<p>Run the animation below to see how an In-order Traversal of a Binary Tree is done.</p>
<div id="divAnim3">
  ...
  <!-- 'R' node -->
  <g class="root parent R">
    <circle cx="170" cy="30" r="20" class="node" />
    <text x="164" y="37" class="svgDataText" >R</text>
  </g>

  <!-- 'A' node -->
  <g class="parent child A">
    <line x1="155" y1="45" x2="101" y2="100" class="branch" marker-end="url(#arrowheadRA)" />
    <circle cx="80" cy="120" r="20" class="node" />
    <text x="73" y="126" class="svgDataText" >A</text>
  </g>
  <!-- 'B' node -->
  <g class="parent child B">
    <line x1="185" y1="45" x2="250" y2="100" class="branch height" marker-end="url(#arrowheadRB)" />
  ...
  <g class="child leaf C" >
    <line x1="70" y1="138" x2="50" y2="180" class="branch" marker-end="url(#arrowheadAC)" start="A" end="C"/>
  ...
  <g class="child leaf D" >
    <line x1="90" y1="138" x2="110" y2="180" class="branch" marker-end="url(#arrowheadAD)" />
...
<line x1="261" y1="138" x2="241" y2="180" class="branch" marker-end="url(#arrowheadBE)" />
  <circle cx="232" cy="207" r="20" class="node" />
  <text x="226" y="213" class="svgDataText" >E</text>
</g>

<!-- 'F' node -->
<g class="child parent leaf F">
  <line x1="281" y1="138" x2="301" y2="180" class="branch height" marker-end="url(#arrowheadBF)" />
...
<g class="child leaf G">
  <line x1="302" y1="225" x2="282" y2="267" class="branch height" marker-end="url(#arrowheadFG)" />
  <circle cx="271" cy="293" r="20" class="node" />
  <text x="265" y="299" class="svgDataText" >G</text>
</g>
</svg>
  <p>Result: </p>
  <button onclick="tl3.play();">In-order Traverse</button>
</div>
<script src="https://cdnjs.cloudflare.com/ajax/libs/animejs/3.2.1/anime.min.js" integrity="sha512-z4OUqw38qNLpn1libAN9BsoDx6nbNFio5lA6CuTp9NlK83b89hgyCVq+N5FdBJptINztxn1Z3SaKSKUS5UP60Q==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
<script>
  let traverseBtn3 = document.querySelector('#divAnim3 button');
  let pResult = document.querySelector('#divAnim3 p');
...
tl3.add({
  targets: '#divAnim3 circle, #divAnim3 text, #divAnim3 line',
  opacity: 1,
  duration: 200,
  begin: function(anim){
    ...
    for(let i=0; i<nodes3.length; i++){
      nodes3[i].classList.remove('nodePrinted');
    }
  },
  complete: function(anim){
    traverseBtn3.innerHTML = 'In-order Traverse';
    traverseBtn3.disabled = false;
    tl3.pause();
  }
})
.add({
  targets: '#divAnim3 .R circle',
  begin: function(anim){
    traverseBtn3.disabled = true;
    document.querySelector('#divAnim3 .R circle').classList.add('thick');
  }
})
.add({
  targets: '#divAnim3 .A circle',
  begin: function(anim){
    document.querySelector('#divAnim3 .A circle').classList.add('thick');
  }
})
.add({
  targets: '#divAnim3 .C',
  begin: function(anim){
    document.querySelector('#divAnim3 .C circle').classList.add('nodePrinted');
    document.querySelector('#divAnim3 .C circle').classList.add('extraThick');
    document.querySelector('#divAnim3 p').innerHTML += 'C';
  },
  complete: function(anim){
    document.querySelector('#divAnim3 .C circle').classList.remove('extraThick');
  }
})
.add({
  targets: '#divAnim3 .C',
  opacity: [1,0.5],
  begin: function(anim){
    document.querySelector('#divAnim3 .A circle').classList.add('nodePrinted');
    document.querySelector('#divAnim3 .A circle').classList.add('extraThick');
    document.querySelector('#divAnim3 p').innerHTML += ',A';
  },
  complete: function(anim){
    document.querySelector('#divAnim3 .A circle').classList.remove('extraThick');
  }
})
.add({
  targets: '#divAnim3 .D circle',
  begin: function(anim){
    document.querySelector('#divAnim3 .D circle').classList.add('nodePrinted');
    document.querySelector('#divAnim3 .D circle').classList.add('extraThick');
    document.querySelector('#divAnim3 p').innerHTML += ',D';
  },
  complete: function(anim){
    document.querySelector('#divAnim3 .D circle').classList.remove('extraThick');
  }
})
.add({
  targets: '#divAnim3 .D',
...
.add({
  ...
  opacity: [1,0.5],
  begin: function(anim){
    document.querySelector('#divAnim3 .A circle').classList.remove('thick');
    document.querySelector('#divAnim3 .R circle').classList.add('nodePrinted');
    document.querySelector('#divAnim3 .R circle').classList.add('extraThick');
    document.querySelector('#divAnim3 p').innerHTML += ',R';
  },
  complete: function(anim){
    document.querySelector('#divAnim3 .R circle').classList.remove('extraThick');
  }
})
.add({
  targets: '#divAnim3 .R',
  begin: function(anim){
    document.querySelector('#divAnim3 .B circle').classList.add('thick');
  }
})
.add({
  begin: function(anim){
    document.querySelector('#divAnim3 .E circle').classList.add('nodePrinted');
    document.querySelector('#divAnim3 .E circle').classList.add('extraThick');
    document.querySelector('#divAnim3 p').innerHTML += ',E';
  },
  complete: function(anim){
    document.querySelector('#divAnim3 .E circle').classList.remove('extraThick');
  }
})
.add({
  targets: '#divAnim3 .E',
  opacity: [1,0.5],
  begin: function(anim){
    document.querySelector('#divAnim3 .B circle').classList.add('nodePrinted');
    document.querySelector('#divAnim3 .B circle').classList.add('extraThick');
    document.querySelector('#divAnim3 p').innerHTML += ',B';
  },
  complete: function(anim){
    document.querySelector('#divAnim3 .B circle').classList.remove('extraThick');
  }
})
.add({
  begin: function(anim){
    document.querySelector('#divAnim3 .F circle').classList.add('thick');
  }
})
.add({
  begin: function(anim){
    document.querySelector('#divAnim3 .G circle').classList.add('nodePrinted');
    document.querySelector('#divAnim3 .G circle').classList.add('extraThick');
    document.querySelector('#divAnim3 p').innerHTML += ',G';
  },
  complete: function(anim){
    document.querySelector('#divAnim3 .G circle').classList.remove('extraThick');
  }
})
.add({
  targets: '#divAnim3 .G',
  opacity: [1,0.5],
  begin: function(anim){
    document.querySelector('#divAnim3 .F circle').classList.add('nodePrinted');
    document.querySelector('#divAnim3 .F circle').classList.add('extraThick');
    document.querySelector('#divAnim3 p').innerHTML += ',F';
  },
  complete: function(anim){
    document.querySelector('#divAnim3 .F circle').classList.remove('extraThick');
    document.querySelector('#divAnim3 .F circle').classList.remove('thick');
  }
})
.add({
  targets: '#divAnim3 .F',
  opacity: [1,0.5],
  complete: function(anim){
    document.querySelector('#divAnim3 .B circle').classList.remove('thick');
  }
})
.add({
  targets: '#divAnim3 .B',
  opacity: [1,0.5],
  complete: function(anim){
    document.querySelector('#divAnim3 .R circle').classList.remove('thick');
  }
})
.add({
  targets: '#divAnim3 .R',
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Python:</p>
  <pre class="language-python notranslate line-numbers w3-white"><code>def inOrderTraversal(node):
    if node is None:
        return
    inOrderTraversal(node.left)
    print(node.data, end=", ")
    inOrderTraversal(node.right)</code></pre>
  <a class="w3-btn w3-margin-bottom" href="trydsa.php?filename=demo_binarytree_traversal" target="_blank">Try it Yourself &raquo;</a>
</div>
