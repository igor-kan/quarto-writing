...
<html lang="en-US">
<head>
<title>DSA Selection Sort</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>DSA <span class="color_h1">Selection Sort</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="dsa_algo_bubblesort.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="dsa_algo_insertionsort.php">Next &#10095;</a>
</div>
<hr>
...
<p>Continue reading to fully understand the Selection Sort algorithm and how to implement it yourself.</p>
...
<p>Before we implement the Selection Sort algorithm in a programming language, let's manually run through a short array only one time, just to get the idea.</p>
...
<p>Can you see what happened to the lowest value 3? In step 3, it has been moved to the start of the array, where it belongs, but at that step the rest of the array remains unsorted.</p>
<p>So the Selection Sort algorithm must run through the array again and again, each time the next lowest value is moved in front of the unsorted part of the array, to its correct position. The sorting continues until the highest value 12 is left at the end of the array. This means that we need to run through the array 4 times, to sort the array of 5 values.</p>
<p>And each time the algorithm runs through the array, the remaining unsorted part of the array becomes shorter.</p>
<p>We will now use what we have learned to implement the Selection Sort algorithm in a programming language.</p>
<hr>

<h2>Selection Sort Implementation</h2>
<p>To implement the Selection Sort algorithm in a programming language, we need:</p>
<ol>
...
<div class="w3-example">
  <h3>Example</h3>
  <pre class="language-python notranslate w3-white"><code>my_array = [64, 34, 25, 5, 22, 11, 90, 12]
...
print("Sorted array:", my_array)</code></pre>
  <a class="w3-btn w3-margin-bottom" href="trydsa.php?filename=demo_selectionsort" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<img src="img_array_removed_shifting_2.png" class="imgTut_1" alt="Shifting other elements when an array element is removed.">
...
<img src="img_array_inserted_shifting_2.png" class="imgTut_1" alt="Shifting other elements when an array element is inserted.">
<div class="ws-note">
...
<img src="img_array_swap_noshifting_2.png" class="imgTut_1" alt="Shifting other elements when an array element is inserted.">
...
<p>Here is an implementation of the improved Selection Sort, using swapping:</p>
<div class="w3-example">
  <h3>Example</h3>
  <pre class="language-python notranslate w3-white" data-line="9"><code>my_array = [64, 34, 25, 12, 22, 11, 90, 5]
...
print("Sorted array:", my_array)</code></pre>
  <a class="w3-btn w3-margin-bottom" href="trydsa.php?filename=demo_selectionsort2" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p class="fontComment">For a more thorough and detailed explanation of Selection Sort time complexity, visit <a href="dsa_timecomplexity_selsort.php">this page</a>.</p>
...
<img src="img_runtime_bubbleSort.png" alt="Selection Sort time complexity">
...
<p>Run the simulation below for different sized arrays.</p>
<p>The red dashed line represents the theoretical time complexity \(O(n^2)\).</p>
<p>Blue crosses appear when you run the simulation. The blue crosses show how many operations are needed to sort an array of a certain size.</p>
<div id="vueApp4">
...
<script>
  ...
  methods: {
    ...
    async addPoint() {
      this.isLoading = true;
      let operations = await this.performSelectionSort();
    ...
    async performSelectionSort() {
      ...
      for (let i = 0; i < n; i++) {
        ...
        for (let j = i + 1; j < n; j++) {
          this.operations++; // Increment for loop iteration
          if (this.array[j].value < this.array[min_index].value) {
        ...
        // Swap elements
        this.operations++; // Increment for swap operation
        [this.array[i], this.array[min_index]] = [this.array[min_index], this.array[i]];
      }
...
<p>The most significant difference from Bubble sort that we can notice in this simulation is that best and worst case is actually almost the same for Selection Sort (\(O(n^2)\)), but for Bubble Sort the best case runtime is only \(O(n)\).</p>
<p>The difference in best and worst case for Selection Sort is mainly the number of swaps. In the best case scenario Selection Sort does not have to swap any of the values because the array is already sorted. And in the worst case scenario, where the array already sorted, but in the wrong order, so Selection Sort must do as many swaps as there are values in array.</p>
<hr>

<div>
<h2>DSA Exercises</h2>
<form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_algo_selectionsort1" method="post" target="_blank">
<h2>Test Yourself With Exercises</h2>
<div class="exercisewindow">
<h2>Exercise:</h2>
<p>Using Selection Sort on this array:</p>
<code>[7,12,9,11,3]</code>
<p>To sort the values from left to right in an increasing (ascending) order.</p>
<p>What is the value of the LAST element after the first run through?</p>
<div class="exerciseprecontainer">
<pre style="overflow: auto;">
<input name="ex1" maxlength="2" style="width: 3ch;">
</pre>
</div>
<br>
<button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
<p><a target="_blank" href="exercise.php?filename=exercise_algo_selectionsort1">Start the Exercise</a></p>
</div>
</form>
</div>
<hr>
