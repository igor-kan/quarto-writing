...
<html lang="en-US">
<head>
<title>DSA Pre-order Traversal</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>DSA <span class="color_h1">Pre-order Traversal</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="dsa_data_binarytrees.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="dsa_algo_binarytrees_inorder.php">Next &#10095;</a>
</div>
...
<p>Pre-order Traversal is a type of Depth First Search, where each node is visited in a certain order. Read more about Binary Tree traversals in general <a href="dsa_data_binarytrees.php#traversal">here</a>.</p>
<p>Pre-order traversal of a Binary Tree looks like this:</p>
<div id="divAnim4">
...
<g class="child leaf G">
  ...
  <p>Result: </p>
  <button onclick="tl4.play();">Pre-order Traverse</button>
</div>
<script src="https://cdnjs.cloudflare.com/ajax/libs/animejs/3.2.1/anime.min.js" integrity="sha512-z4OUqw38qNLpn1libAN9BsoDx6nbNFio5lA6CuTp9NlK83b89hgyCVq+N5FdBJptINztxn1Z3SaKSKUS5UP60Q==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
<script>
  let traverseBtn4 = document.querySelector('#divAnim4 button');
  let pResult4 = document.querySelector('#divAnim4 p');
...
tl4.add({
  targets: '#divAnim4 circle, #divAnim4 text, #divAnim4 line',
  opacity: 1,
  duration: 200,
  begin: function(anim){
  ...
  complete: function(anim){
    traverseBtn4.innerHTML = 'Pre-order Traverse';
    traverseBtn4.disabled = false;
    tl4.pause();
  }
})
.add({
  targets: '#divAnim4 .R circle',
  begin: function(anim){
    traverseBtn4.disabled = true;
    document.querySelector('#divAnim4 .R circle').classList.add('nodePrinted');
    document.querySelector('#divAnim4 .R circle').classList.add('extraThick');
    document.querySelector('#divAnim4 p').innerHTML += 'R';
  },
  complete: function(anim){
    document.querySelector('#divAnim4 .R circle').classList.remove('extraThick');
  }
})
.add({
  targets: '#divAnim4 .R',
  opacity: [1,0.5],
  begin: function(anim){
    document.querySelector('#divAnim4 .A circle').classList.add('nodePrinted');
    document.querySelector('#divAnim4 .A circle').classList.add('extraThick');
    document.querySelector('#divAnim4 p').innerHTML += ',A';
  },
  complete: function(anim){
    document.querySelector('#divAnim4 .A circle').classList.remove('extraThick');
  }
})
.add({
  targets: '#divAnim4 .A',
  opacity: [1,0.5],
  begin: function(anim){
    document.querySelector('#divAnim4 .C circle').classList.add('nodePrinted');
    document.querySelector('#divAnim4 .C circle').classList.add('extraThick');
    document.querySelector('#divAnim4 p').innerHTML += ',C';
  },
  complete: function(anim){
    document.querySelector('#divAnim4 .C circle').classList.remove('extraThick');
  }
})
.add({
  targets: '#divAnim4 .C',
  opacity: [1,0.5],
  begin: function(anim){
    document.querySelector('#divAnim4 .D circle').classList.add('nodePrinted');
    document.querySelector('#divAnim4 .D circle').classList.add('extraThick');
    document.querySelector('#divAnim4 p').innerHTML += ',D';
  },
  complete: function(anim){
    document.querySelector('#divAnim4 .D circle').classList.remove('extraThick');
  }
})
.add({
  targets: '#divAnim4 .D',
  opacity: [1,0.5],
  begin: function(anim){
    document.querySelector('#divAnim4 .B circle').classList.add('nodePrinted');
    document.querySelector('#divAnim4 .B circle').classList.add('extraThick');
    document.querySelector('#divAnim4 p').innerHTML += ',B';
  },
  complete: function(anim){
    document.querySelector('#divAnim4 .B circle').classList.remove('extraThick');
  }
})
.add({
  targets: '#divAnim4 .B',
  opacity: [1,0.5],
  begin: function(anim){
    document.querySelector('#divAnim4 .E circle').classList.add('nodePrinted');
    document.querySelector('#divAnim4 .E circle').classList.add('extraThick');
    document.querySelector('#divAnim4 p').innerHTML += ',E';
  },
  complete: function(anim){
    document.querySelector('#divAnim4 .E circle').classList.remove('extraThick');
  }
})
.add({
  targets: '#divAnim4 .E',
  opacity: [1,0.5],
  begin: function(anim){
    document.querySelector('#divAnim4 .F circle').classList.add('nodePrinted');
    document.querySelector('#divAnim4 .F circle').classList.add('extraThick');
    document.querySelector('#divAnim4 p').innerHTML += ',F';
  },
  complete: function(anim){
    document.querySelector('#divAnim4 .F circle').classList.remove('extraThick');
  }
})
.add({
  targets: '#divAnim4 .F',
  opacity: [1,0.5],
  begin: function(anim){
    document.querySelector('#divAnim4 .G circle').classList.add('nodePrinted');
    document.querySelector('#divAnim4 .G circle').classList.add('extraThick');
    document.querySelector('#divAnim4 p').innerHTML += ',G';
  },
  complete: function(anim){
    document.querySelector('#divAnim4 .G circle').classList.remove('extraThick');
  }
})
.add({
  targets: '#divAnim4 .G',
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Python:</p>
  <pre class="language-python notranslate line-numbers w3-white"><code>def preOrderTraversal(node):
    if node is None:
        return
    print(node.data, end=", ")
    preOrderTraversal(node.left)
    preOrderTraversal(node.right)</code></pre>
  <a class="w3-btn w3-margin-bottom" href="trydsa.php?filename=demo_binarytree_preordertraversal" target="_blank">Try it Yourself &raquo;</a>
</div>
