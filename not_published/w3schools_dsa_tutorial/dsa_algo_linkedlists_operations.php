...
<html lang="en-US">
<head>
<title>DSA Linked Lists Operations</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>DSA <span class="color_h1">Linked Lists Operations</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="dsa_data_linkedlists_types.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="dsa_data_stacks.php">Next &#10095;</a>
</div>
<hr>
...
<p>To traverse a singly linked list, we start with the first node in the list, the head node, and follow that node's next link, and the next node's next link and so on, until the next address is null, like in the animation below:</p>
<div id="divAnim1">
<svg id="svgTraverse" class="dsa_svg" viewBox="0 0 570 100" xmlns="http://www.w3.org/2000/svg">
<defs>
        <style>
            .svgText {
        ...
        <marker id="arrowhead1" markerWidth="8" markerHeight="14" refX="0" refY="7" orient="auto" markerUnits="userSpaceOnUse">
        ...
        <marker id="arrowhead3" markerWidth="8" markerHeight="14" refX="0" refY="7" orient="auto" markerUnits="userSpaceOnUse">
            <line x1="0.5" y1="0.5" x2="7.5" y2="7.5" stroke="black" stroke-width="1.5"/>
            <line x1="0" y1="7" x2="6" y2="7" stroke="black" stroke-width="1"/>
            <line x1="0.5" y1="13.5" x2="7.5" y2="6.5" stroke="black" stroke-width="1.5"/>
        </marker>
        <marker id="arrowhead4" markerWidth="8" markerHeight="14" refX="0" refY="7" orient="auto" markerUnits="userSpaceOnUse">
            <line x1="0.5" y1="0.5" x2="7.5" y2="7.5" stroke="black" stroke-width="1.5"/>
            <line x1="0" y1="7" x2="6" y2="7" stroke="black" stroke-width="1"/>
            <line x1="0.5" y1="13.5" x2="7.5" y2="6.5" stroke="black" stroke-width="1.5"/>
        </marker>
        <marker id="arrowhead5" markerWidth="8" markerHeight="14" refX="0" refY="7" orient="auto" markerUnits="userSpaceOnUse">
            <line x1="0.5" y1="0.5" x2="7.5" y2="7.5" stroke="black" stroke-width="1.5"/>
            <line x1="0" y1="7" x2="6" y2="7" stroke="black" stroke-width="1"/>
            <line x1="0.5" y1="13.5" x2="7.5" y2="6.5" stroke="black" stroke-width="1.5"/>
        </marker>
    ...
    <!-- Node 1 -->
    <line class="arrow1" x1="42" y1="33" x2="60" y2="33" stroke="black" stroke-width="1" fill="none" marker-end="url(#arrowhead1)"></line>
    ...
    <path class="arrow2" d="M120,68 C150,68 120,33 150,33" stroke="black" stroke-width="1" fill="none"
          marker-end="url(#arrowhead2)"></path>
    <path d="M 70 25
              L 120 25
              L 120 81 
              L 70 81 Z"
    ...
    <path class="arrow3" d="M210,68 C240,68 210,33 240,33" stroke="black" stroke-width="1" fill="none"
          marker-end="url(#arrowhead3)"></path>
    <path d="M 160 25
              L 210 25
              L 210 82 
              L 160 82 Z"
    ...
    <path class="arrow4" d="M300,68 C330,68 300,33 330,33" stroke="black" stroke-width="1" fill="none"
          marker-end="url(#arrowhead4)"></path>
    <path d="M 250 25 
              L 300 25 
              L 300 82 
              L 250 82 Z"
...
<path class="arrow5" d="M390,68 C420,68 390,33 420,33" stroke="black" stroke-width="1" fill="none"
          marker-end="url(#arrowhead5)"></path>
<path d="M 340 25
          L 390 25
          L 390 82 
          L 340 82 Z"
    stroke="black" stroke-width="0" fill="none" class="path4"></path>
    <!-- Node 5 -->
<path d="M 430 25
          L 480 25
          L 480 53 
...
<line class="arrow6" x1="482" y1="68" x2="505" y2="68" stroke="#dc143c" stroke-width="1" fill="none" stroke-dasharray="5,5" marker-end="url(#arrowheadRed)"></line>
...
<button id="btnTraverse" style="margin-bottom: 10px;">Traverse</button>
<script src="https://cdnjs.cloudflare.com/ajax/libs/animejs/3.2.1/anime.min.js" integrity="sha512-z4OUqw38qNLpn1libAN9BsoDx6nbNFio5lA6CuTp9NlK83b89hgyCVq+N5FdBJptINztxn1Z3SaKSKUS5UP60Q==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
<script>
let btnTraverse = document.getElementById('btnTraverse');

let animDelay = 800;

btnTraverse.addEventListener("click", function() {

  btnTraverse.disabled = true;
  btnTraverse.innerHTML = "Traversing..."
  ...
  let traverseTimeline = anime.timeline({
    ...
    complete: function(){
      ...
      btnTraverse.innerHTML = 'Traverse';
      anime({
        // targets: '#svgFindLowest'
      });
    }
  });
  ...
  traverseTimeline
    ...
    .add({
      targets: '#svgTraverse .arrow1, #arrowhead1 line',
      strokeWidth: [
        { value: 3 },
        { value: 1 }
      ]
    ...
    .add({
      targets: '#svgTraverse .arrow2, #arrowhead2 line',
      strokeWidth: [
        { value: 3 },
        { value: 1 }
      ]
    ...
    .add({
      targets: '#svgTraverse .arrow3, #arrowhead3 line',
      strokeWidth: [
        { value: 3 },
        { value: 1 }
      ]
    ...
    .add({
      targets: '#svgTraverse .arrow4, #arrowhead4 line',
      strokeWidth: [
        { value: 3 },
        { value: 1 }
      ]
    ...
    .add({
      targets: '#svgTraverse .arrow5, #arrowhead5 line',
      strokeWidth: [
        { value: 3 },
        { value: 1 }
      ]
    ...
    .add({
      targets: '#svgTraverse .arrow6, #arrowheadRed line',
      strokeWidth: [
        { value: 3 },
        { value: 1 }
      ]
...
traverseAndPrint(node1)</code></pre>
  <a class="w3-btn w3-margin-bottom" href="trydsa.php?filename=demo_linkedLists_traverse" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<p>Finding the lowest value in a linked list is very similar to how we <a href="dsa_data_arrays.php#findLowest">found the lowest value in an array</a>, except that we need to follow the next link to get to the next node.</p>
<p>This is how finding the lowest value in a linked list works in principle:</p>
<div id="divAnim2">
  <svg id="svgFindLowest" class="dsa_svg" viewBox="0 0 570 90" xmlns="http://www.w3.org/2000/svg">
<defs>
        <style>
            .svgText {
                font-family: Veranda, sans-serif;
        ...
        <marker id="arrowhead01" markerWidth="8" markerHeight="14" refX="0" refY="7" orient="auto" markerUnits="userSpaceOnUse">
            <line x1="0.5" y1="0.5" x2="7.5" y2="7.5" stroke="black" stroke-width="1.5"/>
            <line x1="0" y1="7" x2="6" y2="7" stroke="black" stroke-width="1"/>
            <line x1="0.5" y1="13.5" x2="7.5" y2="6.5" stroke="black" stroke-width="1.5"/>
        </marker>
        <marker id="arrowhead02" markerWidth="8" markerHeight="14" refX="0" refY="7" orient="auto" markerUnits="userSpaceOnUse">
            <line x1="0.5" y1="0.5" x2="7.5" y2="7.5" stroke="black" stroke-width="1.5"/>
            <line x1="0" y1="7" x2="6" y2="7" stroke="black" stroke-width="1"/>
            <line x1="0.5" y1="13.5" x2="7.5" y2="6.5" stroke="black" stroke-width="1.5"/>
        </marker>
        <marker id="arrowhead03" markerWidth="8" markerHeight="14" refX="0" refY="7" orient="auto" markerUnits="userSpaceOnUse">
            <line x1="0.5" y1="0.5" x2="7.5" y2="7.5" stroke="black" stroke-width="1.5"/>
            <line x1="0" y1="7" x2="6" y2="7" stroke="black" stroke-width="1"/>
            <line x1="0.5" y1="13.5" x2="7.5" y2="6.5" stroke="black" stroke-width="1.5"/>
        </marker>
        <marker id="arrowhead04" markerWidth="8" markerHeight="14" refX="0" refY="7" orient="auto" markerUnits="userSpaceOnUse">
            <line x1="0.5" y1="0.5" x2="7.5" y2="7.5" stroke="black" stroke-width="1.5"/>
            <line x1="0" y1="7" x2="6" y2="7" stroke="black" stroke-width="1"/>
            <line x1="0.5" y1="13.5" x2="7.5" y2="6.5" stroke="black" stroke-width="1.5"/>
        </marker>
        <marker id="arrowhead05" markerWidth="8" markerHeight="14" refX="0" refY="7" orient="auto" markerUnits="userSpaceOnUse">
            <line x1="0.5" y1="0.5" x2="7.5" y2="7.5" stroke="black" stroke-width="1.5"/>
            <line x1="0" y1="7" x2="6" y2="7" stroke="black" stroke-width="1"/>
            <line x1="0.5" y1="13.5" x2="7.5" y2="6.5" stroke="black" stroke-width="1.5"/>
        </marker>
        <marker id="arrowheadRed0" markerWidth="8" markerHeight="14" refX="0" refY="7" orient="auto" markerUnits="userSpaceOnUse">
            <line x1="0.5" y1="0.5" x2="7.5" y2="7.5" stroke="#dc143c" stroke-width="1.5"/>
            <line x1="0" y1="7" x2="6" y2="7" stroke="#dc143c" stroke-width="1"/>
            <line x1="0.5" y1="13.5" x2="7.5" y2="6.5" stroke="#dc143c" stroke-width="1.5"/>
        </marker>
    ...
    <!-- Node 1 -->
    <line class="arrow01" x1="42" y1="33" x2="60" y2="33" stroke="black" stroke-width="1" fill="none" marker-end="url(#arrowhead01)"></line>
    <text x="1" y="37" class="svgDataText text1">Head</text>
    <path d="M 70 25
              L 120 25
              L 120 53 
    ...
    <path class="arrow02" d="M120,68 C150,68 120,33 150,33" stroke="black" stroke-width="1" fill="none"
          marker-end="url(#arrowhead02)"></path>
    <path d="M 70 25
              L 120 25
              L 120 81 
              L 70 81 Z"
    ...
    <line x1="165" y1="68" x2="205" y2="68" stroke="#FCFC62" stroke-width="3"></line>
    <text x="170" y="72" class="svgAddressText2 text3">next</text>
    <path class="arrow03" d="M210,68 C240,68 210,33 240,33" stroke="black" stroke-width="1" fill="none"
          marker-end="url(#arrowhead03)"></path>
    <path d="M 160 25
              L 210 25
              L 210 82 
              L 160 82 Z"
    ...
    <line x1="255" y1="68" x2="295" y2="68" stroke="#FCFC62" stroke-width="3"></line>
    <text x="260" y="72" class="svgAddressText2 text4">next</text>
    <path class="arrow04" d="M300,68 C330,68 300,33 330,33" stroke="black" stroke-width="1" fill="none"
          marker-end="url(#arrowhead04)"></path>
    <path d="M 250 25 
              L 300 25 
              L 300 82 
              L 250 82 Z"
...
<line x1="345" y1="68" x2="385" y2="68" stroke="#FCFC62" stroke-width="3"></line>
<text x="350" y="72" class="svgAddressText2 text5">next</text>
<path class="arrow05" d="M390,68 C420,68 390,33 420,33" stroke="black" stroke-width="1" fill="none"
          marker-end="url(#arrowhead05)"></path>
<path d="M 340 25
          L 390 25
          L 390 82 
          L 340 82 Z"
...
<line x1="435" y1="68" x2="475" y2="68" stroke="#FCFC62" stroke-width="3"></line>
<text x="440" y="72" class="svgAddressText2 text6">next</text>
<line class="arrow06" x1="482" y1="68" x2="505" y2="68" stroke="#dc143c" stroke-width="1" fill="none" stroke-dasharray="5,5" marker-end="url(#arrowheadRed0)"></line>
<text x="520" y="72" class="svgAddressTextRed text7">null</text>
<path d="M 430 25
          L 480 25
          L 480 82 
...
<div class="btnDiv">
  <p>Lowest value: <span id="spanLowest"></span></p>
  <button id="btnFindLowest">Find Lowest</button><span id="spanLowestFinished" style="margin-left: 10px;"></span>
</div>

<script src="https://cdnjs.cloudflare.com/ajax/libs/animejs/3.2.1/anime.min.js" integrity="sha512-z4OUqw38qNLpn1libAN9BsoDx6nbNFio5lA6CuTp9NlK83b89hgyCVq+N5FdBJptINztxn1Z3SaKSKUS5UP60Q==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
<script>
let btnFindLowest = document.getElementById('btnFindLowest');
let spanLowestFinished = document.getElementById('spanLowestFinished');
let spanLowest = document.getElementById('spanLowest');

let animDelay2 = 800;

btnFindLowest.addEventListener("click", function() {
  if(btnFindLowest.innerHTML === "Find Lowest" || btnFindLowest.innerHTML === "Try Again"){
    btnFindLowest.disabled = true;
    spanLowestFinished.innerHTML = '';
    spanLowest.innerHTML = '';
    // Animation to traverse the list
    let traverseTimeline = anime.timeline({
      loop: false,
      easing: 'easeInOutBack',
      ...
      duration: animDelay2,
      complete: function(){
        btnFindLowest.disabled = false;
        btnFindLowest.innerHTML = 'Try Again';
        spanLowestFinished.innerHTML = 'Done!';
        anime({
    ...
    traverseTimeline
      .add({
        targets: '#svgFindLowest .valNode4, #svgFindLowest .rectNode4',
        fill: '#e0e0e0',
        duration: 200,
        easing: 'linear'
      })
      .add({
        targets: '#svgFindLowest .text1',
        strokeWidth: [
          { value: 1 },
          { value: 0 }
        ]
      ...
      .add({
        targets: '#svgFindLowest .arrow01, #arrowhead01 line',
        strokeWidth: [
          { value: 3 },
          { value: 1 }
        ]
      ...
      .add({
        targets: '#svgFindLowest .path1',
        strokeWidth: [
          { value: 4 }
        ],
        duration: animDelay2/2
      }, '-=400')
      // Lowest -> 7
      .add({
        targets: '#svgFindLowest .valNode1, #svgFindLowest .rectNode1',
        fill: '#90ee90'
      }, '-=400')
      .add({
        targets: '#spanLowest',
      ...
      .add({
        targets: '#svgFindLowest .arrow02, #arrowhead02 line',
        strokeWidth: [
          { value: 3 },
          { value: 1 }
        ]
      ...
      .add({
        targets: '#svgFindLowest .arrow03, #arrowhead03 line',
        strokeWidth: [
          { value: 3 },
          { value: 1 }
        ]
      ...
      // Lowest 7 -> 3
      .add({
        targets: '#svgFindLowest .valNode3, #svgFindLowest .rectNode3',
        fill: '#90ee90'
      }, '-=400')
      .add({
        targets: '#svgFindLowest .valNode1, #svgFindLowest .rectNode1',
      ...
      .add({
        targets: '#svgFindLowest .arrow04, #arrowhead04 line',
        strokeWidth: [
          { value: 3 },
          { value: 1 }
        ]
      ...
      .add({
        targets: '#svgFindLowest .arrow05, #arrowhead05 line',
        strokeWidth: [
          { value: 3 },
          { value: 1 }
        ]
      ...
      .add({
        targets: '#svgFindLowest .arrow06, #arrowheadRed0 line',
        strokeWidth: [
          { value: 3 },
          { value: 1 }
        ]
    ...
    btnFindLowest.innerHTML = 'Find Lowest';
    spanLowestFinished.innerHTML = '';
    spanLowest.innerHTML = '';
    anime({
      targets: '#svgFindLowest .valNode4, #svgFindLowest .rectNode4',
...
<div class="w3-example">
  ...
  <pre class="language-python notranslate w3-white" data-line="7,10-11"><code>class Node:
    def __init__(self, data):
        self.data = data
        self.next = None
...
print("The lowest value in the linked list is:", findLowestValue(node1))</code></pre>
<p>The marked lines above is the core of the algorithm. The initial lowest value is set to be the value of the first node. Then, if a lower value is found, the lowest value variable is udated.</p>
  <a class="w3-btn w3-margin-bottom" href="trydsa.php?filename=demo_linkedlists_findlowest" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Delete a Node in a Linked List</h2>
<p>In this case we have the link (or pointer or address) to a node that we want to delete.</p>
<p>It is important to connect the nodes on each side of the node before deleting it, so that the linked list is not broken.</p>
...
<p>In a singly linked list, like we have here, to get the next pointer from the previous node we actually need traverse the list from the start, because there is no way to go backwards from the node we want to delete.</p>
...
<div class="w3-example">
  ...
  <pre class="language-python notranslate w3-white" data-line="13-27"><code>class Node:
    def __init__(self, data):
        self.data = data
        self.next = None
...
print("\nAfter deletion:")
traverseAndPrint(node1)</code></pre>
  <a class="w3-btn w3-margin-bottom" href="trydsa.php?filename=demo_linkedlists_deletespecific" target="_blank">Try it Yourself &raquo;</a>
</div>
...
print("\nAfter insertion:")
traverseAndPrint(node1)</code></pre>
  <a class="w3-btn w3-margin-bottom" href="trydsa.php?filename=demo_linkedLists_insert" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<h2>Other Linked Lists Operations</h2>
<p>We have only covered three basic linked list operations above: traversal (or search), node deletion, and node insertion.</p>
<p>There are a lot of other operations that could be done with linked lists, like sorting for example.</p>
<p>Previously in the tutorial we have covered many sorting algorithms, and we could do many of these sorting algorithms on linked lists as well. Let's take selection sort for example. In selection sort we find the lowest value, remove it, and insert it at the beginning. We could do the same with a linked list as well, right? We have just seen how to search through a linked list, how to remove a node, and how to insert a node.</p>
<div class="ws-note">
  <p><strong>Note:</strong> We cannot sort linked lists with sorting algorithms like Counting Sort, Radix Sort or Quicksort because they use indexes to modify array elements directly based on their position.</p>
</div>
<hr>
...
<div class="ws-note">
  <p><strong>Note: </strong>When using arrays in programming languages like Java or Python, even though we do not need to write code to handle when an array fills up its memory space, and we do not have to shift elements up or down in memory when an element is removed or inserted, these things still happen in the background and can cause problems in time critical applications.</p>
</div>
<hr>
...
<p>Remember that time complexity just says something about the approximate number of operations needed by the algorithm based on a large set of data \(n\), and does not tell us the exact time a specific implementation of an algorithm takes.</p>
...
<p><a href="dsa_algo_linearsearch.php">Linear search</a> for linked lists works the same as for arrays. A list of unsorted values are traversed from the head node until the node with the specific value is found. Time complexity is \(O(n)\).</p>
<p><a href="dsa_algo_binarysearch.php">Binary search</a> is not possible for linked lists because the algorithm is based on jumping directly to different array elements, and that is not possible with linked lists.</p>
...
<div>
<h2>DSA Exercises</h2>
<form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_theory_linkedlists4" method="post" target="_blank">
<h2>Test Yourself With Exercises</h2>
<div class="exercisewindow">
<h2>Exercise:</h2>
<p>Complete the code for the Linked List traversal function.</p>
<div class="exerciseprecontainer">
<pre style="overflow: auto;">
def traverseAndPrint(head):
    currentNode = <input name="ex1" maxlength="4" style="width: 5ch;">
    while currentNode:
        print(currentNode.data, end=" -> ")
        currentNode = currentNode.<input name="ex2" maxlength="4" style="width: 5ch;">
    print("null")
</pre>
</div>
<br>
<button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
<p><a target="_blank" href="exercise.php?filename=exercise_theory_linkedlists4">Start the Exercise</a></p>
</div>
</form>
</div>
<hr>
