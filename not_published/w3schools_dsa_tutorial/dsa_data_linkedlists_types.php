...
<html lang="en-US">
<head>
<title>DSA Linked Lists Types</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>DSA <span class="color_h1">Linked Lists Types</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="dsa_theory_linkedlists_memory.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="dsa_algo_linkedlists_operations.php">Next &#10095;</a>
</div>
<hr>
...
<img src="img_linkedlists_singly.svg" class="dsa_img" alt="A singly linked list.">
<hr>
...
<img src="img_linkedlists_doubly.svg" class="dsa_img" alt="A doubly linked list.">
<hr>
...
<img src="img_linkedlists_circsingly.svg" class="dsa_img" alt="A circular singly linked list.">

<p>The image below is an example of a doubly circular linked list:</p>
<img src="img_linkedlists_circdoubly.svg" class="dsa_img" alt="A circular doubly linked list.">
<div class="ws-note">
  <p><strong>Note: </strong>What kind of linked list you need depends on the problem you are trying to solve.</p>
</div>
<hr>

<h2>Linked List Implementations</h2>
<p>Below are basic implementations of:</p>
<ol>
...
<p>The next page will cover different operations that can be done on linked lists.</p>
<hr>

<a id="singlyImpl"></a>
<h2>1. Singly Linked List Implementation</h2>
<p>Below is an implementation of this singly linked list:</p>
<img src="img_linkedlists_singly_wvalues.svg" class="dsa_img" alt="A singly linked list with values.">
<div class="w3-example">
  <h3>Example</h3>
  <p>A basic singly linked list in Python:</p>
  <p>(This is the same example as on the bottom of the previous page.)</p>
...
print("null")</code></pre>
  <a class="w3-btn w3-margin-bottom" href="trydsa.php?filename=demo_linkedLists_singly" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<h2>2. Doubly Linked List Implementation</h2>
<p>Below is an implementation of this doubly linked list:</p>
<img src="img_linkedlists_doubly_wvalues.svg" class="dsa_img" alt="A doubly linked list with values.">
<div class="w3-example">
  <h3>Example</h3>
  <p>A basic doubly linked list in Python:</p>
  <pre class="language-python notranslate w3-white"><code>class Node:
    def __init__(self, data):
        self.data = data
        self.next = None
...
print("null")</code></pre>
  <a class="w3-btn w3-margin-bottom" href="trydsa.php?filename=demo_linkedLists_doubly" target="_blank">Try it Yourself &raquo;</a>
</div>
<p></p>
<hr>

<h2>3. Circular Singly Linked List Implementation</h2>
<p>Below is an implementation of this circular singly linked list:</p>
<img src="img_linkedlists_circsingly_wvalues.svg" class="dsa_img" alt="A circular singly linked list with values.">
<div class="w3-example">
  <h3>Example</h3>
  <p>A basic circular singly linked list in Python:</p>
  <pre class="language-python notranslate w3-white line-numbers" data-line="14,17"><code>class Node:
    def __init__(self, data):
        self.data = data
        self.next = None
...
print("...")</code></pre>
  <a class="w3-btn w3-margin-bottom" href="trydsa.php?filename=demo_linkedlists_circsingly" target="_blank">Try it Yourself &raquo;</a>
</div>
<p><strong>Line 14: </strong>This makes the singly list circular.</p>
<p><strong>Line 17: </strong>This is how the program knows when to stop so that it only goes through the list one time.</p>
<hr>

<h2>4. Circular Doubly Linked List Implementation</h2>
<p>Below is an implementation of this circular doubly linked list:</p>
<img src="img_linkedlists_circdoubly_wvalues.svg" class="dsa_img" alt="A circular doubly linked list with values.">
<div class="w3-example">
  <h3>Example</h3>
  <p>A basic circular doubly linked list in Python:</p>
  <pre class="language-python notranslate w3-white line-numbers" data-line="13,22,26"><code>class Node:
    def __init__(self, data):
        self.data = data
        self.next = None
        self.prev = None
...
while currentNode != startNode:
    ...
    currentNode = currentNode.prev
print("...")</code></pre>
  <a class="w3-btn w3-margin-bottom" href="trydsa.php?filename=demo_linkedlists_circdoubly" target="_blank">Try it Yourself &raquo;</a>
</div>
<p><strong>Lines 13 and 22: </strong>These links makes the doubly linked list circular.</p>
<p><strong>Lines 26: </strong>This is how the program knows when to stop so that it only goes through the list one time.</p>
<hr>

<div>
<h2>DSA Exercises</h2>
<form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_theory_linkedlists3" method="post" target="_blank">
<h2>Test Yourself With Exercises</h2>
<div class="exercisewindow">
<h2>Exercise:</h2>
<p>Take a look at this singly Linked List: </p>
<img src="img_linkedlists_singly.svg" class="dsa_img" alt="A singly Linked List">
<p>How can we make this Linked List circular?</p>
<div class="exerciseprecontainer">
<pre style="overflow: auto;">
The list can be made circular 
by connecting the next pointer 
in the last node, to the <input name="ex1" maxlength="5" style="width: 6ch;"> node.
</pre>
</div>
<br>
<button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
<p><a target="_blank" href="exercise.php?filename=exercise_theory_linkedlists3">Start the Exercise</a></p>
</div>
</form>
</div>
<hr>
