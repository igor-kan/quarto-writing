...
ny:-->
    ...
    <h1>DSA <span class="color_h1">Queues</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="dsa_data_stacks.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="dsa_theory_hashtables.php">Next &#10095;</a>
</div>
<hr>
...
<p>The first person to stand in line is also the first who can pay and leave the supermarket. This way of organizing elements is called FIFO: First In First Out.</p>
...
<p>Experiment with these basic operations in the queue animation above.</p>
...
<p>To better understand the benefits with using arrays or linked lists to implement queues, you should check out <a href="dsa_theory_linkedlists_memory.php">this page</a> that explains how arrays and linked lists are stored in memory.</p>
<p>This is how it looks like when we use an array as a queue:</p>
<div id="vueApp2">
  <div id="frameDiv2">
    [
    <transition-group>
...
<ul>
  ...
  <li><strong>Easier to implement and understand: </strong>Using arrays to implement queues require less code than using linked lists, and for this reason it is typically easier to understand as well.</li>
</ul>
<p>Reasons for <strong>not</strong> using arrays to implement queues:</p>
<ul>
  <li><strong>Fixed size: </strong>An array occupies a fixed part of the memory. This means that it could take up more memory than needed, or if the array fills up, it cannot hold more elements. And resizing an array can be costly.</li>
  <li><strong>Shifting cost: </strong>Dequeue causes the first element in a queue to be removed, and the other elements must be shifted to take the removed elements' place. This is inefficient and can cause problems, especially if the queue is long.</li>
  <li><strong>Alternatives: </strong>Some programming languages have built-in data structures optimized for queue operations that are better than using arrays.</li>
</ul>
<div class="ws-note">
  <p><strong>Note:</strong> When using arrays in Python for this tutorial, we are really using the Python 'list' data type, but for the scope of this tutorial the 'list' data type can be used in the same way as an array. Learn more about Python lists <a href="https://www.w3schools.com/python/python_lists.asp">here</a>.</p>
</div>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Python:</p>
  <pre class="language-python notranslate w3-white"><code>queue = []
...
# Size
print("Size: ", len(queue))</code></pre>
  <a class="w3-btn w3-margin-bottom" href="trydsa.php?filename=demo_queues_array1" target="_blank">Try it Yourself &raquo;</a>
</div>
<p>But to explicitly create a data structure for queues, with basic operations, we should create a queue class instead. This way of creating queues in Python is also more similar to how queues can be created in other programming languages like C and Java.</p>
<div class="w3-example">
  <h3>Example</h3>
  <p>Python:</p>
  <pre class="language-python notranslate w3-white"><code>class Queue:
    def __init__(self):
        self.queue = []
...
print("Size: ", myQueue.size())</code></pre>
  <a class="w3-btn w3-margin-bottom" href="trydsa.php?filename=demo_queues_array2" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<ul>
  ...
  <li><strong>No shifting: </strong>The front element of the queue can be removed (dequeue) without having to shift other elements in the memory.</li>
</ul>
...
print("Size: ", myQueue.size())</code></pre>
  <a class="w3-btn w3-margin-bottom" href="trydsa.php?filename=demo_queues_linkedlist" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>

<div>
<h2>DSA Exercises</h2>
<form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_data_queues1" method="post" target="_blank">
<h2>Test Yourself With Exercises</h2>
<div class="exercisewindow">
<h2>Exercise:</h2>
<p>The Array below is used as a Queue data structure:</p>
<code>[5,11,8,3]</code>
<p>Which indexes and values are affected by the <span class="w3-codespan">endueue</span> and <span class="w3-codespan">dedueue</span> operations?</p>
<div class="exerciseprecontainer">
<pre style="overflow: auto;">
enqueue(7): 
    value 7 is placed on 
    index <input name="ex1" maxlength="1" style="width: 2ch;"> in the array.

dequeue(): 
    value <input name="ex2" maxlength="1" style="width: 2ch;"> is taken 
    out of the queue.
</pre>
</div>
<br>
<button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
<p><a target="_blank" href="exercise.php?filename=exercise_data_queues1">Start the Exercise</a></p>
</div>
</form>
</div>
<hr>
