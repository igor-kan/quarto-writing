...
<html lang="en-US">
<head>
<title>DSA Linear Search Time Complexity</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>DSA <span class="color_h1">Linear Search Time Complexity</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="dsa_timecomplexity_mergesort.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="dsa_timecomplexity_binarysearch.php">Next &#10095;</a>
</div>
<hr>
...
<p>For a general explanation of what time complexity is, visit <a href="dsa_timecomplexity_theory.php">this page</a>.</p>
<p>For a more thorough and detailed explanation of Insertion Sort time complexity, visit <a href="dsa_timecomplexity_insertionsort.php">this page</a>.</p>

<p><a href="dsa_algo_linearsearch.php">Linear Search</a> compares each value with the value it is looking for. If the value is found, the index is returned, and if it is not found -1 is returned.</p>
<p>To find the time complexity for Linear Search, let's see if we can fins out how many compare operations are needed to find a value in an array with \(n\) values.</p>
<p><strong>Best Case Scenario</strong> is if the value we are looking for is the first value in the array. In such a case only one compare is needed and the time complexity is \(O(1)\).</p>
<p><strong>Worst Case Scenario</strong> is if the whole array is looked through without finding the target value. In such a case all values in the array are compared with the target value, and the time complexity is \(O(n)\).</p>
<p><strong>Average Case Scenario</strong> is not so easy to pinpoint. What is the possibility to finding the target value? That depends on the values in the array right? But if we assume that exactly one of the values in the array is equal to the target value, and that the position of that value can be anywhere, the average time needed for Linear Search is half of the time time needed in the worst case scenario.</p>
<p>Time complexity for Linear Search is \(O(n)\).</p>
...
<p>Run the simulation for different number of values in an array, and see how many compares are needed for Linear Search to find a value in an array of \(n\) values:</p>
<div id="vueApp4">
...
<p>As you can see when running simulations of Linear Search, the search requires few compares if the value is found fast, but if the value we are looking for is not found, the maximum of compares are done.</p>
