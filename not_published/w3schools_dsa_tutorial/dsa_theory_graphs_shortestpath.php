...
#svgDiv-1, #svgDiv11, #svgDiv12, #svgDiv13 {
  width: 306px;
  max-width: 100%;
  height: auto;
}
#svgDiv11, #svgDiv12, #svgDiv13 {
  width: 351px;
}
.svgBalFac {
    font-family: "Roboto Mono", monospace;
...
ny:-->
    ...
    <h1>DSA <span class="color_h1">Shortest Path</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="dsa_algo_graphs_cycledetection.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="dsa_algo_graphs_dijkstra.php">Next &#10095;</a>
</div>
<hr>

<h2>The Shortest Path Problem</h2>
<p>The shortest path problem is famous in the field of computer science.</p>
<p>To solve the shortest path problem means to find the shortest possible route or path between two vertices (or nodes) in a Graph.</p>
<p>In the shortest path problem, a Graph can represent anything from a road network to a communication network, where the vertices can be intersections, cities, or routers, and the edges can be roads, flight paths, or data links.</p>
<div id="svgDiv-1"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 340 210" class="dsa_svg">
<defs>
  ...
  <marker id="arrowheadThick" markerWidth="8" markerHeight="14" refX="0" refY="7" orient="auto" markerUnits="userSpaceOnUse">
      <line x1="0.5" y1="0.5" x2="7.5" y2="7.5" stroke-width="1.5" class="thick"/>
      <line x1="0" y1="7" x2="6" y2="7" stroke-width="1" class="thick"/>
      <line x1="0.5" y1="13.5" x2="7.5" y2="6.5" stroke-width="1.5" class="thick"/>
  </marker>
</defs>
  <!-- 'F' node -->
  ...
  <line x1="298" y1="46" x2="279" y2="69" class="directed FB translucent" marker-end="url(#arrowhead)" />
  <text x="274" y="61" class="svgBalFac translucent">2</text>

  <line x1="191" y1="65" x2="282" y2="39" class="directed CF thick" marker-end="url(#arrowheadThick)" />
  <text x="240" y="45" class="svgBalFac" style="opacity: 1;">4</text>

  <line x1="90" y1="70" x2="143" y2="70" class="directed connected AC translucent" marker-end="url(#arrowhead)" />
  <text x="120" y="67" class="svgBalFac connected translucent">3</text>

  <line x1="121" y1="169" x2="159" y2="97" class="directed connected EC thick" marker-end="url(#arrowheadThick)" />
  <text x="125" y="140" class="svgBalFac connected" style="opacity: 1;">4</text>

  <line x1="131" y1="187" x2="252" y2="187" class="directed connected EG translucent" marker-end="url(#arrowhead)" />
  <text x="180" y="183" class="svgBalFac connected translucent">5</text>

  <line x1="50" y1="187" x2="82" y2="187" class="directed connected DE thick" marker-end="url(#arrowheadThick)" />
  <text x="65" y="183" class="svgBalFac connected" style="opacity: 1;">2</text>
  <!-- 'B' node -->
  <g class="child leaf" transform="translate(90 -30)">
    <circle cx="170" cy="120" r="20" class="node translucent" />
    <text x="164" y="126" class="svgDataText translucent">B</text>
  </g>
  <!-- 'C' node -->
  <g class="parent child" transform="translate(-100 -50)">
    <circle cx="271" cy="120" r="20" class="node thick" />
    <text x="265" y="126" class="svgDataText">C</text>
  </g>
  <line x1="266" y1="174" x2="190" y2="92" class="directed GC translucent" marker-end="url(#arrowhead)" />
  <text x="212" y="140" class="svgBalFac">5</text>

  <line x1="284" y1="167" x2="308" y2="58" class="directed cyclic GF translucent" marker-end="url(#arrowhead)" />
  <!--<line x1="308" y1="50" x2="285" y2="167" class="undirected cyclic FG" />-->
  <text x="298" y="120" class="svgBalFac cyclicWeight">5</text>

  <line x1="190" y1="75" x2="232" y2="84" class="directed CB translucent" marker-end="url(#arrowhead)" />
  <text x="218" y="79" class="svgBalFac">3</text>


  <!-- Nodes A, D, and E -->
  <g class="parent child" transform="translate(-10 -20)">
    <circle cx="80" cy="90" r="20" class="node translucent" />
    <text x="73" y="96" class="svgDataText translucent">A</text>
    <line x1="48" y1="187" x2="71" y2="117" class="directed DA translucent" marker-end="url(#arrowhead)" />
    <text x="45" y="160" class="svgBalFac">4</text>

    <line x1="86" y1="110" x2="110" y2="180" class="directed AE translucent" marker-end="url(#arrowhead)" />
    <text x="89" y="160" class="svgBalFac">4</text>

    <circle cx="121" cy="207" r="20" class="node thick" />
  ...
  <g class="child leaf" transform="translate(-110 -20)">
    <circle cx="391" cy="207" r="20" class="node translucent" />
    <text x="385" y="213" class="svgDataText translucent">G</text>
  </g>
</svg></div>
...
<h2>Solutions to The Shortest Path Problem</h2>
<p><a href="dsa_algo_graphs_dijkstra.php">Dijkstra's algorithm</a> and <a href="dsa_algo_graphs_bellmanford.php">the Bellman-Ford algorithm</a> find the shortest path from one start vertex, to all other vertices.</p>
<p>To solve the shortest path problem means to check the edges inside the Graph until we find a path where we can move from one vertex to another using the lowest possible combined weight along the edges.</p>
<p>This sum of weights along the edges that make up a path is called a <strong>path cost</strong> or a <strong>path weight</strong>.</p>
<p>Algorithms that find the shortest paths, like <a href="dsa_algo_graphs_dijkstra.php">Dijkstra's algorithm</a> or <a href="dsa_algo_graphs_bellmanford.php">the Bellman-Ford algorithm</a>, find the shortest paths from one start vertex to all other vertices.</p>
<p>To begin with, the algorithms set the distance from the start vertex to all vertices to be infinitely long. And as the algorithms run, edges between the vertices are checked over and over, and shorter paths might be found many times until the shortest paths are found at the end.</p>
<p>Every time an edge is checked and it leads to a shorter distance to a vertex being found and updated, it is called a <strong>relaxation</strong>, or <strong>relaxing</strong> an edge.</p>
<hr>

<h2>Positive and Negative Edge Weights</h2>
<p>Some algorithms that find the shortest paths, like <a href="dsa_algo_graphs_dijkstra.php">Dijkstra's algorithm</a>, can only find the shortest paths in graphs where all the edges are positive. Such graphs with positive distances are also the easiest to understand because we can think of the edges between vertices as distances between locations.</p>
...
<defs>
  ...
  <marker id="arrowhead11AC" class="thick" markerWidth="8" markerHeight="14" refX="0" refY="7" orient="auto" markerUnits="userSpaceOnUse">
      <line x1="0.5" y1="0.5" x2="7.5" y2="7.5" stroke-width="1.5"></line>
      <line x1="0" y1="7" x2="6" y2="7" stroke-width="1"></line>
      <line x1="0.5" y1="13.5" x2="7.5" y2="6.5" stroke-width="1.5"></line>
  </marker>
  ...
  <marker id="arrowhead11BC" class="" markerWidth="8" markerHeight="14" refX="0" refY="7" orient="auto" markerUnits="userSpaceOnUse">
      <line x1="0.5" y1="0.5" x2="7.5" y2="7.5" stroke-width="1.5"></line>
      <line x1="0" y1="7" x2="6" y2="7" stroke-width="1"></line>
      <line x1="0.5" y1="13.5" x2="7.5" y2="6.5" stroke-width="1.5"></line>
  </marker>
  ...
  <path d="M 89 22 Q 182 -25 243 48" fill="none" stroke="black" stroke-width="1" class="directed AC thick" marker-end="url(#arrowhead11AC)"/>
  <rect x="160" y="0" width="30" height="30" class="node noticeWeight"></rect>
  ...
  <text x="155" y="65" class="svgBalFac connected translucent">3</text>
  ...
  <g class="child leaf translucent" transform="translate(180 25)">
    ...
    <text x="164" y="127" class="svgDataText">B</text>
  </g>
  <!-- 'C' node -->
  <g class="parent child" transform="translate(-10 -50)">
    <circle cx="271" cy="120" r="20" class="node C" />
    <text x="265" y="127" class="svgDataText">C</text>
  </g>

  <line x1="333" y1="133" x2="282" y2="90" class="directed BC translucent" marker-end="url(#arrowhead11BC)"/>
  <text x="310" y="110" class="svgBalFac translucent">2</text>

  <line x1="231" y1="183" x2="323" y2="154" class="directed connected EB translucent" marker-end="url(#arrowhead11EB)"/>
  <text x="280" y="182" class="svgBalFac connected translucent" >3</text>

  <line x1="36" y1="167" x2="63" y2="58" class="directed DA translucent" marker-end="url(#arrowhead11DA)" />
  ...
  <g class="parent child" transform="translate(-10 -60)">
    <circle cx="80" cy="90" r="20" class="node A active" />
    <text x="74" y="97" class="svgDataText">A</text>
  </g>

  <!-- Nodes E -->
  <g class="parent child translucent" transform="translate(90 -20)">
    <circle cx="121" cy="207" r="20" class="node E" />
    <text x="115" y="214" class="svgDataText">E</text>
  </g>

  <!-- Nodes D -->
  <g class="parent child translucent" transform="translate(-10 -20)">
    <circle cx="41" cy="207" r="20" class="node D" />
    <text x="35" y="214" class="svgDataText" >D</text>
  </g>
  
</svg>
</div>
<p>If we interpret the edge weights as money lost by going from one vertex to another, a positive edge weight of 4 from vertex A to C in the graph above means that we must spend $4 to go from A to C.</p>
<p>But graphs can also have negative edges, and for such graphs <a href="dsa_algo_graphs_bellmanford.php">the Bellman-Ford algorithm</a> can be used to find the shortest paths.</p>
...
<defs>
  ...
  <rect x="140" y="45" width="30" height="30" class="node noticeWeight"></rect>
  ...
  <line x1="333" y1="133" x2="282" y2="90" class="directed BC translucent" marker-end="url(#arrowhead12BC)"/>
  ...
  <line x1="36" y1="167" x2="63" y2="58" class="directed DA translucent" marker-end="url(#arrowhead12DA)" />
  <text x="35" y="120" class="svgBalFac translucent">4</text>
...
<p>And similarly, if the edge weights represent money lost, the negative edge weight -3 from vertex C to A in the graph above can be understood as an edge where there is more money to be made than money lost by going from C to A. So if for example the cost of fuel is $5 going from C to A, and we get paid $8 for picking up packages in C and delivering them in A, money lost is -3, meaning we are actually earning $3 in total.</p>
<hr>

<h2>Negative Cycles in Shortest Path Problems</h2>
<p>Finding the shortest paths becomes impossible if a graph has negative cycles.</p>
<p>Having a negative cycle means that there is a path where you can go in circles, and the edges that make up this circle have a total path weight that is negative.</p>
<p>In the graph below, the path A->E->B->C->A is a negative cycle because the total path weight is 5+2-4-4=-1.</p>
...
<defs>
  ...
  <marker id="arrowhead13AE" class="thick" markerWidth="8" markerHeight="14" refX="0" refY="7" orient="auto" markerUnits="userSpaceOnUse">
      <line x1="0.5" y1="0.5" x2="7.5" y2="7.5" stroke-width="1.5"></line>
      <line x1="0" y1="7" x2="6" y2="7" stroke-width="1"></line>
      <line x1="0.5" y1="13.5" x2="7.5" y2="6.5" stroke-width="1.5"></line>
  </marker>
  ...
  <marker id="arrowhead13EB" class="thick" markerWidth="8" markerHeight="14" refX="0" refY="7" orient="auto" markerUnits="userSpaceOnUse">
      <line x1="0.5" y1="0.5" x2="7.5" y2="7.5" stroke-width="1.5"></line>
      <line x1="0" y1="7" x2="6" y2="7" stroke-width="1"></line>
      <line x1="0.5" y1="13.5" x2="7.5" y2="6.5" stroke-width="1.5"></line>
  </marker>
  <marker id="arrowhead13BC" class="thick" markerWidth="8" markerHeight="14" refX="0" refY="7" orient="auto" markerUnits="userSpaceOnUse">
      <line x1="0.5" y1="0.5" x2="7.5" y2="7.5" stroke-width="1.5"></line>
      <line x1="0" y1="7" x2="6" y2="7" stroke-width="1"></line>
      <line x1="0.5" y1="13.5" x2="7.5" y2="6.5" stroke-width="1.5"></line>
  </marker>
  ...
  <text x="170" y="21" class="svgBalFac translucent" >5</text>

  <line x1="241" y1="67" x2="99" y2="36" class="directed connected CA thick" marker-end="url(#arrowhead13CA)"/>
  <text x="145" y="65" class="svgBalFac connected">-4</text>

  <line x1="218" y1="168" x2="249" y2="96" class="directed connected EC translucent" marker-end="url(#arrowhead13EC)"/>
  <text x="237" y="140" class="svgBalFac connected translucent" >3</text>

  <line x1="50" y1="187" x2="182" y2="187" class="directed connected DE translucent" marker-end="url(#arrowhead13DE)"/>
  <text x="106" y="203" class="svgBalFac connected translucent" >3</text>
  <!-- 'B' node -->
  ...
  <line x1="333" y1="133" x2="282" y2="91" class="directed BC thick" marker-end="url(#arrowhead13BC)"/>
  <text x="305" y="110" class="svgBalFac ">-4</text>

  <line x1="231" y1="183" x2="322" y2="154" class="directed connected EB thick" marker-end="url(#arrowhead13EB)"/>
  ...
  <line x1="49" y1="178" x2="235" y2="83" class="directed DC translucent" marker-end="url(#arrowhead13DC)" />
  <text x="95" y="147" class="svgBalFac translucent">7</text>

  <line x1="82" y1="46" x2="191" y2="165" class="directed AE thick" marker-end="url(#arrowhead13AE)"/>
  <text x="158" y="155" class="svgBalFac ">5</text>

  <!-- Nodes A -->
  <g class="parent child" transform="translate(-10 -60)">
    <circle cx="80" cy="90" r="20" class="node A active thick" />
...
<p>The reason why it is impossible to find the shortest paths in a graph with negative cycles is that it will always be possible to continue running an algorithm to find even shorter paths.</p>
<p>Let's say for example that we are looking for the shortest distance from vertex D in graph above, to all other vertices. At first we find the distance from D to E to be 3, by just walking the edge D->E. But after this, if we walk one round in the negative cycle E->B->C->A->E, then the distance to E becomes 2. After walking one more round the distance becomes 1, which is even shorter, and so on. We can always walk one more round in the negative cycle to find a shorter distance to E, which means the shortest distance can never be found.</p>
<p>Luckily, the <a href="dsa_algo_graphs_bellmanford.php">the Bellman-Ford algorithm</a>, that runs on graphs with negative edges, can be implemented with detection for negative cycles.</p>
<hr>
