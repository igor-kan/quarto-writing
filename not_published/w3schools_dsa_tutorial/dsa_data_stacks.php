...
<a class="w3-left w3-btn" href="dsa_algo_linkedlists_operations.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="dsa_data_queues.php">Next &#10095;</a>
</div>
<hr>
...
<div id="vueApp">
  ...
  <button @click="stack('push')" :disabled="pushIsDisabled">push()</button>
  <button @click="stack('pop')" :disabled="popIsDisabled">pop()</button>
  <button @click="stack('peek')" :disabled="stackTooLow">peek()</button>
  <button @click="stack('isEmpty')">isEmpty()</button>
  <button @click="stack('size')">size()</button>
</div>
<script>
...
<p>To better understand the benefits with using arrays or linked lists to implement stacks, you should check out <a href="dsa_theory_linkedlists_memory.php">this page</a> that explains how arrays and linked lists are stored in memory.</p>
...
<div id="vueApp2">
  ...
  <!--<p>Delay: <input v-model="delay" type="range" min="150" max="500"> {{ delay }}</p>-->
  <p>{{ resultText }}: {{ currVal }}</p>
  <button @click="queue('push')" :disabled="pushIsDisabled">push()</button>
  <button @click="queue('pop')" :disabled="popIsDisabled">pop()</button>
...
print("Size: ",len(stack))</code></pre>
  <a class="w3-btn w3-margin-bottom" href="trydsa.php?filename=demo_stacks_array1" target="_blank">Try it Yourself &raquo;</a>
</div>
...
print("Size: ", myStack.size())</code></pre>
  <a class="w3-btn w3-margin-bottom" href="trydsa.php?filename=demo_stacks_array2" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
print("Size: ", myStack.stackSize())</code></pre>
  <a class="w3-btn w3-margin-bottom" href="trydsa.php?filename=demo_stacks_linkedlist" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>

<div>
<h2>DSA Exercises</h2>
<form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_data_stacks1" method="post" target="_blank">
<h2>Test Yourself With Exercises</h2>
<div class="exercisewindow">
<h2>Exercise:</h2>
<p>The image below represents a "Stack" data structure.</p>
<img src="img_exercises_stacks.png" alt="A Stack">
<p>Running the <span class="w3-codespan">peek()</span> method on the Stack above, what is returned?</p>
<div class="exerciseprecontainer">
<pre style="overflow: auto;">
<input name="ex1" maxlength="1" style="width: 2ch;">
</pre>
</div>
<br>
<button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
<p><a target="_blank" href="exercise.php?filename=exercise_data_stacks1">Start the Exercise</a></p>
</div>
</form>
</div>
<hr>
