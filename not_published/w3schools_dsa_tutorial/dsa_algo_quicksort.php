...
ny:-->
    ...
    <h1>DSA <span class="color_h1">Quicksort</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="dsa_algo_insertionsort.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="dsa_algo_countingsort.php">Next &#10095;</a>
</div>
<hr>

<h2>Quicksort</h2>
<p>As the name suggests, Quicksort is one of the fastest sorting algorithms.</p>
<p>The Quicksort algorithm takes an array of values, chooses one of the values as the 'pivot' element, and moves the other values so that lower values are on the left of the pivot element, and higher values are on the right of it.</p>
<div id="vueApp">
...
<p>In this tutorial the last element of the array is chosen to be the pivot element, but we could also have chosen the first element of the array, or any element in the array really.</p>
<p>Then, the Quicksort algorithm does the same operation recursively on the sub-arrays to the left and right side of the pivot element. This continues until the array is sorted.</p>
<div class="ws-note">
  <p><strong>Recursion </strong>is when a function calls itself.</p>
  <p>After the Quicksort algorithm has put the pivot element in between a sub-array with lower values on the left side, and a sub-array with higher values on the right side, the algorithm calls itself twice, so that Quicksort runs again for the sub-array on the left side, and for the sub-array on the right side. The Quicksort algorithm continues to call itself until the sub-arrays are too small to be sorted.</p>
</div>
<p>The algorithm can be described like this:</p>
<div class="ws-info">
...
<p>Continue reading to fully understand the Quicksort algorithm and how to implement it yourself.</p>
...
<p>Before we implement the Quicksort algorithm in a programming language, let's manually run through a short array, just to get the idea.</p>
<p><strong>Step 1:</strong> We start with an unsorted array.</p>
<div class="w3-code notranslate">
  <code class="language-python w3-white">[ 11, 9, 12, 7, 3]</code></pre>
</div>
<hr>
<p><strong>Step 2:</strong> We choose the last value 3 as the pivot element.</p>
<div class="w3-code notranslate">
  <code class="language-python w3-white">[ 11, 9, 12, 7,<mark class="dsa_mark"> 3</mark>]</code>
</div>
<hr>
<p><strong>Step 3:</strong> The rest of the values in the array are all greater than 3, and must be on the right side of 3. Swap 3 with 11.</p>
<div class="w3-code notranslate">
  <code class="language-python w3-white">[<mark class="dsa_mark"> 3</mark>, 9, 12, 7,<mark class="dsa_mark"> 11</mark>]</code>
</div>
<hr>
<p><strong>Step 4:</strong> Value 3 is now in the correct position. We need to sort the values to the right of 3. We choose the last value 11 as the new pivot element.</p>
<div class="w3-code notranslate">
  <code class="language-python w3-white">[ 3, 9, 12, 7,<mark class="dsa_mark"> 11</mark>]</code>
</div>
<hr>
<p><strong>Step 5:</strong> The value 7 must be to the left of pivot value 11, and 12 must be to the right of it. Move 7 and 12.</p>
<div class="w3-code notranslate">
  <code class="language-python w3-white">[ 3, 9,<mark class="dsa_mark"> 7, 12</mark>, 11]</code>
</div>
<hr>
<p><strong>Step 6:</strong> Swap 11 with 12 so that lower values 9 and 7 are on the left side of 11, and 12 is on the right side.</p>
<div class="w3-code notranslate">
  <code class="language-python w3-white">[ 3, 9, 7,<mark class="dsa_mark"> 11, 12</mark>]</code>
</div>
<hr>
<p><strong>Step 7:</strong> 11 and 12 are in the correct positions. We choose 7 as the pivot element in sub-array [ 9, 7], to the left of 11.</p>
<div class="w3-code notranslate">
  <code class="language-python w3-white">[ 3, 9,<mark class="dsa_mark"> 7</mark>, 11, 12]</code>
</div>
<hr>
<p><strong>Step 8:</strong> We must swap 9 with 7.</p>
<div class="w3-code notranslate">
  <code class="language-python w3-white">[ 3,<mark class="dsa_mark"> 7, 9</mark>, 11, 12]</code>
</div>
<p>And now, the array is sorted.</p>
<hr>
...
<p>We have already seen that last value of the array is chosen as the pivot element, and the rest of the values are arranged so that the values lower than the pivot value are to the left, and the higher values are to the right.</p>
<p>After that, the pivot element is swapped with the first of the higher values. This splits the original array in two, with the pivot element in between the lower and the higher values.</p>
<p>Now we need to do the same as above with the sub-arrays on the left and right side of the old pivot element. And if a sub-array has length 0 or 1, we consider it finished sorted.</p>
<p>To sum up, the Quicksort algorithm makes the sub-arrays become shorter and shorter until array is sorted.</p>
<hr>

<h2>Quicksort Implementation</h2>
<p>To write a 'quickSort' method that splits the array into shorter and shorter sub-arrays we use recursion. This means that the 'quickSort' method must call itself with the new sub-arrays to the left and right of the pivot element. Read more about recursion  <a href="https://www.w3schools.com/python/gloss_python_function_recursion.asp">here</a>.</p>
<p>To implement the Quicksort algorithm in a programming language, we need:</p>
<ol>
  <li>An array with values to sort.</li>
  <li>A <span class="w3-codespan">quickSort</span> method that calls itself (recursion) if the sub-array has a size larger than 1.</li>
  <li>A <span class="w3-codespan">partition</span> method that receives a sub-array, moves values around, swaps the pivot element into the sub-array and returns the index where the next split in sub-arrays happens.</li>
</ol>
...
<div class="w3-example">
  <h3>Example</h3>
  <pre class="language-python notranslate w3-white"><code>def partition(array, low, high):
    pivot = array[high]
    i = low - 1
...
print("Sorted array:", my_array)
  ...
  <a class="w3-btn w3-margin-bottom" href="trydsa.php?filename=demo_quicksort" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Quicksort Time Complexity</h2>
...
<p class="fontComment">For a more thorough and detailed explanation of Quicksort time complexity, visit <a href="dsa_timecomplexity_quicksort.php">this page</a>.</p>

<p>The worst case scenario for Quicksort is \(O(n^2) \). This is when the pivot element is either the highest or lowest value in every sub-array, which leads to a lot of recursive calls. With our implementation above, this happens when the array is already sorted.</p>
<p>But on average, the time complexity for Quicksort is actually just \(O(n \log n) \), which is a lot better than for the previous sorting algorithms we have looked at. That is why Quicksort is so popular.</p>
<p>Below you can see the significant improvement in time complexity for Quicksort in an average scenario \(O(n \log n) \), compared to the previous sorting algorithms Bubble, Selection and Insertion Sort with time complexity \(O(n^2) \):</p>
<img src="img_runtime_quicksort.png" alt="Time Complexity">
<p>The recursion part of the Quicksort algorithm is actually a reason why the average sorting scenario is so fast, because for good picks of the pivot element, the array will be split in half somewhat evenly each time the algorithm calls itself. So the number of recursive calls do not double, even if the number of values \(n \) double.</p>
<p>Run Quicksort on different kinds of arrays with different number of values in the simulation below:</p>
<div id="vueApp4">
...
<script>
  ...
  let nLognCurve = [];
  for (let x = 1; x <= 500; x += 10) {  // Start x from 1 to avoid log2(0)
    nLognCurve.push({ x: x, y: 10*x * Math.log2(x) });
  }
  let ctx = null;
  let myChart = null;
  ...
  methods: {
    ...
    async addPoint() {
      this.isLoading = true;
      let operations = await this.performQuickSort();
      myChart.data.datasets[2].data.push({ x: parseFloat(this.userX), y: operations });
      myChart.update();
    ...
    async addWorstCase(){
      this.isLoading = true;
      let operations =  await this.performQuickSort();
      myChart.data.datasets[2].data.push({ x: this.userX, y: operations });
      myChart.update(); // Update the chart
      this.clearBtnDisabled = false;
      this.isLoading = false;
    },
    ...
    async performQuickSort(low = 0, high = null) {
      if(high === null) {
      ...
      if (low < high) {
        let pivot_index = await this.partition(low, high);
        if(pivot_index % 6 === 0) {
          // Highlight the active element
          this.array[pivot_index].active = true;
          await new Promise(resolve => setTimeout(resolve, 1));
          // Remove the highlight from the active element
          this.array[pivot_index].active = false;
        }
        await this.performQuickSort(low, pivot_index - 1);
        await this.performQuickSort(pivot_index + 1, high);
      }
    ...
    async partition(low, high) {
      ...
      this.operations++;  // Increment for the final swap operation
...
<div>
<h2>DSA Exercises</h2>
<form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_algo_quicksort1" method="post" target="_blank">
<h2>Test Yourself With Exercises</h2>
<div class="exercisewindow">
<h2>Exercise:</h2>
<p>Complete the code for the Quicksort algorithm.</p>
...
def quicksort(array, low=0, high=None):
    ...
    if low &lt; high:
        pivot_index = partition(array, low, high)
        <input name="ex1" maxlength="9" style="width: 10ch;">(array, low, pivot_index-1)
        <input name="ex2" maxlength="9" style="width: 10ch;">(array, pivot_index+1, high)
...
<p><a target="_blank" href="exercise.php?filename=exercise_algo_quicksort1">Start the Exercise</a></p>
</div>
</form>
</div>
<hr>
