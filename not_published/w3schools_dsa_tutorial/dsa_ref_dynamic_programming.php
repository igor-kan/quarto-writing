...
<html lang="en-US">
<head>
<title>DSA Dynamic Programming</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
#arrowhead line,
#arrowheadTranslucent line {
  stroke: black;
  fill: black;
}.darkpagetheme #arrowhead line,
.darkpagetheme #arrowheadTranslucent line {
  stroke: #ddd;
  fill: #ddd;
}
.branch {
...
.dsa_figure {
  ...
  display: block;
  margin: 10px;
}.darkpagetheme .dsa_figure {
  border-color: #ddd;
}

.dsa_figure:nth-child(even) {
  max-width: 340px; /* Adjust max-width for even figures */
}
...
ny:-->
    ...
    <h1><span class="color_h1">Dynamic Programming</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="dsa_ref_tabulation.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="dsa_ref_greedy.php">Next &#10095;</a>
</div>
<svg xmlns="http://www.w3.org/2000/svg" class="hidden-svg" class="dsa_svg">
<defs>
  ...
  <marker id="arrowheadTranslucent" markerWidth="8" markerHeight="14" refX="0" refY="7" orient="auto" markerUnits="userSpaceOnUse">
      <line x1="0.5" y1="0.5" x2="7.5" y2="7.5" stroke-width="1" opacity="1"/>
      <line x1="0" y1="7" x2="6" y2="7" stroke-width="1" opacity="1"/>
      <line x1="0.5" y1="13.5" x2="7.5" y2="6.5" stroke-width="1" opacity="1"/>
  </marker>
...
<p>Dynamic Programming is a method for designing algorithms.</p>
<p>An algorithm designed with Dynamic Programming divides the problem into subproblems, finds solutions to the subproblems, and puts them together to form a complete solution to the problem we want to solve.</p>
<div class="ws-info">
  <p>To design an algorithm for a problem using Dynamic Programming, the problem we want to solve must have these two properties:</p>
  <ul>
    <li><strong>Overlapping Subproblems: </strong>Means that the problem can be broken down into smaller subproblems, where the solutions to the subproblems are overlapping. Having subproblems that are overlapping means that the solution to one subproblem is part of the solution to another subproblem.</li>
    <li><strong>Optimal Substructure: </strong>Means that the complete solution to a problem can be constructed from the solutions of its smaller subproblems. So not only must the problem have overlapping subproblems, the substructure must also be optimal so that there is a way to piece the solutions to the subproblems together to form the complete solution.</li>
  </ul>
</div>
<p>We have already seen Dynamic Programming in this tutorial, in the <a href="dsa_ref_memoization.php">memoization</a> and <a href="dsa_ref_tabulation.php">tabulation</a> techniques, and for solving problems like the <a href="dsa_ref_knapsack.php">0/1 Knapsack Problem</a>, or to find <a href="dsa_theory_graphs_shortestpath.php">the shortest path</a> with <a href="dsa_algo_graphs_bellmanford.php">the Bellman-Ford algorithm</a>.</p>
<div class="ws-note">
  <p><strong>Note: </strong>Another way of designing an algorithm is using a <a href="dsa_ref_greedy.php">greedy</a> approach.</p>
</div>
<!--<p>We have already seen Dynamic Programming in this tutorial, in the techniques <a href="dsa_ref_memoization.php">memoization</a> and <a href="dsa_ref_tabulation.php">tabulation</a>, solving problems like the shortest path with <a href="dsa_algo_graphs_bellmanford.php">the Bellman-Ford algorithm</a>, finding the \(n\)th Fibonacci number, or the 0/1 Knapsack problem.</p>-->
<hr>

<h2>Using Dynamic Programming To Find The \(n\)th Fibonacci Number</h2>
<p>Let's say we want an algorithm that finds the \(n\)th Fibonacci number. We don't know how to find the \(n\)th Fibonacci number yet, except that we want to use Dynamic Programming to design the algorithm.</p>
<div class="ws-info">
  <p><a href="dsa_algo_simple.php">The Fibonacci numbers</a> is a sequence of numbers starting with \(0\) and \(1\), and the next numbers are created by adding the two previous numbers.</p>
  <p>The 8 first Fibonacci numbers are: \(0,\; 1,\; 1,\; 2,\; 3,\; 5,\; 8,\; 13\).</p>
  <p>And counting from 0, the \(4\)th Fibonacci number \(F(4)\) is \(3\).</p>
  <p>In general, this is how a Fibonacci number is created based on the two previous:</p>
  <p><span class="math display">\[
  F(n)=F(n-1)+F(n-2) 
  \]</span></p>
</div>

<p>So how can we use Dynamic Programming to design an algorithm that finds the \(n\)th Fibonacci number?</p>
<p>There is no exact rule for how to design an algorithm using Dynamic Programming, but here is a suggestion that should work in most cases:</p>
<ol>
  <li>Check if the the problem has "overlapping subproblems" and an "optimal substructure".</li>
  <li>Solve the most basic subproblems.</li>
  <li>Find a way to put the subproblem solutions together to form solutions to new subproblems.</li>
  <li>Write the algorithm (the step-by-step procedure).</li>
  <li>Implement the algorithm (test if it works).</li>
</ol>
<p>Let's do it.</p>
<hr>

<h3>Step 1: Check if the problem has "overlapping subproblems" and an "optimal substructure".</h3>
<p>Before trying to find an algorithm using Dynimaic Programming, we must first check if the problem has the two properties "overlapping subproblems" and "optimal substructure".</p>
<p><strong>Overlapping subproblems? </strong></p>
<p>Yes. The \(6\)th Fibonacci number is a combination of the \(5\)th and \(4\)th Fibonacci number: \(8=5+3\). And this rule holds for all other Fibonacci numbers as well. This shows that the problem of finding the \(n\)th Fibonacci number can be broken into subproblems.</p>
<p>Also, the subproblems overlap because \(F(5)\) is based on \(F(4)\) and \(F(3)\), and \(F(6)\) is based on \(F(5)\) and \(F(4)\).</p>
<p><span class="math display">\[
  \begin{equation}
  \begin{aligned}
...
\end{equation}
\]</span></p>
<p> You see? Both solutions to subproblems \(F(5)\) and \(F(6)\) are created using the solution to \(F(4)\), and there are many cases like that, so the subproblems overlap as well.</p>
<p><strong>Optimal substructure? </strong></p>
<p>Yes, the Fibonacci number sequence has a very clear structure, because the two previous numbers are added to create the next Fibonacci number, and this holds for all Fibonacci numbers except for the two first. This means we know <i>how</i> to put together a solution by combining the solutions to the subproblems.</p>
<p>We can conclude that the problem of finding the \(n\)th Fibonacci number satisfies the two requirements, which means that we can use Dynamic Programming to find an algorithm that solves the problem.</p>
...
<h3>Step 2: Solve the most basic subproblems.</h3>
<p>We can now start trying to find an algorithm using Dynamic Programming.</p>
<p>Solving the most basic subproblems first is a good place to start to get an idea of how the algorithm should run.</p>
<p>In our problem of finding the \(n\)th Fibonacci number, finding the most basic subproblems is not that hard, because we already know that</p>
<p><span class="math display">\[
F(0)=0 \\
F(1)=1 \\ 
F(2)=1 \\ 
...
<h3>Step 3: Find a way to put the subproblem solutions together to form solutions to new subproblems.</h3>
<p>In this step, for our problem, how the subproblems are put together is quite straightforward, we just need to add the two previous Fibonacci numbers to find the next one.</p>
<p>So for example, the \(2\)nd Fibonacci number is created by adding the two previous numbers \(F(2)=F(1)+F(0)\), and that is the general rule as well, like mentioned earlier: \(F(n)=F(n-1)+F(n-2)\).</p>
<div class="ws-note">
  <p><strong>Note: </strong>In other problems, combining solutions to subproblems to form new solutions usually involves making decisions like "should we choose this way, or this way?", or "should we include this item, or not?".</p>
</div>
<hr>

<h3>Step 4: Write the algorithm (the step-by-step procedure).</h3>
<p>Instead of writing the text for the algorithm straight away, it might be wise to try to write a procedure to solve a specific problem first, like finding the \(6\)th Fibonacci number.</p>
<p>For reference, the 8 first Fibonacci numbers are: \(0,\; 1,\; 1,\; 2,\; 3,\; 5,\; \underline{8},\; 13\).</p>
<p>Finding the \(6\)th Fibonacci number, we could start with the two first numbers \(0\) and \(1\), which appear in place 0 and 1 in the sequence, and put them in an array, at index 0 and 1. Then we could add the two first numbers in the array to generate the next number, and push that new number as a new element to the array. If we continue like this until the array is 7 elements long we would stop and return <code class="w3-codespan">F[6]</code>. That would work, right?</p>
<p>After solving the specific problem above, it is now easier to write the actual algorithm.</p>
<p>The algorithm for finding the \(n\)th Fibonacci number, using Dynamic Programming as a design method, can be described like this:</p>
<div class="ws-info">
  <p><strong>How it works:</strong></p>
  <ol>
    <li>Create an array <code class="w3-codespan">F</code>, with \(n+1\) elements.</li>
    <li>Store the two first Fibonacci numbers <code class="w3-codespan">F[0]=0</code> and <code class="w3-codespan">F[1]=1</code>.</li>
    <li>Store the next element <code class="w3-codespan">F[2]=F[1]+F[0]</code>, and continue to create new Fibonacci numbers like that until the value in <code class="w3-codespan">F[n]</code> is created.</li>
    <li>Return <code class="w3-codespan">F[n]</code>.</li>
  </ol>
</div>
<hr>

<h3>Step 5: Implement the algorithm (test if it works).</h3>
<p>To implement the algorithm above, we assume that the argument <code class="w3-codespan">n</code> to the function is a positive number (the \(n\)th Fibonacci number), we use a <code class="w3-codespan">for</code> loop to create new Fibonacci numbers, and we return the base cases <code class="w3-codespan">F[0]</code> and <code class="w3-codespan">F[1]</code> straight away if the function is called with <code class="w3-codespan">0</code> or <code class="w3-codespan">1</code> as an argument.</p>
<p>Implementing the algorithm also means that we can check if it works.</p>
<div class="w3-example">
  <h3>Example</h3>
  <p>Finding the 6th Fibonacci number with our new algorithm:</p>
  <pre class="language-python notranslate w3-white"><code>def nth_fibo(n):
    if n==0: return 0
    if n==1: return 1
...
print(f"The {n}th Fibonacci number is {result}")</code></pre>
  <a class="w3-btn w3-margin-bottom" href="trydsa.php?filename=demo_findfibo_dp" target="_blank">Try it Yourself &raquo;</a>
</div>
<p>There it is!</p>
<p>We have used Dynamic Programming as a design method to create an algorithm that finds the \(n\)th Fibonacci number.</p>
<p>We have also implemented the algorithm to demonstrate that it works, and in doing so we have unintentionally used a well established technique within Dynamic Programming called <a href="dsa_ref_tabulation.php">tabulation</a>, where the solution is found by solving subproblems bottom-up, using some kind of table.</p>
<p>Furthermore, we have avoided calculating the same overlapping subproblems many times, like <code class="w3-codespan">F[3]</code> for example, that we could potentially have ended up doing otherwise, with a <a href="dsa_algo_simple.php#nthfibo">brute force recursive approach</a> for example.</p>
<p>Another technique used in Dynamic Programming is called <a href="dsa_ref_memoization.php">memoization</a>. In this case, using memoization essentially solves the problem recursively with brute force, but stores the subproblem solutions for later as the algorithm runs to avoid doing the same calculations more than once.</p>
<hr>

<h2>Techniques Used in Dynamic Programming</h2>
<p>It might be difficult to design an algorithm using Dynamic Programming, but the concept of Dynamic Programming is actually not that hard: Solve the problem, but since the subproblems are overlapping, do it in a smart way so that a specific subproblem only needs to be solved once.</p>
<p>To be able to use solutions to previously solved subproblems in Dynamic Programming, the previously found solutions must be stored somehow, and that can be done using <a href="dsa_ref_memoization.php">memoization</a> or <a href="dsa_ref_tabulation.php">tabulation</a>.</p>
<p><strong>Memoization</strong> is a technique used in Dynamic Programming, where the solution is found recursively. As the algorithm runs, solutions to subproblems are stored, and before trying to compute the solution to a subproblem, it checks first to see if that solution has already been computed, to avoid doing the same computation more than once.</p>
<p>The memoization technique is called "top-down" because the initial function call is for the main problem, and it results in new function calls for solving smaller and smaller subproblems.</p>
<p><strong>Tabulation</strong> is a technique used in Dynamic Programming, where solutions to the overlapping subproblems are stored in a table (array), starting with the most basic subproblems.</p>
<p>The tabulation technique is not recursive, and it is called "bottom-up" because of the way the final solution is built up by solving the most basic subproblems first. Since the most basic subproblem solutions are stored in the table first, when solving a subproblem later that relies on previous subproblems, the algorithm can just pick these solutions right from the table, no need to compute them again.</p>
<p>To get a better sense of how memoization works, and is considered "top-down", and how tabulation works, and is "bottom-up", take a look at the two images below.</p>
<div class="figureWrap" >
<figure class="dsa_figure">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 292 380">

  <g class="root parent" transform="translate(135,40)">
    <text x="0" y="0" class="svgDataText">F(10)</text>
  </g>
  <path d="M 128 49 Q 85 110 85 190 L 85 190 Q 85 265 130 335" class="branch height13" marker-end="url(#arrowheadTranslucent)" stroke-dasharray="5,5" />

  <g class="root parent" transform="translate(140,95)">
    <text x="0" y="0" class="svgDataText">F(9)</text>
    <line x1="15" y1="-20" x2="15" y2="-40" class="branch height13" marker-end="url(#arrowhead)" />
  </g>

  <g class="root parent" transform="translate(140,150)">
    <text x="10" y="0" class="svgDataText">.</text>
    <text x="10" y="10" class="svgDataText">.</text>
    <text x="10" y="20" class="svgDataText">.</text>
    <text x="10" y="30" class="svgDataText">.</text>
    <line x1="15" y1="-20" x2="15" y2="-40" class="branch height13" marker-end="url(#arrowhead)" />
  </g>

  <g class="root parent" transform="translate(140,250)">
    <text x="0" y="0" class="svgDataText">F(2)</text>
    <line x1="15" y1="-20" x2="15" y2="-40" class="branch height13" marker-end="url(#arrowhead)" />
  </g>

  <g class="root parent" transform="translate(140,305)">
    <!--<circle cx="170" cy="30" r="20" class="node" />-->
    <text x="0" y="0" class="svgDataText">F(1)</text>
    <line x1="15" y1="-20" x2="15" y2="-40" class="branch height13" marker-end="url(#arrowhead)" />
  </g>

  <g class="root parent" transform="translate(140,360)">
    <!--<circle cx="170" cy="30" r="20" class="node" />-->
    <text x="0" y="0" class="svgDataText">F(0)</text>
    <line x1="15" y1="-20" x2="15" y2="-40" class="branch height13" marker-end="url(#arrowhead)" />
  </g>
</svg>
      <figcaption>The bottom-up tabulation approach to finding the 10th Fibonacci number.</figcaption>
  </figure>

  <figure class="dsa_figure">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 340 270" class="dsa_svg">
  <g class="root parent" transform="translate(150,40)">
    <text x="0" y="0" class="svgDataText">F(10)</text>
    <line x1="5" y1="5" x2="-45" y2="60" class="branch height13" marker-end="url(#arrowhead)" />
    <line x1="30" y1="5" x2="80" y2="60" class="branch height13" marker-end="url(#arrowhead)" />
  </g>

  <g class="root parent" transform="translate(75,125)">
    <text x="0" y="0" class="svgDataText">F(8)</text>
    <line x1="5" y1="5" x2="-15" y2="50" class="branch height13" marker-end="url(#arrowhead)" />
    <line x1="20" y1="5" x2="40" y2="50" class="branch height13" marker-end="url(#arrowhead)" />
  </g>
  <g class="root parent" transform="translate(35,200)">
    <text x="0" y="0" class="svgDataText">F(6)</text>
    <line x1="10" y1="5" x2="-5" y2="50" class="branch height13" marker-end="url(#arrowheadTranslucent)" stroke-dasharray="5,5" />
    <line x1="20" y1="5" x2="35" y2="50" class="branch height13" marker-end="url(#arrowheadTranslucent)" stroke-dasharray="5,5" />
  </g>
  <g class="root parent" transform="translate(110,200)">
    <text x="0" y="0" class="svgDataText">F(7)</text>
    <line x1="10" y1="5" x2="-5" y2="50" class="branch height13" marker-end="url(#arrowheadTranslucent)" stroke-dasharray="5,5" />
    <line x1="20" y1="5" x2="35" y2="50" class="branch height13" marker-end="url(#arrowheadTranslucent)" stroke-dasharray="5,5" />
  </g>

  <g class="root parent" transform="translate(230,125)">
    <text x="0" y="0" class="svgDataText">F(9)</text>
    <line x1="5" y1="5" x2="-15" y2="50" class="branch height13" marker-end="url(#arrowhead)" />
    <line x1="20" y1="5" x2="40" y2="50" class="branch height13" marker-end="url(#arrowhead)" />
  </g>
  <g class="root parent" transform="translate(195,200)">
    <text x="0" y="0" class="svgDataText">F(7)</text>
    <!--<line x1="10" y1="5" x2="-5" y2="50" class="branch height13" marker-end="url(#arrowheadTranslucent)" stroke-dasharray="5,5" />
    <line x1="20" y1="5" x2="35" y2="50" class="branch height13" marker-end="url(#arrowheadTranslucent)" stroke-dasharray="5,5" />-->
  </g>
  <g class="root parent" transform="translate(270,200)">
    <text x="0" y="0" class="svgDataText">F(8)</text>
    <!--<line x1="10" y1="5" x2="-5" y2="50" class="branch height13" marker-end="url(#arrowheadTranslucent)" stroke-dasharray="5,5" />
    <line x1="20" y1="5" x2="35" y2="50" class="branch height13" marker-end="url(#arrowheadTranslucent)" stroke-dasharray="5,5" />-->
  </g>
    ...
    <figcaption>The top-down memoization approach to finding the 10th Fibonacci number.</figcaption>
  </figure>
</div>
<p>As you can see in the images above, the tabulation approach starts at the bottom by solving <span class="svgDataText">F(0)</span> first, while the memoization approach start at the top with <span class="svgDataText">F(10)</span> and breaking it into smaller and smaller subproblems from there.</p>
<hr>
