...
ny:-->
    ...
    <h1><span class="color_h1">Introduction</span> to Data Structures and Algorithms</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="index.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="dsa_algo_simple.php">Next &#10095;</a>
</div>
...
<div class="w3-panel ws-info intro">
  ...
  <p>Theory about Data Structures and Algorithms (DSA) helps us to use large amounts of data to solve problems efficiently.</p>
</div>

<h2>What are Data Structures?</h2>
<p>A data structure is a way to store data.</p>
<p>We structure data in different ways depending on what data we have, and what we want to do with it.</p>
<figure class="dsa_figure">
  <img src="img_familytree.png" alt="Family Tree">
  <figcaption>Family tree</figcaption>
</figure>
<p>First, let's consider an example without computers in mind, just to get the idea.</p>
<p>If we want to store data about people we are related to, we use a family tree as the data structure. We choose a family tree as the data structure because we have information about people we are related to and how they are related, and we want an overview so that we can easily find a specific family member, several generations back.</p>
<p>With such a family tree data structure visually in front of you, it is easy to see, for example, who my mother's mother is-it is 'Emma,' right? But without the links from child to parents that this data structure provides, it would be difficult to determine how the individuals are related.</p>
<p>Data structures give us the possibility to manage large amounts of data efficiently for uses such as large databases and internet indexing services.</p>
...
<div class="ws-note">
  <p>In Computer Science there are two different kinds of data structures.</p>
  <p><strong>Primitive Data Structures</strong> are basic data structures provided by programming languages to represent single values, such as integers, floating-point numbers, characters, and booleans.</p>
  <p><strong>Abstract Data Structures</strong> are higher-level data structures that are built using primitive data types and provide more complex and specialized operations. Some common examples of abstract data structures include arrays, linked lists, stacks, queues, trees, and graphs.</p>
</div>
<hr>

<h2>What are Algorithms?</h2>
<p>An algorithm is a set of step-by-step instructions to solve a given problem or achieve a specific goal. </p>
<figure class="dsa_figure">
  <img src="img_pommesfrites.png" alt="Pommes Frites Recipe">
  <figcaption>Pommes Frites Recipe</figcaption>
</figure>
<p>A cooking recipe written on a piece of paper is an example of an algorithm, where the goal is to make a certain dinner. The steps needed to make a specific dinner are described exactly.</p>
<p>When we talk about algorithms in Computer Science, the step-by-step instructions are written in a programming language, and instead of food ingredients, an algorithm uses data structures.</p>
<p>Algorithms are fundamental to computer programming as they provide step-by-step instructions for executing tasks. An efficient algorithm can help us to find the solution we are looking for, and to transform a slow program into a faster one.</p>
<p>By studying algorithms, developers can write better programs.</p>
<p>Algorithm examples:</p>
<ul>
  <li>Finding the fastest route in a GPS navigation system</li>
  <li>Navigating an airplane or a car (cruise control)</li>
  <li>Finding what users search for (search engine)</li>
  <li>Sorting, for example sorting movies by rating</li>
</ul>
<p>The algorithms we will look at in this tutorial are designed to solve specific problems, and are often made to work on specific data structures. For example, the 'Bubble Sort' algorithm is designed to sort values, and is made to work on arrays.</p>
<hr>

<h2>Data Structures together with Algorithms</h2>
...
<p>DSA is about finding efficient ways to store and retrieve data, to perform operations on data, and to solve specific problems.</p>
<p>By understanding DSA, you can:</p>
<ul>
  <li>Decide which data structure or algorithm is best for a given situation.</li>
  <li>Make programs that run faster or use less memory.</li>
  <li>Understand how to approach complex problems and solve them in a systematic way.</li>
</ul>
<hr>
...
<h2>Where is Data Structures and Algorithms Needed?</h2>
<p>Data Structures and Algorithms (DSA) are used in virtually every software system, from operating systems to web applications:</p>
<div class="w3-panel ws-info intro">
  <ul>
    <li>For managing large amounts of data, such as in a social network or a search engine.</li>
    <li>For scheduling tasks, to decide which task a computer should do first.</li>
    <li>For planning routes, like in a GPS system to find the shortest path from A to B.</li>
    <li>For optimizing processes, such as arranging tasks so they can be completed as quickly as possible.</li>
    <li>For solving complex problems: From finding the best way to pack a truck to making a computer 'learn' from data.</li>
  </ul>
</div>

<p>DSA is fundamental in nearly every part of the software world:</p>
<div class="w3-panel ws-info intro">
  <ul>
...
<h2>Theory and Terminology</h2>
<p>As we go along in this tutorial, new theoretical concepts and terminology (new words) will be needed so that we can better understand the data structures and algorithms we will be working on.</p>
<p>These new words and concepts will be introduced and explained properly when they are needed, but here is a list of some key terms, just to get an overview of what is coming:</p>
<table class="ws-table-all notranslate">
  <tbody>
    ...
    <tr>
      ...
      <td>A mathematical notation that describes the limiting behavior of a function when the argument tends towards a particular value or infinity. Used in this tutorial to describe the time complexity of an algorithm.</td>
    </tr>
    <tr>
      <td>Recursion</td>
...
<p>In this tutorial, you will first learn about a data structure with matching algorithms, before moving on to the next data structure.</p>
<p>Further into the tutorial the concepts become more complex, and it is therefore a good idea to learn DSA by doing the tutorial step-by-step from the start.</p>
<p>And as mentioned on the previous page, you should be comfortable in at least one of the most common programming languages, like for example <a href="/js/default.asp">JavaScript</a>, <a href="/c/default.asp">C</a> or <a href="/python/default.asp">Python</a>, before doing this tutorial.</p>
<p>On the next page we will look at two different algorithms that prints out the first 100 Fibonacci numbers using only primitive data structures (two integer variables). One algorithm uses a loop, and one algorithm uses something called recursion.</p>
