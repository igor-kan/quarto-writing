...
<html lang="en-US">
<head>
<title>DSA Post-order Traversal</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>DSA <span class="color_h1">Post-order Traversal</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="dsa_algo_binarytrees_inorder.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="dsa_data_binarytrees_arrayImpl.php">Next &#10095;</a>
</div>
...
<p>Post-order Traversal is a type of Depth First Search, where each node is visited in a certain order. Read more about Binary Tree traversals in general <a href="dsa_data_binarytrees.php#traversal">here</a>.</p>
<p>Doing a Post-order Traversal on a Binary Tree can be visualized like this:</p>
<div id="divAnim5">
...
<g class="child leaf G">
  ...
  <p>Result: </p>
  <button onclick="tl5.play();">Post-order Traverse</button>
</div>
<script src="https://cdnjs.cloudflare.com/ajax/libs/animejs/3.2.1/anime.min.js" integrity="sha512-z4OUqw38qNLpn1libAN9BsoDx6nbNFio5lA6CuTp9NlK83b89hgyCVq+N5FdBJptINztxn1Z3SaKSKUS5UP60Q==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
<script>
  let traverseBtn5 = document.querySelector('#divAnim5 button');
  let pResult5 = document.querySelector('#divAnim5 p');
...
tl5.add({
  targets: '#divAnim5 circle, #divAnim5 text, #divAnim5 line',
  opacity: 1,
  duration: 200,
  begin: function(anim){
    traverseBtn5.disabled = true;
    pResult5.innerHTML = 'Result: ';
    let nodes5 = document.querySelectorAll('#divAnim5 circle');
    for(let i=0; i<nodes5.length; i++){
      nodes5[i].classList.remove('nodePrinted');
    }
  },
  complete: function(anim){
    traverseBtn5.innerHTML = 'Post-order Traverse';
    traverseBtn5.disabled = false;
    tl5.pause();
  }
})
.add({
  targets: '#divAnim5 .R circle',
  begin: function(anim){
    traverseBtn5.disabled = true;
    document.querySelector('#divAnim5 .R circle').classList.add('thick');
  }
})
.add({
  targets: '#divAnim5 .A circle',
  begin: function(anim){
    document.querySelector('#divAnim5 .A circle').classList.add('thick');
  }
})
.add({
  targets: '#divAnim5 .C',
  begin: function(anim){
    document.querySelector('#divAnim5 .C circle').classList.add('nodePrinted');
    document.querySelector('#divAnim5 .C circle').classList.add('extraThick');
    document.querySelector('#divAnim5 p').innerHTML += 'C';
  },
  complete: function(anim){
    document.querySelector('#divAnim5 .C circle').classList.remove('extraThick');
  }
})
.add({
  targets: '#divAnim5 .C',
  opacity: [1,0.5],
  begin: function(anim){
    document.querySelector('#divAnim5 .D circle').classList.add('nodePrinted');
    document.querySelector('#divAnim5 .D circle').classList.add('extraThick');
    document.querySelector('#divAnim5 p').innerHTML += ',D';
  },
  complete: function(anim){
    document.querySelector('#divAnim5 .D circle').classList.remove('extraThick');
  }
})
.add({
  targets: '#divAnim5 .D',
  opacity: [1,0.5],
  begin: function(anim){
    document.querySelector('#divAnim5 .A circle').classList.add('nodePrinted');
    document.querySelector('#divAnim5 .A circle').classList.add('extraThick');
    document.querySelector('#divAnim5 p').innerHTML += ',A';
  },
  complete: function(anim){
    document.querySelector('#divAnim5 .A circle').classList.remove('extraThick');
    document.querySelector('#divAnim5 .A circle').classList.remove('thick');
  }
})
.add({
  targets: '#divAnim5 .A',
  opacity: [1,0.5],
  begin: function(anim){
    document.querySelector('#divAnim5 .B circle').classList.add('thick');
  }
})
.add({
  targets: '#divAnim5 .E',
  begin: function(anim){
    document.querySelector('#divAnim5 .E circle').classList.add('nodePrinted');
    document.querySelector('#divAnim5 .E circle').classList.add('extraThick');
    document.querySelector('#divAnim5 p').innerHTML += ',E';
  },
  complete: function(anim){
    document.querySelector('#divAnim5 .E circle').classList.remove('extraThick');
    document.querySelector('#divAnim5 .E circle').classList.remove('thick');
  }
})
.add({
  targets: '#divAnim5 .E',
  opacity: [1,0.5],
  begin: function(anim){
    document.querySelector('#divAnim5 .F circle').classList.add('thick');
  }
})
.add({
  begin: function(anim){
    document.querySelector('#divAnim5 .G circle').classList.add('nodePrinted');
    document.querySelector('#divAnim5 .G circle').classList.add('extraThick');
    document.querySelector('#divAnim5 p').innerHTML += ',G';
  },
  complete: function(anim){
    document.querySelector('#divAnim5 .G circle').classList.remove('extraThick');
    document.querySelector('#divAnim5 .G circle').classList.remove('thick');
  }
})
.add({
  targets: '#divAnim5 .G',
  opacity: [1,0.5],
  begin: function(anim){
    document.querySelector('#divAnim5 .F circle').classList.add('nodePrinted');
    document.querySelector('#divAnim5 .F circle').classList.add('extraThick');
    document.querySelector('#divAnim5 p').innerHTML += ',F';
  },
  complete: function(anim){
    document.querySelector('#divAnim5 .F circle').classList.remove('extraThick');
    document.querySelector('#divAnim5 .F circle').classList.remove('thick');
  }
})
.add({
  targets: '#divAnim5 .F',
  opacity: [1,0.5],
  begin: function(anim){
    document.querySelector('#divAnim5 .B circle').classList.add('nodePrinted');
    document.querySelector('#divAnim5 .B circle').classList.add('extraThick');
    document.querySelector('#divAnim5 p').innerHTML += ',B';
  },
  complete: function(anim){
    document.querySelector('#divAnim5 .B circle').classList.remove('extraThick');
    document.querySelector('#divAnim5 .B circle').classList.remove('thick');
  }
})
.add({
  targets: '#divAnim5 .B',
  opacity: [1,0.5],
  begin: function(anim){
    document.querySelector('#divAnim5 .R circle').classList.add('nodePrinted');
    document.querySelector('#divAnim5 .R circle').classList.add('extraThick');
    document.querySelector('#divAnim5 p').innerHTML += ',R';
  },
  complete: function(anim){
    document.querySelector('#divAnim5 .R circle').classList.remove('extraThick');
    document.querySelector('#divAnim5 .R circle').classList.remove('thick');
  }
})
.add({
  targets: '#divAnim5 .R',
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Python:</p>
  <pre class="language-python notranslate line-numbers w3-white"><code>def postOrderTraversal(node):
    if node is None:
        return
    postOrderTraversal(node.left)
    postOrderTraversal(node.right)
    print(node.data, end=", ")</code></pre>
  <a class="w3-btn w3-margin-bottom" href="trydsa.php?filename=demo_binarytree_postordertraversal" target="_blank">Try it Yourself &raquo;</a>
</div>
