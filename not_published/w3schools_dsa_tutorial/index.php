...
ny:-->
    ...
    <h1>DSA <span class="color_h1">Tutorial</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="/default.asp">&#10094; Home</a>
<a class="w3-right w3-btn" href="dsa_intro.php">Next &#10095;</a>
</div>
  ...
  <div class="cert-card">
    <div class="cert-card-header">
      <div class="cert-card-icon">
        <svg xmlns="http://www.w3.org/2000/svg" width="39" height="39" fill="#0088CC" viewBox="0 0 24 24"><path d="M8.226,19.857H1.353l1.79-4.225h4.812L13.308,3.21H7.564l-4.226,9.82h2.587c.18.3.511.51.887.51a1.04,1.04,0,0,0,1.038-1.037c0-.572-.467-1.023-1.038-1.023-.421,0-.767.24-.932.602H4.647l3.503-7.94h3.76L7.383,14.684l-4.766.03L0,20.79h8.842L10,18.263h3.835l1.278,2.526H24L15.985,3.211Zm2.27-2.586,1.384-3.023,1.503,3.023zm5.218,2.691-.872-1.759h2.737c.18.33.526.556.917.556a1.04,1.04,0,0,0,1.038-1.037,1.04,1.04,0,0,0-1.038-1.038c-.42,0-.782.256-.947.617H14.42l-2.09-4.06,1.534-3.369,1.729,3.519h.812c.165.346.526.601.932.601a1.04,1.04,0,0,0,1.038-1.037,1.04,1.04,0,0,0-1.038-1.038c-.436,0-.812.271-.962.662h-.3l-1.79-3.64,1.699-3.728,6.677,14.751Z"/></svg>
      </div>
      <h2 class="cert-card-title">Learn DSA</h2>
    </div>
    <p class="cert-card-desc">Data Structures and Algorithms (DSA) is a fundamental part of Computer Science that teaches you how to think and solve complex problems systematically.</p>
    <p class="cert-card-desc">Using the right data structure and algorithm makes your program run faster, especially when working with lots of data.</p>
    <p class="cert-card-desc">Knowing DSA can help you perform better in job interviews and land great jobs in tech companies.</p>
    <div class="cert-card-bottom" style="margin-top:auto;padding-top:16px;">
      <a href="dsa_intro.php" class="cert-card-btn">Learn DSA now &#10095;</a>
    </div>
  </div>

  <div class="cert-info" style="padding:24px;display:flex;flex-direction:column;">
    <h3 class="cert-info-title">Become DSA Certified</h3>
    <p class="cert-info-desc">Get certified with our DSA exam, includes a professionally curated study kit to guide you from beginner to exam-ready.</p>
...
<a href="https://campus.w3schools.com/collections/course-catalog/products/learn-data-structures-and-algorithms" class="cert-card-btn cert-btn-white" target="_blank" style="margin-top:12px;background:#fff;color:#000;border:2px solid #000;">Get Certified &#10095;</a>
        </div>
        <div class="cert-preview" style="flex:1 1 auto;padding:0;align-self:flex-start;">
          <svg class="cert-preview-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 560 400" role="img" aria-label="DSA Certificate preview" style="width:100%;max-width:250px;height:auto;display:block;margin:0 0 0 auto;">
            ...
            <text x="280" y="212" text-anchor="middle" font-family="Source Sans Pro Topnav, sans-serif" font-size="13" fill="#475569">has passed the W3Schools DSA Certification exam and is hereby declared a</text>
            <g transform="translate(248,222)">
              <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="#0088CC" viewBox="0 0 24 24"><path d="M8.226,19.857H1.353l1.79-4.225h4.812L13.308,3.21H7.564l-4.226,9.82h2.587c.18.3.511.51.887.51a1.04,1.04,0,0,0,1.038-1.037c0-.572-.467-1.023-1.038-1.023-.421,0-.767.24-.932.602H4.647l3.503-7.94h3.76L7.383,14.684l-4.766.03L0,20.79h8.842L10,18.263h3.835l1.278,2.526H24L15.985,3.211Zm2.27-2.586,1.384-3.023,1.503,3.023zm5.218,2.691-.872-1.759h2.737c.18.33.526.556.917.556a1.04,1.04,0,0,0,1.038-1.037,1.04,1.04,0,0,0-1.038-1.038c-.42,0-.782.256-.947.617H14.42l-2.09-4.06,1.534-3.369,1.729,3.519h.812c.165.346.526.601.932.601a1.04,1.04,0,0,0,1.038-1.037,1.04,1.04,0,0,0-1.038-1.038c-.436,0-.812.271-.962.662h-.3l-1.79-3.64,1.699-3.728,6.677,14.751Z"/></svg>
            </g>
            <text x="280" y="300" text-anchor="middle" font-family="Source Sans Pro Topnav, sans-serif" font-size="18" font-weight="700" fill="#0f172a">Certified DSA Developer</text>
...
<h2>This Tutorial</h2>
<p>This tutorial is made to help you learn Data Structures and Algorithms (DSA)  fast and easy.</p>
<p>Animations, like the one below, are used to explain ideas along the way.</p>
<div id="vueApp">
  <div id="animAndSigns">
    ...
    <div id="frameDiv">
      <transition-group>
        <div v-for="(x, index) in dice" 
          ...
          :style="{
            height: x.dieNmbr*10 + 30 + 'px',
            //width: 30 - x.dieNmbr*3 + 'px',
            transition: 'all ' + delay,
            //backgroundColor: x.bcColor
          }"
        >
          <span>{{ x.dieNmbr }}</span>
        </div>
  ...
  <!--<p>Delay: <input v-model="delay" type="range" min="150" max="500"> {{ delay }}</p>-->
  <p>{{ resultText }}: {{ currVal }}</p>
  ...
  <button @click="queue('peek')" :disabled="queueTooShort">peek()</button>
...
<p>First, you will learn the fundamentals of DSA: understanding different data structures, basic algorithm concepts, and how they are used in programming.</p>
<p>Then, you will learn more about complex data structures like trees and graphs, study advanced sorting and searching algorithms, explore concepts like time complexity, and more.</p>
<p>This tutorial will give you a solid foundation in Data Structures and Algorithms, an essential skill for any software developer.</p>
<hr>
...
<p>The code examples in this tutorial are written in Python, C, and Java. You can see this by clicking the "Run Example" button.</p>
...
<p>Although Data Structures and Algorithms is actually not specific to any programming language, you should have a basic understanding of programming in one of these common programming languages:</p>
<ul>
  <li><a href="/python/default.asp">Python</a></li>
  <li><a href="/c/index.php">C</a></li>
  <li><a href="/cpp/default.asp">C++</a></li>
  <li><a href="/java/default.asp">Java</a></li>
  <li><a href="/js/default.asp">JavaScript</a></li>
</ul>

<hr>
<h2>DSA History</h2>
<p>The word 'algorithm' comes from 'al-Khwarizmi', named after a Persian scholar who lived around year 800.</p>
<p>The concept of algorithmic problem-solving can be traced back to ancient times, long before the invention of computers.</p>
<p>The study of Data Structures and Algorithms really took off with the invention of computers in the 1940s, to efficiently manage and process data.</p>
<p>Today, DSA is a key part of Computer Science education and professional programming, helping us to create faster and more powerful software.</p>
<hr>

<div>
<h2>DSA Exercises</h2>
<form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_algo_simple1" method="post" target="_blank">
<h2>Test Yourself With Exercises</h2>
<div class="exercisewindow">
<h2>Exercise:</h2>
<p>What does DSA stand for?</p>
<div class="exerciseprecontainer">
<pre style="overflow: auto;">
DSA stands for <input name="ex1" maxlength="4" style="width: 5ch;"> Structures and <input name="ex2" maxlength="10" style="width: 11ch;">.
</pre>
</div>
<br>
<button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
<p><a target="_blank" href="exercise.php?filename=exercise_algo_simple1">Start the Exercise</a></p>
</div>
</form>
</div>
<hr>
...
<h2>DSA Quiz ?</h2>
<p>Learn by taking a quiz! The quiz will give you a signal of how much you know about Data Structures and Algorithms.</p>
<p><a href="dsa_quiz.php" class="w3-button w3-blue w3-round">Start DSA Quiz</a></p>
<hr>
...
<p><a href="dsa_examples.php" class="w3-button w3-light-grey w3-round">See All DSA Examples</a></p>
<hr>
...
<a class="w3-right w3-btn w3-round" href="dsa_intro.php" style="font-family: 'Roboto Mono', monospace;background-color:#04AA6D;padding:20px;text-align:right"><span style="color:#D9EEE1">Next &#10095;</span><br class="w3-hide-small"><span class="w3-hide-small"> DSA Introduction</span></a>
</div>
