...
<html lang="en-US">
<head>
<title>DSA Graphs Traversal</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
#svgDiv0 circle, #svgDiv1 circle, #svgDiv2 circle, #svgDiv4 circle {
...
ny:-->
    ...
    <h1>DSA <span class="color_h1">Graphs Traversal</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="dsa_data_graphs_implementation.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="dsa_algo_graphs_cycledetection.php">Next &#10095;</a>
</div>
<hr>

<h2>Graphs Traversal</h2>
<p>To traverse a Graph means to start in one vertex, and go along the edges to visit other vertices until all vertices, or as many as possible, have been visited.</p>
<div id="svgDiv4" class="svgDiv">
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 340 210" class="dsa_svg">
<defs>
  ...
  <!-- 'B' node -->
  <g class="child leaf B" transform="translate(90 -30)">
  ...
  <!-- Nodes A, D, and E -->
  <g class="parent child A" transform="translate(-10 -20)">
...
tl4.add({
  ...
  begin: function(anim){
    ...
    pResult4.innerHTML = 'Result: ';
    let nodes4 = document.querySelectorAll('#svgDiv4 circle');
    for(let i=0; i<nodes4.length; i++){
      nodes4[i].classList.remove('nodePrinted');
    }
  },
  complete: function(anim){
    traverseBtn4.innerHTML = 'DFS Traverse from D';
    traverseBtn4.disabled = false;
    tl4.pause();
  }
})
.add({
  targets: '#svgDiv4 .D circle',
  begin: function(anim){
    traverseBtn4.disabled = true;
    document.querySelector('#svgDiv4 .D circle').classList.add('nodePrinted');
    document.querySelector('#svgDiv4 .D circle').classList.add('extraThick');
    document.querySelector('#svgDiv4 p').innerHTML += 'D';
  },
  complete: function(anim){
    document.querySelector('#svgDiv4 .D circle').classList.remove('extraThick');
  }
})
.add({
  targets: '#svgDiv4 .D',
  opacity: [1,0.5],
  begin: function(anim){
    document.querySelector('#svgDiv4 .A circle').classList.add('nodePrinted');
    document.querySelector('#svgDiv4 .A circle').classList.add('extraThick');
    document.querySelector('#svgDiv4 p').innerHTML += ',A';
  },
  complete: function(anim){
    document.querySelector('#svgDiv4 .A circle').classList.remove('extraThick');
  }
})
.add({
  targets: '#svgDiv4 .A',
  opacity: [1,0.5],
  begin: function(anim){
    document.querySelector('#svgDiv4 .C circle').classList.add('nodePrinted');
    document.querySelector('#svgDiv4 .C circle').classList.add('extraThick');
    document.querySelector('#svgDiv4 p').innerHTML += ',C';
  },
  complete: function(anim){
    document.querySelector('#svgDiv4 .C circle').classList.remove('extraThick');
  }
})
.add({
  targets: '#svgDiv4 .C',
  opacity: [1,0.5],
  begin: function(anim){
    document.querySelector('#svgDiv4 .B circle').classList.add('nodePrinted');
    document.querySelector('#svgDiv4 .B circle').classList.add('extraThick');
    document.querySelector('#svgDiv4 p').innerHTML += ',B';
  },
  complete: function(anim){
    document.querySelector('#svgDiv4 .B circle').classList.remove('extraThick');
  }
})
.add({
  targets: '#svgDiv4 .B',
  opacity: [1,0.5],
  begin: function(anim){
    document.querySelector('#svgDiv4 .F circle').classList.add('nodePrinted');
    document.querySelector('#svgDiv4 .F circle').classList.add('extraThick');
    document.querySelector('#svgDiv4 p').innerHTML += ',F';
  },
  complete: function(anim){
    document.querySelector('#svgDiv4 .F circle').classList.remove('extraThick');
  }
})
.add({
  targets: '#svgDiv4 .F',
  opacity: [1,0.5],
  begin: function(anim){
    document.querySelector('#svgDiv4 .E circle').classList.add('nodePrinted');
    document.querySelector('#svgDiv4 .E circle').classList.add('extraThick');
    document.querySelector('#svgDiv4 p').innerHTML += ',E';
  },
  complete: function(anim){
    document.querySelector('#svgDiv4 .E circle').classList.remove('extraThick');
  }
})
.add({
  targets: '#svgDiv4 .E',
  opacity: [1,0.5],
  begin: function(anim){
    document.querySelector('#svgDiv4 .G circle').classList.add('nodePrinted');
    document.querySelector('#svgDiv4 .G circle').classList.add('extraThick');
    document.querySelector('#svgDiv4 p').innerHTML += ',G';
  },
  complete: function(anim){
    document.querySelector('#svgDiv4 .G circle').classList.remove('extraThick');
  }
})
.add({
  targets: '#svgDiv4 .G',
...
<p>Understanding how a Graph can be traversed is important for understanding how algorithms that run on Graphs work.</p>
<p>The two most common ways a Graph can be traversed are:</p>
<ul>
  <li>Depth First Search (DFS)</li>
  <li>Breadth First Search (BFS)</li>
</ul>
<p>DFS is usually implemented using a <a href="dsa_data_stacks.php">Stack</a> or by the use of recursion (which utilizes the call stack), while BFS is usually implemented using a <a href="dsa_data_queues.php">Queue</a>.</p>
<div class="ws-note">
  <p>The <strong>Call Stack</strong> keeps functions running in the correct order.</p>
  <p>If for example FunctionA calls FunctionB, FunctionB is placed on top of the call stack and starts running. Once FunctionB is finished, it is removed from the stack, and then FunctionA resumes its work.</p>
</div>
...
<a id="dfsTraversal"></a>
<h2>Depth First Search Traversal</h2>
<p>Depth First Search is said to go "deep" because it visits a vertex, then an adjacent vertex, and then that vertex' adjacent vertex, and so on, and in this way the distance from the starting vertex increases for each recursive iteration.</p>
<div class="ws-info">
  <p><strong>How it works:</strong></p>
  <ol>
    <li>Start DFS traversal on a vertex.</li>
    <li>Do a recursive DFS traversal on each of the adjacent vertices as long as they are not already visited.</li>
  </ol>
</div>
<p>Run the animation below to see how Depth First Search (DFS) traversal runs on a specific Graph, starting in vertex D (it is the same as the previous animation).</p>
...
<defs>
  ...
  <p>Result: </p>
  <button onclick="tl0.play();">DFS Traverse from D</button>
</div>
<script src="https://cdnjs.cloudflare.com/ajax/libs/animejs/3.2.1/anime.min.js" integrity="sha512-z4OUqw38qNLpn1libAN9BsoDx6nbNFio5lA6CuTp9NlK83b89hgyCVq+N5FdBJptINztxn1Z3SaKSKUS5UP60Q==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
<script>
...
tl0.add({
  ...
  begin: function(anim){
    ...
    pResult0.innerHTML = 'Result: ';
    let nodes0 = document.querySelectorAll('#svgDiv0 circle');
    for(let i=0; i<nodes0.length; i++){
      nodes0[i].classList.remove('nodePrinted');
    }
  },
  complete: function(anim){
    traverseBtn0.innerHTML = 'DFS Traverse from D';
    traverseBtn0.disabled = false;
    tl0.pause();
  }
})
.add({
  targets: '#svgDiv0 .D circle',
  begin: function(anim){
    traverseBtn0.disabled = true;
    document.querySelector('#svgDiv0 .D circle').classList.add('nodePrinted');
    document.querySelector('#svgDiv0 .D circle').classList.add('extraThick');
    document.querySelector('#svgDiv0 p').innerHTML += 'D';
  },
  complete: function(anim){
    document.querySelector('#svgDiv0 .D circle').classList.remove('extraThick');
  }
})
.add({
  targets: '#svgDiv0 .D',
  opacity: [1,0.5],
  begin: function(anim){
    document.querySelector('#svgDiv0 .A circle').classList.add('nodePrinted');
    document.querySelector('#svgDiv0 .A circle').classList.add('extraThick');
    document.querySelector('#svgDiv0 p').innerHTML += ',A';
  },
  complete: function(anim){
    document.querySelector('#svgDiv0 .A circle').classList.remove('extraThick');
  }
})
.add({
  targets: '#svgDiv0 .A',
  opacity: [1,0.5],
  begin: function(anim){
    document.querySelector('#svgDiv0 .C circle').classList.add('nodePrinted');
    document.querySelector('#svgDiv0 .C circle').classList.add('extraThick');
    document.querySelector('#svgDiv0 p').innerHTML += ',C';
  },
  complete: function(anim){
    document.querySelector('#svgDiv0 .C circle').classList.remove('extraThick');
  }
})
.add({
  targets: '#svgDiv0 .C',
  opacity: [1,0.5],
  begin: function(anim){
    document.querySelector('#svgDiv0 .B circle').classList.add('nodePrinted');
    document.querySelector('#svgDiv0 .B circle').classList.add('extraThick');
    document.querySelector('#svgDiv0 p').innerHTML += ',B';
  },
  complete: function(anim){
    document.querySelector('#svgDiv0 .B circle').classList.remove('extraThick');
  }
})
.add({
  targets: '#svgDiv0 .B',
  opacity: [1,0.5],
  begin: function(anim){
    document.querySelector('#svgDiv0 .F circle').classList.add('nodePrinted');
    document.querySelector('#svgDiv0 .F circle').classList.add('extraThick');
    document.querySelector('#svgDiv0 p').innerHTML += ',F';
  },
  complete: function(anim){
    document.querySelector('#svgDiv0 .F circle').classList.remove('extraThick');
  }
})
.add({
  targets: '#svgDiv0 .F',
  opacity: [1,0.5],
  begin: function(anim){
    document.querySelector('#svgDiv0 .E circle').classList.add('nodePrinted');
    document.querySelector('#svgDiv0 .E circle').classList.add('extraThick');
    document.querySelector('#svgDiv0 p').innerHTML += ',E';
  },
  complete: function(anim){
    document.querySelector('#svgDiv0 .E circle').classList.remove('extraThick');
  }
})
.add({
  targets: '#svgDiv0 .E',
  opacity: [1,0.5],
  begin: function(anim){
    document.querySelector('#svgDiv0 .G circle').classList.add('nodePrinted');
    document.querySelector('#svgDiv0 .G circle').classList.add('extraThick');
    document.querySelector('#svgDiv0 p').innerHTML += ',G';
  },
  complete: function(anim){
    document.querySelector('#svgDiv0 .G circle').classList.remove('extraThick');
  }
})
.add({
  targets: '#svgDiv0 .G',
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Python:</p>
  <pre class="language-python notranslate line-numbers w3-white" data-line="24-35,60"><code>class Graph:
...
g.dfs('D')
  ...
  <a class="w3-btn w3-margin-bottom" href="trydsa.php?filename=demo_graphs_undirected_traversal_dfs" target="_blank">Try it Yourself &raquo;</a>
</div>
<p><strong>Line 60: </strong>The DFS traversal starts when the <code class="w3-codespan">dfs()</code> method is called.</p>
<p><strong>Line 33: </strong>The <code class="w3-codespan">visited</code> array is first set to <code class="w3-codespan">false</code> for all vertices, because no vertices are visited yet at this point.</p>
<p><strong>Line 35: </strong>The <code class="w3-codespan">visited</code> array is sent as an argument to the <code class="w3-codespan">dfs_util()</code> method. When the <code class="w3-codespan">visited</code> array is sent as an argument like this, it is actually just a reference to the <code class="w3-codespan">visited</code> array that is sent to the <code class="w3-codespan">dfs_util()</code> method, and not the actual array with the values inside. So there is always just one <code class="w3-codespan">visited</code> array in our program, and the <code class="w3-codespan">dfs_util()</code> method can make changes to it as nodes are visited (line 25).</p>
<p><strong>Line 28-30: </strong>For the current vertex <code class="w3-codespan">v</code>, all adjacent nodes are called recursively if they are not already visited.</p>
<hr>

<a id="bfsTraversal"></a>
<h2>Breadth First Search Traversal</h2>
<p>Breadth First Search visits all adjacent vertices of a vertex before visiting neighboring vertices to the adjacent vertices. This means that vertices with the same distance from the starting vertex are visited before vertices further away from the starting vertex are visited.</p>
<div class="ws-info">
  <p><strong>How it works:</strong></p>
  <ol>
    <li>Put the starting vertex into the queue.</li>
    <li>For each vertex taken from the queue, visit the vertex, then put all unvisited adjacent vertices into the queue.</li>
    <li>Continue as long as there are vertices in the queue.</li>
  </ol>
</div>
<p>Run the animation below to see how Breadth First Search (BFS) traversal runs on a specific Graph, starting in vertex D.</p>
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 340 210" class="dsa_svg">
  ...
  <p>Result: </p>
  <button onclick="tl1.play();">BFS Traverse from D</button>
</div>
<script>
  let traverseBtn1 = document.querySelector('#svgDiv1 button');
  let pResult1 = document.querySelector('#svgDiv1 p');
...
tl1.add({
  targets: '#svgDiv1 circle, #svgDiv1 text, #svgDiv1 line',
  opacity: 1,
  duration: 200,
  begin: function(anim){
    traverseBtn1.disabled = true;
    pResult1.innerHTML = 'Result: ';
    let nodes1 = document.querySelectorAll('#svgDiv1 circle');
    for(let i=0; i<nodes1.length; i++){
      nodes1[i].classList.remove('nodePrinted');
    }
  },
  complete: function(anim){
    traverseBtn1.innerHTML = 'BFS Traverse from D';
    traverseBtn1.disabled = false;
    tl1.pause();
  }
})
.add({
  targets: '#svgDiv1 .D circle',
  begin: function(anim){
    traverseBtn1.disabled = true;
    document.querySelector('#svgDiv1 .D circle').classList.add('nodePrinted');
    document.querySelector('#svgDiv1 .D circle').classList.add('extraThick');
    document.querySelector('#svgDiv1 p').innerHTML += 'D,';
  },
  complete: function(anim){
    document.querySelector('#svgDiv1 .D circle').classList.remove('extraThick');
  }
})
.add({
  targets: '#svgDiv1 .D',
  opacity: [1,0.5],
  begin: function(anim){
    document.querySelector('#svgDiv1 .A circle').classList.add('nodePrinted');
    document.querySelector('#svgDiv1 .A circle').classList.add('extraThick');
    document.querySelector('#svgDiv1 p').innerHTML += 'A,';
  },
  complete: function(anim){
    document.querySelector('#svgDiv1 .A circle').classList.remove('extraThick');
  }
})
.add({
  targets: '#svgDiv1 .A',
  opacity: [1,0.5],
  begin: function(anim){
    document.querySelector('#svgDiv1 .C circle').classList.add('nodePrinted');
    document.querySelector('#svgDiv1 .C circle').classList.add('extraThick');
    document.querySelector('#svgDiv1 p').innerHTML += 'C,';
  },
  complete: function(anim){
    document.querySelector('#svgDiv1 .C circle').classList.remove('extraThick');
  }
})
.add({
  targets: '#svgDiv1 .C',
  opacity: [1,0.5],
  begin: function(anim){
    document.querySelector('#svgDiv1 .E circle').classList.add('nodePrinted');
    document.querySelector('#svgDiv1 .E circle').classList.add('extraThick');
    document.querySelector('#svgDiv1 p').innerHTML += 'E,';
  },
  complete: function(anim){
    document.querySelector('#svgDiv1 .E circle').classList.remove('extraThick');
  }
})
.add({
  targets: '#svgDiv1 .E',
  opacity: [1,0.5],
  begin: function(anim){
    document.querySelector('#svgDiv1 .B circle').classList.add('nodePrinted');
    document.querySelector('#svgDiv1 .B circle').classList.add('extraThick');
    document.querySelector('#svgDiv1 p').innerHTML += 'B,';
  },
  complete: function(anim){
    document.querySelector('#svgDiv1 .B circle').classList.remove('extraThick');
  }
})
.add({
  targets: '#svgDiv1 .B',
  opacity: [1,0.5],
  begin: function(anim){
    document.querySelector('#svgDiv1 .F circle').classList.add('nodePrinted');
    document.querySelector('#svgDiv1 .F circle').classList.add('extraThick');
    document.querySelector('#svgDiv1 p').innerHTML += 'F,';
  },
  complete: function(anim){
    document.querySelector('#svgDiv1 .F circle').classList.remove('extraThick');
  }
})
.add({
  targets: '#svgDiv1 .F',
  opacity: [1,0.5],
  begin: function(anim){
    document.querySelector('#svgDiv1 .G circle').classList.add('nodePrinted');
    document.querySelector('#svgDiv1 .G circle').classList.add('extraThick');
    document.querySelector('#svgDiv1 p').innerHTML += 'G';
  },
  complete: function(anim){
    document.querySelector('#svgDiv1 .G circle').classList.remove('extraThick');
  }
})
.add({
  targets: '#svgDiv1 .G',
...
<p>As you can see in the animation above, BFS traversal visits vertices the same distance from the starting vertex, before visiting vertices further away. So for example, after visiting vertex A, vertex E and C are visited before visiting B, F and G because those vertices are further away.</p>
<p>Breadth First Search traversal works this way by putting all adjacent vertices in a queue (if they are not already visited), and then using the queue to visit the next vertex.</p>
<p>This code example for Breadth First Search traversal is the same as for the Depth First Search code example above, except for the <code class="w3-codespan">bfs()</code> method:</p>
<div class="w3-example">
  <h3>Example</h3>
  <p>Python:</p>
  <pre class="language-python notranslate line-numbers w3-white" data-line="24-35,60"><code>def bfs(self, start_vertex_data):
  ...
  <a class="w3-btn w3-margin-bottom" href="trydsa.php?filename=demo_graphs_undirected_traversal_bfs" target="_blank">Try it Yourself &raquo;</a>
</div>
<p><strong>Line 2-4: </strong>The <code class="w3-codespan">bfs()</code> method starts by creating a queue with the start vertex inside, creating a <code class="w3-codespan">visited</code> array, and setting the start vertex as visited.</p>
<p><strong>Line 6-13: </strong>The BFS traversal works by taking a vertex from the queue, printing it, and adding adjacent vertices to the queue if they are not visited yet, and then continue to take vertices from the queue in this way. The traversal finishes when the last element in the queue has no unvisited adjacent vertices.</p>
<hr>

<h2>DFS and BFS Traversal of a Directed Graph</h2>
<p>Depth first and breadth first traversals can actually be implemented to work on directed Graphs (instead of undirected) with just very few changes.</p>
<p>Run the animation below to see how a directed Graph can be traversed using DFS or BFS.</p>
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 340 210" class="dsa_svg">
  ...
  <line x1="297" y1="47" x2="279" y2="69" class="directed FB" marker-end="url(#arrowhead)" />

  <line x1="191" y1="65" x2="283" y2="38" class="directed CF" marker-end="url(#arrowhead)"/>

  <line x1="90" y1="95" x2="143" y2="78" class="directed connected AC" marker-end="url(#arrowhead)" />

  <line x1="162" y1="88" x2="124" y2="161" class="directed connected CE" marker-end="url(#arrowhead)" />
  <!-- 'B' node -->
  <g class="child leaf B" transform="translate(90 -30)">
    <circle cx="170" cy="120" r="20" class="node" />
    <text x="164" y="126" class="svgDataText">B</text>
  ...
  <line x1="183" y1="86" x2="260" y2="168" class="directed CG" marker-end="url(#arrowhead)" />

  <line x1="240" y1="86" x2="199" y2="77" class="directed BC" marker-end="url(#arrowhead)" />
  ...
  <line x1="38" y1="168" x2="58" y2="126" class="directed DA" marker-end="url(#arrowhead)" />
  <line x1="102" y1="168" x2="82" y2="126" class="directed EA" marker-end="url(#arrowhead)" />
  <line x1="50" y1="188" x2="82" y2="188" class="directed DE" marker-end="url(#arrowhead)" />
  <g class="parent child E" transform="translate(-10 -20)">
    <circle cx="121" cy="207" r="20" class="node" />
    <text x="115" y="213" class="svgDataText">E</text>
  </g>
  ...
  <p>Result: </p>
  <input type="radio" id="rbtnBFS" value="BFS" name="rbgTraverseType" onchange="onTraverseTypeChange()" checked>
  <label for="rbtnBFS">BFS</label><br>
  <input type="radio" id="rbtnDFS" value="DFS" name="rbgTraverseType" onchange="onTraverseTypeChange()">
  <label for="rbtnDFS">DFS</label><br><br>
  
  <button onclick="startAnim();">Traverse from D</button>
</div>
<script>
  let traverseBtn2 = document.querySelector('#svgDiv2 button');
  let pResult2 = document.querySelector('#svgDiv2 p');
  let labelEls = document.querySelectorAll('#svgDiv2 label');
  let traverse = "Something";
  function disableRadioButtons() {
    document.getElementById("rbtnBFS").disabled = true;
    document.getElementById("rbtnDFS").disabled = true;
    labelEls[0].style.opacity = '0.5';
    labelEls[1].style.opacity = '0.5';
  }

  function enableRadioButtons() {
    document.getElementById("rbtnBFS").disabled = false;
    document.getElementById("rbtnDFS").disabled = false;
    labelEls[0].style.opacity = '1';
    labelEls[1].style.opacity = '1';
  }
    // Create a new anime timeline
let tl2_BFS = anime.timeline({
  autoplay: true, // set to false if you want to control when the timeline start
  duration: 700,
  easing: 'easeInOutQuad',
  loop: false,
});
let tl2_DFS = anime.timeline({
  autoplay: true, // set to false if you want to control when the timeline start
  duration: 700,
  easing: 'easeInOutQuad',
  loop: false,
});
  function onTraverseTypeChange() {
    traverse = document.querySelector('input[name="rbgTraverseType"]:checked').value;
    pResult2.innerHTML = 'Result: ';
    let nodes2 = document.querySelectorAll('#svgDiv2 circle');
    for(let i=0; i<nodes2.length; i++){
      nodes2[i].classList.remove('nodePrinted');
    }
    /*let g2 = document.querySelectorAll('#svgDiv2 g');
    for(let i=0; i<g2.length; i++){
      g2[i].style.opacity = '1';
    }*/
    tl2_BFS.restart();
    tl2_DFS.restart();
  }
  onTraverseTypeChange();
  ...
  function startAnim(){
    if(traverse === "BFS"){
      ...
      console.log("Your traversal: "+traverse);
    }
  }
...
tl2_BFS.add({
  ...
  complete: function(anim){
    traverseBtn2.innerHTML = 'Traverse from D';
    traverseBtn2.disabled = false;
    tl2_BFS.pause();
  }
})
.add({
  targets: '#svgDiv2 .D circle',
  begin: function(anim){
    disableRadioButtons();
    traverseBtn2.disabled = true;
    document.querySelector('#svgDiv2 .D circle').classList.add('nodePrinted');
    document.querySelector('#svgDiv2 .D circle').classList.add('extraThick');
    document.querySelector('#svgDiv2 p').innerHTML += 'D,';
  },
  complete: function(anim){
    document.querySelector('#svgDiv2 .D circle').classList.remove('extraThick');
  }
})
.add({
  targets: '#svgDiv2 .D',
  opacity: [1,0.5],
  begin: function(anim){
    document.querySelector('#svgDiv2 .A circle').classList.add('nodePrinted');
    document.querySelector('#svgDiv2 .A circle').classList.add('extraThick');
    document.querySelector('#svgDiv2 p').innerHTML += 'A,';
  },
  complete: function(anim){
    document.querySelector('#svgDiv2 .A circle').classList.remove('extraThick');
  }
})
.add({
  targets: '#svgDiv2 .A',
  opacity: [1,0.5],
  begin: function(anim){
    document.querySelector('#svgDiv2 .E circle').classList.add('nodePrinted');
    document.querySelector('#svgDiv2 .E circle').classList.add('extraThick');
    document.querySelector('#svgDiv2 p').innerHTML += 'E,';
  },
  complete: function(anim){
    document.querySelector('#svgDiv2 .E circle').classList.remove('extraThick');
  }
})
.add({
  targets: '#svgDiv2 .E',
  opacity: [1,0.5],
  begin: function(anim){
    document.querySelector('#svgDiv2 .C circle').classList.add('nodePrinted');
    document.querySelector('#svgDiv2 .C circle').classList.add('extraThick');
    document.querySelector('#svgDiv2 p').innerHTML += 'C,';
  },
  complete: function(anim){
    document.querySelector('#svgDiv2 .C circle').classList.remove('extraThick');
  }
})
.add({
  targets: '#svgDiv2 .C',
  opacity: [1,0.5],
  begin: function(anim){
    document.querySelector('#svgDiv2 .F circle').classList.add('nodePrinted');
    document.querySelector('#svgDiv2 .F circle').classList.add('extraThick');
    document.querySelector('#svgDiv2 p').innerHTML += 'F,';
  },
  complete: function(anim){
    document.querySelector('#svgDiv2 .F circle').classList.remove('extraThick');
  }
})
.add({
  targets: '#svgDiv2 .F',
  opacity: [1,0.5],
  begin: function(anim){
    document.querySelector('#svgDiv2 .G circle').classList.add('nodePrinted');
    document.querySelector('#svgDiv2 .G circle').classList.add('extraThick');
    document.querySelector('#svgDiv2 p').innerHTML += 'G,';
  },
  complete: function(anim){
    document.querySelector('#svgDiv2 .G circle').classList.remove('extraThick');
  }
})
.add({
  targets: '#svgDiv2 .G',
  opacity: [1,0.5],
  begin: function(anim){
    document.querySelector('#svgDiv2 .B circle').classList.add('nodePrinted');
    document.querySelector('#svgDiv2 .B circle').classList.add('extraThick');
    document.querySelector('#svgDiv2 p').innerHTML += 'B';
  },
  complete: function(anim){
    document.querySelector('#svgDiv2 .B circle').classList.remove('extraThick');
  }
})
.add({
  targets: '#svgDiv2 .B',
...
<p>To go from traversing a directed Graph instead of an undirected Graph, we just need to remove the last line in the <code class="w3-codespan">add_edge()</code> method:</p>
<div class="w3-example">
  <pre class="language-python notranslate w3-white"><code>def add_edge(self, u, v):
    if 0 <= u < self.size and 0 <= v < self.size:
        self.adj_matrix[u][v] = 1
        <del>self.adj_matrix[v][u] = 1</del>
</code></pre>
</div>
<p>We must also take care when we build our Graph because the edges are now directed.</p>
<p>The code example below contains both BFS and DFS traversal of the directed Graph from the animation above:</p>
<div class="w3-example">
  <h3>Example</h3>
  <p>Python:</p>
  <pre class="language-python notranslate w3-white"><code>class Graph:
    def __init__(self, size):
        self.adj_matrix = [[0] * size for _ in range(size)]
        self.size = size
        self.vertex_data = [''] * size  
...
g.bfs('D')
  ...
  <a class="w3-btn w3-margin-bottom" href="trydsa.php?filename=demo_graphs_directed_traversal" target="_blank">Try it Yourself &raquo;</a>
</div>
<p>Now that we have looked at two basic algorithms for how to traverse Graphs, we will use the next pages to see how other algorithms can run on the Graph data structure.</p>
<hr>
