...
<html lang="en-US">
<head>
<title>DSA Minimum Spanning Tree</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>DSA <span class="color_h1">Minimum Spanning Tree</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="dsa_algo_graphs_bellmanford.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="dsa_algo_mst_prim.php">Next &#10095;</a>
</div>
<hr>

<h2>The Minimum Spanning Tree Problem</h2>
<p>The Minimum Spanning Tree (MST) is the collection of edges required to connect all vertices in an undirected graph, with the minimum total edge weight.</p>
<div id="vueApp">
...
<p>The animation above runs <a href="dsa_algo_mst_prim.php">Prim's algorithm</a> to find the MST. Another way to find the MST, which also works for unconnected graphs, is to run <a href="dsa_algo_mst_kruskal.php">Kruskal's algorithm</a>.</p>
<p>It is called a Minimum Spanning <strong>Tree</strong>, because it is a connected, acyclic, undirected graph, which is the definition of a tree data structure.</p>
<p>In the real world, finding the Minimum Spanning Tree can help us find the most effective way to connect houses to the internet or to the electrical grid, or it can help us finding the fastest route to deliver packages.</p>
...
<h2>An MST Thought Experiment</h2>
<p>Let's imagine that the circles in the animation above are villages that are without electrical power, and you want to connect them to the electrical grid. After one village is given electrical power, the electrical cables must be spread out from that village to the others. The villages can be connected in a lot of different ways, each route having a different cost.</p>
<p>The electrical cables are expensive, and digging ditches for the cables, or stretching the cables in the air is expensive as well. The terrain can certainly be a challenge, and then there is perhaps a future cost for maintenance that is different depending on where the cables end up.</p>
<p>All these route costs can be factored in as edge weights in a graph. Every vertex represents a village, and every edge represents a possible route for the electrical cable between two villages.</p>
<p>After such a graph is created, the Minimum Spanning Tree (MST) can be found, and that will be the most effective way to connect these villages to the electrical grid.</p>
<p>And this is actually what the first MST algorithm (Borůvka's algorithm) was made for in 1926: To find the best way to connect the historical region of Moravia, in the Check Republic, to the electrical grid.</p>
<hr>

<h2>MST Algorithms</h2>
<p>The next two pages in this tutorial explains two algorithms that finds the Minimum Spanning Tree in a graph: <a href="dsa_algo_mst_prim.php">Prim's algorithm</a>, and <a href="dsa_algo_mst_kruskal.php">Kruskal's algorithm</a>.</p>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    ...
    <td>\(O(V^2)\), or \( O( E \cdot \log{V}) \) (Optimized)</td>
    <td>\( O( E \cdot \log{E} ) \)</td>
  </tr>
</tbody></table>
<hr>
