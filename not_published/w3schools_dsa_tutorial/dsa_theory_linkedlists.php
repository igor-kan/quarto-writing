...
ny:-->
    ...
    <h1>DSA <span class="color_h1">Linked Lists</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="dsa_algo_binarysearch.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="dsa_theory_linkedlists_memory.php">Next &#10095;</a>
</div>
<div class="ws-info">
...
<img src="img_linkedlists_singly.svg" alt="A singly linked list." style="max-width: 100%;">
...
<div class="ws-note">
  <p><strong>Note: </strong>How linked lists and arrays are stored in memory will be explained in more detail on <a href="dsa_theory_linkedlists_memory.php">the next page</a>.</p>
</div>
...
<div>
<h2>DSA Exercises</h2>
<form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_theory_linkedlists1" method="post" target="_blank">
<h2>Test Yourself With Exercises</h2>
<div class="exercisewindow">
<h2>Exercise:</h2>
<p>What is a node in a Linked List?</p>
<div class="exerciseprecontainer">
<pre style="overflow: auto;">
Each node in a Linked List 
contains <input name="ex1" maxlength="4" style="width: 5ch;">, and a <input name="ex2" maxlength="7" style="width: 8ch;"> 
...
<p><a target="_blank" href="exercise.php?filename=exercise_theory_linkedlists1">Start the Exercise</a></p>
</div>
</form>
</div>
<hr>
