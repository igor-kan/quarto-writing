...
ny:-->
    ...
    <h1>DSA <span class="color_h1">Graphs</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="dsa_data_avltrees.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="dsa_data_graphs_implementation.php">Next &#10095;</a>
</div>
<hr>
...
<!--<defs>
  ...
  <path  d="M 4 49 
            A 25 25 0 1 1 35 43" 
      class="loop directed" transform="translate(54,35)"
      marker-end="url(#arrowhead)"/>
  <path  d="M 4 49 
            A 25 25 0 1 1 27.5 49" 
      class="loop undirected" transform="translate(54,35)"/>
  <text x="32" y="65" class="loop svgBalFac">4</text>-->
  <!-- 'R' node -->
...
<p>Use the animation below to get an understanding of the different Graph properties, and how these properties can be combined.</p>
<div id="divAnim">
  <div id="wrapper">
    <div id="menu">
    <p><label><input type="checkbox" onchange="editGraph('weighted', this.checked)">Weighted</label></p>
    <p><label><input type="checkbox" onchange="editGraph('connected', this.checked)" checked>Connected</label></p>
    <p><label><input type="checkbox" onchange="editGraph('directed', this.checked)" checked>Directed</label></p>
    <p><input type="checkbox" id="inpElCyclic" onchange="editGraph('cyclic', this.checked)" checked><label for="inpElCyclic" id="labelElCyclic">Cyclic</label></p>
    <p><label><input type="checkbox" onchange="editGraph('loop', this.checked)" >Loop</label></p>
    </div>
    <div id="svgDiv"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 340 210" class="dsa_svg">
<defs>
  <marker id="arrowhead" markerWidth="8" markerHeight="14" refX="0" refY="7" orient="auto" markerUnits="userSpaceOnUse">
      <line x1="0.5" y1="0.5" x2="7.5" y2="7.5" stroke-width="1.5"/>
      <line x1="0" y1="7" x2="6" y2="7" stroke-width="1"/>
  ...
  <line x1="274" y1="75" x2="293" y2="53" class="directed BF" marker-end="url(#arrowhead)" />
  <line x1="274" y1="75" x2="297" y2="47" class="undirected BF" />
  <text x="270" y="65" class="svgBalFac">2</text>

  <line x1="191" y1="65" x2="283" y2="39" class="directed CF" marker-end="url(#arrowhead)" />
  <line x1="191" y1="65" x2="291" y2="38" class="undirected CF"/>
  <text x="240" y="47" class="svgBalFac">4</text>

  <line x1="90" y1="95" x2="143" y2="78" class="directed connected AC" marker-end="url(#arrowhead)" />
  <line x1="90" y1="95" x2="151" y2="77" class="undirected connected AC" />
  <text x="120" y="80" class="svgBalFac connected">3</text>

  <line x1="121" y1="169" x2="159" y2="96" class="directed connected EC" marker-end="url(#arrowhead)" />
  <line x1="121" y1="169" x2="162" y2="88" class="undirected connected EC" />
  <text x="120" y="150" class="svgBalFac connected">4</text>
  <!-- 'B' node -->
  <g class="child leaf" transform="translate(90 -30)">
    <circle cx="170" cy="120" r="20" class="node" />
    <text x="164" y="126" class="svgDataText">B</text>
  ...
  <line x1="266" y1="174" x2="190" y2="92" class="directed GC" marker-end="url(#arrowhead)" />
  <line x1="266" y1="174" x2="183" y2="86" class="undirected GC" />
  <text x="218" y="150" class="svgBalFac">5</text>

  <line x1="308" y1="50" x2="286" y2="159" class="directed cyclic FG" marker-end="url(#arrowhead)" />
  <!--<line x1="308" y1="50" x2="285" y2="167" class="undirected cyclic FG" />-->
  <text x="298" y="120" class="svgBalFac cyclicWeight">5</text>

  <line x1="190" y1="75" x2="231" y2="84" class="directed CB" marker-end="url(#arrowhead)" />
  <line x1="190" y1="75" x2="240" y2="86" class="undirected CB" />
  ...
  <g class="parent child" transform="translate(-10 -20)">
    <circle cx="80" cy="120" r="20" class="node" />
    <text x="73" y="126" class="svgDataText">A</text>
    <line x1="70" y1="138" x2="50" y2="180" class="directed AD" marker-end="url(#arrowhead)" />
    <line x1="70" y1="138" x2="48" y2="188" class="undirected AD" />
    <text x="43" y="170" class="svgBalFac">3</text>

    <line x1="90" y1="138" x2="110" y2="180" class="directed AE" marker-end="url(#arrowhead)" />
    <line x1="90" y1="138" x2="112" y2="188" class="undirected AE" />
    <text x="89" y="170" class="svgBalFac">3</text>
...
<script>
  let cyclicEl = document.querySelector('#divAnim .cyclic');
  let cyclicWeightEl = document.querySelector('#divAnim .cyclicWeight');
  let inpElCyclic = document.querySelector('#divAnim #inpElCyclic');
  let labelElCyclic = document.querySelector('#divAnim #labelElCyclic');
  let directedEdges = document.querySelectorAll('#divAnim .directed');
  let undirectedEdges = document.querySelectorAll('#divAnim .undirected');
  let connectedEdges = document.querySelectorAll('#divAnim .connected');
  let edgeWeights = document.querySelectorAll('#divAnim .svgBalFac');
  let loopDirected = document.querySelectorAll('#divAnim .loop .directed');
  let loopUndirected = document.querySelectorAll('#divAnim .loop .undirected');
  let loopStuff = document.querySelectorAll('#divAnim .loop');
  ...
  let clickedLoop = false;

  function updateGraph() {
    for(let i=0; i<edgeWeights.length; i++){
      edgeWeights[i].style.opacity = graphRep['weighted'] ? '1' : '0';
      if(!graphRep.directed){
        cyclicWeightEl.style.opacity = "0";
      }
    }
    /*if(!graphRep.directed || graphRep.loop){
      inpElCyclic.checked = true;
      graphRep.cyclic = true;
      inpElCyclic.disabled = true;
      labelElCyclic.style.opacity = '0.5';
      labelElCyclic.disabled = true;
    } else {
      inpElCyclic.disabled = false;
      labelElCyclic.style.opacity = '1';
    }*/
    if(graphRep.directed) {
      for(let i=0; i<directedEdges.length; i++){
        directedEdges[i].style.opacity = '1';
      }
      for(let i=0; i<undirectedEdges.length; i++){
        undirectedEdges[i].style.opacity = '0';
      }
    } else {
      for(let i=0; i<directedEdges.length; i++){
        directedEdges[i].style.opacity = '0';
      }
      for(let i=0; i<undirectedEdges.length; i++){
        undirectedEdges[i].style.opacity = '1';
      }
    }
    if(!graphRep.connected){
      for(let i=0; i<connectedEdges.length; i++){
        connectedEdges[i].style.opacity = '0';
      }
    }
    if(!graphRep.loop){
      for(let i=0; i<loopStuff.length; i++){
        loopStuff[i].style.opacity = '0';
      }
    }
    if(graphRep.loop || !graphRep.directed){
      labelElCyclic.style.opacity = '0.5';
      inpElCyclic.disabled = true;
      inpElCyclic.checked = true;
    } else {
      labelElCyclic.style.opacity = '1';
      inpElCyclic.disabled = false;
      inpElCyclic.checked = graphRep['cyclic'];
    }
    if(graphRep.directed && !graphRep.cyclic){
      cyclicWeightEl.style.opacity = "0";
      cyclicEl.style.opacity = "0";
    }
    
    /*for (const key in graphRep) {
      const elements = document.getElementsByClassName(key);
      for (let i = 0; i < elements.length; i++) {
        elements[i].style.opacity = graphRep[key] ? '1' : '0';
      }
    }*/
  }
  updateGraph();
  
  function editGraph(graphProp,bool) {
    if(graphProp === 'loop' && bool){
      clickedLoop = true;
    }
    else {
      clickedLoop = false;
    }
    graphRep[graphProp] = bool;
    updateGraph();
  }
</script>

<p>A <strong>weighted</strong> Graph is a Graph where the edges have values. The weight value of an edge can represent things like distance, capacity, time, or probability.</p>
<p>A <strong>connected</strong> Graph is when all the vertices are connected through edges somehow. A Graph that is not connected, is a Graph with isolated (disjoint) subgraphs, or single isolated vertices.</p>
<!-- <p>A connected Graph depending on if it is directed or not:</p>
<ul>
  <li>We have an <strong>undirected connected</strong> Graph is if you can go along the edges in the Graph from one node, to every other node in the Graph.</li>
  <li>A <strong>strongly connected directed</strong> Graph is if you can start at any node and reach every other node in the Graph along the directed edges.</li>
  <li>A <strong>weakly connected directed</strong> Graph is if you can reach all nodes from any node, when disregarding the direction of the edges.</li>
</ul> -->
<p>A <strong>directed</strong> Graph, also known as a digraph, is when the edges between the vertex pairs have a direction. The direction of an edge can represent things like hierarchy or flow.</p>
<p>A cyclic Graph is defined differently depending on whether it is directed or not:</p>
<ul>
  <li>A <strong>directed cyclic</strong> Graph is when you can follow a path along the directed edges that goes in circles. Removing the directed edge from F to G in the animation above makes the directed Graph not cyclic anymore.</li>
  <li>An <strong>undirected cyclic</strong> Graph is when you can come back to the same vertex you started at without using the same edge more than once. The undirected Graph above is cyclic because we can start and end up in vertes C without using the same edge twice.</li>
</ul>
<p>A <strong>loop</strong>, also called a self-loop, is an edge that begins and ends on the same vertex. A loop is a cycle that only consists of one edge. By adding the loop on vertex A in the animation above, the Graph becomes cyclic.</p>
<hr>
...
<div>
<h2>DSA Exercises</h2>
<form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_theory_graphs1" method="post" target="_blank">
<h2>Test Yourself With Exercises</h2>
<div class="exercisewindow">
<h2>Exercise:</h2>
<p>How can the Graph below be described?</p>
<img style="width: 100%; max-width: 300px;" src="img_exercises_graphs.png" alt="A Graph"><br><br>
<div class="exerciseprecontainer">
<pre style="overflow: auto;">
The Graph is cyclic, 
connected, and <input name="ex1" maxlength="8" style="width: 9ch;">.
</pre>
</div>
<br>
<button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
<p><a target="_blank" href="exercise.php?filename=exercise_theory_graphs1">Start the Exercise</a></p>
</div>
</form>
</div>
<hr>
