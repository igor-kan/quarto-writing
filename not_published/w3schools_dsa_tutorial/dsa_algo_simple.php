...
<html lang="en-US">
<head>
<title>DSA Simple Algorithm</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1><span class="color_h1">A Simple Algorithm</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="dsa_intro.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="dsa_data_arrays.php">Next &#10095;</a>
</div>
<hr>

<h2>Fibonacci Numbers</h2>

<p style="font-style: oblique;">The Fibonacci numbers are very useful for introducing algorithms, so before we continue, here is a short introduction to Fibonacci numbers.</p>
<p>The Fibonacci numbers are named after a 13th century Italian mathematician known as Fibonacci.</p>
<p>The two first Fibonacci numbers are 0 and 1, and the next Fibonacci number is always the sum of the two previous numbers, so we get 0, 1, 1, 2, 3, 5, 8, 13, 21, ...</p>
<div id="vueApp">
  <p>Create fibonacci numbers.</p>
    ...
    <div class="frameDiv">
      <transition-group>
        <div v-for="x in dice" 
          ...
          :style="{
            height: x.dieNmbr*10/this.scale + 'px'
          }"
        >
          <span>{{ x.dieNmbr }}</span>
        </div>
...
<script>
  ...
  methods: {
    ...
    async bblSort() {
      ...
      while(this.dice.length<12){
        let i = this.dice.length-1;
        this.dice[i].isSwapped = true;
        this.dice[i-1].isSwapped = true;
        await new Promise(resolve => setTimeout(resolve, this.delay));
        let prev1 = this.dice[this.dice.length-1].dieNmbr;
        let prev2 = this.dice[this.dice.length-2].dieNmbr;
...
<p>This tutorial will use loops and recursion a lot. So before we continue, let's implement three different versions of the algorithm to create Fibonacci numbers, just to see the difference between programming with loops and programming with recursion in a simple way.</p>
...
<h2>The Fibonacci Number Algorithm</h2>
<p>To generate a Fibonacci number, all we need to do is to add the two previous Fibonacci numbers.</p>
<p>The Fibonacci numbers is a good way of demonstrating what an algorithm is. We know the principle of how to find the next number, so we can write an algorithm to create as many Fibonacci numbers as possible.</p>
<p>Below is the algorithm to create the 20 first Fibonacci numbers.</p>
<div class="ws-info">
  <p><strong>How it works:</strong></p>
  <ol>
    <li>Start with the two first Fibonacci numbers 0 and 1.</li>
    <ol type="a">
      <li>Add the two previous numbers together to create a new Fibonacci number.</li>
      <li>Update the value of the two previous numbers.</li>
    </ol>
    <li>Do point a and b above 18 times.</li>
  </ol>
</div>
<hr>

<h2>Loops vs Recursion</h2>
<p>To show the difference between loops and recursion, we will implement solutions to find Fibonacci numbers in three different ways:</p>
<ol>
  <li>An implementation of the Fibonacci algorithm above using a <code>for</code> loop.</li>
  <li>An implementation of the Fibonacci algorithm above using recursion.</li>
  <li>Finding the \(n\)th Fibonacci number using recursion.</li>
</ol>
<hr>

<h2>1. Implementation Using a For Loop</h2>
<p>It can be a good idea to list what the code must contain or do before programming it:</p>
<ul>
  <li>Two variables to hold the previous two Fibonacci numbers</li>
  <li>A for loop that runs 18 times</li>
  <li>Create new Fibonacci numbers by adding the two previous ones</li>
  <li>Print the new Fibonacci number</li>
  <li>Update the variables that hold the previous two fibonacci numbers</li>
</ul>
<p>Using the list above, it is easier to write the program:</p>
<div class="w3-example">
  <h3>Example</h3>
  <pre class="language-python notranslate w3-white"><code>prev2 = 0
prev1 = 1
...
for fibo in range(18):
    ...
    print(newFibo)
    prev2 = prev1
    prev1 = newFibo</code></pre>
  <a class="w3-btn w3-margin-bottom" href="trydsa.php?filename=demo_findfibo1" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>2. Implementation Using Recursion</h2>
<p>Recursion is when a function calls itself.</p>
<p>To implement the Fibonacci algorithm we need most of the same things as in the code example above, but we need to replace the for loop with recursion.</p>
<p>To replace the for loop with recursion, we need to encapsulate much of the code in a function, and we need the function to call itself to create a new Fibonacci number as long as the produced number of Fibonacci numbers is below, or equal to, 19.</p>
<p>Our code looks like this:</p>
<div class="w3-example">
  <h3>Example</h3>
  <pre class="language-python notranslate w3-white"><code>print(0)
print(1)
count = 2
...
fibonacci(1,0)</code></pre>
  <a class="w3-btn w3-margin-bottom" href="trydsa.php?filename=demo_findfibo2" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>

<a id="nthfibo"></a>
<h2>3. Finding The \(n\)th Fibonacci Number Using Recursion</h2>
<p>To find the \(n\)th Fibonacci number we can write code based on the mathematic formula for Fibonacci number \(n\):</p>
<p><span class="math display">\[F(n) = F(n-1) + F(n-2) \]</span></p>
<p>This just means that for example the 10th Fibonacci number is the sum of the 9th and 8th Fibonacci numbers.</p>
<div class="ws-note">
  <p><strong>Note: </strong>This formula uses a 0-based index. This means that to generate the 20th Fibonacci number, we must write \(F(19)\).</p>
</div>
<p>When using this concept with recursion, we can let the function call itself as long as \(n\) is less than, or equal to, 1. If \(n \le 1\) it means that the code execution has reached one of the first two Fibonacci numbers 1 or 0.</p>
<p>The code looks like this:</p>
<div class="w3-example">
  <h3>Example</h3>
  <pre class="language-python notranslate w3-white"><code>def F(n):
    if n <= 1:
        return n
    else:
        return F(n - 1) + F(n - 2)
...
print(F(19))</code></pre>
  <a class="w3-btn w3-margin-bottom" href="trydsa.php?filename=demo_findfibo3" target="_blank">Try it Yourself &raquo;</a>
</div>
<p>Notice that this recursive method calls itself two times, not just one. This makes a huge difference in how the program will actually run on our computer. The number of calculations will explode when we increase the number of the Fibonacci number we want. To be more precise, the number of function calls will double every time we increase the Fibonacci number we want by one.</p>
<p>Just take a look at the number of function calls for \(F(5)\):</p>
<img src="img_recursive_explotion.png" class="imgTut" alt="The number of function calls with recursion">
<p>To better understand the code, here is how the recursive function calls return values so that \(F(5)\) returns the correct value in the end:</p>
<img src="img_recursive_explotion_return.png" class="imgTut" alt="The returns of the recursive function calls">
<p>There are two important things to notice here: The amount of function calls, and the amount of times the function is called with the same arguments.</p>
<p>So even though the code is fascinating and shows how recursion work, the actual code execution is too slow and ineffective to use for creating large Fibonacci numbers.</p>
<hr>

<h2>Summary</h2>
<p>Before we continue, let's look at what we have seen so far:</p>
<ul>
  <li>An algorithm can be implemented in different ways and in different programming languages.</li>
  <li>Recursion and loops are two different programming techniques that can be used to implement algorithms.</li>
</ul>
<p>It is time to move on to the first data structure we will look at, the array.</p>
<p>Click the "Next" button to continue.</p>
<hr>

<div>
<h2>DSA Exercises</h2>
<form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_algo_simple3" method="post" target="_blank">
<h2>Test Yourself With Exercises</h2>
<div class="exercisewindow">
<h2>Exercise:</h2>
<p>How can we make this fibonacci() function recursive?</p>
...
def fibonacci(prev1, prev2):
    ...
    if count &lt;= 19:
        ...
        prev1 = newFibo
        count += 1
        <input name="ex1" maxlength="9" style="width: 10ch;">(prev1, prev2)
    else:
        return
...
<p><a target="_blank" href="exercise.php?filename=exercise_algo_simple3">Start the Exercise</a></p>
</div>
</form>
</div>
<hr>
