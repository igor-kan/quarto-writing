...
<html lang="en-US">
<head>
<title>DSA Graphs Cycle Detection</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
#svgDiv0 circle, #svgDiv0 line, #svgDiv0 text, #svgDiv0 path,
#svgDiv2 circle, #svgDiv2 line, #svgDiv2 text, #svgDiv2 path,
#svgDiv3 circle, #svgDiv3 line, #svgDiv3 text, #svgDiv3 .loop,
#svgDiv4 circle, #svgDiv4 line, #svgDiv4 text, #svgDiv4 .loop  {
...
#arrowheadGreen line, .path1 path,
.darkpagetheme #arrowheadGreen line, .darkpagetheme .path1 path {
  stroke: green;
}
.darkpagetheme .path1 text, .path1 text {
  fill: green;
}
#arrowheadRed line, .path2 path,
.darkpagetheme #arrowheadRed line, .darkpagetheme .path2 path {
  stroke: red;
}
.darkpagetheme .path2 text, .path2 text {
  fill: red;
}
#fatArrowhead line {
  stroke-width: 3;
...
.subset {
  fill: rgb(129,181,117);
  opacity: 0;
  stroke-width: 0;
}
.darkpagetheme .subset {
  fill: #4a733f;
}
#svgDiv3 .loop {
  opacity: 0;
...
ny:-->
    ...
    <h1>DSA <span class="color_h1">Graphs Cycle Detection</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="dsa_algo_graphs_traversal.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="dsa_theory_graphs_shortestpath.php">Next &#10095;</a>
</div>
<hr>

<h2>Cycles in Graphs</h2>
<p>A cycle in a Graph is a path that starts and ends at the same vertex, where no edges are repeated. It is similar to walking through a maze and ending up exactly where you started.</p>
<div id="svgDiv4" class="svgDiv">
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 340 210">
<defs>
  ...
  <marker id="fatArrowhead" markerWidth="8" markerHeight="14" refX="0" refY="7" orient="auto" markerUnits="userSpaceOnUse">
      <line x1="0.5" y1="0.5" x2="7.5" y2="7.5"/>
      <line x1="0" y1="7" x2="6" y2="7" />
      <line x1="0.5" y1="13.5" x2="7.5" y2="6.5" />
  </marker>
</defs>
<path  d="M 7.6 15.2 
            A 20 20 0 1 0 17.1 6.6" 
      class="loop directed thick" transform="translate(235,55)"
      marker-end="url(#fatArrowhead)"/>
  <!-- 'R' node -->
  <g class="root parent F" transform="translate(140 0)">
    <circle cx="170" cy="30" r="20" class="node" />
    <text x="164" y="37" class="svgDataText">F</text>
  </g>

  <line x1="285" y1="120" x2="304" y2="49" class="undirected BF" />

  <line x1="191" y1="65" x2="291" y2="38" class="undirected CF"/>

  <line x1="90" y1="54" x2="150" y2="67" class="undirected connected AC" />

  <line x1="121" y1="128" x2="158" y2="84" class="undirected connected EC" />
  <!-- 'B' node -->
  <g class="child leaf B" transform="translate(110 20)">
    <circle cx="170" cy="120" r="20" class="node" />
    <text x="164" y="126" class="svgDataText">B</text>
  </g>
  <!-- 'C' node -->
  <g class="parent child C" transform="translate(-100 -50)">
    <circle cx="271" cy="120" r="20" class="node" />
    <text x="265" y="126" class="svgDataText">C</text>
  </g>
  <line x1="195" y1="148" x2="176" y2="90" class="undirected GC" />

  <line x1="188" y1="81" x2="263" y2="128" class="undirected CB" />


  <!-- Nodes A, D, and E -->
  <g class="parent child A" transform="translate(-10 -70)">
    <circle cx="80" cy="120" r="20" class="node" />
    <text x="73" y="126" class="svgDataText">A</text>
  </g>
  <g class="parent child" transform="translate(-10 -70)">
    <line x1="70" y1="138" x2="48" y2="188" class="undirected AD" />
    <line x1="90" y1="138" x2="112" y2="188" class="undirected AE" />
  </g>
  <g class="parent child E" transform="translate(-10 -70)">
    <circle cx="121" cy="207" r="20" class="node" />
    <text x="115" y="213" class="svgDataText">E</text>
  </g>
  <g class="parent child D" transform="translate(-10 -70)">
    <circle cx="41" cy="207" r="20" class="node" />
    <text x="35" y="213" class="svgDataText" >D</text>
  </g>

  <!-- 'G' node -->
  <g class="child leaf G" transform="translate(-190 -40)">
    <circle cx="391" cy="207" r="20" class="node" />
    <text x="385" y="213" class="svgDataText">G</text>
  </g>
</svg>
  <p>Is cyclic: </p>
  <button onclick="tl4.play();">DFS Cycle Detection</button>
</div>
<script src="https://cdnjs.cloudflare.com/ajax/libs/animejs/3.2.1/anime.min.js" integrity="sha512-z4OUqw38qNLpn1libAN9BsoDx6nbNFio5lA6CuTp9NlK83b89hgyCVq+N5FdBJptINztxn1Z3SaKSKUS5UP60Q==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
<script>
  let traverseBtn4 = document.querySelector('#svgDiv4 button');
  let pResult4 = document.querySelector('#svgDiv4 p');
...
tl4.add({
  targets: '#svgDiv4 circle, #svgDiv4 text, #svgDiv4 line',
  opacity: 1,
  duration: 200,
  begin: function(anim){
    traverseBtn4.disabled = true;
    pResult4.innerHTML = 'Is cyclic: ';
    let nodesAndLines = document.querySelectorAll('#svgDiv4 circle, #svgDiv4 line');
    for(let i=0; i<nodesAndLines.length; i++){
      nodesAndLines[i].classList.remove('thick');
    }
    document.querySelector('#svgDiv4 path').style.opacity = "0";
  },
  complete: function(anim){
    traverseBtn4.innerHTML = 'DFS Cycle Detection';
    traverseBtn4.disabled = false;
    tl4.pause();
  }
})
.add({
  targets: '#svgDiv4 .A circle',
  begin: function(anim){
    traverseBtn4.disabled = true;
    document.querySelector('#svgDiv4 .A circle').classList.add('thick');
  }
})
.add({
  targets: '#svgDiv4 .AC',
  begin: function(anim){
    document.querySelector('#svgDiv4 .AC').classList.add('thick');
    document.querySelector('#svgDiv4 .C circle').classList.add('thick');
  }
})
.add({
  targets: '#svgDiv4 .CB',
  begin: function(anim){
    document.querySelector('#svgDiv4 .CB').classList.add('thick');
    document.querySelector('#svgDiv4 .B circle').classList.add('thick');
  }
})
.add({
  targets: '#svgDiv4 .BF',
  begin: function(anim){
    document.querySelector('#svgDiv4 .BF').classList.add('thick');
    document.querySelector('#svgDiv4 .F circle').classList.add('thick');
  }
})
.add({
  targets: '#svgDiv4 .BF',
  begin: function(anim){
    document.querySelector('#svgDiv4 .CF').classList.add('thick');
  }
})
.add({
  targets: '#svgDiv4 .CF',
  begin: function(anim){
    document.querySelector('#svgDiv4 path').style.opacity = "1";
    document.querySelector('#svgDiv4 p').innerHTML += 'True';
  }
})
.add({
  begin: function(anim){
...
<p>A cycle can be defined slightly different depending on the situation. A self-loop for example, where an edge goes from and to the same vertex, might or might not be considered a cycle, depending on the problem you are trying to solve.</p>
...
<p>It is important to be able to detect cycles in Graphs because cycles can indicate problems or special conditions in many applications like networking, scheduling, and circuit design.</p>
<p>The two most common ways to detect cycles are:</p>
<ol>
  <li><strong>Depth First Search (DFS): </strong>DFS traversal explores the Graph and marks vertices as visited. A cycle is detected when the current vertex has an adjacent vertex that has already been visited.</li>
  <li><strong>Union-Find: </strong>This works by initially defining each vertex as a group, or a subset. Then these groups are joined for every edge. Whenever a new edge is explored, a cycle is detected if two vertices already belong to the same group.</li>
</ol>
<p>How cycle detection with DFS and Union-Find work, and how they are implemented, are explained in more detail below.</p>
<hr>

<h2>DFS Cycle Detection for Undirected Graphs</h2>
<p>To detect cycles in an undirected Graph using Depth First Search (DFS), we use a code very similar to <a href="dsa_algo_graphs_traversal.php#dfsTraversal">the DFS traversal code</a> on the previous page, with just a few changes.</p>
<div class="ws-info">
  <p><strong>How it works:</strong></p>
  <ol>
    <li>Start DFS traversal on each unvisited vertex (in case the Graph is not connected).</li>
    <li>During DFS, mark vertices as visited, and run DFS on the adjacent vertices (recursively).</li>
    <li>If an adjacent vertex is already visited and is not the parent of the current vertex, a cycle is detected, and <code class="w3-codespan">True</code> is returned.</li>
    <li>If DFS traversal is done on all vertices and no cycles are detected, <code class="w3-codespan">False</code> is returned.</li>
  </ol>
</div>
<p>Run the animation below to see how DFS cycle detection runs on a specific Graph, starting in vertex A (this is the same as the previous animation).</p>
<div id="svgDiv0" class="svgDiv">
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 340 210">
<defs>
  <marker id="arrowhead" markerWidth="8" markerHeight="14" refX="0" refY="7" orient="auto" markerUnits="userSpaceOnUse">
      <line x1="0.5" y1="0.5" x2="7.5" y2="7.5" stroke-width="1.5"/>
...
<path  d="M 7.6 15.2 
  ...
  <p>Is cyclic: </p>
  <button onclick="tl0.play();">DFS Cycle Detection</button>
</div>
<script src="https://cdnjs.cloudflare.com/ajax/libs/animejs/3.2.1/anime.min.js" integrity="sha512-z4OUqw38qNLpn1libAN9BsoDx6nbNFio5lA6CuTp9NlK83b89hgyCVq+N5FdBJptINztxn1Z3SaKSKUS5UP60Q==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
<script>
  let traverseBtn0 = document.querySelector('#svgDiv0 button');
  let pResult0 = document.querySelector('#svgDiv0 p');
...
tl0.add({
  targets: '#svgDiv0 circle, #svgDiv0 text, #svgDiv0 line',
  opacity: 1,
  duration: 200,
  begin: function(anim){
    traverseBtn0.disabled = true;
    pResult0.innerHTML = 'Is cyclic: ';
    let nodesAndLines0 = document.querySelectorAll('#svgDiv0 circle, #svgDiv0 line');
    for(let i=0; i<nodesAndLines0.length; i++){
      nodesAndLines0[i].classList.remove('thick');
    }
    document.querySelector('#svgDiv0 path').style.opacity = "0";
  },
  complete: function(anim){
    traverseBtn0.innerHTML = 'DFS Cycle Detection';
    traverseBtn0.disabled = false;
    tl0.pause();
  }
})
.add({
  targets: '#svgDiv0 .A circle',
  begin: function(anim){
    traverseBtn0.disabled = true;
    document.querySelector('#svgDiv0 .A circle').classList.add('thick');
  }
})
.add({
  targets: '#svgDiv0 .AC',
  begin: function(anim){
    document.querySelector('#svgDiv0 .AC').classList.add('thick');
    document.querySelector('#svgDiv0 .C circle').classList.add('thick');
  }
})
.add({
  targets: '#svgDiv0 .CB',
  begin: function(anim){
    document.querySelector('#svgDiv0 .CB').classList.add('thick');
    document.querySelector('#svgDiv0 .B circle').classList.add('thick');
  }
})
.add({
  targets: '#svgDiv0 .BF',
  begin: function(anim){
    document.querySelector('#svgDiv0 .BF').classList.add('thick');
    document.querySelector('#svgDiv0 .F circle').classList.add('thick');
  }
})
.add({
  targets: '#svgDiv0 .BF',
  begin: function(anim){
    document.querySelector('#svgDiv0 .CF').classList.add('thick');
  }
})
.add({
  targets: '#svgDiv0 .CF',
  begin: function(anim){
    document.querySelector('#svgDiv0 path').style.opacity = "1";
    document.querySelector('#svgDiv0 p').innerHTML += 'True';
  }
})
.add({
  begin: function(anim){
    traverseBtn0.innerHTML = 'Reset';
    traverseBtn0.disabled = false;
  },
  complete: function(anim){
    tl0.pause();
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Python:</p>
  <pre class="language-python notranslate line-numbers w3-white" data-line="24-34,36-42,66"><code>class Graph:
...
print("\nGraph has cycle:", g.is_cyclic())
  ...
  <a class="w3-btn w3-margin-bottom" href="trydsa.php?filename=demo_graphs_undirected_cycledetect_dfs" target="_blank">Try it Yourself &raquo;</a>
</div>
<p><strong>Line 66: </strong>The DFS cycle detection starts when the <code class="w3-codespan">is_cyclic()</code> method is called.</p>
<p><strong>Line 37: </strong>The <code class="w3-codespan">visited</code> array is first set to <code class="w3-codespan">false</code> for all vertices, because no vertices are visited yet at this point.</p>
<p><strong>Line 38-42: </strong>DFS cycle detection is run on all vertices in the Graph. This is to make sure all vertices are visited in case the Graph is not connected. If a node is already visited, there must be a cycle, and <code class="w3-codespan">True</code> is returned. If all nodes are visited just ones, which means no cycles are detected, <code class="w3-codespan">False</code> is returned.</p>
<p><strong>Line 24-34: </strong>This is the part of the DFS cycle detection that visits a vertex, and then visits adjacent vertices recursively. A cycle is detected and <code class="w3-codespan">True</code> is returned if an adjacent vertex has already been visited, and it is not the parent node.</p>
<hr>

<a id="directed"></a>
<h2>DFS Cycle Detection for Directed Graphs</h2>
<p>To detect cycles in Graphs that are directed, the algorithm is still very similar as for undirected Graphs, but the code must be modified a little bit because for a directed Graph, if we come to an adjacent node that has already been visited, it does not necessarily mean that there is a cycle.</p>
<p>Just consider the following Graph where two paths are explored, trying to detect a cycle:</p>
<div id="svgDiv1" class="svgDiv">
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 340 210">
<defs>
  <marker id="arrowhead" markerWidth="8" markerHeight="14" refX="0" refY="7" orient="auto" markerUnits="userSpaceOnUse">
      <line x1="0.5" y1="0.5" x2="7.5" y2="7.5" stroke-width="1.5"/>
  ...
  <marker id="arrowheadGreen" markerWidth="8" markerHeight="14" refX="0" refY="7" orient="auto" markerUnits="userSpaceOnUse">
      <line x1="0.5" y1="0.5" x2="7.5" y2="7.5" stroke-width="1.5"/>
      <line x1="0" y1="7" x2="6" y2="7" stroke-width="1"/>
      <line x1="0.5" y1="13.5" x2="7.5" y2="6.5" stroke-width="1.5"/>
  </marker>
...
<g class="path1">
  <path  d="M -10 -25
            Q 10 95, 115 20" 
      class="loop directed" transform="translate(110,15)"
      marker-end="url(#arrowheadGreen)" stroke-dasharray="5,5"/>
  <text x="140" y="50" class="svgDataText">1</text>
</g>
<g class="path2" transform="translate(-35,90)">
  <path  d="M -5 100 
          Q 40 -10, 170 -10" 
      class="loop directed" transform="translate(110,15)"
      marker-end="url(#arrowheadRed)" stroke-dasharray="5,5"/>
  <text x="175" y="55" class="svgDataText">2</text>
</g>
  

  <line x1="90" y1="95" x2="143" y2="77" class="undirected connected BC" marker-end="url(#arrowhead)" transform="translate(50 0)" />
  

  <!-- 'C' node -->
  <g class="parent child C" transform="translate(-50 -50)">
    <circle cx="271" cy="120" r="20" class="node" />
    <text x="265" y="126" class="svgDataText">C</text>
  </g>

  <!-- Nodes A, D, and E -->
  <g class="parent child A" transform="translate(40 -20)">
    <circle cx="80" cy="120" r="20" class="node" />
    <text x="73" y="126" class="svgDataText">B</text>
  </g>
  <g class="parent child" transform="translate(40 -20)">
    <line x1="50" y1="65" x2="66" y2="95" class="undirected AB" marker-end="url(#arrowhead)" />
    <line x1="25" y1="182" x2="62" y2="142" class="undirected DB" marker-end="url(#arrowhead)"/>
  </g>
  <g class="parent child E" transform="translate(-70 -30)">
    <circle cx="121" cy="207" r="20" class="node" />
    <text x="115" y="213" class="svgDataText">D</text>
  </g>
  <g class="parent child D" transform="translate(40 -180)">
    <circle cx="41" cy="207" r="20" class="node" />
    <text x="35" y="213" class="svgDataText" >A</text>
  </g>
</svg>
</div>
<p>In path 1, the first path to be explored, vertices A->B->C are visited, no cycles detected.</p>
<p>In the second path to be explored (path 2), vertices D->B->C are visited, and the path has no cycles, right? But without changes in our program, a false cycle would actually be detected when going from D to the adjacent vertex B, because B has already been visited in path 1. To avoid such false detections, the code is modified to detect cycles only in case a node has been visited before in the same path.</p>
<div id="svgDiv2" class="svgDiv">
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 340 210">
  <defs>
    <marker id="arrowheadAC" markerWidth="8" markerHeight="14" refX="0" refY="7" orient="auto" markerUnits="userSpaceOnUse">
        <line x1="0.5" y1="0.5" x2="7.5" y2="7.5" stroke-width="1.5"/>
        <line x1="0" y1="7" x2="6" y2="7" stroke-width="1"/>
        <line x1="0.5" y1="13.5" x2="7.5" y2="6.5" stroke-width="1.5"/>
    </marker>
    <marker id="arrowheadCB" markerWidth="8" markerHeight="14" refX="0" refY="7" orient="auto" markerUnits="userSpaceOnUse">
      <line x1="0.5" y1="0.5" x2="7.5" y2="7.5" stroke-width="1.5"/>
      <line x1="0" y1="7" x2="6" y2="7" stroke-width="1"/>
      <line x1="0.5" y1="13.5" x2="7.5" y2="6.5" stroke-width="1.5"/>
  </marker>
  <marker id="arrowheadBF" markerWidth="8" markerHeight="14" refX="0" refY="7" orient="auto" markerUnits="userSpaceOnUse">
      <line x1="0.5" y1="0.5" x2="7.5" y2="7.5" stroke-width="1.5"/>
      <line x1="0" y1="7" x2="6" y2="7" stroke-width="1"/>
      <line x1="0.5" y1="13.5" x2="7.5" y2="6.5" stroke-width="1.5"/>
  </marker>
  <marker id="arrowheadCE" markerWidth="8" markerHeight="14" refX="0" refY="7" orient="auto" markerUnits="userSpaceOnUse">
      <line x1="0.5" y1="0.5" x2="7.5" y2="7.5" stroke-width="1.5"/>
      <line x1="0" y1="7" x2="6" y2="7" stroke-width="1"/>
      <line x1="0.5" y1="13.5" x2="7.5" y2="6.5" stroke-width="1.5"/>
  </marker>
  <marker id="arrowheadEA" markerWidth="8" markerHeight="14" refX="0" refY="7" orient="auto" markerUnits="userSpaceOnUse">
      <line x1="0.5" y1="0.5" x2="7.5" y2="7.5" stroke-width="1.5"/>
      <line x1="0" y1="7" x2="6" y2="7" stroke-width="1"/>
      <line x1="0.5" y1="13.5" x2="7.5" y2="6.5" stroke-width="1.5"/>
  </marker>
...
<path d="M 7.6 15.2 
            A 20 20 0 1 1 17.1 6.6" 
      class="loop directed thick" transform="translate(115,75)"
      marker-end="url(#fatArrowhead)"/>
  <!-- 'R' node -->
  <g class="root parent F" transform="translate(140 40)">
    <circle cx="170" cy="30" r="20" class="node" />
    <text x="165" y="37" class="svgDataText">F</text>
  </g>

  <line x1="288" y1="120" x2="299" y2="96" class="undirected BF" marker-end="url(#arrowheadBF)" />

  <!--<line x1="191" y1="65" x2="291" y2="38" class="undirected CF"/>-->

  <line x1="90" y1="47" x2="153" y2="35" class="undirected connected AC" marker-end="url(#arrowheadAC)" />

  <line x1="170" y1="48" x2="128" y2="114" class="undirected connected CE" marker-end="url(#arrowheadCE)" />
  <!-- 'B' node -->
  <g class="child leaf B" transform="translate(110 20)">
    <circle cx="170" cy="120" r="20" class="node" />
    <text x="164" y="126" class="svgDataText">B</text>
  ...
  <!-- 'C' node -->
  <g class="parent child C" transform="translate(-90 -90)">
    <circle cx="271" cy="120" r="20" class="node" />
    <text x="265" y="126" class="svgDataText">C</text>
  </g>
  <line x1="183" y1="50" x2="197" y2="139" class="undirected CG" marker-end="url(#arrowhead)" />

  <line x1="195" y1="46" x2="259" y2="120" class="undirected CB" marker-end="url(#arrowheadCB)" />
  ...
  <g class="parent child" transform="translate(-10 -70)">
    <line x1="48" y1="188" x2="68" y2="146" class="directed AB" marker-end="url(#arrowhead)" />
    <line x1="112" y1="188" x2="92" y2="146" class="undirected EA" marker-end="url(#arrowheadEA)" />
  </g>
  <g class="parent child E" transform="translate(-10 -70)">
    <circle cx="121" cy="207" r="20" class="node" />
    <text x="115" y="213" class="svgDataText">E</text>
  ...
  <p>Is cyclic: </p>
  <button onclick="tl2.play();">DFS Cycle Detection</button>
</div>
<script src="https://cdnjs.cloudflare.com/ajax/libs/animejs/3.2.1/anime.min.js" integrity="sha512-z4OUqw38qNLpn1libAN9BsoDx6nbNFio5lA6CuTp9NlK83b89hgyCVq+N5FdBJptINztxn1Z3SaKSKUS5UP60Q==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
<script>
  let traverseBtn2 = document.querySelector('#svgDiv2 button');
  let pResult2 = document.querySelector('#svgDiv2 p');
...
tl2.add({
  targets: '#svgDiv2 circle, #svgDiv2 text, #svgDiv2 line',
  opacity: 1,
  duration: 200,
  begin: function(anim){
    traverseBtn2.disabled = true;
    pResult2.innerHTML = 'Is cyclic: ';
    let nodesLinesArrowheads = document.querySelectorAll('#svgDiv2 circle, #svgDiv2 line, #arrowheadAC, #arrowheadCB, #arrowheadBF, #arrowheadCE, #arrowheadEA');
    for(let i=0; i<nodesLinesArrowheads.length; i++){
      nodesLinesArrowheads[i].classList.remove('thick');
    }
    document.querySelector('#svgDiv2 path').style.opacity = "0";
  },
  complete: function(anim){
    traverseBtn2.innerHTML = 'DFS Cycle Detection';
    traverseBtn2.disabled = false;
    tl2.pause();
  }
})
.add({
  targets: '#svgDiv2 .A circle',
  begin: function(anim){
    traverseBtn2.disabled = true;
    document.querySelector('#svgDiv2 .A circle').classList.add('thick');
  }
})
.add({
  targets: '#svgDiv2 .AC',
  begin: function(anim){
    document.querySelector('#svgDiv2 .AC').classList.add('thick');
    document.querySelector('#arrowheadAC').classList.add('thick');
    document.querySelector('#svgDiv2 .C circle').classList.add('thick');
  }
})
.add({
  targets: '#svgDiv2 .CB',
  begin: function(anim){
    document.querySelector('#svgDiv2 .CB').classList.add('thick');
    document.querySelector('#arrowheadCB').classList.add('thick');
    document.querySelector('#svgDiv2 .B circle').classList.add('thick');
  }
})
.add({
  targets: '#svgDiv2 .BF',
  begin: function(anim){
    document.querySelector('#svgDiv2 .BF').classList.add('thick');
    document.querySelector('#arrowheadBF').classList.add('thick');
    document.querySelector('#svgDiv2 .F circle').classList.add('thick');
  }
})
.add({
  targets: '#svgDiv2 .CE',
  begin: function(anim){
    document.querySelector('#svgDiv2 .CE').classList.add('thick');
    document.querySelector('#arrowheadCE').classList.add('thick');
    document.querySelector('#svgDiv2 .E circle').classList.add('thick');
  }
})
.add({
  targets: '#svgDiv2 .EA',
  begin: function(anim){
    document.querySelector('#svgDiv2 .EA').classList.add('thick');
    document.querySelector('#arrowheadEA').classList.add('thick');
  }
})
.add({
  targets: '#svgDiv2 .EA',
  begin: function(anim){
    document.querySelector('#svgDiv2 path').style.opacity = "1";
    document.querySelector('#svgDiv2 p').innerHTML += 'True';
  }
})
.add({
  begin: function(anim){
    traverseBtn2.innerHTML = 'Reset';
    traverseBtn2.disabled = false;
  },
  complete: function(anim){
    tl2.pause();
...
<p>To implement DFS cycle detection on a directed Graph, like in the animation above, we need to remove the symmetry we have in the adjacency matrix for undirected Graphs. We also need to use a <code class="w3-codespan">recStack</code> array to keep track of visited vertices in the current recursive path.</p>
<div class="w3-example">
  <h3>Example</h3>
  <p>Python:</p>
  <pre class="language-python notranslate line-numbers w3-white" data-line="6,26, 14-19"><code>class Graph:
    # ......
    def add_edge(self, u, v):
        if 0 <= u < self.size and 0 <= v < self.size:
            self.adj_matrix[u][v] = 1
            <del>self.adj_matrix[v][u] = 1</del>
    # ......
...
print("Graph has cycle:", g.is_cyclic())
  ...
  <a class="w3-btn w3-margin-bottom" href="trydsa.php?filename=demo_graphs_directed_cycledetect_DFS" target="_blank">Try it Yourself &raquo;</a>
</div>
<p><strong>Line 6: </strong>This line is removed because it is only applicable for undirected Graphs.</p>
<p><strong>Line 26: </strong>The <code class="w3-codespan">recStack</code> array keeps an overview over which vertices have been visited during a recursive exploration of a path.</p>
<p><strong>Line 14-19: </strong>For every adjacent vertex not visited before, do a recursive DFS cycle detection. If an adjacent vertex has been visited before, also in the same recursive path (line 13), a cycle has been found, and <code class="w3-codespan">True</code> is returned.</p>
<hr>

<a id="unionfind"></a>
<h2>Union-Find Cycle Detection</h2>
<p>Detecting cycles using Union-Find is very different from using Depth First Search.</p>
<p>Union-Find cycle detection works by first putting each node in its own subset (like a bag or container). Then, for every edge, the subsets belonging to each vertex are merged. For an edge, if the vertices already belong to the same subset, it means that we have found a cycle.</p>
<div id="svgDiv3" class="svgDiv">
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 340 210">
<defs>
  <marker id="arrowhead" markerWidth="8" markerHeight="14" refX="0" refY="7" orient="auto" markerUnits="userSpaceOnUse">
      <line x1="0.5" y1="0.5" x2="7.5" y2="7.5" stroke-width="1.5"/>
...
<path d="M 0 34 Q 3 9 21 3 T 52 1 T 73 11 T 78 31 T 67 53 T 39 64 T 11 61 Q 0 53 0 34" 
      class="subset A" transform="translate(40,20)"/>

<path d="M 0 34 Q 1 18 8 10 T 28 2 T 50 5 T 65 19 T 67 40 T 46 54 T 14 52 Q 0 46 0 34" 
      class="subset B" transform="translate(0,108)"/>

<path d="M 2 22 Q 12 3 30 0 T 62 26 T 27 58 T 2 22" 
      class="subset C" transform="translate(100,150)"/>

<path d="M 0 20 Q 0 0 30 0 T 61 23 T 31 52 T 0 20" 
      class="subset D" transform="translate(190,65)"/>

<path d="M 0 39 Q 14 4 39 0 T 60 40 T 24 71 T 0 39" 
      class="subset E" transform="translate(250,105)"/>
<path d=" M  0 20 
          Q  0  0, 30 0
          T 60 40
          T 30 70
          T 0 20" 
      class="subset F" transform="translate(280,0)"/>

<path d="M -2 21 Q 7 0 30 0 T 57 26 T 22 53 T -2 21" 
      class="subset G" transform="translate(173,0)"/>
  ...
  <line x1="285" y1="120" x2="304" y2="49" class="undirected EF" />

  <line x1="230" y1="85" x2="293" y2="42" class="undirected DF"/>

  <line x1="90" y1="55" x2="202" y2="84" class="undirected connected AD" />

  <line x1="143" y1="165" x2="208" y2="105" class="undirected connected CD" />
  <!-- 'E' node -->
  <g class="child leaf E" transform="translate(110 20)">
    <circle cx="170" cy="120" r="20" class="node" />
    <text x="164" y="126" class="svgDataText">E</text>
  </g>
  <!-- 'D' node -->
  <g class="parent child D" transform="translate(-50 -30)">
    <circle cx="271" cy="120" r="20" class="node" />
    <text x="265" y="126" class="svgDataText">D</text>
  </g>
  <line x1="206" y1="47" x2="215" y2="72" class="undirected GD" />

  <line x1="234" y1="104" x2="263" y2="128" class="undirected DE" />
  ...
  <g class="parent child" transform="translate(-10 -70)">
    <line x1="70" y1="138" x2="48" y2="188" class="undirected BA" />
    <line x1="90" y1="138" x2="132" y2="230" class="undirected AC" />
  </g>
  <g class="parent child C" transform="translate(10 -30)">
    <circle cx="121" cy="207" r="20" class="node" />
    <text x="115" y="213" class="svgDataText">C</text>
  </g>
  <g class="parent child B" transform="translate(-10 -70)">
    <circle cx="41" cy="207" r="20" class="node" />
    <text x="35" y="213" class="svgDataText" >B</text>
  </g>

  <!-- 'G' node -->
  <g class="child leaf G" transform="translate(-190 -180)">
    <circle cx="391" cy="207" r="20" class="node" />
    <text x="385" y="213" class="svgDataText">G</text>
  </g>
  ...
  <path d="M 7.6 15.2 
            A 20 20 0 1 0 17.1 6.6" 
      class="loop directed thick" transform="translate(122,83)"
      marker-end="url(#fatArrowhead)"/>
</svg>
  <p>Is cyclic: </p>
  <button onclick="tl3.play();">Union-Find Cycle Detection</button>
</div>
<script src="https://cdnjs.cloudflare.com/ajax/libs/animejs/3.2.1/anime.min.js" integrity="sha512-z4OUqw38qNLpn1libAN9BsoDx6nbNFio5lA6CuTp9NlK83b89hgyCVq+N5FdBJptINztxn1Z3SaKSKUS5UP60Q==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
<script>
  let traverseBtn3 = document.querySelector('#svgDiv3 button');
  let pResult3 = document.querySelector('#svgDiv3 p');
  let dur3 = 1000;
...
tl3.add({
  targets: '#svgDiv3 circle, #svgDiv3 text, #svgDiv3 line',
  opacity: 1,
  duration: 200,
  begin: function(anim){
    traverseBtn3.disabled = true;
    pResult3.innerHTML = 'Is cyclic: ';
    let nodesAndLines3 = document.querySelectorAll('#svgDiv3 circle, #svgDiv3 line');
    for(let i=0; i<nodesAndLines3.length; i++){
      nodesAndLines3[i].classList.remove('thick');
    }
    let subsets = document.querySelectorAll('#svgDiv3 .subset');
    for(let i=0; i<subsets.length; i++){
      subsets[i].style.opacity = '0';
    }
    document.querySelector('#svgDiv3 .loop').style.opacity = '0';
  },
  complete: function(anim){
    traverseBtn3.innerHTML = 'Union-Find Cycle Detection';
    traverseBtn3.disabled = false;
    tl3.pause();
  }
})
.add({
  targets: '#svgDiv3 .subset',
  opacity: 1,
  begin: function(){
    traverseBtn3.disabled = true;
  }
...
.add({
  begin: function(anim){
    document.querySelector('#svgDiv3 .A circle').classList.add('thick');
    document.querySelector('#svgDiv3 .B circle').classList.add('thick');
    document.querySelector('#svgDiv3 .BA').classList.add('thick');
  }
})
.add({
  targets: '#svgDiv3 .subset.A',
  d: [
    'M 0 34 Q 3 9 21 3 T 52 1 T 73 11 T 78 31 T 67 53 T 39 64 T 11 61 Q 0 53 0 34',
    'M -12 38 Q 8 8 21 3 T 46 4 T 63 21 T 64 44 T 43 61 T 20 115 T -19 150 Q -60 135 -12 38'
  ]
})
.add({
  targets: '#svgDiv3 .subset.B',
  d: [
    'M 0 34 Q 1 18 8 10 T 28 2 T 50 5 T 65 19 T 67 40 T 46 54 T 14 52 Q 0 46 0 34',
    'M 4 34 Q 4 15 11 7 T 26 -9 T 47 -12 T 61 2 T 60 26 T 45 50 T 16 52 Q 5 46 4 34'
  ]
},'-='+dur3)
.add({
  targets: '#svgDiv3 .subset.A',
  begin: function(anim){
    document.querySelector('#svgDiv3 .BA').classList.remove('thick');
    document.querySelector('#svgDiv3 .A circle').classList.remove('thick');
    document.querySelector('#svgDiv3 .B circle').classList.remove('thick');
  },
  complete: function(anim){
    document.querySelector('#svgDiv3 .A circle').classList.add('thick');
    document.querySelector('#svgDiv3 .C circle').classList.add('thick');
    document.querySelector('#svgDiv3 .AC').classList.add('thick');
  }
})
.add({
  duration: 300
...
.add({
  ...
  d: [
    'M -12 38 Q 8 8 21 3 T 46 4 T 63 21 T 64 44 T 43 61 T 20 115 T -19 150 Q -60 135 -12 38',
    'M -12 38 Q 8 8 23 1 T 53 5 T 62 46 T 93 95 T 129 148 T 94 188 T -19 157 Q -61 135 -12 38'
  ]
})
.add({
  targets: '#svgDiv3 .subset.C',
  d: [
    'M 2 22 Q 12 3 30 0 T 62 26 T 27 58 T 2 22',
    'M -47 -4 Q -47 -51 -33 -59 T 35 -8 T 23 55 T -47 -4'
  ]
},'-='+dur3)
.add({
  targets: '#svgDiv3 .subset.D',
  begin: function(anim){
    document.querySelector('#svgDiv3 .AC').classList.remove('thick');
    document.querySelector('#svgDiv3 .A circle').classList.remove('thick');
    document.querySelector('#svgDiv3 .C circle').classList.remove('thick');
  },
  complete: function(anim){
    document.querySelector('#svgDiv3 .C circle').classList.add('thick');
    document.querySelector('#svgDiv3 .D circle').classList.add('thick');
    document.querySelector('#svgDiv3 .CD').classList.add('thick');
  }
})
.add({
  duration: 300
...
.add({
  ...
  d: [
    'M -12 38 Q 8 8 23 1 T 53 5 T 62 46 T 93 95 T 129 148 T 94 188 T -19 157 Q -61 135 -12 38',
    //'M -12 38 Q 4 7 23 1 T 53 5 T 70 58 T 141 56 T 213 67 T 153 166 T -11 164 Q -66 134 -12 38'
    'M -12 38 Q 4 7 23 1 T 53 5 T 82 88 T 134 91 T 201 39 T 181 140 T -11 164 Q -66 134 -12 38'
  ]
})
.add({
  targets: '#svgDiv3 .subset.D',
  d: [
    'M 0 20 Q 0 0 30 0 T 61 23 T 31 52 T 0 20',
    'M -9 56 Q 4 2 26 3 T 43 48 T 8 97 T -9 56'
  ]
},'-='+dur3)
.add({
  targets: '#svgDiv3 .subset.D',
  begin: function(anim){
    document.querySelector('#svgDiv3 .CD').classList.remove('thick');
    document.querySelector('#svgDiv3 .C circle').classList.remove('thick');
    document.querySelector('#svgDiv3 .D circle').classList.remove('thick');
  },
  complete: function(anim){
    document.querySelector('#svgDiv3 .A circle').classList.add('thick');
    document.querySelector('#svgDiv3 .D circle').classList.add('thick');
    document.querySelector('#svgDiv3 .AD').classList.add('thick');
  }
})
.add({
  duration: 300
...
.add({
  targets: '#svgDiv3 .subset.D',
  begin: function(anim){
    document.querySelector('#svgDiv3 .loop').style.opacity = '1';
    document.querySelector('#svgDiv3 p').innerHTML += 'True';
  }
})
.add({
  begin: function(anim){
    traverseBtn3.innerHTML = 'Reset';
    traverseBtn3.disabled = false;
  },
  complete: function(anim){
    tl3.pause();
...
<p>In the animation above, Union-Find cycle detection explores the edges in the Graph. As edges are explored, the subset of vertex A grows to also include vertices B, C, and D. The cycle is detected when the edge between A and D is explored, and it is discovered that both A and D already belong to the same subset.</p>
<p>The edges between D, E, and F also construct a circle, but this circle is not detected because the algorithm stops (returns <code class="w3-codespan">True</code>) when the first circle is detected.</p>
<p>Union-Find cycle detection is only applicable for Graphs that are undirected.</p>
<p>Union-Find cycle detection is implemented using the <a href="dsa_theory_graphs.php#adjMatrix">adjacency matrix representation</a>, so setting up the Graph structure with vertices and edges is basically the same as in previous examples.</p>
<div class="w3-example">
  <h3>Example</h3>
  <p>Python:</p>
  <pre class="language-python notranslate line-numbers w3-white" data-line="6,17-38"><code>class Graph:
    def __init__(self, size):
        self.adj_matrix = [[0] * size for _ in range(size)]
        self.size = size
        self.vertex_data = [''] * size
...
print("Graph has cycle:", g.is_cyclic())
  ...
  <a class="w3-btn w3-margin-bottom" href="trydsa.php?filename=demo_graphs_undirected_cycledetect_unionfind" target="_blank">Try it Yourself &raquo;</a>
</div>
<p><strong>Line 6: </strong>The <code class="w3-codespan">parent</code> array contains the root vertex for every subset. This is used to detect a cycle by checking if two vertices on either side of an edge already belong to the same subset.</p>
<p><strong>Line 17: </strong>The <code class="w3-codespan">find</code> method finds the root of the set that the given vertex belongs to.</p>
<p><strong>Line 22: </strong>The <code class="w3-codespan">union</code> method combines two subsets.</p>
<p><strong>Line 29: </strong>The <code class="w3-codespan">is_cyclic</code> method uses the <code class="w3-codespan">find</code> method to detect a cycle if two vertices <code class="w3-codespan">x</code> and <code class="w3-codespan">y</code> are already in the same subset. If a cycle is not detected, the <code class="w3-codespan">union</code> method is used to combine the subsets.</p>
<hr>

<div>
<h2>DSA Exercises</h2>
<form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_algo_graphs_cycledetection1" method="post" target="_blank">
<h2>Test Yourself With Exercises</h2>
<div class="exercisewindow">
<h2>Exercise:</h2>
<p>What is a cycle in a Graph?</p>
<div class="exerciseprecontainer">
<pre style="overflow: auto;">
A cycle in a Graph is a path 
that starts and ends at the 
same <input name="ex1" maxlength="6" style="width: 7ch;">, where no <input name="ex2" maxlength="5" style="width: 6ch;"> 
are repeated.
</pre>
</div>
<br>
<button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
<p><a target="_blank" href="exercise.php?filename=exercise_algo_graphs_cycledetection1">Start the Exercise</a></p>
</div>
</form>
</div>
<hr>
