...
#hashset > div {
  border: solid rgba(327, 20, 61, 0) 1px;
  position: relative;
  padding-bottom: 1px 0;
  transition: border-color 0.3s ease-in-out;
}
#hashset .currentBucket {
  background-color: #e7e9eb;
  box-shadow: 0 0 4px 1px #e7e9eb;
}.darkpagetheme #hashset .currentBucket {
  
}
#hashset .currentBucket .blockNmbr {
  background-color: black;
  color: white;
}

.darkpagetheme .currentBucket .colonChar {
  color: black;
}
#vueApp input, 
#vueApp button {
...
.name > div {
  ...
  padding: 0 4px;
  margin: 0;
} .darkpagetheme .name > div {
  color: black;
}
.name > div:nth-child(2) {
  border-left: solid gray 2px;
  transition: border-color 0.1s ease-in-out, background-color 0.1s ease-in-out;
} .darkpagetheme .name > div:nth-child(2) {
  border-color: dimgray;
}
...
} .darkpagetheme .activeEl {
  /*background-color: #b58900;
  box-shadow: 0 0 4px 1px rgba(255,255,255,1);*/
}
.list-0-enter-from, .list-1-enter-from, .list-2-enter-from, .list-3-enter-from, .list-4-enter-from, .list-5-enter-from, .list-6-enter-from, .list-7-enter-from, .list-8-enter-from, .list-9-enter-from {
  opacity: 0;
  translate: 300px 0;
}
.list-0-enter-to, .list-1-enter-to, .list-2-enter-to, .list-3-enter-to, .list-4-enter-to, .list-5-enter-to, .list-6-enter-to, .list-7-enter-to, .list-8-enter-to, .list-9-enter-to {
  opacity: 1;
  translate: 0 0;
}
.list-0-enter-active, .list-1-enter-active, .list-2-enter-active, .list-3-enter-active, .list-4-enter-active, .list-5-enter-active, .list-6-enter-active, .list-7-enter-active, .list-8-enter-active, .list-9-enter-active,
.list-0-leave-active, .list-1-leave-active, .list-2-leave-active, .list-3-leave-active, .list-4-leave-active, .list-5-leave-active, .list-6-leave-active, .list-7-leave-active, .list-8-leave-active, .list-9-leave-active,
.list-0-move, .list-1-move, .list-2-move, .list-3-move, .list-4-move, .list-5-move, .list-6-move, .list-7-move, .list-8-move, .list-9-move {
  transition: all 0.5s ease;
}
.list-0-leave-active, .list-1-leave-active, .list-2-leave-active, .list-3-leave-active, .list-4-leave-active, .list-5-leave-active, .list-6-leave-active, .list-7-leave-active, .list-8-leave-active, .list-9-leave-active { 
  position: absolute;
}
.list-0-leave-from, .list-1-leave-from, .list-2-leave-from, .list-3-leave-from, .list-4-leave-from, .list-5-leave-from, .list-6-leave-from, .list-7-leave-from, .list-8-leave-from, .list-9-leave-from { 
  opacity: 1; 
  translate: 0 0;
}
.list-0-leave-to, .list-1-leave-to, .list-2-leave-to, .list-3-leave-to, .list-4-leave-to, .list-5-leave-to, .list-6-leave-to, .list-7-leave-to, .list-8-leave-to, .list-9-leave-to { 
  opacity: 0; 
  translate: 300px 0;
}
.green-border {
  /*border: 1px solid lightgreen;*/
  box-shadow: 0 0 4px 2px #04AA6D;
}
.ssnText {
  font-family: Consolas, Menlo, "courier new", monospace;
  font-size: smaller;
...
ny:-->
    ...
    <h1>DSA <span class="color_h1">Hash Maps</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="dsa_data_hashsets.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="dsa_theory_trees.php">Next &#10095;</a>
</div>
<hr>

<h2>Hash Maps</h2>
<p>A Hash Map is a form of <a href="dsa_theory_hashtables.php">Hash Table</a> data structure that usually holds a large number of entries.</p>
<p>Using a Hash Map we can search, add, modify, and remove entries really fast.</p>
<p>Hash Maps are used to find detailed information about something.</p>
<p>In the simulation below, people are stored in a Hash Map. A person can be looked up using a person's unique social security number (the Hash Map key), and then we can see that person's name (the Hash Map value).</p>
<div id="vueApp">

  <!-- Buckets animated independently to make animation of removing names work properly -->
  <div id="hashset">
    <p style="font-weight: bold;">Hash Map</p>
    <div>
      <div style="display: inline-block; padding: 2px; margin: 1px;"><span class="blockNmbr">0</span><span class="colonChar">:</span></div>
      <transition-group name="list-0">
        <div v-for="el in hashSet[0]" :key="el.ssn" :class="{'name': true, 'activeEl': el.active }">
          <div class="ssnText">{{ el.ssn }}</div>
          <div>{{ el.name }}</div>
        </div>
      </transition-group>
    </div>
    <div>
      <div style="display: inline-block; padding: 2px; margin: 1px;"><span class="blockNmbr">1</span><span class="colonChar">:</span></div>
      <transition-group name="list-1">
        <div v-for="el in hashSet[1]" :key="el.ssn" :class="{'name': true, 'activeEl': el.active}">
          <div class="ssnText">{{ el.ssn }}</div>
          <div>{{ el.name }}</div>
        </div>
      </transition-group>
    ...
    <div>
      <div style="display: inline-block; padding: 2px; margin: 1px;"><span class="blockNmbr">2</span><span class="colonChar">:</span></div>
      <transition-group name="list-2">
        <div v-for="el in hashSet[2]" :key="el.ssn" :class="{'name': true, 'activeEl': el.active}">
          <div class="ssnText">{{ el.ssn }}</div>
          <div>{{ el.name }}</div>
        </div>
      </transition-group>
    ...
    <div>
      <div style="display: inline-block; padding: 2px; margin: 1px;"><span class="blockNmbr">3</span><span class="colonChar">:</span></div>
      <transition-group name="list-3">
        <div v-for="el in hashSet[3]" :key="el.ssn" :class="{'name': true, 'activeEl': el.active}">
          <div class="ssnText">{{ el.ssn }}</div>
          <div>{{ el.name }}</div>
        </div>
      </transition-group>
    ...
    <div>
      <div style="display: inline-block; padding: 2px; margin: 1px;"><span class="blockNmbr">4</span><span class="colonChar">:</span></div>
      <transition-group name="list-4">
        <div v-for="el in hashSet[4]" :key="el.ssn" :class="{'name': true, 'activeEl': el.active}">
          <div class="ssnText">{{ el.ssn }}</div>
          <div>{{ el.name }}</div>
        </div>
      </transition-group>
    ...
    <div>
      <div style="display: inline-block; padding: 2px; margin: 1px;"><span class="blockNmbr">5</span><span class="colonChar">:</span></div>
      <transition-group name="list-5">
        <div v-for="el in hashSet[5]" :key="el.ssn" :class="{'name': true, 'activeEl': el.active}">
          <div class="ssnText">{{ el.ssn }}</div>
          <div>{{ el.name }}</div>
        </div>
      </transition-group>
    ...
    <div>
      <div style="display: inline-block; padding: 2px; margin: 1px;"><span class="blockNmbr">6</span><span class="colonChar">:</span></div>
      <transition-group name="list-6">
        <div v-for="el in hashSet[6]" :key="el.ssn" :class="{'name': true, 'activeEl': el.active}">
          <div class="ssnText">{{ el.ssn }}</div>
          <div>{{ el.name }}</div>
        </div>
      </transition-group>
    ...
    <div>
      <div style="display: inline-block; padding: 2px; margin: 1px;"><span class="blockNmbr">7</span><span class="colonChar">:</span></div>
      <transition-group name="list-7">
        <div v-for="el in hashSet[7]" :key="el.ssn" :class="{'name': true, 'activeEl': el.active}">
          <div class="ssnText">{{ el.ssn }}</div>
          <div>{{ el.name }}</div>
        </div>
      </transition-group>
    ...
    <div>
      <div style="display: inline-block; padding: 2px; margin: 1px;"><span class="blockNmbr">8</span><span class="colonChar">:</span></div>
      <transition-group name="list-8">
        <div v-for="el in hashSet[8]" :key="el.ssn" :class="{'name': true, 'activeEl': el.active}">
          <div class="ssnText">{{ el.ssn }}</div>
          <div>{{ el.name }}</div>
        </div>
      </transition-group>
    ...
    <div>
      <div style="display: inline-block; padding: 2px; margin: 1px;"><span class="blockNmbr">9</span><span class="colonChar">:</span></div>
      <transition-group name="list-9">
        <div v-for="el in hashSet[9]" :key="el.ssn" :class="{'name': true, 'activeEl': el.active}">
          <div class="ssnText">{{ el.ssn }}</div>
          <div>{{ el.name }}</div>
        </div>
      </transition-group>
...
<!-- <p class="adtext">Advertisement</p> -->
  ...
  <p style="font-weight: bold;">Hash Code</p>
  <p>{{ sumOfAscii }} % 10 = <span class="hashcode">{{ currHashCode }}</span></p>
  <hr>

  <p>{{ resultText }}<span style="opacity: 0;">0</span></p>
  <input type="text" size="3" v-model="inpSSNpart1" ref="inputRef0" :class="{'green-border': ssnValid}" placeholder="XXX" maxlength="3" :disabled="globalDisable">-<input type="text" size="4" v-model="inpSSNpart2" ref="inputRef1" :class="{'green-border': ssnValid}" placeholder="XXXX" maxlength="4" :disabled="globalDisable">
  <input type="text" size="15" v-model="inpName" ref="inputRef" placeholder="Name" :disabled="globalDisable"><br>
  <button @click="addOrUpdateEntry" :disabled="disabledPut" title="Add or modify an entry">put()</button>
  <button @click="remove()" :disabled="disabledRemove" title="Remove an entry">remove()</button>
  <button @click="contains()" :disabled="disabledContains" title="Get entry information">get()</button>
  <button @click="hashSetSize()" title="Check the number of entries" :disabled="globalDisable">size()</button>
</div>
<script>
const app = Vue.createApp({
  data() {
    return {
      ...
      inpName: '',
      sumOfAscii: 0,
      hashSet: Array.from({ length: 10 }, () => []), // Initialize a hash set with 10 buckets
      resultText: 'Try interacting with the Hash Map'
    }
  },
  watch: {
    combinedSSN(newVal) {
      // First, clear all active states.
      this.hashSet.forEach(bucket => bucket.forEach(entry => { entry.active = false; }));

      if (this.inpSSNpart1.length === 3 && this.inpSSNpart2.length === 4) {
        const hashCode = this.currHashCode;
        const bucket = this.hashSet[hashCode];

        const entry = bucket.find(entry => entry.ssn === newVal);
        if (entry) {
          entry.active = true;
        }
      }
    },
    inpSSNpart1(newValue) {
      // Allow only digits by removing non-digit characters
      const sanitized = newValue.replace(/\D/g, '');
      if (sanitized !== newValue) {
        this.inpSSNpart1 = sanitized;
      }
    },
    inpSSNpart2(newValue) {
      // Allow only digits by removing non-digit characters
      const sanitized = newValue.replace(/\D/g, '');
      if (sanitized !== newValue) {
        this.inpSSNpart2 = sanitized;
      }
    },
  },
  computed: {
    disabledPut() {
      return this.globalDisable || !(this.ssnValid && this.inpName !== '');
    },
    disabledRemove() {
      return this.globalDisable || !this.ssnValid;
    },
    disabledContains() {
      return this.globalDisable || !this.ssnValid;
    },
    combinedSSN() {
      return `${this.inpSSNpart1}-${this.inpSSNpart2}`;
    },
    ssnValid() {
      // Simple validation for demonstration purposes
      let valid = this.inpSSNpart1.length === 3 && this.inpSSNpart2.length === 4;
      return valid;
    },
    currHashCode() {
      let hashCode = 0;
      ...
      if (this.combinedSSN !== '') {
        // Combine inpSSNpart1 and inpSSNpart2, remove non-numeric characters, then generate hashCode
        const sanitizedSSN = this.combinedSSN.replace(/\D/g, '');

        const sum = sanitizedSSN.split('').reduce((acc, digit) => acc + parseInt(digit, 10), 0);
        this.sumOfAscii = sum;

        // Perform modulo 10 on the integer value of the SSN
        hashCode = sum % 10;

        // Update UI elements
        let bucketDivs = document.querySelectorAll('#hashset > div');
        bucketDivs.forEach(div => div.classList.remove('currentBucket'));
        if(sanitizedSSN.length > 0) {
          bucketDivs[hashCode].classList.add('currentBucket');
        }
      }
    ...
    ssnExists() {
      // Assuming inpSSN is your model for the SSN input field
      const hashCode = this.currHashCode; // Use the current hash code logic to determine the bucket
      const bucket = this.hashSet[hashCode];
      return bucket.some(entry => entry.ssn === this.combinedSSN); // Check if SSN exists
    }
  },
  methods: {
    isActiveName(name) {
      return this.inpName === name;
    },
    addOrUpdateEntry() {
      if (this.ssnExists) {
        this.modifyEntry(); // Call a method that updates the entry with the new information
      } else {
        this.add(); // Call your existing method to add a new entry
      }
    },
    async modifyEntry() {
      // Implement logic to update an entry's information based on SSN
      const hashCode = this.currHashCode;
      const bucket = this.hashSet[hashCode];
      let nameVal = this.inpName;
      let ssnVal = this.combinedSSN;
      this.resultText = "";
      const entryIndex = bucket.findIndex(entry => entry.ssn === this.combinedSSN);
      if (entryIndex !== -1) {
        bucket[entryIndex].name = this.inpName; 
        this.resultText = "Updated name: ";
        this.globalDisable = true;
        await new Promise(resolve => setTimeout(resolve, 500));
        this.globalDisable = false;
        this.resultText += ssnVal+', ';
        this.resultText += nameVal;
        this.inpName = '';
        this.inpSSNpart1 = '';
        this.inpSSNpart2 = '';
      }
    ...
    async add() {
      if(this.ssnValid && this.inpName !== '') {
        let nameVal = this.inpName;
        let ssnVal = this.combinedSSN;
        this.resultText = "";
        const hashCode = this.currHashCode; // Use the computed property
        const bucket = this.hashSet[hashCode];
        // Check if the bucket already contains an object with the name property equal to nameVal
        const isContained = bucket.some(nameObj => nameObj.name === nameVal);
        if (!isContained) {
          // Push an object with the name and initially set active to false
          bucket.push({ssn: ssnVal, name: nameVal, active: true});
          this.resultText = "Added: ";
          this.globalDisable = true;
          await new Promise(resolve => setTimeout(resolve, 500));
          this.globalDisable = false;
          this.resultText += ssnVal+', ';
          ...
          this.resultText = "Already in the hash map: ";
          this.hashSet.forEach(bucket => {
            bucket.forEach(nameObj => {
              if(nameObj.name === this.inpName){
    ...
    async remove() {
      if(this.ssnValid){
        const hashCode = this.currHashCode; // Use the computed property
        const bucket = this.hashSet[hashCode];
        // Find the index based on object name property
        const index = bucket.findIndex(nameObj => nameObj.ssn === this.combinedSSN);
        this.resultText = '';
        if (index > -1) {
          let removed = bucket.splice(index, 1)[0]; // Remove the object at the found index
          this.resultText = "Removed: ";
          this.globalDisable = true;
          await new Promise(resolve => setTimeout(resolve, 500));
          this.globalDisable = false;
          this.resultText += this.combinedSSN + ', ';
          this.resultText += removed.name;
          this.inpName = '';
          this.inpSSNpart1 = '';
          this.inpSSNpart2 = '';
        } else {
          this.resultText = "Not found in the hash set: ";
          this.globalDisable = true;
          await new Promise(resolve => setTimeout(resolve, 500));
          this.globalDisable = false;
          this.resultText += this.combinedSSN;
    ...
    async contains() {
      if(this.ssnValid){
        const hashCode = this.currHashCode; // Use the computed property
        const bucket = this.hashSet[hashCode];
        // Check if any object in the bucket has a name property matching the inpName
        const contains = bucket.some(nameObj => nameObj.ssn === this.combinedSSN);
        if(contains){
          this.resultText = '';
          this.hashSet.forEach(bucket => {
            bucket.forEach(nameObj => {
              if(nameObj.ssn === this.combinedSSN){
                nameObj.active = false;
              }
            });
          });
          ...
          this.hashSet.forEach(bucket => {
            bucket.forEach(nameObj => {
              if(nameObj.ssn === this.combinedSSN){
                nameObj.active = true;
                this.resultText = "SSN: "+this.combinedSSN+", Name: "+nameObj.name;
              }
            });
          });
        }
          ...
          await new Promise(resolve => setTimeout(resolve, 500));
          this.globalDisable = false;
          this.resultText = 'No entry with '+this.combinedSSN + ' as key.';
        }
      }
      else {
        this.$refs.inputRef0.focus();
    ...
    async hashSetSize() {
      ...
      const totalSize = this.hashSet.reduce((total, bucket) => total + bucket.length, 0);
      this.resultText = 'Size: '+totalSize;
    },
    addElements() {
      this.hashSet = [
        [{ ssn: '123-4569', name: 'Jens', active: false }],
        [],
        [{ ssn: '123-4570', name: 'Peter', active: false }],
        [{ ssn: '123-4571', name: 'Lisa', active: false }],
        [],
        [{ ssn: '123-4672', name: 'Adele', active: false },{ ssn: '123-4573', name: 'Michaela', active: false }],
        [],
        [],
        [{ ssn: '123-4567', name: 'Charlotte', active: false },{ ssn: '123-6574', name: 'Bob', active: false }],
        [{ ssn: '123-4568', name: 'Thomas', active: false }]
      ];
    },
    createObserver() {
      const observer = new IntersectionObserver((entries, observer) => {
        entries.forEach(entry => {
          if (entry.isIntersecting) {
            // The target element has come into view
            entry.target.focus();
            observer.unobserve(entry.target); // Optionally stop observing after focusing
          }
        });
      }, {
        root: null, // observes the element in the context of the viewport
        threshold: 0.1, // callback will be executed when at least 10% of the target is visible
      });

      const inputEl = this.$refs.inputRef0;
      if (inputEl) {
...
<div class="ws-note">
  <p><strong>Note: </strong>The Hash Map would be more useful if more information about each person was attached to the corresponding social security number, like last name, birth date, and address, and maybe other things as well. But the Hash Map simulation above is made to be as simple as possible.</p>
</div>
<p>It is easier to understand how Hash Maps work if you first have a look at the two previous pages about <a href="dsa_theory_hashtables.php">Hash Tables</a> and <a href="dsa_data_hashsets.php">Hash Sets</a>. It is also important to understand the meaning of the words below.</p>
<ul>
  <li><strong>Entry: </strong>Consists of a key and a value, forming a key-value pair.</li>
  <li><strong>Key: </strong>Unique for each entry in the Hash Map. Used to generate a hash code determining the entry's bucket in the Hash Map. This ensures that every entry can be efficiently located.</li>
  <li><strong>Hash Code: </strong>A number generated from an entry's key, to determine what bucket that Hash Map entry belongs to.</li>
  <li><strong>Bucket: </strong>A Hash Map consists of many such buckets, or containers, to store entries.</li>
  <li><strong>Value: </strong>Can be nearly any kind of information, like name, birth date, and address of a person. The value can be many different kinds of information combined.</li>
</ul>
<hr>

<h2>Finding The Hash Code</h2>
<p>A hash code is generated by a <strong>hash function</strong>.</p>
<p>The hash function in the simulation above takes the numbers in the social security number (not the dash), add them together, and does a modulo 10 operation (<code class="w3-codespan">% 10</code>) on the sum of characters to get the hash code as a number from 0 to 9.</p>
<p>This means that a person is stored in one of ten possible buckets in the Hash Map, according to the hash code of that person's social security number. The same hash code is generated and used when we want to search for or remove a person from the Hash Map.</p>
<p>The Hash Code gives us instant access as long as there is just one person in the corresponding bucket.</p>
<p>In the simulation above, <code class="w3-codespan">Charlotte</code> has social security number <code class="w3-codespan">123-4567</code>. Adding the numbers together gives us a sum <code class="w3-codespan">28</code>, and modulo 10 of that is <code class="w3-codespan">8</code>. That is why she belongs to bucket <code class="w3-codespan">8</code>.</p>
<div class="ws-note">
  <p><strong>Modulo: </strong>A mathematical operation, written as <code class="w3-codespan">%</code> in most programming languages (or \(mod\) in mathematics). A modulo operation divides a number with another number, and gives us the resulting remainder. So for example, <code class="w3-codespan">7 % 3</code> will give us the remainder <code class="w3-codespan">1</code>. (Dividing 7 apples between 3 people, means that each person gets 2 apples, with 1 apple to spare.)</p>
</div>
<hr>

<h2>Direct Access in Hash Maps</h2>
<p>Searching for <code class="w3-codespan">Charlotte</code> in the Hash Map, we must use the social security number <code class="w3-codespan">123-4567</code> (the Hash Map key), which generates the hash code <code class="w3-codespan">8</code>, as explained above.</p>
<p>This means we can go straight to bucket <code class="w3-codespan">8</code> to get her name (the Hash Map value), without searching through other entries in the Hash Map.</p>
<p>In cases like this we say that the Hash Map has constant time \(O(1)\) for searching, adding, and removing entries, which is really fast compared to using an array or a linked list.</p>
<p>But, in a worst case scenario, all the people are stored in the same bucket, and if the person we are trying to find is last person in this bucket, we need to compare with all the other social security numbers in that bucket before we find the person we are looking for.</p>
<p>In such a worst case scenario the Hash Map has time complexity \(O(n)\), which is the same time complexity as arrays and linked lists.</p>
<p>To keep Hash Maps fast, it is therefore important to have a hash function that will distribute the entries evenly between the buckets, and to have around as many buckets as Hash Map entries.</p>
<p>Having a lot more buckets than Hash Map entries is a waste of memory, and having a lot less buckets than Hash Map entries is a waste of time.</p>
<div class="ws-note">
  <p><strong>Note: </strong>A social security number can be really long, like 11 digits, which means it is possible to store 100 billion people with unique social security numbers. This is a lot more than in any country's population, and even a lot more than there are people on Earth.</p>
  <p>Using an array where each person's social security number is the index in the array where this person is stored is therefore a huge waste of space (mostly empty buckets).</p>
  <p>Using a Hash Map (or a database with similar properties) makes more sense as the number of buckets can be adjusted to the number of people.</p>
</div>
<hr>

<h2>Hash Map Implementation</h2>
<p>Hash Maps in Python are typically done by using Python's own <a href="python/python_dictionaries.asp"><code class="w3-codespan">dictionary</code> data type</a>, but to get a better understanding of how Hash Maps work we will not use that here.</p>
<p>To implement a Hash Map in Python we create a class <code class="w3-codespan">SimpleHashMap</code>.</p>
<p>Inside the <code class="w3-codespan">SimpleHashMap</code> class we have a method <code class="w3-codespan">__init__</code> to initialize the Hash Map, a method <code class="w3-codespan">hash_function</code> for the hash function, and methods for the basic Hash Map operations: <code class="w3-codespan">put</code>, <code class="w3-codespan">get</code>, and <code class="w3-codespan">remove</code>.</p>
<p>We also create a method <code class="w3-codespan">print_map</code> to better see how the Hash Map looks like.</p>
<div class="w3-example">
  <h3>Example</h3>
  <pre class="language-python notranslate w3-white line-numbers"><code>class SimpleHashMap:
    ...
    def print_map(self):
        ...
        for index, bucket in enumerate(self.buckets):
            print(f"Bucket {index}: {bucket}")</code></pre>
</div>
<p>Using the <code class="w3-codespan">SimpleHashMap</code> class we can create the same Hash Map as in the top of this page:</p>
<div class="w3-example">
  <h3>Example</h3>
  <pre class="language-python notranslate w3-white line-numbers" id="codeBlock" style="height: 38em; overflow-y: scroll;"><code>class SimpleHashMap:
    def __init__(self, size=100):
        self.size = size
        self.buckets = [[] for _ in range(size)]  # A list of buckets, each is a list (to handle collisions)
...
print("Name associated with '123-4570':", hash_map.get("123-4570"))</code></pre>
  <a class="w3-btn w3-margin-bottom" href="trydsa.php?filename=demo_hashmap" target="_blank">Try it Yourself &raquo;</a>
</div>
<script>
