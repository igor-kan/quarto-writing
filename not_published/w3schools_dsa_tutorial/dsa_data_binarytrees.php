...
#divAnim, #divAnim2, #divAnim3, #divAnim4, #divAnim5 {
  border: solid black 1px;
  display: inline-block;
  padding: 10px;
}
#divAnim3 svg, #divAnim4 svg, #divAnim5 svg, .svgAnim {
  width: 292px;
  max-width: 100%;
  height: auto;
}
#divAnim3 button, #divAnim4 button, #divAnim5 button {
  display: block;
  margin: auto;
}
#divAnim3 p, #divAnim4 p, #divAnim5 p {
...
#divAnim3 circle, #divAnim4 circle, #divAnim5 circle {
  transition: all 0.2s;
}
.svgDataText{
...
ny:-->
    ...
    <h1>DSA <span class="color_h1">Binary Trees</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="dsa_theory_trees.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="dsa_algo_binarytrees_preorder.php">Next &#10095;</a>
</div>
...
<p>This restriction, that a node can have a maximum of two child nodes, gives us many benefits:</p>
<ul>
  <li>Algorithms like traversing, searching, insertion and deletion become easier to understand, to implement, and run faster.</li>
  <li>Keeping data sorted in a Binary Search Tree (BST) makes searching very efficient.</li>
  <li>Balancing trees is easier to do with a limited number of child nodes, using an AVL Binary Tree for example.</li>
  <li>Binary Trees can be represented as arrays, making the tree more memory efficient.</li>
</ul>
<p>Use the animation below to see how a Binary Tree looks, and what words we use to describe it.</p>
<div id="divAnim">
  <div id="wrapper">
    <div id="menu">
    <p><label><input type="radio" value="all" name="rbgTree" checked onchange="showTree(this.value)">The Binary Tree</label></p>
    <p><label><input type="radio" value="root" name="rbgTree" onchange="showTree(this.value)">Root node</label></p>
    <p><label><input type="radio" value="aLeft" name="rbgTree" onchange="showTree(this.value)">A's left child</label></p>
    <p><label><input type="radio" value="aRight" name="rbgTree" onchange="showTree(this.value)">A's right child</label></p>
    <p><label><input type="radio" value="bSubtree" name="rbgTree" onchange="showTree(this.value)">B's subtree</label></p>
    <p><label><input type="radio" value="nodes" name="rbgTree" onchange="showTree(this.value)">Tree size (n=8)</label></p>
    <p><label><input type="radio" value="height" name="rbgTree" onchange="showTree(this.value)">Tree height (h=3)</label></p>
    ...
    <div id="svgDiv"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 350 320" class="svgAnim">
  <!-- 'R' node -->
  <g class="root parent">
    ...
    <line x1="185" y1="45" x2="250" y2="100" class="branch height" marker-end="url(#arrowhead)" />
  </g>

  <!-- Leaf -->
  <image x="-14" y="162" width="95" height="95" xlink:href="img_leaf.svg" class="leaf" transform="rotate(25 40 210)" opacity="0"></image>
  <!-- Leaf -->
  <image x="60" y="150" width="80" height="80" xlink:href="img_leaf.svg" class="leaf" opacity="0"></image>
  <!-- 'A' node -->
  ...
  <!-- 'B' node -->
  <g class="parent child bSubtree">
    <circle cx="271" cy="120" r="20" class="node" />
    <text x="265" y="126" class="svgDataText">B</text>
    <line x1="261" y1="138" x2="241" y2="180" class="branch" marker-end="url(#arrowhead)" />
    <line x1="281" y1="138" x2="301" y2="180" class="branch height" marker-end="url(#arrowhead)" />
  </g>

  <!-- 'C' node -->
  <g class="child leaf" id="aLeft">
    <circle cx="41" cy="207" r="20" class="node" />
    <text x="35" y="213" class="svgDataText" >C</text>
  </g>
  ...
  <!-- 'E' node -->
<g class="child leaf bSubtree">
  <circle cx="232" cy="207" r="20" class="node" />
  <text x="226" y="213" class="svgDataText" >E</text>
</g>

<!-- 'F' node -->
<g class="child parent leaf bSubtree">
  <circle cx="312" cy="207" r="20" class="node" />
  <text x="306" y="213" class="svgDataText">F</text>
  <line x1="302" y1="225" x2="282" y2="267" class="branch height" marker-end="url(#arrowhead)" />
</g>

<!-- 'G' node -->
<g class="child leaf bSubtree">
  <circle cx="271" cy="293" r="20" class="node" />
  <text x="265" y="299" class="svgDataText">G</text>
</g>
</svg></div>
  </div>
</div>
...
<script>
  ...
  let bSubtree = document.querySelectorAll('#divAnim .bSubtree circle, #divAnim .bSubtree text, #divAnim .bSubtree line');
  ...
  let height = document.querySelectorAll('#divAnim .height');
  ...
  function dimMany(dim,what){
    ...
    if(what==='all') {
    ...
    else if(what==='bSubtree'){
      for(let i=0; i<bSubtree.length; i++){
        bSubtree[i].style.opacity=thisOpacity;
      }
    }
    else if(what==='leaves'){
      ...
      for(let i=0; i<height.length; i++){
        height[i].style.opacity=thisOpacity;
      }
    }
...
<p>A <strong>parent</strong> node, or <strong>internal</strong> node, in a Binary Tree is a node with one or two <strong>child</strong> nodes.</p>
<p>The <strong>left child node</strong> is the child node to the left.</p>
<p>The <strong>right child node</strong> is the child node to the right.</p>
<p>The <strong>tree height</strong> is the maximum number of edges from the root node to a leaf node.</p>
...
<h2>Binary Trees vs Arrays and Linked Lists</h2>
<p>Benefits of Binary Trees over Arrays and Linked Lists:</p>
<ul>
  ...
  <li><strong>Binary Trees</strong>, such as Binary Search Trees and AVL Trees, are great compared to Arrays and Linked Lists because they are BOTH fast at accessing a node, AND fast when it comes to deleting or inserting a node, with no shifts in memory needed.</li>
</ul>
<p>We will take a closer look at how Binary Search Trees (BSTs) and AVL Trees work on the next two pages, but first let's look at how a Binary Tree can be implemented, and how it can be traversed.</p>
<hr>

<h2>Types of Binary Trees</h2>
<p>There are different variants, or types, of Binary Trees worth discussing to get a better understanding of how Binary Trees can be structured.</p>
<p>The different kinds of Binary Trees are also worth mentioning now as these words and concepts will be used later in the tutorial.</p>
<p>Below are short explanations of different types of Binary Tree structures, and below the explanations are drawings of these kinds of structures to make it as easy to understand as possible.</p>
<p>A <strong>balanced</strong> Binary Tree has at most 1 in difference between its left and right subtree heights, for each node in the tree.</p>
<p>A <strong>complete</strong> Binary Tree has all levels full of nodes, except the last level, which is can also be full, or filled from left to right. The properties of a complete Binary Tree means it is also balanced.</p>
<p>A <strong>full</strong> Binary Tree is a kind of tree where each node has either 0 or 2 child nodes.</p>
<p>A <strong>perfect</strong> Binary Tree has all leaf nodes on the same level, which means that all levels are full of nodes, and all internal nodes have two child nodes.The properties of a perfect Binary Tree means it is also full, balanced, and complete.</p>
<div class="figureWrap">
  <figure>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 360 320" class="dsa_svg">
    <style>
      .figureWrap {
        display: flex;
        flex-wrap: wrap;
  ...
  <g class="root parent">
    ...
    <text x="159" y="37" class="svgDataText">11</text>
  ...
  <g class="child leaf" id="aRight">
    ...
    <text x="115" y="213" class="svgDataText">9</text>
  </g>

  <!-- 'E' node -->
<g class="child leaf">
  <circle cx="232" cy="207" r="20" class="node subtree15 successor13"></circle>
  <text x="221" y="213" class="svgDataText subtree15 successor13">13</text>
</g>
...
<g class="child leaf">
  ...
  <g class="parent child">
    ...
    <text x="74" y="126" class="svgDataText">7</text>
    <line x1="70" y1="138" x2="50" y2="180" class="branch" marker-end="url(#arrowhead)"></line>
    <line x1="92" y1="136" x2="145" y2="185" class="branch" marker-end="url(#arrowhead)"></line>
  </g>
  <!-- 'B' node -->
  <g class="parent child">
    <circle cx="271" cy="120" r="20" class="node subtree15"></circle>
    <text x="260" y="126" class="svgDataText subtree15">15</text>
    <line x1="261" y1="138" x2="241" y2="180" class="branch subtree15" marker-end="url(#arrowhead)"></line>
    <line x1="281" y1="138" x2="301" y2="182" class="branch height13 height15 subtree15" marker-end="url(#arrowhead)"></line>
  </g>
  ...
  <!-- 'D' node -->
  <g class="child leaf" id="aRight" transform="translate(43 0)">
    <circle cx="121" cy="207" r="20" class="node"></circle>
    <text x="115" y="213" class="svgDataText">9</text>
  </g>
...
<!-- 'G' node -->
<g class="child leaf" transform="translate(-251 0)">
  <line x1="307" y1="227" x2="292" y2="267" class="branch height13 height15 subtree15" marker-end="url(#arrowhead)"></line>
  <circle cx="279" cy="293" r="20" class="node subtree15"></circle>
  <text x="274" y="299" class="svgDataText subtree15">2</text>
  <line x1="317" y1="227" x2="332" y2="267" class="branch height13 height15 subtree15" marker-end="url(#arrowhead)"></line>
  <circle cx="344" cy="293" r="20" class="node subtree15"></circle>
  <text x="339" y="299" class="svgDataText subtree15">4</text>
</g>

<g transform="translate(-130 0)">
<line x1="307" y1="227" x2="292" y2="267" class="branch height13 height15 subtree15" marker-end="url(#arrowhead)"></line>
  <circle cx="279" cy="293" r="20" class="node subtree15"></circle>
  <text x="274" y="299" class="svgDataText subtree15">8</text>
</g>
</svg>
    <figcaption>Complete and balanced</figcaption>
  </figure>
...
<g class="child leaf" transform="translate(-60 0)">
  <line x1="307" y1="227" x2="292" y2="267" class="branch height13 height15 subtree15" marker-end="url(#arrowhead)"></line>
  <circle cx="279" cy="293" r="20" class="node subtree15"></circle>
  <text x="268" y="299" class="svgDataText subtree15">12</text>
  <line x1="317" y1="227" x2="324" y2="264" class="branch height13 height15 subtree15" marker-end="url(#arrowhead)"></line>
  <circle cx="328" cy="293" r="20" class="node subtree15"></circle>
  <text x="317" y="299" class="svgDataText subtree15">14</text>
</g>
</svg>
  ...
  <figure>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 360 240" class="dsa_svg">
    <g transform="translate(20 0)">
  <!-- 'R' node -->
  <g class="root parent">
    <circle cx="170" cy="30" r="20" class="node"></circle>
...
<g class="child parent" transform="translate(-190 0)">
  <line x1="281" y1="138" x2="301" y2="182" class="branch height13 height15 subtree15" marker-end="url(#arrowhead)"></line>
  <circle cx="312" cy="207" r="20" class="node subtree15"></circle>
  <text x="307" y="213" class="svgDataText subtree15">9</text>
</g>
</g>

</svg>
    <figcaption>Perfect, full, balanced and complete</figcaption>
  </figure>
</div>
<hr>

<h2>Binary Tree Implementation</h2>
<p>Let's implement this Binary Tree:</p>
<svg xmlns="http://www.w3.org/2000/svg" width="350" height="320" viewBox="0 0 350 320" class="svgAnim">
...
<p>The Binary Tree above can be implemented much like we implemented a <a href="dsa_data_linkedlists_types.php#singlyImpl">Singly Linked List</a>, except that instead of linking each node to one next node, we create a structure where each node can be linked to both its left and right child nodes.</p>
<p>This is how a Binary Tree can be implemented:</p>
...
# Test
print("root.right.left.data:", root.right.left.data)</code></pre>
  <a class="w3-btn w3-margin-bottom" href="trydsa.php?filename=demo_binarytree" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>

<a id="traversal"></a>
<h2>Binary Tree Traversal</h2>
<p>Going through a Tree by visiting every node, one node at a time, is called traversal.</p>
<p>Since Arrays and Linked Lists are linear data structures, there is only one obvious way to traverse these: start at the first element, or node, and continue to visit the next until you have visited them all.</p>
<p>But since a Tree can branch out in different directions (non-linear), there are different ways of traversing Trees.</p>
<p>There are two main categories of Tree traversal methods:</p>
<p><strong>Breadth First Search (BFS)</strong> is when the nodes on the same level are visited before going to the next level in the tree. This means that the tree is explored in a more sideways direction.</p>
<p><strong>Depth First Search (DFS)</strong> is when the traversal moves down the tree all the way to the leaf nodes, exploring the tree branch by branch in a downwards direction.</p>
<p>There are three different types of DFS traversals:</p>
<ul>
  <li><a href="dsa_algo_binarytrees_preorder.php">pre-order</a></li>
  <li><a href="dsa_algo_binarytrees_inorder.php">in-order</a></li>
  <li><a href="dsa_algo_binarytrees_postorder.php">post-order</a></li>
</ul>
<p>These three Depth First Search traversals are described in detail on the next pages.</p>
<hr>

<div>
<h2>DSA Exercises</h2>
<form autocomplete="off" spellcheck="false" id="w3-exerciseform" action="exercise.php?filename=exercise_data_binarytrees1" method="post" target="_blank">
<h2>Test Yourself With Exercises</h2>
<div class="exercisewindow">
<h2>Exercise:</h2>
<p>In a Binary Tree data structure, like the one below:</p>
<img style="width: 100%; max-width: 300px;" src="img_exercises_trees.png" alt="A tree data structure">
<p>What is the relationship between node B and nodes E and F?</p>
<div class="exerciseprecontainer">
<pre style="overflow: auto;">
Node E is B's <input name="ex1" maxlength="5" style="width: 6ch;"> child node, 
and node F is B's <input name="ex2" maxlength="5" style="width: 6ch;"> child node.
</pre>
</div>
<br>
<button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
<p><a target="_blank" href="exercise.php?filename=exercise_data_binarytrees1">Start the Exercise</a></p>
</div>
</form>
</div>
<hr>
