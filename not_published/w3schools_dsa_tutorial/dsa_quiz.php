...
ny:-->
    ...
    <h1>DSA <span class="color_h1">Quiz</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="dsa_exercises.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="dsa_syllabus.php">Next &#10095;</a>
</div>
<hr>
<p class="intro">You can test your skills in Data Structures and Algorithms with W3Schools' Quiz.</p>
<hr>
<h2>The Test</h2>
...
<p>Good luck!</p>
<p><a href='/quiztest/quiztest.php?qtest=DSA' class="w3-btn w3-blue w3-round" style="margin-top:10px;padding:17px;font-size:17px">Start the DSA Quiz &#10095;</a></p>
</div>
<div class="ws-note w3-panel">
  <p>If you do not know DSA, we suggest that you read our <a href="index.php">DSA Tutorial</a> from scratch.</p>
</div>
<hr>
