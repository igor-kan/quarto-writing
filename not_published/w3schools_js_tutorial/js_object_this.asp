...
<html lang="en-US">
<head>
<title>JavaScript this in Objects</title>
<meta charset="utf-8">
...
<h1>JavaScript <b>this</b> Keyword</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_object_methods.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_object_display.asp">Next &#10095;</a>
</div>

<div class="ws-info">
<h2><b>this</b> in Objects</h2>
<p>The <code class="w3-codespan">this</code> keyword refers to an object.</p>
<p>In JavaScript, <code class="w3-codespan">this</code> is used to access
the object that is calling a method.</p>
</div>

<h2><b>this</b> in an Object Method</h2>
<p>When used inside an object method, <code class="w3-codespan">this</code> refers to the object.</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_object_method" target="_blank">
...
<ul>
  <li><code>this.firstName</code> refers to the <code>firstName</code> property of the person object</li>
  <li><code>this.lastName</code> refers to the <code>lastName</code> property of the person object</li>
</ul>

<hr>

<h2>Why Use <b>this</b>?</h2>

<p>
The <code class="w3-codespan">this</code> keyword makes it possible to use the same method with different objects.
</p>
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate jsHigh">
    ...
    document.getElementById("demo").innerHTML = person1.hello();<br>
  </div>
  <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_object_this_multi" target="_blank">
Try it Yourself &raquo;</a>
</div>
...
<p>
When used alone, <code class="w3-codespan">this</code> refers to the global object.
</p>

<p>
In a browser, the global object is the <code>window</code> object.
</p>
...
<div class="w3-example">
  ...
  <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_object_this_alone" target="_blank">
Try it Yourself &raquo;</a>
</div>

<div class="ws-note">
<p>In strict mode, <code class="w3-codespan">this</code> is <code>undefined</code> when used alone.</p>
</div>
<hr>
...
<p>
In a regular function, <code class="w3-codespan">this</code> also refers to the global object.
</p>
...
<div class="w3-example">
  ...
  <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_this_function" target="_blank">
  Try it Yourself &raquo;</a>
</div>
...
<ul>
  <li>In an object method, <code class="w3-codespan">this</code> refers to the object</li>
  <li><code class="w3-codespan">this</code> lets methods access object properties</li>
  <li>Used alone, <code class="w3-codespan"><b></b>this</code> refers to the global object</li>
</ul>
