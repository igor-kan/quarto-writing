...
<html lang="en-US">
<head>
<title>JavaScript Temporal vs Date - What is the Difference?</title>
<meta charset="utf-8">
...
<h1>JavaScript Temporal vs Date</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_temporal_intro.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_temporal_duration.asp">Next &#10095;</a>
</div>

<div class="ws-info">
<p><b>Learn the differences between JavaScript Date and Temporal</b></p>
<ul>
...
<li>Date can fail in DST handling, Temporal can not</li>
</ul>
<p><b>Learn why Temporal is the modern alternative to Date.</b></p>
</div>

<h2>JavaScript Date Problems</h2>

<p>The JavaScript <b>Date object</b> is old and has several <b>design problems</b>.</p>
<p>These are the most common mistakes developers make when using Date objects:</p>
<ul>
  <li><p>Using the wrong month number because months start at 0.</p></li>
  <li><p>Accidentally changing a date object by calling a mutating method.</p></li>
  <li><p>Parsing unclear strings that behave differently across environments.</p></li>
  <li><p>Mixing local time and UTC values in the same program.</p></li>
  <li><p>Doing math across DST changes and getting unexpected hours.</p></li>
</ul>

<hr>
<div class="ws-note">
<p>The JavaScript <code class="w3-codespan">Date</code> object has been used since 1995.</p>
<p><code class="w3-codespan">Temporal</code> is the modern replacement designed to fix many of Date's problems.</p>
</div>

<hr>
<h2>Date Months are 0-Based</h2>
<p>In the JavaScript Date object, January is month 0 and December is month 11.</p>
<div class="w3-example">
<h3>Date Example</h3>
<div class="w3-code notranslate jsHigh">
// May 17, 2026:<br>
let date = new Date(2026, 4, 17)<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_date_month" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="ws-note">
<p>The Date object is confusing because most people expect January to be month 1.</p>
</div>

<hr>
<h2>Temporal Months are 1-Based</h2>
<p>In the JavaScript Temporal object, January is month 1 and December is month 12.</p>
<p>This is much more user-friendly.</p>
...
<hr>
<h2>Date Objects are Mutable</h2>
<p><b>JavaScript Date objects</b> can change.</p>
<p>Date objects are <b>mutable</b>.</p>
<div class="w3-example">
<h3>Date Example</h3>
<p>Date methods can <b>change the original date object:</b></p>
<div class="w3-code notranslate jsHigh">
// Create a Date<br>
const date = new Date("2026-05-17");<br>
<br>
// Add 7 days to date<br>
date.setDate(date.getDate() + 7);<br>
<br>
// Here the original date is lost
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_date_sideffects" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Date Example</h3>
<p>Date methods can <b>change other date objects:</b></p>
<div class="w3-code notranslate jsHigh">
// Create a Date<br>
const date1 = new Date("2026-05-17");<br>
// Create a copy<br>
const date2 = date1;<br>
<br>
// Add 7 days to date1<br>
date1.setDate(date1.getDate() + 7);<br>
<br>
// Here date2 has changed
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_date_sideffects4" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="ws-note">
<p>In the example above, the variables date1 and date2 point to the same object.</p>
<p>Because of thes, date2 changes when date1 changes.</p>
<p>This can create unexpected results when date values are copied or reused.</p>

</div>

<hr>
<h2>Temporal Objects are Immutable</h2>
<p><b>JavaScript Temporal objects</b> cannot change.</p>
<p>Temporal objects are <b>immutable</b>.</p>

<div class="w3-example">
<h3>Temporal Example</h3>
<p>Temporal operations always <b>return a new object</b> (or value).</p>
<div class="w3-code notranslate jsHigh">
// Create a Date<br>
const date1 = Temporal.PlainDate.from("2026-05-17");<br>
<br>
// Add 7 days<br>
const date2 = date1.add({ days: 7 });<br>
<br>
// Here original date1 is kept
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_immutable" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Date Parsing is Inconsistent</h2>
<p>JavaScript has been <b>a minefield of different formats</b>, browser quirks and locale surprises.</p>
<p>Date strings can be parsed differently across browsers and environments,
and different formats may be interpreted as local time or UTC.</p>
<p>A date string like <b>2026-05-07</b> is interpreted as <b>UTC time</b> in JavaScript.</p>
<p>A date-time string like <b>2026-05-07T14:40:00</b>
is interpreted as <b>local time</b>.</p>

<div class="w3-example">
<h3>Date Example</h3>
<div class="w3-code notranslate jsHigh">
const d1 = new Date("2026-05-17");<br>
const d2 = new Date("2026-05-17T00:00:00");<br>
const d3 = new Date("05/17/2026");<br>
const d4 = new Date("May 17 2026");<br>
const d5 = new Date("17 May 2026");<br>
const d6 = new Date(2026, 4, 17);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_date_sideffects3" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Temporal PlainDate</h2>
<p>Temporal avoids the problems above by defining strict parsing rules for
ISO strings.</p>

<p><b>Temporal.PlainDate</b> is not a timestamp.</p>
<p>It is just <b>2026-05-17</b> with no time and no time zone.</p>
<div class="w3-example">
<h3>Temporal Example</h3>
<div class="w3-code notranslate jsHigh">
...
<div class="ws-note">
<p>It is safer to avoid unclear formats and use explicit formats when possible.</p>
</div>

<hr>
<h2>Date and Time Zone</h2>
<p><code class="w3-codespan">new Date(2026, 4, 1)</code> creates a timestamp of
your local time at midnight.</p>
<p>This means a day can "shift" when you format it to UTC.</p>

<div class="w3-example">
<h3>Date Example</h3>
<div class="w3-code notranslate jsHigh">
// Create a Date object<br>
const date = new Date(2026, 4, 1);<br>
<br>
// Might be another day in some time zones:<br>
date.toISOString();
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_date_sideffects5" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<h2>Date Mixes Local Time and UTC</h2>
<p>A Date object always stores a timestamp, but it can display values as local time or UTC.</p>
<p>This mix can easily cause confusion when converting and comparing dates.</p>
<p>The same moment can look different depending on how it is displayed.</p>
...
<br>
let time1 = date.toString();<br>
let time2 = date.toUTCString();<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_vs_date_7" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Temporal Separates Time and UTC</h2>
<p>Temporal uses clear types for time zones.</p>
<p><b>Temporal.ZonedDateTime</b> always includes a time zone.</p>

<div class="w3-example">
<h3>Temporal Example</h3>
<div class="w3-code notranslate jsHigh">
const instant = Temporal.Now.instant();<br>
const local = Temporal.Now.zonedDateTimeISO();<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_vs_date_10" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>DST Can Break Date Math</h2>
<p>Daylight saving time (DST) can cause a day to be 23 or 25 hours long.</p>
<p>This can break calculations that assume every day is exactly 24 hours.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const start = new Date("2026-03-29T00:00:00");<br>
const end = new Date(start.getTime() + 24 * 60 * 60 * 1000);<br>
</div>
</div>
<p>The result can be off by one hour in time zones with DST changes.</p>

<hr>
<h2>Date Math</h2>
<p>Date math often requires manual calculations.</p>
<div class="w3-example">
<h3>Date Example</h3>
<div class="w3-code notranslate jsHigh">
...
<br>
const diff = end - start;</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_vs_date_8" target="_blank">Try it Yourself &raquo;</a>
</div>

<p>Temporal has built-in date arithmetic.</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_vs_date_11" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="ws-note">
<h2>Nanosecond Precision</h2>
<p>The Date object uses milliseconds precision.</p>
<p>Temporal offers 1 million times higher nanosecond precision.</p>
</div>

<hr>
<h2>Date Mixes Everything</h2>
<p>Date mixes everything in one object.</p>
<div class="w3-example">
<h3>Date (Problem)</h3>
<div class="w3-code notranslate jsHigh">
...
<hr>
<h2>Temporal Uses Clear Types</h2>
<p><b>Temporal objects</b> separate different use cases into different objects.</p>
<p>This makes code easier to read and less error-prone.</p>

<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
<tr><th>Object</th><th>Description</th></tr>
<tr><td><a href="js_temporal_duration.asp">Temporal.Duration</a></td>
<td>Object for duration (days, hours, minutes)</td></tr>
<tr><td><a href="js_temporal_instant.asp">Temporal.Instant</a></td>
<td>Object for exact moment in UTC time</td></tr>
<tr><td><a href="js_temporal_plaindatetime.asp">Temporal.PlainDateTime</a></td>
<td>Object for Date and Time only (no time zone)</td></tr><tr>
<td><a href="js_temporal_plain.asp">Temporal.PlainDate</a></td>
<td>Object for Date only (year, month, day)</td></tr>
<tr><td><a href="js_temporal_plaintime.asp">Temporal.PlainTime</a></td>
<td>Object for Time only</td></tr>
<tr><td><a href="js_temporal_plainyearmont.asp">Temporal.PlainYearMonth</a></td>
<td>Object for Year and Month only</td></tr>
<tr><td><a href="js_temporal_plainmonthday.asp">Temporal.PlainMonthDay</a></td>
<td>Object for Month and Day only</td></tr>
<tr><td><a href="js_temporal_zoneddatetime.asp">Temporal.ZonedDateTime</a></td>
<td>Object for Date and Time with time zone</td></tr>
<tr><td><a href="js_temporal_now.asp">Temporal.Now</a></td>
<td>Container for temporal methods</td></tr>
</table>
</div>

<hr>
<h2>Differences Between Date and Temporal</h2>
<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
<tr>
...
<tr>
<td>Date-Only Type</td>
<td>No</td>
<td>Yes</td>
</tr>
<tr>
<td>Time-Only Type</td>
<td>No</td>
<td>Yes</td>
</tr>
<tr>
<td>1-Based Months</td>
<td>No</td>
<td>Yes</td>
</tr>
<tr>
<td>DST safe arithmetic</td>
<td>No</td>
<td>Yes</td>
</tr>
<tr>
<td><a href="js_temporal_formats.asp">ISO 8601</a></td>
<td>Yes</td>
<td>Yes</td>
</tr>
<tr>
<td><a href="js_temporal_formats.asp">RFC 3339</a></td>
<td>Yes</td>
<td>Yes</td>
</tr>
<tr>
<td><a href="js_temporal_formats.asp">RFC 9557 iCalendar</a></td>
<td>No</td>
<td>Yes</td>
</tr>
<tr>
<td>Modern API design</td>
<td>No</td>
<td>Yes</td>
</tr>
<tr>
...
<div class="ws-note">
<p>You may still use <b>JavaScript Date</b> for simple tasks such as getting a quick timestamp.</p>
<p>You may also need it if you support older environments without Temporal.</p>
<p><b>JavaScript Temporal</b> is safer, clearer, and designed for modern applications.</p>
</div>

<hr>
<h2>When to Use Temporal?</h2>
<ul>
  <li><p>You need correct time zone handling.</p></li>
  <li><p>You work with international users.</p></li>
  <li><p>You want safe date arithmetic.</p></li>
  <li><p>You want clear and modern code.</p></li>
</ul>
