...
<!DOCTYPE html>
<html lang="en-US">
<head><title>JavaScript Typed Arrays</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="js_meta_reference.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_typed_methods.asp">Next &#10095;</a>
</div>


<div class="w3-panel ws-info">
<h2>Typed Arrays</h2>
<p><b>Typed arrays</b> was designed for handling <b>Binary Data</b>.</p>
<p>Unlike arrays, typed arrays are buffers of <b>Fixed Length</b>.</p>
<p>Typed arrays store elements of <b>Fixed Types</b> like 8-bit integers or 32-bit numbers.</p>
</div>
<div class="w3-example">
<h3>Examples</h3>
<p>Create a typed array of 5 bytes:</p>
<div class="w3-code notranslate jsHigh">
const myArr = new Uint8Array(5);
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_typed_uint8_1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
<p>Create a typed array from an array:</p>
<div class="w3-code notranslate jsHigh">
const myArr = new Uint8Array([0,1,2,3,4]);
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_typed_uint8_2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
<p>Create a typed array from a list of numbers:</p>
<div class="w3-code notranslate jsHigh">
const myArr = Uint8Array.of(0,1,2,3,4);
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_typed_uint8_3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
<p>Create a typed array from an array:</p>
<div class="w3-code notranslate jsHigh">
const myArr = Uint8Array.from([0,1,2,3,4]);
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_typed_uint8_4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>


<hr>
<h2>Typed Array Benefits</h2>

<p>Typed Arrays were designed to provide an efficient way to handle binary data,
unlike traditional JavaScript arrays which can hold elements of mixed data types.</p>

<p>Typed arrays are raw memory, so JavaScript can pass them directly to any function
without converting the data to another representation.</p>
<p>Typed arrays are seriously faster than normal arrays for passing data
to functions that can use raw binary data. Typed Arrays are highly suitable for:</p>
<ul>
<li><p><b>WebGL and Canvas</b>:
<br>Fast graphics rendering and image processing.</li>
<li><p><b>File APIs</b>:<br>
Fast reading and writing of local files.</li>
<li><p><b>Media APIs</b>:<br>
Fast handling of audio and video data.</li>
<li><p><b>WebSockets</b>:<br>
Efficient binary data transfer over network.</li>
</ul>
<hr>
<div class="ws-note">

<p>Typed arrays provide a way to handle binary data as efficiently as arrays work in C.</p>
</div>
<hr>
<h2>Browser APIs Supporting Typed Arrays</h2>

<div class="w3-example">
<h3>Fetch API Example</h3>
<div class="w3-code notranslate jsHigh">
fetch(url)<br>
.then(request =&gt; request.arrayBuffer())<br>
.then(arrayBuffer =&gt;...);<br>
</div>
</div>
...
<div class="w3-code notranslate jsHigh">
const canvas = document.getElementById('my_canvas');<br>
const context = canvas.getContext('2d');<br>
const imageData = context.getImageData(0, 0, canvas.width, canvas.height);<br>
const uint8ClampedArray = imageData.data;
</div>
</div>

<hr>
<h2>Differences from Regular Arrays</h2>
<ul>
<li><p>Fixed Length:
<br>Typed Arrays cannot be dynamically resized using methods like push() or pop().</p></li>
<li><p>Type Restriction:<br>
Elements must adhere to the specified data type of the typed array.</p></li>
<li><p>Underlying Buffer:<br>
Typed Arrays are views into an ArrayBuffer, allowing direct manipulation of binary data.</p></li>
</ul>

<hr>
<h2>Typed Array Types</h2>
<div class="w3-stretch w3-responsive">
<table class="ws-table-all" style="font-size:14px">
<tr></tr>
<tr>
<th>Name</th>
<th>Min</th>
...
<div class="w3-example">
<h3>Examples</h3>
<p>Create a typed array of 10 signed 8-bit integers (byte format):</p>
<div class="w3-code notranslate jsHigh">
const myArr = new Int8Array(10);
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_typed_int8" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
<p>Create a typed array of 10 unsigned 8-bit integers (octet format):</p>
<div class="w3-code notranslate jsHigh">
const myArr = new Uint8Array(10);
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_typed_uint8" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
<p>Create a typed array of 10 usigned 8-bit integers (clamped format):</p>
<div class="w3-code notranslate jsHigh">
const myArr = new Uint8ClampedArray(10);
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_typed_uint8clamped" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Uint8Array vs Uint8ClampedArray</h2>
<p>The difference between an Uint8Array and  an Uint8ClampedArray is how values are added.</p>
<p>If you set one element in an Uint8ClampedArray to a value outside the 0-255 range,
it will default to 0 or 255.</p>
<p>A typed array will just take the first 8 bits of the value.</p>

<hr>
<div class="ws-note">

<p>Typed arrays are not arrays. </p>
<p>isArray() on a typed array returns false.</p>
<p>Many array methods (like push and pop) are not supported by typed arrays.</p>
</div>

<hr>
<h2>16-Bits Integers</h2>
...
<div class="w3-example">
<h3>Examples</h3>
<p>Create a typed array of 10 signed 16-bit integers (short format):</p>
<div class="w3-code notranslate jsHigh">
const myArr = new Int16Array(10);
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_typed_int16" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
<p>Create a typed array of 10 unsigned 16-bit integers (unsigned short format):</p>
<div class="w3-code notranslate jsHigh">
const myArr = new Uint16Array(10);
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_typed_uint16" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>32-Bit Integers</h2>
<div class="w3-responsive">
<table class="ws-table-all notranslate">
<tr>
  <th width="150px">Name</th>
...
<div class="w3-example">
<h3>Examples</h3>
<p>Create a typed array of 10 signed 32-bit integers (long format):</p>
<div class="w3-code notranslate jsHigh">
const myArr = new Int32Array(10);
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_typed_int32" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
<p>Create a typed array of 10 unsigned 32-bit integers (unsigned long format):</p>
<div class="w3-code notranslate jsHigh">
const myArr = new Uint32Array(10);
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_typed_uint32" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<tr>
  <td>BigInt64Array</td>
  <td>Big signed integer</td>
  <td style="text-align:right">-2<sup>63</sup>/2<sup>63</sup>-1</td>
</tr>
<tr>
  <td>BigUint64Array</td>
  <td>Big unsigned integer</td>
  <td style="text-align:right">0/2<sup>64</sup></td>
</tr>
</table>
</div>
...
<div class="w3-example">
<h3>Examples</h3>
<p>Create a typed array of 10 signed 64-bit integers (bigint format):</p>
<div class="w3-code notranslate jsHigh">
const myArr = new Bigint64Array(10);
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_typed_bigint64" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
<p>Create a typed array of 10 unsigned 64-bit integers (bigint format):</p>
<div class="w3-code notranslate jsHigh">
const myArr = new Biguint64Array(10);
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_typed_biguint64" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<tr>
  <td>Float16Array</td>
  <td>Half precision - 3 significant decimal digits</td>
  <td style="text-align:right">-65504	/ 65504</td>
</tr>
<tr>
  <td>Float32Array</td>
  <td>Normal precision - 7 significant decimal digits</td>
  <td style="text-align:right">-3.4e38 / 3.4e38</td>
</tr>
<tr>
  <td>Float64Array</td>
  <td>Double precision- 15 significant decimal digits</td>
  <td style="text-align:right">-1.8e308 /	1.8e308</td>
</tr>
</table>
</div>

<p>As specified by the <b>ECMAScript</b> standard, arithmetic in JavaScript shall be done using double-precision
floating-point arithmetic:</p>
<img alt="64-bit" src="img_double_floating_point_900.jpg" style="width:100%;max-width:600px">
<div class="w3-example">
<h3>Examples</h3>
<p>Create a typed array of 10 floating point numbers in (half precision) 16-bit format:</p>
<div class="w3-code notranslate jsHigh">
const myArr = new Float16Array(10);
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_typed_float16" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
<p>Create a typed array of 10 floating point numbers in (normal precision) 32-bit format:</p>
<div class="w3-code notranslate jsHigh">
const myArr = new Float32Array(10);
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_typed_float32" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
<p>Create a typed array of 10 floating point numbers in (double precision) 64-bit format:</p>
<div class="w3-code notranslate jsHigh">
const myArr = new Float64Array(10);
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_typed_float64" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<hr>
<div class="ws-note">
<h2>Learn More:</h2>
<p class="w3-large"><a href="js_typed_methods.asp">Typed Array Methods</a></p>
<p class="w3-large"><a href="js_typed_reference.asp">Typed Array Reference</a></p>
<p class="w3-large"><a href="js_arraybuffers.asp">Array Buffers</a></p>
<p class="w3-large"><a href="js_dataview.asp">DataViews</a></p>
<p class="w3-large"><a href="js_atomics.asp">Atomics</a></p>
</div>

<hr>
<h2>Browser Support</h2>
<p><code class="w3-codespan">Typed Arrays</code> is an <a href="js_es6.asp">ES6  feature</a>.</p>
