...
document.getElementById(<i>id</i>).style.<b><i>property</i></b>=<i> new style</i>
</div>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Changes the style of a <code class="w3-codespan">&lt;p&gt;</code> element:</p>
...
<div class="w3-example">
<h3>Example</h3>
<p>Change the style of the HTML element with <code class="w3-codespan">id=&quot;id1&quot;</code>, when the 
...
<div class="w3-example">
<h3>Example</h3>
<p>How to make an element invisible. Do you want to show the element or not?</p>
<div class="w3-code notranslate htmlHigh">
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_visibility" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<hr>
<div id="exercisecontainer" src="xrcise_htmldom_css.js"></div>
<hr>
