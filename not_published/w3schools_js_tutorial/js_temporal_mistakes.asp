...
<html lang="en-US">
<head>
<title>JavaScript Temporal Mistakes – Top 10 Common Errors</title>
<meta charset="utf-8">
...
<h1>JavaScript Temporal Mistakes</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_temporal_formats.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_temporal_migrate.asp">Next &#10095;</a>
</div>

<div class="ws-info">
<p>Temporal is a powerful API, but it can be confusing at first.</p>
<ul>
<li>Remember to use the correct Temporal type</li>
<li>Avoid implicit conversions</li>
<li>Always handle time zones correctly</li>
<li>Use compare() instead of &lt; and &gt;</li>
<li>Remember that Temporal Objects are immutable</li>
</ul>
<p>Here are some common mistakes and how to avoid them.</p>
</div>

<h2>Missing UTC (Z) for Instant</h2>
<p>An Instant must always include UTC.</p>
<div class="w3-example">
<h3>Wrong</h3>
<div class="w3-code notranslate jsHigh">
const instant = Temporal.Instant.from("2026-05-17T14:30:00");
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_error_instant" target="_blank">Try it Yourself &raquo;</a>
<h3>Correct</h3>
<div class="w3-code notranslate jsHigh">
const instant = Temporal.Instant.from("2026-05-17T14:30:00Z");
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_error_instant_ok" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Using PlainDateTime with Time Zone</h2>
<p>PlainDateTime does not support time zones.</p>
<div class="w3-example">
<h3>Wrong</h3>
<div class="w3-code notranslate jsHigh">
const date = Temporal.PlainDateTime.from("2026-05-17T14:30:00Z");
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_error_plaindatetime" target="_blank">Try it Yourself &raquo;</a>
<h3>Correct</h3>
<div class="w3-code notranslate jsHigh">
const date = Temporal.ZonedDateTime.from("2026-05-17T14:30:00");
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_error_plaindatetime_ok" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Comparing Different Types</h2>
<p>Temporals can go wrong when comparing different types.</p>
<div class="w3-example">
<h3>Wrong</h3>
<div class="w3-code notranslate jsHigh">
const d1 = Temporal.PlainDate.from("2026-05-17");<br>
const d2 = Temporal.Instant.from("2026-05-17T14:30Z");<br>
<br>
Temporal.PlainDate.compare(d1, d2);
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_error_compare" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
<h3>Correct</h3>
<div class="w3-code notranslate jsHigh">
const d1 = Temporal.PlainDate.from("2026-05-17");<br>
const d2 = Temporal.PlainDateTime.from("2026-05-17T14:30");<br>
<br>
Temporal.PlainDate.compare(d1, d2);
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_error_compare_ok" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Using equals() with Different Types</h2>
<p>Temporals can go wrong when comparing different types.</p>
<div class="w3-example">
<h3>Wrong</h3>
<div class="w3-code notranslate jsHigh">
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_error_equals" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
<h3>Correct</h3>
<div class="w3-code notranslate jsHigh">
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_error_equals_ok" target="_blank">Try it Yourself &raquo;</a>
</div>

<br>
<h2>Using ==, &lt; or &gt; for Comparison</h2>
<p>Temporal objects cannot be compared with ==, ===, &lt; or &gt;.</p>
<div class="w3-example">
<h3>Wrong</h3>
<div class="w3-code notranslate jsHigh">
const d1 = Temporal.PlainDate.from("2026-05-17");<br>
const d2 = Temporal.PlainDate.from("2026-05-17");<br>
<br>
d1 === d2; // False<br>
d1 == d2;&nbsp; // False<br>
d1 &lt; d2;&nbsp;&nbsp; // TypeError<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_error_less_than" target="_blank">Try it Yourself &raquo;</a>
<h3>Correct</h3>
<div class="w3-code notranslate jsHigh">
const d1 = Temporal.PlainDate.from("2026-05-17");<br>
const d2 = Temporal.PlainDate.from("2026-05-17");<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_error_less_than_ok" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Expecting Mutation</h2>
<p>Temporal objects are immutable.</p>
<div class="w3-example">
<h3>Wrong</h3>
<div class="w3-code notranslate jsHigh">
const date = Temporal.PlainDate.from("2026-05-17");<br>
<br>
date.add({ months: 1 });<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_error_mutation" target="_blank">Try it Yourself &raquo;</a>
<h3>Correct</h3>
<div class="w3-code notranslate jsHigh">
const date = Temporal.PlainDate.from("2026-05-17");<br>
<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_error_mutation_ok" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Using valueOf()</h2>
<p>Temporal objects do not convert to numbers.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const date = Temporal.PlainDate.from("2026-05-17");<br>
<br>
try {<br>
&nbsp;&nbsp;text = date.valueOf();<br>
} catch (err) {<br>
&nbsp;&nbsp;text = err.name;<br>
}
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_error_valueof" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Using Instant for Local Time</h2>
<p>Instant is always UTC (not local time).</p>
<div class="w3-example">
<h3>Wrong</h3>
<div class="w3-code notranslate jsHigh">
Temporal.Now.instant(); // not local time
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_error_local" target="_blank">Try it Yourself &raquo;</a>
<h3>Correct</h3>
<p>Use <code class="w3-codespan">Temporal.Now.zonedDateTimeISO()</code> to get local time:</p>
<div class="w3-code notranslate jsHigh">
Temporal.Now.zonedDateTimeISO();
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_error_local_ok" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Using PlainDate for Time</h2>
<p>PlainDate has no time.</p>
<div class="w3-example">
<h3>Wrong</h3>
<div class="w3-code notranslate jsHigh">
Temporal.PlainDate.from("2026-05-17T14:30");
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_error_plaindate" target="_blank">Try it Yourself &raquo;</a>
<h3>Correct</h3>
<div class="w3-code notranslate jsHigh">
Temporal.PlainDateTime.from("2026-05-17T14:30");
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_error_plaindate_ok" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Forgetting Time Zone in ZonedDateTime</h2>
<p>ZonedDateTime requires a time zone.</p>
<div class="w3-example">
<h3>Wrong</h3>
<div class="w3-code notranslate jsHigh">
Temporal.ZonedDateTime.from("2026-05-17T14:30:00");
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_error_zoned" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_error_zoned_ok" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Not Choosing the Right Type</h2>
<p>Each Temporal type has a specific purpose.</p>
...
<tr>
<td>ZonedDateTime</td>
<td>Date + time + time zone</td>
</tr>
<tr>
<td>Duration</td>
<td>Length of time only</td>
</tr>
</table>
