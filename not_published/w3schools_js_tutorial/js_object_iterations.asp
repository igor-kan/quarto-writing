...
<html lang="en-US">
<head>
<title>JavaScript Object Iterations</title>
...
<h1>JavaScript Object Iterations</h1>
...
// Copies properties from a source object to a target object<br>
Object.assign(target, source)<br><br>
// Creates an object from an existing object<br>
Object.create(object)<br><br>
// Returns an array of the key/value pairs of an object<br>
Object.entries(object)<br><br>
// Creates an object from a list of keys/values<br>
Object.fromEntries()<br><br>
// Returns an array of the keys of an object<br>
Object.keys(object)<br><br>
// Returns an array of the property values of an object<br>
Object.values(object)<br><br>
// Groups object elements according to a function<br>
Object.groupBy(object, callback)<br>
</div>
</div>
...
<p><code class="w3-codespan">Object.entries()</code> is supported in all modern browsers since March 2017:</p>
<!--stop-->
<hr>
<!--start-->
<h2>JavaScript Object.fromEntries()</h2>
<p>The <code class="w3-codespan">fromEntries()</code> method creates an object from
...
<p><code class="w3-codespan">Object.values()</code> is supported in all modern browsers since March 2017:</p>
<!--stop-->
<hr>
<!--start-->
<a id="mark_object_groupby"></a>
<h2>JavaScript Object.groupBy()</h2>
<p>ES2024 added the <code class="w3-codespan">Object.groupBy()</code> method to JavaScript.</p>
...
const result = Object.groupBy(fruits, myCallback);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_object_groupby" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<h2>Browser Support</h2>
<p><code class="w3-codespan">Object.groupby()</code> is an ECMAScript 2024 feature.</p>
...
<p>The JavaScript <code class="w3-codespan">for...in</code> statement loops through the properties of an object.</p>
<h3>Syntax</h3>
...
<p>The block of code inside of the <code class="w3-codespan">for...in</code> loop will be executed once for each property.</p>
