...
<h1>JavaScript Function Arguments</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_function_return.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_function_expressions.asp">Next &#10095;</a>
</div>

<div class="ws-info">
<h2>Parameters vs. Arguments</h2>
<p>In JavaScript, function <b>parameters</b> and <b>arguments</b> are distinct concepts:</p>
<p><b>Parameters</b> are the <b>names</b> listed in the <b>function definition</b>.</p>
<p><b>Arguments</b> are the <b>real values</b> passed to, and <b>received by the function</b>.</p>
</div>
...
<a target="_blank" href="tryit.asp?filename=tryjs_function_multiply" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p>In the example above:</p>
<ul>
  <li><b>a</b> and <b>b</b> are parameters</li>
  <li><b>4</b> and <b>5</b> are arguments</li>
</ul>
<p>The argument <b>4</b> is assigned to the parameter <b>a</b>.</p>
<p>The argument <b>5</b> is assigned to the parameter <b>b</b>.</p>
...
<p>If a function is called with <b>too many arguments</b> (more than declared),
these arguments can be reached using <b>the arguments object</b>.</p>
</div>



<hr>
<h2>The Order of Arguments Matters</h2>
<p>
Arguments are assigned to parameters in the order they appear.<br>
</p>
...
let x1 = subtract(10, 5);<br>
let x2 = subtract(5, 10);<br>
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_function_subtract" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="ws-note">
<p>The two calls above return different results because the order is different.</p>
</div>


<hr>
<h2>Arguments Can Be Variables</h2>
<p>Arguments do not have to be values. They can also be variables.</p>
...
<p>JavaScript function definitions <b>do not specify data types</b> for arguments.</p>
<p>JavaScript functions <b>do not perform type checking</b> on the passed arguments.</p>
<p>JavaScript functions <b>do not check the number</b> of arguments received.</p>

<hr>
<h2>Incorrect Arguments</h2>
<p>Incorrect arguments can return incorrect answers:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_farenheit_to_celsius_4" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<p>
If a function is called with fewer arguments than parameters, the missing values become <b>undefined</b>.<br>
</p>
...
<p>
In the example above, <b>b</b> is <b>undefined</b>, so the result is <b>NaN</b>.<br>
</p>
...
<p>If a function is called with <b>missing arguments</b> (less than declared), the missing values are set to
...
<p><a href="js_es6.asp"><b>ECMAScript 2015</b></a> allows function parameters to have default values.</p>
<p>You can now set a default value for a parameter.</p>
<p>The default value is used if no argument is provided.</p>
...
function myFunction(x, y = 10) {<br>&nbsp;
  return x + y;<br>}<br>myFunction(5);
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_function_default" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>JavaScript arguments are passed by <b>value</b>: The function only 
...
original value.</p>
<p><b>Changes to arguments are not visible (reflected) outside the function.</b></p>
<hr>
...
<p><b>Changes to object properties are visible (reflected) outside the function.</b></p>
<br>
...
<ul class="w3-ul">
  <li><h3>Confusing Parameters and Arguments</h3>
  Parameters are <b>names</b>.<br>Arguments are <b>values</b>.</li>

  <li><h3>Forgetting the Order</h3>
  Arguments are assigned by <b>position</b>.</li>

  <li><h3>Missing Arguments</h3>
  Use default values to <b>avoid undefined</b>.</li>
</ul>

<hr>
<div class="ws-note">
<h2>Quiz</h2>
<p>What happens when a function is called with fewer arguments than parameters?</p>
</div>

<hr>
<div class="ws-note">
<h2>Next Chapter</h2>
<p class="w3-large"><a href="js_function_expressions.asp">Function Expressions</a></p>
<ul>
