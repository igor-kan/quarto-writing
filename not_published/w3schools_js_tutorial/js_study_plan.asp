...
<html lang="en-US">
<head>
<title>JavaScript Study Plan (Lesson Plan)</title>
<meta charset="utf-8">
...
<h1>JavaScript Study Plan</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_syllabus.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_interview_prep.asp">Next &#10095;</a>
</div>
<hr>

<h2>Introduction</h2>
<p>The JavaScript study plan helps you teach your students JavaScript step-by-step.</p>
<p>Creating a study plan for JavaScript is easy.</p>
...
<p>Save time with pre-built teacher materials and study plans. Easily organize your class with a timeline from the introduction of JavaScript to the final exam.</p>
<hr>
...
<p>W3Schools has everything you need to teach JavaScript.</p>

<p>The JavaScript training materials is available for you to include and use in your study plan:</p>
<ul>
  <li><a href="default.asp" target="_blank">W3Schools JavaScript Tutorial</a></li>
  <li><a href="js_exercises.asp" target="_blank">JavaScript Exercises</a></li>
  <li><a href="js_quiz.asp" target="_blank">JavaScript Quiz</a></li>
  <li>JavaScript Challenges (Coding challenges)</li>
  <li><a href="js_exam.asp" target="_blank">JavaScript Certification Exam (End of Pathway Exam)</a></li>
</ul>
<hr>

<h2>JavaScript Syllabus</h2>
<p>With the JavaScript Syllabus, your students will start with the basics, like creating simple web pages, and move to more advanced topics, like adding images, links, and forms. Each chapter has examples, try-its, exercises, and quizzes to make learning easy, interactive and fun.</p>
<p><a title="W3Schools JavaScript Syllabus" href="js_syllabus.asp" target="_blank">Read more about JavaScript Syllabus</a>.</p>
<hr>
...
<ol>
  ...
  <li style="margin-top:16px">
    ...
    <ul>
      <li>The JavaScript study plan aligns with the JavaScript Certification Exam.</li>
      <li>The exam can be taken at the end of the study plan, at your selected date.</li>
      <li>The exam summarizes the JavaScript Tutorial.</li>
...
<p>For example, this is how a 5-week JavaScript study plan could look like:</p>
<ul>
  <li>Week 1: Introduction, Variables, Let, Const &amp; Data Types, Booleans, Numbers</li>
  <li>Week 2: Operators, Assignment, Arithmetic Operators, Assignment, Arithmetic and Math, Strings, Dates, Arrays, Events, Precidence &amp; Conditionals, Loops &amp; Iterables</li>
  <li>Week 3: Maps &amp; Sets, Typeof &amp; Type Conversion, Destructing, Scope, Hoisting &amp; this keyword, Functions, Miscellaneous, Versions, Errors, Debugging &amp; Coding Best Practices</li>
  <li>Week 4: Objects, Modules, Classes, Async, HTML DOM, Browser DOM, Web APIs, AJAX, JSON, JS vs jQuery</li>
  <li>Week 5: Graphics, JavaScript Certification Exam</li>
</ul>

<p>Image of Sample JavaScript study plan:</p>
<a href="js_study_plan.png" target="_blank" title="JavaScript Study Plan"><img src="js_study_plan.png" style="height:auto;max-width:100%;"></a>
<hr>

<h2>Ready to get started?</h2>
<p>Start with <strong> JavaScript Study Plans</strong> today.</p>
...
<p>Are you interested in learning how you can use <a href="/academy/index.php" target="_blank">W3Schools Academy</a> to Teach JavaScript programming? </p>
