...
<a class="w3-right w3-btn" href="js_function_iife.asp">Next &#10095;</a>
</div>

<!--start-->
<div class="ws-info">
<h2>Method Borrowing</h2>
<p>Like with <b>call()</b> and <b>apply()</b>, the <b>bind()</b> method can borrow a method from another object.</p>
<p>Unlike <b>call()</b> and <b>apply()</b>, the <b>bind()</b> method does not run the function immediately.</p>
<p>Instead, it <b>returns a new function</b> that can be called later.</p>
<p>The new function remembers the <b>this</b> value you chose.</p>
</div>

<div class="ws-note">

<p><b>bind()</b> is an advanced topic.</p>
<p>Make sure you understand <b>this</b>, <b>call()</b>, and <b>apply()</b> first.</p>
...
<h2>Basic bind() Syntax</h2>
<p>The <b>bind()</b> method creates a new function.</p>
<p>The first argument sets the <b>this</b> value for the new function.</p>
<p>Additional arguments become <b>fixed arguments</b> for the new function.</p>

<div class="w3-example">
<h3>Syntax</h3>
<div class="w3-code notranslate jsHigh">
const newFunction = functionName.bind(<b>this</b>, arg1, arg2, ...);<br>
</div>
</div>

<hr>
<h2>Using bind() to Fix <b>this</b></h2>
<p>The most common use of <b>bind()</b> is to make sure a function always uses the same <b>this</b> value.</p>
...
const greetJohn = greet.bind(person1);<br><br>
greetJohn();<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_function_bind_greet" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="ws-note">
<p><b>greetJohn</b> is a new function that always uses <b>person1</b> as <b>this</b>.</p>
</div>
...
<br>
// Create member Object<br>
const member = {<br>
&nbsp;&nbsp;firstName:&quot;Hege&quot;,<br>
&nbsp;&nbsp;lastName: &quot;Nilsen&quot;,<br>
}<br>
<br>
// Bind the fullName method to the member Object<br> 
let fullName = person.fullName.bind(member);<br>
<br>
// Later call fullname()<br>
fullname()<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_function_bind_borrow" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="ws-note">
<p><b>fullName</b> is a new function that always uses <b>member</b> as <b>this</b>.</p>
</div>

<hr>
<h2>bind() vs call() and apply()</h2>
<p>The difference between these methods is important:</p>

<ul>
  <li><b>call()</b> calls a function immediately</li>
  <li><b>apply()</b> calls a function immediately</li>
  <li><b>bind()</b> returns a new function</li>
</ul>
...
<br>
// Call a function<br>
greet.apply(person);<br>
<br>
// Create a new function<br>
const greetLater = greet.bind(person);<br>
<br>
// Call the new function<br>
greetLater();<br>
</div>
</div>

<hr>
<h2>bind() for Functions Called Later</h2>
<p>Without <b>bind()</b>, the <b>this</b> value may be lost.</p>
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate jsHigh">
    ...
    const hello = person.sayHello;<br>
    hello(); // this is not person<br>
  </div>
</div>

<p>
The function above loses its <b>this</b> value.<br>
</p>

<div class="w3-example">
  <h3>Example with bind()</h3>
  <div class="w3-code notranslate jsHigh">
    const hello = person.sayHello.bind(person);<br>
    hello();<br>
  </div>
</div>

<hr>
<h2>Using bind() for Preserving <b>this</b></h2>

<p>The <b>bind()</b> method can be used to <b>prevent losing this</b>.</p>
<p>In the following example, the <b>person object</b> has a <b>display method</b>.</p>
<p>In the display method, <b>this</b> refers to the <b>person object</b>:</p>
...
<p>The example below uses person.display as a callback in the setTimeout() method.</p>
<div class="w3-example">
<h3>Example</h3>
<p>This will display undefined instead of person name:</p>
<div class="w3-code notranslate jsHigh">
const person = {<br>
&nbsp;&nbsp;firstName:&quot;John&quot;,<br>
&nbsp;&nbsp;lastName: &quot;Doe&quot;,<br>
...
<p>The <b>bind()</b> method solves this problem.</p>
<p>In the following example, the <b>bind()</b> method is used to bind person.display to person.</p>
<div class="w3-example">
<h3>Example</h3>
<p>This will display correct:</p>
<div class="w3-code notranslate jsHigh">
const person = {<br>
&nbsp;&nbsp;firstName:&quot;John&quot;,<br>
&nbsp;&nbsp;lastName: &quot;Doe&quot;,<br>
...
<h2>bind() with Arguments</h2>
<p>Arguments passed to <b>bind()</b> become fixed values.</p>
<p>This is sometimes called <b>partial application</b>.</p>
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate jsHigh">
    ...
    const double = multiply.bind(null, 2);<br><br>
    double(5);<br>
  </div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_function_bind_arguments" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="ws-note">
<p>The <b>double</b> function will always multiply by 2.</p>
</div>

<hr>

<h2>bind() Does Not Change the Original Function</h2>
<p>
The original function is not modified.</p>
<p>Each call to <b>bind()</b> creates a new function.</p>

<div class="w3-example">
<h3>Examples</h3>
<div class="w3-code notranslate jsHigh">
const greetJohn = greet.bind({ name: "John" });<br>
const greetAnna = greet.bind({ name: "Anna" });<br>
</div>
</div>
...
<ul>
<li><h3>Expecting bind() to Call the Function</h3>
<b>bind()</b> does not execute the function.</li>

<li><h3>Forgetting to Call the Returned Function</h3>
You must call the new function yourself.</li>

<li><h3>Overusing bind()</h3>
Sometimes a normal function call is simpler.</li>
</ul>
...
<h2>Next Chapter</h2>
<p class="w3-large"><a href="js_function_iife.asp">JavaScript Self Invocing Functions</a></p>
