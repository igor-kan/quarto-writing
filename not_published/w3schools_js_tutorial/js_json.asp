...
<div class="w3-cell w3-container w3-white w3-cell-top">
<p>JSON stands for <b>J</b>ava<b>S</b>cript <b>O</b>bject <b>N</b>otation.</p>
<p>JSON is a <b>plain text format</b> for storing and transporting data.</p>
<p>JSON is similar to the syntax for creating JavaScript objects.</p>
<p>JSON is used to <b>send</b>, <b>receive</b> and <b>store data</b>.</p>
...
<p>The example above defines an object with 3 properties:</p>
<ul>
<li>"name"</li>
<li>"age"</li>
<li>"car"</li>
</ul>
<p>Each property has a value:</p>
<ul>
<li>"John"</li>
<li>30</li>
<li>null</li>
...
<h2>Why JSON?</h2>
<ul>
  <li>JSON is make it easy to send and store data between computers</li>
  <li>JSON is text only and language independent <b>*</b> </li>
</ul>

<div class="w3-panel ws-note">
<p><b>*</b> The syntax is derived from JavaScript object syntax, but JSON is text only.</p> 
<p>Code for reading and generating JSON data can be written in any programming language.</p>
<p>The JSON format was originally specified by <a target="_blank" href="http://www.crockford.com">Douglas Crockford</a>.</p>
</div>
...
<!--start-->
<p>The JSON format is syntactically identical to the code for creating JavaScript objects.</p>
<p>Because of this, a JavaScript program can easily convert JSON data into native JavaScript objects.</p>


<p>JavaScript has a built in function for converting JSON strings into JavaScript objects:</p>
...
<p><code class="w3-codespan">JSON.stringify()</code></p>
<div class="ws-note">
<p>You can receive pure text from a server and use it as a JavaScript object.</p>
<p>You can send a JavaScript object to a server in pure text format.</p>
<p>You can work with data as JavaScript objects, with no complicated 
...
<div class="w3-example">
<h3>JSON Example</h3>
<p>Text that defines an employees object with an array of 3 employee objects:</p>
<div class="w3-code notranslate jsHigh">
{<br>&quot;employees&quot;:[<br>
...
<p>If you parse the JSON string with a JavaScript program, you can access the data
as an object:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
let personName = obj.name;<br>
...
<p>Then, use the JavaScript built-in function <code class="w3-codespan">JSON.parse()</code> to convert the string into a JavaScript object:</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const obj = JSON.parse(text);</div>
</div>
