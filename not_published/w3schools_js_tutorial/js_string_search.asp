...
<a class="w3-right w3-btn" href="js_string_reference.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
...
<tr>
<td>
<a href="#mark_indexof">String indexOf()</a><br>
<a href="#mark_lastindexof">String lastIndexOf()</a><br>
<a href="#mark_search">String search()</a><br>
<a href="#mark_match">String match()</a><br></td>
<td>
<a href="#mark_matchall">String matchAll()</a><br>
<a href="#mark_includes">String includes()</a><br>
<a href="#mark_startswith">String startsWith()</a><br>
<a href="#mark_endswith">String endsWith()</a><br>
</td>
</tr>
</table>
</div>
...
<a href="js_string_methods.asp">String Methods</a><br>
...
<p>The <code class="w3-codespan">indexOf()</code> method returns the <b>index</b> (position)
of the <b>first</b> occurrence of a string in a string, or it returns -1 if the string is not found:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let text = &quot;Please locate where 'locate' occurs!&quot;;<br>
...
<p>0 is the first position in a 
string, 1 is the second, 2 is the third, ...</p>
</div>
<!--stop-->
<hr>
<!--start-->
<a id="mark_lastindexof"></a>
<h2>JavaScript String lastIndexOf()</h2>
<p>The <code class="w3-codespan">lastIndexOf()</code> method returns the <b>index</b> of the <strong>last</strong> 
...
<p>Both <code class="w3-codespan">indexOf()</code>, and <code class="w3-codespan">lastIndexOf()</code> return -1
if the text is not found:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let text = &quot;Please locate where 'locate' occurs!&quot;;<br>
...
<p>The <code class="w3-codespan">lastIndexOf()</code> methods searches backwards 
(from the end to the beginning), meaning:
if the second parameter is <code class="w3-codespan">15</code>, the search starts at position 
15, and searches to the beginning of the string.</p>
...
text.lastIndexOf(&quot;locate&quot;, 15);
  ...
  <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_string_lastindexof_2" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>The <code class="w3-codespan">search()</code> method searches a string for a string (or a regular expression)
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_string_search_locate2" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Did You Notice?</h2>
<p>The two methods, <code class="w3-codespan">indexOf()</code> and <code class="w3-codespan">search()</code>, are <strong>equal?</strong></p>
...
<ul>
<li>The <code class="w3-codespan">search()</code> method cannot take a second start position argument.</li>
<li>The <code class="w3-codespan">indexOf()</code> method cannot take 
...
<p>The <code class="w3-codespan">match()</code> method returns an array containing the results of matching
a string against a string (or a regular expression).</p>
<div class="w3-example">
<h3>Examples</h3>
...
<a target="_blank" href="tryit.asp?filename=tryjs_match" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
...
<a target="_blank" href="tryit.asp?filename=tryjs_match_regexp3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
...
<a target="_blank" href="tryit.asp?filename=tryjs_match_regexp" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
<p>Perform a global, case-insensitive search for &quot;ain&quot;:</p>
<div class="w3-code notranslate jsHigh">
let text = &quot;The rain in SPAIN stays mainly in the plain&quot;; <br>
text.match(/ain/gi);
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_match_regexp2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="ws-note">

<p>If a regular expression does not include the <em>g</em> modifier (global search),
<code class="w3-codespan">match()</code> will return only the first match in the string.</p>
<p>Read more about regular expressions in the chapter <a href="/js/js_regexp.asp">JS RegExp</a>.</p>
</div>
<!--stop-->
<hr>
<!--start-->
<a id="mark_matchall"></a>
<a id="mark_string_matchall"></a>
<h2>JavaScript String matchAll()</h2>
<p>The <code class="w3-codespan">matchAll()</code> method returns an iterator containing the results of matching
a string against a string (or a regular expression).</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const iterator = text.matchAll("Cats");<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_string_matchall">Try it Yourself &raquo;</a>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const iterator = text.matchAll(/Cats/g);<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_string_matchall2">Try it Yourself &raquo;</a>
</div>
<p>If you want to search case insensitive, the insensitive flag (i) must be set:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const iterator = text.matchAll(/Cats/gi);<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_string_matchall3">Try it Yourself &raquo;</a>
</div>
<div class="ws-note">
<p><code class="w3-codespan">matchAll()</code> is an <a href="js_2020.asp">ES2020</a> feature.</p>
<p><code class="w3-codespan">matchAll()</code> does not work in Internet Explorer.</p>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>The <code class="w3-codespan">includes()</code> method returns true if a string contains a specified value.</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_includes2" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="ws-note">
<p><code class="w3-codespan">includes()</code> is case sensitive.</p>
<p><code class="w3-codespan">includes()</code> is an <a href="js_es6.asp">ES6 feature</a>.</p>
</div>
<!--stop-->
<hr>
<!--start-->
...
if a string begins with a specified value.</p>
<p>Otherwise it returns <code class="w3-codespan">false</code>:</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_startswith4" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_startswith3" target="_blank">Try it Yourself &raquo;</a>
<p>Returns true:</p>
<div class="w3-code notranslate jsHigh">
let text = &quot;Hello world, welcome to the universe.&quot;;<br>
text.startsWith(&quot;world&quot;, 6)
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_startswith2" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="ws-note">
<p><code class="w3-codespan">startsWith()</code> is case sensitive.</p>
<p><code class="w3-codespan">startsWith()</code> is an <a href="js_es6.asp">ES6 feature</a>.</p>
</div>
<!--stop-->
<hr>
<!--start-->
...
if a string ends with a specified value.</p>
<p>Otherwise it returns <code class="w3-codespan">false</code>:</p>
...
<p><a class="w3-btn" href="tryit.asp?filename=tryjs_endswith2" target="_blank">Try it Yourself &raquo;</a></p>
</div>

<div class="ws-note">
<p><code class="w3-codespan">endsWith()</code> is case sensitive.</p>
<p><code class="w3-codespan">endsWith()</code> is an <a href="js_es6.asp">ES6 feature</a>.</p>
</div>
<!--stop-->
<hr>
<div class="ws-note">
...
<hr>
<div id="exercisecontainer" src="xrcise_string_search.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_string_methods.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_string_reference.asp">Next &#10095;</a>
