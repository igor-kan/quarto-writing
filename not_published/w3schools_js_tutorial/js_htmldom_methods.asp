...
<html lang="en-US">
<head>
<title>JavaScript HTML DOM API</title>
<meta charset="utf-8">
...
<p>The <b>DOM API</b> (Application Programming Interface) is a set of <b>Methods</b> and <b>Properties</b>
that allow JavaScript to change the content, structure, and style of any HTML elements.</p>
<img style="width:100%;border:1px solid lightgrey" src="img_htmltree_800.svg" alt="DOM HTML tree">
<div class="w3-container w3-center w3-light-grey">
<p>An <b>API Method</b> is an <b>Action</b> that you can do on an HTML element.</p>
<p>An <b>API Property</b> is a <b>Value</b> that you can access on an HTML element.</p>
</div>
</div>
...
&lt;p id=&quot;demo&quot;&gt;&lt;/p&gt;<br><br>
&lt;script&gt;<br>
// Access a paragraph Element<br>
const myPara = document.getElementById("demo");<br>
<br>
// Change the content of the Element<br>
myPara.innerHTML = "Hello World!";<br>
&lt;/script&gt;<br><br>
&lt;/body&gt;<br>
&lt;/html&gt;</div>
...
<p><code class="w3-codespan">document</code> is the <b>HTML document</b>.</p>
<p><code class="w3-codespan">getElementById()</code> is a <b>document method</b>.</p>
<p><code class="w3-codespan">myPara = getElementById("demo")</code> <b>retrieves the "demo" element</b>.</p>
<p><code class="w3-codespan">innerHTML</code> is an <b>element property</b>.</p>
<p><code class="w3-codespan">myPara.innerHTML = "Hello World!"</code> <b>changes the property</b>.

<hr>

<h2>HTML DOM API Abilities</h2>
<p>The DOM API provides us with the ability to:</p>
<ul>
<li>Find and select elements</li>
<li>Change element content and attributes</li>
<li>Add, remove, or modify elements</li>
<li>Change CSS styles</li>
<li>Add event listeners to react to user input</li>
</ul>

<hr>
<div class="ws-note">
<h2>JavaScript is the Language</h2>
<p>The <b>DOM API</b> is a standard for how to get, change, add, or delete HTML DOM elements.</p>
<p><b>JavaScript is the language</b> used in browsers to access the DOM through the API.</p>
</div>

<hr>
<h2>API Methods and Properties</h2>
<p>Developers use global objects like <b>document</b> and <b>window</b> as entry points to any API.</p>
<p>If you want to access any element in an HTML page, you always start with accessing the 
document object. The <b>document object</b> represents your <b>web page</b>.</p>
<p>To manipulate HTML with JavaScript, you first need to <b>select an element</b>.</p>
<p>Below are some examples of how you can use the document object to access HTML:</p>
...
<tr><td>document.querySelector(<i>selector</i>)</td><td>Find the first element that matches a CSS selector</td></tr>
<tr><td>document.querySelectorAll(<i>selector</i>)</td><td>Find all elements that match a CSS selector</td></tr>
...
<p>The <b>document object is the owner</b> of all other objects in your web page.</p>
</div>
</div>
<hr>
...
<hr>
<!--start-->
<h2>Accessing Element Content</h2>
<div class="w3-stretch">
<table class="ws-table-all">
<tr><th>Property</th><th>Description</th></tr>
<tr><td><em>element</em>.innerHTML</td><td>The HTML content of an element</td></tr>
<tr><td><i>element</i>.textContent</td><td>The text content of an element</td></tr>
</table>
</div>

<hr>
<h2>Accessing Element Attributes</h2>
<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
<tr><th>Property</th><th>Description</th></tr>
<tr><td><em>element</em>.<em>attribute</em></td><td>Change the attribute value of an HTML element</td></tr>
<tr><td><em>element</em>.style.<em>property</em></td><td>The style of an HTML element</td></tr>
</table>
</div>
...
<tr><td><i>element</i>.setAttribute()</td><td>Create or set a new attribute</td></tr>
</table>
</div>

<hr>
<h2>Manipulating Structure</h2>
<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
<tr><th>Method</th><th>Description</th></tr>
<tr><td>document.createElement()</td><td>Creates a new HTML element</td></tr>
<tr><td>document.removeChild()</td><td>Remove an HTML element</td></tr>
<tr><td>document.appendChild()</td><td>Add an HTML element</td></tr>
<tr><td>document.replaceChild()</td><td>Replace an HTML element</td>
</tr>
</table>
</div>
<!--stop-->
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_htmldom_methods.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_htmldom.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_htmldom_elements.asp">Next &#10095;</a>
