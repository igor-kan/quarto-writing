...
<html lang="en-US">
<head>
<title>Create JavaScript Website Server | W3Schools.com | W3Schools Spaces</title>
<meta charset="utf-8">
...
<h1>JavaScript and HTML Website Hosting</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="js_quiz.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="js_syllabus.asp">Next &#10095;</a>
</div>
<hr>
...
<div class="w3-center hero-background">
            <div class="w3-content">
                <div class="top-section" style="padding-top:100px; color: #ffffff;padding-left:25px;padding-right:25px;">
                    ...
                    <h1 class="hero-title" style="color: #ffffff;font-size: 58px;font-weight:700">Create Website with HTML and JavaScript</h1>
              ...
              <div style="padding:40px 25px 120px 25px;position:relative;">
                ...
                <div class="w3-row-padding">
                  ...
                  <div class="w3-col kaimq w3-center">
                    <h1 style="font-weight: 900;  background: -webkit-linear-gradient(#D9EEE1, #63ADB9);-webkit-background-clip: text;-webkit-text-fill-color: transparent;font-size:85px;margin-bottom:-65px;margin-top:-10px">k<span style="font-size:150px">AI</h1>
