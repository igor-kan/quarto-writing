...
<a class="w3-left w3-btn" href="js_events_management.asp">&#10094; Previous</a>
...
<p>In this example, the content of the <code class="w3-codespan">&lt;h1&gt;</code> element is changed when a user clicks on it:</p>
...
<p>In the example above, a function named <code class="w3-codespan">displayDate</code> will be executed 
...
<p>In the example above, a function named <code class="w3-codespan">displayDate</code> is assigned to 
an HTML element with the <code class="w3-codespan">id=&quot;myBtn&quot;</code>.</p>
...
<p>The <code class="w3-codespan">onload</code> and <code class="w3-codespan">onunload</code> events are triggered when the user enters or leaves the page.</p>
<p>The <code class="w3-codespan">onload</code> event can be used to check the visitor's browser type and browser version, and load the proper version of the web page based on the information.</p>
<p>The <code class="w3-codespan">onload</code> and <code class="w3-codespan">onunload</code> events can be used to deal with cookies.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
...
<p>The <code class="w3-codespan">oninput</code> event is often to some action while the user input data.</p>
<p>Below is an example of how to use the oninput to change the content of an input field.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;input type=&quot;text&quot; id=&quot;fname&quot;
oninput=&quot;upperCase()&quot;&gt;</div>
<a target="_blank" href="tryit.asp?filename=tryjs_events_oninput" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>The onchange Event</h2>
<p>The <code class="w3-codespan">onchange</code> event is often used in combination with validation of input fields.</p>
<p>Below is an example of how to use the onchange. The <code class="w3-codespan">upperCase()</code> 
...
<a target="_blank" href="tryit.asp?filename=tryjs_events_onchange" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>The onmouseover and onmouseout Events</h2>
<p>The <code class="w3-codespan">onmouseover</code> and <code class="w3-codespan">onmouseout</code> events can be used to trigger a function when the user mouses 
...
<p>The <code class="w3-codespan">onmousedown</code>, <code class="w3-codespan">onmouseup</code>, and <code class="w3-codespan">onclick</code> events are all parts of a 
...
<hr>
<div id="exercisecontainer" src="xrcise_htmldom_events.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_events_management.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_htmldom_eventlistener.asp">Next &#10095;</a>
