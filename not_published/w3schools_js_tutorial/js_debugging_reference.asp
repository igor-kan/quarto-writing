...
<html lang="en-US">
<head>
<title>JavaScript Debugging Reference</title>
<meta charset="utf-8">
...
<h1>JavaScript Debugging Reference</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_debugging_async.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_conventions.asp">Next &#10095;</a>
</div>

<hr>
<h2>Full JavaScript Console Reference</h2>
<h4>Revised December 2026</h4>
...
<tr>
<td><a href="/jsref/met_console_assert.asp">assert()</a></td>
<td>Logs a message only if the provided assertion is false. If true, nothing is outputted, which helps keep logs clean.</td>
</tr>
<tr>
<td><a href="/jsref/met_console_clear.asp">clear()</a></td>
<td>Clears the console.</td>
</tr>
<tr>
<td><a href="/jsref/met_console_dir.asp">dir()</a></td>
<td>Displays an interactive, hierarchical listing of the properties of a specified JavaScript object.
This can provide a more detailed view than console.log() for complex objects.</td>
</tr>
<tr>
<td><a href="/jsref/met_console_count.asp">count()</a></td>
<td>Logs the number of times that this particular call to count() has been called.</td>
</tr>
<tr>
<td><a href="/jsref/met_console_error.asp">error()</a></td>
<td>Displays an error message (often red text/background) to the console, useful for highlighting critical issues.</td>
</tr>
<tr>
<td><a href="/jsref/met_console_group.asp">group()</a></td>
...
<tr>
<td><a href="/jsref/met_console_groupcollapsed.asp">groupCollapsed()</a></td>
<td>Creates a new inline group in the console. However, the new group is 
created collapsed. The user will need to use the disclosure button to expand it.</td>
</tr>
<tr>
<td><a href="/jsref/met_console_groupend.asp">groupEnd()</a></td>
<td>Exits the current inline group in the console.</td>
</tr>
<tr>
<td><a href="/jsref/met_console_info.asp">info()</a></td>
<td>Outputs an informational message to the console</td>
</tr>
<tr>
<td><a href="/jsref/met_console_log.asp">log()</a></td>
<td>The most widely used method, it outputs a general message, variable value, or object to the console.
It accepts multiple arguments, allowing you to combine text and object displays.</td>
</tr>
<tr>
<td><a href="/jsref/met_console_table.asp">table()</a></td>
<td>Displays tabular data as a table, which is very useful for visualizing arrays of objects.</td>
</tr>
<tr>
<td><a href="/jsref/met_console_time.asp">time()</a></td>
<td>Starts a timer (can track how long an operation takes).</td>
</tr>
<tr>
<td><a href="/jsref/met_console_timeend.asp">timeEnd()</a></td>
<td>Stops a timer that was previously started by console.time().</td>
</tr>
<tr>
<td><a href="/jsref/met_console_trace.asp">trace()</a></td>
<td>Outputs a stack trace to the console.</td>
</tr>
<tr>
<td><a href="/jsref/met_console_warn.asp">warn()</a></td>
<td>Similar to console.log(), but displays a message with a warning format (often yellow text/background)
and a different log level, allowing filtering in developer tools.</td>
</tr>
</table>
</div>
