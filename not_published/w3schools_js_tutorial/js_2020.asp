...
<a class="w3-left w3-btn" href="js_2021.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_2019.asp">Next &#10095;</a>
</div>
...
<tr><td><a href="js_2020.asp?#mark_bigint">BigInt</a></td>
<td>Stores values too big to store in a JavaScript number</td></tr>

<tr><td><a href="js_2020.asp?#mark_string_matchall">String matchAll()</a></td>
<td>Searchs for all occurrences of a string in a string</td></tr>

<tr><td><a href="js_2020.asp?#mark_promise_allsettled">Promise.allSettled()</a></td>
<td>Takes promises as input and returns a single promise</td></tr>

<tr><td><a href="js_2020.asp?#mark_dynamic_import">Dynamic Import</a></td>
<td>Loads JavaScript modules at runtime</td></tr>

<tr><td><a href="js_2020.asp?#mark_globalthis">globalThis</a></td>
<td>Refers to the global object independent of code environment</td></tr>

<tr><td><a href="js_2020.asp?#mark_importmeta">import.meta</a></td>
<td>Returns an object indicating the base URL of a module</td></tr>

<tr><td><a href="js_2020.asp?#mark_module_namespace_export">Namespace Exports</a></td>
...
<div class="w3-code notranslate jsHigh">
let x = 9999999999999999;<br>
let y = 9999999999999999n;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_numbers_bigint" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let x = 1234567890123456789012345n;<br>
...
<p><a href="js_2021.asp">ES2021</a> introduced the string method replaceAll().</p>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_nullish">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_oper_optional_chaining">Try it Yourself &raquo;</a>
</div>
...
<br>
// Settle All<br>
Promise.allSettled([myPromise1, myPromise2]).then((results) =&gt;<br>
&nbsp;&nbsp;results.forEach((x) =&gt; myDisplay(x.status)),<br>
);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_promise_allsettled">Try it Yourself &raquo;</a>
</div>
<div class="ws-note">
...
<p>The global object is the top-level object in a JavaScript environment:<p>
<ul>
...
<p><code class="w3-codespan">globalThis</code> was introduced in <a href="js_2020.asp">ECMAScript 2020</a>
(ES11) to solve that problem. It is a unified reference to the global object, no matter the environment.</p>

<div class="w3-example">
<h3>Examples</h3>
<div class="w3-code notranslate jsHigh">
globalThis === window); // true in browsers<br>
globalThis === global); // true in Node.js
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_globalthis">Try it Yourself &raquo;</a>
<h3>Example</h3>
<p>Defining a truly global variable:</p>
<div class="w3-code notranslate jsHigh">
globalThis.appName = "W3Schools Demo";
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_globalthis2">Try it Yourself &raquo;</a>
</div>
<p>Previously, developers had to use workarounds like:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const getGlobal = function() {<br>
&nbsp; if (typeof self !== 'undefined') return self;<br>
&nbsp; if (typeof window !== 'undefined') return window;<br>
&nbsp; if (typeof global !== 'undefined') return global;<br>
&nbsp; throw new Error('Cannot find global object');<br>
};<br>
</div>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const myObject = import.meta;<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_modules_importmeta">Try it Yourself &raquo;</a>
</div>
...
<p>Before:</p>
<div class="w3-code notranslate jsHigh">
// re-export all named exports directly<br>
export * from "./utils.js";<br>
// consumers can use:<br>
import { add } from "./math.js";<br>
</div>
<p>Now:</p>
<div class="w3-code notranslate jsHigh">
// re-export all as a namespace<br>
export * as utils from "./utils.js";<br>
// consumers can use:<br>
import { utils } from "./math.js";<br>
</div>
</div>
