...
<html lang="en-US">
<head>
<title>Asynchronous Study Path</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="js_class_static.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_async.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
<div class="w3-container w3-card w3-white w3-round-large">
<h2>Asynchronous Study Path</h2>
<p>Learn Asynchronous JavaScript in the Right Order:</p>
<ul class="w3-large">
  <li><a href="js_async.asp">First: <b>Async Programming</b></a></li>
  <li><a href="js_async_timeouts.asp">Then: Async <b>Timeouts</b></a></li>
  <li><a href="js_async_callbacks.asp">Then: Async <b>Callbacks</b></a></li>
  <li><a href="js_promise.asp">Then: Async <b>Promises</b></a></li>
  <li><a href="js_async_await.asp">Then: Async <b>Await</b></a></li>
  <li><a href="js_async_fetch.asp">Then: Async <b>Fetch</b></a></li>
  <li><a href="js_async_debug.asp">Then: Async <b>Debugging</b></a></li>
  <li><a href="js_promise_reference.asp">Then: Async <b>Reference</b></a></li>
</ul>
</div>

</div>

<div class="w3-row-padding w3-stretch w3-light-grey">
...
<div class="w3-container w3-card w3-white w3-round-large">
<p>Step 1</p>
<h4><a href="js_async.asp">Async <b>Programming</b></a></h4>
<p>JavaScript executes code one line at a time.
Each line must finish before the next line can run.</p>
<p>Asynchronous is how JavaScript can allow some code to run in the background, and let
their results be handled when they are ready.</p>
<p><a class="w3-button w3-green" href="js_async.asp">Beginner</a></p>
</div>

<br>
<div class="w3-container w3-card w3-white w3-round-large">
<p>Step 2</p>
<h4><a href="js_async_timeouts.asp">Async <b>Timeouts</b></a></h4>
<p>The setTimeout() method schedules a function to run after a delay in milliseconds.</p>
<p>It is an asynchrounus operation used to delay code execution without freezing the browser.</p>
<p><a class="w3-button w3-green" href="js_async.asp">Beginner</a></p>
</div>
...
<div class="w3-container w3-card w3-white w3-round-large">
<p>Step 3</p>
<h4><a href="js_async_callbacks.asp">Async <b>Callbacks</b></a></h4>
<p>A callback is a function that runs later.</p>
<p>The name "callback" stems from the idea that the function will
"call you back" later when it has finished its task.</p>
<p><a class="w3-button w3-blue" href="js_async_callbacks.asp">Intermediate</a></p>
</div>

<br>
<div class="w3-container w3-card w3-white w3-round-large">
<p>Step 4</p>
<h4><a href="js_promise.asp">Async <b>Promises</b></a></h4>
<p>JavaScript Promises were created to make asynchronous JavaScript easier to use.</p>
<p>A Promise object represents the completion or failure of an asynchronous operation.</p>
<p>A Promise can be in one of three exclusive states: pending, rejected or fulfilled.</p>
<p><a class="w3-button w3-red" href="js_promise.asp">Advanced</a></p>
</div>

<br>
</div>
<div class="w3-half w3-container w3-light-grey w3-round">

<br>
<div class="w3-container w3-card w3-white w3-round-large">
<p>Step 5</p>
<h4><a href="js_async_await.asp">Async <b>Await</b></a></h4>
<p>async and await make promises easier.</p>
...
<p><a class="w3-button w3-red" href="js_async_await.asp">Advanced</a></p>
</div>

<br>
<div class="w3-container w3-card w3-white w3-round-large">
<p>Step 6</p>
<h4><a href="js_async_fetch.asp">Async <b>Fetch</b></a></h4>
<p>Modern apps use async code to get data.</p>
<p>fetch() is the modern way to request data from a server.</p>
<p>fetch() is asynchronous and returns a promise.</p>
<p><a class="w3-button w3-red" href="js_async_fetch.asp">Advanced</a></p>
</div>

<br>
<div class="w3-container w3-card w3-white w3-round-large">
<p>Step 7</p>
<h4><a href="js_async_debug.asp">Async <b>Debugging</b></a></h4>
<p>Asynchronous bugs are difficult because the code runs later.</p>
<p>This chapter shows practical ways to debug fetch(), promises, async and await.</p>
<p><a class="w3-button w3-red" href="js_async_debug.asp">Advanced</a></p>
</div>

<br>
<div class="w3-container w3-card w3-white w3-round-large">
<p>Step 8</p>
<h4><a href="js_promise_reference.asp">Async <b>References</b></a></h4>
<p>All Promise Object Methods</p>
<p>Revised February 2026</p>
<p><a class="w3-button w3-red" href="js_promise_reference.asp">Advanced</a></p>
</div>
