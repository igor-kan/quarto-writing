...
<a class="w3-left w3-btn" href="js_error_object.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_debugging_console.asp">Next &#10095;</a>
</div>

<!--start-->
<div class="ws-info">
<h2>Debugging for Beginners</h2>
<p><b>Many beginners quit because they cannot debug</b>.</p>
<p>This page shows you how to find out <b>why code does not work</b>.</p>
<p><b>Debugging</b> means finding and fixing mistakes (bugs) in your code.</p>
<p><b>Bugs are normal</b>. The skill is learning how to locate them quickly.</p>
</div>

<h2>Why Code Does Not Work?</h2>
<p>Programming code might contain syntax errors, or logical errors.</p>
<p>Many of these errors are difficult to diagnose.</p>
<p>When code fails, beginners often <b>guess</b> what is wrong.</p>
<p>Debugging is the opposite: you <b>check facts</b>.</p>
<p>A good debugging habit is: <b>Read</b> &#8594; <b>Reproduce</b> &#8594; <b>Reduce</b> &#8594; <b>Fix</b></p>
<ul>
<li>Read the error</li>
<li>Reproduce the problem</li>
<li>Reduce to a small example</li>
<li>Then fix it.
</ul>
...
<hr>
<div class="w3-panel w3-sand w3-stretch">
<span style="font-size:120px;line-height:0.76em;opacity:0.3">&#10077;</span>
<p class="w3-xlarge" style="margin-top:-40px">
<i>Errors can and will happen, every time you write computer code.</i></p>
</div>
...
<hr>
<h2>Step 1: Look in the Console</h2>
<p>The browser console shows errors and messages from JavaScript.</p>
<p>If your code "does nothing", the console often tells you why.</p>

<p>Normally (otherwise follow the steps at the bottom of this page), you <b>activate debugging</b> in your browser with 
the <b>F12 key</b>, and select <b>Console</b> in the debugger menu.<br></p>

<div class="ws-warning">
<p>If you do only one thing: <b>always check the console</b> when something fails.</p>
</div>

<hr>
<h2>Step 2: Use console.log()</h2>
<p>In JavaScript <code class="w3-codespan">console.log()</code> prints values to the console.</p>
<p>This helps you to see what your code is doing.</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_debugging_console" target="_blank">
Try it Yourself &raquo;</a>
<p>Print variables to find what is wrong:</p>
<div class="w3-code notranslate jsHigh">
let price = 50;<br>
let quantity = 3;<br>
let total = price * quantity;<br>
<br>
console.log("Total:", total);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_debugging_variables" target="_blank">
Try it Yourself &raquo;</a>
</div>

<div class="ws-note">
<h2>Tip:</h2>
<p>Log the value <b>before</b> and <b>after</b> the line you suspect.</p>
<p>That can tell you where things start going wrong.</p>
</div>

<hr>
<h2>Step 3: Confirm Your Assumptions</h2>
<p>Many bugs happen because you <b>assume a value</b> is something, but it is not.</p>
<p><b>Check the value</b>.</p>
<p><b>Check the type</b>.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Numbers and strings behave differently:</p>
<div class="w3-code notranslate jsHigh">
let x = 5;<br>
let y = "5";<br>
<br>
console.log(x + y);&nbsp;&nbsp;// 55 (string!)<br>
console.log(x + Number(y));&nbsp;&nbsp;// 10 (number)<br>
</div>
<a class="w3-btn w3-margin-bottom w3-green" href="tryit.asp?filename=tryjs_debugging_types" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Reading Error Messages (Beginner Friendly)</h2>
<p>Error messages look scary, but they usually mean one of a few common things.</p>
<h3>ReferenceError</h3>
<p>Means: This name does not exist.</p>
<p>Often a misspelling or variable not declared.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
console.log(myValue);<br>
// ReferenceError: myValue is not defined<br>
</div>
<a class="w3-btn w3-margin-bottom w3-green" href="tryit.asp?filename=tryjs_debugging_referenceerror" target="_blank">Try it Yourself &raquo;</a>
</div>

<h3>TypeError</h3>
<p>Means: You tried to use a value in an impossible way.</p>
<p>Often <code class="w3-codespan">undefined</code> or <code class="w3-codespan">null</code>.</p>
...
<a class="w3-btn w3-margin-bottom w3-green" href="tryit.asp?filename=tryjs_debugging_typeerror" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="ws-note">

<p>In the console window, the error usually includes a <b>line number</b>.</p>
<p>Click it in the console to jump to the exact line.</p>
</div>

<hr>

<h2>A Simple Debugging Checklist</h2>
<ul>
  <li>Check the console for errors</li>
  <li>Read the error message carefully</li>
  <li>Log values with <code class="w3-codespan">console.log()</code></li>
  <li>Reduce the problem to a small example</li>
...
<div class="w3-example">
<h3>Examples</h3>
<p><strong>Mistake:</strong> Using = instead of == or ===</p>
<div class="w3-code notranslate jsHigh">
let x = 10;<br>
if (x = 5) {<br>
&nbsp;&nbsp;console.log("This runs");<br>
}<br>
</div>
<a class="w3-btn w3-margin-bottom w3-green" href="tryit.asp?filename=tryjs_debugging_equals" target="_blank">
Try it Yourself &raquo;</a>

<p><strong>Fix:</strong> Use comparison:</p>
<div class="w3-code notranslate jsHigh">
let x = 10;<br>
if (x === 5) {<br>
&nbsp;&nbsp;console.log("This runs only if x is 5");<br>
}<br>
</div>
<a class="w3-btn w3-margin-bottom w3-green" href="tryit.asp?filename=tryjs_debugging_equals_fix" target="_blank">
Try it Yourself &raquo;</a>
</div>

<div class="ws-warning">
  If your <code>if</code> statement behaves strangely, check if you accidentally used <code>=</code>.
</div>
...
<p>You can activate debugging in your browser with <b>F12</b>, and select <b>Console</b> in the debugger menu.</p>
...
<ul>
 ...
 <li>From the menu, select &quot;Developer&quot;.</li>
  <li>From &quot;Developer&quot;, select &quot;Developer tools&quot;.<br></li>
 <li>Finally, select &quot;Console&quot;.</li>
</ul>
<h2>Safari</h2>
<ul>
...
<div class="ws-note">
<h2>See Also:</h2>
<p class="w3-large"><a href="js_errors_intro.asp">JavaScript Errors</a></p>
<p class="w3-large"><a href="js_errors_silent.asp">JavaScript Silent Errors</a></p>
<p class="w3-large"><a href="js_errors.asp">JavaScript Error Statemets</a></p>
