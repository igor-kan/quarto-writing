...
<h1>JavaScript Map Methods</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_maps.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_maps_weak.asp">Next &#10095;</a>
</div>

<hr>
<!--start-->
<h2>The new Map() Method</h2>
<p>You can create a map by passing an array to the <code class="w3-codespan">new Map()</code> constructor:</p>
...
<!--start-->
<h2>Map.get()</h2>
<p>You get the value of a key in a map with the <code class="w3-codespan">get()</code> method </p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_map_get" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Map.set()</h2>
<p>You can add elements to a map with the <code class="w3-codespan">set()</code> method:</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_map_set_new" target="_blank">Try it Yourself &raquo;</a>
</div>

<p>The <code class="w3-codespan">set()</code> method can also be used to change existing map values:</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_map_set" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Map.size</h2>
<p>The <code class="w3-codespan">size</code> property returns the number of elements in a map:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
fruits.size;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_map_size" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Map.delete()</h2>
<p>The <code class="w3-codespan">delete()</code> method removes a map element:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
fruits.delete("apples");
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_map_delete" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Map.clear()</h2>
<p>The <code class="w3-codespan">clear()</code> method removes all the elements from a map:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
fruits.clear();
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_map_clear" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Map.has()</h2>
<p>The <code class="w3-codespan">has()</code> method returns true if a key exists in a map:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
fruits.has("apples");
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_map_has" target="_blank">Try it Yourself &raquo;</a>
<h3>Try This:</h3>
<div class="w3-code notranslate jsHigh">
fruits.delete("apples");<br>
fruits.has("apples");
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_map_has_deleted" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<hr>
<h2>Map.forEach()</h2>
<p>The <code class="w3-codespan">forEach()</code> method invokes a callback for each key/value pair in a map:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// List all entries<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_map_foreach" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Map.entries()</h2>
<p>The <code class="w3-codespan">entries()</code> method returns an iterator object with the [key,values] in a map:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// List all entries<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_map_entries" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Map.keys()</h2>
<p>The <code class="w3-codespan">keys()</code> method returns an iterator object with the keys in a map:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// List all keys<br>
let text = "";<br>
for (const x of fruits.keys()) {<br>
&nbsp;&nbsp;text += x;<br>
}
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_map_keys" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Map.values()</h2>
<p>The <code class="w3-codespan">values()</code> method returns an iterator object with the values in a map:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// List all values<br>
let text = "";<br>
for (const x of fruits.values()) {<br>
&nbsp;&nbsp;text += x;<br>
}
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_map_values" target="_blank">Try it Yourself &raquo;</a>
</div>

<p>You can use the <code class="w3-codespan">values()</code> method to sum the values in a map:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Sum all values<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_map_values1" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Objects as Keys</h2>
<div class="ws-note">
...
const fruits = new Map();<br>
<br>
// Add new Elements to the Map<br>
fruits.set(apples, 500);<br>
fruits.set(bananas, 300);<br>
fruits.set(oranges, 200);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_map_create_objects" target="_blank">Try it Yourself &raquo;</a>
</div>

<p>Remember: The key is an object (apples), not a string ("apples"):</p>
<div class="w3-example w3-pale-red">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
fruits.get("apples");&nbsp;&nbsp;// Returns undefined<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_map_get_undefined" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<p>ES2024 added the <code class="w3-codespan">Map.groupBy()</code> method to JavaScript.</p>
<p>The <code class="w3-codespan">Map.groupBy()</code> method groups the elements of an iterable according
to the values returned from a callback function.</p>
<p>The <code class="w3-codespan">Map.groupBy()</code> method does not change the original object.</p>
<p><b>The return value is a Map</b> with a key for each group, where each key is assigned to an Array of the associated elements.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create an Array<br>
...
<br>
// Callback function to Group Elements<br>
function myCallback({ quantity }) {<br>
&nbsp; return quantity &gt; 200 ? "ok" : "low";<br>
}<br>
<br>
// Group by Quantity<br>
const result = Map.groupBy(fruits, myCallback);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_map_groupby" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>

<h2>Browser Support</h2>
<p><code class="w3-codespan">Map.groupBy()</code> is an ECMAScript 2024 feature.</p>
<p><a href="js-2024.asp">JavaScript 2024</a> is supported in new browsers since 
<b>March 2024</b>:</p>
...
<h2>Warning</h2>
<p>ES2024 features are relatively new.</p>
...
<p class="w3-large"><a href="js_maps_weak.asp">JavaScript Weak Maps</a></p>
<p class="w3-large"><a href="js_map_reference.asp">JavaScript Map Reference</a></p>
<p class="w3-large"><a href="js_sets.asp">JavaScript Sets</a></p>
</div>

<div id="exercisecontainer" src="xrcise_map_methods.js"></div>
<hr>
