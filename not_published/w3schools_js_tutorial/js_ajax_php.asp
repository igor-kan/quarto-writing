...
called <code class="w3-codespan">showHint()</code> is executed.</p>
<p>The function is triggered by the <code class="w3-codespan">onkeyup</code> event.</p>
<p>Here is the code:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;p&gt;Start typing a name in the input field below:&lt;/p&gt;<br>
&lt;p&gt;Suggestions: &lt;span id=&quot;txtHint&quot;&gt;&lt;/span&gt;&lt;/p&gt;<br><br>
&lt;form&gt;<br>
First name: &lt;input type=&quot;text&quot; onkeyup=&quot;showHint(this.value)&quot;&gt;<br>&lt;/form&gt;<br><br>
&lt;script&gt;<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;xmlhttp.open(&quot;GET&quot;, &quot;gethint.php?q=&quot; + str);<br>
&nbsp;&nbsp;xmlhttp.send();<br>
&nbsp;&nbsp;}<br>
}<br>
&lt;/script&gt;
...
$a[] = &quot;Wenche&quot;;<br>
$a[] = &quot;Vicky&quot;;<br><br>
 // get the q parameter from URL<br>$q = $_REQUEST[&quot;q&quot;];<br><br>$hint = &quot;&quot;;<br><br>// lookup all hints from array if $q is different from &quot;&quot; <br>if ($q !== &quot;&quot;) {<br>&nbsp;&nbsp;$q = strtolower($q);<br>
  &nbsp; $len=strlen($q);<br>&nbsp;&nbsp;foreach($a as $name) {<br>&nbsp;&nbsp;&nbsp; if (stristr($q, substr($name, 0, $len))) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if ($hint === &quot;&quot;) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$hint = $name;<br>&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; $hint .= &quot;, $name&quot;;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
