...
<html lang="en-US">
<head>
<title>JavaScript Selecting HTML DOM Elements</title>
<meta charset="utf-8">
...
<p>This example finds the element with <code class="w3-codespan">id=&quot;intro&quot;</code>:</p>
...
<p>If the element is not found, element will contain <code class="w3-codespan">null</code>.</p>
<!--stop-->
<hr>
<!--start-->
<h2>Finding HTML Elements by Tag Name</h2>
<p>This example finds all <code class="w3-codespan">&lt;p&gt;</code> elements:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const element = document.getElementsByTagName(&quot;p&quot;);</div>
...
<p>This example finds the element with <code class="w3-codespan">id=&quot;main&quot;</code>, and then finds all <code class="w3-codespan">&lt;p&gt;</code> elements 
inside <code class="w3-codespan">&quot;main&quot;</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<code class="w3-codespan">getElementsByClassName()</code>.<br>
</p>

<p>This example returns a list of all elements with <code class="w3-codespan">class=&quot;intro&quot;</code>.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const x = document.getElementsByClassName(&quot;intro&quot;);</div>
...
&lt;html&gt;<br>
&lt;body&gt;<br><br>
&lt;p class=&quot;demo&quot;&gt;&lt;/p&gt;<br><br>
&lt;script&gt;<br>
// Access a paragraph Element<br>
const myPara = document.querySelector(".demo");<br>
<br>
...
&lt;/body&gt;<br>
&lt;/html&gt;</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_dom_queryselector" target="_blank">Try it Yourself &raquo;</a>
</div>
...
&lt;html&gt;<br>
&lt;body&gt;<br><br>
&lt;p class=&quot;demo&quot;&gt;One&lt;/p&gt;<br>
&lt;p class=&quot;demo&quot;&gt;Two&lt;/p&gt;<br>
<br>
&lt;script&gt;<br>
// Access a paragraph Element<br>
const myItems = document.querySelectorAll(".demo");<br>
<br>
// Change the content of the Element<br>
myItems[0].innerHTML = "First";<br>
&lt;/script&gt;<br><br>
&lt;/body&gt;<br>
&lt;/html&gt;</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_dom_queryselector_all" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Common Mistakes</h2>
<ul>
<li>Using `#` in getElementById():<br>
&nbsp;&nbsp;Wrong: <b>"#demo"</b></li>
<li>Forgetting that querySelector() returns only the first match</li>
</ul>

<p>If you want to find all HTML elements that match a specified CSS selector 
(id, class names, types, attributes, values of attributes, etc), use the <code class="w3-codespan">querySelectorAll()</code> method.<br>
</p>

<p>This example returns a list of all <code class="w3-codespan">&lt;p&gt;</code> elements with <code class="w3-codespan">class=&quot;intro&quot;</code>.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const x = document.querySelectorAll(&quot;p.intro&quot;);</div>
...
<p>This example finds the form element with <code class="w3-codespan">id=&quot;frm1&quot;</code>, in the forms 
...
let text = &quot;&quot;;<br>
for (let i = 0; i &lt; x.length; i++) {<br>&nbsp; text += x.elements[i].value + &quot;&lt;br&gt;&quot;;<br>}<br>document.getElementById(&quot;demo&quot;).innerHTML = text;</div>
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_htmldom_elements.js"></div>
<hr>
