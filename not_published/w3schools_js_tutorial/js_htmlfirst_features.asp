...
<html lang="en-US">
<head>
<title>Native HTML Features - Use built-in browser features before adding JavaScript.</title>
<meta charset="utf-8">
...
<h1>Native HTML Features</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_htmlfirst_progressive.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_htmlfirst_css.asp">Next &#10095;</a>
</div>

<div class="ws-info">
<p>HTML has many built-in features that can replace small JavaScript solutions.</p>
<p>Using native HTML makes pages simpler, faster, and easier to understand.</p>
<p>In HTML-first development, you should always ask: Can the browser already do this?</p>
</div>

<h2>The details Element</h2>

<p>The <code class="w3-codespan">&lt;details&gt;</code> element creates content that users can open and close.</p>

<p>The visible heading is written with the <code class="w3-codespan">&lt;summary&gt;</code> element.</p>
...
&nbsp;&nbsp;&lt;p&gt;This text is hidden until the user opens it.&lt;/p&gt;<br>
&lt;/details&gt;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_htmlfirst_summary" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="ws-note">
...
<p>HTML can validate form fields before a form is submitted.</p>

<p>You can use attributes like <code class="w3-codespan">required</code>, <code class="w3-codespan">minlength</code>, <code class="w3-codespan">maxlength</code>, and <code class="w3-codespan">pattern</code>.</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_htmlfirst_register" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="ws-note">
<p>The browser checks the fields automatically.</p>
</div>
...
<p>HTML includes input types for common data.</p>

<p>These input types can show better keyboards on mobile devices and provide built-in validation.</p>

<ul>
<li><code class="w3-codespan">type="email"</code></li>
<li><code class="w3-codespan">type="number"</code></li>
<li><code class="w3-codespan">type="date"</code></li>
<li><code class="w3-codespan">type="url"</code></li>
<li><code class="w3-codespan">type="search"</code></li>
</ul>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_htmlfirst_birthday" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">&lt;datalist&gt;</code> element gives users a list of suggested values.</p>

<p>The user can choose a suggestion or type another value.</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_htmlfirst_datalist" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">&lt;dialog&gt;</code> element can be used for dialog boxes and popups.</p>

<p>Opening and closing dialogs usually needs a small amount of JavaScript, but the dialog behavior is built into the browser.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;dialog open&gt;<br>
&nbsp;&nbsp;&lt;p&gt;This is an open dialog window.&lt;/p&gt;<br>
&lt;/dialog&gt;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_htmlfirst_dialog" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Lazy Loading Images</h2>
<p>Images can be lazy loaded with the <code class="w3-codespan">loading</code> attribute.</p>
<p>This can improve performance by loading images only when they are needed.</p>
<p>Modern browsers support a <code class="w3-codespan">loading="lazy"</code>
attribute for <code class="w3-codespan">&lt;img&gt;</code> and <code class="w3-codespan">&lt;iframe&gt;</code> elements.
This tells the browser to defer loading the resource until the user scrolls near it.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;!-- The browser handles the timing here --&gt;<br>
&lt;img src="image.jpg" alt="A mountain" loading="lazy"&gt;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_htmlfirst_lazy" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="ws-note">
<p>Use native HTML first. Add JavaScript only when native HTML cannot solve the problem.</p>
</div>
