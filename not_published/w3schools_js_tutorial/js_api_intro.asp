...
<a class="w3-right w3-btn" href="js_api_fetch.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
<p class="w3-large">A Web API is a developer's dream.</p>
<ul class="w3-large">
...
<p>API stands for <b>A</b>pplication <b>P</b>rogramming <b>I</b>nterface.</p>
...
const myElement = document.getElementById(&quot;demo&quot;);<br><br>
function getLocation() {<br>
&nbsp; if (navigator.geolocation) {<br>
&nbsp;&nbsp;&nbsp; navigator.geolocation.getCurrentPosition(showPosition);<br>
&nbsp; } else { <br>&nbsp;&nbsp;&nbsp; myElement.innerHTML = &quot;Geolocation is not supported by this browser.&quot;;<br>
&nbsp; }<br>
}<br><br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_api_geo_coordinates">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Most Important APIs</h2>
<p>The most important APIs in HTML/JavaScript development are.</p>
<ul>
<li><b>The DOM API</b> for HTML and XML documents</li>
<li><b>The Fetch API</b> for networking</li>
<li><b>The Web Storage API</b> for client-side data</li>
</ul> 
<p>These APIs are fundamental to nearly all modern web development.</p>

<hr>
<h2><a href="js_htmldom.asp">The DOM API</a></h2>
<p>
The DOM (Document Object Model) is the core API for HTML and XML documents.
It provides a structured representation of a webpage, allowing JavaScript to access and manipulate elements,
attributes, and content dynamically, creating interactive user interfaces.</p>

<hr>
<h2><a href="js_api_fetch.asp">The Fetch API</a></h2>
<p>
...
<hr>
<h2><a href="js_api_web_storage.asp">Web Storage API</a></h2>
<p>
...
<hr>
<h2><a href="js_api_history.asp">History API</a></h2>
<p>
