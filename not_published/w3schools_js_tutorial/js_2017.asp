...
<html lang="en-US">
<head>
<title>JavaScript ECMAScript 2017</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="js_2018.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_2016.asp">Next &#10095;</a>
</div>

<hr>
<h2>New Features in JavaScript 2017</h2>

<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
<tr><th>Feature</th><th>Description</th><th></th></tr>
<tr><td><a href="js_2017.asp?#mark_padding">String padStart()</a></td>
<td>Pads the beginning of a string</td><td></td></tr>
<tr><td><a href="js_2017.asp?#mark_padding">String padEnd()</a></td>
<td>Pads the end of a string</td><td></td></tr>
<tr><td><a href="js_2017.asp?#mark_obj_entries">Object entries()</a></td>
<td>Returns an array of the key/value pairs of an object</td><td></td></tr>
<tr><td><a href="js_2017.asp?#mark_obj_values">Object values()</a></td>
<td>Returns an array of the values of an object</td><td></td></tr>
<tr><td><a href="js_2017.asp?#mark_async">async and await</a></td>
<td>Simplifies the handling of promises</td><td></td></tr>
<tr><td><a href="js_2017.asp?#mark_trailing_commas">Trailing Commas</a></td>
<td>Allows trailing commas where a comma-separated list of values is accepted</td><td></td></tr>
<tr><td><a href="js_2017.asp?#mark_getownprop">getOwnProperty<br>Descriptors</a></td>
<td>Returns an object containing all own property descriptors of an object</td><td></td></tr>
</table>
</div>

<hr>
<h2>Browser Support</h2>
<p><b>JavaScript 2017</b> is supported in all modern browsers since <b>September 2017</b>:</p>
...
<p>ECMAScript 2017 added two string methods to JavaScript: <code class="w3-codespan">padStart()</code>
and <code class="w3-codespan">padEnd()</code> to support padding at the beginning and at the end of a string.</p>
<div class="w3-example">
<h3>Examples</h3>
<div class="w3-code notranslate jsHigh">
let text = &quot;5&quot;;<br>
text = text.padStart(4,0);<br>
</div>
<a class="w3-btn" href="tryit.asp?filename=tryjs_string_padding1" target="_blank">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
let text = &quot;5&quot;;<br>
text = text.padEnd(4,0);<br>
</div>
...
<h2>JavaScript Object Entries</h2>
<p>ECMAScript 2017 added the <code class="w3-codespan">Object.entries()</code> method to objects.</p>
<p><code class="w3-codespan">Object.entries()</code> returns an array of the key/value pairs in an object:</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_object_entries" target="_blank">Try it Yourself &raquo;</a>
</div>

<p><code class="w3-codespan">Object.entries()</code> makes it simple to use objects in loops:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const fruits = {Bananas:300, Oranges:200, Apples:500};<br>
<br>
let text = "";<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_object_entries_loop" target="_blank">Try it Yourself &raquo;</a>
</div>

<p><code class="w3-codespan">Object.entries()</code> also makes it simple to convert objects to maps:</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_object_entries_map" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<a id="mark_obj_values"></a>
<h2>JavaScript Object Values</h2>
<p><code class="w3-codespan">Object.values()</code> is similar to <code class="w3-codespan">Object.entries()</code>,
but returns a single dimension array of the object values:</p>
<div class="w3-example">
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_object_values" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<hr>
<a id="mark_async"></a>
<h2>JavaScript Async Functions</h2>
<div class="w3-example">
...
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_async4">Try it Yourself &raquo;</a>
</p>
</div>

<hr>
<a id="mark_trailing_commas"></a>
<h2>JavaScript Trailing Commas</h2>
<p>JavaScript allows trailing commas wherever a comma-separated list of values is accepted.</p>
<p>In Array and Object Literals, Function Calls, Parameters, Imports and Exports.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
function myFunc(x,,,) {};<br>
const myArr = [1,2,3,4,,,];<br>
const myObj = {fname: John, age:50,,,};<br>
</div>
</div>

<hr>
<a id="mark_getownprop"></a>
<h2>The Object.getOwnPropertyDescriptor() Method</h2>
<p><code class="w3-codespan">Object.getOwnPropertyDescriptors()</code>
returns all own property descriptors of a given object.</p>
<div class="w3-example">
<h3>Example</h3>
<p>The getOwnPropertyNames() method returns an array with the properties of an object:</p>
<div class="w3-code notranslate jsHigh">
const myProp = Object.getOwnPropertyNames(person);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_getownpropdes">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
<h3>Example</h3>
<p>The getOwnPropertyDescriptors() method returns the property descriptors of an object.</p>
<div class="w3-code notranslate jsHigh">
const myProp = Object.getOwnPropertyDescriptors(person);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_getownpropdes2">Try it Yourself &raquo;</a>
</div>

<p>A property descriptor is an object that describes all attributes of a property:</p>
<ul>
<li><b>value:</b> The property's value</li>
<li><b>writable:</b> true if the property value can be changed</li>
<li><b>enumerable:</b> true if the property will show up in loops (for...in, Object.keys())</li>
<li><b>configurable:</b> true if the property descriptor can be changed or deleted</li>
<li><b>get:</b> Function to get the property value (for accessor properties)</li>
<li><b>set:</b> Function to set the property value (for accessor properties)</li>
</ul>
<hr>
<h2>Object Cloning</h2>
<p>The <code class="w3-codespan">Object.getOwnPropertyDescriptors()</code>
is often used to clone objects while preserving getters, setters, and property attributes:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const clone = Object.defineProperties({}, Object.getOwnPropertyDescriptors(person));
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_getownpropdes3">Try it Yourself &raquo;</a>
</div>
<br><br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_2018.asp">&#10094; Previous</a>
