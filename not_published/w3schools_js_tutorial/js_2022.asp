...
<a class="w3-left w3-btn" href="js_2023.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_2021.asp">Next &#10095;</a>
</div>
...
<tr><td><a href="js_2022.asp?#mark_array_at">Array at()</a></td>
<td>Returns an indexed element from an array</td><td></td></tr>
<tr><td><a href="js_2022.asp?#mark_string_at">String at()</a></td>
<td>Returns an indexed element from an string</td><td></td></tr>
<tr><td><a href="js_2022.asp?#mark_regexp_d">RegExp /d</a></td>
<td>Perform substring matches</td><td></td></tr>
<tr><td><a href="js_2022.asp?#mark_hasown">Object.hasOwn()</a></td>
<td>Check if a property is the own property of an object</td><td></td></tr>
<tr><td><a href="js_2022.asp?#mark_error_cause">error.cause</a></td>
<td>Lets you specify the reason behind an error</td><td></td></tr>
<tr><td><a href="js_2022.asp?#mark_await_import">await import</a></td>
<td>Lets JavasSript modules wait for resources that require import before running.</td><td></td></tr>
<tr><td><a href="js_2022.asp?#mark_class_fields">Class field declarations</a></td>
<td>Allows for properties to be defined directly within a class</td><td></td></tr>
<tr><td><a href="js_2022.asp?#mark_private_methods">Private methods and fields</a></td>
...
<a target="_blank" href="tryit.asp?filename=tryjs_array_at2" class="w3-btn w3-margin_bottom">Try it Yourself &raquo;</a>
</div>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    ...
    <td><a target="_blank" class="w3-btn btnsmall w3-padding-small" href="tryit.asp?filename=tryjs_regexp_i">Try it &raquo;</a></td>
  </tr>
  <tr>
    <td>g</td>
    <td>Perform a global match (find all)</td>
    <td><a target="_blank" class="w3-btn btnsmall w3-padding-small" href="tryit.asp?filename=tryjs_regexp_g">Try it &raquo;</a></td>
  </tr>
  <tr>
    <td>m</td>
    <td>Perform multiline matching</td>
    <td><a target="_blank" class="w3-btn btnsmall w3-padding-small" href="tryit.asp?filename=tryjs_regexp_m">Try it &raquo;</a></td>
  </tr>
  <tr>
    <td>d</td>
    <td>Perform substring matches (New in ES2022)</td>
    <td><a target="_blank" class="w3-btn btnsmall w3-padding-small" href="tryit.asp?filename=tryjs_regexp_indices">Try it &raquo;</a></td>
  </tr>
</table>
...
<a target="_blank" href="tryit.asp?filename=tryjs_obj_hasown" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate jsHigh">
try {<br>
&nbsp; // Create a JSON parse failure<br>
&nbsp; JSON.parse("blablablabla");<br>
} catch(err) {<br>
&nbsp; let text = err.name + " " + err.message;<br>
}<br>
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_error_cause" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
<h3>Example (now)</h3>
<div class="w3-code notranslate jsHigh">
...
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Create a JSON parse failure<br>
&nbsp;&nbsp;&nbsp;&nbsp;JSON.parse("<b>blablablabla</b>");<br>
&nbsp;&nbsp;} catch(err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Create a new error and include the original one as the cause<br>
&nbsp;&nbsp;&nbsp;&nbsp;throw new Error("Failed to load JSON", {cause:err});<br>
&nbsp;&nbsp;}<br>
} catch(err){<br>
&nbsp;&nbsp;let text = err.name + " " + err.message;<br>
...
<a target="_blank" href="tryit.asp?filename=tryjs_error_cause2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate jsHigh">
class Hello {<br>
&nbsp;&nbsp;#counter = 0; &nbsp;// Private field<br>
&nbsp;&nbsp;#myMethod() {} // Private method<br>
}<br>
const myClass = new Hello();<br>
<br>
let x = myClass.#counter;  // Error<br>
myClass.#myMethod(); &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Error<br> 
</div>
</div>
<br>
<div class="w3-clear nextprev">
