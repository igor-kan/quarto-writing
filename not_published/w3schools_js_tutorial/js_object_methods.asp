...
<a class="w3-right w3-btn" href="js_object_this.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
<h2>What are Object Methods?</h2>
<p><b>Methods</b> are <b>actions</b> that can be performed on objects.</p>
<p>Methods are <b>functions</b> stored as <b>property values</b>.</p>
</div>
...
<p>In an object method, <code class="w3-codespan">this</code> refers to the object.</p>
...
&nbsp; id: 5566,<br>
&nbsp; getId: function() {<br>
&nbsp;&nbsp;&nbsp; return <b>this</b>.id;<br>
&nbsp; }<br>
};<br>
<br>
let number = person.getId();
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_object_function_this" target="_blank">
Try it Yourself &raquo;</a></div>
<p>In the example above, <b> <code class="w3-codespan">this</code></b> refers to the <b>person object</b>.</p>
<p><code class="w3-codespan"><b>this.id</b></code> means the <b>id property</b> of the <b>person object</b>.</p>
...
<p>In the example above, <b> <code class="w3-codespan">this</code></b> refers to the <b>person object</b>.</p>
<p><code class="w3-codespan"><b>this.firstName</b></code> means the <b>firstName property</b> of the <b>person object</b>.</p>  
<p><code class="w3-codespan"><b>this.lastName</b></code> means the <b>lastName property</b> of the <b>person object</b>.</p>  

<hr>
<!--start-->
<h2>Accessing Object Methods</h2>
<p>To <b>call</b> an object method, add <b>parentheses ()</b>:</p>
<p>Without parentheses you get the function itself.</p>
<div class="w3-example">
<h3>Syntax</h3>
<div class="w3-code w3-border notranslate">
<i>objectName.methodName</i>()</div>
</div>

<p>If you call a method <b>with parentheses</b>, it will <b>execute as a function</b>:</p>
...
<p>If you call a method <b>without parentheses</b>, it will return the <b>function definition</b>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate">
name = person.fullName;</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_object_function" target="_blank">
...
<p>You can add a method to an object by <b>assigning a function to a property</b>:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Assign person.name to a function<br> 
...
<p>In the example above, <b>person.name</b> is a property with a function assigned to it.</p>
<!--stop-->

<hr>
<!--start-->
<h2>Adding a JavaScript Method</h2>

<p>This example uses the JavaScript <code class="w3-codespan">toUpperCase()</code> method to convert a text 
to uppercase:</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_object_method_toupper" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
...
<ul>
  <li><b>Methods</b> are functions stored as <b>object properties</b></li>
  <li>Call a method with parentheses: <b>person.fullName()</b></li>
  <li>In methods, <b>this</b> refers to the object</li>
  <li>You can <b>add methods</b> to objects by assigning a <b>function to a property</b></li>
</ul>
...
<hr>
<div id="exercisecontainer" src="xrcise_object_method.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_object_properties.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_object_this.asp">Next &#10095;</a>
