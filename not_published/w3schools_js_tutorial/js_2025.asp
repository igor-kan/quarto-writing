...
<h1>ECMAScript 2025</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_2026.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_2024.asp">Next &#10095;</a>
</div>

<div class="ws-info">
<h2>New Features in JavaScript 2025</h2>
<p>The <b>16th edition</b> of the ECMAScript standard, released in <b>June 2025</b>, includes several enhancements
to make JavaScript more readable and efficient.</p>
</div>

<hr>
<h2>New <b>Set Features</b> in ES2025</h2>
<p>JavaScript 2025 includes built-in methods for set operations, such as intersection(), union(), and difference(),
eliminating the need for manual loops or third-party libraries.</p>
<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
<tr><th>Feature</th><th>Description</th><th></th></tr>
<tr><td><a href="js_2025.asp?#mark_set_union">union()</a></td>
<td>Returns the union of two sets</td><td></td></tr>
<tr><td><a href="js_2025.asp?#mark_set_intersection">intersection()</a></td>
<td>Returns the intersection of two sets</td><td></td></tr>
<tr><td><a href="js_2025.asp?#mark_set_difference">difference()</a></td>
<td>Returns the difference between two sets</td><td></td></tr>
<tr><td><a href="js_2025.asp?#mark_set_symmetric_difference">symmetricDifference()</a></td>
<td>Returns the symmetric difference between to sets</td><td></td></tr>
<tr><td><a href="js_2025.asp?#mark_set_issubsetof">isSubsetOf()</a></td>
<td>Returns true if this set is a subset of a given set</td><td></td></tr>
<tr><td><a href="js_2025.asp?#mark_set_issupersetof">isSupersetOf()</a></td>
<td>Returns true if this set is a superset of a given set</td><td></td></tr>
<tr><td><a href="js_2025.asp?#mark_set_isdisjointfrom">isDisjointFrom()</a></td>
<td>Returns true if this set has no elements in in a given set</td><td></td></tr>
</table>
</div>

<hr>
<h2>New <b>Iterator Helpers</b> in ES2025</h2>
<p>The introduction of an Iterator object provides a functional interface with lazy evaluation,
allowing developers to wrap various iterators like Arrays.</p>
<p>A new set of functional operators for iterators (like .map(), .filter(), and .take()) allows for lazy evaluation,
improving performance when handling large data streams.</p>
<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
<tr><th>Function</th><th>Description</th></tr>
<tr><td><a href="js_2025.asp?#mark_iterator_drop">drop()</a></td><td>Returns an iterator that skips a specified number of elements before yielding the rest</td></tr>
<tr><td><a href="js_2025.asp?#mark_iterator_every">every()</a></td><td>Returns <code class="w3-codespan">true</code> if all elements satisfy a test function</td></tr>
<tr><td><a href="js_2025.asp?#mark_iterator_filter">filter()</a></td><td>Returns an iterator containing elements that satisfy a filter function</td></tr>
<tr><td><a href="js_2025.asp?#mark_iterator_find">find()</a></td><td>Returns the first element that satisfies a test function</td></tr>
<tr><td><a href="js_2025.asp?#mark_iterator_flatmap">flatMap()</a></td><td>Returns an iterator by mapping each element and then flattening the results</td></tr>
<tr><td><a href="js_2025.asp?#mark_iterator_foreach">forEach()</a></td><td>Executes a function once for each element in the iterator.</td></tr>
<tr><td><a href="js_2025.asp?#mark_iterator_from">from()</a></td><td>creates an iterator object from an iterable</td></tr>
<tr><td><a href="js_2025.asp?#mark_iterator_map">map()</a></td><td>Returns an iterator with all elements transformed by a map function</td></tr>
<tr><td><a href="js_2025.asp?#mark_iterator_reduce">reduce()</a></td><td>Applies a reducer function against each element to reduce it to a single value</td></tr>
<tr><td><a href="js_2025.asp?#mark_iterator_some">some()</a></td><td>Returns <code class="w3-codespan">true</code> if at least one element satisfy a test function</td></tr>
<tr><td><a href="js_2025.asp?#mark_iterator_take">take()</a></td><td>Returns an iterator that yields a specified number of elements</td></tr>
</table>
</div>
...
<hr>
<h2>Other New Features in ES2025</h2>

<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
<tr><th>Feature</th><th>Description</th><th></th></tr>
<tr><td><a href="js_2025.asp?#mark_regexp_vflag">RegExp /v flag</a></td>
<td>An "upgrade" to the /u (unicode) flag</td><td></td></tr>
<tr><td><a href="js_2025.asp?#mark_regexp_escape">RegExp.escape()</a></td>
<td>Returns a string where regex characters are escaped</td><td></td></tr>
<tr><td><a href="js_2025.asp?#mark_float16_array">Float16Array</a></td>
<td>A Typed Array that stores 16-bit floating-point numbers</td><td></td></tr>
<tr><td><a href="js_2025.asp?#mark_math_f16round">Math.f16round()</a></td>
<td>Returns the nearest 16-bit floating point number</td><td></td></tr>
<tr><td><a href="js_2025.asp?#mark_promise_try">Promise.try()</a></td>
<td>Starts a promise chain for handling promise rejections</td><td></td></tr>
<tr><td><a href="js_2025.asp?#mark_import_attributes">Import Attributes</a></td>
<td>Import attributes allowed in import statements</td><td></td></tr>
</table>
</div>
...
<hr>
<a id="mark_set_union"></a>
<h2>JavaScript Set union()</h2>
<p>The <code class="w3-codespan">union()</code> method returns the union of two sets.</p>
<p>The <code class="w3-codespan">union()</code> method returns a new set containing the elements which are in this set,
or in the argument set, or in both:</p>

<p><img style="width:40%;max-width:200px" alt="Union" src="img_set_union_300.jpg"></p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const A = new Set(['a','b','c']);<br>
const B = new Set(['b','c','d']);<br>
<br>
const C = A.union(B);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_set_union" target="_blank">Try it Yourself &raquo;</a>
</div>
<p>The <code class="w3-codespan">union()</code> method is supported in all modern browsers since June 2024:</p>
...
<hr>
<a id="mark_set_intersection"></a>
<h2>JavaScript Set intersection()</h2>
<p>The <code class="w3-codespan">intersection()</code> method returns the intersection of two sets.</p>
<p>The <code class="w3-codespan">intersection()</code> method returns a new set containing the elements which are in this set
and in the argument set:</p>
<p><img style="width:40%;max-width:200px" alt="Intersection" src="img_set_intersection_300.jpg"></p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const A = new Set(['a','b','c']);<br>
const B = new Set(['b','c','d']);<br>
<br>
const C = A.intersection(B);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_set_intersection" target="_blank">Try it Yourself &raquo;</a>
</div>

<p>The <code class="w3-codespan">intersection()</code> method is supported in all modern browsers since June 2024:</p>
<div class="w3-responsive w3-stretch">
<table class="browserref notranslate">
  <tbody><tr>
    <th class="bsChrome" title="Chrome"></th>
...
<hr>
<a id="mark_set_difference"></a>
<h2>JavaScript Set difference()</h2>
<p>The <code class="w3-codespan">difference()</code> method returns the difference between two sets.</p>
<p>The <code class="w3-codespan">difference()</code> method returns a new set containing elements which are in this set
but not in the argument set:</p>
<p><img style="width:40%;max-width:200px" alt="Difference" src="img_set_difference_300.jpg"></p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const A = new Set(['a','b','c']);<br>
const B = new Set(['b','c','d']);<br>
<br>
const C = A.difference(B);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_set_difference" target="_blank">Try it Yourself &raquo;</a>
</div>
<p>The <code class="w3-codespan">difference()</code> method is supported in all modern browsers since June 2024:</p>
<div class="w3-responsive w3-stretch">
<table class="browserref notranslate">
  <tbody><tr>
    <th class="bsChrome" title="Chrome"></th>
...
<hr>
<a id="mark_set_symmetric_difference"></a>
<h2>JavaScript Set symmetricDifference()</h2>
<p>The <code class="w3-codespan">symmetricDifference()</code> method returns the symmetric difference between to sets.</p>
<p>The <code class="w3-codespan">symmetricDifference()</code> method returns a new set containing elements which are in this set
or in the argument set, but not in both:</p>
<p><img style="width:40%;max-width:200px" alt="Symmetric Difference" src="img_set_symmetric_difference_300.jpg"></p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const A = new Set(['a','b','c']);<br>
const B = new Set(['b','c','d']);<br>
<br>
const C = A.symmetricDifference(B);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_set_symmetric_difference" target="_blank">Try it Yourself &raquo;</a>
</div>
<p>The <code class="w3-codespan">symmetricDifference()</code> method is supported in all modern browsers since June 2024:</p>
<div class="w3-responsive w3-stretch">
<table class="browserref notranslate">
  <tbody><tr>
    <th class="bsChrome" title="Chrome"></th>
...
<hr>
<a id="mark_set_issubsetof"></a>
<h2>JavaScript Set isSubsetOf()</h2>
<p>The <code class="w3-codespan">isSubsetOf()</code> method returns <code class="w3-codespan">true</code>
if all elements in this set are elements in the argument set:</p>
<p><img style="width:40%;max-width:200px" alt="Subset" src="img_set_subset_300.jpg"></p>
...
const B = new Set(['b','c','d']);<br>
<br>
let answer = A.isSubsetOf(B);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_set_is_subset_of" target="_blank">Try it Yourself &raquo;</a>
</div>

<p>The <code class="w3-codespan">isSubsetOf()</code> method is supported in all modern browsers
since June 2024:</p>
...
<hr>
<a id="mark_set_issupersetof"></a>
<h2>JavaScript Set isSupersetOf()</h2>
<p>The <code class="w3-codespan">isSupersetOf()</code> method returns <code class="w3-codespan">true</code> if all elements in the argument set are also in this set:</p>
<p><img style="width:40%;max-width:200px" alt="Superset" src="img_set_superset_300.jpg"></p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const A = new Set(['a','b','c']);<br>
const B = new Set(['b','c','d']);<br>
<br>
let answer = A.isSupersetOf(B);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_set_is_superset_of" target="_blank">Try it Yourself &raquo;</a>
</div>
<p>The <code class="w3-codespan">isSupersetOf()</code> method is supported in all modern browsers since June 2024:</p>
<div class="w3-responsive w3-stretch">
<table class="browserref notranslate">
  <tbody><tr>
    <th class="bsChrome" title="Chrome"></th>
...
<hr>
<a id="mark_set_isdisjointfrom"></a>
<h2>JavaScript Set isDisjointFrom()</h2>
<p>The <code class="w3-codespan">isDisjointFrom()</code> method returns <code class="w3-codespan">true</code>
if this set has no elements in common with the argument set:</p>
<p><img style="width:40%;max-width:200px" alt="Disjoint" src="img_set_disjoint_300.jpg"></p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const A = new Set(['a','b','c']);<br>
const B = new Set(['b','c','d']);<br>
<br>
let answer = A.isDisjointFrom(B);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_set_is_disjoint_from" target="_blank">Try it Yourself &raquo;</a>
</div>
<p>The <code class="w3-codespan">Set.isDisjointFrom()</code> method is supported in all modern browsers since June 2024:</p>
<div class="w3-responsive w3-stretch">
<table class="browserref notranslate">
  <tbody><tr>
    <th class="bsChrome" title="Chrome"></th>
...
<hr>
<a id="mark_iterator_drop"></a>

<a id="mark_iterator_from"></a>
<hr>
<h2>The Iterator.from() Method</h2>
<p>The <code class="w3-codespan">Iterator.from()</code>
creates an iterator object from an existing iterable or iterator object.</p> 
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create an iterator<br>
const myIterator = Iterator.from([1, 2, 3]);<br>
<br>
// Iterate over the elements<br>
let text = "";<br>
for (const x of myIterator) {<br>
&nbsp; text += x;<br>
}<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_iterator_from" target="_blank">Try it Yourself &raquo;</a>
</div>

<a id="mark_iterator_drop"></a>
<hr>
<h2>The drop() Method</h2>
<p>The <code class="w3-codespan">drop()</code> method
returns a new iterator that skips a specified number of elements before yielding the rest.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create an iterator<br>
const myIterator = Iterator.from([1, 2, 3, 4, 5, 6]);<br>
<br>
// Remove the first five<br>
const firstFive = myIterator.drop(5);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_iterator_drop" target="_blank">Try it Yourself &raquo;</a>
</div>

<a id="mark_iterator_every"></a>
<hr>
<h2>The every() Method</h2>
<p>The <code class="w3-codespan">every(fn)</code> method
returns <code class="w3-codespan">true</code> if all elements in the iterator satisfy the provided test function.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create an Iterator<br>
const myIterator = Iterator.from("123456789");<br>
<br>
// Is every Element greater than 7?<br>
let result = myIterator.every(x =&gt; x &gt; 7);
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_iterator_every" target="_blank">Try it Yourself &raquo;</a>
</div>

<a id="mark_iterator_filter"></a>
<hr>
<h2>The filter() Method</h2>
<p>The <code class="w3-codespan">filter()</code> method
returns a new iterator containing elements that satisfy a filter function.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create an iterator<br>
const myIterator = Iterator.from([32, 33, 16, 40]);<br>
<br>
// Filter the iterator<br>
const filteredIterator = myIterator.filter(x =&gt; x &gt; 18);</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_iterator_filter" target="_blank">Try it Yourself &raquo;</a>
</div>

<a id="mark_iterator_find"></a>
<hr>
<h2>The find() Method</h2>
<p>The <code class="w3-codespan">find(fn)</code> method
returns the first element that satisfies a test function.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create an iterator<br>
const myIterator = Iterator.from([3, 10, 18, 30, 20]);<br>
<br>
// Find first greater than 18<br>
let result = myIterator.find(x =&gt; x &gt; 18);
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_iterator_find" target="_blank">Try it Yourself &raquo;</a>
</div>

<a id="mark_iterator_flatmap"></a>
<hr>
<h2>The flatMap() Method</h2>
<p>The <code class="w3-codespan">flatMap()</code> method
returns a new iterator by mapping each element and then flattening
the results into a single iterator.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create an iterator<br>
...
<br>
// Map the Iterator<br>
const mappedIterator = myIterator.flatMap(x =&gt; [x, x * 10]);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_iterator_flatmap" target="_blank">Try it Yourself &raquo;</a>
</div>

<a id="mark_iterator_foreach"></a>
<hr>
<h2>The forEach() Method</h2>
<p>The <code class="w3-codespan">forEach()</code> method
executes a provided function once for each element in the iterator.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create an iterator<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_iterator_foreach" target="_blank">Try it Yourself &raquo;</a>
</div>

<a id="mark_iterator_map"></a>
<hr>
<h2>The map() Method</h2>
<p>The <code class="w3-codespan">map()</code> method
returns a new iterator with all elements transformed by a map function.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create an iterator<br>
const myIterator = Iterator.from("123456789");<br>
<br>
// Now you can use the map method<br>
const mappedIterator = myIterator.map(x =&gt; x * 2);
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_iterator_map" target="_blank">Try it Yourself &raquo;</a>
</div>

<a id="mark_iterator_reduce"></a>
<hr>
<h2>The reduce() Method</h2>
<p>The <code class="w3-codespan">reduce()</code> method
applies a reducer function against an accumulator and each element to reduce it to a single value.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create an Iterator<br>
const myIterator = Iterator.from([175, 50, 25]);<br>
<br>
// Reduce the Iterator<br>
let result = myIterator.reduce(myFunc);
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_iterator_reduce" target="_blank">Try it Yourself &raquo;</a>
</div>

<a id="mark_iterator_some"></a>
<hr>
<h2>The some() Method</h2>
<p>The <code class="w3-codespan">some()</code> method
returns <code class="w3-codespan">true</code> if at least one element in the iterator satisfies the provided test function.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create an Iterator<br>
const myIterator = Iterator.from("123456789");<br>
<br>
// Is some Element greater than 7?<br>
let result = myIterator.some(x =&gt; x &gt; 7);
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_iterator_some" target="_blank">Try it Yourself &raquo;</a>
</div>

<a id="mark_iterator_take"></a>
<hr>
<h2>The take() Method</h2>
<p>The <code class="w3-codespan">take()</code> method
returns a new iterator that yields at most a specified number of elements.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const myIterator = Iterator.from([1, 2, 3, 4, 5, 6]);<br>
<br>
// Take the first five elements<br>
const firstFive = myIterator.take(5);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_iterator_take" target="_blank">Try it Yourself &raquo;</a>
</div>


<hr>
<a id="mark_regexp_vflag"></a>
<h2>The RegExp /v Flag</h2>
<p>The <b>v</b> flag is an "upgrade" to the <b>u</b> flag.</p>
<p>The <b>u</b> (unicode) flag enables full Unicode support in regular expressions.</p>
<p>The <b>v</b> flag enables more Unicode-related features.</p>
<p>The new features are:</p>
<ul>
<li>The \p escape sequence matches strings, instead of just characters.</li>
<li>The character class is upgraded to allow intersection, union, and subtraction syntaxes,
as well as matching multiple Unicode characters.</li>
</ul>
<div class="w3-example">
<h3>Examples</h3>
<div class="w3-code notranslate jsHigh">
let text = "Hello &#128516;";<br>
<br>
let pattern = /\p{RGI_Emoji}/v;<br>
let result = pattern.test(text);<br>
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_regexp_flag_v" class="w3-btn">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
let text = "Hello &#128516;";<br>
<br>
let pattern = /\p{RGI_Emoji}/;<br>
let result = pattern.test(text);<br>
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_regexp_flag_v_2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="ws-note">

<p>Using both flags (u and v) results in a SyntaxError.</p>
</div>

<p><code class="w3-codespan">/<i>regexp</i>/v</code> is supported all in modern browsers since May 2025:</p>
<div class="w3-responsive w3-stretch">
<table class="browserref notranslate">
  <tbody><tr>
    <th class="bsChrome" title="Chrome"></th>
  ...
  <tr>
    <td>Chrome<br>136</td>    
    <td>Edge<br>136</td>
    <td>Firefox<br>134</td>
    <td>Safari<br>18.2</td>
    <td>Opera<br>121</td>
  </tr>
  <tr>
    <td>Apr 2025</td>
...
<hr>
<a id="mark_regexp_escape"></a>
<h2>The RegExp.escape() Method</h2>
<p>The <code class="w3-codespan">RegExp.escape()</code> method returns a string where characters that belongs
to the regular expression syntax are escaped.</p>
<p>This makes it possible to treat characters like +, *, ?, ^, $, (, ), [, ], {, }, |, and \ literally,
and not as part of a regular expression.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Create a regular expression that matches the string "[*]":
<div class="w3-code notranslate jsHigh">
// Escape a text for to use as a regular expression<br>
const safe = RegExp.escape("[*]");<br>
<br>
// Build a new reglar expression<br>
const regex = new RegExp(safe);<br>
<br>
// Text to replace within<br>
const oldText = "[*] is a web school.";<br>
<br>
// Perform the replace<br>
const newText = oldText.match(regex, "W3Schools");<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_regexp_escape" target="_blank">Try it Yourself &raquo;</a>
</div>
<p><code class="w3-codespan">RegExp.escape()</code> is supported all in modern browsers since May 2025:</p>
<div class="w3-responsive w3-stretch">
<table class="browserref notranslate">
  <tbody><tr>
    <th class="bsChrome" title="Chrome"></th>
...
<hr>
<a id="mark_float16_array"></a>
<h2>The Float16Array Method</h2>
<p>A <code class="w3-codespan">Float16Array</code> is a <b>TypedArray</b> that stores 16-bit (half-precision)
floating-point numbers in the IEEE 754 half-precision format.</p>
<p>Float16Array requires half the memory of <code class="w3-codespan">Float32Array</code>
and a quarter of <code class="w3-codespan">Float64Array</code>.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const myArr = new Float16Array([1.5, 2.5, 3.5, 4.5]);<br>
<br>
let bytes = myArr.BYTES_PER_ELEMENT;<br>
let length = myArr.length;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_float16_array" target="_blank">Try it Yourself &raquo;</a>
</div>
<p>The <code class="w3-codespan">Float16Array</code> object is supported in all modern browsers since June 2024:</p>
<div class="w3-responsive w3-stretch">
<table class="browserref notranslate">
  <tbody><tr>
    <th class="bsChrome" title="Chrome"></th>
...
<hr>
<a id="mark_math_f16round"></a>
<h2>The Math.f16round Method</h2>
<p>The static <code class="w3-codespan">Math.f16round()</code> method returns the nearest 16-bit floating point representation of a number.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let a = Math.f16round(2.60);<br>
let b = Math.f16round(2.50);<br>
let c = Math.f16round(2.49);<br>
let d = Math.f16round(-2.60);<br>
let e = Math.f16round(-2.50);<br>
let f = Math.f16round(-2.49);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_math_f16round" target="_blank">Try it Yourself &raquo;</a>
</div>
<p>The <code class="w3-codespan">Math.f16round()</code> method is supported in all modern browsers since June 2024:</p>
<div class="w3-responsive w3-stretch">
<table class="browserref notranslate">
  <tbody><tr>
    <th class="bsChrome" title="Chrome"></th>
...
<hr>
<a id="mark_promise_try"></a>
<h2>The Promise.try() Method</h2>
<p>The Promise.try() method starts a promise chain from potentially throwing, synchronous code.</p>
<p>This ensures exceptions are correctly handled as promise rejections.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
function compute() {<br>
&nbsp;&nbsp;return Promise.try(() =&gt; {<br>
&nbsp;&nbsp;&nbsp;&nbsp;const v = mayThrowSync();<br>
&nbsp;&nbsp;&nbsp;&nbsp;return asyncFunc(v);<br>
&nbsp;&nbsp;});<br>
}<br>
</div>
</div>
...
<hr>
<a id="mark_import_attributes"></a>
<h2>Modules with Import Attributes</h2>
<div class="w3-example">
<h3>Syntax</h3>
<div class="w3-code notranslate jsHigh">
...
<h3>Examples</h3>
<div class="w3-code notranslate jsHigh">
import config from "config.json" with {type:"json"};<br>
<br>
