...
<a class="w3-right w3-btn" href="js_continue.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
<h2>The Break Statement</h2>
<p class="intro">The <code class="w3-codespan">break</code> statement &quot;jumps out&quot; of loops and switches.</p>

<p class="intro">The <code class="w3-codespan">break</code> statement <b>terminates</b> the execution
of a <b>loop</b> or a <b>switch</b> statement.</p>
</div>

<h2>Break in Loops</h2>
<p>When <code class="w3-codespan">break</code> is encountered in a loop,
<b>the loop terminates immediately</b>.
<p>The program control is transfered to the statements following the loop.</p>
<p><b>No more loop iterations</b> are executed.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Terminate the loop (break the loop) when the loop counter (i) is 3:</p>
...
<p>You have already seen the <code class="w3-codespan">break</code> statement used in an earlier 
chapter of this tutorial.</p>
<p>It was used to &quot;jump out&quot; of a <code class="w3-codespan">switch</code> statement.</p>
</div>

<h2>Break in a Switch</h2>
<p>In a <code class="w3-codespan">switch</code> statement, a <code class="w3-codespan">break</code> statement
will exit the switch block after a matching case is executed. Without break, execution would "fall through" to subsequent case blocks.</p>
<!--stop-->

<div class="w3-example">
<h3>Example</h3>
<p>Use the weekday number to calculate the weekday name:</p>
<div class="w3-code notranslate jsHigh">
...
<a target="_blank" href="tryit.asp?filename=tryjs_switch_break" class="w3-btn w3-margin-bottom w3-margin-top">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">

<p>The <code class="w3-codespan">break</code> keyword is crucial for preventing a switch "fall-through."</p>
<p>Without <code class="w3-codespan">break</code>, the code will continue to execute the next case blocks
(and the default block if present) <b>even if their values do not match the expression</b>.</p>
</div>
...
<p>A label provides a name for a statement, or a block of statements,
allowing statements to be referenced to, for program flow control,
particularly in loops.</p>


<div class="w3-example">
<h3>Syntax</h3>
<p>A label is an identifier followed by a colon (<b>:</b>).</p>
<div class="w3-code notranslate jsHigh">
<i>labelname</i>: <i>statement</i>;
</div>
<p>A label precedes a statement or a block of code.</p>
<div class="w3-code notranslate jsHigh">
<i>labelname</i>: {<br>
&nbsp; <i>statements</i><br>
}
...
break <em>labelname</em>; <br>
</div>
</div>

<p>The <code class="w3-codespan">break</code> statement exits a loop or block
and transfers the control to the labeled statement.</p>
<p>The <code class="w3-codespan">break</code> statement is particularly useful for breaking out of
inner or outer loops from nested loops.</p>


<div class="w3-example">
<h3>Example</h3>
<p>Break to <b>loop1</b>:</p>
<div class="w3-code notranslate jsHigh">
let text = "";<br>
<br>
loop1: for (let j = 1; j &lt; 5; j++) {<br>
&nbsp;&nbsp;loop2: for (let i = 1; i &lt; 5; i++) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (i === 3) { break loop1; }<br>
&nbsp;&nbsp;&nbsp;&nbsp;text += i;<br>
&nbsp;&nbsp;  }<br>
}
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_break_label1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Break to <b>loop2</b>:</p>
<div class="w3-code notranslate jsHigh">
let text = "";<br>
<br>
loop1: for (let j = 1; j &lt; 5; j++) {<br>
&nbsp;&nbsp;loop2: for (let i = 1; i &lt; 5; i++) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (i === 3) { break loop2; }<br>
&nbsp;&nbsp;&nbsp;&nbsp;text += i;<br>
&nbsp;&nbsp;  }<br>
}
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_break_label2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">

<p><code class="w3-codespan">break</code> and <code class="w3-codespan">continue</code>
are the only JavaScript statements that can &quot;jump out of&quot; a code block.</p>
<p>A code block is a block of code between { and }.</p>

<p>Without a label reference, <code class="w3-codespan">break</code> can only <strong>
jump out of a loop or a switch</strong>.</p>
<p>With a label reference, <code class="w3-codespan">break</code> can <strong>jump out 
of any code block</strong>:</p>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Break out of the block after the second car:</p>
<div class="w3-code notranslate jsHigh">
