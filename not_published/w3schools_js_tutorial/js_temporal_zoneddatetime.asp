...
<html lang="en-US">
<head>
<title>JavaScript Temporal.ZonedDateTime - Handle Time Zones Correctly</title>
<meta charset="utf-8">
...
<h1>JavaScript ZonedDateTime</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_temporal_plaintime.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_temporal_now.asp">Next &#10095;</a>
</div>
<div class="ws-info">
<h2>Handle Time Zones Correctly</h2>
<p>The <b>Temporal.ZonedDateTime object</b> represents a date and time with a time zone.</p>
<p>It is the safest way to handle international date and time calculations.</p>
<p>It prevents common DST bugs and makes time zone conversions clear and predictable.</p>
<h4>What You Will Learn:</h4>
<ul>
<li>How to use JavaScript Temporal.ZonedDateTime</li>
<li>How to handle time zones correctly</li>
<li>How to add and subtract date</li>
<li>How to avoid DST (Daylight Saving Time) bugs</li>
<li>How to convert between time zones safely</li>
</ul>
</div>

<hr>
<h2>Why ZonedDateTime Is Important</h2>
<p>Time zones and daylight saving time (DST) can cause serious bugs when using JavaScript <code class="w3-codespan">Date</code>.</p>
<p>ZonedDateTime solves this by always storing the time zone together with the date and time.</p>
<p>A <b>Temporal.ZonedDateTime</b> is a timezone and calendar-aware
date/time object that represents a real time event from the perspective of a particular
region on Earth.</p>

<p>The Temporal.ZonedDateTime object is optimized for cases that
require a time zone, <b>DST-safe arithmetic</b> and interoperability with an <b><b>RFC 5545 calendar</b></b>.</p>

<p>Example: December 7th, 1995 at 3:24 AM in US Pacific time (in Gregorian calendar).</p>

<hr>
<h2>Create a ZonedDateTime</h2>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const zonedDate = Temporal.ZonedDateTime.from({<br>
&nbsp;&nbsp;timeZone: 'Europe/Oslo',<br>
&nbsp;&nbsp;year: 2026,<br>
&nbsp;&nbsp;month: 5,<br>
&nbsp;&nbsp;day: 17,<br>
&nbsp;&nbsp;hour: 14,<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_zoned" target="_blank">Try it Yourself &raquo;</a>
</div>

<p>You can also create a ZonedDateTime from a string that includes a time zone.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const zdt = Temporal.ZonedDateTime.from<br>
("2026-02-17T14:30:00[Europe/Oslo]");
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_zoned_2" target="_blank">Try it Yourself &raquo;</a>
</div>


<div class="ws-note">

<p>The time zone name is written inside square brackets.</p>
</div>

<hr>
<h2>Get Current Date and Time with Time Zone</h2>

<p>The <code class="w3-codespan">Temporal.Now.zonedDateTimeISO()</code> method returns your system's current date, time,
and time zone as a <code class="w3-codespan">Temporal.ZonedDateTime</code> object.</p> 
<div class="w3-example">
<h3>Example</h3>
<p>Get the current date and time from your system's time zone:</p>
<div class="w3-code notranslate jsHigh">
const now = Temporal.Now.zonedDateTimeISO();
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_zoned_system_time" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="ws-note">

<p>The current time is returned in <b>ISO 8601</b> format.</p>
</div>


<hr>
<h2>The ISO 8601 Format</h2>
<ul> 
<li>2026-03-02: The calendar date (Year-Month-Day).</li>
<li>T10:36:00: The time of day (T-Hour:Minute:Second).</li>
<li>+01:00: The offset from UTC (Coordinated Universal Time).</li>
<li>[Europe/Oslo]: The IANA time zone name, which is the system's local time zone in this case.</li>
</ul>

<hr>
<h2>Convert Between Time Zones</h2>
<p>You can convert a ZonedDateTime to another time zone.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const oslo = Temporal.ZonedDateTime.from<br>
("2026-05-17T14:30:00+01:00[Europe/Oslo]");<br>
<br>
const newYork = oslo.withTimeZone("America/New_York");<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_zoned_now" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="ws-note">

<p>The exact moment stays the same, but the local clock time changes.</p>
</div>

<hr>
<h2>Add Time Safely (DST Safe)</h2>
<p>Adding days across a daylight saving change can break with <b>Javascript Date</b>.</p>
<p><b>Temporal.ZonedDateTime</b> handles this correctly.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const start = Temporal.ZonedDateTime.from<br>
("2026-03-29T00:00:00+01:00[Europe/Oslo]");<br>
<br>
const nextDay = start.add({ days: 1 });<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_zoned_add" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="ws-note">

<p>Temporal adjusts automatically if a DST change happens.</p>
</div>

<hr>
<h2>ZonedDateTime since()</h2>
...
<div class="w3-code notranslate jsHigh">
const start = Temporal.ZonedDateTime.from(<br>
"2026-02-17T09:00:00+01:00[Europe/Oslo]");<br>
<br>
const end = Temporal.ZonedDateTime.from(<br>
"2026-02-17T17:30:00+01:00[Europe/Oslo]");<br>
<br>
const duration = end.since(start); 
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_duration_since2" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>JavaScript since() and until()</h2>
<p><b>All temporal date objects</b> have their own <b>since() method</b>:</p>
<ul class="w3-large">
<li><i>plaindate</i>.since(<i>plaindate</i>)</li>
<li><i>plaintime</i>.since(<i>plaintime</i>)</li>
<li><i>plainyearmonth</i>.since(<i>plainyearmonth</i>)</li>
<li><i>plainmonthday</i>.since(<i>plainmonthday</i>)</li>
<li><i>plaindatetime</i>.since(<i>plaindatetime</i>)</li>
<li><i>zoneddatetime</i>.since(<i>zoneddatetime</i>)</li>
<li><i>instant</i>.since(<i>instant</i>)</li>
</ul>
<p><b>All temporal objects</b> have their own <b>until() method</b>:</p>
<ul class="w3-large">
<li><i>plaindate</i>.until(<i>plaindate</i>)</li>
<li><i>plaintime</i>.until(<i>plaintime</i>)</li>
<li><i>plainyearmonth</i>.until(<i>plainyearmonth</i>)</li>
<li><i>plainmonthday</i>.until(<i>plainmonthday</i>)</li>
<li><i>plaindatetime</i>.until(<i>plaindatetime</i>)</li>
<li><i>zoneddatetime</i>.until(<i>zoneddatetime</i>)</li>
<li><i>instant</i>.until(<i>instant</i>)</li>
</ul>

<div class="ws-note">
<h2>LearnMore:</h2>
<p class="w3-large"><a href="js_temporal_differences.asp">JavaScript Temporal Since and Until</a></p>
</div>

<hr>
<h2>The with() Method</h2>
<p>The <code class="w3-codespan">with()</code> method creates a new zoned date-time with specified field(s) replaced.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create a ZonedDateTime<br>
const date = Temporal.ZonedDateTimr.from("2026-05-17T14:30:00[Europe/Oslo]");<br>
<br>
// Replace month and day<br>
const customDate = date.with({ month:12, day:25 });<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_zoned_width" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Convert from Instant</h2>
<p>An <code class="w3-codespan">Instant</code> represents a UTC moment.</p>
<p>You can convert it to a ZonedDateTime in a specific time zone.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const instant = Temporal.Now.instant();<br>
<br>
const zoned = instant.toZonedDateTimeISO("Europe/Oslo");<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_zoned_from_instant" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<h2>ZonedDateTime vs PlainDateTime</h2>
<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
<tr><th>Type</th><th>Meaning</th></tr>
<tr><td>Instant</td><td>Exact Moment in UTC time</td></tr>
<tr><td>PlainDateTime</td><td>Plain Date and Time (No Timezone)</td></tr>
<tr><td>ZonedDateTime</td><td>Local Date and Time (+ Time Zone)</td></tr>
</table>
</div>
<div class="w3-stretch">
...
<hr>
<h2>When to Use ZonedDateTime</h2>
<ul>
<li><p>International applications.</p></li>
<li><p>Booking systems.</p></li>
<li><p>Flight or travel systems.</p></li>
<li><p>Applications that must handle DST correctly.</p></li>
<li><p>Any system where time zones matter.</p></li>
</ul>
