...
<a class="w3-left w3-btn" href="js_function_arguments.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_arrow_function.asp">Next &#10095;</a>
</div>

<div class="ws-info">
<h2>What is a Function Expression?</h2>
<p>A function expression is a <b>function stored in a variable</b>.</p>
...
<p>Function expressions are commonly used to create <b>anonymous functions</b>.</p>
<p>The function above is actually function <b>without a name</b>.</p>
<p>Functions stored in variables <b>do not need names</b>.</p>
<p>The <b>variable name is used</b> to call the function.</p>

<div class="ws-note">

<p>But, function expressions can also be a named:</p>
<div class="w3-code notranslate jsHigh">
...
<hr>
<h2>Function Expressions Use Semicolons</h2>
<p>A function expression is a JavaScript <b>statement</b>.</p>
<p>That is why it usually ends with a <b>semicolon</b><b></b>.</p>
...
<hr>
<h2>Functions Stored in Variables</h2>
<p>
Because a function expression is stored in a variable, it can be used like a value.<br>
This is useful when passing functions to other functions (callbacks).<br>
</p>
<p>A <b>function expression</b> can be assigned to a variable, passed as an argument to another function,
or returned from a function.</p>
...
<div class="ws-note">
<h2>Functions vs. Function Expressions</h2>
<p>JavaScript functions are <b>defined</b> with the <b>function</b> keyword.</p>
<p>JavaScript functions can be defined in different ways.</p>
<p>In JavaScript, <b>function declarations</b> and <b>function expression</b> refer to different ways
of defining functions, their different syntax and how they are handled:</p>
...
<hr>
<h2>Function Declarations vs Function Expression</h2>
<p>A <b>function declaration</b> (or simply a function) is defined using:</p>
<ul>
<li>The <b>function</b> keyword</li>
<li>A function <b>name</b></li>
<li>Parameters in parentheses</li>
<li>A code block brackets</li>
</ul>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
...
<p>A <b>function expression</b> is defined using:</p>
<ul>
<li>The <b>function</b> keyword</li>
<li>Parameters in parentheses</li>
<li>A code block brackets</li>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_function_expression_hello" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="ws-note">

<p>The function above is stored in the variable <b>sayHello</b>.</p>
<p>To run it, you call <b>sayHello()</b>.</p>
</div>
...
<p><b>Function declarations</b> are "hoisted" to the top of their scope.
This means you can call a function before it is defined in the code:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
let sum = add(2, 3); // Will work<br>
<br>
function add(a, b) {return a + b;}
</div>
</div>
...
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
let sum = add(2, 3); // &#9940; Will generate error<br>
<br>
const add = function (a, b) {return a + b;};
</div>
</div>
...
<ul class="w3-ul">
<li><b>Syntax:</b><br>
Function declarations require a name. Function expressions can be anonymous.</li>
<li><b>Hoisting:</b><br>
Function declarations are hoisted. Function expressions are not.</li>
<li><b>Flexibility:</b><br>
Function declarations offer more flexibility in how and where they are used.</li>
<li></li>
</ul>
...
<div class="ws-note">
<h2>Quiz</h2>
<p>Which type of function can be called before it is defined in the code?</p>
</div>

<hr>
<h2>When to Use Each</h2>
<ul>
  <li>Use <b>function declarations</b> for general-purpose functions</li>
  <li>Use <b>function expressions</b> when assigning functions to variables</li>
  <li>Use <b>function expressions</b> in callbacks and event handlers</li>
</ul>

<hr>
<h2>Later in this Tutorial</h2>
<p>Function expressions offer high flexibility and are widely used in JavaScript for various purposes,
and you will see a lot more of function expressions in the following chapters:</p>
<ul>
<li><p><b><a href="js_arrow_function.asp">Arrow Functions</a></b><br>The concise arrow function syntax
(=&gt;) is a modern way of writing function expressions.</p></li> 
<li><p><b><a href="js_callback.asp">Callbacks</a></b><br>
Passing functions as arguments to other functions, such as event listeners or asynchronous operations.</p></li>
<li><p><b><a href="js_function_closures.asp">Closures</a></b><br>Function expressions help create closures,
which allow functions to remember and access variables from their containing scope.</p></li>
<li><p><b><a href="js_function_iife.asp">Immediately Invoked Function Expressions (IIFEs)</a></b><br>
Functions Expressions that run as soon as they are defined, are often used to create private scopes
and avoid global variable conflicts.</p></li>
</ul>

<hr>
<div class="ws-note">
<h2>Quiz</h2>
<p>What is the difference between <b>sayHello</b> and <b>sayHello()</b>?</p>
</div>

<hr>
<h2>Common Mistakes</h2>
<ul class="w3-ul w3-border">
<li><h3>Forgetting the Semicolon</h3>
Function expressions are <b>statement</b> and should end with <b>;</b> (<b>semicolon</b>).</li>

<li><h3>Expecting Hoisting</h3>
Arrow functions are <b>not hoisted</b>.<br>
You cannot call a function expression before it is defined.</li>


<li><h3>Confusing Reference and Call</h3>
<b>sayHello</b> is the function. <b>sayHello()</b> calls the function.</li>

<li><h3>Confusing Function Names and Variables</h3>
...
<div class="ws-note">
<h2>Next Chapter</h2>
<p class="w3-large"><a href="js_arrow_function.asp">JavaScript Arrow Functions</a></p>
<ul>
