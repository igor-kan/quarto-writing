...
<html lang="en-US">
<head>
<title>JavaScript Modules Export</title>
<meta charset="utf-8">
...
<h1>JavaScript Modules Export</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_modules.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_modules_import.asp">Next &#10095;</a>
</div>

<!--start-->
<div class="ws-info">

<h2>The Export Keyword</h2>
<p>A module uses the <code class="w3-codespan"><b>export</b></code> keyword
to <b>share values</b> with other files.</p>
<p>A module can have <b>many <b>named exports</b></b>.</p>
<p>A module can (optionally) have <b>one <b>default export</b></b>.</p>
</div>


<h2>Named Exports</h2>
<p>A named export gives a <b>name to each item</b>.</p>
<p>Items can be exported <b>individually</b>, or <b>wrapped in { }</b> at the bottom:</p>

<div class="w3-example">
<h3>Module File "person.js"</h3>
<p><b>name</b> and <b>age</b> exported individually:</p>
<div class="w3-code notranslate jsHigh">
// export name and age<br>
export const name = "Jesse";<br>
export const age = 40;
</div>
<p><b>name</b> and <b>age</b> exported at once at the bottom:</p>
<div class="w3-code notranslate jsHigh">
const name = "Jesse";<br>
const age = 40;<br>
<br>
...
<p>You import named exports by <b>wrapping them in { }</b>.</p>
<p>The <b>names must match</b> exactly.</p>
...
<p><b>Named exports</b> enforce correct naming. If you misspell a name, you get an error.</p>
</div>

<div class="w3-example">
<h3>Module File "math.js"</h3>
<p>Here, <b>PI</b>, <b>add</b>, <b>subtract</b>, <b>multiply</b>, and <b>divide</b> are named exports:</p>
<div class="w3-code notranslate jsHigh">
...
&lt;script type="module"&gt;<br>
<br>
import { add, subtract, PI } from './math.js';<br>
<br>
&lt;/script&gt;<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_modules_math">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Name Strictness</h2>
<p>With named exports, the imported names must match exactly.</p>
<p>Name exports avoid mistakes caused by typos or renaming.</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
...
<hr>
<h2>Toolbox Utilities (Helpers)</h2>
<p>Utilities work best with named exports if they contain multiple helpers:</p>
<ul>
<li>math.js</li>
<li>stringUtils.js</li>
<li>domHelpers.js</li>
<li>dateHelpers.js</li>
</ul>
<hr>
<div class="ws-note">

<p><b>Named exports</b> are perfect for "toolbox" modules containing many utilities.</p>
</div>

<hr>
<h2>Tree-Shaking</h2>
<p>Named exports enable bundlers to remove unused code (tree-shaking).</p>
<p>In this example PI, subract, multiply, and divide is removed:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
...
<hr>
<h2>When to Use Named Export?</h2>
<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
<tr><th>Cases</th><th>Why Named Export</th></tr>
<tr><td>Many functions</td><td>Clearly lists all functions</td></tr>
<tr><td>Strictness needed </td><td>Prevents name typos</td></tr>
<tr><td>Big projects</td><td>Improves consistency</td></tr>
<tr><td>Utility sets</td><td>Matches module structure</td></tr>
<tr><td>Tree-shaking</td><td>Removes unused code automatically</td></tr>
</table>
</div>
...
<p><b>Default Export</b> exports <b>one main value</b> from a module.</p>
<p>This gives a clear intent about what the module's primary functionality is.</p>
<p>If a file is meant to expose one primary function, class, or value, default export makes that explicit:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
...
<p>You can have <b>only one default export</b> in a file.</p>
</div>

<hr>
<h2>Default is Flexible</h2>
<p>Default exports let you import <b>using any name</b>:</p>
...
<p>The name calc does not need to match the original.</p>
<p>Compared to named exports, where the name must match exactly:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
import { calculateSum } from './calculateSum.js';
</div>
</div>
<p>Try it yourself using the module file named <code class="w3-codespan">message.js</code>:</p>
<div class="w3-example">
<h3>Module File "message.js"</h3>
...
<h3>Module Script 2</h3>
<div class="w3-code notranslate htmlHigh">
&lt;script type="module"&gt;<br>
import text from "./message.js";<br>
&lt;/script&gt;
</div>
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_modules_import">Try it Yourself &raquo;</a>
</p>

</div>

<hr>
<h2>Default is Clean</h2>
<p>Many libraries expose a single feature as the default:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
...
<hr>
<h2>Combining Default + Named</h2>
<p>A module can provide one main function plus some helpers:</p>
<div class="w3-example">
<h3>Module File</h3>
<div class="w3-code notranslate jsHigh">
export default function parse() { ... }<br>
<br>
export function validate() { ... }<br>
export function format() { ... }<br>
</div>
<h3>Module Script</h3>
<div class="w3-code notranslate jsHigh">
...
<hr>
<h2>When to Use Default Export?</h2>
<table class="ws-table-all">
<tr></tr>
<tr><th>When</th><th>Why</th></tr>
<tr><td>One main purpose</td><td>Good for modules with a primary function</td></tr>
<tr><td>Flexible naming</td><td>Importers can choose any name</td></tr>
<tr><td>Cleaner imports</td><td>Shorter and simpler import syntax</td></tr>
<tr><td>Common pattern</td><td>Frameworks use it for the main API</td></tr>
</table>
