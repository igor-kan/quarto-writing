...
<html lang="en-US">
<head>
<title>JavaScript Temporal Date Differences</title>
<meta charset="utf-8">
...
<h1>JS Temporal Differences</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_temporal_arithmetic.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_temporal_compare.asp">Next &#10095;</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plaindate_since" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="ws-note">
...
<hr>
<h2>JavaScript Temporal until()</h2>
<p>The <code class="w3-codespan">until()</code> method calculates the duration between two temporal dates.</p>
<p>The <code class="w3-codespan">until()</code> method is effectively the inverse of the
<code class="w3-codespan">since()</code> method. 
<div class="w3-example">
<h3>Syntax</h3>
<div class="w3-code notranslate">
<i>t1</i>.until(<i>t2, options</i>)
</div>
<h3>Meaning</h3>
<p><b>At time t1</b>, how much time is it <b>until t2</b> ?</p>
</div>
...
const end = Temporal.PlainDate.from("2026-05-17");<br>
<br>
const duration = start.until(end);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plaindate_until" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Temporal since() vs until()</h2>
<p>The methods are opposites.</p>
<table class="ws-table-all">
<tr></tr>
<tr><th>Method</th><th>Meaning</th></tr>
<tr><td>a.since(b)</td><td>time from b &#8594; a</td></tr>
<tr><td>a.until(b)</td><td>time from a &#8594; b</td></tr>	
</table>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
const end = Temporal.PlainDate.from("2026-05-17");<br>
<br>
const duration1 = start.since(end);<br>
const duration2 = start.until(end);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_duration_until3" target="_blank">Try it Yourself &raquo;</a>
</div>
<p>Think:</p>
<ul>
<li>since = past (since yesterday)</li>
<li>until = future (until tomorrow)</li>
</ul>

<hr>
<h2>The Options Parameters</h2>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const wedding = Temporal.PlainDate.from("2000-05-17");<br>
const today = Temporal.Now.plainDateISO();<br>
<br>
const duration = today.since(wedding);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_duration_since3" target="_blank">Try it Yourself &raquo;</a>
</div>
<p>The <code class="w3-codespan">since()</code> method returns the total number of days,
but you can use the largestUnit option to break it down into years and months:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const wedding = Temporal.PlainDate.from("2000-05-17");<br>
const today = Temporal.Now.plainDateISO();<br>
<br>
const duration = today.since(wedding, {largestUnit:'years'});<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_duration_since4" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<h2>PlainTime since()</h2>
<div class="w3-example">
<h3>Example: Plain Time</h3>
<div class="w3-code notranslate jsHigh">
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_duration_since1" target="_blank">Try it Yourself &raquo;</a>
</div>
