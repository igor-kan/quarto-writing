...
<a class="w3-left w3-btn" href="js_datatypes_primitives.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_datatypes_symbol.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
<p class="w3-large">A <b>JavaScript variable</b> can be either a <b>Primitive</b> type or an <b>Object</b> type.</p>
<p class="w3-large">The <b>Object data type</b> can hold many <b>different object types</b>.</p>
</div>
...
<p>JavaScript Objects represent <b>complex data</b> structures and functionalities beyond the
primitive data types (string, number, boolean, null, undefined, symbol, bigint).</p>

<p>JavaScript objects are written with curly braces <code class="w3-codespan">{ }</code>.</p>
<p>JavaScript objects contains a collection of different <b>properties</b>.</p>
<p>Object properties are written as <b>name:value</b> pairs, separated by commas.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Create a person object with 4 properties: firstName, 
...
<div class="ws-note">
<h2>Learn More:</h2>
<p class="w3-large"><a href="js_objects.asp">JavaScript Object Tutorial</a></p>
</div>
<hr>
<h2>Built-In Object Types</h2>
<p>A JavaScript object can represent a <b>JavaScript object</b> or a <b>User defined object</b>.</p>
...
<p>JavaScript arrays are a special type of JavaScript objects.</p>
<p>JavaScript arrays are written with square <code class="w3-codespan">[ ]</code> brackets.</p>
<p>Array items are separated by commas.</p>
<p>The following code declares (creates) an array called <code class="w3-codespan">cars</code>, containing three 
items (car names):</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
