...
<html lang="en-US">
<head>
<title>JavaScript Temporal.Instant - Working with Exact Time</title>
<meta charset="utf-8">
...
<h1>JavaScript Temporal Instant</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_temporal_duration.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_temporal_plaindatetime.asp">Next &#10095;</a>
</div>

<div class="ws-info">
<h2>The Temporal.Instant Object</h2>
<p>The <b>Temporal.Instant object</b> represents an <b>exact moment in UTC time</b>.</p>
<p><b>UTC time has NO time zone or calendar</b>.</p>
<p>Example: <b>2026-05-17T14:30:00Z</b></p>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>May 17, 2026 at 14:30:00 UTC time:</p>
<div class="w3-code notranslate jsHigh">
const instant = Temporal.Instant.from("2026-05-17T14:30:00Z");
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_instant" target="_blank">Try it Yourself &raquo;</a>
</div>
<p>The <b>Z</b> at the end of the date stands for <b>Zero time</b>.</p>
<p>The <b>T</b> in the middle is a <b>separator</b> between date and time.</p>
<hr>
<h2>What is UTC Time?</h2>
<p>UTC stands for <b>Universal Time Coordinated</b>.</p>
<ul>
<li>It is the exact time on the zero meridian (Greenwich, London)</li>
<li>It is the same moment everywhere on earth</li>
<li>It is not affected by any time zones</li>
<li>It is not affected by DST (Daylight Saving Time)</li>
</ul>
<div class="ws-note">
<p>Prior to 1972, UTC was called Greenwich Mean Time (GMT).</p>
<p>Is now referred to as Universal Time Coordinated (UTC).</p>
<p>Is also referred to as Coordinated Universal Time.</p>
</div>
<h2>What is Instant Time?</h2>
<ul>
<li>It is measured in <b>UTC</b></li>
<li>It is stored as <b>nanoseconds since Unix epoch</b></li>
<li>Unix epoch is <b>January 1, 1970 00:00:00</b></li>
</ul>

<hr>
<h2>What is Local Time</h2>
<p>To obtain local time in world, you need to add or subtract hours from UTC
depending on how many time zones you are away from Greenwich.</p>
...
London:&nbsp;&nbsp;&nbsp;&nbsp;12:00 (UTC)<br>
Oslo:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;14:00 (UTC+2)<br>
New York:&nbsp;&nbsp;08:00 (UTC-4)<br>
Tokyo:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;21:00 (UTC+9)
</div>
</div>

<hr>
<h2>How to Create a Temporal.Instant</h2>
<p>An Instant can be created in several different ways:</p>
<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
<tr><th>From</th><th>Code</th></tr>
<tr><td>With Constructor</td><td>new Temporal.Instant()</td></tr>
<tr><td>From String</td><td>Temporal.Instant.from()</td></tr>
<tr><td>From Epoch millisec</td><td>Temporal.Instant.fromEpochMilliseconds()</td></tr>
<tr><td>From Epoch nanosec</td><td>Temporal.Instant.fromEpochNanoseconds()</td></tr>
<tr><td>From Current Time</td><td>Temporal.Now.instant()</td></tr>
</table>
</div>

<hr>
<h2>Create an Instant from <b>new</b></h2>
<p>You can create an Instant using the <code class="w3-codespan">new Temporal.Instant()</code> constructor.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const instant = new Temporal.Instant(1779028200000000000n);
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_instant_new" target="_blank">Try it Yourself &raquo;</a>
</div>
<p>The <b>n</b> at the end means <b>BigInt</b>.</p>
<p>The <b>parameter</b> must be a <b>BigInt</b>.</p>

<hr>
<h2>Create an Instant from a String</h2>
<p>You can create an Instant from an
<b><a href="js_temporal_standards.asp?#mark_9557">RFC 9557 string</a></b>.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const instant = Temporal.Instant.from("2026-05-17T14:30:00Z");
...
<hr>
<h2>What is the Z at the End?</h2>
<p>The <b>Z</b> at the end of the time, is the <b><a href="js_temporal_standards.asp?#mark_8601">
ISO 8601</a></b> standard for formatting <b>UTC time</b>.</p>
<p>It indicates that the offset from UTC time is 0 (Zero).</p>
<p>It is also known as <b>Z</b> time, <b>Zero</b> time or <b>Zulu</b> time.</p>
<p>The <b>T</b> in the middle is the <b><a href="js_temporal_standards.asp?#mark_8601">ISO 8601</a></b>
standard for <b>separating</b> date and time.</p>

<hr>
<h2>Create an Instant from Epoch Milliseconds</h2>
<p>You can create an Instant object from the number of <b>milliseconds since the Unix epoch</b>.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const instant = Temporal.Instant.fromEpochMilliseconds(1779028200000);
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_instant_epoch" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="ws-note">
<p><b>Unix epoch is at January 1, 1970 00:00:00 UTC</b></p>
<p>This is similar to how <b>JavaScript Date</b> works internally.</p>
</div>

<hr>
<h2>Create an Instant from Epoch Nanoseconds</h2>
<p>You can create an Instant object from the number of <b>nanoseconds since the Unix epoch</b>.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const instant = Temporal.Instant.fromEpochNanoseconds(1779028200000000000n);
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_instant_epoch_nano" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Create an Instant from Current Time</h2>
<p>JavaScript Temporal.Instant does not have any method for creating an instant from current time.</p>
<p>You must use a Temporal.Now method instead.</p>
<p>The <code class="w3-codespan">Temporal.Now.instant()</code> method returns an Instant object with the exact current time.</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_now_instant" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>HowTo Replace Date.now()</h2>
<p>With <b>Date</b>, you use <code class="w3-codespan">Date.now()</code> to get the current
timestamp.</p>
<p>The <code class="w3-codespan">Date.now()</code> method returns the timestamp value in 
<b>milliseconds</b>:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let timestamp = Date.now();<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_vs_date_5" target="_blank">Try it Yourself &raquo;</a>
</div>

<p>With <b>Temporal</b>, you use <code class="w3-codespan">Temporal.Now.instant()</code>:</p>
<p>The property <code class="w3-codespan">epochMilliseconds</code> returns the timestamp value in 
<b>milliseconds</b>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_vs_date_6" target="_blank">Try it Yourself &raquo;</a>
</div>

<p>The property <code class="w3-codespan">epochNanoseconds</code> returns the timestamp value in 
<b>nanoseconds</b>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_vs_date_1" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="ws-note">
<p>Nanosecond precision is 1,000,000 (one million) times higher than millisecond precision.</p>
</div>

<hr>
<h2>Temporal.Instant compare()</h2>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create Temporal.Instant objects<br>
const i1 = Temporal.Instant.from("2026-05-17T12:00:00Z");<br>
const i2 = Temporal.Instant.from("2026-05-17T12:00:00Z");<br>
const i3 = Temporal.Instant.from("2026-05-17T13:00:00Z");<br>
<br>
// compare()<br>
let x1 = Temporal.Instant.compare(i1, i2));<br>
let x2 = Temporal.Instant.compare(i1, i3));<br>
let x3 = Temporal.Instant.compare(i3, i1));<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_instant_compare" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Temporal.Instant equals()</h2>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create Temporal.Instant objects<br>
...
<br>
// equals()<br>
let x1 = i1.equals(i2);<br>
let x2 = i1.equals(i3);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_instant_equals" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<p><b>Most (*) temporal objects</b> have their own <b>equals() method</b>:</p>
<ul>
<li><i>instant</i>.equals(<i>instant</i>)</li>
<li><i>plaindate</i>.equals(<i>plaindate</i>)</li>
<li><i>plaintime</i>.equals(<i>plaintime</i>)</li>
<li><i>plainyearmonth</i>.equals(<i>plainyearmonth</i>)</li>
<li><i>plainmonthday</i>.equals(<i>plainmonthday</i>)</li>
<li><i>plaindateTime</i>.equals(<i>plaindatetime</i>)</li>
<li><i>zoneddateTime</i>.equals(<i>zoneddtatime</i>)</li>
</ul>
<p>(*) Duration has not.</p>
<div class="ws-note">
<h3>Learn More:</h3>
...
<hr>
<h2>Convert Instant Time to Local Time</h2>
<p>A <b>Temporal.Instant</b> does not include time zone information.</p>
<p>You must convert it to a <b>Temporal.ZonedDateTime</b> to display local time.</p>
<p>The <code class="w3-codespan">toZonedDateTimeISO()</code> method converts a UTC moment
to a specific time zone:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const instant = Temporal.Instant.from("2026-05-17T14:30:00Z");<br>
<br>
const zoned = instant.toZonedDateTimeISO("Europe/Oslo");<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_instant_zoned" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="ws-note">
<p>Instant = "What time is it globally?"</p>
<p>ZonedDateTime = "What time is it here?"</p>
</div>
<hr>
<h2>UTC vs Local Time</h2>
<p>UTC is a global clock.</p>
<p>Time zone is the local view of the same clock.</p>
<table class="ws-table-all">
<tr></tr>
<tr><th>Type</th><th>Description</th></tr>
<tr><td>UTC</td><td>Same worldwide</td></tr>
<tr><td>Local Time</td><td>Depends on Location</td></tr>
</table>
<div class="ws-note">

<p>UTC (Coordinated Universal Time) is the standard time used worldwide.</p>
<p>It is not affected by any time zones or daylight saving time.</p></div>

<hr>
<h2>Why UTC is Important</h2>
<p>UTC is used as a reference time:</p>
<ul>
  <li>Servers and databases store time in UTC</li>
  <li>Logs use UTC timestmps to avoid ime confusion</li>
  <li>Most APIs use UTC timestamps</li>
</ul>

<hr>
<h2>When to Use Temporal.Instant</h2>
<ul>
<li>For exact moments in UTC time</li>
<li>For timestamps</li>
<li>For database logs</li>
<li>For event logs</li>
<li>For comparing moments</li>
</ul>

<hr>
<h2>Compare Instant with Other Types</h2>
<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
