...
<a class="w3-left w3-btn" href="js_iterables.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_generators.asp">Next &#10095;</a>
</div>
<!--start-->

<div class="ws-info">
<h2>The Iterator Object</h2>
<p>An <b>Iterator</b> is an object that provides a standard way to access elements <b>sequentially</b>.</p>
<p>An Iterator must adheres to the <b>Iterator Protocol</b>: It must have a <b>next()</b> method.</p>
</div>

<hr>
<h2>The next() Method</h2>
<p>The <b>next()</b> method returns an object with two properties:</p>
<ul>
<li>The <b>value</b> property holds the <b>next value</b> in the iteration sequence.</li>
<li>The <b>done</b> property returns <code class="w3-codespan">false</code> if there are more elements to iterate over,
otherwise it returns <code class="w3-codespan">true</code>.</li>
</ul>
...
<p>Technically, iterables must implement the <code class="w3-codespan">Symbol.iterator</code> method.</p>
...
<p>Because their prototype objects have a
<code class="w3-codespan">Symbol.iterator</code> method:</p>
</div>

<p>Iterators provide a controlled way to work with data sequences, enabling custom iteration logic
for various data structures.</p>
<p>They are particularly useful for handling streams of data,
lazy computation of values, and building custom data structures with defined iteration behaviors.</p>
...
<p>JavaScript 2025 (ECMAScript 2025) officially approved a set of new Iterator Helper methods that
significantly enhance the functionality of iterators in JavaScript.</p>
<p>The methods provide a more functional and efficient way to work with iterable objects, including generators,
by allowing direct manipulation and transformation without first converting them to arrays:</p>

<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
<tr><th>Function</th><th>Description</th></tr>
<tr><td>drop()</td><td>Returns an iterator that skips a specified number of elements before yielding the rest</td></tr>
<tr><td>every()</td><td>Returns <code class="w3-codespan">true</code> if all elements satisfy a test function</td></tr>
<tr><td>filter()</td><td>Returns an iterator containing elements that satisfy a filter function</td></tr>
<tr><td>find()</td><td>Returns the first element that satisfies a test function</td></tr>
<tr><td>flatMap()</td><td>Returns an iterator by mapping each element and then flattening the results</td></tr>
<tr><td>forEach()</td><td>Executes a function once for each element in the iterator.</td></tr>
<tr><td>from()</td><td>creates an iterator object from an iterable</td></tr>
<tr><td>map()</td><td>Returns an iterator with all elements transformed by a map function</td></tr>
<tr><td>reduce()</td><td>Applies a reducer function against each element to reduce it to a single value</td></tr>
<tr><td>some()</td><td>Returns <code class="w3-codespan">true</code> if at least one element satisfy a test function</td></tr>
<tr><td>take()</td><td>Returns an iterator that yields a specified number of elements</td></tr>
</table>
</div><a id="mark_iterator_from"></a>
<hr>
...
<p>Iterators bring the <b>iteration concept</b> directly into the core JavaScript language
