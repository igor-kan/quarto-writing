...
<a class="w3-left w3-btn" href="js_graphics_canvas.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_graphics_chartjs.asp">Next &#10095;</a>
</div>

<div class="w3-panel ws-info">
<p><b>Plotly.js</b> is a charting library that comes with over 40 chart types:</p>
<ul>
<li>Horizontal and Vertical Bar Charts</li>
<li>Pie and Donut Charts</li>
<li>Line Charts</li>
<li>Scatter and Bubble Plots</li>
<li>Equation Plots</li>
<li>3D Charts</li>
<li>Statistical Graphs</li>
<li>SVG Maps</li>
<li>...</li>
</ul>
<p>Plotly.js is free and open-source under the MIT license.
It costs nothing to install and use.
You can view the source, report issues and contribute using Github.</p>
</div>
...
&nbsp;&nbsp;type: "bar",<br>
&nbsp;&nbsp;orientation:"v",<br>
&nbsp;&nbsp;marker: {color:"rgba(0,0,255)"}<br>
}];<br>
<br>
const layout = {title:"World Wide Wine Production"};<br><br>
Plotly.newPlot("myPlot", data, layout);
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryplotly_bars">Try it Yourself &raquo;</a></p>
</div>
...
&nbsp;&nbsp;type: "bar",<br>
&nbsp;&nbsp;orientation: "h",<br>
&nbsp;&nbsp;marker: {color:"rgba(255,0,0,0.6)"}<br>
...
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryplotly_bars_horizontal">Try it Yourself &raquo;</a></p>
</div>
...
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryplotly_pie">Try it Yourself &raquo;</a></p>
</div>
...
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryplotly_donut">Try it Yourself &raquo;</a></p>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryplotly_function">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-example">
<p>To display scatters instead, change mode to markers:</p>
<div class="w3-code notranslate jsHigh">
// Display using Plotly<br>
const data = [{x:xValues, y:yValues, <b>mode:"markers"</b>}];<br>
const layout = {title: "y = " + exp};<br>
Plotly.newPlot("myPlot", data, layout);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryplotly_function_scatter">Try it Yourself &raquo;</a>
</div>
...
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryplotly_scatter">Try it Yourself &raquo;</a></p>
</div>
...
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryplotly_lines">Try it Yourself &raquo;</a></p>
</div>
...
<h2>Bubble Plots</h2>
<p>Bubble Plots are Scatter Plots whose markers have variable color, size, and symbols.</p>
<p>It is a type of 3-dimensional chart with only two axes (x and y) where the size of the bubble
communicates the third dimention.</p>

<div id="myPlot19" style="width:100%;max-width:700px"></div>

<script>
var xArray = [1,2,3,4];
var yArray = [10,20,30,40];
...
Plotly.newPlot('myPlot19', data, layout);

</script>
<div class="w3-example">
<h3>Source Code</h3>
<div class="w3-code notranslate jsHigh">
const xArray = [1,2,3,4];<br>
const yArray = [10,20,30,40];<br>
<br>
const trace1 = {<br>
&nbsp;&nbsp;x: xArray,<br>
&nbsp;&nbsp;y: yArray,<br>
&nbsp;&nbsp;mode: 'markers',<br>
&nbsp;&nbsp;marker: {<br>
&nbsp;&nbsp;&nbsp;&nbsp;color: ['red', 'green',  'blue', 'orange'],<br>
&nbsp;&nbsp;&nbsp;&nbsp;size: [20, 30, 40, 50]<br>
&nbsp;&nbsp;}<br>
};<br>
<br>
const data = [trace1];<br>
<br>
const layout = {<br>
&nbsp;&nbsp;title: "Plotting Bubbles"<br>
};<br>
<br>
Plotly.newPlot('myPlot', data, layout);
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryplotly_bubbles">Try it Yourself &raquo;</a></p>
</div>
<hr>
<h2>Linear Graphs</h2>
...
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryplotly_function_linear">Try it Yourself &raquo;</a></p>
</div>
...
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryplotly_function_linear_multiple">Try it Yourself &raquo;</a></p>
</div>
