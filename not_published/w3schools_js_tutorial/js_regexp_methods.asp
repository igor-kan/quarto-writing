...
<html lang="en-US">
<head>
<title>JavaScript RegExp Methods</title>
<meta charset="utf-8">
...
<h1>RegExp Methods</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_regexp_objects.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_datatypes.asp">Next &#10095;</a>
</div>
<hr>
<h2>Complete RexExp Reference</h2>
...
<tr>
  <td><a href="/jsref/jsref_regexp_compile.asp">compile()</a></td>
  <td>Compiles a regular expression <span class="deprecated">(Deprecated)</span></td>
</tr>
<tr>
  <td><a href="/jsref/jsref_regexp_constructor.asp">constructor</a></td>
  <td>Returns the function that created the RegExp prototype</td>
</tr>
<tr>
  <td><a href="/jsref/jsref_regexp_dotall.asp">dotAll</a></td>
  <td>Returns <code class="w3-codespan">true</code> if the <strong>s</strong> flag is set in the expression<br>(new in 2018)</td>
</tr>
<tr>
  <td><a href="/jsref/jsref_regexp_escape.asp">escape()</a></td>
  <td>Returns a string where characters that belongs to the regular expression syntax are escaped<br>(new in 2025)</td>
</tr>
<tr>
  <td><a href="/jsref/jsref_regexp_exec.asp">exec()</a></td>
  <td>Returns a result array for a matches in a string</td>
</tr>
<tr>
  <td><a href="/jsref/jsref_regexp_flags.asp">flags</a></td>
  <td>Returns the modifiers set in the expression<br>(new in 2015)</td>
</tr>
<tr>
  <td><a href="/jsref/jsref_regexp_global.asp">global</a></td>
  <td>Returns <code class="w3-codespan">true</code> if the <b>g</b> flag is set in the expression</td>
</tr>
<tr>
  <td><a href="/jsref/jsref_regexp_hasindices.asp">hasIndices</a></td>
  <td>Returns <code class="w3-codespan">true</code> if the <b>d</b> flag is set (new in 2022)</td>
</tr>
<tr>
  <td><a href="/jsref/jsref_regexp_ignorecase.asp">ignoreCase</a></td>
  <td>Returns <code class="w3-codespan">true</code> if the <b>i</b> flag is set</td>
</tr>
<tr>
  <td><a href="/jsref/jsref_regexp_lastindex.asp">lastIndex</a></td>
  <td>Specifies the index at which to start the next match</td>
</tr>
<tr>
  <td><a href="/jsref/jsref_regexp_multiline.asp">multiline</a></td>
  <td>Returns <code class="w3-codespan">true</code> if the <b>m</b> modifier is set</td>
</tr>
<tr>
  <td><a href="/jsref/jsref_regexp_source.asp">source</a></td>
  <td>Returns the text of the RegExp pattern</td>
</tr>
<tr>
  <td><a href="/jsref/jsref_regexp_sticky.asp">sticky</a></td>
  <td>Returns <code class="w3-codespan">true</code> if the <b>y</b> flag is set<br>(new in 2015)</td>
</tr>
<tr>
  <td><a href="/jsref/jsref_regexp_test.asp">test()</a></td>
  <td>Tests for a match in a string. Returns <code class="w3-codespan">true</code> or <code class="w3-codespan">false</code></td>
</tr>
<tr>
  <td><a href="/jsref/jsref_regexp_tostring.asp">toString()</a></td>
  <td>Returns the string value of the regular expression</td>
</tr>
<tr>
  <td><a href="/jsref/jsref_regexp_unicode.asp">unicode</a></td>
  <td>Returns <code class="w3-codespan">true</code> if the <b>u</b> flag is set<br>(new in 2018)</td>
</tr>
<tr>
  <td><a href="/jsref/jsref_regexp_unicodesets.asp">unicodeSets</a></td>
  <td>Returns <code class="w3-codespan">true</code> if the <b>v</b> flag is set<br>(new in 2023)</td>
</tr>
</table>
</div>

<hr>
<h2>RegExp String Methods</h2>
<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
<tr><th width="190px">Method</th><th>Description</th> </tr>
<tr><td><a href="/jsref/jsref_match.asp">match(regexp)</a></td>
<td>Returns an Array of results</td></tr>
<tr><td><a href="/jsref/jsref_string_matchall.asp">matchAll(regexp)</a></td>
<td>Returns an Iterator of results</td></tr>
<tr><td><a href="/jsref/jsref_replace.asp">replace(regexp, s)</a></td>
<td>Returns a new String</td></tr>
<tr><td><a href="/jsref/jsref_string_replaceall.asp">replaceAll(regexp, s)</a></td>
<td>Returns a new String</td></tr>
<tr><td><a href="/jsref/jsref_search.asp">search(regexp)</a></td>
<td>Returns the index of the first match</td></tr>
<tr><td><a href="/jsref/jsref_split.asp">split(regexp)</a></td>
<td>Returns an Array of results</td></tr>
</table>
</div>
