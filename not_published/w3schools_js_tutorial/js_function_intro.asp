...
<!--start-->
<div class="ws-info">
<h2>Functions are Code Blocks</h2>
<p>Functions are <b>reusable code blocks</b> designed to perform a particular task.</p>
<p>Functions <b>are executed</b> when they are <b>called</b> or <b>invoked</b>.</p>
<p>Functions are <b>fundamental</b> in all programming languages.</p>
</div>

<h2>Why Use Functions?</h2>
<p>
Functions help you to:<br>
</p>
...
<hr>
<h2>What Does a Function Look Like?</h2>
<p>A function can be created with the <b>function</b> keyword, a <b>name</b>, and <b>parentheses</b>.</p>
<p>The code to run is written inside <b>curly brackets</b>.</p>
...
<p>The function above does not do anything.</p>
<p>It has to be called first.</p>
</div>

<hr>
<h2>Functions Run When You Call Them</h2>
<p>To run a function, you call it by using its name followed by parentheses like <b>sayHello()</b>:</p>
...
<a target="_blank" href="tryit.asp?filename=tryjs_function_sayhello" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="ws-note">

<p><b>()</b> means execute now.</p>
</div>
<!--stop-->
...
<div class="w3-code notranslate jsHigh">
function
<em>name</em>( <em>p1, p2, ...</em> ) {<br>
&nbsp; // code to be executed<br>
}
</div>
</div>

<p>Functions are defined with the <code class="w3-codespan">function</code> keyword:</p>
<ul>
<li>followed by the function <b>name</b></li>
<li>followed by <b>parentheses ( )</b></li>
<li>followed by <b>brackets { }</b></li>
</ul>
<p>The <b>function name</b> follows the naming rules for variables.</p>

<p><b>Optional parameters</b> are listed inside parentheses: <b>(</b><em> p1, p2, ...</em> <b>)</b></p>
<p><b>Code to be executed</b> is listed inside curly brackets: <b>{ }</b></p>
<p>Functions can <b>return an optional value</b> back to the caller.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Function to multiply two numbers:</p>
<div class="w3-code notranslate jsHigh">
...
<p>A function definition is not an executable statement.</p>
<p>It is not common to end a <b>function definition</b> with a semicolon.</p>
<p><b>Semicolons</b> are used to separate executable JavaScript <b>statements</b>.</p>
</div>

<!--stop-->

<hr>
<h2>A Function Can Be Used Many Times</h2>
<p>
A big benefit is that you can call the same function whenever you need it.<br>
</p>
...
let sum1 = add(5, 5);<br>
let sum2 = add(50, 50);<br>
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_function_add" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="ws-note">
...
<p>Variables declared <b>within</b> a JavaScript function, become <strong>
LOCAL</strong> to 
the function.</p>
...
<div class="ws-note">
<h2>Why Functions?</h2>
<p>Functions enable <b>better code organization</b> and efficiency.</p>
<p>With functions you can <b>reuse the same code</b> many times.</p>
<p>The same code, with different input, can <b>produce different results</b>.</p>
</div>
...
<ul>
<li><b>Parameters</b> - some values are sent to the function</li>
<li><b>Arguments</b> - some values are received by the function</li>
<li><b>Function Code</b> - some work is done inside the function</li>
<li><b>Return Output</b> - some value is returned from the function</li>
</ul>

<p>In the next chapters, you will learn more about <b>input</b> and <b>return</b> values.</p>

<hr>
<div class="ws-note">
<h2>Next Chapter</h2>
<p class="w3-large"><a href="js_function_invocation.asp">Calling JavaScript Functions</a></p>
<ul>
<li>Functions are <b>executed</b> when they are <b>called</b> or <b>invoked</b></li>
<li>You call a function by adding <b>parentheses</b> to its name like: <b>name()</b></li>
</ul>
</div>
<hr>
