...
<a class="w3-left w3-btn" href="js_iterators.asp">&#10094; Previous</a>
...
yield 2;<br>
<br>
// return {value:3, done:true}<br>
return 3;<br>
}<br>
<br>
// Create a Generator<br>
let myGenerator = myStream();<br>
<br>
// Iterate over the Generator<br>
for (let value of myGenerator) { // code }<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_generator" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<p>The for..of loop exits when <b>done:true</b>.
<p>To get all the values, return them with yield.</p>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_generator_2" target="_blank">Try it Yourself &raquo;</a>
</div>
