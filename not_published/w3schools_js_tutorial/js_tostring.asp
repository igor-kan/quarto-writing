...
<html lang="en-US">
<head>
<title>JavaScript toString() Metod</title>
<meta charset="utf-8">
...
<h1>JavaScript toString()</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_nan.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_tolocalestring.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
<p>The JavaScript <code class="w3-codespan">toString()</code> method converts a variable (or a value) to a string.</p>
<p>It is a built-in method for many data types, including numbers, arrays, dates, and objects.</p>
<p>The method is useful for:</p>
<ul>
<li>Converting data to a readable format for display</li>
<li>Ensuring type compatibility when a string is required</li>
<li>Customizing objects other user interfaces</li>
...
<p>When used on an array, <code class="w3-codespan">toString()</code> returns the array elements as a comma separated string.</p>
...
<hr>
<!--start-->
<h2>JavaScript Date toString()</h2>
<p>When used on a date, <code class="w3-codespan">toString()</code> returns a human-readable date and time string.</p>
<div class="w3-example">
<h3>Example</h3>
...
<a target="_blank" href="tryit.asp?filename=tryjs_date_tostring" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>JavaScript Number toString()</h2>
<p>When used on a number, <code class="w3-codespan">toString()</code> returns the number as a string.</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_number_tostring2" target="_blank">Try it Yourself &raquo;</a>
</div>

<p>Convert a number to a string, using base 2 (binary):</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let x = 123;<br>
...
<hr>
<!--start-->
<h2>JavaScript Function toString()</h2>
<p>When used on a function, <code class="w3-codespan">toString()</code> returns the source code of the
function as a string.</p>
<hr>
<h2>JavaScript Object toString()</h2>
<p>When used on an object, <code class="w3-codespan">toString()</code> an object returns "[object Object]".</p>
<p>To provide a meaningful string representation, it can be overridden in the object definition:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let person = {<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_object_tostring" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_nan.asp">&#10094; Previous</a>
