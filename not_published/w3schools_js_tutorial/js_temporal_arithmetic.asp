...
<html lang="en-US">
<head>
<title>JavaScript Temporal Date Arithmetic - Add and Subtract Dates Safely</title>
<meta charset="utf-8">
...
<h1>JS Temporal Arithmetic</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_temporal_now.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_temporal_differences.asp">Next &#10095;</a>
</div>
<div class="ws-info">
<h2>Add and Subtract Dates Safely</h2>
<p><b>JavaScript Temporal</b> has methods for easy and reliable <b>date and time arithmetic</b>.</p>
<p><b>Add and subtract</b> days, months, years, and time without modifying the original value.</p>
<p>Perform date arithmetic without <b>DST (Daylight Saving Time) or Time Zone problems</b>.</p>
</div>
...
<hr>
<h2>JavaScript Temporal Add</h2>
<p>The <code class="w3-codespan">add()</code> method accepts a <b>duration object</b> as input.</p>
<p>Example: <b>{ days: 10 }</b>.</p>

<p>It returns a new temporal date object moved forward by the duration.</p>
<div class="w3-example">
<h3>Syntax</h3>
<div class="w3-code notranslate jsHigh w3-large">
<i>temporal</i>.add(<i>duration</i>)
</div>
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create a Temporal object<br>
const myDate = Temporal.PlainDate.from("2026-05-17");<br>
<br>
// Add a duration<br>
const newDate = myDate.add({ days: 10 });
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_add" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>JavaScript Temporal Subtract</h2>
<p>The <code class="w3-codespan">subtract()</code> method accepts a <b>duration object</b> as input.</p>
<p>Example: <b>{ days: 10 }</b>.</p>
<p>It returns a new temporal date object moved backward by the duration.</p>
<div class="w3-example">
<h3>Syntax</h3>
<div class="w3-code notranslate jsHigh w3-large">
<i>temporal</i>.subtract(<i>duration</i>)
</div>
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create a Temporal object<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_subtract" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="ws-note">
<p>Both <b>add</b> and <b>subract</b> are <b>immutable</b>: They both return a new Temporal object.</p>
</div>

<hr>
<h2>Date Boundaries</h2>
<p>Both add and subtract <b>handle date boundaries</b>:</p>
<p>Adding one day to March 31st is April 1st.</p>

<hr>
<h2>Add Months</h2>
<p>Temporal automatically handles different month lengths.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create a Temporal object<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_add_month" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="ws-note">
<p>If the next month has fewer days, Temporal adjusts automatically.</p>
</div>

<hr>
<h2>Add Years</h2>
<p>Adding years works correctly, even for leap years.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create a Temporal object<br>
const date = Temporal.PlainDate.from("2024-02-29");<br>
<br>
const result = date.add({ years: 1 });<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_add_year" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="ws-note">
<p>Temporal handles leap year adjustments automatically.</p>
</div>

<hr>
<h2>Supported Duration Units</h2>
<p>The <code class="w3-codespan">add()</code> and <code class="w3-codespan">subtract()</code>
methods accept a <b>duration object</b> as input.</p>
<p>Example: <b>{ months: 2, days: 7, hours: 1 }</b>.</p>
<p>The following <b>duration units</b> are supported:</p>
<ul>
<li>years</li>
<li>months</li>
<li>weeks</li>
...
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create any Temporal object<br>
const myDate = Temporal.PlainDate.from('2026-05-17');<br>
<br>
// Add multiple units<br>
const newDate = myDate.add({ years: 1, months: 2, days: 15 });
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_add_multiple" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>PlainDateTime add() and subtract()</h2>
...
<hr>
<h2>PlainDate add() and subtract()</h2>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<br>
// Add and subtract time<br>
const earlier = date.subtract({ months: 3 });<br>
const later = date.add({ days: 10 });
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plaindate_add_subtract" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<h2>Instant add() and subtract()</h2>
<p>From a <b>Temporal.Instant</b> you can only add or subtract time durations
(hours, minutes, seconds) but not calendar durations like months or years,
as their length can vary depending on the time zone and the calendar.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create a Temporal.Instant object<br>
const now = Temporal.Instant.fromEpochMilliseconds(Date.now());<br>
<br>
// Subtract 5 hours and 30 minutes<br>
const fiveHalfHoursAgo = now.subtract({ hours: 5, minutes: 30 });<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_subtract_instant" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Add a Duration to Now</h2>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create a Temporal object<br>
const today = Temporal.Now.plainDateISO();<br>
<br>
// Add a duration<br>
const nextWeek = today.add({ days: 7 });<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_add_now" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="ws-note">
<h2>Immutable</h2>
<p>Unlike the old Date object, Temporal objects are <b>immutable</b>.</p>
<p>All methods return a new instance without modifying the existing one.</p>
</div>
<hr>
<h2>Date Arithmetic with ZonedDateTime</h2>
<p>ZonedDateTime handles daylight saving time (DST) safely.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_add_zoned" target="_blank">Try it Yourself &raquo;</a>
</div>
<p>If a DST change occurs, Temporal adjusts automatically.</p>

<hr>
<h2>Compare with Date Arithmetic</h2>
<p><b>JavaScript legacy Date</b> can cause leap year errors:</p>
<div class="w3-example">
<h3>Date Example</h3>
<div class="w3-code notranslate jsHigh">
// Create a Date object<br>
const start = new Date("2026-02-17");<br>
<br>
// Add 12 days<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_vs_date" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="ws-note">
<h3>The Result is Wrong!</h3>
<p>2026 is not a leap year. 2026 is not divisible by 4.</p>
<p>The closest leap years are 2024 and 2028.</p>
</div>
<div class="w3-example">
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_add_leap" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Best Practices</h2>
<ul>
  <li><p>Use <b>PlainDate</b> for date-only arithmetic.</p></li>
  <li><p>Use <b>ZonedDateTime</b> for time zone-aware calculations.</p></li>
  <li><p>Avoid manual millisecond calculations.</p></li>
  <li><p>Prefer Temporal because it is <b>Immutable</b>.</p></li>
</ul>
