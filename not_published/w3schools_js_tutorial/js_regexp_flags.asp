...
<html lang="en-US">
<head>
<title>JavaScript RegExp Modifier Flags</title>
<meta charset="utf-8">
...
<h1>JavaScript RegExp Flags</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_regexp.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_regexp_characters.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
<h2>RegExp Modifier Flags</h2>
<p><b> Flags</b> are parameters that can modify how a regex pattern is used,
such as making it case-insensitive or global.</p>
...
<tr>
  <td>/d</td>
  <td>Performs substring matches (new 2022)</td>
</tr>
<tr>
  <td>/g</td>
  <td>Performs a global match (find all)</td>
</tr>
<tr>
  <td>/i</td>
...
<tr>
  <td>/m</td>
  <td>Performs multiline matching</td>
</tr>
<tr>
  <td>/s</td>
  <td>Allows . (dot) to match line terminators (new 2018)</td>
</tr>
<tr>
  <td>/u</td>
  <td>Enables Unicode support (new 2015)</td>
</tr>
<tr>
  <td>/v</td>
  <td>An upgrade to the /u flag for better Unicode support (new 2025)</td>
</tr>
<tr>
  <td>/y</td>
  <td>Performs a "sticky" search (new 2015)</td>
</tr>
</table>
</div>

<hr>
<h2>Flag Syntax: /pattern/flags</h2>
<div class="w3-stretch">
<table class="w3-table w3-white w3-bordered w3-border">
<tr><td>/</td><td>Opening delimiter for the regular expression</td></tr>
<tr><td>pattern</td><td>Regular expression (a search criteria)</td></tr>
<tr><td>/</td><td>Closing delimiter for the regular expression</td></tr>
<tr><td>flags</td><td>One or more single modifier flags</td></tr>
</table>
</div>

<!--start-->
<hr>
<h2>RegExp /g Flag (Global)</h2>
<p>The <b>/g</b> flag matches all occurrences of the pattern, rather than just the first one.</p>
<div class="w3-example">
<h3>Example</h3>
<p>A global search for "is" in a string:</p>
<div class="w3-code notranslate jsHigh">
let text = "Is this all there is?";<br>
const pattern = /is/g;<br>
<br>
let result = text.match(pattern);<br>
</div>
<p>
<a class="w3-btn" href="tryit.asp?filename=tryjs_regexp_g" target="_blank">Try it Yourself &raquo;</a></p>
</div>

<hr>
<h2>RegExp /i Flag (Insensitive)</h2>
<p>The <b>/i</b> flag makes the match case-insensitive: /abc/i matches "abc", "AbC", "ABC".</p>
<div class="w3-example">
<h3>Example</h3>
...
<p>
<a class="w3-btn" href="tryit.asp?filename=tryjs_regexp_i" target="_blank">Try it Yourself &raquo;</a></p>
</div>

<hr>
<h2>RegExp /d Flag</h2>
<p>The <b>/d</b> flag (the Indices flag) is used to find the <b>start and end positions</b>
of substrings captured by regular expression groups.</p>
<p>It does not change the regex match. It provides metadata about the result.</p>
<p>The array returned by <code class="w3-codespan">exec()</code> or <code class="w3-codespan">match()</code>
includes an additional <b>indices</b> property: An array of pairs representing the [start, end] index of a specific capture group.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Match every sub text that starts or ends with aa or bb:</p>
<div class="w3-code notranslate jsHigh">
let text = "aaaabb";<br>
const pattern = /(aa)(bb)/d;<br>
<br>
let result = text.match(pattern);<br>
let indexes = result.indices;<br>
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_regexp_indices" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>You can check if a regex has the /d flag using the hasIndices property.</p>

<hr>
<h2>RegExp /s Flag (Single line/DotAll)</h2>
<p>The <b>/s</b> flag allows the . (dot) metacharacter to match newline characters (\n) in addition to any other
character.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Without the /s flag, \n does not match . (wildchars):</p>
<div class="w3-code notranslate jsHigh">
let text = "Line\nLine.";<br>
const pattern = /Line./gs;<br>
<br>
let result = text.match(pattern);<br>
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_regexp_flag_s" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>RegExp /m Flag (Multiline)</h2>
<p>The <b>/m</b> (multiline) flag specifies a <b>multiline match</b>.</p>
<div class="w3-example">
<h3>Example</h3>
...
<a target="_blank" href="tryit.asp?filename=tryjs_regexp_m" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>The <b>/m</b> flag affects the behavior of <b>^</b> and <b>$</b>.</p>
<p><b>^</b> specifies a match at the start of a string.</p>
<p><b>$</b> specifies a match at the end of a string.</p>
<p>With <b>/m</b> set, <b>^</b> and <b>$</b> will match the start and end of each line,
in a multiline string, in addition to the start and end of the entire string.</p>

<hr>

<h2>RegExp /y Flag (Sticky):</h2>
<p>The <b>/y</b> flag performs a "sticky" search from the lastIndex property of the RegExp object.</p>
<p>The <b>/y</b> flag lets a match start at the exact position where the last match ended.</p>

<div class="w3-example">
<h3>Examples</h3>
<div class="w3-code notranslate jsHigh">
let text = "abc def ghi";<br>
const pattern = /\w+/y;<br>
<br>
...
<p>The /y flag must be set to allow match from a position.</p>
...
<p>The example above uses a regex metacharacter <b>\w</b></p>
<p>The meaning of <b>/\w/</b> is "match an (alphanumeric) word character".</p> 
<p>The meaning of <b>/\w+/</b> is "match one or more word characters".</p> 
<p>You will learn more about <b>metacharacters</b> in the next chapters.</p>
</div> 
...
<hr>
<h2>RegExp /u Flag (Unicode)</h2>
<p>The <b>/u</b> flag enables full Unicode support in a regular expression.</p>
<p>By default, JavaScript RegExp treats 4-byte Unicode characters
(like emojis or less common symbols) as two separate 2-byte "surrogate" code units.</p>
<p>The <b>/u</b> flag treats the pattern as a sequence of Unicode code points,
which is important for correctly handling of characters outside the Basic Multilingual Plane (BMP).</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let text = "&#19904;";<br>
const pattern = /\u{04DC0}/u;<br>
<br>
// Returns true:<br>
let result = pattern.test(text);
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_regexp_flag_u_1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p>Without the /u flag, regular expressions are not "Unicode-aware".</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let text = "&#19904;";<br>
const pattern = /\u{04DC0}/;<br>
<br>
// Returns false:<br>
let result = pattern.test(text);
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_regexp_flag_u_3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="ws-note">

<p><b>JavaScript 2025</b> introduced the <b>/v</b> flag as an "upgrade" to the <b>/u</b> flag.</p>
<p><b>The /v Flag</b> enables more Unicode-related features.</p>
</div>

<hr>
<h2>RegExp /v Flag (Unicode Sets)</h2>
<p>The <b>/v</b> flag is an upgrade to the /u flag for better Unicode support.</p>

<p>It enables more Unicode-related features.</p>
...
<div class="w3-code notranslate jsHigh">
let text = "Hello &#128516;";<br>
const pattern = /\p{Emoji}/v;<br>
<br>
// Returns true:<br>
let result = pattern.test(text);<br>
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_regexp_flag_v" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p>Without the /v flag, regular expressions are not "Unicode-aware".</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let text = "Hello &#128516;";<br>
const pattern = /\p{Emoji}/;<br>
<br>
// Returns false:<br>
let result = pattern.test(text);<br>
</div>
...
<hr>
<h2>RegExp Group Modifiers (?flag)</h2>

<p>The (?flag) syntax is a group modifier (inline flag modifier).</p>
<p>It allows for modifying flags in a part of a pattern, rather than to the entire pattern.</p>
<p>(?flags:pattern) enables the flags only for the pattern in the group.</p>

<div class="w3-example">
<h3>Example</h3>
<p>The i flag is only enabled for the W3Schools part of the pattern.</p>
<div class="w3-code notranslate jsHigh">
let text = "W3Schools tutorials.";<br>
const pattern = /(?i:WShools) tutorials/;<br>
<br>
// Returns true:<br>
let result = pattern.test(text);
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_regexp_groups_modifier" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>

<p>The i flag is only enabled for the W3Schools part of the pattern.</p>
<div class="w3-code notranslate jsHigh">
let text = "W3Schools Tutorials.";<br>
const pattern = /(?i:W3Sshools) tutorials/;<br>
<br>
// Returns false:<br>
let result = pattern.test(text);
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_regexp_groups_modifier_2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>JavaScript Regex Flag Properties</h2>
<h4>Revised July 2025</h4>
<div class="w3-stretch">
<table class="ws-table-all notranslate">
<tr></tr>
...
<tr>
  <td>global</td>
  <td>Returns <code class="w3-codespan">true</code> if the /g flag is set</td>
</tr>
<tr>
  <td>hasIndices</td>
  <td>Returns <code class="w3-codespan">true</code> if the /d flag is set</td>
</tr>
<tr>
  <td>ignoreCase</td>
  <td>Returns <code class="w3-codespan">true</code> if the /i flag is set</td>
</tr>
<tr>
  <td>multiline</td>
  <td>Returns <code class="w3-codespan">true</code> if the /m flag is set</td>
</tr>
<tr>
  <td>dotAll</td>
  <td>Returns <code class="w3-codespan">true</code> if the /s flag is set</td>
</tr>
<tr>
  <td>sticky</td>
  <td>Returns <code class="w3-codespan">true</code> if the /y flag is set</td>
</tr>
<tr>
  <td>unicode</td>
  <td>Returns <code class="w3-codespan">true</code> if the /u flag is set</td>
</tr>
<tr>
  <td>unicodeSets</td>
  <td>Returns <code class="w3-codespan">true</code> if the /v flag is set</td>
</tr>
</table>
</div>

<hr>
<h2>The dotAll Property</h2>
<p>The <code class="w3-codespan">dotAll</code> property returns <code class="w3-codespan">true</code>
if the /s flag is set.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const pattern = /W3Schools/s;<br>
<br>
let result = pattern.dotAll;
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_regexp_prop_dotall" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>The global Property</h2>
<p>The <code class="w3-codespan">global</code> property returns <code class="w3-codespan">true</code>
if the /g flag is set.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const pattern = /W3Schools/g;<br>
<br>
let result = pattern.global;
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_regexp_prop_global" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>The hasIndices Property</h2>
<p>The <code class="w3-codespan">hasIndices</code> property returns <code class="w3-codespan">true</code>
if the /d flag is set.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const pattern = /W3Schools/d;<br>
<br>
let result = pattern.hasIndices;
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_regexp_prop_hasindices" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>The ignoreCase Property</h2>
<p>The <code class="w3-codespan">ignoreCase</code> property returns <code class="w3-codespan">true</code>
if the /i flag is set.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const pattern = /W3Schools/i;<br>
<br>
let result = pattern.ignoreCase;
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_regexp_prop_ignorecase" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>The multiline Property</h2>
<p>The <code class="w3-codespan">multiline</code> property returns <code class="w3-codespan">true</code>
if the /m flag is set.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const pattern = /W3Schools/m;<br>
<br>
let result = pattern.multiline;
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_regexp_prop_multiline" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>The sticky Property</h2>
<p>The <code class="w3-codespan">sticky</code> property returns <code class="w3-codespan">true</code>
if the /y flag is set.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const pattern = /W3Schools/y;<br>
<br>
let result = pattern.sticky;
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_regexp_prop_sticky" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>The unicode Property</h2>
<p>The <code class="w3-codespan">unicode</code> property returns <code class="w3-codespan">true</code>
if the /u flag is set.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let text = "&#19904;";<br>
...
<a target="_blank" href="tryit.asp?filename=tryjs_regexp_prop_unicode" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>The unicodeSets Property</h2>
<p>The <code class="w3-codespan">unicodeSets</code> property returns <code class="w3-codespan">true</code>
if the /v flag is set.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let text = "Hello &#128516;";<br>
...
<a target="_blank" href="tryit.asp?filename=tryjs_regexp_prop_unicodesets" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="ws-note">
<h2>See Also:</h2>
<p class="w3-large"><a href="js_regexp_characters.asp">JavaScript RegExp Tutorial</a></p>
<p class="w3-large"><a href="js_regexp_characters.asp">JavaScript RegExp Character Classes</a></p>
<p class="w3-large"><a href="js_regexp_meta_characters.asp">JavaScript RegExp Meta Characters</a></p>
<p class="w3-large"><a href="js_regexp_assertions.asp">JavaScript RegExp Assertions</a></p>
<p class="w3-large"><a href="js_regexp_groups.asp">JavaScript RegExp Groups</a></p>
<p class="w3-large"><a href="js_regexp_quantifiers.asp">JavaScript RegExp Quantifiers</a></p>
<p class="w3-large"><a href="js_regexp_patterns.asp">JavaScript RegExp Patterns</a></p>
<p class="w3-large"><a href="js_regexp_objects.asp">JavaScript RegExp Objects</a></p>
<p class="w3-large"><a href="js_regexp_methods.asp">JavaScript RegExp Methods</a></p>
</div>
