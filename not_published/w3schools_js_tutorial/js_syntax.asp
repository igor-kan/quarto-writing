...
<div class="ws-info">
<h2>Syntax Rules</h2>
<h4>Syntax are the rules how programs must be constructed:</h4>
...
<ul>
<li><b>Literals</b> (Fixed values)</li>
<li><b>Variables</b> (Variable values)</li>
</ul>
<hr>
<h2>JavaScript Literals</h2>
<p>The most important syntax rules for <b>literals</b> (fixed values) are:</p>
<p><b>Numbers</b> are written with or without decimals:</p>
...
<p><b>Strings</b> are text, written within double or single quotes:</p>
...
<p>JavaScript <b>keywords</b> are used to defines <b>actions</b> to be performed.</p>
<p>The
<code class="w3-codespan">let</code> and <code class="w3-codespan">const</code> keywords create variables:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let x = 5;<br>
...
<p><b>Variables</b> are containers for <b>storing data values</b>.</p>
<p>Variables must be <b>identified</b> with <b>unique names</b>.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<p>An <b>identifier</b> is the <b>name</b> you give to a variable.</p>
...
<p>JavaScript <b>assignment operators</b> (=) assign values to variables:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let x = 5;<br>
...
<p>JavaScript uses <b>arithmetic operators</b> ( <code class="w3-codespan">+</code> <code class="w3-codespan">-</code> <code class="w3-codespan">*</code> <code class="w3-codespan">/</code></code> ) to 
<b>compute</b> values: </p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
5 * 10<br> 
...
<p>JavaScript identifiers are <b>case sensitive</b>.</p>
<p>The variables <code class="w3-codespan">lastName</code> and <code class="w3-codespan">lastname</code>, 
...
<div class="ws-note">
<p>JavaScript programmers tend to use lower camel case.</p>
</div>
<!--stop-->
<hr>
...
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: JavaScript Syntax</h2>
  <a href="https://youtu.be/4BBlc_qDs8g&list=PLP9IO4UYNF0WWmZpE3W33vVPRl2GvjEqz" class="ga-featured ga-youtube" target="blank_" >
    <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
      ...
      <picture id="yt_div">
        <source srcset="images/img_javascript_syntax.webp" type="image/webp" />
        <img src="images/img_javascript_syntax.png" style="max-width:100%;height:auto;border-radius:6px" alt="Tutorial on YouTube" loading="lazy">
      </picture>
    </div>
  </a>
</div>
