...
<html lang="en-US">
<head>
<title>JavaScript Temporal Reference</title>
<meta charset="utf-8">
...
<h1>JS Temporal Reference</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_temporal_standards.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_arrays.asp">Next &#10095;</a>
</div>
<hr>
<div class="w3-stretch">
<img alt="Temporal Map" style="width:100%;" src="/js/img_temporal.svg">
</div>
...
<tr><td><a href="?#mark_duration">Temporal.Duration</a></td><td>Length of time (e.g days, hours, minutes)</td></tr>
<tr><td><a href="?#mark_now">Temporal.Now</a></td><td>The current time</td></tr>
<tr><td><a href="?#mark_instant">Temporal.Instant</a></td><td>A fixed point in time, independent of time zone</td></tr>
<tr><td><a href="?#mark_zoned">Temporal.ZonedDateTime</a></td><td>Date and time in a specific time zone</td></tr> 
<tr><th>Plain Dates</th><td></td></tr>
<tr><td><a href="?#mark_plaindate">Temporal.PlainDate()</a></td><td>Calendar date only (2026-05-17)</td></tr> 
<tr><td><a href="?#mark_plaintime">Temporal.PlainTime()</td><td>Time of day only (14:30:00)</td></tr>
<tr><td><a href="?#mark_plaindatetime">Temporal.PlainDateTime()</td><td>Full date and time (2026-05-17 14:30:00)</td></tr>
<tr><td><a href="?#mark_plainyearmonth">Temporal.PlainYearMonth()</td><td>Year and month only (2026-05)</td></tr> 
<tr><td><a href="?#mark_plainmonthday">Temporal.PlainMonthDay()</td><td>Month and day only (05-01)</td></tr>
</table>
</div>

<a id="mark_duration"></a>
<hr>
<h2>Temporal.Duration Methods</h2>
<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
<tr><th>Constructing</th><th>Description</th></tr>
<tr><td><a href="/jsref/jsref_duration_from.asp">from()</a></td>
<td>Returns a new duration object from an object or an ISO string</td></tr>
<tr><td><a href="/jsref/jsref_duration_from.asp">new()</a></td>
<td>Returns a new duration object from integer parameters</td></tr>
<tr><th>Arithmetic</th><th></th></tr>
<tr><td><a href="/jsref/jsref_duration_abs.asp">abs()</a></td><td>Returns a new duration with the absolute value of this duration</td></tr>
<tr><td><a href="/jsref/jsref_duration_add.asp">add()</a></td><td>Returns a new duration with a duration added to this duration</td></tr>
<tr><td><a href="/jsref/jsref_duration_negated.asp">negated()</a></td><td>Returns a new duration with this duration negated</td></tr>
<tr><td><a href="/jsref/jsref_duration_round.asp">round()</a></td><td>Returns a new duration with this duration rounded</td></tr>
<tr><td><a href="/jsref/jsref_duration_subtract.asp">subtract()</a></td><td>Returns a new duration with a duration subtracted from this duration</td></tr>
<tr><th>Comparing</th><th></th></tr>
<tr><td><a href="/jsref/jsref_duration_compare.asp">compare()</a></td>
<td>Compares two durations (returning -1, 0, or 1)</td></tr>
<tr><th>Converting</th><td></td></tr>
<tr><td><a href="/jsref/jsref_duration_with.asp">with()</a></td><td>Returns a new duration with specified field(s) modified</td></tr>
<tr><th>Formatting</th><td></td></tr>
<tr><td><a href="/jsref/jsref_duration_total.asp">total()</a></td><td>Returns a number representing the duration in a given unit</td></tr>
<tr><td><a href="/jsref/jsref_duration_tojson.asp">toJSON()</a></td><td>Returns an RFC 9557 format string for JSON serialization</td></tr>
<tr><td><a href="/jsref/jsref_duration_tolocalestring.asp">toLocaleString()</a></td><td>Returns a language-sensitive representation of the time</td></tr>
<tr><td><a href="/jsref/jsref_duration_tostring.asp">toString()</a></td><td>Returns an RFC 9557 format string representation</td></tr>
<tr><td><a href="/jsref/jsref_duration_valueof.asp">valueOf()</a></td><td>Throws a TypeError (prevents temporals from being converted to primitives)</td></tr>
</table>
</div>

<h2>Temporal.Duration Properties</h2>
<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
<tr><th>Property</th><th>Description</th></tr>
<tr><td>blank</td><td>Boolean true if the duration represents a zero duration</td></tr>
<tr><td>days</td><td>Days as an integer (1-31)</td></tr>
<tr><td>hours</td><td>Hours as an integer (0-23)</td></tr>
<tr><td>microseconds</td><td>Microseconds as an integer (0-999)</td></tr>
<tr><td>milliseconds</td><td>Milliseconds as an integer (0-999)</td></tr>
<tr><td>minutes</td><td>Minutes as an integer (0-59)</td></tr>
<tr><td>months</td><td>Months as an integer (1-12)</td></tr>
<tr><td>nanoseconds</td><td>Nanoseconds as an integer (0-999)</td></tr>
<tr><td>seconds</td><td>Seconds as an integer (0-59)</td></tr>
<tr><td>sign</td><td>1 positive -1 negative</td></tr>
<tr><td>weeks</td><td>Weeks as an integer</td></tr>
<tr><td>years</td><td>Years as an integer</td></tr>
</table>
</div>
...
<div class="ws-note">
<h2>Learn More:</h2>
<p class="w3-large"><a target="_top" href="js_temporal_duration.asp">Temporal Duration Tutorial</a>
</p>
</div>

<a id="mark_now"></a>
<hr>
<h2>Temporal.Now Methods</h2>
<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
<tr><th>Method</th><th>Description</th></tr>
<tr><td><a href="/jsref/jsref_temporal_now_instant.asp">instant()</a></td>
<td>Returns current time as a Temporal.Instant object</td></tr>
<tr><td><a href="/jsref/jsref_temporal_now_plaindateiso.asp">plainDateISO()</a></td>
<td>Returns current date as a Temporal.PlainDate object</td></tr>
<tr><td><a href="/jsref/jsref_temporal_now_plaindatetimeiso.asp">plainDateTimeISO()</a></td>
<td>Returns current date and time as a Temporal.PlainDateTime object</td></tr>
<tr><td><a href="/jsref/jsref_temporal_now_plaintimeiso.asp">plainTimeISO()</a></td>
<td>Returns current time as a Temporal.PlainTime object</td></tr>
<tr><td><a href="/jsref/jsref_temporal_now_timezoneid.asp">timeZoneId</a></td>
<td>Returns system's time zone as a time zone id</td></tr>
<tr><td><a href="/jsref/jsref_temporal_now_zoneddatetimeiso.asp">zonedDateTimeISO()</a></td>
<td>Returns current date and time as a Temporal.ZonedDateTime object</td></tr>
</table>
</div>
...
<div class="ws-note">
<h2>Learn More:</h2>
<p class="w3-large"><a target="_top" href="js_temporal_now.asp">Temporal Now Tutorial</a>
</p>
</div>

<a id="mark_instant"></a>
<hr>
<h2>Temporal.Instant Methods</h2>
<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
<tr><th>Constructing</th><th>Description</th></tr>
<tr><td><a href="/jsref/jsref_instant_new.asp">new</a></td><td>Creates a new Temporal.Instant object</td></tr>
<tr><td><a href="/jsref/jsref_instant_from.asp">from()</a></td><td>Creates a new Instant object from another instant or a string</td></tr>
<tr><td><a href="/jsref/jsref_instant_fromepochmilliseconds.asp">fromEpochMilliseconds()</a></td><td>Returns a new Instant object from a number of milliseconds</td></tr>
<tr><td><a href="/jsref/jsref_instant_fromepochnanoseconds.asp">fromEpochNanoseconds()</a></td><td>Returns a new Instant object from a number of nanoseconds</td></tr>
<tr><th>Arithmetic</th><th></th></tr>
<tr><td><a href="/jsref/jsref_instant_add.asp">add()</a></td><td>Returns a new Instant with a duration added</td></tr>
<tr><td><a href="/jsref/jsref_instant_round.asp">round()</a></td><td>Returns a new Instant with this instant rounded</td></tr>
<tr><td><a href="/jsref/jsref_instant_subtract.asp">subtract()</a></td><td>Returns a new Instant with a duration subtracted</td></tr>
<tr><th>Comparing</th><th></th></tr>
<tr><td><a href="/jsref/jsref_instant_compare.asp">compare()</a></td><td>Returns -1, 0, or 1 from comparing two instants</td></tr>
<tr><td><a href="/jsref/jsref_instant_equals.asp">equals()</a></td><td>Returns true if two instants are identical</td></tr>
<tr><td><a href="/jsref/jsref_instant_since.asp">since()</a></td><td>Returns the duration since another date</td></tr>
<tr><td><a href="/jsref/jsref_instant_until.asp">until()</a></td><td>Returns the duration until another date</td></tr>
<tr><th>Converting</th><td></td></tr>
<tr><td><a href="/jsref/jsref_instant_tozoneddatetimeiso.asp">toZonedDateTimeISO()</a></td><td>Returns a new ZonedDatetime object</td></tr>
<tr><th>Formatting</th><td></td></tr>
<tr><td><a href="/jsref/jsref_instant_tojson.asp">toJSON()</a></td><td>Returns an RFC 9557 format string for JSON serialization</td></tr>
<tr><td><a href="/jsref/jsref_instant_tolocalestring.asp">toLocaleString()</a></td><td>Returns a language-sensitive representation of the instant</td></tr>
<tr><td><a href="/jsref/jsref_instant_tostring.asp">toString()</a></td><td>Returns an RFC 9557 format string representation of the instant</td></tr>
<tr><td><a href="/jsref/jsref_instant_valueof.asp">valueOf()</a></td><td>Throws a TypeError (Instants should not be converted to a primitives)</td></tr>
</table>
</div>
...
<div class="ws-note">
<h2>Learn More:</h2>
<p class="w3-large"><a target="_top" href="js_temporal_instant.asp">JavaScript Temporal Instant Tutorial</a>
</p>
</div>

<a id="mark_zoned"></a>
<hr>
<h2>Temporal ZonedDateTime Methods</h2>
<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
<tr><th>Constructing</th><th>Description</th></tr>
<tr><td><a href="/jsref/jsref_zoneddatetime_new.asp">new</td>
<td>Creates a ZonedDateTime object</td></tr>
<tr><td><a href="/jsref/jsref_zoneddatetime_from.asp">from()</a></td>
<td>Creates a ZonedDateTime object from an object or a string</td></tr>

<tr><th>Converting</th><th></th></tr>
<tr><td><a href="/jsref/jsref_zoneddatetime_gettimezonetransition.asp">getTimeZone<br>Transition()</a></td>
<td>Returns a ZonedDateTime object representing the closest
instant after or before this instant</td></tr>
<tr><td><a href="/jsref/jsref_zoneddatetime_toinstant.asp">toInstant()</a></td>
<td>Returns a Instant object representing this date-time</td></tr>
<tr><td><a href="/jsref/jsref_zoneddatetime_toplaindate.asp">toPlainDate()</a></td>
<td>Returns a PlainDate object representing this date-time</td></tr>
<tr><td><a href="/jsref/jsref_zoneddatetime_toplaindatetime.asp">toPlainDateTime()</a></td>
<td>Returns a PlainDateTime object representing this date-time</td></tr>
<tr><td><a href="/jsref/jsref_zoneddatetime_toplaintime.asp">toPlainTime()</a></td>
<td>Returns a PlainTime object representing this date-time</td></tr>
<tr><td><a href="/jsref/jsref_zoneddatetime_startofday.asp">startOfDay()</a></td>
<td>Returns a ZonedDateTime representing the first instant of this date</td></tr>

<tr><th>Updating</th><th></th></tr>
<tr><td><a href="/jsref/jsref_zoneddatetime_with.asp">with()</a></td>
<td>Returns a ZonedDateTime with specified fields modified</td></tr>
<tr><td><a href="/jsref/jsref_zoneddatetime_withcalendar.asp">withCalendar()</a></td>
<td>Returns a ZonedDateTime with a different calendar system</td></tr>
<tr><td><a href="/jsref/jsref_zoneddatetime_withplaintime.asp">withPlainTime()</a></td>
<td>Returns a ZonedDateTime the time part replaced by a new time</td></tr>
<tr><td><a href="/jsref/jsref_zoneddatetime_withtimezone.asp">withTimeZone()</a></td>
<td>Returns a ZonedDateTime representing this date in a new time zone</td></tr>

<tr><th>Arithmetic</th><th></th></tr>
<tr><td><a href="/jsref/jsref_zoneddatetime_add.asp">add()</a></td>
<td>Returns a ZonedDateTime with a duration added</td></tr>
<tr><td><a href="/jsref/jsref_zoneddatetime_subtract.asp">subtract()</a></td>
<td>Returns a ZonedDateTime with a duration subtracted</td></tr>
<tr><td><a href="/jsref/jsref_zoneddatetime_round.asp">round()</a></td>
<td>Returns a ZonedDateTime rounded to a given unit</td></tr>

<tr><th>Comparing</th><th></th></tr>
<tr><td><a href="/jsref/jsref_zoneddatetime_compare.asp">compare()</a></td>
<td>Returns -1, 0, or 1 from comparing two dates</td></tr>
<tr><td><a href="/jsref/jsref_zoneddatetime_equals.asp">equals()</a></td>
<td>Returns true if two ZonedDateTime objects are identical</td></tr>
<tr><td><a href="/jsref/jsref_zoneddatetime_since.asp">since()</a></td>
<td>Returns the difference from another date</td></tr>
<tr><td><a href="/jsref/jsref_zoneddatetime_until.asp">until()</a></td>
<td>Returns the difference until another date</td></tr>

<tr><th>Formatting</th><td></td></tr>
<tr><td><a href="/jsref/jsref_zoneddatetime_tojson.asp">toJSON()</a></td>
<td>Returns an ISO 8601 string for JSON serialization</td></tr>
<tr><td><a href="/jsref/jsref_zoneddatetime_tolocalestring.asp">toLocaleString()</a></td>
<td>Returns a language-sensitive representation of the date</td></tr>
<tr><td><a href="/jsref/jsref_zoneddatetime_tostring.asp">toString()</a></td>
<td>Returns an ISO 8601 string representation</td></tr>
<tr><td><a href="/jsref/jsref_zoneddatetime_valueof.asp">valueOf()</a></td>
<td>Throws a TypeError (prevents temporals from being converted to primitives)</td></tr>
</table>
</div>

<h2>Temporal ZonedDateTime Properties</h2>
<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
<tr><th>Property</th><th>Description</th></tr>
<tr><td>calendarID</td><td>Calendar system identifier ("iso8601")</td></tr>
<tr><td>day</td><td>The day as an integer (1-31)</td></tr>
<tr><td>dayOfWeek</td><td>The day of the week as an integer (1 = Monday)</td></tr>
<tr><td>dayOfYear</td><td>The ordinal day of the year</td></tr>
<tr><td>daysInMonth</td><td>The total number of days in that month</td></tr>
<tr><td>daysInWeek</td><td>The total number of days in that week</td></tr>
<tr><td>daysInYear</td><td>The total number of days in that year</td></tr>
<tr><td>epochMilliseconds</td><td>Number of milliseconds since Unix epoch</td></tr>
<tr><td>epochNanoseconds</td><td>Number of nanoseconds since Unix epoch</td></tr>
<tr><td>era</td><td>The era name of the calendar, if applicable ("gregory")</td></tr>
<tr><td>eraYear</td><td>The year within the era, if applicable</td></tr>
<tr><td>hour</td><td>The hour as an integer (0-23)</td></tr>
<tr><td>hoursInDay</td><td>Hours in this day in this time zone(0-25)</td></tr>
<tr><td>inLeapYear</td><td>A boolean indicating if the date falls in a leap year</td></tr>
<tr><td>microsecond</td><td>The microsecond as an integer (0-999)</td></tr>
<tr><td>millisecond</td><td>The millisecond as an integer (0-999)</td></tr>
<tr><td>minute</td><td>The minute as an integer (0-59)</td></tr>
<tr><td>month</td><td>The month as an integer (1-12)</td></tr>
<tr><td>monthCode</td><td>A calendar-specific string code for the month ("M01")</td></tr>
<tr><td>monthsInYear</td><td>The total number of months in that year</td></tr>
<tr><td>nanosecond</td><td>The nanosecond as an integer (0-999)</td></tr>
<tr><td>offset</td><td>Offset used to interpret this instant (+HH:mm:ss.sssssssss)</td></tr>
<tr><td>offsetNanoseconds</td><td>Offset used to interpret this instant in nanoseconds</td></tr>
<tr><td>second</td><td>The second as an integer (0-59)</td></tr>
<tr><td>timeZoneId</td><td>Time zone identifier used to interpret this instant</td></tr>
<tr><td>weekOfYear</td><td>The week number within the year</td></tr>
<tr><td>year</td><td>The year as an integer</td></tr>
<tr><td>yearOfWeek</td><td>The year that the week belongs to</td></tr>
</table>
</div>

<div class="w3-example">
<h3>Display All Properties</h3>
<div class="w3-code notranslate jsHigh">
const zoned = Temporal.ZonedDateTime.from("2026-05-17T14:30:00[Europe/Oslo]");
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_zoned_prop" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="ws-note">
<h2>Learn More:</h2>
<p class="w3-large"><a target="_top" href="js_temporal_zoneddatetime.asp">Temporal ZonedDateTime Tutorial</a>
</p>
</div>

<a id="mark_plaindate"></a>
<hr>
<h2>Temporal Plain Objects</h2>
<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
<tr><th>Object</th><th>Description</th></tr>
<tr><td>Temporal.PlainDate</td><td>Calendar date only (2026-05-21)</td></tr> 
<tr><td>Temporal.PlainTime</td><td>Time of day only (14:30:00)</td></tr>
<tr><td>Temporal.PlainMonthDay</td><td>Month and day only (05-01)</td></tr>
<tr><td>Temporal.PlainYearMonth</td><td>Year and month only (2026-05)</td></tr> 
</table>
</div>

<hr>
<h2>Temporal.PlainDate Methods</h2>
<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
<tr><th>Constructing</th><th>Description</th></tr>
<tr><td><a href="/jsref/jsref_plaindate_from.asp">from()</a></td><td>Creates a new PlainDate object from an object or a string</td></tr>
<tr><td><a href="/jsref/jsref_plaindate_new.asp">new</a></td><td>Creates a new PlainDate object from (year, month, day)</td></tr>
<tr><th>Arithmetic</th><th></th></tr>
<tr><td><a href="/jsref/jsref_plaindate_add.asp">add()</a></td><td>Returns a new PlainDate with a duration added</td></tr>
<tr><td><a href="/jsref/jsref_plaindate_subtract.asp">subtract()</a></td><td>Returns a new PlainDate with a duration subtracted</td></tr>
<tr><th>Comparing</th><th></th></tr>
<tr><td><a href="/jsref/jsref_plaindate_compare.asp">compare()</a></td><td>Returns -1, 0, or 1 from comparing two dates</td></tr>
<tr><td><a href="/jsref/jsref_plaindate_equals.asp">equals()</a></td><td>Returns true if two PlainDate objects are identical</td></tr>
<tr><td><a href="/jsref/jsref_plaindate_since.asp">since()</a></td><td>Returns the difference since another date</td></tr>
<tr><td><a href="/jsref/jsref_plaindate_until.asp">until()</a></td><td>Returns the difference until another date</td></tr>
<tr><th>Converting</th><td></td></tr>
<tr><td><a href="/jsref/jsref_plaindate_toplaindatetime.asp">toPlainDateTime()</a></td><td>Returns a new PlainDateTime object</td></tr>
<tr><td><a href="/jsref/jsref_plaindate_toplainmonthday.asp">toPlainMonthDay()</a></td><td>Returns a new PlainMonthDay object</td></tr>
<tr><td><a href="/jsref/jsref_plaindate_toplainyearmonth.asp">toPlainYearMonth()</a></td><td>Returns a new PlainYearMonth object</td></tr>
<tr><td><a href="/jsref/jsref_plaindate_tozoneddatetime.asp">toZonedDateTime()</a></td><td>Returns a new ZonedDatetime object</td></tr>
<tr><td><a href="/jsref/jsref_plaindate_new.asp">with()</a></td><td>Returns a new PlainDate with specified fields modified</td></tr>
<tr><td><a href="/jsref/jsref_plaindate_withcalendar.asp">withCalendar()</td><td>Returns a new PlainDate with a different calendar system</td></tr>
<tr><th>Formatting</th><td></td></tr>
<tr><td><a href="/jsref/jsref_plaindate_tojson.asp">toJSON()</a></td><td>Returns an RFC 9557 format string for JSON serialization</td></tr>
<tr><td><a href="/jsref/jsref_plaindate_tolocalestring.asp">toLocaleString()</a></td><td>Returns a language-sensitive representation of the date</td></tr>
<tr><td><a href="/jsref/jsref_plaindate_tostring.asp">toString()</a></td><td>Returns an RFC 9557 format string representation</td></tr>
<tr><td><a href="/jsref/jsref_plaindate_valueof.asp">valueOf()</a></td><td>Throws a TypeError (should not be converted to primitives)</td></tr>
</table>
</div>

<h2>Temporal.PlainDate Properties</h2>
<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
<tr><th>Property</th><th>Description</th></tr>
...
<tr><td>daysInWeek</td><td>The total number of days in that week</td></tr>
<tr><td>daysInYear</td><td>The total number of days in that year</td></tr>
<tr><td>era</td><td>The era name of the calendar, if applicable</td></tr>
<tr><td>eraYear</td><td>The year within the era, if applicable</td></tr>
<tr><td>inLeapYear</td><td>A boolean indicating if the year is a leap year</td></tr>
<tr><td>month</td><td>The month as an integer (1-12)</td></tr>
<tr><td>monthCode</td><td>A string code for the month ("M01")</td></tr>
<tr><td>monthsInYear</td><td>The total number of months in that year</td></tr>
<tr><td>weekOfYear</td><td>The week number within the year</td></tr>
<tr><td>year</td><td>The year as an integer</td></tr>
<tr><td>yearOfWeek</td><td>The year that the week belongs to</td></tr>
...
<h3>Display All Properties</h3>
<div class="w3-code notranslate jsHigh">
const date = new Temporal.PlainDate(2026, 5, 17);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plaindate_prop" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="ws-note">
<h2>Learn More:</h2>
<p class="w3-large"><a target="_top" href="js_temporal_plain.asp">Temporal PlainDate Tutorial</a>
</p>
</div>

<a id="mark_plainyearmonth"></a>
<hr>
<h2>Temporal.PlainYearMonth Methods</h2>
<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
<tr><th>Constructing</th><th>Description</th></tr>
<tr><td><a href="/jsref/jsref_plainyearmonth_from.asp">from()</a></td><td>Creates a PlainYearMonth object from an object or a string</td></tr>
<tr><td><a href="/jsref/jsref_plainyearmonth_new.asp">new (constructor)</a></td><td>Creates a PlainYearMonth object from integer parameters</td></tr>
<tr><th>Arithmetic</th><th></th></tr>
<tr><td><a href="/jsref/jsref_plainyearmonth_add.asp">add()</a></td><td>Returns a new PlainYearMonth with a duration added</td></tr>
<tr><td><a href="/jsref/jsref_plainyearmonth_subtract.asp">subtract()</a></td><td>Returns a new PlainYearMonth with a duration subtracted</td></tr>
<tr><th>Comparing</th><th></th></tr>
<tr><td><a href="/jsref/jsref_plainyearmonth_compare.asp">compare()</a></td><td>Returns -1, 0, or 1 from comparing two dates</td></tr>
<tr><td><a href="/jsref/jsref_plainyearmonth_equals.asp">equals()</a></td><td>Returns true if two dates are identical</td></tr>
<tr><td><a href="/jsref/jsref_plainyearmonth_since.asp">since()</a></td><td>Returns the difference since another date</td></tr>
<tr><td><a href="/jsref/jsref_plainyearmonth_until.asp">until()</a></td><td>Returns the difference until another date</td></tr>
<tr><th>Converting</th><td></td></tr>
<tr><td><a href="/jsref/jsref_plainyearmonth_toplaindate.asp">toPlainDate()</a></td><td>Returns a new PlainDate object</td></tr>
<tr><td><a href="/jsref/jsref_plainyearmonth_with.asp">with()</a></td><td>Returns a new PlainYearMonth with fields modified</td></tr>
<tr><th>Formatting</th><td></td></tr>
<tr><td><a href="/jsref/jsref_plainyearmonth_tojson.asp">toJSON()</a></td><td>Returns an RFC 9557 format string for JSON serialization</td></tr>
<tr><td><a href="/jsref/jsref_plainyearmonth_tolocalestring.asp">toLocaleString()</a></td><td>Returns a language-sensitive representation of the date</td></tr>
<tr><td><a href="/jsref/jsref_plainyearmonth_tostring.asp">toString()</a></td><td>Returns an RFC 9557 format string representation</td></tr>
<tr><td><a href="/jsref/jsref_plainyearmonth_valueof.asp">valueOf()</a></td><td>TypeError (temporals cannot be converted to primitives)</td></tr>
</table>
</div>

<hr>
<h2>Temporal.PlainYearMonth Properties</h2>
<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
<tr><th>Property</th><th>Description</th></tr>
...
<div class="ws-note">
<h2>Learn More:</h2>
<p class="w3-large"><a target="_top" href="js_temporal_plainyearmonth.asp">Temporal PlainYearMonth Tutorial</a>
</p>
</div>

<a id="mark_plainmonthday"></a>
<hr>
<h2>Temporal.PlainMonthDay Methods</h2>
<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
<tr><th>Constructing</th><th>Description</th></tr>
<tr><td><a href="/jsref/jsref_plainmonthday_from.asp">from()</a></td><td>Creates a PlainMonthDay object from an object or a string</td></tr>
<tr><td><a href="/jsref/jsref_plainmonthday_new.asp">new (constructor)</a></td><td>Creates a PlainMonthDay object from integer parameters</td></tr>
<tr><th>Comparing</th><td></td></tr>
<tr><td><a href="/jsref/jsref_plainmonthday_equals.asp">equals()</a></td><td>Returns true if two PlainMonthDay objects are identical</td></tr>
<tr><th>Converting</th><td></td></tr>
<tr><td><a href="/jsref/jsref_plainmonthday_toplaindate.asp">toPlainDate()</a></td><td>Returns a new PlainDate object</td></tr>
<tr><td><a href="/jsref/jsref_plainmonthday_with.asp">with()</a></td><td>Returns a new PlainMonthDay with specified fields modified</td></tr>
<tr><th>Formatting</th><td></td></tr>
<tr><td><a href="/jsref/jsref_plainmonthday_tojson.asp">toJSON()</a></td><td>Returns an RFC 9557 format string for JSON serialization</td></tr>
<tr><td><a href="/jsref/jsref_plainmonthday_tolocalestring.asp">toLocaleString()</a></td><td>Returns a language-sensitive representation of the date</td></tr>
<tr><td><a href="/jsref/jsref_plainmonthday_tostring.asp">toString()</a></td><td>Returns an RFC 9557 format string representation of the date</td></tr>
<tr><td><a href="/jsref/jsref_plainmonthday_valueof.asp">valueOf()</a></td><td>TypeError (temporals cannot be converted to primitives)</td></tr>
</table>
</div>

<hr>
<h2>Temporal.PlainMonthDay Properties</h2>
<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
<tr><th>Property</th><th>Description</th></tr>
...
<div class="ws-note">
<h2>Learn More:</h2>
<p class="w3-large"><a target="_top" href="js_temporal_plainmonthday.asp">Temporal PlainMonthDay Tutorial</a>
</p>
</div>
...
<hr>
<h2>Temporal PlainTime Methods</h2>
<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
<tr><th>Constructing</th><th>Description</th></tr>
<tr><td><a href="/jsref/jsref_plaintime_from.asp">from()</a></td>
<td>Creates a new PlainTime object from an object or a string</td></tr>
<tr><td><a href="/jsref/jsref_plaintime_new.asp">new</a></td>
<td>Creates a new PlainTime object from integer parameters</td></tr>
<tr><th>Arithmetic</th><th></th></tr>
<tr><td><a href="/jsref/jsref_plaintime_add.asp">add()</a></td>
<td>Returns a new PlainTime with a duration added</td></tr>
<tr><td><a href="/jsref/jsref_plaintime_subtract.asp">subtract()</a></td>
<td>Returns a new PlainTime with a duration subtracted</td></tr>
<tr><td><a href="/jsref/jsref_plaintime_round.asp">round()</a></td>
<td>Returns a new PlainTime rounded to a given unit</td></tr>
<tr><th>Comparing</th><th></th></tr>
<tr><td><a href="/jsref/jsref_plaintime_compare.asp">compare()</a></td>
<td>Returns -1, 0, or 1 from comparing two times</td></tr>
<tr><td><a href="/jsref/jsref_plaintime_equals.asp">equals()</a></td>
<td>Returns true if two PlainTime objects are identical</td></tr>
<tr><td><a href="/jsref/jsref_plaintime_since.asp">since()</a></td>
<td>Returns the difference since another time</td></tr>
<tr><td><a href="/jsref/jsref_plaintime_until.asp">until()</a></td>
<td>Returns the difference until another time</td></tr>
<tr><th>Modifying</th><td></td></tr>
<tr><td><a href="/jsref/jsref_plaintime_with.asp">with()</a></td>
<td>Returns a new PlainTime with specified fields modified</td></tr>
<tr><th>Formatting</th><td></td></tr>
<tr><td><a href="/jsref/jsref_plaintime_tojson.asp">toJSON()</a></td>
<td>Returns an RFC 9557 format string for JSON serialization</td></tr>
<tr><td><a href="/jsref/jsref_plaintime_tolocalestring.asp">toLocaleString()</a></td>
<td>Returns a language-sensitive representation of the time</td></tr>
<tr><td><a href="/jsref/jsref_plaintime_tostring.asp">toString()</a></td>
<td>Returns an RFC 9557 format representation of the time</td></tr>
<tr><td><a href="/jsref/jsref_plaintime_valueof.asp">valueOf()</a></td>
<td>Throws a TypeError<br>
Prevents temporals from being converted to primitives</td></tr>
</table>
</div>

<hr>
<h2>Temporal.PlainTime Properties</h2>
<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
<tr><th>Property</th><th>Description</th></tr>
...
<div class="ws-note">
<h2>Learn More:</h2>
<p class="w3-large"><a target="_top" href="js_temporal_plaintime.asp">Temporal PlainTime Tutorial</a>
</p>
</div>

<a id="mark_plaindatetime"></a>
<hr>
<h2>Temporal.PlainDateTime Methods</h2>
<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
<tr><th>Constructing</th><th>Description</th></tr>
<tr><td><a href="/jsref/jsref_plaindatetime_from.asp">from()</a></td>
<td>Creates a PlainDateTime object from an object or a string</td></tr>
<tr><td><a href="/jsref/jsref_plaindatetime_new.asp">new</a></td>
<td>Creates a PlainDateTime object from parameters</td></tr>
<tr><th>Arithmetic</th><th></th></tr>
<tr><td><a href="/jsref/jsref_plaindatetime_add.asp">add()</a></td>
<td>Returns a PlainDateTime with a duration added</td></tr>
<tr><td><a href="/jsref/jsref_plaindatetime_subtract.asp">subtract()</a></td>
<td>Returns a PlainDateTime with a duration subtracted</td></tr>
<tr><td><a href="/jsref/jsref_plaindatetime_round.asp">round()</a></td>
<td>Returns a PlainDateTime rounded to a given unit</td></tr>
<tr><th>Comparing</th><th></th></tr>
<tr><td><a href="/jsref/jsref_plaindatetime_compare.asp">compare()</a></td>
<td>Returns -1, 0, or 1 from comparing two dates</td></tr>
<tr><td><a href="/jsref/jsref_plaindatetime_equals.asp">equals()</a></td>
<td>Returns true if two PlainDateTime  objects are identical</td></tr>
<tr><td><a href="/jsref/jsref_plaindatetime_since.asp">since()</a></td>
<td>Returns the difference from another PlainDateTime</td></tr>
<tr><td><a href="/jsref/jsref_plaindatetime_until.asp">until()</a></td>
<td>Returns the difference until another PlainDateTime</td></tr>
<tr><th>Converting</th><td></td></tr>
<tr><td><a href="/jsref/jsref_plaindatetime_toplaindate.asp">toPlainDate()</a></td>
<td>Returns a PlainDate object with the date from this PlainDateTime</td></tr>
<tr><td><a href="/jsref/jsref_plaindatetime_toplaintime.asp">toPlainTime()</a></td>
<td>Returns a PlainTime object with the time from this PlainDateTime</td></tr>
<tr><td><a href="/jsref/jsref_plaindatetime_tozoneddatetime.asp">toZonedDateTime()</a></td>
<td>Returns a ZonedDatetime object with this PlainDateTime in a time zone</td></tr>
<tr><td><a href="/jsref/jsref_plaindatetime_with.asp">with()</a></td>
<td>Returns a PlainDateTime with specified fields modified</td></tr>
<tr><td><a href="/jsref/jsref_plaindatetime_withcalendar.asp">withCalendar()</a></td>
<td>Returns a PlainDateTime with a different calendar system</td></tr>
<tr><td><a href="/jsref/jsref_plaindatetime_withplaintime.asp">withPlainTime()</a></td>
<td>Returns a PlainDateTime with the time part replaced by a new time</td></tr>
<tr><th>Formatting</th><td></td></tr>
<tr><td><a href="/jsref/jsref_plaindatetime_tojson.asp">toJSON()</a></td><td>Returns an RFC 9557 format string for JSON serialization</td></tr>
<tr><td><a href="/jsref/jsref_plaindatetime_tolocalestring.asp">toLocaleString()</a></td>
<td>Returns a language-sensitive representation of the date</td></tr>
<tr><td><a href="/jsref/jsref_plaindatetime_tostring.asp">toString()</a></td>
<td>Returns an RFC 9557 format string representation of the date</td></tr>
<tr><td><a href="/jsref/jsref_plaindatetime_valueof.asp">valueOf()</a></td>
<td>Throws an error to prevents temporals from being converted to primitives</td></tr>
</table>
</div>

<hr>
<h2>Temporal.PlainDateTime Properties</h2>
<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
<tr><th>Property</th><th>Description</th></tr>
...
<h3>Display All Properties</h3>
<div class="w3-code notranslate jsHigh">
const date = new Temporal.PlainDateTime(2026, 5, 1, 14, 30);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plaindatetime_prop" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="ws-note">
<h2>Learn More:</h2>
<p class="w3-large"><a target="_top" href="js_temporal_plaindatetime.asp">Temporal PlainDateTime Tutorial</a>
</p>
</div>

<hr>
<h2>Temporal Arithmetic</h2>
<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
<tr><th>Method</th><th>Returns</th></tr>
<tr><td><i>temporal</i>.add()</td>
<td>New temporal representing a date moved forward by a duration</td></tr>
<tr><td><i>temporal</i>.subtract()</td>
<td>New temporal representing a date moved backward by a duration</td></tr>
<tr><td><i>temporal</i>.round()</td>
<td>New temporal rounded down to specified unit</td></tr>
</table>
</div>
...
<table class="ws-table-all">
<tr><th>Method</th><th>Description</th></tr>
<tr><td><i>temporal</i>.compare()</td>
<td>Static method useful for sorting arrays of dates (returns -1, 0, or 1)</td></tr>
<tr><td><i>temporal</i>.equals()</td>
<td>Returns true if two dates (and their calendars) are identical</td></tr>
<tr><td><i>temporal</i>.since()</td>
<td>The duration between two temporal objects</td></tr>
<tr><td><i>temporal</i>.until()</td>
<td>The duration between two temporal objects</td></tr>
</table>
</div>
...
<div class="ws-note">
<h2>Learn More:</h2>
<p class="w3-large"><a target="_top" href="js_temporal_arithmetic.asp">Temporal Math &amp; Comparison</a>
</p>
</div>
