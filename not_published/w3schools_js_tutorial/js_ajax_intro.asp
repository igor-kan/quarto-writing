...
<a class="w3-left w3-btn" href="js_api_web_workers.asp">&#10094; Previous</a>
...
<ul>
<li>A browser built-in <code class="w3-codespan">XMLHttpRequest</code> object (to request data from a web server)</li>
