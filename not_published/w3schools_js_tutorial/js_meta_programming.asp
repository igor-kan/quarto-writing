...
<html lang="en-US">
<head>
<title>JavaScript Meta Programming</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="js_modules_dynamic.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_meta_reflect.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
...
<br>
// Fill Array with Object keys<br>
const myArr = Object.keys(user);
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_meta_object_keys" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate jsHigh">
// Create an Object<br>
const person = {name: "John", age: 41};<br>
<br>
// Define "name" to return "secret"<br>
Object.defineProperty(person, "name", {<br>
&nbsp;&nbsp;get() { return "secret"; }<br>
});<br>
<br>
let name = person.name;
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_proxy_behave" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" href="tryit.asp?filename=tryjs_proxy_set" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
&nbsp;&nbsp;&nbsp;&nbsp;// Log changes<br>
&nbsp;&nbsp;&nbsp;&nbsp;log(property + ": " + value);<br>
&nbsp;&nbsp;&nbsp;&nbsp;// Safe forwarding with Reflect<br>
