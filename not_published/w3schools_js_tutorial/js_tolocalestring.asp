...
<html lang="en-US">
<head>
<title>JavaScript toLocaleString() Metod</title>
<meta charset="utf-8">
...
<h1>JavaScript toLocaleString()</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_tostring.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_type_coercion.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
<p>The <b>toLocaleString()</b> method converts a value to a string, using <b>local formatting rules</b>.</p>
<p>The <b>toLocaleString()</b> method is especially useful for formatting numbers, dates, arrays, currencies,
and percentages for different countries.</p>
</div>

<h2>The toLocaleString() Method</h2>
<p>The <code class="w3-codespan">toLocaleString()</code> method is available for many JavaScript datatypes / objects:</p>
<ul>
  <li>Numbers</li>
  <li>Dates</li>
  <li>Arrays</li>
...
<h3>Example</h3>
<p>In this example it is used on a Number (num).</p>
<div class="w3-code notranslate jsHigh">
let num = 1234567.89;<br>
<br>
let text = num.toLocaleString();<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_tolocalestring_number">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Using Locales</h2>
<p>You can <b>specify a language</b> and country code to format a value for a specific locale.</p>
...
let num = 1234567.89;<br>
<br>
let us = num.toLocaleString("en-US");<br>
let de = num.toLocaleString("de-DE");<br>
let no = num.toLocaleString("no-NO");<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_tolocalestring_locales">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Formatting Currency</h2>
<p>With options, <code class="w3-codespan">toLocaleString()</code> can format numbers as currency.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let price = 1299.95;<br>
<br>
let dollars = price.toLocaleString("en-US",<br>
{style:"currency", currency:"USD"});<br>
<br>
let euros = price.toLocaleString("de-DE",<br>
{style:"currency", currency:"EUR"});<br>
<br>
let kroner = price.toLocaleString("no-NO",<br>
{style:"currency", currency:"NOK"});<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_tolocalestring_currency">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Formatting Percentages</h2>

<p>The <code class="w3-codespan">style:"percent"</code> option formats a number as a percentage.</p>
...
let score = 0.875;<br>
<br>
let result = score.toLocaleString("en-US", {style:"percent"});<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_tolocalestring_percent">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Controlling Decimal Digits</h2>
<p>You can control the number of decimal digits with <code class="w3-codespan">minimumFractionDigits</code> and <code class="w3-codespan">maximumFractionDigits</code>.</p>
...
let num = 3.14159;<br>
<br>
let text = num.toLocaleString("en-US", {<br>
&nbsp;&nbsp;minimumFractionDigits: 2,<br>
&nbsp;&nbsp;maximumFractionDigits: 2<br>
});<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_tolocalestring_decimals">Try it Yourself &raquo;</a>
</div>
<hr>
<div class="ws-note">
<h3>Note</h3>
<p>The method name is <code class="w3-codespan">toLocaleString()</code>, not <code class="w3-codespan">toLocalString()</code>.</p>
<p>The word <b>locale</b> means a language and country format, such as <code class="w3-codespan">"en-US"</code>, <code class="w3-codespan">"de-DE"</code>, or <code class="w3-codespan">"no-NO"</code>.</p>
</div>
<hr>
<h2>Formatting Dates</h2>
<p>Dates can also be formatted with <code class="w3-codespan">toLocaleString()</code>.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let date = new Date();<br>
<br>
let text = date.toLocaleString("en-US");<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_tolocalestring_date">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Date Formatting Options</h2>
<p>Many options can be used to control how dates are displayed.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let date = new Date();<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_tolocalestring_date_options">Try it Yourself &raquo;</a>
</div>
...
<h2>A Clever Use: Readable File Sizes</h2>

<p>A clever use of <code class="w3-codespan">toLocaleString()</code> is to make file sizes easier to read.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
function fileSize(bytes) {<br>
&nbsp;&nbsp;if (bytes &lt; 1024) return bytes + " bytes";<br>
&nbsp;&nbsp;if (bytes &lt; 1024 * 1024) return (bytes / 1024).toLocaleString("en-US", {maximumFractionDigits: 1}) + " KB";<br>
&nbsp;&nbsp;return (bytes / 1024 / 1024).toLocaleString("en-US", {maximumFractionDigits: 1}) + " MB";<br>
}<br>
<br>
let size = 1536000;<br>
let text = fileSize(size);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_tolocalestring_filesize">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Arrays and toLocaleString()</h2>
<p>For arrays, the <code class="w3-codespan">toLocaleString()</code> methods converts each array element.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const dates = [<br>
&nbsp;&nbsp;new Date("2026-01-01"),<br>
&nbsp;&nbsp;new Date("2026-12-24")<br>
];<br>
<br>
let text = dates.toLocaleString("en-US");
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_tolocalestring_array">Try it Yourself &raquo;</a>
</div>
