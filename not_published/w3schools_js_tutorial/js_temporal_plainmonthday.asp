...
<html lang="en-US">
<head>
<title>JavaScript Temporal.PlainMonthDay</title>
<meta charset="utf-8">
...
<h1>JavaScript PlainMonthDay</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_temporal_plainyearmonth.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_temporal_plaintime.asp">Next &#10095;</a>
</div>
<div class="ws-info">
...
<hr>
<h2>How to Create a PlainMonthDay Object</h2>
<p>An <b>PlainMonthDayTime object</b> can be created in several different ways:</p>
<table class="ws-table-all">
<tr></tr>
<tr><th>From</th><th>Code</th></tr>
<tr><th>Parameters</th><td>new Temporal.PlainMonthDay(<i>param</i>)</td></tr>
<tr><th>Object</th><td>Temporal.PlainMonthDay.from(<i>object</i>)</td></tr>
<tr><th><a href="js_temporal_standards.asp">ISO/RFC 9557</a></th><td>Temporal.PlainMonthDay.from(RFC9557)</td></tr>
</table>

<hr>
<h2>Create a PlainMonthDay with <b>new</b></h2>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create a new PlainMonthDay object<br>
const date = new Temporal.PlainMonthDay(5, 17);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plainmonthday" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>PlainMonthDay from(<i>object</i>)</h2>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create a new PlainMonthDay object<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plainmonthday_from" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>PlainMonthDay from(<i>RFC 9557</i>)</h2>
<div class="w3-example">
<h3>Examples</h3>
<div class="w3-code notranslate jsHigh">
// Create a new PlainMonthDay object<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plainmonthday_from_iso" target="_blank">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
// Create a new PlainMonthDay object<br>
const date = Temporal.PlainMonthDay.from("2026-05-17");
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plainmonthday_from_iso_2" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="ws-note">
<p>Note that <b>year is ignored</b> if used as input</p>
</div>

<hr>
<h2>PlainMonthDay equals()</h2>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create two PlainMonthDay objects<br>
const date1 = Temporal.PlainMonthDay.from("05-17");<br>
const date2 = Temporal.PlainMonthDay.from("07-19");<br>
// Compare<br>
let result = date1.equals(date2);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plainmonthday_equals" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">with()</code> method returns a new PlainMonthDay object with specified field(s) replaced.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create a PlainMonthDay object<br>
const date = Temporal.PlainMonthDay.from("05-17");<br>
<br>
// Replace month<br>
const newDate = date.with({ month:12 });<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plainmonthday_with" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>All PlainMonthDay Methods</h2>
<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
...
<h2>All PlainMonthDay Properties</h2>
<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
...
<div class="ws-note">
<h3>Note</h3>
<p>The Temporal.PlainMonthDay object does not have a month property.</p>
<p>This is because non-ISO calendars (Hebrew, Chinese) can have leap months.
The same named month may have a different numerical index (month) each year,
making the month integer ambiguous without a year.</p>
</div>

<div class="w3-example">
<h3>Display all PlainMonthDay Properties</h3>
<div class="w3-code notranslate jsHigh">
const date = new Temporal.PlainMonthDay(5, 17);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plainmonthday_prop" target="_blank">Try it Yourself &raquo;</a>
</div>
