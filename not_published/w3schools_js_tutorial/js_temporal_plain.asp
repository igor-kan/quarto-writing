...
<html lang="en-US">
<head>
<title>JavaScript Temporal.PlainDate - Work with Dates Only</title>
<meta charset="utf-8">
...
<h1>JavaScript Temporal PlainDate</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_temporal_plaindatetime.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_temporal_plainyearmonth.asp">Next &#10095;</a>
</div>
<div class="ws-info">
<h2>The Temporal.PlainDate Object</h2>
<p>The <b>Temporal.PlainDate</b> object represents a <b>calendar date</b> without a time.</p>
<p>A <b>Temporal.PlainDate</b> is typically in <b>ISO 8601</b> format (<b>2026-05-01</b>).</p>
<p>It is easier to use and safer to compare than DateTime objects for dates that are the same
regardless of time zone, such as birthdays and holidays.</p>
</div>

<h2>How to Create a PlainDate Object</h2>
<p>An <b>PlainDateTime object</b> can be created in several different ways:</p>
<table class="ws-table-all">
<tr></tr>
<tr><th>From</th><th>Code</th></tr>
<tr><td>Constructor (new)</td><td>new Temporal.PlainDate()</td></tr>
<tr><td>ISO String </td><td>Temporal.PlainDate.from()</td></tr>
<tr><td>Now (current time)</td><td>Temporal.Now.plainDateISO()</td></tr>
</table>

<hr>
<h2>Create a PlainDate with <b>new</b></h2>
<p>You can create a <b>PlainDate</b> object using the <b>new</b> constructor.</p>
<p>The constructor takes year, month, and day <b>parameters</b>.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create a PlainDate object<br>
const date = new Temporal.PlainDate(2026, 5, 17);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plaindate" target="_blank">Try it Yourself &raquo;</a>
</div>
<p>The <code class="w3-codespan">Temporal.PlainDate()</code> method above:</p>
<ul>
<li>Uses a <b>constructor</b> call</li>
<li>Expects <b>numeric arguments</b> (year, month, day).</li>
<li>Returns a <b>calendar date</b> without a time like <b>2026-05-17</b>.</li> 
</ul>

<div class="ws-note">
<p>Unlike <b>JavaScript Date</b>, Temporal months start at 1.</p>
</div>

<hr>
<h2>Create a PlainDate from a String</h2>
<p>You can create a <b>PlainDate object</b> from an <a href="js_temporal_formats.asp">
<b>ISO 8601 / RFC 9557 string</b></a>.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create a PlainDate object<br>
const date = Temporal.PlainDate.from("2026-05-17");<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plaindate_from" target="_blank">Try it Yourself &raquo;</a>
</div>
<p>In the example above:</p>
<ul>
<li>The input is <b>parsed</b> using ISO 8601 parsing rules</li>
<li>ISO 8601 accepts strings like "<b>2026-05-01</b>"</li>
</ul>

<div class="ws-note">
<p>Parsing means validation pluss automatic conversion.</p>
</div>

<hr>
<h2>Create a PlainDate from an Object</h2>
<p>You can create a <b>PlainDate object</b> from an <b>object</b>.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create a PlainDate object<br>
const date = Temporal.PlainDate.from({year:2026, month:5, day:1});<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plaindate_object" target="_blank">Try it Yourself &raquo;</a>
</div>
<p>From the example above, you can reason that the from() method can accept
both <b>object literals</b> and <b>PlainDate objects</b>.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create a PlainDate object<br>
const d1 = Temporal.PlainDate.from({year:2026, month:5, day:1});<br>
<br>
// Create another PlainDate object<br>
const d2 = Temporal.PlainDate.from(d1);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plaindate_object_2" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Create a PlainDate Object from Now</h2>
<p>The <b>Temporal.Now</b> object has a method for getting <b>the current date</b>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let today = Temporal.Now.plainDateISO();
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_now_plaindate" target="_blank">Try it Yourself &raquo;</a>
</div>
<p>The <b>Temporal.Now.plainDateISO()</b> method is used to get the current date.</p>
<p>It returns a <b>PlainDate</b> object with the (year, month, day)
in the ISO 8601 calendar, specifically ignoring time zones and times.</p>
<hr>
<h2>When to Use Which?</h2>
<h4>Use <code class="w3-codespan">new Temporal.PlainDate()</code> when:</h4>
<ul>
<li>You have trusted numeric values</li>
<li>You want speed</li>
<li>You want predictable construction</li>
<li>You are doing date math</li>
</ul>
<h4>Use <code class="w3-codespan">Temporal.PlainDate.from()</code> when:</h4>
<ul>
<li>You are handling user input (strings)</li>
<li>You are handling external data (JSON)</li>
<li>You want maximum flexibility</li>
</ul>
<h4>Use <code class="w3-codespan">Temporal.Now.plainDateISO()</code> when:</h4>
<ul>
<li>You you need the current date</li>
</ul>

<hr>
<h2>Add and Subtract Days</h2>
<p>Use the <code class="w3-codespan">add()</code> method to <b>add time</b>.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let date = Temporal.PlainDate.from("2026-05-17");<br>
let nextWeek = date.add({ days: 7 });<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plaindate_add" target="_blank">
Try it Yourself &raquo;</a>
</div>
<p>Use the <code class="w3-codespan">subtract()</code> method to <b>subtract time</b>.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let date = Temporal.PlainDate.from("2026-05-17");<br>
let previousWeek = date.subtract({ days: 7 });<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plaindate_subtract" target="_blank">
Try it Yourself &raquo;</a>
</div>
<p><b>All temporal objects</b> have their own <b>add() method</b>:</p>
<ul class="w3-large">
<li><i>duration</i>.add(<i>duration</i>)</li>
<li><i>instant</i>.add(<i>duration</i>)</li>
<li><i>plaindate</i>.add(<i>duration</i>)</li>
<li><i>plaintime</i>.add(<i>duration</i>)</li>
<li><i>plainyearmonth</i>.add(<i>duration</i>)</li>
<li><i>plainmonthday</i>.add(<i>duration</i>)</li>
<li><i>plaindatetime</i>.add(<i>duration</i>)</li>
<li><i>zoneddatetime</i>.add(<i>duration</i>)</li>
</ul>
<p><b>All temporal objects</b> have their own <b>subtract() method</b>:</p>
<ul class="w3-large">
<li><i>duration</i>.subtract(<i>duration</i>)</li>
<li><i>instant</i>.subtract(<i>duration</i>)</li>
<li><i>plaindate</i>.subtract(<i>duration</i>)</li>
<li><i>plaintime</i>.subtract(<i>duration</i>)</li>
<li><i>plainyearmonth</i>.subtract(<i>duration</i>)</li>
<li><i>plainmonthday</i>.subtract(<i>duration</i>)</li>
<li><i>plaindatetime</i>.subtract(<i>duration</i>)</li>
<li><i>zoneddatetime</i>.subtract(<i>duration</i>)</li>
</ul>

<div class="ws-note">
<h2>Learn More:</h2>
<p class="w3-large"><a href="js_temporal_arithmetic.asp">JavaScript Temporal Arithmetic</a></p>
</div>

<hr>
<h2>Duration vs Date Math</h2>
<p>With JavaScript <code class="w3-codespan">Date</code>, you must often calculate time differences
manually using milliseconds.</p>
<div class="w3-example">
<h3>Date Example</h3>
<div class="w3-code notranslate jsHigh">
const start = new Date("2026-05-01");<br>
const end = new Date("2026-05-17");<br>
<br>
let diff = end - start;<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_vs_date_2" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="ws-note">
<p>Temporal provides methods that are clearer and safer than using JavaScript Date methods.</p>
</div>

<hr>
<h2>JavaScript Temporal since()</h2>
<p>The <code class="w3-codespan">since()</code> method calculates the duration between two temporal dates.</p>
<div class="w3-example">
<h3>Syntax</h3>
<div class="w3-code notranslate w3-large">
<i>t1</i>.since(<i>t2, options</i>)
</div>
</div>

<div class="ws-note">
<h2>Meaning:</h2>
<p><b>At time t1</b>, how much time has passed <b>since time t2</b>?</p>
</div>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const start = Temporal.PlainDate.from("2026-05-01");<br>
const end = Temporal.PlainDate.from("2026-05-17");<br>
<br>
const duration = end.since(start); 
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_duration_since" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="ws-note">
<p>The <code class="w3-codespan">since()</code> method returns a <b>Temporal.Duration Object</b>
representing the elapsed time.</p>
<p>The duration is <b>positive</b> if the "other" date is in the <b>past</b>.</p>
<p>The duration is <b>negative</b> if the "other" date is in the <b>future</b>.</p>
</div>

<hr>
<h2>The with() Method</h2>
<p>The <code class="w3-codespan">with()</code> method creates a new PlainDate object
with specific field replaced.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create a PlainDate object<br>
const date = Temporal.PlainDate.from("2026-05-17");<br>
<br>
// Replace month and day<br>
const customDate = date.with({ month:12, day:25 });<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plaindate_with" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<h2>Compare Dates</h2>
<p>The <code class="w3-codespan">compare(<i>date1</i>, <i>date2</i>)</code> method returns -1, 0 or 1:</p>
<ul>
<li>-1 if date1 is before date2</li>
<li>0 they are if equal</li>
<li>1 if date 1 is after date2</li>
</ul>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create two Temporal objects<br>
const date1 = Temporal.PlainDate.from("2026-02-17");<br>
const date2 = Temporal.PlainDate.from("2026-03-01");<br>
<br>
// Compare the dates<br>
let result = Temporal.PlainDate.compare(date1, date2);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_compare_1" target="_blank">
Try it Yourself &raquo;</a>
</div>

<p>You can also use <code class="w3-codespan">equals()</code> to check if two dates are the same.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create two Temporal objects<br>
const a = Temporal.PlainDate.from("2026-02-17");<br>
const b = Temporal.PlainDate.from("2026-02-17");<br>
<br>
// Compare the dates<br>
let result = (a.equals(b));
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_equals" target="_blank">
Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Temporal.PlainDate Properties</h2>
<p>The <code class="w3-codespan">Temporal.PlainDate</code> object has <b>16 properties</b> of calendar date information.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const time = new Temporal.PlainDate(2026, 5, 17);<br>
</div>
...
<hr>
<h2>Temporal Calendars</h2>
<p><b>Temporal.PlainDate</b> defaults to the <b>ISO 8601</b> calendar.</p>
<p>If you want a specific calendar, you can <b>add a calender</b> parameter:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
new Temporal.PlainDate(2026, 5, 17, "gregory")
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plaindate_gregory" target="_blank">Try it Yourself &raquo;</a>
</div>

<p>The <code class="w3-codespan">from()</code> method supports calendars using the [u-ca=calendar] syntax or a calendar
property in objects.</p>
<div class="w3-example">
<h3>Examples</h3>
<div class="w3-code notranslate jsHigh">
Temporal.PlainDate.from("2026-05-17[u-ca=chinese]")
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plaindate_japanese" target="_blank">Try it Yourself &raquo;</a>

<div class="w3-code notranslate jsHigh">
Temporal.PlainDate.from({year:2026, month:5, day:17, calendar:"hebrew"})
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plaindate_hebrew" target="_blank">Try it Yourself &raquo;</a>
</div>

<p>Valid calendar identifiers (calendar_id) for Temporal objects:</p>

<ul>
  <li><b>iso8601</b> - Default ISO calendar</li>
  <li><b>gregory</b> - Gregorian calendar</li>
  <li><b>buddhist</b> - Buddhist calendar</li>
  <li><b>chinese</b> - Chinese calendar</li>
  <li><b>coptic</b> - Coptic calendar</li>
  <li><b>dangi</b> - Korean Dangi calendar</li>
  <li><b>ethioaa</b> - Ethiopic Amete Alem</li>
  <li><b>ethiopic</b> - Ethiopic calendar</li>
  <li><b>hebrew</b> - Hebrew calendar</li>
  <li><b>indian</b> - Indian (Saka) calendar</li>
  <li><b>islamic</b> - Islamic calendar</li>
  <li><b>islamic-civil</b> - Islamic civil calendar</li>
  <li><b>islamic-rgsa</b> - Islamic (Saudi Arabia)</li>
  <li><b>islamic-tbla</b> - Islamic tabular calendar</li>
  <li><b>islamic-umalqura</b> - Umm al-Qura calendar</li>
  <li><b>japanese</b> - Japanese imperial calendar</li>
  <li><b>persian</b> - Persian (Solar Hijri) calendar</li>
  <li><b>roc</b> - Republic of China calendar</li>
</ul>

<p>You can list supported values in your environment with:</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plaindate_calendars" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>When to Use PlainDate</h2>
<ul>
<li><p>Any date without time</p></li>
<li><p>Birthdays</p></li>
<li><p>Deadlines</p></li>
<li><p>Holidays</p></li>
<li><p>Booking dates</p></li>
</ul>
<hr>

<h2>Replace Date for Date-Only Values</h2>

<p>With <code class="w3-codespan">Date</code>, you always get a time and time zone.</p>
<p>This can create confusion when you only need a calendar date.</p>
...
<p><code class="w3-codespan">PlainDate</code> avoids this by storing only year, month, and day.</p>
...
<p>A PlainDate object is essentially the date part of a Temporal.PlainDateTime object,
with the time information removed.</p>
</div>
