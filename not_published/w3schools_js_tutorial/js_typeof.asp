...
<a class="w3-left w3-btn" href="js_datatypes_symbol.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_undefined.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
<h2>The typeof Operator</h2>
<p>The <b>typeof</b> operator returns the <b>data type</b> of a JavaScript variable.</p>
</div>

<h2>Primitive Data Types</h2>
<p>In JavaScript, a primitive value is a single value with no properties or methods.</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_typeof_primitives" target="_blank">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
typeof null&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
// Returns object
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_typeof_primitives_null" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="ws-note">
<p>In JavaScript, <code class="w3-codespan">null</code> is  a primitive value.</p>
<p>However, <code class="w3-codespan">typeof</code> returns object.</p>
<p>This is a <b>well-known bug</b> in JavaScript and has historical reasons.</p>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Complex Data Types</h2>
<p>A complex data type can store multiple values
and/or different data types together.</p>
 
<p>JavaScript has one complex data type:</p>
<ul>
<li>object</li>
</ul>

<p>All other complex types like arrays, functions, sets, and maps are just different types of objects.</p>

<p>The <code class="w3-codespan">typeof</code> operator returns only two types:</p>
<ul>
  <li>object</li>
  <li>function</li>
</ul>
...
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
typeof {name:'John'}&nbsp;&nbsp;&nbsp;// Returns object<br>
typeof [1,2,3,4]&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
// Returns object<br>
typeof new Map()&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
// Returns object<br>
typeof new Set()&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
// Returns object<br><br>
...
<p>The <code class="w3-codespan">typeof</code> operator returns object for all types of objects:
<ul>
<li>objects</li>
<li>arrays</li>
<li>dates</li>
...
<p>You cannot use <code class="w3-codespan">typeof</code> to determine if a JavaScript object is an array or a date.</p>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>ECMAScript 5 (2009) defined a new method for this: <code class="w3-codespan">Array.isArray()</code>:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create an Array<br>
const fruits = ["apples", "bananas", "oranges"];<br>
...
<p>The <code class="w3-codespan">instanceof</code> operator returns <code class="w3-codespan">true</code>
if an object is an instance of a specified object type:</p>
<div class="w3-example">
<h3>Examples</h3>
<div class="w3-code notranslate jsHigh">
// Create a Date<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_instanceof_date" target="_blank">Try it Yourself &raquo;</a>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_instanceof_array" target="_blank">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
// Create a Map<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_instanceof_map" target="_blank">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
// Create a Set<br>
const fruits = new Set(["apples", "bananas", "oranges"]);<br>
<br>
(fruits instanceof Set);
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_instanceof_set" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<p>The <code class="w3-codespan">typeof</code> of an undefined variable is
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_typeof_undefined" target="_blank">Try it Yourself &raquo;</a>
</div>

<p>The <code class="w3-codespan">typeof</code> of a variable with no value is
<code class="w3-codespan">undefined</code>. The value is also <code class="w3-codespan">undefined</code>.</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_typeof_undefined_4" target="_blank">Try it Yourself &raquo;</a>
</div>

<p>Any variable can be emptied, by setting the value to <code class="w3-codespan">undefined</code>.</p>
<p>The type will also be <code class="w3-codespan">undefined</code>.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let car = "Volvo";<br>
...
<!--start-->
<h2>Null</h2>
<p>In JavaScript <code class="w3-codespan">null</code> is &quot;nothing&quot;. It is supposed to be something that doesn't exist.</p>
<p>Unfortunately, in JavaScript, the data type of <code class="w3-codespan">null</code> is an object.</p>

<p>You can empty an object by setting it to <code class="w3-codespan">null</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create an Object<br>
let person = {firstName:&quot;John&quot;, lastName:&quot;Doe&quot;, age:50, eyeColor:&quot;blue&quot;};<br>

<br>person = null;<br>
// Now value is null, but type is still an object<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_datatypes_null" target="_blank">Try it Yourself &raquo;</a>
</div>
<p>You can also empty an object by setting it to <code class="w3-codespan">undefined</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let person = {firstName:&quot;John&quot;, lastName:&quot;Doe&quot;, age:50, eyeColor:&quot;blue&quot;};<br>
...
<p><code class="w3-codespan">undefined</code> and <code class="w3-codespan">null</code> are equal in value but different in type:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
 typeof undefined&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<p>The <code class="w3-codespan">constructor</code> property returns the constructor 
function for all JavaScript variables.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Returns function Object() {[native code]}:<br>
{name:'John',age:34}.constructor<br><br>
// Returns function Array() {[native code]}:<br>
[1,2,3,4].constructor<br><br>
// Returns function Date() {[native code]}:<br>
new Date().constructor<br><br>
// Returns function Set() {[native code]}:<br>
new Set().constructor<br><br>
// Returns function Map() {[native code]}:<br>
new Map().constructor<br><br>
// Returns function Function() {[native code]}:<br>
function () {}.constructor<br><br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_constructor_all" target="_blank">Try it Yourself &raquo;</a>
</div>

<p>With the constructor, you can check if an object is an <strong>Array</strong>:</p>
...
<p><a class="w3-btn" href="tryit.asp?filename=tryjs_typeof_array" target="_blank">Try it Yourself &raquo;</a></p>
</div>

<p>With the constructor, you can check if an object is a <strong>Date</strong>:</p>
...
<p><a class="w3-btn" href="tryit.asp?filename=tryjs_typeof_date" target="_blank">Try it Yourself &raquo;</a></p>
</div>
...
<div class="w3-panel ws-note">
<p>The data type of <b>NaN</b> (Not a Number) is <b>number</b> !</p>
</div>
<!--stop-->
<hr>
<!--start-->
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_oper_void" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>

<div id="exercisecontainer" src="xrcise_typeof.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_datatypes_symbol.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_undefined.asp">Next &#10095;</a>
