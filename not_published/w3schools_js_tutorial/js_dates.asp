...
<p class="w3-center">JavaScript <strong>Date Objects</strong> let us work with dates:</p>
<p class="w3-center"><strong><script>document.write(xxx)</script></strong></p>

<div class="w3-center">
<a href="tryit.asp?filename=tryjs_date_getfullyear" target="_blank" class="w3-btn w3-margin-bottom ws-green">Year: <script>document.write(xxx.getFullYear())</script></a>
<a href="tryit.asp?filename=tryjs_date_getmonth" target="_blank" class="w3-btn w3-margin-bottom ws-green">Month: <script>document.write(xxx.getMonth()+1)</script></a>
<a href="tryit.asp?filename=tryjs_date_getdate" target="_blank" class="w3-btn w3-margin-bottom ws-green">Day: <script>document.write(xxx.getDate())</script></a>
<a href="tryit.asp?filename=tryjs_date_gethours" target="_blank" class="w3-btn w3-margin-bottom ws-green">Hours: <script>document.write(xxx.getHours())</script></a>
<a href="tryit.asp?filename=tryjs_date_getminutes" target="_blank" class="w3-btn w3-margin-bottom ws-green">Minutes: <script>document.write(xxx.getMinutes())</script></a>
<a href="tryit.asp?filename=tryjs_date_getseconds" target="_blank" class="w3-btn w3-margin-bottom ws-green">Seconds: <script>document.write(xxx.getSeconds())</script></a>
</div>
...
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_date_current">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
const d = new Date("2022-03-25");<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_date_date">Try it Yourself &raquo;</a>
</div>
...
<code class="w3-codespan">new Date()</code> constructor.</p>
<p>There are <strong>9 ways</strong> to create a new date object:</p>
...
<br>
new Date(<em>year,month</em>)<br>
new Date(<em>year,month,day</em>)<br>
new Date(<em>year,month,day,hours</em>)<br>
new Date(<em>year,month,day,hours,minutes</em>)<br>
new Date(<em>year,month,day,hours,minutes,seconds</em>)<br>
new Date(<em>year,month,day,hours,minutes,seconds,ms</em>)<br>
<br>
...
<p><code class="w3-codespan">new Date()</code> creates a date object with the <strong>current date and time</strong>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const d = new Date();
...
<hr>
<!--start-->
<h2>new Date(<em>date string</em>)</h2>
<p><code class="w3-codespan">new Date(<em>date string</em>)</code> creates a date object from a <strong>date string</strong>:</p>
<div class="w3-example">
<h3>Examples</h3>
<div class="w3-code notranslate jsHigh">
const d = new Date(&quot;October 13, 2014 11:13:00&quot;);
</div>
<a class="w3-btn" href="tryit.asp?filename=tryjs_date_new_string" target="_blank">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
const d = new Date("2022-03-25");
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_date_date" target="_blank">Try it Yourself &raquo;</a>
</div>

<!--stop-->
<div class="w3-panel ws-note">
<p>Date string formats are described in the next chapter.</p>
</div>
...
<p><code class="w3-codespan">new Date(<em>year, month, ...</em>)</code> creates a date object with a <strong>specified date and time</strong>.</p>
...
<a class="w3-btn" href="tryit.asp?filename=tryjs_date_new_month_11" target="_blank">Try it Yourself &raquo;</a>
<p>Is the same as:</p>
<div class="w3-code notranslate jsHigh">
const d = new Date(2019, 3, 24, 10, 33, 30);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_date_new_month_12" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_date_new_day_35" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p><code class="w3-codespan">new Date(<em>milliseconds</em>)</code> creates a new date object as <b>milliseconds</b> plus zero time:</p>

<div class="w3-example">
<h3>Examples</h3>

<p>01 January 1970 <strong>plus</strong> 100 000 000 000 milliseconds is:</p>  
<div class="w3-code notranslate jsHigh">
...
<p>January 01 1970 <strong>minus</strong> 100 000 000 000 milliseconds is:</p>  
<div class="w3-code notranslate jsHigh">
const d = new Date(-100000000000);
</div>
...
<p>January 01 1970 <strong>plus</strong> 24 hours is:</p>  
<div class="w3-code notranslate jsHigh">
const d = new Date(24 * 60 * 60 * 1000);<br>
// or<br>
...
<p>JavaScript will (by default) output dates using the <b>toString()</b> method.
This is a string representation of the date, including the time zone.
The format is specified in the ECMAScript specification:</p>
<div class="w3-example">
<h3>Example</h3>
...
string, with the <code class="w3-codespan">toString()</code> method.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const d = new Date();<br>
...
<p>The <code class="w3-codespan">toDateString()</code> method converts a date to a more readable 
format:</p>
...
<p>The <code class="w3-codespan">toUTCString()</code> method converts a date to a string using the UTC standard:</p>
...
<p>The <code class="w3-codespan">toISOString()</code> method converts a date to a string using the ISO standard:</p>
...
<p class="w3-large"><a href="js_date_methods.asp">JavaScript Date Get Methods</a></p>
