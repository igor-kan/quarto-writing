...
<a class="w3-left w3-btn" href="js_project_eventlistener.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_project_modal_popup.asp">Next &#10095;</a>
</div>
...
<p>In this project you will build a <b>To-Do List</b>.</p>
<p>You will <b>add</b> tasks, <b>remove</b> tasks, and <b>clear all</b> tasks.</p>
<p>The tasks will be saved in an <b>Array</b> in <b>localStorage</b>.</p>
</div>

<h2>You Will Learn</h2>
<ul>
<li>How to store items in an array</li>
<li>How to remove items from an array</li>
<li>How to display a list using JavaScript</li>
<li>How to save and load data using localStorage</li>
</ul>

<hr>
<h2>First: Create the HTML</h2>
<p>First create an HTML page with:</p>
<ul class="w3-ul">
<li>An <b>input field</b> wid id="task"</li>
<li>A <b>button</b> for calling addTask()</li>
<li>A <b>unordered list</b> with id="list"</li>
<li>A <b>button</b> for calling clearAll()</li>
</ul>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_project_todo_1" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<hr>
<h2>Add a Display Function</h2>
<div class="w3-example">
<h3>Example</h3>
<p>The displayTasks() function updates and displays the list.</p>
<div class="w3-code notranslate jsHigh">
// Function to display the list<br>
function displayTasks() {<br>
&nbsp;&nbsp;let html = "";<br>
&nbsp;&nbsp;for (let i = 0; i &lt; tasks.length; i++) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;html += "&lt;li&gt;" + tasks[i] +<br>
&nbsp;&nbsp;&nbsp;&nbsp;" &lt;button onclick='removeTask(" + i + ")'&gt;x&lt;/button&gt;&lt;/li&gt;";<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;document.getElementById("list").innerHTML = html;<br>
}<br>
</div>
</div>
<div class="ws-note">

<p>The displayTasks() function should be called whenever the list changes.</p>
</div>

<hr>
<h2>Add an Add Task Function</h2>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Function to Add a task<br>
function addTask() {<br>
&nbsp;&nbsp;let taskInput = document.getElementById("task");<br>
&nbsp;&nbsp;let text = taskInput.value;<br>
&nbsp;&nbsp;if (text === "") {<br>
&nbsp;&nbsp;&nbsp;&nbsp;return;<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;tasks.push(text);<br>
...
<hr>
<h2>Add a Remove Task Function</h2>
<div class="w3-example">
<h3>Example</h3>
<p>Remove a task by index:</p>
<div class="w3-code notranslate jsHigh">
// Function to Remove a task<br>
function removeTask(i) {<br>
&nbsp;&nbsp;tasks.splice(i, 1);<br>
&nbsp;&nbsp;saveTasks();<br>
&nbsp;&nbsp;displayTasks();<br>
}<br>
...
<p>The Array method splice(i, 1) removes 1 item at position i.</p>
</div>

<hr>
<h2>Add a Clear All Function</h2>
<div class="w3-example">
<h3>Example</h3>
<p>Remove everything:</p>
<div class="w3-code notranslate jsHigh">
// Function to Clear all tasks<br>
...
<hr>
<h2>Function to Save a Task</h2>
<div class="w3-example">
<h3>Example</h3>
<p>Save in localStorage:</p>
<div class="w3-code notranslate jsHigh">
// Function to Save tasks<br>
function saveTasks() {<br>
&nbsp;&nbsp;localStorage.setItem("tasks", JSON.stringify(tasks));<br>
}<br>
</div>
</div>
<div class="ws-note">

<p>To store arrays in localStorage, we convert them to text using JSON.stringify().</p>
</div>

<hr>
<h2>Function to Load the Tasks</h2>
<div class="w3-example">
<h3>Example</h3>
<p>Load tasks from localStorage:</p>
<div class="w3-code notranslate jsHigh">
function loadTasks() {<br>
&nbsp;&nbsp;let saved = localStorage.getItem("tasks");<br>
&nbsp;&nbsp;if (saved !== null) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;tasks = JSON.parse(saved);<br>
&nbsp;&nbsp;}<br>
}<br>
</div>
</div>
...
<p>To load arrays, we convert them back using JSON.parse().</p>
</div>
...
<br>
// Load and display tasks when page loads<br>
loadTasks();<br>
displayTasks()<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_project_todo" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<hr>
<h3>Exercise 2</h3>
<p>Allow the user to press Enter to add a task.</p>
<hr>
<h3>Exercise 3</h3>
<p>Save the tasks automatically after every change (already done).</p>
<p>Add a "Saved!" message to show when saving.</p>
<hr>
<h3>Bonus Challenges (Level Up)</h3>
<p>Try to improve the project:</p>
<ul><li>Mark tasks as done (&#10004;)</li>
<li>Filter tasks: All / Active / Done</li>
<li>Add "Edit task" functionality</li>
