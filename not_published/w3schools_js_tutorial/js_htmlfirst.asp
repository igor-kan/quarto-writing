...
<html lang="en-US">
<head>
<title>HTML First - How to build simpler and faster web pages.</title>
<meta charset="utf-8">
...
<h1>HTML-First Tutorial</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_htmldom_eventlistener.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_htmlfirst_progressive.asp">Next &#10095;</a>
</div>
<!--start-->

<div class="ws-info">
<h2>What Is HTML-First?</h2>
<p><b>HTML-First</b> is a way of building websites where <b>HTML is the foundation</b> of the page.</p>
<p>A page should be readable, usable, and accessible with <b>Basic HTML and CSS</b>.</p>
<p>This approach is closely related to <b>Progressive Enhancement</b>.</p>
</div>
...
&lt;article&gt;<br>
&lt;h2&gt;Welcome&lt;/h2&gt;<br>
&lt;p&gt;This page works without JavaScript.&lt;/p&gt;<br>
&lt;/article&gt;<br>
<br>
&lt;/body&gt;<br>
&lt;/html&gt;<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_htmlfirst" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="ws-note">
<p>Instead of starting with JavaScript frameworks and complex client-side applications,
HTML-first development starts with clean and meaningful HTML.</p>
<p>The content and structure of a web page should work before JavaScript is added.</p>
</div>

<hr>
<h2>Avoid Unnecessary JavaScript</h2>
<p>JavaScript is powerful, but too much JavaScript can make websites slower and more complicated.</p>
<p>Many websites can be built with more HTML, CSS, and less JavaScript.</p>
<p>HTML-first development can help improve:</p>
<ul>
  <li>Page speed</li>
  <li>Accessibility</li>
...
<p>Progressive enhancement means starting with a working basic page.</p>
<p>Extra features are added only when the browser supports them.</p>
<p>For example, an HTML form should still work even if JavaScript fails.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;form action="<i>Action Page</i>" method="post"&gt;<br>
&nbsp;&nbsp;&lt;label for="email"&gt;Email:&lt;/label&gt;<br>
&nbsp;&nbsp;&lt;input type="email" id="email" name="email" required&gt;<br>
&nbsp;&nbsp;&lt;button type="submit"&gt;Subscribe&lt;/button&gt;<br>
&lt;/form&gt;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_htmlfirst_form" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="ws-note">
<p>The form above uses built-in HTML validation and does not require JavaScript.</p>
</div>

<hr>
<h1>Why HTML-First?</h1>
<p>HTML-first development is not about rejecting JavaScript.</p>

<p>It is about using the browser's built-in features before adding extra complexity.</p>

<p>Many common website features can be created with HTML and CSS alone.</p>

<hr>
<h2>Browsers Are Already Powerful</h2>
<p>Modern browsers understand many useful HTML elements.</p>
<p>These elements can provide structure, behavior, validation, and accessibility.</p>
<p>Examples include <code class="w3-codespan">&lt;form&gt;</code>, <code class="w3-codespan">&lt;button&gt;</code>, <code class="w3-codespan">&lt;details&gt;</code>, <code class="w3-codespan">&lt;summary&gt;</code>, and <code class="w3-codespan">&lt;dialog&gt;</code>.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;details&gt;<br>
&nbsp;&nbsp;&lt;summary&gt;Click to read more&lt;/summary&gt;<br>
&nbsp;&nbsp;&lt;p&gt;This text can be opened and closed without JavaScript.&lt;/p&gt;<br>
&lt;/details&gt;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_htmlfirst_details" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Less JavaScript Can Mean Faster Pages</h2>

<p>JavaScript must be downloaded, parsed, compiled, and executed by the browser.</p>

<p>Large JavaScript files can slow down the first load of a page.</p>

<p>This is especially noticeable on mobile phones and slow networks.</p>

<div class="ws-note">
<p>Smaller pages load faster, use less memory, and feel more responsive.</p>
</div>

<hr>

<h2>HTML Works Before JavaScript Loads</h2>

<p>HTML is displayed as soon as the browser receives it.</p>

<p>This means users can often start reading the page before scripts have finished loading.</p>

<p>For tutorials, articles, product pages, documentation, and forms, this is often enough.</p>

<hr>

<h2>Semantic HTML Improves Accessibility</h2>

<p>Semantic HTML uses elements for their correct meaning.</p>

<p>This helps screen readers, search engines, keyboard users, and other tools understand the page.</p>
...
&lt;main&gt;<br>
&nbsp;&nbsp;&lt;article&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;p&gt;Use meaningful HTML first.&lt;/p&gt;<br>
&nbsp;&nbsp;&lt;/article&gt;<br>
&lt;/main&gt;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_htmlfirst_main" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>When JavaScript Is Still Useful</h2>
<p>JavaScript is still important for many interactive features.</p>
<p>The HTML-first idea is to add JavaScript when it is needed, not before.</p>
<div class="ws-note">
