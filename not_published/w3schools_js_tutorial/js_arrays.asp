...
<a class="w3-left w3-btn" href="js_temporal_reference.asp">&#10094; Previous</a>
...
<div class="ws-info">
<p class="w3-large">An Array is an object type designed for storing data collections.</p>
<p class="w3-large">Key characteristics of JavaScript arrays are:</p>
<ul>
<li><p><b>Elements</b>: An array is a list of values, known as elements.</p></li>
<li><p><b>Ordered</b>: Array elements are ordered based on their index.</p></li>
<li><p><b>Zero indexed</b>: The first element is at index 0, the second at index 1, and so on. </li>
<li><p><b>Dynamic size</b>: Arrays can grow or shrink as elements are added or removed.</li>
<li><p><b>Heterogeneous</b>: Arrays can store elements of different data types
(numbers, strings, objects and other arrays).</li>
</ul>
</div>
<!--stop-->
<hr>
...
names in single variables could look like this:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_array_add_elements">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>The JavaScript method <code class="w3-codespan">toString()</code> converts an array to a 
...
<p>Arrays are a special type of objects. The <code class="w3-codespan">typeof</code> operator in JavaScript returns &quot;object&quot; for 
arrays.</p>
...
<p>The <code class="w3-codespan">length</code> property of an array returns the length of an array (the number of array 
elements).</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<div class="w3-code notranslate jsHigh">
const fruits = [&quot;Banana&quot;, &quot;Orange&quot;, &quot;Apple&quot;];<br>
fruits[fruits.length] = &quot;Lemon&quot;;&nbsp;&nbsp;// Adds "Lemon" to fruits</div>
...
<div class="w3-code notranslate jsHigh">
const fruits = [&quot;Banana&quot;, &quot;Orange&quot;, &quot;Apple&quot;];<br>
fruits[6] = &quot;Lemon&quot;;&nbsp;&nbsp;// Creates undefined "holes" in fruits</div>
...
<div class="w3-panel ws-warning">
<p><strong>WARNING !!</strong><br>
If you use named indexes, JavaScript will redefine the array to an object.</p>
<p>After that, some array methods and properties will produce <strong>incorrect 
results</strong>.</p>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_new_array_three" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_new_array_two" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_array_one" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_array_new_error2" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<p>The problem is that the JavaScript operator <code class="w3-codespan">typeof</code> returns 
&quot;<code class="w3-codespan">object</code>&quot;:</p>
...
<h3>Solution 2:</h3>
<p>The <code class="w3-codespan">instanceof</code> operator returns true if an object is created 
...
<hr>
<!--start-->
<h2>Nested Arrays and Objects</h2>
<p>Values in objects can be arrays, and values in arrays can be objects:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const myObj =
...
for (let i in myObj.cars) {<br>&nbsp; x += &quot;&lt;h1&gt;&quot; + myObj.cars[i].name 
  ...
  <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_array_nested" target="_blank">Try it Yourself &raquo;</a>  
</div>

<!--stop-->
<div class="ws-note W3-large">
<h2>Learn More:</h2>
<p class="w3-large"><a href="js_array_methods.asp">Basic Array Methods</a></p>
...
<p class="w3-large"><a href="js_array_iteration.asp">Array Iteration Methods</a></p>
<p class="w3-large"><a href="js_array_reference.asp">JavaScript Array Reference</a></p>
</div>
