...
<p>Any text between <code class="w3-codespan">//</code> and the end of the line will be ignored by JavaScript 
...
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let x = 5;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Declare x, give it the value of 5<br>
...
<p>Any text between <code class="w3-codespan">/*</code> and <code class="w3-codespan">*/</code> will be ignored by JavaScript.</p>
...
<p>Adding <code class="w3-codespan">//</code> in front of a code line changes the code lines from an executable line to 
a comment.</p>
...
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: JavaScript Comments</h2>
  <a href="https://youtu.be/8yroEebhaEk&list=PLP9IO4UYNF0WWmZpE3W33vVPRl2GvjEqz" class="ga-featured ga-youtube" target="blank_" >
    <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
      ...
      <picture id="yt_div">
        <source srcset="images/img_javascript_comments.webp" type="image/webp" />
        <img src="images/img_javascript_comments.png" style="max-width:100%;height:auto;border-radius:6px" alt="Tutorial on YouTube" loading="lazy">
      </picture>
    </div>
  </a>
</div>
