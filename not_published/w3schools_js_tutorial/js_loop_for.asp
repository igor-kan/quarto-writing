...
<a class="w3-left w3-btn" href="js_loops.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_loop_while.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
<p><b>For Loops</b> can execute a block of code a number of times.</p>
<p><b>For Loops</b> are fundamental for tasks like performing an action multiple times.</p>
</div>
...
for (<i>exp 1</i>;<i> exp 2</i>;<i> exp 3</i>) {<br>
    &nbsp; // <i>code block to be executed</i><br>
 }<br>
</div></div>

<p><strong>exp 1</strong> is executed (one time) before the execution of the code block.</p>
<p><strong>exp 2</strong> defines the condition for executing the code block.</p>
<p><strong>exp 3</strong> is executed (every time) after the code block has been executed.</p>
...
<a target="_blank" href="tryit.asp?filename=tryjs_loop_for_om" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p>From the example above, you can read:</p>
<p><b>exp 1</b> sets a variable before the loop starts (let i = 0).</p>
<p><b>exp 2</b> defines the condition for the loop to run (i must be less than 5).</p>
<p><b>exp 3</b> increases a value (i++) after the code block has been executed.</p>
<!--stop-->
<hr>
...
<div class="w3-example">
<h3>Example</h3>
<p>Use a <code class="w3-codespan">for</code> loop to collect the car names from the cars array:</p>
<div class="w3-code notranslate jsHigh">
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_loop_for_om" target="_blank">Try it Yourself &raquo;</a>
</div>

<h2>How to use exp 1</h2>
<p><b>exp 1</b> is used to initialize the variable(s) used in the loop (let i = 0).</p>
<p><b>exp 1</b> is optional.</p>
<p>You can omit <b>exp 1</b> if the value is set before the loop starts:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const cars = ["BMW", "Volvo", "Saab", "Ford"];<br>
...
<hr>
<!--start-->
<h2>How to use exp 2</h2>
<p><b>exp 2</b> is used to evaluate the condition of the initial variable (i &lt; len).</p>
<p><b>exp 2</b> is also optional.</p>
<p>If <b>exp 2</b> returns <code class="w3-codespan">false</code>, the loop will end.</p>

<div class="w3-panel ws-note">

<p>If you omit exp 2, you must provide a <strong>break</strong> inside the loop.</p>
<p>Otherwise the loop will never end.</p>
<p>This will crash your browser.</p>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>How to use exp 3</h2>
<p><b>exp 3</b> increments the value of the initial variable (i++).</p>
<p><b>exp 3</b> is optional.</p>
<p><b>exp 3</b> can do anything like negative increment (i--), positive 
increment (i = i + 15), or anything else.</p>
<p><b>exp 3</b> can be omitted (if you increment the value inside the loop):</p>
...
<div id="exercisecontainer" src="xrcise_loop_for.js"></div>
<hr>
