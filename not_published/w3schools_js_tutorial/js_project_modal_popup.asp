...
<html lang="en-US">
<head>
<title>JavaScript Modal Popup Project</title>
<meta charset="utf-8">
...
<h1>Project - Modal Popup</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_project_todo.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_project_form_validation.asp">Next &#10095;</a>
</div>

<div class="ws-info">
<h2>Modal Popup</h2>
<p>A <b>modal is a popup window</b> that appears on top of the page.</p>
<p>The project will build a modal that can be closed in three ways:</p>
<ul>
<li>Click the close button (x)</li>
...
<ul>
<li>How to show and hide elements</li>
<li>How to use CSS classes with JavaScript</li>
<li>How to handle click and keydown events</li>
<li>How to detect clicks outside an element</li>
</ul>

<hr>
<h2>First: Create the HTML</h2>
<p>First create the HTML page</p>
<ul class="w3-ul">
<li>Add a <b>button</b> with id="openBth"</li>
<li>Add a Modal structure:</li>
<ul>
<li>Add a <b>div</b> with class="modal-overlay"</li>
<li>Add a <b>div</b> with class="modal-box"</li>
<li>Add a <b>button</b> with id="closeBtn" and class="modal-close"</li>
</ul>
</ul>
...
<br>
&lt;body&gt;<br>
&lt;h2&gt;Modal Popup&lt;/h2&gt;<br>
<br>
&lt;button id="openBtn"&gt;Open Modal&lt;/button&gt;<br>
<br>
&lt;div id="modal" class="modal-overlay"&gt;<br>
&nbsp;&nbsp;&lt;div class="modal-box"&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;button id="closeBtn" class="modal-close"&gt;&times;&lt;/button&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;h3&gt;Hello!&lt;/h3&gt;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&lt;p&gt;This is a modal popup.&lt;/p&gt;<br>
&nbsp;&nbsp;&lt;/div&gt;<br>
&lt;/div&gt;<br>
<br>
&lt;script&gt;<br>
...
<p>The modal has two parts:</p>
<ul>
<li>The overlay (background)</li>
<li>The modal box (content)</li>
</ul>
</div>
<hr>
<h2>Then: Create the CSS</h2>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;style&gt;<br>
/* The overlay (background) */<br>
.modal-overlay {<br>
&nbsp;&nbsp;display: none;<br>
&nbsp;&nbsp;position: fixed;<br>
&nbsp;&nbsp;left: 0;<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_project_popup_1" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>CSS Explained</h2>
<h4>Hide the modal by default:</h4>
<div class="w3-example">
<h3>Example</h3>
...
<h4>Show the modal using a class:</h4>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
.modal-overlay.show {
...
<p>JavaScript will add and remove the show class.</p>
</div>
...
<hr>
<h2>Then: Create the JavaScript</h2>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const modal = document.getElementById("modal");<br>
const openBtn = document.getElementById("openBtn");<br>
const closeBtn = document.getElementById("closeBtn");<br>
<br>
function openModal() {<br>
&nbsp;&nbsp;modal.classList.add("show");<br>
}<br>
...
<br>
openBtn.addEventListener("click", openModal);<br>
closeBtn.addEventListener("click", closeModal);<br>
<br>
/* Close when clicking outside the modal box */<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_project_popup" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>JavaScript Explained</h2>
<ul>
<li>Connect the open button to the openModal() function</li>
<li>Connect the open close button to the closeModal() function</li>
<li>Connect clocking outside the modal to the closeModal() function</li>
<li>Connect the open escape key to the closeModal() function</li>
</ul>

<hr>
<h2>Connect Functions to Buttons</h2>
<p>Connect the open button to the <b>openModal() function</b>, with addEventListener().</p>
<p>Connect the close button to the <b>closeModal() function</b>, with addEventListener().</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
openBtn.addEventListener("click", openModal);<br>
...
<hr>
<h2>Connect Function to Clicking Outside.</h2>
<p>Check if the click happened on the overlay. Connect it to <b>closeModal()</b>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
modal.addEventListener("click", function (event) {<br>
...
<p>event.target === modal means:<br>
The user clicked on the overlay, not inside the modal box.</p>
</div>

<hr>
<h2>Connect Function to Escape Key</h2>
<p>Listen for "Escape" key presses. Connect it to <b>closeModal()</b>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
document.addEventListener("keydown", function (event) {<br>
...
<ul class="w3-ul">
<li><b>Modal never closes when clicking outside:</b><br>
&nbsp;&nbsp;Make sure you check <b>event.target === modal</b>.</li>
<li><b>Escape closes even when modal is hidden:</b><br>
&nbsp;&nbsp;This is OK, but you can add a check to close only if it is open.</li>
<li><b>Using display: none with animation:</b><br>
&nbsp;&nbsp;If you want fade effects, use opacity instead (bonus challenge).</li>
</ul>

<hr>
<h2>Bonus Challenges (Level Up)</h2>
<ul>
<li>Add a fade-in / fade-out effect using CSS</li>
<li>Move focus to the modal when it opens (accessibility)</li>
<li>Trap focus inside the modal (advanced)</li>
<li>Close the modal with the Enter key when a button is focused</li>
</ul>
<hr>
<div class="ws-note">
