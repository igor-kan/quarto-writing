...
<h1>ECMAScript 2026</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_project_form_validation.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_2025.asp">Next &#10095;</a>
</div>

<div class="ws-info">
<h2>New Features in JavaScript 2026</h2>
<p>ECMAScript 2026 introduces several features focused on improving resource management,
handling asynchronous operations, and enhancing data manipulation:</p>
<ul>
<li>New JavaScript Date Object - <code class="w3-codespan"><a href="js_temporal.asp">Temporal Date</a></code></li>
<li>Resource management with <code class="w3-codespan">using</code> and
<code class="w3-codespan">await using</code></li>
<li>Error detection with <code class="w3-codespan">Error.isError()</code></li>
<li>Asynchronous array creation with <code class="w3-codespan">Array.fromAsync()</code></li>
<li>Base64 and hexadecimal encodings for <code class="w3-codespan">Uint8Array</code></li>
<li>Immutability with Records &amp; Tuples (Stage 3 proposal)</li>
<li>Pattern Matching (Stage 3 proposal)</li>
</ul>
</div>

<h2>The Temporal API</h2>
<p>The Temporal API in JavaScript 2026 provides standard objects and functions for working with dates and times.</p>
<p>From ES2026, the Temporal API is the standard for modern date and time management in JavaScript,
designed to replace the legacy Date object.</p>
<p>Unlike Date, Temporal objects are immutable and provide first-class support for time zones
and non-Gregorian calendars.</p>

<hr>
<h2>Resource Management with <b>using</b></h2>
<p>JavaScript 2026 added two keywords to automatically manage and dispose resources
(like file handles or database connections) when they go out of scope,
reducing the need for explicit try...finally blocks.</p>
<ul>
<li><code class="w3-codespan"><a href="js_2026.asp?#mark_using">using</a></code> provides <b>synchronous cleanup</b> of block-scoped variables.</li>
<li><code class="w3-codespan"><a href="js_2026.asp?#mark_using">await using</a></code> provides <b>asynchronous cleanup</b> for resources like network streams.</li>
</ul>

<hr>
<h2>Error Detection with <b>Error.isError()</b></h2>
<p><code class="w3-codespan"><a href="js_2026.asp?#mark_iserror">Error.isError()</a></code> is a static method to reliably check if a value is an Error object,
improving error handling and debugging.</p>

<hr>
<h2>New Array with <b>Array.fromAsync()</b></h2>
<p><code class="w3-codespan"><a href="js_2026.asp?#mark_fromasync">Array.fromAsync()</a></code>
is a feature that allows developers to create a new Array instance from
asynchronous iterables, array-like objects, or Promises, streamlining the handling of data from async sources.</p>

<hr>
<h2>New <b>Uint8Array</b> Methods in ES2026</h2>
<p>Base64 and Hexadecimal Encodings for Uint8Array.</p>
<p>These new static methods facilitate working with binary data by adding direct conversion between
Uint8Array objects and Base64 or hexadecimal strings.</p>
<ul>
<li><code class="w3-codespan"><a href="js_2026.asp?#mark_frombase64">Uint8Array fromBase64()</a></code><br>
<td>Creates a Uint8Array object from a base64-encoded string</li>
<li><code class="w3-codespan"><a href="js_2026.asp?#mark_frombase64">Uint8Array toBase64()</a></code><br>
<td>Returns a base64-encoded string from the data in an int8Array</li>
<li><code class="w3-codespan"><a href="js_2026.asp?#mark_fromhex">Uint8Array fromHex()</a></code><br>
<td>Creates a Uint8Array object from a hexadecimal string</li>
<li><code class="w3-codespan"><a href="js_2026.asp?#mark_fromhex">Uint8Array toHex()</a></code><br>
<td>Returns a hex-encoded string from the data in an int8Array</li>
</ul>
...
<h2>Warning</h2>
<p>The 2026 edition is not published yet. It normally ships in June.
<p>As of November 2025, this is a list of the features in the draft, that is likely to be in the ES2026.</p>
</div>

<hr>
<a id="mark_using"></a>
<h2>Explicit Resource Management</h2>
<h2>The using Keyword</h2>
<p>The <code class="w3-codespan">using</code> keyword is an addition to JavaScript 2026.
It provides a mechanism for managing resources that require explicit disposal.</p>
<p>It <b>declares a block-scoped variable</b>, similar to <code class="w3-codespan">const</code>, but with the difference that
it guarantees synchronous disposal of the used resource when the variable goes out of scope.</p>
...
&nbsp;&nbsp;constructor(name) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;this.name = name;<br>
&nbsp;&nbsp;&nbsp;&nbsp;myDisplay(`Resource ${this.name} acquired.`);<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;[Symbol.dispose]() {<br>
&nbsp;&nbsp;&nbsp;&nbsp;myDisplay(`Resource ${this.name} disposed.`);<br>
&nbsp;&nbsp;}<br>
}<br>
<br>
function manageResource() {<br>
  using resource = new MyResource("Database Connection");<br>
<br>
  // Use the resource here<br>
  myDisplay(`Using resource: ${resource.name}`);<br>
}<br>
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_using" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p>The <code class="w3-codespan">using</code> keyword simplifies resource management by automatically
handling the cleanup process, reducing the risk of resource leaks and improving code readability
compared to manual <code class="w3-codespan">try...finally</code> blocks for disposal.</p>

<ul>
<li><p><b>Resource Management</b><br>
<code class="w3-codespan">using</code> is designed for objects that implement the
<code class="w3-codespan">Symbol.dispose</code> method, which defines the cleanup logic for the resource.</p></li>
<li><p><b>Synchronous Disposal</b><br>
When a variable declared with <code class="w3-codespan">using</code> exits its scope
(at the end of a block or function), its <code class="w3-codespan">Symbol.dispose</code> method is automatically called.</p></li>
<li><p><b>Asynchronous Disposal</b><br>
For resources requiring asynchronous cleanup, 
the <code class="w3-codespan">await using</code> declaration can be employed.
This ensures that the disposal process is awaited before the variable fully goes out of scope.</p></li>
<li><p><b>Block-Scoped</b><br>
Like <code class="w3-codespan">const</code>, variables declared with <code class="w3-codespan">using</code>
are local to the block in which they are declared, and must be initialized at the time of declaration.</p></li>
<li><p><b>Immutable</b><br>
Like to <code class="w3-codespan">const</code>, variables declared with <code class="w3-codespan">using</code>
cannot be reassigned after initialization.</p></li>
</ul>

<h3>Browser Support</h3>
<p><code class="w3-codespan">using</code> is already supported in many browsers:</p>
...
<h2>Explicit Resource Management</h2>
<h2>await using</h2>
<p>Inspired by other languages, JavaScript 2026 introduces <code class="w3-codespan">using</code> blocks for automatic cleanup
of resources like file handles, database connections, or network streams.</p>
<p>This is especially beneficial for asynchronous operations:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
async function processFile() {<br>
&nbsp; using fileHandle = await openFile('data.txt');<br>
<br>
// Work with fileHandle here<br>
<br>
} // fileHandle is automatically closed here<br>
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_await_using" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>


<h3>Browser Support</h3>
<p><code class="w3-codespan">await using</code> is already supported in many browsers:</p>
<div class="w3-responsive w3-stretch">
<table class="browserref notranslate">
  <tbody><tr>
    <th class="bsChrome" title="Chrome"></th>
...
<a id="mark_iserror"></a>
<h2>Error.isError()</h2>
<p>The <code class="w3-codespan">Error.isError()</code> static method checks whether a value is an Error object.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
Error.isError(new TypeError());   // true<br>
Error.isError({ name: "Error" }); // false<br>
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_error_iserror" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p><code class="w3-codespan">Error.isError()</code> is a safe alternative to
<code class="w3-codespan">instanceof Error</code> which fails across realms.</p>
<p><b>Realm-safe error check:</b><br>
An Error from an iframe verifies with <code class="w3-codespan">Error.isError()</code>
and fails with <code class="w3-codespan">instanceof</code>.</p>

<h3>Browser Support</h3>
<p><code class="w3-codespan">Error.isError()</code> is already supported in many browsers:</p>
<div class="w3-responsive w3-stretch">
<table class="browserref notranslate">
  <tbody><tr>
    <th class="bsChrome" title="Chrome"></th>
...
<hr>
<a id="mark_fromasync"></a>
<h2>Array.fromAsync()</h2>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
async function* asyncGenerator() {<br>
&nbsp; yield Promise.resolve(1);<br>
&nbsp; yield Promise.resolve(2);<br>
&nbsp; yield Promise.resolve(3);<br>
}<br>
<br>
async function processAsyncData() {<br>
&nbsp; const arr = await Array.fromAsync(asyncGenerator());<br>
}<br>
<br>
processAsyncData();<br>
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_array_fromasync" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<h3>Browser Support</h3>
<p><code class="w3-codespan">Array.fromAsync()</code> is already supported in many browsers:</p>
<div class="w3-responsive w3-stretch">
<table class="browserref notranslate">
  <tbody><tr>
    <th class="bsChrome" title="Chrome"></th>
...
<hr>
<a id="mark_frombase64"></a>
<h2>Uint8Array to/fromBase64()</h2>

<div class="w3-example">
<h3>Examples</h3>
<div class="w3-code notranslate jsHigh">
let string = 'W3Schools 123';<br>
<br>
const arr = Uint8Array.fromBase64(string);
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_uint8array_fromBase64" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>

<div class="w3-code notranslate jsHigh">
const arr = new Uint8Array([91,116,156,134,138,37,179,93,183]);<br>
<br>
let text = arr.toBase64();
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_uint8array_toBase64" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<h3>Browser Support</h3>
<p><code class="w3-codespan">to/fromBase64()</code> is already supported in many browsers:</p>
<div class="w3-responsive w3-stretch">
<table class="browserref notranslate">
  <tbody><tr>
    <th class="bsChrome" title="Chrome"></th>
...
<hr>
<a id="mark_fromhex"></a>
<h2>Uint8Array to/fromHex()</h2>

<div class="w3-example">
<h3>Examples</h3>
<div class="w3-code notranslate jsHigh">
let text = '5b749c868a25b35db7';<br>
<br>
const arr = Uint8Array.fromHex(text);
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_uint8array_fromhex" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
const arr = new Uint8Array([91,116,156,134,138,37,179,93,183]);<br>
<br>
let text = arr.toHex();
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_uint8array_tohex" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<h3>Browser Support</h3>
<p><code class="w3-codespan">to/fromHex()</code> is already supported in many browsers:</p>
<div class="w3-responsive w3-stretch">
<table class="browserref notranslate">
  <tbody><tr>
    <th class="bsChrome" title="Chrome"></th>
