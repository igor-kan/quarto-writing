...
<a class="w3-left w3-btn" href="js_datatypes_objects.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_typeof.asp">Next &#10095;</a>
</div>
<div class="ws-info">
<h2>Unique Values</h2>
<p>A <b>Symbol</b> represents a <b>unique identifier</b>.</p>
<p>Every Symbol value is unique, even if they have the same description.</p>
<p>A Symbol is a <b>hidden identifier</b> that no code can accidentally access.</p>
</div>

<h2>Creating Symbols</h2>
<p>Use <code class="w3-codespan">Symbol()</code> to create a Symbol:</p>
...
<p>The two Symbols are different:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const id1 = Symbol();<br>
const id2 = Symbol();<br><br>
let result = (id1 === id2);
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_datatypes_symbol" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="ws-note">
<p>The result is <code class="w3-codespan">false</code>.</p>
<p>Every Symbol has a unique value.</p>
</div>

<hr>
<h2>Symbol Descriptions</h2>
<p>You can add a description to a Symbol:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const id = Symbol("id");
...
<p>The description is only for debugging and readability.</p>

<p>It does not make the Symbol unique.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const id1 = Symbol("id");<br>
const id2 = Symbol("id");<br><br>
let result = (id1 === id2);
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_datatypes_symbols" target="_blank">Try it Yourself &raquo;</a>

</div>
<div class="ws-note">
<p>The result is still <code class="w3-codespan">false</code>.</p>
<p><b>Symbols are always unique</b>.</p>
...
<hr>
<h2>Using Symbols as Object Keys</h2>
<p>Symbols are often used as object property keys.</p>
<p>This lets you create hidden or unique properties.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const id = Symbol("id");<br><br>
const person = {<br>
&nbsp;&nbsp;firstName: "John",<br>
&nbsp;&nbsp;lastName: "Doe"<br>
};<br><br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_datatypes_symbol_objectkey" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>The Symbol Type</h2>
<p>A JavaScript Symbol is a primitive data type just like Number, String, or Boolean.</p>
<p>The JavaScript type of a Symbol is <code class="w3-codespan">symbol</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_datatypes_symbol_typeof" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Hidden Identifiers</h2>
<p>A Symbol represents a <b>unique "hidden" identifier</b> that no code can accidentally access.</p>
<p>For instance, if different programmers want to add a person.id property to a person object belonging to a third-party code,
...
<h2>Symbols are Not Included in for...in</h2>
<p>Symbol properties are ignored by <code class="w3-codespan">for...in</code> loops:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const id = Symbol("id");<br><br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_datatypes_symbol_forin" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="ws-note">
<p>The Symbol property is not displayed.</p>
</div>

<hr>

<h2>Symbols are Not Included in JSON</h2>

<p>Symbol properties are ignored by <code class="w3-codespan">JSON.stringify()</code>:</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_datatypes_symbol_json" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<p>JavaScript has a global Symbol registry.</p>

<p>Use <code class="w3-codespan">Symbol.for()</code> to create or reuse a global Symbol:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const id1 = Symbol.for("id");<br>
const id2 = Symbol.for("id");<br><br>
let result = (id1 === id2);
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_datatypes_symbol_global" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="ws-note">
<p>The result is <code class="w3-codespan">true</code>.</p>
</div>
...
<p>JavaScript provides built-in Symbols called well-known Symbols.</p>

<p>These Symbols control JavaScript behaviors.</p>

<p>Examples:</p>

<ul>
<li><code class="w3-codespan">Symbol.iterator</code></li>
<li><code class="w3-codespan">Symbol.asyncIterator</code></li>
<li><code class="w3-codespan">Symbol.toStringTag</code></li>
<li><code class="w3-codespan">Symbol.toPrimitive</code></li>
</ul>
...
<p>The <code class="w3-codespan">Symbol.iterator</code> Symbol defines an iterable object.</p>

<p>This makes objects work with loops like <code class="w3-codespan">for...of</code>.</p>
...
&nbsp;&nbsp;[Symbol.iterator]() {<br>
&nbsp;&nbsp;&nbsp;&nbsp;let index = 0;<br>
&nbsp;&nbsp;&nbsp;&nbsp;let data = this.data;<br><br>
&nbsp;&nbsp;&nbsp;&nbsp;return {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;next() {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (index &lt; data.length) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return {value:data[index++], done:false};<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return {done:true};<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
...
let text = "";<br>
for (const x of myObject) {<br>
&nbsp;&nbsp;text += x + "&lt;br&gt;";<br>
}<br><br>
// Display text
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_datatypes_symbol_iterator" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<p>Use Symbols when you need:</p>

<ul>
<li>Unique object property names</li>
<li>Hidden object properties</li>
<li>Custom iterable objects</li>
<li>Special object behavior</li>
</ul>

<hr>
<h2>When NOT to Use Symbols</h2>
<p>Symbols are not commonly used in everyday JavaScript code.</p>
<p>Do not use Symbols unless you need unique property keys or advanced object behavior.</p>
<p>For normal object properties, use strings names instead.</p>

<hr>
<h2>Browser Support</h2>
<p><code class="w3-codespan">Symbol</code> is an <a href="js_es6.asp">ES6  feature</a>.</p>
