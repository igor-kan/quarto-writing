...
<html lang="en-US">
<head>
<title>JavaScript Counter Project</title>
<meta charset="utf-8">
...
<h1>Project - localStorage Counter</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_precedence.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_project_eventlistener.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
<h2>A Counter with Reset and Save</h2>
<p>In this project you will build a <b>counter</b> with buttons to:</p>
<ul>
<li><b>Increase</b> the counter</li>
<li><b>Decrease</b> the counter</li>
<li><b>Reset</b> the counter</li>
<li><b>Save</b> the counter</li>
<li><b>Load</b> the counter</li>
</ul>
...
<li>JavaScript Events (onclick attributes)</li>
<li>JavaScript localStorage (to <b>Save</b> and <b>Restore</b> the counter)</li>
</ul>
...
&lt;h2&gt;Counter&lt;/h2&gt;<br>
<br>
&lt;p id="count" style="font-size:40px;"&gt;0&lt;/p&gt;<br>
<br>
&lt;button onclick="increaseCount()"&gt;+&lt;/button&gt;<br>
&lt;button onclick="decreaseCount()"&gt;-&lt;/button&gt;<br>
&lt;button onclick="resetCount()"&gt;Reset&lt;/button&gt;<br>
&lt;button onclick="saveCount()"&gt;Save&lt;/button&gt;<br>
&lt;button onclick="loadCount()"&gt;Load&lt;/button&gt;<br>
<br>
&lt;script&gt;<br>
// JavaScript code. See below.<br>
&lt;/script&gt;<br>
</div>
<h3>JavaScript Code</h3>
<div class="w3-code notranslate jsHigh">
// Declare the counter<br>
let count = 0;<br>
<br>
// Function to display the counter<br>
function updateCount() {<br>
&nbsp;&nbsp;document.getElementById("count").innerHTML = count;<br>
}<br>
<br>
// Function to increase the counter<br>
function increaseCount() {<br>
&nbsp;&nbsp;count++;<br>
&nbsp;&nbsp;updateCount();<br>
}<br>
<br>
// Function to decrease the counter<br>
function decreaseCount() {<br>
&nbsp;&nbsp;count--;<br>
&nbsp;&nbsp;updateCount();<br>
}<br>
<br>
// Function to reset the counter<br>
function resetCount() {<br>
&nbsp;&nbsp;count = 0;<br>
&nbsp;&nbsp;updateCount();<br>
}<br>
<br>
// Function to save the counter<br>
function saveCount() {<br>
&nbsp;&nbsp;localStorage.setItem("count", count);<br>
}<br>
<br>
// Function to load the counter<br>
function loadCount() {<br>
&nbsp;&nbsp;let saved = localStorage.getItem("count");<br>
&nbsp;&nbsp;if (saved !== null) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;count = Number(saved);<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;updateCount();<br>
}<br>
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_project_counter"
...
<ul>
<li>Add a <code class="w3-codespan">&lt;h2&gt;</code> header element</li>
<li>Add a <code class="w3-codespan">&lt;p&gt;</code> element displaying a number</li>
<li>Add 5 <code class="w3-codespan">&lt;button&gt;</code> elements</li>
<li>Add an <code class="w3-codespan">onclick</code> attribute to each button</li>
</ul>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
...
<hr>
<h2>2. Create a Script</h2>
<ul>
<li><code class="w3-codespan">let count = 0</code> declares a counter</li>
<li><code class="w3-codespan">Function updateCount() {}</code> creates a function to update counter</li>
<li><code class="w3-codespan">document.getElementById().innerHTML</code> displays the counter
...
<hr>
<h2>3: Add an Increase Counter Function</h2>
<ul>
<li><code class="w3-codespan">Function increaseCount() {}</code> creates an increase function</li>
<li><code class="w3-codespan">count++</code> increases the counter</li>
<li><code class="w3-codespan">updateCount()</code> diplays the counter</li>
</ul>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<hr>
<h2>4: Add a Decrease Counter Function</h2>
<ul>
<li><code class="w3-codespan">Function decreaseCount() {}</code> creates a decrease function</li>
<li><code class="w3-codespan">count--</code> decreases the counter</li>
<li><code class="w3-codespan">updateCount()</code> diplays the counter</li>
</ul>
<div class="w3-example">
<h3>Example</h3>
...
<hr>
<h2>5: Add a Reset Counter Funtion</h2>
<ul>
<li><code class="w3-codespan">Function resetCount() {}</code> creates a reset function</li>
<li><code class="w3-codespan">count = 0</code> resets the counter</li>
<li><code class="w3-codespan">updateCount()</code> diplays the counter</li>
</ul>
...
<hr>
<h2>6: Create a Save Counter Function</h2>
<ul>
<li><code class="w3-codespan">Function saveCount() {}</code> creates a save function</li>
<li><code class="w3-codespan">localStorage.setItem()</code>  saves the value.</li>
</ul>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<hr>
<h2>7: Create a Load Counter Function</h2>
<ul>
<li><code class="w3-codespan">Function loadCount() {}</code> creates a load function</li>
<li><code class="w3-codespan">localStorage.getItem()</code>  gets the value</li>
<li><code class="w3-codespan">Number(saved)</code> converts saved to numberstdisplays the value.</li>
<li><code class="w3-codespan">updateCount()</code> displays the value.</li>
</ul>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<p><code class="w3-codespan">localStorage</code> stores values as text, so we use
<code class="w3-codespan">Number()</code> to convert the value back into a number.
</div>
<br>
</div>
...
<ul>
<li>How to update HTML using JavaScript</li>
<li>How to use button events (onclick)</li>
<li>How to store and load values from localStorage</li>
<li>How to keep your code organized with functions</li>
</ul>
...
<hr>
<h3>Exercice 1</h3>
<p>Make the counter start at 10 instead of 0.</p>
<h3>Exercice 2</h3>
<p>Prevent the counter from going below 0.</p>
<h3>Exercice 3</h3>
<p>Automatically load the saved counter value when the page opens.</p>
...
let count = 10;<br>
<br>
// Load the counter when the page opens<br>
loadCount();<br>
<br>
// Function to display the counter<br>
function updateCount() {<br>
...
<a target="_blank" href="tryit.asp?filename=tryjs_project_counter_ex"
class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="ws-note">
<p>Try saving the value, reload the page, and see if it load automatically.</p>
</div>
