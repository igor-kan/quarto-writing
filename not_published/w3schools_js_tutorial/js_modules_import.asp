...
<html lang="en-US">
<head>
<title>JavaScript Modules Import</title>
<meta charset="utf-8">
...
<a class="w3-right w3-btn" href="js_modules_namespace.asp">Next &#10095;</a>
</div>

<div class="ws-info">
<h2>Import</h2>
<p>You can <b>import modules</b> in two ways, based on if they are
<b>named exports</b> or <b>default exports</b>.</p>
<div class="w3-example">
<p>Named imports are constructed using curly braces:
...
<hr>
<h2>Named Imports</h2>
<p><b>Named imports</b> match named exports in a module.</p>
<p>They let you import one or more <b>explicitly named variables or functions</b> from a module.</p>
<p>You must use the <b>exact names</b> enclosed <b>in curly { } braces</b>:</p>
<div class="w3-example">
<h3>Examples</h3>
<p>Import the named exports <b>name</b> and <b>age</b> from the file person.js:</p>
<div class="w3-code notranslate jsHigh">
import { name, age } from "./person.js";
</div>
<p>
...
<p>Import the named exports <b>add</b>, <b>subtract</b>, and <b>PI</b> from the file math.js:</p>
...
<h2>Named Import Rules</h2>
<p>Import <b>names must match</b> export names:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
import { addd } from './math.js'; // &#10060; Error (name mismatch)
</div>
</div>
<p>You can import <b>multiple items</b> at once:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
import { add, PI } from './math.js';
</div>
</div>
<p>You can <b>rename</b> them using <b>as</b>:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
...
<p><b>Default import</b> is the way to import the primary exported value from a module -
the one that was exported using export default.</p>
<p>Defalt imports are the counterpart to default exports.</p>
<p>You can give a default export any name you like, during import, without using curly braces:</p>
<div class="w3-example">
<h3>Examples</h3>
...
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_modules3">Try it Yourself &raquo;</a>
</p>
</div>

<hr>
<h2>Default Import Rules</h2>
<p>Default import imports single default exports</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
import message from "./message.js";
</div>
</div>
<p>There is no required name. Renaming is allowed.</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
import text from "./message.js";
</div>
...
<hr>
<h2>Importing All</h2>
<p>You can import all named exports from a module as a single object using the * syntax.</p>
<div class="w3-example">
<h3>Examples</h3>
<div class="w3-code notranslate jsHigh">
// Import all named exports from person.js<br>
import * as person from "./person.js";<br>
</div>
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_modules4">Try it Yourself &raquo;</a>
</p>
<div class="w3-code notranslate jsHigh">
// Import all named exports from math.js<br>
import * as math from "./math.js";<br>
</div>
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_modules_math2">Try it Yourself &raquo;</a>
</p>
</div>

<hr>
<h2>Default Import vs Named</h2>
<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
<tr><th>Feature </th><th>Default Import</th><th>Named Import</th></tr>
<tr><td>Typical use case</td><td>One main feature per module</td><td>Multiple features</td></tr>
<tr><td>Matches export name?</td><td>No (you choose)</td><td>Yes (must match)</td></tr>
<tr><td>Can rename freely?</td><td>Always</td><td>Only with as</td></tr>
<tr><td>Export count</td><td>Only one default export allowed</td><td>Multiple exports allowed</td></tr>
</table>
</div>
