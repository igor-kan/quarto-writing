...
<a class="w3-right w3-btn" href="js_codeblocks.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
<h2>Scope = Visibility</h2>
<p><b>Scope</b> determines the <b>accessibility</b> (visibility) of variables.</p>
<p>JavaScript variables have 3 types of scope:</p>
<ul class="w3-large">
<li>Global scope</li>
...
<!--start-->
<h2>Global Scope</h2>
<p>Variables declared <b>Globally</b> (outside any block or function) have
<b>Global Scope</b>.</p>
<p><b>Global</b> variables can be accessed from anywhere in a JavaScript program. </p>
<p>Variables declared with <code class="w3-codespan">var</code>, <code class="w3-codespan">let</code>
and <code class="w3-codespan">const</code> are 
quite similar when declared outside a block.</p>
<p>They all have <b>Global Scope</b>:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
var x = 1;&nbsp;&nbsp;&nbsp;&nbsp;// Global scope<br>
<br>
let y = 2;&nbsp;&nbsp;&nbsp;&nbsp;// Global scope<br>
<br>
const z = 3;&nbsp;&nbsp;// Global scope<br>
</div>
</div>
<div class="w3-example">
<h3>Example</h3>
...
// code here can also use carName <br>}
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_scope_global" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="ws-note">
<p><b>Global variables</b> has <b>Global Scope</b>:</p>
<p>All scripts and functions in the same web page can access a variable with global scope.</p>
</div>
<!--stop-->
...
<p>All JavaScript functions have their own scope.</p>
...
function myFunction1() {<br>
  &nbsp; var carName = "Volvo";&nbsp; // Function Scope<br>
}<br>
<br>
function myFunction2() {<br>
  &nbsp; let carName = "Volvo";&nbsp; // Function Scope<br>
}<br>
<br>
function myFunction3() {<br>
  &nbsp; const carName = "Volvo";&nbsp; // Function Scope<br>
}
</div>
</div>
...
<div class="w3-example">
<h3>Example</h3>
<p>Variables declared within a JavaScript function, are <b>
LOCAL</b> to the function:</p>
<div class="w3-code notranslate jsHigh">
// code here can NOT use carName<br><br>function myFunction() {<br>
&nbsp;&nbsp;let carName = &quot;Volvo&quot;;<br>&nbsp; // code here CAN use carName<br>}<br>
...
<h3>Local Variables have Function Scope</h3>
<ul>
...
<hr>
<h2>Block Scope</h2>
<p>Before <a href="js_es6.asp">ES6</a>, JavaScript variables could only have
<b>Global Scope</b> or <b>Function Scope</b>.</p>
...
inside a code block are "block-scoped," meaning they are only accessible within that block.</p>
...
<p>Variables declared with the <code class="w3-codespan">var</code> keyword,
inside a { } block, can be accessed from outside the block.</p>

<div class="w3-example">
<h3>Example (Not Recommended)</h3>
<div class="w3-code notranslate jsHigh">
{ <br>
&nbsp;&nbsp;var x = 2; <br>
  }<br>
...
<p>If you assign a value to a variable that has <b>not been declared</b>, it will become a <b>GLOBAL</b> variable.</p>
<p>This code example will declare a global variable <code class="w3-codespan">carName</code>, even if 
...
<p>Global variables defined with the <code class="w3-codespan">var</code> keyword belong to the window object:</p>

<div class="w3-example">
<h3>Example (Not Recommended)</h3>
<div class="w3-code notranslate jsHigh">
var carName = &quot;Volvo&quot;;<br>// code here 
can use window.carName<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_scope_window" target="_blank">Try it Yourself &raquo;</a>
</div>

<p>Global variables defined with the <code class="w3-codespan">let</code> keyword do not belong to the window object:</p>
