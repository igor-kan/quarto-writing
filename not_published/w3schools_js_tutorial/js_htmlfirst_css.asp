...
<html lang="en-US">
<head>
<title>CSS Instead of JavaScript - How to use CSS for styling, layout, and simple interaction.</title>
<meta charset="utf-8">
...
<h1>CSS Instead of JavaScript</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_htmlfirst_features.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_function_advanced.asp">Next &#10095;</a>
</div>

<div class="ws-info">
<p>In <b>HTML-first development</b>, CSS is often the second step after HTML.</p>

<p>Many visual effects can be created with CSS instead of JavaScript.</p>

<p>CSS can handle layouts, hover effects, transitions, animations, responsive design, and simple state changes.</p>
...
<p>The <code class="w3-codespan">:hover</code> selector can change an element when the mouse is over it.</p>
...
&lt;style&gt;<br>
button:hover {<br>
&nbsp;&nbsp;background-color:#059862;<br>
}<br>
&lt;/style&gt;<br>
<br>
&lt;button&gt;Hover Over Me&lt;/button&gt;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_htmlfirst_hover" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<p>CSS transitions can animate changes smoothly.</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_htmlfirst_transition" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Show and Hide Content</h2>

<p>CSS can show and hide content using selectors.</p>

<p>This can be useful for simple menus and dropdowns.</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_htmlfirst_hide" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<p>CSS media queries can change the layout for different screen sizes.</p>

<p>This avoids the need for JavaScript-based layout changes.</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_htmlfirst_responsive" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<p>CSS animations can create repeated movement without JavaScript.</p>
...
&nbsp;&nbsp;width:40px;<br>
&nbsp;&nbsp;height:40px;<br>
&nbsp;&nbsp;border:6px solid #ddd;<br>
&nbsp;&nbsp;border-top:6px solid #04AA6D;<br>
&nbsp;&nbsp;border-radius:50%;<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_htmlfirst_animation" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>When CSS Is Enough</h2>

<p>CSS is often enough when the change is visual.</p>

<p>Use CSS for colors, sizes, spacing, layout, motion, and simple visibility changes.</p>

<p>Use JavaScript when the page needs logic, data processing, storage, or communication with a server.</p>

<div class="ws-note">
<p>If the problem is visual, try CSS first.</p>
</div>
