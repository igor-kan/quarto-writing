...
<html lang="en-US">
<head>
<title>JavaScript Object Definitions</title>
<meta charset="utf-8">
...
<h1>JavaScript Object Definitions</h1>

<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_object_advanced.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_this.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
<h3>Methods for Defining JavaScript Objects</h3>
<ul>
  <li>Using an Object Literal</li>
  <li>Using the <code class="w3-codespan">new</code> Keyword</li>
  <li>Using an Object Constructor</li>
  <li>Using <code class="w3-codespan">Object.assign()</code></li>
  <li>Using <code class="w3-codespan">Object.create()</code></li>
  <li>Using <code class="w3-codespan">Object.fromEntries()</code></li>
</ul>
</div>

<hr>
<h2>Using an Object Literal</h2>
<p>An object literal is a list of property <b>key:values</b> inside curly braces <b>{ }</b>.</p>
<div class="w3-code notranslate jsHigh w3-border w3-large">
...
<hr>
<h2>Using the <b>new</b> Keyword</h2>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create an Object<br>
...
<p>The examples above do exactly the same.</p>
<p>But, there is no need to use <code class="w3-codespan">new Object()</code>.</p>
<p>For readability, simplicity and execution speed, use the <b>object literal</b> method.</p>
</div>
<!--stop-->
...
<h2>JavaScript Object.create()</h2>
...
<p><code class="w3-codespan">fromEntries()</code> is an ECMAScript 2019 feature.</p>
...
<tr><td><code class="w3-codespan">string</code></td><td>"Hello"</td></tr>
<tr><td><code class="w3-codespan">number</code></td><td>3.14</td></tr>
<tr><td><code class="w3-codespan">boolean</code></td><td>true</td></tr>
<tr><td><code class="w3-codespan">bigint</code></td><td>12345678901234n</td></tr>
<tr><td><code class="w3-codespan">null</code></td><td>null</td></tr>
<tr><td><code class="w3-codespan">undefined</code></td><td>undefined</td></tr>
<tr><td><code class="w3-codespan">symbol</code></td><td>symbol</td></tr>
</table>
<!--stop-->
...
<tr><td>null</td><td>null</td><td>null is always null</td></tr>
...
<p>The object x is <strong>not a copy</strong> of person. The object x <strong>is</strong> person.</p>
<p>The object x and the object person share the same memory address.</p>
<p>Any changes to x will also change person:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
//Create an Object<br>
...
<br>
// Try to create a copy<br>
const x = person;<br>
<br>
// This will change age in person:<br>
x.age = 10;
</div>
