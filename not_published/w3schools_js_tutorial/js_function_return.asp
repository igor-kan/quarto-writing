...
<a class="w3-right w3-btn" href="js_function_arguments.asp">Next &#10095;</a>
</div>

<div class="ws-info">
<h2>Returning Values from Functions</h2>
<p>A function can return a value back to the code that called it.</p>
<p>The <b>return statement</b> is used to send a value out of a function.</p>
</div>
<h2>The <b>return</b> Statement</h2>
<p>When a function reaches a <b>return</b> statement, the function <b>stops executing</b>.</p>
<p>The <b>value</b> after the <b>return</b> keyword <b>is sent back</b> to the caller.</p>
...
let message = sayHello();<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_function_return5" target="_blank">
Try it Yourself &raquo;</a>
</div>

<div class="ws-note">

<p>The variable <b>message</b> now contains "<b>Hello World</b>".</p>
</div>

<hr>
<h2>Returning a Calculated Value</h2>
<p>Most functions return the result of a calculation or an operation.</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_function_return3" target="_blank">
Try it Yourself &raquo;</a>
</div>


<hr>
<h2>Using Return Values in Expressions</h2>
<p>The returned value can be used anywhere a value is expected.</p>
<p>You can use a function call inside another expression.</p>
...
let total = multiply(2, 3) * 10;<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_function_return6" target="_blank">
Try it Yourself &raquo;</a>
</div>
...
<hr>
<h2>Return Values</h2>
<p>A function can return any type of value (not only numbers).</p>
...
let name = fullName("John", "Doe");<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_function_return7" target="_blank">
Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Return Statements Stop Execution</h2>
<p>Code written after a <b>return</b> statement will <b>NOT be executed</b>.</p>
...
function multiply(a, b) {<br>
&nbsp;&nbsp;return "Done";<br>
&nbsp;&nbsp;// Next line will never run<br>
&nbsp;&nbsp;return a * b;<br>
}<br>
<br>
let result = multiply(4, 3);
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_function_return8" target="_blank">
Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Functions Without return</h2>
<p>If a function does not return a value, the return value will be <b>undefined</b>.</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_function_return9" target="_blank">
Try it Yourself &raquo;</a>
</div>

<div class="ws-note">

<p>The value of <b>result</b> is <b>undefined</b>.</p>
</div>

<hr>
<h2>Returning Values Early</h2>
<p>
You can use <b>return</b> to stop a function early, based on a condition.<br>
</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_function_return_early" target="_blank">Try it Yourself &raquo;</a>

</div>

<hr>
<h2>Returning Values to HTML</h2>
<p>Returned function values are often used to update HTML content.</p>
...
&lt;p id="demo"&gt;&lt;/p&gt;<br><br>
&lt;script&gt;<br>
function toCelsius(farenheit) {<br>
&nbsp;&nbsp;return (5 / 9) * (farenheit - 32);<br>
}<br><br>
document.getElementById("demo").innerHTML = toCelsius(77);<br>
&lt;/script&gt;<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_farenheit_to_celsius_5" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<div class="ws-note">
<h2>Quiz</h2>
<p>What value is returned if a function has no return statement?</p>
</div>

<hr>
<h2>Common Mistakes</h2>
<ul class="w3-ul w3-border">
<li><h3>Forgetting Return</h3>
A function without <b>return</b> sends back <b>undefined</b>.</li>
<li><h3>Expecting Code after Return to Run</h3>
Code after <b>return</b> is ignored.</li>
<li><h3>Confusing console.log() with Return</h3>
<b>console.log()</b> shows output but does not return a value.</li>
<li><h3>Expecting Return</h3>
If your function does not return a value, storing it in a variable will give <b>undefined</b>.</li>
</ul>

<hr>
<div class="ws-note">
<h2>Next Chapter</h2>
<p class="w3-large"><a href="js_function_arguments.asp">Function Arguments</a></p>
<ul>
