...
<a class="w3-left w3-btn" href="js_function_advanced.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_callback.asp">Next &#10095;</a>
</div>

<div class="ws-info">
<h2>Function Definitions vs Function Declarations</h2>
<p><b>Function definition</b> is a <b>general term</b> for defining a function.</p>
<p><b>Function declaration</b> is <b>one specific way</b> to define a function.</p>
<p>Examples of function definitions include:</p>
<ul>
...
<br>
// Function Expression (Named)<br>
const myFunction = function name(x, y) {<br>
&nbsp;&nbsp;return x * y;<br>
};<br>
<br>
// Function Expression (Anonymous)<br>
const myFunction = function (x, y) {<br>
&nbsp;&nbsp;return x * y;<br>
};<br>
<br>
// Arrow Function<br>
...
const myFunction = new Function("x", "y", "return x * y");<br>
<br>
// Object Method<br>
const obj = {<br>
&nbsp;&nbsp;myFunction(x, y) {<br>
...
<p>A function declaration uses the <b>function</b> keyword and a function <b>name</b>.</p>
...
<a target="_blank" href="tryit.asp?filename=tryjs_function_return1" class="w3-btn">Try it Yourself &raquo;</a>
<p>More Common:</p>
<div class="w3-code notranslate jsHigh">
...
<a target="_blank" href="tryit.asp?filename=tryjs_function_return2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p>You can call a function before or after it is declared in the code.</p>
...
<a target="_blank" href="tryit.asp?filename=tryjs_function_return4" class="w3-btn">Try it Yourself &raquo;</a>
<p>After:</p>
<div class="w3-code notranslate jsHigh">
function myFunction(a, b) {<br>
&nbsp;&nbsp;return a * b;<br>
...
<a target="_blank" href="tryit.asp?filename=tryjs_function_return3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Function Expressions</h2>
<p>A function expression stores a function inside a variable.</p>
<p>The function can be anonymous (without a name).</p>
<p>Function expressions are executed only when the code reaches them.</p>
<hr>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<p>Function declarations are <b>hoisted</b> to the top of their scope.</p>
<p>Function expressions are <b>not hoisted</b> in the same way.</p>

<p>Function declarations <b>can</b> be called <b>before they are defined</b>.</p>
<p>Function expressions <b>can not</b> be called <b>before they are defined</b>.</p>

<div class="w3-example">
<h3>Examples</h3>
<p><b>Function declarations</b> can be called before they are defined:</p>

<div class="w3-code notranslate jsHigh">
const sum = add(2, 3); // Will work<br>
<br>
function add(a, b) {return a + b;}
</div>
<p><b>Function expressions</b> can not be called before they are defined:</p>
<div class="w3-code notranslate jsHigh">
const sum = add(2, 3); // &#9940; Will generate error<br>
<br>
...
<div class="w3-stretch w3-margin-top">
...
<tr>
<td><b>Syntax:</b><br>
A statement starting with the function keyword, followed by a required name.</td>
<td><b>Syntax:</b><br>
A part of an expression or assignment, and can be anonymous (without a name).</td>
</tr>

<tr>
<td><b>Hoisting:</b><br>
The function is moved to the top of its scope before code execution,
allowing you to call it from anywhere within that code scope, even before its definition.</td>
<td><b>Hoisting:</b><br>
The variable holding the function might be hoisted
(depending on var, let, or const), but the function assignment itself is not.
You can only call it after it has been defined in the code scope.</td>
</tr>

<tr>
<td><b>Flexibility:</b><br>
Primarily used for general-purpose functions that need to be available globally or in a specific scope.
</td>
<td><b>Flexibility:</b><br>
Can be used in various contexts, such as arguments to other
functions (callbacks), immediately invoked function expressions, and assigned to object properties.</td>
</tr>
</table>
</div>
...
<p>A function stored in a variable can be used like any other value:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
function myFunction(a, b) {<br>&nbsp; return a * b;<br>}<br><br>
let x = myFunction(4, 3);</div>
...
<p>Functions can also be defined with the JavaScript <b>Function() constructor</b>, but this is rarely used.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const myFunction = new Function(&quot;a&quot;, &quot;b&quot;, &quot;return a * b&quot;);<br><br>
let x = myFunction(4, 3);</div>
...
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const myFunction = function (a, b) {return a * b};<br><br>
let x = myFunction(4, 3);</div>
...
<p>Most of the time, you can avoid using the <b>new</b> keyword in JavaScript.</p>
</div>

<hr>
<h2>Functions are Objects</h2>
<p>The <code class="w3-codespan">typeof</code> operator in JavaScript returns <b>function</b> for 
functions.</p>
<p>But, JavaScript functions can best be described as <b>objects</b>.</p>
<p>JavaScript functions have both <strong>properties</strong> and <strong>
methods</strong>.</p>
<p>The <code class="w3-codespan">arguments.length</code> property returns the <b>number of arguments</b> received
by the function:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
function multiply(a, b) {<br>&nbsp;&nbsp;return arguments.length;<br>
}<br>
<br>
// Returns 0<br>
multiply();<br>
...
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
function multiply(a, b) {<br>&nbsp; return a * b;<br>}<br><br>let text = multiply.toString();</div>
