...
<a class="w3-right w3-btn" href="js_function_this.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
<h2><i>"I will call back later!"</i></h2>
<p>A JavaScript callback is a function passed as an argument to another function, 
which is then executed (or "called back") at a later point in time to complete a specific task.</p>
...
<p>A <b>callback function</b> is intended to be <b>executed later</b>.</p>
<p>Later is typically when a specific event occurs or an asynchronous operation completes.</p>

<div class="ws-note">

<p>The name "callback" stems from the idea that the outer function will "call you back"
...
<li><h3><b>Asynchronous Callbacks</b></h3>
<p>Asynchronous callbacks are executed at a later time, allowing the main program to continue running without waiting.</p>
<p>This is essential for preventing the application from freezing during long-running tasks like network requests.</p></li>
<li><h3><b>Synchronous Callbacks</b></h3>
<p>Synchronous Callbacks are executed immediately within the outer function, blocking further operations
until completion.</p>
<p>Array methods like map(), filter(), and forEach() use synchronous callbacks.</p></li>
</ul>

<hr>
<h2>Event Handling</h2>
<p>Callbacks are often used in JavaScript, especially in event handling.</p> 
...
<p><b>Right:</b> displayDate</p>
<p><b>Wrong:</b> displayDate()</p>
</div>
...
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_callback5">Try it Yourself &raquo;</a>
</p>
</div>
...
<h2>Array Methods</h2>
<p>Many built-in array methods like map(), filter(), and forEach() accept callback functions to define
the action performed on each element.</p>
...
<hr>
<h2>Callback Key Concepts</h2>
<ul class="w3-ul w3-border">
<li><h4><b>Function as an Argument</b></h4>
<p>Because functions in JavaScript can be treated like any other
variable or object, you can pass them as arguments to other functions.</p></li>
<li><h4><b>Deferred Execution</b></h4>
<p>The key benefit of a callback is that it allows for deferred execution,
meaning the callback function does not run immediately.</p>
<p>Instead, it runs later, after a specific condition is met, an event occurs, or an asynchronous operation completes.
<p>This mechanism ensures that the program can continue to execute other code while waiting for
long-running tasks (like fetching data from a server, reading a file, or waiting for a user click) to complete</p>.</li>
