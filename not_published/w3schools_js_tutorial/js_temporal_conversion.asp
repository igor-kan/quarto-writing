...
<html lang="en-US">
<head>
<title>JavaScript Temporal Conversion</title>
<meta charset="utf-8">
...
<h1>JavaScript Temporal Conversion</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_temporal_compare.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_temporal_formats.asp">Next &#10095;</a>
</div>
...
<tr><td>Date</td><td>Instant</td><td><i>date</i>.toTemporalInstant()</td></tr>
<tr><td>&nbsp;</td><td></td><td></td></tr>

<tr><td>PlainDate</td><td>PlainTime</td><td>None</td></tr>
<tr><td>PlainDate</td><td>PlainDateTime</td><td><i>date</i>.toPlainDateTime()</td></tr>
<tr><td>PlainDate</td><td>ZonedTime</td><td>None</td></tr>
<tr><td>PlainDate</td><td>Instant</td><td>None</td></tr>
<tr><td>&nbsp;</td><td></td><td></td></tr>
<tr><td>PlainYearMonth</td><td>PlainDate</td><td><i>yearmonth</i>.toPlainDate()</td></tr>
<tr><td>PlainMonthDay</td><td>PlainDate</td><td><i>monthday</i>.toPlainDate()</td></tr>
<tr><td>&nbsp;</td><td></td><td></td></tr>
<tr><td>PlainDateTime</td><td>PlainDate</td><td><i>datetime</i>.toPlainDate()</td></tr>
<tr><td>PlainDateTime</td><td>PlainTime</td><td><i>datetime</i>.toPlainTime()</td></tr>
<tr><td>PlainDateTime</td><td>ZonedDateTime</td><td><i>datetime</i>.toZonedDateTime()</td></tr>
<tr><td>PlainDateTime</td><td>Instant</td><td>None</td></tr>
<tr><td>&nbsp;</td><td></td><td></td></tr>
<tr><td>ZonedDateTime</td><td>PlainDate</td><td><i>zoned</i>.toPlainDate()</td></tr>
<tr><td>ZonedDateTime</td><td>PlainDateTime</td><td><i>zoned</i>.toPlainDateTime()</td></tr>
<tr><td>ZonedDateTime</td><td>PlainTime</td><td><i>zoned</i>.toPlainTime()</td></tr>
<tr><td>ZonedDateTime</td><td>Instant</td><td><i>zoned</i>.toInstant()</td></tr>
<tr><td>&nbsp;</td><td></td><td></td></tr>
<tr><td>Instant</td><td>ZonedDateTime</td><td><i>zoned</i>.toZonedDateTimeISO()</td></tr>
</table>
</div>

<hr>
<h2>Legacy Date to Temporal Instant</h2>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const legacyDate = new Date();<br>
<br>
const instant = legacyDate.toTemporalInstant();
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_date_to_temporal" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>PlainDate to PlainDateTime</h2>
<p>You might like to add a time.</p>
<div class="w3-example">
<h3>Examples</h3>
<div class="w3-code notranslate jsHigh">
const date = Temporal.PlainDate.from("2026-05-17");<br>
<br>
const dateTime = date.toPlainDateTime();<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plaindate_to_plaindatetime" target="_blank">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
const date = Temporal.PlainDate.from("2026-05-17");<br>
<br>
const dateTime = date.toPlainDateTime("14:30");<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plaindate_to_plaindatetime_2" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Combine Date and Time</h2>
<p>You can combine <b>PlainDate</b> and PlainTime to create a PlainDateTime object.</p>
...
const date = Temporal.PlainDate.from("2026-05-17");<br>
<br>
// Create a PlainTime object<br>
<br>
const time = Temporal.PlainTime.from("14:30");<br>
<br>
// Convert into a PlainDateTime object<br>
const dateTime = date.toPlainDateTime(time);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plaindatetime_1" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>PlainDateTime to PlainDate</h2>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const dateTime = Temporal.PlainDateTime.from("2026-05-17T14:30");<br>
<br>
const date = dateTime.toPlainDate();<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plaindatetime_to_plaindate" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>PlainDateTime to PlainTime</h2>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const dateTime = Temporal.PlainDateTime.from("2026-05-17T14:30");<br>
<br>
const time = dateTime.toPlainTime();<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plaindatetime_to_plaintime" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>PlainDateTime to ZonedDateTime</h2>
<p><b>PlainDateTime</b> does not contain a time zone.</p>
<p>You must provide one to create a ZonedDateTime.</p>
...
const dateTime = Temporal.PlainDateTime.from("2026-05-17T14:30");<br>
<br>
const zoned = dateTime.toZonedDateTime();<br>
</div>
<h3>Correct</h3>
<div class="w3-code notranslate jsHigh">
const dateTime = Temporal.PlainDateTime.from("2026-05-17T14:30");<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plaindatetime_to_zoneddatetime" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>ZonedDateTime to PlainDateTime</h2>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const zoned = Temporal.ZonedDateTime.from("2026-05-17T14:30:00+02:00[Europe/Oslo]");<br>
<br>
const dateTime = zoned.toPlainDateTime();<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_zoneddatetime_to_plaindatetime" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>ZonedDateTime to PlainDate</h2>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const zoned = Temporal.ZonedDateTime.from("2026-05-17T14:30:00+02:00[Europe/Oslo]");<br>
<br>
const date = zoned.toPlainDate();<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_zoneddatetime_to_plaindate" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>ZonedDateTime to PlainTime</h2>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const zoned = Temporal.ZonedDateTime.from("2026-05-17T14:30:00+02:00[Europe/Oslo]");<br>
<br>
const time = zoned.toPlainTime();<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_zoneddatetime_to_plaintime" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>ZonedDateTime to Instant</h2>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const zoned = Temporal.ZonedDateTime.from("2026-05-17T14:30:00+02:00[Europe/Oslo]");<br>
<br>
const instant = zoned.toInstant();<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_zoneddatetime_to_instant" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Instant to ZonedDateTime</h2>
<p><b>Instant</b> does not have a toZonedDateTime() method.</p>
<p>You must convert it to a ISO zone first.</p>
<div class="w3-example">
<h3>Wrong</h3>
<div class="w3-code notranslate jsHigh">
const instant = Temporal.Instant.from("2026-05-17T12:30:00Z");<br>
<br>
const zoned = instant.toZonedDateTime("Europe/Oslo");<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_instant_to_zoneddatetime" target="_blank">Try it Yourself &raquo;</a>
<h3>Correct</h3>
<div class="w3-code notranslate jsHigh">
const instant = Temporal.Instant.from("2026-05-17T12:30:00Z");<br>
<br>
...
<th>From</th>
<th>toPlainDate()</th>
<th>toPlainDateTime()</th>
<th>toZonedDateTime()</th>
</tr>
<tr>
<td>PlainYearMonth</td>
<td>YES<br>+ day value</td>
<td>No</td>
<td>No</td>
</tr>
<tr>
<td>PlainMonthDay</td>
<td>YES<br>+ year value</td>
<td>No</td>
<td>No</td>
</tr>
</table>
...
<div class="ws-note">
<p><b>PlainMonthDay</b> and <b>PlainYearMonth</b> need missing parts before becoming a full date.</p>
</div>

<hr>
<h2>PlainYearMonth to PlainDate</h2>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<hr>
<h2>PlainMonthDay to PlainDate</h2>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const monthDay = new Temporal.PlainYearMonth(2026, 5);<br>
<br>
const date = monthDay.toPlainDate({ year: 2026 });
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plainmonthday_to_plaindate" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Time Zone Conversion</h2>
<p>Converting time from another time zone is handled
by the ZonedDateTime method withTimeZone().</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const zdtOslo = Temporal.Now.zonedDateTimeISO('Europe/Oslo');<br>
<br>
const zdtTokyo = zdtOslo.withTimeZone('Asia/Tokyo');
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_zone_to_zone" target="_blank">Try it Yourself &raquo;</a>
</div>
