...
<html lang="en-US">
<head>
<title>JavaScript Object Protection</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="js_object_management.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_object_prototypes.asp">Next &#10095;</a>
</div>
<hr>
<h2>Object Protection Methods</h2>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// Prevents re-assignment<br>
const car = {type:"Fiat", model:"500", color:"white"};
<br><br>
// Prevents adding object properties<br>
...
// Prevents adding and deleting object properties<br>
...
<hr>
<h2>Using const</h2>
<p>The most common way to protect an object from being changed
is by using the <code class="w3-codespan">const</code> keyword.</p>
<p>With <code class="w3-codespan">const</code> you <b>cannot</b> re-assign the object,
but you <b>can</b> change the value of a property, delete a property or create a new property.</p>


<hr>
<!--start-->
<h2>JavaScript Object.preventExtensions()</h2>
<p>The <code class="w3-codespan">Object.preventExtensions()</code> method prevents adding properties to an object.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create Object<br>
...
<br>
// Prevent Extensions<br>
Object.preventExtensions(person);<br>
<br>
// This will throw an error<br>
person.nationality = "English";
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_object_preventextensions" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>Since arrays are objects, arrays can be prevented from extensions too:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create Array<br>
const fruits = [&quot;Banana&quot;, &quot;Orange&quot;, &quot;Apple&quot;, &quot;Mango&quot;];<br>
Object.preventExtensions(fruits);<br>
<br>
// This will throw an error:<br>
fruits.push("Kiwi");
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_object_preventextensions2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="ws-note">

<p>The <code class="w3-codespan">Object.preventExtensions()</code> method will fail silently in non-strict mode and throw a TypeError in strict mode.</p>
</div>

<!--stop-->
<hr>
<!--start-->
<h2>JavaScript Object.isExtensible()</h2>
<p>You can use <code class="w3-codespan">Object.isExtensible()</code> to check if an object is extensible.</p>
<p>The <code class="w3-codespan">Object.isExtensible()</code> returns true if an object is extensible.</p>
<div class="w3-example">
<h3>Examples</h3>
<div class="w3-code notranslate jsHigh">
// Create Object<br>
...
Object.preventExtensions(person);<br>
<br>
// This will return false<br>
let answer = Object.isExtensible(person);
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_object_isextensible" class="w3-btn">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
// Create Array<br>
const fruits = [&quot;Banana&quot;, &quot;Orange&quot;, &quot;Apple&quot;, &quot;Mango&quot;];<br>
<br>
...
<a target="_blank" href="tryit.asp?filename=tryjs_object_isextensible2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
...
<hr>
<!--start-->
<h2>JavaScript Object.seal()</h2>
<p>The <code class="w3-codespan">Object.seal()</code> method prevents additions or deletions of new properties.</p>
<p>The <code class="w3-codespan">Object.seal()</code> method makes existing properties non-configurable.</p>
<p>The <code class="w3-codespan">Object.isSealed()</code> method can be used to check if an object is sealed.</p>
...
<a target="_blank" href="tryit.asp?filename=tryjs_object_seal2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>Since arrays are objects, arrays can be sealed too:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create Array<br>
const fruits = [&quot;Banana&quot;, &quot;Orange&quot;, &quot;Apple&quot;, &quot;Mango&quot;];<br>
Object.seal(fruits);<br>
<br>
// This will throw an error:<br>
fruits.push("Kiwi");
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_object_seal" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="ws-note">

<p>The <code class="w3-codespan">Object.seal()</code> method will fail silently in non-strict mode and throw a TypeError in strict mode.</p>
</div>

<!--stop-->
<hr>
<!--start-->
<h2>JavaScript Object.isSealed()</h2>
<p>The <code class="w3-codespan">Object.isSealed()</code> method can be used to check if an object is sealed.</p>
<p>The <code class="w3-codespan">Object.isSealed()</code> returns true if an object is sealed.</p>
...
<a target="_blank" href="tryit.asp?filename=tryjs_object_issealed" class="w3-btn">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
// Create Array<br>
const fruits = [&quot;Banana&quot;, &quot;Orange&quot;, &quot;Apple&quot;, &quot;Mango&quot;];<br>
<br>
...
<a target="_blank" href="tryit.asp?filename=tryjs_object_issealed2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>JavaScript Object.freeze()</h2>
<p>The <code class="w3-codespan">Object.freeze()</code> method prevents any changes to an object.</p>
<p>Frozen objects are read-only.</p>
<p>No modification, addition or deletion of properties are allowed.</p>
...
<a target="_blank" href="tryit.asp?filename=tryjs_object_freeze2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p>Since arrays are objects, arrays can be frozen too:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const fruits = [&quot;Banana&quot;, &quot;Orange&quot;, &quot;Apple&quot;, &quot;Mango&quot;];<br>
Object.freeze(fruits);<br>
<br>
// This will trow an error:<br>
fruits.push("Kiwi");
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_object_freeze" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="ws-note">

<p>The <code class="w3-codespan">Object.freeze()</code> method will fail silently in non-strict mode and throw a TypeError in strict mode.</p>
</div>

<!--stop-->
<hr>
<!--start-->
<h2>JavaScript Object.isFrozen()</h2>
<p>The <code class="w3-codespan">Object.isFrozen()</code> method can be used to check if an object is frozen.</p>
<p>The <code class="w3-codespan">Object.isFrozen()</code> returns true if an object is frozen.</p>
...
<a target="_blank" href="tryit.asp?filename=tryjs_object_isfrozen" class="w3-btn">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
// Create Array<br>
const fruits = [&quot;Banana&quot;, &quot;Orange&quot;, &quot;Apple&quot;, &quot;Mango&quot;];<br>
Object.freeze(fruits);<br>
...
<a target="_blank" href="tryit.asp?filename=tryjs_object_isfrozen2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<div class="ws-note">
<h2>Advanced Chapters:</h2>
<p class="w3-large"><a href="js_object_definition.asp">JavaScript Object Definitions</a></p>
<p class="w3-large"><a href="js_this.asp">JavaScript Object Advanced this</a></p>
<p class="w3-large"><a href="js_object_methods.asp">JavaScript Object Iterations</a></p>
<p class="w3-large"><a href="js_object_accessors.asp">JavaScript Object Getters &amp; Setters</a></p>
<p class="w3-large"><a href="js_object_management.asp">JavaScript Object Management</a></p>
<p class="w3-large"><a href="js_object_protection.asp">JavaScript Object Protection</a></p>
<p class="w3-large"><a href="js_object_prototypes.asp">JavaScript Object Prototypes</a></p>
<p class="w3-large"><a href="js_object_reference.asp">JavaScript Object Reference</a></p>
</div>
