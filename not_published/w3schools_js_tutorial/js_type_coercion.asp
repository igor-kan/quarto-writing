...
<a class="w3-left w3-btn" href="js_tolocalestring.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_type_conversion.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
<h2>Type Coercion</h2>
<p><b>Type coercion</b> is the <b>automatic conversion</b> of values from one data type to another.</p>
<p><b>Type coercion</b> happens when you perform an operation on different data types,
and the JavaScript engine tries to make them "fit" together.</p>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>JavaScript coerces types differently per operator, so type coercion can hide bugs.</p>
<p>Program continues according to the coercion rules, but these may differ from what the programmer wanted to achieve.</p>
...
<p><b>Coercion is implicit</b> (handled automatically by the engine), while <b>type conversion</b>
is explicit (you manually use functions like Number() or String()).</p>
...
<p>If any part of a + operation is a string, JavaScript converts everything to strings and concatenates them.</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
let x = "5" + 2 // x = "52"
</div>
...
<p>Values are coerced to booleans in logical contexts like if statements or using the double-NOT operator (!!).</p>
<p>Falsy values: 0, "", null, undefined, NaN, and false.</p>
<p>Truthy values: Everything else (including empty objects {} and arrays []).</p>
<hr>
...
<hr>
<h2>Best Practices to Avoid Bugs</h2>
<p><b>Use === (Strict Equality)</b>: This checks both value and type without coercion, preventing weird results.</p>
<p><b>Be Explicit</b>: Instead of relying on automatic behavior, use MDN's recommended conversion methods
like Number() or String() to make your intent clear.</p>
<p><b>Watch for NaN</b>
<p>If a string cannot be converted to a valid number, like "abc" - 1), the result is NaN (Not-a-Number).</p>
