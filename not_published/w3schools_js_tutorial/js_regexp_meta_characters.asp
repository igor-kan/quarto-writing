...
<html lang="en-US">
<head>
<title>JavaScript RegExp Meta Characters</title>
<meta charset="utf-8">
...
<h1>RegExp Meta Characters</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_regexp_characters.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_regexp_assertions.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
<h2>Regular Expression Metacharacters</h2>
<p><strong>Metacharacters</strong> are characters with a special meaning.</p>
<p>They can be used to match digts, words, spaces, and more:</p>
...
<h2>JavaScript Regex Metacharacters</h2>
...
<tr><td>\D</td><td>Matches None Digits</td></tr>
<tr><td>\w</td><td>Matches alphanumeric Word characters</td></tr>
<tr><td>\W</td><td>Matches None alphanumeric Word characters</td></tr>
<tr><td>\s</td><td>Matches Spaces</td></tr>
<tr><td>\S</td><td>Matches None Spaces</td></tr>
<tr><td>\ddd</td><td>Matches characters by the Octal numer ddd</td></tr>
<tr><td>\xhh</td><td>Matches characters by the HexadecimaL number hh</td></tr>
<tr><td>\uhhhh</td><td>Matches Unicode characters by the hex number hhhh</td></tr>
</table>
</div>
...
<p>The \D metacharacter matches non-digit characters.</p>
<div class="w3-example">
<h3>Example</h3>
<p>A global search for non-digit characters:</p>
<div class="w3-code notranslate jsHigh">
let text = &quot;Give 100%!&quot;;<br>
const pattern = /\D/g;<br>
<br>
...
<a target="_blank" href="tryit.asp?filename=tryjs_regexp_nondigit" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<hr>
<h1>RegExp \W Metacharacter</h1>
<p>The \W metacharacter matches non-word characters.</p>
<p>A word character is a character a-z, A-Z, 0-9, including _ (underscore).</p>
<div class="w3-example">
<h3>Example</h3>
...
<a target="_blank" href="tryit.asp?filename=tryjs_regexp_nonwordchar" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>The \s (space) Metacharacter</h2>
<p>The \s metacharacter matches whitespace characters like space, tab, and newline.</p>
<div class="w3-example">
<h3>Example</h3>
<p>A global search for whitespace characters in a string:</p>
<div class="w3-code notranslate jsHigh">
let text = "Is this all there is?";<br>
const pattern = /\s/g;<br>
<br>
let result = text.match(pattern);
</div>
<p>
<a class="w3-btn" href="tryit.asp?filename=tryjs_regexp_s" target="_blank">Try it Yourself &raquo;</a></p>
</div>

<hr>
<h2>RegExp \xhh (hexadecimal)</h2>
<p>\xhh matches characters by the hexadecimal number hh.</p>
<div class="w3-example">
<p>A global replace of the hexadecimal character 6F (o) in a string:</p>
<div class="w3-code notranslate jsHigh">
let text = &quot;Visit W3Schools. Hello World!&quot;;<br>
let pattern = /\x6F/g;<br>
<br>
let result = text.replace(pattern, "*");
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_regexp_hex" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>RegExp \uhhhh (unicode hex)</h2>
<p>\uhhhh matches a Unicode character by the hex number hhhh.</p>
<div class="w3-example">
<h3>Example</h3>
<p>A global search for a Unicode character with the hexadecimal code 0057 (W):</p>
<div class="w3-code notranslate jsHigh">
let text = "Visit W3Schools. Hello World!";<br>
const pattern = /\u0057/g;<br>
<br> 
...
<p>
<a class="w3-btn" href="tryit.asp?filename=tryjs_regexp_ux" target="_blank">Try it Yourself &raquo;</a></p>
</div>
<!--stop-->
<hr>
