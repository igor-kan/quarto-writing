...
<h1>JavaScript Browser Objects</span> Examples</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_events_examples.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_editor.asp">Next &#10095;</a>
</div>
<hr>
...
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="tryit.asp?filename=tryjs_openwindow">Open a new window when clicking on a button</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_openallwindow">Open a new window and control its appearance</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_win_blur">Blur and Focus a new window</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_win_close">Close the new window</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_win_closed">Checks whether the new window has been closed or not</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_win_opener">Write some text to the source (parent) window</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_win_moveby">Move the new window relative to its current position</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_win_moveto">Move the new window to the specified position</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_print">Print the current page</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_dom_window_resizeby">Resize a window by the specified pixels</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_dom_window_resizeto">Resize a window to a specified size</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_dom_window_scrollby">Scroll the content by the specified number of pixels</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_dom_window_scrollto">Scroll the content to a specified position</a>
</div>
<p><a href="js_window.asp" class="ws-btn">Window explained</a></p>
<hr>

<h2>Screen Object</h2>
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="tryit.asp?filename=tryjs_screen_width">The visitor's screen: Width</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_screen_height">The visitor's screen: Height</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_screen_availwidth">The visitor's screen: Available Width</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_screen_availheight">The visitor's screen: Available Height</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_screen_colordepth">The visitor's screen: Color Depth</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_screen_pixeldepth">The visitor's screen: Pixel Depth</a>
</div>
<p><a href="js_window_screen.asp" class="ws-btn">Screen explained</a></p>
<hr>

<h2>Location Object</h2>
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="tryit.asp?filename=tryjs_loc_host">Return the hostname and port of the current URL</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_loc_href">Return the entire URL of the current page</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_loc_pathname">Return the path name of the current URL</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_loc_protocol">Return the protocol portion of the current URL</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_loc_assign">Load a new document</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_loc_replace">Replace the current document</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_breakout">Break out of a frame</a>
</div>
<p><a href="js_window_location.asp" class="ws-btn">Location explained</a></p>
<hr>
...
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="tryit.asp?filename=tryjs_history_length">Display the number of URLs in the history list</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_history_back">Create a back button on a page</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_history_forward">Create a forward button on a page</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_history_go">Load a specific URL from the history list</a>
</div>
<p><a href="js_window_history.asp" class="ws-btn">History explained</a></p>
<hr>

<h2>Navigator Object</h2>
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="tryit.asp?filename=tryjs_nav_cookieenabled">Is cookies enabled in the visitor's browser?</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_nav_appcodename">What is the name of the visitor's browser?</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_nav_product">What is the engine name of the visitor's browser?</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_nav_appversion">What is the version information of the visitor's browser?</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_nav_useragent">What is user agent information of the visitor's browser?</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_nav_platform">What is the platform of the visitor's browser?</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_nav_language">What is the language of the visitor's browser?</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_nav_javaenabled">Is Java enabled in the visitor's browser?</a>
</div>
<p><a href="js_window_navigator.asp" class="ws-btn">Navigator explained</a></p>
<hr>

<h2>Popup Boxes</h2>
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="tryit.asp?filename=tryjs_alert">Display an alert box</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_alert2">Demonstrate line breaks in an alert box</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_confirm">Display a confirm box</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_prompt">Display a prompt box</a>
</div>
<p><a href="js_popup.asp" class="ws-btn">Popup explained</a></p>
<hr>

<h2>Timing</h2>
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="tryit.asp?filename=tryjs_timing1">Simple timing</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_timing2">Another simple timing</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_timing_infinite">Timing event in an infinite loop</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_timing_stop">Timing event in an infinite loop - with a Stop button</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_timing_clock">A clock created with a timing event</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_setinterval">Set and stop a timer with setInterval() and clearInterval()</a>
</div>
<p><a href="js_timing.asp" class="ws-btn">Timing explained</a></p>
<hr>

<h2>Cookies</h2>
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="tryit.asp?filename=tryjs_cookie_username">Create a welcome cookie</a>
<p><a href="js_cookies.asp" class="ws-btn">Cookies explained</a>
</div>
<br>
<br>
<div class="w3-clear nextprev">
