...
<html lang="en-US">
<head>
<title>JavaScript Event Management</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="js_events_timing.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_htmldom_events.asp">Next &#10095;</a>
</div>

<!--start-->
<div class="ws-info">
<p class="w3-large"><b>Event Management</b> is about adding, removing, and controlling events.</p>
</div>
...
<br>
// Let btn listen for click<br>
btn.addEventListener("click", myFunction);<br>
<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_events_add" target="_blank">Try it Yourself &raquo;</a>
</div>
...
&lt;button id="test"&gt;Test click&lt;/button&gt;<br>
<br>
&lt;p id="demo"&gt;&lt;/p&gt;<br>
<br>
&lt;script&gt;<br>
const test = document.getElementById("test");<br>
const remove = document.getElementById("remove");<br>
const add = document.getElementById("add");<br>
<br>
function myFunction() {<br>
&nbsp;&nbsp;  document.getElementById("demo").innerHTML += "Hello!";<br>
}<br>
<br>
// Let add listen for click<br>
add.addEventListener("click", function () {<br>
&nbsp;&nbsp;// Let test listen for click<br>
&nbsp;&nbsp;test.addEventListener("click", myFunction);<br>
});<br>
<br>
// Let remove listen for click<br>
remove.addEventListener("click", function () {<br>
&nbsp;&nbsp;// Prevent test from listen for click<br>
&nbsp;&nbsp;test.removeEventListener("click", myFunction);<br>
});<br>
&lt;/script&gt;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_events_remove" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<div class="ws-note">

<p>To remove an event listener, you must use the <b>same named function</b> you used to add it.</p>
</div>
...
<div class="w3-example">
<h3>Example</h3>
<p>Prevent default (block a link)</p>
<div class="w3-code notranslate htmlHigh">
&lt;a href="https://www.w3schools.com" id="link"&gt;Go to W3Schools&lt;/a&gt;<br>
<br>
&lt;p id="demo"&gt;&lt;/p&gt;<br>
<br>
&lt;script&gt;<br>
...
<br>
// Let link listen for click<br>
link.addEventListener("click", function (event) {<br>
&nbsp;&nbsp;event.preventDefault();<br>
&nbsp;&nbsp;document.getElementById("demo").innerHTML = "Link blocked!";<br>
});<br>
&lt;/script&gt;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_events_block" target="_blank">Try it Yourself &raquo;</a>
</div>
