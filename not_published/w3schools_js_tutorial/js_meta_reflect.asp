...
<html lang="en-US">
<head>
<title>JavaScript Reflect Object</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="js_meta_programming.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_meta_proxy.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
...
<p><b>Reflect</b> was added to JavaScript in <a href="js_es6.asp">ES6 (2015).</a></p>
</div>
...
<a target="_blank" href="tryit.asp?filename=tryjs_reflect_delete" class="w3-btn">Try it Yourself &raquo;</a>
<p>Same as using the <b>delete</b> operator:</p>
<div class="w3-code notranslate jsHigh">
delete person.name;
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_reflect_delete_x" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<br>
let age = Reflect.get(user, "age");<br>
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_reflect_get" class="w3-btn">Try it Yourself &raquo;</a>
<p>Same as:</p>
<div class="w3-code notranslate jsHigh">
let age = user.age;
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_reflect_get_x" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
...
const user = {name: "Jan", age: 40};<br>
<br>
Reflect.set(user, "age", 41);<br>
<br>
let age = Reflect.set(user, "age");<br>
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_reflect_set" class="w3-btn">Try it Yourself &raquo;</a>
<p>Same as:</p>
<div class="w3-code notranslate jsHigh">
user.age = 41;
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_reflect_set_x" class="w3-btn">Try it Yourself &raquo;</a>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
function greet(message) {<br>
&nbsp; return message + ", " + this.name;<br>
}<br>
<br>
const person = {name: "Jan"};<br>
<br>
let msg =  Reflect.apply(greet, person, ["Hello"]);<br>
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_reflect_apply" class="w3-btn">Try it Yourself &raquo;</a>
<p>Same as using <b>greet.apply()</b>:</p>
<div class="w3-code notranslate jsHigh">
let msg = greet.apply(person, ["Hello"]);
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_reflect_apply_x" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
...
<a target="_blank" href="tryit.asp?filename=tryjs_reflect_construct" class="w3-btn">Try it Yourself &raquo;</a>
<p>Same as the <b>new</b> keyword:</p>
<div class="w3-code notranslate jsHigh">
// Create a new Array<br>
const colors = new Array(["red", "green", "blue"]));
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_reflect_construct_x" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<br>
// Add a Property<br>
Reflect.defineProperty(user, "id", {<br>
&nbsp; value: 123,<br>
&nbsp; writable: false<br>
});<br>
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_reflect_defineproperty" class="w3-btn">Try it Yourself &raquo;</a>
<p>Same as using <b>Object.defineProperty()</b>:</p>
<div class="w3-code notranslate jsHigh">
// Add a Property<br>
Object.defineProperty(user, "id", {<br>
&nbsp; value: 123,<br>
&nbsp; writable: false<br>
});
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_reflect_defineproperty_x" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
...
<li><code class="w3-codespan">Reflect.defineProperty()</code> returns <code class="w3-codespan">true</code>
or <code class="w3-codespan">false</code></ul>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const sym = Symbol("secret");<br>
const obj = { a: 1, [sym]: 2 };<br>
<br>
let keys = Reflect.ownKeys(obj);
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_reflect_ownkeys" class="w3-btn">Try it Yourself &raquo;</a>
<p>Almost the same as using <b>Object.keys()</b>:</p>
<div class="w3-code notranslate jsHigh">
let keys = Object.keys(obj);
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_reflect_ownkeys_x" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let answer = Reflect.isExtensible(obj);<br>
</div>
<p>The same as using <b>Object.isExtensible()</b>:</p>
<div class="w3-code notranslate jsHigh">
let answer = Object.isExtensible(obj);<br>
</div>
</div>
...
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
Reflect.isExtensible(1); // TypeError<br>
Object.isExtensible(1);&nbsp; // false (does not throw)<br>
</div>
</div>
...
&nbsp;&nbsp;&nbsp;&nbsp;log(property + ": " + value);<br>
&nbsp;&nbsp;&nbsp;&nbsp;// safe forwarding<br>
&nbsp;&nbsp;&nbsp;&nbsp;return Reflect.set(target, property, value);<br>
&nbsp;&nbsp;}<br>
});<br>
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_reflect_proxy" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="ws-note">
...
<p>The idea of Proxy was developed during the <a href="js_es6.asp">ES6 (2015)</a> design phase before Reflect existed.</p>
...
<p>So <a href="js_es6.asp">ES6 (2015)</a> introduced Reflect to:</p>
<ul>
...
<p class="w3-large"><a href="js_meta_reference.asp">JavaScript Meta Reference</a>
</div>
