...
<a class="w3-left w3-btn" href="js_object_this.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_object_constructor.asp">Next &#10095;</a>
</div>
...
<hr>
<h2>Why do I See [object Object]?</h2>
<p><b>[Object Object]</b> appears when you try to put an object (a data structure with properties)
into a context where <b>a string is expected</b>.</p>
<p><b>[Object Object]</b> how JavaScript deals with this situation.</p>
<p>Some solutions to display JavaScript objects are:
<ul>
...
<p>The properties of an object can be added in a string:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create an Object<br>
...
<p><b>person.x</b> will not work (Because <b>x</b> is the loop variable).</p>
</div>
...
<p><code class="w3-codespan">Object.values()</code> creates an array from the property values:</p>
...
<br>
// Stringify the Array<br>
let text = myArray.toString();
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_object_values2" target="_blank">Try it Yourself &raquo;</a>
</div>

<!--stop-->
<hr>
<!--start-->
<h2>Using Object.entries()</h2>
...
<p>JavaScript objects can be converted to a string with JSON method
<code class="w3-codespan">JSON.stringify()</code>.</p>
<p><code class="w3-codespan">JSON.stringify()</code> is included in JavaScript and supported in all browsers.</p>

<div class="w3-panel ws-note">
<p>The result will be a string written in JSON notation:</p>
...
<br>
// Stringify Object<br>
let text = JSON.stringify(person);<br>
</div>
...
<hr>
<div id="exercisecontainer" src="xrcise_object_display.js"></div>
<hr>
