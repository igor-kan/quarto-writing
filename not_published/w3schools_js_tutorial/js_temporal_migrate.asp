...
<html lang="en-US">
<head>
<title>Migrate from JavaScript Date to Temporal</title>
<meta charset="utf-8">
...
<h1>Migrate from Date to Temporal</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_temporal_mistakes.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_temporal_standards.asp">Next &#10095;</a>
</div>
<div class="ws-info">
<h2>HowTo Replace Date</h2>
<p>JavaScript Temporal was designed to <b>replace the old Date object</b>.</p>
<p>For new JavaScript projects, <b>Temporal is the modern choice</b>.</p>
<p>Temporal provides <b>safer and clearer</b> alternatives to Date patterns.</p>
<p>Temporal handles time zones correctly.</p>
<p>Temporal <b>avoids mutation</b> and <b>simplifies date math</b>.</p>
<p>This chapter shows <b>how to migrate</b> from Date code to modern Temporal code.</p>
</div>

<h2>Replace new Date()</h2>
<p>With Date, you create a date like this:</p>
...
<p>With Temporal, choose the type you need.</p>
<div class="w3-example">
...
<p>Use <code class="w3-codespan">PlainDate</code> if you only need a date.</p>
<div class="w3-example">
<h3>Temporal Date Only</h3>
<div class="w3-code notranslate jsHigh">
...
<hr>
<h2>Replace Date.now()</h2>
<p>Date provides timestamps in milliseconds.</p>
<div class="w3-example">
<h3>Date Example</h3>
<div class="w3-code notranslate jsHigh">
...
<p>With Temporal, use <code class="w3-codespan">Instant</code>.</p>
<div class="w3-example">
<h3>Temporal Example</h3>
<div class="w3-code notranslate jsHigh">
const now = Temporal.Now.instant();<br>
const timestamp = instant.epochMilliseconds);
</div>
</div>

<hr>
<h2>Replace getFullYear(), getMonth(), getDate()</h2>
<p>Date uses getter methods.</p>
<div class="w3-example">
<h3>Date Example</h3>
<div class="w3-code notranslate jsHigh">
const d = new Date();<br>
<br>
let year = d.getFullYear();<br>
let month = d.getMonth();<br>
let day = d.getDate();<br>
</div>
</div>

<p>Temporal exposes properties directly.</p>
<div class="w3-example">
<h3>Temporal Example</h3>
<div class="w3-code notranslate jsHigh">
const date = Temporal.Now.plainDateISO();<br>
<br>
let year = date.year;<br>
let month = date.month;<br>
let day = date.day;<br>
</div>
</div>
...
<p>Months start at 1, not 0.</p>
</div>

<hr>
<h2>Replace setDate() and Other Mutating Methods</h2>
<p>Date changes the original object.</p>
<div class="w3-example">
<h3>Date Example</h3>
<div class="w3-code notranslate jsHigh">
const d = new Date("2026-05-17");<br>
<br>
d.setDate(d.getDate() + 7);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_date_sideffects" target="_blank">
Try it Yourself &raquo;</a>
</div>

<p>Temporal does not mutate values.</p>
<div class="w3-example">
<h3>Temporal Example</h3>
<div class="w3-code notranslate jsHigh">
const date = Temporal.PlainDate.from("2026-02-17");<br>
<br>
const nextWeek = date.add({ days: 7 });<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_vs_date_9" target="_blank">
Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Replace Date Arithmetic</h2>
<p>Date often requires manual millisecond calculations.</p>
<div class="w3-example">
<h3>Date Example</h3>
<div class="w3-code notranslate jsHigh">
...
<br>
const duration = end - start;<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_vs_date_8" target="_blank">
Try it Yourself &raquo;</a>
</div>

<p>Temporal provides built-in duration calculations.</p>
<div class="w3-example">
<h3>Temporal Example</h3>
<div class="w3-code notranslate jsHigh">
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_until_2" target="_blank">
Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Replace Time Zone Handling</h2>
<p><code class="w3-codespan">Date</code> mixes local time and UTC.</p>
<p>This makes time zone handling confusing.</p>
<div class="w3-example">
<h3>Date Example</h3>
<div class="w3-code notranslate jsHigh">
let d = new Date();<br>
<br>
let time1 = d.toString();<br>
let time2 = d.toUTCString();<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_vs_date_7" target="_blank">
Try it Yourself &raquo;</a>
</div>

<p>Temporal uses <code class="w3-codespan">ZonedDateTime</code> for clear time zone handling.</p>
<div class="w3-example">
<h3>Temporal Example</h3>
<div class="w3-code notranslate jsHigh">
const zoned = Temporal.Now.zonedDateTimeISO();<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_now_zoneddatetime" target="_blank">
Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Convert Date to Temporal</h2>
<p>You can convert an existing Date to a Temporal Instant.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const d = new Date();<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_convert_date" target="_blank">
Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Where to Replace Date with Temporal</h2>
<ul>
  <li><p>Use Temporal for new applications.</p></li>
  <li><p>Use Temporal when time zones matter.</p></li>
  <li><p>Use Temporal when doing date arithmetic.</p></li>
  <li><p>Use Date if you must support older environments.</p></li>
</ul>
