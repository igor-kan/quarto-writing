...
<a class="w3-right w3-btn" href="js_control_flow.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
<h2>The Continue Statement</h2>
<p>The <code class="w3-codespan">continue</code> statement <b>skips the current iteration</b> in a loop.</p>
<p>The remaining code in the iteration is skipped and processing moves to the next iteration.</p>.
</div>
...
<h2>Continue to <i>Labelname</i></h2>


<div class="w3-example">
<h3>Syntax</h3>
<div class="w3-code notranslate">
continue <em>labelname</em>;</div>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Continue to <b>loop1</b>:</p>
<div class="w3-code notranslate jsHigh">
let text = "";<br>
<br>
loop1: for (let j = 1; j &lt; 5; j++) {<br>
&nbsp;&nbsp;loop2: for (let i = 1; i &lt; 5; i++) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (i === 3) { continue loop1; }<br>
&nbsp;&nbsp;&nbsp;&nbsp;text += i;<br>
&nbsp;&nbsp;  }<br>
}
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_continue_label1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
<h3>Example</h3>
<p>Continue to <b>loop2</b>:</p>
<div class="w3-code notranslate jsHigh">
let text = "";<br>
<br>
loop1: for (let j = 1; j &lt; 5; j++) {<br>
&nbsp;&nbsp;loop2: for (let i = 1; i &lt; 5; i++) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (i === 3) { continue <b>loop2</b>; }<br>
&nbsp;&nbsp;&nbsp;&nbsp;text += i;<br>
&nbsp;&nbsp;  }<br>
}
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_continue_label2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
