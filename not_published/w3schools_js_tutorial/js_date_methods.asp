...
<p>In JavaScript, date objects are created with <code class="w3-codespan">new Date()</code>.</p>
<p><code class="w3-codespan">new Date()</code> returns a date object with the current date and time.</p>
...
<tr>
<td>getFullYear()</td>
<td>Get <strong>year</strong> as a four digit number (yyyy)</td>
</tr>
<tr>
<td>getMonth()</td>
<td>Get <strong>month</strong> as a number (0-11)</td>
</tr>
<tr>
<td>getDate()</td>
<td>Get <strong>day</strong> as a number (1-31)</td>
</tr>
<tr>
<td>getDay()</td>
...
<tr>
<td>getHours()</td>
<td>Get <strong>hour</strong> (0-23)</td>
</tr>
<tr>
<td>getMinutes()</td>
<td>Get <strong>minute</strong> (0-59)</td>
</tr>
<tr>
<td>getSeconds()</td>
<td>Get <strong>second</strong> (0-59)</td>
</tr>
<tr>
<td>getMilliseconds()</td>
<td>Get <strong>millisecond</strong> (0-999)</td>
</tr>
<tr>
<td>getTime()</td>
...
<p>The <code class="w3-codespan">getFullYear()</code> method returns the year of a date as a four digit number:</p>

<div class="w3-example">
<h3>Examples</h3>
<div class="w3-code notranslate jsHigh">
const d = new Date("2021-03-25");<br>
d.getFullYear();
</div>
<a class="w3-btn" href="tryit.asp?filename=tryjs_date_getfullyear2" target="_blank">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
const d = new Date();<br>
d.getFullYear();
</div>
...
<p>The <code class="w3-codespan">getMonth()</code> method returns the month of a date as a number (0-11).</p>
...
<a class="w3-btn" href="tryit.asp?filename=tryjs_date_getmonth2" target="_blank">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
const d = new Date();<br>
d.getMonth();
</div>
...
<a class="w3-btn" href="tryit.asp?filename=tryjs_date_month2" target="_blank">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
const months = [&quot;January&quot;, &quot;February&quot;, &quot;March&quot;, &quot;April&quot;, &quot;May&quot;,
&quot;June&quot;, &quot;July&quot;, &quot;August&quot;, &quot;September&quot;, &quot;October&quot;,
&quot;November&quot;, &quot;December&quot;];<br>
...
<p>The <code class="w3-codespan">getDate()</code> method returns the day of a date as a number (1-31):</p>
...
<a class="w3-btn" href="tryit.asp?filename=tryjs_date_getdate2" target="_blank">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
const d = new Date();<br>
d.getDate();
</div>
...
<p>The <code class="w3-codespan">getHours()</code> method returns the hours of a date as a number (0-23):</p>
...
<a class="w3-btn" href="tryit.asp?filename=tryjs_date_gethours2" target="_blank">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
const d = new Date();<br>
d.getHours();
</div>
...
<p>The <code class="w3-codespan">getMinutes()</code> method returns the minutes of a date as a number (0-59):</p>
<div class="w3-example">
<h3>Examples</h3>
<div class="w3-code notranslate jsHigh">
const d = new Date("2021-03-25");<br>
...
<a class="w3-btn" href="tryit.asp?filename=tryjs_date_getminutes2" target="_blank">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
const d = new Date();<br>
d.getMinutes();
</div>
...
<p>The <code class="w3-codespan">getSeconds()</code> method returns the seconds of a date as a number (0-59):</p>
<div class="w3-example">
<h3>Examples</h3>
<div class="w3-code notranslate jsHigh">
const d = new Date("2021-03-25");<br>
...
<a class="w3-btn" href="tryit.asp?filename=tryjs_date_getseconds2" target="_blank">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
const d = new Date();<br>
d.getSeconds();
</div>
...
<p>The <code class="w3-codespan">getMilliseconds()</code> method returns the milliseconds of a date as a number (0-999):</p>
<div class="w3-example">
<h3>Examples</h3>
<div class="w3-code notranslate jsHigh">
const d = new Date("2021-03-25");<br>
...
<a class="w3-btn" href="tryit.asp?filename=tryjs_date_getmilliseconds2" target="_blank">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
const d = new Date();<br>
d.getMilliseconds();
</div>
...
<p>The <code class="w3-codespan">getDay()</code> method returns the weekday of a date as a number (0-6).</p>
<div class="w3-panel ws-note">
...
<a class="w3-btn" href="tryit.asp?filename=tryjs_date_getday2" target="_blank">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
const d = new Date();<br>
d.getDay();
</div>
...
<p>You can use an array of names, and <code class="w3-codespan">getDay()</code> to return weekday as a name:</p>
</div>
...
<a class="w3-btn" href="tryit.asp?filename=tryjs_date_weekday2" target="_blank">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
const days = [&quot;Sunday&quot;, &quot;Monday&quot;, &quot;Tuesday&quot;, &quot;Wednesday&quot;,
&quot;Thursday&quot;, &quot;Friday&quot;, &quot;Saturday&quot;];<br>
<br>
...
<p>The <code class="w3-codespan">getTime()</code> method returns the number of milliseconds since January 1, 1970:</p>

<div class="w3-example">
<h3>Examples</h3>
<div class="w3-code notranslate jsHigh">
const d = new Date("1970-01-01");<br>
d.getTime();
</div>
<a class="w3-btn" href="tryit.asp?filename=tryjs_date_gettime3" target="_blank">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
const d = new Date("2021-03-25");<br>
d.getTime();
</div>
<a class="w3-btn" href="tryit.asp?filename=tryjs_date_gettime2" target="_blank">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
const d = new Date();<br>
d.getTime();
</div>
...
<a target="_blank" href="tryit.asp?filename=tryjs_date_now" class="w3-btn">Try it Yourself &raquo;</a>
...
<a target="_blank" href="tryit.asp?filename=tryjs_date_now2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p><code class="w3-codespan">Date.now()</code> is a static method of the Date object.</p>
<p>You cannot use it on a date object like <code class="w3-codespan">myDate.now()</code>.</p>
<p>The syntax is always <code class="w3-codespan">Date.now()</code>.</p>
<!--stop-->
<hr>
<!--start-->
...
<tr>
<td>getUTCDate()</td>
<td>getDate()</td><td>Returns the UTC date</td>
</tr>
<tr>
<td>getUTCFullYear()</td>
<td>getFullYear()</td><td>Returns the UTC year</td>
</tr>
<tr>
<td>getUTCMonth()</td>
<td>getMonth()</td><td>Returns the UTC month</td>
</tr>
<tr>
<td>getUTCDay()</td>
<td>getDay()</td><td>Returns the UTC day</td>
</tr>
<tr>
<td>getUTCHours()</td>
<td>getHours()</td><td>Returns the UTC hour</td>
</tr>
<tr>
<td>getUTCMinutes()</td>
<td>getMinutes()</td><td>Returns the UTC minutes</td>
</tr>
<tr>
<td>getUTCSeconds()</td>
<td>getSeconds()</td><td>Returns the UTC seconds</td>
</tr>
<tr>
<td>getUTCMilliseconds()</td>
<td>getMilliseconds()</td><td>Returns the UTC milliseconds</td>
</tr>
</table>
...
<canvas id="canvas" width="200" height="200" style="background-color:#333"></canvas><br><br>
<button class="w3-btn" style="width:200px" onclick="timeShow(0)">Local Time?</button><br><br>
<button class="w3-btn" style="width:200px" onclick="timeShow(1)">UTC Time?</button>

<hr>
<!--start-->
<h2>The getTimezoneOffset() Method</h2>
<p>The <code class="w3-codespan">getTimezoneOffset()</code> method returns the difference (in minutes)
between local time an UTC time:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let diff = d.getTimezoneOffset();
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_date_gettimezoneoffset" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<div class="ws-note">
<h2>Learn More:</h2>
<p class="w3-large"><a href="js_dates.asp">JavaScript Date Tutorial</a></p>
<p class="w3-large"><a href="js_date_formats.asp">JavaScript Date Formats</a></p>
<p class="w3-large"><a href="js_date_methods_set.asp">JavaScript Date Set Methods</a></p>
<p class="w3-large"><a href="js_date_reference.asp">JavaScript Date Reference</a></p>
</div>

<div id="exercisecontainer" src="xrcise_date_methods.js"></div>
<hr>
...
radius = radius*0.90
timeShow(0);
function timeShow(UTC) {
var now = new Date();
//setInterval(drawClock, 1000);
drawClock(UTC, now);
}
function drawClock(UTC, now) {
  drawFace(ctx, radius);
  drawNumbers(ctx, radius);
  drawTime(ctx, radius, UTC, now);
}
</script>
