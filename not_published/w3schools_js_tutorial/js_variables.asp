...
<!--start-->
<div class="ws-info">
<h2>Variables = Data Containers</h2>
<p><b>JavaScript variables</b> are containers for data.</p>
<p>JavaScript variables can be <b>declared</b> in 4 ways:</p>
...
<div class="w3-half">
<h3>Older JavaScript</h3>
<ul class="w3-stretch">
<li>Using <code class="w3-codespan">var</code> (Not Recommended)</li>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_variables_let" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_variables_const" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<p>Variables are <b>labels</b> for data values.</p>
<p>Variables are <b>containers</b> for storing data.</p>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>Variables are identified with <b>names</b> called <strong>identifiers</strong>.</p>

<p>Names can be short like x, y, z.</p>
<p>Names can be descriptive like age, sum, carName.</p>

<p>The rules for constructing names (identifiers) are:</p>
<ul>
  <li>Names can <b>contain</b> letters, digits, underscores, and dollar signs.</li>
  <li>Names must <b>begin</b> with a letter, a $ sign or an underscore (_).</li>
  <li>Names are <b>case sensitive</b> (X is different from x).</li>
  <li><b>Reserved words</b> (JavaScript keywords) cannot be used as names.</li>
</ul>
<div class="ws-note">
...
<p>JavaScript treats underscore as a letter.</p>
<p>Identifiers containing _ are valid variable names:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_variables_underscore" target="_blank">Try it Yourself &raquo;</a>
</div>

<p>A convention among professional programmers is to start a name with underscore for "private" variables.</p>
<!--stop-->
<hr>
<!--start-->
<h2>JavaScript Dollar Sign $</h2>

<p>JavaScript also treats a dollar sign as a letter.</p>
<p>Identifiers containing $ are valid variable names:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let $ = "Hello World";<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_variables_dollar" target="_blank">Try it Yourself &raquo;</a>
</div>

<p>Using the $ is not very common in JavaScript, but professional programmers often use it as an alias
for the main function in JavaScript libraries.</p>

<!--stop-->

<hr>
<!--start-->
<h2>Declaring JavaScript Variables</h2>
<p><b>Creating a variable</b> in JavaScript is called <b>declaring</b> a variable. </p>
<p>You declare a JavaScript variable with the <code class="w3-codespan">let</code> keyword or
the <code class="w3-codespan">const</code> keyword.</p>

<hr>
<h2>Declaring a Variable Using <b>let</b></h2>
...
<p>Most often you will assign a value to the variable when you declare it:</p>
...
<hr>
<h2>Declaring a Variable Using <b>const</b></h2>
<p>Always use <code class="w3-codespan">const</code> if the value should not be changed</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
const carName = "Volvo";
</div>
...
<p>The two variables <b>price1</b> and <b>price2</b>
are declared with the <code class="w3-codespan">const</code> keyword.</p>
<p>The values of price1 and price2 cannot be changed.</p>
<p>The variable <b>total</b> is declared with the <code class="w3-codespan">let</code> keyword.</p>
<p>The value of total can be changed.</p>

<hr>
<h2>Declaring a Variable Automatically</h2>
<p>Undeclared variables are <b>automatically declared</b> when first used:</p>
<div class="w3-example">
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_variables_undeclared" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<hr>
<h2>Declaring a Variable Using <b>var</b></h2>
<p>The <code class="w3-codespan">var</code> keyword was used in all JavaScript code before 2015.</p>
<p>The <code class="w3-codespan">let</code> and <code class="w3-codespan">const</code> keywords were new to JavaScript in 2015.</p>

<div class="w3-example">
<h3>Using var (<b>Not</b> Recommended)</h3>
<div class="w3-code notranslate jsHigh">
...
<p>4. Only use <code class="w3-codespan">let</code> if you cannot use <code class="w3-codespan">const</code></p>
<p>5. Avoid useing <code class="w3-codespan">var</code>.</p>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>JavaScript Data Types</h2>
<p>JavaScript variables can hold <b>8 datatypes</b>, but for now, just think of <b>numbers</b> and <b>strings</b>.</p>
<p><b>Strings</b> are text written <b>inside quotes</b>.</p>
<p><b>Numbers</b> are written <b>without quotes</b>.</p>
...
<p>Start the statement with <code class="w3-codespan">let</code> or
<code class="w3-codespan">const</code>and separate the variables by <strong>comma</strong>:</p>
...
<p>In JavaScript, the equal sign (<code class="w3-codespan">=</code>) is an <b>assignment</b> operator, not an 
<b>equal to</b> operator.</p>
...
<p>The <b>equal to</b> operator is written like <code class="w3-codespan"><b>==</b></code> in JavaScript.</p>
</div>
<!--stop-->
...
operators like <code class="w3-codespan">=</code> and <code class="w3-codespan">+</code>: </p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let x = 5 + 2 + 3;<br>
...
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: JavaScript Variables</h2>
  <a href="https://youtu.be/7xStNKTM3bE&list=PLP9IO4UYNF0WWmZpE3W33vVPRl2GvjEqz" class="ga-featured ga-youtube" target="blank_" >
    <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
      ...
      <picture id="yt_div">
        <source srcset="images/img_javascript_variables.webp" type="image/webp" />
        <img src="images/img_javascript_variables.png" style="max-width:100%;height:auto;border-radius:6px" alt="Tutorial on YouTube" loading="lazy">
      </picture>
    </div>
  </a>
</div>
