...
<a class="w3-right w3-btn" href="js_if.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
<h2>Conditional Statements</h2>
<p><b>Conditional Statements</b> allow us to perform <b>different actions</b> for <b>different conditions</b>.</p>
<p>Conditional statements <b>run different code</b> depending on <b>true</b> or <b>false</b> conditions.</p>
...
<h2>When to use Conditionals</h2>
<ul>
<li>
Use <code class="w3-codespan">if</code> to specify a <b>code block</b> to be executed,
if a specified condition is <code class="w3-codespan">true</code>
</li>
<li>
Use <code class="w3-codespan">else</code> to specify a <b>code block</b> to be executed,
if the same condition is <code class="w3-codespan">false</code>
</li>
<li>
Use <code class="w3-codespan">else if</code> to specify a <b>new condition</b> to test,
if the first condition is <code class="w3-codespan">false</code>
</li>
<li>
Use <code class="w3-codespan">switch</code> to specify many <b>alternative code blocks</b>
to be executed
</li>
<li>
Use <code class="w3-codespan">(? :)</code> (ternary) as a <b>shorthand</b> for
<code class="w3-codespan">if...else</code>
</li>
</ul>
...
<p>
Use <code class="w3-codespan">if</code> to specify a <b>code block</b> to be executed,
if a specified condition is <code class="w3-codespan">true</code>.</p>
<div class="w3-example">
<h3>Syntax</h3>
<div class="w3-code notranslate jsHigh">
if (<i>condition</i>) {<br>
&nbsp;&nbsp;//<em> code to execute if the condition is true<br>
 </em>}
</div>
</div>
...
<p>
Use <code class="w3-codespan">else</code> to specify a <b>code block</b> to be executed,
if the same condition is <code class="w3-codespan">false</code>.</p>
...
<br>
&nbsp;&nbsp;//<em> code to execute if the condition is false<br>
 </em>}</div>
</div>
...
<p>
Use <code class="w3-codespan">else if</code> to specify a <b>new condition</b> to test,
if the first condition is <code class="w3-codespan">false</code>.</p>

<div class="w3-example">
<h3>Syntax</h3>
<div class="w3-code notranslate jsHigh">
if (<i>condition1</i>) {<br>
&nbsp;&nbsp;//<em> code to execute if condition1 is true<br>
 </em>}
else if (<i>condition2</i>) {<br>
&nbsp;&nbsp;//<em> code to execute if the condition1 is false and condition2 is true</em><br>
} else {<br>
&nbsp;&nbsp;//<em> code to execute if the condition1 is false and condition2 is false<br>
 </em>}</div>
...
<p>
Use <code class="w3-codespan">(? :)</code> (ternary) as a <b>shorthand</b> for
<code class="w3-codespan">if...else</code>.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
<i>condition</i> ? <i>expression1</i> : <i>expression2</i>
</div>
</div>
