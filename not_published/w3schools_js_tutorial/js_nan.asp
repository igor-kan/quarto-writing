...
<h1>JavaScript NaN</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_undefined.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_tostring.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
<p>In JavaScript, <code class="w3-codespan">NaN</code> is short for <b>Not a Number</b>.</p>
<p><code class="w3-codespan">NaN</code> is a JavaScript number that is not a legal number.</p>
</div>

<h2>Invalid Number Operations</h2>
<p>You get <code class="w3-codespan">NaN</code> when JavaScript cannot calculate a number.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_datatypes_nan_number">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>NaN is a Number</h2>
<p>The type of <code class="w3-codespan">NaN</code> is <code class="w3-codespan">number</code>.</p>
<p>This may look strange, but <code class="w3-codespan">NaN</code> belongs to the JavaScript number type.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let x = NaN;<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_datatypes_nan_typeof">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Numeric Strings</h2>
<p>JavaScript tries to convert numeric strings to numbers in arithmetic operations.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let x = 100 / "10";<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_datatypes_nan_numeric_string">Try it Yourself &raquo;</a>
</div>
<div class="ws-note">
<p>The result is <code class="w3-codespan">10</code>, because <code class="w3-codespan">"10"</code> is converted to the number <code class="w3-codespan">10</code>.</p>
</div>

<hr>
<h2>Non-Numeric Strings</h2>
<p>A non-numeric string cannot be converted to a number.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let x = 100 / "Apple";<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_datatypes_nan_non_numeric">Try it Yourself &raquo;</a>
</div>
<div class="ws-note">
<p>The result is <code class="w3-codespan">NaN</code>, because <code class="w3-codespan">"Apple"</code> cannot be converted to a number.</p>
</div>
<hr>

<h2>Using isNaN()</h2>

<p>You can use the JavaScript function <code class="w3-codespan">isNaN()</code> to find out if a value is not a number.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_datatypes_nan_isnan">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>NaN is Not Equal to Itself</h2>

<p><code class="w3-codespan">NaN</code> is the only JavaScript value that is not equal to itself.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_datatypes_nan_not_equal">Try it Yourself &raquo;</a>
</div>

<p>To test for <code class="w3-codespan">NaN</code>, use <code class="w3-codespan">isNaN()</code>.</p>

<hr>

<h2>NaN in Math</h2>

<p>If you use <code class="w3-codespan">NaN</code> in a mathematical operation, the result will also be <code class="w3-codespan">NaN</code>.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_datatypes_nan_math">Try it Yourself &raquo;</a>
</div>

<hr>
<div class="ws-note">
<h2>Note</h2>
<p><code class="w3-codespan">NaN</code> means <b>Not a Number</b>.</p>
<p>But the type of <code class="w3-codespan">NaN</code> is <code class="w3-codespan">number</code>.</p>
<p>Use <code class="w3-codespan">isNaN()</code> to check if a value is <code class="w3-codespan">NaN</code>.</p>
</div>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_undefined.asp">&#10094; Previous</a>
