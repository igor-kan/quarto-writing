...
<div class="ws-info">
<img style="width:30%;margin-left:16px;margin-bottom:16px;margin-right:-16px;margin-top:-16px;max-width:140px;float:right;"
src="img_javascript_480.jpg" alt="JS">
<h2>Learn JavaScript</h2>
<h4><b>The Programming Language of the Web</b></h4>
<p>JavaScript is easy to learn.</p>
<p>This tutorial covers everything from basic JavaScript up to the latest 2026 version.</p>
