...
<html lang="en-US">
<head>
<title>JavaScript Syllabus (Curriculum)</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="js_website.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_study_plan.asp">Next &#10095;</a>
</div>
<hr>
...
<p>The <a title="W3Schools JavaScript Tutorial" href="default.asp">W3Schools JavaScript Tutorial</a> is comprehensive and beginner-friendly.</p>
<p>It will give you a fundamental knowledge of JavaScript.</p>
...
<p>The syllabus outline and its sequence are structured so you can learn JavaScript step by step, from the introduction to creating your first application with JavaScript.</p>
<p><a title="W3Schools JavaScript Tutorial" href="js_intro.asp" class="ws-btn">Get Started With JavaScript &raquo;</a></p>
<hr>

<h2>Learning Outcomes</h2>
<ul>
    <li>Learn how JavaScript works and how it is used in web development.</li>
    <li>Make web pages interactive by typing and running JavaScript code.</li>
    <li>Use variables to store and change data.</li>
    <li>Use data types and operators to do logic and calculations.</li>
    <li>Organize and reuse code by functions.</li>
    <li>Conditions, like "if" and "else," let you control how a program runs. Learn how to use them.</li>
    <li>Use loops (like for and while) to do things over and over again.</li>
    <li>Learn how to use Document Object Model (DOM) to change HTML elements.</li>
    <li>Make interactive user experiences by handling events like button clicks and form submissions.</li>
    <li>Debugging JavaScript code.</li>
</ul>
<div class="ws-note w3-panel">
<p><strong>Note:</strong> Are you a teacher teaching JavaScript? <a href="/academy/index.php" target="_blank">W3Schools Academy</a> is a toolbox of features that can help you teach. It offers classroom features such as pre-built study plans, classroom administration and much more. Read more about <a href="/academy/index.php" target="_blank">Academy here</a>.</p>
</div>
<hr>

<h2>Which Subjects Are JavaScript Relevant For?</h2>
<ul>
    <li style="margin-bottom:16px;">
        <strong>Computer Science (CS) / Information Technology (IT):</strong><br> 
    ...
    <li style="margin-bottom:16px;">
        <strong>Physics and Engineering:</strong><br>
    ...
    <li style="margin-bottom:16px;">
        <strong>Business and Entrepreneurship:</strong><br>
    ...
    <li style="margin-bottom:16px;">
        <strong>STEM (Science, Technology, Engineering, Mathematics):</strong> <br>
    ...
    <li style="margin-bottom:16px;">
        <strong>Robotics and the Internet of Things (IoT):</strong> <br>
        JavaScript is used by some platforms to program robots and IoT devices.
    </li>
</ul>
<p><a title="W3Schools JavaScript Tutorial" href="js_intro.asp" class="ws-btn" style="margin-top:8px">Get Started</a></p>
...
<h2>Activities</h2>
<p>In this tutorial we offer different activities for you to learn JavaScript for free:</p>
<ul>
    <li><a href="default.asp" title="W3Schools JavaScript Tutorial">Lessons</a></li>
    <li><a href="js_exercises.asp" title="W3Schools JavaScript Exercises">Exercises</a></li>
    <li><a href="js_quiz.asp" title="W3Schools JavaScript Quiz">Quizzes</a></li>
</ul>
<hr>
...
<ul class="link-boxes">
    <li><a href="default.asp">JavaScript HOME</a></li>
    <li><a href="js_intro.asp">JavaScript Introduction</a></li>
    <li><a href="js_whereto.asp">JavaScript Where To</a></li>
    <li><a href="js_output.asp">JavaScript Output</a></li>
    <li><a href="js_statements.asp">JavaScript Statements</a></li>
    <li><a href="js_syntax.asp">JavaScript Syntax</a></li>
    <li><a href="js_comments.asp">JavaScript Comments</a></li>
    <li><a href="js_variables.asp">JavaScript Variables</a></li>
    <li><a href="js_let.asp">JavaScript Let</a></li>
    <li><a href="js_const.asp">JavaScript Const</a></li>
    <li><a href="js_operators.asp">JavaScript Operators</a></li>
    <li><a href="js_arithmetic.asp">JavaScript Arithmetic</a></li>
    <li><a href="js_assignment.asp">JavaScript Assignment</a></li>
    <li><a href="js_data_types.asp">JavaScript Data Types</a></li>
    <li><a href="js_function_intro.asp">JavaScript Functions</a></li>
    <li><a href="js_objects.asp">JavaScript Objects</a></li>
    <li><a href="js_events.asp">JavaScript Events</a></li>
    <li><a href="js_strings.asp">JavaScript Strings</a></li>
    <li><a href="js_string_methods.asp">JavaScript String Methods</a></li>
    <li><a href="js_string_search.asp">JavaScript String Search</a></li>
  <li><a href="js_string_templates.asp">JavaScript String Templates</a></li>
    <li><a href="js_numbers.asp">JavaScript Numbers</a></li>
    <li><a href="js_bigint.asp">JavaScript BigInt</a></li>
<li><a href="js_number_properties.asp">JavaScript Number Methods</a></li>
    <li><a href="js_number_methods.asp">JavaScript Number Properties</a></li>
    <li><a href="js_arrays.asp">JavaScript Arrays</a></li>
    <li><a href="js_array_methods.asp">JavaScript Array Methods</a></li>
<li><a href="js_array_search.asp">JavaScript Array Search</a></li>
    <li><a href="js_array_sort.asp">JavaScript Array Sort</a></li>
    <li><a href="js_array_iteration.asp">JavaScript Array Iteration</a></li>
 <li><a href="js_array_const.asp">JavaScript Array Const</a></li>
    <li><a href="js_dates.asp">JavaScript Dates</a></li>
<li><a href="js_date_formats.asp">JavaScript Date Formats</a></li>
    <li><a href="js_date_methods.asp">JavaScript Date Methods</a></li>
<li><a href="js_date_methods_set.asp">JavaScript Set Methods</a></li>
    <li><a href="js_math.asp">JavaScript Math</a></li>
    <li><a href="js_random.asp">JavaScript Random</a></li>
    <li><a href="js_booleans.asp">JavaScript Booleans</a></li>
    <li><a href="js_comparisons.asp">JavaScript Comparisons</a></li>
    <li><a href="js_if_else.asp">JavaScript If Else</a></li>
    <li><a href="js_switch.asp">JavaScript Switch</a></li>
    <li><a href="js_loop_for.asp">JavaScript For Loop</a></li>
<li><a href="js_loop_forin.asp">JavaScript For In</a></li>
<li><a href="js_loop_forin.asp">JavaScript For Of</a></li>
    <li><a href="js_loop_while.asp">JavaScript While Loop</a></li>
    <li><a href="js_break.asp">JavaScript Break and Continue</a></li>
    <li><a href="js_iterables.asp">JavaScript Iterables</a></li>
    <li><a href="js_sets.asp">JavaScript Sets</a></li>
    <li><a href="js_set_methods.asp">JavaScript Set Methods</a></li>
    <li><a href="js_maps.asp">JavaScript Maps</a></li>
    <li><a href="js_map_methods.asp">JavaScript Map Methods</a></li>
    <li><a href="js_typeof.asp">JavaScript typeof</a></li>
    <li><a href="js_type_conversion.asp">JavaScript Type Conversion</a></li>
<li><a href="js_destructuring.asp">JavaScript Destructing</a></li>
    <li><a href="js_bitwise.asp">JavaScript Bitwise</a></li>
    <li><a href="js_regexp.asp">JavaScript RegExp</a></li>
    <li><a href="js_precedence.asp">JavaScript Precedence</a></li>
    <li><a href="js_errors.asp">JavaScript Errors</a></li>
    <li><a href="js_scope.asp">JavaScript Scope</a></li>
    <li><a href="js_hoisting.asp">JavaScript Hoisting</a></li>
    <li><a href="js_strict.asp">JavaScript Strict Mode</a></li>
    <li><a href="js_this.asp">JavaScript this Keyword</a></li>
    <li><a href="js_arrow_function.asp">JavaScript Arrow Function</a></li>
    <li><a href="js_classes.asp">JavaScript Classes</a></li>
    <li><a href="js_modules.asp">JavaScript Modules</a></li>
    <li><a href="js_json.asp">JavaScript JSON</a></li>
    <li><a href="js_debugging.asp">JavaScript Debugging</a></li>
    <li><a href="js_style_guide.asp">JavaScript Style Guide</a></li>
    <li><a href="js_best_practices.asp">JavaScript Best Practices</a></li>
    <li><a href="js_mistakes.asp">JavaScript Mistakes</a></li>
    <li><a href="js_performance.asp">JavaScript Performance</a></li>
    <li><a href="js_reserved.asp">JavaScript Reserved Words</a></li>
<li><a href="js_versions.asp">JavaScript Versions</a></li>
<li><a href="js_object_definition.asp">JavaScript Objects</a></li>
<li><a href="js_function_definition.asp">JavaScript Functions</a></li>
<li><a href="js_class_intro.asp">JavaScript Classes</a></li>
<li><a href="js_asynchronous.asp">JavaScript Async</a></li>
<li><a href="js_htmldom.asp">JavaScript HTML DOM</a></li>
<li><a href="js_window.asp">JavaScript Browser DOM</a></li>
<li><a href="js_api_intro.asp">JavaScript Web APIs</a></li>
<li><a href="js_ajax_intro.asp">JavaScript AJAX</a></li>
<li><a href="js_json_intro.asp">JavaScript JSON</a></li>
<li><a href="js_jquery_selectors.asp">JavaScript vs. jQuery</a></li>
<li><a href="js_graphics.asp">JavaScript Graphics</a></li>
</ul>
</div>
<p><a title="W3Schools JavaScript Tutorial" href="default.asp" class="ws-btn">Get Started</a></p>

<hr>

<h2>Sandbox and Lab Environment</h2>
<p>JavaScript, like any other programming language, is best learned by working hands-on with code.</p>
<p>Easily try code with our "Try it Yourself" editor.</p>
<p>Here, you can edit JavaScript code and view the result:</p>
...
<p>If you want to explore more and host your JavaScript project, we have a feature called <a href="/spaces/index.php" target="_blank">Spaces</a> 
...
<p>The JavaScript exam is a test that summarizes the W3Schools JavaScript syllabus.</p>
<p>After passing the exam you get the "Certified JavaScript Developer" Certification.</p>
...
<p><a class="ws-btn" href="https://campus.w3schools.com/collections/certifications/products/javascript-certificate" target="_blank">Buy Certificate &raquo;</a></p>
<hr>
