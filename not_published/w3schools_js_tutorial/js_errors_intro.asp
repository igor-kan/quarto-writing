...
<a class="w3-left w3-btn" href="js_destructuring.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_errors_silent.asp">Next &#10095;</a>
</div>
<div class="ws-info">
...
<li>URI Errors</li>
<li>Syntax Errors</li>
<li>Eval Error (deprecated)</li>
<li>Silent Errors (next chapter)</li>
</ul>
</div>
<hr>
<!--start-->
<h2>How to Handle JavaScript Errors</h2>
...
<p>The JavaScript statements <code class="w3-codespan">try</code> and <code class="w3-codespan">catch</code> 
come in pairs:</p>
...
<hr>
<h2>Reference Errors</h2>
<p>A <code class="w3-codespan">ReferenceError</code> occurs if you use (reference) a variable that does not exist.</p>

<div class="w3-stretch">
<table class="ws-table-all">
<tr><th>Error Type</th><th>Example</th><th>Error</th></tr>
<tr><th>ReferenceError</th><td>fname = foo;</td>
<td>foo is not defined</td></tr>
<tr><th>ReferenceError</th><td>let x = y;<br>let y = 5;</td>
<td>Cannot access y before initialization</td></tr>
</table>
</div>

<div class="w3-example">
<h3>Examples</h3>
<p>You cannot use a non-existing variable:</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_error_referenceerror2" target="_blank">Try it Yourself &raquo;</a>

</div>


<hr>
<h2>JavaScript Type Errors</h2>
<p>A <code class="w3-codespan">Type Error</code> occurs when a value is of the wrong type or an operation
is invalid on that type.</p>

<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
<tr><th>Error</th><th>Example</th><th>Error Message</th></tr>
<tr><th>TypeError</th><td>anna(5);</td><td>anna is not a function</td></tr>
<tr><th>Type Error</th><td>let num = 1;<br>num.toUpperCase();<br>
</td>
<td>num.toUpperCase is not a function</td></tr>
</table>
</div>
...
<a target="_blank" href="tryit.asp?filename=tryjs_error_typeerror2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
...
<a target="_blank" href="tryit.asp?filename=tryjs_error_typeerror" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<h2>JavaScript Range Errors</h2>
<p>A <code class="w3-codespan">RangeError</code> occurs when a value is out of its valid range.</p>

<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
<tr><th>Error Type</th><th>Example</th><th>Error Message</th></tr>
<tr><th>RangeError</th><td>new Array(-1);</td><td>Invalid array length</td></tr>
<tr><th>RangeError</th><td>num.toPrecision(500);</td><td>toPrecision() argument must be between 1 and 100</td></tr>
</table>
</div>
...
<a target="_blank" href="tryit.asp?filename=tryjs_error_rangeerror2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
...
<hr>
<!--start-->
<h2>JavaScript URI Errors</h2>
<h4>(Uniform Resource Identifier Errors)</h4>
<p>An <code class="w3-codespan">URIError</code> occurs if you use illegal characters in a URI function:</p><div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
<tr><th>Error Type</th><th>Example</th><th>Error Message</th></tr>
<tr><th>URIError</th><td>decodeURI(&quot;%%%&quot;);</td><td>URI malformed</td></tr>
</table>
</div>
...
<p>A  <code class="w3-codespan">Syntax Error</code> occurs when the code violates JavaScript's grammar rules.</p>

<div class="w3-stretch">
<table class="ws-table-all">
<tr><th>Error</th><th>Example</th><th>Error</th></tr>
<tr><th>SyntaxError</th><td>fname = "John);</td><td>Invalid or unexpected token )</td></tr>
<tr><th>SyntaxError</th><td>Math.round(4.6;</td><td>Missing ) after argument list</td></tr>
</table>
</div>
<div class="w3-example">
<h3>Example</h3>
<p>In this example we have made the mistake of not closing the string:</p>
<div class="w3-code notranslate htmlHigh">
// This line cannot be parsed by JavaScript<br>
let fName = "John);<br>
<br>
// Execution stops here
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_errors_parse1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p>The statement above will generate the error: <b>Invalid or unexpected token</b></p>
<p><b>Execution of the program will stop!</b></p>

<div class="ws-note">
<h2>Syntax Errors are Not Catchable</h2>
<ul class="w3-large">
<li>Syntax errors are not catchable by try...catch</li>
<li>Syntax errors happen before runtime</li>
</ul>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>The code below should produce an error, but <b>it does not</b>:</p>
<div class="w3-code notranslate htmlHigh">
try {<br>
&nbsp; let x = Math.round(4.6;)<br>
} catch(err) {<br>
&nbsp; let text = err.name + " " + err.description;<br>
}
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_errors_syntax1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p>The line above is syntactically invalid JavaScript. There is an extra semicolon inside the parentheses.
...
<h2>Why</h2>
<p>The point is how the browser handles syntax errors:</p>
<p>The JavaScript engine throws a SyntaxError before running the script.</p>
<p>Syntax errors are caught before the try...catch block executes.</p>
<p>This means the try block never starts.
The script just fails to run (no let text = update).</p>

<div class="ws-note">

<p>The browser console (F12 &#8594; Console tab) would show something like:<p>
<p>Uncaught SyntaxError: missing ) after argument list.<p>
</div>

<hr>
<!--start-->
<h2>JavaScript Eval Error</h2>
<p>An <code class="w3-codespan">EvalError</code> indicates an error in the eval() function.</p>
<div class="w3-panel ws-warning">
<p>Newer versions of JavaScript do not throw EvalError.</p>
<p>Use SyntaxError instead.</p>
</div>
<hr>
<!--stop-->
<div class="ws-note">
<h2>See Also:</h2>
<p class="w3-large"><a href="js_errors_silent.asp">JavaScript Silent Errors</a></p>
<p class="w3-large"><a href="js_errors.asp">JavaScript Error Statements</a></p>
<p class="w3-large"><a href="js_error_object.asp">JavaScript Error Object</a></p>
<p class="w3-large"><a href="js_debugging.asp">JavaScript Debugging</a></p>
</div>
<hr>
