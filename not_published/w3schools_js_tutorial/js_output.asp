...
<ul>
 <li>Writing into an HTML element, using <code class="w3-codespan">innerHTML</code> or
<code class="w3-codespan">innerText</code>.</li>
...
<p>To access an HTML element, you can use the <code class="w3-codespan">document.getElementById(id)</code> method. </p>
<p>Use the <code class="w3-codespan">id</code> attribute to identify the HTML element.</p>
<p>Then use the <code class="w3-codespan">innerHTML</code> property to change the HTML content
of the HTML element:</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_output_innerhtml" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">

<p>Changing the innerHTML property of an HTML element
is the most common way to display data in HTML.</p>
</div>
<!--stop-->
...
<p>To access an HTML element, use the <code class="w3-codespan">document.getElementById(id)</code> method. </p>
<p>Then use the <code class="w3-codespan">innerText</code> property to change the inner text
of the HTML element:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
...
<br>
&lt;script&gt;<br>
 document.getElementById(&quot;demo&quot;).innerText = "Hello World";<br>
    &lt;/script&gt;<br>
<br>
&lt;/body&gt;<br>
&lt;/html&gt;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_output_innertext" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="w3-panel ws-note">

<p>Use innerHTML when you want to change an HTML element.</p>
<p>Use innerText when you only want to change the plain text.</p>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_output_alert2" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_output_print" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: JavaScript Output</h2>
  <a href="https://youtu.be/we8YhT-NiOA&list=PLP9IO4UYNF0WWmZpE3W33vVPRl2GvjEqz" class="ga-featured ga-youtube" target="blank_" >
    <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
      ...
      <picture id="yt_div">
        <source srcset="images/img_javascript_output.webp" type="image/webp" />
        <img src="images/img_javascript_output.png" style="max-width:100%;height:auto;border-radius:6px" alt="Tutorial on YouTube" loading="lazy">
      </picture>
    </div>
  </a>
</div>
