...
<html lang="en-US">
<head>
<title>JavaScript Temporal PlainTime - Work with Time Only</title>
<meta charset="utf-8">
...
<h1>JavaScript Temporal PlainTime</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_temporal_plainmonthday.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_temporal_zoneddatetime.asp">Next &#10095;</a>
</div>

<div class="ws-info">
<h2>The PlainTime Object</h2>
...
<h2>The Temporal.PlainTime Object</h2>
<p>The <code class="w3-codespan">Temporal PlainTime</code> object is a time object with no date.</p>
<p>It represents an ISO 8601 <b>wall-clock time</b> without a date or time zone.</p>
<p>Example: <b>14:30:00</b>.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const date = new Temporal.PlainTime(14, 30);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plaintime" target="_blank">Try it Yourself &raquo;</a>
</div>

<h2>Create a PlainTime</h2>
<p>You can create a PlainTime from a string.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const time = Temporal.PlainTime.from("14:30");
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plaintime_from" target="_blank">Try it Yourself &raquo;</a>
</div>

<p>You can also create a PlainTime using numeric values.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<div class="ws-note">
<p>The parameters are: hour, minute, second, millisecond, microsecond, nanosecond.</p>
</div>

<hr>
<h2>Get the Current Time</h2>
<p>You can get the current local time using <code class="w3-codespan">Temporal.Now.plainTimeISO()</code>.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const now = Temporal.Now.plainTimeISO();
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plaintime_now" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Get Time Parts</h2>
<p>You can read the different parts of a PlainTime value.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const time = Temporal.PlainTime.from("14:30:15.123");
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plaintime_from2" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Add and Subtract PlainTime</h2>
<p>Use <code class="w3-codespan">add()</code> and <code class="w3-codespan">subtract()</code>
to do PlainTime math.</p>
<p>PlainTime is immutable, so the original value is not changed.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const time = Temporal.PlainTime.from("14:30");<br>
<br>
const later = time.add({ minutes: 45 });<br>
const earlier = time.subtract({ hours: 2 });<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plaintime_add" target="_blank">Try it Yourself &raquo;</a>
</div>

<p>If the time passes midnight, it wraps around:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const time = Temporal.PlainTime.from("23:30");<br>
<br>
const result = time.add({ minutes: 90 });<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plaintime_add_2" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Calculate PlainTime Differences</h2>
<p>Use <code class="w3-codespan">since()</code> and <code class="w3-codespan">until()</code>
to calculate PlainTime differences.</p>
<p>Both methods return a <b>Temporal.Duration object</b>.</p>

<div class="w3-example">
<h3>Examples</h3>
<div class="w3-code notranslate jsHigh">
// Create two PlainTime objects<br>
const start = Temporal.PlainTime.from("09:00");<br>
const end = Temporal.PlainTime.from("17:30");<br>
<br>
// Calculate the difference<br>
const diff = start.since(end);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plaintime_since" target="_blank">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
// Create two PlainTime objects<br>
const start = Temporal.PlainTime.from("09:00");<br>
const end = Temporal.PlainTime.from("17:30");<br>
<br>
// Calculate the difference<br>
const diff = start.until(end);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plaintime_until" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<div class="ws-note">
<h2>LearnMore:</h2>
<p class="w3-large"><a href="js_temporal_differences.asp">Temporal Since and Until Tutorial</a></p>
</div>

<hr>
<h2>The PlainTime compare() Method</h2>
<p>Use <code class="w3-codespan">Temporal.PlainTime.compare()</code> to compare times.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create two PlainTime objects<br>
const a = Temporal.PlainTime.from("08:30");<br>
const b = Temporal.PlainTime.from("14:30");<br>
<br>
// Compare the two objects<br>
result = Temporal.PlainTime.compare(a, b));<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plaintime_compare" target="_blank">Try it Yourself &raquo;</a>
</div>

<p>The result is:</p>
<ul class="w3-ul">
  <li><b>-1</b> if the first time is earlier</li>
  <li><b>0</b> if they are equal</li>
  <li><b>1</b> if the first time is later</li>
</ul>

<div class="ws-note">

<p>Do not use =, &lt;, or &gt; when comparing temporal time.</p>
</div>
...
<div class="ws-note">
<h2>LearnMore:</h2>
<p class="w3-large"><a href="js_temporal_compare.asp">Temporal Compare Tutorial</a></p>
</div>

<hr>
<h2>The PlainTime equals() Method</h2>
<p>Use <code class="w3-codespan">equals()</code> to check if two times are the same.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create two PlainTime objects<br>
const a = Temporal.PlainTime.from("14:30");<br>
const b = Temporal.PlainTime.from("14:30");<br>
<br>
// Compare the two objects<br>
result = a.equals(b);
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plaintime_equals" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<div class="ws-note">
<h2>LearnMore:</h2>
<p class="w3-large"><a href="js_temporal_compare.asp">Temporal Equals Tutorial</a></p>
</div>


<hr>
<h2>When to Use PlainTime</h2>
<ul>
  <li><p>Opening hours (for example: 09:00 to 17:00).</p></li>
  <li><p>Alarm clock times.</p></li>
  <li><p>Recurring daily schedules.</p></li>
  <li><p>Time input fields (without date and time zone).</p></li>
</ul>

<div class="ws-note">
<p>If you need date, use <a href="js_temporal_plaindatetime.asp">PlaneDateTime</a>.</p>
</div>
...
<p>The <code class="w3-codespan">Temporal.PlainTime</code> object has <b>6 properties</b> of time information.</p>
<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plaintime_prop" target="_blank">Try it Yourself &raquo;</a>
</div>
