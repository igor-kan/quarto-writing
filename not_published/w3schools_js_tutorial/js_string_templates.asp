...
<html lang="en-US">
<head>
<title>JavaScript Template Strings</title>
<meta charset="utf-8">
...
<h1>JavaScript String Templates</h1>
...
<p>Beloved child has many names</p>
</div>

<h2>Back-Tics Syntax</h2>
<p><b>Template Strings</b> use back-ticks (``) rather than the quotes ("") to define a string:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let text = `Hello World!`;
</div>
<p><a class="w3-btn" href="tryit.asp?filename=tryjs_templates" target="_blank">Try it Yourself &raquo;</a></p>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Quotes Inside Strings</h2>
<p><b>Template Strings</b> allow both single and double quotes inside a string:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<p><b>Template Strings</b> allow multiline strings:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let text =<br>
...
<!--start-->
<h2>Interpolation</h2>
<p><b>Template Strings</b> allow variables in strings.</p>
<p>Template strings provide an easy way to <b>interpolate</b> variables in strings.</p>
<div class="w3-example">
<h3>Syntax</h3>
<div class="w3-code notranslate jsHigh">
${...}</div>
...
<p><a class="w3-btn" href="tryit.asp?filename=tryjs_templates_variables" target="_blank">Try it Yourself &raquo;</a></p>
</div>
<hr>
<!--stop-->
...
<p><b>Template Strings</b> allow <b>interpolation of expressions</b> in strings:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let price = 10;<br>
...
<p><a class="w3-btn" href="tryit.asp?filename=tryjs_templates_expressions" target="_blank">Try it Yourself &raquo;</a></p>
</div>
<!--stop-->
<hr>
<!--start-->
...
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let header = "Template Strings";<br>
let tags = ["template strings", "javascript", "es6"];<br>
<br>
...
<p><a class="w3-btn" href="tryit.asp?filename=tryjs_templates_html" target="_blank">Try it Yourself &raquo;</a></p>
</div>
<!--stop-->
<hr>
<h2>Browser Support</h2>
<p><code class="w3-codespan">Template Strings</code> is an <a href="js_es6.asp">ES6  feature</a>.</p>
...
<p>For a complete String reference, go to our:</p>
<p><a href="/jsref/jsref_obj_string.asp">Complete JavaScript String Reference</a>.</p>
<p>The reference contains descriptions and examples of all string properties and methods.</p>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_string_templates.js"></div>
<hr>
