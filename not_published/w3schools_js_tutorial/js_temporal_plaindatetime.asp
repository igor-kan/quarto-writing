...
<html lang="en-US">
<head>
<title>JavaScript Temporal.PlainDateTime - Date and Time Without Time Zone</title>
<meta charset="utf-8">
...
<h1>JavaScript PlainDateTime</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_temporal_instant.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_temporal_plain.asp">Next &#10095;</a>
</div>
<div class="ws-info">
<h2>The Temporal.PlainDateTime Object</h2>
...
// Create a PlainDateTime object<br>
const dateTime = Temporal.PlainDateTime.from("2026-05-17T14:30:00");
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plaindatetime_2" target="_blank">Try it Yourself &raquo;</a>
</div>
<p>The <b>T</b> is a literal to separate the date from the time.</p>

<hr>
<h2>What You Should Learn:</h2>
<ul>
<li>How to use JavaScript Temporal.PlainDateTime</li>
<li>How to work with date and time without a time zone</li>
<li>How to add and subtract dates</li>
<li>How to compare dates safely</li>
</ul>

<div class="ws-note">
<p><b>PlainDateTime</b> is useful when you need both date and time, but not time zone.</p>
</div>

<hr>
<h2>How to Create a PlainDateTime Object</h2>
<p>An <b>PlainDateTime object</b> can be created in several different ways:</p>
<table class="ws-table-all">
<tr></tr>
<tr><th>From</th><th>Code</th></tr>
<tr><td>Constructor (new)</td><td>new Temporal.PlainDateTime()</td></tr>
<tr><td>ISO String </td><td>Temporal.PlainDateTime.from()</td></tr>
<tr><td>Now (current time)</td><td>Temporal.Now.plainDateTimeISO()</td></tr>
</table>

<hr>
<h2>Create a PlainDateTime with <b>new</b></h2>
<p>You can create a <b>PlainDateTime object</b> using the <b>new</b> constructor.</p>
<p>The constructor takes <b>parameters</b> like year, month, day, hours, and minutes.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create a PlainDateTime object<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plaindatetime" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="ws-note">
<p>In Temporal objects, months start at 1.</p>
<p>In the legacy Date object, months start at 0.</p>
</div>

<hr>
<h2>Create a PlainDateTime from a String</h2>
<p>You can create a <b>PlainDateTime object</b> from an <a href="js_temporal_standards.asp">
...
<h2>The T Between Date and Time?</h2>
<p>The <b>T</b> is a literal to separate the date from the time.</p>
<p>You should read it as an abbreviation for <b>Time</b>.</p>
<p>It is the separator required by the <a href="js_temporal_standards.asp">
<b>ISO 8601 format</b></a>.</p>

<hr>
<h2>Create a PlainDateTime from Now</h2>
<p>You can create a <b>PlainDateTime object</b> from current time.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const now = Temporal.Now.plainDateTimeISO();
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plaindatetime_3" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Add or Subtract PlainDateTime</h2>
<p>You can safely add or subtract time.</p>
<p>The original value does not change.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create a PlainDateTime object<br>
const date = Temporal.PlainDateTime.from("2026-05-17T14:30:00");<br>
<br>
// Add and subtract time<br>
const earlier = dateTime.subtract({ minutes: 30 });<br>
const later = dateTime.add({ hours: 2 });<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plaindatetime_4" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<h2>When to Use PlainDateTime</h2>
<ul>
<li><p>Applications where time zone conversion is not required.</p></li>
<li><p>Local event scheduling.</p></li>
<li><p>Appointments without international time zone handling.</p></li>
<li><p>Forms that collect date and time.</p></li>
</ul>

<hr>
<h2>Compare PlainDateTime Values</h2>
<p>You can <b>compare</b> PlaneDateTime values using the <b>equals()</b> method.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const d1 = Temporal.PlainDateTime.from("2026-05-17T14:30:00");<br>
const d2 = Temporal.PlainDateTime.from("2026-05-17T14:30:00");<br>
<br>
let result = d1.equals(d2) 
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plaindatetime_5" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<div class="ws-note">
<h2>Learn More:</h2>
<p class="w3-large"><a href="js_temporal_compare.asp">JavaScript Temporal Compare</a></p>
</div>
<hr>
<h2>Convert to ZonedDateTime</h2>
<p>A PlainDateTime object does not include time zone information.</p>
<p>You can <b>convert</b> it to a <b>ZonedDateTime</b> if needed.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const dateTime = Temporal.PlainDateTime.from("2026-05-17T10:00:00");<br>
<br>
const zoned = dateTime.toZonedDateTime("Europe/Oslo");<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plaindatetime_zoned" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Compare PlainDateTime with Other Types</h2>
<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
<tr><th>Type</th><th>Meaning</th></tr>
<tr><td>Instant</td><td>Exact Moment in UTC time</td></tr>
<tr><td>PlainDateTime</td><td>Plaind Date and Time (No Timezone)</td></tr>
...
<p>The <b>Temporal.PlainDateTime object</b> has <b>22 properties</b> of date information.</p>
<div class="w3-example">
<h3>Display all PlainDateTime PropertiesExample</h3>
<div class="w3-code notranslate jsHigh">
