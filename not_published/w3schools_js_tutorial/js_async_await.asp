...
<a class="w3-left w3-btn" href="js_promise.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_async_fetch.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="w3-panel ws-info w3-center" style="padding:8px">
<p class="w3-xlarge"><i><code class="w3-codespan">async</code> and <code class="w3-codespan">await</code>
make promises easier</i></p>
<p>You still use promises, but you write the code like normal step by step code.</p>
<p><b>async</b> makes a function <b>return a Promise</b></p>
<p><b>await</b> makes a function <b>wait for a Promise</b></p>
</div>

<h2>Why async and await Exist</h2>

<p>Promise chains can become long.</p>
<p><code class="w3-codespan">async</code> and <code class="w3-codespan">await</code> were created to reduce nesting and improve readability.</p>
...
<p>The same flow with <code class="w3-codespan">async</code> and <code class="w3-codespan">await</code> is easier to read.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Function to run the three functions in steps<br>
async function run() {<br>
&nbsp;&nbsp;let v1 = await step1();<br>
&nbsp;&nbsp;let v2 = await step2(v1);<br>
&nbsp;&nbsp;let v3 = await step3(v2);<br>
&nbsp;&nbsp;myDisplayer(v3);<br>
}<br><br>
run();<br>
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_async_await">
Try it Yourself &raquo;</a></p>
</div>

<hr>
<h2>The async Keyword</h2>
<p>The <code class="w3-codespan">async</code> keyword before a function makes the function return a promise.</p>
<p>This is true even if you return a normal value.</p>
...
&nbsp; return Promise.resolve("Hello");<br>
}
</div>
</div>

<p>The result is handled with <code class="w3-codespan">then()</code> because it is a promise:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
myFunction().then(<br>
&nbsp; function(value) { /* code if successful */ },<br>
&nbsp; function(value) { /* code if some error */ }<br>
);
</div>
</div>
...
async function myFunction() {<br>
&nbsp; return "Hello";<br>
}<br>myFunction().then(<br>&nbsp; function(value) {myDisplayer(value);},
  <br>&nbsp; function(value) {myDisplayer(value);}<br>);
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_async_await_1">
Try it Yourself &raquo;</a></p>
</div>
...
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_async_await_2">
Try it Yourself &raquo;</a></p>
</div>
<hr>
<h2>The await Keyword</h2>
<p>The <code class="w3-codespan">await</code> keyword makes a function pause the execution 
...
async function run() {<br>
&nbsp;&nbsp;let value = await step1();<br>
&nbsp;&nbsp;myDisplayer(value);<br>
}<br><br>
run();<br>
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_async_await_3">
Try it Yourself &raquo;</a></p>
</div>
...
<p>Promises use <code class="w3-codespan">catch()</code> for errors.</p>
<p><code class="w3-codespan">async</code> and <code class="w3-codespan">await</code> use <code class="w3-codespan">try...catch</code>.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
function fail() {<br>
&nbsp;&nbsp;return Promise.reject("Failed");<br>
}<br><br>
async function run() {<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;let value = await fail();<br>
...
<p>Errors from awaited promises are caught like normal errors.</p>
</div>

<hr>
<h2>Sequential vs Parallel</h2>

<p>Awaiting one by one runs tasks in sequence.</p>
<p>This is correct when one step depends on the previous step.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
async function run() {<br>
&nbsp;&nbsp;let a = await step1();<br>
&nbsp;&nbsp;let b = await step2();<br>
&nbsp;&nbsp;console.log(a, b);<br>
}<br>
</div>
</div>

<p>If tasks do not depend on each other, you can run them in parallel.</p>
<p>Use <code class="w3-codespan">Promise.all()</code> to wait for both.</p>
...
&nbsp;&nbsp;let p1 = step1();<br>
&nbsp;&nbsp;let p2 = step2();<br>
&nbsp;&nbsp;let values = await Promise.all([p1, p2]);<br>
...
<p>Start the promises first.</p>
<p>Await them together.</p>
</div>


<hr>
<h2>Real Example with fetch</h2>
<p><code class="w3-codespan">fetch()</code> returns a promise.</p>
<p>This makes it a perfect example for <code class="w3-codespan">async</code> and <code class="w3-codespan">await</code>.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
async function loadData() {<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;let response = await fetch("data.json");<br>
...
<p>This is promise-based async code written in a synchronous style.</p>

<hr>
<h2>Common Beginner Mistakes</h2>

<div class="ws-warning">
<p>Using <code class="w3-codespan">await</code> outside an <code class="w3-codespan">async</code> function causes an error.</p>
</div>

<div class="ws-warning">
<p>Forgetting <code class="w3-codespan">try...catch</code> can hide async errors.</p>
</div>

<div class="ws-tip">
<p>When async code fails, check the console and the Network tab.</p>
</div>
<!--start-->
<hr>
<h2>More Examples</h2>
...
&nbsp;&nbsp;&nbsp; resolve(&quot;I love You !!&quot;);<br>
&nbsp; });<br>
&nbsp; document.getElementById(&quot;demo&quot;).innerHTML = await myPromise;<br>}<br><br>
 myDisplay();
</div>
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_async3">Try it Yourself &raquo;</a>
</p>
</div>
<div class="ws-note">
...
<div class="w3-code notranslate jsHigh">
async function myDisplay() {<br>
&nbsp; let myPromise = new Promise(function(resolve) {<br>
&nbsp;&nbsp;&nbsp; resolve(&quot;I love You !!&quot;);<br>
&nbsp; });<br>
&nbsp; document.getElementById(&quot;demo&quot;).innerHTML = await myPromise;<br>}<br><br>
 myDisplay();
...
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_async5">Try it Yourself &raquo;</a>
</p>
</div>
<div class="w3-example">
...
async function myDisplay() {<br>
&nbsp; let myPromise = new Promise(function(resolve) {<br>
&nbsp;&nbsp;&nbsp; setTimeout(function() {resolve("I love You !!");}, 3000);<br>
&nbsp; });<br>
&nbsp; document.getElementById(&quot;demo&quot;).innerHTML = await myPromise;<br>}<br><br>
 myDisplay();
</div>
...
<p><code class="w3-codespan">async/await</code> is an ECMAScript 2017 feature.</p>
...
<div class="ws-note">
<h2>Next Chapter</h2>
<p>The next page focuses on <code class="w3-codespan">fetch()</code> and real-world network requests.</p>
<p>You will learn status codes, JSON parsing, and common fetch mistakes.</p>
<p class="w3-large"><a class="w3-btn w3-green" href="js_async_fetch.asp">The Fetch API</a></p>
</div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_promise.asp">&#10094; Previous</a>
