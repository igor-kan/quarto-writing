...
<a class="w3-left w3-btn" href="js_set_reference.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_map_methods.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
<h2>The Map Object</h2>
<p>A <b>JavaScript Map</b> is an object that can store collections of key-value pairs,
similar to a <b>dictionary</b> in other programming languages.</p>
<p>Maps differ from standard objects in that <b>keys can be of any data type</b>.</p>
</div>
...
<li><p><b>Performance</b><br>
Maps are optimized for frequent additions and removals of key-value pairs.
</li>
<li><p><b>Iteration</b><br>
Maps are iterable, allowing for direct use of for...of loops or methods like forEach().<p> 
</p></li>
<li><p><b>Iteration Order</b><br>
The original order is preserved during iteration.<p> 
</p></li>
</ul>
<hr>
<div class="ws-note">

<p>Maps are similar to both Objects (unique key/value collection) and Arrays (ordered values collection).</p>
<p>But if you look close, Maps are most similar to Objects.</p>
</div>
<hr>
<h2>How to Create a Map</h2>
<p>You create a JavaScript Map by:</p>
<ul>
<li>Create a new Map and add elements with <code class="w3-codespan">Map.set()</code></li>
<li>Passing an existing Array to the <code class="w3-codespan">new Map()</code> constructor</li>
</ul>

<div class="w3-example">
<h3>Examples</h3>
<p>Create a new Map and add elements with <code class="w3-codespan">Map.set()</code></p>
...
<p>Pass an Array to the <code class="w3-codespan">new Map()</code> constructor:</p>
<div class="w3-code notranslate jsHigh">
// Create a Map<br>
const fruits = new Map([<br>
&nbsp; ["apples", 500],<br>
...
<h2>Adding Map Values</h2>
<p>You can add elements to a Map with the <code class="w3-codespan">set()</code> method:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
fruits.set("mangos", 100);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_map_add" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Changing Map Values</h2>
...
<p>The <code class="w3-codespan">get()</code> method gets the value of a key in a Map:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
fruits.get("apples");&nbsp;&nbsp;&nbsp;&nbsp;// Returns 500<br>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_map_typeof" target="_blank">Try it Yourself &raquo;</a>
</div>

<p><code class="w3-codespan">instanceof</code> Map returns true:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Returns true:<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_map_instanceof" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<div class="ws-note">
<h2>Learn More:</h2>
<p class="w3-large"><a href="js_map_methods.asp">JavaScript Map Methods</a></p>
...
<p><code class="w3-codespan">Map</code> is an <a href="js_es6.asp">ES6  feature</a>.</p>
