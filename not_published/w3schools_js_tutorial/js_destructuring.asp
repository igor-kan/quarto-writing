...
<a class="w3-right w3-btn" href="js_errors_intro.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
<h2>Destructuring Assignment Syntax</h2>
<p>The destructuring assignment syntax can <b>unpack objects</b> into variables:</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_object_destruct" target="_blank">Try it Yourself &raquo;</a>
</div>
<p>The order of the properties does not matter:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create an Object<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_object_destruct4" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<div class="ws-note">
<p>Destructuring is not destructive.</p>
<p>Destructuring does not change the original object.</p>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Object Default Values</h2>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_object_destruct2" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Object Property Alias</h2>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create an Object<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_object_destruct3" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>String Destructuring</h2>
<p>One use for destructuring is unpacking string characters.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create a String<br>
let name = "W3Schools";<br>
<br>
// Destructuring<br>
let [a1, a2, a3, a4, a5] = name;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_string_destruct" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="ws-note">
<p>Destructuring can be used with any iterables.</p>
</div>
<!--stop-->
<hr>
...
<div class="w3-code notranslate jsHigh">
// Create an Array<br>
const fruits = ["Bananas", "Oranges", "Apples", "Mangos"];<br>
<br>
// Destructuring<br>
let [fruit1, fruit2] = fruits;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_array_destruct" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Skipping Array Values</h2>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_array_destruct2" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Array Position Values</h2>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_array_destruct3" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>The Rest Property</h2>
<p>You can end a destructuring syntax with a rest property.</p>
<p>This syntax will store all remaining values into a new array:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create an Array<br>
const numbers = [10, 20, 30, 40, 50, 60, 70];<br>
<br>
// Destructuring<br>
const [a,b, ...rest] = numbers
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_array_destruct4" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
// Destructuring<br>
let text = "";<br>
for (const [key, value] of fruits) {<br>
&nbsp; text += key + " is " + value;<br>
}
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_map_destruct" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Swapping JavaScript Variables</h2>
<p>You can swap the values of two variables using a destructuring assignment:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_swap_destruct" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->

<hr>
<div id="exercisecontainer" src="xrcise_destructuring.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_type_conversion.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_errors_intro.asp">Next &#10095;</a>
