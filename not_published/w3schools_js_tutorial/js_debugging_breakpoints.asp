...
<html lang="en-US">
<head>
<title>JavaScript Debugging Breakpoints</title>
<meta charset="utf-8">
...
<h1>JavaScript Debugging Breakpoints</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_debugging_console.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_debugging_errors.asp">Next &#10095;</a>
</div>

<!--start-->
<div class="ws-info">
<h2>Breakpoints, Watch, Scope</h2>
<p>Breakpoints let you pause JavaScript and inspect what is really happening.</p>
<p>This is the most powerful debugging technique after using the console.</p>
</div>

<h2>What Is a Breakpoint</h2>
<p>A breakpoint pauses code execution on a specific line.</p>
<p>When the code stops, you can inspect variables and step through the code line by line.</p>
<p>Breakpoints are set inside the browser developer tools.</p>

<div class="ws-note">

<p>You do not guess values when using breakpoints.</p>
<p>You see them.</p>
</div>
...
document.getElementById("demo").innerHTML = add(10, 5);<br>
document.getElementById("demo").innerHTML = add(10, 50);<br>
document.getElementById("demo").innerHTML = add(10, 500);<br>
document.getElementById("demo").innerHTML = add(10, 5000);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryjs_debugging_breakpoint.htm" target="_blank">
Try it Yourself &raquo;</a>
</div>
<p>Open the browser developer tools with <b>F12</b> and go to the <b><b>Sources</b></b> tab.</p>
<p><b>Click on the line numbers</b> in your script to add breakpoints.</p>
<p><b>Reload</b> the page to trigger the breakpoint.</p>
<p>Use the <b>play button</b> to run your code line by line.</p>



<hr>
<h2>The debugger Keyword</h2>
<p>The <code class="w3-codespan">debugger</code> keyword stops the execution of JavaScript, 
...
<div class="ws-note">
<h2>Learn More</h2>
<p>Read more about the <code class="w3-codespan">console.log()</code> method in our <a href="/jsref/met_console_log.asp">JavaScript Console Reference</a>.</p>
</div>
...
<p>When execution is paused, you can control how the code runs.</p>

<ul class="w3-ul w3-card-2" style="max-width:720px">
<li><b>Step Over</b> runs the next line.</li>
<li><b>Step Into</b> enters a function.</li>
<li><b>Step Out</b> exits the current function.</li>
</ul>

<div class="ws-tip">
<p>Step slowly and watch how values change.</p>
</div>

<hr>
<h2>The Scope Panel</h2>

<p>The Scope panel shows which variables are available at the current line.</p>
<p>It helps you understand where variables live.</p>

<ul class="w3-ul w3-card-2" style="max-width:720px">
<li><b>Local</b> variables exist inside a function.</li>
<li><b>Global</b> variables exist everywhere.</li>
</ul>
...
<p>At the breakpoint, <code class="w3-codespan">y</code> exists only inside the function.</p>

<hr>
<h2>Watching Variables</h2>
<p>The Watch panel lets you track variable values live.</p>
<p>This is useful when values change many times.</p>
<p>Add a variable name to the Watch panel.</p>
<p>The value updates automatically as you step through the code.</p>
<div class="ws-tip">
<p>Watch variables instead of adding many <code class="w3-codespan">console.log()</code> calls.</p>
</div>
...
<p>Beginners often forget to reload the page after adding a breakpoint.</p>
</div>

<div class="ws-warning">
<p>Breakpoints inside loops can trigger many times.</p>
</div>
<p>If execution stops repeatedly, disable the breakpoint temporarily.</p>

<hr>
<h2>When to Use Breakpoints</h2>
<ul class="w3-ul w3-border">
<li>When values change unexpectedly.</li>
<li>When code runs but produces wrong results.</li>
<li>When debugging complex logic.</li>
</ul>

<hr>
<h2>Next: Common Errors Explained</h2>
<p>Next page explains the most common JavaScript error messages.</p>
<p>You will learn what they mean and how to fix them.</p>
