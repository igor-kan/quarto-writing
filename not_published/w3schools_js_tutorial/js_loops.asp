...
<a class="w3-left w3-btn" href="js_logical.asp">&#10094; Previous</a>
...
for (<i>expr1</i>;<i> expr2</i>;<i> expr3</i>) {<br>
    &nbsp; // <i>code block to be executed</i><br>
 }<br>
</div></div>

<p><strong>exp1</strong> is executed <b>one time</b> before the execution of the code block.</p>
<p><strong>exp2</strong> defines <b>the condition</b> for executing the code block.</p>
<p><strong>exp3</strong> is executed <b>every time</b> the code block has been executed.</p>
...
<p><b>exp1</b> sets a variable before the loop starts (let i = 0).</p>
<p><b>exp2</b> defines the condition for the loop to run (i must be less than 5).</p>
<p><b>exp3</b> increases a value (i++) each time the code block has been executed.</p>
<!--stop-->
<hr>
<!--start-->
<h2>Loop Scope</h2>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_let_for_loop" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<p>In the first example, <code class="w3-codespan">let i = 5;</code> is declared outside the loop.</p>
<p>In the second example, <code class="w3-codespan">let i = 0;</code>, is declared inside the loop.</p>
<p>When a variable is declared with <code class="w3-codespan">let</code> or <code class="w3-codespan">const</code>
inside a loop, it will only be visible within the loop.</p>
<!--stop-->
<hr>
<!--start-->
<hr>
...
<p>The <code class="w3-codespan">do while</code> loop is a variant of the while loop.</p>
<p>The <code class="w3-codespan">do while</code> loop will 
