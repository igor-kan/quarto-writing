...
<a class="w3-left w3-btn" href="js_array_const.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_set_methods.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
<p>A JavaScript Set is a collection of unique values.</p>
<p>Each value can only occur once in a Set.</p>
<p>The values can be of any type, primitive values or objects.</p>
</div>
...
<ul>
<li>Passing an array to <code class="w3-codespan">new Set()</code></li>
<li>Create an empty set and use <code class="w3-codespan">add()</code> to add values</li>
</ul>
<!--stop-->
<hr>
<!--start-->
...
const c = "c";<br>
<br>
// Add Variables to the Set<br>
letters.add(a);<br>
letters.add(b);<br>
letters.add(c);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_set_create" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<hr>
<!--start-->
<h2>Sets are Objects</h2>
<div class="w3-example">
<p><code class="w3-codespan">typeof</code> returns object:</p>
<div class="w3-code notranslate jsHigh">
typeof letters;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Returns object<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_set_typeof" target="_blank">Try it Yourself &raquo;</a>
<p><code class="w3-codespan">instanceof Set</code> returns true:</p>
<div class="w3-code notranslate jsHigh">
letters instanceof Set;&nbsp;&nbsp;// Returns true<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_set_instanceof" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<div class="ws-note">
...
<p><code class="w3-codespan">Set</code> is an <a href="js_es6.asp">ES6  feature</a>.</p>
