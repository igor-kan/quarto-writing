...
<h1>Invoking JavaScript Functions</h1>

<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_function_intro.asp">&#10094; Previous</a>
...
<p>A JavaScript function runs when it is <b>called</b>.</p>
<p>To <b>call a function</b>, write the name followed by parentheses like <b>name()</b>.</p>

</div>

<h2>Function Invocation</h2>
<p>The code inside a function is <b>NOT executed</b> when the function is <strong>defined</strong>.</p>
<p>The code inside a function <b>will execute</b> when "something" <b>invokes</b> the function:</p>
...
<p>It is common to use the term <b>invoke</b>, because a function can be invoked without being called.</p>
...
<hr>
<h2>Examples</h2>
<p>The function below returns the text <b>"Hello World"</b>.</p>
<p>But it will not run before you call it.</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_function_sayhello_alone" target="_blank">Try it Yourself &raquo;</a>
</div>

<p>The code below calls the function.</p>
<p>But it does not use the result.</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_function_sayhello_no" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="ws-note">

<p>To use the returned value, you can store it in a variable or display it.</p>
</div>

<hr>
<h2>Using the Returned Value</h2>
<p>When a function returns a value, you can store the value in a variable.</p>
...
let greeting = sayHello();<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_function_sayhello" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Displaying the Result</h2>
<p>You can display the returned value in many ways, for example using console.log() or HTML.</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_function_sayhello_log" target="_blank">Try it Yourself &raquo;</a>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_function_sayhello_html" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<h2>Calling a Function Many Times</h2>
<p>
You can call the same function whenever you need it.<br>
</p>
...
<hr>
<h2>Functions are Invoked with ()</h2>
<p><b>The () operator invokes a function</b>.</p>
...
<br>
// Call the toCelcius() function<br>
...
<p>Accessing a function without () returns the function itself and not the result:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
function toCelsius(fahrenheit) {<br>
...
<p><code class="w3-codespan">toCelsius</code> refers to the <b>function itself</b>.</p>
<p><code class="w3-codespan">toCelsius(77)</code> refers to the <b>function result</b>.</p>
</div>

<hr>
<h2>Calling vs Referencing a Function</h2>
<p>This is an important difference:</p>
<p><code class="w3-codespan">sayHello</code> refers to the <b>function itself</b>. It returns the function.</p>
<p><code class="w3-codespan">sayHello()</code> refers to the <b>function result</b>. It returns the result.</p>
...
let text = sayHello;<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_function_itself" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="ws-note">
<p>In the example above, text returns the function itself like:</p>
<p><b>function sayHello() { return "Hello World"; }</b></p>
</div>

<hr>
<h2>Functions Can Be Called from Anywhere</h2>
<p>You can call functions from other functions, from events, or from any code block.</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_function_from_function" target="_blank">Try it Yourself &raquo;</a>
<div class="w3-code notranslate htmlHigh">
&lt;p id="demo"&gt;&lt;/p&gt;<br>
&lt;button onclick="showHello()"&gt;Click Me&lt;/button&gt;<br><br>
&lt;script&gt;<br>
function sayHello() {<br>
&nbsp;&nbsp;return "Hello World";<br>
}<br><br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_function_from_click" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Common Mistakes</h2>
<ul class="w3-ul">
  <li><h3>Forgetting Parentheses ()</h3>
  <b>sayHello</b> does not run the function.<br>You must use <b>sayHello()</b>.</li>
  <li><h3>Expecting Return</h3>
  Some functions do <b>not return a value</b>.<br>
  <li><h3>Expecting Output</h3>
  If a function returns a value, you must display it to see it.</li>
</ul>
...
<div class="ws-note">
<h2>Next Chapter</h2>
<p class="w3-large"><a href="js_function_parameters.asp">Function Parameters</a></p>
<ul>
