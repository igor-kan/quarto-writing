...
<html lang="en-US">
<head>
<title>JavaScript Atomics</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="js_dataview.asp">&#10094; Previous</a>
...
const buffer = new SharedArrayBuffer(4 * Int32Array.BYTES_PER_ELEMENT);<br>
<br>
// Shared integer array with 4 elements<br>
const sharedArray = new Int32Array(buffer);<br>
<br>
...
<a target="_blank" href="tryit.asp?filename=tryjs_atomics_basic" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate jsHigh">
var buffer = new SharedArrayBuffer(4 * Int32Array.BYTES_PER_ELEMENT);<br>
var sharedArray = new Int32Array(buffer);<br>
<br>
// Store a value atomically<br>
Atomics.store(sharedArray, 0, 123);<br>
<br>
// Load the value atomically<br>
var value = Atomics.load(sharedArray, 0);<br>
<br>
...
sharedArray[0] = 5;<br>
<br>
var oldValue = Atomics.add(sharedArray, 0, 3);<br>
<br>
console.log("Old:", oldValue);  // Old: 5<br>
console.log("New:", sharedArray[0]);// New: 8<br>
</div>
</div>
...
sharedArray[0] = 10;<br>
<br>
var oldValue = Atomics.sub(sharedArray, 0, 4);<br>
<br>
console.log("Old:", oldValue);  // Old: 10<br>
console.log("New:", sharedArray[0]);// New: 6<br>
</div>
</div>
...
sharedArray[0] = 1;<br>
<br>
var oldValue = Atomics.exchange(sharedArray, 0, 99);<br>
<br>
console.log("Old:", oldValue);   // Old: 1<br>
console.log("New:", sharedArray[0]); // New: 99<br>
</div>
</div>
...
sharedArray[0] = 10;<br>
<br>
// Only replace 10 with 20 if the current value is 10<br>
var oldValue = Atomics.compareExchange(sharedArray, 0, 10, 20);<br>
<br>
console.log("Old:", oldValue);   // Old: 10<br>
console.log("New:", sharedArray[0]); // New: 20<br>
<br>
// Now it will NOT change because the expected value does not match<br>
oldValue = Atomics.compareExchange(sharedArray, 0, 10, 30);<br>
<br>
console.log("Old:", oldValue);   // Old: 20<br>
console.log("New:", sharedArray[0]); // New: 20<br>
</div>
</div>
...
<div class="w3-code notranslate jsHigh">
// main.js<br>
var buffer = new SharedArrayBuffer(4);<br>
var sharedArray = new Int32Array(buffer);<br>
<br>
sharedArray[0] = 0;<br>
<br>
...
<br>
// Send the shared buffer to the worker<br>
worker.postMessage(buffer);<br>
<br>
// Simulate some work, then set the value and notify the worker<br>
setTimeout(function() {<br>
&nbsp;&nbsp;Atomics.store(sharedArray, 0, 1);<br>
&nbsp;&nbsp;Atomics.notify(sharedArray, 0, 1); // wake 1 worker<br>
}, 1000);<br>
</div>
...
&nbsp;&nbsp;var buffer = e.data;<br>
&nbsp;&nbsp;var sharedArray = new Int32Array(buffer);<br>
<br>
&nbsp;&nbsp;console.log("Worker waiting...");<br>
&nbsp;&nbsp;var result = Atomics.wait(sharedArray, 0, 0); // wait while value is 0<br>
<br>
&nbsp;&nbsp;console.log("Worker woken, result =", result);<br>
&nbsp;&nbsp;console.log("New value:", Atomics.load(sharedArray, 0));<br>
};<br>
</div>
</div>
