...
<html lang="en-US">
<head>
<title>JavaScript Set Methods</title>
<meta charset="utf-8">
...
<h1>JavaScript Set Methods</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_sets.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_set_logic.asp">Next &#10095;</a>
</div>

<!--start-->
<div class="ws-info">
<h2>Set Methods &amp; Properties</h2>

<table class="w3-table w3-large">
<tr>
<td>
<a href="#mark_set_new">new Set()</a><br>
<a href="#mark_set_add">add()</a><br>
<a href="#mark_set_clear">clear()</a><br>
<a href="#mark_set_delete">delete()</a><br>
<a href="#mark_set_entries">entries()</a><br>
</td>
<td>
<a href="#mark_set_foreach">forEach()</a><br>
<a href="#mark_set_has">has()</a><br>
<a href="#mark_set_keys">keys()</a><br>
<a href="#mark_set_values">values()</a><br>
<a href="#mark_set_size">size</a><br>
</td></tr>
</table>
</div>
<a id="mark_set_new"></a>
<h2>The new Set() Method</h2>
<p>Pass an array to the <code class="w3-codespan">new Set()</code> constructor:</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_set_create_array" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_set_add" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_set_add_equals" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="ws-note">

<p>The primary feature of Set objects is that they only store unique values.</p>
<p>If an attempt is made to add an element that already exists in the set, the <code class="w3-codespan">add()</code> method will have no effect,
and the set will remain unchanged.</p>
</div>

<a id="mark_set_size"></a>
<hr>
...
<div class="w3-code notranslate jsHigh">
// Create a new Set<br>
const mySet = new Set(["a","b","c"]);<br>
<br>
// The number of elements are<br>
mySet.size;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_set_size" target="_blank">Try it Yourself &raquo;</a>
</div>

<!--stop-->
<hr>
<!--start-->
<h2>Listing Set Elements</h2>
<p>You can list all Set elements (values) with a <b>for..of</b> loop:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create a Set<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_set_list" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>The <code class="w3-codespan">has()</code> method returns <code class="w3-codespan">true</code> if a specified value exists in a set.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create a Set<br>
const letters = new Set(["a","b","c"]);<br>
<br>
// Does the Set contain "d"?<br>
answer = letters.has("d");
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_set_has" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<hr>
<!--start-->
<a id="mark_set_foreach"></a>
<h2>The forEach() Method</h2>
<p>The <code class="w3-codespan">forEach()</code> method invokes a function for each Set element:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create a Set<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_set_foreach" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<a id="mark_set_values"></a>
<h2>The values() Method</h2>
<p>The <code class="w3-codespan">values()</code> method returns an Iterator object with the values in a Set:</p>
<div class="w3-example">
<h3>Example 1</h3>
<div class="w3-code notranslate jsHigh">
// Create a Set<br>
...
<br>
// Get all Values<br>
const myIterator = letters.values();<br>
<br>
// List all Values<br>
let text = "";<br>
for (const entry of myIterator) {<br>
&nbsp;&nbsp;text += entry;<br>
}<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_set_values2" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
<h3>Example 2</h3>
<div class="w3-code notranslate jsHigh">
...
// List all Values<br>
let text = "";<br>
for (const entry of letters.values()) {<br>
&nbsp;&nbsp;text += entry;<br>
}<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_set_values" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<a id="mark_set_keys"></a>
<h2>The keys() Method</h2>
<p>The <code class="w3-codespan">keys()</code> method returns an Iterator object with the values in a Set:</p>
<div class="ws-note">

<p>A Set has no keys, so <code class="w3-codespan">keys()</code> returns the same as <code class="w3-codespan">values()</code>.</p>
<p>This makes Sets compatible with Maps.</p>
</div>
<div class="w3-example">
<h3>Example 1</h3>
<div class="w3-code notranslate jsHigh">
...
const myIterator = letters.keys();<br>
<br>
// List all Elements<br>
let text = "";<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_set_keys" target="_blank">Try it Yourself &raquo;</a>
</div>
...
// List all Elements<br>
let text = "";<br>
for (const x of letters.keys()) {<br>
&nbsp;&nbsp;text += x;<br>
}
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_set_keys2" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<a id="mark_set_entries"></a>
<h2>The entries() Method</h2>
<p>The <code class="w3-codespan">entries()</code> method returns an Iterator with [value,value] pairs from a Set.</p>
<div class="ws-note">

<p>The <code class="w3-codespan">entries()</code> method is supposed to return a [key,value] pair from an object.</p>
<p>A Set has no keys, so the <code class="w3-codespan">entries()</code> method returns [value,value].</p>
<p>This makes Sets compatible with Maps.</p>
</div>
<div class="w3-example">
<h3>Example 1</h3>
...
<br>
// Get all Entries<br>
const myIterator = letters.entries();<br>
<br>
// List all Entries<br>
let text = "";<br>
for (const entry of myIterator) {<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_set_entries" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
<h3>Example 2</h3>
<div class="w3-code notranslate jsHigh">
...
// List all Entries<br>
let text = "";<br>
for (const entry of letters.entries()) {<br>
&nbsp;&nbsp;text += entry;<br>
}<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_set_entries2" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
<!--stop-->
<div class="ws-note">
...
<p class="w3-large"><a href="js_set_logic.asp">JavaScript Set Logic</a></p>
...
<hr>
<div id="exercisecontainer" src="xrcise_set_methods.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_sets.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_set_logic.asp">Next &#10095;</a>
