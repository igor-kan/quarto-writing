...
<a class="w3-left w3-btn" href="js_control_flow.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_string_templates.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
<p class="w3-large">Strings are for <b>storing text</b></p>
<p class="w3-large">Strings are written <b>with quotes</b></p>
</div>
<h2>Using Quotes</h2>
...
let carName1 = &quot;Volvo XC60&quot;;&nbsp; 
  // Double quotes<br>
let carName2 = 'Volvo XC60';&nbsp; // Single quotes </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_string_quotes">Try it Yourself &raquo;</a>
</div>
<div class="ws-note">

<p>Strings created with single or double quotes work the same.</p>
<p>There is no difference between the two.</p>
</div>
...
let answer3 = 'He is called "Johnny"';<br>
</div>
...
<p>Templates were introduced with ES6 (JavaScript 2016).</p>
<p>Templates are strings enclosed in backticks (`This is a template string`).</p>
<p>Templates allow single and double quotes inside a string:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let text = `He's often called "Johnny"`;
</div>
<p><a class="w3-btn" href="tryit.asp?filename=tryjs_templates_quotes" target="_blank">Try it Yourself &raquo;</a></p>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>String Length</h2>
<p>To find the length of a string, use the built-in <code class="w3-codespan">length</code> property:</p>
...
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
let text = &quot;We are the so-called &quot;Vikings&quot; from the north.&quot;;<br>
</div></div>

<p>The string will be chopped to &quot;We are the so-called &quot;.</p>
<p>To solve this problem, you can use an <b>backslash escape character</b>.</p>
<p>The backslash escape character (<code class="w3-codespan">\</code>) turns special characters into string characters:</p>
...
<div class="w3-example">
<h3>Examples</h3>
<p>\" inserts a double quote in a string:<p>
<div class="w3-code notranslate jsHigh">
let text = &quot;We are the so-called \&quot;Vikings\&quot; from the north.&quot;;</div>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_string_escape_quotes2">Try it Yourself &raquo;</a>
<p>\' inserts a single quote in a string:<p>
<div class="w3-code notranslate jsHigh">
let text= 'It\'s alright.';<br>
</div>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_string_escape_quotes1">Try it Yourself &raquo;</a>
<p>\\ inserts a backslash in a string:<p>
<div class="w3-code notranslate jsHigh">
let text = &quot;The character \\ is called backslash.&quot;;<br>
</div>
...
<p>For readability, programmers often like to avoid long code lines.</p>
<p>A safe way to break up a <b>statement</b> is after an operator:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<p>A safe way to break up a <b>string</b> is by using string addition:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<!--start-->
<h2>Template Strings</h2>
<p>Templates were introduced with ES6 (JavaScript 2015).</p>
<p>Templates are strings enclosed in backticks (`This is a template string`).</p>
...
<p><a class="w3-btn" href="tryit.asp?filename=tryjs_templates_multiline" target="_blank">Try it Yourself &raquo;</a></p>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>But strings can also be defined as objects with the keyword <code class="w3-codespan">new</code>:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
...
<div class="w3-panel ws-note">
<p>Do not create String objects.</p>
...
<div class="w3-example">
<p>When using the <code class="w3-codespan">===</code> operator, x and y are <b>not equal</b>:
