...
<html lang="en-US">
<head>
<title>Progressive Enhancement - Build websites that work for everyone.</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="js_htmlfirst.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_htmlfirst_features.asp">Next &#10095;</a>
</div>
<!--start-->

<div class="ws-info">
<p>Progressive enhancement is a web development strategy where the basic version of a website works first.</p>
<p>Extra features are added later for browsers that support them.</p>
<p>This approach helps websites stay accessible, reliable, and fast.</p>
</div>

<h2>Start With HTML</h2>
<p>The first step is to create a meaningful HTML content.</p>
<p>The page should still work if CSS or JavaScript fails to load.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;h1&gt;Newsletter Signup&lt;/h1&gt;<br>
<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_htmlfirst_email" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="ws-note">
<p>The form above works without JavaScript.</p>
</div>

<hr>
<h2>Add CSS for Better Design</h2>
<p>After the HTML works, CSS can improve the appearance of the page.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;style&gt;<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_htmlfirst_style" target="_blank">Try it Yourself &raquo;</a>

</div>

<hr>

<h2>Add JavaScript as an Enhancement</h2>

<p>JavaScript can improve the user experience, but the page should not depend completely on it.</p>

<p>For example, JavaScript can add instant validation or animations.</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_htmlfirst_script" target="_blank">Try it Yourself &raquo;</a>
</div>

<p>The form still works even if this script does not load.</p>

<hr>

<h2>Why Progressive Enhancement Matters</h2>

<p>Users browse the web with different devices, browsers, and internet speeds.</p>

<p>Some users may disable JavaScript completely.</p>

<p>Others may use older browsers or assistive technologies.</p>

<p>Progressive enhancement helps ensure that everybody can still access the content.</p>

<div class="note">
<p><b>Tip:</b> Try testing your website with JavaScript disabled.</p>
</div>
...
<p>Graceful degradation starts with a complex website and tries to make it work on older browsers.</p>

<p>Progressive enhancement starts simple and adds features step by step.</p>
...
<tr>
<td>Starts simple</td>
<td>Starts advanced</td>
</tr>
<tr>
<td>Adds features later</td>
<td>Removes unsupported features</td>
</tr>
<tr>
<td>Focuses on accessibility</td>
<td>Focuses on compatibility</td>
</tr>
</table>

<hr>

<h2>Modern HTML Helps</h2>

<p>Modern browsers support many features that once required JavaScript.</p>

<p>Examples include:</p>

<ul>
<li><code class="w3-codespan">required</code> form validation</li>
<li><code class="w3-codespan">&lt;details&gt;</code> expandable content</li>
<li><code class="w3-codespan">loading="lazy"</code> image loading</li>
<li>CSS animations and transitions</li>
</ul>

<p>This makes progressive enhancement easier than ever.</p><hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_htmlfirst.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_htmlfirst_features.asp">Next &#10095;</a>
</div>
