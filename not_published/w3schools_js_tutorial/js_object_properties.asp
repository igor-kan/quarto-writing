...
<a class="w3-left w3-btn" href="js_object_intro.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_object_methods.asp">Next &#10095;</a>
</div>
<!--start-->

<div class="ws-info">
<h2>Properties are <b>key:value</b> Pairs</h2>
<p>A <b>JavaScript object</b> is a <b>collection of properties</b></p>
<p>Properties can be <b>changed</b>, <b>added</b>, and <b>deleted</b>.</p>
</div>

<h2>Accessing JavaScript Properties</h2>
<p>You can access object properties in these ways:</p>
<ul>
<li>Dot notation</li>
...
// <i>objectName.property</i><br>
let age = person.age;
</div>
<div class="w3-code w3-border notranslate jsHigh">
//<i>objectName</i>[&quot;<i>property</i>&quot;]<br>
let age = person[&quot;age&quot;];
</div>
<div class="w3-code w3-border notranslate jsHigh">
//<i>objectName</i>[<i>expression</i>]<br>
let age = person[x];
</div>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_object_properties1">
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_object_properties2">
Try it Yourself &raquo;</a>
</div>
<!--stop-->
<div class="ws-note">

<p>In general, <b>dot notation is preferred</b> for readability and simplicity.</p>
<p>Bracket notation is necessary in some cases:</p>
<ul>
<li>The property name is stored in a variable:<br>
person[myVariable] </li>
<li>The property name is not a valid identifier:<br>
person["last-name"]</li>
</ul>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_object_properties7" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<!--start-->
<h2>Changing Properties</h2>
<p>You can change the value of a property:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
person.age = 10;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_object_properties8" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Adding New Properties</h2>
<p>You can add a new property by simply giving it a value:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<p>The <code class="w3-codespan">delete</code> keyword deletes a property from an object:</p>
<div class="w3-example">
<h3>Examples</h3>
<div class="w3-code notranslate jsHigh">
const person = {<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_object_properties5" target="_blank">
Try it Yourself &raquo;</a>
</div>

<div class="ws-note">
<p>The <code class="w3-codespan">delete</code> keyword deletes both <b>the value and the property</b>.</p>
<p>After deleting, the property is removed. Accessing it will return <code class="w3-codespan">undefined</code>.</p>
</div>
...
<p>Use the <code class="w3-codespan">in</code> operator to check if a property exists in an object:</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_object_properties9" target="_blank">
Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_object_nested">Try it Yourself &raquo;</a>  

<div class="w3-code notranslate jsHigh">
myObj.myCars[&quot;car2&quot;];
</div>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_object_nested2">Try it Yourself &raquo;</a>  

<div class="w3-code notranslate jsHigh">
myObj[&quot;myCars&quot;][&quot;car2&quot;];
</div>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_object_nested3">Try it Yourself &raquo;</a>  
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_object_nested4">Try it Yourself &raquo;</a>  
</div>
<hr>
<h2>Summary</h2>
<ul>
  <li>Object properties are <b>key:value</b> pairs</li>
  <li>Access properties with dot notation or bracket notation</li>
  <li>Add, change, and delete properties using assignment and <code>delete</code></li>
  <li>Use the <b>in</b> operator to check if a property exists</li>
</ul>
<hr>
<!--stop-->
<div class="ws-note">
...
<hr>
<div id="exercisecontainer" src="xrcise_object_property.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_object_intro.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_object_methods.asp">Next &#10095;</a>
