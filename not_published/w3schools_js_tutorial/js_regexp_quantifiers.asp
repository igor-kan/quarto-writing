...
<html lang="en-US">
<head>
<title>JavaScript RegExp Quantifiers</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="js_regexp_groups.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_regexp_patterns.asp">Next &#10095;</a>
</div>

<!--start-->
<div class="ws-info">
<h2>RegExp Quantifiers</h2>
<p>Regular Expression (Regex) quantifiers define how many times the preceding character, group, or character class must occur in a string. They control the boundaries of your matches, allowing patterns to be flexible.</p>
<div class="w3-code notranslate jsHigh">
// Match at least one zero<br>
const pattern = /0+/;
</div>
</div>

<h2>JavaScript RexExp Quantifiers</h2>
...
<p><b><i>x</i></b>+ matches matches at least one <i>x</i>.</p>
<div class="w3-example">
<h3>Example</h3>
<p>A global search for at least one "o":</p>
<div class="w3-code notranslate jsHigh">
let text = "Hellooo World! Hello W3Schools!";<br>
const pattern = /lo+/g;<br>
<br>
let result = text.match(pattern);
</div>
<p>
<a class="w3-btn" href="tryit.asp?filename=tryjs_regexp_n1" target="_blank">Try it Yourself &raquo;</a></p>
</div>

<hr>
<h2>RegExp * Quantifier</h2>
<p><b><i>x</i></b>* matches zero or more occurrences of <i>x</i>.</p>
<div class="w3-example">
<h3>Example</h3>
...
<p>
<a class="w3-btn" href="tryit.asp?filename=tryjs_regexp_n2" target="_blank">Try it Yourself &raquo;</a></p>
</div>
...
<h2>RegExp {n} Quantifier</h2>
<p><b><i>x</i>{<i>n</i>}</b> matches <i>n</i> occurences of <i>x</i>.</p>
<div class="w3-example">
<p>A global search for a string that contains a sequence of four digits:</p>
<div class="w3-code notranslate jsHigh">
let text = &quot;100, 1000 or 10000?&quot;;<br>
let pattern = /\d{4}/g;<br>
<br>
let result = text.match(pattern);
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_regexp_nx" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>RegExp {n,m} Quantifier</h2>
<p><b><i>x</i>{<i>n</i>,<i>m</i>}</b> matches from <i>n</i> to <i>m</i> occurences of <i>x</i>.</p>
<div class="w3-example">
<p>A global search for a substring that contains a sequence of three to four digits:</p>
<div class="w3-code notranslate jsHigh">
let text = &quot;100, 1000 or 10000?&quot;;<br>
let pattern = /\d{3,4}/g;<br>
<br>
let result = text.match(pattern);
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_regexp_nxy" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>RegExp {n,} Quantifier</h2>
<p><b><i>x</i>{<i>n</i>,}</b> matches <i>n</i> or more occurences of <i>x</i>.</p>
<div class="w3-example">
<p>A global search for a sequence of at least three digits:</p>
<div class="w3-code notranslate jsHigh">
let text = &quot;100, 1000 or 10000?&quot;;<br>
let pattern = /\d{3,}/g;<br>
<br>
let result = text.match(pattern);
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_regexp_nxx" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
