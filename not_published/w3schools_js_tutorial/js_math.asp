...
<a class="w3-left w3-btn" href="js_generators.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_math_reference.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
...
<a target="_blank" href="tryit.asp?filename=tryjs_math_pi" class="w3-btn">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<!--start-->
<hr>
<h2>Math Properties (Constants)</h2>
<p>The syntax for any Math property is : <code class="w3-codespan">Math.<i>property</i></code>.</p>
...
<!--start-->
<h2>Math Methods</h2>
<p>The syntax for Math any methods is : <code class="w3-codespan">Math.<i>method</i>(<i>number</i>)</code></p>

<hr>
<h2>Number to Integer</h2>
<p>There are 4 common methods to round a number to an integer:</p>
<table class="ws-table-all">
<tr><tr><td>Math.round(x)</td><td>Returns x rounded to its nearest integer</td></tr>
<tr><tr><td>Math.ceil(x)</td><td>Returns x rounded up to its nearest integer</td></tr>
<tr><tr><td>Math.floor(x)</td><td>Returns x rounded down to its nearest integer</td></tr>
<tr><tr><td>Math.trunc(x)</td><td>Returns the integer part of x (<a href="js_es6.asp">new in ES6</a>)</td></tr>
</table>
<!--stop-->
<hr>
<!--start-->
<h2>Math.round()</h2>
<p><code class="w3-codespan">Math.round(x)</code> returns the nearest integer:</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_math_round_1" target="_blank">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
Math.round(4.5);<br>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_math_round_2" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Math.ceil()</h2>
<p><code class="w3-codespan">Math.ceil(x)</code> returns the value of x rounded <strong>up</strong> to its nearest integer:</p>
...
<!--start-->
<h2>Math.floor()</h2>
<p><code class="w3-codespan">Math.floor(x)</code> returns the value of x rounded <strong>down</strong> to its nearest integer:</p>
...
<!--start-->
<h2>Math.sign()</h2>
<p><code class="w3-codespan">Math.sign(x)</code> returns if x is negative, null or positive.</p>
<ul>
...
<p>Math.trunc() and Math.sign() were added to <a href="js_es6.asp">JavaScript 2015 - ES6</a>.</p>
</div>
<!--stop-->
<hr>
...
<!--start-->
<h2>Math.pow()</h2>
<p><code class="w3-codespan">Math.pow(x, y)</code> returns the value of x to the power of y:</p>
...
<!--start-->
<h2>Math.sqrt()</h2>
<p><code class="w3-codespan">Math.sqrt(x)</code> returns the square root of x:</p>
...
<!--start-->
<h2>Math.abs()</h2>
<p><code class="w3-codespan">Math.abs(x)</code> returns the absolute (positive) value of x:</p>
...
<!--start-->
<h2>Math.sin()</h2>
<p><code class="w3-codespan">Math.sin(x)</code> returns the sine (a value between -1 and 1) of the angle x (given in radians).</p>
...
<!--start-->
<h2>Math.cos()</h2>
<p><code class="w3-codespan">Math.cos(x)</code> returns the cosine (a value between -1 and 1) of the angle x (given in radians).</p>
<p>If you want to use degrees instead of radians, you have to convert degrees to radians:</p>
<p>Angle in radians = Angle in degrees x PI / 180.</p>
...
<p><code class="w3-codespan">Math.min()</code> and <code class="w3-codespan">Math.max()</code> can be used to find the lowest or highest value in a list of arguments:</p>
...
<!--start-->
<h2>Math.random()</h2>
<p><code class="w3-codespan">Math.random()</code> returns a random number between 0 (inclusive), and 1 
(exclusive):</p>
...
<p>You will learn more about <code class="w3-codespan">Math.random()</code> in the next chapter of this tutorial.</p>
</div>
...
<p><code class="w3-codespan">Math.log(x)</code> returns the natural logarithm of x.</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_math_log" target="_blank">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
Math.log(2);
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_math_log_2" target="_blank">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
Math.log(3);
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_math_log_3" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_math_log_ten_times" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<div class="ws-note">
<h2>Learn More:</h2>
<p class="w3-large"><a href="js_math_reference.asp">Full Math Reference</a></p>
</div>
<hr>
