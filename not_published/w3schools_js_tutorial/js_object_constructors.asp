...
<a class="w3-left w3-btn" href="js_object_display.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_scope.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
<h2>Object Constructor Functions</h2>
<p>Sometimes we need to create many objects of the same <b>type</b>.</p>
<p>To create an <b>object type</b> we use an <strong>object constructor function</strong>.</p>
<p>It is considered good practice to name constructor functions with an upper-case first letter.</p>
</div>

<div class="w3-example">
<h3>Object Type Person</h3>
...
<p>In the constructor function, <code class="w3-codespan">this</code> has no value.</p>
<p>The value of <code class="w3-codespan">this</code> will become the new object when 
a new object is created.</p>
<h2>Read More:</h2>
<p class="w3-large"><a href="js_object_this.asp">JavaScript Object <b>this</b></a>.</p>
</div>

<p>Now we can use <code class="w3-codespan">new Person()</code>
...
<br>
const mySelf = new Person(&quot;Johnny&quot;, &quot;Rally&quot;, 22, &quot;green&quot;);<br>
</div>
...
<hr>
<!--start-->
<h2>Property Default Values</h2>
<p>A <b>value</b> given to a property will be a <b>default value</b> for all objects
...
<p>Adding a property to a created object is easy:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<div class="ws-note">
<p>The new property will be added to <b>myFather</b>. Not to any other <b>Person Objects</b>.</p>
</div>
...
<p>You can <b>NOT</b> add a new property to an object constructor:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<p>To add a new property, you must add it to the constructor function prototype:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
Person.prototype.nationality = &quot;English&quot;;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_object_constructor8" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<hr>
<!--start-->
<h2>Constructor Function Methods</h2>
<p>A constructor function can also have <b>methods</b>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
function Person(first, last, age, eyecolor) {<br>
...
this.age = age;<br>
  &nbsp;
this.eyeColor = eyecolor;<br>&nbsp;&nbsp;this.fullName = function() {<br>
...
<p>Adding a method to a created object is easy: </p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<div class="ws-note">
<p>The new method will be added to <b>myMother</b>. Not to any other <b>Person Objects</b>.</p>
</div>
...
<p>You cannot add a new method to an object constructor function.</p>
<p>This code will produce a TypeError:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
Person.changeName = function (name) {<br>
&nbsp; this.lastName = name;<br>
}<br>
<br>
myMother.changeName(&quot;Doe&quot;);
</div>
<p>&nbsp;<code class="w3-codespan">TypeError: myMother.changeName is not a function</code></p>
</div>

<p>Adding a new method to a constructor must be done to the constructor function prototype:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
Person.prototype.changeName = function (name) {<br>
&nbsp; this.lastName = name;<br>
}<br>
<br>
myMother.changeName(&quot;Doe&quot;);
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_object_constructor7" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="ws-note">
<p>The changeName() function assigns the value of <code class="w3-codespan">name</code>
to the person's <code class="w3-codespan">lastName</code> property, substituting <code class="w3-codespan">this</code> with <code class="w3-codespan">myMother</code>.</p>
</div>
...
<p>JavaScript has built-in constructors for all native objects:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
new Object()&nbsp;&nbsp;&nbsp;// A new Object object<br>
new Array()&nbsp;&nbsp;&nbsp;&nbsp;// A new Array object<br>
new Map()&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // A new Map object<br>
new Set()&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // A new Set object<br>
new Date()&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// A new Date object<br>
new RegExp()&nbsp;&nbsp;&nbsp;// A new RegExp object<br>
new Function()&nbsp;// A new Function object<br>
</div>
...
<div class="ws-note">
<p>The <code class="w3-codespan">Math()</code> object is not in the list. <code class="w3-codespan">Math</code> is a global object. The <code class="w3-codespan">new</code> keyword cannot be used on 
<code class="w3-codespan">Math</code>.</p>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Did You Know?</h2>
<p>Use object literals <code class="w3-codespan">{}</code> instead of <code class="w3-codespan">new Object()</code>.</p>
<p>Use array literals <code class="w3-codespan">[]</code> instead of <code class="w3-codespan">new Array()</code>.</p>
<p>Use pattern literals <code class="w3-codespan">/()/</code> instead of <code class="w3-codespan">new RegExp()</code>.</p>
<p>Use function expressions <code class="w3-codespan">() {}</code> instead of <code class="w3-codespan">new Function()</code>.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
&quot;&quot;;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // primitive string<br>
0;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // primitive number<br>
false;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // primitive boolean<br>
<br>
{};&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // object object<br>
[];&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // array object<br>
/()/&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // regexp object<br>
...
<div class="ws-note">
<h2>See Also:</h2>
<p class="w3-large"><a href="js_object_intro.asp">What are JavaScript Objects?</a></p>
...
<p class="w3-large"><a href="js_object_display.asp">How to Display Objects</a></p>
</div>
...
<hr>
<div id="exercisecontainer" src="xrcise_object_constructors.js"></div>
<hr>
