...
<a class="w3-right w3-btn" href="js_logical.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
<h2>The Boolean Data Type</h2>
<p>In JavaScript, a Boolean is a primitive data type that can only have one of two values:</p>
<p class="w3-large"><strong>true</strong> or <strong>false</strong></p>
<p>The Boolean value of an expression is the basis for all JavaScript <b>comparisons</b> and 
<b>conditions</b>.</p>

</div>
<h2>Key Boolean Characteristics</h2>
<ul>
<li>true and false are <b>boolean data types</b></li>
<li><b>true and false</b> are the only possible boolean values</li>
<li>true and false must be written in <b>lowercase</b></li>
<li>true and false must be written <b>without quotes</b></li>
</ul>

<hr>
<h2>Boolean Use Cases</h2>
<p>Very often, in programming, you will need a data type that can represent one 
...
<hr>
<h2>Conditions</h2>
<p>Booleans are extensively used in <b>if statements</b> to determine the code blocks to execute based on the logic.</p>
...
<a target="_blank" href="tryit.asp?filename=tryjs_boolean_if" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="ws-note">
<h2>See Also:</h2>
<p class="w3-large"><a href="js_if.asp">JavaScript if</a></p>
<p class="w3-large"><a href="js_if_else.asp">JavaScript if else</a></p>
</div>
...
<a target="_blank" href="tryit.asp?filename=tryjs_boolean_loop_while" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="ws-note">
<h2>See Also:</h2>
<p class="w3-large"><a href="js_loop_for.asp">JavaScript Loops</a></p>
</div>
...
<div class="ws-note">
<h3>Note</h3>
<p>In JavaScript, both an empty array [ ] and an empty object { } are truthy because they are objects.</p>
<p>All objects in JavaScript evaluate to true in a boolean context, regardless of their content.</p>
</div>
<hr>
