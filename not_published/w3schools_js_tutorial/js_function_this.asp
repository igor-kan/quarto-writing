...
<html lang="en-US">
<head>
<title>JavaScript this in Functions</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="js_callback.asp">&#10094; Previous</a>
...
<p class="w3-large"><a href="js_functions.asp">JavaScript Functions Tutorial</a></p>
</div>

<hr>
<h2>Functions are Object Methods</h2>
<p><b>All JavaScript functions are object methods</b>.</p>
...
<hr>
<h2>JavaScript globalThis</h2>
<p>In JavaScript, <code class="w3-codespan">globalThis</code> is a special built-in object that provides a standard way to access the global object,
regardless of the environment your code runs in - whether it is a browser, Node.js, a Web Worker,
or another JS runtime.</p>
...
<p>Each environment used to have its own name for this object.
...
&lt;button onclick="this.innerHTML='Clicked!'"&gt;Click Me&lt;/button&gt;<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_this_click" target="_blank">Try it Yourself &raquo;</a>
<div class="w3-code notranslate htmlHigh">
&lt;button onclick=&quot;this.style.display='none'&quot;&gt;<br>&nbsp; Click to 
Remove Me!<br>&lt;/button&gt;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_this_event"
...
<p>In regular functions the <b>this</b> keyword represents the object that called the 
...
<h2><b>This</b> Precedence</h2>
<p>Use the following precedence of order to determine which object <code class="w3-codespan">this</code> refers to:</p>


<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
<tr><td>Order</td><td>Object</td><th>Because</th></tr>
<tr><td>1</td><td>bind()</td>
<td><code class="w3-codespan">this</code> is in a function being called using bind()</td>
</tr>
<tr><td>2</td><td>apply()</td>
<td><code class="w3-codespan">this</code> is in a function being called using apply()</td>
</tr>
<tr><td>2</td><td>call()</td>
<td><code class="w3-codespan">this</code> is in a function being called using call()</td>
</tr>
<tr><td>3</td><td>Object method</td>
<td><code class="w3-codespan">this</code> is in an object function (method)</td></tr>
<tr><td>4</td><td>Global scope</td>
<td><code class="w3-codespan">this</code> is in a function in the global scope</td>
</tr>
</table>
</div>
...
<div class="w3-code notranslate jsHigh">
  // Regular Function:<br>hello = function() {<br>&nbsp; document.getElementById(&quot;demo&quot;).innerHTML 
  += this;<br>}<br><br>// The window object calls the function:<br>
  window.addEventListener(&quot;load&quot;, hello);<br><br>// A button object calls the 
  function:<br>document.getElementById(&quot;btn&quot;).addEventListener(&quot;click&quot;, hello);</div>
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_arrow_function6">Try it Yourself &raquo;</a>
</p>
<p>With an arrow function <b>this</b> represents the 
<em>owner</em> of the function:</p>
<div class="w3-code notranslate jsHigh">
  // Arrow Function:<br>hello = () =&gt; {<br>&nbsp; document.getElementById(&quot;demo&quot;).innerHTML 
  += this;<br>}<br><br>// The window object calls the function:<br>
  window.addEventListener(&quot;load&quot;, hello);<br><br>// A button object calls the 
  function:<br>document.getElementById(&quot;btn&quot;).addEventListener(&quot;click&quot;, hello);</div>
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_arrow_function7">Try it Yourself &raquo;</a>
</p>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_this_arrow" target="_blank">Try it Yourself &raquo;</a>
...
<p class="w3-large"><a href="js_function_call.asp">The JavaScript call() Function</a></p>
<p class="w3-large"><a href="js_function_apply.asp">The JavaScript apply() Function</a></p>
<p class="w3-large"><a href="js_function_bind.asp">The JavaScript bind() Function</a></p>
</div>
<hr>

<div id="exercisecontainer" src="xrcise_this.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_callback.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_function_call.asp">Next &#10095;</a>
