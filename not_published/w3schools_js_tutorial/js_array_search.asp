...
<tr>
<td>
<a href="#mark_indexof">Array indexOf()</a><br>
<a href="#mark_lastindexof">Array lastIndexOf()</a><br>
<a href="#mark_includes">Array includes()</a><br>
</td>
<td>
<a href="#mark_find">Array find()</a><br>
<a href="#mark_findindex">Array findIndex()</a><br>
<a href="#mark_findlast">Array findLast()</a><br>
<a href="#mark_findlastindex">Array findLastIndex()</a><br>
</td></tr>
</table>
...
<p class="w3-large"><a href="js_array_methods.asp">JavaScript Basic Array Methods</a><br>
...
<p class="w3-large"><a href="js_array_reference.asp">JavaScript Array Reference</a>
</div>
<!--stop-->
<!--start-->
<hr>
...
<p>The <code class="w3-codespan">indexOf()</code> method searches an array for an element value and returns its position.</p>
<div class="ws-note">
...
<p><code class="w3-codespan">Array.indexOf()</code> returns -1 if the item is not found.</p>
...
<p><code class="w3-codespan">Array.lastIndexOf()</code> is the same as <code class="w3-codespan">Array.indexOf()</code>, but 
returns the position of the last occurrence of the specified element.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Search an array for the item "Apple":</p>
<div class="w3-code notranslate jsHigh">
...
<p>ECMAScript 2016 introduced <code class="w3-codespan">Array.includes()</code> to arrays.
This allows us to check if an element is present in an array (including NaN, unlike indexOf).</p>
<div class="w3-example">
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_array_includes" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<p><code class="w3-codespan">includes()</code> is an ECMAScript 2016 feature.</p>
<p><b><a href="js_2016.asp">ES2016</a></b> is fully supported in all modern browsers since <b>March 2017</b>:</p>
...
<!--stop-->
<h2>Browser Support</h2>
<p><code class="w3-codespan">find()</code> is an <a href="js_es6.asp">ES6  feature</a>.</p>
...
<!--stop-->
<h2>Browser Support</h2>
<p><code class="w3-codespan">findIndex()</code> is an <a href="js_es6.asp">ES6  feature</a>.</p>
<p>ES6 is fully supported in all modern browsers since June 2017:</p>
...
<!--stop-->
<h2>Browser Support</h2>
<p><code class="w3-codespan">findLast()</code> is an ECMAScript 2023 feature.</p>
<p><a href="js_2023.asp">JavaScript 2023</a> is supported in all modern browsers since 
<b>July 2023</b>:</p>
...
<!--stop-->
<h2>Browser Support</h2>
<p><code class="w3-codespan">findLastIndex()</code> is an ECMAScript 2023 feature.</p>
<p><a href="js_2023.asp">JavaScript 2023</a> is supported in all modern browsers since 
<b>July 2023</b>:</p>
...
<hr>
<div id="exercisecontainer" src="xrcise_array_search.js"></div>
<hr>
