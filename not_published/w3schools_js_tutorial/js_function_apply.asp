...
<a class="w3-right w3-btn" href="js_function_bind.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
<h2>Method Reuse</h2>
<p>The <b>apply()</b> method lets you write a method that can be used on different objects.</p>
<p>The <b>apply()</b> method is used to call a function with a specific <b>this</b>.<br>
<p>The <b>apply()</b> method is similar to <b>call()</b>, but it passes <b>arguments in an array</b>.</p>
</div>


<div class="ws-note">

<p><b>apply()</b> is an advanced topic.</p>
<p>Make sure you understand <b>this</b> and <b>call()</b> before continuing.<br>
<p class="w3-large"><a href="js_function_this.asp">The <b>this</b> Keyword</a></p>
<p class="w3-large"><a href="js_function_call.asp">The <b>call()</b> Method</a></p>
</div>

<hr>
<h2>Basic apply() Syntax</h2>
<p>The <b>apply()</b> method is used to <b>call a function</b> with an <b>object as an argument</b>.</p>
<p>The <b>apply()</b> method takes <b>this</b> as the first argument.</p>
<p>The second argument is <b>an array of values</b> passed to the function.</p>
<p>The <b>apply()</b> method is similar to the <b>call()</b> method (previous chapter).</p>

<div class="w3-example">
<h3>Syntax</h3>
<div class="w3-code notranslate jsHigh">
functionName.apply(<b>this</b>, [arg1, arg2, ...]);<br>
</div>
</div>

<hr>
<h2>Using apply() to Set <b>this</b></h2>'
<p>When you use <b>apply()</b>, you can decide what <b>this</b> should refer to.</p>
<p>In the example below, the <b>greet function</b> returns a greeting + <b>this.name</b>.</p>
<p>When you use <b>apply()</b>, you decide that <b>this</b> should be the <b>person3</b> object.</p>


<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const person1 = { name: "John" };<br>
const person2 = { name: "Paul" };<br>
const person3 = { name: "Ringo" };<br>
<br>
function greet(greeting) {<br>
&nbsp;&nbsp;return greeting + " " + this.name;<br>
}<br><br>
greet.apply(person3, ["Hello"]);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_function_apply_greeting" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>The Difference Between call() and apply()</h2>
<p>The only difference between <b>apply()</b> and <b>call()</b> is how arguments are passed.</p>
<p>The <b>call()</b> method takes arguments <b>separately</b>.</p>
<p>The <b>apply()</b> method takes arguments as an <b>array</b>.</p>

<div class="ws-note">

<p>Use <b>apply()</b> when your arguments are already stored in an array.</p>
</div>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
greet.call(person, "Hello");<br>
greet.apply(person, ["Hello"]);<br>
</div>
</div>

<hr>
<h2>Borrowing a Method from Another Object</h2>
<p>You can use <b>apply()</b> to <b>borrow a method</b> from another object:</p>
<div class="w3-example">
<h3>Example 1</h3>
<p>Apply the <b>fullName</b> method of <b>person</b> on <b>person1</b>:</p>
<div class="w3-code notranslate jsHigh">
...
&nbsp;&nbsp;&nbsp;&nbsp;return this.firstName + &quot; &quot; + this.lastName;<br>
  &nbsp;&nbsp;}<br>}<br>
<br>
// Create a person1 Object<br>
const person1 = {<br>
&nbsp;&nbsp;firstName:&quot;John&quot;,<br>
  &nbsp; lastName: &quot;Doe&quot;<br>
  }<br>
<br>
// Create a person2 Object<br>
const person2 = {<br>
&nbsp; firstName:&quot;Mary&quot;,<br>
  &nbsp; lastName: &quot;Doe&quot;<br>}<br>
<br>
// This will return &quot;John Doe&quot;:<br>  
  person.fullName.apply(<b>person1</b>);
</div>
<p>
...
<p>In these 2 examples, the <b>apply() method</b> behaves exactly the same as the <b>call() method</b>.</p>
</div>
<div class="w3-example">
<h3>Example 2</h3>
<p>Apply the <b>fullName</b> method of <b>person</b> on <b>person2</b>:</p>
...
const person2 = {<br>
  ...
  &nbsp; lastName: &quot;Doe&quot;<br>}<br>
<br>
// This will return &quot;Mary Doe&quot;<br>
  person.fullName.call(<b>person2</b>);
</div>
<p>
<a class="w3-btn" href="tryit.asp?filename=tryjs_function_apply2" target="_blank">Try it Yourself &raquo;</a>
</p>
</div>

<hr>
<h2>The apply() Method with Arguments</h2>
<p>The <b>apply()</b> method accepts arguments in an array.</p>
<p>All arguments must be placed inside an array, in the correct order.</p>
...
<!--stop-->
<!--start-->
<p>Compared with the <b>call()</b> method:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const person = {<br>
...
<h2>Simulate Array Methods with apply()</h2>

<p>A common use case for <b>apply()</b> is working with Math functions on arrays.</p>
<p>The <b>Math.max()</b> method returns the highest number in a list of number arguments:</p>
...
<p>JavaScript Arrays <b>do not</b> have a max() method, but you can <b>simulate</b> it with the <b>apply</b> method.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const numbers = [4, 8, 5, 1];<br>
<br>
...
<p>In the example above, <b>null</b> is used as <b>this</b>, because <b>Math.max()</b> does
not need a <b>this</b> value.</p>
...
<p>In JavaScript strict mode, if the first argument of the <b>apply()</b> method is not an object,
it becomes the owner (object) of the invoked function.
In "non-strict" mode, it becomes the global object.</p>
<!--stop-->

<hr>
<h2>apply() Does Not Create a New Function</h2>
<p>The <b>call()</b> method and the <b>apply()</b> method runs the function immediately.<br>
<p>They do not return a new function.</p>
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate jsHigh">
    ...
    sum.apply(null, [4, 5]);<br>
  </div>
</div>

<p>If you want a function that can be called later with the same <b>this</b>, use <b>bind()</b> instead.</p>

<hr>
<h2>Common Mistakes</h2>
<ul class="w3-ul">
<li><h3>Forgetting to Use an Array</h3>
The second argument to <b>apply()</b> must be an array.</li>

<li><h3>Confusing apply() with bind()</h3>
<b>apply()</b> runs immediately. <b>bind()</b> returns a new function.</li>

<li><h3>Using <b>apply()</b> when <b>call()</b> is Simpler</h3>
If you do not have an array, <b>call()</b> is often clearer.</li>
</ul>

<div class="ws-note">
<h2>Related <b>this</b> Topics</h2>
<p class="w3-large"><a href="js_function_this.asp">The <b>this</b> Keyword</a></p>
<p class="w3-large"><a href="js_function_call.asp">The <b>call()</b> Method</a></p>
<p class="w3-large"><a href="js_function_apply.asp">The <b>apply()</b> Method</a></p>
<p class="w3-large"><a href="js_function_bind.asp">The <b>bind()</b> Method</a></p>
</div>

<h2>Next Chapter</h2>
<p class="w3-large"><a href="js_function_bind.asp">JavaScript Function bind()</a></p>
