...
<!DOCTYPE html>
<html lang="en-US">
<head><title>JavaScript Error Object</title>
<meta charset="utf-8">
...
an error occurs. </p>
<p>The error object provides useful properties like <b>name</b> and <b>message</b>.</p>
</div>
<h2>Error Object Methods &amp; Properties</h2>
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><a href="/jsref/jsref_error_new_error.asp">new Error()</a></td>
    <td>Creates a new Error object</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_error_name.asp">name</a></td>
    <td>Sets or returns an error name</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_error_message.asp">message</a></td>
    <td>Sets or returns an error message</td>
  </tr>
  <tr>
    <td><a href="/jsref/prop_error_cause.asp">cause</a></td>
    <td>Sets or returns an error cause</td>
  </tr>
  <tr>
    <td><a href="/jsref/jsref_error_iserror.asp">Error.isError(x)</a></td>
    <td>Returns true if a value (x) is an Error</td>
  </tr>
</table>
<!--stop-->
<hr>
...
<tr><td>EvalError</td><td>Deprecated - use SyntaxError instead</td><td>&nbsp;</td></tr>
<tr><td>RangeError</td><td>A number &quot;out of range&quot; has occurred</td><td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryjs_error_rangeerror">Try it &raquo;</a></td></tr>
<tr><td>ReferenceError</td><td>An illegal reference has occurred</td><td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryj_error_referenceerror">Try it &raquo;</a></td></tr>
<tr><td>SyntaxError</td><td>A syntax error has occurred</td><td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryjs_error_syntaxerror">Try it &raquo;</a></td></tr>
<tr><td>TypeError</td><td>A type error has occurred</td><td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryjs_error_typeerror">Try it &raquo;</a></td></tr>
<tr><td>URIError</td><td>An error in encodeURI() has occurred</td><td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryjs_error_urierror">Try it &raquo;</a></td></tr>
</table>

<hr>
<div class="w3-panel ws-warning">
<h2>Non-Standard Properties and Methods</h2>
<p>In older JavaScript code you might find non-standard properties and methods.</p>
<p>Do not use these properties and methods. They will not work in all browsers.</p>
