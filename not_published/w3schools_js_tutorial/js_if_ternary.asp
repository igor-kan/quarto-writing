...
<html lang="en-US">
<head>
<title>JavaScript Conditional Ternary Operator</title>
<meta charset="utf-8">
...
<h1>The JavaScript Ternary Operator</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="js_if_else.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-right w3-btn" href="js_switch.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
...
<h3>Example</h3>
<p>If the <b>value of age</b> is <b>&lt; 18</b>, set the value of <b>text</b> to
<b>"Minor"</b>, otherwise to <b>"Adult"</b>:</p>

<div class="w3-code notranslate jsHigh">
let text = (age &lt; 18) ?  "Minor" : "Adult";
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_if_ternary">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_if_ternary1">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let isMember = false;<br>
let discount = isMember ? 0.2 : 0;<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_if_ternary2">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Description</h2>
<p>The conditional operator is a shorthand for writing conditional
<code class="w3-codespan">if...else</code> statements.</p>
<p>It is called a ternary operator because it takes three operands.</p>

<div class="w3-example">
<h3>Syntax</h3>
<div class="w3-code notranslate jsHigh">
(<em>condition</em>) ?<em> expression1</em> : <em>expression2</em>
</div>
</div>
...
<tr><td><i>condition</i></td>
<td>Required.<br>
The condition to be tested.<br>
An expression that evaluates to <code class="w3-codespan">true</code>
or <code class="w3-codespan">false</code>.</td></tr>
<tr><td>?</td>
<td>Required.<br>
The operator separating the condition from the expressions.</td></tr>
<tr><td><i>expression1</i></td>
<td>Required.<br>
The value to return if the condition is <code class="w3-codespan">true</code>.</td></tr>
<tr><td>:</td>
<td>Required.<br>
The operator separating the expressions.</td></tr>
<tr><td><i>expression2</i></td>
<td>Required.<br>
The value to return if the condition is <code class="w3-codespan">false</code>.</td></tr>
</table>
</div>

<div class="ws-note">

<p>The conditional (ternary) operator is the only JavaScript
operator that takes three operands.</p>
</div>
<!--stop-->

<hr>
<h2>Browser Support</h2>
<p><code class="w3-codespan">() ? x : y</code> is an ES1  feature (JavaScript 1997).</p>
