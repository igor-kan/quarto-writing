...
<a class="w3-left w3-btn" href="js_function_iife.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_function_reference.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
<p class="intro">JavaScript variables can belong to:</p>
<ul>
<li>The <b>local scope</b></li>
<li>The <b>global scope</b></li>
</ul>
...
<p><b>Closures</b> are an advanced topic.</p>
<p>Make sure you understand JavaScript <b>functions</b> and <b>scope</b> first.</p>
<p class="w3-large"><a href="js_functions.asp">JavaScript Functions</a></p>
...
<p>A <b>function</b> can access all variables in the <b>local scope</b>.</p>
...
<p>A <b>function</b> can access all variables in the <b>global scope</b>:</p>
<div class="w3-example">
<h3>Example</h3>
<p><b>a</b> is <b>global variable</b> defined outside the function:</p>
<div class="w3-code notranslate jsHigh">
let a = 4;<br>function myFunction() {<br>
  &nbsp; return a * a;<br>
}
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_function_scope4" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<p>You could use a global variable, and a <b>function</b> to increase the counter:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
  // Initiate counter<br>let counter = 0;<br><br>// Function to increment 
...
<div class="w3-code notranslate jsHigh">
  // Initiate counter<br>let counter = 0;<br><br>// Function to increment 
  counter<br>function add() {<br>&nbsp; let counter = 0; <br>&nbsp; 
  counter += 1;<br>}<br><br>// 
...
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Function to increment counter<br>
function add() {<br>
&nbsp; let counter = 0;<br>
&nbsp; counter += 1;<br>
&nbsp;&nbsp;return counter;<br>
...
x = add();<br>
x = add();<br>
<br>// The counter should now be 3. But it is 1.
</div>
...
<p>Old JavaScript code often contains closures, but modern JavaScript will not use closures as frequently.</p>
...
<hr>
<h2>Modern Alternative: Private Class Fields</h2>
<p>Since ECMAScript 2022, JavaScript supports real private class fields using the <code class="w3-codespan">#</code>
syntax.</p>
<p>Private fields are enforced by the language and cannot be accessed outside the class.</p>
<p>All modern browsers support private class fields.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
class Counter {<br>
...
<br>
const myCounter = new Counter();<br>
myCounter.increment();
</div>
</div>

<p>Private class fields are usually preferred when working with classes.</p>
<ul>
<li>They provide true privacy.</li>
<li>They are simpler than closure-based patterns inside classes.</li>
<li>They are part of the official ECMAScript standard.</li>
</ul>

<p>Closures are still important and useful outside of classes.</p>
<p>Closures are also widely used in older codebases and functional programming patterns.</p>
<hr>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_function_iife.asp">&#10094; Previous</a>
