...
<h1>JavaScript Primitives</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_datatypes.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_datatypes_objects.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
<p class="w3-large">A <b>JavaScript variable</b> can hold <b>8 types</b> of data.</p>
<p class="w3-large"><b>7 Primitive</b> types or an <b>Object</b> type.</p>
</div>
...
<div class="ws-note">
<h2>Learn More:</h2>
<p class="w3-large"><a href="js_string_methods.asp">JavaScript String Methods</a></p>
<p class="w3-large"><a href="js_string_search.asp">JavaScript String Search</a></p>
<p class="w3-large"><a href="js_string_reference.asp">JavaScript String Reference</a></p>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>Whole numbers (integers):<br>
<b>byte</b> (8-bit), <b>short</b> (16-bit), <b>int</b> (32-bit), <b>long</b> (64-bit)</p>
<p>Real numbers (floating-point):<br>
<b>float</b> (32-bit), <b>double</b> (64-bit).</p>
<p><b>Javascript numbers are always double (64-bit floating point).</b></p>
<hr>
<div class="ws-note">
<h2>Learn More:</h2>
<p class="w3-large"><a href="js_numbers.asp">JavaScript Numbers Tutorial</a></p>
<p class="w3-large"><a href="js_number_methods.asp">JavaScript Number Methods</a></p>
<p class="w3-large"><a href="js_number_properties.asp">JavaScript Number Properties</a></p>
<p class="w3-large"><a href="js_number_reference.asp">JavaScript Number Reference</a></p>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>JavaScript BigInt is a new datatype (<a href="js_2020.asp">ES2020</a>) that can be used to store integer values that are too big to be represented
by a normal JavaScript Number.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let x = BigInt("123456789012345678901234567890");
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_bigint">Try 
it Yourself &raquo;</a></div>
<div class="ws-note">
<h2>Learn More:</h2>
<p class="w3-large"><a href="js_bigint.asp">JavaScript BigInt Tutorial</a></p>
</div>
<!--stop-->
<hr>
<!--start-->
...
<div class="ws-note">
<h2>Learn More:</h2>
<p class="w3-large"><a href="js_booleans.asp">JavaScript Boolean Tutorial</a></p>
</div>
<!--stop-->
<hr>
...
<!--start-->
<h2>Undefined</h2>
<p>In JavaScript, a variable without a value, has the value <code class="w3-codespan">undefined</code>. 
The type is also <code class="w3-codespan">undefined</code>.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<p>Any variable can be emptied, by setting the value to <code class="w3-codespan">undefined</code>. 
The type will also be <code class="w3-codespan">undefined</code>.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<!--start-->
<h2>Datatype null</h2>
<p>In JavaScript, a variable or an expression can obtain the datatype null in several ways.
<p>A function can return null or a variable can be assigned the null value:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let carName = null;
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_types_null" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="ws-note">

<p>The <b>typeof</b> operator returns <b>object</b> for null.</p>
<p>This is a historical quirk in JavaScript and does not indicate that null is an object.</p>
</div>

<p>The <b>strict equality operator (===)</b> compares both the value and the type of the operands.</p>
<p>It returns <code class="w3-codespan">true</code> only if both the operands values and types are
<code class="w3-codespan">null</code>.</p>

<p>The <b>loose equality operator</b> (==) also returns <code class="w3-codespan">true</code>
for a <code class="w3-codespan">null</code> value,
but it also returns true if the value is <code class="w3-codespan">undefined</code>.</p>
<p>Using == is not recommended when checking for <code class="w3-codespan">null</code>.</p>
<!--stop-->
