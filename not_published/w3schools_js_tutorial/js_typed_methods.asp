...
<!DOCTYPE html>
<html lang="en-US">
<head><title>JavaScript Typed Array Methods</title>
<meta charset="utf-8">
...
<h1>Typed Array Methods</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_typed_arrays.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_typed_reference.asp">Next &#10095;</a>
</div>

<hr>
<h2>The from() Method</h2>
<p>The <code class="w3-codespan">from()</code>method creates a new typed array from any iterable object:</p>
<div class="w3-example">
<h3>Examples</h3>
<p>Create a typed array from a string:</p>
<div class="w3-code notranslate jsHigh">
const myArr = Int16Array.from("1234567890");
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_typed_from_string" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
<p>Create a typed array from an array:</p>
<div class="w3-code notranslate jsHigh">
const myArr = Int16Array.from([1,2,3,4,5,6,7,8,9,0]);
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_typed_from_array" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>The of() Method</h2>
<p>The <code class="w3-codespan">of()</code> method creates a new typed array from a number of arguments:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const myArr = Int16Array.of(1,2,3,4,5,6,7,8,9,0);
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_typed_of" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>The constructor.name Property</h2>
<p>The <code class="w3-codespan">constructor.name</code> property returns the name (type) of a typed array:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
myArr.constructor.name
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_typed_name" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>The BYTES_PER_ELEMENT Property</h2>
<p><code class="w3-codespan">BYTES_PER_ELEMENT</code> returns the number of bytes used to store each array element:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
myArr.BYTES_PER_ELEMENT
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_typed_bytes" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Common Array Methods</h2>
<p><b>Typed Arrays</b> share many methods with <b>Standard Arrays</b>:</p>
<ul>
<li><p><b>Iteration</b>: forEach(), map(), filter(), reduce(), reduceRight(), every(), some(), find(),
findIndex(), findLast(), findLastIndex().</p></li>
<li><p><b>Searching</b>: includes(), indexOf(), lastIndexOf().</p></li>
<li><p><b>Manipulation</b>: at(), copyWithin(), fill(), reverse(), set(), slice(), sort(), subarray().</p></li>
<li><p><b>Conversion</b>: join(), toLocaleString(), toString().</p></li>
<li><p><b>Non-mutating methods</b>: toReversed(), toSorted(), with().</p></li>
</ul>

<hr>
<h2>The fill() Method</h2>
<p>The <code class="w3-codespan">fill()</code> method changes all elements in a typed array to a value:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Fill <b>all</b> array elements with a value:</p>
<div class="w3-code notranslate jsHigh">
myArr.fill(200);
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_typed_fill" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>The <code class="w3-codespan">fill()</code> method takes two optional arguments: start index and end index:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Fill <b>some</b> array elements with a value:</p>
<div class="w3-code notranslate jsHigh">
myArr.fill(200, 0, 3);
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_typed_fill_some" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>The find() Method</h2>
<p>The <code class="w3-codespan">find()</code> method returns the first element that satisfies a test:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
myArr.find((x) =&gt; x &gt; 18)
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_typed_find" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>The some() Method</h2>
<p>The <code class="w3-codespan">some()</code> method returns true if an element for which a provided function returns true:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
myArr.some((x) =&gt; x &gt; 18)
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_typed_some" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<h2>Not Available Array Methods</h2>
<p>Some array methods are NOT available for typed array.</p>
<p>This is due to the fixed-length nature and the lack of fixed structure.</p>
<table class="ws-table-all">
<tr><th>Method</th><th>Array</th><th>Typed Array</th></tr>
<tr><td>pop()</td><td>Yes</td><td>NO</td></tr>
<tr><td>push()</td><td>Yes</td><td>NO</td></tr>
<tr><td>shift()</td><td>Yes</td><td>NO</td></tr>
<tr><td>unshift()</td><td>Yes</td><td>NO</td></tr>
<tr><td>splice()</td><td>Yes</td><td>NO</td></tr>
<tr><td>flat()</td><td>Yes</td><td>NO</td></tr>
<tr><td>flatMap()</td><td>Yes</td><td>NO</td></tr>
<tr><td>concat()</td><td>Yes</td><td>NO</td></tr>
<tr><td>toSpliced()</td><td>Yes</td><td>NO</td></tr>
</table>
