...
<a class="w3-right w3-btn" href="js_array_search.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
...
<tr><td>
<a href="#mark_length">Array length</a><br>
<a href="#mark_tostring">Array toString</a>()<br>
<a href="#mark_at">Array at()</a><br>
<a href="#mark_join">Array join()</a><br>
<a href="#mark_pop">Array pop()</a><br>
<a href="#mark_push">Array push()</a><br>
<a href="#mark_shift">Array shift()</a><br>
<a href="#mark_unshift">Array unshift()</a><br>
</td>
<td>
<a href="#mark_isarray">Array isArray()</a><br>
<a href="#mark_delete">Array delete()</a><br>
<a href="#mark_concat">Array concat()</a><br>
<a href="#mark_copywithin">Array copyWithin()</a><br>
<a href="#mark_flat">Array flat()</a><br>
<a href="#mark_slice">Array slice()</a><br>
<a href="#mark_splice">Array splice()</a><br>
<a href="#mark_tospliced">Array toSpliced()</a><br>
</td></tr>
</table>
...
<div class="ws-note">
<h2>See Also:</h2>
<p class="w3-large"><a href="js_arrays.asp">JavaScript Array Tutorial</a><br>
<p class="w3-large"><a href="js_array_search.asp">JavaScript Array Search Methods</a><br>
<p class="w3-large"><a href="js_array_sort.asp">JavaScript Array Sort Methods</a><br>
<p class="w3-large"><a href="js_array_iteration.asp">JavaScript Array Iteration Methods</a><br>
</div>
...
<p>The <code class="w3-codespan">length</code> property <b>returns the length</b> (size) of an array:</p>
...
<p>The <code class="w3-codespan">length</code> property can also be used to <b>set the length</b> of an array:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const fruits = [&quot;Banana&quot;, &quot;Orange&quot;, &quot;Apple&quot;, &quot;Mango&quot;];<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_array_length_set" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<a id="mark_tostring"></a>
<h2>JavaScript Array toString()</h2>

<p>The <code class="w3-codespan">toString()</code> method returns the elements of an array as a comma separated string.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const fruits = [&quot;Banana&quot;, &quot;Orange&quot;, &quot;Apple&quot;, &quot;Mango&quot;];<br>
...
<a class="w3-btn w3-margin-bottom w3-margin-top" href="tryit.asp?filename=tryjs_array_tostring" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<div class="ws-note">

<p>Every JavaScript object has a <code class="w3-codespan">toString()</code> method.</p>
<p>The <code class="w3-codespan">toString()</code> method is used internally by JavaScript
when an object needs to be displayed as a text (like in HTML),
or when an object needs to be used as a string.</p>
</div>
...
<p><a href="js_2022.asp">ES2022</a> introduced the array method <code class="w3-codespan">at()</code>:</p>

<div class="w3-example">
<h3>Examples</h3>
<p>Get the third element of fruits using at():</p>
<div class="w3-code notranslate jsHigh">
const fruits = [&quot;Banana&quot;, &quot;Orange&quot;, &quot;Apple&quot;, &quot;Mango&quot;];<br>
let fruit = fruits.at(2);
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_array_at" class="w3-btn">Try it Yourself &raquo;</a>
<p>Get the third element of fruits using []:</p>
<div class="w3-code notranslate jsHigh">
const fruits = [&quot;Banana&quot;, &quot;Orange&quot;, &quot;Apple&quot;, &quot;Mango&quot;];<br>
let fruit = fruits[2];
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_array_at2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p>Many languages allow <code class="w3-codespan">negative bracket indexing</code> like [-1] to access elements from the end of an
...
<a class="w3-btn w3-margin-bottom w3-margin-top" href="tryit.asp?filename=tryjs_array_join" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<p>Shifting is equivalent to popping, but working on the first element instead of 
the last.</p>
<hr>
<a id="mark_shift"></a>
<h2>JavaScript Array shift()</h2>

<p>The <code class="w3-codespan">shift()</code> method removes the first array element and &quot;shifts&quot; all 
...
<p>The <code class="w3-codespan">unshift()</code> method adds a new element to an array (at the beginning), and &quot;unshifts&quot; 
older elements: </p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<a id="mark_isarray"></a>
<h2>Array.isArray()</h2>
<p>ECMAScript 5 (JavaScript 2009) added the new method
<code class="w3-codespan">Array.isArray()</code> to JavaScript:</p>
...
<h3>Warning !</h3>
<p>Using <code class="w3-codespan">delete()</code> leaves <code class="w3-codespan">undefined</code> holes in the 
array.</p>
...
<!--start-->
<a id="mark_concat"></a>
<h2>Merging Arrays (Concatenating)</h2>
...
<hr>
<h2>JavaScript Array concat()</h2>
<p>The <code class="w3-codespan">concat()</code> method creates a new array by merging (concatenating) 
existing arrays:</p>
<div class="w3-example">
...
<hr>
<!--start-->
<a id="mark_copywithin"></a>
<h2>Array copyWithin()</h2>
<p>The <code class="w3-codespan">copyWithin()</code> method copies array elements to another position in an array:</p>
<div class="w3-example">
<h3>Examples</h3>
...
<a target="_blank" href="tryit.asp?filename=tryjs_array_copywithin" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
...
<a target="_blank" href="tryit.asp?filename=tryjs_array_copywithin2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="w3-panel ws-note">

<p>The <code class="w3-codespan">copyWithin()</code> method overwrites the existing values.</p>
<p>The <code class="w3-codespan">copyWithin()</code> method does not add items to the array.</p>
<p>The <code class="w3-codespan">copyWithin()</code> method does not change the length of the array.</p>
</div>
<!--stop-->
<hr>
<!--start-->
...
<hr>
<h2>JavaScript Array flat()</h2>
<p><a href="js_2019.asp">ES2019</a> Introduced the Array flat() method.</p>
<p>The <code class="w3-codespan">flat()</code> method creates a new array with sub-array elements concatenated to a specified depth.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_array_flat" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Browser Support</h2>
<p><code class="w3-codespan">flat()</code> is an ECMAScript 2019 feature.</p>
...
<p>ES2019 added the Array <code class="w3-codespan">flatMap()</code> method to JavaScript.</p>
...
<p>With clever parameter setting, you can use <code class="w3-codespan">splice()</code> to remove elements without leaving 
...
<hr>
<a id="mark_tospliced"></a>
<h2>JavaScript Array toSpliced()</h2>
<p><a href="js_2023.asp">ES2023</a> added the Array toSpliced() method as a safe way to splice an array without altering the original array.</p>
<p>The difference between the new <b>toSpliced()</b> method and the old <b>splice()</b> method is that the new method
creates a new array, keeping the original array unchanged, while the old method altered the original array.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<a target="_blank" href="tryit.asp?filename=tryjs_array_tospliced" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>The <code class="w3-codespan">slice()</code> method slices out a piece of an array into a new 
array:</p>
...
<p>If the end argument is omitted, like in the first examples, the <code class="w3-codespan">slice()</code> 
...
<p><a href="js_array_search.asp">Searching arrays</a> are covered in the next chapter of this tutorial.</p>

<hr>
<h2>Sorting Arrays</h2>
<p><a href="js_array_sort.asp">Sorting arrays</a> covers the methods used to sort arraysg.</p>

<hr>
<h2>Iterating Arrays</h2>
<p><a href="js_array_iteration.asp">Iterating arrays</a> covers methods that operate on all array elements.</p>
<hr>
<div id="exercisecontainer" src="xrcise_array_methods.js"></div>
<hr>
