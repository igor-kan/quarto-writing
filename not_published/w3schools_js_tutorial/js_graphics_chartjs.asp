...
<a class="w3-left w3-btn" href="js_graphics_plotly.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_graphics_google_chart.asp">Next &#10095;</a>
</div>
<div class="w3-panel ws-info">
<p><b>Chart.js</b> is an free JavaScript library for making HTML-based charts.
It is one of the simplest visualization libraries for JavaScript, and 
comes with the many built-in chart types:</p>
<ul>
<li>Scatter Plot</li>
<li>Line Chart</li>
<li>Bar Chart</li>
...
<p><b>1.</b> Add a link to the providing CDN (Content Delivery Network):</p>
<div class="w3-code notranslate htmlHigh">
&lt;script<br>
src="https://cdn.jsdelivr.net/npm/chart.js@4.5.0"&gt;<br>
&lt;/script&gt;
</div>
</div>
<div class="w3-example">
<p><b>2.</b> Add a &lt;canvas&gt; to where in the HTML you want to draw the chart:</p>
<div class="w3-code notranslate htmlHigh">
&lt;canvas&gt;<br>
id="myChart" style="width:100%;max-width:700px"<br>
&lt;/canvas&gt;
</div>
...
<h3>Source Code</h3>
<div class="w3-code notranslate jsHigh">
const xValues = ["Italy", "France", "Spain", "USA", "Argentina"];<br>
const yValues = [55, 49, 44, 24, 15];<br>
const barColors = ["red", "green","blue","orange","brown"];<br>
<br>
...
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=trychartjs_bars_colors_more">Try it Yourself &raquo;</a></p>
</div>
...
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=trychartjs_bars_color">Try it Yourself &raquo;</a></p>
</div>
...
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=trychartjs_bars_colors">Try it Yourself &raquo;</a></p>
</div>

<div class="w3-example">
<h3>Horizontal Bars</h3>
<p>Set Index axiss to y:</p>
<div class="w3-code notranslate jsHigh">
indexAxis: 'y',
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=trychartjs_bars_horizontal">Try it Yourself &raquo;</a></p>
</div>
...
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=trychartjs_pie">Try it Yourself &raquo;</a></p>
</div>
...
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=trychartjs_doughnut">Try it Yourself &raquo;</a></p>
</div>
...
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=trychartjs_scatter">Try it Yourself &raquo;</a></p>
</div>
<hr>
...
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=trychartjs_lines">Try it Yourself &raquo;</a></p>
</div>
...
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=trychartjs_lines_scatter">Try it Yourself &raquo;</a></p>
</div>
...
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=trychartjs_lines_multi">Try it Yourself &raquo;</a></p>
</div>
<hr>
<h2>Linear Graphs</h2>
...
<br>
const ctx = document.getElementById('myChart');<br>
<br>
new Chart(ctx, {<br>
&nbsp;&nbsp;type: "line",<br>
&nbsp;&nbsp;data: {<br>
...
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=trychartjs_linear">Try it Yourself &raquo;</a></p>
</div>
<hr>
...
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=trychartjs_function">Try it Yourself &raquo;</a></p>
</div>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_graphics_plotly.asp">&#10094; Previous</a>
