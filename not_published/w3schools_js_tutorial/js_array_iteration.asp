...
<h1>JavaScript Array Iterations</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_array_sort.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_array_reference.asp">Next &#10095;</a>
</div>
...
<tr>
<td width="50%">
<a href="#mark_foreach">Array forEach</a><br>
<a href="#mark_map">Array map()</a><br>
<a href="#mark_flatmap">Array flatMap()</a><br>
<a href="#mark_filter">Array filter()</a><br>
<a href="#mark_reduce">Array reduce()</a><br>
<a href="#mark_reduceright">Array reduceRight()</a><br>
<a href="#mark_every">Array every()</a><br>
</td><td>
<a href="#mark_some">Array some()</a><br>
<a href="#mark_from">Array from()</a><br>
<a href="#mark_keys">Array keys()</a><br>
<a href="#mark_entries">Array entries()</a><br>
<a href="#mark_with">Array with()</a><br>
<a href="#mark_spread">Array Spread (...)</a><br>
<a href="#mark_rest">Array Rest (...) </a><br>
</td></tr>
</table>
<p class="w3-large"><a href="js_array_reference.asp">Complete JavaScript Array Reference</a>

</div>

<div class="ws-note w3-large">
<h2>See Also:</h2>
<p class="w3-large"><a href="js_arrays.asp">Array Tutorial</a></p>
<p class="w3-large"><a href="js_array_methods.asp">Array Basic Methods</a></p>
<p class="w3-large"><a href="js_array_search.asp">Array Search Methods</a></p>
<p class="w3-large"><a href="js_array_sort.asp">Array Sort Methods</a></p>
<p class="w3-large"><a href="js_array_iteration.asp">Array Iteration Methods</p>
<p class="w3-large"><a href="js_array_reference.asp">Array Reference</a></p>
</div>
<!--stop-->
<!--start-->
<a id="mark_foreach"></a>
<h2>JavaScript Array forEach()</h2>
<p>The <code class="w3-codespan">forEach()</code> method calls a function (a callback function) once for each array element.</p>
...
<p>The <code class="w3-codespan">map()</code> method does not execute the function for array 
elements without values.</p>
<p>The <code class="w3-codespan">map()</code> method does not change the original array.</p>
...
<!--start-->
<a id="mark_flatmap"></a>
<a id="mark_array_flatmap"></a>
<h2>JavaScript Array flatMap()</h2>
<p><a href="js_2019.asp">ES2019</a> added the Array <code class="w3-codespan">flatMap()</code> method to JavaScript.</p>
<p>The <code class="w3-codespan">flatMap()</code> method first maps all elements of an array
and then creates a new array by flattening the array.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_array_flatmap" target="_blank">Try it Yourself &raquo;</a>
</div>

<h2>Browser Support</h2>
<p><code class="w3-codespan">flatMap()</code> is an ECMAScript 2019 feature.</p>
...
<p>The <code class="w3-codespan">filter()</code> method creates a new array with array elements that pass a test.</p>
...
<p>The <code class="w3-codespan">reduce()</code> method runs a function on each array element to produce a single value.</p>
<p>The <code class="w3-codespan">reduce()</code> method works from left-to-right in the array. See also <code class="w3-codespan">reduceRight()</code>.</p>
<div class="w3-panel ws-note">

<p>The <code class="w3-codespan">reduce()</code> method does not reduce the original array.</p>
</div>
...
<p>Since the example above does not use the index and array parameters, it can be 
rewritten to:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<p>The <code class="w3-codespan">reduce()</code> method can accept an initial value:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const numbers = [45, 4, 9, 16, 25];<br>
...
<hr>
<!--start-->
<a id="mark_reduceright"></a>
<h2>JavaScript Array reduceRight()</h2>
<p>The <code class="w3-codespan">reduceRight()</code> method runs a function on each array element to produce a single value.</p>
<p>The <code class="w3-codespan">reduceRight()</code> works from right-to-left in the array. See also <code class="w3-codespan">reduce()</code>.</p>
<div class="w3-panel ws-note">

<p>The <code class="w3-codespan">reduceRight()</code> method does not reduce the original array.</p>
</div>
<p>This example finds the sum of all numbers in an array:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const numbers = [45, 4, 9, 16, 25];<br>
let sum = numbers.reduceRight(myFunction);<br>
  <br>function myFunction(total, value, index, array) {<br>&nbsp; 
  return total + value;<br>} </div>
...
<p>This example checks if all array values are larger than 18:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const numbers = [45, 4, 9, 16, 25];<br>
...
<p>The <code class="w3-codespan">Array.from()</code> method returns an Array object from:</p>
<ul>
<li><p><b>Any iterable object</b></p></li> 
<li><p><b>Any object with a length property</b></p></li>
</ul>
<div class="w3-example">
<h3>Example</h3>
...
<p><code class="w3-codespan">Array.from()</code> has an optional parameter which allows you to execute a function
on each element of the new array:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Create an Array from an Array:</p>
<div class="w3-code notranslate jsHigh">
const myNumbers = [1,2,3,4];<br>
const myArr = Array.from(myNumbers, (x) =&gt; x * 2);
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_array_from_array" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<h2>Browser Support</h2>
<p><code class="w3-codespan">from()</code> is an <a href="js_es6.asp">ES6  feature</a>.</p>
...
<p>The <code class="w3-codespan">Array.keys()</code> method returns an Array Iterator object with the keys of an array.</p>
<div class="w3-example">
<h3>Example</h3>
...
<!--stop-->
<h2>Browser Support</h2>
<p><code class="w3-codespan">keys()</code> is an <a href="js_es6.asp">ES6  feature</a>.</p>
<p>ES6 is fully supported in all modern browsers since June 2017:</p>
...
<!--start-->
<a id="mark_entries"></a>
<h2>JavaScript Array entries()</h2>
<div class="w3-example">
<h3>Example</h3>
...
<!--stop-->
<h2>Browser Support</h2>
<p><code class="w3-codespan">entries()</code> is an <a href="js_es6.asp">ES6  feature</a>.</p>
<p>ES6 is fully supported in all modern browsers since June 2017:</p>
...
<!--start-->
<a id="mark_with"></a>
<h2>JavaScript Array with() Method</h2>
<p><a href="js_2023.asp">ES2023</a> added the Array with() method as a safe way to update elements in an array without altering the original array.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const months = ["Januar", "Februar", "Mar", "April"];<br>
const myMonths = months.with(2, "March");
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_array_with" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<a id="mark_spread"></a>
<h2>JavaScript Array Spread (...)</h2>
<p>The <code class="w3-codespan">...</code> operator expands an array into individual elements.</p>
<p>This can be used join arrays:</p>
<div class="w3-example">
<h3>Example 1</h3>
<div class="w3-code notranslate jsHigh">
const arr1 = [1, 2, 3];<br>
...
<p>In the example above, <b>...arr1</b> expands arr1 into single elements, <b>...arr2</b> expands arr2 into single elements,
and arr3 is constructed using ...arr1 and ...arr2.</p>
<div class="w3-example">
<h3>Example 2</h3>
<div class="w3-code notranslate jsHigh">
...
<p>The spread operator (...) can be used to copy an array:</p>
<div class="w3-example">
<h3>Example 3</h3>
<div class="w3-code notranslate jsHigh">
const arr1 = [1, 2, 3];<br>
...
<a target="_blank" href="tryit.asp?filename=tryjs_oper_spread_copy_array" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p>The spread operator (...) can be used to pass arguments to a function:</p>
...
let maxValue = Math.max(...numbers);<br>
</div>
...
<!--stop-->
<h2>Browser Support</h2>
<p><code class="w3-codespan">... (spread)</code> is an <a href="js_es6.asp">ES6  feature</a>.</p>
<p>ES6 is fully supported in all modern browsers since June 2017:</p>
...
<a target="_blank" href="tryit.asp?filename=tryjs_array_rest1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
<h3>Example 2</h3>
<div class="w3-code notranslate jsHigh">
...
<a target="_blank" href="tryit.asp?filename=tryjs_array_rest2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<h2>Browser Support</h2>
<p><code class="w3-codespan">... (rest)</code> is an ECMAScript 2018 feature.</p>
<p><b><a href="js_2018.asp">ES2018</a></b> is supported in all modern browsers since <b>January 2020</b>:</p>
...
<hr>
<div id="exercisecontainer" src="xrcise_array_iteration.js"></div>
<hr>
