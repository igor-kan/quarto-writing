...
<html lang="en-US">
<head>
<title>JavaScript Module Namespace</title>
<meta charset="utf-8">
...
<h1>JS Module Namespace</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_modules_export.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_modules_dynamic.asp">Next &#10095;</a>
</div>

<!--start-->
<div class="ws-info">
<h2>The Module Namespace Object</h2>
<p>When you use the syntax:
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
import * as <i>name</i> from "<i>module</i>";
</div>
</div>
<p>JavaScript creates a module <b>namespace object</b>.</p>
<p>This is an immutable object that contains all the exported bindings from that module.</p>
</div>
...
<p>Import math_module.js into a namespace object:</p>
<div class="w3-code notranslate jsHigh">
import * as math from "./math_module.js";<br>
<br>
// Now you can use the math namespace object:<br>
let myPi = math.PI<br>
let result1 = math.add(2, 3));<br>
let result2 = math.multiply(2, 3));<br>
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_modules_namespace_2">Try it Yourself &raquo;</a></p>
</div>

<hr>
<h2>Module Namespace Support</h2>
<p><b>Module namespace support</b> refers to the mechanism that allows you to import all exports from a module
into a single <b>namespace object</b>.</p>
<hr>
<div class="ws-note">
<p>The <b>Module Namespace</b> feature is a part of the ES Modules introduced in <a href="js_es6.asp">ECMAScript 2015</a>
to help organize and access modules in a consistent way.</p>
</div>
<hr>

<h2>Module Namespace Features</h2>
<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
<tr><th>Feature</th><th>Description</th></tr>
<tr><th>Namespace</th><td>A special object containing all exports from a module</td></tr>
<tr><th>Syntax</th><td>import * as <i>name</i> from <i>module</i></td></tr>
<tr><th>Purpose</th><td>Organize, access, and reference module exports safely</td></tr>
<tr><th>Read Only</th><td>You can access exports but not reassign them</td></tr>
<tr><th>Live&nbsp;Binding</th><td>If an exported value changes in the module, the namespace reflects that change automatically</td></tr>
<tr><th>Enumerable</th><td>Its properties are enumerable and correspond to named exports</td></tr>
<tr><th>Prototype</th><td>The namespace is a plain object with no prototype<br>(Object.getPrototypeOf(math) === null).</td></tr>
...
<h2>Module Namespace Export</h2>
<p>Module namespace export refers to exporting an entire imported module namespace object from another module.</p>

<h2>Namespace Export</h2>
<p>Normally, you import all of a module's exports into a module namespace object like this:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
import * as math from "./math_module.js";<br>
...
<p>With module namespace exports, you can re-export that entire namespace from your own module - without having to import it first:</p>
...
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_modules_export_2">Try it Yourself &raquo;</a></p>
</div>
<div class="ws-note">

<p>The syntax <b>export * as name from "module"</b> was added in <a href="js_2020.asp">ECMAScript 2020</a>.</p>
</div>
<hr>
...
<tr><td>export * from "module"</td><td>Re-export all named exports individually (not as a namespace)</td></tr>
<tr><td>export * as name from "module"</td><td>Re-export all exports grouped under a single namespace</td></tr>
<tr><td>export { name } from "module"</td><td>Re-export specific exports</td></tr>
</table>
</div>
<hr>
<h2>Aggregator Scripts</h2>
<p>An <b>aggregator script</b> is a script used only to import and re-export items from other modules.</p>
<p>Instead of filling your top module with many import statements, you can use a single aggregator script to do it all.</p>
