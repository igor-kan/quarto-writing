...
<h1>ECMAScript 2023</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_2024.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_2022.asp">Next &#10095;</a>
</div>

<hr>
<h2>New Features in JavaScript 2023</h2>

<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
<tr><th>Feature</th><th>Description</th><th></th></tr>
<tr><td><a href="js_2023.asp?#mark_shebang">#! (Shebang)</a></td>
<td>Tells the operating system which interpreter to use to execute the script</td><td></td></tr>
</table>
</div>

<h3>New Array Features in 2023</h3>
<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
<tr><th>Feature</th><th>Description</th><th></th></tr>
<tr><td><a href="js_2023.asp?#mark_array_findlast">findLast()</a></td>
<td>Returns the value of the last element that satisfies a condition</td><td></td></tr>
<tr><td><a href="js_2023.asp?#mark_array_findlastindex">findLastIndex()</a></td>
<td>Returns the index of the last element that satisfies a condition</td><td></td></tr>
<tr><td><a href="js_2023.asp?#mark_array_toreversed">toReversed()</a></td>
<td>Reverses an array without altering the original array</td><td></td></tr>
<tr><td><a href="js_2023.asp?#mark_array_tosorted">toSorted()</a></td>
<td>Sorts an array without altering the original array</td><td></td></tr>
<tr><td><a href="js_2023.asp?#mark_array_tospliced">toSpliced()</a></td>
<td>Splices an array without altering the original array</td><td></td></tr>
<tr><td><a href="js_2023.asp?#mark_array_with">with()</a></td>
<td>Updates array elements without altering the original array</td><td></td></tr>
</table>
</div>
...
<p><b>ECMAScript 2023</b> is supported in all modern browsers since <b>July 2023</b>:</p>
...
<hr>
<a id="mark_array_findlast"></a>
<h2>JavaScript Array findLast() Method</h2>
<p>ES2023 added the findLast() method that will start from the end of an array and return
the value of the first element that satisfies a condition.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const temp = [27, 28, 30, 40, 42, 35, 30];<br>
let high = temp.findLast(x =&gt; x &gt; 40);
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_array_findLast" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<hr>
<a id="mark_array_findlastindex"></a>
<h2>JavaScript Array findLastIndex() Method</h2>
...
<a target="_blank" href="tryit.asp?filename=tryjs_array_findlastindex" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<hr>
<a id="mark_array_toreversed"></a>
<h2>JavaScript Array toReversed() Method</h2>
<p>ES2023 added the Array toReversed() method as a safe way to reverse an array without altering the original array.</p>
<p>The difference between the new <b>toReversed()</b> method and the old <b>reverse()</b> method is that the new method
...
<hr>
<a id="mark_array_tosorted"></a>
<h2>JavaScript Array toSorted() Method</h2>
<p>ES2023 added the Array toSorted() method as a safe way to sort an array without altering the original array.</p>
<p>The difference between the new <b>toSorted()</b> method and the old <b>sort()</b> method is that the new method
creates a new array, keeping the original array unchanged, while the old method altered the original array.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<hr>
<a id="mark_array_tospliced"></a>
<h2>JavaScript Array toSpliced() Method</h2>
...
<a id="mark_shebang"></a>
<h2><span style="font-size:48px">#!</span> JavaScript Shebang</h2>
<p>In operating systems, a shebang (also known as hashbang, pound-bang, sharp-exclamation or hash-pling)
is a sequence of two characters: a number sign (#) and an exclamation mark (!).</p>
<p><b>#!</b> at the beginning of a script tells the operating system what interpreter should be used to execute the script:</p>
<div class="w3-example">
<h3>Example</h3><div class="w3-code notranslate jsHigh">
<b>#!</b>/usr/bin/env node</div>
</div>
<p>The example above tells the operating system to use the node program to run the script.</p>
<p>Now, you can run JavaScript code with <code class="w3-codespan">./fileName.js</code> instead 
of <code class="w3-codespan">node fileName.js</code>.</p>
