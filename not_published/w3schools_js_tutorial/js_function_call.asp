...
<a class="w3-left w3-btn" href="js_function_this.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_function_apply.asp">Next &#10095;</a>
</div>

<div class="ws-info">
<h2>The JavaScript call() Method</h2>
<p>The <b>call()</b> method can be used to call a function with a specific <b>this</b>.</p>
<p>The <b>call()</b> method lets an object use a method belonging to another object.</p>
<p>In this way, the same <b>method</b> can be used on <b>different objects</b>.</p>
</div>

<div class="ws-note">

<p><b>call()</b> is an advanced topic.</p>
<p>Make sure you understand <b>this</b> before continuing:<br>
<p class="w3-large"><a href="js_function_this.asp">The <b>this</b> Keyword</a></p>
</div>

<hr>
<h2>Basic call() Syntax</h2>
<p>The <b>call()</b> method is used to <b>call a function</b> with an <b>object as an argument</b>.</p>
<p>The <b>call()</b> method takes <b>this</b> as the first argument.</p>
<p>Additional arguments are passed as a <b>comma-separated list</b>.</p>

<div class="w3-example">
  <h3>Syntax</h3>
  <div class="w3-code notranslate jsHigh">
    functionName.call(<b>this</b>, arg1, arg2, ...);<br>
  </div>
</div>

<hr>
<h2>Using call() to Set <b>this</b></h2>
<p>When you use <b>call()</b>, you can decide what <b>this</b> should refer to.</p>
<p>In the example below, the <b>greet function</b> returns a greeting + <b>this.name</b>.</p>
<p>When you use <b>call()</b>, you decide that <b>this</b> should be the <b>person3</b> object.</p>
...
<br>
greet.call(person3, "Hello");<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_function_call_greeting" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Borrowing a Method from Another Object</h2>
<p>You can use <b>call()</b> to <b>borrow a method</b> from another object:</p>
<div class="w3-example">
<h3>Example 1</h3>
<p>Calls the <b>fullName</b> method of <b>person</b>, using it on <b>person1</b>:</p>
<div class="w3-code notranslate jsHigh">
const person = {<br>
...
// This will return &quot;John Doe&quot;:<br>  
  person.fullName.call(<b>person1</b>);
</div>
<p>
...
<div class="w3-example">
<h3>Example 2</h3>
<p>Call the <b>fullName</b> method of <b>person</b>, using it on <b>person2</b>:</p>
...
<p>The <b>call()</b> method can accept arguments.</p>
<p>Arguments are passed normally, separated by commas:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const person = {<br>
...
<hr>
<h2>call() vs Normal Function Call</h2>
<p>Compare a normal function call with a <b>call()</b> call.</p>
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate jsHigh">
    ...
    const person = { name: "John" };<br><br>
    showName();<br>
    showName.call(person);<br>
  </div>
</div>

<p>Without <b>call()</b>, <b>this</b> is not the <b>person</b> object.</p>
<p>With <b>call()</b>, <b>this</b> is set explicitly.</p>

<hr>

<h2>call() Does Not Create a New Function</h2>
<p>
The <b>call()</b> method executes the function immediately.<br>
It does not return a new function.<br>
</p>
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate jsHigh">
    ...
    const person = { name: "John" };<br><br>
    sayHello.call(person);<br>
  </div>
</div>

<p>
If you need a new function that remembers <b>this</b>, use <b>bind()</b> instead.<br>
</p>

<hr>
<h2>Common Mistakes</h2>
<ul class="w3-ul">
<li><h3>Forgetting that call() Runs Immediately</h3>
<b>call()</b> does not return a reusable function.</li>
<li><h3>Passing Arguments as an Array</h3>
<b>call()</b> requires arguments to be listed one by one.
Use <b>apply()</b> for arrays.</li>
<li><h3>Using call() Without Understanding <b>this</b></h3>
Always know what <b>this</b> should refer to.</li>
</ul>

<hr>
<div class="w3-panel w3-pale-yellow w3-leftbar w3-border-yellow">
<h2>Quiz</h2>
<p>What is the main difference between <b>call()</b> and a normal function call?</p>
</div>
<hr>


<h2>Next Chapter</h2>
<p class="w3-large"><a href="js_function_apply.asp">JavaScript Function apply()</a></p>
