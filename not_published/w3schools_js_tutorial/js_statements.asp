...
<p>These programming instructions are called <strong>statements</strong>.</p>
<p>Most JavaScript programs contain many statements.</p>
...
<div class="w3-panel ws-note">
<p>In this tutorial we use 2 spaces of indentation for code blocks.<br>
...
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: JavaScript Statements</h2>
  <a href="https://youtu.be/ZjotKN861EI&list=PLP9IO4UYNF0WWmZpE3W33vVPRl2GvjEqz" class="ga-featured ga-youtube" target="blank_" >
    <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
      ...
      <picture id="yt_div">
        <source srcset="images/img_javascript_statements.webp" type="image/webp" />
        <img src="images/img_javascript_statements.png" style="max-width:100%;height:auto;border-radius:6px" alt="Tutorial on YouTube" loading="lazy">
      </picture>
    </div>
  </a>
</div>
