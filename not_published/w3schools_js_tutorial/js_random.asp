...
<a class="w3-left w3-btn" href="js_math_reference.asp">&#10094; Previous</a>
...
<p><code class="w3-codespan">Math.random()</code> always returns a number lower than 1.</p>

<!--stop-->
<hr>
<!--start-->
<h2>JavaScript Random Integers</h2>
<p><code class="w3-codespan">Math.random()</code> used with <code class="w3-codespan">Math.floor()</code> can be used to return random integers.</p>
<div class="ws-note">
...
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Return a random integer from 0 to 9 (both included):<br>
...
<p><b>Explained</b>:</p>
<p><code class="w3-codespan">Math.random()</code> returns a floating-point number between 0 (inclusive) and 1 (exclusive).</p>
<p>Example outputs: 0.0, 0.237, 0.9999, but never 1.</p>

<p><code class="w3-codespan">Math.random() * 10</code> gives a range from 0 up to but not including 10.</p>
<p>Example possible results: 0.0, 3.5, 9.99, etc.</p>

<p><code class="w3-codespan">Math.floor()</code> rounds a number down to the nearest whole integer:
<ul>
<li>3.5 becomes 3</li>
<li>9.99 becomes 9</li>
<li>0.1 becomes 0</li>
</ul>

<p>The possible integer results are then <b>0 through 9</b> (both inclusive).<p>
<p>In other words, the range is <b>[0, 9]</b>.<p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Return a random integer from 0 to 10 (both included):<br>
...
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Return a random integer from 0 to 99 (both included):<br>
...
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Return a random integer from 0 to 100 (both included):<br>
...
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Return a random integer between 1 and 10 (both included):<br>
Math.floor(Math.random() * 10) + 1;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_random_1_10" target="_blank">Try it Yourself &raquo;</a>
</div>
<p><b>Explained</b>:</p>
<p><code class="w3-codespan">Math.random()</code> returns a <b>number</b> from 0 (inclusive) up to but not including 1.</p>
<p>Multiplying by 10 gives a number from 0 up to but not including 10.</p>
<p>Adding 1 shifts that range to 1 up to but not including 11.</p>
<p><code class="w3-codespan">Math.floor()</code> then rounds down, so you get an 
<b>integer</b> between 1 and 10.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Returns a random integer from 1 to 100 (both included):<br>
...
<tr></tr>
<tr><th>Expression</th><th>Range from</th><th>Range to</th></tr>
<tr><td>Math.random()</td><td>0</td><td>&lt;1</td></tr>
<tr><td>Math.random() * 10</td><td>0</td><td>&lt;10</td></tr>
<tr><td>Math.random() * 100</td><td>0</td><td>&lt;100</td></tr>
<tr><td>Math.floor(Math.random() * 10)</td><td>0</td><td>9</td></tr>
</table>
<!--stop-->
<hr>
...
<p>This JavaScript function always returns a <b>random integer</b> between min (included) and 
max (excluded):</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<p>This JavaScript function always returns a <b>random integer</b> between min and max (both included):</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
function getRndInteger(min, max) {<br>
