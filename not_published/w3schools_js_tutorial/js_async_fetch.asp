...
<a class="w3-left w3-btn" href="js_async_await.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_async_debug.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
<p class="w3-xlarge"><i><code class="w3-codespan">fetch()</code> is the modern way to request data from a server</i></p>
<p><code class="w3-codespan">fetch()</code> is asynchronous and returns a promise</p>
<p><b>Modern apps use async code to get data</b></p>
<p><code class="w3-codespan">fetch()</code> is the most common example</p>
</div>

<h2>fetch Returns a Promise</h2>
<p><code class="w3-codespan">fetch()</code> does not return the data.</p>
<p>It returns a promise that becomes a response later.</p>
...
<p>The result is a <code class="w3-codespan">Response</code> object, not the JSON data.</p>

<hr>
<h2>Getting JSON Data</h2>
<p>To get JSON, you must read the response body.</p>
<p><code class="w3-codespan">response.json()</code> returns a promise.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
fetch("data.json")<br>
...
<p>The above is a promise chain.</p>
</div>

<hr>
<h2>fetch with async and await</h2>
<p><code class="w3-codespan">async</code> and <code class="w3-codespan">await</code> make fetch code easier to read.</p>
<p>This is the recommended way for beginners.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<hr>
<h2>Important: HTTP Errors</h2>
<p>A common beginner mistake is expecting fetch to fail on 404 or 500.</p>
<p>Fetch only rejects on network errors.</p>
<div class="ws-warning">
<p>A 404 response is not a rejected promise.</p>
<p>You must check <code class="w3-codespan">response.ok</code>.</p>
</div>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
async function loadData() {<br>
&nbsp;&nbsp;let response = await fetch("missing.json");<br><br>
&nbsp;&nbsp;if (!response.ok) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;console.log("HTTP Error:", response.status);<br>
&nbsp;&nbsp;&nbsp;&nbsp;return;<br>
&nbsp;&nbsp;}<br><br>
&nbsp;&nbsp;let data = await response.json();<br>
&nbsp;&nbsp;console.log(data);<br>
...
<p>The above handles HTTP errors correctly.</p>
</div>

<hr>
<h2>Network Errors</h2>
<p>A network error happens when the request cannot be completed.</p>
<p>This includes offline mode and DNS errors.</p>
<p>Network errors reject the promise.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
async function loadData() {<br>
...
<hr>
<h2>Common fetch Mistakes</h2>

<div class="ws-warning">
<p>Forgetting <code class="w3-codespan">await</code> gives you a promise instead of data.</p>
</div>
...
<p>This logs a promise.</p>
<p>You must use <code class="w3-codespan">await</code> to get the JSON.</p>
...
<p>If fetch is not working, check the console.</p>
<p>Then check the Network tab.</p>

<ul class="w3-ul w3-border">
<li>Is the file path correct.</li>
<li>Is the status code 200.</li>
<li>Is the response JSON.</li>
</ul>

<div class="ws-note">

<p>Most fetch bugs are not JavaScript bugs.</p>
<p>They are path and response problems.</p>
</div>

<hr>
<h2>Callback vs Fetch</h2>
<div class="w3-example">
<h3>Loading data.json Using a Callback</h3>
<div class="w3-code notranslate jsHigh">
function loadFile(callback) {<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;callback("HTTP Error: " + xhr.status, null);<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;};<br>
&nbsp;&nbsp;xhr.onerror = function() {<br>
&nbsp;&nbsp;&nbsp;&nbsp;callback("Network Error", null);<br>
&nbsp;&nbsp;};<br>
&nbsp;&nbsp;xhr.send();<br>
}<br><br>
loadFile(function(error, data) {<br>
&nbsp;&nbsp;if (error) {<br>
...
<h3>Callback Explained</h3>
<ul>
<li>loadFile() does not return the data</li>
<li>It accepts a callback</li>
<li>The callback runs when the file is loaded</li>
<li>Errors must be handled manually</li>
<li>Nesting increases if you add more steps</li>
</ul>
<div class="w3-example">
<h3>Loading data.json Using Fetch</h3>
<div class="w3-code notranslate jsHigh">
async function loadFile() {<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;let response = await fetch("data.json");<br><br>
&nbsp;&nbsp;&nbsp;&nbsp;if (!response.ok) {<br>
...
<h3>Fetch Explained</h3>
<ul>
<li>fetch() returns a promise</li>
<li>await pauses inside the function</li>
<li>Errors are handled with try...catch</li>
<li>The flow reads top to bottom</li>
<li>No nested callbacks</li>
</ul>
<h3>Main Differences</h3>
<table class="ws-table-all">
<tr></tr>
<tr><th>Callback</th><th>Promise / async-await</th></tr>
<tr><td>You pass a function to run later</td><td>You wait for a promise</td></tr>
<tr><td>Manual error-first pattern</td><td>Built-in error flow</td></tr>
<tr><td>Can become nested</td><td>Reads like normal code</td></tr>
<tr><td>Hard to chain steps</td><td>Easy to chain steps</td></tr>	
</table>
<hr>
<div class="ws-note">
<h2>Next Chapter</h2>
<p>The next page shows how to debug async code like a professional.</p>
<p>You will learn breakpoints, logging patterns, and why async errors feel invisible.</p>
<p class="w3-large"><a class="w3-btn w3-green" href="js_async_debug.asp">Debugging Asynchronous JavaScript</a></p>
</div>
