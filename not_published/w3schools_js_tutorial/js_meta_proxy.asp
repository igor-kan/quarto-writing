...
<a class="w3-left w3-btn" href="js_meta_reflect.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_meta_reference.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
<h2>What is a Proxy?</h2>
<p>A <b>Proxy</b> is a JavaScript object that can <b>wrap other objects</b>.</p>
...
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const myObject = {name: "Jan"};<br>
<br>
const proxy = new Proxy(myObject, {<br>
&nbsp;&nbsp;get(target, prop) {<br>
...
proxy.age = 42;<br>
<br>
let text1 = proxy.name;<br>
let text2 = proxy.age<br>
</div>
...
<a target="_blank" href="tryit.asp?filename=tryjs_proxy_reflect" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Proxy with Reflect Flow</h2>
<p>The flow below is the essence of JavaScript metaprogramming with Proxy + Reflect.</p>

<p><img src="img_proxy.jpg" style="width:100%;max-width:400px" alt="Proxy"></p>
...
&nbsp;&nbsp;&nbsp;&nbsp;if (prop === "age" &amp;&amp; value &lt; 0) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;text = "Age cannot be negative!";<br>
...
<br>
proxy.age = 45;  // OK<br>
proxy.age = -5;  // Error<br>
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_proxy_validate" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<br>
// Create a Proxy<br>
const virtual = new Proxy(person, {<br>
&nbsp;&nbsp;get(target, prop) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;if (prop === "fullName") {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return target.first + " " + target.last;<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
...
<a target="_blank" href="tryit.asp?filename=tryjs_proxy_virtual" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const fn = new Function("a", "b", "return a + b");<br>
<br>
let result = fn(3, 2);
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_proxy_dynamic" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<tr><th>Trap Name</th><th>Triggered when</th></tr>
...
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
get(obj, prop, receiver) {<br>
&nbsp; return Reflect.get(obj, prop, receiver);<br>
}<br>
</div>
...
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
set(obj, prop, value, receiver) {<br>
&nbsp; return Reflect.set(obj, prop, value, receiver);<br>
}
</div>
<p><b>Triggered by:</b></p>
<div class="w3-code notranslate jsHigh">
...
<div class="w3-code notranslate jsHigh">
has(obj, prop) {<br>
&nbsp; return Reflect.has(obj, prop);<br>
}<br>
</div>
<p><b>Triggered by:</b></p>
<div class="w3-code notranslate jsHigh">
...
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
deleteProperty(obj, prop) {<br>
&nbsp; return Reflect.deleteProperty(obj, prop);<br>
}<br>
</div>
<p><b>Triggered by:</b></p>
<div class="w3-code notranslate jsHigh">
...
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
apply(func, thisArg, args) {<br>
&nbsp; return Reflect.apply(func, this, args);<br>
}<br>
</div>
<p><b>Triggered by:</b></p>
<div class="w3-code notranslate jsHigh">
...
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
construct(obj, args, newTarget) {<br>
&nbsp; return Reflect.construct(obj, args, newTarget);<br>
}<br>
</div>
<p><b>Triggered by:</b></p>
<div class="w3-code notranslate jsHigh">
...
<div class="w3-code notranslate jsHigh">
const obj = {}&nbsp;&nbsp;// No trap<br>
Object.create()&nbsp;// No trap<br>
<br>
class User {};<br>
new User();&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// No trap
<br>
...
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
getOwnPropertyDescriptor(obj, prop) {<br>
&nbsp; return Reflect.getOwnPropertyDescriptor(obj, prop);<br>
}<br>
</div>
<p><b>Triggered by:</b></p>
<div class="w3-code notranslate jsHigh">
...
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
defineProperty(obj, prop, descriptor) {<br>
&nbsp; return Reflect.defineProperty(obj, prop, descriptor);<br>
}<br>
</div>
<p><b>Triggered by:</b></p>
<div class="w3-code notranslate jsHigh">
...
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
getPrototypeOf(obj) {<br>
&nbsp; return Reflect.getPrototypeOf(obj);<br>
}<br>
</div>
<p><b>Triggered by:</b></p>
<div class="w3-code notranslate jsHigh">
...
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
setPrototypeOf(obj, prototype) {<br>
&nbsp; return Reflect.setPrototypeOf(obj, prototype);<br>
}<br>
</div>
<p><b>Triggered by:</b></p>
<div class="w3-code notranslate jsHigh">
Object.settPrototypeOf()<br>
</div>
</div>
...
<div class="w3-code notranslate jsHigh">
isExtensible(obj) {<br>
&nbsp; return Reflect.isExtensible(obj);<br>
}<br>
</div>
<p><b>Triggered by:</b></p>
<div class="w3-code notranslate jsHigh">
...
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
preventExtensions(obj) {<br>
&nbsp; return Reflect.preventExtensions(obj);<br>
}<br>
</div>
<p><b>Triggered by:</b></p>
<div class="w3-code notranslate jsHigh">
...
<p>Before <a href="js_es6.asp">ES6 (2015)</a>, many fundamental operations did not exist as functions:<p>
<table class="ws-table-all">
<tr></tr>
...
<p>So <a href="js_es6.asp">ES6 (2015)</a> added Reflect:</p>
<table class="ws-table-all">
