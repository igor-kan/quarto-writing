...
<html lang="en-US">
<head>
<title>JavaScript Objects Learning Path</title>
<meta charset="utf-8">
...
<p><b>Objects</b> are <b>variables</b> that can store both <b>values</b> and <b>functions</b>.</p>
<p><b>Values</b> are stored as <b>key:value</b> pairs called <b>properties</b>.</p>
<p><b>Functions</b> are stored as <b>key:function()</b> pairs called <b>methods</b>.</p>
</div>

<h2>Real Life Comparison</h2>
<p>In real life, we can describe subjects as objects (a car, a person, a house)</p>
...
<tr></tr>
<tr><th>Car Object</th></tr>
<tr><td><img src="objectexplained.jpg" style="width:100%;max-width:260px"></td></tr>
</table>
</div>
...
<table class="ws-table-all">
<tr></tr>
<tr><th>Car Properties</th><th>Car Methods</th></tr>
<tr><td>
car.name = Fiat<br><br>
car.model = 500<br><br>
...
<p>Different cars have the same <b>properties</b>, but the <b>property values</b> can differ from car to car.</p>
<p>Different cars have the same <b>methods</b>, but the methods can be performed <b>at different times</b>.</p>

<hr>
<h2>Object Example</h2>
<p>This code example assigns <b>many values</b> (Fiat, 500, white) to an <b>object</b> named car:</p>
...
<p><code class="w3-codespan">type</code>, <code class="w3-codespan">model</code>,
and <code class="w3-codespan">color</code> are <b>properties</b></p>
<p><code class="w3-codespan">"Fiat"</code>, <code class="w3-codespan">"500"</code>,
and <code class="w3-codespan">"white"</code> are <b>property values</b></p>
</div>

<hr>
<h2>Object Literal</h2>
<p>An <b>object literal</b> "literally" <b>describes an object</b> using a concise syntax with zero or more
<b>key:value</b> pairs inside <b>curly braces</b> to describe all the <b>object properties</b>:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh w3-border">
{firstName:&quot;John&quot;, lastName:&quot;Doe&quot;, age:50, eyeColor:&quot;blue&quot;}
</div>
</div>

<hr>
<h2>How to Create a JavaScript Object</h2>
<p>An <b>object literal</b> is the simplest and most common way to define a JavaScript object.</p>
<p>All the examples below, create the same JavaScript object:</p>
...
<p><b>Spaces and line breaks</b> are not important. An object literal can span multiple lines: </p>
...
<p>You can also create an <b>empty object</b>, and add the properties later:</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_object_create_empty" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="ws-note">

<p>You should declare objects with the <span class="w3-codespan">const</span> keyword.</p>

</div>
<h2>Using the new Keyword</h2>
<div class="w3-example">
<h3>Example 4</h3>
<p>Create a new JavaScript object using <code class="w3-codespan">new Object()</code>:</p>
<div class="w3-code notranslate jsHigh">
// Create an Object<br>
...
<p>There is no need to use <code class="w3-codespan">new Object()</code>.</p>
<p>For readability, simplicity and speed, use an <b>object literal</b> instead.</p>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_object_properties2">Try it Yourself &raquo;</a>
</div>
<!--stop-->
...
<p>Object methods are <b>actions</b> that can be performed on objects.</p>
<p>Object methods are <b>function definitions</b> stored as <b>property values</b>:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_object_method">Try it Yourself &raquo;</a>
</div>

<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
<tr><th style="width:20%">Property</th><th>Property Value</th></tr>
<tr><td>firstName</td><td>John</td></tr>
<tr><td>lastName</td><td>Doe</td></tr>
<tr><td>age</td><td>50</td></tr>
<tr><td>fullName</td>
...
<p>In an object method, <code class="w3-codespan">this</code> refers to <b>the object</b>.</p>
<p>In the example above, <code class="w3-codespan">this</code> refers to <b>the person object</b>.</p>
</div>
...
<div class="ws-note">
<h2>Learn More:</h2>
<p class="w3-large"><a href="js_object_properties.asp">What are Object Properties?</a></p>
<p class="w3-large"><a href="js_object_methods.asp">What are Object Methods?</a></p>
<p class="w3-large"><a href="js_object_this.asp">What is this in Objects?</a></p>
<p class="w3-large"><a href="js_object_display.asp">How to Display Javascript Objects</a></p>
<p class="w3-large"><a href="js_object_constructor.asp">What is an Object Constructor?</a></p>
</div>
<!--stop-->
...
<h2>Summary</h2>
<ul>
<li><b>Objects</b> are containers for <b>Properties</b> and <b>Methods</b></li>
<li><b>Properties</b> are named <b>Values</b> stored as <b>key:value</b> pairs</li>
<li><b>Methods</b> are <b>Functions</b> stored as <b>key:function()</b> pairs.</li>
</ul>

<!--start-->
<hr>
<h2>In JavaScript, Objects are King</h2>
<h4>If you Understand Objects, you Understand JavaScript.</h4>
...
<li>RegExp are Objects</li>
<li>Errors are Objects</li>
</ul>
<p>All JavaScript values, except <b>primitives</b>, are objects.</p>
<!--start-->
<hr>
<h2>JavaScript Primitives</h2>
<p>A <b>primitive data type</b> is data type that can only store a single primitive value.</p>
<p>JavaScript defines 7 types of primitive data types:</p>
<table class="ws-table-all">
<tr><th>Type</th><th>Example value</th></tr>
<tr><td><a href="js_strings.asp"><code class="w3-codespan">string</code></a></td><td>"Hello"</td></tr>
<tr><td><a href="js_numbers.asp"><code class="w3-codespan">number</code></a></td><td>3.14</td></tr>
<tr><td><a href="js_booleans.asp"><code class="w3-codespan">boolean</code></a></td><td>true</td></tr>
<tr><td><a href="js_bigint.asp"><code class="w3-codespan">bigint</code></a></td><td>12345678901234n</td></tr>
<tr><td><a href="js_types.asp"><code class="w3-codespan">null</code></a></td><td>null</td></tr>
<tr><td><a href="js_types.asp"><code class="w3-codespan">undefined</code></a></td><td>undefined</td></tr>
<tr><td><a href="js_types.asp"><code class="w3-codespan">symbol</code></a></td><td>symbol</td></tr>
</table>
<!--stop-->

<hr>
<div id="exercisecontainer" src="xrcise_objects.js"></div>
<hr>
