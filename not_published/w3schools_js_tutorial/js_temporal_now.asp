...
<html lang="en-US">
<head>
<title>JavaScript Temporal.Now - Get Current Date and Time</title>
<meta charset="utf-8">
...
<h1>JavaScript Temporal Now</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_temporal_zoneddatetime.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_temporal_arithmetic.asp">Next &#10095;</a>
</div>

<div class="ws-info">
<h2>The Temporal.Now Object</h2>
...
<p>And one method to get system's time zone:</p>
<ul>
<li>Temporal.Now.timeZoneId()</li>
</ul>
</div>

<h2>What is Temporal.Now?</h2>

<p>Temporal.now is a <b>Namespace object</b>. Like the Math object, it is a container for methods.</p>
<p>These methods provide <b>the current time in various formats</b>
(Instant, ZonedDateTime, PlainDateTime, etc) in nanoseconds precision .</p>

<p><b>Temporal.Now is static</b>. It cannot be instantiated. You cannot use the new keyword to create a Temporal-Now.
new Temporal.Now() will throw an error.</p>
<p>Instead, you call the methods directly on the namespace, such as Temporal.Now.instant().</p>


<div class="ws-note">

<p>Temporal.Now is serving as a replacement for the older Date.now() method.</p>
</div>

<hr>
<h2>Create a Temporal.Instant Object</h2>
<p>The <code class="w3-codespan">Temporal.Now.instant()</code> method returns a
<code class="w3-codespan">Temporal.Instant</code> object
representing the current date and time.</p>
<p>An <code class="w3-codespan">Instant</code> represents an exact moment in time (UTC). It is similar to a timestamp.</p>
...
<hr>
<h2>Create a Temporal.PlainDate Object</h2>
...
in the ISO 8601 calendar, ignoring time zones and times.</p>
<p>A <b>PlainDate</b> object is ideal for calendar-based applications like birthdays,
anniversaries, and scheduling, where the time of day does not matter.</p>


<div class="w3-example">
<h3>Example</h3>
<p>Get the current system date:</p>
<div class="w3-code notranslate jsHigh">
...
<hr>
<h2>Create a Temporal.PlainTime Object</h2>
<p>Use the <code class="w3-codespan">plainTimeISO()</code> method for <b>time only</b>.</p>
<p>It returns a <b>PlainTime</b> object with the current time in the ISO calendar.</p>
<div class="w3-example">
<h3>Example</h3>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_now_plaintime" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Create a Temporal.PlainDateTime Object</h2>
<p>Use the <code class="w3-codespan">plainDateTimeISO()</code> for <b>date and time only</b>.</p>
<p>It returns a <b>PlainDateTime</b> object in the ISO 8601 calendar,
specifically ignoring time zones.</p>
<p>A <b>PlainDateTime</b> object is useful when the date and time for local
scheduling, calendar elements, and date-time arithmetic where
a time zone is not required.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Get the current system date and time:</p>
<div class="w3-code notranslate jsHigh">
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_now_plaindatetime" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<div class="ws-note">
<p>The JavaScript Date object has <b>1 method</b> for getting the current time.</p>
<p>Temporal.Now has <b>5 methods</b> for 5 different date objects.</p>
</div>

<hr>
<h2>Create a Temporal.ZonedDateTime Object</h2>
<p>Use the <code class="w3-codespan">zonedDateTimeISO()</code> method when you need both date and time zone information.</p>
<p>It returns a <code class="w3-codespan">Temporal.ZonedDateTime</code> object that includes your system's time zone.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Get the current system time:</p>
<div class="w3-code notranslate jsHigh">
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_now_zoneddatetime" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Get the Current Time Zone</h2>
<p>The <code class="w3-codespan">timeZoneId()</code> method returns a time zone identifier representing
the system's current time zone.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Get the current system time:</p>
<div class="w3-code notranslate jsHigh">
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_zoned_timezoneid" target="_blank">Try it Yourself &raquo;</a>
</div>
