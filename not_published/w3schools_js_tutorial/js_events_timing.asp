...
<h1>JavaScript Timing Events</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_events_load.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_events_management.asp">Next &#10095;</a>
</div>

<!--start-->
<div class="ws-info">
<p class="w3-large"><b>Timing Events</b> let you run code:</p>
<ul class="w3-large">
<li>After a Delay</li>
<li>Or Repeatedly</li>
</ul>
<p>Timing is driven by <b>Timing Events</b> generated by the system clock.</p>
</div>
...
<tr><td>setTimeout()</td><td>Sets a clock timeout (runs once)</td></tr>
<tr><td>setInterval()</td><td>Sets a clock interval (runs repeatedly)</td></tr>
<tr><td>clearTimeout()</td><td>Clears a timeout</td></tr>
<tr><td>clearInterval()</td><td>Clears an inteval</td></tr>
</table>
</div>
...
<p>The timer functions belong to the window object.</p>
<p><code class="w3-codespan">setTimeout()</code> is the same as <code class="w3-codespan">window.setTimeout()</code>.</p>
</div>
...
&lt;p id="clock"&gt;&lt;/p&gt;<br><br>
&lt;script&gt;<br>
// Call showTime every 1000 millisec<br>
setInterval(showTime, 1000);<br>
<br>
// Fuction to display the time<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_events_simple_clock" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>The setTimeout() Method</h2>
<p>The <code class="w3-codespan">setTimeout()</code> method executes a function after a delay in milliseconds.</p>
<div class="w3-code w3-border notranslate">
setTimeout(<em>function, delay, p1,...,pN</em>)
</div>
...
<tr>
 ...
 <th>Description</th>
    ...
    <td>Required.<br>The function to be called when the timer expires.</td>
    </tr>
  <tr class="w3-white">
    <td><em>delay</em></td>
    <td>Optional.<br>The milliseconds the timer should wait.<br>Defalt 0 (immediately).</td>
    </tr>
  <tr>
    <td><em>p1,...,pN</em></td>
    <td>Optional.<br>Arguments passed to the function.</td>
  </tr>
</table>
<h3>Return Value</h3>
<table class="ws-table-all">
...
<tr>
<td>Integer</td><td>An integer that uniquely identifies the timer.<br>
This "timeout ID" can later be passed to clearTimeout() to cancel the timer.</td>
</tr>
</table>
...
&lt;p id="demo"&gt;&lt;/p&gt;<br><br>
&lt;script&gt;<br>
// let btn listen for a click<br> 
document.getElementById("btn").addEventListener("click", function () {<br>
// Then call showMsg after 2 seconds<br>
&nbsp;&nbsp;setTimeout(showMsg, 2000);<br>
});<br>
<br>
// Function to display message<br>
function showMsg() {<br>
&nbsp;&nbsp;document.getElementById("demo").innerHTML = "Hello after 2 seconds!";<br>
}<br>
&lt;/script&gt;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_events_settimeout" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="ws-note">

<p>The <code class="w3-codespan">setTimeout()</code> method is a core part of asynchronous JavaScript,
allowing code execution to be scheduled without blocking the main execution thread.</p>
</div>
...
<p>The <code class="w3-codespan">setInterval()</code> method calls a function repeatedly.</p>
<div class="w3-code w3-border notranslate">
setInterval(<em>function, delay, p1,...,pN</em>)
</div>
...
<tr>
 ...
 <th>Description</th>
    ...
    <tr>
    <td><em>function</em></td>
    <td>Required.<br>The function to be called for every interval.</td>
    </tr>
  <tr class="w3-white">
    <td><em>delay</em></td>
    <td>Optional.<br>The milliseconds between each function call.<br>Defalt 0.</td>
    </tr>
  <tr>
    <td><em>p1,...,pN</em></td>
    <td>Optional.<br>Arguments passed to the function.</td>
...
<tr>
<td>Integer</td><td>An integer that uniquely identifies the timer.<br>
This "timeout ID" can later be passed to clearInterval() to cancel the timer.</td>
</tr>
</table>

<div class="w3-example">
<h3>Example</h3>
<p><code class="w3-codespan">setInterval()</code> used with
<code class="w3-codespan">clearInterval()</code>:</p>
<div class="w3-code notranslate htmlHigh">
&lt;button id="start"&gt;Start Counter&lt;/button&gt;<br>
&lt;button id="stop"&gt;Stop&lt;/button&gt;<br>
<br>
&lt;p id="counter"&gt;0&lt;/p&gt;<br><br>
&lt;script&gt;<br>
let myInterval;<br>
let count = 0;<br>
<br>
const btnStart = document.getElementById("start");<br>
const btnStop = document.getElementById("stop");<br>
<br>
// let btnStart listen for a click<br>
document.getElementById("start").addEventListener("click", function () {<br>
// Then start counter <br>
&nbsp;&nbsp;myInterval = setInterval(counter, 1000);<br>
});<br>
<br>
// let btnStop listen for a click<br>
document.getElementById("stop").addEventListener("click", function () {<br>
// Then stop counter <br>
&nbsp;&nbsp;clearInterval(myInterval);<br>
});<br><br>
function counter() {<br>
&nbsp;&nbsp;count++;<br>
&nbsp;&nbsp;document.getElementById("counter").innerHTML = count;<br>
}<br>
&lt;/script&gt;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_events_setinterval" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="ws-note">

<p>The <code class="w3-codespan">setTimeout()</code> method executes a function <b>only once</b> after a delay.</p>
<p>The <code class="w3-codespan">setInterval()</code> method executes a function <b>repeatedly</b> at every interval.</p>
</div>
