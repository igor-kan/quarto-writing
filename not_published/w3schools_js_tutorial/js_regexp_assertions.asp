...
<html lang="en-US">
<head>
<title>JavaScript RegExp Assertions</title>
<meta charset="utf-8">
...
<h1>Regular Expression Assertions</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_regexp_meta_characters.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_regexp_groups.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
<h2>RegExp Assertions</h2>
...
<h2>JavaScript Regex Assertions</h2>
...
<tr><td>\B</td><td>Word boundary</td><td>Matches NOT the beginning or end of a word</td></tr>
<tr><td>(?=...)</td><td>Lookahead</td><td>Matches the subsequent string</td></tr>
<tr><td>(?!...)</td><td>Lookahead</td><td>Matches NOT the subsequent string</td></tr>
<tr><td>(?&lt;=...)</td><td>Lookbehind</td><td>Matches the previous string</td></tr>
<tr><td>(?&lt;!...)</td><td>Lookbehind</td><td>Matches NOT the previous string</td></tr>
</table>
</div>
...
<hr>
<h2>The \b Metacharacter</h2>
<p>The \b metacharacter matches the beginning of a word or the end of a word.</p>
<div class="w3-example">
<h3>Examples</h3>
<p>Search for the characters "LO" at the <b>beginning</b> of a word:</p>
<div class="w3-code notranslate jsHigh">
let text = "HELLO, LOOK AT YOU!";<br>
<br> 
let result = text.search(/\bLO/);
</div>
<p>
<a class="w3-btn" href="tryit.asp?filename=tryjs_regexp_b" target="_blank">Try it Yourself &raquo;</a></p>
<p>Search for the characters "LO" at the <b>end</b> of a word:</p>
<div class="w3-code notranslate jsHigh">
let text = "HELLO, LOOK AT YOU!";<br>
<br> 
...
<p>
<a class="w3-btn" href="tryit.asp?filename=tryjs_regexp_b2" target="_blank">Try it Yourself &raquo;</a></p>
</div>
...
<h2>RegExp Lookahead x(?=y)</h2>
<p>x(?=y) matches "x" if "x" is followed by "y".</p>
<div class="w3-example">
<h3>Example</h3>
<p>Match "W3schools" if "W3Schools" is followed by " Tutorials".</p>
<div class="w3-code notranslate jsHigh">
let text = "W3Schools Tutorials";<br>
let pattern = /W3Schools(?= Tutorials)/;<br>
<br>
let result = pattern.test(text);<br>
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_regexp_lookahead" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Negative Lookahead x(?!y)</h2>
<p>x(?!y) matches "x" if "x" is NOT followed by "y".</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let text = "W3Schools Tutorials";<br>
...
<a target="_blank" href="tryit.asp?filename=tryjs_regexp_negative_lookahead" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p><b>Explanation</b></p>
<p>W3Schools matches the literal word.</p>
<p>(?! Tutorials) asserts that what follows is not " Tutorials".</p>
<p>If text = "W3Schools Tutorials", the test returns false.</p>
<p>If text = "W3Schools Website", the test returns true.</p>
<hr>
<h2>RegExp Lookbehind (?&lt;=y)x</h2>
<p>(?&lt;=y)x matches "x" if "x" is preceded by "y".</p>
<div class="w3-example">
<h3>Example</h3>
<p>Match "W3Scools" if "W3Schools" is preceded by "Hello ".</p>
<div class="w3-code notranslate jsHigh">
let text = "Hello W3Schools";<br>
...
<hr>
<h2>Negative Lookbehind (?&lt;!y)x</h2>
<p>(?&lt;!y)x matches "x" only if "x" is NOT preceded by "y".</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let text = "Hello W3Schools";<br>
