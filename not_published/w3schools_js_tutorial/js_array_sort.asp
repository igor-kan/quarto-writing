...
<a class="w3-left w3-btn" href="js_array_search.asp">&#10094; Previous</a>
...
<a href="#mark_sort">Array sort()</a><br>
<a href="#mark_reverse">Array reverse</a>()<br>
<a href="#mark_tosorted">Array toSorted()</a><br>
<a href="#mark_toreversed">Array toReversed()</a><br>
<a href="#mark_objects">Sorting Objects</a><br>

</td>
<td>
<h2>Numeric Sort</h2>
<a href="#mark_numeric">Numeric Sort</a><br>
<a href="#mark_random">Random Sort</a><br>
<a href="#mark_mathmin">Math.min()</a><br>
<a href="#mark_mathmax">Math.max()</a><br>
<a href="#mark_homemin">Home made Min()</a><br>
<a href="#mark_homemin">Home made Max()</a><br>
</td>
</tr>
</table>
...
<h2>See Also:</h2>
<p class="w3-large"><a href="js_arrays.asp">Array Tutorial</a><br>
<p class="w3-large"><a href="js_array_methods.asp">Array Basic Methods</a><br>
<p class="w3-large"><a href="js_array_search.asp">Array Search Methods</a><br>
<p class="w3-large"><a href="js_array_iteration.asp">Array Iteration Methods</a><br>
<p class="w3-large"><a href="js_array_reference.asp">Array Reference</a>
</div>
<!--stop-->
<!--start-->
<a id="mark_sort"></a>
<h2>Sorting an Array</h2>
<p>The <code class="w3-codespan">sort()</code> method sorts an array alphabetically:</p>
...
<p>The <code class="w3-codespan">reverse()</code> method reverses the elements in an array:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const fruits = [&quot;Banana&quot;, &quot;Orange&quot;, &quot;Apple&quot;, &quot;Mango&quot;];<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_array_reverse2" target="_blank">Try it Yourself &raquo;</a>
</div>

<p>By combining <code class="w3-codespan">sort()</code> and <code class="w3-codespan">reverse()</code>,
you can sort an array in descending order:</p>
...
<hr>
<!--start-->
<a id="mark_tosorted"></a>
<h2>JavaScript Array toSorted() Method</h2>
<p><a href="js_2023.asp">ES2023</a> added the <code class="w3-codespan">toSorted()</code> method as a safe way
to sort an array without altering the original array.</p>
<p>The difference between <code class="w3-codespan">toSorted()</code> and <code class="w3-codespan">sort()</code>
is that the first method creates a new array, keeping the original array unchanged, while the last method alters the original array.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<a target="_blank" href="tryit.asp?filename=tryjs_array_tosorted" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<a id="mark_toreversed"></a>
<h2>JavaScript Array toReversed() Method</h2>
<p><a href="js_2023.asp">ES2023</a> added the <code class="w3-codespan">toReversed()</code> method as a safe way
to reverse an array without altering the original array.</p>
<p>The difference between <code class="w3-codespan">toReversed()</code> and <code class="w3-codespan">reverse()</code> is that the first method
creates a new array, keeping the original array unchanged, while the last method alters the original array.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const months = ["Jan", "Feb", "Mar", "Apr"];<br>
...
<a target="_blank" href="tryit.asp?filename=tryjs_array_toreversed" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<a id="mark_numeric"></a>
<h2>Numeric Sort</h2>
<p>By default, the <code class="w3-codespan">sort()</code> function sorts values as <strong>strings</strong>.</p>
<p>This works well for strings (&quot;Apple&quot; comes before &quot;Banana&quot;).</p>
<p>If numbers are sorted as strings, &quot;25&quot; is bigger than &quot;100&quot;, 
because &quot;2&quot; is bigger than &quot;1&quot;.</p>
<p>Because of this, the <code class="w3-codespan">sort()</code> method will produce incorrect result when sorting 
numbers.</p>
...
<p>When the <code class="w3-codespan">sort()</code> function compares two values, it sends the values to the 
compare function, and sorts the values according to the returned (negative, 
zero, positive) value.</p>
<p>If the result is negative, <code class="w3-codespan">a</code> is sorted before
<code class="w3-codespan">b</code>.</p>
<p>If the result is positive, <code class="w3-codespan">b</code> is sorted 
before <code class="w3-codespan">a</code>.</p>
<p>If the result is 0, no changes are done with the sort order of the two 
values.</p>
<p><strong>Example:</strong></p>
<p>The compare function compares all the values in the array, two values at a 
time <code class="w3-codespan">(a, b)</code>.</p>
<p>When comparing 40 and 100, the <code class="w3-codespan">sort()</code> method calls the compare function(40, 100).</p>
<p>The function calculates 40 - 100 <code class="w3-codespan">(a - b)</code>, and 
since the result is negative (-60),&nbsp; the sort function will sort 40 as a value lower than 100.</p>
...
<p>Using a sort function, like explained above, you can sort an numeric array in random order</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const points = [40, 100, 1, 5, 25, 10];<br>
...
<p>The points.sort() method in the example above is not accurate. It will favor some 
numbers over others.</p>
<p>The most popular correct method, is called the Fisher Yates shuffle, and was 
introduced in data science as early as 1938!</p>
<p>In JavaScript the method can be translated to this:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const points = [40, 100, 1, 5, 25, 10];<br><br>
for (let i = points.length -1; i &gt; 0; i--) {<br>
&nbsp; let j = Math.floor(Math.random() * (i+1));<br>
&nbsp; let k = points[i];<br>&nbsp; 
  points[i] = points[j];<br>
&nbsp; points[j] = k;<br>}
</div>
<p>
<a class="w3-btn" href="tryit.asp?filename=tryjs_array_sort_random2" target="_blank">Try it Yourself &raquo;</a>
</p>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Find the Lowest (or Highest) Array Value</h2>
<p>There are no built-in functions for finding the max or min 
value in an array.</p>
<p>To find the lowest or highest value you have 3 options:</p>
<ul>
<li>Sort the array and read the first or last element</li>
<li>Use Math.min() or Math.max()</li>
<li>Write a home made function</li>
</ul>
<!--stop-->
<hr>
<!--start-->
<h2>Find Min or Max with sort()</h2>
<p>After you have sorted an array, you can use the 
...
<p>You can use <code class="w3-codespan">Math.min.apply</code> to find the lowest number in an array:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<p><code class="w3-codespan">Math.min.apply(null, [1, 2, 3])</code> is equivalent to <code class="w3-codespan">Math.min(1, 2, 3)</code>.</p>
...
<p>You can use <code class="w3-codespan">Math.max.apply</code> to find the highest number in an array:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<p><code class="w3-codespan">Math.max.apply(null, [1, 2, 3])</code> is equivalent to <code class="w3-codespan">Math.max(1, 2, 3)</code>.</p>

<!--stop-->
<hr>
<!--start-->
<a id="mark_homemin"></a>
<h2>JavaScript Array Minimum Method</h2>
<p>There is no built-in function for finding the lowest value in a JavaScript array.</p>
<p>The fastest code to find the lowest number is to use a <b>home made</b> method.</p>
...
<h2>JavaScript Array Maximum Method</h2>
<p>There is no built-in function for finding the highest value in a JavaScript array.</p>
<p>The fastest code to find the highest number is to use a <b>home made</b> method.</p>
...
<p>Even if objects have properties of different data types, the <code class="w3-codespan">sort()</code> method 
...
<p><a href="js_2019.asp">ES2019</a> <b>revised</b> the Array <code class="w3-codespan">sort()</code> method.</p>
<p>Before 2019, the specification allowed unstable sorting algorithms such as QuickSort.</p>
<p>After ES2019, browsers must use a stable sorting algorithm:</p>
<p>When sorting elements on a value, the elements must keep their relative position to other elements with the same value.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const myArr = [<br>
&nbsp; {name:"X00",price:100 },<br>
&nbsp; {name:"X01",price:100 },<br>
&nbsp; {name:"X02",price:100 },<br>
&nbsp; {name:"X03",price:100 },<br>
&nbsp; {name:"X04",price:110 },<br>
&nbsp; {name:"X05",price:110 },<br>
&nbsp; {name:"X06",price:110 },<br>
&nbsp; {name:"X07",price:110 }<br>
];
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_array_stable_sort" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>In the example above, when sorting on price, the result is not allowed to come out with the names
in an other relative position like this:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
X01 100<br>
X03 100<br>
...
<hr>
<div id="exercisecontainer" src="xrcise_array_sort.js"></div>
<hr>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_array_search.asp">&#10094; Previous</a>
