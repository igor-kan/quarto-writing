...
<html lang="en-US">
<head>
<title>JavaScript Temporal Tutorial - Modern Date and Time Handling</title>
<meta charset="utf-8">
...
<h1>JavaScript Temporal Intro</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_temporal.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_temporal_vs_date.asp">Next &#10095;</a>
</div>
...
<hr>
<h2>Why Was Temporal Created?</h2>
<p>The <code class="w3-codespan">Date</code> object was created in 1995 and has some design issues that still cause bugs today.</p>
<p>For example, months in <code class="w3-codespan">Date</code> are zero-based, which is confusing.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let d = new Date(2026, 5, 17); // Month 5 = June
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_date_sideffects2" target="_blank">Try it Yourself &raquo;</a>
</div>

<p>Another problem is that many <code class="w3-codespan">Date</code> methods change the same object (mutation), which can create unexpected results.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create a Date<br>
let d = new Date(2026, 5, 17);<br>
<br>
// Add 7 days<br>
d.setDate(d.getDate() + 7);<br>
<br>
...
<p>Temporal was created to solve these issues with clearer object types and predictable behavior.</p>

<hr>
<h2>A Simple Temporal Example</h2>
<p>With Temporal, you can get today's date and add days in a clear and safe way.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<hr>
<h2>Compare With Date</h2>
<p>With <b>JavaScript Date</b>, you only have one type of date object.</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_old_date" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Separate Objects</h2>
<p>Temporal gives you <b>separate objects</b> depending on what you need:</p>
<ul>
  <li><p><b>Instant</b> - Exact moment in UTC</p></li>
  <li><p><b>PlainDate</b> - Date only</p></li>
  <li><p><b>PlainDateTime</b> - Date and time only</p></li>
  <li><p><b>ZonedDateTime</b> - Date and time with zone</p></li>
</ul>

<hr>
<h2>When to Use Each Object</h2>
<ul>
  <li><p><b>Instant</b> - For timestamps and comparisons</p></li>
  <li><p><b>PlainDate</b> - For birthdays and calendar dates</p></li>
  <li><p><b>PlainDateTime</b> - For local scheduling tasks</p></li>
  <li><p><b>ZonedDateTime</b> - For time zone-aware apps</p></li>
</ul>
...
<p><b>Temporal objects are immutable</b>, which means they cannot be changed after they are created.</p>
<p><b>Temporal objects return a new value</b> instead of modifying the existing one.</p>
<hr>
<h2>Temporal Dates are DST-Safe</h2>
<p><b>DST-safe arithmetic</b> ensures time calculations (addition and subtraction) remain accurate across
Daylight Saving Time (DST) transitions, preventing 1-hour errors.</p>
<p>It involves using timezone and calendar-aware objects (ZonedDateTime) that understand
local clock shifts.</p>

<hr>
<h2>Temporal Dates Uses RFC 5545</h2>
<p><b><a href="js_temporal_format.asp">RFC 5545</a></b> (Internet Calendaring and Scheduling Core Object Specification),
is the industry standard for exchanging calendar and scheduling information.</p>  
<p>It allows different systems (like Google Calendar, Apple Calendar,
and Microsoft Outlook) to communicate seamlessly.</p>


<hr>
<h2>JavaScript Date vs Temporal</h2>
<div class="w3-stretch">
...
<div class="ws-note">
<p><b>JavaScript Temporal</b> is a set of built-in date and time objects that
are easier and safer to use than <b>JavaScript Date</b>.</p>
<p>Temporal uses <b>distinct classes for dates and times</b> to prevent bugs related
to local time adjustments (like DST transitions).</p>
</div>

<hr>
<h2>When to Use Temporal?</h2>
<p>Use Temporal when you need reliable date and time handling.</p>
<ul>
<li><p>You need correct time zone support</p></li>
<li><p>You need safe date arithmetic (add / subtract, since / until)</p></li>
<li><p>You need to avoid DST bugs</p></li>
<li><p>You need predictable and readable code</p></li>
</ul>

<div class="ws-note">
<p>You may still have to use JavaScript Date to support environments
where Temporal is not available.</p>
</div>

<hr>
<h2>Temporal Objects</h2>
<h3>Revised March 2026</h3>
<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
