...
<html lang="en-US">
<head>
<title>Debugging Async JavaScript</title>
<meta charset="utf-8">
...
<h1>Debugging Async JavaScript</h1><div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_async_fetch.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_promise_reference.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
<h2>Asynchronous Bugs</h2>
<p>Async bugs are difficult because the code runs later.</p>
<p>This chapter shows practical ways to debug <code class="w3-codespan">fetch()</code>, promises,
<code class="w3-codespan">async</code> and <code class="w3-codespan">await</code>.</p>
</div>

<div class="ws-note">

<p>Async debugging is about finding where the code stops.</p>
<p>Then you find why it stopped.</p>
</div>

<hr>

<h2>Why Async Bugs Feel Invisible</h2>

<p>Async code often fails after your function has already returned.</p>
<p>This makes it feel like nothing happened.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
async function loadData() {<br>
&nbsp;&nbsp;let response = await fetch("missing.json");<br>
...
<p>The <code class="w3-codespan">Done</code> message prints even if the fetch fails later.</p>

<hr>

<h2>Rule 1: Always Handle Errors</h2>

<p>Unhandled promise rejections confuse beginners.</p>
<p>Handle errors early and clearly.</p>
...
<p>This catches network errors and JSON parsing errors.</p>

<hr>

<h2>Rule 2: Check response.ok</h2>

<p>Fetch does not reject on HTTP errors like 404.</p>
...
<p>This separates HTTP errors from network errors.</p>

<hr>

<h2>Rule 3: Log the Right Things</h2>

<p>Logging a promise is not the same as logging the data.</p>
<p>Log the response and status first.</p>
...
&nbsp;&nbsp;console.log(response.headers.get("content-type"));<br>
}<br>
</div>
</div>

<p>This tells you if the server returned what you expected.</p>

<hr>

<h2>Use the Network Tab</h2>

<p>The Network tab shows every request.</p>
<p>This is the fastest way to debug fetch problems.</p>

<ul class="w3-ul w3-card-2" style="max-width:720px">
<li>Check the request URL.</li>
<li>Check the status code.</li>
<li>Check the response body.</li>
<li>Check the response content type.</li>
</ul>

<div class="ws-tip">
<p>Most fetch bugs are not JavaScript bugs.</p>
<p>They are URL and server response bugs.</p>
</div>

<hr>

<h2>Breakpoints on await</h2>

<p>You can set breakpoints on <code class="w3-codespan">await</code> lines.</p>
<p>This lets you inspect values before and after async steps.</p>
...
<p>Set a breakpoint on the first <code class="w3-codespan">await</code> line.</p>
<p>Step over and inspect <code class="w3-codespan">response</code>.</p>

<hr>

<h2>Common Async Errors</h2>

<div class="ws-warning">
<p>Forgetting <code class="w3-codespan">await</code> is the most common beginner mistake.</p>
</div>
...
<p>This logs a promise, not the JSON.</p>
...
<hr>
<h2>Debugging Promise Chains</h2>
<p>Promises can fail anywhere in the chain.</p>
<p>Add logs between steps to find where it fails.</p>
...
<p>This shows which step is failing.</p>
...
<li>Add <code class="w3-codespan">try...catch</code> around awaited code.</li>
<li>Check <code class="w3-codespan">response.ok</code> and <code class="w3-codespan">response.status</code>.</li>
<li>Use the Network tab.</li>
<li>Use breakpoints on <code class="w3-codespan">await</code> lines.</li>
</ul>

<div class="ws-note">
<h2>Next Chapter</h2>
<h4><a class="w3-btn w3-green" href="js_promise_reference.asp">Asynchronous Reference</a></h4>
<p>The tutorial pages teach the concepts.</p>
<p>The reference pages list details and methods.</p>
