...
<!--start-->
<div class="ws-info">
<p>The <code class="w3-codespan">let</code> keyword was introduced in
<a href="js_es6.asp">ES6 (2015)</a></p>
<p>Variables declared with <code class="w3-codespan">let</code> have <b>Block Scope</b></p>
<p>Variables declared with <code class="w3-codespan">let</code> must be <b>Declared</b> before use</p>
<p>Variables declared with <code class="w3-codespan">let</code> cannot be <b>Redeclared</b> in the same scope</p>
</div>

<h2>Block Scope</h2>
<p>Before ES6 (2015), JavaScript did not have <b>Block Scope</b>.</p>
<p>JavaScript had <b>Global Scope</b> and <b>Function Scope</b>.</p>
<p>ES6 introduced the two new JavaScript keywords: <code class="w3-codespan">let</code> and <code class="w3-codespan">const</code>.</p>
<p>These two keywords provided <strong>Block Scope</strong> in JavaScript:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Variables declared inside a { } block cannot be accessed 
...
<p>Inside a function all variables declared with <code class="w3-codespan">var</code>,
<code class="w3-codespan">let</code> or <code class="w3-codespan">const</code> have <b>Function Scope</b>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
//y can NOT be used here<br>
//z can NOT be used here<br>
</div>
</div>

<hr>
<h2>Global Scope</h2>
<p>Variables declared with the <code class="w3-codespan">var</code> always have <b>Global Scope</b>.</p>
<p>Variables declared with the <code class="w3-codespan">var</code> keyword can NOT have block scope:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Variables declared with <code class="w3-codespan">var</code>inside a { } block can be accessed from 
outside the block:</p>
<div class="w3-code notranslate jsHigh">
{ <br>
&nbsp;&nbsp;var x = 2; <br>
...
<p>Variables defined with <code class="w3-codespan">let</code> <b>can not</b> be redeclared.</p>
<p>You can not accidentally redeclare a variable declared with <code class="w3-codespan">let</code>.</p>

<div class="w3-example">
<p>With <code class="w3-codespan">let</code> you <b>can not</b> do this:</p>
<div class="w3-code notranslate jsHigh">
let x = "John Doe";<br>
<br>
let x = 0;
...
<p>Variables defined with <code class="w3-codespan">var</code> <b>can</b> be redeclared.</p>
<div class="w3-example">
<p>With <code class="w3-codespan">var</code> you <b>can</b> do this:</p>
<div class="w3-code notranslate jsHigh">
var x = "John Doe";<br>
<br>
var x = 0;
...
<p>The difference between <code class="w3-codespan">var</code>, <code class="w3-codespan">let</code>,
and <code class="w3-codespan">const</code> lies in <b>scoping</b> mechanisms, <b>reassignment</b> rules, and JavaScript
<b>hoisting</b>.</p>
<div class="ws-note">
<p>Modern JavaScript standards recommend <b>avoiding var</b> to minimize unintentional bugs.</p>
</div>
...
<div class="ws-note">
<h2>Learn More:</h2>
<p class="w3-large"><a href="js_scope.asp">JavaScript Scope</a></p>
<p class="w3-large"><a href="js_hoisting.asp">JavaScript Hoisting</a></p>
<p class="w3-large"><a href="js_varletconst.asp">JavaScript var/let/const</a></p>
</div>
...
<!--start-->
<h2>Redeclaring</h2>
<p>Redeclaring a JavaScript variable with <code class="w3-codespan">var</code> is allowed 
...
<!--start-->
<h2>Let Hoisting</h2>
<p>Variables defined with <code class="w3-codespan">var</code> are <strong>hoisted</strong> to the top 
...
<p>Variables defined with <code class="w3-codespan">let</code> are also hoisted to the top 
of the block, but not initialized.</p>
<p>Meaning: Using a <code class="w3-codespan">let</code> variable before it is declared will result in a 
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_let_hoisting_let" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_let.js"></div>
<hr>
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: JavaScript let</h2>
  <a href="https://youtu.be/-rpU6z9O88o&list=PLP9IO4UYNF0WWmZpE3W33vVPRl2GvjEqz" class="ga-featured ga-youtube" target="blank_" >
    <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
      ...
      <picture id="yt_div">
        <source srcset="images/img_javascript_let.webp" type="image/webp" />
        <img src="images/img_javascript_let.png" style="max-width:100%;height:auto;border-radius:6px" alt="Tutorial on YouTube" loading="lazy">
      </picture>
    </div>
  </a>
</div>
