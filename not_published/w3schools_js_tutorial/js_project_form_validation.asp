...
<a class="w3-left w3-btn" href="js_project_modal_popup.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_2026.asp">Next &#10095;</a>
</div>

<div class="ws-info">
<p>In this project you will build a form with validation.</p>
<p>The form will show error messages under each input field, and it will not submit until everything is valid.</p>
<h3>What You Will Learn</h3>
<ul>
<li>How to validate form fields with JavaScript</li>
<li>How to prevent a form from submitting</li>
<li>How to show error messages under inputs</li>
<li>How to check email and password rules</li>
</ul>
</div>

<hr>
<h2>Step 1 - Create the HTML</h2>
<p>Create a form with four fields and an error message under each field.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;form id="signupForm"&gt;<br>
<br>
&lt;div class="field"&gt;<br>
&nbsp;&nbsp;&lt;label&gt;Name:&lt;/label&gt;&lt;br&gt;<br>
&nbsp;&nbsp;&lt;input id="name" type="text" placeholder="Your name"&gt;<br>
&nbsp;&nbsp;&lt;p id="nameError" class="error"&gt;&lt;/p&gt;<br>
&lt;/div&gt;<br>
<br>
&lt;form&gt;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_project_form_validation1" target="_blank">
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_project_form_validation2" target="_blank">
Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Step 3 - Add JavaScript</h2>
<p>You must create an object for each field.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create an Object for each Field<br>
const form = document.getElementById("signupForm");<br>
const nameInput = document.getElementById("name");<br>
const emailInput = document.getElementById("email");<br>
const passInput = document.getElementById("password");<br>
const confirmInput = document.getElementById("confirm");<br>
const nameError = document.getElementById("nameError");<br>
const emailError = document.getElementById("emailError");<br>
const passError = document.getElementById("passwordError");<br>
const confirmError = document.getElementById("confirmError");<br>
const result = document.getElementById("result");<br>
</div>
</div>

<p>You need a function to diplay errors.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Function to Display Error<br>
function showError(el, message) {<br>
&nbsp;&nbsp;el.innerHTML = message;<br>
}<br>
</div>
</div>

<p>You need a function to clear the error field.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Function to Clear the Error<br>
function clearError(el) {<br>
&nbsp;&nbsp;el.innerHTML = "";<br>
}<br>
</div>
</div>

<p>You need a function to validate the form.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Function to Validate Form<br>
...
<p>You need the code to validate the form.</p>
<p>To validate the form, you must stop the page from reloading.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Prevent Default Reloading<br>
...
// Validate Form<br>
&nbsp;&nbsp;if (validateForm()) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;result.innerHTML = "Form is valid!";<br>
&nbsp;&nbsp;&nbsp;&nbsp;result.className = "ok";<br>
&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;result.innerHTML = "Please fix the errors.";<br>
&nbsp;&nbsp;&nbsp;&nbsp;result.className = "error";<br>
&nbsp;&nbsp;}<br>
});<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_project_form_validation3" target="_blank">
Try it Yourself &raquo;</a>
</div>
...
<h2>Step 4 - Validate Fields</h2>
<p>Create one function per field.</p>
<div class="w3-example">
<h3>Validate Name</h3>
<div class="w3-code notranslate jsHigh">
// Function to Validate Name<br>
function validateName() {<br>
&nbsp;&nbsp;let value = nameInput.value.trim();<br>
&nbsp;&nbsp;if (value.length &lt; 2) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;showError(nameError, "Name must be at least 2 characters.");<br>
&nbsp;&nbsp;&nbsp;&nbsp;return false;<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;clearError(nameError);<br>
&nbsp;&nbsp;return true;<br>
}<br>
<br>
// Function to Validate Form<br>
function validateForm() {<br>
&nbsp;&nbsp;let okName = validateName();<br>
&nbsp;&nbsp;return okName;<br>
}<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_project_form_validation4" target="_blank">
Try it Yourself &raquo;</a>
</div>
...
function validateEmail() {<br>
&nbsp;&nbsp;let value = emailInput.value.trim();<br>
&nbsp;&nbsp;if (!(/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(value))) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;showError(emailError, "Enter a valid email address.");<br>
&nbsp;&nbsp;&nbsp;&nbsp;return false;<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;clearError(emailError);<br>
&nbsp;&nbsp;return true;<br>
}<br>
<br>
// Function to Validate Form<br>
function validateForm() {<br>
&nbsp;&nbsp;let okName = validateName();<br>
&nbsp;&nbsp;let okEmail = validateEmail();<br>
&nbsp;&nbsp;return okName &amp;&amp; okEmail;<br>
}
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_project_form_validation5" target="_blank">
Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate jsHigh">
// Function to Validate Password<br>
function validatePassword() {<br>
&nbsp;&nbsp;let value = passInput.value;<br>
&nbsp;&nbsp;if (value.length &lt; 8) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;showError(passError, "Password must be at least 8 characters.");<br>
&nbsp;&nbsp;&nbsp;&nbsp;return false;<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;clearError(passError);<br>
&nbsp;&nbsp;return true;<br>
}<br>
<br>
// Function to Validate Form<br>
...
&nbsp;&nbsp;let okName = validateName();<br>
&nbsp;&nbsp;let okEmail = validateEmail();<br>
&nbsp;&nbsp;let okPass = validatePassword();<br>
&nbsp;&nbsp;return okName &amp;&amp; okEmail &amp;&amp; okPass;<br>
}
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_project_form_validation6" target="_blank">
Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Validate Confirm</h3>
<div class="w3-code notranslate jsHigh">
// Function to Validate Confirm<br>
function validateConfirm() {<br>
&nbsp;&nbsp;let pass = passInput.value;<br>
&nbsp;&nbsp;let confirm = confirmInput.value;<br>
&nbsp;&nbsp;if (confirm === "") {<br>
&nbsp;&nbsp;&nbsp;&nbsp;showError(confirmError, "Please confirm your password.");<br>
&nbsp;&nbsp;&nbsp;&nbsp;return false;<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;if (confirm !== pass) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;showError(confirmError, "Passwords do not match.");<br>
&nbsp;&nbsp;&nbsp;&nbsp;return false;<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;clearError(confirmError);<br>
&nbsp;&nbsp;return true;<br>
}<br>
<br>
// Function to Validate Form<br>
...
&nbsp;&nbsp;let okEmail = validateEmail();<br>
&nbsp;&nbsp;let okPass = validatePassword();<br>
&nbsp;&nbsp;let okConfirm = validateConfirm();<br>
&nbsp;&nbsp;return okName &amp;&amp; okEmail &amp;&amp; okPass &amp;&amp; okConfirm;<br>
}
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_project_form_validation7" target="_blank">
Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Form Validation (Finished)</h2>
<p>This example shows the finished project.</p>
...
&nbsp;&nbsp;&lt;input id="email" type="text" placeholder="name@example.com"&gt;<br>
&nbsp;&nbsp;&lt;p id="emailError" class="error"&gt;&lt;/p&gt;<br>
&lt;/div&gt;<br>
<br>
&lt;div class="field"&gt;<br>
&nbsp;&nbsp;&lt;label&gt;Password:&lt;/label&gt;&lt;br&gt;<br>
&nbsp;&nbsp;&lt;input id="password" type="password" placeholder="Min 8 characters"&gt;<br>
&nbsp;&nbsp;&lt;p id="passwordError" class="error"&gt;&lt;/p&gt;<br>
&lt;/div&gt;<br>
<br>
&lt;div class="field"&gt;<br>
&nbsp;&nbsp;&lt;label&gt;Confirm Password:&lt;/label&gt;&lt;br&gt;<br>
&nbsp;&nbsp;&lt;input id="confirm" type="password" placeholder="Repeat password"&gt;<br>
&nbsp;&nbsp;&lt;p id="confirmError" class="error"&gt;&lt;/p&gt;<br>
&lt;/div&gt;<br>
<br>
&lt;p&gt;&lt;button type="submit"&gt;Create Account&lt;/button&gt;&lt;/p&gt;<br>
<br>
&lt;/form&gt;<br>
<br>
&lt;p id="result"&gt;&lt;/p&gt;<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_project_form_validation9" target="_blank">
Try it Yourself &raquo;</a>
</div>
...
<ul>
<li>Forgetting <b>event.preventDefault()</b></li>
<li>Not trimming the input values</li>
<li>Using <b>innerHTML</b> with user input (use text only for messages)</li>
</ul>

<hr>
<h2>Exercises</h2>
<h3>Exercise 1</h3>
<p>Add a rule that the password must contain at least one number.</p>
<h3>Exercise 2</h3>
<p>Validate fields while the user is typing (use the input event).</p>
<h3>Exercise 3</h3> <p>Show a green message next to fields that are valid.</p>

<hr>
<h2>Bonus Challenges (Level Up)</h2>
<ul>
<li>Add password strength indicator (Weak / Medium / Strong)</li>
<li>Disable the submit button until everything is valid</li>
...
<ul class="w3-ul">
<li><a href="js_project_counter.asp" class="w3-large">JavaScript Counter</a><br>
A counter project with restore and save in lovalStorage.
</li>
<li><a href="js_project_eventlistener.asp" class="w3-large">JavaScript Event Listener</a><br>
The counter project using event listener instead of onclick.
</li>
<li><a href="js_project_todo.asp" class="w3-large">JavaScript To-Do List</a><br>
A do-do list saved in an array in local storage.
</li>
<li><a href="js_project_modal_popup.asp" class="w3-large">JavaScript Modal Popup</a><br>
A modal popup window that appears on top of the page.
</li>
<li><a href="js_project_form_validation.asp" class="w3-large">JavaScript Form Validation</a><br>
An HTML Form with form validation.
</li>
