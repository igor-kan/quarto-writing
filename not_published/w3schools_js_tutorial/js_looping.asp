...
<a class="w3-left w3-btn" href="js_map_reference.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_iterables.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
<p>JavaScript loops <b>repeat executing a block of code</b> a number of times.</p>
<p>Loops are fundamental for tasks involving:</p>
<ul>
<li>Iteration over values</li>
<li>Iteration over data structures</li>
<li>Performing an action multiple times</li>
</ul>
<div class="w3-stretch">
<table class="ws-table-all">
<tr><th>Loop Type</th><th>Description</th></tr>
<tr><td>for</td><td>Iterates over values and expressions</td></tr>
<tr><td>while</td><td>Iterates over a condition</td></tr>
<tr><td>do...while</td><td>Iterates over a condition</td></tr>
<tr><td>for...in</td><td>Iterates over the properties of an Object</td></tr>
<tr><td>for...of</td><td>Iterates over array like objects</td></tr>
<tr><td>forEach()</td><td>Iterates over each element in an Array</td></tr>
</table>
</div>
...
<h2>The for Loop</h2>
<p>The <code class="w3-codespan">for</code> loop is used when the number of iterations is known.</p>
<p>It consists of an initialization (exp1), a condition (exp2), and an increment expression (exp3).</p>

<div class="w3-example">
<h3>Syntax</h3>
<div class="w3-code notranslate jsHigh">
for (<i>exp1</i>;<i> exp2</i>;<i> exp3</i>) {<br>
    &nbsp; // <i>code block to be executed</i><br>
 }<br>
</div>
</div>

<p><strong>exp1</strong> is executed <b>one time before</b> the execution of the code block.</p>
<p><strong>exp2</strong> defines <b>the condition</b> for executing the code block.</p>
<p><strong>exp3</strong> is executed <b>every time</b> a code block has been executed.</p>
...
<p>The <code class="w3-codespan">while</code> loop executes a block of code as long as a specified condition evaluates to true.</p>
...
<p>The <code class="w3-codespan">do...while</code> loop is similar to the while loop,
but guarantees that the code block will be executed at least once, before the condition is checked.</p>
<div class="w3-example">
<h3>Syntax</h3>
<div class="w3-code notranslate jsHigh">
do {<br>
...
<p>The <code class="w3-codespan">for...in</code> loop iterates over the enumerable properties of an object.</p>
<p>It is typically used for iterating over object keys.</p>
<div class="w3-example">
<h3>Syntax</h3>
<div class="w3-code notranslate jsHigh">
for (<b>key</b> in <b>object</b>) {<br>
&nbsp; // <i>code block to be executed</i><br>
}
</div>
</div>

<p>A JavaScript <code class="w3-codespan">for...in</code> statement loops through the properties
...
<p>The <code class="w3-codespan">for...of</code> loop iterates over the values of iterable objects such as arrays, strings,
Maps, Sets, and NodeLists.</p>
<div class="w3-example">
<h3>Syntax</h3>
<div class="w3-code notranslate jsHigh">
...
<code class="w3-codespan">const</code>, <code class="w3-codespan">let</code>,
or <code class="w3-codespan">var</code>.</li>
<li><b>iterable</b><br>
An object that has iterable properties.</li>
</ul>

<hr>
<h2>Other Methods</h2>
<p>Array methods like forEach(), map(), filter(), and reduce() provide alternative ways
to iterate and manipulate array elements, often offering a more functional and
concise approach compared to traditional loops for array-specific operations.</p>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_map_reference.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_iterables.asp">Next &#10095;</a>
