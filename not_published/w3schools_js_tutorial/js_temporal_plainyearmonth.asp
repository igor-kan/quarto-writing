...
<html lang="en-US">
<head>
<title>JavaScript Temporal.PlainYearMonth</title>
<meta charset="utf-8">
...
<h1>JavaScript PlainYearMonth</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_temporal_plain.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_temporal_plainmonthday.asp">Next &#10095;</a>
</div>
<div class="ws-info">
<h2>The Temporal.PlainYearMonth Object</h2>
<p>The <b>Temporal.PlainYearMonth object</b> is a year and month object.</p>
<p>It represents the <b>year</b> and <b>month</b> of an <b>ISO 8601 calendar</b> without day or time.</p> 
<p><b>Example: 2026-05</b>.</p> 
</div>
...
<hr>
<h2>How to Create a PlainYearMonth Object</h2>
<p>An <b>PlainYearMonth object</b> can be created in different ways:</p>
<table class="ws-table-all">
<tr></tr>
<tr><th>From</th><th>Code</th></tr>
<tr><th>Parameters</th><td>new Temporal.PlainYearMonth(<i>param</i>)</td></tr>
<tr><th>Object</th><td>Temporal.PlainYearMonth.from(<i>object</i>)</td></tr>
<tr><th><a href="js_temporal_standards.asp">ISO / RFC 9557</a></th><td>Temporal.PlainYearMonth.from(<i>RFC 9557</i>)</td></tr>
</table>

<hr>
<h2>Create a PlainYearMonth with <b>new</b></h2>
<p>The <code class="w3-codespan">new PlainYearMonth()</code> constructor creates a new PlainYearMonth object
with integers as input parameters.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create a PlainYearMonth object<br>
const date = new Temporal.PlainYearMonth(2026, 5);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plainyearmonth" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>PlainYearMonth from(<i>object</i>)</h2>
<p>The <code class="w3-codespan">from()</code> method creates a new PlainYearMonth object with an
<b>object</b> as input parameter.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create a PlainYearMonth object<br>
const date = new Temporal.PlainYearMonth({year:2026, month:5});<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plainyearmonth_from" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>PlainYearMonth from(<i>RFC 9557</i>)</h2>
<p>The <code class="w3-codespan">from()</code> method creates a new PlainYearMonth object with an
<b><a href="js_temporal_standards.asp">ISO / RFC 9557</a></b> string as input parameter.</p>
<div class="w3-example">
<h3>Examples</h3>
<div class="w3-code notranslate jsHigh">
// Create a PlainYearMonth object<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plainyearmonth_from_iso" target="_blank">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
// Create a PlainYearMonth object<br>
const date = Temporal.PlainYearMonth.from("2025-05-17");
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plainyearmonth_from_iso_2" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="ws-note">
<p>Note that the day input is ignored in the last example.</p>
</div>

<hr>
<h2>Temporal.PlainYearMonth Properties</h2>
<div class="w3-example">
<h3>Display All PlainYearMonth Properties</h3>
<div class="w3-code notranslate jsHigh">
const date = new Temporal.PlainYearMonth(2026, 5);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plainyearmonth_prop" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Convert to PlainTime</h2>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const yearMonth = new Temporal.PlainYearMonth(2026, 5);<br>
<br>
const date = yearMonth.toPlainDate({ day: 17 });
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plainyearmonth_to_plaindate" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>PlainYearMonth add() and subtract()</h2>
<p>The <code class="w3-codespan">add()</code> method accept a duration object as input.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create a new PlainYearMonth object<br>
const d1 = Temporal.PlainYearMonth.from("2026-05");<br>
<br>
// Add a duration<br>
const d2 = d1.add({years:2, months:2})<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plainyearmonth_add" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">with()</code> method returns a new PlainYearMonth object with specified field(s) replaced.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create a PlainYearMonth object<br>
const date = Temporal.PlainYearMonth.from("2026-05");<br>
<br>
// Replace month<br>
const newDate = date.with({ month:12 });<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plainyearmonth_with" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>All PlainYearMonth Methods</h2>
<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
...
<hr>
<h2>All PlainYearMonth Properties</h2>
<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
