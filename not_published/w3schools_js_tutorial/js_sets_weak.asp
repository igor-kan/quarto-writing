...
<a class="w3-left w3-btn" href="js_set_logic.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_set_reference.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
...
mySet.add(myObj);<br>
<br>
// Do I have myObj in the mySet?<br>
let answer = mySet.has(myObj);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_weakset" target="_blank">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
// Create a WeakSet<br>
let mySet = new WeakSet();<br>
<br>
...
mySet.delete(myObj);<br>
<br>
// Do I have myObj in the mySet?<br>
let answer = mySet.has(myObj);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_weakset_2" target="_blank">Try it Yourself &raquo;</a>
</div>
...
mySet.add(myObj);<br>
<br>
// Remove the Object from memory<br>
myObj = null;<br>
<br>
// Now myObj in mySet will be garbage collected</div>
</div>
...
let text = "";<br>
<br>
// Create a WeakSet to track persons<br>
const persons = new WeakSet();<br>
<br>
// Visitor Objects<br>
...
&nbsp; if (persons.has(visitor)) {<br>
&nbsp;&nbsp;&nbsp; text += visitor.name + " is visiting again.&lt;br&gt;";<br>
&nbsp; } else {<br>
&nbsp;&nbsp;&nbsp; persons.add(visitor);<br>
&nbsp;&nbsp;&nbsp; text += visitor.name + ", age" + visitor.age +", is visiting for the first time&lt;br&gt;";<br>
&nbsp; }<br>
}<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_weakset_visitors" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="ws-note">

<p>If you want to count the visits as well:</p>
<p><a href="js_maps_weak.asp">Try to use a WeakMap instead</a>.</p>
</div>
...
<tr><td>new WeakSet()</td><td>Creates a new WeakSet object</td></tr>
...
<p><code class="w3-codespan">WeakSet</code> is an <a href="js_es6.asp">ES6  feature</a>.</p>
