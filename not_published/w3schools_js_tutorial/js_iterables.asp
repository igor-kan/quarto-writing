...
<a class="w3-left w3-btn" href="js_looping.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_iterators.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
<h2>An Iterable is an Iterable Object</h2>
<p class="w3-large">Iterable can be iterated over with <code class="w3-codespan">for...of</code> loops</p>
</div>
...
<!--start-->
<h2>Iterating</h2>
<p>Iterating means looping over a sequence of elements.</p> 
...
<p>You can use a <code class="w3-codespan">for...of</code> loop to iterate over the elements of a string:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_iterate_string" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Iterating Over an Array</h2>
<p>You can use a <code class="w3-codespan">for...of</code> loop to iterate over the elements of an Array:</p>
<div class="w3-example">
<h3>Example 1</h3>
<div class="w3-code notranslate jsHigh">
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_iterate_array" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example 2</h3>
<div class="w3-code notranslate jsHigh">
const numbers = [2,4,6,8];<br>
<br>
for (const x of numbers) {<br>
&nbsp;&nbsp;// <i>code block to be executed</i><br>
}
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_iterate_array2" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Iterating Over a Set</h2>
<p>You can use a <code class="w3-codespan">for...of</code> loop to iterate over the elements of a Set:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_iterate_set" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<p>You can use a <code class="w3-codespan">for...of</code> loop to iterate over the elements of a Map:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_iterate_map" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<p>The <b>iterator protocol</b> defines how to produce a <b>sequence of values</b> from an object.</p> 
<p>An object becomes an <b>iterator</b> when it implements a <code class="w3-codespan">next()</code> method.</p>
<p>The <code class="w3-codespan">next()</code> method must return an object with two properties:
<ul>
...
<tr>
<th>value</th>
<td>The value returned by the iterator<br>
(Can be omitted if done is true)</td>
</tr>
<tr>
<th>done</th>
<td>
<i>true</i> if the iterator has completed<br>
...
<p>This iterable returns never ending number: 10,20,30,40,.... when <code class="w3-codespan"> the
next()</code> method is called:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Home Made Iterable<br>
function myNumbers() {<br>
&nbsp;&nbsp;let n = 0;<br>
&nbsp;&nbsp;return {<br>
&nbsp;&nbsp;&nbsp;&nbsp;next: function() {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;n += 10;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return {value:n, done:false};<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;};<br>
}<br>
<br>
// Run the Iterable<br>
const n = myNumbers();<br>
n.next(); // Returns 10<br>
n.next(); // Returns 20<br>
n.next(); // Returns 30<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_iterate_homemade" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="ws-note">

<p>Home made iterables do not support the JavaScript <code class="w3-codespan">for...of</code> statement.</p> 
</div>

<p>A JavaScript iterable is an object that has a <b>Symbol.iterator</b>.</p>
<p>The <code class="w3-codespan">Symbol.iterator</code> is a function that returns a <code class="w3-codespan">next()</code> function.</p>
<p>An iterable can be iterated over with the code: <code class="w3-codespan">for (const x of iterable) { }</code>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create an Object<br>
...
<br>
// Make it Iterable<br>
myNumbers[Symbol.iterator] = function() {<br>
&nbsp;&nbsp;let n = 0;<br>
&nbsp;&nbsp;done = false;<br>
&nbsp;&nbsp;return {<br>
&nbsp;&nbsp;&nbsp;&nbsp;next() {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;n += 10;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if (n == 100) {done = true}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return {value:n, done:done};<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;};<br>
}<br>
</div>
<p>Now you can use <code class="w3-codespan">for..of</code></p>
<div class="w3-code notranslate jsHigh">
for (const num of myNumbers) {<br>
&nbsp;&nbsp;// Any Code Here<br>
}<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_iterate_homemade2" target="_blank">Try it Yourself &raquo;</a>
</div>
<p>The Symbol.iterator method is called automatically by <code class="w3-codespan">for..of</code>.
<p>But we can also do it "manually":
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let iterator = myNumbers[Symbol.iterator]();<br>
<br>
while (true) {<br>
&nbsp;&nbsp;const result = iterator.next();<br>
&nbsp;&nbsp;if (result.done) break;<br>
&nbsp;&nbsp;// Any Code Here<br>
}
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_iterate_homemade3" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="ws-note">

<p>Iterators provide a controlled way to work with <b>data sequences</b>,
enabling <b>custom iteration logic</b> for various data structures.</p>
<p>In the next chapter you will learn about the new <b>Iterator Helper Functions</b> introduced in ECMAScript 2025.</p>
</div>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_iterables.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_looping.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_iterators.asp">Next &#10095;</a>
