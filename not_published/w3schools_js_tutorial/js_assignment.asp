...
<!--start-->
<h2>The = Operator</h2>
<p>The <b>Simple Assignment Operator</b> assigns a simple value to a variable.</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_assign_equal2" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
let x = 10;<br>
x **= 5;</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_assign_exponential" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<hr>
<!--start-->
<h2>String Assignment</h2>
<p>Two assignment operators can assign values to strings:</p>
<p>The <b>Simple Assignment Operator</b> assigns a simple value to a string.</p>
<p>The <b>Addition Assignment Operator</b> adds a value to a string.</p>
<hr>
<h2>The = Operator</h2>
The <b>Simple Assignment Operator</b> assigns a value to a variable.
<div class="w3-example">
<h3>String Assignment</h3>
<div class="w3-code notranslate jsHigh">
let text = "Hello";
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_assign_equal3" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>The += Operator</h2>
<p>The <b>Addition Assignment Operator</b> Can also be used to add strings.</p>
<div class="w3-example">
<h3>Addition Assignment Example</h3>
<div class="w3-code notranslate jsHigh">
let text = "Hello";
text += " World";
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_assign_plusequal2" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<div class="w3-example">
<h3>Logical AND Assignment Examples</h3>
<div class="w3-code notranslate jsHigh">
let x = true;<br>
let y = x &amp;&amp;= 10;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_assign_logical_and_and" target="_blank">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
let x = false;<br>
let y = x &amp;&amp;= 10;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_assign_logical_and_and2" target="_blank">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
let x = 1;<br>
let y = x &amp;&amp;= 10;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_assign_logical_and_and4" target="_blank">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
let x = 0;<br>
let y = x &amp;&amp;= 10;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_assign_logical_and_and3" target="_blank">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
let x = undefined;<br>
let y = x &amp;&amp;= 10;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_assign_logical_and_and5" target="_blank">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
let x = null;<br>
let y = x &amp;&amp;= 10;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_assign_logical_and_and6" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="ws-note">

<p>The <code class="w3-codespan">&amp;&amp;=</code> operator is an <a href="js_2020.asp">ES2020 feature</a>.</p>
</div>
<!--stop-->
<hr>
<!--start-->
...
<div class="w3-example">
<h3>Logical OR Assignment Examples</h3>
<div class="w3-code notranslate jsHigh">
let x = false;<br>
let y = x ||= 10;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_assign_logical_or_or" target="_blank">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
let x = true;<br>
let y = x ||= 10;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_assign_logical_or_or2" target="_blank">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
let x = null;<br>
let y = x ||= 10;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_assign_logical_or_or3" target="_blank">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
let x = undefined;<br>
let y = x ||= 10;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_assign_logical_or_or4" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="ws-note">
...
<div class="w3-example">
<h3>Nullish Coalescing Assignment Examples</h3>
<div class="w3-code notranslate jsHigh">
let x;<br>
x ??= 10;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_assign_nullish" target="_blank">Try it Yourself &raquo;</a>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_assign_nullish4" target="_blank">Try it Yourself &raquo;</a>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_assign_nullish2" target="_blank">Try it Yourself &raquo;</a>

<div class="w3-code notranslate jsHigh">
let x = undefined;<br>
x ??= 10;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_assign_nullish3" target="_blank">Try it Yourself &raquo;</a>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_assign_nullish5" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<tr><td>x &amp;&amp;= y</td><td>Assigns y to x only if x is truthy</td></tr>
<tr><td>x ||= y</td><td>Assigns y to x only if x is falsy</td></tr>
<tr><td>x ??= y</td><td>Assigns y to x only if x is null or undefined</td></tr>
</table>

<h2>The 8 FALSY Values</h2>
<table class="ws-table-all">
<tr></tr>
<tr><td>false</td><td>The boolean keyword itself</td></tr>
<tr><td>0</td><td>The number zero</td></tr>
<tr><td>-0</td><td>Negative zero</td></tr>
<tr><td>0n</td><td>BigInt zero</td></tr>
<tr><td>"", '', ``</td><td>Any empty string</td></tr>
<tr><td>null</td><td>The absence of any value</td></tr>
<tr><td>undefined</td><td>A variable that has not been assigned a value</td></tr>
<tr><td>NaN</td><td>"Not-a-Number," usually the result of an invalid math operation</td></tr> 
</table>

<h2>These are TRUTHY</h2>
<p>It is a common mistake to think these are falsy, but they actually evaluate to true:</p>
<table class="ws-table-all">
<tr></tr>
<tr><td>"0"</td><td>A string containing a zero is truthy because it is not empty</td></tr>
<tr><td>"false"</td><td>The string "false" is truthy</td></tr>
<tr><td>[ ]</td><td>An empty array is truthy</td></tr>
<tr><td>{ }</td><td>An empty object is truthy</td></tr>
</table>
<!--stop-->
<hr>
<h2>The Spread (...) Operator</h2>
<p>The <code class="w3-codespan">...</code> operator splits iterables into individual elements.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let text = "12345";<br>
<br>
let min = Math.min(...text);<br>
let max = Math.max(...text);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_assign_spread">Try it Yourself &raquo;</a>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_assignment.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_arithmetic.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_comparisons.asp">Next &#10095;</a>
