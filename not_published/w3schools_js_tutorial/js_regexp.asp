...
<a class="w3-right w3-btn" href="js_regexp_flags.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
<h2>Regular Expressions</h2>
<p class="intro">A <b>Regular Expression</b> is a sequence of characters that forms a <b>search pattern</b>.</p>
<p><b>Regex</b> is a common shorthand for a regular expression.</p>
<p>JavaScript <b>RegExp</b> is an <b>Object</b> for handling Regular Expressions.</p>

<p class="intro">RegExp are be used for:</p>
<ul>
<li>Text searching</li>
<li>Text replacing</li>
...
<p>
<a class="w3-btn" href="tryit.asp?filename=tryjs_regexp_string_search" target="_blank">Try it Yourself &raquo;</a></p>
</div>
...
/<em>pattern</em>/<em>modifier flags</em>
</div></div>
<!--stop-->
<hr>
<!--start-->
<h2>Using String Methods</h2>
<p>Regular expressions are often used with the <strong>string methods</strong>:</p>

<table class="ws-table-all">
<tr></tr>
<tr><th>Method</th><th>Description</th></tr>
<tr><td>match(<i>regex</i>)</td>
<td>Returns an Array of results</td></tr>
<tr><td>replace(<i>regex</i>)</td>
<td>Returns a new String</td></tr>
<tr><td>search(<i>regex</i>)</td>
...
<!--start-->
<h2>Using String match()</h2>
<div class="w3-example">
<p>Search for &quot;W3schools&quot; in a string:</p>
<div class="w3-code notranslate jsHigh">
let text = &quot;Visit W3Schools&quot;;<br>
let n = text.match(/W3schools/);
</div>
<p>
<a class="w3-btn" href="tryit.asp?filename=tryjs_regexp_method_match" target="_blank">Try it Yourself &raquo;</a></p>
</div>

<h2>Using String replace()</h2>
<div class="w3-example">
<p>Replace Microsoft with W3Schools 
in a string:</p>
<div class="w3-code notranslate jsHigh">
let text = &quot;Visit Microsoft!&quot;;<br>
let result = text.replace(/Microsoft/i, &quot;W3Schools&quot;);
</div>
<a class="w3-btn w3-margin-bottom w3-margin-top" href="tryit.asp?filename=tryjs_regexp_method_replace" target="_blank">Try it Yourself &raquo;</a>
</div>

<h2>Using String search()</h2>
<div class="w3-example">
<p>Search for &quot;W3Schools&quot; in a string:</p>
<div class="w3-code notranslate jsHigh">
let text = &quot;Visit W3Schools&quot;;<br>
...
<p>
<a class="w3-btn" href="tryit.asp?filename=tryjs_regexp_method_search" target="_blank">Try it Yourself &raquo;</a></p>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>RexExp Alternation (OR)</h2>
<p>In a regular expression an <b>alternation</b> is denoted with a vertical line character <b>|</b>.</p>
<p>An alternation matches any of the alternatives separated with <b>|</b>.</p>
<div class="w3-example">
<h3>Example</h3>
<p>A global search for the alternatives (red|green|blue):</p>
<div class="w3-code notranslate jsHigh">
let text = "Black, white, red, green, blue, yellow.";<br>
<br>
let result = text.match(/red|green|blue/g);
</div>
<p>
<a class="w3-btn" href="tryit.asp?filename=tryjs_regexp_xy" target="_blank">Try it Yourself &raquo;</a></p>
</div>
...
<p>Regular expression flags are parameters that can modify how a pattern is used,
...
<hr>
<h2>The /i Flag (Insensitive)</h2>
<p>The <b>/i</b> flag makes a match case-insensitive: /abc/i matches "abc", "AbC", "ABC".</p>
...
<div class="ws-note">
<h2>Learn More:</h2>
<p class="w3-large"><a href="js_regexp_flags.asp">JavaScript RegExp Flags</a></p>
</div>
<!--stop-->

<hr>

<h2>RexExp Metacharacters</h2>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// Match words<br>
const pattern = /\w/;
...
<p>They can be used to match digits, words, spaces, and more.</p>
<p>These are the most common:</p>
<table class="ws-table-all">
<tr></tr>
<tr><th>Meta</th><th>Description</th></tr>
<tr><td>\d</td><td>Matches Digits</td></tr>
<tr><td>\w</td><td>Matches Words</td></tr>
<tr><td>\s</td><td>Matches Spaces</td></tr>
</table>

<hr>
<h2>RegExp \d (digits) Metacharacter</h2>
<p>The \d metacharacter matches digits.</p>
<div class="w3-example">
<h3>Example</h3>
<p>A global search for digits in a string:</p>
<div class="w3-code notranslate jsHigh">
let text = "Give 100%!";<br>
const pattern = /\d/g;<br>
<br>
let result = text.match(pattern);
</div>
<p>
<a class="w3-btn" href="tryit.asp?filename=tryjs_regexp_d" target="_blank">Try it Yourself &raquo;</a></p>
</div>

<hr>
<h2>RegExp \w (word) Metacharacter</h2>
<p>The \w metacharacter matches word characters.</p>
<p>A word character is a character a-z, A-Z, 0-9, including _ (underscore).</p>
...
<div class="w3-code notranslate jsHigh">
let text = &quot;Give 100%!&quot;;<br>
const pattern = /\w/g;<br>
<br>
let result = text.match(pattern);
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_regexp_wordchar" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="ws-note">
<h2>Learn More:</h2>
<p class="w3-large"><a href="js_regexp_meta_characters.asp">JavaScript RegExp Metacharacters</a></p>
</div>

<hr>
<h2>JavaScript RegExp Quantifiers</h2>
<p><strong>Quantifiers</strong> define the numbers of characters or expressions to match.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Search for "lo" followed by one or more "o" characters:</p>
<div class="w3-code notranslate jsHigh">
const pattern = /lo+/;<br>
</div>
</div>

<p>The <b>+</b> means "one or more". The pattern matches:</p>
...
<p>These are the most common quantifiers:</p>
...
<tr>
  <td>x+</td>
  <td>Matches any string with at least one occurrences of x</td>
</tr>
<tr>
  <td>x*</td>
  <td>Matches any string with zero or more occurrences of x</td>
</tr>
<tr>
  <td>x?</td>
  <td>Matches any string with zero or one occurrences of x</td>
</tr>
</table>
</div>
...
<p><b><i>x</i>?</b> matches zero or one occurrences of x.</p>
<div class="w3-example">
<h3>Example</h3>
<p>A global search for "1", followed by zero or one "0" characters:</p>
<div class="w3-code notranslate jsHigh">
let text = "1, 100 or 1000?";<br>
const pattern = /10?/g;<br>
<br>
let result = text.match(pattern);
</div>
<p>
<a class="w3-btn" href="tryit.asp?filename=tryjs_regexp_n3" target="_blank">Try it Yourself &raquo;</a></p>
</div>
...
<h2>Regular Expression Assertions</h2>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// Match beginning of string<br>
const pattern = /^W3Schools/;<br>
<br>
// Match end of string<br>
const pattern = /W3Schools$/;
</div>
</div>
<p><b>Assertions</b> matches <b>Boundaries</b> and <b>Lookarounds</b>:</p>
<p>String Boundaries and Word Boundaries.</p>
<p>Lookarounds: Lookaheads and Lookbehinds.</p>
<p>These are the most common:</p>
<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
<tr><th>Syntax</th><th>Name</th><th>Description</th></tr>
<tr><td>^</td><td>String boundary</td><td>Matches the beginning of a string</td></tr>
<tr><td>$</td><td>String boundary</td><td>Matches the end of a string</td></tr>
<tr><td>\b</td><td>Word boundary</td><td>Matches the beginning or end of a word</td></tr>
<tr><td>(?=...)</td><td>Lookahead</td><td>Matches the subsequent string</td></tr>
<tr><td>(?&lt;=...)</td><td>Lookbehind</td><td>Matches the previous string</td></tr>
</table>
</div>

<hr>
<h2>RegExp ^ Metacharacter</h2>
<p>The ^ metacharacter matches the beginning of a string.</p>
<div class="w3-example">
<h3>Examples</h3>
<p>Test if a string starts with W3Schools:</p>
<div class="w3-code notranslate jsHigh">
const pattern = /^W3Schools/;<br>
let text = "W3Schools Tutorial";<br>
<br>
let result = pattern.test(text); // true<br>
</div>
<p>
<a class="w3-btn" href="tryit.asp?filename=tryjs_regexp_hat" target="_blank">Try it Yourself &raquo;</a></p>
<div class="w3-code notranslate jsHigh">
const pattern = /^W3Schools/;<br>
let text = "Hello W3Schools";<br>
<br>
let result = pattern.test(text); // false<br>
</div>
<p>
<a class="w3-btn" href="tryit.asp?filename=tryjs_regexp_hat_2" target="_blank">Try it Yourself &raquo;</a></p>
</div>

<hr>
<h2>RegExp $ Metacharacter</h2>

<p>The $ metacharacter matches the end of a string.</p>
<div class="w3-example">
<p>Test if a string ends with W3Schools:</p>
<div class="w3-code notranslate jsHigh">
const pattern = /W3Schools$/;<br>
let text = "Hello W3Schools";<br>
<br>
...
<a target="_blank" href="tryit.asp?filename=tryjs_regexp_dollar" class="w3-btn">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
const pattern = /W3Schools$/;<br>
let text = "W3Schools tutorial";<br>
<br>
...
<a target="_blank" href="tryit.asp?filename=tryjs_regexp_dollar_2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<hr>
<h2>JavaScript RegExp Character Classes</h2>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
// Match Digits<br>
const pattern = /[0-9]/;
...
<p><b>Character Classes</b> are characters enclosed in square brackets <b>[]</b>.</p>
<p>A character class matches any character from a set within brackets.</p>
<p>These are the most common:</p>
<div class="w3-stretch">
<table class="ws-table-all notranslate">
<tr></tr>
...
<tr>
  <td>[a]</td>
  <td>Matches the character between the brackets</td>
</tr>
<tr>
  <td>[abc]</td>
  <td>Matches all characters between the brackets</td>
  </tr>
<tr>
  <td>[a-z]</td>
  <td>Matches all characters in the range from a to z</td>
</tr>
<tr>
  <td>[0-9]</td>
  <td>Matches all characters in the range from 0 to 9</td>
</tr>
</table>
</div>
...
<div class="w3-example">
<h3>Example [0-9]</h3>
<p>A global search for the characters "0" to "9" in a string:</p>
<div class="w3-code notranslate jsHigh">
let text = "More than 1000 times";<br>
const pattern = /[0-9]/g;<br>
<br>
let result = text.match(pattern);
</div>
<p>
<a class="w3-btn" href="tryit.asp?filename=tryjs_regexp_0-9_1" target="_blank">Try it Yourself &raquo;</a></p>
</div>
...
<div id="exercisecontainer" src="xrcise_regexp.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_random.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_regexp_flags.asp">Next &#10095;</a>
