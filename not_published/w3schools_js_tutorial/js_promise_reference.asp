...
<html lang="en-US">
<head>
<title>JavaScript Promise Referenced</title>
<meta charset="utf-8">
...
<h1>JavaScript Promise Reference</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_async_debug.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_modules.asp">Next &#10095;</a>
</div>
<div class="ws-info">

<p>This page is a reference for <b>JavaScript promises</b>.</p>
<p>Use it to look up promise methods and common patterns.</p>
</div>

<div class="ws-note">

<p>If you want to learn promises step by step, read <a href="js_promise.asp">JavaScript Promises</a>.</p>
</div>

<hr>
<h2>The Promise Object</h2>
<p>The <b>Promise Object</b> represents the completion or failure of an asynchronous operation.</p>
<p>A Promise can have 3 states:</p>
<table class="ws-table-all">
<tr><td>pending</td><td>initial state</td></tr>
<tr><td>rejected</td><td>operation failed</td></tr>
<tr><td>fulfilled</td><td>operation completed</td></tr>
</table>

<hr>
<h2>Promise Object Methods</h2>
...
<tr></tr>
<tr>
  <th width="230px">Method</th>
  <th>Description</th>
</tr>
<tr>
  <td><a href="/jsref/jsref_promise_catch.asp">.catch(onRejected)</a></td>
  <td>Provides a function to run when a promise is rejected</td>
</tr>
<tr>
  <td><a href="/jsref/jsref_promise_finally.asp">.finally(onFinally)</a></td>
  <td>Provides a function to run when a promise is fulfilled or rejected</td>
</tr>
<tr>
  <td><a href="/jsref/jsref_promise_then.asp">.then(onFulfilled, onRejected)</a></td>
  <td>Provides one callback function for fulfilled and one for rejected</td>
</tr>
</table>
</div>
...
<tr>
  <td><a href="/jsref/jsref_promise_all.asp">Promise.all()</a></td>
  <td>Returns a single Promise from a list of promises<br>When all promises fulfill</td>
</tr>
<tr>
  <td><a href="/jsref/jsref_promise_allsettled.asp">Promise.allSettled()</a></td>
  <td>Returns a single Promise from a list of promises<br>When all promises settle</td>
</tr>
<tr>
  <td><a href="/jsref/jsref_promise_any.asp">Promise.any()</a></td>
  <td>Returns a single Promise from a list of promises<br>When any promise fulfills</td>
</tr>
<tr>
  <td><a href="/jsref/jsref_promise_race.asp">Promise.race()</a></td>
  <td>Returns a single Promise from a list of promises<br>When the faster promise settles</td>
</tr>
<tr>
  <td><a href="/jsref/jsref_promise_reject.asp">Promise.reject()</a></td>
  <td>Returns a Promise rejected with a given value</td>
</tr>
<tr>
  <td><a href="/jsref/jsref_promise_resolve.asp">Promise.resolve()</a></td>
  <td>Returns a Promise resolved with a given value</td>
</tr>
<tr>
  <td><a href="/jsref/jsref_promise_then.asp">Promise.then()</a></td>
  <td>Provides two callbacks:<br>One funtion to run when a promise is fulfilled.<br>
  One funtion to run when a promise is rejected.</td>
</tr>
<tr>
  <td><a href="/jsref/jsref_promise_try.asp">Promise.try()</a></td>
  <td>Executes a function and wraps its result in a promise.</td>
</tr>
<tr>
  <td><a href="/jsref/jsref_promise_withresolvers.asp">Promise.withResolvers()</a></td>
  <td>Returns an object containing a new Promise object and two functions to resolve or reject it.</td>
</tr>
</table>
</div>
...
<p>The <code class="w3-codespan">.then()</code> method provides two functions to run when a promise is fulfilled.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Using then() to display a result<br>
myPromise.then(<br>
&nbsp; function(value) {myDisplayer(value)},<br>
&nbsp; function(value) {myDisplayer(value)}<br>
);</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_promise_then">
Try it Yourself &raquo;</a></p>
</div>

<hr>
<h2>The .catch() Method</h2>
<p>The <code class="w3-codespan">.catch()</code> method provides a function to run when a promise is rejected.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Using catch() to display a result<br>
myPromise.catch(<br>
&nbsp; function(value) {myDisplayer(value);}<br>
);<br>
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_promise_catch">
Try it Yourself &raquo;</a></p>
</div>

<hr>
<h2>The .finally() Method</h2>
<p>The <code class="w3-codespan">.finally()</code> method provides a function to run when a promise is fulfilled or rejected.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Using finally() to display a result<br>
myPromise.finally(<br>
&nbsp; function(value) {myDisplayer(value)}<br>
);<br>
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_promise_finally">
Try it Yourself &raquo;</a></p>
</div>

<hr>
<h2>Promise.resolve()</h2>
<p>The <code class="w3-codespan">Promise.resolve()</code> method returns a Promise object resolved with a value.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let promise = Promise.resolve("Resolved OK");<br>
<br>
promise<br>
.then(function(value) {<br>
&nbsp;&nbsp;myDisplayer(value);<br>
})<br>
.catch(function(value) {<br>
&nbsp;&nbsp;myDisplayer(value);<br>
});
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_promise_resolve">
Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Promise.reject()</h2>
<p>The <code class="w3-codespan">Promise.reject()</code> method returns a Promise object rejected with a value.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let promise = Promise.reject("Something went wrong");<br>
<br>
promise<br>
.then(function(value) {<br>
&nbsp;&nbsp;myDisplayer(value);<br>
...
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_promise_reject">
Try it Yourself &raquo;</a></p>
</div>
...
<h2>Promise.all()</h2>
<p>The <code class="w3-codespan">Promise.all()</code> method returns a single Promise from a list of promises,
when all promises fulfill (or rejects when one promise rejects).</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let p1 = Promise.resolve("A");<br>
let p2 = Promise.resolve("B");<br><br>
Promise.all([p1, p2])<br>
.then(function(values) {<br>
&nbsp;&nbsp;myDisplayer(values);<br>
});<br>
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_promise_all">
Try it Yourself &raquo;</a></p>
</div>
<hr>
...
<p><code class="w3-codespan">Promise.allSettled()</code> returns an array of results for all promises.</p>
<p>Each result contains a status and a value or reason.</p>

<div class="w3-example">
<h3>Examples</h3>
<div class="w3-code notranslate jsHigh">
let p1 = Promise.resolve("A");<br>
let p2 = Promise.reject("X");<br><br>
Promise.allSettled([p1, p2])<br>
.then(function(results) {<br>
&nbsp;&nbsp;myDisplayer(JSON.stringify(results));<br>
});<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_promise_all_settled">
Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
// Create a Promise<br>
const myPromise1 = new Promise((resolve, reject) =&gt; {<br>
&nbsp;&nbsp;setTimeout(resolve, 200, "King");<br>
});<br>
<br>
// Create another Promise<br>
const myPromise2 = new Promise((resolve, reject) =&gt; {<br>
&nbsp;&nbsp;setTimeout(resolve, 100, "Queen");<br>
});<br>
<br>
// Settle All<br>
Promise.all([myPromise1, myPromise2])<br>
.then(function(values) {<br>
&nbsp;&nbsp;myDisplayer(values);<br>
});
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_promise_allsettled">
Try it Yourself &raquo;</a>
</div>
...
<p><code class="w3-codespan">Promise.allSettled()</code> is an ES2020 feature.</p>
...
<hr>
<h2>Promise.race()</h2>
<p><code class="w3-codespan">Promise.race()</code> settles when the first promise settles.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let p1 = new Promise(function(resolve) {<br>
&nbsp;&nbsp;setTimeout(function() { resolve("First"); }, 500);<br>
});<br>
let p2 = new Promise(function(resolve) {<br>
&nbsp;&nbsp;setTimeout(function() { resolve("Second"); }, 1000);<br>
});<br><br>
Promise.race([p1, p2])<br>
.then(function(value) {<br>
&nbsp;&nbsp;myDisplayer(value);<br>
});<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_promise_race">
Try it Yourself &raquo;</a>
</div>
...
<p><code class="w3-codespan">Promise.any()</code> resolves when the first promise is fulfilled.</p>
<p>It rejects only if all promises reject.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_promise_any">
Try it Yourself &raquo;</a>
</div>

<div class="ws-tip">
<p><code class="w3-codespan">Promise.any()</code> is useful when multiple sources can provide the same result.</p>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const {promise, resolve, reject} = Promise.withResolvers();<br>
<br>
// You can now use 'resolve' and 'reject' anywhere in your code to control the state of the "promise".<br>
<br>
// Simulate async work<br>
setTimeout(() =&gt; {<br>
...
<br>
// Display result the promise finishes<br>
promise<br>
.then((value) =&gt; {<br>
&nbsp;&nbsp;myDisplayer(value);<br>
})<br>
...
<a target="_blank" href="tryit.asp?filename=tryjs_promise_withresolvers" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate jsHigh">
// Set text in then/catch, update DOM in finally<br>
promise<br>
.then((message) =&gt; text = message)<br>
.catch((error) =&gt; text = error)<br>
.finally(() =&gt; {myDisplayer(text)}<br>
);
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_promise_withresolvers2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<h3>Example Explained</h3>
<ul>
...
<div class="w3-code notranslate jsHigh">
// Use async/await to handle the promise<br>
(async () =&gt; {<br>
&nbsp;&nbsp;try {<br>
&nbsp;&nbsp;&nbsp;&nbsp;text = await promise;  // Wait for resolve<br>
&nbsp;&nbsp;} catch (err) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;text = err;            // Handle reject<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;// Update the UI after promise finishes<br>
&nbsp;&nbsp;myDisplayer(text);<br>
})();
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_promise_withresolvers3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<h3>Example Explained</h3>
<ul>
...
<h2>Related Pages</h2>
<ul class="w3-large">
<li><a href="js_asynchronous.asp">Asynchronous Programming</a></li>
<li><a href="js_async.asp">Async Intro</a></li>
<li><a href="js_async_timeouts.asp">Async Timeouts</a></li>
<li><a href="js_async_callbacks.asp">Async Callbacks</a></li>
<li><a href="js_promise.asp">Async Promises</a></li>
<li><a href="js_async_await.asp">Async and await</a></li>
<li><a href="js_asynC_fetch.asp">Async fetch API</a></li>
<li><a href="js_async_debug.asp">Async Debugging</a></li>
</ul>
</div>
