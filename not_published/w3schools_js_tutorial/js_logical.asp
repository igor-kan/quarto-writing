...
<a class="w3-right w3-btn" href="js_loops.asp">Next &#10095;</a>
</div>
<div class="ws-info">
<h2>Logical Operators</h2>
<p>Logical operators are used to <b>combine boolean expressions</b>.</p>
<p>Logical operators can be used to modify the results of comparisons.</p>
<p>Typically, you will use a comparison operator to check a condition,
and a logical operator to combine conditions into more complex logic.</p>
</div>
...
<td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryjs_oper_and">Try it &raquo;</a></td>
</tr>
<tr>
<td>||</td>
<td>OR</td>
<td>(x === 5 || y === 5) is false</td>
<td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryjs_oper_or">Try it &raquo;</a></td>
</tr>
<tr>
<td>!</td>
<td>NOT</td>
<td> !(x === y) is true</td>
<td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryjs_oper_not">Try it &raquo;</a></td>
</tr>
</table>
</div>
...
<hr>
<h2>JavaScript Logical AND</h2>
<p>The <b>&amp;&amp; operator</b> returns <code class="w3-codespan">true</code>
if <b>both expressions</b> are <code class="w3-codespan">true</code>,
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_oper_and" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>JavaScript Logical OR</h2>
<p>The <b>|| operator</b> returns <code class="w3-codespan">true</code> if <b>one or both expressions</b>
are <code class="w3-codespan">true</code>, otherwise <code class="w3-codespan">false</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let x = 6;<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_oper_or2" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>JavaScript Logical NOT</h2>
<p>The NOT operator (!) returns <code class="w3-codespan">true</code> for <b>false expressions</b>
and <code class="w3-codespan">false</code> for <b>true expressions</b>.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let x = (5 == 8);<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_oper_not" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">??</code> operator returns the right operand when the left operand is 
<b>nullish</b> (<code class="w3-codespan">null</code> or <code class="w3-codespan">undefined</code>),
otherwise it returns the left operand.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let name = null;<br>
...
<p>When programming, a lot of values can be <b>falsey</b> (like 0, empty strings, false,
undefined, null, NaN).</p>
<p>However, sometimes you want to check if a variable is <b>nullish</b> 
(either <code class="w3-codespan">undefined</code> or <code class="w3-codespan">null</code>),
like when it is okay for a variable to be an empty string, or a false value.
Then you can use the <b>nullish coalescing operator</b>.</p>
<hr>
<h2>Browser Support</h2>
<p><code class="w3-codespan">??</code> is an ES2020 feature.</p>
...
<div class="ws-note">
<h2>See Also:</h2>
<p class="w3-large"><a href="js_comparisons.asp">JavaScript Comparisons</a>.</p>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_comparisons.js"></div>
<hr>
