...
<html lang="en-US">
<head>
<title>JavaScript Dynamic Modules</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="js_modules_namespace.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_meta_programming.asp">Next &#10095;</a>
</div>
...
<div class="ws-note">
<p><b>Dynamic Import</b> was introduced in <a href="js_2020.asp">ECMAScript 2020</a></p>
...
&nbsp;&nbsp;const module = await import("./math.js");<br>
&nbsp;&nbsp;let result = module.add(2, 3);<br>
}<br>
run();
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_modules6">Try it Yourself &raquo;</a></p>
<h3>math.js</h3>
<div class="w3-code notranslate jsHigh">
...
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
async function run(x) {<br>
&nbsp;&nbsp;const module = await import("./temperatures.js");<br>
&nbsp;&nbsp;let celsius = module.toCelsius(x);<br>
&nbsp;&nbsp;document.getElementById("demo").textContent = celsius + " Celcius";<br>
}<br>
run(50);
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_modules5">Try it Yourself &raquo;</a></p>
<h3>temperatures.js</h3>
<div class="w3-code notranslate jsHigh">
// Convert Fahrenheit to Celsius<br>
export function toCelsius(farenheit) {<br>
&nbsp;&nbsp;return (farenheit - 32) * 5 / 9;<br>
}<br>
<br>
// Convert Celsius to Fahrenheit<br>
export function toFahrenheit(celsius) {<br>
...
<div class="w3-code notranslate jsHigh">
if (user.isAdmin) {<br>
&nbsp;&nbsp;const adminTools = await import("./admin-tools.js");<br>
&nbsp;&nbsp;adminTools.init();<br>
}
</div>
</div>
