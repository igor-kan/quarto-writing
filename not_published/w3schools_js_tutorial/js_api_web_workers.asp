...
<a target="_blank" href="tryit.asp?filename=tryjs_webworker" class="w3-btn w3-margin-bottom w3-margin-top">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
&lt;/body&gt;<br>
&lt;/html&gt;</div>
<a target="_blank" href="tryit.asp?filename=tryjs_webworker" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
