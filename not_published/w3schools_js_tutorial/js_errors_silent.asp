...
<html lang="en-US">
<head>
<title>JavaScript Silent Errors</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="js_errors_intro.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_errors.asp">Next &#10095;</a>
</div>
<div class="ws-info">
<h2>Silent Errors</h2>
<p>JavaScript can fail siently.</p>
<p>A silent error will not stop your program. The execution will continue.</p>
<p>The reason for silent errors is historical:</p>
<p>The first version of JavaScript did not have catch...try exceptions.</p>
</div>

<div class="ws-note">

<p><b>Silent errors</b> are issues that do not throw exceptions or stop execution,
but still cause logic bugs, unexpected behavior, or failures that are easy to miss.</p>
</div>
<p>Below are some examples of common silent errors, with examples to try:</p>
...
<a target="_blank" href="tryit.asp?filename=tryjs_errors_silent1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Assignment, not comparison</p>
<div class="w3-code notranslate jsHigh">
let result = "Not Active.";<br>
let isActive = false;<br>
<br>
// &#10060; Assignment, not comparison<br>
if (isActive = true) {<br>
&nbsp; let result = "Active!";<br>
}<br>
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_errors_silent2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<h3>Explanation</h3>

<p>When execution reaches the if statement, you might expect that the conditional block
will not be executed because <b>isActive is false</b>.</p>
<p>But, the code <code class="w3-codespan">(isActive = true)</code> in the evaluation will set
<b>isActive to true</b> instead of checking equality with  <code class="w3-codespan">(isActive == true)</code>.</p>
<p>This (<b>true</b>) is also the value of the if condition, so the block will be executed.</p>
<div class="ws-note">
<p>The above mistake is not an error that JavaScript could have detected (it may have been intended).</p>
<p>It is a mistake of the programmer.</p>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Many numeric operations that fail produce NaN (not an exception).</p>
<p>JavaScript will not crash. It just quietly gives you NaN and keeps going.</p>
<div class="w3-code notranslate jsHigh">
// NaN - no error, just wrong data<br>
const result = parseInt("abc");<br>
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_errors_silent3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Accessing a missing property just returns undefined silently.</p>
<div class="w3-code notranslate jsHigh">
const user = {};<br>
let result = user.name;
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_errors_silent4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<h2>Type Coercion</h2>
<p><b>Type coercion</b> is the automatic (implicit) conversion of values from one data type to another.</p>
<p>Because JavaScript is <b>weakly typed</b>, it doesn't throw errors when types don't match;
it just tries to coerce them.</p>
<p>JavaScript coerces types differently per operator, so type coercion can hide bugs.</p>

<div class="w3-example">
<h3>Example</h3>

<div class="w3-code notranslate jsHigh">
let result1 = ('5' + '2'); // = 52<br>
let result2 = ('5' - '2'); // = 3
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_errors_silent5" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>String Coercion (+)</h2>
<p>If any part of a + operation is a string, JavaScript converts everything to strings:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
let x = "5" + 2 // x = "52"
</div>
...
<p>Other arithmetic operators (-, *, /, %) and the unary plus (+x) force values into numbers.</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
let x = "5" - 2 // x = 3
</div>
...
<p>This operator performs coercion to find a "common type" before comparing.</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
let x = (5 == "5") // x = true
</div>
...
<hr>
<h2>Practices to Avoid Bugs</h2>
<p><b>Use === (Strict Equality)</b><br>
This checks both value and type without coercion, preventing weird results.</p>
<p><b>Be Explicit</b><br>
Instead of relying on automatic behavior, use MDN's recommended conversion methods
like Number() or String() to make your intent clear.</p>
<p><b>Watch for NaN</b><br>
If a string cannot be converted to a valid number, like "abc" - 1), the result is NaN (Not-a-Number).</p>
