...
<a class="w3-left w3-btn" href="js_arraybuffers.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_atomics.asp">Next &#10095;</a>
</div>
...
// Create a 16 bytes ArrayBuffer<br>
const buffer = new ArrayBuffer(16);<br>
<br>
// Create a new DataView<br>
const view = new DataView(buffer);<br>
<br>
// Get lengths and offset<br>
let len1 = buffer.byteLength);<br>
let len2 = view.byteLength;<br>
let off1 = view.byteOffset;<br>
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_dataview_create" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<br>
// Create a new DataView<br>
const view = new DataView(buffer, 4, 8);<br>
<br>
// Get lengths and offset<br>
let len1 = buffer.byteLength);<br>
let len2 = view.byteLength;<br>
...
<a target="_blank" href="tryit.asp?filename=tryjs_dataview_create2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate jsHigh">
const buffer = new ArrayBuffer(8);<br>
const view = new DataView(buffer);<br>
<br>
// Write a 32-bit signed integer at byte offset 0<br>
view.setInt32(0, 123456);<br>
<br>
// Read it back<br>
const value = view.getInt32(0);<br>
<br>
...
const view = new DataView(buffer);<br>
<br>
view.setFloat64(0, Math.PI);<br>
view.setFloat64(8, Math.E);<br>
<br>
const pi = view.getFloat64(0);<br>
const e  = view.getFloat64(8);<br>
<br>
console.log("PI:", pi);<br>
console.log("E:", e);<br>
</div>
</div>
...
<div class="w3-code notranslate jsHigh">
const buffer = new ArrayBuffer(4);<br>
const view   = new DataView(buffer);<br>
<br>
// Same number, two different byte orders:<br>
view.setUint32(0, 0x12345678, true);  // little-endian<br>
<br>
console.log(new Uint8Array(buffer));<br>
// Example output: Uint8Array(4) [120, 86, 52, 18] (0x78, 0x56, 0x34, 0x12)<br>
<br>
// Overwrite with big-endian<br>
view.setUint32(0, 0x12345678, false); // big-endian<br>
<br>
console.log(new Uint8Array(buffer));<br>
...
<div class="w3-code notranslate jsHigh">
const buffer = new ArrayBuffer(12);<br>
const view   = new DataView(buffer);<br>
<br>
// Byte 0: a flag (0 or 1)<br>
view.setUint8(0, 1);<br>
<br>
// Bytes 1-2: a 16-bit length (little-endian)<br>
view.setUint16(1, 500, true);<br>
<br>
// Bytes 4-11: a 64-bit float (skip byte 3 for alignment)<br>
view.setFloat64(4, 3.14159, true);<br>
<br>
// Read the values back<br>
const flag   = view.getUint8(0);<br>
const length = view.getUint16(1, true);<br>
const value  = view.getFloat64(4, true);<br>
<br>
console.log("Flag:", flag);<br>
console.log("Length:", length);<br>
...
<a href="#" class="w3-btn">Try it Yourself �</a>
</div>
