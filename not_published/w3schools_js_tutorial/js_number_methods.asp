...
<a class="w3-right w3-btn" href="js_number_properties.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
...
<tr><td width="50%">
<h2>Basic Methods</h2>
<p>Basic number methods can be used <b>on any number</b>:</p>
<a href="#mark_tostring">toString()</a><br>
<a href="#mark_toexponential">toExponential()</a><br>
<a href="#mark_tofixed">toFixed()</a><br>
<a href="#mark_toprecision">toPrecision()</a><br>
<a href="#mark_valueof">valueOf()</a><br>
</td><td>
<h2>Static Methods</h2>
<p>Static methods can only be used <b>on Number</b>:</p>
<a href="#mark_isfinite">Number.isFinite()</a><br>
<a href="#mark_isinteger">Number.isInteger()</a><br>
<a href="#mark_isnan">Number.isNan()</a><br>
<a href="#mark_issafeinteger">Number.isSafeInteger()</a><br>
<a href="#mark_parseint">Number.parseInt()</a><br>
<a href="#mark_parsefloat">Number.parseFloat()</a><br>
</td>
</tr>
</table>
</div>
...
<h2>See Also:</h2>
<a href="js_numbers.asp">Numbers Tutorial</a><br>
<a href="js_number_properties.asp">Number Properties</a><br>
<a href="js_number_reference.asp">Number Reference</a><br>
</div>
...
<p>The <code class="w3-codespan">toString()</code> method can take an optional radix argument to convert
the number to a different base:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let x = 123;<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_numbers_tostring2" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<a id="mark_toexponential"></a>
...
<p><code class="w3-codespan">toFixed()</code> returns a string, with the number 
...
<hr>
<!--start-->
<a id="mark_toprecision"></a>
<h2>The toPrecision() Method</h2>
<p><code class="w3-codespan">toPrecision()</code> returns a string, with a number written with a 
specified length:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<p>The <code class="w3-codespan">valueOf()</code> method is used internally in JavaScript to convert Number 
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_global_number_date_0" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="w3-panel ws-note">

<p>The <code class="w3-codespan">Date()</code> method returns the number of milliseconds since 1.1.1970.
</p>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_global_number_date_1" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<hr>
<!--start-->
<a id="mark_parseint"></a>
<h2>The parseInt() Method</h2>
<p><code class="w3-codespan">parseInt()</code> parses a string and returns a whole number. Spaces are 
...
<hr>
<!--start-->
<a id="mark_parsefloat"></a>
<h2>The parseFloat() Method</h2>
<p><code class="w3-codespan">parseFloat()</code> parses a string and returns a number. Spaces are 
allowed. Only the first number is returned:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<tr><td>Number.isNaN()</td><td>Returns true if the argument is NaN</td></tr>
<tr><td>Number.isFinite()</td><td>Returns true if the argument is not Infinity nor NaN</td></tr>
...
<hr>
<!--start-->
<a id="mark_isfinite"></a>
<h2>The Number.isFinite() Method</h2>
<p>The <code class="w3-codespan">Number.isFinite()</code> method returns <code class="w3-codespan">true</code>
if the argument is not Infinity, -iInfinity, nor Nan.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
Number.isFinite(123);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_number_isfinite" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>The <code class="w3-codespan">Number.isNaN()</code> method returns <code class="w3-codespan">true</code>
if the argument is NaN (Not a Number).</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
Number.isNaN(123);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_number_isnan" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="ws-note">

<p><code class="w3-codespan">Number.isNaN()</code> is the preferred way to check for equality with NaN.
You cannot test for equality with NaN using == or ===.</p> 
</div>
<!--stop-->
<hr>
<!--start-->
<a id="mark_issafeinteger"></a>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_number_parsefloat" target="_blank">Try 
it Yourself &raquo;</a></div>
<p>If the number cannot be converted, <code class="w3-codespan">NaN</code> (Not a Number) is returned.</p>
<div class="ws-note">

<p>The <b>Number</b> methods <code class="w3-codespan">Number.parseInt()</code>
and <code class="w3-codespan">Number.parseFloat()</code><br><br>
are the same as the<br><br>
<b>Global</b> methods <code class="w3-codespan">parseInt()</code> and <code class="w3-codespan">parseFloat()</code>.</p>
<p>The purpose of these two methods is modularization of globals, to make it easier to use the same
JavaScript code outside the browser.</p>
</div>
<!--stop-->
<hr>
<!--start-->
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_number_parseint" target="_blank">Try 
it Yourself &raquo;</a></div>
<p>If the number cannot be converted, <code class="w3-codespan">NaN</code> (Not a Number) is returned.</p>
<!--stop-->
...
<hr>
<div id="exercisecontainer" src="xrcise_number_methods.js"></div>
<hr>
