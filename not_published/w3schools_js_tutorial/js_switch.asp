...
<a class="w3-left w3-btn" href="js_if_ternary.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_booleans.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
<h2>Switch Control Flow</h2>
<p class="intro">Based on a condition, <code class="w3-codespan">switch</code> selects one or more
<b>code blocks to be executed</b>.</p>
<p class="intro"><code class="w3-codespan">switch</code> executes the code blocks that <b>matches an expression</b>.</p>
<p class="intro"><code class="w3-codespan">switch</code> is often used as a more readable alternative
to many if...else if...else statements, especially when dealing with multiple possible values.</p>
</div>
...
<li>If there is no match, no code is executed.</li>
</ul>
...
<div class="ws-note">
 ...
 <p>The <code class="w3-codespan">getDay()</code> method returns the weekday as a number between 
 0 and 6.</p>
...
<p>When JavaScript reaches a <code class="w3-codespan">break</code> 
keyword, it <b>breaks out of the switch</b> block.</p>
<p>This will <b>stop the execution</b> inside the switch block.</p>
...
<p>The <code class="w3-codespan">break</code> keyword is crucial for preventing a "fall-through."</p>
...
<p>The <code class="w3-codespan">default</code> keyword specifies a block of code to run if there is no 
case match.</p>
<p>The <code class="w3-codespan">default</code> keyword is optional.</p>
<p>The <code class="w3-codespan">default</code> can act as a fallback:</p>
<div class="w3-example">
<h3>Example</h3>
 <p>The <code class="w3-codespan">getDay()</code> method returns the weekday as a number between 
 0 and 6.</p>
...
<a target="_blank" href="tryit.asp?filename=tryjs_switch2" class="w3-btn w3-margin-bottom w3-margin-top">Try it Yourself &raquo;</a>
</div>
<p>The <code class="w3-codespan">default</code> case does not have to be the last case in a switch 
block:</p>
<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate jsHigh">
...
<p>Switch uses <strong>strict</strong> comparison (===).</p>
<p>The values must be of the same type to match.</p>
<p>A strict comparison can only be true if both operands are of the same type.</p>

<div class="w3-example">
<h3>Example</h3>
<p>In this example there is no match for x:</p>
<div class="w3-code notranslate jsHigh">
