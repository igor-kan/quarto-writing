...
<html lang="en-US">
<head>
<title>JavaScript EventListener Project</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="js_project_counter.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_project_todo.asp">Next &#10095;</a>
</div>
...
<br>
&lt;button id="btnPlus"&gt;+&lt;/button&gt;<br>
&lt;button id="btnMinus"&gt;-&lt;/button&gt;<br>
...
document.getElementById("btnPlus").addEventListener("click", increaseCount);<br>
document.getElementById("btnMinus").addEventListener("click", decreaseCount);<br>
document.getElementById("btnReset").addEventListener("click", resetCount);<br>
document.getElementById("btnSave").addEventListener("click", saveCount);<br>
document.getElementById("btnLoad").addEventListener("click", loadCount);<br>
<br>
// Declare the counter<br>
let count = 0;<br>
<br>
// Load counter when the page opens<br>
loadCount();<br>
<br>
...
<a target="_blank" href="tryit.asp?filename=tryjs_project_counter_listen"
...
&lt;button id="btnLoad"&gt;Load&lt;/button&gt;<br>
<br>
&lt;script  src="counter.js"&gt;&lt;/script&gt;<br>
<br>
&lt;/body&gt;<br>
&lt;/html&gt;<br>
</div>
...
let count = 0;<br>
<br>
// Use element variables<br>
const countEl = document.getElementById("count");<br>
const msgEl = document.getElementById("message");<br>
const btnPlus = document.getElementById("btnPlus");<br>
const btnMinus = document.getElementById("btnMinus");<br>
const btnReset = document.getElementById("btnReset");<br>
const btnSave = document.getElementById("btnSave");<br>
const btnLoad = document.getElementById("btnLoad");<br>
<br>
// Add event listeners<br>
btnPlus.addEventListener("click", increaseCount);<br>
btnMinus.addEventListener("click", decreaseCount);<br>
btnReset.addEventListener("click", resetCount);<br>
btnSave.addEventListener("click", saveCount);<br>
btnLoad.addEventListener("click", loadCount);<br>
<br>
// Function to display the counter<br>
function updateCount() {<br>
&nbsp;&nbsp;document.getElementById("count").innerHTML = count;<br>
...
<br>
// Function to diplay message<br>
function showMessage(text) {<br>
&nbsp;&nbsp;msgEl.innerHTML = text;<br>
...
<a target="_blank" href="tryit.asp?filename=tryjs_project_counter_3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
