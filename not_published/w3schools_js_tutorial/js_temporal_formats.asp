...
<html lang="en-US">
<head>
<title>JavaScript Temporal Display Formats - toString and LocaIntl.DateTimeFormat</title>
<meta charset="utf-8">
...
<h1>Temporal Display Formats</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_temporal_conversion.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_temporal_mistakes.asp">Next &#10095;</a>
</div>
...
<hr>
<h2>PlainDate toString()</h2>
<p>The <code class="w3-codespan">toString()</code> method returns a standard ISO string.</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_format_plaindate" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>PlainTime toString()</h2>
<p>A <code class="w3-codespan">PlainTime</code> value is formatted as a time string.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const time = Temporal.PlainTime.from("14:30:15");<br>
<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_format_plaintime" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>PlainDateTime toString()</h2>
<p>A <code class="w3-codespan">PlainDateTime</code> value includes both date and time.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const dateTime = Temporal.PlainDateTime.from("2026-05-17T14:30:15");<br>
<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_format_plaindatetime" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>ZonedDateTime toString()</h2>
<p>A <code class="w3-codespan">ZonedDateTime</code> string includes the offset and time zone.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_format_zoneddatetime" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Remove Smaller Time Units</h2>
<p>You can control how much detail to include.</p>
<p>For example, you can hide seconds or milliseconds.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const time = Temporal.PlainTime.from("14:30:15.123");<br>
<br>
...
<hr>
<h2>Control Fractional Digits</h2>
<p>You can choose how many decimal digits to include.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const time = Temporal.PlainTime.from("14:30:15.123456789");<br>
<br>
...
<h2>PlainDate toLocaleString()</h2>
<p>Use <code class="w3-codespan">toLocaleString()</code> to format a value using the user's locale.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const date = Temporal.PlainDate.from("2026-05-17");<br>
<br>
let text_us = date.toLocaleString("en-US");<br>
let text_de = date.toLocaleString("de-DE");<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_format_plaindate_locale" target="_blank">Try it Yourself &raquo;</a>
</div>
<p>The output depends on the chosen locale.</p>

<hr>
<h2>ZonedDateTime toLocaleString()</h2>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const zoned = Temporal.ZonedDateTime.from("2026-05-17T14:30:15+01:00[Europe/Oslo]");<br>
<br>
let text = zoned.toLocaleString("en-US", {<br>
&nbsp;&nbsp;dateStyle: "full",<br>
&nbsp;&nbsp;timeStyle: "short"<br>
});
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_format_zoneddatetime_locale" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Format with Intl.DateTimeFormat</h2>
<p>Use <code class="w3-codespan">Intl.DateTimeFormat</code> when you need more control over the output.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const date = Temporal.PlainDate.from("2026-05-17");<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_format_plaindate_intl" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Format Date and Time Together</h2>
<p>You can format a <code class="w3-codespan">PlainDateTime</code> with both date and time options.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const dateTime = Temporal.PlainDateTime.from("2026-05-17T14:30:15");<br>
<br>
const formatter = new Intl.DateTimeFormat("en-GB", {<br>
&nbsp;&nbsp;year: "numeric",<br>
&nbsp;&nbsp;month: "short",<br>
&nbsp;&nbsp;day: "numeric",<br>
&nbsp;&nbsp;hour: "2-digit",<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_format_plaindatetime_intl" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>ZonedDateTime toLocaleString()</h2>
<p>The <code class="w3-codespan">Intl.DateTimeFormat()</code> method <b>does not
accept a Temporal.ZonedDateTime</b> object as input.</p>
<p>This design choice prevents conflicts between the time zone held by the
ZonedDateTime and the time zone defined in the formatter.</p>
<p>The best solution is to use <code class="w3-codespan">toLocaleString()</code>
instead.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<ul>
<li><p>Use <code class="w3-codespan">toString()</code> for standard ISO output.</p></li>
<li><p>Use <code class="w3-codespan">toLocaleString()</code> for simple local formatting.</p></li>
<li><p>Use <code class="w3-codespan">Intl.DateTimeFormat</code> for custom formatting.</p></li>
</ul>
