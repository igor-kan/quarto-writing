...
<a class="w3-left w3-btn" href="js_async_timeouts.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_promise.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
<h2><i>"I will call back later!"</i></h2>
<p>A <b>callback</b> is a <b>function</b> that <b>runs later</b>.</p>
<p>A callback runs <b>after something</b> has finished.</p>
<p>The name "callback" stems from the idea that the function will "call you back"
later when it has finished its task.</p>
</div>
<!--stop-->

<div class="ws-note">

<p>Callbacks were the first JavaScript solution for <b>handeling asynchronous results</b>
that could not be available immediately.</p>
<p>This page explains what callbacks are and why they can cause some problems.</p>
</div>

<hr>
<h2>What is a Callback Function?</h2>
<p>A <b>callback function</b> is a function passed as an argument into another function.</p>
<p>The callback function is intended to be <b>executed later</b>, typically
when a specific event occurs or an asynchronous operation completes.</p>
<p>This pattern keeps your function flexible.</p>
<p>This is how many older JavaScript APIs worked.</p>

<hr>
<h2>Event Handling</h2>
<p>Callbacks are often used in JavaScript, especially in <b>event handling</b>:</p> 
<p>User interactions, such as button clicks or key presses, can be handled by providing a <b>callback function</b>
to an <b>event listener</b>.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
document.getElementById("myButton").addEventListener("click", displayDate);
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_event_handler" target="_blank">
Try it Yourself &raquo;</a>
</div>
<p>In the example above, <code class="w3-codespan">displayDate</code> is a callback function passed
as an argument to the <code class="w3-codespan">addEventListener()</code> method.</p>
<p><code class="w3-codespan">displayDate</code> will be called when a user clicks the button with id="myButton".</p>

<hr>
<h2>Asynchronous Operations</h2>
<p>Windows functions like <code class="w3-codespan">setTimeout()</code> use callbacks to execute code after a specified delay.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
setTimeout(myFunction, 3000);<br>
<br>
function myFunction() {<br>
&nbsp; document.getElementById("demo").innerHTML = "I love You !!";<br>
}
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_callback5">
Try it Yourself &raquo;</a></p>
</div>
<p>In the example above, <code class="w3-codespan">myFunction</code> is a callback function passed
as an argument to <code class="w3-codespan">setTimeout()</code>.</p>
<p><code class="w3-codespan">3000</code> is the number of milliseconds before
<code class="w3-codespan">myFunction</code> will be called.</p>

<div class="w3-panel ws-note">

<p>When you pass a function as an argument, remember not to use parenthesis.</p>
<p><b>Right:</b> setTimeout(<b>myFunction</b>, 3000)</p>
<p><b>Wrong:</b> setTimeout(<b>myFunction()</b>, 3000)</p>
</div>

<hr>
<h2>The Timing Problem</h2>
<p>Asynchronous code finishes later.</p>
<p>This means you cannot return the result right away (before they are finished).</p>
<div class="w3-example">
<p>Example:</p>
<div class="w3-code notranslate jsHigh">
let result;<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_async_timeout">
Try it Yourself &raquo;</a>
</div>

<p>The result is <code class="w3-codespan">undefined</code> because the async code has not finished yet.</p>

<div class="ws-note">

<p>You cannot solve this problem by waiting in JavaScript.</p>
<p>Waiting would freeze the page.</p>
</div>

<hr>
<h2>The Callback Idea</h2>
<p>The solution to the problem above, is to run the code <b>after the result is ready</b>.</p>
<p>You must give JavaScript a <b>callback function</b> to call later.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_callback_timeout">
Try it Yourself &raquo;</a>
</div>

<p>The value is used inside the callback.</p>
<p>This works because the callback runs later.</p>
...
<p>You could first call the calculator function <code class="w3-codespan">myCalculator</code>,
and then call the display function <code class="w3-codespan">myDisplayer</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Funtion to display something<br>
function myDisplayer(some) {<br>
&nbsp; document.getElementById(&quot;demo&quot;).innerHTML = some;<br>}<br><br>
// Function to calculate a sum<br>
function myCalculator(num1, num2) {<br>
&nbsp; let sum = num1 + num2;<br>
&nbsp; return sum;
<br>
}<br><br>
// Call the calculator<br>
let result = myCalculator(5, 5);<br>
<br>
// Call the displayer<br>
myDisplayer(result);</div>
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_callback3">
Try it Yourself &raquo;</a>
</p>
</div>
<p>Or, you could call the calculator function <code class="w3-codespan">myCalculator</code>,
and let the calculator function call the display function <code class="w3-codespan">myDisplayer</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Funtion to display something<br>
function myDisplayer(some) {<br>&nbsp; document.getElementById(&quot;demo&quot;).innerHTML 
  = some;<br>}<br><br>
// Function to calculate a sum<br>
function myCalculator(num1, num2) {<br>
&nbsp; let sum = num1 + num2;<br>
&nbsp; myDisplayer(sum);<br>}<br>
<br>
// Call the calculator<br>
myCalculator(5, 5);
</div>
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_callback8">
Try it Yourself &raquo;</a>
</p>
</div>
...
<div class="w3-code notranslate jsHigh">
  function myDisplayer(some) {<br>&nbsp; document.getElementById(&quot;demo&quot;).innerHTML 
  = some;<br>}<br><br>function myCalculator(num1, num2, myCallback) {<br>&nbsp; 
  let sum = num1 + num2;<br>&nbsp; 
  myCallback(sum);<br>}<br><br>myCalculator(5, 5, myDisplayer);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_callback4">Try it Yourself &raquo;</a>
</div>

<p>In the example above, <code class="w3-codespan">myDisplayer</code> is used as a <b>callback function</b>.
<p>It is passed to <code class="w3-codespan">myCalculator()</code> as an <b>argument</b>.</p>

<hr>
<h2>Callback Error Handling</h2>

<p>Async code can fail.</p>
<p>Callbacks often use an error-first pattern:.</p>
...
&nbsp;&nbsp;} else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;callback("Something failed", null);<br>
&nbsp;&nbsp;}<br>
}<br><br>
getData(function(error, data) {<br>
&nbsp;&nbsp;if (error) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;myDisplayer(error);<br>
&nbsp;&nbsp;&nbsp;&nbsp;return;<br>
&nbsp;&nbsp;}<br>
&nbsp;&nbsp;myDisplayer(data);<br>
});<br>
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_callback11">
Try it Yourself &raquo;</a></p>
<div class="w3-code notranslate jsHigh">
function getData(callback) {<br>
&nbsp;&nbsp;let ok = false;<br><br>
...
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_callback12">
Try it Yourself &raquo;</a></p>
</div>

<p>In the example above, the getData function is called with a callback.</p>
<p>The callback function has two parameters.</p> 
<p>The first parameter is <b>the error</b>, and the second parameter is <b>the result</b>.</p>
<p>This pattern is common in older JavaScript code.</p>

<hr>
<h2>Callback Drawbacks</h2>
<p>While essential for JavaScript programming, deeply nested callbacks can lead to complex,
hard-to-read code known as "<b>callback hell</b>" or the "<b>pyramid of doom</b>".</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<p>When callbacks get deep, debugging becomes difficult.</p>
<p>The logic moves from left to right and becomes difficult to follow.</p>
</div>

<hr>
<h2>Callback Alternatives</h2>
<p><b>Asynchronous callback</b> solutions are <b>difficult to write</b> and difficult to debug.</p>
<p>Because of this, modern asynchronous JavaScript <b>do not use callbacks</b>.</p>
<p>Modern JavaScript offers superior alternatives for handling asynchronous operations,
using <b>Promises</b> and the <b>async/await</b> syntax, which provide a cleaner flow and better error handling.</p>

<hr>
<h2>When to Use a Callback?</h2>
<p>Callbacks are still important to understand.</p>
...
<div class="ws-note">
<h2>Next Chapter</h2>
<p>The next page explains what a <b>Promise</b> is.</p>
<p>You will learn how promises can replace deep callbacks with a cleaner flow.</p>
<p><a class="w3-btn w3-green" href="js_promise.asp">JavaScript Promises</a></p>
</div>
