...
<html lang="en-US">
<head>
<title>JavaScript Error Statements</title>
<meta charset="utf-8">
...
<h1>JavaScript Error Statements</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_errors_silent.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_error_object.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
<h2>The <b>try</b> Statement</h2>
<p>In JavaScript, the <code class="w3-codespan">try</code> statement is used to handle errors
(also called <b>exceptions</b>) that may occur during code execution - without stopping the entire program.</p>
<p>The <code class="w3-codespan">try</code> statement works together with <code class="w3-codespan">catch</code>.</p>
<p>Sometimes it works with <code class="w3-codespan">finally</code>.</p>
<p>And sometimes it works with <code class="w3-codespan">throw</code>.</p>
</div>
<!--stop-->
...
<hr>
<h2>The Try Block</h2>
<p>The <code class="w3-codespan">try</code> block contains the code that might throw an error.</p>
...
<p>The <code class="w3-codespan">catch</code> block executes only if an error occurs in the try block.</p>
<p>The error object provides details about what went wrong.</p>
<div class="w3-example">
<h3>Syntax</h3>
<div class="w3-code notranslate jsHigh">
try {<br>
...
<h2>The Finally Block (Optional)</h2>
<p>The <code class="w3-codespan">finally</code> block executes after the try and catch blocks,
whether an error occurred or not.</p>
<p>It is commonly used for cleanup tasks (e.g., closing files, stopping loaders, etc.).</p>
<div class="w3-example">
<h3>Syntax</h3>
<div class="w3-code notranslate jsHigh">
try {<br>
...
&nbsp;&nbsp;// Code that always runs, no matter what<br>
}<br>
</div>
</div>
...
<p>The exception can be a JavaScript <code class="w3-codespan">String</code>, a <code class="w3-codespan">Number</code>, a <code class="w3-codespan">Boolean</code> or an <code class="w3-codespan">Object</code>:</p>
...
<p>If you use <code class="w3-codespan">throw</code> together with <code class="w3-codespan">try</code> and 
<code class="w3-codespan">catch</code>, you can control program 
...
<hr>
<!--start-->
<h2>Finally Example</h2>
<p>The <code class="w3-codespan">finally</code> statement lets you execute code, after try and 
...
</em>} finally {<br>&nbsp; <em>Block of code to be executed regardless of the try / catch result<br>
</em>}</div></div>
...
document.getElementById(&quot;demo&quot;).value;<br>&nbsp; 
try { <br>&nbsp;&nbsp;&nbsp; 
if(x.trim() == &quot;&quot;) throw &quot;is empty&quot;;<br>&nbsp;&nbsp;&nbsp; if(isNaN(x)) 
throw &quot;is not a number&quot;;<br>&nbsp;&nbsp;&nbsp; 
    x = Number(x);<br>&nbsp;&nbsp;&nbsp; if(x &gt; 
10) throw &quot;is too high&quot;;<br>&nbsp;&nbsp;&nbsp; if(x &lt; 
5) throw &quot;is too low&quot;;<br>&nbsp;&nbsp;}&nbsp;catch(err) 
{<br>&nbsp;&nbsp;&nbsp; message.innerHTML = &quot;Error: &quot; + 
err + &quot;.&quot;;<br>&nbsp;&nbsp;}&nbsp;finally {<br>&nbsp;&nbsp;&nbsp;&nbsp;document.getElementById(&quot;demo&quot;).value = &quot;&quot;;<br>
  &nbsp;&nbsp;}<br>}</div>
