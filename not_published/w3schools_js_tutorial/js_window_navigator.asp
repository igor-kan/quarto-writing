...
<p>The <code class="w3-codespan">navigator</code> object contains information about the 
visitor's browser.</p>
<p>It can be written with or without the window prefix like:</p>
<p><code class="w3-codespan">windows.navigator</code> or just <code class="w3-codespan">navigator</code></p>
</div>
<h2>Browser Cookies</h2>
<p>The <code class="w3-codespan">cookieEnabled</code> property returns true if cookies are enabled, otherwise 
false:</p>
...
<p>The <code class="w3-codespan">language</code> property returns the browser's language:</p>
...
<p>The <code class="w3-codespan">onLine</code> property returns true if the browser is online:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;p id=&quot;demo&quot;&gt;&lt;/p&gt;<br>
...
<p>The <code class="w3-codespan">appName</code> property returns the application name 
of the browser:</p>
...
<h2>Warning</h2>
<p>This property is removed (deprecated) in the latest web standard.</p>
<p>Most browsers (Chrome, Edge, Firefox, Safari) returns <b>Netscape</b> as
<code class="w3-codespan">appName</code>.</p>
</div>
<!--stop-->
<hr>
...
<p>The <code class="w3-codespan">appCodeName</code> property returns the application code name 
of the browser:</p>
...
<h2>Warning</h2>
<p>This property is removed (deprecated) in the latest web standard.</p>
<p>Most browsers (Chrome, Edge, Firefox, Safari) returns <b>Mozilla</b> as
<code class="w3-codespan">appCodeName</code>.</p>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>The Browser Engine</h2>
<p>The <code class="w3-codespan">product</code> property returns 
...
<h2>Warning</h2>
<p>This property is removed (deprecated) in the latest web standard.</p>
<p>Most browsers returns <b>Gecko</b> as product.</p>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>The Browser Version</h2>
<p>The <code class="w3-codespan">appVersion</code> property returns 
...
<h2>Warning</h2>
<p>This property is removed (deprecated) in the latest web standard.</p>
<p>Do not rely on <code class="w3-codespan">appVersion</code> to return the correct browser version.</p>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>The Browser Agent</h2>
<p>The <code class="w3-codespan">userAgent</code> property returns the user-agent header sent by the browser to the server:</p>
...
<h2>Warning</h2>
<p>The information from the navigator object can often be misleading.</p>
<p>The navigator object should <b>not be used to detect browser versions</b> because:</p>
<ul>
...
<p>The <code class="w3-codespan">platform</code> property returns the browser platform 
(operating system):</p>
...
<h2>Warning</h2>
<p>This property is removed (deprecated) in the latest web standard.</p>
<p>Do not rely on <code class="w3-codespan">platform</code> to return the correct browser platform in all browsers.</p>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Is Java Enabled?</h2>
<p>The <code class="w3-codespan">javaEnabled()</code> method returns true if <a href="/java/default.asp">Java</a> is enabled:</p>
...
<p><code class="w3-codespan">javaEnabled()</code> always returns <code class="w3-codespan">false</code>.</p>
</div>
<!--stop-->
<br>
<div class="w3-clear nextprev">
