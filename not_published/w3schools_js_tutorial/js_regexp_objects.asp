...
<html lang="en-US">
<head>
<title>JavaScript RegExp Objects</title>
<meta charset="utf-8">
...
<h1>JavaScript RegExp Objects</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_regexp_patterns.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_regexp_methods.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
<h2>The RegExp Object</h2>
<p>In JavaScript, <b>RegExp</b> is a regular expression object with 
...
<h2>Using test()</h2>
<p>The <code class="w3-codespan">test()</code> method is a RegExp expression method.</p>
...
<p>
<a target="_blank" href="tryit.asp?filename=tryjs_regexp_test" class="w3-btn">Try it Yourself &raquo;</a>
</p>
</div>
<div class="w3-example">
...
<!--start-->
<h2>Using exec()</h2>
<p>The <code class="w3-codespan">exec()</code> method is a RegExp expression method.</p>
...
<p>The <code class="w3-codespan">RegExp.escape()</code> method returns string where characters that belongs
...
const newText = oldText.replace(regex, "W3Schools");<br>
</div>
...
<p><code class="w3-codespan">RegExp.escape()</code> is an ECMAScript 2025 feature.</p>
