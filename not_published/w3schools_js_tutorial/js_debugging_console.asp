...
<html lang="en-US">
<head>
<title>JavaScript Debugging Console</title>
<meta charset="utf-8">
...
<h1>JavaScript Debugging Console</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_debugging.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_debugging_breakpoints.asp">Next &#10095;</a>
</div>

<div class="ws-info">
<h2>Console Like a Pro</h2>
<p>The browser console is the most important debugging tool for JavaScript beginners.</p>
<p>If you learn how to use the console properly, you will find bugs faster and understand your code better.</p>
</div>

<h2>How to Open the Console</h2>
<p>In Chrome or Edge, open the console like this:</p>

<ul class="w3-ul w3-card-2" style="max-width:720px">
  <li>Right-click anywhere on the page</li>
  <li>Click <b>Inspect</b></li>
...
<p>The console is where JavaScript shows errors, warnings, and messages from your code.</p>
<p>Always keep the console open when testing new JavaScript code.</p>
</div>

<hr>
<h2>console.log()</h2>
<p>The most common console method is <code class="w3-codespan">console.log()</code>.</p>
<p>Use it to print values and see what your program is doing.</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_console_log" target="_blank">
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_console_variables" target="_blank">
...
<hr>
<h2>console.warn()</h2>
<p>Use <code class="w3-codespan">console.warn()</code> to display warnings.</p>
<p>Warnings tell you something might be wrong, but your code can still run.</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_console_warn" target="_blank">
Try it Yourself &raquo;</a>
</div>

<div class="ws-note">

<p>Use warnings when you want to highlight something suspicious in your program.</p>
</div>

<hr>
<h2>console.error()</h2>

<p>Use <code class="w3-codespan">console.error()</code> to display error messages.</p>
<p>Errors show that something has failed.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Error message:</p>
<div class="w3-code notranslate jsHigh">
console.error("Something went wrong!");<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_console_error" target="_blank">
Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Logging Multiple Values</h2>
<p>You can log more than one value at once.</p>
...
let x = 10;<br>
let y = 5;<br><br>
console.log("x =", x, "y =", y);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_console_multiple" target="_blank">
Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Inspecting Objects</h2>
<p>The console is very useful for inspecting objects.</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_console_object" target="_blank">
Try it Yourself &raquo;</a>
</div>
<div class="ws-note">

<p>In the console, you can click the object to expand it and see its properties.</p>
</div>

<hr>
<h2>console.table()</h2>

<p>Use <code class="w3-codespan">console.table()</code> to display data in a table format.</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_console_table" target="_blank">
Try it Yourself &raquo;</a>
</div>

<div class="ws-note">

<p>Tables make it much easier to debug arrays of objects.</p>
</div>

<hr>
<h2>Debugging Tip: Stop Guessing</h2>
<p>Beginners often <b>guess</b> what the value is.</p>
<p>Professionals <b>log the value</b> and confirm it.</p>

<div class="ws-warning">
<p>If your code is not working, <b>do not guess</b>.</p>
<p>Use <code class="w3-codespan">console.log()</code>.</p>
</div>

<hr>
<h2>Next: Breakpoints, Watch, Scope</h2>
<p>Logging is powerful, but sometimes you need to pause code execution.</p>
<p>Next page: Learn how to use breakpoints, step through code, and watch variables live.</p>
<hr>
