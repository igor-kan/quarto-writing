...
<a class="w3-left w3-btn" href="js_string_templates.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_string_search.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
<h2>Basic String Methods</h2>
<p>Javascript strings are primitive and immutable:
All string methods produce a new string without altering the original string.</p>
<div bclass="w3-stretch">
...
<a href="#mark_codepointat">String codePointAt()</a><br>
...
<td>
<a href="#mark_iswellformed">String isWellFormed()</a><br>
<a href="#mark_towellformed">String toWellFormed()</a><br>
...
<div class="ws-note">
<h2>See Also:</h2>
<a href="js_strings.asp">String Tutorial</a><br>
<a href="js_string_search.asp">String Search</a><br>
<a href="js_string_templates.asp">String Templates</a><br>
<a href="js_string_reference.asp">String Reference</a><br>
</div>
<!--stop-->
<!--start-->
<a id="mark_length"></a>
...
<hr>
<!--start-->
<a id="propertyaccess"></a>
<h2>Extracting String Characters</h2>
<p>There are 4 methods for extracting string characters:</p>
<ul>
  <li>The <code class="w3-codespan">at(<em>position</em>)</code> Method</li>
  <li>The <code class="w3-codespan">charAt(<em>position</em>)</code> Method</li>
  <li>The <code class="w3-codespan">charCodeAt(<em>position</em>)</code> Method</li>
...
<hr>
<!--start-->
<a id="mark_charcodeat"></a>
<h2>JavaScript String charCodeAt()</h2>
<p>The <code class="w3-codespan">charCodeAt()</code> method returns the code of the character 
...
<hr>
<!--start-->
<a id="mark_codepointat"></a>
<h2>JavaScript codePointAt()</h2>
<div class="w3-example">
<h3>Examples</h3>
<p>Get code point value at the first position in a string:</p>
<div class="w3-code notranslate jsHigh">
let text = &quot;HELLO WORLD&quot;;<br>
let code = text.codePointAt(0);
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_string_codepointat" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p><a href="js_2022.asp">ES2022</a> introduced the string method <code class="w3-codespan">at()</code>:</p>
...
<a target="_blank" href="tryit.asp?filename=tryjs_string_at" class="w3-btn">Try it Yourself &raquo;</a>
<p>Get the third letter of name:</p>
<div class="w3-code notranslate jsHigh">
const name = "W3Schools";<br>
let letter = name[2];
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_string_at2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>The <code class="w3-codespan">at()</code> method returns the character at a specified index (position) in a string.</p>
<p>The <code class="w3-codespan">at()</code> method is supported in all modern browsers since March 2022:</p>

<div class="ws-note">

<p>The <code class="w3-codespan">at()</code> method is a new addition to JavaScript.</p>
<p>It allows the use of negative indexes while <code class="w3-codespan">charAt()</code> do not.</p>
Now you can use <code class="w3-codespan">myString.at(-2)</code> instead of
<code class="w3-codespan">charAt(myString.length-2)</code>.
</div>
<!--stop-->
<h2>Browser Support</h2>
<p><code class="w3-codespan">at()</code> is an ECMAScript 2022 feature.</p>
<p><a href="js_2022.asp">JavaScript 2022</a> is supported in all modern browsers since <b>March 2022</b>:</p>
...
<p>The <code class="w3-codespan">concat()</code> method can be used instead of the plus operator. 
...
<p><code class="w3-codespan">slice()</code> extracts a part of a string and returns the 
...
<p>The difference is that start and end values less than 0 are treated as 0 in
<code class="w3-codespan">substring()</code>.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<a target="_blank" href="tryit.asp?filename=tryjs_string_substring" class="w3-btn w3-margin-bottom w3-margin-top">Try it Yourself &raquo;</a>
</div>

<p>If you omit the second parameter, <code class="w3-codespan">substring()</code> will slice out the rest of the 
string.</p>
<!--stop-->
<hr>
<!--start-->
...
<h2>Warning</h2>
<p>The <code class="w3-codespan">substr()</code> method is removed (deprecated) in the latest JavaScript standard.</p>
<p>Use <code class="w3-codespan">substring()</code> or <code class="w3-codespan">slice()</code> instead.</p>
</div>
...
<a target="_blank" href="tryit.asp?filename=tryjs_string_substr" class="w3-btn w3-margin-bottom w3-margin-top">Try it Yourself &raquo;</a>
</div>

<p>If you omit the second parameter, <code class="w3-codespan">substr()</code> will slice out the rest of the 
string.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<a class="w3-btn w3-margin-bottom w3-margin-top" href="tryit.asp?filename=tryjs_string_substr1" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<a class="w3-btn w3-margin-bottom w3-margin-top" href="tryit.asp?filename=tryjs_string_substr2" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" href="tryit.asp?filename=tryjs_string_iswellformed" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
let text = "Hello World \uD800";<br>
let result = text.isWellFormed();
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_string_iswellformed2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="ws-note">
...
<a target="_blank" href="tryit.asp?filename=tryjs_string_towellformed" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stopt-->
<hr>
<!--start-->
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_string_trimstart" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Browser Support</h2>
<p><code class="w3-codespan">trimStart()</code> is an ECMAScript 2019 feature.</p>
<p><b><a href="js_2019.asp">ES2019</a></b> is supported in all modern browsers since <b>January 2020</b>:</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_string_trimend" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Browser Support</h2>
<p><code class="w3-codespan">trimEnd()</code> is an ECMAScript 2019 feature.</p>
<p><b><a href="js_2019.asp">ES2019</a></b> is supported in all modern browsers since <b>January 2020</b>:</p>
...
<p><a href="js_2017.asp">ECMAScript 2017</a> added two new string methods to JavaScript: <code class="w3-codespan">padStart()</code>
and <code class="w3-codespan">padEnd()</code> to support padding at the beginning and at the end of a string.</p>

<hr>
<a id="mark_padstart"></a>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_string_padding1" target="_blank">Try it Yourself &raquo;</a>
<p>Pad a string with "x" until it reaches the length 4:</p>
<div class="w3-code notranslate jsHigh">
let text = &quot;5&quot;;<br>
let padded = text.padStart(4,"x");
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_string_padding4" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_string_padding3" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<h2>Browser Support</h2>
<p><code class="w3-codespan">padStart()</code> is an ECMAScript 2017 feature.</p>
<p><b><a href="js_2017.asp">ES2017</a></b> is supported in all modern browsers since <b>September 2017</b>:</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_string_padding2" target="_blank">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
let text = &quot;5&quot;;<br>
let padded = text.padEnd(4,"x");
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_string_padding6" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_string_padding5" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<h2>Browser Support</h2>
<p><code class="w3-codespan">padEnd()</code> is an ECMAScript 2017 feature.</p>
<p><b><a href="js_2017.asp">ES2017</a></b> is supported in all modern browsers since <b>September 2017</b>:</p>
...
<!--start-->
<a id="mark_repeat"></a>
<h2>JavaScript String repeat()</h2>
<p>The <code class="w3-codespan">repeat()</code> method returns a string with a number of copies of a string.</p>
<p>The <code class="w3-codespan">repeat()</code> method returns a new string.</p>
<p>The <code class="w3-codespan">repeat()</code> method does not change the original string.</p>
<div class="w3-example">
<h3>Examples</h3>
<p>Create copies of a text:</p>
<div class="w3-code notranslate jsHigh">
let text = &quot;Hello world!&quot;;<br>
let result = text.repeat(2);
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_string_repeat" class="w3-btn">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
let text = &quot;Hello world!&quot;;<br>
let result = text.repeat(4);
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_string_repeat1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<tr>
<td>String</td><td>A new string containing the copies.</td>
</tr>
</table>
<!--stop-->
<hr>
<h2>Browser Support</h2>
<p><code class="w3-codespan">repeat()</code> is an <a href="js_es6.asp">ES6  feature</a>.</p>
...
<p>The <code class="w3-codespan">replace()</code> method replaces a specified value with another 
value in a string:</p>
...
<p>By default, the <code class="w3-codespan">replace()</code> method is case sensitive. Writing MICROSOFT (with 
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_string_replaceall">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_string_replaceall2">Try it Yourself &raquo;</a>
</div>
...
<hr>
<div class="ws-note">
<h2>Complete JavaScript Reference</h2>
<p>For a complete reference to all JavaScript properties and methods, with full descriptions and many examples, go to:</p>
<p class="w3-large"><a href="/jsref/default.asp">W3Schools' Full JavaScript Reference</a>.</p>
<p>The reference inludes all JavaScript updates from 1999 to 2025.</p>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_string_methods.js"></div>
<hr>
