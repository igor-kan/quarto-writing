...
<div class="ws-info">
<h2>What is JavaScript BigInt?</h2>
<p><b>BigInt</b> is a JavaScript <b>data type</b> for handling and storing <b>big integer values</b>.</p>
<p><b>BigInt</b> allows you to work with <b>integers larger than the limit of Numbers</b>.</p>
<p><b>BigInt</b> can represent an integer of <b>any size</b>, limited only by available memory.</p>
</div>
<hr>
<h2>JavaScript Accuracy</h2>
<p>JavaScript Numbers are only accurate up to 15 digits:</p>
...
<hr>
<h2>Numbers are 64-bits Floating Point</h2>
<p>All JavaScript <b>Numbers</b> are stored in a <b>64-bit floating-point</b> format (IEEE 754 standard).</p>
<p>With this standard, large numbers cannot be exactly represented, but will be rounded.</p>
<p>JavaScript can only safely represent integers up to <b>2<sup>53</sup>-1</b> (9007199254740991).</p>
<p>JavaScript can only safely represent integers down to <b>-2<sup>53</sup>-1</b> (-9007199254740991).</p>

<div class="w3-example">
<h3>Examples</h3>
<div class="w3-code notranslate jsHigh">
// MAX = 9007199254740991<br>
let x = Number.MAX_SAFE_INTEGER;<br>
<br>
// MIN = -9007199254740991<br>
let y = Number.MIN_SAFE_INTEGER;<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_numbers_inaccurate5" target="_blank">Try it Yourself &raquo;</a>
<p>Integers bigger than <code class="w3-codespan">Number.MAX_SAFE_INTEGER</code> will lose precision:</p>
<div class="w3-code notranslate jsHigh">
// Max (accurate)<br>
let x = 9007199254740991;<br>
<br>

// Max + 10 (inaccurate)<br>
let y = x + 10;<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_numbers_inaccurate4" target="_blank">Try it Yourself &raquo;</a>
<p>Integers less than than <code class="w3-codespan">Number.MIN_SAFE_INTEGER</code> will lose precision:</p>
<div class="w3-code notranslate jsHigh">
// Min (accurate)<br>
let x = -9007199254740991;<br>
<br>
// Min - 10 (inaccurate)<br>
let y = x - 10;<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_numbers_inaccurate6" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
<div class="ws-note">

<p>There is no such thing as a JavaScript Integer.</p>
<p>All JavaScript Numbers are 64-bit floating point.</p>
</div>

<hr>
<h2>How to Create a BigInt</h2>
<p>You can create a BigInt in two ways:</p>
<ul>
<li>Using an <b>integer literal</b> with an <b>n</b> suffix</li>
<li>Using the <b>BigInt()</b> constructor with a <b>string</b></li>
</ul>
<div class="w3-example">
<h3>Examples</h3>
<div class="w3-code notranslate jsHigh">
// Using an integer literal with an n suffix:<br>
let x = 999999999999999n;<br>
<br>
// Using the BigInt() constructor with a string:<br>
let y = BigInt("999999999999999");
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_numbers_bigint2" target="_blank">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
let x = 12345678901234567890n;<br>
let y = BigInt("12345678901234567890")
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_numbers_bigint_create" target="_blank">Try it Yourself &raquo;</a>
</div>

<p>You can also create a BigInt using the Bigint() constructor with a <b>Number</b>.</p>
<p><b>Warning !! Numbers are only accurate up to 15 digits</b>.</p>

<div class="w3-example">
<h3>Examples</h3>
<div class="w3-code notranslate jsHigh">
let x = BigInt(9999999999999999);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_numbers_bigint3" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>BigInt is a JavaScript Datatype</h2>
<p>The JavaScript <code class="w3-codespan">typeof</code> a <code class="w3-codespan">BigInt</code> is "bigint":</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let x = BigInt(999999999999999);<br>
<br>
let type = typeof x;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_numbers_bigint_typeof" target="_blank">Try it Yourself &raquo;</a>
</div>

<p><code class="w3-codespan">BigInt</code> is the second numeric data type in JavaScript
(after <code class="w3-codespan">Number</code>).</p>
<p>With <code class="w3-codespan">BigInt</code> the total number of supported data types in JavaScript is 8:</p>
<p>
1. String<br>
2. Number<br>
3. Bigint<br>
...
<p><b>BigInt</b> supports standard JavaScript <b>arithmetic operators</b>.</p>
<p><b>(+, -, ++, --, *, /, %, **)</b></p>
...
<div class="w3-code notranslate jsHigh">
let x = 9007199254740995n;<br>
let y = 9007199254740995n;<br>
<br>
let z = x * y;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_bigint_multiply" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Mixing BigInt and Numbers</h2>

<p>Arithmetic between a <code class="w3-codespan">BigInt</code>
and a <code class="w3-codespan">Number</code> is not allowed (will result in a
<code class="w3-codespan">TypeError</code>).</p>
<p><b>Explicit conversion must be done first</b>.</p>

<div class="w3-example">
<h3>Example</h3>
<p>You cannot mix BigInt and Number directly:</p>
<div class="w3-code notranslate jsHigh">
let x = 10n;<br>
let y = 5;<br>
<br>
...
<p>To fix that, explicitly convert one:</p>
<div class="w3-code notranslate jsHigh">
let x = 10n;<br>
let y = 5;<br>
<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_bigint_mix" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>BigInt / Number Conversions</h2>
<p><b>BigInt to Number:</b> Use the Number() constructor.</p>

<p><b>Number to BigInt:</b> Use the BigInt() constructor.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create a BigInt<br>
let largeNumber = BigInt("12345678901234567890");<br>
<br>
// Conversions<br>
let num = Number(largeNumber);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_bigint_conversion" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="ws-note">

<p>Large BigInts might result in Infinity or loss of precision when converted to number.</p>
</div>

<hr>
<h2>BigInt Decimals</h2>
<p>A <code class="w3-codespan">BigInt</code> can not have decimals.</p>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
let x = 1.5n; // &#10060; TypeError<br>
</div>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_bigint_divide" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="ws-note">

<p>Attempting to convert a number with a fractional part to a BigInt will throw an error.</p>
</div>

<hr>
<h2>Comparison Operators</h2>
<p><b>Bigint</b> supports standard JavaScript <b>comparison operators</b>.</p>
<p>(<b>&lt;, &gt; ==, ===, !==, &lt;=, &gt;=</b>)</p>
<p>BigInts can also be compared with Numbers using standard comparison operators.</p>
<div class="w3-example">
<h3>Example</h3>
<p><b>Comparisons</b> work normally:</p>
<div class="w3-code notranslate jsHigh">
// true<br>
let x = (10n &gt; 5n);<br>
<br>
// false (different types)<br>
let y = (10n === 10);<br>
<br>
// true (loose equality)<br>
let z = (10n == 10);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_bigint_compare" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="ws-note">

<p>Strict equality (===) between a BigInt and a Number will always be false due to different types.</p>
</div>

<hr>
<h2>Bitwise Operators</h2>
<p>BigInt supports bitwise operations, but <b>only with other BigInts</b> (not Numbers):</p>
<ul>
<li>&amp; (AND)</li>
<li>| (OR)</li>
<li>^ (XOR)</li>
...
let b = 3n;   // 0011<br>
<br>
let x = (a &amp; b); // 1n   (0001)<br>
let y = (a | b); // 7n   (0111)<br>
let z = (a ^ b); // 6n   (0110)<br>
let n = (~a);&nbsp;&nbsp;&nbsp;&nbsp;// -6n<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_bigint_bitwise" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Bitwise Shift Operators</h2>
<p><b>BigInt</b> only supports two shift operators:</p>
<ul>
<li>&lt;&lt; (left shift)</li>
...
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let big = 10n; // binary: 1010<br>
<br>
let x = (big &lt;&lt; 2n); // 40n  (101000)<br>
let y = (big &gt;&gt; 1n); // 5n   (0101)<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_bigint_shift" target="_blank">Try it Yourself &raquo;</a>
</div>

<p><b>Impotant Rules:</b></p>
<ul>
<li>Both operands must be BigInt</li>
<li>Shift amounts must be non-negative</li>
<li>Right shift keeps the sign bit for negative values</li>
</ul>
<hr>
<div class="ws-note">

<p>Unsigned right shift (&gt;&gt;&gt;) is not allowed with BigInts.</p>
</div>

<hr>
<h2>BigInt Hex, Octal and Binary</h2>
<p><code class="w3-codespan">BigInt</code> can also be written in hexadecimal, octal, or binary notation:</p>

<p>Like numbers, bigint literals support several bases:</p>
<ul>
<li>Normal: 256n</li>
<li>Octal: 0o400n</li>
<li>Hexadecimal: 0x100n</li>
<li>Binary: 0b100000000n</li>
</ul>
...
let oct = 0o400n;<br>
let hex = 0x100n;<br>
let bin = 0b100000000n;<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_bigint_octal_2" target="_blank">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
let hex = 0x20000000000003n;<br>
let oct = 0o400000000000000003n;<br>
let bin = 0b100000000000000000000000000000000000000000000000000011n;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_bigint_octal" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Precision Curiosity</h2>
<p>Maximum safe integer in JavaScript is 9007199254740991.</p>
<p>Rounding can compromise program security:</p>

<div class="w3-example">
<h3>MAX_SAFE_INTEGER Examples</h3>
<div class="w3-code notranslate jsHigh">
9007199254740992 === 9007199254740993; // is true !!!
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_max_safe_error" target="_blank">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
9007199254740992n === 9007199254740993n; // is false !!!
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_max_safe_error_2" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<div class="ws-note">
<h2>Summary</h2>
<p><b>BigInt</b> allows <b>arbitrary-precision integers</b></p>
<p><b>BigInt</b> numbers can be as large (or small) as <b>your memory allows</b>.</p>
<p><b>BigInt</b> are used for very large integers (cryptography, IDs, timestamps, etc).</p>
<p><b>BigInt</b> is not suitable for decimals - only integers.</p>
<p><b>Math functions</b> (like Math.sqrt()) <b>do not work</b> with BigInts.</p>
<p><b>JSON.stringify()</b> cannot handle BigInts - <b>throws an error</b>.</p>
</div>
<hr>
<h2>Browser Support</h2>
<p><code class="w3-codespan">BigInt()</code> is an ES2020 feature.</p>
<p><b><a href="js_2020.asp">ES2020</a></b> is fully supported in all modern browsers since <b>September 2020</b>:</p>
...
<div id="exercisecontainer" src="xrcise_bigint.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_bitwise.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_functions.asp">Next &#10095;</a>
