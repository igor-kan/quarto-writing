...
<a class="w3-left w3-btn" href="js_continue.asp">&#10094; Previous</a>
...
<p>Control flow statements let you <b>change that order</b>, based on conditions, loops or keywords.</p>
</div>

<h2>Default Flow</h2>
<p>Default flow executes code <b>sequentially</b>
(from top to bottom / from left to right).</p>
<div class="w3-example">
<h3>Example</h3>
<p>Flow sequentially: let x &#8594; let y &#8594; let z.</p>
...
<hr>
<h2>Conditional Control Flow</h2>
<p>Conditions let you <b>make decisions</b> using:</p>
<ul>
<li>if</li>
<li>if...else</li>
<li>switch</li>
...
<div class="w3-example">
<h3>Example</h3>
<p>Flow branches depending on conditions:</p>
<div class="w3-code notranslate jsHigh">
let text = "Unknown";<br>
<br>
if (age &gt;= 18) {<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_if_true" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Loops (Repetition Control Flow)</h2>
<p>Loops let you <b>run code multiple times</b> using:
<ul>
<li>for</li>
<li>while</li>
<li>do...while</li>
...
<div class="w3-example">
<h3>Example</h3>
<p>Repeat flow until a condition (i &lt; 5) is false.</p>
<div class="w3-code notranslate jsHigh">
...
<p>Jump statements let you <b>change the flow</b> abruptly using:</p>
<ul>
<li>break - exits a loop or switch</li>
<li>continue - skips the current loop iteration</li>
<li>return - exits from a function</li>
<li>throw - jumps to error handling</li>
</ul>

<div class="w3-example">
<h3>Example</h3>
<p>Terminate (break) the loop when the loop counter (i) is 3:</p>
<div class="w3-code notranslate jsHigh">
...
<h2>Function Flow</h2>
<p>Functions are <b>callable</b> and reusable <b>code blocks</b></p>
<p>Functions will run when they are called.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Function to compute the product of two numbers:</p>
<div class="w3-code notranslate jsHigh">
...
<p>JavaScript runs on a <b>single thread</b>.</p>
<p>It can only do <b>one thing at a time</b>.</p>
<p>Every task has to wait for the previous one to finish.</p>
<p>This can freeze an application during slow operations (like file requests).</p>

<div class="ws-note">

<p>JavaScript can also run code asynchronously.</p>
<p>Asynchronous programming is covered in the JS Advanced section:</p>
<p class="w3-large"><a href="js_asynchronous.asp">JavaScript Asynchronous Programming</a>.</p>
</div>
