...
/* Syntax highlighting */
.js-keyword  { color: #005cc5; }   /* let */
.js-variable { color: #000000; }   /* x, y, z */
.js-number   { color: #098658; }   /* 5, 6 */
.js-symbol   { color: #000000; }   /* = + ; */
...
body.darktheme .js-keyword  { color: #c5a5c5; }
body.darktheme .js-variable { color: #f1f1f1; }
body.darktheme .js-number   { color: #f78c6c; }
body.darktheme .js-symbol   { color: #f1f1f1; }
...
<p>With our online JavaScript editor, you can edit HTML, CSS and JavaScript code, and view the result in your browser.</p>
...
<div class="compiler-wrapper">
  ...
  <div class="compiler-body">
    ...
    <div class="editor">
<pre>
<span class="js-keyword">let</span> <span class="js-variable">x</span> <span class="js-symbol">=</span> <span class="js-number">5</span><span class="js-symbol">;</span>
<span class="js-keyword">let</span> <span class="js-variable">y</span> <span class="js-symbol">=</span> <span class="js-number">6</span><span class="js-symbol">;</span>
<span class="js-keyword">let</span> <span class="js-variable">z</span> <span class="js-symbol">=</span> <span class="js-variable">x</span> <span class="js-symbol">+</span> <span class="js-variable">y</span><span class="js-symbol">;</span>
</pre>
    </div>
...
11
  ...
  <div class="compiler-footer">
    <a href="tryit.asp?filename=tryjs_editor"
       target="_blank"
       class="ws-btn">
...
<h2>Build and Publish JavaScript Projects</h2>
...
<div class="ws-note w3-panel" style="margin-top:20px;">
  <p>If you do not know JavaScript, we suggest that you read our <a href="default.asp">JavaScript Tutorial</a> from scratch.</p>
</div>
