...
<h1>JavaScript else</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_if.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_if_ternary.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->

<h2>The else Statement</h2>
<p>Use the <code class="w3-codespan">else</code> statement to specify a <b>block of code</b> to be 
executed if a <b>condition</b> is <code class="w3-codespan">false</code>.</p>
...
<p>Use the <code class="w3-codespan">else if</code> statement to specify a <b>new condition</b>
if the first is <code class="w3-codespan">false</code>.</p>
...
<div class="w3-example">
<h3>Example</h3>
<p>This example will write a link to either W3Schools or to the World Wildlife 
Foundation (WWF). By using a random number, there is a 50% chance for each of the 
links.</p>
<div class="w3-code notranslate jsHigh">
let text;<br>
if (Math.random() &lt; 0.5) {<br>
&nbsp; text = "&lt;a href='https://w3schools.com'&gt;Visit W3Schools&lt;/a&gt;";<br>
} else {<br>
&nbsp; text = "&lt;a href='https://wwf.org'&gt;Visit WWF&lt;/a&gt;";<br>
}<br>
document.getElementById("demo").innerHTML = text;<br>
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_randomlink" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<br>
<div class="w3-clear nextprev">
