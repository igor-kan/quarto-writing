...
<p>The HTML DOM allows JavaScript to change both the text and the content of HTML elements.</p>
<p>The easiest way to modify the content is by using the <code class="w3-codespan">innerHTML</code> property:</p>
<div class="w3-code w3-border notranslate">
document.getElementById(<i>id</i>).<b>innerHTML</b> =<i> new HTML</i>
</div>
</div>

<!--start-->
<h2>The innerHTML Property</h2>
<p>The easiest way to get the content of an element is by using the <code class="w3-codespan">innerHTML</code> property.</p>
<p>The <code class="w3-codespan">innerHTML</code> property is useful for getting or replacing the content of HTML elements.</p>

<div class="ws-note">

<p>The <code class="w3-codespan">innerHTML</code> property can be used to get or change any HTML element, 
including <code class="w3-codespan">&lt;html&gt;</code> and <code class="w3-codespan">&lt;body&gt;</code>.</p>
</div>

<hr>
<h2>Common Mistakes</h2>
<ul>
<li>Trying to access a DOM element before it exists</li>
<li>Forgetting the quotes in an id like "demo"</li>
</ul>
<hr>
...
<h3>Example</h3>
<p>Change the content of a <code class="w3-codespan">&lt;p&gt;</code> element:</p>
...
<ul>
  <li>The HTML document above contains a <code class="w3-codespan">&lt;p&gt;</code> element with <code class="w3-codespan">id=&quot;p1&quot;</code></li>
  <li>We use the HTML DOM to get the element with <code class="w3-codespan">id=&quot;p1&quot;</code></li>
  <li>A JavaScript changes the content (<code class="w3-codespan">innerHTML</code>) of that element to &quot;New 
  text!&quot;</li>
</ul>
<!--stop-->
<!--start-->
...
<div class="w3-example">
<h3>Example</h3>
<p>Change the content of an <code class="w3-codespan">&lt;h1&gt;</code> element:</p>
<div class="w3-code notranslate htmlHigh">
...
<br>
&lt;script&gt;<br>
const element = document.getElementById(&quot;id01&quot;);<br>element.innerHTML = &quot;New Heading&quot;;<br>
&lt;/script&gt;<br>
<br>
&lt;/body&gt;<br>
&lt;/html&gt;
...
<p>Example explained:</p>
<ul>
  <li>The HTML document above contains an <code class="w3-codespan">&lt;h1&gt;</code> element with <code class="w3-codespan">id=&quot;id01&quot;</code></li>
  <li>We use the HTML DOM to get the element with <code class="w3-codespan">id=&quot;id01&quot;</code></li>
  <li>A JavaScript changes the content (<code class="w3-codespan">innerHTML</code>) of that element to &quot;New 
  Heading&quot;</li>
</ul>
<!--stop-->
...
<div class="w3-example">
<h3>Example</h3>
<p>Changes the value of the <code class="w3-codespan">src</code> attribute of an <code class="w3-codespan">&lt;img&gt;</code> element:</p>
<div class="w3-code notranslate htmlHigh">
 &lt;!DOCTYPE html&gt;<br>&lt;html&gt;<br>
&lt;body&gt;<br>
<br>
...
<p>Example explained:</p>
<ul>
  <li>The HTML document above contains an <code class="w3-codespan">&lt;img&gt;</code> element with <code class="w3-codespan">id=&quot;myImage&quot;</code></li>
  <li>We use the HTML DOM to get the element with <code class="w3-codespan">id=&quot;myImage&quot;</code></li>
  <li>A JavaScript changes the <code class="w3-codespan">src</code> attribute of that element from &quot;smiley.gif&quot; to &quot;landscape.jpg&quot;</li>
</ul>
<!--stop-->
<hr>
<!--start-->
...
<br>
&lt;script&gt;<br>
document.getElementById("demo").innerHTML = "Date : " + Date();<br>
&lt;/script&gt;<br>
<br>
&lt;/body&gt;<br>
&lt;/html&gt;
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_dom_date" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>In JavaScript, <code class="w3-codespan">document.write()</code> can be used to write directly to the HTML 
output stream:</p>
...
<a target="_blank" href="tryit.asp?filename=tryjs_dom_write" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="ws-warning">
<h2>Warning !</h2>
<p>Never use <code class="w3-codespan">document.write()</code> after the document is loaded. It will 
overwrite the document.</p>
</div>

<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_htmldom_html.js"></div>
<hr>
