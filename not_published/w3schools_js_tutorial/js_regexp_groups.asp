...
<html lang="en-US">
<head>
<title>JavaScript RegExp Groups</title>
<meta charset="utf-8">
...
<h1>Regular Expression Groups</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_regexp_assertions.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_regexp_quantifiers.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
<h2>RegExp Groups</h2>
<p><b>Regular Expression Groups</b> allow you to treat multiple characters as a single unit,
extract specific parts of a match, or reference captured text later.</p>
</div>

<h2>Group Syntaxes</h2>
<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
<tr><th>Type</th><th>Syntax</th><th>Description</th></tr>
<tr><td>Capturing</td><td>(x)</td><td>Matches x and remembers the match for extraction or backreferences</td></tr>
<tr><td>Named Capturing</td><td>(?&lt;name&gt;x)</td><td>Matches x and stores it under a specific name in the groups property</td></tr>
<tr><td>Non-Capturing</td><td>(?:x)</td><td>Groups x logically (e.g., for quantifiers) without remembering the match</td></tr>
<tr><td>Lookahead</td><td>(?=x)</td><td>Matches only if the pattern is followed by x</td></tr>
<tr><td>Lookbehind</td><td>(?&lt;=x)</td><td>Matches only if the pattern is preceded by x</td></tr>
<tr><td>Flag</td><td>(?flag:x)</td><td>Enables flag(s) for x</td></tr>
<tr><td>Flag</td><td>(?flag-flag:x)</td><td>Disables flag(s) for x</td></tr>
</table>
</div>

<hr>
<h2>RegExp Capturing Groups (x)</h2>
<p><b>RegExp Capturing Groups</b> are the most common groups. They group patterns together and "remember"
the matched text for later use.</p>
<p>Capturing groups are created by wrapping a part of a regexp pattern in parentheses (x).</p>
<p>You can access the found patterns in the result array of <b><i>pattern</i>.exec(<i>text</i>)</b> or
<b><i>text</i>.match(<i>pattern</i>)</b>.</p>
<div class="w3-example">
<h3>Examples</h3>
<div class="w3-code notranslate jsHigh">
let text = "Alice loves Bob-";<br>
const pattern = /(\w+) loves (\w+)/;<br>
<br>
let result = text.match(pattern);</div>
<a target="_blank" href="tryit.asp?filename=tryjs_regexp_capturing_groups_1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
let text = "Alice loves Bob-";<br>
const pattern = /(\w+) loves (\w+)/;<br>
<br>
let result = pattern.exec(text);</div>
<a target="_blank" href="tryit.asp?filename=tryjs_regexp_capturing_groups_2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<h2>Explained</h2>
<ul>
<li>(\w+) captures a word</li>
<li>text.match(pattern) returns an array of results</li>
<li>pattern.exec(text) also returns an array of results</li>
<li>The full match is at index 0, and captured groups follow at index 1, 2, ....</li>
</ul>

<hr>
<h2>The Result Array</h2>
<p>When you use a method like text.match(regex) in JavaScript, it returns an array of results.</p>
<p>In JavaScript arrays, items are ordered by numerical positions called indices, starting at 0.
JavaScript automatically organizes the array so that the whole matched text sits at the very first position ([0]),
and the text from your parenthesis groups follows right after ([1], [2], [3]).</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const regex = /(\d{4})-(\d{2})-(\d{2})/;<br>
const text = "2026-05-21";<br>
const match = text.match(regex);<br>
<br>
// This is what the 'match' array actually contains:<br>
[<br>
  "2026-05-21", // Index 0: The entire string that matched the whole regex<br>
  "2026",       // Index 1: The text caught by the 1st set of parentheses<br>
  "05",         // Index 2: The text caught by the 2nd set of parentheses<br>
  "21"          // Index 3: The text caught by the 3rd set of parentheses<br>
]<br>
</div>
</div>

<hr>
<h2>Named Capturing Groups (?&lt;n&gt;)</h2>
<p>Named capturing groups was introduced in <a href="js_2018.asp">ES2018</a>).</p>
<p>Named capturing groups allow you to assign a name to a group instead of indexes.</p>

<p>When using capturing groups, the String method match()
and the RegExp method exec(), return a match object with a groups property.
This property holds the names and the values of the groups.</p>
...
<p>Non-capturing groups are patterns for logical operations (like applying a quantifier to multiple characters)
but do not store the matched text.</p>
<p>The benefits are: They are more performant and keep the capturing group indices clean if you only need
the grouping behavior, not the extracted data.</p>
<p>Example: /(?:ha)+/ matches "haha" but won't create a separate capture for "ha".</p>
...
<div class="ws-note">
<h2>See Also:</h2>
<p class="w3-large"><a href="js_regexp.asp">JavaScript RegExp Tutorial</a></p>
