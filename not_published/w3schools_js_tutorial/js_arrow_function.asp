...
<a class="w3-left w3-btn" href="js_function_expressions.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_function_quiz.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
<p><b>Arrow Functions</b> allow a shorter syntax for <b>function expressions</b>.</p>
<p>You can skip the <b>function</b> keyword, the <b>return</b> keyword, and the 
...
<p><b>Arrow Functions</b> were introduced in <a href="js_es6.asp">ES6</a> and are commonly
used in modern JavaScript.</p>
</div>

<h2>Arrow Function Syntax</h2>
<p>An arrow function uses the <b>=&gt;</b> symbol.</p>
<p>An arrow function is always written as a function expression.</p>
...
<p>This arrow function does the same thing as a regular function expression.</p>

<hr>
<h2>Shorter Syntax</h2>
<p>If the function body contains only one statement:</p>
<p>You can remove the word <b>function</b>, the <b>curly brackets</b> and the <b>return</b> keyword.</p>

<div class="w3-example">
<h3>Before Arrow</h3>
<p>Function to compute the product of a and b:</p>
<div class="w3-code notranslate jsHigh">
const multiply = function(a, b) {return a * b}<br>
</div>
<p>
...
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_arrow_function2">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_arrow_function1">Try it Yourself &raquo;</a>
</p>
</div>

<hr>
<h2>Arrow Functions with One Parameter</h2>
<p>If a function has only one parameter, you can omit the parentheses:</p>

<div class="w3-example">
<h3>With Parantheses</h3>
<div class="w3-code notranslate jsHigh">
const square = (x) =&gt; x * x;<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_arrow_function9">Try it Yourself &raquo;</a>
<h3>Without Parantheses</h3>
<div class="w3-code notranslate jsHigh">
const square = x =&gt; x * x;<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_arrow_function8">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_arrow_function4">Try it Yourself &raquo;</a>
<h3>Without Parantheses</h3>
<div class="w3-code notranslate jsHigh">
const hello = val =&gt; "Hello " + val;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_arrow_function5">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Arrow Functions Return Value by Default</h2>
<p>If the function has only one statement that returns a value:</p>
<p>You can remove the <b>brackets</b> and the <b>return</b> keyword:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const hello = () =&gt; &quot;Hello World!&quot;;</div>
<p>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_arrow_function3">Try it Yourself &raquo;</a>
</p>
</div>
<div class="w3-panel ws-note">

<p>This works only if the function has only one statement.</p>
</div>

<hr>
<h2>Arrow Function Parameters</h2>
<p>If you have parameters, you pass them inside the parentheses:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const hello = (val) =&gt; &quot;Hello &quot; + val;</div>
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_arrow_function4">Try it Yourself &raquo;</a>
</p>
</div>

<p>If you have only one parameter, you can skip the parentheses as well:</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_arrow_function5">Try it Yourself &raquo;</a>
</p>
</div>

<hr>
<h2>Arrow Functions with No Parameters</h2>
<p>If there are no parameters, parentheses are required.</p>
...
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// This will return undefined<br>
const myFunction = (x, y) =&gt;  { x * y };<br>
<br>
// This will return undefined<br>
const myFunction = (x, y) =&gt;  return x * y;<br>
<br>
// This will return the expected result<br>
const myFunction = (x, y) =&gt; { return x * y };<br> 
</div>
...
<h2>Arrow Functions Are Not Declarations</h2>
<p>Arrow functions are always expressions and must be assigned to a variable.</p>
<p>They cannot be used before they are defined.</p>
...
<p>Arrow functions must be defined <strong>before</strong> they are used.</p>
</div>

<hr>
<h2>Arrow Functions and the this Keyword</h2>
<p>Arrow functions do not have their own <b>this</b> value.</p>
<p>They inherit <b>this</b> from the surrounding code.</p>
...
<p>Using an arrow function as a method often gives unexpected results.</p>
...
<p>In this case, <b>this</b> does not refer to the <b>person</b> object.</p>

<hr>
<h2>When to Use Arrow Functions</h2>
<ul>
  <li>For short functions</li>
  <li>For callbacks and array methods</li>
  <li>When you do not need your own <b>this</b></li>
</ul>
...
<ul>
  ...
  <li>When you need your own <b>this</b></li>
  <li>When using function declarations</li>
</ul>

<hr>
<div class="ws-note">
<h2>Quiz</h2>
<p>What is one important difference between arrow functions and regular functions?</p>
</div>
<hr>

<h2>Common Mistakes</h2>
<ul class="w3-ul">
<li><h3>Forgetting Parentheses Rules</h3>
<b>Parentheses</b> are required for zero or multiple parameters.
</li>
<li><h3>Using Arrow Functions as Methods</h3>
Arrow functions do not bind <b>this</b>.</li>

<li><h3>Expecting Hoisting</h3>
Arrow functions are <b>not hoisted</b>.
</li>
</ul>
...
<p>You have now learned the most important concepts about JavaScript functions.</p>
<p>Try the quiz to test your knowledge.</p>
<p class="w3-large"><a href="js_function_quiz.asp">JavaScript Functions Quiz</a></p>
</div>

<!--stop-->
<hr>

<div id="exercisecontainer" src="xrcise_arrow_function.js"></div>
<hr>
