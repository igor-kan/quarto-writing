...
<a class="w3-left w3-btn" href="js_events_mouse.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_events_load.asp">Next &#10095;</a>
</div>

<!--start-->
<div class="ws-info">
<p class="w3-large"><b>Keyboard Events</b> happen when the user presses a key on the keyboard:</p>
<ul class="w3-large">
<li>keydown (key is pressed down)</li>
<li>keyup (key is released)</li>
...
<p><code class="w3-codespan">keypress</code> only fires for character keys (a or 5),
not for control keys (alt or backspace).</p>
<p>Developers are advised to use <code class="w3-codespan">keydown</code> or <code class="w3-codespan">keyup</code> instead. </p>
</div>

<hr>
<h2>The keydown Event</h2>
<h3>Using event.key</h3>
<div class="w3-example">
<h3>Example</h3>
<p>Show which key was pressed:</p>
<div class="w3-code notranslate htmlHigh">
&lt;input id="k" type="text" placeholder="Press a key"&gt;<br>
<br>
&lt;p id="demo"&gt;&lt;/p&gt;<br>
<br>
&lt;script&gt;<br>
const k = document.getElementById("k");<br>
<br>
// Let k listen for keydown<br>
k.addEventListener("keydown", function (event) {<br>
// Then display the event.key<br>
&nbsp;&nbsp;document.getElementById("demo").innerHTML = "You pressed: " + event.key;<br>
});<br>
&lt;/script&gt;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_events_keydown" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Key Properties</h2>
<p>The KeyboardEvent object provides useful properties to determine which key was involved in the event:</p>
<div class="w3-stretch">
<table class="= ws-table-all">
<tr></tr>
<tr><th>Property</th><th>Description</th><th>When pressing Z</th></tr>
<tr><td>event.key</td>
<td>Returns the value of the key.<br>Can vary based on language settings.</td>
<td>Returns z<br>(or Z if shift is held)</td></tr>
<tr><td>event.code</td><td>Returns the key code.<br>Constant, regardless of language settings.</td>
<td>Always returns "KeyZ"</td></tr>
</table>
</div>
...
<p>You can also detect modifier keys using properties like event.ctrlKey, event.shiftKey, event.altKey,
and event.metaKey to implement key combinations (e.g., Ctrl + S). </p>
</div>
...
<hr>
<h2>Detect Enter<h2>
<h3>Using event.code</h3>
<div class="w3-example">
<div class="w3-code notranslate htmlHigh">
&lt;input id="in01" type="text" placeholder="Press Enter"&gt;<br>
<br>
&lt;p id="demo"&gt;&lt;/p&gt;<br>
<br>
&lt;script&gt;<br>
const in01 = document.getElementById("in01");<br>
<br>
// Let in01 listen for keydown<br>
in01.addEventListener("keydown", function (event) {<br>
// If event.code was "enter", then display text<br>
&nbsp;&nbsp;if (event.code === "Enter") {<br>
&nbsp;&nbsp;&nbsp;&nbsp;document.getElementById("demo").innerHTML = "Enter was pressed!";<br>
&nbsp;&nbsp;}<br>
});<br>
&lt;/script&gt;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_events_detectenter" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<div class="ws-note">
<h2>Summary</h2>
<p>JavaScript provides keyboard events to detect and handle user input from the keyboard, 
enabling interactive web experiences like form validation, game controls, and keyboard shortcuts.</p>
</div>
