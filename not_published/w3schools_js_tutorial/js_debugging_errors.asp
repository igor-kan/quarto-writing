...
<html lang="en-US">
<head>
<title>JavaScript Debugging Common Errors</title>
<meta charset="utf-8">
...
<h1>JavaScript Debugging Errors</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_debugging_breakpoints.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_debugging_async.asp">Next &#10095;</a>
</div>

<!--start-->
<div class="ws-info">
<h2>Common Errors Explained</h2>
<p>JavaScript error messages look scary, but most of them mean very simple things.</p>
<p>This page explains the most common errors in beginner-friendly language.</p>
</div>

<div class="ws-note">

<p>Error messages are clues.</p>
<p>They tell you where to look and what kind of mistake happened.</p>
</div>

<hr>
<h2>How to Read an Error Message</h2>
<p>An error message usually has three important parts.</p>
<ul class="w3-ul w3-card-2" style="max-width:720px">
<li>The error type.</li>
<li>A short explanation.</li>
<li>A line number.</li>
</ul>
<p>Click the line number in the console to jump to the exact line of code.</p>

<hr>
<h2>ReferenceError</h2>
<p>A <b>ReferenceError</b> means a variable or function name does not exist.</p>
<p>This is often caused by a misspelling or a missing declaration.</p>
...
<p>JavaScript says it cannot find <code class="w3-codespan">myValue</code>.</p>
<div class="ws-tip">
<p>Check spelling and make sure the variable is declared with <code class="w3-codespan">let</code> or <code class="w3-codespan">const</code>.</p>
</div>

<hr>
<h2>TypeError</h2>
<p>A <b>TypeError</b> means you used a value in an invalid way.</p>
<p>This usually happens with <code class="w3-codespan">undefined</code> or <code class="w3-codespan">null</code>.</p>
...
<p>The variable exists, but it has no value.</p>
<p>You cannot read properties from <code class="w3-codespan">undefined</code>.</p>

<div class="ws-tip">
<p>Log the value before using it.</p>
</div>
...
<p>A <b>SyntaxError</b> means JavaScript cannot understand your code.</p>
<p>This is often caused by missing brackets or parentheses.</p>
...
<p>The closing parenthesis is missing.</p>

<div class="ws-warning">
<p>Syntax errors stop the script from running.</p>
</div>
...
<p><b>NaN</b> means <b>Not a Number</b>.</p>
<p>This happens when JavaScript cannot perform valid math.</p>
...
<p>The result is <code class="w3-codespan">NaN</code>.</p>

<div class="ws-tip">
<p>Check that both values are numbers before doing math.</p>
</div>
...
<p>This is one of the most common beginner errors.</p>
<p>It means you are trying to use something that does not exist.</p>
...
<p>The variable exists, but the object does not.</p>

<hr>

<h2>Common Error Meanings</h2>

<ul class="w3-ul w3-card-2" style="max-width:720px">
<li><b>ReferenceError</b> means a name is not defined.</li>
<li><b>TypeError</b> means a value is used incorrectly.</li>
<li><b>SyntaxError</b> means broken code structure.</li>
<li><b>NaN</b> means invalid math.</li>
</ul>
...
<div class="ws-warning">
<p>Do not ignore errors.</p>
<p>Fix the first error before moving on.</p>
</div>

<p>One error often causes many others.</p>

<hr>

<h2>Next: Debugging Async Code</h2>

<p>Async code introduces new types of bugs.</p>
<p>The next page shows how to debug <code class="w3-codespan">fetch()</code>, promises, and async functions.</p>
