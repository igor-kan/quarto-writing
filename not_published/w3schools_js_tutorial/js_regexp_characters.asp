...
<html lang="en-US">
<head>
<title>JavaScript RegExp Character Classes</title>
<meta charset="utf-8">
...
<h1>RegExp Character Classes</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_regexp_flags.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_regexp_meta_characters.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
...
<h2>JavaScript Regex Character Classes</h2>
...
<h3>Example [HW]</h3>
<p>A global search for the characters "H" and "W" in a string:</p>
<div class="w3-code notranslate jsHigh">
let text = "Hello World!";<br>
const pattern = /[HW]/g;<br>
<br>
let result = text.match(pattern);
</div>
<p>
<a class="w3-btn" href="tryit.asp?filename=tryjs_regexp_abc_2" target="_blank">Try it Yourself &raquo;</a></p>
</div>

<div class="w3-example">
<h3>Example [A-Z]</h3>
<p>A global search for the upper case characters "A" to "Z" in a string:</p>
<div class="w3-code notranslate jsHigh">
let text = "This is W3School";<br>
const pattern = /[A-Z]/g;<br>
<br>
let result = text.match(pattern);
</div>
<p>
<a class="w3-btn" href="tryit.asp?filename=tryjs_regexp_a-z" target="_blank">Try it Yourself &raquo;</a></p>
</div>

<div class="w3-example">
<h3>Example [1234]</h3>
<p>A global search for the characters "1", "2", "3" and "4" in a string:</p>
<div class="w3-code notranslate jsHigh">
let text = "123456789";<br>
const pattern = /[1234]/g;<br>
<br>
let result = text.match(pattern);
</div>
<p>
<a class="w3-btn" href="tryit.asp?filename=tryjs_regexp_0-9_2" target="_blank">Try it Yourself &raquo;</a></p>
</div>

<div class="w3-example">
<h3>Example [1-4]</h3>
<p>A global search for the characters "1" to "4" in a string:</p>
<div class="w3-code notranslate jsHigh">
let text = "123456789";<br>
const pattern = /[1-4]/g;<br>
<br>
let result = text.match(pattern);
</div>
<p>
<a class="w3-btn" href="tryit.asp?filename=tryjs_regexp_0-9" target="_blank">Try it Yourself &raquo;</a></p>
</div>

<div class="ws-note">

<p>[01234] is the same as [0-4]</p>
<p>[abcde] is the same as [a-e]</p>
</div>
