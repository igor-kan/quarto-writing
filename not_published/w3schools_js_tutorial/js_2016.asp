...
<a class="w3-left w3-btn" href="js_2017.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_es6.asp">Next &#10095;</a>
</div>

<hr>
<h2>New Features in JavaScript 2016</h2>
<p>Supported in all modern browsers since <b>March 2017</b>.</p>
...
<tr><td><a href="js_2016.asp?#mark_exponent_1">**</a></td>
<td>Raises the first operand to the power of the second</td><td></td></tr>
<tr><td><a href="js_2016.asp?#mark_exponent_2">**=</a></td>
<td>Raises the value of a variable to the power of the right operand</td><td></td></tr>
<tr><td><a href="js_2016.asp?#mark_array_includes">Array includes()</a></td>
<td>Checks if an element is present in an array</td><td></td></tr>
</table>
</div>

<hr>
<h2>Browser Support</h2>
<p><b>JavaScript 2016</b> is supported in all modern browsers since <b>March 2017</b>:</p>
...
<p>ES 2016 is not supported in Internet Explorer.</p>

<hr>
<a id="mark_exponent_1"></a>
<h2>Exponentiation Operator</h2>
<p>The <b>exponentiation</b> operator (<code class="w3-codespan">**</code>) raises the first operand to the power of the second operand.</p>
...
let z = x ** 2;
  ...
  <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_es6_exponent1" target="_blank">Try it Yourself &raquo;</a>
</div>

<p><code class="w3-codespan">x ** y</code> produces the same result as <code class="w3-codespan">Math.pow(x, y)</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let x = 5;<br>
let z = Math.pow(x,2);
  ...
  <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_es6_exponent2" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<a id="mark_exponent_2"></a>
<h2>Exponentiation Assignment</h2>
The <b>exponentiation assignment</b> operator (<code class="w3-codespan">**=</code>) raises the value of a variable to the power of the right operand.
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let x = 5;<br>
x **= 2;
  ...
  <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_es6_exponent3" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<a id="mark_array_includes"></a>
<h2>JavaScript Array includes()</h2>
<p>ECMAScript 2016 introduced <code class="w3-codespan">Array.includes</code> to arrays.</p>
<p>This allows us to check if an element is present in an array:</p>
<div class="w3-example">
