...
<a class="w3-left w3-btn" href="js_conditionals.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_if_else.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
<h2>The JavaScript if Statement</h2>
<p>Use the JavaScript if statement to execute a block of code <b>when a condition is true</b>.</p>
</div>
<!--start-->
<h2>Syntax</h2>
...
<p>Note that <code class="w3-codespan">if</code> is in lowercase letters. Uppercase letters (If or IF) will generate a JavaScript error.</p>
</div>
...
<a target="_blank" href="tryit.asp?filename=tryjs_ifthen" class="w3-btn w3-margin-bottom w3-margin-top">Try it Yourself &raquo;</a>
</div>
<!--stop-->
...
<div class="w3-code notranslate jsHigh">
let age = 18;<br>
let text = "You can Not drive";<br>
<br>
if (age &gt;= 18) {<br>
&nbsp; text = "You can drive";<br>
}<br>
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_if" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
let age = 16;<br>
let text = "You can Not drive";<br>
<br>
...
<a target="_blank" href="tryit.asp?filename=tryjs_if_not" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<h2>Nested if</h2>
<p>You can use an <code class="w3-codespan">if</code> statement inside another
...
<a target="_blank" href="tryit.asp?filename=tryjs_if_nested" class="w3-btn w3-margin-bottom w3-margin-top">Try it Yourself &raquo;</a>
</div>
<p>Nested if statements can make your code more complex.</p>
<p>A better solution is to use the logical AND operator:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let age = 16;<br>
...
let text = "You can Not drive!";<br>
<br>
if (country == "USA" &amp;&amp; age &gt;= 16) {<br>
&nbsp;&nbsp;text = "You can drive!";<br>
}<br>
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_if_and" class="w3-btn w3-margin-bottom w3-margin-top">Try it Yourself &raquo;</a>
</div>
