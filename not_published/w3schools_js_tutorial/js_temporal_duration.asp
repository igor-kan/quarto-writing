...
<html lang="en-US">
<head>
<title>JavaScript Temporal.Duration - Add and Subtract Time</title>
<meta charset="utf-8">
...
<h1>JavaScript Temporal Duration</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_temporal_vs_date.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_temporal_instant.asp">Next &#10095;</a>
</div>
<div class="ws-info">
<h2>The Temporal.Duration Object</h2>
<p>The <b>Temporal.Duration</b> object represents a <b>length of time.</b></p>
<p>Example: <b>7 days and 1 hour.</b></p>
<p>The <b>Temporal.Duration</b> object includes these <b>properties</b>:</p>
<p><b>years, months, weeks, days, hours, minutes, seconds, milliseconds,
microseconds and nanoseconds</b>.</p>
</div>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create a Duration object<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_duration_2" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>ISO 8601 Duration Codes</h2>
<p>An <b>ISO 8601 duration</b> represent lengths of time.</p>
<p>It uses a standard format starting with <b>&plusmn;P</b> (Period),
followed by the structure <b>nYnMnDTnHnMnS</b>.</p>

<div class="w3-example">
<h3>Syntax</h3>
<p>(spaces are added for readability)</p>
<div class="w3-code notranslate w3-large">
+P nY nM nW nD T nH nM nS
</div>
</div>
<p>It covers years <b>nY</b>, months <b>nM</b>, weeks <b>nW</b>, days <b>nD</b>, and a <b>T</b>
before hours <b>nH</b>, minutes <b>nM</b>, and seconds <b>nS</b>.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Three years, six months, four days, twelve hours, thirty minutes, and five seconds.</p>
<div class="w3-code notranslate w3-large">
P3Y6M4DT12H30M5S
</div>
</div>
...
<tr></tr>
<tr><th>Duration</th><th>Code</th></tr>
<tr><td>1 Day</td><td>P1D</td></tr>
<tr><td>45 Minutes</td><td>PT45M</td></tr>
<tr><td>1 Year, 2 Months, 3 Days</td><td>P1Y2M3D</td></tr>
<tr><td>4 Hours, 5 Minutes, 6 Seconds</td><td>PT4H5M6S</td></tr>
<tr><td>2.5 Hours</td><td>PT2H30M</td></tr>
<tr><td>5 Weeks</td><td>P5W</td></tr>
</table>

<div class="ws-note">
<h2>Learn More:</h2>
<p class="w3-large"><a href="js_temporal_standards.asp">JavaScript Temporal Standards</a></p>
</div>

<hr>
<h2>How to Create a Temporal.Duration</h2>
<p>A Duration can be created in several different ways:</p>
<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
<tr><th>From</th><th>Code</th></tr>
<tr><td>With Constructor</td><td>new Temporal.Duration()</td></tr>
<tr><td>From Object </td><td>Temporal.Duration.from()</td></tr>
<tr><td>From ISO String</td><td>Temporal.Duration.from()</td></tr>
</table>
</div>

<hr>
<h2>Create a Duration Using <b>new</b></h2>
<p>You can create a Temporal.Duration object using the <b>new</b> constructor
with <b>integer parameters</b>.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Create a duration of 7 days and 2 hours.</p>
<div class="w3-code notranslate jsHigh">
// Create a Duration object<br>
const duration = new Temporal.Duration(0, 0, 0, 7, 2);
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_duration_1" target="_blank">Try it Yourself &raquo;</a>
</div>

<p>The parameters must be in this orde:</p>
<ul>
<li>Years</li>
<li>Months</li>
<li>Weeks</li>
...
<hr>
<h2>Create a Duration Using an <b>Object</b></h2>
<p>You can create a duration object using the <code class="w3-codespan">from()</code> method with an 
<b>object literal</b> parameter like <code class="w3-codespan">{days:7, hours: 2}</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create a Duration object<br>
...
<div class="ws-note">
<p>An <b>object literal</b> is the most common method for creating JavaScript objects.</p> 
<p>You create an object by literally writing its contents as
<b>key:value</b> pairs enclosed in <b>curly braces { }</b>.</p>
</div>

<hr>
<h2>Create a Duration Using an <b>ISO string</b></h2>
<p>You can create a Duration object using the <code class="w3-codespan">from()</code> method
with an <b>ISO duration string</b> as parameter.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create a Duration<br>
const duration = Temporal.Duration.from("P7DT2H");
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_duration_3" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="ws-note">
<h3>Learn More:</h3>
<p class="w3-large"><a href="js_temporal_standards.asp?#mark_duration">ISO Duration Strings</a></p>
</div>

<hr>
<h2>Temporal.Duration Properties</h2>
<p>The <code class="w3-codespan">Temporal.Duration</code> object has <b>12 properties</b> of time information.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
//Create a Duration<br>
const duration = new Temporal.Duration(0, 0, 0, 7, 2, 0);<br>
<br>
// List the Properties<br>
let text =<br>
"blank: " + duration.blank + " " +<br>
"sign: " + duration.sign + " " +<br>
"years: " + duration.years + " " +<br>
"months: " + duration.months + " " +<br>
"weeks: " + duration.weeks + " " +<br>
"days: " + duration.days + " " +<br>
"hour: " + duration.hours  + " " +<br>
"minutes: " + duration.minutes  + " " +<br>
"seconds: " + duration.seconds  + " " +<br>
"milliseconds: " + duration.milliseconds  + " " +<br>
"microseconds: " + duration.microseconds  + " " +<br>
"nanoseconds: " + duration.nanoseconds;<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_duration_prop" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>The with() Method</h2>
<p>The <code class="w3-codespan">with()</code> method returns a new duration
with specific properties (time units) replaced:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create a Duration<br>
const duration = Temporal.Duration.from({hours:10, minutes:30});<br>
<br>
// Create a new duration with the minutes changed to 45<br>
const newDuration = duration.with({minutes:45});
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_duration_with" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Safe Date Arithmetic</h2>
<p>The <b>Duration object</b> facilitates safe and clear date and time arithmetic,
preventing issues related to DST (daylight saving time) and time zone changes.</p>
<p>The <b>Duration object</b> can handle time in various units, including years, months,
weeks, days, hours, minutes, seconds, milliseconds, microseconds, and nanoseconds.</p>
<p>The <b>Duration object</b> makes date arithmetic clear, readable, and safer than using manual millisecond calculations.</p>

<hr>
<h2>The Duration add() Method</h2>
<p>The <code class="w3-codespan">add()</code> method returns a new duration with a duration added.</p>
<p>The <code class="w3-codespan">add()</code> method does not change the original duration.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create a Duration<br>
const d1 = Temporal.Duration.from({ hours:2, minutes:30 });<br>
<br>
// Add a Duration<br>
const d2 = d1.add({ hours:1, minutes:30 });
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_temporal_duration_add" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>The Duration subtract() Method</h2>
<p>The <code class="w3-codespan">subtract()</code> method returns a new duration with a duration subtracted.</p>
<p>The <code class="w3-codespan">subtract()</code> method does not change the original duration.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create a Duration<br>
const d1 = Temporal.Duration.from({ hours:2, minutes:30 });<br>
<br>
// Subtract a Duration<br>
const d2 = d1.subtract({ hours:1, minutes:30 });
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_temporal_duration_subtract" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="ws-note">
<h2>Immutability</h2>
<p>Temporal objects are immutable, meaning operations like add() or subtract() return
a new Temporal.Duration instance, leaving the original unchanged.</p>
</div>
...
<h2>Temporal add() and subtract()</h2>
...
<div class="ws-note">
<h3>Learn More:</h3>
<p class="w3-large"><a href="js_temporal_arithmetic.asp">Temporal Arithmetic</a></p>
</div>


<hr>
<h2>The Compare() Method</h2>
<p>The Temporal.Duration object does not have an <code class="w3-codespan">equals()</code> method due to the
complexity of handling different representations of the same duration.</p>
<p>Instead, equality is checked using the static <code class="w3-codespan">Temporal.Duration.compare()</code> method.</p>
<p>This method returns <b>-1</b> if the first duration is shorter, <b>0</b> if it is the same,
and <b>1</b> if it is longer.</p>

<div class="w3-example">
<h3>Examples</h3>
<div class="w3-code notranslate jsHigh">
// Create two Durations<br>
const d1 = Temporal.Duration.from({ hours:1, minutes:30 });<br>
const d2 = Temporal.Duration.from({ minutes:90 });<br>
<br>
// Compare the Durations<br>
let result = Temporal.Duration.compare(d1, d2);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_duration_compare" target="_blank">Try it Yourself &raquo;</a>
<div class="w3-code notranslate jsHigh">
// Create two Durations<br>
const d1 = Temporal.Duration.from({ hours:1, minutes:30 });<br>
const d2 = Temporal.Duration.from({ hours:1, minutes:30 });<br>
<br>
// Compare the Durations<br>
let result = Temporal.Duration.compare(d1, d2);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_duration_compare_2" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="ws-note">
<p>Note that both examples return 0 for equal.</p>
<p>90 minutes is the same duration as 1 hour and 30 minutes.</p>
</div>

<p><b>All temporal objects</b> have their own <b>compare() method</b>:</p>
<ul>
<li>Temporal.Instant.compare(<i>instant1, instant2</i>)</li>
<li>Temporal.PlainDate.compare(<i>plaindate1, plaindate2</i>)</li>
<li>Temporal.PlainTime.compare(<i>plaintime1, plaintime2</i>)</li>
<li>Temporal.PlainYearMonth.compare(<i>plainyearmonth1, plainyearmonth2</i>)</li>
<li>Temporal.PlainMonthDay.compare(<i>plainmonthday1 plainmonthday2</i>)</li>
<li>Temporal.PlainDateTime.compare(<i>plaindatetime1,plaindatetime2</i>)</li>
<li>Temporal.ZonedDateTime.compare(<i>zoneddtatime1, zoneddtatime2</i>)</li>
<li>Temporal.Duration.compare(<i>duration1, duration2</i>)</li>
</ul>

<div class="ws-note">
<h3>Learn More:</h3>
<p class="w3-large"><a href="js_temporal_compare.asp">Temporal Compare</a></p>
</div>
<hr>
<h2>Range Errors</h2>
<div class="w3-example">
...
<div class="w3-code notranslate jsHigh">
// Create two Durations<br>
const d1 = Temporal.Duration.from({ days:30 });<br>
const d2 = Temporal.Duration.from({ months: 1 });<br>
<br>
// Compare the Durations<br>
let result = Temporal.Duration.compare(d1, d2);<br>
</div>
</div>
<p>The code above fails and throws a RangeError because d2 contains a calendar unit (months),
which has an uneven and variable length.</p>
<p>Without a specific starting point on the calendar, the JavaScript runtime cannot determine
exactly how many days are in "1 month" to perform the comparison.</p>
<p>For example, 1 month starting in February could be 28 or 29 days, while 1 month starting in
January is 31 days.</p>
<hr>
<h2>No equals() Method</h2>

<p>The Temporal.Duration object does not have an equals() method because durations can be represented
in multiple "unbalanced" ways that are mathematically equivalent but structurally different.</p>
<p>For example, a duration of 90 seconds is logically equal to 1 minute and 30 seconds,
but they are stored as distinct property sets within the Temporal.Duration object.</p>

<p><b>Unbalanced Units</b>: By default, Temporal.Duration preserves the units exactly as they were defined.
Because "60 minutes" and "1 hour" are different internal representations, a standard equals() method would
be ambiguous (should it check for identical properties or identical time length?)</p>

<p><b>Variable Unit Lengths</b>: Units like days, months, and years do not have a fixed length.
A "month" can be 28, 30, or 31 days depending on the calendar and reference date.</p>
<p><b>Need for Context</b>: To accurately compare two durations containing calendar units
(years, months, weeks), you must provide a relativeTo option (a specific starting point).
Without this reference, the API cannot determine if two calendar-based durations are truly "equal".</p>

<div class="ws-note">
<p>Instead of a simple equals() method, the TC39 Temporal proposal requires developers to use the
static Temporal.Duration.compare() method instead.</p>
</div>

<hr>
<h2>When to Use Duration</h2>
<ul>
  <li><p>Adding or subtracting time</p></li>
  <li><p>Calculating age</p></li>
  <li><p>Calculating differences between dates</p></li>
  <li><p>Calculating time spans (hours, days, months)</p></li>
</ul>
...
<div class="w3-example">
<h3>Display All Duration Properties</h3>
<div class="w3-code notranslate jsHigh">
//Create a Duration<br>
const duration = new Temporal.Duration(0, 0, 0, 7, 2, 0);<br>
<br>
