...
<h1>JavaScript HTML Input Examples</h1>
...
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="tryit.asp?filename=tryjs_button_disabled">Disable a button</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_button_name">Find the name of a button</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_button_type">Find the type of a button</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_button_value">Find the value of a button</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_button_text">Find the text displayed on a button</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_button_form">Find the id of the form a button belongs to</a>
</div>
<hr>

<h2>Form Object</h2>
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="tryit.asp?filename=tryjs_form_submit">Submit a form</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_form_reset">Reset a form</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_form_elements">Find the value of each element in a form</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_form_acceptcharset">Find the accepted character set of a form</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_form_action">Find the action attribute of a form</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_form_enctype">Find the value of the enctype attribute in a form</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_form_length">Find the number of elements in a form</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_form_method">Find the method for sending form data</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_form_name">Find the name of a form</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=tryjs_form_target">Find the target of a form</a>
</div>
<hr>

<h2>Option and Select Objects</h2>
<div class="w3-bar-block">
<a class="w3-button w3-bar-item ws-grey" target="_blank" href="tryit.asp?filename=try_dom_select_disabled">Disable and enable a dropdown list</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=try_dom_select_form">Get the id of the form that contains the dropdown list</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=try_dom_select_length">Get the number of options in the dropdown list</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=try_dom_select_size">Turn the dropdown list into a multiline list</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=try_dom_select_multiple">Select multiple options in a dropdown list</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=try_dom_select_option">Display the selected option in a dropdown list</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=try_dom_select_options">Display all options from a dropdown list</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=try_dom_option_index">Display the index of the selected option in a dropdown list</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=try_dom_option_settext">Change the text of the selected option</a>
<a class="w3-button w3-bar-item ws-grey w3-border-top" target="_blank" href="tryit.asp?filename=try_dom_select_remove">Remove options from a dropdown list</a>
</div>
