...
<a class="w3-left w3-btn" href="js_map_methods.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_map_reference.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
...
// Create a WeakMap<br>
let myMap = new WeakMap();<br>
<br>
// Create an Object<br>
let myObj = {fname:"John", lname:"Doe"};<br>
<br>
// Set a WeakMap value<br>
myMap.set(myObj, "player");<br>
<br>
// Get the WeakMap value<br>
let type = myMap.get(myObj);
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_weakmap" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<br>
myObj = null;<br>
// now myObj (and its values) in myMap can be garbage collected</div>
</div>
...
let text = "";<br>
<br>
// Create a WeakMap to store visit counts<br>
const visitsCount = new WeakMap();<br>
<br>
// Create Visitor Objects<br>
const John = {name:"John", age:40};<br>
const Paul = {name:"Paul", age:41};<br>
const Ringo = {name:"Ringo", age:42};<br>
const George = {name:"George", age:43};<br>
<br>
// Track visits<br>
track(Paul);<br>
track(Ringo);<br>
...
track(John);<br>
<br>
// Function to track visitors<br>
function track(visitor) {<br>
&nbsp; let count = visitsCount.get(visitor) || 0;<br>
&nbsp; count++;<br>
&nbsp; visitsCount.set(visitor, count);<br>
&nbsp; text += visitor.name + ", age " + visitor.age + ", has visited " + count + " time(s).&lt;br&gt;";<br>
}<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_weakmap_visitors" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<tr><td>new WeakMap()</td><td>Creates a new WeakMap object</td></tr>
...
<div class="w3-code notranslate jsHigh">
// Create WeakMap<br>
const myMap = new WeakMap();<br>
<br>
// Private Fields Simulation<br>
class User {<br>
&nbsp;&nbsp;constructor(name) {<br>
&nbsp;&nbsp;myMap.set(this, {secret:"hidden data"});<br>
&nbsp;&nbsp;this.name = name;<br>
&nbsp;}<br>
&nbsp;getSecret() {<br>
&nbsp;&nbsp;return myMap.get(this).secret;<br>
&nbsp; }<br>
}<br>
<br>
const user1 = new User("John");<br>
secret = user1.getSecret();<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_weakmap_secret" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<p><code class="w3-codespan">WeakMap</code> is an <a href="js_es6.asp">ES6  feature</a>.</p>
