...
<a class="w3-left w3-btn" href="js_2020.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_2018.asp">Next &#10095;</a>
</div>

<hr>
<h2>New Features in JavaScript 2019</h2>

<div class="w3-stretch">
<table class="ws-table-all">
<tr></tr>
<tr><th>Feature</th><th>Description</th><th></th></tr>
<tr><td><a href="js_2019.asp?#mark_trim_start">String trimStart()</a></td>
<td>Removes whitespace from the start of a string</td><td></td></tr>
<tr><td><a href="js_2019.asp?#mark_trim_end">String trimEnd()</a></td>
<td>Removes whitespace from the end of a string</td><td></td></tr>
<tr><td><a href="js_2019.asp?#mark_from_entries">Object.fromEntries</a></td>
<td>Creates an object from key/value pairs</td><td></td></tr>
<tr><td><a href="js_2019.asp?#mark_omit_catch">Optional catch binding</a></td>
<td>Allows to omit the catch parameter if it is not needed</td><td></td></tr>
<tr><td><a href="js_2019.asp?#mark_array_flat">Array flat()</a></td>
<td>Creates a new array by flattening a nested array</td><td></td></tr>
<tr><td><a href="js_2019.asp?#mark_array_flatmap">Array flatMap()</a></td>
<td>Maps all array elements and creates a new array by flattening the array</td><td></td></tr>
<tr><td><a href="js_2019.asp?#mark_array_sort">Revised Array sort()</a></td>
<td>Browsers must now use a stable sorting algorithm</td><td></td></tr>
<tr><td><a href="js_2019.asp?#mark_json_stringify">Revised JSON.stringify()</a></td>
<td>Strings with UTF-8 code points now convert safely</td><td></td></tr>
<tr><td><a href="js_2019.asp?#mark_separator_symbols">Separator symbols in strings</td>
<td>Line and paragraph separators (\u2028 and \u2029) are now allowed in strings</td><td></td></tr>
<tr><td><a href="js_2019.asp?#mark_function_tostring">Revised Function.toString()</a></td>
<td>Now returns source code including comments and spaces and syntax details</td><td></td></tr>
</table>
</div>

<hr>
<h2>Browser Support</h2>
<p><b>ECMAScript 2019</b> is supported in all modern browsers since <b>January 2020</b>:</p>
...
<p>ES2019 added the String method <code class="w3-codespan">trimStart()</code> to JavaScript.
...
<hr>
<a id="mark_trim_end"></a>
<h2>JavaScript String trimEnd()</h2>
<p>ES2019 added the String method <code class="w3-codespan">trimEnd()</code> to JavaScript.
...
<hr>
<a id="mark_from_entries"></a>
<h2>JavaScript Object fromEntries()</h2>
<p>ES2019 added the Object method <code class="w3-codespan">fromEntries()</code> to JavaScript.
<p>The <code class="w3-codespan">fromEntries()</code> method creates an object from iterable key / value pairs.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const fruits = [<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_object_fromentries" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<a id="mark_omit_catch"></a>
<h2>Optional catch Binding</h2>
<p>From ES2019 you can omit the catch parameter if you don't need it:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Before 2019:</p>
<div class="w3-code notranslate jsHigh">
...
<hr>
<a id="mark_array_flat"></a>
<h2>JavaScript Array flat()</h2>
<p>ES2019 added the Array <code class="w3-codespan">flat()</code> method to JavaScript.</p>
<p>The <code class="w3-codespan">flat()</code> method creates a new array by flattening a nested array.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<hr>
<a id="mark_array_sort"></a>
<h2>Stable Array sort()</h2>
<p>ES2019 <b>revised</b> the Array <code class="w3-codespan">sort()</code> method.</p>
...
<p>In the example above, when sorting on price, the result should not have names in a different relative position, such as this:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
X01 100<br>
X03 100<br>
...
<h2>Revised JSON.stringify()</h2>
<p>ES2019 <b>revised</b> the JSON <code class="w3-codespan">stringify()</code> method.</p>
<p>Before 2019, JSON could not stringify character encoded with \.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
let text = JSON.stringify("\u26D4");
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_json_stringify_2019" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>Before ES2019, using <code class="w3-codespan">JSON.stringify()</code>JSON on UTF-8 code points (U+D800 to U+DFFF)
returned broken Unicode characters like &#65533;&#65533;&#65533;.</p>
<p>After this revision, strings with UTF-8 code points convert safely with <code class="w3-codespan">JSON.stringify()</code>,
and back to the original using <code class="w3-codespan">JSON.parse()</code>.

<hr>
<a id="mark_separator_symbols"></a>
<h2>Separator Symbols</h2>
<p>Line separators and paragraph separator symbols (\u2028 and \u2029) are now allowed in string literals.</p>
<p>Before 2019, these were treated as line terminators and resulted in error exceptions:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// This is valid in ES2019:<br>
let text = "\u2028";
</div>
<a target="_blank" href="tryit.asp?filename=tryjs_string_newline" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="ws-note">

<p>Now, JavaScript and JSON have equal rules.</p>
<p>Before ES2019:</p>
<p>text = JSON.parse('"\u2028"') would parse to ''.</p>
<p>text = '"\u2028"' would give <b>syntax error</b>.</p>
</div>

<hr>
<a id="mark_function_tostring"></a>
<h2>Revised Function toString()</h2>
<p>ES2019 <b>revised</b> the Function <code class="w3-codespan">toString()</code> method.</p>
<p>The <code class="w3-codespan">toString()</code> method returns a string representing the source code of a function.</p>
<p>From 2019, toString() must return the source code of the function including comments,
spaces, and syntax details.</p>
<p>Before 2019, different browsers returned different variants of the function (like without comments and spaces).
From 2019 the function should be returned exactly as it is written.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<a target="_blank" href="tryit.asp?filename=tryjs_function_tostring" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
