...
<div class="ws-info">
<h2>Curly Braces</h2>
<p>A <b>code block</b> or <b>block statement</b> is a group of statements
enclosed within curly braces <b>{ }</b>.</p>
<p>Code blocks are important for controlling the flow of execution and defining variable
scope within a JavaScript program.</p>
</div>

<h2>Code Blocks and Statements</h2>
<p>Code blocks allows for <b>multiple statements</b> to be treated as a single unit.</p>

<p>The body of a JavaScript <b>function</b> is always enclosed within a code block:</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_functions">Try it Yourself &raquo;</a>
</p>
</div>


<p>Code blocks are essential for <b>if statements</b>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
if (condition) {<br>
...
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_ifthenelse">Try it Yourself &raquo;</a>
</p>
</div>

<p>Code blocks are essential for <b>loop statements</b>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_loop_for_ex">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_while">Try it Yourself &raquo;</a>
</p>
</div>
...
<hr>
<h2>Defining Scope</h2>
<p>Variables declared with <code class="w3-codespan">let</code> and <code class="w3-codespan">const</code>
inside a code block are "block-scoped," meaning they are only accessible within that specific block.</p>
<p>This helps prevent unintended variable overwrites and promotes better code organization:</p>
...
{<br>
&nbsp; let x = 10;<br>
&nbsp; // x is accessible here<br>
}<br>
<br>
// x is not accessible here<br>
</div>
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_block">Try it Yourself &raquo;</a>
</p>
</div>

<hr>
<h2>Standalone Blocks</h2>
<p>Code blocks can also exist independently without being attached to an if statement,
a function or a loop.</p>
<p>This can be used to create a scope for <code class="w3-codespan">let</code>
and <code class="w3-codespan">const</code> variables.</p>
...
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_block_alone">Try it Yourself &raquo;</a>
</div>

<p>This example above demonstrates how a standalone block can be used to limit the scope
of variables.</p>

<h3>Encapsulation</h3>
<p>Variables inside the block are only available in the block.</p>
<p>This prevents "polluting" the global scope, keeps the code clean,
and reduces the risk of name collisions.</p>

<h3>Temporary Use</h3>
<p>If you only need variables for a calculation,
a block lets you declare them, use them, and discard them.</p>

<h3>Organized Code</h3>
<p>You can group related variables and statements in their own scope to avoid accidental name
conflict without forcing them into a function or an object.</p>
<p>This improves readability and avoids accidental name conflictre-use of variable names
outside the block.</p>
