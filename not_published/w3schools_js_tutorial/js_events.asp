...
<a class="w3-left w3-btn" href="js_htmldom_element_reference.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_events_mouse.asp">Next &#10095;</a>
</div>
<!--start-->
<div class="ws-info">
<h2>HTML Events</h2>
<p>HTML events are <b>things that happen</b> to HTML elements.</p>
<p><b>Examples of events:</b></p>
<ul>
<li>An HTML button is clicked</li>
<li>A web page has finished loading</li>
<li>The mouse moves over an element</li>
<li>A keyboard key is pressed</li>
<li>An HTML input field is changed</li>
</ul>
</div>
<!--start-->
...
<p class="intro">When JavaScript is used in HTML pages, <b>JavaScript can react on events</b>.</p>
...
&lt;<em>element</em>
<em>event</em>=<strong>'</strong><em><strong>some JavaScript</strong></em><strong>'</strong>&gt;
</div>
...
<p>In the following example, an <code class="w3-codespan">onclick</code> attribute (with code), is added to a 
<code class="w3-codespan">&lt;button&gt;</code> element:</p>
...
its own element using <code class="w3-codespan"><b>this</b>.innerHTML</code>: </p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
...
<hr>
<h2>Calling a JavaScript Function</h2>
<p>JavaScript code can often be several lines long.</p>
<p>It is more common to use the event attribute to call a function:</p>
...
<p>An event handler is JavaScript code that runs when an event happens.</p>
...
<p>Using event attributes like <code class="w3-codespan">onclick</code> are easy to use.</p>
<p>Nevertheless, using <code class="w3-codespan">addEventListener()</code> is the recommended way to handle events.</p>
<div class="w3-example">
<h3>Not Recommended</h3>
<p>Using the <code class="w3-codespan">onclick</code> attribute:</p> 
<div class="w3-code notranslate htmlHigh">
&lt;button onclick=&quot;displayDate()&quot;&gt;Time is?&lt;/button&gt;<br>
<br>
&lt;p id="demo"&gt;&lt;/p&gt;<br>
<br>
&lt;script&gt;<br>
// Function to display date<br>
function displayDate() {<br>
&nbsp; document.getElementById("demo").innerHTML = Date();<br>
}<br>
&lt;/script&gt;
</div>
<a class="w3-btn" href="tryit.asp?filename=tryjs_events_attribute" target="_blank">Try it Yourself &raquo;</a>
</div>

<p>The <code class="w3-codespan">addEventListener()</code> method keeps HTML and JavaScript separated.</p>

<div class="w3-example">
<h3>Highly Recommended</h3>
<p>Using <code class="w3-codespan">addEventListener()</code> method:</p>
<div class="w3-code notranslate htmlHigh">
...
// Add EventListener to btn<br>
btn.addEventListener("click", function () {<br>
&nbsp; document.getElementById("demo").innerHTML = Date();<br>
});<br>
&lt;/script&gt;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_events_eventlistener" target="_blank">Try it Yourself &raquo;</a>
</div>
