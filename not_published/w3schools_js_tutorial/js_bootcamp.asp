...
<html lang="en-US">
<head>
<title>W3Schools JavaScript Bootcamp</title>
<meta charset="utf-8">
...
<h1>W3Schools JavaScript Bootcamp</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_interview_prep.asp">&#10094; Previous</a>
...
<div class="ws-light-green caption w3-round" style="padding-top:50px;padding-bottom:50px;position:relative;">
  <div style="max-width:1300px;margin:auto">
    <h1 class="bctop">JavaScript Bootcamp</h1>
    ...
    <p style="margin-top:8px;"><a title="Learn More" target="_blank" href="/bootcamp/javascript.php" style="width:200px;font-size:20px;border-radius:25px;font-weight:600;padding:8px 16px;margin-right:5px;margin-top:16px;" class="ws-btn w3-mobile applynowbtn ga-featured">Learn More</a></p>
...
<div class="caption" style="padding-left:0;padding-right:0;font-family: 'Source Sans Pro', sans-serif;">
  ...
  <div style="max-width:950px">
      <p>In this bootcamp, you will learn the programming language that powers the web, from basic syntax to advanced concepts like object-oriented programming and DOM manipulation.</p>
      <p>You will learn the fundamentals of JavaScript over a 4 weeks period together with a live instructor and an interactive cohort of engaged learners!</p>

    <h5 style="font-size:30px;font-weight:bold;">You Will Learn</h5>

    <ul style="font-size:16px;">
      <li>Javascript fundamentals starting at basics such as variables and datatypes, through to control structures, arrays, functions, objects, and more.</li>
      <li>Make websites dynamic and interactive using DOM manipulation and events bringing together knowledge from HTML, CSS & JavaScript into one dynamic application</li>
      <li>Implement user interactions such as form submissions and button clicks to your projects</li>
      <li>Extract and process data from APIs and databases to use in your own applications</li>
      <li>Visualise data</li>
      <li>Dynamically change web page content using advanced JavaScript concepts from ES6 and more</li>
      <li>Complete AJAX requests for seamless data retrieval</li>
      <li>Build scalable and performant applications utilising your knowledge of HTML, CSS & JavaScript</li>
    </ul>
...
<div style="background-color:#F3ECEA;padding-top:30px;color:black" class="w3-round">
  ...
  <p style="margin-top:8px;text-align:center;padding-bottom:45px;"><a title="Learn More" target="_blank" href="/bootcamp/javascript.php" style="width:200px;font-size:20px;border-radius:25px;font-weight:600;padding:6px 6px;" class="ws-btn ga-featured">Learn More</a></p>
</div>
  ...
  <div style="max-width:1350px;margin:auto;padding-left:24px;padding-right:24px;">
    ...
    <div style="text-align:left;font-family: 'Source Sans Pro', sans-serif;">
      ...
      <h4 style='font-size:18px;margin-bottom:20px'><strong>2. Complete the Bootcamp</strong>:<br>
        ...
        <br><br>The bootcamp covers the fundamentals of JavaScript. The curriculum used is the <a target="_blank" href="https://www.w3schools.com/js/default.asp">W3Schools JavaScript Tutorial</a> The bootcamp will help you prepare for the W3Schools JavaScript exam so that you can document and validate your competence.
      ...
      <h4 style='font-size:18px;'><strong>3. Certification and Job Application</strong>:<br>
        Upon completing the bootcamp, you will have passed the W3Schools JavaScript exam and obtained the 
        <strong>Certified JavaScript Developer</strong> Title and an extra acknowledgement that you were a part of the bootcamp on the certification. This certification demonstrates that you know the fundamentals of JavaScript.
      </h4>
      <p><a title="Learn More" target="_blank" href="/bootcamp/javascript.php" style="margin-top:15px;width:200px;font-size:20px;border-radius:25px;font-weight:600;padding:6px 6px;" class="ws-btn w3-mobile applynowbtn ga-featured">Learn More</a></p>
    </div>
  </div>
</div>
