...
<h1>JavaScript Versions</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_es3.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_history.asp">Next &#10095;</a>
</div>

<div class="ws-info">
<h2>Current JavaScript Version</h2>
<p>The current <b>JavaScript</b> version is <a href="js_2025.asp"><b>ES2025</b></a>.</p>
<p><b>ECMAScript</b> is the official name of the <b>JavaScript standard</b>.</p>
<p>JavaScript was invented by Brendan Eich in 1995 and became an ECMA standard in 1997.</p>
<p>The first ECMAScript versions were abbreviated by numbers. (ES1, ES2, ES3, ES5, ES6).</p>
<p>From 2016, versions are named by year (ECMAScript 2016, 2017, 2018, ..., 2025).</p>
</div>
<div class="ws-note">

<h4>W3Schools Covers all JavaScript Versions !</h4>
</div>
...
<td>ECMAScript 1 (1997)
</td><td>FIRST EDITION</td>
</tr>
<tr>

<td>ECMAScript 2 (1998)</td><td>ONLY EDITORIAL CHANGES</td>
</tr>
<tr>
<td>ECMAScript 3 (1999)<br><br>
<a href="js_es3.asp" class="ws-btn">See Details</a><td>
Regular expressions<br>
Error handling (try...catch)<br>
The switch keyword<br>
The do...while loop
</td>
</tr>

<tr>
<td>ECMAScript 4</td><td>WAS NEVER RELEASED</td>
</tr>

<tr>
<td>ECMAScript 5 (2009)<br><br>
<a href="js_es5.asp" class="ws-btn">See Details</a>
</td>
<td>
The "use strict" Directive<br>
JSON support<br>
The String trim() method<br>
The Date.now() method<br>
String property access [ ]<br>
Many new Array methods<br>
Many new Object methods<br>
</td>
</tr>

<tr>
<td>ECMAScript 6 (2015)<br><br>
<a href="js_es6.asp" class="ws-btn">See Details</a></td>
<td>The let and const keywords<br>
...
For...in Loop<br>
Many new Array methods<br>
Many new String methods<br>
Many new Math methods<br>
</td>
</tr>

<tr>
<td>ECMAScript 2016<br><br>
<a href="js_2016.asp" class="ws-btn w3-margin-bottom">See Details</a></td>
<td>The ** Exponentiation Operator<br>
The Array includes() method<br>
</td>
</tr>

<tr>
<td>ECMAScript 2017<br><br>
<a href="js_2017.asp" class="ws-btn w3-margin-bottom">See Details</a></td>
<td>
The String padStart() method<br>
The String padEnd() method<br>
The Object values() method<br>
The Object entries() method<br>
The Object getAllPropertyDescriptors() method<br>
The async and await keywords<br>
</td>
</tr>

<tr>
<td>ECMAScript 2018<br><br>
<a href="js_2018.asp" class="ws-btn w3-margin-bottom">See Details</a></td>
<td>
Asynchronus iteration<br>
Promise finally<br>
Array rest elements<br>
...
<a href="js_2019.asp" class="ws-btn w3-margin-bottom">See Details</a></td>
<td>
String trimStart()<br>
String trimEnd()<br>
...
Array flat()<br>
Array flatMap()<br>
Revised Array sort()<br>
Revised JSON stringify()<br>
Revised Function toString()<br>
Separator symbols in srings<br>
</td>
</tr>

<tr>
<td>ECMAScript 2020<br><br>
<a href="js_2020.asp" class="ws-btn w3-margin-bottom">See Details</a></td>
<td>
BigInt<br>
String matchAll()<br>
...
globalThis<br>
import.meta<br>
Namespace exports<br>
New Operators (??, ?. &amp;&amp;=, ||=, ??=)
</td>
</tr>

<tr>
<td>ECMAScript 2021<br><br>
<a href="js_2021.asp" class="ws-btn w3-margin-bottom">See Details</a></td>
<td>
Promise any()<br>
String replaceAll()<br>
Numeric separator<br>
</td>
</tr>

<tr>
<td>ECMAScript 2022<br><br>
<a href="js_2022.asp" class="ws-btn w3-margin-bottom">See Details</a></td>
<td>
Array at()<br>
String at()<br>
RegExp /d<br>
...
await import<br>
Class fields<br>
Private methods and fields<br>
</td>
</tr>

<tr>
<td>ECMAScript 2023<br><br>
<a href="js_2023.asp" class="ws-btn w3-margin-bottom">See Details</a></td>
<td>
#!<br>
Array findLast()<br>
Array findlastIndex()<br>
Array toReversed()<br>
Array toSorted()<br>
Array toSpliced()<br>
Array with()<br>
...
<tr>
<td>ECMAScript 2024<br><br>
<a href="js_2024.asp" class="ws-btn w3-margin-bottom">See Details</a></td>
<td>
Map groupBy()<br>
Object groupBy()<br>
String isWellFormed()<br>
String toWellFormed()<br>
Promise withResolvers()<br>
Atomics waitAsync<br>
</td>
</tr>

<tr>
<td>ECMAScript 2025<br><br>
<a href="js_2025.asp" class="ws-btn w3-margin-bottom">See Details</a></td>
<td>
RegExp /v flag<br>
RegExp escape()<br>
Float16Array<br>
...
Promise try()<br>
Import Attributes
7 new Set methods<br>
</td>
</tr>

<tr>
<td>ECMAScript 2026<br><br>
<a href="js_2026.asp" class="ws-btn w3-margin-bottom">See Details</a></td>
<td>
Error isError()<br>
Array fromAsync()<br>
The using keyword<br>
The await using<br>
Uin8Array.toBase64()<br>
Uin8Array.fromBase64()<br>
Uin8Array.toHex()<br>
Uin8Array.fromHex()<br>
</td>
</tr>
