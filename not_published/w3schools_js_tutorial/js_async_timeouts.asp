...
<html lang="en-US">
<head>
<title>JavaScript Timeouts</title>
<meta charset="utf-8">
...
<h1>JavaScript Timeouts</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_async.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_async_callbacks.asp">Next &#10095;</a>
</div>

<div class="ws-info">
<h2>The setTimeout() Method</h2>
<p><b>The setTimeout() method</b> schedules a function to <b>run after a delay</b> in milliseconds.</p>
<p>It is an <b>async operation</b> used to delay code execution without freezing the browser.</p>
</div>

<h2>Waiting for a Timeout</h2>
<p>When using the <code class="w3-codespan">setTimeout()</code> method,
you can specify a function to be executed on time-out:</p>
...
<p>In the example above, <code class="w3-codespan">myFunction</code> is passed to
<code class="w3-codespan">setTimeout()</code> as an argument.</p>
...
<p>Wrong: setTimeout(myFunction(), 3000);</p>
</div>

<p>Instead of passing a function name as an argument to another function,
you can always pass the whole function instead:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<p>When using the <code class="w3-codespan">setInterval()</code> method,
you can specify function to be executed for each interval:</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_callback6">Try it Yourself &raquo;</a>
</p>
</div>
<p>In the example above, <code class="w3-codespan">myFunction</code> is passed to <code class="w3-codespan">setInterval()</code> as an argument.</p>
<p><code class="w3-codespan">1000</code> is the number of milliseconds between every time
<code class="w3-codespan">myFunction</code> will be called.</p>
<!--stop-->
...
<div class="ws-note">
<h2>Next Chapter</h2>
<p>A callback runs <b>after another function finishes</b>.</p>
<p>Callbacks were the <b>first solution for asynchronous JavaScript</b>.</p>
<p class="w3-large"><a class="w3-btn w3-green" href="js_async_callbacks.asp">JavaScript Callbacks</a></p>
</div>
<hr>
