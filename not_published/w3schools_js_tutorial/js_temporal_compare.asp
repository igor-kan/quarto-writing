...
<html lang="en-US">
<head>
<title>JavaScript Temporal Compare Methods</title>
<meta charset="utf-8">
...
<h1>JS Temporal Compare</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_temporal_differences.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_temporal_conversion.asp">Next &#10095;</a>
</div>
...
<p><b>The compare() method</b> returns:</p>
<ul>
<li>-1 if the first date is earlier</li>
<li>1 if the first day is later</li>
...
const date2 = Temporal.PlainDate.from("2024-12-25");<br>
<br>
// Compare the dates<br>
result = Temporal.PlainDate.compare(date1, date2);
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_compare_1" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Why &lt; and &gt; Do Not Work</h2>
<p>Temporal objects are objects, not primitive numbers.</p>
<p>When you write (a &lt; b), JavaScript tries to convert both objects to primitives.</p>
<p>For Temporal objects, this does not produce a numeric timestamp like Dates.</p>
...
const b = Temporal.PlainDate.from("2026-03-01");<br>
<br>
// Compare the dates<br>
...
<hr>
<h2>Temporal.Duration.compare()</h2>
<div class="ws-note">
...
Instead, equality is checked using the static <code class="w3-codespan">Temporal.Duration.compare()</code> method.
</div>
<div class="w3-example">
<h3>Examples</h3>
<div class="w3-code notranslate jsHigh">
...
<div class="ws-note">
<p>Note that the two examples above both return 0 for equal.</p>
...
<p>To fix this, you must pass a relativeTo option as the third argument to Temporal.Duration.compare().
This provides a concrete date context to calculate the exact lengths.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
const d1 = Temporal.Duration.from({ days: 30 });<br>
const d2 = Temporal.Duration.from({ months: 1 });<br>
<br>
// Provide a start date (e.g., January 1st, 2026)<br>
const startPoint = Temporal.PlainDate.from("2026-01-01");<br>
<br>
// Compare the Durations using the reference date<br>
let result = Temporal.Duration.compare(d1, d2, { relativeTo: startPoint });<br>
<br>
// Returns -1 (January has 31 days. 30 days is SHORTER than 1 month.)
</div>
</div>
<p>By altering the relativeTo reference point, the execution context dictates different evaluation results:</p>
<p><b>February 1st Start</b>: d1 (30 days) is longer than d2 (1 month / 28 days), returning 1.</p>
<p><b>April 1st Start</b>: d1 (30 days) is exactly equal to d2 (1 month / 30 days), returning 0.</p>
<p><b>January 1st Start</b>: d1 (30 days) is shorter than d2 (1 month / 31 days), returning -1.</p>
<hr>
...
<hr>
<h2>Temporal.PlainDate.compare()</h2>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create two Temporal objects<br>
...
<h2>Temporal Sort</h2>
<p>The <code class="w3-codespan">compare()</code> method is designed to be passed directly into the JavaScript Array.sort() method:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create an Array of dates<br>
const dates = [<br>
&nbsp; Temporal.PlainDate.from("2026-05-17"),<br>
&nbsp; Temporal.PlainDate.from("2022-01-01"),<br>
&nbsp; Temporal.PlainDate.from("2024-12-25")<br>
];<br>
<br>
// Sort chronologically<br>
dates.sort(Temporal.PlainDate.compare);
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_compare" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<div class="ws-note">
<h2>Date Comparison</h2>
<p>Always use the <b>compare()</b> or <b>equals()</b> methods rather than standard equality operators.</p>
</div>
<hr>

<h2>The Temporal equals() Method</h2>
...
<p>The <code class="w3-codespan">equals()</code> method returns
<code class="w3-codespan">true</code> if both dates are equal.</p>
...
<br>
// equals()<br>
let x1 = i1.equals(i2); // true<br>
let x2 = i1.equals(i3); // false<br>
</div>
...
<h2>Temporal.PlainDate equals()</h2>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Create two Temporal objects<br>
const date1 = Temporal.PlainDate.from('2026-05-17');<br>
const date2 = Temporal.PlainDate.from('2026-05-17');<br>
<br>
let result = date1.equals(date2);
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryjs_temporal_plaindate_equals" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Temporal.PlainDateTime equals()</h2>
