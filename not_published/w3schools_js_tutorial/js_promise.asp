...
<a class="w3-left w3-btn" href="js_async_callbacks.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="js_async_await.asp">Next &#10095;</a>
</div>

<!--start-->
<div class="ws-info">
<h2><i>"I Promise a Result!"</i></h2>
<p><b>JavaScript Promises</b> were created to make <b>asynchronous JavaScript easier</b> to use.</p>
<p>A Promise object represents the <b>completion</b> or <b>failure</b> of an <b>asynchronous operation</b>.</p>
<p>A Promise can be in one of <b>three exclusive states</b>:</p>
<table class="ws-table-all">
<tr><td>pending</td><td>operation started (not finished)</td></tr>
...
<h2>Why Promises?</h2>
<p>Many callbacks become hard to read and hard to maintain.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
step1(function(r1) {<br>
&nbsp;&nbsp;step2(r1, function(r2) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;step3(r2, function(r3) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;console.log(r3);<br>
&nbsp;&nbsp;&nbsp;&nbsp;});<br>
&nbsp;&nbsp;});<br>
});<br>
...
<p>The style above is often called <b>callback hell</b>.</p>
<p>Promises let you write the <b>same logic in a cleaner way</b>.</p>
</div>
<p>A Promise acts as a placeholder for a value that will be available at some point in the future,
allowing you to handle asynchronous code in a cleaner way than traditional callbacks.</p>

<hr>
<h2>Promise States</h2>

<p>A promise can be in one of three exclusive states:</p> 
<ul xclass="w3-ul">
<li><p><b>Pending:</b><br>
The initial state; the operation has started but is neither fulfilled nor rejected.</p></li>
<li><p><b>Fulfilled:</b><br>
The operation completed successfully, and a value is available.</p></li>
<li><p><b>Rejected:</b><br>
The operation failed, and a reason (error) is available.</p></li>
</ul>
<p>A promise is considered <b>settled</b> if it is fulfilled or rejected (not pending).</p>
...
<br>
// Code that may take some time<br>
<br>
&nbsp; resolve(value); // when successful<br>
&nbsp; reject(value); &nbsp;// when error<br>
});<br><br>
</div>
</div>

<p>The promise constructor takes a function with two parameters.</p>

<table class="ws-table-all">
<tr></tr>
<tr><th>Parameter</th><th>Description</th></tr>
<tr><td>resolve</td><td>function to run if finishes successfully</td></tr>
<tr><td>reject</td><td>function to run if finishes with an error</td></tr>
</table>

<hr>
<h2>Promises How To</h2>
...
<div class="w3-code notranslate jsHigh">
myPromise.then(<br>
&nbsp; function(value) { /* code if success */ },<br>
&nbsp; function(value) { /* code if error */ }<br>
);
</div>
</div>
...
<p><b>then()</b> takes two arguments, one <b>callback</b> function for <b>success</b> and another for <b>failure</b>.</p>
<p>Both are optional, so you can add a callback function for success or failure only.</p>
</div>

<div class="w3-example">
<h3>Examples</h3>
<div class="w3-code notranslate jsHigh">
// Create a Promise Object<br>
let myPromise = new Promise(function(resolve, reject) {<br>
&nbsp;&nbsp;ok = true;<br>
<br>
// Code that may take some time<br>
...
<br>
// Using then() to display the result<br>
myPromise.then(<br>
&nbsp; function(value) {myDisplayer(value);},<br>
&nbsp; function(value) {myDisplayer(value);}<br>);<br>
</div>
...
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_promise_error">
Try it Yourself &raquo;</a></p>
</div>

<div class="ws-note">

<p>A promise represents a value that will be available later.</p>
<p>A promise is a container for a future result.</p>
<p>The result can be a value or an error.</p>
</div>

<hr>
<h2>The JavaScript Promise Object</h2>
<p>A Promise contains both the <b>producing code</b> and calls to the <b>consuming code</b>:</p>
<div class="w3-example">
...
<table class="ws-table-all">
<tr><th>When</th><th>Call</th></tr>
<tr><td>Success</td><td>resolve(value)</td></tr>
<tr><td>Error</td><td>reject(value)</td></tr>
</table>
<div class="ws-note">

<p>A promise can resolve or reject <b>only once</b>.</p>
</div>
...
<table class="ws-table-all">
<tr><th>myPromise.state</th><th>myPromise.result</th></tr>
...
<hr>
<h2>Core Methods and Usage</h2>
<p>Promises are consumed using methods attached to the promise object:</p>
<ul> 
<li><p><b>.then(onFulfilled, onRejected):</b><br>
This method attaches handlers for both the fulfillment and rejection cases.
It returns a new promise, which enables method chaining.</p></li>
<li><p><b>.catch(onRejected):</b><br>
This is a shorthand for .then(null, onRejected) and is typically used to handle
errors at the end of a promise chain.</p></li>
<li><p><b>.finally(onFinally):</b><br>
This handler is called when the promise is settled (either fulfilled or rejected),
regardless of the outcome. It's useful for cleanup operations.</p></li>
</ul>
<hr>
<h2>Using then and catch</h2>
<p>You do not read a promise result immediately.</p>
<p>You attach code that runs when the promise finishes.</p>

<p><code class="w3-codespan">then()</code> runs when a promise is fulfilled.</p>
<p><code class="w3-codespan">catch()</code> runs when a promise is rejected.</p>

<div class="w3-example">
<h3>Examples</h3>
<div class="w3-code notranslate jsHigh">
let promise = Promise.resolve("OK");<br><br>
promise<br>
...
Try it Yourself &raquo;</a></p>
<div class="w3-code notranslate jsHigh">
let promise = Promise.reject("Error");<br><br>
promise<br>
.then(function(value) {<br>
&nbsp;&nbsp;console.log(value);<br>
})<br>
...
<p>When a promise is fulfilled, the <code class="w3-codespan">then()</code> function runs.</p>
</div>

<hr>
<h2>Returning a Promise</h2>
<p>Promises become powerful when you <b>return a promise from <code class="w3-codespan">then()</code></b>.</p>
<p>This creates a clean chain.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Three functions to run in steps<br>
function step1() {<br>
&nbsp;&nbsp;return Promise.resolve("A");<br>
}<br>
function step2(value) {<br>
&nbsp;&nbsp;return Promise.resolve(value + "B");<br>
}<br>
function step3(value) {<br>
&nbsp;&nbsp;return Promise.resolve(value + "C");<br>
}<br><br>
// Run the three functions in steps<br>
step1()<br>
.then(function(value) {<br>
&nbsp;&nbsp;return step2(value);<br>
})<br>
.then(function(value) {<br>
&nbsp;&nbsp;return step3(value);<br>
})<br>
.then(function(value) {<br>
&nbsp;&nbsp;myDisplayer(value);<br>
});<br>
</div>
<p><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_promise_steps">
Try it Yourself &raquo;</a></p>
</div>

<div class="ws-note">

<p>The chain runs step by step as each promise finishes.</p>
</div>

<hr>
<h2>Where to Put catch</h2>
<p>You can handle errors at the end of the chain.</p>
<p>A single <code class="w3-codespan">catch()</code> can catch errors from any step above.</p>
...
<div class="ws-tip">
<p>This is one reason promises are easier than many nested callbacks.</p>
</div>
...
<p>Forgetting to return a promise breaks the chain.</p>
</div>
...
<p>The second <code class="w3-codespan">then()</code> runs too early.</p>
<p>It runs because nothing was returned from the first <code class="w3-codespan">then()</code>.</p>

<div class="ws-tip">
<p>If you start an async step in <code class="w3-codespan">then()</code>, return it.</p>
</div>

<hr>

<h2>Promises and Real JavaScript</h2>

<p>Many web APIs return promises.</p>
<p><code class="w3-codespan">fetch()</code> is a common example.</p>
...
<p>This is promise-based async programming.</p>
...
<h2>Promise API Static Methods</h2>
<p>JavaScript also provides static methods on the Promise object for handling multiple promises at once:</p> 
<ul>
<li><p><b>Promise.all(iterable):</b><br>
Fulfills when all promises in the iterable are fulfilled; rejects
immediately if any promise rejects.</p></li>
<li><p><b>Promise.allSettled(iterable):</b><br>
 Waits for all promises to settle (either fulfill or reject) and
returns an array of their results.</p></li>
<li><p><b>Promise.race(iterable):</b><br>
Settles (fulfills or rejects) as soon as any of the promises in the iterable settles.</p></li>
<li><p><b>Promise.any(iterable):</b><br>
Fulfills as soon as any promise in the iterable fulfills; rejects if all promises reject.</p></li>
</ul>
<div class="ws-note">
<h2>Learn More:</h2>
<p class="w3-large"><a href="js_promise_reference.asp">Full Promises Reference</a></p>
</div>
...
<div class="w3-code notranslate jsHigh">
setTimeout(function() { myFunction("I love You !!!"); }, 3000);<br>
<br>
...
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_callback9">Try it Yourself &raquo;</a>
</p>
</div>
<div class="w3-example">
...
<h3>Example using Callback</h3>
<div class="w3-code notranslate jsHigh">
function getFile(myCallback) {<br>
&nbsp; let req = new XMLHttpRequest();<br>
&nbsp; req.open('GET', &quot;mycar.html&quot;);<br>
&nbsp; req.onload = function() {<br>
&nbsp;&nbsp;&nbsp; if (req.status == 200) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; myCallback(req.responseText);<br>
&nbsp;&nbsp;&nbsp; } else {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; myCallback(&quot;Error: &quot; + req.status);<br>
&nbsp;&nbsp;&nbsp; }<br>
&nbsp; }<br>
&nbsp; req.send();<br>
}<br><br>
...
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_callback7">Try it Yourself &raquo;</a>
</p>
</div>
<!--stop-->
<!--start-->
...
let myPromise = new Promise(function(myResolve, myReject) {<br>
  ...
  req.onload = function() {<br>
    ...
    if (req.status == 200) {<br>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      myResolve(req.response);<br>
    &nbsp;&nbsp;&nbsp;
    } else {<br>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      myReject("File not Found");<br>
    &nbsp;&nbsp;&nbsp;
    }<br>
&nbsp; };<br>
&nbsp; req.send();<br>
...
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryjs_promise1">Try it Yourself &raquo;</a>
</p>
</div>
<!--stop-->
...
<div class="ws-note">
<h2>Next Chapter</h2>
<p>Promises work well, but chains can still become long.</p>
<p><code class="w3-codespan">async</code> and <code class="w3-codespan">await</code> let you write promise
code like normal code.</p>
<h4><a class="w3-btn w3-green" href="js_async_await.asp">JS Async &amp; Await</a></h4>
</div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="js_async_callbacks.asp">&#10094; Previous</a>
