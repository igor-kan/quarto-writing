...
ny:-->
    ...
    <h1>C <span class="color_h1">The sizeof Operator</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_data_types_dec.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_data_types_reallife.php">Next &#10095;</a>
</div>
<hr>

<!--start-->
<h2>Get the Memory Size</h2>
<p>We introduced in the <a href="c_data_types.php">data types chapter</a> that the memory size of a variable varies depending on the type:</p>
...
<p>The memory size refers to how much space a type occupies in the <em>computer's memory</em>.</p>
<p>To actually get the size (in bytes) of a data type or variable, use the <code class="w3-codespan">sizeof</code> operator:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  int myInt;<br>float myFloat;<br>double myDouble;<br>char myChar;<br>
  <br>printf(&quot;%zu\n&quot;, sizeof(myInt));<br>printf(&quot;%zu\n&quot;, sizeof(myFloat));<br>
  printf(&quot;%zu\n&quot;, sizeof(myDouble));<br>printf(&quot;%zu\n&quot;, sizeof(myChar));</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_sizeof">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
<p>
  Note that we use the <code class='w3-codespan'>%zu</code> format specifier to print the result, instead of <code class='w3-codespan'>%d</code>. This is because the compiler expects the <code class='w3-codespan'>sizeof</code> operator to return a value of type <code class='w3-codespan'>size_t</code>, which is an <a href="c_data_types_extended.php">unsigned integer type</a>. On some computers it might work with <code class='w3-codespan'>%d</code>, but it is safer and more portable to use <code class='w3-codespan'>%zu</code>, which is specifically designed for printing <code class='w3-codespan'>size_t</code> values.
</p>

<h4>Why Should I Know the Size of Data Types?</h4>
<p>Knowing the size of data types helps you understand how much memory your program uses.
This is important when writing larger programs or working with limited memory, because it can affect both performance and efficiency.</p>

<p>For example, the size of a <code class="w3-codespan">char</code> type is 1 byte. Which means if you have an array of 1000 <code class="w3-codespan">char</code> values, it will occupy 1000 bytes (1 KB) of memory.</p>
<p>Using the right data type for the right purpose will <strong>save memory</strong> and<strong> improve the performance</strong> of your program. </p>
<p>You will learn more about the <code class="w3-codespan">sizeof</code> operator later in this tutorial, and how to use it in different scenarios. </p>
</div>
<!--stop-->
...
<div id="exercisecontainer" src="xrcise_data_types_sizeof.js" data-extensions="php"></div>
<hr>
