<!DOCTYPE html>
<html lang="en-US">
<title>C Declare Multiple Variables</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>C <span class="color_h1">Declare Multiple Variables</span></h1>

<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_variables_change.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_variables_names.php">Next &#10095;</a>
</div>
<hr>

<!--start-->
<h2>Declare Multiple Variables</h2>

<p>To declare more than one variable of the same type, use a <strong>comma-separated</strong> list:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  int x = 5, y = 6, z = 50;<br>
  printf(&quot;%d&quot;, x + y + z);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_variables_multiple">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
<p><strong>Note:</strong> All variables must be of the same type. You cannot mix types in the same declaration.</p>
</div>

<p>You can also assign the <strong>same value</strong> to multiple variables at once:</p>
...
<div class="w3-code notranslate javaHigh">
  ...
  x = y = z = 50;<br>
  printf(&quot;%d&quot;, x + y + z);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_variables_multiple2">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
<p><strong>Tip:</strong> Declaring multiple variables on one line is convenient, but declaring them on separate lines can make your code easier to read.</p>
</div>
<!--stop-->
...
<div id="exercisecontainer" src="xrcise_variables_multiple.js" data-extensions="php"></div>
<hr>
