<!DOCTYPE html>
<html lang="en-US">
<title>Get Started with C</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>C <span class="color_h1">Get Started</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_intro.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_syntax.php">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>Get Started With C</h2>
<p>At W3Schools, you can start learning C without installing anything.</p>

<p>Our Online C Editor runs directly in your browser and shows both the code and the result:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="tryc.php?filename=demo_helloworld">Try it Yourself &raquo;</a>
</div>

<p>This editor will be used in the entire tutorial to demonstrate the different aspects of C.</p>
<!--stop-->
<hr>

<!--start-->
<h2>Install C</h2>
<p>If you want to run C programs on your own computer, you need two things:</p>

<ul>
  <li>A text editor to write C code</li>
  <li>A compiler to turn the C code into a program the computer can run</li>
</ul>

<p>The compiler reads your C code and translates it into machine code.</p>

<p>There are many editors and compilers available. To make things easier, most people use an <strong><i>IDE</i></strong>, which includes both.</p>
<!--stop-->
<hr>

<!--start-->
<h2>Install IDE</h2>
<p>An IDE (Integrated Development Environment) is a program that helps you write, compile, and run code.</p>

<p>Popular IDEs include Code::Blocks, Eclipse, and Visual Studio. These are free tools that can also help you find errors in your code.</p>

<p><strong>Note:</strong> Web-based IDEs can also work, but they often have limited features.</p>

<p>In this tutorial, we will use <strong>Code::Blocks</strong>, which is a good and simple choice for beginners.</p>

<p>You can download Code::Blocks from <a href="https://www.codeblocks.org/downloads/binaries/" target="_blank">https://www.codeblocks.org</a>.
Choose the <code class="w3-codespan">mingw-setup.exe</code> file, which includes both the editor and a compiler.</p>
<!--stop-->
...
<p>Write the following C code and save the file as <code class="w3-codespan">
myfirstprogram.c</code> (<strong>File &gt; Save File as</strong>):</p>
<div class="w3-example">
...
<p><strong>Note:</strong> C source files always end with <code class="w3-codespan">.c</code>.</p>

<p><strong>Don't worry</strong> if you don't understand the code above - we will discuss it in detail in later chapters. For now, focus on how to run the code.</p>

<p>In Codeblocks, it should look like this:</p>
<img src="codeblocks2020.png" style="width:100%;max-width:800px" class="w3-border">
...
<p>If you see the message above, your setup is working correctly.</p>

<p><strong>Congratulations</strong>! You have now written and executed your first C program.</p>
<!--stop-->

<div class="w3-panel ws-note">
<p><strong>What just happened?</strong> You wrote C code, the compiler turned it into a program, and the computer ran it. This is the basic workflow you will use throughout this tutorial.</p>
</div>
