<!DOCTYPE html>
<html lang="en-US">
<title>C Change Variable Values</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>C <span class="color_h1">Variable Values</span></h1>

<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_variables_format.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_variables_multiple.php">Next &#10095;</a>
</div>
<hr>

<!--start-->
<h2>Change Variable Values</h2>
<p>If you assign a new value to an existing variable, the new value will <strong>replace</strong> the old one:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  int myNum = 15;&nbsp;&nbsp;// myNum is 15<br>
  myNum = 10;&nbsp; // Now myNum is 10</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_variables_change">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
<p><strong>Note:</strong> This is normal and expected. Variables are meant to change while a program runs.</p>
</div>
...
<div class="w3-code notranslate javaHigh">
  int myNum = 15;<br><br>
  int myOtherNum = 23;<br><br>
  // Assign the value of myOtherNum (23) to myNum<br>
  myNum = myOtherNum;<br><br>
  // myNum is now 23 (was 15)<br>
  printf(&quot;%d&quot;, myNum);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_variables_change2">Try it Yourself &raquo;</a>
</div>

<p>You can even copy values into variables that were declared earlier without a value:</p>
...
<div class="w3-code notranslate javaHigh">
  ...
  int myNum = 15;<br><br>
  // Declare a variable without assigning a value<br>
  int myOtherNum;<br><br>
  // Copy the value from myNum<br>
  myOtherNum = myNum;<br><br>
  // myOtherNum is now 15<br>
  printf(&quot;%d&quot;, myOtherNum);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_variables_change3">Try it Yourself &raquo;</a>
</div>
<!--stop-->
...
<p>You can use mathematical operators to work with variables.</p>
<p>For example, to add one variable to another, use the <code class="w3-codespan">+</code> operator:</p>
...
<div class="w3-code notranslate javaHigh">
  ...
  int sum = x + y;<br>
  printf(&quot;%d&quot;, sum);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_variables_add">Try it Yourself &raquo;</a>
</div>

<p>You can also update a variable using its current value:</p>
...
<div class="w3-code notranslate javaHigh">
  ...
  x = x + 1;<br>
  printf(&quot;%d&quot;, x);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_variables_update">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
<p><strong>Tip:</strong> Writing <code class="w3-codespan">x = x + 1</code> means "take the current value of x and add 1 to it".</p>
<p><strong>Note:</strong> You will learn much more about <a href="c_operators.php">operators</a> in a later chapter.</p>
</div>
<!--stop-->
...
<div id="exercisecontainer" src="xrcise_variables_change.js" data-extensions="php"></div>
<hr>
