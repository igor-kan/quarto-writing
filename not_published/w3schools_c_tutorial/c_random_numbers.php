...
ny:-->
    ...
    <h1>C <span class="color_h1">Random Numbers</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_date_time.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_macros.php">Next &#10095;</a>
</div>
<hr>

<h2>Random Numbers</h2>

<p>In C, you can make random numbers with the <code class="w3-codespan">rand()</code> function, which is found in the <code class="w3-codespan">&lt;stdlib.h&gt;</code> library.</p>

<p>By default, <code class="w3-codespan">rand()</code> gives the same sequence of numbers each time you run the program.  
To get different results on every run, you can also use <code class="w3-codespan">srand()</code> to set a "starting point" (called a <em>seed</em>).  
Since you just learned about <a href="c_date_time.php">date and time</a>, you can now use the <em>current time</em> as the seed (because it is always changing).  
For this, you include <code class="w3-codespan">&lt;time.h&gt;</code> in your program.</p>

<hr>

<h2>Basic Random Number</h2>
<p>The function <code class="w3-codespan">rand()</code> returns a random integer.</p>
...
int main() {
  ...
  <p><a target="_blank" class="w3-btn" href="tryc.php?filename=demo_random_number">Try it Yourself &raquo;</a></p>
</div>

<div class="ws-note ws-panel">
  <p><strong>Note:</strong> If you run this program several times, you will see the <em>same</em> numbers each time. This is because we have not set a seed yet.</p>
</div>
<hr>

<h2>Seeding the Random Generator</h2>
<p>To get different numbers every time you run the program, you must give <code class="w3-codespan">rand()</code> a <em>starting point</em> (seed).</p>
<p>You do this with <code class="w3-codespan">srand()</code>. A common trick is to use the 
<a href="c_date_time.php"><strong>current time</strong></a> as the seed, because the time is always changing:</p>
...
int main() {
  ...
  <p><a target="_blank" class="w3-btn" href="tryc.php?filename=demo_random_number_seed">Try it Yourself &raquo;</a></p>
</div>

<div class="ws-note ws-panel">
  <p><strong>Tip:</strong> Call <code class="w3-codespan">srand()</code> only once, at the start of <code class="w3-codespan">main</code>. Do not call it again inside a loop.</p>
</div>
...
<h2>Random Number in a Range</h2>
<p>Often you want numbers in a smaller range, like 0 to 9.  
You can do this by using the modulo operator <code class="w3-codespan">%</code>:</p>
...
int main() {
  ...
  <p><a target="_blank" class="w3-btn" href="tryc.php?filename=demo_random_number_range">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Real-Life Example: Rolling Dice</h2>
