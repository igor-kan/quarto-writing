<!DOCTYPE html>
<html lang="en-US">
<title>C Function Recursions</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>C <span class="color_h1">Recursion</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_functions_inline.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_functions_pointers.php">Next &#10095;</a>
</div>
<hr>
...
<pre class="language-c w3-white"><code>int sum(int k);
...
<p><a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_functions_recursion"><strong>Try it Yourself &raquo;</strong></a></p>
</div>
...
<div class="w3-example">
<h3>Example</h3>
<p>Use recursion to count down from 5:</p>
<pre class="language-c w3-white"><code>void countdown(int n);
...
<p><a target="_blank" class="w3-btn" href="tryc.php?filename=demo_functions_recursion_countdown"><strong>Try it Yourself &raquo;</strong></a></p>
</div>

<p>The function calls itself with <code class="w3-codespan">n - 1</code> until <code class="w3-codespan">n</code> becomes <code class="w3-codespan">0</code>.</p>
<hr>

<h2>Calculate Factorial with Recursion</h2>
<p>This example uses a recursive function to calculate the factorial of 5:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-c w3-white"><code>int factorial(int n);
...
<p><a target="_blank" class="w3-btn" href="tryc.php?filename=demo_functions_recursion_factorial"><strong>Try it Yourself &raquo;</strong></a></p>
</div>

<div class="ws-note ws-panel">
<p><b>Factorial</b> means multiplying a number by every number below it, down to 1.  
For example, the factorial of 5 is: 5 * 4 * 3 * 2 * 1 = 120.  
By definition, <code class="w3-codespan">0!</code> is also 1.</p>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_functions_recursion.js" data-extensions="php"></div>
<hr>
