<!DOCTYPE html>
<html lang="en-US">
<title>C Real-Life If Else Examples</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>C <span class="color_h1">If ... Else Examples</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_conditions_logical.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_challenges_conditions.php">Next &#10095;</a>
</div>
<hr>

<!--start-->
<h2>Real-Life Examples</h2>
<p>This example shows how you can use <code class="w3-codespan">if..else</code> to "open a door" if the user enters the correct code:</p>
...
<p>This example shows how you can use <code class="w3-codespan">if..else</code> 
to find out if a number is positive or negative:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
...
<p>Find out if a person is old enough to vote, <strong>and </strong>if they are a citizen (using nested if statements):</p>
<div class="w3-example">
<h3>Example</h3>
...
<p>
<a target="_blank" class="w3-btn" href="tryc.php?filename=demo_if_nested_voting">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>Check temperature (Celsius):</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  int temperature = 30;<br><br>if (temperature &lt; 0) {<br>&nbsp; printf(&quot;It's 
  freezing!\n&quot;);<br>} else if (temperature &lt; 20) {<br>&nbsp; printf(&quot;It's 
  cool.\n&quot;);<br>} else {<br>&nbsp; printf(&quot;It's warm.\n&quot;);<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_if_temp">Try it Yourself &raquo;</a>
</div>

<p>System access control example - You must be logged in, and then you either need to be an admin, or have a high security clearance (level 1 or 2) to get access:</p>
<div class="w3-example">
<h3>Example</h3>
