<!DOCTYPE html>
<html lang="en-US">
<title>C Fixed Width Integers</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>C <span class="color_h1">Fixed Width Integers</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_bitwise_operators.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_projects.php">Next &#10095;</a>
</div>
<hr>

<h2>Fixed-Width Integers</h2>

<p>In C, the size of <code class="w3-codespan">int</code>, <code class="w3-codespan">short</code>, and <code class="w3-codespan">long</code> types can vary depending on your computer and system.  
For example, an <code class="w3-codespan">int</code> might take up 2 bytes on one system, and 4 bytes on another.</p>

<p>To make programs behave the same everywhere, C provides <b>fixed-width integer types</b> in the <code class="w3-codespan">&lt;stdint.h&gt;</code> header.  
These types always have the same size (number of bits), no matter which computer you are on.</p>


<p>The most common fixed-width types are:</p>
...
<tr>
  ...
  <th>Size</th>
  <th>Range</th>
  <th>Printf Specifier</th>
</tr>
<tr>
  <td><code class="w3-codespan">int8_t</code></td>
  <td>8 bits (1 byte)</td>
  <td>-128 to 127</td>
  <td><code class="w3-codespan">%d</code></td>
</tr>
<tr>
  <td><code class="w3-codespan">uint8_t</code></td>
  <td>8 bits (1 byte)</td>
  <td>0 to 255</td>
  <td><code class="w3-codespan">%u</code></td>
</tr>
<tr>
  <td><code class="w3-codespan">int16_t</code></td>
  <td>16 bits (2 bytes)</td>
  <td>-32,768 to 32,767</td>
  <td><code class="w3-codespan">%d</code></td>
</tr>
<tr>
  <td><code class="w3-codespan">uint16_t</code></td>
  <td>16 bits (2 bytes)</td>
  <td>0 to 65,535</td>
  <td><code class="w3-codespan">%u</code></td>
</tr>
<tr>
  <td><code class="w3-codespan">int32_t</code></td>
  <td>32 bits (4 bytes)</td>
  <td>-2,147,483,648 to 2,147,483,647</td>
  <td><code class="w3-codespan">%d</code></td>
</tr>
<tr>
  <td><code class="w3-codespan">uint32_t</code></td>
  <td>32 bits (4 bytes)</td>
  <td>0 to 4,294,967,295</td>
  <td><code class="w3-codespan">%u</code></td>
</tr>
<tr>
  <td><code class="w3-codespan">int64_t</code></td>
  <td>64 bits (8 bytes)</td>
  <td>-9,223,372,036,854,775,808 to 9,223,372,036,854,775,807</td>
  <td><code class="w3-codespan">%lld</code></td>
</tr>
<tr>
  <td><code class="w3-codespan">uint64_t</code></td>
  <td>64 bits (8 bytes)</td>
...
<p>
The letter <code class="w3-codespan">u</code> stands for <b>unsigned</b>, which means the type can only store 
<b>non-negative values</b> (0 and up).  
...
<h2>Using Fixed-Width Integers</h2>
...
<p><a target="_blank" class="w3-btn" href="tryc.php?filename=demo_fixedwidth"><strong>Try it Yourself &raquo;</strong></a></p>
</div>

<hr>

<h2>When to Use Fixed-Width Integers?</h2>

<p>For most everyday programs, you don't need these types - a normal  
<code class="w3-codespan">int</code> is usually fine.</p>

<p>But fixed-width integers are <b>essential</b> when:</p>
<ul>
  <li>You are writing <b>embedded systems</b> (programs for small devices, like microcontrollers).</li>
  <li>You are working with <b>file formats</b> where exact sizes matter.</li>
  <li>You are sending data across <b>networks</b> and need consistent results on different machines.</li>
</ul>
<hr>

<h2>Real Life Example</h2>

<p>Imagine you are building a program that shows the battery level of a device.  
Since the battery percentage will always be between 0 and 100, you don't need a large type like <code class="w3-codespan">int</code>.  
Instead, you can use <code class="w3-codespan">uint8_t</code>, which is exactly 1 byte (8 bits) and can store values from 0 to 255:</p>
...
<p><a target="_blank" class="w3-btn" href="tryc.php?filename=demo_fixedwidth_battery"><strong>Try it Yourself &raquo;</strong></a></p>
</div>

<p>Here we save memory by using a <code class="w3-codespan">uint8_t</code>, which is perfect for storing values in a small, well-defined range like a battery percentage.</p>
<hr>
