...
ny:-->
    ...
    <h1>C <span class="color_h1">Bitwise Operators</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_storage_classes.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_fixed_width_ints.php">Next &#10095;</a>
</div>
<hr>

<h2>C Bitwise Operators</h2>

<p><strong>Note:</strong> This is a more <em>advanced</em> topic in C.  
If you are new to programming, don't worry if it feels tricky at first - bitwise operators are mainly used in special cases like system programming, hardware control, or performance optimizations.</p>

<p>In C, <strong>bitwise operators</strong> let you work directly with the <em>bits</em> (the 1s and 0s) that make up numbers in binary form.</p>

<p>Every integer in a computer is stored in <strong>binary</strong>, which means it is represented using bits (binary digits) that are either 0 or 1.  
Bitwise operators allow you to compare, combine, shift, or flip these bits.</p>

<div class="ws-note ws-panel">
  <p><strong>Note:</strong> Bitwise operations only work on integer types (such as <code class="w3-codespan">int</code>, <code class="w3-codespan">char</code>, or <code class="w3-codespan">long</code>).</p>
  <p><strong>Tip:</strong> If you are not yet familiar with binary numbers, check out these pages first:</p>
  <ul>
    <li><a href="https://www.w3schools.com/programming/prog_binary_numbers.php" target="_blank">Intro to Programming - Binary Numbers</a></li>
    <li><a href="https://www.w3schools.com/programming/prog_bits_and_bytes.php" target="_blank">Intro to Programming - Bits and Bytes</a></li>
  </ul>
</div>
...
<table class="ws-table-all">
  ...
  <tr><td>|</td><td>OR</td><td>Sets each bit to 1 if at least one of the bits is 1</td></tr>
  <tr><td>^</td><td>XOR</td><td>Sets each bit to 1 if only one of the bits is 1</td></tr>
  <tr><td>~</td><td>NOT</td><td>Inverts all the bits</td></tr>
  <tr><td>&lt;&lt;</td><td>Left Shift</td><td>Shifts bits to the left (multiplies by powers of 2)</td></tr>
  <tr><td>&gt;&gt;</td><td>Right Shift</td><td>Shifts bits to the right (divides by powers of 2)</td></tr>
</table>
...
<p>Let's start with two integers:</p>

<pre class="language-c notranslate"><code>int a = 6;  // 0110 in binary
int b = 3;  // 0011 in binary</code></pre>

<p>Here's how different bitwise operators work on these values:</p>

<table class="ws-table-all">
  <tr><th>Operation</th><th>Binary Result</th><th>Decimal Result</th></tr>
  <tr><td>a &amp; b</td><td>0010</td><td>2</td></tr>
  <tr><td>a | b</td><td>0111</td><td>7</td></tr>
  <tr><td>a ^ b</td><td>0101</td><td>5</td></tr>
  <tr><td>~a</td><td>...1001</td><td>-7 (on most systems)</td></tr>
  <tr><td>a &lt;&lt; 1</td><td>1100</td><td>12</td></tr>
  <tr><td>a &gt;&gt; 1</td><td>0011</td><td>3</td></tr>
</table>
...
<h2>Decimal and Binary Values</h2>

<p>Here is a small reference table showing how decimal numbers look in binary (16-bit format):</p>
...
<div class="ws-note ws-panel">
  <p><strong>Tip:</strong> Each step to the left doubles the value. For example, <code>0000000000000100</code> is 4 because the third bit from the right is set (2<sup>2</sup> = 4).</p>
</div>
...
<p>The <code class="w3-codespan">&amp;</code> operator compares each bit and returns 1 only if both bits are 1.</p>

<div class="w3-example">
  <h4>Example</h4>
  <pre class="language-c notranslate"><code>int a = 6;   // 0110
int b = 3;   // 0011

int result = a &amp; b;
printf("Result: %d\n", result); // 2 (0010)</code></pre>
  <p><a target="_blank" class="w3-btn" href="tryc.php?filename=demo_bitwise_and">Try it Yourself &raquo;</a></p>
</div>
...
<p>The <code class="w3-codespan">|</code> operator sets a bit to 1 if either bit is 1.</p>
...
int result = a | b;
printf("Result: %d\n", result); // 7 (0111)</code></pre>
  <p><a target="_blank" class="w3-btn" href="tryc.php?filename=demo_bitwise_or">Try it Yourself &raquo;</a></p>
</div>
...
<p>The <code class="w3-codespan">^</code> operator returns 1 only when the bits are different.</p>
...
int result = a ^ b;
printf("Result: %d\n", result); // 5 (0101)</code></pre>
  <p><a target="_blank" class="w3-btn" href="tryc.php?filename=demo_bitwise_xor">Try it Yourself &raquo;</a></p>
</div>
...
<p>The <code class="w3-codespan">~</code> operator inverts each bit (0 becomes 1 and 1 becomes 0).</p>

<div class="w3-example">
  <h4>Example</h4>
  <pre class="language-c notranslate"><code>int a = 5; // 00000101

int result = ~a;
printf("Result: %d\n", result); // -6 on most systems</code></pre>
  <p><a target="_blank" class="w3-btn" href="tryc.php?filename=demo_bitwise_not">Try it Yourself &raquo;</a></p>
</div>

<div class="ws-note ws-panel">
  <p><strong>Note:</strong> The result of <code class="w3-codespan">~</code> depends on how negative numbers are stored (usually two's complement). For example, <code>5 (00000101)</code> becomes <code>11111010</code>, which is interpreted as <code>-6</code>.</p>
</div>
...
<p>The <code class="w3-codespan">&lt;&lt;</code> operator shifts bits to the left and fills in 0s on the right. This is the same as multiplying by powers of 2.</p>

<div class="w3-example">
  <h4>Example</h4>
  <pre class="language-c notranslate"><code>int a = 3; // 00000011

int result = a &lt;&lt; 2;
printf("Result: %d\n", result); // 12 (3 * 2^2)</code></pre>
  <p><a target="_blank" class="w3-btn" href="tryc.php?filename=demo_bitwise_leftshift">Try it Yourself &raquo;</a></p>
</div>
...
<p>The <code class="w3-codespan">&gt;&gt;</code> operator shifts bits to the right. This is the same as dividing by powers of 2. On signed integers, the sign bit may be preserved depending on the system.</p>

<div class="w3-example">
  <h4>Example</h4>
  <pre class="language-c notranslate"><code>int a = 12; // 00001100

int result = a &gt;&gt; 2;
printf("Result: %d\n", result); // 3 (12 / 2^2)</code></pre>
  <p><a target="_blank" class="w3-btn" href="tryc.php?filename=demo_bitwise_rightshift">Try it Yourself &raquo;</a></p>
</div>

<hr>

<h2>Real-Life Example: Flags and Permissions</h2>

<p>Bitwise operators are often used to store multiple options in a single integer, using <em>flags</em>.</p>

<div class="w3-example">
  <h4>Example</h4>
  <pre class="language-c notranslate"><code>#define READ  1  // 0001
#define WRITE 2  // 0010
#define EXEC  4  // 0100
...
if (permissions & EXEC) {
  ...
  <p><a target="_blank" class="w3-btn" href="tryc.php?filename=demo_bitwise_flags">Try it Yourself &raquo;</a></p>
</div>

<p>In this example, the user has both <code>READ</code> and <code>WRITE</code> permissions, but not <code>EXEC</code>.</p>
...
<ul>
  <li>Bitwise operators work on individual bits of integers</li>
  <li><code class="w3-codespan">&amp;</code>: AND - both bits must be 1</li>
  <li><code class="w3-codespan">|</code>: OR - either bit can be 1</li>
  <li><code class="w3-codespan">^</code>: XOR - only one bit is 1</li>
  <li><code class="w3-codespan">~</code>: NOT - flips all bits</li>
  <li><code class="w3-codespan">&lt;&lt;</code>: Left shift - multiplies by powers of 2</li>
  <li><code class="w3-codespan">&gt;&gt;</code>: Right shift - divides by powers of 2</li>
</ul>

<div class="ws-note ws-panel">
  <p><strong>Tip:</strong> Bitwise operations are useful for optimization, low-level hardware access, flags, and masks.</p>
</div>
<hr>
