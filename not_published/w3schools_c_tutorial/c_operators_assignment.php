<!DOCTYPE html>
<html lang="en-US">
<title>C Assignment Operators</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>C <span class="color_h1">Assignment Operators</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_operators_arithmetic.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_operators_comparison.php">Next &#10095;</a>
</div>
<hr>
...
int x = 10;</div>
<a class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_oper_assignment1" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate javaHigh">
int x = 10;<br>x += 5;</div>
<a class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_oper_assignment2" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<td>x = 5</td>
<td>x = 5</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryc.php?filename=demo_oper_ass1">Try it &raquo;</a></td>
</tr>
  <tr>
<td>+=</td>
<td>x += 3</td>
<td>x = x + 3</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryc.php?filename=demo_oper_ass2">Try it &raquo;</a></td>
  </tr>
  <tr>
<td>-=</td>
<td>x -= 3</td>
<td>x = x - 3</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryc.php?filename=demo_oper_ass3">Try it &raquo;</a></td>
  </tr>
  <tr>
<td>*=</td>
<td>x *= 3</td>
<td>x = x * 3</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryc.php?filename=demo_oper_ass4">Try it &raquo;</a></td>
  </tr>
  <tr>
<td>/=</td>
<td>x /= 3</td>
<td>x = x / 3</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryc.php?filename=demo_oper_ass5">Try it &raquo;</a></td>
  </tr>
  <tr>
<td>%=</td>
<td>x %= 3</td>
<td>x = x % 3</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryc.php?filename=demo_oper_ass6">Try it &raquo;</a></td>
  </tr>
  <tr>
<td>&amp;=</td>
<td>x &amp;= 3</td>
<td>x = x &amp; 3</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryc.php?filename=demo_oper_ass7">Try it &raquo;</a></td>
  </tr>
  <tr>
<td>|=</td>
<td>x |= 3</td>
<td>x = x | 3</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryc.php?filename=demo_oper_ass8">Try it &raquo;</a></td>
  </tr>
<tr>
<td>^=</td>
<td>x ^= 3</td>
<td>x = x ^ 3</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryc.php?filename=demo_oper_ass9">Try it &raquo;</a></td>
</tr>
<tr>
<td>&gt;&gt;=</td>
<td>x &gt;&gt;= 3</td>
<td>x = x &gt;&gt; 3</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryc.php?filename=demo_oper_ass10">Try it &raquo;</a></td>
</tr>
<tr>
<td>&lt;&lt;=</td>
<td>x &lt;&lt;= 3</td>
<td>x = x &lt;&lt; 3</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryc.php?filename=demo_oper_ass11">Try it &raquo;</a></td>
</tr>
</table>
</div>
<!--stop-->
...
<p><strong>Note:</strong> Most assignment operators are just shorter ways of writing code.  
For example, <code class="w3-codespan">x += 5</code> is the same as <code class="w3-codespan">x = x + 5</code>, but shorter and often easier to read.</p>
</div>
...
<h2>Real-Life Example: Tracking Savings</h2>
<p>Assignment operators can also be used in real-life scenarios.  
For example, you can use the <code class="w3-codespan">+=</code> operator to keep track of savings when you add money to an account:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-c w3-white"><code>int savings = 100; 
savings += 50; // add 50 to savings

printf("Total savings: %d\n", savings);
</code></pre>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_operators_tracking_savings">Try it Yourself &raquo;</a>
</div>
<hr>
