...
ny:-->
    ...
    <h1>C <span class="color_h1">Character Data Types</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_data_types.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_data_types_numbers.php">Next &#10095;</a>
</div>
<hr>
...
<strong>single </strong>character.</p>
<p>The character must be surrounded by single quotes, like 'A' or 'c', and we use the <code class="w3-codespan">%c</code> format specifier to print it:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  char myGrade = 'A';<br>
  printf(&quot;%c&quot;, myGrade);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_data_types_characters">Try it Yourself &raquo;</a>
</div>

<p>Alternatively, if you are familiar with ASCII, you can use ASCII values to display certain characters. Note that these values are not surrounded by quotes (<code class="w3-codespan">''</code>), 
as they are numbers:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  char a = 65, b = 66, c = 67;<br>
  printf(&quot;%c&quot;, a);<br>printf(&quot;%c&quot;, b);<br>printf(&quot;%c&quot;, c);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_data_types_characters_ascii">Try it Yourself &raquo;</a>
</div>
<p><strong>Tip:</strong> A list of all ASCII values can be found in our <a target="_blank" href="https://www.w3schools.com/charsets/ref_html_ascii.asp">ASCII Table Reference</a>.</p>
<!--stop-->
<hr>

<!--start-->
<h2>Notes on Characters</h2>
<p>If you try to store more than a single character, it will only print the last 
character:</p>

<div class="w3-example w3-pale-red">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh w3-border-red">
  char myText = 'Hello';<br>
  printf(&quot;%c&quot;, myText);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_data_types_characters_multi">Try it Yourself &raquo;</a>
</div>

<div class="ws-warning w3-panel">
<p><strong>Note:</strong> Don't use the <code class="w3-codespan">char</code> type for storing multiple 
characters, as it may produce errors.</p>
</div>
<p>To store multiple characters (or whole words), use <a href="c_strings.php">strings</a> (which you will learn more about in a later chapter):</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  char myText[] = &quot;Hello&quot;;<br>printf(&quot;%s&quot;, myText);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_data_types_characters_s">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
<p>For now, just know that we use strings for storing multiple characters/text, and the char type for single characters.</p>
</div>
<!--stop-->
...
<div id="exercisecontainer" src="xrcise_data_types_characters.js" data-extensions="php"></div>
<hr>
