...
ny:-->
    ...
    <h1>C <span class="color_h1">Operator Precedence</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_operators_logical.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_challenges_operators.php">Next &#10095;</a>
</div>
<hr>

<h2>Operator Precedence</h2>
<p>When a calculation contains more than one operator, C follows <strong>order of operations</strong> rules to decide which part to calculate first.</p>
<p>For example, multiplication happens before addition:</p>

<div class="w3-example">
  <h3>Example</h3>
  <pre class="language-c w3-white"><code>int result1 = 2 + 3 * 4;     // 2 + 12 = 14
int result2 = (2 + 3) * 4;   // 5 * 4 = 20

printf("%d\n", result1);
printf("%d\n", result2);
</code></pre>
  <p><a target="_blank" class="w3-btn" href="tryc.php?filename=demo_oper_precedence">Try it Yourself &raquo;</a></p>
</div>

<h3>Why Does This Happen?</h3>
<p>In <code class="w3-codespan">2 + 3 * 4</code>, the multiplication is done first, so the answer is <code class="w3-codespan">14</code>.</p>
<p>If you want the addition to happen first, you must use parentheses: <code class="w3-codespan">(2 + 3) * 4</code>, which gives <code class="w3-codespan">20</code>.</p>

<div class="ws-note ws-panel">
<p><strong>Tip:</strong> Always use parentheses <code class="w3-codespan">( )</code> if you want to make sure the calculation is done in the order you expect. It also makes your code easier to read.</p>
</div>
...
<ul>
  <li><code class="w3-codespan">()</code> - Parentheses</li>
  <li><code class="w3-codespan">*</code>, <code class="w3-codespan">/</code>, <code class="w3-codespan">%</code> - Multiplication, Division, Modulus</li>
  <li><code class="w3-codespan">+</code>, <code class="w3-codespan">-</code> - Addition, Subtraction</li>
  <li><code class="w3-codespan">&gt;</code>, <code class="w3-codespan">&lt;</code>, <code class="w3-codespan">&gt;=</code>, <code class="w3-codespan">&lt;=</code> - Comparison</li>
  <li><code class="w3-codespan">==</code>, <code class="w3-codespan">!=</code> - Equality</li>
  <li><code class="w3-codespan">&amp;&amp;</code> - Logical AND</li>
  <li><code class="w3-codespan">||</code> - Logical OR</li>
  <li><code class="w3-codespan">=</code> - Assignment</li>
</ul>

<hr>

<h2>Another Example</h2>
<p>Subtraction and addition are done from left to right, unless you add parentheses:</p>

<div class="w3-example">
  <h3>Example</h3>
  <pre class="language-c w3-white"><code>int result1 = 10 - 2 + 5;    // (10 - 2) + 5 = 13
int result2 = 10 - (2 + 5);  // 10 - 7 = 3

printf("%d\n", result1);
printf("%d\n", result2);
</code></pre>
<p><a target="_blank" class="w3-btn" href="tryc.php?filename=demo_oper_precedence2">Try it Yourself &raquo;</a></p>
</div>

<div class="ws-note ws-panel">
<p><strong>Remember:</strong> Parentheses always come first. Use them to control the order of your calculations.</p>
</div>
...
<div id="exercisecontainer" src="xrcise_operators.js" data-extensions="php"></div>
<hr>
