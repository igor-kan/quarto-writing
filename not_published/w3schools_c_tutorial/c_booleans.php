...
ny:-->
    ...
    <h1>C <span class="color_h1">Booleans</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_challenges_operators.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_booleans_reallife.php">Next &#10095;</a>
</div>
<hr>
...
<p>For this, C has a <code class="w3-codespan">bool</code> data type, which is known as <strong>booleans</strong>.</p>
...
<p>In C, the <code class="w3-codespan">bool</code> type is not a built-in data type, like <code class="w3-codespan">int</code> or <code class="w3-codespan">char</code>.</p>
<p>It was introduced in C99, and you must <strong>include</strong> the following header file to use it:</p>
...
<p>
A boolean variable is declared with the <code class="w3-codespan">bool</code> keyword and can take the
values <code class="w3-codespan">true</code> or <code class="w3-codespan">false</code>:
</p>
...
<p>Before trying to print the boolean variables, you should know that boolean values are returned as <strong>integers</strong>:</p> <ul> <li><code class="w3-codespan">1</code> (or any other number that is not 0) represents <code class="w3-codespan">true</code></li> <li><code class="w3-codespan">0</code> represents <code class="w3-codespan">false</code></li> </ul>

<p>Therefore, you can use the <code class="w3-codespan">%d</code> format specifier to print a boolean value:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  // Create boolean variables<br>
  bool isProgrammingFun = true;<br>
  bool isFishTasty = false;<br><br>

  // Print boolean values<br>
  printf("%d", isProgrammingFun);&nbsp;&nbsp;&nbsp;// Prints 1 (true)<br>
  printf("%d", isFishTasty);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Prints 0 (false)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_boolean">Try it Yourself &raquo;</a>
</div>

<p>However, it is more common to get boolean values by <strong>comparing</strong> values and variables.</p>
<!--stop-->
...
<!--start-->
<h2>Comparing Values and Variables</h2>

<p>Comparing values are useful in programming, because they help us to find answers and make decisions.</p>
<p>
For example, you can use a <a href="c_operators.php">comparison operator</a>,
such as the <strong>greater than</strong> (<code class="w3-codespan">&gt;</code>)
...
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  printf("%d", 10 &gt; 9);&nbsp; // Prints 1 (true), because 10 is greater than 9
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_boolean2">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
<p>In C, comparisons return <code class="w3-codespan">1</code> (true) or <code class="w3-codespan">0</code> (false).</p>
</div>

<p>You can also compare two variables:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  int x = 10;<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_boolean3">Try it Yourself &raquo;</a>
</div>

<p>
In the example below, we use the <strong>equal to</strong> (<code class="w3-codespan">==</code>)
...
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  printf("%d", 10 == 10); // Prints 1 (true), because 10 is equal to 10<br>
  printf("%d", 10 == 15); // Prints 0 (false), because 10 is not equal to 15<br>
  printf("%d", 5 == 55);&nbsp; // Prints 0 (false), because 5 is not equal to 55
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_boolean4">Try it Yourself &raquo;</a>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  bool isHamburgerTasty = true;<br>
  bool isPizzaTasty = true;<br><br>

  // Find out if both hamburger and pizza are tasty<br>
  printf("%d", isHamburgerTasty == isPizzaTasty);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_boolean_compare">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
<p>Remember to include the <code class="w3-codespan">&lt;stdbool.h&gt;</code> header file when working with <code class="w3-codespan">bool</code> variables.</p>
</div>
<!--stop-->
...
<p>
You can also store the result of a comparison in a <code class="w3-codespan">bool</code> 
variable:</p>
...
<div class="w3-code notranslate javaHigh">
  ...
  bool isGreater = x &gt; y;<br><br>

  printf("%d", isGreater); // Prints 1 (true)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_boolean_store">
...
<p>
<strong>Note:</strong> It is up to you whether you store the result of a comparison in a boolean variable
or use the comparison directly.<br>
Storing the result can make your code easier to read, especially if you want to reuse it.</p>
</div>

<hr>

<div id="exercisecontainer" src="xrcise_booleans.js" data-extensions="php"></div>
<hr>
