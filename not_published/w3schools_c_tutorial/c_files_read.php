...
<a class="w3-left w3-btn" href="c_files_write.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_structs.php">Next &#10095;</a>
</div>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="/cpp/showcpp.asp?filename=c_demo_files_read">Run example &raquo;</a>
</div>
...
<p>To read every line of the file, you can use a <code class="w3-codespan"><a href="c_while_loop.php">while</a></code> loop:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="/cpp/showcpp.asp?filename=c_demo_files_read_while">Run example &raquo;</a>
</div>
<!--stop-->
...
<h2>Good Practice</h2>
<p>If you try to open a file for reading that does not exist, the <code class="w3-codespan">fopen()</code> function will return <code class="w3-codespan"><a href="c_null.php">NULL</a></code>. </p>
<p><strong>Tip:</strong> As a good practice, we can use an <code class="w3-codespan"><a href="c_conditions.php">if</a></code> statement to test for <code class="w3-codespan">NULL</code>, 
...
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="/cpp/showcpp.asp?filename=c_demo_files_null">Run example &raquo;</a>
</div>
...
<div class="w3-example">
  ...
  <div class="ws-black w3-padding">
   <p><code>Hello World!<br>
Hi everybody!</code></p> </div>
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="/cpp/showcpp.asp?filename=c_demo_files_null2">Run example &raquo;</a>
</div>

<p><strong>Note:</strong> You will learn more about <code class="w3-codespan">NULL</code> in our <a href="c_null.php">NULL chapter</a>.</p>
<!--stop-->

<hr>
<div id="exercisecontainer" src="xrcise_files_read.js" data-extensions="php"></div>
<hr>
