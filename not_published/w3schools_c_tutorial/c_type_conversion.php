<!DOCTYPE html>
<html lang="en-US">
<title>C Data Type Conversion</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>C <span class="color_h1">Type Conversion</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_challenges_data_types.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_constants.php">Next &#10095;</a>
</div>
<hr>

<!--start-->
<h2>Type Conversion</h2>
<p>Sometimes, you have to convert the value of one <a href="c_data_types.php">data type</a> to another 
type. This is known as <strong>type conversion</strong>.</p>
<p>For example, if you try to divide two integers, <code class="w3-codespan">5</code> by <code class="w3-codespan">2</code>, you 
would 
expect the result to be <code class="w3-codespan">2.5</code>. But since we are 
working with integers (and not floating-point values), the following example will just output <code class="w3-codespan">2</code>:</p>
<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    int x = 5;<br>int y = 2;<br>int sum = 5 / 2;<br><br>printf(&quot;%d&quot;, 
    sum);&nbsp;// Outputs 2</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_type_conversion">Try it Yourself &raquo;</a>
</div>
<p>To get the right result, you need to know how <strong>type conversion</strong> 
works.</p>

<p>There are two types of conversion in C:</p>

<ul>
<li><strong>Implicit Conversion</strong> (automatically)
<br>
<li><strong>Explicit Conversion</strong> (manually)</li>
</ul>
<!--stop-->
<hr>
...
<p>Implicit conversion is done automatically by the compiler when you assign a 
value of one type to another.</p>
<p>For example, if you assign an <code class="w3-codespan">int</code> value to a <code class="w3-codespan">
float</code> type:</p>
<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    // Automatic conversion: int to float<br>float myFloat = 9;<br><br>printf(&quot;%f&quot;, 
  myFloat);&nbsp;// 9.000000</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_type_conversion_auto">Try it Yourself &raquo;</a>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  int myInt = 9;<br>float myFloat 
  = myInt;&nbsp; // Automatic conversion: int to float<br><br>printf(&quot;%f&quot;, 
  myFloat);&nbsp; // 9.000000</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_type_conversion_auto">Try it Yourself &raquo;</a>
</div>
-->
...
<p>As you can see, the compiler automatically converts the int value <code class="w3-codespan">9</code> to a 
float value of <code class="w3-codespan">9.000000</code>. </p>
<p>This can be risky, as you might lose control over specific values in 
certain situations. </p>
<p>Especially if it was the other way around - the following example 
automatically converts the float value <code class="w3-codespan">9.99</code> to an int value of <code class="w3-codespan">9</code>:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  // Automatic conversion: float to int<br>int myInt = 9.99;<br><br>printf(&quot;%d&quot;, 
  myInt); // 9</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_type_conversion_auto2">Try it Yourself &raquo;</a>
</div>

<p>What happened to <code class="w3-codespan">.99</code>? We might want that 
data in our program! 
So be careful. It is important that you know how the compiler work in these situations, to 
avoid unexpected results.</p>

<p>As another example, if you divide two integers: <code class="w3-codespan">5</code> by <code class="w3-codespan">2</code>, 
you know that the sum is <code class="w3-codespan">2.5</code>. And as you know from the beginning 
of this page, if you store the sum as an integer, the result will 
only display the number 
<code class="w3-codespan">2</code>. Therefore, it would be better to store the sum 
as a 
<code class="w3-codespan">float</code> or a <code class="w3-codespan">double</code>, right?</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  float sum = 5 / 2;<br><br>
  printf(&quot;%f&quot;, sum);&nbsp;// 2.000000</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_type_conversion_auto3">Try it Yourself &raquo;</a>
</div>

<p>Why is the result <code class="w3-codespan">2.00000</code> and not <code class="w3-codespan">2.5</code>? Well, it is because 
5 and 2 are still integers in the division. 
In this case, you need to manually convert the integer values to 
floating-point values. (see below).</p>
<!--stop-->
...
<p>Explicit conversion is done manually by placing the type in parentheses <code class="w3-codespan">()</code> 
in front of the value.</p>
<p>Considering our problem from the example above, we can now get the right 
result:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  // Manual conversion: int to float<br>float sum = (float) 5 / 2;<br><br>printf(&quot;%f&quot;, 
  sum); // 2.500000</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_type_conversion_man">Try it Yourself &raquo;</a>
</div>

<p>You can also place the type in front of a variable:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  int num1 = 5;<br>int num2 = 2;<br>float sum = (float) num1 / num2;<br><br>printf(&quot;%f&quot;, 
  sum); // 2.500000</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_type_conversion_man2">Try it Yourself &raquo;</a>
</div>

<p>And since you learned about &quot;<a href="c_data_types_dec.php">decimal precision</a>&quot; in a previous chapter, 
you could make the output even cleaner by removing the extra zeros (if you 
like):</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  int num1 = 5;<br>int num2 = 2;<br>float sum = (float) num1 / num2;<br><br>printf(&quot;%.1f&quot;, 
  sum); // 2.5</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_type_conversion_dec">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<p>Here's a real-life example of data types and type conversion where we create a program to calculate the percentage of a user's score in relation to the maximum score in a game:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  ...
  available score. <br>Convert userScore to float to make sure that the division 
  is accurate */<br>float percentage = (float) userScore / maxScore * 100.0;<br>
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_type_conversion.js" data-extensions="php"></div>
<hr>
