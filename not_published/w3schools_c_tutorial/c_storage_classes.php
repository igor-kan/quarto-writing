...
ny:-->
    ...
    <h1>C <span class="color_h1">Storage Classes</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_organize_code.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_bitwise_operators.php">Next &#10095;</a>
</div>
<hr>
...
<p>Storage classes define the <strong>lifetime</strong>, <strong>visibility</strong>, and <strong>memory location</strong> of variables.</p>

<p>There are four main storage class specifiers in C:</p>

<ul>
  <li><code class="w3-codespan">auto</code></li>
  <li><code class="w3-codespan">static</code></li>
  <li><code class="w3-codespan">register</code></li>
 <li><code class="w3-codespan">extern</code></li>
</ul>
<div class="ws-note ws-panel">
<h4>Difference Between Scope and Storage Classes</h4>
<p><strong>Scope</strong> defines where a variable can be used, and 
<strong>storage classes</strong> define how long it lasts and where it's stored. This chapter continues from the <a href="c_scope.php">C Scope</a> chapter.</p>
</div>
<!--stop-->
<hr>
...
<p>The <code class="w3-codespan">auto</code> keyword is used for local variables. It is default for variables declared inside functions, so it's rarely used explicitly.</p>

<div class="w3-example">
  <h3>Example</h3>
  <pre class="language-c w3-white"><code>int main() {
  auto int x = 50;  // Same as just: int x = 50;
  printf("%d\n", x);
  return 0;
}</code></pre>
  <p><a target="_blank" class="w3-btn" href="tryc.php?filename=demo_storage_classes_auto">Try it Yourself &raquo;</a></p>
</div>
<!--stop-->
<hr>
...
<p>The <code class="w3-codespan">static</code> keyword changes how a variable or function behaves in terms of <strong>lifetime</strong> and <strong>visibility</strong>:</p>

<ul>
  <li><strong>Static local variables</strong> keep their value between function calls.</li>
  <li><strong>Static global variables/functions</strong> are not visible outside their file.</li>
</ul>

<div class="w3-example">
  <h3>Example</h3>
  <pre class="language-c w3-white"><code>void count() {
...
<p>Result:</p>
<pre class="w3-black w3-padding"><code>num = 1
num = 2
num = 3</code></pre>
  <p><a target="_blank" class="w3-btn" href="tryc.php?filename=demo_storage_classes_static">Try it Yourself &raquo;</a></p>
</div>
<p>Try to remove the <code class="w3-codespan">static</code> keyword from the example to see the difference.</p>
<!--stop-->
...
<p>The <code class="w3-codespan">register</code> keyword suggests that the variable should be stored in a CPU register (for faster access).</p>

<p>You cannot take the address of a <code class="w3-codespan">register</code> variable using <code class="w3-codespan">&</code>.</p>
<p><strong>Note:</strong> The <code class="w3-codespan">register</code> keyword is mostly obsolete - modern compilers automatically choose the best variables to keep in registers, so you usually don't need to use it.</p>
<div class="w3-example">
  <h3>Example</h3>
  <pre class="language-c w3-white"><code>int main() {
  ...
  <p><a target="_blank" class="w3-btn" href="tryc.php?filename=demo_storage_classes_register">Try it Yourself &raquo;</a></p>
</div>
<!--stop-->
<hr>
...
<p>The <code class="w3-codespan">extern</code> keyword tells the compiler that a variable or function is defined in another file.</p>

<p>It is commonly used when working with <strong>multiple source files</strong>.</p>

<div class="w3-example">
  <p>File 1: <code class="w3-codespan">main.c</code></p>
...
<div class="w3-example">
<p>File 2: <code class="w3-codespan">data.c</code></p>
<pre class="language-c w3-white"><code>int shared = 50;  // Definition of the variable</code></pre>
</div>

<p>Compile both files together:</p>

<pre class="w3-black w3-padding"><code>gcc main.c data.c -o program</code></pre>
<!--stop-->
