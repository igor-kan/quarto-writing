...
<a class="w3-left w3-btn" href="c_input_validation.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_random_numbers.php">Next &#10095;</a>
</div>
<hr>

<h2>Time and Date</h2>

<p>In C, you can use the <code class="w3-codespan">&lt;time.h&gt;</code> header to work with dates and times.</p>

<p>This library lets you get the current time, format it, and perform time-related calculations.</p>

<hr>

<h2>Getting the Current Time</h2>
<p>The <code class="w3-codespan">&lt;time.h&gt;</code> library has a variety of functions to measure dates and times.</p>
<p>For example, the <code class="w3-codespan">time()</code> function returns the current time as a value of type <code class="w3-codespan">time_t</code>.</p>

<p>You can use <code class="w3-codespan">ctime()</code> to convert the time into a readable string, like "Mon Jun 24 10:15:00 2025":</p>
...
int main() {
  ...
  <p><a target="_blank" class="w3-btn" href="tryc.php?filename=demo_date_time">Try it Yourself &raquo;</a></p>
</div>


<hr>

<h2>Breaking Down the Time</h2>

<p>If you want to access individual parts of the date or time, like the year, month, or hour, you can use the <code class="w3-codespan">localtime()</code> function.</p>

<p>This function converts the current time (from <code class="w3-codespan">time()</code>) into a <code class="w3-codespan">struct tm</code>, which is a special structure that holds the date and time in separate fields.</p>

<p>Here's how you can use it to print each part of the current date and time:</p>
...
int main() {
  ...
  <p><a target="_blank" class="w3-btn" href="tryc.php?filename=demo_date_localtime">Try it Yourself &raquo;</a></p>
</div>

<div class="ws-note ws-panel">
  <p><strong>Note:</strong> The <code class="w3-codespan">tm_year</code> stores the number of years since 1900, so we add 1900 to get the full year, and <code class="w3-codespan">tm_mon</code> starts from 0 (so 0 = January, 11 = December).</p>
  <p><strong>Note:</strong> We use <code class="w3-codespan">-&gt;</code> because <code class="w3-codespan">localtime()</code> returns a <a href="c_pointers.php">pointer</a> to a <code class="w3-codespan">struct tm</code>.</p>
 <p>As you learned in the <a href="c_structs_pointers.php">Structs & Pointers</a> chapter: If you have a pointer to a <code class="w3-codespan">struct</code>, use <code class="w3-codespan">-&gt;</code> to access its members. Use the dot <code class="w3-codespan">.</code> only when you're working with the struct directly, not a pointer to it.</p>
</div>
...
<p>You can use <code class="w3-codespan">strftime()</code> to format the date and time as a string:</p>
...
int main() {
  ...
  <p><a target="_blank" class="w3-btn" href="tryc.php?filename=demo_date_strftime">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>When to use Date and Time</h2>
<p>Use date and time in C when you want to:</p>
<ul>
  <li>Display the current time or date</li>
  <li>Log events like errors or user actions</li>
  <li>Add timestamps to files or messages</li>
  <li>Measure how long something takes</li>
  <li>Schedule or delay actions</li>
  <li><a href="c_random_numbers.php">Seed random numbers</a> (so you get different results each run)</li>
</ul>
<hr>
