<!DOCTYPE html>
<html lang="en-US">
<title>C Get the Size of an Array</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>C <span class="color_h1">Array Size</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_arrays.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_arrays_loop.php">Next &#10095;</a>
</div>
<hr>

<h2>Get Array Size</h2>
<p>To get the size of an array, you can use the <code class="w3-codespan">sizeof</code> operator:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-c notranslate"><code>int myNumbers[] = {10, 25, 50, 75, 100};

printf("%zu", sizeof(myNumbers));  // Prints 20</code></pre>
<p><a target="_blank" class="w3-btn" href="tryc.php?filename=demo_array_get_size">Try it Yourself &raquo;</a></p>
</div>
<div class="ws-note w3-panel"><p><strong>Note:</strong> Why did the result show <code class="w3-codespan">20</code> instead of <code class="w3-codespan">5</code>, when the array contains 5 elements?</p>
</div><p>- It is because the <code class="w3-codespan">sizeof</code> operator returns the size of a type in 
<strong>bytes</strong>.</p>
<p>You learned from the <a href="c_data_types.php">Data Types chapter</a> that an <code class="w3-codespan">int</code> type is usually 4 bytes, so from the example above, 4 x 5 
(<em>4 bytes x 5 elements</em>) = <strong>20 bytes</strong>.</p>
<p>Knowing the memory size of an array is great when you are working with 
larger programs that require good memory management.</p>

<p>But what if you just wanted to know how many elements the array was storing? </p>

<hr>

<h2>Get the Number of Elements</h2>

<p>If you want to find out how many elements an array has, you can use this formula, which divides the total size of the array by the size of one element:</p>
<!--
<p>You were probably looking for the result to be <code class="w3-codespan">5</code> (as the array holds 5 elements).</p>
<p>Instead, it prints the number <code class="w3-codespan">20</code> because an <code class="w3-codespan">int</code> is usually 4 bytes, and since there are 5 elements in the array (each representing 4 bytes of memory), we get <code class="w3-codespan">20</code> as the result (5 * 4).</p>
<p>Knowing the size of an array (in bytes) is great when you are working with 
larger programs that require good memory management.</p>
<p>But what if you just wanted to know how many elements the array was storing? </p>
<p>To get the actual <strong>length</strong> of an array, you can use the following formula:</p>
<div class="w3-example">
<div class="w3-code notranslate javaHigh">
  <em>datatype</em> <em>variable</em> = sizeof(<em>arrayName</em>) / sizeof(<em>arrayName</em>[0]);<br>
 </div>
</div>
<p>Here we divide the memory size of an array by the size of one array element. Applying this to our example above, we now get 5 as 
the result (the array holds 5 elements):</p>-->
<div class="w3-example">
<h3>Example</h3>
<pre class="language-c notranslate"><code>int myNumbers[] = {10, 25, 50, 75, 100};
int length = sizeof(myNumbers) / sizeof(myNumbers[0]);

printf("%d", length);  // Prints 5</code></pre>
<p><a target="_blank" class="w3-btn" href="tryc.php?filename=demo_array_get_length">Try it Yourself &raquo;</a></p>
</div>

<p>The <code class="w3-codespan">sizeof</code> formula works for arrays of any type and any size:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-c notranslate"><code>double myValues[] = {1.1, 2.2, 3.3};
int length = sizeof(myValues) / sizeof(myValues[0]);

printf("%d", length);  // Prints 3</code></pre>
<p><a target="_blank" class="w3-btn" href="tryc.php?filename=demo_array_get_length2">Try it Yourself &raquo;</a></p>
</div>

<div class="ws-note ws-panel">
<p>In the <a href="c_array_loops.php">next chapter</a>, you will see how to use this formula to make loops that automatically adapt to the array size.</p></div>
...
<div id="exercisecontainer" src="xrcise_arrays_size.js" data-extensions="php"></div>
<hr>
