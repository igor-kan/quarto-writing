...
ny:-->
    ...
    <h1>C <span class="color_h1">Unions</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_structs_pointers.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_typedef.php">Next &#10095;</a>
</div>
<hr>
...
<p>A <code class="w3-codespan">union</code> is similar to a <code class="w3-codespan"><a href="c_structs.php">struct</a></code> in that it can store members of different data types.</p>

<p>However, there are some differences:</p>
<ul>
  <li>In a <code class="w3-codespan">struct</code>, each member has its own memory.</li>
  <li>In a <code class="w3-codespan">union</code>, all members <strong>share the same memory</strong>, which means you can only use one of the values at a time.</li>
</ul>
<div class="ws-note ws-panel">
<p>Most of the time, you will use <a href="c_structs.php">structs</a> instead of unions, as it can store and access multiple values at the same time, which is more common in everyday programs.</p>
<p>However, unions are useful when you only need to store one of several possible types at a time, and you want to save memory.</p>
</div>
<!--stop-->
<hr>
...
<p>To create a union, use the <code class="w3-codespan">union</code> 
keyword, and then create a variable from it (just like with structs):</p>

<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    union 
    myUnion {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Union declaration<br>&nbsp; int myNum;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Member 
    (int)<br>&nbsp; char myLetter;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Member (char)<br>&nbsp; char myString[30];&nbsp;&nbsp; // Member (char array)<br>
    };&nbsp;<br><br>int main() {<br>&nbsp; union myUnion u1;&nbsp; 
    // Create a union variable with the name &quot;u1&quot;:<br>&nbsp; return 0;<br>}</div>
</div>
<!--stop-->
<hr>

<!--start-->
<h2>Access Union Members</h2>
<p>And just like with structs, to access members of a Union, use the dot <code class="w3-codespan">.</code> 
syntax.</p>
<p><strong>Important:</strong> Since all members share the same memory, changing one will affect the others. Only the <strong>last assigned member</strong> holds a valid value:</p>

<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    union myUnion {<br>&nbsp; int myNum;<br>&nbsp; char myLetter;<br>&nbsp; char 
    myString[30];<br>};<br>
    <br>int main() {<br>&nbsp; union myUnion u1;<br><br>&nbsp; u1.myNum = 1000;<br>
    <br>&nbsp; // Since this is the last value written to the union, myNum no 
    longer holds 1000 - its value is now invalid<br>&nbsp; u1.myLetter = 'A';<br>
    <br>&nbsp; printf(&quot;myNum: %d\n&quot;, u1.myNum); // This value is no longer 
    reliable<br>&nbsp; printf(&quot;myLetter: %c\n&quot;, u1.myLetter); // Prints 'A'<br>
    <br>&nbsp; return 0;<br>}</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_union">Try it Yourself &raquo;</a>
</div>
<!--stop-->
...
<h2>Size of a Union</h2>
<p>The size of a <code class="w3-codespan">union</code> will always be the same as the size of its largest member:</p>

<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    union myUnion {<br>&nbsp; int myNum;<br>&nbsp; char 
    myString[36];<br>};<br><br>int main() {<br>&nbsp; union myUnion u1;<br>&nbsp; printf(&quot;Size of 
    union: %zu bytes\n&quot;, sizeof(u1));<br>&nbsp; return 0;<br>}</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_union_size">Try it Yourself &raquo;</a>
</div>
<p>Since the largest member is 36 bytes, the entire <code class="w3-codespan">union</code> will also be 
<strong>36 bytes</strong>.</p>
<p>
If it was a <code class="w3-codespan">struct</code> instead, the size would be 40 bytes:<br>
<code class="w3-codespan">myNum</code> (4 bytes) + 
<code class="w3-codespan">myString</code> (36 bytes) = 
<strong>40 bytes total</strong>
</p><hr>

<!--start-->
<h2>When to Use Unions</h2>
<p>Use unions when:</p>
<ul>
  <li>You need to store different types in the same location</li>
  <li>You only use one type at a time</li>
  <li>Saving memory is very important</li>
</ul>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_unions.js" data-extensions="php"></div>
<hr>
