...
ny:-->
    ...
    <h1>C <span class="color_h1">Arithmetic Operators</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_operators.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_operators_assignment.php">Next &#10095;</a>
</div>
<hr>
...
<th style="width:10%;text-align:right">Try it</th>
</tr>
<tr>
<td>+</td>
<td>Addition</td>
...
<td>x + y</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryc.php?filename=demo_oper_add">Try it &raquo;</a></td>
</tr>
<tr>
<td>-</td>
<td>Subtraction</td>
...
<td>x - y</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryc.php?filename=demo_oper_sub">Try it &raquo;</a></td>
</tr>
<tr>
<td>*</td>
...
<td>x * y</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryc.php?filename=demo_oper_mult">Try it &raquo;</a></td>
</tr>
<tr>
<td>/</td>
<td>Division</td>
...
<td>x / y</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryc.php?filename=demo_oper_div">Try it &raquo;</a></td>
</tr>
<tr>
<td>%</td>
<td>Modulus</td>
...
<td>x % y</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryc.php?filename=demo_oper_mod">Try it &raquo;</a></td>
</tr>
<tr>
<td>++</td>
<td>Increment</td>
...
<td>++x</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryc.php?filename=demo_oper_inc">Try it &raquo;</a></td>
</tr>
<tr>
<td>--</td>
<td>Decrement</td>
...
<td>--x</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryc.php?filename=demo_oper_dec">Try it &raquo;</a></td>
</tr>
</tbody>
</table>
</div>

<p>Here is an example using different arithmetic operators in one example:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-c w3-white"><code>int x = 10;
int y = 3;
...
<p>
<a target="_blank" class="w3-btn" href="tryc.php?filename=demo_oper_arit_all">Try it Yourself &raquo;</a>
</p>
</div>

<div class="ws-note ws-panel">
<p><strong>Note:</strong> When dividing two integers in C, the result will also be an integer.  
For example, <code class="w3-codespan">10 / 3</code> gives <code class="w3-codespan">3</code>.  
If you want a decimal result, use <code class="w3-codespan">float</code> or <code class="w3-codespan">double</code> values, like <code class="w3-codespan">10.0 / 3</code>.</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-c w3-white"><code>int a = 10;
int b = 3;
...
<p>
<a target="_blank" class="w3-btn" href="tryc.php?filename=demo_oper_division">Try it Yourself &raquo;</a>
</p>
</div>
</div>
...
<p>Incrementing and decrementing are very common in programming, especially when working with counters, loops, and arrays (which you will learn more about in later chapters).</p>

<p>The <code class="w3-codespan">++</code> operator increases a value by 1, while the <code class="w3-codespan">--</code> operator decreases a value by 1:</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryc.php?filename=demo_oper_incdec">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>
<a target="_blank" class="w3-btn" href="tryc.php?filename=demo_oper_incdec2">Try it Yourself &raquo;</a>
</p>
</div>

<p>Sometimes, you might both increment and decrement the same variable. Remember that if you increase a value and later decrease it, it will go up by one and then back down by one - ending up where it started:</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryc.php?filename=demo_oper_incdec3">Try it Yourself &raquo;</a>
</p>
</div>

<h4>Real Life Example: Counting People</h4>
<p>
Imagine you are building a program to count how many people enter and leave a room.  
You can use <code class="w3-codespan">++</code> to increase the counter when someone enters,  
and <code class="w3-codespan">--</code> to decrease it when someone leaves:
</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-c w3-white"><code>int peopleInRoom = 0;
...
<p>
<a target="_blank" class="w3-btn" href="tryc.php?filename=demo_oper_incdec_real">Try it Yourself &raquo;</a>
</p>
</div>
<hr>
