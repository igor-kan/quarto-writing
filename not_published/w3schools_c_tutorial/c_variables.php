...
<h1>C <span class="color_h1">Variables</span></h1>

<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_comments.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_variables_format.php">Next &#10095;</a>
</div>
<hr>
...
<p>You can think of a variable as a named box where you keep a value that can be used later.</p>

<p>In C, variables must have a specific <strong>type</strong>, which tells the program what kind of data the variable can store.</p>

<ul>
 <li><code class="w3-codespan">int</code> - stores whole numbers (integers), such as <code class="w3-codespan">123</code> or <code class="w3-codespan">-123</code></li>
 <li><code class="w3-codespan">float</code> - stores numbers with decimals, such as <code class="w3-codespan">19.99</code> or <code class="w3-codespan">-19.99</code></li>
 <li><code class="w3-codespan">char</code> - stores a single character, such as <code class="w3-codespan">'a'</code> or <code class="w3-codespan">'B'</code>.
 Characters are surrounded by <strong>single quotes</strong></li>
</ul>
...
<p>To create a variable, you must specify the <strong>type</strong> and give the variable a <strong>name</strong>.</p>
<p>You can also assign a value at the same time:</p>

<div class="w3-example">
<h3>Syntax</h3>
<div class="w3-code notranslate javaHigh">
  <em>type</em> <em>variableName</em> = <em>value</em>;</div>
</div>

<p>Where <em>type</em> is one of the C data types (such as <code class="w3-codespan">int</code>),
and <em>variableName</em> is the name you choose (for example <strong>x</strong> or <strong>myNum</strong>).</p>

<p>The equal sign <code class="w3-codespan">=</code> is used to assign a value to the variable.</p>
<p>So, to create a variable that should store a number, look at the following example:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Create a variable named <strong>myNum</strong> of type <code class="w3-codespan">int</code> and assign the value <strong>15</strong>:</p>
<div class="w3-code notranslate javaHigh">
  int myNum = 15;</div>
</div>

<p>You can also declare a variable first and assign a value later:</p>
...
<div class="w3-code notranslate javaHigh">
  ...
  int myNum;<br><br>
  // Assign a value later<br>
  myNum = 15;</div>
</div>

<div class="ws-note w3-panel">
<p><strong>Tip:</strong> Variable names should be meaningful, so your code is easier to understand.</p>
</div>
<!--stop-->
...
<p>You learned from the <a href="c_output.php">output chapter</a> that you can print text using the <code class="w3-codespan">printf()</code> function:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  printf(&quot;Hello World!&quot;);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_variables_printf">Try it Yourself &raquo;</a>
</div>

<p>In many other programming languages (like <a href="/python/default.asp">Python</a>, <a href="/java/default.asp">Java</a>, and <a href="/cpp/default.asp">C++</a>), you would normally use a 
<strong>print function</strong> to display the value of a variable. However, this is not possible in C:</p>
<div class="w3-example w3-pale-red">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh w3-border-red">
  int myNum = 15;<br>
  printf(myNum); // This will cause an error</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_variables_printf_err">Try it Yourself &raquo;</a>
</div>

<p>To print variables in C, you must use something called <a href="c_variables_format.php">format specifiers</a>.</p>
<p>Don't worry - this will be explained clearly in the next chapter.</p>
<!--stop-->

<hr>
<div id="exercisecontainer" src="xrcise_variables.js" data-extensions="php"></div>
<hr>
