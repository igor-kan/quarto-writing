...
ny:-->
    ...
    <h1>C <span class="color_h1">Inline Function</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_math.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_functions_recursion.php">Next &#10095;</a>
</div>
<hr>

<h2>Inline Function</h2>

<p>You might sometimes see the <code class="w3-codespan">inline</code> keyword used in other people's functions.  
It's not something you need to use often as a beginner, but it's good to know what it means.</p>

<p>An <strong>inline function</strong> is a small function that asks the compiler to insert its code <em>directly</em> where it is called, instead of jumping to it.</p>

<p>This can make short, frequently used functions a little faster, because it removes the small delay of a normal function call.</p>

<p>Let's compare a regular function with an inline function:</p>
...
<p>Both functions work the same way. The only difference is that the <code class="w3-codespan">inline</code> version <em>suggests</em> to the compiler to copy the function's code directly where it is used.</p>
...
<p>Here is a simple example that uses an <code class="w3-codespan">inline</code> function:</p>
...
<div class="w3-example">
  ...
  <p>
    <a target="_blank" class="w3-btn" href="tryc.php?filename=demo_functions_inline">Try it Yourself &raquo;</a>
  </p>
</div>

<p>Here, the compiler might replace <code class="w3-codespan">add(5, 3)</code> with the code <code class="w3-codespan">5 + 3</code> directly - saving the time it would take to call a separate function.</p>

<hr>

<h2>When Not to Use Inline</h2>

<p>Inline functions are best for <strong>small, simple</strong> functions. Avoid using them for:</p>

<ul>
  <li>Large functions (they make your program bigger)</li>
  <li>Recursive functions</li>
  <li>Functions that are rarely called</li>
</ul>

<p>Too many inline functions can make your program slower and larger, a problem known as <em>code bloat</em>.</p>

<hr>

<h2>Inline vs Regular Function</h2>

<div class="w3-responsive" >
  <table class="ws-table-all notranslate" style="margin-top:8px;margin-bottom:0">
    <tr>
      <th>Regular Function</th>
      <th>Inline Function</th>
    </tr>
    <tr>
      <td>Code jumps to the function each time it's called</td>
      <td>Code is inserted directly where it's called</td>
    </tr>
    <tr>
      <td>Slightly slower (small delay)</td>
      <td>Slightly faster</td>
    </tr>
    <tr>
      <td>Good for large functions</td>
      <td>Good for small functions</td>
    </tr>
  </table>
</div>
<p>In this tutorial, we will continue to use regular functions.</p>
<hr>

<h2>Summary</h2>

<ul>
  <li>Inline functions are defined with the <code class="w3-codespan">inline</code> keyword.</li>
  <li>They can make small, often-used functions faster.</li>
  <li>The compiler decides whether to inline a function or not.</li>
  <li>Mostly used for short, simple functions.</li>
</ul>
