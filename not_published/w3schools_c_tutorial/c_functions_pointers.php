...
ny:-->
    ...
    <h1>C <span class="color_h1">Function Pointer</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_functions_recursion.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_functions_callback.php">Next &#10095;</a>
</div>
<hr>
...
<p>A <strong>function pointer</strong> is like a normal <a href="c_pointers.php">pointer</a>, but instead of pointing to a variable, it points to a <strong>function</strong>.</p>

<p>This means it stores the <em>address of a function</em>, allowing you to call that function using the pointer.</p>

<p>Function pointers let you decide which function to run while the program is running, or when you want to pass a function as an argument to another function.</p>

<p>Think of it like saving a phone number - the pointer knows <em>where</em> the function lives in memory, so you can "call" it later.</p>

<hr>

<h2>Declaring a Function Pointer</h2>

<p>The general syntax for declaring a function pointer is:</p>

<div class="w3-example">
  <div class="w3-code notranslate javaHigh">
    <em>returnType </em>(*<em>pointerName</em>)(<em>parameterType1</em>, <em>parameterType2</em>, ...);
  </div>
</div>
...
<p>This means <code class="w3-codespan">ptr</code> is a pointer to a function that takes two <code class="w3-codespan">int</code> values and returns an <code class="w3-codespan">int</code>.</p>

<hr>

<h2>Assigning a Function to a Pointer</h2>

<p>You can assign a function to a pointer in two ways:</p>
...
<p>Both are the same, because the function's name already represents its address in memory.</p>

<hr>

<h2>Calling a Function Through a Pointer</h2>

<p>Once the pointer is assigned, you can call the function in two ways:</p>
...
<p>Both are valid and do the same thing.</p>
...
<h2>Function Pointer Example</h2>

<p>Now that you know how to declare and assign a function pointer, let's see a complete example:</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>A pointer to a function that adds two numbers:</p>
  <div class="w3-code notranslate javaHigh">
    int add(int a, int b) {<br>
    &nbsp;&nbsp;return a + b;<br>
    }<br><br>
    int main() {<br>
    &nbsp;&nbsp;int (*ptr)(int, int) = add;<br>
    &nbsp;&nbsp;int result = ptr(5, 3);<br>
    &nbsp;&nbsp;printf("Result: %d", result);<br>
    &nbsp;&nbsp;return 0;<br>
    }
  </div>
  <p><a target="_blank" class="w3-btn" href="tryc.php?filename=demo_functions_pointer">Try it Yourself &raquo;</a></p>
</div>

<p>Here:</p>
<ul>
  <li><code class="w3-codespan">ptr</code> is a pointer to the function <code class="w3-codespan">add()</code>.</li>
  <li><code class="w3-codespan">ptr(5, 3)</code> calls the function using the pointer.</li>
</ul>

<p>This works exactly the same as calling <code class="w3-codespan">add(5, 3)</code>.</p>

<div class="ws-note ws-panel">
  <p><strong>Note:</strong> A function name itself points to the start of its code in memory.  
  That means a function name already acts like a pointer!  
  Declaring a function pointer just gives you a variable that can hold that address - so you can change it or pass it around.
</p>
</div>
...
<p>Function pointers can be passed to other functions - this is called a <strong>callback</strong>.</p>

<p>It allows a function to call another function that you provide as input.</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Passing a function pointer to another function:</p>
  <div class="w3-code notranslate javaHigh">
    void greetMorning() { printf("Good morning!\n"); }<br>
    void greetEvening() { printf("Good evening!\n"); }<br><br>
    void greet(void (*func)()) {<br>
    &nbsp;&nbsp;func();<br>
    }<br><br>
    int main() {<br>
    &nbsp;&nbsp;greet(greetMorning);<br>
    &nbsp;&nbsp;greet(greetEvening);<br>
    &nbsp;&nbsp;return 0;<br>
    }
  </div>
  <p><a target="_blank" class="w3-btn" href="tryc.php?filename=demo_functions_pointer_argument">Try it Yourself &raquo;</a></p>
</div>

<p>Here, <code class="w3-codespan">greet()</code> takes another function as a parameter and calls it.  
This is commonly used in event-driven programs or libraries that need user-provided callback functions.</p>

<hr>

<h2>Function Pointer Array</h2>

<p>You can also store several function pointers in an array, so you can choose which function to run while the program is running.</p>

<p>This example runs three different functions using an array of function pointers:</p>
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate javaHigh">
    ...
    int main() {<br>
    &nbsp;&nbsp;void (*operations[3])() = { add, subtract, multiply };<br>
  ...
  <p><a target="_blank" class="w3-btn" href="tryc.php?filename=demo_functions_pointer_array">Try it Yourself &raquo;</a></p>
</div>

<p>This is often used for simple menus, command lists, or calculators - anywhere you want to call different functions based on user input.</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>A simple calculator using an array of function pointers:</p>
  <div class="w3-code notranslate javaHigh">
    void add(int a, int b) { printf("Result: %d\n", a + b); }<br>
    void subtract(int a, int b) { printf("Result: %d\n", a - b); }<br>
    void multiply(int a, int b) { printf("Result: %d\n", a * b); }<br><br>
    int main() {<br>
    &nbsp;&nbsp;int choice, x = 10, y = 5;<br><br>
    &nbsp;&nbsp;void (*operations[3])(int, int) = { add, subtract, multiply };<br><br>
    &nbsp; printf(&quot;x = %d, y = %d\n\n&quot;, x, y);<br>&nbsp;&nbsp;printf("Choose an operation:\n");<br>
    &nbsp;&nbsp;printf("0: Add\n1: Subtract\n2: Multiply\n");<br>
    &nbsp;&nbsp;scanf("%d", &amp;choice);<br><br>
    &nbsp;&nbsp;if (choice &gt;= 0 &amp;&amp; choice &lt; 3) {<br>
    &nbsp;&nbsp;&nbsp;&nbsp;operations[choice](x, y);<br>
    &nbsp;&nbsp;} else {<br>
  ...
  <p><a target="_blank" class="w3-btn" href="/cpp/showcpp.asp?filename=demo_functions_pointer_array_c">Run Example &raquo;</a></p>
</div>

<p>In this program:</p>
<ul>
  <li>All three math functions (<code class="w3-codespan">add()</code>, <code class="w3-codespan">subtract()</code>, and <code class="w3-codespan">multiply()</code>) are stored in an array.</li>
  <li>The user picks which one to run by entering a number.</li>
  <li>The correct function is then called using the pointer array.</li>
</ul>

<p>This is a simple example of how function pointer arrays make programs more flexible and reusable.</p>

<hr>

<h2>Function Pointer vs Normal Function</h2>
...
<div class="w3-responsive">
  <table class="ws-table-all notranslate">
    ...
    <tr>
      <td>Called directly by its name</td>
      <td>Called using a pointer</td>
    </tr>
    <tr>
      <td>The function is decided before the program runs</td>
      <td>You can choose which function to call while the program is running</td>
    </tr>
    <tr>
      <td>Good for simple code</td>
      <td>Good for flexible and reusable code</td>
    </tr>
  </table>
</div>
...
<ul>
  ...
  <li>You can declare, assign, and call functions through it.</li>
  <li>It allows passing functions as arguments to other functions.</li>
  <li>Useful for callbacks, menus, and flexible program design.</li>
</ul>
