...
ny:-->
    ...
    <h1>C <span class="color_h1">Numeric Data Types</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_data_types_characters.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_data_types_dec.php">Next &#10095;</a>
</div>
<hr>

<!--start-->
<h2>Numeric Types</h2>
<p>Use <code class="w3-codespan">int</code> when you need to store a whole number without decimals, like 35 or 1000, and <code class="w3-codespan">float</code> or <code class="w3-codespan">double</code> when you need a floating point number (with decimals), like 9.99 or 3.14515.</p>
...
<div class="w3-code notranslate javaHigh">
  int myNum = 1000;<br>
  printf(&quot;%d&quot;, myNum);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_data_types_numbers">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate javaHigh">
  float myNum = 5.75;<br>
  printf(&quot;%f&quot;, myNum);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_data_types_numbers2">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate javaHigh">
  ...
  printf(&quot;%lf&quot;, myNum);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_data_types_numbers3">Try it Yourself &raquo;</a>
</div>
...
The precision of <code class="w3-codespan">float</code> is six or seven 
decimal digits, while <code class="w3-codespan">double</code> variables have a precision 
of about 15 digits. Therefore, it is often safer to use <code class="w3-codespan">double</code> for most calculations - but note that it takes up twice as much <a title="Explaining the memory size of data types" href="c_data_types_sizeof.php">memory</a> as <code class="w3-codespan">float</code> (8 
bytes vs. 4 bytes).</p>
</div>
<!--stop-->
<hr>
...
<!--start-->
<h2>Scientific Numbers</h2>
<p>In C, you can write very large or very small floating-point numbers using scientific notation.</p>

<p>This is done using the letter <code class="w3-codespan">e</code> (or <code class="w3-codespan">E</code>), which stands for "times 10 to the power of".</p>
<p>For example, <code class="w3-codespan">35e3</code> means <strong>35 &#215; 10&#179;</strong> = 
<strong>35000</strong>.</p>

<p>This is useful for writing numbers in a shorter way. Especially when working with scientific values or large-scale data.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  float f1 = 35e3;&nbsp;&nbsp; // 35 * 10^3 = 35000<br>double d1 = 12E4;&nbsp; // 12 * 10^4 = 120000<br><br>printf(&quot;%f\n&quot;, f1);<br>
  printf(&quot;%lf&quot;, d1);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_data_types_scientific">Try it Yourself &raquo;</a>
</div>
<!--stop-->
...
<div id="exercisecontainer" src="xrcise_data_types_numbers.js" data-extensions="php"></div>
<hr>
