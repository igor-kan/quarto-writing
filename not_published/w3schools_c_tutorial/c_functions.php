...
ny:-->
    ...
    <h1>C <span class="color_h1">Functions</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_challenges_pointers.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_functions_parameters.php">Next &#10095;</a>
</div>
<hr>
...
<p>Functions are used to perform certain actions, and they are 
...
<p>So it turns out you already know what a function is. You have been using it the whole time 
while studying this tutorial!</p>

<p>For example, <code class="w3-codespan">main()</code> is a function, which is used to execute code, 
and <code class="w3-codespan">printf()</code> is a function; used to output/print text to the screen:</p>


<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  int <strong>main()</strong> {<br>&nbsp; <strong>printf(</strong>&quot;Hello World!&quot;<strong>)</strong>;<br>&nbsp; 
  return 0;<br>}</div>
...
<p>To create (often referred to as <em>declare</em>) your own function, specify the name of the function, followed by parentheses <code class="w3-codespan">()</code> 
and curly brackets <code class="w3-codespan">{}</code>:</p>
<div class="w3-example">
<h3>Syntax</h3>
  <div class="w3-code notranslate javaHigh">
    void <em>myFunction</em>() {<br>&nbsp; 
...
use&quot;, and will be executed when they are called.</p>
...
myFunction()</code>:</p>
<div class="w3-code notranslate javaHigh">
  // Create a function<br>void myFunction() {<br>&nbsp; printf(&quot;I just got 
  executed!&quot;);<br>}<br><br>int main() {<br>&nbsp; 
  <strong>myFunction();</strong> // call the function<br>&nbsp; return 0;<br>}<br><br>// Outputs 
  &quot;I just got executed!&quot;<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_functions">Try it Yourself &raquo;</a>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  void myFunction() {<br>&nbsp; printf(&quot;I just got executed!&quot;);<br>}<br><br>int main() {<br>&nbsp; 
  <strong>myFunction();</strong><br>&nbsp; <strong>myFunction();</strong><br>&nbsp; 
  <strong>myFunction();</strong><br>&nbsp; return 0;<br>}<br><br>// 
  I just got executed!<br>// I just got executed!<br>// I just got executed!<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_functions_multiple">Try it Yourself &raquo;</a>
</div>
<!--
<p>You can also use functions to call other functions:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  // Create a function (myFunction)<br>void myFunction() {<br>&nbsp; 
  printf(&quot;Some text in myFunction\n&quot;);<br>&nbsp; myOtherFunction(); // call 
  myOtherFunction<br>}<br>
  <br>// Create another function (myOtherFunction)<br>void myOtherFunction() {<br>&nbsp; 
  printf(&quot;Hey! Some text in myOtherFunction\n&quot;);<br>}<br><br>int main() {<br>&nbsp; 
  myFunction(); // call myFunction<br>&nbsp; return 0;<br>}<br>
 </div>
<a id="calcfuncbelow" target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_functions_other">Try it Yourself &raquo;</a>
</div>
-->
<!--stop-->
<hr>
...
<p>You can put almost whatever you want inside a function. The purpose of the function is to save the code, and execute it when you need it.</p>
<p>Like in the example below, we have created a function to calculate 
the sum of two numbers. Whenever you are 
ready to execute the function (and perform the calculation), you just call it: </p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  void 
  calculateSum() {<br>&nbsp; int x = 5;<br>&nbsp; int y = 10;<br>&nbsp; int sum = 
  x + y;<br>&nbsp; printf(&quot;The sum of x + y is: %d&quot;, sum);<br>}<br><br>int main() {<br>&nbsp; 
  calculateSum();&nbsp; // call the function<br>&nbsp; return 0;<br>}<br><br>// Outputs The 
  sum of x + y is: 15<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_functions_calculate">Try it Yourself &raquo;</a>
</div>

<p>This was just an example to demonstrate a simple function with different 
statements in C. The real power of 
a function is revealed in the next chapter, when we 
pass &quot;parameters&quot; to it.
This allows the function to calculate the sum of <strong>any</strong> numbers, 
instead of being limited to the fixed values <code class="w3-codespan">5</code> and <code class="w3-codespan">10</code>.</p>
<!--stop-->

<hr>
<div id="exercisecontainer" src="xrcise_functions.js" data-extensions="php"></div>
<hr>
