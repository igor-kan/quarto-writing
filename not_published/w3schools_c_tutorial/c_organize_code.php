<!DOCTYPE html>
<html lang="en-US">
<title>C Organize Code - Modular Programming and Header Files</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>C <span class="color_h1">Organize Code</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_macros.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_storage_classes.php">Next &#10095;</a>
</div>
<hr>

<!--start-->
<h2>Organize Your Code - Modular Programming</h2>

<p>In C programming, modular programming means splitting your code into smaller, reusable parts.</p>
<p>This makes your code easier to read, maintain, and debug.</p>

<p>The most common way to organize C programs is by using separate <code class="w3-codespan">.c</code> files and <code class="w3-codespan">.h</code> header files.</p>
<p>Even though this approach is not required for small beginner programs, it is very useful for larger projects or more experienced programmers who want to keep their code clean and well-structured.</p>
<!--stop-->
<hr>

<!--start-->
<h2>Why Use Header Files?</h2>

<ul>
  <li>To declare functions that are defined in another file</li>
  <li>To share variables, constants, or macros across files</li>
  <li>To organize your code into logical modules</li>
</ul>

<div class="ws-note ws-panel">
  <p><strong>Tip:</strong> Header files usually contain function declarations, macros, and struct definitions.</p>
</div>
<!--stop-->
...
<!--start-->
<h2>Example: Creating a Header File</h2>
<p>In this example, you will learn how to create your own header file and use it to organize code across multiple files.</p>
<p>Let's create a simple <strong>calculator module</strong> with a header file and a source file.</p>

<h4>1. <code class="w3-codespan">calc.h</code></h4>
<p>Start by creating a header file named <code class="w3-codespan">calc.h</code> to declare the functions:</p>

<div class="w3-example">
<p>The <code>calc.h</code> file:</p>
<pre class="language-c w3-white"><code>#ifndef CALC_H
#define CALC_H
...
<p>The <code class="w3-codespan">#ifndef</code>, <code class="w3-codespan">#define</code>, and <code class="w3-codespan">#endif</code> lines are called an <strong>include guard</strong>.</p>

<p>They prevent the file from being included more than once by mistake, which can cause errors during compilation.</p>

<p>This is a common and recommended practice in all C header files.</p>
<p>This file itself contains declarations of two functions: <code class="w3-codespan">add()</code> and <code class="w3-codespan">subtract()</code>.</p>
<!--stop-->
...
<!--start-->
<h2>Writing the Function Definitions</h2>

<h4>2. <code class="w3-codespan">calc.c</code></h4>
<p>Next, write the function definitions inside your <code class="w3-codespan">calc.c</code> file:</p>
<div class="w3-example">
<p>The <code>calc.c</code> file:</p>
<pre class="language-c w3-white"><code>#include "calc.h"
...
<p>This file defines the functions declared in <code class="w3-codespan">calc.h</code>.</p>
<!--stop-->

<hr>

<!--start-->
<h2>Using the Module in main.c</h2>

<h4>3. <code class="w3-codespan">main.c</code></h4>
<p>Finally, write the main program in <code class="w3-codespan">main.c</code> and include the header file to use the calculator functions:</p>
...
<p>Result:</p>
<div class="w3-padding w3-black w3-margin-bottom">
<code>5 + 5 = 10<br>
6 - 4 = 2<br></code>
</div>
</div>
...
<!--stop-->
<h2>How to Compile Multiple Files</h2>

<p>When your program is split across multiple files, you need to compile them together. For example:</p>

<pre class="w3-black w3-padding"><code>gcc main.c calc.c -o program</code></pre>

<p>This tells the compiler to build one executable named <code class="w3-codespan">program</code> from both <code class="w3-codespan">main.c</code> and <code class="w3-codespan">calc.c</code>.</p>
<!--stop-->
