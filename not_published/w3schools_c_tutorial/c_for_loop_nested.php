...
ny:-->
    ...
    <h1>C <span class="color_h1">Nested Loops</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_for_loop.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_for_loop_reallife.php">Next &#10095;</a>
</div>
<hr>
...
<div class="w3-code notranslate javaHigh">
  int i, j;<br><br>// Outer loop<br>for (i = 1; i &lt;= 2; ++i) {<br>&nbsp; printf(&quot;Outer: 
  %d\n&quot;, i);&nbsp; // Executes 2 times<br><br>&nbsp; // Inner loop<br>&nbsp; for (j = 1; j &lt;= 3; ++j) {<br>&nbsp;&nbsp;&nbsp; 
  printf(&quot; Inner: %d\n&quot;, j);&nbsp; // Executes 6 times (2 * 3)<br>&nbsp; }<br>}<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_for_loop_nested">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>

<!--start-->
<h2>Multiplication Table Example</h2>
...
<p><a target="_blank" class="w3-btn" href="tryc.php?filename=demo_for_loop_nested_multi">Try it Yourself &raquo;</a></p>
</div>


<p>
  Nested loops are useful when working with tables, matrices, or <a href="c_arrays_multi.php">multi-dimensional data structures</a>.
</p>
<!--stop-->

<hr>
<div id="exercisecontainer" src="xrcise_for_loop_nested.js" data-extensions="php"></div>
...
<!--
<h2>For-Each Loop</h2>
<p>There is also a "<b>for-each</b>" loop, which is used exclusively to loop through elements in an <strong>array</strong>:</p>
<div class="w3-example">
<h3>Syntax</h3>
<div class="w3-code notranslate javaHigh">
  for (<em>type</em> <em>variable</em> : <em>arrayname</em>) {<br>&nbsp; <i>// code block to be executed</i><br>
  }<br>
 </div>
</div>
<p>The following example outputs all elements in the <strong>myArray</strong> 
array, using a "<b>for-each</b>" loop:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  int myArray[4] = {10, 20, 30, 40}; <br>for (int i : myArray) {<br>&nbsp; cout 
  &lt;&lt; i &lt;&lt; &quot;\n&quot;; <br>}<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trycpp.asp?filename=demo_for_each">Try it Yourself &raquo;</a>
</div>
<div class="ws-note w3-panel">
<p><strong>Note:</strong> Don't worry if you don't understand the example above. You will learn more about Arrays in the <a href="cpp_arrays.asp">C++ Arrays chapter</a>.</p></div>
-->
