...
ny:-->
    ...
    <h1>C <span class="color_h1">Error Handling</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_null.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_input_validation.php">Next &#10095;</a>
</div>
<hr>
...
<p>Error handling lets you detect and respond to problems in your program, like a file that can't be opened or memory that can't be allocated, so your program doesn't crash or behave unexpectedly.</p>

<p>Unlike some languages, C does not have built-in exception handling (like <strong>try/catch</strong>). Instead, C uses return values, global error codes, and helper functions like <code class="w3-codespan">perror()</code> and <code class="w3-codespan">strerror()</code>.</p>
<!--stop-->
...
<p>In the previous chapter, you learned that functions like <code class="w3-codespan">fopen()</code> return <a href="c_null.php"><code class="w3-codespan">NULL</code></a> when something goes wrong.</p>

<p>You can check for <code class="w3-codespan">NULL</code> using an <code class="w3-codespan">if</code> statement to detect and handle errors before your program crashes.</p>

<p>In the example below, we try to open a file that does not exist. Since <code class="w3-codespan">fopen()</code> fails, it returns <code class="w3-codespan">NULL</code> and we print an error message:</p>

<div class="w3-example">
  <h4>Example: fopen() fails</h4>
...
<p>Result:<br>
<div class="w3-black w3-padding w3-margin-bottom">
<code>Error opening file.</code>
</div>
</div>
<!--stop-->
<hr>
...
<p>If you want more details about what went wrong, you can use the <code class="w3-codespan">perror()</code> function.</p>
<p>It prints a custom error message followed by a description of the last error that occurred:</p>

<div class="w3-example">
  <h4>Example: perror() with fopen()</h4>
  <pre class="language-c w3-white"><code>#include &lt;stdio.h&gt;
...
<p>Result:<br>
<div class="w3-black w3-padding w3-margin-bottom">
<code>Error opening file: No such file or directory</code>
</div>
</div>
<!--stop-->
...
<!--start-->
<h2>Using strerror() and errno</h2>

<p><code class="w3-codespan">errno</code> is a global variable that stores the error code from the last failed operation. You can include <code class="w3-codespan">&lt;errno.h&gt;</code> to access it, and <code class="w3-codespan">strerror(errno)</code> will convert the error code into a readable message:</p>

<div class="w3-example">
  <h4>Example: strerror()</h4>
  <pre class="language-c w3-white"><code>#include &lt;stdio.h&gt;
#include &lt;errno.h&gt;
#include &lt;string.h&gt;
...
<p>Error constants are defined in <code class="w3-codespan">&lt;errno.h&gt;</code>. You can compare <code class="w3-codespan">errno</code> to them to detect specific issues:</p>

<table class="ws-table-all">
  <tr><th>Error Code</th><th>Meaning</th></tr>
  <tr><td><code class="w3-codespan">ENOENT</code></td><td>No such file or directory</td></tr>
  <tr><td><code class="w3-codespan">EACCES</code></td><td>Permission denied</td></tr>
  <tr><td><code class="w3-codespan">ENOMEM</code></td><td>Not enough memory</td></tr>
  <tr><td><code class="w3-codespan">EINVAL</code></td><td>Invalid argument</td></tr>
</table>

<div class="w3-example">
  <h4>Example: Custom message for ENOENT</h4>
  <pre class="language-c w3-white"><code>#include &lt;stdio.h&gt;
#include &lt;errno.h&gt;
...
<p>Result:<br>
<div class="w3-black w3-padding w3-margin-bottom">
<code>The file was not found.</code>
</div>
</div>
<!--stop-->
<hr>
...
<!--start-->
<h2>Using exit() to Stop the Program</h2>

<p>If you want to stop the program immediately when an error occurs, you can use <code class="w3-codespan">exit()</code>. 
It lets you return a status code to the operating system.</p>
<p>Exit codes help signal whether the program finished successfully or with an error, like:</p>
<ul>
  <li><code class="w3-codespan">0</code> means success</li>
  <li>Non-zero values (like <code class="w3-codespan">1</code> or <code class="w3-codespan">EXIT_FAILURE</code>) indicate errors</li>
</ul>


<div class="w3-example">
  <h4>Example: Using exit() on error</h4>
  <pre class="language-c w3-white"><code>#include &lt;stdio.h&gt;
#include &lt;stdlib.h&gt;
...
<p>Result:<br>
<div class="w3-black w3-padding w3-margin-bottom">
<code>Failed to open file.</code>
</div>
</div>

<h3>Common Exit Status Codes</h3>

<table class="ws-table-all">
  <tr><th>Code</th><th>Meaning</th></tr>
  <tr><td>0</td><td>Success - the program completed normally</td></tr>
  <tr><td>1</td><td>Error - something went wrong</td></tr>
  <tr><td>EXIT_SUCCESS</td><td>Same as 0 (defined in <code>&lt;stdlib.h&gt;</code>)</td></tr>
  <tr><td>EXIT_FAILURE</td><td>Same as a non-zero error code (also in <code>&lt;stdlib.h&gt;</code>)</td></tr>
</table>

<div class="ws-note ws-panel">
  <p><strong>Tip:</strong> You can use <code class="w3-codespan">EXIT_SUCCESS</code> and <code class="w3-codespan">EXIT_FAILURE</code> 
  instead of numbers to make your code more readable.</p>
</div>
<div class="w3-example">
  <h4>Example: Using EXIT_FAILURE and EXIT_SUCCESS</h4>
  <pre class="language-c w3-white"><code>#include &lt;stdio.h&gt;
#include &lt;stdlib.h&gt;
...
<p>Result:<br>
<div class="w3-black w3-padding w3-margin-bottom">
<code>Could not open nothing.txt: No such file or directory</code>
</div>
</div>
<!--stop-->
<hr>
...
<h2>Summary</h2>
<ul>
  <li>Many C functions return <code class="w3-codespan">NULL</code> when something goes wrong</li>
  <li>Use <code class="w3-codespan">perror()</code> to print a message about the error</li>
  <li>Use <code class="w3-codespan">strerror(errno)</code> to get the error message as a string</li>
  <li><code class="w3-codespan">errno</code> stores the error code from the last failed action</li>
  <li>You can compare <code class="w3-codespan">errno</code> to values like <code class="w3-codespan">ENOENT</code> (file not found) or <code class="w3-codespan">ENOMEM</code> (not enough memory)</li>
  <li>Use <code class="w3-codespan">exit()</code> to stop the program early if there's an error</li>
</ul>

<div class="ws-note ws-panel">
  <p><strong>Tip:</strong> Always check for errors after file operations, memory allocation, and system calls. Ignoring errors can lead to unexpected behavior or crashes.</p>
</div>
<!--stop-->
