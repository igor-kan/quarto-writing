...
<a class="w3-left w3-btn" href="c_challenges_while_loop.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_for_loop_nested.php">Next &#10095;</a>
</div>
<hr>
...
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  int i;<br><br>for (i = 0; i &lt; 5; i++) {<br>&nbsp; printf(&quot;%d\n&quot;, 
  i);<br>}<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_for_loop">Try it Yourself &raquo;</a>
</div>

<p><b>Example explained</b></p>
<ul>
  <li>Statement 1 sets a variable before the loop starts: <code class="w3-codespan">int i = 0</code></li>
  <li>Statement 2 defines the condition for the loop to run: <code class="w3-codespan">i &lt; 5</code>. If the condition is true, the loop will start over again, if it is false, the loop will end.</li>
  <li>Statement 3 increases a value each time the code block in the loop has been executed: <code class="w3-codespan">i++</code></li>
</ul>
<hr>
...
<div class="w3-example">
  ...
  <a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_for_loop_sum">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-example">
  ...
  <a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_for_loop_countdown">Try it Yourself &raquo;</a>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_for_loop.js" data-extensions="php"></div>
<hr>
