<!DOCTYPE html>
<html lang="en-US">
<title>C Input Validation</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>C <span class="color_h1">Input Validation</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_error_handling.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_date_time.php">Next &#10095;</a>
</div>
<hr>

<!--start-->
<h2>Input Validation</h2>
<p>When users enter data into a C program, they might type something unexpected. Input validation makes sure the input is correct before the program continues.</p>

<p>Without validation, your program might crash or give the wrong result!</p>

<p>The examples below show simple ways to check if the user's input is valid in C.</p>
<hr>

<h2>Validate Number Range</h2>
<p>Check if the number is within an allowed range (for example, 1 to 5):</p>
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate javaHigh">
    ...
    int main() {<br>
    &nbsp;&nbsp;int number; // Variable to store the user's number<br><br>

    &nbsp;&nbsp;do {<br>
    &nbsp;&nbsp;&nbsp;&nbsp;printf("Choose a number between 1 and 5: ");<br>
    &nbsp;&nbsp;&nbsp;&nbsp;scanf("%d", &amp;number); // Read number input<br>
    &nbsp;&nbsp;&nbsp;&nbsp;while (getchar() != '\n'); // Clear leftover characters from input buffer<br>
    &nbsp;&nbsp;} while (number &lt; 1 || number &gt; 5); // Keep asking until number is between 1 and 5<br><br>

    &nbsp;&nbsp;printf("You chose: %d\n", number); // Print the valid number<br>
    &nbsp;&nbsp;return 0;<br>
    }
  </div>
<p>Example Result:</p>
<div class="w3-padding w3-black w3-margin-bottom">
<code>Choose a number between 1 and 5: 8<br>
Choose a number between 1 and 5: -2<br>
Choose a number between 1 and 5: 4<br>
You chose: 4</code>
</div>
</div>
<!--stop-->
...
<!--start-->
<h2>Validate Text Input</h2>
<p>Check that a name is not empty. Use <code class="w3-codespan">fgets()</code> and check the first character:</p>
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate javaHigh">
    ...
    int main() {<br>
    &nbsp;&nbsp;char name[100]; // Buffer to store the user's name<br><br>

    &nbsp;&nbsp;do {<br>
    &nbsp;&nbsp;&nbsp;&nbsp;printf("Enter your name: ");<br>
    &nbsp;&nbsp;&nbsp;&nbsp;fgets(name, sizeof(name), stdin); // Read input as a string<br>
    &nbsp;&nbsp;&nbsp;&nbsp;name[strcspn(name, "\n")] = 0; // Remove the newline character if present<br>
    &nbsp;&nbsp;} while (strlen(name) == 0); // Repeat if the input is empty<br><br>

    &nbsp;&nbsp;printf("Hello, %s\n", name); // Greet the user<br>
    &nbsp;&nbsp;return 0;<br>
    }
  </div>
<p>Example Result:</p>
<div class="w3-padding w3-black w3-margin-bottom">
<code>Enter your name: <br>
Enter your name: <br>
...
<!--start-->
<h2>Validate Integer Input</h2>
<p>Make sure the user enters a number. If they enter something else (like a letter), ask again using <code class="w3-codespan">fgets()</code> and <code class="w3-codespan">sscanf()</code>:</p>
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate javaHigh">
    ...
    int main() {<br>
    &nbsp;&nbsp;int number;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Variable to store the user's number<br>
    &nbsp;&nbsp;char input[100];&nbsp; // Buffer to hold user input as a string<br><br>

    &nbsp;&nbsp;printf("Enter a number: ");<br><br>

    &nbsp; // Keep reading input until the user enters a valid integer<br>
    &nbsp;&nbsp;while (fgets(input, sizeof(input), stdin)) {<br>
    &nbsp;&nbsp;&nbsp;&nbsp;// Try to read an integer from the input string<br>
    &nbsp;&nbsp;&nbsp;&nbsp;if (sscanf(input, "%d", &amp;number) == 1) {<br>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;break; // Success: break out of the loop<br>
    &nbsp;&nbsp;&nbsp;&nbsp;} else {<br>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;printf("Invalid input. Try again: "); // 
    If not an integer, ask again<br>
    &nbsp;&nbsp;&nbsp;&nbsp;}<br>
    &nbsp;&nbsp;}<br><br>&nbsp; // Print the valid number entered by 
    the user<br>
...
<p>Example Result:</p>
<div class="w3-padding w3-black w3-margin-bottom">
<code>Enter a number: AB<br>
Invalid input. Try again: 3.5<br>
Invalid input. Try again: 35<br>
You entered: 35</code>
</div>
</div>
<!--stop-->

<p><strong>Tip:</strong> You can read more about <code class="w3-codespan"><a href="ref_stdio_fgets.php">fgets()</a></code> and <code class="w3-codespan"><a href="ref_stdio_sscanf.php">sscanf()</a></code> in our 
<a href="c_ref_stdio.php">&lt;stdio.h&gt; library reference</a>.</p>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_error_handling.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_date_time.php">Next &#10095;</a>
