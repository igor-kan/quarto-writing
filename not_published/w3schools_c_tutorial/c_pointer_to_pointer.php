<!DOCTYPE html>
<html lang="en-US">
<title>C Pointer to Pointer (Double Pointer)</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>C <span class="color_h1">Pointer to Pointer</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_pointers_arithmetic.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_challenges_pointers.php">Next &#10095;</a>
</div>
<hr>

<h2>Pointer to Pointer</h2>

<p>You can also have a <strong>pointer that points to another pointer</strong>.  
This is called a <strong>pointer to pointer</strong> (or "double pointer").</p>

<p>It might sound confusing at first, but it's just one more level of indirection:  
a pointer that stores the <em>address of another pointer</em>.</p>

<div class="ws-note ws-panel">
  <p><strong>Think of it like this:</strong>  
  A normal pointer is like a note with an address on it.  
  A pointer to pointer is like another note telling you where that first note is kept.</p>
  <p><strong>Note:</strong>  
  Pointer to pointer is not something you need to use often as a beginner.  
  However, you might see it in more advanced programs,  
  so it's good to understand what it means and how it works.</p>

</div>

<p>Let's look at a simple example to understand how this works:</p>

<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    int myNum = 10; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// normal variable<br>
    int *ptr = &myNum; &nbsp;&nbsp;&nbsp;// pointer to int<br>
    int **pptr = &ptr; &nbsp;&nbsp;&nbsp;// pointer to pointer<br><br>
    printf("myNum = %d\n", myNum);<br>
    printf("*ptr = %d\n", *ptr);<br>
    printf("**pptr = %d\n", **pptr);</div>
  <p>Result:</p>
  <div class="w3-black w3-padding">
    <code>myNum = 10<br>*ptr = 10<br>**pptr = 10</code>
  </div>
  <p><a target="_blank" class="w3-btn" href="tryc.php?filename=demo_pointer_to_pointer">Try it Yourself &raquo;</a></p>
</div>

<p>Here's what happens step by step:</p>
<ul>
  <li><code class="w3-codespan">myNum</code> holds the value <code class="w3-codespan">10</code>.</li>
  <li><code class="w3-codespan">ptr</code> holds the address of <code class="w3-codespan">myNum</code>.</li>
  <li><code class="w3-codespan">pptr</code> holds the address of <code class="w3-codespan">ptr</code>.</li>
  <li><code class="w3-codespan">*ptr</code> gives the value of <code class="w3-codespan">myNum</code>.</li>
  <li><code class="w3-codespan">**pptr</code> also gives the value of <code class="w3-codespan">myNum</code>, by going through both pointers.</li>
</ul>

<p>So:</p>
<ul>
  <li><code class="w3-codespan">*ptr</code> = value of <code class="w3-codespan">myNum</code></li>
  <li><code class="w3-codespan">**pptr</code> = value of <code class="w3-codespan">myNum</code> through both levels</li>
</ul>
...
<h2>Changing Values Through a Pointer to Pointer</h2>

<p>Since <code class="w3-codespan">**pptr</code> accesses the original variable,  
you can use it to change the value of the variable too:</p>
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate javaHigh">
    ...
    int *ptr = &myNum;<br>
    int **pptr = &ptr;<br><br>
    **pptr = 20; // changes myNum<br><br>
    printf("myNum = %d\n", myNum); // prints 20</div>
  <p><a target="_blank" class="w3-btn" href="tryc.php?filename=demo_pointer_to_pointer2">Try it Yourself &raquo;</a></p>
</div>
...
<ul>
  <li>A <strong>pointer to pointer</strong> stores the address of another pointer.</li>
  <li><code class="w3-codespan">*ptr</code> gives the value of a variable.</li>
  <li><code class="w3-codespan">**pptr</code> gives the same value by following two levels of indirection.</li>
  <li>They can be useful when passing <a href="c_functions_pointers.php">pointers to functions</a> or working with complex data structures.</li>
</ul>
<hr>
<br>
<div class="w3-clear nextprev">
