...
<h1>C <span class="color_h1">Statements</span></h1>

<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_syntax.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_challenges_syntax.php">Next &#10095;</a>
</div>
<hr>

<h2>Statements</h2>
<p>A <strong>computer program</strong> is a list of instructions that a computer follows.</p>
<p>In C, these instructions are called <strong>statements</strong>.</p>

<p>The following statement tells the program to print the text <code class="w3-codespan">Hello World!</code> to the screen:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  printf(&quot;Hello World!&quot;);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_statements">Try it Yourself &raquo;</a>
</div>

<p>Every statement in C must end with a semicolon <code class="w3-codespan">;</code>.</p>

<p>If you forget the semicolon, the compiler will show an error and the program will not run:</p>
...
<code>error: expected ';' before 'return'</code>
</div>

<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="tryc.php?filename=demo_statements_error">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Many Statements</h2>
<p>Most C programs contain more than one statement.</p>
<p>Statements are executed one by one, in the same order as they are written:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  printf(&quot;Hello World!&quot;);<br>
  printf(&quot;Have a good day!&quot;);<br>
  return 0;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_statements2">Try it Yourself &raquo;</a>
</div>

<h4>Example explained</h4>
<p>This program contains three statements:</p>

<ol>
  <li><code class="w3-codespan">printf(&quot;Hello World!&quot;);</code></li>
  <li><code class="w3-codespan">printf(&quot;Have a good day!&quot;);</code></li>
  <li><code class="w3-codespan">return 0;</code></li>
</ol>

<p>The first statement runs first and prints <code class="w3-codespan">Hello World!</code>.<br>
Then the second statement runs and prints <code class="w3-codespan">Have a good day!</code>.<br>
Finally, the last statement runs and ends the program.</p>

<div class="ws-note w3-panel">
<p><strong>Remember:</strong> Each statement is one instruction, and it must end with a semicolon.</p>
<p><strong>Coming up:</strong> The next chapter will show you how to control output and add new lines.</p>
</div>
...
<div id="exercisecontainer" src="xrcise_statements.js" data-extensions="php"></div>
<hr>
