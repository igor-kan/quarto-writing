...
ny:-->
    ...
    <h1>C <span class="color_h1">Do/While Loop</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_while_loop.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_while_loop_reallife.php">Next &#10095;</a>
</div>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_while_do">Try it Yourself &raquo;</a>
</div>
...
<!--start-->
<h2>Condition is False from the Start</h2>
<p>
  In the example above, the condition <code class="w3-codespan">i &lt; 5</code> was <strong>true</strong> at the beginning,
  so the loop executed multiple times. But what if the condition is <strong>false</strong> right from the start?</p>
<p>
  In the example below, the variable <code class="w3-codespan">i</code> starts at <code class="w3-codespan">10</code>,
  so the condition <code class="w3-codespan">i &lt; 5</code> is false immediately 
  - yet the <code class="w3-codespan">do/while</code> loop still runs once:</p>
<div class="w3-example">
<h3>Example</h3>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_do_while_false">Try it Yourself &raquo;</a>
</div>

<div class="ws-note ws-panel">
<h3>Summary</h3>
<p>
  The <code class="w3-codespan">do/while</code> loop always runs at least once, even if the condition is already false.
  This is different from a regular <a href="c_while_loop.php"><code class="w3-codespan">while</code></a> loop, which would skip the loop entirely if the condition is false at the start.
</p>
<p>
  This behavior makes <code class="w3-codespan">do/while</code> useful when you want to ensure something happens at least once,
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="/cpp/showcpp.asp?filename=demo_do_while_userinput_c">Run Example &raquo;</a>
</div>
<div class="ws-note ws-panel">
<p><strong>Note:</strong> You will learn more about the <code class="w3-codespan">scanf()</code> function and <a href="c_user_input.php">user input</a> in a later chapter.</p>
</div>
<!--stop-->
...
<div id="exercisecontainer" src="xrcise_do_while_loop.js" data-extensions="php"></div>
<hr>
