<!DOCTYPE html>
<html lang="en-US">
<title>C Logical Operators</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>C <span class="color_h1">Logical Operators</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_operators_comparison.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_operators_precedence.php">Next &#10095;</a>
</div>
<hr>

<h2>Logical Operators</h2>

<p>As with <a href="c_operators_comparison.php">comparison operators</a>, you can also test for true or false values with logical operators.</p>
<p>Logical operators are used to determine the logic between variables or 
values, by combining multiple conditions:</p>
...
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryc.php?filename=demo_oper_logical1">Try it &raquo;</a></td>
</tr>
<tr>
<td>||&nbsp;</td>
<td>OR</td>
<td>x &lt; 5 || x &lt; 4</td>
<td>Returns 1 if one of the statements is true</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryc.php?filename=demo_oper_logical2">Try it &raquo;</a></td>
</tr>
<tr>
<td>!</td>
<td>NOT</td>
<td>!(x &lt; 5 &amp;&amp; x &lt; 10)</td>
<td>Reverse the result, returns 0 if the result is 1</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryc.php?filename=demo_oper_logical3">Try it &raquo;</a></td>
</tr>
</table>
</div>
<!--stop-->
...
<h2>Real-Life Example: Login Check</h2>
<p>The example below shows how logical operators can be used in a real situation, e.g. when checking login status and access rights:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-c w3-white"><code>int isLoggedIn = 1;
int isAdmin = 0;
...
<p>
<a target="_blank" class="w3-btn" href="tryc.php?filename=demo_oper_logical_real">Try it Yourself &raquo;</a>
</p>
</div>
<div class="ws-note ws-panel">
  <p>Remember: in C, <code class="w3-codespan">1</code> means true and <code class="w3-codespan">0</code> means false. Logical operators often become easier to understand once you start using them inside <code class="w3-codespan">if</code> statements, which you will learn about in the upcoming chapters.</p>
</div>
