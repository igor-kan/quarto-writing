<!DOCTYPE html>
<html lang="en-US">
<title>C Comparison Operators</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>C <span class="color_h1">Comparison Operators</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_operators_assignment.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_operators_logical.php">Next &#10095;</a>
</div>
<hr>
...
<p>The return value of a comparison is either <code class="w3-codespan">1</code> or <code class="w3-codespan">0</code>, which means <strong>true</strong> (<code class="w3-codespan">1</code>) or <strong>false</strong> (<code class="w3-codespan">0</code>). These values are known as 
<strong>Boolean values</strong>, and you will learn more about them in the <a href="c_booleans.php">Booleans</a> and <a href="c_conditions.php">If..Else</a> chapter.</p>

<!--
The return value of a comparison is either 1 or 0, which means true (1) or false (0). These values are known as Boolean values, and you will learn more about them in the Booleans and If..Else chapter.

<p>Comparison operators are used to compare two values.</p>
<p><strong>Note:</strong> The return value of a comparison is either true (<code class="w3-codespan">1</code>) or false (<code class="w3-codespan">0</code>).</p>
-->
...
<div class="w3-code notranslate javaHigh">
  int x = 5;<br>int y = 3;<br>printf(&quot;%d&quot;, x &gt; y); // returns 1 (true) because 5 is greater than 3</div>
<a class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_oper_compare3" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<th style="width:12%;text-align:right">Try it</th>
</tr>
<tr>
<td>==</td>
<td>Equal to</td>
...
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryc.php?filename=demo_oper_compare1">Try it &raquo;</a></td>
</tr>
<tr>
<td>!=</td>
<td>Not equal</td>
<td>x != y</td>
<td>Returns 1 if the values are not equal</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryc.php?filename=demo_oper_compare2">Try it &raquo;</a></td>
</tr>
<tr>
<td>&gt;</td>
<td>Greater than</td>
<td>x &gt; y</td>
<td>Returns 1 if the first value is greater than the second value</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryc.php?filename=demo_oper_compare3">Try it &raquo;</a></td>
</tr>
<tr>
<td>&lt;</td>
<td>Less than</td>
...
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryc.php?filename=demo_oper_compare4">Try it &raquo;</a></td>
</tr>
  <tr>
<td>&gt;=</td>
...
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryc.php?filename=demo_oper_compare5">Try it &raquo;</a></td>
  </tr>
<tr>
<td>&lt;=</td>
...
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryc.php?filename=demo_oper_compare6">Try it &raquo;</a></td>
</tr>
</table>
</div>
...
<p>Comparison operators are often used in real-world conditions, such as checking if a person is old enough to vote:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-c w3-white"><code>int age = 18;

printf("%d\n", age &gt;= 18); // 1 (true), old enough to vote
printf("%d\n", age &lt; 18);  // 0 (false)
</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryc.php?filename=demo_oper_compare_real">Try it Yourself &raquo;</a>
</p>
</div>

<p>Another common use is checking if a password is long enough:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-c w3-white"><code>int passwordLength = 5;

printf("%d\n", passwordLength &gt;= 8); // 0 (false), too short
printf("%d\n", passwordLength &lt; 8);  // 1 (true), needs more characters
</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryc.php?filename=demo_oper_password_length">Try it Yourself &raquo;</a>
</p>
</div>
