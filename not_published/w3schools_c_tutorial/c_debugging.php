...
ny:-->
    ...
    <h1>C <span class="color_h1">Debugging</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_challenges_errors.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_null.php">Next &#10095;</a>
</div>
<hr>
...
<p>Debugging is the process of finding and fixing errors (bugs) in your program.</p>

<p>Bugs are mistakes that make your program crash, behave incorrectly, or give the wrong output.</p>
...
<ul>
  ...
  <li>Give your variables <strong>clear, meaningful names</strong> that describe what they store.</li>
</ul>

<p>Clean code is easier to read - and easier to debug!</p>

<p>In the sections below, we'll introduce several common debugging techniques.</p>
<hr>

<h3>1. Print Debugging</h3>

<p>Use <code class="w3-codespan">printf()</code> to print values at different points 
in your code to see what's going wrong:</p>

<div class="w3-example">
<div class="w3-code notranslate javaHigh w3-border-red">
  int x = 10;<br>int y = 0;<br>printf(&quot;Before division\n&quot;); // Debug output<br>
  int z = x / y; // Crashes (division by zero)<br>printf(&quot;After division\n&quot;); // 
  Never runs</div>
</div>

<p>If you don't see "After division", the program crashed at <code class='w3-codespan'>x / y</code>.</p>
...
<div class="w3-example">
<div class="w3-code notranslate javaHigh w3-border-red">
  int x = 10;<br>int y = 5;<br>int result = x - y;<br><br>printf(&quot;Result: 
  %d\n&quot;, result); // Result: 5</div>
</div>

<p>Expected <code class="w3-codespan">15</code>? That means the logic is wrong: try using 
<code class='w3-codespan'>x + y</code> instead.</p>
<hr>
...
<ul>
  <li>Pause your program using <strong>breakpoints</strong></li>
  <li>Step through your code line by line</li>
  <li>Watch variables and see unexpected values as they change</li>
</ul>
<p><strong>Tip:</strong> Start with <code class="w3-codespan">printf()</code> debugging. Once you're comfortable, explore your IDE's debugger to get even better insights into your code.</p>
...
<h3>4. Learn from Error Messages</h3>

<p>The C compiler and runtime errors often tell you <strong>what went wrong</strong> and <strong>where</strong>. For example:</p>
<div class="w3-example">
<div class="w3-padding w3-black">
<code>error: expected ';' before 'printf'</code>
</div>
</div>

<p><strong>Easy solution:</strong> Fix the missing semicolon!</p>
<!--stop-->
<hr>

<!--start-->
<h2>Debugging with Safe Checks</h2>
<p>Some bugs, like dividing by zero (used in the first example of this page), are known to cause crashes.</p>
<p>If you know an operation could fail, you can check for it in advance and avoid the crash:</p>
<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    ...
    <br>
    &nbsp;&nbsp;if (y != 0) { // // Check that y is not zero before dividing<br>
    &nbsp;&nbsp;&nbsp;&nbsp;int z = x / y;<br>
    &nbsp;&nbsp;&nbsp;&nbsp;printf("Result: %d\n", z);<br>
    &nbsp;&nbsp;} else {<br>
    &nbsp;&nbsp;&nbsp;&nbsp;printf("Error: Division by zero!\n"); // // Print error message instead of crashing<br>
    &nbsp;&nbsp;}<br>
    <br>
  ...
  <a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_debugging_safe">Try it Yourself &raquo;</a>
</div>

<p>Now, instead of crashing, the program prints an error message and continues running. This is an important part of writing safe, debuggable code.</p>

<h3>Another Example - Out-of-Bounds Array Access</h3>
<p>Accessing elements outside the array is another common mistake.</p>
<p>In the example below, we use <code class="w3-codespan">printf()</code> to check the index value before using it:</p>
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate javaHigh">
    ...
    int main() {<br>
    &nbsp;&nbsp;int numbers[3] = {10, 20, 30};<br>
    &nbsp;&nbsp;int index = 5;<br><br>

    &nbsp;&nbsp;printf("Index = %d\n", index);<br>

    &nbsp;&nbsp;if (index &gt;= 0 &amp;&amp; index &lt; 3) { // Make sure the index is within the valid range (0 to 2)<br>
    &nbsp;&nbsp;&nbsp;&nbsp;printf("Value = %d\n", numbers[index]);<br>
    &nbsp;&nbsp;} else {<br>
  ...
  <a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_debugging_array">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Summary</h2>
<ul> 
<li>Use <code class="w3-codespan">printf()</code> to print values and trace your code.</li>
<li>Read error messages carefully - they often tell you what went wrong and where.</li>
<li>Add checks (like <code class="w3-codespan">if (y != 0)</code>) to avoid crashes before they happen.</li>
<li>Use an IDE's debugger when you're ready for deeper debugging.</li>
<li>Debugging helps you understand your program better and fix problems faster.</li>
</ul>
<!--stop-->
<hr>
<!--start-->
<h2>Error Handling</h2>
<p>While debugging is about finding and fixing mistakes in your code during development, <strong>error handling</strong> is a way to deal with problems while the program is running, and run specific code when something goes wrong.</p>
<p>You will learn about <a href="c_null.php">NULL Pointers</a> and <a href="c_error_handling.php">Error Handling</a> in the next chapters.</p>
<!--stop-->
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_challenges_errors.php">&#10094; Previous</a>
