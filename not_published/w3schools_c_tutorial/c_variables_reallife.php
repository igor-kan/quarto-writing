<!DOCTYPE html>
<html lang="en-US">
<title>C Variables - Real Life Examples</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>C <span class="color_h1">Variables - Examples</span></h1>

<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_variables_names.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_challenges_variables.php">Next &#10095;</a>
</div>
<hr>

<!--start-->
<h2>Real-Life Example</h2>
<p>Often in our examples, we simplify variable names to match their data type (myInt 
or myNum for <code class="w3-codespan">int</code> types, myChar for <code class="w3-codespan">char</code> types, 
and so on). This is done to avoid confusion. </p><p>In real programs, variables often represent real-world data.</p>

<p>The following example stores information about a college student:</p>
...
<div class="w3-code notranslate javaHigh">
  // Student data<br>
  int studentID = 15;<br>
  int studentAge = 23;<br>
  float studentFee = 75.25;<br>
  char studentGrade = 'B';<br><br>
  // Print variables<br>
  printf(&quot;Student ID: %d\n&quot;, studentID);<br>
  printf(&quot;Student age: %d\n&quot;, studentAge);<br>
  printf(&quot;Student fee: %f\n&quot;, studentFee);<br>
  printf(&quot;Student grade: %c&quot;, studentGrade);</div>
...
<p><strong>Notice:</strong> Each variable stores a different type of information, but they are all used together in one program.</p>
</div>
<!--stop-->
<hr>
...
<p>Variables are often used to store values, perform calculations, and then show the result.</p>
<p>In this example, we calculate the area of a rectangle:</p>
...
<div class="w3-code notranslate javaHigh">
  ...
  printf(&quot;Length is: %d\n&quot;, length);<br>
  printf(&quot;Width is: %d\n&quot;, width);<br>
  printf(&quot;Area of the rectangle is: %d&quot;, area);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_variables_reallife2">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
<p><strong>Tip:</strong> Calculations are usually done first, and the result is stored in a variable before being printed.</p>
</div>
<!--stop-->
