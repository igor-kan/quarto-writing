<!DOCTYPE html>
<html lang="en-US">
<title>C The else Statement</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>C <span class="color_h1">Else</span></h1>

<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_conditions.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_conditions_elseif.php">Next &#10095;</a>
</div>
<hr>
...
<p>
Use the <code class="w3-codespan">else</code> statement to specify a block of code
to be executed if the condition is <code class="w3-codespan">false</code>.
</p>
...
<p>
In the example below, the program checks the value of <code class="w3-codespan">time</code>.
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_if_else">
Try it Yourself &raquo;
</a>
</div>

<h4>Example explained</h4>
<p>In the example above, <code class="w3-codespan">time</code> (20) is greater than 18, so the condition is <code class="w3-codespan">false</code>. 
Because of this, we move on to the <code class="w3-codespan">else</code> condition and print to the screen "Good 
evening". If <code class="w3-codespan">time</code> was less than 18, the program would print "Good day".</p><!--stop-->
...
<p>
You can also store the condition in a boolean variable and use it in the <code class="w3-codespan">if...else</code> statement.
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_if_else_bool">
Try it Yourself &raquo;
</a>
</div>
...
<p>
<strong>Tip:</strong> A name like <code class="w3-codespan">isDay</code> makes it easy to understand what the condition means.
</p>
</div><!--stop-->
...
<div id="exercisecontainer" src="xrcise_conditions_else.js" data-extensions="php"></div>
<hr>
