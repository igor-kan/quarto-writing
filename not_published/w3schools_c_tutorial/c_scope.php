...
ny:-->
    ...
    <h1>C <span class="color_h1">Variable Scope</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_functions_parameters.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_functions_decl.php">Next &#10095;</a>
</div>
<hr>

<!--start-->
<h2>Scope</h2>
<p>Now that you understand how functions work, it is important to 
learn how variables act inside and outside of functions.</p>
<p>In C, variables are only accessible inside the region they are created. This is called <strong>scope</strong>.</p>
<!--stop-->
<hr>

<!--start-->
<h2>Local Scope</h2>
<p>A variable created inside a function belongs to the <em>local scope</em> 
of that function, and can only be used inside that function:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  void myFunction() {<br>&nbsp; // Local variable that belongs to myFunction<br>&nbsp; int x = 5;<br><br>&nbsp; 
  // Print the variable x<br>&nbsp; printf(&quot;%d&quot;, x); <br>}<br><br>int main() {<br>&nbsp; myFunction();<br>&nbsp; return 
  0;<br>}<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_scope">Try it Yourself &raquo;</a>
</div>

<p>A <strong>local variable</strong> cannot be used outside the function it belongs to. </p>
<p>If you try to access it outside the function, an error occurs:</p>

<div class="w3-example w3-pale-red">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh w3-border-red ">
  void myFunction() {<br>&nbsp; // Local variable that belongs to myFunction<br>&nbsp; 
  int x = 5;<br>}<br><br>int main() 
  {<br>&nbsp; myFunction();<br><br>&nbsp; // Print the variable x in the main 
  function<br>&nbsp; 
  printf(&quot;%d&quot;, x); <br>&nbsp; return 0;<br>}<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_scope_error">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<!--start-->
<h2>Global Scope</h2>
<p><p>A variable created outside of a function, is called a <strong>global variable</strong> and 
belongs to the <em>global scope</em>.</p>
<p>Global variables are available from within any scope, global and local:</p>
<div class="w3-example">
<h3>Example</h3>
<p>A variable created outside of a function is global and can therefore be used by anyone:</p>
<div class="w3-code notranslate javaHigh">
  // Global variable x<br>int x = 5;<br><br>void myFunction() {<br>&nbsp; // We 
  can use x here<br>&nbsp; printf(&quot;%d&quot;, x); <br>}<br><br>int main() {<br>&nbsp; myFunction();<br>
  <br>&nbsp; // We can also use x here<br>&nbsp; printf(&quot;%d&quot;, x);<br>&nbsp; return 
  0;<br>}<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_scope_global">Try it Yourself &raquo;</a>
</div>

<h3>Naming Variables</h3>
<p>If you operate with the same variable name inside and outside of a function, 
C will treat them as two separate variables; One available in the global scope (outside the function) and one available in the local scope (inside the function):</p>
<div class="w3-example">
<h3>Example</h3>
<p>The function will print the local <code class="w3-codespan">x</code>, and 
  ...
  <div class="w3-code notranslate javaHigh">
  // Global variable x<br>int x = 5;<br><br>void myFunction() {<br>&nbsp; // Local 
  variable with the same name as the global variable (x)<br>&nbsp; int x = 22;<br>&nbsp; 
  printf(&quot;%d\n&quot;, x); // Refers to the local variable x<br>}<br><br>int main() {<br>&nbsp; myFunction();<br><br>&nbsp; 
  printf(&quot;%d\n&quot;, x); // Refers to the global variable x<br>&nbsp; return 0;<br>}<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_scope_global2">Try it Yourself &raquo;</a>
</div>
<p>However, you should avoid using the same variable name for both globally and locally variables as it can lead to errors and confusion.</p>

<p>In general, you should be careful with global variables, since they can be 
accessed and modified from any function:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Change the value of <code class="w3-codespan">x</code> from <code class="w3-codespan">myFunction</code>:</p>
  <div class="w3-code notranslate javaHigh">
    // Global variable<br>int x = 5;<br><br>void myFunction() {<br>&nbsp; 
    printf(&quot;%d\n&quot;, ++x); // Increment the value of x by 1 and print it<br>}<br>
    <br>int main() {<br>&nbsp; myFunction();<br><br>&nbsp; printf(&quot;%d\n&quot;, x); // 
    Print the global variable x<br>&nbsp; return 0;<br>}<br><br>// The value of 
    x is now 6 (no longer 5)<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_scope_global3">Try it Yourself &raquo;</a>
</div>
<!--stop-->
...
<!--start-->
<h2>Conclusion</h2>
<p>To sum up, use local variables (with good variable names) as much as you can. This will make your code easier to maintain and 
better to understand. However, you may find global variables when working on existing C programs or 
while collaborating with others. Therefore, it is good to understand how the scope works and how to use it effectively to make sure your code is clear and functional.</p>
<!--stop-->

<hr>
<div id="exercisecontainer" src="xrcise_scope.js" data-extensions="php"></div>
<hr>
