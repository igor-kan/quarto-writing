...
ny:-->
    ...
    <h1>C <span class="color_h1">Preprocessor and Macros</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_random_numbers.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_organize_code.php">Next &#10095;</a>
</div>
<hr>

<!--start-->
<h2>Preprocessor and Macros</h2>

<p>In C, the <strong>preprocessor</strong> runs before the actual compilation begins. It handles things like including files and defining 
<strong>macros</strong>.</p>

<p>Preprocessor commands begin with a <code class="w3-codespan">#</code> symbol and are called <strong>directives</strong>.</p>
<!--stop-->
<hr>

<!--start-->
<h2>#include - Include Header Files</h2>
<p>You have already seen the <code class="w3-codespan">#include</code> directive many times - It tells the compiler to include a file.</p>
<p>It is used to add libraries or custom header files:</p>

<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
#include &lt;stdio.h&gt;<br>#include "myfile.h"
  </div>
</div>

<p>Use angle brackets <code class="w3-codespan">&lt; &gt;</code> for standard libraries and double quotes <code class="w3-codespan">" "</code> for your own files.</p>
<p><strong>Tip:</strong> The most commonly used libraries can be found in our <a href="c_ref_reference.php">C 
Reference Documentation</a>.</p>
<!--stop-->
<hr>

<!--start-->
<h2>#define - Create a Macro</h2>
<p>A macro is a name that represents a value (like PI), or a piece of code, 
defined using the <code class="w3-codespan">#define</code> directive.</p>
<p>In the example below, <code class="w3-codespan">PI</code> is replaced with <code class="w3-codespan">3.14</code> 
before the program is compiled.</p>
<p>This means that every time <code class="w3-codespan">PI</code> appears in the 
code, it will be replaced with <code class="w3-codespan">3.14</code>:</p>
<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    #define PI 3.14<br><br>int main() {<br>&nbsp; printf("Value of PI: %.2f\n", PI);<br>&nbsp; return 0;<br>}
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_macros_define">Try it Yourself &raquo;</a>
</div>

<p>Macros can also take parameters, like a function:</p>

<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    #define SQUARE(x) ((x) * (x))<br><br>int main() {<br>&nbsp; printf("Square of 4: %d\n", SQUARE(4));<br>&nbsp; return 0;<br>}
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_macros_define2">Try it Yourself &raquo;</a>
</div>

<p>Macros with parameters work like shortcuts, but be careful with parentheses to avoid mistakes.</p>
<!--stop-->
...
<!--start-->
<h2>#ifdef and #ifndef - Conditional Compilation</h2>

<p>The <code class="w3-codespan">#ifdef</code> and <code class="w3-codespan">#ifndef</code> directives let you include or skip parts of the code depending on whether a macro is defined.</p> <p>This is called <strong>conditional compilation</strong>, and it's useful for debugging or creating different versions of a program.</p>

<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    #define DEBUG<br><br>int main() {<br>&nbsp; #ifdef DEBUG<br>&nbsp;&nbsp;&nbsp; printf("Debug mode is ON\n");<br>&nbsp; #endif<br>&nbsp; return 0;<br>}
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_macros_ifdef">Try it Yourself &raquo;</a>
</div>

<p>If <code class="w3-codespan">DEBUG</code> is defined, the message will be printed. If it's not defined, that part of the code is skipped.</p>    
<hr>
<h2>Create Your own Header Files</h2>
<p>In the next chapter, you will learn how to create your own header files and organize your code across multiple files using "modular programming".</p>
<!--stop-->
