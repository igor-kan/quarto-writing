<!DOCTYPE html>
<html lang="en-US">
<title>C Short Hand If ... Else (Ternary Operator)</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>C <span class="color_h1">Short Hand If Else</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_conditions_elseif.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_conditions_nested.php">Next &#10095;</a>
</div>
<hr>

<!--start-->
<h2>Short Hand If...Else (Ternary Operator)</h2>
<p>There is also a short-hand <code class="w3-codespan">if...else</code>, known as the <strong>ternary operator</strong> 
because it uses three operands.</p>

<p>The ternary operator <em>returns a value</em> based on a condition: if the condition is <code class="w3-codespan">true</code>, it returns the first value; otherwise, it returns the second value.</p>

<p>It can be used to replace multiple lines of code with a single line, and is often used to replace simple <code class="w3-codespan">if...else</code> statements:</p>
<div class="w3-example">
<h3>Syntax</h3>
<div class="w3-code notranslate javaHigh">

  <em>variable</em> = (<em>condition</em>) ? <em>expressionTrue</em> : <em>
  expressionFalse</em>;<br>
 </div>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  int time = 20;<br>if (time &lt; 18) {<br>&nbsp; printf(&quot;Good day.&quot;);<br>} else {<br>&nbsp; 
  printf(&quot;Good evening.&quot;);<br>}</div>
...
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  int time = 20;<br>(time &lt; 18) ? printf(&quot;Good day.&quot;) : printf(&quot;Good evening.&quot;);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_if_ternary">Try it Yourself &raquo;</a>
</div>

<p>It is completely up to you if you want to use the traditional if...else statement or the ternary operator.</p>
<!--stop-->
...
<div id="exercisecontainer" src="xrcise_conditions_short_hand.js" data-extensions="php"></div>
<hr>
