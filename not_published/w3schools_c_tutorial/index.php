...
<a class="w3-right w3-btn" href="c_intro.php">Next &#10095;</a>
</div>
  ...
  <div class="cert-card">
    <div class="cert-card-header">
      <div class="cert-card-icon">
        <svg xmlns="http://www.w3.org/2000/svg" width="39" height="39" fill="#A8B9CC" viewBox="0 0 24 24"><path d="M16.5921 9.1962s-.354-3.298-3.627-3.39c-3.2741-.09-4.9552 2.474-4.9552 6.14 0 3.6651 1.858 6.5972 5.0451 6.5972 3.184 0 3.5381-3.665 3.5381-3.665l6.1041.365s.36 3.31-2.196 5.836c-2.552 2.5241-5.6901 2.9371-7.8762 2.9201-2.19-.017-5.2261.034-8.1602-2.97-2.938-3.0101-3.436-5.9302-3.436-8.8002 0-2.8701.556-6.6702 4.047-9.5502C7.444.72 9.849 0 12.254 0c10.0422 0 10.7172 9.2602 10.7172 9.2602z"></path></svg>
      </div>
      <h2 class="cert-card-title">Learn C</h2>
    </div>
    <p class="cert-card-desc">C is a general-purpose programming language that has been widely used for over 50 years.</p>
    <p class="cert-card-desc">C is very powerful; it has been used to develop operating systems, databases, applications, etc.</p>
    <div class="cert-card-bottom" style="margin-top:auto;padding-top:16px;">
      <a href="c_intro.php" class="cert-card-btn">Learn C now &#10095;</a>
    </div>
  </div>

  <div class="cert-info" style="padding:24px;display:flex;flex-direction:column;">
    <h3 class="cert-info-title">Become C Certified</h3>
    <p class="cert-info-desc">Get certified with our C exam, includes a professionally curated study kit to guide you from beginner to exam-ready.</p>
...
<a href="https://campus.w3schools.com/collections/course-catalog/products/learn-c" class="cert-card-btn cert-btn-white" target="_blank" style="margin-top:12px;background:#fff;color:#000;border:2px solid #000;">Get Certified &#10095;</a>
        </div>
        <div class="cert-preview" style="flex:1 1 auto;padding:0;align-self:flex-start;">
          <svg class="cert-preview-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 560 400" role="img" aria-label="C Certificate preview" style="width:100%;max-width:250px;height:auto;display:block;margin:0 0 0 auto;">
            ...
            <text x="280" y="212" text-anchor="middle" font-family="Source Sans Pro Topnav, sans-serif" font-size="13" fill="#475569">has passed the W3Schools C Certification exam and is hereby declared a</text>
            <g transform="translate(248,222)">
              <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="#A8B9CC" viewBox="0 0 24 24"><path d="M16.5921 9.1962s-.354-3.298-3.627-3.39c-3.2741-.09-4.9552 2.474-4.9552 6.14 0 3.6651 1.858 6.5972 5.0451 6.5972 3.184 0 3.5381-3.665 3.5381-3.665l6.1041.365s.36 3.31-2.196 5.836c-2.552 2.5241-5.6901 2.9371-7.8762 2.9201-2.19-.017-5.2261.034-8.1602-2.97-2.938-3.0101-3.436-5.9302-3.436-8.8002 0-2.8701.556-6.6702 4.047-9.5502C7.444.72 9.849 0 12.254 0c10.0422 0 10.7172 9.2602 10.7172 9.2602z"></path></svg>
            </g>
            <text x="280" y="300" text-anchor="middle" font-family="Source Sans Pro Topnav, sans-serif" font-size="18" font-weight="700" fill="#0f172a">Certified C Developer</text>
...
<p>Our "Try it Yourself" editor makes it easy to learn C. You can edit code and view 
the result in your browser:</p>
...
<div id="exercisecontainer" src="xrcise_output.js" data-extensions="php"></div>
<p><a class="w3-btn w3-margin-bottom ws-green" href="c_exercises.php" style="border-radius:5px;font-size: 18px;padding-left:25px;padding-right:25px;font-family: 'Source Sans Pro', sans-serif;margin-top:6px;">See all C Exercises</a></p>
<hr>
...
<ul  style="margin-left:-16px">
  <li>How C programs are structured</li>
  <li>Variables, data types, and operators</li>
  <li>If statements, loops, and arrays</li>
  <li>Functions and how to reuse code</li>
  <li>Pointers and memory</li>
  <li>Structures to organize related data</li>
  <li>Reading from and writing to files</li>
  <li>Organizing programs and build real-life projects</li>
</ul>
<hr>
...
/* Push the button to the bottom if content differs */
...
<div class="w3-row-padding equal-height-row" style="margin-left:-12px;margin-right:-12px">
  ...
  <div class="w3-col m6">
    <div class="w3-panel w3-border w3-round-large w3-padding equal-height-card w3-border-light-grey">
      <h2>C Quiz</h2>
<p>Check your understanding with a short quiz and see how well you know the basics of C.</p>
      <p>
        <a href="c_quiz.php" class="w3-button w3-blue w3-round">
          Start C Quiz
        </a>
      </p>
    </div>
  ...
  <div class="w3-col m6">
    <div class="w3-panel w3-border w3-round-large w3-padding equal-height-card w3-border-light-grey">
      ...
      <p>
        <a href="c_examples.php" class="w3-button w3-light-grey w3-round">
          See All C Examples
        </a>
      </p>
    </div>
...
<h2>C Reference</h2>
<p>You will also find complete keyword and function references:</p>

<div class="ref-grid">

  <a href="c_ref_reference.php" class="ref-box">Reference Overview</a>
  <a href="c_ref_keywords.php" class="ref-box">C Keywords</a>
  <a href="c_ref_stdio.php" class="ref-box">C stdio Functions</a>
  <a href="c_ref_stdlib.php" class="ref-box">C stdlib Functions</a>
  <a href="c_ref_string.php" class="ref-box">C string Functions</a>
  <a href="c_ref_math.php" class="ref-box">C math Functions</a>
  <a href="c_ref_ctype.php" class="ref-box">C ctype Functions</a>
  <a href="c_ref_time.php" class="ref-box">C time Functions</a>
