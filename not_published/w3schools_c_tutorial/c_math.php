...
ny:-->
    ...
    <h1>C <span class="color_h1">Math Functions</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_challenges_functions.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_functions_inline.php">Next &#10095;</a>
</div>
<hr>

<!--start-->
<h2>Math Functions</h2>
<p>There is also a list of math functions available, that allows you to perform mathematical tasks on numbers.</p>
<p>To use them, you must include the <code class="w3-codespan">math.h</code>
<strong>header file</strong> in your program:</p>
...
<p>To find the square root of a number, use the <code class="w3-codespan">sqrt()</code> 
function:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_math_sqrt">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<p>The <code class="w3-codespan">ceil()</code> function rounds a number upwards to its nearest integer, and the <code class="w3-codespan">floor()</code>  method rounds a number downwards to its nearest integer, and returns the result:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  printf(&quot;%f&quot;, ceil(1.4));<br>printf(&quot;%f&quot;, 
  floor(1.4));<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_math_ceil_floor">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<p>The <code class="w3-codespan">pow()</code> function returns the value of <em>x</em> to the power of
<em>y</em> (<em>x<sup>y</sup></em>):</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  printf(&quot;%f&quot;, pow(4, 3));<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_math_pow">Try it Yourself &raquo;</a>
</div>
<!--stop-->
...
<p>For a complete reference of math functions, go to our <a href="c_ref_math.php">C 
&lt;math.h&gt; Library Reference</a>.</p>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_math.js" data-extensions="php"></div>
<hr>
