<!DOCTYPE html>
<html lang="en-US">
<title>C Data Types Real-Life Example</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>C <span class="color_h1">Data Types Examples</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_data_types_sizeof.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_data_types_extended.php">Next &#10095;</a>
</div>
<hr>

<!--start-->
<h2>Real-Life Example</h2>
<p>Here's a real-life example of using different data types, to calculate and 
output the total cost of a number of items:</p>
