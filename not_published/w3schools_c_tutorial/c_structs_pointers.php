<!DOCTYPE html>
<html lang="en-US">
<title>C Structs and Pointers</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>C <span class="color_h1">Structs and Pointers</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_structs_nested.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_unions.php">Next &#10095;</a>
</div>
<hr>
...
<p>You can use pointers with structs to make your code more efficient, especially when passing structs to functions or changing their values.</p>
<p>To use a pointer to a struct, just add the <code class="w3-codespan">*</code> symbol, like you would with other data types.</p>
<p>To access its members, you must use the <code class="w3-codespan">-&gt;</code> operator instead of the dot <code class="w3-codespan">.</code> syntax:</p>

<div class="w3-example">
  <h3>Example</h3>
  <pre class="language-c w3-white"><code>// Define a struct
struct Car {
  char brand[30];
  int year;
};
...
int main() {
  ...
  <p><a target="_blank" class="w3-btn" href="tryc.php?filename=demo_structs_pointers"><strong>Try it Yourself &raquo;</strong></a></p>
</div>
<!--stop-->
<hr>

<!--start-->
<h2>Passing Struct Pointers to Functions</h2>

<p>Here's how you can pass a struct pointer to a function and change its values:</p>

<div class="w3-example">
  <h3>Example</h3>
  <pre class="language-c w3-white"><code>struct Car {
  char brand[30];
  int year;
};
...
int main() {
  ...
  <p><a target="_blank" class="w3-btn" href="tryc.php?filename=demo_structs_pointers2"><strong>Try it Yourself &raquo;</strong></a></p>
</div>
<!--stop-->
...
<!--start-->
<h2>Why Use Struct Pointers?</h2>
<p>Using pointers with structs is helpful when:</p>

<ul>
  <li><strong>You want to avoid copying large amounts of data.</strong><br>
  Instead of copying a whole struct, you can just pass a pointer. This makes your program faster and uses less memory.</li>
<br>
  <li><strong>You want to change values inside a function.</strong><br>
  If you pass a pointer to a struct into a function, the function can change the original values.</li>
<br>
  <li><strong>You want to create structs dynamically using memory allocation.</strong><br>
  With pointers, you can use <code class="w3-codespan">malloc()</code> to create structs while the program is running.<br>
  You will learn more about <a href="c_memory_management.php">memory management in a later chapter</a>.</li>
</ul>

<div class="ws-note ws-panel">
  <p><strong>Tip:</strong> If you're working with big programs or many values, struct pointers can help make your code cleaner and more efficient.</p>
</div>
<!--stop-->

<hr>
<div id="exercisecontainer" src="xrcise_structs_pointers.js" data-extensions="php"></div>
<hr>
