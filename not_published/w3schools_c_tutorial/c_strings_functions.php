...
ny:-->
    ...
    <h1>C <span class="color_h1">String Functions</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_strings_esc.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_challenges_strings.php">Next &#10095;</a>
</div>
<hr>

<!--start-->
<h2>String Functions</h2>
<p>C also has many useful string functions, which can be used to perform 
certain operations on strings.</p>
<p>To use them, you must include the <code class="w3-codespan">&lt;string.h&gt;</code> header file in your program:</p>
...
<!--start-->
<h2>String Length</h2>
<p>For example, to get the length of a string, you can use the <code class="w3-codespan">strlen()</code> function:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  char alphabet[] = &quot;ABCDEFGHIJKLMNOPQRSTUVWXYZ&quot;;<br>printf(&quot;%zu&quot;, 
  strlen(alphabet));<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_strings_length">Try it Yourself &raquo;</a>
</div>

<p>In the <a href="c_strings.php">Strings chapter</a>, we used <code class="w3-codespan">sizeof</code> to get the size of a string/array. Note that <code class="w3-codespan">sizeof</code> and <code class="w3-codespan">strlen</code> behaves differently, as <code class="w3-codespan">sizeof</code> also includes the <code class="w3-codespan">\0</code> character 
when counting:</p>
...
<div class="w3-code notranslate javaHigh">
  char alphabet[] = &quot;ABCDEFGHIJKLMNOPQRSTUVWXYZ&quot;;<br>printf(&quot;%zu\n&quot;, 
  strlen(alphabet));&nbsp;&nbsp; // 26<br>printf(&quot;%zu\n&quot;, 
  sizeof(alphabet));&nbsp;&nbsp; // 27<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_strings_length2">Try it Yourself &raquo;</a>
</div>

<p>It is also important that you know that <code class="w3-codespan">sizeof</code> will always return the memory size (in bytes), and not the actual 
string length:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  char alphabet[50] = &quot;ABCDEFGHIJKLMNOPQRSTUVWXYZ&quot;;<br>printf(&quot;%zu\n&quot;, 
  strlen(alphabet));&nbsp;&nbsp; // 26<br>printf(&quot;%zu\n&quot;, sizeof(alphabet));&nbsp;&nbsp; // 
  50<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_strings_length3">Try it Yourself &raquo;</a>
</div>
<!--stop-->
...
<p>To concatenate (combine) two strings, you can use the <code class="w3-codespan">strcat()</code> function:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  char str1[20] = &quot;Hello &quot;;<br>char str2[] = &quot;World!&quot;;<br><br>// 
  Concatenate 
  str2 to str1 (result is stored in str1)<br>strcat(str1, str2);<br><br>// 
  Print str1<br>printf(&quot;%s&quot;, str1);<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_strings_strcat">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
<p>Note that the size of <code class="w3-codespan">str1</code> should be large enough to store the result of the 
two strings combined (20 in our example).</p>
</div>
<!--stop-->
<hr>
...
<!--start-->
<h2>Copy Strings</h2>
<p>To copy the value of one string to another, you can use the <code class="w3-codespan">strcpy()</code> function:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  char str1[20] = &quot;Hello World!&quot;;<br>char str2[20];<br><br>// Copy str1 to str2<br>
  strcpy(str2, str1);<br><br>// Print str2 <br>printf(&quot;%s&quot;, str2);<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_strings_strcpy">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
<p>Note that the size of <code class="w3-codespan">str2</code> should be large 
enough to store the copied string (20 in our example).</p>
</div>
<!--stop-->
<hr>
...
<p>To compare two strings, you can use the <code class="w3-codespan">strcmp()</code> 
function. </p>
<p>It returns <code class="w3-codespan">0</code> if the two strings are equal, otherwise a value that is not 0:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  char str1[] = &quot;Hello&quot;;<br>char str2[] = &quot;Hello&quot;;<br>char str3[] = &quot;Hi&quot;;<br>
  <br>// Compare str1 and str2, and print the result<br>printf(&quot;%d\n&quot;, 
  strcmp(str1, str2));&nbsp; // Returns 0 (the strings are equal)<br><br>// 
  Compare str1 and str3, and print the result<br>
  printf(&quot;%d\n&quot;, strcmp(str1, str3));&nbsp; // Returns -4 (the strings are not 
  equal)<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_strings_strcmp">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<p>For a complete reference of string functions, go to our <a href="c_ref_string.php">C 
&lt;string.h&gt; Library Reference</a>.</p>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_strings_functions.js" data-extensions="php"></div>
<hr>
