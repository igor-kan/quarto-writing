...
<h1>C <span class="color_h1">Comments</span></h1>

<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_challenges_output.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_variables.php">Next &#10095;</a>
</div>
<hr>
...
<p>Comments are notes for humans. They help explain code and make it easier to read.</p>
<p>They can also be used to temporarily "disable" code while testing.</p>
<p>Comments can be <strong>single-line</strong> or <strong>multi-line</strong>.</p>

<div class="ws-note w3-panel">
<p><strong>Remember:</strong> Comments are ignored by the compiler, so they do not affect your program's output.</p>
</div>
<!--stop-->
<hr>
...
<p>Any text between <code class="w3-codespan">//</code> and the end of the line is ignored by the compiler.</p>
<p>This example uses a single-line comment before a line of code:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  // This is a comment<br>printf(&quot;Hello World!&quot;);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_comments_single">Try it Yourself &raquo;</a>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  printf(&quot;Hello World!&quot;); // This is a comment</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_comments_single2">Try it Yourself &raquo;</a>
</div>

<p>You can also use <code class="w3-codespan">//</code> to disable a single line of code:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  printf(&quot;This will run&quot;);<br>// printf(&quot;This will NOT run&quot;);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_comments_disable_line">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<p>Multi-line comments start with <code class="w3-codespan">/*</code> and end with <code class="w3-codespan">*/</code>.</p>
<p>Any text between <code class="w3-codespan">/*</code> and <code class="w3-codespan">*/</code> will be ignored by the compiler:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  /* The code below will print the words Hello World!<br>to the screen, and it is
  amazing */<br>printf(&quot;Hello World!&quot;);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_comments_multi">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
<h4>Single or multi-line comments?</h4>
<p>It is up to you which you want to use. Normally, we use <code class="w3-codespan">//</code> for short comments and <code class="w3-codespan">/* */</code> for longer comments.</p>
<p><strong>Good to know:</strong> Before <strong>C99</strong> (released in 1999), you could only use multi-line comments in C.</p>
</div>
<!--stop-->
...
<div id="exercisecontainer" src="xrcise_comments.js" data-extensions="php"></div>
<hr>
