<!DOCTYPE html>
<html lang="en-US">
<title>C Memory Management (Memory Allocation)</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>C <span class="color_h1">Memory Management</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_challenges_enums.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_memory_allocate.php">Next &#10095;</a>
</div>
<hr>
<!--start-->
<p class="intro">Memory management is the process of handling how much memory a program uses through different operations.</p>
<!--stop-->
...
<p>Understanding how memory works in C is important. When you create a basic variable, C will automatically reserve space for that variable. An <code class="w3-codespan">int</code> variable for example, will typically occupy 4 bytes of memory, while a <code class="w3-codespan">double</code> variable will occupy 8 bytes of memory.</p>
<p>You can use the <code class="w3-codespan">sizeof</code> operator to find the size of different types:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  int myInt;<br>float myFloat;<br>double myDouble;<br>char myChar;<br>
  <br>printf(&quot;%zu\n&quot;, sizeof(myInt));&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // 4 bytes<br>printf(&quot;%zu\n&quot;, sizeof(myFloat));&nbsp;&nbsp;&nbsp; 
  // 4 bytes<br>
  printf(&quot;%zu\n&quot;, sizeof(myDouble));&nbsp;&nbsp; // 8 bytes<br>printf(&quot;%zu\n&quot;, sizeof(myChar));&nbsp;&nbsp;&nbsp;&nbsp; // 1 byte</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_memory_sizeof">Try it Yourself &raquo;</a>
</div>

<p><strong>Why is it important to know?</strong></p>
<p>If you create a program that occupies too much, or unnecessary memory, it can result in slow and poor performance.</p>
<p>In C, you have to manage memory yourself. It is a complicated task, but is also quite powerful when used correctly: Properly managing the computer memory optimizes the performance of the program, so it is useful that you know how to release memory when it is no longer required and only use as little as necessary for the task.</p>
<p>In previous chapters you learned about <strong><a href="/c/c_memory_address.php">memory addresses</a></strong> and <strong><a href="/c/c_pointers.php">pointers</a></strong>.</p>
<p>Both have an importance when it comes to memory management, since it is possible to work directly with memory through <strong><a href="/c/c_pointers.php">pointers</a></strong>.</p>
<p>But be careful; <strong>pointers must be handled with care</strong>, since it is possible to damage data stored in other memory addresses.</p>
<!--stop-->
<hr>

<!--start-->
<h2>Memory Management</h2>
<p>Memory management is the process of handling how much memory a program uses through allocation, reallocation and deallocation (often referred to as "freeing"). We will introduce each of these topics in the following chapters.</p>
<!--stop-->
...
<div id="exercisecontainer" src="xrcise_memory_management.js" data-extensions="php"></div>
<hr>
