...
<a class="w3-left w3-btn" href="c_unions.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_structs_padding.php">Next &#10095;</a>
</div>
<hr>

<h2>C typedef</h2>

<p>The <code class="w3-codespan">typedef</code> keyword lets you create a new name (an <b>alias</b>) for an existing type.  
This can make complex declarations easier to read, and your code easier to maintain.</p>

<p>For example, instead of always writing <code class="w3-codespan">float</code>, we can create a new type called <code class="w3-codespan">Temperature</code> to make the code clearer:</p>
...
#include &lt;stdio.h&gt;<br>
<br>
typedef float Temperature;<br>
<br>
int main() {<br>
&nbsp; Temperature today = 25.5;<br>
&nbsp; Temperature tomorrow = 18.6;<br>
<br>
&nbsp; printf("Today: %.1f C\n", today);<br>
...
&nbsp; return 0;<br>
  ...
  <a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_typedef">Try it Yourself &raquo;</a>
</div>

<p>Here, <code class="w3-codespan">Temperature</code> is just another name for <code class="w3-codespan">float</code>. However, the code is more expressive: it tells us that these numbers are <b>temperatures</b>, not just any floating-point numbers.</p>

<hr>

<h2>Why Use typedef?</h2>
<ul>
  <li><b>Simplifies code</b>: Shorter, easier-to-read type names.</li>
  <li><b>Improves clarity</b>: Expresses intent better (for example, <code class="w3-codespan">AGE</code> instead of just <code class="w3-codespan">int</code>). Also helps avoid confusion when many variables share the same base type (like <code class="w3-codespan">float</code> or <code class="w3-codespan">double</code>).</li>
</ul>

<div class="ws-note w3-panel">
  <p><b>Good To Know:</b> In modern C, <code class="w3-codespan">typedef</code> is often used together with <code class="w3-codespan">struct</code>, <code class="w3-codespan">enum</code>, and function pointers to keep code clean and easier to read.</p>
</div>
<hr>

<h2>typedef with struct</h2>

<p><code class="w3-codespan">typedef</code> can be useful with <code class="w3-codespan">struct</code>, because it lets you avoid writing <code class="w3-codespan">struct</code> every time:</p>
...
<br>
int main() {<br>
&nbsp; struct Car car1 = {"BMW", 1999}; // needs "struct"<br>
&nbsp; Car car2 = {"Ford", 1969};          // shorter with typedef<br>
<br>
&nbsp; printf("%s %d\n", car1.brand, car1.year);<br>
&nbsp; printf("%s %d\n", car2.brand, car2.year);<br>
&nbsp; return 0;<br>
}<br>
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_typedef_struct">Try it Yourself &raquo;</a>
</div>

<p>This example shows how <code class="w3-codespan">typedef</code> makes it easier to work with multiple struct variables, like different car models:</p>
...
<br>
int main() {<br>
&nbsp; Car car1 = {"BMW", "X5", 1999};<br>
&nbsp; Car car2 = {"Ford", "Mustang", 1969};<br>
&nbsp; Car car3 = {"Toyota", "Corolla", 2011};<br>
<br>
&nbsp; printf("%s %s %d\n", car1.brand, car1.model, car1.year);<br>
&nbsp; printf("%s %s %d\n", car2.brand, car2.model, car2.year);<br>
&nbsp; printf("%s %s %d\n", car3.brand, car3.model, car3.year);<br>
<br>
&nbsp; return 0;<br>
}<br>
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_typedef_struct3">Try it Yourself &raquo;</a>
</div>

<p>Here you can see how <code class="w3-codespan">typedef</code> keeps the code clean when structs are nested inside other structs:</p>
...
#include &lt;stdio.h&gt;<br>
<br>
// Define three structs with typedef<br>
typedef struct {<br>
...
<br>
int main() {<br>
&nbsp; Owner person = {"John", "Doe"};<br>
&nbsp; Car car1 = {"Toyota", 2010, person};<br>
&nbsp; Dealership d = {"City Motors", car1};<br>
<br>
&nbsp; printf("Dealership: %s\n", d.name);<br>
&nbsp; printf("Featured Car: %s (%d), owned by %s %s\n",<br>
&nbsp;&nbsp;&nbsp; d.featuredCar.brand,<br>
&nbsp;&nbsp;&nbsp; d.featuredCar.year,<br>
&nbsp;&nbsp;&nbsp; d.featuredCar.owner.firstName,<br>
&nbsp;&nbsp;&nbsp; d.featuredCar.owner.lastName);<br>
<br>
&nbsp; return 0;<br>
}<br>
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_typedef_struct2">Try it Yourself &raquo;</a>
</div>

<div class="ws-note ws-panel">
<p>It is up to you whether you want to use <code class="w3-codespan">typedef</code> or not.  
Your code will work the same without it. However, in modern C it is often used to make code shorter, clearer, and easier to maintain.</p>
</div>
