<!DOCTYPE html>
<html lang="en-US">
<title>C More Data Types (Extended Types)</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>C <span class="color_h1">Extended Types</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_data_types_reallife.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_challenges_data_types.php">Next &#10095;</a>
</div>
<hr>

<h2>More Data Types</h2>
<p>Besides the basic types (<code class="w3-codespan">int</code>, 
<code class="w3-codespan">float</code>, <code class="w3-codespan">double</code>, 
<code class="w3-codespan">char</code>), C also gives you 
<b>extended keywords</b> (<code class="w3-codespan">short</code>, 
<code class="w3-codespan">long</code>, <code class="w3-codespan">unsigned</code>) 
to control how large the number is, or whether it can be negative:</p>
...
<tr>
  ...
  <th>Size*</th>
  <th>Range (commonly)</th>
  <th>Format Specifier</th>
</tr>
<tr>
  <td><code class="w3-codespan">short int</code></td>
  <td>2 bytes</td>
  <td>-32,768 to 32,767</td>
  <td><code class="w3-codespan">%hd</code></td>
</tr>
<tr>
  <td><code class="w3-codespan">unsigned int</code></td>
  <td>2 or 4 bytes</td>
  <td>0 to 65,535 (2 bytes)<br>
      0 to 4,294,967,295 (4 bytes)</td>
  <td><code class="w3-codespan">%u</code></td>
</tr>
<tr>
  <td><code class="w3-codespan">long int</code></td>
  <td>4 or 8 bytes</td>
  <td>-2,147,483,648 to 2,147,483,647 (4 bytes)<br>
      -9,223,372,036,854,775,808 to 9,223,372,036,854,775,807 (8 bytes)</td>
  <td><code class="w3-codespan">%ld</code></td>
</tr>
<tr>
  <td><code class="w3-codespan">long long int</code></td>
  <td>8 bytes</td>
  <td>-9,223,372,036,854,775,808 to 9,223,372,036,854,775,807</td>
  <td><code class="w3-codespan">%lld</code></td>
</tr>
<tr>
  <td><code class="w3-codespan">unsigned long int</code></td>
  <td>4 or 8 bytes</td>
  <td>0 to 4,294,967,295 (4 bytes)<br>
      0 to 18,446,744,073,709,551,615 (8 bytes)</td>
  <td><code class="w3-codespan">%lu</code></td>
</tr>
<tr>
  <td><code class="w3-codespan">unsigned long long int</code></td>
  <td>8 bytes</td>
  <td>0 to 18,446,744,073,709,551,615</td>
  <td><code class="w3-codespan">%llu</code></td>
</tr>
<tr>
  <td><code class="w3-codespan">long double</code></td>
  <td>8, 12, or 16 bytes</td>
  <td>Implementation-dependent, but more precision than <code class="w3-codespan">double</code></td>
  <td><code class="w3-codespan">%Lf</code></td>
</tr>
</table>
</div>
<div class="ws-note ws-panel">
<p><code class="w3-codespan">unsigned</code> means the type can only store non-negative values (0 and up).</p>
<p><strong>*Note:</strong> The size of these types can differ between systems (for example, 2 or 4 bytes, or 4 or 8 bytes), depending on whether the computer is older or newer, 32-bit or 64-bit, and which compiler is used.</p>
</div>

<p>Here is an example of how you can create and print these extended types:</p>
<div class="w3-example">
  <h3>Example</h3>
  <pre class="language-c w3-white"><code>int normalInt = 1000;                       // standard int 
...
printf("Precise: %Lf\n", precise);
  ...
  <p><a target="_blank" class="w3-btn" href="tryc.php?filename=demo_datatypes_more"><strong>Try it Yourself &raquo;</strong></a></p>
</div>
<div class="ws-note w3-panel">
  <p><b>Note:</b> These extended types are mostly used when you need very specific control over memory usage or number ranges.</p>
  <p><b>Note:</b> For everyday programming, <code class="w3-codespan">int</code>, <code class="w3-codespan">float</code>, <code class="w3-codespan">double</code>, and <code class="w3-codespan">char</code> are usually enough.</p>
</div>
...
<h2>Check Size</h2>
<p><em>*The exact sizes depend on your system and compiler.</em> Remember that you can check them with the <code class="w3-codespan">sizeof</code> operator:</p>
<div class="w3-example">
  <h3>Example</h3>
  <pre class="language-c w3-white"><code>printf("Size of int: %zu bytes\n", sizeof(int));
...
printf("Size of long double: %zu bytes\n", sizeof(long double));
  ...
  <p><a target="_blank" class="w3-btn" href="tryc.php?filename=demo_datatypes_more_size"><strong>Try it Yourself &raquo;</strong></a></p>
</div>

<div class="ws-panel ws-note">
<p><strong>Tip:</strong> When you really need exact control over the size of your numbers, you can use the <a href="c_fixed_width_ints.php">fixed-width types</a>, which you will learn about later.</p>
<p><strong>Note:</strong> This page is just to show you that C has other extended types, but for now 
<strong>we will keep focusing on the basic types</strong> (<code class="w3-codespan">int</code>, <code class="w3-codespan">float</code>, <code class="w3-codespan">double</code>, <code class="w3-codespan">char</code>) in this tutorial.</p>
</div>
<hr>
