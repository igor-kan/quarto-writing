<!DOCTYPE html>
<html lang="en-US">
<title>C Callback Functions</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>C <span class="color_h1">Callback Functions</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_functions_pointers.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_files.php">Next &#10095;</a>
</div>
<hr>

<h2>Callback Function</h2>

<p>A <strong>callback function</strong> is a function that is <em>passed as an argument</em> to another function.</p>

<p>The receiving function can then <strong>call it back</strong> (run it) whenever it needs to.</p>

<p>This is a powerful way to make your code <strong>flexible and reusable</strong> - you can decide which function should run, without changing the main logic.</p>

<p>In C, callback functions are usually implemented using <a href="c_functions_pointers.php"><strong>function pointers</strong></a>.</p>

<hr>

<h2>Simple Callback Example</h2>

<p>Here's a basic example that shows how one function can "call back" another:</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Passing a function as an argument to another function:</p>
  <div class="w3-code notranslate javaHigh">
    void sayHello() {<br>
    &nbsp;&nbsp;printf("Hello from the callback!\n");<br>
    }<br><br>
    void runCallback(void (*callback)()) {<br>
    &nbsp;&nbsp;printf("Before calling the callback...\n");<br>
    &nbsp;&nbsp;callback();<br>
    &nbsp;&nbsp;printf("After calling the callback.\n");<br>
    }<br><br>
    int main() {<br>
    &nbsp;&nbsp;runCallback(sayHello);<br>
    &nbsp;&nbsp;return 0;<br>
    }
  </div>
  <p><a target="_blank" class="w3-btn" href="tryc.php?filename=demo_callback_simple">Try it Yourself &raquo;</a></p>
</div>

<p>In this example:</p>
<ul>
  <li><code class="w3-codespan">sayHello()</code> is a normal function that prints a message.</li>
  <li><code class="w3-codespan">runCallback()</code> receives a function pointer as a parameter.</li>
  <li>When <code class="w3-codespan">runCallback(sayHello)</code> runs, it calls <code class="w3-codespan">sayHello()</code> inside itself.</li>
</ul>

<div class="ws-note ws-panel">
  <p><strong>Note:</strong> The word "callback" comes from the fact that one function "calls back" another that was given to it earlier.</p>
</div>

<hr>

<h2>Callback with Parameters</h2>

<p>You can also pass functions that take parameters - just make sure the 
function pointer type matches:</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Passing a function with parameters as a callback:</p>
  <div class="w3-code notranslate javaHigh">
    void addNumbers(int a, int b) {<br>
    &nbsp;&nbsp;printf("The sum is: %d\n", a + b);<br>
    }<br><br>
    void calculate(void (*callback)(int, int), int x, int y) {<br>
    &nbsp;&nbsp;callback(x, y);<br>
    }<br><br>
    int main() {<br>
    &nbsp;&nbsp;calculate(addNumbers, 5, 3);<br>
    &nbsp;&nbsp;return 0;<br>
    }
  </div>
  <p><a target="_blank" class="w3-btn" href="tryc.php?filename=demo_callback_parameters">Try it Yourself &raquo;</a></p>
</div>

<p>Here, <code class="w3-codespan">calculate()</code> receives a function and two numbers,  
then calls the function (in this case, <code class="w3-codespan">addNumbers()</code>) with those numbers as arguments.</p>
...
<p>You can use callbacks to let a function behave differently depending on which function you pass in.  
This is common in sorting, filtering, and event-handling code.</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Using different callback functions to perform different actions:</p>
  <div class="w3-code notranslate javaHigh">
    void greetMorning() { printf("Good morning!\n"); }<br>
    void greetEvening() { printf("Good evening!\n"); }<br><br>
    void greet(void (*callback)()) {<br>
    &nbsp;&nbsp;callback();<br>
    }<br><br>
    int main() {<br>
  ...
  <p><a target="_blank" class="w3-btn" href="tryc.php?filename=demo_callback_multiple">Try it Yourself &raquo;</a></p>
</div>

<p>Depending on which function is passed, the program produces different output - without changing <code class="w3-codespan">greet()</code> itself.</p>

<hr>

<h2>Real-World Example: Using Callbacks in qsort()</h2>

<p>Many C standard library functions use callbacks.  
For example, the <a href="ref_stdlib_qsort.php"><code class="w3-codespan">qsort()</code></a> function in <a href="c_ref_stdlib.php"><code class="w3-codespan">&lt;stdlib.h&gt;</code></a> uses a callback to compare elements while sorting.</p>

<p>You provide the comparison function, and <code class="w3-codespan">qsort()</code> calls it as needed. 
This will <strong>sort</strong> the elements:</p>
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate javaHigh">
    ...
    int main() {<br>
    &nbsp;&nbsp;int numbers[] = { 5, 2, 9, 1, 7 };<br>
    &nbsp;&nbsp;int size = sizeof(numbers) / sizeof(numbers[0]);<br><br>
    &nbsp;&nbsp;qsort(numbers, size, sizeof(int), compare);<br><br>
  ...
  <p><a target="_blank" class="w3-btn" href="tryc.php?filename=demo_callback_qsort">Try it Yourself &raquo;</a></p>
</div>

<p>Here, <code class="w3-codespan">compare()</code> is the callback function used by <code class="w3-codespan">qsort()</code> to decide how to order the numbers.</p>
<hr>
<h2>Summary</h2>

<ul>
  <li>A callback function is a function passed as an argument to another function.</li>
  <li>It allows one function to call another without knowing its name in advance.</li>
  <li>Callbacks make code more flexible and reusable.</li>
  <li>They are used in the C Standard Library (like <code class="w3-codespan">qsort()</code>).</li>
</ul>
