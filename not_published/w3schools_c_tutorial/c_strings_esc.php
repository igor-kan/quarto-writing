<!DOCTYPE html>
<html lang="en-US">
<title>C Strings - Special Characters (Escape Characters)</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>C <span class="color_h1">Special Characters</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_strings.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_strings_functions.php">Next &#10095;</a>
</div>
<hr>

<!--start-->
<h2>Strings - Special Characters</h2>

<p>Because strings must be written within quotes, C will misunderstand this string, 
and generate an error:</p>

<div class="w3-example w3-pale-red">
<div class="w3-code notranslate javaHigh w3-border-red">
  char txt[] = &quot;We are the so-called &quot;Vikings&quot; from the north.&quot;;<br>
 </div>
</div>

<p>The solution to avoid this problem, is to use the <strong>backslash escape character</strong>.</p>
<p>The backslash (<code class="w3-codespan">\</code>) escape character turns special characters into string characters:</p>
...
<p>The sequence <code class="w3-codespan">\"</code>&nbsp; inserts a double quote in a string:<p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_strings_esc1">Try it Yourself &raquo;</a>
</div>

<p>The sequence <code class="w3-codespan">\'</code>&nbsp; inserts a single quote in a string:<p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  char txt[] = &quot;It\'s alright.&quot;;<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_strings_esc2">Try it Yourself &raquo;</a>
</div>

<p>The sequence <code class="w3-codespan">\\</code>&nbsp; inserts a single backslash in a string:<p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  char txt[] = &quot;The character \\ is called backslash.&quot;;<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_strings_esc3">Try it Yourself &raquo;</a>
</div>

<p>Other popular escape characters in C are:</p>
<table class="ws-table-all notranslate">
<tr>
...
<tr>
  <td>\n</td>
  <td>New Line</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryc.php?filename=demo_strings_newline">Try it &raquo;</a></td>
</tr>
<tr>
  <td>\t</td>
  <td>Tab</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryc.php?filename=demo_strings_tab">Try it &raquo;</a></td>
</tr>
<tr>
  <td>\0</td>
  <td>Null</td>
<td><a target="_blank" class="w3-btn btnsmall btnsmall" href="tryc.php?filename=demo_strings_null">Try it &raquo;</a></td>
</tr>
</table>
<!--stop-->
...
<p>If you have a long string, you might want to split it across multiple lines in your code to make it easier to read.</p>

<p>There are two ways to do this in C:</p>


<p>1.<strong> Using a backslash</strong> (<code class="w3-codespan">\</code>) - You can place a backslash at the end of a line to continue the string on the next line:</p>
...
<br>
int main() {<br>
&nbsp; printf("This is a very long string \ <br>
&nbsp; that continues on the next line.\n");<br>
&nbsp; return 0;<br>
}<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_strings_multiline">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
  <p><strong>Note:</strong> The backslash must be the <em>last character</em> on the line.  
  Even a single space or tab after it can cause an error.</p>
</div>

<p>2. <strong>Putting string literals side by side</strong> (recommended) - A clearer way is to simply write two strings next to each other inside quotes.  
The C compiler will automatically join them into one string:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_strings_multiline_concat">Try it Yourself &raquo;</a>
</div>

<p>This method is more common and safer to use, since you don't have to worry about backslashes or trailing spaces.</p>
-->
<hr>
...
<div id="exercisecontainer" src="xrcise_strings_esc.js" data-extensions="php"></div>
<hr>
