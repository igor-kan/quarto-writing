...
<html lang="en-US">
<head>
<title>C Syllabus (Curriculum)</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>C <span class="color_h1">Syllabus</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_compiler.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_study_plan.php">Next &#10095;</a>
</div>
<hr>
...
<p>The <a title="W3Schools C Tutorial" href="index.php">W3Schools C Tutorial</a> is comprehensive and beginner-friendly.</p>
<p>It will give you a fundamental knowledge of C.</p>
...
<p>The syllabus outline and its sequence are structured so you can learn C step by step, from the introduction to creating your first application with C. </p>
<p><a title="W3Schools C Tutorial" href="c_intro.php" class="ws-btn">Get Started With C &raquo;</a></p>
<hr>

<h2>Learning Outcomes</h2>
<ul>
    <li>Understand what the C programming language is and how to write code.</li>
    <li>Learn C syntax and structure.</li>
    <li>Use variables and data types to store and manage data.</li>
    <li>Understand and use printf() and scanf() for input and output.</li>
    <li>Write simple decision-making code with if, else, and switch.</li>
    <li>Create loops using for, while, and do...while.</li>
    <li>Learn about functions to create reusable code.</li>
    <li>Work with arrays to store multiple values.</li>
    <li>Understand pointers and how they are used in C.</li>
    <li>Learn file handling for reading and writing files.</li>
    <li>Write and run C programs.</li>
</ul>
<div class="ws-note w3-panel">
<p><strong>Note:</strong> Are you a teacher teaching C programming? <a href="/academy/index.php" target="_blank">W3Schools Academy</a> is a toolbox of features that can help you teach. It offers classroom features such as pre-built study plans, classroom administration and much more. Read more about <a href="/academy/index.php" target="_blank">Academy here</a>.</p>
</div>
<hr>

<h2>Which Subjects Are C Relevant For?</h2>
<ul>
    ...
    <li style="margin-bottom:16px;">
        <strong>Electrical and Computer Engineering:</strong>  <br>
...
<p><a title="W3Schools C Tutorial" href="c_intro.php" class="ws-btn" style="margin-top:8px">Get Started</a></p>
...
<h2>Activities</h2>
<p>In this tutorial we offer different activities for you to learn C for free:</p>
<ul>
    <li><a href="index.php" title="W3Schools C Tutorial">Lessons</a></li>
    <li><a href="c_exercises.php" title="W3Schools C Exercises">Exercises</a></li>
    <li><a href="c_quiz.php" title="W3Schools C Quiz">Quizzes</a></li>
</ul>
<hr>
...
<ul class="link-boxes">
<li><a href="c_intro.php">C Introduction</a></li>
<li><a href="c_getstarted.php">C Get Started</a></li>
<li><a href="c_syntax.php">C Syntax</a></li>
<li><a href="c_statements.php">C Statements</a></li>
<li><a href="c_output.php">C Output</a></li>
<li><a href="c_comments.php">C Comments</a></li>
<li><a href="c_variables.php">C Variables</a></li>
<li><a href="c_data_types.php">C Data Types</a></li>
<li><a href="c_constants.php">C Constants</a></li>
<li><a href="c_operators.php">C Operators</a></li>
<li><a href="c_booleans.php">C Booleans</a></li>
<li><a href="c_if_else.php">C If...Else</a></li>
<li><a href="c_switch.php">C Switch</a></li>
<li><a href="c_while_loop.php">C While Loop</a></li>
<li><a href="c_for_loop.php">C For Loop</a></li>
<li><a href="c_break.php">C Break and Continue</a></li>
<li><a href="c_arrays.php">C Arrays</a></li>
<li><a href="c_strings.php">C Strings</a></li>
<li><a href="c_user_input.php">C User Input</a></li>
<li><a href="c_memory_address.php">C Memory Address</a></li>
<li><a href="c_pointers.php">C Pointers</a></li>
<li><a href="c_functions.php">C Functions</a></li>
<li><a href="c_functions_parameters.php">C Function Parameters</a></li>
<li><a href="c_scope.php">C Scope</a></li>
<li><a href="c_functions_decl.php">C Function Declaration</a></li>
<li><a href="c_functions_recursion.php">C Recursion</a></li>
<li><a href="c_math.php">C Math Functions</a></li>
<li><a href="c_files.php">C Create Files</a></li>
<li><a href="c_files_write.php">C Write To Files</a></li>
<li><a href="c_files_read.php">C Read Files</a></li>
<li><a href="c_structs.php">C Structures</a></li>
<li><a href="c_enums.php">C Enums</a></li>
<li><a href="c_memory.php">C Memory Management</a></li>
</ul>
</div>
<p><a title="W3Schools C Tutorial" href="index.php" class="ws-btn">Get Started</a></p>
<hr>

<h2>Sandbox and Lab Environment</h2>
<p>C, like any other programming language, is best learned by working hands-on with code.</p>
<p>Easily try code with our "Try it Yourself" editor.</p>
<p>Here, you can edit C code and view the result:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  #include &lt;stdio.h&gt;<br><br>int main() {<br>&nbsp; printf(&quot;Hello World!&quot;);<br>&nbsp; 
  return 0;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_helloworld">Try it Yourself &raquo;</a>
</div>
...
<p>The C exam is a test that summarizes the W3Schools C syllabus.</p>
<p>After passing the exam you get the "Certified C Developer" Certification.</p>
<p>The exam is adaptive and graded, the students will get a grade from intermediate, advanced to professional.</p>

<p>The adaptive exam adjusts to your skill level. If you answer correctly, you get harder questions. If you answer incorrectly, you get easier questions. This to match the questions to your skill level.</p>
<div class="ws-grey w3-padding w3-round">
<img src="syllabus-exam.png" style="width:100%;">
</div>
<p><a class="ws-btn" href="https://campus.w3schools.com/collections/certifications/products/c-certification-exam" target="_blank">Buy Certificate &raquo;</a></p>
<hr>
