<!DOCTYPE html>
<html lang="en-US">
<title>C Pointers and Arrays</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>C <span class="color_h1">Pointers and Arrays</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_pointers.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_pointers_arithmetic.php">Next &#10095;</a>
</div>
<hr>

<!--start-->
<h2>Pointers & Arrays</h2>
<p>You can also use pointers to access <a href="c_arrays.php">arrays</a>.</p>

<p>Consider the following array of integers:</p>
...
<p>You learned from the <a href="c_arrays.php">arrays chapter</a> that you can loop through the array elements with a <code class="w3-codespan">for</code> loop:</p>
<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    int myNumbers[4] = {25, 50, 75, 100};<br>int i;<br><br>for (i = 0; i &lt; 4; 
    i++) {<br>&nbsp; printf(&quot;%d\n&quot;, myNumbers[i]);<br>}<br>
 </div>
 <p>Result:</p>
  <div class="w3-black w3-padding">
    <code>25<br>50<br>75<br>100</code>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="tryc.php?filename=demo_pointers_arrays">Try it Yourself &raquo;</a>
</div>

<p>Instead of printing the value of each array element, let's print the memory address of each array element:</p>
<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    int myNumbers[4] = {25, 50, 75, 100};<br>int i;<br><br>for (i = 0; i &lt; 4; 
 ...
 <p>Result:</p>
  <div class="w3-black w3-padding">
    <code>0x7ffe70f9d8f0<br>0x7ffe70f9d8f4<br>0x7ffe70f9d8f8<br>0x7ffe70f9d8fc</code>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="tryc.php?filename=demo_pointers_arrays2">Try it Yourself &raquo;</a>
</div>

<p>Note that the last number of each of the elements' memory address is 
different, with an addition of 4. </p>
<p>It is because the size of an <code class="w3-codespan">int</code> type is typically 4 bytes, remember:</p>

<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    // Create an int variable<br>int myInt;<br><br>// Get the memory size of an int<br>
    printf(&quot;%zu&quot;, sizeof(myInt));<br>
 </div>
 <p>Result:</p>
  <div class="w3-black w3-padding">
    <code>4</code>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="tryc.php?filename=demo_pointers_arrays_int">Try it Yourself &raquo;</a>
</div>

<p>So from the &quot;memory address example&quot; above, you can see that the compiler 
reserves 4 bytes of memory for each array element, which means that the 
entire array takes up 16 bytes (4 * 4) of memory storage:</p>

<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    int myNumbers[4] = {25, 50, 75, 100};<br><br>// Get the size of the myNumbers 
    array<br>printf(&quot;%zu&quot;, sizeof(myNumbers));<br>
 </div>
 <p>Result:</p>
  <div class="w3-black w3-padding">
    <code>16</code>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="tryc.php?filename=demo_pointers_arrays_size">Try it Yourself &raquo;</a>
</div>
<!--stop-->
...
<!--start-->
<h2>How Are Pointers Related to Arrays</h2>

<p>Ok, so what's the relationship between pointers and arrays? Well, in C, the <strong>name of an 
array</strong>, is actually a <strong>pointer</strong> to the <strong>first 
element</strong> of the array.</p>
<p>Confused? Let's try to understand this better, and use our &quot;memory address example&quot; above 
again. </p>
<p>The <strong>memory address</strong> of the <strong>first element</strong> is the same as the 
<strong>name of the array</strong>:</p>
<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    int myNumbers[4] = {25, 50, 75, 100};<br><br>// Get the memory address of the 
    myNumbers array<br>printf(&quot;%p\n&quot;, myNumbers);<br><br>// Get the memory 
    address of the first array element<br>printf(&quot;%p\n&quot;, &amp;myNumbers[0]);<br>
 </div>
 <p>Result:</p>
  <div class="w3-black w3-padding">
    <code>0x7ffe70f9d8f0<br>0x7ffe70f9d8f0</code>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="tryc.php?filename=demo_pointers_arrays_first">Try it Yourself &raquo;</a>
</div>

<p>This basically means that we can work with arrays through pointers!</p>
<p>How? Since myNumbers is a pointer to the first element in myNumbers, you can use 
the <code class="w3-codespan">*</code> operator to access it:</p>
<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    int myNumbers[4] = {25, 50, 75, 100};<br><br>// Get the value of the first 
    element in myNumbers<br>printf(&quot;%d&quot;, *myNumbers);<br>
 </div>
 <p>Result:</p>
  <div class="w3-black w3-padding">
    <code>25</code>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="tryc.php?filename=demo_pointers_arrays_access">Try it Yourself &raquo;</a>
</div>

<p>To access the rest of the elements in myNumbers, you can increment the pointer/array (+1, +2, etc):</p>
<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    int myNumbers[4] = {25, 50, 75, 100};<br><br>// Get the value of the second 
    element in myNumbers<br>printf(&quot;%d\n&quot;, *(myNumbers + 1));<br><br>// Get the value of the 
    third 
    element in myNumbers<br>printf(&quot;%d&quot;, *(myNumbers + 2));<br><br>// 
    and so on..<br>
 </div>
 <p>Result:</p>
  <div class="w3-black w3-padding">
...
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="tryc.php?filename=demo_pointers_arrays_access2">Try it Yourself &raquo;</a>
</div>

<p>Or loop through it:</p>
<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    int myNumbers[4] = {25, 50, 75, 100};<br>int *ptr = myNumbers;<br>int i;<br>
    <br>for (i = 0; i &lt; 4; i++) {<br>&nbsp; printf(&quot;%d\n&quot;, *(ptr + i));<br>}<br>
 </div>
 <p>Result:</p>
  <div class="w3-black w3-padding">
    <code>25<br>50<br>75<br>100</code>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="tryc.php?filename=demo_pointers_arrays_loop">Try it Yourself &raquo;</a>
</div>

<p>It is also possible to change the value of array elements with pointers:</p>
<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    int myNumbers[4] = {25, 50, 75, 100};<br><br>// Change the 
    value of the first element to 13<br>*myNumbers = 13;<br><br>// Change the 
    value of the second element to 17<br>*(myNumbers +1) = 17;<br><br>// Get 
    the value of the first element<br>printf(&quot;%d\n&quot;, *myNumbers);<br><br>// Get 
    the value of the second element<br>printf(&quot;%d\n&quot;, *(myNumbers + 1));<br>
 </div>
 <p>Result:</p>
  <div class="w3-black w3-padding">
    <code>13<br>17</code>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="tryc.php?filename=demo_pointers_arrays_change">Try it Yourself &raquo;</a>
</div>
...
<div class="ws-note w3-panel">
  ...
  much more efficient to access and manipulate arrays with pointers.</p>
  <p>It is also considered faster and easier to access <a href="c_arrays_multi.php">two-dimensional arrays</a> 
  with pointers.</p>
  <p>And since strings are actually arrays, you can also use pointers to access 
  <a href="c_strings.php">strings</a>.</p>
  <p>For now, it's great that you know how this works. But like we specified in the previous chapter; <strong>pointers 
  must be handled with care</strong>, since it is possible to overwrite other data stored 
  in memory.</p>
</div>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_pointers_arrays.js" data-extensions="php"></div>
<hr>
