<!DOCTYPE html>
<html lang="en-US">
<title>C If ... Else Conditions</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>C <span class="color_h1">If ... Else</span></h1>

<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_challenges_booleans.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_conditions_else.php">Next &#10095;</a>
</div>
<hr>

<!--start-->
<h2>Conditions and If Statements</h2>

<p>You already know that C supports familiar comparison conditions from mathematics, such as:</p>
<ul>
...
<ul>
  <li>Use <code class="w3-codespan">if</code> to specify a block of code to be executed, if a specified condition is <code class="w3-codespan">true</code></li>
  <li>Use <code class="w3-codespan">else</code> to specify a block of code to be executed, if the same condition is <code class="w3-codespan">false</code></li>
  <li>Use <code class="w3-codespan">else if</code> to specify a new condition to test, if the first condition is <code class="w3-codespan">false</code></li>
...
<p>Use the <code class="w3-codespan">if</code> statement to specify a block of code to be executed if a condition is <code class="w3-codespan">true</code>.</p>
...
<p>Note that <code class="w3-codespan">if</code> is written in lowercase letters. Uppercase letters (<code class="w3-codespan">If</code> or <code class="w3-codespan">IF</code>) will generate an error.</p>
</div>

<p>In the example below, we test two values to find out if 20 is greater than 18. If the condition is <code class="w3-codespan">true</code>, we print a message:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_if">Try it Yourself &raquo;</a>
</div>
...
if (x &gt; y) {<br>
&nbsp; printf("x is greater than y");<br>
}
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_if2">Try it Yourself &raquo;</a>
</div>

<h4>Example explained</h4>
<p>
In the example above we use two variables, <strong>x</strong> and <strong>y</strong>, to test whether x is greater than y
(using the <code class="w3-codespan">&gt;</code> operator). As x is 20 and y is 18, the condition is true, so the program prints "x is greater than y".
</p>
<!--stop-->
...
<!--start-->
<h2>Using a Boolean Variable</h2>

<p>
Since the condition in an <code class="w3-codespan">if</code> statement must be either true or false,
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_if_bool">Try it Yourself &raquo;</a>
</div>
<p>This can make your code easier to read, especially when the condition is complex or used more than once.</p>


<div class="w3-panel ws-note">
<p><strong>Note:</strong> Remember to include <code class="w3-codespan">&lt;stdbool.h&gt;</code> when working with <code class="w3-codespan">bool</code> variables.</p>
</div>

<!--stop-->

<hr>
<div id="exercisecontainer" src="xrcise_conditions.js" data-extensions="php"></div>
<hr>
