<!DOCTYPE html>
<html lang="en-US">
<title>C Arrays Real-Life Examples</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>C <span class="color_h1">Arrays - Real-Life Examples</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_arrays_loop.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_arrays_multi.php">Next &#10095;</a>
</div>
<hr>
...
<p>To demonstrate a practical example of using arrays, let's create a program that calculates the average of different ages:</p>
...
<div class="w3-code notranslate javaHigh">
  ...
  the elements of the array<br>for (i = 0; i &lt; 
...
<p>And in this example, we create a program that finds the lowest age among different ages:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  // An array storing different ages<br>int ages[] = {20, 22, 18, 35, 48, 26, 
  87, 70};<br><br>int i;<br><br>// Get the length of the array<br>int length = sizeof(ages) / 
  ...
  the elements of the ages array to find the lowest age<br>for (i = 0; i &lt; 
...
<p>In this example, we go through a list of numbers.  
We skip negative values, but stop the loop completely if we find a zero:</p>
