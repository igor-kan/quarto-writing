<!DOCTYPE html>
<html lang="en-US">
<title>C Arrays and Loops</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>C <span class="color_h1">Array Loop</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_arrays_size.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_arrays_reallife.php">Next &#10095;</a>
</div>
<hr>

<h2>Loop Through an Array</h2>

<p>You can use a <code class="w3-codespan">for</code> loop to go through the elements of an array by writing the size of the array in the loop condition (in this example the array has 4 elements, so we use <code class="w3-codespan">i &lt; 4</code>).  
However, this is not ideal, since it will only work for arrays of a specified size:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-c w3-white"><code>int myNumbers[] = {25, 50, 75, 100};
int i;

for (i = 0; i &lt; 4; i++) {
  printf("%d\n", myNumbers[i]);
}</code></pre>
<p><a target="_blank" class="w3-btn" href="tryc.php?filename=demo_array_loop">Try it Yourself &raquo;</a></p>
</div>

<hr>

<h2>Making Better Loops</h2>

<p>In the <a href="c_arrays_size.php">previous chapter</a>, you learned how to calculate the number of elements in an array using the <code class="w3-codespan">sizeof</code> formula.  
Now we can use that to write loops that work for arrays of any size. This is more flexible and sustainable:</p>
...
<p><a target="_blank" class="w3-btn" href="tryc.php?filename=demo_array_loop_length">Try it Yourself &raquo;</a></p>
</div>

<p>This loop will automatically work no matter how many elements the array has!</p>

<div class="ws-note ws-panel">
<p><strong>Summary:</strong> Always use the <code class="w3-codespan">sizeof</code> formula when looping through arrays.  
It makes your loops adapt to the array size automatically.</p>
</div>
<hr>
