<!DOCTYPE html>
<html lang="en-US">
<title>C Real-Life While Loop Examples</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>C <span class="color_h1">While Loop Examples</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_do_while_loop.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_challenges_while_loop.php">Next &#10095;</a>
</div>
<hr>

<!--start-->
<h2>Real-Life Examples</h2>
<p>To demonstrate a practical example of the <strong>while loop</strong>, we have
created a simple &quot;countdown&quot; program:</p>
...
<p>In this example, we create a program that only print even numbers between 0 and 10 (inclusive):</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  int i = 0;<br><br>while (i &lt;= 10) {<br>&nbsp; printf(&quot;%d\n&quot;, i);<br>&nbsp; i += 2;<br>
  }<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_while_loop_even">Try it Yourself &raquo;</a>
</div>

<p>In this example we use a while loop to reverse some numbers:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  ...
  of 'numbers' and add it to 'revNumber'<br>&nbsp; revNumbers = revNumbers * 10 
...
<p>To demonstrate a practical example of the <strong>while loop</strong> combined with an 
<strong>if else 
statement</strong>, let's say we play a game of Yatzy:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Print "Yatzy!" If the dice number is 6:</p>
<div class="w3-code notranslate javaHigh">
...
<p>If the loop passes the values ranging from 1 to 5, it prints "No Yatzy". Whenever it passes the value 6, it prints "Yatzy!".</p>
<!--stop-->
