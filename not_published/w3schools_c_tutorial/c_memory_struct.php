<!DOCTYPE html>
<html lang="en-US">
<title>C Structures and Dynamic Memory</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>C <span class="color_h1">Structures and Dynamic Memory</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_memory_deallocate.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_memory_reallife.php">Next &#10095;</a>
</div>
<hr>


<h2>Structures and Dynamic Memory</h2>

<p>You can also use <strong>dynamic memory</strong> with structures.</p>

<p>This is useful when you don't know how many structs you'll need in advance, or want to save memory by only allocating what's necessary (e.g., in a car dealership program where the number of cars is not fixed).</p>

<hr>

<h2>Allocating Memory for a Struct</h2>

<p>You can use the <code class="w3-codespan">malloc()</code> function to allocate memory for a struct pointer:</p>
...
int main() {
  ...
  <p><a target="_blank" class="w3-btn" href="tryc.php?filename=demo_memory_struct"><strong>Try it Yourself &raquo;</strong></a></p>
</div>

<h3>Example Explained</h3>
<ul>
  <li><code class="w3-codespan">malloc()</code> allocates memory for one struct</li>
  <li><code class="w3-codespan">strcpy()</code> is used to copy a string into the <code class="w3-codespan">brand</code> field</li>
  <li>We use <code class="w3-codespan">-&gt;</code> to access members through the pointer</li>
  <li><code class="w3-codespan">free()</code> is used at the end to release the memory</li>
</ul>

<div class="ws-note ws-panel">
<p><strong>Note:</strong> <code class="w3-codespan">malloc()</code> allocates uninitialized memory. The content will be undefined until you assign values. If you want memory initialized to zero, you can use <code class="w3-codespan">calloc()</code>.</p>
</div>
...
<h2>Using Arrays of Structs</h2>

<p>You can also allocate memory for multiple structs at once, like an array:</p>

<div class="w3-example">
  <h3>Example: Allocate memory for 3 cars</h3>
  <pre class="language-c w3-white"><code>#include &lt;stdio.h&gt;
#include &lt;stdlib.h&gt;
#include &lt;string.h&gt;
...
int main() {
  ...
  <p><a target="_blank" class="w3-btn" href="tryc.php?filename=demo_memory_struct2"><strong>Try it Yourself &raquo;</strong></a></p>
</div>
<hr>

<h2>Growing Arrays Later with <code class="w3-codespan">realloc()</code></h2>

<p>If you need more elements later, you can resize your dynamic array with <code class="w3-codespan">realloc()</code>. This may move the block to a new location and returns a new pointer. Always store the result in a temporary pointer first to avoid losing the original memory if reallocation fails.</p>

<div class="w3-example">
  <h3>Example: Expand an array of structs</h3>
  <pre class="language-c w3-white"><code>#include &lt;stdio.h&gt;
#include &lt;stdlib.h&gt;
#include &lt;string.h&gt;
...
int main() {
  ...
  <p><a target="_blank" class="w3-btn" href="tryc.php?filename=demo_memory_struct_realloc"><strong>Try it Yourself &raquo;</strong></a></p>
</div>

<div class="ws-note ws-panel">
<p><strong>Note:</strong> New space added by <code class="w3-codespan">realloc()</code> is <em>uninitialized</em>. Be sure to initialize newly added elements (e.g. <code class="w3-codespan">strcpy(cars[2].brand, "Kia"); cars[2].year = 2022;</code>) before using them.</p>
</div>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_memory_deallocate.php">&#10094; Previous</a>
