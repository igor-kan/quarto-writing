<!DOCTYPE html>
<html lang="en-US">
<title>C Multidimensional Arrays (Two-dimensional and more)</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>C <span class="color_h1">Multidimensional Arrays</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_arrays_reallife.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_challenges_arrays.php">Next &#10095;</a>
</div>
<hr>

<!--start-->
<h2>Multidimensional Arrays</h2>
<p>In the previous chapter, you learned about <a href="c_arrays.php">arrays</a>, which is also known as 
<strong>single dimension arrays</strong>. These are great, and something you will use a lot while programming in C. However, if you want to store data as a tabular form, like a table with rows and columns, you need to get familiar with 
<strong>multidimensional arrays</strong>.</p>
<p>A multidimensional array is basically an array of arrays.</p>
<p>Arrays can have any number of dimensions. In this chapter, we will introduce the most common; two-dimensional arrays 
(2D).</p>
<!--stop-->
<hr>
...
<p>A 2D array is also known as a matrix (a table of rows and columns).</p>
<p>To create a 2D array of integers, take a look at the following example:</p>
<!--
<p>To create a two-dimensional array of integers, add each array within its own 
set of curly braces:</p>-->


<div class="w3-example">
<div class="w3-code notranslate javaHigh">
  int matrix[2][3] = { {1, 4, 2}, {3, 6, 8} };<br>
 </div>
</div>

<!--
<p><code class="w3-codespan">numbers</code> is now an array with two arrays 
that contains three integers each.</p>-->

<p>The first dimension represents the number of rows<strong> [2]</strong>, while the second 
dimension represents the number of columns<strong> [3]</strong>. The values are placed in 
row-order, and can be visualized like this:</p>
<!--
<p>To visualize the example above, think of the <code class="w3-codespan">numbers</code> 
array as a table with <strong>two rows</strong>, where each row has 
<strong>three columns</strong>:</p>-->

<div class="ws-light-green w3-round" style="padding:30px 10px">
<img src="col-row.png" style="max-width:100%;margin:auto;display:block;">
</div>
<!--stop-->
<hr>

<!--start-->
<h2>Access the Elements of a 2D Array</h2>

<p>To access an element of a two-dimensional array, you must specify the index 
number of both the row and column.</p>

<p>This statement accesses the value of the element in the <strong>first row (0)</strong> and <strong>third column 
(2)</strong> of the <strong>matrix</strong> array.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  int matrix[2][3] = { {1, 4, 2}, {3, 6, 8} };<br><br>printf(&quot;%d&quot;, 
  matrix[0][2]);&nbsp; // Outputs 2</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_array_multi_access">Try it Yourself &raquo;</a>
</div>
...
<!--start-->
<h2>Change Elements in a 2D Array</h2>
<p>To change the value of an element, refer to the index number of the element in each of the dimensions:</p>
<p>The following example will change the value of the element in the <strong>
first row (0)</strong> and<strong> first column (0)</strong>:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  int matrix[2][3] = { {1, 4, 2}, {3, 6, 8} };<br>matrix[0][0] = 9;<br><br>
  printf(&quot;%d&quot;, matrix[0][0]);&nbsp; // Now outputs 9 instead of 1</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_array_multi_change">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>

<!--start-->
<h2>Loop Through a 2D Array</h2>
<p>To loop through a multi-dimensional array, you need one loop for each of the array&#39;s dimensions.</p>
<p>The following example outputs all elements in the <strong>matrix</strong> array:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  int matrix[2][3] = { {1, 4, 2}, {3, 6, 8} };<br><br>int i, j;<br>for (i = 0; 
  i &lt; 2; i++) {<br>&nbsp; for (j = 0; j &lt; 3; j++) {<br>&nbsp;&nbsp;&nbsp; 
  printf(&quot;%d\n&quot;, matrix[i][j]);<br>&nbsp; }<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_array_multi_loop">Try it Yourself &raquo;</a>
</div>
<!--stop-->

<!--
<h2>Omitting the First Size in Multidimensional Arrays</h2>

<p>In C, you can leave out the size of the <strong>first dimension</strong> when creating a multidimensional array, as long as you provide the values.</p>

<p>C is smart enough to count how many sets of values there are and figure out the size automatically.</p>

<p><strong>However:</strong> You still need to specify the size of the <strong>other dimensions</strong>, like how many elements are in each row or column. Without that, the compiler won't know how to lay out the memory.</p>
<p>Both of these examples are valid:</p>

<div class="w3-example">
  <h4>Example: First dimension is specified</h4>
  <pre class="language-c w3-white"><code>int matrix[2][3] = { {1, 4, 2}, {3, 6, 8} };</code></pre>
</div>

<div class="w3-example">
  <h4>Example: First dimension is omitted</h4>
  <pre class="language-c w3-white"><code>int matrix[][3] = { {1, 4, 2}, {3, 6, 8} };</code></pre>
</div>

<p>In both examples above:</p>
<ul>
  <li>There are 2 sets of values, so C knows the first dimension should be <code class="w3-codespan">2</code></li>
  <li>Each row has 3 elements, so you must write <code class="w3-codespan">[3]</code></li>
</ul>

<div class="ws-note ws-panel">
  <p>You can only leave out the size of the <em>first</em> dimension - not the others!</p>
</div>
-->
...
<p>You can also declare arrays with more than two dimensions:</p>

<div class="w3-example">
  <h3>Example</h3>
  <pre class="language-c w3-white"><code>// A 3D array with 2 blocks, each with 4 rows and 3 columns
int example[2][4][3];</code></pre>
  <p><a target="_blank" class="w3-btn" href="tryc.php?filename=demo_array_multi_3d">Try it Yourself &raquo;</a></p>
</div>

<p>This creates a 3D array with:</p>
<ul>
  <li><code class="w3-codespan">2</code> blocks (first index)</li>
  <li><code class="w3-codespan">4</code> rows per block (second index)</li>
  <li><code class="w3-codespan">3</code> columns per row (third index)</li>
</ul>
<!--stop-->
<hr>

<!--start-->
<h2>When to Use Multidimensional Arrays</h2>

<p>Multidimensional arrays are useful when your data is arranged in rows and columns, like a table, grid, or matrix.</p>

<p>Each extra dimension adds another level of structure:</p>

<ul>
  <li><strong>2D arrays</strong> (like <code class="w3-codespan">int scores[3][4]</code>) are great for storing things like scores, game boards, or spreadsheets</li>
  <li><strong>3D arrays</strong> (like <code class="w3-codespan">int cube[2][3][4]</code>) can represent more complex structures like a set of tables or levels in a game</li>
</ul>
<!--stop-->

<hr>
<div id="exercisecontainer" src="xrcise_arrays_multi.js" data-extensions="php"></div>
<hr>
