...
ny:-->
    ...
    <h1>C <span class="color_h1">Write To Files</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_files.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_files_read.php">Next &#10095;</a>
</div>
<hr>

<!--start-->
<h2>Write To a File</h2>
<p>Let's use the <code class="w3-codespan">w</code> mode from the previous 
chapter again, and write something to the file we just created.</p>
<p>The <code class="w3-codespan">w</code> mode means that the file is opened for
<strong>writing</strong>. To insert content to it, you can use the <code class="w3-codespan">fprintf()</code> 
function and add the pointer variable (<code class="w3-codespan">fptr</code> in our example) and some text:</p>

<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    FILE *fptr;<br><br>// Open a file in writing mode<br>fptr = fopen(&quot;filename.txt&quot;, &quot;w&quot;);<br>
    <br>// Write some text to the file<br>fprintf(fptr, &quot;Some text&quot;);<br>
    <br>// Close the file<br>fclose(fptr);</div>
  <p>As a result, when we open the file on our computer, it looks like this:</p>
  <div class="ws-grey">
   <img src="/c/c_files_write.png" style="max-width:100%;"> </div>
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="/cpp/showcpp.asp?filename=c_demo_files_write&stacked=h">Run example &raquo;</a>
</div>

<div class="ws-note w3-panel">
<p><strong>Note:</strong> If you write to a file that already exists, the old content is deleted, and the new content is inserted. This is important to know, as you might accidentally erase 
existing content.</p>
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate javaHigh">
    fprintf(fptr, &quot;Hello 
    World!&quot;);</div>
  <p>As a result, when we open the file on our computer, it says &quot;Hello World!&quot; 
  instead of &quot;Some text&quot;:</p>
  <div class="ws-grey">
   <img src="/c/c_files_write2.png" style="max-width:100%;"> </div>
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="/cpp/showcpp.asp?filename=c_demo_files_write2&stacked=h">Run example &raquo;</a>
</div>
</div>
<!--stop-->
...
<!--start-->
<h2>Append Content To a File</h2>
<p>If you want to add content to a file without deleting the old content, you can use the
<code class="w3-codespan">a</code> mode.</p>
<p>The <code class="w3-codespan">a</code> mode appends content at the end of the file:</p>


<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
    FILE *fptr;<br><br>// Open a file in append mode<br>fptr = fopen(&quot;filename.txt&quot;, &quot;a&quot;);<br>
    <br>// Append some text to the file<br>fprintf(fptr, &quot;\nHi everybody!&quot;);<br>
    <br>// Close the file<br>fclose(fptr);</div>
  <p>As a result, when we open the file on our computer, it looks like this:</p>
  <div class="ws-grey">
   <img src="/c/c_files_append.png" style="max-width:100%;"> </div>
<a target="_blank" class="w3-btn w3-margin-bottom w3-margin-top" href="/cpp/showcpp.asp?filename=c_demo_files_append&stacked=h">Run example &raquo;</a>
</div>

<div class="ws-note w3-panel">
<p><strong>Note:</strong> Just like with the <code class="w3-codespan">w</code> mode; if the file does not exist, the <code class="w3-codespan">a</code> 
mode will create a new file with the &quot;appended&quot; content.</p>
</div>
<!--stop-->
...
<div id="exercisecontainer" src="xrcise_files_write.js" data-extensions="php"></div>
<hr>
