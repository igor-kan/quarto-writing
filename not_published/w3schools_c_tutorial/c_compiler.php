<!DOCTYPE html>
<html lang="en-US">
<title>C Online Compiler (Editor / Interpreter)</title>
<style>
...
.c-preprocessor { color: #7D3C98; }   /* #include */
.c-keyword      { color: #005cc5 ; }   /* int, return */
.c-type         { color: #d73a49 ; }   /* int */
.c-function     { color: #d73a49 ; }   /* main, printf */
.c-string       { color: green ; }   /* "Hello World!" */
.c-number       { color: #098658; }   /* 0 */
.c-brace        { color: #000000; }
.c-symbol       { color: #000000; }

/* --- Dark mode  */
body.darkpagetheme .editor {
  background-color: rgb(21,32,43); 
}

body.darkpagetheme .editor pre {
  color: red; 
}

/* Dark-mode syntax highlighting */
body.darkpagetheme .c-preprocessor { color: #c792ea; } /* purple */
body.darkpagetheme .c-keyword      { color: #c5a5c5; } /* blue */
body.darkpagetheme .c-type         { color: #c5a5c5; } /* red/pink */
body.darkpagetheme .c-function     { color: #faca6b; } /* red/pink */
body.darkpagetheme .c-string       { color: #c3e88d; } /* green */
body.darkpagetheme .c-number       { color: #f78c6c; } /* orange */
body.darkpagetheme .c-brace        { color: #f1f1f1; }
body.darkpagetheme .c-symbol       { color: #f1f1f1; }

body.darkpagetheme .output {
  background-color: #000;
  color: #f1f1f1;
}

body.darkpagetheme .compiler-wrapper {
...
ny:-->
    ...
    <h1>C <span class="color_h1">Compiler</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_practice.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_syllabus.php">Next &#10095;</a>
</div>
<hr>
<h2>C Compiler (Editor)</h2>

<p>With our online C compiler, you can edit C code, and view the result in your browser.</p>
...
<div class="compiler-wrapper">
  ...
  <div class="compiler-body">
    ...
    <div class="editor">
<pre>
<span class="c-preprocessor">#include</span> <span class="c-symbol">&lt;</span><span class="c-function">stdio</span><span class="c-symbol">.</span><span class="c-function">h</span><span class="c-symbol">&gt;</span>

<span class="c-type">int</span> <span class="c-function">main</span><span class="c-brace">()</span> <span class="c-brace">{</span>
  <span class="c-function">printf</span><span class="c-brace">(</span><span class="c-string">"Hello World!"</span><span class="c-brace">)</span><span class="c-symbol">;</span>
  <span class="c-keyword">return</span> <span class="c-number">0</span><span class="c-symbol">;</span>
...
Hello World!
  ...
  <div class="compiler-footer">
    ...
    <a href="https://www.w3schools.com/c/tryc.php?filename=demo_compiler"
       target="_blank"
       class="ws-btn">
