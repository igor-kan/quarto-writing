<!DOCTYPE html>
<html lang="en-US">
<title>C The else if Statement</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>C <span class="color_h1">Else If</span></h1>

<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_conditions_else.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_conditions_short_hand.php">Next &#10095;</a>
</div>
<hr>
...
<p>
Use the <code class="w3-codespan">else if</code> statement to specify a new condition to test
if the first condition is <code class="w3-codespan">false</code>.
</p>

<p>
You can use <code class="w3-codespan">else if</code> to check multiple conditions, one after another.
</p>
...
&nbsp; <em>// block of code to be executed if condition1 is false and condition2 is true</em><br>
} else {<br>
&nbsp; <em>// block of code to be executed if both conditions are false</em><br>
}
</div>
</div>
...
As soon as one condition is <code class="w3-codespan">true</code>, its block of code runs, and the rest are skipped.
</p>
<!--stop-->
...
<p>
In the example below, we decide which message to print based on the value of
<code class="w3-codespan">time</code>:
</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_if_else_if">Try it Yourself &raquo;</a>
</div>

<h4>Example explained</h4>
<p>
The value of <code class="w3-codespan">time</code> is 16.
The first condition (<code class="w3-codespan">time &lt; 12</code>) is false,
but the second condition (<code class="w3-codespan">time &lt; 18</code>) is true.
Because of this, the code inside the <code class="w3-codespan">else if</code> block runs,
and "Good day." is printed.
</p>

<p>
If the value of <code class="w3-codespan">time</code> was 22, none of the conditions would be true,
and the program would print "Good evening." instead.
</p>
<!--stop-->
...
<p>
Just like with <code class="w3-codespan">if</code> statements, you can store conditions in boolean variables
and use them with <code class="w3-codespan">else if</code>:
</p>
...
bool isMorning = time &lt; 12;<br>
bool isDay = time &lt; 18;<br><br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_if_else_if_bool">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
<p>
<strong>Tip:</strong> Boolean variable names like <code class="w3-codespan">isMorning</code> and
<code class="w3-codespan">isDay</code> make it easier to understand what each condition means.
</p>
</div>
<!--stop-->

<hr>
<div id="exercisecontainer" src="xrcise_conditions_elseif.js" data-extensions="php"></div>
<hr>
