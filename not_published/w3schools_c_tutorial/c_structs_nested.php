<!DOCTYPE html>
<html lang="en-US">
<title>C Nested Structures (structs)</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>C <span class="color_h1">Nested Structures</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_challenges_structs.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_structs_pointers.php">Next &#10095;</a>
</div>
<hr>

<h2>Nested Structs</h2>

<p>A structure can also contain another structure as a member.  
This is called a <b>nested structure</b>, and it is useful when you want to group related data together in layers:</p>
...
&nbsp; char brand[30];<br>
&nbsp; int year;<br>
&nbsp; struct Owner owner; // Nested structure<br>
};<br>
<br>
int main() {<br>
&nbsp; struct Owner person = {"John", "Doe"};<br>
&nbsp; struct Car car1 = {"Toyota", 2010, person};<br>
<br>
&nbsp; printf("Car: %s (%d)\n", car1.brand, car1.year);<br>
&nbsp; printf("Owner: %s %s\n", car1.owner.firstName, car1.owner.lastName);<br>
<br>
&nbsp; return 0;<br>
}<br>
  </div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_struct_nested">Try it Yourself &raquo;</a>
</div>

<p>Here, the <code class="w3-codespan">Car</code> structure contains another structure (<code class="w3-codespan">Owner</code>) inside it.  
This makes it easy to organize complex data, for example, a car and its owner.</p>
<hr>
