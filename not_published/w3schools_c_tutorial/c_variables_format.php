<!DOCTYPE html>
<html lang="en-US">
<title>C Format Specifiers</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
<h1>C <span class="color_h1">Format Specifiers</span></h1>

<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_variables.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_variables_change.php">Next &#10095;</a>
</div>
<hr>

<!--start-->
<h2>Format Specifiers</h2>
<p>Format specifiers are used together with the <code class="w3-codespan">printf()</code> function to print variables.</p>
<p>You can think of a format specifier as a <strong>placeholder</strong> that tells C what kind of value will be printed.</p>

<p>A format specifier always starts with a percentage sign <code class="w3-codespan">%</code>, followed by a letter.</p>

<p>For example, to output the value of an <code class="w3-codespan">int</code> variable, 
use the format 
specifier <code class="w3-codespan">%d</code> surrounded by double quotes (<code class="w3-codespan">""</code>), 
inside the <code class="w3-codespan">printf()</code> function:</p><div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  int myNum = 15;<br>
  printf(&quot;%d&quot;, myNum); // Outputs 15</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_variables_printf_int">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
<p><strong>How it works:</strong> <code class="w3-codespan">%d</code> tells C to expect an integer value, and <code class="w3-codespan">myNum</code> provides that value.</p>
</div>

<p>Different data types use different format specifiers:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  // Create variables<br>
  int myNum = 15;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// Integer (whole number)<br>
  ...
  printf(&quot;%f\n&quot;, myFloatNum);<br>
  printf(&quot;%c\n&quot;, myLetter);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_variables_data_types">Try it Yourself &raquo;</a>
</div>

<p>To combine both text and a variable, separate them with a comma inside the <code class="w3-codespan">
printf()</code> function:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  int myNum = 15;<br>
  printf(&quot;My favorite number is: %d&quot;, myNum);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_variables_combine">Try it Yourself &raquo;</a>
</div>

<p>To print different types in a single <code class="w3-codespan">printf()</code> function, you can use the 
following:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  int myNum = 15;<br>
  char myLetter = 'D';<br>
  printf(&quot;My number is %d and my letter is %c&quot;, myNum, myLetter);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_variables_data_types2">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
<p><strong>Tip:</strong> Each format specifier must match the correct type of value.</p>
<p>You will learn more about <a href="c_data_types.php">data types</a> later in this tutorial.</p>
</div>
<!--stop-->
...
<!--start-->
<h2>Print Values Without Variables</h2>
<p>You can also print values directly without storing them in variables, as long as you use the correct format specifier:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  printf(&quot;My favorite number is: %d&quot;, 15);<br>
  printf(&quot;My favorite letter is: %c&quot;, 'D');</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_variables_withoutfs">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
<p><strong>Note:</strong> Using variables is usually better, because the value can be reused and changed later.</p>
</div>
<!--stop-->

<hr>
<div id="exercisecontainer" src="xrcise_variables_format.js" data-extensions="php"></div>
<hr>
