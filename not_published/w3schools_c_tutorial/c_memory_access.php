...
ny:-->
    ...
    <h1>C <span class="color_h1">Access Memory</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_memory_allocate.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_memory_reallocate.php">Next &#10095;</a>
</div>
<hr>

<!--start-->
<h2>Access Dynamic Memory</h2>
<p>Dynamic memory behaves like an array, with its data type specified by the type of the pointer.</p>

<p>As with arrays, to access an element in dynamic memory, refer to its <strong>index number</strong>:</p>
...
<p>You can also dereference the pointer to access the first element:</p>
<div class="w3-example">
<div class="w3-code notranslate javaHigh">
*ptr = 12;
</div>
...
<div class="w3-example">
<h3>Example</h3>
<p>Read from and write to dynamic memory:</p>
<div class="w3-code notranslate javaHigh">
  // Allocate memory<br>int *ptr;<br>ptr = calloc(4, sizeof(*ptr));<br><br>// 
  Write to the memory<br>*ptr = 2;<br>ptr[1] = 4;<br>ptr[2] = 6;<br><br>// Read 
  from the memory<br>printf(&quot;%d\n&quot;, *ptr);<br>printf(&quot;%d %d %d&quot;, ptr[1], ptr[2], 
  ptr[3]);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_memory_access">Try it Yourself &raquo;</a>
</div>

<h3>A note about data types</h3>
<p>Dynamic memory does not have its own data type, it is just a sequence of bytes. The data in the memory can be interpreted as a type based on the data type of the pointer.</p>
<p>In this example a pointer to four bytes can be interpreted as one <code class="w3-codespan">int</code> value (4 bytes) or as an array of 4 <code class="w3-codespan">char</code> values (1 byte each).

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  int *ptr1 = malloc(4);<br>char *ptr2 = (char*) ptr1;<br>ptr1[0] = 1684234849;<br>
  printf(&quot;%d is %c %c %c %c&quot;, *ptr1, ptr2[0], ptr2[1], ptr2[2], ptr2[3]);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_memory_access2">Try it Yourself &raquo;</a>
</div>
<!--stop-->
...
<div id="exercisecontainer" src="xrcise_memory_access.js" data-extensions="php"></div>
<hr>
<!--
