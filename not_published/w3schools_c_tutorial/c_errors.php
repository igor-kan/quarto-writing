...
ny:-->
    ...
    <h1>C <span class="color_h1">Errors</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_memory_reallife.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_challenges_errors.php">Next &#10095;</a>
</div>
<hr>

<!--start-->
<h2>Errors</h2>
<p>Even experienced C developers make mistakes. The key is learning how to spot and fix them!</p>
<p>These pages cover common errors and helpful debugging tips to help you understand what's going wrong and how to fix it.</p>
<!--stop-->
<hr>

<!--start-->
<h2>Common Compile-Time Errors</h2>
<p>Compile-time errors are mistakes that prevent your program from compiling.</p>

<p><strong>1) Missing semicolon:</strong></p>
...
<code>error: expected ',' or ';' before 'printf'</code>
</div>
  <a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryc.php?filename=demo_error_semicolon">Try it Yourself &raquo;</a>
</div>

<p><strong>2) Using undeclared variables:</strong></p>
<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate javaHigh w3-border-red">
    #include &lt;stdio.h&gt;<br>
...
<p>Result:</p>
<div class="w3-padding w3-black">
<code>error: 'myVar' undeclared</code>
</div>
  <a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryc.php?filename=demo_error_undeclared">Try it Yourself &raquo;</a>
</div>

<p><strong>3) Mismatched types</strong> (e.g. assigning a <code class="w3-codespan">string</code> to an <code class="w3-codespan">int</code>):</p>
<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate javaHigh w3-border-red">
    #include &lt;stdio.h&gt;<br>
...
<p>Result:</p>
<div class="w3-padding w3-black">
<code>error: initialization makes integer from pointer without a cast</code>
</div>
  <a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryc.php?filename=demo_error_mismatch">Try it Yourself &raquo;</a>
</div>
<!--stop-->
...
<p>Runtime errors occur when the program compiles but crashes or behaves unexpectedly.</p>

<p><strong>1) Dividing by zero:</strong></p>
<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate javaHigh w3-border-red">
    #include &lt;stdio.h&gt;<br>
    ...
    &nbsp;&nbsp;int y = 0;<br>
    &nbsp;&nbsp;int result = x / y;<br>
    &nbsp;&nbsp;printf("%d\\n", result);  // not possible<br>
    &nbsp;&nbsp;return 0;<br>
    }
  </div>
</div>

<p><strong>2) Accessing out-of-bounds array elements:</strong></p>
<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate javaHigh w3-border-red">
    #include &lt;stdio.h&gt;<br>
    <br>
    int main() {<br>
    &nbsp;&nbsp;int numbers[3] = {1, 2, 3};<br>
    &nbsp;&nbsp;printf("%d\\n", numbers[8]);  // element does not exist<br>
    &nbsp;&nbsp;return 0;<br>
    }
  </div>
</div>

<p><strong>3) Using freed memory:</strong></p>
<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate javaHigh w3-border-red">
    #include &lt;stdio.h&gt;<br>
    ...
    <br>
    int main() {<br>
    &nbsp;&nbsp;int* ptr = malloc(sizeof(int));<br>
    &nbsp;&nbsp;*ptr = 10;<br>
    &nbsp;&nbsp;free(ptr); <br>
    &nbsp;&nbsp;printf("%d\\n", *ptr); // Undefined behavior - accessing memory that was freed<br>
    &nbsp;&nbsp;return 0;<br>
    }
  </div>
</div>
...
<!--start-->
<h2>Good Habits to Avoid Errors</h2>
<ul>
  <li>Always initialize your variables</li>
  <li>Use meaningful variable names</li>
  <li>Keep your code clean and use indentation to stay organized</li>
  <li>Keep functions short and focused</li>
  <li>Check if loops or conditions are running as expected</li>
  <li>Read error messages carefully - they often tell you exactly where the problem is</li>
</ul>

<p>In the next chapter, you will learn how to debug your code - how to find and fix bugs/errors in your C program.</p>
<!--stop-->

<hr>
<div id="exercisecontainer" src="xrcise_errors.js" data-extensions="php"></div>
<hr>
