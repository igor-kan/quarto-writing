<!DOCTYPE html>
<html lang="en-US">
<title>C Enum (Enumeration)</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>C <span class="color_h1">Enumeration (enum)</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_structs_padding.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_challenges_enums.php">Next &#10095;</a>
</div>
<hr>
...
<p>An <strong>enum</strong> is a special type that represents a group of constants (unchangeable values).</p>

<p>To create an enum, use the <code class="w3-codespan">enum</code> keyword, 
followed by the name of the enum, and separate the enum items with a comma:</p>

<div class="w3-example">
<div class="w3-code notranslate javaHigh">
  enum Level {<br>&nbsp; LOW,<br>&nbsp; MEDIUM,<br>&nbsp; HIGH<br>};</div>
</div>

<div class="ws-note w3-panel">
<p>Note that the last item does not need a comma.</p>
<p>It is not required to use uppercase, but often considered as good practice.</p>
<p>Enum is short for "enumerations", which means "specifically listed".</p>
</div>

<p>To access the enum, you must create a variable of it.</p>
<p>Inside the <code class="w3-codespan">main()</code> method, specify the <code class="w3-codespan">enum</code> keyword, followed by the name 
of the enum (<code class="w3-codespan">Level</code>) and then the name of the enum variable (<code class="w3-codespan">myVar</code> in this 
example):</p>

<div class="w3-example">
<div class="w3-code notranslate javaHigh">
  enum Level myVar;</div>
</div>

<p>Now that you have created an enum variable (<code class="w3-codespan">myVar</code>), you can assign 
a value to it.</p>
<p>The assigned value must be one of the items inside the enum (<code class="w3-codespan">LOW</code>, <code class="w3-codespan">MEDIUM</code> or <code class="w3-codespan">HIGH</code>):</p>

<div class="w3-example">
<div class="w3-code notranslate javaHigh">
  enum Level myVar = MEDIUM;</div>
</div>

<p>By default, the first item (<code class="w3-codespan">LOW</code>) has the value <code class="w3-codespan">0</code>, the second 
(<code class="w3-codespan">MEDIUM</code>) has the value <code class="w3-codespan">1</code>, etc.</p>
<p>If you now try to print myVar, it will output <code class="w3-codespan">1</code>, which represents <code class="w3-codespan">MEDIUM</code>:</p>

<div class="w3-example">
<div class="w3-code notranslate javaHigh">
  int main() {<br>&nbsp; // Create an enum variable and assign a value to it<br>&nbsp; enum Level myVar 
  = MEDIUM;<br>
  <br>&nbsp; // Print the enum variable<br>&nbsp; printf(&quot;%d&quot;, myVar);<br><br>&nbsp; 
  return 0;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_enum">Try it Yourself &raquo;</a>
</div>

<!--
<p>You can also assign a value to the enum variable when you create it:</p>

<div class="w3-example">
<div class="w3-code notranslate javaHigh">
  int main() {<br>&nbsp; // Create an enum variable and assign a value to it<br>&nbsp; enum Level myVar = MEDIUM;<br>
  <br>&nbsp; // Print the enum variable<br>&nbsp; printf(&quot;%d&quot;, myVar);<br><br>&nbsp; 
  return 0;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_enum2">Try it Yourself &raquo;</a>
</div>
-->
<!--stop-->
...
<p>As you know, the first item of an enum has the value 0. The second has the value 1, and so on.</p>
<p>To make more sense of the values, you can easily change them:</p>

<div class="w3-example">
<div class="w3-code notranslate javaHigh">
  enum Level {<br>&nbsp; LOW = 25,<br>&nbsp; MEDIUM = 50,<br>&nbsp; HIGH = 75<br>
  };</div>
  <div class="w3-code notranslate javaHigh">
    printf(&quot;%d&quot;, myVar); // Now outputs 50</div>

<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_enum_change">Try it Yourself &raquo;</a>
</div>

<p>Note that if you assign a value to one specific item, the next items will update their numbers accordingly:</p>

<div class="w3-example">
<div class="w3-code notranslate javaHigh">
  enum Level {<br>&nbsp; LOW = 5,<br>&nbsp; MEDIUM,&nbsp;// Now 6<br>&nbsp; HIGH&nbsp;// Now 7<br>
  };</div>

<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_enum_change2">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>

<!--start-->
<h2>Enum in a Switch Statement</h2>
<p>Enums are often used in switch statements to check for corresponding values:</p>

<div class="w3-example">
<div class="w3-code notranslate javaHigh">
  enum Level {<br>&nbsp; LOW = 1,<br>&nbsp; MEDIUM,<br>&nbsp; HIGH<br>};<br><br>int main() {<br>&nbsp; 
  enum Level myVar = MEDIUM;<br><br>&nbsp; switch (myVar) {<br>&nbsp;&nbsp;&nbsp; 
  case 1:<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; printf(&quot;Low Level&quot;);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  break;<br>&nbsp;&nbsp;&nbsp; case 2:<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  printf(&quot;Medium level&quot;);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; break;<br>&nbsp;&nbsp;&nbsp; 
  case 3:<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; printf(&quot;High level&quot;);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  break;<br>&nbsp; }<br>&nbsp; return 0;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_enum_switch">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>typedef with enum</h2>

<p>You can also use <code class="w3-codespan">typedef</code> with <code class="w3-codespan">enum</code>.  
This makes it easier to declare variables of the enum type, without having to write <code class="w3-codespan">enum</code> every time:</p>

<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate javaHigh">
// Without typedef<br>
enum Day {MON, TUE, WED, THU, FRI, SAT, SUN};<br>
enum Day today = WED;<br>
<br>
// With typedef<br>
typedef enum {MON, TUE, WED, THU, FRI, SAT, SUN} Day;<br>
Day today = WED;<br>
  </div>
</div>

<p>Both versions work the same, but the <code class="w3-codespan">typedef</code> version is shorter and easier to read:</p>
...
&nbsp; return 0;<br>
  ...
  <a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_typedef_enum">Try it Yourself &raquo;</a>
</div>
<hr>

<div class="ws-note w3-panel">
  <h4>Why And When To Use Enums?</h4>
  <p>Enums are used to give names to constants, which makes the code easier to 
  read and maintain.</p>
...
<hr>
<div id="exercisecontainer" src="xrcise_enums.js" data-extensions="php"></div>
<hr>
