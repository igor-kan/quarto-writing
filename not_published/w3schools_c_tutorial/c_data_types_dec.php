<!DOCTYPE html>
<html lang="en-US">
<title>C Data Types Decimal Precision</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>C <span class="color_h1">Decimal Precision</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_data_types_numbers.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_data_types_sizeof.php">Next &#10095;</a>
</div>
<hr>

<!--start-->
<h2>Set Decimal Precision</h2>
<p>You have probably already noticed that if you print a floating point number, 
the output will show many digits after the decimal point:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  float myFloatNum = 3.5;<br>double myDoubleNum = 19.99;<br><br>
  printf(&quot;%f\n&quot;, myFloatNum); 
  // Outputs 3.500000<br>printf(&quot;%lf&quot;, myDoubleNum); // Outputs 
  19.990000</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_decimal_precision">Try it Yourself &raquo;</a>
</div>

<p>If you want to remove the extra zeros (set decimal precision), you can use a 
dot (<code class="w3-codespan">.</code>) followed by a number that specifies how many digits that should be shown 
after the decimal point:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  float myFloatNum = 3.5;<br><br>printf(&quot;%f\n&quot;, myFloatNum);&nbsp;&nbsp; // Default will show 6 digits after the decimal point<br>printf(&quot;%.1f\n&quot;, 
  myFloatNum); // Only show 1 digit<br>printf(&quot;%.2f\n&quot;, myFloatNum); // Only 
  show 2 digits<br>printf(&quot;%.4f&quot;, myFloatNum);&nbsp;&nbsp; // Only show 4 digits</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_decimal_precision2">Try it Yourself &raquo;</a>
</div>
<!--stop-->
...
<div id="exercisecontainer" src="xrcise_data_types_dec.js" data-extensions="php"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_data_types_numbers.php">&#10094; Previous</a>
