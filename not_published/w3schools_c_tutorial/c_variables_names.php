<!DOCTYPE html>
<html lang="en-US">
<title>C Variable Names (Identifiers)</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>C <span class="color_h1">Variable Names (Identifiers)</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_variables_multiple.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_variables_reallife.php">Next &#10095;</a>
</div>
<hr>

<!--start-->
<h2>C Variable Names</h2>
<p>All C <strong>variables</strong> must be
...
<p><strong>Note:</strong> It is recommended to use descriptive names in order to 
create understandable and maintainable code:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  // Good variable name<br>int minutesPerHour = 60;<br><br>// OK, but not so easy to 
  understand what <strong>m</strong> actually is<br>int  
  m = 60;<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_variables_identifiers">Try it Yourself &raquo;</a>
</div>

<p>The<strong> general rules </strong>for naming variables are:</p>
<ul>
  <li>Names can contain letters, digits and underscores</li>
  <li>Names must begin with a letter or an underscore (_)</li>
  <li>Names are case-sensitive (<code class="w3-codespan">myVar</code> and <code class="w3-codespan">myvar</code> are different variables)</li>
  <li>Names cannot contain whitespaces or special characters like !, #, %, etc.</li>
  <li>Reserved words (such as <code class="w3-codespan">int</code>) cannot be used as names</li>
</ul>

<div class="ws-note w3-panel">
<h4>Valid and Invalid Names</h4>
<p>Here are some examples to help you remember the rules:</p>
<ul>
  <li><strong>Valid:</strong> <code class="w3-codespan">age</code>, <code class="w3-codespan">_count</code>, <code class="w3-codespan">totalSum</code></li>
  <li><strong>Invalid:</strong> <code class="w3-codespan">1age</code> (starts with a number), <code class="w3-codespan">my-age</code> (contains <code class="w3-codespan">-</code>), <code class="w3-codespan">int</code> (reserved word)</li>
</ul><hr>
<p><strong>Naming style:</strong> Many C programmers use <em>camelCase</em> (like <code class="w3-codespan">totalScore</code>) or underscores
(like <code class="w3-codespan">total_score</code>). Choose one style and use it consistently.</p>
</div>
<!--stop-->
...
<div id="exercisecontainer" src="xrcise_variables_names.js" data-extensions="php"></div>
<hr>
