...
<html lang="en-US">
<head>
<title>C Challenges (Coding Challenges)</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>C <span class="color_h1">Code Challenges</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_quiz.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_practice.php">Next &#10095;</a>
</div>
<hr>
<p>Test your C skills with code challenges from all categories:</p>

<div class="challenge_tiles">
<h2 class="heading">Code Challenges</h2>
<div class="challenge_toolbar">
  <input id="challenge_filter" type="search" placeholder="Filter challenges (e.g. variables, functions, arrays)" aria-label="Filter challenges">
</div>
...
(function() {
  ...
  overviews.forEach(function(overview) {
    var challengeLink = overview.querySelector('a[href*="c_challenges_"]');
    if (challengeLink) {
      ...
      var title = headerLink ? headerLink.textContent.trim() : href.replace('c_challenges_', '').replace('.asp', '');
      title = title.replace(/^C\s*/i, '');
...
<p>Code challenges are interactive coding exercises where you write C code to achieve a specific result.</p>
<p>Each challenge presents you with a goal and lets you practice writing real C code.</p>
