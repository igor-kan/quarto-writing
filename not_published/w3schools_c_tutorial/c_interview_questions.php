...
ny:-->
    ...
    <h1>C <span class="color_h1">Interview Questions</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_study_plan.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="index.php">Next &#10095;</a>
</div>
<hr>

<h2>C Interview Questions with Answers</h2>

<p>
This page gives simple C interview questions with short answers.
The questions are made for beginners, so you can use them to study for tests and job interviews.
</p>

<ul>
  <li>Core C basics and program structure</li>
  <li>Variables and data types</li>
  <li>Conditions and loops</li>
  <li>Arrays and strings</li>
  <li>Pointers and memory</li>
  <li>Functions, scope, and structures</li>
</ul>

<hr>

<h2 class="interview-h2">Core C Basics</h2>

<h3>1. What is C used for?</h3>
<p><strong>Answer:</strong></p>
<ul>
  <li>C is a programming language used to write fast and efficient programs.</li>
  <li>It is often used for system software, embedded systems, and performance-critical applications.</li>
</ul>
<hr>

<h3>2. What is the basic structure of a C program?</h3>
<p><strong>Answer:</strong></p>
<ul>
  <li>A typical C program has <code class="w3-codespan">#include</code> lines, a <code class="w3-codespan">main()</code> function, and C statements inside <code class="w3-codespan">{ }</code>.</li>
</ul>

<div class="w3-example">
  <pre class="language-c w3-white"><code>#include &lt;stdio.h&gt;
...
<h3>3. What does the main() function do in C?</h3>
<p><strong>Answer:</strong></p>
<ul>
  <li><code class="w3-codespan">main()</code> is the starting point of every C program.</li>
  <li>The code inside <code class="w3-codespan">main()</code> runs first when the program starts.</li>
  <li>The <code class="w3-codespan">return 0;</code> line usually means "the program ended successfully".</li>
</ul>
...
<h3>4. What is the purpose of #include &lt;stdio.h&gt;?</h3>
<p><strong>Answer:</strong></p>
<ul>
  <li><code class="w3-codespan">#include &lt;stdio.h&gt;</code> tells the compiler to include the standard input/output library.</li>
  <li>It lets you use functions like <code class="w3-codespan">printf()</code> and <code class="w3-codespan">scanf()</code>.</li>
</ul>

<hr>

<h3>5. What does printf() do?</h3>
<p><strong>Answer:</strong></p>
<ul>
  <li><code class="w3-codespan">printf()</code> prints text and values to the screen.</li>
  <li>You can use format specifiers like <code class="w3-codespan">%d</code> for integers and <code class="w3-codespan">%f</code> for floating-point numbers.</li>
</ul>
...
<h2 class="interview-h2">Variables and Data Types</h2>

<h3>6. What is a variable in C?</h3>
<p><strong>Answer:</strong></p>
<ul>
  <li>A variable is a named place in memory where a value is stored.</li>
  <li>In C, you must declare the type before the variable name.</li>
</ul>

<div class="w3-example">
  <pre class="language-c w3-white"><code>int count = 10;
float price = 19.95;
...
<h3>7. What is the difference between int, float, and char?</h3>
<p><strong>Answer:</strong></p>
<ul>
  <li><code class="w3-codespan">int</code> stores whole numbers (e.g. 3, -10, 200).</li>
  <li><code class="w3-codespan">float</code> stores numbers with decimals (e.g. 3.14, -0.5).</li>
  <li><code class="w3-codespan">char</code> stores a single character (e.g. <code class="w3-codespan">'A'</code>, <code class="w3-codespan">'B'</code>).</li>
</ul>

<hr>

<h3>8. What is a constant and why would you use one?</h3>
<p><strong>Answer:</strong></p>
<ul>
  <li>A constant is a value that cannot be changed once it is set.</li>
  <li>Using <code class="w3-codespan">const</code> makes your intent clear and protects the value from being changed by mistake.</li>
</ul>

<div class="w3-example">
  <pre class="language-c w3-white"><code>const int DAYS_IN_WEEK = 7;
// DAYS_IN_WEEK = 8; // not allowed</code></pre>
</div>

<hr>

<h3>9. How do you read user input in C?</h3>
<p><strong>Answer:</strong></p>
<ul>
  <li>You can use <code class="w3-codespan">scanf()</code> to read values from the keyboard.</li>
  <li>You must pass the address of the variable using <code class="w3-codespan">&amp;</code>.</li>
</ul>

<div class="w3-example">
  <pre class="language-c w3-white"><code>int number;
scanf("%d", &amp;number);</code></pre>
</div>

<hr>

<h2 class="interview-h2">Conditions and Loops</h2>

<h3>10. What is an if statement used for?</h3>
<p><strong>Answer:</strong></p>
<ul>
  <li>An <code class="w3-codespan">if</code> statement lets the program make a decision.</li>
  <li>Code inside the <code class="w3-codespan">if</code> block runs only when the condition is true.</li>
</ul>

<div class="w3-example">
  <pre class="language-c w3-white"><code>int age = 20;
...
<h3>11. What is a loop in C?</h3>
<p><strong>Answer:</strong></p>
<ul>
  <li>A loop repeats the same block of code multiple times.</li>
  <li>C has <code class="w3-codespan">for</code>, <code class="w3-codespan">while</code>, and <code class="w3-codespan">do...while</code> loops.</li>
</ul>

<div class="w3-example">
  <pre class="language-c w3-white"><code>for (int i = 1; i &lt;= 5; i++) {
  printf("%d\n", i);
}</code></pre>
</div>
...
<h3>12. What is the difference between while and do...while?</h3>
<p><strong>Answer:</strong></p>
<ul>
  <li><code class="w3-codespan">while</code> checks the condition before running the loop body.</li>
  <li><code class="w3-codespan">do...while</code> runs the loop body once, then checks the condition.</li>
  <li>This means <code class="w3-codespan">do...while</code> always runs at least one time.</li>
</ul>

<hr>

<h3>13. What is a switch statement?</h3>
<p><strong>Answer:</strong></p>
<ul>
  <li>A <code class="w3-codespan">switch</code> statement chooses one block of code to run based on the value of an expression.</li>
  <li>Each option is written as a <code class="w3-codespan">case</code>, and <code class="w3-codespan">default</code> handles all other values.</li>
</ul>

<div class="w3-example">
  <pre class="language-c w3-white"><code>int day = 2;
...
<h2 class="interview-h2">Arrays and Strings</h2>

<h3>14. What is an array in C?</h3>
<p><strong>Answer:</strong></p>
<ul>
  <li>An array stores many values of the same type in one variable name.</li>
  <li>You access each element by its index, starting from 0.</li>
</ul>

<div class="w3-example">
  <pre class="language-c w3-white"><code>int scores[3] = {10, 20, 30};
printf("%d\n", scores[0]); // first element</code></pre>
</div>

<hr>

<h3>15. How are strings represented in C?</h3>
<p><strong>Answer:</strong></p>
<ul>
  <li>In C, a string is an array of characters.</li>
  <li>It ends with a special character <code class="w3-codespan">'\0'</code> (the null terminator).</li>
</ul>

<div class="w3-example">
  <pre class="language-c w3-white"><code>char greeting[] = "Hello";
printf("%s\n", greeting);</code></pre>
</div>

<hr>

<h2 class="interview-h2">Pointers and Memory</h2>

<h3>16. What is a pointer in C?</h3>
<p><strong>Answer:</strong></p>
<ul>
  <li>A pointer is a variable that stores the memory address of another variable.</li>
  <li>Pointers are used to work directly with memory and to share data with functions.</li>
</ul>

<div class="w3-example">
  <pre class="language-c w3-white"><code>int value = 10;
int *ptr = &amp;value;  // ptr holds the address of value</code></pre>
</div>

<hr>

<h3>17. What do the & and * operators mean with pointers?</h3>
<p><strong>Answer:</strong></p>
<ul>
  <li><code class="w3-codespan">&amp;</code> gives the address of a variable (the "address of&quot; operator).</li>
  <li><code class="w3-codespan">*</code> gives the value at an address (the "dereference&quot; operator).</li>
</ul>

<div class="w3-example">
  <pre class="language-c w3-white"><code>int x = 5;
int *p = &amp;x;    // &amp;x is the address of x
printf("%d\n", *p); // *p is the value at that address (5)</code></pre>
</div>

<hr>

<h3>18. What is a NULL pointer?</h3>
<p><strong>Answer:</strong></p>
<ul>
  <li>A NULL pointer is a pointer that does not point to any valid memory location.</li>
  <li>It is often used to show that the pointer is "empty&quot; or not yet set.</li>
</ul>

<div class="w3-example">
  <pre class="language-c w3-white"><code>int *ptr = NULL;  // pointer not pointing anywhere yet</code></pre>
</div>

<hr>

<h2 class="interview-h2">Functions, Scope, and Structures</h2>

<h3>19. What is a function in C and why use it?</h3>
<p><strong>Answer:</strong></p>
<ul>
  <li>A function is a block of code that performs a specific task.</li>
  <li>Functions help you split a large program into smaller, reusable pieces.</li>
</ul>

<div class="w3-example">
  <pre class="language-c w3-white"><code>int add(int a, int b) {
  return a + b;
}</code></pre>
</div>
...
<h3>20. What is the difference between local and global variables?</h3>
<p><strong>Answer:</strong></p>
<ul>
  <li>A local variable is declared inside a function and can be used only there.</li>
  <li>A global variable is declared outside all functions and can be used in the entire file (after its declaration).</li>
</ul>

<hr>

<h3>21. What is a struct in C?</h3>
<p><strong>Answer:</strong></p>
<ul>
  <li>A <code class="w3-codespan">struct</code> (structure) is a custom type that groups related variables under one name.</li>
  <li>The grouped variables can have different types.</li>
</ul>

<div class="w3-example">
  <pre class="language-c w3-white"><code>struct Person {
  char name[50];
  int age;
};</code></pre>
</div>
...
<h3>22. Why would you use a struct instead of separate variables?</h3>
<p><strong>Answer:</strong></p>
<ul>
  <li>A struct keeps related information together, making the code easier to understand.</li>
  <li>It is useful when you want to treat multiple pieces of data as one unit (for example, a person or a product).</li>
</ul>
<hr>
