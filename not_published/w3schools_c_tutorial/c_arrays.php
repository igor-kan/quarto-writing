...
ny:-->
    ...
    <h1>C <span class="color_h1">Arrays</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_break_continue.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_arrays_size.php">Next &#10095;</a>
</div>
<hr>
...
value.</p>
<p>To create an array, define the data type (like <code class="w3-codespan">int</code>) and specify the name 
of the array followed by <strong>square brackets []</strong>.

</p>
<p>To insert values to it, use a comma-separated list inside curly braces, and 
make sure all values are of the same data type:</p>
...
<p>We have now created a variable that holds an array of four integers.</p>
<!--stop-->
<hr>

<!--start-->
<h2>Access the Elements of an Array</h2>
<p>To access an array element, refer to its<strong> index number</strong>.</p>
<p>Array indexes start with <strong>0</strong>: [0] is the first element. [1] is the second element, etc.</p>
<p>This statement accesses the value of the <strong>first element [0]</strong> in 
<code class="w3-codespan">myNumbers</code>:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  int myNumbers[] = {25, 50, 75, 100};<br>
  printf(&quot;%d&quot;, myNumbers[0]);<br><br>// Outputs 25<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_array">Try it Yourself &raquo;</a>
</div>
<!--stop-->
...
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  int myNumbers[] = {25, 50, 75, 100};<br>myNumbers[0] = 33;<br><br>
  printf(&quot;%d&quot;, myNumbers[0]);<br><br>
  // Now outputs 33 instead of 25<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_array_change">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr id="arrayloop">
...
<p>Another common way to create arrays, is to specify the size of the array, and add 
elements later:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  // Declare an array of four integers:<br>int myNumbers[4];<br><br>// Add 
  elements<br>myNumbers[0] = 25;<br>myNumbers[1] = 50;<br>myNumbers[2] = 75;<br>
  myNumbers[3] = 100;<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_array_set_size">Try it Yourself &raquo;</a>
</div>
<p>Using this method, <strong>you should know the number of array elements in advance,</strong> 
in order for the program to store enough memory.</p>
<p>You are not able to change the size of the array after creation.</p>
<!--stop-->
<hr>

<!--start-->
<h2>Avoid Mixing Data Types</h2>
<p>It is important to note that all elements in an array <strong>must be of the same 
<a href="c_data_types.php">data type</a></strong>.</p>
<p>This means you cannot mix different types of values, like <strong>integers</strong> and 
<strong>floating point</strong> numbers, in the same array:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_array_type">Try it Yourself &raquo;</a>
</div>
<p>In the example above, the values <code class="w3-codespan">3.15</code> and <code class="w3-codespan">5.99</code> will be truncated to <code class="w3-codespan">3</code> and <code class="w3-codespan">5</code>. In some cases it might also result in an error, so 
it is important to always make sure that the elements in the array are of the 
same type.</p>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_arrays.js" data-extensions="php"></div>
<hr>
