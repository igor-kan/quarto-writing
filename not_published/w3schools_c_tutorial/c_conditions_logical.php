<!DOCTYPE html>
<html lang="en-US">
<title>C Logical Operators in Conditions</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>C <span class="color_h1">Logical Operators in Conditions</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_conditions_nested.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_conditions_reallife.php">Next &#10095;</a>
</div>
<hr>

<h2>Logical Operators in Conditions</h2>

<p>You can combine or reverse conditions using <a href="c_operators_logical.php">logical operators</a>. 
These work together with <code class="w3-codespan">if</code>, <code class="w3-codespan">else</code>, and <code class="w3-codespan">else if</code> to build more complex decisions.</p>

<ul>
  <li><code class="w3-codespan">&amp;&amp;</code> (AND) - all conditions must be true</li>
  <li><code class="w3-codespan">||</code> (OR) - at least one condition must be true</li>
  <li><code class="w3-codespan">!</code> (NOT) - reverses a condition (<code class="w3-codespan">true</code> &#8594; <code class="w3-codespan">false</code>, <code class="w3-codespan">false</code> &#8594; <code class="w3-codespan">true</code>)</li>
</ul>

<hr>

<h2>AND (<code class="w3-codespan">&amp;&amp;</code>)</h2>

<p>Use AND (<code class="w3-codespan">&amp;&amp;</code>) when <strong>both</strong> conditions must be true:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Test if <code>a</code> is greater than <code>b</code>, <strong>and</strong> if <code>c</code> is greater than <code>a</code>:</p>
<pre class="language-c w3-white"><code>int a = 200;
int b = 33;
int c = 500;
...
<p>
<a target="_blank" class="w3-btn" href="tryc.php?filename=demo_if_and">Try it Yourself &raquo;</a>
</p>
</div>

<hr>

<h2>OR (<code class="w3-codespan">||</code>)</h2>

<p>Use OR (<code class="w3-codespan">||</code>) when <strong>at least one</strong> of the conditions can be true:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Test if <code>a</code> is greater than <code>b</code>, <strong>or</strong> if <code>a</code> is greater than <code>c</code>:</p>
<pre class="language-c w3-white"><code>int a = 200;
int b = 33;
int c = 500;
...
<p>
<a target="_blank" class="w3-btn" href="tryc.php?filename=demo_if_or">Try it Yourself &raquo;</a>
</p>
</div>
...
<h2>NOT (<code class="w3-codespan">!</code>)</h2>
<p>
The NOT operator (<code class="w3-codespan">!</code>) <strong>reverses</strong> a condition:
</p>
<ul>
  <li>If a condition is <code class="w3-codespan">true</code>, <code class="w3-codespan">!</code> makes it <code class="w3-codespan">false</code>.</li>
  <li>If a condition is <code class="w3-codespan">false</code>, <code class="w3-codespan">!</code> makes it <code class="w3-codespan">true</code>.</li>
</ul>
<p>This is useful when you want to check that something <em>is not</em> the case:</p>

<div class="w3-example">
  <h3>Example</h3>
  <p>Test if <code>a</code> is <strong>not</strong> greater than <code>b</code>:</p>
  <pre class="language-c w3-white"><code>int a = 33;
int b = 200;
...
if (!(a &gt; b)) { 
  ...
  <p>
    <a target="_blank" class="w3-btn" href="tryc.php?filename=demo_if_not">Try it Yourself &raquo;</a>
  </p>
</div>
<hr>
...
<p>In real programs, logical operators are often used for access control.  
For example, to get access to a system, there are specific requirements:</p>

<p>You must be logged in, and then you either need to be an admin, 
or have a high security clearance (level 1 or 2):</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-c w3-white"><code>bool isLoggedIn = true;
bool isAdmin = false;
...
<p>
<a target="_blank" class="w3-btn" href="tryc.php?filename=demo_if_security">Try it Yourself &raquo;</a>
</p>
</div>
<hr>
