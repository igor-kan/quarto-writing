<!DOCTYPE html>
<html lang="en-US">
<title>C Real-Life For Loop Examples</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>C <span class="color_h1">For Loop Examples</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_for_loop_nested.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_challenges_for_loop.php">Next &#10095;</a>
</div>
<hr>

<h2>Real-Life Examples</h2>
<p>To demonstrate a practical example of the <strong>for loop</strong>, let's 
create a program that counts to 100 by tens:</p>
...
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  for (i = 0; i &lt;= 10; i = i + 2) {<br>&nbsp; printf(&quot;%d\n&quot;, i);<br>}<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_for_loop_even">Try it Yourself &raquo;</a>
</div>

<p>Here we only print odd numbers:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
  for (i = 1; i &lt; 10; i = i + 2) {<br>&nbsp; printf(&quot;%d\n&quot;, i);<br>}<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_for_loop_odd">Try it Yourself &raquo;</a>
</div>

<p>In this example we print the powers of 2 up to 512:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
...
<p>And in this example, we create a program that prints the multiplication table for a specified number:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate javaHigh">
