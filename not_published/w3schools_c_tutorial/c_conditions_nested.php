...
ny:-->
    ...
    <h1>C <span class="color_h1">Nested If</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_conditions_short_hand.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_conditions_logical.php">Next &#10095;</a>
</div>
<hr>

<h2>Nested If</h2>

<p>You can also place an <code class="w3-codespan">if</code> statement inside another <code class="w3-codespan">if</code>. 
This is called a <strong>nested if</strong> statement.</p>
<p>A nested <code class="w3-codespan">if</code> lets you check for a condition only if another condition is already <code class="w3-codespan">true</code>.</p>

<div class="w3-example">
<h3>Syntax</h3>
<pre class="language-c w3-white"><code>if (condition1) {
...
<p>In this example, we first check if <code class="w3-codespan">x</code> is greater than 10.  
If it is, we then check if <code class="w3-codespan">y</code> is greater than 20:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-c w3-white"><code>int x = 15;
int y = 25;
...
<p>
<a target="_blank" class="w3-btn" href="tryc.php?filename=demo_if_nested">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>Nested <code class="w3-codespan">if</code> statements are useful when you need to test multiple conditions that depend on each other.  
For example, checking if a person is old enough to vote, and if they are a citizen:</p>
...
<h2>Notes</h2>
<ul>
  <li>You can nest as many <code class="w3-codespan">if</code> statements as you want, but avoid making the code too deep - it can become hard to read.</li>
  <li>Nested <code class="w3-codespan">if</code> is often used together with <code class="w3-codespan">else</code> and <code class="w3-codespan">else if</code> for more complex decision making.</li>
</ul>
