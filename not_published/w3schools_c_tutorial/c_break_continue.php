...
ny:-->
    ...
    <h1>C <span class="color_h1">Break and Continue</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_challenges_for_loop.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_arrays.php">Next &#10095;</a>
</div>
<hr>

<h2>Break</h2>
<p>You have already seen the <code class="w3-codespan">break</code> statement used in an earlier chapter of this tutorial. It was used to "jump out" of a <a href="c_switch.php"><code class="w3-codespan">switch</code></a> statement.</p>
<p>The <code class="w3-codespan">break</code> statement can also be used to jump out of a 
<strong>loop</strong>.</p>
<p>This example stops the loop when <code class="w3-codespan">i</code> is equal to 4:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-c w3-white" data-line="5"><code>int i;
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_break">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_continue">Try it Yourself &raquo;</a>
</div>

<div class="ws-note ws-panel">
<p><strong>Good to Remember:</strong></p>
<ul>
  <li><code class="w3-codespan">break</code> = stop the loop completely.</li>
  <li><code class="w3-codespan">continue</code> = skip this round, but keep looping.</li>
</ul>
</div>

<hr>

<h2>Combining Break and Continue</h2>

<p>You can also combine <code class="w3-codespan">break</code> and <code class="w3-codespan">continue</code>.</p>
<p>This example skips printing 2 and stops the loop at 4:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-c w3-white" data-line="5,8"><code>int i;
...
<p>
<a target="_blank" class="w3-btn" href="tryc.php?filename=demo_break_continue">Try it Yourself &raquo;</a>
</p>
</div>
...
<div class="w3-example">
<h3>Break Example</h3>
<pre class="language-c w3-white"><code>int i = 0;
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_break_while">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryc.php?filename=demo_continue_while">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-example">
<h3>Example</h3>
<pre class="language-c w3-white"><code>int myNumbers[] = {3, -1, 7, 0, 9};
...
<p>
<a target="_blank" class="w3-btn" href="tryc.php?filename=demo_break_continue_reallife">Try it Yourself &raquo;</a>
</p>
</div>

<div class="ws-note ws-panel">
<p><strong>Note:</strong> Don't worry if you don't fully understand the example above.  
It uses an <a href="c_arrays.php">array</a> (<code class="w3-codespan">int numbers[] = {3, -1, 7, 0, 9};</code>) to store the numbers,  
and you will learn more about <a href="c_arrays.php">arrays</a> in the next chapter.</p>
</div>


<hr>
<div id="exercisecontainer" src="xrcise_break_continue.js" data-extensions="php"></div>
<hr>
