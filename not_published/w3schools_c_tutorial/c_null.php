...
ny:-->
    ...
    <h1>C <span class="color_h1">NULL</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="c_debugging.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="c_error_handling.php">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>C NULL</h2>

<p><code class="w3-codespan">NULL</code> is a special value that represents a "null pointer" 
- a pointer that does not point to anything.</p>

<p>It helps you avoid using pointers that are empty or invalid. You can compare a pointer to <code class="w3-codespan">NULL</code> to check if it is safe to use.</p>

<p>Many C functions return <code class="w3-codespan">NULL</code> 
when something goes wrong. For example, <code class="w3-codespan">fopen()</code> returns <code class="w3-codespan">NULL</code> if 
a file cannot be opened, and <code class="w3-codespan">malloc()</code> returns <code class="w3-codespan">NULL</code> if memory allocation fails. We can check for this using an <code class="w3-codespan">if</code> statement, and print an error message if something goes wrong.</p>

<p>In this example, we try to open a file that does not exist. Since <code class="w3-codespan">fopen()</code> fails, it returns <code class="w3-codespan">NULL</code> 
and we print an error message:</p>
...
<p><a target="_blank" class="w3-btn" href="tryc.php?filename=demo_null">Try it Yourself &raquo;</a></p>
</div>

<p>If you try to allocate too much memory, <code class="w3-codespan">malloc()</code> may fail and return <code class="w3-codespan">NULL</code>:</p>
...
<p><a target="_blank" class="w3-btn" href="tryc.php?filename=demo_null2">Try it Yourself &raquo;</a></p>
</div>
<!--stop-->
...
<ul>
  <li><code class="w3-codespan">NULL</code> represents a null (empty) pointer</li>
  <li>It signals that a pointer is not pointing anywhere</li>
  <li>You can compare a pointer to <code class="w3-codespan">NULL</code> to check if it's safe to use</li>
  <li>Functions like <code class="w3-codespan">malloc()</code> and <code class="w3-codespan">fopen()</code> return <code class="w3-codespan">NULL</code> if they fail</li>
</ul>

<div class="ws-note ws-panel">
  <p><strong>Tip:</strong> Always check if a pointer is <code class="w3-codespan">NULL</code> before using it. This helps avoid crashes caused by accessing invalid memory.</p>
</div>
<!--stop-->
