...
<h1>CSS <span class="color_h1">Center Align</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_challenges_inline-block.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_align_horizontal.asp">Next &#10095;</a>
</div>
<hr>

<h2>CSS Centering Elements</h2>
<p>With CSS, you can center elements (horizontally, vertically, or both) with several methods, depending on the type of element.</p>
<div class="center">
...
<h3>Example</h3>
<p>Center a div element using flexbox:</p>
<div class="w3-code notranslate cssHigh">
.center {<br>&nbsp; display: flex;<br>&nbsp; justify-content: center;<br>&nbsp; 
align-items: center;<br>}</div>
...
<p>There are several ways to horizontally align elements:</p>
<ul>
  <li><strong>margin: auto</strong> - Center block elements</li>
  <li><strong>text-align: center</strong> - Center text inside elements</li>
  <li><strong>float</strong> or <strong>position</strong> - Left/right alignment</li>
</ul>
<hr>

<h2>Vertical Alignment</h2>
<p>Vertical centering can be achieved using modern layout techniques:</p>
<ul>
  <li><strong>Flexbox</strong> - Use <code class="w3-codespan">align-items: center</code></li>
  <li><strong>Grid</strong> - Use <code class="w3-codespan">place-items: center</code></li>
  <li><strong>Position + Transform</strong> - For elements of unknown dimensions</li>
</ul>
<div class="w3-panel ws-note">
  <p><strong>Tip:</strong> Flexbox is the most modern and recommended method for centering content both horizontally and vertically!</p>
</div>
