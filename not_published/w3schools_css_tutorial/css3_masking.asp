...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="css_challenges_objectposition.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="css3_masking_gradients.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>The CSS mask-image Property</h2>
<p>CSS masking allows you to create a mask layer to place over an element to partially or fully hide portions of the element.</p>
<p>The CSS <code class="w3-codespan"><a href="/cssref/css3_pr_mask-image.php">mask-image</a></code> property specifies a mask 
layer image.</p>
<p>The mask layer image can be a PNG image, an SVG image, a <a href="css3_gradients.asp">CSS gradient</a>, or an 
<a href="/graphics/svg_intro.asp">SVG &lt;mask&gt; element</a>. </p>
<!--stop-->
<hr>
<!--start-->
<h2>Use a PNG Image as the Mask Layer</h2>
<p>To use a PNG image as the mask layer, use a url() value to pass in the mask 
layer image.</p>
<p>The mask image needs to have a transparent or semi-transparent area. Black 
indicates fully transparent.</p>
<p>Here is the mask image (&quot;w3logo.png&quot;) we will use:</p>

<img src="w3logo.png" alt="W3Schools.com" style="width:260px;height:241px;">

<p>Here is an image from Cinque Terre, in Italy:</p>
<img src="img_5terre.jpg" alt="Cinque Terre" style="max-width:596px;width:100%;height:auto;">

<p>Now, we apply the mask image as the mask layer for the image from Cinque Terre, Italy:</p>
<img  class="mask1" src="img_5terre.jpg" alt="Cinque Terre" style="max-width:596px;width:100%;height:auto;">

<div class="w3-example">
<h3>Example</h3>
  <p>Here is the source code:</p>
<div class="w3-code notranslate cssHigh">
  .mask1 {<br>&nbsp; -webkit-mask-image: url(w3logo.png);<br>&nbsp; mask-image: 
  url(w3logo.png);<br>&nbsp; mask-repeat: no-repeat; <br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss3_mask-image" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>The <code class="w3-codespan"><a href="/cssref/css3_pr_mask-image.php">mask-image</a></code> property specifies the image 
to be used as a mask layer for an element.</p>
<p>The <code class="w3-codespan"><a href="/cssref/css3_pr_mask-repeat.php">mask-repeat</a></code> property specifies if or how 
...
<hr>
<!--start-->
<h2>Repeat the Mask Layer Image</h2>
<p>If we omit the <code class="w3-codespan"><a href="/cssref/css3_pr_mask-repeat.php">mask-repeat</a></code> property, the mask image will be repeated all over the image from Cinque Terre, Italy:</p>

<img class="mask1-2" src="img_5terre.jpg" alt="Cinque Terre" style="max-width:596px;width:100%;height:auto;">

<div class="w3-example">
<h3>Example</h3>
  <p>Omit the mask-repeat property:</p>
<div class="w3-code notranslate cssHigh">
  .mask1 {<br>&nbsp; -webkit-mask-image: url(w3logo.png);<br>&nbsp; mask-image: 
  url(w3logo.png);<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss3_mask-image1_repeat" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Position the Mask Layer Image</h2>
<p>The <code class="w3-codespan"><a href="/cssref/css3_pr_mask-position.php">
mask-position</a></code> property sets the starting position of a mask image 
(relative to the mask position area). By default, a mask image is placed at the 
top-left corner of an element, and repeated both vertically and horizontally.</p>
<p>Here, we position the mask image in center:</p>

<img class="mask1-3" src="img_5terre.jpg" alt="Cinque Terre" style="max-width:596px;width:100%;height:auto;">

<div class="w3-example">
<h3>Example</h3>
  <p>Position the mask layer image:</p>
<div class="w3-code notranslate cssHigh">
  .mask1 {<br>&nbsp; -webkit-mask-image: url(w3logo.png);<br>&nbsp; mask-image: 
  url(w3logo.png);<br>&nbsp; mask-repeat: no-repeat;<br>&nbsp; mask-position: 
  center; <br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss3_mask-image1_pos" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
