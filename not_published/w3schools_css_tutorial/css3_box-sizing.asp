...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="css_challenges_css3_property.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_challenges_css3_box-sizing.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS Box Sizing</h2>
<p>The CSS <code class="w3-codespan"><a href="/cssref/css3_pr_box-sizing.php">box-sizing</a></code> 
property defines how to calculate the width and height of an element: should the 
calculation include padding and borders, or not.</p>
...
<p>This means: When you set the width/height of an element, the element often appears 
bigger than you have set (because the element's border and padding are added to the element's specified width/height).</p>
<p>The following illustrates two &lt;div&gt; elements with the same 
specified width and height. The two &lt;div&gt; elements end up with different sizes 
(because div2 has a large padding 
specified):</p>
<div id="div1">This div is has width: 300px and height: 100px.</div>
<br>
<div id="div2">This div also has width: 300px and height: 100px.</div>
...
<p>The <code class="w3-codespan"><a href="/cssref/css3_pr_box-sizing.php">box-sizing</a></code> property solves this problem.</p>
...
<hr>
<!--start-->
<h2>The CSS box-sizing Solution</h2>
<p>The <code class="w3-codespan"><a href="/cssref/css3_pr_box-sizing.php">box-sizing</a></code> property allows us to include the padding and border in 
an element's total width and height.</p>
<p>If you set <code class="w3-codespan">box-sizing: border-box;</code> on an element, 
the padding and border are 
included in the calculation of the width and height:</p>
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_css3_box-sizing.js"></div>
<hr>
