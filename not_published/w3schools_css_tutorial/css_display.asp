...
<h1>CSS <span class="color_h1">The display</span> Property</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_challenges_table.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_display_hide.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>The CSS display Property</h2>
<p>The <code class="w3-codespan"><a href="/cssref/pr_class_display.php">display</a></code> property is 
an important CSS property for controlling layout. It specifies whether an HTML 
element is treated as a block or an inline element.</p>
<p>Every HTML element has a default display value, depending on what type of element it is. The default display value for most elements is <code class="w3-codespan">block</code> or 
<code class="w3-codespan">inline</code>.</p>
<p>The <code class="w3-codespan"><a href="/cssref/pr_class_display.php">display</a></code> property is used to change the default display behavior of HTML elements. </p>
<!--stop-->
<hr>
<!--start-->
...
<p>The CSS <code class="w3-codespan"><a href="/cssref/pr_class_display.php">display</a></code> property has many values. 
The following table lists the most commonly used:</p>
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td>contents</td>
    <td>Makes the container disappear, making its child elements children of the 
  ...
  <tr>
    ...
    element, but you can apply height, width, padding, and margin values</td>
    </tr>
  <tr>
    <td>none</td>
    <td>The element is completely hidden from the document flow (does not take 
    up any space). </td>
  </tr>
  </table>
<hr>
...
<p>A common example is to change <code class="w3-codespan">&lt;li&gt;</code> elements 
to inline, to create a horizontal menu:</p>
...
<h2>Example of More Display Values</h2>
<p>The following example demonstrates some more display values:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  p.ex1 {display: none;}<br>p.ex2 {display: inline;}<br>p.ex3 {display: block;}<br>
  p.ex4 {display: inline-block;}<br>p.ex5 {display: flex;}<br>p.ex6 {display: 
  grid;}</div>
<a target="_blank" href="tryit.asp?filename=trycss_display2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_display_visibility.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_challenges_table.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_display_hide.asp">Next &#10095;</a>
