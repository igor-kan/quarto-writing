...
<a class="w3-left w3-btn" href="css_challenges_combinators.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_pseudo_classes_interactive.asp">Next &#10095;</a>
</div>
<hr>

<h2>CSS Pseudo-classes</h2>
<p>A CSS pseudo-class is a keyword that can be added to a selector, to define a style for a special state of an element.</p>
<p>Some common use for pseudo-classes:</p>
<ul>
...
<h3>Syntax</h3>
<p>Pseudo-classes are always denoted by a single colon (:) followed by the pseudo-class name:</p>
<div class="w3-example">
<div class="w3-code notranslate cssHigh">
selector:pseudo-class-name {<br><em>&nbsp;&nbsp;CSS properties</em><br>}</div>
</div>
...
<p>Interactive pseudo-classes apply styles based on <strong>user interaction</strong>:</p>
<ul>
  <li><code class="w3-codespan">:hover</code> - When mouse is over an element</li>
  <li><code class="w3-codespan">:focus</code> - When an element has focus</li>
  <li><code class="w3-codespan">:active</code> - When an element is being activated</li>
  <li><code class="w3-codespan">:link</code> - Unvisited links</li>
  <li><code class="w3-codespan">:visited</code> - Visited links</li>
</ul>
<hr>

<h2>Structural Pseudo-classes</h2>
<p>Structural pseudo-classes select elements based on <strong>their position in the document tree</strong>:</p>
<ul>
  <li><code class="w3-codespan">:first-child</code> - First child of a parent</li>
  <li><code class="w3-codespan">:last-child</code> - Last child of a parent</li>
  <li><code class="w3-codespan">:nth-child(n)</code> - The nth child of a parent</li>
  <li><code class="w3-codespan">:lang()</code> - Elements with a specific language</li>
</ul>
<hr>
