...
<h1>CSS <span class="color_h1">Comments</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="css_challenges_howto.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="css_errors.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS Comments</h2>
<p>Comments are used to explain the CSS code, and may help when you edit the 
source code at a later date.</p>
<p>Comments are also used to temporarily disable sections of CSS code within a 
stylesheet.</p>

<p>Comments are ignored by browsers!</p>
<p>A CSS comment is placed inside the HTML <code class="w3-codespan">&lt;style&gt;</code> element, and starts with <code class="w3-codespan">/*</code> and ends with <code class="w3-codespan">*/</code>:</p>
...
<a target="_blank" href="tryit.asp?filename=trycss_comments" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" href="tryit.asp?filename=trycss_comments2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p>Even in the middle of a code line:</p>
...
<a target="_blank" href="tryit.asp?filename=trycss_comments2_2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p>Comments can also span 
multiple lines:&nbsp;</p>
...
<a target="_blank" href="tryit.asp?filename=trycss_comments3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<p>From the HTML tutorial, you learned that you can add comments to your HTML source by using the 
<code class="w3-codespan">&lt;!--...--&gt;</code> syntax.</p>
<p>In the following example, we use a combination of HTML and CSS comments:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  ...
  World!&lt;/p&gt;<br>&lt;p&gt;This paragraph is styled with CSS.&lt;/p&gt;<br>&lt;p&gt;HTML 
  and CSS comments are 
  not shown in the output.&lt;/p&gt;<br><br>&lt;/body&gt;<br>&lt;/html&gt;<br>
</div>
<a target="_blank" href="tryit.asp?filename=trycss_comments4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: CSS Comments</h2>
  <a href="https://youtu.be/uVtEJD3vBEs&list=PLP9IO4UYNF0UCaUSF3XNZ1U9f01E5h5PM" class="ga-featured ga-youtube" target="blank_" >
    <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
      ...
      <picture id="yt_div">
        <source srcset="images/css_comments.webp" type="image/webp" />
        <img src="images/css_comments.png" style="max-width:100%;height:auto;border-radius:6px" alt="Tutorial on YouTube" loading="lazy">
      </picture>
    </div>
  </a>
</div>
