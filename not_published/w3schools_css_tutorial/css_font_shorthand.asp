...
<h1>CSS <span class="color_h1">Font Property</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="css_font_pairings.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_challenges_font.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>The CSS Font Shorthand Property</h2>
<p>To shorten the code, it is possible to specify all the individual font properties in one 
declaration.</p>

<p>The CSS <code class="w3-codespan"><a href="/cssref/pr_font_font.php">font</a></code> property is a shorthand property for:</p>
<ul>
<li><code class="w3-codespan"><a href="/cssref/pr_font_font-style.php">font-style</a></code></li>
<li><code class="w3-codespan"><a href="/cssref/pr_font_font-variant.php">font-variant</a></code></li>
<li><code class="w3-codespan"><a href="/cssref/pr_font_weight.php">font-weight</a></code></li>
<li><code class="w3-codespan"><a href="/cssref/css3_pr_font-stretch.php">font-stretch</a></code></li>
<li><code class="w3-codespan"><a href="/cssref/pr_font_font-size.php">font-size</a></code></li>
<li><code class="w3-codespan"><a href="/cssref/pr_dim_line-height.php">line-height</a></code></li>
<li><code class="w3-codespan"><a href="/cssref/pr_font_font-family.php">font-family</a></code></li>
</ul>

<h3>Rules for the CSS Font Shorthand Property</h3>
<ol>
  <li>The <code class="w3-codespan"><a href="/cssref/pr_font_font-size.php">font-size</a></code> and 
  <code class="w3-codespan"><a href="/cssref/pr_font_font-family.php">font-family</a></code>
values are required. If one of the other values is missing, their default value are used.</li>
  <li>If defined, <code class="w3-codespan">
  <a href="/cssref/pr_font_font-style.php">font-style</a></code>,
  <code class="w3-codespan"><a href="/cssref/pr_font_font-variant.php">font-variant</a></code> 
  and <code class="w3-codespan"><a href="/cssref/pr_font_weight.php">font-weight</a></code> 
  must precede <code class="w3-codespan">
  <a href="/cssref/pr_font_font-size.php">font-size</a></code>.</li>
  <li>If defined, <code class="w3-codespan">
  <a href="/cssref/pr_dim_line-height.php">line-height</a></code> must 
  immediately follow <code class="w3-codespan">
  <a href="/cssref/pr_font_font-size.php">font-size</a></code>, preceded by &quot;/&quot;, 
  like this: 15px/30px.</li>
  <li><code class="w3-codespan"><a href="/cssref/pr_font_font-family.php">font-family</a></code> 
  must be the last value specified.</li>
</ol>

<div class="w3-example">
<h3>Example</h3>
<p>Use the font shorthand property to set multiple font properties in 
one declaration:</p>
<div class="w3-code notranslate cssHigh">
    p.a {<br>&nbsp; font: 20px Arial, sans-serif;<br>}<br><br>p.b {<br>&nbsp; font: 
    italic bold 16px Arial, sans-serif;<br>}<br><br>p.c {<br>&nbsp; font: italic 
    small-caps bold 15px/30px Georgia, serif;<br>} </div>
<a target="_blank" href="tryit.asp?filename=trycss_font" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_font_shorthand.js"></div>
<hr>
