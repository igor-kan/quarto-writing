...
<a class="w3-left w3-btn" href="css_challenges_css3_3dtransforms.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css3_transitions_timing.asp">Next &#10095;</a>
</div>
<hr>
...
<h2>The CSS transition Property</h2>
<p>To create a transition effect, you must specify the CSS property you want to add a 
transition to, and the duration of the transition.</p>
<p>The CSS <code class="w3-codespan"><a href="/cssref/css3_pr_transition.php">transition</a></code> 
property is a shorthand property for:</p>
<ul>
<li><code class="w3-codespan"><a href="/cssref/css3_pr_transition-property.php">transition-property</a></code></li>
<li><code class="w3-codespan"><a href="/cssref/css3_pr_transition-duration.php">transition-duration</a></code></li>
<li><code class="w3-codespan"><a href="/cssref/css3_pr_transition-timing-function.php">transition-timing-function</a></code></li>
<li><code class="w3-codespan"><a href="/cssref/css3_pr_transition-delay.php">transition-delay</a></code></li>
</ul>
<h3>CSS Transition Example</h3>
<p>The following example shows a 100px * 100px &lt;div&gt; element. The &lt;div&gt; 
element has specified a transition effect for the width property, with a duration of 2 seconds:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
div
{<br>&nbsp; width: 100px;<br>&nbsp;&nbsp;height: 100px;<br>&nbsp; 
background-color: red;<br>&nbsp;&nbsp;transition: width 2s;<br>
}
</div>
<br>
</div>
<h3>How to Trigger the Transition</h3>
<p>The transition is triggered when there is a change in the element's properties. 
This often happens within pseudo-classes (:hover, :active, :focus, or 
:checked).</p>
<p>So, from the code above, the transition effect will start when the width property changes value.</p>
<p>Now, we add a div:hover class that specifies a new value for the width property when a user 
mouses over the &lt;div&gt; element:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
div:hover
...
<h2>Change Multiple Property Values</h2>
<p>You can change multiple properties by separating them by commas.</p>
<p>The following example adds a transition effect for the width, height, and 
background-color properties, with a duration 
of 2 seconds for the width, 4 seconds for the height, and 3 seconds for the 
background-color:</p>
<div class="w3-example">
<h3>Example</h3>
  <p>Add a transition effect for the width, height, and background-color 
  properties:</p>
<div class="w3-code notranslate cssHigh">
div
{<br>
&nbsp;&nbsp;transition: width 2s, height 4s, background-color 3s;<br>
}
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_transition2">Try it Yourself &raquo;</a>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_css3_transitions.js"></div>
<hr>
