...
<a class="w3-left w3-btn" href="css_challenges_colors.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_background_image.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
...
<div style="color:#000;width:100%;border:1px solid gray;padding:16px;background:#e1efbb url('mountain.jpg')">
...
<p>The <code class="w3-codespan"><a href="/cssref/pr_background-color.php">background-color</a></code> property specifies the background color of an element.</p>
...
<div class="w3-example">
<h3>Example</h3>
<p>Here, the &lt;h1&gt;, &lt;p&gt;, and &lt;div&gt; elements will have different background colors:&nbsp;</p>
<div class="w3-code notranslate cssHigh">
...
<p>The <code class="w3-codespan"><a href="/cssref/css3_pr_opacity.php">opacity</a></code> property specifies the opacity/transparency of an element. It can take a value from 0.0 - 1.0. The lower value, the more transparent:</p>
...
<a target="_blank" href="tryit.asp?filename=trycss_background_opacity" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
<p><strong>Note:</strong> When using the <code class="w3-codespan">
<a href="/cssref/css3_pr_opacity.php">opacity</a></code> property to add transparency to the background of an element, all of its child elements 
...
you can use an RGB color value with an <strong>alpha</strong> channel (RGB<strong>A</strong>) - which specifies the opacity for a color.</p>
...
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
div {<br>&nbsp; background: rgba(0, 128, 0, 0.3) /* Green background with 30% opacity */<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_background_opacity2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: CSS Background Color</h2>
  <a href="https://youtu.be/-itttmX6HX0&list=PLP9IO4UYNF0UCaUSF3XNZ1U9f01E5h5PM" class="ga-featured ga-youtube" target="blank_" >
    <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
      ...
      <picture id="yt_div">
        <source srcset="images/css_background_colors.webp" type="image/webp" />
        <img src="images/css_background_colors.png" style="max-width:100%;height:auto;border-radius:6px" alt="Tutorial on YouTube" loading="lazy">
      </picture>
    </div>
  </a>
</div>
