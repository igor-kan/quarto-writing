...
<a class="w3-left w3-btn" href="css_challenges_align.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_challenges_combinators.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
...
<p>The <a href="/cssref/sel_element_gt.php">child combinator</a> selects all elements that are 
direct children of a 
specified element.</p>
<p>The following example selects all &lt;p&gt; elements that are  
direct children of &lt;div&gt;:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
div &gt; p {<br>&nbsp;&nbsp;background-color: yellow;<br>}</div>
...
<p>The <a href="/cssref/sel_element_pluss.php">next sibling combinator</a> is used to select an element that is directly 
after a specific element.</p>
<p>Sibling elements must have the same parent element.</p>
<p>The following example selects the first &lt;p&gt; element that immediately 
follows a &lt;div&gt;, and share the same parent:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
div + p {<br>&nbsp; background-color: yellow;<br>}</div>
...
<p>The <a href="/cssref/sel_gen_sibling.php">subsequent-sibling combinator</a> selects 
all elements that are next siblings of a specified element.</p>
<p>The following example selects all &lt;p&gt; elements that are next siblings of &lt;div&gt;, 
and share the same parent:&nbsp;</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
div ~ p {<br>&nbsp; background-color: yellow;<br>}</div>
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_combinators.js"></div>
<hr>
