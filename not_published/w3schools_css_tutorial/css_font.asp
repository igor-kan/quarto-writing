...
<a class="w3-left w3-btn" href="css_challenges_text.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="css_font_websafe.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
...
<p>Choosing a font that is easy to read is important. It is also important to choose 
...
<p>The CSS <code class="w3-codespan"><a href="/cssref/pr_font_font-family.php">font-family</a></code> property 
specifies the font for an element.</p>

<p><strong>Tip:</strong> The <code class="w3-codespan"><a href="/cssref/pr_font_font-family.php">font-family</a></code> property should 
hold several font names as a &quot;fallback&quot; system. If the browser does not support the first font, it tries the next font. The font names should be separated with a comma.</p>
<p>Always start with the font you want, and always end with a generic family, to let the browser pick a similar font in the generic family, if no other fonts are 
available.</p>
...
<p><b>Note</b>: If the font name is more than one word, it must be in quotation marks, like: &quot;Times New Roman&quot;.</p>
  <p><strong>Tip:</strong> Read more about fallback fonts in 
  <a href="css_font_websafe.asp">CSS Web Safe Fonts</a>.</p>
</div>
...
<ol>
  <li><strong>Serif fonts</strong> - have a small stroke at the edges of each letter. They create a sense of formality and elegance.</li>
  <li><strong>Sans-serif fonts</strong> - have clean lines (no small strokes attached). They create a modern and minimalistic look.</li>
  <li><strong>Monospace fonts</strong> - here all the letters have the same fixed width. They create a mechanical look.</li>
  <li><strong>Cursive fonts</strong> - imitate human handwriting.</li>
  <li><strong>Fantasy fonts</strong> - are decorative/playful fonts.</li>
</ol>
...
<div class="w3-panel ws-note">
 <p><strong>Note:</strong> On computer screens, <strong>sans-serif fonts</strong> are considered easier to read than serif fonts.</p>
</div>
<!--stop-->
<hr>
<!--start-->
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_font.js"></div>
<hr>
