...
<a class="w3-left w3-btn" href="css_challenges_form_styling.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="css_counters_nested.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS Counters</h2>
<p>With CSS counters, you can create dynamic numbering of elements (like 
headings, sections, or list items) without using JavaScript.</p>
<p>CSS counters are "variables" maintained by CSS, and their values can 
be incremented (or decremented) by CSS rules.</p>
...
<!--stop-->
<hr>
<h2>CSS Automatic Numbering With Counters</h2>
<p>CSS counters are like "variables". The variable values can be incremented 
(or decremented) by CSS rules.</p>
<p>To work with CSS counters we will use the following properties:</p>
<ul>
<li><code class="w3-codespan"><a href="/cssref/pr_gen_counter-reset.php">counter-reset</a></code> - Creates or resets a counter</li>
<li><code class="w3-codespan"><a href="/cssref/pr_gen_counter-increment.php">counter-increment</a></code> - Increments or decrements a counter</li>
<li><code class="w3-codespan"><a href="/cssref/pr_gen_content.php">content</a></code> - Inserts generated content</li>
<li><code class="w3-codespan"><a href="/cssref/func_counter.php">counter()</a></code> - Adds the value of a counter to an element</li>
</ul>
<p>To use a CSS counter, it must first be created with the <code class="w3-codespan">
<a href="/cssref/pr_gen_counter-reset.php">counter-reset</a></code> property.</p>
<!--stop-->
<hr>
<!--start-->
<h2>CSS Increase and Decrease Counter</h2>
<p>The following example creates a counter for the page (in the body selector), 
then it increments the counter value by 1 for each &lt;h2&gt; element:</p>
...
<hr>
<!--start-->
<h2>Decrementing a Counter</h2>
<p>The <code class="w3-codespan"><a href="/cssref/pr_gen_counter-increment.php">counter-increment</a></code> 
property has a second parameter. The default value is 1. To decrease the counter value, you can set it to 
-1.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
body {<br>&nbsp;&nbsp;counter-reset: section;<br>}<br><br>h2::before {<br>&nbsp; counter-increment: section 
  -1;<br>&nbsp;&nbsp;content: &quot;Section &quot; counter(section) &quot;: &quot;;<br>}
</div>
<a target="_blank" href="tryit.asp?filename=trycss_counters1_1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<hr>
<!--start-->
<h2>Incrementing by Custom Values</h2>
<p>You can increment the counter by any value. Here we increment by 2:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
body {<br>&nbsp;&nbsp;counter-reset: section;<br>}<br><br>h2::before {<br>&nbsp; counter-increment: section 
  2;<br>&nbsp;&nbsp;content: &quot;Section &quot; counter(section) &quot;: &quot;;<br>}
</div>
<a target="_blank" href="tryit.asp?filename=trycss_counters1_2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_counters.js"></div>
<hr>
