...
<html lang="en-US">
<head>
<title>CSS overflow-x and overflow-y</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">overflow-x and overflow-y</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="css_overflow.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_challenges_overflow.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>Overflow in Specific Directions</h2>
<p>The <code class="w3-codespan">overflow-x</code> and <code class="w3-codespan">overflow-y</code> properties allow you to control overflow behavior independently for horizontal and vertical directions.</p>
<hr>

<h2>CSS overflow-x and overflow-y</h2>
<p>The <code class="w3-codespan"><a href="/cssref/css3_pr_overflow-x.php">overflow-x</a></code> and <code class="w3-codespan">
<a href="/cssref/css3_pr_overflow-y.php">overflow-y</a></code> properties specifies 
whether to change the overflow of content just horizontally or vertically (or 
both):</p>
<ul>
  <li><code class="w3-codespan"><a href="/cssref/css3_pr_overflow-x.php">overflow-x</a></code> specifies what to do with the left/right edges of the 
content.</li>
  <li><code class="w3-codespan"><a href="/cssref/css3_pr_overflow-y.php">overflow-y</a></code> specifies what to do with the top/bottom edges of the 
content.</li>
</ul>
...
<h3>Example</h3>
<p>Hide horizontal scrollbar and add vertical scrollbar:</p>
<div class="w3-code notranslate cssHigh">
div {<br>&nbsp; overflow-x: hidden; /* Hide horizontal scrollbar 
*/<br>&nbsp;&nbsp;overflow-y: scroll; /* Add vertical scrollbar */<br>}</div>
...
<p>These properties are useful when you need different scroll behavior for horizontal and vertical content:</p>
<ul>
  <li><strong>Horizontal scrolling table</strong> - Use <code class="w3-codespan">overflow-x: auto</code> for wide tables</li>
  <li><strong>Chat windows</strong> - Use <code class="w3-codespan">overflow-y: scroll</code> for vertical message scrolling</li>
  <li><strong>Code blocks</strong> - Use <code class="w3-codespan">overflow-x: auto</code> to handle long lines</li>
</ul>

<div class="w3-example">
<h3>Example</h3>
<p>Add horizontal scrollbar only:</p>
<div class="w3-code notranslate cssHigh">
div {<br>&nbsp; overflow-x: scroll;<br>&nbsp; overflow-y: hidden;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_overflow_x" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_overflow_xy.js"></div>
<hr>
