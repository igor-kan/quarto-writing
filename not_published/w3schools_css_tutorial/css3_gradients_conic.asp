...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="css3_gradients_radial.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_challenges_css3_gradients.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS conic-gradient() Function</h2>
<p>The CSS <code class="w3-codespan"><a href="/cssref/func_conic-gradient.php">
conic-gradient()</a></code> function creates a conic gradient.</p>
...
<p>By default, <code class="w3-codespan">angle</code> is 0deg and <code class="w3-codespan">
position</code> is center.</p>
<p>If no <code class="w3-codespan">degree</code> is specified, the colors will be spread equally around 
the center point.</p>
<!--stop-->
<hr>
<!--start-->
...
<div class="w3-code notranslate cssHigh">
    #grad {<br>&nbsp; background-image: conic-gradient(red, yellow, green);<br>} </div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_gradient-conic" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<div class="w3-code notranslate cssHigh">
    #grad {<br>&nbsp; background-image: conic-gradient(red, yellow, green, blue, black);<br>} </div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_gradient-conic2" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<div class="w3-code notranslate cssHigh">
    #grad {<br>&nbsp; background-image: conic-gradient(red 45deg, yellow 
    90deg, green 210deg);<br>} </div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_gradient-conic3" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<p>Just add <code class="w3-codespan">
<a href="/cssref/css3_pr_border-radius.php">border-radius: 50%</a></code> to make the conic gradient look like a pie:</p>
<div id="grad13"></div>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
    #grad {<br>&nbsp; background-image: conic-gradient(red, yellow, green, blue, 
    black);<br>&nbsp; 
    border-radius: 50%;<br>
} </div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_gradient-conic4" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
    #grad {<br>&nbsp; background-image: conic-gradient(red 0deg, red 90deg, yellow 90deg, yellow 
    180deg, green 180deg, green 270deg, blue 270deg);<br>&nbsp; 
    border-radius: 50%;<br>
} </div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_gradient-conic41" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<div class="w3-code notranslate cssHigh">
    #grad {<br>&nbsp; background-image: conic-gradient(from 90deg, red, yellow, 
    green);<br>} </div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_gradient-conic6" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<div class="w3-code notranslate cssHigh">
    #grad {<br>&nbsp; background-image: conic-gradient(at 60% 45%, red, yellow, 
    green);<br>} </div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_gradient-conic7" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>CSS repeating-conic-gradient() Function</h2>
<p>The CSS <code class="w3-codespan">
<a href="/cssref/func_repeating-conic-gradient.php">repeating-conic-gradient()</a></code> function is used to repeat conic gradients:</p>
<div id="grad14"></div>
<div class="w3-example">
<h3>Example</h3>
...
repeating-conic-gradient(red 10%, yellow 20%);<br>&nbsp; 
    border-radius: 50%;<br>} </div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_gradient-conic5" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate cssHigh">
    #grad {<br>&nbsp; background-image: 
repeating-conic-gradient(red 0deg 10deg, yellow 10deg 20deg, blue 20deg 30deg);<br>&nbsp; 
    border-radius: 50%;<br>} </div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_gradient-conic8" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_css3_gradients_conic.js"></div>
<hr>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><a href="/cssref/func_conic-gradient.php">conic-gradient()</a></td>
    <td>Creates a conic gradient. Define at least two 
    colors (around a center point)</td>
  </tr>
  <tr>
    <td><a href="/cssref/func_linear-gradient.php">linear-gradient()</a></td>
    <td>Creates a linear gradient. Define at least two 
    colors (top to bottom)</td>
  </tr>
  <tr>
    <td><a href="/cssref/func_radial-gradient.php">radial-gradient()</a></td>
    <td>Creates a radial gradient. Define at least two 
    colors (center to edges)</td>
  </tr>
  <tr>
    <td><a href="/cssref/func_repeating-conic-gradient.php">repeating-conic-gradient()</a></td>
    <td>Repeats a conic gradient</td>
  </tr>
  <tr>
    <td><a href="/cssref/func_repeating-linear-gradient.php">repeating-linear-gradient()</a></td>
    <td>Repeats a linear gradient</td>
  </tr>
  <tr>
    <td><a href="/cssref/func_repeating-radial-gradient.php">repeating-radial-gradient()</a></td>
