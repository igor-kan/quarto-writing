...
<html lang="en-US">
<head>
<title>CSS Text Alignment and Text Direction</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">Text Alignment</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_text.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_text_decoration.asp">Next &#10095;</a>
</div>
<hr>

<h2>CSS Text Alignment and Text Direction</h2>
<p>In this chapter you will learn about the following properties:</p>
<ul>
<li><code class="w3-codespan"><a href="/cssref/pr_text_text-align.php">text-align</a></code></li>
<li><code class="w3-codespan"><a href="/cssref/css3_pr_text-align-last.php">text-align-last</a></code></li>
<li><code class="w3-codespan"><a href="/cssref/pr_pos_vertical-align.php">vertical-align</a></code></li>
<li><code class="w3-codespan"><a href="/cssref/pr_text_direction.php">direction</a></code></li>
<li><code class="w3-codespan"><a href="/cssref/pr_text_unicode-bidi.php">unicode-bidi</a></code></li>
</ul>
<hr>
<!--start-->
<h2>Text Alignment</h2>
<p>The <code class="w3-codespan"><a href="/cssref/pr_text_text-align.php">text-align</a></code> property is used to set the horizontal alignment of a text.</p>
<p>This property can have one of the following values:</p>
<ul>
  <li><code class="w3-codespan">left</code> - Aligns the text to the left</li>
  <li><code class="w3-codespan">right</code> - Aligns the text to the right</li>
  <li><code class="w3-codespan">center</code> - Centers the text</li>
  <li><code class="w3-codespan">justify</code> - Stretches the lines so that 
  each line has equal width</li>
</ul>
<p>The following example shows left, right and center aligned text 
(left is default if text direction is left-to-right, and right 
is default if text direction is right-to-left):</p>
...
<p>When the <code class="w3-codespan"><a href="/cssref/pr_text_text-align.php">text-align</a></code> property is set to &quot;justify&quot;, each line is 
...
<p>The <code class="w3-codespan"><a href="/cssref/css3_pr_text-align-last.php">text-align-last</a></code> property specifies how to align the last line of a text.</p>
<p>This property can have one of the following values:</p>
<ul>
  <li><code class="w3-codespan">auto</code> - Default value. The last line is 
  justified and aligned left</li>
  <li><code class="w3-codespan">left</code> - The last line is aligned to the 
  left</li>
  <li><code class="w3-codespan">right</code> - The last line is aligned to the 
  right</li>
  <li><code class="w3-codespan">center</code> - The last line is center-aligned</li>
  <li><code class="w3-codespan">justify</code> - The last line is justified as 
  the rest of the lines</li>
  <li><code class="w3-codespan">start</code> - The last line is aligned at the 
  start of the line</li>
  <li><code class="w3-codespan">end</code> - The last line is aligned at the end 
  of the line</li>
</ul>
<div class="w3-example">
  <h3>Example</h3>
  <p>Different alignment of the last line in three &lt;p&gt; elements:</p>
<div class="w3-code notranslate cssHigh">
  p.a
{<br>
  &nbsp;
...
<a target="_blank" href="tryit.asp?filename=trycss_text-align-last" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<p>The <code class="w3-codespan"><a href="/cssref/pr_pos_vertical-align.php">vertical-align</a></code> property sets the vertical alignment of an element.</p>
<p>This property can have one of the following values:</p>
<ul>
  <li><code class="w3-codespan">baseline</code> - Default value. The element is 
  aligned with the baseline of the parent</li>
  <li><code class="w3-codespan">length/%</code> - Raises or lower an element by 
  the specified length or percent</li>
  <li><code class="w3-codespan">sub</code> - The element is aligned with the 
  subscript baseline of the parent</li>
  <li><code class="w3-codespan">super</code> - The element is aligned with the 
  superscript baseline of the parent</li>
  <li><code class="w3-codespan">top</code> - The element is aligned with the top 
  of the tallest element on the line</li>
  <li><code class="w3-codespan">text-top</code> - The element is aligned with 
  the top of the parent element's font</li>
  <li><code class="w3-codespan">middle</code> - The element is placed in the 
  middle of the parent element</li>
  <li><code class="w3-codespan">bottom</code> - The element is aligned with the 
  lowest element on the line</li>
  <li><code class="w3-codespan">text-bottom</code> - The element is aligned with 
  the bottom of the parent element's font</li>
</ul>
<div class="w3-example">
<h3>Example</h3>
<p>Set the vertical alignment of an image in a text:&nbsp;</p>
<div class="w3-code notranslate cssHigh">
  img.a {<br>&nbsp; vertical-align: baseline;<br>}<br><br>img.b {<br>&nbsp; 
  vertical-align: text-top;<br>}<br><br>img.c {<br>&nbsp; vertical-align: 
  text-bottom;<br>}<br><br>img.d {<br>&nbsp; vertical-align: sub;<br>}<br><br>
  img.e {<br>&nbsp; vertical-align: super;<br>}</div>
...
<p>The <code class="w3-codespan"><a href="/cssref/pr_text_direction.php">direction</a></code> 
property specifies the text direction/writing direction within a block-level element.</p>
<p>Tip: Use this property together with the <code class="w3-codespan">
<a href="/cssref/pr_text_unicode-bidi.php">unicode-bidi</a></code> property to 
set or return whether the text should be overridden to support multiple 
languages in the same document.</p>
<div class="w3-example">
  <h3>Example</h3>
<div class="w3-code notranslate cssHigh">
...
<hr>
<div id="exercisecontainer" src="xrcise_text_align.js"></div>
<hr>

<h2>The CSS Text Alignment/Direction Properties</h2>
<table class="ws-table-all notranslate">
  ...
  <tr>
    ...
    <td>Used together with the <a href="/cssref/pr_text_direction.php">direction</a> property to set or return whether the text should be overridden to support multiple languages in the same document</td>
  </tr>
  <tr>
