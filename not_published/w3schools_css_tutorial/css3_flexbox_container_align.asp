...
<html lang="en-US">
<head>
<title>CSS Flexbox align-items and align-content</title>
<meta charset="utf-8">
...
<h1>CSS Flexbox <span class="color_h1">Align</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css3_flexbox_container_justify.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_challenges_flexbox_container.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS align-items Property</h2>
<p>The <code class="w3-codespan"><a href="/cssref/css3_pr_align-items.php">align-items</a></code> property 
aligns the flex items vertically (on the cross-axis).</p>
<p>This property can have one of the following values:</p>
<ul>
  <li><code class="w3-codespan">normal</code> (default)</li>
  <li><code class="w3-codespan">stretch</code></li>
  <li><code class="w3-codespan">center</code></li>
  <li><code class="w3-codespan">flex-start</code></li>
  <li><code class="w3-codespan">flex-end</code></li>
  <li><code class="w3-codespan">baseline</code></li>
</ul>

<div class="w3-example">
<h3>Example</h3>
<p>The <code class="w3-codespan">center</code> value aligns the flex items in the middle of the container:</p>
...
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss3_flexbox_align-items_center">Try it Yourself &raquo;</a></p>
</div>
...
<p>Result:</p>
<div class="w3-white notranslate w3-padding">
  <div class="flex-container2" style="align-items:flex-start;height:200px;">
    <div class="item2">1</div>
    <div class="item2">2</div>
    <div class="item2">3</div>  
  </div>
</div>
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss3_flexbox_align-items_flex-start">Try it Yourself &raquo;</a></p>
</div>
...
<p>Result:</p>
<div class="w3-white notranslate w3-padding">
  <div class="flex-container2" style="align-items:flex-end;height:200px;">
    <div class="item2">1</div>
    <div class="item2">2</div>
    <div class="item2">3</div>  
  </div>
</div>
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss3_flexbox_align-items_flex-end">Try it Yourself &raquo;</a></p>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>The <code class="w3-codespan">stretch</code> value stretches the flex items to fill the container 
(this is equal to &quot;normal&quot; which is default):</p>
<div class="w3-code notranslate cssHigh">
  .flex-container {<br>&nbsp; 
  display: flex;<br>&nbsp; height: 200px;<br>&nbsp; 
...
<p>Result:</p>
<div class="w3-white notranslate w3-padding">
  <div class="flex-container2" style="align-items:stretch;height:200px;">
    <div class="item2">1</div>
    <div class="item2">2</div>
    <div class="item2">3</div>  
  </div>
</div>
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss3_flexbox_align-items_stretch">Try it Yourself &raquo;</a></p>
</div>
<!--stop-->
<hr>
...
<p>The <code class="w3-codespan"><a href="/cssref/css3_pr_align-content.php">align-content</a></code> property aligns 
the flex lines. It only has effect when flex items wrap onto multiple lines.</p>
<p>This property can have one of the following values:</p>
<ul>
  <li><code class="w3-codespan">stretch</code> (default)</li>
  <li><code class="w3-codespan">center</code></li>
  <li><code class="w3-codespan">flex-start</code></li>
  <li><code class="w3-codespan">flex-end</code></li>
...
<div class="w3-example">
<h3>Example</h3>
<p>With <code class="w3-codespan">center</code>, the flex lines are packed toward the center of the container:</p>
<div class="w3-code notranslate cssHigh">
  .flex-container {<br>&nbsp; 
  display: flex;<br>&nbsp; height: 400px;<br>&nbsp; 
  flex-wrap: wrap;<br>&nbsp; 
...
<p>Result:</p>
<div class="w3-white notranslate w3-padding">
  <div class="flex-container2" style="flex-wrap:wrap;align-content:center;height:400px;overflow:scroll;">
    <div class="item2">1</div>
    <div class="item2">2</div>
    <div class="item2">3</div>  
...
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss3_flexbox_align-content_center">Try it Yourself &raquo;</a></p>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>With <code class="w3-codespan">space-between</code>, the space between the flex lines are 
equal:</p>
<div class="w3-code notranslate cssHigh">
  .flex-container {<br>&nbsp; 
  display: flex;<br>&nbsp; height: 400px;<br>&nbsp; 
...
<p>Result:</p>
<div class="w3-white notranslate w3-padding">
  <div class="flex-container2" style="flex-wrap:wrap;align-content:space-between;height:400px;overflow:scroll;">
    <div class="item2">1</div>
    <div class="item2">2</div>
    <div class="item2">3</div>  
    <div class="item2">4</div>
...
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss3_flexbox_align-content_space-between">Try it Yourself &raquo;</a></p>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>True Centering With Flexbox</h2>
<p>The following example shows how to solve a common style problem: true centering.</p>
<p>To achieve true centering, set both the <code class="w3-codespan">justify-content</code> and the <code class="w3-codespan">align-items</code> properties to
<code class="w3-codespan">center</code> for the flex container, and the flex item will be perfectly centered 
both horizontally and vertically:</p>

<div class="flex-container2" style="justify-content:center;align-items:center;height:300px;">
  <div class="item2" style="height:120px;width:180px;">True Centering</div>
</div>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  .flex-container {<br>&nbsp; display: flex;<br>&nbsp; height: 400px;<br><strong>&nbsp; justify-content: 
...
<hr>
<div id="exercisecontainer" src="xrcise_css3_flexbox_container_align.js"></div>
<hr>
