...
<a class="w3-left w3-btn" href="css_challenges_list.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_table_size.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<p class="intro">&nbsp;HTML tables can be greatly improved with CSS:</p>
...
<a target="_blank" href="tryit.asp?filename=trycss_table_fancy" class="ws-btn">Try it Yourself &raquo;</a>
<hr>

<h2>CSS Table Borders</h2>
<p>The CSS <code class="w3-codespan">
<a href="/cssref/pr_border.php">border</a></code> property is used to specify 
the width, style, and color of table borders.</p>
<p>The <code class="w3-codespan">
<a href="/cssref/pr_border.php">border</a></code> property is a shorthand property for:</p>
<ul>
  <li> <code class="w3-codespan"><a href="/cssref/pr_border-width.php">border-width</a></code> - sets the width of the border</li>
  <li> <code class="w3-codespan"><a href="/cssref/pr_border-style.php">border-style</a></code> - sets the style of the border (required)</li>
  <li> <code class="w3-codespan"><a href="/cssref/pr_border-color.php">border-color</a></code> - sets the color of the border</li>
</ul>
<p>The example below specifies a 1px solid border for &lt;table&gt;, &lt;th&gt;, and &lt;td&gt; elements:</p>
<table class="table1">
  <tr>
  <th>Firstname</th>
  <th>Lastname</th>
...
<h2>CSS Table Border Color</h2>
<p>The example below specifies a 1px solid green border for &lt;table&gt;, &lt;th&gt;, and &lt;td&gt; elements:</p>
<table class="color">
  <tr>
  <th>Firstname</th>
  <th>Lastname</th>
...
<a target="_blank" href="tryit.asp?filename=trycss_table_border_color" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="ws-note w3-panel">
<h3>Why Double Borders?</h3>
<p>Notice that the tables in the examples above have double borders. This is 
because both the &lt;table&gt;, &lt;th&gt;, and &lt;td&gt; elements have separate borders.</p>
...
<hr>
<!--start-->
<h2>CSS Collapse Table Borders</h2>
<p>The CSS <code class="w3-codespan"><a href="/cssref/pr_border-collapse.php">border-collapse</a></code> property 
sets whether table borders should collapse into a single border or be separated 
as in standard HTML.</p>
<p>This property can have one of the following values:</p>
<ul>
  <li><code class="w3-codespan">separate</code> - Default value. Borders are 
  separated; each cell will display its own borders</li>
  <li><code class="w3-codespan">collapse</code> - Borders are collapsed into a 
  single border when possible</li>
</ul>

<p>The following table has collapsed borders:</p>
...
<div class="w3-example">
<h3>Example</h3>
  <p>Using the border-collapse property:</p>
<div class="w3-code notranslate cssHigh">
table
{<br>
...
<code class="w3-codespan"><a href="/cssref/pr_padding.php">padding</a></code> property on 
...
{<br>
  &nbsp;
padding: 10px;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_table_border_padding">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>CSS Border Spacing</h2>
<p>The CSS <code class="w3-codespan"><a href="/cssref/pr_border-spacing.php">
border-spacing</a></code> property 
sets the distance between the borders of adjacent cells.</p>
<p><strong>Note:</strong> This property works only when <code class="w3-codespan"><a href="/cssref/pr_border-collapse.php">border-collapse</a></code> 
is set to "separate".</p>
<p>The following table has a border-spacing of 15px:</p>
...
<div class="w3-example">
<h3>Example</h3>
  <p>Using the border-spacing property:</p>
<div class="w3-code notranslate cssHigh">
table
{<br>
&nbsp; border-collapse: separate;<br>&nbsp; border-spacing: 15px;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_table_border-spacing">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>CSS Outside Table Borders</h2>
<p>If you just want a border around the table (not inside), you specify the <code class="w3-codespan">
<a href="/cssref/pr_border.php">border</a></code> property only for the 
&lt;table&gt; element:</p>
<table class="onlytableborder">
  <tr>
    <th>Firstname</th>
    <th>Lastname</th>
  </tr>
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_table.js"></div>
<hr>
