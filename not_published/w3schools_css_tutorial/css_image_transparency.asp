...
<h1>CSS <span class="color_h1">Opacity</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_challenges_pseudo_elements.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_challenges_image_transparency.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS Image Opacity</h2>
<p>The <code class="w3-codespan"><a href="/cssref/css3_pr_opacity.php">opacity</a></code> property specifies the opacity/transparency of an element.</p>
<p>The <code class="w3-codespan">opacity</code> property can take a value from 0.0 - 1.0:</p>
<ul>
  <li>0.0 - The element will be completely transparent</li>
  <li>0.5 - The element will be 50% transparent</li>
  <li>1.0 - Default. The element will be fully opaque</li>
</ul>
...
<p>The <code class="w3-codespan"><a href="/cssref/css3_pr_opacity.php">opacity</a></code> property is often used with 
<code class="w3-codespan">
<a href="/cssref/sel_hover.php">:hover</a></code> 
to change the opacity on mouse-over:</p>
<div class="w3-row-padding" style="margin:0 -16px">
<div class="w3-third w3-center">
...
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
img {<br>&nbsp; opacity: 0.5;<br>}<br><br>img:hover {<br>&nbsp;&nbsp;opacity: 1.0;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_image_transparency" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<h3>Reversed Hover Effect</h3>

<p>Here is an example of reversed hover effect:</p>
<div class="w3-row-padding" style="margin:0 -16px">
<div class="w3-third w3-center">
...
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
img:hover {<br>&nbsp;&nbsp;opacity: 0.5;<br>}</div>
...
<p>When using the <code class="w3-codespan">
<a href="/cssref/css3_pr_opacity.php">opacity</a></code> property to add transparency to the background of an element, all child elements 
inherit the same transparency. This can make the text inside a transparent element hard to read:</p>
...
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
div {<br>&nbsp;&nbsp;opacity: 0.3;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_opacity_box" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Transparency using background-color</h2>
<p>To NOT apply the transparency to child elements, you can use the <code class="w3-codespan">
<a href="/cssref/pr_background-color.php">background-color</a></code> property 
with an RGBA value.</p>
<p>RGBA color values are an extension of RGB color values with an alpha channel 
- which specifies the opacity for a color.</p>
<p>An RGBA color value is specified with: rgba(red, green, blue, alpha). Where 
...
<p>The following example sets the opacity for the background color and not the text:</p>

<div class="w3-cell-row">
<div class="w3-cell w3-mobile w3-center">
<div style="background:rgb(4, 170, 109);padding:50px;color:black"><p>100% opacity</p></div>
</div>
<div class="w3-cell w3-mobile w3-center">
<div style="background:rgba(4, 170, 109,0.6);padding:50px;color:black"><p>60% opacity</p></div>
</div>
<div class="w3-cell w3-mobile w3-center">
<div style="background:rgba(4, 170, 109,0.3);padding:50px;color:black"><p>30% opacity</p></div>
</div>
<div class="w3-cell w3-mobile w3-center">
<div style="background:rgba(4, 170, 109,0.1);padding:50px;color:black"><p>10% opacity</p></div>
</div>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
div {<br>&nbsp; background: rgba(4, 170, 109, 0.3) /* Green background with 30% 
opacity */<br>}</div>
...
<ul>
  <li>Create a &lt;div&gt; element (class=&quot;background&quot;) with a background image, and a border.</li>
  <li>Create another &lt;div&gt; (class=&quot;transbox&quot;) inside the first &lt;div&gt;.</li>
  <li>The 
&lt;div class=&quot;transbox&quot;&gt; have a 0.6 transparent background color, and a border.
  </li>
  <li>Inside the transparent 
&lt;div&gt;, we add some text inside a &lt;p&gt; element.</li>
</ul>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_image_transparency.js"></div>
<hr>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><a href="/cssref/css3_pr_opacity.php">opacity</a></td>
