...
<h1>CSS <span class="color_h1">Form Elements</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_form_focus.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_challenges_form_styling.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>Style Textarea</h2>
<p>By default, a &lt;textarea&gt; can be resized with a &quot;grabber&quot; in the bottom right 
corner. To remove the grabber, set the <code class="w3-codespan">
<a href="/cssref/css3_pr_resize.php">resize</a></code> property to <code class="w3-codespan">
none</code>:</p>
...
<hr>
<!--start-->
<h2>Style Form Buttons</h2>
<p>Form buttons of type &quot;button&quot;, &quot;submit&quot; and &quot;reset&quot; can also be styled with 
CSS:</p>
...
{<br>&nbsp; background-color: #04AA6D;<br>&nbsp; border: 
...
<!--stop-->
<p><strong>Tip:</strong> For more information about how to style buttons, read our <a href="css3_buttons.asp">CSS Buttons Tutorial</a>.</p>
<hr>

<h2>CSS Responsive Form</h2>
<p>The following example uses <a href="css3_mediaqueries.asp">CSS media queries</a> to create a responsive form. You will learn more about 
media queries in a later chapter.</p>
<p>When the screen is less than 600px wide, we make the labels and input fields stack on top of each other, instead of next to each other.</p>
<p>Resize the screen to see the form layout change!</p>
<a target="_blank" href="tryit.asp?filename=trycss_form_responsive" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a>
<iframe src="trycss_form_responsive_ifr.htm" style="margin-left:-8px;border:none;width:100%;height:535px;"></iframe>
<hr>
<div id="exercisecontainer" src="xrcise_form_elements.js"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_form_focus.asp">&#10094; Previous</a>
