...
<h1>CSS <span class="color_h1">HSL Colors</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_colors_hex.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_challenges_colors.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>HSL Value</h2>
...
<p style="font-size:20px;font-weight:bold;">hsl(<em>hue</em>, <em>saturation</em>, <em>lightness</em>)</p>

<p><strong>Hue</strong> is a degree on the color wheel (from 0 to 360):
  <ul>
...
<p><strong>Saturation</strong> is a percentage value: 0% means a shade of gray, and 100% is the full color.</p>
<p><strong>Lightness</strong> is also a percentage; 0% is black, 50% is neither light or dark, 100% is white.</p>
...
<!--start-->
<h3>Lightness</h3>
<p>The lightness of a color can be described as how much light you want to give the color, where 0% means no light (black), 50% means 50% light (neither dark nor light) 
and 100% means full lightness (white).</p>
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_colors_hsl.js"></div>

<hr>
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: CSS Colors HSL</h2>
  <a href="https://youtu.be/Vilk0BFQZ4Y&list=PLP9IO4UYNF0UCaUSF3XNZ1U9f01E5h5PM" class="ga-featured ga-youtube" target="blank_" >
    <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
      ...
      <picture id="yt_div">
        <source srcset="images/css_colors_hsl.webp" type="image/webp" />
        <img src="images/css_colors_hsl.png" style="max-width:100%;height:auto;border-radius:6px" alt="Tutorial on YouTube" loading="lazy">
      </picture>
    </div>
  </a>
</div>
