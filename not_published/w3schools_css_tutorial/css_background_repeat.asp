...
<h1>CSS <span class="color_h1">Background Image Repeat</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_background_image.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_background_attachment.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS background-repeat</h2>
<p>The <code class="w3-codespan"><a href="/cssref/pr_background-repeat.php">
background-repeat</a></code> property sets if/how a background image will be 
repeated.</p>
...
<h2>CSS background-repeat Horizontally</h2>
<p>If the image above is repeated only horizontally (<code class="w3-codespan"><a href="/cssref/pr_background-repeat.php">background-repeat: repeat-x;</a></code>), the background will look 
better:</p>
...
<div class="w3-panel ws-note">
  <p><b>Tip:</b> To repeat an image only vertically, use <code class="w3-codespan">
  <a href="/cssref/pr_background-repeat.php">background-repeat: repeat-y;</a></code></p>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>CSS background-repeat: no-repeat</h2>
<p>Showing the background image only once is also specified by the <code class="w3-codespan">
<a href="/cssref/pr_background-repeat.php">background-repeat</a></code> property:</p>
<div class="w3-example">
<h3>Example</h3>
  <p>Show the background image only once:</p>
<div class="w3-code notranslate cssHigh">
body
{<br>
...
<p>In the example above, the background image is placed in the same place as the text. We want to change the position of the image, so that it does not 
...
<p>The <code class="w3-codespan"><a href="/cssref/pr_background-position.php">background-position</a></code> property is used to 
set the starting position of the background image.</p>
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_background_repeat.js"></div>
<hr>

<h2>The CSS Background Repeat and Position Properties</h2>
...
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: CSS Background Repeat and Position</h2>
  <a href="https://youtu.be/k9dNFtC2F8A&list=PLP9IO4UYNF0UCaUSF3XNZ1U9f01E5h5PM" class="ga-featured ga-youtube" target="blank_" >
    <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
      ...
      <picture id="yt_div">
        <source srcset="images/css_background_repeat.webp" type="image/webp" />
        <img src="images/css_background_repeat.png" style="max-width:100%;height:auto;border-radius:6px" alt="Tutorial on YouTube" loading="lazy">
      </picture>
    </div>
  </a>
</div>
