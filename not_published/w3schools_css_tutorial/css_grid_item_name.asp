...
<html lang="en-US">
<head>
<title>CSS Naming Grid Items</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">Naming Grid Items</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="css_grid_item.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="css_grid_item_align.asp">Next &#10095;</a>
</div>
<hr>

<!--start-->
<h2>Naming Grid Items with grid-area</h2>
<p>The CSS <code class="w3-codespan">
<a href="/cssref/pr_grid-template-areas.php">grid-template-areas</a></code> is a 
grid container property, and it specifies 
areas within the grid layout.</p>
<p>You can name grid items by using the CSS <code class="w3-codespan"><a href="/cssref/pr_grid-area.php">grid-area</a></code>  
property, and then reference to the name in the <code class="w3-codespan">grid-template-areas</code> 
property.</p>
<p>Each area is defined within apostrophes. The named grid items in each area is defined inside the apostrophes, separated by a space.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Let &quot;Item1&quot; get the name &quot;myHeader&quot;, and let it span five columns in a five columns grid layout:</p>
<div class="w3-code notranslate cssHigh">
  .container {<br>&nbsp; display: grid;<br>&nbsp; grid-template-areas: 'myHeader 
  myHeader myHeader myHeader myHeader';<br>}<br><br>.item1 {<br>&nbsp; grid-area: 
  myHeader;<br>} <br></div>
<p>Result:</p>
<div class="w3-white notranslate w3-padding">
<div class="grid-container2" style="grid-template-areas:'myArea myArea myArea myArea myArea'">
...
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss_grid_grid-area_named">Try it Yourself &raquo;</a></p>
</div>

<p>We can use a period sign (.) to refer to a grid item with no name:</p>

<div class="w3-example">
<h3>Example</h3>
  <p>Let &quot;myHeader&quot; span three columns in a five columns grid layout (a period sign 
  represent an item with no name):</p>
<div class="w3-code notranslate cssHigh">
  .container {<br>&nbsp; display: grid;<br>&nbsp; grid-template-areas: 'myHeader 
  myHeader myHeader . .';<br>}<br><br>.item1 {<br>&nbsp; grid-area: 
  myHeader;<br>} <br></div>
<p>Result:</p>
<div class="w3-white notranslate w3-padding">
<div class="grid-container2" style="grid-template-areas:'myArea myArea myArea . .'">
  <div style="grid-area:myArea">1</div>
  <div>2</div>
  <div>3</div>  
  <div>4</div>
...
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss_grid_grid-area_named1">Try it Yourself &raquo;</a></p>
</div>
<!--stop-->
<hr>
...
<hr>
<!--start-->
<p>To define two rows (two areas), define the second row inside another set of apostrophes:</p>
<div class="w3-example">
<h3>Example</h3>
  <p>Let &quot;myHeader&quot; span two columns <em>and</em> two rows:</p>
<div class="w3-code notranslate cssHigh">
  .container {<br>&nbsp; display: grid;<br>&nbsp; grid-template-areas:<br>&nbsp;&nbsp;&nbsp; 'myHeader 
  myHeader 
  . . .'<br>&nbsp;&nbsp;&nbsp; 'myHeader myHeader . . .';<br>}<br><br>.item1 {<br>&nbsp; grid-area: 
  myHeader;<br>} <br></div>
<p>Result:</p>
<div class="w3-white notranslate w3-padding">
<div class="grid-container2" style="grid-template-areas:'myArea myArea . . .' 'myArea myArea . . .'">
  <div style="grid-area:myArea">1</div>
  <div>2</div>
  <div>3</div>  
  <div>4</div>
...
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss_grid_grid-area_named2">Try it Yourself &raquo;</a></p>
</div>
<hr>
<h2>Make a ready-to-use Webpage Template</h2>
<p>Here, we will name all grid items to make a ready-to-use webpage template:</p>
<div class="w3-example">
<h3>Example</h3>
  <p>Name all grid items, and make a ready-to-use webpage template:</p>
<div class="w3-code notranslate cssHigh">
  .item1 { grid-area: header; }<br>.item2 { grid-area: menu; }<br>.item3 { 
  grid-area: main; }<br>.item4 { grid-area: right; }<br>.item5 { grid-area: 
  footer; }<br><br>.container {<br>&nbsp; display: grid;<br>&nbsp; grid-template-areas:<br>&nbsp;&nbsp;&nbsp; 
  'header header header header header header'<br>&nbsp;&nbsp;&nbsp; 'menu main 
  main main main right'<br>&nbsp;&nbsp;&nbsp; 'menu footer footer footer footer 
  footer';<br>} <br></div>
<p>Result:</p>
<div class="w3-white notranslate w3-padding">
...
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss_grid_grid-area_named3">Try it Yourself &raquo;</a></p>
</div>
<!--stop-->
<br>
<div class="w3-clear nextprev">
