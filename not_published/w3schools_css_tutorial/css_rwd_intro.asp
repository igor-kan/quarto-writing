...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="css_challenges_supports_rule.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_challenges_rwd_intro.asp">Next &#10095;</a>
</div>
<hr>

<h2>Introduction to Responsive Web Design</h2>
<p>Responsive web design is about creating web pages that look good on all 
devices!</p>
<p>A responsive web design will automatically adjust for different screen sizes 
and viewports.</p>
<hr>

<h2>Best Experience For All Users</h2>
<p>Web pages can be viewed with many different devices: desktops, tablets, and mobile phones.</p>
<p>Your web page should look good, and be easy to use, regardless of the device.</p>
<p>Responsive web design is about using HTML and CSS to automatically resize, 
hide, shrink, or enlarge a website, to make it look good on all devices.</p>
<p>Key components in responsive web design are:</p>
<ul>
  <li>Viewport &lt;meta&gt; tag</li>
  <li>Flexible layout (grid and flex)</li>
  <li>Mediaqueries</li>
</ul>
<br>
...
<br>
<a class="ws-btn" target="_blank" href="tryit.asp?filename=tryresponsive_breakpoints2">Try it Yourself &raquo;</a>
...
<hr>
<div id="exercisecontainer" src="xrcise_rwd_intro.js"></div>
<hr>
