...
<html lang="en-US">
<head>
<title>CSS Grid Items - Alignment</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">Grid Items - Alignment</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="css_grid_item_name.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="css_grid_item_order.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS Grid Items - Alignment</h2>
<p>Grid items can be aligned within their respective grid cells using properties like: </p>
<ul>
  <li><code class="w3-codespan">justify-self</code> - Specifies the horizontal alignment within a cell</li>
  <li><code class="w3-codespan">align-self</code> - Specifies the vertical alignment within a cell</li>
  <li><code class="w3-codespan">place-self</code> - Shorthand property for <code class="w3-codespan">align-self</code> and <code class="w3-codespan">justify-self</code></li>
</ul>
<p>These can also be applied to all grid items in a container using <code class="w3-codespan">justify-items</code> and <code class="w3-codespan">
align-items</code> on the grid container.</p>
<!--stop-->
<hr>

<!--start-->
<h2>The CSS justify-self Property</h2>
<p>The <code class="w3-codespan"><a href="/cssref/css_pr_justify-self.php">justify-self</a></code>  property is used to 
align a grid item within its grid cell in the inline direction.</p>
<p><strong>Tip:</strong> For pages in English, inline direction is left to right and block direction is 
top to bottom.</p>
<p>This property can have one of the following values:</p>
<ul>
  <li><code class="w3-codespan">auto</code> (default)</li>
  <li><code class="w3-codespan">normal</code></li>
  <li><code class="w3-codespan">stretch</code></li>
  <li><code class="w3-codespan">start</code></li>
  <li><code class="w3-codespan">left</code></li>
  <li><code class="w3-codespan">center</code></li>
  <li><code class="w3-codespan">end</code></li>
  <li><code class="w3-codespan">right</code></li>
</ul>
<p><strong>Note:</strong> For this property to have any alignment effect, the grid item need available space around itself in the inline direction.</p>

<div class="w3-example">
<h3>Example</h3>
  <p>Using the <code class="w3-codespan">justify-self</code>  property:</p>
<div class="w3-code notranslate cssHigh">
  .item1 {justify-self: right;}<br>.item6 {justify-self: 
  center;}</div>
<p>Result:</p>
<div class="w3-white notranslate w3-padding">
<div class="grid-container">
  <div style="justify-self: right;">Item 1</div>
  <div>Item 2</div>
  <div>Item 3</div>  
  <div>Item 4</div>
  <div>Item 5</div>
  <div style="justify-self: center;">Item 6</div>
</div>
</div>  
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss_grid_item_justify-self">Try it Yourself &raquo;</a></p>
</div>
<!--stop-->
<hr>
...
<!--start-->
<h2>The CSS align-self Property</h2>
<p>The <code class="w3-codespan"><a href="/cssref/css3_pr_align-self.php">align-self</a></code> property is 
used to align a grid item within its grid cell in the block direction.</p>
<p>This property can have one of the following values:</p>
<ul>
  <li><code class="w3-codespan">auto</code> (default)</li>
  <li><code class="w3-codespan">normal</code></li>
...
<p><strong>Note:</strong> For this property to have any alignment effect, the grid item need available space around itself in the 
block direction.&nbsp;</p>
<div class="w3-example">
<h3>Example</h3>
  <p>Using the <code class="w3-codespan">align-self</code> property:</p>
<div class="w3-code notranslate cssHigh">
  .item1 {align-self: start;}<br>.item6 {align-self: center;}</div>
<p>Result:</p>
<div class="w3-white notranslate w3-padding">
<div class="grid-container" style="height:300px;">
  <div style="align-self: start;">Item 1</div>
  <div>Item 2</div>
  <div>Item 3</div>  
  <div>Item 4</div>
  <div>Item 5</div>
  <div style="align-self: center;">Item 6</div>
</div>
</div>  
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss_grid_item_align-self">Try it Yourself &raquo;</a></p>
</div>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_grid_item.js"></div>
<hr>

<h2>CSS Grid Item Alignment Properties</h2>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    ...
    <td>Align a grid item within its grid cell in the block direction</td>
  </tr>
  <tr>
    <td><a href="/cssref/css_pr_justify-self.php">justify-self</a></td>
    <td>Align a grid item within its grid cell in the inline direction</td>
  </tr>
  <tr>
    <td><a href="/cssref/css_pr_place-self.php">place-self</a></td>
    <td>A shorthand property for <em>align-self</em> and <em>justify-self</em></td>
  </tr>
</table>
