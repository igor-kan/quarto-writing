...
<h1>CSS <span class="color_h1">Grid Layout</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="css_challenges_flexbox_responsive.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="css_challenges_grid_intro.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS Grid Layout Module</h2>
<p>The Grid Layout Module offers a grid-based layout system, with rows and columns.</p>
<p>The Grid Layout Module allows developers to easily create complex web layouts.</p>
<p>The Grid Layout Module makes it easy to design a responsive layout structure, 
without using <code class="w3-codespan">
<a href="/cssref/pr_class_float.php">float</a></code> or positioning.</p>
...
<p><a class="ws-btn" target="_blank" href="tryit.asp?filename=trycss_grid_layout_named">Try it Yourself &raquo;</a></p>

<div class="w3-panel ws-note">
  <h3>Grid vs. Flexbox</h3>
  <p>CSS Grid is used for two-dimensional layout, with rows AND columns.</p>
  <p><a href="css3_flexbox.asp">CSS Flexbox</a> is used for one-dimensional layout, with rows OR columns.</p>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>CSS Grid Components</h2>
<p>A grid always consists of:</p>
<ul>
  <li><strong>A Grid Container</strong> - The parent (container) element, where the <code class="w3-codespan"><a href="/cssref/pr_class_display.php">display</a></code> property is set to <code class="w3-codespan">
  grid</code> or <code class="w3-codespan">inline-grid</code></li>
  <li><strong>One or more Grid Items</strong> - The direct children of the grid container automatically becomes grid items</li>
</ul>
<!--stop-->
<hr>
...
<hr>
<!--start-->
<h2>A Grid Container with Five Grid Items</h2>
<p>The element below represents a <strong>grid container</strong> (the blue area) with five <strong>grid items</strong>.</p>
...
<h3>Example</h3>
  <p>A grid container with five grid items:</p>
<div class="w3-code notranslate htmlHigh">
  &lt;html&gt;<br>&lt;head&gt;<br>&lt;style&gt;<br>.container {<br>&nbsp; display: grid;<br>&nbsp; 
  grid-template-columns: auto auto auto;<br>&nbsp; background-color: dodgerblue;<br>&nbsp; 
  padding: 10px;<br>}<br>.container div {<br>&nbsp; background-color: #f1f1f1;<br>&nbsp; 
  border: 1px solid black;<br>&nbsp; padding: 10px;<br>&nbsp; font-size: 30px;<br>&nbsp; 
  text-align: center;<br>}<br>&lt;/style&gt;<br>&lt;/head&gt;<br>&lt;body&gt;<br><br>&lt;div class=&quot;container&quot;&gt;<br>&nbsp; 
  &lt;div&gt;1&lt;/div&gt;<br>&nbsp; &lt;div&gt;2&lt;/div&gt;<br>&nbsp; &lt;div&gt;3&lt;/div&gt; <br>&nbsp; 
  &lt;div&gt;4&lt;/div&gt;<br>&nbsp; &lt;div&gt;5&lt;/div&gt;<br>&lt;/div&gt;<br><br>&lt;/body&gt;<br>
  &lt;/html&gt;</div>
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss_grid">Try it Yourself &raquo;</a></p>
</div>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> You will learn more about grid containers and grid items in the next chapters.</p>
</div>
<!--stop-->
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    ...
    <td>Vertically aligns the whole grid inside the container (when total grid 
    size is smaller than container)</td>
  </tr>
  <tr>
    <td><a href="/cssref/css3_pr_align-items.php">align-items</a></td>
    <td>Specifies the default alignment for items inside a flexbox or grid 
    container</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Specifies the display behavior (the type of rendering box) of an element</td>
  </tr>
  <tr>
  ...
  <tr>
    <td><a href="/cssref/pr_grid-auto-columns.php">grid-auto-columns</a></td>
    <td>Specifies a default column size</td>
  </tr>
  <tr>
    <td><a href="/cssref/pr_grid-auto-flow.php">grid-auto-flow</a></td>
    <td>Specifies how auto-placed items are inserted in the grid</td>
  </tr>
  <tr>
    <td><a href="/cssref/pr_grid-auto-rows.php">grid-auto-rows</a></td>
  ...
  <tr>
    <td><a href="/cssref/css_pr_place-content.php">place-content</a></td>
    <td>A shorthand property for the <em>align-content</em> and the <em>
    justify-content</em> properties</td>
  </tr>
  <tr>
    <td><a href="/cssref/css3_pr_row-gap.php">row-gap</a></td>
