...
<html lang="en-US">
<head>
<title>CSS The z-index Property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">The z-index</span> Property</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="css_challenges_position_offset.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_challenges_z-index.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>The CSS z-index Property</h2>
<p>The <code class="w3-codespan"><a href="/cssref/pr_pos_z-index.php">z-index</a></code> property specifies the stack order of 
positioned elements.</p>
<p>The stack order defines which element should be placed in front or behind other 
elements.</p>
...
<div style="position:relative;padding:80px;height:270px;">
<img style="position:absolute;left:30px;top:15px;z-index:0;height:250px;" src="img_tree.png">
<h1 style="position:absolute;left:35px;top:35px;z-index:0;">This is a heading</h1>
<p style="position:absolute;left:35px;top:120px;z-index:0;">Because the image has a z-index of -1, it will be placed behind the text.</p>
</div>

<div class="w3-example" style="position:relative;z-index:0">
<h3>Example</h3>
...
<p><strong>Note:</strong> <code class="w3-codespan">
<a href="/cssref/pr_pos_z-index.php">z-index</a></code> only works on <a href="css_position.asp">positioned elements</a> (position: absolute, 
position: relative, position: fixed, or position: sticky) and <a href="css3_flexbox.asp">flex items</a> 
(elements that are direct children of display: flex elements).</p>
<!--stop-->
<hr>
...
<p>A positioned element with a greater stack order is always above an element 
with a lower stack order.</p>
...
<div class="w3-code notranslate htmlHigh">
  ...
  box&lt;/div&gt;<br>&nbsp; &lt;div class=&quot;green-box&quot;&gt;Green box&lt;/div&gt;<br>&lt;/div&gt;<br><br>&lt;/body&gt;<br>&lt;/html&gt;</div>
<a target="_blank" href="tryit.asp?filename=trycss_zindex2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Without z-index</h2>
<p>If several positioned elements overlap each other without a <code class="w3-codespan">
<a href="/cssref/pr_pos_z-index.php">z-index</a></code>  
specified, the elements render in the order they are defined in the HTML source 
code.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Same example as above, but here with no z-index specified:</p>
<div class="w3-code notranslate htmlHigh">
  &lt;html&gt;<br>&lt;head&gt;<br>&lt;style&gt;<br>.container {<br>&nbsp; position: relative;<br>}<br>
  ...
  class=&quot;black-box&quot;&gt;Black box&lt;/div&gt;<br>&nbsp; &lt;div class=&quot;gray-box&quot;&gt;Gray 
  box&lt;/div&gt;<br>&nbsp; &lt;div class=&quot;green-box&quot;&gt;Green box&lt;/div&gt;<br>&lt;/div&gt;<br><br>&lt;/body&gt;<br>&lt;/html&gt;</div>
<a target="_blank" href="tryit.asp?filename=trycss_zindex3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->

<hr>
<div id="exercisecontainer" src="xrcise_z-index.js"></div>
<hr>
