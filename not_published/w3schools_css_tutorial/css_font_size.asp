...
<h1>CSS <span class="color_h1">Font Size</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_font_style.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_font_google.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS Font Size</h2>
<p>The CSS <code class="w3-codespan"><a href="/cssref/pr_font_font-size.php">font-size</a></code> property 
is used to specify the size of the text/font.</p>
<p>Being able to manage the text size is very important in web design.</p>
<p>However, you 
...
paragraphs.</p>
<p>The <code class="w3-codespan"><a href="/cssref/pr_font_font-size.php">font-size</a></code> can be set to an absolute size or to a relative size.</p>
  <p>Absolute sizes:</p>
  <ul>
    <li><code class="w3-codespan">px</code>: Pixels offers fixed and precise control over the font size.</li>
    <li><code class="w3-codespan">xx-small</code>, <code class="w3-codespan">
    x-small</code>, <code class="w3-codespan">small</code>, <code class="w3-codespan">
    medium</code>, <code class="w3-codespan">large</code>, <code class="w3-codespan">
    x-large</code>, <code class="w3-codespan">xx-large</code>. These keywords 
    has a predefined set of sizes in browsers.</li>
  </ul>
  <p>Relative sizes:</p>
  <ul>
    <li><code class="w3-codespan">em</code>: This unit is relative to the font size of the parent element.</li>
    <li><code class="w3-codespan">rem</code>: This unit is relative to the font size of 
    the root HTML element.</li>
    <li><code class="w3-codespan">%</code>: This unit is relative to the font 
    size of the parent element</li>
    <li><code class="w3-codespan">smaller</code> and <code class="w3-codespan">
    larger</code>: These units adjust the font size relative to the 
    parent element. </li>
  </ul>
  <h3>How to Pick the Right Unit?</h3>
  <ul>
    <li>For fixed and precise control, <code class="w3-codespan">px</code> can be used.</li>
    <li>With <code class="w3-codespan">px</code>, the web page will not scale 
    well on different screen sizes or with user preferences.</li>
    <li>Absolute size can be useful when the physical size of the output is known.</li>
    <li>For scalable web designs, use <code class="w3-codespan">em</code> or <code class="w3-codespan">
    rem</code>; they allow users to adjust text size in their browser settings.</li>
    <li>Percentage (<code class="w3-codespan">%</code>) can be useful for adjusting font sizes based on parent 
    elements.</li>
  </ul>
<!--stop-->
<hr>
...
<p>Setting the text size with pixels (<code class="w3-codespan">px</code>) gives 
you full control over the text size.</p>
<p>If you use pixels, the web page may not scale very well on different screen 
sizes and the users cannot adjust the text size in their browser settings. 
However, users can still use the zoom tool to resize the entire page.</p>
<div class="w3-example">
<h3>Example</h3>
  <p>Set font sizes with px:</p>
<div class="w3-code notranslate cssHigh">
h1 {<br>&nbsp;&nbsp;font-size: 40px;<br>}<br>
<br>h2 {<br>&nbsp;&nbsp;font-size: 30px;<br>}<br>
<br>p {<br>&nbsp;&nbsp;font-size: 16px;<br>}</div>
...
<p>The <code class="w3-codespan">em</code> unit is relative to the font size of 
the parent element. So, if the parent element has a font size of 16px, then 2.5em 
would result in 40px.</p>

<p>In the following example, the text size in 
<code class="w3-codespan">em</code> is the same as the previous example 
in pixels. However, the
<code class="w3-codespan">em</code> unit allows the user to adjust the text size 
in the browser settings.</p>

<div class="w3-example">
<h3>Example</h3>
  <p>Set font sizes with em:</p>
<div class="w3-code notranslate cssHigh">
  body {<br>&nbsp; font-size: 16px; /* Base font size */<br>}<br>
  <br>h1 {<br>&nbsp; font-size: 2.5em; /* 2.5 * 16 = 40px */<br>}<br>
<br>h2 {<br>&nbsp;&nbsp;font-size: 1.875em; /* 1.875 * 16 = 30px */<br>
}<br>
<br>p {<br>&nbsp; font-size: 1em; /* 1 * 16 = 16px */<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_font-size_em" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Set Font Size With Rem</h2>
<p>The <code class="w3-codespan">rem</code> unit is relative to the font size of 
the root HTML element (&lt;html&gt;).</p>
<p>Unlike <code class="w3-codespan">em</code>, which is relative to the font-size of its parent element, <code class="w3-codespan">rem</code>  
always refers to the font-size of the &lt;html&gt; element, regardless of its position 
in the document tree. This makes <code class="w3-codespan">rem</code> very useful for creating scalable and responsive 
designs. By changing the font-size of the &lt;html&gt; element, all elements sized 
with <code class="w3-codespan">rem</code> units will scale proportionally throughout the entire page.</p>
<p>The default font-size of the &lt;html&gt; element in most browsers, is 16px. 
So, by default, 1rem equals 16px unless explicitly overridden in the CSS.</p>

<div class="w3-example">
<h3>Example</h3>
  <p>Set font sizes with rem:</p>
<div class="w3-code notranslate cssHigh">
  html {<br>&nbsp; font-size: 16px; /* Set the root font size */<br>}<br>
  <br>h1 {<br>&nbsp; font-size: 2.5rem; /* 2.5 * 16 = 40px */<br>}<br>
<br>h2 {<br>&nbsp;&nbsp;font-size: 1.875rem; /* 1.875 * 16 = 30px */<br>
}<br>
<br>p {<br>&nbsp; font-size: 1rem; /* 1 * 16 = 16px */<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_font-size_rem" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>The vw Unit</h2>
<p>The font size can also be set with the <code class="w3-codespan">vw</code> unit, which means the &quot;viewport width&quot;.</p>
<p>The <code class="w3-codespan">vw</code> unit is a relative unit that 
represents a percentage of the width of the viewport.</p>
<p>1vw = 1% of the current width of the browser's viewport. So, if the viewport is 500px wide, 1vw is 5px.</p>
<p>This way the text size will follow the size of the browser window:</p>
