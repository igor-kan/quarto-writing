...
<html lang="en-US">
<head>
<title>CSS Text Indentation and Spacing</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">Text Spacing</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_text_transformation.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_text_shadow.asp">Next &#10095;</a>
</div>
<hr>

<h2>CSS Text Spacing</h2>
<p>CSS has several properties to control text spacing.</p>
<p>In this chapter you will learn about the following properties:</p>
<ul>
<li><code class="w3-codespan"><a href="/cssref/pr_text_text-indent.php">text-indent</a></code></li>
<li><code class="w3-codespan"><a href="/cssref/pr_text_letter-spacing.php">letter-spacing</a></code></li>
<li><code class="w3-codespan"><a href="/cssref/pr_dim_line-height.php">line-height</a></code></li>
  <li><code class="w3-codespan"><a href="/cssref/pr_text_word-spacing.php">word-spacing</a></code></li>
  <li><code class="w3-codespan"><a href="/cssref/pr_text_white-space.php">white-space</a></code></li>
</ul>
<hr>
<!--start-->
<h2>CSS Text Indentation</h2>
<p>The CSS <code class="w3-codespan"><a href="/cssref/pr_text_text-indent.php">text-indent</a></code> property is used to specify the indentation of the first line 
in a text-block.</p>
<p><strong>Tip:</strong> Negative values are allowed. The first line will be 
indented to the left if the value is negative.</p>
<div class="w3-example">
<h3>Example</h3>
  <p>Indent the first line of text in a text-block:</p>
...
<a href="/cssref/pr_text_letter-spacing.php">letter-spacing</a></code> property is used to specify the space between the characters in a text.</p>
<p><strong>Tip:</strong> Negative values are allowed.</p>
<div class="w3-example">
<h3>Example</h3>
  <p>Increase and decrease the space between characters:</p>
<div class="w3-code notranslate cssHigh">
h1 {<br>&nbsp; letter-spacing: 5px;<br>}<br><br>h2 {<br>&nbsp;&nbsp;letter-spacing: -2px;<br>}</div>
...
<p>The CSS <code class="w3-codespan"><a href="/cssref/pr_dim_line-height.php">line-height</a></code> property is used to specify the space between lines.</p>
<p><strong>Note:</strong> Negative values are not allowed.</p>
<div class="w3-example">
<h3>Example</h3>
  <p>Specify the space between lines:</p>
<div class="w3-code notranslate cssHigh">
...
<p>The CSS <code class="w3-codespan"><a href="/cssref/pr_text_word-spacing.php">word-spacing</a></code> property is used to specify the space between 
the words in a text.</p>
<p><strong>Tip:</strong> Negative values are allowed.</p>
<div class="w3-example">
<h3>Example</h3>
  <p>Increase and decrease the space between words:</p>
<div class="w3-code notranslate cssHigh">
  p.one {<br>&nbsp;&nbsp;word-spacing: 10px;<br>}<br><br>p.two {<br>&nbsp;&nbsp;word-spacing: -2px;<br>}</div>
...
<p>The CSS <code class="w3-codespan"><a href="/cssref/pr_text_white-space.php">white-space</a></code> property specifies how white-space inside an element is handled.</p>
<p>This property can have one of the following values:</p>
<ul>
  <li><code class="w3-codespan">normal</code></li>
  <li><code class="w3-codespan">nowrap</code></li>
  <li><code class="w3-codespan">pre</code></li>
  <li><code class="w3-codespan">pre-line</code></li>
  <li><code class="w3-codespan">pre-wrap</code></li>
</ul>
<div class="w3-example">
<h3>Example</h3>
  <p>How to disable text wrapping inside an element</p>
<div class="w3-code notranslate cssHigh">
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_text_spacing.js"></div>
<hr>

<h2>The CSS Text Spacing Properties</h2>
<table class="ws-table-all notranslate">
  ...
  <tr>
    ...
    <td>Specifies the space between characters in a text</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Specifies how to handle white-space inside an element</td>
  </tr>
  <tr>
    <td><a href="/cssref/pr_text_word-spacing.php">word-spacing</a></td>
    <td>Specifies the space between words in a text</td>
  </tr>
</table>
