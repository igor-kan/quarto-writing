...
<a class="w3-left w3-btn" href="css_errors.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_colors_rgb.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS Colors</h2>
<p>In CSS, colors are specified by using a predefined color name, or with a RGB, HEX, HSL, RGBA, HSLA value.</p>
<hr>
...
<p><a target="_blank" href="tryit.asp?filename=trycss_color_names" class="ws-btn w3-margin-bottom">Try it Yourself &raquo;</a></p>
<p>CSS/HTML support <a href="/colors/colors_names.asp">140 standard color names</a>.</p>
<!--stop-->
<hr>
<!--start-->
...
<div style="background-color:dodgerblue; text-align:center;color:white;font-size:34px;">Hello World</div>
...
<p>In CSS, colors can also be specified using RGB values, HEX values, HSL 
...
<p>You will learn more about <a href="css_colors_rgb.asp">RGB</a>, <a href="css_colors_hex.asp">HEX</a> and <a href="css_colors_hsl.asp">HSL</a> in the next chapters.</p>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_colors.js"></div>

<hr>
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: CSS Colors Introduction</h2>
  <a href="https://youtu.be/q0uWmobMf6I&list=PLP9IO4UYNF0UCaUSF3XNZ1U9f01E5h5PM" class="ga-featured ga-youtube" target="blank_" >
    <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
      ...
      <picture id="yt_div">
        <source srcset="images/css_colors_introduction.webp" type="image/webp" />
        <img src="images/css_colors_introduction.png" style="max-width:100%;height:auto;border-radius:6px" alt="Tutorial on YouTube" loading="lazy">
      </picture>
    </div>
  </a>
</div>
