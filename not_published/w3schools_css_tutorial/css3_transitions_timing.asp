...
<html lang="en-US">
<head>
<title>CSS Transition Timing</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">Transition Timing</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css3_transitions.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_challenges_css3_transitions.asp">Next &#10095;</a>
</div>
<hr>

<h2>CSS Transition Speed Curve</h2>
<p>The <code class="w3-codespan">
<a href="/cssref/css3_pr_transition-timing-function.php">transition-timing-function</a></code> property specifies the speed curve of the transition effect.</p>
<p>This property can have one of the following values:</p>
<ul>
<li><code class="w3-codespan">ease</code> - transition will start slow, then go fast, 
and end slow (this is default)</li>
<li><code class="w3-codespan">linear</code> - transition will keep the same speed from start to end</li>
<li><code class="w3-codespan">ease-in</code> - transition will start slow</li>
<li><code class="w3-codespan">ease-out</code> - transition will end slow</li>
<li><code class="w3-codespan">ease-in-out</code> - transition will have a slow start and end</li>
...
<h3>Example</h3>
  <p>Some different speed curves for transition:</p>
...
<h2>CSS Transition Delay</h2>
<p>The <code class="w3-codespan"><a href="/cssref/css3_pr_transition-delay.php">transition-delay</a></code> property specifies a delay 
before the transition starts.</p>
<p>The <code class="w3-codespan">transition-delay</code> value is defined in 
seconds (s) or milliseconds (ms).</p>
...
<p>The following example combines transition and transform for a &lt;div&gt;:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
div {<br>&nbsp;&nbsp;transition: 
width 2s, height 2s, background-color 2s, transform 2s;<br>}</div>
...
<p>The following example combines transition and transform for a button:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  button {<br>&nbsp;&nbsp;transition: background-color 1s ease-out, transform 1s 
  ease-out;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_transition_transform2">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>or by using the shorthand property <code class="w3-codespan">
<a href="/cssref/css3_pr_transition.php">transition</a></code>:</p>
...
<hr>
<div id="exercisecontainer" src="xrcise_css3_transitions_timing.js"></div>
<hr>
