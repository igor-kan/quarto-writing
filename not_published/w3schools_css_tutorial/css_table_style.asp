...
<h1>CSS <span class="color_h1">Table Styling</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_table_align.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_table_responsive.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS Table Padding</h2>
<p>To add some more space between the inner borders and the content in a table, use the 
...
{<br>
  &nbsp;
padding: 10px;<br>&nbsp; text-align: left;<br>
}</div>
...
<hr>
<!--start-->
<h2>CSS Horizontal Dividers</h2>
<p>To create horizontal dividers for a table, add the <code class="w3-codespan"><a href="/cssref/pr_border-bottom.php">border-bottom</a></code> property to &lt;th&gt; and &lt;td&gt; 
elements:</p>
...
<hr>
<!--start-->
<h2>CSS Hoverable Table</h2>
<p>Use the CSS <code class="w3-codespan"><a href="/cssref/sel_hover.php">:hover</a></code> selector on &lt;tr&gt; to highlight table rows on mouse 
over:</p>
...
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
tr:hover {background-color: coral;}</div>
...
<hr>
<!--start-->
<h2>CSS Zebra-striped Table</h2>
<p>For zebra-striped tables, use the <code class="w3-codespan">
<a href="/cssref/sel_nth-child.php">nth-child()</a></code> selector and add a <code class="w3-codespan">
<a href="/cssref/pr_background-color.php">background-color</a></code> to all even (or odd) table rows:</p>
...
<hr>
<!--start-->
<h2>CSS Table Color</h2>
<p>The example below specifies a background color and a text color for the &lt;th&gt; elements:</p>
<table class="zebra">
