...
<h1>CSS <span class="color_h1">Form Inputs</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_form.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_form_focus.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>Styling Form Input Fields</h2>
<p>With CSS, you can style most of the different input types, like text fields, 
password fields, checkboxes, radio buttons, and file inputs. You can also style 
input labels and form buttons.</p>
<p>Some commonly used CSS properties for styling input fields, are:</p>
<ul>
  <li> <code class="w3-codespan"><a href="/cssref/pr_dim_width.php">width</a></code>
  </li>
  <li> <code class="w3-codespan"><a href="/cssref/pr_padding.php">padding</a></code></li>
  <li> <code class="w3-codespan"><a href="/cssref/pr_margin.php">margin</a></code></li>
  <li> <code class="w3-codespan"><a href="/cssref/pr_border.php">border</a></code></li>
  <li> <code class="w3-codespan"><a href="/cssref/css3_pr_border-radius.php">border-radius</a></code></li>
  <li> <code class="w3-codespan"><a href="/cssref/pr_background-color.php">background-color</a></code></li>
  <li> <code class="w3-codespan"><a href="/cssref/pr_text_color.php">color</a></code></li>
  <li> <code class="w3-codespan"><a href="/cssref/pr_font_font-size.php">
  font-size</a></code></li>
</ul>
<hr>

<h2>Style Input Width</h2>
<p>The <code class="w3-codespan"><a href="/cssref/pr_dim_width.php">width</a></code> property 
is used to set the width of an input field.</p>
<p><strong>Tip:</strong> The default width of an HTML input text field, is 20 characters.</p>
<p>Here we set the width to 100%:</p>
...
style a specific input type, you can use <a href="css_attribute_selectors.asp">attribute selectors</a>:</p>
<ul>
...
<hr>
<!--start-->
<h2>Style Input Padding</h2>
<p>The <code class="w3-codespan"><a href="/cssref/pr_padding.php">padding</a></code> property 
is used to add some space inside the text field.</p>
<p><strong>Tip:</strong> When you have several input fields after each other, you might 
also want to add some <code class="w3-codespan"><a href="/cssref/pr_margin.php">margin</a></code>, to add more space 
around them:</p>
<label for="fname3">First Name</label>
<input type="text" id="fname3" name="firstname" class="inputpadding">
<label for="lname3">Last Name</label>
<input type="text" id="lname3" name="lastname" class="inputpadding">
...
input[type=text]
{<br>
  &nbsp; width: 100%;<br>&nbsp; padding: 12px;<br>&nbsp; margin: 10px 0;<br>&nbsp; 
...
<div class="w3-panel ws-note">
  <p>Note that we have set the <code class="w3-codespan">
  <a href="/cssref/css3_pr_box-sizing.php">box-sizing</a></code> property to 
...
<hr>
<!--start-->
<h2>Style Input Border</h2>
<p>The <code class="w3-codespan"><a href="/cssref/pr_border.php">border</a></code> property 
is used to change the border size and color, and 
the <code class="w3-codespan"><a href="/cssref/css3_pr_border-radius.php">border-radius</a></code> property 
can be used to add rounded corners:</p>
...
<p>If you only want a bottom border, use the <code class="w3-codespan">
<a href="/cssref/pr_border-bottom.php">border-bottom</a></code> property:</p>
...
<hr>
<!--start-->
<h2>Style Input Background Color and Color</h2>
<p>The <code class="w3-codespan"><a href="/cssref/pr_background-color.php">background-color</a></code> property 
is used to add a background color to the input, and 
the <code class="w3-codespan"><a href="/cssref/pr_text_color.php">color</a></code> property 
is used to change the text color:</p>
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_form_inputs.js"></div>
<hr>
