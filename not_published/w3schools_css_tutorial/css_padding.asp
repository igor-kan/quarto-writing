...
<a class="w3-right w3-btn" href="css_padding_box-sizing.asp">Next &#10095;</a>
</div>
<hr>

<!--start-->
<h2>CSS Padding</h2>
<p>The CSS padding properties are used to generate space around 
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_padding_intro" class="ws-btn">Try it Yourself &raquo;</a>
<!--stop-->
<hr>
<!--start-->
...
<ul>
<li><code class="w3-codespan"><a href="/cssref/pr_padding-top.php">padding-top</a></code> - sets the top padding of an element</li>
<li><code class="w3-codespan"><a href="/cssref/pr_padding-right.php">padding-right</a></code> - sets the 
right padding of an element</li>
<li><code class="w3-codespan"><a href="/cssref/pr_padding-bottom.php">padding-bottom</a></code> - sets the 
bottom padding of an element</li>
<li><code class="w3-codespan"><a href="/cssref/pr_padding-left.php">padding-left</a></code> - sets the 
left padding of an element</li>
</ul>
...
one declaration.</p>
<p>The <code class="w3-codespan"><a href="/cssref/pr_padding.php">padding</a></code> property is a shorthand property for the following individual 
padding properties:</p>
<ul>
<li><code class="w3-codespan"><a href="/cssref/pr_padding-top.php">padding-top</a></code></li>
<li><code class="w3-codespan"><a href="/cssref/pr_padding-right.php">padding-right</a></code></li>
<li><code class="w3-codespan"><a href="/cssref/pr_padding-bottom.php">padding-bottom</a></code></li>
<li><code class="w3-codespan"><a href="/cssref/pr_padding-left.php">padding-left</a></code></li>
</ul>
<p>Here is how it works:</p>
<p>If the <code class="w3-codespan"><a href="/cssref/pr_padding.php">padding</a></code> property has four values:</p>
<ul>
...
<p>If the <code class="w3-codespan"><a href="/cssref/pr_padding.php">padding</a></code> property has three values:</p>
<ul>
...
<p>If the <code class="w3-codespan"><a href="/cssref/pr_padding.php">padding</a></code> property has two values:</p>
<ul>
...
<p>If the <code class="w3-codespan"><a href="/cssref/pr_padding.php">padding</a></code> property has one value:</p>
<ul>
...
<p><a href="tryit.asp?filename=trycss_padding-left" target="_blank">Set the left-padding property</a><br>
This example demonstrates how to set the left padding of a &lt;p&gt; element.</p>

<p><a target="_blank" href="tryit.asp?filename=trycss_padding-right">Set the right-padding property</a><br>
This example demonstrates how to set the right padding of a &lt;p&gt; element.</p>

<p><a target="_blank" href="tryit.asp?filename=trycss_padding-top">Set the top-padding property</a><br>
This example demonstrates how to set the top padding of a &lt;p&gt; element.</p>

<p><a target="_blank" href="tryit.asp?filename=trycss_padding-bottom">Set the bottom-padding property</a><br>
This example demonstrates how to set the bottom padding of a &lt;p&gt; element.</p>
<hr>

<div id="exercisecontainer" src="xrcise_padding.js"></div>
