...
<html lang="en-US">
<head>
<title>CSS Masking - Gradient Mask Layers</title>
<meta charset="utf-8">
...
<h1>CSS Gradient Mask Layers</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="css3_masking.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="css3_masking_svg.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS Gradient Mask Layers</h2>
<p><a href="css3_gradients.asp">CSS gradients</a> can also be used as the mask layer image. </p>
<hr>

<h2>Linear Gradient Mask Layer</h2>
<p>Here, we use a linear gradient mask layer for our image. This linear gradient goes from top (black) to bottom (transparent):</p>

<img class="mask2" src="img_5terre.jpg" alt="Cinque Terre" style="max-width:596px;width:100%;height:auto;">

<div class="w3-example">
<h3>Example</h3>
<p>Use a linear gradient as a mask layer:</p>
<div class="w3-code notranslate cssHigh">
    .mask1 {<br>&nbsp; -webkit-mask-image: linear-gradient(black, transparent);<br>&nbsp; mask-image: linear-gradient(black, 
    transparent);<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss3_mask-image2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p>Here, we use a linear gradient along with text masking as the mask layer for our image:</p>
<div class="mask2-1">
<p>Cinque Terre is a coastal area within Liguria, in the northwest of Italy. It lies in the west of La Spezia Province, and comprises five villages: Monterosso al Mare, Vernazza, Corniglia, Manarola, and Riomaggiore.</p>
<p>Cinque Terre is a coastal area within Liguria, in the northwest of Italy. It lies in the west of La Spezia Province, and comprises five villages: Monterosso al Mare, Vernazza, Corniglia, Manarola, and Riomaggiore.</p>
</div>
...
<div class="w3-code notranslate cssHigh">
    .mask1 {<br>&nbsp; max-width: 600px;<br>&nbsp; height: 400px;<br>&nbsp; background: url(img_5terre.jpg) no-repeat;<br>&nbsp; 
    -webkit-mask-image: linear-gradient(black, transparent);<br>&nbsp; 
    mask-image: linear-gradient (black, transparent);<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss3_mask-image2-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<hr>
<!--start-->
<h2>Radial Gradient Mask Layer - Circle</h2>
<p>Here, we use a radial gradient (shaped as a circle) as the mask layer for our image:</p>

<img class="mask3" src="img_5terre.jpg" alt="Cinque Terre" style="max-width:596px;width:100%;height:auto;">

<div class="w3-example">
<h3>Example</h3>
<p>Use a radial gradient as a mask layer (a circle):</p>
<div class="w3-code notranslate cssHigh">
    .mask2 {<br>&nbsp; -webkit-mask-image: 
    radial-gradient(circle, black 50%, rgba(0, 0, 0, 0.5) 50%);<br>&nbsp; 
    mask-image: radial-gradient(circle, black 50%, rgba(0, 0, 0, 0.5) 50%);<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss3_mask-image3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Radial Gradient Mask Layer - Ellipse</h2>
<p>Here, we use a radial gradient (shaped as an ellipse) as the mask layer for our image:</p>

<img class="mask4" src="img_5terre.jpg" alt="Cinque Terre" style="max-width:596px;width:100%;height:auto;">

<div class="w3-example">
<h3>Example</h3>
  <p>Use a radial gradient as a mask layer (an ellipse):</p>
<div class="w3-code notranslate cssHigh">
    .mask3 {<br>&nbsp; -webkit-mask-image: radial-gradient(ellipse, black 50%, rgba(0, 
    0, 0, 0.5) 50%);<br>&nbsp; mask-image: radial-gradient(ellipse, black 50%, rgba(0, 0, 
    0, 0.5) 50%);<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss3_mask-image4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Conic Gradient Mask Layer</h2>
<p>Here, we use a conic gradient as the mask layer for our image:</p>

<img class="mask4-1" src="img_5terre.jpg" alt="Cinque Terre" style="max-width:596px;width:100%;height:auto;">

<div class="w3-example">
<h3>Example</h3>
  <p>Use a radial gradient as a mask layer (an ellipse):</p>
<div class="w3-code notranslate cssHigh">
    .mask3 {<br>&nbsp; -webkit-mask-image: conic-gradient(black 0deg, 
    transparent 360deg);<br>&nbsp; mask-image: conic-gradient(black 0deg, transparent 
    360deg);<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss3_mask-image4_1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
