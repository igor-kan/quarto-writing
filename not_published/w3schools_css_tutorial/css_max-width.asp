...
<html lang="en-US">
<head>
<title>CSS The max-width Property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">The max-width Property</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_challenges_display.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_challenges_max-width.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>The CSS max-width Property</h2>
<p>The <code class="w3-codespan"><a href="/cssref/pr_dim_max-width.php">max-width</a></code> property defines the maximum width of an element.</p>
<p>This property prevents the element's width from being larger than the 
specified value (it can be smaller, but not larger).</p>
<p>This property is useful for creating responsive layouts and to ensure 
content readability across various screen sizes.</p>
<h3>Problem with width:</h3>
<p>Here we have a horizontally centered &lt;div&gt; element with a specific
<code class="w3-codespan"><a href="/cssref/pr_dim_width.php">width</a></code> 
(600px):</p>

<div class="w3-theme-border" style="border-width:3px;border-style:solid;width:600px;margin:auto;padding:8px;">
This &lt;div&gt; element has a width of 600px, and margin set to auto. This &lt;div&gt; element has a width of 600px, and margin set to auto.</div>
<br>

<p>What happens to the &lt;div&gt; above if the browser window is 
smaller than the width of the element? Some of the content will not show, and 
the browser might add a horizontal scrollbar to the page.</p>

<h3>Using max-width instead:</h3>
<p>Now, we use the <code class="w3-codespan">
<a href="/cssref/pr_dim_max-width.php">max-width</a></code> property instead. 
This will improve the 
browser's handling of small windows:</p>

<div class="w3-theme-border" style="border-width:3px;border-style:solid; max-width:600px;margin:auto;;padding:8px;">
This &lt;div&gt; element has a max-width of 600px, and margin set to auto. This &lt;div&gt; element has a max-width of 600px, and margin set to auto.</div>
<br>
<p><strong>Tip:</strong> Resize the browser window to less than 600px wide, to see the difference between 
the two &lt;div&gt;s!</p>

<p>Here is the CSS code for the two &lt;div&gt;s above:</p>
...
<hr>
<div id="exercisecontainer" src="xrcise_max-width.js"></div>
<hr>
