...
<h1>CSS Flexbox <span class="color_h1">justify-content</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css3_flexbox_container.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css3_flexbox_container_align.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS justify-content Property</h2>
<p>The <code class="w3-codespan"><a href="/cssref/css3_pr_justify-content.php">justify-content</a></code> property  
aligns the flex items along the main-axis (horizontally).</p>
<p>This property can have one of the following values:</p>
<ul>
  <li><code class="w3-codespan">center</code> </li>
  <li><code class="w3-codespan">flex-start</code> (default)</li>
...
<h3>Example</h3>
<p>The <code class="w3-codespan">center</code> value aligns the flex items in the center of the container:</p>
...
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss3_flexbox_justify-content_center">Try it Yourself &raquo;</a></p>
</div>
...
<p>Result:</p>
<div class="w3-white notranslate w3-padding">
  <div class="flex-container2" style="justify-content:flex-start">
    <div class="item2">1</div>
    <div class="item2">2</div>
    <div class="item2">3</div>  
  </div>
</div>
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss3_flexbox_justify-content_flex-start">Try it Yourself &raquo;</a></p>
</div>
...
<p>Result:</p>
<div class="w3-white notranslate w3-padding">
  <div class="flex-container2" style="justify-content:flex-end">
    <div class="item2">1</div>
    <div class="item2">2</div>
    <div class="item2">3</div>  
  </div>
</div>
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss3_flexbox_justify-content_flex-end">Try it Yourself &raquo;</a></p>
</div>
<!--stop-->
<hr>
...
<div class="w3-example">
<h3>Example</h3>
<p>The <code class="w3-codespan">space-around</code> value displays the flex items with space 
before, between, and after the lines:</p>
<div class="w3-code notranslate cssHigh">
  .flex-container {<br>&nbsp; 
  display: flex;<br>&nbsp; 
...
<p>Result:</p>
<div class="w3-white notranslate w3-padding">
  <div class="flex-container2" style="justify-content:space-around">
    <div class="item2">1</div>
    <div class="item2">2</div>
    <div class="item2">3</div>  
  </div>
</div>
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss3_flexbox_justify-content_space-around">Try it Yourself &raquo;</a></p>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>The <code class="w3-codespan">space-between</code> value displays the flex items with space 
between the lines:</p>
<div class="w3-code notranslate cssHigh">
  .flex-container {<br>&nbsp; 
  display: flex;<br>&nbsp; 
...
<p>Result:</p>
<div class="w3-white notranslate w3-padding">
  <div class="flex-container2" style="justify-content:space-between">
    <div class="item2">1</div>
    <div class="item2">2</div>
    <div class="item2">3</div>  
  </div>
</div>
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss3_flexbox_justify-content_space-between">Try it Yourself &raquo;</a></p>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>The <code class="w3-codespan">space-evenly</code> value displays the flex items with equal space around them:</p>
<div class="w3-code notranslate cssHigh">
  .flex-container {<br>&nbsp; 
  display: flex;<br>&nbsp; 
...
<p>Result:</p>
<div class="w3-white notranslate w3-padding">
  <div class="flex-container2" style="justify-content:space-evenly">
    <div class="item2">1</div>
    <div class="item2">2</div>
    <div class="item2">3</div>  
  </div>
</div>
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss3_flexbox_justify-content_space-evenly">Try it Yourself &raquo;</a></p>
</div>
<!--stop-->

<hr>
<div id="exercisecontainer" src="xrcise_css3_flexbox_container_justify.js"></div>
<hr>
