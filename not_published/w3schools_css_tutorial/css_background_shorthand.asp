...
<h1>CSS <span class="color_h1">Background Shorthand</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_background_attachment.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_challenges_background.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS background - Shorthand property</h2>
<p>To shorten the code, it is possible to specify all the background properties in one 
...
<p>You can use the shorthand property <code class="w3-codespan">
<a href="/cssref/css3_pr_background.php">background</a></code>:</p>

<div class="w3-example">
<h3>Example</h3>
  <p>Use the shorthand property to set all the background properties in one 
  declaration:</p>
<div class="w3-code notranslate cssHigh">
...
<p>
The <code class="w3-codespan"><a href="/cssref/css3_pr_background.php">background</a></code> 
property is a shorthand property for the following properties:</p>
<ul>
...
<p>If some of the property values are missing, they will be set to their initial 
(default) values.</p>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_background_shorthand.js"></div>
<hr>
...
<h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: CSS Background Shorthand</h2>
  <a href="https://youtu.be/rSEKmi5tR9E&list=PLP9IO4UYNF0UCaUSF3XNZ1U9f01E5h5PM" class="ga-featured ga-youtube" target="blank_" > 
    <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
      ...
      <picture id="yt_div">
        <source srcset="images/css_background_shorthand.webp" type="image/webp" />
        <img src="images/css_background_shorthand.png" style="max-width:100%;height:auto;border-radius:6px" alt="Tutorial on YouTube" loading="lazy">
      </picture>
    </div>
  </a>
</div>
