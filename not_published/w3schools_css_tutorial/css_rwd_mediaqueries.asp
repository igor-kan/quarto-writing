...
<a class="w3-left w3-btn" href="css_challenges_rwd_grid.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_challenges_rwd_mediaqueries.asp">Next &#10095;</a>
</div>
<hr>
<h2>CSS Media Queries</h2>
<p>CSS media queries allow you to apply styles based on the characteristics of a 
device or the environment displaying the web page.</p>

<p>CSS media queries are essential for creating responsive web pages.</p>

<p>The CSS <code class="w3-codespan"><a href="/cssref/atrule_media.php">@media</a></code> rule 
is used to add media queries to your style sheet.</p>
<hr>

<h2>Use Mediaqueries to Add a Breakpoint</h2>
<p>On the previous page we made a grid layout web page. Now we want to add a 
breakpoint with mediaqueries to rearrange the grid items on bigger screens.</p>
<div class="w3-row-padding" style="text-align:center;font-weight:bold;">
...
<h3>Example</h3>
<p>Here we use a media query to add a breakpoint at 600px:</p>
<div class="w3-code notranslate cssHigh">
  @media (min-width: 600px) {<br>&nbsp; .header {grid-area: 1 / span 6;}<br>&nbsp; 
  .menu {grid-area: 2 / span 1;}<br>&nbsp; .content {grid-area: 2 / span 4;}<br>&nbsp; 
  .facts {grid-area: 2 / span 1;}<br>&nbsp; .footer {grid-area: 3 / span 6;}<br>
  }<br></div>
...
<div class="w3-example">
<h3>Example</h3>
<p>Here we use media queries to add breakpoints when screen is min 600px, and when screen is min 768px :</p>
<div class="w3-code notranslate cssHigh">
  @media (min-width: 600px) {<br>&nbsp; .header {grid-area: 1 / span 6;}<br>&nbsp; 
  .menu {grid-area: 2 / span 1;}<br>&nbsp; .content {grid-area: 2 / span 4;}<br>&nbsp; 
  .facts {grid-area: 3 / span 6;}<br>&nbsp; .footer {grid-area: 4 / span 6;}<br>
  }<br><br>
  @media (min-width: 768px) {<br>&nbsp; .header {grid-area: 1 / span 6;}<br>&nbsp; 
  .menu {grid-area: 2 / span 1;}<br>&nbsp; .content {grid-area: 2 / span 4;}<br>&nbsp; 
  .facts {grid-area: 2 / span 1;}<br>&nbsp; .footer {grid-area: 3 / span 6;}<br>
  }<br></div>
<a target="_blank" href="tryit.asp?filename=tryresponsive_breakpoints2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a target="_blank" href="tryit.asp?filename=tryresponsive_mediaquery_orientation2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_mediaqueries_hide2">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_mediaqueries_fontsize2">Try it Yourself &raquo;</a>
</div>
<hr>
...
<hr>
<div id="exercisecontainer" src="xrcise_rwd_mediaqueries.js"></div>
<hr>
