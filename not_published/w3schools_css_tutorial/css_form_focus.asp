...
<html lang="en-US">
<head>
<title>CSS Form Focus and Icons</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">Form Focus and Icons</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_form_inputs.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_form_elements.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>Style Input with Focus</h2>
<p>By default, some browsers will add a blue outline around the input when it gets 
focus (clicked on). You can remove this behavior by adding <code class="w3-codespan">
<a href="/cssref/pr_outline.php">outline: none;</a></code> to the input.</p>
<p>Use the <code class="w3-codespan"><a href="/cssref/sel_focus.php">:focus</a></code> selector to do something with the input field when it gets focus:</p>
...
<!--start-->
<h2>Style Input with icon/image</h2>
<p>If you want an icon inside the input, use the <code class="w3-codespan">
<a href="/cssref/pr_background-image.php">background-image</a></code> property and 
position it with the <code class="w3-codespan">
<a href="/cssref/pr_background-position.php">background-position</a></code> property. Also notice that we 
add a 
...
<p>In this example we use the CSS <code class="w3-codespan">
<a href="/cssref/css3_pr_transition.php">transition</a></code> property to animate 
the width of the search input when it gets focus. You will learn more about the <code class="w3-codespan">
<a href="/cssref/css3_pr_transition.php">transition</a></code> property later, in our <a href="css3_transitions.asp">CSS Transitions</a> chapter.</p>
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_form_focus.js"></div>
<hr>
