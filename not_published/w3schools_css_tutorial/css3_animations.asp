...
@keyframes animated_div {
  ...
  70% {transform: rotate(0deg);left:500px;background:orange;}
...
<a class="w3-left w3-btn" href="css_challenges_css3_transitions.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css3_animations_timing.asp">Next &#10095;</a>
</div>
<hr>
...
<p>To use CSS animation, you must specify some keyframes for the 
animation.</p>
<p>Keyframes hold what styles the element will have at certain times.</p>
<hr>

<h2>CSS animation-name and animation-duration</h2>
<p>The <code class="w3-codespan"><a href="/cssref/css3_pr_animation-name.php">animation-name</a></code> 
property specifies a name for the animation.</p>
<p>The <code class="w3-codespan"><a href="/cssref/css3_pr_animation-duration.php">animation-duration</a></code> 
property defines how long an animation should take to complete. If this property 
is not specified, no animation will occur, because the default value is 0s (0 
seconds).</p>
<hr>

<h2>CSS @keyframes Rule</h2>
<p>When you specify CSS styles inside the <code class="w3-codespan">
<a href="/cssref/atrule_keyframes.php">@keyframes</a></code>
...
<p>The following example binds the &quot;myAnimation&quot; animation to the &lt;div&gt; element. 
...
animation-name: myAnimation;<br>&nbsp;&nbsp;animation-duration: 4s;<br>
}
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_animation1">Try it Yourself &raquo;</a>
</div>
<p>In the example above we have used 
the keywords &quot;from&quot; and &quot;to&quot; in the <code class="w3-codespan">
@keyframes</code>
rule, which represents 0% (start) and 100% (complete).</p>
...
width: 100px;<br>&nbsp; height: 100px;<br>&nbsp;&nbsp;background-color: red;<br>&nbsp;&nbsp;animation-name: 
  myAnimation;<br>&nbsp;&nbsp;animation-duration: 4s;<br>}</div>
...
position: relative;<br>&nbsp;&nbsp;background-color: red;<br>&nbsp;&nbsp;animation-name: 
  myAnimation;<br>&nbsp;&nbsp;animation-duration: 4s;<br>}</div>
...
<hr>
<div id="exercisecontainer" src="xrcise_css3_animations.js"></div>
<hr>
