...
<a class="w3-left w3-btn" href="css_challenges_image_sprites.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_attribute_selectors_advanced.asp">Next &#10095;</a>
</div>
<hr>

<h2>CSS Attribute Selectors</h2>
<p>CSS attribute selectors are used to select and style HTML elements with 
a specific attribute or attribute value, or both.</p>
<p>Attribute selectors are enclosed in square brackets <code class="w3-codespan">[]</code>.&nbsp;</p>
<p>CSS has the following attribute selectors:</p>
<ul>
  <li><code class="w3-codespan">[attribute]</code> 
  - Select elements with the specified attribute</li>
  <li><code class="w3-codespan">[attribute=&quot;value&quot;]</code> 
  - Select elements with a specific attribute and an exact value</li>
  <li><code class="w3-codespan">[attribute~=&quot;value&quot;]</code>
  - Select elements with an attribute value containing a specific word</li>
  <li><code class="w3-codespan">[attribute|=&quot;value&quot;]</code> 
  - Select elements with the specific attribute, whose value can be exactly the 
  value, or start with the value followed by a hyphen (-)</li>
  <li><code class="w3-codespan">[attribute^=&quot;value&quot;]</code> 
  - Select elements whose attribute value starts with 
  a specific value</li>
  <li><code class="w3-codespan">[attribute$=&quot;value&quot;]</code> 
  - Select elements whose attribute 
value ends with a specific value</li>
  <li><code class="w3-codespan">[attribute*=&quot;value&quot;]</code> 
  - Select elements whose attribute value contains a specific value</li>
</ul>
<p><strong>Tip:</strong> The attribute selectors are case-sensitive by default. 
To perform a case-insensitive match, add an <code class="w3-codespan">i</code> 
before the closing bracket. Example: <code class="w3-codespan">[attribute=&quot;value&quot; 
i]</code>.</p>
<hr>

<h2>CSS [attribute] Selector</h2>
<p>The <code class="w3-codespan"><a href="/cssref/sel_attribute.php">[attribute]</a></code> selector is used to select elements with 
the specified 
attribute.</p>
...
<p>The <code class="w3-codespan"><a href="/cssref/sel_attribute_value.php">[attribute=&quot;value&quot;]</a></code> selector is used to select elements with a specific 
attribute with an exact value.</p>
...
<a href="/cssref/sel_attribute_value_contains.php">[attribute~=&quot;value&quot;]</a></code> selector is used to select elements with an attribute 
value containing a specific word.</p>
...
<h2>CSS [attribute|=&quot;value&quot;] Selector</h2>
<p>The <code class="w3-codespan"><a href="/cssref/sel_attribute_value_lang.php">[attribute|=&quot;value&quot;]</a></code> selector 
...
<hr>
<div id="exercisecontainer" src="xrcise_attribute_selectors.js"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_challenges_image_sprites.asp">&#10094; Previous</a>
