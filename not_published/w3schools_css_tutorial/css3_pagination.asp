...
.pagination li a.active, .pagination2 li a.active, .pagination3 li a.active {
...
.pagination2 li a:hover:not(.active), .pagination3 li a:hover:not(.active) {
...
body.darkpagetheme .pagination li a,
body.darkpagetheme .pagination2 li a,
body.darkpagetheme .pagination3 li a {
  color: white;
}
body.darkpagetheme ul.pagination2 li a:hover:not(.active),
body.darkpagetheme ul.pagination3 li a:hover:not(.active) {
  color:#000;
}

body.darkpagetheme .pagination li a.disabled {
  color: darkgray;
}
</style>
</head>
...
<a class="w3-left w3-btn" href="css_challenges_css3_buttons.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css3_pagination_styles.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS Pagination</h2>
<p>Learn how to create a responsive pagination using CSS.</p>
<p>If you have a website with lots of pages, you may want to add some sort of pagination 
on each page.</p>
<p>Pagination is typically a series of links, wrapped in an unordered list (<code class="w3-codespan">&lt;ul&gt;</code>). 
Each link represents an individual page number. In addition there are &quot;previous&quot; and &quot;next&quot; controls:</p>
...
<h3>Example</h3>
  <p>A simple pagination:</p>
<div class="w3-code notranslate cssHigh">
  .pagination {<br>&nbsp; display: flex;<br>&nbsp; justify-content: center;<br>&nbsp; 
  list-style: none; /* remove list bullets */<br>&nbsp; padding: 0px;<br>}<br><br>.pagination li a 
  {<br>&nbsp; display: block; /* let links fill the list item */<br>&nbsp; 
  padding: 8px 12px;<br>&nbsp; text-decoration: none;<br>&nbsp; border: 1px 
  solid gray;<br>&nbsp; color: black; <br>&nbsp; margin: 0 4px;<br>&nbsp; border-radius: 5px; /* add 
  rounded borders */<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_ex_pagination" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<h3>Example Explained</h3>
<p>Style the pagination container with:</p>
<ul>
  <li><code class="w3-codespan">display: flex;</code> to arrange the page numbers horizontally</li>
  <li><code class="w3-codespan">justify-content: center;</code> to center align them</li>
  <li><code class="w3-codespan">list-style: none;</code> to remove the list 
  bullets</li>
</ul>
<p>The style the <code class="w3-codespan">&lt;a&gt;</code> elements within the
<code class="w3-codespan">&lt;li&gt;</code> elements for the look of the page numbers, 
with properties like <code class="w3-codespan">display</code>,
<code class="w3-codespan">padding</code>, <code class="w3-codespan">
text-decoration</code>, <code class="w3-codespan">border</code>,
<code class="w3-codespan">background-color</code>, <code class="w3-codespan">
color</code>, <code class="w3-codespan">font-size</code>, and
<code class="w3-codespan">border-radius</code>.</p>

<!--stop-->
<hr>
<!--start-->
<h2>Pagination With an Active Class</h2>
<p>Highlight the currently active page with an <code class="w3-codespan">.active</code> class, 
to indicate which page the user is on:</p>
...
<div class="w3-example">
<h3>Example</h3>
  <p>Pagination with an .active class:</p>
<div class="w3-code notranslate cssHigh">
  .pagination li a.active {<br>&nbsp; background-color: #4CAF50;<br>&nbsp; 
  color: white;<br>}</div>
...
<hr>
<h2>Pagination With a Disabled Class</h2>
<p>If the user are currently on the last page, the &quot;Next&quot; button should be 
disabled.</p>
<p>Here, we add a <code class="w3-codespan">.disabled</code> class, 
and sets the <code class="w3-codespan">
<a href="/cssref/pr_text_color.php">color</a></code> , <code class="w3-codespan">
<a href="/cssref/pr_class_cursor.php">cursor</a></code> and <code class="w3-codespan">
<a href="/cssref/css3_pr_pointer-events.php">pointer-events</a></code> 
properties, to make the &quot;Next&quot; button disabled:</p>
...
<div class="w3-example">
<h3>Example</h3>
  <p>Pagination with a .disabled class:</p>
<div class="w3-code notranslate cssHigh">
  .pagination li a.disabled {<br>&nbsp; color: #dddddd;<br>&nbsp; cursor: 
  not-allowed;<br>&nbsp; pointer-events: none;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_ex_pagination_disabled" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>

<h2>Pagination Subpages</h2>
<p>Continue learning about CSS pagination:</p>
<ul>
<li><a href="css3_pagination_styles.asp">Pagination Styles</a> - hover effects, transitions, breadcrumbs</li>
</ul>

<hr>
<div id="exercisecontainer" src="xrcise_css3_pagination.js"></div>
<hr>
