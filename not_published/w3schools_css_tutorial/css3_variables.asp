...
<h1>CSS Variables - var() Function</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="css3_user_interface.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="css3_variables_overriding.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS Variables</h2>
<p>The <code class="w3-codespan"><a href="/cssref/func_var.php">var()</a></code> function is used to insert the value of a 
CSS variable.</p>
...
<hr>
<!--start-->
<h2>CSS Declare a Variable</h2>
<p>CSS variables can have a global or local scope.</p>
<p>Global variables can be accessed through the entire document, while 
local variables can be used only inside the selector where it is declared.</p>
<p>To create a global variable, declare it inside the <code class="w3-codespan"><a href="/cssref/sel_root.asp">:root</a></code>   
selector. The <code class="w3-codespan">:root</code> selector matches the document's root element.</p>
<p>To create a local variable, declare it inside the selector that is going to use it.</p>
<p>A CSS variable name must begin with two dashes (--) and is case sensitive!</p>

<h3>Syntax</h3>
<div class="w3-code w3-border notranslate"><div>
  :root {<br>&nbsp; --primary-bg-color: green; /* global scope */<br>}<br><br>.note {<br>&nbsp; --note-bg: 
  yellow; /* local scope */<br>}</div>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>The CSS var() Function</h2>
<p>The <code class="w3-codespan"><a href="/cssref/func_var.php">var()</a></code> function is used to insert the value of a 
declared CSS variable.</p>
<h3>Syntax</h3>
<div class="w3-code w3-border notranslate"><div>
...
<p>Advantages of using <code class="w3-codespan"><a href="/cssref/func_var.php">var()</a></code> are: </p>
<ul>
  <li>Makes the code easier to maintain (simplifies updates)</li>
  <li>Makes the code easier to read (more understandable)</li>
  <li>Makes it easier to change the color values for the entire page</li>
</ul>
<!--stop-->
<hr>
...
<p>Here, we declare two global variables (--primary-bg-color and --primary-color).</p>
<p>Then, we use the 
<code class="w3-codespan"><a href="/cssref/func_var.php">var()</a></code> function to insert the value of the variables later in the style sheet:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  :root {<br>&nbsp; --primary-bg-color: #1e90ff;<br>&nbsp; --primary-color: 
  #ffffff; <br>}<br><br>body {<br>&nbsp; background-color: 
  var(--primary-bg-color);<br>}<br><br>.container {<br>&nbsp; color: 
  var(--primary-bg-color);<br>&nbsp; background-color: var(--primary-color);<br>&nbsp; 
  padding: 15px;<br>}<br><br>.container h2 {<br>&nbsp; border-bottom: 2px solid 
  var(--primary-bg-color);<br>}<br><br>.container .note {<br>&nbsp; border: 1px 
  solid var(--primary-bg-color);<br>&nbsp; padding: 10px;<br>}   
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_var">Try it Yourself &raquo;</a>
<br>
</div>

<p>To change the look of the page, you just need to change the two variable values:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  :root {<br>&nbsp; --primary-bg-color: #8FBC8F;<br>&nbsp; --primary-color: 
  #FFFAF0; <br>}<br><br>
  body {<br>&nbsp; background-color: var(--primary-bg-color);<br>}<br><br>
  .container {<br>&nbsp; color: var(--primary-bg-color);<br>&nbsp; 
  background-color: var(--primary-color);<br>&nbsp; padding: 15px;<br>}<br><br>
  .container h2 {<br>&nbsp; border-bottom: 2px solid var(--primary-bg-color);<br>
  }<br><br>.container .note {<br>&nbsp; border: 1px solid 
  var(--primary-bg-color);<br>&nbsp; padding: 10px;<br>}   
</div>
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_css3_variables.js"></div>
<hr>
