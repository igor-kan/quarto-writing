...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="css_challenges_website_layout.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_challenges_css3_rounded_corners.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<div class="w3-theme-border" style="border-width:3px;border-style:solid;margin-top:20px;font-size:15px;padding:25px;border-radius:25px;">
  ...
  <p>The CSS <code class="w3-codespan"><a href="/cssref/css3_pr_border-radius.php">border-radius</a></code> property is used to create rounded corners for elements.</p>
</div>
<hr>

<h2>CSS border-radius Property</h2>
<p>The <code class="w3-codespan"><a href="/cssref/css3_pr_border-radius.php">border-radius</a></code> property defines
the radius of an element's corners.</p>
<p>This property can be applied to all elements with a <code class="w3-codespan"><a href="/cssref/pr_background-color.php">
background-color</a></code>, a <code class="w3-codespan"><a href="/cssref/pr_border.php">border</a></code>, 
or a <code class="w3-codespan"><a href="/cssref/pr_background-image.php">background-image</a></code>.</p>

<p>Here are three examples:</p>
<p>1. Rounded corners for an element with a background color:</p>
...
<div class="w3-code notranslate cssHigh">
   #div1 {<br>&nbsp;&nbsp;border-radius: 25px;<br>&nbsp;&nbsp;background-color: #73AD21;<br>&nbsp;&nbsp;padding: 20px; <br>&nbsp;&nbsp;width: 200px;<br>&nbsp;&nbsp;height: 150px; <br>}<br><br>#div2 {<br>&nbsp;&nbsp;border-radius: 25px;<br>&nbsp;&nbsp;border: 2px solid #73AD21;<br>&nbsp;&nbsp;padding: 20px; <br>&nbsp;&nbsp;width: 200px;<br>&nbsp;&nbsp;height: 150px; <br>}<br><br>#div3 {<br>&nbsp;&nbsp;border-radius: 25px;<br>&nbsp;&nbsp;background-image: url(paper.gif);<br>&nbsp;&nbsp;background-position: left top;<br>&nbsp; background-repeat: 
...
<div class="w3-panel ws-note">
 <p><b>Tip:</b> The <code class="w3-codespan">
 <a href="/cssref/css3_pr_border-radius.php">border-radius</a></code> property is actually a shorthand property for the 
<code class="w3-codespan"><a href="/cssref/css3_pr_border-top-left-radius.php">border-top-left-radius</a></code>, <code class="w3-codespan">
 <a href="/cssref/css3_pr_border-top-right-radius.php">border-top-right-radius</a></code>, <code class="w3-codespan">
 <a href="/cssref/css3_pr_border-bottom-right-radius.php">border-bottom-right-radius</a></code> 
and <code class="w3-codespan">
 <a href="/cssref/css3_pr_border-bottom-left-radius.php">border-bottom-left-radius</a></code> properties.</p>
</div>
<!--stop-->
<hr>
...
<p>The <code class="w3-codespan"><a href="/cssref/css3_pr_border-radius.php">border-radius</a></code> property can have from one 
...
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
   #div1 {<br>&nbsp; border-radius: 15px 50px 30px 5px; /* four values */<br>
   &nbsp;background: #04AA6D;<br>&nbsp; 
width: 200px;<br>&nbsp;&nbsp;height: 150px; <br>}<br><br>#div2 {<br>&nbsp;&nbsp;border-radius: 15px 50px 30px; /* 
   three values */<br>
   &nbsp; background: #04AA6D;<br>&nbsp; width: 200px;<br>&nbsp; 
height: 150px; <br>}<br><br>#div3 {<br>&nbsp;&nbsp;border-radius: 15px 50px; /* two values */<br>
&nbsp;&nbsp;background: #04AA6D;<br>&nbsp;&nbsp;width: 200px;<br>
   &nbsp; 
height: 150px; <br>}<br><br>#div4 {<br>&nbsp;&nbsp;border-radius: 15px; /* one value */<br>
   &nbsp; background: #04AA6D;<br>&nbsp; width: 200px;<br>&nbsp;&nbsp;height: 150px; <br>} </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_border-radius2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>CSS Elliptical and Circular Shapes</h2>
<p>To create elliptical corners, you must specify two values for each radius, 
separated by a slash /. The first value defines the horizontal radius, and the 
second value defines the vertical radius.</p>
<p>To create a oval shape (for a rectangular element), or to create a circular 
shape (for a square element) set <code class="w3-codespan"><a href="/cssref/css3_pr_border-radius.php">border-radius</a></code> 
to 50%.&nbsp;</p>
<div class="w3-example">
<h3>Example</h3>
  <p>Create elliptical, oval and circular shapes: </p>
<div class="w3-code notranslate cssHigh">
   #div1 {<br>&nbsp; border-radius: 70px / 30px;<br>&nbsp; 
background: #04AA6D;<br>&nbsp;&nbsp;width: 200px;<br>&nbsp;&nbsp;height: 150px; <br>}<br><br>#div2 {<br>&nbsp;&nbsp;border-radius: 15px / 50px;<br>&nbsp;&nbsp;background: 
   #04AA6D;<br>
   &nbsp;&nbsp;width: 200px;<br>&nbsp;&nbsp;height: 150px; <br>}<br><br>#div3 {<br>
   &nbsp; 
border-radius: 50%;<br>&nbsp; background: #04AA6D;<br>&nbsp;&nbsp;width: 200px;<br>&nbsp;&nbsp;height: 150px;<br>}<br>
   <br>#div4 {<br>border-radius: 50%;<br>background: #04AA6D;<br>width: 200px;<br>
   height: 200px;<br>} </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_border-radius3">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_css3_borders.js"></div>
<hr>
