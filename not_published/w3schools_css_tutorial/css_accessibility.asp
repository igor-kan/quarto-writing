...
<html lang="en-US">
<head>
<title>CSS Accessibility Styling</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">Accessibility Styling</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_challenges_performance.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="css_challenges_accessibility.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS Accessibility Styling</h2>
<p>A website should be designed to ensure good accessibility for all users, including those with disabilities.</p>
<p>CSS accessibility styling is about using good styling technics to improve the visual clarity, navigation, and overall user experience.&nbsp;</p>
<hr>

<h2>CSS Accessibility Styling Technics</h2>
<p>Here are some tips and technics on how to improve the accessibility of your 
web site:</p>

<h3>1. Provide High Color Contrast</h3>
<p>Always use a good color contrast between the text and the background for 
readability. This is especially important for users with visual impairments or 
color blindness.</p>

<div class="w3-example">
  <h3>Good Color Contrast</h3>
  <div class="w3-code notranslate cssHigh">
body {<br>
&nbsp; background-color: #ffffff;<br>
&nbsp; color: #000000;<br>}
  </div>
  <a target="_blank" href="tryit.asp?filename=trycss_high_contrast" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
  <h3>Bad Color Contrast</h3>
  <div class="w3-code notranslate cssHigh">
body {<br>
&nbsp; background-color: #eeeeee;<br>
&nbsp; color: #cccccc;<br>}
  </div>
  <a target="_blank" href="tryit.asp?filename=trycss_poor_contrast" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->

<h3>2. Provide Good Font, Font Size and Line Height</h3>
<p>Always provide a font that is easily readable. In addition, use a proper font 
size and line height. Use relative units (like <code class="w3-codespan">rem</code>) 
for <code class="w3-codespan">font-size</code>, to allow the user to scale the 
text size in the browser settings.</p>

<div class="w3-example">
  <h3>Good Font Example</h3>
  <div class="w3-code notranslate cssHigh">
    body {<br>&nbsp; font-family: Arial, sans-serif;<br>&nbsp; font-size: 1rem;<br>&nbsp; 
    line-height: 1.6;<br>}
  </div>
  <a target="_blank" href="tryit.asp?filename=trycss_good_font" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
  <h3>Bad Font Example</h3>
  <div class="w3-code notranslate cssHigh">
    body {<br>&nbsp; font-family: Georgia, serif;<br>&nbsp; font-size: 12px;<br>&nbsp; 
    font-style: italic;<br>&nbsp; font-variant: small-caps;<br>&nbsp; 
    line-height: 90%;<br>}
  </div>
  <a target="_blank" href="tryit.asp?filename=trycss_bad_font" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h3>3. Have Visible Focus Indicators</h3>
<p>Always use the <code class="w3-codespan"><a href="/cssref/sel_focus.php">:focus</a></code> 
pseudo-class to ensure that interactive elements (like links, buttons, input 
fields) have a clear visual focus style. </p>
<p>Using <code class="w3-codespan">:focus</code> will ensure that keyboard users and screen-readers 
understand which element is currently active.</p>
...
button:focus,
input:focus {<br>
&nbsp; outline: 2px solid orange;<br>
    }
  </div>
  <a target="_blank" href="tryit.asp?filename=trycss_focus_outline" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<hr>
<!--start-->
<h3>4. Avoid Hiding Focus</h3>
<p>Never remove the default focus outlines, without replacing them with another visible focus style.</p>
...
&nbsp; outline: none;<br>}
  ...
  <a target="_blank" href="tryit.asp?filename=trycss_remove_outline" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<hr>
<!--start-->
<h3>5. Use CSS + Semantic HTML</h3>
<p>Use CSS for visual styling, and structure content with semantic HTML elements 
(instead of non-semantic elements, like <code class="w3-codespan">&lt;div&gt;</code> for everything).</p>
...
<h3>6. Respect User Preferences</h3>
<p>The CSS <code class="w3-codespan">prefers-reduced-motion</code> <code class="w3-codespan">
<a href="/cssref/atrule_media.php">@media</a></code> feature lets you check if
   a user has asked to reduce motion, such as animations or transitions. </p>
<p>Some users have motion sensitivity and prefer websites with less animation.
  You can use this media query to turn off, or tone down animations and 
transitions for the users who has activated this setting on their computer:</p>
<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate cssHigh">
...
<h2>Summary</h2>
<ul>
  <li>Provide high color contrast</li>
  <li>Provide easily readable fonts</li>
  <li>Keep focus outlines visible</li>
