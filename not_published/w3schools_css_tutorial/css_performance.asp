...
<h1>CSS <span class="color_h1">Performance Optimization</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_challenges_math_functions.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_challenges_performance.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>Optimizing CSS</h2>
<p>Optimizing CSS makes your website load faster and run more smoothly; which 
also results in a better user experience.</p>
<p>Here are some tips for optimizing CSS:</p>

<h3>1. Use Simple Selectors</h3>
<p>Use simple selectors when possible. Complex selectors increase the parsing 
time.</p>
<div class="w3-example">
  <h3>Bad Example</h3>
  <div class="w3-code notranslate cssHigh">
    body #navlist
ul li a.button:hover {<br>
...
<h3>2. Avoid Universal Selector for Styling</h3>
<p>Avoid the universal selector (*) when not strictly necessary. The universal 
selector (*) affects every element and can slow down page rendering.</p>
...
* {<br>
&nbsp; margin: 0;<br>
&nbsp; padding: 0;<br>&nbsp; font-size: 16px;<br>
}
  </div>
</div>
<hr>
...
<p>Avoid inline styles when not necessary. Inline styles make your HTML heavier and are harder to manage.</p>

<div class="w3-example">
  <h3>Bad Example</h3>
  <div class="w3-code notranslate htmlHigh">
&lt;div style="color: red; font-size: 18px;"&gt;Hello&lt;/div&gt;<br>&lt;p style="color: 
...
<hr>
<!--start-->
<h3>4. Avoid @import</h3>
<p>Avoid using <code class="w3-codespan"><a href="/cssref/atrule_import.php">@import</a></code> for loading 
external CSS, as it delays stylesheet loading.</p>
<p>Add external CSS with the <code class="w3-codespan">&lt;link&gt;</code> tag in the 
head section, so it loads before the page is rendered.</p>
...
<h3>5. Use Shorthand Properties</h3>
<p>Use shorthand properties when possible. It saves space and is faster to parse.</p>
<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate cssHigh">
/* Long version */<br>
...
<h3>6. Cut Down Unnecessary Animations</h3>
<p>A high number of animations and large animations require more processing 
power to handle, which degrades performance. So, remove unnecessary animations.</p>
<hr>

<h3>7. Use Properties that Not Cause Repaint of Animations</h3>
<p>Animation performance relies also on what properties you are animating.</p>
<p>Some properties (like width, height, left, top), trigger a layout 
recalculation when animated, and should be avoided.</p>
<p>If possible, use animation properties that do not cause repaint, like 
transforms, opacity and filter.</p>
<hr>

<h3>8. Combine and Minify CSS</h3>
<p>Use one CSS file when possible, and remove spaces and comments to reduce file size.</p>
...
<h3>9. Cache Your CSS</h3>
<p>Make sure your CSS file is cached by the browser by giving it a long expiration time in your server settings. This reduces how often users need to re-load it.</p>
<hr>
<h2>Summary</h2>
<ul>
