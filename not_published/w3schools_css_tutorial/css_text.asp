...
<h1>CSS <span class="color_h1">Text Color</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_challenges_outline.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_text_align.asp">Next &#10095;</a>
</div>
<hr>

<h2>CSS Text Formatting</h2>
<p>CSS has a lot of properties for styling and formatting text.</p>
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_text" class="ws-btn">Try it Yourself &raquo;</a>
<hr>

<h2>CSS Text Color</h2>
<p>The <code class="w3-codespan"><a href="/cssref/pr_text_color.php">color</a></code> property is used to set the color of the text. 
...
<br>h1 {<br>&nbsp; color: green;<br>}<br><br>h2 {<br>&nbsp; color: red;<br>}</div>
...
<p>In this example, we define both the <code class="w3-codespan">
<a href="/cssref/pr_background-color.php">background-color</a></code> property and the <code class="w3-codespan">
<a href="/cssref/pr_text_color.php">color</a></code> property:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
body {<br>&nbsp; background-color: lightgrey;<br>&nbsp; color: blue;<br>}<br>
<br>h1 {<br>&nbsp; background-color: black;<br>&nbsp; color: white;<br>}<br><br>
  div {<br>&nbsp; background-color: blue;<br>&nbsp; color: white;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_color_bg" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="w3-panel ws-note">
<p><strong>Important:</strong> High contrast is very important for people with 
vision problems. So, always ensure that the contrast  
between the text color and the background color (or background image) is good!</p>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_text.js"></div>
<hr>

<h2>The CSS Text Color Property</h2>
