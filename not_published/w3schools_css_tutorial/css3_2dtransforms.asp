...
<a class="w3-left w3-btn" href="css_challenges_css3_fonts.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css3_2dtransforms_scale.asp">Next &#10095;</a>
</div>
<hr>

<h2>CSS 2D Transforms</h2>
<p>The CSS <code class="w3-codespan"><a href="/cssref/css3_pr_transform.php">transform</a></code> 
property applies a 2D or 3D transformation to an element. This property allows 
you to rotate, scale, move, and skew elements.</p>
...
<h2>CSS 2D Transforms Functions</h2>
<p>With the CSS <code class="w3-codespan">
<a href="/cssref/css3_pr_transform.php">transform</a></code> property you can use 
the following 2D transformation functions:</p>
<ul>
<li><code class="w3-codespan"><a href="/cssref/func_translate.php">translate()</a></code></li>
<li><code class="w3-codespan"><a href="/cssref/func_rotate.php">rotate()</a></code></li>
<li><code class="w3-codespan"><a href="/cssref/func_scalex.php">scaleX()</a></code></li>
<li><code class="w3-codespan"><a href="/cssref/func_scaley.php">scaleY()</a></code></li>
<li><code class="w3-codespan"><a href="/cssref/func_scale.php">scale()</a></code></li>
<li><code class="w3-codespan"><a href="/cssref/func_skewx.php">skewX()</a></code></li>
<li><code class="w3-codespan"><a href="/cssref/func_skewy.php">skewY()</a></code></li>
<li><code class="w3-codespan"><a href="/cssref/func_skew.php">skew()</a></code></li>
<li><code class="w3-codespan"><a href="/cssref/func_matrix.php">matrix()</a></code></li>
</ul>
<hr>

<h2>The CSS translate() Function</h2>
<p>The <code class="w3-codespan"><a href="/cssref/func_translate.php">translate()</a></code> function moves an element from its current position (according 
to the parameters given for the X-axis and the Y-axis).</p>
<p>The following example moves the &lt;div&gt; element 50 pixels to the right, and 100 pixels down from its current position:</p>

<div style="height:140px"><div style="background:white;padding:10px;width:auto;position:absolute;"><img src="transform_translate.gif" alt="Translate"></div></div>
...
<h2>The CSS rotate() Function</h2>
<p>The <code class="w3-codespan"><a href="/cssref/func_rotate.php">rotate()</a></code> function rotates an element clockwise or counter-clockwise according to a given degree.</p>
...
<hr>
<div id="exercisecontainer" src="xrcise_css3_2dtransforms.js"></div>
<hr>
...
<h2>CSS 2D Transform Functions</h2>
<table class="ws-table-all notranslate">
  <tr>
  ...
  <tr>
    <td><a href="/cssref/func_matrix.php">matrix()</a></td>
    <td>Defines a 2D transformation, using a matrix of six values</td>
  </tr>
  <tr>
    <td><a href="/cssref/func_translate.php">translate()</a></td>
    <td>Defines a 2D translation, moving the element along the X- and the Y-axis</td>
  </tr>
<tr>
    <td><a href="/cssref/func_translatex.php">translateX()</a></td>
    <td>Defines a 2D translation, moving the element along the X-axis</td>
  </tr>
  <tr>
    <td><a href="/cssref/func_translatey.php">translateY()</a></td>
    <td>Defines a 2D translation, moving the element along the Y-axis</td>
  </tr>
  <tr>
    <td><a href="/cssref/func_scale.php">scale()</a></td>
    <td>Defines a 2D scale transformation, scaling the elements width and height</td>
  </tr>
  <tr>
   <td><a href="/cssref/func_scalex.php">scaleX()</a></td>
   <td>Defines a 2D scale transformation, scaling the element's width</td>
  </tr>
  <tr>
    <td><a href="/cssref/func_scaley.php">scaleY()</a></td>
    <td>Defines a 2D scale transformation, scaling the element's height</td>
  </tr>
  <tr>
    <td><a href="/cssref/func_rotate.php">rotate()</a></td>
    <td>Defines a 2D rotation, the angle is specified in the parameter</td>
  </tr>
  <tr>
    <td><a href="/cssref/func_skew.php">skew()</a></td>
    <td>Defines a 2D skew transformation along the X- and the Y-axis</td>
  </tr>
  <tr>
    <td><a href="/cssref/func_skewx.php">skewX()</a></td>
    <td>Defines a 2D skew transformation along the X-axis</td>
  </tr>
  <tr>
    <td><a href="/cssref/func_skewy.php">skewY()</a></td>
