...
<a class="w3-left w3-btn" href="css_challenges_link.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_challenges_list.asp">Next &#10095;</a>
</div>
<hr>

<h2>CSS Styling Lists</h2>
<p>In HTML, there are two main types of lists:</p>
<ul>
  <li>&lt;ul&gt; - unordered lists (list items are marked with bullets)</li>
  <li>&lt;ol&gt; - ordered lists (list items are marked with numbers or letters)</li>
</ul>

<p>CSS has the following properties for styling HTML lists:</p>
<ul>
  <li><code class="w3-codespan"><a href="/cssref/pr_list-style-type.php">list-style-type</a></code> 
  - Specifies the type of list-item marker</li>
  <li><code class="w3-codespan"><a href="/cssref/pr_list-style-image.php">list-style-image</a></code> 
  - Specifies an image as the list-item marker</li>
  <li><code class="w3-codespan"><a href="/cssref/pr_list-style-position.php">list-style-position</a></code> 
  - Specifies the position of the list-item markers</li>
  <li><code class="w3-codespan"><a href="/cssref/pr_list-style.php">list-style</a></code> 
  - A shorthand property for the properties above</li>
</ul>
<hr>

<h2>CSS Style List-item Markers</h2>
<p>The CSS <code class="w3-codespan"><a href="/cssref/pr_list-style-type.php">list-style-type</a></code> 
...
<div class="w3-code notranslate cssHigh">
  ...
  {list-style-type: square;}<br><br>ol.d {list-style-type: upper-roman;}<br>ol.e 
  {list-style-type: lower-roman;}<br>ol.f {list-style-type: lower-alpha;}<br>
  ol.g {list-style-type: decimal;}</div>
<a target="_blank" href="tryit.asp?filename=trycss_list-style-type_ex" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p><strong>Note:</strong> Some of the values are for unordered lists, and some for ordered lists.</p>
<hr>

<h2>CSS Replace List-item Marker with an Image</h2>
<p>The CSS <code class="w3-codespan"><a href="/cssref/pr_list-style-image.php">list-style-image</a></code> property is used to replace the list-item marker with an image.</p>
<p><strong>Note:</strong> Always specify a <code class="w3-codespan"><a href="/cssref/pr_list-style-type.php">list-style-type</a></code> property in addition. This property is used if the image for some reason is unavailable.</p>
<div class="w3-example">
<h3>Example</h3>
  <p>Replace the list-item markers with an image:</p>
<div class="w3-code notranslate cssHigh">
ul
{<br>
  &nbsp; list-style-image: url('sqpurple.gif');<br>&nbsp; list-style-type: 
  square;<br>
}</div>
...
<h2>CSS Position the List-item Markers</h2>
<p>The CSS <code class="w3-codespan"><a href="/cssref/pr_list-style-position.php">list-style-position</a></code> 
...
<div class="w3-example">
<h3>Example</h3>
  <p>Position the list-item markers:</p>
<div class="w3-code notranslate cssHigh">
...
<h2>CSS Remove List-Item Markers</h2>
<p>The <code class="w3-codespan">list-style-type:none;</code> property is 
used to remove the list-item markers.</p>
<p><strong>Note:</strong> A list has a default margin 
and padding. To remove this, add <code class="w3-codespan">margin:0</code> and <code class="w3-codespan">padding:0</code> to 
the &lt;ul&gt; or &lt;ol&gt; element:</p>
<div class="w3-example">
<h3>Example</h3>
  <p>Remove the list-item markers:</p>
<div class="w3-code notranslate cssHigh">
ul
{<br>
  &nbsp;
...
<h2>CSS list-style Shorthand Property</h2>
<p>The <code class="w3-codespan"><a href="/cssref/pr_list-style.php">list-style</a></code> property is a shorthand property. It is used to set all the 
list properties in one declaration.</p>

<p>When using the shorthand property, the order of the property values are:</p>
<ul>
  <li><code class="w3-codespan"><a href="/cssref/pr_list-style-type.php">list-style-type</a></code></li>
  <li><code class="w3-codespan"><a href="/cssref/pr_list-style-position.php">list-style-position</a></code></li>
  <li><code class="w3-codespan"><a href="/cssref/pr_list-style-image.php">list-style-image</a></code></li>
</ul>
<p>If one of the property values above is missing, the default value for the missing property will be inserted.</p>
<div class="w3-example">
<h3>Example</h3>
  <p>Use the list-style shorthand property:</p>
<div class="w3-code notranslate cssHigh">
ul
{<br>
  &nbsp;
...
<h2>CSS Styling List With Colors</h2>
<p>We can also style lists with colors, margins and padding, to make them look a little more 
interesting.</p>
...
<div class="w3-example">
<h3>Example</h3>
  <p>Styling lists with colors, margins and padding:</p>
<div class="w3-code notranslate cssHigh">
  ol {<br>&nbsp; background: salmon;<br>&nbsp; padding: 20px;<br>}<br><br>ol li {<br>&nbsp; 
  background: mistyrose;<br>&nbsp; color: darkred;<br>&nbsp; padding: 10px;<br>&nbsp; 
  margin-left: 20px;<br>}<br><br>ul {<br>&nbsp; background: powderblue;<br>&nbsp; padding: 
  20px;<br>}<br>
  <br>ul li {<br>&nbsp; background: mistyrose;<br>&nbsp; color: darkblue;<br>&nbsp; 
  margin: 5px;<br>}</div>
<p>Result:</p>
...
<hr>
<div id="exercisecontainer" src="xrcise_list.js"></div>
<hr>
