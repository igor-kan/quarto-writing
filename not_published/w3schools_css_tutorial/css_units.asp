...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="css_challenges_counters.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="css_units_absolute.asp">Next &#10095;</a>
</div>
<hr>

<h2>CSS Units</h2>
<p>CSS units are used to define the length and size of several properties.</p>
<p>Several CSS properties take &quot;length&quot; values, such as <code class="w3-codespan">font-size</code>,
<code class="w3-codespan">width</code>, <code class="w3-codespan">margin</code>,
<code class="w3-codespan">padding</code>, <code class="w3-codespan">border</code>, etc.</p>
<p>CSS has two types of units:</p>
<ul>
  <li><a href="css_units_absolute.asp">Absolute units</a></li>
  <li><a href="css_units_relative.asp">Relative units</a></li>
</ul>
<hr>
...
<p>Relative units specify a length relative to another length property (like parent 
element, root element, or viewport).</p>
<p>Relative length units scale better between different screen sizes, making them ideal for responsive web design.</p>
<p>The two most used relative units are <code class="w3-codespan">em</code> and <code class="w3-codespan">
rem</code>.</p>
<div class="w3-panel ws-note">
<p><strong>Tip:</strong> The <code class="w3-codespan">em</code> and <code class="w3-codespan">rem</code> units are perfect for creating  
scalable and responsive websites!</p>
</div>
<hr>
