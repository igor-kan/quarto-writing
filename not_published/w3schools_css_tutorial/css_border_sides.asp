...
<h1>CSS <span class="color_h1">Border Sides</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_border_color.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_border_shorthand.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS Border - Individual Sides</h2>
<p>From the examples on the previous pages, you have seen that it is possible to specify a 
...
<ul>
  <li><code class="w3-codespan" class="w3-codespan">
  <a href="/cssref/pr_border-top_style.php">border-top-style</a></code></li>
  <li><code class="w3-codespan" class="w3-codespan">
  <a href="/cssref/pr_border-right_style.php">border-right-style</a></code></li>
  <li><code class="w3-codespan" class="w3-codespan">
  <a href="/cssref/pr_border-bottom_style.php">border-bottom-style</a></code></li>
  <li><code class="w3-codespan" class="w3-codespan">
  <a href="/cssref/pr_border-left_style.php">border-left-style</a></code></li>
</ul>

<p>In the example below we use the four properties above to set the style of 
each border side:</p>
...
<a target="_blank" href="tryit.asp?filename=trycss_border-side" class="w3-btn w3-margin-bottom w3-margin-top">Try it Yourself &raquo;</a>
</div>

<p>We can also use the shorthand <code class="w3-codespan" class="w3-codespan">
<a href="/cssref/pr_border-style.php">border-style</a></code> property to 
achieve the same result.</p>
<p>The example below gives the same result as the example above:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
p {<br>&nbsp;
...
<a target="_blank" href="tryit.asp?filename=trycss_border-side2" class="w3-btn w3-margin-bottom w3-margin-top">Try it Yourself &raquo;</a>
</div>

<p>So, here is how it works:</p>
<p>If the <code class="w3-codespan" class="w3-codespan">
<a href="/cssref/pr_border-style.php">border-style</a></code> property has four values:</p>
<ul>
...
<p>If the <code class="w3-codespan" class="w3-codespan">
<a href="/cssref/pr_border-style.php">border-style</a></code> property has three values:</p>
<ul>
...
<p>If the <code class="w3-codespan" class="w3-codespan">
<a href="/cssref/pr_border-style.php">border-style</a></code> property has two values:</p>
<ul>
...
<p>If the <code class="w3-codespan" class="w3-codespan">
<a href="/cssref/pr_border-style.php">border-style</a></code> property has one value:</p>
<ul>
...
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  /* Four values */<br>p {<br>&nbsp; border-style: dotted solid double dashed; <br>}<br><br>/* Three 
  values */<br>p {<br>&nbsp; border-style: dotted solid double; <br>}<br>
  <br>/* Two values */<br>p {<br>&nbsp; border-style: dotted solid; <br>}<br><br>/* One value */<br>p {<br>&nbsp; border-style: dotted; <br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-side3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="ws-note w3-panel">
<p>The <code class="w3-codespan" class="w3-codespan">
<a href="/cssref/pr_border-style.php">border-style</a></code> property is used in the example above. However, it also works with 
<code class="w3-codespan" class="w3-codespan">
<a href="/cssref/pr_border-width.php">border-width</a></code>  
and <code class="w3-codespan" class="w3-codespan">
<a href="/cssref/pr_border-color.php">border-color</a></code>.</p>
</div>
<!--stop-->
...
<hr>
<div id="exercisecontainer" src="xrcise_border_sides.js"></div>
<hr>
