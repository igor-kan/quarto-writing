...
<h1>CSS <span class="color_h1">display: inline-block</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_challenges_float.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_challenges_inline-block.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>The CSS display: inline-block</h2>
<p>The <code class="w3-codespan"><a href="/cssref/pr_class_display.php">display: inline-block</a></code> 
property combines the features of both inline and block elements.</p>
<p>An element with <code class="w3-codespan">display: inline-block</code> will 
appear on the same line as other inline or inline-block elements. In addition, 
you can set the <code class="w3-codespan"><a href="/cssref/pr_dim_width.php">
width</a></code>, <code class="w3-codespan"><a href="/cssref/pr_dim_height.php">
height</a></code>, <code class="w3-codespan">
<a href="/cssref/pr_margin-top.php">margin-top</a></code>, and <code class="w3-codespan">
<a href="/cssref/pr_margin-bottom.php">margin-bottom</a></code> properties for 
the element (like block elements).</p>
...
<div class="w3-code notranslate cssHigh">
  ...
  padding: 5px;<br>&nbsp; border: 2px solid red; <br>}<br><br>span.b {<br>
  &nbsp; display: 
  inline-block;<br>&nbsp; width: 100px;<br>&nbsp; height: 
  35px;<br>&nbsp; padding: 5px;<br>&nbsp; border: 2px 
  solid red; <br>}<br><br>
  span.c {<br>&nbsp;&nbsp;display: block;<br>&nbsp;&nbsp;width: 
  100px;<br>&nbsp;&nbsp;height: 35px;<br>&nbsp; padding: 5px;<br>&nbsp; 
  border: 2px solid red; <br>}</div>
...
<hr>
<!--start-->
<h2>&nbsp;Create a Horizontal Navigation Menu</h2>
<p>A common use for <code class="w3-codespan">display: inline-block</code> 
is to display list items horizontally instead of vertically. The following 
example creates a horizontal navigation menu:</p>
<div class="w3-example">
  <h3>Example</h3>
  <p>Create a horizontal navigation menu:</p>
<div class="w3-code notranslate cssHigh">
  .nav {<br>&nbsp; background-color: lightgray; <br>&nbsp;&nbsp;list-style-type: none;<br>&nbsp; padding: 0;<br>&nbsp; margin: 0;<br>}<br><br>.nav li {<br>&nbsp;&nbsp;display: inline-block;<br>
  &nbsp; font-size: 18px;<br>&nbsp;&nbsp;padding: 
  15px;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_inline-block_nav" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_inline-block.js"></div>
<hr>
