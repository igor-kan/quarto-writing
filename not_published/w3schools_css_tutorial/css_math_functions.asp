...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="css_challenges_important.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="css_challenges_math_functions.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS Math Functions</h2>
<p>CSS math functions allow mathematical expressions to be used as property values.</p>
<p>In this chapter, we will explain the following math functions:</p>
<ul>
  <li><code class="w3-codespan">calc()</code></li>
  <li><code class="w3-codespan">max()</code></li>
  <li><code class="w3-codespan">min()</code></li>
  <li><code class="w3-codespan">clamp()</code></li>
</ul>
<hr>

<h2>The CSS calc() Function</h2>
<p>The <code class="w3-codespan"><a href="/cssref/func_calc.php">calc()</a></code> function performs a 
mathematical calculation that will be used as the property value.</p>
<p>The <code class="w3-codespan">calc()</code> function supports addition (+), 
subtraction (-), multiplication (*), and division (/), and can combine different 
units, like pixels and percentages.</p>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    ...
    <td>Required. A mathematical expression. The result will be used as the value</td>
  </tr>
</table>
...
<h3>Example</h3>
<p>Use calc() to calculate the width and the height of a &lt;div&gt; element:</p>
<div class="w3-code notranslate cssHigh">
 #div1 {<br>&nbsp; margin: auto;<br>&nbsp; width: calc(100% - 100px);<br>&nbsp; 
  height: calc(30vh + 50px);<br>
...
<hr>
<!--start-->
<h2>The CSS max() Function</h2>
<p>The <code class="w3-codespan">
<a href="/cssref/func_max.php">max()</a></code> function takes a comma-separated list of values, 
and uses the largest value from the list as the property value.</p>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    ...
    <td>Required. A list of comma-separated values</td>
  </tr>
</table>
...
300px:</p>
<div class="w3-code notranslate cssHigh">
 #div1 {<br>&nbsp; height: 100px;<br>&nbsp; width: max(50%, 300px);<br>&nbsp; 
  border: 1px solid black;<br>&nbsp; padding: 10px;<br>}   
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_func_max">Try it Yourself &raquo;</a>
<br>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>The CSS min() Function</h2>
<p>The <code class="w3-codespan"><a href="/cssref/func_min.php">min()</a></code> function 
takes a comma-separated list of values, and uses the smallest value from the 
list as the property value.</p>
...
300px:</p>
<div class="w3-code notranslate cssHigh">
 #div1 {<br>&nbsp; height: 100px;<br>&nbsp; 
  width: min(50%, 300px);<br>&nbsp; border: 1px solid black;<br>&nbsp; padding: 
  10px;<br>}   
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_func_min">Try it Yourself &raquo;</a>
<br>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>The CSS clamp() Function</h2>
<p>The <code class="w3-codespan"><a href="/cssref/func_clamp.php">clamp()</a></code> 
...
depending on the size of the viewport.</p>
<p>The <code class="w3-codespan">clamp()</code> function has three parameters: a minimum value, a preferred 
value, and a maximum value:</p>
<ul>
  <li>If the preferred value is between the min and max value, the preferred value is used</li>
  <li>If the preferred value is smaller than the min value, the min value is used</li>
  <li>If the preferred value is larger than the max value, the max value is used</li>
</ul>
<h3>CSS Syntax</h3>
<div class="w3-code w3-border notranslate"><div>
  clamp(<em>min</em>, <em>preferred</em>, <em>max</em>)</div>
</div>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><em>min</em></td>
    <td>Optional. The smallest allowed value</td>
  </tr>
  <tr>
    <td><em>preferred</em></td>
    <td>Required. The preferred value</td>
  </tr>
  <tr>
    <td><em>max</em></td>
    <td>Optional. The largest allowed value</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>Set the &lt;h2&gt; element's font-size to 5vw, but never smaller than 1.5rem 
or larger than 3rem.</p>
<p>Set the &lt;div&gt; element's font-size to 2.5vw, but never smaller than 
1rem or larger than 2rem. Also set the div container to 50% wide, but never smaller than 200px or wider than 600px:</p>
<div class="w3-code notranslate cssHigh">
  h2 {<br>&nbsp; font-size: clamp(1.5rem, 5vw, 3rem);<br>}<br><br>div {<br>&nbsp; 
  border: 1px solid green;<br>&nbsp; padding: 10px;<br>&nbsp; font-size: clamp(1rem, 2.5vw, 2rem);<br>&nbsp; width: 
  clamp(200px, 50%, 600px);<br>}   
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_func_clamp">Try it Yourself &raquo;</a>
<br>
</div>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_math_functions.js"></div>
<hr>

<h2>CSS Functions Reference</h2>

<div class="ws-note w3-panel">
  <p>For a complete list of all CSS functions, visit our   <a href="/cssref/css_functions.php">CSS Functions Reference</a>.</p>
</div>
