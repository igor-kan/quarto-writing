...
<h1>CSS <span class="color_h1">Grid Gap</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="css_grid_tracks.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="css_grid_align.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS Grid Gaps</h2>
<p>The space between the rows and columns in a grid container are called <em>gaps</em> (or <em>gutters</em>).</p>
<p>The gaps are created between the grid rows and columns, not on the outer 
edges of the grid container.</p>
<img src="grid_gaps.png" style="background-color:white;max-width:100%">
<p>The default size of the gap is 0, which means that there are no spacing 
between grid items.</p>
<p>The size of the gap can be adjusted with the following properties:</p>
<ul>
  <li><code class="w3-codespan">column-gap</code> - Specifies the gap between grid columns</li>
  <li><code class="w3-codespan">row-gap</code> - Specifies the gap between grid rows</li>
  <li><code class="w3-codespan">gap</code> - Shorthand property for <code class="w3-codespan">row-gap</code> and <code class="w3-codespan">column-gap</code> </li>
</ul>
<hr>

<h2>The CSS column-gap Property</h2>
<p>The <code class="w3-codespan"><a href="/cssref/css3_pr_column-gap.php">column-gap</a></code> 
property specifies the gap between the columns in a grid.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Specify a 50 pixels gap between the grid columns:</p>
<div class="w3-code notranslate cssHigh">
.container {<br>&nbsp; 
  display: grid;<br><strong>&nbsp; </strong>column-gap: 50px;<br>}
</div>
<p>Result:</p>
<div class="w3-white notranslate w3-padding">
<div class="grid-container" style="column-gap:50px;">
  <div>1</div>
  <div>2</div>
  <div>3</div>  
  <div>4</div>
...
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss_grid_grid-column-gap">Try it Yourself &raquo;</a></p>
</div>
<!--stop-->
<hr>
...
<hr>
<!--start-->
<h2>The CSS row-gap Property</h2>
<p>The <code class="w3-codespan"><a href="/cssref/css3_pr_row-gap.php">row-gap</a></code> property specifies the gap 
between the rows in a grid.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Specify a 50 pixels gap between the grid rows:</p>
<div class="w3-code notranslate cssHigh">
  .container {<br>&nbsp; 
  display: grid;<br><strong>&nbsp; </strong>row-gap: 50px;<strong><br></strong>}</div>
<p>Result:</p>
<div class="w3-white notranslate w3-padding">
<div class="grid-container" style="row-gap:50px;">
  <div>1</div>
  <div>2</div>
  <div>3</div>  
  <div>4</div>
...
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss_grid_grid-row-gap">Try it Yourself &raquo;</a></p>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>The CSS gap Property</h2>
<p>The <code class="w3-codespan"><a href="/cssref/css3_pr_gap.php">gap</a></code> property is a shorthand property for 
<code class="w3-codespan"><a href="/cssref/css3_pr_row-gap.php">row-gap</a></code> and 
<code class="w3-codespan"><a href="/cssref/css3_pr_column-gap.php">column-gap</a></code>.</p>
<p>If a single value is provided, it applies the same gap to both rows and columns.</p>
<p>If two values are provided, the first value sets the <code class="w3-codespan">row-gap</code>, and the second value sets the 
<code class="w3-codespan">column-gap</code>.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Using one value - Set gap between rows and columns to 50px:</p>
<div class="w3-code notranslate cssHigh">
  .container {<br>&nbsp; 
  display: grid;<br><strong>&nbsp; </strong>gap: 50px;<strong><br></strong>}</div>
<p>Result:</p>
<div class="w3-white notranslate w3-padding">
<div class="grid-container" style="gap:50px;">
  <div>1</div>
  <div>2</div>
  <div>3</div>  
  <div>4</div>
...
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss_grid_grid-gap">Try it Yourself &raquo;</a></p>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Using two values - Set gap between rows to 30px, and gap between columns to 100px:</p>
<div class="w3-code notranslate cssHigh">
  .container {<br>&nbsp; 
  display: grid;<br><strong>&nbsp; </strong>gap: 30px 100px;<strong><br></strong>}</div>
<p>Result:</p>
<div class="w3-white notranslate w3-padding">
<div class="grid-container" style="gap:30px 100px;">
  <div>1</div>
  <div>2</div>
  <div>3</div>  
  <div>4</div>
...
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss_grid_grid-gap2">Try it Yourself &raquo;</a></p>
</div>
<!--stop-->
<hr>

<h2>&nbsp;CSS Grid Gap Properties</h2>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    ...
    <td>Specifies the gap between the grid columns</td>
  </tr>
  <tr>
    <td><a href="/cssref/css3_pr_gap.php">gap</a></td>
    <td>A shorthand property for <em>row-gap</em> and <em>column-gap</em></td>
  </tr>
  <tr>
