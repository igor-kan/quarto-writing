...
<h1>CSS <span class="color_h1">Background Image</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_background.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_background_repeat.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS background-image</h2>
<p>The <code class="w3-codespan"><a href="/cssref/pr_background-image.php">background-image</a></code> property specifies an image to use as the background of an element.</p>
...
<p>This example shows a <strong>bad combination</strong> of text and background image. The text is 
hardly readable:&nbsp;</p>
<div class="w3-code notranslate cssHigh">
...
<a target="_blank" href="tryit.asp?filename=trycss_background-image_p" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_background_image.js"></div>
<hr>
...
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: CSS Background Images</h2>
  <a href="https://youtu.be/FMyU_h8m-0c&list=PLP9IO4UYNF0UCaUSF3XNZ1U9f01E5h5PM" class="ga-featured ga-youtube" target="blank_" >  
    <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
      ...
      <picture id="yt_div">
        <source srcset="images/css_background_images.webp" type="image/webp" />
        <img src="images/css_background_images.png" style="max-width:100%;height:auto;border-radius:6px" alt="Tutorial on YouTube" loading="lazy">
      </picture>
    </div>
  </a>
</div>
