...
<h1>CSS <span class="color_h1">Float Examples</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_float_clear.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_challenges_float.asp">Next &#10095;</a>
</div>
<hr>

<!--start-->
<h2>Create Equal Width Boxes</h2>
<p>With the <code class="w3-codespan"><a href="/cssref/pr_class_float.php">float</a></code> property, it is easy to float boxes of content side by side:</p>
<div class="w3-row-padding w3-center" style="margin:0 -16px;color:#000;">
...
<p>You can easily create three floating boxes side by side. However, when you add something that enlarges the width of each box (e.g. padding or borders), the box 
can break. The <code class="w3-codespan">
<a href="/cssref/css3_pr_box-sizing.php">box-sizing</a></code> property allows us to include the padding and border in the box's total width (and height), making sure that the padding stays inside of the box and that it does not break.</p>
...
<hr>
<!--start-->
<h2>Create Boxes With Equal Heights</h2>
...
This is where CSS Flexbox comes in handy - as it can automatically stretch 
...
<div class="ws-note w3-panel">
<p><strong>Tip:</strong>&nbsp; You can read more about the Flexbox Layout Module in our <a href="css3_flexbox.asp">CSS Flexbox Chapter</a>.</p>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>You can also use <code class="w3-codespan">
<a href="/cssref/pr_class_float.php">float</a></code> with a list of hyperlinks to create a horizontal menu:</p>
<div class="w3-example">
<h3>Example</h3>
