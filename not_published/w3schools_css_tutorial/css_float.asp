...
<a class="w3-left w3-btn" href="css_challenges_overflow.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_float_clear.asp">Next &#10095;</a>
</div>
<hr>

<h2>The CSS float Property</h2>
<p>The <code class="w3-codespan"><a href="/cssref/pr_class_float.php">float</a></code> property specifies how an element should float 
...
<p>The <code class="w3-codespan">float</code> property can have one of the following values:</p>
<ul>
  ...
  <li> <code class="w3-codespan">none</code> - Default. The element does not float 
  and is displayed just where it occurs in the text</li>
  <li> <code class="w3-codespan">inherit</code> - The element inherits the float value of its parent</li>
</ul>
<p><strong>Tip:</strong> The <code class="w3-codespan">float</code> property is often used to wrap text around images!</p>
<hr>

<h2>CSS float: right Example</h2>
<p>The <code class="w3-codespan">float: right</code> value indicates that an 
element should float to the right within its container. </p>
<p>The following example specifies that the image should float to the <strong>right</strong>.</p>
<p><strong>Tip:</strong> If you make the screen smaller, you will see that the text wraps around the image.</p>
...
<h2>CSS float: left Example</h2>
<p>The <code class="w3-codespan">float: left</code> value indicates that an 
element should float to the left within its container. </p>
<p>The following example specifies that the image should float to the <strong>left</strong>:</p>
<div class="w3-clear w3-border w3-padding">
...
<h2>CSS float: none Example</h2>
<p>The <code class="w3-codespan">float: none</code> value is the default value 
for <code class="w3-codespan">float</code>, and the element is displayed just 
where it occurs in its container. </p>
...
<h2>CSS Float Next To Each Other</h2>
<p>HTML &lt;div&gt; elements are block elements, and will start on a new line and 
take up the full width available. However, if we 
use <code class="w3-codespan">float: left</code> we can make the &lt;div&gt; elements 
to float next to each other:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
...
<a target="_blank" href="tryit.asp?filename=trycss_layout_float3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_float.js"></div>
<hr>
