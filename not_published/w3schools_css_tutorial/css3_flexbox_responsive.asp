...
<h1>CSS <span class="color_h1">Responsive Flexbox</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_challenges_flexbox_items.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="css_challenges_flexbox_responsive.asp">Next &#10095;</a>
</div>
<hr>

<h2>Responsive Flexbox</h2>
<p>You learned from the <a href="css3_mediaqueries.asp">CSS Media Queries</a> 
chapter that you can use media queries to create different layouts for different screen sizes and devices.</p>

<p>For example, if you want to create a three-column layout for large screen sizes, and 
a one-column layout for small screen sizes (such as phones), you can change the <code class="w3-codespan"><a href="/cssref/css3_pr_flex-direction.php">flex-direction</a></code> from <code class="w3-codespan">row</code> to <code class="w3-codespan">column</code> 
at a specific breakpoint (600px in the example below):</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  .flex-container {<br>&nbsp; display: flex;<br>&nbsp; flex-direction: row;<br>}<br><br>
  .flex-item {<br>&nbsp; background-color: #f1f1f1;<br>&nbsp; padding: 10px;<br>&nbsp; 
  font-size: 30px;<br>&nbsp; text-align: center;<br>&nbsp; width: 100%;<br>}<br><br>/* 
  Make a one column-layout instead of three-column layout */<br>@media 
  (max-width: 600px) {<br>&nbsp; .flex-container {<br>&nbsp;&nbsp;&nbsp; 
  flex-direction: column;<br>&nbsp; }<br>}</div>
<p>
<a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss3_flexbox_responsive">Try it Yourself &raquo;</a>
</p>
</div>
<p>Another way is to change the percentage of the <code class="w3-codespan">
<a href="/cssref/css3_pr_flex.php">flex</a></code> property of the flex items 
to create different layouts for different screen sizes. Note that we 
also have to include <code class="w3-codespan">flex-wrap: wrap;</code> on the flex container for this example to 
work:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  .flex-container {<br>&nbsp; display: flex;<br>&nbsp; flex-wrap: wrap;<br>}<br><br>.flex-item 
  {<br>&nbsp; background-color: #f1f1f1;<br>&nbsp; padding: 10px;<br>&nbsp; 
  text-align: center; <br>&nbsp; font-size: 30px;<br>&nbsp; flex: 33.3%;<br>}<br><br>/* 
  Make a one 
  column-layout instead of a three-column layout */<br>@media (max-width: 600px) 
  {<br>&nbsp; .flex-item {<br>&nbsp;&nbsp;&nbsp; flex: 100%;<br>&nbsp; }<br>}</div>
<p>
<a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss3_flexbox_responsive2">Try it Yourself &raquo;</a>
</p>
</div>
...
<iframe src="trycss3_flexbox_image_gallery.htm" style="background-color:white;border:6px solid #f1f1f1;width:100%;height:600px;"></iframe>
<a class="ws-btn w3-margin-top" target="_blank" href="tryit.asp?filename=trycss3_flexbox_image_gallery">Try it Yourself &raquo;</a>
<hr>
...
<iframe src="trycss3_flexbox_website.htm" style="border:6px solid #eee;width:100%;height:630px;"></iframe>
<a class="ws-btn w3-margin-top" target="_blank" href="tryit.asp?filename=trycss3_flexbox_website">Try it Yourself &raquo;</a>
<br><br>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_challenges_flexbox_items.asp">&#10094; Previous</a>
