...
<html lang="en-US">
<head>
<title>CSS clear and clearfix Hack</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">clear and Clearfix Hack</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_float.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_float_examples.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>The CSS clear Property</h2>
<p>The <code class="w3-codespan"><a href="/cssref/pr_class_clear.php">clear</a></code> property specifies what 
should happen with the element that is NEXT to a floating element.</p>
<p>The <code class="w3-codespan"><a href="/cssref/pr_class_clear.php">clear</a></code> 
property prevents elements from wrapping around or beside the floated content.</p>
<p>This property can have one of the 
following values:</p>
<ul>
  <li> <code class="w3-codespan">none</code> - Default. Allows elements to float 
  on either side</li>
  <li> <code class="w3-codespan">left</code> - The element is pushed below  
  floated elements on its left side</li>
  <li> <code class="w3-codespan">right</code> - The element is pushed below 
  floated elements, on its right side</li>
  <li> <code class="w3-codespan">both</code> - The element is pushed below floated elements, 
  on both its left and right side</li>
  <li> <code class="w3-codespan">inherit</code> - The element inherits the clear value 
  from its parent</li>
</ul>
<div class="w3-example">
  <h3>Example</h3>
<p>&nbsp;Here, clear: left; pushes div2 down below the floating div1, on its 
left side:</p>
<div class="w3-code notranslate cssHigh">
div1 {<br>&nbsp;&nbsp;float: left;<br>}<br><br>div2 {<br>&nbsp;&nbsp;clear: left;<br>}</div>
...
<hr>
<!--start-->
<h2>The CSS Clearfix Hack</h2>
<p>If a floated element is taller than the containing element, it will "overflow" outside of its container. We can then add a clearfix hack to 
...
<p>The clearfix hack involves the <code class="w3-codespan">
<a href="/cssref/sel_after.php">::after</a></code> pseudo-element, and is used 
to ensure that the parent container properly encloses its floated child 
elements:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
...
<ul>
    <li>.clearfix::after - Targets a pseudo-element that is generated after the 
    content of any element with class=&quot;clearfix&quot;</li>
    <li>content: &quot;&quot; - Ensures the pseudo-element is rendered, even if it has no visible content</li>
    <li>clear: both - This clears both left and right floats, effectively 
    pushing any following content below the floated elements, and forces the 
    parent container to expand to include them</li>
    <li>display: table - This creates a new block formatting context, which helps in containing floats</li>
</ul>
<div class="ws-note w3-panel">
  <p>You will learn more about the <code class="w3-codespan">
<a href="/cssref/sel_after.php">::after</a></code> pseudo-element in a later chapter.</p>
</div>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_float_clear.js"></div>
<hr>
