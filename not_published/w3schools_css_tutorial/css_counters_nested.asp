...
<h1>CSS <span class="color_h1">Nested Counters</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_counters.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="css_challenges_counters.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS Using Two Counters</h2>
<p>You can create multiple counters for different levels of numbering. The following example creates one counter for the page (named "section") and one 
counter for each &lt;h1&gt; element (named "subsection"):</p>
...
<hr>
<!--start-->
<h2>The CSS counters() Function</h2>
<p>The <code class="w3-codespan"><a href="/cssref/func_counters.php">counters()</a></code> 
function returns the current values of the named and nested counters, as a 
string.</p>
<p>Here we use the <code class="w3-codespan">counters()</code> function to 
insert a string between different levels of nested counters:</p>
<div class="w3-example">
  <h3>Example</h3>
<div class="w3-code notranslate cssHigh">
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_counters_nested.js"></div>
<hr>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><a href="/cssref/func_counter.php">counter()</a></td>
    <td>Returns the current value of the named counter</td>
  </tr>
  <tr>
    <td><a href="/cssref/func_counters.php">counters()</a></td>
    <td>Returns the current values of the named and nested counters</td>
  </tr>
</table>
