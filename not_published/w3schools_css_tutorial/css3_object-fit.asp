...
<h1>CSS <span class="color_h1">object-fit Property</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="css_challenges_imageshapes.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="css_challenges_objectfit.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS object-fit Property</h2>
<p>The CSS <code class="w3-codespan"><a href="/cssref/css3_pr_object-fit.php">object-fit</a></code> property is used to specify how an &lt;img&gt; or &lt;video&gt; should 
be resized to fit its container.</p>
<p>This property can take one of the following values:</p>
<ul>
  <li><code class="w3-codespan">fill</code> - This is default. Does not preserve the aspect ratio. The image is resized to fill the container (the image will be stretched or squeezed to fit).</li>
  <li><code class="w3-codespan">cover</code> - Preserves the aspect ratio, and 
  the image fills the container. Cuts overflowing content if needed.</li>
  <li><code class="w3-codespan">contain</code> - Preserves the aspect ratio, and fits the image inside the container, without cutting - leaves empty space if needed.</li>
  <li><code class="w3-codespan">none</code> - The image is not resized.</li>
  <li><code class="w3-codespan">scale-down</code> - the image is scaled down to the smallest version of <code class="w3-codespan">none</code> or <code class="w3-codespan">
contain.</code></li>
</ul>
<!--stop-->
<hr>
...
<p>The <code class="w3-codespan">object-fit: fill;</code> value does not preserve the aspect ratio, and the image is resized to fill the container (the 
image will be stretched or squeezed to fit):</p>
<img src="paris.jpg" alt="Paris" style="width:200px;height:300px;object-fit:fill;border:1px solid black;">
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  .image-container {<br>&nbsp; width: 200px;<br>&nbsp; height: 300px;<br>&nbsp; 
  border: 1px solid black;<br>&nbsp; margin-bottom: 25px;<br>}<br><br>.image-container img {<br>&nbsp; 
  width: 100%;<br>&nbsp; height: 100%;<br>&nbsp; object-fit: fill;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss3_object-fit_fill" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Using object-fit: cover;</h2>
<p>The <code class="w3-codespan">object-fit: cover;</code> value preserves the aspect ratio, and 
the image fills the container. The image will be clipped to fit:</p>
<img src="paris.jpg" alt="Paris" style="width:200px;height:300px;object-fit:cover;border:1px solid black;">
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  .image-container {<br>&nbsp; width: 200px;<br>&nbsp; height: 300px;<br>&nbsp; 
  border: 1px solid black;<br>&nbsp; margin-bottom: 25px;<br>}<br><br>.image-container img {<br>&nbsp; 
  width: 100%;<br>&nbsp; height: 100%;<br>&nbsp; object-fit: cover;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss3_object-fit_cover" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Using object-fit: contain; </h2>
<p>The <code class="w3-codespan">object-fit: contain;</code> value preserves the aspect ratio, and fits the image inside the container, without cutting - will leave empty 
space if needed:</p>
<img src="paris.jpg" alt="Paris" style="width:200px;height:300px;object-fit:contain;border:1px solid black;">
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  .image-container {<br>&nbsp; width: 200px;<br>&nbsp; height: 300px;<br>&nbsp; 
  border: 1px solid black;<br>&nbsp; margin-bottom: 25px;<br>}<br><br>.image-container img {<br>&nbsp; 
  width: 100%;<br>&nbsp; height: 100%;<br>&nbsp; object-fit: contain;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss3_object-fit_contain" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<p>The <code class="w3-codespan">object-fit: none;</code> value does not resize or scale the image:</p>
<img src="paris.jpg" alt="Paris" style="width:200px;height:300px;object-fit:none;border:1px solid black;">
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  .image-container {<br>&nbsp; width: 200px;<br>&nbsp; height: 300px;<br>&nbsp; 
  border: 1px solid black;<br>&nbsp; margin-bottom: 25px;<br>}<br><br>.image-container img {<br>&nbsp; 
  width: 100%;<br>&nbsp; height: 100%;<br>&nbsp; object-fit: none;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss3_object-fit_none" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Using object-fit: scale-down; </h2>
<p>The <code class="w3-codespan">object-fit: scale-down;</code> value scales the image down to the smallest version of <code class="w3-codespan">none</code> or <code class="w3-codespan">
contain</code>:</p>
<img src="paris.jpg" alt="Paris" style="width:200px;height:300px;object-fit:scale-down;border:1px solid black;">
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  .image-container {<br>&nbsp; width: 200px;<br>&nbsp; height: 300px;<br>&nbsp; 
  border: 1px solid black;<br>&nbsp; margin-bottom: 25px;<br>}<br><br>.image-container img {<br>&nbsp; 
  width: 100%;<br>&nbsp; height: 100%;<br>&nbsp; object-fit: scale-down;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss3_object-fit_scale-down" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Another Example</h2>
<p>Here we have two images and we want them to fill the width of 50% of the browser window and 100% of the height of the container.</p>
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_css3_object-fit.js"></div>
<hr>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><a href="/cssref/css3_pr_object-position.php">object-position</a></td>
