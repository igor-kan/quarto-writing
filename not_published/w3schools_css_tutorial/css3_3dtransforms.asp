...
<a class="w3-left w3-btn" href="css_challenges_css3_transforms.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_challenges_css3_3dtransforms.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
...
<h2>CSS 3D Transforms Functions </h2>
<p>With the CSS <code class="w3-codespan"><a href="/cssref/css3_pr_transform.php">transform</a></code> 
property you can use 
the following 3D transformation functions:</p>
<ul>
<li><code class="w3-codespan"><a href="/cssref/func_rotatex.php">rotateX()</a></code></li>
<li><code class="w3-codespan"><a href="/cssref/func_rotatey.php">rotateY()</a></code></li>
<li><code class="w3-codespan"><a href="/cssref/func_rotatez.php">rotateZ()</a></code></li>
</ul>
<!--stop-->
<hr>
<!--start-->
<h2>The CSS rotateX() Function</h2>
<p>The <code class="w3-codespan"><a href="/cssref/func_rotatex.php">rotateX()</a></code> function rotates an element around its X-axis at a given degree:</p>
<div style="height:140px"><div style="background:white;padding:20px;width:auto;position:absolute;"><img src="transform_rotatex.gif" alt="Rotate X" /></div></div>
...
<hr>
<!--start-->
<h2>The CSS rotateY() Function</h2>
<p>The <code class="w3-codespan"><a href="/cssref/func_rotatey.php">rotateY()</a></code> function rotates an element around its Y-axis at a given degree:</p>
<div style="height:140px"><div style="background:white;padding:20px;width:auto;position:absolute;"><img src="transform_rotatey.gif" alt="Rotate Y" /></div></div>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  #myDiv
...
<hr>
<!--start-->
<h2>The CSS rotateZ() Function</h2>
<p>The <code class="w3-codespan"><a href="/cssref/func_rotatez.php">rotateZ()</a></code> function rotates an element around its Z-axis at a given degree:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  #myDiv
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_css3_3dtransforms.js"></div>
<hr>
...
<h2>CSS 3D Transform Functions</h2>
<table class="ws-table-all notranslate">
  <tr>
  ...
  <tr>
    <td><a href="/cssref/func_matrix3d.php">matrix3d()</a></td>
  ...
  <tr>
    <td><a href="/cssref/func_scale3d.php">scale3d()</a></td>
  ...
  <tr>
    <td><a href="/cssref/func_rotate3d.php">rotate3d()</a></td>
    <td>Defines a 3D rotation</td>
  </tr>
  <tr>
    <td><a href="/cssref/func_rotatex.php">rotateX()</a></td>
    <td>Defines a 3D rotation along the X-axis</td>
  </tr>
  <tr>
    <td><a href="/cssref/func_rotatey.php">rotateY()</a></td>
    <td>Defines a 3D rotation along the Y-axis</td>
  </tr>
  <tr>
    <td><a href="/cssref/func_rotatez.php">rotateZ()</a></td>
    <td>Defines a 3D rotation along the Z-axis</td>
  </tr>
  <tr>
    <td><a href="/cssref/func_perspective.php">perspective()</a></td>
