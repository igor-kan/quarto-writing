...
<html lang="en-US">
<head>
<title>CSS The position Property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">The position</span> Property</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="css_challenges_max-width.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="css_positioning_fixed_absolute.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS Positioning</h2>
<p>CSS positioning is about controlling the placement of elements within a web page.</p>
<p>With CSS positioning, you can override the normal document flow.</p>
<hr>

<h2>The CSS position Property</h2>
<p>The <code class="w3-codespan"><a href="/cssref/pr_class_position.php">position</a></code> property specifies the positioning 
type for an element.</p>
<p>This property can have one of the following values: </p>
<ul>
<li><code class="w3-codespan">static</code> - This is default. Element is positioned according to the normal 
document flow</li>
<li><code class="w3-codespan">relative</code> - Element is positioned relative to its normal position in the document flow</li>
<li><code class="w3-codespan">fixed</code> - Element is positioned relative to the viewport</li>
<li><code class="w3-codespan">absolute</code> - Element is positioned relative to the nearest positioned ancestor</li>
<li><code class="w3-codespan">sticky</code> - Element toggles between a relative and fixed position, depending on the scroll position</li>
</ul>
<p>Elements are then positioned to their final location with the <code class="w3-codespan">
<a href="/cssref/pr_pos_top.php">top</a></code>, <code class="w3-codespan">
<a href="/cssref/pr_pos_bottom.php">bottom</a></code>, <code class="w3-codespan">
<a href="/cssref/pr_pos_left.php">left</a></code>, and <code class="w3-codespan">
<a href="/cssref/pr_pos_right.php">right</a></code> properties.</p>
<!--stop-->
<hr>
<!--start-->
<h2>CSS position: static</h2>
<p>All HTML elements are positioned static by default.</p>
<p>Static positioned elements are not affected by the top, bottom, left, and right properties.</p>
<p>An element with <code class="w3-codespan">position: static;</code> is always positioned according to the normal flow of the page:</p>
...
<p>An element with <code class="w3-codespan">position: relative;</code> is positioned relative to its normal position 
in the document flow.</p>
<p>Setting the top, right, bottom, and left properties will cause
...
This &lt;div&gt; has position: relative, and is skewed 30 px to the right of its normal position</div>
<p>Here is the CSS that is used:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_positioning.js"></div>
<hr>
