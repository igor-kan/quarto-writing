...
<a class="w3-right w3-btn" href="css_align_vertical.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>Horizontal Centering</h2>
<p>There are several ways to horizontally center elements in CSS, depending on the type of element.</p>
<hr>

<h2>Center Align Block Elements</h2>
<p>Use <code class="w3-codespan"><a href="/cssref/pr_margin.php">margin: auto;</a></code>, 
to horizontally center a block-level element (like &lt;div&gt;).</p>
<p>Also specify a <code class="w3-codespan"><a href="/cssref/pr_dim_width.php">
width</a></code> for the element, to prevent it from stretching out to the edges of its container.</p>
<p><b>Note:</b> Center aligning has no effect on block-level elements if the <code class="w3-codespan">width</code> property is not set 
(or set to 100%).</p>
<p>Below, the &lt;div&gt; element is centered and has a width of 50% (and the remaining space 
...
<p>To center the text inside a block-level element, use <code class="w3-codespan">text-align: center;</code>.</p>
...
<hr>
<!--start-->
<h2>Center Align an Image</h2>
<p>To center an image, set <code class="w3-codespan">
<a href="/cssref/pr_margin-left.php">margin-left</a></code> and <code class="w3-codespan">
<a href="/cssref/pr_margin-right.php">margin-right</a></code> to <code class="w3-codespan">auto</code>, and 
also turn the image into a <code class="w3-codespan">block</code> element:</p>
...
<p>Another method for aligning elements is to use <code class="w3-codespan">
<a href="/cssref/pr_class_position.php">position: absolute;</a></code>:</p>
<p><b>Note:</b> Absolute positioned elements are removed from the normal flow, and can overlap 
other elements.</p>

<div style="position:relative;margin-bottom:180px">
  <div style="position:absolute;right:0px;width:300px;border:3px solid green;padding:10px;">
    <p>This &lt;div&gt; element is positioned to the right, with the position: 
    absolute property.</p>
  </div>
</div>
...
<p>Another method for aligning an element to the left or right, is to use the <code class="w3-codespan">
<a href="/cssref/pr_class_float.php">float</a></code> property:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
.right
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_align_horizontal.js"></div>
<hr>
