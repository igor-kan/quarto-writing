...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="css3_variables_javascript.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="css_challenges_css3_variables.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS Variables in Media Queries</h2>
<p>Media Queries are about defining different style rules for different devices (screens, tablets, mobile phones, etc.). You can learn more 
Media Queries in our <a href="css3_mediaqueries.asp">Media Queries Chapter</a>.</p>

<p>Now we want to set one variable value for screens below 450px wide, and 
another variable value for screens above 450px wide.</p>

<p>Here, we first declare a new local variable named --fontsize for the 
<code class="w3-codespan">.container</code> class. We set its value to 20 pixels. Then, we create a 
<code class="w3-codespan"><a href="/cssref/atrule_media.php">@media</a></code> rule that says &quot;When the browser's width 
is 450px or wider, change the --fontsize variable value of the 
<code class="w3-codespan">.container</code> class to 40px.&quot;:</p>
...
<div class="w3-code notranslate cssHigh">
  ...
  var(--primary-bg-color);<br>}<br><br>.container {<br>&nbsp; --fontsize: 20px;<br>&nbsp; 
  color: var(--primary-bg-color);<br>&nbsp; background-color: 
  var(--primary-color);<br>&nbsp; padding: 15px;<br>&nbsp; font-size: 
  var(--fontsize);<br>}<br><br>.container h2 {<br>&nbsp; border-bottom: 2px 
  solid var(--primary-bg-color);<br>}<br><br>@media screen and (min-width: 
  450px) {<br>&nbsp; .container {<br>&nbsp;&nbsp;&nbsp; --fontsize: 40px;<br>&nbsp; 
  }<br>}   
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_var_mq">Try it Yourself &raquo;</a>
<br>
</div>
<!--stop-->
<hr>
...
<hr>
<!--start-->
<p>Here is another example where we also change the value of the --primary-bg-color variable 
in the  
<code class="w3-codespan"><a href="/cssref/atrule_media.php">@media</a></code> rule:</p>
...
<div class="w3-code notranslate cssHigh">
  ...
  var(--primary-color);<br>&nbsp; padding: 15px;<br>&nbsp; font-size: 
  var(--fontsize);<br>}<br><br>.container h2 {<br>&nbsp; border-bottom: 2px 
  solid var(--primary-bg-color);<br>}<br>
  <br>@media screen and (min-width: 450px) {<br>&nbsp; .container {<br>&nbsp;&nbsp;&nbsp; 
  --fontsize: 40px;<br>&nbsp; }<br>&nbsp; :root {<br>&nbsp;&nbsp;&nbsp; 
  --primary-bg-color: lightblue;<br>&nbsp; }<br>}   
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_var_mq2">Try it Yourself &raquo;</a>
<br>
</div>
<!--stop-->
<hr>
