...
<a class="w3-left w3-btn" href="css_challenges_min_max.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_challenges_boxmodel.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
...
calculate the total width and height of an element, you must also include the padding and borders.</p>
</div>

<div class="w3-example">
<h3>Example</h3>

<p>This &lt;div&gt; element will have a total width of 350px and a total height 
of 80px:&nbsp;</p>
<div class="w3-code notranslate cssHigh">
div {<br>
&nbsp; width: 320px;<br>
...
<strong>= 350px (total width)</strong>
<br><br>
&nbsp;&nbsp;50px (height of content area)<br>
+ 20px (top padding + bottom padding)<br>
+ 10px (top border + bottom border)<br>
<strong>= 80px (total height)</strong></div>
...
<div class="w3-panel ws-note">
  <p><b>Note:</b> The margin property also affects the total space that the box 
  will take up on the page, but the margin is not included in the actual size of 
  the box. The box's total width and height stops at the border.</p>
</div>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_boxmodel.js"></div>
<hr>
