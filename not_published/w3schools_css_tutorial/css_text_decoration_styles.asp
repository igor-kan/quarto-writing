...
<html lang="en-US">
<head>
<title>CSS Text Decoration Styles</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">Text Decoration Styles</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_text_decoration.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_text_transformation.asp">Next &#10095;</a>
</div>
<hr>

<h2>Specify a Style for the Decoration Line</h2>
<p>The CSS <code class="w3-codespan">
<a href="/cssref/css3_pr_text-decoration-style.php">text-decoration-style</a></code> property 
sets the style of the decoration line.</p>
<p>This property can have one of the following values:</p>
<ul>
  <li><code class="w3-codespan">solid</code> - Default value. Single line</li>
  <li><code class="w3-codespan">double</code> - Double line</li>
  <li><code class="w3-codespan">dotted</code> - Dotted line</li>
  <li><code class="w3-codespan">dashed</code> - Dashed line</li>
  <li><code class="w3-codespan">wavy</code> - Wavy line</li>
</ul>

<div class="w3-example">
<h3>Example</h3>
  <p>Add different styles for the decoration line:</p>
<div class="w3-code notranslate cssHigh">
  h1 {<br>&nbsp; text-decoration-line: underline;<br>&nbsp; 
  text-decoration-style: solid;<br>}<br><br>h2 {<br>&nbsp; text-decoration-line: underline;<br>&nbsp; 
  text-decoration-style: double; <br>}<br>
  <br>h3 {<br>&nbsp; text-decoration-line: underline;<br>&nbsp; 
  text-decoration-style: dotted; <br>}<br><br>p.ex1 {<br>&nbsp; text-decoration-line: underline;<br>&nbsp; 
  text-decoration-style: dashed; <br>}<br><br>p.ex2 {<br>&nbsp; text-decoration-line: underline;<br>&nbsp; 
  text-decoration-style: wavy; <br>}<br><br>p.ex3 {<br>&nbsp; text-decoration-line: 
  underline;<br>&nbsp; text-decoration-color: red; <br>&nbsp; 
  text-decoration-style: wavy; <br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_text-decoration-style" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<h2>Specify the Thickness for the Decoration Line</h2>
<p>The CSS <code class="w3-codespan">
<a href="/cssref/pr_text_text-decoration-thickness.php">text-decoration-thickness</a></code> property is used to 
set the thickness of the decoration line.</p>

<div class="w3-example">
<h3>Example</h3>
  <p>Add different thickness for the decoration line:</p>
<div class="w3-code notranslate cssHigh">
  h1 {<br>&nbsp; text-decoration-line: underline;<br>&nbsp; 
  text-decoration-thickness: auto;<br>}<br><br>h2 {<br>&nbsp; text-decoration-line: 
  underline;<br>&nbsp; text-decoration-thickness: 5px;<br>}<br><br>h3 {<br>&nbsp; 
  text-decoration-line: underline;<br>&nbsp; text-decoration-thickness: 25%;<br>
  }<br><br>p {<br>&nbsp; 
  text-decoration-line: underline;<br>&nbsp; text-decoration-color: red; <br>&nbsp; 
  text-decoration-style: double;<br>&nbsp; text-decoration-thickness: 5px; <br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_text-decoration-thickness" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>The Shorthand Property</h2>
<p>The CSS <code class="w3-codespan">
<a href="/cssref/pr_text_text-decoration.php">text-decoration</a></code> property is a shorthand 
property for:</p>
<ul>
<li><code class="w3-codespan">
<a href="/cssref/css3_pr_text-decoration-line.php">text-decoration-line</a></code> (required)</li>
<li><code class="w3-codespan">
<a href="/cssref/css3_pr_text-decoration-color.php">text-decoration-color</a></code> (optional)</li>
<li><code class="w3-codespan">
<a href="/cssref/css3_pr_text-decoration-style.php">text-decoration-style</a></code> (optional)</li>
<li><code class="w3-codespan">
<a href="/cssref/pr_text_text-decoration-thickness.php">text-decoration-thickness</a></code> (optional)</li>
</ul>
<div class="w3-example">
  <h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  h1 {<br>&nbsp; text-decoration: underline;<br>}<br><br>h2 {<br>&nbsp; 
  text-decoration: underline red;<br>}<br><br>h3 {<br>&nbsp; text-decoration: underline 
  red double;<br>}<br><br>p {<br>&nbsp; 
  text-decoration: underline red double 5px;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_text-decoration" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>A Small Tip on Links</h2>
<p>All links in HTML are underlined by default. Sometimes you 
see that links are styled with no underline. The <code class="w3-codespan">text-decoration: none;</code> is used to remove 
...
<hr>
<div id="exercisecontainer" src="xrcise_css_text_decoration_styles.js"></div>
<hr>
