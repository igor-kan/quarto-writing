...
<h1>CSS <span class="color_h1">Animation Timing</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css3_animations.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css3_animations_properties.asp">Next &#10095;</a>
</div>
<hr>

<h2>CSS animation-delay Property</h2>
<p>The <code class="w3-codespan"><a href="/cssref/css3_pr_animation-delay.php">animation-delay</a></code> property specifies a delay for the start of an animation.</p>
...
<a href="/cssref/css3_pr_animation-iteration-count.php">animation-iteration-count</a></code> property specifies the number of times an animation should run.</p>
<p>The following example will run the animation 3 times before it stops:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
div {<br>&nbsp;&nbsp;width: 100px;<br>&nbsp;&nbsp;height: 100px;<br>&nbsp;&nbsp;position: relative;<br>&nbsp;&nbsp;background-color: red;<br>&nbsp;&nbsp;animation-name: 
  myAnimation;<br>&nbsp;&nbsp;animation-duration: 4s;<br>&nbsp;&nbsp;animation-iteration-count: 3;<br>}</div>
...
width: 100px;<br>&nbsp; height: 100px;<br>&nbsp; 
position: relative;<br>&nbsp;&nbsp;background-color: red;<br>&nbsp;&nbsp;animation-name: 
  myAnimation;<br>&nbsp;&nbsp;animation-duration: 4s;<br>
...
<p>The <code class="w3-codespan">
<a href="/cssref/css3_pr_animation-timing-function.php">animation-timing-function</a></code> property specifies the speed curve of the 
animation.</p>
...
<hr>
<div id="exercisecontainer" src="xrcise_css3_animations_timing.js"></div>
<hr>
