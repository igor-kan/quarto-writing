...
<h1>CSS <span class="color_h1">Custom Fonts</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_challenges_css3_text_effects.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_challenges_css3_fonts.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>The CSS @font-face Rule</h2>
<p>The CSS <code class="w3-codespan">
<a href="/cssref/atrule_font-face.php">@font-face</a></code> rule allows you to 
define and load custom fonts for use on a webpage.</p>
<p>The font does not have to be installed on the user's computer.</p>
<p>When you have found/bought the font you want to use, just include the font 
file on your web server, and it will be automatically downloaded to the user when needed.</p>
<!--stop-->
<hr>
<!--start-->
<h2>Common Font Formats</h2>
<p>The most widely used font formats are WOFF/WOFF2 for web pages and TTF/OTF 
for desktop.</p>
<h3>WOFF/WOFF2 (Web Open Font Format)</h3>
<p>WOFF/WOFF2 are optimized to reduce file size and are the ideal font format for use in web pages. It was developed in 2009, and is 
now a W3C Recommendation. WOFF/WOFF2 are supported by all major browsers.</p>
<h3>TTF (TrueType Fonts) and OTF (OpenType Fonts)</h3>
<p>TTF was developed in the late 1980s, by Apple. OTF was developed by Apple and Microsoft. 
TTF is the most common font format for both the Mac OS and Microsoft 
Windows operating systems. OTF is built on TTF, as a more advanced, scalable format
that supports rich typesetting features.
Both types are popular because of their accessibility and quality, but they are 
not optimized for web use.</p>
<hr>

<h2>Use Your Custom Font</h2>
<p>In the <code class="w3-codespan"><a href="/cssref/atrule_font-face.php">@font-face</a></code> rule; first 
specify a name for the custom font (e.g. &quot;myFont&quot;) in the font-family 
descriptor, then point to the font file in the src descriptor.</p>
<p>Then, to use the custom font in an HTML element, refer to the name of the font (&quot;myFont&quot;) through the <code class="w3-codespan">
<a href="/cssref/pr_font_font-family.php">font-family</a></code> property:</p>
...
{<br>
  &nbsp;
font-family: myFont; /* set name */<br>
  &nbsp;
src: url(sansation_light.woff); /* url of the font */<br>
}<br>
<br>
  p
{<br>
  &nbsp;
font-family: myFont; /* use font */<br>
}
</div>
...
<hr>
<!--start-->
<h2>Bold Custom Font</h2>
<p>You must add another <code class="w3-codespan">
<a href="/cssref/atrule_font-face.php">@font-face</a></code> rule containing descriptors for bold text:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
@font-face
...
<p>Browsers will use this file whenever a piece of text with the font-family "myFont" should render as bold.</p>
<p><strong>Tip:</strong> This way you can have many <code class="w3-codespan">
<a href="/cssref/atrule_font-face.php">@font-face</a></code> rules for the same font.</p>
<hr>

<h2>CSS @font-face Descriptors</h2>
<p>The following table lists the font descriptors that can be defined inside the <code class="w3-codespan">
<a href="/cssref/atrule_font-face.php">@font-face</a></code> rule:</p>
...
<tr>
   <td>font-weight</td>
   <td>Optional. Defines the weight of the font. Default is &quot;normal&quot;</td>
 </tr>
  <tr>
    <td>font-display</td>
    <td>Optional. Defines how the font loads and displays. Default is &quot;auto&quot;</td>
  </tr>
  <tr>
    <td>unicode-range</td>
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_css3_fonts.js"></div>
<hr>
