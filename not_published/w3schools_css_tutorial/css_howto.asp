...
<h1><span class="color_h1">How To Add CSS</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="css_challenges_selectors.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="css_howto_internal.asp">Next &#10095;</a>
</div>
<hr>
...
<ol>
  <li>External CSS - link to an external .css file</li>
  <li>Internal CSS - use the &lt;style&gt; element in the head section</li>
  <li>Inline CSS - use the style attribute on HTML elements</li>
</ol>
...
<div class="w3-code notranslate htmlHigh">
  ...
  &lt;p&gt;This is a paragraph.&lt;/p&gt;<br><br>&lt;/body&gt;<br>&lt;/html&gt;</div>
...
<div class="w3-panel ws-warning">
  <p><strong>Note:</strong> Do not add a space between the property value (20) and the unit 
  (px):<br>
  Incorrect (space): <code class="w3-codespan">margin-left: 20 px;</code><br>
  Correct (no space): <code class="w3-codespan">margin-left: 20px;</code></p>
</div>
<!--stop-->
<hr>
...
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: How to add CSS to HTML</h2>
  <a href="https://youtu.be/VSwaoQ3TFkQ&list=PLP9IO4UYNF0UCaUSF3XNZ1U9f01E5h5PM" class="ga-featured ga-youtube" target="blank_" >
    <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
      ...
      <picture id="yt_div">
        <source srcset="images/css_howto.webp" type="image/webp" />
        <img src="images/css_howto.png" style="max-width:100%;height:auto;border-radius:6px" alt="Tutorial on YouTube" loading="lazy">
      </picture>
    </div>
  </a>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_howto.js"></div>
<hr>
