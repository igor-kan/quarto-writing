...
<html lang="en-US">
<head>
<title>CSS Study Plan (Lesson Plan)</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">Study Plan</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_syllabus.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_interview_prep.asp">Next &#10095;</a>
</div>
<hr>
...
<p>Save time with pre-built teacher materials and study plans. Easily organize your class with a timeline from the introduction of CSS to the final exam.</p>
<hr>
...
<ul>
  <li><a href="default.asp" target="_blank">W3Schools CSS Tutorial</a></li>
  <li><a href="CSS_exercises.asp" target="_blank">CSS Exercises</a></li>
  <li><a href="CSS_quiz.asp" target="_blank">CSS Quiz</a></li>
  <li>CSS Challenges (Coding challenges)</li>
  <li><a href="CSS_exam.asp" target="_blank">CSS Certification Exam (End of Pathway Exam)</a></li>
</ul>
<hr>

<h2>CSS Syllabus</h2>
<p>With the CSS Syllabus, your students will start with the basics, like styling text and changing colors, and move to more advanced topics, like creating layouts with Flexbox, Grid, and responsive design. Each chapter has examples, try-it-yourself sections, exercises, and quizzes to make learning easy, interactive, and fun.</p>
<p><a title="W3Schools CSS Syllabus" href="CSS_syllabus.asp" target="_blank">Read more about CSS Syllabus</a>.</p>
<hr>
...
<ol>
  ...
  <li style="margin-top:16px">
    ...
    <ul>
      <li>The CSS study plan aligns with the CSS Certification Exam.</li>
      <li>The exam can be taken at the end of the study plan, at your selected date.</li>
      <li>The exam summarizes the CSS Tutorial.</li>
...
<ul>
  <li>Week 1: Introduction, Colors, Backgrounds</li>
  <li>Week 2: Borders, Margins Padding &amp; Directions, Outline, Text</li>
  <li>Week 3: Fonts, Icons, Links, Lists, Tables</li>
  <li>Week 4: Visibility and Layouts, Float, Selectors, Image Sprites, Properties, Navigation Bar Demos, Demos</li>
  <li>Week 5: Advanced, Gradients, Shadows, Variables, Flexbox, Responsive, Grid, CSS Certification Exam</li>
</ul>

<p>Image of Sample CSS study plan:</p>
<a href="css_study_plan.png" target="_blank" title="CSS Study Plan"><img src="CSS_study_plan.png" style="height:auto;max-width:100%;"></a>
<hr>

<h2>Ready to get started?</h2>
<p>Start with <strong> CSS Study Plans</strong> today.</p>
...
<p>Are you interested in learning how you can use <a href="/academy/index.php" target="_blank">W3Schools Academy</a> to Teach CSS programming? </p>
