...
.btn1 {background-color: #04AA6D;} /* Green */
...
.border1 {border-radius:3px;background-color:white;color:black;border:2px solid #04AA6D;}
.border2 {border-radius:3px;background-color:white;color:black;border:2px dotted #008CBA;}
.border3 {border-radius:3px;background-color:white;color:black;border:2px dashed #f44336;}
.border4 {border-radius:3px;background-color:white;color:black;border:2px solid #e7e7e7;}
.border5 {border-radius:3px;background-color:white;color:black;border:1px solid #555555;}

.border111{border-radius:3px;background-color:white;color:black;border: 2px solid #04AA6D;}
.border222{border-radius:3px;background-color:white;color:black;border: 2px solid #008CBA;}
.border333 {border-radius:3px;background-color:white;color:black;border: 2px solid #f44336;}
.border444 {border-radius:3px;background-color:white;color:black;border: 2px solid #e7e7e7;}
.border555 {border-radius:3px;background-color:white;color:black;border: 2px solid #555555;}

.border111:hover {background-color:#04AA6D;color:white;}
.border222:hover {background-color:#008cba;color:white;}
.border333:hover {background-color:#f44336;color:white;}
.border444:hover {background-color:#e7e7e7;color:black;}
.border555:hover {background-color:#555555;color:white;}


.shadow1 {box-shadow:0 8px 16px 0 rgba(0,0,0,0.6)}
.shadow2:hover {box-shadow:0 8px 16px 0 rgba(0,0,0,0.6)}
...
<h1>CSS Styling Buttons</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_challenges_css3_masking.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css3_buttons_hover.asp">Next &#10095;</a>
</div>
<hr>

<h2>CSS Styling Buttons</h2>
<p>With CSS, different HTML buttons can be styled in many ways.</p>
<p>The most common CSS properties for styling buttons are:</p>
<ul>
  <li><code class="w3-codespan"><a href="/cssref/pr_background-color.php">background-color</a></code> - defines the background color of a button</li>
  <li><code class="w3-codespan"><a href="/cssref/pr_text_color.php">color</a></code> - defines the text color of a button</li>
  <li><code class="w3-codespan"><a href="/cssref/pr_border.php">border</a></code> - defines the border of a button</li>
  <li><code class="w3-codespan"><a href="/cssref/pr_padding.php">padding</a></code> - defines the space between the text and the border of a button</li>
  <li><code class="w3-codespan"><a href="/cssref/css3_pr_border-radius.php">border-radius</a></code> - adds rounded corners to a button</li>
  <li><code class="w3-codespan"><a href="/cssref/css3_pr_box-shadow.php">box-shadow</a></code> - adds shadows to a button</li>
  <li><code class="w3-codespan"><a href="/cssref/pr_text_text-align.php">text-align</a></code> - centers the text of a button</li>
  <li><code class="w3-codespan"><a href="/cssref/pr_font_font-size.php">font-size</a></code> - defines the font size of the text on a button</li>
  <li><code class="w3-codespan"><a href="/cssref/pr_text_text-decoration.php">text-decoration</a></code> - removes the underline for &lt;a&gt; elements used as buttons</li>
  <li><code class="w3-codespan"><a href="/cssref/pr_class_cursor.php">cursor</a></code> - 
  changes the mouse cursor when hovering over the button</li>
</ul>
<p>Buttons are typically created with the HTML <code class="w3-codespan">
&lt;button&gt;</code> 
element, the <code class="w3-codespan">&lt;input type=&quot;button&quot;&gt;</code> element, or 
an <code class="w3-codespan">&lt;a&gt;</code> element styled as a button.</p>
<hr>

<h2>CSS Basic Button Styling</h2>
<button>Default Button</button>
<button class="btn">CSS Button</button>
<div class="w3-example">
<h3>Example</h3>
  <p>A basic button styling for different HTML elements:</p>
...
<a target="_blank" href="tryit.asp?filename=trycss_buttons_basic" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>CSS Button Colors</h2>
<p>The CSS <code class="w3-codespan"><a href="/cssref/pr_background-color.php">background-color</a></code> property 
is used to define the background color of a button.</p>
<p>The CSS <code class="w3-codespan"><a href="/cssref/pr_text_color.php">color</a></code> property 
is used to define the text color of a button.</p>
...
<div class="w3-example">
<h3>Example</h3>
  <p>Buttons with different colors:</p>
<div class="w3-code notranslate cssHigh">
.button1 {background-color: #04AA6D;} /* Green */<br>
.button2 {background-color: #008CBA;} /* Blue */<br>
.button3 {background-color: #f44336;} /* Red */ <br>
.button4 {background-color: #e7e7e7; color: black;} /* Gray */<br>
.button5 {background-color: #555555;} /* Black */
</div>
<a target="_blank" href="tryit.asp?filename=trycss_buttons_color" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<h2>CSS Button Sizes</h2>
<p>The CSS <code class="w3-codespan"> <a href="/cssref/pr_font_font-size.php">font-size</a></code> property 
is used to define the font size for the text on a button:</p>
...
<div class="w3-example">
<h3>Example</h3>
  <p>Buttons with different font size:</p>
<div class="w3-code notranslate cssHigh">
.button1 {font-size: 10px;}<br>
.button2 {font-size: 12px;}<br>
.button3 {font-size: 16px;}<br>
.button4 {font-size: 20px;}<br>
.button5 {font-size: 24px;}
</div>
<a target="_blank" href="tryit.asp?filename=trycss_buttons_font" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p>The CSS <code class="w3-codespan"><a href="/cssref/pr_padding.php">padding</a></code> property 
is used to define the space between the text and the border of a button:</p>
...
<div class="w3-example">
<h3>Example</h3>
  <p>Buttons with different padding:</p>
<div class="w3-code notranslate cssHigh">
.button1 {padding: 10px 24px;}<br>
.button2 {padding: 12px 28px;}<br>
.button3 {padding: 14px 40px;}<br>
.button4 {padding: 32px 16px;}<br>
.button5 {padding: 16px;}</div>
<a target="_blank" href="tryit.asp?filename=trycss_buttons_padding" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>CSS Rounded Buttons</h2>
<p>The CSS <code class="w3-codespan"><a href="/cssref/css3_pr_border-radius.php">border-radius</a></code> property 
is used to add rounded corners to a button:</p>
...
<div class="w3-example">
<h3>Example</h3>
  <p>Buttons with different rounded corners:</p>
<div class="w3-code notranslate cssHigh">
.button1 {border-radius: 2px;}<br>
.button2 {border-radius: 4px;}<br>
.button3 {border-radius: 8px;}<br>
.button4 {border-radius: 12px;}<br>
.button5 {border-radius: 50%;}</div>
<a target="_blank" href="tryit.asp?filename=trycss_buttons_round" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>CSS Button Borders</h2>
<p>The CSS <code class="w3-codespan"><a href="/cssref/pr_border.php">border</a></code> property 
is used to define the border of a button:</p>
...
<div class="w3-example">
<h3>Example</h3>
  <p>Buttons with different borders:</p>
<div class="w3-code notranslate cssHigh">
  .button1 {border: 2px solid #04AA6D;}<br>.button2 {border: 2px dotted 
  #008CBA;}<br>.button3 {border: 2px dashed #f44336;}<br>.button4 {border: 1px 
  solid #e7e7e7;}<br>.button5 {border: 1px solid #555555;}</div>
