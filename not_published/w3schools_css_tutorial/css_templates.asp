...
<a class="w3-left w3-btn" href="css_exam.asp">&#10094; Previous</a>
...
<div>
  <div class="w3-col header ws-grey" style="margin-bottom:8px;height:60px;"></div>
  <div class="w3-row">
  <div class="w3-col s4 ws-grey ws-border-right" style="height:170px;"></div>
  <div class="w3-col s4 ws-grey ws-border-right" style="height:170px;"></div>
  <div class="w3-col s4 ws-grey" style="height:170px;"></div>
  </div>
  <div class="w3-col footer ws-grey" style="margin-top:8px;height:31px;"></div>
</div>
      <a target="_blank" href="tryit.asp?filename=trycss_template1_float" class="ws-btn w3-block" style="margin-top:8px">Try it (using float) &raquo;</a>
      <a target="_blank" href="tryit.asp?filename=trycss_template1_flexbox" class="ws-btn w3-block" style="margin-top:8px">Try it (using flexbox) &raquo;</a>
      <a target="_blank" href="tryit.asp?filename=trycss_template1_grid" class="ws-btn w3-block" style="margin-top:8px">Try it (using grid) &raquo;</a>
    </div>
  </div>
...
<div>
  <div class="w3-col header ws-grey" style="margin-bottom:8px;height:60px;"></div>
  <div class="w3-row">
  <div class="w3-col s2 ws-grey ws-border-right" style="height:170px;"></div>
  <div class="w3-col s8 ws-grey ws-border-right" style="height:170px;"></div>
  <div class="w3-col s2 ws-grey" style="height:170px;"></div>
  </div>
  <div class="w3-col footer ws-grey" style="margin-top:8px;height:31px;"></div>
</div>
      <a target="_blank" href="tryit.asp?filename=trycss_template2_float" class="ws-btn w3-block" style="margin-top:8px">Try it (using float) &raquo;</a>
      <a target="_blank" href="tryit.asp?filename=trycss_template2_flexbox" class="ws-btn w3-block" style="margin-top:8px">Try it (using flexbox) &raquo;</a>
      <a target="_blank" href="tryit.asp?filename=trycss_template2_grid" class="ws-btn w3-block" style="margin-top:8px">Try it (using grid) &raquo;</a>
    </div>
  </div>
</div>
...
<div>
  <div class="w3-col header ws-grey" style="margin-bottom:8px;height:31px;"></div>
   <div class="w3-col ws-grey" style="height:200px;"></div>
  <div class="w3-col footer ws-grey" style="margin-top:8px;height:31px;"></div>
</div>
    
      <a target="_blank" href="tryit.asp?filename=trycss_template3" class="ws-btn w3-block" style="margin-top:8px">Try it Yourself &raquo;</a>
    </div>
  </div>
  <div class="w3-col l6">
...
<div>
  <div class="w3-row">
  <div class="w3-col s3 ws-grey ws-border-right" style="height:279px;"></div>
  <div class="w3-col s9 ws-grey" style="height:279px;"></div>
  </div>
</div>
    

      <a target="_blank" href="tryit.asp?filename=trycss_template4" class="ws-btn w3-block" style="margin-top:8px">Try it Yourself &raquo;</a>
    </div>
  </div>
</div>
