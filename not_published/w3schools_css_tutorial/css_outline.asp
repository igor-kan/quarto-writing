...
<a class="w3-left w3-btn" href="css_challenges_boxmodel.asp">&#10094; Previous</a>
...
<div style="width:98%;border:2px solid black;outline:#04AA6D solid 5px;padding:20px;margin:auto;text-align:center">
<p>This element has a black border and a green outline with a width of 5px.</p>
</div>
<br>
<a target="_blank" href="tryit.asp?filename=trycss_outline_intro" class="ws-btn">Try it Yourself &raquo;</a>

<div class="w3-panel ws-note">
<p><b>Note:</b> Outline differs from <a href="css_border.asp">borders</a>! The outline is 
...
<ul>
  <li> <code class="w3-codespan"><a href="/cssref/pr_outline-style.php">outline-style</a></code> - Specifies the style of the outline</li>
  <li> <code class="w3-codespan"><a href="/cssref/pr_outline-color.php">outline-color</a></code> - Specifies the color of the outline</li>
  <li> <code class="w3-codespan"><a href="/cssref/pr_outline-width.php">outline-width</a></code> - Specifies the width of the outline</li>
  <li> <code class="w3-codespan"><a href="/cssref/pr_outline-offset.php">outline-offset</a></code> - Adds space between the outline and the edge/border of an element</li>
  <li> <code class="w3-codespan"><a href="/cssref/pr_outline.php">outline</a></code> - A shorthand property</li>
</ul>
<hr>
...
<h2>CSS The outline-style Property</h2>
<p>The <code class="w3-codespan"><a href="/cssref/pr_outline-style.php">outline-style</a></code> property specifies the style of the outline, 
...
<p>The following example shows the different <code class="w3-codespan">
<a href="/cssref/pr_outline-style.php">outline-style</a></code> values:</p>
...
<p style="outline-style:dotted;outline-color:green;padding:6px">A dotted outline.</p>
<p style="outline-style:dashed;outline-color:green;padding:6px">A dashed outline.</p>
<p style="outline-style:solid;outline-color:green;padding:6px">A solid outline.</p>
<p style="outline-style:double;outline-color:green;padding:6px">A double outline.</p>
<p style="outline-style:groove;outline-color:green;padding:6px">A groove outline. The effect depends on the outline-color value.</p>
<p style="outline-style:ridge;outline-color:green;padding:6px">A ridge outline. The effect depends on the outline-color value.</p>
<p style="outline-style:inset;outline-color:green;padding:6px">An inset outline. The effect depends on the outline-color value.</p>
<p style="outline-style:outset;outline-color:green;padding:6px">An outset outline. The effect depends on the outline-color value.</p>
</div>
...
<div class="w3-panel ws-note">
  ...
  <code class="w3-codespan"><a href="/cssref/pr_outline-style.php">outline-style</a></code> property is set!</p>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_outline.js"></div>
<hr>
