...
<html lang="en-US">
<head>
<title>CSS Centering Images</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">Centering Images</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="css_challenges_imagemodal.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="css_challenges_imagecenter.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>Centering Images</h2>
<p>With CSS, you can center images with several methods.</p>
<p>An image can be centered horizontally, vertically, or both.</p>
<hr>
<h2>Center an Image Horizontally</h2>
<p>To display a horizontally centered image, we can use <code class="w3-codespan">
<a href="/cssref/pr_margin.php">margin: auto;</a></code> or <code class="w3-codespan">
<a href="/cssref/pr_class_display.php">display: flex;</a></code>.</p>
<h3>1. Using margin: auto</h3>
<p>One way to center an image horizontally on a page is to use <code class="w3-codespan">margin: auto</code>.</p>
<p>Since the &lt;img&gt; element is an inline element by default (and <code class="w3-codespan">
margin: auto</code>  does not have any effect on inline elements) we must 
convert the image to a block element, with <code class="w3-codespan">display: block</code>.</p>
<p>In addition, we have to define a <code class="w3-codespan">width</code>. The 
width of the image must be smaller than the width of the page.</p>
<p>Here is a horizontally centered image using <code class="w3-codespan">margin: auto</code>:</p>

<img src="paris.jpg" alt="Paris" style="width:50%;display:block;margin:auto;">
...
<a target="_blank" href="tryit.asp?filename=trycss_image_center1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<h3>2. Using display: flex</h3>
<p>Another way to center an image horizontally on a page is to use  <code class="w3-codespan">display: flex</code>.</p>
<p>Here, we put the &lt;img&gt; element inside a &lt;div&gt; container.</p>
<p>We add the following CSS to the div container:</p>
<ul>
  <li><code class="w3-codespan">display: flex</code></li>
  <li><code class="w3-codespan">justify-content: center</code> (centers the image horizontally in the div container)</li>
</ul>
<p>Then, we set a <code class="w3-codespan">width</code> for the image. The width of the image must be smaller than the width of the page.</p>

<p>Here is a horizontally centered image using  <code class="w3-codespan">display: flex</code>:</p>
...
<div class="w3-code notranslate cssHigh">
  div {<br>&nbsp; display: flex;<br>&nbsp; justify-content: center;<br>}<br><br>
  img {<br>&nbsp; width: 50%;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_image_center3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<p>To display an image that is both vertically and horizontally centered (true 
centering), we can use <code class="w3-codespan">display: flex;</code> or <code class="w3-codespan">display: 
grid;</code>.</p>
<h3>1. Using display: flex</h3>
<p>To display an image that is both vertically and horizontally centered with
<a href="css3_flexbox.asp">flexbox</a>, we use a combination of:&nbsp;</p>
<ul>
  <li><code class="w3-codespan">display: flex;</code></li>
  <li><code class="w3-codespan">justify-content: center;</code> (centers the image horizontally in the container)</li>
  <li><code class="w3-codespan">align-items: center;</code> (centers the image vertically in the container)</li>
  <li><code class="w3-codespan">height: 600px;</code> (the height of the container)</li>
</ul>
<p>Here, we also put the &lt;img&gt; element inside a &lt;div&gt; container.</p>
<p>Then, we set a <code class="w3-codespan">width</code> for the image (must be smaller than the 
width of the container).</p>

<p>Here is a vertically and horizontally centered image with flexbox:</p>
<div style="display:flex;justify-content:center;align-items:center;height:600px;border:1px solid black">
<img src="paris.jpg" alt="Paris" style="width:50%;">
</div>
...
<div class="w3-code notranslate cssHigh">
  div {<br>&nbsp; display: flex;<br>&nbsp; justify-content: center;<br>&nbsp; 
  align-items: center;<br>&nbsp; height: 600px;<br>&nbsp; border: 1px solid 
  black;<br>}<br><br>img {<br>&nbsp;
width: 50%;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_image_center2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<h3>2. Using display: grid</h3>
<p>To display an image that is both vertically and horizontally centered with
<a href="css_grid.asp">grid</a>, we use a combination of:&nbsp;</p>
<ul>
  <li><code class="w3-codespan">display: grid;</code></li>
  <li><code class="w3-codespan">place-items: center;</code> (centers the image horizontally 
  and vertically in the container)</li>
  <li><code class="w3-codespan">height: 600px;</code> (the height of the container)</li>
</ul>
<p>Here, we also put the &lt;img&gt; element inside a &lt;div&gt; container.</p>
<p>Then, we set a <code class="w3-codespan">width</code> for the image (must be smaller than the 
...
<p>Here is a vertically and horizontally centered image with grid:</p>
<div style="display:grid;place-items:center;height:600px;border:1px solid black">
<img src="paris.jpg" alt="Paris" style="width:50%;">
</div>

<div class="w3-example">
<h3>Example</h3>
  <p>True centering using display: grid:</p>
<div class="w3-code notranslate cssHigh">
  div {<br>&nbsp;display: grid;<br>&nbsp; place-items: center;<br>&nbsp; height: 
  600px;<br>&nbsp; border: 1px solid 
  black;<br>}<br><br>img {<br>&nbsp;
width: 50%;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_image_center4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_css3_image_center.js"></div>
<hr>
