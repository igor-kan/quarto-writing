...
<html lang="en-US">
<head>
<title>CSS Pseudo-elements for Text</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">Pseudo-elements</span> for Text</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_pseudo_elements.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_pseudo_elements_content.asp">Next &#10095;</a>
</div>
<hr>

<h2>Pseudo-elements for Text</h2>
<p>Pseudo-elements for text, allow you to style specific parts of text content, such as the first line or first letter.</p>
<hr>

<h2>The CSS ::first-line Pseudo-element</h2>
<p>The <code class="w3-codespan"><a href="/cssref/sel_firstline.php">::first-line</a></code> pseudo-element is used to add a special style 
to the first line of a text.</p>

<p><strong>Note:</strong> The <code class="w3-codespan">
::first-line</code> pseudo-element can only be applied to block-level 
elements.</p>

<div class="w3-example">
<h3>Example</h3>
  <p>Format the first line of text in all &lt;p&gt; 
elements:&nbsp;</p>
<div class="w3-code notranslate cssHigh">
p::first-line 
{<br>
  &nbsp;
color: red;<br>&nbsp; font-variant: small-caps;<br>
  &nbsp;
font-size: 19px;<br>
}</div>
...
<h2>The CSS ::first-letter Pseudo-element</h2>
<p>The <code class="w3-codespan"><a href="/cssref/sel_firstletter.php">::first-letter</a></code> pseudo-element is used to add a special style to the first 
letter of a text.</p>

<p><strong>Note:</strong> The <code class="w3-codespan">
::first-letter</code> pseudo-element can only be applied to block-level 
elements.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Format the first letter of the text in all &lt;p&gt; 
elements:&nbsp;&nbsp;</p>
<div class="w3-code notranslate cssHigh">
p::first-letter 
{<br>
...
<h2>Pseudo-elements and HTML Classes</h2>
<p>Pseudo-elements can easily be combined with HTML classes.&nbsp;</p>
<div class="w3-example">
<h3>Example</h3>
<p>Display the first letter of &lt;p&gt; elements with 
class=&quot;intro&quot;, in red and in a larger size:&nbsp;</p>
<div class="w3-code notranslate cssHigh">
...
<p>In the following example, the first letter of &lt;p&gt; elements will be red and in 
an xx-large font size. The rest of the first line will be blue and in 
small-caps. The rest of the paragraph will be in the default font size and color:</p>
...
<hr>
<div id="exercisecontainer" src="xrcise_pseudo_elements_text.js"></div>
<hr>
