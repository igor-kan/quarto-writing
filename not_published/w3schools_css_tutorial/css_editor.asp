...
body.darktheme .css-selector { color: #f78c6c; }
body.darktheme .css-property { color: #c5a5c5; }
body.darktheme .css-value    { color: #88c999; }
body.darktheme .css-brace    { color: #f1f1f1; }
body.darktheme .css-symbol   { color: #f1f1f1; }
...
<h1>CSS <span class="color_h1">Online Editor</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_examples.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_snippets.asp">Next &#10095;</a>
</div>
<hr>

<h2>CSS Editor</h2>

<p>With our online CSS editor, you can edit HTML, CSS and JavaScript code, and view the result in your browser.</p>
...
<div class="compiler-wrapper">
  ...
  <div class="compiler-body">
    ...
    <div class="editor">
<pre>
<span class="css-selector">body</span> <span class="css-brace">{</span>
  <span class="css-property">background-color</span><span class="css-symbol">:</span> <span class="css-value">lightblue</span><span class="css-symbol">;</span>
<span class="css-brace">}</span>

<span class="css-selector">h1</span> <span class="css-brace">{</span>
  <span class="css-property">color</span><span class="css-symbol">:</span> <span class="css-value">white</span><span class="css-symbol">;</span>
  <span class="css-property">text-align</span><span class="css-symbol">:</span> <span class="css-value">center</span><span class="css-symbol">;</span>
<span class="css-brace">}</span>

<span class="css-selector">p</span> <span class="css-brace">{</span>
  <span class="css-property">font-family</span><span class="css-symbol">:</span> <span class="css-value">verdana</span><span class="css-symbol">;</span>
<span class="css-brace">}</span>
</pre>
    </div>

    <div class="output">
      <h1 class="w3-serif" style="font-weight:bold;text-align:center;color:white">My First CSS Example</h1>
      <p style="font-family:verdana;font-size:20px;color:black">This is a paragraph.</p>
    </div>

  </div>

  <div class="compiler-footer">
    <a href="tryit.asp?filename=trycss_editor"
       target="_blank"
       class="ws-btn">
...
<h2>Build and Publish Websites</h2>

<p>If you want to save your HTML, CSS and JavaScript code, and create your own website, <a href="/spaces/index.php">W3Schools Spaces</a> gives you an easy place to write, run, manage, and publish code online.</p>
