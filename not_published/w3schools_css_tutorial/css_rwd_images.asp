...
<a class="w3-left w3-btn" href="css_challenges_rwd_mediaqueries.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_challenges_rwd_images.asp">Next &#10095;</a>
</div>
<hr>
<div style="text-align:center;">
<img src="img_chania.jpg" style="max-width:100%;height:auto;">
<p>Resize the browser window to see how the image scales to fit the page.</p>
</div>
<hr>
<h2>Using The width Property</h2>

<p>If the <code class="w3-codespan"><a href="/cssref/pr_dim_width.php">width</a></code> property is set to a percentage 
and the <code class="w3-codespan"><a href="/cssref/pr_dim_height.php">height</a></code> property is set to &quot;auto&quot;, the image will be 
...
<code class="w3-codespan"><a href="/cssref/pr_dim_max-width.php">max-width</a></code> property instead.</p>
<hr>
<h2>Using The max-width Property</h2>
<p>If the 
<code class="w3-codespan"><a href="/cssref/pr_dim_max-width.php">max-width</a></code> property is set to 100%, the image will scale down if it has to, but never scale up to be larger than its 
original size:</p>
...
<p>1. Using <code class="w3-codespan">background-size: contain;</code>: The background 
image will scale up and down, and tries to fit the content area. However, the image will keep its aspect ratio (the proportional relationship 
...
<div class="w3-example">
<h3>Example</h3>
<p>Using <code class="w3-codespan">background-size: contain;</code>:</p>
<div class="w3-code notranslate cssHigh">
div {<br>&nbsp; width: 100%;<br>&nbsp; height: 400px;<br>&nbsp; 
background-image: url('img_flowers.jpg');<br>&nbsp;&nbsp;background-repeat: no-repeat;<br>&nbsp;&nbsp;background-size: contain;<br>&nbsp;&nbsp;border: 1px solid 
  black;<br>}</div>
...
<p>2. Using <code class="w3-codespan">background-size: 100% 100%;</code>: The background image will stretch to cover the entire content area:</p>

<div class="bg2"></div>

<div class="w3-example">
<h3>Example</h3>
<p>Using <code class="w3-codespan">background-size: 100% 100%;</code>:</p>
<div class="w3-code notranslate cssHigh">
div {<br>&nbsp; width: 100%;<br>&nbsp; height: 400px;<br>&nbsp; 
background-image: url('img_flowers.jpg');<br>&nbsp; 
background-size: 100% 100%;<br>&nbsp; border: 1px solid black;<br>}</div>
...
<p>3. Using <code class="w3-codespan">background-size: cover;</code>: The background image will scale to cover the entire content area. Notice that the &quot;cover&quot; value keeps the aspect 
ratio, and some part of the background image may be clipped:</p>

<div class="bg3"></div>

<div class="w3-example">
<h3>Example</h3>
  <p>Using <code class="w3-codespan">background-size: cover;</code>:</p>

<div class="w3-code notranslate cssHigh">
div {<br>&nbsp;&nbsp;width: 100%;<br>&nbsp; height: 400px;<br>&nbsp; 
background-image: url('img_flowers.jpg');<br>&nbsp;&nbsp;background-size: cover;<br>&nbsp;&nbsp;border: 1px solid 
  black;<br>}</div>
...
<p>The HTML <code class="w3-codespan">&lt;picture&gt;</code> element gives web 
developers more flexibility in specifying image resources.</p>
<p>The most common use of the <code class="w3-codespan">&lt;picture&gt;</code> 
...
be designed to more nicely fill the browser viewport.</p>
...
<a href="/cssref/atrule_media.php">CSS @media rule</a>.</p>
...
<hr>
<div id="exercisecontainer" src="xrcise_rwd_images.js"></div>
<hr>
