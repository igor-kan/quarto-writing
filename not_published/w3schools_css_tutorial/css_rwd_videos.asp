...
<a class="w3-left w3-btn" href="css_challenges_rwd_images.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_challenges_rwd_videos.asp">Next &#10095;</a>
</div>
<hr>
<h2>Using The width Property</h2>

<p>If the <code class="w3-codespan"><a href="/cssref/pr_dim_width.php">width</a></code> property is set to 100%, the video player will be 
...
<p>If the 
<code class="w3-codespan"><a href="/cssref/pr_dim_max-width.php">max-width</a></code> property is set to 100%, the video player will scale down if it has to, but never scale up to be larger than its 
original size:</p>
...
<hr>
<div id="exercisecontainer" src="xrcise_rwd_videos.js"></div>
<hr>
