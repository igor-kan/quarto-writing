...
<h1>CSS <span class="color_h1">Margin Collapse</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_margin.asp">&#10094; Previous</a>
<a class="w3-right w3-btn"  href="css_challenges_margin.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS Margin Collapse</h2>
<p>Margin collapse is when two margins collapse into a single margin.</p>
...
<p><strong>Note:</strong> Margin collapse only happens with top and bottom 
margins! Not left and right margins!</p>
<p>In the following example, the &lt;h1&gt; element has a bottom margin of 50px and 
the &lt;h2&gt; element has a top margin of 20px. So, the vertical margin between the 
...
h1 {<br>&nbsp;&nbsp;margin-bottom: 50px;<br>}<br><br>h2 {<br>&nbsp;&nbsp;margin-top: 20px;<br>}</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_margin_collapse" target="_blank">Try it Yourself &raquo;</a>
</div>

<p>In the following example, each &lt;p&gt; element has a top margin of 30px and a 
bottom margin of 30px. So, the vertical margin between the &lt;p&gt; elements should 
have been 60px (30px + 30px). However, due to margin collapse, the actual margin 
ends up being 30px:</p>

<div class="w3-example">
<h3>Example</h3>
  <p>Demonstration of margin collapse: </p>
<div class="w3-code notranslate cssHigh">
  p {<br>&nbsp; margin-top: 30px;<br>&nbsp; margin-bottom: 30px; <br>}</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_margin_collapse2" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<hr>
<div id="exercisecontainer" src="xrcise_margin_collapse.js"></div>
<hr>
