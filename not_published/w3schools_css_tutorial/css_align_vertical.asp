...
<h1>CSS <span class="color_h1">Vertical Align</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_align_horizontal.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_challenges_align.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>Vertical Centering</h2>
<p>Vertical centering in CSS can be achieved using modern layout techniques like Flexbox and Grid, or using positioning with transforms.</p>
<hr>

<h2>Center Align with Flexbox</h2>
<p>With <a href="css3_flexbox.asp">CSS flexbox</a> you can center elements, both horizontally and vertically, within a flex container.</p>
<p>A flex container with both the <code class="w3-codespan"><a href="/cssref/css3_pr_justify-content.php">justify-content</a></code> and the
<code class="w3-codespan"><a href="/cssref/css3_pr_align-items.php">align-items</a></code> properties set to 
<code class="w3-codespan">center</code> will align the item(s) in the center (in both axis):</p>
...
<div class="w3-code notranslate cssHigh">
  ...
  green; <br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss3_align_flex" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<hr>
<!--start-->
<h2>Center Align with Grid</h2>
<p>With <a href="css_grid.asp">CSS grid</a> you can center elements, both horizontally and vertically, within a grid container.</p>
<p>A grid container with the <code class="w3-codespan"><a href="/cssref/css_pr_place-items.php">place-items</a></code> property set to center, will align the item(s) in the center (in both axis).</p>
<div style="display: grid;place-items: center;height: 200px;border: 3px solid green;">
I am vertically and horizontally centered.
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  .center {<br>&nbsp; display: grid;<br>&nbsp; place-items: center;<br>&nbsp; height: 200px;<br>&nbsp; border: 3px solid 
  green; <br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss3_align_grid" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Center Align with position and transform</h2>
<p>If you deal with elements of unknown or dynamic dimensions, it is a common 
technique to use <code class="w3-codespan">position: 
absolute;</code> combined with <code class="w3-codespan">transform: translate();</code> 
to center an element:</p>

<div style="height:200px;position:relative;border:3px solid green;">
  <p style="margin:0;position:absolute;top:50%;left:50%;transform:translate(-50%, -50%);">I am vertically and horizontally centered.</p>
</div>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
.container p {<br>&nbsp;&nbsp;margin: 0;<br>&nbsp; 
...
Chapter</a>.</p>
<hr>
<div id="exercisecontainer" src="xrcise_align_vertical.js"></div>
<hr>
