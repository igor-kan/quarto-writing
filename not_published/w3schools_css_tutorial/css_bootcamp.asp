...
<html lang="en-US">
<head>
<title>W3Schools CSS Bootcamp</title>
<meta charset="utf-8">
...
<h1>W3Schools <span class="color_h1">CSS Bootcamp</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_interview_prep.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="/cssref/index.php">Next &#10095;</a>
</div>
<hr>
<div class="ws-light-green caption w3-round" style="padding-top:50px;padding-bottom:50px;position:relative;">
  <div style="max-width:1300px;margin:auto">
    <h1 class="bctop">HTML & CSS Bootcamp</h1>
    ...
    <h4 style="margin-top:15px;"><strong>Duration</strong>: 3 Weeks.</h4>

    <p style="margin-top:8px;"><a title="Learn More" target="_blank" href="/bootcamp/html-css.php" style="width:200px;font-size:20px;border-radius:25px;font-weight:600;padding:8px 16px;margin-right:5px;margin-top:16px;" class="ws-btn w3-mobile applynowbtn ga-featured">Learn More</a></p>
...
<div class="caption" style="padding-left:0;padding-right:0;font-family: 'Source Sans Pro', sans-serif;">
  ...
  <div style="max-width:950px">
    <p>In this bootcamp, you will learn the foundational skills needed to create beautiful and functional websites, from writing HTML markup to styling your pages with CSS.</p>
    <p>You will learn HTML and CSS over a 3 weeks period together with a <strong>live instructor</strong> and an interactive cohort of engaged learners!</p>

    <h5 style="font-size:30px;font-weight:bold;">You Will Learn</h5>

    <ul style="font-size:16px;">
      <li>HTML and CSS fundamentals including Elements, Attributes, Tables, Forms and more.</li> 
      <li>How to write best fit Semantic HTML</li>
      <li>How to create your first functional website utilising HTML & CSS standards</li>
      <li>How to structure websites logically and ensure they are correctly formatted for accessibility</li>
      <li>The basics of website design and styling using CSS for layout, positioning, grid and responsive design</li>
      <li>CSS Flexbox for positioning and layout</li>
      <li>How to implement functional forms, lists, tables and media on a website</li>
      <li>How to control the style and layout of multiple web pages all at once</li>
      <li>How to change the appearance and layout of all the pages in a Web site</li>
    </ul>
...
<div style="background-color:#F3ECEA;padding-top:30px;color:black" class="w3-round">
  ...
  <p style="margin-top:8px;text-align:center;padding-bottom:45px;"><a title="Learn More" target="_blank" href="/bootcamp/html-css.php" style="width:200px;font-size:20px;border-radius:25px;font-weight:600;padding:6px 6px;" class="ws-btn ga-featured">Learn More</a></p>
</div>
  ...
  <div style="max-width:1350px;margin:auto;padding-left:24px;padding-right:24px;">
    ...
    <div style="text-align:left;font-family: 'Source Sans Pro', sans-serif;">
      ...
      <h4 style='font-size:18px;margin-bottom:20px'><strong>2. Complete the Bootcamp</strong>:<br>
        ...
        <br><br>By the end of this bootcamp you will learn HTML and CSS. The curriculum used is the <a target="_blank" href="https://www.w3schools.com/html/default.asp">W3Schools HTML Tutorial</a> and <a target="_blank" href="https://www.w3schools.com/css/default.asp">W3Schools CSS Tutorial</a>. The bootcamp will help you prepare for the W3Schools HTML and CSS exam so that you can document and validate your competence by getting certified.
      ...
      <h4 style='font-size:18px;'><strong>3. Certification and Job Application</strong>:<br>
        Upon completing the bootcamp, you will have passed the W3Schools HTML and CSS exams and obtained the
        <strong>Certified HTML Developer</strong> and <strong>Certified CSS Developer</strong> titles and an extra acknowledgement that you were a part of the bootcamp on the certification. This certification demonstrates that you know HTML and CSS.
      </h4>
      <p><a title="Learn More" target="_blank" href="/bootcamp/html-css.php" style="margin-top:15px;width:200px;font-size:20px;border-radius:25px;font-weight:600;padding:6px 6px;" class="ws-btn w3-mobile applynowbtn ga-featured">Learn More</a></p>
    </div>
  </div>
</div>
<br><hr>
