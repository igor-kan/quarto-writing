...
<h1>CSS <span class="color_h1">Outline Width</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_outline.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_outline_color.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS Outline Width</h2>
<p>The <code class="w3-codespan"><a href="/cssref/pr_outline-width.php">outline-width</a></code> property specifies the width of the outline, 
and can have one of the following values:</p>
<ul>
  <li><code class="w3-codespan">thin</code> (typically 1px)</li>
  <li><code class="w3-codespan">medium</code> (typically 3px)</li>
  <li><code class="w3-codespan">thick</code> (typically 5px)</li>
  <li>A specific size (in px, pt, cm, em, etc)</li>
</ul>

<h2>CSS Outline Width Examples</h2>
<p>Here are some outlines with different widths:</p>
<p style="outline-style:solid;outline-color:green;outline-width:thin;padding:6px;">A thin outline.</p>
<p style="outline-style:solid;outline-color:green;outline-width:medium;padding:6px;">A medium outline.</p>
<p style="outline-style:solid;outline-color:green;outline-width:thick;padding:6px;">A thick outline.</p>
<p style="outline-style:solid;outline-color:green;outline-width:8px;padding:6px;">A 
8px thick outline.</p>

<div class="w3-example">
<h3>Example</h3>
  <p>&nbsp;Demonstration of different outline widths:</p>
<div class="w3-code notranslate cssHigh">
  p {<br>&nbsp; padding: 5px;<br>&nbsp; 
  outline-style: solid;<br>&nbsp; outline-color: green;<br>}<br><br>p.ex1 {<br>&nbsp; outline-width: thin;<br>}<br><br>
  p.ex2 {<br>&nbsp; outline-width: medium;<br>}<br><br>p.ex3 {<br>&nbsp; outline-width: 
  thick;<br>}<br><br>p.ex4 {<br>&nbsp; outline-width: 8px;<br>} </div>
...
<hr>
<div id="exercisecontainer" src="xrcise_outline_width.js"></div>
<!--stop-->
<hr>
