...
<h1>CSS <span class="color_h1">Text Transformation</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_text_decoration_styles.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_text_spacing.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS Text Transformation</h2>
<p>The CSS <code class="w3-codespan">
<a href="/cssref/pr_text_text-transform.php">text-transform</a></code> property is used to 
control the capitalization of text in an element.</p>
<p>It can be used to transform a text into uppercase or lowercase letters, or 
...
<ul>
  <li><code class="w3-codespan">none</code> - No transformation. Text renders as it is</li>
  <li><code class="w3-codespan">capitalize</code> - Transforms the first character of each word to uppercase</li>
  <li><code class="w3-codespan">uppercase</code> - Transforms all characters to uppercase</li>
  <li><code class="w3-codespan">lowercase</code> - Transforms all characters to lowercase</li>
</ul>
<div class="w3-example">
<h3>Example</h3>
  <p>Demonstration of the text-transform property:</p>
...
<hr>
<div id="exercisecontainer" src="xrcise_text_transformation.js"></div>
<hr>
<h2>The CSS Text Transformation Property</h2>
