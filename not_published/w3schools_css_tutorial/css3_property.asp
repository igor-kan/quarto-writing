...
<html lang="en-US">
<head>
<title>CSS - The @property Rule</title>
<meta charset="utf-8">
...
<h1>CSS @property Rule</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="css_challenges_css3_variables.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="css_challenges_css3_property.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>The CSS @property Rule</h2>
<p>The <code class="w3-codespan"><a href="/cssref/atrule_property.php">@property</a></code> rule is used to define custom 
CSS properties (CSS variables) directly in the stylesheet without having to run any 
JavaScript.</p>
<p>The <code class="w3-codespan">@property</code> rule has data type checking 
and constraining, sets a default value, and specifies the inherit behaviour.</p>

<p>The definition below creates a custom property named --myColor, defines it as a color property, 
specifies that it will inherit values from its parent elements, and its default value is lightgray.</p>

<h3>Syntax of @property</h3>
<div class="w3-code w3-border notranslate">
  @property --myColor {<br>&nbsp; syntax: &quot;&lt;color&gt;&quot;;<br>&nbsp; inherits: true;<br>&nbsp; 
  initial-value: lightgray;<br>}
</div>

<h3>Using the Custom Property</h3>
<p>The CSS <code class="w3-codespan">
<a href="/cssref/func_var.php">var()</a></code>  
function is used to insert the custom property in CSS:</p>
<div class="w3-code w3-border notranslate">
  body {<br>&nbsp; background-color: var(--myColor);<br>}
</div>
<hr>

<h2>Benefits of Using @property</h2>
<p>The benefits of using <code class="w3-codespan">
<a href="/cssref/atrule_property.php">@property</a></code> is:</p>
<ul>
  <li><strong>Data type checking:</strong> You must specify the data type of the 
  custom property, such as &lt;number&gt;, &lt;color&gt;, &lt;length&gt;, etc. This prevents 
  errors and ensures that custom properties are used correctly</li>
  <li><strong>Set default value:</strong> You must set a default value for the custom property. 
  This ensures that if an invalid value is assigned later, the browser uses the 
  default value as a fallback</li>
  <li><strong>Set inheritance behavior:</strong> You must specify whether the 
  custom property will inherit values from its parent elements or not. This 
  ensures that you will have full control over inheritance</li>
</ul>
<!--stop-->
<hr>
<!--start-->
<h2>CSS @property Example</h2>
<p>The following example defines two custom properties: my-bg-color and 
my-txt-color.</p>
<p>The div, then uses the custom properties in the <code class="w3-codespan">
<a href="/cssref/pr_background-color.php">background-color</a></code> and
<code class="w3-codespan">
<a href="/cssref/pr_text_color.php">color</a></code> properties:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  @property --my-bg-color {<br>&nbsp; syntax: &quot;&lt;color&gt;&quot;;<br>&nbsp; inherits: 
  true;<br>&nbsp; initial-value: lightgray;<br>}<br><br>@property --my-txt-color {<br>&nbsp; 
  syntax: &quot;&lt;color&gt;&quot;;<br>&nbsp; inherits: true;<br>&nbsp; initial-value: darkblue;<br>
  }<br><br>div {<br>&nbsp; width: 300px;<br>&nbsp; height: 150px;<br>&nbsp; 
  padding: 15px;<br>&nbsp; background-color: var(--my-bg-color);<br>&nbsp; 
  color: var(--my-txt-color); <br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_property">Try it Yourself &raquo;</a>
<br>
</div>
<!--stop-->
<hr>
...
<hr>
<!--start-->
<h2>Another @property Example</h2>
<p>In the following example we use the default custom property on the &lt;div&gt; 
...
<div class="w3-code notranslate cssHigh">
  @property --my-bg-color {<br>&nbsp; syntax: &quot;&lt;color&gt;&quot;;<br>&nbsp; inherits: 
  true;<br>&nbsp; initial-value: lightgray;<br>}<br><br>div {<br>&nbsp; width: 300px;<br>&nbsp; 
  height: 150px;<br>&nbsp; padding: 15px;<br>&nbsp; background-color: var(--my-bg-color);<br>
  }<br><br>.fresh {<br>&nbsp; --my-bg-color: #ff6347;<br>}<br><br>.nature {<br>&nbsp; --my-bg-color: rgb(120, 
  180, 30);<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_property2">Try it Yourself &raquo;</a>
<br>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Avoid Error with Type Checking and Fallback Value</h2>
<p>In the following example we set the custom property in class .nature 
...
<div class="w3-code notranslate cssHigh">
  ...
  true;<br>&nbsp; initial-value: lightgray;<br>}<br><br>div {<br>&nbsp; width: 300px;<br>&nbsp; 
  height: 150px;<br>&nbsp; padding: 15px;<br>&nbsp; background-color: var(--my-bg-color);<br>
  }<br><br>.fresh {<br>&nbsp; --my-bg-color: #ff6347;<br>}<br><br>.nature {<br>&nbsp; --my-bg-color: 
  2;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_property3">Try it Yourself &raquo;</a>
<br>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Use of the inherits Value</h2>
<p>In the following example we will set the inherits value to false. This means 
...
<div class="w3-code notranslate cssHigh">
  @property --my-bg-color {<br>&nbsp; syntax: &quot;&lt;color&gt;&quot;;<br>&nbsp; inherits: 
  false;<br>&nbsp; initial-value: lightgray;<br>}</div>
  <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_property4" target="_blank">Try it Yourself &raquo;</a>
<br>
</div>

<p>The next example sets the inherits value to true. This means 
that the custom property 
...
<div class="w3-code notranslate cssHigh">
  @property --my-bg-color {<br>&nbsp; syntax: &quot;&lt;color&gt;&quot;;<br>&nbsp; inherits: 
  true;<br>&nbsp; initial-value: lightgray;<br>}</div>
  <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_property5" target="_blank">Try it Yourself &raquo;</a>
<br>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Create Smooth Animation with @property</h2>
<p>A complete new opportunity you can achieve with the <code class="w3-codespan">
<a href="/cssref/atrule_property.php">@property</a></code>  
rule, is to animate something that could not be animated before: Gradients. Look at the 
following example:</p>
  
<div class="w3-example">
<h3>Example</h3>
<p>Specify two custom properties for a gradient:</p>
<div class="w3-code notranslate cssHigh">
    @property --startColor {<br>&nbsp; syntax: &quot;&lt;color&gt;&quot;;<br>&nbsp; 
    initial-value: #EADEDB;<br>&nbsp; inherits: false;<br>}<br><br>@property --endColor {<br>&nbsp; syntax: 
    &quot;&lt;color&gt;&quot;;<br>&nbsp; initial-value: #BC70A4;<br>&nbsp; inherits: false;<br>}<br>
</div>
  <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_property6" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_css3_property.js"></div>
<hr>

<h2>CSS @property Rule</h2>
