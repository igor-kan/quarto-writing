...
<h1>CSS <span class="color_h1">Relative Units</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="css_units_absolute.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="css_challenges_units.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS Relative Units</h2>
<p>Relative units specify a length relative to another length property (like parent element, root element, or viewport).</p>
<p>Relative length units scale better between different screen sizes.</p>

<div class="w3-panel ws-note">
<p><strong>Tip:</strong> The <code class="w3-codespan">em</code> and <code class="w3-codespan">rem</code>
units are perfect for creating scalable and responsive websites!</p>
</div>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td>%</td>
    <td>Relative to the size of the parent element</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_unit_percentage">Try it</a></td>
  </tr>
    <tr>
    <td>fr</td>
    <td>A fractional unit. 1fr equals 1 part of the available space</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_unit_fr">Try it</a></td>
  </tr>
  <tr>
    <td>ch</td>
    <td>Relative to width of the &quot;0&quot; (zero) character</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_unit_ch">Try it</a></td>
  </tr>
    </table>
</div>
<p>* Viewport = the browser window size. 1vw = 1% of the current width of the browser's viewport. So, if the viewport is 500px wide, 1vw is 5px.</p>
<!--stop-->
<hr>
...
<a target="_blank" href="tryit.asp?filename=trycss_units_em" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<a target="_blank" href="tryit.asp?filename=trycss_units_rem" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_units_relative.js"></div>
<hr>
<br>
