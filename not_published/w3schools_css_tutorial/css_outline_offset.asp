...
<html lang="en-US">
<head>
<title>CSS Outline Offset</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="css_outline_shorthand.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_challenges_outline.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
...
<p style="margin:30px;padding:5px;border:1px solid black;outline:3px solid red;outline-offset:15px;">
This paragraph has a black border and a red outline 15px outside the border edge.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  p {<br>&nbsp;&nbsp;margin: 30px;<br>&nbsp; padding: 5px;<br>&nbsp; border: 1px solid black;<br>&nbsp; outline: 
  3px solid red;<br>&nbsp; 
...
<p>The following example shows that the space between an element's border and its outline is transparent:</p>
<p style="margin:30px;padding:5px;background:yellow;border:1px solid black;outline:3px solid red;outline-offset:15px;color:black;">
This paragraph has an outline of 15px outside the border edge.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  p {<br>&nbsp; margin: 30px;<br>&nbsp; padding: 5px;<br>&nbsp; background: 
...
<hr>
<!--start-->
<h2>CSS Outline Offset with Negative Value</h2>
<p>The following example shows the use of an outline-offset with a negative value, now the outline will be placed inside the border edge:</p>
<p style="margin:30px;padding:5px;background:yellow;border:1px solid black;outline:3px solid red;outline-offset:-5px;color:black;">
This paragraph has a black border and a red outline -5px inside the border edge.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  p {<br>&nbsp; margin: 30px;<br>&nbsp; padding: 5px;<br>&nbsp; background: 
...
<a target="_blank" href="tryit.asp?filename=trycss_outline-offset3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_outline_offset.js"></div>
<hr>
