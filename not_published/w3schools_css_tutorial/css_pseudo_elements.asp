...
<a class="w3-left w3-btn" href="css_challenges_pseudo_classes.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_pseudo_elements_text.asp">Next &#10095;</a>
</div>
<hr>

<h2>CSS Pseudo-Elements</h2>
<p>A CSS pseudo-element is a keyword that can be added to a selector, to style a 
specific part of an element.</p>
<p>Some common use for pseudo-elements:</p>
<ul>
  <li>Style the first letter or first line, of an element</li>
  <li>Insert content before or after an element</li>
  <li>Style the markers of list items</li>
  <li>Style the user-selected portion of an element</li>
  <li>Style the viewbox behind a dialog box</li>
</ul>

<h3>Syntax</h3>
<p>Pseudo-elements are denoted by a double colon (::) followed by the pseudo-element name:</p>
<div class="w3-example">
<div class="w3-code notranslate cssHigh">
selector::pseudo-element-name {<br><em>&nbsp;&nbsp;CSS properties</em><br>}</div>
</div>
<hr>

<h2>Text Pseudo-elements</h2>
<p>Text pseudo-elements style specific parts of text content:</p>
<ul>
  <li><code class="w3-codespan">::first-line</code> - Style the first line of text</li>
  <li><code class="w3-codespan">::first-letter</code> - Style the first letter of text</li>
</ul>
<hr>

<h2>Content Pseudo-elements</h2>
<p>Content pseudo-elements insert or style generated content:</p>
<ul>
  <li><code class="w3-codespan">::before</code> - Insert content before an element</li>
  <li><code class="w3-codespan">::after</code> - Insert content after an element</li>
  <li><code class="w3-codespan">::marker</code> - Style list item markers</li>
  <li><code class="w3-codespan">::selection</code> - Style user-selected text</li>
  <li><code class="w3-codespan">::backdrop</code> - Style dialog backdrop</li>
</ul>
<hr>
