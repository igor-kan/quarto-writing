...
<a class="w3-left w3-btn" href="css3_gradients.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="css3_gradients_conic.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS radial-gradient() Function</h2>
<p>The CSS <code class="w3-codespan"><a href="/cssref/func_radial-gradient.php">
radial-gradient()</a></code> function creates a radial gradient.</p>
<p>A radial gradient defines a color transition that goes goes out from a 
central point.</p>
<p>A radial gradient requires at least two color stops. Color stops are the 
colors you want to render smooth transitions among.</p>

<h3>Syntax</h3>
<div class="w3-code w3-border notranslate"><div>
background-image: radial-gradient(<em>shape size </em>at<em> position, start-color, ..., last-color</em>);</div></div>
<p>By default, <code class="w3-codespan">shape</code> is ellipse, <code class="w3-codespan">size</code> is farthest-corner, and <code class="w3-codespan">
position</code> is center.</p>
<h3>Radial Gradient - Evenly Spaced Color Stops (this is default)</h3>
...
<hr>
<!--start-->
<h2>Radial Gradient - Set Shape</h2>
<p>The <code class="w3-codespan">shape</code> parameter defines the shape of the gradient. It can take one of the following values:</p>
<ul>
...
<hr>
<!--start-->
<h2>Radial Gradient - The size Parameter</h2>
<p>The <code class="w3-codespan">size</code> parameter defines the size of the gradient'ending 
shape. It can take one of the following values:</p>
<ul>
...
<div class="w3-code notranslate cssHigh">
    #grad1 {<br>&nbsp; background-image: radial-gradient(closest-side at 70% 60%, red, yellow, 
black);<br>}<br>
<br>#grad2 {<br>
    &nbsp; background-image: radial-gradient(farthest-side at 70% 60%, red, yellow, black);<br>} </div>
...
<hr>
<!--start-->
<h2>CSS repeating-radial-gradient() Function</h2>
<p>The CSS <code class="w3-codespan">
<a href="/cssref/func_repeating-radial-gradient.php">repeating-radial-gradient()</a></code> function is used to repeat radial gradients:</p>
<div id="grad13"></div>
<div class="w3-example">
<h3>Example</h3>
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_css3_gradients_radial.js"></div>
<hr>
