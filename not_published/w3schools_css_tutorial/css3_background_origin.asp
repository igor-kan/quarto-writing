...
<h1>CSS <span class="color_h1">Background Origin</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="css3_background_size.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="css3_background_clip.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS background-origin Property</h2>
<p>The CSS <code class="w3-codespan">
<a href="/cssref/css3_pr_background-origin.php">background-origin</a></code> property specifies where the background image is 
positioned.</p>
<p>This property can have one of the following values:</p>
<ul>
<li> <code class="w3-codespan">
padding-box</code> - The background image starts from the top-left corner of the padding edge. 
This is default</li>
  <li><code class="w3-codespan">
border-box</code> - The background image starts from the top-left corner of the border 
  edge</li>
<li> <code class="w3-codespan">
content-box</code> - The background image starts from the top-left corner of the content 
edge</li>
</ul>
<p><strong>Note:</strong> This property has no effect if the <code class="w3-codespan">
<a href="/cssref/pr_background-attachment.php">background-attachment</a></code> 
property is set to &quot;fixed&quot;.</p>
<p>The following example illustrates the <code class="w3-codespan">
background-origin</code> property:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  #div1 {<br>&nbsp; border: 2px solid black;<br>&nbsp; padding: 35px;<br>&nbsp; 
  background-image: url(img_flwr.gif);<br>&nbsp; background-repeat: no-repeat;<br>&nbsp; 
  background-origin: padding-box; <br>}<br><br>#div2 {<br>&nbsp; border: 2px solid black;<br>&nbsp; 
  padding: 35px;<br>&nbsp; background-image: url(img_flwr.gif);<br>&nbsp; 
  background-repeat: no-repeat;<br>&nbsp; background-origin: border-box;<br>}<br><br>#div3 {<br>&nbsp; border: 2px solid 
  black;<br>&nbsp; padding: 35px;<br>&nbsp; background-image: url(img_flwr.gif);<br>&nbsp; 
  background-repeat: no-repeat;<br>&nbsp; background-origin: content-box;<br>} </div>
