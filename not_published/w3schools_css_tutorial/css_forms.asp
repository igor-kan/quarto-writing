...
<a class="w3-left w3-btn" href="css_challenges_attribute_selectors.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_form_inputs.asp">Next &#10095;</a>
</div>
<hr>

<h2>CSS Styling Forms</h2>
<p>CSS is used to style HTML forms. The look of an HTML form can be greatly improved with CSS:</p>
...
<a target="_blank" href="tryit.asp?filename=trycss_forms" class="ws-btn w3-block w3-margin-top w3-padding-16">Try it Yourself &raquo;</a>
</form>
</div>
<hr>
