...
<h1>CSS <span class="color_h1">Background Size</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="css3_backgrounds.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="css3_background_origin.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>The CSS background-size Property</h2>
<p>The <code class="w3-codespan">
<a href="/cssref/css3_pr_background-size.php">background-size</a></code> property allows you to specify the size of background images.</p>
<p>The background size can be specified in lengths, percentages, or by using one of the 
keywords: <code class="w3-codespan">auto</code>, <code class="w3-codespan">contain</code>, 
or <code class="w3-codespan">cover</code>.</p>
...
<h3>Example</h3>
  <p>Set background size with pixels:</p>
<div class="w3-code notranslate cssHigh">
#div1
{<br>
  &nbsp;
background-image: url(img_flower.jpg);<br>&nbsp;&nbsp;background-position: right top;<br>
  &nbsp;&nbsp;background-repeat: no-repeat;<br>&nbsp;&nbsp;background-size: 100px 80px;<br>}
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_background-size">Try it Yourself &raquo;</a>
</div>

<h3>background-size - auto, contain and cover</h3>
<p>The keyword values for <code class="w3-codespan">
<a href="/cssref/css3_pr_background-size.php">background-size</a></code> are 
<code class="w3-codespan">auto</code>, <code class="w3-codespan">contain</code> 
and <code class="w3-codespan">cover</code>.</p>
<p>The <code class="w3-codespan">auto</code> value is the default value, and 
displays the background image in its original size.</p>
<p>The <code class="w3-codespan">contain</code> value scales the image up or down, to fit inside the content area.</p>
<p>The <code class="w3-codespan">cover</code> value scales the image to be as large as possible so that the content area is 
completely covered by the background image (its width and height will be equal to, or 
larger than the content area).</p>
<div class="w3-example">
<h3>Example</h3>
<p>Set background size with contain, cover and auto:</p>
<div class="w3-code notranslate cssHigh">
   #div1 {<br>&nbsp; border: 1px solid black;<br>&nbsp; background-image: 
   url(img_flwr.gif);<br>&nbsp; background-repeat: no-repeat;<br>&nbsp; 
   background-size: contain;<br>}<br><br>#div2 
   {<br>&nbsp; border: 1px solid black;<br>&nbsp; background-image: url(img_flwr.gif);<br>&nbsp; 
   background-repeat: no-repeat;<br>&nbsp; background-size: cover;<br>}<br><br>#div3 {<br>&nbsp; 
   border: 1px solid black;<br>&nbsp; background-image: url(img_flwr.gif);<br>&nbsp; 
   background-repeat: no-repeat;<br>&nbsp; background-size: auto; <br>} </div>
...
<p>The <code class="w3-codespan"><a href="/cssref/css3_pr_background-size.php">background-size</a></code> property also accepts multiple values  
...
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
   #div1 {<br>&nbsp;&nbsp;background-image: url(img_tree.gif), 
   url(img_flwr.gif), url(paper.gif);<br>&nbsp;&nbsp;background-position: left top, right 
   bottom, left top;<br>&nbsp;&nbsp;background-repeat: no-repeat, no-repeat, repeat;<br>&nbsp; background-size: 
   contain, 150px, auto;<br>} </div>
...
<hr>
<!--start-->
<h2>CSS Full Size Background Image</h2>
<p>Now we want to have a background image that covers the entire 
...
<p>Here, we define the styles in the &lt;html&gt; element 
(the &lt;html&gt; element is always at least the height of the browser window). Then 
we set a fixed and centered background on it. 
