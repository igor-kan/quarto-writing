...
<html lang="en-US">
<head>
<title>CSS Specificity Hierarchy</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">Specificity Hierarchy</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="css_specificity.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="css_challenges_specificity.asp">Next &#10095;</a>
</div>
<hr>

<h2>Specificity Hierarchy</h2>
<p>Each type of CSS selector has a position in the specificity hierarchy, and the selector types carry different "weights".</p>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    ...
    <td>Highest priority, will override all other selectors</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>Id selectors</td>
    <td>#navbar</td>
    <td>Second highest priority</td>
    <td>1-0-0</td>
  </tr>
  <tr>
    <td>Classes, attribute selectors and pseudo-classes</td>
    <td>.test, [type=&quot;text&quot;], :hover</td>
    <td>Third highest priority</td>
    <td>0-1-0</td>
  </tr>
  <tr>
  ...
  <tr>
    <td>Universal selector and :where()</td>
    <td>*, where()</td>
    <td>No priority</td>
    <td>0-0-0</td>
  </tr>
...
<h2>Understand the Weight Notation</h2>
<p>The weight notation uses three numbers (X-Y-Z):</p>
<ul>
  <li><strong>X</strong> - Number of ID selectors</li>
  <li><strong>Y</strong> - Number of class selectors, attribute selectors, and pseudo-classes</li>
  <li><strong>Z</strong> - Number of element selectors and pseudo-elements</li>
</ul>
<p>The selector with the higher leftmost number wins. If equal, compare the next number, and so on.</p>
<hr>

<h2>Calculate the Specificity Weight</h2>
<p>The declaration with the highest specificity/weight value will be applied to the element.</p>
<div class="w3-example">
<h3>Example</h3>
<p>The specificity hierarchy and weight:</p>
<div class="w3-code notranslate htmlHigh">
  &lt;html&gt;<br>&lt;head&gt;<br>&nbsp; &lt;style&gt;<br>&nbsp;&nbsp;&nbsp; 
  #demo {color: blue;} /* weight: 1-0-0 */<br>&nbsp;&nbsp;&nbsp; p#demo {color: 
  orange;} /* weight: 1-0-1 WINS! */<br>&nbsp;&nbsp;&nbsp; .test {color: green;} 
  /* weight: 0-1-0 */<br>&nbsp;&nbsp;&nbsp; p.test {color: green;} /* weight: 
  0-1-1 */<br>&nbsp;&nbsp;&nbsp; p {color: red;} /* weight: 0-0-1 */<br>&nbsp; 
  &lt;/style&gt;<br>&lt;/head&gt;<br>&lt;body&gt;<br><br>&lt;p id=&quot;demo&quot; class=&quot;test&quot;&gt;Hello World!&lt;/p&gt;<br><br>&lt;/body&gt;<br>&lt;/html&gt;</div>
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss_specificity_hierarchy">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>More Specificity Examples</h2>
<p>Understand how specificity works in different scenarios:</p>
<h3>Equal specificity: the latest rule wins</h3>
<p>If the same rule is written twice in the external style sheet, the latest rule wins:</p>
<div class="w3-example">
<h3>Example</h3>
...
<h3>ID selectors beat attribute selectors</h3>
<p>Look at the following code lines - Here, the first rule has higher specificity than the second, and will therefore be applied:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  #myDiv {background-color: yellow;}<br>div[id=myDiv] {background-color: blue;}
</div>
...
<h3>A class selector beats element selectors</h3>
<p>A class selector such as .intro beats h1, p, div, etc:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
...
<p>The universal selector (*) has no specificity weight value:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  * {background-color: yellow;}<br>h1 {background-color: red;}
</div>
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss_specificity4">Try it Yourself &raquo;</a></p>
</div>

<h3>Inline style vs external style sheet</h3>
<p>The embedded style sheet is closer to the element to be styled. So in the 
following situation the last rule will be applied:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
/*From external CSS file:*/<br>#content h1 {background-color: red;}<br><br>
/*In HTML file:*/<br>&lt;style&gt;<br>#content h1 {background-color: 
yellow;}<br>&lt;/style&gt;
</div>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_specificity_hierarchy.js"></div>
<hr>
