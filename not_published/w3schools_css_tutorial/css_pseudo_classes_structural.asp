...
<html lang="en-US">
<head>
<title>CSS Structural Pseudo-classes</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">Structural Pseudo-classes</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_pseudo_classes_interactive.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_challenges_pseudo_classes.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>Structural Pseudo-classes</h2>
<p>Structural pseudo-classes select elements based on their position in the document tree.</p>
<hr>

<h2>The CSS :first-child Pseudo-class</h2>
<p>The <code class="w3-codespan"><a href="/cssref/sel_firstchild.php">:first-child</a></code> pseudo-class matches a specific element that is the first child of another element.</p>

<h3>Style all first child &lt;p&gt; elements</h3>
<p>In the following example, the selector matches all &lt;p&gt; elements that is the first child of any element:</p>
...
<hr>
<!--start-->
<h3>Style the first &lt;em&gt; element in all &lt;p&gt; elements</h3>
<p>In the following example, the selector matches the first &lt;em&gt; element in all &lt;p&gt; elements:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
p em:first-child
...
<h3>Style all &lt;em&gt; elements in all first child &lt;p&gt; elements</h3>
<p>In the following example, the selector matches all &lt;em&gt; elements in &lt;p&gt; elements that are the first child of another element:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
p:first-child em
...
<hr>
<!--start-->
<h2>The CSS :lang() Pseudo-class</h2>
<p>The <code class="w3-codespan"><a href="/cssref/sel_lang.php">:lang()</a></code> pseudo-class 
is used to select elements with a lang attribute with the specified value.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Define the quotation marks for &lt;q&gt; elements with lang=&quot;no&quot;:&nbsp;</p>
...
<hr>
<!--start-->
<h2>Other Structural Pseudo-classes</h2>
<p>There are many more structural pseudo-classes available:</p>
<ul>
  <li><code class="w3-codespan">:last-child</code> - Matches the last child of a parent</li>
  <li><code class="w3-codespan">:nth-child(n)</code> - Matches the nth child of a parent</li>
  <li><code class="w3-codespan">:nth-last-child(n)</code> - Matches the nth child from the end</li>
  <li><code class="w3-codespan">:only-child</code> - Matches an element that is the only child</li>
  <li><code class="w3-codespan">:first-of-type</code> - Matches the first element of its type</li>
  <li><code class="w3-codespan">:last-of-type</code> - Matches the last element of its type</li>
</ul>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_pseudo_classes_structural.js"></div>
<hr>

<h2>CSS Pseudo-classes Reference</h2>
<div class="ws-note w3-panel">
  <p>For a complete list of all CSS Pseudo-classes, visit our <a href="/cssref/css_ref_pseudo_classes.php">CSS Pseudo-classes Reference</a>.</p>
</div>
