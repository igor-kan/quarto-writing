...
<html lang="en-US">
<head>
<title>CSS Min/Max Height and Width</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">Min/Max Height and Width</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_height_width.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_challenges_height_width.asp">Next &#10095;</a>
</div>
<hr>

<h2>CSS Min/Max Height and Width</h2>
<p>The <code class="w3-codespan"><a href="/cssref/pr_dim_min-width.php">min-width</a></code> and <code class="w3-codespan"><a href="/cssref/pr_dim_max-width.php">max-width</a></code> properties are used to set the minimum and maximum width of an element.</p>
<p>The <code class="w3-codespan"><a href="/cssref/pr_dim_min-height.php">min-height</a></code> and <code class="w3-codespan"><a href="/cssref/pr_dim_max-height.php">max-height</a></code> properties are used to set the minimum and maximum height of an element.</p>
<hr>

<h2>CSS Using max-width</h2>
<p>The <code class="w3-codespan"><a href="/cssref/pr_dim_max-width.php">max-width</a></code> property sets the maximum 
allowed width of an element. This prevents the width of an element to be larger 
than the <code class="w3-codespan"><a href="/cssref/pr_dim_max-width.php">max-width</a></code> 
property value. </p>
<p>The <code class="w3-codespan"><a href="/cssref/pr_dim_max-width.php">max-width</a></code> 
property can have the following values:</p>
<ul>
  <li><code class="w3-codespan">length</code> - Defines the maximum width in px, cm, etc.</li>
  <li><em><code class="w3-codespan">%</code></em> - Defines the maximum width in percent of the containing block</li>
  <li><code class="w3-codespan">none</code> - This is default. Means that there is no maximum width</li>
</ul>

<p>One problem with the
<code class="w3-codespan"><a href="/cssref/pr_dim_width.php">width</a></code> 
...
So, using <code class="w3-codespan">
<a href="/cssref/pr_dim_max-width.php">max-width</a></code> will improve the browser's handling on small windows.</p>
<hr>

<h2>CSS max-width Examples</h2>
<p>Drag the browser window to smaller than 600px wide, to see the difference between the two divs below!</p>

<p>Using width:</p>
<div class="w3-theme-border" style="width:600px;padding:10px;background-color:powderblue;color:black">
This element has a width of 600 pixels.</div>

<p>Using max-width:</p>
<div class="w3-theme-border" style="padding:10px;background-color:powderblue;color:black;max-width:600px;">
This element has a max-width of 600 pixels.</div>

<div class="w3-example">
<h3>Example</h3>
<p>One &lt;div&gt; element with a max-width of 500 pixels, and one &lt;div&gt; element 
with a width of 500 pixels:</p>
<div class="w3-code notranslate cssHigh">
  .div1 {<br>&nbsp; max-width: 500px;<br>&nbsp; background-color: powderblue;<br>
  }<br><br>
  .div2 {<br>&nbsp; width: 500px;<br>&nbsp; background-color: powderblue;<br>}</div>
<p>
<a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss_dim_max_width">Try it Yourself &raquo;</a>
</p>
</div>

<p><strong>Note:</strong> If you use both the
<code class="w3-codespan"><a href="/cssref/pr_dim_width.php">width</a></code> property and the
<code class="w3-codespan"><a href="/cssref/pr_dim_max-width.php">max-width</a></code> property on the same element, and the value of the
<code class="w3-codespan"><a href="/cssref/pr_dim_width.php">width</a></code> property is larger than the
<code class="w3-codespan"><a href="/cssref/pr_dim_max-width.php">max-width</a></code> property; the
<code class="w3-codespan"><a href="/cssref/pr_dim_max-width.php">max-width</a></code> property 
value will be used!</p>

<div class="w3-example">
<h3>Example</h3>
<p>A &lt;div&gt; element with both a width and a max-width property:</p>
<div class="w3-code notranslate cssHigh">
  .div1 {<br>&nbsp; width: 100%;<br>&nbsp; max-width: 900px;<br>&nbsp; 
  background-color: powderblue;<br>}</div>
<p>
<a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss_dim_max_width2">Try it Yourself &raquo;</a>
</p>
</div>
<hr>
...
<hr>
<div id="exercisecontainer" src="xrcise_height_width_min_max.js"></div>
<hr>
