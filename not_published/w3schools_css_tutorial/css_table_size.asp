...
<html lang="en-US">
<head>
<title>CSS Table Size (Width and Height)</title>
<meta charset="utf-8">
...
<style>
table.width1,table.width1 td,table.width1 th,
table.width2,table.width2 td,table.width2 th,
table.width3,table.width3 td,table.width3 th,
table.width4,table.width4 td,table.width4 th,
table.height1,table.height1 td,table.height1 th
{
  border: 1px solid;
}
...
<h1>CSS <span class="color_h1">Table Size (Width and Height)</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_table.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_table_align.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS Table Width</h2>
<p>The CSS <code class="w3-codespan"><a href="/cssref/pr_dim_width.php">width</a></code> 
property is used to set the width of a table.</p>
<p>The width can be set:</p>
<ul>
  <li>in percent (%)</li>
  <li>as a fixed length (px)</li>
  <li>by the <code class="w3-codespan">auto</code> keyword</li>
</ul>
<hr>

<h2>CSS Table Width in Percent</h2>
<p>To create a table that spans the entire screen (full-width), use
<code class="w3-codespan">width: 100%;</code>:</p>
<table class="width1">
  <tr>
  <th>Firstname</th>
  <th>Lastname</th>
...
<p>To create a table that spans half the page, use <code class="w3-codespan">width: 50%;</code>:</p>
<table class="width2">
  <tr>
  <th>Firstname</th>
  <th>Lastname</th>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_table_width2">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<hr>
<!--start-->
<h2>CSS Table Width in a Fixed Width</h2>
<p>To create a table with a fixed width, use <code class="w3-codespan">width: 500px</code>:</p>
<table class="width3">
  <tr>
  <th>Firstname</th>
  <th>Lastname</th>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_table_width3">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>CSS Table Width Using auto</h2>
<p>To let the browser calculate the width, use <code class="w3-codespan">width: auto;</code>:</p>
<table class="width4">
  <tr>
  <th>Firstname</th>
  <th>Lastname</th>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_table_width4">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>CSS Table Height</h2>
<p>The CSS <code class="w3-codespan"><a href="/cssref/pr_dim_height.php">height</a></code> 
property is used to set the height of a table.</p>
<p>The height can be set:</p>
<ul>
  <li>in percent (%)</li>
  <li>as a fixed length (px)</li>
  <li>by the <code class="w3-codespan">auto</code> keyword</li>
...
<p>The example below sets the height of the table headers (&lt;th&gt;) to 70px:</p>
...
<div class="w3-example">
<h3>Example</h3>
  <p>Set the height of table headers to a fixed height:</p>
<div class="w3-code notranslate cssHigh">
th
{<br>
&nbsp;&nbsp;height: 70px;<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_table_height">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_table_size.js"></div>
<hr>
