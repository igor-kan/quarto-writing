...
<html lang="en-US">
<head>
<title>CSS Flexbox (Flexible Box Layout)</title>
<meta charset="utf-8">
...
<a class="w3-right w3-btn" href="css_challenges_flexbox_intro.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS Flexbox (Flexible Box Layout)</h2>
<p>CSS Flexbox is short for the CSS Flexible Box Layout module.</p>
<p>Flexbox is a layout model for arranging items (horizontally or 
vertically) within a container, in a flexible and responsive way.</p>
<p>Flexbox makes it easy to design a 
flexible and responsive layout, without using <code class="w3-codespan">
<a href="/cssref/pr_class_float.php">float</a></code> or positioning.</p>

<div class="flex-container2">
  <div class="item2"><h3>Item 1</h3></div>
  <div class="item2"><h3>Item 2</h3></div>
  <div class="item2"><h3>Item 3</h3></div>  
  <div class="item2"><h3>Item 4</h3></div>
  <div class="item2"><h3>Item 5</h3></div>
</div>
<p><a class="ws-btn" target="_blank" href="tryit.asp?filename=trycss3_flexbox">Try it Yourself &raquo;</a></p>

<div class="w3-panel ws-note">
  <h3>Flexbox vs. Grid</h3>
  <p>CSS Flexbox is used for a one-dimensional layout, with rows 
  OR columns.</p>
  <p><a href="css_grid.asp">CSS Grid</a> is used for a two-dimensional layout, with rows 
  AND columns.</p>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>CSS Flexbox Components</h2>
<p>A flexbox always consists of:</p>
<ul>
  <li><strong>A Flex Container</strong> - The parent (container) element, where the <code class="w3-codespan"><a href="/cssref/pr_class_display.php">display</a></code> property is set to <code class="w3-codespan">flex</code> or <code class="w3-codespan">inline-flex</code></li>
  <li><strong>One or more Flex Items</strong> - The direct children of the flex container 
  automatically becomes flex items</li>
</ul>
<!--stop-->
<hr>
...
<hr>
<!--start-->
<h2>A Flex Container with Three Flex Items</h2>

<p>The element below represents a <strong>flex container</strong> (the blue area) with three 
...
<div class="w3-code notranslate htmlHigh">
  &lt;html&gt;<br>&lt;head&gt;<br>&lt;style&gt;<br>.container {<br>&nbsp; display: flex;<br>&nbsp; 
  background-color: DodgerBlue;<br>}<br><br>.container div {<br>&nbsp; 
  background-color: #f1f1f1;<br>&nbsp; margin: 10px;<br>&nbsp; padding: 20px;<br>&nbsp; 
  font-size: 30px;<br>}<br>&lt;/style&gt;<br>&lt;/head&gt;<br>&lt;body&gt;<br><br>&lt;div 
  class=&quot;container&quot;&gt;<br>&nbsp; &lt;div&gt;Item 1&lt;/div&gt;<br>&nbsp; &lt;div&gt;Item 2&lt;/div&gt;<br>&nbsp; 
  &lt;div&gt;Item 3&lt;/div&gt; <br>&lt;/div&gt;<br><br>&lt;/body&gt;<br>&lt;/html&gt;</div>
<p>
<a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss3_flexbox2">Try it Yourself &raquo;</a>
</p>
</div>
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_css3_flexbox.js"></div>
<hr>
