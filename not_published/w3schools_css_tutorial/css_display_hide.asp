...
<h1>CSS <span class="color_h1">Hide</span> Elements</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_display.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_challenges_display.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS display: none;</h2>
<p>When using <code class="w3-codespan">display: none;</code> the element is completely hidden from the document flow 
and does not take 
    up any space.</p>
<p>It is commonly used with JavaScript to hide 
or show elements without deleting and recreating them.</p>
<p class="flip" onclick="myShowFunction()">Click to show hidden panel</p>
<div id="panel">
  <p>This panel contains a &lt;div&gt; element, which is hidden by default, with display: none.</p>
  <p>We use JavaScript to show it (change it to display: block).</p>
</div>

<div class="w3-example">
<h3>Example</h3>
  <p>How to use CSS and JavaScript to show a hidden element on a click event:</p>
<div class="w3-code notranslate cssHigh">
  &lt;style&gt;<br>#panel {<br>&nbsp; display: 
  none;<br>}<br>&lt;/style&gt;<br><br>&lt;script&gt;<br>function myFunction() {<br>
  &nbsp;
  document.getElementById(&quot;panel&quot;).style.display = &quot;block&quot;;<br>}<br>&lt;/script&gt;</div>
<a target="_blank" href="tryit.asp?filename=trycss_display_js" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
  <p>How to use CSS and JavaScript to toggle between show and hide on a click event:</p>
<div class="w3-code notranslate cssHigh">
  &lt;style&gt;<br>#panel {<br>&nbsp; display: 
  none;<br>}<br>&lt;/style&gt;<br><br>&lt;script&gt;<br>function myFunction() {<br>&nbsp; 
  var x = document.getElementById(&quot;panel&quot;);<br>&nbsp; if (x.style.display === 
  &quot;none&quot;) {<br>&nbsp;&nbsp;&nbsp; x.style.display = &quot;block&quot;;<br>&nbsp; } else {<br>&nbsp;&nbsp;&nbsp; 
  x.style.display = &quot;none&quot;;<br>&nbsp; }<br>}<br>
  &lt;/script&gt;</div>
<a target="_blank" href="tryit.asp?filename=trycss_display_js_toggle" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<hr>
<h2>Hide an Element - Use display:none or visibility:hidden?</h2>
...
<a target="_blank" href="tryit.asp?filename=trycss_display" class="ws-btn w3-margin-top">Try it Yourself &raquo;</a>

<p>Hiding an element can be done by setting the <code class="w3-codespan">
<a href="/cssref/pr_class_display.php">display</a></code> property to 
...
<p>You can also use <code class="w3-codespan"><a href="/cssref/pr_class_visibility.php">visibility:hidden;</a></code> to hide an element.</p>
<p>However, with this property, the element will be hidden, but it will still take up the same space 
as if it was visible:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
...
<hr>
<div id="exercisecontainer" src="xrcise_display_hide.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_display.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_challenges_display.asp">Next &#10095;</a>
