...
<a class="w3-left w3-btn" href="css_navbar_horizontal_fixed.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_dropdowns_advanced.asp">Next &#10095;</a>
</div>
<hr>

<h2>CSS Dropdowns</h2>
<p>CSS dropdowns are used to display a list of options or content when a user 
clicks or hover over an element, like a button or a navigation link.</p>

<p>A CSS dropdown consists of a trigger element (like &lt;div&gt;, &lt;button&gt;, &lt;p&gt;, &lt;a&gt;, 
etc.).</p>
<p>When the trigger element is clicked or hovered over, the dropdown content 
will be displayed.</p>
<p>The dropdown content is a container element (e.g. &lt;div&gt;) that holds the hidden content 
(can be text, links, images, etc.).&nbsp;</p>

<p>Mouse over the three CSS dropdown examples below:</p>

<div class="w3-row" style="padding:20px;border:1px solid black;">
...
<div class="w3-third">
  <div class="dropdown dropdown2">
    ...
    <img class="dropimg" src="img_5terre.jpg" alt="Cinque Terre" width="100" height="50">
...
<h2>CSS Dropdown Box with Text</h2>
<p>Here, we create a dropdown box with some text, that appears when the user mouses over a &lt;div&gt; element.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;style&gt;<br>.dropdown {<br>&nbsp; position: relative;<br>}<br><br>.dropdown-content {<br>&nbsp; display: 
none;<br>&nbsp; position: absolute;<br>&nbsp; 
background-color: #f9f9f9;<br>&nbsp; min-width: 130px;<br>&nbsp;&nbsp;box-shadow: 0px 8px 16px 0px rgba(0,0,0,0.2);<br>
  &nbsp; padding: 
12px 16px;<br>}<br><br>.dropdown:hover 
.dropdown-content {<br>&nbsp; display: block;<br>}<br>&lt;/style&gt;<br><br>
&lt;div class="dropdown"&gt;Mouse over me!<br>&nbsp; 
&lt;div class="dropdown-content"&gt;Hello World!&lt;/div&gt;<br>&lt;/div&gt;</div>
<a target="_blank" href="tryit.asp?filename=trycss_dropdown_text" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<h3>Example Explained</h3>
<ul>
  <li>The .dropdown class uses <code class="w3-codespan">
  <a href="/cssref/pr_class_position.php">position:relative</a></code>, which is needed when we want the 
dropdown content to be placed right below the trigger element (the dropdown 
  content will use 
  <code class="w3-codespan"><a href="/cssref/pr_class_position.php">position:absolute</a></code>).</li>
  <li>The .dropdown-content class holds the dropdown content. It is hidden by 
default, and will be displayed on hover. </li>
  <li>The 
  <code class="w3-codespan"><a href="/cssref/pr_dim_min-width.php">min-width</a></code> 
  property is set to 130px. Feel free to change 
this! If you want the width of the dropdown content to be 
as wide as the trigger element, set <code class="w3-codespan">
  <a href="/cssref/pr_dim_width.php">width</a></code> to 100% and
  <code class="w3-codespan"><a href="/cssref/pr_pos_overflow.php">overflow:auto</a></code> to 
enable scroll on small screens.</li>
  <li>Instead of using a border, we use the <code class="w3-codespan">
  <a href="/cssref/css3_pr_box-shadow.php">box-shadow</a></code> property to make the 
dropdown content look like a "card".</li>
  <li>The <code class="w3-codespan"><a href="/cssref/sel_hover.php">:hover</a></code> selector is used to show the dropdown 
  content when the user  
mouses over the &lt;div class=&quot;dropdown&quot;&gt; element.</li>
</ul>
<hr>
...
<p>This example is similar to the previous one, except that we add a button and links inside the dropdown box and style them to fit 
the dropdown button:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;style&gt;<br>.dropdown {<br>
  &nbsp; position: relative;<br>}<br><br>/* Style the dropdown button */<br>.dropbtn {<br>&nbsp; 
background-color: #4CAF50;<br>&nbsp; color: white;<br>&nbsp; 
padding: 16px;<br>&nbsp; font-size: 16px;<br>&nbsp; 
border: none;<br>&nbsp; cursor: pointer;<br>}<br><br>/* Dropdown content */<br>
.dropdown-content {<br>&nbsp; display: none;<br>&nbsp; position: 
absolute;<br>&nbsp; background-color: #f9f9f9;<br>&nbsp; 
min-width: 200px;<br>&nbsp; box-shadow: 
0px 8px 16px 0px rgba(0,0,0,0.2);<br>}<br><br>/* Links inside dropdown content */<br>
...
.dropdown-content a:hover {<br>&nbsp; background-color: #f1f1f1<br>}<br><br>/* Show the 
dropdown content on hover */<br>.dropdown:hover .dropdown-content {<br>&nbsp; 
display: block;<br>}<br><br>/* Change background color of dropdown 
button on hover */<br>.dropdown:hover .dropbtn {<br>&nbsp;&nbsp;background-color: #3e8e41;<br>}<br>&lt;/style&gt;<br><br>
...
<hr>
<div id="exercisecontainer" src="xrcise_dropdowns.js"></div>
<hr>
