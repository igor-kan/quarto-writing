...
<html lang="en-US">
<head>
<title>CSS Padding and box-sizing</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">Padding</span> and box-sizing</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_padding.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_challenges_padding.asp">Next &#10095;</a>
</div>
<hr>
<h2>Padding and Element Width</h2>
<p>The CSS <code class="w3-codespan"><a href="/cssref/pr_dim_width.php">width</a></code> property specifies the width of the element's content area. The 
...
<hr>
<!--start-->
<h2>Padding and box-sizing</h2>
<p>The <code class="w3-codespan"><a href="/cssref/css3_pr_box-sizing.php">box-sizing</a></code> property defines how the width and height of an element are calculated: should they include padding and borders, or not.</p>
<p>The <code class="w3-codespan"><a href="/cssref/css3_pr_box-sizing.php">box-sizing</a></code> property can have the following values:</p>
<ul>
  <li><code class="w3-codespan">content-box</code> - This is default. The width and height properties includes only the content 
  (border and padding are not included)</li>
  <li><code class="w3-codespan">border-box</code> - The width and height properties includes content, padding and 
  border</li>
</ul>
<p>So, to keep the width at 300px, no matter the amount of padding, you can use the <code class="w3-codespan">
<a href="/cssref/css3_pr_box-sizing.php">box-sizing: border-box;</a></code>. This causes the element to maintain its actual width; if 
...
<div id="exercisecontainer" src="xrcise_padding_box-sizing.js"></div>
<hr>
