...
<h1>CSS <span class="color_h1">Responsive Tables</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_table_style.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_challenges_table.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS Responsive Tables</h2>
<p>A responsive table will display a horizontal scrollbar if the screen is too 
small to display the full content.</p>
<p>Resize the browser window to see the effect:</p>

<div class="w3-responsive">
<table class="ws-table-all" style="margin:0"><tr>
  <th>First Name</th>
  <th>Last Name</th>
  <th>Points</th>
  <th>Points</th>
...
<h3>How to do it:</h3>
<p>Wrap the &lt;table&gt; element in a &lt;div&gt; container.</p>

<p>Set the <code class="w3-codespan">
<a href="/cssref/css3_pr_overflow-x.php">overflow-x</a></code> property to
<code class="w3-codespan">
auto</code> for the &lt;div&gt; element:&nbsp;</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  div.tablecontainer {<br>&nbsp; overflow-x: auto;<br>} </div>
...
<p><strong>Note:</strong> In OS X Lion (on Mac), scrollbars are hidden by default and 
are only shown when being used (even though "overflow:scroll" is set).</p>
</div>
<!--stop-->
<hr>
...
<p><a href="tryit.asp?filename=trycss_table_caption-side" target="_blank">Add 
and position a table caption</a><br>
This example demonstrates how to add, and position a table caption.</p>
<hr>
<div id="exercisecontainer" src="xrcise_table_responsive.js"></div>
<hr>
