...
<a class="w3-left w3-btn" href="css_challenges_css3_pagination.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css3_multiple_columns_rules.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS Multi-column Layout</h2>
<p>The CSS Multi-column Layout Module allows easy definition of multiple columns of text - just like in newspapers:</p>
...
<p>The CSS <code class="w3-codespan"><a href="/cssref/css3_pr_column-count.php">column-count</a></code> property specifies the number of columns an element should 
be divided into.</p>

<div class="w3-example">
<h3>Example</h3>
  <p>Divide the text in the &lt;div&gt; element into 3 columns:</p>
...
<hr>
<!--start-->
<h2>CSS Column Gap</h2>
<p>The CSS <code class="w3-codespan"><a href="/cssref/css3_pr_column-gap.php">column-gap</a></code> property specifies the 
...
<h2>Column Subpages</h2>
<p>Continue learning about CSS multiple columns:</p>
<ul>
<li><a href="css3_multiple_columns_rules.asp">Column Rules</a> - column-rule, column-span, column-width</li>
</ul>

<hr>
<div id="exercisecontainer" src="xrcise_css3_multiple_columns.js"></div>
<hr>
