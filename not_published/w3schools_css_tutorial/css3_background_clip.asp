...
<h1>CSS <span class="color_h1">Background Clip</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="css3_background_origin.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_challenges_css3_backgrounds.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS background-clip Property</h2>
<p>The CSS <code class="w3-codespan">
<a href="/cssref/css3_pr_background-clip.php">background-clip</a></code> property 
defines how far the background (color, image, or gradient) should extend within 
an element.</p>
<p>This property can have one of the following values:</p>
<ul>
<li> <code class="w3-codespan">
border-box</code> - The background extends behind the border. This is default</li>
  <li> <code class="w3-codespan">
  padding-box</code> - The background extends to the inside edge of the border</li>
<li> <code class="w3-codespan">
content-box</code> - The background extends to the edge of the content box</li>
</ul>
<div class="w3-example">
<h3>Example</h3>
  <p>Using the <code class="w3-codespan">background-clip</code> property with a background image:</p>
<div class="w3-code notranslate cssHigh">
   #div1 {<br>&nbsp; border: 5px dotted black;<br>&nbsp; padding: 35px;<br>&nbsp; 
   background-image: url(paper.gif);<br>&nbsp; background-clip: border-box; <br>
   }<br><br>#div2 {<br>&nbsp; 
   border: 5px dotted black;<br>&nbsp; padding: 35px;<br>&nbsp; 
   background-image: url(paper.gif);<br>&nbsp; background-clip: padding-box;<br>
   }<br><br>#div3 {<br>&nbsp; 
   border: 5px dotted black;<br>&nbsp; padding: 35px;<br>&nbsp; 
   background-image: url(paper.gif);<br>&nbsp; background-clip: content-box;<br>
   } </div>
...
<div class="w3-example">
<h3>Example</h3>
  <p>Using the <code class="w3-codespan">background-clip</code> property with a background color:</p>
<div class="w3-code notranslate cssHigh">
   #div1 {<br>&nbsp; border: 5px dotted black;<br>&nbsp; padding: 35px;<br>&nbsp; 
   background-color: lightblue;<br>&nbsp; background-clip: border-box; <br>
   }<br><br>#div2 {<br>&nbsp; 
   border: 5px dotted black;<br>&nbsp; padding: 35px;<br>&nbsp; 
   background-color: lightblue;<br>&nbsp; background-clip: padding-box;<br>
   }<br><br>#div3 {<br>&nbsp; 
   border: 5px dotted black;<br>&nbsp; padding: 35px;<br>&nbsp; 
   background-color: lightblue;<br>&nbsp; background-clip: content-box;<br>
   } </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_background-clip2">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_css3_backgrounds.js"></div>
<hr>
