...
<h1>CSS <span class="color_h1">Absolute Units</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="css_units.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="css_units_relative.asp">Next &#10095;</a>
</div>
<hr>

<h2>CSS Absolute Units</h2>
<p>Absolute units are fixed, and the length expressed in any of these will appear exactly that size.</p>
<p>Absolute units do not change when the screen size change, and are not recommended for websites. 
However, they can be used if the output medium is known, such 
as for print layout.</p>
<p>The most used absolute unit is <code class="w3-codespan">px</code> (pixels).</p>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td>px</td>
    <td>Pixels</td>
    <td>The most used absolute unit for screens (1px = 1/96th of 1in)</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_unit_px">Try it</a> </td>
    </tr>
  <tr>
    <td>cm</td>
    <td>Centimeters</td>
    <td>Primarly used in print stylesheet</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_unit_cm">Try it</a></td>
  </tr>
    <tr>
    <td>mm</td>
    <td>Millimeters</td>
    <td>Primarly used in print stylesheet</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_unit_mm">Try it</a></td>
    </tr>
  <tr>
    <td>in</td>
    <td>Inches</td>
    <td>Primarly used in print stylesheet (1in = 96px = 2.54cm)</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_unit_in">Try it</a></td>
  </tr>
  <tr>
    <td>pt</td>
    <td>Points</td>
    <td>A typographical unit (1pt = 1/72 of 1in)</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_unit_pt">Try it</a></td>
  </tr>
  <tr>
    <td>pc</td>
    <td>Picas</td>
    <td>A print unit (1pc = 12 pt)</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_unit_pc">Try it</a></td>
  </tr>
</table>
</div>
<hr>

<h2>Set Font Size With Px</h2>
<p>Setting the text size with <code class="w3-codespan">px</code> (pixels) gives you full control over the text size.</p>
<p>If you use pixels, the web page may not scale very well on different screen sizes and the users cannot adjust the text size in their browser settings. However, users can still use the zoom tool to resize the entire page.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Set font sizes with px:</p>
<div class="w3-code notranslate cssHigh">
  h1 {<br>&nbsp; font-size: 40px;<br>}<br><br>h2 {<br>&nbsp; font-size: 30px;<br>}<br><br>p {<br>&nbsp; 
  font-size: 17px;<br>}</div>
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss_units_px">Try it Yourself &raquo;</a></p>
</div>
...
<h2>When to Use Absolute Units</h2>
<p>Absolute units can be used when:</p>
<ul>
  <li>You need precise, fixed dimensions</li>
  <li>Designing for print media</li>
  <li>Creating elements that should not scale with the viewport</li>
</ul>

<div class="w3-panel ws-note">
  <p><strong>Tip:</strong> For most web design purposes, consider using <a href="css_units_relative.asp">relative units</a> like <code class="w3-codespan">em</code> 
  or <code class="w3-codespan">rem</code> for better responsiveness.</p>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_units_absolute.js"></div>
<hr>
<br>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="css_units.asp">&#10094; Previous</a>
