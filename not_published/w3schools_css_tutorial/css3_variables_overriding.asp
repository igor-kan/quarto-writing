...
<div class="w3-clear nextprev">
  ...
  <a class="w3-right w3-btn" href="css3_variables_javascript.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>Override Global Variable With Local Variable</h2>
<p>From the previous page we have learned that global variables can be accessed through the entire document, while 
...
<p>Assume we want a different border color for &lt;p class=&quot;note&quot;&gt; elements. Then, we can 
re-declare the --primary-bg-color variable inside the .note selector. When we use var(--primary-bg-color) 
inside this selector, it will use the local --primary-bg-color variable value declared here. </p>
<p>We see that the local --primary-bg-color variable will override the global --primary-bg-color 
variable for the .note selector:</p>
...
<div class="w3-code notranslate cssHigh">
  ...
  var(--primary-bg-color);<br>}<br><br>.container .note {<br>&nbsp; 
  --primary-bg-color: red; /* local variable will override global */<br>&nbsp; 
  border: 1px solid var(--primary-bg-color);<br>&nbsp; padding: 10px;<br>}   
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_var_override">Try it Yourself &raquo;</a>
<br>
</div>
<!--stop-->
<hr>
...
<p>If a variable is going to be used only one single place, we could also have declared a new local variable, like this:</p>
<div class="w3-example">
  <h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  :root {<br>&nbsp; --primary-bg-color: #1e90ff;<br>&nbsp; --primary-color: 
  ...
  padding: 15px;<br>}<br><br>.container h2 {<br>&nbsp; border-bottom: 2px solid 
  var(--primary-bg-color);<br>}<br><br>.container .note {<br>&nbsp; 
  --note-border-color: red; /* new local variable */<br>&nbsp; border: 1px solid 
  var(--note-border-color);<br>&nbsp; padding: 10px;<br>}   
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_var_local">Try it Yourself &raquo;</a>
<br>
</div>
<!--stop-->
<hr>
