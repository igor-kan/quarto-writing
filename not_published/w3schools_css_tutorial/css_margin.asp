...
<a class="w3-left w3-btn" href="css_challenges_border.asp">&#10094; Previous</a>
<a class="w3-right w3-btn"  href="css_margin_collapse.asp">Next &#10095;</a>
</div>
<hr>

<!--start-->
<h2>CSS Margins</h2>
<p>The CSS margin properties are used to create space around elements, 
outside of any defined borders.</p>
<p>Margins define the distance between an element's border and the surrounding 
elements.</p>
<p>With CSS, you have full control over the margins. CSS has properties 
...
<a target="_blank" href="tryit.asp?filename=trycss_margin_intro" class="ws-btn">Try it Yourself &raquo;</a>
<!--stop-->
<hr>
...
<ul>
<li><code class="w3-codespan"><a href="/cssref/pr_margin-top.php">margin-top</a></code> - sets the top margin of an element</li>
<li><code class="w3-codespan"><a href="/cssref/pr_margin-right.php">margin-right</a></code> - sets the 
right margin of an element</li>
<li><code class="w3-codespan"><a href="/cssref/pr_margin-bottom.php">margin-bottom</a></code> - sets the 
bottom margin of an element</li>
<li><code class="w3-codespan"><a href="/cssref/pr_margin-left.php">margin-left</a></code> - sets the 
left margin of an element</li>
</ul>
...
<p><b>Tip:</b> Negative values are also allowed.</p>
...
one declaration.</p>
<p>The <code class="w3-codespan"><a href="/cssref/pr_margin.php">margin</a></code> property is a shorthand property for the following individual margin properties:</p>
<ul>
<li><code class="w3-codespan"><a href="/cssref/pr_margin-top.php">margin-top</a></code></li>
<li><code class="w3-codespan"><a href="/cssref/pr_margin-right.php">margin-right</a></code></li>
<li><code class="w3-codespan"><a href="/cssref/pr_margin-bottom.php">margin-bottom</a></code></li>
<li><code class="w3-codespan"><a href="/cssref/pr_margin-left.php">margin-left</a></code></li>
</ul>
<p>Here is how it works:</p>
<p>If the <code class="w3-codespan"><a href="/cssref/pr_margin.php">margin</a></code> property has four values:</p>
<ul>
...
<p>If the <code class="w3-codespan"><a href="/cssref/pr_margin.php">margin</a></code> property has three values:</p>
<ul>
...
<p>If the <code class="w3-codespan"><a href="/cssref/pr_margin.php">margin</a></code> property has two values:</p>
<ul>
...
<p>If the <code class="w3-codespan"><a href="/cssref/pr_margin.php">margin</a></code> property has one value:</p>
<ul>
...
<p>You can set the <code class="w3-codespan"><a href="/cssref/pr_margin.php">margin</a></code> 
property to <code class="w3-codespan">auto</code> to horizontally center the element within its container.</p>
...
<p>You can set the <code class="w3-codespan"><a href="/cssref/pr_margin.php">margin</a></code> 
property to <code class="w3-codespan">inherit</code> to let the margin be 
inherited from the parent element.</p>
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_margin.js"></div>
<hr>
