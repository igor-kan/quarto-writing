...
<h1>CSS <span class="color_h1">Navigation Bars</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_challenges_image_transparency.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_navbar_vertical.asp">Next &#10095;</a>
</div>
<hr>

<h2>CSS Navigation Bars</h2>
<p>A navigation bar is an important component of web design.</p>
<p>Navigation bars 
helps users to easily navigate between different sections of a website.</p>
<p>Navigation bars are typically built with HTML list elements ( &lt;ul&gt; and &lt;li&gt;), 
and then styled with CSS to get a great look.</p>
<p>A navigation bar is typically located at the top or at the side of a webpage.</p>

<div class="w3-row">
<div class="w3-col m4">
<p>A vertical navbar:</p>
...
<p>A navigation bar is basically a list of links, so using the HTML &lt;ul&gt; and &lt;li&gt; elements makes perfect 
sense:</p>
...
<p>Now let's remove the bullets and the margins and padding from the &lt;ul&gt; 
element:</p>
<div class="w3-example">
<h3>Example</h3>
...
<ul>
<li>Set <code class="w3-codespan"><a href="/cssref/pr_list-style-type.php">list-style-type: none;</a></code> - Removes the bullet 
points from list</li>
<li>Set <code class="w3-codespan"><a href="/cssref/pr_margin.php">margin: 0;</a></code> 
- Resets default browser margins</li>
  <li>Set <code class="w3-codespan">
<a href="/cssref/pr_padding.php">padding: 0;</a></code> - Resets default browser 
  paddings</li>
</ul>
<p><strong>Note:</strong> The HTML and CSS code in the example above is the base code used 
for both vertical and horizontal navigation bars, which you will learn more about in the next chapters.</p>
<hr>
