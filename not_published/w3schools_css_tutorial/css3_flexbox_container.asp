...
<a class="w3-left w3-btn" href="css_challenges_flexbox_intro.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css3_flexbox_container_justify.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS Flex Container Properties</h2>
<p>The flex container element can have the following properties:</p>
<ul>
  <li><code class="w3-codespan">display</code> - Must be set to <code class="w3-codespan">flex</code> or <code class="w3-codespan">inline-flex</code></li>
  <li><code class="w3-codespan">flex-direction</code> - Sets the display-direction of flex items</li>
  <li><code class="w3-codespan">flex-wrap</code> - Specifies whether the flex items should wrap or not</li>
  <li><code class="w3-codespan">flex-flow</code> - Shorthand property for  <code class="w3-codespan">flex-direction</code> and <code class="w3-codespan">flex-wrap</code></li>
  <li><code class="w3-codespan">justify-content</code> - Aligns the flex items when they do not use all available space on the main-axis (horizontally)</li>
  <li><code class="w3-codespan">align-items</code> - Aligns the flex items when they do not use all available space on the cross-axis (vertically)</li>
  <li><code class="w3-codespan">align-content</code> - Aligns the flex lines when there is extra space in the cross axis and flex items wrap</li>
</ul>
<!--stop-->
<hr>

<!--start-->
<h2>CSS flex-direction Property</h2>
<p>The <code class="w3-codespan"><a href="/cssref/css3_pr_flex-direction.php">flex-direction</a></code> property specifies the display-direction of flex items in the flex container.</p>
<p>This property can have one of the following values:</p>
<ul>
  <li><code class="w3-codespan">row</code> (default)</li>
  <li><code class="w3-codespan">column</code></li>
  <li><code class="w3-codespan">row-reverse</code></li>
  <li><code class="w3-codespan">column-reverse</code></li>
</ul>

<div class="w3-example">
<h3>Example</h3>
<p>The <code class="w3-codespan">row</code> value is the default value, and it 
displays the flex items horizontally (from left to right):</p>
...
<div class="flex-container2" style="flex-direction:row">
  <div class="item2">1</div>
  <div class="item2">2</div>
  <div class="item2">3</div>  
</div>
</div>
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss3_flexbox_flex-direction_row">Try it Yourself &raquo;</a></p>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>The <code class="w3-codespan">column</code> value displays the flex items vertically (from top to bottom):</p>
<div class="w3-code notranslate cssHigh">
  .flex-container {<br>&nbsp; 
  display: flex;<br>&nbsp; 
...
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss3_flexbox_flex-direction_column">Try it Yourself &raquo;</a></p>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>The <code class="w3-codespan">row-reverse</code> value displays the flex items horizontally (but from right to left):</p>
<div class="w3-code notranslate cssHigh">
  .flex-container {<br>&nbsp; 
  display: flex;<br>&nbsp; 
...
<p>Result:</p>
<div class="w3-white notranslate w3-padding">
<div class="flex-container2" style="flex-direction:row-reverse">
  <div class="item2">1</div>
  <div class="item2">2</div>
  <div class="item2">3</div>  
</div>
</div>
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss3_flexbox_flex-direction_row-reverse">Try it Yourself &raquo;</a></p>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>The <code class="w3-codespan">column-reverse</code> value displays the flex items vertically (but from bottom to top):</p>
<div class="w3-code notranslate cssHigh">
  .flex-container {<br>&nbsp; 
  display: flex;<br>&nbsp; 
...
<p>Result:</p>
<div class="w3-white notranslate w3-padding">
<div class="flex-container2" style="flex-direction:column-reverse">
  <div class="item2">1</div>
  <div class="item2">2</div>
  <div class="item2">3</div>  
</div>
</div>
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss3_flexbox_flex-direction_column-reverse">Try it Yourself &raquo;</a></p>
</div>
<!--stop-->
<hr>
...
<hr>
<!--start-->
<h2>CSS flex-wrap Property</h2>
<p>The <code class="w3-codespan"><a href="/cssref/css3_pr_flex-wrap.php">flex-wrap</a></code> property specifies whether the flex items should wrap or not, 
if there is not enough room for them on one flex line.</p>
<p>This property can have one of the following values:</p>
<ul>
  <li><code class="w3-codespan">nowrap</code> (default)</li>
  <li><code class="w3-codespan">wrap</code></li>
  <li><code class="w3-codespan">wrap-reverse</code></li>
</ul>
...
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss3_flexbox_flex-wrap_nowrap">Try it Yourself &raquo;</a></p>
</div>
...
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss3_flexbox_flex-wrap_wrap">Try it Yourself &raquo;</a></p>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>The <code class="w3-codespan">wrap-reverse</code> value specifies that the flex items will wrap 
...
<p>Result:</p>
<div class="w3-white notranslate w3-padding">
  <div class="flex-container2" style="flex-wrap:wrap-reverse">
    <div class="item2">1</div>
    <div class="item2">2</div>
    <div class="item2">3</div>  
    <div class="item2">4</div>
...
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss3_flexbox_flex-wrap_wrap-reverse">Try it Yourself &raquo;</a></p>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>CSS flex-flow Property</h2>
<p>The <code class="w3-codespan"><a href="/cssref/css3_pr_flex-flow.php">flex-flow</a></code> property is a shorthand property for setting both the <code class="w3-codespan">
<a href="/cssref/css3_pr_flex-direction.php">flex-direction</a></code> and 
<code class="w3-codespan"><a href="/cssref/css3_pr_flex-wrap.php">flex-wrap</a></code> properties.</p>
...
<h2>Flex Container Subpages</h2>
<p>Continue learning about flex container properties:</p>
<ul>
<li><a href="css3_flexbox_container_justify.asp">justify-content</a> - horizontal alignment of flex items</li>
<li><a href="css3_flexbox_container_align.asp">align-items &amp; align-content</a> - vertical alignment and true centering</li>
</ul>

<hr>
<div id="exercisecontainer" src="xrcise_css3_flexbox_container.js"></div>
<hr>
