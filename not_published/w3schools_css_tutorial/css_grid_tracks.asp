...
<h1>CSS <span class="color_h1">Grid Tracks</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="css_grid_container.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="css_grid_gap.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS Grid Tracks (Rows and Colums)</h2>
<p>Inside the grid container you define the number and size of the grid columns 
and rows.</p>
<p>For this, we will use the following properties:</p>
<ul>
  <li><code class="w3-codespan">grid-template-columns</code> - Defines the number and width of 
  the columns in the grid</li>
  <li><code class="w3-codespan">grid-template-rows</code> - Defines the number and height of 
  the rows in the grid</li>
  <li><code class="w3-codespan">grid-template-areas</code> - Defines how to display columns and rows, using named grid items</li>
</ul>
<!--stop-->
<hr>
<!--start-->
<h2>The CSS grid-template-columns Property</h2>
<p>The <code class="w3-codespan"><a href="/cssref/pr_grid-template-columns.php">grid-template-columns</a></code> property 
defines the number and width of the columns in the grid.</p>
<p>The value is a space-separated-list, where each value defines the width 
of the respective column.</p>
<p>Common values are:</p>
<ul>
  <li>Fixed lengths (100px 300px 200px)</li>
  <li>Percentages (20% 60% 20%)</li>
  <li>fr unit (1fr 2fr 1fr)</li>
  <li>auto (auto auto auto)</li>
  <li>repeat() (repeat(3, 1fr))</li>
  <li>minmax() (minmax(80px, 1fr) 150px 150px)</li>
</ul>
<hr>

<h2>CSS grid-template-columns: auto</h2>
<p>To create a grid layout with 3 columns of equal width, use the &quot;auto&quot; 
keyword.</p> 

<div class="w3-example">
<h3>Example</h3>
<p>Create a grid with 3 columns of equal width:</p>
...
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss_grid_grid-template-columns1">Try it Yourself &raquo;</a></p>
</div>
<!--stop-->
<hr>
...
<!--start-->
<h2>Grid Columns with Mixed Width</h2>
<p>To create a grid layout with 3 columns: 2 columns with a fixed width, and 
1 column with size &quot;auto&quot;.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Create a grid with a fixed size for column 1 and 2, and column 3 as auto size:</p>
<div class="w3-code notranslate cssHigh">
  .container {<br>
  &nbsp; display: grid;<br>&nbsp; 
  grid-template-columns: 80px 200px auto;<br>}
</div>
<p>Result:</p>
<div class="w3-white notranslate w3-padding">
<div class="grid-container" style="grid-template-columns:80px 200px auto;">
  <div>1</div>
  <div>2</div>
  <div>3</div>  
  <div>4</div>
...
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss_grid_grid-template-columns2">Try it Yourself &raquo;</a></p>
</div>

<div class="w3-panel ws-note">
<p><b>Note:</b> If you have more than 3 grid items in a 3 columns grid, the grid will automatically 
add new rows to put the items in.</p>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Grid Columns with the fr Unit</h2>
<p>The <code class="w3-codespan">fr</code> unit stands for &quot;fraction&quot;. 
This unit automatically divides the available space into fractions.</p>
<p>1fr will take 1 fraction of the available space, while 2fr will take 
2 fractions of the available space.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Here, each column will take up 33.3% of the container width, splitting it equally:</p>
<div class="w3-code notranslate cssHigh">
  .container {<br>
  &nbsp; display: grid;<br>&nbsp; 
...
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss_grid-template-columns_fr">Try it Yourself &raquo;</a></p>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Here, the second column will be twice as big as the others:</p>
<div class="w3-code notranslate cssHigh">
  .container {<br>
  &nbsp; display: grid;<br>&nbsp; 
...
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss_grid-template-columns_fr2">Try it Yourself &raquo;</a></p>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Grid Columns with the repeat() Function</h2>
<p>The CSS <code class="w3-codespan"><a href="/cssref/func_repeat.php">repeat()</a></code> function is used to repeat a set of columns or rows in a grid.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Use repeat() to create three equal-width columns in a grid:</p>
<div class="w3-code notranslate cssHigh">
  .container {<br>
  &nbsp; display: grid;<br>&nbsp; 
...
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss_grid-template-columns_repeat">Try it Yourself &raquo;</a></p>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Grid Columns with the minmax() Function</h2>
<p>The CSS <code class="w3-codespan"><a href="/cssref/func_minmax.php">minmax()</a></code> function is used to 
define a size-range greater than or equal to a min value and less than or equal to a max value.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Use minmax() to define that first column is at least 80px wide and can grow 
to 1fr:</p>
<div class="w3-code notranslate cssHigh">
  .container {<br>
  &nbsp; display: grid;<br>&nbsp; 
  grid-template-columns: minmax(80px, 1fr) 150px 150px;<br>}
</div>
<p>Result:</p>
<div class="w3-white notranslate w3-padding">
<div class="grid-container" style="grid-template-columns:minmax(80px,1fr) 150px 150px;">
  <div>1</div>
  <div>2</div>
  <div>3</div>  
  <div>4</div>
...
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss_grid-template-columns_minmax">Try it Yourself &raquo;</a></p>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>The CSS grid-template-rows Property</h2>
<p>The <code class="w3-codespan"><a href="/cssref/pr_grid-template-rows.php">grid-template-rows</a></code> property 
defines the number and height of the rows in the grid.</p>
...
<div class="w3-example">
<h3>Example</h3>
  <p>Set the first row in the grid to 80px high, and the second row to 200px 
  high:</p>
<div class="w3-code notranslate cssHigh">
  .container {<br>
  &nbsp; display: grid;<br>&nbsp; 
...
<p>Result:</p>
<div class="w3-white notranslate w3-padding">
<div class="grid-container" style="grid-template-rows:80px 200px;">
  <div>1</div>
  <div>2</div>
  <div>3</div>  
  <div>4</div>
...
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss_grid_grid-template-rows">Try it Yourself &raquo;</a></p>
</div>

<div class="w3-panel ws-note">
<p>Notice that the first row in the grid above is 80px high and the second row is 200px high. 
The next rows will use auto as default.</p>
</div>
<!--stop-->
