...
<h1>CSS <span class="color_h1">Inheritance</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="css_challenges_units.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="css_challenges_inheritance.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS Inheritance</h2>
<p>CSS inheritance is about what happens if no value is specified for a 
property on an element.</p>
<p>If no value is specified for a property, the value can either be inherited 
from the parent element, or be set to its initial (default) value. </p>
<p>For CSS inheritance, properties are categorized in two types:</p>
<ul>
  <li><strong>inherited properties</strong></li>
  <li><strong>non-inherited properties</strong></li>
</ul>
<hr>

<h2>Inherited Properties</h2>
<p>Inherited properties are, by default, set to the computed value of the parent element.</p>
<p>Properties related to text, such as <code class="w3-codespan">
<a href="/cssref/pr_text_color.php">color</a></code>, <code class="w3-codespan">
<a href="/cssref/pr_font_font-family.php">font-family</a></code>, <code class="w3-codespan">
<a href="/cssref/pr_font_font-size.php">font-size</a></code>, <code class="w3-codespan">
<a href="/cssref/pr_dim_line-height.php">line-height</a></code>, and <code class="w3-codespan">
<a href="/cssref/pr_text_text-align.php">text-align</a></code>, are typically 
inherited. This ensures consistent text styling throughout a document.</p>

<p>In the following example, the text inside the &lt;strong&gt; element will appear in 20px and in blue, since the 
&lt;strong&gt; element inherits the <code class="w3-codespan">
color</code> and the <code class="w3-codespan">
font-size</code> value from the parent (&lt;p&gt;) element.</p>

<div class="w3-example">
<h3>Example</h3>
<p>The color and font-size properties are inherited:</p>
<div class="w3-code notranslate htmlHigh">
  &lt;style&gt;<br>p {<br>&nbsp; color: blue;<br>&nbsp; font-size: 20px;<br>}<br>&lt;/style&gt;<br><br>&lt;body&gt;<br>&lt;p&gt;This 
  is a paragraph with some &lt;strong&gt;important&lt;/strong&gt; text.&lt;/p&gt;<br>
  &lt;/body&gt;</div>
<p>
<a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss_inherit_color">Try it Yourself &raquo;</a>
</p>
</div>
<!--stop-->
<hr>
...
<hr>
<!--start-->
<h2>Non-inherited Properties</h2>
<p>If there is not set a value for a non-inherited property, 
the value is set to the initial (default) value of that property.</p>
<p>Properties related to the box model or layout, like <code class="w3-codespan">
<a href="/cssref/pr_border.php">border</a></code>, <code class="w3-codespan">
<a href="/cssref/css3_pr_background.php">background</a></code>, <code class="w3-codespan">
<a href="/cssref/pr_margin.php">margin</a></code>, <code class="w3-codespan">
<a href="/cssref/pr_padding.php">padding</a></code>, <code class="w3-codespan">
<a href="/cssref/pr_dim_width.php">width</a></code>, and <code class="w3-codespan">
<a href="/cssref/pr_dim_height.php">height</a></code>, are typically not 
inherited.</p>

<p>In the following example, the &lt;strong&gt; element, inside the &lt;p&gt; element, will not have an 
additional border (since the initial 
value of <code class="w3-codespan">
<a href="/cssref/pr_border-style.php">border-style</a></code> is none).</p>

<div class="w3-example">
<h3>Example</h3>
<p>The border property is not inherited:</p>
<div class="w3-code notranslate htmlHigh">
  &lt;style&gt;<br>p {<br>&nbsp; border: 1px solid red;<br>}<br>&lt;/style&gt;<br><br>&lt;body&gt;<br>&lt;p&gt;This 
  is a paragraph with some &lt;strong&gt;important&lt;/strong&gt; text.&lt;/p&gt;<br>
  &lt;/body&gt;</div>
<p>
<a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss_inherit_non">Try it Yourself &raquo;</a>
</p>
</div>
<!--stop-->
<hr>
...
<p>The <code class="w3-codespan"><a href="/cssref/css_inherit.php">inherit</a></code> keyword 
is used to explicitly specify inheritance. It 
works on both inherited and non-inherited properties.</p>
<p>In the following example, the &lt;strong&gt; element, inside the &lt;p&gt; element, will have an additional border, since 
we have used the <code class="w3-codespan">inherit</code> 
keyword to explicitly specify that the border value should be inherit.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Explicitly set the inheritance with the <code class="w3-codespan">inherit</code> keyword:</p>
<div class="w3-code notranslate htmlHigh">
  &lt;style&gt;<br>p {<br>&nbsp; border: 1px solid red;<br>}<br><br>strong {<br>&nbsp; border: inherit;<br>}<br>&lt;/style&gt;<br><br>&lt;body&gt;<br>&lt;p&gt;This 
  is a paragraph with some &lt;strong&gt;strong&lt;/strong&gt; text.&lt;/p&gt;<br>
  &lt;/body&gt;</div>
<p>
<a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss_inherit_keyword">Try it Yourself &raquo;</a>
</p>
</div>
<!--stop-->
