...
<h1>CSS <span class="color_h1">Button Hover Effects</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css3_buttons.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css3_buttons_groups.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<p class="intro">This page covers CSS button hover effects, shadows, disabled states, and width.</p>
<hr>

<h2>CSS Hoverable Buttons</h2>
<p>The CSS <code class="w3-codespan"><a href="/cssref/sel_hover.php">:hover</a></code> pseudo-class is used to change the style of a button when you mouse over it.</p>
<p><strong>Tip:</strong> Use the CSS <code class="w3-codespan"><a href="/cssref/css3_pr_transition-duration.php">transition-duration</a></code> property to determine the 
speed of the "hover" effect:</p>

<button type="button" class="btn border111">Green</button>
<button type="button" class="btn border222">Blue</button>
<button type="button" class="btn border333">Red</button>
<button type="button" class="btn border444">Grey</button>
<button type="button" class="btn border555">Black</button>
...
.button {<br>&nbsp; transition-duration: 0.4s;<br>}<br><br>.button:hover {<br>&nbsp; 
background-color: #4CAF50; /* Green */<br>&nbsp; color: white;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_buttons_hover" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<h2>CSS Buttons With Shadow</h2>
<p>The CSS <code class="w3-codespan"><a href="/cssref/css3_pr_box-shadow.php">box-shadow</a></code> property 
is used to add a shadow to a button:</p>
...
<div class="w3-example">
<h3>Example</h3>
  <p>Buttons with shadows:</p>
<div class="w3-code notranslate cssHigh">
  .button1 {box-shadow:0 8px 16px 0 rgba(0,0,0,0.6)}<br>.button2:hover 
  {box-shadow:0 8px 16px 0 rgba(0,0,0,0.6)}</div>
<a target="_blank" href="tryit.asp?filename=trycss_buttons_shadow" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->

<h2>CSS Disabled Button</h2>
<p>The CSS <code class="w3-codespan"><a href="/cssref/css3_pr_opacity.php">opacity</a></code> property 
can be used to add transparency to a button (creates a 
"disabled" look).</p>
<p><strong>Tip:</strong> You can also add the <code class="w3-codespan"><a href="/cssref/pr_class_cursor.php">cursor</a></code> property with a value of 
"not-allowed", which will display a "no parking sign" when you mouse over the button:</p>
...
<div class="w3-code notranslate cssHigh">
.disabledbtn {<br>&nbsp; opacity: 0.6;<br>&nbsp;&nbsp;cursor: not-allowed;<br>}</div>
...
<p>By default, the size of a button is determined by its text content.</p>
<p>The CSS <code class="w3-codespan"><a href="/cssref/pr_dim_width.php">width</a></code> property 
can be used to define a specific width for a button.</p>
<p><strong>Tip:</strong> Use pixels to set a fixed width, or percent for a responsive width (e.g. 50% of its parent element).</p>

<button type="button" class="btn btn1 width1">250px</button><br>
<button type="button" class="btn btn2 width2">50%</button><br>
<button type="button" class="btn btn1 width3">100%</button>

<div class="w3-example">
<h3>Example</h3>
  <p>Buttons with different widths:</p>
<div class="w3-code notranslate cssHigh">
...
<a target="_blank" href="tryit.asp?filename=trycss_buttons_image" class="ws-btn w3-margin-top">Try it Yourself &raquo;</a>
<hr>
<div id="exercisecontainer" src="xrcise_css3_buttons_hover.js"></div>
<hr>
