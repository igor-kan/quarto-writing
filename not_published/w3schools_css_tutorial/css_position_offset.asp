...
<html lang="en-US">
<head>
<title>CSS Positioning Offsets</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">Position</span> Offsets</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_challenges_position.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="css_challenges_position_offset.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>Positioning with top, right, bottom, and left</h2>
<p>The <code class="w3-codespan">top</code>, <code class="w3-codespan">right</code>, <code class="w3-codespan">bottom</code>, and <code class="w3-codespan">left</code> properties are used to position elements.</p>
<p>These properties only work on <strong>positioned elements</strong> (elements with <code class="w3-codespan">position</code> set to <code class="w3-codespan">relative</code>, <code class="w3-codespan">absolute</code>, <code class="w3-codespan">fixed</code>, or <code class="w3-codespan">sticky</code>).</p>
<!--stop-->
<hr>
<!--start-->
<h2>Positioning Text On an Image</h2>
<p>How to position text on an image:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="notranslate">
  <div style="position:relative;text-align:center;">
    <img src="img_5terre_wide.jpg" alt="Cinque Terre" style="width:100%;height:auto;opacity:0.5">
