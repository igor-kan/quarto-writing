...
<a class="w3-left w3-btn" href="css_challenges_css3_rounded_corners.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_challenges_css3_border_images.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
...
<a href="/cssref/css3_pr_border-image.php">border-image</a></code> property, you can 
define an image to be used as the border around an element.</p>
</div>
<hr>

<h2>CSS border-image Property</h2>
<p>The <code class="w3-codespan"><a href="/cssref/css3_pr_border-image.php">border-image</a></code> property allows you to 
define an image to be used as the border around an element, instead of the normal border.</p>

<p>This property takes an image and slices it into nine sections, 
...
<p>The <code class="w3-codespan">border-image</code> property is a shorthand property for the 
following properties:</p>
<ul>
  <li><code class="w3-codespan"><a href="/cssref/css3_pr_border-image-source.php">border-image-source</a></code> 
  - defines the path to the image</li>
  <li><code class="w3-codespan"><a href="/cssref/css3_pr_border-image-slice.php">border-image-slice</a></code> 
  - defines how to slice the image</li>
  <li><code class="w3-codespan"><a href="/cssref/css3_pr_border-image-width.php">border-image-width</a></code> 
  - defines the width of the image</li>
  <li><code class="w3-codespan"><a href="/cssref/css3_pr_border-image-outset.php">border-image-outset</a></code> 
  defines the amount by which the border image area extends beyond the border box</li>
  <li><code class="w3-codespan"><a href="/cssref/css3_pr_border-image-repeat.php">border-image-repeat</a></code> 
  - defines how to repeat the image</li>
</ul>

<p><strong>Note:</strong> For <code class="w3-codespan">border-image</code> to work, the element also needs the 
<code class="w3-codespan"><a href="/cssref/pr_border.php">border</a></code> property set!</p>
<hr>

<h2>CSS border-image Examples</h2>
<p>We will use the following image (named &quot;border.png&quot;):</p>
<p><img src="border.png" alt="Border" style="width:81px;height:81px"></p>
<p>In the following example, the url(border.png) specifies the source image, the 
number 30 slices the image 30 pixels from each edge, and the <code class="w3-codespan">
round</code> value specifies that the middle section of the image is tiled (repeated) to fill the area (and rescaled to fit, if needed):</p>

<div id="border_image">An image as the border!</div>
...
<div class="w3-code notranslate cssHigh">
   #borderimg
{<br>
&nbsp;&nbsp;border: 10px solid transparent; /* Required for border-image */<br>
...
<p>Here, the <code class="w3-codespan">stretch</code> value specifies that the middle section of the image is stretched to fill the area:</p>

<div id="border_image2">An image as the border!</div>
...
<p>Different slice values completely changes the look of the border image:</p>
<p>Example 1:</p>
<div id="border_image3">border-image: url(border.png) 50 round;</div>

<p>Example 2:</p>
<div id="border_image4">border-image: url(border.png) 20% round;</div>

<p>Example 3:</p>
<div id="border_image5">border-image: url(border.png) 30% round;</div>
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_css3_border_images.js"></div>
<hr>
