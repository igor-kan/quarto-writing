...
<h1>CSS <span class="color_h1">Grid Items</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="css_challenges_grid_container.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="css_grid_item_name.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS Grid Items</h2>
<p>A grid container contains one or more grid items.</p>
<p>All direct child elements of a grid container automatically become grid items.</p>
<p>Below is a grid container with five grid items:</p>
...
<p><a class="ws-btn" target="_blank" href="tryit.asp?filename=trycss_grid_item">Try it Yourself &raquo;</a></p>
<!--stop-->
<hr>
<!--start-->
<h2>CSS Sizing/Spanning Grid Items</h2>
<p>A grid item can span over mulitiple columns or rows.</p>
<p>We can specify where to start and end a grid item by using the following properties:</p>
<ul>
  <li><code class="w3-codespan">grid-column-start</code> - Specifies on which column-line the grid item will start</li>
  <li><code class="w3-codespan">grid-column-end</code> - Specifies on which column-line the grid item will end</li>
  <li><code class="w3-codespan">grid-column</code> - Shorthand property for <code class="w3-codespan">grid-column-start</code> and <code class="w3-codespan">grid-column-end</code></li>
  <li><code class="w3-codespan">grid-row-start</code> - Specifies on which row-line the grid item will start</li>
  <li><code class="w3-codespan">grid-row-end</code> - Specifies on which row-line the grid item will end</li>
  <li><code class="w3-codespan">grid-row</code> - Shorthand property for <code class="w3-codespan">grid-row-start</code> and <code class="w3-codespan">grid-row-end</code></li>
</ul>
<p>The lines between the columns in a grid are called <em>column-lines</em>, and the lines between the rows in a grid are called <em>row-lines</em>.</p>
<p>We can refer to line numbers when placing a grid item in a grid container.</p>
<!--stop-->
<hr>

<!--start-->
<h2>CSS grid-column-start and grid-column-end</h2>
<p>The <code class="w3-codespan"><a href="/cssref/pr_grid-column-start.php">grid-column-start</a></code> property 
specifies on which column-line the grid item will start.</p>
<p>The <code class="w3-codespan"><a href="/cssref/pr_grid-column-end.php">grid-column-end</a></code> property 
specifies on which column-line the grid item will end.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Let the first grid item start at column-line 1, and end on column-line 3:</p>
...
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss_grid_lines">Try it Yourself &raquo;</a></p>
</div>
<!--stop-->
<hr>
...
<hr>
<!--start-->
<h2>The CSS grid-column Property</h2>
<p>The <code class="w3-codespan"><a href="/cssref/pr_grid-column.php">grid-column</a></code> property is a shorthand property for the <code class="w3-codespan">
<a href="/cssref/pr_grid-column-start.php">grid-column-start</a></code> and the <code class="w3-codespan">
<a href="/cssref/pr_grid-column-end.php">grid-column-end</a></code> properties.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Let the first grid item start at column-line 1, and let it span 2 columns:</p>
<div class="w3-code notranslate cssHigh">
  .item1 {<br><strong>
  &nbsp; </strong>grid-column: 1 / span 
  2;<br>}</div>
<p>Result:</p>
<div class="w3-white notranslate w3-padding">
<div class="grid-container">
...
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss_grid_lines3">Try it Yourself &raquo;</a></p>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>CSS grid-row-start and grid-row-end</h2>
<p>The <code class="w3-codespan"><a href="/cssref/pr_grid-row-start.php">grid-row-start</a></code> property 
specifies on which row-line the grid item will start.</p>
<p>The <code class="w3-codespan"><a href="/cssref/pr_grid-row-end.php">grid-row-end</a></code> property 
specifies on which row-line the grid item will end.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Let the first grid item start at row-line 1, and end on row-line 3:</p>
<div class="w3-code notranslate cssHigh">
  .item1 {<br><strong>
...
<div class="w3-white notranslate w3-padding">
<div class="grid-container">
  <div style="grid-row-start:1;grid-row-end:3;">1</div>
  <div>2</div>
  <div>3</div>  
  <div>4</div>
  <div>5</div>
...
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss_grid_lines2">Try it Yourself &raquo;</a></p>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>The CSS grid-row Property</h2>
<p>The <code class="w3-codespan"><a href="/cssref/pr_grid-row.php">grid-row</a></code> property is a shorthand property for the <code class="w3-codespan">
<a href="/cssref/pr_grid-row-start.php">grid-row-start</a></code> and the <code class="w3-codespan">
<a href="/cssref/pr_grid-row-end.php">grid-row-end</a></code> properties.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Let the first grid item start at row-line 1, and let it span 2 rows:</p>
<div class="w3-code notranslate cssHigh">
  .item1 {<br><strong>
  &nbsp; </strong>grid-row: 1 / span 2;<br>}</div>
<p>Result:</p>
<div class="w3-white notranslate w3-padding">
<div class="grid-container">
...
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss_grid_lines4">Try it Yourself &raquo;</a></p>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Combine grid-column and grid-row</h2>
<p>Here we use both the <code class="w3-codespan"><a href="/cssref/pr_grid-column.php">grid-column</a></code> 
and <code class="w3-codespan"><a href="/cssref/pr_grid-row.php">grid-row</a></code> properties 
to let a grid item span both columns and rows.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Let the first grid item start at column-line 1, and let it span 2 columns, also let the first grid item start at row-line 1, and let it span 2 rows:</p>
<div class="w3-code notranslate cssHigh">
  .item1 {<br>&nbsp; grid-column: 1 / span 2;<br>&nbsp; grid-row: 1 / span 2;<br>}</div>
<p>Result:</p>
<div class="w3-white notranslate w3-padding">
<div class="grid-container">
...
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss_grid_lines5">Try it Yourself &raquo;</a></p>
</div>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_grid_columns_rows.js"></div>
<hr>


<h2>All CSS Grid Item Properties</h2>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    ...
    <td>Aligns the content for a specific grid item along the column axis</td>
  </tr>
  <tr>
    <td><a href="/cssref/pr_grid-area.php">grid-area</a></td>
    <td>A shorthand property for the <em>grid-row-start, grid-column-start</em>, <em>grid-row-end </em>and the <em>grid-column-end</em> properties</td>
  </tr>
  <tr>
  ...
  <tr>
    <td><a href="/cssref/css_pr_justify-self.php">justify-self</a></td>
    <td>Aligns the content for a specific grid item along the row axis</td>
  </tr>
  <tr>
    <td><a href="/cssref/css_pr_place-self.php">place-self</a></td>
    <td>A shorthand property for the <em>align-self</em> and the <em>
    justify-self</em> properties</td>
  </tr>
  </table>
