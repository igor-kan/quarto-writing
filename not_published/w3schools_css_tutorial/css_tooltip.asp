...
<a class="w3-left w3-btn" href="css_challenges_css3_animations.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_tooltip_arrows.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS Tooltip</h2>

<p>A CSS tooltip is used to specify extra information about something when the 
...
<hr>
<!--start-->
<h2>CSS Create a Basic Tooltip</h2>
...
black; /* Add dots under the hoverable text */<br>&nbsp; cursor: pointer;<br>}<br><br>/* Tooltip text 
*/<br>.tooltiptext {<br>&nbsp;&nbsp;visibility: hidden; /* 
  Hidden by default */<br>&nbsp;&nbsp;width: 130px;<br>
  &nbsp; 
background-color: black;<br>&nbsp;&nbsp;color: #ffffff;<br>&nbsp;&nbsp;text-align: center;<br>
  &nbsp; padding: 5px 0;<br>&nbsp; 
border-radius: 6px;<br>&nbsp; position: absolute;<br>
  &nbsp; z-index: 1; /* Ensure tooltip is displayed above 
  content */<br>}<br><br>/* Show 
the tooltip text on hover */<br>.tooltip:hover 
...
over me</span><br>
&nbsp; &lt;span class=&quot;tooltiptext&quot;&gt;<span style="color:black;">Some 
  tooltip 
...
<ul>
  <li>Use a container element (like &lt;div&gt;) and add the 
  <code class="w3-codespan">&quot;tooltip&quot;</code> class to it. When the user mouse over this &lt;div&gt;, it will show the 
tooltip text.</li>
  <li>The tooltip text is placed inside an inline element (like &lt;span&gt;) with 
  <code class="w3-codespan">class=&quot;tooltiptext&quot;</code>.</li>
</ul>
<p><strong>CSS:</strong></p>
<ul>
  <li>The <code class="w3-codespan">tooltip</code> class use 
  <code class="w3-codespan">position:relative</code>, 
which is needed to position the tooltip text (<code class="w3-codespan">position:absolute</code>).
  <strong>Tip:</strong> See examples below on how to position the tooltip.</li>
  <li>The <code class="w3-codespan">tooltiptext</code> class holds the actual 
  tooltip text. It is hidden by default, and will be visible on hover.</li>
  <li>The <code class="w3-codespan">:hover</code> selector is used to show the tooltip text when the user moves the 
mouse over the &lt;div&gt; with <code class="w3-codespan">class=&quot;tooltip&quot;</code>.</li>
</ul>
<!--stop-->
<hr>
...
<p>You can position the tooltip as you like. Here we will show how to position 
the tooltip to the left, right, top and bottom.</p>

<h3>Right- and Left-aligned Tooltip</h3>
...
<h3>Top- and Bottom-aligned Tooltip</h3>
<p>If you want the tooltip to appear on top or on the bottom, see examples 
below. Note that we use the <code class="w3-codespan">margin-left</code> property with a value of minus 65 
pixels. This is to center the tooltip above/below the hoverable text. It is set 
to the half of the tooltip's width (130/2 = 65).</p>

<div class="w3-example">
<h3>Example</h3>
  <p>Top-aligned tooltip:&nbsp;</p>
<div class="w3-code notranslate cssHigh">
  .tooltiptext {<br>&nbsp; width: 130px;<br>&nbsp; 
bottom: 100%;<br>&nbsp; left: 
  65%; <br>&nbsp;&nbsp;margin-left: -65px; /* Use half of the width 
(130/2 = 65), to center the tooltip */<br>}
</div>
<p>Result:</p>
   <div class="w3-padding w3-white notranslate w3-center">
     <div class="tooltip">Hover over me
...
<div class="w3-code notranslate cssHigh">
&nbsp;.tooltiptext {<br>&nbsp; width: 130px;<br>&nbsp; top: 100%;<br>&nbsp; left: 
50%; <br>&nbsp;&nbsp;margin-left: -65px; /* Use half of the width 
(130/2 = 65), to center the tooltip */<br>}
</div>
<p>Result:</p>
    <div class="w3-padding w3-white notranslate w3-center">
...
<hr>
<!--start-->
<h2>Fade-in Tooltip</h2>

<p>If you want a tooltip that fades in, use the CSS <code class="w3-codespan">transition</code> property 
and the <code class="w3-codespan">opacity</code> 
property, and go from being completely invisible to 100% visible, in a number of specified seconds 
(2 second in our example):</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  .tooltiptext {<br>&nbsp; opacity: 0;<br>&nbsp; 
transition: opacity 2s;<br>}<br><br>.tooltip:hover 
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_tooltip.js"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_challenges_css3_animations.asp">&#10094; Previous</a>
