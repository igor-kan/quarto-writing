...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="css_challenges_css3_backgrounds.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="css_colors_keywords.asp">Next &#10095;</a>
</div>
<hr>
...
<!--start-->
<h2>RGBA Colors</h2>
<p>RGBA color values are an extension of <a href="css_colors_rgb.asp">RGB colors</a> with an alpha channel - which specifies the opacity 
for a color.</p>
...
<p>&nbsp;The alpha parameter is a number between 0.0 
...
<!--start-->
<h2>HSLA Colors</h2>
<p>HSLA color values are an extension of <a href="css_colors_hsl.asp">HSL colors</a> with an alpha channel - which specifies the opacity 
for a color.</p>
...
between 0.0 (fully transparent) and 1.0 (fully opaque):</p>
...
<hr>
<!--start-->
<h2>CSS opacity Property</h2>
<p>The <code class="w3-codespan"><a href="/cssref/css3_pr_opacity.php">opacity</a></code> property sets the opacity for 
...
<p class="w3-margin-top"><strong>Notice</strong> that the text inside the 
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_css3_colors.js"></div>
<hr>
