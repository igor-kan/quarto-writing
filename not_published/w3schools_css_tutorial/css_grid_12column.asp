...
<html lang="en-US">
<head>
<title>CSS 12-Column Grid Layout</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">12-Column Grid Layout</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="css_challenges_grid_item_order.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="css_challenges_grid_12column.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->

<h2>CSS 12-Column Grid Layout</h2>
<p>A 12-column grid is a common and flexible method for structuring web page content, particularly for responsive web design.</p>
<p>The 12-column grid system divides the available horizontal space into 12 equal-width columns, allowing for 
precise placement and sizing of elements within the layout.</p>
<hr>

<h2>Benefits of a 12-Column Grid</h2>
<ul>
  <li><strong>Flexibility:</strong> The number 12 is highly divisible. Designers 
  can easily create designs with halves, thirds, and quarters (2 columns of 6, 3 columns of 4, 4 columns of 3).</li>
  <li><strong>Responsiveness:</strong> A 12-column grid is 
  ideal for building responsive websites that adapt to different screen sizes (desktop, 
  tablet, or mobile) with mediaqueries. This provides a consistent user experience across 
  all platforms.</li>
  <li><strong>Efficiency:</strong> Having a pre-defined structure speeds up the 
  design process.</li>
</ul>
<p>Here is how to create a basic 12-column CSS Grid layout:</p>
<hr>

<h2>Define the Grid Container</h2>
<p>Apply <code class="w3-codespan">display: grid;</code> to the grid container.</p>
<hr>

<h2>Create the 12 Columns</h2>
<p>Use the <code class="w3-codespan">grid-template-columns</code> property to define the 12 columns.</p>
<p>The code <code class="w3-codespan">repeat(12, [col-start] 1fr);</code> creates a 12-column grid with equal-width,  
and names the start line of each column track <code class="w3-codespan">
col-start</code>.</p>
<ul>
  <li> <code class="w3-codespan">repeat(12,..)</code>: Tells the grid to repeat the following track 
definition 12 times, resulting in 12 columns.</li>
  <li> <code class="w3-codespan">[col-start]</code>: This creates a named grid line. Because it is repeated 12 times, 
you will have 12 lines named col-start. This is useful for placing grid items at 
specific start points within the grid.</li>
  <li> <code class="w3-codespan">1fr</code>: A fractional unit that 
  represents one fraction of the total available space in the grid container. By 
  using 1fr, each of the 12 columns will be an equal, fluid width.</li>
</ul>
<hr>

<h2>Place the Grid Items</h2>
<p>Grid items can then be placed and 
sized across these 12 columns using <code class="w3-codespan">grid-column</code>.</p>
<ul>
  <li>To make a grid item span a certain number of columns, use
  <code class="w3-codespan">grid-column: span &lt;number&gt;;</code> or 
  <code class="w3-codespan">grid-column: 
&lt;start-line&gt; / span &lt;number&gt;;</code>.</li>
  <li>You can also define the start and end 
grid lines for an item using <code class="w3-codespan">grid-column: &lt;start-line&gt; 
/ &lt;end-line&gt;;</code>.</li>
</ul>
...
<h2>Use Mediaqueries to Add Breakpoints</h2>
<p>Always design for mobile first: <span lang="no-bok">Here we display the 
sections in the source order (from top to bottom) for screens less than 576 pixels wide.</span></p>
<p><span lang="no-bok">Then, we go to a two-column layout for screens between 
576 and 767 pixels wide.</span></p>
<p><span lang="no-bok">Then, we go to a three-column layout for screens over 767 
pixels wide.</span></p>


<div class="w3-example">
<h3>Example</h3>
  <p>Complete example of a 12-column grid layout:</p>
<div class="w3-code notranslate cssHigh">
  * {<br>&nbsp; box-sizing: border-box;<br>}<br><br>.container {<br>&nbsp; display: grid;<br>
  &nbsp;
  grid-template-columns: repeat(12, [col-start] 1fr);<br>&nbsp; gap: 20px;<br>}<br><br>
  nav ul {<br>&nbsp; list-style: none;<br>&nbsp; margin: 0;<br>&nbsp; padding: 0;<br>}<br><br>/* 
  Mobile first */<br>.container &gt; * {<br>&nbsp; border: 1px solid green;<br>
  &nbsp;
  background-color: beige;<br>&nbsp; padding: 10px;<br>&nbsp; grid-column: col-start / span 
  12;<br>}<br><br>@media (min-width: 576px) {<br>&nbsp; .sidebar {<br>&nbsp;&nbsp;&nbsp; grid-column: 
  col-start / span 3;<br>&nbsp;&nbsp;&nbsp; grid-row: 3;<br>&nbsp; }<br>&nbsp; .ads {<br>&nbsp;&nbsp;&nbsp; grid-column: col-start / 
  span 3;<br>&nbsp; }<br>&nbsp; .content, .footer {<br>&nbsp;&nbsp;&nbsp; grid-column: col-start 
  4 / span 9;<br>&nbsp; }<br>&nbsp; nav ul {<br>&nbsp;&nbsp;&nbsp; display: flex;<br>&nbsp;&nbsp;&nbsp; justify-content: 
  space-between;<br>&nbsp; }<br>}<br><br>@media (min-width: 768px) {<br>&nbsp; .nav {<br>
  &nbsp;&nbsp;&nbsp;
  grid-column: col-start / span 2;<br>&nbsp;&nbsp;&nbsp; grid-row: 2 / 4;<br>&nbsp; }<br>&nbsp; .content {<br>
  &nbsp;&nbsp;&nbsp;
  grid-column: col-start 3 / span 8;<br>&nbsp;&nbsp;&nbsp; grid-row: 2 / 4;<br>&nbsp; }<br>&nbsp; .sidebar {<br>
  &nbsp;&nbsp;&nbsp;
  grid-column: col-start 11 / span 2;<br>&nbsp; }<br>&nbsp; .ads {<br>
  &nbsp;&nbsp;&nbsp;
  grid-column: col-start 11 / span 2;<br>&nbsp; }<br>&nbsp; .footer {<br>
  &nbsp;&nbsp;&nbsp;
  grid-column: col-start / span 12;<br>&nbsp; }<br>&nbsp; nav ul {<br>&nbsp;&nbsp;&nbsp; flex-direction: column;<br>
  &nbsp;
  }<br>}</div>
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss_grid_12columnresponsive">Try it Yourself &raquo;</a></p>
</div>
<!--stop-->
