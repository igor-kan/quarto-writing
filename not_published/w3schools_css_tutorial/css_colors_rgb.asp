...
<html lang="en-US">
<head>
<title>CSS RGB and RGBA Colors</title>
...
<h1>CSS <span class="color_h1">RGB Colors</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_colors.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_colors_hex.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>RGB Value</h2>
...
<p style="font-size:20px;font-weight:bold">rgb(<em>red,</em> <em>green</em>, <em>blue</em>)</p>
...
<div class="w3-container xw3-light-grey">
  ...
  <div class="w3-row w3-container">
    ...
    <div class="w3-col m3 w3-container w3-center">
      ...
      <div id="valGreen2A" xstyle="background-color:#00ff00;border-radius:5px;opacity:0.8">0</div>
    </div>
    <div class="w3-col m3 w3-container w3-center">
      <p>BLUE</p>
      <input onchange="changeRGBA()" oninput="changeRGBA()" type="range" id="slideBlueA" name="slideBlueA" value="71" min="0" max="255">
      <div id="valBlue2A" xstyle="background-color:blue;border-radius:5px;color:white;opacity:0.8">0</div>
    </div>
    <div class="w3-col m3 w3-container w3-center">
      <p>ALPHA</p>
      <input onchange="changeRGBA()" oninput="changeRGBA()" type="range" id="slideAlphaA" name="slideAlphaA" value="5" min="0" max="10">
      <div id="valAlpha2A" xstyle="background-color:blue;border-radius:5px;color:white;opacity:0.8">0</div>
    </div>
  </div>
</div>
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_colors_rgb.js"></div>

<hr>
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: CSS Colors RGB & RGBA</h2>
  <a href="https://youtu.be/6tbUo6PXc88&list=PLP9IO4UYNF0UCaUSF3XNZ1U9f01E5h5PM" class="ga-featured ga-youtube" target="blank_" >
    <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
      ...
      <picture id="yt_div">
        <source srcset="images/css_colors_rgb.webp" type="image/webp" />
        <img src="images/css_colors_rgb.png" style="max-width:100%;height:auto;border-radius:6px" alt="Tutorial on YouTube" loading="lazy">
      </picture>
    </div>
  </a>
</div>
