...
<a class="w3-left w3-btn" href="css_colors_rgb.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_colors_hsl.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>HEX Value</h2>
...
<p style="font-size:20px;font-weight:bold;">#<em>rrggbb</em></p>
...
<a target="_blank" href="tryit.asp?filename=trycss_color_hex_3digit" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_colors_hex.js"></div>
<hr>
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: CSS Colors Hex</h2>
  <a href="https://youtu.be/LLmCr_201GU&list=PLP9IO4UYNF0UCaUSF3XNZ1U9f01E5h5PM" class="ga-featured ga-youtube" target="blank_" >  
    <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
      ...
      <picture id="yt_div">
        <source srcset="images/css_colors_hex.webp" type="image/webp" />
        <img src="images/css_colors_hex.png" style="max-width:100%;height:auto;border-radius:6px" alt="Tutorial on YouTube" loading="lazy">
      </picture>
    </div>
  </a>
</div>
