...
<html lang="en-US">
<head>
<title>CSS Pagination Styles</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">Pagination Styles</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css3_pagination.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_challenges_css3_pagination.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<p class="intro">This page covers advanced pagination styling including hover effects, transitions, and breadcrumbs.</p>
<hr>

<h2>Pagination with Hover Effect</h2>
<p>Use the <code class="w3-codespan"><a href="/cssref/sel_hover.php">:hover</a></code> 
selector to change the background color of each page link when the user hovers over them:</p>
...
<h3>Example</h3>
  <p>Pagination with hover effect:</p>
<div class="w3-code notranslate cssHigh">
  .pagination li a:hover:not(.active) {<br>&nbsp; background-color: lightgray;<br>
  }</div>
<a target="_blank" href="tryit.asp?filename=trycss_ex_pagination_hover" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Transition Effect on Hover</h2>
<p>Add the <code class="w3-codespan"><a href="/cssref/css3_pr_transition.php">transition</a></code> property to the page links to create a transition effect on hover:</p>
...
<div class="w3-example">
<h3>Example</h3>
  <p>Add transition effect on hover:</p>
<div class="w3-code notranslate cssHigh">
  .pagination li a {<br>&nbsp; display: block;<br>&nbsp; padding: 8px 12px;<br>&nbsp; 
  text-decoration: none;<br>&nbsp; border: 1px solid gray;<br>&nbsp; color: 
  black;<br>&nbsp; margin: 0 4px;<br>&nbsp; border-radius: 5px;<br>&nbsp; 
  transition: background-color 1s; <br>}</div>
...
<p>Another variation of pagination is a so-called &quot;breadcrumb&quot;:</p>

<ul class="breadcrumb">
  <li><a href="#">Home</a></li>
  <li><a href="#">Pictures</a></li>
  <li><a href="#">Summer 25</a></li>
  <li>Italy</li>
</ul>

<div class="w3-example">
<h3>Example</h3>
  <p>Create a breadcrumb:</p>
<div class="w3-code notranslate cssHigh">
ul.breadcrumb {<br>&nbsp; padding: 8px;<br>&nbsp; 
list-style: none;<br>&nbsp; background-color: #eee;<br>}<br><br>
ul.breadcrumb li {display: inline;}<br>ul.breadcrumb li a {color: green;}<br><br>ul.breadcrumb li+li:before {<br>&nbsp; 
padding: 8px;<br>&nbsp; color: black;<br>&nbsp;&nbsp;content: &quot;/\00a0&quot;;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_breadcrumbs" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->

<hr>
<div id="exercisecontainer" src="xrcise_css3_pagination_styles.js"></div>
<hr>
