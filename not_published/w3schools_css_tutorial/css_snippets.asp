...
<link href="/howto/howto.css" rel="stylesheet">
</head>
<body>
...
<h1>CSS <span class="color_h1">Snippets</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_editor.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_quiz.asp">Next &#10095;</a>
</div>
<hr>

<h2>CSS Snippets</h2>
<p>Have you ever seen a cool feature on a website and thought "How do they do that"?</p>
<p>We have collected a bunch of CSS snippets that you can use in your projects, for free:</p>

<div class="w3-card-4 w3-round" style="margin-top:28px;">
 <div class="w3-container">
   <h2><a target="_blank" href="/howto/howto_css_image_text_blocks.asp" class="h2-anchor">Image Text Blocks</a></h2>
   <div style="position:relative;">
  <img src="/howto/img_nature_wide.jpg" alt="Nature" style="width:100%;height:auto">
  <div style="position:absolute;bottom:16px;right:16px;background:black;color:white;padding:10px 12px;">Nature<br>Beautiful sunrise</div>
  </div>
  <div class="howto-container">
    <p><a target="_blank" href="/howto/howto_css_image_text_blocks.asp" class="ws-btn">Learn How To &raquo;</a></p>
  </div>
 </div>
</div>
<br>
...
<div class="w3-card-4 w3-round w3-container">
  <h2><a target="_blank" href="/howto/howto_css_alert_buttons.asp" class="h2-anchor">Alert Buttons</a></h2>
...
<button class="btnalert default">Default</button>  
  <div class="howto-container">
    <p><a target="_blank" href="/howto/howto_css_alert_buttons.asp" class="ws-btn">Learn How To &raquo;</a></p>
  </div>
</div>
<br>

<div class="w3-card-4 w3-container w3-round">
  <h2><a target="_blank" href="/howto/howto_css_loader.asp" class="h2-anchor">Loaders</a></h2>
  <p><div class="w3-row"><div class="w3-half"><div class="loader"></div> </div>
  <div class="w3-half">
  <div class="loader2"></div></div></div></p>
  <div class="howto-container">
    <p><a target="_blank" href="/howto/howto_css_loader.asp" class="ws-btn">Learn How To &raquo;</a></p>
  </div>
</div>
<br>

<div class="w3-card-4 w3-container w3-round">
  <h2><a target="_blank" href="/howto/howto_js_topnav.asp" class="h2-anchor">Top Navigation</a></h2>
<div class="w3-bar w3-black">
  ...
  <div class="howto-container">
    <p><a target="_blank" href="/howto/howto_js_topnav.asp" class="ws-btn">Learn How To &raquo;</a></p>
  </div>
</div>
<br>
...
<hr>
  <h2><a target="_blank" href="/howto/howto_css_animated_search.asp" class="h2-anchor">Animated Search Form</a></h2>
  <input id="myInp" type="text" name="search" placeholder="Search..">
  <div class="howto-container">
    <p><a target="_blank" href="/howto/howto_css_animated_search.asp" class="ws-btn">Learn How To &raquo;</a></p>
  </div>
</div>
<br>

<div class="w3-card-4 w3-container w3-round">
  <h2><a target="_blank" href="/howto/howto_css_dropdown.asp" class="h2-anchor">Hover Dropdowns</a></h2>
...
<div class="howto-container">
  <p><a target="_blank" href="/howto/howto_css_dropdown.asp" class="ws-btn">Learn How To &raquo;</a></p>
</div>
</div>
<br>

<div class="w3-card-4 w3-container w3-round">
  <h2><a target="_blank" href="/howto/howto_css_fixed_sidebar.asp" class="h2-anchor">Fixed Sidebar</a></h2>
<div class="w3-row-padding" style="margin:0 -16px 16px -16px">
<div class="w3-col m6 s12">
<iframe src="/howto/tryhow_css_sidenav_ifr.htm" style="width:100%;border:5px solid #ddd;height:300px;background-color:#fff;"></iframe>
</div>
<div class="w3-col m6 w3-hide-small">
<iframe src="/howto/tryhow_css_sidenav_ifr2.htm" style="width:100%;border:5px solid #ddd;height:300px;background-color:#fff;"></iframe>
</div>
</div>
  <div class="howto-container">
    <p><a target="_blank" href="/howto/howto_css_fixed_sidebar.asp" class="ws-btn">Learn How To &raquo;</a></p>
  </div>
</div>
<br>
...
<h3>How To - Snippets Library</h3>
<p>For more snippets, you can visit our <a href="/howto/default.asp">How To section</a>, that include hundreds of code snippets for HTML, CSS and JavaScript.</p>
<p><a href="/howto/default.asp" class="ws-btn">Go to W3Schools How To section &raquo;</a></p>
</div>
