...
<h1>CSS <span class="color_h1">Column Rules</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css3_multiple_columns.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_challenges_css3_columns.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<p class="intro">This page covers CSS column rules, span, and width properties.</p>
<hr>

<h2>CSS Column Rule</h2>
<p>The CSS <code class="w3-codespan">
<a href="/cssref/css3_pr_column-rule-style.php">column-rule-style</a></code> property specifies the style of the 
...
<p>The CSS <code class="w3-codespan">
<a href="/cssref/css3_pr_column-rule-width.php">column-rule-width</a></code> property specifies the width of the 
vertical rule between columns:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
div
...
<p>The CSS <code class="w3-codespan">
<a href="/cssref/css3_pr_column-rule-color.php">column-rule-color</a></code> property specifies the color of the 
vertical rule between columns:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
...
<p>The CSS <code class="w3-codespan"><a href="/cssref/css3_pr_column-rule.php">column-rule</a></code> property is a shorthand property for setting all the column-rule-* properties above. </p>
<div class="w3-example">
<h3>Example</h3>
  <p>Sets the width, style, and color of the vertical rule between columns:</p>
<div class="w3-code notranslate cssHigh">
div
{<br>
...
<hr>
<!--start-->
<h2>CSS Column Span</h2>
<p>The CSS <code class="w3-codespan"><a href="/cssref/css3_pr_column-span.php">column-span</a></code> property specifies how many columns an element 
(typically a heading) should span across.</p>

<div class="w3-example">
<h3>Example</h3>
  <p>Specify that the &lt;h2&gt; element should span across all columns (and be 
  aligned in center):</p>
<div class="w3-code notranslate cssHigh">
h2 {<br>
&nbsp;&nbsp;column-span: all;<br>&nbsp; text-align: center;<br>
}
</div>
...
<hr>
<!--start-->
<h2>CSS Column Width</h2>
<p>The CSS <code class="w3-codespan"><a href="/cssref/css3_pr_column-width.php">column-width</a></code> property specifies a suggested, optimal width for 
each column.</p>
<p>Here, the browser will determine the number of columns based on this width and the available space.</p>

<div class="w3-example">
<h3>Example</h3>
  <p>Specify that the suggested, optimal width for the columns should be 100px:</p>
<div class="w3-code notranslate cssHigh">
div {<br>
...
<hr>
<div id="exercisecontainer" src="xrcise_css3_multiple_columns_rules.js"></div>
<hr>
