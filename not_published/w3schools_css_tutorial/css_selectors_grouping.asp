...
<h1>CSS <span class="color_h1">Grouping</span> Selectors</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="css_selectors.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="css_challenges_selectors.asp">Next &#10095;</a>
</div>
<hr>

<!--start-->
<h2>The CSS Universal Selector</h2>
<p>The <code class="w3-codespan"><a href="/cssref/sel_all.php">universal selector (*)</a></code> selects all HTML elements on the page.</p>
...
<a target="_blank" href="tryit.asp?filename=trycss_syntax_universal" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
...
<p>The <code class="w3-codespan"><a href="/cssref/sel_element_comma.php">grouping selector</a></code> selects all the HTML elements with the same style 
definitions.</p>
...
<hr>
<div id="exercisecontainer" src="xrcise_selectors_grouping.js"></div>
<hr>
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: CSS Simple Selectors</h2>
  <a href="https://youtu.be/ZNskBxLVOfs&list=PLP9IO4UYNF0UCaUSF3XNZ1U9f01E5h5PM" class="ga-featured ga-youtube" target="blank_" >
    <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
      ...
      <picture id="yt_div">
        <source srcset="images/css_selectors.webp" type="image/webp" />
        <img src="images/css_selectors.png" style="max-width:100%;height:auto;border-radius:6px" alt="Tutorial on YouTube" loading="lazy">
      </picture>
    </div>
  </a>
</div>
