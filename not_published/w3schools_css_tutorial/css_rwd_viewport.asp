...
<a class="w3-left w3-btn" href="css_challenges_rwd_intro.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_challenges_rwd_viewport.asp">Next &#10095;</a>
</div>
<hr>
<h2>Setting The Viewport</h2>
<p>The viewport is the user's visible area of a web page.</p>
<p>The viewport varies with the device (will be a lot smaller on a mobile phone than on a computer screen).</p>
<p>You should include the following <code class="w3-codespan">&lt;meta&gt;</code> element in 
the <code class="w3-codespan">&lt;head&gt;</code> section of all your web pages:</p>
...
<p><strong>Tip:</strong> If you are browsing this page with a phone or a tablet, you can click on the two links above to see the difference.</p>
</div>
<hr>
...
<p><strong>2. Do NOT let the content rely on a particular width to 
render well</strong> - Since screen dimensions vary 
...
<hr>
<div id="exercisecontainer" src="xrcise_rwd_viewport.js"></div>
<hr>
