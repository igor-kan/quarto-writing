...
<html lang="en-US">
<head>
<title>CSS Change Variables With JavaScript</title>
<meta charset="utf-8">
...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="css3_variables_overriding.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="css3_variables_mediaqueries.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>Change Variables With JavaScript</h2>
<p>CSS variables have access to the DOM, which means that you can change them with JavaScript.</p>
<p>Here is an example of how you can create a script to display and change the --primary-bg-color variable from the example used in the previous pages. 
...
<div class="w3-code notranslate htmlHigh">
  &lt;script&gt;<br>// Get the root element<br>var r = 
  document.querySelector(':root');<br><br>// Function for getting a variable 
  value<br>function myFunction_get() {<br>&nbsp; // Get the styles (properties 
  and values) for the root<br>&nbsp; var rs = getComputedStyle(r);<br>&nbsp; // 
  Alert the value of the --primary-bg-color variable<br>&nbsp; alert(&quot;The value 
  of --primary-bg-color is: &quot; + rs.getPropertyValue('--primary-bg-color'));<br>}<br>
  <br>// Function for setting a variable value<br>function myFunction_set() {<br>&nbsp; 
  // Set the value of variable --primary-bg-color to another value (in this case 
  &quot;green&quot;)<br>&nbsp; r.style.setProperty('--primary-bg-color', 'green');<br>}<br>
  &lt;/script&gt;   
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_var_js">Try it Yourself &raquo;</a>
<br>
</div>
<!--stop-->
<hr>
