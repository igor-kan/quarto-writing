...
<html lang="en-US">
<head>
<title>CSS Pseudo-elements for Content</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">Pseudo-elements</span> for Content</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_pseudo_elements_text.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_challenges_pseudo_elements.asp">Next &#10095;</a>
</div>
<hr>
<h2>Pseudo-elements for Content</h2>
<p>Pseudo-elements for content allow you to insert content before or after elements, style list markers, and more.</p>
<hr>

<h2>The CSS ::before Pseudo-element</h2>
<p>The <code class="w3-codespan"><a href="/cssref/sel_before.php">::before</a></code> pseudo-element 
is used to insert some content before the content of a specified element.</p>
<p>Use the <code class="w3-codespan"><a href="/cssref/pr_gen_content.php">
content</a></code> property to specify the content to insert.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Insert an image before the content of each &lt;h3&gt; element:&nbsp;</p>
...
<h2>The CSS ::after Pseudo-element</h2>
<p>The <code class="w3-codespan"><a href="/cssref/sel_after.php">::after</a></code> pseudo-element 
is used to insert some content after the content of a specified element.</p>
<p>Use the <code class="w3-codespan"><a href="/cssref/pr_gen_content.php">
content</a></code> property to specify the content to insert.&nbsp;</p>
<div class="w3-example">
<h3>Example</h3>
<p>Insert an image after the content of each &lt;h3&gt; element:</p>
<div class="w3-code notranslate cssHigh">
h3::after
{<br>
&nbsp;&nbsp;content: url(smiley.gif);<br>
...
<h2>The CSS ::marker Pseudo-element</h2>
<p>The <code class="w3-codespan"><a href="/cssref/sel_marker.php">::marker</a></code> pseudo-element 
is used to style the list item markers.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Style the markers of list items:&nbsp;</p>
<div class="w3-code notranslate cssHigh">
::marker { <br>
&nbsp;&nbsp;color: red;<br>&nbsp; font-size: 23px;<br>
}</div>
<a target="_blank" href="tryit.asp?filename=trycss_marker" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>The CSS ::selection Pseudo-element</h2>
<p>The <code class="w3-codespan"><a href="/cssref/sel_selection.php">::selection</a></code> pseudo-element is used to style the part of a text that is selected by a user.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Style the user-selected text with a red color, and a yellow background:&nbsp;</p>
<div class="w3-code notranslate cssHigh">
...
<h2>The CSS ::backdrop Pseudo-element</h2>
<p>The <code class="w3-codespan"><a href="/cssref/sel_backdrop.php">::backdrop</a></code> pseudo-element 
is used to style the viewbox behind a dialog box or popover element.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Style the viewbox behind a dialog box:&nbsp;</p>
<div class="w3-code notranslate cssHigh">
  dialog::backdrop {<br>&nbsp; background-color: lightgreen;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss3_backdrop" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_pseudo_elements_content.js"></div>
<hr>

<h2>CSS Pseudo-elements Reference</h2>
<div class="ws-note w3-panel">
  <p>For a complete list of all CSS Pseudo-elements, visit our <a href="/cssref/css_ref_pseudo_elements.php">CSS Pseudo-elements Reference</a>.</p>
</div>
