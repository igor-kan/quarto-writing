...
<h2>CSS Vertical Navigation Bar</h2>
<p>In a vertical navigation bar, the navigation links are stacked vertically (on 
top of each other), and is typically aligned along the left or right side of a 
webpage.</p>
<p>The basics of a vertical navigation bar is an unordered list (&lt;ul&gt;), with list 
items (&lt;li&gt;), each holding a link (&lt;a&gt;), as shown in the <a href="css_navbar.asp">Navbar Intro</a> page.</p>
<hr>

<h2>CSS Vertical Navbar Example</h2>
<p>Here, we create a basic vertical navigation bar with a gray background color, 
and we also change the background color and the text color of the links when the 
user mouse over them:</p>
<ul class="vertical">
...
block;<br>&nbsp; color: black;<br>&nbsp; padding: 8px 16px;<br>&nbsp; text-decoration: none;<br>}<br><br>
  /* Change the link and background color on hover */<br>li a:hover {<br>&nbsp; 
background-color: #555555;<br>&nbsp;&nbsp;color: white;<br>}</div>
...
<ul>
  <li>The first block (ul)&nbsp; is similar to the previous page. In addition we 
  have specified a fixed width (200px) and a light gray background color</li>
  <li>The next block (li a) styles &lt;a&gt; elements inside &lt;li&gt; elements</li>
  <li>Displaying the links as block elements makes the whole 
link area clickable (not just the text), and allows us to specify width, padding, margin, height, etc. 
  We add a link color and some padding. We also remove the underline from these 
  &lt;a&gt; elements</li>
  <li>The last block (li a:hover) changes the link color and background color 
  when a user mouse over them</li>
</ul>
<hr>
...
<h2>Active State</h2>
<p>Now we add an "active" class to highlight the link corresponding to the 
...
<h2>Center Navbar Links &amp; Add Borders</h2>
<p>To center the navbar links, add <code class="w3-codespan">
<a href="/cssref/pr_text_text-align.php">text-align: center;</a></code> to &lt;li&gt; or &lt;a&gt;.</p>
<p>If you want a border around the navbar, add the <code class="w3-codespan"><a href="/cssref/pr_border.php">border</a></code> property to &lt;ul&gt;.</p>
<p>If you also want 
borders inside the navbar, add a <code class="w3-codespan">
<a href="/cssref/pr_border-bottom.php">border-bottom</a></code> property to all &lt;li&gt; elements, except for the 
last one:</p>
...
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
ul {<br>&nbsp; border: 1px solid #555555;<br>}<br><br>li {<br>&nbsp; text-align: center;<br>
  &nbsp; 
border-bottom: 1px solid #555555;<br>}<br><br>li:last-child {<br>&nbsp; 
...
ul {<br>&nbsp; list-style-type: none;<br>&nbsp; 
margin: 0;<br>&nbsp; padding: 0;<br>&nbsp; width: 
  130px;<br>&nbsp; background-color: #f1f1f1;<br>&nbsp;&nbsp;height: 100%; /* Full height */<br>
  &nbsp; position: fixed; /* 
...
<div class="w3-example">
<h3>Example</h3>
<p>How to use CSS media queries to create a responsive navbar:</p>
<div class="w3-white">
<img src="navbar_responsive_ver.jpg" alt="Responsive Navbar" style="width:100%">
</div>
...
<hr>
<div id="exercisecontainer" src="xrcise_navbar_vertical.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_navbar.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_navbar_horizontal.asp">Next &#10095;</a>
