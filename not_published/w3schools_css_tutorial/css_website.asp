...
<html lang="en-US">
<head>
<title>Create CSS Website Server | W3Schools.com | W3Schools Spaces</title>
<meta charset="utf-8">
...
<h1>CSS and HTML Website <span class="color_h1">Hosting</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_challenges.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_syllabus.asp">Next &#10095;</a>
</div>
<hr>
...
<div class="w3-center hero-background">
            <div class="w3-content">
                <div class="top-section" style="padding-top:100px; color: #ffffff;padding-left:25px;padding-right:25px;">
                    ...
                    <h1 class="hero-title" style="color: #ffffff;font-size: 55px;font-weight:700">Create a Website with HTML and CSS</h1>
                    <!--<h2 style="font-size:30px">with <b style="color: #FFC0C7;">W3Schools Spaces</b></h2>-->
                            <h4 class="details-description">Host Websites with <span style="color: #FFC0C7;">W3Schools Spaces</span></h4>
                        ...
                        <div class="w3-center w3-content w3-row-padding">
                            <div class="text-content w3-center w3-padding-32 w3-row w3-container" style="margin-bottom: -90px !important;">
                                <div class="feature-responsive text-domain text-padding w3-col l12 m12 s12">
                                    <h3 class="rightside-text-padding w3-left-align" style="margin-left: 6px;"><b>Included for in all plans</b></h3>
