...
div.rgallery-item:hover {
  border: 1px solid #777;
}

div.rgallery-item img {
  width: 100%;
  height: auto;
}

div.rgallery-item div.desc {
  padding: 15px;
  text-align: center;
}
...
<a class="w3-left w3-btn" href="css_challenges_css_tooltip.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css3_images_effects.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to style images using CSS.</p>
<hr>
<h2>Rounded Images</h2>
<p>You can use the <code class="w3-codespan">border-radius</code> property to create rounded images:</p><br>

<img src="paris.jpg" alt="Paris" width="250" height="250" style="border-radius:20px;">

<div class="w3-example">
<h3>Example</h3>
<p>Rounded Image:</p>
<div class="w3-code notranslate cssHigh">
img {<br>&nbsp;&nbsp;border-radius: 8px;<br>}
</div>
<a target="_blank" href="tryit.asp?filename=trycss_ex_images_round" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<img src="paris.jpg" alt="Paris" width="250" height="250" style="border-radius:50%;">
<div class="w3-example">
<h3>Example</h3>
<p>Circled Image:</p>
<div class="w3-code notranslate cssHigh">
img {<br>&nbsp; border-radius: 50%;<br>}
</div>
<a target="_blank" href="tryit.asp?filename=trycss_ex_images_circle" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p><strong>Tip:</strong> Look at the <a href="css3_image_shapes.asp">CSS Image Shapes</a> chapter to learn how to shape (clip) images to circles, ellipses and polygons.</p>
<hr>

<h2>Thumbnail Images</h2>
<p>Use the <code class="w3-codespan">border</code> property to create thumbnail images:</p>
<img src="paris.jpg" alt="Paris" style="width:150px;border:1px solid #ddd;border-radius:4px;padding:5px;">
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
img {<br>&nbsp;&nbsp;border: 1px solid #ddd;<br>&nbsp;&nbsp;border-radius: 4px;<br>&nbsp;&nbsp;padding: 5px;<br>&nbsp;&nbsp;width: 150px;<br>}
</div>
<a target="_blank" href="tryit.asp?filename=trycss_ex_images_thumbnail" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p>Thumbnail image as a link:</p>
...
<p><strong>Tip:</strong> Read more about Responsive Web Design in our <a href="css_rwd_intro.asp">CSS RWD Tutorial</a>.</p>
<hr>
...
<p>CSS can be used to create responsive image galleries. This example use 
...
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  @media only screen and (max-width: 768px) {<br>&nbsp; div.gallery-item {<br>&nbsp;&nbsp;&nbsp; 
  width: calc(50% - 20px);<br>&nbsp; }<br>}<br><br>@media only screen and (max-width: 480px) {<br>&nbsp; 
  div.gallery-item {<br>&nbsp;&nbsp;&nbsp; width: calc(100% - 20px);<br>&nbsp; }<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_ex_images_gallery_responsive" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p><strong>Tip:</strong> Read more about Responsive Web Design in our <a href="css_rwd_intro.asp">CSS RWD Tutorial</a>.</p>
<hr>
<div id="exercisecontainer" src="xrcise_css3_images.js"></div>
<hr>
