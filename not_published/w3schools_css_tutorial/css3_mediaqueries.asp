...
<a class="w3-left w3-btn" href="css_challenges_css3_box-sizing.asp">&#10094; Previous</a>
...
<p>A media query consists of an optional media-type and one or more 
media-features, which resolve to either true or false.</p>

<div class="w3-code w3-border notranslate">
@media [not] <i>media-type </i>and<i> </i> (<i>media-feature: value</i>) 
  and<i> </i> (<i>media-feature: value</i>) {<i><br><em>&nbsp; /* CSS rules to apply 
  */</em><br></i>}
</div>

<p>The media-type is optional. However, if you use <strong>not</strong>, you must also specify a media-type.</p>
<p>The result of a media query is true if the specified media-type matches the type of device, and all media-features are true. When a media query is true, the corresponding style rules are 
applied, following the normal cascading rules.</p>

<p>Meaning of the <strong>not</strong> and <strong>and</strong> keywords:</p>
<p><strong>not:</strong> This optional keyword inverts the meaning of the entire media query.</p>
<p><strong>and:</strong> This keyword combines a media-type and one or more 
media-features.</p>
<hr>

<h2>CSS Media Types</h2>
<p>The optional media type specifies the type of media the styles are for. If 
media type is omitted, it will be set to &quot;all&quot;.</p>
<table class="ws-table-all notranslate">
  ...
  <tr>
    ...
    <tr>
    <td>screen</td>
    <td>Used for computer screens, tablets, and smart-phones</td>
    </tr>
  </table>
<hr>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    ...
    <td>User's preferred color scheme (light or dark)</td>
    </tr>
  </table>
<hr>

<h2>Media Queries Examples</h2>
<p>Here, we use a media query to change the background-color of the body to lightgreen, if the width of the viewport is 480px, or wider:</p>
...
<p>Here, we use a media query to change the background-color of the body to lightgreen, if the width of the viewport is 
between 480px and 768px:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
@media screen and (min-width: 480px) and (max-width: 768px) {<br>&nbsp; body {<br>
&nbsp;&nbsp;&nbsp;&nbsp;background-color: lightgreen;<br>&nbsp;&nbsp;}<br>}<br>
</div>
...
<p>For more examples on media queries, go to the next page: <a href="css3_mediaqueries_ex.asp">CSS MQ Examples</a>.</p>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_css3_mediaqueries.js"></div>
<hr>
