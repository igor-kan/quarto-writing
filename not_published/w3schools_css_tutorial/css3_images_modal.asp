...
<html lang="en-US">
<head>
<title>CSS Responsive Modal Images</title>
<meta charset="utf-8">
...
<h1>CSS Responsive Modal Images</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_challenges_css3_images.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="css_challenges_imagemodal.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>Responsive Modal Image Gallery</h2>
<p>A modal image gives a user the ability to display a larger version of an 
image, without navigating away from the current page. When a user clicks on a 
modal image, it shows a popup window that appears on top of the main content of 
the webpage, often with a semi-transparent background. The modal must be closed 
by the user, typically with a &quot;close&quot; button or an &quot;X&quot; sign in top-right corner.</p>
<p>This example demonstrates how to use HTML, CSS and JavaScript together, to create a responsive modal image gallery.</p>
<p>We use CSS to create a modal window (dialog box), and hide it by default.</p>
<p>Then, we use a JavaScript to show the modal window with the correct image inside, when a user clicks on the image:</p>

<div class="gallery">
  <img src="img_5terre.jpg" alt="Cinque Terre" class="gallery-item" onclick="openModal('modal1', 'Cinque Terre')" width="600" height="400">
  <img src="img_forest.jpg" alt="Forest" class="gallery-item" onclick="openModal('modal2', 'Forest')" width="600" height="400">
  <img src="img_lights.jpg" alt="Northern Lights" class="gallery-item" onclick="openModal('modal3', 'Nothern Lights')" width="600" height="400">
  <img src="img_mountains.jpg" alt="Mountains" class="gallery-item" onclick="openModal('modal4', 'Mountains')" width="600" height="400">
</div>

<div id="modal1" class="modal">
  <span class="close" onclick="closeModal('modal1')">&times;</span>
  <img src="img_5terre.jpg" alt="Cinque Terre" class="modal-content" width="600" height="400">
  <div class="caption"></div>
</div>

<div id="modal2" class="modal">
  <span class="close" onclick="closeModal('modal2')">&times;</span>
  <img src="img_forest.jpg" alt="Forest" class="modal-content" width="600" height="400">
  <div class="caption"></div>
</div>

<div id="modal3" class="modal">
  <span class="close" onclick="closeModal('modal3')">&times;</span>
  <img src="img_lights.jpg" alt="Northern Lights" class="modal-content" width="600" height="400">
  <div class="caption"></div>
</div>

<div id="modal4" class="modal">
  <span class="close" onclick="closeModal('modal4')">&times;</span>
  <img src="img_mountains.jpg" alt="Mountains" class="modal-content" width="600" height="400">
  <div class="caption"></div>
</div>
...
<div class="w3-code notranslate htmlHigh">
  &lt;html&gt;<br>&lt;head&gt;<br>&lt;meta name=&quot;viewport&quot; content=&quot;width=device-width, 
  initial-scale=1.0&quot;&gt;<br>&lt;style&gt;<br>* {<br>&nbsp; margin: 0;<br>&nbsp; padding: 0;<br>
  &nbsp;
  box-sizing: border-box;<br>}<br><br>h1 {<br>&nbsp; text-align: center;<br>&nbsp; padding: 
  20px;<br>}<br><br>.gallery {<br>&nbsp; display: flex;<br>&nbsp; flex-wrap: wrap;<br>
  &nbsp;
  justify-content: flex-start;<br>&nbsp; padding: 0 15px;<br>}<br><br>.gallery-item {<br>
  &nbsp;
  position: relative;<br>&nbsp; width: calc(25% - 20px);<br>&nbsp; height: auto;<br>&nbsp; margin: 
  10px;<br>&nbsp; cursor: pointer;<br>&nbsp; transition: transform 0.5s ease;<br>}<br><br>
  .gallery-item:hover {<br>&nbsp; transform: scale(1.1);<br>}<br><br>/* The Modal 
  (background) */<br>.modal {<br>&nbsp; display: none;<br>&nbsp; position: fixed;<br>&nbsp; z-index: 
  1000;<br>&nbsp; left: 0;<br>&nbsp; top: 0;<br>&nbsp; width: 100%;<br>&nbsp; height: 100%;<br>
  &nbsp;
  background-color: rgba(0, 0, 0, 0.8);<br>&nbsp; align-items: center;<br>
  &nbsp;
  justify-content: center;<br>&nbsp; transition: opacity 0.5s ease;<br>}<br><br>/* 
  Modal content (image) */<br>.modal-content {<br>&nbsp; position: relative;<br>&nbsp; width: 
  90%;<br>&nbsp; height: auto;<br>&nbsp; max-width: 90%;<br>&nbsp; max-height: 90%;<br>&nbsp; border-radius: 
  5px;<br>&nbsp; overflow: hidden;<br>&nbsp; animation: zoomIn 0.5s;<br>}<br><br>@keyframes 
  zoomIn {<br>&nbsp; from {transform: scale(0.6);}<br>&nbsp; to {transform: scale(1);}<br>}<br>
  <br>.modal.show {<br>&nbsp; display: flex;<br>&nbsp; opacity: 1;<br>}<br><br>/* Close button 
  */<br>.close {<br>&nbsp; position: absolute;<br>&nbsp; top: 10px;<br>&nbsp; right: 15px;<br>&nbsp; color: 
  #ffffff;<br>&nbsp; font-size: 35px;<br>&nbsp; font-weight: bold;<br>&nbsp; cursor: pointer;<br>
  &nbsp;
  transition: transform 0.3s;<br>}<br><br>/* Caption of modal image */<br>
  .caption {<br>&nbsp; position: absolute;<br>&nbsp; bottom: 15px;<br>&nbsp; width: 100%;<br>
  &nbsp;
  text-align: center;<br>&nbsp; color: #ffffff;<br>&nbsp; font-size: 24px;<br>}<br><br>@media 
  screen and (max-width: 768px) {<br>&nbsp; .gallery-item {<br>&nbsp;&nbsp;&nbsp; width: calc(50% - 20px);<br>
  &nbsp;
  }<br>}<br><br>@media screen and (max-width: 480px) {<br>&nbsp; .gallery-item {<br>
  &nbsp;&nbsp;&nbsp;
  width: calc(100% - 20px);<br>&nbsp; }<br>}<br>&lt;/style&gt;<br>&lt;/head&gt;<br>&lt;body&gt;<br><br>
  &lt;h1&gt;Responsive Modal Images&lt;/h1&gt;<br><br>&lt;div class=&quot;gallery&quot;&gt;<br>&nbsp; &lt;img 
  src=&quot;img_5terre.jpg&quot; alt=&quot;Cinque Terre&quot; class=&quot;gallery-item&quot; 
  onclick=&quot;openModal('modal1', 'Cinque Terre')&quot;&gt;<br>
  &nbsp;
  &lt;img src=&quot;img_forest.jpg&quot; alt=&quot;Forest&quot; class=&quot;gallery-item&quot; 
  onclick=&quot;openModal('modal2', 'Forest')&quot;&gt;<br>&nbsp; &lt;img 
  src=&quot;img_lights.jpg&quot; alt=&quot;Northern Lights&quot; class=&quot;gallery-item&quot; 
  onclick=&quot;openModal('modal3', 'Nothern Lights')&quot;&gt;<br>
  &nbsp;
  &lt;img src=&quot;img_mountains.jpg&quot; alt=&quot;Mountains&quot; class=&quot;gallery-item&quot; 
  onclick=&quot;openModal('modal4', 'Mountains')&quot;&gt;<br>&lt;/div&gt;<br>
  <br>&lt;div id=&quot;modal1&quot; class=&quot;modal&quot;&gt;<br>&nbsp; &lt;span class=&quot;close&quot; 
  onclick=&quot;closeModal('modal1')&quot;&gt;&amp;times;&lt;/span&gt;<br>&nbsp; &lt;img src=&quot;img_5terre.jpg&quot; 
  alt=&quot;Cinque Terre&quot; class=&quot;modal-content&quot;&gt;<br>&nbsp; &lt;div 
  class=&quot;caption&quot;&gt;&lt;/div&gt;<br>&lt;/div&gt;<br><br>&lt;div id=&quot;modal2&quot; class=&quot;modal&quot;&gt;<br>
  &nbsp;
  &lt;span class=&quot;close&quot; onclick=&quot;closeModal('modal2')&quot;&gt;&amp;times;&lt;/span&gt;<br>&nbsp; &lt;img 
  src=&quot;img_forest.jpg&quot; alt=&quot;Forest&quot; class=&quot;modal-content&quot;&gt;<br>&nbsp; &lt;div class=&quot;caption&quot;&gt;&lt;/div&gt;<br>&lt;/div&gt;<br><br>&lt;div id=&quot;modal3&quot; 
  class=&quot;modal&quot;&gt;<br>&nbsp; &lt;span class=&quot;close&quot; 
  onclick=&quot;closeModal('modal3')&quot;&gt;&amp;times;&lt;/span&gt;<br>&nbsp; &lt;img src=&quot;img_lights.jpg&quot; 
  alt=&quot;Northern Lights&quot; class=&quot;modal-content&quot;&gt;<br>&nbsp; &lt;div 
  class=&quot;caption&quot;&gt;&lt;/div&gt;<br>&lt;/div&gt;<br><br>&lt;div id=&quot;modal4&quot; class=&quot;modal&quot;&gt;<br>
  &nbsp;
  &lt;span class=&quot;close&quot; onclick=&quot;closeModal('modal4')&quot;&gt;&amp;times;&lt;/span&gt;<br>&nbsp; &lt;img 
  src=&quot;img_mountains.jpg&quot; alt=&quot;Mountains&quot; class=&quot;modal-content&quot;&gt;<br>&nbsp; &lt;div class=&quot;caption&quot;&gt;&lt;/div&gt;<br>&lt;/div&gt;<br><br>&lt;script&gt;<br>function openModal(modalId, caption) {<br>&nbsp; let modal = 
  document.getElementById(modalId);<br>&nbsp; modal.style.display = &quot;flex&quot;;<br>
  &nbsp;
  modal.classList.add(&quot;show&quot;);<br>&nbsp; let message = modal.querySelector(&quot;.caption&quot;);<br>
  &nbsp;
  message.innerText = caption;<br>}<br><br>function closeModal(modalId) {<br>&nbsp; let 
  modal = document.getElementById(modalId);<br>&nbsp; modal.classList.remove(&quot;show&quot;);<br>
  &nbsp;
  setTimeout(function () {<br>&nbsp;&nbsp;&nbsp; modal.style.display = &quot;none&quot;;<br>
  &nbsp;&nbsp;&nbsp;
  modal.querySelector(&quot;.caption&quot;).innerText = &quot;&quot;;<br>&nbsp; }, 300);<br>}<br>&lt;/script&gt;<br><br>
  &lt;/body&gt;<br>&lt;/html&gt;</div>
