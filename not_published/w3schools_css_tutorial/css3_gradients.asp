...
#grad1 {
    ...
    background-image: linear-gradient(to right, maroon, orange, green);    
    color:white;
}
...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="css_challenges_css3_colors.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css3_gradients_radial.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS Gradients</h2>
<p>The CSS gradient functions let you display smooth transitions between two or more colors 
within an element.</p>
<p>CSS defines three types of gradients:</p>
<ul>
  <li><strong>Linear Gradients</strong> - The color transition goes down, up, left, right, 
  or diagonally</li>
  <li><strong>Radial Gradients</strong> - The color transition goes out from a 
  central point</li>
  <li><strong>Conic Gradients</strong> - The color transition is rotated around a center point</li>
</ul>
<p>The CSS gradient functions are used within the <code class="w3-codespan">
<a href="/cssref/pr_background-image.php">background-image</a></code> property.</p>
<div id="grad1" style="text-align:center;margin:auto;color:#f3f3f3;font-size:30px;font-weight:bold;padding-top:105px;">
A Linear Gradient Background</div>
<!--stop-->
<hr>
<!--start-->
<h2>CSS linear-gradient() Function</h2>
<p>The CSS <code class="w3-codespan"><a href="/cssref/func_linear-gradient.php">
linear-gradient()</a></code> function creates a linear gradient.</p>
<p>A linear gradient defines a color transition that goes in a straight line, it 
can go down, up, to left, to right, 
  or diagonally.</p>
<p>A linear gradient requires 
...
<h3>Direction - Top to Bottom (this is default)</h3>
<p>The following example shows a linear gradient that goes from top to bottom. It starts red, transitioning to yellow:</p>
<div id="grad2" style="text-align:center;">top to bottom (default)</div>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
   #grad {<br>&nbsp;&nbsp;background-image: linear-gradient(to bottom, red, yellow);<br>} </div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_gradient-linear" target="_blank">Try it Yourself &raquo;</a>
</div>

<h3>Direction - Bottom to Top</h3>
<p>The following example shows a linear gradient that goes from bottom to top. It starts red, transitioning to yellow:</p>
<div id="grad2_2" style="text-align:center;">bottom to top</div>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
   #grad {<br>&nbsp;&nbsp;background-image: linear-gradient(to top, red, yellow);<br>} </div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_gradient-linear2" target="_blank">Try it Yourself &raquo;</a>
</div>

<h3>Direction - Left to Right</h3>
<p>The following example shows a linear gradient that goes from left to right. It starts red, transitioning to 
yellow:</p>
...
<h3>Direction - Diagonal</h3>
<p>The following example shows a linear gradient that goes from top-left to bottom-right. It starts red, transitioning to yellow:</p>
...
<hr>
<!--start-->
<h2>Linear Gradient - Using Angles</h2>
<p>If you want more control over the direction of the gradient, you can define 
an <code class="w3-codespan">angle</code> parameter, instead of the predefined directions (to bottom, to 
top, to right, to left, to bottom right, etc.).</p>
<ul>
  <li>A value of 0deg is equivalent to 
&quot;to top&quot;.</li>
  <li>A value of 90deg is equivalent to &quot;to right&quot;.</li>
  <li>A value of 
180deg is equivalent to &quot;to bottom&quot;.</li>
  <li>A value of 270deg equivalent to &quot;to left&quot;</li>
</ul>
<h3>Syntax</h3>
<div class="w3-code w3-border notranslate">
<div>
...
<hr>
<!--start-->
<h2>Linear Gradient - Multiple Color Stops</h2>
...
<p>The following example shows a linear gradient (from left to 
...
<p>The following example shows a linear gradient that goes from left to right. It starts fully transparent, transitioning to full color red:</p>
<div id="grad8"></div>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
...
<hr>
<!--start-->
<h2>CSS repeating-linear-gradient() Function</h2>
<p>The CSS <code class="w3-codespan">
<a href="/cssref/func_repeating-linear-gradient.php">
repeating-linear-gradient()</a></code> function is used to repeat linear gradients:</p>
<div id="grad9"></div>
<div class="w3-example">
<h3>Example</h3>
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_css3_gradients.js"></div>
<hr>
