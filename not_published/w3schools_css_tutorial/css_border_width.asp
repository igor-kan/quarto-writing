...
<h1>CSS <span class="color_h1">Border Width</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_border.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_border_color.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS Border Width</h2>
<p>The <code class="w3-codespan" class="w3-codespan">
<a href="/cssref/pr_border-width.php">border-width</a></code> property specifies the width of the four borders.</p>
...
<a target="_blank" href="tryit.asp?filename=trycss_border-width" class="w3-btn w3-margin-bottom w3-margin-top">Try it Yourself &raquo;</a>
</div>
<!--stop-->
...
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  p.one {<br>&nbsp; border-style: solid;<br>&nbsp; border-width: 5px 20px; /* 
  5px top and bottom, 20px on the sides */<br>}<br><br>p.two {<br>&nbsp; border-style: 
  solid;<br>&nbsp; border-width: 20px 5px; /* 20px top and bottom, 5px on the 
  sides */<br>}<br>
  <br>p.three {<br>&nbsp; border-style: solid;<br>&nbsp; border-width: 25px 10px 
  4px 35px; /* 25px top, 10px right, 4px bottom and 35px left */<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-width2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_border_width.js"></div>
<hr>
