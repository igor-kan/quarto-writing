  ...
  <div class="cert-card">
    <div class="cert-card-header">
      <div class="cert-card-icon">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#1572B6"><path d="M1.5 0h21l-1.91 21.563L11.977 24l-8.565-2.438L1.5 0zm17.09 4.413L5.41 4.41l.213 2.622 10.125.002-.255 2.716h-6.64l.24 2.573h6.182l-.366 3.523-2.91.804-2.956-.81-.188-2.11h-2.61l.29 3.855L12 19.288l5.373-1.53L18.59 4.414z"/></svg>
      </div>
      <h2 class="cert-card-title">Learn CSS</h2>
    </div>
    <p class="cert-card-desc">CSS is the language we use to style an HTML document.</p>
    <p class="cert-card-desc">CSS describes how HTML elements should be displayed.</p>
    <p class="cert-card-desc">This tutorial will teach you CSS from basic to advanced.</p>
    <div class="cert-card-bottom" style="margin-top:auto;padding-top:16px;">
      <a href="css_intro.asp" class="cert-card-btn">Learn CSS now &#10095;</a>
    </div>
  </div>

  <div class="cert-info" style="padding:24px;display:flex;flex-direction:column;">
    <h3 class="cert-info-title">Become CSS Certified</h3>
    <p class="cert-info-desc">Get certified with our CSS exam, includes a professionally curated study kit to guide you from beginner to exam-ready.</p>
...
<a href="https://campus.w3schools.com/collections/course-catalog/products/css-course" class="cert-card-btn cert-btn-white" target="_blank" style="margin-top:12px;background:#fff;color:#000;border:2px solid #000;">Get Certified &#10095;</a>
        </div>
        <div class="cert-preview" style="flex:1 1 auto;padding:0;align-self:flex-start;">
          <svg class="cert-preview-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 560 400" role="img" aria-label="CSS Certificate preview" style="width:100%;max-width:250px;height:auto;display:block;margin:0 0 0 auto;">
            ...
            <text x="280" y="212" text-anchor="middle" font-family="Source Sans Pro Topnav, sans-serif" font-size="13" fill="#475569">has passed the W3Schools CSS Certification exam and is hereby declared a</text>
            <g transform="translate(256,228)">
              <svg width="48" height="48" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#1572B6"><path d="M1.5 0h21l-1.91 21.563L11.977 24l-8.565-2.438L1.5 0zm17.09 4.413L5.41 4.41l.213 2.622 10.125.002-.255 2.716h-6.64l.24 2.573h6.182l-.366 3.523-2.91.804-2.956-.81-.188-2.11h-2.61l.29 3.855L12 19.288l5.373-1.53L18.59 4.414z"/></svg>
            </g>
            <text x="280" y="298" text-anchor="middle" font-family="Source Sans Pro Topnav, sans-serif" font-size="18" font-weight="700" fill="#0f172a">Certified CSS Developer</text>
...
<div id="exercisecontainer" src="xrcise_background.js"></div>
<p><a class="w3-btn w3-margin-bottom ws-green" href="css_exercises.asp" style="border-radius:5px;font-size: 18px;padding-left:25px;padding-right:25px;font-family: 'Source Sans Pro', sans-serif;margin-top:6px;">See all CSS Exercises</a></p>
<hr>
...
<div class="w3-third">
  <a class="bigbtn" href="/cssref/index.php">CSS Properties</a>
</div>

<div class="w3-third">
  <a class="bigbtn" href="/cssref/css3_browsersupport.php">CSS Browser Support</a>
</div>

<div class="w3-third">
  <a class="bigbtn" href="/cssref/css_selectors.php">CSS Selectors</a>
</div>

<div class="w3-third">
  <a class="bigbtn" href="/cssref/css_ref_combinators.php">CSS Combinators</a>
</div>

<div class="w3-third">
  <a class="bigbtn" href="/cssref/css_ref_pseudo_classes.php">CSS Pseudo-classes</a>
</div>

<div class="w3-third">
  <a class="bigbtn" href="/cssref/css_ref_pseudo_elements.php">CSS Pseudo-elements</a>
</div>

<div class="w3-third">
  <a class="bigbtn" href="/cssref/css_ref_atrules.php">CSS At-rules</a>
</div>

<div class="w3-third">
  <a class="bigbtn" href="/cssref/css_functions.php">CSS Functions</a>
</div>

<div class="w3-third">
  <a class="bigbtn" href="/cssref/css_animatable.php">CSS Animatable</a>
</div>

<div class="w3-third">
  <a class="bigbtn" href="/cssref/css_websafe_fonts.php">CSS Web Safe Fonts</a>
</div>

<div class="w3-third">
  <a class="bigbtn" href="/cssref/css_units.php">CSS Units</a>
</div>

<div class="w3-third">
  <a class="bigbtn" href="/cssref/css_pxtoemconversion.php">Px to Em Conversion</a>
</div>

<div class="w3-third">
  <a class="bigbtn" href="/cssref/css_colors.php">CSS Colors</a>
</div>

<div class="w3-third">
  <a class="bigbtn" href="/cssref/css_default_values.php">CSS Default Values</a>
</div>

<div class="w3-third">
  <a class="bigbtn" href="/cssref/css_entities.php">CSS Entities</a>
</div>

<div class="w3-third">
  <a class="bigbtn" href="/cssref/css_ref_aural.php">CSS Aural</a>
</div>
