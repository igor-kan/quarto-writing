...
<a class="w3-left w3-btn" href="css_challenges_css3_mediaqueries.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_challenges_css3_mediaqueries.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS Media Queries Examples</h2>
<p>Media queries are a popular technique for delivering a tailored style sheet to different devices.</p>
<p>To demonstrate a simple example, we can change the background color for different devices:</p>

<img src="mqcap.JPG" style="width:100%;max-width:700px;margin:auto;display:block;">

<div class="w3-example">
<h3>Example</h3>
  <p>Use media queries to change the background color for different viewport 
  widths:</p>
<div class="w3-code notranslate cssHigh">
  /* Base style for mobile devices */<br>body {<br>&nbsp; background-color: 
  olive;<br>&nbsp; color: white;<br>}<br><br>/* For devices with a minimum width 
  of 768px (Medium) */<br>@media screen and (min-width: 768px) {<br>&nbsp; body 
  {<br>&nbsp;&nbsp;&nbsp; background-color: blue;<br>&nbsp;&nbsp;&nbsp; color: 
  white;<br>&nbsp; }<br>}<br><br>/* For devices with a minimum width of 992px 
  (Large) */<br>@media screen and (min-width: 992px) {<br>&nbsp; body {<br>&nbsp;&nbsp;&nbsp; 
  background-color: tan;<br>&nbsp;&nbsp;&nbsp; color: black;<br>&nbsp; }<br>}<br>
</div>
...
<div>
  <div class="w3-row">
    <div class="w3-col s3 ws-grey ws-border-right" style="height:110px;"></div>
    <div class="w3-col s3 ws-grey ws-border-right" style="height:110px;"></div>
    <div class="w3-col s3 ws-grey ws-border-right" style="height:110px;"></div>
    <div class="w3-col s3 ws-grey" style="height:110px;"></div>
  </div>
</div>
...
<div>
  <div class="w3-row">
  <div class="w3-col s6 ws-grey ws-border-right" style="height:110px;"></div>
  <div class="w3-col s6 ws-grey" style="height:110px;"></div>
  </div>
</div>
  ...
  <div class="w3-col m4">
    <div class="w3-card-2 w3-padding w3-padding-16"><p style="margin-top:0px">
      Small screens:</p>
<div style="overflow:auto;">
  <div class="w3-col header ws-grey" style="height:110px;"></div>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  * {<br>box-sizing: border-box;<br>}<br><br>/* Container for flexboxes */<br>.container {<br>&nbsp; display: flex;<br>&nbsp; 
  ...
  @media screen and (max-width: 600px) {<br>&nbsp; .container {<br>&nbsp;&nbsp;&nbsp; 
...
<p>Here, we use media queries to create a responsive navigation menu, that varies in design on different screen sizes.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh"> 
   ul {<br>&nbsp; list-style-type: none;<br>&nbsp; margin: 0;<br>&nbsp; padding: 
   0;<br>&nbsp; background-color: #333333;<br>&nbsp; display: flex;<br>}<br><br>
   ul li a {<br>&nbsp; display: block;<br>&nbsp; color: white;<br>&nbsp; 
   padding: 14px 16px;<br>&nbsp; text-decoration: none;<br>}<br><br>ul li 
   a:hover {<br>&nbsp; background-color: #111111;<br>}<br><br>/* For viewport 
   width 600px or less, make the menu links stack on top of each other */<br>
   @media screen and (max-width: 600px) {<br>&nbsp; ul {flex-direction: column;}<br>
   }</div>
...
<p>Here, we use media queries to hide an element on small screens:</p>
<div class="w3-yellow w3-hide-small w3-padding">I will be hidden on small screens.</div>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  /* Hide element if the viewport width is 600px or less */<br>@media 
  screen and (max-width: 600px) {<br>&nbsp; #div1 {<br>&nbsp;&nbsp;&nbsp; 
...
<p>Here, we use media queries to change the font size of an element on different viewport widths:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  /* If viewport width is 600px or more, set font-size to 80px */<br>@media screen and (min-width: 
  600px) {<br>&nbsp; #div1 {<br>&nbsp;&nbsp;&nbsp; 
  font-size: 80px;<br>&nbsp; }<br>}<br>
</div>
...
<hr>
<!--start-->
<h2>Media Queries for Screen Orientation</h2>
<p>Media queries can also be used to change the layout of a page depending on the orientation of the screen.</p>
<p>Here, we change the background-color of the body, if the screen orientation is in landscape mode: </p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
...
<a target="_blank" href="tryit.asp?filename=trycss_mediaqueries_orientation" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Media Queries for User Preferences</h2>
<p>Some users have motion sensitivity and prefer websites with less animation.</p>
<p>The <code class="w3-codespan">prefers-reduced-motion</code> 
...
and transitions for the users who has activated this setting on their computer:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
...
&nbsp; }<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_mediaqueries_userpref" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Responsive Image Gallery</h2>
<p>Here, we use media queries together with flexbox to create a responsive image gallery:</p>
<div class="w3-example">
<h3>Example</h3>
<div>
...
<p>Here, we use media queries together with flexbox to create a responsive website:</p>
<div class="w3-example">
<h3>Example</h3>
<div>
...
<!--stop-->
<hr>
<h2>CSS Responsive Web Design</h2>
<p>To learn more about responsive web design, read our <a href="css_rwd_intro.asp">Responsive Web Design Tutorial</a>.</p>
