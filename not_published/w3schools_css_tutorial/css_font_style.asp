...
<h1>CSS <span class="color_h1">Font Style</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="css_font_fallbacks.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_font_size.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS Font Style</h2>
<p>The CSS <code class="w3-codespan"><a href="/cssref/pr_font_font-style.php">font-style</a></code> property 
specifies the font style for a text..</p>
<p>This property can have one of the following values:</p>
<ul>
<li><code class="w3-codespan">normal</code> - The text is shown normally</li>
<li><code class="w3-codespan">italic</code> - The text is shown in italics</li>
<li><code class="w3-codespan">oblique</code> - The text is &quot;leaning&quot;
(oblique is very similar to italic)</li>
</ul>
...
<p>The CSS <code class="w3-codespan"><a href="/cssref/pr_font_weight.php">font-weight</a></code> property specifies 
how thick or thin characters in text should be displayed.</p>
<p>This property can have one of the following values:</p>
<ul>
  <li><code class="w3-codespan">normal</code> - This is default. Defines normal 
  characters</li>
  <li><code class="w3-codespan">bold</code> - Defines thick characters</li>
  <li><code class="w3-codespan">bolder</code> - Defines thicker characters</li>
  <li><code class="w3-codespan">lighter</code> - Defines lighter characters</li>
  <li><code class="w3-codespan">100-900</code> - Defines from thin to thick characters. 400 is the same as 
  normal, and 700 is the same as bold</li>
</ul>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  p.normal {<br>&nbsp; font-weight: normal;<br>}<br><br>p.light {<br>&nbsp; 
  font-weight: lighter;<br>}<br><br>p.thick {<br>&nbsp; font-weight: bold;<br>}<br>
  <br>p.thicker {<br>&nbsp; font-weight: 900;<br>}</div>
...
<p>The CSS <code class="w3-codespan"><a href="/cssref/pr_font_font-variant.php">font-variant</a></code> property specifies whether or not a text should 
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_font_style.js"></div>
<hr>
