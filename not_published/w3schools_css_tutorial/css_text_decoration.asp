...
<h1>CSS <span class="color_h1">Text Decoration</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_text_align.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_text_decoration_styles.asp">Next &#10095;</a>
</div>
<hr>

<h2>CSS Text Decoration</h2>
<p>The CSS <code class="w3-codespan">
<a href="/cssref/pr_text_text-decoration.php">text-decoration</a></code> 
property is used to control the appearance of decorative lines on text.</p>
<p>It is a shorthand property for the following individual properties:</p>
<ul>
<li><code class="w3-codespan">
<a href="/cssref/css3_pr_text-decoration-line.php">text-decoration-line</a></code></li>
<li><code class="w3-codespan">
<a href="/cssref/css3_pr_text-decoration-color.php">text-decoration-color</a></code></li>
<li><code class="w3-codespan">
<a href="/cssref/css3_pr_text-decoration-style.php">text-decoration-style</a></code></li>
<li><code class="w3-codespan">
<a href="/cssref/pr_text_text-decoration-thickness.php">text-decoration-thickness</a></code></li>
</ul>
<hr>

<h2>Add a Decoration Line to Text</h2>
<p>The CSS <code class="w3-codespan">
<a href="/cssref/css3_pr_text-decoration-line.php">text-decoration-line</a></code> property 
sets the type of decoration line added to the text.</p>
<p>This property can have one or more of the following values:</p>
<ul>
  <li><code class="w3-codespan">none</code> - Default value. Displays no 
  decoration line</li>
  <li><code class="w3-codespan">underline</code> - The decoration line is 
  displayed under the text</li>
  <li><code class="w3-codespan">overline</code> - The decoration line is 
  displayed over the text</li>
  <li><code class="w3-codespan">line-through</code> - The decoration line is 
  displayed through the text</li>
</ul>
<p><strong>Tip:</strong> You can combine multiple values, like overline and 
underline to display lines both over and under a text.</p>
<div class="w3-example">
<h3>Example</h3>
  <p>Set different types of decoration lines: </p>
<div class="w3-code notranslate cssHigh">
h1 {<br>&nbsp; text-decoration-line: overline;<br>}<br>
<br>h2 {<br>&nbsp; text-decoration-line: line-through;<br>}<br>
<br>h3 {<br>&nbsp; text-decoration-line: underline;<br>}<br><br>p {<br>&nbsp; text-decoration-line: 
  overline underline;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_text-decoration-line" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="w3-panel ws-note">
<p><strong>Note:</strong> It is not recommended to underline text that is not a 
link, as this often confuses the reader!</p>
</div>
<hr>
...
<p>The CSS <code class="w3-codespan">
<a href="/cssref/css3_pr_text-decoration-color.php">text-decoration-color</a></code> property is used to 
set the color of the decoration line.</p>

<div class="w3-example">
<h3>Example</h3>
  <p>Add different colors to the decoration line:</p>
<div class="w3-code notranslate cssHigh">
h1 {<br>&nbsp; text-decoration-line: overline;<br>&nbsp; text-decoration-color: 
  red;<br>}<br>
<br>h2 {<br>&nbsp; text-decoration-line: line-through;<br>&nbsp; text-decoration-color: 
  blue;<br>}<br>
<br>h3 {<br>&nbsp; text-decoration-line: underline;<br>&nbsp; text-decoration-color: 
  green;<br>}<br><br>p {<br>&nbsp; text-decoration-line: 
  overline underline;<br>&nbsp; text-decoration-color: purple;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_text-decoration-color" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_text_decoration.js"></div>
<hr>
