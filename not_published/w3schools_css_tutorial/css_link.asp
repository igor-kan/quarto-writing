...
<a class="w3-left w3-btn" href="css_challenges_icons.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_link_buttons.asp">Next &#10095;</a>
</div>
<hr>

<h2>CSS Styling Links</h2>
<p>HTML links can be styled with many CSS properties, like
<code class="w3-codespan"><a href="/cssref/pr_text_color.php">color</a></code>, 
<code class="w3-codespan"><a href="/cssref/pr_text_text-decoration.php">text-decoration</a></code>,
<code class="w3-codespan"><a href="/cssref/pr_background-color.php">background-color</a></code>,
<code class="w3-codespan"><a href="/cssref/pr_font_font-size.php">font-size</a></code>,
<code class="w3-codespan"><a href="/cssref/pr_font_weight.php">font-weight</a></code>,
<code class="w3-codespan"><a href="/cssref/pr_font_font-family.php">font-family</a></code>, etc.).</p>
<div class="w3-example">
<h3>Example</h3>
<p>Style a link with a color, background-color, and a bold font-weight:</p>
...
<h2>Styling Links Depending on State</h2>
<p>In addition, links can be styled differently depending on what <strong>state</strong> they are in.</p>
<p>The four link states are: </p>
<ul>
<li><code class="w3-codespan"><a href="/cssref/sel_link.php">:link</a></code> - a normal, unvisited link</li>
<li><code class="w3-codespan"><a href="/cssref/sel_visited.php">:visited</a></code> - a link the user has visited</li>
<li><code class="w3-codespan"><a href="/cssref/sel_hover.php">:hover</a></code> - a link when the user mouses over it</li>
<li><code class="w3-codespan"><a href="/cssref/sel_active.php">:active</a></code> - a link the moment it is clicked</li>
</ul>
<p>When setting the style for link states, there are some order rules:</p>
<ul>
<li>:hover must come after :link and :visited</li>
<li>:active must come after :hover</li>
</ul>

<div class="w3-example">
<h3>Example</h3>
  <p>Style links according to link state:</p>
<div class="w3-code notranslate cssHigh">
...
<h2>CSS Links - Text Decoration</h2>
<p>The <code class="w3-codespan"><a href="/cssref/pr_text_text-decoration.php">text-decoration</a></code> property is mostly used to remove underlines from links:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
...
<hr>
<h2>CSS Links - Background Color</h2>
<p>The <code class="w3-codespan"><a href="/cssref/pr_background-color.php">background-color</a></code> property can be used to specify a background color for links:</p>
...
<div class="w3-example">
<h3>Example</h3>
<p>This example demonstrates how to add other styles to HTML links:</p>
<div class="w3-code notranslate cssHigh">
  a.one:link {color:red;}<br>a.one:visited {color:blue;}<br>a.one:hover 
  {color:orange;}<br><br>a.two:link {color:red;}<br>a.two:visited {color:blue;}<br>
  a.two:hover {font-size:150%;}<br><br>a.three:link {color:red;}<br>
  a.three:visited {color:blue;}<br>a.three:hover {background:lightgreen;}<br>
  <br>a.four:link {color:red;}<br>a.four:visited {color:blue;}<br>a.four:hover 
  {font-family:monospace;}<br><br>a.five:link {color:red;text-decoration:none;}<br>
  a.five:visited {color:blue;text-decoration:none;}<br>a.five:hover 
  {text-decoration:underline;}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_link2">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>This example demonstrates the different types of cursors (can be useful for links):</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_cursor">Try it Yourself &raquo;</a>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_link.js"></div>
<hr>
