...
<html lang="en-US">
<head>
<title>CSS Sticky Positioning</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">Sticky Positioning</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_positioning_fixed_absolute.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="css_challenges_position.asp">Next &#10095;</a>
</div>
<hr>

<h2>CSS position: sticky</h2>
...
<iframe src="trycss_position_sticky_ifr.htm" style="width:100%;border:4px solid #e5e5e5"></iframe>
...
</div><p>In this example, when the sticky element reach the top of the page 
(top: 0), it sticks to this position:</p><div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
div.sticky {<br>&nbsp; position: 
...
<h2>Common Uses for Sticky Positioning</h2>
<p>Sticky positioning is commonly used for:</p>
<ul>
  <li><strong>Sticky headers</strong> - Navigation bars that stick to the top when scrolling</li>
  <li><strong>Sticky sidebars</strong> - Side content that stays visible while scrolling main content</li>
  <li><strong>Sticky table headers</strong> - Table headers that remain visible when scrolling long tables</li>
</ul>
<hr>

<h2>Sticky vs. Fixed</h2>
<p>The key differences between <code class="w3-codespan">sticky</code> and <code class="w3-codespan">fixed</code> positioning:</p>
...
<tr>
<td>Initial behavior</td>
<td>Acts like <code>relative</code></td>
<td>Always fixed to viewport</td>
</tr>
<tr>
<td>Space in document</td>
<td>Takes up space initially</td>
<td>Does not take up space</td>
</tr>
<tr>
<td>Scroll behavior</td>
<td>Sticks after threshold</td>
<td>Always fixed</td>
</tr>
<tr>
<td>Container bound</td>
<td>Yes, respects parent boundaries</td>
<td>No, always relative to viewport</td>
</tr>
</table>
<hr>
<div id="exercisecontainer" src="xrcise_positioning_sticky.js"></div>
<hr>
