...
<div class="w3-clear nextprev">
  ...
  <a class="w3-right w3-btn" href="css_grid_tracks.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS Grid Container</h2>
<p>A grid container contains one or more grid items arranged in columns and rows.</p>
<p>All direct child elements of a grid container automatically become grid items.</p>
<p>An element becomes a grid container when its <code class="w3-codespan"><a href="/cssref/pr_class_display.php">display</a></code> property 
is set to <code class="w3-codespan">grid</code> or <code class="w3-codespan">inline-grid</code>.</p>
...
<p><a class="ws-btn" target="_blank" href="tryit.asp?filename=trycss_grid_container">Try it Yourself &raquo;</a></p>
<hr>

<h2>Display Grid Property</h2>
<p>The <code class="w3-codespan">&lt;div&gt;</code> element becomes a grid container when its <code class="w3-codespan">
<a href="/cssref/pr_class_display.php">display</a></code> property 
is set to <code class="w3-codespan">grid</code> or <code class="w3-codespan">inline-grid</code>.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Use <code class="w3-codespan">display: grid</code> <span lang="no-bok">to 
make a block-level grid container:</span></p>
...
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss_grid_display_grid">Try it Yourself &raquo;</a></p>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Use <code class="w3-codespan">display: inline-grid</code> <span lang="no-bok">
to make an inline grid container:</span></p>
<div class="w3-code notranslate cssHigh">
  .container {<br>&nbsp; 
...
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss_grid_display_inline-grid">Try it Yourself &raquo;</a></p>
</div>
<!--stop-->
<hr>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    ...
    <td>Vertically aligns the grid items inside the container</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Horizontally aligns the grid items inside the container</td>
  </tr>
  <tr>
