...
<a class="w3-left w3-btn" href="css_challenges_css3_columns.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_challenges_css3_user_interface.asp">Next &#10095;</a>
</div>
<hr>
...
<!--start-->
<h2>CSS Resize</h2>
<p>The <code class="w3-codespan"><a href="/cssref/css3_pr_resize.php">resize</a></code> property specifies if (and how) an element 
can be resized by a user.</p>
<p>This property can have one of the following values:</p>
<ul>
  <li><code class="w3-codespan">horizontal</code> - user can resize the element 
  horizontally (the width)</li>
  <li><code class="w3-codespan">vertical</code> - user can resize the element 
  vertically (the height)</li>
  <li><code class="w3-codespan">both</code> - user can resize the element both 
  vertically and horizontally </li>
  <li><code class="w3-codespan">none</code> - user cannot resize the element</li>
</ul>

<div id="resize"><p>You can resize this div element in a vertical way!</p>
<p>To resize: Click and drag at the bottom-right corner!</p>
</div>

<h3>CSS Resize - Only Width</h3>
...
<h3>CSS Resize - Both Width and Height</h3>

<p>The following example lets the user resize both the width and height of a &lt;div&gt; element:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
div
...
<h3>CSS Disable Resize in Textarea</h3>
<p>A &lt;textarea&gt; is often resizable by default.</p>
<p>Here, we have used the <code class="w3-codespan">resize</code> property to disable the resizability 
in &lt;textarea&gt;:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
...
<p>The <code class="w3-codespan"><a href="/cssref/pr_outline-offset.php">outline-offset</a></code> property adds 
...
<p style="margin:30px 10px;padding:15px;border:1px solid black;outline:3px solid red;outline-offset:15px;">
This paragraph has a black border and a red outline 15px outside the border edge.</p>
...
<p>The following example uses the <code class="w3-codespan">
outline-offset</code> property to add space 
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_css3_user_interface.js"></div>
<hr>
