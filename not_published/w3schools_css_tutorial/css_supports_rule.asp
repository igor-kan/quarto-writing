...
<h1>CSS <span class="color_h1">@supports Rule</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="css_challenges_grid_12column.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="css_challenges_supports_rule.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->

<h2>The CSS @supports Rule</h2>
<p>The <code class="w3-codespan"><a href="/cssref/atrule_supports.php">@supports</a></code> rule lets you 
check if the browser supports a specific CSS property or value, and to define fallback styles if the feature is not supported.</p>
<p>This is useful for applying styles only when the browser can handle them.</p>
...
<hr>
<!--start-->
<h2>Example: Using @supports with grid and flex</h2>
<p>You can combine <code class="w3-codespan">
<a href="/cssref/atrule_supports.php">@supports</a></code> with regular CSS to provide fallback styling.</p>
<p>Here, if the browser supports display: flex, the CSS inside the @supports rule will 
  be applied. If not, the .container class outside the @supports rule will be 
  applied:</p>
<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate cssHigh">
    /* use this CSS if the browser does not support display: flex */<br>    
.container {<br>
&nbsp; float: left;<br>
&nbsp; width: 100%;<br>
}<br><br>
/* use this CSS if the browser supports display: flex */<br>
...
&nbsp; }<br>
  ...
  <a target="_blank" href="tryit.asp?filename=trycss_supports_fallback" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>Here, if the browser supports display: grid, the CSS inside the @supports rule will 
  be applied. If not, the .container class outside the @supports rule will be 
  applied:</p>
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate cssHigh">
    /* use this CSS if the browser does not support display: grid */<br>.container 
    {<br>&nbsp; display: table;<br>&nbsp; width: 90%;<br>&nbsp; background-color: 
    #2196F3;<br>&nbsp; padding: 10px;<br>}<br><br>/* use this CSS if the browser 
    supports display: grid */<br>@supports (display: grid) {<br>&nbsp; .container 
    {<br>&nbsp;&nbsp;&nbsp; display: grid;<br>&nbsp;&nbsp;&nbsp; grid: auto;<br>&nbsp;&nbsp;&nbsp; 
    grid-gap: 10px;<br>&nbsp;&nbsp;&nbsp; background-color: #2196F3;<br>&nbsp;&nbsp;&nbsp; 
    padding: 10px;<br>&nbsp; }<br>}<br></div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_atrule_supports">Try it Yourself &raquo;</a>
  </div>
<!--stop-->
<hr>
...
<hr>
<!--start-->
<h2>Negating with <code>not</code></h2>
<p>You can use <code class="w3-codespan">not</code> to apply styles only when a feature is <em>not</em> supported:</p>
...
<p>You can use <code class="w3-codespan">and</code>, <code class="w3-codespan">or</code>, and <code class="w3-codespan">not</code> for multiple conditions:</p>

<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate cssHigh">
@supports (display: grid) and (gap: 10px) {<br>
&nbsp; .container {<br>
&nbsp;&nbsp;&nbsp; display: grid;<br>
&nbsp;&nbsp;&nbsp; gap: 10px;<br>
&nbsp; }<br>
...
<div class="w3-panel ws-note">
  <p><strong>Note:</strong> Always provide fallback styles outside of 
  <code class="w3-codespan"><a href="/cssref/atrule_supports.php">@supports</a></code>, for older browsers.</p>
</div>
<!--stop-->
<hr>
...
<table class="ws-table-all notranslate">
  <tr>
    <th style="width:25%">At-rule</th>
    <th>Description</th>
  </tr>
  <tr>
    <td><a href="/cssref/atrule_supports.php">@supports</a></td>
    <td>Used to test whether a browser supports a CSS feature</td>
  </tr>
</table>
<br>
