...
<html lang="en-US">
<head>
<title>CSS Shaping Images</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">Image Shapes</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="css_challenges_imagefilters.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="css_challenges_imageshapes.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">With CSS it is easy to shape (clip) images to circles, ellipses and polygons.</p>
<hr>
<!--start-->
<h2>CSS clip-path Property and the circle() Function</h2>
<p>The <code class="w3-codespan"><a href="/cssref/css3_pr_clip-path.php">clip-path</a></code> property lets you clip an 
element to a basic shape.</p>
<p>The <code class="w3-codespan"><a href="/cssref/func_circle.php">circle()</a></code> function defines a circle with a radius and a position.</p>
<p>Here we clip an image to a circle with 50% radius:</p>

<img src="pineapple.jpg" alt="Pineapple" width="300" height="300" style="clip-path:circle(50%)">

<div class="w3-example">
<h3>Example</h3>
  <p>Clip an image to a circle with 50% radius:</p>
<div class="w3-code notranslate cssHigh">
img {<br>&nbsp;&nbsp;clip-path: circle(50%);<br>
}</div>
<a target="_blank" href="tryit.asp?filename=trycss_func_circle" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p>We can also specify the center of the circle. This can be a length or percentage value. It can also be a value such as left, right, top, or bottom. The default value is center.</p>
<p>Here we clip an image to a circle with 50% radius and position the center of the 
circle to the right:</p>

<img src="pineapple.jpg" alt="Pineapple" width="300" height="300" style="clip-path:circle(50% at right)">

<div class="w3-example">
<h3>Example</h3>
  <p>Clip an image to a circle with 50% radius and position the center of the 
circle to the right:</p>
<div class="w3-code notranslate cssHigh">
img {<br>&nbsp;&nbsp;clip-path: circle(50% at right);<br>
}</div>
<a target="_blank" href="tryit.asp?filename=trycss_func_circle2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>CSS shape-outside and circle()</h2>
<p>The <code class="w3-codespan"><a href="/cssref/css_pr_shape-outside.php">shape-outside</a></code> property lets you define a shape for 
the wrapping of the inline content.</p>
<p>The <code class="w3-codespan"><a href="/cssref/func_circle.php">circle()</a></code> function defines a circle with a radius and a position.</p>

<p>Here we clip an image to a circle with 40% radius, and set the shape-outside 
to a circle with 45% radius (to shape the text):</p>

<div class="clearfix" style="border:1px solid green;padding:10px;">
  <img src="pineapple.jpg" alt="Pineapple" width="300" height="300" style="float:left;clip-path:circle(40%);shape-outside:circle(45%)">
  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla ac laoreet quam, id aliquet nisl. Etiam id eros ligula. Aenean euismod, enim sed mollis feugiat, magna massa cursus leo, ut maximus metus eros non ante. Praesent eget tincidunt mauris, ut euismod ipsum. In hac habitasse platea dictumst. In dapibus tortor magna, elementum elementum neque sagittis id. Integer vestibulum semper dui, quis finibus libero elementum nec. Fusce ultricies lectus a eros interdum, efficitur iaculis nibh varius. Praesent sed ex bibendum, fermentum tortor nec, tincidunt augue. Maecenas in lobortis ligula, at viverra velit. Donec facilisis blandit purus sed efficitur. Duis est augue, bibendum quis bibendum sed, feugiat vel eros. Quisque ut nisi sed erat malesuada euismod. Aliquam feugiat erat eget sodales imperdiet. Ut vel tortor auctor, rutrum lectus a, tempor nunc. Vivamus nec elit ornare, dictum urna sollicitudin, ornare diam. Nullam dictum arcu vitae odio ultrices iaculis.</p>
</div>

<div class="w3-example">
<h3>Example</h3>
  <p>Use of circle(), clip-path and shape-outside:</p>
<div class="w3-code notranslate cssHigh">
  img {<br>&nbsp; float: left;<br>&nbsp; clip-path: circle(40%);<br>&nbsp; 
  shape-outside: circle(45%);<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_func_circle4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<hr>
<!--start-->
<h2>CSS clip-path and ellipse()</h2>
<p>The <code class="w3-codespan"><a href="/cssref/css3_pr_clip-path.php">clip-path</a></code> property lets you clip an 
element to a basic shape.</p>
<p>The <code class="w3-codespan"><a href="/cssref/func_ellipse.php">ellipse()</a></code> function defines an ellipse with two radii x and y.</p>

<p>Here we clip an image to an ellipse with 50% radius x and 35% radius y:</p>

<img src="pineapple.jpg" alt="Pineapple" width="300" height="300" style="clip-path:ellipse(50% 35%)">

<div class="w3-example">
<h3>Example</h3>
  <p>Clip an image to an ellipse with 50% radius x and 35% radius y:</p>
<div class="w3-code notranslate cssHigh">
img {<br>&nbsp; clip-path: ellipse(50% 35%);<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_func_ellipse" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p>We can also specify the center of the ellipse. This can be a length or percentage value. It can also be a value such as left, right, top, or bottom. The default value is center.</p>
<p>Here we clip an image to an ellipse with 50% radius x and 35% radius y, and 
position the center of the ellipse to the right:</p>

<img src="pineapple.jpg" alt="Pineapple" width="300" height="300" style="clip-path:ellipse(50% 35% at right)">

<div class="w3-example">
<h3>Example</h3>
  <p>Clip an image to an ellipse with 50% radius x and 35% radius y, and 
  position the center of the ellipse to the right:</p>
<div class="w3-code notranslate cssHigh">
  img {<br>&nbsp; clip-path: ellipse(50% 35% at right);<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_func_ellipse2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>CSS shape-outside and ellipse()</h2>

<p>Here we clip an image to an ellipse with 40% radius x and 50% radius y, and set the shape-outside 
to an ellipse with 45% radius x and 50% radius y (to shape the text):</p>

<div class="clearfix" style="border:1px solid green;padding:10px;">
  <img src="pineapple.jpg" alt="Pineapple" width="300" height="300" style="float:left;clip-path:ellipse(40% 50%);shape-outside:ellipse(45% 50%)">
  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla ac laoreet quam, id aliquet nisl. Etiam id eros ligula. Aenean euismod, enim sed mollis feugiat, magna massa cursus leo, ut maximus metus eros non ante. Praesent eget tincidunt mauris, ut euismod ipsum. In hac habitasse platea dictumst. In dapibus tortor magna, elementum elementum neque sagittis id. Integer vestibulum semper dui, quis finibus libero elementum nec. Fusce ultricies lectus a eros interdum, efficitur iaculis nibh varius. Praesent sed ex bibendum, fermentum tortor nec, tincidunt augue. Maecenas in lobortis ligula, at viverra velit. Donec facilisis blandit purus sed efficitur. Duis est augue, bibendum quis bibendum sed, feugiat vel eros. Quisque ut nisi sed erat malesuada euismod. Aliquam feugiat erat eget sodales imperdiet. Ut vel tortor auctor, rutrum lectus a, tempor nunc. Vivamus nec elit ornare, dictum urna sollicitudin, ornare diam. Nullam dictum arcu vitae odio ultrices iaculis.</p>
</div>

<div class="w3-example">
<h3>Example</h3>
  <p>Use of ellipse(), clip-path and shape-outside:</p>
<div class="w3-code notranslate cssHigh">
  img {<br>&nbsp; float: left;<br>&nbsp; clip-path: ellipse(40% 50%);<br>&nbsp; 
  shape-outside: ellipse(45% 50%);<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_func_ellipse4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>CSS polygon() Function</h2>
<p>The <code class="w3-codespan"><a href="/cssref/func_polygon.php">polygon()</a></code> function defines a 
polygon.</p>
<p>This function contains points that 
...
defines the right bottom corner.</p>
<p>The <code class="w3-codespan">polygon()</code> function is used within the
<code class="w3-codespan"><a href="/cssref/css3_pr_clip-path.php">clip-path</a></code> property and the
<code class="w3-codespan"><a href="/cssref/css_pr_shape-outside.php">shape-outside</a></code> property.</p>
<p>Here we clip an image to a polygon:&nbsp;</p>

<img src="pineapple.jpg" alt="Pineapple" width="300" height="300" style="clip-path:polygon(50% 0%, 100% 50%, 50% 100%, 0% 50%)">

<div class="w3-example">
<h3>Example</h3>
  <p>Clip an image to a polygon:</p>
<div class="w3-code notranslate cssHigh">
img {<br>&nbsp; clip-path: polygon(50% 0%, 100% 50%, 50% 100%, 0% 50%);<br>
}</div>
<a target="_blank" href="tryit.asp?filename=trycss_func_polygon" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_css3_image_shapes.js"></div>
<hr>

<h2>CSS Properties and Functions</h2>
<p>The following table lists the CSS properties and functions used in this 
chapter:</p>
<table class="ws-table-all notranslate">
  <tr>
    <th style="width:25%">Property/Function</th>
    <th>Description</th>
  </tr>
  <tr>
    <td><a href="/cssref/css3_pr_clip-path.php">clip-path</a></td>
    <td>Lets you clip an element to a basic shape or to an SVG source</td>
  </tr>
  <tr>
    <td><a href="/cssref/css_pr_shape-outside.php">shape-outside</a></td>
    <td>Lets you define a shape for the wrapping of the inline content</td>
  </tr>
  <tr>
    <td><a href="/cssref/func_circle.php">circle()</a></td>
    <td>Defines a circle with a radius and a position</td>
  </tr>
  <tr>
    <td><a href="/cssref/func_ellipse.php">ellipse()</a></td>
    <td>Defines an ellipse with two radii x and y</td>
  </tr>
  <tr>
    <td><a href="/cssref/func_polygon.php">polygon()</a></td>
    <td>Defines a polygon</td>
  </tr>
  </table>
