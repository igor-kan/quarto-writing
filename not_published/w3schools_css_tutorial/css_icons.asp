...
<html lang="en-US">
<head>
<title>CSS Icons - Font Awesome</title>
<meta charset="utf-8">
...
<h1>CSS Icons - <span class="color_h1">Font Awesome</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_challenges_font.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_icons_bootstrap.asp">Next &#10095;</a>
</div>
<hr>

<h2>How To Add Icons</h2>
<p>Icons can easily be added to your HTML page, by using an icon library.</p>
<p>Just add the name of the icon class to any inline HTML element
(like <code class="w3-codespan">&lt;i&gt;</code> or <code class="w3-codespan">&lt;span&gt;</code>).</p>
<p>Icons from icon libraries are scalable vectors that can be customized with CSS (size, color, shadow, etc.).</p>
...
<p>To use the Font Awesome icons, go to <a href="https://fontawesome.com" target="_blank">
fontawesome.com</a>, sign in, and get a code to add in the <code class="w3-codespan">&lt;head&gt;</code> section of your HTML page.</p>
<p>The code looks something like this:</p>
<div style="overflow:auto">
<code class="w3-codespan">&lt;script src=&quot;https://kit.fontawesome.com/<em>yourcode</em>.js&quot; crossorigin="anonymous"&gt;&lt;/script&gt;</code>
</div>

<p>Read more about Font Awesome in our 
<a href="/icons/fontawesome5_intro.asp">Font 
Awesome Tutorial</a>.</p>
...
<hr>
<div id="exercisecontainer" src="xrcise_icons.js"></div>
<hr>
