...
<h1>CSS <span class="color_h1">Button Groups</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css3_buttons_hover.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_challenges_css3_buttons.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<p class="intro">This page covers CSS button groups and animated buttons.</p>
<hr>

<h2>CSS Horizontal Button Group</h2>
<p>To create a group of buttons, wrap the buttons in a &lt;div&gt; element, and add 
<code class="w3-codespan">display: flex;</code> to the &lt;div&gt; element. Also add
<code class="w3-codespan">flex-wrap: wrap;</code>, to let the buttons wrap on a 
new line on small screens:</p>
...
<div class="w3-code notranslate cssHigh">
  .btn-group {<br>&nbsp; display: flex;<br>&nbsp; 
  flex-wrap: wrap;<br>}<br><br>.button {<br>&nbsp; 
  background-color: #04AA6D;<br>&nbsp; border: none;<br>&nbsp; color: white;<br>&nbsp; 
  padding: 15px 32px;<br>&nbsp; text-align: center;<br>&nbsp; text-decoration: 
  none;<br>&nbsp; font-size: 16px;<br>&nbsp; cursor: pointer;<br>}<br><br>.btn-group .button:hover {<br>&nbsp; background-color: 
  dodgerblue;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_buttons_group" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<hr>
<!--start-->
<h2>CSS Bordered Button Group</h2>

<p>Use the <code class="w3-codespan"><a href="/cssref/pr_border.php">border</a></code> property to create a bordered button 
group:</p>

<div class="btn-group">
<button type="button" class="btn" style="border: 1px solid green;">Button</button>
<button type="button" class="btn" style="border: 1px solid green;border-left:none;">Button</button>
<button type="button" class="btn" style="border: 1px solid green;border-left:none;">Button</button>
<button type="button" class="btn" style="border: 1px solid green;border-left:none;">Button</button>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  .button {<br>&nbsp; border: 1px solid green;<br>}<br><br>.btn-group 
  .button:not(:last-child) {<br>&nbsp; border-right: none;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_buttons_group_border" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>CSS Vertical Button Group</h2>

<p>To create a vertical button group, wrap the buttons in a &lt;div&gt; element, and add 
<code class="w3-codespan">display: flex;</code> to the &lt;div&gt; element. Also add
<code class="w3-codespan">flex-direction: column;</code>, to let the buttons be 
displayed in a vertical way:</p>


<div class="btn-group" style="flex-direction:column;">
<button type="button" class="btn" style="border: 1px solid green;width:150px;border-bottom:none;margin:0">Button</button>
<button type="button" class="btn" style="border: 1px solid green;width:150px;border-bottom:none;margin:0">Button</button>
<button type="button" class="btn" style="border: 1px solid green;width:150px;border-bottom:none;margin:0">Button</button>
<button type="button" class="btn" style="border: 1px solid green;width:150px;margin:0">Button</button>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  .btn-group {<br>&nbsp; display: flex;<br>&nbsp; flex-direction: column;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_buttons_group_vertical" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<button class="button" style="vertical-align:middle;width:180px;"><span>Hover </span></button>
</div>
<a target="_blank" href="tryit.asp?filename=trycss_buttons_animate1" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-padding w3-white">
<button class="pressed" style="margin:5px;width:180px;"><span>
Click </span></button>
</div>
<a target="_blank" href="tryit.asp?filename=trycss_buttons_animate3" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-padding w3-white">
<button class="btnfade" style="width:180px;"><span>
Fade In </span></button>
</div>
<a target="_blank" href="tryit.asp?filename=trycss_buttons_fade" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-padding w3-white">
<button class="rippleripple" style="width:180px;"><span>
Click </span></button>
</div>
<a target="_blank" href="tryit.asp?filename=trycss_buttons_animate2" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->

<hr>
<div id="exercisecontainer" src="xrcise_css3_buttons_groups.js"></div>
<hr>
