...
<html lang="en-US">
<head>
<title>CSS The overflow Property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">The overflow Property</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="css_challenges_z-index.asp">&#10094; Previous</a>
<a class="w3-right w3-btn"  href="css_overflow_xy.asp">Next &#10095;</a></div>
<hr>
<!--start-->
<h2>The CSS overflow Property</h2>
<p>The CSS <code class="w3-codespan"><a href="/cssref/pr_pos_overflow.php">overflow</a></code> property controls what 
...
<p>The <code class="w3-codespan"><a href="/cssref/pr_pos_overflow.php">overflow</a></code> property has the following values:</p>
<ul>
<li><code class="w3-codespan">visible</code> - Default. The overflow is not clipped. The content renders outside the element's box</li>
<li><code class="w3-codespan">hidden</code> - The overflow is clipped, and the rest of the content is hidden</li>
<li><code class="w3-codespan">scroll</code> - Scrollbars are added. User must scroll to see all content</li>
<li><code class="w3-codespan">auto</code> - Similar to <code class="w3-codespan">scroll</code>, but adds scrollbars only when necessary</li>
</ul>

<p>Here, scrollbars are added on overflow:</p>
<div id="overflow1">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi. Nam liber tempor cum soluta nobis eleifend option congue nihil imperdiet doming id quod mazim placerat facer possim assum. Typi non habent claritatem insitam; est usus legentis in iis qui facit eorum claritatem.</div>
<br>
<a target="_blank" href="tryit.asp?filename=trycss_overflow_intro" class="ws-btn">Try it Yourself &raquo;</a>
...
div {<br>&nbsp; width: 200px;<br>&nbsp;&nbsp;height: 
  65px;<br>&nbsp;&nbsp;background-color: coral;<br>&nbsp; 
...
<p>With the <code class="w3-codespan">scroll</code> value, horizontal and 
vertical scrollbars are always added. User must scroll to see all content:</p>
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_overflow.js"></div>
<hr>
...
<table class="ws-table-all notranslate">
  ...
  <tr>
    <td><a href="/cssref/css_pr_overflow-anchor.php">overflow-anchor</a></td>
    <td>Makes it possible to turn off scroll anchoring</td>
  </tr>
  <tr>
  ...
  <tr>
    <td><a href="/cssref/css3_pr_overflow-wrap.php">overflow-wrap</a></td>
    <td>Specifies whether or not the browser can break lines with long words, if 
    they overflow its container</td>
  </tr>
  </table>
...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="css_challenges_z-index.asp">&#10094; Previous</a>
<a class="w3-right w3-btn"  href="css_overflow_xy.asp">Next &#10095;</a>
</div>
<div
