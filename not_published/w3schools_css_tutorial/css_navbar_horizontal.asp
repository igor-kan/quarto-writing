...
<a class="w3-right w3-btn" href="css_challenges_navbar.asp">Next &#10095;</a>
</div>
<hr>

<h2>CSS Horizontal Navigation Bar</h2>
<p>In a horizontal navigation bar, the navigation links are stacked horizontally (next 
to each other), and is typically aligned on the top of a 
webpage.</p>
<p>The basics of a horizontal navigation bar is an unordered list (&lt;ul&gt;), with list 
items (&lt;li&gt;), each holding a link (&lt;a&gt;), as shown in the <a href="css_navbar.asp">Navbar Intro</a> page.</p>
<p>It is also common to add a &lt;nav&gt; element around the &lt;ul&gt; element, that will 
serve as a container for your navigation bar.</p>
<hr>

<h2>Horizontal Navbar Using Float</h2>
<p>One way of creating a horizontal navigation bar is to add the <code class="w3-codespan"><a href="/cssref/pr_class_float.php">float</a></code> 
property to the &lt;li&gt; 
elements.</p>

<p>Here we create a basic horizontal navigation bar with a dark background color and 
change the background color of the links when the user moves the mouse over them:</p>
...
<h3>Example</h3>
<p>Horizontal navbar with float:</p>
<div class="w3-code notranslate cssHigh">
ul {<br>&nbsp; list-style-type: none;<br>&nbsp;&nbsp;margin: 0;<br>&nbsp; padding: 0;<br>
  &nbsp; overflow: 
hidden;<br>&nbsp; background-color: #333333;<br>}<br><br>ul li {<br>&nbsp; 
float: left;<br>}<br>
<br>ul li a {<br>&nbsp; display: block;<br>&nbsp; 
color: white;<br>&nbsp; text-align: center;<br>&nbsp; 
padding: 14px 16px;<br>&nbsp; text-decoration: none;<br>}<br>
<br>ul li a:hover {<br>&nbsp; background-color: 
#111111;<br>}</div>
...
<ul>
<li><code class="w3-codespan">overflow: 
  hidden;</code> - Prevents list items from going outside of the list</li>
  <li><code class="w3-codespan">background-color: #333333;</code> - Adds a black background-color to 
the &lt;ul&gt; element</li>
  <li><code class="w3-codespan">float: left;</code> - 
  Makes &lt;li&gt; elements  
float next to each other</li>
<li><code class="w3-codespan">display: block;</code> -  
Allows us to specify padding, 
height, width, and margins to &lt;a&gt;</li>
<li><code class="w3-codespan">padding: 14px 16px;</code> - 
Add some padding 
between each &lt;a&gt; element</li>
  <li><code class="w3-codespan">text-decoration: none;</code> - 
  Removes underline from the links</li>
</ul>
<hr>

<h2>Horizontal Navbar Using Flex</h2>
<p>A more modern way of creating a horizontal navigation bar, is to use
<a href="css3_flexbox.asp">CSS flexbox</a>.</p>

<p>The following example creates an equal-looking horizontal navbar as above, 
but with flexbox:</p>

<div class="w3-example">
<h3>Example</h3>
  <p>Horizontal navbar with flex:</p>
<div class="w3-code notranslate cssHigh">
  ul {<br>&nbsp; list-style-type: none;<br>&nbsp; margin: 0;<br>&nbsp; padding: 
  0;<br>&nbsp; background-color: #333333;<br>&nbsp; display: flex;<br>}<br><br>ul li a 
  {<br>&nbsp; display: block;<br>&nbsp; color: white;<br>&nbsp; padding: 14px 
  16px;<br>&nbsp; text-decoration: none;<br>}<br><br>ul li a:hover {<br>&nbsp; background-color: 
  #111111;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_navbar_horizontal_flex">Try it Yourself &raquo;</a>
</div>

<p>The solution here are <code class="w3-codespan">display: flex;</code>. This 
creates a flex context and by default the items are shown from left to right.</p>

<p>And just by adding one line to the ul block: <code class="w3-codespan">justify-content: 
center;</code>, you will have a horizontally centered navbar:</p>

<div class="w3-example">
<h3>Example</h3>
  <p>Horizontal centered navbar with flex:</p>
<div class="w3-code notranslate cssHigh">
  ul {<br>&nbsp; list-style-type: none;<br>&nbsp; margin: 0;<br>&nbsp; padding: 
  0;<br>&nbsp; background-color: #333333;<br>&nbsp; display: flex;<br>&nbsp;
  <strong>justify-content: center;</strong><br>}<br></div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_navbar_horizontal_flex_center">Try it Yourself &raquo;</a>
</div>
<hr>
...
<h2>Active State</h2>
<p>Here, we add an &quot;active&quot; class to highlight the link corresponding to the 
current page to let the user know which page/section he/she is on:</p>
<ul class="horizontal">
...
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  ul li a.active {<br>&nbsp; background-color: #04AA6D;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_navbar_horizontal_active">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Gray Horizontal Navbar</h2>
<p>Here is an example of a gray horizontal navigation bar with a thin, gray border:</p>
...
<div class="w3-code notranslate cssHigh">
  ul {<br>&nbsp; list-style-type: none;<br>&nbsp; margin: 0;<br>&nbsp; padding: 
  0;<br>&nbsp; display: flex;<br>&nbsp; border: 1px solid #e7e7e7;<br>&nbsp; 
  background-color: #f3f3f3;<br>}<br>
</div>
...
<h2>Right-align Last Link</h2>
<p>You can right-align one or more links by floating the list items to the right (<code class="w3-codespan"><a href="/cssref/pr_class_float.php">float: right;</a></code>):</p>
<ul class="horizontal">
  <li><a class="active" href="javascript:void(0)">Home</a></li>
  <li><a href="javascript:void(0)">News</a></li>
  <li><a href="javascript:void(0)">Contact</a></li>
...
&lt;ul&gt;<br>&nbsp; &lt;li&gt;&lt;a href=&quot;#home&quot; class=&quot;active&quot;&gt;Home&lt;/a&gt;&lt;/li&gt;<br>&nbsp; 
&lt;li&gt;&lt;a href=&quot;#news&quot;&gt;News&lt;/a&gt;&lt;/li&gt;<br>&nbsp; &lt;li&gt;&lt;a href=&quot;#contact&quot;&gt;Contact&lt;/a&gt;&lt;/li&gt;<br>
&nbsp; &lt;li style=&quot;float:right&quot;&gt;&lt;a href=&quot;#about&quot;&gt;About&lt;/a&gt;&lt;/li&gt;<br>&lt;/ul&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_navbar_horizontal_alignright">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Border Dividers</h2>
<p>Add the <code class="w3-codespan"><a href="/cssref/pr_border-right.php">border-right</a></code> property to &lt;li&gt; 
elements (to all &lt;li&gt;s, except the last), to create link dividers:</p>
...
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
/* Add a lightgray right border to all list items, except the last */<br>ul li {<br>&nbsp; 
  float: left;<br>&nbsp; border-right: 1px solid #bbbbbb;<br>}<br><br>ul 
...
<p>You can make the navigation bar to stay fixed at the top or at the bottom of 
a page, by using the <code class="w3-codespan">
<a href="/cssref/pr_class_position.php">position</a></code> property along with <code class="w3-codespan">
<a href="/cssref/pr_pos_top.php">top</a></code> or <code class="w3-codespan">
<a href="/cssref/pr_pos_bottom.php">bottom</a></code>:</p>
<div class="w3-row">
<div class="w3-half">
<div class="width94">
...
<div class="ws-note w3-panel" style="margin-top:0">
<p><strong>Note:</strong> Fixed position might not work properly on mobile devices.</p>
</div>
<hr>

<h2>Sticky Navigation Bar</h2>
<p>Add <code class="w3-codespan"><a href="/cssref/pr_class_position.php">position: sticky;</a></code> to &lt;ul&gt; to create a sticky navbar.</p>
<p>An element with <code class="w3-codespan">position: sticky;</code> toggles between 
a <code class="w3-codespan">relative</code> and <code class="w3-codespan">fixed</code> 
position, depending on the scroll position.</p>
<p>A sticky element is positioned relative until a certain scroll position is 
reached - then it "sticks" in that place (like position: fixed).</p>
<iframe src="tryhow_js_navbar_sticky.htm" style="width:100%;border:3px solid #e9e9e9;height:400px;padding:0"></iframe><div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  ul {<br>&nbsp; position: sticky;<br>&nbsp; top: 0;<br>}</div>
...
<p><strong>Note: </strong> You must specify at least one of the <code class="w3-codespan">top</code>, <code class="w3-codespan">right</code>, <code class="w3-codespan">bottom</code> or <code class="w3-codespan">left</code> 
properties, for 
sticky positioning to work.</p>
</div>
<hr>

<h2>Dropdown Menu in Navigation Bar</h2>
<p>Here we create a dropdown menu for one of the menu links:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-white">
...
<div class="w3-example">
<h3>Example</h3>
<p>How to use CSS media queries to create responsive top navigation:</p>
<div class="w3-white">
<img src="navbar_responsive_hor.jpg" alt="Responsive Navbar" style="width:100%">
</div>
...
<hr>
<div id="exercisecontainer" src="xrcise_navbar_horizontal.js"></div>
<hr>
