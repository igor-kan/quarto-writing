...
<a class="w3-right w3-btn" href="css_challenges_css3_shadows.asp">Next &#10095;</a>
</div>
<hr>
...
<p>In its simplest use, you can only specify the horizontal and the vertical offset of the shadow.</p>
<p>In addition, you can add a shadow color, a spread radius, a blur effect, and 
change the shadow from an outer shadow to an inner shadow (inset).</p>
<hr>

<h2>CSS Horizontal and Vertical Shadow</h2>
<p>In its simplest use, you only specify the horizontal and the vertical offset 
of the shadow.</p>
<p>The 
...
<p>The <code class="w3-codespan">blur</code> parameter defines the blur radius 
...
<p>The <code class="w3-codespan">spread</code> parameter defines the spread radius 
of the shadow.</p>
<p>A positive value increases 
the size of the shadow, and a negative value decreases the size of the shadow.</p>
...
an outer shadow (outset) to an inner shadow (inside an element's frame).</p>
...
<p>To attach more than one shadow to an element, add a comma-separated list of shadows.</p>
<div id="boxshadow6">A &lt;div&gt; element with multiple shadows</div>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
    div
{<br>
&nbsp; box-shadow: 5px 5px 8px blue, 10px 10px 8px red, 15px 15px 8px green;<br>
}
</div>
