...
<h1>CSS <span class="color_h1">object-position Property</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="css_challenges_objectfit.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="css_challenges_objectposition.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS object-position Property</h2>
<p>The CSS <code class="w3-codespan"><a href="/cssref/css3_pr_object-position.php">object-position</a></code> property 
is used together with the <code class="w3-codespan">
<a href="/cssref/css3_pr_object-fit.php">object-fit</a></code> property to 
specify how an &lt;img&gt; or &lt;video&gt; should be positioned with x/y coordinates within 
its container.</p>

<p>The first value controls the x-axis and the second value controls the y-axis. 
The value can be a string (left, center or right), or a number (in px or %). 
Negative values are also allowed.</p>
<!--stop-->
<hr>
<!--start-->
<h2>Using the object-position Property</h2>
<p>Let's say that the part of the image that is shown, is not the part that we 
want. To 
position the image, we will use the <code class="w3-codespan">
object-position</code> property.</p>
<p>Here we position the image so that the great old building is in 
center:</p>

<img src="paris.jpg" alt="Paris" style="width:200px;height:300px;object-fit:cover;object-position:80% 100%">
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  .image-container {<br>&nbsp; width: 200px;<br>&nbsp; height: 300px;<br>&nbsp; 
  border: 1px solid black;<br>}<br><br>.image-container img {<br>&nbsp; width: 100%;<br>&nbsp; 
  height: 100%;<br>&nbsp; object-fit: cover;<br>&nbsp; object-position: 80% 
  100%; <br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss3_object-position" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>Here we will use the <code class="w3-codespan"><a href="/cssref/css3_pr_object-position.php">object-position</a></code> property 
to position the image so that the famous Eiffel Tower is in center:</p>
<img src="paris.jpg" alt="Paris" style="width:200px;height:300px;object-fit:cover;object-position:15% 100%">
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  .image-container {<br>&nbsp; width: 200px;<br>&nbsp; height: 300px;<br>&nbsp; 
  border: 1px solid black;<br>}<br><br>.image-container img {<br>&nbsp; width: 100%;<br>&nbsp; 
  height: 100%;<br>&nbsp; object-fit: cover;<br>&nbsp; object-position: 15% 
  100%; <br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss3_object-position2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_css3_object-position.js"></div>
<hr>
