...
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  ...
  <a href="https://youtu.be/AGDDdsiZ0Ko&list=PLP9IO4UYNF0UCaUSF3XNZ1U9f01E5h5PM" class="ga-featured ga-youtube" target="blank_" >
    <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
      ...
      <picture id="yt_div">
        <source srcset="images/css_introduction.webp" type="image/webp" />
