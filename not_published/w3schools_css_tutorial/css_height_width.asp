...
<a class="w3-left w3-btn" href="css_challenges_padding.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_height_width_min_max.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS Height and Width</h2>
<p>The CSS <code class="w3-codespan"><a href="/cssref/pr_dim_height.php">height</a></code> and <code class="w3-codespan">
<a href="/cssref/pr_dim_width.php">width</a></code> properties are used to set the height and width of an element.</p>
<div class="w3-theme-border" style="height:70px;width:100%;border-width:1px;border-style:solid;padding:8px;">
This element has a height of 70 pixels and a width of 100%.
</div>
<br>
<a target="_blank" href="tryit.asp?filename=trycss_height_width_intro" class="ws-btn">Try it Yourself &raquo;</a>
<!--stop-->
<hr>
<!--start-->

<h2>CSS Set height and width</h2>
<p>The <code class="w3-codespan"><a href="/cssref/pr_dim_height.php">height</a></code> and <code class="w3-codespan">
<a href="/cssref/pr_dim_width.php">width</a></code> properties are used to set the 
height and width of an element.</p>
<p>The height and width do not include padding, borders, or margins. 
...
<p>The <code class="w3-codespan"><a href="/cssref/pr_dim_height.php">height</a></code> and <code class="w3-codespan">
<a href="/cssref/pr_dim_width.php">width</a></code> properties 
...
<li><code class="w3-codespan">length</code> - Defines the height or width in px, cm, 
em, etc.</li>
<li><code class="w3-codespan">%</code> - Defines the height or width in percent of 
the containing block</li>
<li><code class="w3-codespan">initial</code> - Sets the height or width to its 
default value</li>
  <li><code class="w3-codespan">inherit</code> - The height or width will be 
...
<div class="w3-theme-border" style="width:50%;height:200px;padding:10px;background-color:powderblue;color:black;">
...
<div class="w3-theme-border" style="height:100px;width:500px;padding:10px;background-color:powderblue;color:black">
...
<p><strong>Note:</strong> Remember that the <code class="w3-codespan">
<a href="/cssref/pr_dim_height.php">height</a></code> and <code class="w3-codespan">
<a href="/cssref/pr_dim_width.php">width</a></code> properties do not include padding, borders, 
or margins! They set the height/width of the area inside the padding, border, 
and margin of the element!</p>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_height_width.js"></div>
<hr>
