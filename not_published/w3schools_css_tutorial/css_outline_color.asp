...
<h1>CSS <span class="color_h1">Outline Color</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_outline_width.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_outline_shorthand.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS Outline Color</h2>
<p>The <code class="w3-codespan"><a href="/cssref/pr_outline-color.php">outline-color</a></code> property is used to set the color of the outline.</p>
...
<h2>CSS Outline Color Examples</h2>

<p>Here are some different outlines with different colors. 
Also notice that these elements also have a thin black border inside the outline:</p>
<p style="border: 1px solid black;outline-style:solid;outline-color:red;padding:6px;">A solid red outline.</p>
<p style="border: 1px solid black;outline-style:dotted;outline-color:blue;padding:6px;">A dotted blue outline.</p>
<p style="border: 1px solid black;outline-style:outset;outline-color:green;padding:6px;">An outset green outline.</p>
<p style="border: 1px solid black;outline-style:solid;outline-color:invert;padding:6px;">A solid invert outline.</p>

<div class="w3-example">
<h3>Example</h3>
  <p>&nbsp;Demonstration of different outline colors:</p>
<div class="w3-code notranslate cssHigh">
  p {<br>&nbsp; border: 1px solid black;<br>&nbsp; padding: 5px;<br>}<br><br>
  p.ex1 {<br>&nbsp; outline-style: solid;<br>&nbsp; outline-color: red;<br>}<br>
  <br>p.ex2 {<br>&nbsp; outline-style: dotted;<br>&nbsp; outline-color: blue;<br>
  }<br><br>p.ex3 {<br>&nbsp; outline-style: outset;<br>&nbsp; outline-color: 
  green;<br>}<br><br>p.ex4 {<br>&nbsp; outline-style: solid;<br>&nbsp; 
  outline-color: invert;<br>}</div>
...
<!--start-->
<h2>HEX Values</h2>
<p>The outline color can also be specified using a hexadecimal value (HEX):</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  p.ex1 {<br>&nbsp; outline-style: solid;<br>&nbsp; outline-color: #ff0000; 
  /* red */<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_outline-color-hex" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<!--start-->
<h2>RGB Values</h2>
<p>Or by using RGB values:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  p.ex1 {<br>&nbsp; outline-style: solid;<br>&nbsp; outline-color: rgb(255, 0, 0); /* 
  red */<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_outline-color-rgb" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>HSL Values</h2>
<p>You can also use HSL values:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  p.ex1 {<br>&nbsp; outline-style: solid;<br>&nbsp; outline-color: hsl(0, 100%, 50%); 
  /* red */<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_outline-color-hsl" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<div class="ws-note w3-panel">
<p>You can learn more about HEX, RGB and HSL values in our <a href="css_colors.asp">CSS Colors</a> chapters.</p>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_outline_color.js"></div>
<hr>
