...
<html lang="en-US">
<head>
<title>CSS Interactive Pseudo-classes</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">Interactive Pseudo-classes</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_pseudo_classes.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_pseudo_classes_structural.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>Interactive Pseudo-classes</h2>
<p>Interactive pseudo-classes apply styles based on user interaction with elements.</p>

<p>Here we use the <code class="w3-codespan"><a href="/cssref/sel_hover.php">:hover</a></code> pseudo-class and the 
<code class="w3-codespan"><a href="/cssref/sel_focus.php">:focus</a></code> pseudo-class:</p>
<div class="w3-row">
<div class="w3-half">
<div class="mouseover">
<p>Mouse Over Me</p>
...
<div class="w3-half">
<input class="focus" type="text" name="fname" autocomplete="off" placeholder="Click Me To Get Focus">
</div>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Pseudo-classes Used on Links</h2>
<p>For HTML links, it is common to use the following pseudo-classes:</p>
<ul>
  <li><code class="w3-codespan"><a href="/cssref/sel_link.php">:link</a></code> - Styles unvisited links</li>
  <li><code class="w3-codespan"><a href="/cssref/sel_visited.php">:visited</a></code> - Styles visited links</li>
  <li><code class="w3-codespan"><a href="/cssref/sel_hover.php">:hover</a></code> - Styles a link on mouse over</li>
  <li><code class="w3-codespan"><a href="/cssref/sel_active.php">:active</a></code> - Styles an activated link</li>
</ul>
<div class="w3-example">
<h3>Example</h3>
  <p>Display links in different colors depending on state:</p>
...
<a target="_blank" href="tryit.asp?filename=trycss_pseudo-class_links" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
<br>
</div>
...
<!--start-->
<h2>:hover on &lt;div&gt;</h2>
<p>Here is an example of using the <code class="w3-codespan">
<a href="/cssref/sel_hover.php">:hover</a></code> pseudo-class on a &lt;div&gt; element:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
...
<p>Here is an example of using the <code class="w3-codespan">
<a href="/cssref/sel_focus.php">:focus</a></code> pseudo-class to style an input field when it gets focus:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  input:focus {<br>&nbsp; background-color: yellow;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_link_focus" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
<br>
</div>
<!--stop-->
<hr>
...
<p>Pseudo-classes can easily be combined with HTML classes:</p>
<div class="w3-example">
<h3>Example</h3>
  <p>Add a :hover pseudo-class to the &lt;a&gt; element with class &quot;highlight&quot;:</p>
<div class="w3-code notranslate cssHigh">
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_pseudo_classes_interactive.js"></div>
<hr>
