...
<html lang="en-US">
<head>
<title>CSS Grid Items - Order</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">Grid Items - Order</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="css_grid_item_align.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="css_challenges_grid_item.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>Set the Visual Order of the Grid Items</h2>

<p>The CSS <code class="w3-codespan"><a href="/cssref/css3_pr_order.php">order</a></code> property can be used to 
define the visual order of the grid items.</p>

<p>The first grid item in the HTML source code does not have to appear as the first item in the grid container.</p>

<div class="w3-example">
<h3>Example</h3>
  <p>Set the visual order of the grid items:</p>
<div class="w3-code notranslate cssHigh">
  .item1 {order: 3;}<br>.item2 {order: 6;}<br>.item3 {order: 1;}<br>.item4 
  {order: 2;}<br>.item5 {order: 4;}<br>.item6 {order: 5;}</div>
<p>Result:</p>
...
<p><a class="w3-btn" target="_blank" href="tryit.asp?filename=trycss_grid_order">Try it Yourself &raquo;</a></p>
</div>

<div class="w3-panel ws-note">
<p><strong>Accessibility note:</strong> The <code class="w3-codespan">order</code> 
...
order than it is visually presented.</p>
</div>
<!--stop-->
<hr>
