...
<html lang="en-US">
<head>
<title>CSS Outline Shorthand Property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">Outline Shorthand </span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_outline_color.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_outline_offset.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS Outline - Shorthand property</h2>
<p>The <code class="w3-codespan"><a href="/cssref/pr_outline.php">outline</a></code> property is a shorthand property for 
setting the following individual outline properties:</p>
<ul>
<li> <code class="w3-codespan"><a href="/cssref/pr_outline-width.php">outline-width</a></code></li>
<li> <code class="w3-codespan"><a href="/cssref/pr_outline-style.php">outline-style</a></code> (required)</li>
<li> <code class="w3-codespan"><a href="/cssref/pr_outline-color.php">outline-color</a></code></li>
</ul>
<p>You can specify one, two, or three values from the list above. The order of the values does not matter.</p>

<h2>CSS Outline Shorthand Examples</h2>
<p>Here are some different outlines specified with the shorthand <code class="w3-codespan"><a href="/cssref/pr_outline.php">outline</a></code>  
property:</p>
<p style="outline:dashed;padding:6px;">A dashed outline.</p>
<p style="outline:dotted red;padding:6px;">A dotted red outline.</p>
<p style="outline:7px solid yellow;padding:6px;">A 7px solid yellow outline.</p>
<p style="outline:ridge thick pink;padding:6px;">A thick ridge pink outline.</p>

<div class="w3-example">
<h3>Example</h3>
  <p>&nbsp;Demonstration of the outline shorthand property:</p>
<div class="w3-code notranslate cssHigh">
p.ex1
{outline: dashed;}<br>p.ex2
{outline: dotted red;}<br>p.ex3
{outline: 7px solid yellow;}<br>p.ex4
...
<hr>
<!--start-->
<h2>CSS Outline With Rounded Corners</h2>
<p>Outlines can also have rounded corners.</p>
<p>The <code class="w3-codespan" class="w3-codespan">
<a href="/cssref/css3_pr_border-radius.php">border-radius</a></code> property is 
used to add rounded borders to an element.</p>
<p>Here are some different outlines with rounded corners:</p>
<p style="outline:dashed;border-radius:8px;padding:6px;">A dashed outline.</p>
<p style="outline:dotted red;border-radius:8px;padding:6px;">A dotted red outline.</p>
<p style="outline:7px solid yellow;border-radius:8px;padding:6px;">A 7px solid yellow outline.</p>
<p style="outline:ridge thick pink;border-radius:8px;padding:6px;">A thick ridge pink outline.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  p.ex1 {<br>&nbsp; outline: dashed;<br>&nbsp; border-radius: 8px;<br>}<br><br>p.ex2 {<br>&nbsp; 
  outline: dotted red;<br>&nbsp; border-radius: 5px; <br>}<br><br>p.ex3 {<br>&nbsp; 
  outline: 7px solid yellow;<br>&nbsp; border-radius: 5px;<br>}<br><br>p.ex4 {<br>&nbsp; 
  outline: thick ridge pink;<br>&nbsp; border-radius: 8px;<br>}<br><br>p.ex5 {<br>&nbsp; outline: 
  thick solid green;<br>&nbsp; border-radius: 10px;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_outline2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_outline_shorthand.js"></div>
<hr>
