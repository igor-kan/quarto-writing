...
<h1>CSS <span class="color_h1">Text Shadow</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_text_spacing.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_challenges_text.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS Text Shadow</h2>
<p>The <code class="w3-codespan"><a href="/cssref/css3_pr_text-shadow.php">text-shadow</a></code> property adds shadow to text.</p>
<p>In its simplest use, you only specify the horizontal and the vertical shadow.</p>
<p>In addition, you can add a shadow color and blur effect.</p>
<h2 id="simpleshadow">Text shadow effect!</h2>
<div class="w3-example">
<h3>Example</h3>
  <p>Horizontal and vertical shadow:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_text-shadow1">Try it Yourself &raquo;</a>
</div>

<p>Next, add a color (red) to the shadow:</p>
<h2 id="simpleshadow2">Text shadow effect!</h2>
<div class="w3-example">
<h3>Example</h3>
  <p>Horizontal and vertical shadow, with color:</p>
<div class="w3-code notranslate cssHigh">
   h1
{<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_text-shadow2">Try it Yourself &raquo;</a>
</div>

<p>Then, add a blur effect (5px) to the shadow:</p>
<h2 id="simpleshadow3">Text shadow effect!</h2>
<div class="w3-example">
<h3>Example</h3>
  <p>Horizontal and vertical shadow, with color and blur effect:</p>
<div class="w3-code notranslate cssHigh">
    h1
{<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_text-shadow3">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>More Text Shadow Examples</h2>
...
<div class="w3-code notranslate cssHigh">
h1 {<br>
&nbsp; color: white;<br>&nbsp; text-shadow: 2px 2px 4px #000000;<br>}
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_text-shadow4">Try it Yourself &raquo;</a>
</div>

<h2 id="simpleshadow5">Text shadow effect!</h2>
<div class="w3-example">
<h3>Example</h3>
  <p>Text-shadow with red neon glow:</p>
<div class="w3-code notranslate cssHigh">
h1 {<br>
&nbsp; text-shadow: 0 0 3px #ff0000;<br>}
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_text-shadow5">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<p>The <code class="w3-codespan"><a href="/cssref/css3_pr_text-shadow.php">text-shadow</a></code> property 
...
<div class="w3-example">
<h3>Example</h3>
  <p>Text-shadow with red and blue neon glow:</p>
<div class="w3-code notranslate cssHigh">
h1 {<br>
&nbsp; text-shadow: 0 0 3px #ff0000, 0 0 5px #0000ff;<br>}
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_text-shadow6">Try it Yourself &raquo;</a>
</div>

<p>The following example shows a white text with black, blue, and red neon glow:</p>
<h2 id="simpleshadow7">Text shadow effect!</h2>
<div class="w3-example">
<h3>Example</h3>
  <p>Text-shadow with black, blue and red neon glow:</p>
<div class="w3-code notranslate cssHigh">
h1 {<br>
&nbsp; color: white;<br>&nbsp; text-shadow: 1px 1px 2px black, 0 0 25px blue, 0 
  0 5px red;<br>}
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_text-shadow7">Try it Yourself &raquo;</a>
</div>
<!--stop-->
...
<p><strong>Tip:</strong> <a href="css3_text_effects.asp">Go to our CSS Text Effects</a> chapter to learn about different text effects.</p>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_text_shadow.js"></div>
<hr>

<h2>The CSS Text Shadow Property</h2>
