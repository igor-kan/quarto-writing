...
<html lang="en-US">
<head>
<title>CSS Syllabus (Curriculum)</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">Syllabus</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_website.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_study_plan.asp">Next &#10095;</a>
</div>
<hr>
...
<p>The <a title="W3Schools CSS Tutorial" href="default.asp">W3Schools CSS Tutorial</a> is comprehensive and beginner-friendly.</p>
<p>It will give you a fundamental knowledge of CSS.</p>
...
<p>The syllabus outline and its sequence are structured so you can learn CSS step by step, from the introduction to creating your first application with CSS.</p>
<p><a title="W3Schools CSS Tutorial" href="css_intro.asp" class="ws-btn">Get Started With CSS &raquo;</a></p>
<hr>

<h2>Learning Outcomes</h2>
<ul>
    <li>Understand how CSS is used to format and style web pages.</li>
    <li>Use CSS rules and syntax to define how HTML elements look.</li>
    <li>Use colors, fonts, and text properties to customize webpage text.</li>
    <li>Implement different types of selectors (e.g., class, ID, element selectors) for targeted styling.</li>
    <li>Use the box model properties (border, padding, and margin) to create and change the layout.</li>
    <li>To organize elements on the page, use the positioning properties (static, relative, absolute, and fixed).</li>
    <li>Use media queries to create responsive web pages.</li>
    <li>Style borders and backgrounds with different qualities and effects.</li>
    <li>Learn how to utilize CSS Flexbox to create responsive, adaptable layouts.</li>
    <li>Link an external CSS file to an HTML document.</li>
</ul>
<div class="ws-note w3-panel">
<p><strong>Note:</strong> Are you a teacher teaching CSS? <a href="/academy/index.php" target="_blank">W3Schools Academy</a> is a toolbox of features that can help you teach. It offers classroom features such as pre-built study plans, classroom administration and much more. Read more about <a href="/academy/index.php" target="_blank">Academy here</a>.</p>
</div>
<hr>

<h2>Which Subjects Are CSS Relevant For?</h2>
<ul>
   <li style="margin-bottom:16px;"><strong>Web pages:</strong><br> HTML is the 
   standard markup language for creating web pages, and CSS is the language used 
   to style them.</li>

  <li style="margin-bottom:16px;"><strong>Computer Science (CS) / Information Technology (IT):</strong><br> 
  HTML together with CSS is fundamental to understanding the internet, web 
  development and programming.</li>
  <li style="margin-bottom:16px;"><strong>Digital Media:</strong><br> Text, 
  photos, and other media can be added to digital platforms using CSS together 
  with HTML, which is essential for content creation and management.</li>
  <li style="margin-bottom:16px;"><strong>Business / Entrepreneurship:</strong><br> Understanding how to create a website is helpful for projects related to the internet.</li>
  <li style="margin-bottom:16px;"><strong>Art and Design:</strong><br> CSS 
  supports Web Design, creativity, and visual communication ideas that are all 
  part of web design.</li>
  <li style="margin-bottom:16px;"><strong>STEM (Science, Technology, Engineering, Mathematics):</strong><br> 
  Building web pages with HTML and CSS is a part of technology integration in 
  STEM projects, teaching logical thinking and problem-solving.</li>
  <li><strong>Career and Technical Education (CTE):</strong><br> CSS together 
  with HTML is part of the curriculum for career-focused courses, especially 
  those related to web development, IT support, and digital marketing.</li>
</ul>
<p><a title="W3Schools CSS Tutorial" href="css_intro.asp" class="ws-btn" style="margin-top:8px">Get Started</a></p>
...
<h2>Activities</h2>
<p>In this tutorial we offer different activities for you to learn CSS for free:</p>
<ul>
    <li><a href="default.asp" title="W3Schools CSS Tutorial">Lessons</a></li>
    <li><a href="css_exercises.asp" title="W3Schools CSS Exercises">Exercises</a></li>
    <li><a href="css_quiz.asp" title="W3Schools CSS Quiz">Quizzes</a></li>
</ul>
<hr>
...
<p>CSS, like any other coding language, is best learned by working hands-on with code.</p>
<p>Easily try code with our "Try it Yourself" editor.</p>
<p>Here, you can edit CSS code and view the result:</p>
...
<p>The CSS exam is a test that summarizes the W3Schools CSS syllabus.</p>
<p>After passing the exam you get the "Certified CSS Developer" Certification.</p>
...
<p><a class="ws-btn" href="https://campus.w3schools.com/collections/certifications/products/css-certificate" target="_blank">Buy Certificate &raquo;</a></p>
<hr>
