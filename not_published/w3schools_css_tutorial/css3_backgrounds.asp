...
<a class="w3-left w3-btn" href="css_challenges_css3_border_images.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="css3_background_size.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>CSS Multiple Backgrounds</h2>
<p>CSS allows you to add multiple background images for an element, through the 
<code class="w3-codespan"><a href="/cssref/pr_background-image.php">background-image</a></code> property.</p>
...
(aligned to the right-bottom) and the second image is a paper-like background (aligned to the top-left corner):</p>
...
<div class="w3-code notranslate cssHigh">
   #example1 {<br>&nbsp;&nbsp;background-image: url(img_flwr.gif), url(paper.gif);<br>&nbsp;&nbsp;background-position: right bottom, left top;<br>&nbsp;&nbsp;background-repeat: no-repeat, repeat;<br>} </div>
...
background properties (as above) or with the <code class="w3-codespan">
<a href="/cssref/css3_pr_background.php">background</a></code> shorthand property.</p>
<p>The following example uses the <code class="w3-codespan">
background</code> shorthand property (same result as 
example above):</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
