<!DOCTYPE html>
<html lang="en-US">
<title>SciPy Online Compiler (Editor / Interpreter)</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
body.darkpagetheme .py-keyword  { color: #c5a5c5; }
body.darkpagetheme .py-module   { color: #c792ea; }
body.darkpagetheme .py-function { color: #faca6b; }
body.darkpagetheme .py-string   { color: #c3e88d; }
body.darkpagetheme .py-symbol   { color: #f1f1f1; }
...
<h1>SciPy <span class="color_h1">Online Compiler</span></h1>

<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="scipy_exam.php">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="scipy_quiz.php">Next &#10095;</a>
</div>
<hr>

<h2>SciPy (Python) Editor</h2>

<p>With our online editor, you can write Python code, use the SciPy module, and view the result in your browser.</p>
...
<div class="compiler-wrapper">
  ...
  <div class="compiler-body">
    ...
    <div class="editor">
<pre>
<span class="py-keyword">from</span> <span class="py-module">scipy</span> <span class="py-keyword">import</span> <span class="py-module">constants</span>

<span class="py-function">print</span><span class="py-symbol">(</span><span class="py-module">constants</span><span class="py-symbol">.</span><span class="py-module">liter</span><span class="py-symbol">)</span>
</pre>
    </div>

    <div class="output">0.001</div>

  </div>

  <div class="compiler-footer">
    <a href="trypython.php?filename=demo_scipy_editor"
       target="_blank"
       class="ws-btn">
...
<h2>Publish Your Code</h2>

<p>If you want to create your own website or build Python applications, check out <a href="/spaces/index.php">W3Schools Spaces</a>.</p> 

<p>With <a href="/spaces/index.php">W3Schools Spaces</a>, you can write, run, and share Python code directly in your browser.</p>

<p><a href="/spaces/index.php">W3Schools Spaces</a> supports libraries like NumPy, Pandas, and SciPy.</p>


<div class="ws-note w3-panel">
  <p>If you don't know Python, we suggest that you read our <a href="/python/default.asp">Python Tutorial</a> from scratch.</p>
</div>
