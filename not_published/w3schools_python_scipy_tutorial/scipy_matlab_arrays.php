...
<html lang="en-US">
<head>
<title>SciPy Matlab Arrays</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>SciPy <span class="color_h1">Matlab Arrays</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="scipy_spatial_data.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="scipy_interpolation.php">Next &#10095;</a>
</div>
<hr>

<h2>Working With Matlab Arrays</h2>
<p>We know that NumPy provides us with methods to persist the data in readable formats for 
Python.
But SciPy provides us with interoperability with Matlab as well.</p>
<p>SciPy provides us with the module <code class="w3-codespan">scipy.io</code>, which has functions for working with 
Matlab arrays.</p>

<hr>

<h2>Exporting Data in Matlab Format</h2>

<p>The <code class="w3-codespan">savemat()</code> function allows us to export data in 
Matlab format.</p>

<p>The method takes the following parameters:</p>

<ol>
<li><strong>filename</strong> - the file name for saving data.</li>
<li><strong>mdict</strong> - a dictionary containing the data.</li>
<li><strong>do_compression</strong> - a boolean value that specifies whether to compress the 
result or not. Default False.</li>
</ol>

<div class="w3-example">
<h3>Example</h3>
<p>Export the following array as variable name "vec" to a mat file:</p>
<div class="w3-code notranslate pythonHigh">
from scipy import io<br>
import numpy as np<br>
<br>
arr = np.arange(10)<br>
<br>
io.savemat('arr.mat', {"vec": arr})<br>
</div>
</div>

<div class="w3-panel ws-note">
  <p><strong>Note:</strong> The example above saves a file name "arr.mat" on your computer.</p>
  <p>To open the file, check out the "Import Data from Matlab Format" example below:</p>
</div>
...
<h2>Import Data from Matlab Format</h2>

<p>The <code class="w3-codespan">loadmat()</code> function allows us to import data from a 
Matlab file.</p>

<p>The function takes one required parameter:</p>

<p>
<strong>filename</strong> - the file name of the saved data.
</p>

<p>It will return a structured array whose keys are the variable names, and the corresponding values are the variable values.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Import the array from following mat file.:</p>
<div class="w3-code notranslate pythonHigh">
from scipy import io<br>
import numpy as np<br>
<br>
...
<br>
# Export:
<br>io.savemat('arr.mat', {"vec": arr})<br>
<br>
# Import:<br>
  mydata = io.loadmat('arr.mat')<br>
<br>
print(mydata)</div>
<h3>Result:</h3>
<p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.php?filename=demo_scipy_matlab_arrays">Try it Yourself &raquo;</a>
</div>

<p>Use the variable name "vec" to display only the array from the matlab data:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.php?filename=demo_scipy_matlab_arrays2">Try it Yourself &raquo;</a>

</div>


<p><strong>Note:</strong> We can see that the array originally was 1D,
but on extraction it has increased one dimension.</p>
<p>In order to resolve this we can pass an additional argument <code class="w3-codespan">squeeze_me=True</code>:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
# Import:<br>
mydata = io.loadmat('arr.mat', squeeze_me=True)<br>
<br>
print(mydata['vec'])</div>
<h3>Result:</h3>
<p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.php?filename=demo_scipy_matlab_arrays3">Try it Yourself &raquo;</a>

</div>
<hr>
<div id="exercisecontainer" src="xrcise_matlab_arrays.js" data-extensions="php"></div>
<hr>
