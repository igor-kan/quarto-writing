...
ny:-->
    ...
    <h1>SciPy <span class="color_h1">Graphs</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="scipy_sparse_data.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="scipy_spatial_data.php">Next &#10095;</a>
</div>
<hr>

<h2>Working with Graphs</h2>
<p>Graphs are an essential data structure.</p>
<p>SciPy provides us with the module <code class="w3-codespan">scipy.sparse.csgraph</code> for working with 
such data structures.</p>

<hr>
<h2>Adjacency Matrix</h2>

<p>Adjacency matrix is a <code class="w3-codespan">nxn</code> matrix where <code class="w3-codespan">n</code>
is the number of elements in a graph.</p>

<p>And the values represents the connection between the elements.</p>

<p>Example:</p>
<div style="text-align:center">
<img src="../scipy_graph.png" style="margin:auto;text-align:center;max-width:100%">
</div>
<p>For a graph like this, with elements A, B and C, the connections are:</p>
<p>A &amp; B are connected with weight 1.</p>
<p>A &amp; C are connected with weight 2.</p>
<p>C &amp; B is not connected.</p>

<p>The Adjency Matrix would look like this:</p>
...
<p>Below follows some of the most used methods for working with adjacency matrices.</p>
<hr>

<h2>Connected Components</h2>

Find all of the connected components with the <code class="w3-codespan">connected_components()</code> method.
...
<br>
newarr = csr_matrix(arr)<br>
<br>
print(connected_components(newarr))</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_scipy_graphs_connected_components">Try it Yourself &raquo;</a>
</div>
...
<p>Use the <code class="w3-codespan">dijkstra</code> method to find the shortest path in a graph from one element to 
another.</p>
<p>It takes following arguments:</p>
<ol>
<li><strong>return_predecessors:</strong> boolean (True to return whole path of traversal 
otherwise False).</li>
<li><strong>indices:</strong> index of the element to return all paths from that element only.</li>
<li><strong>limit:</strong> max weight of path.</li>
</ol>
<div class="w3-example">
<h3>Example</h3>
<p>Find the shortest path from element 1 to 2:</p>
<div class="w3-code notranslate pythonHigh">
import numpy as np<br>
from scipy.sparse.csgraph import dijkstra<br>
from scipy.sparse import csr_matrix<br>
<br>
arr = np.array([<br>
&nbsp;&nbsp;[0, 1, 2],<br>
...
newarr = csr_matrix(arr)<br>
<br>
print(dijkstra(newarr, return_predecessors=True, indices=0))</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_scipy_graphs_dijkstra">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Floyd Warshall</h2>

<p>Use the <code class="w3-codespan">floyd_warshall()</code> method to find shortest path between all pairs of elements.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Find the shortest path between all pairs of elements:</p>
<div class="w3-code notranslate pythonHigh">
import numpy as np<br>
from scipy.sparse.csgraph import floyd_warshall<br>
from scipy.sparse import csr_matrix<br>
<br>
arr = np.array([<br>
&nbsp;&nbsp;[0, 1, 2],<br>
...
newarr = csr_matrix(arr)<br>
<br>
print(floyd_warshall(newarr, return_predecessors=True))</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_scipy_graphs_floyd_warshall">Try it Yourself &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">bellman_ford()</code> method can also find the shortest path between all pairs of elements, but this method can handle negative weights as well.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Find shortest path from element 1 to 2 with given graph with a negative weight:</p>
<div class="w3-code notranslate pythonHigh">
import numpy as np<br>
from scipy.sparse.csgraph import bellman_ford<br>
from scipy.sparse import csr_matrix<br>
<br>
arr = np.array([<br>
&nbsp;&nbsp;[0, -1, 2],<br>
...
newarr = csr_matrix(arr)<br>
<br>
print(bellman_ford(newarr, return_predecessors=True, indices=0))</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_scipy_graphs_bellman_ford">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Depth First Order</h2>

<p>The <code class="w3-codespan">depth_first_order()</code> method returns a depth first traversal from a node.</p>
...
<div class="w3-example">
<h3>Example</h3>
<p>Traverse the graph depth first for given adjacency matrix:</p>
<div class="w3-code notranslate pythonHigh">
import numpy as np<br>
from scipy.sparse.csgraph import depth_first_order<br>
from scipy.sparse import csr_matrix<br>
<br>
arr = np.array([<br>
&nbsp;&nbsp;[0, 1, 0, 1],<br>
...
newarr = csr_matrix(arr)<br>
<br>
print(depth_first_order(newarr, 1))</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_scipy_graphs_depth_first_order">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Breadth First Order</h2>

<p>The <code class="w3-codespan">breadth_first_order()</code> method returns a breadth first traversal from a node.</p>
...
<div class="w3-example">
<h3>Example</h3>
<p>Traverse the graph breadth first for given adjacency matrix:</p>
<div class="w3-code notranslate pythonHigh">
import numpy as np<br>
from scipy.sparse.csgraph import breadth_first_order<br>
from scipy.sparse import csr_matrix<br>
<br>
arr = np.array([<br>
&nbsp;&nbsp;[0, 1, 0, 1],<br>
...
newarr = csr_matrix(arr)<br>
<br>
print(breadth_first_order(newarr, 1))</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_scipy_graphs_breadth_first_order">Try it Yourself &raquo;</a>
</div>
