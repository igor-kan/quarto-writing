...
ny:-->
    ...
    <h1>SciPy <span class="color_h1">Exercises</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="scipy_quiz.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="scipy_syllabus.php">Next &#10095;</a>
</div>
<hr>
<p>Test your SciPy skills with exercises from all categories:</p>
<style>
.exercise_tiles {
  background:#f3f4f6;
  border-radius:12px;
...
<input id="exercise_filter" type="search" placeholder="Filter categories (e.g. arrays, data, graph, etc.)" aria-label="Filter categories">
<div id="exercise_counter"><span class="count">0</span>/9 done</div>
</div>



<a href='exercise.php?x=xrcise_getting_started1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_getting_started'><div class='tile-content'><h2>Introduction<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Introduction exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Introduction completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.php?x=xrcise_constants1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_constants'><div class='tile-content'><h2>Constants<small>7 exercises</small></h2></div><button class='open-btn' aria-label='Open Constants exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Constants completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.php?x=xrcise_optimizers1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_optimizers'><div class='tile-content'><h2>Optimizers<small>4 exercises</small></h2></div><button class='open-btn' aria-label='Open Optimizers exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Optimizers completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.php?x=xrcise_sparse_data1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_sparse_data'><div class='tile-content'><h2>Sparse Data<small>4 exercises</small></h2></div><button class='open-btn' aria-label='Open Sparse Data exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Sparse Data completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.php?x=xrcise_graphs1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_graphs'><div class='tile-content'><h2>Graphs<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Graphs exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Graphs completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.php?x=xrcise_spatial_data1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_spatial_data'><div class='tile-content'><h2>Spatial Data<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Spatial Data exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Spatial Data completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.php?x=xrcise_matlab_arrays1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_matlab_arrays'><div class='tile-content'><h2>Matlab Arrays<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Matlab Arrays exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Matlab Arrays completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.php?x=xrcise_interpolation1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_interpolation'><div class='tile-content'><h2>Interpolation<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Interpolation exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Interpolation completed' disabled><span class='done-label'>Done</span></div></a><a href='exercise.php?x=xrcise_statistical_significance_tests1' target='_blank' rel='opener'><div class='exercise_tile' id='xr_statistical_significance_tests'><div class='tile-content'><h2>Significance Tests<small>3 exercises</small></h2></div><button class='open-btn' aria-label='Open Significance Tests exercises'>Open</button><input type='checkbox' class='complete-checkbox' aria-label='Significance Tests completed' disabled><span class='done-label'>Done</span></div></a>
</div>
<hr>
...
<p>If you don't know SciPy, we suggest that you read our <a href="index.php">SciPy Tutorial</a> from scratch.</p>
</div>
<hr>
<style>
#w3_cert_cta {
