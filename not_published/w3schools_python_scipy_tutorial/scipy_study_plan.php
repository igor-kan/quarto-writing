...
<html lang="en-US">
<head>
<title>SciPy Study Plan (Lesson Plan)</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>SciPy <span class="color_h1">Study Plan</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="scipy_syllabus.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="index.php">Next &#10095;</a>
</div>
<hr>

<h2>Introduction</h2>
<p>The SciPy study plan helps you teach your students SciPy step-by-step.</p>
<p>Creating a study plan for SciPy is easy.</p>
...
<p>Save time with pre-built teacher materials and study plans. Easily organize your class with a timeline from the introduction of SciPy to the final exam.</p>
<hr>
...
<p>W3Schools has everything you need to teach SciPy.</p>

<p>The SciPy training materials is available for you to include and use in your study plan:</p>
<ul>
  <li><a href="index.php" target="_blank">W3Schools SciPy Tutorial</a></li>
  <li><a href="scipy_exercises.php" target="_blank">SciPy Exercises</a></li>
  <li><a href="scipy_quiz.php" target="_blank">SciPy Quiz</a></li>
  <li>SciPy Challenges (Coding challenges)</li>
  <li><a href="scipy_exam.php" target="_blank">SciPy Certification Exam (End of Pathway Exam)</a></li>
</ul>
<hr>

<h2>SciPy Syllabus</h2>
<p>With the SciPy Syllabus, your students will start with the basics, like understanding SciPy sub-packages and performing basic scientific calculations, and move to more advanced topics, like optimization, integration, and signal processing. Each chapter includes simple examples, try-it-yourself sections, exercises, and quizzes to make learning easy, interactive, and fun.</p>
<p><a title="W3Schools SciPy Syllabus" href="scipy_syllabus.php" target="_blank">Read more about SciPy Syllabus</a>.</p>
<hr>
...
<ol>
  ...
  <li style="margin-top:16px">
    ...
    <ul>
      <li>The SciPy study plan aligns with the SciPy Certification Exam.</li>
      <li>The exam can be taken at the end of the study plan, at your selected date.</li>
      <li>The exam summarizes the SciPy Tutorial.</li>
...
<p>For example, this is how a 3-week SciPy study plan could look like:</p>

<ul>
  <li>Week 1: Introduction, Constants, Optimizers</li>
  <li>Week 2: Sparse Data, Graphs, Spatial Data, Matlab Arrays, Interpolation</li>
  <li>Week 3: Significance Tests, SciPy Certification Exam</li>
</ul>

<p>Image of Sample SciPy study plan:</p>
<a href="scipy_study_plan.png" target="_blank" title="SciPy Study Plan"><img src="scipy_study_plan.png" style="height:auto;max-width:100%;" loading="lazy"></a>
<hr>

<h2>Ready to get started?</h2>
<p>Start with <strong> SciPy Study Plans</strong> today.</p>
...
<p>Are you interested in learning how you can use <a href="/academy/index.php" target="_blank">W3Schools Academy</a> to Teach SciPy programming? </p>
