...
<html lang="en-US">
<head>
<title>SciPy Getting Started</title>
<!-- [START] inc_meta.inc -->
<meta charset="utf-8">
...
ny:-->
    ...
    <h1>SciPy <span class="color_h1">Getting Started</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="scipy_intro.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="scipy_constants.php">Next &#10095;</a>
</div>
<hr>

<h2>Installation of SciPy</h2>
<p>If you have <a href="/python/default.asp">Python</a> and <a href="/python/python_pip.asp">PIP</a> already installed on a system, then installation of 
SciPy is very easy.</p>
<p>Install it using this command:</p>

<div class="w3-example">
<div class="w3-code notranslate w3-black">
C:\Users\<em>Your Name</em>&gt;pip install scipy</div>
</div>

<p>If this command fails, then use a Python distribution that already has SciPy installed like, Anaconda, Spyder etc.</p>
<hr>

<h2>Import SciPy</h2>
<p>Once SciPy is installed, import the SciPy module(s) you want to use in your applications by adding the
<code class="w3-codespan">from scipy import <i>module</i></code> statement:</p>
...
<p>Now we have imported the <em>constants</em> module from SciPy, and the application is ready to use it:</p>
...
<div class="w3-panel ws-note">
  <p><strong>constants:</strong> SciPy offers a set of mathematical constants, one of them is 
  <code class="w3-codespan">liter</code> which returns 1 liter as cubic meters.</p>
  <p>You will learn more about constants in the next chapter.</p>
</div>

<hr>

<h2>Checking SciPy Version</h2>

<p>The version string is stored under the <code class="w3-codespan">__version__</code> 
attribute.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  import scipy<br><br>print(scipy.__version__)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_scipy_version">Try it Yourself &raquo;</a>
</div>
...
<div id="exercisecontainer" src="xrcise_getting_started.js" data-extensions="php"></div>
<hr>
