...
ny:-->
    ...
    <h1>SciPy <span class="color_h1">Sparse Data</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="scipy_optimizers.php">&#10094; Previous</a>
<a class="w3-right w3-btn" href="scipy_graphs.php">Next &#10095;</a>
</div>
<hr>

<h2>What is Sparse Data</h2>
<p>Sparse data is data that has mostly unused elements (elements that don't carry any information ).</p>
<p>It can be an array like this one:</p>
<p><code class="w3-codespan">[1, 0, 2, 0, 0, 3, 0, 0, 0, 0, 0, 0]</code></p>

<div class="w3-panel ws-note">
  <p><strong>Sparse Data:</strong> is a data set where most of the item values are zero.</p>
  <p><strong>Dense Array:</strong> is the opposite of a sparse array: most of the values are <em>not </em>zero.</p>
</div>

<p>In scientific computing, when we are dealing with partial derivatives in linear algebra we will come across sparse data.</p>

<hr>
<h2>How to Work With Sparse Data</h2>

<p>SciPy has a module, <code class="w3-codespan">scipy.sparse</code>
that provides functions to deal with sparse data.</p>

<p>There are primarily two types of sparse matrices that we use:</p>

<p><strong>CSC</strong> - Compressed Sparse Column. For efficient arithmetic, 
fast column slicing.</p>
<p><strong>CSR</strong> - Compressed Sparse Row. For fast row slicing, faster 
matrix vector products</p>
<p>We will use the <strong>CSR </strong>matrix in this tutorial.</p>

<hr>

<h2>CSR Matrix</h2>

<p>We can create CSR matrix by passing an arrray into function <code class="w3-codespan">scipy.sparse.csr_matrix()</code>.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Create a CSR matrix from an array:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_scipy_sparse_csr">Try it Yourself &raquo;</a>
</div>

<p>The example above returns:</p>
...
<style>
.darkcodespan .w3-codespan {
  color:#fff;
  background-color:rgb(40,44,52);
}
</style>
<div class="darkcodespan">
<p>From the result we can see that there are 3 items with value.</p>
<p>The 1. item is in row <code class="w3-codespan">0</code> position 
<code class="w3-codespan">5</code> and has the value <code class="w3-codespan">
1</code>.</p>
<p>The 2. item is in row <code class="w3-codespan">0</code> position 
<code class="w3-codespan">6</code> and has the value <code class="w3-codespan">
1</code>.</p>
<p>The 3. item is in row <code class="w3-codespan">0</code> position 
<code class="w3-codespan">8</code> and has the value <code class="w3-codespan">
2</code>.</p>
</div>
...
<p>Viewing stored data (not the zero items) with the <code class="w3-codespan">data</code> property:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_scipy_sparse_csr2">Try it Yourself &raquo;</a>
</div>
<p>Counting nonzeros with the <code class="w3-codespan">count_nonzero()</code> method:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_scipy_sparse_count_nonzero">Try it Yourself &raquo;</a>
</div>

<p>Removing zero-entries from the matrix with the <code class="w3-codespan">eliminate_zeros()</code> method:</p>
...
<br>
arr = np.array([[0, 0, 0], [0, 0, 1], [1, 0, 2]])<br>
<br>
mat = csr_matrix(arr)<br>
mat.eliminate_zeros()<br>
<br>
print(mat)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_scipy_sparse_eliminate_zeros">Try it Yourself &raquo;</a>
</div>

<p>Eliminating duplicate entries with the <code class="w3-codespan">sum_duplicates()</code> method:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Eliminating duplicates by adding them:</p>
<div class="w3-code notranslate pythonHigh">
import numpy as np<br>
from scipy.sparse import csr_matrix<br>
<br>
...
<br>
mat = csr_matrix(arr)<br>
mat.sum_duplicates()<br>
<br>
print(mat)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_scipy_sparse_sum_duplicates">Try it Yourself &raquo;</a>
</div>

<p>Converting from csr to csc with the <code class="w3-codespan">tocsc()</code> method:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.php?filename=demo_scipy_sparse_tocsc">Try it Yourself &raquo;</a>
</div>


<div class="w3-panel ws-note">
  <p><strong>Note:</strong> Apart from the mentioned sparse specific operations, sparse matrices support all of the operations that normal matrices support e.g. reshaping, summing, arithemetic, broadcasting etc.</p>
</div>


<hr>
<div id="exercisecontainer" src="xrcise_sparse_data.js" data-extensions="php"></div>
<hr>
