...
<p>The <code class="w3-codespan">UPDATE</code> statement is used to update or modify 
one or more records in a table.</p>
...
<!--start-->
<h2>UPDATE Table</h2>
<p>The following SQL updates the record with CustomerID = 1, with a new contact person 
AND 
a new city.</p>
...
<p>The <code class="w3-codespan">WHERE</code> clause determines which records 
...
WHERE</code> clause, ALL records will be updated!</p>
</div>
<p>The following SQL will update the ContactName to "Juan" for ALL records:</p>
<div class="w3-example">
  <h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
UPDATE Customers<br>
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_update.js"></div>
<hr>
