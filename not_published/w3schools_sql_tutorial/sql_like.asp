...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="sql_avg.asp">&#10094; Previous</a>
...
WHERE</code> clause to search for a specified pattern within a column's text 
data.</p>
...
<p>The following SQL selects all customers that starts with the letter "a":</p>
...
WHERE <em>columnN</em> LIKE <em>pattern</em>;</code></p>
</div>
<hr>
...
<p>The <code class="w3-codespan">%</code> wildcard represents any number of characters, even zero characters.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Return all customers from a City that <em>contains</em> the character 
sequence 'on':</p>
<div class="w3-code notranslate sqlHigh">
 SELECT * FROM Customers<br>
 WHERE city LIKE '%on%';</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_like_l" class="w3-btn w3-margin-bottom">
 Try it Yourself &raquo;</a>
</div>
<hr>

<h2>The _ Wildcard</h2>
<p>The <code class="w3-codespan">_</code> wildcard represents one single character.</p>
<p>It can be any character or number, but each <code class="w3-codespan">_</code> represents one, and only one, character.</p>
<div class="w3-example">
<h3>Example</h3>
...
<div class="w3-code notranslate sqlHigh">
 SELECT * FROM Customers<br>
 WHERE city LIKE 'l_nd__';</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_like_london" class="w3-btn w3-margin-bottom">
 Try it Yourself &raquo;</a>
</div>
<hr>
...
<h2>Starts With</h2>
<p>To return records that starts with a specific letter or phrase, add the <code class="w3-codespan">%</code> at the end of the letter or phrase.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Return all customers that starts with 'La':</p>
<div class="w3-code notranslate sqlHigh">
 SELECT * FROM Customers<br>
 WHERE CustomerName LIKE 'La%';</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_like_la" class="w3-btn w3-margin-bottom">
 Try it Yourself &raquo;</a>
</div>
...
<div class="w3-example">
<h3>Example</h3>
<p>Return all customers that starts with 'a' or starts with 'b':</p>
<div class="w3-code notranslate sqlHigh">
 SELECT * FROM Customers<br>
 WHERE CustomerName LIKE 'a%' OR CustomerName LIKE 'b%'; </div>
<a target="_blank" href="trysql.asp?filename=trysql_select_like_ending2" class="w3-btn w3-margin-bottom">
 Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Ends With</h2>
<p>To return records that ends with a specific letter or phrase, add the <code class="w3-codespan">%</code> at the beginning of the letter or phrase.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Return all customers that ends with 'a':</p>
<div class="w3-code notranslate sqlHigh">
 SELECT * FROM Customers<br>
 WHERE CustomerName LIKE '%a'; </div>
...
<div class="w3-panel ws-note">
<p><strong>Tip:</strong> You can also combine "starts with" and "ends with":</p>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Return all customers that starts with "b" and ends with "s":</p>

<div class="w3-code notranslate sqlHigh">
 SELECT * FROM Customers<br>
  WHERE CustomerName LIKE 'b%s';</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_like_startend" class="w3-btn w3-margin-bottom">
 Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Contains</h2>
<p>To return records that contains a specific letter or phrase, add the 
<code class="w3-codespan">%</code> both before and after the letter or phrase.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Return all customers that contains the phrase 'or'</p>
<div class="w3-code notranslate sqlHigh">
 SELECT * FROM Customers<br>
...
<h2>Combine Wildcards</h2>
<p>Any wildcard, like <code class="w3-codespan">%</code> and <code class="w3-codespan">_</code> 
, can be used in combination with other 
wildcards.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Return all customers that starts with "a" and are at least 3 characters in length:</p>
...
<h2>Without Wildcards</h2>
<p>If no wildcard is specified, the phrase has to have an exact match to return a result.</p>
<div class="w3-example">
<h3>Example</h3>
...
<a target="_blank" href="trysql.asp?filename=trysql_select_like_spain" class="w3-btn w3-margin-bottom">
 Try it Yourself &raquo;</a>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_like.js"></div>
<hr>
