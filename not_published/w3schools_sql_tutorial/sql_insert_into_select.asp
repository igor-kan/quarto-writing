...
<p>The <code class="w3-codespan">INSERT INTO SELECT</code> statement is used to copy data from 
an existing table and 
insert it into another existing table.</p>
...
INSERT INTO <em>target_table</em><br>
SELECT * FROM <em>source_table</em><br>
WHERE <em>condition</em>;
</div></div>

<p><strong>Note:</strong> If you omit the column names, the number and order of 
columns in the source and target tables must be exactly the same!</p>

<p>Copy only some columns from one table to another table:</p>
<div class="w3-example">
<div class="w3-code notranslate sqlHigh">
INSERT INTO <em>target_table </em>(<em>column1</em>, <em>column2</em>, <em>column3</em>, ...)<br>
SELECT <em>column1</em>, <em>column2</em>, <em>column3</em>, ...<br>
FROM <em>source_table</em><br>
WHERE <em>condition</em>;
</div></div>
<hr>
...
<div class="w3-example">
<h3>Example</h3>
<p>Copy "Suppliers" into "Customers" (the columns that are not filled with data, will contain NULL):</p>
<div class="w3-code notranslate sqlHigh">
...
<div class="w3-example">
<h3>Example</h3>
<p>Copy "Suppliers" into "Customers" (copy all columns):</p>
<div class="w3-code notranslate sqlHigh">
  INSERT INTO Customers<br>SELECT * FROM Suppliers;
</div>
</div>
...
<hr>
<div id="exercisecontainer" src="xrcise_insert_into_select.js"></div>
<hr>
