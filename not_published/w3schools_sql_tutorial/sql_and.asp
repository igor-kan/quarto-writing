...
<h1>SQL <span class="color_h1">AND</span> Operator</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="sql_orderby.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="sql_or.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->

<h2>The SQL AND Operator</h2>
<p>The <code class="w3-codespan">WHERE</code> clause can contain one or many <code class="w3-codespan">
AND</code> operators.</p>
<p>The <code class="w3-codespan">AND</code> operator is used to filter records 
based on more than one condition.</p>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> The <code class="w3-codespan">AND</code> operator displays a record if <strong>all</strong> the conditions are TRUE.</p>
</div>

<p>The following SQL selects all customers from Spain that starts with the letter 'G':</p>
...
<a target="_blank" href="trysql.asp?filename=trysql_select_and" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
WHERE <em>condition1</em> AND <em>condition2</em> AND <em>condition3 ...</em>;</code></p>
</div>
<hr>
...
<hr>
<!--start-->
<h2>All Conditions Must Be True</h2>
<p>The following SQL selects all customers where 
Country is "Brazil" AND 
City is "Rio de Janeiro" AND CustomerID is higher than 50:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
  SELECT * FROM Customers<br>WHERE Country = 'Brazil'<br>AND City = 'Rio de 
  Janeiro'<br>AND CustomerID &gt; 50;
</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_where_and_and" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<h2>AND vs. OR</h2>
<div class="w3-panel ws-note">
<p>The <code class="w3-codespan">AND</code> operator displays a record if 
<strong>all</strong> the conditions are TRUE.</p>
<p>The <code class="w3-codespan">OR</code> operator displays a record if <strong>any</strong> of the conditions are TRUE.</p>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Combining AND and OR</h2>
<p>You can also combine <code class="w3-codespan">AND</code> and <code class="w3-codespan">OR</code> operators.</p>

<p>The following SQL selects all customers from Spain that starts with a "G" or an "R" 
(make sure to use parenthesis to get the correct result):</p>
<div class="w3-example">
<h3>Example</h3>
<p>Select all Spanish customers that starts with either "G" or "R":</p>
<div class="w3-code notranslate sqlHigh">
 SELECT * FROM Customers<br>
 WHERE Country = 'Spain'
 AND (CustomerName LIKE 'G%' OR CustomerName LIKE 'R%');</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_and_or" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p>Without parenthesis, the SQL above will return all customers from Spain that starts with a "G", <em>plus</em>
all customers that starts with an "R", regardless of the country value:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
 SELECT * FROM Customers<br>
 WHERE Country = 'Spain'
 AND CustomerName LIKE 'G%' OR CustomerName LIKE 'R%';</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_and_or2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_and.js"></div>
<hr>
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: SQL AND Operator</h2>
  <a href="https://youtu.be/r1V39Iia4j0&list=PLP9IO4UYNF0UQkBXlTMSw0CYsxv-GDkkI" class="ga-featured ga-youtube" target="blank_" > 
    <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
      ...
      <picture id="yt_div">
        <source srcset="images/img_sql_and.webp" type="image/webp" />
        <img src="images/img_sql_and.png" style="max-width:100%;height:auto;border-radius:6px" alt="SQL Tutorial on YouTube" loading="lazy">
      </picture>
    </div>
  </a>
</div>
