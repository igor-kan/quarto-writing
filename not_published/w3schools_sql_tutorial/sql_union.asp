...
<div class="w3-clear nextprev">
  ...
  <a class="w3-right w3-btn" href="sql_union_all.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
...
statements.</p>
<p>The <code class="w3-codespan">UNION</code> operator automatically <strong>removes 
duplicate rows</strong> from the result set.</p>
<p>Requirements for <code class="w3-codespan">UNION</code>:</p>
<ul>
...
<p>The following SQL returns the unique (distinct) countries from both the "Customers" and the "Suppliers" table:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
 SELECT Country FROM Customers<br>UNION<br>SELECT Country FROM Suppliers<br>ORDER BY Country;
</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_union" class="w3-btn w3-margin-bottom">
 Try it Yourself &raquo;</a>
</div>
<p><b>Note:</b> If some customers or suppliers have the same country, each country will only be
listed once, because <code class="w3-codespan">UNION</code> selects only distinct values. Use
<code class="w3-codespan"><a href="sql_union_all.asp">UNION ALL</a></code> to also select duplicate values!</p>
<!--stop-->
<hr>
<!--start-->
<h2>SQL UNION With WHERE</h2>
<p>Here we add a <code class="w3-codespan">WHERE</code> clause to only return the unique German cities from both the "Customers" and the "Suppliers" table:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
...
<p>The following SQL lists all customers and suppliers:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
...
<p>Notice the "AS Type" above - it is an alias. <a href="sql_alias.asp">Aliases</a> are used to give a column a temporary name.
So, here we have created a temporary column named "Type", that list whether the contact person is
a "Customer" or a "Supplier".</p>
<!--stop-->
<hr>
