...
<p>The <code class="w3-codespan">HAVING</code> clause is used to filter the results of a <code class="w3-codespan">GROUP BY</code> query based on aggregate functions.</p>
<p>Unlike the <code class="w3-codespan">WHERE</code> clause, which filters individual rows before grouping, 
the <code class="w3-codespan">HAVING</code>
clause
filters groups <strong>after</strong> the aggregation has been performed.</p>

<h3>HAVING Syntax</h3>
<div class="w3-example">
<div class="w3-code notranslate sqlHigh">
SELECT <em>column1, aggregate_function(column2), column3, ...</em><br>
FROM <em>table_name</em><br>
WHERE <em>condition</em><br>
GROUP BY <em>column1</em>, <em>column3</em><br>
HAVING <em>condition</em> -- The condition on grouped data<br>
ORDER BY <em>column_name</em>;
</div></div>
<!--stop-->
<hr>
<h2>Demo Database</h2>
...
<p>The following SQL returns the number of customers in each country - but only include countries with more than 5 customers:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
SELECT Country, COUNT(CustomerID) AS [Number of Customers]<br>
FROM Customers<br>
GROUP BY Country<br>
HAVING COUNT(CustomerID) &gt; 5;
</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_having" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p>The following SQL returns the number of customers in each country, sorted from high to low (and only include countries with more than 5 customers):</p><div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
SELECT Country, COUNT(CustomerID) AS [Number of Customers]<br>
FROM Customers<br>
...
<a target="_blank" href="trysql.asp?filename=trysql_select_having_orderby" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<p>The following SQL returns the employees that have registered more 
than 10 orders:</p>
...
<p>The following SQL returns if the employees "Davolio" or "Fuller" have registered 
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_having.js"></div>
<hr>
