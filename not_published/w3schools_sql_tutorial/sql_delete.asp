...
<p>The following SQL deletes the customer "Alfreds Futterkiste" from 
...
<p>It is possible to delete all records in a table, without deleting the table. 
...
<p>The following SQL deletes ALL records in the &quot;Customers&quot; table, without deleting the table:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
DELETE FROM Customers;
...
<p>To delete the table completely, use the <code class="w3-codespan">DROP TABLE</code> statement:</p>
<h3>Syntax</h3>
<div class="w3-example ws-light-grey">
<p><code class="sqlHigh">
...
<p>The following SQL drops the entire &quot;Customers&quot; table:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Delete entire "Customers" table:</p>
<div class="w3-code notranslate sqlHigh">
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_delete.js"></div>
<hr>
