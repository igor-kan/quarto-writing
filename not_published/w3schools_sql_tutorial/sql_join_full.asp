...
<h1>SQL <span class="color_h1">FULL JOIN</span></h1>
...
<!--start-->
<h2>SQL FULL JOIN</h2>
<p>The <code class="w3-codespan">FULL JOIN</code> returns <b>all rows</b> when there is a match in either the left or right table.</p>
<p>If a row in the left table has no match in the right table, the result set includes the left row's data and NULL values for all columns of the right table.</p>
<p>If a row in the right table has no match in the left table, the result set includes the right row's data and NULL values for all columns of the left table.</p>
<p>The <code class="w3-codespan">FULL JOIN</code> and <code class="w3-codespan">FULL OUTER JOIN</code> keywords are equal - the <code class="w3-codespan">OUTER</code> keyword is optional.</p>
<p style="text-align:center;"><img class="invert-on-dark" alt="SQL FULL OUTER JOIN" height="158" src="img_full_outer_join.png"></p>
<p><strong>Note:</strong> <code class="w3-codespan">FULL JOIN</code> can potentially return very large result-sets!</p>

<h3>FULL JOIN Syntax</h3>
<div class="w3-example">
<div class="w3-code notranslate sqlHigh">
SELECT <em>column_name(s)</em><br>
FROM <em>table1</em><br>
FULL JOIN <em>table2</em><br>
ON <em>table1.column_name</em> = <em>table2.column_name</em><br>
...
<a target="_blank" href="trysql.asp?filename=trysql_select_join_full" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p><strong>Note:</strong> <code class="w3-codespan">FULL JOIN</code> returns all matching
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_join_full.js"></div>
<hr>
