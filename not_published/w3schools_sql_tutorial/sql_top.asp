...
<html lang="en-US">
<head>
<title>SQL SELECT TOP, LIMIT and FETCH FIRST</title>
<meta charset="utf-8">
...
<h1>SQL <span class="color_h1">SELECT TOP, LIMIT and FETCH FIRST</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="sql_delete.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="sql_aggregate_functions.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>The SQL SELECT TOP Clause</h2>
<p>The <code class="w3-codespan">SELECT TOP</code> clause is used to limit the number of records to return.</p>
...
<p>The following SQL selects only the first 3 records of the "Customers" table:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Select only the first 3 records of the Customers table:</p>
...
FROM <em>table_name<br></em>WHERE <em>condition</em>;</code></p>
</div>
...
LIMIT <em>number</em>;</code></p>
</div>

<h3>Syntax for Oracle 12+</h3>
<div class="w3-example ws-light-grey">
<p><code class="sqlHigh">
SELECT <em>column_name(s)</em><br>
FROM <em>table_name<br></em>ORDER BY <em>
  column_name(s)</em><br>
  FETCH FIRST <em>number</em> ROWS ONLY;</code></p>
</div>
<hr>
...
<hr>
<!--start-->
<h2>MySQL - The LIMIT Clause</h2>

<p>The following SQL shows the equivalent example for MySQL:</p>
<div class="w3-example">
<h3>Example</h3>
...
<hr>
<!--start-->
<h2>Oracle - The FETCH FIRST Clause</h2>
<p>The following SQL shows the equivalent example for 
Oracle:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Select the first 3 records of the Customers table:</p>
<div class="w3-code notranslate sqlHigh">
SELECT * FROM Customers<br>FETCH FIRST 3 ROWS ONLY;</div>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>SQL TOP PERCENT Example</h2>
<p>Here we will use the <code class="w3-codespan">SELECT TOP</code> clause with the percent syntax.</p>
<p>The following SQL selects the first 50% of the records from the "Customers" table (for SQL Server/MS Access):</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
 SELECT TOP 50 PERCENT * FROM Customers;
</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_top_percent" class="w3-btn w3-margin-bottom">
 Try it Yourself &raquo;</a>
</div>
<p>The following SQL shows the equivalent example for 
Oracle:</p>
...
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
SELECT * FROM Customers<br>FETCH FIRST 50 PERCENT ROWS ONLY;
</div>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>SELECT TOP with WHERE</h2>
<p>The following SQL selects the first three records from the "Customers" table, 
where Country is "Germany" (for SQL Server/MS Access):</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
SELECT TOP 3 * FROM Customers<br>WHERE Country = 'Germany';
</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_top_where" class="w3-btn w3-margin-bottom">
 Try it Yourself &raquo;</a>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
SELECT * FROM Customers<br>WHERE Country = 'Germany'<br>FETCH FIRST 3 ROWS ONLY;
</div>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>SELECT TOP and ORDER BY</h2>

<p>Add the <code class="w3-codespan">ORDER BY</code> keyword when you want to sort the result, and return the first 3 records of the sorted result.</p>

<p>For SQL Server and MS Access:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Sort the result reverse alphabetically by CustomerName, and return the first 3 records:</p>
<div class="w3-code notranslate sqlHigh">
SELECT TOP 3 * FROM Customers<br>ORDER BY CustomerName DESC;
</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_top_orderby" class="w3-btn w3-margin-bottom">
 Try it Yourself &raquo;</a>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
 SELECT * FROM Customers<br>ORDER BY CustomerName DESC<br>LIMIT 3;</div>
<a target="_blank" href="trymysql.asp?filename=trysql_select_limit_orderby" class="w3-btn w3-margin-bottom">
 Try it Yourself &raquo;</a>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
SELECT * FROM Customers<br>ORDER BY CustomerName DESC<br>FETCH FIRST 3 ROWS ONLY;
</div>
</div>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_top.js"></div>
<hr>
