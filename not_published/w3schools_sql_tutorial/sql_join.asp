...
<hr>
<!--start-->
<h2>The SQL JOIN Clause</h2>
<p>The <code class="w3-codespan">JOIN</code> clause is used to combine rows from two or more tables, based on a related column between them.</p>
<p>Here are the different types of JOINs in SQL:</p>
  <ul>
    <li><code class="w3-codespan">(INNER) JOIN</code>: Returns only rows that have <b>matching values</b> in both tables</li>
    <li><code class="w3-codespan">LEFT (OUTER) JOIN</code>: Returns <b>all rows from the left table</b>, and only the matched rows from the right table</li>
    <li><code class="w3-codespan">RIGHT (OUTER) JOIN</code>: Returns <b>all rows from the right table</b>, and only the matched rows from the left table</li>
    <li><code class="w3-codespan">FULL (OUTER) JOIN</code>: Returns <b>all rows</b> when there is a match in either the left or right table</li>
  </ul>
<p>Look at an order in "Orders" table:</p>
...
<p>Then, look at a customer in the "Customers" table:</p>
<div class="w3-responsive">
<table class="ws-table-all notranslate">
  <tr>
...
<p>Here we see that the "CustomerID" column in the "Orders" table refers to the
...
<hr>
<div id="exercisecontainer" src="xrcise_join.js"></div>
<hr>
