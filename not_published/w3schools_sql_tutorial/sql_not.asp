...
<h1>SQL <span class="color_h1">NOT</span> Operator</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="sql_or.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="sql_insert.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>The NOT Operator</h2>
<p>The <code class="w3-codespan">NOT</code> operator is used in the <code class="w3-codespan">WHERE</code> 
clause to return all records that DO NOT match the specified criteria. It reverses the result of a condition from true to false and vice-versa. </p>
<p>The following SQL selects all customers that are NOT 
from Spain:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Select only the customers that are NOT from Spain:</p>
<div class="w3-code notranslate sqlHigh">
 SELECT * FROM Customers<br>
 WHERE NOT Country = 'Spain';
</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_not" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p>In the example above, the <code class="w3-codespan">NOT</code> operator is used in combination with the
<code class="w3-codespan">=</code> operator.</p>
<p>The <code class="w3-codespan">NOT</code> operator is also used in combination with other operators to exclude data, such as:</p>
<ul>
  <li> <code class="w3-codespan">NOT LIKE</code></li>
  <li> <code class="w3-codespan">NOT BETWEEN</code></li>
  <li> <code class="w3-codespan">NOT IN</code></li>
  <li> <code class="w3-codespan">IS NOT NULL</code></li>
  <li> <code class="w3-codespan">NOT EXISTS</code></li>
</ul>
...
<hr>
<!--start-->
<h2>The NOT LIKE Operator</h2>
<p>The <code class="w3-codespan">NOT LIKE</code> operator is used in the <code class="w3-codespan">WHERE</code> clause to exclude rows that match a specified character pattern.</p>
<p>There are two wildcards often used in conjunction with the <code class="w3-codespan">NOT LIKE</code> operator:</p>
<ul>
  <li>A percent sign <code class="w3-codespan">%</code>  - represents zero, one, or multiple characters</li>
  <li>A underscore sign <code class="w3-codespan">_</code> - represents a single character</li>
</ul>

<p>The following SQL selects all customers that do NOT start with the letter "A":</p>
<div class="w3-example">
<h3>Example</h3>
<p>Select customers that does not start with the letter 'A':</p>
<div class="w3-code notranslate sqlHigh">
 SELECT * FROM Customers<br>
 WHERE CustomerName NOT LIKE 'A%';
</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_not_like" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>The NOT BETWEEN Operator</h2>
<p>The <code class="w3-codespan">NOT BETWEEN</code> operator is used in the <code class="w3-codespan">WHERE</code> clause to select rows where a value falls outside a specified inclusive range.</p>
<p>The <code class="w3-codespan">NOT BETWEEN</code> operator can be used with numeric, text, or date values.</p>
<p>The following SQL selects all customers with a CustomerID NOT between 10 and 
60:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Select customers with a customerID not between 10 and 60:</p>
<div class="w3-code notranslate sqlHigh">
 SELECT * FROM Customers<br>
 WHERE CustomerID NOT BETWEEN 10 AND 60;
</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_not_between2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>The NOT IN Operator</h2>
<p>The <code class="w3-codespan">NOT IN</code> operator is used in the <code class="w3-codespan">WHERE</code>
clause to exclude rows that match any value in a specified list or a subquery result set.</p>
<p>The following SQL selects all customers with City NOT IN "Paris" or "London":</p>
<div class="w3-example">
<h3>Example</h3>
<p>Select customers that are not from Paris or London:</p>
<div class="w3-code notranslate sqlHigh">
 SELECT * FROM Customers<br>
 WHERE City NOT IN ('Paris', 'London');
</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_not_in" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>NOT Greater Than</h2>
<p>The "NOT Greater Than" condition is expressed with the <code class="w3-codespan">NOT</code> 
operator in conjunction with the standard greater than or equal to (&gt;=) operator.</p>
<p>The following SQL selects all customers with a CustomerID not greater than 50:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Select customers with a CustomerId not greater than 50:</p>
<div class="w3-code notranslate sqlHigh">
 SELECT * FROM Customers<br>
 WHERE NOT CustomerID &gt; 50;
</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_not_gt" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>NOT Less Than</h2>
<p>The "NOT Less Than" condition is expressed with the <code class="w3-codespan">NOT</code> 
operator in conjunction with the standard less than or equal to (&lt;=) operator.</p>
<p>The following SQL selects all customers with a CustomerID not less than 50:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Select customers with a CustomerID not less than 50:</p>
<div class="w3-code notranslate sqlHigh">
 SELECT * FROM Customers<br>
 WHERE NOT CustomerId &lt; 50;
</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_not_lt" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_not.js"></div>
<hr>
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: SQL NOT Operator</h2>
  <a href="https://youtu.be/CJRl5kBWlgI&list=PLP9IO4UYNF0UQkBXlTMSw0CYsxv-GDkkI" class="ga-featured ga-youtube" target="blank_" > 
    <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
      ...
      <picture id="yt_div">
        <source srcset="images/img_sql_not.webp" type="image/webp" />
        <img src="images/img_sql_not.png" style="max-width:100%;height:auto;border-radius:6px" alt="SQL Tutorial on YouTube" loading="lazy">
      </picture>
    </div>
  </a>
</div>
