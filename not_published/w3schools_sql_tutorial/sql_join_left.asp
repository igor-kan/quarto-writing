...
<h1>SQL <span class="color_h1">LEFT JOIN</span></h1>
...
<h2>SQL LEFT JOIN</h2>
<p>The <code class="w3-codespan">LEFT JOIN</code> returns <b>all rows from the left table</b> (table1), and only the matched rows from the right table (table2).</p>
<p>If there is no match in the right table, the result for the columns from the right table will be NULL.</p> 
<p>The <code class="w3-codespan">LEFT JOIN</code> and <code class="w3-codespan">LEFT OUTER JOIN</code> keywords are equal - the <code class="w3-codespan">OUTER</code> keyword is optional.</p>
<p style="text-align:center;"><img class="invert-on-dark" alt="SQL LEFT JOIN" src="img_left_join.png"></p>
...
<p>Here we see that the <strong>related column</strong> between the two tables above, is the "CustomerID" column.</p>
<hr>
...
<h2>SQL LEFT JOIN Examples</h2>
<p>The following SQL returns all customers and their orders, including customers who have not placed any orders:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
...
<p><strong>Tip:</strong> To find only the customers who have not placed any order, add a <code class="w3-codespan">WHERE</code> clause to filter for NULL values on the right table:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
SELECT Customers.CustomerName, Orders.OrderID<br>
...
<a target="_blank" href="trysql.asp?filename=trysql_select_join_left2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_join_left.js"></div>
<hr>
