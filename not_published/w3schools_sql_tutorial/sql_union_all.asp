...
<html lang="en-US">
<head>
<title>SQL UNION ALL Operator</title>
<meta charset="utf-8">
...
<h1>SQL <span class="color_h1">UNION ALL</span> Operator</h1>
...
<hr>
<!--start-->
<h2>The SQL UNION ALL Operator</h2>
<p>The <code class="w3-codespan">UNION ALL</code> operator is used to combine the result-set of two or more 
<code class="w3-codespan">SELECT</code> 
statements.</p>
<p>The <code class="w3-codespan">UNION ALL</code> operator includes all rows 
from each statement, <strong>including any duplicates</strong>.</p>
<p>Requirements for <code class="w3-codespan">UNION ALL</code>:&nbsp;</p>
<ul>
  <li>Every <code class="w3-codespan">SELECT</code> statement within
  <code class="w3-codespan">UNION ALL</code> must have the same number of columns</li>
  <li>The columns must also have similar data types</li>
  <li>The columns in every <code class="w3-codespan">SELECT</code> statement must also be in the same order</li>
</ul>
...
<p>The following SQL returns all the countries (also duplicate values) from both the "Customers" and the "Suppliers" table:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
 SELECT Country FROM Customers<br>UNION ALL<br>SELECT Country FROM Suppliers<br>
 ORDER BY Country;
</div>
...
<p>Here we add a <code class="w3-codespan">WHERE</code> clause to return all the German cities from both the "Customers"
and the "Suppliers" table:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_union.js"></div>
<hr>
