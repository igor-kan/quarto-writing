...
<p>Here, <em>column1, column2, ...</em> are the <strong>column names</strong> in the table you want to select data from.</p>
<p>The <em>table_name</em> represents the <strong>name of the table</strong> you want to select data from.</p>
<!--stop-->
<hr>
<!--start-->
<h2>Demo Database</h2>
...
<p>To select ALL columns, without specifying every column name, use the
<code class="w3-codespan">SELECT *</code> syntax:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Select ALL columns from the "Customers" table:</p>
<div class="w3-code notranslate sqlHigh">
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_select.js"></div>
<hr>
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: SQL SELECT Statement</h2>
  <a href="https://youtu.be/af4LckivJT8&list=PLP9IO4UYNF0UQkBXlTMSw0CYsxv-GDkkI" class="ga-featured ga-youtube" target="blank_" > 
    <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
      ...
      <picture id="yt_div">
        <source srcset="images/img_sql_select.webp" type="image/webp" />
        <img src="images/img_sql_select.png" style="max-width:100%;height:auto;border-radius:6px" alt="SQL Tutorial on YouTube" loading="lazy">
      </picture>
    </div>
  </a>
</div>
