...
<p>The following SQL uses multiple <code class="w3-codespan">OR</code> conditions to select all customers from 
Germany, France, or UK (same result, but longer code):</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
SELECT * FROM Customers<br>
...
<p>By using the <code class="w3-codespan">NOT IN</code> operator,
you return all records that are NOT any of the values in the list.</p>
...
<a target="_blank" href="trysql.asp?filename=trysql_select_not_in2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>IN (SELECT)</h2>
<p>You can also use <code class="w3-codespan">IN</code> with a subquery in the <code class="w3-codespan">WHERE</code> clause.</p>
<p>With a subquery you can return all records from the main query that are present in the result of the subquery.</p>
<p>The following SQL returns all customers who also have an order in the "Orders" table:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
SELECT * FROM Customers<br>
...
<h2>NOT IN (SELECT)</h2>
<p>The result in the example above returned 74 records,
that means that there are 17 customers that haven't placed any orders.</p>
<p>Let us check if that is correct, by using the <code class="w3-codespan">NOT IN</code> operator.</p>
<p>The following SQL returns all customers who do NOT have any orders in the "Orders" table:</p>
...
<hr>
<div id="exercisecontainer" src="xrcise_in.js"></div>
<hr>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="sql_wildcards.asp">&#10094; Previous</a>
