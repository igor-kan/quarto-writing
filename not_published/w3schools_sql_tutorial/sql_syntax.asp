...
<p>SQL statements consist of keywords that are easy to understand.</p>
<p>The following SQL statement selects all records from the table named "Customers":</p>
<div class="w3-example">
<h3>Example</h3>
<p>Select all records from the Customers table:</p>
