...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="sql_union_all.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="sql_having.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>The SQL GROUP BY Statement</h2>
<p>The <code class="w3-codespan">GROUP BY</code> statement is used to group rows that have the same values into summary rows, like "Find the number of customers in each country".</p>
<p>The <code class="w3-codespan">GROUP BY</code> statement is almost always used in conjunction with aggregate functions, like <code class="w3-codespan">COUNT()</code>,
<code class="w3-codespan">MAX()</code>, <code class="w3-codespan">MIN()</code>, <code class="w3-codespan">SUM()</code>, <code class="w3-codespan">AVG()</code>,
to perform calculations on each group.</p>
...
<p>The following SQL returns the number of customers in each country:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
  SELECT Country, COUNT(CustomerID) AS [Number of Customers]<br>FROM Customers<br>GROUP BY Country;
</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_groupby" class="w3-btn w3-margin-bottom">
  Try it Yourself »</a>
</div>
<p>The following SQL returns the number of customers in each country, sorted from high to low:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
...
<p>The following SQL returns the number of orders sent by each shipper:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
  SELECT Shippers.ShipperName, COUNT(Orders.OrderID) AS NumberOfOrders<br>FROM 
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_groupby.js"></div>
<hr>
