...
(unique) values.</p>
<p>In a table, a column may contain several duplicate values - and sometimes you 
want to list only the unique values.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Select all the distinct (unique) countries from the "Customers" table:</p>
...
<p>If you omit the <code class="w3-codespan">DISTINCT</code> keyword, the SQL statement 
returns the "Country" value from all the records of the "Customers" table:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
...
<p>By using the  
<code class="w3-codespan">COUNT()</code> function with the
<code class="w3-codespan">DISTINCT</code> keyword, we can count the number of 
unique countries.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
...
<p><strong>Note:</strong> The COUNT(DISTINCT <em>column_name</em>) is not supported in Microsoft Access databases.</p>
</div>
...
<code class="w3-codespan">COUNT()</code> function later in this tutorial.</p>
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_distinct.js"></div>
<hr>
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: SQL SELECT DISTINCT Statement</h2>
  <a href="https://youtu.be/yuYKEx6VDPE&list=PLP9IO4UYNF0UQkBXlTMSw0CYsxv-GDkkI" class="ga-featured ga-youtube" target="blank_" > 
    <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
      ...
      <picture id="yt_div">
        <source srcset="images/img_sql_select_distinct.webp" type="image/webp" />
        <img src="images/img_sql_select_distinct.png" style="max-width:100%;height:auto;border-radius:6px" alt="SQL Tutorial on YouTube" loading="lazy">
      </picture>
    </div>
  </a>
</div>
