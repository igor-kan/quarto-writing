...
<h1>SQL <span class="color_h1">OR</span> Operator</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="sql_and.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="sql_not.asp">Next &#10095;</a>
</div>
<hr>
<!--start-->
<h2>The SQL OR Operator</h2>
<p>The <code class="w3-codespan">WHERE</code> clause can contain one or more <code class="w3-codespan">OR</code> operators.</p>
<p>The <code class="w3-codespan">OR</code> operator is used to filter records based on more than one condition.</p>

<div class="w3-panel ws-note">
<p><strong>Note: </strong>The <code class="w3-codespan">OR</code> operator displays a record if <strong>any</strong> of the conditions are TRUE.</p>
</div>

<p>The following SQL selects all customers from Germany OR Spain:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Select all customers where Country is "Germany" OR "Spain":</p>
<div class="w3-code notranslate sqlHigh">
 SELECT *<br>
 FROM Customers<br>
 WHERE Country = 'Germany' OR Country = 'Spain';
</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_or" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<hr>
<!--start-->
<h2>At Least One Condition Must Be True</h2>

<p>The following SQL selects all customers where City is "Berlin", 
OR CustomerName starts with the letter "G", OR Country is "Norway":</p>
...
<a target="_blank" href="trysql.asp?filename=trysql_select_where_or_or" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<h2>AND vs. OR</h2>
<div class="w3-panel ws-note">
<p>The <code class="w3-codespan">AND</code> operator displays a record if <strong>all</strong> the conditions are TRUE.</p>
...
<p>The following SQL selects all customers from Spain that starts with a "G" or an 
"R" 
...
<p>Without parenthesis, the SQL above will return all customers from Spain that starts with a 
"G", <em>plus</em>
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_or.js"></div>
<hr>
