...
<p>The <code class="w3-codespan">WHERE</code> clause is used to extract only those records that fulfill a specific 
condition.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Here we select all customers from <strong>Mexico</strong>:</p>
...
<p>You can use other operators than the <code class="w3-codespan">
=</code> operator to filter the search.</p>
...
<div class="w3-code notranslate sqlHigh">
 SELECT * FROM Customers<br>
 WHERE CustomerID > 80;</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_where_gt" class="w3-btn w3-margin-bottom">
 Try it Yourself &raquo;</a>
</div>
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_where.js"></div>
<hr>
<div class="w3-padding w3-round" style="background-color:#282b35;color:white;margin-bottom:10px;">
  <h2 style="max-width:720px;position:relative;margin:auto;text-decoration: none;text-align:center">Video: SQL WHERE Clause</h2>
  <a href="https://youtu.be/L9GBpVXq-zc&list=PLP9IO4UYNF0UQkBXlTMSw0CYsxv-GDkkI" class="ga-featured ga-youtube" target="blank_" > 
    <div id="yt_container" style="max-width:720px;position:relative;margin:auto;">
      ...
      <picture id="yt_div">
        <source srcset="images/img_sql_where.webp" type="image/webp" />
        <img src="images/img_sql_where.png" style="max-width:100%;height:auto;border-radius:6px" alt="SQL Tutorial on YouTube" loading="lazy">
      </picture>
    </div>
  </a>
</div>
