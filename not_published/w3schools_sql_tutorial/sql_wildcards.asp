...
<h3>Example</h3>
<p>Return all customers that starts with the letter 'a':</p>

<div class="w3-code notranslate sqlHigh">
 SELECT * FROM Customers<br>
 WHERE CustomerName LIKE 'a%'; </div>
  <a class="w3-btn w3-margin-bottom" href="trysql.asp?filename=trysql_select_wildcard_a" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<table class="ws-table-all notranslate wildcards">
  <tr>
    <th>Symbol</th>
    <th>Description</th>
  </tr>
...
<p>* Not supported in PostgreSQL and MySQL databases.</p>
<p>** Supported only in Oracle databases.</p>
<!--stop-->
<hr>
<h2>Demo Database</h2>
...
<div class="w3-example">
<h3>Example</h3>
<p>Return all customers that ends with the pattern 'es':</p>
<div class="w3-code notranslate sqlHigh">
 SELECT * FROM Customers<br>
 WHERE CustomerName LIKE '%es';
</div>
  <a class="w3-btn w3-margin-bottom" href="trysql.asp?filename=trysql_select_wildcard_endswith" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Return all customers that <em>contains</em> the pattern 'mer':</p>
<div class="w3-code notranslate sqlHigh">
 SELECT * FROM Customers<br>
 WHERE CustomerName LIKE '%mer%';
</div>
  <a class="w3-btn w3-margin-bottom" href="trysql.asp?filename=trysql_select_wildcard_contains" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
...
<p>The <code class="w3-codespan">_</code> wildcard represents a single character.</p>

<p>It can be any character or number, but each <code class="w3-codespan">_</code> represents one, and only one, character.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Return all customers with a <code class="w3-codespan">City</code> starting with any character, followed by "ondon":</p>
<div class="w3-code notranslate sqlHigh">
 SELECT * FROM Customers<br>
...
<div class="w3-example">
<h3>Example</h3>
<p>Return all customers with a <code class="w3-codespan">City</code> starting with "L", followed by any 
3 characters, ending with "on":</p>
<div class="w3-code notranslate sqlHigh">
 SELECT * FROM Customers<br>
 WHERE City LIKE 'L___on';
</div>
  <a class="w3-btn w3-margin-bottom" href="trysql.asp?filename=trysql_select_wildcard_3_underscores" target="_blank">Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Using the [] Wildcard</h2>
<p>The <code class="w3-codespan">[]</code> wildcard returns a result if <em>any</em>
of the characters inside gets a match.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Return all customers starting with either "b", "s", or "p":</p>
<div class="w3-code notranslate sqlHigh">
 SELECT * FROM Customers<br>
 WHERE CustomerName LIKE '[bsp]%';
</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_wildcard_charlist" class="w3-btn w3-margin-bottom">
 Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
<!--start-->
<h2>Using the - Wildcard</h2>
<p>The <code class="w3-codespan">-</code> wildcard allows you to specify a range 
of characters inside the <code class="w3-codespan">[]</code> wildcard.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Return all customers starting with 
"a", "b", "c", "d", "e" or "f":</p>
...
<a target="_blank" href="trysql.asp?filename=trysql_select_wildcard_charlist2" class="w3-btn w3-margin-bottom">
 Try it Yourself &raquo;</a>
</div>
<!--stop-->
<hr>
...
<hr>
<!--start-->
<h2>Microsoft Access Wildcards</h2>

<p>The Microsoft Access Database has some other wildcards:</p>
<table class="ws-table-all notranslate">
  <tr>
    <th>Symbol</th>
    <th>Description</th>
...
<!--stop-->
<hr>
<div id="exercisecontainer" src="xrcise_wildcards.js"></div>
<hr>
