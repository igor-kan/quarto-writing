...
<h2>SQL Aliases</h2>
<p>An alias is created with the <code class="w3-codespan">AS</code> keyword, and 
is often used to make a column name more readable.</p>
<p>An alias only exists for the duration of that query.</p>
<hr>
<h2>Alias for Columns</h2>
<p>The following SQL creates two aliases, one for the CustomerID 
...
<h2>Aliases with Spaces</h2>
<p>If you want your alias to contain one or more spaces, like "My Great Products",
surround the aliasname with square brackets or double quotes:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Using [square brackets] for aliases with space characters:</p>
<div class="w3-code notranslate sqlHigh">
 SELECT ProductName AS [My Great Products]<br>
 FROM Products;</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_alias_brackets" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>OR:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Using "double quotes" for aliases with space characters:</p>
<div class="w3-code notranslate sqlHigh">
 SELECT ProductName AS "My Great Products"<br>
 FROM Products;</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_alias_quotes" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel ws-note">
<p><b>Note:</b> Some database systems allows both [] and "", and some only allows one of them.</p>
</div>
<hr>

<h2>Concatenate Columns</h2>
<p>The following SQL creates an alias named "Address" that combine four columns (Address, PostalCode, 
City and Country):</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
...
FROM Customers;</div>
<a target="_blank" href="trymysql.asp?filename=trysql_select_alias_mysql_concat" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate sqlHigh">
  ...
  Country) AS Address<br>FROM Customers;</div></div>
<hr>

<h2>Alias for Tables</h2>
<p>The same rules applies when you want to use an alias for a table.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Refer to the Customers table as Persons instead:</p>
<div class="w3-code notranslate sqlHigh">
 SELECT * FROM Customers AS Persons;
</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_alias_table_persons" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p>It might seem useless to use aliases on tables, but when you are joining tables,
it makes sense.</p>
<p>In the following example, c is the alias for customers and o is for orders, making the query shorter and easier to read:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
SELECT c.CustomerName, o.OrderID<br>
...
<p>You will learn more about <a href="sql_join.asp">SQL Joins</a> in the next chapters.</p>

<p>Aliases are useful when:</p>
<ul>
  <li>There are more than one table involved in a query</li>
  <li>Functions are used in the query</li>
  <li>Column names are long or not very readable</li>
  <li>Two or more columns are combined together</li>
</ul>
<hr>
<div id="exercisecontainer" src="xrcise_alias.js"></div>
<hr>
