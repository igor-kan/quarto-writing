...
<p>If a field in a table is optional, it is possible to insert or update a record without adding any value to this field.
This way, the field will be saved with a <code class="w3-codespan">NULL</code> value.</p>
<p>A <code class="w3-codespan">NULL</code> value represents an unknown, missing, or inapplicable data in a database field. It is not a value itself, but a placeholder to indicate the absence of data.</p>
<div class="w3-panel ws-note">
<p><b>Note:</b> A <code class="w3-codespan">NULL</code> value is different from zero (0) or an empty string (''). A field with a <code class="w3-codespan">NULL</code>
value is one that has been left blank upon record creation.</p>
</div>
<!--stop-->
<hr>
<!--start-->
...
<div class="w3-panel ws-note">
  <p><b>Tip:</b> Always use <code class="w3-codespan">IS NULL</code> to look for NULL values.</p>
</div>
<!--stop-->
<hr>
<!--start-->
