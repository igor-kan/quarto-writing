...
<html lang="en-US">
<head>
<title>React ES6 Destructuring</title>
<meta charset="utf-8">
...
<h1>React ES6 <span class="color_h1">Destructuring</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="react_es6_array_map.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="react_es6_spread.asp">Next &#10095;</a>
</div>

<hr>
<h2>Destructuring in React</h2>
<p>Destructuring is a JavaScript feature that allows you to extract values from objects or arrays into distinct variables. In React, it's commonly used with props, hooks, and state management.</p>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> Destructuring makes React code cleaner and more readable by reducing repetitive object and array access.</p>
</div>
...
<h3>Example</h3>
<p>Before:</p>
<pre class="language-jsx w3-white"><code>const vehicles = ['mustang', 'f-150', 'expedition'];
...
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryreact_es6_destructuring_oldway">Try it Yourself &raquo;</a>
</p>
</div>
...
//You can now access each variable separately:
document.getElementById('demo').innerHTML = truck;</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryreact_es6_destructuring_newway">Try it Yourself &raquo;</a>
</p>  
</div>

<div class="w3-panel ws-note">
<p>When destructuring <em>arrays</em>, the order that variables are declared is important.</p>
</div>
...
const [car,, suv] = vehicles;</code></pre>
</div>
...
<div class="w3-example">
<h3>Example</h3>
<pre class="language-jsx w3-white"><code>function dateInfo(dat) {
  const d = dat.getDate();
...
const [date, month, year] = dateInfo(new Date());</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryreact_es6_destructuring_array">Try it Yourself &raquo;</a>
</p>
</div>
<hr>
...
<p>You can use destructuring to extract the values from an object:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Unpack the values from an object:</p>
<pre class="language-jsx w3-white"><code>const person = {
  firstName: "John",
  lastName: "Doe",
  age: 50
};
...
//You can now access each variable separately:
document.getElementById("demo").innerHTML = firstName;</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryreact_es6_destructuring_object1">Try it Yourself &raquo;</a>
</p>
</div>

<p>For <em>objects</em>, the <em>order</em> of the properties does not matter:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Unpack the values in a random order:</p>
<pre class="language-jsx w3-white"><code>const person = {
  firstName: "John",
  lastName: "Doe",
  age: 50
...
// Destructuring
let {lastName, age, firstName} = person;</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryreact_es6_destructuring_object1_2">Try it Yourself &raquo;</a>
</p>
</div>

<p>You can extract only the value(s) you want:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Extract only firstName from the object:</p>
<pre class="language-jsx w3-white"><code>const person = {
  firstName: "John",
  lastName: "Doe",
  age: 50
...
// Destructuring
let {firstName} = person;</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryreact_es6_destructuring_object2">Try it Yourself &raquo;</a>
</p>
</div>

<p>For potentially missing properties we can set default values:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Set a default value for the missing property:</p>
<pre class="language-jsx w3-white"><code>const person = {
  firstName: "John",
  lastName: "Doe",
  age: 50
...
// Destructuring
let {firstName, lastName, age, country = "Norway"} = person;</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryreact_es6_destructuring_object3">Try it Yourself &raquo;</a>
</p>
</div>


<p>We can also destructure deeply nested objects by referencing the nested object then using a colon and curly braces to again destructure the items needed from the nested object:</p>
...
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryreact_es6_destructuring_object4">Try it Yourself &raquo;</a>
</p>
</div>

<p>Read more about <a href="/js/js_destructuring.asp">Destructuring in our JavaScript Tutorial</a>.</p>
<hr>

<h2>Destructuring in React Components</h2>

<p>Destructuring is particularly useful in React for working with props, hooks, and API responses. It helps make your code more concise and easier to read.</p>

<hr>

<h2>Props Destructuring</h2>

<p>When a component receives props, you can use destructuring to extract the values you need.</p>

<p>Check out the difference between using and not using destructuring:</p>

<div class="w3-example">
<pre class="language-jsx w3-white"><code>//Using destructuring:
...
<div class="w3-example">
<pre class="language-jsx w3-white"><code>//NOT using destructuring:
function Greeting(props) {
  return &lt;h1&gt;Hello, {props.name}! You are {props.age} years old.&lt;/h1&gt;;
}</code></pre>
</div>

<p>Let's see a working example:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Using destructuring to extract props:</p>
...
<p>
<a class="w3-btn" href="showreact.asp?filename=demo_react_destructuring1" target="_blank">Try it Yourself &raquo;</a>
</p>
</div>

<hr>

<h2>useState Hook Destructuring</h2>

<p>When a component uses the <em>useState</em> hook, we use destructuring to extract the values from it.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Using destructuring to extract values from useState:</p>
<pre class="language-jsx w3-white"><code>import { createRoot, useState } from 'react-dom/client'
...
<p><a class="w3-btn" href="showreact.asp?filename=demo_react_destructuring2" target="_blank">Try it Yourself &raquo;</a></p>
</div>


<hr>
<div id="exercisecontainer" src="xrcise_es6_destructuring.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="react_es6_array_map.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="react_es6_spread.asp">Next &#10095;</a>
