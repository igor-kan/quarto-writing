...
<a class="w3-left w3-btn" href="react_forms_checkbox.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="react_portals.asp">Next &#10095;</a>
</div>
...
<p>Radio buttons are typically used in groups where only one option can be selected.</p>

<p>All radio buttons in a group should share the same name attribute.</p>

<p>You control radio buttons based on whether the radio button's value matches the selected value in your state.</p>

<div class="w3-example">
<h3>Example:</h3>
<p>React uses the <code class="w3-codespan">checked</code> attribute to control the radio button:</p>
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_forms_radio">Run 
Example &raquo;</a>
</p>
</div>
...
<hr>
<div id="exercisecontainer" src="xrcise_forms_radio.js"></div>
<hr>
