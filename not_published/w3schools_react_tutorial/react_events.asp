...
<a class="w3-left w3-btn" href="react_props_children.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="react_conditional_rendering.asp">Next &#10095;</a>
</div>

<hr>

<p class="intro">Just like HTML DOM events, React can perform actions based on user events.</p>
<p class="intro">React has the same events as HTML: click, change, mouseover etc.</p>

<hr>

<h2>Adding Events</h2>
<p>React events are written in camelCase syntax:</p>
<p><code class="w3-codespan">onClick</code>
instead of <code class="w3-codespan">onclick</code>.</p>
<p>React event handlers are written inside curly 
braces:</p>
<p><code class="w3-codespan">onClick={shoot}</code>&nbsp; instead of
<code class="w3-codespan">onclick=&quot;shoot()&quot;</code>. </p>

<div class="w3-example">
<h3>React:</h3>
<pre class="language-jsx w3-white"><code>&lt;button onClick={shoot}&gt;Take the Shot!&lt;/button&gt;
</code></pre>
</div>

<div class="w3-example">
<h3>HTML:</h3>
<pre class="language-html w3-white"><code>&lt;button onclick=&quot;shoot()&quot;&gt;Take the Shot!&lt;/button&gt;
</code></pre>
<br>
</div>
...
<div class="w3-example">
<h3>Example:</h3>
  <p>Put the <code class="w3-codespan">shoot</code> function inside the
  <code class="w3-codespan">Football</code> component:</p>
<pre class="language-jsx w3-white"><code>function Football() {
  const shoot = () =&gt; {
    alert(&quot;Great Shot!&quot;);
  }
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_events">Run 
Example &raquo;</a>
</p>
</div>
...
<div class="w3-example">
  <h3>Example:</h3>
  <p>Send &quot;Goal!&quot; as a parameter to the <code class="w3-codespan">shoot</code> 
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_events2">Run 
Example &raquo;</a>
</p>
</div>
...
<div class="w3-example">
<h3>Example:</h3>
  <p>Arrow Function: Sending the event object manually:</p>
<pre class="language-jsx w3-white" data-line="11"><code>function Football() {
  const shoot = (a, b) =&gt; {
    alert(b.type);
    /*
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_events3">Run 
Example &raquo;</a>
</p>

</div>
<p>This will come in handy when we look at <a href="react_forms.asp">Form</a> in 
a later chapter.</p>
<hr>

<div id="exercisecontainer" src="xrcise_events.js"></div>
<hr>
