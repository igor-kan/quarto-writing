...
<a class="w3-left w3-btn" href="react_router.asp">❮ Previous</a>
<a class="w3-right w3-btn" href="react_forward_ref.asp">Next ❯</a>
</div>

<hr>

<h2>What is useTransition?</h2>
<p>The <code class="w3-codespan">useTransition</code> hook helps you keep your React app responsive during heavy updates.</p>

<p>It lets you mark some state updates as "non-urgent", allowing other, more urgent updates to happen first.</p>

<hr>

<h2>When to Use Transitions?</h2>
<p>Use transitions when you have:</p>
<ul>
  <li>A slow operation that might freeze the UI</li>
  <li>Updates that aren't immediately critical</li>
  <li>Search results that take time to display</li>
</ul>

<hr>

<h2>Basic Example</h2>
<p>Here's a simple example showing how to use transitions in a search feature:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-jsx w3-white"><code>import { useState, useTransition } from 'react';
...
<p>
  <a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_transitions">Run Example &raquo;</a>
</p>
</div>

<p>In this example:</p>
<ul>
  <li>The input field updates immediately (urgent update)</li>
  <li>The search results update is marked as a transition (non-urgent)</li>
  <li>The loading message shows while the transition is pending</li>
</ul>
...
<p>Here's a more practical example with a slow search feature:</p>
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_transitions2">Run Example &raquo;</a>
</p>
</div>

<p>How this example works:</p>
<ol>
  <li>When you type in the input field, it updates immediately</li>
  <li>The search results update is wrapped in <code class="w3-codespan">startTransition</code></li>
  <li>While the results are updating, <code class="w3-codespan">isPending</code> is true</li>
  <li>The UI stays responsive even with many results</li>
</ol>

<hr>

<h2>useTransition Hook</h2>
<p>The <code class="w3-codespan">useTransition</code> hook returns two items:</p>
<ul>
  <li><code class="w3-codespan">isPending</code>: tells you if a transition is active</li>
  <li><code class="w3-codespan">startTransition</code>: function to mark updates as transitions</li>
</ul>

<hr>

<div class="ws-note">
<p><strong>Note:</strong> Use transitions only for non-urgent updates. For example, typing in an input field should be urgent, but filtering a large list can be a transition.</p>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_transitions.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="react_router.asp">❮ Previous</a>
<a class="w3-right w3-btn" href="react_forward_ref.asp">Next ❯</a>
