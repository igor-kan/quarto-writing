...
<h1>React <code class="w3-codespan">useReducer</code> Hook</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="react_useref.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="react_usecallback.asp">Next &#10095;</a>
</div>

<hr>

<p class="intro">The <code class="w3-codespan">useReducer</code> Hook is similar to the <code class="w3-codespan">useState</code> Hook.</p>
<p class="intro">It allows for custom state logic.</p>
<p class="intro">If you find yourself keeping track of multiple pieces of state that rely on complex logic, <code class="w3-codespan">useReducer</code> may be useful.</p>

<hr>

<h2>Syntax</h2>

<p>The useReducer Hook accepts three arguments.</p>

<pre class="language-jsx"><code>useReducer(<i>reducer</i>, <i>initialState</i>, <i>init</i>)
</code></pre>

<p>The <code class="w3-codespan">reducer</code> function contains your custom state logic and the <code class="w3-codespan">initialState</code>can be a simple value,
   but generally will contain an object. The <code class="w3-codespan">init</code> argument is optional and is used to initialize the state.</p>

<p>The <code class="w3-codespan">useReducer</code> Hook returns the current <code class="w3-codespan">state</code>and a <code class="w3-codespan">dispatch</code>method.</p>

<p>Here is an example where we use <code class="w3-codespan">useReducer</code> to keep track of the score of two players:</p>

<div class="w3-example">
<h3>Example:</h3>
<pre class="language-jsx w3-white"><code>import { useReducer } from 'react';
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_usereducer">Run 
Example &raquo;</a>
</p>
</div>
...
<hr>
<div id="exercisecontainer" src="xrcise_usereducer.js"></div>
<hr>
