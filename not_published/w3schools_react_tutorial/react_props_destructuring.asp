...
<html lang="en-US">
<head>
<title>React Destructuring Props</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="react_props.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="react_props_children.asp">Next &#10095;</a>
</div>
...
<p>You can limit the properties a component receives by using destructuring.</p>

<div class="w3-example">
<h3>Example</h3>
<p>The component knows it only need the <code class="w3-codespan">color</code> property, so in the function definition, it only specifies that:</p>
<pre class="language-jsx w3-white"><code>function Car({color}) {
  return (
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_props_destructuring">Run 
Example &raquo;</a>
</p>
</div>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> React uses curly brackets to destructure props:
  <code class="w3-codespan">{color}</code>.</p>
</div>
<hr>

<p>You can also destruct the properties you need inside the component.</p>

<p>This way, the component receives all the properties, but the destructuring makes sure it only uses the ones it needs.</p>

<div class="w3-example">
<h3>Example</h3>
<p>The component receives all the properties, but uses destructuring to limit the properties inside the component.</p>
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_props_destructuring2">Run 
Example &raquo;</a>
</p>
</div>
...
<h2>Destructuring <code class="w3-codespan">...rest</code></h2>

<p>When you don't know how many properties you will receive, you can use the <code class="w3-codespan">...rest</code> operator.</p>

<p>Meaning: you can specify the properties you need, and the rest will be stored in an object.</p>

<div class="w3-example">
<h3>Example</h3>
<p>The component specifies the color and the brand, but the rest is stored in an object like this:<br>
<code class="w3-codespan">{ model: "Mustang", year: 1969 }</code>.</p>
<pre class="language-jsx w3-white"><code>function Car({color, brand, ...rest}) {
  return (
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_props_destructuring3">Run 
Example &raquo;</a>
</p>
</div>
...
<p>With Destructuring, you can set default values for props.</p>

<p>If a property has no value, the default value will be used.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Set the default color value to "blue":</p>
<pre class="language-jsx w3-white"><code>function Car({color = "blue", brand}) {
  return (
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_props_destructuring4">Run 
Example &raquo;</a>
</p>
</div>
  
<hr>
<div id="exercisecontainer" src="xrcise_props_destructuring.js"></div>
<hr>
