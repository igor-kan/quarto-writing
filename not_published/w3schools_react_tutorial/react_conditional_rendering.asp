...
<a class="w3-left w3-btn" href="react_events.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="react_lists.asp">Next &#10095;</a>
</div>

<hr>

<p class="intro">In React, you can conditionally render components.</p>
<p class="intro">There are several ways to do this.</p>

<hr>

<h2><code class="w3-codespan">if</code> Statement</h2>

<p>We can use the <code class="w3-codespan">if</code> JavaScript operator to decide which component to render.</p>

<div class="w3-example">
<h3>Example:</h3>
  <p>We'll use these two components:</p>
<pre class="language-jsx w3-white"><code>function MissedGoal() {
  return &lt;h1&gt;MISSED!&lt;/h1&gt;;
}
...
<pre class="language-jsx w3-white"><code>function Goal(props) {
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_if">Run 
Example &raquo;</a>
</p>
</div>

<p>Try changing the <code class="w3-codespan">isGoal</code> attribute to <code class="w3-codespan">true</code>:</p>
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_if2">Run 
Example &raquo;</a>
</p>
</div>
...
<hr>
<h2>Logical <code class="w3-codespan">&amp;&amp;</code> Operator</h2>
<p>Another way to conditionally render a React component is by using the <code class="w3-codespan">&amp;&amp;</code> operator.</p>

<p>In the example below, the heading will only be
  rendered if the <code class="w3-codespan">props.brand</code> property is not empty:</p>

<div class="w3-example">
<h3>Example:</h3>
<p>The right side of <code class="w3-codespan">&amp;&amp;</code> will only be rendered if the left side is true:</p>
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_conditionals_logical">Run 
Example &raquo;</a>
</p>
</div>
    
<p>If <code class="w3-codespan">props.brand</code> evaluates to true,
the expression after <code class="w3-codespan">&amp;&amp;</code> will render.</p>

<p>Try emptying the <code class="w3-codespan">brand</code> property:</p>
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_conditionals_logical2">Run 
Example &raquo;</a>
</p>
</div>
...
<p>Another way to conditionally render elements is by using a ternary operator.</p>

<div class="w3-example">
<pre class="language-jsx w3-white"><code>condition ? true : false
</code></pre>
</div>
...
<div class="w3-example">
<h3>Example:</h3>
  <p>Return the <code class="w3-codespan">MadeGoal</code> component if
  <code class="w3-codespan">isGoal</code> is <code class="w3-codespan">true</code>, 
  otherwise return the <code class="w3-codespan">MissedGoal</code> component:</p>
<pre class="language-jsx w3-white"><code>function Goal(props) {
  const isGoal = props.isGoal;
  return (
    &lt;&gt;
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_conditionals_ternary">Run 
Example &raquo;</a>
</p>
</div>

<p>To learn more, see the <a href="react_es6_ternary.asp">ternary operator</a> section.</p>
<hr>

<div id="exercisecontainer" src="xrcise_conditional_rendering.js"></div>
