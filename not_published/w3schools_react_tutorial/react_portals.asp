...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="react_forms_radio.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="react_suspense.asp">Next &#10095;</a>
  </div>
<hr>
<p class="intro">React Portals provide a way to render HTML outside the parent component's DOM hierarchy.</p>
<p class="intro">This is particularly useful for components like modals, tooltips, and dialogs that need to break out of their container's layout.</p>
<hr>
<h2>What are React Portals?</h2>
<p>A Portal is a React method that is included in the <code class="w3-codespan">react-dom</code> package.</p>

<p>It is used to render HTML outside the parent component's DOM hierarchy.</p>

<p>Normally the returned HTML element is a child of the parent component, and returned like this:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Without using the <code class="w3-codespan">createPortal</code> method:</p>
<pre class="language-jsx w3-white"><code>function myChild() {
  return (
    &lt;div&gt;
      Welcome
    &lt;/div&gt;
...
<p>But by using the <code class="w3-codespan">createPortal</code> method, the HTML is not a child of the parent component, and is rendered outside the parent component's DOM hierarchy:</p>
<div class="w3-example">
<h3>Example</h3>
<p>With the <code class="w3-codespan">createPortal</code> method:</p>
<pre class="language-jsx w3-white"><code>import { createPortal } from 'react-dom';
...
createPortal(children, domNode)</code></pre>
</div>

<p>The first argument (<code class="w3-codespan">children</code>) is any renderable React content, like elements, strings, or fragments.</p>
<p>The second argument (<code class="w3-codespan">domNode</code>) is a DOM element where the portal should be inserted instead.</p>

<hr>

<h2>Creating a Modal with Portal</h2>

<p>React Portals are particularly useful for components like modals, tooltips, and dialogs that need to break out of their container's layout.</p>

<p>Here is an example of a modal component where the modal is rendered outside the parent component's DOM hierarchy:</p>
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_portals_modal">Run Example &raquo;</a>
</p>
</div>

<h3>Example Explained</h3>

<p>First, we import the necessary functions:</p>
<ul>
  <li><code class="w3-codespan">createPortal</code> from react-dom - for creating the portal</li>
  <li><code class="w3-codespan">useState</code> from react - for managing the modal's open/close state</li>
</ul>

<p>The <code class="w3-codespan">Modal</code> component uses <code class="w3-codespan">createPortal</code>
to render its content directly into the <code class="w3-codespan">document.body</code> element.</p>
...
<p>Portals are particularly useful for:</p>
<ul>
...
<p>Any UI element that needs to "break out" of its container's layout, especially when the parent component has:</p>
<ul>
  <li><code class="w3-codespan">overflow: hidden</code></li>
  <li><code class="w3-codespan">z-index</code> conflicts</li>
  <li>Complex positioning requirements</li>
</ul>

<hr>

<h2>Event Bubbling in Portals</h2>
<p>Even though a portal renders content in a different part of the DOM tree, events from the portal content still bubble up through the React component tree as if the portal wasn't there.</p>

<p>For example, if a button inside a portal is clicked, the event will still bubble up to the parent component, and the parent component's event handler will be triggered.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Click the button to demonstrate that both the button and the parent div element will have its
  <code class="w3-codespan">onClick</code> event triggered:</p>
<pre class="language-jsx w3-white"><code>import { createRoot } from 'react-dom/client';
import { useState } from 'react';
import { createPortal } from 'react-dom';
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_portals_events">Run Example &raquo;</a>
</p>
</div>
...
<p>In this example:</p>
<ul>
  <li>The <code class="w3-codespan">PortalButton</code> component is rendered as a floating button fixed to the bottom-right corner of the screen using a portal</li>
  <li>Even though the button exists outside the parent <code class="w3-codespan">&lt;div&gt;</code> in the DOM, clicking it will:</li>
  <ol>
    <li>First trigger the button's own <code class="w3-codespan">onClick</code> handler (incrementing the counter)</li>
    <li>Then trigger the parent div's <code class="w3-codespan">onClick</code> handler</li>
  </ol>
  <li>This demonstrates that event bubbling works through React's component hierarchy, not the DOM hierarchy</li>
</ul>

<hr>
<div id="exercisecontainer" src="xrcise_portals.js"></div>
<hr>
