...
<html lang="en-US">
<head>
<title>Your First React App - React Fundamentals</title>
<meta charset="utf-8">
...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="react_getstarted.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="react_render.asp">Next &#10095;</a>
</div>
<hr>

<p class="intro">Now that your development environment is set up, let's try to modify the default app to display "Hello, World!".</p>

<hr>
<h2>Modify the React App</h2>
<p>Look in the <code class="w3-codespan">my-react-app</code> directory, and you will find a 
  <code class="w3-codespan">src</code> folder. Inside the
  <code class="w3-codespan">src</code> folder there is a file called 
  <code class="w3-codespan">App.jsx</code>, open it and it will look like this:</p>
  
<div class="w3-example">
<h3>Example</h3>
<p>This is the default content of the <code class="w3-codespan">App.jsx</code> file in the <code class="w3-codespan">src</code> folder:</p>
<pre class="language-jsx w3-white" data-tab-header="App.jsx"><code>import { useState } from 'react'
...
<p>Try replacing the <b>entire file content</b> with the code below and save the file.</p>


<div class="w3-example">
<h3>Example</h3>
<p>Replace all the content of the <code class="w3-codespan">App.jsx</code> file with the code below:</p>
<pre class="language-jsx w3-white" data-tab-header="App.jsx"><code>function App() {
  return (
    &lt;div className=&quot;App&quot;&gt;
      &lt;h1&gt;Hello World!&lt;/h1&gt;
    &lt;/div&gt;
...
<img src="screenshot_react2_2.png" style="max-width:100%">
</div>


<p>Congratulations! You've just modified your first React application.</p>
...
<hr>
<div id="exercisecontainer" src="xrcise_first_app.js"></div>
<hr>
