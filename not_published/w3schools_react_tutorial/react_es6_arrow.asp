...
<a class="w3-left w3-btn" href="react_es6_classes.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="react_es6_variables.asp">Next &#10095;</a>
</div>
...
<h3>Example</h3>
<p>Before:</p>
<pre class="language-jsx w3-white"><code>hello = function() {
  return &quot;Hello World!&quot;;
}</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryreact_es6_function">Try it Yourself &raquo;</a>
</p>
</div>
...
<pre class="language-jsx w3-white"><code>hello = () =&gt; {
  return &quot;Hello World!&quot;;
}</code></pre>
<p>
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryreact_es6_arrow1">Try it Yourself &raquo;</a>

</p>
</div>

<p>It gets shorter! If the function has only one statement, and the statement 
returns a value, you can remove the brackets <em>and</em> the
<code class="w3-codespan">return</code> keyword:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Arrow Functions Return Value by Default:</p>
<pre class="language-jsx w3-white"><code>hello = () =&gt; &quot;Hello World!&quot;;</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryreact_es6_arrow2">Try it Yourself &raquo;</a>
</p>
</div>
<div class="w3-panel ws-note">
<p><strong>Note:</strong> This works only if the function has only one 
statement.</p>
</div>
...
<pre class="language-jsx w3-white"><code>hello = (val) =&gt; &quot;Hello &quot; + val;</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryreact_es6_arrow3">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryreact_es6_arrow4">Try it Yourself &raquo;</a>
</p>
</div>
...
<h2>What About <code class="w3-codespan">this</code>?</h2>
<p>The handling of <code class="w3-codespan">this</code> is also different in arrow functions compared to regular 
functions.</p>
<p>In short, with arrow functions there is no binding of
<code class="w3-codespan">this</code>.</p>
<p>In regular functions the <code class="w3-codespan">this</code> keyword represented the object that called the 
function, which could be the window, the document, a button or whatever.</p>
<p>With arrow functions, the <code class="w3-codespan">this</code> keyword <em>always</em> represents the 
object that 
defined the arrow function.</p>
<p>Let us take a look at two examples to understand the difference.</p>
<p>Both examples call a method twice, first when the page loads, and once again 
when the user clicks a button.</p>
<p>The first example uses a regular function, and the second example uses an 
arrow function.</p>
<p>The result shows that the first example returns two different objects (window and button), 
and the 
second example returns the Header object twice.</p>
<div class="w3-example">
<h3>Example</h3>
<p>With a regular function, <code class="w3-codespan">this</code> represents the 
object that called the function:</p>
<pre class="language-jsx w3-white" data-line="8"><code>class Header {
  constructor() {
    this.color = &quot;Red&quot;;
  }
...
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryreact_es6_arrow_this_regular">Try it Yourself &raquo;</a>
</p>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>With an arrow function, <code class="w3-codespan">this</code> represents the 
Header object no matter who called the function:</p>
<pre class="language-jsx w3-white" data-line="8"><code>class Header {
  constructor() {
    this.color = &quot;Red&quot;;
  }
...
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryreact_es6_arrow_this">Try it Yourself &raquo;</a>
</p>
</div>

<p>Remember these differences when you are working with functions. Sometimes the 
behavior of regular functions is what you want, if not, use arrow functions.</p>

<hr>

<div id="exercisecontainer" src="xrcise_es6_arrow.js"></div>
