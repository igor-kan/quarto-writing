...
<a class="w3-left w3-btn" href="react_class.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="react_props_destructuring.asp">Next &#10095;</a>
</div>

<hr>

<p class="intro">Props are arguments passed into React components.</p>
<p class="intro">Props are passed to components via HTML attributes.</p>
<div class="w3-panel ws-note">
<p><code class="w3-codespan">props</code> stands for properties.</p>
</div>
...
<h3>Example</h3>
<p>Add a <code class="w3-codespan">brand</code> attribute to the <code class="w3-codespan">Car</code> element:</p>
...
<p>The component receives the argument as a <code class="w3-codespan">props</code> object:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Use the <code class="w3-codespan">brand</code> attribute in the <code class="w3-codespan">Car</code> component:</p>
<pre class="language-jsx w3-white"><code>function Car(props) {
  return (
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_props">Run 
Example &raquo;</a>
</p>
</div>

<p>The name of the object is <code class="w3-codespan">props</code>, but you can call it anything you want.</p>

<div class="w3-example">
<h3>Example</h3>
<p>You can use <code class="w3-codespan">myobj</code> instead of <code class="w3-codespan">props</code> in the component:</p>
<pre class="language-jsx w3-white"><code>function Car(myobj) {
  return (
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_props2">Run 
Example &raquo;</a>
</p>
</div>
<hr>
...
<h2>Pass Multiple Properties</h2>
<p>You can send as many properties as you want.</p>

<p>Every attribute is sent to the <code class="w3-codespan">Car</code> component as object properties.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Send multiple properties to the <code class="w3-codespan">Car</code> component:</p>
<pre class="language-jsx w3-white"><code>createRoot(document.getElementById('root')).render(
...
<p>All properties are received in the <code class="w3-codespan">Car</code> component inside the <code class="w3-codespan">props</code> object:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Use the property values in the <code class="w3-codespan">Car</code> component:</p>
<pre class="language-jsx w3-white"><code>function Car(props) {
  return (
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_props3">Run Example &raquo;</a>
</p>
</div>
...
<p>React props can be of any data type, including variables, numbers, strings, objects, arrays, and more.</p>

<p>Strings can be sent inside quotes as in the examples above, but numbers, variables, and objects need to be sent inside curly brackets.

<div class="w3-example">
<h3>Example</h3>
<p>Numbers has to be sent inside curly brackets to be treated as numbers:</p>
<pre class="language-jsx w3-white"><code>createRoot(document.getElementById('root')).render(
  &lt;Car year={1969} /&gt;
);</code></pre>
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_props4">Run Example &raquo;</a>
</p>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Variables has to be sent inside curly brackets:</p>
<pre class="language-jsx w3-white"><code>let x = "Ford";

createRoot(document.getElementById('root')).render(
  &lt;Car brand={x} /&gt;
);</code></pre>
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_props5">Run Example &raquo;</a>
</p>
</div>
              
<div class="w3-example">
<h3>Example</h3>
<p>Objects and Arrays has to be sent inside curly brackets:</p>
<pre class="language-jsx w3-white"><code>let x = [1964, 1965, 1966];
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_props6">Run Example &raquo;</a>
</p>
</div>
...
<p>The component treats objects like objects, and you can use the dot notation to access the properties.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Use the dot notation to access object properties:</p>
<pre class="language-jsx w3-white"><code>function Car(props) {
  return (
    &lt;&gt;
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_props7">Run 
Example &raquo;</a>
</p>
</div>
...
<p>Array props can be accessed using the indexes.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Use the indexes to access array properties:</p>
<pre class="language-jsx w3-white"><code>function Car(props) {
  return (
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_props8">Run 
Example &raquo;</a>
</p>
</div>
...
<p>Attributes are also how you pass data from one component to another, as parameters.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Send the <code class="w3-codespan">brand</code> attribute from the <code class="w3-codespan">Garage</code> component to the <code class="w3-codespan">Car</code> component:</p>
<pre class="language-jsx w3-white"><code>function Car(props) {
  return (
    &lt;h2&gt;I am a {props.brand}!&lt;/h2&gt;
  );
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_props9">Run 
Example &raquo;</a>
</p>
</div>
...
<div class="w3-panel ws-note">
<p><strong>Note:</strong> React Props are read-only! You will get an error if you try to change their 
value.</p>
</div>
<hr>

<div id="exercisecontainer" src="xrcise_props.js"></div>
