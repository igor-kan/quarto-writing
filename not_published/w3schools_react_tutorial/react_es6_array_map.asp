...
<html lang="en-US">
<head>
<title>React ES6 Array map()</title>
<meta charset="utf-8">
...
<h1>JavaScript <span class="color_h1">Array map()</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="react_es6_variables.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="react_es6_destructuring.asp">Next &#10095;</a>
</div>

<hr>

<h2>The map() Method</h2>
<p>The <code class="w3-codespan">map()</code> method creates a new array with the results of calling a function for every array element.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Multiply each number by 2:</p>
<pre class="language-js w3-white"><code>const numbers = [1, 2, 3, 4];
const doubled = numbers.map(x => x * 2);
</code></pre>
<p><a class="w3-btn" href="tryit.asp?filename=tryreact_es6_map1" target="_blank">Try it Yourself &raquo;</a></p>
</div>

<hr>

<h2>map() in React</h2>
<p>The <code class="w3-codespan">map()</code> method is commonly used in React to render lists of elements:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-jsx w3-white"><code>const fruitlist = ['apple', 'banana', 'cherry'];
...
<p><a class="w3-btn" href="showreact.asp?filename=demo_react_map2" target="_blank">Try it Yourself &raquo;</a></p>
</div>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> When using <code class="w3-codespan">map()</code> in React to create list items, each item needs a unique <code class="w3-codespan">key</code> prop.</p>
</div>

<hr>

<h2>map() with Objects</h2>
<p>You can also use <code class="w3-codespan">map()</code> with arrays of objects:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-jsx w3-white"><code>const users = [
...
<p><a class="w3-btn" href="showreact.asp?filename=demo_react_map3" target="_blank">Try it Yourself &raquo;</a></p>
</div>
...
<p>The <code class="w3-codespan">map()</code> method takes three parameters:</p>
<ul>
  <li><code class="w3-codespan">currentValue</code> - The current element being processed</li>
  <li><code class="w3-codespan">index</code> - The index of the current element (optional)</li>
  <li><code class="w3-codespan">array</code> - The array that map was called upon (optional)</li>
</ul>
...
<p><a class="w3-btn" href="showreact.asp?filename=demo_react_map4" target="_blank">Try it Yourself &raquo;</a></p>
</div>

<hr>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> The <code class="w3-codespan">map()</code> method always returns a new array. It does not modify the original array.</p>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_es6_array_map.js"></div>
<hr>
