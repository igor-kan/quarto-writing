...
<a class="w3-left w3-btn" href="react_forward_ref.asp">❮ Previous</a>
<a class="w3-right w3-btn" href="react_hooks.asp">Next ❯</a>
</div>

<hr>

<h2>TypeScript vs JavaScript</h2>
<p>Here are the key differences between TypeScript and JavaScript:</p>
...
<tr>
  <td>Type System</td>
  <td>Static typing with type annotations</td>
...
<tr>
  ...
  <td><code>let name = "John";</code></td>
</tr>
<tr>
  <td>Object Properties</td>
  <td>Must match defined interface</td>
  <td>Can add any properties</td>
</tr>
<tr>
  <td>IDE Support</td>
  <td>Better autocomplete and hints</td>
  <td>Basic autocomplete</td>
</tr>
</table>
</div>

<h3>Examples for Each Feature</h3>
...
<p>TypeScript:</p>
<pre class="language-tsx w3-white"><code>// Types are explicitly declared
...
age = "25"; // Error: Type 'string' is not 
           // assignable to type 'number'</code></pre>
</div>
</div>
<div class="w3-col l6 s12">
<div class="w3-card w3-padding">
<p>JavaScript:</p>
<pre class="language-javascript w3-white"><code>// Types are inferred dynamically
let name = "John";
let age = 25;
let active = true;
let numbers = [1, 2, 3];
...
<div class="w3-example">
<h4>2. Error Detection</h4>
<div class="w3-row">
<div class="w3-col l6 s12">
<div class="w3-card w3-padding">
<p>TypeScript:</p>
<pre class="language-tsx w3-white"><code>interface User {
  name: string;
  email: string;
}
...
sendEmail({ name: "John" }); // Error: missing
                            // email property</code></pre>
</div>
</div>
<div class="w3-col l6 s12">
<div class="w3-card w3-padding">
<p>JavaScript:</p>
<pre class="language-javascript w3-white"><code>function sendEmail(user) {
  console.log(user.email);
}
...
<div class="w3-example">
<h4>3. Object Properties</h4>
<div class="w3-row">
<div class="w3-col l6 s12">
<div class="w3-card w3-padding">
<p>TypeScript:</p>
<pre class="language-tsx w3-white"><code>interface Person {
  name: string;
  age: number;
}
...
person.location = "NYC";</code></pre>
</div>
</div>
<div class="w3-col l6 s12">
<div class="w3-card w3-padding">
<p>JavaScript:</p>
<pre class="language-javascript w3-white"><code>const person = {
  name: "John",
  age: 25
};
...
user.  // Shows: name, email, sendMessage</code></pre>
</div>
</div>
<div class="w3-col l6 s12">
<div class="w3-card w3-padding">
<p>JavaScript:</p>
<pre class="language-javascript w3-white"><code>const user = {
  name: "John",
  email: "john@example.com",
  sendMessage(msg) {
    console.log(msg);
...
<div class="w3-example">
<h4>5. Function Parameters</h4>
<div class="w3-row">
<div class="w3-col l6 s12">
<div class="w3-card w3-padding">
<p>TypeScript:</p>
<pre class="language-tsx w3-white"><code>function greet(name: string, age: number) {
  return `${name} is ${age} years old`;
}

greet("John", 25);     // OK
greet("John", "25"); // Error!</code></pre>
</div>
</div>
<div class="w3-col l6 s12">
<div class="w3-card w3-padding">
<p>JavaScript:</p>
<pre class="language-javascript w3-white"><code>function greet(name, age) {
  return `${name} is ${age} years old`;
}

greet("John", 25);     // OK
greet("John", "25"); // Also OK</code></pre>
</div>
</div>
</div>
</div>
...
<h2>What is TypeScript in React?</h2>
<p>TypeScript adds static typing to JavaScript, making your React code more reliable and easier to maintain.</p>

<p>Benefits of using TypeScript with React:</p>
<ul>
  <li>Catch errors early during development</li>
  <li>Better code completion in your editor</li>
  <li>Easier refactoring</li>
  <li>Clear interface definitions for components</li>
</ul>

<hr>

<h2>Creating a React TypeScript Project</h2>
<p>Create a new React project with TypeScript:</p>
...
<div class="w3-example">
<h3>Example</h3>
<pre class="language-tsx w3-white"><code>interface GreetingProps {
  name: string;
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_typescript_basic">Run Example &raquo;</a>
</p>
</div>
...
<h2>Typing Hooks</h2>
<p>How to use TypeScript with React hooks:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-tsx w3-white"><code>import { useState, useEffect } from 'react';
...
<p>TypeScript helps you handle events correctly:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-tsx w3-white"><code>function Form() {
...
<h2>Common Types</h2>
<p>Frequently used TypeScript types in React:</p>

<div class="w3-example">
<pre class="language-tsx w3-white"><code>// Props with children
...
<div class="w3-note">
<p><strong>Note:</strong> TypeScript's type inference is quite good. You don't always need to explicitly declare types when they can be inferred.</p>
</div>
...
<ul>
  <li>Use interfaces for objects that represent a clear concept</li>
  <li>Use type for unions, intersections, or mapped types</li>
  <li>Make props optional when they have sensible defaults</li>
  <li>Use the built-in React types when possible</li>
  <li>Keep type definitions close to where they're used</li>
</ul>
