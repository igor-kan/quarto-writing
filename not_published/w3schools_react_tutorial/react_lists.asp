...
<html lang="en-US">
<head>
<title>React Lists - React Fundamentals</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="react_conditional_rendering.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="react_forms.asp">Next &#10095;</a>
</div>

<hr>

<p class="intro">In React, you will render lists with some type of loop.</p>
<p class="intro">The JavaScript <code class="w3-codespan">map()</code> array method is generally the preferred method.</p>
<div class="w3-panel ws-note">
<p>If you need a refresher on the <code class="w3-codespan">map()</code> method, check out the 
<a href="react_es6_array_map.asp">ES6 Array map() section</a>.</p>
</div>
...
<h3>Example:</h3>
<p>Let's create a simple list using the <code class="w3-codespan">map()</code> method:</p>
<pre class="language-jsx w3-white"><code>function MyCars() {
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_lists">Run 
Example &raquo;</a>
</p>
</div>

<p>When you run this code in your React environment,
  it will work but you will receive a warning that there is no "key" provided for the list items.</p>
...
<p>Keys must be unique among siblings, but they don't have to be unique across the entire application.</p>
...
<div class="w3-example">
<h3>Example:</h3>
<p>Here the example from above, with keys:</p>
<pre class="language-jsx w3-white"><code>function MyCars() {
  const cars = [
    {id: 1001, brand: 'Ford'},
    {id: 1002, brand: 'BMW'},
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_lists_keys">Run 
Example &raquo;</a>
</p>
</div>
<hr>

<h2>Using Array Index as Keys</h2>

<p>While it's possible to use the array index as a key, it's not recommended unless:</p>
<ul>
...
<div class="w3-example">
<h3>Example:</h3>
<p>Using array indexes as keys (not recommended for dynamic lists):</p>
<pre class="language-jsx w3-white"><code>function MyCars() {
  const cars = ['Ford', 'BMW', 'Audi'];
  return (
    &lt;&gt;
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_lists_keys_index">Run Example &raquo;</a>
</p>
</div>
