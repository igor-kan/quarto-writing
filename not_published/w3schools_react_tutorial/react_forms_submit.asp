...
<html lang="en-US">
<head>
<title>React Submit Forms</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="react_forms.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="react_forms_textarea.asp">Next &#10095;</a>
</div>
...
<p>You can control the submit action by adding an event handler in the <code class="w3-codespan">onSubmit</code> attribute for the <code class="w3-codespan">&lt;form&gt;</code>:</p>

<div class="w3-example">
<h3>Example:</h3>
  <p>Add a submit button and an event handler in the <code class="w3-codespan">onSubmit</code> attribute:</p>
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_forms_submit">Run 
Example &raquo;</a>
</p>
</div>
