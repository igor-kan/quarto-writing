...
<html lang="en-US">
<head>
<title>React ES6 Template Strings</title>
<meta charset="utf-8">
...
<h1>React ES6 Template Strings</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="react_es6_ternary.asp">❮ Previous</a>
  <a class="w3-right w3-btn" href="react_jsx.asp">Next ❯</a>
</div>

<hr>

<h2>Template Strings</h2>
<p>Template strings allow you to write strings that span multiple lines and include embedded expressions:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Before:</p>
<pre class="language-js w3-white"><code>const name = "John";
const age = 30;
const message = "Hello, " + name + "!\n" + 
"You are " + age + " years old.";</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryreact_es6_template1">Try it Yourself &raquo;</a>
</p>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>With Template Strings:</p>
<pre class="language-jsx w3-white"><code>const name = "John";
const age = 30;
const message = `Hello, ${name}!
You are ${age} years old.`;</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryreact_es6_template2">Try it Yourself &raquo;</a>
</p>
</div>

<p>Template strings use backticks (`) instead of quotes and can include:</p>
<ul>
  <li>Multiple lines without \n</li>
  <li>Expressions inside ${}</li>
  <li>Quotes without escaping</li>
</ul>

<div class="w3-example">
<h3>Example</h3>
<p>Multi-line Strings:</p>
<pre class="language-jsx w3-white"><code>const html = `
  &lt;div&gt;
    &lt;h1&gt;Title&lt;/h1&gt;
    &lt;p&gt;Paragraph&lt;/p&gt;
  &lt;/div&gt;
`;</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryreact_es6_template3">Try it Yourself &raquo;</a>
</p>
</div>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> The indentation in multi-line strings becomes part of the string.</p>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>The indentation becomes part of the string:</p>
<pre class="language-jsx w3-white"><code>const x = `
  John:
    Hello, how are you?
  Jane:
    I'm fine, thanks!
`;</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryreact_es6_template3_1">Try it Yourself &raquo;</a>
</p>
</div>
...
<p>You can include any valid JavaScript expression inside <code class="w3-codespan">${}</code> in a template string:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Insert variables inside template strings:</p>
<pre class="language-jsx w3-white"><code>let firstName = "John";
let lastName = "Doe";

let text = `Welcome ${firstName}, ${lastName}!`;
</code></pre>
<p><a class="w3-btn" href="tryit.asp?filename=tryreact_es6_template_variables" target="_blank">Try it Yourself &raquo;</a></p>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Insert expressions inside template strings:</p>
<pre class="language-jsx w3-white"><code>let price = 10;
let quantity = 5;

let total = `Total: ${price * quantity}`;
</code></pre>
<p><a class="w3-btn" href="tryit.asp?filename=tryreact_es6_template_expressions" target="_blank">Try it Yourself &raquo;</a></p>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Using the <code class="w3-codespan">map</code> function inside template strings:</p>
<pre class="language-jsx w3-white"><code>const items = ["apple", "banana", "orange"];
const list = `You have ${items.length} items:
${items.map(item => `- ${item}`).join('\n')}`;
</code></pre>
<p><a class="w3-btn" href="tryit.asp?filename=tryreact_es6_template_map" target="_blank">Try it Yourself &raquo;</a></p>
</div>
  
<div class="w3-example">
<h3>Example</h3>
<p>Using ternery operator inside template strings:</p>
<pre class="language-jsx w3-white"><code>const isAdmin = true;
const message = `Status: ${isAdmin ? 'Admin' : 'User'}`;
</code></pre>
<p><a class="w3-btn" href="tryit.asp?filename=tryreact_es6_template_ternary" target="_blank">Try it Yourself &raquo;</a></p>
</div>
  
<hr>

<h2>Tagged Templates</h2>
<p>You can also use template strings with a function (called a tag) to modify the output.</p>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> Tagged templates are an advanced feature. You might not need them in most cases.</p>
</div>
  
<p>The function takes the text and the expression(s) as arguments.</p>
...
<h3>Example</h3>
<p>Tagged Template:</p>
<pre class="language-jsx w3-white"><code>function highlight(strings, fname) {
...
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryreact_es6_template_tagged">Try it Yourself &raquo;</a>
</p>
</div>

<h3>Example Explained</h3>

<p>The function name is <code class="w3-codespan">highlight</code>, you can name it whatever you want.</p>
<p>The first argument holds the text between the expressions, as an array.<br>The array items are splitted by the expression.<br>
  In this example <code class="w3-codespan">strings[0]</code> holds "Hello " and <code class="w3-codespan">strings[1]</code> holds " how are you?".</p>
<p>The second argument holds the expressions. In this example <code class="w3-codespan">fname</code> holds "John".</p>
<p>Inside the function you can use the arguments to create the final string, and return it.</p>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> If the template string contains multiple expressions, the text will still be held in the first argument,
but the expressions will either be held in multiple arguments, or as an array in the second argument.</p>
</div>
  
<div class="w3-example">
<h3>Example</h3>
<p>Tagged Template with multiple expressions:</p>
<pre class="language-jsx w3-white"><code>function highlight(strings, fname1, fname2) {
...
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryreact_es6_template_tagged2">Try it Yourself &raquo;</a>
</p>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Tagged Template with multiple expressions that are held in an array using the rest parameter:</p>
<pre class="language-jsx w3-white"><code>function highlight(strings, ...fname) {
...
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryreact_es6_template_tagged3">Try it Yourself &raquo;</a>
</p>
</div>
  
<hr>
<div id="exercisecontainer" src="xrcise_es6_template_strings.js"></div>
<hr>
