...
<html lang="en-US">
<head>
<title>React JSX Expressions</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="react_jsx.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="react_jsx_attributes.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">One of the most powerful features of JSX is the ability to embed JavaScript expressions directly within your markup.</p>
<hr>

<h2>Expressions</h2>
<p>You can insert any valid JavaScript expression inside JSX by wrapping it in curly braces <code class="w3-codespan">{ }</code>.</p>
<p>React will evaluate the expression and render the result in the DOM.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Execute the expression <code class="w3-codespan">218 * 1.36</code>:</p>
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_jsx_expressions1">Run 
Example &raquo;</a>
</p>
</div>
...
<hr>
<h2>Variables</h2>
<p>Variables are also valid expressions. Insert variables in JSX by wrapping it in curly braces <code class="w3-codespan">{ }</code>.</p>
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_jsx_expressions2">Run 
Example &raquo;</a>
</p>
</div>
...
<p>Function calls are valid expressions. Insert function calls in JSX by wrapping it in curly braces <code class="w3-codespan">{ }</code>.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Use a function inside JSX:</p>
<pre class="language-jsx w3-white"><code>function kwtohp(kw) {
  return kw * 1.36;
}
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_jsx_expressions3">Run 
Example &raquo;</a>
</p>
</div>
...
<p>Access object properties within JSX:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Refer to an object property inside JSX:</p>
<pre class="language-jsx w3-white"><code>function Car() {
  const myobj = {
    name: "Fiat",
    model: "500",
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_jsx_expressions4">Run 
Example &raquo;</a>
</p>
</div>
