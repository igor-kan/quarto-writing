...
<html lang="en-US">
<head>
<title>React Forms - Multiple Input Fields</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="react_forms_select.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="react_forms_checkbox.asp">Next &#10095;</a>
</div>
...
<p>When you have multiple controlled input fields in a form, you can manage their state either by:</p>

<p>1. Using a separate useState call for each input.</p>
<p>2. Using a single useState call with an object to hold all form field values.</p>

<p>We will use the second approach, as it is more common for forms.</p>

<p>Make sure each input field has a unique name attribute.</p>

<p>Also, when initializing the state, use an object instead of a string. If the input fields have no initial value, use an empty object.</p>
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_forms_multiple">Run 
Example &raquo;</a>
</p>
</div>
...
<p>The first thing to notice is that when using a single useState call, we use an object to hold any initial values.
  In this case, with no initial values, we use an empty object:</p>
<pre class="language-jsx w3-white"><code>const [inputs, setInputs] = useState({});
</code></pre>

<p>Next, the handleChange function is updated to handle multiple input fields.</p>

<p>In the function, we access the input fields in the event handler using the
  <code class="w3-codespan">e.target.name</code> and
  <code class="w3-codespan">e.target.value</code> syntax.</p>
...
<p>When refering to input values,
  we add the name of the state object, <code class="w3-codespan">inputs</code>, as well as the name of the input field:</p>
...
&lt;input 
  ...
  onChange={handleChange}
/>
&lt;p&gt;Current values: {inputs.firstname} {inputs.lastname}&lt;/p&gt;</code></pre>
...
<p>To add initial values to the input fields in the example above,
  add the proper keys and values to the <code class="w3-codespan">useState</code> object:</p>
<div class="w3-example">
  <h3>Example:</h3>
  <p>Use initial values for firstname and lastname:</p>
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_forms_multiple2">Run 
Example &raquo;</a>
</p>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_forms_multiple_inputs.js"></div>
<hr>
