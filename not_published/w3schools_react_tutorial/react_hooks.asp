...
<a class="w3-left w3-btn" href="react_sass_styling.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="react_usestate.asp">Next &#10095;</a>
</div>

<hr>

<p class="intro">Hooks allow functions to have access to state and other React features without using classes.</p>

<p class="intro">They provide a more direct API to React concepts like props, state, context, refs, and lifecycle.</p>
...
<h3>Example:</h3>
  <p>Here is an example of a Hook. Don't worry if it doesn't make sense. We will go into more detail in the <a href="react_usestate.asp">next section</a>.</p>
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_hooks">Run 
Example &raquo;</a>
</p>
</div>
...
<p>If you have stateful logic that needs to be reused in several components, you can build your own custom Hooks.</p>

<p>We'll go into more detail in the <a href="react_customhooks.asp">Custom Hooks section</a>.</p>
