...
<a class="w3-left w3-btn" href="react_portals.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="react_css_styling.asp">Next &#10095;</a>
</div>

<hr>

<p class="intro">React Suspense lets you display an alternative HTML while waiting for code or data to load.</p>
<p class="intro">The alternative HTML can be a component, text, or any valid content.</p>

<hr>

<h2>What is Suspense?</h2>
<p>Suspense is a React feature that lets your components display an alternative HTML while waiting for code or data to load.</p>
<p>The most common use cases are:</p>
<ul>
  <li>Data fetching with suspense-enabled frameworks</li>
  <li>Loading components dynamically with <code class="w3-codespan">React.lazy()</code></li>
</ul>

<hr>

<h2>Using Suspense</h2>
<p>If a component takes time to load, you can use a <code class="w3-codespan">Suspense</code> component,
and it will display the fallback content while the component is loading.</p>

<div class="w3-example">
<h3>Example</h3>
<p>The <code class="w3-codespan">Fruits</code> component takes two seconds to load,
so we wrap it in a <code class="w3-codespan">Suspense</code> component to display a loading message while it is loading.</p>
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_suspense_basic">Run Example &raquo;</a>
</p>
</div>

<hr>

<h2>Using Suspense with <code class="w3-codespan">lazy</code> Loading</h2>

<p>Another common use of the <code class="w3-codespan">Suspense</code> component is when importing components with <code class="w3-codespan">lazy</code> loading:</p>

<p>In the example above we had to fake a delay of two seconds to see the loading message. A task like displaying three fruits from an array
  would be too fast to see the loading message at all.</p>

<p>But with <code class="w3-codespan">lazy</code> loading, we can import a component dynamically, and it will display a loading message while it is loading,
  even if the task is very fast.</p>

<p>Lets first create an example WITHOUT using <code class="w3-codespan">lazy</code> loading, where we do not fake a two seconds delay:</p>

<div class="w3-example">
<h3>Example</h3>
<p>This example is too fast to see the loading message:</p>
<pre class="language-jsx w3-white"><code>import { createRoot } from 'react-dom/client';
import { Suspense } from 'react';
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_suspense_not_lazy">Run Example &raquo;</a>
</p>
</div>

<p>Now let us create an example WITH using <code class="w3-codespan">lazy</code> loading:</p>
  
<div class="w3-example">
<h3>Example</h3>
<p>Same example as above, but using <code class="w3-codespan">lazy</code> loading:</p>
<pre class="language-jsx w3-white"><code>import { createRoot } from 'react-dom/client';
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_suspense_lazy">Run Example &raquo;</a>
</p>
</div>
    
    <h3>Example Explained</h3>
<ul>
  <li><code class="w3-codespan">lazy()</code> lets you load a component dynamically</li>
  <li><code class="w3-codespan">Suspense</code> shows a fallback while the component loads</li>
</ul>
...
<p>One Suspense component can wrap multiple lazy components:</p>
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_suspense_lazy_multi">Run Example &raquo;</a>
</p>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_suspense.js"></div>
<hr>
