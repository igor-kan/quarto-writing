...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="react_render.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="react_es6.asp">Next &#10095;</a>
</div>

<hr>

<h2>Upgrade to React 19</h2>
<p>Upgrading an existing React application to version 19 only requires two steps.</p>

<div class="w3-panel ws-note">
<p>If you are already using the latest version of React, you can skip this section.</p>
</div>

<hr>

<h2>Step 1: Install React 19</h2>    
...
<p>In order to take advantage of React 19's concurrent features you'll need to use the new root API for client rendering.</p>

<div class="w3-example">
<pre class="language-jsx w3-white"><code>// Before
...
<div class="w3-panel ws-note">
<p>Your application will work without using the new root API. If you continue to use
<code class="w3-codespan">ReactDOM.render</code> your application will behave like React 17.</p>
</div>
