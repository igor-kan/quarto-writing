...
<html lang="en-US">
<head>
<title>React Forms - Textarea</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="react_forms_submit.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="react_forms_select.asp">Next &#10095;</a>
</div>

<hr>

<h2>Textarea</h2>
<p>The textarea element in React is slightly different from ordinary HTML.</p>

<p>In HTML the value of a textarea is the text between the start tag 
<code class="w3-codespan">&lt;textarea&gt;</code> 
and the end tag <code class="w3-codespan">&lt;/textarea&gt;</code>.</p>

<div class="w3-example">
  <pre class="language-jsx w3-white"><code>&lt;textarea&gt;
  Content of the textarea.
&lt;/textarea&gt;</code></pre>
</div>

<p>In React the value of a textarea is placed in a value attribute, just like with the input element.</p>

<p>We'll use the <code class="w3-codespan">useState</code> Hook to manage the value of the textarea:</p>

<div class="w3-example">
<h3>Example:</h3>
<p>React uses the value attribute to control the textarea:</p>
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_forms_textarea">Run 
Example &raquo;</a>
</p>
</div>
...
<hr>
<p>By making these changes to the <code class="w3-codespan">&lt;textarea></code> element,
  React is able to handle it as any other input element.</p>
<hr>
<div id="exercisecontainer" src="xrcise_forms_textarea.js"></div>
<hr>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="react_forms_submit.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="react_forms_select.asp">Next &#10095;</a>
