...
<html lang="en-US">
<head>
<title>React Forms - S  elect</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="react_forms_textarea.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="react_forms_multiple_inputs.asp">Next &#10095;</a>
</div>

<hr>

<h2>Select</h2>
<p>A drop down list, or a select box, in React is also a bit different from HTML.</p>

<p>In HTML, the selected value in the drop down list is defined with the <code class="w3-codespan">selected</code> attribute:</p>

<div class="w3-example">
  <h3>HTML:</h3>
  <pre class="language-html w3-white"><code>&lt;select&gt;
...
<p>In React, the selected value is defined with a <code class="w3-codespan">value</code>
attribute on the <code class="w3-codespan">select</code> tag:</p>

<div class="w3-example">
  <h3>Example:</h3>
  <p>React uses the value attribute to control the select box:</p>
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_forms_select">Run 
Example &raquo;</a>
</p>
</div>
<hr>

<p>By making these changes to the <code class="w3-codespan">&lt;select></code> element,
  React is able to handle it as any other input element.</p>

<hr>
<div id="exercisecontainer" src="xrcise_forms_select.js"></div>
