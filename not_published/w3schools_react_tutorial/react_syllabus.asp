...
<html lang="en-US">
<head>
<title>React Syllabus (Curriculum)</title>
<meta charset="utf-8">
...
<h1>React <span class="color_h1">Syllabus</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="react_exercises.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="react_study_plan.asp">Next &#10095;</a>
</div>
<hr>
...
<p>The <a title="W3Schools React Tutorial" href="default.asp">W3Schools React Tutorial</a> is comprehensive and beginner-friendly.</p>
<p>It will give you a fundamental knowledge of React.</p>
<p>It is designed for beginners and requires intermediate JavaScript knowledge.</p>
...
<p>The syllabus outline and its sequence are structured so you can learn React step by step, from basic components to advanced features.</p>
<p><a title="W3Schools React Tutorial" href="react_intro.asp" class="ws-btn">Get Started With React &raquo;</a></p>
<hr>
...
<ul>
  ...
  <li>Work with React components, both class and functional components.</li>
  <li>Handle component props and state management.</li>
  <li>Implement event handling and conditional rendering.</li>
  <li>Create and manage lists with keys in React.</li>
  <li>Build forms and handle user input in React applications.</li>
  <li>Implement navigation using React Router.</li>
  <li>Use React Hooks (useState, useEffect, useContext, useRef, etc.).</li>
  <li>Apply performance optimization with React Memo.</li>
  <li>Style React components using CSS and Sass.</li>
  <li>Create custom hooks for reusable logic.</li>
</ul>
<div class="ws-note w3-panel">
<p><strong>Note:</strong> Are you a teacher teaching React? <a href="/academy/index.php" target="_blank">W3Schools Academy</a> is a toolbox of features that can help you teach. It offers classroom features such as pre-built study plans, classroom administration and much more. Read more about <a href="/academy/index.php" target="_blank">Academy here</a>.</p>
</div>
<hr>

<h2>Which Subjects Are React Relevant For?</h2>
<ul>
   <li style="margin-bottom:16px;"><strong>Web Development:</strong><br> React can be used for building modern web applications.</li>
   <li style="margin-bottom:16px;"><strong>Front-end Development:</strong><br> React is a leading library for user interface development.</li>
   <li style="margin-bottom:16px;"><strong>Single Page Applications:</strong><br> React enables building dynamic single-page applications.</li>
   <li style="margin-bottom:16px;"><strong>User Interface Design:</strong><br> React provides a component-based approach to UI development.</li>
   <li style="margin-bottom:16px;"><strong>Web Applications:</strong><br> React is ideal for interactive web applications.</li>
   <li style="margin-bottom:16px;"><strong>Mobile Development:</strong><br> React Native extends React concepts to mobile development.</li>
   <li><strong>Modern JavaScript Development:</strong><br> React embraces modern JavaScript features and practices.</li>
</ul>
<p><a title="W3Schools React Tutorial" href="react_intro.asp" class="ws-btn" style="margin-top:8px">Get Started</a></p>
<hr>

<h2>Activities</h2>
<p>In this tutorial we offer different activities for you to learn React for free:</p>
<ul>
    <li><a href="default.asp" title="W3Schools React Tutorial">Lessons</a></li>
    <li><a href="react_exercises.asp" title="W3Schools React Exercises">Exercises</a></li>
    <li><a href="react_quiz.asp" title="W3Schools React Quiz">Quizzes</a></li>
</ul>
...
<ul class="link-boxes">
    <li><a href="default.asp">React Home</a></li>
    <li><a href="react_intro.asp">React Intro</a></li>
    <li><a href="react_getstarted.asp">React Get Started</a></li>
    <li><a href="react_upgrade.asp">React Upgrade</a></li>
    <li><a href="react_es6.asp">React ES6</a></li>
    <li><a href="react_es6_classes.asp">ES6 Classes</a></li>
    <li><a href="react_es6_arrow.asp">ES6 Arrow Functions</a></li>
    <li><a href="react_es6_variables.asp">ES6 Variables</a></li>
    <li><a href="react_es6_array_methods.asp">ES6 Array Methods</a></li>
    <li><a href="react_es6_destructuring.asp">ES6 Destructuring</a></li>
    <li><a href="react_es6_spread.asp">ES6 Spread Operator</a></li>
    <li><a href="react_es6_modules.asp">ES6 Modules</a></li>
    <li><a href="react_es6_ternary.asp">ES6 Ternary Operator</a></li>
    <li><a href="react_render.asp">React Render HTML</a></li>
    <li><a href="react_jsx.asp">React JSX</a></li>
    <li><a href="react_components.asp">React Components</a></li>
    <li><a href="react_class.asp">React Class</a></li>
    <li><a href="react_props.asp">React Props</a></li>
    <li><a href="react_events.asp">React Events</a></li>
    <li><a href="react_conditional_rendering.asp">React Conditionals</a></li>
    <li><a href="react_lists.asp">React Lists</a></li>
    <li><a href="react_forms.asp">React Forms</a></li>
    <li><a href="react_router.asp">React Router</a></li>
    <li><a href="react_memo.asp">React Memo</a></li>
    <li><a href="react_css_styling.asp">React CSS Styling</a></li>
    <li><a href="react_sass_styling.asp">React Sass Styling</a></li>
    <li><a href="react_hooks.asp">What is a Hook?</a></li>
    <li><a href="react_usestate.asp">useState</a></li>
    <li><a href="react_useeffect.asp">useEffect</a></li>
    <li><a href="react_usecontext.asp">useContext</a></li>
    <li><a href="react_useref.asp">useRef</a></li>
    <li><a href="react_usereducer.asp">useReducer</a></li>
    <li><a href="react_usecallback.asp">useCallback</a></li>
    <li><a href="react_usememo.asp">useMemo</a></li>
    <li><a href="react_customhooks.asp">Custom Hooks</a></li>
</ul>
</div>
<p><a title="W3Schools React Tutorial" href="default.asp" class="ws-btn">Get Started</a></p>
<hr>

<h2>Sandbox and Lab Environment</h2>
<p>React, like any programming library, is best learned through hands-on practice.</p>
<p>Try this example using our editor:</p>
<div class="w3-example">
<h3>Example:</h3>

<pre class="language-jsx xw3-white"><code>import React from 'react';
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo2_react_test">Run 
Example &raquo;</a>
</p>
</div>
...
<p>The React exam is a test that summarizes the W3Schools React syllabus.</p>
<p>After passing the exam you get the "Certified React Developer" Certification.</p>
...
<div class="ws-grey w3-padding w3-round">
<a href="reactjs_exam.png" target="_blank"><img src="reactjs_exam.png" style="width: 100%" loading="lazy"></a>
</div>
<p><a class="ws-btn" href="https://campus.w3schools.com/collections/certifications/products/react-js-certificate" target="_blank">Buy Certificate &raquo;</a></p>
<hr>
