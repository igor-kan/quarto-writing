...
<a class="w3-left w3-btn" href="react_es6_destructuring.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="react_es6_modules.asp">Next &#10095;</a>
</div>

<hr>
<h2>Spread Operator</h2>
<p>The JavaScript spread operator (<code class="w3-codespan">...</code>) copies all or part of an existing array
or object into another array or object.</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-jsx w3-white"><code>const numbersOne = [1, 2, 3];
const numbersTwo = [4, 5, 6];
const numbersCombined = [...numbersOne, ...numbersTwo];</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryreact_es6_spread1">Try it Yourself &raquo;</a>
</p>
</div>
...
<pre class="language-jsx w3-white"><code>const numbers = [1, 2, 3, 4, 5, 6];

const [one, two, ...rest] = numbers;</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryreact_es6_spread2">Try it Yourself &raquo;</a>
</p>
</div>
...
<pre class="language-jsx w3-white"><code>const car = {
  brand: 'Ford',
  model: 'Mustang',
  color: 'red'
}
...
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryreact_es6_spread3">Try it Yourself &raquo;</a>
</p>
</div>

<div class="w3-panel ws-note">
<p>Notice that the properties that did not match were added,
and the property that did match
was overwritten by the last object.</p>
</div>
...
<div id="exercisecontainer" src="xrcise_es6_spread.js"></div>
