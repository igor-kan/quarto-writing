...
<html lang="en-US">
<head>
<title>React ES6 Ternary Operator</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="react_es6_modules.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="react_es6_template_strings.asp">Next &#10095;</a>
</div>
...
<h3>Example</h3>
<p>Before:</p>
<pre class="language-jsx w3-white"><code>if (authenticated) {
  renderApp();
} else {
  renderLogin();
}
...
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryreact_es6_ternary1">Try it Yourself &raquo;</a>
</p>
</div>
...
<h3>Example</h3>
<p>With Ternary</p>
<pre class="language-jsx w3-white"><code>authenticated ? renderApp() : renderLogin();
</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryreact_es6_ternary2">Try it Yourself &raquo;</a>
</p>
</div>
<hr>
...
<hr>
<div id="exercisecontainer" src="xrcise_es6_ternary.js"></div>
