...
<a class="w3-right w3-btn" href="react_sass_styling.asp">Next ❯</a>
</div>

<hr>

<h2>What is a Higher Order Component?</h2>
<p>A Higher Order Component (HOC) is like a wrapper that adds extra features to your React components. Think of it like putting a case on your phone - the case adds new features (like water protection) without changing the phone itself.</p>

<div class="ws-note">
<p><strong>Note:</strong> HOCs are functions that take a component and return an enhanced version of that component.</p>
</div>

<h2>Example: Adding a Border</h2>
<p>To demonstrate how HOCs work, let's create a simple example - adding a border to any component:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Create a function that adds a border around whatever component you pass to it:</p>
<pre class="language-jsx w3-white"><code>// This is our HOC - it adds a border to any component
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_hoc_border">Run Example &raquo;</a>
</p>
</div>

<p>In this example:</p>
<ol>
  <li><code class="w3-codespan">withBorder</code> is our HOC - it's a function that takes a component</li>
  <li>It returns a new component that wraps the original in a <code class="w3-codespan">div</code> with a border</li>
  <li>The original component (<code class="w3-codespan">Greeting</code>) remains unchanged</li>
  <li>We can still use both the original and enhanced versions</li>
</ol>
...
<div class="ws-note">
<p><strong>Note:</strong> Often, HOC's can be replaced with React Hooks,
  but HOC's are still useful for certain cross-cutting concerns like authentication or data fetching patterns.</p>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_hoc.js"></div>
<hr>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="react_forward_ref.asp">❮ Previous</a>
  <a class="w3-right w3-btn" href="react_sass_styling.asp">Next ❯</a>
