...
<a class="w3-left w3-btn" href="react_css_styling.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="react_css_js.asp">Next &#10095;</a>
</div>

<hr>

<p class="intro">CSS Modules let you write CSS that is scoped locally to a specific component.</p>
<p class="intro">This prevents CSS class name conflicts and makes your styles more maintainable.</p>

<hr>

<h2>What are CSS Modules?</h2>
<p>In React, CSS Modules are CSS files where class names are scoped locally by default.</p>

<div class="ws-note">
<p><strong>Note:</strong> CSS Modules are not a part of the React core library, but are supported by many React build tools.</p>
</div>

<p>The CSS file have to have the <code class="w3-codespan">.module.css</code> extension and can be used by importing it into your React file(s).</p>

<hr>

<h2>Creating a CSS Module</h2>

<p>Let's create a CSS module called <code class="w3-codespan">Button.module.css</code>, where we style some buttons.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Create a file named <code class="w3-codespan">Button.module.css</code>, and insert some styles in it:</p>
<pre class="language-css w3-white" data-tab-header="Button.module.css"><code>.mybutton {
  padding: 10px 20px;
  border: none;
  border-radius: 4px;
  cursor: pointer;
...
<h2>Using a CSS Module</h2>
<p>Import and use the CSS Module in your component:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Create a Button component that uses the CSS Module:</p>
<pre class="language-jsx w3-white"><code>import styles from './Button.module.css';
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_css_modules_basic">Run Example &raquo;</a>
</p>
</div>

<h3>Example Explained</h3>
<ul>
  <li>We import the styles object from the CSS Module</li>
  <li>We use <code class="w3-codespan">styles.mybutton</code> to access the <code class="w3-codespan">mybutton</code> class</li>
  <li>The actual class name of the button will be unique (e.g., <code class="w3-codespan">_mybutton_q1obu_1</code>)</li>
</ul>
...
<p>In the example above, we only used one class, but let's add more classes:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Add more styles in <code class="w3-codespan">Button.module.css</code>:</p>
<pre class="language-css w3-white" data-tab-header="Button.module.css"><code>.mybutton {
  padding: 10px 20px;
  border: none;
  border-radius: 4px;
...
<p>To demostrate the changes, we need to have two buttons, with two classes each:</p>

<div class="w3-example">
<h3>Example</h3>
<p>An example with two buttons, with different styling:</p>
<pre class="language-jsx w3-white" data-line="6,9"><code>import styles from './Button.module.css';
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_css_modules_two_buttons">Run Example &raquo;</a>
</p>
</div>
...
<p>CSS Modules allow you to combine classes using the <code class="w3-codespan">composes</code> keyword:</p>

<p>Which means that one class can inherit the styles of another class.</p>

<p>For the previous example, both the <code class="w3-codespan">primary</code>
  and the <code class="w3-codespan">secondary</code> classes
  are depending on the styles of the <code class="w3-codespan">mybutton</code> class.</p>

<p>This can be done by adding <code class="w3-codespan">composes: mybutton</code> to the <code class="w3-codespan">primary</code> and <code class="w3-codespan">secondary</code> classes:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-css w3-white" data-tab-header="Button.module.css" data-line="9, 14"><code>.mybutton {
  padding: 10px 20px;
  border: none;
  border-radius: 4px;
  cursor: pointer;
...
<p>Now it is enough to use the <code class="w3-codespan">primary</code>
  and <code class="w3-codespan">secondary</code> classes in the component:</p>
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_css_modules_composes">Run Example &raquo;</a>
</p>
</div>
...
<p>When using CSS Modules, the classes in the <code class="w3-codespan">.module.css</code> file can only be used in the component that imports them.
  This is done by prefixing the class name with a hash of the file name and a unique identifier.
  It is safe to use the same class name in different files, as the names will be unique.</p>

<p>However, sometimes you want your classes to be available globally, and use them in other components.</p>

<p>You can do this with the <code class="w3-codespan">:global</code> syntax:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Here is a CSS Module with a global class named <code class="w3-codespan">.myheader</code>:</p>
<pre class="language-css w3-white" data-tab-header="BlueHeader.module.css"><code>:global(.myheader) {
  padding: 10px 20px;
  font-size: 50px;
  color: white;
...
<p>The <code class="w3-codespan">:global</code> wrapper makes the class available for everyone.</p>

<p>It is simply called <code class="w3-codespan">.myheader</code> and not prefixed and added a unique identifier like <code class="w3-codespan">_myheader_q1obu_1</code></p>

<p>You can use it in your components like this:</p>

<div class="w3-example">
  <h3>Example</h3>
  <pre class="language-jsx w3-white"><code>import styles from './BlueHeader.module.css';
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_css_modules_global">Run Example &raquo;</a>
</p>
</div>
<hr>
<h2>Combine Global and Local Classes</h2>
<p>You can combine global and local classes in the same CSS Module:</p>
<div class="w3-example">
<h3>Example</h3>
<p>A CSS Module with both global and local classes:</p>
<pre class="language-css w3-white" data-tab-header="MyStyles.module.css"><code>:global(.myheader) {
  padding: 10px 20px;
  font-size: 50px;
  color: white;
  background-color: dodgerblue;
...
<p>Use it in your components like this:</p>
<div class="w3-example">
  <h3>Example</h3>
  <pre class="language-jsx w3-white"><code>import styles from './MyStyles.module.css';
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_css_modules_combine">Run Example &raquo;</a>
</p>
</div>
  
<hr>
<div id="exercisecontainer" src="xrcise_css_modules.js"></div>
<hr>
