...
<html lang="en-US">
<head>
<title>React Sass Styling</title>
<meta charset="utf-8">
...
<h1>React Sass Styling</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="react_hoc.asp">❮ Previous</a>
...
<h2>What is Sass?</h2>
<p class="intro">Sass is a CSS pre-processor.</p>
<p class="intro">Sass files are executed on the server and sends CSS to the browser.</p>
<p class="intro">Sass adds extra features to CSS like variables, nesting, mixins, and more.</p>
<p class="intro">You can learn more about Sass in our <a href="/sass/default.asp">Sass Tutorial</a>.</p>
<hr>

<h2>Adding Sass to React</h2>
<p>To add Sass to a React project, you need to install the Sass package:</p>
...
<h2>Create a Sass file</h2>
<p>Create a Sass file the same way as you create CSS files,
  but Sass files have the file extension <code class="w3-codespan">.scss</code>:</p>

<div class="w3-example">
<h3>Example</h3>
<p>In the newly created <code class="w3-codespan">.scss</code> file, add some simple styling:</p>
<pre class="language-scss w3-white" data-tab-header="MyStyle.scss"><code>$myColor: red;
...
<h2>Import the Sass file</h2>

<p>Import the Sass file in your React component:</p>
...
<p>
  <a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_sass">Run Example &raquo;</a>
  </p>
...
<p>Sass has many Built-in Modules that you can use to manipulate colors, math, strings, etc.</p>

<p>One example is the <code class="w3-codespan">sass:color</code> module.</p>

<p>It has a function to make a color darker or lighter, just by giving it a percentage:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-scss w3-white" data-tab-header="MyStyle.scss"><code>@use 'sass:color';
$myColor: red;
...
<p>Let us add the headers to our component:</p>
...
<p>
  <a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_sass2">Run Example &raquo;</a>
  </p>
...
<div class="ws-note">
<p><strong>Note:</strong> Sass files are compiled to CSS at build time.</p>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_sass_styling.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="react_hoc.asp">❮ Previous</a>
<a class="w3-right w3-btn" href="react_hooks.asp">Next ❯</a>
