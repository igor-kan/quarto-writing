...
<html lang="en-US">
<head>
<title>React Props Children</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="react_props_destructuring.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="react_events.asp">Next &#10095;</a>
</div>
...
<p>In React, you can send the content between the opening and closing tags of a component, to another component.</p>

<p>This can be accessed in the other component using the <code class="w3-codespan">props.children</code> property.</p>

<div class="w3-example">
<h3>Example</h3>
<p>From the <code class="w3-codespan">Parent</code> component, send the content between the opening and closing tags of the <code class="w3-codespan">Son</code> and <code class="w3-codespan">Daughter</code> components:</p>
<pre class="language-jsx w3-white"><code>function Son(props) {
  return (
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_props_children">Run 
Example &raquo;</a>
</p>
</div>
...
<hr>
<div id="exercisecontainer" src="xrcise_props_children.js"></div>
<hr>
