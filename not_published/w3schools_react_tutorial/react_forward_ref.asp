...
<a class="w3-left w3-btn" href="react_transitions.asp">❮ Previous</a>
<a class="w3-right w3-btn" href="react_hoc.asp">Next ❯</a>
</div>

<hr>

<h2>What is forwardRef?</h2>
<p><code class="w3-codespan">forwardRef</code> lets your component pass a reference to one of its children. It's like giving a direct reference to a DOM element inside your component.</p>

<p>Common uses for <code class="w3-codespan">forwardRef</code>:</p>
<ul>
...
<h2>Basic Example</h2>
<p>Here's a simple example of forwarding a ref to an input element:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-jsx w3-white"><code>import { forwardRef, useRef } from 'react';
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_forwardref">Run Example &raquo;</a>
</p>
</div>

<p>In this example:</p>
<ul>
  <li>We wrap our input component with <code class="w3-codespan">forwardRef</code></li>
  <li>The component receives a <code class="w3-codespan">ref</code> as its second parameter</li>
  <li>The parent can now control the input element directly</li>
</ul>

<div class="ws-note">
<p><strong>Note:</strong> Only use <code class="w3-codespan">forwardRef</code> when you need direct access to a DOM element. For most cases, you can use props and state instead.</p>
</div>
...
<hr>
<div id="exercisecontainer" src="xrcise_forward_ref.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="react_transitions.asp">❮ Previous</a>
<a class="w3-right w3-btn" href="react_hoc.asp">Next ❯</a>
