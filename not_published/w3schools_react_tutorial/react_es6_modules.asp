...
<a class="w3-left w3-btn" href="react_es6_spread.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="react_es6_ternary.asp">Next &#10095;</a>
</div>
...
<p>Let us create a file named <code class="w3-codespan">person.js</code>, and 
fill it with the things we want to export.</p>

<p>There are two types of exports: Named and Default.</p>
<hr>
<h2>Named Exports</h2>

<p>You can create named exports two ways:</p>

<div class="w3-example">
<h3>Example</h3>
<p>In-line individually:</p>

<pre class="language-jsx w3-white" data-tab-header="person.js"><code>export const name = "Tobias"
export const age = 18
</code></pre>
</div>
...
<pre class="language-jsx w3-white" data-tab-header="person.js"><code>const name = "Tobias"
const age = 18
...
<p>Let us create another file, named <code class="w3-codespan">message.js</code>, and 
use it for demonstrating default export.</p>
<p>You can only have one default export in a file.</p>
<div class="w3-example">
<h3>Example</h3>
<p>Insert the following code into the newly created file:</p>
<pre class="language-jsx w3-white" data-tab-header="message.js"><code>const message = () => {
  const name = "Tobias";
  const age = 18;
...
<p>You can import modules into a file in two ways, based on if they are named 
exports or default exports.</p>
...
<pre class="language-jsx w3-white"><code>import { name, age } from "./person.js";
</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryreact_es6_module1">Try it Yourself &raquo;</a>
</p>
</div>
<div class="w3-example">
<h3>Example</h3>
<p>Import a default export from the file message.js:</p>
<pre class="language-jsx w3-white"><code>import message from "./message.js";
</code></pre>
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryreact_es6_module2">Try it Yourself &raquo;</a>
</p>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_es6_modules.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="react_es6_spread.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="react_es6_ternary.asp">Next &#10095;</a>
