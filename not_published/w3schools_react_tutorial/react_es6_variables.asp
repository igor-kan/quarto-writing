...
<html lang="en-US">
<head>
<title>React ES6 Variables</title>
<meta charset="utf-8">
...
<h1>React ES6 Variables</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="react_es6_arrow.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="react_es6_array_map.asp">Next &#10095;</a>
</div>

<hr>
<h2>Variables</h2>
<p>Before ES6 there was only one way of defining your variables: with the <code class="w3-codespan">
...
<p>Now, with ES6, there are three ways of defining your variables:
<code class="w3-codespan">var</code>, <code class="w3-codespan">let</code>, and <code class="w3-codespan">const</code>.</p>

<div class="w3-example">
<h3>Example</h3>
<p>var</p>
<pre class="language-jsx w3-white"><code>var x = 5.6;
</code></pre>
<br>
</div>
...
<p>If you use <code class="w3-codespan">var</code> inside of a block, i.e. a for loop, the 
variable is still available outside of that block.</p>

<div class="w3-panel ws-note">
<p><code class="w3-codespan">var</code> has a <em>function</em> scope, not a 
<em>block</em> scope.</p>
</div>
<div class="w3-example">
<h3>Example</h3>
<p>let</p>
<pre class="language-jsx w3-white"><code>let x = 5.6;
</code></pre>
<br>
</div>
...
<p><code class="w3-codespan">let</code> is the block scoped version of 
<code class="w3-codespan">var</code>, and is limited to the block (or expression) where it is defined.</p>

<p>If you use <code class="w3-codespan">let</code> inside of a block, i.e. a for loop, the 
variable is only available inside of that loop.</p>
<div class="w3-panel ws-note">
<p><code class="w3-codespan">let</code> has a <em>block</em> scope.</p>
</div>
...
<h3>Example</h3>
<p>const</p>
<pre class="language-jsx w3-white"><code>const x = 5.6;
</code></pre>
<br>
</div>

<p><code class="w3-codespan">const</code> is a variable that once it has been 
created, its value can never change.</p>

<div class="w3-panel ws-note">
<p><code class="w3-codespan">const</code> has a <em>block</em> scope.</p>
</div>
...
<div id="exercisecontainer" src="xrcise_es6_variables.js"></div>
