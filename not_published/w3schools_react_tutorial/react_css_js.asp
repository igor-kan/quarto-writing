...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="react_css_modules.asp">❮ Previous</a>
  <a class="w3-right w3-btn" href="react_router.asp">Next ❯</a>
</div>
<hr>

<h2>What is CSS-in-JS?</h2>
<p>CSS-in-JS is a styling technique where you can write CSS directly in your JavaScript code.</p>

<p>This approach allows you to:</p>
<ul>
  <li>Write CSS using JavaScript</li>
  <li>Create component-scoped styles</li>
  <li>Use dynamic styles based on props</li>
  <li>Avoid CSS class name conflicts</li>
</ul>

<div class="w3-panel ws-note">
  <p>In this tutorial, we'll use the popular <code class="w3-codespan">styled-components</code> library.</p>
</div>
...
<p>CSS-in-JS is not a part of the React core library, but can be installed using many React build tools, like Vite, Webpack, or Create React App.</p>

<p>To install <code class="w3-codespan">styled-components</code>, run the following command:</p>
...
<p>Now you can start writing CSS directly in your .jsx files:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Insert styles directly in the .jsx files:</p>
<pre class="language-jsx w3-white"><code>import styled from 'styled-components';
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_css_js_basic">Run Example &raquo;</a>
</p>
</div>

<p>Without CSS-in-JS, you would have to either:</p>
<ul>
  <li>Write CSS in a separate .css file and import it into your React components</li>
  <li>Use inline styles</li>
</ul>

<p>Notice that:</p>
<ul>
  <li>We use the <code class="w3-codespan">styled</code> object to create components</li>
  <li>Styles are written inside template literals (backticks)</li>
  <li>You can use regular CSS syntax</li>
</ul>
...
<h2>Props in Styled Components</h2>

<p>Another powerful feature of CSS-in-JS is the ability to use props to make styles dynamic.</p>

<p>Let's create an example where we have two buttons, one primary and one secondary.</p>
<p>We want to base their background color on the value of the <code class="w3-codespan">btntype</code> prop:</p>
<div class="w3-example">
<h3>Example</h3>
<pre class="language-jsx w3-white"><code>import styled from 'styled-components';
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_css_js_props">Run Example &raquo;</a>
</p>
</div>
...
<p>Another way of letting multiple elements have the same styles is to extend existing styled components.</p>

<p>For example, we can create a <code class="w3-codespan">PrimaryButton</code>
  and <code class="w3-codespan">SuccessButton</code>
  that both have the same styles as the <code class="w3-codespan">Button</code> component,
  but they also have separate background colors:</p>
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_css_js_extend">Run Example &raquo;</a>
</p>
</div>

<hr>

<h2>Component-Scoped Styles</h2>

<p>Just like with <a href="react_css_modules.asp">CSS Modules</a>, styles created in CSS-in-JS are scoped to the component.</p>

<p>They are given unique names and can only be used in the component that imports them.</p>

<p>If we view the source of the page in the example above, the buttons will have unique class names
  like <code class="w3-codespan">bSOFjJ</code>
  and <code class="w3-codespan">pkxvl</code>,
  and will be refering to the CSS with the same unique class names in the style section.</p>

<img src="img_css_in_js2.png" alt="React CSS in JS" class="w3-image" style="max-width:100%">  

<hr>

<h2>Global Styles</h2>
<p>You can also create global styles, which will be given normal class name and will be available for all components:</p>

<div class="w3-example">
<h3>Example</h3>
<pre class="language-jsx w3-white"><code>import { createGlobalStyle } from 'styled-components';
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_css_js_global">Run Example &raquo;</a>
</p>
</div>
<p>If we view the source of the result in the example above, the CSS will have normal names and will be available for all components.</p>

<img src="img_css_in_js_global2.png" alt="React CSS in JS" class="w3-image" style="max-width:100%">  

<hr>
<div id="exercisecontainer" src="xrcise_css_js.js"></div>
<hr>
