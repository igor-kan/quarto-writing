...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="react_jsx_if_statements.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="react_class.asp">Next &#10095;</a>
</div>

<hr>

<p class="intro">Components are like functions that return HTML elements.</p>
...
<p>Class components are still supported, check the <a href="react_class.asp">Class components</a> section for more information.</p>
</div>
...
<p>React components returns HTML code.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Create a Function component called <code class="w3-codespan">Car</code></p>
...
<p>Now your React application has a component called <code class="w3-codespan">Car</code>, which returns an 
<code class="w3-codespan">&lt;h2&gt;</code> element.</p>
<p>To use this component in your application, refer to it like this:
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_components">Run 
Example &raquo;</a>
</p>
</div>
...
<p>Arguments can be passed into a component as <code class="w3-codespan">props</code>, which stands for properties.</p>

<p>You send the arguments into the component as HTML attributes.</p>
<p>You will learn more about <code class="w3-codespan">props</code> in our <a href="react_props.asp">React Props chapter</a>.</p>
<div class="w3-example">
  <h3>Example</h3>
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_components_props">Run 
Example &raquo;</a>
</p>
</div>
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_components_many">Run 
Example &raquo;</a>
</p>
</div>
...
<h2>Rendering a Component Twice</h2>

<p>We can render a component multiple times:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Use the <code class="w3-codespan">Car</code> component twice inside the <code class="w3-codespan">Garage</code> component:</p>
<pre class="language-jsx w3-white"><code>function Car() {
  return (
    &lt;h2&gt;I am a Car!&lt;/h2&gt;
  );
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_components_twice">Run 
Example &raquo;</a>
</p>
</div>

<p>The example above might be a bit useless, but if we change the content of the <code class="w3-codespan">Car</code> component, by using arguments, it makes more sense:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Use the <code class="w3-codespan">Car</code> component to display two different cars:</p>
<pre class="language-jsx w3-white"><code>function Car(props) {
  return (
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_components_twice2">Run 
Example &raquo;</a>
</p>
</div>
...
<p>To do that, create a new file in the <code class="w3-codespan">src</code> folder with a <code class="w3-codespan">.jsx</code> 
...
<pre class="language-jsx w3-white" data-tab-header="Vehicle.jsx"><code>function Car() {
  return (
    &lt;h2&gt;Hi, I am a Car!&lt;/h2&gt;
  );
}
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_components_import">Run 
Example &raquo;</a>
</p>
...
<div id="exercisecontainer" src="xrcise_components.js"></div>
