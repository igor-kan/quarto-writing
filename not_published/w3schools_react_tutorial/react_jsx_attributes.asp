...
<html lang="en-US">
<head>
<title>React JSX Attributes</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="react_jsx_expressions.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="react_jsx_if_statements.asp">Next &#10095;</a>
</div>

<hr>
<p class="intro">JSX allows you to insert attributes into HTML elements, but there are a few important differences.</p>
<hr>
...
<pre class="language-jsx w3-white"><code>function Car() {
  return (
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_jsx_attributes1">Run 
Example &raquo;</a>
</p>
</div>
...
<h2>Expressions as Attributes</h2>
<p>You can also use JavaScript expressions as attribute values.
This is very useful for dynamic attributes.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Use JavaScript expressions as attribute values:</p>
<pre class="language-jsx w3-white"><code>function Car() {
  const x = "myclass";
  return (
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_jsx_attributes2">Run 
Example &raquo;</a>
</p>
</div>

<p>Note that the attribute value is not wrapped in quotes, this is important when using expressions (JavaScript variables)
as attribute values. If you use quotes, JSX will treat it as a string literals and not a JavaScript expression.</p>
...
<h2>camelCase Event Attributes</h2>
<p>Event attributes in JSX are written in camelCase.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Use camelCase for event attributes:</p>
<pre class="language-jsx w3-white"><code>function Car() {
  const myfunc = () => {
    alert('Hello World');
  };
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_jsx_attributes3">Run 
Example &raquo;</a>
</p>
</div>
...
<p>If you pass no value for an attribute, JSX treats it as true. To pass false, you must specify it as an expression.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Boolean true in JSX, this will make the button disabled:</p>
<pre class="language-jsx w3-white"><code>&lt;button onClick={myfunc} disabled&gt;Click me&lt;/button&gt;
</code></pre>
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_jsx_attributes4">Run Example &raquo;</a>
</p>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Also true in JSX, this will also make the button disabled:</p>
<pre class="language-jsx w3-white"><code>&lt;button onClick={myfunc} disabled={true}&gt;Click me&lt;/button&gt;
</code></pre>
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_jsx_attributes5">Run Example &raquo;</a>
</p>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>False in JSX, this will NOT make the button disabled:</p>
<pre class="language-jsx w3-white"><code>&lt;button onClick={myfunc} disabled={false}&gt;Click me&lt;/button&gt;
</code></pre>
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_jsx_attributes6">Run Example &raquo;</a>
</p>
</div>
...
<p>The style attribute in JSX only accepts a JavaScript object with camelCased CSS property names, rather than a CSS string (as in HTML).</p>

<div class="w3-example">
<h3>Example</h3>
<p>Use the <code class="w3-codespan">style</code> attribute:</p>
<pre class="language-jsx w3-white"><code>function Car() {
  const mystyles = {
    color: "red",
    fontSize: "20px",
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_jsx_attributes7">Run Example &raquo;</a>
</p>
</div>

<p>Notice two things about the example above.</p>
<ol>
  <li>The styles are stored in an object.</li>
  <li>Style properties are written in camelCase, e.g. <code class="w3-codespan">fontSize</code>, instead of <code class="w3-codespan">font-size</code>.</li>
</ol>

<p>This is an important difference between HTML and JSX.</p>

<p>You will learn more about CSS and styling in the <a href="react_css_styling.asp">React CSS Styling chapter</a>.</p>

<hr>
<div id="exercisecontainer" src="xrcise_jsx_attributes.js"></div>
<hr>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="react_jsx_expressions.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="react_jsx_if_statements.asp">Next &#10095;</a>
