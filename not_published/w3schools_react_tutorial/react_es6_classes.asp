...
<a class="w3-left w3-btn" href="react_es6.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="react_es6_arrow.asp">Next &#10095;</a>
</div>
...
<code class="w3-codespan">function</code> to initiate it, we use the keyword
<code class="w3-codespan">class</code>, and the properties are assigned inside a
<code class="w3-codespan">constructor()</code> method.</p>

<div class="w3-example">
  <h3>Example</h3>
<p>A simple class constructor:</p>
<pre class="language-jsx w3-white"><code>class Car {
  constructor(name) {
    this.brand = name;
  }
}
...
<p>Notice the case of the class name.
...
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryreact_es6_class">Try it Yourself &raquo;</a>
</p>
</div>

<div class="w3-panel ws-note">
<p><strong>Note:</strong> The constructor function is called automatically when the object is initialized.</p>
</div>
...
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryreact_es6_class_method">Try it Yourself &raquo;</a>
</p>
</div>



<p>As you can see in the example above, you call the method by referring to the 
...
<p>To create a class inheritance, use the <code class="w3-codespan">extends</code> 
keyword.</p>
<p>A class created with a class inheritance inherits all the methods from 
another class:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Create a class named "Model" which will inherit the methods from the &quot;Car&quot; 
class:</p>
<pre class="language-jsx w3-white"><code>class Car {
  constructor(name) {
    this.brand = name;
...
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=tryreact_es6_class_inherit">Try it Yourself &raquo;</a>
</p>
</div>



<p>The <code class="w3-codespan">super()</code> method refers to the parent 
class.</p>
<p>By calling the <code class="w3-codespan">super()</code> method in the 
constructor method, we call the parent's constructor method and get access to 
the parent's properties and methods.</p>
<p>To learn more about classes, check out our <a href="/js/js_class_intro.asp">JavaScript Classes</a> section.</p>

<hr>
<div id="exercisecontainer" src="xrcise_es6_classes.js"></div>
<hr>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="react_es6.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="react_es6_arrow.asp">Next &#10095;</a>
