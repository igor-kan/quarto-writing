...
<a class="w3-left w3-btn" href="react_first_app.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="react_upgrade.asp">Next &#10095;</a>
</div>

<hr>

<p class="intro">React's goal is in many ways to render HTML in a web page.</p>
<p class="intro">React renders HTML to the web page via a container, and a function called
<code class="w3-codespan">createRoot()</code>.</p>

<hr>

<h2>The Container</h2>

<p>React uses a container to render HTML in a web page.</p>

<p>Typically, this container is a <code class="w3-codespan">&lt;div id="root"&gt;&lt;/div&gt;</code> element in the <code class="w3-codespan">index.html</code> file.</p>

<p>If you have followed the steps in the previous chapter, you should have a file called <code class="w3-codespan">index.html</code> in the root directory of your project:</p>

<div class="w3-example">
<h3>Example</h3>
<p>The default content of the <code class="w3-codespan">index.html</code> file:</p>
<pre class="language-html w3-white" data-tab-header="index.html"><code>&lt;!doctype html&gt;
&lt;html lang="en"&gt;
&nbsp;&nbsp;&lt;head&gt;
&nbsp;&nbsp;&nbsp;&nbsp;&lt;meta charset="UTF-8" /&gt;
...
<p>To better understand the content of the <code class="w3-codespan">index.html</code> file, let's remove all the code we don't need.</p>

<div class="w3-example">
<h3>Example</h3>
<p>The <code class="w3-codespan">index.html</code> file should now look like this:</p>
<pre class="language-html w3-white" data-tab-header="index.html"><code>&lt;!doctype html&gt;
&lt;html lang="en"&gt;
&nbsp;&nbsp;&lt;body&gt;
&nbsp;&nbsp;&nbsp;&nbsp;&lt;div id="root"&gt;&lt;/div&gt;
...
<p>The file is now stripped from unnecessary code, and we can concentrate on learning React without any disturbing elements.</p>

<hr>

<h2>The createRoot Function</h2>

<p>The <code class="w3-codespan">createRoot</code> function is located in the <code class="w3-codespan">main.jsx</code>
file in the <code class="w3-codespan">src</code> folder, and is a built-in function that is used to create a root node for a React application.</p>

<div class="w3-example">
<h3>Example</h3>
<p>The default content of the <code class="w3-codespan">src/main.jsx</code> file:</p>
<pre class="language-jsx w3-white" data-tab-header="main.jsx"><code>import { StrictMode } from 'react'
...
<p>To better understand the <code class="w3-codespan">createRoot</code> function, let's remove unnecessary code and write our own "Hello React!" example:</p>

<div class="w3-example">
<h3>Example</h3>
<p>The <code class="w3-codespan">src/main.jsx</code> file should now look like this:</p>
...
<p>If you save the file, the result in the browser will look like this:</p>
  
<div class="w3-container w3-margin-top">
<img src="react_helloreact.png" style="max-width:100%">
</div>
...
<p>Did you notice the <code class="w3-codespan">render</code> method?</p>

<p>The <code class="w3-codespan">render</code> method defines what to render in the HTML container.</p>

<p>The result is displayed in the <code class="w3-codespan">&lt;div id="root"></code> element.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Display a paragraph inside the &quot;root&quot; element:</p>
<pre class="language-jsx w3-white" data-tab-header="main.jsx"><code>import { createRoot } from 'react-dom/client'
...
<!--<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo2_react_render1">Run 
Example &raquo;</a>
</p>-->
</div>
...
<div class="w3-container w3-margin-top">
<img src="react_welcome.png" style="max-width:100%">
</div>

<hr>

<div class="w3-panel ws-note">
<p><b>Note:</b> the element id does not have to be "root", but this is the standard convention.</p>
</div>
<hr>
...
<p>W3Schools has its own "Show React" tool where we will show the result of the code we explain in the tutorial.</p>

<p>Click the "Run Example" button to see the result:</p>

<div class="w3-example">
<h3>Example</h3>
<p>The same example shown in our "Show React" tool:</p>
<pre class="language-jsx w3-white" data-tab-header="main.jsx"><code>import { createRoot } from 'react-dom/client'
...
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_render">Run Example &raquo;</a>  
</div>
...
<p>The HTML code in this tutorial uses JSX which allows you to write HTML tags 
inside the JavaScript code:</p>

<p>Don't worry if the syntax is unfamiliar, you will learn more about JSX later in this tutorial.</p>
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_render2">Run 
Example &raquo;</a>
</p>
</div>
...
<p>It does NOT have to be a <code class="w3-codespan">&lt;div&gt;</code> element and it does 
NOT have to 
have the <code class="w3-codespan">id='root'</code>:</p>
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_render3">Run 
Example &raquo;</a>
</p>
</div>
<hr>
<div id="exercisecontainer" src="xrcise_render.js"></div>
<hr>
