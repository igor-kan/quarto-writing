...
<html lang="en-US">
<head>
<title>React JSX If Statements</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="react_jsx_attributes.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="react_components.asp">Next &#10095;</a>
</div>

<hr>

<h2>Conditions - if statements</h2>
<p>React supports <code class="w3-codespan">if</code> statements, but not <em>inside </em>JSX.</p>
<p>To be able to use conditional statements in JSX, you should put the <code class="w3-codespan">if</code> 
statements outside of the JSX, or you could use a ternary expression instead:</p>
<h4>Option 1:</h4>
<p>Write <code class="w3-codespan">if</code> statements outside of the JSX code:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Write &quot;Banana" if <code class="w3-codespan">x</code> is less than 10, otherwise "Apple":</p>
<pre class="language-jsx w3-white"><code>function Fruit() {
  const x = 5;
  let y = &quot;Apple&quot;;
  if (x &lt; 10) {
    y = &quot;Banana&quot;;
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_jsx_if1">Run 
Example &raquo;</a>
</p>
</div>
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_jsx_if2">Run 
Example &raquo;</a>
</p>
</div>
<div class="w3-panel ws-note">
<p><strong>Note</strong> that in order to embed a JavaScript expression inside JSX,
the JavaScript must be wrapped with curly braces, <code class="w3-codespan">{}</code>.</p>
</div>
...
<hr>
<div id="exercisecontainer" src="xrcise_jsx_if_statements.js"></div>
<hr>
