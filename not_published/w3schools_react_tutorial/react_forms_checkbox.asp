...
<html lang="en-US">
<head>
<title>React Forms - Checkbox</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="react_forms_multiple_inputs.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="react_forms_radio.asp">Next &#10095;</a>
</div>
...
<p>For checkboxes, use the <code class="w3-codespan">checked</code> attribute
  instead of <code class="w3-codespan">value</code> to control its state.</p>

<p>We'll use the <code class="w3-codespan">useState</code> Hook to manage the value of the textarea:</p>

<p>In the <code class="w3-codespan">handleChange</code> function,
  use the <code class="w3-codespan">e.target.type</code> property check if the current input is a checkbox or not.</p>

<div class="w3-example">
<h3>Example:</h3>
<p>React uses the <code class="w3-codespan">checked</code> attribute to control the checkbox:</p>
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_forms_checkbox">Run 
Example &raquo;</a>
</p>
</div>
...
<div class="w3-example">
  <h3>Example:</h3>
  <p>Use initial values for the input fields:</p>
...
<p>
<a target="_blank" class="w3-btn" href="showreact.asp?filename=demo_react_forms_checkbox2">Run 
Example &raquo;</a>
</p>
</div>

<hr>
<div id="exercisecontainer" src="xrcise_forms_checkbox.js"></div>
<hr>
