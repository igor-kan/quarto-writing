...
<a class="w3-left w3-btn" href="react_intro.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="react_first_app.asp">Next &#10095;</a>
</div>
...
<p>Also, you need to set up a React Environment, and choose a build tool.</p>
</div>
...
<p>First, make sure you have Node.js installed. You can check by running this in your terminal:</p>
...
<p>If Node.js is installed, you will get a result with the version number:</p>
...
<p>If not, you will need to install Node.js.</p>

<hr>

<h2>Install a Build Tool (Vite)</h2>

<p>When you have Node.js installed, you can start creating a React application by choosing a build tool.</p>

<p>We will use the <a href="https://vite.dev/" target="_blank">Vite</a> build tool in this tutorial.</p>

<p>Run this command to install Vite:</p>
...
<p>If the installation was a success, you will get a result like this:</p>
...
<p>Run this command to create a React application named <code class="w3-codespan">my-react-app</code>:</p>
...
<p>If you get this message, just press <code class="w3-codespan">y</code> and press <code class="w3-codespan">Enter</code> to continue:</p>

<div class="w3-example">
<div class="w3-code notranslate w3-black">
Need to install the following packages:<br>
create-vite@9.0.7<br>
Ok to proceed? (y)
</div>
</div>

<p>Next, you might get this message, just press <code class="w3-codespan">Enter</code> to continue:</p>
...
<br>
  <span class="w3-text-gray">|</span><br>
  <span class="w3-text-blue">*</span>&nbsp;&nbsp;Install with npm and start now?<br>
  <span class="w3-text-blue">|</span>&nbsp;&nbsp;<span class="w3-text-green">&gt;</span> Yes <span class="w3-text-gray">/&nbsp;&nbsp;&nbsp;No</span><br>
  <span class="w3-text-blue">-</span>
</div>
</div>

<p>If the creation was a success, you will get a result like this:</p>
...
<br>
  <span class="w3-text-gray">|</span><br>
  <span class="w3-text-green">o</span>&nbsp;&nbsp;Scaffolding project in C:\Users\stale\my-react-app...<br>
  <span class="w3-text-gray">|</span><br>
  <span class="w3-text-gray">-</span>&nbsp;&nbsp;Done. Now run:<br>
  <br>
  &nbsp;&nbsp;cd my-react-app<br>
  &nbsp;&nbsp;npm install<br>
  &nbsp;&nbsp;npm run dev
...
<p>As the result above suggests, navigate to your new react application directory:</p>
...
<p>And run this command to install dependencies:</p>
...
<div class="w3-example">
  <div class="w3-code notranslate w3-black">
added 154 packages, and audited 155 packages in 8s<br>
<br>
33 packages are looking for funding<br>
&nbsp;&nbsp;run `npm fund` for details<br>
<br>
found <span class="w3-text-green">0</span> vulnerabilities
  </div>
</div>
...
<p>Run this command to run the React application <code class="w3-codespan">
my-react-app</code>:</p>
...
<div class="w3-code notranslate w3-black">
<br>
<span class="w3-text-green">VITE v8.0.15</span> <span class="w3-text-gray">ready in</span> 262 ms<br>
<br>
<span class="w3-text-green">&#8594;</span> Local:&nbsp;&nbsp;&nbsp;&nbsp;<span class="w3-text-blue">http://localhost:<span style="color:cyan">5173</span>/</span><br>
<span class="w3-text-green" style="opacity:0.5">&#8594;</span> <span class="w3-text-gray">Network: use</span> --host <span class="w3-text-gray">to expose</span><br>
<span class="w3-text-green" style="opacity:0.5">&#8594;</span> <span class="w3-text-gray">press</span> h + enter <span class="w3-text-gray">to show help</span>
<br>
<br>
</div>
</div>
...
<code class="w3-codespan">localhost:5173</code> in the address bar.</p>

<p>The result:</p>

<div class="w3-container w3-margin-top">
<img src="screenshot_react1_3.png" style="max-width:100%">
</div>
<br>
