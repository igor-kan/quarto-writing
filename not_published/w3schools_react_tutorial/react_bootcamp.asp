...
<html lang="en-US">
<head>
<title>W3Schools React Bootcamp</title>
<meta charset="utf-8">
...
<h1>W3Schools <span class="color_h1">React Bootcamp</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="react_interview_prep.asp">&#10094; Previous</a>
...
<div class="ws-light-green caption w3-round" style="padding-top:50px;padding-bottom:50px;position:relative;">
  <div style="max-width:1300px;margin:auto">
    <h1 class="bctop">FrontEnd Bootcamp With ReactJS</h1>
    ...
    <h4 style="margin-top:15px;"><strong>Duration</strong>: 6 Weeks.</h4>

    <p style="margin-top:8px;"><a title="Learn More" target="_blank" href="/bootcamp/react.php" style="width:200px;font-size:20px;border-radius:25px;font-weight:600;padding:8px 16px;margin-right:5px;margin-top:16px;" class="ws-btn w3-mobile applynowbtn ga-featured">Learn More</a></p>
...
<div class="caption" style="padding-left:0;padding-right:0;font-family: 'Source Sans Pro', sans-serif;">
  ...
  <div style="max-width:950px">
      <p>In this bootcamp, you will learn how to build dynamic and responsive user interfaces using ReactJS, a popular and powerful JavaScript library for front-end development. You will also learn how to work with React components, manage state and data, and integrate with other tools and frameworks.</p>
      <p>You will learn the fundamentals of ReactJS over a 6 weeks period, together with a live instructor and an interactive cohort of engaged learners!</p>

    <h5 style="font-size:30px;font-weight:bold;">You Will Learn</h5>

    <ul style="font-size:16px;">
      <li>The fundamentals of React including: Functional Components, Props, Hooks, Event Handling</li> 
      <li>How to write JSX syntax and use it within the React Framework</li>
      <li>How to structure an application out of components and how to build these components using React</li>
      <li>Intermediate React concepts such as unidirectional data flow, conditional rendering & lists</li>
      <li>Handling client and server side routing using React Router</li>
      <li>Advanced concepts such as Axios, useEffect and Asynchronous JS</li>
      <li>How to manage state within React</li>
      <li>How to build user interfaces for websites with reusable components</li>
      <li>How to build rich single-page applications for the web</li>
      <li>How to work in on a React project as a team utilising industry standards for Agile delivery</li>
    </ul>
...
<div style="background-color:#F3ECEA;padding-top:30px;color:black" class="w3-round">
  ...
  <p style="margin-top:8px;text-align:center;padding-bottom:45px;"><a title="Learn More" target="_blank" href="/bootcamp/react.php" style="width:200px;font-size:20px;border-radius:25px;font-weight:600;padding:6px 6px;" class="ws-btn ga-featured">Learn More</a></p>
</div>
  ...
  <div style="max-width:1350px;margin:auto;padding-left:24px;padding-right:24px;">
    ...
    <div style="text-align:left;font-family: 'Source Sans Pro', sans-serif;">
      ...
      <h4 style='font-size:18px;margin-bottom:20px'><strong>2. Complete the Bootcamp</strong>:<br>
        ...
        <br><br>The bootcamp covers the fundamentals of ReactJS. The curriculum used is the <a target="_blank" href="https://www.w3schools.com/react/default.asp">W3Schools React Tutorial</a>. The bootcamp will help you prepare for the W3Schools ReactJS exam so that you can document and validate your competence.
      ...
      <h4 style='font-size:18px;'><strong>3. Certification and Job Application</strong>:<br>
        Upon completing the bootcamp, you will have passed the W3Schools ReactJS exam and obtained the 
        <strong>Certified ReactJS Developer</strong> Title and an extra acknowledgement that you were a part of the bootcamp on the certification. This certification demonstrates that you know the fundamentals of ReactJS. 
      </h4>
      <p><a title="Learn More" target="_blank" href="/bootcamp/react.php" style="margin-top:15px;width:200px;font-size:20px;border-radius:25px;font-weight:600;padding:6px 6px;" class="ws-btn w3-mobile applynowbtn ga-featured">Learn More</a></p>
    </div>
  </div>
</div>
