...
description: "A comprehensive project proposal for the Aurora Internal AI Assistant, detailing the RAG architecture, safety layers, Gantt timelines, real cloud pricing, and security mapping."
...
- [Confirmation of Approach](#confirmation-of-approach)
- [What Aurora's Team Will See](#what-auroras-team-will-see)
- [System Architecture](#system-architecture)
- [Answers to All Project Brief Questions](#answers-to-all-project-brief-questions)
- [Technology Stack](#technology-stack)
- [Phase 1 — Detailed Delivery Plan](#phase-1--detailed-delivery-plan)
- [Phase 2 — Future Expansion Roadmap](#phase-2--future-expansion-roadmap)
- [Cost Estimate & Market Rate Comparison](#cost-estimate--market-rate-comparison)
- [Real Infrastructure & Ongoing Costs](#real-infrastructure--ongoing-costs)
- [Security & Compliance Mapping](#security-compliance-mapping)
- [Team Structure & Relevant Experience](#team-structure--relevant-experience)
...
When an Aurora employee opens the assistant, they see a clean, professional chat interface:
...
These are **real Azure prices** that Aurora will pay directly to Microsoft. They are identical regardless of how the system is developed.
...
| **Aurora Stakeholders** | CEO + Senior Tax Managers | Requirements validation, UAT testing, knowledge base content, weekly feedback |
...
|---|---|---|---|
| 1 | ✅ **Approve proposal** and confirm budget ($670 Phase 1) | CEO | ASAP |
...
| 6 | 📝 **Escalation topics list** — which queries should always route to Tax Manager | CEO + Tax Managers | Week 2 |
