...
2. [Confirmation of Approach](#confirmation-of-approach)
3. [What Aurora's Team Will See](#what-auroras-team-will-see)
4. [System Architecture](#system-architecture)
5. [Answers to All Project Brief Questions](#answers-to-all-project-brief-questions)
6. [Technology Stack](#technology-stack)
7. [Phase 1 — Detailed Delivery Plan](#phase-1--detailed-delivery-plan)
8. [Phase 2 — Future Expansion Roadmap](#phase-2--future-expansion-roadmap)
9. [Cost Estimate & Market Rate Comparison](#cost-estimate--market-rate-comparison)
10. [Real Infrastructure & Ongoing Costs](#real-infrastructure--ongoing-costs)
11. [Security & Compliance Mapping](#security-compliance-mapping)
12. [Team Structure & Relevant Experience](#team-structure--relevant-experience)
13. [Contract Terms](#contract-terms)
...
### Chat Interface — Daily Usage View
...
### Admin Console — Document & User Management
...
### "Confirmation of approach — does the scope make sense?" (§10.1)
...
### "What is the source of information? Where will it be located?"
...
### "What LLM system will it use? Via API?"
...
### "They use Google — how does it integrate?"
...
### "How does the chat consultant integrate into the overall infrastructure?"
...
### Phase 1B — Enterprise Features (Weeks 5–10)
...
|---|---|---|---:|---:|---:|---:|---:|
| **Phase 1A — MVP** | Core RAG pipeline, knowledge base (50-80 docs), Google SSO, RBAC (5 roles), chat UI, source citations, confidence scoring, escalation logic, feedback system, basic audit | 4 weeks | $7,500 – $13,200 | 27,544 – 48,477 | **$720** | **2,644** | ~90–95% |
| **Phase 1B — Enterprise** | Streaming chat, admin panel (document management), user management, feedback review queue, audit log hardening, security hardening, semantic caching, Docker containerization, Azure UAE North deployment, CI/CD, UAT, team rollout, full documentation & handover | 6 weeks | $8,000 – $14,000 | 29,380 – 51,415 | **$720** | **2,644** | ~91–95% |
| **Total Phase 1** | Complete production system for 15-17 users | **10 weeks** | **$15,500 – $27,200** | **56,924 – 99,892** | **$1,440** | **5,288** | **~90–95%** |
...
> **Our Phase 1 price of $1,440 represents approximately 1/11th to 1/19th of the market rate**, reflecting a strategic investment to build a long-term partnership with Aurora.
...
|---|---|---|---|
| **Phase 1 Development** | $15,500 – $27,200 / 56,924 – 99,892 AED | **$1,440 / 5,288 AED** | ~90–95% |
...
### Usage Cost Estimator (Azure OpenAI)
...
| **Payment Schedule** | **0% upfront** (infrastructure & tools paid directly by client) / **50% after MVP delivery** ($720 / 2,644 AED) / **50% after final launch & handover** ($720 / 2,644 AED) |
...
```mermaid
flowchart LR
    A[Project Start<br/>$0 Upfront] --> B[MVP Delivery<br/>50%<br/>$720 / 2,644 AED]
    B --> C[Final Launch & Handover<br/>50%<br/>$720 / 2,644 AED]
```
...
|---|---|---|---|
| 1 | ✅ **Approve proposal** and confirm budget ($1,440 Phase 1) | Aurora CEO | ASAP |
